...
thf(cclim1fr1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccmul) @ XB2 @ ccaddc) @ (cco @ XA2 @ (ccv @ Xn) @ ccmul) @ ccdiv))))) => ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (XA2 != ccc0)) => ((Xph => (cwcel @ XB2 @ ccc)) => (! [Xn:$i] : (Xph => (cwbr @ (XF @ Xn) @ cc1 @ ccli)))))))))))).
