...
thf(climsupequzlem_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((? [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X)) => (! [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XM @ ccz))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwfn @ XF @ (ccfv @ XM @ ccuz)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XN @ ccz))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwfn @ XG @ (ccfv @ XN @ ccuz)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XK @ ccz))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ (ccfv @ XK @ ccuz))) => ((ccfv @ (ccv @ Xk) @ XF) = (ccfv @ (ccv @ Xk) @ XG)))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccfv @ XF @ cclsp) = (ccfv @ XG @ cclsp)))))))))))))))))).
