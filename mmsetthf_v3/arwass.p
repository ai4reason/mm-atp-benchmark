...
thf(carwass_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XH = (ccfv @ XC @ cchoma)) => ((Xc_x = (ccfv @ XC @ cccoa)) => ((Xc_1 = (ccfv @ XC @ ccida)) => ((Xph => (cwcel @ XF @ (cco @ XX @ XY @ XH))) => ((Xph => (cwcel @ XG @ (cco @ XY @ XZ @ XH))) => ((Xph => (cwcel @ XK @ (cco @ XZ @ XW @ XH))) => (Xph => ((cco @ (cco @ XK @ XG @ Xc_x) @ XF @ Xc_x) = (cco @ XK @ (cco @ XG @ XF @ Xc_x) @ Xc_x)))))))))))))))))))))).
