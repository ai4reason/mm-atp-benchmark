...
thf(afconst3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ (ccsn @ XB2) @ XF) <=> ((cwfn @ XF @ XA2) & (cwss @ XA2 @ (ccima @ (cccnv @ XF) @ (ccsn @ XB2))))))))).
...
thf(cfconst4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ (ccsn @ XB2) @ XF) <=> ((cwfn @ XF @ XA2) & ((ccima @ (cccnv @ XF) @ (ccsn @ XB2)) = XA2))))))).
