...
thf(cfsneq_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((XB2 = (ccsn @ XA2)) => ((Xph => (cwfn @ XF @ XB2)) => ((Xph => (cwfn @ XG @ XB2)) => (Xph => ((XF = XG) <=> ((ccfv @ XA2 @ XF) = (ccfv @ XA2 @ XG))))))))))))))).
