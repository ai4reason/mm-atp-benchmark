...
thf(cfvprmselelfz_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((! [Xm:$i] : ((XF @ Xm) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccif @ (cwcel @ (ccv @ Xm) @ ccprime) @ (ccv @ Xm) @ cc1))))) => (! [Xm:$i] : (((cwcel @ XN @ ccn) & (cwcel @ XX @ (cco @ cc1 @ XN @ ccfz))) => (cwcel @ (ccfv @ XX @ (XF @ Xm)) @ (cco @ cc1 @ XN @ ccfz))))))))).
