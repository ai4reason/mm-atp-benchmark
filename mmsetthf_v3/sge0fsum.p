...
thf(csge0fsum_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((Xph => (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => (Xph => ((ccfv @ XF @ ccsumge0) = (ccsu @ XX @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))))))))))).
