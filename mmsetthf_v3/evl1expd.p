...
thf(apwsmulg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XR @ XI @ ccpws)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xc_xb = (ccfv @ XY @ ccmg)) => ((Xc_x = (ccfv @ XR @ ccmg)) => ((((cwcel @ XR @ ccmnd) & (cwcel @ XI @ XV)) & ((cwcel @ XN @ ccn0) & (cwcel @ XX @ XB2) & (cwcel @ XA2 @ XI))) => ((ccfv @ XA2 @ (cco @ XN @ XX @ Xc_xb)) = (cco @ XN @ (ccfv @ XA2 @ XX) @ Xc_x)))))))))))))))))).
thf(aoveq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))))).
thf(cevl1expd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((XO = (ccfv @ XR @ cce1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XU = (ccfv @ XP @ ccbs)) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => ((cwcel @ XM @ XU) & ((ccfv @ XY @ (ccfv @ XM @ XO)) = XV))) => ((Xc_xb = (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg)) => ((Xc_ex = (ccfv @ (ccfv @ XR @ ccmgp) @ ccmg)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((cwcel @ (cco @ XN @ XM @ Xc_xb) @ XU) & ((ccfv @ XY @ (ccfv @ (cco @ XN @ XM @ Xc_xb) @ XO)) = (cco @ XN @ XV @ Xc_ex))))))))))))))))))))))))))).
