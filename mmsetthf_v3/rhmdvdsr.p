...
thf(advdsr2_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pa:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((! [Xz:$i] : ((Xc_pa @ Xz) = (ccfv @ XR @ ccdsr))) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (! [Xz:$i] : ((cwcel @ XX @ XB2) => ((cwbr @ XX @ XY @ (Xc_pa @ Xz)) <=> (cwrex @ (^ [Xz:$i] : ((cco @ (ccv @ Xz) @ XX @ Xc_x) = XY)) @ (^ [Xz:$i] : XB2))))))))))))))).
...
thf(crhmdvdsr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pa:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XR @ ccbs)) => ((Xc_pa = (ccfv @ XR @ ccdsr)) => ((Xc_dv = (ccfv @ XS @ ccdsr)) => ((((cwcel @ XF @ (cco @ XR @ XS @ ccrh)) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) & (cwbr @ XA2 @ XB2 @ Xc_pa)) => (cwbr @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ Xc_dv)))))))))))))).
