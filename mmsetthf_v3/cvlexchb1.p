...
thf(ccvlexchb1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cwcel @ XK @ cclc) & ((cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2) & (cwcel @ XX @ XB2)) & (~ (cwbr @ XP @ XX @ Xc_le))) => ((cwbr @ XP @ (cco @ XX @ XQ @ Xc_or) @ Xc_le) <=> ((cco @ XX @ XP @ Xc_or) = (cco @ XX @ XQ @ Xc_or))))))))))))))))).
