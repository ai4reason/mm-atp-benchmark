...
thf(cnn0digval_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XB2 @ ccn) & (cwcel @ XK @ ccn0) & (cwcel @ XR @ (cco @ ccc0 @ ccpnf @ ccico))) => ((cco @ XK @ XR @ (ccfv @ XB2 @ ccdig)) = (cco @ (ccfv @ (cco @ XR @ (cco @ XB2 @ XK @ ccexp) @ ccdiv) @ ccfl) @ XB2 @ ccmo))))))).
