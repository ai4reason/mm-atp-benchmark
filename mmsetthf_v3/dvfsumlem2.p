...
thf(advle_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XM @ ccr)) => ((Xph => (cwcel @ XN @ ccr)) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ XM @ XN @ ccicc)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cco @ (cco @ XM @ XN @ ccicc) @ ccr @ cccncf))) => ((Xph => ((cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : (cco @ XM @ XN @ ccioo)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : (cco @ XM @ XN @ ccioo)) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ XM @ XN @ ccicc)) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (cco @ (cco @ XM @ XN @ ccicc) @ ccr @ cccncf))) => ((Xph => ((cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : (cco @ XM @ XN @ ccioo)) @ (^ [Xx3:$i] : (XC @ Xx3))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : (cco @ XM @ XN @ ccioo)) @ (^ [Xx3:$i] : (XD @ Xx3))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XM @ XN @ ccioo))) => (cwbr @ (XB2 @ Xx3) @ (XD @ Xx3) @ ccle))) => ((Xph => (cwcel @ XX @ (cco @ XM @ XN @ ccicc))) => ((Xph => (cwcel @ XY @ (cco @ XM @ XN @ ccicc))) => ((Xph => (cwbr @ XX @ XY @ ccle)) => ((! [Xx3:$i] : (((ccv @ Xx3) = XX) => ((XA2 @ Xx3) = XP))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XX) => ((XC @ Xx3) = XQ))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XY) => ((XA2 @ Xx3) = XR))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XY) => ((XC @ Xx3) = XS))) => (Xph => (cwbr @ (cco @ XR @ XP @ ccmin) @ (cco @ XS @ XQ @ ccmin) @ ccle)))))))))))))))))))))))))))))).
...
thf(advfsumlem1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xk:$i] : (XS = (cco @ (XT @ Xk) @ ccpnf @ ccioo))) => ((! [Xk:$i] : ((XZ @ Xk) = (ccfv @ XM @ ccuz))) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XD @ ccr)) => ((Xph => (cwbr @ XM @ (cco @ XD @ cc1 @ ccaddc) @ ccle)) => ((! [Xk:$i] : (Xph => (cwcel @ (XT @ Xk) @ ccr))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XS)) => (cwcel @ (XA2 @ Xx3 @ Xk) @ ccr)))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XS)) => (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3 @ Xk))))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (XZ @ Xk))) => (cwcel @ (XB2 @ Xx3) @ ccr)))) => ((! [Xk:$i] : (Xph => ((cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xk))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))) => ((! [Xx3:$i] : (! [Xk:$i] : (((ccv @ Xx3) = (ccv @ Xk)) => ((XB2 @ Xx3) = (XC @ Xk))))) => ((Xph => (cwcel @ XU @ ccxr)) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xk) @ XS)) & ((cwbr @ XD @ (ccv @ Xx3) @ ccle) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xk) @ ccle) & (cwbr @ (ccv @ Xk) @ XU @ ccle))) => (cwbr @ (XC @ Xk) @ (XB2 @ Xx3) @ ccle)))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XH @ Xx3 @ Xk) = (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccmin) @ (XB2 @ Xx3) @ ccmul) @ (cco @ (ccsu @ (cco @ XM @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xk:$i] : (XC @ Xk))) @ (XA2 @ Xx3 @ Xk) @ ccmin) @ ccaddc)))))) => ((Xph => (cwcel @ XX @ XS)) => ((Xph => (cwcel @ XY @ XS)) => ((Xph => (cwbr @ XD @ XX @ ccle)) => ((Xph => (cwbr @ XX @ XY @ ccle)) => ((Xph => (cwbr @ XY @ XU @ ccle)) => ((Xph => (cwbr @ XY @ (cco @ (ccfv @ XX @ ccfl) @ cc1 @ ccaddc) @ ccle)) => (! [Xx3:$i] : (! [Xk:$i] : (Xph => ((ccfv @ XY @ (XH @ Xx3 @ Xk)) = (cco @ (cco @ (cco @ (cco @ XY @ (ccfv @ XX @ ccfl) @ ccmin) @ (ccsb @ XY @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccmul) @ (ccsb @ XY @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xk))) @ ccmin) @ (ccsu @ (cco @ XM @ (ccfv @ XX @ ccfl) @ ccfz) @ (^ [Xk:$i] : (XC @ Xk))) @ ccaddc)))))))))))))))))))))))))))))))))))))))).
...
thf(avtoclg1f_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (((? [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3)) @ X))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> (Xps @ Xx3)))) => ((! [Xx3:$i] : (Xph @ Xx3)) => (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => (Xps @ Xx3))))))))))).
...
thf(cdvfsumlem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xk:$i] : (XS = (cco @ (XT @ Xk) @ ccpnf @ ccioo))) => ((! [Xk:$i] : ((XZ @ Xk) = (ccfv @ XM @ ccuz))) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XD @ ccr)) => ((Xph => (cwbr @ XM @ (cco @ XD @ cc1 @ ccaddc) @ ccle)) => ((! [Xk:$i] : (Xph => (cwcel @ (XT @ Xk) @ ccr))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XS)) => (cwcel @ (XA2 @ Xx3 @ Xk) @ ccr)))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XS)) => (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3 @ Xk))))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (XZ @ Xk))) => (cwcel @ (XB2 @ Xx3) @ ccr)))) => ((! [Xk:$i] : (Xph => ((cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xk))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))) => ((! [Xx3:$i] : (! [Xk:$i] : (((ccv @ Xx3) = (ccv @ Xk)) => ((XB2 @ Xx3) = (XC @ Xk))))) => ((Xph => (cwcel @ XU @ ccxr)) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xk) @ XS)) & ((cwbr @ XD @ (ccv @ Xx3) @ ccle) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xk) @ ccle) & (cwbr @ (ccv @ Xk) @ XU @ ccle))) => (cwbr @ (XC @ Xk) @ (XB2 @ Xx3) @ ccle)))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XH @ Xx3 @ Xk) = (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccmin) @ (XB2 @ Xx3) @ ccmul) @ (cco @ (ccsu @ (cco @ XM @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xk:$i] : (XC @ Xk))) @ (XA2 @ Xx3 @ Xk) @ ccmin) @ ccaddc)))))) => ((Xph => (cwcel @ XX @ XS)) => ((Xph => (cwcel @ XY @ XS)) => ((Xph => (cwbr @ XD @ XX @ ccle)) => ((Xph => (cwbr @ XX @ XY @ ccle)) => ((Xph => (cwbr @ XY @ XU @ ccle)) => ((Xph => (cwbr @ XY @ (cco @ (ccfv @ XX @ ccfl) @ cc1 @ ccaddc) @ ccle)) => (! [Xx3:$i] : (! [Xk:$i] : (Xph => ((cwbr @ (ccfv @ XY @ (XH @ Xx3 @ Xk)) @ (ccfv @ XX @ (XH @ Xx3 @ Xk)) @ ccle) & (cwbr @ (cco @ (ccfv @ XX @ (XH @ Xx3 @ Xk)) @ (ccsb @ XX @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccmin) @ (cco @ (ccfv @ XY @ (XH @ Xx3 @ Xk)) @ (ccsb @ XY @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccmin) @ ccle)))))))))))))))))))))))))))))))))))))))).
