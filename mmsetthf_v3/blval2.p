...
thf(cblval2_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) & (cwcel @ XP @ XX) & (cwcel @ XR @ ccrp)) => ((cco @ XP @ XR @ (ccfv @ XD @ ccbl)) = (ccima @ (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ XR @ ccico)) @ (ccsn @ XP))))))))).
