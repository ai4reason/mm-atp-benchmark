...
thf(arintn0_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (((cwss @ XX @ (ccpw @ XA2)) & (XX != cc0)) => ((ccin @ XA2 @ (ccint @ XX)) = (ccint @ XX)))))).
thf(a_3adant3_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => ((Xph & Xps & Xth) => Xch))))))).
thf(cismred2_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwss @ XC @ (ccpw @ XX))) => ((! [Xs1:$i] : ((Xph & (cwss @ (ccv @ Xs1) @ XC)) => (cwcel @ (ccin @ XX @ (ccint @ (ccv @ Xs1))) @ XC))) => (Xph => (cwcel @ XC @ (ccfv @ XX @ ccmre))))))))).
