...
thf(avdwapfval_thm,axiom,(! [XK:($i > $o)] : ((cwcel @ XK @ ccn0) => ((ccfv @ XK @ ccvdwa) = (ccmpt2 @ (^ [Xa:$i] : (^ [Xd:$i] : ccn)) @ (^ [Xa:$i] : (^ [Xd:$i] : ccn)) @ (^ [Xa:$i] : (^ [Xd:$i] : (ccrn @ (ccmpt @ (^ [Xm:$i] : (cco @ ccc0 @ (cco @ XK @ cc1 @ ccmin) @ ccfz)) @ (^ [Xm:$i] : (cco @ (ccv @ Xa) @ (cco @ (ccv @ Xm) @ (ccv @ Xd) @ ccmul) @ ccaddc))))))))))).
...
thf(cvdwapval_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XK @ ccn0) & (cwcel @ XA2 @ ccn) & (cwcel @ XD @ ccn)) => ((cwcel @ XX @ (cco @ XA2 @ XD @ (ccfv @ XK @ ccvdwa))) <=> (cwrex @ (^ [Xm:$i] : (XX = (cco @ XA2 @ (cco @ (ccv @ Xm) @ XD @ ccmul) @ ccaddc))) @ (^ [Xm:$i] : (cco @ ccc0 @ (cco @ XK @ cc1 @ ccmin) @ ccfz)))))))))).
