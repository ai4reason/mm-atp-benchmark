...
thf(cjm2_17c_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccn)) => (cwbr @ (cco @ XA2 @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc1 @ ccaddc) @ ccrmy) @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ cclt))))).
