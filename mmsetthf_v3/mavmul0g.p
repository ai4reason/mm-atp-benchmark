...
thf(amavmul0_thm,axiom,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((Xc_x = (cco @ XR @ (ccop @ XN @ XN) @ ccmvmul)) => (((XN = cc0) & (cwcel @ XR @ XV)) => ((cco @ cc0 @ cc0 @ Xc_x) = cc0)))))))).
...
thf(cmavmul0g_conj,conjecture,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_x = (cco @ XR @ (ccop @ XN @ XN) @ ccmvmul)) => (((XN = cc0) & (cwcel @ XR @ XV)) => ((cco @ XX @ XY @ Xc_x) = cc0)))))))))).
