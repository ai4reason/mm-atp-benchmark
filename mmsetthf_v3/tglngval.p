...
thf(ctglngval_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((! [Xz:$i] : ((XL @ Xz) = (ccfv @ XG @ cclng))) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XX @ XP)) => ((Xph => (cwcel @ XY @ XP)) => ((Xph => (XX != XY)) => (! [Xz:$i] : (Xph => ((cco @ XX @ XY @ (XL @ Xz)) = (ccrab @ (^ [Xz:$i] : ((cwcel @ (ccv @ Xz) @ (cco @ XX @ XY @ XI)) | (cwcel @ XX @ (cco @ (ccv @ Xz) @ XY @ XI)) | (cwcel @ XY @ (cco @ XX @ (ccv @ Xz) @ XI)))) @ (^ [Xz:$i] : XP)))))))))))))))))))).
