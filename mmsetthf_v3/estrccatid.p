...
thf(cestrccatid_conj,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : ((XC = (ccfv @ XU @ ccestrc)) => ((cwcel @ XU @ XV) => ((cwcel @ XC @ cccat) & ((ccfv @ XC @ cccid) = (ccmpt @ (^ [Xx3:$i] : XU) @ (^ [Xx3:$i] : (ccres @ ccid @ (ccfv @ (ccv @ Xx3) @ ccbs)))))))))))).
