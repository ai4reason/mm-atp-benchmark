...
thf(axkotop_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XR @ cctop) & (cwcel @ XS @ cctop)) => (cwcel @ (cco @ XS @ XR @ ccxko) @ cctop))))).
...
thf(axkouni_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (cco @ XS @ XR @ ccxko)) => (((cwcel @ XR @ cctop) & (cwcel @ XS @ cctop)) => ((cco @ XR @ XS @ cccn) = (ccuni @ XJ)))))))).
...
thf(cxkohaus_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XR @ cctop) & (cwcel @ XS @ ccha)) => (cwcel @ (cco @ XS @ XR @ ccxko) @ ccha))))).
