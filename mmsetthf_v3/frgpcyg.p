...
thf(a_0frgp_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((XG = (ccfv @ cc0 @ ccfrgp)) => ((XB2 = (ccfv @ XG @ ccbs)) => (cwbr @ XB2 @ cc1o @ ccen)))))).
thf(ccc0_tp,type,(ccc0 : ($i > $o))).
thf(a_0cyg_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ ccgrp) & (cwbr @ XB2 @ cc1o @ ccen)) => (cwcel @ XG @ cccyg)))))).
...
thf(afrgpup3_thm,axiom,(! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XG = (ccfv @ XI @ ccfrgp)) => ((XB2 = (ccfv @ XH @ ccbs)) => ((XU = (ccfv @ XI @ ccvrgp)) => (((cwcel @ XH @ ccgrp) & (cwcel @ XI @ XV) & (cwf @ XI @ XB2 @ XF)) => (cwreu @ (^ [Xm:$i] : ((cccom @ (ccv @ Xm) @ XU) = XF)) @ (^ [Xm:$i] : (cco @ XG @ XH @ ccghm))))))))))))))).
...
thf(acygabl_thm,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ cccyg) => (cwcel @ XG @ ccabl)))).
...
thf(afrgpnabl_thm,axiom,(! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XG = (ccfv @ XI @ ccfrgp)) => ((cwbr @ cc1o @ XI @ ccsdm) => (~ (cwcel @ XG @ ccabl))))))).
