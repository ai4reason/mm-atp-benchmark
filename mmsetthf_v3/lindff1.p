...
thf(alindfind2_thm,axiom,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((XK = (ccfv @ XW @ cclspn)) => ((XL = (ccfv @ XW @ ccsca)) => ((((cwcel @ XW @ cclmod) & (cwcel @ XL @ ccnzr)) & (cwbr @ XF @ XW @ cclindf) & (cwcel @ XE @ (ccdm @ XF))) => (~ (cwcel @ (ccfv @ XE @ XF) @ (ccfv @ (ccima @ XF @ (ccdif @ (ccdm @ XF) @ (ccsn @ XE))) @ XK)))))))))))).
...
thf(clindff1_conj,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XL = (ccfv @ XW @ ccsca)) => (((cwcel @ XW @ cclmod) & (cwcel @ XL @ ccnzr) & (cwbr @ XF @ XW @ cclindf)) => (cwf1 @ (ccdm @ XF) @ XB2 @ XF))))))))).
