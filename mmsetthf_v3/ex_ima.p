...
thf(aex_res_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((XF = (ccpr @ (ccop @ cc2 @ cc6) @ (ccop @ cc3 @ cc9))) & (XB2 = (ccpr @ cc1 @ cc2))) => ((ccres @ XF @ XB2) = (ccsn @ (ccop @ cc2 @ cc6))))))).
...
thf(cex_ima_conj,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((XF = (ccpr @ (ccop @ cc2 @ cc6) @ (ccop @ cc3 @ cc9))) & (XB2 = (ccpr @ cc1 @ cc2))) => ((ccima @ XF @ XB2) = (ccsn @ cc6)))))).
