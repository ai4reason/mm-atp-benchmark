...
thf(clmclim_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((XZ = (ccfv @ XM @ ccuz)) => (((cwcel @ XM @ ccz) & (cwss @ XZ @ (ccdm @ XF))) => ((cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) <=> ((cwcel @ XF @ (cco @ ccc @ ccc @ ccpm)) & (cwbr @ XF @ XP @ ccli)))))))))))).
