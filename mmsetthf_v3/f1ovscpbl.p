...
thf(cf1ovscpbl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwf1o @ XV @ XX @ XF)) => ((Xph & ((cwcel @ XA2 @ XK) & (cwcel @ XB2 @ XV) & (cwcel @ XC @ XV))) => (((ccfv @ XB2 @ XF) = (ccfv @ XC @ XF)) => ((ccfv @ (cco @ XA2 @ XB2 @ Xc_pl) @ XF) = (ccfv @ (cco @ XA2 @ XC @ Xc_pl) @ XF))))))))))))))).
