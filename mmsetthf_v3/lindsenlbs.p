...
thf(clindsenlbs_conj,conjecture,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XR @ ccdr) & (cwcel @ XI @ ccfn) & (cwcel @ XX @ (ccfv @ (cco @ XR @ XI @ ccfrlm) @ cclinds))) & (cwbr @ XX @ XI @ ccen)) => (cwcel @ XX @ (ccfv @ (cco @ XR @ XI @ ccfrlm) @ cclbs))))))).
