...
thf(a_2sb5_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xz:$i] : (! [Xw:$i] : (((^ [Xx3:$i] : ((^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)) @ Xw)) @ Xz) <=> (? [Xx3:$i] : (? [Xy1:$i] : ((((ccv @ Xx3) = (ccv @ Xz)) & ((ccv @ Xy1) = (ccv @ Xw))) & (Xph @ Xx3 @ Xy1 @ Xz @ Xw))))))))).
thf(copelopabsbALT_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xz:$i] : (! [Xw:$i] : ((cwcel @ (ccop @ (ccv @ Xz) @ (ccv @ Xw)) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw))))) <=> ((^ [Xy1:$i] : ((^ [Xx3:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)) @ Xz)) @ Xw)))))).
