...
thf(atrfil2_thm,axiom,(! [XA2:($i > $o)] : (! [XL:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XL @ (ccfv @ XY @ ccfil)) & (cwss @ XA2 @ XY)) => ((cwcel @ (cco @ XL @ XA2 @ ccrest) @ (ccfv @ XA2 @ ccfil)) <=> (cwral @ (^ [Xv:$i] : ((ccin @ (ccv @ Xv) @ XA2) != cc0)) @ (^ [Xv:$i] : XL)))))))).
...
thf(aelfilss_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XF @ (ccfv @ XX @ ccfil)) & (cwss @ XA2 @ XX)) => ((cwcel @ XA2 @ XF) <=> (cwrex @ (^ [Xt:$i] : (cwss @ (ccv @ Xt) @ XA2)) @ (^ [Xt:$i] : XF)))))))).
thf(ctrfil3_conj,conjecture,(! [XA2:($i > $o)] : (! [XL:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XL @ (ccfv @ XY @ ccfil)) & (cwss @ XA2 @ XY)) => ((cwcel @ (cco @ XL @ XA2 @ ccrest) @ (ccfv @ XA2 @ ccfil)) <=> (~ (cwcel @ (ccdif @ XY @ XA2) @ XL)))))))).
