...
thf(ci1fpos_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ XF) @ ccle) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0))))) => (! [Xx3:$i] : ((cwcel @ XF @ (ccdm @ ccitg1)) => (cwcel @ (XG @ Xx3) @ (ccdm @ ccitg1)))))))).
