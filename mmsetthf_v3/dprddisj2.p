...
thf(aeldprd_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [Xc_0:($i > ($i > ($i > ($i > $o))))] : ((! [Xf1:$i] : (! [Xh:$i] : (! [Xi:$i] : ((Xc_0 @ Xf1 @ Xh @ Xi) = (ccfv @ XG @ cc0g))))) => ((! [Xf1:$i] : (! [Xh:$i] : (! [Xi:$i] : ((XW @ Xf1 @ Xh @ Xi) = (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ (Xc_0 @ Xf1 @ Xh @ Xi) @ ccfsupp)) @ (^ [Xh:$i] : (ccixp @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XS))))))))) => (! [Xh:$i] : (! [Xi:$i] : (((ccdm @ XS) = XI) => ((cwcel @ (XA2 @ Xh @ Xi) @ (cco @ XG @ XS @ ccdprd)) <=> ((cwbr @ XG @ XS @ (ccdm @ ccdprd)) & (cwrex @ (^ [Xf1:$i] : ((XA2 @ Xh @ Xi) = (cco @ XG @ (ccv @ Xf1) @ ccgsu))) @ (^ [Xf1:$i] : (XW @ Xf1 @ Xh @ Xi))))))))))))))))).
...
thf(admdprdsplitlem_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xi:$i] : ((Xc_0 @ Xi) = (ccfv @ XG @ cc0g))) => ((! [Xh:$i] : (! [Xi:$i] : ((XW @ Xh @ Xi) = (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ (Xc_0 @ Xi) @ ccfsupp)) @ (^ [Xh:$i] : (ccixp @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XS)))))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwbr @ XG @ XS @ (ccdm @ ccdprd))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => ((ccdm @ XS) = XI)))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwss @ XA2 @ XI)))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwcel @ (XF @ Xi) @ (XW @ Xh @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwcel @ (cco @ XG @ (XF @ Xi) @ ccgsu) @ (cco @ XG @ (ccres @ XS @ XA2) @ ccdprd))))) => (! [Xh:$i] : (! [Xi:$i] : (((Xph @ Xh @ Xi) & (cwcel @ (XX @ Xh @ Xi) @ (ccdif @ XI @ XA2))) => ((ccfv @ (XX @ Xh @ Xi) @ (XF @ Xi)) = (Xc_0 @ Xi)))))))))))))))))))))).
...
thf(cdprddisj2_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xph => (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((Xph => ((ccdm @ XS) = XI)) => ((Xph => (cwss @ XC @ XI)) => ((Xph => (cwss @ XD @ XI)) => ((Xph => ((ccin @ XC @ XD) = cc0)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (Xph => ((ccin @ (cco @ XG @ (ccres @ XS @ XC) @ ccdprd) @ (cco @ XG @ (ccres @ XS @ XD) @ ccdprd)) = (ccsn @ Xc_0))))))))))))))))).
