...
thf(cpjdsi_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => (((cwcel @ XA2 @ (cco @ XG @ XH @ cchj)) & (cwss @ XG @ (ccfv @ XH @ ccort))) => (XA2 = (cco @ (ccfv @ XA2 @ (ccfv @ XG @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccva))))))))).
