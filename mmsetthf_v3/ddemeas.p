...
thf(addeval0_thm,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccr) & (~ (cwcel @ ccc0 @ XA2))) => ((ccfv @ XA2 @ ccdde) = ccc0)))).
...
thf(addeval1_thm,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccr) & (cwcel @ ccc0 @ XA2)) => ((ccfv @ XA2 @ ccdde) = cc1)))).
