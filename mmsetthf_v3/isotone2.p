...
thf(cisotone2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : ((cwss @ (ccv @ Xa) @ (ccv @ Xb)) => (cwss @ (ccfv @ (ccv @ Xa) @ XF) @ (ccfv @ (ccv @ Xb) @ XF)))) @ (^ [Xb:$i] : (ccpw @ XA2)))) @ (^ [Xa:$i] : (ccpw @ XA2))) <=> (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwss @ (ccfv @ (ccin @ (ccv @ Xa) @ (ccv @ Xb)) @ XF) @ (ccin @ (ccfv @ (ccv @ Xa) @ XF) @ (ccfv @ (ccv @ Xb) @ XF)))) @ (^ [Xb:$i] : (ccpw @ XA2)))) @ (^ [Xa:$i] : (ccpw @ XA2))))))).
