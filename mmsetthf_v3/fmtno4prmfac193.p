...
thf(cfmtno4prmfac193_conj,conjecture,(! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwbr @ XP @ (ccfv @ cc4 @ ccfmtno) @ ccdvds) & (cwbr @ XP @ (ccfv @ (ccfv @ (ccfv @ cc4 @ ccfmtno) @ ccsqrt) @ ccfl) @ ccle)) => (XP = (ccdc @ (ccdc @ cc1 @ cc9) @ cc3))))).
