...
thf(cbl2in_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XD @ (ccfv @ XX @ ccme)) & (cwcel @ XP @ XX) & (cwcel @ XQ @ XX)) & ((cwcel @ XR @ ccr) & (cwbr @ XR @ (cco @ (cco @ XP @ XQ @ XD) @ cc2 @ ccdiv) @ ccle))) => ((ccin @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (cco @ XQ @ XR @ (ccfv @ XD @ ccbl))) = cc0)))))))).
