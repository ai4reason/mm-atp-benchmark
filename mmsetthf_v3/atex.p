...
thf(ahl2at_thm,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((cwcel @ XK @ cchlt) => (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : ((ccv @ Xp) != (ccv @ Xq))) @ (^ [Xq:$i] : XA2))) @ (^ [Xp:$i] : XA2))))))).
...
thf(catex_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((cwcel @ XK @ cchlt) => (XA2 != cc0)))))).
