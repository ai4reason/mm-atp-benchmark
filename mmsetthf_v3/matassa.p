...
thf(amamuvs2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XR @ cccrg)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XF = (cco @ XR @ (ccotp @ XM @ XN @ XO) @ ccmmul)) => ((Xph => (cwcel @ XM @ ccfn)) => ((Xph => (cwcel @ XN @ ccfn)) => ((Xph => (cwcel @ XO @ ccfn)) => ((Xph => (cwcel @ XX @ (cco @ XB2 @ (ccxp @ XM @ XN) @ ccmap))) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XZ @ (cco @ XB2 @ (ccxp @ XN @ XO) @ ccmap))) => (Xph => ((cco @ XX @ (cco @ (ccxp @ (ccxp @ XN @ XO) @ (ccsn @ XY)) @ XZ @ (ccof @ Xc_x)) @ XF) = (cco @ (ccxp @ (ccxp @ XM @ XO) @ (ccsn @ XY)) @ (cco @ XX @ XZ @ XF) @ (ccof @ Xc_x)))))))))))))))))))))))))).
