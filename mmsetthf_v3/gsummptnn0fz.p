...
thf(afsfnn0gsumfsffz_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccfv @ (XG @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (Xc_0 = (ccfv @ (XG @ Xx3) @ cc0g))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XG @ Xx3) @ cccmn))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XF @ (cco @ (XB2 @ Xx3) @ ccn0 @ ccmap)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XS @ ccn0))) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccres @ XF @ (cco @ ccc0 @ XS @ ccfz)))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cwral @ (^ [Xx3:$i] : ((cwbr @ XS @ (ccv @ Xx3) @ cclt) => ((ccfv @ (ccv @ Xx3) @ XF) = Xc_0))) @ (^ [Xx3:$i] : ccn0)) => ((cco @ (XG @ Xx3) @ XF @ ccgsu) = (cco @ (XG @ Xx3) @ (XH @ Xx3) @ ccgsu))))))))))))))))))).
...
thf(cgsummptnn0fz_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : (((? [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X)) => (! [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X))) => ((! [Xk:$i] : (XB2 = (ccfv @ (XG @ Xk) @ ccbs))) => ((! [Xk:$i] : (Xc_0 = (ccfv @ (XG @ Xk) @ cc0g))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XG @ Xk) @ cccmn))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwral @ (^ [Xk:$i] : (cwcel @ (XC @ Xk) @ XB2)) @ (^ [Xk:$i] : ccn0)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XS @ ccn0))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwral @ (^ [Xk:$i] : ((cwbr @ XS @ (ccv @ Xk) @ cclt) => ((XC @ Xk) = Xc_0))) @ (^ [Xk:$i] : ccn0)))) => (! [Xk:$i] : ((Xph @ Xk) => ((cco @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (XC @ Xk))) @ ccgsu) = (cco @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : (cco @ ccc0 @ XS @ ccfz)) @ (^ [Xk:$i] : (XC @ Xk))) @ ccgsu)))))))))))))))))).
