...
thf(atxcls_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XR @ (ccfv @ XX @ cctopon)) & (cwcel @ XS @ (ccfv @ XY @ cctopon))) & ((cwss @ XA2 @ XX) & (cwss @ XB2 @ XY))) => ((ccfv @ (ccxp @ XA2 @ XB2) @ (ccfv @ (cco @ XR @ XS @ cctx) @ cccl)) = (ccxp @ (ccfv @ XA2 @ (ccfv @ XR @ cccl)) @ (ccfv @ XB2 @ (ccfv @ XS @ cccl)))))))))))).
...
thf(acncls2i_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccuni @ XK)) => (((cwcel @ XF @ (cco @ XJ @ XK @ cccn)) & (cwss @ XS @ XY)) => (cwss @ (ccfv @ (ccima @ (cccnv @ XF) @ XS) @ (ccfv @ XJ @ cccl)) @ (ccima @ (cccnv @ XF) @ (ccfv @ XS @ (ccfv @ XK @ cccl)))))))))))).
...
thf(cclssubg_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ XG @ cctopn)) => (((cwcel @ XG @ cctgp) & (cwcel @ XS @ (ccfv @ XG @ ccsubg))) => (cwcel @ (ccfv @ XS @ (ccfv @ XJ @ cccl)) @ (ccfv @ XG @ ccsubg)))))))).
