...
thf(advdsmod_thm,axiom,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XP @ ccn) & (cwcel @ XN @ ccn) & (cwcel @ XK @ ccz)) & (cwbr @ XP @ XN @ ccdvds)) => ((cwbr @ XP @ (cco @ XK @ XN @ ccmo) @ ccdvds) <=> (cwbr @ XP @ XK @ ccdvds))))))).
...
thf(clgsdir2lem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ ccz) & (cwbr @ cc2 @ (cco @ XK @ cc1 @ ccaddc) @ ccdvds) & (((cwcel @ XA2 @ ccz) & (~ (cwbr @ cc2 @ XA2 @ ccdvds))) => ((cwcel @ (cco @ XA2 @ cc8 @ ccmo) @ (cco @ ccc0 @ XK @ ccfz)) => (cwcel @ (cco @ XA2 @ cc8 @ ccmo) @ XS)))) => ((XM = (cco @ XK @ cc1 @ ccaddc)) => ((XN = (cco @ XM @ cc1 @ ccaddc)) => ((cwcel @ XN @ XS) => ((cwcel @ XN @ ccz) & (cwbr @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccdvds) & (((cwcel @ XA2 @ ccz) & (~ (cwbr @ cc2 @ XA2 @ ccdvds))) => ((cwcel @ (cco @ XA2 @ cc8 @ ccmo) @ (cco @ ccc0 @ XN @ ccfz)) => (cwcel @ (cco @ XA2 @ cc8 @ ccmo) @ XS)))))))))))))).
