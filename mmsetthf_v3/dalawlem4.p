...
thf(adalawlem3_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((((cwcel @ XK @ cchlt) & (cwbr @ (cco @ (cco @ XP @ XS @ Xc_or) @ (cco @ XQ @ XT @ Xc_or) @ Xc_an) @ (cco @ XP @ XQ @ Xc_or) @ Xc_le) & (cwbr @ (cco @ (cco @ XP @ XS @ Xc_or) @ (cco @ XQ @ XT @ Xc_or) @ Xc_an) @ (cco @ XR @ XU @ Xc_or) @ Xc_le)) & ((cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2) & (cwcel @ XR @ XA2)) & ((cwcel @ XS @ XA2) & (cwcel @ XT @ XA2) & (cwcel @ XU @ XA2))) => (cwbr @ (cco @ (cco @ (cco @ XQ @ XT @ Xc_or) @ XP @ Xc_or) @ XS @ Xc_an) @ (cco @ (cco @ (cco @ XQ @ XR @ Xc_or) @ (cco @ XT @ XU @ Xc_or) @ Xc_an) @ (cco @ (cco @ XR @ XP @ Xc_or) @ (cco @ XU @ XS @ Xc_or) @ Xc_an) @ Xc_or) @ Xc_le)))))))))))))))))).
...
thf(cdalawlem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((((cwcel @ XK @ cchlt) & (cwbr @ (cco @ (cco @ XP @ XS @ Xc_or) @ (cco @ XQ @ XT @ Xc_or) @ Xc_an) @ (cco @ XP @ XQ @ Xc_or) @ Xc_le) & (cwbr @ (cco @ (cco @ XP @ XS @ Xc_or) @ (cco @ XQ @ XT @ Xc_or) @ Xc_an) @ (cco @ XR @ XU @ Xc_or) @ Xc_le)) & ((cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2) & (cwcel @ XR @ XA2)) & ((cwcel @ XS @ XA2) & (cwcel @ XT @ XA2) & (cwcel @ XU @ XA2))) => (cwbr @ (cco @ (cco @ (cco @ XP @ XS @ Xc_or) @ XQ @ Xc_or) @ XT @ Xc_an) @ (cco @ (cco @ (cco @ XQ @ XR @ Xc_or) @ (cco @ XT @ XU @ Xc_or) @ Xc_an) @ (cco @ (cco @ XR @ XP @ Xc_or) @ (cco @ XU @ XS @ Xc_or) @ Xc_an) @ Xc_or) @ Xc_le)))))))))))))))))).
