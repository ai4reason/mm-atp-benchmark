...
thf(cidfuval_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : ((! [Xz:$i] : ((XI @ Xz) = (ccfv @ XC @ ccidfu))) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XC @ cccat)) => ((XH = (ccfv @ XC @ cchom)) => (! [Xz:$i] : (Xph => ((XI @ Xz) = (ccop @ (ccres @ ccid @ XB2) @ (ccmpt @ (^ [Xz:$i] : (ccxp @ XB2 @ XB2)) @ (^ [Xz:$i] : (ccres @ ccid @ (ccfv @ (ccv @ Xz) @ XH)))))))))))))))))).
