...
thf(alspsntri_thm,axiom,(! [Xc_pl:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => ((XN = (ccfv @ XW @ cclspn)) => ((Xc_po = (ccfv @ XW @ cclsm)) => (((cwcel @ XW @ cclmod) & (cwcel @ XX @ XV) & (cwcel @ XY @ XV)) => (cwss @ (ccfv @ (ccsn @ (cco @ XX @ XY @ Xc_pl)) @ XN) @ (cco @ (ccfv @ (ccsn @ XX) @ XN) @ (ccfv @ (ccsn @ XY) @ XN) @ Xc_po))))))))))))))).
thf(ccdlemn4a_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_po:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XP = (ccfv @ XW @ (ccfv @ XK @ ccoc))) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xh:$i] : ((XO @ Xh) = (ccmpt @ (^ [Xh:$i] : XT) @ (^ [Xh:$i] : (ccres @ ccid @ XB2))))) => ((! [Xh:$i] : ((XU @ Xh) = (ccfv @ XW @ (ccfv @ XK @ ccdvh)))) => ((! [Xh:$i] : ((XF @ Xh) = (ccrio @ (^ [Xh:$i] : ((ccfv @ XP @ (ccv @ Xh)) = XQ)) @ (^ [Xh:$i] : XT)))) => ((! [Xh:$i] : ((XG @ Xh) = (ccrio @ (^ [Xh:$i] : ((ccfv @ XP @ (ccv @ Xh)) = XR)) @ (^ [Xh:$i] : XT)))) => ((! [Xh:$i] : ((XJ @ Xh) = (ccrio @ (^ [Xh:$i] : ((ccfv @ XQ @ (ccv @ Xh)) = XR)) @ (^ [Xh:$i] : XT)))) => ((! [Xh:$i] : ((XN @ Xh) = (ccfv @ (XU @ Xh) @ cclspn))) => ((! [Xh:$i] : ((Xc_po @ Xh) = (ccfv @ (XU @ Xh) @ cclsm))) => (! [Xh:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le))) & ((cwcel @ XR @ XA2) & (~ (cwbr @ XR @ XW @ Xc_le)))) => (cwss @ (ccfv @ (ccsn @ (ccop @ (XG @ Xh) @ (ccres @ ccid @ XT))) @ (XN @ Xh)) @ (cco @ (ccfv @ (ccsn @ (ccop @ (XF @ Xh) @ (ccres @ ccid @ XT))) @ (XN @ Xh)) @ (ccfv @ (ccsn @ (ccop @ (XJ @ Xh) @ (XO @ Xh))) @ (XN @ Xh)) @ (Xc_po @ Xh)))))))))))))))))))))))))))))))))))).
