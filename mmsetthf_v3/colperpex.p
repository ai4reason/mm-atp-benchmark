...
thf(acolperpexlem3_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (XA2 != XB2)) => ((Xph => (~ (cwcel @ XC @ (cco @ XA2 @ XB2 @ XL)))) => (Xph => (cwrex @ (^ [Xp:$i] : ((cwbr @ (cco @ XA2 @ (ccv @ Xp) @ XL) @ (cco @ XA2 @ XB2 @ XL) @ (ccfv @ XG @ ccperpg)) & (cwrex @ (^ [Xt:$i] : (((cwcel @ (ccv @ Xt) @ (cco @ XA2 @ XB2 @ XL)) | (XA2 = XB2)) & (cwcel @ (ccv @ Xt) @ (cco @ XC @ (ccv @ Xp) @ XI)))) @ (^ [Xt:$i] : XP)))) @ (^ [Xp:$i] : XP))))))))))))))))))))))).
...
thf(ccolperpex_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (XA2 != XB2)) => ((Xph => (cwbr @ XG @ cc2 @ ccstrkgld)) => (Xph => (cwrex @ (^ [Xp:$i] : ((cwbr @ (cco @ XA2 @ (ccv @ Xp) @ XL) @ (cco @ XA2 @ XB2 @ XL) @ (ccfv @ XG @ ccperpg)) & (cwrex @ (^ [Xt:$i] : (((cwcel @ (ccv @ Xt) @ (cco @ XA2 @ XB2 @ XL)) | (XA2 = XB2)) & (cwcel @ (ccv @ Xt) @ (cco @ XC @ (ccv @ Xp) @ XI)))) @ (^ [Xt:$i] : XP)))) @ (^ [Xp:$i] : XP))))))))))))))))))))))).
