...
thf(cdrsdir_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => (((cwcel @ XK @ ccdrs) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => (cwrex @ (^ [Xz:$i] : ((cwbr @ XX @ (ccv @ Xz) @ Xc_le) & (cwbr @ XY @ (ccv @ Xz) @ Xc_le))) @ (^ [Xz:$i] : XB2))))))))))).
