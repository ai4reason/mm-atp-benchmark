...
thf(aisucn2_thm,axiom,(! [Xph:$o] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xs1:$i] : (XU = (cco @ (ccxp @ XX @ XX) @ (XR @ Xs1) @ ccfg))) => ((! [Xy1:$i] : (! [Xr:$i] : ((XV @ Xy1 @ Xr) = (cco @ (ccxp @ (XY @ Xr) @ (XY @ Xr)) @ (XS @ Xr) @ ccfg)))) => ((Xph => (cwcel @ XU @ (ccfv @ XX @ ccust))) => ((! [Xy1:$i] : (! [Xr:$i] : (Xph => (cwcel @ (XV @ Xy1 @ Xr) @ (ccfv @ (XY @ Xr) @ ccust))))) => ((! [Xs1:$i] : (Xph => (cwcel @ (XR @ Xs1) @ (ccfv @ (ccxp @ XX @ XX) @ ccfbas)))) => ((! [Xr:$i] : (Xph => (cwcel @ (XS @ Xr) @ (ccfv @ (ccxp @ (XY @ Xr) @ (XY @ Xr)) @ ccfbas)))) => (! [Xy1:$i] : (! [Xr:$i] : (Xph => ((cwcel @ XF @ (cco @ XU @ (XV @ Xy1 @ Xr) @ ccucn)) <=> ((cwf @ XX @ (XY @ Xr) @ XF) & (cwral @ (^ [Xs1:$i] : (cwrex @ (^ [Xr:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xr)) => (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccv @ Xs1)))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))) @ (^ [Xr:$i] : (XR @ Xs1)))) @ (^ [Xs1:$i] : (XS @ Xr))))))))))))))))))))))).
...
thf(ametust_thm,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico)))))) => (((XX != cc0) & (cwcel @ XD @ (ccfv @ XX @ ccpsmet))) => (cwcel @ (cco @ (ccxp @ XX @ XX) @ XF @ ccfg) @ (ccfv @ XX @ ccust)))))))).
...
thf(ametustfbas_thm,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico)))))) => (((XX != cc0) & (cwcel @ XD @ (ccfv @ XX @ ccpsmet))) => (cwcel @ XF @ (ccfv @ (ccxp @ XX @ XX) @ ccfbas)))))))).
...
thf(aelbl4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) & (cwcel @ XR @ ccrp)) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX))) => ((cwcel @ XB2 @ (cco @ XA2 @ XR @ (ccfv @ XD @ ccbl))) <=> (cwbr @ XB2 @ XA2 @ (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ XR @ ccico))))))))))).
...
thf(aelbl3ps_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) & (cwcel @ XR @ ccxr)) & ((cwcel @ XP @ XX) & (cwcel @ XA2 @ XX))) => ((cwcel @ XA2 @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl))) <=> (cwbr @ (cco @ XA2 @ XP @ XD) @ XR @ cclt))))))))).
