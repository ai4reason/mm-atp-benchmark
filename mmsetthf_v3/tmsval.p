...
thf(ctmsval_conj,conjecture,(! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XM = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XX) @ (ccop @ (ccfv @ ccnx @ ccds) @ XD))) => ((XK = (ccfv @ XD @ cctmt)) => ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => (XK = (cco @ XM @ (ccop @ (ccfv @ ccnx @ ccts) @ (ccfv @ XD @ ccmopn)) @ ccsts)))))))))).
