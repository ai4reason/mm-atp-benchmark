...
thf(acnpimaex_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) & (cwcel @ XA2 @ XK) & (cwcel @ (ccfv @ XP @ XF) @ XA2)) => (cwrex @ (^ [Xx3:$i] : ((cwcel @ XP @ (ccv @ Xx3)) & (cwss @ (ccima @ XF @ (ccv @ Xx3)) @ XA2))) @ (^ [Xx3:$i] : XJ))))))))).
...
thf(aiunopn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XJ:($i > $o)] : (((cwcel @ XJ @ cctop) & (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ XJ)) @ (^ [Xx3:$i] : XA2))) => (cwcel @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XJ)))))).
thf(asubopnmbl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ XA2 @ ccrest)) => (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ XB2 @ XJ)) => (cwcel @ XB2 @ (ccdm @ ccvol)))))))).
...
thf(anulmbl_thm,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccr) & ((ccfv @ XA2 @ ccovol) = ccc0)) => (cwcel @ XA2 @ (ccdm @ ccvol))))).
...
thf(ccnambfre_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwf @ XA2 @ ccr @ XF) & (cwcel @ XA2 @ (ccdm @ ccvol)) & ((ccfv @ (ccdif @ XA2 @ (ccima @ (cccom @ (cccnv @ (cco @ (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ XA2 @ ccrest) @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccnp)) @ ccep) @ (ccsn @ XF))) @ ccovol) = ccc0)) => (cwcel @ XF @ ccmbf))))).
