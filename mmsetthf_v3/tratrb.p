...
thf(ctratrb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwtr @ XA2) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) | (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)) | ((ccv @ Xx3) = (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) & (cwcel @ XB2 @ XA2)) => (cwtr @ XB2))))).
