...
thf(crpmul_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ ccz) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((((cco @ XK @ XM @ ccgcd) = cc1) & ((cco @ XK @ XN @ ccgcd) = cc1)) => ((cco @ XK @ (cco @ XM @ XN @ ccmul) @ ccgcd) = cc1))))))).
