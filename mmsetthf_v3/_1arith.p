...
thf(a_1arithlem3_thm,axiom,(! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xn:$i] : (! [Xp:$i] : ((XM @ Xn @ Xp) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xp:$i] : ccprime) @ (^ [Xp:$i] : (cco @ (ccv @ Xp) @ (ccv @ Xn) @ ccpc)))))))) => (! [Xn:$i] : (! [Xp:$i] : ((cwcel @ XN @ ccn) => (cwf @ ccprime @ ccn0 @ (ccfv @ XN @ (XM @ Xn @ Xp)))))))))).
...
thf(a_1arithlem2_thm,axiom,(! [XP:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xn:$i] : (! [Xp:$i] : ((XM @ Xn @ Xp) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xp:$i] : ccprime) @ (^ [Xp:$i] : (cco @ (ccv @ Xp) @ (ccv @ Xn) @ ccpc)))))))) => (! [Xn:$i] : (! [Xp:$i] : (((cwcel @ XN @ ccn) & (cwcel @ (XP @ Xn) @ ccprime)) => ((ccfv @ (XP @ Xn) @ (ccfv @ XN @ (XM @ Xn @ Xp))) = (cco @ (XP @ Xn) @ XN @ ccpc)))))))))).
...
thf(apc11_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn0) & (cwcel @ XB2 @ ccn0)) => ((XA2 = XB2) <=> (cwral @ (^ [Xp:$i] : ((cco @ (ccv @ Xp) @ XA2 @ ccpc) = (cco @ (ccv @ Xp) @ XB2 @ ccpc))) @ (^ [Xp:$i] : ccprime))))))).
...
thf(a_1arithlem4_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : ((! [Xn:$i] : (! [Xp:$i] : ((XM @ Xn @ Xp) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xp:$i] : ccprime) @ (^ [Xp:$i] : (cco @ (ccv @ Xp) @ (ccv @ Xn) @ ccpc)))))))) => ((! [Xy1:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XG @ Xy1) = (ccmpt @ (^ [Xy1:$i] : ccn) @ (^ [Xy1:$i] : (ccif @ (cwcel @ (ccv @ Xy1) @ ccprime) @ (cco @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xy1) @ (XF @ Xn @ Xp)) @ ccexp) @ cc1))))))) => ((! [Xx3:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xph @ Xx3 @ Xn @ Xp) => (cwf @ ccprime @ ccn0 @ (XF @ Xn @ Xp)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xph @ Xx3 @ Xn @ Xp) => (cwcel @ (XN @ Xy1) @ ccn)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (! [Xq:$i] : (! [Xp:$i] : (((Xph @ Xx3 @ Xn @ Xp) & ((cwcel @ (ccv @ Xq) @ ccprime) & (cwbr @ (XN @ Xy1) @ (ccv @ Xq) @ ccle))) => ((ccfv @ (ccv @ Xq) @ (XF @ Xn @ Xp)) = ccc0))))))) => (! [Xx3:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xph @ Xx3 @ Xn @ Xp) => (cwrex @ (^ [Xx3:$i] : ((XF @ Xn @ Xp) = (ccfv @ (ccv @ Xx3) @ (XM @ Xn @ Xp)))) @ (^ [Xx3:$i] : ccn))))))))))))))))).
...
thf(c_1arith_conj,conjecture,(! [XR:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : ((! [Xn:$i] : (! [Xp:$i] : ((XM @ Xn @ Xp) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xp:$i] : ccprime) @ (^ [Xp:$i] : (cco @ (ccv @ Xp) @ (ccv @ Xn) @ ccpc)))))))) => ((! [Xe:$i] : (! [Xp:$i] : ((XR @ Xe @ Xp) = (ccrab @ (^ [Xe:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xe)) @ ccn) @ ccfn)) @ (^ [Xe:$i] : (cco @ ccn0 @ ccprime @ ccmap)))))) => (! [Xe:$i] : (! [Xn:$i] : (! [Xp:$i] : (cwf1o @ ccn @ (XR @ Xe @ Xp) @ (XM @ Xn @ Xp)))))))))).
