...
thf(aspllen_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XS @ (ccword @ XA2))) => ((Xph => (cwcel @ XF @ (cco @ ccc0 @ XT @ ccfz))) => ((Xph => (cwcel @ XT @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) => ((Xph => (cwcel @ XR @ (ccword @ XA2))) => (Xph => ((ccfv @ (cco @ XS @ (ccotp @ XF @ XT @ XR) @ ccsplice) @ cchash) = (cco @ (ccfv @ XS @ cchash) @ (cco @ (ccfv @ XR @ cchash) @ (cco @ XT @ XF @ ccmin) @ ccmin) @ ccaddc)))))))))))))).
