...
thf(cupgr1elem_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (ccpr @ XB2 @ XC) @ XS))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XB2 @ (XW @ Xx3)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ (ccsn @ (ccpr @ XB2 @ XC)) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2 @ ccle)) @ (^ [Xx3:$i] : (ccdif @ XS @ (ccsn @ cc0))))))))))))))).
