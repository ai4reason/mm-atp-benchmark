...
thf(asmoword_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((((cwfn @ XF @ XA2) & (cwsmo @ XF)) & ((cwcel @ XC @ XA2) & (cwcel @ XD @ XA2))) => ((cwss @ XC @ XD) <=> (cwss @ (ccfv @ XC @ XF) @ (ccfv @ XD @ XF))))))))).
...
thf(ccfcoflem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((? [Xf1:$i] : ((cwf @ XB2 @ XA2 @ (ccv @ Xf1)) & (cwsmo @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2)))) => (cwss @ (ccfv @ XA2 @ cccf) @ (ccfv @ XB2 @ cccf))))))).
