...
thf(cisi1f_conj,conjecture,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ ccitg1)) <=> ((cwcel @ XF @ ccmbf) & ((cwf @ ccr @ ccr @ XF) & (cwcel @ (ccrn @ XF) @ ccfn) & (cwcel @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccdif @ ccr @ (ccsn @ ccc0))) @ ccvol) @ ccr)))))).
