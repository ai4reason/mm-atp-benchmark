...
thf(cpsgnodpmr_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XS = (ccfv @ XD @ ccsymg)) => ((XP = (ccfv @ XS @ ccbs)) => ((XN = (ccfv @ XD @ ccpsgn)) => (((cwcel @ XD @ ccfn) & (cwcel @ XF @ XP) & ((ccfv @ XF @ XN) = (ccneg @ cc1))) => (cwcel @ XF @ (ccdif @ XP @ (ccfv @ XD @ ccevpm))))))))))))).
