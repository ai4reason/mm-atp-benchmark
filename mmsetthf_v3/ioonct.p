...
thf(cioonct_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((XC = (cco @ XA2 @ XB2 @ ccioo)) => (Xph => (~ (cwbr @ XC @ ccom @ ccdom)))))))))))).
