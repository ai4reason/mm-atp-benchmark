...
thf(clindslinindimp2lem1_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (XR = (ccfv @ (XM @ Xx3) @ ccsca))) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccfv @ XR @ ccbs))) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((! [Xx3:$i] : ((XZ @ Xx3) = (ccfv @ (XM @ Xx3) @ cc0g))) => ((! [Xx3:$i] : (! [Xf1:$i] : ((XY @ Xx3 @ Xf1) = (ccfv @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ XR @ ccminusg))))) => ((! [Xx3:$i] : (! [Xf1:$i] : ((XG @ Xx3 @ Xf1) = (ccres @ (ccv @ Xf1) @ (ccdif @ XS @ (ccsn @ (ccv @ Xx3))))))) => (! [Xx3:$i] : (! [Xf1:$i] : ((((cwcel @ XS @ (XV @ Xx3 @ Xf1)) & (cwcel @ (XM @ Xx3) @ cclmod)) & ((cwss @ XS @ (ccfv @ (XM @ Xx3) @ ccbs)) & (cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xf1) @ (cco @ (XB2 @ Xx3) @ XS @ ccmap)))) => (cwcel @ (XY @ Xx3 @ Xf1) @ (XB2 @ Xx3))))))))))))))))))))).
