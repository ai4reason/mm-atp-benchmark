...
thf(cefcvgfsum_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (! [Xn:$i] : ((XF @ Xk @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccsu @ (cco @ ccc0 @ (ccv @ Xn) @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ XA2 @ (ccv @ Xk) @ ccexp) @ (ccfv @ (ccv @ Xk) @ ccfa) @ ccdiv)))))))) => (! [Xk:$i] : (! [Xn:$i] : ((cwcel @ XA2 @ ccc) => (cwbr @ (XF @ Xk @ Xn) @ (ccfv @ XA2 @ cce) @ ccli)))))))).
