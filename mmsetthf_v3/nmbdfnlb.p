...
thf(cnmbdfnlb_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XT @ cclf) & (cwcel @ (ccfv @ XT @ ccnmf) @ ccr) & (cwcel @ XA2 @ cchil)) => (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ ccabs) @ (cco @ (ccfv @ XT @ ccnmf) @ (ccfv @ XA2 @ ccno) @ ccmul) @ ccle))))).
