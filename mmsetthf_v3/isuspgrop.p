...
thf(cisuspgrop_conj,conjecture,(! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XV @ XW) & (cwcel @ XE @ XX)) => ((cwcel @ (ccop @ XV @ XE) @ ccuspgr) <=> (cwf1 @ (ccdm @ XE) @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccfv @ (ccv @ Xp) @ cchash) @ cc2 @ ccle)) @ (^ [Xp:$i] : (ccdif @ (ccpw @ XV) @ (ccsn @ cc0)))) @ XE)))))))).
