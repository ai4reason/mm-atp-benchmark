...
thf(aaomclem8_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ (XA2 @ Xy1) @ ccon0)))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwral @ (^ [Xa:$i] : (((ccv @ Xa) != cc0) => (cwcel @ (ccfv @ (ccv @ Xa) @ (ccv @ Xy1)) @ (ccdif @ (ccin @ (ccpw @ (ccv @ Xa)) @ ccfn) @ (ccsn @ cc0))))) @ (^ [Xa:$i] : (ccpw @ (ccfv @ (XA2 @ Xy1) @ ccr1))))))) => (! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (? [Xb:$i] : (cwwe @ (ccfv @ (XA2 @ Xy1) @ ccr1) @ (ccv @ Xb))))))))))).
...
thf(cdfac11_conj,conjecture,(cwac <=> (! [Xx3:$i] : (? [Xf1:$i] : (cwral @ (^ [Xz:$i] : (((ccv @ Xz) != cc0) => (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xf1)) @ (ccdif @ (ccin @ (ccpw @ (ccv @ Xz)) @ ccfn) @ (ccsn @ cc0))))) @ (^ [Xz:$i] : (ccv @ Xx3))))))).
