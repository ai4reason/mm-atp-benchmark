...
thf(citgoval_conj,conjecture,(! [XS:($i > $o)] : ((cwss @ XS @ ccc) => ((ccfv @ XS @ ccitgo) = (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xp:$i] : (((ccfv @ (ccv @ Xx3) @ (ccv @ Xp)) = ccc0) & ((ccfv @ (ccfv @ (ccv @ Xp) @ ccdgr) @ (ccfv @ (ccv @ Xp) @ cccoe)) = cc1))) @ (^ [Xp:$i] : (ccfv @ XS @ ccply)))) @ (^ [Xx3:$i] : ccc)))))).
