...
thf(aelunitrn_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccicc)) => (cwcel @ XA2 @ ccr)))).
...
thf(axrge0iifcv_thm,axiom,(! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = ccc0) @ ccpnf @ (ccneg @ (ccfv @ (ccv @ Xx3) @ cclog))))))) => (! [Xx3:$i] : ((cwcel @ XX @ (cco @ ccc0 @ cc1 @ ccioc)) => ((ccfv @ XX @ (XF @ Xx3)) = (ccneg @ (ccfv @ XX @ cclog))))))))).
...
thf(cxrge0iifiso_conj,conjecture,(! [XF:($i > $o)] : ((XF = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = ccc0) @ ccpnf @ (ccneg @ (ccfv @ (ccv @ Xx3) @ cclog)))))) => (cwiso @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ ccc0 @ ccpnf @ ccicc) @ cclt @ (cccnv @ cclt) @ XF)))).
