...
thf(cbnj556_conj,conjecture,(! [Xet:($i > ($i > ($i > $o)))] : (! [Xsi:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : ((! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xsi @ Xm @ Xn @ Xp) <=> ((cwcel @ (ccv @ Xm) @ (XD @ Xm @ Xn @ Xp)) & ((ccv @ Xn) = (ccsuc @ (ccv @ Xm))) & (cwcel @ (ccv @ Xp) @ (ccv @ Xm))))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xet @ Xm @ Xn @ Xp) <=> (cw_bnj17 @ (cwcel @ (ccv @ Xm) @ (XD @ Xm @ Xn @ Xp)) @ ((ccv @ Xn) = (ccsuc @ (ccv @ Xm))) @ (cwcel @ (ccv @ Xp) @ ccom) @ ((ccv @ Xm) = (ccsuc @ (ccv @ Xp)))))))) => (! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xet @ Xm @ Xn @ Xp) => (Xsi @ Xm @ Xn @ Xp))))))))))).
