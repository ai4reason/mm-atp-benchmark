...
thf(climsupresico_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XM @ ccr)) => ((XZ = (cco @ XM @ ccpnf @ ccico)) => ((Xph => (cwcel @ XF @ XV)) => (Xph => ((ccfv @ (ccres @ XF @ XZ) @ cclsp) = (ccfv @ XF @ cclsp)))))))))))).
