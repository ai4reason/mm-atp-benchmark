...
thf(agam1_thm,axiom,((ccfv @ cc1 @ ccgam) = cc1)).
...
thf(agamp1_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn))) => ((ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ ccgam) = (cco @ (ccfv @ XA2 @ ccgam) @ XA2 @ ccmul))))).
