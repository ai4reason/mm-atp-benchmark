...
thf(affthf1o_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => ((XJ = (ccfv @ XD @ cchom)) => ((Xph => (cwbr @ XF @ XG @ (ccin @ (cco @ XC @ XD @ ccful) @ (cco @ XC @ XD @ ccfth)))) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => (Xph => (cwf1o @ (cco @ XX @ XY @ XH) @ (cco @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ XJ) @ (cco @ XX @ XY @ XG)))))))))))))))))))).
...
thf(acofuval2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (XB2 = (ccfv @ (XC @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwbr @ XF @ XG @ (cco @ (XC @ Xx3 @ Xy1) @ (XD @ Xx3 @ Xy1) @ ccfunc))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwbr @ XH @ XK @ (cco @ (XD @ Xx3 @ Xy1) @ (XE @ Xx3 @ Xy1) @ ccfunc))))) => (Xph => ((cco @ (ccop @ XH @ XK) @ (ccop @ XF @ XG) @ cccofu) = (ccop @ (cccom @ XH @ XF) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cccom @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ XK) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG))))))))))))))))))))).
