...
thf(cswrd0swrd_conj,conjecture,(! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz)) & (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz))) => ((cwcel @ XL @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfz)) => ((cco @ (cco @ XW @ (ccop @ XM @ XN) @ ccsubstr) @ (ccop @ ccc0 @ XL) @ ccsubstr) = (cco @ XW @ (ccop @ XM @ (cco @ XM @ XL @ ccaddc)) @ ccsubstr)))))))))).
