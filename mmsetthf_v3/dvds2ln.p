...
thf(cdvds2ln_conj,conjecture,(! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XI @ ccz) & (cwcel @ XJ @ ccz)) & ((cwcel @ XK @ ccz) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz))) => (((cwbr @ XK @ XM @ ccdvds) & (cwbr @ XK @ XN @ ccdvds)) => (cwbr @ XK @ (cco @ (cco @ XI @ XM @ ccmul) @ (cco @ XJ @ XN @ ccmul) @ ccaddc) @ ccdvds))))))))).
