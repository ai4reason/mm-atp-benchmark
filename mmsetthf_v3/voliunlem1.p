...
thf(cvoliunlem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : ((Xph @ Xi) => (cwf @ ccn @ (ccdm @ ccvol) @ XF))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwdisj @ (^ [Xi:$i] : ccn) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XF))))) => ((! [Xi:$i] : (! [Xn:$i] : ((XH @ Xi @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccin @ (XE @ Xi) @ (ccfv @ (ccv @ Xn) @ XF)) @ ccovol)))))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwss @ (XE @ Xi) @ ccr))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwcel @ (ccfv @ (XE @ Xi) @ ccovol) @ ccr))) => (! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : (((Xph @ Xi) & (cwcel @ (ccv @ Xk) @ ccn)) => (cwbr @ (cco @ (ccfv @ (ccv @ Xk) @ (ccseq @ ccaddc @ (XH @ Xi @ Xn) @ cc1)) @ (ccfv @ (ccdif @ (XE @ Xi) @ (ccuni @ (ccrn @ XF))) @ ccovol) @ ccaddc) @ (ccfv @ (XE @ Xi) @ ccovol) @ ccle))))))))))))))).
