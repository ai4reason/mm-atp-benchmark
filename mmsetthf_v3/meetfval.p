...
thf(aglbfun_thm,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : ((XG = (ccfv @ XK @ ccglb)) => (cwfun @ XG))))).
...
thf(aglbelss_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XG = (ccfv @ XK @ ccglb)) => ((Xph => (cwcel @ XK @ XV)) => ((Xph => (cwcel @ XS @ (ccdm @ XG))) => (Xph => (cwss @ XS @ XB2))))))))))))))).
...
thf(assoprab2_thm,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xx3 @ Xy1 @ Xz) => (Xps @ Xx3 @ Xy1 @ Xz))))) => (cwss @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))) @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xps @ Xx3 @ Xy1 @ Xz)))))))))).
...
thf(adf_meet_ax,axiom,(ccmee = (ccmpt @ (^ [Xp:$i] : ccvv) @ (^ [Xp:$i] : (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (cwbr @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz) @ (ccfv @ (ccv @ Xp) @ ccglb)))))))))).
thf(cmeetfval_conj,conjecture,(! [XG:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_an:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XG @ Xx3 @ Xy1) = (ccfv @ XK @ ccglb)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xc_an @ Xx3 @ Xy1 @ Xz) = (ccfv @ XK @ ccmee))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ XK @ (XV @ Xx3 @ Xy1 @ Xz)) => ((Xc_an @ Xx3 @ Xy1 @ Xz) = (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (cwbr @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz) @ (XG @ Xx3 @ Xy1)))))))))))))))))).
