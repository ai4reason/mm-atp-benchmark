...
thf(aisinitoi_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XO:($i > $o)] : ((! [Xh:$i] : ((XB2 @ Xh) = (ccfv @ XC @ ccbs))) => ((! [Xh:$i] : (! [Xb:$i] : ((XH @ Xh @ Xb) = (ccfv @ XC @ cchom)))) => ((! [Xh:$i] : (! [Xb:$i] : ((Xph @ Xh @ Xb) => (cwcel @ XC @ cccat)))) => (! [Xh:$i] : (! [Xb:$i] : (((Xph @ Xh @ Xb) & (cwcel @ XO @ (ccfv @ XC @ ccinito))) => ((cwcel @ XO @ (XB2 @ Xh)) & (cwral @ (^ [Xb:$i] : (cweu @ (^ [Xh:$i] : (cwcel @ (ccv @ Xh) @ (cco @ XO @ (ccv @ Xb) @ (XH @ Xh @ Xb)))))) @ (^ [Xb:$i] : (XB2 @ Xh)))))))))))))))).
...
thf(cinitoid_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XO:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph & (cwcel @ XO @ (ccfv @ XC @ ccinito))) => ((cco @ XO @ XO @ XH) = (ccsn @ (ccfv @ XO @ (ccfv @ XC @ cccid)))))))))))))).
