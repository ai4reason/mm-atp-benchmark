...
thf(ctfindsg_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XB2) => ((Xph @ Xx3) <=> (Xps @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccsuc @ (ccv @ Xy1))) => ((Xph @ Xx3) <=> (Xth @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XA2 @ Xy1)) => ((Xph @ Xx3) <=> (Xta @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XB2 @ ccon0) => (Xps @ Xx3 @ Xy1)))) => ((! [Xy1:$i] : ((((cwcel @ (ccv @ Xy1) @ ccon0) & (cwcel @ XB2 @ ccon0)) & (cwss @ XB2 @ (ccv @ Xy1))) => ((Xch @ Xy1) => (Xth @ Xy1)))) => ((! [Xx3:$i] : ((((cwlim @ (ccv @ Xx3)) & (cwcel @ XB2 @ ccon0)) & (cwss @ XB2 @ (ccv @ Xx3))) => ((cwral @ (^ [Xy1:$i] : ((cwss @ XB2 @ (ccv @ Xy1)) => (Xch @ Xy1))) @ (^ [Xy1:$i] : (ccv @ Xx3))) => (Xph @ Xx3)))) => (! [Xy1:$i] : ((((cwcel @ (XA2 @ Xy1) @ ccon0) & (cwcel @ XB2 @ ccon0)) & (cwss @ XB2 @ (XA2 @ Xy1))) => (Xta @ Xy1)))))))))))))))))).
