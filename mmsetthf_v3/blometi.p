...
thf(cblometi_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XY = (ccfv @ XW @ ccba)) => ((XC = (ccfv @ XU @ ccims)) => ((XD = (ccfv @ XW @ ccims)) => ((XN = (cco @ XU @ XW @ ccnmoo)) => ((XB2 = (cco @ XU @ XW @ ccblo)) => ((cwcel @ XU @ ccnv) => ((cwcel @ XW @ ccnv) => (((cwcel @ XT @ XB2) & (cwcel @ XP @ XX) & (cwcel @ XQ @ XX)) => (cwbr @ (cco @ (ccfv @ XP @ XT) @ (ccfv @ XQ @ XT) @ XD) @ (cco @ (ccfv @ XT @ XN) @ (cco @ XP @ XQ @ XC) @ ccmul) @ ccle)))))))))))))))))))))).
