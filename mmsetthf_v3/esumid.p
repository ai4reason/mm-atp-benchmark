...
thf(axrge0tsmseq_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XG = (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((Xph => (cwcel @ XC @ (cco @ XG @ XF @ cctsu))) => (Xph => (XC = (ccuni @ (cco @ XG @ XF @ cctsu))))))))))))))).
