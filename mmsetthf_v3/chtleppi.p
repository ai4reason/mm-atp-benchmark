...
thf(appival_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ XA2 @ ccppi) = (ccfv @ (ccin @ (cco @ ccc0 @ XA2 @ ccicc) @ ccprime) @ cchash))))).
...
thf(cchtleppi_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwbr @ (ccfv @ XA2 @ cccht) @ (cco @ (ccfv @ XA2 @ ccppi) @ (ccfv @ XA2 @ cclog) @ ccmul) @ ccle)))).
