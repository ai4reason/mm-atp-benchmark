...
thf(cdfafn5b_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwral @ (^ [Xx3:$i] : (cwcel @ (ccafv @ (ccv @ Xx3) @ XF) @ (XV @ Xx3))) @ (^ [Xx3:$i] : XA2)) => ((cwfn @ XF @ XA2) <=> (XF = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccafv @ (ccv @ Xx3) @ XF)))))))))).
