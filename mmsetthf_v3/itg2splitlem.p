...
thf(ai1fres_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0))))) => (! [Xx3:$i] : (((cwcel @ XF @ (ccdm @ ccitg1)) & (cwcel @ XA2 @ (ccdm @ ccvol))) => (cwcel @ (XG @ Xx3) @ (ccdm @ ccitg1))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(abreqtrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (cwbr @ XA2 @ XB2 @ XR)) => ((Xph => (XB2 = XC)) => (Xph => (cwbr @ XA2 @ XC @ XR)))))))))).
thf(ccmin_tp,type,(ccmin : ($i > $o))).
thf(aitg1lea_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ (ccdm @ ccitg1))) => ((Xph => (cwss @ XA2 @ ccr)) => ((Xph => ((ccfv @ XA2 @ ccovol) = ccc0)) => ((Xph => (cwcel @ XG @ (ccdm @ ccitg1))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ ccr @ XA2))) => (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG) @ ccle))) => (Xph => (cwbr @ (ccfv @ XF @ ccitg1) @ (ccfv @ XG @ ccitg1) @ ccle)))))))))))).
...
thf(aitg1add_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ (ccdm @ ccitg1))) => ((Xph => (cwcel @ XG @ (ccdm @ ccitg1))) => (Xph => ((ccfv @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ ccitg1) = (cco @ (ccfv @ XF @ ccitg1) @ (ccfv @ XG @ ccitg1) @ ccaddc))))))))).
...
thf(aitg2ub_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF) & (cwcel @ XG @ (ccdm @ ccitg1)) & (cwbr @ XG @ XF @ (ccofr @ ccle))) => (cwbr @ (ccfv @ XG @ ccitg1) @ (ccfv @ XF @ ccitg2) @ ccle))))).
