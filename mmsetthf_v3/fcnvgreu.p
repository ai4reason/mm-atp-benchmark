...
thf(afgreu_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwfun @ XF) & (cwcel @ XX @ (ccdm @ XF))) => (cwreu @ (^ [Xp:$i] : (XX = (ccfv @ (ccv @ Xp) @ cc1st))) @ (^ [Xp:$i] : XF)))))).
...
thf(acnvf1olem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwrel @ XA2) & ((cwcel @ XB2 @ XA2) & (XC = (ccuni @ (cccnv @ (ccsn @ XB2)))))) => ((cwcel @ XC @ (cccnv @ XA2)) & (XB2 = (ccuni @ (cccnv @ (ccsn @ XC)))))))))).
