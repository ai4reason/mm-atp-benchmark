...
thf(aevenelz_thm,axiom,(! [XN:($i > $o)] : ((cwbr @ cc2 @ XN @ ccdvds) => (cwcel @ XN @ ccz)))).
...
thf(ceven2n_conj,conjecture,(! [XN:($i > $o)] : ((cwbr @ cc2 @ XN @ ccdvds) <=> (cwrex @ (^ [Xn:$i] : ((cco @ cc2 @ (ccv @ Xn) @ ccmul) = XN)) @ (^ [Xn:$i] : ccz))))).
