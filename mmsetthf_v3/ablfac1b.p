...
thf(aablfacrp_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_po:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XO) @ XM @ ccdvds)) @ (^ [Xx3:$i] : XB2)))) => ((! [Xx3:$i] : ((XL @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XO) @ XN @ ccdvds)) @ (^ [Xx3:$i] : XB2)))) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => ((cco @ XM @ XN @ ccgcd) = cc1)) => ((Xph => ((ccfv @ XB2 @ cchash) = (cco @ XM @ XN @ ccmul))) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((! [Xx3:$i] : ((Xc_po @ Xx3) = (ccfv @ XG @ cclsm))) => (! [Xx3:$i] : (Xph => (((ccin @ (XK @ Xx3) @ (XL @ Xx3)) = (ccsn @ Xc_0)) & ((cco @ (XK @ Xx3) @ (XL @ Xx3) @ (Xc_po @ Xx3)) = XB2)))))))))))))))))))))))))).
thf(asimp2d_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps & Xch & Xth)) => (Xph => Xch))))))).
thf(cablfac1b_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((! [Xx3:$i] : (! [Xp:$i] : ((XS @ Xx3 @ Xp) = (ccmpt @ (^ [Xp:$i] : XA2) @ (^ [Xp:$i] : (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XO) @ (cco @ (ccv @ Xp) @ (cco @ (ccv @ Xp) @ (ccfv @ XB2 @ cchash) @ ccpc) @ ccexp) @ ccdvds)) @ (^ [Xx3:$i] : XB2))))))) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XB2 @ ccfn)) => ((Xph => (cwss @ XA2 @ ccprime)) => (! [Xx3:$i] : (! [Xp:$i] : (Xph => (cwbr @ XG @ (XS @ Xx3 @ Xp) @ (ccdm @ ccdprd)))))))))))))))))).
