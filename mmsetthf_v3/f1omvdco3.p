...
thf(af1omvdco2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (((cwf1o @ XA2 @ XA2 @ XF) & (cwf1o @ XA2 @ XA2 @ XG) & (~ ((cwss @ (ccdm @ (ccdif @ XF @ ccid)) @ XX) <=> (cwss @ (ccdm @ (ccdif @ XG @ ccid)) @ XX)))) => (~ (cwss @ (ccdm @ (ccdif @ (cccom @ XF @ XG) @ ccid)) @ XX)))))))).
thf(acon2bii_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph <=> (~ Xps)) => (Xps <=> (~ Xph)))))).
thf(cf1omvdco3_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (((cwf1o @ XA2 @ XA2 @ XF) & (cwf1o @ XA2 @ XA2 @ XG) & (~ ((cwcel @ XX @ (ccdm @ (ccdif @ XF @ ccid))) <=> (cwcel @ XX @ (ccdm @ (ccdif @ XG @ ccid)))))) => (cwcel @ XX @ (ccdm @ (ccdif @ (cccom @ XF @ XG) @ ccid))))))))).
