...
thf(crusgrpropnb_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xv:$i] : ((XV @ Xv) = (ccfv @ XG @ ccvtx))) => ((cwbr @ XG @ XK @ ccrusgr) => ((cwcel @ XG @ ccusgr) & (cwcel @ XK @ ccxnn0) & (cwral @ (^ [Xv:$i] : ((ccfv @ (cco @ XG @ (ccv @ Xv) @ ccnbgr) @ cchash) = XK)) @ (^ [Xv:$i] : (XV @ Xv)))))))))).
