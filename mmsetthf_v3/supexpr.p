...
thf(asuplem1pr_thm,axiom,(! [XA2:($i > $o)] : (((XA2 != cc0) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccltp)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccnp))) => (cwcel @ (ccuni @ XA2) @ ccnp)))).
...
thf(asuplem2pr_thm,axiom,(! [Xy1:$i] : (! [XA2:($i > $o)] : ((cwss @ XA2 @ ccnp) => (((cwcel @ (ccv @ Xy1) @ XA2) => (~ (cwbr @ (ccuni @ XA2) @ (ccv @ Xy1) @ ccltp))) & ((cwbr @ (ccv @ Xy1) @ (ccuni @ XA2) @ ccltp) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccltp)) @ (^ [Xz:$i] : XA2)))))))).
...
thf(csupexpr_conj,conjecture,(! [XA2:($i > $o)] : (((XA2 != cc0) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccltp)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccnp))) => (cwrex @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccltp))) @ (^ [Xy1:$i] : XA2)) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccltp) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccltp)) @ (^ [Xz:$i] : XA2)))) @ (^ [Xy1:$i] : ccnp)))) @ (^ [Xx3:$i] : ccnp))))).
