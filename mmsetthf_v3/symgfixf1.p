...
thf(asymgfixf_thm,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XP = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((XQ = (ccrab @ (^ [Xq:$i] : ((ccfv @ XK @ (ccv @ Xq)) = XK)) @ (^ [Xq:$i] : XP))) => ((XS = (ccfv @ (ccfv @ (ccdif @ XN @ (ccsn @ XK)) @ ccsymg) @ ccbs)) => ((! [Xq:$i] : ((XH @ Xq) = (ccmpt @ (^ [Xq:$i] : XQ) @ (^ [Xq:$i] : (ccres @ (ccv @ Xq) @ (ccdif @ XN @ (ccsn @ XK))))))) => (! [Xq:$i] : ((cwcel @ XK @ XN) => (cwf @ XQ @ XS @ (XH @ Xq))))))))))))))).
...
thf(afvreseq_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xx3:$i] : ((((cwfn @ XF @ (XA2 @ Xx3)) & (cwfn @ XG @ (XA2 @ Xx3))) & (cwss @ XB2 @ (XA2 @ Xx3))) => (((ccres @ XF @ XB2) = (ccres @ XG @ XB2)) <=> (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xx3) @ XG))) @ (^ [Xx3:$i] : XB2)))))))))).
...
thf(csymgfixf1_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XP = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((XQ = (ccrab @ (^ [Xq:$i] : ((ccfv @ XK @ (ccv @ Xq)) = XK)) @ (^ [Xq:$i] : XP))) => ((XS = (ccfv @ (ccfv @ (ccdif @ XN @ (ccsn @ XK)) @ ccsymg) @ ccbs)) => ((! [Xq:$i] : ((XH @ Xq) = (ccmpt @ (^ [Xq:$i] : XQ) @ (^ [Xq:$i] : (ccres @ (ccv @ Xq) @ (ccdif @ XN @ (ccsn @ XK))))))) => (! [Xq:$i] : ((cwcel @ XK @ XN) => (cwf1 @ XQ @ XS @ (XH @ Xq))))))))))))))).
