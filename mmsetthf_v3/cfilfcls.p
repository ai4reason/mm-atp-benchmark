...
thf(adf_cfil_ax,axiom,(cccfil = (ccmpt @ (^ [Xd:$i] : (ccuni @ (ccrn @ ccxmt))) @ (^ [Xd:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (ccima @ (ccv @ Xd) @ (ccxp @ (ccv @ Xy1) @ (ccv @ Xy1))) @ (cco @ ccc0 @ (ccv @ Xx3) @ ccico))) @ (^ [Xy1:$i] : (ccv @ Xf1)))) @ (^ [Xx3:$i] : ccrp))) @ (^ [Xf1:$i] : (ccfv @ (ccdm @ (ccdm @ (ccv @ Xd))) @ ccfil))))))).
...
thf(acfil3i_thm,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XF @ (ccfv @ XD @ cccfil)) & (cwcel @ XR @ ccrp)) => (cwrex @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ XR @ (ccfv @ XD @ ccbl)) @ XF)) @ (^ [Xx3:$i] : XX)))))))).
...
thf(ccfilfcls_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((XX = (ccdm @ (ccdm @ XD))) => ((cwcel @ XF @ (ccfv @ XD @ cccfil)) => ((cco @ XJ @ XF @ ccfcls) = (cco @ XJ @ XF @ ccflim)))))))))).
