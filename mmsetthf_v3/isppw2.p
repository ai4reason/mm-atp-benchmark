...
thf(aisppw_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => (((ccfv @ XA2 @ ccvma) != ccc0) <=> (cwreu @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XA2 @ ccdvds)) @ (^ [Xp:$i] : ccprime)))))).
...
thf(cisppw2_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => (((ccfv @ XA2 @ ccvma) != ccc0) <=> (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xk:$i] : (XA2 = (cco @ (ccv @ Xp) @ (ccv @ Xk) @ ccexp))) @ (^ [Xk:$i] : ccn))) @ (^ [Xp:$i] : ccprime)))))).
