...
thf(crusgrpropadjvtx_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xv:$i] : ((XV @ Xv) = (ccfv @ XG @ ccvtx))) => (! [Xk:$i] : ((cwbr @ XG @ (XK @ Xk) @ ccrusgr) => ((cwcel @ XG @ ccusgr) & (cwcel @ (XK @ Xk) @ ccxnn0) & (cwral @ (^ [Xv:$i] : ((ccfv @ (ccrab @ (^ [Xk:$i] : (cwcel @ (ccpr @ (ccv @ Xv) @ (ccv @ Xk)) @ (ccfv @ XG @ ccedg))) @ (^ [Xk:$i] : (XV @ Xv))) @ cchash) = (XK @ Xk))) @ (^ [Xv:$i] : (XV @ Xv))))))))))).
