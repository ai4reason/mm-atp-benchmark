...
thf(acosordlem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ (cco @ ccc0 @ ccpi @ ccicc))) => ((Xph => (cwcel @ XB2 @ (cco @ ccc0 @ ccpi @ ccicc))) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => (Xph => (cwbr @ (ccfv @ XB2 @ cccos) @ (ccfv @ XA2 @ cccos) @ cclt))))))))).
...
thf(ccosord_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ ccpi @ ccicc)) & (cwcel @ XB2 @ (cco @ ccc0 @ ccpi @ ccicc))) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (ccfv @ XB2 @ cccos) @ (ccfv @ XA2 @ cccos) @ cclt)))))).
