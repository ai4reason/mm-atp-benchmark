...
thf(a_3exbidv_thm,axiom,(! [Xph:$o] : (! [Xps:($i > ($i > ($i > $o)))] : (! [Xch:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => ((Xps @ Xx3 @ Xy1 @ Xz) <=> (Xch @ Xx3 @ Xy1 @ Xz)))))) => (Xph => ((? [Xx3:$i] : (? [Xy1:$i] : (? [Xz:$i] : (Xps @ Xx3 @ Xy1 @ Xz)))) <=> (? [Xx3:$i] : (? [Xy1:$i] : (? [Xz:$i] : (Xch @ Xx3 @ Xy1 @ Xz))))))))))).
...
thf(celoprabi_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [Xch:($i > ($i > ($i > $o)))] : (! [Xth:$o] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccfv @ (ccfv @ XA2 @ cc1st) @ cc1st)) => ((Xph @ Xx3 @ Xy1 @ Xz) <=> (Xps @ Xx3 @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccfv @ (ccfv @ XA2 @ cc1st) @ cc2nd)) => ((Xps @ Xx3 @ Xy1 @ Xz) <=> (Xch @ Xx3 @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xz) = (ccfv @ XA2 @ cc2nd)) => ((Xch @ Xx3 @ Xy1 @ Xz) <=> Xth))))) => ((cwcel @ XA2 @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))))) => Xth)))))))))).
