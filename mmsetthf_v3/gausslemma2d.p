...
thf(agausslemma2dlem7_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XH = (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((! [Xx3:$i] : ((XR @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XH @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ cc2 @ ccdiv) @ cclt) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ ccmin)))))) => ((XM = (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => ((! [Xx3:$i] : ((XN @ Xx3) = (cco @ XH @ XM @ ccmin))) => (! [Xx3:$i] : (Xph => ((cco @ (cco @ (cco @ (ccneg @ cc1) @ (XN @ Xx3) @ ccexp) @ (cco @ cc2 @ XH @ ccexp) @ ccmul) @ XP @ ccmo) = cc1))))))))))))))).
...
thf(am1expeven_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cco @ (ccneg @ cc1) @ (cco @ cc2 @ XN @ ccmul) @ ccexp) = cc1)))).
...
thf(algsvalmod_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((cco @ (cco @ XA2 @ XP @ cclgs) @ XP @ ccmo) = (cco @ (cco @ XA2 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ XP @ ccmo)))))).
thf(cc3_tp,type,(cc3 : ($i > $o))).
thf(cctp_tp,type,(cctp : (($i > $o) > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(agausslemma2dlem0i_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XM = (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => ((XH = (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((XN = (cco @ XH @ XM @ ccmin)) => (Xph => (((cco @ (cco @ cc2 @ XP @ cclgs) @ XP @ ccmo) = (cco @ (cco @ (ccneg @ cc1) @ XN @ ccexp) @ XP @ ccmo)) => ((cco @ cc2 @ XP @ cclgs) = (cco @ (ccneg @ cc1) @ XN @ ccexp)))))))))))))).
thf(cgausslemma2d_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XH = (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((! [Xx3:$i] : ((XR @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XH @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ cc2 @ ccdiv) @ cclt) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ ccmin)))))) => ((XM = (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => ((! [Xx3:$i] : ((XN @ Xx3) = (cco @ XH @ XM @ ccmin))) => (! [Xx3:$i] : (Xph => ((cco @ cc2 @ XP @ cclgs) = (cco @ (ccneg @ cc1) @ (XN @ Xx3) @ ccexp)))))))))))))))).
