...
thf(aramubcl_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XM @ ccn0) & (cwcel @ XR @ XV) & (cwf @ XR @ ccn0 @ XF)) & ((cwcel @ XA2 @ ccn0) & (cwbr @ (cco @ XM @ XF @ ccram) @ XA2 @ ccle))) => (cwcel @ (cco @ XM @ XF @ ccram) @ ccn0)))))))).
...
thf(aramxrcl_thm,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XM @ ccn0) & (cwcel @ XR @ XV) & (cwf @ XR @ ccn0 @ XF)) => (cwcel @ (cco @ XM @ XF @ ccram) @ ccxr))))))).
