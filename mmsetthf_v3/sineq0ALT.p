...
thf(aabssinper_thm,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XK @ ccz)) => ((ccfv @ (ccfv @ (cco @ XA2 @ (cco @ XK @ ccpi @ ccmul) @ ccaddc) @ ccsin) @ ccabs) = (ccfv @ (ccfv @ XA2 @ ccsin) @ ccabs)))))).
...
thf(asinq12gt0_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ ccpi @ ccioo)) => (cwbr @ ccc0 @ (ccfv @ XA2 @ ccsin) @ cclt)))).
...
thf(csineq0ALT_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (((ccfv @ XA2 @ ccsin) = ccc0) <=> (cwcel @ (cco @ XA2 @ ccpi @ ccdiv) @ ccz))))).
