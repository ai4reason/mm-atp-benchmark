...
thf(aisppw2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => (((ccfv @ XA2 @ ccvma) != ccc0) <=> (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xk:$i] : (XA2 = (cco @ (ccv @ Xp) @ (ccv @ Xk) @ ccexp))) @ (^ [Xk:$i] : ccn))) @ (^ [Xp:$i] : ccprime)))))).
...
thf(cefvmacl_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => (cwcel @ (ccfv @ (ccfv @ XA2 @ ccvma) @ cce) @ ccn)))).
