...
thf(ahoiqssbllem3_thm,axiom,(! [Xph:$o] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((Xph => (XX != cc0)) => ((Xph => (cwcel @ XY @ (cco @ ccr @ XX @ ccmap))) => ((Xph => (cwcel @ XE @ ccrp)) => (Xph => (cwrex @ (^ [Xc:$i] : (cwrex @ (^ [Xd:$i] : ((cwcel @ XY @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ ccico)))) & (cwss @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ ccico))) @ (cco @ XY @ XE @ (ccfv @ (ccfv @ (ccfv @ XX @ ccrrx) @ ccds) @ ccbl))))) @ (^ [Xd:$i] : (cco @ ccq @ XX @ ccmap)))) @ (^ [Xc:$i] : (cco @ ccq @ XX @ ccmap))))))))))))).
thf(aneqne_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((~ (XA2 = XB2)) => (XA2 != XB2))))).
thf(choiqssbl_conj,conjecture,(! [Xph:$o] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((Xph => (cwcel @ XY @ (cco @ ccr @ XX @ ccmap))) => ((Xph => (cwcel @ XE @ ccrp)) => (Xph => (cwrex @ (^ [Xc:$i] : (cwrex @ (^ [Xd:$i] : ((cwcel @ XY @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ ccico)))) & (cwss @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ ccico))) @ (cco @ XY @ XE @ (ccfv @ (ccfv @ (ccfv @ XX @ ccrrx) @ ccds) @ ccbl))))) @ (^ [Xd:$i] : (cco @ ccq @ XX @ ccmap)))) @ (^ [Xc:$i] : (cco @ ccq @ XX @ ccmap)))))))))))).
