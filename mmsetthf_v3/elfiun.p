...
thf(celfiun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XB2 @ XD) & (cwcel @ XC @ XK)) => ((cwcel @ XA2 @ (ccfv @ (ccun @ XB2 @ XC) @ ccfi)) <=> ((cwcel @ XA2 @ (ccfv @ XB2 @ ccfi)) | (cwcel @ XA2 @ (ccfv @ XC @ ccfi)) | (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (XA2 = (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccfv @ XC @ ccfi)))) @ (^ [Xx3:$i] : (ccfv @ XB2 @ ccfi)))))))))))).
