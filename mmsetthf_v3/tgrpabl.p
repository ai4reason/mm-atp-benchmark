...
thf(atgrpbase_thm,axiom,(! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XG = (ccfv @ XW @ (ccfv @ XK @ cctgrp))) => ((XC = (ccfv @ XG @ ccbs)) => (((cwcel @ XK @ XV) & (cwcel @ XW @ XH)) => (XC = XT)))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(aeqidd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (Xph => (XA2 = XA2))))).
thf(atgrpgrp_thm,axiom,(! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XG = (ccfv @ XW @ (ccfv @ XK @ cctgrp))) => (((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) => (cwcel @ XG @ ccgrp))))))))).
...
thf(atgrpov_thm,axiom,(! [Xc_pl:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XG = (ccfv @ XW @ (ccfv @ XK @ cctgrp))) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (((cwcel @ XK @ XV) & (cwcel @ XW @ XH) & ((cwcel @ XX @ XT) & (cwcel @ XY @ XT))) => ((cco @ XX @ XY @ Xc_pl) = (cccom @ XX @ XY))))))))))))))))).
thf(a_3com23_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps & Xch) => Xth) => ((Xph & Xch & Xps) => Xth))))))).
thf(ctgrpabl_conj,conjecture,(! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XG = (ccfv @ XW @ (ccfv @ XK @ cctgrp))) => (((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) => (cwcel @ XG @ ccabl))))))))).
