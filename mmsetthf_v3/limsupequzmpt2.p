...
thf(alimsupresuz2_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XM @ ccz)) => ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XF @ XV)) => ((Xph => (cwss @ (ccdm @ XF) @ ccz)) => (Xph => ((ccfv @ (ccres @ XF @ XZ) @ cclsp) = (ccfv @ XF @ cclsp))))))))))))).
