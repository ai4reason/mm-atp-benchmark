...
thf(adf_uss_ax,axiom,(ccuss = (ccmpt @ (^ [Xf1:$i] : ccvv) @ (^ [Xf1:$i] : (cco @ (ccfv @ (ccv @ Xf1) @ ccunif) @ (ccxp @ (ccfv @ (ccv @ Xf1) @ ccbs) @ (ccfv @ (ccv @ Xf1) @ ccbs)) @ ccrest))))).
...
thf(cussval_conj,conjecture,(! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XU = (ccfv @ XW @ ccunif)) => ((cco @ XU @ (ccxp @ XB2 @ XB2) @ ccrest) = (ccfv @ XW @ ccuss)))))))).
