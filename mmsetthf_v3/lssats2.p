...
thf(clssats2_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : ((XS @ Xx3) = (ccfv @ (XW @ Xx3) @ cclss))) => ((! [Xx3:$i] : (XN = (ccfv @ (XW @ Xx3) @ cclspn))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XW @ Xx3) @ cclmod))) => ((! [Xx3:$i] : (Xph => (cwcel @ XU @ (XS @ Xx3)))) => (Xph => (XU = (cciun @ (^ [Xx3:$i] : XU) @ (^ [Xx3:$i] : (ccfv @ (ccsn @ (ccv @ Xx3)) @ XN))))))))))))))).
