...
thf(aleibpi_thm,axiom,(! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (ccneg @ cc1) @ (ccv @ Xn) @ ccexp) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))))) => (! [Xn:$i] : (cwbr @ (ccseq @ ccaddc @ (XF @ Xn) @ ccc0) @ (cco @ ccpi @ cc4 @ ccdiv) @ ccli))))).
thf(cleibpisum_conj,conjecture,((ccsu @ ccn0 @ (^ [Xn:$i] : (cco @ (cco @ (ccneg @ cc1) @ (ccv @ Xn) @ ccexp) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))) = (cco @ ccpi @ cc4 @ ccdiv))).
