...
thf(adivnumden2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (cwcel @ (ccneg @ XB2) @ ccn)) => (((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccnumer) = (ccneg @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv))) & ((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccdenom) = (ccneg @ (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv)))))))).
...
thf(cqqhval2lem_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((XL = (ccfv @ XR @ cczrh)) => ((((cwcel @ XR @ ccdr) & ((ccfv @ XR @ ccchr) = ccc0)) & ((cwcel @ XX @ ccz) & (cwcel @ XY @ ccz) & (XY != ccc0))) => ((cco @ (ccfv @ (ccfv @ (cco @ XX @ XY @ ccdiv) @ ccnumer) @ XL) @ (ccfv @ (ccfv @ (cco @ XX @ XY @ ccdiv) @ ccdenom) @ XL) @ Xc_dv) = (cco @ (ccfv @ XX @ XL) @ (ccfv @ XY @ XL) @ Xc_dv))))))))))))).
