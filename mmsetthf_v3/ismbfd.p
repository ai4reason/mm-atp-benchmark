...
thf(cismbfd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (Xph => (cwf @ (XA2 @ Xx3) @ ccr @ XF))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccxr)) => (cwcel @ (ccima @ (cccnv @ XF) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccioo)) @ (ccdm @ ccvol)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccxr)) => (cwcel @ (ccima @ (cccnv @ XF) @ (cco @ ccmnf @ (ccv @ Xx3) @ ccioo)) @ (ccdm @ ccvol)))) => (Xph => (cwcel @ XF @ ccmbf))))))))).
