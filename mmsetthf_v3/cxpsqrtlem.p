...
thf(aefeul_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ cce) = (cco @ (ccfv @ (ccfv @ XA2 @ ccre) @ cce) @ (cco @ (ccfv @ (ccfv @ XA2 @ ccim) @ cccos) @ (cco @ cci @ (ccfv @ (ccfv @ XA2 @ ccim) @ ccsin) @ ccmul) @ ccaddc) @ ccmul))))).
...
thf(ccxpsqrtlem_conj,conjecture,(! [XA2:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (XA2 != ccc0)) & ((cco @ XA2 @ (cco @ cc1 @ cc2 @ ccdiv) @ cccxp) = (ccneg @ (ccfv @ XA2 @ ccsqrt)))) => (cwcel @ (cco @ cci @ (ccfv @ XA2 @ ccsqrt) @ ccmul) @ ccr)))).
