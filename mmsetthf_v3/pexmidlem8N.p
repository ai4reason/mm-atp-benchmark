...
thf(cpexmidlem8N_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => ((Xc_pe = (ccfv @ XK @ ccpolN)) => ((((cwcel @ XK @ cchlt) & (cwss @ XX @ XA2)) & (((ccfv @ (ccfv @ XX @ Xc_pe) @ Xc_pe) = XX) & (XX != cc0))) => ((cco @ XX @ (ccfv @ XX @ Xc_pe) @ Xc_pl) = XA2))))))))))).
