...
thf(adf_dioph_ax,axiom,(ccdioph = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccrn @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xp:$i] : (ccfv @ (ccv @ Xn) @ ccuz))) @ (^ [Xk:$i] : (^ [Xp:$i] : (ccfv @ (cco @ cc1 @ (ccv @ Xk) @ ccfz) @ ccmzp))) @ (^ [Xk:$i] : (^ [Xp:$i] : (^ [Xt:$i] : (cwrex @ (^ [Xu:$i] : (((ccv @ Xt) = (ccres @ (ccv @ Xu) @ (cco @ cc1 @ (ccv @ Xn) @ ccfz))) & ((ccfv @ (ccv @ Xu) @ (ccv @ Xp)) = ccc0))) @ (^ [Xu:$i] : (cco @ ccn0 @ (cco @ cc1 @ (ccv @ Xk) @ ccfz) @ ccmap)))))))))))).
