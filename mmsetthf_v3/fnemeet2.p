...
thf(afnemeet1_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xy1:$i] : (((cwcel @ XX @ (XV @ Xy1)) & (cwral @ (^ [Xy1:$i] : (XX = (ccuni @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XS)) & (cwcel @ XA2 @ XS)) => (cwbr @ (ccin @ (ccpw @ XX) @ (cciin @ (^ [Xt:$i] : XS) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ cctg)))) @ XA2 @ ccfne)))))))).
thf(afnebas_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XA2)) => ((XY = (ccuni @ XB2)) => ((cwbr @ XA2 @ XB2 @ ccfne) => (XX = XY))))))))).
...
thf(afnetr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccfne) & (cwbr @ XB2 @ XC @ ccfne)) => (cwbr @ XA2 @ XC @ ccfne)))))).
...
thf(afnetg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccfne) => (cwss @ XA2 @ (ccfv @ XB2 @ cctg)))))).
...
thf(cfnemeet2_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xy1:$i] : (((cwcel @ XX @ (XV @ Xy1)) & (cwral @ (^ [Xy1:$i] : (XX = (ccuni @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XS))) => ((cwbr @ (XT @ Xy1) @ (ccin @ (ccpw @ XX) @ (cciin @ (^ [Xt:$i] : XS) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ cctg)))) @ ccfne) <=> ((XX = (ccuni @ (XT @ Xy1))) & (cwral @ (^ [Xx3:$i] : (cwbr @ (XT @ Xy1) @ (ccv @ Xx3) @ ccfne)) @ (^ [Xx3:$i] : XS))))))))))).
