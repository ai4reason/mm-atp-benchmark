...
thf(csetsmsds_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (XX = (ccfv @ XM @ ccbs))) => ((Xph => (XD = (ccres @ (ccfv @ XM @ ccds) @ (ccxp @ XX @ XX)))) => ((Xph => (XK = (cco @ XM @ (ccop @ (ccfv @ ccnx @ ccts) @ (ccfv @ XD @ ccmopn)) @ ccsts))) => (Xph => ((ccfv @ XM @ ccds) = (ccfv @ XK @ ccds)))))))))))).
