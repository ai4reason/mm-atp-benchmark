...
thf(ccphorthcom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_xi = (ccfv @ XW @ ccip)) => ((XV = (ccfv @ XW @ ccbs)) => (((cwcel @ XW @ cccph) & (cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) => (((cco @ XA2 @ XB2 @ Xc_xi) = ccc0) <=> ((cco @ XB2 @ XA2 @ Xc_xi) = ccc0))))))))))).
