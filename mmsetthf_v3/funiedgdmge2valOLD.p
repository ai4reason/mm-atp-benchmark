...
thf(cfuniedgdmge2valOLD_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XG @ XV) & (cwfun @ (ccdif @ XG @ (ccsn @ cc0))) & (cwbr @ cc2 @ (ccfv @ (ccdm @ XG) @ cchash) @ ccle)) => ((ccfv @ XG @ cciedg) = (ccfv @ XG @ ccedgf)))))).
