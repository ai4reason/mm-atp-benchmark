...
thf(adf_rgmod_ax,axiom,(ccrglmod = (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccfv @ (ccfv @ (ccv @ Xw) @ ccbs) @ (ccfv @ (ccv @ Xw) @ ccsra)))))).
...
thf(crlmval_conj,conjecture,(! [XW:($i > $o)] : ((ccfv @ XW @ ccrglmod) = (ccfv @ (ccfv @ XW @ ccbs) @ (ccfv @ XW @ ccsra))))).
