...
thf(alindfmm_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XB2 = (ccfv @ XS @ ccbs)) => ((XC = (ccfv @ XT @ ccbs)) => (((cwcel @ XG @ (cco @ XS @ XT @ cclmhm)) & (cwf1 @ XB2 @ XC @ XG) & (cwf @ XI @ XB2 @ XF)) => ((cwbr @ XF @ XS @ cclindf) <=> (cwbr @ (cccom @ XG @ XF) @ XT @ cclindf))))))))))))).
...
thf(af1linds_thm,axiom,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ cclmod) & (cwcel @ XS @ (ccfv @ XW @ cclinds)) & (cwf1 @ XD @ XS @ XF)) => (cwbr @ XF @ XW @ cclindf))))))).
thf(asyl5eqel_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((Xph => (cwcel @ XB2 @ XC)) => (Xph => (cwcel @ XA2 @ XC))))))))).
thf(adf_ima_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccima @ XA2 @ XB2) = (ccrn @ (ccres @ XA2 @ XB2)))))).
thf(asylan_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => (((Xps & Xch) => Xth) => ((Xph & Xch) => Xth)))))))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(cwfun_tp,type,(cwfun : (($i > $o) > $o))).
thf(alindfrn_thm,axiom,(! [XF:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ cclmod) & (cwbr @ XF @ XW @ cclindf)) => (cwcel @ (ccrn @ XF) @ (ccfv @ XW @ cclinds)))))).
...
thf(clindsmm_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XS @ ccbs)) => ((XC = (ccfv @ XT @ ccbs)) => (((cwcel @ XG @ (cco @ XS @ XT @ cclmhm)) & (cwf1 @ XB2 @ XC @ XG) & (cwss @ XF @ XB2)) => ((cwcel @ XF @ (ccfv @ XS @ cclinds)) <=> (cwcel @ (ccima @ XG @ XF) @ (ccfv @ XT @ cclinds))))))))))))).
