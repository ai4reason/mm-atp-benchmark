...
thf(akrippenlem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((XS = (ccfv @ XG @ ccmir)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((XM = (ccfv @ XX @ XS)) => ((XN = (ccfv @ XY @ XS)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XE @ XP)) => ((Xph => (cwcel @ XF @ XP)) => ((Xph => (cwcel @ XX @ XP)) => ((Xph => (cwcel @ XY @ XP)) => ((Xph => (cwcel @ XC @ (cco @ XA2 @ XE @ XI))) => ((Xph => (cwcel @ XC @ (cco @ XB2 @ XF @ XI))) => ((Xph => ((cco @ XC @ XA2 @ Xc_mi) = (cco @ XC @ XB2 @ Xc_mi))) => ((Xph => ((cco @ XC @ XE @ Xc_mi) = (cco @ XC @ XF @ Xc_mi))) => ((Xph => (XB2 = (ccfv @ XA2 @ XM))) => ((Xph => (XF = (ccfv @ XE @ XN))) => ((Xc_le = (ccfv @ XG @ ccleg)) => ((Xph => (cwbr @ (cco @ XC @ XA2 @ Xc_mi) @ (cco @ XC @ XE @ Xc_mi) @ Xc_le)) => (Xph => (cwcel @ XC @ (cco @ XX @ XY @ XI)))))))))))))))))))))))))))))))))))))))))))).
