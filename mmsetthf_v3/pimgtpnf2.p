...
thf(cpimgtpnf2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwf @ XA2 @ ccr @ (XF @ Xx3)))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccrab @ (^ [Xx3:$i] : (cwbr @ ccpnf @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ cclt)) @ (^ [Xx3:$i] : XA2)) = cc0))))))))).
