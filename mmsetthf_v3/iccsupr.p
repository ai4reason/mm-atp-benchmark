...
thf(ciccsupr_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : ((((cwcel @ (XA2 @ Xx3) @ ccr) & (cwcel @ XB2 @ ccr)) & (cwss @ XS @ (cco @ (XA2 @ Xx3) @ XB2 @ ccicc)) & (cwcel @ (XC @ Xx3 @ Xy1) @ XS)) => ((cwss @ XS @ ccr) & (XS != cc0) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XS))) @ (^ [Xx3:$i] : ccr))))))))))).
