...
thf(a_0plef_thm,axiom,(! [XF:($i > $o)] : ((cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF) <=> ((cwf @ ccr @ ccr @ XF) & (cwbr @ cc0p @ XF @ (ccofr @ ccle)))))).
