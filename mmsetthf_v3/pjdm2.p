...
thf(cpjdm2_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XL = (ccfv @ XW @ cclss)) => ((Xc_pe = (ccfv @ XW @ ccocv)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((XK = (ccfv @ XW @ ccpj)) => ((cwcel @ XW @ ccphl) => ((cwcel @ XT @ (ccdm @ XK)) <=> ((cwcel @ XT @ XL) & ((cco @ XT @ (ccfv @ XT @ Xc_pe) @ Xc_po) = XV))))))))))))))))).
