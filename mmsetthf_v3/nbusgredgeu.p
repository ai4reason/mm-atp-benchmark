...
thf(armoeq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (cwrmo @ (^ [Xx3:$i] : ((ccv @ Xx3) = XA2)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))).
...
thf(cnbusgredgeu_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ ccusgr) & (cwcel @ XM @ (cco @ XG @ XN @ ccnbgr))) => (cwreu @ (^ [Xe:$i] : ((ccv @ Xe) = (ccpr @ XM @ XN))) @ (^ [Xe:$i] : XE))))))))).
