...
thf(alubfun_thm,axiom,(! [XU:($i > $o)] : (! [XK:($i > $o)] : ((XU = (ccfv @ XK @ cclub)) => (cwfun @ XU))))).
...
thf(alubelss_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XU = (ccfv @ XK @ cclub)) => ((Xph => (cwcel @ XK @ XV)) => ((Xph => (cwcel @ XS @ (ccdm @ XU))) => (Xph => (cwss @ XS @ XB2))))))))))))))).
...
thf(adf_join_ax,axiom,(ccjn = (ccmpt @ (^ [Xp:$i] : ccvv) @ (^ [Xp:$i] : (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (cwbr @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz) @ (ccfv @ (ccv @ Xp) @ cclub)))))))))).
thf(cjoinfval_conj,conjecture,(! [XU:($i > ($i > ($i > $o)))] : (! [Xc_or:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XU @ Xx3 @ Xy1) = (ccfv @ XK @ cclub)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xc_or @ Xx3 @ Xy1 @ Xz) = (ccfv @ XK @ ccjn))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ XK @ (XV @ Xx3 @ Xy1 @ Xz)) => ((Xc_or @ Xx3 @ Xy1 @ Xz) = (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (cwbr @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz) @ (XU @ Xx3 @ Xy1)))))))))))))))))).
