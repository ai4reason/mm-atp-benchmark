...
thf(aoffval0_thm,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XF @ (XV @ Xx3)) & (cwcel @ XG @ (XW @ Xx3))) => ((cco @ XF @ XG @ (ccof @ XR)) = (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccdm @ XF) @ (ccdm @ XG))) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG) @ XR)))))))))))).
