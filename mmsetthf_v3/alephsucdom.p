...
thf(aalephnbtwn2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (~ ((cwbr @ (ccfv @ XA2 @ ccale) @ XB2 @ ccsdm) & (cwbr @ XB2 @ (ccfv @ (ccsuc @ XA2) @ ccale) @ ccsdm)))))).
...
thf(adomtriord_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((cwbr @ XA2 @ XB2 @ ccdom) <=> (~ (cwbr @ XB2 @ XA2 @ ccsdm))))))).
thf(aendomtr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccen) & (cwbr @ XB2 @ XC @ ccdom)) => (cwbr @ XA2 @ XC @ ccdom)))))).
thf(calephsucdom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccon0) => ((cwbr @ XA2 @ (ccfv @ XB2 @ ccale) @ ccdom) <=> (cwbr @ XA2 @ (ccfv @ (ccsuc @ XB2) @ ccale) @ ccsdm)))))).
