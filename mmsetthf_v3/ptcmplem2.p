...
thf(afonum_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwfo @ XA2 @ XB2 @ XF)) => (cwcel @ XB2 @ (ccdm @ cccrd))))))).
...
thf(assnum_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwss @ XB2 @ XA2)) => (cwcel @ XB2 @ (ccdm @ cccrd)))))).
...
thf(aixpiunwdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XA2 @ (XV @ Xx3)) & (cwcel @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (XW @ Xx3)) & ((ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) != cc0)) => (cwbr @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccxp @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XA2) @ ccwdom)))))))).
thf(anumwdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwbr @ XB2 @ XA2 @ ccwdom)) => (cwcel @ XB2 @ (ccdm @ cccrd)))))).
thf(cptcmplem2_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xw:$i] : ((XS @ Xw) = (ccmpt2 @ (^ [Xk:$i] : (^ [Xu:$i] : XA2)) @ (^ [Xk:$i] : (^ [Xu:$i] : (ccfv @ (ccv @ Xk) @ XF))) @ (^ [Xk:$i] : (^ [Xu:$i] : (ccima @ (cccnv @ (ccmpt @ (^ [Xw:$i] : XX) @ (^ [Xw:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xw))))) @ (ccv @ Xu))))))) => ((XX = (ccixp @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (ccuni @ (ccfv @ (ccv @ Xn) @ XF))))) => ((! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xz @ Xw) => (cwcel @ XA2 @ XV)))) => ((! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xz @ Xw) => (cwf @ XA2 @ cccmp @ XF)))) => ((! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xz @ Xw) => (cwcel @ XX @ (ccin @ ccufl @ (ccdm @ cccrd)))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xn:$i] : ((Xph @ Xz @ Xw) => (cwss @ (XU @ Xw @ Xn) @ (ccrn @ (XS @ Xw))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xn:$i] : ((Xph @ Xz @ Xw) => (XX = (ccuni @ (XU @ Xw @ Xn))))))) => ((! [Xz:$i] : (! [Xw:$i] : (! [Xn:$i] : ((Xph @ Xz @ Xw) => (~ (cwrex @ (^ [Xz:$i] : (XX = (ccuni @ (ccv @ Xz)))) @ (^ [Xz:$i] : (ccin @ (ccpw @ (XU @ Xw @ Xn)) @ ccfn)))))))) => (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xz @ Xw) => (cwcel @ (cciun @ (^ [Xk:$i] : (ccrab @ (^ [Xn:$i] : (~ (cwbr @ (ccuni @ (ccfv @ (ccv @ Xn) @ XF)) @ cc1o @ ccen))) @ (^ [Xn:$i] : XA2))) @ (^ [Xk:$i] : (ccuni @ (ccfv @ (ccv @ Xk) @ XF)))) @ (ccdm @ cccrd))))))))))))))))))))).
