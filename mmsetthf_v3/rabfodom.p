...
thf(crabfodom_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2) & ((ccv @ Xy1) = (ccfv @ (ccv @ Xx3) @ XF))) => ((Xch @ Xy1) <=> (Xps @ Xx3))))) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwfo @ XA2 @ XB2 @ XF)) => (Xph => (cwbr @ (ccrab @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : XB2)) @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ ccdom))))))))))))).
