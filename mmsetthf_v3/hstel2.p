...
thf(chstel2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : ((((cwcel @ XS @ cchst) & (cwcel @ XA2 @ ccch)) & ((cwcel @ XB2 @ ccch) & (cwss @ XA2 @ (ccfv @ XB2 @ ccort)))) => (((cco @ (ccfv @ XA2 @ XS) @ (ccfv @ XB2 @ XS) @ ccsp) = ccc0) & ((ccfv @ (cco @ XA2 @ XB2 @ cchj) @ XS) = (cco @ (ccfv @ XA2 @ XS) @ (ccfv @ XB2 @ XS) @ ccva)))))))).
