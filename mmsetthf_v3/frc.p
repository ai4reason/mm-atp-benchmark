...
thf(cfrc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XB2 @ ccvv) => (((cwfr @ XA2 @ XR) & (cwss @ XB2 @ XA2) & (XB2 != cc0)) => (cwrex @ (^ [Xx3:$i] : ((ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR)) @ (^ [Xy1:$i] : XB2)) = cc0)) @ (^ [Xx3:$i] : XB2)))))))).
