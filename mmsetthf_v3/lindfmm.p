...
thf(af1elima_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwf1 @ XA2 @ XB2 @ XF) & (cwcel @ XX @ XA2) & (cwss @ XY @ XA2)) => ((cwcel @ (ccfv @ XX @ XF) @ (ccima @ XF @ XY)) <=> (cwcel @ XX @ XY))))))))).
...
thf(almhmlsp_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XS @ ccbs)) => ((XK = (ccfv @ XS @ cclspn)) => ((XL = (ccfv @ XT @ cclspn)) => (((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) & (cwss @ XU @ XV)) => ((ccima @ XF @ (ccfv @ XU @ XK)) = (ccfv @ (ccima @ XF @ XU) @ XL)))))))))))))).
...
thf(almhmlmod2_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) => (cwcel @ XT @ cclmod)))))).
thf(aad2ant2lr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (((Xph & Xps) => Xch) => (((Xth & Xph) & (Xps & Xta)) => Xch)))))))).
thf(clindfmm_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XB2 = (ccfv @ XS @ ccbs)) => ((XC = (ccfv @ XT @ ccbs)) => (((cwcel @ XG @ (cco @ XS @ XT @ cclmhm)) & (cwf1 @ XB2 @ XC @ XG) & (cwf @ XI @ XB2 @ XF)) => ((cwbr @ XF @ XS @ cclindf) <=> (cwbr @ (cccom @ XG @ XF) @ XT @ cclindf))))))))))))).
