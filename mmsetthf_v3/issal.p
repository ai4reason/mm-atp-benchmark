...
thf(adf_salg_ax,axiom,(ccsalg = (^ [Xx3:$i] : ((cwcel @ cc0 @ (ccv @ Xx3)) & (cwral @ (^ [Xy1:$i] : (cwcel @ (ccdif @ (ccuni @ (ccv @ Xx3)) @ (ccv @ Xy1)) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3))) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ ccom @ ccdom) => (cwcel @ (ccuni @ (ccv @ Xy1)) @ (ccv @ Xx3)))) @ (^ [Xy1:$i] : (ccpw @ (ccv @ Xx3)))))))).
thf(cissal_conj,conjecture,(! [XS:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : ((cwcel @ XS @ (XV @ Xy1)) => ((cwcel @ XS @ ccsalg) <=> ((cwcel @ cc0 @ XS) & (cwral @ (^ [Xy1:$i] : (cwcel @ (ccdif @ (ccuni @ XS) @ (ccv @ Xy1)) @ XS)) @ (^ [Xy1:$i] : XS)) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ ccom @ ccdom) => (cwcel @ (ccuni @ (ccv @ Xy1)) @ XS))) @ (^ [Xy1:$i] : (ccpw @ XS)))))))))).
