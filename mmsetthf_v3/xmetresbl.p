...
thf(axmeter_thm,axiom,(! [XD:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XX:($i > $o)] : ((Xc_sm = (ccima @ (cccnv @ XD) @ ccr)) => ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => (cwer @ XX @ Xc_sm))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(aadantrr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => ((Xph & (Xps & Xth)) => Xch))))))).
thf(asselda_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwss @ XA2 @ XB2)) => ((Xph & (cwcel @ XC @ XA2)) => (cwcel @ XC @ XB2)))))))).
thf(ccpnf_tp,type,(ccpnf : ($i > $o))).
thf(ablssec_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((Xc_sm = (ccima @ (cccnv @ XD) @ ccr)) => (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XP @ XX) & (cwcel @ XS @ ccxr)) => (cwss @ (cco @ XP @ XS @ (ccfv @ XD @ ccbl)) @ (ccec @ XP @ Xc_sm)))))))))).
...
thf(cxmetresbl_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (cco @ XP @ XR @ (ccfv @ XD @ ccbl))) => (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XP @ XX) & (cwcel @ XR @ ccxr)) => (cwcel @ (ccres @ XD @ (ccxp @ XB2 @ XB2)) @ (ccfv @ XB2 @ ccme)))))))))).
