...
thf(cxadddi2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & ((cwcel @ XB2 @ ccxr) & (cwbr @ ccc0 @ XB2 @ ccle)) & ((cwcel @ XC @ ccxr) & (cwbr @ ccc0 @ XC @ ccle))) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccxad) @ ccxmu) = (cco @ (cco @ XA2 @ XB2 @ ccxmu) @ (cco @ XA2 @ XC @ ccxmu) @ ccxad))))))).
