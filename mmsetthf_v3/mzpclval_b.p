...
thf(adf_mzpcl_ax,axiom,(ccmzpcl = (ccmpt @ (^ [Xv:$i] : ccvv) @ (^ [Xv:$i] : (ccrab @ (^ [Xp:$i] : (((cwral @ (^ [Xi:$i] : (cwcel @ (ccxp @ (cco @ ccz @ (ccv @ Xv) @ ccmap) @ (ccsn @ (ccv @ Xi))) @ (ccv @ Xp))) @ (^ [Xi:$i] : ccz)) & (cwral @ (^ [Xj:$i] : (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccz @ (ccv @ Xv) @ ccmap)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xj) @ (ccv @ Xx3)))) @ (ccv @ Xp))) @ (^ [Xj:$i] : (ccv @ Xv)))) & (cwral @ (^ [Xf1:$i] : (cwral @ (^ [Xg1:$i] : ((cwcel @ (cco @ (ccv @ Xf1) @ (ccv @ Xg1) @ (ccof @ ccaddc)) @ (ccv @ Xp)) & (cwcel @ (cco @ (ccv @ Xf1) @ (ccv @ Xg1) @ (ccof @ ccmul)) @ (ccv @ Xp)))) @ (^ [Xg1:$i] : (ccv @ Xp)))) @ (^ [Xf1:$i] : (ccv @ Xp))))) @ (^ [Xp:$i] : (ccpw @ (cco @ ccz @ (cco @ ccz @ (ccv @ Xv) @ ccmap) @ ccmap)))))))).
