...
thf(c_3oalem3_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwcel @ XR @ ccch) => ((cwcel @ XS @ ccch) => (cwss @ (ccin @ (cco @ XB2 @ XR @ ccph) @ (cco @ XC @ XS @ ccph)) @ (cco @ XB2 @ (ccin @ XR @ (cco @ XS @ (ccin @ (cco @ XB2 @ XC @ ccph) @ (cco @ XR @ XS @ ccph)) @ ccph)) @ ccph))))))))))).
