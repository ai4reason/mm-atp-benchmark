...
thf(cmndifsplit_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_0 = (ccfv @ XM @ cc0g)) => ((Xc_pl = (ccfv @ XM @ ccplusg)) => (((cwcel @ XM @ ccmnd) & (cwcel @ XA2 @ XB2) & (~ (Xph & Xps))) => ((ccif @ (Xph | Xps) @ XA2 @ Xc_0) = (cco @ (ccif @ Xph @ XA2 @ Xc_0) @ (ccif @ Xps @ XA2 @ Xc_0) @ Xc_pl)))))))))))))).
