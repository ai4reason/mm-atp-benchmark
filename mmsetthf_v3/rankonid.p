...
thf(arankonidlem_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccr1)) => ((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) & ((ccfv @ XA2 @ ccrnk) = XA2))))).
...
thf(crankonid_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccr1)) <=> ((ccfv @ XA2 @ ccrnk) = XA2)))).
