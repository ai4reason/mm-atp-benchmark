...
thf(cfvovco_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwf @ XX @ (ccxp @ XV @ XW) @ XF)) => ((Xph => (cwcel @ XY @ XX)) => (Xph => ((ccfv @ XY @ (cccom @ XO @ XF)) = (cco @ (ccfv @ (ccfv @ XY @ XF) @ cc1st) @ (ccfv @ (ccfv @ XY @ XF) @ cc2nd) @ XO))))))))))))).
