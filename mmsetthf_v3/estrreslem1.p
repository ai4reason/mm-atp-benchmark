...
thf(astrndxid_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XS @ XV)) => ((XE = (ccslot @ XN)) => ((cwcel @ XN @ ccn) => (Xph => ((ccfv @ (ccfv @ ccnx @ XE) @ XS) = (ccfv @ XS @ XE)))))))))))).
...
thf(afvtp1g_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((((cwcel @ XA2 @ XV) & (cwcel @ XD @ XW)) & ((XA2 != XB2) & (XA2 != XC))) => ((ccfv @ XA2 @ (cctp @ (ccop @ XA2 @ XD) @ (ccop @ XB2 @ XE) @ (ccop @ XC @ XF))) = XD))))))))))).
