...
thf(cusgredgprvALT_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XE = (ccfv @ XG @ cciedg)) => ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ ccusgr) & (cwcel @ XX @ (ccdm @ XE))) => (((ccfv @ XX @ XE) = (ccpr @ XM @ XN)) => ((cwcel @ XM @ XV) & (cwcel @ XN @ XV))))))))))))).
