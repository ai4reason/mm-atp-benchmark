...
thf(aiccsplit_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc))) => ((cco @ XA2 @ XB2 @ ccicc) = (ccun @ (cco @ XA2 @ XC @ ccicc) @ (cco @ XC @ XB2 @ ccicc)))))))).
...
thf(cvolcn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (ccin @ XA2 @ (cco @ XB2 @ (ccv @ Xx3) @ ccicc)) @ ccvol))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ XB2 @ ccr)) => (cwcel @ (XF @ Xx3) @ (cco @ ccr @ ccr @ cccncf))))))))).
