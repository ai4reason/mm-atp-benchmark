...
thf(cswrdccatin12_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XL = (ccfv @ XA2 @ cchash)) => (((cwcel @ XA2 @ (ccword @ XV)) & (cwcel @ XB2 @ (ccword @ XV))) => (((cwcel @ XM @ (cco @ ccc0 @ XL @ ccfz)) & (cwcel @ XN @ (cco @ XL @ (cco @ XL @ (ccfv @ XB2 @ cchash) @ ccaddc) @ ccfz))) => ((cco @ (cco @ XA2 @ XB2 @ ccconcat) @ (ccop @ XM @ XN) @ ccsubstr) = (cco @ (cco @ XA2 @ (ccop @ XM @ XL) @ ccsubstr) @ (cco @ XB2 @ (ccop @ ccc0 @ (cco @ XN @ XL @ ccmin)) @ ccsubstr) @ ccconcat)))))))))))).
