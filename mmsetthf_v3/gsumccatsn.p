...
thf(cgsumccatsn_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (((cwcel @ XG @ ccmnd) & (cwcel @ XW @ (ccword @ XB2)) & (cwcel @ XZ @ XB2)) => ((cco @ XG @ (cco @ XW @ (ccs1 @ XZ) @ ccconcat) @ ccgsu) = (cco @ (cco @ XG @ XW @ ccgsu) @ XZ @ Xc_pl))))))))))).
