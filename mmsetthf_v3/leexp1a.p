...
thf(aexpge0_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XN @ ccn0) & (cwbr @ ccc0 @ XA2 @ ccle)) => (cwbr @ ccc0 @ (cco @ XA2 @ XN @ ccexp) @ ccle))))).
...
thf(cleexp1a_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XN @ ccn0)) & ((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ XA2 @ XB2 @ ccle))) => (cwbr @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XB2 @ XN @ ccexp) @ ccle)))))).
