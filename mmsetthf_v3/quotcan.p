...
thf(cquotcan_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XH = (cco @ XF @ XG @ (ccof @ ccmul))) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XS @ ccply)) & (XG != cc0p)) => ((cco @ XH @ XG @ ccquot) = XF)))))))).
