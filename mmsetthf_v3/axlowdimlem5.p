...
thf(aaxlowdimlem3_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) => ((cco @ cc1 @ XN @ ccfz) = (ccun @ (cco @ cc1 @ cc2 @ ccfz) @ (cco @ cc3 @ XN @ ccfz)))))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(aeluz2nn_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) => (cwcel @ XA2 @ ccn)))).
thf(ccv_tp,type,(ccv : ($i > ($i > $o)))).
thf(ccmap_tp,type,(ccmap : ($i > $o))).
thf(aelee_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cwcel @ XA2 @ (ccfv @ XN @ ccee)) <=> (cwf @ (cco @ cc1 @ XN @ ccfz) @ ccr @ XA2)))))).
thf(caxlowdimlem5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) => (cwcel @ (ccun @ (ccpr @ (ccop @ cc1 @ XA2) @ (ccop @ cc2 @ XB2)) @ (ccxp @ (cco @ cc3 @ XN @ ccfz) @ (ccsn @ ccc0))) @ (ccfv @ XN @ ccee))))))))).
