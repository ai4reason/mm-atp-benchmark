...
thf(climciccioolb_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwf @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ XF)) => (Xph => ((cco @ (ccres @ XF @ (cco @ XA2 @ XB2 @ ccioo)) @ XA2 @ cclimc) = (cco @ XF @ XA2 @ cclimc)))))))))))).
