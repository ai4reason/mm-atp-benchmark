...
thf(af1imaeq_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (((cwf1 @ XA2 @ XB2 @ XF) & ((cwss @ XC @ XA2) & (cwss @ XD @ XA2))) => (((ccima @ XF @ XC) = (ccima @ XF @ XD)) <=> (XC = XD))))))))).
...
thf(aimasf1obl_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (XU = (cco @ XF @ XR @ ccimas))) => ((Xph => (XV = (ccfv @ XR @ ccbs))) => ((Xph => (cwf1o @ XV @ XB2 @ XF)) => ((Xph => (cwcel @ XR @ XZ)) => ((XE = (ccres @ (ccfv @ XR @ ccds) @ (ccxp @ XV @ XV))) => ((XD = (ccfv @ XU @ ccds)) => ((Xph => (cwcel @ XE @ (ccfv @ XV @ ccxmt))) => ((Xph => (cwcel @ XP @ XV)) => ((Xph => (cwcel @ XS @ ccxr)) => (Xph => ((cco @ (ccfv @ XP @ XF) @ XS @ (ccfv @ XD @ ccbl)) = (ccima @ XF @ (cco @ XP @ XS @ (ccfv @ XE @ ccbl)))))))))))))))))))))))))).
...
thf(aelqtop2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ XV) & (cwfo @ XX @ XY @ XF)) => ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccqtop)) <=> ((cwss @ XA2 @ XY) & (cwcel @ (ccima @ (cccnv @ XF) @ XA2) @ XJ)))))))))))).
...
thf(ablf_thm,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => (cwf @ (ccxp @ XX @ ccxr) @ (ccpw @ XX) @ (ccfv @ XD @ ccbl)))))).
...
thf(cimasf1oxms_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (XU = (cco @ XF @ XR @ ccimas))) => ((Xph => (XV = (ccfv @ XR @ ccbs))) => ((Xph => (cwf1o @ XV @ XB2 @ XF)) => ((Xph => (cwcel @ XR @ ccxme)) => (Xph => (cwcel @ XU @ ccxme))))))))))))).
