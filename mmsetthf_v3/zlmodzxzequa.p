...
thf(a_2t6m3t4e0_thm,axiom,((cco @ (cco @ cc2 @ cc6 @ ccmul) @ (cco @ cc3 @ cc4 @ ccmul) @ ccmin) = ccc0)).
...
thf(azlmodzxzscm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => ((Xc_xb = (ccfv @ XZ @ ccvsca)) => (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (cwcel @ XC @ ccz)) => ((cco @ XA2 @ (ccpr @ (ccop @ ccc0 @ XB2) @ (ccop @ cc1 @ XC)) @ Xc_xb) = (ccpr @ (ccop @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul)) @ (ccop @ cc1 @ (cco @ XA2 @ XC @ ccmul))))))))))))).
...
thf(azlmodzxzsub_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => ((Xc_mi = (ccfv @ XZ @ ccsg)) => ((((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) & ((cwcel @ XC @ ccz) & (cwcel @ XD @ ccz))) => ((cco @ (ccpr @ (ccop @ ccc0 @ XA2) @ (ccop @ cc1 @ XC)) @ (ccpr @ (ccop @ ccc0 @ XB2) @ (ccop @ cc1 @ XD)) @ Xc_mi) = (ccpr @ (ccop @ ccc0 @ (cco @ XA2 @ XB2 @ ccmin)) @ (ccop @ cc1 @ (cco @ XC @ XD @ ccmin)))))))))))))).
thf(czlmodzxzequa_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => ((Xc_0 = (ccpr @ (ccop @ ccc0 @ ccc0) @ (ccop @ cc1 @ ccc0))) => ((Xc_xb = (ccfv @ XZ @ ccvsca)) => ((Xc_mi = (ccfv @ XZ @ ccsg)) => ((XA2 = (ccpr @ (ccop @ ccc0 @ cc3) @ (ccop @ cc1 @ cc6))) => ((XB2 = (ccpr @ (ccop @ ccc0 @ cc2) @ (ccop @ cc1 @ cc4))) => ((cco @ (cco @ cc2 @ XA2 @ Xc_xb) @ (cco @ cc3 @ XB2 @ Xc_xb) @ Xc_mi) = Xc_0)))))))))))))).
