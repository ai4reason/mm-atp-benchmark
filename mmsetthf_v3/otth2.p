...
thf(cotth2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XR @ ccvv) => (((ccop @ (ccop @ XA2 @ XB2) @ XR) = (ccop @ (ccop @ XC @ XD) @ XS)) <=> ((XA2 = XC) & (XB2 = XD) & (XR = XS))))))))))))).
