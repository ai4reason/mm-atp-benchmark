...
thf(aiicmp_thm,axiom,(cwcel @ ccii @ cccmp)).
...
thf(altdiv23_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccr) & ((cwcel @ XB2 @ ccr) & (cwbr @ ccc0 @ XB2 @ cclt)) & ((cwcel @ XC @ ccr) & (cwbr @ ccc0 @ XC @ cclt))) => ((cwbr @ (cco @ XA2 @ XB2 @ ccdiv) @ XC @ cclt) <=> (cwbr @ (cco @ XA2 @ XC @ ccdiv) @ XB2 @ cclt))))))).
...
thf(ablres_thm,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XC = (ccres @ XD @ (ccxp @ XY @ XY))) => (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XP @ (ccin @ XX @ XY)) & (cwcel @ XR @ ccxr)) => ((cco @ XP @ XR @ (ccfv @ XC @ ccbl)) = (ccin @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ XY))))))))))).
...
thf(clebnumii_conj,conjecture,(! [XU:($i > $o)] : (((cwss @ XU @ ccii) & ((cco @ ccc0 @ cc1 @ ccicc) = (ccuni @ XU))) => (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xu:$i] : (cwss @ (cco @ (cco @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ (ccv @ Xn) @ ccdiv) @ (cco @ (ccv @ Xk) @ (ccv @ Xn) @ ccdiv) @ ccicc) @ (ccv @ Xu))) @ (^ [Xu:$i] : XU))) @ (^ [Xk:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccfz)))) @ (^ [Xn:$i] : ccn))))).
