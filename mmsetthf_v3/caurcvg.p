...
thf(acaurcvgr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwss @ XA2 @ ccr)) => ((Xph => (cwf @ XA2 @ ccr @ XF)) => ((Xph => ((ccsup @ XA2 @ ccxr @ cclt) = ccpnf)) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : ((cwbr @ (ccv @ Xj) @ (ccv @ Xk) @ ccle) => (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xj) @ XF) @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt))) @ (^ [Xk:$i] : XA2))) @ (^ [Xj:$i] : XA2))) @ (^ [Xx3:$i] : ccrp))) => (Xph => (cwbr @ XF @ (ccfv @ XF @ cclsp) @ ccrli)))))))))).
...
thf(arlimclim_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwf @ XZ @ ccc @ XF)) => (Xph => ((cwbr @ XF @ XA2 @ ccrli) <=> (cwbr @ XF @ XA2 @ ccli)))))))))))).
...
thf(ccaurcvg_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (XZ = (ccfv @ (XM @ Xk) @ ccuz))) => ((Xph => (cwf @ XZ @ ccr @ XF)) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xm) @ XF) @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xm) @ ccuz)))) @ (^ [Xm:$i] : XZ))) @ (^ [Xx3:$i] : ccrp))) => (Xph => (cwbr @ XF @ (ccfv @ XF @ cclsp) @ ccli)))))))))).
