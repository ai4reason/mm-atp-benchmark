...
thf(asmodm2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XA2) & (cwsmo @ XF)) => (cword @ XA2))))).
...
thf(asmofvon2_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwsmo @ XF) => (cwcel @ (ccfv @ XB2 @ XF) @ ccon0))))).
...
thf(asmoel2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((((cwfn @ XF @ XA2) & (cwsmo @ XF)) & ((cwcel @ XB2 @ XA2) & (cwcel @ XC @ XB2))) => (cwcel @ (ccfv @ XC @ XF) @ (ccfv @ XB2 @ XF)))))))).
...
thf(csmogt_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XA2) & (cwsmo @ XF) & (cwcel @ XC @ XA2)) => (cwss @ XC @ (ccfv @ XC @ XF))))))).
