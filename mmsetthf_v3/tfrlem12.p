...
thf(atfrlem11_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : ((XA2 @ Xx3 @ Xy1 @ Xf1) = (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) = (ccfv @ (ccres @ (ccv @ Xf1) @ (ccv @ Xy1)) @ XF))) @ (^ [Xy1:$i] : (ccv @ Xx3))))) @ (^ [Xx3:$i] : ccon0))))))) => ((XC = (ccun @ (ccrecs @ XF) @ (ccsn @ (ccop @ (ccdm @ (ccrecs @ XF)) @ (ccfv @ (ccrecs @ XF) @ XF))))) => ((cwcel @ (ccdm @ (ccrecs @ XF)) @ ccon0) => ((cwcel @ XB2 @ (ccsuc @ (ccdm @ (ccrecs @ XF)))) => ((ccfv @ XB2 @ XC) = (ccfv @ (ccres @ XC @ XB2) @ XF))))))))))).
...
thf(ctfrlem12_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : ((XA2 @ Xx3 @ Xy1 @ Xf1) = (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) = (ccfv @ (ccres @ (ccv @ Xf1) @ (ccv @ Xy1)) @ XF))) @ (^ [Xy1:$i] : (ccv @ Xx3))))) @ (^ [Xx3:$i] : ccon0))))))) => ((XC = (ccun @ (ccrecs @ XF) @ (ccsn @ (ccop @ (ccdm @ (ccrecs @ XF)) @ (ccfv @ (ccrecs @ XF) @ XF))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : ((cwcel @ (ccrecs @ XF) @ ccvv) => (cwcel @ XC @ (XA2 @ Xx3 @ Xy1 @ Xf1)))))))))))).
