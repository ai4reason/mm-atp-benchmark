...
thf(celicc4abs_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccr)) => ((cwcel @ XC @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XA2 @ XB2 @ ccaddc) @ ccicc)) <=> (cwbr @ (ccfv @ (cco @ XC @ XA2 @ ccmin) @ ccabs) @ XB2 @ ccle))))))).
