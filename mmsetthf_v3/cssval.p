...
thf(adf_css_ax,axiom,(cccss = (ccmpt @ (^ [Xh:$i] : ccvv) @ (^ [Xh:$i] : (^ [Xs1:$i] : ((ccv @ Xs1) = (ccfv @ (ccfv @ (ccv @ Xs1) @ (ccfv @ (ccv @ Xh) @ ccocv)) @ (ccfv @ (ccv @ Xh) @ ccocv)))))))).
...
thf(ccssval_conj,conjecture,(! [XC:($i > ($i > $o))] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : ((Xc_pe = (ccfv @ XW @ ccocv)) => ((! [Xs1:$i] : ((XC @ Xs1) = (ccfv @ XW @ cccss))) => (! [Xs1:$i] : ((cwcel @ XW @ (XX @ Xs1)) => ((XC @ Xs1) = (^ [Xs1:$i] : ((ccv @ Xs1) = (ccfv @ (ccfv @ (ccv @ Xs1) @ Xc_pe) @ Xc_pe))))))))))))).
