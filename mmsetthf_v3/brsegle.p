...
thf(cbrsegle_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & ((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee))) & ((cwcel @ XC @ (ccfv @ XN @ ccee)) & (cwcel @ XD @ (ccfv @ XN @ ccee)))) => ((cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ ccsegle) <=> (cwrex @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ (ccop @ XC @ XD) @ ccbtwn) & (cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ (ccv @ Xy1)) @ cccgr))) @ (^ [Xy1:$i] : (ccfv @ XN @ ccee))))))))))).
