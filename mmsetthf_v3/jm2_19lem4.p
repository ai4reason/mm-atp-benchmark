...
thf(cjm2_19lem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & ((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) & (cwcel @ XI @ ccz)) => ((cwbr @ (cco @ XA2 @ XM @ ccrmy) @ (cco @ XA2 @ XN @ ccrmy) @ ccdvds) <=> (cwbr @ (cco @ XA2 @ XM @ ccrmy) @ (cco @ XA2 @ (cco @ XN @ (cco @ XI @ XM @ ccmul) @ ccaddc) @ ccrmy) @ ccdvds)))))))).
