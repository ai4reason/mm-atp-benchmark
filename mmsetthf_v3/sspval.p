...
thf(adf_ssp_ax,axiom,(ccss = (ccmpt @ (^ [Xu:$i] : ccnv) @ (^ [Xu:$i] : (ccrab @ (^ [Xw:$i] : ((cwss @ (ccfv @ (ccv @ Xw) @ ccpv) @ (ccfv @ (ccv @ Xu) @ ccpv)) & (cwss @ (ccfv @ (ccv @ Xw) @ ccns) @ (ccfv @ (ccv @ Xu) @ ccns)) & (cwss @ (ccfv @ (ccv @ Xw) @ ccnmcv) @ (ccfv @ (ccv @ Xu) @ ccnmcv)))) @ (^ [Xw:$i] : ccnv)))))).
...
thf(csspval_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XN:($i > $o)] : ((XG = (ccfv @ XU @ ccpv)) => ((XS = (ccfv @ XU @ ccns)) => ((XN = (ccfv @ XU @ ccnmcv)) => ((! [Xw:$i] : ((XH @ Xw) = (ccfv @ XU @ ccss))) => (! [Xw:$i] : ((cwcel @ XU @ ccnv) => ((XH @ Xw) = (ccrab @ (^ [Xw:$i] : ((cwss @ (ccfv @ (ccv @ Xw) @ ccpv) @ XG) & (cwss @ (ccfv @ (ccv @ Xw) @ ccns) @ XS) & (cwss @ (ccfv @ (ccv @ Xw) @ ccnmcv) @ XN))) @ (^ [Xw:$i] : ccnv))))))))))))))).
