...
thf(ccshwsexa_conj,conjecture,(! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (cwcel @ (ccrab @ (^ [Xw:$i] : (cwrex @ (^ [Xn:$i] : ((cco @ XW @ (ccv @ Xn) @ cccsh) = (ccv @ Xw))) @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)))) @ (^ [Xw:$i] : (ccword @ (XV @ Xw)))) @ ccvv)))).
