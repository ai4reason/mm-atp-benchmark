...
thf(aalgcvga_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((cwf @ XS @ XS @ XF) => ((! [Xz:$i] : (XR = (ccseq @ (cccom @ XF @ cc1st) @ (ccxp @ ccn0 @ (ccsn @ (XA2 @ Xz))) @ ccc0))) => ((cwf @ XS @ ccn0 @ XC) => ((! [Xz:$i] : ((cwcel @ (ccv @ Xz) @ XS) => (((ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ XC) != ccc0) => (cwbr @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ XC) @ (ccfv @ (ccv @ Xz) @ XC) @ cclt)))) => ((! [Xz:$i] : ((XN @ Xz) = (ccfv @ (XA2 @ Xz) @ XC))) => (! [Xz:$i] : ((cwcel @ (XA2 @ Xz) @ XS) => ((cwcel @ (XK @ Xz) @ (ccfv @ (XN @ Xz) @ ccuz)) => ((ccfv @ (ccfv @ (XK @ Xz) @ XR) @ XC) = ccc0))))))))))))))))).
...
thf(calgfx_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwf @ XS @ XS @ XF) => ((! [Xz:$i] : (XR = (ccseq @ (cccom @ XF @ cc1st) @ (ccxp @ ccn0 @ (ccsn @ (XA2 @ Xz))) @ ccc0))) => ((cwf @ XS @ ccn0 @ XC) => ((! [Xz:$i] : ((cwcel @ (ccv @ Xz) @ XS) => (((ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ XC) != ccc0) => (cwbr @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ XC) @ (ccfv @ (ccv @ Xz) @ XC) @ cclt)))) => ((! [Xz:$i] : (XN = (ccfv @ (XA2 @ Xz) @ XC))) => ((! [Xz:$i] : ((cwcel @ (ccv @ Xz) @ XS) => (((ccfv @ (ccv @ Xz) @ XC) = ccc0) => ((ccfv @ (ccv @ Xz) @ XF) = (ccv @ Xz))))) => (! [Xz:$i] : ((cwcel @ (XA2 @ Xz) @ XS) => ((cwcel @ XK @ (ccfv @ XN @ ccuz)) => ((ccfv @ XK @ XR) = (ccfv @ XN @ XR))))))))))))))))))).
