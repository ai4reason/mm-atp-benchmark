...
thf(advcnvre_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ XX @ ccr @ cccncf))) => ((Xph => ((ccdm @ (cco @ ccr @ XF @ ccdv)) = XX)) => ((Xph => (~ (cwcel @ ccc0 @ (ccrn @ (cco @ ccr @ XF @ ccdv))))) => ((Xph => (cwf1o @ XX @ XY @ XF)) => (Xph => ((cco @ ccr @ (cccnv @ XF) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XY) @ (^ [Xx3:$i] : (cco @ cc1 @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (cccnv @ XF)) @ (cco @ ccr @ XF @ ccdv)) @ ccdiv)))))))))))))).
