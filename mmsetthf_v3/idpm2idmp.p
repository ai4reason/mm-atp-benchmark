...
thf(adecpmatid_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XC = (cco @ XN @ XP @ ccmat)) => ((XI = (ccfv @ XC @ ccur)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((Xc_0 = (ccfv @ XA2 @ cc0g)) => ((Xc_1 = (ccfv @ XA2 @ ccur)) => (((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg) & (cwcel @ XK @ ccn0)) => ((cco @ XI @ XK @ ccdecpmat) = (ccif @ (XK = ccc0) @ Xc_1 @ Xc_0))))))))))))))))))).
...
thf(aply1idvr1_thm,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XX = (ccfv @ XR @ ccv1)) => ((XN = (ccfv @ XP @ ccmgp)) => ((Xc_ex = (ccfv @ XN @ ccmg)) => ((cwcel @ XR @ ccrg) => ((cco @ ccc0 @ XX @ Xc_ex) = (ccfv @ XP @ ccur))))))))))))).
