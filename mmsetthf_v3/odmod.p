...
thf(amulgsubdir_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => (((cwcel @ XG @ ccgrp) & ((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz) & (cwcel @ XX @ XB2))) => ((cco @ (cco @ XM @ XN @ ccmin) @ XX @ Xc_x) = (cco @ (cco @ XM @ XX @ Xc_x) @ (cco @ XN @ XX @ Xc_x) @ Xc_mi)))))))))))))).
...
thf(amulgz_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XN @ ccz)) => ((cco @ XN @ Xc_0 @ Xc_x) = Xc_0))))))))))).
...
thf(codmod_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & (cwcel @ XN @ ccz)) & (cwcel @ (ccfv @ XA2 @ XO) @ ccn)) => ((cco @ (cco @ XN @ (ccfv @ XA2 @ XO) @ ccmo) @ XA2 @ Xc_x) = (cco @ XN @ XA2 @ Xc_x))))))))))))))).
