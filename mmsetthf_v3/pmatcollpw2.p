...
thf(apmatcollpw1_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : ((XC @ Xi @ Xj @ Xn) = (cco @ XN @ XP @ ccmat))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (XB2 = (ccfv @ (XC @ Xi @ Xj @ Xn) @ ccbs))))) => ((Xc_xp = (ccfv @ XP @ ccvsca)) => ((Xc_ex = (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg)) => ((XX = (ccfv @ XR @ ccv1)) => (((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg) & (cwcel @ XM @ XB2)) => (XM = (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ XP @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (cco @ XM @ (ccv @ Xn) @ ccdecpmat)) @ (cco @ (ccv @ Xn) @ XX @ Xc_ex) @ Xc_xp))) @ ccgsu)))))))))))))))))))))).
...
thf(amatgsum_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [Xc_0:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : ((XA2 @ Xy1 @ Xi @ Xj) = (cco @ XN @ XR @ ccmat))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : ((XB2 @ Xy1 @ Xi @ Xj) = (ccfv @ (XA2 @ Xy1 @ Xi @ Xj) @ ccbs))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : ((Xc_0 @ Xy1 @ Xi @ Xj) = (ccfv @ (XA2 @ Xy1 @ Xi @ Xj) @ cc0g))))) => ((! [Xi:$i] : (! [Xj:$i] : ((Xph @ Xi @ Xj) => (cwcel @ XN @ ccfn)))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : ((Xph @ Xi @ Xj) => (cwcel @ XJ @ (XW @ Xy1 @ Xi @ Xj)))))) => ((! [Xi:$i] : (! [Xj:$i] : ((Xph @ Xi @ Xj) => (cwcel @ XR @ ccrg)))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : (((Xph @ Xi @ Xj) & (cwcel @ (ccv @ Xy1) @ XJ)) => (cwcel @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (XU @ Xy1 @ Xi @ Xj)))) @ (XB2 @ Xy1 @ Xi @ Xj)))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : ((Xph @ Xi @ Xj) => (cwbr @ (ccmpt @ (^ [Xy1:$i] : XJ) @ (^ [Xy1:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (XU @ Xy1 @ Xi @ Xj)))))) @ (Xc_0 @ Xy1 @ Xi @ Xj) @ ccfsupp))))) => (! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : ((Xph @ Xi @ Xj) => ((cco @ (XA2 @ Xy1 @ Xi @ Xj) @ (ccmpt @ (^ [Xy1:$i] : XJ) @ (^ [Xy1:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (XU @ Xy1 @ Xi @ Xj)))))) @ ccgsu) = (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ XR @ (ccmpt @ (^ [Xy1:$i] : XJ) @ (^ [Xy1:$i] : (XU @ Xy1 @ Xi @ Xj))) @ ccgsu))))))))))))))))))))))))))).
...
thf(apmatcollpw2lem_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : ((XC @ Xi @ Xj @ Xn) = (cco @ XN @ XP @ ccmat))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (XB2 = (ccfv @ (XC @ Xi @ Xj @ Xn) @ ccbs))))) => ((Xc_xp = (ccfv @ XP @ ccvsca)) => ((Xc_ex = (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg)) => ((XX = (ccfv @ XR @ ccv1)) => (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg) & (cwcel @ XM @ XB2)) => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (cco @ XM @ (ccv @ Xn) @ ccdecpmat)) @ (cco @ (ccv @ Xn) @ XX @ Xc_ex) @ Xc_xp)))))) @ (ccfv @ (XC @ Xi @ Xj @ Xn) @ cc0g) @ ccfsupp))))))))))))))))))))).
