...
thf(aalephord3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((cwss @ XA2 @ XB2) <=> (cwss @ (ccfv @ XA2 @ ccale) @ (ccfv @ XB2 @ ccale))))))).
...
thf(caleph11_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => (((ccfv @ XA2 @ ccale) = (ccfv @ XB2 @ ccale)) <=> (XA2 = XB2)))))).
