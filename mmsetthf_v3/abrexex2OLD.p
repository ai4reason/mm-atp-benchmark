...
thf(cabrexex2OLD_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (cwcel @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ ccvv)) => (cwcel @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : XA2))) @ ccvv)))))).
