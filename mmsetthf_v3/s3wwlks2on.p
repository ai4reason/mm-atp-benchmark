...
thf(cs3wwlks2on_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xf1:$i] : ((XV @ Xf1) = (ccfv @ XG @ ccvtx))) => (! [Xf1:$i] : (((cwcel @ XG @ ccupgr) & (cwcel @ XA2 @ (XV @ Xf1)) & (cwcel @ XC @ (XV @ Xf1))) => ((cwcel @ (ccs3 @ XA2 @ XB2 @ XC) @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwlksnon))) <=> (? [Xf1:$i] : ((cwbr @ (ccv @ Xf1) @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccfv @ XG @ ccwlks)) & ((ccfv @ (ccv @ Xf1) @ cchash) = cc2))))))))))))).
