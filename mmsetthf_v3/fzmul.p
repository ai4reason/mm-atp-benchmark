...
thf(cfzmul_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz) & (cwcel @ XK @ ccn)) => ((cwcel @ XJ @ (cco @ XM @ XN @ ccfz)) => (cwcel @ (cco @ XK @ XJ @ ccmul) @ (cco @ (cco @ XK @ XM @ ccmul) @ (cco @ XK @ XN @ ccmul) @ ccfz))))))))).
