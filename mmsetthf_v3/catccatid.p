...
thf(acofulid_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ XC @ XD @ ccfunc))) => ((XI = (ccfv @ XD @ ccidfu)) => (Xph => ((cco @ XI @ XF @ cccofu) = XF)))))))))).
...
thf(acofurid_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ XC @ XD @ ccfunc))) => ((XI = (ccfv @ XC @ ccidfu)) => (Xph => ((cco @ XF @ XI @ cccofu) = XF)))))))))).
...
thf(acofuass_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XG @ (cco @ XC @ XD @ ccfunc))) => ((Xph => (cwcel @ XH @ (cco @ XD @ XE @ ccfunc))) => ((Xph => (cwcel @ XK @ (cco @ XE @ XF @ ccfunc))) => (Xph => ((cco @ (cco @ XK @ XH @ cccofu) @ XG @ cccofu) = (cco @ XK @ (cco @ XH @ XG @ cccofu) @ cccofu))))))))))))))).
