...
thf(acdlemg5_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((! [Xq:$i] : ((Xc_or @ Xq) = (ccfv @ XK @ ccjn))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le)))) => (cwrex @ (^ [Xq:$i] : ((XP != (ccv @ Xq)) & (~ (cwbr @ (ccv @ Xq) @ XW @ Xc_le)))) @ (^ [Xq:$i] : XA2))))))))))))))).
