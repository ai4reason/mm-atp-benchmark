...
thf(an0lplig_thm,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ ccplig) => (~ (cwcel @ cc0 @ XG))))).
...
thf(cpliguhgr_conj,conjecture,(! [XG:($i > $o)] : ((cwcel @ XG @ ccplig) => (cwcel @ (ccop @ (ccuni @ XG) @ (ccres @ ccid @ XG)) @ ccuhgr)))).
