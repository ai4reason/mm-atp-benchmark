...
thf(cjoindmss_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xph => (cwcel @ XK @ XV)) => (Xph => (cwss @ (ccdm @ Xc_or) @ (ccxp @ XB2 @ XB2)))))))))))).
