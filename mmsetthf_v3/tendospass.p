...
thf(ctendospass_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((((cwcel @ XK @ XX) & (cwcel @ XW @ XH)) & ((cwcel @ XU @ XE) & (cwcel @ XV @ XE) & (cwcel @ XF @ XT))) => ((ccfv @ XF @ (cccom @ XU @ XV)) = (ccfv @ (ccfv @ XF @ XV) @ XU)))))))))))))))).
