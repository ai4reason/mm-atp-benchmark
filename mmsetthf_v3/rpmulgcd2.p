...
thf(crpmulgcd2_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XK @ ccz) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) & ((cco @ XM @ XN @ ccgcd) = cc1)) => ((cco @ XK @ (cco @ XM @ XN @ ccmul) @ ccgcd) = (cco @ (cco @ XK @ XM @ ccgcd) @ (cco @ XK @ XN @ ccgcd) @ ccmul))))))).
