...
thf(acsbeq2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [Xx3:$i] : ((! [Xx3:$i] : ((XB2 @ Xx3) = (XC @ Xx3))) => ((ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XC @ Xx3)))))))))).
...
thf(csumeq2w_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [Xk:$i] : ((! [Xk:$i] : ((XB2 @ Xk) = (XC @ Xk))) => ((ccsu @ (XA2 @ Xk) @ (^ [Xk:$i] : (XB2 @ Xk))) = (ccsu @ (XA2 @ Xk) @ (^ [Xk:$i] : (XC @ Xk)))))))))).
