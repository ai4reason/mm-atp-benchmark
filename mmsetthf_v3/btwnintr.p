...
thf(cbtwnintr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & ((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee))) & ((cwcel @ XC @ (ccfv @ XN @ ccee)) & (cwcel @ XD @ (ccfv @ XN @ ccee)))) => (((cwbr @ XB2 @ (ccop @ XA2 @ XD) @ ccbtwn) & (cwbr @ XC @ (ccop @ XB2 @ XD) @ ccbtwn)) => (cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn))))))))).
