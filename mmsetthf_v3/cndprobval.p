...
thf(adf_cndprob_ax,axiom,(cccprob = (ccmpt @ (^ [Xp:$i] : ccprb) @ (^ [Xp:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (ccdm @ (ccv @ Xp)))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccdm @ (ccv @ Xp)))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ (ccfv @ (ccin @ (ccv @ Xa) @ (ccv @ Xb)) @ (ccv @ Xp)) @ (ccfv @ (ccv @ Xb) @ (ccv @ Xp)) @ ccdiv)))))))).
...
thf(ccndprobval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprb) & (cwcel @ XA2 @ (ccdm @ XP)) & (cwcel @ XB2 @ (ccdm @ XP))) => ((ccfv @ (ccop @ XA2 @ XB2) @ (ccfv @ XP @ cccprob)) = (cco @ (ccfv @ (ccin @ XA2 @ XB2) @ XP) @ (ccfv @ XB2 @ XP) @ ccdiv))))))).
