...
thf(cuspgr1v1eop_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XV @ XW) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XV)) => (cwcel @ (ccop @ XV @ (ccsn @ (ccop @ XA2 @ (ccsn @ XB2)))) @ ccuspgr)))))))).
