...
thf(cabfmpeld_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((XF = (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (Xph => (cwcel @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)) @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((((ccv @ Xx3) = XA2) & ((ccv @ Xy1) = XB2)) => ((Xps @ Xx3 @ Xy1) <=> Xch))))) => (! [Xx3:$i] : (Xph => (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ (XW @ Xx3))) => ((cwcel @ XB2 @ (ccfv @ XA2 @ XF)) <=> Xch)))))))))))))))).
