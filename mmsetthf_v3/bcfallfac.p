...
thf(afallfacval4_thm,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (cco @ ccc0 @ XA2 @ ccfz)) => ((cco @ XA2 @ XN @ ccfallfac) = (cco @ (ccfv @ XA2 @ ccfa) @ (ccfv @ (cco @ XA2 @ XN @ ccmin) @ ccfa) @ ccdiv)))))).
...
thf(cbcfallfac_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) => ((cco @ XN @ XK @ ccbc) = (cco @ (cco @ XN @ XK @ ccfallfac) @ (ccfv @ XK @ ccfa) @ ccdiv)))))).
