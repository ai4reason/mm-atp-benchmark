...
thf(aelwwlks2ons3im_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XW @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwlksnon))) => ((XW = (ccs3 @ XA2 @ (ccfv @ cc1 @ XW) @ XC)) & (cwcel @ (ccfv @ cc1 @ XW) @ XV)))))))))).
...
thf(celwwlks2ons3_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XW @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwlksnon))) <=> (cwrex @ (^ [Xb:$i] : ((XW = (ccs3 @ XA2 @ (ccv @ Xb) @ XC)) & (cwcel @ (ccs3 @ XA2 @ (ccv @ Xb) @ XC) @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwlksnon))))) @ (^ [Xb:$i] : XV)))))))))).
