...
thf(alincresunit3lem3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XR = (ccfv @ XM @ ccsca)) => ((XE = (ccfv @ XR @ ccbs)) => ((XU = (ccfv @ XR @ ccui)) => ((XN = (ccfv @ XR @ ccminusg)) => ((Xc_x = (ccfv @ XM @ ccvsca)) => ((((cwcel @ XM @ cclmod) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) & (cwcel @ XA2 @ XU)) => (((cco @ (ccfv @ XA2 @ XN) @ XX @ Xc_x) = (cco @ (ccfv @ XA2 @ XN) @ XY @ Xc_x)) <=> (XX = XY)))))))))))))))))))).
