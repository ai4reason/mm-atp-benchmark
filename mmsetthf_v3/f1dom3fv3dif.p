...
thf(cf1dom3fv3dif_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XY) & (cwcel @ XC @ XZ))) => ((Xph => ((XA2 != XB2) & (XA2 != XC) & (XB2 != XC))) => ((Xph => (cwf1 @ (cctp @ XA2 @ XB2 @ XC) @ XR @ XF)) => (Xph => (((ccfv @ XA2 @ XF) != (ccfv @ XB2 @ XF)) & ((ccfv @ XA2 @ XF) != (ccfv @ XC @ XF)) & ((ccfv @ XB2 @ XF) != (ccfv @ XC @ XF))))))))))))))))).
