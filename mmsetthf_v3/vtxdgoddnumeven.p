...
thf(afinsumvtxdgeven_thm,axiom,(! [XD:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xv:$i] : ((XI @ Xv) = (ccfv @ XG @ cciedg))) => ((! [Xv:$i] : ((XD @ Xv) = (ccfv @ XG @ ccvtxdg))) => (! [Xv:$i] : (((cwcel @ XG @ ccupgr) & (cwcel @ XV @ ccfn) & (cwcel @ (XI @ Xv) @ ccfn)) => (cwbr @ cc2 @ (ccsu @ XV @ (^ [Xv:$i] : (ccfv @ (ccv @ Xv) @ (XD @ Xv)))) @ ccdvds))))))))))).
...
thf(aopeo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (~ (cwbr @ cc2 @ XA2 @ ccdvds))) & ((cwcel @ XB2 @ ccz) & (cwbr @ cc2 @ XB2 @ ccdvds))) => (~ (cwbr @ cc2 @ (cco @ XA2 @ XB2 @ ccaddc) @ ccdvds)))))).
thf(cvtxdgoddnumeven_conj,conjecture,(! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XG @ cciedg)) => ((XD = (ccfv @ XG @ ccvtxdg)) => (((cwcel @ XG @ ccupgr) & (cwcel @ XV @ ccfn) & (cwcel @ XI @ ccfn)) => (cwbr @ cc2 @ (ccfv @ (ccrab @ (^ [Xv:$i] : (~ (cwbr @ cc2 @ (ccfv @ (ccv @ Xv) @ XD) @ ccdvds))) @ (^ [Xv:$i] : XV)) @ cchash) @ ccdvds)))))))))).
