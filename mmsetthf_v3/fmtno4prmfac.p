...
thf(cfmtno4prmfac_conj,conjecture,(! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwbr @ XP @ (ccfv @ cc4 @ ccfmtno) @ ccdvds) & (cwbr @ XP @ (ccfv @ (ccfv @ (ccfv @ cc4 @ ccfmtno) @ ccsqrt) @ ccfl) @ ccle)) => ((XP = (ccdc @ cc6 @ cc5)) | (XP = (ccdc @ (ccdc @ cc1 @ cc2) @ cc9)) | (XP = (ccdc @ (ccdc @ cc1 @ cc9) @ cc3)))))).
