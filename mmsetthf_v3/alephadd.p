...
thf(ainfcda_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwcel @ XB2 @ (ccdm @ cccrd)) & (cwbr @ ccom @ XA2 @ ccdom)) => (cwbr @ (cco @ XA2 @ XB2 @ cccda) @ (ccun @ XA2 @ XB2) @ ccen))))).
...
thf(calephadd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwbr @ (cco @ (ccfv @ XA2 @ ccale) @ (ccfv @ XB2 @ ccale) @ cccda) @ (ccun @ (ccfv @ XA2 @ ccale) @ (ccfv @ XB2 @ ccale)) @ ccen)))).
