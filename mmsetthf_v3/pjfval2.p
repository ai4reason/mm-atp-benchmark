...
thf(apjdm_thm,axiom,(! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XL = (ccfv @ XW @ cclss)) => ((Xc_pe = (ccfv @ XW @ ccocv)) => ((XP = (ccfv @ XW @ ccpj1)) => ((XK = (ccfv @ XW @ ccpj)) => ((cwcel @ XT @ (ccdm @ XK)) <=> ((cwcel @ XT @ XL) & (cwf @ XV @ XV @ (cco @ XT @ (ccfv @ XT @ Xc_pe) @ XP))))))))))))))))).
