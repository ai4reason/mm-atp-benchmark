...
thf(asdom0_thm,axiom,(! [XA2:($i > $o)] : (~ (cwbr @ XA2 @ cc0 @ ccsdm)))).
...
thf(afpwwe_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xy1:$i] : (XW = (ccopab @ (^ [Xx3:$i] : (^ [Xr:$i] : (((cwss @ (ccv @ Xx3) @ (XA2 @ Xy1)) & (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)))) & ((cwwe @ (ccv @ Xx3) @ (ccv @ Xr)) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccima @ (cccnv @ (ccv @ Xr)) @ (ccsn @ (ccv @ Xy1))) @ XF) = (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccv @ Xx3)))))))))) => ((! [Xy1:$i] : (Xph => (cwcel @ (XA2 @ Xy1) @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccin @ (ccpw @ (XA2 @ Xy1)) @ (ccdm @ cccrd)))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (XA2 @ Xy1))))) => ((XX = (ccuni @ (ccdm @ XW))) => (Xph => (((cwbr @ XY @ XR @ XW) & (cwcel @ (ccfv @ XY @ XF) @ XY)) <=> ((XY = XX) & (XR = (ccfv @ XX @ XW))))))))))))))))).
...
thf(afpwwelem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (XW = (ccopab @ (^ [Xx3:$i] : (^ [Xr:$i] : (((cwss @ (ccv @ Xx3) @ (XA2 @ Xy1)) & (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)))) & ((cwwe @ (ccv @ Xx3) @ (ccv @ Xr)) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccima @ (cccnv @ (ccv @ Xr)) @ (ccsn @ (ccv @ Xy1))) @ XF) = (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccv @ Xx3)))))))))) => ((! [Xy1:$i] : (Xph => (cwcel @ (XA2 @ Xy1) @ ccvv))) => (! [Xy1:$i] : (Xph => ((cwbr @ XX @ XR @ XW) <=> (((cwss @ XX @ (XA2 @ Xy1)) & (cwss @ XR @ (ccxp @ XX @ XX))) & ((cwwe @ XX @ XR) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccima @ (cccnv @ XR) @ (ccsn @ (ccv @ Xy1))) @ XF) = (ccv @ Xy1))) @ (^ [Xy1:$i] : XX)))))))))))))))).
...
thf(ainfcda1_thm,axiom,(! [XA2:($i > $o)] : ((cwbr @ ccom @ XA2 @ ccdom) => (cwbr @ (cco @ XA2 @ cc1o @ cccda) @ XA2 @ ccen)))).
thf(a_2onn_thm,axiom,(cwcel @ cc2o @ ccom)).
thf(annsdom_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccom) => (cwbr @ XA2 @ ccom @ ccsdm)))).
thf(acdafi_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwbr @ XA2 @ ccom @ ccsdm) & (cwbr @ XB2 @ ccom @ ccsdm)) => (cwbr @ (cco @ XA2 @ XB2 @ cccda) @ ccom @ ccsdm))))).
...
thf(acanthp1lem1_thm,axiom,(! [XA2:($i > $o)] : ((cwbr @ cc1o @ XA2 @ ccsdm) => (cwbr @ (cco @ XA2 @ cc2o @ cccda) @ (ccpw @ XA2) @ ccdom)))).
thf(asdomdomtr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccsdm) & (cwbr @ XB2 @ XC @ ccdom)) => (cwbr @ XA2 @ XC @ ccsdm)))))).
thf(ccanthp1lem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwbr @ cc1o @ XA2 @ ccsdm)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xr:$i] : (Xph => (cwf1o @ (ccpw @ XA2) @ (cco @ XA2 @ cc1o @ cccda) @ (XF @ Xx3 @ Xy1 @ Xr)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xr:$i] : (Xph => (cwf1o @ (ccdif @ (cco @ XA2 @ cc1o @ cccda) @ (ccsn @ (ccfv @ XA2 @ (XF @ Xx3 @ Xy1 @ Xr)))) @ XA2 @ (XG @ Xx3 @ Xy1 @ Xr)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xr:$i] : (XH = (cccom @ (cccom @ (XG @ Xx3 @ Xy1 @ Xr) @ (XF @ Xx3 @ Xy1 @ Xr)) @ (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = XA2) @ cc0 @ (ccv @ Xx3))))))))) => ((XW = (ccopab @ (^ [Xx3:$i] : (^ [Xr:$i] : (((cwss @ (ccv @ Xx3) @ XA2) & (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)))) & ((cwwe @ (ccv @ Xx3) @ (ccv @ Xr)) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccima @ (cccnv @ (ccv @ Xr)) @ (ccsn @ (ccv @ Xy1))) @ XH) = (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))) => ((XB2 = (ccuni @ (ccdm @ XW))) => (~ Xph))))))))))))))).
