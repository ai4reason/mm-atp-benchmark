...
thf(cxmulasslem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwbr @ ccc0 @ XA2 @ cclt)) & ((cwcel @ XB2 @ ccxr) & (cwbr @ ccc0 @ XB2 @ cclt)) & ((cwcel @ XC @ ccxr) & (cwbr @ ccc0 @ XC @ cclt))) => ((cco @ (cco @ XA2 @ XB2 @ ccxmu) @ XC @ ccxmu) = (cco @ XA2 @ (cco @ XB2 @ XC @ ccxmu) @ ccxmu))))))).
