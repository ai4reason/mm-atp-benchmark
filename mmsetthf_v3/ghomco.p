...
thf(agrpocl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => (((cwcel @ XG @ ccgr) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => (cwcel @ (cco @ XA2 @ XB2 @ XG) @ XX)))))))).
...
thf(cghomco_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : ((((cwcel @ XG @ ccgr) & (cwcel @ XH @ ccgr) & (cwcel @ XK @ ccgr)) & ((cwcel @ XS @ (cco @ XG @ XH @ ccghomOLD)) & (cwcel @ XT @ (cco @ XH @ XK @ ccghomOLD)))) => (cwcel @ (cccom @ XT @ XS) @ (cco @ XG @ XK @ ccghomOLD))))))))).
