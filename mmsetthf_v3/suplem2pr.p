...
thf(csuplem2pr_conj,conjecture,(! [Xy1:$i] : (! [XA2:($i > $o)] : ((cwss @ XA2 @ ccnp) => (((cwcel @ (ccv @ Xy1) @ XA2) => (~ (cwbr @ (ccuni @ XA2) @ (ccv @ Xy1) @ ccltp))) & ((cwbr @ (ccv @ Xy1) @ (ccuni @ XA2) @ ccltp) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccltp)) @ (^ [Xz:$i] : XA2)))))))).
