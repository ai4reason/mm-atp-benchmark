...
thf(aissmo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwf @ (XB2 @ Xx3 @ Xy1) @ ccon0 @ XA2))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cword @ (XB2 @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (XB2 @ Xx3 @ Xy1)) & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3 @ Xy1))) => ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XA2) @ (ccfv @ (ccv @ Xy1) @ XA2)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((ccdm @ XA2) = (XB2 @ Xx3 @ Xy1)))) => (cwsmo @ XA2)))))))).
...
thf(ar1sdom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ XA2)) => (cwbr @ (ccfv @ XB2 @ ccr1) @ (ccfv @ XA2 @ ccr1) @ ccsdm))))).
