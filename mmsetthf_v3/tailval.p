...
thf(atailfval_thm,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XD)) => ((cwcel @ XD @ ccdir) => ((ccfv @ XD @ cctail) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccima @ XD @ (ccsn @ (ccv @ Xx3))))))))))).
...
thf(ctailval_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XD)) => (((cwcel @ XD @ ccdir) & (cwcel @ XA2 @ XX)) => ((ccfv @ XA2 @ (ccfv @ XD @ cctail)) = (ccima @ XD @ (ccsn @ XA2))))))))).
