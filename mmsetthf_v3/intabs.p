...
thf(cintabs_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccint @ (^ [Xy1:$i] : (Xps @ Xy1)))) => ((Xph @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xy1:$i] : ((cwss @ (ccint @ (^ [Xy1:$i] : (Xps @ Xy1))) @ (XA2 @ Xy1)) & (Xch @ Xy1))) => (! [Xy1:$i] : ((ccint @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ (XA2 @ Xy1)) & (Xph @ Xx3)))) = (ccint @ (^ [Xx3:$i] : (Xph @ Xx3))))))))))))).
