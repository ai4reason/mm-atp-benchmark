...
thf(autopreg_thm,axiom,(! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XU @ ccutop)) => (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ XJ @ ccha)) => (cwcel @ XJ @ ccreg))))))).
thf(cuspreg_conj,conjecture,(! [XJ:($i > $o)] : (! [XW:($i > $o)] : ((XJ = (ccfv @ XW @ cctopn)) => (((cwcel @ XW @ ccusp) & (cwcel @ XJ @ ccha)) => (cwcel @ XJ @ ccreg)))))).
