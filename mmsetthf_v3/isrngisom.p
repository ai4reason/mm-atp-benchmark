...
thf(cisrngisom_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XR @ XV) & (cwcel @ XS @ XW)) => ((cwcel @ XF @ (cco @ XR @ XS @ ccrngs)) <=> ((cwcel @ XF @ (cco @ XR @ XS @ ccrngh)) & (cwcel @ (cccnv @ XF) @ (cco @ XS @ XR @ ccrngh))))))))))).
