...
thf(cleordtval_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : ((XA2 @ Xx3) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ ccpnf @ ccioc)))))) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (cco @ ccmnf @ (ccv @ Xx3) @ ccico)))))) => ((! [Xx3:$i] : ((XC @ Xx3) = (ccrn @ ccioo))) => (! [Xx3:$i] : ((ccfv @ ccle @ ccordt) = (ccfv @ (ccun @ (ccun @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ (XC @ Xx3)) @ cctg)))))))))).
