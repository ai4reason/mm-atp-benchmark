...
thf(afrgr2wwlkn0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ ccfrgr) & ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) & (XA2 != XB2)) => ((cco @ XA2 @ XB2 @ (cco @ cc2 @ XG @ ccwwlksnon)) != cc0)))))))).
...
thf(cfrgr2wwlk1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ ccfrgr) & ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) & (XA2 != XB2)) => ((ccfv @ (cco @ XA2 @ XB2 @ (cco @ cc2 @ XG @ ccwwlksnon)) @ cchash) = cc1)))))))).
