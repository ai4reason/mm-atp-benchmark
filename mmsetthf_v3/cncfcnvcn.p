...
thf(ccncfcnvcn_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((XK = (cco @ XJ @ XX @ ccrest)) => (((cwcel @ XK @ cccmp) & (cwcel @ XF @ (cco @ XX @ XY @ cccncf))) => ((cwf1o @ XX @ XY @ XF) <=> (cwcel @ (cccnv @ XF) @ (cco @ XY @ XX @ cccncf)))))))))))).
