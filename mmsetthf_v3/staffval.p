...
thf(adf_staf_ax,axiom,(ccstf = (ccmpt @ (^ [Xf1:$i] : ccvv) @ (^ [Xf1:$i] : (ccmpt @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xf1) @ ccbs)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xf1) @ ccstv)))))))).
...
thf(cstaffval_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > ($i > $o))] : (! [Xc_as:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_as = (ccfv @ XR @ ccstv)) => ((! [Xx3:$i] : ((Xc_xb @ Xx3) = (ccfv @ XR @ ccstf))) => (! [Xx3:$i] : ((Xc_xb @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ Xc_as))))))))))))).
