...
thf(alfladd_thm,axiom,(! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XD = (ccfv @ XW @ ccsca)) => ((Xc_pd = (ccfv @ XD @ ccplusg)) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => ((XF = (ccfv @ XW @ cclfn)) => (((cwcel @ XW @ cclmod) & (cwcel @ XG @ XF) & ((cwcel @ XX @ XV) & (cwcel @ XY @ XV))) => ((ccfv @ (cco @ XX @ XY @ Xc_pl) @ XG) = (cco @ (ccfv @ XX @ XG) @ (ccfv @ XY @ XG) @ Xc_pd)))))))))))))))))).
