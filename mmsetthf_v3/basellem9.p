...
thf(abasellem7_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xn:$i] : ((XG @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))))) => ((! [Xn:$i] : (cwcel @ (XA2 @ Xn) @ ccc)) => (! [Xn:$i] : (cwbr @ (cco @ (ccxp @ ccn @ (ccsn @ cc1)) @ (cco @ (ccxp @ ccn @ (ccsn @ (XA2 @ Xn))) @ (XG @ Xn) @ (ccof @ ccmul)) @ (ccof @ ccaddc)) @ cc1 @ ccli))))))).
...
thf(abasellem6_thm,axiom,(! [XG:($i > ($i > $o))] : ((! [Xn:$i] : ((XG @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))))) => (! [Xn:$i] : (cwbr @ (XG @ Xn) @ ccc0 @ ccli))))).
...
thf(aofc1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((Xph => (cwfn @ XF @ XA2)) => (((Xph & (cwcel @ XX @ XA2)) => ((ccfv @ XX @ XF) = XC)) => ((Xph & (cwcel @ XX @ XA2)) => ((ccfv @ XX @ (cco @ (ccxp @ XA2 @ (ccsn @ XB2)) @ XF @ (ccof @ XR))) = (cco @ XB2 @ XC @ XR))))))))))))))))).
...
thf(abasellem8_thm,axiom,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xn:$i] : ((XG @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))))) => ((XF = (ccseq @ ccaddc @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (ccneg @ cc2) @ ccexp))) @ cc1)) => ((! [Xn:$i] : ((XH @ Xn) = (cco @ (ccxp @ ccn @ (ccsn @ (cco @ (cco @ ccpi @ cc2 @ ccexp) @ cc6 @ ccdiv))) @ (cco @ (ccxp @ ccn @ (ccsn @ cc1)) @ (XG @ Xn) @ (ccof @ ccmin)) @ (ccof @ ccmul)))) => ((! [Xn:$i] : (XJ = (cco @ (XH @ Xn) @ (cco @ (ccxp @ ccn @ (ccsn @ cc1)) @ (cco @ (ccxp @ ccn @ (ccsn @ (ccneg @ cc2))) @ (XG @ Xn) @ (ccof @ ccmul)) @ (ccof @ ccaddc)) @ (ccof @ ccmul)))) => ((! [Xn:$i] : ((XK @ Xn) = (cco @ (XH @ Xn) @ (cco @ (ccxp @ ccn @ (ccsn @ cc1)) @ (XG @ Xn) @ (ccof @ ccaddc)) @ (ccof @ ccmul)))) => ((XN = (cco @ (cco @ cc2 @ XM @ ccmul) @ cc1 @ ccaddc)) => (! [Xn:$i] : ((cwcel @ XM @ ccn) => ((cwbr @ (ccfv @ XM @ XJ) @ (ccfv @ XM @ XF) @ ccle) & (cwbr @ (ccfv @ XM @ XF) @ (ccfv @ XM @ (XK @ Xn)) @ ccle)))))))))))))))))).
...
thf(cbasellem9_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > $o))] : ((! [Xn:$i] : ((XG @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))))) => ((XF = (ccseq @ ccaddc @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (ccneg @ cc2) @ ccexp))) @ cc1)) => ((! [Xn:$i] : ((XH @ Xn) = (cco @ (ccxp @ ccn @ (ccsn @ (cco @ (cco @ ccpi @ cc2 @ ccexp) @ cc6 @ ccdiv))) @ (cco @ (ccxp @ ccn @ (ccsn @ cc1)) @ (XG @ Xn) @ (ccof @ ccmin)) @ (ccof @ ccmul)))) => ((! [Xn:$i] : (XJ = (cco @ (XH @ Xn) @ (cco @ (ccxp @ ccn @ (ccsn @ cc1)) @ (cco @ (ccxp @ ccn @ (ccsn @ (ccneg @ cc2))) @ (XG @ Xn) @ (ccof @ ccmul)) @ (ccof @ ccaddc)) @ (ccof @ ccmul)))) => ((! [Xn:$i] : ((XK @ Xn) = (cco @ (XH @ Xn) @ (cco @ (ccxp @ ccn @ (ccsn @ cc1)) @ (XG @ Xn) @ (ccof @ ccaddc)) @ (ccof @ ccmul)))) => ((ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccv @ Xk) @ (ccneg @ cc2) @ ccexp))) = (cco @ (cco @ ccpi @ cc2 @ ccexp) @ cc6 @ ccdiv))))))))))))).
