...
thf(cballotlemelo_conj,conjecture,(! [XC:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((cwcel @ XM @ ccn) => ((cwcel @ XN @ ccn) => ((XO = (ccrab @ (^ [Xc:$i] : ((ccfv @ (ccv @ Xc) @ cchash) = XM)) @ (^ [Xc:$i] : (ccpw @ (cco @ cc1 @ (cco @ XM @ XN @ ccaddc) @ ccfz))))) => (! [Xc:$i] : ((cwcel @ (XC @ Xc) @ XO) <=> ((cwss @ (XC @ Xc) @ (cco @ cc1 @ (cco @ XM @ XN @ ccaddc) @ ccfz)) & ((ccfv @ (XC @ Xc) @ cchash) = XM)))))))))))).
