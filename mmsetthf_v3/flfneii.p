...
thf(cflfneii_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => (! [Xs1:$i] : ((((cwcel @ XJ @ cctop) & (cwcel @ XL @ (ccfv @ XY @ ccfil)) & (cwf @ XY @ XX @ XF)) & (cwcel @ (XA2 @ Xs1) @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf))) & (cwcel @ XN @ (ccfv @ (ccsn @ (XA2 @ Xs1)) @ (ccfv @ XJ @ ccnei)))) => (cwrex @ (^ [Xs1:$i] : (cwss @ (ccima @ XF @ (ccv @ Xs1)) @ XN)) @ (^ [Xs1:$i] : XL))))))))))))).
