...
thf(cvacn_conj,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((XC = (ccfv @ XU @ ccims)) => ((XJ = (ccfv @ XC @ ccmopn)) => ((XG = (ccfv @ XU @ ccpv)) => ((cwcel @ XU @ ccnv) => (cwcel @ XG @ (cco @ (cco @ XJ @ XJ @ cctx) @ XJ @ cccn))))))))))).
