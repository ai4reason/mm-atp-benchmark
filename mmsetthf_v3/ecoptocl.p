...
thf(cecoptocl_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XS @ Xx3 @ Xy1) = (ccqs @ (ccxp @ XB2 @ XC) @ XR)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccec @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XR) = XA2) => ((Xph @ Xx3 @ Xy1) <=> Xps)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XB2) & (cwcel @ (ccv @ Xy1) @ XC)) => (Xph @ Xx3 @ Xy1)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XA2 @ (XS @ Xx3 @ Xy1)) => Xps)))))))))))))).
