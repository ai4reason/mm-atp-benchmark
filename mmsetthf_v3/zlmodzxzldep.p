...
thf(azlmodzxzldeplem2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => ((XA2 = (ccpr @ (ccop @ ccc0 @ cc3) @ (ccop @ cc1 @ cc6))) => ((XB2 = (ccpr @ (ccop @ ccc0 @ cc2) @ (ccop @ cc1 @ cc4))) => ((XF = (ccpr @ (ccop @ XA2 @ cc2) @ (ccop @ XB2 @ (ccneg @ cc3)))) => (cwbr @ XF @ ccc0 @ ccfsupp)))))))))).
thf(cccmn_tp,type,(cccmn : ($i > $o))).
thf(ccplusg_tp,type,(ccplusg : ($i > $o))).
thf(ccgsu_tp,type,(ccgsu : ($i > $o))).
thf(ccvsca_tp,type,(ccvsca : ($i > $o))).
thf(ccmpt_tp,type,(ccmpt : (($i > ($i > $o)) > (($i > ($i > $o)) > ($i > $o))))).
thf(azlmodzxzldeplem3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => ((XA2 = (ccpr @ (ccop @ ccc0 @ cc3) @ (ccop @ cc1 @ cc6))) => ((XB2 = (ccpr @ (ccop @ ccc0 @ cc2) @ (ccop @ cc1 @ cc4))) => ((XF = (ccpr @ (ccop @ XA2 @ cc2) @ (ccop @ XB2 @ (ccneg @ cc3)))) => ((cco @ XF @ (ccpr @ XA2 @ XB2) @ (ccfv @ XZ @ cclinc)) = (ccfv @ XZ @ cc0g))))))))))).
thf(azlmodzxzldeplem4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xy1:$i] : ((XZ @ Xy1) = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm))) => ((XA2 = (ccpr @ (ccop @ ccc0 @ cc3) @ (ccop @ cc1 @ cc6))) => ((XB2 = (ccpr @ (ccop @ ccc0 @ cc2) @ (ccop @ cc1 @ cc4))) => ((XF = (ccpr @ (ccop @ XA2 @ cc2) @ (ccop @ XB2 @ (ccneg @ cc3)))) => (cwrex @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ XF) != ccc0)) @ (^ [Xy1:$i] : (ccpr @ XA2 @ XB2)))))))))))).
