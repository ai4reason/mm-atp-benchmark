...
thf(cs3eqs2s1eq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV) & (cwcel @ XC @ XV)) & ((cwcel @ XD @ XV) & (cwcel @ XE @ XV) & (cwcel @ XF @ XV))) => (((ccs3 @ XA2 @ XB2 @ XC) = (ccs3 @ XD @ XE @ XF)) <=> (((ccs2 @ XA2 @ XB2) = (ccs2 @ XD @ XE)) & ((ccs1 @ XC) = (ccs1 @ XF))))))))))))).
