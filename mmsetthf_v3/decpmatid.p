...
thf(cdecpmatid_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XC = (cco @ XN @ XP @ ccmat)) => ((XI = (ccfv @ XC @ ccur)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((Xc_0 = (ccfv @ XA2 @ cc0g)) => ((Xc_1 = (ccfv @ XA2 @ ccur)) => (((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg) & (cwcel @ XK @ ccn0)) => ((cco @ XI @ XK @ ccdecpmat) = (ccif @ (XK = ccc0) @ Xc_1 @ Xc_0))))))))))))))))))).
