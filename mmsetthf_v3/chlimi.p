...
thf(aspcgv_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> Xps))) => (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((! [Xx3:$i] : (Xph @ Xx3)) => Xps))))))))).
...
thf(cchlimi_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (((cwcel @ XH @ ccch) & (cwf @ ccn @ XH @ XF) & (cwbr @ XF @ XA2 @ cchli)) => (cwcel @ XA2 @ XH))))))).
