...
thf(adchrfi_thm,axiom,(! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XD = (ccfv @ XG @ ccbs)) => ((cwcel @ XN @ ccn) => (cwcel @ XD @ ccfn)))))))).
...
thf(adchrinv_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XD = (ccfv @ XG @ ccbs)) => ((Xph => (cwcel @ XX @ XD)) => ((XI = (ccfv @ XG @ ccminusg)) => (Xph => ((ccfv @ XX @ XI) = (cccom @ cccj @ XX)))))))))))))).
...
thf(agrpinv11_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XG @ ccminusg)) => ((Xph => (cwcel @ XG @ ccgrp)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => (Xph => (((ccfv @ XX @ XN) = (ccfv @ XY @ XN)) <=> (XX = XY))))))))))))))).
thf(ccmnd_tp,type,(ccmnd : ($i > $o))).
thf(agrpidcl_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((cwcel @ XG @ ccgrp) => (cwcel @ Xc_0 @ XB2)))))))).
thf(agrpinvid_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XG @ cc0g)) => ((XN = (ccfv @ XG @ ccminusg)) => ((cwcel @ XG @ ccgrp) => ((ccfv @ Xc_0 @ XN) = Xc_0)))))))).
...
thf(aclimcj_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwbr @ XF @ XA2 @ ccli)) => ((! [Xk:$i] : (Xph => (cwcel @ XG @ (XW @ Xk)))) => ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XG) = (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ cccj)))) => (Xph => (cwbr @ XG @ (ccfv @ XA2 @ cccj) @ ccli)))))))))))))))).
...
thf(afsumcj_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccc))) => (Xph => ((ccfv @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ cccj) = (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (XB2 @ Xk) @ cccj))))))))))).
...
thf(cdchrisum0re_conj,conjecture,(! [Xph:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XN @ cczn)) => ((XL = (ccfv @ XZ @ cczrh)) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XN @ ccn))) => ((! [Xy1:$i] : (! [Xm:$i] : ((XG @ Xy1 @ Xm) = (ccfv @ XN @ ccdchr)))) => ((! [Xy1:$i] : (! [Xm:$i] : (XD = (ccfv @ (XG @ Xy1 @ Xm) @ ccbs)))) => ((! [Xy1:$i] : (! [Xm:$i] : (Xc_1 = (ccfv @ (XG @ Xy1 @ Xm) @ cc0g)))) => ((! [Xy1:$i] : (! [Xm:$i] : ((XW @ Xy1 @ Xm) = (ccrab @ (^ [Xy1:$i] : ((ccsu @ ccn @ (^ [Xm:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ XL) @ (ccv @ Xy1)) @ (ccv @ Xm) @ ccdiv))) = ccc0)) @ (^ [Xy1:$i] : (ccdif @ XD @ (ccsn @ Xc_1))))))) => ((! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xy1) => (cwcel @ XX @ (XW @ Xy1 @ Xm))))) => (! [Xy1:$i] : ((Xph @ Xy1) => (cwf @ (ccfv @ XZ @ ccbs) @ ccr @ XX))))))))))))))))))))).
