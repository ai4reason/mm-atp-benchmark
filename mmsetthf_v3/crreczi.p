...
thf(ccrreczi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => (((XA2 != ccc0) | (XB2 != ccc0)) => ((cco @ cc1 @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccaddc) @ ccdiv) = (cco @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccmin) @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) @ ccdiv)))))))).
