...
thf(apcgcd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => ((cco @ XP @ (cco @ XA2 @ XB2 @ ccgcd) @ ccpc) = (ccif @ (cwbr @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc) @ ccle) @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc)))))))).
...
thf(cmumullem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn) & ((cco @ XA2 @ XB2 @ ccgcd) = cc1)) & (((ccfv @ XA2 @ ccmu) != ccc0) & ((ccfv @ XB2 @ ccmu) != ccc0))) => ((ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ ccmu) != ccc0))))).
