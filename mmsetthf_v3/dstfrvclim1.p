...
thf(ameascnbl_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : ((XJ = (ccfv @ (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress) @ cctopn)) => ((Xph => (cwcel @ XM @ (ccfv @ XS @ ccmeas))) => ((Xph => (cwf @ ccn @ XS @ XF)) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwss @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF)))) => (Xph => (cwbr @ (cccom @ XM @ XF) @ (ccfv @ (ccuni @ (ccrn @ XF)) @ XM) @ (ccfv @ XJ @ cclm))))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(adomprobmeas_thm,axiom,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprb) => (cwcel @ XP @ (ccfv @ (ccdm @ XP) @ ccmeas))))).
...
thf(aorvclteel_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XP @ ccprb)) => ((Xph => (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => (cwcel @ (cco @ XX @ XA2 @ (ccorvc @ ccle)) @ (ccdm @ XP))))))))))).
...
thf(aorvclteinc_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XP @ ccprb)) => ((Xph => (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => (Xph => (cwss @ (cco @ XX @ XA2 @ (ccorvc @ ccle)) @ (cco @ XX @ XB2 @ (ccorvc @ ccle))))))))))))))).
...
thf(adstfrvunirn_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XP @ ccprb)) => ((Xph => (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => (Xph => ((ccuni @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ XX @ (ccv @ Xn) @ (ccorvc @ ccle)))))) = (ccuni @ (ccdm @ XP)))))))))).
...
thf(aiccssico_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & ((cwbr @ XA2 @ XC @ ccle) & (cwbr @ XD @ XB2 @ cclt))) => (cwss @ (cco @ XC @ XD @ ccicc) @ (cco @ XA2 @ XB2 @ ccico)))))))).
...
thf(aprobtot_thm,axiom,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprb) => ((ccfv @ (ccuni @ (ccdm @ XP)) @ XP) = cc1)))).
...
thf(aclimmpt_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (XZ = (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : ((XG @ Xk) = (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XF))))) => (! [Xk:$i] : (((cwcel @ (XM @ Xk) @ ccz) & (cwcel @ XF @ (XV @ Xk))) => ((cwbr @ XF @ XA2 @ ccli) <=> (cwbr @ (XG @ Xk) @ XA2 @ ccli))))))))))))).
thf(annuz_thm,axiom,(ccn = (ccfv @ cc1 @ ccuz))).
thf(cdstfrvclim1_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XP @ ccprb)) => ((Xph => (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => ((! [Xx3:$i] : (Xph => ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (cco @ XX @ (ccv @ Xx3) @ (ccorvc @ ccle)) @ XP)))))) => (! [Xx3:$i] : (Xph => (cwbr @ (XF @ Xx3) @ cc1 @ ccli))))))))))).
