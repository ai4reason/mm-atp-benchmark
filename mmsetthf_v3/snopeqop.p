...
thf(csnopeqop_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XD @ ccvv) => (((ccsn @ (ccop @ XA2 @ XB2)) = (ccop @ XC @ XD)) <=> ((XA2 = XB2) & (XC = XD) & (XC = (ccsn @ XA2))))))))))))).
