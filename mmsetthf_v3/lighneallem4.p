...
thf(advdsprmpweqnn_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccn0)) => ((cwbr @ XA2 @ (cco @ XP @ XN @ ccexp) @ ccdvds) => (cwrex @ (^ [Xn:$i] : (XA2 = (cco @ XP @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn)))))))).
...
thf(an2dvdsm1_thm,axiom,(~ (cwbr @ cc2 @ (ccneg @ cc1) @ ccdvds))).
...
thf(clighneallem4_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) & (cwcel @ XM @ ccn) & (cwcel @ XN @ ccn)) & ((~ (cwbr @ cc2 @ XN @ ccdvds)) & (~ (cwbr @ cc2 @ XM @ ccdvds))) & ((cco @ (cco @ cc2 @ XN @ ccexp) @ cc1 @ ccmin) = (cco @ XP @ XM @ ccexp))) => (XM = cc1)))))).
