...
thf(cpmtrprfv3_conj,conjecture,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => (((cwcel @ XD @ XV) & ((cwcel @ XX @ XD) & (cwcel @ XY @ XD) & (cwcel @ XZ @ XD)) & ((XX != XY) & (XX != XZ) & (XY != XZ))) => ((ccfv @ XZ @ (ccfv @ (ccpr @ XX @ XY) @ XT)) = XZ)))))))))).
