...
thf(czorn2g_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwpo @ XA2 @ XR) & (! [Xw:$i] : (((cwss @ (ccv @ Xw) @ XA2) & (cwor @ (ccv @ Xw) @ XR)) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xz) @ (ccv @ Xx3) @ XR) | ((ccv @ Xz) = (ccv @ Xx3)))) @ (^ [Xz:$i] : (ccv @ Xw)))) @ (^ [Xx3:$i] : XA2))))) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
