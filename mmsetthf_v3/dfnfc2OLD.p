...
thf(cdfnfc2OLD_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : ((! [Xx3:$i] : (cwcel @ (XA2 @ Xx3) @ (XV @ Xx3 @ Xy1))) => ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) <=> (! [Xy1:$i] : ((? [X:$i] : ((^ [Xx3:$i] : ((ccv @ Xy1) = (XA2 @ Xx3))) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : ((ccv @ Xy1) = (XA2 @ Xx3))) @ X)))))))))).
