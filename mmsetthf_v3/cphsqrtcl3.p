...
thf(ccphsqrtcl3_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ cccph) & (cwcel @ cci @ XK) & (cwcel @ XA2 @ XK)) => (cwcel @ (ccfv @ XA2 @ ccsqrt) @ XK))))))))).
