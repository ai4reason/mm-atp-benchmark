...
thf(adgradd_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (ccfv @ XF @ ccdgr)) => ((XN = (ccfv @ XG @ ccdgr)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XS @ ccply))) => (cwbr @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ ccdgr) @ (ccif @ (cwbr @ XM @ XN @ ccle) @ XN @ XM) @ ccle)))))))))).
...
thf(acoeadd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XB2 = (ccfv @ XG @ cccoe)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XS @ ccply))) => ((ccfv @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ cccoe) = (cco @ XA2 @ XB2 @ (ccof @ ccaddc)))))))))))).
...
thf(cdgradd2_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (ccfv @ XF @ ccdgr)) => ((XN = (ccfv @ XG @ ccdgr)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XS @ ccply)) & (cwbr @ XM @ XN @ cclt)) => ((ccfv @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ ccdgr) = XN)))))))))).
