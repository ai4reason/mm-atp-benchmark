...
thf(cflimopn_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XF @ (ccfv @ XX @ ccfil))) => ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim)) <=> ((cwcel @ XA2 @ XX) & (cwral @ (^ [Xx3:$i] : ((cwcel @ XA2 @ (ccv @ Xx3)) => (cwcel @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : XJ)))))))))).
