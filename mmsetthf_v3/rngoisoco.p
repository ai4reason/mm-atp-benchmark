...
thf(aanim12da_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (((Xph & Xps) => Xth) => (((Xph & Xch) => Xta) => ((Xph & (Xps & Xch)) => (Xth & Xta)))))))))).
...
thf(arngoisohom_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XR @ ccrngo) & (cwcel @ XS @ ccrngo) & (cwcel @ XF @ (cco @ XR @ XS @ ccrngiso))) => (cwcel @ XF @ (cco @ XR @ XS @ ccrnghom))))))).
...
thf(arngohomco_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cwcel @ XR @ ccrngo) & (cwcel @ XS @ ccrngo) & (cwcel @ XT @ ccrngo)) & ((cwcel @ XF @ (cco @ XR @ XS @ ccrnghom)) & (cwcel @ XG @ (cco @ XS @ XT @ ccrnghom)))) => (cwcel @ (cccom @ XG @ XF) @ (cco @ XR @ XT @ ccrnghom))))))))).
thf(asyl2anc_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xph => Xch) => (((Xps & Xch) => Xth) => (Xph => Xth))))))))).
thf(aadantrl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => ((Xph & (Xth & Xps)) => Xch))))))).
thf(arngoiso1o_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XX = (ccrn @ XG)) => ((XJ = (ccfv @ XS @ cc1st)) => ((XY = (ccrn @ XJ)) => (((cwcel @ XR @ ccrngo) & (cwcel @ XS @ ccrngo) & (cwcel @ XF @ (cco @ XR @ XS @ ccrngiso))) => (cwf1o @ XX @ XY @ XF)))))))))))))).
...
thf(crngoisoco_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cwcel @ XR @ ccrngo) & (cwcel @ XS @ ccrngo) & (cwcel @ XT @ ccrngo)) & ((cwcel @ XF @ (cco @ XR @ XS @ ccrngiso)) & (cwcel @ XG @ (cco @ XS @ XT @ ccrngiso)))) => (cwcel @ (cccom @ XG @ XF) @ (cco @ XR @ XT @ ccrngiso))))))))).
