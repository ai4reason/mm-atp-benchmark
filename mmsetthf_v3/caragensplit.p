...
thf(ccaragensplit_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XS = (ccfv @ XO @ cccaragen)) => ((XX = (ccuni @ (ccdm @ XO))) => ((Xph => (cwcel @ XE @ XS)) => ((Xph => (cwss @ XA2 @ XX)) => (Xph => ((cco @ (ccfv @ (ccin @ XA2 @ XE) @ XO) @ (ccfv @ (ccdif @ XA2 @ XE) @ XO) @ ccxad) = (ccfv @ XA2 @ XO))))))))))))))).
