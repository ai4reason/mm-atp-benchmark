...
thf(apjfval_thm,axiom,(! [XP:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XL = (ccfv @ XW @ cclss)) => ((Xc_pe = (ccfv @ XW @ ccocv)) => ((XP = (ccfv @ XW @ ccpj1)) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccfv @ XW @ ccpj))) => (! [Xx3:$i] : ((XK @ Xx3) = (ccin @ (ccmpt @ (^ [Xx3:$i] : XL) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ Xc_pe) @ XP))) @ (ccxp @ ccvv @ (cco @ XV @ XV @ ccmap))))))))))))))))).
...
thf(aelpm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XF @ (cco @ XA2 @ XB2 @ ccpm)) <=> ((cwfun @ XF) & (cwss @ XF @ (ccxp @ XB2 @ XA2)))))))))).
...
thf(cpjpm_conj,conjecture,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XL = (ccfv @ XW @ cclss)) => ((XK = (ccfv @ XW @ ccpj)) => (cwcel @ XK @ (cco @ (cco @ XV @ XV @ ccmap) @ XL @ ccpm)))))))))).
