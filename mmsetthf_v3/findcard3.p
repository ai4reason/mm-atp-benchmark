...
thf(cfindcard3_conj,conjecture,(! [Xph:($i > $o)] : (! [Xch:($i > $o)] : (! [Xta:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XA2 @ Xy1)) => ((Xph @ Xx3) <=> (Xta @ Xy1))))) => ((! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ ccfn) => ((! [Xx3:$i] : ((cwpss @ (ccv @ Xx3) @ (ccv @ Xy1)) => (Xph @ Xx3))) => (Xch @ Xy1)))) => (! [Xy1:$i] : ((cwcel @ (XA2 @ Xy1) @ ccfn) => (Xta @ Xy1))))))))))).
