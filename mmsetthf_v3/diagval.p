...
thf(adf_diag_ax,axiom,(ccdiag = (ccmpt2 @ (^ [Xc:$i] : (^ [Xd:$i] : cccat)) @ (^ [Xc:$i] : (^ [Xd:$i] : cccat)) @ (^ [Xc:$i] : (^ [Xd:$i] : (cco @ (ccop @ (ccv @ Xc) @ (ccv @ Xd)) @ (cco @ (ccv @ Xc) @ (ccv @ Xd) @ cc1stf) @ cccurf)))))).
...
thf(cdiagval_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XL:($i > $o)] : ((XL = (cco @ XC @ XD @ ccdiag)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XD @ cccat)) => (Xph => (XL = (cco @ (ccop @ XC @ XD) @ (cco @ XC @ XD @ cc1stf) @ cccurf))))))))))).
