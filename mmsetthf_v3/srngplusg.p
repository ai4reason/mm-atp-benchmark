...
thf(csrngplusg_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XX:($i > $o)] : ((XR = (ccun @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl) @ (ccop @ (ccfv @ ccnx @ ccmulr) @ Xc_x)) @ (ccsn @ (ccop @ (ccfv @ ccnx @ ccstv) @ Xc_as)))) => ((cwcel @ Xc_pl @ XX) => (Xc_pl = (ccfv @ XR @ ccplusg))))))))))).
