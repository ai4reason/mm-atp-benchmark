...
thf(adfdm3_thm,axiom,(! [XA2:($i > $o)] : ((ccdm @ XA2) = (^ [Xx3:$i] : (? [Xy1:$i] : (cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XA2)))))).
thf(ccsbdm_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [Xx3:$i] : ((ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (ccdm @ (XB2 @ Xx3)))) = (ccdm @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))).
