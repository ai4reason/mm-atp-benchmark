...
thf(cdmdsl3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch) & (cwcel @ XC @ ccch)) & ((cwbr @ XB2 @ XA2 @ ccdmd) & (cwss @ XA2 @ XC) & (cwss @ XC @ (cco @ XA2 @ XB2 @ cchj)))) => ((cco @ (ccin @ XC @ XB2) @ XA2 @ cchj) = XC)))))).
