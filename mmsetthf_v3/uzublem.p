...
thf(cuzublem_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : ((? [X:$i] : ((^ [Xj:$i] : (Xph @ Xx3 @ Xj)) @ X)) => (! [X:$i] : ((^ [Xj:$i] : (Xph @ Xx3 @ Xj)) @ X)))) => ((cwnfc @ (^ [Xj:$i] : (XX @ Xj))) => ((! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xj) => (cwcel @ (XM @ Xx3) @ ccz)))) => ((! [Xx3:$i] : (! [Xj:$i] : ((XZ @ Xj) = (ccfv @ (XM @ Xx3) @ ccuz)))) => ((! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xj) => (cwcel @ (XY @ Xx3 @ Xj) @ ccr)))) => ((! [Xx3:$i] : (! [Xj:$i] : ((XW @ Xx3 @ Xj) = (ccsup @ (ccrn @ (ccmpt @ (^ [Xj:$i] : (cco @ (XM @ Xx3) @ (XK @ Xx3) @ ccfz)) @ (^ [Xj:$i] : (XB2 @ Xj)))) @ ccr @ cclt)))) => ((! [Xx3:$i] : (! [Xj:$i] : ((XX @ Xj) = (ccif @ (cwbr @ (XW @ Xx3 @ Xj) @ (XY @ Xx3 @ Xj) @ ccle) @ (XY @ Xx3 @ Xj) @ (XW @ Xx3 @ Xj))))) => ((! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xj) => (cwcel @ (XK @ Xx3) @ (XZ @ Xj))))) => ((! [Xx3:$i] : (! [Xj:$i] : (((Xph @ Xx3 @ Xj) & (cwcel @ (ccv @ Xj) @ (XZ @ Xj))) => (cwcel @ (XB2 @ Xj) @ ccr)))) => ((! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xj) => (cwral @ (^ [Xj:$i] : (cwbr @ (XB2 @ Xj) @ (XY @ Xx3 @ Xj) @ ccle)) @ (^ [Xj:$i] : (ccfv @ (XK @ Xx3) @ ccuz)))))) => (! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xj) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xj:$i] : (cwbr @ (XB2 @ Xj) @ (ccv @ Xx3) @ ccle)) @ (^ [Xj:$i] : (XZ @ Xj)))) @ (^ [Xx3:$i] : ccr)))))))))))))))))))))))).
