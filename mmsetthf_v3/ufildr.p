...
thf(afilconn_thm,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccfil)) => (cwcel @ (ccun @ XF @ (ccsn @ cc0)) @ ccconn))))).
...
thf(cufildr_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccun @ XF @ (ccsn @ cc0))) => ((cwcel @ XF @ (ccfv @ XX @ ccufil)) => ((ccun @ XJ @ (ccfv @ XJ @ cccld)) = (ccpw @ XX)))))))).
