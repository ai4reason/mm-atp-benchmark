...
thf(cscmatscmide_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_1 = (ccfv @ XA2 @ ccur)) => ((Xc_as = (ccfv @ XA2 @ ccvsca)) => ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg) & (cwcel @ XC @ XB2)) & ((cwcel @ XI @ XN) & (cwcel @ XJ @ XN))) => ((cco @ XI @ XJ @ (cco @ XC @ Xc_1 @ Xc_as)) = (ccif @ (XI = XJ) @ XC @ Xc_0))))))))))))))))))).
