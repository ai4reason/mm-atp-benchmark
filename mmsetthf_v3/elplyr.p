...
thf(celplyr_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (((cwss @ XS @ ccc) & (cwcel @ XN @ ccn0) & (cwf @ ccn0 @ XS @ XA2)) => (cwcel @ (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul))))) @ (ccfv @ XS @ ccply))))))).
