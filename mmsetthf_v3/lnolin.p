...
thf(clnolin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XY = (ccfv @ XW @ ccba)) => ((XG = (ccfv @ XU @ ccpv)) => ((XH = (ccfv @ XW @ ccpv)) => ((XR = (ccfv @ XU @ ccns)) => ((XS = (ccfv @ XW @ ccns)) => ((XL = (cco @ XU @ XW @ cclno)) => ((((cwcel @ XU @ ccnv) & (cwcel @ XW @ ccnv) & (cwcel @ XT @ XL)) & ((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ XX) & (cwcel @ XC @ XX))) => ((ccfv @ (cco @ (cco @ XA2 @ XB2 @ XR) @ XC @ XG) @ XT) = (cco @ (cco @ XA2 @ (ccfv @ XB2 @ XT) @ XS) @ (ccfv @ XC @ XT) @ XH)))))))))))))))))))))))).
