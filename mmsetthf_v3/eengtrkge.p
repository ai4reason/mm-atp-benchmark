...
thf(aaxeuclid_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & ((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee)) & (cwcel @ XC @ (ccfv @ XN @ ccee))) & ((cwcel @ XD @ (ccfv @ XN @ ccee)) & (cwcel @ XT @ (ccfv @ XN @ ccee)))) => (((cwbr @ XD @ (ccop @ XA2 @ XT) @ ccbtwn) & (cwbr @ XD @ (ccop @ XB2 @ XC) @ ccbtwn) & (XA2 != XD)) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwbr @ XB2 @ (ccop @ XA2 @ (ccv @ Xx3)) @ ccbtwn) & (cwbr @ XC @ (ccop @ XA2 @ (ccv @ Xy1)) @ ccbtwn) & (cwbr @ XT @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ ccbtwn))) @ (^ [Xy1:$i] : (ccfv @ XN @ ccee)))) @ (^ [Xx3:$i] : (ccfv @ XN @ ccee)))))))))))).
...
thf(arexeqbidva_thm,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (XA2 = XB2)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => ((Xps @ Xx3) <=> (Xch @ Xx3)))) => (Xph => ((cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)) <=> (cwrex @ (^ [Xx3:$i] : (Xch @ Xx3)) @ (^ [Xx3:$i] : XB2)))))))))))).
...
thf(aistrkge_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xa:$i] : (! [Xb:$i] : (XP = (ccfv @ (XG @ Xx3 @ Xy1 @ Xz @ Xv @ Xu @ Xa @ Xb) @ ccbs))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xa:$i] : (! [Xb:$i] : (Xc_mi = (ccfv @ (XG @ Xx3 @ Xy1 @ Xz @ Xv @ Xu @ Xa @ Xb) @ ccds))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xa:$i] : (! [Xb:$i] : (XI = (ccfv @ (XG @ Xx3 @ Xy1 @ Xz @ Xv @ Xu @ Xa @ Xb) @ ccitv))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xa:$i] : (! [Xb:$i] : ((cwcel @ (XG @ Xx3 @ Xy1 @ Xz @ Xv @ Xu @ Xa @ Xb) @ ccstrkge) <=> ((cwcel @ (XG @ Xx3 @ Xy1 @ Xz @ Xv @ Xu @ Xa @ Xb) @ ccvv) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xu:$i] : (cwral @ (^ [Xv:$i] : (((cwcel @ (ccv @ Xu) @ (cco @ (ccv @ Xx3) @ (ccv @ Xv) @ XI)) & (cwcel @ (ccv @ Xu) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XI)) & ((ccv @ Xx3) != (ccv @ Xu))) => (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : ((cwcel @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xa) @ XI)) & (cwcel @ (ccv @ Xz) @ (cco @ (ccv @ Xx3) @ (ccv @ Xb) @ XI)) & (cwcel @ (ccv @ Xv) @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ XI)))) @ (^ [Xb:$i] : XP))) @ (^ [Xa:$i] : XP)))) @ (^ [Xv:$i] : XP))) @ (^ [Xu:$i] : XP))) @ (^ [Xz:$i] : XP))) @ (^ [Xy1:$i] : XP))) @ (^ [Xx3:$i] : XP))))))))))))))))))).
