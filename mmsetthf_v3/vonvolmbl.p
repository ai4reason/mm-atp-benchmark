...
thf(aisvonmbl_thm,axiom,(! [Xph:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : ((! [Xa:$i] : ((Xph @ Xa) => (cwcel @ XX @ ccfn))) => (! [Xa:$i] : ((Xph @ Xa) => ((cwcel @ XE @ (ccdm @ (ccfv @ XX @ ccvoln))) <=> ((cwss @ XE @ (cco @ ccr @ XX @ ccmap)) & (cwral @ (^ [Xa:$i] : ((cco @ (ccfv @ (ccin @ (ccv @ Xa) @ XE) @ (ccfv @ XX @ ccovoln)) @ (ccfv @ (ccdif @ (ccv @ Xa) @ XE) @ (ccfv @ XX @ ccovoln)) @ ccxad) = (ccfv @ (ccv @ Xa) @ (ccfv @ XX @ ccovoln)))) @ (^ [Xa:$i] : (ccpw @ (cco @ ccr @ XX @ ccmap))))))))))))).
...
thf(cvonvolmbl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwss @ XB2 @ ccr)) => (Xph => ((cwcel @ (cco @ XB2 @ (ccsn @ XA2) @ ccmap) @ (ccdm @ (ccfv @ (ccsn @ XA2) @ ccvoln))) <=> (cwcel @ XB2 @ (ccdm @ ccvol))))))))))).
