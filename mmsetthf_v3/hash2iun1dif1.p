...
thf(ahash2iun_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccfn))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3))) => (cwcel @ (XC @ Xx3 @ Xy1) @ ccfn)))) => ((Xph => (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cciun @ (^ [Xy1:$i] : (XB2 @ Xx3)) @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwdisj @ (^ [Xy1:$i] : (XB2 @ Xx3)) @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))) => (Xph => ((ccfv @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cciun @ (^ [Xy1:$i] : (XB2 @ Xx3)) @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))) @ cchash) = (ccsu @ XA2 @ (^ [Xx3:$i] : (ccsu @ (XB2 @ Xx3) @ (^ [Xy1:$i] : (ccfv @ (XC @ Xx3 @ Xy1) @ cchash))))))))))))))))).
...
thf(chash2iun1dif1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccdif @ XA2 @ (ccsn @ (ccv @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3))) => (cwcel @ (XC @ Xx3 @ Xy1) @ ccfn)))) => ((Xph => (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cciun @ (^ [Xy1:$i] : (XB2 @ Xx3)) @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwdisj @ (^ [Xy1:$i] : (XB2 @ Xx3)) @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3))) => ((ccfv @ (XC @ Xx3 @ Xy1) @ cchash) = cc1)))) => (Xph => ((ccfv @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cciun @ (^ [Xy1:$i] : (XB2 @ Xx3)) @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))) @ cchash) = (cco @ (ccfv @ XA2 @ cchash) @ (cco @ (ccfv @ XA2 @ cchash) @ cc1 @ ccmin) @ ccmul)))))))))))))).
