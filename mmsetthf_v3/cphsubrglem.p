...
thf(ccphsubrglem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : ((XK = (ccfv @ XF @ ccbs)) => ((Xph => (XF = (cco @ cccnfld @ XA2 @ ccress))) => ((Xph => (cwcel @ XF @ ccdr)) => (Xph => ((XF = (cco @ cccnfld @ XK @ ccress)) & (XK = (ccin @ XA2 @ ccc)) & (cwcel @ XK @ (ccfv @ cccnfld @ ccsubrg)))))))))))).
