...
thf(aaaliou2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccin @ ccaa @ ccr)) => (cwrex @ (^ [Xk:$i] : (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xp:$i] : (cwral @ (^ [Xq:$i] : ((XA2 = (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv)) | (cwbr @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xq) @ (ccv @ Xk) @ ccexp) @ ccdiv) @ (ccfv @ (cco @ XA2 @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv) @ ccmin) @ ccabs) @ cclt))) @ (^ [Xq:$i] : ccn))) @ (^ [Xp:$i] : ccz))) @ (^ [Xx3:$i] : ccrp))) @ (^ [Xk:$i] : ccn))))).
...
thf(caaliou2b_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => (cwrex @ (^ [Xk:$i] : (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xp:$i] : (cwral @ (^ [Xq:$i] : ((XA2 = (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv)) | (cwbr @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xq) @ (ccv @ Xk) @ ccexp) @ ccdiv) @ (ccfv @ (cco @ XA2 @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv) @ ccmin) @ ccabs) @ cclt))) @ (^ [Xq:$i] : ccn))) @ (^ [Xp:$i] : ccz))) @ (^ [Xx3:$i] : ccrp))) @ (^ [Xk:$i] : ccn))))).
