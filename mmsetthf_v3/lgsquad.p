...
thf(clgsquad_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (((cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) & (cwcel @ XQ @ (ccdif @ ccprime @ (ccsn @ cc2))) & (XP != XQ)) => ((cco @ (cco @ XP @ XQ @ cclgs) @ (cco @ XQ @ XP @ cclgs) @ ccmul) = (cco @ (ccneg @ cc1) @ (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (cco @ (cco @ XQ @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccmul) @ ccexp)))))).
