...
thf(arisefallfac_thm,axiom,(! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ ccc) & (cwcel @ XN @ ccn0)) => ((cco @ XX @ XN @ ccrisefac) = (cco @ (cco @ (ccneg @ cc1) @ XN @ ccexp) @ (cco @ (ccneg @ XX) @ XN @ ccfallfac) @ ccmul)))))).
thf(cfallrisefac_conj,conjecture,(! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ ccc) & (cwcel @ XN @ ccn0)) => ((cco @ XX @ XN @ ccfallfac) = (cco @ (cco @ (ccneg @ cc1) @ XN @ ccexp) @ (cco @ (ccneg @ XX) @ XN @ ccrisefac) @ ccmul)))))).
