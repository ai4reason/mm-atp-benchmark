...
thf(aghmcyg_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XC = (ccfv @ XH @ ccbs)) => (((cwcel @ XF @ (cco @ XG @ XH @ ccghm)) & (cwfo @ XB2 @ XC @ XF)) => ((cwcel @ XG @ cccyg) => (cwcel @ XH @ cccyg))))))))))).
