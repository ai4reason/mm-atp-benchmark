...
thf(cquotval_conj,conjecture,(! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xq:$i] : ((XR @ Xq) = (cco @ XF @ (cco @ XG @ (ccv @ Xq) @ (ccof @ ccmul)) @ (ccof @ ccmin)))) => (! [Xq:$i] : (((cwcel @ XF @ (ccfv @ (XS @ Xq) @ ccply)) & (cwcel @ XG @ (ccfv @ (XS @ Xq) @ ccply)) & (XG != cc0p)) => ((cco @ XF @ XG @ ccquot) = (ccrio @ (^ [Xq:$i] : (((XR @ Xq) = cc0p) | (cwbr @ (ccfv @ (XR @ Xq) @ ccdgr) @ (ccfv @ XG @ ccdgr) @ cclt))) @ (^ [Xq:$i] : (ccfv @ ccc @ ccply)))))))))))).
