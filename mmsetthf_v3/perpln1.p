...
thf(admopabss_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (cwss @ (ccdm @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) & (Xph @ Xx3 @ Xy1)))))) @ XA2)))).
...
thf(cperpln1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwbr @ XA2 @ XB2 @ (ccfv @ XG @ ccperpg))) => (Xph => (cwcel @ XA2 @ (ccrn @ XL)))))))))))).
