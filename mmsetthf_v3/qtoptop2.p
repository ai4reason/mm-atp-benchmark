...
thf(aqtopres_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XF @ XV) => ((cco @ XJ @ XF @ ccqtop) = (cco @ XJ @ (ccres @ XF @ XX) @ ccqtop))))))))).
...
thf(aelqtop_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ XV) & (cwfo @ XZ @ XY @ XF) & (cwss @ XZ @ XX)) => ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccqtop)) <=> ((cwss @ XA2 @ XY) & (cwcel @ (ccima @ (cccnv @ XF) @ XA2) @ XJ))))))))))))).
...
thf(cqtoptop2_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XJ @ cctop) & (cwcel @ XF @ XV) & (cwfun @ XF)) => (cwcel @ (cco @ XJ @ XF @ ccqtop) @ cctop)))))).
