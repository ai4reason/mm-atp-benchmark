...
thf(aismred2_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwss @ XC @ (ccpw @ XX))) => ((! [Xs1:$i] : ((Xph & (cwss @ (ccv @ Xs1) @ XC)) => (cwcel @ (ccin @ XX @ (ccint @ (ccv @ Xs1))) @ XC))) => (Xph => (cwcel @ XC @ (ccfv @ XX @ ccmre))))))))).
...
thf(cisacs1i_conj,conjecture,(! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xs1:$i] : (((cwcel @ XX @ (XV @ Xs1)) & (cwf @ (ccpw @ XX) @ (ccpw @ XX) @ XF)) => (cwcel @ (ccrab @ (^ [Xs1:$i] : (cwss @ (ccuni @ (ccima @ XF @ (ccin @ (ccpw @ (ccv @ Xs1)) @ ccfn))) @ (ccv @ Xs1))) @ (^ [Xs1:$i] : (ccpw @ XX))) @ (ccfv @ XX @ ccacs)))))))).
