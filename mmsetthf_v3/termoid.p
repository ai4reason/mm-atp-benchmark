...
thf(ctermoid_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XO:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph & (cwcel @ XO @ (ccfv @ XC @ cctermo))) => ((cco @ XO @ XO @ XH) = (ccsn @ (ccfv @ XO @ (ccfv @ XC @ cccid)))))))))))))).
