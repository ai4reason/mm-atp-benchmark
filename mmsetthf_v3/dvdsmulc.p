...
thf(cdvdsmulc_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz) & (cwcel @ XK @ ccz)) => ((cwbr @ XM @ XN @ ccdvds) => (cwbr @ (cco @ XM @ XK @ ccmul) @ (cco @ XN @ XK @ ccmul) @ ccdvds))))))).
