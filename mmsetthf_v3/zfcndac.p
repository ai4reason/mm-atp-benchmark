...
thf(czfcndac_conj,conjecture,(! [Xx3:$i] : (? [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (((cwcel @ (ccv @ Xz) @ (ccv @ Xw)) & (cwcel @ (ccv @ Xw) @ (ccv @ Xx3))) => (? [Xv:$i] : (! [Xu:$i] : ((? [Xt:$i] : (((cwcel @ (ccv @ Xu) @ (ccv @ Xw)) & (cwcel @ (ccv @ Xw) @ (ccv @ Xt))) & ((cwcel @ (ccv @ Xu) @ (ccv @ Xt)) & (cwcel @ (ccv @ Xt) @ (ccv @ Xy1))))) <=> ((ccv @ Xu) = (ccv @ Xv))))))))))).
