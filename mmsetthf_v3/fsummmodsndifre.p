...
thf(cfsummmodsndifre_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwcel @ XN @ ccn) & (cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xk) @ ccz)) @ (^ [Xk:$i] : XA2))) => (cwcel @ (ccsu @ (ccdif @ XA2 @ (ccsn @ XX)) @ (^ [Xk:$i] : (cco @ (XB2 @ Xk) @ XN @ ccmo))) @ ccr))))))).
