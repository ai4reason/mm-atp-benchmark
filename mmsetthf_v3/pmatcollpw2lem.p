...
thf(arabssnn0fi_thm,axiom,(! [Xph:($i > $o)] : ((cwcel @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : ccn0)) @ ccfn) <=> (cwrex @ (^ [Xs1:$i] : (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xs1) @ (ccv @ Xx3) @ cclt) => (~ (Xph @ Xx3)))) @ (^ [Xx3:$i] : ccn0))) @ (^ [Xs1:$i] : ccn0))))).
