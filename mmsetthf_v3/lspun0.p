...
thf(clspun0_conj,conjecture,(! [Xph:$o] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XN = (ccfv @ XW @ cclspn)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwss @ XX @ XV)) => (Xph => ((ccfv @ (ccun @ XX @ (ccsn @ Xc_0)) @ XN) = (ccfv @ XX @ XN))))))))))))))).
