...
thf(agsuminv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((XI = (ccfv @ XG @ ccminusg)) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwbr @ XF @ Xc_0 @ ccfsupp)) => (Xph => ((cco @ XG @ (cccom @ XI @ XF) @ ccgsu) = (ccfv @ (cco @ XG @ XF @ ccgsu) @ XI))))))))))))))))))).
...
thf(cgsumsub_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwf @ XA2 @ XB2 @ XH)) => ((Xph => (cwbr @ XF @ Xc_0 @ ccfsupp)) => ((Xph => (cwbr @ XH @ Xc_0 @ ccfsupp)) => (Xph => ((cco @ XG @ (cco @ XF @ XH @ (ccof @ Xc_mi)) @ ccgsu) = (cco @ (cco @ XG @ XF @ ccgsu) @ (cco @ XG @ XH @ ccgsu) @ Xc_mi)))))))))))))))))))))).
