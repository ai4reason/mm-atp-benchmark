...
thf(avonvol_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ (ccdm @ ccvol))) => (Xph => ((ccfv @ (cco @ XB2 @ (ccsn @ XA2) @ ccmap) @ (ccfv @ (ccsn @ XA2) @ ccvoln)) = (ccfv @ XB2 @ ccvol)))))))))).
...
thf(avonmblss2_thm,axiom,(! [Xph:$o] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((Xph => (cwcel @ XY @ (ccdm @ (ccfv @ XX @ ccvoln)))) => (Xph => (cwss @ XY @ (cco @ ccr @ XX @ ccmap))))))))).
...
thf(avonvolmbl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwss @ XB2 @ ccr)) => (Xph => ((cwcel @ (cco @ XB2 @ (ccsn @ XA2) @ ccmap) @ (ccdm @ (ccfv @ (ccsn @ XA2) @ ccvoln))) <=> (cwcel @ XB2 @ (ccdm @ ccvol))))))))))).
