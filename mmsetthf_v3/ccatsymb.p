...
thf(cccatsymb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ (ccword @ XV)) & (cwcel @ XB2 @ (ccword @ XV)) & (cwcel @ XI @ ccz)) => ((ccfv @ XI @ (cco @ XA2 @ XB2 @ ccconcat)) = (ccif @ (cwbr @ XI @ (ccfv @ XA2 @ cchash) @ cclt) @ (ccfv @ XI @ XA2) @ (ccfv @ (cco @ XI @ (ccfv @ XA2 @ cchash) @ ccmin) @ XB2))))))))).
