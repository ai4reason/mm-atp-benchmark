...
thf(cpsgneldm_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XG = (ccfv @ XD @ ccsymg)) => ((XN = (ccfv @ XD @ ccpsgn)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((cwcel @ XP @ (ccdm @ XN)) <=> ((cwcel @ XP @ XB2) & (cwcel @ (ccdm @ (ccdif @ XP @ ccid)) @ ccfn)))))))))))).
