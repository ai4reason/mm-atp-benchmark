...
thf(cgcdi_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ ccn0) => ((cwcel @ XR @ ccn0) => ((cwcel @ XN @ ccn0) => (((cco @ XN @ XR @ ccgcd) = XG) => (((cco @ (cco @ XK @ XN @ ccmul) @ XR @ ccaddc) = XM) => ((cco @ XM @ XN @ ccgcd) = XG)))))))))))).
