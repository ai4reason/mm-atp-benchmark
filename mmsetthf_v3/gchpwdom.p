...
thf(agchor_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccgch) & (~ (cwcel @ XA2 @ ccfn))) & ((cwbr @ XA2 @ XB2 @ ccdom) & (cwbr @ XB2 @ (ccpw @ XA2) @ ccdom))) => ((cwbr @ XA2 @ XB2 @ ccen) | (cwbr @ XB2 @ (ccpw @ XA2) @ ccen)))))).
...
thf(cgchpwdom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwbr @ ccom @ XA2 @ ccdom) & (cwcel @ XA2 @ ccgch) & (cwcel @ XB2 @ ccgch)) => ((cwbr @ XA2 @ XB2 @ ccsdm) <=> (cwbr @ (ccpw @ XA2) @ XB2 @ ccdom)))))).
