...
thf(adgrmul2_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (ccfv @ XF @ ccdgr)) => ((XN = (ccfv @ XG @ ccdgr)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XS @ ccply))) => (cwbr @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccdgr) @ (cco @ XM @ XN @ ccaddc) @ ccle)))))))))).
...
thf(cdgrmul_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (ccfv @ XF @ ccdgr)) => ((XN = (ccfv @ XG @ ccdgr)) => ((((cwcel @ XF @ (ccfv @ XS @ ccply)) & (XF != cc0p)) & ((cwcel @ XG @ (ccfv @ XS @ ccply)) & (XG != cc0p))) => ((ccfv @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccdgr) = (cco @ XM @ XN @ ccaddc))))))))))).
