...
thf(cneival_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => ((ccfv @ XS @ (ccfv @ XJ @ ccnei)) = (ccrab @ (^ [Xv:$i] : (cwrex @ (^ [Xg1:$i] : ((cwss @ XS @ (ccv @ Xg1)) & (cwss @ (ccv @ Xg1) @ (ccv @ Xv)))) @ (^ [Xg1:$i] : XJ))) @ (^ [Xv:$i] : (ccpw @ XX)))))))))).
