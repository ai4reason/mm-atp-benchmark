...
thf(clshpne0_conj,conjecture,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((XH = (ccfv @ XW @ cclsh)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XU @ XH)) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => ((cco @ XU @ (ccfv @ (ccsn @ XX) @ XN) @ Xc_po) = XV)) => (Xph => (XX != Xc_0))))))))))))))))))))).
