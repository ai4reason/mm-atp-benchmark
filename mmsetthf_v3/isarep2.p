...
thf(cisarep2_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : ((! [Xz:$i] : (cwcel @ (XA2 @ Xz) @ ccvv)) => ((! [Xz:$i] : (cwral @ (^ [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((Xph @ Xx3 @ Xy1) & ((^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ Xz)) => ((ccv @ Xy1) = (ccv @ Xz)))))) @ (^ [Xx3:$i] : (XA2 @ Xz)))) => (! [Xz:$i] : (? [Xw:$i] : ((ccv @ Xw) = (ccima @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))) @ (XA2 @ Xz)))))))))).
