...
thf(axrgepnfd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwbr @ ccpnf @ XA2 @ ccle)) => (Xph => (XA2 = ccpnf))))))).
...
thf(axadd0ge2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => (Xph => (cwbr @ XA2 @ (cco @ XB2 @ XA2 @ ccxad) @ ccle)))))))).
