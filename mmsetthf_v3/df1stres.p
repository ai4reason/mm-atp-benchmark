...
thf(adf1st2_thm,axiom,((ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : ((ccv @ Xz) = (ccv @ Xx3)))))) = (ccres @ cc1st @ (ccxp @ ccvv @ ccvv)))).
...
thf(cdf1stres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccres @ cc1st @ (ccxp @ XA2 @ XB2)) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XA2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xx3)))))))).
