...
thf(cwilthlem1_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XN @ (cco @ cc1 @ (cco @ XP @ cc1 @ ccmin) @ ccfz))) => ((XN = (cco @ (cco @ XN @ (cco @ XP @ cc2 @ ccmin) @ ccexp) @ XP @ ccmo)) <=> ((XN = cc1) | (XN = (cco @ XP @ cc1 @ ccmin)))))))).
