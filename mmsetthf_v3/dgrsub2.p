...
thf(cdgrsub2_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XN = (ccfv @ XF @ ccdgr)) => ((((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XT @ ccply))) & (((ccfv @ XG @ ccdgr) = XN) & (cwcel @ XN @ ccn) & ((ccfv @ XN @ (ccfv @ XF @ cccoe)) = (ccfv @ XN @ (ccfv @ XG @ cccoe))))) => (cwbr @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmin)) @ ccdgr) @ XN @ cclt))))))))).
