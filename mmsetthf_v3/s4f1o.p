...
thf(cs4f1o_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : ((((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS)) & ((cwcel @ XC @ XS) & (cwcel @ XD @ XS))) => ((((XA2 != XB2) & (XA2 != XC) & (XA2 != XD)) & ((XB2 != XC) & (XB2 != XD) & (XC != XD))) => ((XE = (ccs4 @ XA2 @ XB2 @ XC @ XD)) => (cwf1o @ (ccdm @ XE) @ (ccun @ (ccpr @ XA2 @ XB2) @ (ccpr @ XC @ XD)) @ XE))))))))))).
