...
thf(ahashuni_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwss @ XA2 @ ccfn)) => ((Xph => (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3)))) => (Xph => ((ccfv @ (ccuni @ XA2) @ cchash) = (ccsu @ XA2 @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ cchash))))))))))).
