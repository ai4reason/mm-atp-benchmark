...
thf(ciedginwlk_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => (((cwfun @ XI) & (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) & (cwcel @ XX @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))) => (cwcel @ (ccfv @ (ccfv @ XX @ XF) @ XI) @ (ccrn @ XI)))))))))).
