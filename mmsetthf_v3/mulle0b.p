...
thf(amulge0b_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul) @ ccle) <=> (((cwbr @ XA2 @ ccc0 @ ccle) & (cwbr @ XB2 @ ccc0 @ ccle)) | ((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ ccc0 @ XB2 @ ccle)))))))).
...
thf(cmulle0b_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ (cco @ XA2 @ XB2 @ ccmul) @ ccc0 @ ccle) <=> (((cwbr @ XA2 @ ccc0 @ ccle) & (cwbr @ ccc0 @ XB2 @ ccle)) | ((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ XB2 @ ccc0 @ ccle)))))))).
