...
thf(cobsip_conj,conjecture,(! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_1 = (ccfv @ XF @ ccur)) => ((Xc_0 = (ccfv @ XF @ cc0g)) => (((cwcel @ XB2 @ (ccfv @ XW @ ccobs)) & (cwcel @ XP @ XB2) & (cwcel @ XQ @ XB2)) => ((cco @ XP @ XQ @ Xc_xi) = (ccif @ (XP = XQ) @ Xc_1 @ Xc_0)))))))))))))))))).
