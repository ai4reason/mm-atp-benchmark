...
thf(amressmrcd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ (ccfv @ XX @ ccmre))) => ((XN = (ccfv @ XA2 @ ccmrc)) => ((Xph => (cwss @ XS @ (ccfv @ XT @ XN))) => ((Xph => (cwss @ XT @ XS)) => (Xph => ((ccfv @ XS @ XN) = (ccfv @ XT @ XN)))))))))))))).
...
thf(cmrieqvlemd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XA2 @ (ccfv @ XX @ ccmre))) => ((XN = (ccfv @ XA2 @ ccmrc)) => ((Xph => (cwss @ XS @ XX)) => ((Xph => (cwcel @ XY @ XS)) => (Xph => ((cwcel @ XY @ (ccfv @ (ccdif @ XS @ (ccsn @ XY)) @ XN)) <=> ((ccfv @ (ccdif @ XS @ (ccsn @ XY)) @ XN) = (ccfv @ XS @ XN))))))))))))))).
