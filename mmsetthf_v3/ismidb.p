...
thf(amideu_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((XS = (ccfv @ XG @ ccmir)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwbr @ XG @ cc2 @ ccstrkgld)) => (Xph => (cwreu @ (^ [Xx3:$i] : (XB2 = (ccfv @ XA2 @ (ccfv @ (ccv @ Xx3) @ XS)))) @ (^ [Xx3:$i] : XP)))))))))))))))))))))).
