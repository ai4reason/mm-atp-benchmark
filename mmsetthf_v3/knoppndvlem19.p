...
thf(cknoppndvlem19_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((! [Xm:$i] : ((XA2 @ Xm) = (cco @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccneg @ XJ) @ ccexp) @ cc2 @ ccdiv) @ (ccv @ Xm) @ ccmul))) => ((! [Xm:$i] : ((XB2 @ Xm) = (cco @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccneg @ XJ) @ ccexp) @ cc2 @ ccdiv) @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc) @ ccmul))) => ((Xph => (cwcel @ XJ @ ccn0)) => ((Xph => (cwcel @ XH @ ccr)) => ((Xph => (cwcel @ XN @ ccn)) => (Xph => (cwrex @ (^ [Xm:$i] : ((cwbr @ (XA2 @ Xm) @ XH @ ccle) & (cwbr @ XH @ (XB2 @ Xm) @ ccle))) @ (^ [Xm:$i] : ccz))))))))))))))).
