...
thf(celecxrn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XB2 @ (ccec @ XA2 @ (ccxrn @ XR @ XS))) <=> (? [Xx3:$i] : (? [Xy1:$i] : ((XB2 = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) & (cwbr @ XA2 @ (ccv @ Xx3) @ XR) & (cwbr @ XA2 @ (ccv @ Xy1) @ XS)))))))))))).
