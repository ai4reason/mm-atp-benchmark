...
thf(citg2le_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF) & (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccicc) @ XG) & (cwbr @ XF @ XG @ (ccofr @ ccle))) => (cwbr @ (ccfv @ XF @ ccitg2) @ (ccfv @ XG @ ccitg2) @ ccle))))).
