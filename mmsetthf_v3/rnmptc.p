...
thf(crnmptc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ XB2 @ XC))) => ((Xph => (XA2 != cc0)) => (! [Xx3:$i] : (Xph => ((ccrn @ (XF @ Xx3)) = (ccsn @ XB2))))))))))))).
