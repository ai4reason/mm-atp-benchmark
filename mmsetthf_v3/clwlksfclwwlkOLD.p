...
thf(aclwlksfclwwlk2sswdOLD_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((! [Xc:$i] : ((XA2 @ Xc) = (ccfv @ (ccv @ Xc) @ cc1st))) => ((! [Xc:$i] : ((XB2 @ Xc) = (ccfv @ (ccv @ Xc) @ cc2nd))) => ((! [Xc:$i] : ((XC @ Xc) = (ccrab @ (^ [Xc:$i] : ((ccfv @ (XA2 @ Xc) @ cchash) = XN)) @ (^ [Xc:$i] : (ccfv @ XG @ ccclwlks))))) => ((! [Xc:$i] : ((XF @ Xc) = (ccmpt @ (^ [Xc:$i] : (XC @ Xc)) @ (^ [Xc:$i] : (cco @ (XB2 @ Xc) @ (ccop @ ccc0 @ (ccfv @ (XA2 @ Xc) @ cchash)) @ ccsubstr))))) => (! [Xc:$i] : ((cwcel @ (ccv @ Xc) @ (XC @ Xc)) => ((ccfv @ (XA2 @ Xc) @ cchash) = (ccfv @ (cco @ (XB2 @ Xc) @ (ccop @ ccc0 @ (ccfv @ (XA2 @ Xc) @ cchash)) @ ccsubstr) @ cchash))))))))))))))).
