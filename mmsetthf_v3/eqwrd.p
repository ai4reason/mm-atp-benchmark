...
thf(ceqwrd_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xi:$i] : (((cwcel @ XU @ (ccword @ (XV @ Xi))) & (cwcel @ XW @ (ccword @ (XV @ Xi)))) => ((XU = XW) <=> (((ccfv @ XU @ cchash) = (ccfv @ XW @ cchash)) & (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XU) = (ccfv @ (ccv @ Xi) @ XW))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XU @ cchash) @ ccfzo))))))))))).
