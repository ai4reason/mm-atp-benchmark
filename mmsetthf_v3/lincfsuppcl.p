...
thf(clincfsuppcl_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XR = (ccfv @ XM @ ccsca)) => ((XS = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XM @ cclmod) & ((cwcel @ XV @ XW) & (cwss @ XV @ XB2)) & ((cwcel @ XF @ (cco @ XS @ XV @ ccmap)) & (cwbr @ XF @ Xc_0 @ ccfsupp))) => (cwcel @ (cco @ XF @ XV @ (ccfv @ XM @ cclinc)) @ XB2))))))))))))))).
