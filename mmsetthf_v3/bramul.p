...
thf(cbramul_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ ccc) & (cwcel @ XC @ cchil)) => ((ccfv @ (cco @ XB2 @ XC @ ccsm) @ (ccfv @ XA2 @ ccbr)) = (cco @ XB2 @ (ccfv @ XC @ (ccfv @ XA2 @ ccbr)) @ ccmul))))))).
