...
thf(cig1peu_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XU = (ccfv @ XP @ cclidl)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((XM = (ccfv @ XR @ ccmn1)) => ((XD = (ccfv @ XR @ ccdg1)) => (((cwcel @ XR @ ccdr) & (cwcel @ XI @ XU) & (XI != (ccsn @ Xc_0))) => (cwreu @ (^ [Xg1:$i] : ((ccfv @ (ccv @ Xg1) @ XD) = (ccinf @ (ccima @ XD @ (ccdif @ XI @ (ccsn @ Xc_0))) @ ccr @ cclt))) @ (^ [Xg1:$i] : (ccin @ XI @ XM))))))))))))))))).
