...
thf(aresiexd_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XB2 @ XV)) => (Xph => (cwcel @ (ccres @ ccid @ XB2) @ ccvv))))))).
