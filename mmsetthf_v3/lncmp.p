...
thf(aisline3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((! [Xq:$i] : (! [Xp:$i] : ((Xc_or @ Xq @ Xp) = (ccfv @ XK @ ccjn)))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xq:$i] : (! [Xp:$i] : ((XN @ Xq @ Xp) = (ccfv @ XK @ cclines)))) => ((XM = (ccfv @ XK @ ccpmap)) => (! [Xq:$i] : (! [Xp:$i] : (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2)) => ((cwcel @ (ccfv @ XX @ XM) @ (XN @ Xq @ Xp)) <=> (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (((ccv @ Xp) != (ccv @ Xq)) & (XX = (cco @ (ccv @ Xp) @ (ccv @ Xq) @ (Xc_or @ Xq @ Xp))))) @ (^ [Xq:$i] : XA2))) @ (^ [Xp:$i] : XA2))))))))))))))))))).
...
thf(alneq2at_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XN = (ccfv @ XK @ cclines)) => ((XM = (ccfv @ XK @ ccpmap)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2) & (cwcel @ (ccfv @ XX @ XM) @ XN)) & ((cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2) & (XP != XQ)) & ((cwbr @ XP @ XX @ Xc_le) & (cwbr @ XQ @ XX @ Xc_le))) => (XX = (cco @ XP @ XQ @ Xc_or)))))))))))))))))))).
...
thf(clncmp_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XN = (ccfv @ XK @ cclines)) => ((XM = (ccfv @ XK @ ccpmap)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) & ((cwcel @ (ccfv @ XX @ XM) @ XN) & (cwcel @ (ccfv @ XY @ XM) @ XN))) => ((cwbr @ XX @ XY @ Xc_le) <=> (XX = XY))))))))))))))).
