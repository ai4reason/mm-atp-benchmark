...
thf(csetindtrs_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xz:$i] : ((cwral @ (^ [Xy1:$i] : (Xps @ Xy1 @ Xz)) @ (^ [Xy1:$i] : (ccv @ Xx3))) => (Xph @ Xx3)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xps @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (XB2 @ Xy1)) => ((Xph @ Xx3) <=> (Xch @ Xy1 @ Xz)))))) => (! [Xy1:$i] : (! [Xz:$i] : ((? [Xz:$i] : ((cwtr @ (ccv @ Xz)) & (cwcel @ (XB2 @ Xy1) @ (ccv @ Xz)))) => (Xch @ Xy1 @ Xz)))))))))))).
