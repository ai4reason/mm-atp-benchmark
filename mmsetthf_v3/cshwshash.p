...
thf(acshwrepswhash1_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xw:$i] : (! [Xn:$i] : ((XM @ Xw @ Xn) = (ccrab @ (^ [Xw:$i] : (cwrex @ (^ [Xn:$i] : ((cco @ XW @ (ccv @ Xn) @ cccsh) = (ccv @ Xw))) @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)))) @ (^ [Xw:$i] : (ccword @ XV)))))) => (! [Xw:$i] : (! [Xn:$i] : (((cwcel @ XA2 @ XV) & (cwcel @ XN @ ccn) & (XW = (cco @ XA2 @ XN @ ccreps))) => ((ccfv @ (XM @ Xw @ Xn) @ cchash) = cc1))))))))))).
...
thf(ccshwshash_conj,conjecture,(! [XM:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xw:$i] : (! [Xn:$i] : ((XM @ Xw @ Xn) = (ccrab @ (^ [Xw:$i] : (cwrex @ (^ [Xn:$i] : ((cco @ XW @ (ccv @ Xn) @ cccsh) = (ccv @ Xw))) @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)))) @ (^ [Xw:$i] : (ccword @ XV)))))) => (! [Xw:$i] : (! [Xn:$i] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ (ccfv @ XW @ cchash) @ ccprime)) => (((ccfv @ (XM @ Xw @ Xn) @ cchash) = (ccfv @ XW @ cchash)) | ((ccfv @ (XM @ Xw @ Xn) @ cchash) = cc1)))))))))).
