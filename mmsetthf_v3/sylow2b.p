...
thf(asylow2blem3_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_pl:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XX @ ccfn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XH @ (ccfv @ XG @ ccsubg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XK @ (ccfv @ XG @ ccsubg))))) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_sm = (cco @ XG @ XK @ ccqg)) => ((Xc_x = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XH)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccqs @ XX @ Xc_sm))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrn @ (ccmpt @ (^ [Xz:$i] : (ccv @ Xy1)) @ (^ [Xz:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_pl)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : ((Xph @ Xx3 @ Xy1) => (cwbr @ (XP @ Xx3 @ Xy1 @ Xz @ Xg1) @ (cco @ XG @ XH @ ccress) @ ccpgp)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : ((Xph @ Xx3 @ Xy1) => ((ccfv @ XK @ cchash) = (cco @ (XP @ Xx3 @ Xy1 @ Xz @ Xg1) @ (cco @ (XP @ Xx3 @ Xy1 @ Xz @ Xg1) @ (ccfv @ XX @ cchash) @ ccpc) @ ccexp))))))) => ((! [Xy1:$i] : (! [Xg1:$i] : ((Xc_mi @ Xy1 @ Xg1) = (ccfv @ XG @ ccsg)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwrex @ (^ [Xg1:$i] : (cwss @ XH @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XK) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xg1) @ (ccv @ Xx3) @ Xc_pl) @ (ccv @ Xg1) @ (Xc_mi @ Xy1 @ Xg1))))))) @ (^ [Xg1:$i] : XX)))))))))))))))))))))))))).
