...
thf(adf_dgraa_ax,axiom,(ccdgraa = (ccmpt @ (^ [Xx3:$i] : ccaa) @ (^ [Xx3:$i] : (ccinf @ (ccrab @ (^ [Xd:$i] : (cwrex @ (^ [Xp:$i] : (((ccfv @ (ccv @ Xp) @ ccdgr) = (ccv @ Xd)) & ((ccfv @ (ccv @ Xx3) @ (ccv @ Xp)) = ccc0))) @ (^ [Xp:$i] : (ccdif @ (ccfv @ ccq @ ccply) @ (ccsn @ cc0p))))) @ (^ [Xd:$i] : ccn)) @ ccr @ cclt))))).
...
thf(cdgraaval_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => ((ccfv @ XA2 @ ccdgraa) = (ccinf @ (ccrab @ (^ [Xd:$i] : (cwrex @ (^ [Xp:$i] : (((ccfv @ (ccv @ Xp) @ ccdgr) = (ccv @ Xd)) & ((ccfv @ XA2 @ (ccv @ Xp)) = ccc0))) @ (^ [Xp:$i] : (ccdif @ (ccfv @ ccq @ ccply) @ (ccsn @ cc0p))))) @ (^ [Xd:$i] : ccn)) @ ccr @ cclt))))).
