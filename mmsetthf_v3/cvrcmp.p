...
thf(ccvrcmp_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XC = (ccfv @ XK @ cccvr)) => (((cwcel @ XK @ ccpo) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2) & (cwcel @ XZ @ XB2)) & ((cwbr @ XZ @ XX @ XC) & (cwbr @ XZ @ XY @ XC))) => ((cwbr @ XX @ XY @ Xc_le) <=> (XX = XY)))))))))))))).
