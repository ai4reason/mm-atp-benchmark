...
thf(amdetleib_thm,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xp:$i] : ((XD @ Xx3 @ Xp) = (cco @ XN @ XR @ ccmdat)))) => ((! [Xx3:$i] : (! [Xp:$i] : ((XA2 @ Xx3 @ Xp) = (cco @ XN @ XR @ ccmat)))) => ((! [Xx3:$i] : (! [Xp:$i] : ((XB2 @ Xx3 @ Xp) = (ccfv @ (XA2 @ Xx3 @ Xp) @ ccbs)))) => ((! [Xx3:$i] : (! [Xp:$i] : ((XP @ Xx3 @ Xp) = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)))) => ((! [Xx3:$i] : (! [Xp:$i] : ((XY @ Xx3 @ Xp) = (ccfv @ XR @ cczrh)))) => ((! [Xx3:$i] : (! [Xp:$i] : ((XS @ Xx3 @ Xp) = (ccfv @ XN @ ccpsgn)))) => ((! [Xx3:$i] : (! [Xp:$i] : ((Xc_x @ Xx3 @ Xp) = (ccfv @ XR @ ccmulr)))) => ((! [Xx3:$i] : (! [Xp:$i] : ((XU @ Xx3 @ Xp) = (ccfv @ XR @ ccmgp)))) => (! [Xx3:$i] : (! [Xp:$i] : ((cwcel @ XM @ (XB2 @ Xx3 @ Xp)) => ((ccfv @ XM @ (XD @ Xx3 @ Xp)) = (cco @ XR @ (ccmpt @ (^ [Xp:$i] : (XP @ Xx3 @ Xp)) @ (^ [Xp:$i] : (cco @ (ccfv @ (ccv @ Xp) @ (cccom @ (XY @ Xx3 @ Xp) @ (XS @ Xx3 @ Xp))) @ (cco @ (XU @ Xx3 @ Xp) @ (ccmpt @ (^ [Xx3:$i] : XN) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xp)) @ (ccv @ Xx3) @ XM))) @ ccgsu) @ (Xc_x @ Xx3 @ Xp)))) @ ccgsu))))))))))))))))))))))))).
...
thf(agrpinvf_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XG @ ccminusg)) => ((cwcel @ XG @ ccgrp) => (cwf @ XB2 @ XB2 @ XN)))))))).
thf(ccio_tp,type,(ccio : (($i > $o) > ($i > $o)))).
thf(afveq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))).
thf(agsummptfidminv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xx3:$i] : (XB2 = (ccfv @ (XG @ Xx3) @ ccbs))) => ((! [Xx3:$i] : ((Xc_0 @ Xx3) = (ccfv @ (XG @ Xx3) @ cc0g))) => ((! [Xx3:$i] : ((XI @ Xx3) = (ccfv @ (XG @ Xx3) @ ccminusg))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XG @ Xx3) @ ccabl))) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XC @ Xx3) @ XB2))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))) => (! [Xx3:$i] : (Xph => ((cco @ (XG @ Xx3) @ (cccom @ (XI @ Xx3) @ (XF @ Xx3)) @ ccgsu) = (ccfv @ (cco @ (XG @ Xx3) @ (XF @ Xx3) @ ccgsu) @ (XI @ Xx3))))))))))))))))))))).
...
thf(agsummptfif1o_thm,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xi:$i] : (XB2 = (ccfv @ (XG @ Xi) @ ccbs))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwcel @ (XG @ Xi) @ cccmn))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwcel @ XN @ ccfn))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwral @ (^ [Xi:$i] : (cwcel @ (XX @ Xi) @ XB2)) @ (^ [Xi:$i] : XN)))) => ((! [Xi:$i] : ((XF @ Xi) = (ccmpt @ (^ [Xi:$i] : XN) @ (^ [Xi:$i] : (XX @ Xi))))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwf1o @ (XC @ Xi) @ XN @ (XH @ Xi)))) => (! [Xi:$i] : ((Xph @ Xi) => ((cco @ (XG @ Xi) @ (XF @ Xi) @ ccgsu) = (cco @ (XG @ Xi) @ (cccom @ (XF @ Xi) @ (XH @ Xi)) @ ccgsu))))))))))))))))))).
...
thf(apmtrrn_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((XR = (ccrn @ XT)) => (((cwcel @ XD @ XV) & (cwss @ XP @ XD) & (cwbr @ XP @ cc2o @ ccen)) => (cwcel @ (ccfv @ XP @ XT) @ XR)))))))))).
...
thf(aneleqtrrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (~ (cwcel @ XC @ XB2))) => ((Xph => (XA2 = XB2)) => (Xph => (~ (cwcel @ XC @ XA2)))))))))).
...
thf(cmdetralt_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xa:$i] : ((XD @ Xa) = (cco @ XN @ (XR @ Xa) @ ccmdat))) => ((! [Xa:$i] : ((XA2 @ Xa) = (cco @ XN @ (XR @ Xa) @ ccmat))) => ((! [Xa:$i] : ((XB2 @ Xa) = (ccfv @ (XA2 @ Xa) @ ccbs))) => ((! [Xa:$i] : ((Xc_0 @ Xa) = (ccfv @ (XR @ Xa) @ cc0g))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwcel @ (XR @ Xa) @ cccrg))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwcel @ XX @ (XB2 @ Xa)))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwcel @ XI @ XN))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwcel @ XJ @ XN))) => ((! [Xa:$i] : ((Xph @ Xa) => (XI != XJ))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwral @ (^ [Xa:$i] : ((cco @ XI @ (ccv @ Xa) @ XX) = (cco @ XJ @ (ccv @ Xa) @ XX))) @ (^ [Xa:$i] : XN)))) => (! [Xa:$i] : ((Xph @ Xa) => ((ccfv @ XX @ (XD @ Xa)) = (Xc_0 @ Xa))))))))))))))))))))))))).
