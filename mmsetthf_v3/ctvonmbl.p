...
thf(cctvonmbl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((Xph => (cwss @ XA2 @ (cco @ ccr @ XX @ ccmap))) => ((Xph => (cwbr @ XA2 @ ccom @ ccdom)) => (Xph => (cwcel @ XA2 @ (ccdm @ (ccfv @ XX @ ccvoln))))))))))).
