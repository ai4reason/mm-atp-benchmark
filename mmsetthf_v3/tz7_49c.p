...
thf(ctz7_49c_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((cwfn @ XF @ ccon0) => (! [Xx3:$i] : (((cwcel @ XA2 @ (XB2 @ Xx3)) & (cwral @ (^ [Xx3:$i] : (((ccdif @ XA2 @ (ccima @ XF @ (ccv @ Xx3))) != cc0) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccdif @ XA2 @ (ccima @ XF @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : ccon0))) => (cwrex @ (^ [Xx3:$i] : (cwf1o @ (ccv @ Xx3) @ XA2 @ (ccres @ XF @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0))))))))).
