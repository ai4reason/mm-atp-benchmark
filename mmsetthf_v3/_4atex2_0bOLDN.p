...
thf(a_4atex2_0aOLDN_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xz:$i] : ((XH @ Xz) = (ccfv @ XK @ cclh))) => (! [Xz:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ (XH @ Xz))) & (((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) & ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le))) & (XS = (ccfv @ XK @ ccp0))) & ((XP != XQ) & ((cwcel @ XT @ XA2) & (~ (cwbr @ XT @ XW @ Xc_le))) & (cwrex @ (^ [Xr:$i] : ((~ (cwbr @ (ccv @ Xr) @ XW @ Xc_le)) & ((cco @ XP @ (ccv @ Xr) @ Xc_or) = (cco @ XQ @ (ccv @ Xr) @ Xc_or)))) @ (^ [Xr:$i] : XA2)))) => (cwrex @ (^ [Xz:$i] : ((~ (cwbr @ (ccv @ Xz) @ XW @ Xc_le)) & ((cco @ XS @ (ccv @ Xz) @ Xc_or) = (cco @ XT @ (ccv @ Xz) @ Xc_or)))) @ (^ [Xz:$i] : XA2))))))))))))))))))).
...
thf(c_4atex2_0bOLDN_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xz:$i] : ((XH @ Xz) = (ccfv @ XK @ cclh))) => (! [Xz:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ (XH @ Xz))) & (((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) & ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le))) & ((cwcel @ XS @ XA2) & (~ (cwbr @ XS @ XW @ Xc_le)))) & ((XP != XQ) & (XT = (ccfv @ XK @ ccp0)) & (cwrex @ (^ [Xr:$i] : ((~ (cwbr @ (ccv @ Xr) @ XW @ Xc_le)) & ((cco @ XP @ (ccv @ Xr) @ Xc_or) = (cco @ XQ @ (ccv @ Xr) @ Xc_or)))) @ (^ [Xr:$i] : XA2)))) => (cwrex @ (^ [Xz:$i] : ((~ (cwbr @ (ccv @ Xz) @ XW @ Xc_le)) & ((cco @ XS @ (ccv @ Xz) @ Xc_or) = (cco @ XT @ (ccv @ Xz) @ Xc_or)))) @ (^ [Xz:$i] : XA2))))))))))))))))))).
