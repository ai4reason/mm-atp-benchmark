...
thf(afsumkthpow_thm,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XK @ ccn0) & (cwcel @ XM @ ccn0)) => ((ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ XK @ ccexp))) = (cco @ (cco @ (cco @ (cco @ XK @ cc1 @ ccaddc) @ (cco @ XM @ cc1 @ ccaddc) @ ccbp) @ (cco @ (cco @ XK @ cc1 @ ccaddc) @ ccc0 @ ccbp) @ ccmin) @ (cco @ XK @ cc1 @ ccaddc) @ ccdiv)))))).
...
thf(abpoly4_thm,axiom,(! [XX:($i > $o)] : ((cwcel @ XX @ ccc) => ((cco @ cc4 @ XX @ ccbp) = (cco @ (cco @ (cco @ (cco @ XX @ cc4 @ ccexp) @ (cco @ cc2 @ (cco @ XX @ cc3 @ ccexp) @ ccmul) @ ccmin) @ (cco @ XX @ cc2 @ ccexp) @ ccaddc) @ (cco @ cc1 @ (ccdc @ cc3 @ ccc0) @ ccdiv) @ ccmin))))).
