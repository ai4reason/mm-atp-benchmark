...
thf(ainawina_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccina) => (cwcel @ XA2 @ ccwina)))).
thf(asylbid_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps <=> Xch)) => ((Xph => (Xch => Xth)) => (Xph => (Xps => Xth))))))))).
thf(asyl6bb_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps <=> Xch)) => ((Xch <=> Xth) => (Xph => (Xps <=> Xth))))))))).
thf(aeleq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cwcel @ XC @ XA2) <=> (cwcel @ XC @ XB2))))))))).
thf(asyl2anc_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xph => Xch) => (((Xps & Xch) => Xth) => (Xph => Xth))))))))).
thf(awinaon_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccwina) => (cwcel @ XA2 @ ccon0)))).
thf(cccrd_tp,type,(cccrd : ($i > $o))).
thf(ccom_tp,type,(ccom : ($i > $o))).
thf(awinalim_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccwina) => (cwlim @ XA2)))).
thf(ar1lim_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XA2 @ (XB2 @ Xx3)) & (cwlim @ XA2)) => ((ccfv @ XA2 @ ccr1) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ ccr1))))))))).
...
thf(ar1pw_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccon0) => ((cwcel @ XA2 @ (ccfv @ XB2 @ ccr1)) <=> (cwcel @ (ccpw @ XA2) @ (ccfv @ (ccsuc @ XB2) @ ccr1))))))).
...
thf(ar1tr2_thm,axiom,(! [XA2:($i > $o)] : (cwss @ (ccuni @ (ccfv @ XA2 @ ccr1)) @ (ccfv @ XA2 @ ccr1)))).
...
thf(arankr1ag_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) & (cwcel @ XB2 @ (ccdm @ ccr1))) => ((cwcel @ XA2 @ (ccfv @ XB2 @ ccr1)) <=> (cwcel @ (ccfv @ XA2 @ ccrnk) @ XB2)))))).
