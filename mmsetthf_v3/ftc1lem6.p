...
thf(aftc1lem5_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xt:$i] : ((XG @ Xx3 @ Xt) = (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccitg @ (^ [Xt:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccioo)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ XF)))))))) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ XD)) => ((Xph => (cwss @ XD @ ccr)) => ((Xph => (cwcel @ XF @ ccibl)) => ((Xph => (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : (Xph => (cwcel @ XF @ (ccfv @ XC @ (cco @ (XK @ Xx3 @ Xy1 @ Xz @ Xt) @ (XL @ Xt) @ cccnp)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : ((XJ @ Xx3 @ Xy1 @ Xz @ Xt) = (cco @ (XL @ Xt) @ ccr @ ccrest)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : ((XK @ Xx3 @ Xy1 @ Xz @ Xt) = (cco @ (XL @ Xt) @ XD @ ccrest)))))) => ((! [Xt:$i] : ((XL @ Xt) = (ccfv @ cccnfld @ cctopn))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xt:$i] : ((XH @ Xx3 @ Xz @ Xt) = (ccmpt @ (^ [Xz:$i] : (ccdif @ (cco @ XA2 @ XB2 @ ccicc) @ (ccsn @ XC))) @ (^ [Xz:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xz) @ (XG @ Xx3 @ Xt)) @ (ccfv @ XC @ (XG @ Xx3 @ Xt)) @ ccmin) @ (cco @ (ccv @ Xz) @ XC @ ccmin) @ ccdiv))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (Xph => (cwcel @ (XE @ Xx3 @ Xz) @ ccrp)))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xt:$i] : (Xph => (cwcel @ (XR @ Xx3 @ Xz @ Xt) @ ccrp))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XD)) => ((cwbr @ (ccfv @ (cco @ (ccv @ Xy1) @ XC @ ccmin) @ ccabs) @ (XR @ Xx3 @ Xz @ Xt) @ cclt) => (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ XC @ XF) @ ccmin) @ ccabs) @ (XE @ Xx3 @ Xz) @ cclt))))))) => ((! [Xy1:$i] : (Xph => (cwcel @ (XX @ Xy1) @ (cco @ XA2 @ XB2 @ ccicc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : (Xph => (cwbr @ (ccfv @ (cco @ (XX @ Xy1) @ XC @ ccmin) @ ccabs) @ (XR @ Xx3 @ Xz @ Xt) @ cclt)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : ((Xph & ((XX @ Xy1) != XC)) => (cwbr @ (ccfv @ (cco @ (ccfv @ (XX @ Xy1) @ (XH @ Xx3 @ Xz @ Xt)) @ (ccfv @ XC @ XF) @ ccmin) @ ccabs) @ (XE @ Xx3 @ Xz) @ cclt))))))))))))))))))))))))))))))))))))))).
...
thf(advlem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XD @ ccc @ XF)) => ((Xph => (cwss @ XD @ ccc)) => ((Xph => (cwcel @ XB2 @ XD)) => ((Xph & (cwcel @ XA2 @ (ccdif @ XD @ (ccsn @ XB2)))) => (cwcel @ (cco @ (cco @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ ccmin) @ (cco @ XA2 @ XB2 @ ccmin) @ ccdiv) @ ccc))))))))))).
