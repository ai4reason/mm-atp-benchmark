...
thf(cspeimfw_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3 @ Xy1) => (Xps @ Xx3 @ Xy1))))) => (! [Xy1:$i] : ((~ (! [Xx3:$i] : (~ ((ccv @ Xx3) = (ccv @ Xy1))))) => ((! [Xx3:$i] : (Xph @ Xx3 @ Xy1)) => (? [Xx3:$i] : (Xps @ Xx3 @ Xy1))))))))).
