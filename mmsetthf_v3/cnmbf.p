...
thf(aismbf1_thm,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ ccmbf) <=> ((cwcel @ XF @ (cco @ ccc @ ccr @ ccpm)) & (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccima @ (cccnv @ (cccom @ ccre @ XF)) @ (ccv @ Xx3)) @ (ccdm @ ccvol)) & (cwcel @ (ccima @ (cccnv @ (cccom @ ccim @ XF)) @ (ccv @ Xx3)) @ (ccdm @ ccvol)))) @ (^ [Xx3:$i] : (ccrn @ ccioo))))))).
thf(ccnmbf_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ XF @ (cco @ XA2 @ ccc @ cccncf))) => (cwcel @ XF @ ccmbf))))).
