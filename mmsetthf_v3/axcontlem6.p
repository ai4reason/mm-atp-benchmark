...
thf(aaxcontlem5_thm,axiom,(! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xi:$i] : (! [Xp:$i] : ((XD @ Xi @ Xp) = (ccrab @ (^ [Xp:$i] : ((cwbr @ XU @ (ccop @ XZ @ (ccv @ Xp)) @ ccbtwn) | (cwbr @ (ccv @ Xp) @ (ccop @ XZ @ XU) @ ccbtwn))) @ (^ [Xp:$i] : (ccfv @ XN @ ccee)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xi:$i] : (! [Xp:$i] : ((XF @ Xx3 @ Xt @ Xi @ Xp) = (ccopab @ (^ [Xx3:$i] : (^ [Xt:$i] : ((cwcel @ (ccv @ Xx3) @ (XD @ Xi @ Xp)) & ((cwcel @ (ccv @ Xt) @ (cco @ ccc0 @ ccpnf @ ccico)) & (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ (ccv @ Xx3)) = (cco @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccfv @ (ccv @ Xi) @ XZ) @ ccmul) @ (cco @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ XU) @ ccmul) @ ccaddc))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz))))))))))))) => (! [Xx3:$i] : (! [Xt:$i] : (! [Xi:$i] : (! [Xp:$i] : (((((cwcel @ XN @ ccn) & (cwcel @ XZ @ (ccfv @ XN @ ccee)) & (cwcel @ XU @ (ccfv @ XN @ ccee))) & (XZ != XU)) & (cwcel @ (XP @ Xp) @ (XD @ Xi @ Xp))) => (((ccfv @ (XP @ Xp) @ (XF @ Xx3 @ Xt @ Xi @ Xp)) = (XT @ Xp)) <=> ((cwcel @ (XT @ Xp) @ (cco @ ccc0 @ ccpnf @ ccico)) & (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ (XP @ Xp)) = (cco @ (cco @ (cco @ cc1 @ (XT @ Xp) @ ccmin) @ (ccfv @ (ccv @ Xi) @ XZ) @ ccmul) @ (cco @ (XT @ Xp) @ (ccfv @ (ccv @ Xi) @ XU) @ ccmul) @ ccaddc))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz)))))))))))))))))))).
