...
thf(czringlpirlem3_conj,conjecture,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XI @ (ccfv @ czring @ cclidl))) => ((Xph => (XI != (ccsn @ ccc0))) => ((XG = (ccinf @ (ccin @ XI @ ccn) @ ccr @ cclt)) => ((Xph => (cwcel @ XX @ XI)) => (Xph => (cwbr @ XG @ XX @ ccdvds))))))))))).
