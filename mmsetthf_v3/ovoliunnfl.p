...
thf(aovolctb_thm,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccr) & (cwbr @ XA2 @ ccn @ ccen)) => ((ccfv @ XA2 @ ccovol) = ccc0)))).
...
thf(aovolre_thm,axiom,((ccfv @ ccr @ ccovol) = ccpnf)).
