...
thf(aatcvrj0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => ((XC = (ccfv @ XK @ cccvr)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cwcel @ XK @ cchlt) & ((cwcel @ XX @ XB2) & (cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2)) & (cwbr @ XX @ (cco @ XP @ XQ @ Xc_or) @ XC)) => ((XX = Xc_0) <=> (XP = XQ)))))))))))))))))).
...
thf(acvrat_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_lt = (ccfv @ XK @ ccplt)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cwcel @ XK @ cchlt) & ((cwcel @ XX @ XB2) & (cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2))) => (((XX != Xc_0) & (cwbr @ XX @ (cco @ XP @ XQ @ Xc_or) @ Xc_lt)) => (cwcel @ XX @ XA2)))))))))))))))))).
thf(ccvrat2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XC = (ccfv @ XK @ cccvr)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cwcel @ XK @ cchlt) & ((cwcel @ XX @ XB2) & (cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2)) & ((XP != XQ) & (cwbr @ XX @ (cco @ XP @ XQ @ Xc_or) @ XC))) => (cwcel @ XX @ XA2))))))))))))))).
