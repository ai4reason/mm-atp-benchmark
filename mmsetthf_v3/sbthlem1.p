...
thf(csbthlem1_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xg1:$i] : (cwcel @ (XA2 @ Xf1 @ Xg1) @ ccvv))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XD @ Xf1 @ Xg1) = (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ (XA2 @ Xf1 @ Xg1)) & (cwss @ (ccima @ (ccv @ Xg1) @ (ccdif @ (XB2 @ Xf1 @ Xg1) @ (ccima @ (ccv @ Xf1) @ (ccv @ Xx3)))) @ (ccdif @ (XA2 @ Xf1 @ Xg1) @ (ccv @ Xx3)))))))) => (! [Xf1:$i] : (! [Xg1:$i] : (cwss @ (ccuni @ (XD @ Xf1 @ Xg1)) @ (ccdif @ (XA2 @ Xf1 @ Xg1) @ (ccima @ (ccv @ Xg1) @ (ccdif @ (XB2 @ Xf1 @ Xg1) @ (ccima @ (ccv @ Xf1) @ (ccuni @ (XD @ Xf1 @ Xg1))))))))))))))).
