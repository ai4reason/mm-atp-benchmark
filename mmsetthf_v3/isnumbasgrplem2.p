...
thf(abasfn_thm,axiom,(cwfn @ ccbs @ ccvv)).
...
thf(agrprcan_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (((cwcel @ XG @ ccgrp) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2) & (cwcel @ XZ @ XB2))) => (((cco @ XX @ XZ @ Xc_pl) = (cco @ XY @ XZ @ Xc_pl)) <=> (XX = XY)))))))))))).
thf(aharndom_thm,axiom,(! [XX:($i > $o)] : (~ (cwbr @ (ccfv @ XX @ cchar) @ XX @ ccdom)))).
thf(cwfo_tp,type,(cwfo : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(awdomnumr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ (ccdm @ cccrd)) => ((cwbr @ XA2 @ XB2 @ ccwdom) <=> (cwbr @ XA2 @ XB2 @ ccdom)))))).
