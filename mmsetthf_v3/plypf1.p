...
thf(asubrgply1_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : ((XS = (ccfv @ XR @ ccpl1)) => ((XH = (cco @ XR @ XT @ ccress)) => ((XU = (ccfv @ XH @ ccpl1)) => ((XB2 = (ccfv @ XU @ ccbs)) => ((cwcel @ XT @ (ccfv @ XR @ ccsubrg)) => (cwcel @ XB2 @ (ccfv @ XS @ ccsubrg)))))))))))))).
...
thf(apwselbasb_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XY = (cco @ XR @ XI @ ccpws)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XV = (ccfv @ XY @ ccbs)) => (((cwcel @ XR @ XW) & (cwcel @ XI @ XZ)) => ((cwcel @ XX @ XV) <=> (cwf @ XI @ XB2 @ XX))))))))))))))).
...
thf(asubrg1asclcl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XA2 = (ccfv @ XP @ ccascl)) => ((XH = (cco @ XR @ XT @ ccress)) => ((XU = (ccfv @ XH @ ccpl1)) => ((Xph => (cwcel @ XT @ (ccfv @ XR @ ccsubrg))) => ((XB2 = (ccfv @ XU @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((Xph => (cwcel @ XX @ XK)) => (Xph => ((cwcel @ (ccfv @ XX @ XA2) @ XB2) <=> (cwcel @ XX @ XT)))))))))))))))))))))).
...
thf(asubrgvr1cl_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XR @ ccv1)) => ((Xph => (cwcel @ XT @ (ccfv @ XR @ ccsubrg))) => ((XH = (cco @ XR @ XT @ ccress)) => ((XU = (ccfv @ XH @ ccpl1)) => ((XB2 = (ccfv @ XU @ ccbs)) => (Xph => (cwcel @ XX @ XB2))))))))))))))).
thf(asubmmulgcl_thm,axiom,(! [XS:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xc_xb = (ccfv @ XG @ ccmg)) => (((cwcel @ XS @ (ccfv @ XG @ ccsubmnd)) & (cwcel @ XN @ ccn0) & (cwcel @ XX @ XS)) => (cwcel @ (cco @ XN @ XX @ Xc_xb) @ XS))))))))).
...
thf(aply1coe_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XX = (ccfv @ XR @ ccv1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xc_x = (ccfv @ XP @ ccvsca)) => ((! [Xk:$i] : ((XM @ Xk) = (ccfv @ XP @ ccmgp))) => ((! [Xk:$i] : (Xc_ex = (ccfv @ (XM @ Xk) @ ccmg))) => ((XA2 = (ccfv @ XK @ ccco1)) => (((cwcel @ XR @ ccrg) & (cwcel @ XK @ XB2)) => (XK = (cco @ XP @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ (ccv @ Xk) @ XX @ Xc_ex) @ Xc_x))) @ ccgsu)))))))))))))))))))).
thf(agsummhm_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => (cwcel @ XG @ cccmn)) => ((Xph => (cwcel @ XH @ ccmnd)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XK @ (cco @ XG @ XH @ ccmhm))) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwbr @ XF @ Xc_0 @ ccfsupp)) => (Xph => ((cco @ XH @ (cccom @ XK @ XF) @ ccgsu) = (ccfv @ (cco @ XG @ XF @ ccgsu) @ XK))))))))))))))))))))).
...
thf(adeg1ge_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XA2 = (ccfv @ XF @ ccco1)) => (((cwcel @ XF @ XB2) & (cwcel @ XG @ ccn0) & ((ccfv @ XG @ XA2) != Xc_0)) => (cwbr @ XG @ (ccfv @ XF @ XD) @ ccle)))))))))))))))).
...
thf(cplypf1_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : ((XR = (cco @ cccnfld @ XS @ ccress)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XA2 = (ccfv @ XP @ ccbs)) => ((XE = (ccfv @ cccnfld @ cce1)) => ((cwcel @ XS @ (ccfv @ cccnfld @ ccsubrg)) => ((ccfv @ XS @ ccply) = (ccima @ XE @ XA2))))))))))))).
