...
thf(areprfi2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XS @ ccn0)) => ((Xph => (cwss @ XA2 @ ccn)) => (Xph => (cwcel @ (cco @ XA2 @ XN @ (ccfv @ XS @ ccrepr)) @ ccfn)))))))))).
...
thf(aleexp2_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) & (cwbr @ cc1 @ XA2 @ cclt)) => ((cwbr @ XM @ XN @ ccle) <=> (cwbr @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccle))))))).
...
thf(ahgt750lemd_thm,axiom,(! [Xph:$o] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwbr @ (cco @ (ccdc @ cc1 @ ccc0) @ (ccdc @ cc2 @ cc7) @ ccexp) @ XN @ ccle)) => (Xph => (cwbr @ (ccsu @ (ccun @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ ccprime) @ (ccsn @ cc2)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ ccvma))) @ (cco @ (cco @ cc1 @ (ccdp2 @ cc4 @ (ccdp2 @ cc2 @ (ccdp2 @ cc6 @ cc3))) @ ccdp) @ (ccfv @ XN @ ccsqrt) @ ccmul) @ cclt))))))).
thf(afzfid_thm,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (Xph => (cwcel @ (cco @ XM @ XN @ ccfz) @ ccfn)))))).
thf(ahgt750lemc_thm,axiom,(! [Xph:($i > $o)] : (! [XN:($i > $o)] : ((! [Xj:$i] : ((Xph @ Xj) => (cwcel @ XN @ ccn))) => (! [Xj:$i] : ((Xph @ Xj) => (cwbr @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xj:$i] : (ccfv @ (ccv @ Xj) @ ccvma))) @ (cco @ (cco @ cc1 @ (ccdp2 @ ccc0 @ (ccdp2 @ cc3 @ (ccdp2 @ cc8 @ (ccdp2 @ cc8 @ cc3)))) @ ccdp) @ XN @ ccmul) @ cclt))))))).
...
thf(ahgt750lem2_thm,axiom,(cwbr @ (cco @ cc3 @ (cco @ (cco @ (cco @ (cco @ cc1 @ (ccdp2 @ ccc0 @ (ccdp2 @ cc7 @ (ccdp2 @ cc9 @ (ccdp2 @ cc9 @ (ccdp2 @ cc5 @ cc5))))) @ ccdp) @ cc2 @ ccexp) @ (cco @ cc1 @ (ccdp2 @ cc4 @ (ccdp2 @ cc1 @ cc4)) @ ccdp) @ ccmul) @ (cco @ (cco @ cc1 @ (ccdp2 @ cc4 @ (ccdp2 @ cc2 @ (ccdp2 @ cc6 @ cc3))) @ ccdp) @ (cco @ cc1 @ (ccdp2 @ ccc0 @ (ccdp2 @ cc3 @ (ccdp2 @ cc8 @ (ccdp2 @ cc8 @ cc3)))) @ ccdp) @ ccmul) @ ccmul) @ ccmul) @ (cco @ cc7 @ (ccdp2 @ cc3 @ (ccdp2 @ cc4 @ cc8)) @ ccdp) @ cclt)).
...
thf(adivsqrtid_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => ((cco @ XA2 @ (ccfv @ XA2 @ ccsqrt) @ ccdiv) = (ccfv @ XA2 @ ccsqrt))))).
