...
thf(covolfcl_conj,conjecture,(! [XF:($i > $o)] : (! [XN:($i > $o)] : (((cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF) & (cwcel @ XN @ ccn)) => ((cwcel @ (ccfv @ (ccfv @ XN @ XF) @ cc1st) @ ccr) & (cwcel @ (ccfv @ (ccfv @ XN @ XF) @ cc2nd) @ ccr) & (cwbr @ (ccfv @ (ccfv @ XN @ XF) @ cc1st) @ (ccfv @ (ccfv @ XN @ XF) @ cc2nd) @ ccle)))))).
