...
thf(cvtxdeqd_conj,conjecture,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XG @ XX)) => ((Xph => (cwcel @ XH @ XY)) => ((Xph => ((ccfv @ XH @ ccvtx) = (ccfv @ XG @ ccvtx))) => ((Xph => ((ccfv @ XH @ cciedg) = (ccfv @ XG @ cciedg))) => (Xph => ((ccfv @ XH @ ccvtxdg) = (ccfv @ XG @ ccvtxdg))))))))))))).
