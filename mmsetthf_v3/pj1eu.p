...
thf(asubgdisjb_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((XZ = (ccfv @ XG @ cccntz)) => ((Xph => (cwcel @ XT @ (ccfv @ XG @ ccsubg))) => ((Xph => (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((Xph => ((ccin @ XT @ XU) = (ccsn @ Xc_0))) => ((Xph => (cwss @ XT @ (ccfv @ XU @ XZ))) => ((Xph => (cwcel @ XA2 @ XT)) => ((Xph => (cwcel @ XC @ XT)) => ((Xph => (cwcel @ XB2 @ XU)) => ((Xph => (cwcel @ XD @ XU)) => (Xph => (((cco @ XA2 @ XB2 @ Xc_pl) = (cco @ XC @ XD @ Xc_pl)) <=> ((XA2 = XC) & (XB2 = XD))))))))))))))))))))))))))).
...
thf(cpj1eu_conj,conjecture,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > $o)))] : ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_po = (ccfv @ XG @ cclsm)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_0 @ Xx3 @ Xy1) = (ccfv @ XG @ cc0g)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XZ @ Xx3 @ Xy1) = (ccfv @ XG @ cccntz)))) => ((Xph => (cwcel @ XT @ (ccfv @ XG @ ccsubg))) => ((Xph => (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((ccin @ XT @ XU) = (ccsn @ (Xc_0 @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwss @ XT @ (ccfv @ XU @ (XZ @ Xx3 @ Xy1)))))) => ((Xph & (cwcel @ XX @ (cco @ XT @ XU @ Xc_po))) => (cwreu @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (XX = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl))) @ (^ [Xy1:$i] : XU))) @ (^ [Xx3:$i] : XT))))))))))))))))))))).
