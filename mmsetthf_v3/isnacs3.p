...
thf(anacsacs_thm,axiom,(! [XC:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XC @ (ccfv @ XX @ ccnacs)) => (cwcel @ XC @ (ccfv @ XX @ ccacs)))))).
...
thf(anacsfg_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => (((cwcel @ XC @ (ccfv @ XX @ ccnacs)) & (cwcel @ XS @ XC)) => (cwrex @ (^ [Xg1:$i] : (XS = (ccfv @ (ccv @ Xg1) @ XF))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XX) @ ccfn)))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(asyl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(amrefg2_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => ((cwcel @ XC @ (ccfv @ XX @ ccmre)) => ((cwrex @ (^ [Xg1:$i] : (XS = (ccfv @ (ccv @ Xg1) @ XF))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XX) @ ccfn))) <=> (cwrex @ (^ [Xg1:$i] : (XS = (ccfv @ (ccv @ Xg1) @ XF))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XS) @ ccfn))))))))))).
