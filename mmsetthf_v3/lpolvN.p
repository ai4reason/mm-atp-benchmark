...
thf(clpolvN_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XP = (ccfv @ XW @ cclpoN)) => ((Xph => (cwcel @ XW @ XX)) => ((Xph => (cwcel @ Xc_pe @ XP)) => (Xph => ((ccfv @ XV @ Xc_pe) = (ccsn @ Xc_0)))))))))))))))).
