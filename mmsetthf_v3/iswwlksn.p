...
thf(ciswwlksn_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) <=> ((cwcel @ XW @ (ccfv @ XG @ ccwwlks)) & ((ccfv @ XW @ cchash) = (cco @ XN @ cc1 @ ccaddc))))))))).
