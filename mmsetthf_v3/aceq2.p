...
thf(caceq2_conj,conjecture,(! [Xx3:$i] : ((? [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (cwreu @ (^ [Xv:$i] : (cwrex @ (^ [Xu:$i] : ((cwcel @ (ccv @ Xz) @ (ccv @ Xu)) & (cwcel @ (ccv @ Xv) @ (ccv @ Xu)))) @ (^ [Xu:$i] : (ccv @ Xy1)))) @ (^ [Xv:$i] : (ccv @ Xz)))) @ (^ [Xw:$i] : (ccv @ Xz)))) @ (^ [Xz:$i] : (ccv @ Xx3)))) <=> (? [Xy1:$i] : (cwral @ (^ [Xz:$i] : (((ccv @ Xz) != cc0) => (cwreu @ (^ [Xw:$i] : (cwrex @ (^ [Xv:$i] : ((cwcel @ (ccv @ Xz) @ (ccv @ Xv)) & (cwcel @ (ccv @ Xw) @ (ccv @ Xv)))) @ (^ [Xv:$i] : (ccv @ Xy1)))) @ (^ [Xw:$i] : (ccv @ Xz))))) @ (^ [Xz:$i] : (ccv @ Xx3))))))).
