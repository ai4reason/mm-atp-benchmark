...
thf(amatmulcell_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [Xc_xp:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xj:$i] : ((XA2 @ Xj) = (cco @ XN @ XR @ ccmat))) => ((! [Xj:$i] : (XB2 = (ccfv @ (XA2 @ Xj) @ ccbs))) => ((! [Xj:$i] : ((Xc_x @ Xj) = (ccfv @ XR @ ccmulr))) => ((! [Xj:$i] : ((Xc_xp @ Xj) = (ccfv @ (XA2 @ Xj) @ ccmulr))) => (! [Xj:$i] : (((cwcel @ XR @ ccrg) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) & ((cwcel @ XI @ XN) & (cwcel @ XJ @ XN))) => ((cco @ XI @ XJ @ (cco @ XX @ XY @ (Xc_xp @ Xj))) = (cco @ XR @ (ccmpt @ (^ [Xj:$i] : XN) @ (^ [Xj:$i] : (cco @ (cco @ XI @ (ccv @ Xj) @ XX) @ (cco @ (ccv @ Xj) @ XJ @ XY) @ (ccfv @ XR @ ccmulr)))) @ ccgsu))))))))))))))))))).
...
thf(amatvscacell_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XA2 @ ccvsca)) => ((Xc_xp = (ccfv @ XR @ ccmulr)) => (((cwcel @ XR @ ccrg) & ((cwcel @ XX @ XK) & (cwcel @ XY @ XB2)) & ((cwcel @ XI @ XN) & (cwcel @ XJ @ XN))) => ((cco @ XI @ XJ @ (cco @ XX @ XY @ Xc_x)) = (cco @ XX @ (cco @ XI @ XJ @ XY) @ Xc_xp)))))))))))))))))))).
...
thf(cscmatscm_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_xp:($i > ($i > ($i > $o)))] : (! [Xc_as:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XK = (ccfv @ XR @ ccbs)) => ((! [Xc:$i] : ((XA2 @ Xc) = (cco @ XN @ XR @ ccmat))) => ((! [Xm:$i] : (! [Xc:$i] : ((XB2 @ Xm @ Xc) = (ccfv @ (XA2 @ Xc) @ ccbs)))) => ((! [Xc:$i] : ((Xc_as @ Xc) = (ccfv @ (XA2 @ Xc) @ ccvsca))) => ((! [Xm:$i] : (! [Xc:$i] : ((Xc_xp @ Xm @ Xc) = (ccfv @ (XA2 @ Xc) @ ccmulr)))) => ((XS = (cco @ XN @ XR @ ccscmat)) => ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) & (cwcel @ XC @ XS)) => (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xm:$i] : ((cco @ XC @ (ccv @ Xm) @ (Xc_xp @ Xm @ Xc)) = (cco @ (ccv @ Xc) @ (ccv @ Xm) @ (Xc_as @ Xc)))) @ (^ [Xm:$i] : (XB2 @ Xm @ Xc)))) @ (^ [Xc:$i] : XK))))))))))))))))))).
