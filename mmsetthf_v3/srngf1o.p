...
thf(asrngcnv_thm,axiom,(! [XR:($i > $o)] : (! [Xc_as:($i > $o)] : ((Xc_as = (ccfv @ XR @ ccstf)) => ((cwcel @ XR @ ccsr) => (Xc_as = (cccnv @ Xc_as))))))).
thf(ccdm_tp,type,(ccdm : (($i > $o) > ($i > $o)))).
thf(cwfun_tp,type,(cwfun : (($i > $o) > $o))).
thf(adff1o4_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf1o @ XA2 @ XB2 @ XF) <=> ((cwfn @ XF @ XA2) & (cwfn @ (cccnv @ XF) @ XB2))))))).
thf(csrngf1o_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_as:($i > $o)] : ((Xc_as = (ccfv @ XR @ ccstf)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((cwcel @ XR @ ccsr) => (cwf1o @ XB2 @ XB2 @ Xc_as)))))))).
