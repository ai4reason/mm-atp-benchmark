...
thf(cusgredgreu_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ cciedg)) => (((cwcel @ XG @ ccusgr) & (cwcel @ XX @ (ccdm @ XE)) & (cwcel @ XY @ (ccfv @ XX @ XE))) => (cwreu @ (^ [Xy1:$i] : ((ccfv @ XX @ XE) = (ccpr @ XY @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XV))))))))))).
