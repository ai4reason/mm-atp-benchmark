...
thf(ccshweqrep_conj,conjecture,(! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XL @ ccz)) => ((((cco @ XW @ XL @ cccsh) = XW) & (cwcel @ XI @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) => (cwral @ (^ [Xj:$i] : ((ccfv @ XI @ XW) = (ccfv @ (cco @ (cco @ XI @ (cco @ (ccv @ Xj) @ XL @ ccmul) @ ccaddc) @ (ccfv @ XW @ cchash) @ ccmo) @ XW))) @ (^ [Xj:$i] : ccn0))))))))).
