...
thf(cdchrzrhmul_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XZ = (ccfv @ XN @ cczn)) => ((XD = (ccfv @ XG @ ccbs)) => ((XL = (ccfv @ XZ @ cczrh)) => ((Xph => (cwcel @ XX @ XD)) => ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XC @ ccz)) => (Xph => ((ccfv @ (ccfv @ (cco @ XA2 @ XC @ ccmul) @ XL) @ XX) = (cco @ (ccfv @ (ccfv @ XA2 @ XL) @ XX) @ (ccfv @ (ccfv @ XC @ XL) @ XX) @ ccmul)))))))))))))))))))).
