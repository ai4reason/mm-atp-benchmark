...
thf(climsuppnfdlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (Xph => (cwss @ (XA2 @ Xx3 @ Xj @ Xk) @ ccr))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (Xph => (cwf @ (XA2 @ Xx3 @ Xj @ Xk) @ ccxr @ XF))))) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xj:$i] : ((cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) & (cwbr @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xj) @ XF) @ ccle))) @ (^ [Xj:$i] : (XA2 @ Xx3 @ Xj @ Xk)))) @ (^ [Xk:$i] : ccr))) @ (^ [Xx3:$i] : ccr))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XG @ Xx3 @ Xj @ Xk) = (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccsup @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))))) => (Xph => ((ccfv @ XF @ cclsp) = ccpnf))))))))))).
