...
thf(anmval2_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XN = (ccfv @ XW @ ccnm)) => ((XX = (ccfv @ XW @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XD = (ccfv @ XW @ ccds)) => ((XE = (ccres @ XD @ (ccxp @ XX @ XX))) => (((cwcel @ XW @ ccgrp) & (cwcel @ XA2 @ XX)) => ((ccfv @ XA2 @ XN) = (cco @ XA2 @ Xc_0 @ XE)))))))))))))))).
...
thf(cnmhmcn_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (ccfv @ XS @ cctopn)) => ((XK = (ccfv @ XT @ cctopn)) => ((XG = (ccfv @ XS @ ccsca)) => ((XB2 = (ccfv @ XG @ ccbs)) => (((cwcel @ XS @ (ccin @ ccnlm @ ccclm)) & (cwcel @ XT @ (ccin @ ccnlm @ ccclm)) & (cwss @ ccq @ XB2)) => ((cwcel @ XF @ (cco @ XS @ XT @ ccnmhm)) <=> ((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) & (cwcel @ XF @ (cco @ XJ @ XK @ cccn))))))))))))))))).
