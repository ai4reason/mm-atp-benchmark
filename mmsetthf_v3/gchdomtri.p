...
thf(acdalepw_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwbr @ (cco @ XA2 @ XA2 @ cccda) @ XA2 @ ccen) & (cwbr @ XB2 @ (ccpw @ XA2) @ ccdom)) => (cwbr @ (cco @ XA2 @ XB2 @ cccda) @ (ccpw @ XA2) @ ccdom))))).
...
thf(cgchdomtri_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccgch) & (cwbr @ (cco @ XA2 @ XA2 @ cccda) @ XA2 @ ccen) & (cwbr @ XB2 @ (ccpw @ XA2) @ ccdom)) => ((cwbr @ XA2 @ XB2 @ ccdom) | (cwbr @ XB2 @ XA2 @ ccdom)))))).
