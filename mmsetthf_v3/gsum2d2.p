...
thf(agsum2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => (cwcel @ XG @ cccmn)) => ((! [Xj:$i] : (! [Xk:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xj @ Xk))))) => ((Xph => (cwrel @ XA2)) => ((! [Xj:$i] : (! [Xk:$i] : (Xph => (cwcel @ XD @ (XW @ Xj @ Xk))))) => ((Xph => (cwss @ (ccdm @ XA2) @ XD)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwbr @ XF @ Xc_0 @ ccfsupp)) => (Xph => ((cco @ XG @ XF @ ccgsu) = (cco @ XG @ (ccmpt @ (^ [Xj:$i] : XD) @ (^ [Xj:$i] : (cco @ XG @ (ccmpt @ (^ [Xk:$i] : (ccima @ XA2 @ (ccsn @ (ccv @ Xj)))) @ (^ [Xk:$i] : (cco @ (ccv @ Xj) @ (ccv @ Xk) @ XF))) @ ccgsu))) @ ccgsu)))))))))))))))))))))).
...
thf(aopth1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (((ccop @ XA2 @ XB2) = (ccop @ XC @ XD)) => (XA2 = XC))))))))).
