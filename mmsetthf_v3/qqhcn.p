...
thf(cqqhcn_conj,conjecture,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XZ:($i > $o)] : ((XQ = (cco @ cccnfld @ ccq @ ccress)) => ((XJ = (ccfv @ XQ @ cctopn)) => ((XZ = (ccfv @ XR @ cczlm)) => ((XK = (ccfv @ XR @ cctopn)) => (((cwcel @ XR @ (ccin @ ccnrg @ ccdr)) & (cwcel @ XZ @ ccnlm) & ((ccfv @ XR @ ccchr) = ccc0)) => (cwcel @ (ccfv @ XR @ ccqqh) @ (cco @ XJ @ XK @ cccn))))))))))))).
