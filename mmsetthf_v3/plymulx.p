...
thf(cplymulx_conj,conjecture,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccfv @ ccr @ ccply)) => ((ccfv @ (cco @ XF @ ccidp @ (ccof @ ccmul)) @ cccoe) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ ccc0 @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ (ccfv @ XF @ cccoe))))))))).
