...
thf(aarwcd_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = (ccfv @ XC @ ccarw)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((cwcel @ XF @ XA2) => (cwcel @ (ccfv @ XF @ cccoda) @ XB2))))))))).
thf(affnfv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) <=> ((cwfn @ XF @ XA2) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ XB2)) @ (^ [Xx3:$i] : XA2)))))))).
thf(ccdaf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = (ccfv @ XC @ ccarw)) => ((XB2 = (ccfv @ XC @ ccbs)) => (cwf @ XA2 @ XB2 @ (ccres @ cccoda @ XA2)))))))).
