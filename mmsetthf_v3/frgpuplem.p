...
thf(asplcl_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XS @ (ccword @ XA2)) & (cwcel @ XR @ (ccword @ XA2))) => (cwcel @ (cco @ XS @ (ccotp @ XF @ XT @ XR) @ ccsplice) @ (ccword @ XA2))))))))).
...
thf(afrgpuptinv_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xz:$i] : (XB2 = (ccfv @ (XH @ Xy1 @ Xz) @ ccbs)))) => ((! [Xy1:$i] : (! [Xz:$i] : (XN = (ccfv @ (XH @ Xy1 @ Xz) @ ccminusg)))) => ((! [Xy1:$i] : (! [Xz:$i] : ((XT @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xy1:$i] : (^ [Xz:$i] : XI)) @ (^ [Xy1:$i] : (^ [Xz:$i] : cc2o)) @ (^ [Xy1:$i] : (^ [Xz:$i] : (ccif @ ((ccv @ Xz) = cc0) @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ XN)))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwcel @ (XH @ Xy1 @ Xz) @ ccgrp)))) => ((! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwcel @ XI @ (XV @ Xy1 @ Xz))))) => ((Xph => (cwf @ XI @ XB2 @ XF)) => ((! [Xy1:$i] : (! [Xz:$i] : ((XM @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xy1:$i] : (^ [Xz:$i] : XI)) @ (^ [Xy1:$i] : (^ [Xz:$i] : cc2o)) @ (^ [Xy1:$i] : (^ [Xz:$i] : (ccop @ (ccv @ Xy1) @ (ccdif @ cc1o @ (ccv @ Xz))))))))) => (! [Xy1:$i] : (! [Xz:$i] : ((Xph & (cwcel @ XA2 @ (ccxp @ XI @ cc2o))) => ((ccfv @ (ccfv @ XA2 @ (XM @ Xy1 @ Xz)) @ (XT @ Xy1 @ Xz)) = (ccfv @ (ccfv @ XA2 @ (XT @ Xy1 @ Xz)) @ XN))))))))))))))))))))))).
...
thf(agsumws2_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (((cwcel @ XG @ ccmnd) & (cwcel @ XS @ XB2) & (cwcel @ XT @ XB2)) => ((cco @ XG @ (ccs2 @ XS @ XT) @ ccgsu) = (cco @ XS @ XT @ Xc_pl))))))))))).
...
thf(asplval_thm,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XS @ XV) & ((cwcel @ XF @ XW) & (cwcel @ XT @ XX) & (cwcel @ XR @ XY))) => ((cco @ XS @ (ccotp @ XF @ XT @ XR) @ ccsplice) = (cco @ (cco @ (cco @ XS @ (ccop @ ccc0 @ XF) @ ccsubstr) @ XR @ ccconcat) @ (cco @ XS @ (ccop @ XT @ (ccfv @ XS @ cchash)) @ ccsubstr) @ ccconcat)))))))))))).
