...
thf(cneificl_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XJ @ cctop) & (cwss @ XN @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)))) & ((cwcel @ XN @ ccfn) & (XN != cc0))) => (cwcel @ (ccint @ XN) @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)))))))).
