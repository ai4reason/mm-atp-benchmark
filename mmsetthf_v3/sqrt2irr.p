...
thf(asqrt2irrlem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XB2 @ ccn)) => ((Xph => ((ccfv @ cc2 @ ccsqrt) = (cco @ XA2 @ XB2 @ ccdiv))) => (Xph => ((cwcel @ (cco @ XA2 @ cc2 @ ccdiv) @ ccz) & (cwcel @ (cco @ XB2 @ cc2 @ ccdiv) @ ccn)))))))))).
