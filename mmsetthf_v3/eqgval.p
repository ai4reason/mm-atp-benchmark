...
thf(aeqgfval_thm,axiom,(! [Xc_pl:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XG @ ccminusg)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XR @ Xx3 @ Xy1) = (cco @ XG @ XS @ ccqg)))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XG @ (XV @ Xx3 @ Xy1)) & (cwss @ XS @ XX)) => ((XR @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwss @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XX) & (cwcel @ (cco @ (ccfv @ (ccv @ Xx3) @ XN) @ (ccv @ Xy1) @ Xc_pl) @ XS))))))))))))))))))))).
...
thf(ceqgval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XG @ ccminusg)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((XR = (cco @ XG @ XS @ ccqg)) => (((cwcel @ XG @ XV) & (cwss @ XS @ XX)) => ((cwbr @ XA2 @ XB2 @ XR) <=> ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX) & (cwcel @ (cco @ (ccfv @ XA2 @ XN) @ XB2 @ Xc_pl) @ XS)))))))))))))))))).
