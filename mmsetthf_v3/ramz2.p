...
thf(cramz2_conj,conjecture,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XM @ ccn) & (cwcel @ XR @ XV) & (cwf @ XR @ ccn0 @ XF)) & ((cwcel @ XC @ XR) & ((ccfv @ XC @ XF) = ccc0))) => ((cco @ XM @ XF @ ccram) = ccc0)))))))).
