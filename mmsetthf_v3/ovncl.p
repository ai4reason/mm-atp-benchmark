...
thf(covncl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((Xph => (cwss @ XA2 @ (cco @ ccr @ XX @ ccmap))) => (Xph => (cwcel @ (ccfv @ XA2 @ (ccfv @ XX @ ccovoln)) @ (cco @ ccc0 @ ccpnf @ ccicc))))))))).
