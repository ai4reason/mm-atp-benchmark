...
thf(aeulerpathpr_thm,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ ccupgr) & (cwbr @ XF @ XP @ (ccfv @ XG @ cceupth))) => (cwcel @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (~ (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XG @ ccvtxdg)) @ ccdvds))) @ (^ [Xx3:$i] : XV)) @ cchash) @ (ccpr @ ccc0 @ cc2))))))))).
thf(ceulerpath_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ ccupgr) & ((ccfv @ XG @ cceupth) != cc0)) => (cwcel @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (~ (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XG @ ccvtxdg)) @ ccdvds))) @ (^ [Xx3:$i] : XV)) @ cchash) @ (ccpr @ ccc0 @ cc2))))))).
