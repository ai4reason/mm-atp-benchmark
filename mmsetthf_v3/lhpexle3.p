...
thf(alhpexle3lem_thm,axiom,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XX @ XA2) & (cwcel @ XY @ XA2) & (cwcel @ XZ @ XA2)) & ((cwbr @ XX @ XW @ Xc_le) & (cwbr @ XY @ XW @ Xc_le) & (cwbr @ XZ @ XW @ Xc_le))) => (cwrex @ (^ [Xp:$i] : ((cwbr @ (ccv @ Xp) @ XW @ Xc_le) & (((ccv @ Xp) != XX) & ((ccv @ Xp) != XY) & ((ccv @ Xp) != XZ)))) @ (^ [Xp:$i] : XA2))))))))))))))).
...
thf(clhpexle3_conj,conjecture,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => (((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) => (cwrex @ (^ [Xp:$i] : ((cwbr @ (ccv @ Xp) @ XW @ Xc_le) & (((ccv @ Xp) != XX) & ((ccv @ Xp) != XY) & ((ccv @ Xp) != XZ)))) @ (^ [Xp:$i] : XA2))))))))))))))).
