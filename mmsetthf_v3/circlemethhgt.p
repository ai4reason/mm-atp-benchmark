...
thf(aprodfzo03_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : ((! [Xk:$i] : (((ccv @ Xk) = ccc0) => ((XD @ Xk) = XA2))) => ((! [Xk:$i] : (((ccv @ Xk) = cc1) => ((XD @ Xk) = XB2))) => ((! [Xk:$i] : (((ccv @ Xk) = cc2) => ((XD @ Xk) = XC))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ ccc0 @ cc3 @ ccfzo))) => (cwcel @ (XD @ Xk) @ ccc))) => (Xph => ((ccprod @ (^ [Xk:$i] : (cco @ ccc0 @ cc3 @ ccfzo)) @ (^ [Xk:$i] : (XD @ Xk))) = (cco @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ ccmul))))))))))))).
