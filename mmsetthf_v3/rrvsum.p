...
thf(arrvadd_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XP @ ccprb)) => ((Xph => (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => ((Xph => (cwcel @ XY @ (ccfv @ XP @ ccrrv))) => (Xph => (cwcel @ (cco @ XX @ XY @ (ccof @ ccaddc)) @ (ccfv @ XP @ ccrrv))))))))))).
...
thf(crrvsum_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XP @ ccprb)) => ((Xph => (cwf @ ccn @ (ccfv @ XP @ ccrrv) @ XX)) => (((Xph & (cwcel @ XN @ ccn)) => (XS = (ccfv @ XN @ (ccseq @ (ccof @ ccaddc) @ XX @ cc1)))) => ((Xph & (cwcel @ XN @ ccn)) => (cwcel @ XS @ (ccfv @ XP @ ccrrv)))))))))))).
