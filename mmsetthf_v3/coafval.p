...
thf(adf_coa_ax,axiom,(cccoa = (ccmpt @ (^ [Xc:$i] : cccat) @ (^ [Xc:$i] : (ccmpt2 @ (^ [Xg1:$i] : (^ [Xf1:$i] : (ccfv @ (ccv @ Xc) @ ccarw))) @ (^ [Xg1:$i] : (^ [Xf1:$i] : (ccrab @ (^ [Xh:$i] : ((ccfv @ (ccv @ Xh) @ cccoda) = (ccfv @ (ccv @ Xg1) @ ccdoma))) @ (^ [Xh:$i] : (ccfv @ (ccv @ Xc) @ ccarw))))) @ (^ [Xg1:$i] : (^ [Xf1:$i] : (ccotp @ (ccfv @ (ccv @ Xf1) @ ccdoma) @ (ccfv @ (ccv @ Xg1) @ cccoda) @ (cco @ (ccfv @ (ccv @ Xg1) @ cc2nd) @ (ccfv @ (ccv @ Xf1) @ cc2nd) @ (cco @ (ccop @ (ccfv @ (ccv @ Xf1) @ ccdoma) @ (ccfv @ (ccv @ Xg1) @ ccdoma)) @ (ccfv @ (ccv @ Xg1) @ cccoda) @ (ccfv @ (ccv @ Xc) @ ccco))))))))))).
...
thf(aarwrcl_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = (ccfv @ XC @ ccarw)) => ((cwcel @ XF @ XA2) => (cwcel @ XC @ cccat))))))).
