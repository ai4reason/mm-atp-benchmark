...
thf(adf_mdet_ax,axiom,(ccmdat = (ccmpt2 @ (^ [Xn:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xr:$i] : (ccmpt @ (^ [Xm:$i] : (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xr) @ ccmat) @ ccbs)) @ (^ [Xm:$i] : (cco @ (ccv @ Xr) @ (ccmpt @ (^ [Xp:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ ccsymg) @ ccbs)) @ (^ [Xp:$i] : (cco @ (ccfv @ (ccv @ Xp) @ (cccom @ (ccfv @ (ccv @ Xr) @ cczrh) @ (ccfv @ (ccv @ Xn) @ ccpsgn))) @ (cco @ (ccfv @ (ccv @ Xr) @ ccmgp) @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xn)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xp)) @ (ccv @ Xx3) @ (ccv @ Xm)))) @ ccgsu) @ (ccfv @ (ccv @ Xr) @ ccmulr)))) @ ccgsu)))))))).
