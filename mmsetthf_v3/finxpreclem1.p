...
thf(cfinxpreclem1_conj,conjecture,(! [XU:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XU) => (cc0 = (ccfv @ (ccop @ cc1o @ XX) @ (ccmpt2 @ (^ [Xn:$i] : (^ [Xx3:$i] : ccom)) @ (^ [Xn:$i] : (^ [Xx3:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xx3:$i] : (ccif @ (((ccv @ Xn) = cc1o) & (cwcel @ (ccv @ Xx3) @ XU)) @ cc0 @ (ccif @ (cwcel @ (ccv @ Xx3) @ (ccxp @ ccvv @ XU)) @ (ccop @ (ccuni @ (ccv @ Xn)) @ (ccfv @ (ccv @ Xx3) @ cc1st)) @ (ccop @ (ccv @ Xn) @ (ccv @ Xx3))))))))))))).
