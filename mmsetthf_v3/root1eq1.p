...
thf(aefeq1_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (((ccfv @ XA2 @ cce) = cc1) <=> (cwcel @ (cco @ XA2 @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ ccdiv) @ ccz))))).
...
thf(croot1eq1_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XK @ ccz)) => (((cco @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ XN @ ccdiv) @ cccxp) @ XK @ ccexp) = cc1) <=> (cwbr @ XN @ XK @ ccdvds)))))).
