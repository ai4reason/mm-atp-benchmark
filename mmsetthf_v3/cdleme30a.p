...
thf(alhpj1_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_1 = (ccfv @ XK @ ccp1)) => ((XH = (ccfv @ XK @ cclh)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XX @ XB2) & (~ (cwbr @ XX @ XW @ Xc_le)))) => ((cco @ XW @ XX @ Xc_or) = Xc_1)))))))))))))))).
...
thf(ccdleme30a_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xs1:$i] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ (ccv @ Xs1) @ XA2) & ((cwcel @ XX @ XB2) & (~ (cwbr @ XX @ XW @ Xc_le))) & (cwcel @ XY @ XB2)) & (((cco @ (ccv @ Xs1) @ (cco @ XX @ XW @ Xc_an) @ Xc_or) = XX) & (cwbr @ XX @ XY @ Xc_le))) => ((cco @ (ccv @ Xs1) @ (cco @ XY @ XW @ Xc_an) @ Xc_or) = XY)))))))))))))))))))).
