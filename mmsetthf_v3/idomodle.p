...
thf(cidomodle_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XO:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (cco @ (ccfv @ XR @ ccmgp) @ (ccfv @ XR @ ccui) @ ccress))) => ((! [Xx3:$i] : (XB2 = (ccfv @ (XG @ Xx3) @ ccbs))) => ((! [Xx3:$i] : ((XO @ Xx3) = (ccfv @ (XG @ Xx3) @ ccod))) => (((cwcel @ XR @ ccidom) & (cwcel @ XN @ ccn)) => (cwbr @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (XO @ Xx3)) @ XN @ ccdvds)) @ (^ [Xx3:$i] : XB2)) @ cchash) @ XN @ ccle))))))))))).
