...
thf(cordthmeo_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccdm @ XR)) => ((XY = (ccdm @ XS)) => (((cwcel @ XR @ XV) & (cwcel @ XS @ XW) & (cwiso @ XX @ XY @ XR @ XS @ XF)) => (cwcel @ XF @ (cco @ (ccfv @ XR @ ccordt) @ (ccfv @ XS @ ccordt) @ cchmeo))))))))))))).
