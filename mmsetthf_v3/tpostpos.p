...
thf(areltpos_thm,axiom,(! [XF:($i > $o)] : (cwrel @ (cctpos @ XF)))).
...
thf(abrtpos_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XC @ XV) => ((cwbr @ (ccop @ XA2 @ XB2) @ XC @ (cctpos @ XF)) <=> (cwbr @ (ccop @ XB2 @ XA2) @ XC @ XF))))))))).
...
thf(abrtpos0_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwbr @ cc0 @ XA2 @ (cctpos @ XF)) <=> (cwbr @ cc0 @ XA2 @ XF))))))).
...
thf(ctpostpos_conj,conjecture,(! [XF:($i > $o)] : ((cctpos @ (cctpos @ XF)) = (ccin @ XF @ (ccxp @ (ccun @ (ccxp @ ccvv @ ccvv) @ (ccsn @ cc0)) @ ccvv))))).
