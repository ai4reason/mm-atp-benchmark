...
thf(adihmeetlem17N_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [Xp:$i] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XH = (ccfv @ XK @ cclh)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((Xc_po = (ccfv @ XU @ cclsm)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((Xc_0 = (ccfv @ XK @ ccp0)) => (((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XX @ XB2) & (~ (cwbr @ XX @ XW @ Xc_le))) & ((cwcel @ (ccv @ Xp) @ XA2) & (~ (cwbr @ (ccv @ Xp) @ XW @ Xc_le)))) & ((cwcel @ XY @ XB2) & (cwbr @ (cco @ XX @ XY @ Xc_an) @ XW @ Xc_le) & (cwbr @ (ccv @ Xp) @ XX @ Xc_le))) => ((cco @ XY @ (ccv @ Xp) @ Xc_an) = Xc_0)))))))))))))))))))))))))))).
...
thf(adihmeetlem16N_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : (! [Xr:$i] : (! [Xp:$i] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XH = (ccfv @ XK @ cclh)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((Xc_po = (ccfv @ XU @ cclsm)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => (((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwcel @ XY @ XB2) & ((cwcel @ (ccv @ Xp) @ XA2) & (~ (cwbr @ (ccv @ Xp) @ XW @ Xc_le)))) & (((cwcel @ (ccv @ Xr) @ XA2) & (~ (cwbr @ (ccv @ Xr) @ XW @ Xc_le))) & (cwbr @ (ccv @ Xr) @ XY @ Xc_le) & (cwbr @ (cco @ XY @ (ccv @ Xp) @ Xc_an) @ XW @ Xc_le))) => ((ccfv @ (cco @ XY @ (ccv @ Xp) @ Xc_an) @ XI) = (ccin @ (ccfv @ XY @ XI) @ (ccfv @ (ccv @ Xp) @ XI)))))))))))))))))))))))))))).
