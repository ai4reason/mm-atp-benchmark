...
thf(aetransclem7_thm,axiom,(! [Xph:$o] : (! [XC:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xj:$i] : (Xph => (cwcel @ (XP @ Xj) @ ccn))) => ((! [Xj:$i] : (Xph => (cwf @ (cco @ ccc0 @ XM @ ccfz) @ (cco @ ccc0 @ (XN @ Xj) @ ccfz) @ (XC @ Xj)))) => ((! [Xj:$i] : (Xph => (cwcel @ (XJ @ Xj) @ (cco @ ccc0 @ XM @ ccfz)))) => (Xph => (cwcel @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xj:$i] : (ccif @ (cwbr @ (XP @ Xj) @ (ccfv @ (ccv @ Xj) @ (XC @ Xj)) @ cclt) @ ccc0 @ (cco @ (cco @ (ccfv @ (XP @ Xj) @ ccfa) @ (ccfv @ (cco @ (XP @ Xj) @ (ccfv @ (ccv @ Xj) @ (XC @ Xj)) @ ccmin) @ ccfa) @ ccdiv) @ (cco @ (cco @ (XJ @ Xj) @ (ccv @ Xj) @ ccmin) @ (cco @ (XP @ Xj) @ (ccfv @ (ccv @ Xj) @ (XC @ Xj)) @ ccmin) @ ccexp) @ ccmul)))) @ ccz)))))))))))).
...
thf(cetransclem15_conj,conjecture,(! [Xph:$o] : (! [XC:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xj:$i] : (Xph => (cwcel @ (XP @ Xj) @ ccn))) => ((Xph => (cwcel @ XM @ ccn0)) => ((! [Xj:$i] : (Xph => (cwcel @ (XN @ Xj) @ ccn0))) => ((! [Xj:$i] : (Xph => (cwf @ (cco @ ccc0 @ XM @ ccfz) @ (cco @ ccc0 @ (XN @ Xj) @ ccfz) @ (XC @ Xj)))) => ((! [Xj:$i] : ((XT @ Xj) = (cco @ (cco @ (ccfv @ (XN @ Xj) @ ccfa) @ (ccprod @ (^ [Xj:$i] : (cco @ ccc0 @ XM @ ccfz)) @ (^ [Xj:$i] : (ccfv @ (ccfv @ (ccv @ Xj) @ (XC @ Xj)) @ ccfa))) @ ccdiv) @ (cco @ (ccif @ (cwbr @ (cco @ (XP @ Xj) @ cc1 @ ccmin) @ (ccfv @ ccc0 @ (XC @ Xj)) @ cclt) @ ccc0 @ (cco @ (cco @ (ccfv @ (cco @ (XP @ Xj) @ cc1 @ ccmin) @ ccfa) @ (ccfv @ (cco @ (cco @ (XP @ Xj) @ cc1 @ ccmin) @ (ccfv @ ccc0 @ (XC @ Xj)) @ ccmin) @ ccfa) @ ccdiv) @ (cco @ (XJ @ Xj) @ (cco @ (cco @ (XP @ Xj) @ cc1 @ ccmin) @ (ccfv @ ccc0 @ (XC @ Xj)) @ ccmin) @ ccexp) @ ccmul)) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xj:$i] : (ccif @ (cwbr @ (XP @ Xj) @ (ccfv @ (ccv @ Xj) @ (XC @ Xj)) @ cclt) @ ccc0 @ (cco @ (cco @ (ccfv @ (XP @ Xj) @ ccfa) @ (ccfv @ (cco @ (XP @ Xj) @ (ccfv @ (ccv @ Xj) @ (XC @ Xj)) @ ccmin) @ ccfa) @ ccdiv) @ (cco @ (cco @ (XJ @ Xj) @ (ccv @ Xj) @ ccmin) @ (cco @ (XP @ Xj) @ (ccfv @ (ccv @ Xj) @ (XC @ Xj)) @ ccmin) @ ccexp) @ ccmul)))) @ ccmul) @ ccmul))) => ((! [Xj:$i] : (Xph => ((XJ @ Xj) = ccc0))) => ((! [Xj:$i] : (Xph => ((ccfv @ ccc0 @ (XC @ Xj)) != (cco @ (XP @ Xj) @ cc1 @ ccmin)))) => (! [Xj:$i] : (Xph => ((XT @ Xj) = ccc0)))))))))))))))))).
