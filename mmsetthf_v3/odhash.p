...
thf(aodf1o1_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((XO = (ccfv @ XG @ ccod)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & ((ccfv @ XA2 @ XO) = ccc0)) => (cwf1o @ ccz @ (ccfv @ (ccsn @ XA2) @ XK) @ (ccmpt @ (^ [Xx3:$i] : ccz) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ Xc_x)))))))))))))))).
...
thf(codhash_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & ((ccfv @ XA2 @ XO) = ccc0)) => ((ccfv @ (ccfv @ (ccsn @ XA2) @ XK) @ cchash) = ccpnf))))))))))).
