...
thf(aplyco_thm,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ (ccfv @ XS @ ccply))) => ((Xph => (cwcel @ XG @ (ccfv @ XS @ ccply))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccaddc) @ XS)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmul) @ XS)))) => (Xph => (cwcel @ (cccom @ XF @ XG) @ (ccfv @ XS @ ccply)))))))))))).
...
thf(aplysubcl_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XS @ ccply))) => (cwcel @ (cco @ XF @ XG @ (ccof @ ccmin)) @ (ccfv @ ccc @ ccply))))))).
...
thf(adgrmulc_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XA2 @ ccc) & (XA2 != ccc0) & (cwcel @ XF @ (ccfv @ XS @ ccply))) => ((ccfv @ (cco @ (ccxp @ ccc @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul)) @ ccdgr) = (ccfv @ XF @ ccdgr))))))).
thf(adgrcolem1_thm,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : ((XN @ Xx3) = (ccfv @ XG @ ccdgr))) => ((Xph => (cwcel @ XM @ ccn)) => ((! [Xx3:$i] : (Xph => (cwcel @ (XN @ Xx3) @ ccn))) => ((! [Xx3:$i] : (Xph => (cwcel @ XG @ (ccfv @ (XS @ Xx3) @ ccply)))) => (! [Xx3:$i] : (Xph => ((ccfv @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XG) @ XM @ ccexp))) @ ccdgr) = (cco @ XM @ (XN @ Xx3) @ ccmul)))))))))))))).
thf(asimpr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(adgradd2_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (ccfv @ XF @ ccdgr)) => ((XN = (ccfv @ XG @ ccdgr)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XS @ ccply)) & (cwbr @ XM @ XN @ cclt)) => ((ccfv @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ ccdgr) = XN)))))))))).
...
thf(a_0dgr_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (ccxp @ ccc @ (ccsn @ XA2)) @ ccdgr) = ccc0)))).
...
thf(a_0dgrb_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (ccfv @ XS @ ccply)) => (((ccfv @ XF @ ccdgr) = ccc0) <=> (XF = (ccxp @ ccc @ (ccsn @ (ccfv @ ccc0 @ XF))))))))).
thf(asylib_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps <=> Xch) => (Xph => Xch))))))).
thf(aelnn0_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn0) <=> ((cwcel @ XA2 @ ccn) | (XA2 = ccc0))))).
thf(cdgrcolem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (ccfv @ XF @ ccdgr)) => ((XN = (ccfv @ XG @ ccdgr)) => ((! [Xf1:$i] : (Xph => (cwcel @ XF @ (ccfv @ (XS @ Xf1) @ ccply)))) => ((! [Xf1:$i] : (Xph => (cwcel @ XG @ (ccfv @ (XS @ Xf1) @ ccply)))) => ((XA2 = (ccfv @ XF @ cccoe)) => ((Xph => (cwcel @ XD @ ccn0)) => ((Xph => (XM = (cco @ XD @ cc1 @ ccaddc))) => ((Xph => (cwral @ (^ [Xf1:$i] : ((cwbr @ (ccfv @ (ccv @ Xf1) @ ccdgr) @ XD @ ccle) => ((ccfv @ (cccom @ (ccv @ Xf1) @ XG) @ ccdgr) = (cco @ (ccfv @ (ccv @ Xf1) @ ccdgr) @ XN @ ccmul)))) @ (^ [Xf1:$i] : (ccfv @ ccc @ ccply)))) => (Xph => ((ccfv @ (cccom @ XF @ XG) @ ccdgr) = (cco @ XM @ XN @ ccmul)))))))))))))))))))).
