...
thf(aalgrflem_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cco @ XB2 @ XC @ (cccom @ XF @ cc1st)) = (ccfv @ XB2 @ XF)))))))).
