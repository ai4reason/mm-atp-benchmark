...
thf(afprodex01_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xk:$i] : (! [Xl:$i] : (((ccv @ Xk) = (ccv @ Xl)) => ((XB2 @ Xk) = (XC @ Xl))))) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ (ccpr @ ccc0 @ cc1)))) => (Xph => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) = (ccif @ (cwral @ (^ [Xl:$i] : ((XC @ Xl) = cc1)) @ (^ [Xl:$i] : XA2)) @ cc1 @ ccc0))))))))))).
