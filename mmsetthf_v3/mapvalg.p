...
thf(adf_map_ax,axiom,(ccmap = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xf1:$i] : (cwf @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccv @ Xf1)))))))).
thf(cmapvalg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [Xf1:$i] : (((cwcel @ XA2 @ (XC @ Xf1)) & (cwcel @ XB2 @ (XD @ Xf1))) => ((cco @ XA2 @ XB2 @ ccmap) = (^ [Xf1:$i] : (cwf @ XB2 @ XA2 @ (ccv @ Xf1))))))))))).
