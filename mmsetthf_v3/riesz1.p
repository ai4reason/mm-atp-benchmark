...
thf(criesz1_conj,conjecture,(! [XT:($i > $o)] : ((cwcel @ XT @ cclf) => ((cwcel @ (ccfv @ XT @ ccnmf) @ ccr) <=> (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XT) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsp))) @ (^ [Xx3:$i] : cchil))) @ (^ [Xy1:$i] : cchil)))))).
