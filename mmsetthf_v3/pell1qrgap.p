...
thf(cpell1qrgap_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) & (cwcel @ XA2 @ (ccfv @ XD @ ccpell1qr)) & (cwbr @ cc1 @ XA2 @ cclt)) => (cwbr @ (cco @ (ccfv @ (cco @ XD @ cc1 @ ccaddc) @ ccsqrt) @ (ccfv @ XD @ ccsqrt) @ ccaddc) @ XA2 @ ccle))))).
