...
thf(clkrlsp3_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((XF = (ccfv @ XW @ cclfn)) => ((XK = (ccfv @ XW @ cclk)) => (((cwcel @ XW @ cclvec) & ((cwcel @ XX @ XV) & (cwcel @ XG @ XF)) & (~ (cwcel @ XX @ (ccfv @ XG @ XK)))) => ((ccfv @ (ccun @ (ccfv @ XG @ XK) @ (ccsn @ XX)) @ XN) = XV)))))))))))))).
