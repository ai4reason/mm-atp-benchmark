...
thf(amptsuppd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XZ @ (XW @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ (XU @ Xx3)))) => (! [Xx3:$i] : (Xph => ((cco @ (XF @ Xx3) @ XZ @ ccsupp) = (ccrab @ (^ [Xx3:$i] : ((XB2 @ Xx3) != XZ)) @ (^ [Xx3:$i] : XA2)))))))))))))))))).
...
thf(asuppval1_thm,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : (((cwfun @ XX) & (cwcel @ XX @ XV) & (cwcel @ XZ @ XW)) => ((cco @ XX @ XZ @ ccsupp) = (ccrab @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XX) != XZ)) @ (^ [Xi:$i] : (ccdm @ XX)))))))))).
thf(cdomnmsuppn0_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XR = (ccfv @ XM @ ccbs)) => ((((cwcel @ XM @ ccdomn) & (cwcel @ XV @ XX)) & ((cwcel @ XC @ XR) & (XC != (ccfv @ XM @ cc0g))) & (cwcel @ XA2 @ (cco @ XR @ XV @ ccmap))) => ((cco @ (ccmpt @ (^ [Xv:$i] : XV) @ (^ [Xv:$i] : (cco @ XC @ (ccfv @ (ccv @ Xv) @ XA2) @ (ccfv @ XM @ ccmulr)))) @ (ccfv @ XM @ cc0g) @ ccsupp) = (cco @ XA2 @ (ccfv @ XM @ cc0g) @ ccsupp))))))))))).
