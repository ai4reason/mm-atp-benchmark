...
thf(acdlemk40t_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xz:$i] : (! [Xg1:$i] : ((XX @ Xz @ Xg1) = (ccrio @ (^ [Xz:$i] : (Xph @ Xz @ Xg1)) @ (^ [Xz:$i] : (XT @ Xz)))))) => ((! [Xz:$i] : (! [Xg1:$i] : ((XU @ Xz @ Xg1) = (ccmpt @ (^ [Xg1:$i] : (XT @ Xz)) @ (^ [Xg1:$i] : (ccif @ ((XF @ Xz) = (XN @ Xz)) @ (ccv @ Xg1) @ (XX @ Xz @ Xg1))))))) => (! [Xz:$i] : (! [Xg1:$i] : ((((XF @ Xz) = (XN @ Xz)) & (cwcel @ (XG @ Xz @ Xg1) @ (XT @ Xz))) => ((ccfv @ (XG @ Xz @ Xg1) @ (XU @ Xz @ Xg1)) = (XG @ Xz @ Xg1))))))))))))))).
...
thf(acdlemk39u1_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > $o)))] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((! [Xz:$i] : (! [Xb:$i] : ((XZ @ Xz @ Xb) = (cco @ (cco @ XP @ (ccfv @ (ccv @ Xb) @ XR) @ Xc_or) @ (cco @ (ccfv @ XP @ XN) @ (ccfv @ (cccom @ (ccv @ Xb) @ (cccnv @ XF)) @ XR) @ Xc_or) @ Xc_an)))) => ((! [Xz:$i] : (! [Xg1:$i] : (! [Xb:$i] : ((XY @ Xg1 @ Xb) = (cco @ (cco @ XP @ (ccfv @ (ccv @ Xg1) @ XR) @ Xc_or) @ (cco @ (XZ @ Xz @ Xb) @ (ccfv @ (cccom @ (ccv @ Xg1) @ (cccnv @ (ccv @ Xb))) @ XR) @ Xc_or) @ Xc_an))))) => ((! [Xz:$i] : (! [Xg1:$i] : (! [Xb:$i] : ((XX @ Xz @ Xg1 @ Xb) = (ccrio @ (^ [Xz:$i] : (cwral @ (^ [Xb:$i] : ((((ccv @ Xb) != (ccres @ ccid @ XB2)) & ((ccfv @ (ccv @ Xb) @ XR) != (ccfv @ XF @ XR)) & ((ccfv @ (ccv @ Xb) @ XR) != (ccfv @ (ccv @ Xg1) @ XR))) => ((ccfv @ XP @ (ccv @ Xz)) = (XY @ Xg1 @ Xb)))) @ (^ [Xb:$i] : XT))) @ (^ [Xz:$i] : XT)))))) => ((! [Xz:$i] : (! [Xg1:$i] : (! [Xb:$i] : ((XU @ Xz @ Xg1 @ Xb) = (ccmpt @ (^ [Xg1:$i] : XT) @ (^ [Xg1:$i] : (ccif @ (XF = XN) @ (ccv @ Xg1) @ (XX @ Xz @ Xg1 @ Xb)))))))) => (! [Xz:$i] : (! [Xg1:$i] : (! [Xb:$i] : (((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwcel @ XF @ XT) & (cwcel @ XN @ XT)) & (((ccfv @ XF @ XR) = (ccfv @ XN @ XR)) & (XF != XN) & (cwcel @ XG @ XT)) & ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le)))) => (cwbr @ (ccfv @ (ccfv @ XG @ (XU @ Xz @ Xg1 @ Xb)) @ XR) @ (ccfv @ XG @ XR) @ Xc_le)))))))))))))))))))))))))))))))))))).
thf(ccdlemk39u_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > $o)))] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((! [Xz:$i] : (! [Xb:$i] : ((XZ @ Xz @ Xb) = (cco @ (cco @ XP @ (ccfv @ (ccv @ Xb) @ XR) @ Xc_or) @ (cco @ (ccfv @ XP @ XN) @ (ccfv @ (cccom @ (ccv @ Xb) @ (cccnv @ XF)) @ XR) @ Xc_or) @ Xc_an)))) => ((! [Xz:$i] : (! [Xg1:$i] : (! [Xb:$i] : ((XY @ Xg1 @ Xb) = (cco @ (cco @ XP @ (ccfv @ (ccv @ Xg1) @ XR) @ Xc_or) @ (cco @ (XZ @ Xz @ Xb) @ (ccfv @ (cccom @ (ccv @ Xg1) @ (cccnv @ (ccv @ Xb))) @ XR) @ Xc_or) @ Xc_an))))) => ((! [Xz:$i] : (! [Xg1:$i] : (! [Xb:$i] : ((XX @ Xz @ Xg1 @ Xb) = (ccrio @ (^ [Xz:$i] : (cwral @ (^ [Xb:$i] : ((((ccv @ Xb) != (ccres @ ccid @ XB2)) & ((ccfv @ (ccv @ Xb) @ XR) != (ccfv @ XF @ XR)) & ((ccfv @ (ccv @ Xb) @ XR) != (ccfv @ (ccv @ Xg1) @ XR))) => ((ccfv @ XP @ (ccv @ Xz)) = (XY @ Xg1 @ Xb)))) @ (^ [Xb:$i] : XT))) @ (^ [Xz:$i] : XT)))))) => ((! [Xz:$i] : (! [Xg1:$i] : (! [Xb:$i] : ((XU @ Xz @ Xg1 @ Xb) = (ccmpt @ (^ [Xg1:$i] : XT) @ (^ [Xg1:$i] : (ccif @ (XF = XN) @ (ccv @ Xg1) @ (XX @ Xz @ Xg1 @ Xb)))))))) => (! [Xz:$i] : (! [Xg1:$i] : (! [Xb:$i] : (((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwcel @ XF @ XT) & (cwcel @ XN @ XT)) & (((ccfv @ XF @ XR) = (ccfv @ XN @ XR)) & (cwcel @ XG @ XT)) & ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le)))) => (cwbr @ (ccfv @ (ccfv @ XG @ (XU @ Xz @ Xg1 @ Xb)) @ XR) @ (ccfv @ XG @ XR) @ Xc_le)))))))))))))))))))))))))))))))))))).
