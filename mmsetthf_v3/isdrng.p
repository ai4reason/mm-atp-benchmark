...
thf(cisdrng_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XU = (ccfv @ XR @ ccui)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cwcel @ XR @ ccdr) <=> ((cwcel @ XR @ ccrg) & (XU = (ccdif @ XB2 @ (ccsn @ Xc_0))))))))))))).
