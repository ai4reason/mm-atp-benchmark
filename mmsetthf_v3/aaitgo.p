...
thf(ampaacl_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => (cwcel @ (ccfv @ XA2 @ ccmpaa) @ (ccfv @ ccq @ ccply))))).
thf(ampaaroot_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => ((ccfv @ XA2 @ (ccfv @ XA2 @ ccmpaa)) = ccc0)))).
thf(aeqtrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XB2 = XC)) => (Xph => (XA2 = XC))))))))).
thf(afveq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))))).
thf(ampaadgr_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => ((ccfv @ (ccfv @ XA2 @ ccmpaa) @ ccdgr) = (ccfv @ XA2 @ ccdgraa))))).
thf(ampaamn_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => ((ccfv @ (ccfv @ XA2 @ ccdgraa) @ (ccfv @ (ccfv @ XA2 @ ccmpaa) @ cccoe)) = cc1)))).
