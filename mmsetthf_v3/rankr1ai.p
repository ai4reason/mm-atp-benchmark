...
thf(ar1val1_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccr1)) => ((ccfv @ XA2 @ ccr1) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccpw @ (ccfv @ (ccv @ Xx3) @ ccr1)))))))).
...
thf(crankr1ai_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ XB2 @ ccr1)) => (cwcel @ (ccfv @ XA2 @ ccrnk) @ XB2))))).
