...
thf(cclimrecf_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : (((? [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X)) => (! [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X))) => ((cwnfc @ (^ [Xk:$i] : (XG @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XH @ Xk))) => ((! [Xk:$i] : (XZ = (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XM @ Xk) @ ccz))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwbr @ (XG @ Xk) @ (XA2 @ Xk) @ ccli))) => ((! [Xk:$i] : ((Xph @ Xk) => ((XA2 @ Xk) != ccc0))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ (XG @ Xk)) @ (ccdif @ ccc @ (ccsn @ ccc0))))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ (XH @ Xk)) = (cco @ cc1 @ (ccfv @ (ccv @ Xk) @ (XG @ Xk)) @ ccdiv)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XH @ Xk) @ (XW @ Xk)))) => (! [Xk:$i] : ((Xph @ Xk) => (cwbr @ (XH @ Xk) @ (cco @ cc1 @ (XA2 @ Xk) @ ccdiv) @ ccli))))))))))))))))))))).
