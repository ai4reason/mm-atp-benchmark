...
thf(ccnvtrcl0_conj,conjecture,(! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => ((cccnv @ (ccint @ (^ [Xx3:$i] : ((cwss @ XX @ (ccv @ Xx3)) & (cwss @ (cccom @ (ccv @ Xx3) @ (ccv @ Xx3)) @ (ccv @ Xx3)))))) = (ccint @ (^ [Xy1:$i] : ((cwss @ (cccnv @ XX) @ (ccv @ Xy1)) & (cwss @ (cccom @ (ccv @ Xy1) @ (ccv @ Xy1)) @ (ccv @ Xy1)))))))))).
