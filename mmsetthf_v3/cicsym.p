...
thf(aelrng_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((cwcel @ XA2 @ (ccrn @ XB2)) <=> (? [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ XB2))))))))).
...
thf(ccicsym_conj,conjecture,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XC @ cccat) & (cwbr @ XR @ XS @ (ccfv @ XC @ cccic))) => (cwbr @ XS @ XR @ (ccfv @ XC @ cccic))))))).
