...
thf(cdvcjbr_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwf @ XX @ ccc @ XF)) => ((Xph => (cwss @ XX @ ccr)) => ((Xph => (cwcel @ XC @ (ccdm @ (cco @ ccr @ XF @ ccdv)))) => (Xph => (cwbr @ XC @ (ccfv @ (ccfv @ XC @ (cco @ ccr @ XF @ ccdv)) @ cccj) @ (cco @ ccr @ (cccom @ cccj @ XF) @ ccdv))))))))))).
