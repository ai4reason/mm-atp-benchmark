...
thf(cfourierdlem5_conj,conjecture,(! [XS:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((XS @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (cco @ XX @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xx3) @ ccmul) @ ccsin))))) => (! [Xx3:$i] : ((cwcel @ XX @ ccr) => (cwf @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ ccr @ (XS @ Xx3)))))))).
