...
thf(adf_frmd_ax,axiom,(ccfrmd = (ccmpt @ (^ [Xi:$i] : ccvv) @ (^ [Xi:$i] : (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccword @ (ccv @ Xi))) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (ccres @ ccconcat @ (ccxp @ (ccword @ (ccv @ Xi)) @ (ccword @ (ccv @ Xi)))))))))).
...
thf(cfrmdval_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XM = (ccfv @ XI @ ccfrmd)) => (((cwcel @ XI @ XV) => (XB2 = (ccword @ XI))) => ((Xc_pl = (ccres @ ccconcat @ (ccxp @ XB2 @ XB2))) => ((cwcel @ XI @ XV) => (XM = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl))))))))))))).
