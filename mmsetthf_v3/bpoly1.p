...
thf(abpolyval_thm,axiom,(! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XX @ ccc)) => ((cco @ XN @ XX @ ccbp) = (cco @ (cco @ XX @ XN @ ccexp) @ (ccsu @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ (ccv @ Xk) @ XX @ ccbp) @ (cco @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ cc1 @ ccaddc) @ ccdiv) @ ccmul))) @ ccmin)))))).
...
thf(abpoly0_thm,axiom,(! [XX:($i > $o)] : ((cwcel @ XX @ ccc) => ((cco @ ccc0 @ XX @ ccbp) = cc1)))).
...
thf(cbpoly1_conj,conjecture,(! [XX:($i > $o)] : ((cwcel @ XX @ ccc) => ((cco @ cc1 @ XX @ ccbp) = (cco @ XX @ (cco @ cc1 @ cc2 @ ccdiv) @ ccmin))))).
