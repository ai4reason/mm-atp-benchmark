...
thf(asbc6g_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ XA2) <=> (! [Xx3:$i] : (((ccv @ Xx3) = XA2) => (Xph @ Xx3)))))))))).
...
thf(crdgeqoa_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XN @ ccon0) & (cwcel @ XM @ ccon0) & (cwcel @ XX @ ccom)) => (((ccfv @ XN @ (ccrdg @ XF @ XA2)) = (ccfv @ XM @ (ccrdg @ XF @ XB2))) => ((ccfv @ (cco @ XN @ XX @ ccoa) @ (ccrdg @ XF @ XA2)) = (ccfv @ (cco @ XM @ XX @ ccoa) @ (ccrdg @ XF @ XB2)))))))))))).
