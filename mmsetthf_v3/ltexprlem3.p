...
thf(cltexprlem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((! [Xy1:$i] : ((XC @ Xy1) = (^ [Xx3:$i] : (? [Xy1:$i] : ((~ (cwcel @ (ccv @ Xy1) @ XA2)) & (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccplq) @ XB2)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XB2 @ ccnp) => ((cwcel @ (ccv @ Xx3) @ (XC @ Xy1)) => (! [Xz:$i] : ((cwbr @ (ccv @ Xz) @ (ccv @ Xx3) @ ccltq) => (cwcel @ (ccv @ Xz) @ (XC @ Xy1))))))))))))).
