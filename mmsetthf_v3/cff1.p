...
thf(ccff1_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (? [Xf1:$i] : ((cwf1 @ (ccfv @ XA2 @ cccf) @ XA2 @ (ccv @ Xf1)) & (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xf1)))) @ (^ [Xw:$i] : (ccfv @ XA2 @ cccf)))) @ (^ [Xz:$i] : XA2))))))).
