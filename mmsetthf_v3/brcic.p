...
thf(acicfval_thm,axiom,(! [XC:($i > $o)] : ((cwcel @ XC @ cccat) => ((ccfv @ XC @ cccic) = (cco @ (ccfv @ XC @ cciso) @ cc0 @ ccsupp))))).
...
thf(aisofn_thm,axiom,(! [XC:($i > $o)] : ((cwcel @ XC @ cccat) => (cwfn @ (ccfv @ XC @ cciso) @ (ccxp @ (ccfv @ XC @ ccbs) @ (ccfv @ XC @ ccbs)))))).
thf(afvn0elsuppb_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XB2 @ XV) & (cwcel @ XX @ XB2) & (cwfn @ XG @ XB2)) => (((ccfv @ XX @ XG) != cc0) <=> (cwcel @ XX @ (cco @ XG @ cc0 @ ccsupp))))))))).
thf(cbrcic_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XI = (ccfv @ XC @ cciso)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => (Xph => ((cwbr @ XX @ XY @ (ccfv @ XC @ cccic)) <=> ((cco @ XX @ XY @ XI) != cc0))))))))))))))).
