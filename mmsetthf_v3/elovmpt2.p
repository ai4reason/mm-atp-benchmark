...
thf(celovmpt2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : ((XD @ Xa @ Xb) = (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : XA2)) @ (^ [Xa:$i] : (^ [Xb:$i] : XB2)) @ (^ [Xa:$i] : (^ [Xb:$i] : (XC @ Xa @ Xb))))))) => ((! [Xa:$i] : (! [Xb:$i] : (cwcel @ (XC @ Xa @ Xb) @ ccvv))) => ((! [Xa:$i] : (! [Xb:$i] : ((((ccv @ Xa) = XX) & ((ccv @ Xb) = XY)) => ((XC @ Xa @ Xb) = XE)))) => (! [Xa:$i] : (! [Xb:$i] : ((cwcel @ XF @ (cco @ XX @ XY @ (XD @ Xa @ Xb))) <=> ((cwcel @ XX @ XA2) & (cwcel @ XY @ XB2) & (cwcel @ XF @ XE))))))))))))))))).
