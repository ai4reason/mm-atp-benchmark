...
thf(acbvmpt2x2_thm,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwnfc @ (^ [Xz:$i] : (XA2 @ Xx3 @ Xy1 @ Xz))))) => ((! [Xz:$i] : (! [Xw:$i] : (cwnfc @ (^ [Xy1:$i] : (XD @ Xy1 @ Xz @ Xw))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (cwnfc @ (^ [Xz:$i] : (XC @ Xx3 @ Xy1 @ Xz @ Xw)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwnfc @ (^ [Xw:$i] : (XC @ Xx3 @ Xy1 @ Xz @ Xw)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwnfc @ (^ [Xx3:$i] : (XE @ Xx3 @ Xy1 @ Xz @ Xw)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwnfc @ (^ [Xy1:$i] : (XE @ Xx3 @ Xy1 @ Xz @ Xw)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (((ccv @ Xy1) = (ccv @ Xz)) => ((XA2 @ Xx3 @ Xy1 @ Xz) = (XD @ Xy1 @ Xz @ Xw))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((((ccv @ Xy1) = (ccv @ Xz)) & ((ccv @ Xx3) = (ccv @ Xw))) => ((XC @ Xx3 @ Xy1 @ Xz @ Xw) = (XE @ Xx3 @ Xy1 @ Xz @ Xw))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1 @ Xz))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1 @ Xz @ Xw)))) = (ccmpt2 @ (^ [Xw:$i] : (^ [Xz:$i] : (XD @ Xy1 @ Xz @ Xw))) @ (^ [Xw:$i] : (^ [Xz:$i] : XB2)) @ (^ [Xw:$i] : (^ [Xz:$i] : (XE @ Xx3 @ Xy1 @ Xz @ Xw))))))))))))))))))))))).
...
thf(ampt2mptx2_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xz) = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) => ((XC @ Xz) = (XD @ Xx3 @ Xy1)))))) => ((ccmpt @ (^ [Xz:$i] : (cciun @ (^ [Xy1:$i] : (XB2 @ Xy1)) @ (^ [Xy1:$i] : (ccxp @ (XA2 @ Xy1) @ (ccsn @ (ccv @ Xy1)))))) @ (^ [Xz:$i] : (XC @ Xz))) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xy1))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XB2 @ Xy1))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XD @ Xx3 @ Xy1))))))))))).
...
thf(cdmmpt2ssx2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xy1))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwss @ (ccdm @ (XF @ Xx3 @ Xy1)) @ (cciun @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (ccxp @ (XA2 @ Xy1) @ (ccsn @ (ccv @ Xy1)))))))))))))).
