...
thf(chdmap14lem6_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xg1:$i] : ((XH @ Xg1) = (ccfv @ (XK @ Xg1) @ cclh))) => ((! [Xg1:$i] : ((XU @ Xg1) = (ccfv @ (XW @ Xg1) @ (ccfv @ (XK @ Xg1) @ ccdvh)))) => ((! [Xg1:$i] : ((XV @ Xg1) = (ccfv @ (XU @ Xg1) @ ccbs))) => ((! [Xg1:$i] : ((Xc_x @ Xg1) = (ccfv @ (XU @ Xg1) @ ccvsca))) => ((! [Xg1:$i] : ((Xc_0 @ Xg1) = (ccfv @ (XU @ Xg1) @ cc0g))) => ((! [Xg1:$i] : ((XR @ Xg1) = (ccfv @ (XU @ Xg1) @ ccsca))) => ((! [Xg1:$i] : ((XB2 @ Xg1) = (ccfv @ (XR @ Xg1) @ ccbs))) => ((! [Xg1:$i] : ((XZ @ Xg1) = (ccfv @ (XR @ Xg1) @ cc0g))) => ((! [Xg1:$i] : (XC = (ccfv @ (XW @ Xg1) @ (ccfv @ (XK @ Xg1) @ cclcd)))) => ((Xc_xb = (ccfv @ XC @ ccvsca)) => ((! [Xg1:$i] : ((XL @ Xg1) = (ccfv @ XC @ cclspn))) => ((! [Xg1:$i] : ((XP @ Xg1) = (ccfv @ XC @ ccsca))) => ((! [Xg1:$i] : (XA2 = (ccfv @ (XP @ Xg1) @ ccbs))) => ((! [Xg1:$i] : (XQ = (ccfv @ (XP @ Xg1) @ cc0g))) => ((! [Xg1:$i] : (XS = (ccfv @ (XW @ Xg1) @ (ccfv @ (XK @ Xg1) @ cchdma)))) => ((! [Xg1:$i] : (Xph => ((cwcel @ (XK @ Xg1) @ cchlt) & (cwcel @ (XW @ Xg1) @ (XH @ Xg1))))) => ((! [Xg1:$i] : (Xph => (cwcel @ XX @ (ccdif @ (XV @ Xg1) @ (ccsn @ (Xc_0 @ Xg1)))))) => ((! [Xg1:$i] : (Xph => ((XF @ Xg1) = (XZ @ Xg1)))) => (Xph => (cwreu @ (^ [Xg1:$i] : ((ccfv @ (cco @ (XF @ Xg1) @ XX @ (Xc_x @ Xg1)) @ XS) = (cco @ (ccv @ Xg1) @ (ccfv @ XX @ XS) @ Xc_xb))) @ (^ [Xg1:$i] : XA2)))))))))))))))))))))))))))))))))))))))))).
