...
thf(aqussub_thm,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (cco @ XG @ (cco @ XG @ XS @ ccqg) @ ccqus)) => ((XV = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((XN = (ccfv @ XH @ ccsg)) => (((cwcel @ XS @ (ccfv @ XG @ ccnsg)) & (cwcel @ XX @ XV) & (cwcel @ XY @ XV)) => ((cco @ (ccec @ XX @ (cco @ XG @ XS @ ccqg)) @ (ccec @ XY @ (cco @ XG @ XS @ ccqg)) @ XN) = (ccec @ (cco @ XX @ XY @ Xc_mi) @ (cco @ XG @ XS @ ccqg))))))))))))))))).
...
thf(atgpsubcn_thm,axiom,(! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XJ = (ccfv @ XG @ cctopn)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((cwcel @ XG @ cctgp) => (cwcel @ Xc_mi @ (cco @ (cco @ XJ @ XJ @ cctx) @ XJ @ cccn))))))))).
...
thf(aistgp2_thm,axiom,(! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XJ = (ccfv @ XG @ cctopn)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((cwcel @ XG @ cctgp) <=> ((cwcel @ XG @ ccgrp) & (cwcel @ XG @ cctps) & (cwcel @ Xc_mi @ (cco @ (cco @ XJ @ XJ @ cctx) @ XJ @ cccn)))))))))).
thf(cqustgplem_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (cco @ XG @ (cco @ XG @ XY @ ccqg) @ ccqus)) => ((XX = (ccfv @ XG @ ccbs)) => ((XJ = (ccfv @ XG @ cctopn)) => ((XK = (ccfv @ XH @ cctopn)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccec @ (ccv @ Xx3) @ (cco @ XG @ XY @ ccqg)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xc_mi @ Xx3 @ Xz @ Xw) = (ccmpt2 @ (^ [Xz:$i] : (^ [Xw:$i] : XX)) @ (^ [Xz:$i] : (^ [Xw:$i] : XX)) @ (^ [Xz:$i] : (^ [Xw:$i] : (ccec @ (cco @ (ccv @ Xz) @ (ccv @ Xw) @ (ccfv @ XG @ ccsg)) @ (cco @ XG @ XY @ ccqg))))))))) => (((cwcel @ XG @ cctgp) & (cwcel @ XY @ (ccfv @ XG @ ccnsg))) => (cwcel @ XH @ cctgp))))))))))))))))).
