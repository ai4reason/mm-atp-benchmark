...
thf(apwundif_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccpw @ (ccun @ XA2 @ XB2)) = (ccun @ (ccdif @ (ccpw @ (ccun @ XA2 @ XB2)) @ (ccpw @ XA2)) @ (ccpw @ XA2)))))).
...
thf(cpwfilem_conj,conjecture,(! [XF:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xb:$i] : (! [Xc:$i] : ((XF @ Xx3 @ Xb @ Xc) = (ccmpt @ (^ [Xc:$i] : (ccpw @ (ccv @ Xb))) @ (^ [Xc:$i] : (ccun @ (ccv @ Xc) @ (ccsn @ (ccv @ Xx3))))))))) => (! [Xx3:$i] : (! [Xb:$i] : ((cwcel @ (ccpw @ (ccv @ Xb)) @ ccfn) => (cwcel @ (ccpw @ (ccun @ (ccv @ Xb) @ (ccsn @ (ccv @ Xx3)))) @ ccfn))))))).
