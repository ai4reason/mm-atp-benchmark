...
thf(amvrf2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XP = (cco @ XI @ XR @ ccmpl)) => ((XV = (cco @ XI @ XR @ ccmvr)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XR @ ccrg)) => (Xph => (cwf @ XI @ XB2 @ XV))))))))))))))).
...
thf(apsrassa_thm,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((Xph => (cwcel @ XI @ XV)) => ((Xph => (cwcel @ XR @ cccrg)) => (Xph => (cwcel @ XS @ ccasa))))))))))).
thf(amvrf_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((XV = (cco @ XI @ XR @ ccmvr)) => ((XB2 = (ccfv @ XS @ ccbs)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XR @ ccrg)) => (Xph => (cwf @ XI @ XB2 @ XV))))))))))))))).
thf(afrn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => (cwss @ (ccrn @ XF) @ XB2)))))).
thf(ccint_tp,type,(ccint : (($i > $o) > ($i > $o)))).
thf(aaspval2_thm,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XW @ ccasp)) => ((XC = (ccfv @ XW @ ccascl)) => ((XR = (ccfv @ (ccfv @ XW @ ccsubrg) @ ccmrc)) => ((XV = (ccfv @ XW @ ccbs)) => (((cwcel @ XW @ ccasa) & (cwss @ XS @ XV)) => ((ccfv @ XS @ XA2) = (ccfv @ (ccun @ (ccrn @ XC) @ XS) @ XR)))))))))))))).
thf(ccsupp_tp,type,(ccsupp : ($i > $o))).
thf(ccsubmnd_tp,type,(ccsubmnd : ($i > $o))).
thf(ccsubg_tp,type,(ccsubg : ($i > $o))).
thf(ccabl_tp,type,(ccabl : ($i > $o))).
thf(amplbas2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XP = (cco @ XI @ XR @ ccmpl)) => ((XS = (cco @ XI @ XR @ ccmps)) => ((XV = (cco @ XI @ XR @ ccmvr)) => ((XA2 = (ccfv @ XS @ ccasp)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XR @ cccrg)) => (Xph => ((ccfv @ (ccrn @ XV) @ XA2) = (ccfv @ XP @ ccbs)))))))))))))))))).
...
thf(amplsubrg_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((XP = (cco @ XI @ XR @ ccmpl)) => ((XU = (ccfv @ XP @ ccbs)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XR @ ccrg)) => (Xph => (cwcel @ XU @ (ccfv @ XS @ ccsubrg)))))))))))))))).
...
thf(aressascl_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XW @ ccascl)) => ((XX = (cco @ XW @ XS @ ccress)) => ((cwcel @ XS @ (ccfv @ XW @ ccsubrg)) => (XA2 = (ccfv @ XX @ ccascl)))))))))).
...
thf(asubmrc_thm,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => ((XG = (ccfv @ (ccin @ XC @ (ccpw @ XD)) @ ccmrc)) => (((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwcel @ XD @ XC) & (cwss @ XU @ XD)) => ((ccfv @ XU @ XG) = (ccfv @ XU @ XF)))))))))))).
...
thf(afnreseql_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (((cwfn @ XF @ XA2) & (cwfn @ XG @ XA2) & (cwss @ XX @ XA2)) => (((ccres @ XF @ XX) = (ccres @ XG @ XX)) <=> (cwss @ XX @ (ccdm @ (ccin @ XF @ XG)))))))))).
thf(afneqeql2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfn @ XF @ XA2) & (cwfn @ XG @ XA2)) => ((XF = XG) <=> (cwss @ XA2 @ (ccdm @ (ccin @ XF @ XG))))))))).
