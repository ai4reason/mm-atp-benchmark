...
thf(cshftfib_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccima @ (cco @ XF @ XA2 @ ccshi) @ (ccsn @ XB2)) = (ccima @ XF @ (ccsn @ (cco @ XB2 @ XA2 @ ccmin)))))))))).
