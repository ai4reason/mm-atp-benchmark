...
thf(asxbrsigalem5_thm,axiom,(! [XR:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : ((! [Xn:$i] : ((XJ @ Xn) = (ccfv @ (ccrn @ ccioo) @ cctg))) => ((! [Xn:$i] : ((XI @ Xn) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccico)))))) => ((! [Xv:$i] : (! [Xu:$i] : (! [Xn:$i] : ((XR @ Xv @ Xu) = (ccmpt2 @ (^ [Xu:$i] : (^ [Xv:$i] : (ccrn @ (XI @ Xn)))) @ (^ [Xu:$i] : (^ [Xv:$i] : (ccrn @ (XI @ Xn)))) @ (^ [Xu:$i] : (^ [Xv:$i] : (ccxp @ (ccv @ Xu) @ (ccv @ Xv))))))))) => (! [Xn:$i] : (cwss @ (ccfv @ (cco @ (XJ @ Xn) @ (XJ @ Xn) @ cctx) @ ccsigagen) @ (cco @ ccbrsiga @ ccbrsiga @ ccsx)))))))))).
...
thf(csxbrsigalem6_conj,conjecture,(! [XJ:($i > $o)] : ((XJ = (ccfv @ (ccrn @ ccioo) @ cctg)) => (cwss @ (ccfv @ (cco @ XJ @ XJ @ cctx) @ ccsigagen) @ (cco @ ccbrsiga @ ccbrsiga @ ccsx))))).
