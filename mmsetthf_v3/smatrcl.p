...
thf(aovrcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwrel @ (ccdm @ XF)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ XF)) => ((cwcel @ XA2 @ ccvv) & (cwcel @ XB2 @ ccvv))))))))).
...
thf(csmatrcl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XS = (cco @ XK @ XL @ (ccfv @ XA2 @ ccsmat))) => ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XK @ (cco @ cc1 @ XM @ ccfz))) => ((Xph => (cwcel @ XL @ (cco @ cc1 @ XN @ ccfz))) => ((Xph => (cwcel @ XA2 @ (cco @ XB2 @ (ccxp @ (cco @ cc1 @ XM @ ccfz) @ (cco @ cc1 @ XN @ ccfz)) @ ccmap))) => (Xph => (cwcel @ XS @ (cco @ XB2 @ (ccxp @ (cco @ cc1 @ (cco @ XM @ cc1 @ ccmin) @ ccfz) @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ ccmap)))))))))))))))))).
