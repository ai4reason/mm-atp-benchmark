...
thf(ctgoldbachlt_conj,conjecture,(cwrex @ (^ [Xm:$i] : ((cwbr @ (cco @ cc8 @ (cco @ (ccdc @ cc1 @ ccc0) @ (ccdc @ cc3 @ ccc0) @ ccexp) @ ccmul) @ (ccv @ Xm) @ cclt) & (cwral @ (^ [Xn:$i] : (((cwbr @ cc7 @ (ccv @ Xn) @ cclt) & (cwbr @ (ccv @ Xn) @ (ccv @ Xm) @ cclt)) => (cwcel @ (ccv @ Xn) @ ccgbo))) @ (^ [Xn:$i] : ccodd)))) @ (^ [Xm:$i] : ccn))).
