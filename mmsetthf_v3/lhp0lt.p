...
thf(alhpexlt_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((Xc_lt = (ccfv @ XK @ ccplt)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xp:$i] : ((XH @ Xp) = (ccfv @ XK @ cclh))) => (! [Xp:$i] : (((cwcel @ XK @ cchlt) & (cwcel @ XW @ (XH @ Xp))) => (cwrex @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XW @ Xc_lt)) @ (^ [Xp:$i] : XA2))))))))))))).
