...
thf(avoncl_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((XS = (ccdm @ (ccfv @ XX @ ccvoln))) => ((Xph => (cwcel @ XA2 @ XS)) => (Xph => (cwcel @ (ccfv @ XA2 @ (ccfv @ XX @ ccvoln)) @ (cco @ ccc0 @ ccpnf @ ccicc))))))))))).
