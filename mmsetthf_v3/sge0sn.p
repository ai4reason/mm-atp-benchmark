...
thf(asuppr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (((cwor @ XA2 @ XR) & (cwcel @ XB2 @ XA2) & (cwcel @ XC @ XA2)) => ((ccsup @ (ccpr @ XB2 @ XC) @ XA2 @ XR) = (ccif @ (cwbr @ XC @ XB2 @ XR) @ XB2 @ XC)))))))).
...
thf(afmptpr_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XB2 @ (XW @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XC @ (XX @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XD @ (XY @ Xx3)))) => ((! [Xx3:$i] : ((Xph & ((ccv @ Xx3) = XA2)) => ((XE @ Xx3) = XC))) => ((! [Xx3:$i] : ((Xph & ((ccv @ Xx3) = XB2)) => ((XE @ Xx3) = XD))) => (Xph => ((ccpr @ (ccop @ XA2 @ XC) @ (ccop @ XB2 @ XD)) = (ccmpt @ (^ [Xx3:$i] : (ccpr @ XA2 @ XB2)) @ (^ [Xx3:$i] : (XE @ Xx3)))))))))))))))))))))).
...
thf(csge0sn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ (ccsn @ XA2) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => (Xph => ((ccfv @ XF @ ccsumge0) = (ccfv @ XA2 @ XF)))))))))).
