...
thf(cdisjunsn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (((ccv @ Xx3) = XM) => ((XB2 @ Xx3) = XC))) => (((cwcel @ XM @ XV) & (~ (cwcel @ XM @ XA2))) => ((cwdisj @ (^ [Xx3:$i] : (ccun @ XA2 @ (ccsn @ XM))) @ (^ [Xx3:$i] : (XB2 @ Xx3))) <=> ((cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) & ((ccin @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XC) = cc0))))))))))).
