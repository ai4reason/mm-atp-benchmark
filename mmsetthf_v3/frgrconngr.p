...
thf(a_2pthfrgr_thm,axiom,(! [XG:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xp:$i] : ((XV @ Xf1 @ Xp) = (ccfv @ XG @ ccvtx)))) => (! [Xf1:$i] : (! [Xp:$i] : ((cwcel @ XG @ ccfrgr) => (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (? [Xf1:$i] : (? [Xp:$i] : ((cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (ccfv @ XG @ ccspthson))) & ((ccfv @ (ccv @ Xf1) @ cchash) = cc2))))) @ (^ [Xb:$i] : (ccdif @ (XV @ Xf1 @ Xp) @ (ccsn @ (ccv @ Xa)))))) @ (^ [Xa:$i] : (XV @ Xf1 @ Xp)))))))))).
...
thf(cfrgrconngr_conj,conjecture,(! [XG:($i > $o)] : ((cwcel @ XG @ ccfrgr) => (cwcel @ XG @ ccconngr)))).
