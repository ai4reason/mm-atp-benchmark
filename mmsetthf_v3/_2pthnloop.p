...
thf(c_2pthnloop_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => (((cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) & (cwbr @ cc1 @ (ccfv @ XF @ cchash) @ cclt)) => (cwral @ (^ [Xi:$i] : (cwbr @ cc2 @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xi) @ XF) @ XI) @ cchash) @ ccle)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)))))))))).
