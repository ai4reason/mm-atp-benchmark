...
thf(aivthle2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XU @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ XD)) => ((Xph => (cwcel @ XF @ (cco @ XD @ ccc @ cccncf))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccicc))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ ccr))) => ((Xph => ((cwbr @ (ccfv @ XB2 @ XF) @ XU @ ccle) & (cwbr @ XU @ (ccfv @ XA2 @ XF) @ ccle))) => (Xph => (cwrex @ (^ [Xc:$i] : ((ccfv @ (ccv @ Xc) @ XF) = XU)) @ (^ [Xc:$i] : (cco @ XA2 @ XB2 @ ccicc))))))))))))))))))).
...
thf(civthicc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XM @ (cco @ XA2 @ XB2 @ ccicc))) => ((Xph => (cwcel @ XN @ (cco @ XA2 @ XB2 @ ccicc))) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ XD)) => ((Xph => (cwcel @ XF @ (cco @ XD @ ccc @ cccncf))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccicc))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ ccr))) => (Xph => (cwss @ (cco @ (ccfv @ XM @ XF) @ (ccfv @ XN @ XF) @ ccicc) @ (ccrn @ XF)))))))))))))))))).
