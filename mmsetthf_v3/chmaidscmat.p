...
thf(cchmaidscmat_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XC = (cco @ XN @ XR @ ccchpmat)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XE = (ccfv @ XP @ ccbs)) => ((XY = (cco @ XN @ XP @ ccmat)) => ((XK = (ccfv @ XY @ ccbs)) => ((Xc_x = (ccfv @ XY @ ccvsca)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((Xc_1 = (ccfv @ XY @ ccur)) => ((XS = (cco @ XN @ XP @ ccscmat)) => (((cwcel @ XN @ ccfn) & (cwcel @ XR @ cccrg) & (cwcel @ XM @ XB2)) => (cwcel @ (cco @ (ccfv @ XM @ XC) @ Xc_1 @ Xc_x) @ XS)))))))))))))))))))))))))))).
