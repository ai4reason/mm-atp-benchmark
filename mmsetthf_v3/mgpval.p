...
thf(adf_mgp_ax,axiom,(ccmgp = (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (cco @ (ccv @ Xw) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (ccfv @ (ccv @ Xw) @ ccmulr)) @ ccsts))))).
...
thf(cmgpval_conj,conjecture,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XM:($i > $o)] : ((XM = (ccfv @ XR @ ccmgp)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (XM = (cco @ XR @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_x) @ ccsts)))))))).
