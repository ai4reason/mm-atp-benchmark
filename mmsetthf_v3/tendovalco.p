...
thf(ctendovalco_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((((cwcel @ XK @ XV) & (cwcel @ XW @ XH) & (cwcel @ XS @ XE)) & ((cwcel @ XF @ XT) & (cwcel @ XG @ XT))) => ((ccfv @ (cccom @ XF @ XG) @ XS) = (cccom @ (ccfv @ XF @ XS) @ (ccfv @ XG @ XS))))))))))))))))).
