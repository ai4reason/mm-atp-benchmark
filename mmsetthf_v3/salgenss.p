...
thf(csalgenss_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ XV)) => ((XG = (ccfv @ XX @ ccsalgen)) => ((Xph => (cwcel @ XS @ ccsalg)) => ((Xph => (cwss @ XX @ XS)) => ((Xph => ((ccuni @ XS) = (ccuni @ XX))) => (Xph => (cwss @ XG @ XS))))))))))))).
