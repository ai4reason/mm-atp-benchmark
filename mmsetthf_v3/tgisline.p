...
thf(atglngval_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((! [Xz:$i] : ((XL @ Xz) = (ccfv @ XG @ cclng))) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XX @ XP)) => ((Xph => (cwcel @ XY @ XP)) => ((Xph => (XX != XY)) => (! [Xz:$i] : (Xph => ((cco @ XX @ XY @ (XL @ Xz)) = (ccrab @ (^ [Xz:$i] : ((cwcel @ (ccv @ Xz) @ (cco @ XX @ XY @ XI)) | (cwcel @ XX @ (cco @ (ccv @ Xz) @ XY @ XI)) | (cwcel @ XY @ (cco @ XX @ (ccv @ Xz) @ XI)))) @ (^ [Xz:$i] : XP)))))))))))))))))))).
...
thf(atglng_thm,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > $o))))] : ((XP = (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XL @ Xx3 @ Xy1 @ Xz) = (ccfv @ XG @ cclng))))) => ((XI = (ccfv @ XG @ ccitv)) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ XG @ ccstrkg) => ((XL @ Xx3 @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XP)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ XP @ (ccsn @ (ccv @ Xx3))))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xz:$i] : ((cwcel @ (ccv @ Xz) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XI)) | (cwcel @ (ccv @ Xx3) @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ XI)) | (cwcel @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ XI)))) @ (^ [Xz:$i] : XP)))))))))))))))))).
...
thf(ctgisline_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > ($i > ($i > $o)))] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccitv)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XL @ Xx3 @ Xy1) = (ccfv @ XG @ cclng)))) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XA2 @ (ccrn @ (XL @ Xx3 @ Xy1)))))) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((XA2 = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XL @ Xx3 @ Xy1))) & ((ccv @ Xx3) != (ccv @ Xy1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))))))))))))))).
