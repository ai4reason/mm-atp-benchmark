...
thf(aefrlim_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : ((! [Xk:$i] : ((XS @ Xk) = (cco @ ccc0 @ (cco @ cc1 @ (cco @ (ccfv @ XA2 @ ccabs) @ cc1 @ ccaddc) @ ccdiv) @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl)))) => ((cwcel @ XA2 @ ccc) => (cwbr @ (ccmpt @ (^ [Xk:$i] : ccrp) @ (^ [Xk:$i] : (cco @ (cco @ cc1 @ (cco @ XA2 @ (ccv @ Xk) @ ccdiv) @ ccaddc) @ (ccv @ Xk) @ cccxp))) @ (ccfv @ XA2 @ cce) @ ccrli)))))).
