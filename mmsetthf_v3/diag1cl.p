...
thf(adiagcl_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > $o)] : (! [XL:($i > $o)] : ((XL = (cco @ XC @ XD @ ccdiag)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XD @ cccat)) => ((XQ = (cco @ XD @ XC @ ccfuc)) => (Xph => (cwcel @ XL @ (cco @ XC @ XQ @ ccfunc))))))))))))).
thf(a_1st2ndbr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwrel @ XB2) & (cwcel @ XA2 @ XB2)) => (cwbr @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XA2 @ cc2nd) @ XB2))))).
thf(cdiag1cl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : ((XL = (cco @ XC @ XD @ ccdiag)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XD @ cccat)) => ((XA2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XX @ XA2)) => ((XK = (ccfv @ XX @ (ccfv @ XL @ cc1st))) => (Xph => (cwcel @ XK @ (cco @ XD @ XC @ ccfunc))))))))))))))))).
