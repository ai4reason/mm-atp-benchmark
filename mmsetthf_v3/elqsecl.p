...
thf(celqsecl_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [Xc_sm:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [Xy1:$i] : ((cwcel @ (XB2 @ Xy1) @ (XX @ Xy1)) => ((cwcel @ (XB2 @ Xy1) @ (ccqs @ (XW @ Xy1) @ Xc_sm)) <=> (cwrex @ (^ [Xx3:$i] : ((XB2 @ Xy1) = (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_sm)))) @ (^ [Xx3:$i] : (XW @ Xy1))))))))))).
