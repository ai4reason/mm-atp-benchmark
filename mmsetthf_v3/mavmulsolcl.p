...
thf(amavmuldm_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XC = (cco @ XB2 @ (ccxp @ XM @ XN) @ ccmap)) => ((XD = (cco @ XB2 @ XN @ ccmap)) => ((Xc_x = (cco @ XR @ (ccop @ XM @ XN) @ ccmvmul)) => (((cwcel @ XR @ XV) & (cwcel @ XM @ ccfn) & (cwcel @ XN @ ccfn)) => ((ccdm @ Xc_x) = (ccxp @ XC @ XD)))))))))))))))).
