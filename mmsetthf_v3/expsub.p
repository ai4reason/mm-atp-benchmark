...
thf(cexpsub_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (XA2 != ccc0)) & ((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz))) => ((cco @ XA2 @ (cco @ XM @ XN @ ccmin) @ ccexp) = (cco @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccdiv))))))).
