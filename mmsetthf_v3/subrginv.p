...
thf(csubrginv_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((XI = (ccfv @ XR @ ccinvr)) => ((XU = (ccfv @ XS @ ccui)) => ((XJ = (ccfv @ XS @ ccinvr)) => (((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) & (cwcel @ XX @ XU)) => ((ccfv @ XX @ XI) = (ccfv @ XX @ XJ))))))))))))))).
