...
thf(atchphl_thm,axiom,(! [XG:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XW @ cctch)) => ((cwcel @ XW @ ccphl) <=> (cwcel @ XG @ ccphl)))))).
...
thf(atngngpd_thm,axiom,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (XT = (cco @ (XG @ Xx3 @ Xy1) @ XN @ cctng)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XX = (ccfv @ (XG @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xc_mi = (ccfv @ (XG @ Xx3 @ Xy1) @ ccsg)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xc_0 = (ccfv @ (XG @ Xx3 @ Xy1) @ cc0g)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XG @ Xx3 @ Xy1) @ ccgrp)))) => ((Xph => (cwf @ XX @ ccr @ XN)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (((ccfv @ (ccv @ Xx3) @ XN) = ccc0) <=> ((ccv @ Xx3) = Xc_0)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xy1) @ XX))) => (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_mi) @ XN) @ (cco @ (ccfv @ (ccv @ Xx3) @ XN) @ (ccfv @ (ccv @ Xy1) @ XN) @ ccaddc) @ ccle)))) => (Xph => (cwcel @ XT @ ccngp)))))))))))))))))).
...
thf(atchcphlem3_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XW @ cctch)) => ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xph => (cwcel @ XW @ ccphl)) => ((Xph => (XF = (cco @ cccnfld @ XK @ ccress))) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((Xph & (cwcel @ XX @ XV)) => (cwcel @ (cco @ XX @ XX @ Xc_xi) @ ccr))))))))))))))))).
...
thf(atchclm_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XW @ cctch)) => ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xph => (cwcel @ XW @ ccphl)) => ((Xph => (XF = (cco @ cccnfld @ XK @ ccress))) => (Xph => (cwcel @ XW @ ccclm)))))))))))))).
thf(aclm0_thm,axiom,(! [XF:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((cwcel @ XW @ ccclm) => (ccc0 = (ccfv @ XF @ cc0g))))))).
...
thf(atchcphlem1_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (ccfv @ XW @ cctch)) => ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xph => (cwcel @ XW @ ccphl)) => ((! [Xx3:$i] : (Xph => (XF = (cco @ cccnfld @ (XK @ Xx3) @ ccress)))) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ (XK @ Xx3)) & (cwcel @ (ccv @ Xx3) @ ccr) & (cwbr @ ccc0 @ (ccv @ Xx3) @ ccle))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ ccsqrt) @ (XK @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XV)) => (cwbr @ ccc0 @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ Xc_xi) @ ccle))) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccfv @ XF @ ccbs))) => ((Xc_mi = (ccfv @ XW @ ccsg)) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwcel @ XY @ XV)) => (Xph => (cwbr @ (ccfv @ (cco @ (cco @ XX @ XY @ Xc_mi) @ (cco @ XX @ XY @ Xc_mi) @ Xc_xi) @ ccsqrt) @ (cco @ (ccfv @ (cco @ XX @ XX @ Xc_xi) @ ccsqrt) @ (ccfv @ (cco @ XY @ XY @ Xc_xi) @ ccsqrt) @ ccaddc) @ ccle))))))))))))))))))))))))).
...
thf(atchcphlem2_thm,axiom,(! [Xph:$o] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (ccfv @ XW @ cctch)) => ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xph => (cwcel @ XW @ ccphl)) => ((! [Xx3:$i] : (Xph => (XF = (cco @ cccnfld @ (XK @ Xx3) @ ccress)))) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ (XK @ Xx3)) & (cwcel @ (ccv @ Xx3) @ ccr) & (cwbr @ ccc0 @ (ccv @ Xx3) @ ccle))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ ccsqrt) @ (XK @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XV)) => (cwbr @ ccc0 @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ Xc_xi) @ ccle))) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccfv @ XF @ ccbs))) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((! [Xx3:$i] : (Xph => (cwcel @ XX @ (XK @ Xx3)))) => ((Xph => (cwcel @ XY @ XV)) => (Xph => ((ccfv @ (cco @ (cco @ XX @ XY @ Xc_x) @ (cco @ XX @ XY @ Xc_x) @ Xc_xi) @ ccsqrt) = (cco @ (ccfv @ XX @ ccabs) @ (ccfv @ (cco @ XY @ XY @ Xc_xi) @ ccsqrt) @ ccmul)))))))))))))))))))))))))).
...
thf(atchnmval_thm,axiom,(! [XG:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XW @ cctch)) => ((XN = (ccfv @ XG @ ccnm)) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_xi = (ccfv @ XW @ ccip)) => (((cwcel @ XW @ ccgrp) & (cwcel @ XX @ XV)) => ((ccfv @ XX @ XN) = (ccfv @ (cco @ XX @ XX @ Xc_xi) @ ccsqrt)))))))))))))).
...
thf(atngnm_thm,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XT = (cco @ XG @ XN @ cctng)) => ((XX = (ccfv @ XG @ ccbs)) => ((cwcel @ XA2 @ ccvv) => (((cwcel @ XG @ ccgrp) & (cwf @ XX @ XA2 @ XN)) => (XN = (ccfv @ XT @ ccnm)))))))))))).
...
thf(ctchcph_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XW @ cctch)) => ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xph => (cwcel @ XW @ ccphl)) => ((! [Xx3:$i] : (Xph => (XF = (cco @ cccnfld @ (XK @ Xx3) @ ccress)))) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ (XK @ Xx3)) & (cwcel @ (ccv @ Xx3) @ ccr) & (cwbr @ ccc0 @ (ccv @ Xx3) @ ccle))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ ccsqrt) @ (XK @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XV)) => (cwbr @ ccc0 @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ Xc_xi) @ ccle))) => (Xph => (cwcel @ XG @ cccph)))))))))))))))))).
