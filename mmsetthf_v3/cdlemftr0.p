...
thf(ccdlemftr0_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((! [Xf1:$i] : ((XB2 @ Xf1) = (ccfv @ XK @ ccbs))) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => (((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) => (cwrex @ (^ [Xf1:$i] : ((ccv @ Xf1) != (ccres @ ccid @ (XB2 @ Xf1)))) @ (^ [Xf1:$i] : XT)))))))))))).
