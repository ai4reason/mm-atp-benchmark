...
thf(cusgr2wlkneq_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cwcel @ XG @ ccusgr) & (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks))) & (((ccfv @ XF @ cchash) = cc2) & ((ccfv @ ccc0 @ XP) != (ccfv @ (ccfv @ XF @ cchash) @ XP)))) => ((((ccfv @ ccc0 @ XP) != (ccfv @ cc1 @ XP)) & ((ccfv @ ccc0 @ XP) != (ccfv @ cc2 @ XP)) & ((ccfv @ cc1 @ XP) != (ccfv @ cc2 @ XP))) & ((ccfv @ ccc0 @ XF) != (ccfv @ cc1 @ XF)))))))).
