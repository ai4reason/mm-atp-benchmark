...
thf(aringmneg2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XN = (ccfv @ XR @ ccminusg)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => (Xph => ((cco @ XX @ (ccfv @ XY @ XN) @ Xc_x) = (ccfv @ (cco @ XX @ XY @ Xc_x) @ XN))))))))))))))))).
...
thf(ccntzsubr_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XM = (ccfv @ XR @ ccmgp)) => ((XZ = (ccfv @ XM @ cccntz)) => (((cwcel @ XR @ ccrg) & (cwss @ XS @ XB2)) => (cwcel @ (ccfv @ XS @ XZ) @ (ccfv @ XR @ ccsubrg)))))))))))).
