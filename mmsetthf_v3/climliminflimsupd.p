...
thf(cclimliminflimsupd_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XM @ ccz)) => ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwf @ XZ @ ccr @ XF)) => ((Xph => (cwcel @ XF @ (ccdm @ ccli))) => (Xph => ((ccfv @ XF @ cclsi) = (ccfv @ XF @ cclsp)))))))))))).
