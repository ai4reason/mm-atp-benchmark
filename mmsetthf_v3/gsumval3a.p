...
thf(agsumvallem2_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XO @ Xx3 @ Xy1) = (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) = (ccv @ Xy1)) & ((cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ Xc_pl) = (ccv @ Xy1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XG @ ccmnd) => ((XO @ Xx3 @ Xy1) = (ccsn @ Xc_0))))))))))))))).
...
thf(cgsumval3a_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : (! [XZ:($i > ($i > ($i > $o)))] : ((XB2 = (ccfv @ XG @ ccbs)) => ((! [Xf1:$i] : ((Xc_0 @ Xf1) = (ccfv @ XG @ cc0g))) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((! [Xx3:$i] : (! [Xf1:$i] : ((XZ @ Xx3 @ Xf1) = (ccfv @ XG @ cccntz)))) => ((Xph => (cwcel @ XG @ ccmnd)) => ((! [Xf1:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xf1)))) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((! [Xx3:$i] : (! [Xf1:$i] : (Xph => (cwss @ (ccrn @ XF) @ (ccfv @ (ccrn @ XF) @ (XZ @ Xx3 @ Xf1)))))) => ((Xph => (cwcel @ XW @ ccfn)) => ((Xph => (XW != cc0)) => ((! [Xf1:$i] : (XW = (cco @ XF @ (Xc_0 @ Xf1) @ ccsupp))) => ((Xph => (~ (cwcel @ XA2 @ (ccrn @ ccfz)))) => (Xph => ((cco @ XG @ XF @ ccgsu) = (ccio @ (^ [Xx3:$i] : (? [Xf1:$i] : ((cwf1o @ (cco @ cc1 @ (ccfv @ XW @ cchash) @ ccfz) @ XW @ (ccv @ Xf1)) & ((ccv @ Xx3) = (ccfv @ (ccfv @ XW @ cchash) @ (ccseq @ Xc_pl @ (cccom @ XF @ (ccv @ Xf1)) @ cc1)))))))))))))))))))))))))))))))).
