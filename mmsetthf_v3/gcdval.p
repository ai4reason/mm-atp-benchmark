...
thf(cgcdval_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ XM @ XN @ ccgcd) = (ccif @ ((XM = ccc0) & (XN = ccc0)) @ ccc0 @ (ccsup @ (ccrab @ (^ [Xn:$i] : ((cwbr @ (ccv @ Xn) @ XM @ ccdvds) & (cwbr @ (ccv @ Xn) @ XN @ ccdvds))) @ (^ [Xn:$i] : ccz)) @ ccr @ cclt))))))).
