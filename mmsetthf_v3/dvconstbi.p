...
thf(asblpnf_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((XD = (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XS @ XS))) => ((Xph & (cwcel @ XP @ XS)) => ((cco @ XP @ ccpnf @ (ccfv @ XD @ ccbl)) = XS))))))))).
...
thf(advsconst_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XS @ (ccpr @ ccr @ ccc)) & (cwcel @ XA2 @ ccc)) => ((cco @ XS @ (ccxp @ XS @ (ccsn @ XA2)) @ ccdv) = (ccxp @ XS @ (ccsn @ ccc0))))))).
...
thf(cdvconstbi_conj,conjecture,(! [Xph:($i > $o)] : (! [XS:($i > $o)] : (! [XY:($i > $o)] : ((! [Xc:$i] : ((Xph @ Xc) => (cwcel @ XS @ (ccpr @ ccr @ ccc)))) => ((! [Xc:$i] : ((Xph @ Xc) => (cwf @ XS @ ccc @ XY))) => ((! [Xc:$i] : ((Xph @ Xc) => ((ccdm @ (cco @ XS @ XY @ ccdv)) = XS))) => (! [Xc:$i] : ((Xph @ Xc) => (((cco @ XS @ XY @ ccdv) = (ccxp @ XS @ (ccsn @ ccc0))) <=> (cwrex @ (^ [Xc:$i] : (XY = (ccxp @ XS @ (ccsn @ (ccv @ Xc))))) @ (^ [Xc:$i] : ccc)))))))))))).
