...
thf(celss2prb_conj,conjecture,(! [XP:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XP @ (ccrab @ (^ [Xz:$i] : ((ccfv @ (ccv @ Xz) @ cchash) = cc2)) @ (^ [Xz:$i] : (ccpw @ XV)))) <=> (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (((ccv @ Xx3) != (ccv @ Xy1)) & (XP = (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : XV))) @ (^ [Xx3:$i] : XV)))))).
