...
thf(clelttrdi_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => ((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccr))) => ((Xph => (cwbr @ XB2 @ XC @ ccle)) => (Xph => ((cwbr @ XA2 @ XB2 @ cclt) => (cwbr @ XA2 @ XC @ cclt)))))))))).
