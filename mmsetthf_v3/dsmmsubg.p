...
thf(adsmmbase_thm,axiom,(! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xf1:$i] : ((XB2 @ Xx3 @ Xf1) = (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) != (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ cc0g))) @ (^ [Xx3:$i] : (ccdm @ XR))) @ ccfn)) @ (^ [Xf1:$i] : (ccfv @ (cco @ XS @ XR @ ccprds) @ ccbs)))))) => (! [Xx3:$i] : (! [Xf1:$i] : ((cwcel @ XR @ (XV @ Xx3 @ Xf1)) => ((XB2 @ Xx3 @ Xf1) = (ccfv @ (cco @ XS @ XR @ ccdsmm) @ ccbs))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(assrab2_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (cwss @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ XA2)))).
thf(afveq2i_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))).
thf(cccom_tp,type,(cccom : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(adsmm0cl_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (cco @ XS @ XR @ ccprds)) => ((XH = (ccfv @ (cco @ XS @ XR @ ccdsmm) @ ccbs)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwf @ XI @ ccmnd @ XR)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => (Xph => (cwcel @ Xc_0 @ XH)))))))))))))))))).
...
thf(adsmmacl_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XP = (cco @ XS @ XR @ ccprds)) => ((XH = (ccfv @ (cco @ XS @ XR @ ccdsmm) @ ccbs)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwf @ XI @ ccmnd @ XR)) => ((Xph => (cwcel @ XJ @ XH)) => ((Xph => (cwcel @ XK @ XH)) => ((Xc_pl = (ccfv @ XP @ ccplusg)) => (Xph => (cwcel @ (cco @ XJ @ XK @ Xc_pl) @ XH)))))))))))))))))))))).
...
thf(aprdsinvgd2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwf @ XI @ ccgrp @ XR)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XN = (ccfv @ XY @ ccminusg)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XJ @ XI)) => (Xph => ((ccfv @ XJ @ (ccfv @ XX @ XN)) = (ccfv @ (ccfv @ XJ @ XX) @ (ccfv @ (ccfv @ XJ @ XR) @ ccminusg)))))))))))))))))))))))).
...
thf(cdsmmsubg_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XP = (cco @ XS @ XR @ ccprds)) => ((XH = (ccfv @ (cco @ XS @ XR @ ccdsmm) @ ccbs)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwf @ XI @ ccgrp @ XR)) => (Xph => (cwcel @ XH @ (ccfv @ XP @ ccsubg))))))))))))))))).
