...
thf(appicl_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwcel @ (ccfv @ XA2 @ ccppi) @ ccn0)))).
...
thf(altsub13d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ cclt)) => (Xph => (cwbr @ XC @ (cco @ XB2 @ XA2 @ ccmin) @ cclt))))))))))).
thf(anndivred_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccn)) => (Xph => (cwcel @ (cco @ XA2 @ XB2 @ ccdiv) @ ccr)))))))).
thf(ccz_tp,type,(ccz : ($i > $o))).
thf(appinncl_thm,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ cc2 @ XA2 @ ccle)) => (cwcel @ (ccfv @ XA2 @ ccppi) @ ccn)))).
...
thf(appiltx_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwbr @ (ccfv @ XA2 @ ccppi) @ XA2 @ cclt)))).
...
thf(appifl_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ (ccfv @ XA2 @ ccfl) @ ccppi) = (ccfv @ XA2 @ ccppi))))).
...
thf(appidif_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ XM @ ccuz)) => ((cco @ (ccfv @ XN @ ccppi) @ (ccfv @ XM @ ccppi) @ ccmin) = (ccfv @ (ccin @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XN @ ccfz) @ ccprime) @ cchash)))))).
...
thf(achtval_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ XA2 @ cccht) = (ccsu @ (ccin @ (cco @ ccc0 @ XA2 @ ccicc) @ ccprime) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xp) @ cclog))))))).
...
thf(appisval2_thm,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ cc2 @ (ccfv @ XM @ ccuz))) => ((ccin @ (cco @ ccc0 @ XA2 @ ccicc) @ ccprime) = (ccin @ (cco @ XM @ (ccfv @ XA2 @ ccfl) @ ccfz) @ ccprime)))))).
thf(cchtppilimlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwbr @ XA2 @ cc1 @ cclt)) => ((Xph => (cwcel @ XN @ (cco @ cc2 @ ccpnf @ ccico))) => ((Xph => (cwbr @ (cco @ (cco @ XN @ XA2 @ cccxp) @ (ccfv @ XN @ ccppi) @ ccdiv) @ (cco @ cc1 @ XA2 @ ccmin) @ cclt)) => (Xph => (cwbr @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ (ccfv @ XN @ ccppi) @ (ccfv @ XN @ cclog) @ ccmul) @ ccmul) @ (ccfv @ XN @ cccht) @ cclt)))))))))).
