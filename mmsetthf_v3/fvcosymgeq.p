...
thf(cfvcosymgeq_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xn:$i] : ((XS @ Xn) = (ccfv @ (XN @ Xn) @ ccsymg))) => ((! [Xn:$i] : ((XB2 @ Xn) = (ccfv @ (XS @ Xn) @ ccbs))) => ((! [Xn:$i] : ((XZ @ Xn) = (ccfv @ (XM @ Xn) @ ccsymg))) => ((! [Xn:$i] : ((XP @ Xn) = (ccfv @ (XZ @ Xn) @ ccbs))) => ((! [Xn:$i] : (XI = (ccin @ (XN @ Xn) @ (XM @ Xn)))) => (! [Xn:$i] : (((cwcel @ XG @ (XB2 @ Xn)) & (cwcel @ XK @ (XP @ Xn))) => (((cwcel @ XX @ XI) & ((ccfv @ XX @ XG) = (ccfv @ XX @ XK)) & (cwral @ (^ [Xn:$i] : ((ccfv @ (ccv @ Xn) @ XF) = (ccfv @ (ccv @ Xn) @ XH))) @ (^ [Xn:$i] : XI))) => ((ccfv @ XX @ (cccom @ XF @ XG)) = (ccfv @ XX @ (cccom @ XH @ XK)))))))))))))))))))))))).
