...
thf(cswrdswrd0_conj,conjecture,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) => (((cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) & (cwcel @ XL @ (cco @ XK @ XN @ ccfz))) => ((cco @ (cco @ XW @ (ccop @ ccc0 @ XN) @ ccsubstr) @ (ccop @ XK @ XL) @ ccsubstr) = (cco @ XW @ (ccop @ XK @ XL) @ ccsubstr)))))))))).
