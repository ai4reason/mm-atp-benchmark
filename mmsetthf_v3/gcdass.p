...
thf(agcdval_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ XM @ XN @ ccgcd) = (ccif @ ((XM = ccc0) & (XN = ccc0)) @ ccc0 @ (ccsup @ (ccrab @ (^ [Xn:$i] : ((cwbr @ (ccv @ Xn) @ XM @ ccdvds) & (cwbr @ (ccv @ Xn) @ XN @ ccdvds))) @ (^ [Xn:$i] : ccz)) @ ccr @ cclt))))))).
...
thf(cgcdass_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XM @ ccz) & (cwcel @ XP @ ccz)) => ((cco @ (cco @ XN @ XM @ ccgcd) @ XP @ ccgcd) = (cco @ XN @ (cco @ XM @ XP @ ccgcd) @ ccgcd))))))).
