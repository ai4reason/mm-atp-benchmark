...
thf(aisi1f_thm,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ ccitg1)) <=> ((cwcel @ XF @ ccmbf) & ((cwf @ ccr @ ccr @ XF) & (cwcel @ (ccrn @ XF) @ ccfn) & (cwcel @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccdif @ ccr @ (ccsn @ ccc0))) @ ccvol) @ ccr)))))).
thf(ci1fd_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : ((Xph => (cwf @ ccr @ ccr @ XF)) => ((Xph => (cwcel @ (ccrn @ XF) @ ccfn)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ (ccrn @ XF) @ (ccsn @ ccc0)))) => (cwcel @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xx3))) @ (ccdm @ ccvol)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ (ccrn @ XF) @ (ccsn @ ccc0)))) => (cwcel @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xx3))) @ ccvol) @ ccr))) => (Xph => (cwcel @ XF @ (ccdm @ ccitg1)))))))))).
