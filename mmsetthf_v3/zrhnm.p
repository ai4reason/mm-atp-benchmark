...
thf(anm1_thm,axiom,(! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XN:($i > $o)] : ((XN = (ccfv @ XR @ ccnm)) => ((Xc_1 = (ccfv @ XR @ ccur)) => (((cwcel @ XR @ ccnrg) & (cwcel @ XR @ ccnzr)) => ((ccfv @ Xc_1 @ XN) = cc1)))))))).
...
thf(czrhnm_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XN = (ccfv @ XR @ ccnm)) => ((XZ = (ccfv @ XR @ cczlm)) => ((XL = (ccfv @ XR @ cczrh)) => ((((cwcel @ XZ @ ccnlm) & (cwcel @ XZ @ ccnrg) & (cwcel @ XR @ ccnzr)) & (cwcel @ XM @ ccz)) => ((ccfv @ (ccfv @ XM @ XL) @ XN) = (ccfv @ XM @ ccabs)))))))))))))).
