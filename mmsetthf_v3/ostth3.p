...
thf(arppwr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn) & (cwcel @ XN @ ccn)) => (((cco @ XA2 @ XB2 @ ccgcd) = cc1) => ((cco @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XB2 @ XN @ ccexp) @ ccgcd) = cc1))))))).
