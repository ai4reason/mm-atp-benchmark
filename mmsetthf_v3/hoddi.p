...
thf(choddi_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XR @ cclo) & (cwf @ cchil @ cchil @ XS) & (cwf @ cchil @ cchil @ XT)) => ((cccom @ XR @ (cco @ XS @ XT @ cchod)) = (cco @ (cccom @ XR @ XS) @ (cccom @ XR @ XT) @ cchod))))))).
