...
thf(axrge0iifmhm_thm,axiom,(! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((XF = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = ccc0) @ ccpnf @ (ccneg @ (ccfv @ (ccv @ Xx3) @ cclog)))))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (cco @ (ccfv @ ccle @ ccordt) @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccrest))) => (cwcel @ XF @ (cco @ (cco @ (ccfv @ cccnfld @ ccmgp) @ (cco @ ccc0 @ cc1 @ ccicc) @ ccress) @ (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress) @ ccmhm))))))).
