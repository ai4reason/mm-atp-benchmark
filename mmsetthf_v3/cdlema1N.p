...
thf(ccdlema1N_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XN = (ccfv @ XK @ cclines)) => ((XF = (ccfv @ XK @ ccpmap)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) & ((cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2) & (cwcel @ XR @ XA2)) & (((XR != XP) & (cwbr @ XR @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)) & ((cwbr @ XP @ XX @ Xc_le) & (cwbr @ XQ @ XY @ Xc_le)) & ((cwcel @ (ccfv @ XY @ XF) @ XN) & (cwcel @ (cco @ XX @ XY @ Xc_an) @ XA2) & (~ (cwbr @ XQ @ XX @ Xc_le))))) => ((cco @ XX @ XR @ Xc_or) = (cco @ XX @ XY @ Xc_or)))))))))))))))))))))))).
