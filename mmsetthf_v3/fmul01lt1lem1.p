...
thf(cfmul01lt1lem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : ((cwnfc @ (^ [Xi:$i] : (XB2 @ Xi))) => (((? [X:$i] : ((^ [Xi:$i] : (Xph @ Xi)) @ X)) => (! [X:$i] : ((^ [Xi:$i] : (Xph @ Xi)) @ X))) => ((! [Xi:$i] : ((XA2 @ Xi) = (ccseq @ ccmul @ (XB2 @ Xi) @ XL))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwcel @ XL @ ccz))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwcel @ XM @ (ccfv @ XL @ ccuz)))) => ((! [Xi:$i] : (((Xph @ Xi) & (cwcel @ (ccv @ Xi) @ (cco @ XL @ XM @ ccfz))) => (cwcel @ (ccfv @ (ccv @ Xi) @ (XB2 @ Xi)) @ ccr))) => ((! [Xi:$i] : (((Xph @ Xi) & (cwcel @ (ccv @ Xi) @ (cco @ XL @ XM @ ccfz))) => (cwbr @ ccc0 @ (ccfv @ (ccv @ Xi) @ (XB2 @ Xi)) @ ccle))) => ((! [Xi:$i] : (((Xph @ Xi) & (cwcel @ (ccv @ Xi) @ (cco @ XL @ XM @ ccfz))) => (cwbr @ (ccfv @ (ccv @ Xi) @ (XB2 @ Xi)) @ cc1 @ ccle))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwcel @ (XE @ Xi) @ ccrp))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwbr @ (ccfv @ XL @ (XB2 @ Xi)) @ (XE @ Xi) @ cclt))) => (! [Xi:$i] : ((Xph @ Xi) => (cwbr @ (ccfv @ XM @ (XA2 @ Xi)) @ (XE @ Xi) @ cclt)))))))))))))))))))).
