...
thf(calephval3_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((ccfv @ XA2 @ ccale) = (ccint @ (^ [Xx3:$i] : (((ccfv @ (ccv @ Xx3) @ cccrd) = (ccv @ Xx3)) & (cwss @ ccom @ (ccv @ Xx3)) & (cwral @ (^ [Xy1:$i] : (~ ((ccv @ Xx3) = (ccfv @ (ccv @ Xy1) @ ccale)))) @ (^ [Xy1:$i] : XA2))))))))).
