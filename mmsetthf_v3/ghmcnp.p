...
thf(cghmcnp_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XJ = (ccfv @ XG @ cctopn)) => ((XK = (ccfv @ XH @ cctopn)) => (((cwcel @ XG @ cctmd) & (cwcel @ XH @ cctmd) & (cwcel @ XF @ (cco @ XG @ XH @ ccghm))) => ((cwcel @ XF @ (ccfv @ XA2 @ (cco @ XJ @ XK @ cccnp))) <=> ((cwcel @ XA2 @ XX) & (cwcel @ XF @ (cco @ XJ @ XK @ cccn)))))))))))))))).
