...
thf(aamgmwlem_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : ((XM = (ccfv @ cccnfld @ ccmgp)) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (XA2 != cc0)) => ((Xph => (cwf @ XA2 @ ccrp @ XF)) => ((Xph => (cwf @ XA2 @ ccrp @ XW)) => ((Xph => ((cco @ cccnfld @ XW @ ccgsu) = cc1)) => (Xph => (cwbr @ (cco @ XM @ (cco @ XF @ XW @ (ccof @ cccxp)) @ ccgsu) @ (cco @ cccnfld @ (cco @ XF @ XW @ (ccof @ ccmul)) @ ccgsu) @ ccle)))))))))))))).
...
thf(camgmlemALT_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((XM = (ccfv @ cccnfld @ ccmgp)) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (XA2 != cc0)) => ((Xph => (cwf @ XA2 @ ccrp @ XF)) => (Xph => (cwbr @ (cco @ (cco @ XM @ XF @ ccgsu) @ (cco @ cc1 @ (ccfv @ XA2 @ cchash) @ ccdiv) @ cccxp) @ (cco @ (cco @ cccnfld @ XF @ ccgsu) @ (ccfv @ XA2 @ cchash) @ ccdiv) @ ccle))))))))))).
