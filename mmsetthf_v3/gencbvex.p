...
thf(cgencbvex_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwcel @ (XA2 @ Xx3) @ ccvv)) => ((! [Xx3:$i] : (! [Xy1:$i] : (((XA2 @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((XA2 @ Xx3) = (ccv @ Xy1)) => ((Xch @ Xx3) <=> (Xth @ Xy1))))) => ((! [Xy1:$i] : ((Xth @ Xy1) <=> (? [Xx3:$i] : ((Xch @ Xx3) & ((XA2 @ Xx3) = (ccv @ Xy1)))))) => ((? [Xx3:$i] : ((Xch @ Xx3) & (Xph @ Xx3))) <=> (? [Xy1:$i] : ((Xth @ Xy1) & (Xps @ Xy1)))))))))))))).
