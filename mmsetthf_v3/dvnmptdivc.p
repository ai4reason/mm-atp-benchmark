...
thf(cdvnmptdivc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwss @ XX @ XS)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XA2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xn) @ (cco @ ccc0 @ XM @ ccfz))) => (cwcel @ (XB2 @ Xx3 @ Xn) @ ccc)))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ (cco @ ccc0 @ XM @ ccfz))) => ((ccfv @ (ccv @ Xn) @ (cco @ XS @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccdvn)) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xn)))))) => ((! [Xn:$i] : (Xph => (cwcel @ (XC @ Xn) @ ccc))) => ((! [Xn:$i] : (Xph => ((XC @ Xn) != ccc0))) => ((Xph => (cwcel @ XM @ ccn0)) => (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ (cco @ ccc0 @ XM @ ccfz))) => ((ccfv @ (ccv @ Xn) @ (cco @ XS @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (XA2 @ Xx3) @ (XC @ Xn) @ ccdiv))) @ ccdvn)) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xx3 @ Xn) @ (XC @ Xn) @ ccdiv)))))))))))))))))))))).
