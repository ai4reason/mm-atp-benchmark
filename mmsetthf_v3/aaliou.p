...
thf(aaalioulem6_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xq:$i] : (! [Xp:$i] : ((XN @ Xq @ Xp) = (ccfv @ XF @ ccdgr)))) => ((Xph => (cwcel @ XF @ (ccfv @ ccz @ ccply))) => ((! [Xq:$i] : (! [Xp:$i] : (Xph => (cwcel @ (XN @ Xq @ Xp) @ ccn)))) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => ((ccfv @ XA2 @ XF) = ccc0)) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xp:$i] : (cwral @ (^ [Xq:$i] : ((XA2 = (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv)) | (cwbr @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xq) @ (XN @ Xq @ Xp) @ ccexp) @ ccdiv) @ (ccfv @ (cco @ XA2 @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv) @ ccmin) @ ccabs) @ ccle))) @ (^ [Xq:$i] : ccn))) @ (^ [Xp:$i] : ccz))) @ (^ [Xx3:$i] : ccrp))))))))))))).
