...
thf(aincexclem_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwcel @ XB2 @ ccfn)) => ((cco @ (ccfv @ XB2 @ cchash) @ (ccfv @ (ccin @ XB2 @ (ccuni @ XA2)) @ cchash) @ ccmin) = (ccsu @ (ccpw @ XA2) @ (^ [Xs1:$i] : (cco @ (cco @ (ccneg @ cc1) @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccexp) @ (ccfv @ (ccin @ XB2 @ (ccint @ (ccv @ Xs1))) @ cchash) @ ccmul)))))))).
