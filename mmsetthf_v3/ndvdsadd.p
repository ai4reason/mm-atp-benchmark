...
thf(cndvdsadd_conj,conjecture,(! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XD @ ccn) & ((cwcel @ XK @ ccn) & (cwbr @ XK @ XD @ cclt))) => ((cwbr @ XD @ XN @ ccdvds) => (~ (cwbr @ XD @ (cco @ XN @ XK @ ccaddc) @ ccdvds)))))))).
