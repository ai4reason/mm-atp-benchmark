...
thf(cdifsqpwdvds_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccn0) & (cwcel @ XB2 @ ccn0) & (cwbr @ (cco @ XB2 @ cc1 @ ccaddc) @ XA2 @ cclt)) & ((cwcel @ XC @ ccprime) & (cwcel @ XD @ ccn0))) => (((cco @ XC @ XD @ ccexp) = (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccmin)) => (cwbr @ XC @ (cco @ cc2 @ XB2 @ ccmul) @ ccdvds)))))))).
