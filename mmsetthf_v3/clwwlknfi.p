...
thf(aclwwlkneq0_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (((cwnel @ XG @ ccvv) | (cwnel @ XN @ ccn)) => ((cco @ XN @ XG @ ccclwwlkn) = cc0))))).
thf(ccom_tp,type,(ccom : ($i > $o))).
thf(a_0fin_thm,axiom,(cwcel @ cc0 @ ccfn)).
thf(cclwwlknfi_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ (ccfv @ XG @ ccvtx) @ ccfn) => (cwcel @ (cco @ XN @ XG @ ccclwwlkn) @ ccfn))))).
