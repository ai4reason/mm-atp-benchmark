...
thf(cpl42N_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((Xc_pe = (ccfv @ XK @ ccoc)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) & ((cwcel @ XZ @ XB2) & (cwcel @ XW @ XB2) & (cwcel @ XV @ XB2))) => (((cwbr @ XX @ (ccfv @ XY @ Xc_pe) @ Xc_le) & (cwbr @ XZ @ (ccfv @ XW @ Xc_pe) @ Xc_le)) => (cwbr @ (cco @ (cco @ (cco @ (cco @ XX @ XY @ Xc_or) @ XZ @ Xc_an) @ XW @ Xc_or) @ XV @ Xc_an) @ (cco @ (cco @ XX @ XY @ Xc_or) @ (cco @ (cco @ XX @ XW @ Xc_or) @ (cco @ XY @ XV @ Xc_or) @ Xc_an) @ Xc_or) @ Xc_le)))))))))))))))))))).
