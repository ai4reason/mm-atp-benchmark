...
thf(aply1domn_thm,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((cwcel @ XR @ ccdomn) => (cwcel @ XP @ ccdomn)))))).
...
thf(adeg1xrf_thm,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => (cwf @ XB2 @ ccxr @ XD))))))))).
...
thf(adeg1mul2_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XE = (ccfv @ XR @ ccrlreg)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xc_x = (ccfv @ XP @ ccmulr)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XF @ XB2)) => ((Xph => (XF != Xc_0)) => ((Xph => (cwcel @ (ccfv @ (ccfv @ XF @ XD) @ (ccfv @ XF @ ccco1)) @ XE)) => ((Xph => (cwcel @ XG @ XB2)) => ((Xph => (XG != Xc_0)) => (Xph => ((ccfv @ (cco @ XF @ XG @ Xc_x) @ XD) = (cco @ (ccfv @ XF @ XD) @ (ccfv @ XG @ XD) @ ccaddc)))))))))))))))))))))))))).
thf(aad2antrl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xch & (Xph & Xth)) => Xps))))))).
thf(asimpl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xph)))).
thf(adeg1ldgdomn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XE = (ccfv @ XR @ ccrlreg)) => ((XA2 = (ccfv @ XF @ ccco1)) => (((cwcel @ XR @ ccdomn) & (cwcel @ XF @ XB2) & (XF != Xc_0)) => (cwcel @ (ccfv @ (ccfv @ XF @ XD) @ XA2) @ XE))))))))))))))))).
...
thf(cdeg1mhm_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((XY = (cco @ (ccfv @ XP @ ccmgp) @ (ccdif @ XB2 @ (ccsn @ Xc_0)) @ ccress)) => ((XN = (cco @ cccnfld @ ccn0 @ ccress)) => ((cwcel @ XR @ ccdomn) => (cwcel @ (ccres @ XD @ (ccdif @ XB2 @ (ccsn @ Xc_0))) @ (cco @ XY @ XN @ ccmhm))))))))))))))))).
