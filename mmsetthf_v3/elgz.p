...
thf(adf_gz_ax,axiom,(ccgz = (ccrab @ (^ [Xx3:$i] : ((cwcel @ (ccfv @ (ccv @ Xx3) @ ccre) @ ccz) & (cwcel @ (ccfv @ (ccv @ Xx3) @ ccim) @ ccz))) @ (^ [Xx3:$i] : ccc)))).
thf(a_3anass_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & Xps & Xch) <=> (Xph & (Xps & Xch))))))).
thf(celgz_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccgz) <=> ((cwcel @ XA2 @ ccc) & (cwcel @ (ccfv @ XA2 @ ccre) @ ccz) & (cwcel @ (ccfv @ XA2 @ ccim) @ ccz))))).
