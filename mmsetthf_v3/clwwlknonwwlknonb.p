...
thf(aclwwlknwwlksnb_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ ccn)) => ((cwcel @ XW @ (cco @ XN @ XG @ ccclwwlkn)) <=> (cwcel @ (cco @ XW @ (ccs1 @ (ccfv @ ccc0 @ XW)) @ ccconcat) @ (cco @ XN @ XG @ ccwwlksn)))))))))).
...
thf(cclwwlknonwwlknonb_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ ccn)) => ((cwcel @ XW @ (cco @ XX @ XN @ (ccfv @ XG @ ccclwwlknon))) <=> (cwcel @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ (cco @ XX @ XX @ (cco @ XN @ XG @ ccwwlksnon)))))))))))).
