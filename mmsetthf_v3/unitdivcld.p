...
thf(cunitdivcld_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccicc)) & (cwcel @ XB2 @ (cco @ ccc0 @ cc1 @ ccicc)) & (XB2 != ccc0)) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwcel @ (cco @ XA2 @ XB2 @ ccdiv) @ (cco @ ccc0 @ cc1 @ ccicc))))))).
