...
thf(cdrnginvrcl_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XI = (ccfv @ XR @ ccinvr)) => (((cwcel @ XR @ ccdr) & (cwcel @ XX @ XB2) & (XX != Xc_0)) => (cwcel @ (ccfv @ XX @ XI) @ XB2))))))))))).
