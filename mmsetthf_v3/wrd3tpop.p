...
thf(afntpb_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwfn @ XF @ (cctp @ XA2 @ XB2 @ XC)) <=> (XF = (cctp @ (ccop @ XA2 @ (ccfv @ XA2 @ XF)) @ (ccop @ XB2 @ (ccfv @ XB2 @ XF)) @ (ccop @ XC @ (ccfv @ XC @ XF))))))))))))).
thf(ccc_tp,type,(ccc : ($i > $o))).
thf(ac0ex_thm,axiom,(cwcel @ ccc0 @ ccvv)).
thf(a_1ex_thm,axiom,(cwcel @ cc1 @ ccvv)).
thf(a_2ex_thm,axiom,(cwcel @ cc2 @ ccvv)).
thf(cwrd3tpop_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & ((ccfv @ XW @ cchash) = cc3)) => (XW = (cctp @ (ccop @ ccc0 @ (ccfv @ ccc0 @ XW)) @ (ccop @ cc1 @ (ccfv @ cc1 @ XW)) @ (ccop @ cc2 @ (ccfv @ cc2 @ XW)))))))).
