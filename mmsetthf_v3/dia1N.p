...
thf(cdia1N_conj,conjecture,(! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdia))) => (((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) => ((ccfv @ XW @ XI) = XT))))))))))).
