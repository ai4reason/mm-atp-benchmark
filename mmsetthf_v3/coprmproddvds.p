...
thf(ccoprmproddvds_conj,conjecture,(! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [Xn:$i] : ((((cwss @ XM @ ccn) & (cwcel @ XM @ ccfn)) & ((cwcel @ (XK @ Xn) @ ccn) & (cwf @ ccn @ ccn @ XF)) & ((cwral @ (^ [Xm:$i] : (cwral @ (^ [Xn:$i] : ((cco @ (ccfv @ (ccv @ Xm) @ XF) @ (ccfv @ (ccv @ Xn) @ XF) @ ccgcd) = cc1)) @ (^ [Xn:$i] : (ccdif @ XM @ (ccsn @ (ccv @ Xm)))))) @ (^ [Xm:$i] : XM)) & (cwral @ (^ [Xm:$i] : (cwbr @ (ccfv @ (ccv @ Xm) @ XF) @ (XK @ Xn) @ ccdvds)) @ (^ [Xm:$i] : XM)))) => (cwbr @ (ccprod @ (^ [Xm:$i] : XM) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xm) @ XF))) @ (XK @ Xn) @ ccdvds))))))).
