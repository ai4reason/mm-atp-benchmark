...
thf(czrhchr_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XL = (ccfv @ XR @ cczrh)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cwcel @ XR @ ccrg) => (((ccfv @ XR @ ccchr) = ccc0) <=> (cwf1 @ ccz @ XB2 @ XL))))))))))).
