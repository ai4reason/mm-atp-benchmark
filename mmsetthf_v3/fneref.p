...
thf(aisfne2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XX @ Xx3 @ Xy1 @ Xz) = (ccuni @ XA2))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XY @ Xx3 @ Xy1 @ Xz) = (ccuni @ XB2))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ XB2 @ XC) => ((cwbr @ XA2 @ XB2 @ ccfne) <=> (((XX @ Xx3 @ Xy1 @ Xz) = (XY @ Xx3 @ Xy1 @ Xz)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((cwcel @ (ccv @ Xy1) @ (ccv @ Xz)) & (cwss @ (ccv @ Xz) @ (ccv @ Xx3)))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2)))))))))))))))).
thf(cfneref_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwbr @ XA2 @ XA2 @ ccfne))))).
