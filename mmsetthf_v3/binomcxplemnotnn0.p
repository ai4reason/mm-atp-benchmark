...
thf(adv11cn_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ XA2 @ XR @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl))) => ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XR @ ccxr)) => ((Xph => (cwf @ XX @ ccc @ XF)) => ((Xph => (cwf @ XX @ ccc @ XG)) => ((Xph => ((ccdm @ (cco @ ccc @ XF @ ccdv)) = XX)) => ((Xph => ((cco @ ccc @ XF @ ccdv) = (cco @ ccc @ XG @ ccdv))) => ((Xph => (cwcel @ XC @ XX)) => ((Xph => ((ccfv @ XC @ XF) = (ccfv @ XC @ XG))) => (Xph => (XF = XG))))))))))))))))))).
...
thf(abinomcxplemcvg_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > $o))] : ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((Xph @ Xr) => (cwcel @ (XA2 @ Xj @ Xk @ Xr @ Xb) @ ccrp)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((Xph @ Xr) => (cwcel @ (XB2 @ Xj @ Xk @ Xr @ Xb) @ ccr)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((Xph @ Xr) => (cwbr @ (ccfv @ (XB2 @ Xj @ Xk @ Xr @ Xb) @ ccabs) @ (ccfv @ (XA2 @ Xj @ Xk @ Xr @ Xb) @ ccabs) @ cclt)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((Xph @ Xr) => (cwcel @ (XC @ Xj @ Xk @ Xr @ Xb) @ ccc)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XF @ Xj @ Xr) = (ccmpt @ (^ [Xj:$i] : ccn0) @ (^ [Xj:$i] : (cco @ (XC @ Xj @ Xk @ Xr @ Xb) @ (ccv @ Xj) @ ccbcc)))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XS @ Xj @ Xk @ Xb) = (ccmpt @ (^ [Xb:$i] : ccc) @ (^ [Xb:$i] : (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xj @ Xr)) @ (cco @ (ccv @ Xb) @ (ccv @ Xk) @ ccexp) @ ccmul)))))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XR @ Xj @ Xk @ Xr @ Xb) = (ccsup @ (ccrab @ (^ [Xr:$i] : (cwcel @ (ccseq @ ccaddc @ (ccfv @ (ccv @ Xr) @ (XS @ Xj @ Xk @ Xb)) @ ccc0) @ (ccdm @ ccli))) @ (^ [Xr:$i] : ccr)) @ ccxr @ cclt)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XE @ Xj @ Xk @ Xr @ Xb) = (ccmpt @ (^ [Xb:$i] : ccc) @ (^ [Xb:$i] : (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ (ccfv @ (ccv @ Xk) @ (XF @ Xj @ Xr)) @ ccmul) @ (cco @ (ccv @ Xb) @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ ccexp) @ ccmul)))))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XD @ Xj @ Xk @ Xr @ Xb) = (ccima @ (cccnv @ ccabs) @ (cco @ ccc0 @ (XR @ Xj @ Xk @ Xr @ Xb) @ ccico))))))) => (! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : (((Xph @ Xr) & (cwcel @ (XJ @ Xj) @ (XD @ Xj @ Xk @ Xr @ Xb))) => ((cwcel @ (ccseq @ ccaddc @ (ccfv @ (XJ @ Xj) @ (XS @ Xj @ Xk @ Xb)) @ ccc0) @ (ccdm @ ccli)) & (cwcel @ (ccseq @ ccaddc @ (ccfv @ (XJ @ Xj) @ (XE @ Xj @ Xk @ Xr @ Xb)) @ cc1) @ (ccdm @ ccli)))))))))))))))))))))))))))).
...
thf(abinomcxplemdvsum_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XE:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > $o))] : ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((Xph @ Xr) => (cwcel @ (XA2 @ Xj @ Xk @ Xr @ Xb) @ ccrp)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((Xph @ Xr) => (cwcel @ (XB2 @ Xj @ Xk @ Xr @ Xb) @ ccr)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((Xph @ Xr) => (cwbr @ (ccfv @ (XB2 @ Xj @ Xk @ Xr @ Xb) @ ccabs) @ (ccfv @ (XA2 @ Xj @ Xk @ Xr @ Xb) @ ccabs) @ cclt)))))) => ((! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((Xph @ Xr) => (cwcel @ (XC @ Xk @ Xr @ Xb) @ ccc))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XF @ Xj) = (ccmpt @ (^ [Xj:$i] : ccn0) @ (^ [Xj:$i] : (cco @ (XC @ Xk @ Xr @ Xb) @ (ccv @ Xj) @ ccbcc)))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XS @ Xj @ Xk @ Xr @ Xb) = (ccmpt @ (^ [Xb:$i] : ccc) @ (^ [Xb:$i] : (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xj)) @ (cco @ (ccv @ Xb) @ (ccv @ Xk) @ ccexp) @ ccmul)))))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XR @ Xj @ Xk @ Xr @ Xb) = (ccsup @ (ccrab @ (^ [Xr:$i] : (cwcel @ (ccseq @ ccaddc @ (ccfv @ (ccv @ Xr) @ (XS @ Xj @ Xk @ Xr @ Xb)) @ ccc0) @ (ccdm @ ccli))) @ (^ [Xr:$i] : ccr)) @ ccxr @ cclt)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XE @ Xj @ Xk @ Xr @ Xb) = (ccmpt @ (^ [Xb:$i] : ccc) @ (^ [Xb:$i] : (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ (ccfv @ (ccv @ Xk) @ (XF @ Xj)) @ ccmul) @ (cco @ (ccv @ Xb) @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ ccexp) @ ccmul)))))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XD @ Xj @ Xk @ Xr @ Xb) = (ccima @ (cccnv @ ccabs) @ (cco @ ccc0 @ (XR @ Xj @ Xk @ Xr @ Xb) @ ccico))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XP @ Xj @ Xk @ Xr @ Xb) = (ccmpt @ (^ [Xb:$i] : (XD @ Xj @ Xk @ Xr @ Xb)) @ (^ [Xb:$i] : (ccsu @ ccn0 @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xb) @ (XS @ Xj @ Xk @ Xr @ Xb)))))))))))) => (! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((Xph @ Xr) => ((cco @ ccc @ (XP @ Xj @ Xk @ Xr @ Xb) @ ccdv) = (ccmpt @ (^ [Xb:$i] : (XD @ Xj @ Xk @ Xr @ Xb)) @ (^ [Xb:$i] : (ccsu @ ccn @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xb) @ (XE @ Xj @ Xk @ Xr @ Xb)))))))))))))))))))))))))))))))))).
thf(afdm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => ((ccdm @ XF) = XA2)))))).
thf(ccioc_tp,type,(ccioc : ($i > $o))).
thf(abinomcxplemdvbinom_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((Xph @ Xr @ Xb) => (cwcel @ (XA2 @ Xj @ Xk @ Xr @ Xb) @ ccrp)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((Xph @ Xr @ Xb) => (cwcel @ (XB2 @ Xj @ Xk @ Xr @ Xb) @ ccr)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((Xph @ Xr @ Xb) => (cwbr @ (ccfv @ (XB2 @ Xj @ Xk @ Xr @ Xb) @ ccabs) @ (ccfv @ (XA2 @ Xj @ Xk @ Xr @ Xb) @ ccabs) @ cclt)))))) => ((! [Xr:$i] : (! [Xb:$i] : ((Xph @ Xr @ Xb) => (cwcel @ (XC @ Xr) @ ccc)))) => ((! [Xj:$i] : (! [Xr:$i] : ((XF @ Xj @ Xr) = (ccmpt @ (^ [Xj:$i] : ccn0) @ (^ [Xj:$i] : (cco @ (XC @ Xr) @ (ccv @ Xj) @ ccbcc)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XS @ Xj @ Xk @ Xb) = (ccmpt @ (^ [Xb:$i] : ccc) @ (^ [Xb:$i] : (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xj @ Xr)) @ (cco @ (ccv @ Xb) @ (ccv @ Xk) @ ccexp) @ ccmul)))))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XR @ Xj @ Xk @ Xr @ Xb) = (ccsup @ (ccrab @ (^ [Xr:$i] : (cwcel @ (ccseq @ ccaddc @ (ccfv @ (ccv @ Xr) @ (XS @ Xj @ Xk @ Xb)) @ ccc0) @ (ccdm @ ccli))) @ (^ [Xr:$i] : ccr)) @ ccxr @ cclt)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XE @ Xj @ Xk @ Xr @ Xb) = (ccmpt @ (^ [Xb:$i] : ccc) @ (^ [Xb:$i] : (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ (ccfv @ (ccv @ Xk) @ (XF @ Xj @ Xr)) @ ccmul) @ (cco @ (ccv @ Xb) @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ ccexp) @ ccmul)))))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XD @ Xj @ Xk @ Xr @ Xb) = (ccima @ (cccnv @ ccabs) @ (cco @ ccc0 @ (XR @ Xj @ Xk @ Xr @ Xb) @ ccico))))))) => (! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : (((Xph @ Xr @ Xb) & (~ (cwcel @ (XC @ Xr) @ ccn0))) => ((cco @ ccc @ (ccmpt @ (^ [Xb:$i] : (XD @ Xj @ Xk @ Xr @ Xb)) @ (^ [Xb:$i] : (cco @ (cco @ cc1 @ (ccv @ Xb) @ ccaddc) @ (ccneg @ (XC @ Xr)) @ cccxp))) @ ccdv) = (ccmpt @ (^ [Xb:$i] : (XD @ Xj @ Xk @ Xr @ Xb)) @ (^ [Xb:$i] : (cco @ (ccneg @ (XC @ Xr)) @ (cco @ (cco @ cc1 @ (ccv @ Xb) @ ccaddc) @ (cco @ (ccneg @ (XC @ Xr)) @ cc1 @ ccmin) @ cccxp) @ ccmul)))))))))))))))))))))))))))).
...
thf(aisumadd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XF) = (XA2 @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XA2 @ Xk) @ ccc))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XG) = (XB2 @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XB2 @ Xk) @ ccc))) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli))) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XG @ XM) @ (ccdm @ ccli))) => (Xph => ((ccsu @ XZ @ (^ [Xk:$i] : (cco @ (XA2 @ Xk) @ (XB2 @ Xk) @ ccaddc))) = (cco @ (ccsu @ XZ @ (^ [Xk:$i] : (XA2 @ Xk))) @ (ccsu @ XZ @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccaddc))))))))))))))))))).
...
thf(abccp1k_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XK @ ccn0)) => (Xph => ((cco @ XC @ (cco @ XK @ cc1 @ ccaddc) @ ccbcc) = (cco @ (cco @ XC @ XK @ ccbcc) @ (cco @ (cco @ XC @ XK @ ccmin) @ (cco @ XK @ cc1 @ ccaddc) @ ccdiv) @ ccmul))))))))).
...
thf(aisummulc2_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XF) = (XA2 @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XA2 @ Xk) @ ccc))) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli))) => ((Xph => (cwcel @ XB2 @ ccc)) => (Xph => ((cco @ XB2 @ (ccsu @ XZ @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccmul) = (ccsu @ XZ @ (^ [Xk:$i] : (cco @ XB2 @ (XA2 @ Xk) @ ccmul)))))))))))))))))).
thf(ccid_tp,type,(ccid : ($i > $o))).
thf(aisumshft_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xj:$i] : (! [Xk:$i] : ((XZ @ Xj) = (ccfv @ (XM @ Xj @ Xk) @ ccuz)))) => ((! [Xj:$i] : (! [Xk:$i] : (XW = (ccfv @ (cco @ (XM @ Xj @ Xk) @ XK @ ccaddc) @ ccuz)))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xj) = (cco @ XK @ (ccv @ Xk) @ ccaddc)) => ((XA2 @ Xj) = (XB2 @ Xk))))) => ((Xph => (cwcel @ XK @ ccz)) => ((! [Xj:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XM @ Xj @ Xk) @ ccz)))) => ((! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ XW)) => (cwcel @ (XA2 @ Xj) @ ccc))) => (! [Xj:$i] : (Xph => ((ccsu @ XW @ (^ [Xj:$i] : (XA2 @ Xj))) = (ccsu @ (XZ @ Xj) @ (^ [Xk:$i] : (XB2 @ Xk)))))))))))))))))))).
...
thf(abccn0_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XC @ ccc)) => (Xph => ((cco @ XC @ ccc0 @ ccbcc) = cc1)))))).
...
thf(abinomcxplemwb_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XK @ ccn)) => (Xph => ((cco @ (cco @ (cco @ XC @ XK @ ccmin) @ (cco @ XC @ XK @ ccbcc) @ ccmul) @ (cco @ (cco @ XC @ (cco @ XK @ cc1 @ ccmin) @ ccmin) @ (cco @ XC @ (cco @ XK @ cc1 @ ccmin) @ ccbcc) @ ccmul) @ ccaddc) = (cco @ XC @ (cco @ XC @ XK @ ccbcc) @ ccmul))))))))).
...
thf(aoffval2f_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (((? [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X))) => ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XA2 @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => (cwcel @ (XB2 @ Xx3) @ (XW @ Xx3)))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => (cwcel @ (XC @ Xx3) @ (XX @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3)))))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cco @ (XF @ Xx3) @ (XG @ Xx3) @ (ccof @ XR)) = (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xx3) @ (XC @ Xx3) @ XR)))))))))))))))))))))))).
...
thf(advconst_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ ccc @ (ccxp @ ccc @ (ccsn @ XA2)) @ ccdv) = (ccxp @ ccc @ (ccsn @ ccc0)))))).
...
thf(ablcntr_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XP @ XX) & (cwcel @ XR @ ccrp)) => (cwcel @ XP @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl))))))))).
thf(asyldanl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (((Xph & Xps) => Xch) => ((((Xph & Xch) & Xth) => Xta) => (((Xph & Xps) & Xth) => Xta))))))))).
thf(avtoclf_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (((? [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3)) @ X))) => ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> (Xps @ Xx3)))) => ((! [Xx3:$i] : (Xph @ Xx3)) => (! [Xx3:$i] : (Xps @ Xx3)))))))))).
...
thf(aofdivcan4_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwf @ XA2 @ ccc @ XF) & (cwf @ XA2 @ (ccdif @ ccc @ (ccsn @ ccc0)) @ XG)) => ((cco @ (cco @ XF @ XG @ (ccof @ ccmul)) @ XG @ (ccof @ ccdiv)) = XF))))))).
...
thf(aisummulc1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XF) = (XA2 @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XA2 @ Xk) @ ccc))) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli))) => ((Xph => (cwcel @ XB2 @ ccc)) => (Xph => ((cco @ (ccsu @ XZ @ (^ [Xk:$i] : (XA2 @ Xk))) @ XB2 @ ccmul) = (ccsu @ XZ @ (^ [Xk:$i] : (cco @ (XA2 @ Xk) @ XB2 @ ccmul)))))))))))))))))).
...
thf(cbinomcxplemnotnn0_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : ((! [Xj:$i] : (! [Xr:$i] : ((Xph @ Xr) => (cwcel @ (XA2 @ Xj) @ ccrp)))) => ((! [Xj:$i] : (! [Xr:$i] : ((Xph @ Xr) => (cwcel @ (XB2 @ Xj) @ ccr)))) => ((! [Xj:$i] : (! [Xr:$i] : ((Xph @ Xr) => (cwbr @ (ccfv @ (XB2 @ Xj) @ ccabs) @ (ccfv @ (XA2 @ Xj) @ ccabs) @ cclt)))) => ((! [Xr:$i] : ((Xph @ Xr) => (cwcel @ (XC @ Xr) @ ccc))) => ((! [Xj:$i] : (! [Xr:$i] : ((XF @ Xj) = (ccmpt @ (^ [Xj:$i] : ccn0) @ (^ [Xj:$i] : (cco @ (XC @ Xr) @ (ccv @ Xj) @ ccbcc)))))) => ((! [Xj:$i] : (! [Xb:$i] : ((XS @ Xj @ Xb) = (ccmpt @ (^ [Xb:$i] : ccc) @ (^ [Xb:$i] : (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xj)) @ (cco @ (ccv @ Xb) @ (ccv @ Xk) @ ccexp) @ ccmul)))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XR @ Xj @ Xk @ Xr @ Xb) = (ccsup @ (ccrab @ (^ [Xr:$i] : (cwcel @ (ccseq @ ccaddc @ (ccfv @ (ccv @ Xr) @ (XS @ Xj @ Xb)) @ ccc0) @ (ccdm @ ccli))) @ (^ [Xr:$i] : ccr)) @ ccxr @ cclt)))))) => ((! [Xj:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XE @ Xr @ Xb) = (ccmpt @ (^ [Xb:$i] : ccc) @ (^ [Xb:$i] : (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ (ccfv @ (ccv @ Xk) @ (XF @ Xj)) @ ccmul) @ (cco @ (ccv @ Xb) @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ ccexp) @ ccmul))))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XD @ Xr @ Xb) = (ccima @ (cccnv @ ccabs) @ (cco @ ccc0 @ (XR @ Xj @ Xk @ Xr @ Xb) @ ccico))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XP @ Xj @ Xk @ Xr @ Xb) = (ccmpt @ (^ [Xb:$i] : (XD @ Xr @ Xb)) @ (^ [Xb:$i] : (ccsu @ ccn0 @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xb) @ (XS @ Xj @ Xb)))))))))))) => (! [Xj:$i] : (! [Xr:$i] : (((Xph @ Xr) & (~ (cwcel @ (XC @ Xr) @ ccn0))) => ((cco @ (cco @ (XA2 @ Xj) @ (XB2 @ Xj) @ ccaddc) @ (XC @ Xr) @ cccxp) = (ccsu @ ccn0 @ (^ [Xk:$i] : (cco @ (cco @ (XC @ Xr) @ (ccv @ Xk) @ ccbcc) @ (cco @ (cco @ (XA2 @ Xj) @ (cco @ (XC @ Xr) @ (ccv @ Xk) @ ccmin) @ cccxp) @ (cco @ (XB2 @ Xj) @ (ccv @ Xk) @ ccexp) @ ccmul) @ ccmul)))))))))))))))))))))))))))).
