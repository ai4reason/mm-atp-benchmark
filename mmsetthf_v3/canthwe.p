...
thf(abr0_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (~ (cwbr @ XA2 @ XB2 @ cc0))))).
thf(cwor_tp,type,(cwor : (($i > $o) > (($i > $o) > $o)))).
thf(cwfr_tp,type,(cwfr : (($i > $o) > (($i > $o) > $o)))).
thf(awesn_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwrel @ XR) => ((cwwe @ (ccsn @ XA2) @ XR) <=> (~ (cwbr @ XA2 @ XA2 @ XR))))))).
thf(aopelopaba_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : ((((ccv @ Xx3) = XA2) & ((ccv @ Xy1) = XB2)) => ((Xph @ Xx3 @ Xy1) <=> Xps)))) => ((cwcel @ (ccop @ XA2 @ XB2) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))) <=> Xps))))))))).
...
thf(ccanthwe_conj,conjecture,(! [XA2:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((XO = (ccopab @ (^ [Xx3:$i] : (^ [Xr:$i] : ((cwss @ (ccv @ Xx3) @ XA2) & (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3))) & (cwwe @ (ccv @ Xx3) @ (ccv @ Xr))))))) => ((cwcel @ XA2 @ XV) => (cwbr @ XA2 @ XO @ ccsdm))))))).
