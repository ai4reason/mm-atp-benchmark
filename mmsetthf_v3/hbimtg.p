...
thf(chbimtg_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xx3:$i] : (((! [Xx3:$i] : ((Xph @ Xx3) => (! [Xx3:$i] : (Xch @ Xx3)))) & ((Xps @ Xx3) => (! [Xx3:$i] : (Xth @ Xx3)))) => (((Xch @ Xx3) => (Xps @ Xx3)) => (! [Xx3:$i] : ((Xph @ Xx3) => (Xth @ Xx3))))))))))).
