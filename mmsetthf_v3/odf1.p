...
thf(codf1_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccz) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ Xc_x))))) => (! [Xx3:$i] : (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX)) => (((ccfv @ XA2 @ XO) = ccc0) <=> (cwf1 @ ccz @ XX @ (XF @ Xx3)))))))))))))))).
