...
thf(adf_rag_ax,axiom,(ccrag = (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccrab @ (^ [Xw:$i] : (((ccfv @ (ccv @ Xw) @ cchash) = cc3) & ((cco @ (ccfv @ ccc0 @ (ccv @ Xw)) @ (ccfv @ cc2 @ (ccv @ Xw)) @ (ccfv @ (ccv @ Xg1) @ ccds)) = (cco @ (ccfv @ ccc0 @ (ccv @ Xw)) @ (ccfv @ (ccfv @ cc2 @ (ccv @ Xw)) @ (ccfv @ (ccfv @ cc1 @ (ccv @ Xw)) @ (ccfv @ (ccv @ Xg1) @ ccmir))) @ (ccfv @ (ccv @ Xg1) @ ccds))))) @ (^ [Xw:$i] : (ccword @ (ccfv @ (ccv @ Xg1) @ ccbs)))))))).
...
thf(cisrag_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((XS = (ccfv @ XG @ ccmir)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => (Xph => ((cwcel @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccfv @ XG @ ccrag)) <=> ((cco @ XA2 @ XC @ Xc_mi) = (cco @ XA2 @ (ccfv @ XC @ (ccfv @ XB2 @ XS)) @ Xc_mi)))))))))))))))))))))))).
