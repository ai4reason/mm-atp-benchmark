...
thf(climcresiooub_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwbr @ XB2 @ XC @ cclt)) => ((Xph => (cwss @ (cco @ XB2 @ XC @ ccioo) @ XA2)) => ((Xph => (cwcel @ XD @ ccxr)) => ((Xph => (cwbr @ XD @ XB2 @ ccle)) => (Xph => ((cco @ (ccres @ XF @ (cco @ XB2 @ XC @ ccioo)) @ XC @ cclimc) = (cco @ (ccres @ XF @ (cco @ XD @ XC @ ccioo)) @ XC @ cclimc))))))))))))))))).
