...
thf(clspval_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xt:$i] : (XV = (ccfv @ (XW @ Xt) @ ccbs))) => ((! [Xt:$i] : (XS = (ccfv @ (XW @ Xt) @ cclss))) => ((! [Xt:$i] : ((XN @ Xt) = (ccfv @ (XW @ Xt) @ cclspn))) => (! [Xt:$i] : (((cwcel @ (XW @ Xt) @ cclmod) & (cwss @ XU @ XV)) => ((ccfv @ XU @ (XN @ Xt)) = (ccint @ (ccrab @ (^ [Xt:$i] : (cwss @ XU @ (ccv @ Xt))) @ (^ [Xt:$i] : XS))))))))))))))).
