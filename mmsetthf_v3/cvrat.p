...
thf(ccvrat_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_lt = (ccfv @ XK @ ccplt)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cwcel @ XK @ cchlt) & ((cwcel @ XX @ XB2) & (cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2))) => (((XX != Xc_0) & (cwbr @ XX @ (cco @ XP @ XQ @ Xc_or) @ Xc_lt)) => (cwcel @ XX @ XA2)))))))))))))))))).
