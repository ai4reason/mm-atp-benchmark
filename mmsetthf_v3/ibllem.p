...
thf(cibllem_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => ((XB2 @ Xx3) = (XC @ Xx3)))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccif @ ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) & (cwbr @ ccc0 @ (XB2 @ Xx3) @ ccle)) @ (XB2 @ Xx3) @ ccc0) = (ccif @ ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) & (cwbr @ ccc0 @ (XC @ Xx3) @ ccle)) @ (XC @ Xx3) @ ccc0)))))))))).
