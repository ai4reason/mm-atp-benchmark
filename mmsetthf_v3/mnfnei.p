...
thf(cmnfnei_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ ccle @ ccordt)) & (cwcel @ ccmnf @ XA2)) => (cwrex @ (^ [Xx3:$i] : (cwss @ (cco @ ccmnf @ (ccv @ Xx3) @ ccico) @ XA2)) @ (^ [Xx3:$i] : ccr))))).
