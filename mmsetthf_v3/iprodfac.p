...
thf(ciprodfac_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((ccfv @ XA2 @ ccfa) = (ccprod @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ cc1 @ (cco @ cc1 @ (ccv @ Xk) @ ccdiv) @ ccaddc) @ XA2 @ ccexp) @ (cco @ cc1 @ (cco @ XA2 @ (ccv @ Xk) @ ccdiv) @ ccaddc) @ ccdiv))))))).
