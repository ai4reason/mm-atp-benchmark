...
thf(asylow2a_thm,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xc_po:($i > $o)] : (! [Xc_sm:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xu:$i] : (! [Xh:$i] : (XX = (ccfv @ (XG @ Xu @ Xh) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) => (cwcel @ Xc_po @ (cco @ (XG @ Xu @ Xh) @ XY @ ccga)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) => (cwbr @ (XP @ Xx3 @ Xy1 @ Xu @ Xg1 @ Xh) @ (XG @ Xu @ Xh) @ ccpgp))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : ((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) => (cwcel @ XX @ ccfn)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : ((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) => (cwcel @ XY @ ccfn)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((XZ @ Xx3 @ Xy1 @ Xu @ Xg1 @ Xh) = (ccrab @ (^ [Xu:$i] : (cwral @ (^ [Xh:$i] : ((cco @ (ccv @ Xh) @ (ccv @ Xu) @ Xc_po) = (ccv @ Xu))) @ (^ [Xh:$i] : XX))) @ (^ [Xu:$i] : XY)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : ((Xc_sm @ Xx3 @ Xy1 @ Xu @ Xg1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwss @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XY) & (cwrex @ (^ [Xg1:$i] : ((cco @ (ccv @ Xg1) @ (ccv @ Xx3) @ Xc_po) = (ccv @ Xy1))) @ (^ [Xg1:$i] : XX))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) => (cwbr @ (XP @ Xx3 @ Xy1 @ Xu @ Xg1 @ Xh) @ (cco @ (ccfv @ XY @ cchash) @ (ccfv @ (XZ @ Xx3 @ Xy1 @ Xu @ Xg1 @ Xh) @ cchash) @ ccmin) @ ccdvds))))))))))))))))))))))).
thf(asylow2blem2_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xc_pl:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XX @ ccfn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XH @ (ccfv @ XG @ ccsubg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XK @ (ccfv @ XG @ ccsubg))))) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_sm = (cco @ XG @ XK @ ccqg)) => ((Xc_x = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XH)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccqs @ XX @ Xc_sm))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrn @ (ccmpt @ (^ [Xz:$i] : (ccv @ Xy1)) @ (^ [Xz:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_pl)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ Xc_x @ (cco @ (cco @ XG @ XH @ ccress) @ (ccqs @ XX @ Xc_sm) @ ccga))))))))))))))))))))).
...
thf(asylow2blem1_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XX @ ccfn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XH @ (ccfv @ XG @ ccsubg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XK @ (ccfv @ XG @ ccsubg))))) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_sm = (cco @ XG @ XK @ ccqg)) => ((Xc_x = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XH)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccqs @ XX @ Xc_sm))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrn @ (ccmpt @ (^ [Xz:$i] : (ccv @ Xy1)) @ (^ [Xz:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_pl)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((Xph @ Xx3 @ Xy1) & (cwcel @ XB2 @ XH) & (cwcel @ XC @ XX)) => ((cco @ XB2 @ (ccec @ XC @ Xc_sm) @ Xc_x) = (ccec @ (cco @ XB2 @ XC @ Xc_pl) @ Xc_sm))))))))))))))))))))))).
...
thf(csylow2blem3_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_pl:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XX @ ccfn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XH @ (ccfv @ XG @ ccsubg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XK @ (ccfv @ XG @ ccsubg))))) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_sm = (cco @ XG @ XK @ ccqg)) => ((Xc_x = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XH)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccqs @ XX @ Xc_sm))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrn @ (ccmpt @ (^ [Xz:$i] : (ccv @ Xy1)) @ (^ [Xz:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_pl)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : ((Xph @ Xx3 @ Xy1) => (cwbr @ (XP @ Xx3 @ Xy1 @ Xz @ Xg1) @ (cco @ XG @ XH @ ccress) @ ccpgp)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : ((Xph @ Xx3 @ Xy1) => ((ccfv @ XK @ cchash) = (cco @ (XP @ Xx3 @ Xy1 @ Xz @ Xg1) @ (cco @ (XP @ Xx3 @ Xy1 @ Xz @ Xg1) @ (ccfv @ XX @ cchash) @ ccpc) @ ccexp))))))) => ((! [Xy1:$i] : (! [Xg1:$i] : ((Xc_mi @ Xy1 @ Xg1) = (ccfv @ XG @ ccsg)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwrex @ (^ [Xg1:$i] : (cwss @ XH @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XK) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xg1) @ (ccv @ Xx3) @ Xc_pl) @ (ccv @ Xg1) @ (Xc_mi @ Xy1 @ Xg1))))))) @ (^ [Xg1:$i] : XX)))))))))))))))))))))))))).
