...
thf(ccphsqrtcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ cccph) & ((cwcel @ XA2 @ XK) & (cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle))) => (cwcel @ (ccfv @ XA2 @ ccsqrt) @ XK))))))))).
