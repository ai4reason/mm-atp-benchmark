...
thf(atposfn2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwrel @ XA2) => ((cwfn @ XF @ XA2) => (cwfn @ (cctpos @ XF) @ (cccnv @ XA2))))))).
...
thf(ctposfo2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwrel @ XA2) => ((cwfo @ XA2 @ XB2 @ XF) => (cwfo @ (cccnv @ XA2) @ XB2 @ (cctpos @ XF)))))))).
