...
thf(algsqrlem5_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) & ((cco @ XA2 @ XP @ cclgs) = cc1)) => (cwrex @ (^ [Xx3:$i] : (cwbr @ XP @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ XA2 @ ccmin) @ ccdvds)) @ (^ [Xx3:$i] : ccz)))))).
