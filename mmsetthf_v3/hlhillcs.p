...
thf(aiscss_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((Xc_pe = (ccfv @ XW @ ccocv)) => ((XC = (ccfv @ XW @ cccss)) => ((cwcel @ XW @ XX) => ((cwcel @ XS @ XC) <=> (XS = (ccfv @ (ccfv @ XS @ Xc_pe) @ Xc_pe)))))))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(asylan2_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xch) => (((Xps & Xch) => Xth) => ((Xps & Xph) => Xth)))))))).
thf(acssss_thm,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XC = (ccfv @ XW @ cccss)) => ((cwcel @ XS @ XC) => (cwss @ XS @ XV))))))))).
...
thf(ahlhilocv_thm,axiom,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XL = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ cchlh))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((XV = (ccfv @ XL @ ccbs)) => ((XN = (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((XO = (ccfv @ XU @ ccocv)) => ((Xph => (cwss @ XX @ XV)) => (Xph => ((ccfv @ XX @ XO) = (ccfv @ XX @ XN)))))))))))))))))))))).
...
thf(chlhillcs_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ cchlh))) => ((XC = (ccfv @ XU @ cccss)) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => (Xph => (XC = (ccrn @ XI)))))))))))))))).
