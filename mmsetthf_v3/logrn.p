...
thf(aeff1o_thm,axiom,(! [XS:($i > $o)] : ((XS = (ccima @ (cccnv @ ccim) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc))) => (cwf1o @ XS @ (ccdif @ ccc @ (ccsn @ ccc0)) @ (ccres @ cce @ XS))))).
...
thf(clogrn_conj,conjecture,((ccrn @ cclog) = (ccima @ (cccnv @ ccim) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc)))).
