...
thf(aaxc9_b1_thm,axiom,(! [Xx3:$i] : ((~ (! [Xz:$i] : ((ccv @ Xz) = (ccv @ Xx3)))) => ((~ (! [Xz:$i] : ((ccv @ Xz) = (ccv @ Xx3)))) => (((ccv @ Xx3) = (ccv @ Xx3)) => (! [Xz:$i] : ((ccv @ Xx3) = (ccv @ Xx3)))))))).
...
thf(chbae_b1_conj,conjecture,((! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3))) => (! [Xz:$i] : (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3)))))).
