...
thf(aabvdiv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (ccfv @ XR @ ccabv)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((((cwcel @ XR @ ccdr) & (cwcel @ XF @ XA2)) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2) & (XY != Xc_0))) => ((ccfv @ (cco @ XX @ XY @ Xc_dv) @ XF) = (cco @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ ccdiv)))))))))))))))).
...
thf(aabvneg_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XR @ ccabv)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XN = (ccfv @ XR @ ccminusg)) => (((cwcel @ XF @ XA2) & (cwcel @ XX @ XB2)) => ((ccfv @ (ccfv @ XX @ XN) @ XF) = (ccfv @ XX @ XF))))))))))))).
...
thf(costthlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XQ = (cco @ cccnfld @ ccq @ ccress)) => ((XA2 = (ccfv @ XQ @ ccabv)) => ((Xph => (cwcel @ XF @ XA2)) => ((Xph => (cwcel @ XG @ XA2)) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ (ccfv @ cc2 @ ccuz))) => ((ccfv @ (ccv @ Xn) @ XF) = (ccfv @ (ccv @ Xn) @ XG)))) => (Xph => (XF = XG))))))))))))).
