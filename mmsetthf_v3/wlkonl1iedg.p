...
thf(cwlkonl1iedg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => (! [Xe:$i] : (((cwbr @ XF @ XP @ (cco @ XA2 @ (XB2 @ Xe) @ (ccfv @ XG @ ccwlkson))) & ((ccfv @ XF @ cchash) != ccc0)) => (cwrex @ (^ [Xe:$i] : (cwcel @ XA2 @ (ccv @ Xe))) @ (^ [Xe:$i] : (ccrn @ XI))))))))))))).
