...
thf(aackbijnn_thm,axiom,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccn0) @ ccfn)) @ (^ [Xx3:$i] : (ccsu @ (ccv @ Xx3) @ (^ [Xy1:$i] : (cco @ cc2 @ (ccv @ Xy1) @ ccexp)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwf1o @ (ccin @ (ccpw @ ccn0) @ ccfn) @ ccn0 @ (XF @ Xx3 @ Xy1))))))).
...
thf(cbitsinv2_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccin @ (ccpw @ ccn0) @ ccfn)) => ((ccfv @ (ccsu @ XA2 @ (^ [Xn:$i] : (cco @ cc2 @ (ccv @ Xn) @ ccexp))) @ ccbits) = XA2)))).
