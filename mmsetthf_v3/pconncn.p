...
thf(cpconncn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xf1:$i] : ((XX @ Xf1) = (ccuni @ XJ))) => (! [Xf1:$i] : (((cwcel @ XJ @ ccpconn) & (cwcel @ XA2 @ (XX @ Xf1)) & (cwcel @ XB2 @ (XX @ Xf1))) => (cwrex @ (^ [Xf1:$i] : (((ccfv @ ccc0 @ (ccv @ Xf1)) = XA2) & ((ccfv @ cc1 @ (ccv @ Xf1)) = XB2))) @ (^ [Xf1:$i] : (cco @ ccii @ XJ @ cccn))))))))))).
