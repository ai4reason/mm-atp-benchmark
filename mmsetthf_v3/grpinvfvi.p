...
thf(agrpinvfn_thm,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XG @ ccminusg)) => (cwfn @ XN @ XB2))))))).
...
thf(cgrpinvfvi_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XN = (ccfv @ XG @ ccminusg)) => (XN = (ccfv @ (ccfv @ XG @ ccid) @ ccminusg)))))).
