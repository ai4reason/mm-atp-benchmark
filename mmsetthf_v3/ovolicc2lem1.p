...
thf(covolicc2lem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((! [Xt:$i] : ((XS @ Xt) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1))) => ((Xph => (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((Xph => (cwcel @ XU @ (ccin @ (ccpw @ (ccrn @ (cccom @ ccioo @ XF))) @ ccfn))) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ (ccuni @ XU))) => ((Xph => (cwf @ XU @ ccn @ XG)) => ((! [Xt:$i] : ((Xph & (cwcel @ (ccv @ Xt) @ XU)) => ((ccfv @ (ccfv @ (ccv @ Xt) @ XG) @ (cccom @ ccioo @ XF)) = (ccv @ Xt)))) => (! [Xt:$i] : ((Xph & (cwcel @ XX @ XU)) => ((cwcel @ (XP @ Xt) @ XX) <=> ((cwcel @ (XP @ Xt) @ ccr) & (cwbr @ (ccfv @ (ccfv @ (ccfv @ XX @ XG) @ XF) @ cc1st) @ (XP @ Xt) @ cclt) & (cwbr @ (XP @ Xt) @ (ccfv @ (ccfv @ (ccfv @ XX @ XG) @ XF) @ cc2nd) @ cclt)))))))))))))))))))))))).
