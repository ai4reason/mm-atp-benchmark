...
thf(celicoelioo_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwbr @ XA2 @ XB2 @ cclt)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico)) <=> ((XC = XA2) | (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo))))))))).
