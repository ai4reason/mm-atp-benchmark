...
thf(cmat2pmatlin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XT = (cco @ XN @ XR @ ccmat2pmat)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XC = (cco @ XN @ XP @ ccmat)) => ((XH = (ccfv @ XC @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((XS = (ccfv @ XP @ ccascl)) => ((Xc_x = (ccfv @ XA2 @ ccvsca)) => ((Xc_xp = (ccfv @ XC @ ccvsca)) => ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ cccrg)) & ((cwcel @ XX @ XK) & (cwcel @ XY @ XB2))) => ((ccfv @ (cco @ XX @ XY @ Xc_x) @ XT) = (cco @ (ccfv @ XX @ XS) @ (ccfv @ XY @ XT) @ Xc_xp)))))))))))))))))))))))))))).
