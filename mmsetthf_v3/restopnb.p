...
thf(crestopnb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XJ @ cctop) & (cwcel @ XA2 @ XV)) & ((cwcel @ XB2 @ XJ) & (cwss @ XB2 @ XA2) & (cwss @ XC @ XB2))) => ((cwcel @ XC @ XJ) <=> (cwcel @ XC @ (cco @ XJ @ XA2 @ ccrest)))))))))).
