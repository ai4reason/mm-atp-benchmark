...
thf(adf_mbf_ax,axiom,(ccmbf = (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccima @ (cccnv @ (cccom @ ccre @ (ccv @ Xf1))) @ (ccv @ Xx3)) @ (ccdm @ ccvol)) & (cwcel @ (ccima @ (cccnv @ (cccom @ ccim @ (ccv @ Xf1))) @ (ccv @ Xx3)) @ (ccdm @ ccvol)))) @ (^ [Xx3:$i] : (ccrn @ ccioo)))) @ (^ [Xf1:$i] : (cco @ ccc @ ccr @ ccpm))))).
thf(cismbf1_conj,conjecture,(! [XF:($i > $o)] : ((cwcel @ XF @ ccmbf) <=> ((cwcel @ XF @ (cco @ ccc @ ccr @ ccpm)) & (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccima @ (cccnv @ (cccom @ ccre @ XF)) @ (ccv @ Xx3)) @ (ccdm @ ccvol)) & (cwcel @ (ccima @ (cccnv @ (cccom @ ccim @ XF)) @ (ccv @ Xx3)) @ (ccdm @ ccvol)))) @ (^ [Xx3:$i] : (ccrn @ ccioo))))))).
