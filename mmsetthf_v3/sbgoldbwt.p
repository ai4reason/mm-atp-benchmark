...
thf(csbgoldbwt_conj,conjecture,((cwral @ (^ [Xn:$i] : ((cwbr @ cc4 @ (ccv @ Xn) @ cclt) => (cwcel @ (ccv @ Xn) @ ccgbe))) @ (^ [Xn:$i] : cceven)) => (cwral @ (^ [Xm:$i] : ((cwbr @ cc5 @ (ccv @ Xm) @ cclt) => (cwcel @ (ccv @ Xm) @ ccgbow))) @ (^ [Xm:$i] : ccodd)))).
