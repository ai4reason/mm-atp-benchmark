...
thf(cdigval_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XB2 @ ccn) & (cwcel @ XK @ ccz) & (cwcel @ XR @ (cco @ ccc0 @ ccpnf @ ccico))) => ((cco @ XK @ XR @ (ccfv @ XB2 @ ccdig)) = (cco @ (ccfv @ (cco @ (cco @ XB2 @ (ccneg @ XK) @ ccexp) @ XR @ ccmul) @ ccfl) @ XB2 @ ccmo))))))).
