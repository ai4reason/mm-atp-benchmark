...
thf(copthpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XD @ ccvv) => ((XA2 != XD) => (((ccpr @ XA2 @ XB2) = (ccpr @ XC @ XD)) <=> ((XA2 = XC) & (XB2 = XD))))))))))))).
