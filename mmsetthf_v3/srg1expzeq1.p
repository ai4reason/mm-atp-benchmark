...
thf(csrg1expzeq1_conj,conjecture,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XG = (ccfv @ XR @ ccmgp)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_1 = (ccfv @ XR @ ccur)) => (((cwcel @ XR @ ccsrg) & (cwcel @ XN @ ccn0)) => ((cco @ XN @ Xc_1 @ Xc_x) = Xc_1))))))))))).
