...
thf(adf_pautN_ax,axiom,(ccpautN = (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (^ [Xf1:$i] : ((cwf1o @ (ccfv @ (ccv @ Xk) @ ccpsubsp) @ (ccfv @ (ccv @ Xk) @ ccpsubsp) @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwss @ (ccv @ Xx3) @ (ccv @ Xy1)) <=> (cwss @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1))))) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xk) @ ccpsubsp)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xk) @ ccpsubsp))))))))).
