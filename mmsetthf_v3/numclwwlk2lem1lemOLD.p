...
thf(cnumclwwlk2lem1lemOLD_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XN @ ccn0) & (cwcel @ XX @ (ccfv @ XG @ ccvtx))) & ((cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) & ((ccfv @ XW @ cclsw) != (ccfv @ ccc0 @ XW)))) => (((ccfv @ ccc0 @ (cco @ XW @ (ccs1 @ XX) @ ccconcat)) = (ccfv @ ccc0 @ XW)) & ((ccfv @ XN @ (cco @ XW @ (ccs1 @ XX) @ ccconcat)) != (ccfv @ ccc0 @ XW))))))))).
