...
thf(cptrescn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (XX = (ccuni @ (XJ @ Xx3)))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ XF @ ccpt))) => ((XK = (ccfv @ (ccres @ XF @ XB2) @ ccpt)) => (! [Xx3:$i] : (((cwcel @ XA2 @ XV) & (cwf @ XA2 @ cctop @ XF) & (cwss @ XB2 @ XA2)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccres @ (ccv @ Xx3) @ XB2))) @ (cco @ (XJ @ Xx3) @ XK @ cccn))))))))))))))).
