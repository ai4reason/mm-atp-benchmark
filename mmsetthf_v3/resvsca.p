...
thf(cresvsca_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XR = (cco @ XW @ XA2 @ ccresv)) => ((XF = (ccfv @ XW @ ccsca)) => ((XB2 = (ccfv @ XF @ ccbs)) => ((cwcel @ XA2 @ XV) => ((cco @ XF @ XA2 @ ccress) = (ccfv @ XR @ ccsca))))))))))))).
