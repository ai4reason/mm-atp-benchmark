...
thf(cinfcvgaux1i_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XR @ Xx3 @ Xy1) = (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (ccneg @ (XA2 @ Xy1 @ Xz @ Xw)))) @ (^ [Xy1:$i] : (XX @ Xz @ Xw))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((cwcel @ (ccv @ Xy1) @ (XX @ Xz @ Xw)) => (cwcel @ (XA2 @ Xy1 @ Xz @ Xw) @ ccr))))) => ((! [Xz:$i] : (! [Xw:$i] : (cwcel @ (XZ @ Xz @ Xw) @ (XX @ Xz @ Xw)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ ccle)) @ (^ [Xw:$i] : (XR @ Xx3 @ Xy1)))) @ (^ [Xz:$i] : ccr)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwss @ (XR @ Xx3 @ Xy1) @ ccr) & ((XR @ Xx3 @ Xy1) != cc0) & (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ ccle)) @ (^ [Xw:$i] : (XR @ Xx3 @ Xy1)))) @ (^ [Xz:$i] : ccr)))))))))))))).
