...
thf(adicfnN_thm,axiom,(! [XA2:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xp:$i] : ((XH @ Xp) = (ccfv @ XK @ cclh))) => ((! [Xp:$i] : ((XI @ Xp) = (ccfv @ XW @ (ccfv @ XK @ ccdic)))) => (! [Xp:$i] : (((cwcel @ XK @ (XV @ Xp)) & (cwcel @ XW @ (XH @ Xp))) => (cwfn @ (XI @ Xp) @ (ccrab @ (^ [Xp:$i] : (~ (cwbr @ (ccv @ Xp) @ XW @ Xc_le))) @ (^ [Xp:$i] : XA2))))))))))))))))).
