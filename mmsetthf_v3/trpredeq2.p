...
thf(ardgeq12_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((XF = XG) & (XA2 = XB2)) => ((ccrdg @ XF @ XA2) = (ccrdg @ XG @ XB2)))))))).
...
thf(ctrpredeq2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = XB2) => ((cctrpred @ XA2 @ XR @ XX) = (cctrpred @ XB2 @ XR @ XX)))))))).
