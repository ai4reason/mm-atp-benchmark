...
thf(cmetf1o_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XN @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ XM))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XY @ XA2) & (cwcel @ XM @ (ccfv @ XX @ ccme)) & (cwf1o @ XY @ XX @ XF)) => (cwcel @ (XN @ Xx3 @ Xy1) @ (ccfv @ XY @ ccme))))))))))))).
