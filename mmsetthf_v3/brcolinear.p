...
thf(cbrcolinear_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & ((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee)) & (cwcel @ XC @ (ccfv @ XN @ ccee)))) => ((cwbr @ XA2 @ (ccop @ XB2 @ XC) @ cccolin) <=> ((cwbr @ XA2 @ (ccop @ XB2 @ XC) @ ccbtwn) | (cwbr @ XB2 @ (ccop @ XC @ XA2) @ ccbtwn) | (cwbr @ XC @ (ccop @ XA2 @ XB2) @ ccbtwn))))))))).
