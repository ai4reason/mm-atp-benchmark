...
thf(chsmexlem7_conj,conjecture,(! [XH:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xz:$i] : ((XH @ Xz) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xz:$i] : ccvv) @ (^ [Xz:$i] : (ccfv @ (ccpw @ (ccxp @ XX @ (ccv @ Xz))) @ cchar))) @ (ccfv @ (ccpw @ XX) @ cchar)) @ ccom))) => (! [Xz:$i] : ((ccfv @ cc0 @ (XH @ Xz)) = (ccfv @ (ccpw @ XX) @ cchar))))))).
