...
thf(cchscllem4_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XA2 @ ccch))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XB2 @ ccch))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwss @ XB2 @ (ccfv @ XA2 @ ccort)))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwf @ ccn @ (cco @ XA2 @ XB2 @ ccph) @ XH))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwbr @ XH @ (ccv @ Xu) @ cchli))) => ((! [Xu:$i] : (! [Xn:$i] : ((XF @ Xu @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XH) @ (ccfv @ XA2 @ ccpjh))))))) => ((! [Xu:$i] : (! [Xn:$i] : ((XG @ Xu @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XH) @ (ccfv @ XB2 @ ccpjh))))))) => (! [Xu:$i] : ((Xph @ Xu) => (cwcel @ (ccv @ Xu) @ (cco @ XA2 @ XB2 @ ccph)))))))))))))))))).
