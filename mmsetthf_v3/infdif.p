...
thf(auncdadom_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => (cwbr @ (ccun @ XA2 @ XB2) @ (cco @ XA2 @ XB2 @ cccda) @ ccdom))))))).
...
thf(acdainf_thm,axiom,(! [XA2:($i > $o)] : ((cwbr @ ccom @ XA2 @ ccdom) <=> (cwbr @ ccom @ (cco @ XA2 @ XA2 @ cccda) @ ccdom)))).
...
thf(ainfcdaabs_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwbr @ ccom @ XA2 @ ccdom) & (cwbr @ XB2 @ XA2 @ ccdom)) => (cwbr @ (cco @ XA2 @ XB2 @ cccda) @ XA2 @ ccen))))).
...
thf(cinfdif_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwbr @ ccom @ XA2 @ ccdom) & (cwbr @ XB2 @ XA2 @ ccsdm)) => (cwbr @ (ccdif @ XA2 @ XB2) @ XA2 @ ccen))))).
