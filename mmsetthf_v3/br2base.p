...
thf(aelpwuni_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ XA2) => ((cwss @ XA2 @ (ccpw @ XB2)) <=> ((ccuni @ XA2) = XB2)))))).
thf(cbr2base_conj,conjecture,((ccuni @ (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccbrsiga)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccbrsiga)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccxp @ (ccv @ Xx3) @ (ccv @ Xy1))))))) = (ccxp @ ccr @ ccr))).
