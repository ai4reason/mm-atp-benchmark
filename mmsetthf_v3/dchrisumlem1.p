...
thf(adchrsum_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [Xc_1:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xa:$i] : ((XG @ Xa) = (ccfv @ (XN @ Xa) @ ccdchr))) => ((! [Xa:$i] : (XZ = (ccfv @ (XN @ Xa) @ cczn))) => ((! [Xa:$i] : ((XD @ Xa) = (ccfv @ (XG @ Xa) @ ccbs))) => ((! [Xa:$i] : (Xc_1 = (ccfv @ (XG @ Xa) @ cc0g))) => ((! [Xa:$i] : (Xph => (cwcel @ XX @ (XD @ Xa)))) => ((XB2 = (ccfv @ XZ @ ccbs)) => (! [Xa:$i] : (Xph => ((ccsu @ XB2 @ (^ [Xa:$i] : (ccfv @ (ccv @ Xa) @ XX))) = (ccif @ (XX = Xc_1) @ (ccfv @ (XN @ Xa) @ ccphi) @ ccc0))))))))))))))))))).
