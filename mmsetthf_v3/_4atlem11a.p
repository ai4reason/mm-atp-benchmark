...
thf(a_4atlem4b_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2)) & ((cwcel @ XR @ XA2) & (cwcel @ XS @ XA2))) => ((cco @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XR @ XS @ Xc_or) @ Xc_or) = (cco @ XQ @ (cco @ (cco @ XP @ XR @ Xc_or) @ XS @ Xc_or) @ Xc_or))))))))))))))).
thf(aeqeq12d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((XA2 = XC) <=> (XB2 = XD))))))))))).
thf(c_4atlem11a_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2)) & ((cwcel @ XU @ XA2) & (cwcel @ XV @ XA2) & (cwcel @ XW @ XA2)) & (~ (cwbr @ XQ @ (cco @ (cco @ XP @ XV @ Xc_or) @ XW @ Xc_or) @ Xc_le))) => ((cwbr @ XQ @ (cco @ (cco @ XP @ XU @ Xc_or) @ (cco @ XV @ XW @ Xc_or) @ Xc_or) @ Xc_le) <=> ((cco @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XV @ XW @ Xc_or) @ Xc_or) = (cco @ (cco @ XP @ XU @ Xc_or) @ (cco @ XV @ XW @ Xc_or) @ Xc_or))))))))))))))))).
