...
thf(crankr1c_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) => ((XB2 = (ccfv @ XA2 @ ccrnk)) <=> ((~ (cwcel @ XA2 @ (ccfv @ XB2 @ ccr1))) & (cwcel @ XA2 @ (ccfv @ (ccsuc @ XB2) @ ccr1)))))))).
