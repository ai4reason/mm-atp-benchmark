...
thf(acarageniuncl_thm,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((! [Xn:$i] : ((XS @ Xn) = (ccfv @ XO @ cccaragen))) => ((Xph => (cwcel @ XM @ ccz)) => ((XZ = (ccfv @ XM @ ccuz)) => ((! [Xn:$i] : (Xph => (cwf @ XZ @ (XS @ Xn) @ XE))) => (! [Xn:$i] : (Xph => (cwcel @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))) @ (XS @ Xn)))))))))))))))).
...
thf(ccaragenunicl_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XS = (ccfv @ XO @ cccaragen)) => ((Xph => (cwss @ XX @ XS)) => ((Xph => (cwbr @ XX @ ccom @ ccdom)) => (Xph => (cwcel @ (ccuni @ XX) @ XS))))))))))).
