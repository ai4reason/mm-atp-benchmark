...
thf(clvolnltN_conj,conjecture,(! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_lt = (ccfv @ XK @ ccplt)) => ((XV = (ccfv @ XK @ cclvol)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XV) & (cwcel @ XY @ XV)) => (~ (cwbr @ XX @ XY @ Xc_lt))))))))))).
