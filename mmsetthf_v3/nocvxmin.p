...
thf(abdayrn_thm,axiom,((ccrn @ ccbday) = ccon0)).
...
thf(abdaydm_thm,axiom,((ccdm @ ccbday) = ccsur)).
...
thf(anocvxminlem_thm,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : (! [Xx3:$i] : (((cwss @ XA2 @ ccsur) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ ccslt) & (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccslt)) => (cwcel @ (ccv @ Xz) @ XA2))) @ (^ [Xz:$i] : ccsur))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))) => ((((cwcel @ XX @ XA2) & (cwcel @ (XY @ Xx3) @ XA2)) & (((ccfv @ XX @ ccbday) = (ccint @ (ccima @ ccbday @ XA2))) & ((ccfv @ (XY @ Xx3) @ ccbday) = (ccint @ (ccima @ ccbday @ XA2))))) => (~ (cwbr @ XX @ (XY @ Xx3) @ ccslt))))))))).
...
thf(cnocvxmin_conj,conjecture,(! [XA2:($i > $o)] : (((XA2 != cc0) & (cwss @ XA2 @ ccsur) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ ccslt) & (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccslt)) => (cwcel @ (ccv @ Xz) @ XA2))) @ (^ [Xz:$i] : ccsur))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))) => (cwreu @ (^ [Xw:$i] : ((ccfv @ (ccv @ Xw) @ ccbday) = (ccint @ (ccima @ ccbday @ XA2)))) @ (^ [Xw:$i] : XA2))))).
