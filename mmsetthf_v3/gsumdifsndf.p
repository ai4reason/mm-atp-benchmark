...
thf(cgsumdifsndf_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((cwnfc @ (^ [Xk:$i] : (XY @ Xk))) => (((? [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X)) => (! [X:$i] : ((^ [Xk:$i] : (Xph @ Xk)) @ X))) => ((XB2 = (ccfv @ XG @ ccbs)) => ((! [Xk:$i] : ((Xc_pl @ Xk) = (ccfv @ XG @ ccplusg))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XG @ cccmn))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XA2 @ (XW @ Xk)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwbr @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XX @ Xk))) @ (ccfv @ XG @ cc0g) @ ccfsupp))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XX @ Xk) @ XB2))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XM @ XA2))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XY @ Xk) @ XB2))) => ((! [Xk:$i] : (((Xph @ Xk) & ((ccv @ Xk) = XM)) => ((XX @ Xk) = (XY @ Xk)))) => (! [Xk:$i] : ((Xph @ Xk) => ((cco @ XG @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XX @ Xk))) @ ccgsu) = (cco @ (cco @ XG @ (ccmpt @ (^ [Xk:$i] : (ccdif @ XA2 @ (ccsn @ XM))) @ (^ [Xk:$i] : (XX @ Xk))) @ ccgsu) @ (XY @ Xk) @ (Xc_pl @ Xk)))))))))))))))))))))))))).
