...
thf(adf_gcd_ax,axiom,(ccgcd = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (((ccv @ Xx3) = ccc0) & ((ccv @ Xy1) = ccc0)) @ ccc0 @ (ccsup @ (ccrab @ (^ [Xn:$i] : ((cwbr @ (ccv @ Xn) @ (ccv @ Xx3) @ ccdvds) & (cwbr @ (ccv @ Xn) @ (ccv @ Xy1) @ ccdvds))) @ (^ [Xn:$i] : ccz)) @ ccr @ cclt))))))).
thf(cgcdf_conj,conjecture,(cwf @ (ccxp @ ccz @ ccz) @ ccn0 @ ccgcd)).
