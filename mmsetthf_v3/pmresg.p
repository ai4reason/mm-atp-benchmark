...
thf(afnpm_thm,axiom,(cwfn @ ccpm @ (ccxp @ ccvv @ ccvv))).
...
thf(cpmresg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XB2 @ XV) & (cwcel @ XF @ (cco @ XA2 @ XC @ ccpm))) => (cwcel @ (ccres @ XF @ XB2) @ (cco @ XA2 @ XB2 @ ccpm))))))))).
