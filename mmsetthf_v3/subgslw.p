...
thf(csubgslw_conj,conjecture,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : ((XH = (cco @ XG @ XS @ ccress)) => (((cwcel @ XS @ (ccfv @ XG @ ccsubg)) & (cwcel @ XK @ (cco @ XP @ XG @ ccslw)) & (cwss @ XK @ XS)) => (cwcel @ XK @ (cco @ XP @ XH @ ccslw)))))))))).
