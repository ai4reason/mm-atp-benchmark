...
thf(celmapintrab_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (cwcel @ (XC @ Xx3) @ ccvv)) => ((! [Xx3:$i] : (cwss @ (XC @ Xx3) @ XB2)) => (! [Xx3:$i] : (! [Xw:$i] : ((cwcel @ XA2 @ (XV @ Xx3 @ Xw)) => ((cwcel @ XA2 @ (ccint @ (ccrab @ (^ [Xw:$i] : (? [Xx3:$i] : (((ccv @ Xw) = (XC @ Xx3)) & (Xph @ Xx3)))) @ (^ [Xw:$i] : (ccpw @ XB2))))) <=> (((? [Xx3:$i] : (Xph @ Xx3)) => (cwcel @ XA2 @ XB2)) & (! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ (XC @ Xx3))))))))))))))))).
