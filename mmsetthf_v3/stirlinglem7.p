...
thf(aclim2ser_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XN @ XZ)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((Xph => (cwbr @ (ccseq @ ccaddc @ XF @ XM) @ XA2 @ ccli)) => (Xph => (cwbr @ (ccseq @ ccaddc @ XF @ (cco @ XN @ cc1 @ ccaddc)) @ (cco @ XA2 @ (ccfv @ XN @ (ccseq @ ccaddc @ XF @ XM)) @ ccmin) @ ccli))))))))))))).
...
thf(astirlinglem6_thm,axiom,(! [XH:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xj:$i] : ((XH @ Xj) = (ccmpt @ (^ [Xj:$i] : ccn0) @ (^ [Xj:$i] : (cco @ cc2 @ (cco @ (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xj) @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ (cco @ (cco @ cc1 @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ (cco @ (cco @ cc2 @ (ccv @ Xj) @ ccmul) @ cc1 @ ccaddc) @ ccexp) @ ccmul) @ ccmul))))) => (! [Xj:$i] : ((cwcel @ XN @ ccn) => (cwbr @ (ccseq @ ccaddc @ (XH @ Xj) @ ccc0) @ (ccfv @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XN @ ccdiv) @ cclog) @ ccli))))))).
...
thf(aseqdistr_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XS)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => ((cco @ XC @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XT) = (cco @ (cco @ XC @ (ccv @ Xx3) @ XT) @ (cco @ XC @ (ccv @ Xy1) @ XT) @ Xc_pl))))) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XM @ XN @ ccfz))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XG) @ XS))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XM @ XN @ ccfz))) => ((ccfv @ (ccv @ Xx3) @ (XF @ Xy1)) = (cco @ XC @ (ccfv @ (ccv @ Xx3) @ XG) @ XT))))) => (! [Xy1:$i] : (Xph => ((ccfv @ XN @ (ccseq @ Xc_pl @ (XF @ Xy1) @ XM)) = (cco @ XC @ (ccfv @ XN @ (ccseq @ Xc_pl @ XG @ XM)) @ XT))))))))))))))))))).
...
thf(cstirlinglem7_conj,conjecture,(! [XH:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xk:$i] : (! [Xn:$i] : ((XJ @ Xk @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ (cco @ cc1 @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccaddc) @ cc2 @ ccdiv) @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ (ccv @ Xn) @ ccdiv) @ cclog) @ ccmul) @ cc1 @ ccmin)))))) => ((! [Xk:$i] : ((XK @ Xk) = (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ (cco @ (cco @ cc1 @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ ccexp) @ ccmul))))) => ((! [Xk:$i] : ((XH @ Xk) = (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ cc2 @ (cco @ (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ (cco @ (cco @ cc1 @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccaddc) @ ccexp) @ ccmul) @ ccmul))))) => (! [Xk:$i] : (! [Xn:$i] : ((cwcel @ XN @ ccn) => (cwbr @ (ccseq @ ccaddc @ (XK @ Xk) @ cc1) @ (ccfv @ XN @ (XJ @ Xk @ Xn)) @ ccli)))))))))))).
