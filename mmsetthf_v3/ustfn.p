...
thf(adf_ust_ax,axiom,(ccust = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (^ [Xu:$i] : ((cwss @ (ccv @ Xu) @ (ccpw @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)))) & (cwcel @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)) @ (ccv @ Xu)) & (cwral @ (^ [Xv:$i] : ((cwral @ (^ [Xw:$i] : ((cwss @ (ccv @ Xv) @ (ccv @ Xw)) => (cwcel @ (ccv @ Xw) @ (ccv @ Xu)))) @ (^ [Xw:$i] : (ccpw @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3))))) & (cwral @ (^ [Xw:$i] : (cwcel @ (ccin @ (ccv @ Xv) @ (ccv @ Xw)) @ (ccv @ Xu))) @ (^ [Xw:$i] : (ccv @ Xu))) & ((cwss @ (ccres @ ccid @ (ccv @ Xx3)) @ (ccv @ Xv)) & (cwcel @ (cccnv @ (ccv @ Xv)) @ (ccv @ Xu)) & (cwrex @ (^ [Xw:$i] : (cwss @ (cccom @ (ccv @ Xw) @ (ccv @ Xw)) @ (ccv @ Xv))) @ (^ [Xw:$i] : (ccv @ Xu)))))) @ (^ [Xv:$i] : (ccv @ Xu))))))))).
thf(custfn_conj,conjecture,(cwfn @ ccust @ ccvv)).
