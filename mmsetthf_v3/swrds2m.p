...
thf(aswrds2_thm,axiom,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XA2)) & (cwcel @ XI @ ccn0) & (cwcel @ (cco @ XI @ cc1 @ ccaddc) @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) => ((cco @ XW @ (ccop @ XI @ (cco @ XI @ cc2 @ ccaddc)) @ ccsubstr) = (ccs2 @ (ccfv @ XI @ XW) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XW)))))))).
...
thf(cswrds2m_conj,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ (cco @ cc2 @ (ccfv @ XW @ cchash) @ ccfz))) => ((cco @ XW @ (ccop @ (cco @ XN @ cc2 @ ccmin) @ XN) @ ccsubstr) = (ccs2 @ (ccfv @ (cco @ XN @ cc2 @ ccmin) @ XW) @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ XW)))))))).
