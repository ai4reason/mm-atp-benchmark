...
thf(ao1bddrp_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : ((! [Xm:$i] : ((Xph @ Xm) => (cwss @ XA2 @ ccr))) => ((! [Xm:$i] : ((Xph @ Xm) => (cwcel @ (XC @ Xm) @ ccr))) => ((! [Xx3:$i] : (! [Xm:$i] : (((Xph @ Xm) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccc)))) => ((! [Xm:$i] : ((Xph @ Xm) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cco1))) => ((! [Xy1:$i] : (! [Xm:$i] : (((Xph @ Xm) & ((cwcel @ (ccv @ Xy1) @ ccr) & (cwbr @ (XC @ Xm) @ (ccv @ Xy1) @ ccle))) => (cwcel @ (XM @ Xy1) @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : ((((Xph @ Xm) & (cwcel @ (ccv @ Xx3) @ XA2)) & (((cwcel @ (ccv @ Xy1) @ ccr) & (cwbr @ (XC @ Xm) @ (ccv @ Xy1) @ ccle)) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt))) => (cwbr @ (ccfv @ (XB2 @ Xx3) @ ccabs) @ (XM @ Xy1) @ ccle))))) => (! [Xm:$i] : ((Xph @ Xm) => (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (XB2 @ Xx3) @ ccabs) @ (ccv @ Xm) @ ccle)) @ (^ [Xx3:$i] : XA2))) @ (^ [Xm:$i] : ccrp)))))))))))))))).
...
thf(aselberg2lem_thm,axiom,(cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccmul))) @ (cco @ (ccfv @ (ccv @ Xx3) @ ccchp) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ ccmin) @ (ccv @ Xx3) @ ccdiv))) @ cco1)).
...
thf(aselberg3lem1_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : ((! [Xy1:$i] : (! [Xk:$i] : ((Xph @ Xy1 @ Xk) => (cwcel @ XA2 @ ccrp)))) => ((! [Xy1:$i] : (! [Xk:$i] : ((Xph @ Xy1 @ Xk) => (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xy1) @ ccfl) @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ ccvma) @ (ccfv @ (ccv @ Xk) @ cclog) @ ccmul))) @ (cco @ (ccfv @ (ccv @ Xy1) @ ccchp) @ (ccfv @ (ccv @ Xy1) @ cclog) @ ccmul) @ ccmin) @ (ccv @ Xy1) @ ccdiv) @ ccabs) @ XA2 @ ccle)) @ (^ [Xy1:$i] : (cco @ cc1 @ ccpnf @ ccico)))))) => (! [Xy1:$i] : (! [Xk:$i] : ((Xph @ Xy1 @ Xk) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (cco @ cc2 @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccdiv) @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ ccchp) @ ccmul) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccmul))) @ ccmul) @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ ccchp) @ ccmul))) @ ccmin) @ (ccv @ Xx3) @ ccdiv))) @ cco1))))))))).
thf(asimpl_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xph)))).
thf(asimpr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(cselberg3lem2_conj,conjecture,(cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (cco @ cc2 @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccdiv) @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ ccchp) @ ccmul) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccmul))) @ ccmul) @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ ccchp) @ ccmul))) @ ccmin) @ (ccv @ Xx3) @ ccdiv))) @ cco1)).
