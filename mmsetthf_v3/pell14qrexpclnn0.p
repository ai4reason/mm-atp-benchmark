...
thf(cpell14qrexpclnn0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) & (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) & (cwcel @ XB2 @ ccn0)) => (cwcel @ (cco @ XA2 @ XB2 @ ccexp) @ (ccfv @ XD @ ccpell14qr))))))).
