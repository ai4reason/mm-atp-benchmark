...
thf(amat1dimelbas_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xr:$i] : ((XA2 @ Xr) = (cco @ (ccsn @ XE) @ XR @ ccmat))) => ((XB2 = (ccfv @ XR @ ccbs)) => ((! [Xr:$i] : ((XO @ Xr) = (ccop @ XE @ XE))) => (! [Xr:$i] : (((cwcel @ XR @ ccrg) & (cwcel @ XE @ XV)) => ((cwcel @ XM @ (ccfv @ (XA2 @ Xr) @ ccbs)) <=> (cwrex @ (^ [Xr:$i] : (XM = (ccsn @ (ccop @ (XO @ Xr) @ (ccv @ Xr))))) @ (^ [Xr:$i] : XB2)))))))))))))))).
...
thf(amat1dimmul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (cco @ (ccsn @ XE) @ XR @ ccmat)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XO = (ccop @ XE @ XE)) => ((((cwcel @ XR @ ccrg) & (cwcel @ XE @ XV)) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2))) => ((cco @ (ccsn @ (ccop @ XO @ XX)) @ (ccsn @ (ccop @ XO @ XY)) @ (ccfv @ XA2 @ ccmulr)) = (ccsn @ (ccop @ XO @ (cco @ XX @ XY @ (ccfv @ XR @ ccmulr)))))))))))))))))).
...
thf(cmat1dimcrng_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (cco @ (ccsn @ XE) @ XR @ ccmat)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XO = (ccop @ XE @ XE)) => (((cwcel @ XR @ cccrg) & (cwcel @ XE @ XV)) => (cwcel @ XA2 @ cccrg)))))))))))).
