...
thf(adfgcd2_thm,axiom,(! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((XD = (cco @ XM @ XN @ ccgcd)) <=> ((cwbr @ ccc0 @ XD @ ccle) & ((cwbr @ XD @ XM @ ccdvds) & (cwbr @ XD @ XN @ ccdvds)) & (cwral @ (^ [Xe:$i] : (((cwbr @ (ccv @ Xe) @ XM @ ccdvds) & (cwbr @ (ccv @ Xe) @ XN @ ccdvds)) => (cwbr @ (ccv @ Xe) @ XD @ ccdvds))) @ (^ [Xe:$i] : ccz))))))))).
