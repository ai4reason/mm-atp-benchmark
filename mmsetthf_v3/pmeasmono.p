...
thf(axrge0addge_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ ccxad) @ ccle))))).
...
thf(cpmeasmono_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (cwf @ XR @ (cco @ ccc0 @ ccpnf @ ccicc) @ XP)) => ((Xph => ((ccfv @ cc0 @ XP) = ccc0)) => ((! [Xx3:$i] : ((Xph & ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) & (cwss @ (ccv @ Xx3) @ XR) & (cwdisj @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccv @ Xy1))))) => ((ccfv @ (ccuni @ (ccv @ Xx3)) @ XP) = (ccesum @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XP)))))) => ((Xph => (cwcel @ XA2 @ XR)) => ((Xph => (cwcel @ XB2 @ XR)) => ((Xph => (cwcel @ (ccdif @ XB2 @ XA2) @ XR)) => ((Xph => (cwss @ XA2 @ XB2)) => (Xph => (cwbr @ (ccfv @ XA2 @ XP) @ (ccfv @ XB2 @ XP) @ ccle))))))))))))))).
