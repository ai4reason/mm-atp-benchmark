...
thf(cllyi_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (((cwcel @ XJ @ (cclly @ XA2)) & (cwcel @ XU @ XJ) & (cwcel @ XP @ XU)) => (cwrex @ (^ [Xu:$i] : ((cwss @ (ccv @ Xu) @ XU) & (cwcel @ XP @ (ccv @ Xu)) & (cwcel @ (cco @ XJ @ (ccv @ Xu) @ ccrest) @ XA2))) @ (^ [Xu:$i] : XJ)))))))).
