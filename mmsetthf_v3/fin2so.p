...
thf(afin34_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfin3) => (cwcel @ XA2 @ ccfin4)))).
thf(cc1o_tp,type,(cc1o : ($i > $o))).
thf(ccen_tp,type,(ccen : ($i > $o))).
thf(cccda_tp,type,(cccda : ($i > $o))).
thf(cco_tp,type,(cco : (($i > $o) > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(afin45_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfin4) => (cwcel @ XA2 @ ccfin5)))).
thf(ccon0_tp,type,(ccon0 : ($i > $o))).
thf(cc2o_tp,type,(cc2o : ($i > $o))).
thf(afin56_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfin5) => (cwcel @ XA2 @ ccfin6)))).
thf(cword_tp,type,(cword : (($i > $o) > $o))).
thf(afin67_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfin6) => (cwcel @ XA2 @ ccfin7)))).
thf(abiimpac_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps <=> Xch)) => ((Xps & Xph) => Xch)))))).
thf(afin71num_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ cccrd)) => ((cwcel @ XA2 @ ccfin7) <=> (cwcel @ XA2 @ ccfn))))).
thf(cfin2so_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (((cwcel @ XA2 @ ccfin2) & (cwor @ XA2 @ XR)) => (cwcel @ XA2 @ ccfn))))).
