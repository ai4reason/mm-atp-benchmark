...
thf(aclmsubcl_thm,axiom,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ ccclm) & (cwcel @ XX @ XK) & (cwcel @ XY @ XK)) => (cwcel @ (cco @ XX @ XY @ ccmin) @ XK)))))))))).
...
thf(aclmvsass_thm,axiom,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ ccclm) & ((cwcel @ XQ @ XK) & (cwcel @ XR @ XK) & (cwcel @ XX @ XV))) => ((cco @ (cco @ XQ @ XR @ ccmul) @ XX @ Xc_x) = (cco @ XQ @ (cco @ XR @ XX @ Xc_x) @ Xc_x)))))))))))))))).
...
thf(attgelitv_thm,axiom,(! [Xph:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : ((XG @ Xk) = (ccfv @ XH @ ccttg))) => ((! [Xk:$i] : ((XI @ Xk) = (ccfv @ (XG @ Xk) @ ccitv))) => ((XP = (ccfv @ XH @ ccbs)) => ((Xc_mi = (ccfv @ XH @ ccsg)) => ((! [Xk:$i] : ((Xc_x @ Xk) = (ccfv @ XH @ ccvsca))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XX @ XP))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XY @ XP))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XH @ XV))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XZ @ XP))) => (! [Xk:$i] : ((Xph @ Xk) => ((cwcel @ XZ @ (cco @ XX @ XY @ (XI @ Xk))) <=> (cwrex @ (^ [Xk:$i] : ((cco @ XZ @ XX @ Xc_mi) = (cco @ (ccv @ Xk) @ (cco @ XY @ XX @ Xc_mi) @ (Xc_x @ Xk)))) @ (^ [Xk:$i] : (cco @ ccc0 @ cc1 @ ccicc))))))))))))))))))))))))))).
thf(cttgcontlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (ccfv @ XH @ ccttg)) => ((XI = (ccfv @ XG @ ccitv)) => ((XP = (ccfv @ XH @ ccbs)) => ((Xc_mi = (ccfv @ XH @ ccsg)) => ((Xc_x = (ccfv @ XH @ ccvsca)) => ((Xph => (cwcel @ XX @ XP)) => ((Xph => (cwcel @ XY @ XP)) => ((XR = (ccfv @ (ccfv @ XH @ ccsca) @ ccbs)) => ((Xph => (cwss @ (cco @ ccc0 @ cc1 @ ccicc) @ XR)) => ((Xc_pl = (ccfv @ XH @ ccplusg)) => ((Xph => (cwcel @ XH @ cccvs)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XN @ XP)) => ((Xph => (XM != ccc0)) => ((Xph => (XK != ccc0)) => ((Xph => (XK != cc1)) => ((Xph => (XL != XM)) => ((Xph => (cwbr @ XL @ (cco @ XM @ XK @ ccdiv) @ ccle)) => ((Xph => (cwcel @ XL @ (cco @ ccc0 @ cc1 @ ccicc))) => ((Xph => (cwcel @ XK @ (cco @ ccc0 @ cc1 @ ccicc))) => ((Xph => (cwcel @ XM @ (cco @ ccc0 @ XL @ ccicc))) => ((Xph => ((cco @ XX @ XA2 @ Xc_mi) = (cco @ XK @ (cco @ XY @ XA2 @ Xc_mi) @ Xc_x))) => ((Xph => ((cco @ XX @ XA2 @ Xc_mi) = (cco @ XM @ (cco @ XN @ XA2 @ Xc_mi) @ Xc_x))) => ((Xph => (XB2 = (cco @ XA2 @ (cco @ XL @ (cco @ XN @ XA2 @ Xc_mi) @ Xc_x) @ Xc_pl))) => (Xph => (cwcel @ XB2 @ (cco @ XX @ XY @ XI))))))))))))))))))))))))))))))))))))))))))))).
