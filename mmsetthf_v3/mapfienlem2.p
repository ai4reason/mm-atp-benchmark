...
thf(afsuppco_thm,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwbr @ XF @ XZ @ ccfsupp)) => ((Xph => (cwf1 @ XX @ XY @ XG)) => ((Xph => (cwcel @ XZ @ XW)) => ((Xph => (cwcel @ XF @ XV)) => (Xph => (cwbr @ (cccom @ XF @ XG) @ XZ @ ccfsupp))))))))))))))).
