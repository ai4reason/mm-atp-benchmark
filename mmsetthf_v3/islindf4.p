...
thf(araldifsni_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwral @ (^ [Xx3:$i] : (~ (Xph @ Xx3))) @ (^ [Xx3:$i] : (ccdif @ (XA2 @ Xx3) @ (ccsn @ (XB2 @ Xx3))))) <=> (cwral @ (^ [Xx3:$i] : ((Xph @ Xx3) => ((ccv @ Xx3) = (XB2 @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))).
...
thf(almodvsinv_thm,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XN = (ccfv @ XW @ ccminusg)) => ((XM = (ccfv @ XF @ ccminusg)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ cclmod) & (cwcel @ XR @ XK) & (cwcel @ XX @ XB2)) => ((cco @ (ccfv @ XR @ XM) @ XX @ Xc_x) = (ccfv @ (cco @ XR @ XX @ Xc_x) @ XN))))))))))))))))))).
...
thf(alcomf_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XB2 = (ccfv @ XW @ ccbs)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwf @ XI @ XK @ XG)) => ((Xph => (cwf @ XI @ XB2 @ XH)) => ((Xph => (cwcel @ XI @ XV)) => (Xph => (cwf @ XI @ XB2 @ (cco @ XG @ XH @ (ccof @ Xc_x))))))))))))))))))))))).
...
thf(alcomfsupp_thm,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XB2 = (ccfv @ XW @ ccbs)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwf @ XI @ XK @ XG)) => ((Xph => (cwf @ XI @ XB2 @ XH)) => ((Xph => (cwcel @ XI @ XV)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XY = (ccfv @ XF @ cc0g)) => ((Xph => (cwbr @ XG @ XY @ ccfsupp)) => (Xph => (cwbr @ (cco @ XG @ XH @ (ccof @ Xc_x)) @ Xc_0 @ ccfsupp)))))))))))))))))))))))))).
...
thf(afsnunf2_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwf @ (ccdif @ XS @ (ccsn @ XX)) @ XT @ XF) & (cwcel @ XX @ XS) & (cwcel @ XY @ XT)) => (cwf @ XS @ XT @ (ccun @ XF @ (ccsn @ (ccop @ XX @ XY))))))))))).
...
thf(aelmapfun_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (cco @ XB2 @ XC @ ccmap)) => (cwfun @ XA2)))))).
thf(afdm_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => ((ccdm @ XF) = XA2)))))).
thf(ampbird_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xch) => ((Xph => (Xps <=> Xch)) => (Xph => Xps))))))).
thf(aneldifsnd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (Xph => (~ (cwcel @ XA2 @ (ccdif @ XB2 @ (ccsn @ XA2))))))))).
...
thf(afunsnfsupp_thm,axiom,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((((cwcel @ XX @ XV) & (cwcel @ XY @ XW)) & ((cwfun @ XF) & (cwnel @ XX @ (ccdm @ XF)))) => ((cwbr @ (ccun @ XF @ (ccsn @ (ccop @ XX @ XY))) @ XZ @ ccfsupp) <=> (cwbr @ XF @ XZ @ ccfsupp)))))))))).
...
thf(afsnunres_thm,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwfn @ XF @ XS) & (~ (cwcel @ XX @ XS))) => ((ccres @ (ccun @ XF @ (ccsn @ (ccop @ XX @ XY))) @ XS) = XF))))))).
thf(a_3eqtrd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XB2 = XC)) => ((Xph => (XC = XD)) => (Xph => (XA2 = XD))))))))))).
thf(afnressn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XA2) & (cwcel @ XB2 @ XA2)) => ((ccres @ XF @ (ccsn @ XB2)) = (ccsn @ (ccop @ XB2 @ (ccfv @ XB2 @ XF))))))))).
...
thf(afmptsn_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XA2 @ (XV @ Xx3)) & (cwcel @ XB2 @ (XW @ Xx3))) => ((ccsn @ (ccop @ XA2 @ XB2)) = (ccmpt @ (^ [Xx3:$i] : (ccsn @ XA2)) @ (^ [Xx3:$i] : XB2)))))))))).
...
thf(aralxpmap_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (((ccv @ Xf1) = (ccun @ (ccv @ Xg1) @ (ccsn @ (ccop @ XJ @ (ccv @ Xy1))))) => ((Xph @ Xf1) <=> (Xps @ Xy1 @ Xg1)))))) => ((cwcel @ XJ @ XT) => ((cwral @ (^ [Xf1:$i] : (Xph @ Xf1)) @ (^ [Xf1:$i] : (cco @ XS @ XT @ ccmap))) <=> (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xg1:$i] : (Xps @ Xy1 @ Xg1)) @ (^ [Xg1:$i] : (cco @ XS @ (ccdif @ XT @ (ccsn @ XJ)) @ ccmap)))) @ (^ [Xy1:$i] : XS))))))))))).
...
thf(cislindf4_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XR = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XY = (ccfv @ XR @ cc0g)) => ((XL = (ccfv @ (cco @ XR @ XI @ ccfrlm) @ ccbs)) => (((cwcel @ XW @ cclmod) & (cwcel @ XI @ XX) & (cwf @ XI @ XB2 @ XF)) => ((cwbr @ XF @ XW @ cclindf) <=> (cwral @ (^ [Xx3:$i] : (((cco @ XW @ (cco @ (ccv @ Xx3) @ XF @ (ccof @ Xc_x)) @ ccgsu) = Xc_0) => ((ccv @ Xx3) = (ccxp @ XI @ (ccsn @ XY))))) @ (^ [Xx3:$i] : XL))))))))))))))))))))).
