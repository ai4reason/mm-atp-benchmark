...
thf(amap0b_thm,axiom,(! [XA2:($i > $o)] : ((XA2 != cc0) => ((cco @ cc0 @ XA2 @ ccmap) = cc0)))).
...
thf(cply1plusgfvi_conj,conjecture,(! [XR:($i > $o)] : ((ccfv @ (ccfv @ XR @ ccpl1) @ ccplusg) = (ccfv @ (ccfv @ (ccfv @ XR @ ccid) @ ccpl1) @ ccplusg)))).
