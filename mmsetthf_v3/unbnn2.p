...
thf(cunbnn2_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ ccom @ ccvv) & (cwss @ XA2 @ ccom) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccom))) => (cwbr @ XA2 @ ccom @ ccen)))).
