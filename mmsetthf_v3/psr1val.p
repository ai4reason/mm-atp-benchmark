...
thf(adf_psr1_ax,axiom,(ccps1 = (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccfv @ cc0 @ (cco @ cc1o @ (ccv @ Xr) @ ccopws)))))).
...
thf(cpsr1val_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((XS = (ccfv @ XR @ ccps1)) => (XS = (ccfv @ cc0 @ (cco @ cc1o @ XR @ ccopws))))))).
