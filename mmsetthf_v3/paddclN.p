...
thf(apadd4N_thm,axiom,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => (((cwcel @ XK @ cchlt) & ((cwss @ XX @ XA2) & (cwss @ XY @ XA2)) & ((cwss @ XZ @ XA2) & (cwss @ XW @ XA2))) => ((cco @ (cco @ XX @ XY @ Xc_pl) @ (cco @ XZ @ XW @ Xc_pl) @ Xc_pl) = (cco @ (cco @ XX @ XZ @ Xc_pl) @ (cco @ XY @ XW @ Xc_pl) @ Xc_pl))))))))))))).
...
thf(aispsubsp2_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [Xc_or:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : ((! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((Xc_le @ Xr @ Xq @ Xp) = (ccfv @ XK @ ccple))))) => ((! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((Xc_or @ Xr @ Xq @ Xp) = (ccfv @ XK @ ccjn))))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((XS @ Xr @ Xq @ Xp) = (ccfv @ XK @ ccpsubsp))))) => (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((cwcel @ XK @ (XD @ Xr @ Xq @ Xp)) => ((cwcel @ XX @ (XS @ Xr @ Xq @ Xp)) <=> ((cwss @ XX @ XA2) & (cwral @ (^ [Xp:$i] : ((cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : (cwbr @ (ccv @ Xp) @ (cco @ (ccv @ Xq) @ (ccv @ Xr) @ (Xc_or @ Xr @ Xq @ Xp)) @ (Xc_le @ Xr @ Xq @ Xp))) @ (^ [Xr:$i] : XX))) @ (^ [Xq:$i] : XX)) => (cwcel @ (ccv @ Xp) @ XX))) @ (^ [Xp:$i] : XA2)))))))))))))))))))).
thf(cpaddclN_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XS = (ccfv @ XK @ ccpsubsp)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XS) & (cwcel @ XY @ XS)) => (cwcel @ (cco @ XX @ XY @ Xc_pl) @ XS)))))))))).
