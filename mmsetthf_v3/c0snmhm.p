...
thf(cc0snmhm_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XT @ ccbs)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : Xc_0)))) => ((XZ = (ccfv @ XT @ cc0g)) => (! [Xx3:$i] : (((cwcel @ XS @ ccmnd) & (cwcel @ XT @ ccmnd) & (XB2 = (ccsn @ XZ))) => (cwcel @ (XH @ Xx3) @ (cco @ XT @ XS @ ccmhm))))))))))))))).
