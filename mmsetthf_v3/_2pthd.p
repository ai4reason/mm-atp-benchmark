...
thf(apthd_thm,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : ((Xph => (cwcel @ XP @ (ccword @ ccvv))) => ((XR = (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin)) => ((Xph => (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (((ccv @ Xi) != (ccv @ Xj)) => ((ccfv @ (ccv @ Xi) @ XP) != (ccfv @ (ccv @ Xj) @ XP)))) @ (^ [Xj:$i] : (cco @ cc1 @ XR @ ccfzo)))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XP @ cchash) @ ccfzo)))) => (((ccfv @ XF @ cchash) = XR) => ((! [Xi:$i] : (! [Xj:$i] : (Xph => (cwbr @ XF @ XP @ (ccfv @ (XG @ Xi @ Xj) @ cctrls))))) => (! [Xi:$i] : (! [Xj:$i] : (Xph => (cwbr @ XF @ XP @ (ccfv @ (XG @ Xi @ Xj) @ ccpths)))))))))))))))).
