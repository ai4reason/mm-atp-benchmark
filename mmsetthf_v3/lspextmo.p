...
thf(almhmeql_thm,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XU = (ccfv @ XS @ cclss)) => (((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) & (cwcel @ XG @ (cco @ XS @ XT @ cclmhm))) => (cwcel @ (ccdm @ (ccin @ XF @ XG)) @ XU))))))))).
...
thf(afneqeql_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfn @ XF @ XA2) & (cwfn @ XG @ XA2)) => ((XF = XG) <=> ((ccdm @ (ccin @ XF @ XG)) = XA2))))))).
...
thf(clspextmo_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XS @ ccbs)) => ((XK = (ccfv @ XS @ cclspn)) => (((cwss @ XX @ XB2) & ((ccfv @ XX @ XK) = XB2)) => (cwrmo @ (^ [Xg1:$i] : ((ccres @ (ccv @ Xg1) @ XX) = XF)) @ (^ [Xg1:$i] : (cco @ XS @ XT @ cclmhm))))))))))))).
