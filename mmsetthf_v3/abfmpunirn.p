...
thf(afnunirn_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : ((cwfn @ XF @ XI) => ((cwcel @ XA2 @ (ccuni @ (ccrn @ XF))) <=> (cwrex @ (^ [Xx3:$i] : (cwcel @ XA2 @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : XI)))))))).
...
thf(cabfmpunirn_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((XF = (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (cwcel @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ ccvv)) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xy1) = XB2) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xx3))))) => ((cwcel @ XB2 @ (ccuni @ (ccrn @ XF))) <=> ((cwcel @ XB2 @ ccvv) & (cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XV))))))))))))).
