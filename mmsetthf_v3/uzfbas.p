...
thf(auzrest_thm,axiom,(! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((cwcel @ XM @ ccz) => ((cco @ (ccrn @ ccuz) @ XZ @ ccrest) = (ccima @ ccuz @ XZ))))))).
...
thf(azfbas_thm,axiom,(cwcel @ (ccrn @ ccuz) @ (ccfv @ ccz @ ccfbas))).
