...
thf(ciocinioc2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwcel @ XC @ ccxr)) & (cwbr @ XA2 @ XB2 @ ccle)) => ((ccin @ (cco @ XA2 @ XC @ ccioc) @ (cco @ XB2 @ XC @ ccioc)) = (cco @ XB2 @ XC @ ccioc))))))).
