...
thf(atrcl_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > $o))] : ((! [Xz:$i] : (cwcel @ (XA2 @ Xz) @ ccvv)) => ((! [Xz:$i] : ((XF @ Xz) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xz:$i] : ccvv) @ (^ [Xz:$i] : (ccun @ (ccv @ Xz) @ (ccuni @ (ccv @ Xz))))) @ (XA2 @ Xz)) @ ccom))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XC @ Xx3 @ Xy1 @ Xz) = (cciun @ (^ [Xy1:$i] : ccom) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ (XF @ Xz)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwss @ (XA2 @ Xz) @ (XC @ Xx3 @ Xy1 @ Xz)) & (cwtr @ (XC @ Xx3 @ Xy1 @ Xz)) & (! [Xx3:$i] : (((cwss @ (XA2 @ Xz) @ (ccv @ Xx3)) & (cwtr @ (ccv @ Xx3))) => (cwss @ (XC @ Xx3 @ Xy1 @ Xz) @ (ccv @ Xx3))))))))))))))).
...
thf(ctz9_1_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (? [Xx3:$i] : ((cwss @ XA2 @ (ccv @ Xx3)) & (cwtr @ (ccv @ Xx3)) & (! [Xy1:$i] : (((cwss @ XA2 @ (ccv @ Xy1)) & (cwtr @ (ccv @ Xy1))) => (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))))))))).
