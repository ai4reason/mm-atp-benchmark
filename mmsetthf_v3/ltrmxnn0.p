...
thf(altmulgt11_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwbr @ ccc0 @ XA2 @ cclt)) => ((cwbr @ cc1 @ XB2 @ cclt) <=> (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ ccmul) @ cclt)))))).
...
thf(cltrmxnn0_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) => ((cwbr @ XM @ XN @ cclt) <=> (cwbr @ (cco @ XA2 @ XM @ ccrmx) @ (cco @ XA2 @ XN @ ccrmx) @ cclt))))))).
