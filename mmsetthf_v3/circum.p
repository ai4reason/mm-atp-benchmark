...
thf(asinccvg_thm,axiom,(! [XF:($i > $o)] : (((cwf @ ccn @ (ccdif @ ccr @ (ccsn @ ccc0)) @ XF) & (cwbr @ XF @ ccc0 @ ccli)) => (cwbr @ (cccom @ (ccmpt @ (^ [Xx3:$i] : (ccdif @ ccr @ (ccsn @ ccc0))) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ (ccv @ Xx3) @ ccdiv))) @ XF) @ cc1 @ ccli)))).
...
thf(ccircum_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : ((! [Xn:$i] : ((XA2 @ Xn) = (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccv @ Xn) @ ccdiv))) => ((! [Xn:$i] : ((XP @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ (cco @ XR @ (ccfv @ (cco @ (XA2 @ Xn) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccmul))))) => ((cwcel @ XR @ ccr) => (! [Xn:$i] : (cwbr @ (XP @ Xn) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ XR @ ccmul) @ ccli))))))))).
