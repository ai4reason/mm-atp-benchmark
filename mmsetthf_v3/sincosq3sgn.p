...
thf(asincosq2sgn_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ (cco @ ccpi @ cc2 @ ccdiv) @ ccpi @ ccioo)) => ((cwbr @ ccc0 @ (ccfv @ XA2 @ ccsin) @ cclt) & (cwbr @ (ccfv @ XA2 @ cccos) @ ccc0 @ cclt))))).
...
thf(csincosq3sgn_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccpi @ (cco @ cc3 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccmul) @ ccioo)) => ((cwbr @ (ccfv @ XA2 @ ccsin) @ ccc0 @ cclt) & (cwbr @ (ccfv @ XA2 @ cccos) @ ccc0 @ cclt))))).
