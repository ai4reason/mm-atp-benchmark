...
thf(atz9_12lem2_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((cwcel @ XA2 @ ccvv) => ((! [Xz:$i] : (! [Xv:$i] : ((XF @ Xz @ Xv) = (ccmpt @ (^ [Xz:$i] : ccvv) @ (^ [Xz:$i] : (ccint @ (ccrab @ (^ [Xv:$i] : (cwcel @ (ccv @ Xz) @ (ccfv @ (ccv @ Xv) @ ccr1))) @ (^ [Xv:$i] : ccon0)))))))) => (! [Xz:$i] : (! [Xv:$i] : (cwcel @ (ccsuc @ (ccuni @ (ccima @ (XF @ Xz @ Xv) @ XA2))) @ ccon0)))))))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(ccpw_tp,type,(ccpw : (($i > $o) > ($i > $o)))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(ccdm_tp,type,(ccdm : (($i > $o) > ($i > $o)))).
thf(atz9_12lem3_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((cwcel @ XA2 @ ccvv) => ((! [Xz:$i] : (! [Xv:$i] : ((XF @ Xz @ Xv) = (ccmpt @ (^ [Xz:$i] : ccvv) @ (^ [Xz:$i] : (ccint @ (ccrab @ (^ [Xv:$i] : (cwcel @ (ccv @ Xz) @ (ccfv @ (ccv @ Xv) @ ccr1))) @ (^ [Xv:$i] : ccon0)))))))) => (! [Xz:$i] : (! [Xv:$i] : ((cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ ccr1))) @ (^ [Xy1:$i] : ccon0))) @ (^ [Xx3:$i] : XA2)) => (cwcel @ XA2 @ (ccfv @ (ccsuc @ (ccsuc @ (ccuni @ (ccima @ (XF @ Xz @ Xv) @ XA2)))) @ ccr1)))))))))).
