...
thf(creprdifc_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((! [Xx3:$i] : (! [Xc:$i] : ((XC @ Xx3 @ Xc) = (ccrab @ (^ [Xc:$i] : (~ (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xc)) @ XB2))) @ (^ [Xc:$i] : (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr))))))) => ((! [Xc:$i] : ((Xph @ Xc) => (cwss @ XA2 @ ccn))) => ((! [Xc:$i] : ((Xph @ Xc) => (cwss @ XB2 @ ccn))) => ((! [Xc:$i] : ((Xph @ Xc) => (cwcel @ XM @ ccn0))) => ((! [Xc:$i] : ((Xph @ Xc) => (cwcel @ XS @ ccn0))) => (! [Xc:$i] : ((Xph @ Xc) => ((ccdif @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)) @ (cco @ XB2 @ XM @ (ccfv @ XS @ ccrepr))) = (cciun @ (^ [Xx3:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xc)))))))))))))))))).
