...
thf(apreimaioomnf_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ ccr @ XF)) => ((Xph => (cwcel @ XB2 @ ccxr)) => (Xph => ((ccima @ (cccnv @ XF) @ (cco @ ccmnf @ XB2 @ ccioo)) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ XB2 @ cclt)) @ (^ [Xx3:$i] : XA2))))))))))).
...
thf(csmfco_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((Xph => (cwcel @ XS @ ccsalg)) => ((Xph => (cwcel @ XF @ (ccfv @ XS @ ccsmblfn))) => ((XJ = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((XB2 = (ccfv @ XJ @ ccsalgen)) => ((Xph => (cwcel @ XH @ (ccfv @ XB2 @ ccsmblfn))) => (Xph => (cwcel @ (cccom @ XH @ XF) @ (ccfv @ XS @ ccsmblfn))))))))))))))).
