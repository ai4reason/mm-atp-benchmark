...
thf(acfub_thm,axiom,(! [XA2:($i > $o)] : (cwss @ (ccfv @ XA2 @ cccf) @ (ccint @ (^ [Xx3:$i] : (? [Xy1:$i] : (((ccv @ Xx3) = (ccfv @ (ccv @ Xy1) @ cccrd)) & ((cwss @ (ccv @ Xy1) @ XA2) & (cwss @ XA2 @ (ccuni @ (ccv @ Xy1))))))))))).
...
thf(ccflm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XA2 @ (XB2 @ Xx3 @ Xy1)) & (cwlim @ XA2)) => ((ccfv @ XA2 @ cccf) = (ccint @ (^ [Xx3:$i] : (? [Xy1:$i] : (((ccv @ Xx3) = (ccfv @ (ccv @ Xy1) @ cccrd)) & ((cwss @ (ccv @ Xy1) @ XA2) & (XA2 = (ccuni @ (ccv @ Xy1))))))))))))))).
