...
thf(cccats1swrdeqrex_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XU @ (ccword @ XV)) & ((ccfv @ XU @ cchash) = (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc))) => ((XW = (cco @ XU @ (ccop @ ccc0 @ (ccfv @ XW @ cchash)) @ ccsubstr)) => (cwrex @ (^ [Xs1:$i] : (XU = (cco @ XW @ (ccs1 @ (ccv @ Xs1)) @ ccconcat))) @ (^ [Xs1:$i] : XV)))))))).
