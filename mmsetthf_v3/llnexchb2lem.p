...
thf(cllnexchb2lem_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XN = (ccfv @ XK @ cclln)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XX @ XN) & (cwcel @ XY @ XN)) & ((cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2) & (~ (cwbr @ XP @ XX @ Xc_le))) & (cwcel @ (cco @ XX @ XY @ Xc_an) @ XA2)) => ((cwbr @ (cco @ XX @ XY @ Xc_an) @ (cco @ XP @ XQ @ Xc_or) @ Xc_le) <=> ((cco @ XX @ XY @ Xc_an) = (cco @ XX @ (cco @ XP @ XQ @ Xc_or) @ Xc_an)))))))))))))))))))).
