...
thf(ccvlsupr3_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => (((cwcel @ XK @ cclc) & ((cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2) & (cwcel @ XR @ XA2))) => (((cco @ XP @ XR @ Xc_or) = (cco @ XQ @ XR @ Xc_or)) <=> ((XP != XQ) => ((XR != XP) & (XR != XQ) & (cwbr @ XR @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)))))))))))))))).
