...
thf(aalephsuc2_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((ccfv @ (ccsuc @ XA2) @ ccale) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ XA2 @ ccale) @ ccdom)) @ (^ [Xx3:$i] : ccon0)))))).
...
thf(aalephordilem1_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (cwbr @ (ccfv @ XA2 @ ccale) @ (ccfv @ (ccsuc @ XA2) @ ccale) @ ccsdm)))).
...
thf(calephsuc3_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (cwbr @ (ccfv @ (ccsuc @ XA2) @ ccale) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ XA2 @ ccale) @ ccen)) @ (^ [Xx3:$i] : ccon0)) @ ccen)))).
