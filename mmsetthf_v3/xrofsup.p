...
thf(ar19_29d2r_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xch @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((Xps @ Xx3 @ Xy1) & (Xch @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)))))))))))))).
...
thf(arexxp_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccop @ (ccv @ Xy1) @ (ccv @ Xz))) => ((Xph @ Xx3) <=> (Xps @ Xy1 @ Xz)))))) => ((cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccxp @ XA2 @ XB2))) <=> (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (Xps @ Xy1 @ Xz)) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XA2))))))))).
...
thf(axlt2addrd_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xb @ Xc) => (cwcel @ XA2 @ ccr)))) => ((! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xb @ Xc) => (cwcel @ XB2 @ ccxr)))) => ((! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xb @ Xc) => (cwcel @ XC @ ccxr)))) => ((! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xb @ Xc) => (XB2 != ccmnf)))) => ((! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xb @ Xc) => (XC != ccmnf)))) => ((! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xb @ Xc) => (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccxad) @ cclt)))) => (! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xb @ Xc) => (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : ((XA2 = (cco @ (ccv @ Xb) @ (ccv @ Xc) @ ccxad)) & (cwbr @ (ccv @ Xb) @ XB2 @ cclt) & (cwbr @ (ccv @ Xc) @ XC @ cclt))) @ (^ [Xc:$i] : ccxr))) @ (^ [Xb:$i] : ccxr)))))))))))))))).
...
thf(cxrofsup_conj,conjecture,(! [Xph:$o] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwss @ XX @ ccxr)) => ((Xph => (cwss @ XY @ ccxr)) => ((Xph => ((ccsup @ XX @ ccxr @ cclt) != ccmnf)) => ((Xph => ((ccsup @ XY @ ccxr @ cclt) != ccmnf)) => ((Xph => (XZ = (ccima @ ccxad @ (ccxp @ XX @ XY)))) => (Xph => ((ccsup @ XZ @ ccxr @ cclt) = (cco @ (ccsup @ XX @ ccxr @ cclt) @ (ccsup @ XY @ ccxr @ cclt) @ ccxad))))))))))))).
