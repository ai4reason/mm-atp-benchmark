...
thf(a_4001lem3_thm,axiom,(! [XN:($i > $o)] : ((XN = (ccdc @ (ccdc @ (ccdc @ cc4 @ ccc0) @ ccc0) @ cc1)) => ((cco @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ XN @ ccmo) = (cco @ cc1 @ XN @ ccmo))))).
thf(a_4001lem4_thm,axiom,(! [XN:($i > $o)] : ((XN = (ccdc @ (ccdc @ (ccdc @ cc4 @ ccc0) @ ccc0) @ cc1)) => ((cco @ (cco @ (cco @ cc2 @ (ccdc @ (ccdc @ cc8 @ ccc0) @ ccc0) @ ccexp) @ cc1 @ ccmin) @ XN @ ccgcd) = cc1)))).
