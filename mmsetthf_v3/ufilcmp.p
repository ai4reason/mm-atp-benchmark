...
thf(cufilcmp_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ ccufl) & (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwcel @ XJ @ cccmp) <=> (cwral @ (^ [Xf1:$i] : ((cco @ XJ @ (ccv @ Xf1) @ ccflim) != cc0)) @ (^ [Xf1:$i] : (ccfv @ XX @ ccufil)))))))).
