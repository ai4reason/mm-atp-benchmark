...
thf(afilunirn_thm,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccuni @ (ccrn @ ccfil))) <=> (cwcel @ XF @ (ccfv @ (ccuni @ XF) @ ccfil))))).
...
thf(cisfcls_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) <=> ((cwcel @ XJ @ cctop) & (cwcel @ XF @ (ccfv @ XX @ ccfil)) & (cwral @ (^ [Xs1:$i] : (cwcel @ XA2 @ (ccfv @ (ccv @ Xs1) @ (ccfv @ XJ @ cccl)))) @ (^ [Xs1:$i] : XF)))))))))).
