...
thf(advaplusg_thm,axiom,(! [Xc_pl:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : ((! [Xf1:$i] : ((XH @ Xf1) = (ccfv @ XK @ cclh))) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xf1:$i] : ((XE @ Xf1) = (ccfv @ XW @ (ccfv @ XK @ cctendo)))) => ((! [Xf1:$i] : ((XU @ Xf1) = (ccfv @ XW @ (ccfv @ XK @ ccdveca)))) => ((! [Xf1:$i] : ((XF @ Xf1) = (ccfv @ (XU @ Xf1) @ ccsca))) => ((! [Xf1:$i] : ((Xc_pl @ Xf1) = (ccfv @ (XF @ Xf1) @ ccplusg))) => (! [Xf1:$i] : ((((cwcel @ XK @ (XV @ Xf1)) & (cwcel @ XW @ (XH @ Xf1))) & ((cwcel @ XR @ (XE @ Xf1)) & (cwcel @ XS @ (XE @ Xf1)))) => ((cco @ XR @ XS @ (Xc_pl @ Xf1)) = (ccmpt @ (^ [Xf1:$i] : XT) @ (^ [Xf1:$i] : (cccom @ (ccfv @ (ccv @ Xf1) @ XR) @ (ccfv @ (ccv @ Xf1) @ XS))))))))))))))))))))))))).
