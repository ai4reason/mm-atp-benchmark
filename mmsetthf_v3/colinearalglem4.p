...
thf(ccolinearalglem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XC @ (ccfv @ XN @ ccee))) & (cwcel @ XK @ ccr)) => ((cwral @ (^ [Xi:$i] : (cwbr @ (cco @ (cco @ (cco @ (cco @ XK @ (cco @ (ccfv @ (ccv @ Xi) @ XC) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmin) @ ccmul) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccaddc) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmin) @ (cco @ (ccfv @ (ccv @ Xi) @ XC) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmin) @ ccmul) @ ccc0 @ ccle)) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz))) | (cwral @ (^ [Xi:$i] : (cwbr @ (cco @ (cco @ (ccfv @ (ccv @ Xi) @ XC) @ (cco @ (cco @ XK @ (cco @ (ccfv @ (ccv @ Xi) @ XC) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmin) @ ccmul) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccaddc) @ ccmin) @ (cco @ (ccfv @ (ccv @ Xi) @ XA2) @ (cco @ (cco @ XK @ (cco @ (ccfv @ (ccv @ Xi) @ XC) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmin) @ ccmul) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccaddc) @ ccmin) @ ccmul) @ ccc0 @ ccle)) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz))) | (cwral @ (^ [Xi:$i] : (cwbr @ (cco @ (cco @ (ccfv @ (ccv @ Xi) @ XA2) @ (ccfv @ (ccv @ Xi) @ XC) @ ccmin) @ (cco @ (cco @ (cco @ XK @ (cco @ (ccfv @ (ccv @ Xi) @ XC) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmin) @ ccmul) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccaddc) @ (ccfv @ (ccv @ Xi) @ XC) @ ccmin) @ ccmul) @ ccc0 @ ccle)) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz)))))))))).
