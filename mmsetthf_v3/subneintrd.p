...
thf(csubneintrd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (XB2 != XC)) => (Xph => ((cco @ XA2 @ XB2 @ ccmin) != (cco @ XA2 @ XC @ ccmin)))))))))))).
