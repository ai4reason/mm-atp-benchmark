...
thf(asdom2en01_thm,axiom,(! [XA2:($i > $o)] : ((cwbr @ XA2 @ cc2o @ ccsdm) <=> ((XA2 = cc0) | (cwbr @ XA2 @ cc1o @ ccen))))).
...
thf(axp2cda_thm,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((ccxp @ XA2 @ cc2o) = (cco @ XA2 @ XA2 @ cccda)))))).
...
thf(aisfin6_thm,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfin6) <=> ((cwbr @ XA2 @ cc2o @ ccsdm) | (cwbr @ XA2 @ (ccxp @ XA2 @ XA2) @ ccsdm))))).
thf(cfin56_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfin5) => (cwcel @ XA2 @ ccfin6)))).
