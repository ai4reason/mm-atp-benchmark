...
thf(asigaclcu_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) & (cwcel @ XA2 @ (ccpw @ XS)) & (cwbr @ XA2 @ ccom @ ccdom)) => (cwcel @ (ccuni @ XA2) @ XS))))).
...
thf(ctotprobd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((Xph => (cwcel @ XP @ ccprb)) => ((Xph => (cwcel @ XA2 @ (ccdm @ XP))) => ((Xph => (cwcel @ XB2 @ (ccpw @ (ccdm @ XP)))) => ((Xph => ((ccuni @ XB2) = (ccuni @ (ccdm @ XP)))) => ((Xph => (cwbr @ XB2 @ ccom @ ccdom)) => ((Xph => (cwdisj @ (^ [Xb:$i] : XB2) @ (^ [Xb:$i] : (ccv @ Xb)))) => (Xph => ((ccfv @ XA2 @ XP) = (ccesum @ (^ [Xb:$i] : XB2) @ (^ [Xb:$i] : (ccfv @ (ccin @ (ccv @ Xb) @ XA2) @ XP)))))))))))))))).
