...
thf(adf_nrg_ax,axiom,(ccnrg = (ccrab @ (^ [Xw:$i] : (cwcel @ (ccfv @ (ccv @ Xw) @ ccnm) @ (ccfv @ (ccv @ Xw) @ ccabv))) @ (^ [Xw:$i] : ccngp)))).
thf(cisnrg_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : ((XN = (ccfv @ XR @ ccnm)) => ((XA2 = (ccfv @ XR @ ccabv)) => ((cwcel @ XR @ ccnrg) <=> ((cwcel @ XR @ ccngp) & (cwcel @ XN @ XA2))))))))).
