...
thf(ambfimaicc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((((cwcel @ XF @ ccmbf) & (cwf @ XA2 @ ccr @ XF)) & ((cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccr))) => (cwcel @ (ccima @ (cccnv @ XF) @ (cco @ XB2 @ XC @ ccicc)) @ (ccdm @ ccvol)))))))).
thf(cmbfimasn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ ccmbf) & (cwf @ XA2 @ ccr @ XF) & (cwcel @ XB2 @ ccr)) => (cwcel @ (ccima @ (cccnv @ XF) @ (ccsn @ XB2)) @ (ccdm @ ccvol))))))).
