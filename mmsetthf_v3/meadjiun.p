...
thf(ameadjiunlem_thm,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xi:$i] : (Xph => (cwcel @ (XM @ Xi) @ ccmea))) => ((! [Xi:$i] : ((XS @ Xi) = (ccdm @ (XM @ Xi)))) => ((! [Xi:$i] : (Xph => (cwcel @ XX @ (XV @ Xi)))) => ((! [Xi:$i] : (Xph => (cwf @ XX @ (XS @ Xi) @ XG))) => ((XY = (ccrab @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XG) != cc0)) @ (^ [Xi:$i] : XX))) => ((Xph => (cwdisj @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XG)))) => (! [Xi:$i] : (Xph => ((ccfv @ (ccres @ (XM @ Xi) @ (ccrn @ XG)) @ ccsumge0) = (ccfv @ (cccom @ (XM @ Xi) @ XG) @ ccsumge0)))))))))))))))))).
