...
thf(amulgcdr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (cwcel @ XC @ ccn0)) => ((cco @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XC @ ccmul) @ ccgcd) = (cco @ (cco @ XA2 @ XB2 @ ccgcd) @ XC @ ccmul))))))).
...
thf(agcddiv_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (cwcel @ XC @ ccn)) & ((cwbr @ XC @ XA2 @ ccdvds) & (cwbr @ XC @ XB2 @ ccdvds))) => ((cco @ (cco @ XA2 @ XB2 @ ccgcd) @ XC @ ccdiv) = (cco @ (cco @ XA2 @ XC @ ccdiv) @ (cco @ XB2 @ XC @ ccdiv) @ ccgcd))))))).
...
thf(chashgcdlem_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xy1:$i] : (! [Xz:$i] : ((XA2 @ Xy1 @ Xz) = (ccrab @ (^ [Xy1:$i] : ((cco @ (ccv @ Xy1) @ (cco @ XM @ XN @ ccdiv) @ ccgcd) = cc1)) @ (^ [Xy1:$i] : (cco @ ccc0 @ (cco @ XM @ XN @ ccdiv) @ ccfzo)))))) => ((! [Xy1:$i] : (! [Xz:$i] : ((XB2 @ Xy1 @ Xz) = (ccrab @ (^ [Xz:$i] : ((cco @ (ccv @ Xz) @ XM @ ccgcd) = XN)) @ (^ [Xz:$i] : (cco @ ccc0 @ XM @ ccfzo)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XF @ Xx3 @ Xy1 @ Xz) = (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xy1 @ Xz)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XN @ ccmul))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ XM @ ccn) & (cwcel @ XN @ ccn) & (cwbr @ XN @ XM @ ccdvds)) => (cwf1o @ (XA2 @ Xy1 @ Xz) @ (XB2 @ Xy1 @ Xz) @ (XF @ Xx3 @ Xy1 @ Xz))))))))))))))).
