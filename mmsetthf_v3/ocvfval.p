...
thf(adf_ocv_ax,axiom,(ccocv = (ccmpt @ (^ [Xh:$i] : ccvv) @ (^ [Xh:$i] : (ccmpt @ (^ [Xs1:$i] : (ccpw @ (ccfv @ (ccv @ Xh) @ ccbs))) @ (^ [Xs1:$i] : (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xh) @ ccip)) = (ccfv @ (ccfv @ (ccv @ Xh) @ ccsca) @ cc0g))) @ (^ [Xy1:$i] : (ccv @ Xs1)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xh) @ ccbs))))))))).
