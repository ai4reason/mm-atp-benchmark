...
thf(adf_sle_ax,axiom,(ccsle = (ccdif @ (ccxp @ ccsur @ ccsur) @ (cccnv @ ccslt)))).
...
thf(cslenlt_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccsur) & (cwcel @ XB2 @ ccsur)) => ((cwbr @ XA2 @ XB2 @ ccsle) <=> (~ (cwbr @ XB2 @ XA2 @ ccslt))))))).
