...
thf(aprmop1_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccprmo) = (ccif @ (cwcel @ (cco @ XN @ cc1 @ ccaddc) @ ccprime) @ (cco @ (ccfv @ XN @ ccprmo) @ (cco @ XN @ cc1 @ ccaddc) @ ccmul) @ (ccfv @ XN @ ccprmo)))))).
