...
thf(cssimaexg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [Xx3:$i] : (((cwcel @ XA2 @ (XC @ Xx3)) & (cwfun @ XF) & (cwss @ XB2 @ (ccima @ XF @ XA2))) => (? [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) & (XB2 = (ccima @ XF @ (ccv @ Xx3)))))))))))).
