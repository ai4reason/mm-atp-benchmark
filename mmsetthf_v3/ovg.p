...
thf(covg_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > $o)] : (! [Xth:$o] : (! [Xta:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3 @ Xy1 @ Xz) <=> (Xps @ Xy1 @ Xz)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = XB2) => ((Xps @ Xy1 @ Xz) <=> (Xch @ Xz))))) => ((! [Xz:$i] : (((ccv @ Xz) = XC) => ((Xch @ Xz) <=> Xth))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((Xta @ Xz) & ((cwcel @ (ccv @ Xx3) @ XR) & (cwcel @ (ccv @ Xy1) @ XS))) => (cweu @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XF @ Xx3 @ Xy1 @ Xz) = (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (((cwcel @ (ccv @ Xx3) @ XR) & (cwcel @ (ccv @ Xy1) @ XS)) & (Xph @ Xx3 @ Xy1 @ Xz)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((Xta @ Xz) & ((cwcel @ XA2 @ XR) & (cwcel @ XB2 @ XS) & (cwcel @ XC @ (XD @ Xx3 @ Xy1 @ Xz)))) => (((cco @ XA2 @ XB2 @ (XF @ Xx3 @ Xy1 @ Xz)) = XC) <=> Xth))))))))))))))))))))))).
