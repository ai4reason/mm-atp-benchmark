...
thf(cnormlem9_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cwcel @ XC @ cchil) => ((cwcel @ XD @ cchil) => ((cco @ (cco @ XA2 @ XB2 @ ccmv) @ (cco @ XC @ XD @ ccmv) @ ccsp) = (cco @ (cco @ (cco @ XA2 @ XC @ ccsp) @ (cco @ XB2 @ XD @ ccsp) @ ccaddc) @ (cco @ (cco @ XA2 @ XD @ ccsp) @ (cco @ XB2 @ XC @ ccsp) @ ccaddc) @ ccmin))))))))))).
