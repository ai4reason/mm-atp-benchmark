...
thf(cge0mulcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccico)) & (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccico))) => (cwcel @ (cco @ XA2 @ XB2 @ ccmul) @ (cco @ ccc0 @ ccpnf @ ccico)))))).
