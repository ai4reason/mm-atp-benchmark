...
thf(acaun0_thm,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XF @ (ccfv @ XD @ ccca))) => (XX != cc0)))))).
...
thf(acmetcaulem_thm,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((Xph => (cwcel @ XD @ (ccfv @ XX @ ccms))) => ((Xph => (cwcel @ XP @ XX)) => ((Xph => (cwcel @ XF @ (ccfv @ XD @ ccca))) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccn) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (ccdm @ XF)) @ (ccfv @ (ccv @ Xx3) @ XF) @ XP))))) => (Xph => (cwcel @ XF @ (ccdm @ (ccfv @ XJ @ cclm))))))))))))))))).
