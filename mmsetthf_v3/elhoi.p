...
thf(celhoi_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XX @ (XV @ Xx3)))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cwcel @ XY @ (cco @ (cco @ XA2 @ XB2 @ ccico) @ XX @ ccmap)) <=> ((cwf @ XX @ ccxr @ XY) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XY) @ (cco @ XA2 @ XB2 @ ccico))) @ (^ [Xx3:$i] : XX)))))))))))))).
