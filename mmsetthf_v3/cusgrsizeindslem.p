...
thf(ccusgrsizeindslem_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ cccusgr) & (cwcel @ XV @ ccfn) & (cwcel @ XN @ XV)) => ((ccfv @ (ccrab @ (^ [Xe:$i] : (cwcel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)) @ cchash) = (cco @ (ccfv @ XV @ cchash) @ cc1 @ ccmin)))))))))).
