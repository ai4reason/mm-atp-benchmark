...
thf(ahlcompl_thm,axiom,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : ((XD = (ccfv @ XU @ ccims)) => ((XJ = (ccfv @ XD @ ccmopn)) => (((cwcel @ XU @ cchlo) & (cwcel @ XF @ (ccfv @ XD @ ccca))) => (cwcel @ XF @ (ccdm @ (ccfv @ XJ @ cclm))))))))))).
...
thf(caxhcompl_zf_conj,conjecture,(! [XU:($i > $o)] : (! [XF:($i > $o)] : ((XU = (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((cwcel @ XU @ cchlo) => ((cwcel @ XF @ cccau) => (cwrex @ (^ [Xx3:$i] : (cwbr @ XF @ (ccv @ Xx3) @ cchli)) @ (^ [Xx3:$i] : cchil)))))))).
