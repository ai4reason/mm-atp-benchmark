...
thf(ccnprest2_conj,conjecture,(! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => (((cwcel @ XK @ cctop) & (cwf @ XX @ XB2 @ XF) & (cwss @ XB2 @ XY)) => ((cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) <=> (cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ (cco @ XK @ XB2 @ ccrest) @ cccnp))))))))))))))).
