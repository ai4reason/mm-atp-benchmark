...
thf(clmodvsghm_conj,conjecture,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccfv @ XW @ ccsca))) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((! [Xx3:$i] : (XK = (ccfv @ (XF @ Xx3) @ ccbs))) => (((cwcel @ XW @ cclmod) & (cwcel @ XR @ XK)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (cco @ XR @ (ccv @ Xx3) @ Xc_x))) @ (cco @ XW @ XW @ ccghm)))))))))))))).
