...
thf(anmmul_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XR @ ccbs)) => ((XN = (ccfv @ XR @ ccnm)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (((cwcel @ XR @ ccnrg) & (cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => ((ccfv @ (cco @ XA2 @ XB2 @ Xc_x) @ XN) = (cco @ (ccfv @ XA2 @ XN) @ (ccfv @ XB2 @ XN) @ ccmul))))))))))))).
thf(aoveq2d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))))).
thf(asimplr_thm,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) & Xch) => Xps))))).
thf(ccur_tp,type,(ccur : ($i > $o))).
thf(anminvr_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((XN = (ccfv @ XR @ ccnm)) => ((XU = (ccfv @ XR @ ccui)) => ((XI = (ccfv @ XR @ ccinvr)) => (((cwcel @ XR @ ccnrg) & (cwcel @ XR @ ccnzr) & (cwcel @ XA2 @ XU)) => ((ccfv @ (ccfv @ XA2 @ XI) @ XN) = (cco @ cc1 @ (ccfv @ XA2 @ XN) @ ccdiv)))))))))))).
...
thf(aunitnmn0_thm,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : ((XN = (ccfv @ XR @ ccnm)) => ((XU = (ccfv @ XR @ ccui)) => (((cwcel @ XR @ ccnrg) & (cwcel @ XR @ ccnzr) & (cwcel @ XA2 @ XU)) => ((ccfv @ XA2 @ XN) != ccc0))))))))).
thf(cnmdvr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XR @ ccbs)) => ((XN = (ccfv @ XR @ ccnm)) => ((XU = (ccfv @ XR @ ccui)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((((cwcel @ XR @ ccnrg) & (cwcel @ XR @ ccnzr)) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XU))) => ((ccfv @ (cco @ XA2 @ XB2 @ Xc_dv) @ XN) = (cco @ (ccfv @ XA2 @ XN) @ (ccfv @ XB2 @ XN) @ ccdiv))))))))))))))).
