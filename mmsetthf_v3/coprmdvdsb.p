...
thf(ccoprmdvdsb_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ ccz) & (cwcel @ XN @ ccz) & ((cwcel @ XM @ ccz) & ((cco @ XK @ XM @ ccgcd) = cc1))) => ((cwbr @ XK @ XN @ ccdvds) <=> (cwbr @ XK @ (cco @ XM @ XN @ ccmul) @ ccdvds))))))).
