...
thf(awallispilem4_thm,axiom,(! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XI:($i > ($i > ($i > ($i > $o))))] : ((! [Xk:$i] : (! [Xn:$i] : ((XF @ Xk @ Xn) = (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccmin) @ ccdiv) @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ ccmul)))))) => ((! [Xz:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XI @ Xz @ Xk @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccitg @ (^ [Xz:$i] : (cco @ ccc0 @ ccpi @ ccioo)) @ (^ [Xz:$i] : (cco @ (ccfv @ (ccv @ Xz) @ ccsin) @ (ccv @ Xn) @ ccexp))))))))) => ((! [Xz:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XG @ Xz @ Xk @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ (XI @ Xz @ Xk @ Xn)) @ (ccfv @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (XI @ Xz @ Xk @ Xn)) @ ccdiv))))))) => ((! [Xz:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XH @ Xz @ Xk @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ ccpi @ cc2 @ ccdiv) @ (cco @ cc1 @ (ccfv @ (ccv @ Xn) @ (ccseq @ ccmul @ (XF @ Xk @ Xn) @ cc1)) @ ccdiv) @ ccmul))))))) => (! [Xz:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XG @ Xz @ Xk @ Xn) = (XH @ Xz @ Xk @ Xn)))))))))))))).
...
thf(awallispilem3_thm,axiom,(! [XI:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xn:$i] : ((XI @ Xx3 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ (ccv @ Xn) @ ccexp)))))))) => (! [Xx3:$i] : (! [Xn:$i] : ((cwcel @ (XN @ Xx3 @ Xn) @ ccn0) => (cwcel @ (ccfv @ (XN @ Xx3 @ Xn) @ (XI @ Xx3 @ Xn)) @ ccrp)))))))).
...
thf(awallispilem1_thm,axiom,(! [Xph:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xn:$i] : ((XI @ Xx3 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ (ccv @ Xn) @ ccexp)))))))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XN @ ccn0))) => (! [Xx3:$i] : (! [Xn:$i] : ((Xph @ Xn) => (cwbr @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ (XI @ Xx3 @ Xn)) @ (ccfv @ XN @ (XI @ Xx3 @ Xn)) @ ccle)))))))))).
...
thf(cwallispilem5_conj,conjecture,(! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (! [Xn:$i] : ((XF @ Xk @ Xn) = (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccmin) @ ccdiv) @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ ccmul)))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XI @ Xx3 @ Xk @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ (ccv @ Xn) @ ccexp))))))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XG @ Xx3 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ (XI @ Xx3 @ Xk @ Xn)) @ (ccfv @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (XI @ Xx3 @ Xk @ Xn)) @ ccdiv))))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XH @ Xx3 @ Xk @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ ccpi @ cc2 @ ccdiv) @ (cco @ cc1 @ (ccfv @ (ccv @ Xn) @ (ccseq @ ccmul @ (XF @ Xk @ Xn) @ cc1)) @ ccdiv) @ ccmul))))))) => ((! [Xx3:$i] : (! [Xn:$i] : ((XL @ Xx3 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccdiv)))))) => (! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : (cwbr @ (XH @ Xx3 @ Xk @ Xn) @ cc1 @ ccli))))))))))))))).
