...
thf(chashsslei_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cwss @ XB2 @ XA2) => (((cwcel @ XA2 @ ccfn) & (cwbr @ (ccfv @ XA2 @ cchash) @ XN @ ccle)) => ((cwcel @ XN @ ccn0) => ((cwcel @ XB2 @ ccfn) & (cwbr @ (ccfv @ XB2 @ cchash) @ XN @ ccle))))))))).
