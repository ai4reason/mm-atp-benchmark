...
thf(acaovcl_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS)) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) @ XS)))) => (! [Xx3:$i] : (((cwcel @ XA2 @ XS) & (cwcel @ (XB2 @ Xx3) @ XS)) => (cwcel @ (cco @ XA2 @ (XB2 @ Xx3) @ XF) @ XS))))))))).
