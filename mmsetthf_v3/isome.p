...
thf(adf_ome_ax,axiom,(ccome = (^ [Xx3:$i] : (((((cwf @ (ccdm @ (ccv @ Xx3)) @ (cco @ ccc0 @ ccpnf @ ccicc) @ (ccv @ Xx3)) & ((ccdm @ (ccv @ Xx3)) = (ccpw @ (ccuni @ (ccdm @ (ccv @ Xx3)))))) & ((ccfv @ cc0 @ (ccv @ Xx3)) = ccc0)) & (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xx3)) @ ccle)) @ (^ [Xz:$i] : (ccpw @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : (ccpw @ (ccuni @ (ccdm @ (ccv @ Xx3))))))) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ ccom @ ccdom) => (cwbr @ (ccfv @ (ccuni @ (ccv @ Xy1)) @ (ccv @ Xx3)) @ (ccfv @ (ccres @ (ccv @ Xx3) @ (ccv @ Xy1)) @ ccsumge0) @ ccle))) @ (^ [Xy1:$i] : (ccpw @ (ccdm @ (ccv @ Xx3))))))))).
thf(cisome_conj,conjecture,(! [XO:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ XO @ (XV @ Xy1 @ Xz)) => ((cwcel @ XO @ ccome) <=> (((((cwf @ (ccdm @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XO) & ((ccdm @ XO) = (ccpw @ (ccuni @ (ccdm @ XO))))) & ((ccfv @ cc0 @ XO) = ccc0)) & (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (ccv @ Xz) @ XO) @ (ccfv @ (ccv @ Xy1) @ XO) @ ccle)) @ (^ [Xz:$i] : (ccpw @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : (ccpw @ (ccuni @ (ccdm @ XO)))))) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ ccom @ ccdom) => (cwbr @ (ccfv @ (ccuni @ (ccv @ Xy1)) @ XO) @ (ccfv @ (ccres @ XO @ (ccv @ Xy1)) @ ccsumge0) @ ccle))) @ (^ [Xy1:$i] : (ccpw @ (ccdm @ XO)))))))))))).
