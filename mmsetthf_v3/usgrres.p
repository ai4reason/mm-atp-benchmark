...
thf(cusgrres_conj,conjecture,(! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xi:$i] : ((XV @ Xi) = (ccfv @ (XG @ Xi) @ ccvtx))) => ((! [Xi:$i] : (XE = (ccfv @ (XG @ Xi) @ cciedg))) => ((! [Xi:$i] : ((XF @ Xi) = (ccrab @ (^ [Xi:$i] : (cwnel @ XN @ (ccfv @ (ccv @ Xi) @ XE))) @ (^ [Xi:$i] : (ccdm @ XE))))) => ((! [Xi:$i] : ((XS @ Xi) = (ccop @ (ccdif @ (XV @ Xi) @ (ccsn @ XN)) @ (ccres @ XE @ (XF @ Xi))))) => (! [Xi:$i] : (((cwcel @ (XG @ Xi) @ ccusgr) & (cwcel @ XN @ (XV @ Xi))) => (cwcel @ (XS @ Xi) @ ccusgr)))))))))))))).
