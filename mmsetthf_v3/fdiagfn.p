...
thf(cfdiagfn_conj,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccxp @ XI @ (ccsn @ (ccv @ Xx3))))))) => (! [Xx3:$i] : (((cwcel @ XB2 @ XV) & (cwcel @ XI @ XW)) => (cwf @ XB2 @ (cco @ XB2 @ XI @ ccmap) @ (XF @ Xx3))))))))))).
