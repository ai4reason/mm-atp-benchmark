...
thf(csummodnegmod_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz) & (cwcel @ XN @ ccn)) => (((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XN @ ccmo) = ccc0) <=> ((cco @ XA2 @ XN @ ccmo) = (cco @ (ccneg @ XB2) @ XN @ ccmo)))))))).
