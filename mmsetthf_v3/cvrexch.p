...
thf(acvrexchlem_thm,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XC = (ccfv @ XK @ cccvr)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => ((cwbr @ (cco @ XX @ XY @ Xc_an) @ XY @ XC) => (cwbr @ XX @ (cco @ XX @ XY @ Xc_or) @ XC))))))))))))))).
...
thf(ccvrexch_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XC = (ccfv @ XK @ cccvr)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => ((cwbr @ (cco @ XX @ XY @ Xc_an) @ XY @ XC) <=> (cwbr @ XX @ (cco @ XX @ XY @ Xc_or) @ XC))))))))))))))).
