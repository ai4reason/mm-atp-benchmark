...
thf(asnatpsubN_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XS = (ccfv @ XK @ ccpsubsp)) => (((cwcel @ XK @ ccal) & (cwcel @ XP @ XA2)) => (cwcel @ (ccsn @ XP) @ XS))))))))).
...
thf(apsubspi2N_thm,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XS = (ccfv @ XK @ ccpsubsp)) => ((((cwcel @ XK @ XD) & (cwcel @ XX @ XS) & (cwcel @ XP @ XA2)) & ((cwcel @ XQ @ XX) & (cwcel @ XR @ XX) & (cwbr @ XP @ (cco @ XQ @ XR @ Xc_or) @ Xc_le))) => (cwcel @ XP @ XX))))))))))))))))).
...
thf(cpclfinclN_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XU = (ccfv @ XK @ ccpclN)) => ((XS = (ccfv @ XK @ ccpscN)) => (((cwcel @ XK @ cchlt) & (cwss @ XX @ XA2) & (cwcel @ XX @ ccfn)) => (cwcel @ (ccfv @ XX @ XU) @ XS))))))))))).
