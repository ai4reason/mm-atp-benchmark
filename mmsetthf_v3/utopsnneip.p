...
thf(cutopsnneip_conj,conjecture,(! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xv:$i] : ((XJ @ Xv) = (ccfv @ XU @ ccutop))) => (! [Xv:$i] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ XP @ XX)) => ((ccfv @ (ccsn @ XP) @ (ccfv @ (XJ @ Xv) @ ccnei)) = (ccrn @ (ccmpt @ (^ [Xv:$i] : XU) @ (^ [Xv:$i] : (ccima @ (ccv @ Xv) @ (ccsn @ XP)))))))))))))).
