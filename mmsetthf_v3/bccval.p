...
thf(adf_bcc_ax,axiom,(ccbcc = (ccmpt2 @ (^ [Xc:$i] : (^ [Xk:$i] : ccc)) @ (^ [Xc:$i] : (^ [Xk:$i] : ccn0)) @ (^ [Xc:$i] : (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xc) @ (ccv @ Xk) @ ccfallfac) @ (ccfv @ (ccv @ Xk) @ ccfa) @ ccdiv)))))).
...
thf(cbccval_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XK @ ccn0)) => (Xph => ((cco @ XC @ XK @ ccbcc) = (cco @ (cco @ XC @ XK @ ccfallfac) @ (ccfv @ XK @ ccfa) @ ccdiv))))))))).
