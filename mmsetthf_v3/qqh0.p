...
thf(agcd0id_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cco @ ccc0 @ XN @ ccgcd) = (ccfv @ XN @ ccabs))))).
...
thf(advr1_thm,axiom,(! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((Xc_1 = (ccfv @ XR @ ccur)) => (((cwcel @ XR @ ccrg) & (cwcel @ XX @ XB2)) => ((cco @ XX @ Xc_1 @ Xc_dv) = XX))))))))))).
