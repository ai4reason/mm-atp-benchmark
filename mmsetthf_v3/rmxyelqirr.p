...
thf(arabab_thm,axiom,(! [Xph:($i > $o)] : ((ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : ccvv)) = (^ [Xx3:$i] : (Xph @ Xx3))))).
...
thf(crmxyelqirr_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [Xc:$i] : (! [Xd:$i] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ (XN @ Xc @ Xd) @ ccz)) => (cwcel @ (cco @ (cco @ XA2 @ (ccfv @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ ccsqrt) @ ccaddc) @ (XN @ Xc @ Xd) @ ccexp) @ (^ [Xa:$i] : (cwrex @ (^ [Xc:$i] : (cwrex @ (^ [Xd:$i] : ((ccv @ Xa) = (cco @ (ccv @ Xc) @ (cco @ (ccfv @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ ccsqrt) @ (ccv @ Xd) @ ccmul) @ ccaddc))) @ (^ [Xd:$i] : ccz))) @ (^ [Xc:$i] : ccn0)))))))))).
