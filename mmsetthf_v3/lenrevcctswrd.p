...
thf(clenrevcctswrd_conj,conjecture,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XM @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) => ((ccfv @ (cco @ (cco @ XW @ (ccop @ XM @ (ccfv @ XW @ cchash)) @ ccsubstr) @ (cco @ XW @ (ccop @ ccc0 @ XM) @ ccsubstr) @ ccconcat) @ cchash) = (ccfv @ XW @ cchash))))))).
