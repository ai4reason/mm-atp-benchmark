...
thf(cxrlimcnp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : ((Xph => (XA2 = (ccun @ XB2 @ (ccsn @ ccpnf)))) => ((Xph => (cwss @ XB2 @ ccr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XR @ Xx3) @ ccc))) => ((! [Xx3:$i] : (((ccv @ Xx3) = ccpnf) => ((XR @ Xx3) = XC))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ cccnfld @ cctopn))) => ((! [Xx3:$i] : ((XK @ Xx3) = (cco @ (ccfv @ ccle @ ccordt) @ XA2 @ ccrest))) => (! [Xx3:$i] : (Xph => ((cwbr @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XR @ Xx3))) @ XC @ ccrli) <=> (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XR @ Xx3))) @ (ccfv @ ccpnf @ (cco @ (XK @ Xx3) @ (XJ @ Xx3) @ cccnp)))))))))))))))))))).
