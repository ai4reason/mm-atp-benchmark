...
thf(aghomlinOLD_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((((cwcel @ XG @ ccgr) & (cwcel @ XH @ ccgr) & (cwcel @ XF @ (cco @ XG @ XH @ ccghomOLD))) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX))) => ((cco @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ XH) = (ccfv @ (cco @ XA2 @ XB2 @ XG) @ XF))))))))))).
...
thf(agrpoid_thm,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((XU = (ccfv @ XG @ ccgi)) => (((cwcel @ XG @ ccgr) & (cwcel @ XA2 @ XX)) => ((XA2 = XU) <=> ((cco @ XA2 @ XA2 @ XG) = XA2)))))))))).
thf(cghomidOLD_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XU = (ccfv @ XG @ ccgi)) => ((XT = (ccfv @ XH @ ccgi)) => (((cwcel @ XG @ ccgr) & (cwcel @ XH @ ccgr) & (cwcel @ XF @ (cco @ XG @ XH @ ccghomOLD))) => ((ccfv @ XU @ XF) = XT)))))))))).
