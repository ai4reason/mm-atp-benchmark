...
thf(cccatco_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XS @ (ccword @ XA2)) & (cwcel @ XT @ (ccword @ XA2)) & (cwf @ XA2 @ XB2 @ XF)) => ((cccom @ XF @ (cco @ XS @ XT @ ccconcat)) = (cco @ (cccom @ XF @ XS) @ (cccom @ XF @ XT) @ ccconcat))))))))).
