...
thf(ccoinfliplem_conj,conjecture,(! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XH @ ccvv) => ((cwcel @ XT @ ccvv) => ((XH != XT) => ((XP = (cco @ (ccres @ cchash @ (ccpw @ (ccpr @ XH @ XT))) @ cc2 @ (ccofc @ ccdiv))) => ((XX = (ccpr @ (ccop @ XH @ cc1) @ (ccop @ XT @ ccc0))) => (XP = (cco @ (ccres @ cchash @ (ccpw @ (ccpr @ XH @ XT))) @ cc2 @ (ccofc @ ccxdiv))))))))))))).
