...
thf(cxrge0adddir_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc)) & (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc)) & (cwcel @ XC @ (cco @ ccc0 @ ccpnf @ ccicc))) => ((cco @ (cco @ XA2 @ XB2 @ ccxad) @ XC @ ccxmu) = (cco @ (cco @ XA2 @ XC @ ccxmu) @ (cco @ XB2 @ XC @ ccxmu) @ ccxad))))))).
