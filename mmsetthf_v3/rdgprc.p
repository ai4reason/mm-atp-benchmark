...
thf(ardglim_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XB2 @ XC) & (cwlim @ XB2)) => ((ccfv @ XB2 @ (ccrdg @ XF @ XA2)) = (ccuni @ (ccima @ (ccrdg @ XF @ XA2) @ XB2))))))))).
...
thf(crdgprc_conj,conjecture,(! [XF:($i > $o)] : (! [XI:($i > $o)] : ((~ (cwcel @ XI @ ccvv)) => ((ccrdg @ XF @ XI) = (ccrdg @ XF @ cc0)))))).
