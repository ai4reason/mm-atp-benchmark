...
thf(afseqen_thm,axiom,(! [XA2:($i > $o)] : (((cwbr @ (ccxp @ XA2 @ XA2) @ XA2 @ ccen) & (XA2 != cc0)) => (cwbr @ (cciun @ (^ [Xn:$i] : ccom) @ (^ [Xn:$i] : (cco @ XA2 @ (ccv @ Xn) @ ccmap))) @ (ccxp @ ccom @ XA2) @ ccen)))).
...
thf(cinfpwfien_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwbr @ ccom @ XA2 @ ccdom)) => (cwbr @ (ccin @ (ccpw @ XA2) @ ccfn) @ XA2 @ ccen)))).
