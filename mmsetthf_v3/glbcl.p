...
thf(cglbcl_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XG = (ccfv @ XK @ ccglb)) => ((Xph => (cwcel @ XK @ XV)) => ((Xph => (cwcel @ XS @ (ccdm @ XG))) => (Xph => (cwcel @ (ccfv @ XS @ XG) @ XB2))))))))))))).
