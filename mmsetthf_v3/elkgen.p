...
thf(celkgen_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XX @ cctopon)) => ((cwcel @ XA2 @ (ccfv @ XJ @ cckgen)) <=> ((cwss @ XA2 @ XX) & (cwral @ (^ [Xk:$i] : ((cwcel @ (cco @ XJ @ (ccv @ Xk) @ ccrest) @ cccmp) => (cwcel @ (ccin @ XA2 @ (ccv @ Xk)) @ (cco @ XJ @ (ccv @ Xk) @ ccrest)))) @ (^ [Xk:$i] : (ccpw @ XX)))))))))).
