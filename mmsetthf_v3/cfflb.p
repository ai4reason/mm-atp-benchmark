...
thf(ccfflb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((? [Xf1:$i] : ((cwf @ XB2 @ XA2 @ (ccv @ Xf1)) & (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xf1)))) @ (^ [Xw:$i] : XB2))) @ (^ [Xz:$i] : XA2)))) => (cwss @ (ccfv @ XA2 @ cccf) @ XB2)))))).
