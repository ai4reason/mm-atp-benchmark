...
thf(cressval2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XR = (cco @ XW @ XA2 @ ccress)) => ((XB2 = (ccfv @ XW @ ccbs)) => (((~ (cwss @ XB2 @ XA2)) & (cwcel @ XW @ XX) & (cwcel @ XA2 @ XY)) => (XR = (cco @ XW @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccin @ XA2 @ XB2)) @ ccsts)))))))))))).
