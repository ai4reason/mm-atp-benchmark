...
thf(alss0v_thm,axiom,(! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XX = (cco @ XW @ XU @ ccress)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XZ = (ccfv @ XX @ cc0g)) => ((XL = (ccfv @ XW @ cclss)) => (((cwcel @ XW @ cclmod) & (cwcel @ XU @ XL)) => (XZ = Xc_0))))))))))))).
