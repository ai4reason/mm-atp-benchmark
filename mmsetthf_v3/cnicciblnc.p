...
thf(abddiblnc_thm,axiom,(! [XF:($i > $o)] : (((cwcel @ XF @ ccmbf) & (cwcel @ (ccfv @ (ccdm @ XF) @ ccvol) @ ccr) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ ccabs) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (ccdm @ XF)))) @ (^ [Xx3:$i] : ccr))) => (cwcel @ XF @ ccibl)))).
thf(ccnicciblnc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr) & (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ cccncf))) => (cwcel @ XF @ ccibl)))))).
