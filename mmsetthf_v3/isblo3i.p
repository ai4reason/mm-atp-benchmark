...
thf(cisblo3i_conj,conjecture,(! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XM = (ccfv @ XU @ ccnmcv)) => ((XN = (ccfv @ XW @ ccnmcv)) => ((! [Xy1:$i] : ((XL @ Xy1) = (cco @ XU @ XW @ cclno))) => ((XB2 = (cco @ XU @ XW @ ccblo)) => ((cwcel @ XU @ ccnv) => ((cwcel @ XW @ ccnv) => (! [Xy1:$i] : ((cwcel @ XT @ XB2) <=> ((cwcel @ XT @ (XL @ Xy1)) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XT) @ XN) @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XM) @ ccmul) @ ccle)) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : ccr))))))))))))))))))))).
