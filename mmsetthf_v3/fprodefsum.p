...
thf(aprodfc_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((ccprod @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (ccfv @ (ccv @ Xj) @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk)))))) = (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))))))).
...
thf(cfprodefsum_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XN @ XZ)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XA2 @ Xk) @ ccc))) => (Xph => ((ccprod @ (^ [Xk:$i] : (cco @ XM @ XN @ ccfz)) @ (^ [Xk:$i] : (ccfv @ (XA2 @ Xk) @ cce))) = (ccfv @ (ccsu @ (cco @ XM @ XN @ ccfz) @ (^ [Xk:$i] : (XA2 @ Xk))) @ cce)))))))))))).
