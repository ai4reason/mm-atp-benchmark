...
thf(ann0ob_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn0) <=> (cwcel @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn0))))).
...
thf(azob_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccz) <=> (cwcel @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccz))))).
...
thf(cnn0sumshdiglemB_conj,conjecture,(! [Xy1:$i] : (! [Xa:$i] : ((((cwcel @ (ccv @ Xa) @ ccn) & (cwcel @ (cco @ (cco @ (ccv @ Xa) @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn0)) & (cwcel @ (ccv @ Xy1) @ ccn)) => ((cwral @ (^ [Xx3:$i] : (((ccfv @ (ccv @ Xx3) @ ccblen) = (ccv @ Xy1)) => ((ccv @ Xx3) = (ccsu @ (cco @ ccc0 @ (ccv @ Xy1) @ ccfzo) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ (ccv @ Xx3) @ (ccfv @ cc2 @ ccdig)) @ (cco @ cc2 @ (ccv @ Xk) @ ccexp) @ ccmul)))))) @ (^ [Xx3:$i] : ccn0)) => (((ccfv @ (ccv @ Xa) @ ccblen) = (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) => ((ccv @ Xa) = (ccsu @ (cco @ ccc0 @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ ccfzo) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ (ccv @ Xa) @ (ccfv @ cc2 @ ccdig)) @ (cco @ cc2 @ (ccv @ Xk) @ ccexp) @ ccmul)))))))))).
