...
thf(afnsnr_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ (ccsn @ XA2)) => ((cwcel @ XB2 @ XF) => (XB2 = (ccop @ XA2 @ (ccfv @ XA2 @ XF))))))))).
...
thf(cfnsnb_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwfn @ XF @ (ccsn @ XA2)) <=> (XF = (ccsn @ (ccop @ XA2 @ (ccfv @ XA2 @ XF))))))))).
