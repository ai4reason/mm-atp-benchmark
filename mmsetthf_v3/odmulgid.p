...
thf(codmulgid_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & (cwcel @ XN @ ccz)) & (cwcel @ XK @ ccz)) => ((cwbr @ (ccfv @ (cco @ XN @ XA2 @ Xc_x) @ XO) @ XK @ ccdvds) <=> (cwbr @ (ccfv @ XA2 @ XO) @ (cco @ XK @ XN @ ccmul) @ ccdvds)))))))))))))).
