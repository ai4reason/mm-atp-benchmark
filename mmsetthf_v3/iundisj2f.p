...
thf(assiun2sf_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XC @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XD @ Xx3))) => ((! [Xx3:$i] : (((ccv @ Xx3) = (XC @ Xx3)) => ((XB2 @ Xx3) = (XD @ Xx3)))) => (! [Xx3:$i] : ((cwcel @ (XC @ Xx3) @ (XA2 @ Xx3)) => (cwss @ (XD @ Xx3) @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))))))))).
