...
thf(csnclseqg_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XJ = (ccfv @ XG @ cctopn)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xc_sm = (cco @ XG @ XS @ ccqg)) => ((XS = (ccfv @ (ccsn @ Xc_0) @ (ccfv @ XJ @ cccl))) => (((cwcel @ XG @ cctgp) & (cwcel @ XA2 @ XX)) => ((ccec @ XA2 @ Xc_sm) = (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ cccl))))))))))))))))).
