...
thf(amrcssv_thm,axiom,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => ((cwcel @ XC @ (ccfv @ XX @ ccmre)) => (cwss @ (ccfv @ XU @ XF) @ XX)))))))).
...
thf(aodngen_thm,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX) & (cwcel @ (ccfv @ XA2 @ XO) @ ccn)) => ((ccfv @ (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XO) = (ccfv @ XA2 @ XO))) @ (^ [Xx3:$i] : (ccfv @ (ccsn @ XA2) @ XK))) @ cchash) = (ccfv @ (ccfv @ XA2 @ XO) @ ccphi)))))))))))).
thf(cproot1hash_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XG = (cco @ (ccfv @ XR @ ccmgp) @ (ccfv @ XR @ ccui) @ ccress)) => ((XO = (ccfv @ XG @ ccod)) => (((cwcel @ XR @ ccidom) & (cwcel @ XN @ ccn) & (cwcel @ XX @ (ccima @ (cccnv @ XO) @ (ccsn @ XN)))) => ((ccfv @ (ccima @ (cccnv @ XO) @ (ccsn @ XN)) @ cchash) = (ccfv @ XN @ ccphi))))))))))).
