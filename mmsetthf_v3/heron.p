...
thf(cheron_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XO:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccdiv) @ cclog) @ ccim))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XX @ Xx3 @ Xy1) = (ccfv @ (cco @ XB2 @ XC @ ccmin) @ ccabs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XY @ Xx3 @ Xy1) = (ccfv @ (cco @ XA2 @ XC @ ccmin) @ ccabs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XZ @ Xx3 @ Xy1) = (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XO @ Xx3 @ Xy1) = (cco @ (cco @ XB2 @ XC @ ccmin) @ (cco @ XA2 @ XC @ ccmin) @ (XF @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XS @ Xx3 @ Xy1) = (cco @ (cco @ (cco @ (XX @ Xx3 @ Xy1) @ (XY @ Xx3 @ Xy1) @ ccaddc) @ (XZ @ Xx3 @ Xy1) @ ccaddc) @ cc2 @ ccdiv)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XA2 @ ccc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XB2 @ ccc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XC @ ccc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (XA2 != XC)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (XB2 != XC)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => ((cco @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (cco @ (XX @ Xx3 @ Xy1) @ (XY @ Xx3 @ Xy1) @ ccmul) @ ccmul) @ (ccfv @ (ccfv @ (XO @ Xx3 @ Xy1) @ ccsin) @ ccabs) @ ccmul) = (ccfv @ (cco @ (cco @ (XS @ Xx3 @ Xy1) @ (cco @ (XS @ Xx3 @ Xy1) @ (XX @ Xx3 @ Xy1) @ ccmin) @ ccmul) @ (cco @ (cco @ (XS @ Xx3 @ Xy1) @ (XY @ Xx3 @ Xy1) @ ccmin) @ (cco @ (XS @ Xx3 @ Xy1) @ (XZ @ Xx3 @ Xy1) @ ccmin) @ ccmul) @ ccmul) @ ccsqrt))))))))))))))))))))))))))).
