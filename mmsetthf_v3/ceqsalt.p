...
thf(cceqsalt_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((((? [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xps @ Xx3)) @ X))) & (! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> (Xps @ Xx3)))) & (cwcel @ XA2 @ (XV @ Xx3))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => (Xph @ Xx3))) <=> (Xps @ Xx3))))))))).
