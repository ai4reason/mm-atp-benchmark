...
thf(cbj_ismooredr2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3)))) => ((Xph => (cwcel @ (ccuni @ XA2) @ XA2)) => ((! [Xx3:$i] : (((Xph & (cwss @ (ccv @ Xx3) @ XA2)) & ((ccv @ Xx3) != cc0)) => (cwcel @ (ccint @ (ccv @ Xx3)) @ XA2))) => (Xph => (cwcel @ XA2 @ ccmoore))))))))).
