...
thf(aaxlowdim1_thm,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) != (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccfv @ XN @ ccee)))) @ (^ [Xx3:$i] : (ccfv @ XN @ ccee)))))).
...
thf(cbtwndiff_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee))) => (cwrex @ (^ [Xc:$i] : ((cwbr @ XB2 @ (ccop @ XA2 @ (ccv @ Xc)) @ ccbtwn) & (XB2 != (ccv @ Xc)))) @ (^ [Xc:$i] : (ccfv @ XN @ ccee)))))))).
