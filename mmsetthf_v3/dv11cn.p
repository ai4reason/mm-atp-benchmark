...
thf(cdv11cn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ XA2 @ XR @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl))) => ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XR @ ccxr)) => ((Xph => (cwf @ XX @ ccc @ XF)) => ((Xph => (cwf @ XX @ ccc @ XG)) => ((Xph => ((ccdm @ (cco @ ccc @ XF @ ccdv)) = XX)) => ((Xph => ((cco @ ccc @ XF @ ccdv) = (cco @ ccc @ XG @ ccdv))) => ((Xph => (cwcel @ XC @ XX)) => ((Xph => ((ccfv @ XC @ XF) = (ccfv @ XC @ XG))) => (Xph => (XF = XG))))))))))))))))))).
