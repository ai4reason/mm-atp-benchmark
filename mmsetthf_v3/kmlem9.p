...
thf(akmlem5_thm,axiom,(! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (((cwcel @ (ccv @ Xw) @ (ccv @ Xx3)) & ((ccv @ Xz) != (ccv @ Xw))) => ((ccin @ (ccdif @ (ccv @ Xz) @ (ccuni @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xz))))) @ (ccdif @ (ccv @ Xw) @ (ccuni @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xw)))))) = cc0)))))).
thf(aeqeq1d_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((XA2 = XC) <=> (XB2 = XC))))))))).
thf(aineq12_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((XA2 = XB2) & (XC = XD)) => ((ccin @ XA2 @ XC) = (ccin @ XB2 @ XD)))))))).
thf(ckmlem9_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xu:$i] : (! [Xt:$i] : ((XA2 @ Xx3 @ Xu @ Xt) = (^ [Xu:$i] : (cwrex @ (^ [Xt:$i] : ((ccv @ Xu) = (ccdif @ (ccv @ Xt) @ (ccuni @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xt))))))) @ (^ [Xt:$i] : (ccv @ Xx3)))))))) => (! [Xx3:$i] : (! [Xu:$i] : (! [Xt:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (((ccv @ Xz) != (ccv @ Xw)) => ((ccin @ (ccv @ Xz) @ (ccv @ Xw)) = cc0))) @ (^ [Xw:$i] : (XA2 @ Xx3 @ Xu @ Xt)))) @ (^ [Xz:$i] : (XA2 @ Xx3 @ Xu @ Xt))))))))).
