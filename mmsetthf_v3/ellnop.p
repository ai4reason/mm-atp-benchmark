...
thf(cellnop_conj,conjecture,(! [XT:($i > $o)] : ((cwcel @ XT @ cclo) <=> ((cwf @ cchil @ cchil @ XT) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((ccfv @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsm) @ (ccv @ Xz) @ ccva) @ XT) = (cco @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XT) @ ccsm) @ (ccfv @ (ccv @ Xz) @ XT) @ ccva))) @ (^ [Xz:$i] : cchil))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : ccc)))))).
