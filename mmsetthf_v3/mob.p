...
thf(amob2_thm,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> Xps))) => (! [Xx3:$i] : (((cwcel @ XA2 @ (XB2 @ Xx3)) & (cwmo @ (^ [Xx3:$i] : (Xph @ Xx3))) & (Xph @ Xx3)) => (((ccv @ Xx3) = XA2) <=> Xps))))))))).
thf(cmob_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> Xps))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XB2) => ((Xph @ Xx3) <=> Xch))) => (! [Xx3:$i] : ((((cwcel @ XA2 @ (XC @ Xx3)) & (cwcel @ XB2 @ (XD @ Xx3))) & (cwmo @ (^ [Xx3:$i] : (Xph @ Xx3))) & Xps) => ((XA2 = XB2) <=> Xch))))))))))))).
