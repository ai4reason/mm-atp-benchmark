...
thf(cixpiin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : ((XB2 != cc0) => ((ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cciin @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))) = (cciin @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xy1))))))))))).
