...
thf(cdnibndlem11_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => (cwbr @ (ccfv @ (cco @ (ccfv @ (cco @ (ccfv @ (cco @ XB2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ XB2 @ ccmin) @ ccabs) @ (ccfv @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ XA2 @ ccmin) @ ccabs) @ ccmin) @ ccabs) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccle)))))))).
