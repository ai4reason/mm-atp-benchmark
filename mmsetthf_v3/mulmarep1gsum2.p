...
thf(amulmarep1el_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XV = (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => ((Xc_1 = (ccfv @ XA2 @ ccur)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XE = (ccfv @ XK @ (cco @ Xc_1 @ XC @ (cco @ XN @ XR @ ccmatrepV)))) => (((cwcel @ XR @ ccrg) & ((cwcel @ XX @ XB2) & (cwcel @ XC @ XV) & (cwcel @ XK @ XN)) & ((cwcel @ XI @ XN) & (cwcel @ XJ @ XN) & (cwcel @ XL @ XN))) => ((cco @ (cco @ XI @ XL @ XX) @ (cco @ XL @ XJ @ XE) @ (ccfv @ XR @ ccmulr)) = (ccif @ (XJ = XK) @ (cco @ (cco @ XI @ XL @ XX) @ (ccfv @ XL @ XC) @ (ccfv @ XR @ ccmulr)) @ (ccif @ (XJ = XL) @ (cco @ XI @ XL @ XX) @ Xc_0))))))))))))))))))))))))).
...
thf(amulmarep1gsum1_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xl:$i] : ((XA2 @ Xl) = (cco @ XN @ XR @ ccmat))) => ((! [Xl:$i] : (XB2 = (ccfv @ (XA2 @ Xl) @ ccbs))) => ((XV = (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => ((! [Xl:$i] : ((Xc_1 @ Xl) = (ccfv @ (XA2 @ Xl) @ ccur))) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((! [Xl:$i] : ((XE @ Xl) = (ccfv @ XK @ (cco @ (Xc_1 @ Xl) @ XC @ (cco @ XN @ XR @ ccmatrepV))))) => (((cwcel @ XR @ ccrg) & ((cwcel @ XX @ XB2) & (cwcel @ XC @ XV) & (cwcel @ XK @ XN)) & ((cwcel @ XI @ XN) & (cwcel @ XJ @ XN) & (XJ != XK))) => ((cco @ XR @ (ccmpt @ (^ [Xl:$i] : XN) @ (^ [Xl:$i] : (cco @ (cco @ XI @ (ccv @ Xl) @ XX) @ (cco @ (ccv @ Xl) @ XJ @ (XE @ Xl)) @ (ccfv @ XR @ ccmulr)))) @ ccgsu) = (cco @ XI @ XJ @ XX))))))))))))))))))))))).
