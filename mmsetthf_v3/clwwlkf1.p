...
thf(cclwwlkf1_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((! [Xw:$i] : ((XD @ Xw) = (ccrab @ (^ [Xw:$i] : ((ccfv @ (ccv @ Xw) @ cclsw) = (ccfv @ ccc0 @ (ccv @ Xw)))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))))) => ((! [Xw:$i] : (! [Xt:$i] : ((XF @ Xw @ Xt) = (ccmpt @ (^ [Xt:$i] : (XD @ Xw)) @ (^ [Xt:$i] : (cco @ (ccv @ Xt) @ (ccop @ ccc0 @ XN) @ ccsubstr)))))) => (! [Xw:$i] : (! [Xt:$i] : ((cwcel @ XN @ ccn) => (cwf1 @ (XD @ Xw) @ (cco @ XN @ XG @ ccclwwlkn) @ (XF @ Xw @ Xt)))))))))))).
