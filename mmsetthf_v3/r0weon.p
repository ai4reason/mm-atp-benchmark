...
thf(afnwe_thm,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XT @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XA2)) & ((cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ XR) | (((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xy1) @ XF)) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XS)))))))))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwf @ XA2 @ XB2 @ XF))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwwe @ XB2 @ XR))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwwe @ XA2 @ XS))) => ((! [Xy1:$i] : (! [Xw:$i] : ((Xph @ Xy1) => (cwcel @ (ccima @ XF @ (ccv @ Xw)) @ ccvv)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xy1) => (cwwe @ XA2 @ (XT @ Xx3 @ Xy1)))))))))))))))))).
...
thf(afnse_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((XT @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (XA2 @ Xw)) & (cwcel @ (ccv @ Xy1) @ (XA2 @ Xw))) & ((cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ XR) | (((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xy1) @ XF)) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XS @ Xw)))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1) => (cwf @ (XA2 @ Xw) @ (XB2 @ Xx3 @ Xy1) @ XF))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwse @ (XB2 @ Xx3 @ Xy1) @ XR)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xw)) @ ccvv))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1) => (cwse @ (XA2 @ Xw) @ (XT @ Xx3 @ Xy1)))))))))))))))))).
