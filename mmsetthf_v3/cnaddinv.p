...
thf(acnaddabl_thm,axiom,(! [XG:($i > $o)] : ((XG = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ ccc) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ ccaddc))) => (cwcel @ XG @ ccabl)))).
...
thf(acnaddid_thm,axiom,(! [XG:($i > $o)] : ((XG = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ ccc) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ ccaddc))) => ((ccfv @ XG @ cc0g) = ccc0)))).
thf(aeqid_thm,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(ccnaddinv_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : ((XG = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ ccc) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ ccaddc))) => ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ (ccfv @ XG @ ccminusg)) = (ccneg @ XA2))))))).
