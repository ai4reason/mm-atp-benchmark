...
thf(cconnclo_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((Xph => (cwcel @ XJ @ ccconn)) => ((Xph => (cwcel @ XA2 @ XJ)) => ((Xph => (XA2 != cc0)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XJ @ cccld))) => (Xph => (XA2 = XX)))))))))))).
