...
thf(advdsval3_thm,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn) & (cwcel @ XN @ ccz)) => ((cwbr @ XM @ XN @ ccdvds) <=> ((cco @ XN @ XM @ ccmo) = ccc0)))))).
thf(cbezoutlem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xz:$i] : ((XM @ Xz) = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xz) = (cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ (cco @ XB2 @ (ccv @ Xy1) @ ccmul) @ ccaddc))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccn)))) => ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XB2 @ ccz)) => ((! [Xz:$i] : (XG = (ccinf @ (XM @ Xz) @ ccr @ cclt))) => ((Xph => (~ ((XA2 = ccc0) & (XB2 = ccc0)))) => (! [Xz:$i] : (Xph => ((cwcel @ XC @ (XM @ Xz)) => (cwbr @ XG @ XC @ ccdvds)))))))))))))))).
