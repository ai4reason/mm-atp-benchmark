...
thf(afacth_thm,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (cco @ ccidp @ (ccxp @ ccc @ (ccsn @ XA2)) @ (ccof @ ccmin))) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XA2 @ ccc) & ((ccfv @ XA2 @ XF) = ccc0)) => (XF = (cco @ XG @ (cco @ XF @ XG @ ccquot) @ (ccof @ ccmul)))))))))).
...
thf(aofmulrt_thm,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwf @ XA2 @ ccc @ XF) & (cwf @ XA2 @ ccc @ XG)) => ((ccima @ (cccnv @ (cco @ XF @ XG @ (ccof @ ccmul))) @ (ccsn @ ccc0)) = (ccun @ (ccima @ (cccnv @ XF) @ (ccsn @ ccc0)) @ (ccima @ (cccnv @ XG) @ (ccsn @ ccc0)))))))))).
...
thf(acaofid1_thm,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwcel @ (XA2 @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwf @ (XA2 @ Xx3) @ XS @ XF))) => ((! [Xx3:$i] : (Xph => (cwcel @ XB2 @ (XW @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XC @ (XX @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XS)) => ((cco @ (ccv @ Xx3) @ XB2 @ XR) = XC))) => (! [Xx3:$i] : (Xph => ((cco @ XF @ (ccxp @ (XA2 @ Xx3) @ (ccsn @ XB2)) @ (ccof @ XR)) = (ccxp @ (XA2 @ Xx3) @ (ccsn @ XC))))))))))))))))))))).
...
thf(cfta1lem_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xg1:$i] : ((XR @ Xg1) = (ccima @ (cccnv @ XF) @ (ccsn @ ccc0)))) => ((! [Xg1:$i] : ((Xph @ Xg1) => (cwcel @ XD @ ccn0))) => ((! [Xg1:$i] : ((Xph @ Xg1) => (cwcel @ XF @ (ccdif @ (ccfv @ ccc @ ccply) @ (ccsn @ cc0p))))) => ((! [Xg1:$i] : ((Xph @ Xg1) => ((ccfv @ XF @ ccdgr) = (cco @ XD @ cc1 @ ccaddc)))) => ((! [Xg1:$i] : ((Xph @ Xg1) => (cwcel @ XA2 @ (ccima @ (cccnv @ XF) @ (ccsn @ ccc0))))) => ((! [Xg1:$i] : ((Xph @ Xg1) => (cwral @ (^ [Xg1:$i] : (((ccfv @ (ccv @ Xg1) @ ccdgr) = XD) => ((cwcel @ (ccima @ (cccnv @ (ccv @ Xg1)) @ (ccsn @ ccc0)) @ ccfn) & (cwbr @ (ccfv @ (ccima @ (cccnv @ (ccv @ Xg1)) @ (ccsn @ ccc0)) @ cchash) @ (ccfv @ (ccv @ Xg1) @ ccdgr) @ ccle)))) @ (^ [Xg1:$i] : (ccdif @ (ccfv @ ccc @ ccply) @ (ccsn @ cc0p)))))) => (! [Xg1:$i] : ((Xph @ Xg1) => ((cwcel @ (XR @ Xg1) @ ccfn) & (cwbr @ (ccfv @ (XR @ Xg1) @ cchash) @ (ccfv @ XF @ ccdgr) @ ccle)))))))))))))))).
