...
thf(ccuspcvg_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XJ = (ccfv @ XW @ cctopn)) => (((cwcel @ XW @ cccusp) & (cwcel @ XC @ (ccfv @ (ccfv @ XW @ ccuss) @ cccfilu)) & (cwcel @ XC @ (ccfv @ XB2 @ ccfil))) => ((cco @ XJ @ XC @ ccflim) != cc0))))))))).
