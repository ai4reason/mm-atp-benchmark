...
thf(afveqdmss_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((XD = (ccdm @ XB2)) => (((cwfun @ XB2) & (cwnel @ cc0 @ (ccrn @ XB2)) & (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XA2) = (ccfv @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : XD))) => (cwss @ XD @ (ccdm @ XA2)))))))).
...
thf(cfveqressseq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((XD = (ccdm @ XB2)) => (((cwfun @ XB2) & (cwnel @ cc0 @ (ccrn @ XB2)) & (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XA2) = (ccfv @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : XD))) => ((ccres @ XA2 @ XD) = XB2))))))).
