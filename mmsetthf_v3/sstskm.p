...
thf(csstskm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((cwss @ XB2 @ (ccfv @ XA2 @ cctskm)) <=> (cwral @ (^ [Xx3:$i] : ((cwcel @ XA2 @ (ccv @ Xx3)) => (cwss @ XB2 @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : cctsk))))))))).
