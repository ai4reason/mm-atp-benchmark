...
thf(ablnei_thm,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XP @ XX) & (cwcel @ XR @ ccrp)) => (cwcel @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei))))))))))).
