...
thf(asubcos_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ (ccfv @ XB2 @ cccos) @ (ccfv @ XA2 @ cccos) @ ccmin) = (cco @ cc2 @ (cco @ (ccfv @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ cc2 @ ccdiv) @ ccsin) @ (ccfv @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccmul)))))).
