...
thf(acncfioobd_thm,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccc @ cccncf))) => ((Xph => (cwcel @ XL @ (cco @ XF @ XB2 @ cclimc))) => ((Xph => (cwcel @ XR @ (cco @ XF @ XA2 @ cclimc))) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ ccabs) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccioo)))) @ (^ [Xx3:$i] : ccr))))))))))))))).
...
thf(cfourierdlem70_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xs1:$i] : (Xph => (cwcel @ (XA2 @ Xx3 @ Xs1) @ ccr)))) => ((! [Xx3:$i] : (! [Xs1:$i] : (Xph => (cwcel @ (XB2 @ Xx3 @ Xs1) @ ccr)))) => ((! [Xx3:$i] : (! [Xs1:$i] : (Xph => (cwbr @ (XA2 @ Xx3 @ Xs1) @ (XB2 @ Xx3 @ Xs1) @ ccle)))) => ((! [Xx3:$i] : (! [Xs1:$i] : (Xph => (cwf @ (cco @ (XA2 @ Xx3 @ Xs1) @ (XB2 @ Xx3 @ Xs1) @ ccicc) @ ccr @ XF)))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XM @ Xx3) @ ccn))) => ((! [Xx3:$i] : (Xph => (cwf @ (cco @ ccc0 @ (XM @ Xx3) @ ccfz) @ ccr @ XQ))) => ((! [Xx3:$i] : (! [Xs1:$i] : (Xph => ((ccfv @ ccc0 @ XQ) = (XA2 @ Xx3 @ Xs1))))) => ((! [Xx3:$i] : (! [Xs1:$i] : (Xph => ((ccfv @ (XM @ Xx3) @ XQ) = (XB2 @ Xx3 @ Xs1))))) => ((! [Xx3:$i] : (! [Xi:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ (XM @ Xx3) @ ccfzo))) => (cwbr @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ cclt)))) => ((! [Xx3:$i] : (! [Xi:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ (XM @ Xx3) @ ccfzo))) => (cwcel @ (ccres @ XF @ (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ ccioo)) @ (cco @ (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ ccioo) @ ccc @ cccncf))))) => ((! [Xx3:$i] : (! [Xi:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ (XM @ Xx3) @ ccfzo))) => (cwcel @ (XR @ Xx3 @ Xi) @ (cco @ (ccres @ XF @ (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ ccioo)) @ (ccfv @ (ccv @ Xi) @ XQ) @ cclimc))))) => ((! [Xx3:$i] : (! [Xi:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ (XM @ Xx3) @ ccfzo))) => (cwcel @ (XL @ Xx3 @ Xi) @ (cco @ (ccres @ XF @ (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ ccioo)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ cclimc))))) => ((! [Xx3:$i] : (XI = (ccmpt @ (^ [Xi:$i] : (cco @ ccc0 @ (XM @ Xx3) @ ccfzo)) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XQ) @ ccioo))))) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xs1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xs1) @ XF) @ ccabs) @ (ccv @ Xx3) @ ccle)) @ (^ [Xs1:$i] : (cco @ (XA2 @ Xx3 @ Xs1) @ (XB2 @ Xx3 @ Xs1) @ ccicc)))) @ (^ [Xx3:$i] : ccr)))))))))))))))))))))))))).
