...
thf(csubrguss_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((XU = (ccfv @ XR @ ccui)) => ((XV = (ccfv @ XS @ ccui)) => ((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) => (cwss @ XV @ XU))))))))))).
