...
thf(acarsgval_thm,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xe:$i] : (! [Xa:$i] : (Xph => (cwcel @ XO @ (XV @ Xe @ Xa))))) => ((Xph => (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => (Xph => ((ccfv @ XM @ cccarsg) = (ccrab @ (^ [Xa:$i] : (cwral @ (^ [Xe:$i] : ((cco @ (ccfv @ (ccin @ (ccv @ Xe) @ (ccv @ Xa)) @ XM) @ (ccfv @ (ccdif @ (ccv @ Xe) @ (ccv @ Xa)) @ XM) @ ccxad) = (ccfv @ (ccv @ Xe) @ XM))) @ (^ [Xe:$i] : (ccpw @ XO)))) @ (^ [Xa:$i] : (ccpw @ XO)))))))))))).
...
thf(celcarsg_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xe:$i] : (Xph => (cwcel @ XO @ (XV @ Xe)))) => ((Xph => (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => (Xph => ((cwcel @ XA2 @ (ccfv @ XM @ cccarsg)) <=> ((cwss @ XA2 @ XO) & (cwral @ (^ [Xe:$i] : ((cco @ (ccfv @ (ccin @ (ccv @ Xe) @ XA2) @ XM) @ (ccfv @ (ccdif @ (ccv @ Xe) @ XA2) @ XM) @ ccxad) = (ccfv @ (ccv @ Xe) @ XM))) @ (^ [Xe:$i] : (ccpw @ XO)))))))))))))).
