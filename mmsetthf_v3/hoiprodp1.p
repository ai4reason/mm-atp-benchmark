...
thf(choiprodp1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XL @ Xx3 @ Xk @ Xa @ Xb) = (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ ((ccv @ Xx3) = cc0) @ ccc0 @ (ccprod @ (^ [Xk:$i] : (ccv @ Xx3)) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xb)) @ ccico) @ ccvol)))))))))))))) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : (Xph => (cwcel @ (XY @ Xx3 @ Xa @ Xb) @ ccfn))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (Xph => (cwcel @ (XZ @ Xx3 @ Xa @ Xb) @ (XV @ Xx3 @ Xk @ Xa @ Xb))))))) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : (Xph => (~ (cwcel @ (XZ @ Xx3 @ Xa @ Xb) @ (XY @ Xx3 @ Xa @ Xb))))))) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : (XX = (ccun @ (XY @ Xx3 @ Xa @ Xb) @ (ccsn @ (XZ @ Xx3 @ Xa @ Xb))))))) => ((! [Xx3:$i] : (Xph => (cwf @ XX @ ccr @ (XA2 @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwf @ XX @ ccr @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XG @ Xx3 @ Xk @ Xa @ Xb) = (ccprod @ (^ [Xk:$i] : (XY @ Xx3 @ Xa @ Xb)) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (XA2 @ Xx3)) @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xx3)) @ ccico) @ ccvol)))))))) => (! [Xx3:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (Xph => ((cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ (ccfv @ XX @ (XL @ Xx3 @ Xk @ Xa @ Xb))) = (cco @ (XG @ Xx3 @ Xk @ Xa @ Xb) @ (ccfv @ (cco @ (ccfv @ (XZ @ Xx3 @ Xa @ Xb) @ (XA2 @ Xx3)) @ (ccfv @ (XZ @ Xx3 @ Xa @ Xb) @ (XB2 @ Xx3)) @ ccico) @ ccvol) @ ccmul))))))))))))))))))))))))).
