...
thf(cfilbcmb_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (XA2 != cc0) & (cwss @ XB2 @ ccr)) => ((cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccle) => (Xph @ Xx3 @ Xz))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2)) => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccle) => (cwral @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xz)) @ (^ [Xx3:$i] : XA2)))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2)))))))).
