...
thf(algsqrmodndvds_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => (((cco @ XA2 @ XP @ cclgs) = cc1) => (cwrex @ (^ [Xx3:$i] : (((cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ XP @ ccmo) = (cco @ XA2 @ XP @ ccmo)) & (~ (cwbr @ XP @ (ccv @ Xx3) @ ccdvds)))) @ (^ [Xx3:$i] : ccz))))))).
...
thf(avfermltl_thm,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccz) & (~ (cwbr @ XP @ XA2 @ ccdvds))) => ((cco @ (cco @ XA2 @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ XP @ ccmo) = cc1))))).
...
thf(csfprmdvdsmersenne_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (((cwcel @ XP @ ccprime) & ((cwcel @ XQ @ ccprime) & ((cco @ XQ @ cc8 @ ccmo) = cc7) & (XQ = (cco @ (cco @ cc2 @ XP @ ccmul) @ cc1 @ ccaddc)))) => (cwbr @ XQ @ (cco @ (cco @ cc2 @ XP @ ccexp) @ cc1 @ ccmin) @ ccdvds))))).
