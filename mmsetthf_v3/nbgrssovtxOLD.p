...
thf(anbgrnself2OLD_thm,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XG @ XW) => (cwnel @ XN @ (cco @ XG @ XN @ ccnbgr))))))).
...
thf(cnbgrssovtxOLD_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XG @ XW) => (cwss @ (cco @ XG @ XN @ ccnbgr) @ (ccdif @ XV @ (ccsn @ XN)))))))))).
