...
thf(cfperdvper_conj,conjecture,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((Xph => (cwf @ ccr @ ccc @ XF)) => ((Xph => (cwcel @ XT @ ccr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => ((ccfv @ (cco @ (ccv @ Xx3) @ XT @ ccaddc) @ XF) = (ccfv @ (ccv @ Xx3) @ XF)))) => ((! [Xx3:$i] : ((XG @ Xx3) = (cco @ ccr @ XF @ ccdv))) => (! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdm @ (XG @ Xx3)))) => ((cwcel @ (cco @ (ccv @ Xx3) @ XT @ ccaddc) @ (ccdm @ (XG @ Xx3))) & ((ccfv @ (cco @ (ccv @ Xx3) @ XT @ ccaddc) @ (XG @ Xx3)) = (ccfv @ (ccv @ Xx3) @ (XG @ Xx3))))))))))))))).
