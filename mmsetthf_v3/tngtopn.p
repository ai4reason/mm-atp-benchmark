...
thf(atngtset_thm,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XT = (cco @ XG @ XN @ cctng)) => ((XD = (ccfv @ XT @ ccds)) => ((XJ = (ccfv @ XD @ ccmopn)) => (((cwcel @ XG @ XV) & (cwcel @ XN @ XW)) => (XJ = (ccfv @ XT @ ccts)))))))))))))).
