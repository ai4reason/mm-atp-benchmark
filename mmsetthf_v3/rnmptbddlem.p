...
thf(crnmptbddlem_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (((? [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X)) => (! [X:$i] : ((^ [Xx3:$i] : (Xph @ Xx3)) @ X))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3 @ Xy1) @ (ccv @ Xy1) @ ccle)) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)))) @ (^ [Xy1:$i] : ccr)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccle)) @ (^ [Xz:$i] : (ccrn @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1))))))) @ (^ [Xy1:$i] : ccr)))))))))).
