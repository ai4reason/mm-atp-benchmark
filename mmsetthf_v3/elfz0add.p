...
thf(celfz0add_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccn0) & (cwcel @ XB2 @ ccn0)) => ((cwcel @ XN @ (cco @ ccc0 @ XA2 @ ccfz)) => (cwcel @ XN @ (cco @ ccc0 @ (cco @ XA2 @ XB2 @ ccaddc) @ ccfz)))))))).
