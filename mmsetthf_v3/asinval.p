...
thf(casinval_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ ccasin) = (cco @ (ccneg @ cci) @ (ccfv @ (cco @ (cco @ cci @ XA2 @ ccmul) @ (ccfv @ (cco @ cc1 @ (cco @ XA2 @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccaddc) @ cclog) @ ccmul))))).
