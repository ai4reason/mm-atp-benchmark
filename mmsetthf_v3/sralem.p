...
thf(asraval_thm,axiom,(! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ XV) & (cwss @ XS @ (ccfv @ XW @ ccbs))) => ((ccfv @ XS @ (ccfv @ XW @ ccsra)) = (cco @ (cco @ (cco @ XW @ (ccop @ (ccfv @ ccnx @ ccsca) @ (cco @ XW @ XS @ ccress)) @ ccsts) @ (ccop @ (ccfv @ ccnx @ ccvsca) @ (ccfv @ XW @ ccmulr)) @ ccsts) @ (ccop @ (ccfv @ ccnx @ ccip) @ (ccfv @ XW @ ccmulr)) @ ccsts))))))).
...
thf(csralem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (XA2 = (ccfv @ XS @ (ccfv @ XW @ ccsra)))) => ((Xph => (cwss @ XS @ (ccfv @ XW @ ccbs))) => ((XE = (ccslot @ XN)) => ((cwcel @ XN @ ccn) => (((cwbr @ XN @ cc5 @ cclt) | (cwbr @ cc8 @ XN @ cclt)) => (Xph => ((ccfv @ XW @ XE) = (ccfv @ XA2 @ XE))))))))))))))).
