...
thf(cbnj1097_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [Xth:($i > ($i > $o))] : (! [Xta:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xi:$i] : (! [XX:($i > ($i > ($i > $o)))] : (! [Xph0:($i > ($i > $o))] : ((! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xf1 @ Xn) <=> ((ccfv @ cc0 @ (ccv @ Xf1)) = (cc_bnj14 @ (XA2 @ Xf1 @ Xn) @ (XR @ Xf1 @ Xn) @ (XX @ Xf1 @ Xn)))))) => ((! [Xf1:$i] : (! [Xn:$i] : ((Xch @ Xf1 @ Xn) <=> (cw_bnj17 @ (cwcel @ (ccv @ Xn) @ (XD @ Xf1 @ Xn)) @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) @ (Xph @ Xf1 @ Xn) @ (Xps @ Xf1 @ Xn))))) => ((! [Xf1:$i] : (! [Xn:$i] : ((Xta @ Xf1 @ Xn) <=> ((cwcel @ (XB2 @ Xf1 @ Xn) @ ccvv) & (cw_bnj19 @ (XA2 @ Xf1 @ Xn) @ (XB2 @ Xf1 @ Xn) @ (XR @ Xf1 @ Xn)) & (cwss @ (cc_bnj14 @ (XA2 @ Xf1 @ Xn) @ (XR @ Xf1 @ Xn) @ (XX @ Xf1 @ Xn)) @ (XB2 @ Xf1 @ Xn)))))) => (! [Xf1:$i] : (! [Xn:$i] : ((((ccv @ Xi) = cc0) & (((Xth @ Xf1 @ Xn) & (Xta @ Xf1 @ Xn) & (Xch @ Xf1 @ Xn)) & (Xph0 @ Xf1 @ Xn))) => (cwss @ (ccfv @ (ccv @ Xi) @ (ccv @ Xf1)) @ (XB2 @ Xf1 @ Xn))))))))))))))))))))).
