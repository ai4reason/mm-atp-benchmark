...
thf(acnconst_thm,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XK @ (ccfv @ XY @ cctopon))) & ((cwcel @ XB2 @ XY) & (cwf @ XX @ (ccsn @ XB2) @ XF))) => (cwcel @ XF @ (cco @ XJ @ XK @ cccn)))))))))).
...
thf(axrmulc1cn_thm,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ ccle @ ccordt))) => ((XF = (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XC @ ccxmu)))) => ((Xph => (cwcel @ XC @ ccrp)) => (! [Xx3:$i] : (Xph => (cwcel @ XF @ (cco @ (XJ @ Xx3) @ (XJ @ Xx3) @ cccn)))))))))))).
...
thf(aelicoelioo_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr) & (cwbr @ XA2 @ XB2 @ cclt)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico)) <=> ((XC = XA2) | (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo))))))))).
