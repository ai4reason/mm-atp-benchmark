...
thf(cditgeq3d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwbr @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ ccle))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ ccioo))) => ((XD @ Xx3) = (XE @ Xx3)))) => (Xph => ((ccdit @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)) @ (^ [Xx3:$i] : (XD @ Xx3))) = (ccdit @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)) @ (^ [Xx3:$i] : (XE @ Xx3))))))))))))).
