...
thf(afprodntriv_thm,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : (XZ = (ccfv @ (XM @ Xy1 @ Xk @ Xn) @ ccuz))))) => ((! [Xy1:$i] : (! [Xk:$i] : ((Xph @ Xy1 @ Xk) => (cwcel @ (XN @ Xk) @ XZ)))) => ((! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xk) => (cwss @ XA2 @ (cco @ (XM @ Xy1 @ Xk @ Xn) @ (XN @ Xk) @ ccfz)))))) => (! [Xy1:$i] : (! [Xk:$i] : ((Xph @ Xy1 @ Xk) => (cwrex @ (^ [Xn:$i] : (? [Xy1:$i] : (((ccv @ Xy1) != ccc0) & (cwbr @ (ccseq @ ccmul @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ cc1))) @ (ccv @ Xn)) @ (ccv @ Xy1) @ ccli)))) @ (^ [Xn:$i] : XZ))))))))))))))).
