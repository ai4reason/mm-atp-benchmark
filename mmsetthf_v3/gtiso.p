...
thf(aisocnv3_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : ((XC = (ccdif @ (ccxp @ XA2 @ XA2) @ XR)) => ((XD = (ccdif @ (ccxp @ XB2 @ XB2) @ XS)) => ((cwiso @ XA2 @ XB2 @ XR @ XS @ XH) <=> (cwiso @ XA2 @ XB2 @ XC @ XD @ XH)))))))))))).
...
thf(aisoeq2_thm,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : ((XR = XT) => ((cwiso @ XA2 @ XB2 @ XR @ XS @ XH) <=> (cwiso @ XA2 @ XB2 @ XT @ XS @ XH)))))))))).
...
thf(cgtiso_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwss @ XA2 @ ccxr) & (cwss @ XB2 @ ccxr)) => ((cwiso @ XA2 @ XB2 @ cclt @ (cccnv @ cclt) @ XF) <=> (cwiso @ XA2 @ XB2 @ ccle @ (cccnv @ ccle) @ XF))))))).
