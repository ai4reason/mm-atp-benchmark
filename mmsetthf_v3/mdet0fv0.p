...
thf(amdet0pr_thm,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccrg) => ((cco @ cc0 @ XR @ ccmdat) = (ccsn @ (ccop @ cc0 @ (ccfv @ XR @ ccur))))))).
...
thf(cmdet0fv0_conj,conjecture,(! [XR:($i > $o)] : ((cwcel @ XR @ ccrg) => ((ccfv @ cc0 @ (cco @ cc0 @ XR @ ccmdat)) = (ccfv @ XR @ ccur))))).
