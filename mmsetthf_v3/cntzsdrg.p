...
thf(ccntzsdrg_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XM = (ccfv @ XR @ ccmgp)) => ((XZ = (ccfv @ XM @ cccntz)) => (((cwcel @ XR @ ccdr) & (cwss @ XS @ XB2)) => (cwcel @ (ccfv @ XS @ XZ) @ (ccfv @ XR @ ccsdrg)))))))))))).
