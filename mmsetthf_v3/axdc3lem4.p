...
thf(aaxdc3lem3_thm,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > $o))] : ((! [Xk:$i] : (cwcel @ (XA2 @ Xk) @ ccvv)) => ((! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((XS @ Xk @ Xm @ Xn @ Xs1) = (^ [Xs1:$i] : (cwrex @ (^ [Xn:$i] : ((cwf @ (ccsuc @ (ccv @ Xn)) @ (XA2 @ Xk) @ (ccv @ Xs1)) & ((ccfv @ cc0 @ (ccv @ Xs1)) = (XC @ Xk)) & (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccsuc @ (ccv @ Xk)) @ (ccv @ Xs1)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xs1)) @ (XF @ Xk)))) @ (^ [Xk:$i] : (ccv @ Xn))))) @ (^ [Xn:$i] : ccom)))))))) => ((cwcel @ XB2 @ ccvv) => (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((cwcel @ XB2 @ (XS @ Xk @ Xm @ Xn @ Xs1)) <=> (cwrex @ (^ [Xm:$i] : ((cwf @ (ccsuc @ (ccv @ Xm)) @ (XA2 @ Xk) @ XB2) & ((ccfv @ cc0 @ XB2) = (XC @ Xk)) & (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccsuc @ (ccv @ Xk)) @ XB2) @ (ccfv @ (ccfv @ (ccv @ Xk) @ XB2) @ (XF @ Xk)))) @ (^ [Xk:$i] : (ccv @ Xm))))) @ (^ [Xm:$i] : ccom)))))))))))))))).
