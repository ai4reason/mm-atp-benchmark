...
thf(am1detdiag_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XD = (cco @ XN @ XR @ ccmdat)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((cw3a @ (cwcel @ XR @ cccrg) @ ((XN = (ccsn @ XI)) & (cwcel @ XI @ XV)) @ (cwcel @ XM @ XB2)) => ((ccfv @ XM @ XD) = (cco @ XI @ XI @ XM))))))))))))))).
...
thf(achpmat1dlem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XC = (cco @ XN @ XR @ ccchpmat)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_mi = (ccfv @ XP @ ccsg)) => ((XS = (ccfv @ XP @ ccascl)) => ((XG = (cco @ XN @ XP @ ccmat)) => ((XT = (cco @ XN @ XR @ ccmat2pmat)) => ((cw3a @ (cwcel @ XR @ ccrg) @ ((XN = (ccsn @ XI)) & (cwcel @ XI @ XV)) @ (cwcel @ XM @ XB2)) => ((cco @ XI @ XI @ (cco @ (cco @ XX @ (ccfv @ XG @ ccur) @ (ccfv @ XG @ ccvsca)) @ (ccfv @ XM @ XT) @ (ccfv @ XG @ ccsg))) = (cco @ XX @ (ccfv @ (cco @ XI @ XI @ XM) @ XS) @ Xc_mi))))))))))))))))))))))))))).
thf(cchpmat1d_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XC = (cco @ XN @ XR @ ccchpmat)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_mi = (ccfv @ XP @ ccsg)) => ((XS = (ccfv @ XP @ ccascl)) => ((cw3a @ (cwcel @ XR @ cccrg) @ ((XN = (ccsn @ XI)) & (cwcel @ XI @ XV)) @ (cwcel @ XM @ XB2)) => ((ccfv @ XM @ XC) = (cco @ XX @ (ccfv @ (cco @ XI @ XI @ XM) @ XS) @ Xc_mi))))))))))))))))))))))).
