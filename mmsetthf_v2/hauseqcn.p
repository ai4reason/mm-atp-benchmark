...
thf(afnreseql_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwfn @ XF @ XA2) @ (cwfn @ XG @ XA2) @ (cwss @ XX @ XA2)) => (((ccres @ XF @ XX) = (ccres @ XG @ XX)) <=> (cwss @ XX @ (ccdm @ (ccin @ XF @ XG)))))))))).
...
thf(afneqeql2_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfn @ XF @ XA2) & (cwfn @ XG @ XA2)) => ((XF = XG) <=> (cwss @ XA2 @ (ccdm @ (ccin @ XF @ XG))))))))).
