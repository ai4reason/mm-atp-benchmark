...
thf(afzisoeu_ax,axiom,(! [Xph:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XH @ ccfn))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwor @ XH @ cclt))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XM @ ccz))) => ((XN = (cco @ (ccfv @ XH @ cchash) @ (cco @ XM @ cc1 @ ccmin) @ ccaddc)) => (! [Xf1:$i] : ((Xph @ Xf1) => (cweu @ (^ [Xf1:$i] : (cwiso @ (cco @ XM @ XN @ ccfz) @ XH @ cclt @ cclt @ (ccv @ Xf1))))))))))))))).
