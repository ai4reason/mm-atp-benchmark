...
thf(asbceq1dd_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph @ Xx3) => ((XA2 @ Xx3) = (XB2 @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (XA2 @ Xx3)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (XB2 @ Xx3))))))))))).
...
thf(csdclem2_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [Xch:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xth:($i > ($i > ($i > ($i > $o))))] : (! [Xta:($i > ($i > $o))] : (! [Xsi:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > $o)] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xn:$i] : (((ccv @ Xg1) = (ccres @ (ccv @ Xf1) @ (cco @ XM @ (ccv @ Xn) @ ccfz))) => ((Xps @ Xw @ Xg1 @ Xn) <=> (Xch @ Xx3 @ Xw @ Xf1 @ Xh @ Xk @ Xn)))))))))) => ((! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xn:$i] : (((ccv @ Xn) = XM) => ((Xps @ Xw @ Xg1 @ Xn) <=> (Xta @ Xf1 @ Xg1))))))) => ((! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xn:$i] : (((ccv @ Xn) = (ccv @ Xk)) => ((Xps @ Xw @ Xg1 @ Xn) <=> (Xth @ Xf1 @ Xg1 @ Xh @ Xk))))))))) => ((! [Xw:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xn:$i] : ((((ccv @ Xg1) = (ccv @ Xh)) & ((ccv @ Xn) = (cco @ (ccv @ Xk) @ cc1 @ ccaddc))) => ((Xps @ Xw @ Xg1 @ Xn) <=> (Xsi @ Xw @ Xh @ Xk)))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xph @ Xf1 @ Xg1 @ Xh @ Xk) => (cwcel @ XA2 @ (XV @ Xx3 @ Xw @ Xf1 @ Xg1 @ Xk @ Xn)))))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : ((Xph @ Xf1 @ Xg1 @ Xh @ Xk) => (cwcel @ XM @ ccz)))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : ((Xph @ Xf1 @ Xg1 @ Xh @ Xk) => (? [Xg1:$i] : ((cwf @ (ccsn @ XM) @ XA2 @ (ccv @ Xg1)) & (Xta @ Xf1 @ Xg1)))))))) => ((! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (((Xph @ Xf1 @ Xg1 @ Xh @ Xk) & (cwcel @ (ccv @ Xk) @ XZ)) => (((cwf @ (cco @ XM @ (ccv @ Xk) @ ccfz) @ XA2 @ (ccv @ Xg1)) & (Xth @ Xf1 @ Xg1 @ Xh @ Xk)) => (? [Xh:$i] : (cw3a @ (cwf @ (cco @ XM @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ ccfz) @ XA2 @ (ccv @ Xh)) @ ((ccv @ Xg1) = (ccres @ (ccv @ Xh) @ (cco @ XM @ (ccv @ Xk) @ ccfz))) @ (Xsi @ Xw @ Xh @ Xk)))))))))) => ((! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xn:$i] : ((XJ @ Xf1 @ Xg1 @ Xn) = (ccab @ (^ [Xg1:$i] : (cwrex @ (^ [Xn:$i] : ((cwf @ (cco @ XM @ (ccv @ Xn) @ ccfz) @ XA2 @ (ccv @ Xg1)) & (Xps @ Xw @ Xg1 @ Xn))) @ (^ [Xn:$i] : XZ))))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XF @ Xf1 @ Xg1 @ Xh @ Xk) = (ccmpt2 @ (^ [Xw:$i] : (^ [Xx3:$i] : XZ)) @ (^ [Xw:$i] : (^ [Xx3:$i] : (XJ @ Xf1 @ Xg1 @ Xn))) @ (^ [Xw:$i] : (^ [Xx3:$i] : (ccab @ (^ [Xh:$i] : (cwrex @ (^ [Xk:$i] : (cw3a @ (cwf @ (cco @ XM @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ ccfz) @ XA2 @ (ccv @ Xh)) @ ((ccv @ Xx3) = (ccres @ (ccv @ Xh) @ (cco @ XM @ (ccv @ Xk) @ ccfz))) @ (Xsi @ Xw @ Xh @ Xk))) @ (^ [Xk:$i] : XZ))))))))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (cwnf @ (^ [Xk:$i] : (Xph @ Xf1 @ Xg1 @ Xh @ Xk)))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xph @ Xf1 @ Xg1 @ Xh @ Xk) => (cwf @ XZ @ (XJ @ Xf1 @ Xg1 @ Xn) @ XG))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : ((Xph @ Xf1 @ Xg1 @ Xh @ Xk) => (cwf @ (cco @ XM @ XM @ ccfz) @ XA2 @ (ccfv @ XM @ XG))))))) => ((! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : (((Xph @ Xf1 @ Xg1 @ Xh @ Xk) & (cwcel @ (ccv @ Xw) @ XZ)) => (cwcel @ (ccfv @ (cco @ (ccv @ Xw) @ cc1 @ ccaddc) @ XG) @ (cco @ (ccv @ Xw) @ (ccfv @ (ccv @ Xw) @ XG) @ (XF @ Xf1 @ Xg1 @ Xh @ Xk))))))))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xk:$i] : ((Xph @ Xf1 @ Xg1 @ Xh @ Xk) => (? [Xf1:$i] : ((cwf @ XZ @ XA2 @ (ccv @ Xf1)) & (cwral @ (^ [Xn:$i] : (Xch @ Xx3 @ Xw @ Xf1 @ Xh @ Xk @ Xn)) @ (^ [Xn:$i] : XZ)))))))))))))))))))))))))))))))))))))))).
