...
thf(cdvdscmulr_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ ((cwcel @ XK @ ccz) & (cwne @ XK @ ccc0))) => ((cwbr @ (cco @ XK @ XM @ ccmul) @ (cco @ XK @ XN @ ccmul) @ ccdvds) <=> (cwbr @ XM @ XN @ ccdvds))))))).
