...
thf(a_3cyclfrgrrn1_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XE:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : ((! [Xb:$i] : (! [Xc:$i] : (XV = (ccfv @ (XG @ Xb @ Xc) @ ccvtx)))) => ((! [Xb:$i] : (! [Xc:$i] : (XE = (ccfv @ (XG @ Xb @ Xc) @ ccedg)))) => (! [Xb:$i] : (! [Xc:$i] : ((cw3a @ (cwcel @ (XG @ Xb @ Xc) @ ccfrgr) @ ((cwcel @ XA2 @ XV) & (cwcel @ (XC @ Xb @ Xc) @ XV)) @ (cwne @ XA2 @ (XC @ Xb @ Xc))) => (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (cw3a @ (cwcel @ (ccpr @ XA2 @ (ccv @ Xb)) @ XE) @ (cwcel @ (ccpr @ (ccv @ Xb) @ (ccv @ Xc)) @ XE) @ (cwcel @ (ccpr @ (ccv @ Xc) @ XA2) @ XE))) @ (^ [Xc:$i] : XV))) @ (^ [Xb:$i] : XV))))))))))))).
thf(c_3cyclfrgrrn_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ ccfrgr) & (cwbr @ cc1 @ (ccfv @ XV @ cchash) @ cclt)) => (cwral @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (cw3a @ (cwcel @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)) @ XE) @ (cwcel @ (ccpr @ (ccv @ Xb) @ (ccv @ Xc)) @ XE) @ (cwcel @ (ccpr @ (ccv @ Xc) @ (ccv @ Xa)) @ XE))) @ (^ [Xc:$i] : XV))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))))).
