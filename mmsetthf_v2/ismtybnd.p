...
thf(aismtybndlem_ax,axiom,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XN @ (ccfv @ XY @ ccxmt)) & (cwcel @ XF @ (cco @ XM @ XN @ ccismty))) => ((cwcel @ XM @ (ccfv @ XX @ ccbnd)) => (cwcel @ XN @ (ccfv @ XY @ ccbnd)))))))))).
...
thf(cismtybnd_conj,conjecture,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XM @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XN @ (ccfv @ XY @ ccxmt)) @ (cwcel @ XF @ (cco @ XM @ XN @ ccismty))) => ((cwcel @ XM @ (ccfv @ XX @ ccbnd)) <=> (cwcel @ XN @ (ccfv @ XY @ ccbnd)))))))))).
