...
thf(clincscm_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_xb:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xc_xb @ Xx3) = (ccfv @ XM @ ccvsca))) => ((Xc_x = (ccfv @ (ccfv @ XM @ ccsca) @ ccmulr)) => ((! [Xx3:$i] : ((XX @ Xx3) = (cco @ XA2 @ XV @ (ccfv @ XM @ cclinc)))) => ((XR = (ccfv @ (ccfv @ XM @ ccsca) @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (cco @ XS @ (ccfv @ (ccv @ Xx3) @ XA2) @ Xc_x))))) => (! [Xx3:$i] : ((cw3a @ ((cwcel @ XM @ cclmod) & (cwcel @ XV @ (ccpw @ (ccfv @ XM @ ccbs)))) @ ((cwcel @ XA2 @ (cco @ XR @ XV @ ccmap)) & (cwcel @ XS @ XR)) @ (cwbr @ XA2 @ (ccfv @ (ccfv @ XM @ ccsca) @ cc0g) @ ccfsupp)) => ((cco @ XS @ (XX @ Xx3) @ (Xc_xb @ Xx3)) = (cco @ (XF @ Xx3) @ XV @ (ccfv @ XM @ cclinc)))))))))))))))))))).
