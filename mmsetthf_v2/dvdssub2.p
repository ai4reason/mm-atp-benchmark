...
thf(cdvdssub2_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) & (cwbr @ XK @ (cco @ XM @ XN @ ccmin) @ ccdvds)) => ((cwbr @ XK @ XM @ ccdvds) <=> (cwbr @ XK @ XN @ ccdvds))))))).
