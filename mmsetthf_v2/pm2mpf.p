...
thf(apm2mpcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XC = (cco @ XN @ XP @ ccmat)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xc_as = (ccfv @ XQ @ ccvsca)) => ((Xc_ex = (ccfv @ (ccfv @ XQ @ ccmgp) @ ccmg)) => ((XX = (ccfv @ XA2 @ ccv1)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XQ = (ccfv @ XA2 @ ccpl1)) => ((XT = (cco @ XN @ XR @ ccpm2mp)) => ((XL = (ccfv @ XQ @ ccbs)) => ((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg) @ (cwcel @ XM @ XB2)) => (cwcel @ (ccfv @ XM @ XT) @ XL)))))))))))))))))))))))))).
