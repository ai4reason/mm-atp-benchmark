...
thf(a_1stcclb_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cc1stc) & (cwcel @ XA2 @ XX)) => (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) & (cwral @ (^ [Xy1:$i] : ((cwcel @ XA2 @ (ccv @ Xy1)) => (cwrex @ (^ [Xz:$i] : ((cwcel @ XA2 @ (ccv @ Xz)) & (cwss @ (ccv @ Xz) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccv @ Xx3))))) @ (^ [Xy1:$i] : XJ)))) @ (^ [Xx3:$i] : (ccpw @ XJ))))))))).
...
thf(afiinopn_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : ((cwcel @ XJ @ cctop) => ((cw3a @ (cwss @ XA2 @ XJ) @ (cwne @ XA2 @ cc0) @ (cwcel @ XA2 @ ccfn)) => (cwcel @ (ccint @ XA2) @ XJ)))))).
