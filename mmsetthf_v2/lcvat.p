...
thf(alrelat_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_po:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((XS = (ccfv @ XW @ cclss)) => ((! [Xq:$i] : ((Xc_po @ Xq) = (ccfv @ XW @ cclsm))) => ((XA2 = (ccfv @ XW @ cclsa)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XT @ XS)) => ((Xph => (cwcel @ XU @ XS)) => ((Xph => (cwpss @ XT @ XU)) => (Xph => (cwrex @ (^ [Xq:$i] : ((cwpss @ XT @ (cco @ XT @ (ccv @ Xq) @ (Xc_po @ Xq))) & (cwss @ (cco @ XT @ (ccv @ Xq) @ (Xc_po @ Xq)) @ XU))) @ (^ [Xq:$i] : XA2)))))))))))))))))).
...
thf(alcvnbtwn2_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XS = (ccfv @ XW @ cclss)) => ((XC = (ccfv @ XW @ cclcv)) => ((Xph => (cwcel @ XW @ XX)) => ((Xph => (cwcel @ XR @ XS)) => ((Xph => (cwcel @ XT @ XS)) => ((Xph => (cwcel @ XU @ XS)) => ((Xph => (cwbr @ XR @ XT @ XC)) => ((Xph => (cwpss @ XR @ XU)) => ((Xph => (cwss @ XU @ XT)) => (Xph => (XU = XT)))))))))))))))))))).
...
thf(clcvat_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [Xc_po:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((XS = (ccfv @ XW @ cclss)) => ((! [Xq:$i] : ((Xc_po @ Xq) = (ccfv @ XW @ cclsm))) => ((XA2 = (ccfv @ XW @ cclsa)) => ((! [Xq:$i] : ((XC @ Xq) = (ccfv @ XW @ cclcv))) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XT @ XS)) => ((Xph => (cwcel @ XU @ XS)) => ((! [Xq:$i] : (Xph => (cwbr @ XT @ XU @ (XC @ Xq)))) => (Xph => (cwrex @ (^ [Xq:$i] : ((cco @ XT @ (ccv @ Xq) @ (Xc_po @ Xq)) = XU)) @ (^ [Xq:$i] : XA2)))))))))))))))))))).
