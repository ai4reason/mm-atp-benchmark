...
thf(ainindif_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : ((ccin @ (ccin @ XA2 @ XC) @ (ccdif @ XA2 @ XC)) = cc0)))).
...
thf(cindsumin_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xk:$i] : (Xph => (cwcel @ XO @ (XV @ Xk)))) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwss @ XA2 @ XO)) => ((Xph => (cwss @ XB2 @ XO)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XC @ Xk) @ ccc))) => (Xph => ((ccsu @ XA2 @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccfv @ XB2 @ (ccfv @ XO @ ccind))) @ (XC @ Xk) @ ccmul))) = (ccsu @ (ccin @ XA2 @ XB2) @ (^ [Xk:$i] : (XC @ Xk))))))))))))))))).
