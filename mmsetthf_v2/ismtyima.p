...
thf(cismtyima_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cw3a @ (cwcel @ XM @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XN @ (ccfv @ XY @ ccxmt)) @ (cwcel @ XF @ (cco @ XM @ XN @ ccismty))) & ((cwcel @ XP @ XX) & (cwcel @ XR @ ccxr))) => ((ccima @ XF @ (cco @ XP @ XR @ (ccfv @ XM @ ccbl))) = (cco @ (ccfv @ XP @ XF) @ XR @ (ccfv @ XN @ ccbl)))))))))))).
