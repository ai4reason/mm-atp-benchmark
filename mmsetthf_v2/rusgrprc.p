...
thf(argrusgrprc_ax,axiom,(cwnel @ (ccrab @ (^ [Xg1:$i] : (cwral @ (^ [Xv:$i] : ((ccfv @ (ccv @ Xv) @ (ccfv @ (ccv @ Xg1) @ ccvtxdg)) = ccc0)) @ (^ [Xv:$i] : (ccfv @ (ccv @ Xg1) @ ccvtx)))) @ (^ [Xg1:$i] : ccusgr)) @ ccvv)).
...
thf(a_0xnn0_ax,axiom,(cwcel @ ccc0 @ ccxnn0)).
thf(ccrgr_tp,type,(ccrgr : ($i > $o))).
thf(aisrusgr0_ax,axiom,(! [XD:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xv:$i] : ((XV @ Xv) = (ccfv @ XG @ ccvtx))) => ((! [Xv:$i] : ((XD @ Xv) = (ccfv @ XG @ ccvtxdg))) => (! [Xv:$i] : (((cwcel @ XG @ (XW @ Xv)) & (cwcel @ XK @ (XZ @ Xv))) => ((cwbr @ XG @ XK @ ccrusgr) <=> (cw3a @ (cwcel @ XG @ ccusgr) @ (cwcel @ XK @ ccxnn0) @ (cwral @ (^ [Xv:$i] : ((ccfv @ (ccv @ Xv) @ (XD @ Xv)) = XK)) @ (^ [Xv:$i] : (XV @ Xv)))))))))))))))).
...
thf(crusgrprc_conj,conjecture,(cwnel @ (ccab @ (^ [Xg1:$i] : (cwbr @ (ccv @ Xg1) @ ccc0 @ ccrusgr))) @ ccvv)).
