...
thf(a_1p1times_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ (cco @ cc1 @ cc1 @ ccaddc) @ XA2 @ ccmul) = (cco @ XA2 @ XA2 @ ccaddc))))).
...
thf(aaddcan_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) => (((cco @ XA2 @ XB2 @ ccaddc) = (cco @ XA2 @ XC @ ccaddc)) <=> (XB2 = XC))))))).
thf(caddcom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ XA2 @ XB2 @ ccaddc) = (cco @ XB2 @ XA2 @ ccaddc)))))).
