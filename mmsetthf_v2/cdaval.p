...
thf(aunexb_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccvv) & (cwcel @ XB2 @ ccvv)) <=> (cwcel @ (ccun @ XA2 @ XB2) @ ccvv))))).
...
thf(adf_cda_ax,axiom,(cccda = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccun @ (ccxp @ (ccv @ Xx3) @ (ccsn @ cc0)) @ (ccxp @ (ccv @ Xy1) @ (ccsn @ cc1o)))))))).
thf(ccdaval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cco @ XA2 @ XB2 @ cccda) = (ccun @ (ccxp @ XA2 @ (ccsn @ cc0)) @ (ccxp @ XB2 @ (ccsn @ cc1o)))))))))).
