...
thf(abrfvrcld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (cwcel @ XR @ ccvv)) => (Xph => ((cwbr @ XA2 @ XB2 @ (ccfv @ XR @ ccrcl)) <=> ((cwbr @ XA2 @ XB2 @ (cco @ XR @ ccc0 @ ccrelexp)) | (cwbr @ XA2 @ XB2 @ (cco @ XR @ cc1 @ ccrelexp))))))))))).
...
thf(aresieq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XB2 @ XA2) & (cwcel @ XC @ XA2)) => ((cwbr @ XB2 @ XC @ (ccres @ ccid @ XA2)) <=> (XB2 = XC))))))).
thf(adf_3an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) <=> ((Xph & Xps) & Xch)))))).
thf(arelexp1d_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : ((Xph => (cwcel @ XR @ ccvv)) => (Xph => ((cco @ XR @ cc1 @ ccrelexp) = XR)))))).
thf(cbrfvrcld2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (cwcel @ XR @ ccvv)) => (Xph => ((cwbr @ XA2 @ XB2 @ (ccfv @ XR @ ccrcl)) <=> ((cw3a @ (cwcel @ XA2 @ (ccun @ (ccdm @ XR) @ (ccrn @ XR))) @ (cwcel @ XB2 @ (ccun @ (ccdm @ XR) @ (ccrn @ XR))) @ (XA2 = XB2)) | (cwbr @ XA2 @ XB2 @ XR)))))))))).
