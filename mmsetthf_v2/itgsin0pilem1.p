...
thf(citgsin0pilem1_conj,conjecture,(! [XC:($i > ($i > $o))] : ((! [Xt:$i] : ((XC @ Xt) = (ccmpt @ (^ [Xt:$i] : (cco @ ccc0 @ ccpi @ ccicc)) @ (^ [Xt:$i] : (ccneg @ (ccfv @ (ccv @ Xt) @ cccos)))))) => ((ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ ccsin))) = cc2)))).
