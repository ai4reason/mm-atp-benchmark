...
thf(afsn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwf @ (ccsn @ XA2) @ (ccsn @ XB2) @ XF) <=> (XF = (ccsn @ (ccop @ XA2 @ XB2)))))))))).
...
thf(afzsuc2_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ (ccfv @ (cco @ XM @ cc1 @ ccmin) @ ccuz))) => ((cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) = (ccun @ (cco @ XM @ XN @ ccfz) @ (ccsn @ (cco @ XN @ cc1 @ ccaddc)))))))).
...
thf(af1oexrnex_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwf1o @ XA2 @ XB2 @ XF) & (cwcel @ XB2 @ XV)) => (cwcel @ XF @ ccvv))))))).
