...
thf(adf_subg_ax,axiom,(ccsubg = (ccmpt @ (^ [Xw:$i] : ccgrp) @ (^ [Xw:$i] : (ccrab @ (^ [Xs1:$i] : (cwcel @ (cco @ (ccv @ Xw) @ (ccv @ Xs1) @ ccress) @ ccgrp)) @ (^ [Xs1:$i] : (ccpw @ (ccfv @ (ccv @ Xw) @ ccbs)))))))).
...
thf(cissubg_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((cwcel @ XS @ (ccfv @ XG @ ccsubg)) <=> (cw3a @ (cwcel @ XG @ ccgrp) @ (cwss @ XS @ XB2) @ (cwcel @ (cco @ XG @ XS @ ccress) @ ccgrp)))))))).
