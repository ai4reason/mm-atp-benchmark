...
thf(areflexg_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ (ccres @ ccid @ (ccun @ (ccdm @ XA2) @ (ccrn @ XA2))) @ XA2) <=> (! [Xx3:$i] : (! [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XA2) => ((cwbr @ (ccv @ Xx3) @ (ccv @ Xx3) @ XA2) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xy1) @ XA2)))))))).
thf(cwrel_tp,type,(cwrel : (($i > $o) > $o))).
thf(acnvssco_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ (cccnv @ XA2) @ (cccnv @ (cccom @ XB2 @ XC))) <=> (! [Xx3:$i] : (! [Xy1:$i] : (? [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XA2) => ((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ XC) & (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ XB2))))))))))).
thf(crefimssco_conj,conjecture,(! [XA2:($i > $o)] : ((cwss @ (ccres @ ccid @ (ccun @ (ccdm @ XA2) @ (ccrn @ XA2))) @ XA2) => (cwss @ (cccnv @ XA2) @ (cccnv @ (cccom @ XA2 @ XA2)))))).
