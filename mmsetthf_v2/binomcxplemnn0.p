...
thf(abccbc_ax,axiom,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XK @ ccn0)) => (Xph => ((cco @ XN @ XK @ ccbcc) = (cco @ XN @ XK @ ccbc))))))))).
...
thf(cbinomcxplemnn0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ (ccfv @ XB2 @ ccabs) @ (ccfv @ XA2 @ ccabs) @ cclt)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph & (cwcel @ XC @ ccn0)) => ((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ cccxp) = (ccsu @ ccn0 @ (^ [Xk:$i] : (cco @ (cco @ XC @ (ccv @ Xk) @ ccbcc) @ (cco @ (cco @ XA2 @ (cco @ XC @ (ccv @ Xk) @ ccmin) @ cccxp) @ (cco @ XB2 @ (ccv @ Xk) @ ccexp) @ ccmul) @ ccmul)))))))))))))).
