...
thf(acirclemeth_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XS @ ccn)) => ((Xph => (cwf @ (cco @ ccc0 @ XS @ ccfzo) @ (cco @ ccc @ ccn @ ccmap) @ XL)) => (Xph => ((ccsu @ (cco @ ccn @ XN @ (ccfv @ XS @ ccrepr)) @ (^ [Xc:$i] : (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xa) @ XL)))))) = (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccv @ Xx3) @ (cco @ (ccfv @ (ccv @ Xa) @ XL) @ XN @ ccvts)))) @ (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (cco @ (ccneg @ XN) @ (ccv @ Xx3) @ ccmul) @ ccmul) @ cce) @ ccmul))))))))))))).
thf(aa1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(a_3nn_ax,axiom,(cwcel @ cc3 @ ccn)).
thf(ccword_tp,type,(ccword : (($i > $o) > ($i > $o)))).
thf(awrdfd_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (XN = (ccfv @ XW @ cchash))) => ((Xph => (cwcel @ XW @ (ccword @ XS))) => (Xph => (cwf @ (cco @ ccc0 @ XN @ ccfzo) @ XS @ XW))))))))).
thf(aeqcomi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 = XB2) => (XB2 = XA2))))).
thf(ccs2_tp,type,(ccs2 : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(as3len_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccfv @ (ccs3 @ XA2 @ XB2 @ XC) @ cchash) = cc3))))).
thf(as3cld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ XX)) => ((Xph => (cwcel @ XB2 @ XX)) => ((Xph => (cwcel @ XC @ XX)) => (Xph => (cwcel @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccword @ XX)))))))))))).
...
thf(aprodfzo03_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : ((! [Xk:$i] : (((ccv @ Xk) = ccc0) => ((XD @ Xk) = XA2))) => ((! [Xk:$i] : (((ccv @ Xk) = cc1) => ((XD @ Xk) = XB2))) => ((! [Xk:$i] : (((ccv @ Xk) = cc2) => ((XD @ Xk) = XC))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ ccc0 @ cc3 @ ccfzo))) => (cwcel @ (XD @ Xk) @ ccc))) => (Xph => ((ccprod @ (^ [Xk:$i] : (cco @ ccc0 @ cc3 @ ccfzo)) @ (^ [Xk:$i] : (XD @ Xk))) = (cco @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ ccmul))))))))))))).
...
thf(aelfznelfzob_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : ((cwcel @ XM @ (cco @ ccc0 @ XK @ ccfz)) => ((~ (cwcel @ XM @ (cco @ cc1 @ XK @ ccfzo))) <=> ((XM = ccc0) | (XM = XK))))))).
thf(avtscl_ax,axiom,(! [Xph:$o] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (cwf @ ccn @ ccc @ XL)) => (Xph => (cwcel @ (ccfv @ XX @ (cco @ XL @ XN @ ccvts)) @ ccc)))))))))).
...
thf(afzo0sn0fzo1_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cco @ ccc0 @ XN @ ccfzo) = (ccun @ (ccsn @ ccc0) @ (cco @ cc1 @ XN @ ccfzo)))))).
...
thf(ahashfzo_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ (ccfv @ XA2 @ ccuz)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccfzo) @ cchash) = (cco @ XB2 @ XA2 @ ccmin)))))).
