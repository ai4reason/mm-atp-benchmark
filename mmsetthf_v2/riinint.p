...
thf(adfiin3g_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ (XC @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cciin @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (ccint @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))))).
...
thf(criinint_conj,conjecture,(! [XS:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ XV) & (cwral @ (^ [Xk:$i] : (cwss @ (XS @ Xk) @ XX)) @ (^ [Xk:$i] : (XI @ Xk)))) => ((ccin @ XX @ (cciin @ (^ [Xk:$i] : (XI @ Xk)) @ (^ [Xk:$i] : (XS @ Xk)))) = (ccint @ (ccun @ (ccsn @ XX) @ (ccrn @ (ccmpt @ (^ [Xk:$i] : (XI @ Xk)) @ (^ [Xk:$i] : (XS @ Xk))))))))))))).
