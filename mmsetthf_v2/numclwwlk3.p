...
thf(aclwwlknonfin_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XV @ ccfn) => (cwcel @ (cco @ XX @ XN @ (ccfv @ XG @ ccclwwlknon)) @ ccfn)))))))).
...
thf(anumclwlk3lem3_ax,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccc) @ (cwcel @ XY @ ccc) @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz))) => ((cco @ (cco @ (cco @ XK @ (cco @ XN @ cc2 @ ccmin) @ ccexp) @ XY @ ccmin) @ (cco @ XK @ XY @ ccmul) @ ccaddc) = (cco @ (cco @ (cco @ XK @ cc1 @ ccmin) @ XY @ ccmul) @ (cco @ XK @ (cco @ XN @ cc2 @ ccmin) @ ccexp) @ ccaddc))))))).
thf(cnumclwwlk3_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((((cwbr @ XG @ XK @ ccrusgr) & (cwcel @ XG @ ccfrgr)) & (cw3a @ (cwcel @ XV @ ccfn) @ (cwcel @ XX @ XV) @ (cwcel @ XN @ (ccfv @ cc3 @ ccuz)))) => ((ccfv @ (cco @ XX @ XN @ (ccfv @ XG @ ccclwwlknon)) @ cchash) = (cco @ (cco @ (cco @ XK @ cc1 @ ccmin) @ (ccfv @ (cco @ XX @ (cco @ XN @ cc2 @ ccmin) @ (ccfv @ XG @ ccclwwlknon)) @ cchash) @ ccmul) @ (cco @ XK @ (cco @ XN @ cc2 @ ccmin) @ ccexp) @ ccaddc)))))))))).
