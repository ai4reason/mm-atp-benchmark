...
thf(arelexpaddd_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwrel @ XR)) => ((Xph => (cwcel @ XR @ ccvv)) => (Xph => (((cwcel @ XN @ ccn0) & (cwcel @ XM @ ccn0)) => ((cccom @ (cco @ XR @ XN @ ccrelexp) @ (cco @ XR @ XM @ ccrelexp)) = (cco @ XR @ (cco @ XN @ XM @ ccaddc) @ ccrelexp))))))))))).
...
thf(crtrclreclem3_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : ((Xph => (cwrel @ XR)) => ((Xph => (cwcel @ XR @ ccvv)) => (Xph => (cwss @ (cccom @ (ccfv @ XR @ ccrtrcl) @ (ccfv @ XR @ ccrtrcl)) @ (ccfv @ XR @ ccrtrcl)))))))).
