...
thf(acardprclem_ax,axiom,(! [XA2:($i > $o)] : ((XA2 = (ccab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cccrd) = (ccv @ Xx3))))) => (~ (cwcel @ XA2 @ ccvv))))).
...
thf(ccardprc_conj,conjecture,(cwnel @ (ccab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cccrd) = (ccv @ Xx3)))) @ ccvv)).
