...
thf(acongr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XM @ ccn)) => (((cco @ XA2 @ XM @ ccmo) = (cco @ XB2 @ XM @ ccmo)) <=> (cwrex @ (^ [Xn:$i] : ((cco @ (ccv @ Xn) @ XM @ ccmul) = (cco @ XA2 @ XB2 @ ccmin))) @ (^ [Xn:$i] : ccz)))))))).
...
thf(adivgcdcoprmex_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ ((cwcel @ XB2 @ ccz) & (cwne @ XB2 @ ccc0)) @ (XM = (cco @ XA2 @ XB2 @ ccgcd))) => (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cw3a @ (XA2 = (cco @ XM @ (ccv @ Xa) @ ccmul)) @ (XB2 = (cco @ XM @ (ccv @ Xb) @ ccmul)) @ ((cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccgcd) = cc1))) @ (^ [Xb:$i] : ccz))) @ (^ [Xa:$i] : ccz))))))).
...
thf(agcd2n0cl_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwne @ XN @ ccc0)) => (cwcel @ (cco @ XM @ XN @ ccgcd) @ ccn))))).
...
thf(adivgcdnnr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccz)) => (cwcel @ (cco @ XA2 @ (cco @ XB2 @ XA2 @ ccgcd) @ ccdiv) @ ccn))))).
...
thf(ccncongr1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz)) & ((cwcel @ XN @ ccn) & (XM = (cco @ XN @ (cco @ XC @ XN @ ccgcd) @ ccdiv)))) => (((cco @ (cco @ XA2 @ XC @ ccmul) @ XN @ ccmo) = (cco @ (cco @ XB2 @ XC @ ccmul) @ XN @ ccmo)) => ((cco @ XA2 @ XM @ ccmo) = (cco @ XB2 @ XM @ ccmo)))))))))).
