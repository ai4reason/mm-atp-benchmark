...
thf(aarchiabllem1b_ax,axiom,(! [Xph:$o] : (! [Xy1:$i] : (! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((! [Xn:$i] : ((Xc_le @ Xn) = (ccfv @ XW @ ccple))) => ((Xc_lt = (ccfv @ XW @ ccplt)) => ((Xc_x = (ccfv @ XW @ ccmg)) => ((Xph => (cwcel @ XW @ ccogrp)) => ((Xph => (cwcel @ XW @ ccarchi)) => ((Xph => (cwcel @ XU @ XB2)) => ((Xph => (cwbr @ Xc_0 @ XU @ Xc_lt)) => ((! [Xx3:$i] : (! [Xn:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwbr @ Xc_0 @ (ccv @ Xx3) @ Xc_lt)) => (cwbr @ XU @ (ccv @ Xx3) @ (Xc_le @ Xn))))) => ((Xph & (cwcel @ (ccv @ Xy1) @ XB2)) => (cwrex @ (^ [Xn:$i] : ((ccv @ Xy1) = (cco @ (ccv @ Xn) @ XU @ Xc_x))) @ (^ [Xn:$i] : ccz))))))))))))))))))))))).
thf(aadantrr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => ((Xph & (Xps & Xth)) => Xch))))))).
thf(ccmnd_tp,type,(ccmnd : ($i > $o))).
thf(cccmn_tp,type,(cccmn : ($i > $o))).
thf(aisabl2_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_pl @ Xx3 @ Xy1) = (ccfv @ XG @ ccplusg)))) => ((cwcel @ XG @ ccabl) <=> ((cwcel @ XG @ ccgrp) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_pl @ Xx3 @ Xy1)) = (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (Xc_pl @ Xx3 @ Xy1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)))))))))).
thf(carchiabllem1_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((Xc_le = (ccfv @ XW @ ccple)) => ((Xc_lt = (ccfv @ XW @ ccplt)) => ((Xc_x = (ccfv @ XW @ ccmg)) => ((Xph => (cwcel @ XW @ ccogrp)) => ((Xph => (cwcel @ XW @ ccarchi)) => ((Xph => (cwcel @ XU @ XB2)) => ((Xph => (cwbr @ Xc_0 @ XU @ Xc_lt)) => ((! [Xx3:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwbr @ Xc_0 @ (ccv @ Xx3) @ Xc_lt)) => (cwbr @ XU @ (ccv @ Xx3) @ Xc_le))) => (Xph => (cwcel @ XW @ ccabl))))))))))))))))))))).
