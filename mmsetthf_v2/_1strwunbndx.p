...
thf(c_1strwunbndx_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((XG = (ccsn @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2))) => ((Xph => (cwcel @ XU @ ccwun)) => ((Xph => (cwcel @ (ccfv @ ccnx @ ccbs) @ XU)) => ((Xph & (cwcel @ XB2 @ XU)) => (cwcel @ XG @ XU)))))))))).
