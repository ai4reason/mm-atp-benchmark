...
thf(aeleigvec_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((cwcel @ XA2 @ (ccfv @ XT @ ccei)) <=> (cw3a @ (cwcel @ XA2 @ cchil) @ (cwne @ XA2 @ cc0v) @ (cwrex @ (^ [Xx3:$i] : ((ccfv @ XA2 @ XT) = (cco @ (ccv @ Xx3) @ XA2 @ ccsm))) @ (^ [Xx3:$i] : ccc)))))))).
...
thf(celeigvec2_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((cwcel @ XA2 @ (ccfv @ XT @ ccei)) <=> (cw3a @ (cwcel @ XA2 @ cchil) @ (cwne @ XA2 @ cc0v) @ (cwcel @ (ccfv @ XA2 @ XT) @ (ccfv @ (ccsn @ XA2) @ ccspn)))))))).
