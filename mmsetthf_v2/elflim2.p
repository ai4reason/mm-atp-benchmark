...
thf(aflimval_ax,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwcel @ XF @ (ccuni @ (ccrn @ ccfil)))) => ((cco @ XJ @ XF @ ccflim) = (ccrab @ (^ [Xx3:$i] : ((cwss @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)) @ XF) & (cwss @ XF @ (ccpw @ XX)))) @ (^ [Xx3:$i] : XX))))))))).
...
thf(celflim2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim)) <=> ((cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XF @ (ccuni @ (ccrn @ ccfil))) @ (cwss @ XF @ (ccpw @ XX))) & ((cwcel @ XA2 @ XX) & (cwss @ (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ ccnei)) @ XF)))))))))).
