...
thf(admiun_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((ccdm @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) = (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (ccdm @ (XB2 @ Xx3)))))))).
...
thf(adprd2db_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : ((Xph => (cwrel @ XA2)) => ((Xph => (cwf @ XA2 @ (ccfv @ XG @ ccsubg) @ XS)) => ((! [Xj:$i] : (Xph => (cwss @ (ccdm @ XA2) @ (XI @ Xj)))) => ((! [Xi:$i] : (! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ (XI @ Xj))) => (cwbr @ XG @ (ccmpt @ (^ [Xj:$i] : (ccima @ XA2 @ (ccsn @ (ccv @ Xi)))) @ (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XS))) @ (ccdm @ ccdprd))))) => ((! [Xj:$i] : (Xph => (cwbr @ XG @ (ccmpt @ (^ [Xi:$i] : (XI @ Xj)) @ (^ [Xi:$i] : (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (ccima @ XA2 @ (ccsn @ (ccv @ Xi)))) @ (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XS))) @ ccdprd))) @ (ccdm @ ccdprd)))) => ((! [Xj:$i] : ((XK @ Xj) = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc))) => (! [Xj:$i] : (Xph => ((cco @ XG @ XS @ ccdprd) = (cco @ XG @ (ccmpt @ (^ [Xi:$i] : (XI @ Xj)) @ (^ [Xi:$i] : (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (ccima @ XA2 @ (ccsn @ (ccv @ Xi)))) @ (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XS))) @ ccdprd))) @ ccdprd))))))))))))))))).
thf(aeqtr3d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XA2 = XC)) => (Xph => (XB2 = XC))))))))).
thf(cdprd2d2_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((! [Xi:$i] : (! [Xj:$i] : ((Xph & ((cwcel @ (ccv @ Xi) @ XI) & (cwcel @ (ccv @ Xj) @ (XJ @ Xi)))) => (cwcel @ (XS @ Xi @ Xj) @ (ccfv @ XG @ ccsubg))))) => ((! [Xi:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ XI)) => (cwbr @ XG @ (ccmpt @ (^ [Xj:$i] : (XJ @ Xi)) @ (^ [Xj:$i] : (XS @ Xi @ Xj))) @ (ccdm @ ccdprd)))) => ((Xph => (cwbr @ XG @ (ccmpt @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (XJ @ Xi)) @ (^ [Xj:$i] : (XS @ Xi @ Xj))) @ ccdprd))) @ (ccdm @ ccdprd))) => (Xph => ((cwbr @ XG @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XI)) @ (^ [Xi:$i] : (^ [Xj:$i] : (XJ @ Xi))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XS @ Xi @ Xj)))) @ (ccdm @ ccdprd)) & ((cco @ XG @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XI)) @ (^ [Xi:$i] : (^ [Xj:$i] : (XJ @ Xi))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XS @ Xi @ Xj)))) @ ccdprd) = (cco @ XG @ (ccmpt @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (XJ @ Xi)) @ (^ [Xj:$i] : (XS @ Xi @ Xj))) @ ccdprd))) @ ccdprd))))))))))))).
