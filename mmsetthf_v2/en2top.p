...
thf(asdom2en01_ax,axiom,(! [XA2:($i > $o)] : ((cwbr @ XA2 @ cc2o @ ccsdm) <=> ((XA2 = cc0) | (cwbr @ XA2 @ cc1o @ ccen))))).
...
thf(aen2eqpr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwbr @ XC @ cc2o @ ccen) @ (cwcel @ XA2 @ XC) @ (cwcel @ XB2 @ XC)) => ((cwne @ XA2 @ XB2) => (XC = (ccpr @ XA2 @ XB2)))))))).
...
thf(cen2top_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XX @ cctopon)) => ((cwbr @ XJ @ cc2o @ ccen) <=> ((XJ = (ccpr @ cc0 @ XX)) & (cwne @ XX @ cc0))))))).
