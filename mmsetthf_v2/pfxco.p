...
thf(aswrdco_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XA2)) @ ((cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) @ (cwf @ XA2 @ XB2 @ XF)) => ((cccom @ XF @ (cco @ XW @ (ccop @ XM @ XN) @ ccsubstr)) = (cco @ (cccom @ XF @ XW) @ (ccop @ XM @ XN) @ ccsubstr)))))))))).
...
thf(cpfxco_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XA2)) @ (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz)) @ (cwf @ XA2 @ XB2 @ XF)) => ((cccom @ XF @ (cco @ XW @ XN @ ccpfx)) = (cco @ (cccom @ XF @ XW) @ XN @ ccpfx))))))))).
