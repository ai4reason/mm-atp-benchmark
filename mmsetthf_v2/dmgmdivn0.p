...
thf(cdmgmdivn0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn)))) => ((Xph => (cwcel @ XM @ ccn)) => (Xph => (cwne @ (cco @ (cco @ XA2 @ XM @ ccdiv) @ cc1 @ ccaddc) @ ccc0)))))))).
