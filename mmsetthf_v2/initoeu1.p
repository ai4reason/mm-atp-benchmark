...
thf(a_2initoinv_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XC @ ccinito))) => ((Xph => (cwcel @ XB2 @ (ccfv @ XC @ ccinito))) => ((cw3a @ Xph @ (cwcel @ XG @ (cco @ XB2 @ XA2 @ (ccfv @ XC @ cchom))) @ (cwcel @ XF @ (cco @ XA2 @ XB2 @ (ccfv @ XC @ cchom)))) => (cwbr @ XF @ XG @ (cco @ XA2 @ XB2 @ (ccfv @ XC @ ccinv)))))))))))))).
...
thf(cinitoeu1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XC @ ccinito))) => ((Xph => (cwcel @ XB2 @ (ccfv @ XC @ ccinito))) => (Xph => (cweu @ (^ [Xf1:$i] : (cwcel @ (ccv @ Xf1) @ (cco @ XA2 @ XB2 @ (ccfv @ XC @ cciso)))))))))))))).
