...
thf(cllni_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XC = (ccfv @ XK @ cccvr)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XN = (ccfv @ XK @ cclln)) => (((cw3a @ (cwcel @ XK @ XD) @ (cwcel @ XX @ XB2) @ (cwcel @ XP @ XA2)) & (cwbr @ XP @ XX @ XC)) => (cwcel @ XX @ XN))))))))))))))).
