...
thf(azeqzmulgcd_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => (cwrex @ (^ [Xn:$i] : (XA2 = (cco @ (ccv @ Xn) @ (cco @ XA2 @ XB2 @ ccgcd) @ ccmul))) @ (^ [Xn:$i] : ccz)))))).
...
thf(adivgcdcoprm0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwne @ XB2 @ ccc0)) => ((cco @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv) @ (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv) @ ccgcd) = cc1))))).
thf(aeqeq1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((XA2 = XC) <=> (XB2 = XC))))))))).
thf(aoveq12_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (((XA2 = XB2) & (XC = XD)) => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XD @ XF))))))))).
thf(cdivgcdcoprmex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ ((cwcel @ XB2 @ ccz) & (cwne @ XB2 @ ccc0)) @ (XM = (cco @ XA2 @ XB2 @ ccgcd))) => (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cw3a @ (XA2 = (cco @ XM @ (ccv @ Xa) @ ccmul)) @ (XB2 = (cco @ XM @ (ccv @ Xb) @ ccmul)) @ ((cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccgcd) = cc1))) @ (^ [Xb:$i] : ccz))) @ (^ [Xa:$i] : ccz))))))).
