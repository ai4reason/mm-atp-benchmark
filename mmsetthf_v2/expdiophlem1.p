...
thf(ajm3_1_ax,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XK @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccn)) & (cwbr @ (cco @ XK @ (cco @ XN @ cc1 @ ccaddc) @ ccrmy) @ XA2 @ ccle)) => ((cco @ XK @ XN @ ccexp) = (cco @ (cco @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ (cco @ XA2 @ XK @ ccmin) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul) @ ccmin) @ (cco @ (cco @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ XK @ ccmul) @ (cco @ XK @ cc2 @ ccexp) @ ccmin) @ cc1 @ ccmin) @ ccmo))))))).
...
thf(ajm3_1lem3_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz))) => ((Xph => (cwcel @ XK @ (ccfv @ cc2 @ ccuz))) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwbr @ (cco @ XK @ (cco @ XN @ cc1 @ ccaddc) @ ccrmy) @ XA2 @ ccle)) => (Xph => (cwcel @ (cco @ (cco @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ XK @ ccmul) @ (cco @ XK @ cc2 @ ccexp) @ ccmin) @ cc1 @ ccmin) @ ccn))))))))))).
thf(asimpl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xph)))).
thf(adivalgmodcl_ax,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XD @ ccn) @ (cwcel @ XR @ ccn0)) => ((XR = (cco @ XN @ XD @ ccmo)) <=> ((cwbr @ XR @ XD @ cclt) & (cwbr @ XD @ (cco @ XN @ XR @ ccmin) @ ccdvds)))))))).
thf(a_3bitrrd_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => (Xps <=> Xch)) => ((Xph => (Xch <=> Xth)) => ((Xph => (Xth <=> Xta)) => (Xph => (Xta <=> Xps))))))))))).
thf(armynn0_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccn0)) => (cwcel @ (cco @ XA2 @ XN @ ccrmy) @ ccn0))))).
...
thf(cexpdiophlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccn0) => ((((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XB2 @ ccn)) & (XC = (cco @ XA2 @ XB2 @ ccexp))) <=> (cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xe:$i] : (cwrex @ (^ [Xf1:$i] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XB2 @ ccn)) & (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & ((ccv @ Xd) = (cco @ XA2 @ (cco @ XB2 @ cc1 @ ccaddc) @ ccrmy))) & (((cwcel @ (ccv @ Xd) @ (ccfv @ cc2 @ ccuz)) & ((ccv @ Xe) = (cco @ (ccv @ Xd) @ XB2 @ ccrmy))) & (((cwcel @ (ccv @ Xd) @ (ccfv @ cc2 @ ccuz)) & ((ccv @ Xf1) = (cco @ (ccv @ Xd) @ XB2 @ ccrmx))) & ((cwbr @ XC @ (cco @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xd) @ ccmul) @ XA2 @ ccmul) @ (cco @ XA2 @ cc2 @ ccexp) @ ccmin) @ cc1 @ ccmin) @ cclt) & (cwbr @ (cco @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xd) @ ccmul) @ XA2 @ ccmul) @ (cco @ XA2 @ cc2 @ ccexp) @ ccmin) @ cc1 @ ccmin) @ (cco @ (cco @ (ccv @ Xf1) @ (cco @ (cco @ (ccv @ Xd) @ XA2 @ ccmin) @ (ccv @ Xe) @ ccmul) @ ccmin) @ XC @ ccmin) @ ccdvds))))))) @ (^ [Xf1:$i] : ccn0))) @ (^ [Xe:$i] : ccn0))) @ (^ [Xd:$i] : ccn0)))))))).
