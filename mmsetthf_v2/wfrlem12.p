...
thf(afnop_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XA2) & (cwcel @ (ccop @ XB2 @ XC) @ XF)) => (cwcel @ XB2 @ XA2))))))).
...
thf(cwfrlem12_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((! [Xy1:$i] : ((XF @ Xy1) = (ccwrecs @ XA2 @ XR @ XG))) => (! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ (ccdm @ (XF @ Xy1))) => ((ccfv @ (ccv @ Xy1) @ (XF @ Xy1)) = (ccfv @ (ccres @ (XF @ Xy1) @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ XG)))))))))))).
