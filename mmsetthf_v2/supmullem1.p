...
thf(csupmullem1_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xb:$i] : ((XC @ Xy1 @ Xz @ Xv @ Xb) = (ccab @ (^ [Xz:$i] : (cwrex @ (^ [Xv:$i] : (cwrex @ (^ [Xb:$i] : ((ccv @ Xz) = (cco @ (ccv @ Xv) @ (ccv @ Xb) @ ccmul))) @ (^ [Xb:$i] : XB2))) @ (^ [Xv:$i] : XA2))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : ((Xph @ Xx3 @ Xy1 @ Xv) <=> (cw3a @ ((cwral @ (^ [Xx3:$i] : (cwbr @ ccc0 @ (ccv @ Xx3) @ ccle)) @ (^ [Xx3:$i] : XA2)) & (cwral @ (^ [Xx3:$i] : (cwbr @ ccc0 @ (ccv @ Xx3) @ ccle)) @ (^ [Xx3:$i] : XB2))) @ (cw3a @ (cwss @ XA2 @ ccr) @ (cwne @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr))) @ (cw3a @ (cwss @ XB2 @ ccr) @ (cwne @ XB2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : ccr)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xb:$i] : ((Xph @ Xx3 @ Xy1 @ Xv) => (cwral @ (^ [Xw:$i] : (cwbr @ (ccv @ Xw) @ (cco @ (ccsup @ XA2 @ ccr @ cclt) @ (ccsup @ XB2 @ ccr @ cclt) @ ccmul) @ ccle)) @ (^ [Xw:$i] : (XC @ Xy1 @ Xz @ Xv @ Xb)))))))))))))))).
