...
thf(acnfldsrngbas_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((XR = (cco @ cccnfld @ XS @ ccress)) => ((cwss @ XS @ ccc) => (XS = (ccfv @ XR @ ccbs))))))).
...
thf(cnnsgrpmgm_conj,conjecture,(! [XM:($i > $o)] : ((XM = (cco @ cccnfld @ ccn @ ccress)) => (cwcel @ XM @ ccmgm)))).
