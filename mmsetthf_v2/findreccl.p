...
thf(afindfvcl_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ (ccfv @ cc0 @ XF) @ XP)) => ((! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ ccom) => (Xph => ((cwcel @ (ccfv @ (ccv @ Xy1) @ XF) @ XP) => (cwcel @ (ccfv @ (ccsuc @ (ccv @ Xy1)) @ XF) @ XP))))) => (! [Xy1:$i] : ((cwcel @ (XA2 @ Xy1) @ ccom) => (Xph => (cwcel @ (ccfv @ (XA2 @ Xy1) @ XF) @ XP))))))))))).
thf(ampd_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => (Xps => Xch)) => (Xph => Xch))))))).
thf(ardg0g_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ XC) => ((ccfv @ cc0 @ (ccrdg @ XF @ XA2)) = XA2)))))).
...
thf(cfindreccl_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : ((! [Xz:$i] : ((cwcel @ (ccv @ Xz) @ XP) => (cwcel @ (ccfv @ (ccv @ Xz) @ XG) @ XP))) => (! [Xz:$i] : ((cwcel @ (XC @ Xz) @ ccom) => ((cwcel @ XA2 @ XP) => (cwcel @ (ccfv @ (XC @ Xz) @ (ccrdg @ XG @ XA2)) @ XP)))))))))).
