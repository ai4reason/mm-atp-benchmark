...
thf(as3wwlks2on_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xf1:$i] : ((XV @ Xf1) = (ccfv @ XG @ ccvtx))) => (! [Xf1:$i] : ((cw3a @ (cwcel @ XG @ ccupgr) @ (cwcel @ XA2 @ (XV @ Xf1)) @ (cwcel @ XC @ (XV @ Xf1))) => ((cwcel @ (ccs3 @ XA2 @ XB2 @ XC) @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwlksnon))) <=> (? [Xf1:$i] : ((cwbr @ (ccv @ Xf1) @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccfv @ XG @ ccwlks)) & ((ccfv @ (ccv @ Xf1) @ cchash) = cc2))))))))))))).
...
thf(aupgr2wlk_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XG @ cciedg)) => ((cwcel @ XG @ ccupgr) => (((cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) & ((ccfv @ XF @ cchash) = cc2)) <=> (cw3a @ (cwf @ (cco @ ccc0 @ cc2 @ ccfzo) @ (ccdm @ XI) @ XF) @ (cwf @ (cco @ ccc0 @ cc2 @ ccfz) @ XV @ XP) @ (((ccfv @ (ccfv @ ccc0 @ XF) @ XI) = (ccpr @ (ccfv @ ccc0 @ XP) @ (ccfv @ cc1 @ XP))) & ((ccfv @ (ccfv @ cc1 @ XF) @ XI) = (ccpr @ (ccfv @ cc1 @ XP) @ (ccfv @ cc2 @ XP))))))))))))))).
...
thf(cumgrwwlks2on_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ ccumgr) & (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XV))) => ((cwcel @ (ccs3 @ XA2 @ XB2 @ XC) @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwlksnon))) <=> ((cwcel @ (ccpr @ XA2 @ XB2) @ XE) & (cwcel @ (ccpr @ XB2 @ XC) @ XE))))))))))))).
