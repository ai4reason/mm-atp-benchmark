...
thf(clautle_conj,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XI = (ccfv @ XK @ cclaut)) => ((((cwcel @ XK @ XV) & (cwcel @ XF @ XI)) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2))) => ((cwbr @ XX @ XY @ Xc_le) <=> (cwbr @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ Xc_le))))))))))))))).
