...
thf(asbgoldbb_ax,axiom,((cwral @ (^ [Xn:$i] : ((cwbr @ cc4 @ (ccv @ Xn) @ cclt) => (cwcel @ (ccv @ Xn) @ ccgbe))) @ (^ [Xn:$i] : cceven)) => (cwral @ (^ [Xn:$i] : ((cwbr @ cc2 @ (ccv @ Xn) @ cclt) => (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : ((ccv @ Xn) = (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccaddc))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime)))) @ (^ [Xn:$i] : cceven)))).
...
thf(aemee_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cceven) & (cwcel @ XB2 @ cceven)) => (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ cceven))))).
...
thf(csgoldbeven3prm_conj,conjecture,(! [XN:($i > $o)] : ((cwral @ (^ [Xn:$i] : ((cwbr @ cc4 @ (ccv @ Xn) @ cclt) => (cwcel @ (ccv @ Xn) @ ccgbe))) @ (^ [Xn:$i] : cceven)) => (((cwcel @ XN @ cceven) & (cwbr @ cc6 @ XN @ ccle)) => (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : (XN = (cco @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccaddc) @ (ccv @ Xr) @ ccaddc))) @ (^ [Xr:$i] : ccprime))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime)))))).
