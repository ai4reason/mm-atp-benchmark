...
thf(cinintabd_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xw) => (? [Xx3:$i] : (Xps @ Xx3))))) => (! [Xx3:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xw) => ((ccin @ XA2 @ (ccint @ (ccab @ (^ [Xx3:$i] : (Xps @ Xx3))))) = (ccint @ (ccrab @ (^ [Xw:$i] : (? [Xx3:$i] : (((ccv @ Xw) = (ccin @ XA2 @ (ccv @ Xx3))) & (Xps @ Xx3)))) @ (^ [Xw:$i] : (ccpw @ XA2))))))))))))).
