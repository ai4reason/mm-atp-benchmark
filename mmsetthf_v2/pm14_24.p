...
thf(apm14_12_ax,axiom,(! [Xph:($i > $o)] : ((cweu @ (^ [Xx3:$i] : (Xph @ Xx3))) => (! [Xx3:$i] : (! [Xy1:$i] : (((Xph @ Xx3) & (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (ccv @ Xy1))) => ((ccv @ Xx3) = (ccv @ Xy1)))))))).
thf(aadantl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xch & Xph) => Xps)))))).
thf(apm13_13b_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [Xx3:$i] : (((cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (XA2 @ Xx3)) & ((ccv @ Xx3) = (XA2 @ Xx3))) => (Xph @ Xx3)))))).
...
thf(cpm14_24_conj,conjecture,(! [Xph:($i > $o)] : ((cweu @ (^ [Xx3:$i] : (Xph @ Xx3))) => (! [Xy1:$i] : ((cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (ccv @ Xy1)) <=> ((ccv @ Xy1) = (ccio @ (^ [Xx3:$i] : (Xph @ Xx3))))))))).
