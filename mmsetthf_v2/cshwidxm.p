...
thf(ccshwidxm_conj,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ (cco @ cc1 @ (ccfv @ XW @ cchash) @ ccfz))) => ((ccfv @ (cco @ (ccfv @ XW @ cchash) @ XN @ ccmin) @ (cco @ XW @ XN @ cccsh)) = (ccfv @ ccc0 @ XW))))))).
