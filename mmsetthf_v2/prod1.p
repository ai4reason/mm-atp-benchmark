...
thf(aprodfclim1_ax,axiom,(! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((cwcel @ XM @ ccz) => (cwbr @ (ccseq @ ccmul @ (ccxp @ XZ @ (ccsn @ cc1)) @ XM) @ cc1 @ ccli)))))).
...
thf(aprodf1_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((cwcel @ XN @ XZ) => ((ccfv @ XN @ (ccseq @ ccmul @ (ccxp @ XZ @ (ccsn @ cc1)) @ XM)) = cc1))))))).
thf(annuz_ax,axiom,(ccn = (ccfv @ cc1 @ ccuz))).
thf(cprod1_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (((cwss @ XA2 @ (ccfv @ XM @ ccuz)) | (cwcel @ XA2 @ ccfn)) => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : cc1)) = cc1))))).
