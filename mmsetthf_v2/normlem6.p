...
thf(adiscr_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwbr @ ccc0 @ (cco @ (cco @ (cco @ XA2 @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccmul) @ (cco @ XB2 @ (ccv @ Xx3) @ ccmul) @ ccaddc) @ XC @ ccaddc) @ ccle))) => (Xph => (cwbr @ (cco @ (cco @ XB2 @ cc2 @ ccexp) @ (cco @ cc4 @ (cco @ XA2 @ XC @ ccmul) @ ccmul) @ ccmin) @ ccc0 @ ccle))))))))))).
...
thf(anormlem5_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XS @ ccc) => ((cwcel @ XF @ cchil) => ((cwcel @ XG @ cchil) => ((XB2 = (ccneg @ (cco @ (cco @ (ccfv @ XS @ cccj) @ (cco @ XF @ XG @ ccsp) @ ccmul) @ (cco @ XS @ (cco @ XG @ XF @ ccsp) @ ccmul) @ ccaddc))) => ((XA2 = (cco @ XG @ XG @ ccsp)) => ((XC = (cco @ XF @ XF @ ccsp)) => ((cwcel @ XR @ ccr) => (((ccfv @ XS @ ccabs) = cc1) => (cwbr @ ccc0 @ (cco @ (cco @ (cco @ XA2 @ (cco @ XR @ cc2 @ ccexp) @ ccmul) @ (cco @ XB2 @ XR @ ccmul) @ ccaddc) @ XC @ ccaddc) @ ccle))))))))))))))))).
...
thf(alesubadd2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwcel @ XC @ ccr) => ((cwbr @ (cco @ XA2 @ XB2 @ ccmin) @ XC @ ccle) <=> (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ ccle))))))))).
...
thf(aabsrei_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ XA2 @ ccabs) = (ccfv @ (cco @ XA2 @ cc2 @ ccexp) @ ccsqrt))))).
thf(aeqtr2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((XB2 = XC) => (XC = XA2))))))).
thf(asqrtmulii_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwbr @ ccc0 @ XA2 @ ccle) => ((cwbr @ ccc0 @ XB2 @ ccle) => ((ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ ccsqrt) = (cco @ (ccfv @ XA2 @ ccsqrt) @ (ccfv @ XB2 @ ccsqrt) @ ccmul))))))))).
thf(aoveq12i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((XC = XD) => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XD @ XF)))))))))).
thf(asqrt4_ax,axiom,((ccfv @ cc4 @ ccsqrt) = cc2)).
thf(cnormlem6_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XS @ ccc) => ((cwcel @ XF @ cchil) => ((cwcel @ XG @ cchil) => ((XB2 = (ccneg @ (cco @ (cco @ (ccfv @ XS @ cccj) @ (cco @ XF @ XG @ ccsp) @ ccmul) @ (cco @ XS @ (cco @ XG @ XF @ ccsp) @ ccmul) @ ccaddc))) => ((XA2 = (cco @ XG @ XG @ ccsp)) => ((XC = (cco @ XF @ XF @ ccsp)) => (((ccfv @ XS @ ccabs) = cc1) => (cwbr @ (ccfv @ XB2 @ ccabs) @ (cco @ cc2 @ (cco @ (ccfv @ XA2 @ ccsqrt) @ (ccfv @ XC @ ccsqrt) @ ccmul) @ ccmul) @ ccle))))))))))))))).
