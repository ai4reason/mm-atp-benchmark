...
thf(arpnnen1lem4OLD_ax,axiom,(! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xk:$i] : ((XT @ Xx3 @ Xk) = (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccdiv) @ (ccv @ Xx3) @ cclt)) @ (^ [Xn:$i] : ccz))))) => ((XF = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (ccsup @ (XT @ Xx3 @ Xk) @ ccr @ cclt) @ (ccv @ Xk) @ ccdiv)))))) => (! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ ccr) => (cwcel @ (ccsup @ (ccrn @ (ccfv @ (ccv @ Xx3) @ XF)) @ ccr @ cclt) @ ccr)))))))).
...
thf(arpnnen1lem2_ax,axiom,(! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xk:$i] : ((XT @ Xx3 @ Xk) = (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccdiv) @ (ccv @ Xx3) @ cclt)) @ (^ [Xn:$i] : ccz))))) => ((XF = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (ccsup @ (XT @ Xx3 @ Xk) @ ccr @ cclt) @ (ccv @ Xk) @ ccdiv)))))) => (! [Xx3:$i] : (! [Xk:$i] : (((cwcel @ (ccv @ Xx3) @ ccr) & (cwcel @ (ccv @ Xk) @ ccn)) => (cwcel @ (ccsup @ (XT @ Xx3 @ Xk) @ ccr @ cclt) @ ccz))))))))).
...
thf(abtwnz_b_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwrex @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ cclt)) @ (^ [Xx3:$i] : ccz)) & (cwrex @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ cclt)) @ (^ [Xx3:$i] : ccz)))))).
...
thf(aeqlelt_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((XA2 = XB2) <=> ((cwbr @ XA2 @ XB2 @ ccle) & (~ (cwbr @ XA2 @ XB2 @ cclt)))))))).
thf(crpnnen1lem5OLD_conj,conjecture,(! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xk:$i] : ((XT @ Xx3 @ Xk) = (ccrab @ (^ [Xn:$i] : (cwbr @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccdiv) @ (ccv @ Xx3) @ cclt)) @ (^ [Xn:$i] : ccz))))) => ((XF = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (ccsup @ (XT @ Xx3 @ Xk) @ ccr @ cclt) @ (ccv @ Xk) @ ccdiv)))))) => (! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ ccr) => ((ccsup @ (ccrn @ (ccfv @ (ccv @ Xx3) @ XF)) @ ccr @ cclt) = (ccv @ Xx3))))))))).
