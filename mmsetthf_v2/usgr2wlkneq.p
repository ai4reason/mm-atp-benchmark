...
thf(cusgr2wlkneq_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cwcel @ XG @ ccusgr) & (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks))) & (((ccfv @ XF @ cchash) = cc2) & (cwne @ (ccfv @ ccc0 @ XP) @ (ccfv @ (ccfv @ XF @ cchash) @ XP)))) => ((cw3a @ (cwne @ (ccfv @ ccc0 @ XP) @ (ccfv @ cc1 @ XP)) @ (cwne @ (ccfv @ ccc0 @ XP) @ (ccfv @ cc2 @ XP)) @ (cwne @ (ccfv @ cc1 @ XP) @ (ccfv @ cc2 @ XP))) & (cwne @ (ccfv @ ccc0 @ XF) @ (ccfv @ cc1 @ XF)))))))).
