...
thf(aidsrngd_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_as:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_as = (ccfv @ XR @ ccstv)) => ((Xph => (cwcel @ XR @ cccrg)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => ((ccfv @ (ccv @ Xx3) @ Xc_as) = (ccv @ Xx3)))) => (Xph => (cwcel @ XR @ ccsr))))))))))).
thf(cccnfld_tp,type,(cccnfld : ($i > $o))).
thf(ccc_tp,type,(ccc : ($i > $o))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(arebase_ax,axiom,(ccr = (ccfv @ ccrefld @ ccbs))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(arefldcj_ax,axiom,(cccj = (ccfv @ ccrefld @ ccstv))).
