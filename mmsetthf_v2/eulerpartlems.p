...
thf(afsumcvg4_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((XS = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwf @ XS @ ccc @ XF)) => ((Xph => (cwcel @ (ccima @ (cccnv @ XF) @ (ccdif @ ccc @ (ccsn @ ccc0))) @ ccfn)) => (Xph => (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli)))))))))))).
...
thf(ceulerpartlems_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : ((XR = (ccab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)))) => ((! [Xf1:$i] : (! [Xk:$i] : ((XS @ Xf1 @ Xk) = (ccmpt @ (^ [Xf1:$i] : (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) @ (^ [Xf1:$i] : (ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul)))))))) => (! [Xt:$i] : (! [Xf1:$i] : (! [Xk:$i] : (((cwcel @ XA2 @ (ccin @ (cco @ ccn0 @ ccn @ ccmap) @ XR)) & (cwcel @ (ccv @ Xt) @ (ccfv @ (cco @ (ccfv @ XA2 @ (XS @ Xf1 @ Xk)) @ cc1 @ ccaddc) @ ccuz))) => ((ccfv @ (ccv @ Xt) @ XA2) = ccc0))))))))))).
