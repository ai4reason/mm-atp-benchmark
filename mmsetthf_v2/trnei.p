...
thf(aneindisj2_ax,axiom,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX) @ (cwcel @ XP @ XX)) => ((cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cccl))) <=> (cwral @ (^ [Xn:$i] : (cwne @ (ccin @ (ccv @ Xn) @ XS) @ cc0)) @ (^ [Xn:$i] : (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei)))))))))))).
...
thf(atrfil2_ax,axiom,(! [XA2:($i > $o)] : (! [XL:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XL @ (ccfv @ XY @ ccfil)) & (cwss @ XA2 @ XY)) => ((cwcel @ (cco @ XL @ XA2 @ ccrest) @ (ccfv @ XA2 @ ccfil)) <=> (cwral @ (^ [Xv:$i] : (cwne @ (ccin @ (ccv @ Xv) @ XA2) @ cc0)) @ (^ [Xv:$i] : XL)))))))).
thf(ctrnei_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XY @ cctopon)) @ (cwss @ XA2 @ XY) @ (cwcel @ XP @ XY)) => ((cwcel @ XP @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl))) <=> (cwcel @ (cco @ (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest) @ (ccfv @ XA2 @ ccfil))))))))).
