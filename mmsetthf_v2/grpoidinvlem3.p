...
thf(agrpoidinvlem2_ax,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccrn @ XG)) => ((((cwcel @ XG @ ccgr) & ((cwcel @ XY @ XX) & (cwcel @ XA2 @ XX))) & (((cco @ XU @ XY @ XG) = XY) & ((cco @ XY @ XA2 @ XG) = XU))) => ((cco @ (cco @ XA2 @ XY @ XG) @ (cco @ XA2 @ XY @ XG) @ XG) = (cco @ XA2 @ XY @ XG)))))))))).
...
thf(agrpoidinvlem1_ax,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccrn @ XG)) => ((((cwcel @ XG @ ccgr) & ((cwcel @ XY @ XX) & (cwcel @ XA2 @ XX))) & (((cco @ XY @ XA2 @ XG) = XU) & ((cco @ XA2 @ XA2 @ XG) = XA2))) => ((cco @ XU @ XA2 @ XG) = XU))))))))).
thf(cgrpoidinvlem3_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((! [Xx3:$i] : (! [Xz:$i] : ((Xph @ Xx3 @ Xz) <=> (cwral @ (^ [Xx3:$i] : ((cco @ XU @ (ccv @ Xx3) @ XG) = (ccv @ Xx3))) @ (^ [Xx3:$i] : XX))))) => ((! [Xx3:$i] : (! [Xz:$i] : ((Xps @ Xx3 @ Xz) <=> (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xz:$i] : ((cco @ (ccv @ Xz) @ (ccv @ Xx3) @ XG) = XU)) @ (^ [Xz:$i] : XX))) @ (^ [Xx3:$i] : XX))))) => (! [Xx3:$i] : (! [Xz:$i] : (((((cwcel @ XG @ ccgr) & (cwcel @ XU @ XX)) & ((Xph @ Xx3 @ Xz) & (Xps @ Xx3 @ Xz))) & (cwcel @ XA2 @ XX)) => (cwrex @ (^ [Xy1:$i] : (((cco @ (ccv @ Xy1) @ XA2 @ XG) = XU) & ((cco @ XA2 @ (ccv @ Xy1) @ XG) = XU))) @ (^ [Xy1:$i] : XX))))))))))))))).
