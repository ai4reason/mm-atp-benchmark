...
thf(azringlpirlem3_ax,axiom,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XI @ (ccfv @ czring @ cclidl))) => ((Xph => (cwne @ XI @ (ccsn @ ccc0))) => ((XG = (ccinf @ (ccin @ XI @ ccn) @ ccr @ cclt)) => ((Xph => (cwcel @ XX @ XI)) => (Xph => (cwbr @ XG @ XX @ ccdvds))))))))))).
...
thf(alpigen_ax,axiom,(! [Xc_pa:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : ((XU = (ccfv @ XR @ cclidl)) => ((XP = (ccfv @ XR @ cclpidl)) => ((Xc_pa = (ccfv @ XR @ ccdsr)) => (((cwcel @ XR @ ccrg) & (cwcel @ XI @ XU)) => ((cwcel @ XI @ XP) <=> (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pa)) @ (^ [Xy1:$i] : XI))) @ (^ [Xx3:$i] : XI))))))))))))).
thf(ccopab_tp,type,(ccopab : (($i > ($i > $o)) > ($i > $o)))).
thf(advdsrzring_ax,axiom,(ccdvds = (ccfv @ czring @ ccdsr))).
