...
thf(cmblsplit_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwss @ XB2 @ ccr) @ (cwcel @ (ccfv @ XB2 @ ccovol) @ ccr)) => ((ccfv @ XB2 @ ccovol) = (cco @ (ccfv @ (ccin @ XB2 @ XA2) @ ccovol) @ (ccfv @ (ccdif @ XB2 @ XA2) @ ccovol) @ ccaddc)))))).
