...
thf(aopprringb_ax,axiom,(! [XR:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XR @ ccoppr)) => ((cwcel @ XR @ ccrg) <=> (cwcel @ XO @ ccrg)))))).
...
thf(crhmopp_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (cco @ XR @ XS @ ccrh)) => (cwcel @ XF @ (cco @ (ccfv @ XR @ ccoppr) @ (ccfv @ XS @ ccoppr) @ ccrh))))))).
