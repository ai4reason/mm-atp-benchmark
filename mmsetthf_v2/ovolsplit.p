...
thf(axrge0nemnfd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => (Xph => (cwne @ XA2 @ ccmnf)))))).
...
thf(covolsplit_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwss @ XA2 @ ccr)) => (Xph => (cwbr @ (ccfv @ XA2 @ ccovol) @ (cco @ (ccfv @ (ccin @ XA2 @ XB2) @ ccovol) @ (ccfv @ (ccdif @ XA2 @ XB2) @ ccovol) @ ccxad) @ ccle))))))).
