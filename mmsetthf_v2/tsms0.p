...
thf(ctsms0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => (cwcel @ XG @ cccmn)) => ((Xph => (cwcel @ XG @ cctps)) => ((Xph => (cwcel @ XA2 @ XV)) => (Xph => (cwcel @ Xc_0 @ (cco @ XG @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : Xc_0)) @ cctsu))))))))))))).
