...
thf(aharinf_ax,axiom,(! [XS:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XS @ XV) & (~ (cwcel @ XS @ ccfn))) => (cwss @ ccom @ (ccfv @ XS @ cchar)))))).
...
thf(aunxpwdom2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ (ccxp @ XA2 @ XA2) @ (ccun @ XB2 @ XC) @ ccen) => ((cwbr @ XA2 @ XB2 @ ccwdom) | (cwbr @ XA2 @ XC @ ccdom))))))).
...
thf(cttac_conj,conjecture,(cwac <=> (! [Xc:$i] : ((cwbr @ ccom @ (ccv @ Xc) @ ccdom) => (cwbr @ (ccxp @ (ccv @ Xc) @ (ccv @ Xc)) @ (ccv @ Xc) @ ccen))))).
