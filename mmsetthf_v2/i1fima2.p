...
thf(acnvimarndm_ax,axiom,(! [XA2:($i > $o)] : ((ccima @ (cccnv @ XA2) @ (ccrn @ XA2)) = (ccdm @ XA2)))).
...
thf(aisi1f_ax,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ ccitg1)) <=> ((cwcel @ XF @ ccmbf) & (cw3a @ (cwf @ ccr @ ccr @ XF) @ (cwcel @ (ccrn @ XF) @ ccfn) @ (cwcel @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccdif @ ccr @ (ccsn @ ccc0))) @ ccvol) @ ccr)))))).
...
thf(ci1fima2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ (ccdm @ ccitg1)) & (~ (cwcel @ ccc0 @ XA2))) => (cwcel @ (ccfv @ (ccima @ (cccnv @ XF) @ XA2) @ ccvol) @ ccr))))).
