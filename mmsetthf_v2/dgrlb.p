...
thf(asupnub_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xx3 @ Xy1 @ Xz) => (cwor @ XA2 @ XR))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xx3 @ Xy1 @ Xz) => (cwrex @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR))) @ (^ [Xy1:$i] : XB2)) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ XR)) @ (^ [Xz:$i] : XB2)))) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : XA2)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xx3 @ Xy1 @ Xz) => (((cwcel @ (XC @ Xx3 @ Xy1) @ XA2) & (cwral @ (^ [Xz:$i] : (~ (cwbr @ (XC @ Xx3 @ Xy1) @ (ccv @ Xz) @ XR))) @ (^ [Xz:$i] : XB2))) => (~ (cwbr @ (XC @ Xx3 @ Xy1) @ (ccsup @ XB2 @ XA2 @ XR) @ XR))))))))))))))).
...
thf(cdgrlb_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XN = (ccfv @ XF @ ccdgr)) => ((cw3a @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XM @ ccn0) @ ((ccima @ XA2 @ (ccfv @ (cco @ XM @ cc1 @ ccaddc) @ ccuz)) = (ccsn @ ccc0))) => (cwbr @ XN @ XM @ ccle)))))))))).
