...
thf(abj_sngltagi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ (cbj_csngl @ XB2)) => (cwcel @ XA2 @ (cbj_ctag @ XB2)))))).
...
thf(cbj_sngltag_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ (ccsn @ XA2) @ (cbj_csngl @ XB2)) <=> (cwcel @ (ccsn @ XA2) @ (cbj_ctag @ XB2)))))))).
