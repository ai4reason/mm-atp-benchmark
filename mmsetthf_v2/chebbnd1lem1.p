...
thf(apclogsum_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => ((ccsu @ (ccin @ (cco @ cc1 @ XA2 @ ccfz) @ ccprime) @ (^ [Xp:$i] : (cco @ (cco @ (ccv @ Xp) @ XA2 @ ccpc) @ (ccfv @ (ccv @ Xp) @ cclog) @ ccmul))) = (ccfv @ XA2 @ cclog))))).
...
thf(cchebbnd1lem1_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XK = (ccif @ (cwbr @ (cco @ cc2 @ XN @ ccmul) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ ccle) @ (cco @ cc2 @ XN @ ccmul) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc))) => ((cwcel @ XN @ (ccfv @ cc4 @ ccuz)) => (cwbr @ (ccfv @ (cco @ (cco @ cc4 @ XN @ ccexp) @ XN @ ccdiv) @ cclog) @ (cco @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ ccppi) @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ cclog) @ ccmul) @ cclt)))))).
