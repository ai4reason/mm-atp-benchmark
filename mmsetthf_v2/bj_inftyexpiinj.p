...
thf(abj_inftyexpiinv_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc)) => ((ccfv @ (ccfv @ XA2 @ ccinftyexpi) @ cc1st) = XA2)))).
thf(aeqeq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((XC = XA2) <=> (XC = XB2))))))))).
thf(aadantl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xch & Xph) => Xps)))))).
thf(cbj_inftyexpiinj_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc)) & (cwcel @ XB2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc))) => ((XA2 = XB2) <=> ((ccfv @ XA2 @ ccinftyexpi) = (ccfv @ XB2 @ ccinftyexpi))))))).
