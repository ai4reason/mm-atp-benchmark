...
thf(aringid_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (((cwcel @ XR @ ccrg) & (cwcel @ XX @ XB2)) => (cwrex @ (^ [Xu:$i] : (((cco @ (ccv @ Xu) @ XX @ Xc_x) = XX) & ((cco @ XX @ (ccv @ Xu) @ Xc_x) = XX))) @ (^ [Xu:$i] : XB2)))))))))).
...
thf(cringadd2_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : ((Xc_pl @ Xx3) = (ccfv @ XR @ ccplusg))) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (((cwcel @ XR @ ccrg) & (cwcel @ XX @ XB2)) => (cwrex @ (^ [Xx3:$i] : ((cco @ XX @ XX @ (Xc_pl @ Xx3)) = (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ (Xc_pl @ Xx3)) @ XX @ Xc_x))) @ (^ [Xx3:$i] : XB2)))))))))))).
