...
thf(a_2llnma2rN_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2) @ (cwcel @ XR @ XA2)) @ ((cwne @ XP @ XQ) & (~ (cwbr @ XR @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)))) => ((cco @ (cco @ XP @ XR @ Xc_or) @ (cco @ XQ @ XR @ Xc_or) @ Xc_an) = XR))))))))))))))).
thf(ccdleme20y_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwcel @ XR @ XA2) @ (cwcel @ XS @ XA2) @ (cwcel @ XT @ XA2)) @ ((cwne @ XS @ XT) & (~ (cwbr @ XR @ (cco @ XS @ XT @ Xc_or) @ Xc_le)))) => ((cco @ (cco @ XS @ XR @ Xc_or) @ (cco @ XT @ XR @ Xc_or) @ Xc_an) = XR))))))))))))))).
