...
thf(achincl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => (cwcel @ (ccin @ XA2 @ XB2) @ ccch))))).
...
thf(aledi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) => (cwss @ (cco @ (ccin @ XA2 @ XB2) @ (ccin @ XA2 @ XC) @ cchj) @ (ccin @ XA2 @ (cco @ XB2 @ XC @ cchj)))))))).
thf(aeqtrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XB2 = XC)) => (Xph => (XA2 = XC))))))))).
thf(a_3impdi_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((((Xph & Xps) & (Xph & Xch)) => Xth) => ((cw3a @ Xph @ Xps @ Xch) => Xth))))))).
...
thf(achdmj1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((ccfv @ (cco @ XA2 @ XB2 @ cchj) @ ccort) = (ccin @ (ccfv @ XA2 @ ccort) @ (ccfv @ XB2 @ ccort))))))).
thf(aineqan12d_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xps => (XC = XD)) => ((Xph & Xps) => ((ccin @ XA2 @ XC) = (ccin @ XB2 @ XD)))))))))))).
thf(achdmm1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((ccfv @ (ccin @ XA2 @ XB2) @ ccort) = (cco @ (ccfv @ XA2 @ ccort) @ (ccfv @ XB2 @ ccort) @ cchj)))))).
...
thf(acmcm2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((cwbr @ XA2 @ XB2 @ cccm) <=> (cwbr @ XA2 @ (ccfv @ XB2 @ ccort) @ cccm)))))).
thf(achoccl_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => (cwcel @ (ccfv @ XA2 @ ccort) @ ccch)))).
thf(acmbr3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((cwbr @ XA2 @ XB2 @ cccm) <=> ((ccin @ XA2 @ (cco @ (ccfv @ XA2 @ ccort) @ XB2 @ cchj)) = (ccin @ XA2 @ XB2))))))).
...
thf(ainindi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccin @ XA2 @ (ccin @ XB2 @ XC)) = (ccin @ (ccin @ XA2 @ XB2) @ (ccin @ XA2 @ XC))))))).
...
thf(achocin_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((ccin @ XA2 @ (ccfv @ XA2 @ ccort)) = cc0h)))).
thf(achm0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((ccin @ XA2 @ cc0h) = cc0h)))).
thf(apjoml_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccsh)) & ((cwss @ XA2 @ XB2) & ((ccin @ XB2 @ (ccfv @ XA2 @ ccort)) = cc0h))) => (XA2 = XB2))))).
thf(cfh1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) & ((cwbr @ XA2 @ XB2 @ cccm) & (cwbr @ XA2 @ XC @ cccm))) => ((ccin @ XA2 @ (cco @ XB2 @ XC @ cchj)) = (cco @ (ccin @ XA2 @ XB2) @ (ccin @ XA2 @ XC) @ cchj))))))).
