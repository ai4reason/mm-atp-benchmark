...
thf(caxpre_lttrn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) => (((cwbr @ XA2 @ XB2 @ ccltrr) & (cwbr @ XB2 @ XC @ ccltrr)) => (cwbr @ XA2 @ XC @ ccltrr))))))).
