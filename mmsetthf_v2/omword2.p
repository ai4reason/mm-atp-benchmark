...
thf(aom1r_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cco @ cc1o @ XA2 @ ccomu) = XA2)))).
...
thf(comword2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) & (cwcel @ cc0 @ XB2)) => (cwss @ XA2 @ (cco @ XB2 @ XA2 @ ccomu)))))).
