...
thf(abrrpssg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((cwbr @ XA2 @ XB2 @ ccrpss) <=> (cwpss @ XA2 @ XB2))))))).
...
thf(csorpssi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwor @ XA2 @ ccrpss) & ((cwcel @ XB2 @ XA2) & (cwcel @ XC @ XA2))) => ((cwss @ XB2 @ XC) | (cwss @ XC @ XB2))))))).
