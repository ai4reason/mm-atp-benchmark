...
thf(a_0ngrp_ax,axiom,(~ (cwcel @ cc0 @ ccgr))).
...
thf(agidsn_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((ccfv @ (ccsn @ (ccop @ (ccop @ XA2 @ XA2) @ XA2)) @ ccgi) = XA2)))).
...
thf(aisdivrngo_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ XA2) => ((cwcel @ (ccop @ XG @ XH) @ ccdrng) <=> ((cwcel @ (ccop @ XG @ XH) @ ccrngo) & (cwcel @ (ccres @ XH @ (ccxp @ (ccdif @ (ccrn @ XG) @ (ccsn @ (ccfv @ XG @ ccgi))) @ (ccdif @ (ccrn @ XG) @ (ccsn @ (ccfv @ XG @ ccgi))))) @ ccgr)))))))).
