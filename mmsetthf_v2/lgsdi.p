...
thf(algsfcl3_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (cco @ XA2 @ (ccv @ Xn) @ cclgs) @ (cco @ (ccv @ Xn) @ XN @ ccpc) @ ccexp) @ cc1))))) => (! [Xn:$i] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ ccz) @ (cwne @ XN @ ccc0)) => (cwf @ ccn @ ccz @ (XF @ Xn))))))))).
...
thf(algsval4_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (cco @ XA2 @ (ccv @ Xn) @ cclgs) @ (cco @ (ccv @ Xn) @ XN @ ccpc) @ ccexp) @ cc1))))) => (! [Xn:$i] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ ccz) @ (cwne @ XN @ ccc0)) => ((cco @ XA2 @ XN @ cclgs) = (cco @ (ccif @ ((cwbr @ XN @ ccc0 @ cclt) & (cwbr @ XA2 @ ccc0 @ cclt)) @ (ccneg @ cc1) @ cc1) @ (ccfv @ (ccfv @ XN @ ccabs) @ (ccseq @ ccmul @ (XF @ Xn) @ cc1)) @ ccmul))))))))).
...
thf(clgsdi_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) & ((cwne @ XM @ ccc0) & (cwne @ XN @ ccc0))) => ((cco @ XA2 @ (cco @ XM @ XN @ ccmul) @ cclgs) = (cco @ (cco @ XA2 @ XM @ cclgs) @ (cco @ XA2 @ XN @ cclgs) @ ccmul))))))).
