...
thf(ataupilem2_ax,axiom,(cwbr @ cctau @ (cco @ cc2 @ ccpi @ ccmul) @ ccle)).
...
thf(ataupilem3_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccin @ ccrp @ (ccima @ (cccnv @ cccos) @ (ccsn @ cc1)))) <=> ((cwcel @ XA2 @ ccrp) & ((ccfv @ XA2 @ cccos) = cc1))))).
thf(ataupilemrplb_ax,axiom,(! [XA2:($i > ($i > $o))] : (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : (ccin @ ccrp @ (XA2 @ Xy1))))) @ (^ [Xx3:$i] : ccr)))).
...
thf(ataupilem1_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccrp) & ((ccfv @ XA2 @ cccos) = cc1)) => (cwbr @ (cco @ cc2 @ ccpi @ ccmul) @ XA2 @ ccle)))).
