...
thf(aopidon2OLD_ax,axiom,(! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((cwcel @ XG @ (ccin @ ccmagm @ ccexid)) => (cwfo @ (ccxp @ XX @ XX) @ XX @ XG)))))).
...
thf(cexidreslem_conj,conjecture,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccrn @ XG)) => ((XU = (ccfv @ XG @ ccgi)) => ((XH = (ccres @ XG @ (ccxp @ XY @ XY))) => ((cw3a @ (cwcel @ XG @ (ccin @ ccmagm @ ccexid)) @ (cwss @ XY @ XX) @ (cwcel @ XU @ XY)) => ((cwcel @ XU @ (ccdm @ (ccdm @ XH))) & (cwral @ (^ [Xx3:$i] : (((cco @ XU @ (ccv @ Xx3) @ XH) = (ccv @ Xx3)) & ((cco @ (ccv @ Xx3) @ XU @ XH) = (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccdm @ (ccdm @ XH))))))))))))))).
