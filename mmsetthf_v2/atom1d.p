...
thf(achne0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwne @ XA2 @ cc0h) <=> (cwrex @ (^ [Xx3:$i] : (cwne @ (ccv @ Xx3) @ cc0v)) @ (^ [Xx3:$i] : XA2)))))).
...
thf(ach1dle_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ XA2)) => (cwss @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort) @ XA2))))).
...
thf(catom1d_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccat) <=> (cwrex @ (^ [Xx3:$i] : ((cwne @ (ccv @ Xx3) @ cc0v) & (XA2 = (ccfv @ (ccsn @ (ccv @ Xx3)) @ ccspn)))) @ (^ [Xx3:$i] : cchil))))).
