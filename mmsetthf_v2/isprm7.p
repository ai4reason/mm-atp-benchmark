...
thf(cisprm7_conj,conjecture,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprime) <=> ((cwcel @ XP @ (ccfv @ cc2 @ ccuz)) & (cwral @ (^ [Xz:$i] : (~ (cwbr @ (ccv @ Xz) @ XP @ ccdvds))) @ (^ [Xz:$i] : (ccin @ (cco @ cc2 @ (ccfv @ (ccfv @ XP @ ccsqrt) @ ccfl) @ ccfz) @ ccprime))))))).
