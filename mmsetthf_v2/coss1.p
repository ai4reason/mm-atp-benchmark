...
thf(assbr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwss @ XA2 @ XB2) => ((cwbr @ XC @ XD @ XA2) => (cwbr @ XC @ XD @ XB2)))))))).
...
thf(ccoss1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ XB2) => (cwss @ (cccom @ XA2 @ XC) @ (cccom @ XB2 @ XC))))))).
