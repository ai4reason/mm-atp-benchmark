...
thf(arecclnq_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccnq) => (cwcel @ (ccfv @ XA2 @ ccrq) @ ccnq)))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(acaovord2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ (ccv @ Xz) @ XS) => ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) <=> (cwbr @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ XF) @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ XF) @ XR)))))) => ((cwcel @ XC @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) = (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XF)))) => ((cwcel @ XC @ XS) => ((cwbr @ XA2 @ XB2 @ XR) <=> (cwbr @ (cco @ XA2 @ XC @ XF) @ (cco @ XB2 @ XC @ XF) @ XR))))))))))))))).
...
thf(cmulclprlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xx3:$i] : (((((cwcel @ XA2 @ ccnp) & (cwcel @ (ccv @ Xg1) @ XA2)) & ((cwcel @ XB2 @ ccnp) & (cwcel @ (ccv @ Xh) @ XB2))) & (cwcel @ (ccv @ Xx3) @ ccnq)) => ((cwbr @ (ccv @ Xx3) @ (cco @ (ccv @ Xg1) @ (ccv @ Xh) @ ccmq) @ ccltq) => (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccmp)))))))))).
