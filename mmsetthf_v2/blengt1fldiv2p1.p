...
thf(anneop_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn) | (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn))))).
...
thf(ablennn0em1_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn0)) => ((ccfv @ (cco @ XN @ cc2 @ ccdiv) @ ccblen) = (cco @ (ccfv @ XN @ ccblen) @ cc1 @ ccmin))))).
...
thf(ablennngt2o2_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) & (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn0)) => ((ccfv @ XN @ ccblen) = (cco @ (ccfv @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccblen) @ cc1 @ ccaddc))))).
...
thf(ann0ofldiv2_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn0)) => ((ccfv @ (cco @ XN @ cc2 @ ccdiv) @ ccfl) = (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv))))).
thf(cblengt1fldiv2p1_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) => ((ccfv @ XN @ ccblen) = (cco @ (ccfv @ (ccfv @ (cco @ XN @ cc2 @ ccdiv) @ ccfl) @ ccblen) @ cc1 @ ccaddc))))).
