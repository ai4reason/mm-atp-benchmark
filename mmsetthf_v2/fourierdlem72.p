...
thf(advmulcncf_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwf @ XX @ ccc @ XF)) => ((Xph => (cwf @ XX @ ccc @ XG)) => ((Xph => (cwcel @ (cco @ XS @ XF @ ccdv) @ (cco @ XX @ ccc @ cccncf))) => ((Xph => (cwcel @ (cco @ XS @ XG @ ccdv) @ (cco @ XX @ ccc @ cccncf))) => (Xph => (cwcel @ (cco @ XS @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccdv) @ (cco @ XX @ ccc @ cccncf)))))))))))))).
...
thf(afourierdlem59_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwf @ ccr @ ccr @ XF)) => ((Xph => (cwcel @ XX @ ccr)) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (~ (cwcel @ ccc0 @ (cco @ XA2 @ XB2 @ ccioo)))) => ((Xph => (cwcel @ (cco @ ccr @ (ccres @ XF @ (cco @ (cco @ XX @ XA2 @ ccaddc) @ (cco @ XX @ XB2 @ ccaddc) @ ccioo)) @ ccdv) @ (cco @ (cco @ (cco @ XX @ XA2 @ ccaddc) @ (cco @ XX @ XB2 @ ccaddc) @ ccioo) @ ccr @ cccncf))) => ((Xph => (cwcel @ XC @ ccr)) => ((! [Xs1:$i] : ((XH @ Xs1) = (ccmpt @ (^ [Xs1:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xs1:$i] : (cco @ (cco @ (ccfv @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XF) @ XC @ ccmin) @ (ccv @ Xs1) @ ccdiv))))) => (! [Xs1:$i] : (Xph => (cwcel @ (cco @ ccr @ (XH @ Xs1) @ ccdv) @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ cccncf)))))))))))))))))))).
thf(anelrdva_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwne @ (ccv @ Xx3) @ XB2))) => (Xph => (~ (cwcel @ XB2 @ XA2)))))))).
...
thf(afourierdlem58_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XK:($i > ($i > $o))] : ((! [Xs1:$i] : ((XK @ Xs1) = (ccmpt @ (^ [Xs1:$i] : XA2) @ (^ [Xs1:$i] : (cco @ (ccv @ Xs1) @ (cco @ cc2 @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv))))) => ((Xph => (cwss @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc))) => ((Xph => (~ (cwcel @ ccc0 @ XA2))) => ((Xph => (cwcel @ XA2 @ (ccfv @ (ccrn @ ccioo) @ cctg))) => (! [Xs1:$i] : (Xph => (cwcel @ (cco @ ccr @ (XK @ Xs1) @ ccdv) @ (cco @ XA2 @ ccr @ cccncf)))))))))))).
