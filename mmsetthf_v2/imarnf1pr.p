...
thf(afnimapr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwfn @ XF @ XA2) @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2)) => ((ccima @ XF @ (ccpr @ XB2 @ XC)) = (ccpr @ (ccfv @ XB2 @ XF) @ (ccfv @ XC @ XF))))))))).
...
thf(arnfdmpr_ax,axiom,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XX @ XV) & (cwcel @ XY @ XW)) => ((cwfn @ XF @ (ccpr @ XX @ XY)) => ((ccrn @ XF) = (ccpr @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF))))))))))).
thf(apreq12_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((XA2 = XC) & (XB2 = XD)) => ((ccpr @ XA2 @ XB2) = (ccpr @ XC @ XD)))))))).
thf(cimarnf1pr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XX @ XV) & (cwcel @ XY @ XW)) => ((((cwf @ (ccpr @ XX @ XY) @ (ccdm @ XE) @ XF) & (cwf @ (ccdm @ XE) @ XR @ XE)) & (((ccfv @ (ccfv @ XX @ XF) @ XE) = XA2) & ((ccfv @ (ccfv @ XY @ XF) @ XE) = XB2))) => ((ccima @ XE @ (ccrn @ XF)) = (ccpr @ XA2 @ XB2)))))))))))))).
