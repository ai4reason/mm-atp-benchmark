...
thf(a_1pthon2v_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xp:$i] : ((XV @ Xf1 @ Xp) = (ccfv @ XG @ ccvtx)))) => ((! [Xe:$i] : (! [Xf1:$i] : (! [Xp:$i] : ((XE @ Xe @ Xf1 @ Xp) = (ccfv @ XG @ ccedg))))) => (! [Xf1:$i] : (! [Xp:$i] : ((cw3a @ (cwcel @ XG @ ccuhgr) @ ((cwcel @ XA2 @ (XV @ Xf1 @ Xp)) & (cwcel @ XB2 @ (XV @ Xf1 @ Xp))) @ (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ XA2 @ XB2) @ (ccv @ Xe))) @ (^ [Xe:$i] : (XE @ Xe @ Xf1 @ Xp)))) => (? [Xf1:$i] : (? [Xp:$i] : (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (cco @ XA2 @ XB2 @ (ccfv @ XG @ ccpthson)))))))))))))))).
thf(c_1pthon2ve_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xp:$i] : ((XV @ Xf1 @ Xp) = (ccfv @ XG @ ccvtx)))) => ((! [Xf1:$i] : (! [Xp:$i] : ((XE @ Xf1 @ Xp) = (ccfv @ XG @ ccedg)))) => (! [Xf1:$i] : (! [Xp:$i] : ((cw3a @ (cwcel @ XG @ ccuhgr) @ ((cwcel @ XA2 @ (XV @ Xf1 @ Xp)) & (cwcel @ XB2 @ (XV @ Xf1 @ Xp))) @ (cwcel @ (ccpr @ XA2 @ XB2) @ (XE @ Xf1 @ Xp))) => (? [Xf1:$i] : (? [Xp:$i] : (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (cco @ XA2 @ XB2 @ (ccfv @ XG @ ccpthson)))))))))))))))).
