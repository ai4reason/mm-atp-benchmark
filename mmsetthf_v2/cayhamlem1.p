...
thf(achfacfpmmulgsum2_ax,axiom,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_pl:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [Xc_xp:($i > ($i > ($i > $o)))] : (! [Xc_ex:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > $o)))] : (! [Xc_mi:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XA2 @ Xi @ Xn @ Xs1 @ Xb) = (cco @ (XN @ Xs1 @ Xb) @ (XR @ Xs1 @ Xb) @ ccmat)))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XB2 @ Xs1 @ Xb) = (ccfv @ (XA2 @ Xi @ Xn @ Xs1 @ Xb) @ ccbs)))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XP @ Xi @ Xn @ Xs1 @ Xb) = (ccfv @ (XR @ Xs1 @ Xb) @ ccpl1)))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XY @ Xs1 @ Xb) = (cco @ (XN @ Xs1 @ Xb) @ (XP @ Xi @ Xn @ Xs1 @ Xb) @ ccmat)))))) => ((! [Xs1:$i] : (! [Xb:$i] : ((Xc_xp @ Xs1 @ Xb) = (ccfv @ (XY @ Xs1 @ Xb) @ ccmulr)))) => ((! [Xi:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((Xc_mi @ Xi @ Xs1 @ Xb) = (ccfv @ (XY @ Xs1 @ Xb) @ ccsg))))) => ((! [Xi:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((Xc_0 @ Xi @ Xs1 @ Xb) = (ccfv @ (XY @ Xs1 @ Xb) @ cc0g))))) => ((! [Xs1:$i] : (! [Xb:$i] : ((XT @ Xs1 @ Xb) = (cco @ (XN @ Xs1 @ Xb) @ (XR @ Xs1 @ Xb) @ ccmat2pmat)))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XG @ Xn @ Xs1 @ Xb) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ (cco @ (Xc_0 @ Xi @ Xs1 @ Xb) @ (cco @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xs1 @ Xb)) @ (ccfv @ (ccfv @ ccc0 @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (Xc_xp @ Xs1 @ Xb)) @ (Xc_mi @ Xi @ Xs1 @ Xb)) @ (ccif @ ((ccv @ Xn) = (cco @ (ccv @ Xs1) @ cc1 @ ccaddc)) @ (ccfv @ (ccfv @ (ccv @ Xs1) @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (ccif @ (cwbr @ (cco @ (ccv @ Xs1) @ cc1 @ ccaddc) @ (ccv @ Xn) @ cclt) @ (Xc_0 @ Xi @ Xs1 @ Xb) @ (cco @ (ccfv @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (cco @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xs1 @ Xb)) @ (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (Xc_xp @ Xs1 @ Xb)) @ (Xc_mi @ Xi @ Xs1 @ Xb)))))))))))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((Xc_ex @ Xn @ Xs1 @ Xb) = (ccfv @ (ccfv @ (XY @ Xs1 @ Xb) @ ccmgp) @ ccmg))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((Xc_pl @ Xi @ Xn @ Xs1 @ Xb) = (ccfv @ (XY @ Xs1 @ Xb) @ ccplusg)))))) => (! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : (((cw3a @ (cwcel @ (XN @ Xs1 @ Xb) @ ccfn) @ (cwcel @ (XR @ Xs1 @ Xb) @ cccrg) @ (cwcel @ (XM @ Xs1 @ Xb) @ (XB2 @ Xs1 @ Xb))) & ((cwcel @ (ccv @ Xs1) @ ccn) & (cwcel @ (ccv @ Xb) @ (cco @ (XB2 @ Xs1 @ Xb) @ (cco @ ccc0 @ (ccv @ Xs1) @ ccfz) @ ccmap)))) => ((cco @ (XY @ Xs1 @ Xb) @ (ccmpt @ (^ [Xi:$i] : ccn0) @ (^ [Xi:$i] : (cco @ (cco @ (ccv @ Xi) @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xs1 @ Xb)) @ (Xc_ex @ Xn @ Xs1 @ Xb)) @ (ccfv @ (ccv @ Xi) @ (XG @ Xn @ Xs1 @ Xb)) @ (Xc_xp @ Xs1 @ Xb)))) @ ccgsu) = (cco @ (cco @ (XY @ Xs1 @ Xb) @ (ccmpt @ (^ [Xi:$i] : (cco @ cc1 @ (ccv @ Xs1) @ ccfz)) @ (^ [Xi:$i] : (cco @ (cco @ (cco @ (ccv @ Xi) @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xs1 @ Xb)) @ (Xc_ex @ Xn @ Xs1 @ Xb)) @ (ccfv @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccmin) @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (Xc_xp @ Xs1 @ Xb)) @ (cco @ (cco @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xs1 @ Xb)) @ (Xc_ex @ Xn @ Xs1 @ Xb)) @ (ccfv @ (ccfv @ (ccv @ Xi) @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (Xc_xp @ Xs1 @ Xb)) @ (Xc_mi @ Xi @ Xs1 @ Xb)))) @ ccgsu) @ (cco @ (cco @ (cco @ (cco @ (ccv @ Xs1) @ cc1 @ ccaddc) @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xs1 @ Xb)) @ (Xc_ex @ Xn @ Xs1 @ Xb)) @ (ccfv @ (ccfv @ (ccv @ Xs1) @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (Xc_xp @ Xs1 @ Xb)) @ (cco @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xs1 @ Xb)) @ (ccfv @ (ccfv @ ccc0 @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (Xc_xp @ Xs1 @ Xb)) @ (Xc_mi @ Xi @ Xs1 @ Xb)) @ (Xc_pl @ Xi @ Xn @ Xs1 @ Xb)))))))))))))))))))))))))))))))))).
...
thf(atelgsumfz_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [Xc_mi:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xk:$i] : (XB2 = (ccfv @ (XG @ Xk) @ ccbs))) => ((! [Xk:$i] : (Xph => (cwcel @ (XG @ Xk) @ ccabl))) => ((! [Xk:$i] : ((Xc_mi @ Xk) = (ccfv @ (XG @ Xk) @ ccsg))) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((Xph => (cwral @ (^ [Xk:$i] : (cwcel @ (XA2 @ Xk) @ XB2)) @ (^ [Xk:$i] : (cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccfz)))) => ((! [Xi:$i] : (! [Xk:$i] : (((ccv @ Xk) = (ccv @ Xi)) => ((XA2 @ Xk) = (XL @ Xi))))) => ((! [Xi:$i] : (! [Xk:$i] : (((ccv @ Xk) = (cco @ (ccv @ Xi) @ cc1 @ ccaddc)) => ((XA2 @ Xk) = (XC @ Xi))))) => ((! [Xi:$i] : (! [Xk:$i] : (((ccv @ Xk) = XM) => ((XA2 @ Xk) = (XD @ Xi))))) => ((! [Xi:$i] : (! [Xk:$i] : (((ccv @ Xk) = (cco @ XN @ cc1 @ ccaddc)) => ((XA2 @ Xk) = (XE @ Xi))))) => (! [Xi:$i] : (! [Xk:$i] : (Xph => ((cco @ (XG @ Xk) @ (ccmpt @ (^ [Xi:$i] : (cco @ XM @ XN @ ccfz)) @ (^ [Xi:$i] : (cco @ (XL @ Xi) @ (XC @ Xi) @ (Xc_mi @ Xk)))) @ ccgsu) = (cco @ (XD @ Xi) @ (XE @ Xi) @ (Xc_mi @ Xk))))))))))))))))))))))))))).
...
thf(aelfzm1b_ax,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ ccz) & (cwcel @ XN @ ccz)) => ((cwcel @ XK @ (cco @ cc1 @ XN @ ccfz)) <=> (cwcel @ (cco @ XK @ cc1 @ ccmin) @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))))))).
...
thf(agrpnpncan0_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cwcel @ XG @ ccgrp) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2))) => ((cco @ (cco @ XX @ XY @ Xc_mi) @ (cco @ XY @ XX @ Xc_mi) @ Xc_pl) = Xc_0)))))))))))))).
thf(ccayhamlem1_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [Xc_xp:($i > ($i > ($i > $o)))] : (! [Xc_ex:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > $o)))] : (! [Xc_mi:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XA2 @ Xi @ Xn @ Xs1 @ Xb) = (cco @ (XN @ Xs1 @ Xb) @ (XR @ Xs1 @ Xb) @ ccmat)))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XB2 @ Xs1 @ Xb) = (ccfv @ (XA2 @ Xi @ Xn @ Xs1 @ Xb) @ ccbs)))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XP @ Xi @ Xn @ Xs1 @ Xb) = (ccfv @ (XR @ Xs1 @ Xb) @ ccpl1)))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XY @ Xs1 @ Xb) = (cco @ (XN @ Xs1 @ Xb) @ (XP @ Xi @ Xn @ Xs1 @ Xb) @ ccmat)))))) => ((! [Xs1:$i] : (! [Xb:$i] : ((Xc_xp @ Xs1 @ Xb) = (ccfv @ (XY @ Xs1 @ Xb) @ ccmulr)))) => ((! [Xs1:$i] : (! [Xb:$i] : ((Xc_mi @ Xs1 @ Xb) = (ccfv @ (XY @ Xs1 @ Xb) @ ccsg)))) => ((! [Xi:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((Xc_0 @ Xi @ Xs1 @ Xb) = (ccfv @ (XY @ Xs1 @ Xb) @ cc0g))))) => ((! [Xs1:$i] : (! [Xb:$i] : ((XT @ Xs1 @ Xb) = (cco @ (XN @ Xs1 @ Xb) @ (XR @ Xs1 @ Xb) @ ccmat2pmat)))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XG @ Xn @ Xs1 @ Xb) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ (cco @ (Xc_0 @ Xi @ Xs1 @ Xb) @ (cco @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xs1 @ Xb)) @ (ccfv @ (ccfv @ ccc0 @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (Xc_xp @ Xs1 @ Xb)) @ (Xc_mi @ Xs1 @ Xb)) @ (ccif @ ((ccv @ Xn) = (cco @ (ccv @ Xs1) @ cc1 @ ccaddc)) @ (ccfv @ (ccfv @ (ccv @ Xs1) @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (ccif @ (cwbr @ (cco @ (ccv @ Xs1) @ cc1 @ ccaddc) @ (ccv @ Xn) @ cclt) @ (Xc_0 @ Xi @ Xs1 @ Xb) @ (cco @ (ccfv @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (cco @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xs1 @ Xb)) @ (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (Xc_xp @ Xs1 @ Xb)) @ (Xc_mi @ Xs1 @ Xb)))))))))))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((Xc_ex @ Xn @ Xs1 @ Xb) = (ccfv @ (ccfv @ (XY @ Xs1 @ Xb) @ ccmgp) @ ccmg))))) => (! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : (((cw3a @ (cwcel @ (XN @ Xs1 @ Xb) @ ccfn) @ (cwcel @ (XR @ Xs1 @ Xb) @ cccrg) @ (cwcel @ (XM @ Xs1 @ Xb) @ (XB2 @ Xs1 @ Xb))) & ((cwcel @ (ccv @ Xs1) @ ccn) & (cwcel @ (ccv @ Xb) @ (cco @ (XB2 @ Xs1 @ Xb) @ (cco @ ccc0 @ (ccv @ Xs1) @ ccfz) @ ccmap)))) => ((cco @ (XY @ Xs1 @ Xb) @ (ccmpt @ (^ [Xi:$i] : ccn0) @ (^ [Xi:$i] : (cco @ (cco @ (ccv @ Xi) @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xs1 @ Xb)) @ (Xc_ex @ Xn @ Xs1 @ Xb)) @ (ccfv @ (ccv @ Xi) @ (XG @ Xn @ Xs1 @ Xb)) @ (Xc_xp @ Xs1 @ Xb)))) @ ccgsu) = (Xc_0 @ Xi @ Xs1 @ Xb))))))))))))))))))))))))))))))).
