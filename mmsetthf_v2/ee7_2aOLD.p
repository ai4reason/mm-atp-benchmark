...
thf(anndivsub_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccn)) & ((cwcel @ (cco @ XA2 @ XC @ ccdiv) @ ccn) & (cwbr @ XA2 @ XB2 @ cclt))) => ((cwcel @ (cco @ XB2 @ XC @ ccdiv) @ ccn) <=> (cwcel @ (cco @ (cco @ XB2 @ XA2 @ ccmin) @ XC @ ccdiv) @ ccn))))))).
