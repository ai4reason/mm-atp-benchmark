...
thf(amulcanenq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccnpi) @ (cwcel @ XB2 @ ccnpi) @ (cwcel @ XC @ ccnpi)) => (cwbr @ (ccop @ (cco @ XA2 @ XB2 @ ccmi) @ (cco @ XA2 @ XC @ ccmi)) @ (ccop @ XB2 @ XC) @ cceq)))))).
...
thf(cltexnq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccnq) => ((cwbr @ XA2 @ XB2 @ ccltq) <=> (? [Xx3:$i] : ((cco @ XA2 @ (ccv @ Xx3) @ ccplq) = XB2))))))).
