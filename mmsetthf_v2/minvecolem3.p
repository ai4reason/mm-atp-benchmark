...
thf(asspba_ax,axiom,(! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XY = (ccfv @ XW @ ccba)) => ((XH = (ccfv @ XU @ ccss)) => (((cwcel @ XU @ ccnv) & (cwcel @ XW @ XH)) => (cwss @ XY @ XX))))))))))).
...
thf(aminvecolem2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xy1:$i] : ((XX @ Xy1) = (ccfv @ XU @ ccba))) => ((XM = (ccfv @ XU @ ccnsb)) => ((XN = (ccfv @ XU @ ccnmcv)) => ((XY = (ccfv @ XW @ ccba)) => ((Xph => (cwcel @ XU @ cccphlo)) => ((Xph => (cwcel @ XW @ (ccin @ (ccfv @ XU @ ccss) @ cccbn))) => ((! [Xy1:$i] : (Xph => (cwcel @ XA2 @ (XX @ Xy1)))) => ((XD = (ccfv @ XU @ ccims)) => ((XJ = (ccfv @ XD @ ccmopn)) => ((! [Xy1:$i] : ((XR @ Xy1) = (ccrn @ (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ XM) @ XN)))))) => ((! [Xy1:$i] : (XS = (ccinf @ (XR @ Xy1) @ ccr @ cclt))) => ((! [Xy1:$i] : (Xph => (cwcel @ (XB2 @ Xy1) @ ccr))) => ((! [Xy1:$i] : (Xph => (cwbr @ ccc0 @ (XB2 @ Xy1) @ ccle))) => ((Xph => (cwcel @ XK @ XY)) => ((Xph => (cwcel @ XL @ XY)) => ((! [Xy1:$i] : (Xph => (cwbr @ (cco @ (cco @ XA2 @ XK @ XD) @ cc2 @ ccexp) @ (cco @ (cco @ XS @ cc2 @ ccexp) @ (XB2 @ Xy1) @ ccaddc) @ ccle))) => ((! [Xy1:$i] : (Xph => (cwbr @ (cco @ (cco @ XA2 @ XL @ XD) @ cc2 @ ccexp) @ (cco @ (cco @ XS @ cc2 @ ccexp) @ (XB2 @ Xy1) @ ccaddc) @ ccle))) => (! [Xy1:$i] : (Xph => (cwbr @ (cco @ (cco @ XK @ XL @ XD) @ cc2 @ ccexp) @ (cco @ cc4 @ (XB2 @ Xy1) @ ccmul) @ ccle)))))))))))))))))))))))))))))))))))).
...
thf(aminvecolem1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xy1:$i] : ((XX @ Xy1) = (ccfv @ XU @ ccba))) => ((XM = (ccfv @ XU @ ccnsb)) => ((XN = (ccfv @ XU @ ccnmcv)) => ((XY = (ccfv @ XW @ ccba)) => ((Xph => (cwcel @ XU @ cccphlo)) => ((Xph => (cwcel @ XW @ (ccin @ (ccfv @ XU @ ccss) @ cccbn))) => ((! [Xy1:$i] : (Xph => (cwcel @ XA2 @ (XX @ Xy1)))) => ((XD = (ccfv @ XU @ ccims)) => ((XJ = (ccfv @ XD @ ccmopn)) => ((! [Xy1:$i] : ((XR @ Xy1) = (ccrn @ (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ XM) @ XN)))))) => (! [Xy1:$i] : (Xph => (cw3a @ (cwss @ (XR @ Xy1) @ ccr) @ (cwne @ (XR @ Xy1) @ cc0) @ (cwral @ (^ [Xw:$i] : (cwbr @ ccc0 @ (ccv @ Xw) @ ccle)) @ (^ [Xw:$i] : (XR @ Xy1)))))))))))))))))))))))))))).
