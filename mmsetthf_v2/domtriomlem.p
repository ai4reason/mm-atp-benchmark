...
thf(apwsdompw_ax,axiom,(! [XB2:($i > $o)] : (! [Xn:$i] : (((cwcel @ (ccv @ Xn) @ ccom) & (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ (ccv @ Xk) @ XB2) @ (ccpw @ (ccv @ Xk)) @ ccen)) @ (^ [Xk:$i] : (ccsuc @ (ccv @ Xn))))) => (cwbr @ (cciun @ (^ [Xk:$i] : (ccv @ Xn)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XB2))) @ (ccfv @ (ccv @ Xn) @ XB2) @ ccsdm))))).
thf(asdomdif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccsdm) => (cwne @ (ccdif @ XB2 @ XA2) @ cc0))))).
...
thf(cdomtriomlem_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (cwcel @ (XA2 @ Xk) @ ccvv)) => ((! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XB2 @ Xy1 @ Xk @ Xn) = (ccab @ (^ [Xy1:$i] : ((cwss @ (ccv @ Xy1) @ (XA2 @ Xk)) & (cwbr @ (ccv @ Xy1) @ (ccpw @ (ccv @ Xn)) @ ccen)))))))) => ((! [Xy1:$i] : (! [Xb:$i] : ((XC @ Xy1 @ Xb) = (ccmpt @ (^ [Xn:$i] : ccom) @ (^ [Xn:$i] : (ccdif @ (ccfv @ (ccv @ Xn) @ (ccv @ Xb)) @ (cciun @ (^ [Xk:$i] : (ccv @ Xn)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xb)))))))))) => (! [Xk:$i] : ((~ (cwcel @ (XA2 @ Xk) @ ccfn)) => (cwbr @ ccom @ (XA2 @ Xk) @ ccdom)))))))))).
