...
thf(aicopnfsup_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwne @ XA2 @ ccpnf)) => ((ccsup @ (cco @ XA2 @ ccpnf @ ccico) @ ccxr @ cclt) = ccpnf)))).
thf(climinfresico_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XM @ ccr)) => ((XZ = (cco @ XM @ ccpnf @ ccico)) => ((Xph => (cwcel @ XF @ XV)) => (Xph => ((ccfv @ (ccres @ XF @ XZ) @ cclsi) = (ccfv @ XF @ cclsi)))))))))))).
