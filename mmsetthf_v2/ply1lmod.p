...
thf(apsr1lmod_ax,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : ((XP = (ccfv @ XR @ ccps1)) => ((cwcel @ XR @ ccrg) => (cwcel @ XP @ cclmod)))))).
...
thf(cply1lmod_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((cwcel @ XR @ ccrg) => (cwcel @ XP @ cclmod)))))).
