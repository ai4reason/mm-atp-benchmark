...
thf(acpmadugsumlemF_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [Xc_pl:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_1:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xs1:$i] : (! [Xb:$i] : ((! [Xi:$i] : ((XA2 @ Xi) = (cco @ XN @ XR @ ccmat))) => ((! [Xi:$i] : (XB2 = (ccfv @ (XA2 @ Xi) @ ccbs))) => ((! [Xi:$i] : ((XP @ Xi) = (ccfv @ XR @ ccpl1))) => ((! [Xi:$i] : (XY = (cco @ XN @ (XP @ Xi) @ ccmat))) => ((XT = (cco @ XN @ XR @ ccmat2pmat)) => ((XX = (ccfv @ XR @ ccv1)) => ((! [Xi:$i] : (Xc_ex = (ccfv @ (ccfv @ (XP @ Xi) @ ccmgp) @ ccmg))) => ((Xc_x = (ccfv @ XY @ ccvsca)) => ((Xc_xp = (ccfv @ XY @ ccmulr)) => ((Xc_1 = (ccfv @ XY @ ccur)) => ((! [Xi:$i] : ((Xc_pl @ Xi) = (ccfv @ XY @ ccplusg))) => ((Xc_mi = (ccfv @ XY @ ccsg)) => (! [Xi:$i] : (((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ cccrg) @ (cwcel @ XM @ XB2)) & ((cwcel @ (ccv @ Xs1) @ ccn) & (cwcel @ (ccv @ Xb) @ (cco @ XB2 @ (cco @ ccc0 @ (ccv @ Xs1) @ ccfz) @ ccmap)))) => ((cco @ (cco @ (cco @ XX @ Xc_1 @ Xc_x) @ (cco @ XY @ (ccmpt @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xs1) @ ccfz)) @ (^ [Xi:$i] : (cco @ (cco @ (ccv @ Xi) @ XX @ Xc_ex) @ (ccfv @ (ccfv @ (ccv @ Xi) @ (ccv @ Xb)) @ XT) @ Xc_x))) @ ccgsu) @ Xc_xp) @ (cco @ (ccfv @ XM @ XT) @ (cco @ XY @ (ccmpt @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xs1) @ ccfz)) @ (^ [Xi:$i] : (cco @ (cco @ (ccv @ Xi) @ XX @ Xc_ex) @ (ccfv @ (ccfv @ (ccv @ Xi) @ (ccv @ Xb)) @ XT) @ Xc_x))) @ ccgsu) @ Xc_xp) @ Xc_mi) = (cco @ (cco @ XY @ (ccmpt @ (^ [Xi:$i] : (cco @ cc1 @ (ccv @ Xs1) @ ccfz)) @ (^ [Xi:$i] : (cco @ (cco @ (ccv @ Xi) @ XX @ Xc_ex) @ (cco @ (ccfv @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccmin) @ (ccv @ Xb)) @ XT) @ (cco @ (ccfv @ XM @ XT) @ (ccfv @ (ccfv @ (ccv @ Xi) @ (ccv @ Xb)) @ XT) @ Xc_xp) @ Xc_mi) @ Xc_x))) @ ccgsu) @ (cco @ (cco @ (cco @ (cco @ (ccv @ Xs1) @ cc1 @ ccaddc) @ XX @ Xc_ex) @ (ccfv @ (ccfv @ (ccv @ Xs1) @ (ccv @ Xb)) @ XT) @ Xc_x) @ (cco @ (ccfv @ XM @ XT) @ (ccfv @ (ccfv @ ccc0 @ (ccv @ Xb)) @ XT) @ Xc_xp) @ Xc_mi) @ (Xc_pl @ Xi))))))))))))))))))))))))))))))))))).
...
thf(amaduf_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XJ = (cco @ XN @ XR @ ccmadu)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((cwcel @ XR @ cccrg) => (cwf @ XB2 @ XB2 @ XJ))))))))))).
thf(achmatcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XY = (cco @ XN @ XP @ ccmat)) => ((XX = (ccfv @ XR @ ccv1)) => ((XT = (cco @ XN @ XR @ ccmat2pmat)) => ((Xc_mi = (ccfv @ XY @ ccsg)) => ((Xc_x = (ccfv @ XY @ ccvsca)) => ((Xc_1 = (ccfv @ XY @ ccur)) => ((XH = (cco @ (cco @ XX @ Xc_1 @ Xc_x) @ (ccfv @ XM @ XT) @ Xc_mi)) => ((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg) @ (cwcel @ XM @ XB2)) => (cwcel @ XH @ (ccfv @ XY @ ccbs))))))))))))))))))))))))))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(apmatcollpw3fi1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [Xc_ex:($i > $o)] : (! [Xc_as:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((! [Xf1:$i] : (! [Xs1:$i] : ((XP @ Xf1 @ Xs1) = (ccfv @ XR @ ccpl1)))) => ((! [Xf1:$i] : (! [Xs1:$i] : (XC = (cco @ XN @ (XP @ Xf1 @ Xs1) @ ccmat)))) => ((XB2 = (ccfv @ XC @ ccbs)) => ((! [Xn:$i] : ((Xc_as @ Xn) = (ccfv @ XC @ ccvsca))) => ((! [Xf1:$i] : (! [Xs1:$i] : (Xc_ex = (ccfv @ (ccfv @ (XP @ Xf1 @ Xs1) @ ccmgp) @ ccmg)))) => ((XX = (ccfv @ XR @ ccv1)) => ((! [Xn:$i] : ((XT @ Xn) = (cco @ XN @ XR @ ccmat2pmat))) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XD = (ccfv @ XA2 @ ccbs)) => ((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ cccrg) @ (cwcel @ XM @ XB2)) => (cwrex @ (^ [Xs1:$i] : (cwrex @ (^ [Xf1:$i] : (XM = (cco @ XC @ (ccmpt @ (^ [Xn:$i] : (cco @ ccc0 @ (ccv @ Xs1) @ ccfz)) @ (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xn) @ XX @ Xc_ex) @ (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ (XT @ Xn)) @ (Xc_as @ Xn)))) @ ccgsu))) @ (^ [Xf1:$i] : (cco @ XD @ (cco @ ccc0 @ (ccv @ Xs1) @ ccfz) @ ccmap)))) @ (^ [Xs1:$i] : ccn))))))))))))))))))))))))).
thf(ccpmadugsumfi_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [Xc_pl:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > ($i > ($i > $o)))] : (! [Xc_1:($i > ($i > ($i > $o)))] : (! [Xc_ex:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xi:$i] : ((XA2 @ Xi) = (cco @ XN @ XR @ ccmat))) => ((! [Xi:$i] : (XB2 = (ccfv @ (XA2 @ Xi) @ ccbs))) => ((! [Xs1:$i] : (! [Xb:$i] : ((XP @ Xs1 @ Xb) = (ccfv @ XR @ ccpl1)))) => ((! [Xs1:$i] : (! [Xb:$i] : (XY = (cco @ XN @ (XP @ Xs1 @ Xb) @ ccmat)))) => ((XT = (cco @ XN @ XR @ ccmat2pmat)) => ((XX = (ccfv @ XR @ ccv1)) => ((! [Xs1:$i] : (! [Xb:$i] : (Xc_ex = (ccfv @ (ccfv @ (XP @ Xs1 @ Xb) @ ccmgp) @ ccmg)))) => ((Xc_x = (ccfv @ XY @ ccvsca)) => ((! [Xs1:$i] : (! [Xb:$i] : ((Xc_xp @ Xs1 @ Xb) = (ccfv @ XY @ ccmulr)))) => ((! [Xs1:$i] : (! [Xb:$i] : ((Xc_1 @ Xs1 @ Xb) = (ccfv @ XY @ ccur)))) => ((! [Xi:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((Xc_pl @ Xi @ Xs1 @ Xb) = (ccfv @ XY @ ccplusg))))) => ((! [Xs1:$i] : (! [Xb:$i] : ((Xc_mi @ Xs1 @ Xb) = (ccfv @ XY @ ccsg)))) => ((! [Xs1:$i] : (! [Xb:$i] : (XI = (cco @ (cco @ XX @ (Xc_1 @ Xs1 @ Xb) @ Xc_x) @ (ccfv @ XM @ XT) @ (Xc_mi @ Xs1 @ Xb))))) => ((! [Xs1:$i] : (! [Xb:$i] : (XJ = (cco @ XN @ (XP @ Xs1 @ Xb) @ ccmadu)))) => (! [Xi:$i] : ((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ cccrg) @ (cwcel @ XM @ XB2)) => (cwrex @ (^ [Xs1:$i] : (cwrex @ (^ [Xb:$i] : ((cco @ XI @ (ccfv @ XI @ XJ) @ (Xc_xp @ Xs1 @ Xb)) = (cco @ (cco @ XY @ (ccmpt @ (^ [Xi:$i] : (cco @ cc1 @ (ccv @ Xs1) @ ccfz)) @ (^ [Xi:$i] : (cco @ (cco @ (ccv @ Xi) @ XX @ Xc_ex) @ (cco @ (ccfv @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccmin) @ (ccv @ Xb)) @ XT) @ (cco @ (ccfv @ XM @ XT) @ (ccfv @ (ccfv @ (ccv @ Xi) @ (ccv @ Xb)) @ XT) @ (Xc_xp @ Xs1 @ Xb)) @ (Xc_mi @ Xs1 @ Xb)) @ Xc_x))) @ ccgsu) @ (cco @ (cco @ (cco @ (cco @ (ccv @ Xs1) @ cc1 @ ccaddc) @ XX @ Xc_ex) @ (ccfv @ (ccfv @ (ccv @ Xs1) @ (ccv @ Xb)) @ XT) @ Xc_x) @ (cco @ (ccfv @ XM @ XT) @ (ccfv @ (ccfv @ ccc0 @ (ccv @ Xb)) @ XT) @ (Xc_xp @ Xs1 @ Xb)) @ (Xc_mi @ Xs1 @ Xb)) @ (Xc_pl @ Xi @ Xs1 @ Xb)))) @ (^ [Xb:$i] : (cco @ XB2 @ (cco @ ccc0 @ (ccv @ Xs1) @ ccfz) @ ccmap)))) @ (^ [Xs1:$i] : ccn)))))))))))))))))))))))))))))))))))).
