...
thf(ccoe1sclmulfv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((XA2 = (ccfv @ XP @ ccascl)) => ((Xc_xb = (ccfv @ XP @ ccmulr)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((cw3a @ (cwcel @ XR @ ccrg) @ ((cwcel @ XX @ XK) & (cwcel @ XY @ XB2)) @ (cwcel @ Xc_0 @ ccn0)) => ((ccfv @ Xc_0 @ (ccfv @ (cco @ (ccfv @ XX @ XA2) @ XY @ Xc_xb) @ ccco1)) = (cco @ XX @ (ccfv @ Xc_0 @ (ccfv @ XY @ ccco1)) @ Xc_x)))))))))))))))))))).
