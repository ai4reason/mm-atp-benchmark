...
thf(aatlex_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccfv @ XK @ ccbs))) => ((! [Xy1:$i] : ((Xc_le @ Xy1) = (ccfv @ XK @ ccple))) => ((! [Xy1:$i] : ((Xc_0 @ Xy1) = (ccfv @ XK @ ccp0))) => ((XA2 = (ccfv @ XK @ ccatm)) => (! [Xy1:$i] : ((cw3a @ (cwcel @ XK @ ccal) @ (cwcel @ XX @ (XB2 @ Xy1)) @ (cwne @ XX @ (Xc_0 @ Xy1))) => (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ XX @ (Xc_le @ Xy1))) @ (^ [Xy1:$i] : XA2))))))))))))))).
...
thf(acvrat3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cwcel @ XK @ cchlt) & (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2))) => ((cw3a @ (cwne @ XP @ XQ) @ (~ (cwbr @ XQ @ XX @ Xc_le)) @ (cwbr @ XP @ (cco @ XX @ XQ @ Xc_or) @ Xc_le)) => (cwcel @ (cco @ XX @ (cco @ XP @ XQ @ Xc_or) @ Xc_an) @ XA2)))))))))))))))))).
...
thf(aimp44_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => (Xps => (Xch => (Xth => Xta)))) => ((Xph & ((Xps & Xch) & Xth)) => Xta)))))))).
...
thf(alatmcom_ax,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((cw3a @ (cwcel @ XK @ cclat) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => ((cco @ XX @ XY @ Xc_an) = (cco @ XY @ XX @ Xc_an))))))))))).
...
thf(aople0_ax,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => (((cwcel @ XK @ ccops) & (cwcel @ XX @ XB2)) => ((cwbr @ XX @ Xc_0 @ Xc_le) <=> (XX = Xc_0)))))))))))).
...
thf(ahlexch3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2) @ (cwcel @ XX @ XB2)) @ ((cco @ XP @ XX @ Xc_an) = Xc_0)) => ((cwbr @ XP @ (cco @ XX @ XQ @ Xc_or) @ Xc_le) => (cwbr @ XQ @ (cco @ XX @ XP @ Xc_or) @ Xc_le)))))))))))))))))))).
thf(ccvrat4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((! [Xr:$i] : ((Xc_0 @ Xr) = (ccfv @ XK @ ccp0))) => ((XA2 = (ccfv @ XK @ ccatm)) => (! [Xr:$i] : (((cwcel @ XK @ cchlt) & (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2))) => (((cwne @ XX @ (Xc_0 @ Xr)) & (cwbr @ XP @ (cco @ XX @ XQ @ Xc_or) @ Xc_le)) => (cwrex @ (^ [Xr:$i] : ((cwbr @ (ccv @ Xr) @ XX @ Xc_le) & (cwbr @ XP @ (cco @ XQ @ (ccv @ Xr) @ Xc_or) @ Xc_le))) @ (^ [Xr:$i] : XA2)))))))))))))))))))).
