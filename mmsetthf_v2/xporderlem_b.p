...
thf(cxporderlem_b_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XT @ Xx3 @ Xy1 @ Xa @ Xb) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (ccxp @ (XA2 @ Xa @ Xb) @ (XB2 @ Xa @ Xb))) & (cwcel @ (ccv @ Xy1) @ (ccxp @ (XA2 @ Xa @ Xb) @ (XB2 @ Xa @ Xb)))) & ((cwbr @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc1st) @ (XR @ Xa @ Xb)) | (((ccfv @ (ccv @ Xx3) @ cc1st) = (ccfv @ (ccv @ Xy1) @ cc1st)) & (cwbr @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccfv @ (ccv @ Xy1) @ cc2nd) @ (XS @ Xa @ Xb))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((cwbr @ (ccop @ (ccv @ Xa) @ (ccv @ Xb)) @ (ccop @ (ccv @ Xa) @ (ccv @ Xb)) @ (XT @ Xx3 @ Xy1 @ Xa @ Xb)) <=> ((((cwcel @ (ccv @ Xa) @ (XA2 @ Xa @ Xb)) & (cwcel @ (ccv @ Xa) @ (XA2 @ Xa @ Xb))) & ((cwcel @ (ccv @ Xb) @ (XB2 @ Xa @ Xb)) & (cwcel @ (ccv @ Xb) @ (XB2 @ Xa @ Xb)))) & ((cwbr @ (ccv @ Xa) @ (ccv @ Xa) @ (XR @ Xa @ Xb)) | (((ccv @ Xa) = (ccv @ Xa)) & (cwbr @ (ccv @ Xb) @ (ccv @ Xb) @ (XS @ Xa @ Xb))))))))))))))))).
