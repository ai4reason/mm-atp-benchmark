...
thf(adf_ordt_ax,axiom,(ccordt = (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccfv @ (ccfv @ (ccun @ (ccsn @ (ccdm @ (ccv @ Xr))) @ (ccrn @ (ccun @ (ccmpt @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xr))) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccv @ Xr)))) @ (^ [Xy1:$i] : (ccdm @ (ccv @ Xr)))))) @ (ccmpt @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xr))) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xr)))) @ (^ [Xy1:$i] : (ccdm @ (ccv @ Xr))))))))) @ ccfi) @ cctg))))).
