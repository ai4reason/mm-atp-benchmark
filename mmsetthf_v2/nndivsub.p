...
thf(a_3impdir_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((((Xph & Xps) & (Xch & Xps)) => Xth) => ((cw3a @ Xph @ Xch @ Xps) => Xth))))))).
thf(aanim12i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xch => Xth) => ((Xph & Xch) => (Xps & Xth))))))))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(annssi2_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((cwss @ ccn @ XD) => (((cwcel @ XB2 @ ccn) => Xph) => (((cw3a @ (cwcel @ XA2 @ XD) @ (cwcel @ XB2 @ XD) @ Xph) => Xps) => (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn)) => Xps)))))))))).
...
thf(cnndivsub_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccn)) & ((cwcel @ (cco @ XA2 @ XC @ ccdiv) @ ccn) & (cwbr @ XA2 @ XB2 @ cclt))) => ((cwcel @ (cco @ XB2 @ XC @ ccdiv) @ ccn) <=> (cwcel @ (cco @ (cco @ XB2 @ XA2 @ ccmin) @ XC @ ccdiv) @ ccn))))))).
