...
thf(atnggrpr_ax,axiom,(! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XT = (cco @ XG @ XN @ cctng)) => (((cwcel @ XN @ XV) & (cwcel @ XT @ ccngp)) => (cwcel @ XG @ ccgrp)))))))).
...
thf(atngngpd_ax,axiom,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (XT = (cco @ (XG @ Xx3 @ Xy1) @ XN @ cctng)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XX = (ccfv @ (XG @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xc_mi = (ccfv @ (XG @ Xx3 @ Xy1) @ ccsg)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xc_0 = (ccfv @ (XG @ Xx3 @ Xy1) @ cc0g)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XG @ Xx3 @ Xy1) @ ccgrp)))) => ((Xph => (cwf @ XX @ ccr @ XN)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (((ccfv @ (ccv @ Xx3) @ XN) = ccc0) <=> ((ccv @ Xx3) = Xc_0)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xy1) @ XX))) => (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_mi) @ XN) @ (cco @ (ccfv @ (ccv @ Xx3) @ XN) @ (ccfv @ (ccv @ Xy1) @ XN) @ ccaddc) @ ccle)))) => (Xph => (cwcel @ XT @ ccngp)))))))))))))))))).
