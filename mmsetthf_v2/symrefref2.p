...
thf(aidreseqidinxp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ XB2) => ((ccin @ ccid @ (ccxp @ XA2 @ XB2)) = (ccres @ ccid @ XA2)))))).
thf(csymrefref2_conj,conjecture,(! [XR:($i > $o)] : ((cwss @ (cccnv @ XR) @ XR) => ((cwss @ (ccin @ ccid @ (ccxp @ (ccdm @ XR) @ (ccrn @ XR))) @ XR) <=> (cwss @ (ccres @ ccid @ (ccdm @ XR)) @ XR))))).
