...
thf(acoe1mul4_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XY = (ccfv @ XR @ ccpl1)) => ((Xc_xb = (ccfv @ XY @ ccmulr)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XD = (ccfv @ XR @ ccdg1)) => ((Xc_0 = (ccfv @ XY @ cc0g)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XF @ XB2)) => ((Xph => (cwne @ XF @ Xc_0)) => ((Xph => (cwcel @ XG @ XB2)) => ((Xph => (cwne @ XG @ Xc_0)) => (Xph => ((ccfv @ (cco @ (ccfv @ XF @ XD) @ (ccfv @ XG @ XD) @ ccaddc) @ (ccfv @ (cco @ XF @ XG @ Xc_xb) @ ccco1)) = (cco @ (ccfv @ (ccfv @ XF @ XD) @ (ccfv @ XF @ ccco1)) @ (ccfv @ (ccfv @ XG @ XD) @ (ccfv @ XG @ ccco1)) @ Xc_x))))))))))))))))))))))))).
...
thf(arrgeq0i_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XE = (ccfv @ XR @ ccrlreg)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XX @ XE) & (cwcel @ XY @ XB2)) => (((cco @ XX @ XY @ Xc_x) = Xc_0) => (XY = Xc_0))))))))))))))).
thf(cclt_tp,type,(cclt : ($i > $o))).
thf(adeg1ge_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XA2 = (ccfv @ XF @ ccco1)) => ((cw3a @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ ccn0) @ (cwne @ (ccfv @ XG @ XA2) @ Xc_0)) => (cwbr @ XG @ (ccfv @ XF @ XD) @ ccle)))))))))))))))).
...
thf(cdeg1mul2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XE = (ccfv @ XR @ ccrlreg)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xc_x = (ccfv @ XP @ ccmulr)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XF @ XB2)) => ((Xph => (cwne @ XF @ Xc_0)) => ((Xph => (cwcel @ (ccfv @ (ccfv @ XF @ XD) @ (ccfv @ XF @ ccco1)) @ XE)) => ((Xph => (cwcel @ XG @ XB2)) => ((Xph => (cwne @ XG @ Xc_0)) => (Xph => ((ccfv @ (cco @ XF @ XG @ Xc_x) @ XD) = (cco @ (ccfv @ XF @ XD) @ (ccfv @ XG @ XD) @ ccaddc)))))))))))))))))))))))))).
