...
thf(cdomnmuln0_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cw3a @ (cwcel @ XR @ ccdomn) @ ((cwcel @ XX @ XB2) & (cwne @ XX @ Xc_0)) @ ((cwcel @ XY @ XB2) & (cwne @ XY @ Xc_0))) => (cwne @ (cco @ XX @ XY @ Xc_x) @ Xc_0)))))))))))).
