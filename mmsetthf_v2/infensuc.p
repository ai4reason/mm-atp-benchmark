...
thf(aomon_ax,axiom,((cwcel @ ccom @ ccon0) | (ccom = ccon0))).
...
thf(alimensuci_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwlim @ XA2) => ((cwcel @ XA2 @ XV) => (cwbr @ XA2 @ (ccsuc @ XA2) @ ccen)))))).
...
thf(alimensuc_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwlim @ XA2)) => (cwbr @ XA2 @ (ccsuc @ XA2) @ ccen))))).
thf(cinfensuc_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwss @ ccom @ XA2)) => (cwbr @ XA2 @ (ccsuc @ XA2) @ ccen)))).
