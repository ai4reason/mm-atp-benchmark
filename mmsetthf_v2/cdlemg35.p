...
thf(ccdlemg35_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > ($i > $o))] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((! [Xv:$i] : ((Xc_or @ Xv) = (ccfv @ XK @ ccjn))) => ((! [Xv:$i] : ((Xc_an @ Xv) = (ccfv @ XK @ ccmee))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ (cw3a @ ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) @ (cwcel @ XF @ XT) @ (cwcel @ XG @ XT)) @ (cw3a @ (cwne @ (ccfv @ XP @ XF) @ XP) @ (cwne @ (ccfv @ XP @ XG) @ XP) @ (cwne @ (ccfv @ XF @ XR) @ (ccfv @ XG @ XR)))) => (cwrex @ (^ [Xv:$i] : ((cwbr @ (ccv @ Xv) @ XW @ Xc_le) & ((cwne @ (ccv @ Xv) @ (ccfv @ XF @ XR)) & (cwne @ (ccv @ Xv) @ (ccfv @ XG @ XR))))) @ (^ [Xv:$i] : XA2))))))))))))))))))))))).
