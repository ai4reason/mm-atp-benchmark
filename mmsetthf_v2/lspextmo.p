...
thf(almhmeql_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XU = (ccfv @ XS @ cclss)) => (((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) & (cwcel @ XG @ (cco @ XS @ XT @ cclmhm))) => (cwcel @ (ccdm @ (ccin @ XF @ XG)) @ XU))))))))).
