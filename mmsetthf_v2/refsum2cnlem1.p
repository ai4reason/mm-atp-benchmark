...
thf(arefsumcn_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XK @ Xx3 @ Xk) = (ccfv @ (ccrn @ ccioo) @ cctg)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XJ @ (ccfv @ XX @ cctopon)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ ccfn))) => ((! [Xx3:$i] : (! [Xk:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xk))) @ (cco @ XJ @ (XK @ Xx3 @ Xk) @ cccn))))) => (! [Xx3:$i] : (! [Xk:$i] : ((Xph @ Xx3) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xx3 @ Xk))))) @ (cco @ XJ @ (XK @ Xx3 @ Xk) @ cccn))))))))))))))))).
