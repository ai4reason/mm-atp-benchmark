...
thf(covn0_conj,conjecture,(! [Xph:$o] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => (Xph => ((ccfv @ cc0 @ (ccfv @ XX @ ccovoln)) = ccc0)))))).
