...
thf(austdiag_ax,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ XV @ XU)) => (cwss @ (ccres @ ccid @ XX) @ XV)))))).
...
thf(custuqtop3_conj,conjecture,(! [XU:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xv:$i] : ((XN @ Xv) = (ccmpt @ (^ [Xp:$i] : XX) @ (^ [Xp:$i] : (ccrn @ (ccmpt @ (^ [Xv:$i] : XU) @ (^ [Xv:$i] : (ccima @ (ccv @ Xv) @ (ccsn @ (ccv @ Xp)))))))))) => (! [Xv:$i] : (! [Xp:$i] : (! [Xa:$i] : ((((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ (ccv @ Xp) @ XX)) & (cwcel @ (ccv @ Xa) @ (ccfv @ (ccv @ Xp) @ (XN @ Xv)))) => (cwcel @ (ccv @ Xp) @ (ccv @ Xa))))))))))).
