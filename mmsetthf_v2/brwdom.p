...
thf(adf_wdom_ax,axiom,(ccwdom = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((ccv @ Xx3) = cc0) | (? [Xz:$i] : (cwfo @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccv @ Xz))))))))).
thf(cbrwdom_conj,conjecture,(! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xz:$i] : ((cwcel @ XY @ (XV @ Xz)) => ((cwbr @ XX @ XY @ ccwdom) <=> ((XX = cc0) | (? [Xz:$i] : (cwfo @ XY @ XX @ (ccv @ Xz))))))))))).
