...
thf(ambfmax_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : ((Xph => (cwf @ XA2 @ ccr @ XF)) => ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwf @ XA2 @ ccr @ XG)) => ((Xph => (cwcel @ XG @ ccmbf)) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG) @ ccle) @ (ccfv @ (ccv @ Xx3) @ XG) @ (ccfv @ (ccv @ Xx3) @ XF)))))) => (! [Xx3:$i] : (Xph => (cwcel @ (XH @ Xx3) @ ccmbf)))))))))))))).
