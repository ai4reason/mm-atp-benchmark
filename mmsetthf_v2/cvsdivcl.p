...
thf(acvsdiv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ cccvs) & (cw3a @ (cwcel @ XA2 @ XK) @ (cwcel @ XB2 @ XK) @ (cwne @ XB2 @ ccc0))) => ((cco @ XA2 @ XB2 @ ccdiv) = (cco @ XA2 @ XB2 @ (ccfv @ XF @ ccdvr)))))))))))).
...
thf(acvsunit_ax,axiom,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((cwcel @ XW @ cccvs) => ((ccdif @ XK @ (ccsn @ ccc0)) = (ccfv @ XF @ ccui))))))))).
...
thf(ccvsdivcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ cccvs) & (cw3a @ (cwcel @ XA2 @ XK) @ (cwcel @ XB2 @ XK) @ (cwne @ XB2 @ ccc0))) => (cwcel @ (cco @ XA2 @ XB2 @ ccdiv) @ XK)))))))))).
