...
thf(cfcomptf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => (! [Xx3:$i] : (((cwf @ XD @ XE @ XA2) & (cwf @ XC @ XD @ (XB2 @ Xx3))) => ((cccom @ XA2 @ (XB2 @ Xx3)) = (ccmpt @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ (XB2 @ Xx3)) @ XA2))))))))))))).
