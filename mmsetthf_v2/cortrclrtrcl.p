...
thf(acotrclrcl_ax,axiom,((cccom @ cctcl @ ccrcl) = ccrtcl)).
...
thf(acorclrtrcl_ax,axiom,((cccom @ ccrcl @ ccrtcl) = ccrtcl)).
thf(acotrclrtrcl_ax,axiom,((cccom @ cctcl @ ccrtcl) = ccrtcl)).
thf(ccortrclrtrcl_conj,conjecture,((cccom @ ccrtcl @ ccrtcl) = ccrtcl)).
