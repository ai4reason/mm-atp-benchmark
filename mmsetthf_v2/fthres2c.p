...
thf(cfthres2c_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (ccfv @ XC @ ccbs)) => ((XE = (cco @ XD @ XS @ ccress)) => ((Xph => (cwcel @ XD @ cccat)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwf @ XA2 @ XS @ XF)) => (Xph => ((cwbr @ XF @ XG @ (cco @ XC @ XD @ ccfth)) <=> (cwbr @ XF @ XG @ (cco @ XC @ XE @ ccfth))))))))))))))))))).
