...
thf(adf_inv_ax,axiom,(ccinv = (ccmpt @ (^ [Xc:$i] : cccat) @ (^ [Xc:$i] : (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xc) @ ccbs))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xc) @ ccbs))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccin @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xc) @ ccsect)) @ (cccnv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xc) @ ccsect))))))))))).
...
thf(aisofval_ax,axiom,(! [XC:($i > $o)] : ((cwcel @ XC @ cccat) => ((ccfv @ XC @ cciso) = (cccom @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xx3)))) @ (ccfv @ XC @ ccinv)))))).
thf(cisofn_conj,conjecture,(! [XC:($i > $o)] : ((cwcel @ XC @ cccat) => (cwfn @ (ccfv @ XC @ cciso) @ (ccxp @ (ccfv @ XC @ ccbs) @ (ccfv @ XC @ ccbs)))))).
