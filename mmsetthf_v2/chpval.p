...
thf(adf_chp_ax,axiom,(ccchp = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ ccvma))))))).
...
thf(cchpval_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ XA2 @ ccchp) = (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ ccvma))))))).
