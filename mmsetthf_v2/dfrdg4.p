...
thf(adfrdg3_ax,axiom,(! [XF:($i > $o)] : (! [XI:($i > $o)] : ((ccrdg @ XF @ XI) = (ccuni @ (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) = (ccif @ ((ccv @ Xy1) = cc0) @ (ccif @ (cwcel @ XI @ ccvv) @ XI @ cc0) @ (ccif @ (cwlim @ (ccv @ Xy1)) @ (ccuni @ (ccima @ (ccv @ Xf1) @ (ccv @ Xy1))) @ (ccfv @ (ccfv @ (ccuni @ (ccv @ Xy1)) @ (ccv @ Xf1)) @ XF))))) @ (^ [Xy1:$i] : (ccv @ Xx3))))) @ (^ [Xx3:$i] : ccon0))))))))).
...
thf(abrapply_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwbr @ (ccop @ XA2 @ XB2) @ XC @ ccapply) <=> (XC = (ccfv @ XB2 @ XA2)))))))))).
thf(abrfullfun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwbr @ XA2 @ XB2 @ (ccfullfn @ XF)) <=> (XB2 = (ccfv @ XA2 @ XF))))))))).
...
thf(abrsuccf_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwbr @ XA2 @ XB2 @ ccsuccf) <=> (XB2 = (ccsuc @ XA2)))))))).
...
thf(aunisnif_ax,axiom,(! [XA2:($i > $o)] : ((ccuni @ (ccsn @ XA2)) = (ccif @ (cwcel @ XA2 @ ccvv) @ XA2 @ cc0)))).
...
thf(anlimsucg_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (~ (cwlim @ (ccsuc @ XA2))))))).
...
thf(cdfrdg4_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((ccrdg @ XF @ XA2) = (ccuni @ (ccdif @ (ccin @ ccfuns @ (ccima @ (cccnv @ ccdomain) @ ccon0)) @ (ccdm @ (ccdif @ (cccom @ (cccnv @ ccep) @ ccdomain) @ (ccfix @ (cccom @ (cccnv @ ccapply) @ (ccun @ (ccxp @ (ccxp @ ccvv @ (ccsn @ cc0)) @ (ccsn @ (ccuni @ (ccsn @ XA2)))) @ (ccun @ (ccres @ (cccom @ ccbigcup @ ccimg) @ (ccxp @ ccvv @ cclimits)) @ (ccres @ (cccom @ (ccfullfn @ XF) @ (cccom @ ccapply @ (ccpprod @ ccid @ ccbigcup))) @ (ccxp @ ccvv @ (ccrn @ ccsuccf))))))))))))))).
