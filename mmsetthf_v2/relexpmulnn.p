...
thf(crelexpmulnn_conj,conjecture,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XR @ XV) & (XI = (cco @ XJ @ XK @ ccmul))) & ((cwcel @ XJ @ ccn) & (cwcel @ XK @ ccn))) => ((cco @ (cco @ XR @ XJ @ ccrelexp) @ XK @ ccrelexp) = (cco @ XR @ XI @ ccrelexp))))))))).
