...
thf(crgspnval_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (XB2 = (ccfv @ XR @ ccbs))) => ((Xph => (cwss @ XA2 @ XB2)) => ((! [Xt:$i] : (Xph => ((XN @ Xt) = (ccfv @ XR @ ccrgspn)))) => ((! [Xt:$i] : (Xph => ((XU @ Xt) = (ccfv @ XA2 @ (XN @ Xt))))) => (! [Xt:$i] : (Xph => ((XU @ Xt) = (ccint @ (ccrab @ (^ [Xt:$i] : (cwss @ XA2 @ (ccv @ Xt))) @ (^ [Xt:$i] : (ccfv @ XR @ ccsubrg))))))))))))))))))).
