...
thf(ahashvnfin_ax,axiom,(! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XS @ XV) & (cwcel @ XN @ ccn0)) => (((ccfv @ XS @ cchash) = XN) => (cwcel @ XS @ ccfn))))))).
...
thf(chash2pr_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xa:$i] : (! [Xb:$i] : (((cwcel @ XV @ (XW @ Xa @ Xb)) & ((ccfv @ XV @ cchash) = cc2)) => (? [Xa:$i] : (? [Xb:$i] : (XV = (ccpr @ (ccv @ Xa) @ (ccv @ Xb))))))))))).
