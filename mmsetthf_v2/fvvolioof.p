...
thf(cfvvolioof_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwf @ XA2 @ (ccxp @ ccxr @ ccxr) @ XF)) => ((Xph => (cwcel @ XX @ XA2)) => (Xph => ((ccfv @ XX @ (cccom @ (cccom @ ccvol @ ccioo) @ XF)) = (ccfv @ (cco @ (ccfv @ (ccfv @ XX @ XF) @ cc1st) @ (ccfv @ (ccfv @ XX @ XF) @ cc2nd) @ ccioo) @ ccvol)))))))))).
