...
thf(afrege71_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xz:$i] : (cwcel @ XX @ (XV @ Xz))) => (! [Xz:$i] : (((! [Xz:$i] : ((cwbr @ XX @ (ccv @ Xz) @ XR) => (cwcel @ (ccv @ Xz) @ XA2))) => ((cwbr @ XX @ (XY @ Xz) @ XR) => (cwcel @ (XY @ Xz) @ XA2))) => ((cwhe @ XA2 @ XR) => ((cwcel @ XX @ XA2) => ((cwbr @ XX @ (XY @ Xz) @ XR) => (cwcel @ (XY @ Xz) @ XA2))))))))))))).
