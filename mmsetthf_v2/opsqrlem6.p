...
thf(ann1suc_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = cc1) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) => ((Xph @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> (Xth @ Xy1))))) => ((! [Xy1:$i] : (Xps @ Xy1)) => ((! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ ccn) => (Xch @ Xy1))) => (! [Xy1:$i] : ((cwcel @ XA2 @ ccn) => (Xth @ Xy1)))))))))))))).
...
thf(aopsqrlem2_ax,axiom,(! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((cwcel @ XT @ ccho) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XS @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccho)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccho)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (cco @ XT @ (cccom @ (ccv @ Xx3) @ (ccv @ Xx3)) @ cchod) @ cchot) @ cchos))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccseq @ (XS @ Xx3 @ Xy1) @ (ccxp @ ccn @ (ccsn @ cch0o)) @ cc1)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((ccfv @ cc1 @ (XF @ Xx3 @ Xy1)) = cch0o)))))))))).
thf(cc0v_tp,type,(cc0v : ($i > $o))).
thf(cwral_tp,type,(cwral : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(ccle_tp,type,(ccle : ($i > $o))).
thf(ccsp_tp,type,(ccsp : ($i > $o))).
thf(aidleop_ax,axiom,(cwbr @ cch0o @ cchio @ ccleo)).
...
thf(aidhmop_ax,axiom,(cwcel @ cchio @ ccho)).
thf(affvelrni_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => ((cwcel @ XC @ XA2) => (cwcel @ (ccfv @ XC @ XF) @ XB2)))))))).
thf(aopsqrlem4_ax,axiom,(! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((cwcel @ XT @ ccho) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XS @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccho)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccho)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (cco @ XT @ (cccom @ (ccv @ Xx3) @ (ccv @ Xx3)) @ cchod) @ cchot) @ cchos))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccseq @ (XS @ Xx3 @ Xy1) @ (ccxp @ ccn @ (ccsn @ cch0o)) @ cc1)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwf @ ccn @ ccho @ (XF @ Xx3 @ Xy1))))))))))).
thf(ccneg_tp,type,(ccneg : (($i > $o) > ($i > $o)))).
thf(ahmopd_ax,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (((cwcel @ XT @ ccho) & (cwcel @ XU @ ccho)) => (cwcel @ (cco @ XT @ XU @ cchod) @ ccho))))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(amp3an3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (Xch => (((cw3a @ Xph @ Xps @ Xch) => Xth) => ((Xph & Xps) => Xth)))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(ahmopco_ax,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : ((cw3a @ (cwcel @ XT @ ccho) @ (cwcel @ XU @ ccho) @ ((cccom @ XT @ XU) = (cccom @ XU @ XT))) => (cwcel @ (cccom @ XT @ XU) @ ccho))))).
...
thf(aleop3_ax,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (((cwcel @ XT @ ccho) & (cwcel @ XU @ ccho)) => ((cwbr @ XT @ XU @ ccleo) <=> (cwbr @ cch0o @ (cco @ XU @ XT @ cchod) @ ccleo)))))).
thf(ampanl2_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (Xps => ((((Xph & Xps) & Xch) => Xth) => ((Xph & Xch) => Xth)))))))).
thf(ccva_tp,type,(ccva : ($i > $o))).
thf(aleopadd_ax,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : ((((cwcel @ XT @ ccho) & (cwcel @ XU @ ccho)) & ((cwbr @ cch0o @ XT @ ccleo) & (cwbr @ cch0o @ XU @ ccleo))) => (cwbr @ cch0o @ (cco @ XT @ XU @ cchos) @ ccleo))))).
...
thf(ahosubcl_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (((cwf @ cchil @ cchil @ XS) & (cwf @ cchil @ cchil @ XT)) => (cwf @ cchil @ cchil @ (cco @ XS @ XT @ cchod)))))).
thf(amp3an1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (Xph => (((cw3a @ Xph @ Xps @ Xch) => Xth) => ((Xps & Xch) => Xth)))))))).
thf(ahosubsub4_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : ((cw3a @ (cwf @ cchil @ cchil @ XS) @ (cwf @ cchil @ cchil @ XT) @ (cwf @ cchil @ cchil @ XU)) => ((cco @ (cco @ XS @ XT @ cchod) @ XU @ cchod) = (cco @ XS @ (cco @ XT @ XU @ cchos) @ cchod))))))).
...
thf(ahoadd32_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwf @ cchil @ cchil @ XR) @ (cwf @ cchil @ cchil @ XS) @ (cwf @ cchil @ cchil @ XT)) => ((cco @ (cco @ XR @ XS @ cchos) @ XT @ cchos) = (cco @ (cco @ XR @ XT @ cchos) @ XS @ cchos))))))).
thf(aoveq1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XC @ XF)))))))).
thf(aho2times_ax,axiom,(! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((cco @ cc2 @ XT @ cchot) = (cco @ XT @ XT @ cchos))))).
...
thf(ahosubadd4_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : ((((cwf @ cchil @ cchil @ XR) & (cwf @ cchil @ cchil @ XS)) & ((cwf @ cchil @ cchil @ XT) & (cwf @ cchil @ cchil @ XU))) => ((cco @ (cco @ XR @ XS @ cchod) @ (cco @ XT @ XU @ cchod) @ cchod) = (cco @ (cco @ XR @ XU @ cchos) @ (cco @ XS @ XT @ cchos) @ cchod)))))))).
thf(aoveq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))))).
thf(aeqtrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XB2 = XC)) => (Xph => (XA2 = XC))))))))).
thf(ahalfcn_ax,axiom,(cwcel @ (cco @ cc1 @ cc2 @ ccdiv) @ ccc)).
thf(ahoadddi_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwf @ cchil @ cchil @ XT) @ (cwf @ cchil @ cchil @ XU)) => ((cco @ XA2 @ (cco @ XT @ XU @ cchos) @ cchot) = (cco @ (cco @ XA2 @ XT @ cchot) @ (cco @ XA2 @ XU @ cchot) @ cchos))))))).
...
thf(ahomulass_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwf @ cchil @ cchil @ XT)) => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ XT @ cchot) = (cco @ XA2 @ (cco @ XB2 @ XT @ cchot) @ cchot))))))).
thf(ahomulid2_ax,axiom,(! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((cco @ cc1 @ XT @ cchot) = XT)))).
thf(ahosubdi_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwf @ cchil @ cchil @ XT) @ (cwf @ cchil @ cchil @ XU)) => ((cco @ XA2 @ (cco @ XT @ XU @ cchod) @ cchot) = (cco @ (cco @ XA2 @ XT @ cchot) @ (cco @ XA2 @ XU @ cchot) @ cchod))))))).
thf(ahocsubdir_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwf @ cchil @ cchil @ XR) @ (cwf @ cchil @ cchil @ XS) @ (cwf @ cchil @ cchil @ XT)) => ((cccom @ (cco @ XR @ XS @ cchod) @ XT) = (cco @ (cccom @ XR @ XT) @ (cccom @ XS @ XT) @ cchod))))))).
...
thf(ahoddi_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwcel @ XR @ cclo) @ (cwf @ cchil @ cchil @ XS) @ (cwf @ cchil @ cchil @ XT)) => ((cccom @ XR @ (cco @ XS @ XT @ cchod)) = (cco @ (cccom @ XR @ XS) @ (cccom @ XR @ XT) @ cchod))))))).
thf(aa1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(ccpjh_tp,type,(ccpjh : ($i > $o))).
thf(ahoid1i_ax,axiom,(! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((cccom @ XT @ cchio) = XT)))).
thf(ccid_tp,type,(ccid : ($i > $o))).
thf(ccres_tp,type,(ccres : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ahoico2_ax,axiom,(! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((cccom @ cchio @ XT) = XT)))).
thf(amp3an2_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (Xps => (((cw3a @ Xph @ Xps @ Xch) => Xth) => ((Xph & Xch) => Xth)))))))).
thf(ahoico1_ax,axiom,(! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((cccom @ XT @ cchio) = XT)))).
...
thf(aleopmul_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XT @ ccho) @ (cwbr @ ccc0 @ XA2 @ cclt)) => ((cwbr @ cch0o @ XT @ ccleo) <=> (cwbr @ cch0o @ (cco @ XA2 @ XT @ cchot) @ ccleo)))))).
