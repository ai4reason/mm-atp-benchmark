...
thf(cpmtr3ncomlem1_conj,conjecture,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((XF = (ccfv @ (ccpr @ XX @ XY) @ XT)) => ((XG = (ccfv @ (ccpr @ XY @ XZ) @ XT)) => ((cw3a @ (cwcel @ XD @ XV) @ (cw3a @ (cwcel @ XX @ XD) @ (cwcel @ XY @ XD) @ (cwcel @ XZ @ XD)) @ (cw3a @ (cwne @ XX @ XY) @ (cwne @ XX @ XZ) @ (cwne @ XY @ XZ))) => (cwne @ (ccfv @ XX @ (cccom @ XG @ XF)) @ (ccfv @ XX @ (cccom @ XF @ XG)))))))))))))))).
