...
thf(aimasvscafn_ax,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (Xph => ((XU @ Xq @ Xp @ Xa) = (cco @ XF @ (XR @ Xa) @ ccimas)))))) => ((! [Xa:$i] : (Xph => (XV = (ccfv @ (XR @ Xa) @ ccbs)))) => ((! [Xa:$i] : (Xph => (cwfo @ XV @ (XB2 @ Xa) @ XF))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (Xph => (cwcel @ (XR @ Xa) @ (XZ @ Xq @ Xp @ Xa)))))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : ((XG @ Xq @ Xp @ Xa) = (ccfv @ (XR @ Xa) @ ccsca))))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (XK = (ccfv @ (XG @ Xq @ Xp @ Xa) @ ccbs))))) => ((! [Xa:$i] : ((Xc_x @ Xa) = (ccfv @ (XR @ Xa) @ ccvsca))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (Xc_xb = (ccfv @ (XU @ Xq @ Xp @ Xa) @ ccvsca))))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : ((Xph & (cw3a @ (cwcel @ (ccv @ Xp) @ XK) @ (cwcel @ (ccv @ Xa) @ XV) @ (cwcel @ (ccv @ Xq) @ XV))) => (((ccfv @ (ccv @ Xa) @ XF) = (ccfv @ (ccv @ Xq) @ XF)) => ((ccfv @ (cco @ (ccv @ Xp) @ (ccv @ Xa) @ (Xc_x @ Xa)) @ XF) = (ccfv @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ (Xc_x @ Xa)) @ XF))))))) => (! [Xa:$i] : (Xph => (cwfn @ Xc_xb @ (ccxp @ XK @ (XB2 @ Xa)))))))))))))))))))))))))).
...
thf(adff2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) <=> ((cwfn @ XF @ XA2) & (cwss @ XF @ (ccxp @ XA2 @ XB2)))))))).
thf(cimasvscaf_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (Xph => ((XU @ Xq @ Xp @ Xa) = (cco @ XF @ (XR @ Xa) @ ccimas)))))) => ((! [Xa:$i] : (Xph => (XV = (ccfv @ (XR @ Xa) @ ccbs)))) => ((! [Xa:$i] : (Xph => (cwfo @ XV @ (XB2 @ Xa) @ XF))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (Xph => (cwcel @ (XR @ Xa) @ (XZ @ Xq @ Xp @ Xa)))))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : ((XG @ Xq @ Xp @ Xa) = (ccfv @ (XR @ Xa) @ ccsca))))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (XK = (ccfv @ (XG @ Xq @ Xp @ Xa) @ ccbs))))) => ((! [Xa:$i] : ((Xc_x @ Xa) = (ccfv @ (XR @ Xa) @ ccvsca))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : (Xc_xb = (ccfv @ (XU @ Xq @ Xp @ Xa) @ ccvsca))))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : ((Xph & (cw3a @ (cwcel @ (ccv @ Xp) @ XK) @ (cwcel @ (ccv @ Xa) @ XV) @ (cwcel @ (ccv @ Xq) @ XV))) => (((ccfv @ (ccv @ Xa) @ XF) = (ccfv @ (ccv @ Xq) @ XF)) => ((ccfv @ (cco @ (ccv @ Xp) @ (ccv @ Xa) @ (Xc_x @ Xa)) @ XF) = (ccfv @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ (Xc_x @ Xa)) @ XF))))))) => ((! [Xq:$i] : (! [Xp:$i] : (! [Xa:$i] : ((Xph & ((cwcel @ (ccv @ Xp) @ XK) & (cwcel @ (ccv @ Xq) @ XV))) => (cwcel @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ (Xc_x @ Xa)) @ XV))))) => (! [Xa:$i] : (Xph => (cwf @ (ccxp @ XK @ (XB2 @ Xa)) @ (XB2 @ Xa) @ Xc_xb))))))))))))))))))))))))).
