...
thf(czrhcopsgnelbas_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((XS = (ccfv @ XN @ ccpsgn)) => ((XY = (ccfv @ XR @ cczrh)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XN @ ccfn) @ (cwcel @ XQ @ XP)) => (cwcel @ (ccfv @ XQ @ (cccom @ XY @ XS)) @ (ccfv @ XR @ ccbs))))))))))))).
