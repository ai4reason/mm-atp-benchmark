...
thf(cnmopub2tALT_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwf @ cchil @ cchil @ XT) @ ((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XT) @ ccno) @ (cco @ XA2 @ (ccfv @ (ccv @ Xx3) @ ccno) @ ccmul) @ ccle)) @ (^ [Xx3:$i] : cchil))) => (cwbr @ (ccfv @ XT @ ccnop) @ XA2 @ ccle))))).
