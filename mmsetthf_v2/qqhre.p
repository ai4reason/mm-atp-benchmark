...
thf(azrhre_ax,axiom,((ccfv @ ccrefld @ cczrh) = (ccres @ ccid @ ccz))).
...
thf(aqqhf_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((XL = (ccfv @ XR @ cczrh)) => (((cwcel @ XR @ ccdr) & ((ccfv @ XR @ ccchr) = ccc0)) => (cwf @ ccq @ XB2 @ (ccfv @ XR @ ccqqh))))))))))).
...
thf(aredvr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwne @ XB2 @ ccc0)) => ((cco @ XA2 @ XB2 @ (ccfv @ ccrefld @ ccdvr)) = (cco @ XA2 @ XB2 @ ccdiv)))))).
