...
thf(afnwe2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xz:$i] : (((ccv @ Xz) = (ccfv @ (ccv @ Xx3) @ XF)) => ((XS @ Xz) = (XU @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XT @ Xx3 @ Xy1 @ Xz) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ (XR @ Xz)) | (((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xy1) @ XF)) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XU @ Xx3))))))))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwwe @ (ccrab @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ XF) = (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xy1:$i] : XA2)) @ (XU @ Xx3)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwf @ XA2 @ (XB2 @ Xx3 @ Xy1 @ Xz) @ (ccres @ XF @ XA2)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwwe @ (XB2 @ Xx3 @ Xy1 @ Xz) @ (XR @ Xz)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwwe @ XA2 @ (XT @ Xx3 @ Xy1 @ Xz)))))))))))))))))))).
...
thf(arankidb_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) => (cwcel @ XA2 @ (ccfv @ (ccsuc @ (ccfv @ XA2 @ ccrnk)) @ ccr1))))).
...
thf(aabid1_ax,axiom,(! [XA2:($i > $o)] : (XA2 = (ccab @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2)))))).
...
thf(alimsuc2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cword @ XA2) & (XA2 = (ccuni @ XA2))) => ((cwcel @ XB2 @ XA2) <=> (cwcel @ (ccsuc @ XB2) @ XA2)))))).
