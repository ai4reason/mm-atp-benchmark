...
thf(aacndom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccdom) => ((cwcel @ XX @ (cwacn @ XB2)) => (cwcel @ XX @ (cwacn @ XA2)))))))).
...
thf(aacni2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XX:($i > $o)] : (((cwcel @ XX @ (cwacn @ XA2)) & (cwral @ (^ [Xx3:$i] : ((cwss @ (XB2 @ Xx3) @ XX) & (cwne @ (XB2 @ Xx3) @ cc0))) @ (^ [Xx3:$i] : XA2))) => (? [Xg1:$i] : ((cwf @ XA2 @ XX @ (ccv @ Xg1)) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2))))))))).
thf(aeximi_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (Xps @ Xx3))) => ((? [Xx3:$i] : (Xph @ Xx3)) => (? [Xx3:$i] : (Xps @ Xx3))))))).
thf(asylib_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps <=> Xch) => (Xph => Xch))))))).
thf(asimpr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(aralbii2_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) => (Xph @ Xx3)) <=> ((cwcel @ (ccv @ Xx3) @ (XB2 @ Xx3)) => (Xps @ Xx3)))) => ((cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) <=> (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))).
...
thf(adfac8a_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xy1:$i] : ((cwcel @ XA2 @ (XB2 @ Xy1)) => ((? [Xh:$i] : (cwral @ (^ [Xy1:$i] : ((cwne @ (ccv @ Xy1) @ cc0) => (cwcel @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xh)) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccpw @ XA2)))) => (cwcel @ XA2 @ (ccdm @ cccrd)))))))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccuni_tp,type,(ccuni : (($i > $o) > ($i > $o)))).
thf(anumacn_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XX @ (ccdm @ cccrd)) => (cwcel @ XX @ (cwacn @ XA2)))))))).
thf(cacnnum_conj,conjecture,(! [XX:($i > $o)] : ((cwcel @ XX @ (cwacn @ (ccpw @ XX))) <=> (cwcel @ XX @ (ccdm @ cccrd))))).
