...
thf(aoppchomfpropd_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => ((ccfv @ XC @ cchomf) = (ccfv @ XD @ cchomf))) => (Xph => ((ccfv @ (ccfv @ XC @ ccoppc) @ cchomf) = (ccfv @ (ccfv @ XD @ ccoppc) @ cchomf)))))))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(ccco_tp,type,(ccco : ($i > $o))).
thf(cwral_tp,type,(cwral : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(aoppccomfpropd_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => ((ccfv @ XC @ cchomf) = (ccfv @ XD @ cchomf))) => ((Xph => ((ccfv @ XC @ cccomf) = (ccfv @ XD @ cccomf))) => (Xph => ((ccfv @ (ccfv @ XC @ ccoppc) @ cccomf) = (ccfv @ (ccfv @ XD @ ccoppc) @ cccomf))))))))).
