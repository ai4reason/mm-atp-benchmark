...
thf(csuppssfifsupp_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : (((cw3a @ (cwcel @ XG @ XV) @ (cwfun @ XG) @ (cwcel @ XZ @ XW)) & ((cwcel @ XF @ ccfn) & (cwss @ (cco @ XG @ XZ @ ccsupp) @ XF))) => (cwbr @ XG @ XZ @ ccfsupp)))))))).
