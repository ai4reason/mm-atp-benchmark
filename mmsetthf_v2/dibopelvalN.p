...
thf(cdibopelvalN_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xf1:$i] : ((XB2 @ Xf1) = (ccfv @ XK @ ccbs))) => ((! [Xf1:$i] : ((XH @ Xf1) = (ccfv @ XK @ cclh))) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xf1:$i] : ((Xc_0 @ Xf1) = (ccmpt @ (^ [Xf1:$i] : XT) @ (^ [Xf1:$i] : (ccres @ ccid @ (XB2 @ Xf1)))))) => ((! [Xf1:$i] : ((XJ @ Xf1) = (ccfv @ XW @ (ccfv @ XK @ ccdia)))) => ((! [Xf1:$i] : ((XI @ Xf1) = (ccfv @ XW @ (ccfv @ XK @ ccdib)))) => (! [Xf1:$i] : ((((cwcel @ XK @ (XV @ Xf1)) & (cwcel @ XW @ (XH @ Xf1))) & (cwcel @ (XX @ Xf1) @ (ccdm @ (XJ @ Xf1)))) => ((cwcel @ (ccop @ (XF @ Xf1) @ (XS @ Xf1)) @ (ccfv @ (XX @ Xf1) @ (XI @ Xf1))) <=> ((cwcel @ (XF @ Xf1) @ (ccfv @ (XX @ Xf1) @ (XJ @ Xf1))) & ((XS @ Xf1) = (Xc_0 @ Xf1))))))))))))))))))))))))).
