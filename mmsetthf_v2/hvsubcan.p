...
thf(ahvaddcan_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil)) => (((cco @ XA2 @ XB2 @ ccva) = (cco @ XA2 @ XC @ ccva)) <=> (XB2 = XC))))))).
...
thf(chvsubcan_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil)) => (((cco @ XA2 @ XB2 @ ccmv) = (cco @ XA2 @ XC @ ccmv)) <=> (XB2 = XC))))))).
