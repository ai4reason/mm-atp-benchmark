...
thf(copabssxpd_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (Xps @ Xx3 @ Xy1)) => (cwcel @ (ccv @ Xx3) @ XA2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (Xps @ Xx3 @ Xy1)) => (cwcel @ (ccv @ Xy1) @ XB2)))) => (Xph => (cwss @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)))) @ (ccxp @ XA2 @ XB2)))))))))).
