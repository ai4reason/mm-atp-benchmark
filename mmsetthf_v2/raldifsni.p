...
thf(craldifsni_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwral @ (^ [Xx3:$i] : (~ (Xph @ Xx3))) @ (^ [Xx3:$i] : (ccdif @ (XA2 @ Xx3) @ (ccsn @ (XB2 @ Xx3))))) <=> (cwral @ (^ [Xx3:$i] : ((Xph @ Xx3) => ((ccv @ Xx3) = (XB2 @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))).
