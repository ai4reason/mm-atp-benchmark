...
thf(chvmulcom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ cchil)) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccsm) @ ccsm) = (cco @ XB2 @ (cco @ XA2 @ XC @ ccsm) @ ccsm))))))).
