...
thf(ablss_ax,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XB2 @ (ccrn @ (ccfv @ XD @ ccbl))) @ (cwcel @ XP @ XB2)) => (cwrex @ (^ [Xx3:$i] : (cwss @ (cco @ XP @ (ccv @ Xx3) @ (ccfv @ XD @ ccbl)) @ XB2)) @ (^ [Xx3:$i] : ccrp)))))))).
