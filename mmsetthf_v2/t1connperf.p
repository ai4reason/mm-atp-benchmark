...
thf(aisperf3_ax,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ ccperf) <=> ((cwcel @ XJ @ cctop) & (cwral @ (^ [Xx3:$i] : (~ (cwcel @ (ccsn @ (ccv @ Xx3)) @ XJ))) @ (^ [Xx3:$i] : XX)))))))).
thf(ct1connperf_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwcel @ XJ @ cct1) @ (cwcel @ XJ @ ccconn) @ (~ (cwbr @ XX @ cc1o @ ccen))) => (cwcel @ XJ @ ccperf)))))).
