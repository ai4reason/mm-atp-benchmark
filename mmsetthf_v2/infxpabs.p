...
thf(ainfxpdom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwbr @ XB2 @ XA2 @ ccdom)) => (cwbr @ (ccxp @ XA2 @ XB2) @ XA2 @ ccdom))))).
...
thf(cinfxpabs_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwbr @ ccom @ XA2 @ ccdom)) & ((cwne @ XB2 @ cc0) & (cwbr @ XB2 @ XA2 @ ccdom))) => (cwbr @ (ccxp @ XA2 @ XB2) @ XA2 @ ccen))))).
