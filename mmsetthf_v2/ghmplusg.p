...
thf(cghmplusg_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xc_pl = (ccfv @ XN @ ccplusg)) => ((cw3a @ (cwcel @ XN @ ccabl) @ (cwcel @ XF @ (cco @ XM @ XN @ ccghm)) @ (cwcel @ XG @ (cco @ XM @ XN @ ccghm))) => (cwcel @ (cco @ XF @ XG @ (ccof @ Xc_pl)) @ (cco @ XM @ XN @ ccghm)))))))))).
