...
thf(abcfallfac_ax,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) => ((cco @ XN @ XK @ ccbc) = (cco @ (cco @ XN @ XK @ ccfallfac) @ (ccfv @ XK @ ccfa) @ ccdiv)))))).
...
thf(ann0split_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => (ccn0 = (ccun @ (cco @ ccc0 @ XN @ ccfz) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccuz)))))).
...
thf(cbccbc_conj,conjecture,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XK @ ccn0)) => (Xph => ((cco @ XN @ XK @ ccbcc) = (cco @ XN @ XK @ ccbc))))))))).
