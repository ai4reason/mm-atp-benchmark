...
thf(astirlinglem13_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : ((! [Xn:$i] : (! [Xd:$i] : ((XA2 @ Xn @ Xd) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul) @ ccdiv)))))) => ((! [Xn:$i] : (! [Xd:$i] : ((XB2 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xn @ Xd)) @ cclog)))))) => (! [Xn:$i] : (cwrex @ (^ [Xd:$i] : (cwbr @ (XB2 @ Xn) @ (ccv @ Xd) @ ccli)) @ (^ [Xd:$i] : ccr)))))))).
