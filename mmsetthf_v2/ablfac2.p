...
thf(aiscyg_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((cwcel @ XG @ cccyg) <=> ((cwcel @ XG @ ccgrp) & (cwrex @ (^ [Xx3:$i] : ((ccrn @ (ccmpt @ (^ [Xn:$i] : ccz) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ Xc_x)))) = XB2)) @ (^ [Xx3:$i] : XB2)))))))))).
...
thf(aablfac_ax,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((! [Xr:$i] : ((XC @ Xr) = (ccrab @ (^ [Xr:$i] : (cwcel @ (cco @ XG @ (ccv @ Xr) @ ccress) @ (ccin @ cccyg @ (ccrn @ ccpgp)))) @ (^ [Xr:$i] : (ccfv @ XG @ ccsubg))))) => ((! [Xr:$i] : ((Xph @ Xr) => (cwcel @ XG @ ccabl))) => ((! [Xr:$i] : ((Xph @ Xr) => (cwcel @ XB2 @ ccfn))) => (! [Xr:$i] : ((Xph @ Xr) => (cwrex @ (^ [Xs1:$i] : ((cwbr @ XG @ (ccv @ Xs1) @ (ccdm @ ccdprd)) & ((cco @ XG @ (ccv @ Xs1) @ ccdprd) = XB2))) @ (^ [Xs1:$i] : (ccword @ (XC @ Xr))))))))))))))).
thf(cablfac2_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((! [Xr:$i] : ((XC @ Xr) = (ccrab @ (^ [Xr:$i] : (cwcel @ (cco @ XG @ (ccv @ Xr) @ ccress) @ (ccin @ cccyg @ (ccrn @ ccpgp)))) @ (^ [Xr:$i] : (ccfv @ XG @ ccsubg))))) => ((! [Xr:$i] : ((Xph @ Xr) => (cwcel @ XG @ ccabl))) => ((! [Xr:$i] : ((Xph @ Xr) => (cwcel @ XB2 @ ccfn))) => ((! [Xn:$i] : (! [Xr:$i] : ((Xc_x @ Xn @ Xr) = (ccfv @ XG @ ccmg)))) => ((! [Xw:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xr:$i] : ((XS @ Xw @ Xk @ Xn) = (ccmpt @ (^ [Xk:$i] : (ccdm @ (ccv @ Xw))) @ (^ [Xk:$i] : (ccrn @ (ccmpt @ (^ [Xn:$i] : ccz) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xw)) @ (Xc_x @ Xn @ Xr)))))))))))) => (! [Xk:$i] : (! [Xn:$i] : (! [Xr:$i] : ((Xph @ Xr) => (cwrex @ (^ [Xw:$i] : (cw3a @ (cwf @ (ccdm @ (ccv @ Xw)) @ (XC @ Xr) @ (XS @ Xw @ Xk @ Xn)) @ (cwbr @ XG @ (XS @ Xw @ Xk @ Xn) @ (ccdm @ ccdprd)) @ ((cco @ XG @ (XS @ Xw @ Xk @ Xn) @ ccdprd) = XB2))) @ (^ [Xw:$i] : (ccword @ XB2)))))))))))))))))))).
