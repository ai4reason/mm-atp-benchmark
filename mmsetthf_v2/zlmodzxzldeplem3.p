...
thf(agsumpr_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((! [Xk:$i] : ((Xc_pl @ Xk) = (ccfv @ XG @ ccplusg))) => ((! [Xk:$i] : (((ccv @ Xk) = XM) => ((XA2 @ Xk) = XC))) => ((! [Xk:$i] : (((ccv @ Xk) = XN) => ((XA2 @ Xk) = XD))) => (! [Xk:$i] : ((cw3a @ (cwcel @ XG @ cccmn) @ (cw3a @ (cwcel @ XM @ XV) @ (cwcel @ XN @ XW) @ (cwne @ XM @ XN)) @ ((cwcel @ XC @ XB2) & (cwcel @ XD @ XB2))) => ((cco @ XG @ (ccmpt @ (^ [Xk:$i] : (ccpr @ XM @ XN)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccgsu) = (cco @ XC @ XD @ (Xc_pl @ Xk)))))))))))))))))))).
...
thf(azlmodzxzequap_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => ((XA2 = (ccpr @ (ccop @ ccc0 @ cc3) @ (ccop @ cc1 @ cc6))) => ((XB2 = (ccpr @ (ccop @ ccc0 @ cc2) @ (ccop @ cc1 @ cc4))) => ((Xc_0 = (ccpr @ (ccop @ ccc0 @ ccc0) @ (ccop @ cc1 @ ccc0))) => ((Xc_pl = (ccfv @ XZ @ ccplusg)) => ((Xc_xb = (ccfv @ XZ @ ccvsca)) => ((cco @ (cco @ cc2 @ XA2 @ Xc_xb) @ (cco @ (ccneg @ cc3) @ XB2 @ Xc_xb) @ Xc_pl) = Xc_0)))))))))))))).
thf(ccxp_tp,type,(ccxp : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(azlmodzxz0_ax,axiom,(! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => ((Xc_0 = (ccpr @ (ccop @ ccc0 @ ccc0) @ (ccop @ cc1 @ ccc0))) => (Xc_0 = (ccfv @ XZ @ cc0g))))))).
