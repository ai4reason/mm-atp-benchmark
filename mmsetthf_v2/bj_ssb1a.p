...
thf(abj_ssblem2_ax,axiom,(! [Xph:($i > $o)] : (! [Xt:$i] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xy1) = (ccv @ Xt)) => (((ccv @ Xx3) = (ccv @ Xy1)) => (Xph @ Xx3))))) => (! [Xy1:$i] : (! [Xx3:$i] : (((ccv @ Xy1) = (ccv @ Xt)) => (((ccv @ Xx3) = (ccv @ Xy1)) => (Xph @ Xx3))))))))).
thf(astdpc5v_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (Xph => (Xps @ Xx3))) => (Xph => (! [Xx3:$i] : (Xps @ Xx3))))))).
thf(adf_ssb_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xt:$i] : ((cwssb @ (^ [Xx3:$i] : (^ [Xt:$i] : (Xph @ Xx3 @ Xt)))) <=> (! [Xy1:$i] : (((ccv @ Xy1) = (ccv @ Xt)) => (! [Xx3:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => (Xph @ Xx3 @ Xt))))))))).
thf(cbj_ssb1a_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xt:$i] : ((! [Xx3:$i] : (((ccv @ Xx3) = (ccv @ Xt)) => (Xph @ Xx3 @ Xt))) => (cwssb @ (^ [Xx3:$i] : (^ [Xt:$i] : (Xph @ Xx3 @ Xt)))))))).
