...
thf(ccmt2N_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_pe = (ccfv @ XK @ ccoc)) => ((XC = (ccfv @ XK @ cccmtN)) => ((cw3a @ (cwcel @ XK @ ccoml) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => ((cwbr @ XX @ XY @ XC) <=> (cwbr @ XX @ (ccfv @ XY @ Xc_pe) @ XC))))))))))))).
