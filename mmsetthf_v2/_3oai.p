...
thf(a_3oalem5_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((XR = (ccin @ (ccfv @ XB2 @ ccort) @ (cco @ XB2 @ XA2 @ cchj))) => ((XS = (ccin @ (ccfv @ XC @ ccort) @ (cco @ XC @ XA2 @ cchj))) => ((ccin @ (cco @ XB2 @ XR @ ccph) @ (cco @ XC @ XS @ ccph)) = (ccin @ (cco @ XB2 @ XR @ cchj) @ (cco @ XC @ XS @ cchj)))))))))))))).
thf(asstri_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ XB2) => ((cwss @ XB2 @ XC) => (cwss @ XA2 @ XC))))))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(ccva_tp,type,(ccva : ($i > $o))).
thf(ccv_tp,type,(ccv : ($i > ($i > $o)))).
thf(a_3oalem3_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwcel @ XR @ ccch) => ((cwcel @ XS @ ccch) => (cwss @ (ccin @ (cco @ XB2 @ XR @ ccph) @ (cco @ XC @ XS @ ccph)) @ (cco @ XB2 @ (ccin @ XR @ (cco @ XS @ (ccin @ (cco @ XB2 @ XC @ ccph) @ (cco @ XR @ XS @ ccph)) @ ccph)) @ ccph))))))))))).
