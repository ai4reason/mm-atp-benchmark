...
thf(cprtlem100_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwrex @ (^ [Xx3:$i] : ((cwcel @ (XB2 @ Xx3) @ (ccv @ Xx3)) & (Xph @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) <=> (cwrex @ (^ [Xx3:$i] : ((cwcel @ (XB2 @ Xx3) @ (ccv @ Xx3)) & (Xph @ Xx3))) @ (^ [Xx3:$i] : (ccdif @ (XA2 @ Xx3) @ (ccsn @ cc0))))))))).
