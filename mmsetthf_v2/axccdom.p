...
thf(caxccdom_conj,conjecture,(! [Xph:($i > $o)] : (! [XX:($i > $o)] : ((! [Xf1:$i] : ((Xph @ Xf1) => (cwbr @ XX @ ccom @ ccdom))) => ((! [Xz:$i] : (! [Xf1:$i] : (((Xph @ Xf1) & (cwcel @ (ccv @ Xz) @ XX)) => (cwne @ (ccv @ Xz) @ cc0)))) => (! [Xf1:$i] : ((Xph @ Xf1) => (? [Xf1:$i] : ((cwfn @ (ccv @ Xf1) @ XX) & (cwral @ (^ [Xz:$i] : (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xf1)) @ (ccv @ Xz))) @ (^ [Xz:$i] : XX))))))))))).
