...
thf(asubmgmrcl_ax,axiom,(! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwcel @ XS @ (ccfv @ XM @ ccsubmgm)) => (cwcel @ XM @ ccmgm))))).
...
thf(asubmgmbas_ax,axiom,(! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : ((XH = (cco @ XM @ XS @ ccress)) => ((cwcel @ XS @ (ccfv @ XM @ ccsubmgm)) => (XS = (ccfv @ XH @ ccbs)))))))).
