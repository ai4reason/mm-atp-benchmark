...
thf(aaciunf1lem_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xj:$i] : ((Xph @ Xf1) => (cwcel @ (XA2 @ Xj) @ (XV @ Xx3 @ Xf1 @ Xj)))))) => ((! [Xf1:$i] : (! [Xj:$i] : (((Xph @ Xf1) & (cwcel @ (ccv @ Xj) @ (XA2 @ Xj))) => (cwne @ (XB2 @ Xj) @ cc0)))) => ((cwnfc @ (^ [Xj:$i] : (XA2 @ Xj))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xj:$i] : (((Xph @ Xf1) & (cwcel @ (ccv @ Xj) @ (XA2 @ Xj))) => (cwcel @ (XB2 @ Xj) @ (XW @ Xx3 @ Xf1)))))) => (! [Xf1:$i] : ((Xph @ Xf1) => (? [Xf1:$i] : ((cwf1 @ (cciun @ (^ [Xj:$i] : (XA2 @ Xj)) @ (^ [Xj:$i] : (XB2 @ Xj))) @ (cciun @ (^ [Xj:$i] : (XA2 @ Xj)) @ (^ [Xj:$i] : (ccxp @ (ccsn @ (ccv @ Xj)) @ (XB2 @ Xj)))) @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ cc2nd) = (ccv @ Xx3))) @ (^ [Xx3:$i] : (cciun @ (^ [Xj:$i] : (XA2 @ Xj)) @ (^ [Xj:$i] : (XB2 @ Xj))))))))))))))))))).
...
thf(af1eq123d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (XF = XG)) => ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((cwf1 @ XA2 @ XC @ XF) <=> (cwf1 @ XB2 @ XD @ XG)))))))))))))).
...
thf(adifrab_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((ccdif @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) = (ccrab @ (^ [Xx3:$i] : ((Xph @ Xx3) & (~ (Xps @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))).
thf(adifeq1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((ccdif @ XA2 @ XC) = (ccdif @ XB2 @ XC))))))).
thf(arabtru_ax,axiom,(! [XA2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (! [Xx3:$i] : ((ccrab @ (^ [Xx3:$i] : $true) @ (^ [Xx3:$i] : (XA2 @ Xx3))) = (XA2 @ Xx3)))))).
