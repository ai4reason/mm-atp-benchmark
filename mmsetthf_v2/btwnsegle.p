...
thf(acgrrflxd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XB2 @ (ccfv @ XN @ ccee))) => (Xph => (cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XA2 @ XB2) @ cccgr)))))))))).
...
thf(cbtwnsegle_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee)))) => ((cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn) => (cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XA2 @ XC) @ ccsegle)))))))).
