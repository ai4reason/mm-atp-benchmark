...
thf(cswoord2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [Xc_lt:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XR @ Xx3 @ Xy1 @ Xz) = (ccdif @ (ccxp @ XX @ XX) @ (ccun @ Xc_lt @ (cccnv @ Xc_lt))))))) => ((! [Xy1:$i] : (! [Xz:$i] : ((Xph & ((cwcel @ (ccv @ Xy1) @ XX) & (cwcel @ (ccv @ Xz) @ XX))) => ((cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_lt) => (~ (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ Xc_lt)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph & (cw3a @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX) @ (cwcel @ (ccv @ Xz) @ XX))) => ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_lt) => ((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_lt) | (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ Xc_lt))))))) => ((Xph => (cwcel @ XB2 @ XX)) => ((Xph => (cwcel @ XC @ XX)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwbr @ XA2 @ XB2 @ (XR @ Xx3 @ Xy1 @ Xz)))))) => (Xph => ((cwbr @ XC @ XA2 @ Xc_lt) <=> (cwbr @ XC @ XB2 @ Xc_lt))))))))))))))))).
