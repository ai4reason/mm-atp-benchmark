...
thf(asmcn_ax,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XC = (ccfv @ XU @ ccims)) => ((XJ = (ccfv @ XC @ ccmopn)) => ((XS = (ccfv @ XU @ ccns)) => ((XK = (ccfv @ cccnfld @ cctopn)) => ((cwcel @ XU @ ccnv) => (cwcel @ XS @ (cco @ (cco @ XK @ XJ @ cctx) @ XJ @ cccn))))))))))))).
...
thf(adipcn_ax,axiom,(! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XP = (ccfv @ XU @ ccdip)) => ((XC = (ccfv @ XU @ ccims)) => ((XJ = (ccfv @ XC @ ccmopn)) => ((XK = (ccfv @ cccnfld @ cctopn)) => ((cwcel @ XU @ ccnv) => (cwcel @ XP @ (cco @ (cco @ XJ @ XJ @ cctx) @ XK @ cccn))))))))))))).
