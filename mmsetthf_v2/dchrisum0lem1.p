...
thf(adchrisum0lem1a_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (((Xph & (cwcel @ XX @ ccrp)) & (cwcel @ XD @ (cco @ cc1 @ (ccfv @ XX @ ccfl) @ ccfz))) => ((cwbr @ XX @ (cco @ (cco @ XX @ cc2 @ ccexp) @ XD @ ccdiv) @ ccle) & (cwcel @ (ccfv @ (cco @ (cco @ XX @ cc2 @ ccexp) @ XD @ ccdiv) @ ccfl) @ (ccfv @ (ccfv @ XX @ ccfl) @ ccuz)))))))).
...
thf(adivsqrsum_ax,axiom,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xn:$i] : ((XF @ Xx3 @ Xn) = (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ cc1 @ (ccfv @ (ccv @ Xn) @ ccsqrt) @ ccdiv))) @ (cco @ cc2 @ (ccfv @ (ccv @ Xx3) @ ccsqrt) @ ccmul) @ ccmin)))))) => (! [Xx3:$i] : (! [Xn:$i] : (cwcel @ (XF @ Xx3 @ Xn) @ (ccdm @ ccrli))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(arlimdmo1_ax,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ ccrli)) => (cwcel @ XF @ cco1)))).
...
thf(asqrtlim_ax,axiom,(cwbr @ (ccmpt @ (^ [Xn:$i] : ccrp) @ (^ [Xn:$i] : (cco @ cc1 @ (ccfv @ (ccv @ Xn) @ ccsqrt) @ ccdiv))) @ ccc0 @ ccrli)).
...
thf(adchrisum0lem1b_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [Xc_1:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > $o))] : (! [Xd:$i] : ((! [Xa:$i] : ((XZ @ Xa) = (ccfv @ (XN @ Xa) @ cczn))) => ((! [Xa:$i] : (XL = (ccfv @ (XZ @ Xa) @ cczrh))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ (XN @ Xa) @ ccn)))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : ((XG @ Xy1 @ Xm @ Xa) = (ccfv @ (XN @ Xa) @ ccdchr))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : ((XD @ Xa) = (ccfv @ (XG @ Xy1 @ Xm @ Xa) @ ccbs))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : ((Xc_1 @ Xa) = (ccfv @ (XG @ Xy1 @ Xm @ Xa) @ cc0g))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : ((XW @ Xy1 @ Xm @ Xa) = (ccrab @ (^ [Xy1:$i] : ((ccsu @ ccn @ (^ [Xm:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ XL) @ (ccv @ Xy1)) @ (ccv @ Xm) @ ccdiv))) = ccc0)) @ (^ [Xy1:$i] : (ccdif @ (XD @ Xa) @ (ccsn @ (Xc_1 @ Xa))))))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ XX @ (XW @ Xy1 @ Xm @ Xa)))))) => ((! [Xa:$i] : ((XF @ Xa) = (ccmpt @ (^ [Xa:$i] : ccn) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xa) @ XL) @ XX) @ (ccfv @ (ccv @ Xa) @ ccsqrt) @ ccdiv))))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ (XC @ Xa) @ (cco @ ccc0 @ ccpnf @ ccico))))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwbr @ (ccseq @ ccaddc @ (XF @ Xa) @ cc1) @ (XS @ Xa) @ ccli)))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccfv @ (ccv @ Xy1) @ ccfl) @ (ccseq @ ccaddc @ (XF @ Xa) @ cc1)) @ (XS @ Xa) @ ccmin) @ ccabs) @ (cco @ (XC @ Xa) @ (ccfv @ (ccv @ Xy1) @ ccsqrt) @ ccdiv) @ ccle)) @ (^ [Xy1:$i] : (cco @ cc1 @ ccpnf @ ccico)))))) => (! [Xy1:$i] : (! [Xa:$i] : ((((Xph @ Xy1 @ Xa) & (cwcel @ (ccv @ Xx3) @ ccrp)) & (cwcel @ (ccv @ Xd) @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz))) => (cwbr @ (ccfv @ (ccsu @ (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ ccfl) @ cc1 @ ccaddc) @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (ccv @ Xd) @ ccdiv) @ ccfl) @ ccfz) @ (^ [Xm:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ XL) @ XX) @ (ccfv @ (ccv @ Xm) @ ccsqrt) @ ccdiv))) @ ccabs) @ (cco @ (cco @ cc2 @ (XC @ Xa) @ ccmul) @ (ccfv @ (ccv @ Xx3) @ ccsqrt) @ ccdiv) @ ccle))))))))))))))))))))))))))))))).
