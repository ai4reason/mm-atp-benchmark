...
thf(ccndprobin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (((cw3a @ (cwcel @ XP @ ccprb) @ (cwcel @ XA2 @ (ccdm @ XP)) @ (cwcel @ XB2 @ (ccdm @ XP))) & (cwne @ (ccfv @ XB2 @ XP) @ ccc0)) => ((cco @ (ccfv @ (ccop @ XA2 @ XB2) @ (ccfv @ XP @ cccprob)) @ (ccfv @ XB2 @ XP) @ ccmul) = (ccfv @ (ccin @ XA2 @ XB2) @ XP))))))).
