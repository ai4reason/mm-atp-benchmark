...
thf(crrhf_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XZ:($i > $o)] : ((XD = (ccres @ (ccfv @ XR @ ccds) @ (ccxp @ XB2 @ XB2))) => ((XJ = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XK = (ccfv @ XR @ cctopn)) => ((XZ = (ccfv @ XR @ cczlm)) => ((Xph => (cwcel @ XR @ ccdr)) => ((Xph => (cwcel @ XR @ ccnrg)) => ((Xph => (cwcel @ XZ @ ccnlm)) => ((Xph => ((ccfv @ XR @ ccchr) = ccc0)) => ((Xph => (cwcel @ XR @ cccusp)) => ((Xph => ((ccfv @ XR @ ccuss) = (ccfv @ XD @ ccmetu))) => (Xph => (cwf @ ccr @ XB2 @ (ccfv @ XR @ ccrrh)))))))))))))))))))))).
