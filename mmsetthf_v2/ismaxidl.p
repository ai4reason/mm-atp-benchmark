...
thf(amaxidlval_ax,axiom,(! [XR:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : ((XG @ Xi @ Xj) = (ccfv @ XR @ cc1st)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XX @ Xi @ Xj) = (ccrn @ (XG @ Xi @ Xj))))) => (! [Xj:$i] : ((cwcel @ XR @ ccrngo) => ((ccfv @ XR @ ccmaxidl) = (ccrab @ (^ [Xi:$i] : ((cwne @ (ccv @ Xi) @ (XX @ Xi @ Xj)) & (cwral @ (^ [Xj:$i] : ((cwss @ (ccv @ Xi) @ (ccv @ Xj)) => (((ccv @ Xj) = (ccv @ Xi)) | ((ccv @ Xj) = (XX @ Xi @ Xj))))) @ (^ [Xj:$i] : (ccfv @ XR @ ccidl))))) @ (^ [Xi:$i] : (ccfv @ XR @ ccidl)))))))))))).
...
thf(cismaxidl_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xj:$i] : ((XG @ Xj) = (ccfv @ XR @ cc1st))) => ((! [Xj:$i] : ((XX @ Xj) = (ccrn @ (XG @ Xj)))) => (! [Xj:$i] : ((cwcel @ XR @ ccrngo) => ((cwcel @ XM @ (ccfv @ XR @ ccmaxidl)) <=> (cw3a @ (cwcel @ XM @ (ccfv @ XR @ ccidl)) @ (cwne @ XM @ (XX @ Xj)) @ (cwral @ (^ [Xj:$i] : ((cwss @ XM @ (ccv @ Xj)) => (((ccv @ Xj) = XM) | ((ccv @ Xj) = (XX @ Xj))))) @ (^ [Xj:$i] : (ccfv @ XR @ ccidl)))))))))))))).
