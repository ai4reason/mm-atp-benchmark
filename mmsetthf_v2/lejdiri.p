...
thf(alejdii_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => (cwss @ (cco @ XA2 @ (ccin @ XB2 @ XC) @ cchj) @ (ccin @ (cco @ XA2 @ XB2 @ cchj) @ (cco @ XA2 @ XC @ cchj)))))))))).
