...
thf(clog2sumbnd_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwbr @ cc1 @ XA2 @ ccle)) => (cwbr @ (ccfv @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ cclog) @ cc2 @ ccexp))) @ (cco @ XA2 @ (cco @ (cco @ (ccfv @ XA2 @ cclog) @ cc2 @ ccexp) @ (cco @ cc2 @ (cco @ cc2 @ (ccfv @ XA2 @ cclog) @ ccmul) @ ccmin) @ ccaddc) @ ccmul) @ ccmin) @ ccabs) @ (cco @ (cco @ (ccfv @ XA2 @ cclog) @ cc2 @ ccexp) @ cc2 @ ccaddc) @ ccle)))).
