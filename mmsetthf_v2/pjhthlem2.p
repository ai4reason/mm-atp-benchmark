...
thf(apjhthlem1_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ cchil))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XB2 @ XH))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XC @ XH))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno) @ (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccmv) @ ccno) @ ccle)) @ (^ [Xx3:$i] : XH)))) => ((XT = (cco @ (cco @ (cco @ XA2 @ XB2 @ ccmv) @ XC @ ccsp) @ (cco @ (cco @ XC @ XC @ ccsp) @ cc1 @ ccaddc) @ ccdiv)) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cco @ (cco @ XA2 @ XB2 @ ccmv) @ XC @ ccsp) = ccc0)))))))))))))))).
...
thf(aminveco_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xy1:$i] : ((XX @ Xy1) = (ccfv @ XU @ ccba))) => ((XM = (ccfv @ XU @ ccnsb)) => ((XN = (ccfv @ XU @ ccnmcv)) => ((XY = (ccfv @ XW @ ccba)) => ((Xph => (cwcel @ XU @ cccphlo)) => ((Xph => (cwcel @ XW @ (ccin @ (ccfv @ XU @ ccss) @ cccbn))) => ((! [Xy1:$i] : (Xph => (cwcel @ XA2 @ (XX @ Xy1)))) => (Xph => (cwreu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ XM) @ XN) @ (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ XM) @ XN) @ ccle)) @ (^ [Xy1:$i] : XY))) @ (^ [Xx3:$i] : XY))))))))))))))))))).
