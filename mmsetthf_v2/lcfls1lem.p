...
thf(clcfls1lem_conj,conjecture,(! [XC:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : ((! [Xf1:$i] : ((XC @ Xf1) = (ccrab @ (^ [Xf1:$i] : (((ccfv @ (ccfv @ (ccfv @ (ccv @ Xf1) @ XL) @ Xc_pe) @ Xc_pe) = (ccfv @ (ccv @ Xf1) @ XL)) & (cwss @ (ccfv @ (ccfv @ (ccv @ Xf1) @ XL) @ Xc_pe) @ XQ))) @ (^ [Xf1:$i] : XF)))) => (! [Xf1:$i] : ((cwcel @ XG @ (XC @ Xf1)) <=> (cw3a @ (cwcel @ XG @ XF) @ ((ccfv @ (ccfv @ (ccfv @ XG @ XL) @ Xc_pe) @ Xc_pe) = (ccfv @ XG @ XL)) @ (cwss @ (ccfv @ (ccfv @ XG @ XL) @ Xc_pe) @ XQ)))))))))))).
