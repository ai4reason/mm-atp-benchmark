...
thf(cgrpidval_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((XB2 = (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : (! [Xe:$i] : ((Xc_pl @ Xx3 @ Xe) = (ccfv @ XG @ ccplusg)))) => ((! [Xx3:$i] : (! [Xe:$i] : ((Xc_0 @ Xx3 @ Xe) = (ccfv @ XG @ cc0g)))) => (! [Xx3:$i] : (! [Xe:$i] : ((Xc_0 @ Xx3 @ Xe) = (ccio @ (^ [Xe:$i] : ((cwcel @ (ccv @ Xe) @ XB2) & (cwral @ (^ [Xx3:$i] : (((cco @ (ccv @ Xe) @ (ccv @ Xx3) @ (Xc_pl @ Xx3 @ Xe)) = (ccv @ Xx3)) & ((cco @ (ccv @ Xx3) @ (ccv @ Xe) @ (Xc_pl @ Xx3 @ Xe)) = (ccv @ Xx3)))) @ (^ [Xx3:$i] : XB2)))))))))))))))).
