...
thf(arepswlen_ax,axiom,(! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XS @ XV) & (cwcel @ XN @ ccn0)) => ((ccfv @ (cco @ XS @ XN @ ccreps) @ cchash) = XN)))))).
...
thf(arepswsymb_ax,axiom,(! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XS @ XV) @ (cwcel @ XN @ ccn0) @ (cwcel @ XI @ (cco @ ccc0 @ XN @ ccfzo))) => ((ccfv @ XI @ (cco @ XS @ XN @ ccreps)) = XS))))))).
...
thf(afzocatel_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ (cco @ ccc0 @ (cco @ XB2 @ XC @ ccaddc) @ ccfzo)) & (~ (cwcel @ XA2 @ (cco @ ccc0 @ XB2 @ ccfzo)))) & ((cwcel @ XB2 @ ccz) & (cwcel @ XC @ ccz))) => (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ ccc0 @ XC @ ccfzo))))))).
...
thf(accatfval_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XS @ (XV @ Xx3)) & (cwcel @ XT @ (XW @ Xx3))) => ((cco @ XS @ XT @ ccconcat) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XS @ cchash) @ (ccfv @ XT @ cchash) @ ccaddc) @ ccfzo)) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfzo)) @ (ccfv @ (ccv @ Xx3) @ XS) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccfv @ XS @ cchash) @ ccmin) @ XT)))))))))))).
thf(ccc_tp,type,(ccc : ($i > $o))).
thf(ccn_tp,type,(ccn : ($i > $o))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(ann0addcl_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) => (cwcel @ (cco @ XM @ XN @ ccaddc) @ ccn0))))).
thf(areps_ax,axiom,(! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XS @ (XV @ Xx3)) & (cwcel @ XN @ ccn0)) => ((cco @ XS @ XN @ ccreps) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ XN @ ccfzo)) @ (^ [Xx3:$i] : XS))))))))).
thf(crepswccat_conj,conjecture,(! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XS @ XV) @ (cwcel @ XN @ ccn0) @ (cwcel @ XM @ ccn0)) => ((cco @ (cco @ XS @ XN @ ccreps) @ (cco @ XS @ XM @ ccreps) @ ccconcat) = (cco @ XS @ (cco @ XN @ XM @ ccaddc) @ ccreps)))))))).
