...
thf(ccotsqcscsq_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ (ccfv @ XA2 @ ccsin) @ ccc0)) => ((cco @ cc1 @ (cco @ (ccfv @ XA2 @ cccot) @ cc2 @ ccexp) @ ccaddc) = (cco @ (ccfv @ XA2 @ cccsc) @ cc2 @ ccexp))))).
