...
thf(c_3elpr2eq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (((cw3a @ (cwcel @ XX @ (ccpr @ XA2 @ XB2)) @ (cwcel @ XY @ (ccpr @ XA2 @ XB2)) @ (cwcel @ XZ @ (ccpr @ XA2 @ XB2))) & ((cwne @ XY @ XX) & (cwne @ XZ @ XX))) => (XY = XZ)))))))).
