...
thf(cdisji_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (((ccv @ Xx3) = XX) => ((XB2 @ Xx3) = XC))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XY) => ((XB2 @ Xx3) = XD))) => (! [Xx3:$i] : ((cw3a @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ((cwcel @ XX @ XA2) & (cwcel @ XY @ XA2)) @ ((cwcel @ (XZ @ Xx3) @ XC) & (cwcel @ (XZ @ Xx3) @ XD))) => (XX = XY))))))))))))).
