...
thf(arearchi_ax,axiom,(cwcel @ ccrefld @ ccarchi)).
...
thf(asubsubm_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XH = (cco @ XG @ XS @ ccress)) => ((cwcel @ XS @ (ccfv @ XG @ ccsubmnd)) => ((cwcel @ XA2 @ (ccfv @ XH @ ccsubmnd)) <=> ((cwcel @ XA2 @ (ccfv @ XG @ ccsubmnd)) & (cwss @ XA2 @ XS)))))))))).
thf(ccdif_tp,type,(ccdif : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccple_tp,type,(ccple : ($i > $o))).
thf(ccplt_tp,type,(ccplt : ($i > $o))).
thf(asubmarchi_ax,axiom,(! [XA2:($i > $o)] : (! [XW:($i > $o)] : ((((cwcel @ XW @ cctos) & (cwcel @ XW @ ccarchi)) & (cwcel @ XA2 @ (ccfv @ XW @ ccsubmnd))) => (cwcel @ (cco @ XW @ XA2 @ ccress) @ ccarchi))))).
thf(cnn0archi_conj,conjecture,(cwcel @ (cco @ cccnfld @ ccn0 @ ccress) @ ccarchi)).
