...
thf(aulmuni_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (((cwbr @ XF @ XG @ (ccfv @ XS @ cculm)) & (cwbr @ XF @ XH @ (ccfv @ XS @ cculm))) => (XG = XH))))))).
...
thf(culmdm_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ (ccfv @ XS @ cculm))) <=> (cwbr @ XF @ (ccfv @ XF @ (ccfv @ XS @ cculm)) @ (ccfv @ XS @ cculm)))))).
