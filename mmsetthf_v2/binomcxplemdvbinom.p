...
thf(abinomcxplemradcnv_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((Xph @ Xr @ Xb) => (cwcel @ (XA2 @ Xj @ Xk @ Xr @ Xb) @ ccrp)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((Xph @ Xr @ Xb) => (cwcel @ (XB2 @ Xj @ Xk @ Xr @ Xb) @ ccr)))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((Xph @ Xr @ Xb) => (cwbr @ (ccfv @ (XB2 @ Xj @ Xk @ Xr @ Xb) @ ccabs) @ (ccfv @ (XA2 @ Xj @ Xk @ Xr @ Xb) @ ccabs) @ cclt)))))) => ((! [Xr:$i] : (! [Xb:$i] : ((Xph @ Xr @ Xb) => (cwcel @ (XC @ Xr @ Xb) @ ccc)))) => ((! [Xj:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XF @ Xj @ Xr) = (ccmpt @ (^ [Xj:$i] : ccn0) @ (^ [Xj:$i] : (cco @ (XC @ Xr @ Xb) @ (ccv @ Xj) @ ccbcc))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XS @ Xj @ Xk @ Xb) = (ccmpt @ (^ [Xb:$i] : ccc) @ (^ [Xb:$i] : (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xj @ Xr)) @ (cco @ (ccv @ Xb) @ (ccv @ Xk) @ ccexp) @ ccmul)))))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : ((XR @ Xj @ Xk @ Xr @ Xb) = (ccsup @ (ccrab @ (^ [Xr:$i] : (cwcel @ (ccseq @ ccaddc @ (ccfv @ (ccv @ Xr) @ (XS @ Xj @ Xk @ Xb)) @ ccc0) @ (ccdm @ ccli))) @ (^ [Xr:$i] : ccr)) @ ccxr @ cclt)))))) => (! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xb:$i] : (((Xph @ Xr @ Xb) & (~ (cwcel @ (XC @ Xr @ Xb) @ ccn0))) => ((XR @ Xj @ Xk @ Xr @ Xb) = cc1))))))))))))))))))))).
...
thf(advcncxp1_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((cwcel @ XA2 @ ccc) => ((cco @ ccc @ (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ cccxp))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (cco @ XA2 @ (cco @ (ccv @ Xx3) @ (cco @ XA2 @ cc1 @ ccmin) @ cccxp) @ ccmul))))))))).
