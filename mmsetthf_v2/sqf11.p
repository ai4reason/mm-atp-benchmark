...
thf(apc11_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn0) & (cwcel @ XB2 @ ccn0)) => ((XA2 = XB2) <=> (cwral @ (^ [Xp:$i] : ((cco @ (ccv @ Xp) @ XA2 @ ccpc) = (cco @ (ccv @ Xp) @ XB2 @ ccpc))) @ (^ [Xp:$i] : ccprime))))))).
...
thf(asqfpc_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccn) @ (cwne @ (ccfv @ XA2 @ ccmu) @ ccc0) @ (cwcel @ XP @ ccprime)) => (cwbr @ (cco @ XP @ XA2 @ ccpc) @ cc1 @ ccle))))).
...
thf(csqf11_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccn) & (cwne @ (ccfv @ XA2 @ ccmu) @ ccc0)) & ((cwcel @ XB2 @ ccn) & (cwne @ (ccfv @ XB2 @ ccmu) @ ccc0))) => ((XA2 = XB2) <=> (cwral @ (^ [Xp:$i] : ((cwbr @ (ccv @ Xp) @ XA2 @ ccdvds) <=> (cwbr @ (ccv @ Xp) @ XB2 @ ccdvds))) @ (^ [Xp:$i] : ccprime))))))).
