...
thf(c_2ndcsep_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ cc2ndc) => (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) & ((ccfv @ (ccv @ Xx3) @ (ccfv @ XJ @ cccl)) = XX))) @ (^ [Xx3:$i] : (ccpw @ XX)))))))).
