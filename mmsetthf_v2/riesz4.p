...
thf(ariesz4i_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ cclf) => ((cwcel @ XT @ cccnfn) => (cwreu @ (^ [Xw:$i] : (cwral @ (^ [Xv:$i] : ((ccfv @ (ccv @ Xv) @ XT) = (cco @ (ccv @ Xv) @ (ccv @ Xw) @ ccsp))) @ (^ [Xv:$i] : cchil))) @ (^ [Xw:$i] : cchil)))))).
...
thf(criesz4_conj,conjecture,(! [XT:($i > $o)] : ((cwcel @ XT @ (ccin @ cclf @ cccnfn)) => (cwreu @ (^ [Xw:$i] : (cwral @ (^ [Xv:$i] : ((ccfv @ (ccv @ Xv) @ XT) = (cco @ (ccv @ Xv) @ (ccv @ Xw) @ ccsp))) @ (^ [Xv:$i] : cchil))) @ (^ [Xw:$i] : cchil))))).
