...
thf(a_2sqn0_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((Xph => (cwcel @ XP @ ccprime)) => ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XB2 @ ccz)) => ((Xph => ((cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) = XP)) => (Xph => (cwne @ XA2 @ ccc0))))))))))).
...
thf(ann0sqeq1_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & ((cco @ XN @ cc2 @ ccexp) = cc1)) => (XN = cc1)))).
