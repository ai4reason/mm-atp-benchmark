...
thf(aswrdval_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XS @ XV) @ (cwcel @ XF @ ccz) @ (cwcel @ XL @ ccz)) => ((cco @ XS @ (ccop @ XF @ XL) @ ccsubstr) = (ccif @ (cwss @ (cco @ XF @ XL @ ccfzo) @ (ccdm @ XS)) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (cco @ XL @ XF @ ccmin) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ XF @ ccaddc) @ XS))) @ cc0)))))))).
...
thf(assfzoulel_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) => (((cwbr @ XN @ XA2 @ ccle) | (cwbr @ XB2 @ ccc0 @ ccle)) => ((cwss @ (cco @ XA2 @ XB2 @ ccfzo) @ (cco @ ccc0 @ XN @ ccfzo)) => (cwbr @ XB2 @ XA2 @ ccle)))))))).
...
thf(cswrdnd2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) => ((cw3o @ (cwbr @ XB2 @ XA2 @ ccle) @ (cwbr @ (ccfv @ XW @ cchash) @ XA2 @ ccle) @ (cwbr @ XB2 @ ccc0 @ ccle)) => ((cco @ XW @ (ccop @ XA2 @ XB2) @ ccsubstr) = cc0)))))))).
