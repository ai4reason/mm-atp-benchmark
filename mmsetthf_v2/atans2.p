...
thf(aatans_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((! [Xy1:$i] : ((XS @ Xy1) = (ccrab @ (^ [Xy1:$i] : (cwcel @ (cco @ cc1 @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ XD)) @ (^ [Xy1:$i] : ccc)))) => (! [Xy1:$i] : ((cwcel @ XA2 @ (XS @ Xy1)) <=> ((cwcel @ XA2 @ ccc) & (cwcel @ (cco @ cc1 @ (cco @ XA2 @ cc2 @ ccexp) @ ccaddc) @ XD)))))))))).
thf(a_3anass_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) <=> (Xph & (Xps & Xch))))))).
thf(catans2_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((! [Xy1:$i] : ((XS @ Xy1) = (ccrab @ (^ [Xy1:$i] : (cwcel @ (cco @ cc1 @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ XD)) @ (^ [Xy1:$i] : ccc)))) => (! [Xy1:$i] : ((cwcel @ XA2 @ (XS @ Xy1)) <=> (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccmin) @ XD) @ (cwcel @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) @ XD)))))))))).
