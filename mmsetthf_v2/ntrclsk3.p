...
thf(asselpwd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XB2 @ XV)) => ((Xph => (cwss @ XA2 @ XB2)) => (Xph => (cwcel @ XA2 @ (ccpw @ XB2)))))))))).
...
thf(ainss_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwss @ XA2 @ XC) | (cwss @ XB2 @ XC)) => (cwss @ (ccin @ XA2 @ XB2) @ XC)))))).
thf(asscon34b_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwss @ XA2 @ XC) & (cwss @ XB2 @ XC)) => ((cwss @ XA2 @ XB2) <=> (cwss @ (ccdif @ XC @ XB2) @ (ccdif @ XC @ XA2)))))))).
...
thf(arp_simp2_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) => Xps))))).
