...
thf(alsatcvat3_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((XS = (ccfv @ XW @ cclss)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((XA2 = (ccfv @ XW @ cclsa)) => ((Xph => (cwcel @ XW @ cclvec)) => ((Xph => (cwcel @ XU @ XS)) => ((Xph => (cwcel @ XQ @ XA2)) => ((Xph => (cwcel @ XR @ XA2)) => ((Xph => (cwne @ XQ @ XR)) => ((Xph => (~ (cwss @ XR @ XU))) => ((Xph => (cwss @ XQ @ (cco @ XU @ XR @ Xc_po))) => (Xph => (cwcel @ (ccin @ XU @ (cco @ XQ @ XR @ Xc_po)) @ XA2))))))))))))))))))))).
...
thf(al1cvpat_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XS = (ccfv @ XW @ cclss)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((XA2 = (ccfv @ XW @ cclsa)) => ((XC = (ccfv @ XW @ cclcv)) => ((Xph => (cwcel @ XW @ cclvec)) => ((Xph => (cwcel @ XU @ XS)) => ((Xph => (cwcel @ XQ @ XA2)) => ((Xph => (cwbr @ XU @ XV @ XC)) => ((Xph => (~ (cwss @ XQ @ XU))) => (Xph => ((cco @ XU @ XQ @ Xc_po) = XV)))))))))))))))))))))).
