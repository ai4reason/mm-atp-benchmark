...
thf(cpw2f1olem_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XA2 @ (XV @ Xz)))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XB2 @ (XW @ Xz)))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XC @ (XW @ Xz)))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwne @ XB2 @ XC))) => (! [Xz:$i] : ((Xph @ Xz) => (((cwcel @ XS @ (ccpw @ XA2)) & ((XG @ Xz) = (ccmpt @ (^ [Xz:$i] : XA2) @ (^ [Xz:$i] : (ccif @ (cwcel @ (ccv @ Xz) @ XS) @ XC @ XB2))))) <=> ((cwcel @ (XG @ Xz) @ (cco @ (ccpr @ XB2 @ XC) @ XA2 @ ccmap)) & (XS = (ccima @ (cccnv @ (XG @ Xz)) @ (ccsn @ XC)))))))))))))))))))).
