...
thf(aeqbrrdv2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((((cwrel @ XA2) & (cwrel @ XB2)) & Xph) => ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XA2) <=> (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XB2))))) => ((((cwrel @ XA2) & (cwrel @ XB2)) & Xph) => (XA2 = XB2))))))).
