...
thf(alogbge0b_ax,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XX @ ccrp)) => ((cwbr @ ccc0 @ (cco @ XB2 @ XX @ cclogb) @ ccle) <=> (cwbr @ cc1 @ XX @ ccle)))))).
thf(alogblt1b_ax,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XX @ ccrp)) => ((cwbr @ (cco @ XB2 @ XX @ cclogb) @ cc1 @ cclt) <=> (cwbr @ XX @ XB2 @ cclt)))))).
...
thf(cnnlog2ge0lt1_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((XN = cc1) <=> ((cwbr @ ccc0 @ (cco @ cc2 @ XN @ cclogb) @ ccle) & (cwbr @ (cco @ cc2 @ XN @ cclogb) @ cc1 @ cclt)))))).
