...
thf(alogdmnrp_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((cwcel @ XA2 @ XD) => (~ (cwcel @ (ccneg @ XA2) @ ccrp))))))).
...
thf(aellogrn_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccrn @ cclog)) <=> (cw3a @ (cwcel @ XA2 @ ccc) @ (cwbr @ (ccneg @ ccpi) @ (ccfv @ XA2 @ ccim) @ cclt) @ (cwbr @ (ccfv @ XA2 @ ccim) @ ccpi @ ccle))))).
...
thf(adiveq0d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwne @ XB2 @ ccc0)) => ((Xph => ((cco @ XA2 @ XB2 @ ccdiv) = ccc0)) => (Xph => (XA2 = ccc0)))))))))).
...
thf(acrimd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((ccfv @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccaddc) @ ccim) = XB2)))))))).
...
thf(aefeul_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ cce) = (cco @ (ccfv @ (ccfv @ XA2 @ ccre) @ cce) @ (cco @ (ccfv @ (ccfv @ XA2 @ ccim) @ cccos) @ (cco @ cci @ (ccfv @ (ccfv @ XA2 @ ccim) @ ccsin) @ ccmul) @ ccaddc) @ ccmul))))).
...
thf(clogf1o2_conj,conjecture,(! [XD:($i > $o)] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwf1o @ XD @ (ccima @ (cccnv @ ccim) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo)) @ (ccres @ cclog @ XD))))).
