...
thf(abtwnexchand_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XB2 @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XC @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XD @ (ccfv @ XN @ ccee))) => (((Xph & Xps) => (cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn)) => (((Xph & Xps) => (cwbr @ XC @ (ccop @ XA2 @ XD) @ ccbtwn)) => ((Xph & Xps) => (cwbr @ XB2 @ (ccop @ XA2 @ XD) @ ccbtwn))))))))))))))))).
...
thf(acgrextendand_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XB2 @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XC @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XD @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XE @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XF @ (ccfv @ XN @ ccee))) => (((Xph & Xps) => (cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn)) => (((Xph & Xps) => (cwbr @ XE @ (ccop @ XD @ XF) @ ccbtwn)) => (((Xph & Xps) => (cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XD @ XE) @ cccgr)) => (((Xph & Xps) => (cwbr @ (ccop @ XB2 @ XC) @ (ccop @ XE @ XF) @ cccgr)) => ((Xph & Xps) => (cwbr @ (ccop @ XA2 @ XC) @ (ccop @ XD @ XF) @ cccgr))))))))))))))))))))))).
thf(abtwnexch3and_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XB2 @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XC @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XD @ (ccfv @ XN @ ccee))) => (((Xph & Xps) => (cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn)) => (((Xph & Xps) => (cwbr @ XC @ (ccop @ XA2 @ XD) @ ccbtwn)) => ((Xph & Xps) => (cwbr @ XC @ (ccop @ XB2 @ XD) @ ccbtwn))))))))))))))))).
...
thf(asegconeq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee))) @ (cw3a @ (cwcel @ XQ @ (ccfv @ XN @ ccee)) @ (cwcel @ XX @ (ccfv @ XN @ ccee)) @ (cwcel @ XY @ (ccfv @ XN @ ccee)))) => ((cw3a @ (cwne @ XQ @ XA2) @ ((cwbr @ XA2 @ (ccop @ XQ @ XX) @ ccbtwn) & (cwbr @ (ccop @ XA2 @ XX) @ (ccop @ XB2 @ XC) @ cccgr)) @ ((cwbr @ XA2 @ (ccop @ XQ @ XY) @ ccbtwn) & (cwbr @ (ccop @ XA2 @ XY) @ (ccop @ XB2 @ XC) @ cccgr))) => (XX = XY))))))))))).
