...
thf(anbusgrvtx_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ ccusgr) & (cwcel @ XN @ XV)) => ((cco @ XG @ XN @ ccnbgr) = (ccrab @ (^ [Xn:$i] : (cwcel @ (ccpr @ XN @ (ccv @ Xn)) @ XE)) @ (^ [Xn:$i] : XV))))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(asimpr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(crusgrpropadjvtx_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xv:$i] : ((XV @ Xv) = (ccfv @ XG @ ccvtx))) => (! [Xk:$i] : ((cwbr @ XG @ (XK @ Xk) @ ccrusgr) => (cw3a @ (cwcel @ XG @ ccusgr) @ (cwcel @ (XK @ Xk) @ ccxnn0) @ (cwral @ (^ [Xv:$i] : ((ccfv @ (ccrab @ (^ [Xk:$i] : (cwcel @ (ccpr @ (ccv @ Xv) @ (ccv @ Xk)) @ (ccfv @ XG @ ccedg))) @ (^ [Xk:$i] : (XV @ Xv))) @ cchash) = (XK @ Xk))) @ (^ [Xv:$i] : (XV @ Xv))))))))))).
