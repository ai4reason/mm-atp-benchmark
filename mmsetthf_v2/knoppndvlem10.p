...
thf(cknoppndvlem10_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xx3:$i] : ((XT @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (ccv @ Xx3) @ ccmin) @ ccabs))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((XF @ Xx3 @ Xy1 @ Xn) = (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (XC @ Xx3) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccv @ Xn) @ ccexp) @ (ccv @ Xy1) @ ccmul) @ (XT @ Xx3)) @ ccmul))))))))) => ((! [Xy1:$i] : (XA2 = (cco @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccneg @ (XJ @ Xy1)) @ ccexp) @ cc2 @ ccdiv) @ XM @ ccmul))) => ((! [Xy1:$i] : (XB2 = (cco @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccneg @ (XJ @ Xy1)) @ ccexp) @ cc2 @ ccdiv) @ (cco @ XM @ cc1 @ ccaddc) @ ccmul))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XC @ Xx3) @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3) => (cwcel @ (XJ @ Xy1) @ ccn0)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XM @ ccz))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XN @ ccn))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((Xph @ Xx3) => ((ccfv @ (cco @ (ccfv @ (XJ @ Xy1) @ (ccfv @ XB2 @ (XF @ Xx3 @ Xy1 @ Xn))) @ (ccfv @ (XJ @ Xy1) @ (ccfv @ XA2 @ (XF @ Xx3 @ Xy1 @ Xn))) @ ccmin) @ ccabs) = (cco @ (cco @ (ccfv @ (XC @ Xx3) @ ccabs) @ (XJ @ Xy1) @ ccexp) @ cc2 @ ccdiv)))))))))))))))))))))))).
