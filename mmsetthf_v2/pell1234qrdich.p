...
thf(aelpell14qr_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) => ((cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) <=> ((cwcel @ XA2 @ ccr) & (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : ((XA2 = (cco @ (ccv @ Xz) @ (cco @ (ccfv @ XD @ ccsqrt) @ (ccv @ Xw) @ ccmul) @ ccaddc)) & ((cco @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ (cco @ XD @ (cco @ (ccv @ Xw) @ cc2 @ ccexp) @ ccmul) @ ccmin) = cc1))) @ (^ [Xw:$i] : ccz))) @ (^ [Xz:$i] : ccn0)))))))).
...
thf(cpell1234qrdich_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) & (cwcel @ XA2 @ (ccfv @ XD @ ccpell1234qr))) => ((cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) | (cwcel @ (ccneg @ XA2) @ (ccfv @ XD @ ccpell14qr))))))).
