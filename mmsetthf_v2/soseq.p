...
thf(aposeq_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xg1:$i] : (cwpo @ (ccun @ (XA2 @ Xy1 @ Xg1) @ (ccsn @ cc0)) @ (XR @ Xy1)))) => ((! [Xy1:$i] : (! [Xg1:$i] : ((XF @ Xy1) = (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : (cwf @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xg1) @ (ccv @ Xf1))) @ (^ [Xx3:$i] : ccon0))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XS @ Xx3 @ Xy1 @ Xf1 @ Xg1) = (ccopab @ (^ [Xf1:$i] : (^ [Xg1:$i] : (((cwcel @ (ccv @ Xf1) @ (XF @ Xy1)) & (cwcel @ (ccv @ Xg1) @ (XF @ Xy1))) & (cwrex @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) = (ccfv @ (ccv @ Xy1) @ (ccv @ Xg1)))) @ (^ [Xy1:$i] : (ccv @ Xx3))) & (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (XR @ Xy1)))) @ (^ [Xx3:$i] : ccon0))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (cwpo @ (XF @ Xy1) @ (XS @ Xx3 @ Xy1 @ Xf1 @ Xg1)))))))))))))).
...
thf(abianabs_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps <=> (Xph & Xch))) => (Xph => (Xps <=> Xch))))))).
...
thf(aorderseqlem_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xf1:$i] : ((XF @ Xx3 @ Xf1) = (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : (cwf @ (ccv @ Xx3) @ XA2 @ (ccv @ Xf1))) @ (^ [Xx3:$i] : ccon0))))))) => (! [Xx3:$i] : (! [Xf1:$i] : ((cwcel @ XG @ (XF @ Xx3 @ Xf1)) => (cwcel @ (ccfv @ (XX @ Xf1) @ XG) @ (ccun @ XA2 @ (ccsn @ cc0)))))))))))).
...
thf(atfisg_ax,axiom,(! [Xph:($i > $o)] : ((cwral @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccv @ Xx3))) => (Xph @ Xx3))) @ (^ [Xx3:$i] : ccon0)) => (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : ccon0))))).
...
thf(asyl6ci_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => (Xps => Xch)) => ((Xph => Xth) => ((Xch => (Xth => Xta)) => (Xph => (Xps => Xta))))))))))).
...
thf(asyldd_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => (Xps => (Xch => Xth))) => ((Xph => (Xps => (Xth => Xta))) => (Xph => (Xps => (Xch => Xta))))))))))).
...
thf(a_3orel13_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((~ Xph) & (~ Xch)) => ((cw3o @ Xph @ Xps @ Xch) => Xps)))))).
thf(aadantl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xch & Xph) => Xps)))))).
thf(affn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => (cwfn @ XF @ XA2)))))).
thf(aeqfnfv2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xx3:$i] : (((cwfn @ XF @ XA2) & (cwfn @ XG @ (XB2 @ Xx3))) => ((XF = XG) <=> ((XA2 = (XB2 @ Xx3)) & (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xx3) @ XG))) @ (^ [Xx3:$i] : XA2))))))))))).
