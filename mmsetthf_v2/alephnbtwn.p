...
thf(acardsdomel_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ (ccdm @ cccrd))) => ((cwbr @ XA2 @ XB2 @ ccsdm) <=> (cwcel @ XA2 @ (ccfv @ XB2 @ cccrd))))))).
...
thf(aalephsuc_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((ccfv @ (ccsuc @ XA2) @ ccale) = (ccfv @ (ccfv @ XA2 @ ccale) @ cchar))))).
thf(amp2b_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => ((Xph => Xps) => ((Xps => Xch) => Xch))))))).
thf(aharval2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ cccrd)) => ((ccfv @ XA2 @ cchar) = (ccint @ (ccrab @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ ccsdm)) @ (^ [Xx3:$i] : ccon0))))))).
...
thf(calephnbtwn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((ccfv @ XB2 @ cccrd) = XB2) => (~ ((cwcel @ (ccfv @ XA2 @ ccale) @ XB2) & (cwcel @ XB2 @ (ccfv @ (ccsuc @ XA2) @ ccale)))))))).
