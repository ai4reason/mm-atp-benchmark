...
thf(aabs3lemd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XD @ ccr)) => ((Xph => (cwbr @ (ccfv @ (cco @ XA2 @ XC @ ccmin) @ ccabs) @ (cco @ XD @ cc2 @ ccdiv) @ cclt)) => ((Xph => (cwbr @ (ccfv @ (cco @ XC @ XB2 @ ccmin) @ ccabs) @ (cco @ XD @ cc2 @ ccdiv) @ cclt)) => (Xph => (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ XD @ cclt)))))))))))))).
...
thf(aulmf2_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : (((cwfn @ XF @ XZ) & (cwbr @ XF @ XG @ (ccfv @ XS @ cculm))) => (cwf @ XZ @ (cco @ ccc @ XS @ ccmap) @ XF))))))).
...
thf(aabs3difd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => (Xph => (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ (cco @ (ccfv @ (cco @ XA2 @ XC @ ccmin) @ ccabs) @ (ccfv @ (cco @ XC @ XB2 @ ccmin) @ ccabs) @ ccaddc) @ ccle)))))))))).
...
thf(asub4d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XD @ ccc)) => (Xph => ((cco @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XD @ ccmin) @ ccmin) = (cco @ (cco @ XA2 @ XC @ ccmin) @ (cco @ XB2 @ XD @ ccmin) @ ccmin))))))))))))).
...
thf(aclimabs_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwbr @ XF @ XA2 @ ccli)) => ((! [Xk:$i] : (Xph => (cwcel @ XG @ (XW @ Xk)))) => ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XG) = (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ ccabs)))) => (Xph => (cwbr @ XG @ (ccfv @ XA2 @ ccabs) @ ccli)))))))))))))))).
...
thf(aclimsubc1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwbr @ XF @ XA2 @ ccli)) => ((Xph => (cwcel @ XC @ ccc)) => ((! [Xk:$i] : (Xph => (cwcel @ XG @ (XW @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XG) = (cco @ (ccfv @ (ccv @ Xk) @ XF) @ XC @ ccmin)))) => (Xph => (cwbr @ XG @ (cco @ XA2 @ XC @ ccmin) @ ccli)))))))))))))))))).
...
thf(aclimconst2_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwss @ (ccfv @ XM @ ccuz) @ XZ) => ((cwcel @ XZ @ ccvv) => (((cwcel @ XA2 @ ccc) & (cwcel @ XM @ ccz)) => (cwbr @ (ccxp @ XZ @ (ccsn @ XA2)) @ XA2 @ ccli)))))))).
...
thf(advlip2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((XJ = (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XS @ XS))) => ((! [Xx3:$i] : (Xph => (cwss @ (XX @ Xx3) @ XS))) => ((! [Xx3:$i] : (Xph => (cwf @ (XX @ Xx3) @ ccc @ XF))) => ((Xph => (cwcel @ XA2 @ XS)) => ((Xph => (cwcel @ XR @ ccxr)) => ((XB2 = (cco @ XA2 @ XR @ (ccfv @ XJ @ ccbl))) => ((Xph => (cwss @ XB2 @ (ccdm @ (cco @ XS @ XF @ ccdv)))) => ((Xph => (cwcel @ XM @ ccr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (cco @ XS @ XF @ ccdv)) @ ccabs) @ XM @ ccle))) => ((Xph & ((cwcel @ XY @ XB2) & (cwcel @ XZ @ XB2))) => (cwbr @ (ccfv @ (cco @ (ccfv @ XY @ XF) @ (ccfv @ XZ @ XF) @ ccmin) @ ccabs) @ (cco @ XM @ (ccfv @ (cco @ XY @ XZ @ ccmin) @ ccabs) @ ccmul) @ ccle)))))))))))))))))))))))).
...
thf(aledivmul2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccrp)) => (Xph => ((cwbr @ (cco @ XA2 @ XC @ ccdiv) @ XB2 @ ccle) <=> (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ ccle))))))))))).
...
thf(culmdvlem1_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xz:$i] : (! [Xm:$i] : (XZ = (ccfv @ (XM @ Xz @ Xm) @ ccuz)))) => ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((! [Xz:$i] : (! [Xm:$i] : (Xph => (cwcel @ (XM @ Xz @ Xm) @ ccz)))) => ((Xph => (cwf @ XZ @ (cco @ ccc @ XX @ ccmap) @ XF)) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xm:$i] : (Xph => (cwf @ XX @ ccc @ (XG @ Xx3 @ Xk @ Xm)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : ((Xph & (cwcel @ (ccv @ Xz) @ XX)) => (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xk) @ XF)))) @ (ccfv @ (ccv @ Xz) @ (XG @ Xx3 @ Xk @ Xm)) @ ccli)))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xm:$i] : (Xph => (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (cco @ XS @ (ccfv @ (ccv @ Xk) @ XF) @ ccdv))) @ (XH @ Xx3 @ Xk @ Xm) @ (ccfv @ XX @ cculm)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : ((Xph & (Xps @ Xx3 @ Xz @ Xk @ Xm)) => (cwcel @ (XC @ Xx3 @ Xm) @ XX)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : ((Xph & (Xps @ Xx3 @ Xz @ Xk @ Xm)) => (cwcel @ (XR @ Xz @ Xk) @ ccrp)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : ((Xph & (Xps @ Xx3 @ Xz @ Xk @ Xm)) => (cwcel @ (XU @ Xx3 @ Xz @ Xk @ Xm) @ ccrp)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : ((Xph & (Xps @ Xx3 @ Xz @ Xk @ Xm)) => (cwcel @ (XW @ Xx3 @ Xz @ Xk @ Xm) @ ccrp)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : ((Xph & (Xps @ Xx3 @ Xz @ Xk @ Xm)) => (cwbr @ (XU @ Xx3 @ Xz @ Xk @ Xm) @ (XW @ Xx3 @ Xz @ Xk @ Xm) @ cclt)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : ((Xph & (Xps @ Xx3 @ Xz @ Xk @ Xm)) => (cwss @ (cco @ (XC @ Xx3 @ Xm) @ (XU @ Xx3 @ Xz @ Xk @ Xm) @ (ccfv @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XS @ XS)) @ ccbl)) @ XX)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : ((Xph & (Xps @ Xx3 @ Xz @ Xk @ Xm)) => (cwbr @ (ccfv @ (cco @ (XY @ Xx3 @ Xm) @ (XC @ Xx3 @ Xm) @ ccmin) @ ccabs) @ (XU @ Xx3 @ Xz @ Xk @ Xm) @ cclt)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : ((Xph & (Xps @ Xx3 @ Xz @ Xk @ Xm)) => (cwcel @ (XN @ Xz) @ XZ)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : ((Xph & (Xps @ Xx3 @ Xz @ Xk @ Xm)) => (cwral @ (^ [Xm:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xx3) @ (cco @ XS @ (ccfv @ (XN @ Xz) @ XF) @ ccdv)) @ (ccfv @ (ccv @ Xx3) @ (cco @ XS @ (ccfv @ (ccv @ Xm) @ XF) @ ccdv)) @ ccmin) @ ccabs) @ (cco @ (cco @ (XR @ Xz @ Xk) @ cc2 @ ccdiv) @ cc2 @ ccdiv) @ cclt)) @ (^ [Xx3:$i] : XX))) @ (^ [Xm:$i] : (ccfv @ (XN @ Xz) @ ccuz)))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : ((Xph & (Xps @ Xx3 @ Xz @ Xk @ Xm)) => (cwbr @ (ccfv @ (cco @ (ccfv @ (XC @ Xx3 @ Xm) @ (cco @ XS @ (ccfv @ (XN @ Xz) @ XF) @ ccdv)) @ (ccfv @ (XC @ Xx3 @ Xm) @ (XH @ Xx3 @ Xk @ Xm)) @ ccmin) @ ccabs) @ (cco @ (XR @ Xz @ Xk) @ cc2 @ ccdiv) @ cclt)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : ((Xph & (Xps @ Xx3 @ Xz @ Xk @ Xm)) => (cwcel @ (XY @ Xx3 @ Xm) @ XX)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : ((Xph & (Xps @ Xx3 @ Xz @ Xk @ Xm)) => (cwne @ (XY @ Xx3 @ Xm) @ (XC @ Xx3 @ Xm))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : ((Xph & (Xps @ Xx3 @ Xz @ Xk @ Xm)) => ((cwbr @ (ccfv @ (cco @ (XY @ Xx3 @ Xm) @ (XC @ Xx3 @ Xm) @ ccmin) @ ccabs) @ (XW @ Xx3 @ Xz @ Xk @ Xm) @ cclt) => (cwbr @ (ccfv @ (cco @ (cco @ (cco @ (ccfv @ (XY @ Xx3 @ Xm) @ (ccfv @ (XN @ Xz) @ XF)) @ (ccfv @ (XC @ Xx3 @ Xm) @ (ccfv @ (XN @ Xz) @ XF)) @ ccmin) @ (cco @ (XY @ Xx3 @ Xm) @ (XC @ Xx3 @ Xm) @ ccmin) @ ccdiv) @ (ccfv @ (XC @ Xx3 @ Xm) @ (cco @ XS @ (ccfv @ (XN @ Xz) @ XF) @ ccdv)) @ ccmin) @ ccabs) @ (cco @ (cco @ (XR @ Xz @ Xk) @ cc2 @ ccdiv) @ cc2 @ ccdiv) @ cclt))))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xm:$i] : ((Xph & (Xps @ Xx3 @ Xz @ Xk @ Xm)) => (cwbr @ (ccfv @ (cco @ (cco @ (cco @ (ccfv @ (XY @ Xx3 @ Xm) @ (XG @ Xx3 @ Xk @ Xm)) @ (ccfv @ (XC @ Xx3 @ Xm) @ (XG @ Xx3 @ Xk @ Xm)) @ ccmin) @ (cco @ (XY @ Xx3 @ Xm) @ (XC @ Xx3 @ Xm) @ ccmin) @ ccdiv) @ (ccfv @ (XC @ Xx3 @ Xm) @ (XH @ Xx3 @ Xk @ Xm)) @ ccmin) @ ccabs) @ (XR @ Xz @ Xk) @ cclt)))))))))))))))))))))))))))))))))))))))))).
