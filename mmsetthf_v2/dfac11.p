...
thf(aaomclem8_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ (XA2 @ Xy1) @ ccon0)))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwral @ (^ [Xa:$i] : ((cwne @ (ccv @ Xa) @ cc0) => (cwcel @ (ccfv @ (ccv @ Xa) @ (ccv @ Xy1)) @ (ccdif @ (ccin @ (ccpw @ (ccv @ Xa)) @ ccfn) @ (ccsn @ cc0))))) @ (^ [Xa:$i] : (ccpw @ (ccfv @ (XA2 @ Xy1) @ ccr1))))))) => (! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (? [Xb:$i] : (cwwe @ (ccfv @ (XA2 @ Xy1) @ ccr1) @ (ccv @ Xb))))))))))).
thf(arankon_ax,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccfv @ XA2 @ ccrnk) @ ccon0))).
thf(amp2b_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => ((Xph => Xps) => ((Xps => Xch) => Xch))))))).
thf(ar1rankid_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwss @ XA2 @ (ccfv @ (ccfv @ XA2 @ ccrnk) @ ccr1)))))).
...
thf(adfac8_ax,axiom,(cwac <=> (! [Xx3:$i] : (? [Xr:$i] : (cwwe @ (ccv @ Xx3) @ (ccv @ Xr)))))).
thf(cdfac11_conj,conjecture,(cwac <=> (! [Xx3:$i] : (? [Xf1:$i] : (cwral @ (^ [Xz:$i] : ((cwne @ (ccv @ Xz) @ cc0) => (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xf1)) @ (ccdif @ (ccin @ (ccpw @ (ccv @ Xz)) @ ccfn) @ (ccsn @ cc0))))) @ (^ [Xz:$i] : (ccv @ Xx3))))))).
