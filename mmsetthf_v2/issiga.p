...
thf(cissiga_conj,conjecture,(! [XS:($i > $o)] : (! [XO:($i > $o)] : ((cwcel @ XS @ ccvv) => ((cwcel @ XS @ (ccfv @ XO @ ccsiga)) <=> ((cwss @ XS @ (ccpw @ XO)) & (cw3a @ (cwcel @ XO @ XS) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccdif @ XO @ (ccv @ Xx3)) @ XS)) @ (^ [Xx3:$i] : XS)) @ (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) => (cwcel @ (ccuni @ (ccv @ Xx3)) @ XS))) @ (^ [Xx3:$i] : (ccpw @ XS)))))))))).
