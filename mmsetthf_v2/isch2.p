...
thf(aisch_ax,axiom,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) <=> ((cwcel @ XH @ ccsh) & (cwss @ (ccima @ cchli @ (cco @ XH @ ccn @ ccmap)) @ XH))))).
...
thf(cisch2_conj,conjecture,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) <=> ((cwcel @ XH @ ccsh) & (! [Xf1:$i] : (! [Xx3:$i] : (((cwf @ ccn @ XH @ (ccv @ Xf1)) & (cwbr @ (ccv @ Xf1) @ (ccv @ Xx3) @ cchli)) => (cwcel @ (ccv @ Xx3) @ XH)))))))).
