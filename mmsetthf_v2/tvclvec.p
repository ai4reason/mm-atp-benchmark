...
thf(atvclmod_ax,axiom,(! [XW:($i > $o)] : ((cwcel @ XW @ cctvc) => (cwcel @ XW @ cclmod)))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(atvctdrg_ax,axiom,(! [XF:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((cwcel @ XW @ cctvc) => (cwcel @ XF @ cctdrg)))))).
...
thf(atdrgdrng_ax,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ cctdrg) => (cwcel @ XR @ ccdr)))).
