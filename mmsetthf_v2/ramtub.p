...
thf(cramtub_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XC @ Xi @ Xn @ Xs1 @ Xa @ Xb) = (ccmpt2 @ (^ [Xa:$i] : (^ [Xi:$i] : ccvv)) @ (^ [Xa:$i] : (^ [Xi:$i] : ccn0)) @ (^ [Xa:$i] : (^ [Xi:$i] : (ccrab @ (^ [Xb:$i] : ((ccfv @ (ccv @ Xb) @ cchash) = (ccv @ Xi))) @ (^ [Xb:$i] : (ccpw @ (ccv @ Xa))))))))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((XT @ Xx3 @ Xf1 @ Xi @ Xn @ Xs1 @ Xa @ Xb @ Xc) = (ccrab @ (^ [Xn:$i] : (! [Xs1:$i] : ((cwbr @ (ccv @ Xn) @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccle) => (cwral @ (^ [Xf1:$i] : (cwrex @ (^ [Xc:$i] : (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccfv @ (ccv @ Xc) @ (XF @ Xi @ Xa @ Xb)) @ (ccfv @ (ccv @ Xx3) @ cchash) @ ccle) & (cwss @ (cco @ (ccv @ Xx3) @ XM @ (XC @ Xi @ Xn @ Xs1 @ Xa @ Xb)) @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ (ccv @ Xc)))))) @ (^ [Xx3:$i] : (ccpw @ (ccv @ Xs1))))) @ (^ [Xc:$i] : (XR @ Xi @ Xa @ Xb)))) @ (^ [Xf1:$i] : (cco @ (XR @ Xi @ Xa @ Xb) @ (cco @ (ccv @ Xs1) @ XM @ (XC @ Xi @ Xn @ Xs1 @ Xa @ Xb)) @ ccmap)))))) @ (^ [Xn:$i] : ccn0))))))))))) => (! [Xx3:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (((cw3a @ (cwcel @ XM @ ccn0) @ (cwcel @ (XR @ Xi @ Xa @ Xb) @ (XV @ Xi @ Xa @ Xb)) @ (cwf @ (XR @ Xi @ Xa @ Xb) @ ccn0 @ (XF @ Xi @ Xa @ Xb))) & (cwcel @ (XA2 @ Xf1 @ Xn @ Xs1 @ Xb @ Xc) @ (XT @ Xx3 @ Xf1 @ Xi @ Xn @ Xs1 @ Xa @ Xb @ Xc))) => (cwbr @ (cco @ XM @ (XF @ Xi @ Xa @ Xb) @ ccram) @ (XA2 @ Xf1 @ Xn @ Xs1 @ Xb @ Xc) @ ccle)))))))))))))))))))).
