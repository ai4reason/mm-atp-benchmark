...
thf(celeesubd_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xi:$i] : ((Xph @ Xi) => ((XC @ Xi) = (ccmpt @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XA2) @ (ccfv @ (ccv @ Xi) @ XB2) @ ccmin)))))) => (! [Xi:$i] : ((cw3a @ (Xph @ Xi) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee))) => (cwcel @ (XC @ Xi) @ (ccfv @ XN @ ccee))))))))))).
