...
thf(aplyeq0lem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((Xph => (cwss @ XS @ ccc)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XA2 @ (cco @ (ccun @ XS @ (ccsn @ ccc0)) @ ccn0 @ ccmap))) => ((Xph => ((ccima @ XA2 @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccuz)) = (ccsn @ ccc0))) => ((Xph => (cc0p = (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul))))))) => ((! [Xz:$i] : ((XM @ Xz) = (ccsup @ (ccima @ (cccnv @ XA2) @ (ccdif @ XS @ (ccsn @ ccc0))) @ ccr @ cclt))) => ((Xph => (cwne @ (ccima @ (cccnv @ XA2) @ (ccdif @ XS @ (ccsn @ ccc0))) @ cc0)) => (~ Xph)))))))))))))).
...
thf(cplyeq0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwss @ XS @ ccc)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XA2 @ (cco @ (ccun @ XS @ (ccsn @ ccc0)) @ ccn0 @ ccmap))) => ((Xph => ((ccima @ XA2 @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccuz)) = (ccsn @ ccc0))) => ((Xph => (cc0p = (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul))))))) => (Xph => (XA2 = (ccxp @ ccn0 @ (ccsn @ ccc0)))))))))))))).
