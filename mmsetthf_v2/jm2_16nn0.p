...
thf(a_2nn0ind_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [Xet:($i > $o)] : (! [Xrh:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xy1:$i] : (Xps @ Xy1)) => ((! [Xy1:$i] : (Xch @ Xy1)) => ((! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ ccn) => (((Xth @ Xy1) & (Xta @ Xy1)) => (Xet @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = ccc0) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = cc1) => ((Xph @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ cc1 @ ccmin)) => ((Xph @ Xx3) <=> (Xth @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xta @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) => ((Xph @ Xx3) <=> (Xet @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XA2 @ Xy1)) => ((Xph @ Xx3) <=> (Xrh @ Xy1))))) => (! [Xy1:$i] : ((cwcel @ (XA2 @ Xy1) @ ccn0) => (Xrh @ Xy1))))))))))))))))))))).
...
thf(acongid_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => (cwbr @ XA2 @ (cco @ XB2 @ XB2 @ ccmin) @ ccdvds))))).
...
thf(army1_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) => ((cco @ XA2 @ cc1 @ ccrmy) = cc1)))).
...
thf(acongmul_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((cw3a @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz)) @ ((cwcel @ XD @ ccz) & (cwcel @ XE @ ccz)) @ ((cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccdvds) & (cwbr @ XA2 @ (cco @ XD @ XE @ ccmin) @ ccdvds))) => (cwbr @ XA2 @ (cco @ (cco @ XB2 @ XD @ ccmul) @ (cco @ XC @ XE @ ccmul) @ ccmin) @ ccdvds)))))))).
thf(asimp3l_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cw3a @ Xph @ Xps @ (Xch & Xth)) => Xch)))))).
thf(acongsub_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((cw3a @ (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz)) @ ((cwcel @ XD @ ccz) & (cwcel @ XE @ ccz)) @ ((cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccdvds) & (cwbr @ XA2 @ (cco @ XD @ XE @ ccmin) @ ccdvds))) => (cwbr @ XA2 @ (cco @ (cco @ XB2 @ XD @ ccmin) @ (cco @ XC @ XE @ ccmin) @ ccmin) @ ccdvds)))))))).
thf(aoveq12d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XD @ XF)))))))))))).
thf(armyluc_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccz)) => ((cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccrmy) = (cco @ (cco @ cc2 @ (cco @ (cco @ XA2 @ XN @ ccrmy) @ XA2 @ ccmul) @ ccmul) @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccmin) @ ccrmy) @ ccmin)))))).
...
thf(apnncand_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => (Xph => ((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XA2 @ XC @ ccmin) @ ccmin) = (cco @ XB2 @ XC @ ccaddc))))))))))).
...
thf(cjm2_16nn0_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccn0)) => (cwbr @ (cco @ XA2 @ cc1 @ ccmin) @ (cco @ (cco @ XA2 @ XN @ ccrmy) @ XN @ ccmin) @ ccdvds))))).
