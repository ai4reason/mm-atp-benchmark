...
thf(cumgrvad2edg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XE = (ccfv @ XG @ ccedg)) => ((((cwcel @ XG @ ccumgr) & (cwne @ XA2 @ XB2)) & ((cwcel @ (ccpr @ XN @ XA2) @ XE) & (cwcel @ (ccpr @ XB2 @ XN) @ XE))) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cw3a @ (cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwcel @ XN @ (ccv @ Xx3)) @ (cwcel @ XN @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XE))) @ (^ [Xx3:$i] : XE)))))))))).
