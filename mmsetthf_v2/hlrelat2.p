...
thf(alatnlemlt_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_lt = (ccfv @ XK @ ccplt)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((cw3a @ (cwcel @ XK @ cclat) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => ((~ (cwbr @ XX @ XY @ Xc_le)) <=> (cwbr @ (cco @ XX @ XY @ Xc_an) @ XX @ Xc_lt))))))))))))))).
...
thf(ahlrelat_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_lt = (ccfv @ XK @ ccplt)) => ((! [Xp:$i] : ((Xc_or @ Xp) = (ccfv @ XK @ ccjn))) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) & (cwbr @ XX @ XY @ Xc_lt)) => (cwrex @ (^ [Xp:$i] : ((cwbr @ XX @ (cco @ XX @ (ccv @ Xp) @ (Xc_or @ Xp)) @ Xc_lt) & (cwbr @ (cco @ XX @ (ccv @ Xp) @ (Xc_or @ Xp)) @ XY @ Xc_le))) @ (^ [Xp:$i] : XA2))))))))))))))))).
...
thf(apm4_55_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((~ ((~ Xph) & Xps)) <=> (Xph | (~ Xps)))))).
...
thf(chlrelat2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => ((~ (cwbr @ XX @ XY @ Xc_le)) <=> (cwrex @ (^ [Xp:$i] : ((cwbr @ (ccv @ Xp) @ XX @ Xc_le) & (~ (cwbr @ (ccv @ Xp) @ XY @ Xc_le)))) @ (^ [Xp:$i] : XA2)))))))))))))).
