...
thf(afaclbnd4lem3_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XM @ ccn0) & (cwcel @ XK @ ccn0)) & (XN = ccc0)) => (cwbr @ (cco @ (cco @ XN @ XK @ ccexp) @ (cco @ XM @ XN @ ccexp) @ ccmul) @ (cco @ (cco @ (cco @ cc2 @ (cco @ XK @ cc2 @ ccexp) @ ccexp) @ (cco @ XM @ (cco @ XM @ XK @ ccaddc) @ ccexp) @ ccmul) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccle)))))).
...
thf(afaclbnd3_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) => (cwbr @ (cco @ XM @ XN @ ccexp) @ (cco @ (cco @ XM @ XM @ ccexp) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccle))))).
...
thf(cfaclbnd4lem4_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XK @ ccn0) @ (cwcel @ XM @ ccn0)) => (cwbr @ (cco @ (cco @ XN @ XK @ ccexp) @ (cco @ XM @ XN @ ccexp) @ ccmul) @ (cco @ (cco @ (cco @ cc2 @ (cco @ XK @ cc2 @ ccexp) @ ccexp) @ (cco @ XM @ (cco @ XM @ XK @ ccaddc) @ ccexp) @ ccmul) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccle)))))).
