...
thf(adsmmlmod_ax,axiom,(! [Xph:$o] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwcel @ XI @ (XW @ Xx3)))) => ((Xph => (cwcel @ XS @ ccrg)) => ((Xph => (cwf @ XI @ cclmod @ XR)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => ((ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccsca) = XS))) => ((! [Xx3:$i] : ((XC @ Xx3) = (cco @ XS @ XR @ ccdsmm))) => (! [Xx3:$i] : (Xph => (cwcel @ (XC @ Xx3) @ cclmod))))))))))))))).
