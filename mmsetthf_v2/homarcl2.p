...
thf(chomarcl2_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (ccfv @ XC @ cchoma)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((cwcel @ XF @ (cco @ XX @ XY @ XH)) => ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)))))))))))).
