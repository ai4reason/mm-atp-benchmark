...
thf(acdaen_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccen) & (cwbr @ XC @ XD @ ccen)) => (cwbr @ (cco @ XA2 @ XC @ cccda) @ (cco @ XB2 @ XD @ cccda) @ ccen))))))).
...
thf(adjudisj_b_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (((ccin @ XA2 @ XB2) = cc0) => ((ccin @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (XC @ Xx3)))) @ (cciun @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (XD @ Xx3))))) = cc0))))))).
thf(acdaun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ ((ccin @ XA2 @ XB2) = cc0)) => (cwbr @ (cco @ XA2 @ XB2 @ cccda) @ (ccun @ XA2 @ XB2) @ ccen))))))).
...
thf(acarden2b_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) => ((ccfv @ XA2 @ cccrd) = (ccfv @ XB2 @ cccrd)))))).
thf(aficardom_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfn) => (cwcel @ (ccfv @ XA2 @ cccrd) @ ccom)))).
thf(annacda_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => ((ccfv @ (cco @ XA2 @ XB2 @ cccda) @ cccrd) = (cco @ XA2 @ XB2 @ ccoa)))))).
thf(a_3adant3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => ((cw3a @ Xph @ Xps @ Xth) => Xch))))))).
thf(aackbij1lem6_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccin @ (ccpw @ ccom) @ ccfn)) & (cwcel @ XB2 @ (ccin @ (ccpw @ ccom) @ ccfn))) => (cwcel @ (ccun @ XA2 @ XB2) @ (ccin @ (ccpw @ ccom) @ ccfn)))))).
thf(aackbij1lem7_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((XF = (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => ((cwcel @ XA2 @ (ccin @ (ccpw @ ccom) @ ccfn)) => ((ccfv @ XA2 @ XF) = (ccfv @ (cciun @ (^ [Xy1:$i] : XA2) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd))))))).
...
thf(cackbij1lem9_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((XF = (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => ((cw3a @ (cwcel @ XA2 @ (ccin @ (ccpw @ ccom) @ ccfn)) @ (cwcel @ XB2 @ (ccin @ (ccpw @ ccom) @ ccfn)) @ ((ccin @ XA2 @ XB2) = cc0)) => ((ccfv @ (ccun @ XA2 @ XB2) @ XF) = (cco @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ ccoa)))))))).
