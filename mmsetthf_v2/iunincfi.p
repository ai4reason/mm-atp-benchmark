...
thf(assinc_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xm:$i] : ((Xph & (cwcel @ (ccv @ Xm) @ (cco @ XM @ XN @ ccfzo))) => (cwss @ (ccfv @ (ccv @ Xm) @ XF) @ (ccfv @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc) @ XF)))) => (Xph => (cwss @ (ccfv @ XM @ XF) @ (ccfv @ XN @ XF)))))))))).
...
thf(ciunincfi_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ (cco @ XM @ XN @ ccfzo))) => (cwss @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF)))) => (Xph => ((cciun @ (^ [Xn:$i] : (cco @ XM @ XN @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XF))) = (ccfv @ XN @ XF)))))))))).
