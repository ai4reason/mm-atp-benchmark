...
thf(afinptfin_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfn) => (cwcel @ XA2 @ ccptfin)))).
...
thf(aptfinfin_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XA2)) => (((cwcel @ XA2 @ ccptfin) & (cwcel @ XP @ XX)) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwcel @ XP @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2)) @ ccfn))))))).
...
thf(ccomppfsc_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ cctop) => ((cwcel @ XJ @ cccmp) <=> (cwral @ (^ [Xc:$i] : ((XX = (ccuni @ (ccv @ Xc))) => (cwrex @ (^ [Xd:$i] : ((cwss @ (ccv @ Xd) @ (ccv @ Xc)) & (XX = (ccuni @ (ccv @ Xd))))) @ (^ [Xd:$i] : ccptfin)))) @ (^ [Xc:$i] : (ccpw @ XJ))))))))).
