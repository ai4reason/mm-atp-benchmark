...
thf(aunabs_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccun @ XA2 @ (ccin @ XA2 @ XB2)) = XA2)))).
...
thf(cvolun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwcel @ XB2 @ (ccdm @ ccvol)) @ ((ccin @ XA2 @ XB2) = cc0)) & ((cwcel @ (ccfv @ XA2 @ ccvol) @ ccr) & (cwcel @ (ccfv @ XB2 @ ccvol) @ ccr))) => ((ccfv @ (ccun @ XA2 @ XB2) @ ccvol) = (cco @ (ccfv @ XA2 @ ccvol) @ (ccfv @ XB2 @ ccvol) @ ccaddc)))))).
