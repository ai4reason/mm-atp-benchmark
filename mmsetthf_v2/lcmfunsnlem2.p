...
thf(aeqoreldif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XB2 @ XC) => ((cwcel @ XA2 @ XC) <=> ((XA2 = XB2) | (cwcel @ XA2 @ (ccdif @ XC @ (ccsn @ XB2)))))))))).
...
thf(aecase3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xch) => ((Xps => Xch) => (((~ (Xph | Xps)) => Xch) => Xch))))))).
