...
thf(atxcmplem2_ax,axiom,(! [Xph:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xv:$i] : (XX = (ccuni @ (XR @ Xv)))) => ((XY = (ccuni @ XS)) => ((! [Xv:$i] : ((Xph @ Xv) => (cwcel @ (XR @ Xv) @ cccmp))) => ((! [Xv:$i] : ((Xph @ Xv) => (cwcel @ XS @ cccmp))) => ((! [Xv:$i] : ((Xph @ Xv) => (cwss @ XW @ (cco @ (XR @ Xv) @ XS @ cctx)))) => ((! [Xv:$i] : ((Xph @ Xv) => ((ccxp @ XX @ XY) = (ccuni @ XW)))) => (! [Xv:$i] : ((Xph @ Xv) => (cwrex @ (^ [Xv:$i] : ((ccxp @ XX @ XY) = (ccuni @ (ccv @ Xv)))) @ (^ [Xv:$i] : (ccin @ (ccpw @ XW) @ ccfn)))))))))))))))))).
