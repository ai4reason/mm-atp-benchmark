...
thf(adf_nlm_ax,axiom,(ccnlm = (ccrab @ (^ [Xw:$i] : (cwsbc @ (^ [Xf1:$i] : ((cwcel @ (ccv @ Xf1) @ ccnrg) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xw) @ ccvsca)) @ (ccfv @ (ccv @ Xw) @ ccnm)) = (cco @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xf1) @ ccnm)) @ (ccfv @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xw) @ ccnm)) @ ccmul))) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xw) @ ccbs)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xf1) @ ccbs))))) @ (ccfv @ (ccv @ Xw) @ ccsca))) @ (^ [Xw:$i] : (ccin @ ccngp @ cclmod))))).
thf(cisnlm_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ ccnm)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccfv @ XW @ ccsca)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XK @ Xy1) = (ccfv @ (XF @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XA2 = (ccfv @ (XF @ Xx3 @ Xy1) @ ccnm)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XW @ ccnlm) <=> ((cw3a @ (cwcel @ XW @ ccngp) @ (cwcel @ XW @ cclmod) @ (cwcel @ (XF @ Xx3 @ Xy1) @ ccnrg)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_x) @ XN) = (cco @ (ccfv @ (ccv @ Xx3) @ XA2) @ (ccfv @ (ccv @ Xy1) @ XN) @ ccmul))) @ (^ [Xy1:$i] : XV))) @ (^ [Xx3:$i] : (XK @ Xy1))))))))))))))))))))).
