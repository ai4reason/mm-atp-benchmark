...
thf(amulcmpblnrlem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cco @ XA2 @ XD @ ccpp) = (cco @ XB2 @ XC @ ccpp)) & ((cco @ XF @ XS @ ccpp) = (cco @ XG @ XR @ ccpp))) => ((cco @ (cco @ XD @ XF @ ccmp) @ (cco @ (cco @ (cco @ XA2 @ XF @ ccmp) @ (cco @ XB2 @ XG @ ccmp) @ ccpp) @ (cco @ (cco @ XC @ XS @ ccmp) @ (cco @ XD @ XR @ ccmp) @ ccpp) @ ccpp) @ ccpp) = (cco @ (cco @ XD @ XF @ ccmp) @ (cco @ (cco @ (cco @ XA2 @ XG @ ccmp) @ (cco @ XB2 @ XF @ ccmp) @ ccpp) @ (cco @ (cco @ XC @ XR @ ccmp) @ (cco @ XD @ XS @ ccmp) @ ccpp) @ ccpp) @ ccpp)))))))))))).
...
thf(aenrbreq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccnp) & (cwcel @ XB2 @ ccnp)) & ((cwcel @ XC @ ccnp) & (cwcel @ XD @ ccnp))) => ((cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ ccer) <=> ((cco @ XA2 @ XD @ ccpp) = (cco @ XB2 @ XC @ ccpp))))))))).
