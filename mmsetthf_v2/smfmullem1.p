...
thf(aioogtlbd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo))) => (Xph => (cwbr @ XA2 @ XC @ cclt)))))))))).
thf(aiooltubd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo))) => (Xph => (cwbr @ XC @ XB2 @ cclt)))))))))).
...
thf(asqrlearg_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => ((cwbr @ (cco @ XA2 @ cc2 @ ccexp) @ XA2 @ ccle) <=> (cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccicc)))))))).
