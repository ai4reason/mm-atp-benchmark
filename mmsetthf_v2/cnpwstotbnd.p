...
thf(acnfldms_ax,axiom,(cwcel @ cccnfld @ ccmt)).
...
thf(acntotbnd_ax,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((XD = (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XX @ XX))) => ((cwcel @ XD @ (ccfv @ XX @ cctotbnd)) <=> (cwcel @ XD @ (ccfv @ XX @ ccbnd))))))).
...
thf(acnfldds_ax,axiom,((cccom @ ccabs @ ccmin) = (ccfv @ cccnfld @ ccds))).
...
thf(ccnpwstotbnd_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ (cco @ cccnfld @ XA2 @ ccress) @ XI @ ccpws)) => ((XD = (ccres @ (ccfv @ XY @ ccds) @ (ccxp @ XX @ XX))) => (((cwss @ XA2 @ ccc) & (cwcel @ XI @ ccfn)) => ((cwcel @ XD @ (ccfv @ XX @ cctotbnd)) <=> (cwcel @ XD @ (ccfv @ XX @ ccbnd)))))))))))).
