...
thf(artrclreclem1_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : ((Xph => (cwrel @ XR)) => ((Xph => (cwcel @ XR @ ccvv)) => (Xph => (cwss @ (ccres @ ccid @ (ccuni @ (ccuni @ XR))) @ (ccfv @ XR @ ccrtrcl)))))))).
thf(cc1_tp,type,(cc1 : ($i > $o))).
thf(artrclreclem2_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : ((Xph => (cwcel @ XR @ ccvv)) => (Xph => (cwss @ XR @ (ccfv @ XR @ ccrtrcl))))))).
thf(ccaddc_tp,type,(ccaddc : ($i > $o))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(cwbr_tp,type,(cwbr : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(ccopab_tp,type,(ccopab : (($i > ($i > $o)) > ($i > $o)))).
thf(artrclreclem3_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : ((Xph => (cwrel @ XR)) => ((Xph => (cwcel @ XR @ ccvv)) => (Xph => (cwss @ (cccom @ (ccfv @ XR @ ccrtrcl) @ (ccfv @ XR @ ccrtrcl)) @ (ccfv @ XR @ ccrtrcl)))))))).
...
thf(artrclreclem4_ax,axiom,(! [Xph:$o] : (! [XR:($i > ($i > $o))] : ((! [Xs1:$i] : (Xph => (cwrel @ (XR @ Xs1)))) => ((! [Xs1:$i] : (Xph => (cwcel @ (XR @ Xs1) @ ccvv))) => (Xph => (! [Xs1:$i] : ((cw3a @ (cwss @ (ccres @ ccid @ (ccun @ (ccdm @ (XR @ Xs1)) @ (ccrn @ (XR @ Xs1)))) @ (ccv @ Xs1)) @ (cwss @ (XR @ Xs1) @ (ccv @ Xs1)) @ (cwss @ (cccom @ (ccv @ Xs1) @ (ccv @ Xs1)) @ (ccv @ Xs1))) => (cwss @ (ccfv @ (XR @ Xs1) @ ccrtrcl) @ (ccv @ Xs1)))))))))).
