...
thf(adivgcdodd_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn)) => ((~ (cwbr @ cc2 @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv) @ ccdvds)) | (~ (cwbr @ cc2 @ (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv) @ ccdvds))))))).
...
thf(apythagtriplem19_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccn)) @ ((cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) = (cco @ XC @ cc2 @ ccexp)) @ (~ (cwbr @ cc2 @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv) @ ccdvds))) => (cwrex @ (^ [Xn:$i] : (cwrex @ (^ [Xm:$i] : (cwrex @ (^ [Xk:$i] : (cw3a @ (XA2 = (cco @ (ccv @ Xk) @ (cco @ (cco @ (ccv @ Xm) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ ccmin) @ ccmul)) @ (XB2 = (cco @ (ccv @ Xk) @ (cco @ cc2 @ (cco @ (ccv @ Xm) @ (ccv @ Xn) @ ccmul) @ ccmul) @ ccmul)) @ (XC = (cco @ (ccv @ Xk) @ (cco @ (cco @ (ccv @ Xm) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ ccaddc) @ ccmul)))) @ (^ [Xk:$i] : ccn))) @ (^ [Xm:$i] : ccn))) @ (^ [Xn:$i] : ccn))))))).
...
thf(annsqcl_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => (cwcel @ (cco @ XA2 @ cc2 @ ccexp) @ ccn)))).
...
thf(apythagtriplem2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn)) => ((cwrex @ (^ [Xn:$i] : (cwrex @ (^ [Xm:$i] : (cwrex @ (^ [Xk:$i] : (((ccpr @ XA2 @ XB2) = (ccpr @ (cco @ (ccv @ Xk) @ (cco @ (cco @ (ccv @ Xm) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ ccmin) @ ccmul) @ (cco @ (ccv @ Xk) @ (cco @ cc2 @ (cco @ (ccv @ Xm) @ (ccv @ Xn) @ ccmul) @ ccmul) @ ccmul))) & (XC = (cco @ (ccv @ Xk) @ (cco @ (cco @ (ccv @ Xm) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ ccaddc) @ ccmul)))) @ (^ [Xk:$i] : ccn))) @ (^ [Xm:$i] : ccn))) @ (^ [Xn:$i] : ccn)) => ((cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) = (cco @ XC @ cc2 @ ccexp)))))))).
thf(cpythagtrip_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccn)) => (((cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) = (cco @ XC @ cc2 @ ccexp)) <=> (cwrex @ (^ [Xn:$i] : (cwrex @ (^ [Xm:$i] : (cwrex @ (^ [Xk:$i] : (((ccpr @ XA2 @ XB2) = (ccpr @ (cco @ (ccv @ Xk) @ (cco @ (cco @ (ccv @ Xm) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ ccmin) @ ccmul) @ (cco @ (ccv @ Xk) @ (cco @ cc2 @ (cco @ (ccv @ Xm) @ (ccv @ Xn) @ ccmul) @ ccmul) @ ccmul))) & (XC = (cco @ (ccv @ Xk) @ (cco @ (cco @ (ccv @ Xm) @ cc2 @ ccexp) @ (cco @ (ccv @ Xn) @ cc2 @ ccexp) @ ccaddc) @ ccmul)))) @ (^ [Xk:$i] : ccn))) @ (^ [Xm:$i] : ccn))) @ (^ [Xn:$i] : ccn)))))))).
