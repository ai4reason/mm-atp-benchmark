...
thf(amonsect_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XM = (ccfv @ XC @ ccmon)) => ((XS = (ccfv @ XC @ ccsect)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((XN = (ccfv @ XC @ ccinv)) => ((Xph => (cwcel @ XF @ (cco @ XX @ XY @ XM))) => ((Xph => (cwbr @ XG @ XF @ (cco @ XY @ XX @ XS))) => (Xph => (cwbr @ XF @ XG @ (cco @ XX @ XY @ XN))))))))))))))))))))))).
...
thf(aoppcinv_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XO = (ccfv @ XC @ ccoppc)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((XI = (ccfv @ XC @ ccinv)) => ((XJ = (ccfv @ XO @ ccinv)) => (Xph => ((cco @ XX @ XY @ XJ) = (cco @ XY @ XX @ XI))))))))))))))))))).
thf(cepisect_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XE = (ccfv @ XC @ ccepi)) => ((XS = (ccfv @ XC @ ccsect)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((XN = (ccfv @ XC @ ccinv)) => ((Xph => (cwcel @ XF @ (cco @ XX @ XY @ XE))) => ((Xph => (cwbr @ XF @ XG @ (cco @ XX @ XY @ XS))) => (Xph => (cwbr @ XF @ XG @ (cco @ XX @ XY @ XN))))))))))))))))))))))).
