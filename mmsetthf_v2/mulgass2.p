...
thf(amulgp1_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XN @ ccz) @ (cwcel @ XX @ XB2)) => ((cco @ (cco @ XN @ cc1 @ ccaddc) @ XX @ Xc_x) = (cco @ (cco @ XN @ XX @ Xc_x) @ XX @ Xc_pl))))))))))))).
...
thf(aringmneg1_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XN = (ccfv @ XR @ ccminusg)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => (Xph => ((cco @ (ccfv @ XX @ XN) @ XY @ Xc_x) = (ccfv @ (cco @ XX @ XY @ Xc_x) @ XN))))))))))))))))).
thf(cmulgass2_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmg)) => ((Xc_xp = (ccfv @ XR @ ccmulr)) => (((cwcel @ XR @ ccrg) & (cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2))) => ((cco @ (cco @ XN @ XX @ Xc_x) @ XY @ Xc_xp) = (cco @ XN @ (cco @ XX @ XY @ Xc_xp) @ Xc_x)))))))))))))).
