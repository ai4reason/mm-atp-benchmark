...
thf(a_1stctop_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cc1stc) => (cwcel @ XJ @ cctop)))).
...
thf(almcld_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwbr @ XF @ XP @ (ccfv @ XJ @ cclm))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ XS))) => ((Xph => (cwcel @ XS @ (ccfv @ XJ @ cccld))) => (Xph => (cwcel @ XP @ XS))))))))))))))))).
...
thf(almss_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XK = (cco @ XJ @ XY @ ccrest)) => ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XY @ XV)) => ((Xph => (cwcel @ XJ @ cctop)) => ((Xph => (cwcel @ XP @ XY)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwf @ XZ @ XY @ XF)) => (Xph => ((cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) <=> (cwbr @ XF @ XP @ (ccfv @ XK @ cclm))))))))))))))))))))).
...
thf(a_1stckgenlem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwf @ ccn @ XX @ XF)) => ((Xph => (cwbr @ XF @ XA2 @ (ccfv @ XJ @ cclm))) => (Xph => (cwcel @ (cco @ XJ @ (ccun @ (ccrn @ XF) @ (ccsn @ XA2)) @ ccrest) @ cccmp))))))))))).
thf(akgeni_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ XJ @ cckgen)) & (cwcel @ (cco @ XJ @ XK @ ccrest) @ cccmp)) => (cwcel @ (ccin @ XA2 @ XK) @ (cco @ XJ @ XK @ ccrest))))))).
...
thf(akgenuni_ax,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ cctop) => (XX = (ccuni @ (ccfv @ XJ @ cckgen)))))))).
thf(aisopn2_ax,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => ((cwcel @ XS @ XJ) <=> (cwcel @ (ccdif @ XX @ XS) @ (ccfv @ XJ @ cccld))))))))).
thf(aiskgen2_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ (ccrn @ cckgen)) <=> ((cwcel @ XJ @ cctop) & (cwss @ (ccfv @ XJ @ cckgen) @ XJ))))).
thf(c_1stckgen_conj,conjecture,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cc1stc) => (cwcel @ XJ @ (ccrn @ cckgen))))).
