...
thf(amclsax_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > $o))] : (! [XO:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XD @ Xx3 @ Xy1 @ Xv @ Xa @ Xb) = (ccfv @ (XT @ Xv @ Xa @ Xb) @ ccmdv))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XE @ Xx3 @ Xy1 @ Xa @ Xb) = (ccfv @ (XT @ Xv @ Xa @ Xb) @ ccmex))))))) => ((! [Xy1:$i] : (! [Xv:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XC @ Xy1 @ Xa @ Xb) = (ccfv @ (XT @ Xv @ Xa @ Xb) @ ccmcls)))))) => ((! [Xv:$i] : (! [Xa:$i] : (! [Xb:$i] : (Xph => (cwcel @ (XT @ Xv @ Xa @ Xb) @ ccmfs))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xa:$i] : (! [Xb:$i] : (Xph => (cwss @ XK @ (XD @ Xx3 @ Xy1 @ Xv @ Xa @ Xb)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : (Xph => (cwss @ (XB2 @ Xa @ Xb) @ (XE @ Xx3 @ Xy1 @ Xa @ Xb))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XA2 @ Xx3 @ Xy1 @ Xv @ Xa @ Xb) = (ccfv @ (XT @ Xv @ Xa @ Xb) @ ccmax))))))) => ((! [Xv:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XL @ Xv @ Xa @ Xb) = (ccfv @ (XT @ Xv @ Xa @ Xb) @ ccmsub))))) => ((! [Xy1:$i] : (! [Xv:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XV @ Xy1 @ Xa @ Xb) = (ccfv @ (XT @ Xv @ Xa @ Xb) @ ccmvar)))))) => ((! [Xy1:$i] : (! [Xv:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XH @ Xy1) = (ccfv @ (XT @ Xv @ Xa @ Xb) @ ccmvh)))))) => ((! [Xy1:$i] : (! [Xv:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XW @ Xy1 @ Xv) = (ccfv @ (XT @ Xv @ Xa @ Xb) @ ccmvrs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xa:$i] : (! [Xb:$i] : (Xph => (cwcel @ (ccotp @ (XM @ Xv) @ (XO @ Xv @ Xa @ Xb) @ (XP @ Xv @ Xa @ Xb)) @ (XA2 @ Xx3 @ Xy1 @ Xv @ Xa @ Xb)))))))) => ((! [Xv:$i] : (! [Xa:$i] : (! [Xb:$i] : (Xph => (cwcel @ XS @ (ccrn @ (XL @ Xv @ Xa @ Xb))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (XO @ Xv @ Xa @ Xb))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XS) @ (cco @ XK @ (XB2 @ Xa @ Xb) @ (XC @ Xy1 @ Xa @ Xb))))))))) => ((! [Xy1:$i] : (! [Xv:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph & (cwcel @ (ccv @ Xv) @ (XV @ Xy1 @ Xa @ Xb))) => (cwcel @ (ccfv @ (ccfv @ (ccv @ Xv) @ (XH @ Xy1)) @ XS) @ (cco @ XK @ (XB2 @ Xa @ Xb) @ (XC @ Xy1 @ Xa @ Xb)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph & (cw3a @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XM @ Xv)) @ (cwcel @ (ccv @ Xa) @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XH @ Xy1)) @ XS) @ (XW @ Xy1 @ Xv))) @ (cwcel @ (ccv @ Xb) @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xy1) @ (XH @ Xy1)) @ XS) @ (XW @ Xy1 @ Xv))))) => (cwbr @ (ccv @ Xa) @ (ccv @ Xb) @ XK))))))) => (! [Xy1:$i] : (! [Xv:$i] : (! [Xa:$i] : (! [Xb:$i] : (Xph => (cwcel @ (ccfv @ (XP @ Xv @ Xa @ Xb) @ XS) @ (cco @ XK @ (XB2 @ Xa @ Xb) @ (XC @ Xy1 @ Xa @ Xb))))))))))))))))))))))))))))))))))))))))).
thf(ccmrsub_tp,type,(ccmrsub : ($i > $o))).
thf(cc2nd_tp,type,(cc2nd : ($i > $o))).
thf(cc1st_tp,type,(cc1st : ($i > $o))).
thf(ccmpt_tp,type,(ccmpt : (($i > ($i > $o)) > (($i > ($i > $o)) > ($i > $o))))).
thf(amsubco_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XS = (ccfv @ XT @ ccmsub)) => (((cwcel @ XF @ (ccrn @ XS)) & (cwcel @ XG @ (ccrn @ XS))) => (cwcel @ (cccom @ XF @ XG) @ (ccrn @ XS))))))))).
...
thf(amdvval_ax,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XT @ ccmvar)) => ((XD = (ccfv @ XT @ ccmdv)) => (XD = (ccdif @ (ccxp @ XV @ XV) @ ccid)))))))).
...
thf(amsubvrs_ax,axiom,(! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((XS @ Xx3) = (ccfv @ XT @ ccmsub))) => ((XE = (ccfv @ XT @ ccmex)) => ((XV = (ccfv @ XT @ ccmvrs)) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccfv @ XT @ ccmvh))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XT @ ccmfs) @ (cwcel @ XF @ (ccrn @ (XS @ Xx3))) @ (cwcel @ XX @ XE)) => ((ccfv @ (ccfv @ XX @ XF) @ XV) = (cciun @ (^ [Xx3:$i] : (ccfv @ XX @ XV)) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XH @ Xx3)) @ XF) @ XV)))))))))))))))))).
