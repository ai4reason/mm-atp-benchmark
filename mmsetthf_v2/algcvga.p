...
thf(aalgcvg_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > ($i > $o))] : ((cwf @ XS @ XS @ XF) => ((! [Xz:$i] : (XR = (ccseq @ (cccom @ XF @ cc1st) @ (ccxp @ ccn0 @ (ccsn @ (XA2 @ Xz))) @ ccc0))) => ((cwf @ XS @ ccn0 @ XC) => ((! [Xz:$i] : ((cwcel @ (ccv @ Xz) @ XS) => ((cwne @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ XC) @ ccc0) => (cwbr @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ XC) @ (ccfv @ (ccv @ Xz) @ XC) @ cclt)))) => ((! [Xz:$i] : ((XN @ Xz) = (ccfv @ (XA2 @ Xz) @ XC))) => (! [Xz:$i] : ((cwcel @ (XA2 @ Xz) @ XS) => ((ccfv @ (ccfv @ (XN @ Xz) @ XR) @ XC) = ccc0))))))))))))))).
...
thf(aalgcvgb_ax,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwf @ XS @ XS @ XF) => ((cwf @ XS @ ccn0 @ XC) => ((cwcel @ XX @ XS) => (((cwne @ (ccfv @ (ccfv @ XX @ XF) @ XC) @ ccc0) => (cwbr @ (ccfv @ (ccfv @ XX @ XF) @ XC) @ (ccfv @ XX @ XC) @ cclt)) <=> (((cwne @ (ccfv @ XX @ XC) @ ccc0) => (cwbr @ (ccfv @ (ccfv @ XX @ XF) @ XC) @ (ccfv @ XX @ XC) @ cclt)) & (((ccfv @ XX @ XC) = ccc0) => ((ccfv @ (ccfv @ XX @ XF) @ XC) = ccc0)))))))))))).
...
thf(calgcvga_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((cwf @ XS @ XS @ XF) => ((! [Xz:$i] : (XR = (ccseq @ (cccom @ XF @ cc1st) @ (ccxp @ ccn0 @ (ccsn @ (XA2 @ Xz))) @ ccc0))) => ((cwf @ XS @ ccn0 @ XC) => ((! [Xz:$i] : ((cwcel @ (ccv @ Xz) @ XS) => ((cwne @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ XC) @ ccc0) => (cwbr @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ XC) @ (ccfv @ (ccv @ Xz) @ XC) @ cclt)))) => ((! [Xz:$i] : ((XN @ Xz) = (ccfv @ (XA2 @ Xz) @ XC))) => (! [Xz:$i] : ((cwcel @ (XA2 @ Xz) @ XS) => ((cwcel @ (XK @ Xz) @ (ccfv @ (XN @ Xz) @ ccuz)) => ((ccfv @ (ccfv @ (XK @ Xz) @ XR) @ XC) = ccc0))))))))))))))))).
