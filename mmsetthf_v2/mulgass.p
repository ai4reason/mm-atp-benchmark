...
thf(amulgneg2_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((XI = (ccfv @ XG @ ccminusg)) => ((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XN @ ccz) @ (cwcel @ XX @ XB2)) => ((cco @ (ccneg @ XN) @ XX @ Xc_x) = (cco @ XN @ (ccfv @ XX @ XI) @ Xc_x))))))))))))).
...
thf(cmulgass_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => (((cwcel @ XG @ ccgrp) & (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwcel @ XX @ XB2))) => ((cco @ (cco @ XM @ XN @ ccmul) @ XX @ Xc_x) = (cco @ XM @ (cco @ XN @ XX @ Xc_x) @ Xc_x)))))))))))).
