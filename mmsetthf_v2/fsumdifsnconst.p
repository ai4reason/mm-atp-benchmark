...
thf(cfsumdifsnconst_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ ccc)) => ((ccsu @ (ccdif @ XA2 @ (ccsn @ XB2)) @ (^ [Xk:$i] : XC)) = (cco @ (cco @ (ccfv @ XA2 @ cchash) @ cc1 @ ccmin) @ XC @ ccmul))))))).
