...
thf(atanord1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccico)) & (cwcel @ XB2 @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccico))) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (ccfv @ XA2 @ cctan) @ (ccfv @ XB2 @ cctan) @ cclt)))))).
...
thf(ctanord_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)) & (cwcel @ XB2 @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (ccfv @ XA2 @ cctan) @ (ccfv @ XB2 @ cctan) @ cclt)))))).
