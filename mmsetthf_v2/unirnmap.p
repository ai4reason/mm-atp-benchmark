...
thf(cunirnmap_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwss @ XX @ (cco @ XB2 @ XA2 @ ccmap))) => (Xph => (cwss @ XX @ (cco @ (ccrn @ (ccuni @ XX)) @ XA2 @ ccmap))))))))))).
