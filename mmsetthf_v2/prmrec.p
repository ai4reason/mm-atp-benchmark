...
thf(aprmreclem6_ax,axiom,(! [XF:($i > $o)] : ((XF = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccc0)))) => (~ (cwcel @ (ccseq @ ccaddc @ XF @ cc1) @ (ccdm @ ccli)))))).
...
thf(cprmrec_conj,conjecture,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (! [Xn:$i] : ((XF @ Xk @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsu @ (ccin @ ccprime @ (cco @ cc1 @ (ccv @ Xn) @ ccfz)) @ (^ [Xk:$i] : (cco @ cc1 @ (ccv @ Xk) @ ccdiv)))))))) => (! [Xk:$i] : (! [Xn:$i] : (~ (cwcel @ (XF @ Xk @ Xn) @ (ccdm @ ccli)))))))).
