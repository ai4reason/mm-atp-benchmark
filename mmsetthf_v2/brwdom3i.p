...
thf(abrwdom3_ax,axiom,(! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (((cwcel @ XX @ (XV @ Xx3 @ Xy1 @ Xf1)) & (cwcel @ XY @ (XW @ Xx3 @ Xy1 @ Xf1))) => ((cwbr @ XX @ XY @ ccwdom) <=> (? [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)))) @ (^ [Xy1:$i] : XY))) @ (^ [Xx3:$i] : XX))))))))))))).
