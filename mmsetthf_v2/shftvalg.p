...
thf(cshftvalg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XF @ XV) @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) => ((ccfv @ XB2 @ (cco @ XF @ XA2 @ ccshi)) = (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ XF)))))))).
