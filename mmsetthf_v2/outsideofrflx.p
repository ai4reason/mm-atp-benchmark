...
thf(acolineartriv2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee))) => (cwbr @ XA2 @ (ccop @ XB2 @ XB2) @ cccolin)))))).
...
thf(coutsideofrflx_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XP @ (ccfv @ XN @ ccee)) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee))) => ((cwne @ XA2 @ XP) => (cwbr @ XP @ (ccop @ XA2 @ XA2) @ ccoutsideof))))))).
