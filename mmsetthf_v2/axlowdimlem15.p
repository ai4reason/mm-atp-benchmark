...
thf(aaxlowdimlem7_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((XP = (ccun @ (ccsn @ (ccop @ cc3 @ (ccneg @ cc1))) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ cc3)) @ (ccsn @ ccc0)))) => ((cwcel @ XN @ (ccfv @ cc3 @ ccuz)) => (cwcel @ XP @ (ccfv @ XN @ ccee))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(asylan_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => (((Xps & Xch) => Xth) => ((Xph & Xch) => Xth)))))))).
thf(aeluzge3nn_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ cc3 @ ccuz)) => (cwcel @ XN @ ccn)))).
thf(cwf1o_tp,type,(cwf1o : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(aaxlowdimlem10_ax,axiom,(! [XQ:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((XQ = (ccun @ (ccsn @ (ccop @ (cco @ XI @ cc1 @ ccaddc) @ cc1)) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (cco @ XI @ cc1 @ ccaddc))) @ (ccsn @ ccc0)))) => (((cwcel @ XN @ ccn) & (cwcel @ XI @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) => (cwcel @ XQ @ (ccfv @ XN @ ccee)))))))).
...
thf(aaxlowdimlem13_ax,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((XP = (ccun @ (ccsn @ (ccop @ cc3 @ (ccneg @ cc1))) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ cc3)) @ (ccsn @ ccc0)))) => ((XQ = (ccun @ (ccsn @ (ccop @ (cco @ XI @ cc1 @ ccaddc) @ cc1)) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (cco @ XI @ cc1 @ ccaddc))) @ (ccsn @ ccc0)))) => (((cwcel @ XN @ ccn) & (cwcel @ XI @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) => (cwne @ XP @ XQ))))))))).
...
thf(aaxlowdimlem14_ax,axiom,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((XQ = (ccun @ (ccsn @ (ccop @ (cco @ XI @ cc1 @ ccaddc) @ cc1)) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (cco @ XI @ cc1 @ ccaddc))) @ (ccsn @ ccc0)))) => ((XR = (ccun @ (ccsn @ (ccop @ (cco @ XJ @ cc1 @ ccaddc) @ cc1)) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (cco @ XJ @ cc1 @ ccaddc))) @ (ccsn @ ccc0)))) => ((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XI @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (cwcel @ XJ @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) => ((XQ = XR) => (XI = XJ))))))))))).
...
thf(caxlowdimlem15_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xi:$i] : ((XF @ Xi) = (ccmpt @ (^ [Xi:$i] : (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xi:$i] : (ccif @ ((ccv @ Xi) = cc1) @ (ccun @ (ccsn @ (ccop @ cc3 @ (ccneg @ cc1))) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ cc3)) @ (ccsn @ ccc0))) @ (ccun @ (ccsn @ (ccop @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ cc1)) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc))) @ (ccsn @ ccc0)))))))) => (! [Xi:$i] : ((cwcel @ XN @ (ccfv @ cc3 @ ccuz)) => (cwf1 @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (ccfv @ XN @ ccee) @ (XF @ Xi)))))))).
