...
thf(awallispi_ax,axiom,(! [XF:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : ((XF @ Xk) = (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccmin) @ ccdiv) @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ ccmul))))) => ((! [Xk:$i] : (! [Xn:$i] : ((XW @ Xk @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (ccseq @ ccmul @ (XF @ Xk) @ cc1))))))) => (! [Xk:$i] : (! [Xn:$i] : (cwbr @ (XW @ Xk @ Xn) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccli)))))))).
...
thf(awallispi2lem2_ax,axiom,(! [XN:($i > ($i > $o))] : (! [Xk:$i] : ((cwcel @ (XN @ Xk) @ ccn) => ((ccfv @ (XN @ Xk) @ (ccseq @ ccmul @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc4 @ ccexp) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccmin) @ ccmul) @ cc2 @ ccexp) @ ccdiv))) @ cc1)) = (cco @ (cco @ (cco @ cc2 @ (cco @ cc4 @ (XN @ Xk) @ ccmul) @ ccexp) @ (cco @ (ccfv @ (XN @ Xk) @ ccfa) @ cc4 @ ccexp) @ ccmul) @ (cco @ (ccfv @ (cco @ cc2 @ (XN @ Xk) @ ccmul) @ ccfa) @ cc2 @ ccexp) @ ccdiv)))))).
thf(cc3_tp,type,(cc3 : ($i > $o))).
thf(awallispi2lem1_ax,axiom,(! [XN:($i > ($i > $o))] : (! [Xk:$i] : ((cwcel @ (XN @ Xk) @ ccn) => ((ccfv @ (XN @ Xk) @ (ccseq @ ccmul @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccmin) @ ccdiv) @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ ccmul))) @ cc1)) = (cco @ (cco @ cc1 @ (cco @ (cco @ cc2 @ (XN @ Xk) @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ (ccfv @ (XN @ Xk) @ (ccseq @ ccmul @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc4 @ ccexp) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ (cco @ (cco @ cc2 @ (ccv @ Xk) @ ccmul) @ cc1 @ ccmin) @ ccmul) @ cc2 @ ccexp) @ ccdiv))) @ cc1)) @ ccmul)))))).
thf(cwallispi2_conj,conjecture,(! [XV:($i > ($i > $o))] : ((! [Xn:$i] : ((XV @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ (cco @ cc2 @ (cco @ cc4 @ (ccv @ Xn) @ ccmul) @ ccexp) @ (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ cc4 @ ccexp) @ ccmul) @ (cco @ (ccfv @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ ccfa) @ cc2 @ ccexp) @ ccdiv) @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))))) => (! [Xn:$i] : (cwbr @ (XV @ Xn) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccli))))).
