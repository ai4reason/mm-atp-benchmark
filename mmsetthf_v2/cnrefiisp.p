...
thf(acnrefiisplem_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ ccc))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (~ (cwcel @ XA2 @ ccr)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XB2 @ Xx3) @ ccfn))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XC @ Xy1) = (ccun @ ccr @ (XB2 @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XD @ Xx3 @ Xy1) = (ccun @ (ccsn @ (ccfv @ (ccfv @ XA2 @ ccim) @ ccabs)) @ (cciun @ (^ [Xy1:$i] : (ccdif @ (ccin @ (XB2 @ Xx3) @ ccc) @ (ccsn @ XA2))) @ (^ [Xy1:$i] : (ccsn @ (ccfv @ (cco @ (ccv @ Xy1) @ XA2 @ ccmin) @ ccabs)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XX = (ccinf @ (XD @ Xx3 @ Xy1) @ ccxr @ cclt)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((cwcel @ (ccv @ Xy1) @ ccc) & (cwne @ (ccv @ Xy1) @ XA2)) => (cwbr @ (ccv @ Xx3) @ (ccfv @ (cco @ (ccv @ Xy1) @ XA2 @ ccmin) @ ccabs) @ ccle))) @ (^ [Xy1:$i] : (XC @ Xy1)))) @ (^ [Xx3:$i] : ccrp))))))))))))))))).
...
thf(ccnrefiisp_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XA2 @ ccc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (~ (cwcel @ XA2 @ ccr))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (XB2 @ Xy1) @ ccfn)))) => ((! [Xy1:$i] : (XC = (ccun @ ccr @ (XB2 @ Xy1)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((cwcel @ (ccv @ Xy1) @ ccc) & (cwne @ (ccv @ Xy1) @ XA2)) => (cwbr @ (ccv @ Xx3) @ (ccfv @ (cco @ (ccv @ Xy1) @ XA2 @ ccmin) @ ccabs) @ ccle))) @ (^ [Xy1:$i] : XC))) @ (^ [Xx3:$i] : ccrp)))))))))))))).
