...
thf(amvdco_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (cwss @ (ccdm @ (ccdif @ (cccom @ XF @ XG) @ ccid)) @ (ccun @ (ccdm @ (ccdif @ XF @ ccid)) @ (ccdm @ (ccdif @ XG @ ccid))))))).
...
thf(af1omvdcnv_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwf1o @ XA2 @ XA2 @ XF) => ((ccdm @ (ccdif @ (cccnv @ XF) @ ccid)) = (ccdm @ (ccdif @ XF @ ccid))))))).
thf(asimprr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & (Xps & Xch)) => Xch))))).
thf(csymgsssg_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (XG = (ccfv @ (XD @ Xx3) @ ccsymg))) => ((XB2 = (ccfv @ XG @ ccbs)) => (! [Xx3:$i] : ((cwcel @ (XD @ Xx3) @ (XV @ Xx3)) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccdm @ (ccdif @ (ccv @ Xx3) @ ccid)) @ XX)) @ (^ [Xx3:$i] : XB2)) @ (ccfv @ XG @ ccsubg)))))))))))).
