...
thf(aelpell1qr_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) => ((cwcel @ XA2 @ (ccfv @ XD @ ccpell1qr)) <=> ((cwcel @ XA2 @ ccr) & (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : ((XA2 = (cco @ (ccv @ Xz) @ (cco @ (ccfv @ XD @ ccsqrt) @ (ccv @ Xw) @ ccmul) @ ccaddc)) & ((cco @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ (cco @ XD @ (cco @ (ccv @ Xw) @ cc2 @ ccexp) @ ccmul) @ ccmin) = cc1))) @ (^ [Xw:$i] : ccn0))) @ (^ [Xz:$i] : ccn0)))))))).
thf(cpellqrexplicit_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (((cw3a @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn0)) & ((cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XD @ (cco @ XB2 @ cc2 @ ccexp) @ ccmul) @ ccmin) = cc1)) => (cwcel @ (cco @ XA2 @ (cco @ (ccfv @ XD @ ccsqrt) @ XB2 @ ccmul) @ ccaddc) @ (ccfv @ XD @ ccpell1qr))))))).
