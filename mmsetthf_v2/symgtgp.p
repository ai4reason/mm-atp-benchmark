...
thf(asymgtopn_ax,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XX @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((cwcel @ XX @ XV) => ((cco @ (ccfv @ (ccxp @ XX @ (ccsn @ (ccpw @ XX))) @ ccpt) @ XB2 @ ccrest) = (ccfv @ XG @ cctopn)))))))))).
...
thf(adisllycmp_ax,axiom,(! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => (cwcel @ (ccpw @ XX) @ (cclly @ cccmp)))))).
thf(ccnei_tp,type,(ccnei : ($i > $o))).
thf(allynlly_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : ((cwcel @ XJ @ (cclly @ XA2)) => (cwcel @ XJ @ (ccnlly @ XA2)))))).
...
thf(agrpplusf_ax,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XF = (ccfv @ XG @ ccplusf)) => ((cwcel @ XG @ ccgrp) => (cwf @ (ccxp @ XB2 @ XB2) @ XB2 @ XF)))))))).
...
thf(csymgtgp_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((cwcel @ XA2 @ XV) => (cwcel @ XG @ cctgp))))))).
