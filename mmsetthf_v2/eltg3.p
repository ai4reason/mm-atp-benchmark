...
thf(aeltg4i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ XB2 @ cctg)) => (XA2 = (ccuni @ (ccin @ XB2 @ (ccpw @ XA2)))))))).
...
thf(celtg3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((cwcel @ XA2 @ (ccfv @ XB2 @ cctg)) <=> (? [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XB2) & (XA2 = (ccuni @ (ccv @ Xx3))))))))))).
