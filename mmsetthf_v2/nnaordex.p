...
thf(cnnaordex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => ((cwcel @ XA2 @ XB2) <=> (cwrex @ (^ [Xx3:$i] : ((cwcel @ cc0 @ (ccv @ Xx3)) & ((cco @ XA2 @ (ccv @ Xx3) @ ccoa) = XB2))) @ (^ [Xx3:$i] : ccom))))))).
