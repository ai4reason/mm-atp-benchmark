...
thf(aanabss7_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xps & (Xph & Xps)) => Xch) => ((Xph & Xps) => Xch)))))).
...
thf(cdivalgmodOLD_conj,conjecture,(! [XD:($i > $o)] : (! [XN:($i > $o)] : (! [Xr:$i] : (((cwcel @ XN @ ccz) & (cwcel @ XD @ ccn)) => (((ccv @ Xr) = (cco @ XN @ XD @ ccmo)) <=> ((cwcel @ (ccv @ Xr) @ ccn0) & ((cwbr @ (ccv @ Xr) @ XD @ cclt) & (cwbr @ XD @ (cco @ XN @ (ccv @ Xr) @ ccmin) @ ccdvds))))))))).
