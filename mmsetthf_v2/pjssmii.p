...
thf(apjsubii_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ (ccfv @ XH @ ccpjh)) = (cco @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ (ccfv @ XB2 @ (ccfv @ XH @ ccpjh)) @ ccmv))))))))).
...
thf(apjss2i_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => ((cwcel @ XG @ ccch) => ((cwss @ XH @ XG) => ((ccfv @ (ccfv @ XA2 @ (ccfv @ XG @ ccpjh)) @ (ccfv @ XH @ ccpjh)) = (ccfv @ XA2 @ (ccfv @ XH @ ccpjh))))))))))).
...
thf(apjoc2i_ax,axiom,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => ((cwcel @ XA2 @ (ccfv @ XH @ ccort)) <=> ((ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) = cc0v))))))).
thf(aneg1cn_ax,axiom,(cwcel @ (ccneg @ cc1) @ ccc)).
thf(ccmul_tp,type,(ccmul : ($i > $o))).
thf(ccc0_tp,type,(ccc0 : ($i > $o))).
thf(ahvmul0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ XA2 @ cc0v @ ccsm) = cc0v)))).
...
thf(apjsslem_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => ((cwcel @ XG @ ccch) => ((cco @ (ccfv @ XA2 @ (ccfv @ (ccfv @ XH @ ccort) @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ (ccfv @ XG @ ccort) @ ccpjh)) @ ccmv) = (cco @ (ccfv @ XA2 @ (ccfv @ XG @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccmv))))))))).
...
thf(apjchi_ax,axiom,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => ((cwcel @ XA2 @ XH) <=> ((ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) = XA2))))))).
thf(ahvsubcli_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => (cwcel @ (cco @ XA2 @ XB2 @ ccmv) @ cchil)))))).
thf(cpjssmii_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => ((cwcel @ XG @ ccch) => ((cwss @ XH @ XG) => ((cco @ (ccfv @ XA2 @ (ccfv @ XG @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccmv) = (ccfv @ XA2 @ (ccfv @ (ccin @ XG @ (ccfv @ XH @ ccort)) @ ccpjh))))))))))).
