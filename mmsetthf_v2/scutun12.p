...
thf(assltun1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XC @ ccsslt) & (cwbr @ XB2 @ XC @ ccsslt)) => (cwbr @ (ccun @ XA2 @ XB2) @ XC @ ccsslt)))))).
thf(asimp3d_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (cw3a @ Xps @ Xch @ Xth)) => (Xph => Xth))))))).
thf(asimp3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) => Xch))))).
thf(assltun2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccsslt) & (cwbr @ XA2 @ XC @ ccsslt)) => (cwbr @ XA2 @ (ccun @ XB2 @ XC) @ ccsslt)))))).
...
thf(asslttr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwbr @ XA2 @ XB2 @ ccsslt) @ (cwbr @ XB2 @ XC @ ccsslt) @ (cwne @ XB2 @ cc0)) => (cwbr @ XA2 @ XC @ ccsslt)))))).
...
thf(aelima_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XA2 @ (ccima @ XB2 @ XC)) <=> (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ XB2)) @ (^ [Xx3:$i] : XC)))))))).
...
thf(abdayfn_ax,axiom,(cwfn @ ccbday @ ccsur)).
...
thf(ascutbday_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccsslt) => ((ccfv @ (cco @ XA2 @ XB2 @ ccscut) @ ccbday) = (ccint @ (ccima @ ccbday @ (ccrab @ (^ [Xx3:$i] : ((cwbr @ XA2 @ (ccsn @ (ccv @ Xx3)) @ ccsslt) & (cwbr @ (ccsn @ (ccv @ Xx3)) @ XB2 @ ccsslt))) @ (^ [Xx3:$i] : ccsur))))))))).
...
thf(asssslt1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccsslt) & (cwss @ XC @ XA2)) => (cwbr @ XC @ XB2 @ ccsslt)))))).
thf(asimprr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & (Xps & Xch)) => Xch))))).
thf(asssslt2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccsslt) & (cwss @ XC @ XB2)) => (cwbr @ XA2 @ XC @ ccsslt)))))).
...
thf(aconway_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccsslt) => (cwreu @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ ccbday) = (ccint @ (ccima @ ccbday @ (ccrab @ (^ [Xy1:$i] : ((cwbr @ XA2 @ (ccsn @ (ccv @ Xy1)) @ ccsslt) & (cwbr @ (ccsn @ (ccv @ Xy1)) @ XB2 @ ccsslt))) @ (^ [Xy1:$i] : ccsur)))))) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : ((cwbr @ XA2 @ (ccsn @ (ccv @ Xy1)) @ ccsslt) & (cwbr @ (ccsn @ (ccv @ Xy1)) @ XB2 @ ccsslt))) @ (^ [Xy1:$i] : ccsur)))))))).
...
thf(cscutun12_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cw3a @ (cwbr @ XA2 @ XB2 @ ccsslt) @ (cwbr @ XC @ (ccsn @ (cco @ XA2 @ XB2 @ ccscut)) @ ccsslt) @ (cwbr @ (ccsn @ (cco @ XA2 @ XB2 @ ccscut)) @ XD @ ccsslt)) => ((cco @ (ccun @ XA2 @ XC) @ (ccun @ XB2 @ XD) @ ccscut) = (cco @ XA2 @ XB2 @ ccscut)))))))).
