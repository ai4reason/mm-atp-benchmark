...
thf(aefif1olem3_ax,axiom,(! [Xph:$o] : (! [Xx3:$i] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xw:$i] : ((XF @ Xw) = (ccmpt @ (^ [Xw:$i] : XD) @ (^ [Xw:$i] : (ccfv @ (cco @ cci @ (ccv @ Xw) @ ccmul) @ cce))))) => ((XC = (ccima @ (cccnv @ ccabs) @ (ccsn @ cc1))) => ((Xph & (cwcel @ (ccv @ Xx3) @ XC)) => (cwcel @ (ccfv @ (ccfv @ (ccv @ Xx3) @ ccsqrt) @ ccim) @ (cco @ (ccneg @ cc1) @ cc1 @ ccicc))))))))))).
...
thf(aresinf1o_ax,axiom,(cwf1o @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccicc) @ (cco @ (ccneg @ cc1) @ cc1 @ ccicc) @ (ccres @ ccsin @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccicc)))).
...
thf(acosq14ge0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccicc)) => (cwbr @ ccc0 @ (ccfv @ XA2 @ cccos) @ ccle)))).
thf(asqrtrege0d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => (Xph => (cwbr @ ccc0 @ (ccfv @ (ccfv @ XA2 @ ccsqrt) @ ccre) @ ccle)))))).
