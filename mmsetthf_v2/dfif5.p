...
thf(adfif4_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : ((XC @ Xx3) = (ccab @ (^ [Xx3:$i] : Xph)))) => (! [Xx3:$i] : ((ccif @ Xph @ (XA2 @ Xx3) @ (XB2 @ Xx3)) = (ccin @ (ccun @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ (ccin @ (ccun @ (XA2 @ Xx3) @ (ccdif @ ccvv @ (XC @ Xx3))) @ (ccun @ (XB2 @ Xx3) @ (XC @ Xx3)))))))))))).
...
thf(aundifabs_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccun @ XA2 @ (ccdif @ XA2 @ XB2)) = XA2)))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(ainabs_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccin @ XA2 @ (ccun @ XA2 @ XB2)) = XA2)))).
thf(aundif2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccun @ XA2 @ (ccdif @ XB2 @ XA2)) = (ccun @ XA2 @ XB2))))).
thf(aunundi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccun @ XA2 @ (ccun @ XB2 @ XC)) = (ccun @ (ccun @ XA2 @ XB2) @ (ccun @ XA2 @ XC))))))).
...
thf(cdfif5_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : ((XC @ Xx3) = (ccab @ (^ [Xx3:$i] : Xph)))) => (! [Xx3:$i] : ((ccif @ Xph @ (XA2 @ Xx3) @ (XB2 @ Xx3)) = (ccun @ (ccin @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ (ccun @ (ccin @ (ccdif @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ (XC @ Xx3)) @ (ccin @ (ccdif @ (XB2 @ Xx3) @ (XA2 @ Xx3)) @ (ccdif @ ccvv @ (XC @ Xx3))))))))))))).
