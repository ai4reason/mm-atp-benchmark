...
thf(cstoweidlem8_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((cw3a @ (Xph @ Xt) @ (cwcel @ (ccv @ Xf1) @ (XA2 @ Xt)) @ (cwcel @ (ccv @ Xg1) @ (XA2 @ Xt))) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (XT @ Xt)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccaddc))) @ (XA2 @ Xt)))))) => ((cwnfc @ (^ [Xt:$i] : (XF @ Xt))) => ((! [Xf1:$i] : (cwnfc @ (^ [Xt:$i] : (XG @ Xt @ Xf1)))) => (! [Xt:$i] : (! [Xf1:$i] : ((cw3a @ (Xph @ Xt) @ (cwcel @ (XF @ Xt) @ (XA2 @ Xt)) @ (cwcel @ (XG @ Xt @ Xf1) @ (XA2 @ Xt))) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (XT @ Xt)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (XF @ Xt)) @ (ccfv @ (ccv @ Xt) @ (XG @ Xt @ Xf1)) @ ccaddc))) @ (XA2 @ Xt)))))))))))))).
