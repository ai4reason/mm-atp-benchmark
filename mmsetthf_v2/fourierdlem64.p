...
thf(afourierdlem54_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > $o))] : (! [XO:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : ((XT @ Xf1 @ Xm @ Xp) = (cco @ (XB2 @ Xx3 @ Xf1 @ Xk) @ (XA2 @ Xx3 @ Xf1 @ Xk) @ ccmin))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : ((XP @ Xx3 @ Xf1 @ Xi @ Xk @ Xm @ Xp) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccrab @ (^ [Xp:$i] : ((((ccfv @ ccc0 @ (ccv @ Xp)) = (XA2 @ Xx3 @ Xf1 @ Xk)) & ((ccfv @ (ccv @ Xm) @ (ccv @ Xp)) = (XB2 @ Xx3 @ Xf1 @ Xk))) & (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xm) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ ccr @ (cco @ ccc0 @ (ccv @ Xm) @ ccfz) @ ccmap)))))))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xx3 @ Xm @ Xp) => (cwcel @ (XM @ Xx3 @ Xf1 @ Xk) @ ccn))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xx3 @ Xm @ Xp) => (cwcel @ (XQ @ Xf1 @ Xm) @ (ccfv @ (XM @ Xx3 @ Xf1 @ Xk) @ (XP @ Xx3 @ Xf1 @ Xi @ Xk @ Xm @ Xp)))))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xx3 @ Xm @ Xp) => (cwcel @ (XC @ Xf1 @ Xi @ Xk) @ ccr)))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xx3 @ Xm @ Xp) => (cwcel @ (XD @ Xf1 @ Xi @ Xk) @ ccr)))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xx3 @ Xm @ Xp) => (cwbr @ (XC @ Xf1 @ Xi @ Xk) @ (XD @ Xf1 @ Xi @ Xk) @ cclt)))))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : ((XO @ Xx3 @ Xf1 @ Xi @ Xk @ Xm @ Xp) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccrab @ (^ [Xp:$i] : ((((ccfv @ ccc0 @ (ccv @ Xp)) = (XC @ Xf1 @ Xi @ Xk)) & ((ccfv @ (ccv @ Xm) @ (ccv @ Xp)) = (XD @ Xf1 @ Xi @ Xk))) & (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xm) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ ccr @ (cco @ ccc0 @ (ccv @ Xm) @ ccfz) @ ccmap)))))))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : ((XH @ Xi @ Xk @ Xm @ Xp) = (ccun @ (ccpr @ (XC @ Xf1 @ Xi @ Xk) @ (XD @ Xf1 @ Xi @ Xk)) @ (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xk:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xk) @ (XT @ Xf1 @ Xm @ Xp) @ ccmul) @ ccaddc) @ (ccrn @ (XQ @ Xf1 @ Xm)))) @ (^ [Xk:$i] : ccz))) @ (^ [Xx3:$i] : (cco @ (XC @ Xf1 @ Xi @ Xk) @ (XD @ Xf1 @ Xi @ Xk) @ ccicc)))))))))) => ((! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : ((XN @ Xk) = (cco @ (ccfv @ (XH @ Xi @ Xk @ Xm @ Xp) @ cchash) @ cc1 @ ccmin)))))) => ((! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : ((XS @ Xk @ Xm) = (ccio @ (^ [Xf1:$i] : (cwiso @ (cco @ ccc0 @ (XN @ Xk) @ ccfz) @ (XH @ Xi @ Xk @ Xm @ Xp) @ cclt @ cclt @ (ccv @ Xf1))))))))) => (! [Xx3:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xx3 @ Xm @ Xp) => (((cwcel @ (XN @ Xk) @ ccn) & (cwcel @ (XS @ Xk @ Xm) @ (ccfv @ (XN @ Xk) @ (XO @ Xx3 @ Xf1 @ Xi @ Xk @ Xm @ Xp)))) & (cwiso @ (cco @ ccc0 @ (XN @ Xk) @ ccfz) @ (XH @ Xi @ Xk @ Xm @ Xp) @ cclt @ cclt @ (XS @ Xk @ Xm))))))))))))))))))))))))))))))))))).
...
thf(abtwnz_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwrex @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ cclt)) @ (^ [Xx3:$i] : ccz)) & (cwrex @ (^ [Xy1:$i] : (cwbr @ XA2 @ (ccv @ Xy1) @ cclt)) @ (^ [Xy1:$i] : ccz)))))).
...
thf(altaddsub2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => (Xph => ((cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ cclt) <=> (cwbr @ XB2 @ (cco @ XC @ XA2 @ ccmin) @ cclt))))))))))).
...
thf(asuprzcl_ax,axiom,(! [XA2:($i > $o)] : ((cw3a @ (cwss @ XA2 @ ccz) @ (cwne @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr))) => (cwcel @ (ccsup @ XA2 @ ccr @ cclt) @ XA2)))).
...
thf(aelfzfzo_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XA2 @ (cco @ XM @ XN @ ccfzo)) <=> ((cwcel @ XA2 @ (cco @ XM @ XN @ ccfz)) & (cwbr @ XA2 @ XN @ cclt))))))).
...
thf(cfourierdlem64_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XP:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (! [Xl:$i] : ((XT @ Xf1 @ Xm @ Xp) = (cco @ (XB2 @ Xy1 @ Xf1 @ Xj @ Xk @ Xl) @ (XA2 @ Xy1 @ Xf1 @ Xj @ Xk @ Xl) @ ccmin))))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (! [Xl:$i] : ((XP @ Xy1 @ Xf1 @ Xi @ Xj @ Xk @ Xm @ Xp @ Xl) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccrab @ (^ [Xp:$i] : ((((ccfv @ ccc0 @ (ccv @ Xp)) = (XA2 @ Xy1 @ Xf1 @ Xj @ Xk @ Xl)) & ((ccfv @ (ccv @ Xm) @ (ccv @ Xp)) = (XB2 @ Xy1 @ Xf1 @ Xj @ Xk @ Xl))) & (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xm) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ ccr @ (cco @ ccc0 @ (ccv @ Xm) @ ccfz) @ ccmap)))))))))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xm:$i] : (! [Xp:$i] : (! [Xl:$i] : ((Xph @ Xy1 @ Xm @ Xp @ Xl) => (cwcel @ (XM @ Xy1 @ Xf1 @ Xl) @ ccn))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (! [Xl:$i] : ((Xph @ Xy1 @ Xm @ Xp @ Xl) => (cwcel @ (XQ @ Xf1 @ Xm) @ (ccfv @ (XM @ Xy1 @ Xf1 @ Xl) @ (XP @ Xy1 @ Xf1 @ Xi @ Xj @ Xk @ Xm @ Xp @ Xl)))))))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (! [Xl:$i] : ((Xph @ Xy1 @ Xm @ Xp @ Xl) => (cwcel @ (XC @ Xf1 @ Xi @ Xj @ Xk @ Xl) @ ccr)))))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (! [Xl:$i] : ((Xph @ Xy1 @ Xm @ Xp @ Xl) => (cwcel @ (XD @ Xf1 @ Xi @ Xj @ Xk @ Xl) @ ccr)))))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (! [Xl:$i] : ((Xph @ Xy1 @ Xm @ Xp @ Xl) => (cwbr @ (XC @ Xf1 @ Xi @ Xj @ Xk @ Xl) @ (XD @ Xf1 @ Xi @ Xj @ Xk @ Xl) @ cclt)))))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (! [Xl:$i] : ((XH @ Xi @ Xk @ Xm @ Xp @ Xl) = (ccun @ (ccpr @ (XC @ Xf1 @ Xi @ Xj @ Xk @ Xl) @ (XD @ Xf1 @ Xi @ Xj @ Xk @ Xl)) @ (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xk:$i] : (cwcel @ (cco @ (ccv @ Xy1) @ (cco @ (ccv @ Xk) @ (XT @ Xf1 @ Xm @ Xp) @ ccmul) @ ccaddc) @ (ccrn @ (XQ @ Xf1 @ Xm)))) @ (^ [Xk:$i] : ccz))) @ (^ [Xy1:$i] : (cco @ (XC @ Xf1 @ Xi @ Xj @ Xk @ Xl) @ (XD @ Xf1 @ Xi @ Xj @ Xk @ Xl) @ ccicc)))))))))))) => ((! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (! [Xl:$i] : ((XN @ Xk @ Xl) = (cco @ (ccfv @ (XH @ Xi @ Xk @ Xm @ Xp @ Xl) @ cchash) @ cc1 @ ccmin))))))) => ((! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (! [Xl:$i] : ((XV @ Xm) = (ccio @ (^ [Xf1:$i] : (cwiso @ (cco @ ccc0 @ (XN @ Xk @ Xl) @ ccfz) @ (XH @ Xi @ Xk @ Xm @ Xp @ Xl) @ cclt @ cclt @ (ccv @ Xf1)))))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : (! [Xl:$i] : ((Xph @ Xy1 @ Xm @ Xp @ Xl) => (cwcel @ (XJ @ Xy1 @ Xf1 @ Xm @ Xp) @ (cco @ ccc0 @ (XN @ Xk @ Xl) @ ccfzo))))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : ((XL @ Xf1 @ Xi @ Xm @ Xp) = (ccsup @ (ccrab @ (^ [Xk:$i] : (cwbr @ (cco @ (ccfv @ ccc0 @ (XQ @ Xf1 @ Xm)) @ (cco @ (ccv @ Xk) @ (XT @ Xf1 @ Xm @ Xp) @ ccmul) @ ccaddc) @ (ccfv @ (XJ @ Xy1 @ Xf1 @ Xm @ Xp) @ (XV @ Xm)) @ ccle)) @ (^ [Xk:$i] : ccz)) @ ccr @ cclt))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : (! [Xl:$i] : ((XI @ Xf1 @ Xm @ Xp) = (ccsup @ (ccrab @ (^ [Xj:$i] : (cwbr @ (cco @ (ccfv @ (ccv @ Xj) @ (XQ @ Xf1 @ Xm)) @ (cco @ (XL @ Xf1 @ Xi @ Xm @ Xp) @ (XT @ Xf1 @ Xm @ Xp) @ ccmul) @ ccaddc) @ (ccfv @ (XJ @ Xy1 @ Xf1 @ Xm @ Xp) @ (XV @ Xm)) @ ccle)) @ (^ [Xj:$i] : (cco @ ccc0 @ (XM @ Xy1 @ Xf1 @ Xl) @ ccfzo))) @ ccr @ cclt)))))))) => (! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : (! [Xl:$i] : ((Xph @ Xy1 @ Xm @ Xp @ Xl) => (((cwcel @ (XI @ Xf1 @ Xm @ Xp) @ (cco @ ccc0 @ (XM @ Xy1 @ Xf1 @ Xl) @ ccfzo)) & (cwcel @ (XL @ Xf1 @ Xi @ Xm @ Xp) @ ccz)) & (cwrex @ (^ [Xi:$i] : (cwrex @ (^ [Xl:$i] : (cwss @ (cco @ (ccfv @ (XJ @ Xy1 @ Xf1 @ Xm @ Xp) @ (XV @ Xm)) @ (ccfv @ (cco @ (XJ @ Xy1 @ Xf1 @ Xm @ Xp) @ cc1 @ ccaddc) @ (XV @ Xm)) @ ccioo) @ (cco @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xf1 @ Xm)) @ (cco @ (ccv @ Xl) @ (XT @ Xf1 @ Xm @ Xp) @ ccmul) @ ccaddc) @ (cco @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xf1 @ Xm)) @ (cco @ (ccv @ Xl) @ (XT @ Xf1 @ Xm @ Xp) @ ccmul) @ ccaddc) @ ccioo))) @ (^ [Xl:$i] : ccz))) @ (^ [Xi:$i] : (cco @ ccc0 @ (XM @ Xy1 @ Xf1 @ Xl) @ ccfzo)))))))))))))))))))))))))))))))))))))))).
