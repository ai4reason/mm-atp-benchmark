...
thf(clidlsubcl_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XU = (ccfv @ XR @ cclidl)) => ((Xc_mi = (ccfv @ XR @ ccsg)) => ((((cwcel @ XR @ ccrg) & (cwcel @ XI @ XU)) & ((cwcel @ XX @ XI) & (cwcel @ XY @ XI))) => (cwcel @ (cco @ XX @ XY @ Xc_mi) @ XI))))))))))).
