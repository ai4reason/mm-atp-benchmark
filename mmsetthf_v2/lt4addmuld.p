...
thf(alt3addmuld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwcel @ XD @ ccr)) => ((Xph => (cwbr @ XA2 @ XD @ cclt)) => ((Xph => (cwbr @ XB2 @ XD @ cclt)) => ((Xph => (cwbr @ XC @ XD @ cclt)) => (Xph => (cwbr @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ ccaddc) @ (cco @ cc3 @ XD @ ccmul) @ cclt))))))))))))))).
