...
thf(asymgfixelq_ax,axiom,(! [XP:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xq:$i] : (XP = (ccfv @ (ccfv @ (XN @ Xq) @ ccsymg) @ ccbs))) => ((! [Xq:$i] : ((XQ @ Xq) = (ccrab @ (^ [Xq:$i] : ((ccfv @ XK @ (ccv @ Xq)) = XK)) @ (^ [Xq:$i] : XP)))) => (! [Xq:$i] : ((cwcel @ (XF @ Xq) @ (XV @ Xq)) => ((cwcel @ (XF @ Xq) @ (XQ @ Xq)) <=> ((cwf1o @ (XN @ Xq) @ (XN @ Xq) @ (XF @ Xq)) & ((ccfv @ XK @ (XF @ Xq)) = XK)))))))))))))).
