...
thf(acoeq12i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((XA2 = XB2) => ((XC = XD) => ((cccom @ XA2 @ XC) = (cccom @ XB2 @ XD))))))))).
...
thf(asymginv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XG @ ccminusg)) => ((cwcel @ XF @ XB2) => ((ccfv @ XF @ XN) = (cccnv @ XF)))))))))))).
thf(azrhpsgninv_ax,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((XY = (ccfv @ XR @ cczrh)) => ((XS = (ccfv @ XN @ ccpsgn)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XN @ ccfn) @ (cwcel @ XF @ XP)) => ((ccfv @ (cccnv @ XF) @ (cccom @ XY @ XS)) = (ccfv @ XF @ (cccom @ XY @ XS)))))))))))))).
...
thf(cmdetleib2_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xp:$i] : ((XD @ Xx3 @ Xp) = (cco @ XN @ XR @ ccmdat)))) => ((! [Xx3:$i] : (! [Xp:$i] : ((XA2 @ Xx3 @ Xp) = (cco @ XN @ XR @ ccmat)))) => ((! [Xx3:$i] : (! [Xp:$i] : (XB2 = (ccfv @ (XA2 @ Xx3 @ Xp) @ ccbs)))) => ((XP = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((! [Xx3:$i] : ((XY @ Xx3) = (ccfv @ XR @ cczrh))) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccfv @ XN @ ccpsgn))) => ((! [Xx3:$i] : ((Xc_x @ Xx3) = (ccfv @ XR @ ccmulr))) => ((! [Xx3:$i] : ((XU @ Xx3) = (ccfv @ XR @ ccmgp))) => (! [Xx3:$i] : (! [Xp:$i] : (((cwcel @ XR @ cccrg) & (cwcel @ XM @ XB2)) => ((ccfv @ XM @ (XD @ Xx3 @ Xp)) = (cco @ XR @ (ccmpt @ (^ [Xp:$i] : XP) @ (^ [Xp:$i] : (cco @ (ccfv @ (ccv @ Xp) @ (cccom @ (XY @ Xx3) @ (XS @ Xx3))) @ (cco @ (XU @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XN) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xp)) @ XM))) @ ccgsu) @ (Xc_x @ Xx3)))) @ ccgsu))))))))))))))))))))))))).
