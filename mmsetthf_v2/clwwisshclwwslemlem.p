...
thf(amodltm1p1mod_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XM @ ccrp) @ (cwbr @ (cco @ XA2 @ XM @ ccmo) @ (cco @ XM @ cc1 @ ccmin) @ cclt)) => ((cco @ (cco @ XA2 @ cc1 @ ccaddc) @ XM @ ccmo) = (cco @ (cco @ XA2 @ XM @ ccmo) @ cc1 @ ccaddc)))))).
...
thf(aelfzonlteqm1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ XB2 @ ccfzo)) & (~ (cwbr @ XA2 @ (cco @ XB2 @ cc1 @ ccmin) @ cclt))) => (XA2 = (cco @ XB2 @ cc1 @ ccmin)))))).
...
thf(amodm1p1mod0_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XM @ ccrp)) => (((cco @ XA2 @ XM @ ccmo) = (cco @ XM @ cc1 @ ccmin)) => ((cco @ (cco @ XA2 @ cc1 @ ccaddc) @ XM @ ccmo) = ccc0)))))).
thf(cclwwisshclwwslemlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cw3a @ (cwcel @ XL @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) @ (cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ XW) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XW)) @ XR)) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ XL @ cc1 @ ccmin) @ ccfzo))) @ (cwcel @ (ccpr @ (ccfv @ (cco @ XL @ cc1 @ ccmin) @ XW) @ (ccfv @ ccc0 @ XW)) @ XR)) => (cwcel @ (ccpr @ (ccfv @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XL @ ccmo) @ XW) @ (ccfv @ (cco @ (cco @ (cco @ XA2 @ cc1 @ ccaddc) @ XB2 @ ccaddc) @ XL @ ccmo) @ XW)) @ XR)))))))).
