...
thf(cfmptap_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (((ccun @ XR @ (ccsn @ XA2)) = XS) => ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((XC @ Xx3) = XB2))) => ((ccun @ (ccmpt @ (^ [Xx3:$i] : XR) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (ccsn @ (ccop @ XA2 @ XB2))) = (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (XC @ Xx3)))))))))))))).
