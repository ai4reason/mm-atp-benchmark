...
thf(cefeul_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ cce) = (cco @ (ccfv @ (ccfv @ XA2 @ ccre) @ cce) @ (cco @ (ccfv @ (ccfv @ XA2 @ ccim) @ cccos) @ (cco @ cci @ (ccfv @ (ccfv @ XA2 @ ccim) @ ccsin) @ ccmul) @ ccaddc) @ ccmul))))).
