...
thf(cdgraaub_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : ((((cwcel @ XP @ (ccfv @ ccq @ ccply)) & (cwne @ XP @ cc0p)) & ((cwcel @ XA2 @ ccc) & ((ccfv @ XA2 @ XP) = ccc0))) => (cwbr @ (ccfv @ XA2 @ ccdgraa) @ (ccfv @ XP @ ccdgr) @ ccle))))).
