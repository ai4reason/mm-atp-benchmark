...
thf(almcnp_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwbr @ XF @ XP @ (ccfv @ XJ @ cclm))) => ((Xph => (cwcel @ XG @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp)))) => (Xph => (cwbr @ (cccom @ XG @ XF) @ (ccfv @ XP @ XG) @ (ccfv @ XK @ cclm)))))))))))).
...
thf(ainssdif0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ (ccin @ XA2 @ XB2) @ XC) <=> ((ccin @ XA2 @ (ccdif @ XB2 @ XC)) = cc0)))))).
thf(arexanali_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((cwrex @ (^ [Xx3:$i] : ((Xph @ Xx3) & (~ (Xps @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) <=> (~ (cwral @ (^ [Xx3:$i] : ((Xph @ Xx3) => (Xps @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))).
...
thf(c_1stccnp_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XJ @ cc1stc)) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((Xph => (cwcel @ XP @ XX)) => (Xph => ((cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) <=> ((cwf @ XX @ XY @ XF) & (! [Xf1:$i] : (((cwf @ ccn @ XX @ (ccv @ Xf1)) & (cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XJ @ cclm))) => (cwbr @ (cccom @ XF @ (ccv @ Xf1)) @ (ccfv @ XP @ XF) @ (ccfv @ XK @ cclm))))))))))))))))))).
