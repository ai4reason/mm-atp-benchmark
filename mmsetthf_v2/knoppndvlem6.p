...
thf(aknoppndvlem2_ax,axiom,(! [Xph:$o] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XI @ ccz)) => ((Xph => (cwcel @ XJ @ ccz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwbr @ XJ @ XI @ cclt)) => (Xph => (cwcel @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XI @ ccexp) @ (cco @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccneg @ XJ) @ ccexp) @ cc2 @ ccdiv) @ XM @ ccmul) @ ccmul) @ ccz))))))))))))).
