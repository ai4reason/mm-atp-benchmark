...
thf(aprmreclem1_ax,axiom,(! [XQ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : ((XQ @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsup @ (ccrab @ (^ [Xr:$i] : (cwbr @ (cco @ (ccv @ Xr) @ cc2 @ ccexp) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xr:$i] : ccn)) @ ccr @ cclt))))) => (! [Xn:$i] : ((cwcel @ XN @ ccn) => (cw3a @ (cwcel @ (ccfv @ XN @ (XQ @ Xn)) @ ccn) @ (cwbr @ (cco @ (ccfv @ XN @ (XQ @ Xn)) @ cc2 @ ccexp) @ XN @ ccdvds) @ ((cwcel @ (XK @ Xn) @ (ccfv @ cc2 @ ccuz)) => (~ (cwbr @ (cco @ (XK @ Xn) @ cc2 @ ccexp) @ (cco @ XN @ (cco @ (ccfv @ XN @ (XQ @ Xn)) @ cc2 @ ccexp) @ ccdiv) @ ccdvds))))))))))).
...
thf(cprmreclem3_conj,conjecture,(! [Xph:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((XF = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccc0)))) => ((! [Xr:$i] : ((Xph @ Xr) => (cwcel @ (XK @ Xr) @ ccn))) => ((! [Xr:$i] : ((Xph @ Xr) => (cwcel @ (XN @ Xr) @ ccn))) => ((! [Xr:$i] : ((XM @ Xr) = (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xp:$i] : (~ (cwbr @ (ccv @ Xp) @ (ccv @ Xn) @ ccdvds))) @ (^ [Xp:$i] : (ccdif @ ccprime @ (cco @ cc1 @ (XK @ Xr) @ ccfz))))) @ (^ [Xn:$i] : (cco @ cc1 @ (XN @ Xr) @ ccfz))))) => ((XQ = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccsup @ (ccrab @ (^ [Xr:$i] : (cwbr @ (cco @ (ccv @ Xr) @ cc2 @ ccexp) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xr:$i] : ccn)) @ ccr @ cclt)))) => (! [Xr:$i] : ((Xph @ Xr) => (cwbr @ (ccfv @ (XM @ Xr) @ cchash) @ (cco @ (cco @ cc2 @ (XK @ Xr) @ ccexp) @ (ccfv @ (XN @ Xr) @ ccsqrt) @ ccmul) @ ccle))))))))))))))).
