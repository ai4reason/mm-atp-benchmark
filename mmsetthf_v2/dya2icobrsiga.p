...
thf(adifioo_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) & (cwbr @ XA2 @ XB2 @ cclt)) => ((ccdif @ (cco @ XA2 @ XC @ ccioo) @ (cco @ XA2 @ XB2 @ ccioo)) = (cco @ XB2 @ XC @ ccico))))))).
