...
thf(adf_concat_ax,axiom,(ccconcat = (ccmpt2 @ (^ [Xs1:$i] : (^ [Xt:$i] : ccvv)) @ (^ [Xs1:$i] : (^ [Xt:$i] : ccvv)) @ (^ [Xs1:$i] : (^ [Xt:$i] : (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (cco @ (ccfv @ (ccv @ Xs1) @ cchash) @ (ccfv @ (ccv @ Xt) @ cchash) @ ccaddc) @ ccfzo)) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (cco @ ccc0 @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccfzo)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xs1)) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccmin) @ (ccv @ Xt)))))))))).
thf(amptex_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aovex_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(cccatfval_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XS @ (XV @ Xx3)) & (cwcel @ XT @ (XW @ Xx3))) => ((cco @ XS @ XT @ ccconcat) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XS @ cchash) @ (ccfv @ XT @ cchash) @ ccaddc) @ ccfzo)) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfzo)) @ (ccfv @ (ccv @ Xx3) @ XS) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccfv @ XS @ cchash) @ ccmin) @ XT)))))))))))).
