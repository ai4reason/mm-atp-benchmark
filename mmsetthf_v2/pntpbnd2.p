...
thf(aflwordi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ ccle)) => (cwbr @ (ccfv @ XA2 @ ccfl) @ (ccfv @ XB2 @ ccfl) @ ccle))))).
