...
thf(anorm_iii_i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ cchil) => ((ccfv @ (cco @ XA2 @ XB2 @ ccsm) @ ccno) = (cco @ (ccfv @ XA2 @ ccabs) @ (ccfv @ XB2 @ ccno) @ ccmul))))))).
...
thf(cnormsubi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno) = (ccfv @ (cco @ XB2 @ XA2 @ ccmv) @ ccno))))))).
