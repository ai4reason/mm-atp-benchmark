...
thf(adf_vdwmc_ax,axiom,(ccvdwm = (ccopab @ (^ [Xk:$i] : (^ [Xf1:$i] : (? [Xc:$i] : (cwne @ (ccin @ (ccrn @ (ccfv @ (ccv @ Xk) @ ccvdwa)) @ (ccpw @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ (ccv @ Xc))))) @ cc0))))))).
...
thf(avdwapf_ax,axiom,(! [XK:($i > $o)] : ((cwcel @ XK @ ccn0) => (cwf @ (ccxp @ ccn @ ccn) @ (ccpw @ ccn) @ (ccfv @ XK @ ccvdwa))))).
