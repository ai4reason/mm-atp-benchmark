...
thf(a_19_37_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => (! [Xx3:$i] : ((? [Xx3:$i] : ((Xph @ Xx3) => (Xps @ Xx3))) <=> ((Xph @ Xx3) => (? [Xx3:$i] : (Xps @ Xx3))))))))).
...
thf(cbnj900_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xn:$i] : ((XD @ Xf1 @ Xn) = (ccdif @ ccom @ (ccsn @ cc0))))) => ((! [Xf1:$i] : (! [Xn:$i] : ((XB2 @ Xf1 @ Xn) = (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xn:$i] : (cw3a @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) @ (Xph @ Xf1 @ Xn) @ (Xps @ Xf1 @ Xn))) @ (^ [Xn:$i] : (XD @ Xf1 @ Xn)))))))) => (! [Xf1:$i] : (! [Xn:$i] : ((cwcel @ (ccv @ Xf1) @ (XB2 @ Xf1 @ Xn)) => (cwcel @ cc0 @ (ccdm @ (ccv @ Xf1))))))))))))).
