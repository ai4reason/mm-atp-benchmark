...
thf(cdvcmulf_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwf @ XX @ ccc @ XF)) => ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => ((ccdm @ (cco @ XS @ XF @ ccdv)) = XX)) => (Xph => ((cco @ XS @ (cco @ (ccxp @ XS @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul)) @ ccdv) = (cco @ (ccxp @ XS @ (ccsn @ XA2)) @ (cco @ XS @ XF @ ccdv) @ (ccof @ ccmul)))))))))))))).
