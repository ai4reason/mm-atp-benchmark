...
thf(adffun3f_ax,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xz:$i] : (cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1 @ Xz))))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwnfc @ (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1 @ Xz))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwnfc @ (^ [Xz:$i] : (XA2 @ Xx3 @ Xy1 @ Xz))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwfun @ (XA2 @ Xx3 @ Xy1 @ Xz)) <=> ((cwrel @ (XA2 @ Xx3 @ Xy1 @ Xz)) & (! [Xx3:$i] : (? [Xz:$i] : (! [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XA2 @ Xx3 @ Xy1 @ Xz)) => ((ccv @ Xy1) = (ccv @ Xz)))))))))))))))).
