...
thf(cmatepmcl_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xn:$i] : ((XA2 @ Xn) = (cco @ (XN @ Xn) @ XR @ ccmat))) => ((! [Xn:$i] : (XB2 = (ccfv @ (XA2 @ Xn) @ ccbs))) => ((! [Xn:$i] : (XP = (ccfv @ (ccfv @ (XN @ Xn) @ ccsymg) @ ccbs))) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XQ @ XP) @ (cwcel @ XM @ XB2)) => (cwral @ (^ [Xn:$i] : (cwcel @ (cco @ (ccfv @ (ccv @ Xn) @ XQ) @ (ccv @ Xn) @ XM) @ (ccfv @ XR @ ccbs))) @ (^ [Xn:$i] : (XN @ Xn))))))))))))))).
