...
thf(apolatN_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_pe:($i > $o)] : ((Xc_pe = (ccfv @ XK @ ccoc)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XM = (ccfv @ XK @ ccpmap)) => ((XP = (ccfv @ XK @ ccpolN)) => (((cwcel @ XK @ ccol) & (cwcel @ XQ @ XA2)) => ((ccfv @ (ccsn @ XQ) @ XP) = (ccfv @ (ccfv @ XQ @ Xc_pe) @ XM)))))))))))))).
...
thf(c_2polatN_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XK:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XP = (ccfv @ XK @ ccpolN)) => (((cwcel @ XK @ cchlt) & (cwcel @ XQ @ XA2)) => ((ccfv @ (ccfv @ (ccsn @ XQ) @ XP) @ XP) = (ccsn @ XQ)))))))))).
