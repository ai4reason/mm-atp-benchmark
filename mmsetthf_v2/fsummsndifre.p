...
thf(cfsummsndifre_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xk) @ ccz)) @ (^ [Xk:$i] : XA2))) => (cwcel @ (ccsu @ (ccdif @ XA2 @ (ccsn @ XX)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccr)))))).
