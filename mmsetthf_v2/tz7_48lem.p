...
thf(apm3_48_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph => Xps) & (Xch => Xth)) => ((Xph | Xch) => (Xps | Xth)))))))).
...
thf(ctz7_48lem_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ ccon0) => (((cwss @ XA2 @ ccon0) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ ((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xy1) @ XF)))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2))) => (cwfun @ (cccnv @ (ccres @ XF @ XA2)))))))).
