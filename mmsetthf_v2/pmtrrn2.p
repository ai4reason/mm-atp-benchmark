...
thf(apmtrfrn_ax,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((XR = (ccrn @ XT)) => ((XP = (ccdm @ (ccdif @ XF @ ccid))) => ((cwcel @ XF @ XR) => ((cw3a @ (cwcel @ XD @ ccvv) @ (cwss @ XP @ XD) @ (cwbr @ XP @ cc2o @ ccen)) & (XF = (ccfv @ XP @ XT))))))))))))).
...
thf(apr2ne_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ XC) & (cwcel @ XB2 @ XD)) => ((cwbr @ (ccpr @ XA2 @ XB2) @ cc2o @ ccen) <=> (cwne @ XA2 @ XB2)))))))).
...
thf(cpmtrrn2_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((XR = (ccrn @ XT)) => ((cwcel @ XF @ XR) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) & (XF = (ccfv @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XT)))) @ (^ [Xy1:$i] : XD))) @ (^ [Xx3:$i] : XD)))))))))).
