...
thf(cfzosplitsni_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XB2 @ (ccfv @ XA2 @ ccuz)) => ((cwcel @ XC @ (cco @ XA2 @ (cco @ XB2 @ cc1 @ ccaddc) @ ccfzo)) <=> ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccfzo)) | (XC = XB2)))))))).
