...
thf(acvbr2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((cwbr @ XA2 @ XB2 @ cccv) <=> ((cwpss @ XA2 @ XB2) & (cwral @ (^ [Xx3:$i] : (((cwpss @ XA2 @ (ccv @ Xx3)) & (cwss @ (ccv @ Xx3) @ XB2)) => ((ccv @ Xx3) = XB2))) @ (^ [Xx3:$i] : ccch)))))))).
thf(aanbi12d_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => (Xps <=> Xch)) => ((Xph => (Xth <=> Xta)) => (Xph => ((Xps & Xth) <=> (Xch & Xta))))))))))).
thf(ach0pss_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwpss @ cc0h @ XA2) <=> (cwne @ XA2 @ cc0h))))).
...
thf(celat2_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccat) <=> ((cwcel @ XA2 @ ccch) & ((cwne @ XA2 @ cc0h) & (cwral @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) => (((ccv @ Xx3) = XA2) | ((ccv @ Xx3) = cc0h)))) @ (^ [Xx3:$i] : ccch))))))).
