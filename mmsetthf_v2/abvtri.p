...
thf(cabvtri_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (ccfv @ XR @ ccabv)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((cw3a @ (cwcel @ XF @ XA2) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => (cwbr @ (ccfv @ (cco @ XX @ XY @ Xc_pl) @ XF) @ (cco @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ ccaddc) @ ccle))))))))))))).
