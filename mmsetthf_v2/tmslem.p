...
thf(asetsmsbas_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (XX = (ccfv @ XM @ ccbs))) => ((Xph => (XD = (ccres @ (ccfv @ XM @ ccds) @ (ccxp @ XX @ XX)))) => ((Xph => (XK = (cco @ XM @ (ccop @ (ccfv @ ccnx @ ccts) @ (ccfv @ XD @ ccmopn)) @ ccsts))) => (Xph => (XX = (ccfv @ XK @ ccbs)))))))))))).
...
thf(atmsval_ax,axiom,(! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XM = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XX) @ (ccop @ (ccfv @ ccnx @ ccds) @ XD))) => ((XK = (ccfv @ XD @ cctmt)) => ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => (XK = (cco @ XM @ (ccop @ (ccfv @ ccnx @ ccts) @ (ccfv @ XD @ ccmopn)) @ ccsts)))))))))).
thf(aeqtrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XB2 = XC)) => (Xph => (XA2 = XC))))))))).
thf(asetsmsds_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (XX = (ccfv @ XM @ ccbs))) => ((Xph => (XD = (ccres @ (ccfv @ XM @ ccds) @ (ccxp @ XX @ XX)))) => ((Xph => (XK = (cco @ XM @ (ccop @ (ccfv @ ccnx @ ccts) @ (ccfv @ XD @ ccmopn)) @ ccsts))) => (Xph => ((ccfv @ XM @ ccds) = (ccfv @ XK @ ccds)))))))))))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(cctg_tp,type,(cctg : ($i > $o))).
thf(ccbl_tp,type,(ccbl : ($i > $o))).
thf(ccpw_tp,type,(ccpw : (($i > $o) > ($i > $o)))).
thf(asetsmstopn_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (XX = (ccfv @ XM @ ccbs))) => ((Xph => (XD = (ccres @ (ccfv @ XM @ ccds) @ (ccxp @ XX @ XX)))) => ((Xph => (XK = (cco @ XM @ (ccop @ (ccfv @ ccnx @ ccts) @ (ccfv @ XD @ ccmopn)) @ ccsts))) => ((Xph => (cwcel @ XM @ XV)) => (Xph => ((ccfv @ XD @ ccmopn) = (ccfv @ XK @ cctopn)))))))))))))).
thf(aa1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(aeqeltri_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwcel @ XB2 @ XC) => (cwcel @ XA2 @ XC))))))).
thf(aprex_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwcel @ (ccpr @ XA2 @ XB2) @ ccvv)))).
thf(ctmslem_conj,conjecture,(! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XM = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XX) @ (ccop @ (ccfv @ ccnx @ ccds) @ XD))) => ((XK = (ccfv @ XD @ cctmt)) => ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => (cw3a @ (XX = (ccfv @ XK @ ccbs)) @ (XD = (ccfv @ XK @ ccds)) @ ((ccfv @ XD @ ccmopn) = (ccfv @ XK @ cctopn))))))))))).
