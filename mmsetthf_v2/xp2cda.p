...
thf(axpundi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccxp @ XA2 @ (ccun @ XB2 @ XC)) = (ccun @ (ccxp @ XA2 @ XB2) @ (ccxp @ XA2 @ XC))))))).
thf(cxp2cda_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((ccxp @ XA2 @ cc2o) = (cco @ XA2 @ XA2 @ cccda)))))).
