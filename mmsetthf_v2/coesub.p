...
thf(acoeadd_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XB2 = (ccfv @ XG @ cccoe)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XS @ ccply))) => ((ccfv @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ cccoe) = (cco @ XA2 @ XB2 @ (ccof @ ccaddc)))))))))))).
...
thf(acoemulc_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XF @ (ccfv @ XS @ ccply))) => ((ccfv @ (cco @ (ccxp @ ccc @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul)) @ cccoe) = (cco @ (ccxp @ ccn0 @ (ccsn @ XA2)) @ (ccfv @ XF @ cccoe) @ (ccof @ ccmul)))))))).
...
thf(ccoesub_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XB2 = (ccfv @ XG @ cccoe)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XS @ ccply))) => ((ccfv @ (cco @ XF @ XG @ (ccof @ ccmin)) @ cccoe) = (cco @ XA2 @ XB2 @ (ccof @ ccmin)))))))))))).
