...
thf(acoeid3_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XN = (ccfv @ XF @ ccdgr)) => ((cw3a @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XM @ (ccfv @ XN @ ccuz)) @ (cwcel @ XX @ ccc)) => ((ccfv @ XX @ XF) = (ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ XX @ (ccv @ Xk) @ ccexp) @ ccmul)))))))))))))).
...
thf(azsssubrg_ax,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ (ccfv @ cccnfld @ ccsubrg)) => (cwss @ ccz @ XR)))).
...
thf(cdvply2g_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XS @ (ccfv @ cccnfld @ ccsubrg)) & (cwcel @ XF @ (ccfv @ XS @ ccply))) => (cwcel @ (cco @ ccc @ XF @ ccdv) @ (ccfv @ XS @ ccply)))))).
