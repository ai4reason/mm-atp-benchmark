...
thf(aisfildlem_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (Xph => ((cwcel @ (ccv @ Xx3) @ XF) <=> ((cwss @ (ccv @ Xx3) @ XA2) & (Xps @ Xx3))))) => ((Xph => (cwcel @ XA2 @ ccvv)) => (! [Xx3:$i] : (Xph => ((cwcel @ (XB2 @ Xx3) @ XF) <=> ((cwss @ (XB2 @ Xx3) @ XA2) & (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (XB2 @ Xx3)))))))))))))).
...
thf(aisfil2_ax,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccfil)) <=> (cw3a @ (cw3a @ (cwss @ XF @ (ccpw @ XX)) @ (~ (cwcel @ cc0 @ XF)) @ (cwcel @ XX @ XF)) @ (cwral @ (^ [Xx3:$i] : ((cwrex @ (^ [Xy1:$i] : (cwss @ (ccv @ Xy1) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : XF)) => (cwcel @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : (ccpw @ XX))) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XF)) @ (^ [Xy1:$i] : XF))) @ (^ [Xx3:$i] : XF))))))).
thf(cisfild_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xz:$i] : (Xph => ((cwcel @ (ccv @ Xx3) @ XF) <=> ((cwss @ (ccv @ Xx3) @ XA2) & (Xps @ Xx3 @ Xz)))))) => ((Xph => (cwcel @ XA2 @ ccvv)) => ((! [Xz:$i] : (Xph => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ XA2))) => ((! [Xz:$i] : (Xph => (~ (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ cc0)))) => ((! [Xy1:$i] : (! [Xz:$i] : ((cw3a @ Xph @ (cwss @ (ccv @ Xy1) @ XA2) @ (cwss @ (ccv @ Xz) @ (ccv @ Xy1))) => ((cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xz)) => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xy1)))))) => ((! [Xy1:$i] : (! [Xz:$i] : ((cw3a @ Xph @ (cwss @ (ccv @ Xy1) @ XA2) @ (cwss @ (ccv @ Xz) @ XA2)) => (((cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xy1)) & (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xz))) => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccin @ (ccv @ Xy1) @ (ccv @ Xz))))))) => (Xph => (cwcel @ XF @ (ccfv @ XA2 @ ccfil)))))))))))))).
