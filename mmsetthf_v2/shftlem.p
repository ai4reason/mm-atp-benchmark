...
thf(cshftlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwss @ XB2 @ ccc)) => ((ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ XB2)) @ (^ [Xx3:$i] : ccc)) = (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ XA2 @ ccaddc))) @ (^ [Xy1:$i] : XB2))))))))).
