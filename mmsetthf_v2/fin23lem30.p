...
thf(aelunirn_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfun @ XF) => ((cwcel @ XA2 @ (ccuni @ (ccrn @ XF))) <=> (cwrex @ (^ [Xx3:$i] : (cwcel @ XA2 @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : (ccdm @ XF)))))))).
...
thf(cfin23lem30_conj,conjecture,(! [XP:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XQ:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))))] : (! [XR:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XZ:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : ((! [Xx3:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xg1:$i] : ((XU @ Xx3 @ Xw @ Xt @ Xg1) = (ccseqom @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xu:$i] : ccom)) @ (^ [Xi:$i] : (^ [Xu:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xu:$i] : (ccif @ ((ccin @ (ccfv @ (ccv @ Xi) @ (ccv @ Xt)) @ (ccv @ Xu)) = cc0) @ (ccv @ Xu) @ (ccin @ (ccfv @ (ccv @ Xi) @ (ccv @ Xt)) @ (ccv @ Xu)))))) @ (ccuni @ (ccrn @ (ccv @ Xt))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((XF @ Xx3 @ Xz @ Xw @ Xv @ Xu @ Xg1 @ Xi) = (ccab @ (^ [Xg1:$i] : (cwral @ (^ [Xa:$i] : ((cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xa)))) @ (^ [Xx3:$i] : ccom)) => (cwcel @ (ccint @ (ccrn @ (ccv @ Xa))) @ (ccrn @ (ccv @ Xa))))) @ (^ [Xa:$i] : (cco @ (ccpw @ (ccv @ Xg1)) @ ccom @ ccmap))))))))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((XP @ Xv @ Xu @ Xt @ Xg1 @ Xi) = (ccrab @ (^ [Xv:$i] : (cwss @ (ccint @ (ccrn @ (XU @ Xx3 @ Xw @ Xt @ Xg1))) @ (ccfv @ (ccv @ Xv) @ (ccv @ Xt)))) @ (^ [Xv:$i] : ccom)))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xa:$i] : ((XQ @ Xx3 @ Xz @ Xw @ Xv @ Xu @ Xt @ Xg1 @ Xi @ Xa) = (ccmpt @ (^ [Xw:$i] : ccom) @ (^ [Xw:$i] : (ccrio @ (^ [Xx3:$i] : (cwbr @ (ccin @ (ccv @ Xx3) @ (XP @ Xv @ Xu @ Xt @ Xg1 @ Xi)) @ (ccv @ Xw) @ ccen)) @ (^ [Xx3:$i] : (XP @ Xv @ Xu @ Xt @ Xg1 @ Xi))))))))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((XR @ Xx3 @ Xz @ Xw @ Xt @ Xg1) = (ccmpt @ (^ [Xw:$i] : ccom) @ (^ [Xw:$i] : (ccrio @ (^ [Xx3:$i] : (cwbr @ (ccin @ (ccv @ Xx3) @ (ccdif @ ccom @ (XP @ Xv @ Xu @ Xt @ Xg1 @ Xi))) @ (ccv @ Xw) @ ccen)) @ (^ [Xx3:$i] : (ccdif @ ccom @ (XP @ Xv @ Xu @ Xt @ Xg1 @ Xi))))))))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xa:$i] : ((XZ @ Xx3 @ Xz @ Xw @ Xv @ Xu @ Xt @ Xg1 @ Xi) = (ccif @ (cwcel @ (XP @ Xv @ Xu @ Xt @ Xg1 @ Xi) @ ccfn) @ (cccom @ (ccv @ Xt) @ (XR @ Xx3 @ Xz @ Xw @ Xt @ Xg1)) @ (cccom @ (ccmpt @ (^ [Xz:$i] : (XP @ Xv @ Xu @ Xt @ Xg1 @ Xi)) @ (^ [Xz:$i] : (ccdif @ (ccfv @ (ccv @ Xz) @ (ccv @ Xt)) @ (ccint @ (ccrn @ (XU @ Xx3 @ Xw @ Xt @ Xg1)))))) @ (XQ @ Xx3 @ Xz @ Xw @ Xv @ Xu @ Xt @ Xg1 @ Xi @ Xa))))))))))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((cwfun @ (ccv @ Xt)) => ((ccin @ (ccuni @ (ccrn @ (XZ @ Xx3 @ Xz @ Xw @ Xv @ Xu @ Xt @ Xg1 @ Xi))) @ (ccint @ (ccrn @ (XU @ Xx3 @ Xw @ Xt @ Xg1)))) = cc0))))))))))))))))))))))).
