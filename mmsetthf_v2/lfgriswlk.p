...
thf(alfgrwlkprop_ax,axiom,(! [XP:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (XI = (ccfv @ (XG @ Xx3) @ cciedg))) => (! [Xx3:$i] : (((cwbr @ XF @ (XP @ Xx3) @ (ccfv @ (XG @ Xx3) @ ccwlks)) & (cwf @ (ccdm @ XI) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ cchash) @ ccle)) @ (^ [Xx3:$i] : (ccpw @ XV))) @ XI)) => (cwral @ (^ [Xk:$i] : (cwne @ (ccfv @ (ccv @ Xk) @ (XP @ Xx3)) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (XP @ Xx3)))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)))))))))))).
thf(awlkvtxeledg_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : ((! [Xk:$i] : ((XI @ Xk) = (ccfv @ XG @ cciedg))) => ((cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) => (cwral @ (^ [Xk:$i] : (cwss @ (ccpr @ (ccfv @ (ccv @ Xk) @ XP) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XP)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ (XI @ Xk)))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)))))))))).
...
thf(clfgriswlk_conj,conjecture,(! [XP:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (XI = (ccfv @ (XG @ Xx3) @ cciedg))) => ((! [Xx3:$i] : (XV = (ccfv @ (XG @ Xx3) @ ccvtx))) => (! [Xx3:$i] : (! [Xk:$i] : (((cwcel @ (XG @ Xx3) @ (XW @ Xx3 @ Xk)) & (cwf @ (ccdm @ XI) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ cchash) @ ccle)) @ (^ [Xx3:$i] : (ccpw @ XV))) @ XI)) => ((cwbr @ XF @ (XP @ Xx3) @ (ccfv @ (XG @ Xx3) @ ccwlks)) <=> (cw3a @ (cwcel @ XF @ (ccword @ (ccdm @ XI))) @ (cwf @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz) @ XV @ (XP @ Xx3)) @ (cwral @ (^ [Xk:$i] : ((cwne @ (ccfv @ (ccv @ Xk) @ (XP @ Xx3)) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (XP @ Xx3))) & (cwss @ (ccpr @ (ccfv @ (ccv @ Xk) @ (XP @ Xx3)) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (XP @ Xx3))) @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ XI)))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))))))))))))))))).
