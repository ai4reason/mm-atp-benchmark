...
thf(codlem2_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XN @ ccn) @ ((cco @ XN @ XA2 @ Xc_x) = Xc_0)) => (cwcel @ (ccfv @ XA2 @ XO) @ (cco @ cc1 @ XN @ ccfz))))))))))))))).
