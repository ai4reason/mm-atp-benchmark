...
thf(arestnlly_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : (! [Xj:$i] : ((Xph & ((cwcel @ (ccv @ Xj) @ XA2) & (cwcel @ (ccv @ Xx3) @ (ccv @ Xj)))) => (cwcel @ (cco @ (ccv @ Xj) @ (ccv @ Xx3) @ ccrest) @ XA2)))) => (Xph => ((ccnlly @ XA2) = (cclly @ XA2))))))).
