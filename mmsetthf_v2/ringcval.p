...
thf(cringcval_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((XC = (ccfv @ XU @ ccringc)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (XB2 = (ccin @ XU @ ccrg))) => ((Xph => (XH = (ccres @ ccrh @ (ccxp @ XB2 @ XB2)))) => (Xph => (XC = (cco @ (ccfv @ XU @ ccestrc) @ XH @ ccresc)))))))))))))).
