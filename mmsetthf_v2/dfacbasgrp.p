...
thf(aisnumbasgrp_ax,axiom,(! [XS:($i > $o)] : ((cwcel @ XS @ (ccdm @ cccrd)) <=> (cwcel @ (ccun @ XS @ (ccfv @ XS @ cchar)) @ (ccima @ ccbs @ ccgrp))))).
thf(cdfacbasgrp_conj,conjecture,(cwac <=> ((ccima @ ccbs @ ccgrp) = (ccdif @ ccvv @ (ccsn @ cc0))))).
