...
thf(aordtbaslem_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XR)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XA2 @ Xx3 @ Xy1) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))) @ (^ [Xy1:$i] : XX)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XR @ cctsr) => ((ccfv @ (XA2 @ Xx3 @ Xy1) @ ccfi) = (XA2 @ Xx3 @ Xy1))))))))))).
...
thf(afiin_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ XC @ ccfi)) & (cwcel @ XB2 @ (ccfv @ XC @ ccfi))) => (cwcel @ (ccin @ XA2 @ XB2) @ (ccfv @ XC @ ccfi))))))).
...
thf(cordtbas2_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XR)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XA2 @ Xx3 @ Xy1) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))) @ (^ [Xy1:$i] : XX)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xx3 @ Xy1) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR))) @ (^ [Xy1:$i] : XX)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XC @ Xx3 @ Xy1 @ Xa @ Xb) = (ccrn @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : XX)) @ (^ [Xa:$i] : (^ [Xb:$i] : XX)) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccrab @ (^ [Xy1:$i] : ((~ (cwbr @ (ccv @ Xy1) @ (ccv @ Xa) @ XR)) & (~ (cwbr @ (ccv @ Xb) @ (ccv @ Xy1) @ XR)))) @ (^ [Xy1:$i] : XX))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((cwcel @ XR @ cctsr) => ((ccfv @ (ccun @ (XA2 @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1)) @ ccfi) = (ccun @ (ccun @ (XA2 @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1)) @ (XC @ Xx3 @ Xy1 @ Xa @ Xb)))))))))))))))))).
