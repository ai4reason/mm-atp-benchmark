...
thf(czlmodzxzldeplem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xy1:$i] : ((XZ @ Xy1) = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm))) => ((XA2 = (ccpr @ (ccop @ ccc0 @ cc3) @ (ccop @ cc1 @ cc6))) => ((XB2 = (ccpr @ (ccop @ ccc0 @ cc2) @ (ccop @ cc1 @ cc4))) => ((XF = (ccpr @ (ccop @ XA2 @ cc2) @ (ccop @ XB2 @ (ccneg @ cc3)))) => (cwrex @ (^ [Xy1:$i] : (cwne @ (ccfv @ (ccv @ Xy1) @ XF) @ ccc0)) @ (^ [Xy1:$i] : (ccpr @ XA2 @ XB2)))))))))))).
