...
thf(aismred2_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwss @ XC @ (ccpw @ XX))) => ((! [Xs1:$i] : ((Xph & (cwss @ (ccv @ Xs1) @ XC)) => (cwcel @ (ccin @ XX @ (ccint @ (ccv @ Xs1))) @ XC))) => (Xph => (cwcel @ XC @ (ccfv @ XX @ ccmre))))))))).
...
thf(amremre_ax,axiom,(! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => (cwcel @ (ccfv @ XX @ ccmre) @ (ccfv @ (ccpw @ XX) @ ccmre)))))).
...
thf(amrerintcl_ax,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwss @ XS @ XC)) => (cwcel @ (ccin @ XX @ (ccint @ XS)) @ XC)))))).
...
thf(aacsfiel2_ax,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => (((cwcel @ XC @ (ccfv @ XX @ ccacs)) & (cwss @ XS @ XX)) => ((cwcel @ XS @ XC) <=> (cwral @ (^ [Xy1:$i] : (cwss @ (ccfv @ (ccv @ Xy1) @ XF) @ XS)) @ (^ [Xy1:$i] : (ccin @ (ccpw @ XS) @ ccfn))))))))))).
...
thf(aelrint2_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [Xy1:$i] : ((cwcel @ XX @ (XA2 @ Xy1)) => ((cwcel @ XX @ (ccin @ (XA2 @ Xy1) @ (ccint @ XB2))) <=> (cwral @ (^ [Xy1:$i] : (cwcel @ XX @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XB2))))))))).
...
thf(cmreacs_conj,conjecture,(! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => (cwcel @ (ccfv @ XX @ ccacs) @ (ccfv @ (ccpw @ XX) @ ccmre)))))).
