...
thf(atposf_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ (ccxp @ XA2 @ XB2) @ XC @ XF) => (cwf @ (ccxp @ XB2 @ XA2) @ XC @ (cctpos @ XF)))))))).
...
thf(ctposmap_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : ((cwcel @ XA2 @ (cco @ XB2 @ (ccxp @ XI @ XJ) @ ccmap)) => (cwcel @ (cctpos @ XA2) @ (cco @ XB2 @ (ccxp @ XJ @ XI) @ ccmap)))))))).
