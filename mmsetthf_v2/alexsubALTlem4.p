...
thf(aalexsubALTlem3_ax,axiom,(! [Xt:$i] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [Xa:$i] : ((XX = (ccuni @ XJ)) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xu:$i] : (((((cw3a @ (XJ = (ccfv @ (ccfv @ (ccv @ Xx3) @ ccfi) @ cctg)) @ (cwral @ (^ [Xc:$i] : ((XX = (ccuni @ (ccv @ Xc))) => (cwrex @ (^ [Xd:$i] : (XX = (ccuni @ (ccv @ Xd)))) @ (^ [Xd:$i] : (ccin @ (ccpw @ (ccv @ Xc)) @ ccfn))))) @ (^ [Xc:$i] : (ccpw @ (ccv @ Xx3)))) @ (cwcel @ (ccv @ Xa) @ (ccpw @ (ccfv @ (ccv @ Xx3) @ ccfi)))) & ((cwcel @ (ccv @ Xu) @ (ccpw @ (ccfv @ (ccv @ Xx3) @ ccfi))) & ((cwss @ (ccv @ Xa) @ (ccv @ Xu)) & (cwral @ (^ [Xb:$i] : (~ (XX = (ccuni @ (ccv @ Xb))))) @ (^ [Xb:$i] : (ccin @ (ccpw @ (ccv @ Xu)) @ ccfn)))))) & (cwcel @ (ccv @ Xw) @ (ccv @ Xu))) & (((cwcel @ (ccv @ Xt) @ (ccin @ (ccpw @ (ccv @ Xx3)) @ ccfn)) & ((ccv @ Xw) = (ccint @ (ccv @ Xt)))) & ((cwcel @ (ccv @ Xy1) @ (ccv @ Xw)) & (~ (cwcel @ (ccv @ Xy1) @ (ccuni @ (ccin @ (ccv @ Xx3) @ (ccv @ Xu)))))))) => (cwrex @ (^ [Xs1:$i] : (cwral @ (^ [Xn:$i] : (~ (XX = (ccuni @ (ccv @ Xn))))) @ (^ [Xn:$i] : (ccin @ (ccpw @ (ccun @ (ccv @ Xu) @ (ccsn @ (ccv @ Xs1)))) @ ccfn)))) @ (^ [Xs1:$i] : (ccv @ Xt)))))))))))))).
...
thf(aimp55_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xph => (Xps => (Xch => (Xth => (Xta => Xet))))) => (((Xph & (Xps & (Xch & Xth))) & Xta) => Xet))))))))).
...
thf(calexsubALTlem4_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (! [Xx3:$i] : ((XJ = (ccfv @ (ccfv @ (ccv @ Xx3) @ ccfi) @ cctg)) => ((cwral @ (^ [Xc:$i] : ((XX = (ccuni @ (ccv @ Xc))) => (cwrex @ (^ [Xd:$i] : (XX = (ccuni @ (ccv @ Xd)))) @ (^ [Xd:$i] : (ccin @ (ccpw @ (ccv @ Xc)) @ ccfn))))) @ (^ [Xc:$i] : (ccpw @ (ccv @ Xx3)))) => (cwral @ (^ [Xa:$i] : ((XX = (ccuni @ (ccv @ Xa))) => (cwrex @ (^ [Xb:$i] : (XX = (ccuni @ (ccv @ Xb)))) @ (^ [Xb:$i] : (ccin @ (ccpw @ (ccv @ Xa)) @ ccfn))))) @ (^ [Xa:$i] : (ccpw @ (ccfv @ (ccv @ Xx3) @ ccfi))))))))))).
