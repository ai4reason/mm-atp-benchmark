...
thf(aimadomg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ XB2) => ((cwfun @ XF) => (cwbr @ (ccima @ XF @ XA2) @ XA2 @ ccdom))))))).
thf(chausmapdom_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwcel @ XJ @ ccha) @ (cwcel @ XJ @ cc1stc) @ (cwss @ XA2 @ XX)) => (cwbr @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (cco @ XA2 @ ccn @ ccmap) @ ccdom))))))).
