...
thf(aeldifvsn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XA2 @ (ccdif @ ccvv @ (ccsn @ XB2))) <=> (cwne @ XA2 @ XB2))))))).
...
thf(ccnvimadfsn_conj,conjecture,(! [XR:($i > $o)] : (! [XZ:($i > $o)] : ((ccima @ (cccnv @ XR) @ (ccdif @ ccvv @ (ccsn @ XZ))) = (ccab @ (^ [Xx3:$i] : (? [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) & (cwne @ (ccv @ Xy1) @ XZ))))))))).
