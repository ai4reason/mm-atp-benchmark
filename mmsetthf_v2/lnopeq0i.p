...
thf(alnopeq0lem2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => ((cco @ (ccfv @ XA2 @ XT) @ XB2 @ ccsp) = (cco @ (cco @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccva) @ XT) @ (cco @ XA2 @ XB2 @ ccva) @ ccsp) @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ XT) @ (cco @ XA2 @ XB2 @ ccmv) @ ccsp) @ ccmin) @ (cco @ cci @ (cco @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccsm) @ ccva) @ XT) @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccsm) @ ccva) @ ccsp) @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccsm) @ ccmv) @ XT) @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccsm) @ ccmv) @ ccsp) @ ccmin) @ ccmul) @ ccaddc) @ cc4 @ ccdiv)))))))).
...
thf(aho01i_ax,axiom,(! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xy1) @ ccsp) = ccc0)) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : cchil)) <=> (XT = cch0o))))).
...
thf(clnopeq0i_conj,conjecture,(! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => ((cwral @ (^ [Xx3:$i] : ((cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xx3) @ ccsp) = ccc0)) @ (^ [Xx3:$i] : cchil)) <=> (XT = cch0o))))).
