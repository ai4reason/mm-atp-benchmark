...
thf(atrclfvub_ax,axiom,(! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XR @ XV) => (cwss @ (ccfv @ XR @ cctcl) @ (ccun @ XR @ (ccxp @ (ccdm @ XR) @ (ccrn @ XR)))))))).
...
thf(cdmtrclfv_conj,conjecture,(! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XR @ XV) => ((ccdm @ (ccfv @ XR @ cctcl)) = (ccdm @ XR)))))).
