...
thf(aclwwlknon1_ax,axiom,(! [XC:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xw:$i] : ((XC @ Xw) = (ccfv @ XG @ ccclwwlknon))) => ((! [Xw:$i] : ((XE @ Xw) = (ccfv @ XG @ ccedg))) => (! [Xw:$i] : ((cwcel @ XX @ XV) => ((cco @ XX @ cc1 @ (XC @ Xw)) = (ccrab @ (^ [Xw:$i] : (((ccv @ Xw) = (ccs1 @ XX)) & (cwcel @ (ccsn @ XX) @ (XE @ Xw)))) @ (^ [Xw:$i] : (ccword @ XV))))))))))))))).
