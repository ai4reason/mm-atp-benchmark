...
thf(aunirnfdomd_ax,axiom,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwf @ XT @ ccfn @ XF)) => ((Xph => (~ (cwcel @ XT @ ccfn))) => ((Xph => (cwcel @ XT @ XV)) => (Xph => (cwbr @ (ccuni @ (ccrn @ XF)) @ XT @ ccdom)))))))))).
...
thf(aacsinfd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ (ccfv @ XX @ ccacs))) => ((XN = (ccfv @ XA2 @ ccmrc)) => ((XI = (ccfv @ XA2 @ ccmri)) => ((Xph => (cwcel @ XS @ XI)) => ((Xph => (cwss @ XT @ XX)) => ((Xph => ((ccfv @ XS @ XN) = (ccfv @ XT @ XN))) => ((Xph => (~ (cwcel @ XS @ ccfn))) => (Xph => (~ (cwcel @ XT @ ccfn)))))))))))))))))).
