...
thf(agcdaddmlem_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ ccz) => ((cwcel @ XM @ ccz) => ((cwcel @ XN @ ccz) => ((cco @ XM @ XN @ ccgcd) = (cco @ XM @ (cco @ (cco @ XK @ XM @ ccmul) @ XN @ ccaddc) @ ccgcd))))))))).
...
thf(cgcdaddm_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) => ((cco @ XM @ XN @ ccgcd) = (cco @ XM @ (cco @ XN @ (cco @ XK @ XM @ ccmul) @ ccaddc) @ ccgcd))))))).
