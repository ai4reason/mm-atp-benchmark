...
thf(chof2fval_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((XM @ Xf1 @ Xg1 @ Xh) = (ccfv @ XC @ cchof))))) => ((Xph => (cwcel @ XC @ cccat)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XZ @ XB2)) => ((Xph => (cwcel @ XW @ XB2)) => ((Xc_x = (ccfv @ XC @ ccco)) => (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (Xph => ((cco @ (ccop @ XX @ XY) @ (ccop @ XZ @ XW) @ (ccfv @ (XM @ Xf1 @ Xg1 @ Xh) @ cc2nd)) = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ XZ @ XX @ XH))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ XY @ XW @ XH))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccmpt @ (^ [Xh:$i] : (cco @ XX @ XY @ XH)) @ (^ [Xh:$i] : (cco @ (cco @ (ccv @ Xg1) @ (ccv @ Xh) @ (cco @ (ccop @ XX @ XY) @ XW @ Xc_x)) @ (ccv @ Xf1) @ (cco @ (ccop @ XZ @ XX) @ XW @ Xc_x)))))))))))))))))))))))))))))))).
