...
thf(anbfusgrlevtxm2_ax,axiom,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((((cwcel @ XG @ ccfusgr) & (cwcel @ XU @ XV)) & (cw3a @ (cwcel @ XM @ XV) @ (cwne @ XM @ XU) @ (cwnel @ XM @ (cco @ XG @ XU @ ccnbgr)))) => (cwbr @ (ccfv @ (cco @ XG @ XU @ ccnbgr) @ cchash) @ (cco @ (ccfv @ XV @ cchash) @ cc2 @ ccmin) @ ccle)))))))).
...
thf(cnbusgrvtxm1_conj,conjecture,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ ccfusgr) & (cwcel @ XU @ XV)) => (((ccfv @ (cco @ XG @ XU @ ccnbgr) @ cchash) = (cco @ (ccfv @ XV @ cchash) @ cc1 @ ccmin)) => (((cwcel @ XM @ XV) & (cwne @ XM @ XU)) => (cwcel @ XM @ (cco @ XG @ XU @ ccnbgr))))))))))).
