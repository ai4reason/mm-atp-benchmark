...
thf(c_2wlklem_conj,conjecture,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwral @ (^ [Xk:$i] : ((ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ XE) = (ccpr @ (ccfv @ (ccv @ Xk) @ XP) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XP)))) @ (^ [Xk:$i] : (ccpr @ ccc0 @ cc1))) <=> (((ccfv @ (ccfv @ ccc0 @ XF) @ XE) = (ccpr @ (ccfv @ ccc0 @ XP) @ (ccfv @ cc1 @ XP))) & ((ccfv @ (ccfv @ cc1 @ XF) @ XE) = (ccpr @ (ccfv @ cc1 @ XP) @ (ccfv @ cc2 @ XP))))))))).
