...
thf(cmndpluscn_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ XF @ (cco @ (XJ @ Xx3 @ Xy1) @ (XK @ Xx3 @ Xy1) @ cchmeo)))) => ((cwf @ (ccxp @ XB2 @ XB2) @ XB2 @ Xc_pl) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwf @ (ccxp @ (XC @ Xx3 @ Xy1) @ (XC @ Xx3 @ Xy1)) @ (XC @ Xx3 @ Xy1) @ Xc_as))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ (XJ @ Xx3 @ Xy1) @ (ccfv @ XB2 @ cctopon)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ (XK @ Xx3 @ Xy1) @ (ccfv @ (XC @ Xx3 @ Xy1) @ cctopon)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XB2) & (cwcel @ (ccv @ Xy1) @ XB2)) => ((ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XF) = (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ Xc_as))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ Xc_pl @ (cco @ (cco @ (XJ @ Xx3 @ Xy1) @ (XJ @ Xx3 @ Xy1) @ cctx) @ (XJ @ Xx3 @ Xy1) @ cccn)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ Xc_as @ (cco @ (cco @ (XK @ Xx3 @ Xy1) @ (XK @ Xx3 @ Xy1) @ cctx) @ (XK @ Xx3 @ Xy1) @ cccn))))))))))))))))))).
