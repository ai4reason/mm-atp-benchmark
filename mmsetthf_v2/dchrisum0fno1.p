...
thf(alogsqrt_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => ((ccfv @ (ccfv @ XA2 @ ccsqrt) @ cclog) = (cco @ (ccfv @ XA2 @ cclog) @ cc2 @ ccdiv))))).
