...
thf(asymggen_ax,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XT = (ccrn @ (ccfv @ XD @ ccpmtr))) => ((XG = (ccfv @ XD @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubmnd) @ ccmrc)) => ((cwcel @ XD @ XV) => ((ccfv @ XT @ XK) = (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccdm @ (ccdif @ (ccv @ Xx3) @ ccid)) @ ccfn)) @ (^ [Xx3:$i] : XB2))))))))))))))).
...
thf(agsumwspan_ax,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XK = (ccfv @ (ccfv @ XM @ ccsubmnd) @ ccmrc)) => (((cwcel @ XM @ ccmnd) & (cwss @ XG @ XB2)) => ((ccfv @ XG @ XK) = (ccrn @ (ccmpt @ (^ [Xw:$i] : (ccword @ XG)) @ (^ [Xw:$i] : (cco @ XM @ (ccv @ Xw) @ ccgsu))))))))))))).
...
thf(cpsgneldm2_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((XG = (ccfv @ XD @ ccsymg)) => ((XT = (ccrn @ (ccfv @ XD @ ccpmtr))) => ((XN = (ccfv @ XD @ ccpsgn)) => (! [Xw:$i] : ((cwcel @ XD @ (XV @ Xw)) => ((cwcel @ XP @ (ccdm @ XN)) <=> (cwrex @ (^ [Xw:$i] : (XP = (cco @ XG @ (ccv @ Xw) @ ccgsu))) @ (^ [Xw:$i] : (ccword @ XT)))))))))))))))).
