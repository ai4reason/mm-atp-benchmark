...
thf(alvolcmp_ax,axiom,(! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XV = (ccfv @ XK @ cclvol)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV)) => ((cwbr @ XX @ XY @ Xc_le) <=> (XX = XY))))))))))).
thf(clvolnltN_conj,conjecture,(! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_lt = (ccfv @ XK @ ccplt)) => ((XV = (ccfv @ XK @ cclvol)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV)) => (~ (cwbr @ XX @ XY @ Xc_lt))))))))))).
