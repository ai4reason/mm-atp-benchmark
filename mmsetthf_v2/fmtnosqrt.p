...
thf(asqrtpwpw2p_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XM @ ccn0) @ (cwbr @ XM @ (cco @ (cco @ cc2 @ (cco @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ cc1 @ ccaddc) @ ccexp) @ cc1 @ ccaddc) @ cclt)) => ((ccfv @ (ccfv @ (cco @ (cco @ cc2 @ (cco @ cc2 @ XN @ ccexp) @ ccexp) @ XM @ ccaddc) @ ccsqrt) @ ccfl) = (cco @ cc2 @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccexp)))))).
