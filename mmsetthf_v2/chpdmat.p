...
thf(achpdmatlem2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [Xi:$i] : (! [Xj:$i] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XC = (cco @ XN @ XR @ ccchpmat)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XS = (ccfv @ XP @ ccascl)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XG = (ccfv @ XP @ ccmgp)) => ((Xc_mi = (ccfv @ XP @ ccsg)) => ((XQ = (cco @ XN @ XP @ ccmat)) => ((Xc_1 = (ccfv @ XQ @ ccur)) => ((Xc_x = (ccfv @ XQ @ ccvsca)) => ((XZ = (ccfv @ XQ @ ccsg)) => ((XT = (cco @ XN @ XR @ ccmat2pmat)) => ((((((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg) @ (cwcel @ XM @ XB2)) & (cwcel @ (ccv @ Xi) @ XN)) & (cwcel @ (ccv @ Xj) @ XN)) & (cwne @ (ccv @ Xi) @ (ccv @ Xj))) & ((cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM) = Xc_0)) => ((cco @ (ccv @ Xi) @ (ccv @ Xj) @ (cco @ (cco @ XX @ Xc_1 @ Xc_x) @ (ccfv @ XM @ XT) @ XZ)) = (ccfv @ XP @ cc0g))))))))))))))))))))))))))))))))))))).
...
thf(amdetdiag_ax,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XD @ Xi @ Xj @ Xk) = (cco @ XN @ (XR @ Xi @ Xj) @ ccmdat))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XA2 @ Xi @ Xj @ Xk) = (cco @ XN @ (XR @ Xi @ Xj) @ ccmat))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XB2 @ Xi @ Xj) = (ccfv @ (XA2 @ Xi @ Xj @ Xk) @ ccbs))))) => ((! [Xi:$i] : (! [Xj:$i] : ((XG @ Xi @ Xj) = (ccfv @ (XR @ Xi @ Xj) @ ccmgp)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xc_0 = (ccfv @ (XR @ Xi @ Xj) @ cc0g)))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((cw3a @ (cwcel @ (XR @ Xi @ Xj) @ cccrg) @ (cwcel @ XN @ ccfn) @ (cwcel @ XM @ (XB2 @ Xi @ Xj))) => ((cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : ((cwne @ (ccv @ Xi) @ (ccv @ Xj)) => ((cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM) = Xc_0))) @ (^ [Xj:$i] : XN))) @ (^ [Xi:$i] : XN)) => ((ccfv @ XM @ (XD @ Xi @ Xj @ Xk)) = (cco @ (XG @ Xi @ Xj) @ (ccmpt @ (^ [Xk:$i] : XN) @ (^ [Xk:$i] : (cco @ (ccv @ Xk) @ (ccv @ Xk) @ XM))) @ ccgsu))))))))))))))))))))).
...
thf(achpdmatlem3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XC = (cco @ XN @ XR @ ccchpmat)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XS = (ccfv @ XP @ ccascl)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XG = (ccfv @ XP @ ccmgp)) => ((Xc_mi = (ccfv @ XP @ ccsg)) => ((XQ = (cco @ XN @ XP @ ccmat)) => ((Xc_1 = (ccfv @ XQ @ ccur)) => ((Xc_x = (ccfv @ XQ @ ccvsca)) => ((XZ = (ccfv @ XQ @ ccsg)) => ((XT = (cco @ XN @ XR @ ccmat2pmat)) => (((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg) @ (cwcel @ XM @ XB2)) & (cwcel @ XK @ XN)) => ((cco @ XK @ XK @ (cco @ (cco @ XX @ Xc_1 @ Xc_x) @ (ccfv @ XM @ XT) @ XZ)) = (cco @ XX @ (ccfv @ (cco @ XK @ XK @ XM) @ XS) @ Xc_mi)))))))))))))))))))))))))))))))))))).
