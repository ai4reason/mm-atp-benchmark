...
thf(aunoplin_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ ccuo) => (cwcel @ XT @ cclo)))).
...
thf(aunopnorm_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XT @ ccuo) & (cwcel @ XA2 @ cchil)) => ((ccfv @ (ccfv @ XA2 @ XT) @ ccno) = (ccfv @ XA2 @ ccno)))))).
thf(adedth_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((XA2 = (ccif @ Xph @ XA2 @ XB2)) => (Xps <=> Xch)) => (Xch => (Xph => Xps))))))))).
thf(aeleq1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwcel @ XA2 @ XC) <=> (cwcel @ XB2 @ XC))))))).
thf(cc0v_tp,type,(cc0v : ($i > $o))).
thf(alnopunii_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => ((cwfo @ cchil @ cchil @ XT) => ((cwral @ (^ [Xx3:$i] : ((ccfv @ (ccfv @ (ccv @ Xx3) @ XT) @ ccno) = (ccfv @ (ccv @ Xx3) @ ccno))) @ (^ [Xx3:$i] : cchil)) => (cwcel @ XT @ ccuo)))))).
...
thf(aidlnop_ax,axiom,(cwcel @ (ccres @ ccid @ cchil) @ cclo)).
...
thf(celunop2_conj,conjecture,(! [XT:($i > $o)] : ((cwcel @ XT @ ccuo) <=> (cw3a @ (cwcel @ XT @ cclo) @ (cwfo @ cchil @ cchil @ XT) @ (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccfv @ (ccv @ Xx3) @ XT) @ ccno) = (ccfv @ (ccv @ Xx3) @ ccno))) @ (^ [Xx3:$i] : cchil)))))).
