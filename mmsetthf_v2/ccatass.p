...
thf(cccatass_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : ((cw3a @ (cwcel @ XS @ (ccword @ XB2)) @ (cwcel @ XT @ (ccword @ XB2)) @ (cwcel @ XU @ (ccword @ XB2))) => ((cco @ (cco @ XS @ XT @ ccconcat) @ XU @ ccconcat) = (cco @ XS @ (cco @ XT @ XU @ ccconcat) @ ccconcat)))))))).
