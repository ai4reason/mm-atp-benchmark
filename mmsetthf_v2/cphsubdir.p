...
thf(aipsubdir_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_mi = (ccfv @ XW @ ccsg)) => ((XS = (ccfv @ XF @ ccsg)) => (((cwcel @ XW @ ccphl) & (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XV))) => ((cco @ (cco @ XA2 @ XB2 @ Xc_mi) @ XC @ Xc_xi) = (cco @ (cco @ XA2 @ XC @ Xc_xi) @ (cco @ XB2 @ XC @ Xc_xi) @ XS)))))))))))))))))).
...
thf(ccphsubdir_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_xi = (ccfv @ XW @ ccip)) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_mi = (ccfv @ XW @ ccsg)) => (((cwcel @ XW @ cccph) & (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XV))) => ((cco @ (cco @ XA2 @ XB2 @ Xc_mi) @ XC @ Xc_xi) = (cco @ (cco @ XA2 @ XC @ Xc_xi) @ (cco @ XB2 @ XC @ Xc_xi) @ ccmin)))))))))))))).
