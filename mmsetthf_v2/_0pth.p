...
thf(afuncnv0_ax,axiom,(cwfun @ (cccnv @ cc0))).
...
thf(c_0pth_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XG @ XW) => ((cwbr @ cc0 @ XP @ (ccfv @ XG @ ccpths)) <=> (cwf @ (cco @ ccc0 @ ccc0 @ ccfz) @ XV @ XP))))))))).
