...
thf(apwfseq_ax,axiom,(! [XA2:($i > $o)] : ((cwbr @ ccom @ XA2 @ ccdom) => (~ (cwbr @ (ccpw @ XA2) @ (cciun @ (^ [Xn:$i] : ccom) @ (^ [Xn:$i] : (cco @ XA2 @ (ccv @ Xn) @ ccmap))) @ ccdom))))).
...
thf(amap2xp_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwbr @ (cco @ XA2 @ cc2o @ ccmap) @ (ccxp @ XA2 @ XA2) @ ccen))))).
...
thf(cpwxpndom2_conj,conjecture,(! [XA2:($i > $o)] : ((cwbr @ ccom @ XA2 @ ccdom) => (~ (cwbr @ (ccpw @ XA2) @ (cco @ XA2 @ (ccxp @ XA2 @ XA2) @ cccda) @ ccdom))))).
