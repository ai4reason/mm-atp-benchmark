...
thf(ablen1_ax,axiom,((ccfv @ cc1 @ ccblen) = cc1)).
...
thf(a_0dig2nn0o_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn0)) => ((cco @ ccc0 @ XN @ (ccfv @ cc2 @ ccdig)) = cc1)))).
...
thf(adignn0flhalf_ax,axiom,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XI @ ccn0)) => ((cco @ (cco @ XI @ cc1 @ ccaddc) @ XA2 @ (ccfv @ cc2 @ ccdig)) = (cco @ XI @ (ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ ccfl) @ (ccfv @ cc2 @ ccdig))))))).
