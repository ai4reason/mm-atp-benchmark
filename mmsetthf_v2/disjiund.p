...
thf(adisjiunb_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : (((ccv @ Xi) = (ccv @ Xj)) => ((XB2 @ Xi) = (XD @ Xj))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (((ccv @ Xi) = (ccv @ Xj)) => ((XC @ Xx3 @ Xi) = (XE @ Xx3 @ Xj)))))) => (! [Xx3:$i] : ((cwdisj @ (^ [Xi:$i] : (XA2 @ Xx3)) @ (^ [Xi:$i] : (cciun @ (^ [Xx3:$i] : (XB2 @ Xi)) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xi))))) <=> (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (((ccv @ Xi) = (ccv @ Xj)) | ((ccin @ (cciun @ (^ [Xx3:$i] : (XB2 @ Xi)) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xi))) @ (cciun @ (^ [Xx3:$i] : (XD @ Xj)) @ (^ [Xx3:$i] : (XE @ Xx3 @ Xj)))) = cc0))) @ (^ [Xj:$i] : (XA2 @ Xx3)))) @ (^ [Xi:$i] : (XA2 @ Xx3))))))))))))).
thf(cdisjiund_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (((ccv @ Xa) = (ccv @ Xc)) => ((XA2 @ Xa @ Xb) = (XC @ Xb @ Xc)))))) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (((ccv @ Xb) = (ccv @ Xd)) => ((XC @ Xb @ Xc) = (XD @ Xx3 @ Xa @ Xc @ Xd)))))))) => ((! [Xa:$i] : (! [Xc:$i] : (((ccv @ Xa) = (ccv @ Xc)) => ((XW @ Xa) = (XX @ Xc))))) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xa @ Xb)) @ (cwcel @ (ccv @ Xx3) @ (XD @ Xx3 @ Xa @ Xc @ Xd))) => ((ccv @ Xa) = (ccv @ Xc)))))))) => (! [Xx3:$i] : (! [Xb:$i] : (! [Xd:$i] : (Xph => (cwdisj @ (^ [Xa:$i] : (XV @ Xx3 @ Xb @ Xd)) @ (^ [Xa:$i] : (cciun @ (^ [Xb:$i] : (XW @ Xa)) @ (^ [Xb:$i] : (XA2 @ Xa @ Xb))))))))))))))))))))).
