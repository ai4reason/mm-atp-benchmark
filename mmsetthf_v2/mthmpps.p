...
thf(amthmsta_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : ((XU = (ccfv @ XT @ ccmthm)) => ((XS = (ccfv @ XT @ ccmpst)) => (cwss @ XU @ XS))))))).
...
thf(ass2mcls_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XD = (ccfv @ XT @ ccmdv)) => ((XE = (ccfv @ XT @ ccmex)) => ((XC = (ccfv @ XT @ ccmcls)) => ((Xph => (cwcel @ XT @ ccmfs)) => ((Xph => (cwss @ XK @ XD)) => ((Xph => (cwss @ XB2 @ XE)) => ((Xph => (cwss @ XX @ XK)) => ((Xph => (cwss @ XY @ XB2)) => (Xph => (cwss @ (cco @ XX @ XY @ XC) @ (cco @ XK @ XB2 @ XC))))))))))))))))))))).
...
thf(aotth_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XR @ ccvv) => (((ccotp @ XA2 @ XB2 @ XR) = (ccotp @ XC @ XD @ XS)) <=> (cw3a @ (XA2 = XC) @ (XB2 = XD) @ (XR = XS))))))))))))).
...
thf(aelmpps_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((XP = (ccfv @ XT @ ccmpst)) => ((XJ = (ccfv @ XT @ ccmpps)) => ((XC = (ccfv @ XT @ ccmcls)) => ((cwcel @ (ccotp @ XD @ XH @ XA2) @ XJ) <=> ((cwcel @ (ccotp @ XD @ XH @ XA2) @ XP) & (cwcel @ XA2 @ (cco @ XD @ XH @ XC))))))))))))))).
