...
thf(aomeunile_ax,axiom,(! [Xph:$o] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XX = (ccuni @ (ccdm @ XO))) => ((Xph => (cwss @ XY @ (ccpw @ XX))) => ((Xph => (cwbr @ XY @ ccom @ ccdom)) => (Xph => (cwbr @ (ccfv @ (ccuni @ XY) @ XO) @ (ccfv @ (ccres @ XO @ XY) @ ccsumge0) @ ccle))))))))))).
...
thf(asge0resrn_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((Xph => (cwf @ XA2 @ XB2 @ XG)) => ((Xph => (cwwe @ XA2 @ XR)) => (Xph => (cwbr @ (ccfv @ (ccres @ XF @ (ccrn @ XG)) @ ccsumge0) @ (ccfv @ (cccom @ XF @ XG) @ ccsumge0) @ ccle)))))))))))))).
