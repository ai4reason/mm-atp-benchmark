...
thf(afiming_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cw3a @ (cwor @ XA2 @ XR) @ (cwcel @ XA2 @ ccfn) @ (cwne @ XA2 @ cc0)) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) => (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
...
thf(cfiinfg_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cw3a @ (cwor @ XA2 @ XR) @ (cwcel @ XA2 @ ccfn) @ (cwne @ XA2 @ cc0)) => (cwrex @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))) @ (^ [Xy1:$i] : XA2)) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ XR)) @ (^ [Xz:$i] : XA2)))) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : XA2)))))).
