...
thf(cressplusf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XH = (cco @ XG @ XA2 @ ccress)) => ((Xc_pd = (ccfv @ XG @ ccplusg)) => ((cwfn @ Xc_pd @ (ccxp @ XB2 @ XB2)) => ((cwss @ XA2 @ XB2) => ((ccfv @ XH @ ccplusf) = (ccres @ Xc_pd @ (ccxp @ XA2 @ XA2)))))))))))))).
