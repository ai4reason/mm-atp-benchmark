...
thf(cdigfval_conj,conjecture,(! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccn) => ((ccfv @ XB2 @ ccdig) = (ccmpt2 @ (^ [Xk:$i] : (^ [Xr:$i] : ccz)) @ (^ [Xk:$i] : (^ [Xr:$i] : (cco @ ccc0 @ ccpnf @ ccico))) @ (^ [Xk:$i] : (^ [Xr:$i] : (cco @ (ccfv @ (cco @ (cco @ XB2 @ (ccneg @ (ccv @ Xk)) @ ccexp) @ (ccv @ Xr) @ ccmul) @ ccfl) @ XB2 @ ccmo)))))))).
