...
thf(aaxcontlem2_ax,axiom,(! [XD:($i > ($i > ($i > $o)))] : (! [XU:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xi:$i] : (! [Xp:$i] : ((XD @ Xi @ Xp) = (ccrab @ (^ [Xp:$i] : ((cwbr @ XU @ (ccop @ XZ @ (ccv @ Xp)) @ ccbtwn) | (cwbr @ (ccv @ Xp) @ (ccop @ XZ @ XU) @ ccbtwn))) @ (^ [Xp:$i] : (ccfv @ XN @ ccee)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xi:$i] : (! [Xp:$i] : ((XF @ Xx3 @ Xt @ Xi @ Xp) = (ccopab @ (^ [Xx3:$i] : (^ [Xt:$i] : ((cwcel @ (ccv @ Xx3) @ (XD @ Xi @ Xp)) & ((cwcel @ (ccv @ Xt) @ (cco @ ccc0 @ ccpnf @ ccico)) & (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ (ccv @ Xx3)) = (cco @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccfv @ (ccv @ Xi) @ XZ) @ ccmul) @ (cco @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ XU) @ ccmul) @ ccaddc))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz))))))))))))) => (! [Xx3:$i] : (! [Xt:$i] : (! [Xi:$i] : (! [Xp:$i] : (((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XZ @ (ccfv @ XN @ ccee)) @ (cwcel @ XU @ (ccfv @ XN @ ccee))) & (cwne @ XZ @ XU)) => (cwf1o @ (XD @ Xi @ Xp) @ (cco @ ccc0 @ ccpnf @ ccico) @ (XF @ Xx3 @ Xt @ Xi @ Xp))))))))))))))).
...
thf(aaxcontlem9_ax,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XU:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xy1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XD @ Xy1 @ Xi @ Xm @ Xn @ Xp) = (ccrab @ (^ [Xp:$i] : ((cwbr @ XU @ (ccop @ XZ @ (ccv @ Xp)) @ ccbtwn) | (cwbr @ (ccv @ Xp) @ (ccop @ XZ @ XU) @ ccbtwn))) @ (^ [Xp:$i] : (ccfv @ XN @ ccee))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XF @ Xx3 @ Xy1 @ Xn) = (ccopab @ (^ [Xx3:$i] : (^ [Xt:$i] : ((cwcel @ (ccv @ Xx3) @ (XD @ Xy1 @ Xi @ Xm @ Xn @ Xp)) & ((cwcel @ (ccv @ Xt) @ (cco @ ccc0 @ ccpnf @ ccico)) & (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ (ccv @ Xx3)) = (cco @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccfv @ (ccv @ Xi) @ XZ) @ ccmul) @ (cco @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ XU) @ ccmul) @ ccaddc))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz))))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : (! [Xi:$i] : ((((cwcel @ XN @ ccn) & (cw3a @ (cwss @ (XA2 @ Xy1 @ Xt @ Xi) @ (ccfv @ XN @ ccee)) @ (cwss @ (XB2 @ Xt @ Xi) @ (ccfv @ XN @ ccee)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccop @ XZ @ (ccv @ Xy1)) @ ccbtwn)) @ (^ [Xy1:$i] : (XB2 @ Xt @ Xi)))) @ (^ [Xx3:$i] : (XA2 @ Xy1 @ Xt @ Xi))))) & ((cw3a @ (cwcel @ XZ @ (ccfv @ XN @ ccee)) @ (cwcel @ XU @ (XA2 @ Xy1 @ Xt @ Xi)) @ (cwne @ (XB2 @ Xt @ Xi) @ cc0)) & (cwne @ XZ @ XU))) => (cwral @ (^ [Xn:$i] : (cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xn) @ (ccv @ Xm) @ ccle)) @ (^ [Xm:$i] : (ccima @ (XF @ Xx3 @ Xy1 @ Xn) @ (XB2 @ Xt @ Xi))))) @ (^ [Xn:$i] : (ccima @ (XF @ Xx3 @ Xy1 @ Xn) @ (XA2 @ Xy1 @ Xt @ Xi))))))))))))))))))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(adedekindle_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwss @ XA2 @ ccr) @ (cwss @ XB2 @ ccr) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))) => (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ ccle) & (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccle))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))) @ (^ [Xz:$i] : ccr)))))).
...
thf(aaxcontlem4_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : ((XD @ Xx3 @ Xy1 @ Xp) = (ccrab @ (^ [Xp:$i] : ((cwbr @ XU @ (ccop @ XZ @ (ccv @ Xp)) @ ccbtwn) | (cwbr @ (ccv @ Xp) @ (ccop @ XZ @ XU) @ ccbtwn))) @ (^ [Xp:$i] : (ccfv @ XN @ ccee))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : ((((cwcel @ XN @ ccn) & (cw3a @ (cwss @ (XA2 @ Xy1) @ (ccfv @ XN @ ccee)) @ (cwss @ XB2 @ (ccfv @ XN @ ccee)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccop @ XZ @ (ccv @ Xy1)) @ ccbtwn)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1))))) & ((cw3a @ (cwcel @ XZ @ (ccfv @ XN @ ccee)) @ (cwcel @ XU @ (XA2 @ Xy1)) @ (cwne @ XB2 @ cc0)) & (cwne @ XZ @ XU))) => (cwss @ (XA2 @ Xy1) @ (XD @ Xx3 @ Xy1 @ Xp)))))))))))))).
...
thf(aaxcontlem3_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : ((XD @ Xx3 @ Xy1 @ Xp) = (ccrab @ (^ [Xp:$i] : ((cwbr @ XU @ (ccop @ XZ @ (ccv @ Xp)) @ ccbtwn) | (cwbr @ (ccv @ Xp) @ (ccop @ XZ @ XU) @ ccbtwn))) @ (^ [Xp:$i] : (ccfv @ XN @ ccee))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xp:$i] : ((((cwcel @ XN @ ccn) & (cw3a @ (cwss @ (XA2 @ Xy1) @ (ccfv @ XN @ ccee)) @ (cwss @ XB2 @ (ccfv @ XN @ ccee)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccop @ XZ @ (ccv @ Xy1)) @ ccbtwn)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1))))) & (cw3a @ (cwcel @ XZ @ (ccfv @ XN @ ccee)) @ (cwcel @ XU @ (XA2 @ Xy1)) @ (cwne @ XZ @ XU))) => (cwss @ XB2 @ (XD @ Xx3 @ Xy1 @ Xp)))))))))))))).
...
thf(aaxcontlem8_ax,axiom,(! [XD:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xi:$i] : ((XD @ Xi) = (ccrab @ (^ [Xp:$i] : ((cwbr @ XU @ (ccop @ XZ @ (ccv @ Xp)) @ ccbtwn) | (cwbr @ (ccv @ Xp) @ (ccop @ XZ @ XU) @ ccbtwn))) @ (^ [Xp:$i] : (ccfv @ XN @ ccee))))) => ((! [Xx3:$i] : (! [Xi:$i] : ((XF @ Xx3) = (ccopab @ (^ [Xx3:$i] : (^ [Xt:$i] : ((cwcel @ (ccv @ Xx3) @ (XD @ Xi)) & ((cwcel @ (ccv @ Xt) @ (cco @ ccc0 @ ccpnf @ ccico)) & (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ (ccv @ Xx3)) = (cco @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccfv @ (ccv @ Xi) @ XZ) @ ccmul) @ (cco @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ XU) @ ccmul) @ ccaddc))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz))))))))))) => (! [Xx3:$i] : (! [Xi:$i] : ((((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XZ @ (ccfv @ XN @ ccee)) @ (cwcel @ XU @ (ccfv @ XN @ ccee))) & (cwne @ XZ @ XU)) & (cw3a @ (cwcel @ XP @ (XD @ Xi)) @ (cwcel @ XQ @ (XD @ Xi)) @ (cwcel @ XR @ (XD @ Xi)))) => (((cwbr @ (ccfv @ XP @ (XF @ Xx3)) @ (ccfv @ XQ @ (XF @ Xx3)) @ ccle) & (cwbr @ (ccfv @ XQ @ (XF @ Xx3)) @ (ccfv @ XR @ (XF @ Xx3)) @ ccle)) => (cwbr @ XQ @ (ccop @ XP @ XR) @ ccbtwn)))))))))))))))).
...
thf(caxcontlem10_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xy1:$i] : (! [Xi:$i] : (! [Xb:$i] : ((XD @ Xy1 @ Xi @ Xb) = (ccrab @ (^ [Xp:$i] : ((cwbr @ XU @ (ccop @ XZ @ (ccv @ Xp)) @ ccbtwn) | (cwbr @ (ccv @ Xp) @ (ccop @ XZ @ XU) @ ccbtwn))) @ (^ [Xp:$i] : (ccfv @ XN @ ccee))))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xb:$i] : (XF = (ccopab @ (^ [Xx3:$i] : (^ [Xt:$i] : ((cwcel @ (ccv @ Xx3) @ (XD @ Xy1 @ Xi @ Xb)) & ((cwcel @ (ccv @ Xt) @ (cco @ ccc0 @ ccpnf @ ccico)) & (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ (ccv @ Xx3)) = (cco @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccfv @ (ccv @ Xi) @ XZ) @ ccmul) @ (cco @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ XU) @ ccmul) @ ccaddc))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz)))))))))))) => (! [Xy1:$i] : (! [Xt:$i] : (! [Xi:$i] : ((((cwcel @ XN @ ccn) & (cw3a @ (cwss @ (XA2 @ Xy1 @ Xt @ Xi) @ (ccfv @ XN @ ccee)) @ (cwss @ (XB2 @ Xt @ Xi) @ (ccfv @ XN @ ccee)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccop @ XZ @ (ccv @ Xy1)) @ ccbtwn)) @ (^ [Xy1:$i] : (XB2 @ Xt @ Xi)))) @ (^ [Xx3:$i] : (XA2 @ Xy1 @ Xt @ Xi))))) & ((cw3a @ (cwcel @ XZ @ (ccfv @ XN @ ccee)) @ (cwcel @ XU @ (XA2 @ Xy1 @ Xt @ Xi)) @ (cwne @ (XB2 @ Xt @ Xi) @ cc0)) & (cwne @ XZ @ XU))) => (cwrex @ (^ [Xb:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xb) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ ccbtwn)) @ (^ [Xy1:$i] : (XB2 @ Xt @ Xi)))) @ (^ [Xx3:$i] : (XA2 @ Xy1 @ Xt @ Xi)))) @ (^ [Xb:$i] : (ccfv @ XN @ ccee))))))))))))))))).
