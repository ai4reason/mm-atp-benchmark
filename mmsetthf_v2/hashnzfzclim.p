...
thf(ahashnzfz_ax,axiom,(! [Xph:$o] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XJ @ ccz)) => ((Xph => (cwcel @ XK @ (ccfv @ (cco @ XJ @ cc1 @ ccmin) @ ccuz))) => (Xph => ((ccfv @ (ccin @ (ccima @ ccdvds @ (ccsn @ XN)) @ (cco @ XJ @ XK @ ccfz)) @ cchash) = (cco @ (ccfv @ (cco @ XK @ XN @ ccdiv) @ ccfl) @ (ccfv @ (cco @ (cco @ XJ @ cc1 @ ccmin) @ XN @ ccdiv) @ ccfl) @ ccmin))))))))))).
...
thf(aflflp1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ (ccfv @ XA2 @ ccfl) @ XB2 @ ccle) <=> (cwbr @ XA2 @ (cco @ (ccfv @ XB2 @ ccfl) @ cc1 @ ccaddc) @ cclt)))))).
...
thf(aclimres_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XF @ XV)) => ((cwbr @ (ccres @ XF @ (ccfv @ XM @ ccuz)) @ XA2 @ ccli) <=> (cwbr @ XF @ XA2 @ ccli)))))))).
...
thf(chashnzfzclim_conj,conjecture,(! [Xph:$o] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XJ @ ccz)) => (Xph => (cwbr @ (ccmpt @ (^ [Xk:$i] : (ccfv @ (cco @ XJ @ cc1 @ ccmin) @ ccuz)) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccin @ (ccima @ ccdvds @ (ccsn @ XM)) @ (cco @ XJ @ (ccv @ Xk) @ ccfz)) @ cchash) @ (ccv @ Xk) @ ccdiv))) @ (cco @ cc1 @ XM @ ccdiv) @ ccli)))))))).
