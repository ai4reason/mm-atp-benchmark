...
thf(cfvun2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwfn @ XF @ XA2) @ (cwfn @ XG @ XB2) @ (((ccin @ XA2 @ XB2) = cc0) & (cwcel @ XX @ XB2))) => ((ccfv @ XX @ (ccun @ XF @ XG)) = (ccfv @ XX @ XG))))))))).
