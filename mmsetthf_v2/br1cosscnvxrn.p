...
thf(aecxrn_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((ccec @ XA2 @ (ccxrn @ XR @ XS)) = (ccopab @ (^ [Xy1:$i] : (^ [Xz:$i] : ((cwbr @ XA2 @ (ccv @ Xy1) @ XR) & (cwbr @ XA2 @ (ccv @ Xz) @ XS)))))))))))).
...
thf(abrcosscnv2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwbr @ XA2 @ XB2 @ (cccoss @ (cccnv @ XR))) <=> (cwne @ (ccin @ (ccec @ XA2 @ XR) @ (ccec @ XB2 @ XR)) @ cc0))))))))).
