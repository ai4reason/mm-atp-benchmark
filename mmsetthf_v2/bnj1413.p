...
thf(abnj1148_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cw_bnj15 @ XA2 @ XR) & (cwcel @ XX @ XA2)) => (cwcel @ (cc_bnj14 @ XA2 @ XR @ XX) @ ccvv)))))).
...
thf(abnj1127_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XY @ (cc_bnj18 @ XA2 @ XR @ XX)) => (cwcel @ XY @ XA2))))))).
...
thf(cbnj1413_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccun @ (cc_bnj14 @ XA2 @ XR @ XX) @ (cciun @ (^ [Xy1:$i] : (cc_bnj14 @ XA2 @ XR @ XX)) @ (^ [Xy1:$i] : (cc_bnj18 @ XA2 @ XR @ (ccv @ Xy1))))))) => (! [Xy1:$i] : (((cw_bnj15 @ XA2 @ XR) & (cwcel @ XX @ XA2)) => (cwcel @ (XB2 @ Xy1) @ ccvv))))))))).
