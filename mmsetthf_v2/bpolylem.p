...
thf(awrecseq3_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XF = XG) => ((ccwrecs @ XA2 @ XR @ XF) = (ccwrecs @ XA2 @ XR @ XG)))))))).
thf(ccio_tp,type,(ccio : (($i > $o) > ($i > $o)))).
thf(afveq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))).
thf(adf_bpoly_ax,axiom,(ccbp = (ccmpt2 @ (^ [Xm:$i] : (^ [Xx3:$i] : ccn0)) @ (^ [Xm:$i] : (^ [Xx3:$i] : ccc)) @ (^ [Xm:$i] : (^ [Xx3:$i] : (ccfv @ (ccv @ Xm) @ (ccwrecs @ ccn0 @ cclt @ (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccsb @ (ccfv @ (ccdm @ (ccv @ Xg1)) @ cchash) @ (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccexp) @ (ccsu @ (ccdm @ (ccv @ Xg1)) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccbc) @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xg1)) @ (cco @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccmin) @ cc1 @ ccaddc) @ ccdiv) @ ccmul))) @ ccmin)))))))))))).
...
thf(altweuz_ax,axiom,(! [XA2:($i > $o)] : (cwwe @ (ccfv @ XA2 @ ccuz) @ cclt))).
...
thf(aexse_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwse @ XA2 @ XR)))))).
...
thf(aprednn0_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((ccpred @ ccn0 @ cclt @ XN) = (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))))).
...
thf(awfrfun_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((XF = (ccwrecs @ XA2 @ XR @ XG)) => (cwfun @ XF))))))))).
...
thf(awfr1_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((XF = (ccwrecs @ XA2 @ XR @ XG)) => (cwfn @ XF @ XA2))))))))).
...
thf(afz01en_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => (cwbr @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ ccen)))).
...
thf(cbpolylem_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((! [Xg1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XG @ Xg1 @ Xk @ Xn) = (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccsb @ (ccfv @ (ccdm @ (ccv @ Xg1)) @ cchash) @ (^ [Xn:$i] : (cco @ (cco @ XX @ (ccv @ Xn) @ ccexp) @ (ccsu @ (ccdm @ (ccv @ Xg1)) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccbc) @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xg1)) @ (cco @ (cco @ (ccv @ Xn) @ (ccv @ Xk) @ ccmin) @ cc1 @ ccaddc) @ ccdiv) @ ccmul))) @ ccmin))))))))) => ((! [Xg1:$i] : (! [Xk:$i] : (! [Xn:$i] : (XF = (ccwrecs @ ccn0 @ cclt @ (XG @ Xg1 @ Xk @ Xn)))))) => (((cwcel @ XN @ ccn0) & (cwcel @ XX @ ccc)) => ((cco @ XN @ XX @ ccbp) = (cco @ (cco @ XX @ XN @ ccexp) @ (ccsu @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ (ccv @ Xk) @ XX @ ccbp) @ (cco @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ cc1 @ ccaddc) @ ccdiv) @ ccmul))) @ ccmin)))))))))).
