...
thf(aipodrscl_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ (ccfv @ XA2 @ ccipo) @ ccdrs) => (cwcel @ XA2 @ ccvv)))).
...
thf(cipodrsfi_conj,conjecture,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ (ccfv @ XA2 @ ccipo) @ ccdrs) @ (cwss @ XX @ XA2) @ (cwcel @ XX @ ccfn)) => (cwrex @ (^ [Xz:$i] : (cwss @ (ccuni @ XX) @ (ccv @ Xz))) @ (^ [Xz:$i] : XA2)))))).
