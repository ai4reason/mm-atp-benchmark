...
thf(aofmpteq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cw3a @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwfn @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XA2) @ (cwfn @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ XA2)) => ((cco @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (ccof @ XR)) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xx3) @ (XC @ Xx3) @ XR)))))))))))).
...
thf(azrhpsgnmhm_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (((cwcel @ XR @ ccrg) & (cwcel @ XA2 @ ccfn)) => (cwcel @ (cccom @ (ccfv @ XR @ cczrh) @ (ccfv @ XA2 @ ccpsgn)) @ (cco @ (ccfv @ XA2 @ ccsymg) @ (ccfv @ XR @ ccmgp) @ ccmhm)))))).
...
thf(agsummptfidmadd2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [Xc_pl:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : ((! [Xx3:$i] : (XB2 = (ccfv @ (XG @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (Xc_pl = (ccfv @ (XG @ Xx3) @ ccplusg))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XG @ Xx3) @ cccmn))) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XC @ Xx3) @ XB2))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XD @ Xx3) @ XB2))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XD @ Xx3))))) => (! [Xx3:$i] : (Xph => ((cco @ (XG @ Xx3) @ (cco @ (XF @ Xx3) @ (XH @ Xx3) @ (ccof @ Xc_pl)) @ ccgsu) = (cco @ (cco @ (XG @ Xx3) @ (XF @ Xx3) @ ccgsu) @ (cco @ (XG @ Xx3) @ (XH @ Xx3) @ ccgsu) @ Xc_pl)))))))))))))))))))))).
...
thf(amdetleib2_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xp:$i] : ((XD @ Xx3 @ Xp) = (cco @ XN @ XR @ ccmdat)))) => ((! [Xx3:$i] : (! [Xp:$i] : ((XA2 @ Xx3 @ Xp) = (cco @ XN @ XR @ ccmat)))) => ((! [Xx3:$i] : (! [Xp:$i] : (XB2 = (ccfv @ (XA2 @ Xx3 @ Xp) @ ccbs)))) => ((XP = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((! [Xx3:$i] : ((XY @ Xx3) = (ccfv @ XR @ cczrh))) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccfv @ XN @ ccpsgn))) => ((! [Xx3:$i] : ((Xc_x @ Xx3) = (ccfv @ XR @ ccmulr))) => ((! [Xx3:$i] : ((XU @ Xx3) = (ccfv @ XR @ ccmgp))) => (! [Xx3:$i] : (! [Xp:$i] : (((cwcel @ XR @ cccrg) & (cwcel @ XM @ XB2)) => ((ccfv @ XM @ (XD @ Xx3 @ Xp)) = (cco @ XR @ (ccmpt @ (^ [Xp:$i] : XP) @ (^ [Xp:$i] : (cco @ (ccfv @ (ccv @ Xp) @ (cccom @ (XY @ Xx3) @ (XS @ Xx3))) @ (cco @ (XU @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XN) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xp)) @ XM))) @ ccgsu) @ (Xc_x @ Xx3)))) @ ccgsu))))))))))))))))))))))))).
thf(cmdetrlin_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XD = (cco @ XN @ XR @ ccmdat)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XZ @ XB2)) => ((Xph => (cwcel @ XI @ XN)) => ((Xph => ((ccres @ XX @ (ccxp @ (ccsn @ XI) @ XN)) = (cco @ (ccres @ XY @ (ccxp @ (ccsn @ XI) @ XN)) @ (ccres @ XZ @ (ccxp @ (ccsn @ XI) @ XN)) @ (ccof @ Xc_pl)))) => ((Xph => ((ccres @ XX @ (ccxp @ (ccdif @ XN @ (ccsn @ XI)) @ XN)) = (ccres @ XY @ (ccxp @ (ccdif @ XN @ (ccsn @ XI)) @ XN)))) => ((Xph => ((ccres @ XX @ (ccxp @ (ccdif @ XN @ (ccsn @ XI)) @ XN)) = (ccres @ XZ @ (ccxp @ (ccdif @ XN @ (ccsn @ XI)) @ XN)))) => (Xph => ((ccfv @ XX @ XD) = (cco @ (ccfv @ XY @ XD) @ (ccfv @ XZ @ XD) @ Xc_pl))))))))))))))))))))))))))).
