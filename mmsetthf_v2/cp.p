...
thf(acplem2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (? [Xy1:$i] : (cwral @ (^ [Xx3:$i] : ((cwne @ (XB2 @ Xx3) @ cc0) => (cwne @ (ccin @ (XB2 @ Xx3) @ (ccv @ Xy1)) @ cc0))) @ (^ [Xx3:$i] : XA2))))))).
...
thf(ccp_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xz:$i] : (? [Xw:$i] : (cwral @ (^ [Xx3:$i] : ((? [Xy1:$i] : (Xph @ Xx3 @ Xy1)) => (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (ccv @ Xw))))) @ (^ [Xx3:$i] : (ccv @ Xz))))))).
