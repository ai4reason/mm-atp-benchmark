...
thf(cinfrelb_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ (cwss @ XB2 @ ccr) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : ccr)) @ (cwcel @ (XA2 @ Xx3 @ Xy1) @ XB2)) => (cwbr @ (ccinf @ XB2 @ ccr @ cclt) @ (XA2 @ Xx3 @ Xy1) @ ccle))))))).
