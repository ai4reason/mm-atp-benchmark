...
thf(achtvalz_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((ccfv @ XN @ cccht) = (ccsu @ (ccin @ (cco @ cc1 @ XN @ ccfz) @ ccprime) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ cclog))))))).
...
thf(alog2le1_ax,axiom,(cwbr @ (ccfv @ cc2 @ cclog) @ cc1 @ cclt)).
...
thf(adp0h_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => ((cco @ ccc0 @ XA2 @ ccdp) = (cco @ XA2 @ (ccdc @ cc1 @ ccc0) @ ccdiv))))).
...
thf(asqrtled_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XB2 @ ccle)) => (Xph => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwbr @ (ccfv @ XA2 @ ccsqrt) @ (ccfv @ XB2 @ ccsqrt) @ ccle))))))))))).
