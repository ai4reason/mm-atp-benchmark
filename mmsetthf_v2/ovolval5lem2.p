...
thf(afcomptss_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwf @ XA2 @ (XB2 @ Xx3) @ XF))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ (XB2 @ Xx3) @ XC))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwf @ XC @ XD @ XG))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cccom @ XG @ XF) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XG))))))))))))))))).
...
thf(aovolval5lem1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XW:($i > $o)] : ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwcel @ (XA2 @ Xn) @ ccr))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwcel @ (XB2 @ Xn) @ ccr))) => ((Xph => (cwcel @ XW @ ccrp)) => ((XC = (ccrab @ (^ [Xn:$i] : (cwbr @ (XA2 @ Xn) @ (XB2 @ Xn) @ cclt)) @ (^ [Xn:$i] : ccn))) => (Xph => (cwbr @ (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (cco @ (cco @ (XA2 @ Xn) @ (cco @ XW @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccmin) @ (XB2 @ Xn) @ ccioo) @ ccvol))) @ ccsumge0) @ (cco @ (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (cco @ (XA2 @ Xn) @ (XB2 @ Xn) @ ccico) @ ccvol))) @ ccsumge0) @ XW @ ccxad) @ ccle)))))))))))).
...
thf(avolioofmpt_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((! [Xx3:$i] : (Xph => (cwf @ XA2 @ (ccxp @ ccxr @ ccxr) @ (XF @ Xx3)))) => (! [Xx3:$i] : (Xph => ((cccom @ (cccom @ ccvol @ ccioo) @ (XF @ Xx3)) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ cc1st) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ cc2nd) @ ccioo) @ ccvol)))))))))))).
