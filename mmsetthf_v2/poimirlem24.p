...
thf(acsbnestg_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ (XA2 @ Xx3 @ Xy1) @ (XV @ Xx3 @ Xy1)) => ((ccsb @ (XA2 @ Xx3 @ Xy1) @ (^ [Xx3:$i] : (ccsb @ (XB2 @ Xx3 @ Xy1) @ (^ [Xy1:$i] : (XC @ Xy1))))) = (ccsb @ (ccsb @ (XA2 @ Xx3 @ Xy1) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (XC @ Xy1)))))))))))).
...
thf(aelfzmlbm_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ XM @ XN @ ccfz)) => (cwcel @ (cco @ XK @ XM @ ccmin) @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfz))))))).
...
thf(apoimirlem23_ax,axiom,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwf @ (cco @ cc1 @ XN @ ccfz) @ (cco @ ccc0 @ XK @ ccfzo) @ XT)) => ((Xph => (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ XU)) => ((Xph => (cwcel @ XV @ (cco @ ccc0 @ XN @ ccfz))) => (Xph => ((cwrex @ (^ [Xp:$i] : (cwne @ (ccfv @ XN @ (ccv @ Xp)) @ ccc0)) @ (^ [Xp:$i] : (ccrn @ (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xy1:$i] : (ccsb @ (ccif @ (cwbr @ (ccv @ Xy1) @ XV @ cclt) @ (ccv @ Xy1) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (^ [Xj:$i] : (cco @ XT @ (ccun @ (ccxp @ (ccima @ XU @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ XU @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc))))))))) <=> (~ ((XV = XN) & (((ccfv @ XN @ XT) = ccc0) & ((ccfv @ XN @ XU) = XN))))))))))))))))).
thf(cpoimirlem24_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((! [Xj:$i] : (! [Xs1:$i] : (! [Xp:$i] : (((ccv @ Xp) = (cco @ (ccfv @ (ccv @ Xs1) @ cc1st) @ (ccun @ (ccxp @ (ccima @ (ccfv @ (ccv @ Xs1) @ cc2nd) @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (ccfv @ (ccv @ Xs1) @ cc2nd) @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc))) => ((XB2 @ Xp) = (XC @ Xj @ Xs1)))))) => ((! [Xp:$i] : ((Xph & (cwf @ (cco @ cc1 @ XN @ ccfz) @ (cco @ ccc0 @ XK @ ccfz) @ (ccv @ Xp))) => (cwcel @ (XB2 @ Xp) @ (cco @ ccc0 @ XN @ ccfz)))) => ((Xph => (cwf @ (cco @ cc1 @ XN @ ccfz) @ (cco @ ccc0 @ XK @ ccfzo) @ XT)) => ((Xph => (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ XU)) => ((Xph => (cwcel @ XV @ (cco @ ccc0 @ XN @ ccfz))) => (Xph => ((cwrex @ (^ [Xx3:$i] : (((ccv @ Xx3) = (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xy1:$i] : (ccsb @ (ccif @ (cwbr @ (ccv @ Xy1) @ XV @ cclt) @ (ccv @ Xy1) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (^ [Xj:$i] : (cco @ XT @ (ccun @ (ccxp @ (ccima @ XU @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ XU @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc))))))) & ((cwss @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (ccrn @ (ccmpt @ (^ [Xp:$i] : (ccrn @ (ccv @ Xx3))) @ (^ [Xp:$i] : (XB2 @ Xp))))) & (cwrex @ (^ [Xp:$i] : (cwne @ (ccfv @ XN @ (ccv @ Xp)) @ ccc0)) @ (^ [Xp:$i] : (ccrn @ (ccv @ Xx3))))))) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ ccc0 @ XK @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ ccmap))) <=> ((cwral @ (^ [Xi:$i] : (cwrex @ (^ [Xj:$i] : ((ccv @ Xi) = (ccsb @ (ccop @ XT @ XU) @ (^ [Xs1:$i] : (XC @ Xj @ Xs1))))) @ (^ [Xj:$i] : (ccdif @ (cco @ ccc0 @ XN @ ccfz) @ (ccsn @ XV))))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) & (~ ((XV = XN) & (((ccfv @ XN @ XT) = ccc0) & ((ccfv @ XN @ XU) = XN)))))))))))))))))))))).
