...
thf(afzpreddisj_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ XM @ ccuz)) => ((ccin @ (ccsn @ XM) @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XN @ ccfz)) = cc0))))).
...
thf(adifininv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((ccin @ (ccdif @ XA2 @ XC) @ XB2) = cc0) & ((ccin @ (ccdif @ XC @ XA2) @ XB2) = cc0)) => ((ccin @ XA2 @ XB2) = (ccin @ XC @ XB2))))))).
thf(asyldan_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => (((Xph & Xch) => Xth) => ((Xph & Xps) => Xth)))))))).
thf(abiimpa_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps <=> Xch)) => ((Xph & Xps) => Xch)))))).
thf(aznnnlt1_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((~ (cwcel @ XN @ ccn)) <=> (cwbr @ XN @ cc1 @ cclt))))).
...
thf(auzssico_ax,axiom,(! [XM:($i > $o)] : ((cwcel @ XM @ ccz) => (cwss @ (ccfv @ XM @ ccuz) @ (cco @ XM @ ccpnf @ ccico))))).
...
thf(aiccssico_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & ((cwbr @ XA2 @ XC @ ccle) & (cwbr @ XD @ XB2 @ cclt))) => (cwss @ (cco @ XC @ XD @ ccicc) @ (cco @ XA2 @ XB2 @ ccico)))))))).
...
thf(aicodisj_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) => ((ccin @ (cco @ XA2 @ XB2 @ ccico) @ (cco @ XB2 @ XC @ ccico)) = cc0)))))).
...
thf(aexmidd_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps | (~ Xps)))))).
thf(cchtvalz_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((ccfv @ XN @ cccht) = (ccsu @ (ccin @ (cco @ cc1 @ XN @ ccfz) @ ccprime) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ cclog))))))).
