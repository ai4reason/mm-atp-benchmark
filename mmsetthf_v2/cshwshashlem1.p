...
thf(acshwsidrepswmod0_ax,axiom,(! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ (ccfv @ XW @ cchash) @ ccprime) @ (cwcel @ XL @ ccz)) => (((cco @ XW @ XL @ cccsh) = XW) => (((cco @ XL @ (ccfv @ XW @ cchash) @ ccmo) = ccc0) | (XW = (cco @ (ccfv @ ccc0 @ XW) @ (ccfv @ XW @ cchash) @ ccreps))))))))).
...
thf(afzofzim_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (((cwne @ XK @ XM) & (cwcel @ XK @ (cco @ ccc0 @ XM @ ccfz))) => (cwcel @ XK @ (cco @ ccc0 @ XM @ ccfzo)))))).
...
thf(ccshwshashlem1_conj,conjecture,(! [Xph:$o] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => ((cwcel @ XW @ (ccword @ XV)) & (cwcel @ (ccfv @ XW @ cchash) @ ccprime))) => ((cw3a @ Xph @ (cwrex @ (^ [Xi:$i] : (cwne @ (ccfv @ (ccv @ Xi) @ XW) @ (ccfv @ ccc0 @ XW))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) @ (cwcel @ XL @ (cco @ cc1 @ (ccfv @ XW @ cchash) @ ccfzo))) => (cwne @ (cco @ XW @ XL @ cccsh) @ XW)))))))).
