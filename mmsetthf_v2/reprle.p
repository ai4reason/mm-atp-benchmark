...
thf(afsumub_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : ((! [Xk:$i] : (((ccv @ Xk) = XK) => ((XB2 @ Xk) = XD))) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : (Xph => ((ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) = (XC @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccrp))) => ((Xph => (cwcel @ XK @ XA2)) => (! [Xk:$i] : (Xph => (cwbr @ XD @ (XC @ Xk) @ ccle))))))))))))))).
...
thf(creprle_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XS @ ccn0)) => ((Xph => (cwcel @ XC @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)))) => ((Xph => (cwcel @ XX @ (cco @ ccc0 @ XS @ ccfzo))) => (Xph => (cwbr @ (ccfv @ XX @ XC) @ XM @ ccle)))))))))))))).
