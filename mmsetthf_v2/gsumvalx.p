...
thf(adf_gsum_ax,axiom,(ccgsu = (ccmpt2 @ (^ [Xw:$i] : (^ [Xf1:$i] : ccvv)) @ (^ [Xw:$i] : (^ [Xf1:$i] : ccvv)) @ (^ [Xw:$i] : (^ [Xf1:$i] : (ccsb @ (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xw) @ ccplusg)) = (ccv @ Xy1)) & ((cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xw) @ ccplusg)) = (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xw) @ ccbs)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xw) @ ccbs))) @ (^ [Xo:$i] : (ccif @ (cwss @ (ccrn @ (ccv @ Xf1)) @ (ccv @ Xo)) @ (ccfv @ (ccv @ Xw) @ cc0g) @ (ccif @ (cwcel @ (ccdm @ (ccv @ Xf1)) @ (ccrn @ ccfz)) @ (ccio @ (^ [Xx3:$i] : (? [Xm:$i] : (cwrex @ (^ [Xn:$i] : (((ccdm @ (ccv @ Xf1)) = (cco @ (ccv @ Xm) @ (ccv @ Xn) @ ccfz)) & ((ccv @ Xx3) = (ccfv @ (ccv @ Xn) @ (ccseq @ (ccfv @ (ccv @ Xw) @ ccplusg) @ (ccv @ Xf1) @ (ccv @ Xm)))))) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xm) @ ccuz)))))) @ (ccio @ (^ [Xx3:$i] : (? [Xg1:$i] : (cwsbc @ (^ [Xy1:$i] : ((cwf1o @ (cco @ cc1 @ (ccfv @ (ccv @ Xy1) @ cchash) @ ccfz) @ (ccv @ Xy1) @ (ccv @ Xg1)) & ((ccv @ Xx3) = (ccfv @ (ccfv @ (ccv @ Xy1) @ cchash) @ (ccseq @ (ccfv @ (ccv @ Xw) @ ccplusg) @ (cccom @ (ccv @ Xf1) @ (ccv @ Xg1)) @ cc1))))) @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccdif @ ccvv @ (ccv @ Xo)))))))))))))))).
