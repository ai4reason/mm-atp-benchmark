...
thf(alimuni2_ax,axiom,(! [XA2:($i > $o)] : ((cwlim @ XA2) => (cwlim @ (ccuni @ XA2))))).
...
thf(aonsucuni2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (XA2 = (ccsuc @ XB2))) => ((ccsuc @ (ccuni @ XA2)) = XA2))))).
...
thf(a_3ori_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3o @ Xph @ Xps @ Xch) => (((~ Xph) & (~ Xps)) => Xch)))))).
...
thf(arankxplim_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (((cwlim @ (ccfv @ (ccun @ XA2 @ XB2) @ ccrnk)) & (cwne @ (ccxp @ XA2 @ XB2) @ cc0)) => ((ccfv @ (ccxp @ XA2 @ XB2) @ ccrnk) = (ccfv @ (ccun @ XA2 @ XB2) @ ccrnk)))))))).
thf(alimeq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 = XB2) => ((cwlim @ XA2) <=> (cwlim @ XB2)))))).
thf(aidd_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xps))))).
thf(crankxplim3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwlim @ (ccfv @ (ccxp @ XA2 @ XB2) @ ccrnk)) <=> (cwlim @ (ccuni @ (ccfv @ (ccxp @ XA2 @ XB2) @ ccrnk))))))))).
