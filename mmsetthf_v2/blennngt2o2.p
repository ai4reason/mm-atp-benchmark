...
thf(arelogbdivb_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XB2 @ (ccdif @ ccrp @ (ccsn @ cc1))) & (cwcel @ XA2 @ ccrp)) => ((cco @ XB2 @ (cco @ XA2 @ XB2 @ ccdiv) @ cclogb) = (cco @ (cco @ XB2 @ XA2 @ cclogb) @ cc1 @ ccmin)))))).
...
thf(aflsubz_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XN @ ccz)) => ((ccfv @ (cco @ XA2 @ XN @ ccmin) @ ccfl) = (cco @ (ccfv @ XA2 @ ccfl) @ XN @ ccmin)))))).
...
thf(annolog2flm1_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) & (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn)) => ((ccfv @ (cco @ cc2 @ XN @ cclogb) @ ccfl) = (ccfv @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ cclogb) @ ccfl))))).
thf(ccmul_tp,type,(ccmul : ($i > $o))).
thf(anno_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) & (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn0)) => (cwcel @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn)))).
thf(ccabs_tp,type,(ccabs : ($i > $o))).
thf(ablennn_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((ccfv @ XN @ ccblen) = (cco @ (ccfv @ (cco @ cc2 @ XN @ cclogb) @ ccfl) @ cc1 @ ccaddc))))).
thf(cblennngt2o2_conj,conjecture,(! [XN:($i > $o)] : (((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) & (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn0)) => ((ccfv @ XN @ ccblen) = (cco @ (ccfv @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccblen) @ cc1 @ ccaddc))))).
