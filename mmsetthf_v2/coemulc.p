...
thf(afconstg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => (cwf @ XA2 @ (ccsn @ XB2) @ (ccxp @ XA2 @ (ccsn @ XB2)))))))).
...
thf(ann0le0eq0_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cwbr @ XN @ ccc0 @ ccle) <=> (XN = ccc0))))).
...
thf(aelfz3_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => (cwcel @ XN @ (cco @ XN @ XN @ ccfz))))).
...
thf(ccoemulc_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XF @ (ccfv @ XS @ ccply))) => ((ccfv @ (cco @ (ccxp @ ccc @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul)) @ cccoe) = (cco @ (ccxp @ ccn0 @ (ccsn @ XA2)) @ (ccfv @ XF @ cccoe) @ (ccof @ ccmul)))))))).
