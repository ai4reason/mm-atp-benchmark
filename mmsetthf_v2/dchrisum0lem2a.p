...
thf(aclimrlim2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xn:$i] : (XZ = (ccfv @ (XM @ Xx3 @ Xn) @ ccuz)))) => ((! [Xx3:$i] : (! [Xn:$i] : (((ccv @ Xn) = (ccfv @ (ccv @ Xx3) @ ccfl)) => ((XB2 @ Xn) = (XC @ Xx3))))) => ((! [Xn:$i] : (Xph => (cwss @ (XA2 @ Xn) @ ccr))) => ((! [Xx3:$i] : (! [Xn:$i] : (Xph => (cwcel @ (XM @ Xx3 @ Xn) @ ccz)))) => ((! [Xn:$i] : (Xph => (cwbr @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (XB2 @ Xn))) @ (XD @ Xn) @ ccli))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ XZ)) => (cwcel @ (XB2 @ Xn) @ ccc))) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xn))) => (cwbr @ (XM @ Xx3 @ Xn) @ (ccv @ Xx3) @ ccle)))) => (! [Xn:$i] : (Xph => (cwbr @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xn)) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (XD @ Xn) @ ccrli)))))))))))))))))).
...
thf(ao1resb_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwss @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((cwcel @ XF @ cco1) <=> (cwcel @ (ccres @ XF @ (cco @ XB2 @ ccpnf @ ccico)) @ cco1))))))))))).
...
thf(adivsqrsumf_ax,axiom,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xn:$i] : ((XF @ Xx3 @ Xn) = (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ cc1 @ (ccfv @ (ccv @ Xn) @ ccsqrt) @ ccdiv))) @ (cco @ cc2 @ (ccfv @ (ccv @ Xx3) @ ccsqrt) @ ccmul) @ ccmin)))))) => (! [Xx3:$i] : (! [Xn:$i] : (cwf @ ccrp @ ccr @ (XF @ Xx3 @ Xn))))))).
...
thf(aelo1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwss @ XA2 @ ccr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccc))) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwcel @ XM @ ccr)) => ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XA2) & (cwbr @ XC @ (ccv @ Xx3) @ ccle))) => (cwbr @ (ccfv @ (XB2 @ Xx3) @ ccabs) @ XM @ ccle))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cco1))))))))))))).
...
thf(adchrabs2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XD = (ccfv @ XG @ ccbs)) => ((XZ = (ccfv @ XN @ cczn)) => ((XB2 = (ccfv @ XZ @ ccbs)) => ((Xph => (cwcel @ XX @ XD)) => ((Xph => (cwcel @ XA2 @ XB2)) => (Xph => (cwbr @ (ccfv @ (ccfv @ XA2 @ XX) @ ccabs) @ cc1 @ ccle))))))))))))))))).
...
thf(arecdiv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwne @ XA2 @ ccc0)) & ((cwcel @ XB2 @ ccc) & (cwne @ XB2 @ ccc0))) => ((cco @ cc1 @ (cco @ XA2 @ XB2 @ ccdiv) @ ccdiv) = (cco @ XB2 @ XA2 @ ccdiv)))))).
...
thf(admdcan_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ ((cwcel @ XA2 @ ccc) & (cwne @ XA2 @ ccc0)) @ ((cwcel @ XB2 @ ccc) & (cwne @ XB2 @ ccc0)) @ (cwcel @ XC @ ccc)) => ((cco @ (cco @ XA2 @ XB2 @ ccdiv) @ (cco @ XC @ XA2 @ ccdiv) @ ccmul) = (cco @ XC @ XB2 @ ccdiv))))))).
