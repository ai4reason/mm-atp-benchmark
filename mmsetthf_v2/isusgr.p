...
thf(adf_usgr_ax,axiom,(ccusgr = (ccab @ (^ [Xg1:$i] : (cwsbc @ (^ [Xv:$i] : (cwsbc @ (^ [Xe:$i] : (cwf1 @ (ccdm @ (ccv @ Xe)) @ (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cchash) = cc2)) @ (^ [Xx3:$i] : (ccdif @ (ccpw @ (ccv @ Xv)) @ (ccsn @ cc0)))) @ (ccv @ Xe))) @ (ccfv @ (ccv @ Xg1) @ cciedg))) @ (ccfv @ (ccv @ Xg1) @ ccvtx)))))).
...
thf(cisusgr_conj,conjecture,(! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccfv @ XG @ cciedg))) => (! [Xx3:$i] : ((cwcel @ XG @ (XU @ Xx3)) => ((cwcel @ XG @ ccusgr) <=> (cwf1 @ (ccdm @ (XE @ Xx3)) @ (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cchash) = cc2)) @ (^ [Xx3:$i] : (ccdif @ (ccpw @ XV) @ (ccsn @ cc0)))) @ (XE @ Xx3)))))))))))).
