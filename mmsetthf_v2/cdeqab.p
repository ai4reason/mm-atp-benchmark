...
thf(ccdeqab_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwcdeq @ ((Xph @ Xx3 @ Xy1 @ Xz) <=> (Xps @ Xx3 @ Xy1 @ Xz)) @ Xx3 @ Xy1)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwcdeq @ ((ccab @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz))) = (ccab @ (^ [Xz:$i] : (Xps @ Xx3 @ Xy1 @ Xz)))) @ Xx3 @ Xy1))))))).
