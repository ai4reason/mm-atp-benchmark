...
thf(azfinf2_ax,axiom,(? [Xx3:$i] : ((cwcel @ cc0 @ (ccv @ Xx3)) & (cwral @ (^ [Xy1:$i] : (cwcel @ (ccsuc @ (ccv @ Xy1)) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3)))))).
...
thf(apeano5_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ cc0 @ XA2) & (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) => (cwcel @ (ccsuc @ (ccv @ Xx3)) @ XA2))) @ (^ [Xx3:$i] : ccom))) => (cwss @ ccom @ XA2)))).
...
thf(comex_conj,conjecture,(cwcel @ ccom @ ccvv)).
