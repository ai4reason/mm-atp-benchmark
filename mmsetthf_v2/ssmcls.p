...
thf(assmclslem_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : ((XD = (ccfv @ XT @ ccmdv)) => ((XE = (ccfv @ XT @ ccmex)) => ((XC = (ccfv @ XT @ ccmcls)) => ((Xph => (cwcel @ XT @ ccmfs)) => ((Xph => (cwss @ XK @ XD)) => ((Xph => (cwss @ XB2 @ XE)) => ((XH = (ccfv @ XT @ ccmvh)) => (Xph => (cwss @ (ccun @ XB2 @ (ccrn @ XH)) @ (cco @ XK @ XB2 @ XC))))))))))))))))))).
