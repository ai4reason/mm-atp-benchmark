...
thf(aulmcn_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwf @ XZ @ (cco @ XS @ ccc @ cccncf) @ XF)) => ((Xph => (cwbr @ XF @ XG @ (ccfv @ XS @ cculm))) => (Xph => (cwcel @ XG @ (cco @ XS @ ccc @ cccncf)))))))))))))).
