...
thf(achto1lb_ax,axiom,(cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc2 @ ccpnf @ ccico)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ cccht) @ ccdiv))) @ cco1)).
...
thf(achpub_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ cc1 @ XA2 @ ccle)) => (cwbr @ (ccfv @ XA2 @ ccchp) @ (cco @ (ccfv @ XA2 @ cccht) @ (cco @ (ccfv @ XA2 @ ccsqrt) @ (ccfv @ XA2 @ cclog) @ ccmul) @ ccaddc) @ ccle)))).
...
thf(cchpchtlim_conj,conjecture,(cwbr @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc2 @ ccpnf @ ccico)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccchp) @ (ccfv @ (ccv @ Xx3) @ cccht) @ ccdiv))) @ cc1 @ ccrli)).
