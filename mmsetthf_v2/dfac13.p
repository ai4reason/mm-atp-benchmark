...
thf(aacnnum_ax,axiom,(! [XX:($i > $o)] : ((cwcel @ XX @ (cwacn @ (ccpw @ XX))) <=> (cwcel @ XX @ (ccdm @ cccrd))))).
...
thf(adfacacn_ax,axiom,(cwac <=> (! [Xx3:$i] : ((cwacn @ (ccv @ Xx3)) = ccvv)))).
thf(cdfac13_conj,conjecture,(cwac <=> (! [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (cwacn @ (ccv @ Xx3)))))).
