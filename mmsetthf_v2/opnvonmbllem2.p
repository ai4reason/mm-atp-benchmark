...
thf(ahoiqssbl_ax,axiom,(! [Xph:$o] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((Xph => (cwcel @ XY @ (cco @ ccr @ XX @ ccmap))) => ((Xph => (cwcel @ XE @ ccrp)) => (Xph => (cwrex @ (^ [Xc:$i] : (cwrex @ (^ [Xd:$i] : ((cwcel @ XY @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ ccico)))) & (cwss @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ ccico))) @ (cco @ XY @ XE @ (ccfv @ (ccfv @ (ccfv @ XX @ ccrrx) @ ccds) @ ccbl))))) @ (^ [Xd:$i] : (cco @ ccq @ XX @ ccmap)))) @ (^ [Xc:$i] : (cco @ ccq @ XX @ ccmap)))))))))))).
...
thf(aopnvonmbllem1_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xh:$i] : (cwnf @ (^ [Xi:$i] : (Xph @ Xh @ Xi)))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwcel @ XX @ (XV @ Xh @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwf @ XX @ ccq @ (XC @ Xh @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwf @ XX @ ccq @ (XD @ Xh @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwss @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (XC @ Xh @ Xi)) @ (ccfv @ (ccv @ Xi) @ (XD @ Xh @ Xi)) @ ccico))) @ (XB2 @ Xh @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwss @ (XB2 @ Xh @ Xi) @ (XG @ Xi))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwcel @ (XY @ Xi) @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (XC @ Xh @ Xi)) @ (ccfv @ (ccv @ Xi) @ (XD @ Xh @ Xi)) @ ccico))))))) => ((! [Xh:$i] : (! [Xi:$i] : ((XK @ Xh @ Xi) = (ccrab @ (^ [Xh:$i] : (cwss @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (cccom @ ccico @ (ccv @ Xh))))) @ (XG @ Xi))) @ (^ [Xh:$i] : (cco @ (ccxp @ ccq @ ccq) @ XX @ ccmap)))))) => ((! [Xh:$i] : (! [Xi:$i] : ((XH @ Xi) = (ccmpt @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (ccop @ (ccfv @ (ccv @ Xi) @ (XC @ Xh @ Xi)) @ (ccfv @ (ccv @ Xi) @ (XD @ Xh @ Xi)))))))) => (! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwrex @ (^ [Xh:$i] : (cwcel @ (XY @ Xi) @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (cccom @ ccico @ (ccv @ Xh))))))) @ (^ [Xh:$i] : (XK @ Xh @ Xi)))))))))))))))))))))))))).
...
thf(copnvonmbllem2_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((XS = (ccdm @ (ccfv @ XX @ ccvoln))) => ((Xph => (cwcel @ XG @ (ccfv @ (ccfv @ XX @ ccrrx) @ cctopn))) => ((XK = (ccrab @ (^ [Xh:$i] : (cwss @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (cccom @ ccico @ (ccv @ Xh))))) @ XG)) @ (^ [Xh:$i] : (cco @ (ccxp @ ccq @ ccq) @ XX @ ccmap)))) => (Xph => (cwcel @ XG @ XS)))))))))))).
