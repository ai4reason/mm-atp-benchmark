...
thf(cabexssex_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (cwcel @ (ccab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))) @ ccvv)) => (cwcel @ (ccab @ (^ [Xy1:$i] : (? [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) & (Xph @ Xx3 @ Xy1))))) @ ccvv)))))).
