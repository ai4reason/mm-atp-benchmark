...
thf(areslmhm_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XU = (ccfv @ XS @ cclss)) => ((XR = (cco @ XS @ XX @ ccress)) => (((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) & (cwcel @ XX @ XU)) => (cwcel @ (ccres @ XF @ XX) @ (cco @ XR @ XT @ cclmhm)))))))))))).
