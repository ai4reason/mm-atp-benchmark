...
thf(aloglesqrt_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle)) => (cwbr @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cclog) @ (ccfv @ XA2 @ ccsqrt) @ ccle)))).
...
thf(crplogsumlem1_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => (cwbr @ (ccsu @ (cco @ cc2 @ XA2 @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ cclog) @ (cco @ (ccv @ Xn) @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ ccmul) @ ccdiv))) @ cc2 @ ccle)))).
