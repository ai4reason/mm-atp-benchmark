...
thf(arrxmet_ax,axiom,(! [XD:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xh:$i] : ((XX @ Xh) = (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ ccc0 @ ccfsupp)) @ (^ [Xh:$i] : (cco @ ccr @ XI @ ccmap))))) => ((! [Xh:$i] : ((XD @ Xh) = (ccfv @ (ccfv @ XI @ ccrrx) @ ccds))) => (! [Xh:$i] : ((cwcel @ XI @ XV) => (cwcel @ (XD @ Xh) @ (ccfv @ (XX @ Xh) @ ccme))))))))))).
