...
thf(cfiphp3d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : ((Xph => (cwbr @ XA2 @ ccn @ ccen)) => ((Xph => (cwcel @ XB2 @ ccfn)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XD @ Xx3) @ XB2))) => (Xph => (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccrab @ (^ [Xx3:$i] : ((XD @ Xx3) = (ccv @ Xy1))) @ (^ [Xx3:$i] : XA2)) @ ccn @ ccen)) @ (^ [Xy1:$i] : XB2))))))))))).
