...
thf(cqirropth_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccdif @ ccc @ ccq)) @ ((cwcel @ XB2 @ ccq) & (cwcel @ XC @ ccq)) @ ((cwcel @ XD @ ccq) & (cwcel @ XE @ ccq))) => (((cco @ XB2 @ (cco @ XA2 @ XC @ ccmul) @ ccaddc) = (cco @ XD @ (cco @ XA2 @ XE @ ccmul) @ ccaddc)) <=> ((XB2 = XD) & (XC = XE)))))))))).
