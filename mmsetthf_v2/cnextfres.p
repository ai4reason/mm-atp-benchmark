...
thf(aflfcntr_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XC = (ccuni @ XJ)) => ((XB2 = (ccuni @ XK)) => ((Xph => (cwcel @ XJ @ cctop)) => ((Xph => (cwss @ XA2 @ XC)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XJ @ XA2 @ ccrest) @ XK @ cccn))) => ((Xph => (cwcel @ XX @ XA2)) => (Xph => (cwcel @ (ccfv @ XX @ XF) @ (ccfv @ XF @ (cco @ XK @ (cco @ (ccfv @ (ccsn @ XX) @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest) @ ccflf))))))))))))))))))).
