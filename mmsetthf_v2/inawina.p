...
thf(ainawinalem_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cwral @ (^ [Xx3:$i] : (cwbr @ (ccpw @ (ccv @ Xx3)) @ XA2 @ ccsdm)) @ (^ [Xx3:$i] : XA2)) => (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsdm)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
...
thf(aelwina_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccwina) <=> (cw3a @ (cwne @ XA2 @ cc0) @ ((ccfv @ XA2 @ cccf) = XA2) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsdm)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
thf(cinawina_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccina) => (cwcel @ XA2 @ ccwina)))).
