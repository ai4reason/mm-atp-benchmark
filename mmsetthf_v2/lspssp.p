...
thf(clspssp_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XS = (ccfv @ XW @ cclss)) => ((XN = (ccfv @ XW @ cclspn)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XU @ XS) @ (cwss @ XT @ XU)) => (cwss @ (ccfv @ XT @ XN) @ XU)))))))))).
