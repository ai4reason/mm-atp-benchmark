...
thf(analset_ax,axiom,(~ (? [Xx3:$i] : (! [Xy1:$i] : (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)))))).
...
thf(ckmlem2_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xw:$i] : ((? [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((Xph @ Xz @ Xw) => (cweu @ (^ [Xw:$i] : (cwcel @ (ccv @ Xw) @ (ccin @ (ccv @ Xz) @ (ccv @ Xy1))))))) @ (^ [Xz:$i] : (ccv @ Xx3)))) <=> (? [Xy1:$i] : ((~ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))) & (cwral @ (^ [Xz:$i] : ((Xph @ Xz @ Xw) => (cweu @ (^ [Xw:$i] : (cwcel @ (ccv @ Xw) @ (ccin @ (ccv @ Xz) @ (ccv @ Xy1))))))) @ (^ [Xz:$i] : (ccv @ Xx3)))))))))).
