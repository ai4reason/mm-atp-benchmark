...
thf(apm2_61ddan_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xth) => (((Xph & Xch) => Xth) => (((Xph & ((~ Xps) & (~ Xch))) => Xth) => (Xph => Xth))))))))).
...
thf(algsdir2lem4_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) & (cwcel @ (cco @ XA2 @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7))) => ((cwcel @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)) <=> (cwcel @ (cco @ XB2 @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7))))))).
...
thf(algsdir2lem5_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) & ((cwcel @ (cco @ XA2 @ cc8 @ ccmo) @ (ccpr @ cc3 @ cc5)) & (cwcel @ (cco @ XB2 @ cc8 @ ccmo) @ (ccpr @ cc3 @ cc5)))) => (cwcel @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)))))).
...
thf(clgsdir2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ cc2 @ cclgs) = (cco @ (cco @ XA2 @ cc2 @ cclgs) @ (cco @ XB2 @ cc2 @ cclgs) @ ccmul)))))).
