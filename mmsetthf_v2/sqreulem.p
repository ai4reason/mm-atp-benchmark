...
thf(csqreulem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XB2 = (cco @ (ccfv @ (ccfv @ XA2 @ ccabs) @ ccsqrt) @ (cco @ (cco @ (ccfv @ XA2 @ ccabs) @ XA2 @ ccaddc) @ (ccfv @ (cco @ (ccfv @ XA2 @ ccabs) @ XA2 @ ccaddc) @ ccabs) @ ccdiv) @ ccmul)) => (((cwcel @ XA2 @ ccc) & (cwne @ (cco @ (ccfv @ XA2 @ ccabs) @ XA2 @ ccaddc) @ ccc0)) => (cw3a @ ((cco @ XB2 @ cc2 @ ccexp) = XA2) @ (cwbr @ ccc0 @ (ccfv @ XB2 @ ccre) @ ccle) @ (cwnel @ (cco @ cci @ XB2 @ ccmul) @ ccrp))))))).
