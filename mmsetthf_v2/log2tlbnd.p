...
thf(alog2cnv_ax,axiom,(! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ cc2 @ (cco @ (cco @ cc3 @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccmul) @ (cco @ cc9 @ (ccv @ Xn) @ ccexp) @ ccmul) @ ccdiv))))) => (! [Xn:$i] : (cwbr @ (ccseq @ ccaddc @ (XF @ Xn) @ ccc0) @ (ccfv @ cc2 @ cclog) @ ccli))))).
...
thf(adivdivdivi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwcel @ XC @ ccc) => ((cwcel @ XD @ ccc) => ((cwne @ XB2 @ ccc0) => ((cwne @ XD @ ccc0) => ((cwne @ XC @ ccc0) => ((cco @ (cco @ XA2 @ XB2 @ ccdiv) @ (cco @ XC @ XD @ ccdiv) @ ccdiv) = (cco @ (cco @ XA2 @ XD @ ccmul) @ (cco @ XB2 @ XC @ ccmul) @ ccdiv)))))))))))))).
