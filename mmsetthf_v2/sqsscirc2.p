...
thf(asqsscirc1_ax,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((((cwcel @ XX @ ccr) & (cwbr @ ccc0 @ XX @ ccle)) & ((cwcel @ XY @ ccr) & (cwbr @ ccc0 @ XY @ ccle))) & (cwcel @ XD @ ccrp)) => (((cwbr @ XX @ (cco @ XD @ cc2 @ ccdiv) @ cclt) & (cwbr @ XY @ (cco @ XD @ cc2 @ ccdiv) @ cclt)) => (cwbr @ (ccfv @ (cco @ (cco @ XX @ cc2 @ ccexp) @ (cco @ XY @ cc2 @ ccexp) @ ccaddc) @ ccsqrt) @ XD @ cclt))))))).
thf(abitr4d_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps <=> Xch)) => ((Xph => (Xth <=> Xch)) => (Xph => (Xps <=> Xth))))))))).
thf(abreq1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cwbr @ XA2 @ XC @ XR) <=> (cwbr @ XB2 @ XC @ XR)))))))))).
thf(aabsval2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => (Xph => ((ccfv @ XA2 @ ccabs) = (ccfv @ (cco @ (cco @ (ccfv @ XA2 @ ccre) @ cc2 @ ccexp) @ (cco @ (ccfv @ XA2 @ ccim) @ cc2 @ ccexp) @ ccaddc) @ ccsqrt))))))).
