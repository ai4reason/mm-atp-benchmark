...
thf(crmydbl_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccz)) => ((cco @ XA2 @ (cco @ cc2 @ XN @ ccmul) @ ccrmy) = (cco @ (cco @ cc2 @ (cco @ XA2 @ XN @ ccrmx) @ ccmul) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul)))))).
