...
thf(anppcan3d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => (Xph => ((cco @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XB2 @ ccaddc) @ ccaddc) = (cco @ XA2 @ XC @ ccaddc))))))))))).
thf(aoveq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))))).
thf(a_3eqtr4d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XA2)) => ((Xph => (XD = XB2)) => (Xph => (XC = XD))))))))))).
thf(afsumfldivdiag_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : ((Xph => (cwcel @ XA2 @ ccr)) => ((! [Xm:$i] : (! [Xn:$i] : ((Xph & ((cwcel @ (ccv @ Xn) @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz)) & (cwcel @ (ccv @ Xm) @ (cco @ cc1 @ (ccfv @ (cco @ XA2 @ (ccv @ Xn) @ ccdiv) @ ccfl) @ ccfz)))) => (cwcel @ (XB2 @ Xm @ Xn) @ ccc)))) => (Xph => ((ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xn:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (cco @ XA2 @ (ccv @ Xn) @ ccdiv) @ ccfl) @ ccfz) @ (^ [Xm:$i] : (XB2 @ Xm @ Xn))))) = (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xm:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (cco @ XA2 @ (ccv @ Xm) @ ccdiv) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (XB2 @ Xm @ Xn))))))))))))).
...
thf(aselberg4lem1_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : ((! [Xy1:$i] : (! [Xi:$i] : ((Xph @ Xy1 @ Xi) => (cwcel @ XA2 @ ccrp)))) => ((! [Xy1:$i] : (! [Xi:$i] : ((Xph @ Xy1 @ Xi) => (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xy1) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul))) @ (ccv @ Xy1) @ ccdiv) @ (cco @ cc2 @ (ccfv @ (ccv @ Xy1) @ cclog) @ ccmul) @ ccmin) @ ccabs) @ XA2 @ ccle)) @ (^ [Xy1:$i] : (cco @ cc1 @ ccpnf @ ccico)))))) => (! [Xy1:$i] : (! [Xi:$i] : ((Xph @ Xy1 @ Xi) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccsu @ (cco @ cc1 @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ ccfl) @ ccfz) @ (^ [Xm:$i] : (cco @ (ccfv @ (ccv @ Xm) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xm) @ cclog) @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ (ccv @ Xm) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul))) @ ccmul))) @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ ccdiv) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmin))) @ cco1))))))))).
