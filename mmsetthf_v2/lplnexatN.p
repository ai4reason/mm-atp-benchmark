...
thf(clplnexatN_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((! [Xq:$i] : ((Xc_or @ Xq) = (ccfv @ XK @ ccjn))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xq:$i] : ((XN @ Xq) = (ccfv @ XK @ cclln))) => ((! [Xq:$i] : ((XP @ Xq) = (ccfv @ XK @ cclpl))) => (! [Xq:$i] : (((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ (XP @ Xq)) @ (cwcel @ XY @ (XN @ Xq))) & (cwbr @ XY @ XX @ Xc_le)) => (cwrex @ (^ [Xq:$i] : ((~ (cwbr @ (ccv @ Xq) @ XY @ Xc_le)) & (XX = (cco @ XY @ (ccv @ Xq) @ (Xc_or @ Xq))))) @ (^ [Xq:$i] : XA2)))))))))))))))))).
