...
thf(afrlmbasfsupp_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XF = (cco @ XR @ XI @ ccfrlm)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XB2 = (ccfv @ XF @ ccbs)) => (((cwcel @ XI @ XW) & (cwcel @ XX @ XB2)) => (cwbr @ XX @ Xc_0 @ ccfsupp))))))))))))).
...
thf(afrlmvscaval_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XR @ XI @ ccfrlm)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XA2 @ XK)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XJ @ XI)) => ((Xc_xb = (ccfv @ XY @ ccvsca)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (Xph => ((ccfv @ XJ @ (cco @ XA2 @ XX @ Xc_xb)) = (cco @ XA2 @ (ccfv @ XJ @ XX) @ Xc_x))))))))))))))))))))))))).
thf(asimplrr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & (Xps & Xch)) & Xth) => Xch)))))).
thf(cfrlmup1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XF = (cco @ XR @ XI @ ccfrlm)) => ((XB2 = (ccfv @ XF @ ccbs)) => ((XC = (ccfv @ XT @ ccbs)) => ((Xc_x = (ccfv @ XT @ ccvsca)) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ XT @ (cco @ (ccv @ Xx3) @ XA2 @ (ccof @ Xc_x)) @ ccgsu))))) => ((Xph => (cwcel @ XT @ cclmod)) => ((Xph => (cwcel @ XI @ XX)) => ((Xph => (XR = (ccfv @ XT @ ccsca))) => ((Xph => (cwf @ XI @ XC @ XA2)) => (! [Xx3:$i] : (Xph => (cwcel @ (XE @ Xx3) @ (cco @ XF @ XT @ cclmhm))))))))))))))))))))))))).
