...
thf(cdissnlocfin_conj,conjecture,(! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XC = (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xu) = (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XX))))) => ((cwcel @ XX @ XV) => (cwcel @ XC @ (ccfv @ (ccpw @ XX) @ cclocfin)))))))).
