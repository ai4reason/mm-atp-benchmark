...
thf(aspansncv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ cchil)) => (((cwpss @ XA2 @ XB2) & (cwss @ XB2 @ (cco @ XA2 @ (ccfv @ (ccsn @ XC) @ ccspn) @ cchj))) => (XB2 = (cco @ XA2 @ (ccfv @ (ccsn @ XC) @ ccspn) @ cchj)))))))).
