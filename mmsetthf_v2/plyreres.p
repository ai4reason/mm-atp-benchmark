...
thf(afnssresb_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ XA2) => ((cwfn @ (ccres @ XF @ XB2) @ XB2) <=> (cwss @ XB2 @ XA2))))))).
...
thf(aplyrecj_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ (ccfv @ ccr @ ccply)) & (cwcel @ XA2 @ ccc)) => ((ccfv @ (ccfv @ XA2 @ XF) @ cccj) = (ccfv @ (ccfv @ XA2 @ cccj) @ XF)))))).
...
thf(cplyreres_conj,conjecture,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccfv @ ccr @ ccply)) => (cwf @ ccr @ ccr @ (ccres @ XF @ ccr))))).
