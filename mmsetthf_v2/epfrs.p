...
thf(atz9_1_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (? [Xx3:$i] : (cw3a @ (cwss @ XA2 @ (ccv @ Xx3)) @ (cwtr @ (ccv @ Xx3)) @ (! [Xy1:$i] : (((cwss @ XA2 @ (ccv @ Xy1)) & (cwtr @ (ccv @ Xy1))) => (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))))))))).
thf(ccpr_tp,type,(ccpr : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(asnex_ax,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccsn @ XA2) @ ccvv))).
thf(cepfrs_conj,conjecture,(! [XA2:($i > $o)] : (((cwfr @ XA2 @ ccep) & (cwne @ XA2 @ cc0)) => (cwrex @ (^ [Xx3:$i] : ((ccin @ (ccv @ Xx3) @ XA2) = cc0)) @ (^ [Xx3:$i] : XA2))))).
