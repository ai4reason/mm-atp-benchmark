...
thf(adf_itg_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((ccitg @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (ccsu @ (cco @ ccc0 @ cc3 @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ cci @ (ccv @ Xk) @ ccexp) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccsb @ (ccfv @ (cco @ (XB2 @ Xx3) @ (cco @ cci @ (ccv @ Xk) @ ccexp) @ ccdiv) @ ccre) @ (^ [Xy1:$i] : (ccif @ ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) & (cwbr @ ccc0 @ (ccv @ Xy1) @ ccle)) @ (ccv @ Xy1) @ ccc0))))) @ ccitg2) @ ccmul))))))).
