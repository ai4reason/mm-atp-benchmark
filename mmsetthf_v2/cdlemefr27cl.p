...
thf(ccdlemefr27cl_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > ($i > $o))] : (! [Xc_an:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xs1:$i] : ((XB2 @ Xs1) = (ccfv @ (XK @ Xs1) @ ccbs))) => ((! [Xs1:$i] : ((Xc_le @ Xs1) = (ccfv @ (XK @ Xs1) @ ccple))) => ((! [Xs1:$i] : ((Xc_or @ Xs1) = (ccfv @ (XK @ Xs1) @ ccjn))) => ((! [Xs1:$i] : ((Xc_an @ Xs1) = (ccfv @ (XK @ Xs1) @ ccmee))) => ((! [Xs1:$i] : ((XA2 @ Xs1) = (ccfv @ (XK @ Xs1) @ ccatm))) => ((! [Xs1:$i] : ((XH @ Xs1) = (ccfv @ (XK @ Xs1) @ cclh))) => ((! [Xs1:$i] : ((XU @ Xs1) = (cco @ (cco @ (XP @ Xs1) @ (XQ @ Xs1) @ (Xc_or @ Xs1)) @ (XW @ Xs1) @ (Xc_an @ Xs1)))) => ((! [Xs1:$i] : ((XC @ Xs1) = (cco @ (cco @ (ccv @ Xs1) @ (XU @ Xs1) @ (Xc_or @ Xs1)) @ (cco @ (XQ @ Xs1) @ (cco @ (cco @ (XP @ Xs1) @ (ccv @ Xs1) @ (Xc_or @ Xs1)) @ (XW @ Xs1) @ (Xc_an @ Xs1)) @ (Xc_or @ Xs1)) @ (Xc_an @ Xs1)))) => ((! [Xs1:$i] : ((XN @ Xs1) = (ccif @ (cwbr @ (ccv @ Xs1) @ (cco @ (XP @ Xs1) @ (XQ @ Xs1) @ (Xc_or @ Xs1)) @ (Xc_le @ Xs1)) @ (XI @ Xs1) @ (XC @ Xs1)))) => (! [Xs1:$i] : (((cw3a @ ((cwcel @ (XK @ Xs1) @ cchlt) & (cwcel @ (XW @ Xs1) @ (XH @ Xs1))) @ (cwcel @ (XP @ Xs1) @ (XA2 @ Xs1)) @ (cwcel @ (XQ @ Xs1) @ (XA2 @ Xs1))) & (cw3a @ (cwcel @ (ccv @ Xs1) @ (XA2 @ Xs1)) @ (~ (cwbr @ (ccv @ Xs1) @ (cco @ (XP @ Xs1) @ (XQ @ Xs1) @ (Xc_or @ Xs1)) @ (Xc_le @ Xs1))) @ (cwne @ (XP @ Xs1) @ (XQ @ Xs1)))) => (cwcel @ (XN @ Xs1) @ (XB2 @ Xs1)))))))))))))))))))))))))))).
