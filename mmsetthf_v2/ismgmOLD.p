...
thf(adf_mgmOLD_ax,axiom,(ccmagm = (ccab @ (^ [Xg1:$i] : (? [Xt:$i] : (cwf @ (ccxp @ (ccv @ Xt) @ (ccv @ Xt)) @ (ccv @ Xt) @ (ccv @ Xg1))))))).
...
thf(cismgmOLD_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ (ccdm @ XG))) => ((cwcel @ XG @ XA2) => ((cwcel @ XG @ ccmagm) <=> (cwf @ (ccxp @ XX @ XX) @ XX @ XG)))))))).
