...
thf(afilin_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwcel @ XA2 @ XF) @ (cwcel @ XB2 @ XF)) => (cwcel @ (ccin @ XA2 @ XB2) @ XF))))))).
...
thf(aad5ant24_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (((Xph & Xps) => Xch) => (((((Xth & Xph) & Xta) & Xps) & Xet) => Xch))))))))).
thf(cwfun_tp,type,(cwfun : (($i > $o) > $o))).
thf(cclt_tp,type,(cclt : ($i > $o))).
thf(cwbr_tp,type,(cwbr : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(cwrel_tp,type,(cwrel : (($i > $o) > $o))).
thf(ametustid_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico)))))) => (((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) & (cwcel @ XA2 @ XF)) => (cwss @ (ccres @ ccid @ XX) @ XA2)))))))).
...
thf(ametustsym_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico)))))) => (((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) & (cwcel @ XA2 @ XF)) => ((cccnv @ XA2) = XA2)))))))).
...
thf(ametustexhalf_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico)))))) => ((((cwne @ XX @ cc0) & (cwcel @ XD @ (ccfv @ XX @ ccpsmet))) & (cwcel @ XA2 @ XF)) => (cwrex @ (^ [Xv:$i] : (cwss @ (cccom @ (ccv @ Xv) @ (ccv @ Xv)) @ XA2)) @ (^ [Xv:$i] : XF))))))))).
...
thf(cmetust_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico)))))) => (((cwne @ XX @ cc0) & (cwcel @ XD @ (ccfv @ XX @ ccpsmet))) => (cwcel @ (cco @ (ccxp @ XX @ XX) @ XF @ ccfg) @ (ccfv @ XX @ ccust)))))))).
