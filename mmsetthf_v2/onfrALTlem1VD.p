...
thf(acbvexsv_ax,axiom,(! [Xph:($i > $o)] : ((? [Xx3:$i] : (Xph @ Xx3)) <=> (? [Xy1:$i] : (cwsb @ (^ [Xx3:$i] : (Xph @ Xx3)) @ Xy1))))).
...
thf(aonfrALTlem4_ax,axiom,(! [Xa:$i] : (! [Xy1:$i] : ((cwsbc @ (^ [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xa)) & ((ccin @ (ccv @ Xa) @ (ccv @ Xx3)) = cc0))) @ (ccv @ Xy1)) <=> ((cwcel @ (ccv @ Xy1) @ (ccv @ Xa)) & ((ccin @ (ccv @ Xa) @ (ccv @ Xy1)) = cc0)))))).
...
thf(confrALTlem1VD_conj,conjecture,(! [Xa:$i] : (! [Xx3:$i] : (cwvd2 @ ((cwss @ (ccv @ Xa) @ ccon0) & (cwne @ (ccv @ Xa) @ cc0)) @ ((cwcel @ (ccv @ Xx3) @ (ccv @ Xa)) & ((ccin @ (ccv @ Xa) @ (ccv @ Xx3)) = cc0)) @ (cwrex @ (^ [Xy1:$i] : ((ccin @ (ccv @ Xa) @ (ccv @ Xy1)) = cc0)) @ (^ [Xy1:$i] : (ccv @ Xa))))))).
