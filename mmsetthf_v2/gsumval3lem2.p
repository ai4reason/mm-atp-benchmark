...
thf(asupp0cosupp0_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XF @ XV) & (cwcel @ XG @ XW)) => (((cco @ XF @ XZ @ ccsupp) = cc0) => ((cco @ (cccom @ XF @ XG) @ XZ @ ccsupp) = cc0))))))))).
...
thf(cgsumval3lem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((XB2 = (ccfv @ XG @ ccbs)) => ((! [Xf1:$i] : ((Xc_0 @ Xf1) = (ccfv @ XG @ cc0g))) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((! [Xf1:$i] : ((XZ @ Xf1) = (ccfv @ XG @ cccntz))) => ((Xph => (cwcel @ XG @ ccmnd)) => ((! [Xf1:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xf1)))) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((! [Xf1:$i] : (Xph => (cwss @ (ccrn @ XF) @ (ccfv @ (ccrn @ XF) @ (XZ @ Xf1))))) => ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwf1 @ (cco @ cc1 @ XM @ ccfz) @ XA2 @ XH)) => ((! [Xf1:$i] : (Xph => (cwss @ (cco @ XF @ (Xc_0 @ Xf1) @ ccsupp) @ (ccrn @ XH)))) => ((! [Xf1:$i] : (XW = (cco @ (cccom @ XF @ XH) @ (Xc_0 @ Xf1) @ ccsupp))) => (! [Xf1:$i] : (((Xph & (cwne @ XW @ cc0)) & ((~ (cwcel @ XA2 @ (ccrn @ ccfz))) & (cwiso @ (cco @ cc1 @ (ccfv @ XW @ cchash) @ ccfz) @ XW @ cclt @ cclt @ (ccv @ Xf1)))) => ((cco @ XG @ XF @ ccgsu) = (ccfv @ (ccfv @ XW @ cchash) @ (ccseq @ Xc_pl @ (cccom @ XF @ (cccom @ XH @ (ccv @ Xf1))) @ cc1)))))))))))))))))))))))))))))).
