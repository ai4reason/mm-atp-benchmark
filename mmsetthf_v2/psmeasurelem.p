...
thf(apwpwuni_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XA2 @ (ccpw @ (ccpw @ XB2))) <=> (cwcel @ (ccuni @ XA2) @ (ccpw @ XB2)))))))).
