...
thf(caxlowdimlem14_conj,conjecture,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((XQ = (ccun @ (ccsn @ (ccop @ (cco @ XI @ cc1 @ ccaddc) @ cc1)) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (cco @ XI @ cc1 @ ccaddc))) @ (ccsn @ ccc0)))) => ((XR = (ccun @ (ccsn @ (ccop @ (cco @ XJ @ cc1 @ ccaddc) @ cc1)) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (cco @ XJ @ cc1 @ ccaddc))) @ (ccsn @ ccc0)))) => ((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XI @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (cwcel @ XJ @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) => ((XQ = XR) => (XI = XJ))))))))))).
