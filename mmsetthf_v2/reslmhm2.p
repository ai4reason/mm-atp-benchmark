...
thf(aresghm2_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XT @ XX @ ccress)) => (((cwcel @ XF @ (cco @ XS @ XU @ ccghm)) & (cwcel @ XX @ (ccfv @ XT @ ccsubg))) => (cwcel @ XF @ (cco @ XS @ XT @ ccghm)))))))))).
...
thf(creslmhm2_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XT @ XX @ ccress)) => ((XL = (ccfv @ XT @ cclss)) => ((cw3a @ (cwcel @ XF @ (cco @ XS @ XU @ cclmhm)) @ (cwcel @ XT @ cclmod) @ (cwcel @ XX @ XL)) => (cwcel @ XF @ (cco @ XS @ XT @ cclmhm)))))))))))).
