...
thf(algamucov2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xk:$i] : (! [Xr:$i] : ((XU @ Xx3 @ Xk @ Xr) = (ccrab @ (^ [Xx3:$i] : ((cwbr @ (ccfv @ (ccv @ Xx3) @ ccabs) @ (ccv @ Xr) @ ccle) & (cwral @ (^ [Xk:$i] : (cwbr @ (cco @ cc1 @ (ccv @ Xr) @ ccdiv) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xk) @ ccaddc) @ ccabs) @ ccle)) @ (^ [Xk:$i] : ccn0)))) @ (^ [Xx3:$i] : ccc)))))) => ((Xph => (cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn)))) => (! [Xx3:$i] : (! [Xk:$i] : (Xph => (cwrex @ (^ [Xr:$i] : (cwcel @ XA2 @ (XU @ Xx3 @ Xk @ Xr))) @ (^ [Xr:$i] : ccn))))))))))).
...
thf(clgamcvglem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xk:$i] : (! [Xr:$i] : ((XU @ Xx3 @ Xk @ Xr) = (ccrab @ (^ [Xx3:$i] : ((cwbr @ (ccfv @ (ccv @ Xx3) @ ccabs) @ (ccv @ Xr) @ ccle) & (cwral @ (^ [Xk:$i] : (cwbr @ (cco @ cc1 @ (ccv @ Xr) @ ccdiv) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xk) @ ccaddc) @ ccabs) @ ccle)) @ (^ [Xk:$i] : ccn0)))) @ (^ [Xx3:$i] : ccc)))))) => ((Xph => (cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn)))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xm:$i] : ((XG @ Xx3 @ Xk @ Xm) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (cco @ (cco @ XA2 @ (ccfv @ (cco @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc) @ (ccv @ Xm) @ ccdiv) @ cclog) @ ccmul) @ (ccfv @ (cco @ (cco @ XA2 @ (ccv @ Xm) @ ccdiv) @ cc1 @ ccaddc) @ cclog) @ ccmin))))))) => (! [Xx3:$i] : (! [Xk:$i] : (! [Xm:$i] : (Xph => ((cwcel @ (ccfv @ XA2 @ cclgam) @ ccc) & (cwbr @ (ccseq @ ccaddc @ (XG @ Xx3 @ Xk @ Xm) @ cc1) @ (cco @ (ccfv @ XA2 @ cclgam) @ (ccfv @ XA2 @ cclog) @ ccaddc) @ ccli)))))))))))))).
