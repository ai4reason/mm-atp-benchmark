...
thf(aclmnegneg_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => (((cwcel @ XW @ ccclm) & (cwcel @ XA2 @ XV)) => ((cco @ (ccneg @ cc1) @ (cco @ (ccneg @ cc1) @ XA2 @ Xc_x) @ Xc_x) = XA2))))))))))).
...
thf(cclmnegsubdi2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => ((cw3a @ (cwcel @ XW @ ccclm) @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV)) => ((cco @ (ccneg @ cc1) @ (cco @ XA2 @ (cco @ (ccneg @ cc1) @ XB2 @ Xc_x) @ Xc_pl) @ Xc_x) = (cco @ XB2 @ (cco @ (ccneg @ cc1) @ XA2 @ Xc_x) @ Xc_pl))))))))))))).
