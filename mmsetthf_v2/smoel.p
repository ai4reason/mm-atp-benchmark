...
thf(asmodm_ax,axiom,(! [XA2:($i > $o)] : ((cwsmo @ XA2) => (cword @ (ccdm @ XA2))))).
...
thf(adf_smo_ax,axiom,(! [XA2:($i > $o)] : ((cwsmo @ XA2) <=> (cw3a @ (cwf @ (ccdm @ XA2) @ ccon0 @ XA2) @ (cword @ (ccdm @ XA2)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XA2) @ (ccfv @ (ccv @ Xy1) @ XA2)))) @ (^ [Xy1:$i] : (ccdm @ XA2)))) @ (^ [Xx3:$i] : (ccdm @ XA2))))))).
...
thf(csmoel_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwsmo @ XB2) @ (cwcel @ XA2 @ (ccdm @ XB2)) @ (cwcel @ XC @ XA2)) => (cwcel @ (ccfv @ XC @ XB2) @ (ccfv @ XA2 @ XB2))))))).
