...
thf(amdsymlem7_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((! [Xp:$i] : ((XC @ Xp) = (cco @ XA2 @ (ccv @ Xp) @ cchj))) => (((cwne @ XA2 @ cc0h) & (cwne @ XB2 @ cc0h)) => ((cwbr @ XB2 @ XA2 @ ccdmd) <=> (cwral @ (^ [Xp:$i] : ((cwss @ (ccv @ Xp) @ (cco @ XA2 @ XB2 @ cchj)) => (cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : ((cwss @ (ccv @ Xp) @ (cco @ (ccv @ Xq) @ (ccv @ Xr) @ cchj)) & ((cwss @ (ccv @ Xq) @ XA2) & (cwss @ (ccv @ Xr) @ XB2)))) @ (^ [Xr:$i] : ccat))) @ (^ [Xq:$i] : ccat)))) @ (^ [Xp:$i] : ccat))))))))))).
thf(aancoms_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) => Xch) => ((Xps & Xph) => Xch)))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(cmdsymlem8_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((! [Xp:$i] : ((XC @ Xp) = (cco @ XA2 @ (ccv @ Xp) @ cchj))) => (((cwne @ XA2 @ cc0h) & (cwne @ XB2 @ cc0h)) => ((cwbr @ XB2 @ XA2 @ ccdmd) <=> (cwbr @ XA2 @ XB2 @ ccdmd)))))))))).
