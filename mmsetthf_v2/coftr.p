...
thf(aordtr2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cword @ XA2) & (cword @ XC)) => (((cwss @ XA2 @ XB2) & (cwcel @ XB2 @ XC)) => (cwcel @ XA2 @ XC))))))).
...
thf(asmoword_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((((cwfn @ XF @ XA2) & (cwsmo @ XF)) & ((cwcel @ XC @ XA2) & (cwcel @ XD @ XA2))) => ((cwss @ XC @ XD) <=> (cwss @ (ccfv @ XC @ XF) @ (ccfv @ XD @ XF))))))))).
