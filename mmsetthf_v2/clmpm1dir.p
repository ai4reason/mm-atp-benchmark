...
thf(aclmsubdir_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_mi = (ccfv @ XW @ ccsg)) => ((Xph => (cwcel @ XW @ ccclm)) => ((Xph => (cwcel @ XA2 @ XK)) => ((Xph => (cwcel @ XB2 @ XK)) => ((Xph => (cwcel @ XX @ XV)) => (Xph => ((cco @ (cco @ XA2 @ XB2 @ ccmin) @ XX @ Xc_x) = (cco @ (cco @ XA2 @ XX @ Xc_x) @ (cco @ XB2 @ XX @ Xc_x) @ Xc_mi))))))))))))))))))))))).
...
thf(cclmpm1dir_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => ((XK = (ccfv @ (ccfv @ XW @ ccsca) @ ccbs)) => (((cwcel @ XW @ ccclm) & (cw3a @ (cwcel @ XA2 @ XK) @ (cwcel @ XB2 @ XK) @ (cwcel @ XC @ XV))) => ((cco @ (cco @ XA2 @ XB2 @ ccmin) @ XC @ Xc_x) = (cco @ (cco @ XA2 @ XC @ Xc_x) @ (cco @ (ccneg @ cc1) @ (cco @ XB2 @ XC @ Xc_x) @ Xc_x) @ Xc_pl)))))))))))))))).
