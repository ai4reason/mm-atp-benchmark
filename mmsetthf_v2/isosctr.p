...
thf(cisosctr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccdiv) @ cclog) @ ccim))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) @ (cw3a @ (cwne @ XA2 @ XC) @ (cwne @ XB2 @ XC) @ (cwne @ XA2 @ XB2)) @ ((ccfv @ (cco @ XA2 @ XC @ ccmin) @ ccabs) = (ccfv @ (cco @ XB2 @ XC @ ccmin) @ ccabs))) => ((cco @ (cco @ XC @ XA2 @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ (XF @ Xx3 @ Xy1)) = (cco @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XB2 @ ccmin) @ (XF @ Xx3 @ Xy1)))))))))))).
