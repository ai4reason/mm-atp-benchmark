...
thf(anfiota_ax,axiom,(! [Xph:($i > ($i > $o))] : ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))) => (cwnfc @ (^ [Xx3:$i] : (ccio @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))))))).
...
thf(cnfsum_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xk)))) => ((! [Xk:$i] : (cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xk)))) => (! [Xk:$i] : (cwnfc @ (^ [Xx3:$i] : (ccsu @ (XA2 @ Xx3 @ Xk) @ (^ [Xk:$i] : (XB2 @ Xx3 @ Xk))))))))))).
