...
thf(aqtopss_ax,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn)) @ (cwcel @ XK @ (ccfv @ XY @ cctopon)) @ ((ccrn @ XF) = XY)) => (cwss @ XK @ (cco @ XJ @ XF @ ccqtop)))))))).
...
thf(cqtopomap_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((Xph => ((ccrn @ XF) = XY)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XJ)) => (cwcel @ (ccima @ XF @ (ccv @ Xx3)) @ XK))) => (Xph => (XK = (cco @ XJ @ XF @ ccqtop))))))))))))).
