...
thf(cfzonfzoufzol_conj,conjecture,(! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XM @ ccz) @ (cwbr @ XM @ XN @ cclt) @ (cwcel @ XI @ (cco @ ccc0 @ XN @ ccfzo))) => ((~ (cwcel @ XI @ (cco @ (cco @ XN @ XM @ ccmin) @ XN @ ccfzo))) => (cwcel @ XI @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfzo)))))))).
