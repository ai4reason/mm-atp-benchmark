...
thf(advadd_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwf @ XX @ ccc @ XF)) => ((Xph => (cwss @ XX @ XS)) => ((Xph => (cwf @ XY @ ccc @ XG)) => ((Xph => (cwss @ XY @ XS)) => ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwcel @ XC @ (ccdm @ (cco @ XS @ XF @ ccdv)))) => ((Xph => (cwcel @ XC @ (ccdm @ (cco @ XS @ XG @ ccdv)))) => (Xph => ((ccfv @ XC @ (cco @ XS @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ ccdv)) = (cco @ (ccfv @ XC @ (cco @ XS @ XF @ ccdv)) @ (ccfv @ XC @ (cco @ XS @ XG @ ccdv)) @ ccaddc)))))))))))))))))).
thf(cdvaddf_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwf @ XX @ ccc @ XF)) => ((Xph => (cwf @ XX @ ccc @ XG)) => ((Xph => ((ccdm @ (cco @ XS @ XF @ ccdv)) = XX)) => ((Xph => ((ccdm @ (cco @ XS @ XG @ ccdv)) = XX)) => (Xph => ((cco @ XS @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ ccdv) = (cco @ (cco @ XS @ XF @ ccdv) @ (cco @ XS @ XG @ ccdv) @ (ccof @ ccaddc))))))))))))))).
