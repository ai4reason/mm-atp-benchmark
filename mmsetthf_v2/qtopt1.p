...
thf(cqtopt1_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : ((XX @ Xx3) = (ccuni @ XJ))) => ((Xph => (cwcel @ XJ @ cct1)) => ((! [Xx3:$i] : (Xph => (cwfo @ (XX @ Xx3) @ (XY @ Xx3) @ XF))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (XY @ Xx3))) => (cwcel @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xx3))) @ (ccfv @ XJ @ cccld)))) => (Xph => (cwcel @ (cco @ XJ @ XF @ ccqtop) @ cct1)))))))))))).
