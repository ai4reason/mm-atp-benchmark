...
thf(arepsw0_ax,axiom,(! [XS:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XS @ XV) => ((cco @ XS @ ccc0 @ ccreps) = cc0))))).
...
thf(arepsundef_ax,axiom,(! [XS:($i > $o)] : (! [XN:($i > $o)] : ((cwnel @ XN @ ccn0) => ((cco @ XS @ XN @ ccreps) = cc0))))).
...
thf(crepswswrd_conj,conjecture,(! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ ((cwcel @ XS @ XV) & (cwcel @ XL @ ccn0)) @ ((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) @ (cwbr @ XN @ XL @ ccle)) => ((cco @ (cco @ XS @ XL @ ccreps) @ (ccop @ XM @ XN) @ ccsubstr) = (cco @ XS @ (cco @ XN @ XM @ ccmin) @ ccreps))))))))).
