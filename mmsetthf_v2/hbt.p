...
thf(alnrring_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ cclnr) => (cwcel @ XA2 @ ccrg)))).
...
thf(aislnr3_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XU = (ccfv @ XR @ cclidl)) => ((cwcel @ XR @ cclnr) <=> ((cwcel @ XR @ ccrg) & (cwcel @ XU @ (ccfv @ XB2 @ ccnacs)))))))))).
...
thf(ahbtlem7_ax,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XU = (ccfv @ XP @ cclidl)) => ((XS = (ccfv @ XR @ ccldgis)) => ((XT = (ccfv @ XR @ cclidl)) => (((cwcel @ XR @ ccrg) & (cwcel @ XI @ XU)) => (cwf @ ccn0 @ XT @ (ccfv @ XI @ XS)))))))))))))).
...
thf(ahbtlem4_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XU = (ccfv @ XP @ cclidl)) => ((XS = (ccfv @ XR @ ccldgis)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XI @ XU)) => ((Xph => (cwcel @ XX @ ccn0)) => ((Xph => (cwcel @ XY @ ccn0)) => ((Xph => (cwbr @ XX @ XY @ ccle)) => (Xph => (cwss @ (ccfv @ XX @ (ccfv @ XI @ XS)) @ (ccfv @ XY @ (ccfv @ XI @ XS))))))))))))))))))))).
...
thf(anacsfix_ax,axiom,(! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xx3:$i] : ((cw3a @ (cwcel @ (XC @ Xx3) @ (ccfv @ (XX @ Xx3) @ ccnacs)) @ (cwf @ ccn0 @ (XC @ Xx3) @ XF) @ (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XF))) @ (^ [Xx3:$i] : ccn0))) => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((ccfv @ (ccv @ Xz) @ XF) = (ccfv @ (ccv @ Xy1) @ XF))) @ (^ [Xz:$i] : (ccfv @ (ccv @ Xy1) @ ccuz)))) @ (^ [Xy1:$i] : ccn0)))))))).
...
thf(ahbtlem6_ax,axiom,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xk:$i] : ((XP @ Xk) = (ccfv @ XR @ ccpl1))) => ((! [Xk:$i] : ((XU @ Xk) = (ccfv @ (XP @ Xk) @ cclidl))) => ((XS = (ccfv @ XR @ ccldgis)) => ((! [Xk:$i] : ((XN @ Xk) = (ccfv @ (XP @ Xk) @ ccrsp))) => ((Xph => (cwcel @ XR @ cclnr)) => ((! [Xk:$i] : (Xph => (cwcel @ XI @ (XU @ Xk)))) => ((Xph => (cwcel @ XX @ ccn0)) => (Xph => (cwrex @ (^ [Xk:$i] : (cwss @ (ccfv @ XX @ (ccfv @ XI @ XS)) @ (ccfv @ XX @ (ccfv @ (ccfv @ (ccv @ Xk) @ (XN @ Xk)) @ XS)))) @ (^ [Xk:$i] : (ccin @ (ccpw @ XI) @ ccfn)))))))))))))))))))).
...
thf(ahbtlem5_ax,axiom,(! [Xph:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : ((! [Xx3:$i] : ((XP @ Xx3) = (ccfv @ (XR @ Xx3) @ ccpl1))) => ((! [Xx3:$i] : ((XU @ Xx3) = (ccfv @ (XP @ Xx3) @ cclidl))) => ((! [Xx3:$i] : (XS = (ccfv @ (XR @ Xx3) @ ccldgis))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XR @ Xx3) @ ccrg))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XI @ (XU @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XJ @ (XU @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XI @ XJ))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XJ @ XS)) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XI @ XS)))) @ (^ [Xx3:$i] : ccn0)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (XI = XJ))))))))))))))))))).
...
thf(arspssp_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : ((XK = (ccfv @ XR @ ccrsp)) => ((XU = (ccfv @ XR @ cclidl)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XU) @ (cwss @ XG @ XI)) => (cwss @ (ccfv @ XG @ XK) @ XI)))))))))).
...
thf(ahbtlem3_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XU = (ccfv @ XP @ cclidl)) => ((XS = (ccfv @ XR @ ccldgis)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XI @ XU)) => ((Xph => (cwcel @ XJ @ XU)) => ((Xph => (cwss @ XI @ XJ)) => ((Xph => (cwcel @ XX @ ccn0)) => (Xph => (cwss @ (ccfv @ XX @ (ccfv @ XI @ XS)) @ (ccfv @ XX @ (ccfv @ XJ @ XS))))))))))))))))))))).
...
thf(aislnr2_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XU = (ccfv @ XR @ cclidl)) => ((XN = (ccfv @ XR @ ccrsp)) => ((cwcel @ XR @ cclnr) <=> ((cwcel @ XR @ ccrg) & (cwral @ (^ [Xi:$i] : (cwrex @ (^ [Xg1:$i] : ((ccv @ Xi) = (ccfv @ (ccv @ Xg1) @ XN))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XB2) @ ccfn)))) @ (^ [Xi:$i] : XU)))))))))))).
thf(chbt_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((cwcel @ XR @ cclnr) => (cwcel @ XP @ cclnr)))))).
