...
thf(amodremain_ax,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XD @ ccn) @ ((cwcel @ XR @ ccn0) & (cwbr @ XR @ XD @ cclt))) => (((cco @ XN @ XD @ ccmo) = XR) <=> (cwrex @ (^ [Xz:$i] : ((cco @ (cco @ (ccv @ Xz) @ XD @ ccmul) @ XR @ ccaddc) = XN)) @ (^ [Xz:$i] : ccz)))))))).
...
thf(a_7pos_ax,axiom,(cwbr @ ccc0 @ cc7 @ cclt)).
thf(a_7lt8_ax,axiom,(cwbr @ cc7 @ cc8 @ cclt)).
thf(amuladdmodid_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccrp) @ (cwcel @ XA2 @ (cco @ ccc0 @ XM @ ccico))) => ((cco @ (cco @ (cco @ XN @ XM @ ccmul) @ XA2 @ ccaddc) @ XM @ ccmo) = XA2)))))).
thf(aeqeq1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((XA2 = XC) <=> (XB2 = XC))))))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccfv_tp,type,(ccfv : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aoveq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))).
thf(cmod42tp1mod8_conj,conjecture,(! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & ((cco @ XN @ cc4 @ ccmo) = cc3)) => ((cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc) @ cc8 @ ccmo) = cc7)))).
