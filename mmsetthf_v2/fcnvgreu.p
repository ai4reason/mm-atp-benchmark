...
thf(afgreu_ax,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwfun @ XF) & (cwcel @ XX @ (ccdm @ XF))) => (cwreu @ (^ [Xp:$i] : (XX = (ccfv @ (ccv @ Xp) @ cc1st))) @ (^ [Xp:$i] : XF)))))).
thf(aadantr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph & Xch) => Xps)))))).
thf(cwrmo_tp,type,(cwrmo : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(areuxfr4d_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XC)) => (cwcel @ (XA2 @ Xy1) @ XB2))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => (cwreu @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XA2 @ Xy1))) @ (^ [Xy1:$i] : XC)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((ccv @ Xx3) = (XA2 @ Xy1))) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => (Xph => ((cwreu @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XB2)) <=> (cwreu @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : XC)))))))))))))).
...
thf(a_2nd1st_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccxp @ XB2 @ XC)) => ((ccuni @ (cccnv @ (ccsn @ XA2))) = (ccop @ (ccfv @ XA2 @ cc2nd) @ (ccfv @ XA2 @ cc1st)))))))).
thf(ampan_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (((Xph & Xps) => Xch) => (Xps => Xch))))))).
thf(arelcnv_ax,axiom,(! [XA2:($i > $o)] : (cwrel @ (cccnv @ XA2)))).
thf(asimpld_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps & Xch)) => (Xph => Xps)))))).
thf(acnvf1olem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwrel @ XA2) & ((cwcel @ XB2 @ XA2) & (XC = (ccuni @ (cccnv @ (ccsn @ XB2)))))) => ((cwcel @ XC @ (cccnv @ XA2)) & (XB2 = (ccuni @ (cccnv @ (ccsn @ XC)))))))))).
...
thf(areu6_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) <=> (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : ((Xph @ Xx3) <=> ((ccv @ Xx3) = (ccv @ Xy1)))) @ (^ [Xx3:$i] : XA2))) @ (^ [Xy1:$i] : XA2)))))).
...
thf(cfcnvgreu_conj,conjecture,(! [XA2:($i > $o)] : (! [XY:($i > $o)] : ((((cwrel @ XA2) & (cwfun @ (cccnv @ XA2))) & (cwcel @ XY @ (ccrn @ XA2))) => (cwreu @ (^ [Xp:$i] : (XY = (ccfv @ (ccv @ Xp) @ cc2nd))) @ (^ [Xp:$i] : XA2)))))).
