...
thf(aisrrvv_ax,axiom,(! [Xph:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XP @ ccprb))) => (! [Xy1:$i] : ((Xph @ Xy1) => ((cwcel @ XX @ (ccfv @ XP @ ccrrv)) <=> ((cwf @ (ccuni @ (ccdm @ XP)) @ ccr @ XX) & (cwral @ (^ [Xy1:$i] : (cwcel @ (ccima @ (cccnv @ XX) @ (ccv @ Xy1)) @ (ccdm @ XP))) @ (^ [Xy1:$i] : ccbrsiga))))))))))).
...
thf(ccoinfliprv_conj,conjecture,(! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XH @ ccvv) => ((cwcel @ XT @ ccvv) => ((cwne @ XH @ XT) => ((XP = (cco @ (ccres @ cchash @ (ccpw @ (ccpr @ XH @ XT))) @ cc2 @ (ccofc @ ccdiv))) => ((XX = (ccpr @ (ccop @ XH @ cc1) @ (ccop @ XT @ ccc0))) => (cwcel @ XX @ (ccfv @ XP @ ccrrv)))))))))))).
