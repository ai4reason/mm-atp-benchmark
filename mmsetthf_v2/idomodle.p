...
thf(aidomrootle_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_ex:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((! [Xy1:$i] : ((Xc_ex @ Xy1) = (ccfv @ (ccfv @ XR @ ccmgp) @ ccmg))) => ((cw3a @ (cwcel @ XR @ ccidom) @ (cwcel @ XX @ XB2) @ (cwcel @ XN @ ccn)) => (cwbr @ (ccfv @ (ccrab @ (^ [Xy1:$i] : ((cco @ XN @ (ccv @ Xy1) @ (Xc_ex @ Xy1)) = XX)) @ (^ [Xy1:$i] : XB2)) @ cchash) @ XN @ ccle)))))))))).
