...
thf(apmap0_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XK @ ccp0)) => ((XM = (ccfv @ XK @ ccpmap)) => ((cwcel @ XK @ ccal) => ((ccfv @ Xc_0 @ XM) = cc0)))))))).
thf(ass0b_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ cc0) <=> (XA2 = cc0)))).
thf(cpnonsingN_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XP = (ccfv @ XK @ ccpolN)) => (((cwcel @ XK @ cchlt) & (cwss @ XX @ XA2)) => ((ccin @ XX @ (ccfv @ XX @ XP)) = cc0))))))))).
