...
thf(advdsprmpweq_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ ccn) @ (cwcel @ XN @ ccn0)) => ((cwbr @ XA2 @ (cco @ XP @ XN @ ccexp) @ ccdvds) => (cwrex @ (^ [Xn:$i] : (XA2 = (cco @ XP @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn0)))))))).
...
thf(altsubnn0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn0) & (cwcel @ XB2 @ ccn0)) => ((cwbr @ XB2 @ XA2 @ cclt) => (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ ccn0)))))).
...
thf(arecnz_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ cc1 @ XA2 @ cclt)) => (~ (cwcel @ (cco @ cc1 @ XA2 @ ccdiv) @ ccz))))).
thf(cdvdsprmpweqle_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ ccn) @ (cwcel @ XN @ ccn0)) => ((cwbr @ XA2 @ (cco @ XP @ XN @ ccexp) @ ccdvds) => (cwrex @ (^ [Xn:$i] : ((cwbr @ (ccv @ Xn) @ XN @ ccle) & (XA2 = (cco @ XP @ (ccv @ Xn) @ ccexp)))) @ (^ [Xn:$i] : ccn0)))))))).
