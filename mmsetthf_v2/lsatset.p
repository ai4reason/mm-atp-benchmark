...
thf(clsatset_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((! [Xv:$i] : ((XA2 @ Xv) = (ccfv @ XW @ cclsa))) => (! [Xv:$i] : ((cwcel @ XW @ XX) => ((XA2 @ Xv) = (ccrn @ (ccmpt @ (^ [Xv:$i] : (ccdif @ XV @ (ccsn @ Xc_0))) @ (^ [Xv:$i] : (ccfv @ (ccsn @ (ccv @ Xv)) @ XN)))))))))))))))))).
