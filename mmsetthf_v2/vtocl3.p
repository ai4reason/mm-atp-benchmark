...
thf(cvtocl3_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cw3a @ ((ccv @ Xx3) = XA2) @ ((ccv @ Xy1) = XB2) @ ((ccv @ Xz) = XC)) => ((Xph @ Xx3 @ Xy1 @ Xz) <=> Xps))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))) => Xps))))))))))).
