...
thf(apellfund14b_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) => ((cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) <=> (cwrex @ (^ [Xx3:$i] : (XA2 = (cco @ (ccfv @ XD @ ccpellfund) @ (ccv @ Xx3) @ ccexp))) @ (^ [Xx3:$i] : ccz))))))).
