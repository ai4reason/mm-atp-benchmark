...
thf(anmoffn_ax,axiom,(cwfn @ ccnmo @ (ccxp @ ccngp @ ccngp))).
thf(cwfun_tp,type,(cwfun : (($i > $o) > $o))).
thf(afndm_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ XA2) => ((ccdm @ XF) = XA2))))).
thf(ccab_tp,type,(ccab : (($i > $o) > ($i > $o)))).
thf(ccopab_tp,type,(ccopab : (($i > ($i > $o)) > ($i > $o)))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(acnv0_ax,axiom,((cccnv @ cc0) = cc0)).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(a_0ima_ax,axiom,(! [XA2:($i > $o)] : ((ccima @ cc0 @ XA2) = cc0))).
thf(cnghmfval_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ XS @ XT @ ccnmo)) => ((cco @ XS @ XT @ ccnghm) = (ccima @ (cccnv @ XN) @ ccr))))))).
