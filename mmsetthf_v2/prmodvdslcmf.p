...
thf(afvprmselgcd1_ax,axiom,(! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xm:$i] : ((XF @ Xm) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccif @ (cwcel @ (ccv @ Xm) @ ccprime) @ (ccv @ Xm) @ cc1))))) => (! [Xm:$i] : ((cw3a @ (cwcel @ XX @ (cco @ cc1 @ XN @ ccfz)) @ (cwcel @ XY @ (cco @ cc1 @ XN @ ccfz)) @ (cwne @ XX @ XY)) => ((cco @ (ccfv @ XX @ (XF @ Xm)) @ (ccfv @ XY @ (XF @ Xm)) @ ccgcd) = cc1))))))))).
...
thf(acoprmproddvds_ax,axiom,(! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [Xn:$i] : ((cw3a @ ((cwss @ XM @ ccn) & (cwcel @ XM @ ccfn)) @ ((cwcel @ (XK @ Xn) @ ccn) & (cwf @ ccn @ ccn @ XF)) @ ((cwral @ (^ [Xm:$i] : (cwral @ (^ [Xn:$i] : ((cco @ (ccfv @ (ccv @ Xm) @ XF) @ (ccfv @ (ccv @ Xn) @ XF) @ ccgcd) = cc1)) @ (^ [Xn:$i] : (ccdif @ XM @ (ccsn @ (ccv @ Xm)))))) @ (^ [Xm:$i] : XM)) & (cwral @ (^ [Xm:$i] : (cwbr @ (ccfv @ (ccv @ Xm) @ XF) @ (XK @ Xn) @ ccdvds)) @ (^ [Xm:$i] : XM)))) => (cwbr @ (ccprod @ (^ [Xm:$i] : XM) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xm) @ XF))) @ (XK @ Xn) @ ccdvds))))))).
