...
thf(adgrmulc_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwcel @ XF @ (ccfv @ XS @ ccply))) => ((ccfv @ (cco @ (ccxp @ ccc @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul)) @ ccdgr) = (ccfv @ XF @ ccdgr))))))).
thf(adgrcolem1_ax,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : ((XN @ Xx3) = (ccfv @ XG @ ccdgr))) => ((Xph => (cwcel @ XM @ ccn)) => ((! [Xx3:$i] : (Xph => (cwcel @ (XN @ Xx3) @ ccn))) => ((! [Xx3:$i] : (Xph => (cwcel @ XG @ (ccfv @ (XS @ Xx3) @ ccply)))) => (! [Xx3:$i] : (Xph => ((ccfv @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XG) @ XM @ ccexp))) @ ccdgr) = (cco @ XM @ (XN @ Xx3) @ ccmul)))))))))))))).
