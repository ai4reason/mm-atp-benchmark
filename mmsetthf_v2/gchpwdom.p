...
thf(adomen1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) => ((cwbr @ XA2 @ XC @ ccdom) <=> (cwbr @ XB2 @ XC @ ccdom))))))).
...
thf(agchi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccgch) @ (cwbr @ XA2 @ XB2 @ ccsdm) @ (cwbr @ XB2 @ (ccpw @ XA2) @ ccsdm)) => (cwcel @ XA2 @ ccfn))))).
...
thf(apwdom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccdom) => (cwbr @ (ccpw @ XA2) @ (ccpw @ XB2) @ ccdom))))).
thf(acdadom1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccdom) => (cwbr @ (cco @ XA2 @ XC @ cccda) @ (cco @ XB2 @ XC @ cccda) @ ccdom)))))).
...
thf(apwcda1_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwbr @ (cco @ (ccpw @ XA2) @ (ccpw @ XA2) @ cccda) @ (ccpw @ (cco @ XA2 @ cc1o @ cccda)) @ ccen))))).
thf(agchcda1_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccgch) & (~ (cwcel @ XA2 @ ccfn))) => (cwbr @ (cco @ XA2 @ cc1o @ cccda) @ XA2 @ ccen)))).
...
thf(cgchpwdom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwcel @ XA2 @ ccgch) @ (cwcel @ XB2 @ ccgch)) => ((cwbr @ XA2 @ XB2 @ ccsdm) <=> (cwbr @ (ccpw @ XA2) @ XB2 @ ccdom)))))).
