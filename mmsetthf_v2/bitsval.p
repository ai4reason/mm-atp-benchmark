...
thf(abitsfval_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((ccfv @ XN @ ccbits) = (ccrab @ (^ [Xm:$i] : (~ (cwbr @ cc2 @ (ccfv @ (cco @ XN @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccdiv) @ ccfl) @ ccdvds))) @ (^ [Xm:$i] : ccn0)))))).
...
thf(cbitsval_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XM @ (ccfv @ XN @ ccbits)) <=> (cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccn0) @ (~ (cwbr @ cc2 @ (ccfv @ (cco @ XN @ (cco @ cc2 @ XM @ ccexp) @ ccdiv) @ ccfl) @ ccdvds))))))).
