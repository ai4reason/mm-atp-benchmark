...
thf(adyadmax_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((XF = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv)))))) => (((cwss @ XA2 @ (ccrn @ XF)) & (cwne @ XA2 @ cc0)) => (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((cwss @ (ccfv @ (ccv @ Xz) @ ccicc) @ (ccfv @ (ccv @ Xw) @ ccicc)) => ((ccv @ Xz) = (ccv @ Xw)))) @ (^ [Xw:$i] : XA2))) @ (^ [Xz:$i] : XA2))))))).
