...
thf(accatalpha_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XA2 @ (ccword @ ccvv)) & (cwcel @ XB2 @ (ccword @ ccvv))) => ((cwcel @ (cco @ XA2 @ XB2 @ ccconcat) @ (ccword @ XS)) <=> ((cwcel @ XA2 @ (ccword @ XS)) & (cwcel @ XB2 @ (ccword @ XS))))))))).
...
thf(cccats1alpha_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ (ccword @ XV)) & (cwcel @ XX @ XU)) => ((cwcel @ (cco @ XA2 @ (ccs1 @ XX) @ ccconcat) @ (ccword @ XS)) <=> ((cwcel @ XA2 @ (ccword @ XS)) & (cwcel @ XX @ XS)))))))))).
