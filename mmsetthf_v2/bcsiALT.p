...
thf(aabslem2_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ XA2 @ ccc0)) => ((cco @ (cco @ (ccfv @ (cco @ XA2 @ (ccfv @ XA2 @ ccabs) @ ccdiv) @ cccj) @ XA2 @ ccmul) @ (cco @ (cco @ XA2 @ (ccfv @ XA2 @ ccabs) @ ccdiv) @ (ccfv @ XA2 @ cccj) @ ccmul) @ ccaddc) = (cco @ cc2 @ (ccfv @ XA2 @ ccabs) @ ccmul))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(anecon3bii_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((XA2 = XB2) <=> (XC = XD)) => ((cwne @ XA2 @ XB2) <=> (cwne @ XC @ XD)))))))).
thf(aabs00i_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (((ccfv @ XA2 @ ccabs) = ccc0) <=> (XA2 = ccc0))))).
...
thf(aabsgt0i_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwne @ XA2 @ ccc0) <=> (cwbr @ ccc0 @ (ccfv @ XA2 @ ccabs) @ cclt))))).
...
thf(anormlem7tALT_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => (((cwcel @ XS @ ccc) & ((ccfv @ XS @ ccabs) = cc1)) => (cwbr @ (cco @ (cco @ (ccfv @ XS @ cccj) @ (cco @ XA2 @ XB2 @ ccsp) @ ccmul) @ (cco @ XS @ (cco @ XB2 @ XA2 @ ccsp) @ ccmul) @ ccaddc) @ (cco @ cc2 @ (cco @ (ccfv @ (cco @ XB2 @ XB2 @ ccsp) @ ccsqrt) @ (ccfv @ (cco @ XA2 @ XA2 @ ccsp) @ ccsqrt) @ ccmul) @ ccmul) @ ccle)))))))).
