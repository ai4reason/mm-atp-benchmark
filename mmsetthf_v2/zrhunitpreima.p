...
thf(czrhunitpreima_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XL = (ccfv @ XR @ cczrh)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccdr) & ((ccfv @ XR @ ccchr) = ccc0)) => ((ccima @ (cccnv @ XL) @ (ccfv @ XR @ ccui)) = (ccdif @ ccz @ (ccsn @ ccc0)))))))))))).
