...
thf(alplni2_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XP = (ccfv @ XK @ cclpl)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwcel @ XQ @ XA2) @ (cwcel @ XR @ XA2) @ (cwcel @ XS @ XA2)) @ ((cwne @ XQ @ XR) & (~ (cwbr @ XS @ (cco @ XQ @ XR @ Xc_or) @ Xc_le)))) => (cwcel @ (cco @ (cco @ XQ @ XR @ Xc_or) @ XS @ Xc_or) @ XP))))))))))))))).
...
thf(c_2llnjaN_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XN = (ccfv @ XK @ cclln)) => ((XP = (ccfv @ XK @ cclpl)) => (((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XP)) @ (cw3a @ (cwcel @ XQ @ XA2) @ (cwcel @ XR @ XA2) @ (cwne @ XQ @ XR)) @ (cw3a @ (cwcel @ XS @ XA2) @ (cwcel @ XT @ XA2) @ (cwne @ XS @ XT))) & (cw3a @ (cwbr @ (cco @ XQ @ XR @ Xc_or) @ XW @ Xc_le) @ (cwbr @ (cco @ XS @ XT @ Xc_or) @ XW @ Xc_le) @ (cwne @ (cco @ XQ @ XR @ Xc_or) @ (cco @ XS @ XT @ Xc_or)))) => ((cco @ (cco @ XQ @ XR @ Xc_or) @ (cco @ XS @ XT @ Xc_or) @ Xc_or) = XW))))))))))))))))))).
