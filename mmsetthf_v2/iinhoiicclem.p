...
thf(aelixpconstg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XF @ (XV @ Xx3)) => ((cwcel @ XF @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2))) <=> (cwf @ XA2 @ XB2 @ XF))))))))).
