...
thf(afindes_ax,axiom,(! [Xph:($i > $o)] : ((cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ cc0) => ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ ccom) => ((Xph @ Xx3) => (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (ccsuc @ (ccv @ Xx3)))))) => (! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ ccom) => (Xph @ Xx3))))))).
...
thf(crdgeqoa_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccon0) @ (cwcel @ XM @ ccon0) @ (cwcel @ XX @ ccom)) => (((ccfv @ XN @ (ccrdg @ XF @ XA2)) = (ccfv @ XM @ (ccrdg @ XF @ XB2))) => ((ccfv @ (cco @ XN @ XX @ ccoa) @ (ccrdg @ XF @ XA2)) = (ccfv @ (cco @ XM @ XX @ ccoa) @ (ccrdg @ XF @ XB2)))))))))))).
