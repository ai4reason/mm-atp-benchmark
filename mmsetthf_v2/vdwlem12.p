...
thf(cvdwlem12_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XR @ ccfn)) => ((Xph => (cwf @ (cco @ cc1 @ (cco @ (ccfv @ XR @ cchash) @ cc1 @ ccaddc) @ ccfz) @ XR @ XF)) => ((Xph => (~ (cwbr @ cc2 @ XF @ ccvdwm))) => (~ Xph)))))))).
