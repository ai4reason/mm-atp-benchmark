...
thf(afin1a2lem10_ax,axiom,(! [XA2:($i > $o)] : ((cw3a @ (cwne @ XA2 @ cc0) @ (cwcel @ XA2 @ ccfn) @ (cwor @ XA2 @ ccrpss)) => (cwcel @ (ccuni @ XA2) @ XA2)))).
...
thf(apssdif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwpss @ XA2 @ XB2) => (cwne @ (ccdif @ XB2 @ XA2) @ cc0))))).
...
thf(alsmss2_ax,axiom,(! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((Xc_po = (ccfv @ XG @ cclsm)) => ((cw3a @ (cwcel @ XT @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XU @ (ccfv @ XG @ ccsubg)) @ (cwss @ XU @ XT)) => ((cco @ XT @ XU @ Xc_po) = XT)))))))).
...
thf(cpgpfac1lem5_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => ((XS = (ccfv @ (ccsn @ XA2) @ XK)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((! [Xt:$i] : (! [Xs1:$i] : ((XO @ Xt @ Xs1) = (ccfv @ XG @ ccod)))) => ((! [Xt:$i] : (! [Xs1:$i] : ((XE @ Xt @ Xs1) = (ccfv @ XG @ ccgex)))) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xc_po = (ccfv @ XG @ cclsm)) => ((Xph => (cwbr @ XP @ XG @ ccpgp)) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XB2 @ ccfn)) => ((! [Xt:$i] : (! [Xs1:$i] : (Xph => ((ccfv @ XA2 @ (XO @ Xt @ Xs1)) = (XE @ Xt @ Xs1))))) => ((Xph => (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((Xph => (cwcel @ XA2 @ XU)) => ((Xph => (cwral @ (^ [Xs1:$i] : (((cwpss @ (ccv @ Xs1) @ XU) & (cwcel @ XA2 @ (ccv @ Xs1))) => (cwrex @ (^ [Xt:$i] : (((ccin @ XS @ (ccv @ Xt)) = (ccsn @ Xc_0)) & ((cco @ XS @ (ccv @ Xt) @ Xc_po) = (ccv @ Xs1)))) @ (^ [Xt:$i] : (ccfv @ XG @ ccsubg))))) @ (^ [Xs1:$i] : (ccfv @ XG @ ccsubg)))) => (Xph => (cwrex @ (^ [Xt:$i] : (((ccin @ XS @ (ccv @ Xt)) = (ccsn @ Xc_0)) & ((cco @ XS @ (ccv @ Xt) @ Xc_po) = XU))) @ (^ [Xt:$i] : (ccfv @ XG @ ccsubg))))))))))))))))))))))))))))))).
