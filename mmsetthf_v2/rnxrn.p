...
thf(adfrn6_ax,axiom,(! [XR:($i > $o)] : ((ccrn @ XR) = (ccab @ (^ [Xx3:$i] : (cwne @ (ccec @ (ccv @ Xx3) @ (cccnv @ XR)) @ cc0)))))).
...
thf(aelec1cnvxrn2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((cwcel @ XB2 @ (ccec @ XA2 @ (cccnv @ (ccxrn @ XR @ XS)))) <=> (? [Xy1:$i] : (? [Xz:$i] : (cw3a @ (XA2 = (ccop @ (ccv @ Xy1) @ (ccv @ Xz))) @ (cwbr @ XB2 @ (ccv @ Xy1) @ XR) @ (cwbr @ XB2 @ (ccv @ Xz) @ XS)))))))))))).
...
thf(crnxrn_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((ccrn @ (ccxrn @ XR @ XS)) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (? [Xu:$i] : ((cwbr @ (ccv @ Xu) @ (ccv @ Xx3) @ XR) & (cwbr @ (ccv @ Xu) @ (ccv @ Xy1) @ XS)))))))))).
