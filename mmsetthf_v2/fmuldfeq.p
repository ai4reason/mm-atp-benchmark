...
thf(afmuldfeqlem1_ax,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xt:$i] : (! [Xg1:$i] : (! [Xi:$i] : (cwnf @ (^ [Xf1:$i] : (Xph @ Xt @ Xf1 @ Xg1 @ Xi)))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xi:$i] : (cwnf @ (^ [Xg1:$i] : (Xph @ Xt @ Xf1 @ Xg1 @ Xi)))))) => ((! [Xi:$i] : (cwnfc @ (^ [Xt:$i] : (XY @ Xt @ Xi)))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((XP @ Xt @ Xf1 @ Xg1 @ Xi) = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (XY @ Xt @ Xi))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (XY @ Xt @ Xi))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccmpt @ (^ [Xt:$i] : (XT @ Xi)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))))))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((XF @ Xt @ Xf1 @ Xg1 @ Xi) = (ccmpt @ (^ [Xt:$i] : (XT @ Xi)) @ (^ [Xt:$i] : (ccmpt @ (^ [Xi:$i] : (cco @ cc1 @ (XM @ Xt @ Xf1 @ Xg1) @ ccfz)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ (XU @ Xg1)))))))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((Xph @ Xt @ Xf1 @ Xg1 @ Xi) => (cwcel @ (XT @ Xi) @ ccvv)))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((Xph @ Xt @ Xf1 @ Xg1 @ Xi) => (cwf @ (cco @ cc1 @ (XM @ Xt @ Xf1 @ Xg1) @ ccfz) @ (XY @ Xt @ Xi) @ (XU @ Xg1))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((cw3a @ (Xph @ Xt @ Xf1 @ Xg1 @ Xi) @ (cwcel @ (ccv @ Xf1) @ (XY @ Xt @ Xi)) @ (cwcel @ (ccv @ Xg1) @ (XY @ Xt @ Xi))) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (XT @ Xi)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))) @ (XY @ Xt @ Xi))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((Xph @ Xt @ Xf1 @ Xg1 @ Xi) => (cwcel @ (XN @ Xg1 @ Xi) @ (cco @ cc1 @ (XM @ Xt @ Xf1 @ Xg1) @ ccfz))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((Xph @ Xt @ Xf1 @ Xg1 @ Xi) => (cwcel @ (cco @ (XN @ Xg1 @ Xi) @ cc1 @ ccaddc) @ (cco @ cc1 @ (XM @ Xt @ Xf1 @ Xg1) @ ccfz))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((Xph @ Xt @ Xf1 @ Xg1 @ Xi) => ((ccfv @ (ccv @ Xt) @ (ccfv @ (XN @ Xg1 @ Xi) @ (ccseq @ (XP @ Xt @ Xf1 @ Xg1 @ Xi) @ (XU @ Xg1) @ cc1))) = (ccfv @ (XN @ Xg1 @ Xi) @ (ccseq @ ccmul @ (ccfv @ (ccv @ Xt) @ (XF @ Xt @ Xf1 @ Xg1 @ Xi)) @ cc1)))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (((Xph @ Xt @ Xf1 @ Xg1 @ Xi) & (cwcel @ (ccv @ Xf1) @ (XY @ Xt @ Xi))) => (cwf @ (XT @ Xi) @ ccr @ (ccv @ Xf1))))))) => (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (((Xph @ Xt @ Xf1 @ Xg1 @ Xi) & (cwcel @ (ccv @ Xt) @ (XT @ Xi))) => ((ccfv @ (ccv @ Xt) @ (ccfv @ (cco @ (XN @ Xg1 @ Xi) @ cc1 @ ccaddc) @ (ccseq @ (XP @ Xt @ Xf1 @ Xg1 @ Xi) @ (XU @ Xg1) @ cc1))) = (ccfv @ (cco @ (XN @ Xg1 @ Xi) @ cc1 @ ccaddc) @ (ccseq @ ccmul @ (ccfv @ (ccv @ Xt) @ (XF @ Xt @ Xf1 @ Xg1 @ Xi)) @ cc1))))))))))))))))))))))))))))).
...
thf(anfseq_ax,axiom,(! [Xc_pl:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XM @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (Xc_pl @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => (cwnfc @ (^ [Xx3:$i] : (ccseq @ (Xc_pl @ Xx3) @ (XF @ Xx3) @ (XM @ Xx3))))))))))).
...
thf(cfmuldfeq_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xt:$i] : (cwnf @ (^ [Xi:$i] : (Xph @ Xt @ Xi)))) => ((! [Xi:$i] : (cwnfc @ (^ [Xt:$i] : (XY @ Xt @ Xi)))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((XP @ Xt @ Xf1 @ Xg1 @ Xi) = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (XY @ Xt @ Xi))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (XY @ Xt @ Xi))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))))))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((XX @ Xt @ Xf1 @ Xg1 @ Xi) = (ccfv @ (XM @ Xt) @ (ccseq @ (XP @ Xt @ Xf1 @ Xg1 @ Xi) @ XU @ cc1))))))) => ((! [Xt:$i] : (! [Xi:$i] : ((XF @ Xt @ Xi) = (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccmpt @ (^ [Xi:$i] : (cco @ cc1 @ (XM @ Xt) @ ccfz)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ XU))))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((XZ @ Xt @ Xf1 @ Xg1 @ Xi) = (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccfv @ (XM @ Xt) @ (ccseq @ ccmul @ (ccfv @ (ccv @ Xt) @ (XF @ Xt @ Xi)) @ cc1))))))))) => ((! [Xt:$i] : (! [Xi:$i] : ((Xph @ Xt @ Xi) => (cwcel @ XT @ ccvv)))) => ((! [Xt:$i] : (! [Xi:$i] : ((Xph @ Xt @ Xi) => (cwcel @ (XM @ Xt) @ ccn)))) => ((! [Xt:$i] : (! [Xi:$i] : ((Xph @ Xt @ Xi) => (cwf @ (cco @ cc1 @ (XM @ Xt) @ ccfz) @ (XY @ Xt @ Xi) @ XU)))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xi:$i] : (((Xph @ Xt @ Xi) & (cwcel @ (ccv @ Xf1) @ (XY @ Xt @ Xi))) => (cwf @ XT @ ccr @ (ccv @ Xf1)))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((cw3a @ (Xph @ Xt @ Xi) @ (cwcel @ (ccv @ Xf1) @ (XY @ Xt @ Xi)) @ (cwcel @ (ccv @ Xg1) @ (XY @ Xt @ Xi))) => (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))) @ (XY @ Xt @ Xi))))))) => (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : (((Xph @ Xt @ Xi) & (cwcel @ (ccv @ Xt) @ XT)) => ((ccfv @ (ccv @ Xt) @ (XX @ Xt @ Xf1 @ Xg1 @ Xi)) = (ccfv @ (ccv @ Xt) @ (XZ @ Xt @ Xf1 @ Xg1 @ Xi))))))))))))))))))))))))))))).
