...
thf(aimasgim_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (XU = (cco @ XF @ XR @ ccimas))) => ((Xph => (XV = (ccfv @ XR @ ccbs))) => ((Xph => (cwf1o @ XV @ XB2 @ XF)) => ((Xph => (cwcel @ XR @ ccgrp)) => (Xph => (cwcel @ XF @ (cco @ XR @ XU @ ccgim)))))))))))))).
...
thf(agicabl_ax,axiom,(! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwbr @ XG @ XH @ ccgic) => ((cwcel @ XG @ ccabl) <=> (cwcel @ XH @ ccabl)))))).
...
thf(cisnumbasgrplem1_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => (((cwcel @ XR @ ccabl) & (cwbr @ XC @ XB2 @ ccen)) => (cwcel @ XC @ (ccima @ ccbs @ ccabl)))))))).
