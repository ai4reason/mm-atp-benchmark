...
thf(amulgaddcom_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XN @ ccz) @ (cwcel @ XX @ XB2)) => ((cco @ (cco @ XN @ XX @ Xc_x) @ XX @ Xc_pl) = (cco @ XX @ (cco @ XN @ XX @ Xc_x) @ Xc_pl))))))))))))).
...
thf(cmulginvcom_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((XI = (ccfv @ XG @ ccminusg)) => ((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XN @ ccz) @ (cwcel @ XX @ XB2)) => ((cco @ XN @ (ccfv @ XX @ XI) @ Xc_x) = (ccfv @ (cco @ XN @ XX @ Xc_x) @ XI))))))))))))).
