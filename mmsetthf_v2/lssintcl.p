...
thf(aintssuni2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ XB2) & (cwne @ XA2 @ cc0)) => (cwss @ (ccint @ XA2) @ (ccuni @ XB2)))))).
...
thf(clssintcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : ((XS = (ccfv @ XW @ cclss)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwss @ XA2 @ XS) @ (cwne @ XA2 @ cc0)) => (cwcel @ (ccint @ XA2) @ XS))))))).
