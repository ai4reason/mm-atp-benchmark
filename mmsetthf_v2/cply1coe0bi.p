...
thf(acply1coe0_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XK = (ccfv @ XR @ ccbs)) => ((! [Xn:$i] : ((Xc_0 @ Xn) = (ccfv @ XR @ cc0g))) => ((! [Xn:$i] : ((XP @ Xn) = (ccfv @ XR @ ccpl1))) => ((! [Xn:$i] : ((XB2 @ Xn) = (ccfv @ (XP @ Xn) @ ccbs))) => ((! [Xn:$i] : ((XA2 @ Xn) = (ccfv @ (XP @ Xn) @ ccascl))) => (((cwcel @ XR @ ccrg) & (cwcel @ XS @ XK)) => (cwral @ (^ [Xn:$i] : ((ccfv @ (ccv @ Xn) @ (ccfv @ (ccfv @ XS @ (XA2 @ Xn)) @ ccco1)) = (Xc_0 @ Xn))) @ (^ [Xn:$i] : ccn)))))))))))))))).
...
thf(acoe1scl_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XA2 = (ccfv @ XP @ ccascl)) => ((XK = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccrg) & (cwcel @ XX @ XK)) => ((ccfv @ (ccfv @ XX @ XA2) @ ccco1) = (ccmpt @ (^ [Xx3:$i] : ccn0) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = ccc0) @ XX @ Xc_0)))))))))))))))).
...
thf(aply1sclid_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XA2 = (ccfv @ XP @ ccascl)) => ((XK = (ccfv @ XR @ ccbs)) => (((cwcel @ XR @ ccrg) & (cwcel @ XX @ XK)) => (XX = (ccfv @ ccc0 @ (ccfv @ (ccfv @ XX @ XA2) @ ccco1))))))))))))).
...
thf(ccply1coe0bi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XK = (ccfv @ XR @ ccbs)) => ((! [Xn:$i] : ((Xc_0 @ Xn) = (ccfv @ XR @ cc0g))) => ((! [Xn:$i] : (! [Xs1:$i] : ((XP @ Xn @ Xs1) = (ccfv @ XR @ ccpl1)))) => ((! [Xn:$i] : (! [Xs1:$i] : (XB2 = (ccfv @ (XP @ Xn @ Xs1) @ ccbs)))) => ((! [Xn:$i] : (! [Xs1:$i] : (XA2 = (ccfv @ (XP @ Xn @ Xs1) @ ccascl)))) => (((cwcel @ XR @ ccrg) & (cwcel @ XM @ XB2)) => ((cwrex @ (^ [Xs1:$i] : (XM = (ccfv @ (ccv @ Xs1) @ XA2))) @ (^ [Xs1:$i] : XK)) <=> (cwral @ (^ [Xn:$i] : ((ccfv @ (ccv @ Xn) @ (ccfv @ XM @ ccco1)) = (Xc_0 @ Xn))) @ (^ [Xn:$i] : ccn))))))))))))))))).
