...
thf(azlmodzxzldep_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => ((XA2 = (ccpr @ (ccop @ ccc0 @ cc3) @ (ccop @ cc1 @ cc6))) => ((XB2 = (ccpr @ (ccop @ ccc0 @ cc2) @ (ccop @ cc1 @ cc4))) => (cwbr @ (ccpr @ XA2 @ XB2) @ XZ @ cclindeps)))))))).
...
thf(aldepsnlinclem1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => ((XA2 = (ccpr @ (ccop @ ccc0 @ cc3) @ (ccop @ cc1 @ cc6))) => ((XB2 = (ccpr @ (ccop @ ccc0 @ cc2) @ (ccop @ cc1 @ cc4))) => ((cwcel @ XF @ (cco @ (ccfv @ czring @ ccbs) @ (ccsn @ XB2) @ ccmap)) => (cwne @ (cco @ XF @ (ccsn @ XB2) @ (ccfv @ XZ @ cclinc)) @ XA2)))))))))).
thf(aoveq1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XC @ XF)))))))).
thf(afveq2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))).
thf(aax_mp_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((Xph => Xps) => Xps))))).
thf(aeqcomd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => (XB2 = XA2))))))).
thf(asimpr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(aldepsnlinclem2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => ((XA2 = (ccpr @ (ccop @ ccc0 @ cc3) @ (ccop @ cc1 @ cc6))) => ((XB2 = (ccpr @ (ccop @ ccc0 @ cc2) @ (ccop @ cc1 @ cc4))) => ((cwcel @ XF @ (cco @ (ccfv @ czring @ ccbs) @ (ccsn @ XA2) @ ccmap)) => (cwne @ (cco @ XF @ (ccsn @ XA2) @ (ccfv @ XZ @ cclinc)) @ XB2)))))))))).
...
thf(cldepsnlinc_conj,conjecture,(cwrex @ (^ [Xm:$i] : (cwrex @ (^ [Xs1:$i] : ((cwbr @ (ccv @ Xs1) @ (ccv @ Xm) @ cclindeps) & (cwral @ (^ [Xv:$i] : (cwral @ (^ [Xf1:$i] : ((cwbr @ (ccv @ Xf1) @ (ccfv @ (ccfv @ (ccv @ Xm) @ ccsca) @ cc0g) @ ccfsupp) => (cwne @ (cco @ (ccv @ Xf1) @ (ccdif @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xv))) @ (ccfv @ (ccv @ Xm) @ cclinc)) @ (ccv @ Xv)))) @ (^ [Xf1:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ ccsca) @ ccbs) @ (ccdif @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xv))) @ ccmap)))) @ (^ [Xv:$i] : (ccv @ Xs1))))) @ (^ [Xs1:$i] : (ccpw @ (ccfv @ (ccv @ Xm) @ ccbs))))) @ (^ [Xm:$i] : cclmod))).
