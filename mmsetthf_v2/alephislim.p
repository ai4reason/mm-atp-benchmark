...
thf(acardlim_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ ccom @ (ccfv @ XA2 @ cccrd)) <=> (cwlim @ (ccfv @ XA2 @ cccrd))))).
...
thf(calephislim_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) <=> (cwlim @ (ccfv @ XA2 @ ccale))))).
