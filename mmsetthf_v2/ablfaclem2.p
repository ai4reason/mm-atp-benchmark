...
thf(adprdf1o_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : ((Xph => (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((Xph => ((ccdm @ XS) = XI)) => ((Xph => (cwf1o @ XJ @ XI @ XF)) => (Xph => ((cwbr @ XG @ (cccom @ XS @ XF) @ (ccdm @ ccdprd)) & ((cco @ XG @ (cccom @ XS @ XF) @ ccdprd) = (cco @ XG @ XS @ ccdprd)))))))))))))).
thf(cwrel_tp,type,(cwrel : (($i > $o) > $o))).
thf(adprd2d2_ax,axiom,(! [Xph:$o] : (! [XS:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((! [Xi:$i] : (! [Xj:$i] : ((Xph & ((cwcel @ (ccv @ Xi) @ XI) & (cwcel @ (ccv @ Xj) @ (XJ @ Xi)))) => (cwcel @ (XS @ Xi @ Xj) @ (ccfv @ XG @ ccsubg))))) => ((! [Xi:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ XI)) => (cwbr @ XG @ (ccmpt @ (^ [Xj:$i] : (XJ @ Xi)) @ (^ [Xj:$i] : (XS @ Xi @ Xj))) @ (ccdm @ ccdprd)))) => ((Xph => (cwbr @ XG @ (ccmpt @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (XJ @ Xi)) @ (^ [Xj:$i] : (XS @ Xi @ Xj))) @ ccdprd))) @ (ccdm @ ccdprd))) => (Xph => ((cwbr @ XG @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XI)) @ (^ [Xi:$i] : (^ [Xj:$i] : (XJ @ Xi))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XS @ Xi @ Xj)))) @ (ccdm @ ccdprd)) & ((cco @ XG @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XI)) @ (^ [Xi:$i] : (^ [Xj:$i] : (XJ @ Xi))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XS @ Xi @ Xj)))) @ ccdprd) = (cco @ XG @ (ccmpt @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (cco @ XG @ (ccmpt @ (^ [Xj:$i] : (XJ @ Xi)) @ (^ [Xj:$i] : (XS @ Xi @ Xj))) @ ccdprd))) @ ccdprd))))))))))))).
...
thf(aablfac1c_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : ((! [Xw:$i] : (XB2 = (ccfv @ (XG @ Xw) @ ccbs))) => ((! [Xw:$i] : ((XO @ Xw) = (ccfv @ (XG @ Xw) @ ccod))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xp:$i] : ((XS @ Xx3 @ Xw @ Xp) = (ccmpt @ (^ [Xp:$i] : (XA2 @ Xw)) @ (^ [Xp:$i] : (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (XO @ Xw)) @ (cco @ (ccv @ Xp) @ (cco @ (ccv @ Xp) @ (ccfv @ XB2 @ cchash) @ ccpc) @ ccexp) @ ccdvds)) @ (^ [Xx3:$i] : XB2)))))))) => ((! [Xw:$i] : (Xph => (cwcel @ (XG @ Xw) @ ccabl))) => ((Xph => (cwcel @ XB2 @ ccfn)) => ((! [Xw:$i] : (Xph => (cwss @ (XA2 @ Xw) @ ccprime))) => ((! [Xw:$i] : ((XD @ Xw) = (ccrab @ (^ [Xw:$i] : (cwbr @ (ccv @ Xw) @ (ccfv @ XB2 @ cchash) @ ccdvds)) @ (^ [Xw:$i] : ccprime)))) => ((! [Xw:$i] : (Xph => (cwss @ (XD @ Xw) @ (XA2 @ Xw)))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xp:$i] : (Xph => ((cco @ (XG @ Xw) @ (XS @ Xx3 @ Xw @ Xp) @ ccdprd) = XB2))))))))))))))))))))).
