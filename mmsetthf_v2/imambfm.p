...
thf(asssigagen_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwss @ XA2 @ (ccfv @ XA2 @ ccsigagen)))))).
thf(ampbir2and_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xch) => ((Xph => Xth) => ((Xph => (Xps <=> (Xch & Xth))) => (Xph => Xps))))))))).
thf(asyl21anc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xps) => ((Xph => Xch) => ((Xph => Xth) => ((((Xps & Xch) & Xth) => Xta) => (Xph => Xta))))))))))).
thf(aunielsiga_ax,axiom,(! [XS:($i > $o)] : ((cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) => (cwcel @ (ccuni @ XS) @ XS)))).
...
thf(aunipreima_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfun @ XF) => ((ccima @ (cccnv @ XF) @ (ccuni @ XA2)) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccima @ (cccnv @ XF) @ (ccv @ Xx3))))))))).
thf(aelelpwi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ XB2) & (cwcel @ XB2 @ (ccpw @ XC))) => (cwcel @ XA2 @ XC)))))).
thf(cwnfc_tp,type,(cwnfc : (($i > ($i > $o)) > $o))).
thf(asigaclcuni_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : ((cwnfc @ (^ [Xk:$i] : (XA2 @ Xk))) => (! [Xk:$i] : ((cw3a @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) @ (cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xk) @ XS)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (cwbr @ (XA2 @ Xk) @ ccom @ ccdom)) => (cwcel @ (cciun @ (^ [Xk:$i] : (XA2 @ Xk)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ XS)))))))).
...
thf(asigagenss_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XS @ (ccfv @ (ccuni @ XA2) @ ccsiga)) & (cwss @ XA2 @ XS)) => (cwss @ (ccfv @ XA2 @ ccsigagen) @ XS))))).
...
thf(cimambfm_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XK @ ccvv)) => ((Xph => (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga)))) => ((Xph => (XT = (ccfv @ XK @ ccsigagen))) => (Xph => ((cwcel @ XF @ (cco @ XS @ XT @ ccmbfm)) <=> ((cwf @ (ccuni @ XS) @ (ccuni @ XT) @ XF) & (cwral @ (^ [Xa:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xa)) @ XS)) @ (^ [Xa:$i] : XK)))))))))))))).
