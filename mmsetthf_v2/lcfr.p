...
thf(alss0cl_ax,axiom,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XS = (ccfv @ XW @ cclss)) => (((cwcel @ XW @ cclmod) & (cwcel @ XU @ XS)) => (cwcel @ Xc_0 @ XU))))))))).
thf(aldual0vcl_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XF = (ccfv @ XW @ cclfn)) => ((XD = (ccfv @ XW @ ccld)) => ((Xc_0 = (ccfv @ XD @ cc0g)) => ((Xph => (cwcel @ XW @ cclmod)) => (Xph => (cwcel @ Xc_0 @ XF)))))))))))).
...
thf(alcfrlem42_ax,axiom,(! [Xph:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > $o))] : (! [Xc_pl:($i > $o)] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XU:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xf1:$i] : (! [Xg1:$i] : ((XH @ Xf1 @ Xg1) = (ccfv @ (XK @ Xf1 @ Xg1) @ cclh)))) => ((! [Xf1:$i] : (! [Xg1:$i] : (Xc_pe = (ccfv @ (XW @ Xf1 @ Xg1) @ (ccfv @ (XK @ Xf1 @ Xg1) @ ccoch))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (XU = (ccfv @ (XW @ Xf1 @ Xg1) @ (ccfv @ (XK @ Xf1 @ Xg1) @ ccdvh))))) => ((Xc_pl = (ccfv @ XU @ ccplusg)) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XF @ Xf1 @ Xg1) = (ccfv @ XU @ cclfn)))) => ((XL = (ccfv @ XU @ cclk)) => ((! [Xf1:$i] : ((XD @ Xf1) = (ccfv @ XU @ ccld))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XQ @ Xf1 @ Xg1) = (ccfv @ (XD @ Xf1) @ cclss)))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XC @ Xf1 @ Xg1) = (ccrab @ (^ [Xf1:$i] : ((ccfv @ (ccfv @ (ccfv @ (ccv @ Xf1) @ XL) @ Xc_pe) @ Xc_pe) = (ccfv @ (ccv @ Xf1) @ XL))) @ (^ [Xf1:$i] : (ccfv @ XU @ cclfn)))))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XE @ Xf1 @ Xg1) = (cciun @ (^ [Xg1:$i] : (XG @ Xf1)) @ (^ [Xg1:$i] : (ccfv @ (ccfv @ (ccv @ Xg1) @ XL) @ Xc_pe)))))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xf1) => ((cwcel @ (XK @ Xf1 @ Xg1) @ cchlt) & (cwcel @ (XW @ Xf1 @ Xg1) @ (XH @ Xf1 @ Xg1)))))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xf1) => (cwcel @ (XG @ Xf1) @ (XQ @ Xf1 @ Xg1))))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xf1) => (cwss @ (XG @ Xf1) @ (XC @ Xf1 @ Xg1))))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xf1) => (cwcel @ XX @ (XE @ Xf1 @ Xg1))))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xf1) => (cwcel @ XY @ (XE @ Xf1 @ Xg1))))) => (! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xf1) => (cwcel @ (cco @ XX @ XY @ Xc_pl) @ (XE @ Xf1 @ Xg1))))))))))))))))))))))))))))))))))))).
thf(aax_mp_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((Xph => Xps) => Xps))))).
thf(arabeq_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 = XB2) => ((ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) = (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XB2)))))))).
thf(alcfrlem5_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [Xc_pe:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xf1:$i] : ((XH @ Xf1) = (ccfv @ (XK @ Xf1) @ cclh))) => ((! [Xf1:$i] : ((Xc_pe @ Xf1) = (ccfv @ (XW @ Xf1) @ (ccfv @ (XK @ Xf1) @ ccoch)))) => ((! [Xf1:$i] : ((XU @ Xf1) = (ccfv @ (XW @ Xf1) @ (ccfv @ (XK @ Xf1) @ ccdvh)))) => ((! [Xf1:$i] : ((XV @ Xf1) = (ccfv @ (XU @ Xf1) @ ccbs))) => ((! [Xf1:$i] : ((XF @ Xf1) = (ccfv @ (XU @ Xf1) @ cclfn))) => ((! [Xf1:$i] : ((XL @ Xf1) = (ccfv @ (XU @ Xf1) @ cclk))) => ((! [Xf1:$i] : ((XD @ Xf1) = (ccfv @ (XU @ Xf1) @ ccld))) => ((! [Xf1:$i] : ((XS @ Xf1) = (ccfv @ (XD @ Xf1) @ cclss))) => ((! [Xf1:$i] : (Xph => ((cwcel @ (XK @ Xf1) @ cchlt) & (cwcel @ (XW @ Xf1) @ (XH @ Xf1))))) => ((! [Xf1:$i] : (Xph => (cwcel @ (XR @ Xf1) @ (XS @ Xf1)))) => ((! [Xf1:$i] : ((XQ @ Xf1) = (cciun @ (^ [Xf1:$i] : (XR @ Xf1)) @ (^ [Xf1:$i] : (ccfv @ (ccfv @ (ccv @ Xf1) @ (XL @ Xf1)) @ (Xc_pe @ Xf1)))))) => ((! [Xf1:$i] : (Xph => (cwcel @ XX @ (XQ @ Xf1)))) => ((! [Xf1:$i] : ((XC @ Xf1) = (ccfv @ (XU @ Xf1) @ ccsca))) => ((! [Xf1:$i] : ((XB2 @ Xf1) = (ccfv @ (XC @ Xf1) @ ccbs))) => ((! [Xf1:$i] : (Xc_x = (ccfv @ (XU @ Xf1) @ ccvsca))) => ((! [Xf1:$i] : (Xph => (cwcel @ XA2 @ (XB2 @ Xf1)))) => (! [Xf1:$i] : (Xph => (cwcel @ (cco @ XA2 @ XX @ Xc_x) @ (XQ @ Xf1))))))))))))))))))))))))))))))))))))))).
...
thf(clcfr_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xg1:$i] : ((XH @ Xf1 @ Xg1) = (ccfv @ (XK @ Xf1 @ Xg1) @ cclh)))) => ((! [Xf1:$i] : (! [Xg1:$i] : (Xc_pe = (ccfv @ (XW @ Xf1 @ Xg1) @ (ccfv @ (XK @ Xf1 @ Xg1) @ ccoch))))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XU @ Xg1) = (ccfv @ (XW @ Xf1 @ Xg1) @ (ccfv @ (XK @ Xf1 @ Xg1) @ ccdvh))))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XS @ Xf1 @ Xg1) = (ccfv @ (XU @ Xg1) @ cclss)))) => ((! [Xg1:$i] : ((XF @ Xg1) = (ccfv @ (XU @ Xg1) @ cclfn))) => ((! [Xg1:$i] : (XL = (ccfv @ (XU @ Xg1) @ cclk))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XD @ Xf1 @ Xg1) = (ccfv @ (XU @ Xg1) @ ccld)))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XT @ Xf1 @ Xg1) = (ccfv @ (XD @ Xf1 @ Xg1) @ cclss)))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XC @ Xf1 @ Xg1) = (ccrab @ (^ [Xf1:$i] : ((ccfv @ (ccfv @ (ccfv @ (ccv @ Xf1) @ XL) @ Xc_pe) @ Xc_pe) = (ccfv @ (ccv @ Xf1) @ XL))) @ (^ [Xf1:$i] : (XF @ Xg1)))))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XQ @ Xf1 @ Xg1) = (cciun @ (^ [Xg1:$i] : (XR @ Xf1)) @ (^ [Xg1:$i] : (ccfv @ (ccfv @ (ccv @ Xg1) @ XL) @ Xc_pe)))))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xf1 @ Xg1) => ((cwcel @ (XK @ Xf1 @ Xg1) @ cchlt) & (cwcel @ (XW @ Xf1 @ Xg1) @ (XH @ Xf1 @ Xg1)))))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xf1 @ Xg1) => (cwcel @ (XR @ Xf1) @ (XT @ Xf1 @ Xg1))))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xf1 @ Xg1) => (cwss @ (XR @ Xf1) @ (XC @ Xf1 @ Xg1))))) => (! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xf1 @ Xg1) => (cwcel @ (XQ @ Xf1 @ Xg1) @ (XS @ Xf1 @ Xg1))))))))))))))))))))))))))))))))).
