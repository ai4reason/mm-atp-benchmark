...
thf(asalexct_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3)))) => ((XS = (ccrab @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) | (cwbr @ (ccdif @ XA2 @ (ccv @ Xx3)) @ ccom @ ccdom))) @ (^ [Xx3:$i] : (ccpw @ XA2)))) => (Xph => (cwcel @ XS @ ccsalg))))))))).
thf(aeqeltri_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwcel @ XB2 @ XC) => (cwcel @ XA2 @ XC))))))).
thf(aovex_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(aunisalgen_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ XV)) => ((XS = (ccfv @ XX @ ccsalgen)) => ((XU = (ccuni @ XX)) => (Xph => (cwcel @ XU @ XS))))))))))).
...
thf(asalexct2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : ((XA2 = (cco @ ccc0 @ cc2 @ ccicc)) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccrab @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) | (cwbr @ (ccdif @ XA2 @ (ccv @ Xx3)) @ ccom @ ccdom))) @ (^ [Xx3:$i] : (ccpw @ XA2))))) => ((XB2 = (cco @ ccc0 @ cc1 @ ccicc)) => (! [Xx3:$i] : (~ (cwcel @ XB2 @ (XS @ Xx3))))))))))).
thf(anelss_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ XB2) & (~ (cwcel @ XA2 @ XC))) => (~ (cwss @ XB2 @ XC))))))).
thf(csalgensscntex_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : ((XA2 @ Xy1) = (cco @ ccc0 @ cc2 @ ccicc))) => ((! [Xy1:$i] : (XS = (ccrab @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) | (cwbr @ (ccdif @ (XA2 @ Xy1) @ (ccv @ Xx3)) @ ccom @ ccdom))) @ (^ [Xx3:$i] : (ccpw @ (XA2 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XX @ Xx3 @ Xy1) = (ccrn @ (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xy1:$i] : (ccsn @ (ccv @ Xy1)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XG @ Xx3 @ Xy1) = (ccfv @ (XX @ Xx3 @ Xy1) @ ccsalgen)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cw3a @ (cwss @ (XX @ Xx3 @ Xy1) @ XS) @ (cwcel @ XS @ ccsalg) @ (~ (cwss @ (XG @ Xx3 @ Xy1) @ XS)))))))))))))).
