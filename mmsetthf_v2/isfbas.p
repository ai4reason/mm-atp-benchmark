...
thf(aelmptrab_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:$o] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : (XD @ Xy1)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((((ccv @ Xx3) = XX) & ((ccv @ Xy1) = XY)) => ((Xph @ Xx3 @ Xy1) <=> Xps)))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XX) => ((XB2 @ Xx3) = XC))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (XD @ Xy1)) => (cwcel @ (XB2 @ Xx3) @ XV)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XY @ (ccfv @ XX @ (XF @ Xx3 @ Xy1))) <=> (cw3a @ (cwcel @ XX @ (XD @ Xy1)) @ (cwcel @ XY @ XC) @ Xps)))))))))))))))))).
thf(adf_fbas_ax,axiom,(ccfbas = (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccrab @ (^ [Xx3:$i] : (cw3a @ (cwne @ (ccv @ Xx3) @ cc0) @ (cwnel @ cc0 @ (ccv @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwne @ (ccin @ (ccv @ Xx3) @ (ccpw @ (ccin @ (ccv @ Xy1) @ (ccv @ Xz)))) @ cc0)) @ (^ [Xz:$i] : (ccv @ Xx3)))) @ (^ [Xy1:$i] : (ccv @ Xx3))))) @ (^ [Xx3:$i] : (ccpw @ (ccpw @ (ccv @ Xw))))))))).
...
thf(cisfbas_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XB2 @ (XA2 @ Xx3 @ Xy1)) => ((cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) <=> ((cwss @ XF @ (ccpw @ XB2)) & (cw3a @ (cwne @ XF @ cc0) @ (cwnel @ cc0 @ XF) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwne @ (ccin @ XF @ (ccpw @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ cc0)) @ (^ [Xy1:$i] : XF))) @ (^ [Xx3:$i] : XF)))))))))))).
