...
thf(aopeo_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (~ (cwbr @ cc2 @ XA2 @ ccdvds))) & ((cwcel @ XB2 @ ccz) & (cwbr @ cc2 @ XB2 @ ccdvds))) => (~ (cwbr @ cc2 @ (cco @ XA2 @ XB2 @ ccaddc) @ ccdvds)))))).
...
thf(afsumsplitsnun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XZ:($i > $o)] : (! [Xk:$i] : ((cw3a @ (cwcel @ XA2 @ ccfn) @ ((cwcel @ XZ @ (XV @ Xk)) & (cwnel @ XZ @ XA2)) @ (cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xk) @ ccz)) @ (^ [Xk:$i] : (ccun @ XA2 @ (ccsn @ XZ))))) => ((ccsu @ (ccun @ XA2 @ (ccsn @ XZ)) @ (^ [Xk:$i] : (XB2 @ Xk))) = (cco @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccsb @ XZ @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccaddc))))))))).
thf(anotbi_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph <=> Xps) <=> ((~ Xph) <=> (~ Xps)))))).
thf(csumodd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccz))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (~ (cwbr @ cc2 @ (XB2 @ Xk) @ ccdvds)))) => (Xph => ((cwbr @ cc2 @ (ccfv @ XA2 @ cchash) @ ccdvds) <=> (cwbr @ cc2 @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccdvds)))))))))).
