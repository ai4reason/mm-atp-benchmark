...
thf(adf_pstm_ax,axiom,(ccpstm = (ccmpt @ (^ [Xd:$i] : (ccuni @ (ccrn @ ccpsmet))) @ (^ [Xd:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (ccqs @ (ccdm @ (ccdm @ (ccv @ Xd))) @ (ccfv @ (ccv @ Xd) @ ccmetid)))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccqs @ (ccdm @ (ccdm @ (ccv @ Xd))) @ (ccfv @ (ccv @ Xd) @ ccmetid)))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccuni @ (ccab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xz) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xd)))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xa))))))))))))).
...
thf(apsmetdmdm_ax,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) => (XX = (ccdm @ (ccdm @ XD))))))).
...
thf(aqseq1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((ccqs @ XA2 @ XC) = (ccqs @ XB2 @ XC))))))).
thf(asyl6reqr_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((XC = XB2) => (Xph => (XC = XA2))))))))).
thf(ccio_tp,type,(ccio : (($i > $o) > ($i > $o)))).
thf(afveq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))).
thf(aqseq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((ccqs @ XC @ XA2) = (ccqs @ XC @ XB2))))))).
...
thf(aqsexg_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwcel @ (ccqs @ XA2 @ XR) @ ccvv)))))).
...
thf(cpstmval_conj,conjecture,(! [XD:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XX:($i > $o)] : ((Xc_sm = (ccfv @ XD @ ccmetid)) => ((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) => ((ccfv @ XD @ ccpstm) = (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (ccqs @ XX @ Xc_sm))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccqs @ XX @ Xc_sm))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccuni @ (ccab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xz) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xa)))))))))))))))).
