...
thf(cgsumsubgcl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XS @ (ccfv @ XG @ ccsubg))) => ((Xph => (cwf @ XA2 @ XS @ XF)) => ((Xph => (cwbr @ XF @ Xc_0 @ ccfsupp)) => (Xph => (cwcel @ (cco @ XG @ XF @ ccgsu) @ XS)))))))))))))))).
