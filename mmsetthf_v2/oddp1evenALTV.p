...
thf(aisodd_ax,axiom,(! [XZ:($i > $o)] : ((cwcel @ XZ @ ccodd) <=> ((cwcel @ XZ @ ccz) & (cwcel @ (cco @ (cco @ XZ @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccz))))).
...
thf(coddp1evenALTV_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cwcel @ XN @ ccodd) <=> (cwcel @ (cco @ XN @ cc1 @ ccaddc) @ cceven))))).
