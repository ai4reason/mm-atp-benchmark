...
thf(clsslsp_conj,conjecture,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ XW @ XU @ ccress)) => ((XM = (ccfv @ XW @ cclspn)) => ((XN = (ccfv @ XX @ cclspn)) => ((XL = (ccfv @ XW @ cclss)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XU @ XL) @ (cwss @ XG @ XU)) => ((ccfv @ XG @ XM) = (ccfv @ XG @ XN))))))))))))))).
