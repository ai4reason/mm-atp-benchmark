...
thf(adgradd2_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (ccfv @ XF @ ccdgr)) => ((XN = (ccfv @ XG @ ccdgr)) => ((cw3a @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XG @ (ccfv @ XS @ ccply)) @ (cwbr @ XM @ XN @ cclt)) => ((ccfv @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ ccdgr) = XN)))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(aeqcomi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 = XB2) => (XB2 = XA2))))).
thf(adgrid_ax,axiom,((ccfv @ ccidp @ ccdgr) = cc1)).
...
thf(cplyremlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : ((XG = (cco @ ccidp @ (ccxp @ ccc @ (ccsn @ XA2)) @ (ccof @ ccmin))) => ((cwcel @ XA2 @ ccc) => (cw3a @ (cwcel @ XG @ (ccfv @ ccc @ ccply)) @ ((ccfv @ XG @ ccdgr) = cc1) @ ((ccima @ (cccnv @ XG) @ (ccsn @ ccc0)) = (ccsn @ XA2)))))))).
