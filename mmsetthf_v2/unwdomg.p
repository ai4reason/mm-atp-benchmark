...
thf(cunwdomg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cw3a @ (cwbr @ XA2 @ XB2 @ ccwdom) @ (cwbr @ XC @ XD @ ccwdom) @ ((ccin @ XB2 @ XD) = cc0)) => (cwbr @ (ccun @ XA2 @ XC) @ (ccun @ XB2 @ XD) @ ccwdom))))))).
