...
thf(cltmul12a_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ XA2 @ XB2 @ cclt))) & (((cwcel @ XC @ ccr) & (cwcel @ XD @ ccr)) & ((cwbr @ ccc0 @ XC @ ccle) & (cwbr @ XC @ XD @ cclt)))) => (cwbr @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XD @ ccmul) @ cclt))))))).
