...
thf(atancld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwne @ (ccfv @ XA2 @ cccos) @ ccc0)) => (Xph => (cwcel @ (ccfv @ XA2 @ cctan) @ ccc))))))).
...
thf(atanaddlem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) & ((cwne @ (ccfv @ XA2 @ cccos) @ ccc0) & (cwne @ (ccfv @ XB2 @ cccos) @ ccc0))) => ((cwne @ (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cccos) @ ccc0) <=> (cwne @ (cco @ (ccfv @ XA2 @ cctan) @ (ccfv @ XB2 @ cctan) @ ccmul) @ cc1)))))).
...
thf(aretancld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwne @ (ccfv @ XA2 @ cccos) @ ccc0)) => (Xph => (cwcel @ (ccfv @ XA2 @ cctan) @ ccr))))))).
thf(a_1re_ax,axiom,(cwcel @ cc1 @ ccr)).
thf(aresqcld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => (cwcel @ (cco @ XA2 @ cc2 @ ccexp) @ ccr)))))).
thf(aretanhcl_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwcel @ (cco @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cctan) @ cci @ ccdiv) @ ccr)))).
...
thf(arecjd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => (Xph => ((ccfv @ (ccfv @ XA2 @ cccj) @ ccre) = (ccfv @ XA2 @ ccre))))))).
...
thf(anegne0i_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwne @ XA2 @ ccc0) => (cwne @ (ccneg @ XA2) @ ccc0))))).
...
thf(aim1_ax,axiom,((ccfv @ cc1 @ ccim) = ccc0)).
...
thf(atanadd_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) & (cw3a @ (cwne @ (ccfv @ XA2 @ cccos) @ ccc0) @ (cwne @ (ccfv @ XB2 @ cccos) @ ccc0) @ (cwne @ (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cccos) @ ccc0))) => ((ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cctan) = (cco @ (cco @ (ccfv @ XA2 @ cctan) @ (ccfv @ XB2 @ cctan) @ ccaddc) @ (cco @ cc1 @ (cco @ (ccfv @ XA2 @ cctan) @ (ccfv @ XB2 @ cctan) @ ccmul) @ ccmin) @ ccdiv)))))).
...
thf(ctanregt0_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ (ccfv @ XA2 @ ccre) @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))) => (cwbr @ ccc0 @ (ccfv @ (ccfv @ XA2 @ cctan) @ ccre) @ cclt)))).
