...
thf(aaxc5c4c711toc7_ax,axiom,(! [Xph:($i > $o)] : (! [Xx3:$i] : ((~ (! [Xx3:$i] : (~ (! [Xx3:$i] : (Xph @ Xx3))))) => (Xph @ Xx3))))).
...
thf(aaxc5c4c711_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xy1:$i] : (((! [Xx3:$i] : (! [Xy1:$i] : (~ (! [Xx3:$i] : (! [Xy1:$i] : ((! [Xy1:$i] : (Xph @ Xx3 @ Xy1)) => (Xps @ Xx3 @ Xy1))))))) => ((Xph @ Xx3 @ Xy1) => (! [Xy1:$i] : ((! [Xy1:$i] : (Xph @ Xx3 @ Xy1)) => (Xps @ Xx3 @ Xy1))))) => ((! [Xy1:$i] : (Xph @ Xx3 @ Xy1)) => (! [Xy1:$i] : (Xps @ Xx3 @ Xy1))))))))).
...
thf(caxc5c4c711to11_conj,conjecture,(! [Xph:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph @ Xx3 @ Xy1))) => (! [Xy1:$i] : (! [Xx3:$i] : (Xph @ Xx3 @ Xy1)))))).
