...
thf(a_2wlkdlem1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XP = (ccs3 @ XA2 @ XB2 @ XC)) => ((XF = (ccs2 @ XJ @ XK)) => ((ccfv @ XP @ cchash) = (cco @ (ccfv @ XF @ cchash) @ cc1 @ ccaddc)))))))))))).
thf(a_2wlkdlem10_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xk:$i] : (XP = (ccs3 @ (XA2 @ Xk) @ (XB2 @ Xk) @ (XC @ Xk)))) => ((! [Xk:$i] : (XF = (ccs2 @ (XJ @ Xk) @ (XK @ Xk)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cw3a @ (cwcel @ (XA2 @ Xk) @ XV) @ (cwcel @ (XB2 @ Xk) @ XV) @ (cwcel @ (XC @ Xk) @ XV)))) => ((! [Xk:$i] : ((Xph @ Xk) => ((cwne @ (XA2 @ Xk) @ (XB2 @ Xk)) & (cwne @ (XB2 @ Xk) @ (XC @ Xk))))) => ((! [Xk:$i] : ((Xph @ Xk) => ((cwss @ (ccpr @ (XA2 @ Xk) @ (XB2 @ Xk)) @ (ccfv @ (XJ @ Xk) @ XI)) & (cwss @ (ccpr @ (XB2 @ Xk) @ (XC @ Xk)) @ (ccfv @ (XK @ Xk) @ XI))))) => (! [Xk:$i] : ((Xph @ Xk) => (cwral @ (^ [Xk:$i] : (cwss @ (ccpr @ (ccfv @ (ccv @ Xk) @ XP) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XP)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ XI))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))))))))))))))))))))).
thf(a_2wlkdlem5_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xk:$i] : (XP = (ccs3 @ (XA2 @ Xk) @ (XB2 @ Xk) @ (XC @ Xk)))) => ((! [Xk:$i] : (XF = (ccs2 @ (XJ @ Xk) @ (XK @ Xk)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cw3a @ (cwcel @ (XA2 @ Xk) @ XV) @ (cwcel @ (XB2 @ Xk) @ XV) @ (cwcel @ (XC @ Xk) @ XV)))) => ((! [Xk:$i] : ((Xph @ Xk) => ((cwne @ (XA2 @ Xk) @ (XB2 @ Xk)) & (cwne @ (XB2 @ Xk) @ (XC @ Xk))))) => (! [Xk:$i] : ((Xph @ Xk) => (cwral @ (^ [Xk:$i] : (cwne @ (ccfv @ (ccv @ Xk) @ XP) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XP))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))))))))))))))))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(a_3ad2ant1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xch) => ((cw3a @ Xph @ Xps @ Xth) => Xch))))))).
thf(a_1vgrex_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XN @ XV) => (cwcel @ XG @ ccvv))))))).
thf(cctp_tp,type,(cctp : (($i > $o) > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(a_2wlkdlem4_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xk:$i] : (XP = (ccs3 @ (XA2 @ Xk) @ (XB2 @ Xk) @ (XC @ Xk)))) => ((! [Xk:$i] : (XF = (ccs2 @ (XJ @ Xk) @ (XK @ Xk)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cw3a @ (cwcel @ (XA2 @ Xk) @ XV) @ (cwcel @ (XB2 @ Xk) @ XV) @ (cwcel @ (XC @ Xk) @ XV)))) => (! [Xk:$i] : ((Xph @ Xk) => (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccv @ Xk) @ XP) @ XV)) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz)))))))))))))))))).
