...
thf(c_4sqlem6_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XM @ ccn)) => ((XB2 = (cco @ (cco @ (cco @ XA2 @ (cco @ XM @ cc2 @ ccdiv) @ ccaddc) @ XM @ ccmo) @ (cco @ XM @ cc2 @ ccdiv) @ ccmin)) => (Xph => ((cwbr @ (ccneg @ (cco @ XM @ cc2 @ ccdiv)) @ XB2 @ ccle) & (cwbr @ XB2 @ (cco @ XM @ cc2 @ ccdiv) @ cclt))))))))))).
