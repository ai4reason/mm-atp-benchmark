...
thf(arexrab_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [Xch:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xy1) = (ccv @ Xx3)) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xx3))))) => (! [Xy1:$i] : ((cwrex @ (^ [Xx3:$i] : (Xch @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XA2 @ Xx3))))) <=> (cwrex @ (^ [Xx3:$i] : ((Xps @ Xx3) & (Xch @ Xx3 @ Xy1))) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))))).
...
thf(axkococnlem_ax,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((XF @ Xf1 @ Xg1 @ Xh) = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ (XS @ Xh) @ XT @ cccn))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ XR @ (XS @ Xh) @ cccn))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cccom @ (ccv @ Xf1) @ (ccv @ Xg1))))))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xz @ Xf1 @ Xg1 @ Xh) => (cwcel @ (XS @ Xh) @ (ccnlly @ cccmp))))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xz @ Xf1 @ Xg1 @ Xh) => (cwss @ (XK @ Xf1 @ Xg1) @ (ccuni @ XR))))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xz @ Xf1 @ Xg1 @ Xh) => (cwcel @ (cco @ XR @ (XK @ Xf1 @ Xg1) @ ccrest) @ cccmp)))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xz @ Xf1 @ Xg1 @ Xh) => (cwcel @ (XV @ Xf1 @ Xg1) @ XT)))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xz @ Xf1 @ Xg1 @ Xh) => (cwcel @ (XA2 @ Xf1 @ Xg1 @ Xh) @ (cco @ (XS @ Xh) @ XT @ cccn))))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xz @ Xf1 @ Xg1 @ Xh) => (cwcel @ (XB2 @ Xf1 @ Xg1 @ Xh) @ (cco @ XR @ (XS @ Xh) @ cccn))))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xz @ Xf1 @ Xg1 @ Xh) => (cwss @ (ccima @ (cccom @ (XA2 @ Xf1 @ Xg1 @ Xh) @ (XB2 @ Xf1 @ Xg1 @ Xh)) @ (XK @ Xf1 @ Xg1)) @ (XV @ Xf1 @ Xg1))))))) => (! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xz @ Xf1 @ Xg1 @ Xh) => (cwrex @ (^ [Xz:$i] : ((cwcel @ (ccop @ (XA2 @ Xf1 @ Xg1 @ Xh) @ (XB2 @ Xf1 @ Xg1 @ Xh)) @ (ccv @ Xz)) & (cwss @ (ccv @ Xz) @ (ccima @ (cccnv @ (XF @ Xf1 @ Xg1 @ Xh)) @ (ccrab @ (^ [Xh:$i] : (cwss @ (ccima @ (ccv @ Xh) @ (XK @ Xf1 @ Xg1)) @ (XV @ Xf1 @ Xg1))) @ (^ [Xh:$i] : (cco @ XR @ XT @ cccn))))))) @ (^ [Xz:$i] : (cco @ (cco @ XT @ (XS @ Xh) @ ccxko) @ (cco @ (XS @ Xh) @ XR @ ccxko) @ cctx)))))))))))))))))))))))))).
...
thf(axkotop_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XR @ cctop) & (cwcel @ XS @ cctop)) => (cwcel @ (cco @ XS @ XR @ ccxko) @ cctop))))).
thf(asimp1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) => Xph))))).
thf(atxtop_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XR @ cctop) & (cwcel @ XS @ cctop)) => (cwcel @ (cco @ XR @ XS @ cctx) @ cctop))))).
thf(aeltop2_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : ((cwcel @ XJ @ cctop) => ((cwcel @ XA2 @ XJ) <=> (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwss @ (ccv @ Xy1) @ XA2))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XA2))))))).
...
thf(cxkococn_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xg1:$i] : ((XF @ Xf1 @ Xg1) = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ XS @ XT @ cccn))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ XR @ XS @ cccn))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cccom @ (ccv @ Xf1) @ (ccv @ Xg1)))))))) => (! [Xf1:$i] : (! [Xg1:$i] : ((cw3a @ (cwcel @ XR @ cctop) @ (cwcel @ XS @ (ccnlly @ cccmp)) @ (cwcel @ XT @ cctop)) => (cwcel @ (XF @ Xf1 @ Xg1) @ (cco @ (cco @ (cco @ XT @ XS @ ccxko) @ (cco @ XS @ XR @ ccxko) @ cctx) @ (cco @ XT @ XR @ ccxko) @ cccn))))))))))).
