...
thf(cconjnmzb_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [Xc_mi:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((! [Xz:$i] : ((Xc_mi @ Xz) = (ccfv @ XG @ ccsg))) => ((! [Xx3:$i] : (! [Xz:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (cco @ (cco @ XA2 @ (ccv @ Xx3) @ Xc_pl) @ XA2 @ (Xc_mi @ Xz))))))) => ((! [Xy1:$i] : (! [Xz:$i] : ((XN @ Xy1 @ Xz) = (ccrab @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_pl) @ XS) <=> (cwcel @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ Xc_pl) @ XS))) @ (^ [Xz:$i] : XX))) @ (^ [Xy1:$i] : XX))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ XS @ (ccfv @ XG @ ccsubg)) => ((cwcel @ XA2 @ (XN @ Xy1 @ Xz)) <=> ((cwcel @ XA2 @ XX) & (XS = (ccrn @ (XF @ Xx3))))))))))))))))))))))).
