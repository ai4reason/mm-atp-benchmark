...
thf(csubgnm_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XH = (cco @ XG @ XA2 @ ccress)) => ((XN = (ccfv @ XG @ ccnm)) => ((XM = (ccfv @ XH @ ccnm)) => ((cwcel @ XA2 @ (ccfv @ XG @ ccsubg)) => (XM = (ccres @ XN @ XA2)))))))))))).
