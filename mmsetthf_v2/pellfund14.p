...
thf(apell14qrrp_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) & (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr))) => (cwcel @ XA2 @ ccrp))))).
thf(aadantr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph & Xch) => Xps)))))).
thf(apellfundrp_ax,axiom,(! [XD:($i > $o)] : ((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) => (cwcel @ (ccfv @ XD @ ccpellfund) @ ccrp)))).
thf(apellfundne1_ax,axiom,(! [XD:($i > $o)] : ((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) => (cwne @ (ccfv @ XD @ ccpellfund) @ cc1)))).
thf(areglogcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XB2 @ ccrp) @ (cwne @ XB2 @ cc1)) => (cwcel @ (cco @ (ccfv @ XA2 @ cclog) @ (ccfv @ XB2 @ cclog) @ ccdiv) @ ccr))))).
thf(amulcan2ad_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwne @ XC @ ccc0)) => ((Xph => ((cco @ XA2 @ XC @ ccmul) = (cco @ XB2 @ XC @ ccmul))) => (Xph => (XA2 = XB2)))))))))))).
...
thf(apell1qrss14_ax,axiom,(! [XD:($i > $o)] : ((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) => (cwss @ (ccfv @ XD @ ccpell1qr) @ (ccfv @ XD @ ccpell14qr))))).
thf(apellfundex_ax,axiom,(! [XD:($i > $o)] : ((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) => (cwcel @ (ccfv @ XD @ ccpellfund) @ (ccfv @ XD @ ccpell1qr))))).
thf(apell14qrexpcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((cw3a @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) @ (cwcel @ XB2 @ ccz)) => (cwcel @ (cco @ XA2 @ XB2 @ ccexp) @ (ccfv @ XD @ ccpell14qr))))))).
...
thf(amodfrac_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cco @ XA2 @ cc1 @ ccmo) = (cco @ XA2 @ (ccfv @ XA2 @ ccfl) @ ccmin))))).
thf(areglog1_ax,axiom,(! [XC:($i > $o)] : (((cwcel @ XC @ ccrp) & (cwne @ XC @ cc1)) => ((cco @ (ccfv @ cc1 @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) = ccc0)))).
thf(areglogmul_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XB2 @ ccrp) @ ((cwcel @ XC @ ccrp) & (cwne @ XC @ cc1))) => ((cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) = (cco @ (cco @ (ccfv @ XA2 @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) @ (cco @ (ccfv @ XB2 @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) @ ccaddc))))))).
thf(aoveq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))))).
thf(asyl12anc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xps) => ((Xph => Xch) => ((Xph => Xth) => (((Xps & (Xch & Xth)) => Xta) => (Xph => Xta))))))))))).
thf(areglogexpbas_ax,axiom,(! [XC:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & ((cwcel @ XC @ ccrp) & (cwne @ XC @ cc1))) => ((cco @ (ccfv @ (cco @ XC @ XN @ ccexp) @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) = XN))))).
...
thf(apellfundgt1_ax,axiom,(! [XD:($i > $o)] : ((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) => (cwbr @ cc1 @ (ccfv @ XD @ ccpellfund) @ cclt)))).
thf(areglogleb_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccrp) & (cwcel @ XB2 @ ccrp)) & ((cwcel @ XC @ ccrp) & (cwbr @ cc1 @ XC @ cclt))) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwbr @ (cco @ (ccfv @ XA2 @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) @ (cco @ (ccfv @ XB2 @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) @ ccle))))))).
thf(aeqbrtrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (cwbr @ XB2 @ XC @ XR)) => (Xph => (cwbr @ XA2 @ XC @ XR)))))))))).
thf(amodlt_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccrp)) => (cwbr @ (cco @ XA2 @ XB2 @ ccmo) @ XB2 @ cclt))))).
thf(areglogbas_ax,axiom,(! [XC:($i > $o)] : (((cwcel @ XC @ ccrp) & (cwne @ XC @ cc1)) => ((cco @ (ccfv @ XC @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) = cc1)))).
thf(areglogltb_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccrp) & (cwcel @ XB2 @ ccrp)) & ((cwcel @ XC @ ccrp) & (cwbr @ cc1 @ XC @ cclt))) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (cco @ (ccfv @ XA2 @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) @ (cco @ (ccfv @ XB2 @ cclog) @ (ccfv @ XC @ cclog) @ ccdiv) @ cclt))))))).
thf(apellfund14gap_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((cw3a @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) @ ((cwbr @ cc1 @ XA2 @ ccle) & (cwbr @ XA2 @ (ccfv @ XD @ ccpellfund) @ cclt))) => (XA2 = cc1))))).
...
thf(cpellfund14_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) & (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr))) => (cwrex @ (^ [Xx3:$i] : (XA2 = (cco @ (ccfv @ XD @ ccpellfund) @ (ccv @ Xx3) @ ccexp))) @ (^ [Xx3:$i] : ccz)))))).
