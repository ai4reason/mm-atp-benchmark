...
thf(aetasslt_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccsslt) => (cwrex @ (^ [Xx3:$i] : (cw3a @ (cwbr @ XA2 @ (ccsn @ (ccv @ Xx3)) @ ccsslt) @ (cwbr @ (ccsn @ (ccv @ Xx3)) @ XB2 @ ccsslt) @ (cwss @ (ccfv @ (ccv @ Xx3) @ ccbday) @ (ccsuc @ (ccuni @ (ccima @ ccbday @ (ccun @ XA2 @ XB2))))))) @ (^ [Xx3:$i] : ccsur)))))).
...
thf(cscutbdaybnd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccsslt) => (cwss @ (ccfv @ (cco @ XA2 @ XB2 @ ccscut) @ ccbday) @ (ccsuc @ (ccuni @ (ccima @ ccbday @ (ccun @ XA2 @ XB2))))))))).
