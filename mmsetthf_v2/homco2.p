...
thf(chomco2_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XT @ cclo) @ (cwf @ cchil @ cchil @ XU)) => ((cccom @ XT @ (cco @ XA2 @ XU @ cchot)) = (cco @ XA2 @ (cccom @ XT @ XU) @ cchot))))))).
