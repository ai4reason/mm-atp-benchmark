...
thf(aexpnegd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwne @ XA2 @ ccc0)) => ((Xph => (cwcel @ XN @ ccz)) => (Xph => ((cco @ XA2 @ (ccneg @ XN) @ ccexp) = (cco @ cc1 @ (cco @ XA2 @ XN @ ccexp) @ ccdiv)))))))))).
...
thf(acxplim_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccrp) @ (^ [Xn:$i] : (cco @ cc1 @ (cco @ (ccv @ Xn) @ XA2 @ cccxp) @ ccdiv))) @ ccc0 @ ccrli)))).
...
thf(csignsplypnf_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XD = (ccfv @ XF @ ccdgr)) => ((XC = (ccfv @ XF @ cccoe)) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccfv @ XD @ XC))) => ((XG = (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XD @ ccexp)))) => (! [Xx3:$i] : ((cwcel @ XF @ (ccfv @ ccr @ ccply)) => (cwbr @ (cco @ XF @ XG @ (ccof @ ccdiv)) @ (XB2 @ Xx3) @ ccrli))))))))))))).
