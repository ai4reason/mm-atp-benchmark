...
thf(celuzgtdifelfzo_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => (((cwcel @ XN @ (ccfv @ XA2 @ ccuz)) & (cwbr @ XB2 @ XA2 @ cclt)) => (cwcel @ (cco @ XN @ XA2 @ ccmin) @ (cco @ ccc0 @ (cco @ XN @ XB2 @ ccmin) @ ccfzo)))))))).
