...
thf(afnwe_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XT @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XA2)) & ((cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ XR) | (((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xy1) @ XF)) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XS)))))))))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwf @ XA2 @ XB2 @ XF))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwwe @ XB2 @ XR))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwwe @ XA2 @ XS))) => ((! [Xy1:$i] : (! [Xw:$i] : ((Xph @ Xy1) => (cwcel @ (ccima @ XF @ (ccv @ Xw)) @ ccvv)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xy1) => (cwwe @ XA2 @ (XT @ Xx3 @ Xy1)))))))))))))))))).
...
thf(aordun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cword @ XA2) & (cword @ XB2)) => (cword @ (ccun @ XA2 @ XB2)))))).
thf(aepweon_ax,axiom,(cwwe @ ccon0 @ ccep)).
thf(aleweon_ax,axiom,(! [XL:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XL @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (ccxp @ ccon0 @ ccon0)) & (cwcel @ (ccv @ Xy1) @ (ccxp @ ccon0 @ ccon0))) & ((cwcel @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc1st)) | (((ccfv @ (ccv @ Xx3) @ cc1st) = (ccfv @ (ccv @ Xy1) @ cc1st)) & (cwcel @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccfv @ (ccv @ Xy1) @ cc2nd))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwwe @ (ccxp @ ccon0 @ ccon0) @ (XL @ Xx3 @ Xy1))))))).
...
thf(aimadmres_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccima @ XA2 @ (ccdm @ (ccres @ XA2 @ XB2))) = (ccima @ XA2 @ XB2))))).
...
thf(aopelrn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ (ccop @ XA2 @ XB2) @ XC) => (cwcel @ XB2 @ (ccrn @ XC))))))))).
thf(aprssi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ XC) & (cwcel @ XB2 @ XC)) => (cwss @ (ccpr @ XA2 @ XB2) @ XC)))))).
thf(aordunpr_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XB2 @ ccon0) & (cwcel @ XC @ ccon0)) => (cwcel @ (ccun @ XB2 @ XC) @ (ccpr @ XB2 @ XC)))))).
...
thf(afnse_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((XT @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (XA2 @ Xw)) & (cwcel @ (ccv @ Xy1) @ (XA2 @ Xw))) & ((cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ XR) | (((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xy1) @ XF)) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XS @ Xw)))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1) => (cwf @ (XA2 @ Xw) @ (XB2 @ Xx3 @ Xy1) @ XF))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwse @ (XB2 @ Xx3 @ Xy1) @ XR)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xw)) @ ccvv))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1) => (cwse @ (XA2 @ Xw) @ (XT @ Xx3 @ Xy1)))))))))))))))))).
...
thf(aelxp6_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccxp @ XB2 @ XC)) <=> ((XA2 = (ccop @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XA2 @ cc2nd))) & ((cwcel @ (ccfv @ XA2 @ cc1st) @ XB2) & (cwcel @ (ccfv @ XA2 @ cc2nd) @ XC)))))))).
thf(cr0weon_conj,conjecture,(! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XL @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (ccxp @ ccon0 @ ccon0)) & (cwcel @ (ccv @ Xy1) @ (ccxp @ ccon0 @ ccon0))) & ((cwcel @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc1st)) | (((ccfv @ (ccv @ Xx3) @ cc1st) = (ccfv @ (ccv @ Xy1) @ cc1st)) & (cwcel @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccfv @ (ccv @ Xy1) @ cc2nd))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XR @ Xx3 @ Xy1 @ Xz @ Xw) = (ccopab @ (^ [Xz:$i] : (^ [Xw:$i] : (((cwcel @ (ccv @ Xz) @ (ccxp @ ccon0 @ ccon0)) & (cwcel @ (ccv @ Xw) @ (ccxp @ ccon0 @ ccon0))) & ((cwcel @ (ccun @ (ccfv @ (ccv @ Xz) @ cc1st) @ (ccfv @ (ccv @ Xz) @ cc2nd)) @ (ccun @ (ccfv @ (ccv @ Xw) @ cc1st) @ (ccfv @ (ccv @ Xw) @ cc2nd))) | (((ccun @ (ccfv @ (ccv @ Xz) @ cc1st) @ (ccfv @ (ccv @ Xz) @ cc2nd)) = (ccun @ (ccfv @ (ccv @ Xw) @ cc1st) @ (ccfv @ (ccv @ Xw) @ cc2nd))) & (cwbr @ (ccv @ Xz) @ (ccv @ Xw) @ (XL @ Xx3 @ Xy1))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((cwwe @ (ccxp @ ccon0 @ ccon0) @ (XR @ Xx3 @ Xy1 @ Xz @ Xw)) & (cwse @ (ccxp @ ccon0 @ ccon0) @ (XR @ Xx3 @ Xy1 @ Xz @ Xw)))))))))))).
