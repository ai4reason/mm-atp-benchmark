...
thf(aproot1mul_ax,axiom,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (cco @ (ccfv @ XR @ ccmgp) @ (ccfv @ XR @ ccui) @ ccress)) => ((XO = (ccfv @ XG @ ccod)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => ((((cwcel @ XR @ ccidom) & (cwcel @ XN @ ccn)) & ((cwcel @ XX @ (ccima @ (cccnv @ XO) @ (ccsn @ XN))) & (cwcel @ XY @ (ccima @ (cccnv @ XO) @ (ccsn @ XN))))) => (cwcel @ XX @ (ccfv @ (ccsn @ XY) @ XK)))))))))))))).
...
thf(aodngen_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => ((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XX) @ (cwcel @ (ccfv @ XA2 @ XO) @ ccn)) => ((ccfv @ (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XO) = (ccfv @ XA2 @ XO))) @ (^ [Xx3:$i] : (ccfv @ (ccsn @ XA2) @ XK))) @ cchash) = (ccfv @ (ccfv @ XA2 @ XO) @ ccphi)))))))))))).
thf(cproot1hash_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XG = (cco @ (ccfv @ XR @ ccmgp) @ (ccfv @ XR @ ccui) @ ccress)) => ((XO = (ccfv @ XG @ ccod)) => ((cw3a @ (cwcel @ XR @ ccidom) @ (cwcel @ XN @ ccn) @ (cwcel @ XX @ (ccima @ (cccnv @ XO) @ (ccsn @ XN)))) => ((ccfv @ (ccima @ (cccnv @ XO) @ (ccsn @ XN)) @ cchash) = (ccfv @ XN @ ccphi))))))))))).
