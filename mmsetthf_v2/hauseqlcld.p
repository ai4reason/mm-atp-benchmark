...
thf(ahausdiag_ax,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ ccha) <=> ((cwcel @ XJ @ cctop) & (cwcel @ (ccres @ ccid @ XX) @ (ccfv @ (cco @ XJ @ XJ @ cctx) @ cccld)))))))).
...
thf(chauseqlcld_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XK @ ccha)) => ((Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ XJ @ XK @ cccn))) => (Xph => (cwcel @ (ccdm @ (ccin @ XF @ XG)) @ (ccfv @ XJ @ cccld)))))))))))).
