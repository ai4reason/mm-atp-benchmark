...
thf(abcm1nt_ax,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) => ((cco @ XN @ XK @ ccbc) = (cco @ (cco @ (cco @ XN @ cc1 @ ccmin) @ XK @ ccbc) @ (cco @ XN @ (cco @ XN @ XK @ ccmin) @ ccdiv) @ ccmul)))))).
