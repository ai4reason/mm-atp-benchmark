...
thf(aisclo2_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XA2 @ XX)) => ((cwcel @ XA2 @ (ccin @ XJ @ (ccfv @ XJ @ cccld))) <=> (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwral @ (^ [Xz:$i] : ((cwcel @ (ccv @ Xz) @ XA2) => (cwss @ (ccv @ Xy1) @ XA2))) @ (^ [Xz:$i] : (ccv @ Xy1))))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XX))))))))).
