...
thf(csupgtoreq_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((Xph => (cwor @ XA2 @ XR)) => ((Xph => (cwss @ XB2 @ XA2)) => ((Xph => (cwcel @ XB2 @ ccfn)) => ((Xph => (cwcel @ XC @ XB2)) => ((Xph => (XS = (ccsup @ XB2 @ XA2 @ XR))) => (Xph => ((cwbr @ XC @ XS @ XR) | (XC = XS))))))))))))))).
