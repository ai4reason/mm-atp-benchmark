...
thf(clmodvsneg_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XN = (ccfv @ XW @ ccminusg)) => ((XK = (ccfv @ XF @ ccbs)) => ((XM = (ccfv @ XF @ ccminusg)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XR @ XK)) => (Xph => ((ccfv @ (cco @ XR @ XX @ Xc_x) @ XN) = (cco @ (ccfv @ XR @ XM) @ XX @ Xc_x))))))))))))))))))))))).
