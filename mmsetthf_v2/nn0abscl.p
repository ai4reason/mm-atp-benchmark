...
thf(aabsz_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XA2 @ ccz) <=> (cwcel @ (ccfv @ XA2 @ ccabs) @ ccz))))).
...
thf(cnn0abscl_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccz) => (cwcel @ (ccfv @ XA2 @ ccabs) @ ccn0)))).
