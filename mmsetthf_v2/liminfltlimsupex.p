...
thf(aliminf10ex_ax,axiom,(! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwbr @ cc2 @ (ccv @ Xn) @ ccdvds) @ ccc0 @ cc1))))) => (! [Xn:$i] : ((ccfv @ (XF @ Xn) @ cclsi) = ccc0))))).
thf(ccle_tp,type,(ccle : ($i > $o))).
thf(alimsup10ex_ax,axiom,(! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwbr @ cc2 @ (ccv @ Xn) @ ccdvds) @ ccc0 @ cc1))))) => (! [Xn:$i] : ((ccfv @ (XF @ Xn) @ cclsp) = cc1))))).
