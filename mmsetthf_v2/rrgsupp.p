...
thf(arrgeq0_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XE = (ccfv @ XR @ ccrlreg)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XE) @ (cwcel @ XY @ XB2)) => (((cco @ XX @ XY @ Xc_x) = Xc_0) <=> (XY = Xc_0))))))))))))))).
