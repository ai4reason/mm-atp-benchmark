...
thf(atposf2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwrel @ XA2) => ((cwf @ XA2 @ XB2 @ XF) => (cwf @ (cccnv @ XA2) @ XB2 @ (cctpos @ XF)))))))).
...
thf(ctposf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ (ccxp @ XA2 @ XB2) @ XC @ XF) => (cwf @ (ccxp @ XB2 @ XA2) @ XC @ (cctpos @ XF)))))))).
