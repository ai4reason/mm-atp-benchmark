...
thf(clmbr_conj,conjecture,(! [Xph:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XJ @ (ccfv @ XX @ cctopon)))) => (! [Xy1:$i] : ((Xph @ Xy1) => ((cwbr @ XF @ (XP @ Xy1) @ (ccfv @ XJ @ cclm)) <=> (cw3a @ (cwcel @ XF @ (cco @ XX @ ccc @ ccpm)) @ (cwcel @ (XP @ Xy1) @ XX) @ (cwral @ (^ [Xu:$i] : ((cwcel @ (XP @ Xy1) @ (ccv @ Xu)) => (cwrex @ (^ [Xy1:$i] : (cwf @ (ccv @ Xy1) @ (ccv @ Xu) @ (ccres @ XF @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccrn @ ccuz))))) @ (^ [Xu:$i] : XJ))))))))))))).
