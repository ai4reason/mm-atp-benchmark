...
thf(afourierdlem60_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ XF)) => ((Xph => (cwcel @ XY @ (cco @ XF @ XB2 @ cclimc))) => ((XG = (cco @ ccr @ XF @ ccdv)) => ((Xph => ((ccdm @ XG) = (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => (cwcel @ XE @ (cco @ XG @ XB2 @ cclimc))) => ((! [Xs1:$i] : ((XH @ Xs1) = (ccmpt @ (^ [Xs1:$i] : (cco @ (cco @ XA2 @ XB2 @ ccmin) @ ccc0 @ ccioo)) @ (^ [Xs1:$i] : (cco @ (cco @ (ccfv @ (cco @ XB2 @ (ccv @ Xs1) @ ccaddc) @ XF) @ XY @ ccmin) @ (ccv @ Xs1) @ ccdiv))))) => ((XN = (ccmpt @ (^ [Xs1:$i] : (cco @ (cco @ XA2 @ XB2 @ ccmin) @ ccc0 @ ccioo)) @ (^ [Xs1:$i] : (cco @ (ccfv @ (cco @ XB2 @ (ccv @ Xs1) @ ccaddc) @ XF) @ XY @ ccmin)))) => ((XD = (ccmpt @ (^ [Xs1:$i] : (cco @ (cco @ XA2 @ XB2 @ ccmin) @ ccc0 @ ccioo)) @ (^ [Xs1:$i] : (ccv @ Xs1)))) => (! [Xs1:$i] : (Xph => (cwcel @ XE @ (cco @ (XH @ Xs1) @ ccc0 @ cclimc)))))))))))))))))))))))))).
...
thf(afourierdlem15_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XQ:($i > ($i > $o))] : (! [XM:($i > $o)] : ((! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : ((XP @ Xi @ Xm @ Xp) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccrab @ (^ [Xp:$i] : ((((ccfv @ ccc0 @ (ccv @ Xp)) = XA2) & ((ccfv @ (ccv @ Xm) @ (ccv @ Xp)) = XB2)) & (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xm) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ ccr @ (cco @ ccc0 @ (ccv @ Xm) @ ccfz) @ ccmap))))))))) => ((! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwcel @ XM @ ccn)))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwcel @ (XQ @ Xm) @ (ccfv @ XM @ (XP @ Xi @ Xm @ Xp))))))) => (! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwf @ (cco @ ccc0 @ XM @ ccfz) @ (cco @ XA2 @ XB2 @ ccicc) @ (XQ @ Xm))))))))))))))).
...
thf(alimcresi_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (cwss @ (cco @ XF @ XB2 @ cclimc) @ (cco @ (ccres @ XF @ XC) @ XB2 @ cclimc)))))).
...
thf(altnsymd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => (Xph => (~ (cwbr @ XB2 @ XA2 @ cclt)))))))))).
...
thf(altaddneg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ XA2 @ ccc0 @ cclt) <=> (cwbr @ (cco @ XB2 @ XA2 @ ccaddc) @ XB2 @ cclt)))))).
...
thf(adivlimc_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xx3) @ (XC @ Xx3) @ ccdiv))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XC @ Xx3) @ (ccdif @ ccc @ (ccsn @ ccc0))))) => ((! [Xx3:$i] : (Xph => (cwcel @ XX @ (cco @ (XF @ Xx3) @ XD @ cclimc)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XY @ (cco @ (XG @ Xx3) @ XD @ cclimc)))) => ((Xph => (cwne @ XY @ ccc0)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwne @ (XC @ Xx3) @ ccc0))) => (! [Xx3:$i] : (Xph => (cwcel @ (cco @ XX @ XY @ ccdiv) @ (cco @ (XH @ Xx3) @ XD @ cclimc)))))))))))))))))))))))).
...
thf(asublimc_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xx3) @ (XC @ Xx3) @ ccmin))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XC @ Xx3) @ ccc))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XE @ Xx3) @ (cco @ (XF @ Xx3) @ (XD @ Xx3) @ cclimc)))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XI @ Xx3) @ (cco @ (XG @ Xx3) @ (XD @ Xx3) @ cclimc)))) => (! [Xx3:$i] : (Xph => (cwcel @ (cco @ (XE @ Xx3) @ (XI @ Xx3) @ ccmin) @ (cco @ (XH @ Xx3) @ (XD @ Xx3) @ cclimc)))))))))))))))))))))).
thf(afourierdlem53_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwf @ ccr @ ccr @ XF)) => ((Xph => (cwcel @ XX @ ccr)) => ((Xph => (cwss @ XA2 @ ccr)) => ((! [Xs1:$i] : ((XG @ Xs1) = (ccmpt @ (^ [Xs1:$i] : XA2) @ (^ [Xs1:$i] : (ccfv @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XF))))) => ((! [Xs1:$i] : ((Xph & (cwcel @ (ccv @ Xs1) @ XA2)) => (cwcel @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XB2))) => ((Xph => (cwss @ XB2 @ ccr)) => ((! [Xs1:$i] : ((Xph & (cwcel @ (ccv @ Xs1) @ XA2)) => (cwne @ (ccv @ Xs1) @ XD))) => ((! [Xs1:$i] : (Xph => (cwcel @ (XC @ Xs1) @ (cco @ (ccres @ XF @ XB2) @ (cco @ XX @ XD @ ccaddc) @ cclimc)))) => ((Xph => (cwcel @ XD @ ccc)) => (! [Xs1:$i] : (Xph => (cwcel @ (XC @ Xs1) @ (cco @ (XG @ Xs1) @ XD @ cclimc)))))))))))))))))))))).
...
thf(alttri5d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwne @ XA2 @ XB2)) => ((Xph => (~ (cwbr @ XB2 @ XA2 @ cclt))) => (Xph => (cwbr @ XA2 @ XB2 @ cclt)))))))))).
...
thf(acondan_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & (~ Xps)) => Xch) => (((Xph & (~ Xps)) => (~ Xch)) => (Xph => Xps))))))).
...
thf(alimcrecl_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : ((Xph => (cwf @ XA2 @ ccr @ XF)) => ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ (ccfv @ XA2 @ (ccfv @ (ccfv @ cccnfld @ cctopn) @ cclp)))) => ((Xph => (cwcel @ XL @ (cco @ XF @ XB2 @ cclimc))) => (Xph => (cwcel @ XL @ ccr)))))))))))).
...
thf(cfourierdlem74_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XO:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > ($i > ($i > $o))))] : ((! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwcel @ XX @ ccr)))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : ((XP @ Xi @ Xm @ Xs1 @ Xp) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccrab @ (^ [Xp:$i] : ((((ccfv @ ccc0 @ (ccv @ Xp)) = (cco @ (ccneg @ ccpi) @ XX @ ccaddc)) & ((ccfv @ (ccv @ Xm) @ (ccv @ Xp)) = (cco @ ccpi @ XX @ ccaddc))) & (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xm) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ ccr @ (cco @ ccc0 @ (ccv @ Xm) @ ccfz) @ ccmap)))))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwf @ ccr @ ccr @ (XF @ Xi @ Xm @ Xp)))))) => ((! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwcel @ XX @ (ccrn @ (XV @ Xm)))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwcel @ (XY @ Xi @ Xm @ Xp) @ ccr))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwcel @ (XW @ Xi @ Xm @ Xp) @ (cco @ (ccres @ (XF @ Xi @ Xm @ Xp) @ (cco @ ccmnf @ XX @ ccioo)) @ XX @ cclimc)))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : ((XH @ Xi @ Xm @ Xp) = (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (ccif @ ((ccv @ Xs1) = ccc0) @ ccc0 @ (cco @ (cco @ (ccfv @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ (XF @ Xi @ Xm @ Xp)) @ (ccif @ (cwbr @ ccc0 @ (ccv @ Xs1) @ cclt) @ (XY @ Xi @ Xm @ Xp) @ (XW @ Xi @ Xm @ Xp)) @ ccmin) @ (ccv @ Xs1) @ ccdiv)))))))) => ((! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwcel @ XM @ ccn)))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwcel @ (XV @ Xm) @ (ccfv @ XM @ (XP @ Xi @ Xm @ Xs1 @ Xp)))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : (((Xph @ Xm @ Xp) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XM @ ccfzo))) => (cwcel @ (XR @ Xi @ Xm @ Xp) @ (cco @ (ccres @ (XF @ Xi @ Xm @ Xp) @ (cco @ (ccfv @ (ccv @ Xi) @ (XV @ Xm)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XV @ Xm)) @ ccioo)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XV @ Xm)) @ cclimc)))))) => ((! [Xm:$i] : ((XQ @ Xm) = (ccmpt @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfz)) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (XV @ Xm)) @ XX @ ccmin))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : ((XO @ Xi @ Xm @ Xs1 @ Xp) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccrab @ (^ [Xp:$i] : ((((ccfv @ ccc0 @ (ccv @ Xp)) = (ccneg @ ccpi)) & ((ccfv @ (ccv @ Xm) @ (ccv @ Xp)) = ccpi)) & (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xm) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ ccr @ (cco @ ccc0 @ (ccv @ Xm) @ ccfz) @ ccmap)))))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : ((XG @ Xi @ Xm @ Xs1 @ Xp) = (cco @ ccr @ (XF @ Xi @ Xm @ Xp) @ ccdv)))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : (((Xph @ Xm @ Xp) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XM @ ccfzo))) => (cwf @ (cco @ (ccfv @ (ccv @ Xi) @ (XV @ Xm)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XV @ Xm)) @ ccioo) @ ccr @ (ccres @ (XG @ Xi @ Xm @ Xs1 @ Xp) @ (cco @ (ccfv @ (ccv @ Xi) @ (XV @ Xm)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XV @ Xm)) @ ccioo)))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwcel @ (XE @ Xi @ Xm @ Xp) @ (cco @ (ccres @ (XG @ Xi @ Xm @ Xs1 @ Xp) @ (cco @ ccmnf @ XX @ ccioo)) @ XX @ cclimc))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : ((XA2 @ Xi @ Xm @ Xs1 @ Xp) = (ccif @ ((ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XV @ Xm)) = XX) @ (XE @ Xi @ Xm @ Xp) @ (cco @ (cco @ (XR @ Xi @ Xm @ Xp) @ (ccif @ (cwbr @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XV @ Xm)) @ XX @ cclt) @ (XW @ Xi @ Xm @ Xp) @ (XY @ Xi @ Xm @ Xp)) @ ccmin) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm)) @ ccdiv))))))) => (! [Xi:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xp:$i] : (((Xph @ Xm @ Xp) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XM @ ccfzo))) => (cwcel @ (XA2 @ Xi @ Xm @ Xs1 @ Xp) @ (cco @ (ccres @ (XH @ Xi @ Xm @ Xp) @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xm)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm)) @ ccioo)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xm)) @ cclimc))))))))))))))))))))))))))))))))))))))).
