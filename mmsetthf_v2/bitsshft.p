...
thf(abitsuz_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccn0)) => ((cwbr @ (cco @ cc2 @ XN @ ccexp) @ XA2 @ ccdvds) <=> (cwss @ (ccfv @ XA2 @ ccbits) @ (ccfv @ XN @ ccuz))))))).
...
thf(cbitsshft_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccn0)) => ((ccrab @ (^ [Xn:$i] : (cwcel @ (cco @ (ccv @ Xn) @ XN @ ccmin) @ (ccfv @ XA2 @ ccbits))) @ (^ [Xn:$i] : ccn0)) = (ccfv @ (cco @ XA2 @ (cco @ cc2 @ XN @ ccexp) @ ccmul) @ ccbits)))))).
