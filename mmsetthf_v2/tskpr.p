...
thf(atskinf_ax,axiom,(! [XT:($i > $o)] : (((cwcel @ XT @ cctsk) & (cwne @ XT @ cc0)) => (cwbr @ ccom @ XT @ ccdom)))).
...
thf(ctskpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwcel @ XT @ cctsk) @ (cwcel @ XA2 @ XT) @ (cwcel @ XB2 @ XT)) => (cwcel @ (ccpr @ XA2 @ XB2) @ XT)))))).
