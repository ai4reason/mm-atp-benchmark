...
thf(a_4sqlem6_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XM @ ccn)) => ((XB2 = (cco @ (cco @ (cco @ XA2 @ (cco @ XM @ cc2 @ ccdiv) @ ccaddc) @ XM @ ccmo) @ (cco @ XM @ cc2 @ ccdiv) @ ccmin)) => (Xph => ((cwbr @ (ccneg @ (cco @ XM @ cc2 @ ccdiv)) @ XB2 @ ccle) & (cwbr @ XB2 @ (cco @ XM @ cc2 @ ccdiv) @ cclt))))))))))).
...
thf(c_4sqlem10_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XM @ ccn)) => ((XB2 = (cco @ (cco @ (cco @ XA2 @ (cco @ XM @ cc2 @ ccdiv) @ ccaddc) @ XM @ ccmo) @ (cco @ XM @ cc2 @ ccdiv) @ ccmin)) => (((Xph & Xps) => ((cco @ (cco @ (cco @ (cco @ XM @ cc2 @ ccexp) @ cc2 @ ccdiv) @ cc2 @ ccdiv) @ (cco @ XB2 @ cc2 @ ccexp) @ ccmin) = ccc0)) => ((Xph & Xps) => (cwbr @ (cco @ XM @ cc2 @ ccexp) @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ XM @ cc2 @ ccexp) @ cc2 @ ccdiv) @ cc2 @ ccdiv) @ ccmin) @ ccdvds)))))))))))).
