...
thf(afourierdlem61_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ XF)) => ((Xph => (cwcel @ XY @ (cco @ XF @ XA2 @ cclimc))) => ((XG = (cco @ ccr @ XF @ ccdv)) => ((Xph => ((ccdm @ XG) = (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => (cwcel @ XE @ (cco @ XG @ XA2 @ cclimc))) => ((! [Xs1:$i] : ((XH @ Xs1) = (ccmpt @ (^ [Xs1:$i] : (cco @ ccc0 @ (cco @ XB2 @ XA2 @ ccmin) @ ccioo)) @ (^ [Xs1:$i] : (cco @ (cco @ (ccfv @ (cco @ XA2 @ (ccv @ Xs1) @ ccaddc) @ XF) @ XY @ ccmin) @ (ccv @ Xs1) @ ccdiv))))) => ((XN = (ccmpt @ (^ [Xs1:$i] : (cco @ ccc0 @ (cco @ XB2 @ XA2 @ ccmin) @ ccioo)) @ (^ [Xs1:$i] : (cco @ (ccfv @ (cco @ XA2 @ (ccv @ Xs1) @ ccaddc) @ XF) @ XY @ ccmin)))) => ((XD = (ccmpt @ (^ [Xs1:$i] : (cco @ ccc0 @ (cco @ XB2 @ XA2 @ ccmin) @ ccioo)) @ (^ [Xs1:$i] : (ccv @ Xs1)))) => (! [Xs1:$i] : (Xph => (cwcel @ XE @ (cco @ (XH @ Xs1) @ ccc0 @ cclimc)))))))))))))))))))))))))).
