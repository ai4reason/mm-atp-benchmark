...
thf(aimastset_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (XU = (cco @ XF @ XR @ ccimas))) => ((Xph => (XV = (ccfv @ XR @ ccbs))) => ((Xph => (cwfo @ XV @ XB2 @ XF)) => ((Xph => (cwcel @ XR @ XZ)) => ((XJ = (ccfv @ XR @ cctopn)) => ((XO = (ccfv @ XU @ ccts)) => (Xph => (XO = (cco @ XJ @ XF @ ccqtop))))))))))))))))))).
...
thf(aqtopval_ax,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (! [Xs1:$i] : (((cwcel @ XJ @ XV) & (cwcel @ XF @ (XW @ Xs1))) => ((cco @ XJ @ XF @ ccqtop) = (ccrab @ (^ [Xs1:$i] : (cwcel @ (ccin @ (ccima @ (cccnv @ XF) @ (ccv @ Xs1)) @ XX) @ XJ)) @ (^ [Xs1:$i] : (ccpw @ (ccima @ XF @ XX)))))))))))))).
...
thf(cimastopn_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (XU = (cco @ XF @ XR @ ccimas))) => ((Xph => (XV = (ccfv @ XR @ ccbs))) => ((Xph => (cwfo @ XV @ XB2 @ XF)) => ((Xph => (cwcel @ XR @ XW)) => ((XJ = (ccfv @ XR @ cctopn)) => ((XO = (ccfv @ XU @ cctopn)) => (Xph => (XO = (cco @ XJ @ XF @ ccqtop))))))))))))))))))).
