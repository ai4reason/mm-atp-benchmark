...
thf(aopmpt2ismgm_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : ((! [Xy1:$i] : (XB2 = (ccfv @ (XM @ Xy1) @ ccbs))) => ((! [Xy1:$i] : ((ccfv @ (XM @ Xy1) @ ccplusg) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1)))))) => ((Xph => (cwne @ XB2 @ cc0)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & (cwcel @ (ccv @ Xy1) @ XB2))) => (cwcel @ (XC @ Xx3 @ Xy1) @ XB2)))) => (! [Xy1:$i] : (Xph => (cwcel @ (XM @ Xy1) @ ccmgm)))))))))))).
...
thf(ccopissgrp_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xy1:$i] : (XB2 = (ccfv @ (XM @ Xy1) @ ccbs))) => ((! [Xy1:$i] : ((ccfv @ (XM @ Xy1) @ ccplusg) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XC))))) => ((Xph => (cwne @ XB2 @ cc0)) => ((Xph => (cwcel @ XC @ XB2)) => (! [Xy1:$i] : (Xph => (cwcel @ (XM @ Xy1) @ ccsgrp)))))))))))).
