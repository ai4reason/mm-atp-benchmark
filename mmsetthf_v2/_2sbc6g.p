...
thf(asbc6_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ XA2) <=> (! [Xx3:$i] : (((ccv @ Xx3) = XA2) => (Xph @ Xx3)))))))).
...
thf(c_2sbc6g_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [Xz:$i] : (! [Xw:$i] : (((cwcel @ XA2 @ (XC @ Xz @ Xw)) & (cwcel @ XB2 @ (XD @ Xz @ Xw))) => ((! [Xz:$i] : (! [Xw:$i] : ((((ccv @ Xz) = XA2) & ((ccv @ Xw) = XB2)) => (Xph @ Xz @ Xw)))) <=> (cwsbc @ (^ [Xz:$i] : (cwsbc @ (^ [Xw:$i] : (Xph @ Xz @ Xw)) @ XB2)) @ XA2))))))))))).
