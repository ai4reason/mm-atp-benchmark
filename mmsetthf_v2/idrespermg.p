...
thf(aidressubgsymg_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((cwcel @ XA2 @ XV) => (cwcel @ (ccsn @ (ccres @ ccid @ XA2)) @ (ccfv @ XG @ ccsubg)))))))).
thf(asylbid_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps <=> Xch)) => ((Xph => (Xch => Xth)) => (Xph => (Xps => Xth))))))))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(apgrpsubgsymgbi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((cwcel @ XA2 @ XV) => ((cwcel @ XP @ (ccfv @ XG @ ccsubg)) <=> ((cwss @ XP @ XB2) & (cwcel @ (cco @ XG @ XP @ ccress) @ ccgrp)))))))))))).
