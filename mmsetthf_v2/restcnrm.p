...
thf(acnrmtop_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cccnrm) => (cwcel @ XJ @ cctop)))).
...
thf(aiscnrm2_ax,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XX @ cctopon)) => ((cwcel @ XJ @ cccnrm) <=> (cwral @ (^ [Xx3:$i] : (cwcel @ (cco @ XJ @ (ccv @ Xx3) @ ccrest) @ ccnrm)) @ (^ [Xx3:$i] : (ccpw @ XX)))))))).
