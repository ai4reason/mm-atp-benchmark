...
thf(aseqeq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((ccseq @ XA2 @ XF @ XM) = (ccseq @ XB2 @ XF @ XM)))))))))).
...
thf(adf_sad_ax,axiom,(ccsad = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccpw @ ccn0))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccpw @ ccn0))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xk:$i] : (cwhad @ (cwcel @ (ccv @ Xk) @ (ccv @ Xx3)) @ (cwcel @ (ccv @ Xk) @ (ccv @ Xy1)) @ (cwcel @ cc0 @ (ccfv @ (ccv @ Xk) @ (ccseq @ (ccmpt2 @ (^ [Xc:$i] : (^ [Xm:$i] : cc2o)) @ (^ [Xc:$i] : (^ [Xm:$i] : ccn0)) @ (^ [Xc:$i] : (^ [Xm:$i] : (ccif @ (cwcad @ (cwcel @ (ccv @ Xm) @ (ccv @ Xx3)) @ (cwcel @ (ccv @ Xm) @ (ccv @ Xy1)) @ (cwcel @ cc0 @ (ccv @ Xc))) @ cc1o @ cc0)))) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ cc0 @ (cco @ (ccv @ Xn) @ cc1 @ ccmin)))) @ ccc0))))) @ (^ [Xk:$i] : ccn0))))))).
thf(arabex_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ ccvv))))).
thf(csadfval_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwss @ (XA2 @ Xn) @ ccn0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwss @ (XB2 @ Xn) @ ccn0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XC @ Xm @ Xn @ Xc) = (ccseq @ (ccmpt2 @ (^ [Xc:$i] : (^ [Xm:$i] : cc2o)) @ (^ [Xc:$i] : (^ [Xm:$i] : ccn0)) @ (^ [Xc:$i] : (^ [Xm:$i] : (ccif @ (cwcad @ (cwcel @ (ccv @ Xm) @ (XA2 @ Xn)) @ (cwcel @ (ccv @ Xm) @ (XB2 @ Xn)) @ (cwcel @ cc0 @ (ccv @ Xc))) @ cc1o @ cc0)))) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ cc0 @ (cco @ (ccv @ Xn) @ cc1 @ ccmin)))) @ ccc0))))) => (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => ((cco @ (XA2 @ Xn) @ (XB2 @ Xn) @ ccsad) = (ccrab @ (^ [Xk:$i] : (cwhad @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xn)) @ (cwcel @ (ccv @ Xk) @ (XB2 @ Xn)) @ (cwcel @ cc0 @ (ccfv @ (ccv @ Xk) @ (XC @ Xm @ Xn @ Xc))))) @ (^ [Xk:$i] : ccn0))))))))))))))).
