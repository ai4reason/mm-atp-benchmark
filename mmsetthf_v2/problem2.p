...
thf(aadd4i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwcel @ XC @ ccc) => ((cwcel @ XD @ ccc) => ((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XC @ XD @ ccaddc) @ ccaddc) = (cco @ (cco @ XA2 @ XC @ ccaddc) @ (cco @ XB2 @ XD @ ccaddc) @ ccaddc))))))))))).
...
thf(cproblem2_conj,conjecture,((cco @ (cco @ (cco @ cc2 @ (ccdc @ cc1 @ ccc0) @ ccmul) @ cc5 @ ccaddc) @ (cco @ (cco @ cc1 @ (ccdc @ cc1 @ ccc0) @ ccmul) @ cc4 @ ccaddc) @ ccaddc) = (cco @ (cco @ cc3 @ (ccdc @ cc1 @ ccc0) @ ccmul) @ cc9 @ ccaddc))).
