...
thf(cxralrple3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwbr @ ccc0 @ XC @ ccle)) => (Xph => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ XA2 @ (cco @ XB2 @ (cco @ XC @ (ccv @ Xx3) @ ccmul) @ ccaddc) @ ccle)) @ (^ [Xx3:$i] : ccrp))))))))))))).
