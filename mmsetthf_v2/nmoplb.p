...
thf(cnmoplb_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwf @ cchil @ cchil @ XT) @ (cwcel @ XA2 @ cchil) @ (cwbr @ (ccfv @ XA2 @ ccno) @ cc1 @ ccle)) => (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ ccno) @ (ccfv @ XT @ ccnop) @ ccle))))).
