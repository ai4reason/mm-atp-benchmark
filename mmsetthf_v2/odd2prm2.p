...
thf(aopoeALTV_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccodd) & (cwcel @ XB2 @ ccodd)) => (cwcel @ (cco @ XA2 @ XB2 @ ccaddc) @ cceven))))).
...
thf(codd2prm2_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccodd) @ ((cwcel @ XP @ ccprime) & (cwcel @ XQ @ ccprime)) @ (XN = (cco @ XP @ XQ @ ccaddc))) => ((XP = cc2) | (XQ = cc2))))))).
