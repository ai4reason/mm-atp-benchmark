...
thf(asmu02_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccn0) => ((cco @ cc0 @ XA2 @ ccsmu) = cc0)))).
...
thf(asmup1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn0)) => ((Xph => (cwss @ XB2 @ ccn0)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((cco @ (ccin @ XA2 @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccaddc) @ ccfzo)) @ XB2 @ ccsmu) = (cco @ (cco @ (ccin @ XA2 @ (cco @ ccc0 @ XN @ ccfzo)) @ XB2 @ ccsmu) @ (ccrab @ (^ [Xn:$i] : ((cwcel @ XN @ XA2) & (cwcel @ (cco @ (ccv @ Xn) @ XN @ ccmin) @ XB2))) @ (^ [Xn:$i] : ccn0)) @ ccsad))))))))))).
...
thf(abitsshft_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccn0)) => ((ccrab @ (^ [Xn:$i] : (cwcel @ (cco @ (ccv @ Xn) @ XN @ ccmin) @ (ccfv @ XA2 @ ccbits))) @ (^ [Xn:$i] : ccn0)) = (ccfv @ (cco @ XA2 @ (cco @ cc2 @ XN @ ccexp) @ ccmul) @ ccbits)))))).
...
thf(csmumullem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XB2 @ ccz)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((cco @ (ccin @ (ccfv @ XA2 @ ccbits) @ (cco @ ccc0 @ XN @ ccfzo)) @ (ccfv @ XB2 @ ccbits) @ ccsmu) = (ccfv @ (cco @ (cco @ XA2 @ (cco @ cc2 @ XN @ ccexp) @ ccmo) @ XB2 @ ccmul) @ ccbits))))))))))).
