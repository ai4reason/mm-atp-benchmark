...
thf(abcnp1n_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cco @ (cco @ XN @ cc1 @ ccaddc) @ XN @ ccbc) = (cco @ XN @ cc1 @ ccaddc))))).
...
thf(abcxmas_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XM @ ccn0)) => ((cco @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XM @ ccaddc) @ XM @ ccbc) = (ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xj:$i] : (cco @ (cco @ XN @ (ccv @ Xj) @ ccaddc) @ (ccv @ Xj) @ ccbc)))))))).
...
thf(abcp1m1_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cco @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ XN @ cc1 @ ccmin) @ ccbc) = (cco @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XN @ ccmul) @ cc2 @ ccdiv))))).
