...
thf(assfzunsnext_ax,axiom,(! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwss @ XS @ (cco @ XM @ XN @ ccfz)) & (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwcel @ XI @ ccz))) => (cwss @ (ccun @ XS @ (ccsn @ XI)) @ (cco @ (ccif @ (cwbr @ XI @ XM @ ccle) @ XI @ XM) @ (ccif @ (cwbr @ XI @ XN @ ccle) @ XN @ XI) @ ccfz)))))))).
thf(abreq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((XA2 = XB2) => ((cwbr @ XC @ XA2 @ XR) <=> (cwbr @ XC @ XB2 @ XR)))))))).
thf(csetsstruct2_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cw3a @ (cwbr @ XG @ XX @ ccstr) @ (cwcel @ XE @ XV) @ (cwcel @ XI @ ccn)) & (XY = (ccop @ (ccif @ (cwbr @ XI @ (ccfv @ XX @ cc1st) @ ccle) @ XI @ (ccfv @ XX @ cc1st)) @ (ccif @ (cwbr @ XI @ (ccfv @ XX @ cc2nd) @ ccle) @ (ccfv @ XX @ cc2nd) @ XI)))) => (cwbr @ (cco @ XG @ (ccop @ XI @ XE) @ ccsts) @ XY @ ccstr))))))))).
