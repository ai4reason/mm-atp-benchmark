...
thf(aimass2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwss @ XA2 @ XB2)) => (Xph => (cwss @ (ccima @ XC @ XA2) @ (ccima @ XC @ XB2))))))))).
thf(aicossico2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwcel @ XC @ ccxr)) => ((Xph => (cwbr @ XB2 @ XA2 @ ccle)) => (Xph => (cwss @ (cco @ XA2 @ XC @ ccico) @ (cco @ XB2 @ XC @ ccico))))))))))).
...
thf(ainfxrlesupxr_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwss @ XA2 @ ccxr)) => ((Xph => (cwne @ XA2 @ cc0)) => (Xph => (cwbr @ (ccinf @ XA2 @ ccxr @ cclt) @ (ccsup @ XA2 @ ccxr @ cclt) @ ccle))))))).
...
thf(asupxrleubrnmptf_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XC @ Xx3))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => (cwcel @ (XB2 @ Xx3) @ ccxr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XC @ Xx3) @ ccxr))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cwbr @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ ccxr @ cclt) @ (XC @ Xx3) @ ccle) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (XC @ Xx3) @ ccle)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))))))))))).
...
thf(aliminfvald_ax,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XF @ (XV @ Xk)))) => ((! [Xk:$i] : ((XG @ Xk) = (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccinf @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccfv @ XF @ cclsi) = (ccsup @ (ccrn @ (XG @ Xk)) @ ccxr @ cclt))))))))))).
thf(alimsupvald_ax,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XF @ (XV @ Xk)))) => ((! [Xk:$i] : ((XG @ Xk) = (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccsup @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccfv @ XF @ cclsp) = (ccinf @ (ccrn @ (XG @ Xk)) @ ccxr @ cclt))))))))))).
thf(climinflelimsuplem_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XF @ (XV @ Xj @ Xk))))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xj:$i] : (cwne @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xj) @ ccpnf @ ccico)) @ ccxr) @ cc0)) @ (^ [Xj:$i] : (cco @ (ccv @ Xk) @ ccpnf @ ccico)))) @ (^ [Xk:$i] : ccr)))) => (! [Xk:$i] : ((Xph @ Xk) => (cwbr @ (ccfv @ XF @ cclsi) @ (ccfv @ XF @ cclsp) @ ccle))))))))).
