...
thf(asecval_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ (ccfv @ XA2 @ cccos) @ ccc0)) => ((ccfv @ XA2 @ ccsec) = (cco @ cc1 @ (ccfv @ XA2 @ cccos) @ ccdiv))))).
...
thf(crecsec_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ (ccfv @ XA2 @ cccos) @ ccc0)) => ((ccfv @ XA2 @ cccos) = (cco @ cc1 @ (ccfv @ XA2 @ ccsec) @ ccdiv))))).
