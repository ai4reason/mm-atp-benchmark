...
thf(admdbr6ati_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwbr @ XA2 @ XB2 @ ccdmd) <=> (cwral @ (^ [Xx3:$i] : ((ccin @ (cco @ XA2 @ XB2 @ cchj) @ (ccv @ Xx3)) = (ccin @ (cco @ (ccin @ (cco @ (ccv @ Xx3) @ XB2 @ cchj) @ XA2) @ XB2 @ cchj) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccat)))))))).
...
thf(admdbr5ati_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwbr @ XA2 @ XB2 @ ccdmd) <=> (cwral @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ cchj)) => (cwss @ (ccv @ Xx3) @ (cco @ (ccin @ (cco @ (ccv @ Xx3) @ XB2 @ cchj) @ XA2) @ XB2 @ cchj)))) @ (^ [Xx3:$i] : ccat)))))))).
thf(cdmdbr7ati_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwbr @ XA2 @ XB2 @ ccdmd) <=> (cwral @ (^ [Xx3:$i] : (cwss @ (ccin @ (cco @ XA2 @ XB2 @ cchj) @ (ccv @ Xx3)) @ (cco @ (ccin @ (cco @ (ccv @ Xx3) @ XB2 @ cchj) @ XA2) @ XB2 @ cchj))) @ (^ [Xx3:$i] : ccat)))))))).
