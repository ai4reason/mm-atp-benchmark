...
thf(cfvopab4ndm_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) & (Xph @ Xx3 @ Xy1)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((~ (cwcel @ (XB2 @ Xx3 @ Xy1) @ XA2)) => ((ccfv @ (XB2 @ Xx3 @ Xy1) @ (XF @ Xx3 @ Xy1)) = cc0)))))))))).
