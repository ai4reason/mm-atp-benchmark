...
thf(alhpmcvr6N_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((! [Xp:$i] : ((Xc_or @ Xp) = (ccfv @ XK @ ccjn))) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ ((cwcel @ XX @ XB2) & (~ (cwbr @ XX @ XW @ Xc_le))) @ ((cwcel @ XY @ XB2) & (cwbr @ (cco @ XX @ XY @ Xc_an) @ XW @ Xc_le))) => (cwrex @ (^ [Xp:$i] : (cw3a @ (~ (cwbr @ (ccv @ Xp) @ XW @ Xc_le)) @ (~ (cwbr @ (ccv @ Xp) @ XY @ Xc_le)) @ (cwbr @ (ccv @ Xp) @ XX @ Xc_le))) @ (^ [Xp:$i] : XA2)))))))))))))))))))).
