...
thf(adigfval_ax,axiom,(! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccn) => ((ccfv @ XB2 @ ccdig) = (ccmpt2 @ (^ [Xk:$i] : (^ [Xr:$i] : ccz)) @ (^ [Xk:$i] : (^ [Xr:$i] : (cco @ ccc0 @ ccpnf @ ccico))) @ (^ [Xk:$i] : (^ [Xr:$i] : (cco @ (ccfv @ (cco @ (cco @ XB2 @ (ccneg @ (ccv @ Xk)) @ ccexp) @ (ccv @ Xr) @ ccmul) @ ccfl) @ XB2 @ ccmo)))))))).
...
thf(cdigval_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : ((cw3a @ (cwcel @ XB2 @ ccn) @ (cwcel @ XK @ ccz) @ (cwcel @ XR @ (cco @ ccc0 @ ccpnf @ ccico))) => ((cco @ XK @ XR @ (ccfv @ XB2 @ ccdig)) = (cco @ (ccfv @ (cco @ (cco @ XB2 @ (ccneg @ XK) @ ccexp) @ XR @ ccmul) @ ccfl) @ XB2 @ ccmo))))))).
