...
thf(cxpprsng_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwcel @ XC @ XU)) => ((ccxp @ (ccpr @ XA2 @ XB2) @ (ccsn @ XC)) = (ccpr @ (ccop @ XA2 @ XC) @ (ccop @ XB2 @ XC))))))))))).
