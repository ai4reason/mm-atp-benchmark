...
thf(chis35_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) & ((cwcel @ XC @ cchil) & (cwcel @ XD @ cchil))) => ((cco @ (cco @ XA2 @ XC @ ccsm) @ (cco @ XB2 @ XD @ ccsm) @ ccsp) = (cco @ (cco @ XA2 @ (ccfv @ XB2 @ cccj) @ ccmul) @ (cco @ XC @ XD @ ccsp) @ ccmul)))))))).
