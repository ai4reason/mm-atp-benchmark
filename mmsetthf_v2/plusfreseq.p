...
thf(afveqressseq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((XD = (ccdm @ XB2)) => ((cw3a @ (cwfun @ XB2) @ (cwnel @ cc0 @ (ccrn @ XB2)) @ (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XA2) = (ccfv @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : XD))) => ((ccres @ XA2 @ XD) = XB2))))))).
thf(afndm_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ XA2) => ((ccdm @ XF) = XA2))))).
thf(cplusfreseq_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XM:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_pl = (ccfv @ XM @ ccplusg)) => ((Xc_pd = (ccfv @ XM @ ccplusf)) => ((cwnel @ cc0 @ (ccrn @ Xc_pd)) => ((ccres @ Xc_pl @ (ccxp @ XB2 @ XB2)) = Xc_pd)))))))))).
