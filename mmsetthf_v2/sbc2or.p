...
thf(apm5_15_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph <=> Xps) | (Xph <=> (~ Xps)))))).
...
thf(csbc2or_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (((cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ XA2) <=> (? [Xx3:$i] : (((ccv @ Xx3) = XA2) & (Xph @ Xx3)))) | ((cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ XA2) <=> (! [Xx3:$i] : (((ccv @ Xx3) = XA2) => (Xph @ Xx3)))))))).
