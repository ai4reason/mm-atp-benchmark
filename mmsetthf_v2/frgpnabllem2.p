...
thf(afrgpnabllem1_ax,axiom,(! [Xph:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [Xc_pl:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [Xc_sm:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XU:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XI:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((XG @ Xy1 @ Xz @ Xw @ Xv @ Xn) = (ccfv @ XI @ ccfrgp))))))) => ((XW = (ccfv @ (ccword @ (ccxp @ XI @ cc2o)) @ ccid)) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((Xc_sm @ Xw @ Xv @ Xn) = (ccfv @ XI @ ccefg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((Xc_pl @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn) = (ccfv @ (XG @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ ccplusg)))))))) => ((! [Xy1:$i] : (! [Xz:$i] : ((XM @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xy1:$i] : (^ [Xz:$i] : XI)) @ (^ [Xy1:$i] : (^ [Xz:$i] : cc2o)) @ (^ [Xy1:$i] : (^ [Xz:$i] : (ccop @ (ccv @ Xy1) @ (ccdif @ cc1o @ (ccv @ Xz))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((XT @ Xy1 @ Xz @ Xw @ Xv @ Xn) = (ccmpt @ (^ [Xv:$i] : XW) @ (^ [Xv:$i] : (ccmpt2 @ (^ [Xn:$i] : (^ [Xw:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xv) @ cchash) @ ccfz))) @ (^ [Xn:$i] : (^ [Xw:$i] : (ccxp @ XI @ cc2o))) @ (^ [Xn:$i] : (^ [Xw:$i] : (cco @ (ccv @ Xv) @ (ccotp @ (ccv @ Xn) @ (ccv @ Xn) @ (ccs2 @ (ccv @ Xw) @ (ccfv @ (ccv @ Xw) @ (XM @ Xy1 @ Xz)))) @ ccsplice)))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((XD @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn) = (ccdif @ XW @ (cciun @ (^ [Xx3:$i] : XW) @ (^ [Xx3:$i] : (ccrn @ (ccfv @ (ccv @ Xx3) @ (XT @ Xy1 @ Xz @ Xw @ Xv @ Xn))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((XU @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn) = (ccfv @ XI @ ccvrgp)))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xz @ Xw @ Xv @ Xn) => (cwcel @ XI @ ccvv))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xz @ Xw @ Xv @ Xn) => (cwcel @ (XA2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ XI))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xz @ Xw @ Xv @ Xn) => (cwcel @ (XB2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ XI))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xz @ Xw @ Xv @ Xn) => (cwcel @ (ccs2 @ (ccop @ (XA2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ cc0) @ (ccop @ (XB2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ cc0)) @ (ccin @ (XD @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (cco @ (ccfv @ (XA2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (XU @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn)) @ (ccfv @ (XB2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (XU @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn)) @ (Xc_pl @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn))))))))))))))))))))))))))))))))))).
thf(cwfn_tp,type,(cwfn : (($i > $o) > (($i > $o) > $o)))).
thf(cccnv_tp,type,(cccnv : (($i > $o) > ($i > $o)))).
thf(ccima_tp,type,(ccima : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(cwfo_tp,type,(cwfo : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(ccdm_tp,type,(ccdm : (($i > $o) > ($i > $o)))).
thf(aefgredeu_ax,axiom,(! [XA2:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [Xc_sm:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XW:($i > $o)] : ((! [Xk:$i] : (! [Xd:$i] : (XW = (ccfv @ (ccword @ (ccxp @ (XI @ Xk @ Xd) @ cc2o)) @ ccid)))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xd:$i] : ((Xc_sm @ Xw @ Xv @ Xk @ Xn) = (ccfv @ (XI @ Xk @ Xd) @ ccefg))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xk:$i] : (! [Xd:$i] : ((XM @ Xy1 @ Xz @ Xk @ Xd) = (ccmpt2 @ (^ [Xy1:$i] : (^ [Xz:$i] : (XI @ Xk @ Xd))) @ (^ [Xy1:$i] : (^ [Xz:$i] : cc2o)) @ (^ [Xy1:$i] : (^ [Xz:$i] : (ccop @ (ccv @ Xy1) @ (ccdif @ cc1o @ (ccv @ Xz))))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xd:$i] : ((XT @ Xy1 @ Xz @ Xw @ Xv @ Xn @ Xd) = (ccmpt @ (^ [Xv:$i] : XW) @ (^ [Xv:$i] : (ccmpt2 @ (^ [Xn:$i] : (^ [Xw:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xv) @ cchash) @ ccfz))) @ (^ [Xn:$i] : (^ [Xw:$i] : (ccxp @ (XI @ Xk @ Xd) @ cc2o))) @ (^ [Xn:$i] : (^ [Xw:$i] : (cco @ (ccv @ Xv) @ (ccotp @ (ccv @ Xn) @ (ccv @ Xn) @ (ccs2 @ (ccv @ Xw) @ (ccfv @ (ccv @ Xw) @ (XM @ Xy1 @ Xz @ Xk @ Xd)))) @ ccsplice)))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xd:$i] : ((XD @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xk @ Xn) = (ccdif @ XW @ (cciun @ (^ [Xx3:$i] : XW) @ (^ [Xx3:$i] : (ccrn @ (ccfv @ (ccv @ Xx3) @ (XT @ Xy1 @ Xz @ Xw @ Xv @ Xn @ Xd))))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xd:$i] : ((XS @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xk @ Xm @ Xn) = (ccmpt @ (^ [Xm:$i] : (ccrab @ (^ [Xt:$i] : ((cwcel @ (ccfv @ ccc0 @ (ccv @ Xt)) @ (XD @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xk @ Xn)) & (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccv @ Xk) @ (ccv @ Xt)) @ (ccrn @ (ccfv @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ (ccv @ Xt)) @ (XT @ Xy1 @ Xz @ Xw @ Xv @ Xn @ Xd))))) @ (^ [Xk:$i] : (cco @ cc1 @ (ccfv @ (ccv @ Xt) @ cchash) @ ccfzo))))) @ (^ [Xt:$i] : (ccdif @ (ccword @ XW) @ (ccsn @ cc0))))) @ (^ [Xm:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xm) @ cchash) @ cc1 @ ccmin) @ (ccv @ Xm))))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xt:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : ((cwcel @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xk @ Xm @ Xn) @ XW) => (cwreu @ (^ [Xd:$i] : (cwbr @ (ccv @ Xd) @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xt @ Xk @ Xm @ Xn) @ (Xc_sm @ Xw @ Xv @ Xk @ Xn))) @ (^ [Xd:$i] : (XD @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xk @ Xn)))))))))))))))))))))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(areurmo_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (cwrmo @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))).
...
thf(aqsel_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwer @ XX @ XR) @ (cwcel @ XB2 @ (ccqs @ XA2 @ XR)) @ (cwcel @ XC @ XB2)) => (XB2 = (ccec @ XC @ XR))))))))).
...
thf(cfrgpnabllem2_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [Xc_pl:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [Xc_sm:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XU:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XI:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((XG @ Xy1 @ Xz @ Xw @ Xv @ Xn) = (ccfv @ XI @ ccfrgp))))))) => ((XW = (ccfv @ (ccword @ (ccxp @ XI @ cc2o)) @ ccid)) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((Xc_sm @ Xw @ Xv @ Xn) = (ccfv @ XI @ ccefg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((Xc_pl @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn) = (ccfv @ (XG @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ ccplusg)))))))) => ((! [Xy1:$i] : (! [Xz:$i] : ((XM @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xy1:$i] : (^ [Xz:$i] : XI)) @ (^ [Xy1:$i] : (^ [Xz:$i] : cc2o)) @ (^ [Xy1:$i] : (^ [Xz:$i] : (ccop @ (ccv @ Xy1) @ (ccdif @ cc1o @ (ccv @ Xz))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((XT @ Xy1 @ Xz @ Xw @ Xv @ Xn) = (ccmpt @ (^ [Xv:$i] : XW) @ (^ [Xv:$i] : (ccmpt2 @ (^ [Xn:$i] : (^ [Xw:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xv) @ cchash) @ ccfz))) @ (^ [Xn:$i] : (^ [Xw:$i] : (ccxp @ XI @ cc2o))) @ (^ [Xn:$i] : (^ [Xw:$i] : (cco @ (ccv @ Xv) @ (ccotp @ (ccv @ Xn) @ (ccv @ Xn) @ (ccs2 @ (ccv @ Xw) @ (ccfv @ (ccv @ Xw) @ (XM @ Xy1 @ Xz)))) @ ccsplice)))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((XD @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn) = (ccdif @ XW @ (cciun @ (^ [Xx3:$i] : XW) @ (^ [Xx3:$i] : (ccrn @ (ccfv @ (ccv @ Xx3) @ (XT @ Xy1 @ Xz @ Xw @ Xv @ Xn))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((XU @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn) = (ccfv @ XI @ ccvrgp)))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xz @ Xw @ Xv @ Xn) => (cwcel @ XI @ ccvv))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xz @ Xw @ Xv @ Xn) => (cwcel @ (XA2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ XI))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xz @ Xw @ Xv @ Xn) => (cwcel @ (XB2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ XI))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xz @ Xw @ Xv @ Xn) => ((cco @ (ccfv @ (XA2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (XU @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn)) @ (ccfv @ (XB2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (XU @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn)) @ (Xc_pl @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn)) = (cco @ (ccfv @ (XB2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (XU @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn)) @ (ccfv @ (XA2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) @ (XU @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn)) @ (Xc_pl @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xn)))))))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xz @ Xw @ Xv @ Xn) => ((XA2 @ Xy1 @ Xz @ Xw @ Xv @ Xn) = (XB2 @ Xy1 @ Xz @ Xw @ Xv @ Xn))))))))))))))))))))))))))))))))).
