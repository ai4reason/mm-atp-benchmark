...
thf(abrwitnlem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XR = (ccima @ (cccnv @ XO) @ (ccdif @ ccvv @ cc1o))) => ((cwfn @ XO @ XX) => ((cwbr @ XA2 @ XB2 @ XR) <=> (cwne @ (cco @ XA2 @ XB2 @ XO) @ cc0)))))))))).
...
thf(cbrric_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwbr @ XR @ XS @ ccric) <=> (cwne @ (cco @ XR @ XS @ ccrs) @ cc0))))).
