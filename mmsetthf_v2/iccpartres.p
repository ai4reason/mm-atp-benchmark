...
thf(afzofzp1b_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ (ccfv @ XA2 @ ccuz)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccfzo)) <=> (cwcel @ (cco @ XC @ cc1 @ ccaddc) @ (cco @ XA2 @ XB2 @ ccfz)))))))).
thf(ciccpartres_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XM @ ccn) & (cwcel @ XP @ (ccfv @ (cco @ XM @ cc1 @ ccaddc) @ cciccp))) => (cwcel @ (ccres @ XP @ (cco @ ccc0 @ XM @ ccfz)) @ (ccfv @ XM @ cciccp)))))).
