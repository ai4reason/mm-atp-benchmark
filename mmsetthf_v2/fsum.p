...
thf(amoi2_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> Xps))) => (! [Xx3:$i] : ((((cwcel @ XA2 @ (XB2 @ Xx3)) & (cwmo @ (^ [Xx3:$i] : (Xph @ Xx3)))) & ((Xph @ Xx3) & Xps)) => ((ccv @ Xx3) = XA2))))))))).
