...
thf(awlkp1_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XG @ cciedg)) => ((Xph => (cwfun @ XI)) => ((Xph => (cwcel @ XI @ ccfn)) => ((Xph => (cwcel @ XB2 @ ccvv)) => ((Xph => (cwcel @ XC @ XV)) => ((Xph => (~ (cwcel @ XB2 @ (ccdm @ XI)))) => ((Xph => (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks))) => ((XN = (ccfv @ XF @ cchash)) => ((Xph => (cwcel @ XE @ (ccfv @ XG @ ccedg))) => ((Xph => (cwss @ (ccpr @ (ccfv @ XN @ XP) @ XC) @ XE)) => ((Xph => ((ccfv @ XS @ cciedg) = (ccun @ XI @ (ccsn @ (ccop @ XB2 @ XE))))) => ((XH = (ccun @ XF @ (ccsn @ (ccop @ XN @ XB2)))) => ((XQ = (ccun @ XP @ (ccsn @ (ccop @ (cco @ XN @ cc1 @ ccaddc) @ XC)))) => ((Xph => ((ccfv @ XS @ ccvtx) = XV)) => (((Xph & (XC = (ccfv @ XN @ XP))) => (XE = (ccsn @ XC))) => (Xph => (cwbr @ XH @ XQ @ (ccfv @ XS @ ccwlks))))))))))))))))))))))))))))))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(cctrls_tp,type,(cctrls : ($i > $o))).
thf(aeupthiswlk_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwbr @ XF @ XP @ (ccfv @ XG @ cceupth)) => (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks))))))).
thf(aa1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(ampbird_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xch) => ((Xph => (Xps <=> Xch)) => (Xph => Xps))))))).
thf(asyl22anc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xph => Xps) => ((Xph => Xch) => ((Xph => Xth) => ((Xph => Xta) => ((((Xps & Xch) & (Xth & Xta)) => Xet) => (Xph => Xet))))))))))))).
thf(a_3syl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xps => Xch) => ((Xch => Xth) => (Xph => Xth))))))))).
thf(aeupthi_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => ((cwbr @ XF @ XP @ (ccfv @ XG @ cceupth)) => ((cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) & (cwf1o @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XI) @ XF))))))))).
