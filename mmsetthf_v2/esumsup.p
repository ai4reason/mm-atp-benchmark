...
thf(aesumfzf_ax,axiom,(! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => (! [Xk:$i] : (((cwf @ ccn @ (cco @ ccc0 @ ccpnf @ ccicc) @ (XF @ Xk)) & (cwcel @ XN @ ccn)) => ((ccesum @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xk)))) = (ccfv @ XN @ (ccseq @ ccxad @ (XF @ Xk) @ cc1))))))))).
thf(cesumsup_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xk:$i] : (Xph => (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn)) => (cwcel @ (XA2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => (Xph => ((ccesum @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (XA2 @ Xk))) = (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccesum @ (^ [Xk:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk)))))) @ ccxr @ cclt))))))))).
