...
thf(adf_fg_ax,axiom,(ccfg = (ccmpt2 @ (^ [Xw:$i] : (^ [Xx3:$i] : ccvv)) @ (^ [Xw:$i] : (^ [Xx3:$i] : (ccfv @ (ccv @ Xw) @ ccfbas))) @ (^ [Xw:$i] : (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (cwne @ (ccin @ (ccv @ Xx3) @ (ccpw @ (ccv @ Xy1))) @ cc0)) @ (^ [Xy1:$i] : (ccpw @ (ccv @ Xw))))))))).
...
thf(cfgval_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccfbas)) => ((cco @ XX @ XF @ ccfg) = (ccrab @ (^ [Xx3:$i] : (cwne @ (ccin @ XF @ (ccpw @ (ccv @ Xx3))) @ cc0)) @ (^ [Xx3:$i] : (ccpw @ XX)))))))).
