...
thf(apsasym_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cw3a @ (cwcel @ XR @ ccps) @ (cwbr @ XA2 @ XB2 @ XR) @ (cwbr @ XB2 @ XA2 @ XR)) => (XA2 = XB2)))))).
...
thf(cordthauslem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XR)) => ((cw3a @ (cwcel @ XR @ cctsr) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) => ((cwbr @ XA2 @ XB2 @ XR) => ((cwne @ XA2 @ XB2) => (cwrex @ (^ [Xm:$i] : (cwrex @ (^ [Xn:$i] : (cw3a @ (cwcel @ XA2 @ (ccv @ Xm)) @ (cwcel @ XB2 @ (ccv @ Xn)) @ ((ccin @ (ccv @ Xm) @ (ccv @ Xn)) = cc0))) @ (^ [Xn:$i] : (ccfv @ XR @ ccordt)))) @ (^ [Xm:$i] : (ccfv @ XR @ ccordt)))))))))))).
