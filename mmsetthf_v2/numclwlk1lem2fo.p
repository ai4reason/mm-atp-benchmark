...
thf(anumclwlk1lem2foa_ax,axiom,(! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > ($i > $o)))] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((XC @ Xw @ Xv @ Xn) = (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : XV)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccfv @ cc2 @ ccuz))) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccrab @ (^ [Xw:$i] : ((ccfv @ (cco @ (ccv @ Xn) @ cc2 @ ccmin) @ (ccv @ Xw)) = (ccv @ Xv))) @ (^ [Xw:$i] : (cco @ (ccv @ Xv) @ (ccv @ Xn) @ (ccfv @ XG @ ccclwwlknon))))))))))) => ((! [Xv:$i] : (! [Xn:$i] : ((XF @ Xv @ Xn) = (cco @ XX @ (cco @ XN @ cc2 @ ccmin) @ (ccfv @ XG @ ccclwwlknon))))) => (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((cw3a @ (cwcel @ XG @ ccusgr) @ (cwcel @ XX @ XV) @ (cwcel @ XN @ (ccfv @ cc3 @ ccuz))) => (((cwcel @ (XW @ Xv @ Xn) @ (XF @ Xv @ Xn)) & (cwcel @ (XY @ Xv @ Xn) @ (cco @ XG @ XX @ ccnbgr))) => (cwcel @ (cco @ (cco @ (XW @ Xv @ Xn) @ (ccs1 @ XX) @ ccconcat) @ (ccs1 @ (XY @ Xv @ Xn)) @ ccconcat) @ (cco @ XX @ XN @ (XC @ Xw @ Xv @ Xn)))))))))))))))))))).
...
thf(accatw2s1p2_ax,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XW @ (ccword @ XV)) & ((ccfv @ XW @ cchash) = XN)) & ((cwcel @ XX @ XV) & (cwcel @ XY @ XV))) => ((ccfv @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ (ccs1 @ XY) @ ccconcat)) = XY)))))))).
