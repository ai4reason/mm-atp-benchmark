...
thf(cbitsp1o_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XM @ ccn0)) => ((cwcel @ (cco @ XM @ cc1 @ ccaddc) @ (ccfv @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc) @ ccbits)) <=> (cwcel @ XM @ (ccfv @ XN @ ccbits))))))).
