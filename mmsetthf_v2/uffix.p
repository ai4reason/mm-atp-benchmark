...
thf(cuffix_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ XV) & (cwcel @ XA2 @ XX)) => ((cwcel @ (ccsn @ (ccsn @ XA2)) @ (ccfv @ XX @ ccfbas)) & ((ccrab @ (^ [Xx3:$i] : (cwcel @ XA2 @ (ccv @ Xx3))) @ (^ [Xx3:$i] : (ccpw @ XX))) = (cco @ XX @ (ccsn @ (ccsn @ XA2)) @ ccfg)))))))).
