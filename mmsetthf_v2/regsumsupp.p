...
thf(cregsumsupp_conj,conjecture,(! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwf @ XI @ ccr @ XF) @ (cwbr @ XF @ ccc0 @ ccfsupp) @ (cwcel @ XI @ XV)) => ((cco @ ccrefld @ XF @ ccgsu) = (ccsu @ (cco @ XF @ ccc0 @ ccsupp) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))))))))).
