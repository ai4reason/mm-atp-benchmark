...
thf(aitg2addnclem_ax,axiom,(! [XF:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : ((XL @ Xx3 @ Xy1 @ Xz @ Xg1) = (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xg1:$i] : ((cwrex @ (^ [Xy1:$i] : (cwbr @ (ccmpt @ (^ [Xz:$i] : ccr) @ (^ [Xz:$i] : (ccif @ ((ccfv @ (ccv @ Xz) @ (ccv @ Xg1)) = ccc0) @ ccc0 @ (cco @ (ccfv @ (ccv @ Xz) @ (ccv @ Xg1)) @ (ccv @ Xy1) @ ccaddc)))) @ XF @ (ccofr @ ccle))) @ (^ [Xy1:$i] : ccrp)) & ((ccv @ Xx3) = (ccfv @ (ccv @ Xg1) @ ccitg1)))) @ (^ [Xg1:$i] : (ccdm @ ccitg1)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xg1:$i] : ((cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF) => ((ccfv @ XF @ ccitg2) = (ccsup @ (XL @ Xx3 @ Xy1 @ Xz @ Xg1) @ ccxr @ cclt))))))))))).
...
thf(aitg2addnclem3_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xs1:$i] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((Xph => (cwcel @ (ccfv @ XF @ ccitg2) @ ccr)) => ((Xph => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XG)) => ((Xph => (cwcel @ (ccfv @ XG @ ccitg2) @ ccr)) => (Xph => ((cwrex @ (^ [Xh:$i] : ((cwrex @ (^ [Xy1:$i] : (cwbr @ (ccmpt @ (^ [Xz:$i] : ccr) @ (^ [Xz:$i] : (ccif @ ((ccfv @ (ccv @ Xz) @ (ccv @ Xh)) = ccc0) @ ccc0 @ (cco @ (ccfv @ (ccv @ Xz) @ (ccv @ Xh)) @ (ccv @ Xy1) @ ccaddc)))) @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ (ccofr @ ccle))) @ (^ [Xy1:$i] : ccrp)) & ((ccv @ Xs1) = (ccfv @ (ccv @ Xh) @ ccitg1)))) @ (^ [Xh:$i] : (ccdm @ ccitg1))) => (? [Xt:$i] : (? [Xu:$i] : ((cwrex @ (^ [Xf1:$i] : (cwrex @ (^ [Xg1:$i] : (((cwrex @ (^ [Xc:$i] : (cwbr @ (ccmpt @ (^ [Xz:$i] : ccr) @ (^ [Xz:$i] : (ccif @ ((ccfv @ (ccv @ Xz) @ (ccv @ Xf1)) = ccc0) @ ccc0 @ (cco @ (ccfv @ (ccv @ Xz) @ (ccv @ Xf1)) @ (ccv @ Xc) @ ccaddc)))) @ XF @ (ccofr @ ccle))) @ (^ [Xc:$i] : ccrp)) & ((ccv @ Xt) = (ccfv @ (ccv @ Xf1) @ ccitg1))) & ((cwrex @ (^ [Xd:$i] : (cwbr @ (ccmpt @ (^ [Xz:$i] : ccr) @ (^ [Xz:$i] : (ccif @ ((ccfv @ (ccv @ Xz) @ (ccv @ Xg1)) = ccc0) @ ccc0 @ (cco @ (ccfv @ (ccv @ Xz) @ (ccv @ Xg1)) @ (ccv @ Xd) @ ccaddc)))) @ XG @ (ccofr @ ccle))) @ (^ [Xd:$i] : ccrp)) & ((ccv @ Xu) = (ccfv @ (ccv @ Xg1) @ ccitg1))))) @ (^ [Xg1:$i] : (ccdm @ ccitg1)))) @ (^ [Xf1:$i] : (ccdm @ ccitg1))) & ((ccv @ Xs1) = (cco @ (ccv @ Xt) @ (ccv @ Xu) @ ccaddc))))))))))))))))).
...
thf(aitg1add_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ (ccdm @ ccitg1))) => ((Xph => (cwcel @ XG @ (ccdm @ ccitg1))) => (Xph => ((ccfv @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ ccitg1) = (cco @ (ccfv @ XF @ ccitg1) @ (ccfv @ XG @ ccitg1) @ ccaddc))))))))).
...
thf(citg2addnc_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((Xph => (cwcel @ (ccfv @ XF @ ccitg2) @ ccr)) => ((Xph => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XG)) => ((Xph => (cwcel @ (ccfv @ XG @ ccitg2) @ ccr)) => (Xph => ((ccfv @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ ccitg2) = (cco @ (ccfv @ XF @ ccitg2) @ (ccfv @ XG @ ccitg2) @ ccaddc)))))))))))).
