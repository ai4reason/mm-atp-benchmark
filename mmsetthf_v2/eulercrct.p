...
thf(ceulercrct_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cw3a @ (cwcel @ XG @ ccupgr) @ (cwbr @ XF @ XP @ (ccfv @ XG @ cceupth)) @ (cwbr @ XF @ XP @ (ccfv @ XG @ cccrcts))) => (cwral @ (^ [Xx3:$i] : (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XG @ ccvtxdg)) @ ccdvds)) @ (^ [Xx3:$i] : XV))))))))).
