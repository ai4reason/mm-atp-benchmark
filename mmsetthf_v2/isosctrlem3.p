...
thf(aangneg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccdiv) @ cclog) @ ccim))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((((cwcel @ XA2 @ ccc) & (cwne @ XA2 @ ccc0)) & ((cwcel @ XB2 @ ccc) & (cwne @ XB2 @ ccc0))) => ((cco @ (ccneg @ XA2) @ (ccneg @ XB2) @ (XF @ Xx3 @ Xy1)) = (cco @ XA2 @ XB2 @ (XF @ Xx3 @ Xy1))))))))))).
...
thf(adivne1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwne @ XB2 @ ccc0)) => ((Xph => (cwne @ XA2 @ XB2)) => (Xph => (cwne @ (cco @ XA2 @ XB2 @ ccdiv) @ cc1)))))))))).
...
thf(aisosctrlem2_ax,axiom,(! [XA2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ ((ccfv @ XA2 @ ccabs) = cc1) @ (~ (cc1 = XA2))) => ((ccfv @ (ccfv @ (cco @ cc1 @ XA2 @ ccmin) @ cclog) @ ccim) = (ccfv @ (ccfv @ (cco @ (ccneg @ XA2) @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv) @ cclog) @ ccim))))).
...
thf(aangcan_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccdiv) @ cclog) @ ccim))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ ((cwcel @ XA2 @ ccc) & (cwne @ XA2 @ ccc0)) @ ((cwcel @ XB2 @ ccc) & (cwne @ XB2 @ ccc0)) @ ((cwcel @ XC @ ccc) & (cwne @ XC @ ccc0))) => ((cco @ (cco @ XC @ XA2 @ ccmul) @ (cco @ XC @ XB2 @ ccmul) @ (XF @ Xx3 @ Xy1)) = (cco @ XA2 @ XB2 @ (XF @ Xx3 @ Xy1)))))))))))).
...
thf(cisosctrlem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccdiv) @ cclog) @ ccim))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ ((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) @ (cw3a @ (cwne @ XA2 @ ccc0) @ (cwne @ XB2 @ ccc0) @ (cwne @ XA2 @ XB2)) @ ((ccfv @ XA2 @ ccabs) = (ccfv @ XB2 @ ccabs))) => ((cco @ (ccneg @ XA2) @ (cco @ XB2 @ XA2 @ ccmin) @ (XF @ Xx3 @ Xy1)) = (cco @ (cco @ XA2 @ XB2 @ ccmin) @ (ccneg @ XB2) @ (XF @ Xx3 @ Xy1))))))))))).
