...
thf(cfrnssb_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [Xk:$i] : (((cwss @ XV @ (XW @ Xk)) & (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ XV)) @ (^ [Xk:$i] : XA2))) => ((cwf @ XA2 @ (XW @ Xk) @ XF) <=> (cwf @ XA2 @ XV @ XF))))))))).
