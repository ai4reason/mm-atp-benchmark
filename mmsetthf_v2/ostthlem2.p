...
thf(aostthlem1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XQ = (cco @ cccnfld @ ccq @ ccress)) => ((XA2 = (ccfv @ XQ @ ccabv)) => ((Xph => (cwcel @ XF @ XA2)) => ((Xph => (cwcel @ XG @ XA2)) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ (ccfv @ cc2 @ ccuz))) => ((ccfv @ (ccv @ Xn) @ XF) = (ccfv @ (ccv @ Xn) @ XG)))) => (Xph => (XF = XG))))))))))))).
...
thf(costthlem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xp:$i] : ((XQ @ Xp) = (cco @ cccnfld @ ccq @ ccress))) => ((! [Xp:$i] : (XA2 = (ccfv @ (XQ @ Xp) @ ccabv))) => ((Xph => (cwcel @ XF @ XA2)) => ((Xph => (cwcel @ XG @ XA2)) => ((! [Xp:$i] : ((Xph & (cwcel @ (ccv @ Xp) @ ccprime)) => ((ccfv @ (ccv @ Xp) @ XF) = (ccfv @ (ccv @ Xp) @ XG)))) => (Xph => (XF = XG))))))))))))).
