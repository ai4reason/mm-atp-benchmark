...
thf(aindisuni_ax,axiom,(! [XA2:($i > $o)] : ((ccfv @ XA2 @ ccid) = (ccuni @ (ccpr @ cc0 @ XA2))))).
...
thf(aindislem_ax,axiom,(! [XA2:($i > $o)] : ((ccpr @ cc0 @ (ccfv @ XA2 @ ccid)) = (ccpr @ cc0 @ XA2)))).
...
thf(atxindislem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccxp @ (ccfv @ XA2 @ ccid) @ (ccfv @ XB2 @ ccid)) = (ccfv @ (ccxp @ XA2 @ XB2) @ ccid))))).
thf(ctxindis_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cco @ (ccpr @ cc0 @ XA2) @ (ccpr @ cc0 @ XB2) @ cctx) = (ccpr @ cc0 @ (ccxp @ XA2 @ XB2)))))).
