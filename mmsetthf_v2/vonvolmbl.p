...
thf(aisvonmbl_ax,axiom,(! [Xph:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : ((! [Xa:$i] : ((Xph @ Xa) => (cwcel @ XX @ ccfn))) => (! [Xa:$i] : ((Xph @ Xa) => ((cwcel @ XE @ (ccdm @ (ccfv @ XX @ ccvoln))) <=> ((cwss @ XE @ (cco @ ccr @ XX @ ccmap)) & (cwral @ (^ [Xa:$i] : ((cco @ (ccfv @ (ccin @ (ccv @ Xa) @ XE) @ (ccfv @ XX @ ccovoln)) @ (ccfv @ (ccdif @ (ccv @ Xa) @ XE) @ (ccfv @ XX @ ccovoln)) @ ccxad) = (ccfv @ (ccv @ Xa) @ (ccfv @ XX @ ccovoln)))) @ (^ [Xa:$i] : (ccpw @ (cco @ ccr @ XX @ ccmap))))))))))))).
thf(ccle_tp,type,(ccle : ($i > $o))).
thf(aismbl4_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccvol)) <=> ((cwss @ XA2 @ ccr) & (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ ccovol) = (cco @ (ccfv @ (ccin @ (ccv @ Xx3) @ XA2) @ ccovol) @ (ccfv @ (ccdif @ (ccv @ Xx3) @ XA2) @ ccovol) @ ccxad))) @ (^ [Xx3:$i] : (ccpw @ ccr))))))).
