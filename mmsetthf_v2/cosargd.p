...
thf(ccosargd_conj,conjecture,(! [Xph:$o] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (cwne @ XX @ ccc0)) => (Xph => ((ccfv @ (ccfv @ (ccfv @ XX @ cclog) @ ccim) @ cccos) = (cco @ (ccfv @ XX @ ccre) @ (ccfv @ XX @ ccabs) @ ccdiv)))))))).
