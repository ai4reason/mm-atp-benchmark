...
thf(achdmm4i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((ccfv @ (ccin @ (ccfv @ XA2 @ ccort) @ (ccfv @ XB2 @ ccort)) @ ccort) = (cco @ XA2 @ XB2 @ cchj))))))).
thf(achjcli_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwcel @ (cco @ XA2 @ XB2 @ cchj) @ ccch)))))).
thf(cchjassi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cco @ (cco @ XA2 @ XB2 @ cchj) @ XC @ cchj) = (cco @ XA2 @ (cco @ XB2 @ XC @ cchj) @ cchj))))))))).
