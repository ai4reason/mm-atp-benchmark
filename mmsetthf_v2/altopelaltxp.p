...
thf(aaltopth_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (((ccaltop @ XA2 @ XB2) = (ccaltop @ XC @ XD)) <=> ((XA2 = XC) & (XB2 = XD)))))))))).
...
thf(caltopelaltxp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ (ccaltop @ XX @ XY) @ (ccaltxp @ XA2 @ XB2)) <=> ((cwcel @ XX @ XA2) & (cwcel @ XY @ XB2)))))))).
