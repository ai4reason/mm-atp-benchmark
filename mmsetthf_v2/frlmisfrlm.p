...
thf(cfrlmisfrlm_conj,conjecture,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XR @ ccnzr) @ (cwcel @ XI @ XY) @ (cwbr @ XI @ XJ @ ccen)) => (cwbr @ (cco @ XR @ XI @ ccfrlm) @ (cco @ XR @ XJ @ ccfrlm) @ cclmic))))))).
