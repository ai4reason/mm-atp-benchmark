...
thf(alimsupbnd1f_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xj:$i] : (XF @ Xj))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwss @ XB2 @ ccr)))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwf @ XB2 @ ccxr @ (XF @ Xj))))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwcel @ XA2 @ ccxr)))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : ((cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) => (cwbr @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ XA2 @ ccle))) @ (^ [Xj:$i] : XB2))) @ (^ [Xk:$i] : ccr))))) => (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwbr @ (ccfv @ (XF @ Xj) @ cclsp) @ XA2 @ ccle)))))))))))))).
thf(ccltrr_tp,type,(ccltrr : ($i > $o))).
thf(altpnf_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwbr @ XA2 @ ccpnf @ cclt)))).
thf(aadantl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xch & Xph) => Xps)))))).
thf(axreqnltd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (XA2 = XB2)) => (Xph => (~ (cwbr @ XA2 @ XB2 @ cclt))))))))).
...
thf(alimsuppnfd_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xj:$i] : (XF @ Xj))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xj @ Xk) => (cwss @ XA2 @ ccr))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xj @ Xk) => (cwf @ XA2 @ ccxr @ (XF @ Xj)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xj @ Xk) => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xj:$i] : ((cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) & (cwbr @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ ccle))) @ (^ [Xj:$i] : XA2))) @ (^ [Xk:$i] : ccr))) @ (^ [Xx3:$i] : ccr)))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xj @ Xk) => ((ccfv @ (XF @ Xj) @ cclsp) = ccpnf))))))))))))).
thf(climsuppnflem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xj:$i] : (XF @ Xj))) => ((Xph => (cwss @ XA2 @ ccr)) => ((! [Xj:$i] : (Xph => (cwf @ XA2 @ ccxr @ (XF @ Xj)))) => (! [Xj:$i] : (Xph => (((ccfv @ (XF @ Xj) @ cclsp) = ccpnf) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xj:$i] : ((cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) & (cwbr @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ ccle))) @ (^ [Xj:$i] : XA2))) @ (^ [Xk:$i] : ccr))) @ (^ [Xx3:$i] : ccr)))))))))))).
