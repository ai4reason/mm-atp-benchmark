...
thf(aelmapsnd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwfn @ XF @ (ccsn @ XA2))) => ((Xph => (cwcel @ XB2 @ XV)) => ((Xph => (cwcel @ (ccfv @ XA2 @ XF) @ XB2)) => (Xph => (cwcel @ XF @ (cco @ XB2 @ (ccsn @ XA2) @ ccmap)))))))))))).
...
thf(afvmap_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((Xph => (cwcel @ XF @ (cco @ XA2 @ XB2 @ ccmap))) => ((Xph => (cwcel @ XC @ XB2)) => (Xph => (cwcel @ (ccfv @ XC @ XF) @ XA2)))))))))))))).
...
thf(afsneqrn_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((XB2 = (ccsn @ XA2)) => ((Xph => (cwfn @ XF @ XB2)) => ((Xph => (cwfn @ XG @ XB2)) => (Xph => ((XF = XG) <=> (cwcel @ (ccfv @ XA2 @ XF) @ (ccrn @ XG))))))))))))))).
...
thf(cssmapsn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((cwnfc @ (^ [Xf1:$i] : (XD @ Xf1))) => ((! [Xf1:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xf1)))) => ((! [Xf1:$i] : (Xph => (cwss @ XC @ (cco @ (XB2 @ Xf1) @ (ccsn @ XA2) @ ccmap)))) => ((! [Xf1:$i] : ((XD @ Xf1) = (cciun @ (^ [Xf1:$i] : XC) @ (^ [Xf1:$i] : (ccrn @ (ccv @ Xf1)))))) => (! [Xf1:$i] : (Xph => (XC = (cco @ (XD @ Xf1) @ (ccsn @ XA2) @ ccmap))))))))))))))).
