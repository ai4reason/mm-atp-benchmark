...
thf(aelfi2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((cwcel @ XA2 @ (ccfv @ XB2 @ ccfi)) <=> (cwrex @ (^ [Xx3:$i] : (XA2 = (ccint @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccdif @ (ccin @ (ccpw @ XB2) @ ccfn) @ (ccsn @ cc0)))))))))).
...
thf(aufilb_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XF @ (ccfv @ XX @ ccufil)) & (cwss @ XS @ XX)) => ((~ (cwcel @ XS @ XF)) <=> (cwcel @ (ccdif @ XX @ XS) @ XF))))))).
...
thf(afilintn0_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XF @ (ccfv @ XX @ ccfil)) & (cw3a @ (cwss @ XA2 @ XF) @ (cwne @ XA2 @ cc0) @ (cwcel @ XA2 @ ccfn))) => (cwne @ (ccint @ XA2) @ cc0)))))).
...
thf(calexsublem_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccufl)) => ((Xph => (XX = (ccuni @ XB2))) => ((Xph => (XJ = (ccfv @ (ccfv @ XB2 @ ccfi) @ cctg))) => ((! [Xx3:$i] : ((Xph & ((cwss @ (ccv @ Xx3) @ XB2) & (XX = (ccuni @ (ccv @ Xx3))))) => (cwrex @ (^ [Xy1:$i] : (XX = (ccuni @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccin @ (ccpw @ (ccv @ Xx3)) @ ccfn))))) => ((Xph => (cwcel @ XF @ (ccfv @ XX @ ccufil))) => ((Xph => ((cco @ XJ @ XF @ ccflim) = cc0)) => (~ Xph))))))))))))).
