...
thf(acosmpi_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (cco @ XA2 @ ccpi @ ccmin) @ cccos) = (ccneg @ (ccfv @ XA2 @ cccos)))))).
...
thf(asinmul_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ (ccfv @ XA2 @ ccsin) @ (ccfv @ XB2 @ ccsin) @ ccmul) = (cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ cccos) @ (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cccos) @ ccmin) @ cc2 @ ccdiv)))))).
...
thf(acosppi_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (cco @ XA2 @ ccpi @ ccaddc) @ cccos) = (ccneg @ (ccfv @ XA2 @ cccos)))))).
