...
thf(amodprmn0modprm0_ax,axiom,(! [XP:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XN @ ccz) @ (cwne @ (cco @ XN @ XP @ ccmo) @ ccc0)) => ((cwcel @ XI @ (cco @ ccc0 @ XP @ ccfzo)) => (cwrex @ (^ [Xj:$i] : ((cco @ (cco @ XI @ (cco @ (ccv @ Xj) @ XN @ ccmul) @ ccaddc) @ XP @ ccmo) = ccc0)) @ (^ [Xj:$i] : (cco @ ccc0 @ XP @ ccfzo))))))))).
...
thf(acshweqrep_ax,axiom,(! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XL @ ccz)) => ((((cco @ XW @ XL @ cccsh) = XW) & (cwcel @ XI @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) => (cwral @ (^ [Xj:$i] : ((ccfv @ XI @ XW) = (ccfv @ (cco @ (cco @ XI @ (cco @ (ccv @ Xj) @ XL @ ccmul) @ ccaddc) @ (ccfv @ XW @ cchash) @ ccmo) @ XW))) @ (^ [Xj:$i] : ccn0))))))))).
...
thf(ccshwsidrepsw_conj,conjecture,(! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ (ccfv @ XW @ cchash) @ ccprime)) => ((cw3a @ (cwcel @ XL @ ccz) @ (cwne @ (cco @ XL @ (ccfv @ XW @ cchash) @ ccmo) @ ccc0) @ ((cco @ XW @ XL @ cccsh) = XW)) => (XW = (cco @ (ccfv @ ccc0 @ XW) @ (ccfv @ XW @ cchash) @ ccreps)))))))).
