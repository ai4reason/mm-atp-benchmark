...
thf(aresin4p_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ cci @ XA2 @ ccmul) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : ((cwcel @ XA2 @ ccr) => ((ccfv @ XA2 @ ccsin) = (cco @ (cco @ XA2 @ (cco @ (cco @ XA2 @ cc3 @ ccexp) @ cc6 @ ccdiv) @ ccmin) @ (ccfv @ (ccsu @ (ccfv @ cc4 @ ccuz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xn)))) @ ccim) @ ccaddc)))))))).
