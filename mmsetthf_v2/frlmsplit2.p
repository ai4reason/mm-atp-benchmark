...
thf(areslmhm2b_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XT @ XX @ ccress)) => ((XL = (ccfv @ XT @ cclss)) => ((cw3a @ (cwcel @ XT @ cclmod) @ (cwcel @ XX @ XL) @ (cwss @ (ccrn @ XF) @ XX)) => ((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) <=> (cwcel @ XF @ (cco @ XS @ XU @ cclmhm))))))))))))).
...
thf(cfrlmsplit2_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XY = (cco @ XR @ XU @ ccfrlm)) => ((XZ = (cco @ XR @ XV @ ccfrlm)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XC = (ccfv @ XZ @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccres @ (ccv @ Xx3) @ XV))))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XU @ XX) @ (cwss @ XV @ XU)) => (cwcel @ (XF @ Xx3) @ (cco @ XY @ XZ @ cclmhm))))))))))))))))))).
