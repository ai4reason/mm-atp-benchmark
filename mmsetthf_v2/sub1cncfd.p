...
thf(csub1cncfd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccc)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ ccmin))))) => (! [Xx3:$i] : (Xph => (cwcel @ (XF @ Xx3) @ (cco @ ccc @ ccc @ cccncf)))))))))).
