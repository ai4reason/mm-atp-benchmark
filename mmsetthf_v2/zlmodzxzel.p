...
thf(czlmodzxzel_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => (cwcel @ (ccpr @ (ccop @ ccc0 @ XA2) @ (ccop @ cc1 @ XB2)) @ (ccfv @ XZ @ ccbs)))))))).
