...
thf(aslesolvec_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XV = (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => ((Xc_x = (cco @ XR @ (ccop @ XN @ XN) @ ccmvmul)) => ((((cwne @ XN @ cc0) & (cwcel @ XR @ ccrg)) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XV))) => (((cco @ XX @ XZ @ Xc_x) = XY) => (cwcel @ XZ @ XV))))))))))))))))).
...
thf(advrcan3_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XU = (ccfv @ XR @ ccui)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XU)) => ((cco @ (cco @ XX @ XY @ Xc_x) @ XY @ Xc_dv) = XX)))))))))))))).
...
thf(acramerimplem1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XV = (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => ((XE = (ccfv @ XI @ (cco @ (ccfv @ XA2 @ ccur) @ XZ @ (cco @ XN @ XR @ ccmatrepV)))) => ((XD = (cco @ XN @ XR @ ccmdat)) => (((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ cccrg) @ (cwcel @ XI @ XN)) & (cwcel @ XZ @ XV)) => ((ccfv @ XE @ XD) = (ccfv @ XI @ XZ)))))))))))))))))).
thf(a_3adant3r_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (((cw3a @ Xph @ Xps @ Xch) => Xth) => ((cw3a @ Xph @ Xps @ (Xch & Xta)) => Xth)))))))).
thf(acramerimplem3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xo:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XV = (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => ((XE = (ccfv @ XI @ (cco @ (ccfv @ XA2 @ ccur) @ XZ @ (cco @ XN @ XR @ ccmatrepV)))) => ((XH = (ccfv @ XI @ (cco @ XX @ XY @ (cco @ XN @ XR @ ccmatrepV)))) => ((Xc_x = (cco @ XR @ (ccop @ XN @ XN) @ ccmvmul)) => ((XD = (cco @ XN @ XR @ ccmdat)) => ((Xc_xo = (ccfv @ XR @ ccmulr)) => ((cw3a @ ((cwcel @ XR @ cccrg) & (cwcel @ XI @ XN)) @ ((cwcel @ XX @ XB2) & (cwcel @ XY @ XV)) @ ((cco @ XX @ XZ @ Xc_x) = XY)) => ((cco @ (ccfv @ XX @ XD) @ (ccfv @ XE @ XD) @ Xc_xo) = (ccfv @ XH @ XD)))))))))))))))))))))))))).
thf(ccramerimp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XV = (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => ((XE = (ccfv @ XI @ (cco @ (ccfv @ XA2 @ ccur) @ XZ @ (cco @ XN @ XR @ ccmatrepV)))) => ((XH = (ccfv @ XI @ (cco @ XX @ XY @ (cco @ XN @ XR @ ccmatrepV)))) => ((Xc_x = (cco @ XR @ (ccop @ XN @ XN) @ ccmvmul)) => ((XD = (cco @ XN @ XR @ ccmdat)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((cw3a @ ((cwcel @ XR @ cccrg) & (cwcel @ XI @ XN)) @ ((cwcel @ XX @ XB2) & (cwcel @ XY @ XV)) @ (((cco @ XX @ XZ @ Xc_x) = XY) & (cwcel @ (ccfv @ XX @ XD) @ (ccfv @ XR @ ccui)))) => ((ccfv @ XI @ XZ) = (cco @ (ccfv @ XH @ XD) @ (ccfv @ XX @ XD) @ Xc_dv)))))))))))))))))))))))))).
