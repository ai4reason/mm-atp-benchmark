...
thf(clkrf0_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XW @ ccsca)) => ((Xc_0 = (ccfv @ XD @ cc0g)) => ((XF = (ccfv @ XW @ cclfn)) => ((XK = (ccfv @ XW @ cclk)) => ((cw3a @ (cwcel @ XW @ XY) @ (cwcel @ XG @ XF) @ (cwcel @ XX @ (ccfv @ XG @ XK))) => ((ccfv @ XX @ XG) = Xc_0))))))))))))))).
