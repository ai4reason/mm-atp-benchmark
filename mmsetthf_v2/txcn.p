...
thf(aupxp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xh:$i] : ((XP @ Xh) = (ccres @ cc1st @ (ccxp @ XB2 @ XC)))) => ((! [Xh:$i] : ((XQ @ Xh) = (ccres @ cc2nd @ (ccxp @ XB2 @ XC)))) => ((cw3a @ (cwcel @ XA2 @ XD) @ (cwf @ XA2 @ XB2 @ XF) @ (cwf @ XA2 @ XC @ XG)) => (cweu @ (^ [Xh:$i] : (cw3a @ (cwf @ XA2 @ (ccxp @ XB2 @ XC) @ (ccv @ Xh)) @ (XF = (cccom @ (XP @ Xh) @ (ccv @ Xh))) @ (XG = (cccom @ (XQ @ Xh) @ (ccv @ Xh)))))))))))))))))).
...
thf(ctxcn_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XX = (ccuni @ XR)) => ((XY = (ccuni @ XS)) => ((XZ = (ccxp @ XX @ XY)) => ((XW = (ccuni @ XU)) => ((XP = (ccres @ cc1st @ XZ)) => ((XQ = (ccres @ cc2nd @ XZ)) => ((cw3a @ (cwcel @ XR @ cctop) @ (cwcel @ XS @ cctop) @ (cwf @ XW @ XZ @ XF)) => ((cwcel @ XF @ (cco @ XU @ (cco @ XR @ XS @ cctx) @ cccn)) <=> ((cwcel @ (cccom @ XP @ XF) @ (cco @ XU @ XR @ cccn)) & (cwcel @ (cccom @ XQ @ XF) @ (cco @ XU @ XS @ cccn)))))))))))))))))))))).
