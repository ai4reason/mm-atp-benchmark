...
thf(af1cocnv1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf1 @ XA2 @ XB2 @ XF) => ((cccom @ (cccnv @ XF) @ XF) = (ccres @ ccid @ XA2))))))).
...
thf(cdiophrw_conj,conjecture,(! [XP:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : ((cw3a @ (cwcel @ XS @ ccvv) @ (cwf1 @ XT @ XS @ XM) @ ((ccres @ XM @ XO) = (ccres @ ccid @ XO))) => ((ccab @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (((ccv @ Xa) = (ccres @ (ccv @ Xb) @ XO)) & ((ccfv @ (ccv @ Xb) @ (ccmpt @ (^ [Xd:$i] : (cco @ ccz @ XS @ ccmap)) @ (^ [Xd:$i] : (ccfv @ (cccom @ (ccv @ Xd) @ XM) @ (XP @ Xa))))) = ccc0))) @ (^ [Xb:$i] : (cco @ ccn0 @ XS @ ccmap))))) = (ccab @ (^ [Xa:$i] : (cwrex @ (^ [Xc:$i] : (((ccv @ Xa) = (ccres @ (ccv @ Xc) @ XO)) & ((ccfv @ (ccv @ Xc) @ (XP @ Xa)) = ccc0))) @ (^ [Xc:$i] : (cco @ ccn0 @ XT @ ccmap))))))))))))).
