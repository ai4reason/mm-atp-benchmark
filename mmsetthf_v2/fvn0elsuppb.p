...
thf(cfvn0elsuppb_conj,conjecture,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XB2 @ XV) @ (cwcel @ XX @ XB2) @ (cwfn @ XG @ XB2)) => ((cwne @ (ccfv @ XX @ XG) @ cc0) <=> (cwcel @ XX @ (cco @ XG @ cc0 @ ccsupp))))))))).
