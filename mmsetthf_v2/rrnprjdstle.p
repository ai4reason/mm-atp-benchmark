...
thf(arrxdstprj1_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xh:$i] : ((XX @ Xh) = (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ ccc0 @ ccfsupp)) @ (^ [Xh:$i] : (cco @ ccr @ XI @ ccmap))))) => ((! [Xh:$i] : ((XD @ Xh) = (ccfv @ (ccfv @ XI @ ccrrx) @ ccds))) => ((! [Xh:$i] : ((XM @ Xh) = (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ ccr @ ccr)))) => (! [Xh:$i] : ((((cwcel @ XI @ XV) & (cwcel @ (XA2 @ Xh) @ XI)) & ((cwcel @ XF @ (XX @ Xh)) & (cwcel @ XG @ (XX @ Xh)))) => (cwbr @ (cco @ (ccfv @ (XA2 @ Xh) @ XF) @ (ccfv @ (XA2 @ Xh) @ XG) @ (XM @ Xh)) @ (cco @ XF @ XG @ (XD @ Xh)) @ ccle))))))))))))))).
thf(crrnprjdstle_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((Xph => (cwf @ XX @ ccr @ XF)) => ((Xph => (cwf @ XX @ ccr @ XG)) => ((Xph => (cwcel @ XI @ XX)) => ((XD = (ccfv @ (ccfv @ XX @ ccrrx) @ ccds)) => (Xph => (cwbr @ (ccfv @ (cco @ (ccfv @ XI @ XF) @ (ccfv @ XI @ XG) @ ccmin) @ ccabs) @ (cco @ XF @ XG @ XD) @ ccle)))))))))))))).
