...
thf(cscafeq_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_xb = (ccfv @ XW @ ccscaf)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((cwfn @ Xc_x @ (ccxp @ XK @ XB2)) => (Xc_xb = Xc_x)))))))))))))).
