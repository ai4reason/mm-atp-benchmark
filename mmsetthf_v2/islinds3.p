...
thf(alsslsp_ax,axiom,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ XW @ XU @ ccress)) => ((XM = (ccfv @ XW @ cclspn)) => ((XN = (ccfv @ XX @ cclspn)) => ((XL = (ccfv @ XW @ cclss)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XU @ XL) @ (cwss @ XG @ XU)) => ((ccfv @ XG @ XM) = (ccfv @ XG @ XN))))))))))))))).
...
thf(alsslinds_ax,axiom,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XU = (ccfv @ XW @ cclss)) => ((XX = (cco @ XW @ XS @ ccress)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XS @ XU) @ (cwss @ XF @ XS)) => ((cwcel @ XF @ (ccfv @ XX @ cclinds)) <=> (cwcel @ XF @ (ccfv @ XW @ cclinds)))))))))))).
