...
thf(atususp_ax,axiom,(! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XK = (ccfv @ XU @ cctus)) => ((cwcel @ XU @ (ccfv @ XX @ ccust)) => (cwcel @ XK @ ccusp))))))).
...
thf(acfilucfil2_ax,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (((cwne @ XX @ cc0) & (cwcel @ XD @ (ccfv @ XX @ ccpsmet))) => ((cwcel @ XC @ (ccfv @ (ccfv @ XD @ ccmetu) @ cccfilu)) <=> ((cwcel @ XC @ (ccfv @ XX @ ccfbas)) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (ccima @ XD @ (ccxp @ (ccv @ Xy1) @ (ccv @ Xy1))) @ (cco @ ccc0 @ (ccv @ Xx3) @ ccico))) @ (^ [Xy1:$i] : XC))) @ (^ [Xx3:$i] : ccrp))))))))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(aiscfil_ax,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => ((cwcel @ XF @ (ccfv @ XD @ cccfil)) <=> ((cwcel @ XF @ (ccfv @ XX @ ccfil)) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (ccima @ XD @ (ccxp @ (ccv @ Xy1) @ (ccv @ Xy1))) @ (cco @ ccc0 @ (ccv @ Xx3) @ ccico))) @ (^ [Xy1:$i] : XF))) @ (^ [Xx3:$i] : ccrp))))))))).
...
thf(ccmetcusp_conj,conjecture,(! [XD:($i > $o)] : (! [XX:($i > $o)] : (((cwne @ XX @ cc0) & (cwcel @ XD @ (ccfv @ XX @ ccms))) => (cwcel @ (ccfv @ (ccfv @ XD @ ccmetu) @ cctus) @ cccusp))))).
