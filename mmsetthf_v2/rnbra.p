...
thf(abrabn_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ cchil) => (cwcel @ (ccfv @ (ccfv @ XA2 @ ccbr) @ ccnmf) @ ccr)))).
...
thf(ariesz1_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ cclf) => ((cwcel @ (ccfv @ XT @ ccnmf) @ ccr) <=> (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XT) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsp))) @ (^ [Xx3:$i] : cchil))) @ (^ [Xy1:$i] : cchil)))))).
...
thf(alnfnf_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ cclf) => (cwf @ cchil @ ccc @ XT)))).
