...
thf(adec0uOLD_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cco @ cc10 @ XA2 @ ccmul) = (ccdc @ XA2 @ ccc0))))).
thf(adeceq1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((ccdc @ XA2 @ XC) = (ccdc @ XB2 @ XC))))))).
thf(aeqcomi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 = XB2) => (XB2 = XA2))))).
thf(cdecmul10addOLD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XM @ ccn0) => ((XE = (cco @ XM @ XA2 @ ccmul)) => ((XF = (cco @ XM @ XB2 @ ccmul)) => ((cco @ XM @ (ccdc @ XA2 @ XB2) @ ccmul) = (cco @ (ccdc @ XE @ ccc0) @ XF @ ccaddc))))))))))))).
