...
thf(ahashbc0_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XC @ Xi @ Xa @ Xb) = (ccmpt2 @ (^ [Xa:$i] : (^ [Xi:$i] : ccvv)) @ (^ [Xa:$i] : (^ [Xi:$i] : ccn0)) @ (^ [Xa:$i] : (^ [Xi:$i] : (ccrab @ (^ [Xb:$i] : ((ccfv @ (ccv @ Xb) @ cchash) = (ccv @ Xi))) @ (^ [Xb:$i] : (ccpw @ (ccv @ Xa))))))))))) => (! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : ((cwcel @ (XA2 @ Xb) @ (XV @ Xi @ Xa @ Xb)) => ((cco @ (XA2 @ Xb) @ ccc0 @ (XC @ Xi @ Xa @ Xb)) = (ccsn @ cc0))))))))))).
...
thf(ann0lem1lt_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) => ((cwbr @ XM @ XN @ ccle) <=> (cwbr @ (cco @ XM @ cc1 @ ccmin) @ XN @ cclt)))))).
...
thf(c_0ram_conj,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : (((cw3a @ (cwcel @ XR @ (XV @ Xy1)) @ (cwne @ XR @ cc0) @ (cwf @ XR @ ccn0 @ XF)) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (ccrn @ XF)))) @ (^ [Xx3:$i] : ccz))) => ((cco @ ccc0 @ XF @ ccram) = (ccsup @ (ccrn @ XF) @ ccr @ cclt)))))))).
