...
thf(afdivmptf_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwf @ XA2 @ ccc @ XF) @ (cwf @ XA2 @ ccc @ XG) @ (cwcel @ XA2 @ XV)) => (cwf @ (cco @ XG @ ccc0 @ ccsupp) @ ccc @ (cco @ XF @ XG @ ccfdiv)))))))).
...
thf(cfdivpm_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwf @ XA2 @ ccc @ XF) @ (cwf @ XA2 @ ccc @ XG) @ (cwcel @ XA2 @ XV)) => (cwcel @ (cco @ XF @ XG @ ccfdiv) @ (cco @ ccc @ XA2 @ ccpm)))))))).
