...
thf(apjidmcoi_ax,axiom,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cccom @ (ccfv @ XH @ ccpjh) @ (ccfv @ XH @ ccpjh)) = (ccfv @ XH @ ccpjh))))).
...
thf(cpjidmco_conj,conjecture,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cccom @ (ccfv @ XH @ ccpjh) @ (ccfv @ XH @ ccpjh)) = (ccfv @ XH @ ccpjh))))).
