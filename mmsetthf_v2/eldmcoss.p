...
thf(admcoss3_ax,axiom,(! [XR:($i > $o)] : ((ccdm @ (cccoss @ XR)) = (ccdm @ (cccnv @ XR))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(aeldmcnv_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XA2 @ (ccdm @ (cccnv @ XR))) <=> (? [Xu:$i] : (cwbr @ (ccv @ Xu) @ XA2 @ XR)))))))).
