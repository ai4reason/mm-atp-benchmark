...
thf(ainres2_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((ccin @ (ccres @ XR @ XA2) @ XS) = (ccres @ (ccin @ XR @ XS) @ XA2)))))).
thf(cxrnres_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((ccres @ (ccxrn @ XR @ XS) @ XA2) = (ccxrn @ (ccres @ XR @ XA2) @ XS)))))).
