...
thf(acnlnadj_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ (ccin @ cclo @ cccop)) => (cwrex @ (^ [Xt:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xy1) @ ccsp) = (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xt)) @ ccsp))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : cchil))) @ (^ [Xt:$i] : (ccin @ cclo @ cccop)))))).
...
thf(ccnlnssadj_conj,conjecture,(cwss @ (ccin @ cclo @ cccop) @ (ccdm @ ccado))).
