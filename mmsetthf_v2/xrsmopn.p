...
thf(axrsxmet_ax,axiom,(! [XD:($i > $o)] : ((XD = (ccfv @ ccxrs @ ccds)) => (cwcel @ XD @ (ccfv @ ccxr @ ccxmt))))).
...
thf(ablres_ax,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XC = (ccres @ XD @ (ccxp @ XY @ XY))) => ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ (ccin @ XX @ XY)) @ (cwcel @ XR @ ccxr)) => ((cco @ XP @ XR @ (ccfv @ XC @ ccbl)) = (ccin @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ XY))))))))))).
thf(aeqcomi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 = XB2) => (XB2 = XA2))))).
thf(axrsdsre_ax,axiom,(! [XD:($i > $o)] : ((XD = (ccfv @ ccxrs @ ccds)) => ((ccres @ XD @ (ccxp @ ccr @ ccr)) = (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ ccr @ ccr)))))).
thf(asylib_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps <=> Xch) => (Xph => Xch))))))).
thf(asylan2_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xch) => (((Xps & Xch) => Xth) => ((Xps & Xph) => Xth)))))))).
thf(cccnv_tp,type,(cccnv : (($i > $o) > ($i > $o)))).
thf(ccima_tp,type,(ccima : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccec_tp,type,(ccec : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(axrsblre_ax,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((XD = (ccfv @ ccxrs @ ccds)) => (((cwcel @ XP @ ccr) & (cwcel @ XR @ ccxr)) => (cwss @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ ccr))))))).
...
thf(axrsdsreclb_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((XD = (ccfv @ ccxrs @ ccds)) => ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwne @ XA2 @ XB2)) => ((cwcel @ (cco @ XA2 @ XB2 @ XD) @ ccr) <=> ((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr))))))))).
...
thf(cxrsmopn_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : ((XD = (ccfv @ ccxrs @ ccds)) => ((XJ = (ccfv @ XD @ ccmopn)) => (cwss @ (ccfv @ ccle @ ccordt) @ XJ)))))).
