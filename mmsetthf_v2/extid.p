...
thf(aecidsn_ax,axiom,(! [XA2:($i > $o)] : ((ccec @ XA2 @ ccid) = (ccsn @ XA2)))).
thf(asneqbg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (((ccsn @ XA2) = (ccsn @ XB2)) <=> (XA2 = XB2))))))).
thf(cextid_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (((ccec @ XA2 @ (cccnv @ ccid)) = (ccec @ XB2 @ (cccnv @ ccid))) <=> (XA2 = XB2))))))).
