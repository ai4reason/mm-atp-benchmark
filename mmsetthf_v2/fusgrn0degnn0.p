...
thf(cfusgrn0degnn0_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xn:$i] : ((XV @ Xn) = (ccfv @ XG @ ccvtx))) => (! [Xn:$i] : (((cwcel @ XG @ ccfusgr) & (cwne @ (XV @ Xn) @ cc0)) => (cwrex @ (^ [Xv:$i] : (cwrex @ (^ [Xn:$i] : ((ccfv @ (ccv @ Xv) @ (ccfv @ XG @ ccvtxdg)) = (ccv @ Xn))) @ (^ [Xn:$i] : ccn0))) @ (^ [Xv:$i] : (XV @ Xn))))))))).
