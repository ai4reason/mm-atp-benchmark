...
thf(a_2llnma3r_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2) @ (cwcel @ XR @ XA2)) @ (cwne @ (cco @ XP @ XR @ Xc_or) @ (cco @ XQ @ XR @ Xc_or))) => ((cco @ (cco @ XP @ XR @ Xc_or) @ (cco @ XQ @ XR @ Xc_or) @ Xc_an) = XR))))))))))))))).
...
thf(ccdlemg12a_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XU = (cco @ (cco @ XP @ XQ @ Xc_or) @ XW @ Xc_an)) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ (cw3a @ ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) @ ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le))) @ (cwcel @ XF @ XT)) @ (cw3a @ (cwcel @ XG @ XT) @ (cwne @ XP @ XQ) @ (cwne @ (cco @ XP @ XU @ Xc_or) @ (cco @ (ccfv @ XP @ XG) @ XU @ Xc_or)))) => (cwbr @ (cco @ (cco @ XP @ XU @ Xc_or) @ (cco @ (ccfv @ XP @ XG) @ XU @ Xc_or) @ Xc_an) @ (cco @ (ccfv @ (ccfv @ XP @ XG) @ XF) @ XU @ Xc_or) @ Xc_le))))))))))))))))))))))).
