...
thf(afnmrc_ax,axiom,(cwfn @ ccmrc @ (ccuni @ (ccrn @ ccmre)))).
...
thf(cismrc_conj,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (ccima @ ccmrc @ (ccfv @ XB2 @ ccmre))) <=> (cw3a @ (cwcel @ XB2 @ ccvv) @ (cwf @ (ccpw @ XB2) @ (ccpw @ XB2) @ XF) @ (! [Xx3:$i] : (! [Xy1:$i] : (((cwss @ (ccv @ Xx3) @ XB2) & (cwss @ (ccv @ Xy1) @ (ccv @ Xx3))) => (cw3a @ (cwss @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ XF)) @ (cwss @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF)) @ ((ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XF) = (ccfv @ (ccv @ Xx3) @ XF))))))))))).
