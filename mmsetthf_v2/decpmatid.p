...
thf(apmat1ovd_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XC = (cco @ XN @ XP @ ccmat)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((Xc_1 = (ccfv @ XP @ ccur)) => ((Xph => (cwcel @ XN @ ccfn)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XI @ XN)) => ((Xph => (cwcel @ XJ @ XN)) => ((XU = (ccfv @ XC @ ccur)) => (Xph => ((cco @ XI @ XJ @ XU) = (ccif @ (XI = XJ) @ Xc_1 @ Xc_0))))))))))))))))))))))).
...
thf(aiffv_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((ccfv @ XA2 @ (ccif @ Xph @ XF @ XG)) = (ccif @ Xph @ (ccfv @ XA2 @ XF) @ (ccfv @ XA2 @ XG)))))))).
...
thf(amat1_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) => ((ccfv @ XA2 @ ccur) = (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = (ccv @ Xj)) @ Xc_1 @ Xc_0))))))))))))))).
...
thf(cdecpmatid_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XC = (cco @ XN @ XP @ ccmat)) => ((XI = (ccfv @ XC @ ccur)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((Xc_0 = (ccfv @ XA2 @ cc0g)) => ((Xc_1 = (ccfv @ XA2 @ ccur)) => ((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg) @ (cwcel @ XK @ ccn0)) => ((cco @ XI @ XK @ ccdecpmat) = (ccif @ (XK = ccc0) @ Xc_1 @ Xc_0))))))))))))))))))).
