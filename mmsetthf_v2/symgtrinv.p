...
thf(ainvoppggim_ax,axiom,(! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XG @ ccoppg)) => ((XI = (ccfv @ XG @ ccminusg)) => ((cwcel @ XG @ ccgrp) => (cwcel @ XI @ (cco @ XG @ XO @ ccgim))))))))).
...
thf(apmtrfcnv_ax,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((XR = (ccrn @ XT)) => ((cwcel @ XF @ XR) => ((cccnv @ XF) = XF))))))))).
thf(agrpmnd_ax,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ ccgrp) => (cwcel @ XG @ ccmnd)))).
thf(ccconcat_tp,type,(ccconcat : ($i > $o))).
thf(ccs1_tp,type,(ccs1 : (($i > $o) > ($i > $o)))).
thf(agsumwrev_ax,axiom,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XO = (ccfv @ XM @ ccoppg)) => (((cwcel @ XM @ ccmnd) & (cwcel @ XW @ (ccword @ XB2))) => ((cco @ XO @ XW @ ccgsu) = (cco @ XM @ (ccfv @ XW @ ccreverse) @ ccgsu)))))))))).
thf(csymgtrinv_conj,conjecture,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XT = (ccrn @ (ccfv @ XD @ ccpmtr))) => ((XG = (ccfv @ XD @ ccsymg)) => ((XI = (ccfv @ XG @ ccminusg)) => (((cwcel @ XD @ XV) & (cwcel @ XW @ (ccword @ XT))) => ((ccfv @ (cco @ XG @ XW @ ccgsu) @ XI) = (cco @ XG @ (ccfv @ XW @ ccreverse) @ ccgsu))))))))))))).
