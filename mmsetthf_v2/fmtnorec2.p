...
thf(afmtno0_ax,axiom,((ccfv @ ccc0 @ ccfmtno) = cc3)).
...
thf(afmtno1_ax,axiom,((ccfv @ cc1 @ ccfmtno) = cc5)).
thf(ccmin_tp,type,(ccmin : ($i > $o))).
thf(afmtnorec2lem_ax,axiom,(! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ ccn0) => (((ccfv @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ ccfmtno) = (cco @ (ccprod @ (^ [Xn:$i] : (cco @ ccc0 @ (ccv @ Xy1) @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ ccfmtno))) @ cc2 @ ccaddc)) => ((ccfv @ (cco @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ cc1 @ ccaddc) @ ccfmtno) = (cco @ (ccprod @ (^ [Xn:$i] : (cco @ ccc0 @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ ccfmtno))) @ cc2 @ ccaddc)))))).
thf(cfmtnorec2_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccfmtno) = (cco @ (ccprod @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ ccfmtno))) @ cc2 @ ccaddc))))).
