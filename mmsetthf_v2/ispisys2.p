...
thf(cispisys2_conj,conjecture,(! [XP:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : ((! [Xx3:$i] : (! [Xs1:$i] : ((XP @ Xx3 @ Xs1) = (ccrab @ (^ [Xs1:$i] : (cwss @ (ccfv @ (ccv @ Xs1) @ ccfi) @ (ccv @ Xs1))) @ (^ [Xs1:$i] : (ccpw @ (ccpw @ XO))))))) => (! [Xx3:$i] : (! [Xs1:$i] : ((cwcel @ XS @ (XP @ Xx3 @ Xs1)) <=> ((cwcel @ XS @ (ccpw @ (ccpw @ XO))) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccint @ (ccv @ Xx3)) @ XS)) @ (^ [Xx3:$i] : (ccdif @ (ccin @ (ccpw @ XS) @ ccfn) @ (ccsn @ cc0))))))))))))).
