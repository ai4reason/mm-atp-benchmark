...
thf(advdsaddr_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwbr @ XM @ XN @ ccdvds) <=> (cwbr @ XM @ (cco @ XN @ XM @ ccaddc) @ ccdvds)))))).
...
thf(csignslema_conj,conjecture,(! [Xph:$o] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((Xph => (cwcel @ XE @ ccn0)) => ((Xph => (cwcel @ XF @ ccn0)) => ((Xph => (cwcel @ XG @ ccn0)) => ((Xph => (cwcel @ XH @ ccn0)) => ((Xph => ((cwbr @ XE @ XG @ cclt) & (~ (cwbr @ cc2 @ (cco @ XG @ XE @ ccmin) @ ccdvds)))) => ((Xph => (cwcel @ (cco @ (cco @ XH @ XG @ ccmin) @ (cco @ XF @ XE @ ccmin) @ ccmin) @ (ccpr @ ccc0 @ cc2))) => (Xph => ((cwbr @ XF @ XH @ cclt) & (~ (cwbr @ cc2 @ (cco @ XH @ XF @ ccmin) @ ccdvds)))))))))))))))).
