...
thf(ahne0_ax,axiom,((cwne @ cchil @ cc0h) <=> (cwrex @ (^ [Xx3:$i] : (cwne @ (ccv @ Xx3) @ cc0v)) @ (^ [Xx3:$i] : cchil)))).
thf(anorm1hex_b_ax,axiom,((cwrex @ (^ [Xx3:$i] : (cwne @ (ccv @ Xx3) @ cc0v)) @ (^ [Xx3:$i] : cchil)) <=> (cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ ccno) = cc1)) @ (^ [Xx3:$i] : cchil)))).
...
thf(cnmopun_conj,conjecture,(! [XT:($i > $o)] : (((cwne @ cchil @ cc0h) & (cwcel @ XT @ ccuo)) => ((ccfv @ XT @ ccnop) = cc1)))).
