...
thf(aiscld_ax,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ cctop) => ((cwcel @ XS @ (ccfv @ XJ @ cccld)) <=> ((cwss @ XS @ XX) & (cwcel @ (ccdif @ XX @ XS) @ XJ))))))))).
thf(copnsubg_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ XG @ cctopn)) => ((cw3a @ (cwcel @ XG @ cctgp) @ (cwcel @ XS @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XS @ XJ)) => (cwcel @ XS @ (ccfv @ XJ @ cccld)))))))).
