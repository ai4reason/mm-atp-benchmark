...
thf(aressuppfi_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ (ccdif @ (ccdm @ XF) @ XB2) @ ccfn)) => ((Xph => (cwcel @ XF @ XW)) => ((Xph => (XG = (ccres @ XF @ XB2))) => ((Xph => (cwcel @ (cco @ XG @ XZ @ ccsupp) @ ccfn)) => ((Xph => (cwcel @ XZ @ XV)) => (Xph => (cwcel @ (cco @ XF @ XZ @ ccsupp) @ ccfn))))))))))))))).
