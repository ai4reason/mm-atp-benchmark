...
thf(c_1to3vfriendship_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xv:$i] : (XV = (ccfv @ (XG @ Xv) @ ccvtx))) => ((! [Xv:$i] : (XE = (ccfv @ (XG @ Xv) @ ccedg))) => (! [Xv:$i] : (((cwcel @ XA2 @ (XX @ Xv)) & (cw3o @ (XV = (ccsn @ XA2)) @ (XV = (ccpr @ XA2 @ XB2)) @ (XV = (cctp @ XA2 @ XB2 @ XC)))) => ((cwcel @ (XG @ Xv) @ ccfrgr) => (cwrex @ (^ [Xv:$i] : (cwral @ (^ [Xw:$i] : (cwcel @ (ccpr @ (ccv @ Xv) @ (ccv @ Xw)) @ XE)) @ (^ [Xw:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV))))))))))))))).
