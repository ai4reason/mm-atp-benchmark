...
thf(amp3an3an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (Xph => ((Xps => Xch) => ((Xth => Xta) => (((cw3a @ Xph @ Xch @ Xta) => Xet) => ((Xps & Xth) => Xet)))))))))))).
...
thf(cnn0p1elfzo_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccn0) @ (cwcel @ XN @ ccn0) @ (cwbr @ (cco @ XK @ cc1 @ ccaddc) @ XN @ ccle)) => (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfzo)))))).
