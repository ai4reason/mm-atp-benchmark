...
thf(afoeq3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cwfo @ XC @ XA2 @ XF) <=> (cwfo @ XC @ XB2 @ XF)))))))).
thf(cfifo_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xy1:$i] : ((XF @ Xy1) = (ccmpt @ (^ [Xy1:$i] : (ccdif @ (ccin @ (ccpw @ XA2) @ ccfn) @ (ccsn @ cc0))) @ (^ [Xy1:$i] : (ccint @ (ccv @ Xy1)))))) => (! [Xy1:$i] : ((cwcel @ XA2 @ XV) => (cwfo @ (ccdif @ (ccin @ (ccpw @ XA2) @ ccfn) @ (ccsn @ cc0)) @ (ccfv @ XA2 @ ccfi) @ (XF @ Xy1))))))))).
