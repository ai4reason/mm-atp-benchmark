...
thf(ctrlcocnvat_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ ((cwcel @ XF @ XT) & (cwcel @ XG @ XT)) @ (cwne @ (ccfv @ XF @ XR) @ (ccfv @ XG @ XR))) => (cwcel @ (ccfv @ (cccom @ XF @ (cccnv @ XG)) @ XR) @ XA2))))))))))))))).
