...
thf(afzosplitpr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ (ccfv @ XA2 @ ccuz)) => ((cco @ XA2 @ (cco @ XB2 @ cc2 @ ccaddc) @ ccfzo) = (ccun @ (cco @ XA2 @ XB2 @ ccfzo) @ (ccpr @ XB2 @ (cco @ XB2 @ cc1 @ ccaddc)))))))).
...
thf(cfzosplitprm1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cco @ XA2 @ (cco @ XB2 @ cc1 @ ccaddc) @ ccfzo) = (ccun @ (cco @ XA2 @ (cco @ XB2 @ cc1 @ ccmin) @ ccfzo) @ (ccpr @ (cco @ XB2 @ cc1 @ ccmin) @ XB2))))))).
