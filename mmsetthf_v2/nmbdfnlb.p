...
thf(anmbdfnlbi_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XT @ cclf) & (cwcel @ (ccfv @ XT @ ccnmf) @ ccr)) => ((cwcel @ XA2 @ cchil) => (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ ccabs) @ (cco @ (ccfv @ XT @ ccnmf) @ (ccfv @ XA2 @ ccno) @ ccmul) @ ccle)))))).
...
thf(a_0lnfn_ax,axiom,(cwcel @ (ccxp @ cchil @ (ccsn @ ccc0)) @ cclf)).
...
thf(anmfn0_ax,axiom,((ccfv @ (ccxp @ cchil @ (ccsn @ ccc0)) @ ccnmf) = ccc0)).
thf(a_0re_ax,axiom,(cwcel @ ccc0 @ ccr)).
thf(cnmbdfnlb_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwcel @ XT @ cclf) @ (cwcel @ (ccfv @ XT @ ccnmf) @ ccr) @ (cwcel @ XA2 @ cchil)) => (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ ccabs) @ (cco @ (ccfv @ XT @ ccnmf) @ (ccfv @ XA2 @ ccno) @ ccmul) @ ccle))))).
