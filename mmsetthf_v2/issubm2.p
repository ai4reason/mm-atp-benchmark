...
thf(aissubmnd_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((XH = (cco @ XG @ XS @ ccress)) => ((cw3a @ (cwcel @ XG @ ccmnd) @ (cwss @ XS @ XB2) @ (cwcel @ Xc_0 @ XS)) => ((cwcel @ XH @ ccmnd) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XS)) @ (^ [Xy1:$i] : XS))) @ (^ [Xx3:$i] : XS))))))))))))))).
thf(adf_3an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) <=> ((Xph & Xps) & Xch)))))).
thf(cissubm2_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_0 = (ccfv @ XM @ cc0g)) => ((XH = (cco @ XM @ XS @ ccress)) => ((cwcel @ XM @ ccmnd) => ((cwcel @ XS @ (ccfv @ XM @ ccsubmnd)) <=> (cw3a @ (cwss @ XS @ XB2) @ (cwcel @ Xc_0 @ XS) @ (cwcel @ XH @ ccmnd))))))))))))).
