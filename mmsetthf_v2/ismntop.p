...
thf(aismntoplly_ax,axiom,(! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XJ @ XV)) => ((cwbr @ XN @ XJ @ ccmntop) <=> (cw3a @ (cwcel @ XJ @ cc2ndc) @ (cwcel @ XJ @ ccha) @ (cwcel @ XJ @ (cclly @ (ccec @ (ccfv @ (ccfv @ XN @ ccehl) @ cctopn) @ cchmph)))))))))).
...
thf(ahmpher_ax,axiom,(cwer @ cctop @ cchmph)).
...
thf(ahmphsymb_ax,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwbr @ XJ @ XK @ cchmph) <=> (cwbr @ XK @ XJ @ cchmph))))).
...
thf(cismntop_conj,conjecture,(! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (((cwcel @ XN @ ccn0) & (cwcel @ XJ @ (XV @ Xx3 @ Xy1 @ Xu))) => ((cwbr @ XN @ XJ @ ccmntop) <=> (cw3a @ (cwcel @ XJ @ cc2ndc) @ (cwcel @ XJ @ ccha) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : ((cwcel @ (ccv @ Xy1) @ (ccv @ Xu)) & (cwbr @ (cco @ XJ @ (ccv @ Xu) @ ccrest) @ (ccfv @ (ccfv @ XN @ ccehl) @ cctopn) @ cchmph))) @ (^ [Xu:$i] : (ccin @ XJ @ (ccpw @ (ccv @ Xx3)))))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XJ)))))))))))).
