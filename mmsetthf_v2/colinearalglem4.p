...
thf(arelin01_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cw3o @ (cwbr @ XA2 @ ccc0 @ ccle) @ ((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ XA2 @ cc1 @ ccle)) @ (cwbr @ cc1 @ XA2 @ ccle))))).
...
thf(amulle0b_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ (cco @ XA2 @ XB2 @ ccmul) @ ccc0 @ ccle) <=> (((cwbr @ XA2 @ ccc0 @ ccle) & (cwbr @ ccc0 @ XB2 @ ccle)) | ((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ XB2 @ ccc0 @ ccle)))))))).
...
thf(ccolinearalglem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XC @ (ccfv @ XN @ ccee))) & (cwcel @ XK @ ccr)) => (cw3o @ (cwral @ (^ [Xi:$i] : (cwbr @ (cco @ (cco @ (cco @ (cco @ XK @ (cco @ (ccfv @ (ccv @ Xi) @ XC) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmin) @ ccmul) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccaddc) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmin) @ (cco @ (ccfv @ (ccv @ Xi) @ XC) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmin) @ ccmul) @ ccc0 @ ccle)) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz))) @ (cwral @ (^ [Xi:$i] : (cwbr @ (cco @ (cco @ (ccfv @ (ccv @ Xi) @ XC) @ (cco @ (cco @ XK @ (cco @ (ccfv @ (ccv @ Xi) @ XC) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmin) @ ccmul) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccaddc) @ ccmin) @ (cco @ (ccfv @ (ccv @ Xi) @ XA2) @ (cco @ (cco @ XK @ (cco @ (ccfv @ (ccv @ Xi) @ XC) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmin) @ ccmul) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccaddc) @ ccmin) @ ccmul) @ ccc0 @ ccle)) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz))) @ (cwral @ (^ [Xi:$i] : (cwbr @ (cco @ (cco @ (ccfv @ (ccv @ Xi) @ XA2) @ (ccfv @ (ccv @ Xi) @ XC) @ ccmin) @ (cco @ (cco @ (cco @ XK @ (cco @ (ccfv @ (ccv @ Xi) @ XC) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmin) @ ccmul) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccaddc) @ (ccfv @ (ccv @ Xi) @ XC) @ ccmin) @ ccmul) @ ccc0 @ ccle)) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz)))))))))).
