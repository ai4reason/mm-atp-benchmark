...
thf(cwinainflem_conj,conjecture,(! [XA2:($i > $o)] : ((cw3a @ (cwne @ XA2 @ cc0) @ (cwcel @ XA2 @ ccon0) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsdm)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))) => (cwss @ ccom @ XA2)))).
