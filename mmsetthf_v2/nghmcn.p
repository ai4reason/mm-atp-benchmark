...
thf(anmods_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XN = (cco @ XS @ XT @ ccnmo)) => ((XV = (ccfv @ XS @ ccbs)) => ((XC = (ccfv @ XS @ ccds)) => ((XD = (ccfv @ XT @ ccds)) => ((cw3a @ (cwcel @ XF @ (cco @ XS @ XT @ ccnghm)) @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV)) => (cwbr @ (cco @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ XD) @ (cco @ (ccfv @ XF @ XN) @ (cco @ XA2 @ XB2 @ XC) @ ccmul) @ ccle)))))))))))))))).
...
thf(cnghmcn_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (ccfv @ XS @ cctopn)) => ((XK = (ccfv @ XT @ cctopn)) => ((cwcel @ XF @ (cco @ XS @ XT @ ccnghm)) => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))))))))))).
