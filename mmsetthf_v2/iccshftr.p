...
thf(ciccshftr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cco @ XA2 @ XR @ ccaddc) = XC) => (((cco @ XB2 @ XR @ ccaddc) = XD) => ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwcel @ XX @ ccr) & (cwcel @ XR @ ccr))) => ((cwcel @ XX @ (cco @ XA2 @ XB2 @ ccicc)) <=> (cwcel @ (cco @ XX @ XR @ ccaddc) @ (cco @ XC @ XD @ ccicc))))))))))))).
