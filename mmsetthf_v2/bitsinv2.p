...
thf(aackbijnn_ax,axiom,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccn0) @ ccfn)) @ (^ [Xx3:$i] : (ccsu @ (ccv @ Xx3) @ (^ [Xy1:$i] : (cco @ cc2 @ (ccv @ Xy1) @ ccexp)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwf1o @ (ccin @ (ccpw @ ccn0) @ ccfn) @ ccn0 @ (XF @ Xx3 @ Xy1))))))).
