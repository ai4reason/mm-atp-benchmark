...
thf(aharmonicbnd4_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwbr @ (ccfv @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xm:$i] : (cco @ cc1 @ (ccv @ Xm) @ ccdiv))) @ (cco @ (ccfv @ XA2 @ cclog) @ ccem @ ccaddc) @ ccmin) @ ccabs) @ (cco @ cc1 @ XA2 @ ccdiv) @ ccle)))).
