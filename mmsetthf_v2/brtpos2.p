...
thf(cbrtpos2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((cwbr @ XA2 @ XB2 @ (cctpos @ XF)) <=> ((cwcel @ XA2 @ (ccun @ (cccnv @ (ccdm @ XF)) @ (ccsn @ cc0))) & (cwbr @ (ccuni @ (cccnv @ (ccsn @ XA2))) @ XB2 @ XF))))))))).
