...
thf(achabs2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((ccin @ XA2 @ (cco @ XA2 @ XB2 @ cchj)) = XA2))))).
thf(cdmdbr5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((cwbr @ XA2 @ XB2 @ ccdmd) <=> (cwral @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ cchj)) => (cwss @ (ccv @ Xx3) @ (cco @ (ccin @ (cco @ (ccv @ Xx3) @ XB2 @ cchj) @ XA2) @ XB2 @ cchj)))) @ (^ [Xx3:$i] : ccch))))))).
