...
thf(amarypha1lem_ax,axiom,(! [XA2:($i > $o)] : (! [Xb:$i] : ((cwcel @ XA2 @ ccfn) => ((cwcel @ (ccv @ Xb) @ ccfn) => (cwral @ (^ [Xc:$i] : ((cwral @ (^ [Xd:$i] : (cwbr @ (ccv @ Xd) @ (ccima @ (ccv @ Xc) @ (ccv @ Xd)) @ ccdom)) @ (^ [Xd:$i] : (ccpw @ XA2))) => (cwrex @ (^ [Xe:$i] : (cwf1 @ XA2 @ ccvv @ (ccv @ Xe))) @ (^ [Xe:$i] : (ccpw @ (ccv @ Xc)))))) @ (^ [Xc:$i] : (ccpw @ (ccxp @ XA2 @ (ccv @ Xb)))))))))).
