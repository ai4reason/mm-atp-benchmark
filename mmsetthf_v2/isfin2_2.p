...
thf(apssdifcom1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwss @ XA2 @ XC) & (cwss @ XB2 @ XC)) => ((cwpss @ (ccdif @ XC @ XA2) @ XB2) <=> (cwpss @ (ccdif @ XC @ XB2) @ XA2))))))).
...
thf(cisfin2_2_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : ((cwcel @ XA2 @ (XV @ Xy1)) => ((cwcel @ XA2 @ ccfin2) <=> (cwral @ (^ [Xy1:$i] : (((cwne @ (ccv @ Xy1) @ cc0) & (cwor @ (ccv @ Xy1) @ ccrpss)) => (cwcel @ (ccint @ (ccv @ Xy1)) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccpw @ (ccpw @ XA2)))))))))).
