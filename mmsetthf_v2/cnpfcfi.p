...
thf(afclsfil_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) => (cwcel @ XF @ (ccfv @ XX @ ccfil))))))))).
...
thf(afclsfnflim_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccfil)) => ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) <=> (cwrex @ (^ [Xg1:$i] : ((cwss @ XF @ (ccv @ Xg1)) & (cwcel @ XA2 @ (cco @ XJ @ (ccv @ Xg1) @ ccflim)))) @ (^ [Xg1:$i] : (ccfv @ XX @ ccfil)))))))))).
...
thf(aflfssfcf_ax,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) => (cwss @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf)) @ (ccfv @ XF @ (cco @ XJ @ XL @ ccfcf)))))))))).
...
thf(afmss_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cw3a @ (cwcel @ XX @ XA2) @ (cwcel @ XB2 @ (ccfv @ XY @ ccfbas)) @ (cwcel @ XC @ (ccfv @ XY @ ccfbas))) & ((cwf @ XY @ XX @ XF) & (cwss @ XB2 @ XC))) => (cwss @ (ccfv @ XB2 @ (cco @ XX @ XF @ ccfm)) @ (ccfv @ XC @ (cco @ XX @ XF @ ccfm))))))))))).
thf(afclsss2_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwss @ XF @ XG)) => (cwss @ (cco @ XJ @ XG @ ccfcls) @ (cco @ XJ @ XF @ ccfcls)))))))).
thf(ccmpt2_tp,type,(ccmpt2 : (($i > ($i > ($i > $o))) > (($i > ($i > ($i > $o))) > (($i > ($i > ($i > $o))) > ($i > $o)))))).
thf(ccmap_tp,type,(ccmap : ($i > $o))).
thf(afcfval_ax,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) => ((ccfv @ XF @ (cco @ XJ @ XL @ ccfcf)) = (cco @ XJ @ (ccfv @ XL @ (cco @ XX @ XF @ ccfm)) @ ccfcls))))))))).
...
thf(ccnpfcfi_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((cw3a @ (cwcel @ XK @ cctop) @ (cwcel @ XA2 @ (cco @ XJ @ XL @ ccfcls)) @ (cwcel @ XF @ (ccfv @ XA2 @ (cco @ XJ @ XK @ cccnp)))) => (cwcel @ (ccfv @ XA2 @ XF) @ (ccfv @ XF @ (cco @ XK @ XL @ ccfcf)))))))))).
