...
thf(abtwnconn1lem2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (((cw3a @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ (cw3a @ (cwcel @ XC @ (ccfv @ XN @ ccee)) @ (cwcel @ XD @ (ccfv @ XN @ ccee)) @ (cwcel @ (ccv @ Xc) @ (ccfv @ XN @ ccee))) @ (cw3a @ (cwcel @ (ccv @ Xd) @ (ccfv @ XN @ ccee)) @ (cwcel @ (ccv @ Xb) @ (ccfv @ XN @ ccee)) @ (cwcel @ XX @ (ccfv @ XN @ ccee)))) & (cw3a @ (((cwne @ XA2 @ XB2) & (cwne @ XB2 @ XC)) & ((cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn) & (cwbr @ XB2 @ (ccop @ XA2 @ XD) @ ccbtwn))) @ (((cwbr @ XD @ (ccop @ XA2 @ (ccv @ Xc)) @ ccbtwn) & (cwbr @ (ccop @ XD @ (ccv @ Xc)) @ (ccop @ XC @ XD) @ cccgr)) & ((cwbr @ XC @ (ccop @ XA2 @ (ccv @ Xd)) @ ccbtwn) & (cwbr @ (ccop @ XC @ (ccv @ Xd)) @ (ccop @ XC @ XD) @ cccgr))) @ (((cwbr @ (ccv @ Xc) @ (ccop @ XA2 @ (ccv @ Xb)) @ ccbtwn) & (cwbr @ (ccop @ (ccv @ Xc) @ (ccv @ Xb)) @ (ccop @ XC @ XB2) @ cccgr)) & ((cwbr @ (ccv @ Xd) @ (ccop @ XA2 @ XX) @ ccbtwn) & (cwbr @ (ccop @ (ccv @ Xd) @ XX) @ (ccop @ XD @ XB2) @ cccgr))))) => (XX = (ccv @ Xb))))))))))))).
...
thf(cbtwnconn1lem14_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : (((cw3a @ (cwcel @ XN @ ccn) @ ((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ ((cwcel @ XC @ (ccfv @ XN @ ccee)) & (cwcel @ XD @ (ccfv @ XN @ ccee)))) & (((cwne @ XA2 @ XB2) & (cwne @ XB2 @ XC)) & ((cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn) & (cwbr @ XB2 @ (ccop @ XA2 @ XD) @ ccbtwn)))) => ((cwbr @ XC @ (ccop @ XA2 @ XD) @ ccbtwn) | (cwbr @ XD @ (ccop @ XA2 @ XC) @ ccbtwn))))))))).
