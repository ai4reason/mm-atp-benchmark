...
thf(apfxswrd_ax,axiom,(! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz)) @ (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz))) => ((cwcel @ XL @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfz)) => ((cco @ (cco @ XW @ (ccop @ XM @ XN) @ ccsubstr) @ XL @ ccpfx) = (cco @ XW @ (ccop @ XM @ (cco @ XM @ XL @ ccaddc)) @ ccsubstr)))))))))).
...
thf(cpfxpfx_conj,conjecture,(! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz)) @ (cwcel @ XL @ (cco @ ccc0 @ XN @ ccfz))) => ((cco @ (cco @ XW @ XN @ ccpfx) @ XL @ ccpfx) = (cco @ XW @ XL @ ccpfx)))))))).
