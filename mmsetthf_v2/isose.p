...
thf(aisoselem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : ((Xph => (cwiso @ XA2 @ XB2 @ XR @ XS @ XH)) => ((! [Xx3:$i] : (Xph => (cwcel @ (ccima @ XH @ (ccv @ Xx3)) @ ccvv))) => (Xph => ((cwse @ XA2 @ XR) => (cwse @ XB2 @ XS)))))))))))).
