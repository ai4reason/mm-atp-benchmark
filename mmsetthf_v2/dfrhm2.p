...
thf(aisghm3_ax,axiom,(! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XS @ ccbs)) => ((XY = (ccfv @ XT @ ccbs)) => ((Xc_pl = (ccfv @ XS @ ccplusg)) => ((Xc_pd = (ccfv @ XT @ ccplusg)) => (((cwcel @ XS @ ccgrp) & (cwcel @ XT @ ccgrp)) => ((cwcel @ XF @ (cco @ XS @ XT @ ccghm)) <=> ((cwf @ XX @ XY @ XF) & (cwral @ (^ [Xu:$i] : (cwral @ (^ [Xv:$i] : ((ccfv @ (cco @ (ccv @ Xu) @ (ccv @ Xv) @ Xc_pl) @ XF) = (cco @ (ccfv @ (ccv @ Xu) @ XF) @ (ccfv @ (ccv @ Xv) @ XF) @ Xc_pd))) @ (^ [Xv:$i] : XX))) @ (^ [Xu:$i] : XX))))))))))))))))).
...
thf(cdfrhm2_conj,conjecture,(ccrh = (ccmpt2 @ (^ [Xr:$i] : (^ [Xs1:$i] : ccrg)) @ (^ [Xr:$i] : (^ [Xs1:$i] : ccrg)) @ (^ [Xr:$i] : (^ [Xs1:$i] : (ccin @ (cco @ (ccv @ Xr) @ (ccv @ Xs1) @ ccghm) @ (cco @ (ccfv @ (ccv @ Xr) @ ccmgp) @ (ccfv @ (ccv @ Xs1) @ ccmgp) @ ccmhm))))))).
