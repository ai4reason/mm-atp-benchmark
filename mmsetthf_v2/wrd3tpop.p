...
thf(afntpb_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwfn @ XF @ (cctp @ XA2 @ XB2 @ XC)) <=> (XF = (cctp @ (ccop @ XA2 @ (ccfv @ XA2 @ XF)) @ (ccop @ XB2 @ (ccfv @ XB2 @ XF)) @ (ccop @ XC @ (ccfv @ XC @ XF))))))))))))).
