...
thf(aefgi_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccfv @ (ccword @ (ccxp @ XI @ cc2o)) @ ccid)) => ((Xc_sm = (ccfv @ XI @ ccefg)) => ((((cwcel @ XA2 @ XW) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XA2 @ cchash) @ ccfz))) & ((cwcel @ XJ @ XI) & (cwcel @ XK @ cc2o))) => (cwbr @ XA2 @ (cco @ XA2 @ (ccotp @ XN @ XN @ (ccs2 @ (ccop @ XJ @ XK) @ (ccop @ XJ @ (ccdif @ cc1o @ XK)))) @ ccsplice) @ Xc_sm)))))))))))).
...
thf(cefgi0_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccfv @ (ccword @ (ccxp @ XI @ cc2o)) @ ccid)) => ((Xc_sm = (ccfv @ XI @ ccefg)) => ((cw3a @ (cwcel @ XA2 @ XW) @ (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XA2 @ cchash) @ ccfz)) @ (cwcel @ XJ @ XI)) => (cwbr @ XA2 @ (cco @ XA2 @ (ccotp @ XN @ XN @ (ccs2 @ (ccop @ XJ @ cc0) @ (ccop @ XJ @ cc1o))) @ ccsplice) @ Xc_sm))))))))))).
