...
thf(acramerlem2_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_dv:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xz:$i] : (! [Xi:$i] : ((XA2 @ Xz @ Xi) = (cco @ XN @ XR @ ccmat)))) => ((! [Xz:$i] : (! [Xi:$i] : (XB2 = (ccfv @ (XA2 @ Xz @ Xi) @ ccbs)))) => ((XV = (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => ((XD = (cco @ XN @ XR @ ccmdat)) => ((! [Xz:$i] : ((Xc_x @ Xz) = (cco @ XR @ (ccop @ XN @ XN) @ ccmvmul))) => ((! [Xz:$i] : ((Xc_dv @ Xz) = (ccfv @ XR @ ccdvr))) => ((cw3a @ (cwcel @ XR @ cccrg) @ ((cwcel @ XX @ XB2) & (cwcel @ XY @ XV)) @ (cwcel @ (ccfv @ XX @ XD) @ (ccfv @ XR @ ccui))) => (cwral @ (^ [Xz:$i] : (((cco @ XX @ (ccv @ Xz) @ (Xc_x @ Xz)) = XY) => ((ccv @ Xz) = (ccmpt @ (^ [Xi:$i] : XN) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xi) @ (cco @ XX @ XY @ (cco @ XN @ XR @ ccmatrepV))) @ XD) @ (ccfv @ XX @ XD) @ (Xc_dv @ Xz))))))) @ (^ [Xz:$i] : XV)))))))))))))))))))).
...
thf(arexraleqim_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xth:($i > $o)] : (! [XA2:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccv @ Xz)) => ((Xps @ Xx3) <=> (Xph @ Xz))))) => ((! [Xx3:$i] : (! [Xz:$i] : (((ccv @ Xz) = XY) => ((Xph @ Xz) <=> (Xth @ Xx3))))) => (! [Xx3:$i] : (((cwrex @ (^ [Xz:$i] : (Xph @ Xz)) @ (^ [Xz:$i] : XA2)) & (cwral @ (^ [Xx3:$i] : ((Xps @ Xx3) => ((ccv @ Xx3) = XY))) @ (^ [Xx3:$i] : XA2))) => (Xth @ Xx3))))))))))).
