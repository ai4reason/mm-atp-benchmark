...
thf(aan3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) & (Xch & Xth)) => (Xph & Xth))))))).
thf(aim2anan9r_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xph => (Xps => Xch)) => ((Xth => (Xta => Xet)) => ((Xth & Xph) => ((Xps & Xta) => (Xch & Xet)))))))))))).
