...
thf(csinmul_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ (ccfv @ XA2 @ ccsin) @ (ccfv @ XB2 @ ccsin) @ ccmul) = (cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ cccos) @ (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cccos) @ ccmin) @ cc2 @ ccdiv)))))).
