...
thf(achsupval2_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccch) => ((ccfv @ XA2 @ cchsup) = (ccint @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccuni @ XA2) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : ccch))))))).
...
thf(cchsupid_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((ccfv @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XA2)) @ (^ [Xx3:$i] : ccch)) @ cchsup) = XA2)))).
