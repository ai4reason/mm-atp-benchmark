...
thf(cbloval_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XN = (cco @ XU @ XW @ ccnmoo)) => ((XL = (cco @ XU @ XW @ cclno)) => ((! [Xt:$i] : ((XB2 @ Xt) = (cco @ XU @ XW @ ccblo))) => (! [Xt:$i] : (((cwcel @ XU @ ccnv) & (cwcel @ XW @ ccnv)) => ((XB2 @ Xt) = (ccrab @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccv @ Xt) @ XN) @ ccpnf @ cclt)) @ (^ [Xt:$i] : XL)))))))))))))).
