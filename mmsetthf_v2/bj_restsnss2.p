...
thf(abj_restsn_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XY @ XV) & (cwcel @ XA2 @ XW)) => ((cco @ (ccsn @ XY) @ XA2 @ ccrest) = (ccsn @ (ccin @ XY @ XA2))))))))).
thf(abiimpa_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps <=> Xch)) => ((Xph & Xps) => Xch)))))).
thf(aeqeq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((XC = XA2) <=> (XC = XB2))))))).
thf(cbj_restsnss2_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwss @ XY @ XA2)) => ((cco @ (ccsn @ XY) @ XA2 @ ccrest) = (ccsn @ XY))))))).
