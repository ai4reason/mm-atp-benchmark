...
thf(apmtr3ncom_ax,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((XT = (ccfv @ XD @ ccpmtr)) => (! [Xf1:$i] : (! [Xg1:$i] : (((cwcel @ XD @ (XV @ Xf1 @ Xg1)) & (cwbr @ cc3 @ (ccfv @ XD @ cchash) @ ccle)) => (cwrex @ (^ [Xf1:$i] : (cwrex @ (^ [Xg1:$i] : (cwne @ (cccom @ (ccv @ Xg1) @ (ccv @ Xf1)) @ (cccom @ (ccv @ Xf1) @ (ccv @ Xg1)))) @ (^ [Xg1:$i] : (ccrn @ XT)))) @ (^ [Xf1:$i] : (ccrn @ XT))))))))))).
