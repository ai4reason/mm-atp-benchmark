...
thf(adf_vrmd_ax,axiom,(ccvrmd = (ccmpt @ (^ [Xi:$i] : ccvv) @ (^ [Xi:$i] : (ccmpt @ (^ [Xj:$i] : (ccv @ Xi)) @ (^ [Xj:$i] : (ccs1 @ (ccv @ Xj)))))))).
thf(cvrmdfval_conj,conjecture,(! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((! [Xj:$i] : ((XU @ Xj) = (ccfv @ XI @ ccvrmd))) => (! [Xj:$i] : ((cwcel @ XI @ XV) => ((XU @ Xj) = (ccmpt @ (^ [Xj:$i] : XI) @ (^ [Xj:$i] : (ccs1 @ (ccv @ Xj)))))))))))).
