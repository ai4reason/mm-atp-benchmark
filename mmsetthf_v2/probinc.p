...
thf(cprobinc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (((cw3a @ (cwcel @ XP @ ccprb) @ (cwcel @ XA2 @ (ccdm @ XP)) @ (cwcel @ XB2 @ (ccdm @ XP))) & (cwss @ XA2 @ XB2)) => (cwbr @ (ccfv @ XA2 @ XP) @ (ccfv @ XB2 @ XP) @ ccle)))))).
