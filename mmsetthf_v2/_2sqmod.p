...
thf(a_2sqcoprm_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((Xph => (cwcel @ XP @ ccprime)) => ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XB2 @ ccz)) => ((Xph => ((cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) = XP)) => (Xph => ((cco @ XA2 @ XB2 @ ccgcd) = cc1))))))))))).
...
thf(asubeqxfrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XD @ ccc)) => ((Xph => ((cco @ XA2 @ XB2 @ ccmin) = (cco @ XC @ XD @ ccmin))) => (Xph => ((cco @ XA2 @ XC @ ccmin) = (cco @ XB2 @ XD @ ccmin)))))))))))))).
...
thf(aznsqcld_ax,axiom,(! [Xph:$o] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccz)) => ((Xph => (cwne @ XN @ ccc0)) => (Xph => (cwcel @ (cco @ XN @ cc2 @ ccexp) @ ccn))))))).
