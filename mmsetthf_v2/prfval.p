...
thf(adf_prf_ax,axiom,(ccprf = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : ccvv)) @ (^ [Xf1:$i] : (^ [Xg1:$i] : ccvv)) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccsb @ (ccdm @ (ccfv @ (ccv @ Xf1) @ cc1st)) @ (^ [Xb:$i] : (ccop @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xb)) @ (^ [Xx3:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xf1) @ cc1st)) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xg1) @ cc1st))))) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xb))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xb))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccmpt @ (^ [Xh:$i] : (ccdm @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xf1) @ cc2nd)))) @ (^ [Xh:$i] : (ccop @ (ccfv @ (ccv @ Xh) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xf1) @ cc2nd))) @ (ccfv @ (ccv @ Xh) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xg1) @ cc2nd))))))))))))))))).
thf(acsbied2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (Xph => (XA2 = (XB2 @ Xx3)))) => ((! [Xx3:$i] : ((Xph & ((ccv @ Xx3) = (XB2 @ Xx3))) => ((XC @ Xx3) = XD))) => (Xph => ((ccsb @ XA2 @ (^ [Xx3:$i] : (XC @ Xx3))) = XD)))))))))))).
...
thf(cprfval_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xh:$i] : ((XP @ Xx3 @ Xy1 @ Xh) = (cco @ XF @ XG @ ccprf))))) => ((! [Xh:$i] : (XB2 = (ccfv @ (XC @ Xh) @ ccbs))) => ((! [Xh:$i] : (XH = (ccfv @ (XC @ Xh) @ cchom))) => ((! [Xh:$i] : (Xph => (cwcel @ XF @ (cco @ (XC @ Xh) @ (XD @ Xh) @ ccfunc)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xh:$i] : (Xph => (cwcel @ XG @ (cco @ (XC @ Xh) @ (XE @ Xx3 @ Xy1 @ Xh) @ ccfunc)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xh:$i] : (Xph => ((XP @ Xx3 @ Xy1 @ Xh) = (ccop @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XF @ cc1st)) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XG @ cc1st))))) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccmpt @ (^ [Xh:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XH)) @ (^ [Xh:$i] : (ccop @ (ccfv @ (ccv @ Xh) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XF @ cc2nd))) @ (ccfv @ (ccv @ Xh) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XG @ cc2nd)))))))))))))))))))))))))))))).
