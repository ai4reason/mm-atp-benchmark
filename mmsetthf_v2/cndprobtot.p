...
thf(ccndprobtot_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprb) @ (cwcel @ XA2 @ (ccdm @ XP)) @ (cwne @ (ccfv @ XA2 @ XP) @ ccc0)) => ((ccfv @ (ccop @ (ccuni @ (ccdm @ XP)) @ XA2) @ (ccfv @ XP @ cccprob)) = cc1))))).
