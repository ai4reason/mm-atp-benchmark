...
thf(amap0b_ax,axiom,(! [XA2:($i > $o)] : ((cwne @ XA2 @ cc0) => ((cco @ cc0 @ XA2 @ ccmap) = cc0)))).
thf(a_0dom_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwbr @ cc0 @ XA2 @ ccdom)))).
...
thf(amap0g_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => (((cco @ XA2 @ XB2 @ ccmap) = cc0) <=> ((XA2 = cc0) & (cwne @ XB2 @ cc0))))))))).
thf(asimpl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xph)))).
thf(axpdom3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwne @ XB2 @ cc0)) => (cwbr @ XA2 @ (ccxp @ XA2 @ XB2) @ ccdom))))))).
...
thf(areldmmap_ax,axiom,(cwrel @ (ccdm @ ccmap))).
thf(cmapdom2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccdom) & (~ ((XA2 = cc0) & (XC = cc0)))) => (cwbr @ (cco @ XC @ XA2 @ ccmap) @ (cco @ XC @ XB2 @ ccmap) @ ccdom)))))).
