...
thf(aackbij1b_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((XF = (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => ((cwcel @ XA2 @ ccom) => ((ccima @ XF @ (ccpw @ XA2)) = (ccfv @ (ccpw @ XA2) @ cccrd))))))).
...
thf(af1opw_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf1o @ XA2 @ XB2 @ XF) => (cwf1o @ (ccpw @ XA2) @ (ccpw @ XB2) @ (ccmpt @ (^ [Xb:$i] : (ccpw @ XA2)) @ (^ [Xb:$i] : (ccima @ XF @ (ccv @ Xb)))))))))).
