...
thf(ceqgval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XG @ ccminusg)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((XR = (cco @ XG @ XS @ ccqg)) => (((cwcel @ XG @ XV) & (cwss @ XS @ XX)) => ((cwbr @ XA2 @ XB2 @ XR) <=> (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ (cco @ (ccfv @ XA2 @ XN) @ XB2 @ Xc_pl) @ XS)))))))))))))))))).
