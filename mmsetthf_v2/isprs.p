...
thf(adf_preset_ax,axiom,(ccpreset = (ccab @ (^ [Xf1:$i] : (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xr:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xx3) @ (ccv @ Xr)) & (((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xr)) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xr))) => (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ (ccv @ Xr))))) @ (^ [Xz:$i] : (ccv @ Xb)))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xb)))) @ (ccfv @ (ccv @ Xf1) @ ccple))) @ (ccfv @ (ccv @ Xf1) @ ccbs)))))).
thf(cisprs_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((cwcel @ XK @ ccpreset) <=> ((cwcel @ XK @ ccvv) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xx3) @ Xc_le) & (((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_le) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_le)) => (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_le)))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)))))))))).
