...
thf(aqqhval_ax,axiom,(! [Xc_dv:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_1:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_dv @ Xx3 @ Xy1) = (ccfv @ XR @ ccdvr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_1 @ Xx3 @ Xy1) = (ccfv @ XR @ ccur)))) => ((! [Xx3:$i] : ((XL @ Xx3) = (ccfv @ XR @ cczrh))) => ((cwcel @ XR @ ccvv) => ((ccfv @ XR @ ccqqh) = (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccima @ (cccnv @ (XL @ Xx3)) @ (ccfv @ XR @ ccui)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccdiv) @ (cco @ (ccfv @ (ccv @ Xx3) @ (XL @ Xx3)) @ (ccfv @ (ccv @ Xy1) @ (XL @ Xx3)) @ (Xc_dv @ Xx3 @ Xy1))))))))))))))))).
...
thf(azrhunitpreima_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XL = (ccfv @ XR @ cczrh)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccdr) & ((ccfv @ XR @ ccchr) = ccc0)) => ((ccima @ (cccnv @ XL) @ (ccfv @ XR @ ccui)) = (ccdif @ ccz @ (ccsn @ ccc0)))))))))))).
...
thf(aqdivcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccq) @ (cwcel @ XB2 @ ccq) @ (cwne @ XB2 @ ccc0)) => (cwcel @ (cco @ XA2 @ XB2 @ ccdiv) @ ccq))))).
...
thf(aqqhval2lem_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((XL = (ccfv @ XR @ cczrh)) => ((((cwcel @ XR @ ccdr) & ((ccfv @ XR @ ccchr) = ccc0)) & (cw3a @ (cwcel @ XX @ ccz) @ (cwcel @ XY @ ccz) @ (cwne @ XY @ ccc0))) => ((cco @ (ccfv @ (ccfv @ (cco @ XX @ XY @ ccdiv) @ ccnumer) @ XL) @ (ccfv @ (ccfv @ (cco @ XX @ XY @ ccdiv) @ ccdenom) @ XL) @ Xc_dv) = (cco @ (ccfv @ XX @ XL) @ (ccfv @ XY @ XL) @ Xc_dv))))))))))))).
thf(aspc2ev_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : ((((ccv @ Xx3) = XA2) & ((ccv @ Xy1) = XB2)) => ((Xph @ Xx3 @ Xy1) <=> Xps)))) => (Xps => (? [Xx3:$i] : (? [Xy1:$i] : (Xph @ Xx3 @ Xy1)))))))))))).
...
thf(aqeqnumdivden_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccq) => (XA2 = (cco @ (ccfv @ XA2 @ ccnumer) @ (ccfv @ XA2 @ ccdenom) @ ccdiv))))).
...
thf(cqqhval2_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((XL = (ccfv @ XR @ cczrh)) => (((cwcel @ XR @ ccdr) & ((ccfv @ XR @ ccchr) = ccc0)) => ((ccfv @ XR @ ccqqh) = (ccmpt @ (^ [Xq:$i] : ccq) @ (^ [Xq:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xq) @ ccnumer) @ XL) @ (ccfv @ (ccfv @ (ccv @ Xq) @ ccdenom) @ XL) @ Xc_dv))))))))))))).
