...
thf(aitg2gt0_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ (ccdm @ ccvol))) => ((Xph => (cwbr @ ccc0 @ (ccfv @ XA2 @ ccvol) @ cclt)) => ((Xph => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((Xph => (cwcel @ XF @ ccmbf)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ XF) @ cclt))) => (Xph => (cwbr @ ccc0 @ (ccfv @ XF @ ccitg2) @ cclt))))))))))).
