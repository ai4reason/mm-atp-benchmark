...
thf(apwpwssunieq_ax,axiom,(! [XA2:($i > $o)] : (cwss @ (ccab @ (^ [Xx3:$i] : ((ccuni @ (ccv @ Xx3)) = XA2))) @ (ccpw @ (ccpw @ XA2))))).
...
thf(ctoponsspwpw_conj,conjecture,(! [XA2:($i > $o)] : (cwss @ (ccfv @ XA2 @ cctopon) @ (ccpw @ (ccpw @ XA2))))).
