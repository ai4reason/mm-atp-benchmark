...
thf(abr1steqg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwbr @ (ccop @ XA2 @ XB2) @ XC @ cc1st) <=> (XC = XA2))))))))).
...
thf(cfv1stcnv_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XX @ XA2) & (cwcel @ XY @ XV)) => ((ccfv @ XX @ (cccnv @ (ccres @ cc1st @ (ccxp @ XA2 @ (ccsn @ XY))))) = (ccop @ XX @ XY)))))))).
