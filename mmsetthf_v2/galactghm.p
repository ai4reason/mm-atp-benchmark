...
thf(agagrp_ax,axiom,(! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ Xc_po @ (cco @ XG @ XY @ ccga)) => (cwcel @ XG @ ccgrp)))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(agaset_ax,axiom,(! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ Xc_po @ (cco @ XG @ XY @ ccga)) => (cwcel @ XY @ ccvv)))))).
...
thf(agapm_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XY) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ Xc_po))))) => (! [Xx3:$i] : (((cwcel @ Xc_po @ (cco @ XG @ XY @ ccga)) & (cwcel @ XA2 @ XX)) => (cwf1o @ XY @ XY @ (XF @ Xx3))))))))))))).
thf(aadantr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph & Xch) => Xps)))))).
thf(aelsymgbas_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((cwcel @ XA2 @ XV) => ((cwcel @ XF @ XB2) <=> (cwf1o @ XA2 @ XA2 @ XF))))))))))).
...
thf(agaass_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (((cwcel @ Xc_po @ (cco @ XG @ XY @ ccga)) & (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XY))) => ((cco @ (cco @ XA2 @ XB2 @ Xc_pl) @ XC @ Xc_po) = (cco @ XA2 @ (cco @ XB2 @ XC @ Xc_po) @ Xc_po)))))))))))))).
...
thf(agaf_ax,axiom,(! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((cwcel @ Xc_po @ (cco @ XG @ XY @ ccga)) => (cwf @ (ccxp @ XX @ XY) @ XY @ Xc_po)))))))).
...
thf(cgalactghm_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((! [Xy1:$i] : ((XH @ Xy1) = (ccfv @ XY @ ccsymg))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_po)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ Xc_po @ (cco @ XG @ XY @ ccga)) => (cwcel @ (XF @ Xx3 @ Xy1) @ (cco @ XG @ (XH @ Xy1) @ ccghm))))))))))))))).
