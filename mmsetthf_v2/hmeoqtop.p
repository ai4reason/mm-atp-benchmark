...
thf(aqtopomap_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((Xph => ((ccrn @ XF) = XY)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XJ)) => (cwcel @ (ccima @ XF @ (ccv @ Xx3)) @ XK))) => (Xph => (XK = (cco @ XJ @ XF @ ccqtop))))))))))))).
...
thf(chmeoqtop_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwcel @ XF @ (cco @ XJ @ XK @ cchmeo)) => (XK = (cco @ XJ @ XF @ ccqtop))))))).
