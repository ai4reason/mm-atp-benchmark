...
thf(aelcntzsn_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_pl = (ccfv @ XM @ ccplusg)) => ((XZ = (ccfv @ XM @ cccntz)) => ((cwcel @ XY @ XB2) => ((cwcel @ XX @ (ccfv @ (ccsn @ XY) @ XZ)) <=> ((cwcel @ XX @ XB2) & ((cco @ XX @ XY @ Xc_pl) = (cco @ XY @ XX @ Xc_pl))))))))))))))).
...
thf(cgsumconst_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((! [Xk:$i] : ((Xc_x @ Xk) = (ccfv @ XG @ ccmg))) => (! [Xk:$i] : ((cw3a @ (cwcel @ XG @ ccmnd) @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XX @ XB2)) => ((cco @ XG @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : XX)) @ ccgsu) = (cco @ (ccfv @ XA2 @ cchash) @ XX @ (Xc_x @ Xk))))))))))))).
