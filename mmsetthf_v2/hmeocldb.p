...
thf(chmeocldb_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (((cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XK @ cctop) @ (cwcel @ XF @ (cco @ XJ @ XK @ cchmeo))) & (cwcel @ XS @ (ccfv @ XK @ cccld))) => (cwcel @ (ccima @ (cccnv @ XF) @ XS) @ (ccfv @ XJ @ cccld)))))))).
