...
thf(apjds3i_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XF @ ccch) => ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => ((((cwcel @ XA2 @ (cco @ (cco @ XF @ XG @ cchj) @ XH @ cchj)) & (cwss @ XF @ (ccfv @ XG @ ccort))) & ((cwss @ XF @ (ccfv @ XH @ ccort)) & (cwss @ XG @ (ccfv @ XH @ ccort)))) => (XA2 = (cco @ (cco @ (ccfv @ XA2 @ (ccfv @ XF @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ XG @ ccpjh)) @ ccva) @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccva))))))))))).
...
thf(ashlessi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => ((cwcel @ XC @ ccsh) => ((cwss @ XA2 @ XB2) => (cwss @ (cco @ XA2 @ XC @ ccph) @ (cco @ XB2 @ XC @ ccph)))))))))).
