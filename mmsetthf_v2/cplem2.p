...
thf(acplem1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XC @ Xx3 @ Xy1 @ Xz) = (ccrab @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwss @ (ccfv @ (ccv @ Xy1) @ ccrnk) @ (ccfv @ (ccv @ Xz) @ ccrnk))) @ (^ [Xz:$i] : (XB2 @ Xx3)))) @ (^ [Xy1:$i] : (XB2 @ Xx3))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XD @ Xx3 @ Xy1 @ Xz) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xy1 @ Xz))))))) => (! [Xy1:$i] : (! [Xz:$i] : (cwral @ (^ [Xx3:$i] : ((cwne @ (XB2 @ Xx3) @ cc0) => (cwne @ (ccin @ (XB2 @ Xx3) @ (XD @ Xx3 @ Xy1 @ Xz)) @ cc0))) @ (^ [Xx3:$i] : XA2))))))))))).
...
thf(ccplem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (? [Xy1:$i] : (cwral @ (^ [Xx3:$i] : ((cwne @ (XB2 @ Xx3) @ cc0) => (cwne @ (ccin @ (XB2 @ Xx3) @ (ccv @ Xy1)) @ cc0))) @ (^ [Xx3:$i] : XA2))))))).
