...
thf(climinfvaluz3_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XM @ ccz))) => ((XZ = (ccfv @ XM @ ccuz)) => ((! [Xk:$i] : ((Xph @ Xk) => (cwf @ XZ @ ccxr @ (XF @ Xk)))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccfv @ (XF @ Xk) @ cclsi) = (ccxne @ (ccfv @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccxne @ (ccfv @ (ccv @ Xk) @ (XF @ Xk))))) @ cclsp))))))))))))))).
