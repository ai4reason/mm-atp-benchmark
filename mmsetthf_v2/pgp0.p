...
thf(apgpfi1_ax,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XP @ ccprime) @ (cwcel @ XN @ ccn0)) => (((ccfv @ XX @ cchash) = (cco @ XP @ XN @ ccexp)) => (cwbr @ XP @ XG @ ccpgp))))))))).
thf(cpgp0_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XP @ ccprime)) => (cwbr @ XP @ (cco @ XG @ (ccsn @ Xc_0) @ ccress) @ ccpgp))))))).
