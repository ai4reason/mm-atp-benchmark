...
thf(anna0r_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccom) => ((cco @ cc0 @ XA2 @ ccoa) = XA2)))).
...
thf(cnnacom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => ((cco @ XA2 @ XB2 @ ccoa) = (cco @ XB2 @ XA2 @ ccoa)))))).
