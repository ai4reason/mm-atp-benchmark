...
thf(culmclm_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwf @ XZ @ (cco @ ccc @ XS @ ccmap) @ XF)) => ((Xph => (cwcel @ XA2 @ XS)) => ((! [Xk:$i] : (Xph => (cwcel @ XH @ (XW @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ XA2 @ (ccfv @ (ccv @ Xk) @ XF)) = (ccfv @ (ccv @ Xk) @ XH)))) => ((Xph => (cwbr @ XF @ XG @ (ccfv @ XS @ cculm))) => (Xph => (cwbr @ XH @ (ccfv @ XA2 @ XG) @ ccli))))))))))))))))))).
