...
thf(cfmcncfil_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((XK = (ccfv @ XE @ ccmopn)) => (((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccms)) @ (cwcel @ XE @ (ccfv @ XY @ ccxmt)) @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) & (cwcel @ XB2 @ (ccfv @ XD @ cccfil))) => (cwcel @ (ccfv @ XB2 @ (cco @ XY @ XF @ ccfm)) @ (ccfv @ XE @ cccfil)))))))))))))).
