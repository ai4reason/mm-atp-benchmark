...
thf(ambfi1fseq_ax,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : ((! [Xg1:$i] : ((Xph @ Xg1) => (cwcel @ XF @ ccmbf))) => ((! [Xg1:$i] : ((Xph @ Xg1) => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF))) => (! [Xg1:$i] : ((Xph @ Xg1) => (? [Xg1:$i] : (cw3a @ (cwf @ ccn @ (ccdm @ ccitg1) @ (ccv @ Xg1)) @ (cwral @ (^ [Xn:$i] : ((cwbr @ cc0p @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ (ccofr @ ccle)) & (cwbr @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ (ccv @ Xg1)) @ (ccofr @ ccle)))) @ (^ [Xn:$i] : ccn)) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1))))) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccli)) @ (^ [Xx3:$i] : ccr))))))))))).
...
thf(ai1fsub_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (ccdm @ ccitg1)) & (cwcel @ XG @ (ccdm @ ccitg1))) => (cwcel @ (cco @ XF @ XG @ (ccof @ ccmin)) @ (ccdm @ ccitg1)))))).
...
thf(cmbfi1flimlem_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwf @ ccr @ ccr @ XF)) => (Xph => (? [Xg1:$i] : ((cwf @ ccn @ (ccdm @ ccitg1) @ (ccv @ Xg1)) & (cwral @ (^ [Xx3:$i] : (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1))))) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccli)) @ (^ [Xx3:$i] : ccr)))))))))).
