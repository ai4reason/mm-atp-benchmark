...
thf(arefref_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwbr @ XA2 @ XA2 @ ccref))))).
...
thf(a_0top_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cctop) => (((ccuni @ XJ) = cc0) <=> (XJ = (ccsn @ cc0)))))).
...
thf(arefun0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccref) & (cwne @ XB2 @ cc0)) => (cwbr @ (ccun @ XA2 @ (ccsn @ cc0)) @ XB2 @ ccref))))).
...
thf(alfinun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccfv @ XJ @ cclocfin)) @ (cwcel @ XB2 @ ccfn) @ (cwss @ (ccuni @ XB2) @ (ccuni @ XJ))) => (cwcel @ (ccun @ XA2 @ XB2) @ (ccfv @ XJ @ cclocfin))))))).
...
thf(clocfinref_conj,conjecture,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xf1:$i] : ((XX @ Xf1) = (ccuni @ XJ))) => ((Xph => (cwss @ XU @ XJ)) => ((! [Xf1:$i] : (Xph => ((XX @ Xf1) = (ccuni @ XU)))) => ((Xph => (cwss @ XV @ XJ)) => ((Xph => (cwbr @ XV @ XU @ ccref)) => ((Xph => (cwcel @ XV @ (ccfv @ XJ @ cclocfin))) => (Xph => (? [Xf1:$i] : (cw3a @ (cwf @ XU @ XJ @ (ccv @ Xf1)) @ (cwbr @ (ccrn @ (ccv @ Xf1)) @ XU @ ccref) @ (cwcel @ (ccrn @ (ccv @ Xf1)) @ (ccfv @ XJ @ cclocfin))))))))))))))))).
