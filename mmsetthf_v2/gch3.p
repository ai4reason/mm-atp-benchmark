...
thf(agchaleph2_ax,axiom,(! [XA2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ (ccfv @ XA2 @ ccale) @ ccgch) @ (cwcel @ (ccfv @ (ccsuc @ XA2) @ ccale) @ ccgch)) => (cwbr @ (ccfv @ (ccsuc @ XA2) @ ccale) @ (ccpw @ (ccfv @ XA2 @ ccale)) @ ccen)))).
...
thf(aalephgch_ax,axiom,(! [XA2:($i > $o)] : ((cwbr @ (ccfv @ (ccsuc @ XA2) @ ccale) @ (ccpw @ (ccfv @ XA2 @ ccale)) @ ccen) => (cwcel @ (ccfv @ XA2 @ ccale) @ ccgch)))).
...
thf(agch2_ax,axiom,((ccgch = ccvv) <=> (cwss @ (ccrn @ ccale) @ ccgch))).
thf(cgch3_conj,conjecture,((ccgch = ccvv) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ ccale) @ (ccpw @ (ccfv @ (ccv @ Xx3) @ ccale)) @ ccen)) @ (^ [Xx3:$i] : ccon0)))).
