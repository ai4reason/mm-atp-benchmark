...
thf(cxdivval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccr) @ (cwne @ XB2 @ ccc0)) => ((cco @ XA2 @ XB2 @ ccxdiv) = (ccrio @ (^ [Xx3:$i] : ((cco @ XB2 @ (ccv @ Xx3) @ ccxmu) = XA2)) @ (^ [Xx3:$i] : ccxr))))))).
