...
thf(cupwlkbprop_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XG @ cciedg)) => ((cwbr @ XF @ XP @ (ccfv @ XG @ ccupwlks)) => (cw3a @ (cwcel @ XG @ ccvv) @ (cwcel @ XF @ ccvv) @ (cwcel @ XP @ ccvv))))))))))).
