...
thf(cpjsumi_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => ((cwss @ XG @ (ccfv @ XH @ ccort)) => ((ccfv @ XA2 @ (ccfv @ (cco @ XG @ XH @ ccph) @ ccpjh)) = (cco @ (ccfv @ XA2 @ (ccfv @ XG @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccva)))))))))).
