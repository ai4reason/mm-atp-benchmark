...
thf(c_2elfz3nn0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ XN @ ccfz)) & (cwcel @ XB2 @ (cco @ ccc0 @ XN @ ccfz))) => (cw3a @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn0) @ (cwcel @ XN @ ccn0))))))).
