...
thf(cbinom3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ cc3 @ ccexp) = (cco @ (cco @ (cco @ XA2 @ cc3 @ ccexp) @ (cco @ cc3 @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ XB2 @ ccmul) @ ccmul) @ ccaddc) @ (cco @ (cco @ cc3 @ (cco @ XA2 @ (cco @ XB2 @ cc2 @ ccexp) @ ccmul) @ ccmul) @ (cco @ XB2 @ cc3 @ ccexp) @ ccaddc) @ ccaddc)))))).
