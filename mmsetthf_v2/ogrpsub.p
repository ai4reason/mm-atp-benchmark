...
thf(cogrpsub_conj,conjecture,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_le = (ccfv @ XG @ ccple)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((cw3a @ (cwcel @ XG @ ccogrp) @ (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2)) @ (cwbr @ XX @ XY @ Xc_le)) => (cwbr @ (cco @ XX @ XZ @ Xc_mi) @ (cco @ XY @ XZ @ Xc_mi) @ Xc_le))))))))))))).
