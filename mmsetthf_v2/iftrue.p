...
thf(adedlem0a_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (Xps <=> ((Xch => Xph) => (Xps & Xph)))))))).
thf(adfif2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccif @ Xph @ XA2 @ XB2) = (ccab @ (^ [Xx3:$i] : (((cwcel @ (ccv @ Xx3) @ XB2) => Xph) => ((cwcel @ (ccv @ Xx3) @ XA2) & Xph))))))))).
