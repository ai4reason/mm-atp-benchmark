...
thf(citgcoscmulx_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwbr @ XB2 @ XC @ ccle)) => ((Xph => (cwne @ XA2 @ ccc0)) => (Xph => ((ccitg @ (^ [Xx3:$i] : (cco @ XB2 @ XC @ ccioo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ cccos))) = (cco @ (cco @ (ccfv @ (cco @ XA2 @ XC @ ccmul) @ ccsin) @ (ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ ccsin) @ ccmin) @ XA2 @ ccdiv))))))))))))).
