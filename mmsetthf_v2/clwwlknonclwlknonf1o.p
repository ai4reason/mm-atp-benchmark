...
thf(aclwlknf1oclwwlkn_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((! [Xw:$i] : (! [Xc:$i] : ((XA2 @ Xw @ Xc) = (ccfv @ (ccv @ Xc) @ cc1st)))) => ((! [Xw:$i] : (! [Xc:$i] : ((XB2 @ Xw @ Xc) = (ccfv @ (ccv @ Xc) @ cc2nd)))) => ((! [Xw:$i] : ((XC @ Xw) = (ccrab @ (^ [Xw:$i] : ((ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) = XN)) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks))))) => ((! [Xw:$i] : (! [Xc:$i] : ((XF @ Xw @ Xc) = (ccmpt @ (^ [Xc:$i] : (XC @ Xw)) @ (^ [Xc:$i] : (cco @ (XB2 @ Xw @ Xc) @ (ccop @ ccc0 @ (ccfv @ (XA2 @ Xw @ Xc) @ cchash)) @ ccsubstr)))))) => (! [Xw:$i] : (! [Xc:$i] : (((cwcel @ XG @ ccuspgr) & (cwcel @ XN @ ccn)) => (cwf1o @ (XC @ Xw) @ (cco @ XN @ XG @ ccclwwlkn) @ (XF @ Xw @ Xc)))))))))))))))).
...
thf(awlklenvp1_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) => ((ccfv @ XP @ cchash) = (cco @ (ccfv @ XF @ cchash) @ cc1 @ ccaddc))))))).
thf(ccfzo_tp,type,(ccfzo : ($i > $o))).
thf(aswrd0fv0_ax,axiom,(! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XI @ (cco @ cc1 @ (ccfv @ XW @ cchash) @ ccfz))) => ((ccfv @ ccc0 @ (cco @ XW @ (ccop @ ccc0 @ XI) @ ccsubstr)) = (ccfv @ ccc0 @ XW))))))).
...
thf(cclwwlknonclwlknonf1o_conj,conjecture,(! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XW = (ccrab @ (^ [Xw:$i] : (((ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) = XN) & ((ccfv @ ccc0 @ (ccfv @ (ccv @ Xw) @ cc2nd)) = XX))) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks)))) => ((! [Xw:$i] : (! [Xc:$i] : ((XF @ Xw @ Xc) = (ccmpt @ (^ [Xc:$i] : XW) @ (^ [Xc:$i] : (cco @ (ccfv @ (ccv @ Xc) @ cc2nd) @ (ccop @ ccc0 @ (ccfv @ (ccfv @ (ccv @ Xc) @ cc1st) @ cchash)) @ ccsubstr)))))) => (! [Xw:$i] : (! [Xc:$i] : ((cw3a @ (cwcel @ XG @ ccuspgr) @ (cwcel @ XX @ XV) @ (cwcel @ XN @ ccn)) => (cwf1o @ XW @ (cco @ XX @ XN @ (ccfv @ XG @ ccclwwlknon)) @ (XF @ Xw @ Xc))))))))))))))).
