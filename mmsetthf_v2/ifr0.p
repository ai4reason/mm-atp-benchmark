...
thf(amt2i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xch => ((Xph => (Xps => (~ Xch))) => (Xph => (~ Xps)))))))).
...
thf(afr0_ax,axiom,(! [XR:($i > $o)] : (cwfr @ cc0 @ XR))).
thf(afreq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((XA2 = XB2) => ((cwfr @ XA2 @ XR) <=> (cwfr @ XB2 @ XR))))))).
thf(cifr0_conj,conjecture,(! [XA2:($i > $o)] : ((cwfr @ XA2 @ ccid) <=> (XA2 = cc0)))).
