...
thf(cftc1anclem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cw3a @ (cwf @ XA2 @ ccc @ XF) @ (cwcel @ XF @ ccibl) @ (cwcel @ XG @ (ccpr @ ccre @ ccim))) => (cwcel @ (ccfv @ (ccmpt @ (^ [Xt:$i] : ccr) @ (^ [Xt:$i] : (ccif @ (cwcel @ (ccv @ Xt) @ XA2) @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xt) @ XF) @ XG) @ ccabs) @ ccc0))) @ ccitg2) @ ccr)))))).
