...
thf(ctxcnmpt_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XW:($i > $o)] : ((XW = (ccuni @ XU)) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XW) @ (^ [Xx3:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG)))))) => (! [Xx3:$i] : (((cwcel @ XF @ (cco @ XU @ XR @ cccn)) & (cwcel @ XG @ (cco @ XU @ XS @ cccn))) => (cwcel @ (XH @ Xx3) @ (cco @ XU @ (cco @ XR @ XS @ cctx) @ cccn)))))))))))))).
