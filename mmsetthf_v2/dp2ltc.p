...
thf(altadd2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (cco @ XC @ XA2 @ ccaddc) @ (cco @ XC @ XB2 @ ccaddc) @ cclt))))))).
...
thf(cdp2ltc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccrp) => ((cwcel @ XC @ ccn0) => ((cwcel @ XD @ ccrp) => ((cwbr @ XB2 @ (ccdc @ cc1 @ ccc0) @ cclt) => ((cwbr @ XA2 @ XC @ cclt) => (cwbr @ (ccdp2 @ XA2 @ XB2) @ (ccdp2 @ XC @ XD) @ cclt)))))))))))).
