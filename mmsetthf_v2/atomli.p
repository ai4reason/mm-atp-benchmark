...
thf(ahatomic_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwne @ XA2 @ cc0h)) => (cwrex @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XA2)) @ (^ [Xx3:$i] : ccat))))).
...
thf(aibd_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps => (Xps <=> Xch))) => (Xph => (Xps => Xch))))))).
...
thf(apjoml3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((cwss @ XB2 @ XA2) => ((ccin @ XA2 @ (cco @ (ccfv @ XA2 @ ccort) @ XB2 @ cchj)) = XB2)))))).
...
thf(achub1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => (cwss @ XA2 @ (cco @ XA2 @ XB2 @ cchj)))))).
...
thf(aorthin_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccsh) & (cwcel @ XB2 @ ccsh)) => ((cwss @ XA2 @ (ccfv @ XB2 @ ccort)) => ((ccin @ XA2 @ XB2) = cc0h)))))).
thf(cccv_tp,type,(cccv : ($i > $o))).
thf(cwbr_tp,type,(cwbr : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(cwpss_tp,type,(cwpss : (($i > $o) > (($i > $o) > $o)))).
thf(aatexch_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccat) @ (cwcel @ XC @ ccat)) => (((cwss @ XB2 @ (cco @ XA2 @ XC @ cchj)) & ((ccin @ XA2 @ XB2) = cc0h)) => (cwss @ XC @ (cco @ XA2 @ XB2 @ cchj)))))))).
...
thf(catomli_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccat) => (cwcel @ (ccin @ (cco @ XA2 @ XB2 @ cchj) @ (ccfv @ XA2 @ ccort)) @ (ccun @ ccat @ (ccsn @ cc0h)))))))).
