...
thf(afprodeq0_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XN @ XZ)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XA2 @ Xk) @ ccc))) => ((! [Xk:$i] : ((Xph & ((ccv @ Xk) = XN)) => ((XA2 @ Xk) = ccc0))) => ((Xph & (cwcel @ XK @ (ccfv @ XN @ ccuz))) => ((ccprod @ (^ [Xk:$i] : (cco @ XM @ XK @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) = ccc0))))))))))))).
...
thf(cbcc0_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XK @ ccn0)) => (Xph => (((cco @ XC @ XK @ ccbcc) = ccc0) <=> (cwcel @ XC @ (cco @ ccc0 @ (cco @ XK @ cc1 @ ccmin) @ ccfz)))))))))).
