...
thf(asqoddm1div8z_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (~ (cwbr @ cc2 @ XN @ ccdvds))) => (cwcel @ (cco @ (cco @ (cco @ XN @ cc2 @ ccexp) @ cc1 @ ccmin) @ cc8 @ ccdiv) @ ccz)))).
thf(ccc_tp,type,(ccc : ($i > $o))).
thf(am1exp1_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => (((cco @ (ccneg @ cc1) @ XN @ ccexp) = cc1) <=> (cwbr @ cc2 @ XN @ ccdvds))))).
thf(a_2lgsoddprmlem4_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (~ (cwbr @ cc2 @ XN @ ccdvds))) => ((cwbr @ cc2 @ (cco @ (cco @ (cco @ XN @ cc2 @ ccexp) @ cc1 @ ccmin) @ cc8 @ ccdiv) @ ccdvds) <=> (cwcel @ (cco @ XN @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)))))).
...
thf(algscl1_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccz)) => (cwcel @ (cco @ XA2 @ XN @ cclgs) @ (cctp @ (ccneg @ cc1) @ ccc0 @ cc1)))))).
...
thf(am1expo_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (~ (cwbr @ cc2 @ XN @ ccdvds))) => ((cco @ (ccneg @ cc1) @ XN @ ccexp) = (ccneg @ cc1))))).
...
thf(c_2lgsoddprm_conj,conjecture,(! [XP:($i > $o)] : ((cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) => ((cco @ cc2 @ XP @ cclgs) = (cco @ (ccneg @ cc1) @ (cco @ (cco @ (cco @ XP @ cc2 @ ccexp) @ cc1 @ ccmin) @ cc8 @ ccdiv) @ ccexp))))).
