...
thf(cixpsnval_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xx3:$i] : ((cwcel @ XX @ (XV @ Xx3)) => ((ccixp @ (^ [Xx3:$i] : (ccsn @ XX)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (ccab @ (^ [Xf1:$i] : ((cwfn @ (ccv @ Xf1) @ (ccsn @ XX)) & (cwcel @ (ccfv @ XX @ (ccv @ Xf1)) @ (ccsb @ XX @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))))))).
