...
thf(acarden_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ XC) & (cwcel @ XB2 @ XD)) => (((ccfv @ XA2 @ cccrd) = (ccfv @ XB2 @ cccrd)) <=> (cwbr @ XA2 @ XB2 @ ccen)))))))).
...
thf(ccardeq0_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (((ccfv @ XA2 @ cccrd) = cc0) <=> (XA2 = cc0)))))).
