...
thf(arelfi_ax,axiom,(! [XA2:($i > $o)] : ((cwrel @ XA2) => ((cwcel @ XA2 @ ccfn) <=> ((cwcel @ (ccdm @ XA2) @ ccfn) & (cwcel @ (ccrn @ XA2) @ ccfn)))))).
...
thf(affsrn_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XZ @ XW)) => ((Xph => (cwcel @ XF @ XV)) => ((Xph => (cwfun @ XF)) => ((Xph => (cwcel @ (cco @ XF @ XZ @ ccsupp) @ ccfn)) => (Xph => (cwcel @ (ccrn @ XF) @ ccfn)))))))))))).
...
thf(aopabdm_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XR:($i > $o)] : ((XR = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))) => ((ccdm @ XR) = (ccab @ (^ [Xx3:$i] : (? [Xy1:$i] : (Xph @ Xx3 @ Xy1))))))))).
...
thf(aunifi3_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ (ccuni @ XA2) @ ccfn) => (cwss @ XA2 @ ccfn)))).
thf(aopabrn_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XR:($i > $o)] : ((XR = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))) => ((ccrn @ XR) = (ccab @ (^ [Xy1:$i] : (? [Xx3:$i] : (Xph @ Xx3 @ Xy1))))))))).
