...
thf(cmdandyv12_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xph <=> $false) => ((Xps <=> $true) => ((Xch <=> $false) => ((Xth <=> $false) => ((Xta <=> $true) => ((Xet <=> $true) => ((((Xch <=> Xph) & (Xth <=> Xph)) & (Xta <=> Xps)) & (Xet <=> Xps))))))))))))))).
