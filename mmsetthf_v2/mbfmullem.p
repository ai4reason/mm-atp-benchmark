...
thf(ambfi1flim_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwf @ XA2 @ ccr @ XF)) => (Xph => (? [Xg1:$i] : ((cwf @ ccn @ (ccdm @ ccitg1) @ (ccv @ Xg1)) & (cwral @ (^ [Xx3:$i] : (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1))))) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccli)) @ (^ [Xx3:$i] : XA2))))))))))).
...
thf(ambfmullem2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwcel @ XG @ ccmbf)) => ((Xph => (cwf @ XA2 @ ccr @ XF)) => ((Xph => (cwf @ XA2 @ ccr @ XG)) => ((Xph => (cwf @ ccn @ (ccdm @ ccitg1) @ XP)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XP)))) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccli))) => ((Xph => (cwf @ ccn @ (ccdm @ ccitg1) @ XQ)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XQ)))) @ (ccfv @ (ccv @ Xx3) @ XG) @ ccli))) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccmbf))))))))))))))))).
...
thf(cmbfmullem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwcel @ XG @ ccmbf)) => ((Xph => (cwf @ XA2 @ ccr @ XF)) => ((Xph => (cwf @ XA2 @ ccr @ XG)) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccmbf))))))))))).
