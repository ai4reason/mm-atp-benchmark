...
thf(aclwlkssizeeq_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XG @ ccuspgr) & (cwcel @ XN @ ccn)) => ((ccfv @ (cco @ XN @ XG @ ccclwwlkn) @ cchash) = (ccfv @ (ccrab @ (^ [Xw:$i] : ((ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) = XN)) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks))) @ cchash)))))).
