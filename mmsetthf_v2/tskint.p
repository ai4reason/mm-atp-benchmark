...
thf(atskss_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwcel @ XT @ cctsk) @ (cwcel @ XA2 @ XT) @ (cwss @ XB2 @ XA2)) => (cwcel @ XB2 @ XT)))))).
thf(ctskint_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ ((cwcel @ XT @ cctsk) & (cwtr @ XT)) @ (cwcel @ XA2 @ XT) @ (cwne @ XA2 @ cc0)) => (cwcel @ (ccint @ XA2) @ XT))))).
