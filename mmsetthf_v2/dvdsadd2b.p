...
thf(cdvdsadd2b_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ ((cwcel @ XC @ ccz) & (cwbr @ XA2 @ XC @ ccdvds))) => ((cwbr @ XA2 @ XB2 @ ccdvds) <=> (cwbr @ XA2 @ (cco @ XC @ XB2 @ ccaddc) @ ccdvds))))))).
