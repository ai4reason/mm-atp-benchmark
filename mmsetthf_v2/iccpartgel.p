...
thf(aiccpartgtl_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XP @ (ccfv @ XM @ cciccp))) => (Xph => (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ ccc0 @ XP) @ (ccfv @ (ccv @ Xi) @ XP) @ cclt)) @ (^ [Xi:$i] : (cco @ cc1 @ XM @ ccfz)))))))))).
