...
thf(achcoeffeq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_xp:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > ($i > $o)))] : (! [Xc_1:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [Xc_as:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [XY:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XY = (cco @ XN @ XP @ ccmat)) => ((! [Xs1:$i] : (! [Xb:$i] : ((Xc_xp @ Xs1 @ Xb) = (ccfv @ XY @ ccmulr)))) => ((Xc_mi = (ccfv @ XY @ ccsg)) => ((! [Xs1:$i] : (! [Xb:$i] : ((Xc_0 @ Xs1 @ Xb) = (ccfv @ XY @ cc0g)))) => ((XT = (cco @ XN @ XR @ ccmat2pmat)) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XC @ Xn @ Xs1 @ Xb) = (cco @ XN @ XR @ ccchpmat))))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XK @ Xs1 @ Xb) = (ccfv @ XM @ (XC @ Xn @ Xs1 @ Xb)))))) => ((! [Xs1:$i] : (! [Xb:$i] : ((XG @ Xs1 @ Xb) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ (cco @ (Xc_0 @ Xs1 @ Xb) @ (cco @ (ccfv @ XM @ XT) @ (ccfv @ (ccfv @ ccc0 @ (ccv @ Xb)) @ XT) @ (Xc_xp @ Xs1 @ Xb)) @ Xc_mi) @ (ccif @ ((ccv @ Xn) = (cco @ (ccv @ Xs1) @ cc1 @ ccaddc)) @ (ccfv @ (ccfv @ (ccv @ Xs1) @ (ccv @ Xb)) @ XT) @ (ccif @ (cwbr @ (cco @ (ccv @ Xs1) @ cc1 @ ccaddc) @ (ccv @ Xn) @ cclt) @ (Xc_0 @ Xs1 @ Xb) @ (cco @ (ccfv @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ (ccv @ Xb)) @ XT) @ (cco @ (ccfv @ XM @ XT) @ (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xb)) @ XT) @ (Xc_xp @ Xs1 @ Xb)) @ Xc_mi))))))))) => ((! [Xs1:$i] : (! [Xb:$i] : ((XW @ Xs1 @ Xb) = (ccfv @ XY @ ccbs)))) => ((! [Xs1:$i] : (! [Xb:$i] : ((Xc_1 @ Xs1 @ Xb) = (ccfv @ XA2 @ ccur)))) => ((! [Xs1:$i] : (! [Xb:$i] : ((Xc_as @ Xs1 @ Xb) = (ccfv @ XA2 @ ccvsca)))) => ((! [Xs1:$i] : (! [Xb:$i] : ((XU @ Xs1 @ Xb) = (cco @ XN @ XR @ cccpmat2mat)))) => ((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ cccrg) @ (cwcel @ XM @ XB2)) => (cwrex @ (^ [Xs1:$i] : (cwrex @ (^ [Xb:$i] : (cwral @ (^ [Xn:$i] : ((ccfv @ (ccfv @ (ccv @ Xn) @ (XG @ Xs1 @ Xb)) @ (XU @ Xs1 @ Xb)) = (cco @ (ccfv @ (ccv @ Xn) @ (ccfv @ (XK @ Xs1 @ Xb) @ ccco1)) @ (Xc_1 @ Xs1 @ Xb) @ (Xc_as @ Xs1 @ Xb)))) @ (^ [Xn:$i] : ccn0))) @ (^ [Xb:$i] : (cco @ XB2 @ (cco @ ccc0 @ (ccv @ Xs1) @ ccfz) @ ccmap)))) @ (^ [Xs1:$i] : ccn))))))))))))))))))))))))))))))))))))).
