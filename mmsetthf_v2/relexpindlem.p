...
thf(arelexp0_ax,axiom,(! [XR:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XR @ XV) & (cwrel @ XR)) => ((cco @ XR @ ccc0 @ ccrelexp) = (ccres @ ccid @ (ccuni @ (ccuni @ XR)))))))).
...
thf(aanbi1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph <=> Xps) => ((Xph & Xch) <=> (Xps & Xch))))))).
...
thf(arelexpsucl_ax,axiom,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XR @ XV) @ (cwrel @ XR) @ (cwcel @ XN @ ccn0)) => ((cco @ XR @ (cco @ XN @ cc1 @ ccaddc) @ ccrelexp) = (cccom @ XR @ (cco @ XR @ XN @ ccrelexp)))))))).
...
thf(crelexpindlem_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > ($i > $o))] : (! [Xth:($i > ($i > $o))] : (! [Xet:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xn:$i] : ((Xet => (cwrel @ XR)) => ((Xet => (cwcel @ XR @ ccvv)) => ((Xet => (cwcel @ XS @ ccvv)) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (((ccv @ Xi) = XS) => ((Xph @ Xi) <=> (Xch @ Xx3 @ Xj)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (((ccv @ Xi) = (ccv @ Xx3)) => ((Xph @ Xi) <=> (Xps @ Xx3))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (((ccv @ Xi) = (ccv @ Xj)) => ((Xph @ Xi) <=> (Xth @ Xx3 @ Xj)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (Xet => (Xch @ Xx3 @ Xj)))) => ((! [Xx3:$i] : (! [Xj:$i] : (Xet => ((cwbr @ (ccv @ Xj) @ (ccv @ Xx3) @ XR) => ((Xth @ Xx3 @ Xj) => (Xps @ Xx3)))))) => (! [Xx3:$i] : (Xet => ((cwcel @ (ccv @ Xn) @ ccn0) => ((cwbr @ XS @ (ccv @ Xx3) @ (cco @ XR @ (ccv @ Xn) @ ccrelexp)) => (Xps @ Xx3)))))))))))))))))))))).
