...
thf(aneibl_ax,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XP @ XX)) => ((cwcel @ XN @ (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei))) <=> ((cwss @ XN @ XX) & (cwrex @ (^ [Xr:$i] : (cwss @ (cco @ XP @ (ccv @ Xr) @ (ccfv @ XD @ ccbl)) @ XN)) @ (^ [Xr:$i] : ccrp)))))))))))).
...
thf(cislpcn_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : ((Xph => (cwss @ XS @ ccc)) => ((Xph => (cwcel @ XP @ ccc)) => (Xph => ((cwcel @ XP @ (ccfv @ XS @ (ccfv @ (ccfv @ cccnfld @ cctopn) @ cclp))) <=> (cwral @ (^ [Xe:$i] : (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ XP @ ccmin) @ ccabs) @ (ccv @ Xe) @ cclt)) @ (^ [Xx3:$i] : (ccdif @ XS @ (ccsn @ XP))))) @ (^ [Xe:$i] : ccrp)))))))))).
