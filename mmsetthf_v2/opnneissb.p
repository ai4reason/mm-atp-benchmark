...
thf(copnneissb_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XN @ XJ) @ (cwss @ XS @ XX)) => ((cwss @ XS @ XN) <=> (cwcel @ XN @ (ccfv @ XS @ (ccfv @ XJ @ ccnei))))))))))).
