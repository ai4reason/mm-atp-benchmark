...
thf(afvun_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cwfun @ XF) & (cwfun @ XG)) & ((ccin @ (ccdm @ XF) @ (ccdm @ XG)) = cc0)) => ((ccfv @ XA2 @ (ccun @ XF @ XG)) = (ccun @ (ccfv @ XA2 @ XF) @ (ccfv @ XA2 @ XG)))))))).
thf(cundifixp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cw3a @ (cwcel @ XF @ (ccixp @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3)))) @ (cwcel @ XG @ (ccixp @ (^ [Xx3:$i] : (ccdif @ XA2 @ XB2)) @ (^ [Xx3:$i] : (XC @ Xx3)))) @ (cwss @ XB2 @ XA2)) => (cwcel @ (ccun @ XF @ XG) @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))))))))).
