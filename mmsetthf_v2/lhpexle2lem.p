...
thf(clhpexle2lem_conj,conjecture,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ ((cwcel @ XX @ XA2) & (cwbr @ XX @ XW @ Xc_le)) @ ((cwcel @ XY @ XA2) & (cwbr @ XY @ XW @ Xc_le))) => (cwrex @ (^ [Xp:$i] : (cw3a @ (cwbr @ (ccv @ Xp) @ XW @ Xc_le) @ (cwne @ (ccv @ Xp) @ XX) @ (cwne @ (ccv @ Xp) @ XY))) @ (^ [Xp:$i] : XA2)))))))))))))).
