...
thf(achub2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => (cwss @ XA2 @ (cco @ XB2 @ XA2 @ cchj)))))).
...
thf(achcv2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccat)) => ((cwpss @ XA2 @ (cco @ XA2 @ XB2 @ cchj)) <=> (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ cchj) @ cccv)))))).
...
thf(catexch_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccat) @ (cwcel @ XC @ ccat)) => (((cwss @ XB2 @ (cco @ XA2 @ XC @ cchj)) & ((ccin @ XA2 @ XB2) = cc0h)) => (cwss @ XC @ (cco @ XA2 @ XB2 @ cchj)))))))).
