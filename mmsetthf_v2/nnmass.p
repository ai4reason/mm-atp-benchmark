...
thf(anndi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom) @ (cwcel @ XC @ ccom)) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccoa) @ ccomu) = (cco @ (cco @ XA2 @ XB2 @ ccomu) @ (cco @ XA2 @ XC @ ccomu) @ ccoa))))))).
thf(cnnmass_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom) @ (cwcel @ XC @ ccom)) => ((cco @ (cco @ XA2 @ XB2 @ ccomu) @ XC @ ccomu) = (cco @ XA2 @ (cco @ XB2 @ XC @ ccomu) @ ccomu))))))).
