...
thf(aivthlem1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : ((! [Xz:$i] : (Xph => (cwcel @ (XA2 @ Xz) @ ccr))) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XU @ ccr)) => ((! [Xz:$i] : (Xph => (cwbr @ (XA2 @ Xz) @ XB2 @ cclt))) => ((! [Xz:$i] : (Xph => (cwss @ (cco @ (XA2 @ Xz) @ XB2 @ ccicc) @ XD))) => ((Xph => (cwcel @ XF @ (cco @ XD @ ccc @ cccncf))) => ((! [Xx3:$i] : (! [Xz:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ (XA2 @ Xz) @ XB2 @ ccicc))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ ccr)))) => ((! [Xz:$i] : (Xph => ((cwbr @ (ccfv @ (XA2 @ Xz) @ XF) @ XU @ cclt) & (cwbr @ XU @ (ccfv @ XB2 @ XF) @ cclt)))) => ((! [Xz:$i] : (XS = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ XU @ ccle)) @ (^ [Xx3:$i] : (cco @ (XA2 @ Xz) @ XB2 @ ccicc))))) => (! [Xz:$i] : (Xph => ((cwcel @ (XA2 @ Xz) @ XS) & (cwral @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ XB2 @ ccle)) @ (^ [Xz:$i] : XS)))))))))))))))))))))).
...
thf(aivthlem2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XU @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ XD)) => ((Xph => (cwcel @ XF @ (cco @ XD @ ccc @ cccncf))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccicc))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ ccr))) => ((Xph => ((cwbr @ (ccfv @ XA2 @ XF) @ XU @ cclt) & (cwbr @ XU @ (ccfv @ XB2 @ XF) @ cclt))) => ((XS = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ XU @ ccle)) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)))) => ((XC = (ccsup @ XS @ ccr @ cclt)) => (Xph => (~ (cwbr @ (ccfv @ XC @ XF) @ XU @ cclt)))))))))))))))))))))).
...
thf(alttri3d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((XA2 = XB2) <=> ((~ (cwbr @ XA2 @ XB2 @ cclt)) & (~ (cwbr @ XB2 @ XA2 @ cclt))))))))))).
...
thf(altlend_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((cwbr @ XA2 @ XB2 @ cclt) <=> ((cwbr @ XA2 @ XB2 @ ccle) & (cwne @ XB2 @ XA2)))))))))).
...
thf(civthlem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XU @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ XD)) => ((Xph => (cwcel @ XF @ (cco @ XD @ ccc @ cccncf))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccicc))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ ccr))) => ((Xph => ((cwbr @ (ccfv @ XA2 @ XF) @ XU @ cclt) & (cwbr @ XU @ (ccfv @ XB2 @ XF) @ cclt))) => ((XS = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ XU @ ccle)) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)))) => ((XC = (ccsup @ XS @ ccr @ cclt)) => (Xph => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo)) & ((ccfv @ XC @ XF) = XU)))))))))))))))))))))).
