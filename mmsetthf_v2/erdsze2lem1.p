...
thf(cerdsze2lem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XR @ ccn)) => ((Xph => (cwcel @ XS @ ccn)) => ((Xph => (cwf1 @ XA2 @ ccr @ XF)) => ((Xph => (cwss @ XA2 @ ccr)) => ((XN = (cco @ (cco @ XR @ cc1 @ ccmin) @ (cco @ XS @ cc1 @ ccmin) @ ccmul)) => ((Xph => (cwbr @ XN @ (ccfv @ XA2 @ cchash) @ cclt)) => (Xph => (? [Xf1:$i] : ((cwf1 @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ XA2 @ (ccv @ Xf1)) & (cwiso @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (ccrn @ (ccv @ Xf1)) @ cclt @ cclt @ (ccv @ Xf1)))))))))))))))))).
