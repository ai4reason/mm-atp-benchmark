...
thf(custund_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwss @ (ccxp @ XA2 @ XA2) @ XV)) => ((Xph => (cwss @ (ccxp @ XB2 @ XB2) @ XV)) => ((Xph => (cwne @ (ccin @ XA2 @ XB2) @ cc0)) => (Xph => (cwss @ (ccxp @ (ccun @ XA2 @ XB2) @ (ccun @ XA2 @ XB2)) @ (cccom @ XV @ XV))))))))))).
