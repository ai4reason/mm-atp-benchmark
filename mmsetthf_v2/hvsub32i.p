...
thf(ahvsub32_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil)) => ((cco @ (cco @ XA2 @ XB2 @ ccmv) @ XC @ ccmv) = (cco @ (cco @ XA2 @ XC @ ccmv) @ XB2 @ ccmv))))))).
