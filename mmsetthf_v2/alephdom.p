...
thf(aeqeng_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((XA2 = XB2) => (cwbr @ XA2 @ XB2 @ ccen))))))).
...
thf(aordtri2or_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cword @ XA2) & (cword @ XB2)) => ((cwcel @ XA2 @ XB2) | (cwss @ XB2 @ XA2)))))).
...
thf(calephdom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((cwss @ XA2 @ XB2) <=> (cwbr @ (ccfv @ XA2 @ ccale) @ (ccfv @ XB2 @ ccale) @ ccdom)))))).
