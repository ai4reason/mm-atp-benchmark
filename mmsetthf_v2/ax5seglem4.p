...
thf(cax5seglem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ ((cwcel @ XN @ ccn) & (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee)))) @ (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XB2) = (cco @ (cco @ (cco @ cc1 @ XT @ ccmin) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmul) @ (cco @ XT @ (ccfv @ (ccv @ Xi) @ XC) @ ccmul) @ ccaddc))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz))) @ (cwne @ XA2 @ XB2)) => (cwne @ XT @ ccc0)))))))).
