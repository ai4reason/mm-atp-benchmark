...
thf(achnlei_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((~ (cwss @ XB2 @ XA2)) <=> (cwpss @ XA2 @ (cco @ XA2 @ XB2 @ cchj)))))))).
...
thf(cchnle_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((~ (cwss @ XB2 @ XA2)) <=> (cwpss @ XA2 @ (cco @ XA2 @ XB2 @ cchj))))))).
