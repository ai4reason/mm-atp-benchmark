...
thf(aopprnzr_ax,axiom,(! [XR:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XR @ ccoppr)) => ((cwcel @ XR @ ccnzr) => (cwcel @ XO @ ccnzr)))))).
...
thf(copprdomn_conj,conjecture,(! [XR:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XR @ ccoppr)) => ((cwcel @ XR @ ccdomn) => (cwcel @ XO @ ccdomn)))))).
