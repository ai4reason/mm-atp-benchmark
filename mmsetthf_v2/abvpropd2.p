...
thf(cabvpropd2_conj,conjecture,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((Xph => ((ccfv @ XK @ ccbs) = (ccfv @ XL @ ccbs))) => ((Xph => ((ccfv @ XK @ ccplusg) = (ccfv @ XL @ ccplusg))) => ((Xph => ((ccfv @ XK @ ccmulr) = (ccfv @ XL @ ccmulr))) => (Xph => ((ccfv @ XK @ ccabv) = (ccfv @ XL @ ccabv)))))))))).
