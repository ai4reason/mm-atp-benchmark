...
thf(csgmval2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccn)) => ((cco @ XA2 @ XB2 @ ccsgm) = (ccsu @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XB2 @ ccdvds)) @ (^ [Xp:$i] : ccn)) @ (^ [Xk:$i] : (cco @ (ccv @ Xk) @ XA2 @ ccexp)))))))).
