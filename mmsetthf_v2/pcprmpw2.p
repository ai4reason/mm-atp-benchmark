...
thf(cpcprmpw2_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccn)) => ((cwrex @ (^ [Xn:$i] : (cwbr @ XA2 @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ ccdvds)) @ (^ [Xn:$i] : ccn0)) <=> (XA2 = (cco @ XP @ (cco @ XP @ XA2 @ ccpc) @ ccexp))))))).
