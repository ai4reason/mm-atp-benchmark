...
thf(afaclbnd4_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XK @ ccn0) @ (cwcel @ XM @ ccn0)) => (cwbr @ (cco @ (cco @ XN @ XK @ ccexp) @ (cco @ XM @ XN @ ccexp) @ ccmul) @ (cco @ (cco @ (cco @ cc2 @ (cco @ XK @ cc2 @ ccexp) @ ccexp) @ (cco @ XM @ (cco @ XM @ XK @ ccaddc) @ ccexp) @ ccmul) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccle)))))).
...
thf(cfaclbnd5_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XK @ ccn0) @ (cwcel @ XM @ ccn)) => (cwbr @ (cco @ (cco @ XN @ XK @ ccexp) @ (cco @ XM @ XN @ ccexp) @ ccmul) @ (cco @ (cco @ cc2 @ (cco @ (cco @ cc2 @ (cco @ XK @ cc2 @ ccexp) @ ccexp) @ (cco @ XM @ (cco @ XM @ XK @ ccaddc) @ ccexp) @ ccmul) @ ccmul) @ (ccfv @ XN @ ccfa) @ ccmul) @ cclt)))))).
