...
thf(aiotassuni_ax,axiom,(! [Xph:($i > $o)] : (cwss @ (ccio @ (^ [Xx3:$i] : (Xph @ Xx3))) @ (ccuni @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3))))))).
...
thf(cbj_nuliotaALT_conj,conjecture,(cc0 = (ccio @ (^ [Xx3:$i] : (! [Xy1:$i] : (~ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)))))))).
