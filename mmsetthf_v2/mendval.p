...
thf(aofeq_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((XR = XS) => ((ccof @ XR) = (ccof @ XS)))))).
...
thf(adf_mend_ax,axiom,(ccmend = (ccmpt @ (^ [Xm:$i] : ccvv) @ (^ [Xm:$i] : (ccsb @ (cco @ (ccv @ Xm) @ (ccv @ Xm) @ cclmhm) @ (^ [Xb:$i] : (ccun @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccv @ Xb)) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xb))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xb))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccof @ (ccfv @ (ccv @ Xm) @ ccplusg))))))) @ (ccop @ (ccfv @ ccnx @ ccmulr) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xb))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xb))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cccom @ (ccv @ Xx3) @ (ccv @ Xy1))))))) @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccsca) @ (ccfv @ (ccv @ Xm) @ ccsca)) @ (ccop @ (ccfv @ ccnx @ ccvsca) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccfv @ (ccv @ Xm) @ ccsca) @ ccbs))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xb))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccxp @ (ccfv @ (ccv @ Xm) @ ccbs) @ (ccsn @ (ccv @ Xx3))) @ (ccv @ Xy1) @ (ccof @ (ccfv @ (ccv @ Xm) @ ccvsca))))))))))))))).
