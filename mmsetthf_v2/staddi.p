...
thf(astle1_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XS @ ccst) => ((cwcel @ XA2 @ ccch) => (cwbr @ (ccfv @ XA2 @ XS) @ cc1 @ ccle)))))).
...
thf(cstaddi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XS @ ccst) => (((cco @ (ccfv @ XA2 @ XS) @ (ccfv @ XB2 @ XS) @ ccaddc) = cc2) => ((ccfv @ XA2 @ XS) = cc1))))))))).
