...
thf(acats1fvn_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XT = (cco @ XS @ (ccs1 @ XX) @ ccconcat)) => ((cwcel @ XS @ (ccword @ ccvv)) => (((ccfv @ XS @ cchash) = XM) => ((cwcel @ XX @ XV) => ((ccfv @ XM @ XT) = XX))))))))))).
...
thf(cs4fv3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XD @ XV) => ((ccfv @ cc3 @ (ccs4 @ XA2 @ XB2 @ XC @ XD)) = XD)))))))).
