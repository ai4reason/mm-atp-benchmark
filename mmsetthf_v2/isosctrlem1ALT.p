...
thf(aeel12131_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : ((Xph => Xps) => (((Xph & Xch) => Xth) => (((Xph & Xta) => Xet) => (((cw3a @ Xps @ Xth @ Xet) => Xze) => ((cw3a @ Xph @ Xch @ Xta) => Xze))))))))))))).
...
thf(a_3impcombi_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((cw3a @ Xph @ Xps @ Xph) => (Xch <=> Xth)) => ((cw3a @ Xps @ Xph @ Xch) => Xth))))))).
...
thf(cisosctrlem1ALT_conj,conjecture,(! [XA2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ ((ccfv @ XA2 @ ccabs) = cc1) @ (~ (cc1 = XA2))) => (cwne @ (ccfv @ (ccfv @ (cco @ cc1 @ XA2 @ ccmin) @ cclog) @ ccim) @ ccpi)))).
