...
thf(apjoml3i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwss @ XB2 @ XA2) => ((ccin @ XA2 @ (cco @ (ccfv @ XA2 @ ccort) @ XB2 @ cchj)) = XB2))))))).
thf(aifchhv_ax,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccif @ (cwcel @ XA2 @ ccch) @ XA2 @ cchil) @ ccch))).
thf(cpjoml3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((cwss @ XB2 @ XA2) => ((ccin @ XA2 @ (cco @ (ccfv @ XA2 @ ccort) @ XB2 @ cchj)) = XB2)))))).
