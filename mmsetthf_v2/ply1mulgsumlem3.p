...
thf(aply1mulgsumlem2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > ($i > $o))))] : (! [Xc_xp:($i > ($i > ($i > ($i > $o))))] : (! [Xc_ex:($i > ($i > ($i > ($i > $o))))] : (! [Xc_as:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xn:$i] : (! [Xs1:$i] : (! [Xl:$i] : ((XP @ Xn @ Xs1 @ Xl) = (ccfv @ XR @ ccpl1))))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xl:$i] : (XB2 = (ccfv @ (XP @ Xn @ Xs1 @ Xl) @ ccbs))))) => ((XA2 = (ccfv @ XK @ ccco1)) => ((XC = (ccfv @ XL @ ccco1)) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xl:$i] : ((XX @ Xn @ Xs1 @ Xl) = (ccfv @ XR @ ccv1))))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xl:$i] : ((Xc_xp @ Xn @ Xs1 @ Xl) = (ccfv @ (XP @ Xn @ Xs1 @ Xl) @ ccmulr))))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xl:$i] : ((Xc_x @ Xn @ Xs1 @ Xl) = (ccfv @ (XP @ Xn @ Xs1 @ Xl) @ ccvsca))))) => ((! [Xn:$i] : (! [Xl:$i] : ((Xc_as @ Xn @ Xl) = (ccfv @ XR @ ccmulr)))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xl:$i] : ((XM @ Xn @ Xs1 @ Xl) = (ccfv @ (XP @ Xn @ Xs1 @ Xl) @ ccmgp))))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xl:$i] : ((Xc_ex @ Xn @ Xs1 @ Xl) = (ccfv @ (XM @ Xn @ Xs1 @ Xl) @ ccmg))))) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XK @ XB2) @ (cwcel @ XL @ XB2)) => (cwrex @ (^ [Xs1:$i] : (cwral @ (^ [Xn:$i] : ((cwbr @ (ccv @ Xs1) @ (ccv @ Xn) @ cclt) => ((cco @ XR @ (ccmpt @ (^ [Xl:$i] : (cco @ ccc0 @ (ccv @ Xn) @ ccfz)) @ (^ [Xl:$i] : (cco @ (ccfv @ (ccv @ Xl) @ XA2) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xl) @ ccmin) @ XC) @ (Xc_as @ Xn @ Xl)))) @ ccgsu) = (ccfv @ XR @ cc0g)))) @ (^ [Xn:$i] : ccn0))) @ (^ [Xs1:$i] : ccn0))))))))))))))))))))))))))).
