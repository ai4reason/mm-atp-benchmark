...
thf(auhgrspan_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ cciedg)) => ((Xph => (cwcel @ XS @ XW)) => ((Xph => ((ccfv @ XS @ ccvtx) = XV)) => ((Xph => ((ccfv @ XS @ cciedg) = (ccres @ XE @ XA2))) => ((Xph => (cwcel @ XG @ ccuhgr)) => (Xph => (cwcel @ XS @ ccuhgr)))))))))))))))).
