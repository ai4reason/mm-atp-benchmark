...
thf(axkopjcn_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XR)) => ((cw3a @ (cwcel @ XR @ cctop) @ (cwcel @ XS @ cctop) @ (cwcel @ XA2 @ XX)) => (cwcel @ (ccmpt @ (^ [Xf1:$i] : (cco @ XR @ XS @ cccn)) @ (^ [Xf1:$i] : (ccfv @ XA2 @ (ccv @ Xf1)))) @ (cco @ (cco @ XS @ XR @ ccxko) @ XS @ cccn))))))))).
