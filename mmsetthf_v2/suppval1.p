...
thf(csuppval1_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cw3a @ (cwfun @ XX) @ (cwcel @ XX @ XV) @ (cwcel @ XZ @ XW)) => ((cco @ XX @ XZ @ ccsupp) = (ccrab @ (^ [Xi:$i] : (cwne @ (ccfv @ (ccv @ Xi) @ XX) @ XZ)) @ (^ [Xi:$i] : (ccdm @ XX)))))))))).
