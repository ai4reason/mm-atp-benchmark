...
thf(anmolb2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XN = (cco @ XS @ XT @ ccnmo)) => ((XV = (ccfv @ XS @ ccbs)) => ((XL = (ccfv @ XS @ ccnm)) => ((XM = (ccfv @ XT @ ccnm)) => ((! [Xx3:$i] : ((Xc_0 @ Xx3) = (ccfv @ XS @ cc0g))) => ((Xph => (cwcel @ XS @ ccngp)) => ((Xph => (cwcel @ XT @ ccngp)) => ((Xph => (cwcel @ XF @ (cco @ XS @ XT @ ccghm))) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XV) & (cwne @ (ccv @ Xx3) @ (Xc_0 @ Xx3)))) => (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XM) @ (cco @ XA2 @ (ccfv @ (ccv @ Xx3) @ XL) @ ccmul) @ ccle))) => (Xph => (cwbr @ (ccfv @ XF @ XN) @ XA2 @ ccle)))))))))))))))))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(a_3ad2ant2_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xch) => ((cw3a @ Xps @ Xph @ Xth) => Xch))))))).
thf(anghmrcl1_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (cco @ XS @ XT @ ccnghm)) => (cwcel @ XS @ ccngp)))))).
thf(anghmrcl2_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (cco @ XS @ XT @ ccnghm)) => (cwcel @ XT @ ccngp)))))).
...
thf(anghmghm_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (cco @ XS @ XT @ ccnghm)) => (cwcel @ XF @ (cco @ XS @ XT @ ccghm))))))).
thf(cccmn_tp,type,(cccmn : ($i > $o))).
thf(aghmplusg_ax,axiom,(! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xc_pl = (ccfv @ XN @ ccplusg)) => ((cw3a @ (cwcel @ XN @ ccabl) @ (cwcel @ XF @ (cco @ XM @ XN @ ccghm)) @ (cwcel @ XG @ (cco @ XM @ XN @ ccghm))) => (cwcel @ (cco @ XF @ XG @ (ccof @ Xc_pl)) @ (cco @ XM @ XN @ ccghm)))))))))).
thf(areaddcld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => (cwcel @ (cco @ XA2 @ XB2 @ ccaddc) @ ccr)))))))).
thf(anghmcl_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ XS @ XT @ ccnmo)) => ((cwcel @ XF @ (cco @ XS @ XT @ ccnghm)) => (cwcel @ (ccfv @ XF @ XN) @ ccr)))))))).
...
thf(anmoge0_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ XS @ XT @ ccnmo)) => ((cw3a @ (cwcel @ XS @ ccngp) @ (cwcel @ XT @ ccngp) @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm))) => (cwbr @ ccc0 @ (ccfv @ XF @ XN) @ ccle)))))))).
...
thf(anmtri_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XG @ ccnm)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((cw3a @ (cwcel @ XG @ ccngp) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) => (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ Xc_pl) @ XN) @ (cco @ (ccfv @ XA2 @ XN) @ (ccfv @ XB2 @ XN) @ ccaddc) @ ccle)))))))))))).
...
thf(anmoi_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XN = (cco @ XS @ XT @ ccnmo)) => ((XV = (ccfv @ XS @ ccbs)) => ((XL = (ccfv @ XS @ ccnm)) => ((XM = (ccfv @ XT @ ccnm)) => (((cwcel @ XF @ (cco @ XS @ XT @ ccnghm)) & (cwcel @ XX @ XV)) => (cwbr @ (ccfv @ (ccfv @ XX @ XF) @ XM) @ (cco @ (ccfv @ XF @ XN) @ (ccfv @ XX @ XL) @ ccmul) @ ccle))))))))))))))).
...
thf(cnmotri_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ XS @ XT @ ccnmo)) => ((Xc_pl = (ccfv @ XT @ ccplusg)) => ((cw3a @ (cwcel @ XT @ ccabl) @ (cwcel @ XF @ (cco @ XS @ XT @ ccnghm)) @ (cwcel @ XG @ (cco @ XS @ XT @ ccnghm))) => (cwbr @ (ccfv @ (cco @ XF @ XG @ (ccof @ Xc_pl)) @ XN) @ (cco @ (ccfv @ XF @ XN) @ (ccfv @ XG @ XN) @ ccaddc) @ ccle))))))))))).
