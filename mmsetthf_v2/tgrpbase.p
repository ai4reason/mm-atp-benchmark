...
thf(ctgrpbase_conj,conjecture,(! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XG = (ccfv @ XW @ (ccfv @ XK @ cctgrp))) => ((XC = (ccfv @ XG @ ccbs)) => (((cwcel @ XK @ XV) & (cwcel @ XW @ XH)) => (XC = XT)))))))))))))).
