...
thf(afidmfisupp_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwf @ XD @ XR @ XF)) => ((Xph => (cwcel @ XD @ ccfn)) => ((Xph => (cwcel @ XZ @ XV)) => (Xph => (cwbr @ XF @ XZ @ ccfsupp)))))))))))).
...
thf(aregsumsupp_ax,axiom,(! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwf @ XI @ ccr @ XF) @ (cwbr @ XF @ ccc0 @ ccfsupp) @ (cwcel @ XI @ XV)) => ((cco @ ccrefld @ XF @ ccgsu) = (ccsu @ (cco @ XF @ ccc0 @ ccsupp) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))))))))).
thf(cwfn_tp,type,(cwfn : (($i > $o) > (($i > $o) > $o)))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(afsumsupp0_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwf @ XA2 @ ccc @ XF)) => (Xph => ((ccsu @ (cco @ XF @ ccc0 @ ccsupp) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XF))) = (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XF))))))))))).
...
thf(crrxtopnfi_conj,conjecture,(! [Xph:$o] : (! [XI:($i > $o)] : ((Xph => (cwcel @ XI @ ccfn)) => (Xph => ((ccfv @ (ccfv @ XI @ ccrrx) @ cctopn) = (ccfv @ (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ ccr @ XI @ ccmap))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ ccr @ XI @ ccmap))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccfv @ (ccsu @ XI @ (^ [Xk:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xg1)) @ ccmin) @ cc2 @ ccexp))) @ ccsqrt)))) @ ccmopn))))))).
