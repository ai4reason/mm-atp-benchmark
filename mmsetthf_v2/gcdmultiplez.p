...
thf(agcdabs2_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XM @ ccz)) => ((cco @ XN @ (ccfv @ XM @ ccabs) @ ccgcd) = (cco @ XN @ XM @ ccgcd)))))).
...
thf(agcdmultiple_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn) & (cwcel @ XN @ ccn)) => ((cco @ XM @ (cco @ XM @ XN @ ccmul) @ ccgcd) = XM))))).
...
thf(cgcdmultiplez_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn) & (cwcel @ XN @ ccz)) => ((cco @ XM @ (cco @ XM @ XN @ ccmul) @ ccgcd) = XM))))).
