...
thf(aiccpartgt_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XP @ (ccfv @ XM @ cciccp))) => (Xph => (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : ((cwbr @ (ccv @ Xi) @ (ccv @ Xj) @ cclt) => (cwbr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (ccv @ Xj) @ XP) @ cclt))) @ (^ [Xj:$i] : (cco @ ccc0 @ XM @ ccfz)))) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfz)))))))))).
...
thf(axrltnsym_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwbr @ XA2 @ XB2 @ cclt) => (~ (cwbr @ XB2 @ XA2 @ cclt))))))).
