...
thf(aen2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccvv)) => ((Xph => (cwcel @ XB2 @ ccvv)) => ((! [Xx3:$i] : (Xph => ((cwcel @ (ccv @ Xx3) @ XA2) => (cwcel @ (XC @ Xx3) @ ccvv)))) => ((! [Xy1:$i] : (Xph => ((cwcel @ (ccv @ Xy1) @ XB2) => (cwcel @ (XD @ Xy1) @ ccvv)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (((cwcel @ (ccv @ Xx3) @ XA2) & ((ccv @ Xy1) = (XC @ Xx3))) <=> ((cwcel @ (ccv @ Xy1) @ XB2) & ((ccv @ Xx3) = (XD @ Xy1))))))) => (Xph => (cwbr @ XA2 @ XB2 @ ccen))))))))))))).
...
thf(aellz1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccz) => ((cwcel @ XA2 @ (ccdif @ ccz @ (ccfv @ (cco @ XB2 @ cc1 @ ccaddc) @ ccuz))) <=> ((cwcel @ XA2 @ ccz) & (cwbr @ XA2 @ XB2 @ ccle))))))).
...
thf(clzenom_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => (cwbr @ (ccdif @ ccz @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccuz)) @ ccom @ ccen)))).
