...
thf(cbcs2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil) @ (cwbr @ (ccfv @ XA2 @ ccno) @ cc1 @ ccle)) => (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccsp) @ ccabs) @ (ccfv @ XB2 @ ccno) @ ccle))))).
