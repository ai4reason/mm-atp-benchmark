...
thf(as1dm_ax,axiom,(! [XA2:($i > $o)] : ((ccdm @ (ccs1 @ XA2)) = (ccsn @ ccc0)))).
thf(cwlk2v2elem1_conj,conjecture,(! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XI = (ccs1 @ (ccpr @ XX @ XY))) => ((XF = (ccs2 @ ccc0 @ ccc0)) => (cwcel @ XF @ (ccword @ (ccdm @ XI)))))))))).
