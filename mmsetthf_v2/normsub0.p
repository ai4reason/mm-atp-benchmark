...
thf(anormsub0i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => (((ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno) = ccc0) <=> (XA2 = XB2))))))).
thf(aifhvhv0_ax,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccif @ (cwcel @ XA2 @ cchil) @ XA2 @ cc0v) @ cchil))).
thf(cnormsub0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => (((ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno) = ccc0) <=> (XA2 = XB2)))))).
