...
thf(aclwlknf1oclwwlknlem1_ax,axiom,(! [XC:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XC @ (ccfv @ XG @ ccclwlks)) & (cwbr @ cc1 @ (ccfv @ (ccfv @ XC @ cc1st) @ cchash) @ ccle)) => ((ccfv @ (cco @ (ccfv @ XC @ cc2nd) @ (ccop @ ccc0 @ (cco @ (ccfv @ (ccfv @ XC @ cc2nd) @ cchash) @ cc1 @ ccmin)) @ ccsubstr) @ cchash) = (ccfv @ (ccfv @ XC @ cc1st) @ cchash)))))).
thf(aclwlknf1oclwwlknlem3_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xw:$i] : (! [Xc:$i] : ((XA2 @ Xw @ Xc) = (ccfv @ (ccv @ Xc) @ cc1st)))) => ((! [Xw:$i] : (! [Xc:$i] : ((XB2 @ Xw @ Xc) = (ccfv @ (ccv @ Xc) @ cc2nd)))) => ((! [Xw:$i] : (! [Xc:$i] : ((XC @ Xw) = (ccrab @ (^ [Xw:$i] : ((ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) = (XN @ Xc))) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks)))))) => ((! [Xw:$i] : (! [Xc:$i] : ((XF @ Xw @ Xc) = (ccmpt @ (^ [Xc:$i] : (XC @ Xw)) @ (^ [Xc:$i] : (cco @ (XB2 @ Xw @ Xc) @ (ccop @ ccc0 @ (ccfv @ (XA2 @ Xw @ Xc) @ cchash)) @ ccsubstr)))))) => (! [Xw:$i] : (! [Xc:$i] : (((cwcel @ XG @ ccuspgr) & (cwcel @ (XN @ Xc) @ ccn)) => ((XF @ Xw @ Xc) = (ccres @ (ccmpt @ (^ [Xc:$i] : (ccrab @ (^ [Xw:$i] : (cwbr @ cc1 @ (ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) @ ccle)) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks)))) @ (^ [Xc:$i] : (cco @ (XB2 @ Xw @ Xc) @ (ccop @ ccc0 @ (ccfv @ (XA2 @ Xw @ Xc) @ cchash)) @ ccsubstr))) @ (XC @ Xw))))))))))))))))).
...
thf(aclwlknf1oclwwlknlem2_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((ccrab @ (^ [Xw:$i] : ((ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) = XN)) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks))) = (ccrab @ (^ [Xc:$i] : ((cwbr @ cc1 @ (ccfv @ (ccfv @ (ccv @ Xc) @ cc1st) @ cchash) @ ccle) & ((ccfv @ (ccfv @ (ccv @ Xc) @ cc1st) @ cchash) = XN))) @ (^ [Xc:$i] : (ccfv @ XG @ ccclwlks)))))))).
