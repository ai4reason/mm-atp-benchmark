...
thf(aulmpm_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwbr @ XF @ XG @ (ccfv @ XS @ cculm)) => (cwcel @ XF @ (cco @ (cco @ ccc @ XS @ ccmap) @ ccz @ ccpm))))))).
...
thf(culmf2_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : (((cwfn @ XF @ XZ) & (cwbr @ XF @ XG @ (ccfv @ XS @ cculm))) => (cwf @ XZ @ (cco @ ccc @ XS @ ccmap) @ XF))))))).
