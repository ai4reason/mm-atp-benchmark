...
thf(arngone0_ax,axiom,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XX = (ccrn @ XG)) => ((cwcel @ XR @ ccrngo) => (cwne @ XX @ cc0)))))))).
...
thf(crngoueqz_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XH = (ccfv @ XR @ cc2nd)) => ((XZ = (ccfv @ XG @ ccgi)) => ((XU = (ccfv @ XH @ ccgi)) => ((XX = (ccrn @ XG)) => ((cwcel @ XR @ ccrngo) => ((cwbr @ XX @ cc1o @ ccen) <=> (XU = XZ))))))))))))))).
