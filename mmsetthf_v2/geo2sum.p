...
thf(cgeo2sum_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XA2 @ ccc)) => ((ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ XA2 @ (cco @ cc2 @ (ccv @ Xk) @ ccexp) @ ccdiv))) = (cco @ XA2 @ (cco @ XA2 @ (cco @ cc2 @ XN @ ccexp) @ ccdiv) @ ccmin)))))).
