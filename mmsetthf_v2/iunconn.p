...
thf(arexn0_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) => (cwne @ XA2 @ cc0))))).
...
thf(aconnsub_ax,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwss @ XS @ XX)) => ((cwcel @ (cco @ XJ @ XS @ ccrest) @ ccconn) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cw3a @ (cwne @ (ccin @ (ccv @ Xx3) @ XS) @ cc0) @ (cwne @ (ccin @ (ccv @ Xy1) @ XS) @ cc0) @ (cwss @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccdif @ XX @ XS))) => (~ (cwss @ XS @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)))))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XJ)))))))).
thf(ciunconn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwss @ (XB2 @ Xk) @ XX))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ XP @ (XB2 @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (cco @ XJ @ (XB2 @ Xk) @ ccrest) @ ccconn))) => (Xph => (cwcel @ (cco @ XJ @ (cciun @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccrest) @ ccconn))))))))))))).
