...
thf(adf_gch_ax,axiom,(ccgch = (ccun @ ccfn @ (ccab @ (^ [Xx3:$i] : (! [Xy1:$i] : (~ ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsdm) & (cwbr @ (ccv @ Xy1) @ (ccpw @ (ccv @ Xx3)) @ ccsdm))))))))).
...
thf(celgch_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((cwcel @ XA2 @ ccgch) <=> ((cwcel @ XA2 @ ccfn) | (! [Xx3:$i] : (~ ((cwbr @ XA2 @ (ccv @ Xx3) @ ccsdm) & (cwbr @ (ccv @ Xx3) @ (ccpw @ XA2) @ ccsdm))))))))))).
