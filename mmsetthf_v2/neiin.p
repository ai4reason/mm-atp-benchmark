...
thf(cneiin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XM @ (ccfv @ XA2 @ (ccfv @ XJ @ ccnei))) @ (cwcel @ XN @ (ccfv @ XB2 @ (ccfv @ XJ @ ccnei)))) => (cwcel @ (ccin @ XM @ XN) @ (ccfv @ (ccin @ XA2 @ XB2) @ (ccfv @ XJ @ ccnei)))))))))).
