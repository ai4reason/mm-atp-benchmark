...
thf(af1rhm0to0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (ccfv @ XR @ ccbs)) => ((XB2 = (ccfv @ XS @ ccbs)) => ((XN = (ccfv @ XS @ cc0g)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cw3a @ (cwcel @ XF @ (cco @ XR @ XS @ ccrh)) @ (cwf1 @ XA2 @ XB2 @ XF) @ (cwcel @ XX @ XA2)) => (((ccfv @ XX @ XF) = XN) <=> (XX = Xc_0)))))))))))))))).
thf(crim0to0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (ccfv @ XR @ ccbs)) => ((XB2 = (ccfv @ XS @ ccbs)) => ((XN = (ccfv @ XS @ cc0g)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XF @ (cco @ XR @ XS @ ccrs)) & (cwcel @ XX @ XA2)) => (((ccfv @ XX @ XF) = XN) <=> (XX = Xc_0)))))))))))))))).
