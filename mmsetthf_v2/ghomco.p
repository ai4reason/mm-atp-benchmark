...
thf(cghomco_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (((cw3a @ (cwcel @ XG @ ccgr) @ (cwcel @ XH @ ccgr) @ (cwcel @ XK @ ccgr)) & ((cwcel @ XS @ (cco @ XG @ XH @ ccghomOLD)) & (cwcel @ XT @ (cco @ XH @ XK @ ccghomOLD)))) => (cwcel @ (cccom @ XT @ XS) @ (cco @ XG @ XK @ ccghomOLD))))))))).
