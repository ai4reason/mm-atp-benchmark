...
thf(ccdj3lem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > ($i > ($i > ($i > $o))))] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XT @ Xx3 @ Xz @ Xw) = (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccph)) @ (^ [Xx3:$i] : (ccrio @ (^ [Xw:$i] : (cwrex @ (^ [Xz:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xz) @ (ccv @ Xw) @ ccva))) @ (^ [Xz:$i] : XA2))) @ (^ [Xw:$i] : XB2)))))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : ((cw3a @ (cwcel @ XC @ XA2) @ (cwcel @ XD @ XB2) @ ((ccin @ XA2 @ XB2) = cc0h)) => ((ccfv @ (cco @ XC @ XD @ ccva) @ (XT @ Xx3 @ Xz @ Xw)) = XD)))))))))))))).
