...
thf(awlknwwlksnfun_ax,axiom,(! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xp:$i] : ((XT @ Xp) = (ccrab @ (^ [Xp:$i] : ((ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) = XN)) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks))))) => ((! [Xp:$i] : ((XW @ Xp) = (cco @ XN @ XG @ ccwwlksn))) => ((! [Xt:$i] : (! [Xp:$i] : ((XF @ Xt @ Xp) = (ccmpt @ (^ [Xt:$i] : (XT @ Xp)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ cc2nd)))))) => (! [Xt:$i] : (! [Xp:$i] : (((cwcel @ XG @ ccupgr) & (cwcel @ XN @ ccn0)) => (cwf @ (XT @ Xp) @ (XW @ Xp) @ (XF @ Xt @ Xp)))))))))))))).
...
thf(auspgr2wlkeq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ ((cwcel @ XG @ ccuspgr) & (cwcel @ XN @ ccn0)) @ ((cwcel @ XA2 @ (ccfv @ XG @ ccwlks)) & ((ccfv @ (ccfv @ XA2 @ cc1st) @ cchash) = XN)) @ ((cwcel @ XB2 @ (ccfv @ XG @ ccwlks)) & ((ccfv @ (ccfv @ XB2 @ cc1st) @ cchash) = XN))) => (((ccfv @ XA2 @ cc2nd) = (ccfv @ XB2 @ cc2nd)) => (XA2 = XB2)))))))).
...
thf(cwlknwwlksninj_conj,conjecture,(! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xp:$i] : ((XT @ Xp) = (ccrab @ (^ [Xp:$i] : ((ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) = XN)) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks))))) => ((! [Xp:$i] : ((XW @ Xp) = (cco @ XN @ XG @ ccwwlksn))) => ((! [Xt:$i] : (! [Xp:$i] : ((XF @ Xt @ Xp) = (ccmpt @ (^ [Xt:$i] : (XT @ Xp)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ cc2nd)))))) => (! [Xt:$i] : (! [Xp:$i] : (((cwcel @ XG @ ccuspgr) & (cwcel @ XN @ ccn0)) => (cwf1 @ (XT @ Xp) @ (XW @ Xp) @ (XF @ Xt @ Xp)))))))))))))).
