...
thf(cstoweidlem14_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XD:($i > $o)] : ((! [Xj:$i] : ((XA2 @ Xj) = (ccrab @ (^ [Xj:$i] : (cwbr @ (cco @ cc1 @ XD @ ccdiv) @ (ccv @ Xj) @ cclt)) @ (^ [Xj:$i] : ccn)))) => ((! [Xj:$i] : ((Xph @ Xj) => (cwcel @ XD @ ccrp))) => ((! [Xj:$i] : ((Xph @ Xj) => (cwbr @ XD @ cc1 @ cclt))) => (! [Xj:$i] : ((Xph @ Xj) => (cwrex @ (^ [Xk:$i] : ((cwbr @ cc1 @ (cco @ (ccv @ Xk) @ XD @ ccmul) @ cclt) & (cwbr @ (cco @ (cco @ (ccv @ Xk) @ XD @ ccmul) @ cc2 @ ccdiv) @ cc1 @ cclt))) @ (^ [Xk:$i] : ccn))))))))))).
