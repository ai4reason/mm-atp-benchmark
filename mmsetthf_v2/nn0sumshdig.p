...
thf(ann0sumshdiglem2_ax,axiom,(! [XL:($i > $o)] : ((cwcel @ XL @ ccn) => (cwral @ (^ [Xa:$i] : (((ccfv @ (ccv @ Xa) @ ccblen) = XL) => ((ccv @ Xa) = (ccsu @ (cco @ ccc0 @ XL @ ccfzo) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ (ccv @ Xa) @ (ccfv @ cc2 @ ccdig)) @ (cco @ cc2 @ (ccv @ Xk) @ ccexp) @ ccmul)))))) @ (^ [Xa:$i] : ccn0))))).
