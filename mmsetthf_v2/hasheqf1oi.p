...
thf(afiinfnf1o_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (~ (cwcel @ XB2 @ ccfn))) => (~ (? [Xf1:$i] : (cwf1o @ XA2 @ XB2 @ (ccv @ Xf1)))))))).
...
thf(af1ocnvb_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwrel @ XF) => ((cwf1o @ XA2 @ XB2 @ XF) <=> (cwf1o @ XB2 @ XA2 @ (cccnv @ XF)))))))).
...
thf(afocdmex_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwfo @ XA2 @ XB2 @ XF)) => (cwcel @ XB2 @ ccvv))))))).
