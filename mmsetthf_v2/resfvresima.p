...
thf(cresfvresima_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwfun @ XF)) => ((Xph => (cwss @ XS @ (ccdm @ XF))) => ((Xph => (cwcel @ XX @ XS)) => (Xph => ((ccfv @ (ccfv @ XX @ (ccres @ XF @ XS)) @ (ccres @ XH @ (ccima @ XF @ XS))) = (ccfv @ (ccfv @ XX @ XF) @ XH)))))))))))).
