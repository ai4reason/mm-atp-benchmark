...
thf(agen31_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:($i > $o)] : ((! [Xx3:$i] : (cwvd3 @ Xph @ Xps @ Xch @ (Xth @ Xx3))) => (cwvd3 @ Xph @ Xps @ Xch @ (! [Xx3:$i] : (Xth @ Xx3))))))))).
thf(ain3an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cwvd3 @ Xph @ Xps @ (Xch & Xth) @ Xta) => (cwvd3 @ Xph @ Xps @ Xch @ (Xth => Xta))))))))).
...
thf(aonfrALTlem3VD_ax,axiom,(! [Xx3:$i] : (! [Xa:$i] : (cwvd2 @ ((cwss @ (ccv @ Xa) @ ccon0) & (cwne @ (ccv @ Xa) @ cc0)) @ ((cwcel @ (ccv @ Xx3) @ (ccv @ Xa)) & (~ ((ccin @ (ccv @ Xa) @ (ccv @ Xx3)) = cc0))) @ (cwrex @ (^ [Xy1:$i] : ((ccin @ (ccin @ (ccv @ Xa) @ (ccv @ Xx3)) @ (ccv @ Xy1)) = cc0)) @ (^ [Xy1:$i] : (ccin @ (ccv @ Xa) @ (ccv @ Xx3)))))))).
...
thf(confrALTlem2VD_conj,conjecture,(! [Xx3:$i] : (! [Xa:$i] : (cwvd2 @ ((cwss @ (ccv @ Xa) @ ccon0) & (cwne @ (ccv @ Xa) @ cc0)) @ ((cwcel @ (ccv @ Xx3) @ (ccv @ Xa)) & (~ ((ccin @ (ccv @ Xa) @ (ccv @ Xx3)) = cc0))) @ (cwrex @ (^ [Xy1:$i] : ((ccin @ (ccv @ Xa) @ (ccv @ Xy1)) = cc0)) @ (^ [Xy1:$i] : (ccv @ Xa))))))).
