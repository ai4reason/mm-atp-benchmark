...
thf(cpsrbagsn_conj,conjecture,(! [XD:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xf1:$i] : ((XD @ Xx3 @ Xf1) = (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ XI @ ccmap)))))) => (! [Xx3:$i] : (! [Xf1:$i] : ((cwcel @ XI @ (XV @ Xx3 @ Xf1)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = XK) @ cc1 @ ccc0))) @ (XD @ Xx3 @ Xf1))))))))))).
