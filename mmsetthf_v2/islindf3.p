...
thf(cislindf3_conj,conjecture,(! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((XL = (ccfv @ XW @ ccsca)) => (((cwcel @ XW @ cclmod) & (cwcel @ XL @ ccnzr)) => ((cwbr @ XF @ XW @ cclindf) <=> ((cwf1 @ (ccdm @ XF) @ ccvv @ XF) & (cwcel @ (ccrn @ XF) @ (ccfv @ XW @ cclinds)))))))))).
