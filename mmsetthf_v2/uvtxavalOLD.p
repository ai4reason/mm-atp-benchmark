...
thf(cuvtxavalOLD_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : ((XV = (ccfv @ XG @ ccvtx)) => (! [Xv:$i] : (! [Xn:$i] : ((cwcel @ XG @ (XW @ Xv @ Xn)) => ((ccfv @ XG @ ccuvtx) = (ccrab @ (^ [Xv:$i] : (cwral @ (^ [Xn:$i] : (cwcel @ (ccv @ Xn) @ (cco @ XG @ (ccv @ Xv) @ ccnbgr))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV))))))))))).
