...
thf(aphp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwpss @ XB2 @ XA2)) => (~ (cwbr @ XA2 @ XB2 @ ccen)))))).
...
thf(cphp3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwpss @ XB2 @ XA2)) => (cwbr @ XB2 @ XA2 @ ccsdm))))).
