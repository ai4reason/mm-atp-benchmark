...
thf(aspc2ed_ax,axiom,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xch @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (cwnf @ (^ [Xy1:$i] : (Xch @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (((ccv @ Xx3) = XA2) & ((ccv @ Xy1) = XB2))) => ((Xps @ Xx3 @ Xy1) <=> (Xch @ Xx3 @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ XA2 @ (XV @ Xx3 @ Xy1)) & (cwcel @ XB2 @ (XW @ Xx3 @ Xy1)))) => ((Xch @ Xx3 @ Xy1) => (? [Xx3:$i] : (? [Xy1:$i] : (Xps @ Xx3 @ Xy1)))))))))))))))))).
...
thf(aexrot3_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : ((? [Xx3:$i] : (? [Xy1:$i] : (? [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))) <=> (? [Xy1:$i] : (? [Xz:$i] : (? [Xx3:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))))).
...
thf(ccnvoprabOLD_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (cwnf @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xy1 @ Xz @ Xa)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xa:$i] : (cwnf @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1 @ Xz @ Xa)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : (((ccv @ Xa) = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) => ((Xps @ Xx3 @ Xy1 @ Xz @ Xa) <=> (Xph @ Xx3 @ Xy1 @ Xz))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xa:$i] : ((Xps @ Xx3 @ Xy1 @ Xz @ Xa) => (cwcel @ (ccv @ Xa) @ (ccxp @ ccvv @ ccvv))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cccnv @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))))) = (ccopab @ (^ [Xz:$i] : (^ [Xa:$i] : (Xps @ Xx3 @ Xy1 @ Xz @ Xa)))))))))))))).
