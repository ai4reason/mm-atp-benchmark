...
thf(aabsmulgcd_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) => ((cco @ (cco @ XK @ XM @ ccmul) @ (cco @ XK @ XN @ ccmul) @ ccgcd) = (ccfv @ (cco @ XK @ (cco @ XM @ XN @ ccgcd) @ ccmul) @ ccabs))))))).
...
thf(ccoprmdvdsOLD_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) => (((cwbr @ XK @ (cco @ XM @ XN @ ccmul) @ ccdvds) & ((cco @ XK @ XM @ ccgcd) = cc1)) => (cwbr @ XK @ XN @ ccdvds))))))).
