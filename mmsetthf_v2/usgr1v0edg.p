...
thf(ausgr1v_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XG @ XW) & ((ccfv @ XG @ ccvtx) = (ccsn @ XA2))) => ((cwcel @ XG @ ccusgr) <=> ((ccfv @ XG @ cciedg) = cc0))))))).
...
thf(cusgr1v0edg_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XG @ XW) @ ((ccfv @ XG @ ccvtx) = (ccsn @ XA2)) @ (cwfun @ (ccfv @ XG @ cciedg))) => ((cwcel @ XG @ ccusgr) <=> ((ccfv @ XG @ ccedg) = cc0))))))).
