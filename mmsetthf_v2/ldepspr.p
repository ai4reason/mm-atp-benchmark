...
thf(alincvalpr_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XS = (ccfv @ XM @ ccsca)) => ((XR = (ccfv @ XS @ ccbs)) => ((Xc_x = (ccfv @ XM @ ccvsca)) => ((Xc_pl = (ccfv @ XM @ ccplusg)) => ((XF = (ccpr @ (ccop @ XV @ XX) @ (ccop @ XW @ XY))) => ((cw3a @ ((cwcel @ XM @ cclmod) & (cwne @ XV @ XW)) @ ((cwcel @ XV @ XB2) & (cwcel @ XX @ XR)) @ ((cwcel @ XW @ XB2) & (cwcel @ XY @ XR))) => ((cco @ XF @ (ccpr @ XV @ XW) @ (ccfv @ XM @ cclinc)) = (cco @ (cco @ XX @ XV @ Xc_x) @ (cco @ XY @ XW @ Xc_x) @ Xc_pl))))))))))))))))))))).
...
thf(aldepsprlem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XR = (ccfv @ XM @ ccsca)) => ((XS = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XZ = (ccfv @ XM @ cc0g)) => ((Xc_x = (ccfv @ XM @ ccvsca)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((XN = (ccfv @ XR @ ccminusg)) => (((cwcel @ XM @ cclmod) & (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XA2 @ XS))) => ((XX = (cco @ XA2 @ XY @ Xc_x)) => ((cco @ (cco @ Xc_1 @ XX @ Xc_x) @ (cco @ (ccfv @ XA2 @ XN) @ XY @ Xc_x) @ (ccfv @ XM @ ccplusg)) = XZ)))))))))))))))))))))))).
...
thf(amapprop_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XF = (ccpr @ (ccop @ XX @ XA2) @ (ccop @ XY @ XB2))) => ((cw3a @ ((cwcel @ XX @ XV) & (cwcel @ XA2 @ XR)) @ ((cwcel @ XY @ XV) & (cwcel @ XB2 @ XR)) @ ((cwne @ XX @ XY) & (cwcel @ XR @ XW))) => (cwcel @ XF @ (cco @ XR @ (ccpr @ XX @ XY) @ ccmap))))))))))))).
...
thf(cldepspr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XR = (ccfv @ XM @ ccsca)) => ((XS = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XZ = (ccfv @ XM @ cc0g)) => ((Xc_x = (ccfv @ XM @ ccvsca)) => (((cwcel @ XM @ cclmod) & (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwne @ XX @ XY))) => (((cwcel @ XA2 @ XS) & (XX = (cco @ XA2 @ XY @ Xc_x))) => (cwbr @ (ccpr @ XX @ XY) @ XM @ cclindeps)))))))))))))))))))).
