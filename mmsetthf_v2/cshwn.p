...
thf(a_0csh0_ax,axiom,(! [XN:($i > $o)] : ((cco @ cc0 @ XN @ cccsh) = cc0))).
...
thf(acshwmodn_ax,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ ccz)) => ((cco @ XW @ XN @ cccsh) = (cco @ XW @ (cco @ XN @ (ccfv @ XW @ cchash) @ ccmo) @ cccsh))))))).
...
thf(ccshwn_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ (ccword @ XV)) => ((cco @ XW @ (ccfv @ XW @ cchash) @ cccsh) = XW))))).
