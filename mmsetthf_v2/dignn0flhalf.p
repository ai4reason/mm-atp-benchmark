...
thf(ann0eo_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn0) | (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn0))))).
...
thf(adignn0ehalf_ax,axiom,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : ((cw3a @ (cwcel @ (cco @ XA2 @ cc2 @ ccdiv) @ ccn0) @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XI @ ccn0)) => ((cco @ (cco @ XI @ cc1 @ ccaddc) @ XA2 @ (ccfv @ cc2 @ ccdig)) = (cco @ XI @ (cco @ XA2 @ cc2 @ ccdiv) @ (ccfv @ cc2 @ ccdig))))))).
...
thf(azefldiv2_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccz)) => ((ccfv @ (cco @ XN @ cc2 @ ccdiv) @ ccfl) = (cco @ XN @ cc2 @ ccdiv))))).
...
thf(adignn0flhalflem2_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn) @ (cwcel @ XN @ ccn0)) => ((ccfv @ (cco @ XA2 @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ ccdiv) @ ccfl) = (ccfv @ (cco @ (ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ ccfl) @ (cco @ cc2 @ XN @ ccexp) @ ccdiv) @ ccfl)))))).
