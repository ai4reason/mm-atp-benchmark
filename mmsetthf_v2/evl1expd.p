...
thf(apwsmulg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XR @ XI @ ccpws)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xc_xb = (ccfv @ XY @ ccmg)) => ((Xc_x = (ccfv @ XR @ ccmg)) => ((((cwcel @ XR @ ccmnd) & (cwcel @ XI @ XV)) & (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XX @ XB2) @ (cwcel @ XA2 @ XI))) => ((ccfv @ XA2 @ (cco @ XN @ XX @ Xc_xb)) = (cco @ XN @ (ccfv @ XA2 @ XX) @ Xc_x)))))))))))))))))).
