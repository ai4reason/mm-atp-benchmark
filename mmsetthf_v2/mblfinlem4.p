...
thf(cmblfinlem4_conj,conjecture,(! [XA2:($i > $o)] : ((((cwss @ XA2 @ ccr) & (cwcel @ (ccfv @ XA2 @ ccovol) @ ccr)) & (cwcel @ XA2 @ (ccdm @ ccvol))) => ((ccfv @ XA2 @ ccovol) = (ccsup @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xb:$i] : ((cwss @ (ccv @ Xb) @ XA2) & ((ccv @ Xy1) = (ccfv @ (ccv @ Xb) @ ccvol)))) @ (^ [Xb:$i] : (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld))))) @ ccr @ cclt))))).
