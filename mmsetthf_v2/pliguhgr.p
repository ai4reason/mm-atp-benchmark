...
thf(an0lplig_ax,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ ccplig) => (~ (cwcel @ cc0 @ XG))))).
...
thf(aisuhgrop_ax,axiom,(! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XV @ XW) & (cwcel @ XE @ XX)) => ((cwcel @ (ccop @ XV @ XE) @ ccuhgr) <=> (cwf @ (ccdm @ XE) @ (ccdif @ (ccpw @ XV) @ (ccsn @ cc0)) @ XE)))))))).
