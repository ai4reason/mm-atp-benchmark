...
thf(afibp1_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccfib) = (cco @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ ccfib) @ (ccfv @ XN @ ccfib) @ ccaddc))))).
...
thf(afib1_ax,axiom,((ccfv @ cc1 @ ccfib) = cc1)).
thf(afib2_ax,axiom,((ccfv @ cc2 @ ccfib) = cc1)).
thf(a_1p1e2_ax,axiom,((cco @ cc1 @ cc1 @ ccaddc) = cc2)).
thf(cfib3_conj,conjecture,((ccfv @ cc3 @ ccfib) = cc2)).
