...
thf(aretos_ax,axiom,(cwcel @ ccrefld @ cctos)).
...
thf(areplusg_ax,axiom,(ccaddc = (ccfv @ ccrefld @ ccplusg))).
thf(arele2_ax,axiom,(ccle = (ccfv @ ccrefld @ ccple))).
...
thf(aisorng_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((XB2 = (ccfv @ XR @ ccbs)) => ((! [Xa:$i] : (! [Xb:$i] : ((Xc_0 @ Xa @ Xb) = (ccfv @ XR @ cc0g)))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xc_x @ Xa @ Xb) = (ccfv @ XR @ ccmulr)))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xc_le @ Xa @ Xb) = (ccfv @ XR @ ccple)))) => ((cwcel @ XR @ ccorng) <=> (cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XR @ ccogrp) @ (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (((cwbr @ (Xc_0 @ Xa @ Xb) @ (ccv @ Xa) @ (Xc_le @ Xa @ Xb)) & (cwbr @ (Xc_0 @ Xa @ Xb) @ (ccv @ Xb) @ (Xc_le @ Xa @ Xb))) => (cwbr @ (Xc_0 @ Xa @ Xb) @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (Xc_x @ Xa @ Xb)) @ (Xc_le @ Xa @ Xb)))) @ (^ [Xb:$i] : XB2))) @ (^ [Xa:$i] : XB2)))))))))))))).
