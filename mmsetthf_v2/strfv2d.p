...
thf(cstrfv2d_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XE = (ccslot @ (ccfv @ ccnx @ XE))) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwfun @ (cccnv @ (cccnv @ XS)))) => ((Xph => (cwcel @ (ccop @ (ccfv @ ccnx @ XE) @ XC) @ XS)) => ((Xph => (cwcel @ XC @ XW)) => (Xph => (XC = (ccfv @ XS @ XE))))))))))))))).
