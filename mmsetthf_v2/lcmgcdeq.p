...
thf(alcmid_ax,axiom,(! [XM:($i > $o)] : ((cwcel @ XM @ ccz) => ((cco @ XM @ XM @ cclcm) = (ccfv @ XM @ ccabs))))).
thf(ccaddc_tp,type,(ccaddc : ($i > $o))).
thf(cc1_tp,type,(cc1 : ($i > $o))).
thf(agcdid_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cco @ XN @ XN @ ccgcd) = (ccfv @ XN @ ccabs))))).
thf(aeqeq12d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((XA2 = XC) <=> (XB2 = XD))))))))))).
thf(aoveq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))).
thf(alcmabs_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ (ccfv @ XM @ ccabs) @ (ccfv @ XN @ ccabs) @ cclcm) = (cco @ XM @ XN @ cclcm)))))).
thf(agcdabs_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ (ccfv @ XM @ ccabs) @ (ccfv @ XN @ ccabs) @ ccgcd) = (cco @ XM @ XN @ ccgcd)))))).
thf(clcmgcdeq_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => (((cco @ XM @ XN @ cclcm) = (cco @ XM @ XN @ ccgcd)) <=> ((ccfv @ XM @ ccabs) = (ccfv @ XN @ ccabs))))))).
