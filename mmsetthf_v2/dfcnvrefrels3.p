...
thf(ainxpssidinxp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwss @ (ccin @ XR @ (ccxp @ XA2 @ XB2)) @ (ccin @ ccid @ (ccxp @ XA2 @ XB2))) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) => ((ccv @ Xx3) = (ccv @ Xy1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))).
thf(cdfcnvrefrels3_conj,conjecture,(cccnvrefrels = (ccrab @ (^ [Xr:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xr)) => ((ccv @ Xx3) = (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccrn @ (ccv @ Xr))))) @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xr))))) @ (^ [Xr:$i] : ccrels)))).
