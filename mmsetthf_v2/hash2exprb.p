...
thf(ahash2prde_ax,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XV @ XW) & ((ccfv @ XV @ cchash) = cc2)) => (? [Xa:$i] : (? [Xb:$i] : ((cwne @ (ccv @ Xa) @ (ccv @ Xb)) & (XV = (ccpr @ (ccv @ Xa) @ (ccv @ Xb)))))))))).
...
thf(chash2exprb_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XV @ XW) => (((ccfv @ XV @ cchash) = cc2) <=> (? [Xa:$i] : (? [Xb:$i] : ((cwne @ (ccv @ Xa) @ (ccv @ Xb)) & (XV = (ccpr @ (ccv @ Xa) @ (ccv @ Xb))))))))))).
