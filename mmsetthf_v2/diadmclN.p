...
thf(cdiadmclN_conj,conjecture,(! [XB2:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdia))) => ((((cwcel @ XK @ XV) & (cwcel @ XW @ XH)) & (cwcel @ XX @ (ccdm @ XI))) => (cwcel @ XX @ XB2))))))))))))).
