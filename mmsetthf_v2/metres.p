...
thf(ametreslem_ax,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((ccdm @ XD) = (ccxp @ XX @ XX)) => ((ccres @ XD @ (ccxp @ XR @ XR)) = (ccres @ XD @ (ccxp @ (ccin @ XX @ XR) @ (ccin @ XX @ XR))))))))).
...
thf(cmetres_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ (ccfv @ XX @ ccme)) => (cwcel @ (ccres @ XD @ (ccxp @ XR @ XR)) @ (ccfv @ (ccin @ XX @ XR) @ ccme))))))).
