...
thf(aelab4g_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> Xps))) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccab @ (^ [Xx3:$i] : (Xph @ Xx3))))) => (! [Xx3:$i] : ((cwcel @ XA2 @ (XB2 @ Xx3)) <=> ((cwcel @ XA2 @ ccvv) & Xps)))))))))).
...
thf(aoveqdr_b_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xx3:$i] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (XF = XG)) => ((Xph & Xps) => ((cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ XF) = (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ XG)))))))))).
thf(adf_trkgc_ax,axiom,(ccstrkgc = (ccab @ (^ [Xf1:$i] : (cwsbc @ (^ [Xp:$i] : (cwsbc @ (^ [Xd:$i] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xd)) = (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccv @ Xd)))) @ (^ [Xy1:$i] : (ccv @ Xp)))) @ (^ [Xx3:$i] : (ccv @ Xp))) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xd)) = (cco @ (ccv @ Xz) @ (ccv @ Xz) @ (ccv @ Xd))) => ((ccv @ Xx3) = (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccv @ Xp)))) @ (^ [Xy1:$i] : (ccv @ Xp)))) @ (^ [Xx3:$i] : (ccv @ Xp))))) @ (ccfv @ (ccv @ Xf1) @ ccds))) @ (ccfv @ (ccv @ Xf1) @ ccbs)))))).
thf(cistrkgc_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (XP = (ccfv @ (XG @ Xx3 @ Xy1 @ Xz) @ ccbs))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xc_mi = (ccfv @ (XG @ Xx3 @ Xy1 @ Xz) @ ccds))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (XI = (ccfv @ (XG @ Xx3 @ Xy1 @ Xz) @ ccitv))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ (XG @ Xx3 @ Xy1 @ Xz) @ ccstrkgc) <=> ((cwcel @ (XG @ Xx3 @ Xy1 @ Xz) @ ccvv) & ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_mi) = (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ Xc_mi))) @ (^ [Xy1:$i] : XP))) @ (^ [Xx3:$i] : XP)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_mi) = (cco @ (ccv @ Xz) @ (ccv @ Xz) @ Xc_mi)) => ((ccv @ Xx3) = (ccv @ Xy1)))) @ (^ [Xz:$i] : XP))) @ (^ [Xy1:$i] : XP))) @ (^ [Xx3:$i] : XP)))))))))))))))).
