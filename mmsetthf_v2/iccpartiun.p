...
thf(ciccpartiun_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XP @ (ccfv @ XM @ cciccp))) => (Xph => ((cco @ (ccfv @ ccc0 @ XP) @ (ccfv @ XM @ XP) @ ccico) = (cciun @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfzo)) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP) @ ccico))))))))))).
