...
thf(clplni2_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XP = (ccfv @ XK @ cclpl)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwcel @ XQ @ XA2) @ (cwcel @ XR @ XA2) @ (cwcel @ XS @ XA2)) @ ((cwne @ XQ @ XR) & (~ (cwbr @ XS @ (cco @ XQ @ XR @ Xc_or) @ Xc_le)))) => (cwcel @ (cco @ (cco @ XQ @ XR @ Xc_or) @ XS @ Xc_or) @ XP))))))))))))))).
