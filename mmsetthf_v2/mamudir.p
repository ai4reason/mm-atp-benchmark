...
thf(amndvcl_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_pl = (ccfv @ XM @ ccplusg)) => ((cw3a @ (cwcel @ XM @ ccmnd) @ (cwcel @ XX @ (cco @ XB2 @ XI @ ccmap)) @ (cwcel @ XY @ (cco @ XB2 @ XI @ ccmap))) => (cwcel @ (cco @ XX @ XY @ (ccof @ Xc_pl)) @ (cco @ XB2 @ XI @ ccmap)))))))))))).
