...
thf(cispgp_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : ((! [Xn:$i] : ((XX @ Xn) = (ccfv @ XG @ ccbs))) => ((! [Xx3:$i] : (! [Xn:$i] : ((XO @ Xx3 @ Xn) = (ccfv @ XG @ ccod)))) => (! [Xn:$i] : ((cwbr @ XP @ XG @ ccpgp) <=> (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XG @ ccgrp) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xn:$i] : ((ccfv @ (ccv @ Xx3) @ (XO @ Xx3 @ Xn)) = (cco @ XP @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn0))) @ (^ [Xx3:$i] : (XX @ Xn))))))))))))).
