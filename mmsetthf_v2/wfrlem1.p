...
thf(cwfrlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XB2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xf1 @ Xg1) = (ccab @ (^ [Xf1:$i] : (? [Xx3:$i] : (cw3a @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) @ ((cwss @ (ccv @ Xx3) @ XA2) & (cwral @ (^ [Xy1:$i] : (cwss @ (ccpred @ XA2 @ XR @ (ccv @ Xy1)) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) = (ccfv @ (ccres @ (ccv @ Xf1) @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ XF))) @ (^ [Xy1:$i] : (ccv @ Xx3)))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XB2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xf1 @ Xg1) = (ccab @ (^ [Xg1:$i] : (? [Xz:$i] : (cw3a @ (cwfn @ (ccv @ Xg1) @ (ccv @ Xz)) @ ((cwss @ (ccv @ Xz) @ XA2) & (cwral @ (^ [Xw:$i] : (cwss @ (ccpred @ XA2 @ XR @ (ccv @ Xw)) @ (ccv @ Xz))) @ (^ [Xw:$i] : (ccv @ Xz)))) @ (cwral @ (^ [Xw:$i] : ((ccfv @ (ccv @ Xw) @ (ccv @ Xg1)) = (ccfv @ (ccres @ (ccv @ Xg1) @ (ccpred @ XA2 @ XR @ (ccv @ Xw))) @ XF))) @ (^ [Xw:$i] : (ccv @ Xz)))))))))))))))))))).
