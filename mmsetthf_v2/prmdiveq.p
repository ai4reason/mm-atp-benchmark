...
thf(cprmdiveq_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((XR = (cco @ (cco @ XA2 @ (cco @ XP @ cc2 @ ccmin) @ ccexp) @ XP @ ccmo)) => ((cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ ccz) @ (~ (cwbr @ XP @ XA2 @ ccdvds))) => (((cwcel @ XS @ (cco @ ccc0 @ (cco @ XP @ cc1 @ ccmin) @ ccfz)) & (cwbr @ XP @ (cco @ (cco @ XA2 @ XS @ ccmul) @ cc1 @ ccmin) @ ccdvds)) <=> (XS = XR))))))))).
