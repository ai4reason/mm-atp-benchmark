...
thf(aprodsn_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((! [Xk:$i] : (((ccv @ Xk) = XM) => ((XA2 @ Xk) = XB2))) => (((cwcel @ XM @ XV) & (cwcel @ XB2 @ ccc)) => ((ccprod @ (^ [Xk:$i] : (ccsn @ XM)) @ (^ [Xk:$i] : (XA2 @ Xk))) = XB2)))))))).
...
thf(aixpeq2_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwral @ (^ [Xx3:$i] : ((XB2 @ Xx3) = (XC @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((ccixp @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (ccixp @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3))))))))).
...
thf(aelixpsn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XF @ (ccixp @ (^ [Xx3:$i] : (ccsn @ XA2)) @ (^ [Xx3:$i] : XB2))) <=> (cwrex @ (^ [Xy1:$i] : (XF = (ccsn @ (ccop @ XA2 @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : XB2))))))))).
...
thf(asneqr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (((ccsn @ XA2) = (ccsn @ XB2)) => (XA2 = XB2)))))).
...
thf(choidmv1le_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XX:($i > ($i > $o))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XL @ Xx3 @ Xj @ Xk @ Xa @ Xb) = (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ ((ccv @ Xx3) = cc0) @ ccc0 @ (ccprod @ (^ [Xk:$i] : (ccv @ Xx3)) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xb)) @ ccico) @ ccvol))))))))))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xk) => (cwcel @ (XZ @ Xa @ Xb) @ (XV @ Xx3 @ Xj @ Xa @ Xb)))))))) => ((! [Xj:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XX @ Xj) = (ccsn @ (XZ @ Xa @ Xb)))))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xk) => (cwf @ (XX @ Xj) @ ccr @ XA2)))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xk) => (cwf @ (XX @ Xj) @ ccr @ XB2)))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xk) => (cwf @ ccn @ (cco @ ccr @ (XX @ Xj) @ ccmap) @ XC)))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xk) => (cwf @ ccn @ (cco @ ccr @ (XX @ Xj) @ ccmap) @ XD)))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xk) => (cwss @ (ccixp @ (^ [Xk:$i] : (XX @ Xj)) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (ccv @ Xk) @ XB2) @ ccico))) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : (XX @ Xj)) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ XC)) @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ XD)) @ ccico))))))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xk) => (cwbr @ (cco @ XA2 @ XB2 @ (ccfv @ (XX @ Xj) @ (XL @ Xx3 @ Xj @ Xk @ Xa @ Xb))) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (cco @ (ccfv @ (ccv @ Xj) @ XC) @ (ccfv @ (ccv @ Xj) @ XD) @ (ccfv @ (XX @ Xj) @ (XL @ Xx3 @ Xj @ Xk @ Xa @ Xb))))) @ ccsumge0) @ ccle))))))))))))))))))))))))).
