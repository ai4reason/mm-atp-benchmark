...
thf(asyl5breq_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((cwbr @ XA2 @ XB2 @ XR) => ((Xph => (XB2 = XC)) => (Xph => (cwbr @ XA2 @ XC @ XR)))))))))).
...
thf(adipsubdi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XM = (ccfv @ XU @ ccnsb)) => ((XP = (ccfv @ XU @ ccdip)) => (((cwcel @ XU @ cccphlo) & (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX))) => ((cco @ XA2 @ (cco @ XB2 @ XC @ XM) @ XP) = (cco @ (cco @ XA2 @ XB2 @ XP) @ (cco @ XA2 @ XC @ XP) @ ccmin)))))))))))))).
...
thf(adipass_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XS = (ccfv @ XU @ ccns)) => ((XP = (ccfv @ XU @ ccdip)) => (((cwcel @ XU @ cccphlo) & (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX))) => ((cco @ (cco @ XA2 @ XB2 @ XS) @ XC @ XP) = (cco @ XA2 @ (cco @ XB2 @ XC @ XP) @ ccmul)))))))))))))).
thf(adipassr2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XS = (ccfv @ XU @ ccns)) => ((XP = (ccfv @ XU @ ccdip)) => (((cwcel @ XU @ cccphlo) & (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ XX))) => ((cco @ XA2 @ (cco @ (ccfv @ XB2 @ cccj) @ XC @ XS) @ XP) = (cco @ XB2 @ (cco @ XA2 @ XC @ XP) @ ccmul)))))))))))))).
...
thf(asub4_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) & ((cwcel @ XC @ ccc) & (cwcel @ XD @ ccc))) => ((cco @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XD @ ccmin) @ ccmin) = (cco @ (cco @ XA2 @ XC @ ccmin) @ (cco @ XB2 @ XD @ ccmin) @ ccmin)))))))).
...
thf(asubge0i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmin) @ ccle) <=> (cwbr @ XB2 @ XA2 @ ccle))))))).
...
thf(asqrtlei_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => (((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ ccc0 @ XB2 @ ccle)) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwbr @ (ccfv @ XA2 @ ccsqrt) @ (ccfv @ XB2 @ ccsqrt) @ ccle)))))))).
...
thf(asqrtsqi_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwbr @ ccc0 @ XA2 @ ccle) => ((ccfv @ (cco @ XA2 @ cc2 @ ccexp) @ ccsqrt) = XA2))))).
thf(csiilem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XN = (ccfv @ XU @ ccnmcv)) => ((XP = (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => ((cwcel @ XA2 @ XX) => ((cwcel @ XB2 @ XX) => ((XM = (ccfv @ XU @ ccnsb)) => ((XS = (ccfv @ XU @ ccns)) => ((cwcel @ XC @ ccc) => ((cwcel @ (cco @ XC @ (cco @ XA2 @ XB2 @ XP) @ ccmul) @ ccr) => ((cwbr @ ccc0 @ (cco @ XC @ (cco @ XA2 @ XB2 @ XP) @ ccmul) @ ccle) => (((cco @ XB2 @ XA2 @ XP) = (cco @ XC @ (cco @ (ccfv @ XB2 @ XN) @ cc2 @ ccexp) @ ccmul)) => (cwbr @ (ccfv @ (cco @ (cco @ XA2 @ XB2 @ XP) @ (cco @ XC @ (cco @ (ccfv @ XB2 @ XN) @ cc2 @ ccexp) @ ccmul) @ ccmul) @ ccsqrt) @ (cco @ (ccfv @ XA2 @ XN) @ (ccfv @ XB2 @ XN) @ ccmul) @ ccle))))))))))))))))))))))).
