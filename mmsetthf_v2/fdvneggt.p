...
thf(afdvposlt_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (XE = (cco @ (XC @ Xx3) @ (XD @ Xx3) @ ccioo))) => ((Xph => (cwcel @ XA2 @ XE)) => ((Xph => (cwcel @ XB2 @ XE)) => ((Xph => (cwf @ XE @ ccr @ XF)) => ((Xph => (cwcel @ (cco @ ccr @ XF @ ccdv) @ (cco @ XE @ ccr @ cccncf))) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccioo))) => (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) @ cclt))) => (Xph => (cwbr @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ cclt))))))))))))))))).
...
thf(cfdvneggt_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (XE = (cco @ (XC @ Xx3) @ (XD @ Xx3) @ ccioo))) => ((Xph => (cwcel @ XA2 @ XE)) => ((Xph => (cwcel @ XB2 @ XE)) => ((Xph => (cwf @ XE @ ccr @ XF)) => ((Xph => (cwcel @ (cco @ ccr @ XF @ ccdv) @ (cco @ XE @ ccr @ cccncf))) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccioo))) => (cwbr @ (ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) @ ccc0 @ cclt))) => (Xph => (cwbr @ (ccfv @ XB2 @ XF) @ (ccfv @ XA2 @ XF) @ cclt))))))))))))))))).
