...
thf(cnmfnleub_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (((cwf @ cchil @ ccc @ XT) & (cwcel @ XA2 @ ccxr)) => ((cwbr @ (ccfv @ XT @ ccnmf) @ XA2 @ ccle) <=> (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccfv @ (ccv @ Xx3) @ ccno) @ cc1 @ ccle) => (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XT) @ ccabs) @ XA2 @ ccle))) @ (^ [Xx3:$i] : cchil))))))).
