...
thf(clrelat_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_po:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((XS = (ccfv @ XW @ cclss)) => ((! [Xq:$i] : ((Xc_po @ Xq) = (ccfv @ XW @ cclsm))) => ((XA2 = (ccfv @ XW @ cclsa)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XT @ XS)) => ((Xph => (cwcel @ XU @ XS)) => ((Xph => (cwpss @ XT @ XU)) => (Xph => (cwrex @ (^ [Xq:$i] : ((cwpss @ XT @ (cco @ XT @ (ccv @ Xq) @ (Xc_po @ Xq))) & (cwss @ (cco @ XT @ (ccv @ Xq) @ (Xc_po @ Xq)) @ XU))) @ (^ [Xq:$i] : XA2)))))))))))))))))).
