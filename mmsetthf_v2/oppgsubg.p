...
thf(aoppggrpb_ax,axiom,(! [XR:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XR @ ccoppg)) => ((cwcel @ XR @ ccgrp) <=> (cwcel @ XO @ ccgrp)))))).
...
thf(coppgsubg_conj,conjecture,(! [XG:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XG @ ccoppg)) => ((ccfv @ XG @ ccsubg) = (ccfv @ XO @ ccsubg)))))).
