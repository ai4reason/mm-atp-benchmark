...
thf(cvdwlem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XV @ ccn)) => ((Xph => (cwcel @ XW @ ccn)) => ((Xph => (cwcel @ XA2 @ (cco @ cc1 @ XV @ ccfz))) => ((Xph => (cwcel @ XB2 @ (cco @ cc1 @ XW @ ccfz))) => (Xph => (cwcel @ (cco @ XB2 @ (cco @ XW @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ XV @ ccaddc) @ ccmul) @ ccaddc) @ (cco @ cc1 @ (cco @ XW @ (cco @ cc2 @ XV @ ccmul) @ ccmul) @ ccfz))))))))))))).
