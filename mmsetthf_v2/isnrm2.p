...
thf(anrmtop_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ ccnrm) => (cwcel @ XJ @ cctop)))).
...
thf(anrmsep2_ax,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (((cwcel @ XJ @ ccnrm) & (cw3a @ (cwcel @ XC @ (ccfv @ XJ @ cccld)) @ (cwcel @ XD @ (ccfv @ XJ @ cccld)) @ ((ccin @ XC @ XD) = cc0))) => (cwrex @ (^ [Xx3:$i] : ((cwss @ XC @ (ccv @ Xx3)) & ((ccin @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XJ @ cccl)) @ XD) = cc0))) @ (^ [Xx3:$i] : XJ))))))).
...
thf(cisnrm2_conj,conjecture,(! [XJ:($i > $o)] : ((cwcel @ XJ @ ccnrm) <=> ((cwcel @ XJ @ cctop) & (cwral @ (^ [Xc:$i] : (cwral @ (^ [Xd:$i] : (((ccin @ (ccv @ Xc) @ (ccv @ Xd)) = cc0) => (cwrex @ (^ [Xo:$i] : ((cwss @ (ccv @ Xc) @ (ccv @ Xo)) & ((ccin @ (ccfv @ (ccv @ Xo) @ (ccfv @ XJ @ cccl)) @ (ccv @ Xd)) = cc0))) @ (^ [Xo:$i] : XJ)))) @ (^ [Xd:$i] : (ccfv @ XJ @ cccld)))) @ (^ [Xc:$i] : (ccfv @ XJ @ cccld))))))).
