...
thf(cfzocatel_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ (cco @ ccc0 @ (cco @ XB2 @ XC @ ccaddc) @ ccfzo)) & (~ (cwcel @ XA2 @ (cco @ ccc0 @ XB2 @ ccfzo)))) & ((cwcel @ XB2 @ ccz) & (cwcel @ XC @ ccz))) => (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ ccc0 @ XC @ ccfzo))))))).
