...
thf(asummodnegmod_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XN @ ccn)) => (((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XN @ ccmo) = ccc0) <=> ((cco @ XA2 @ XN @ ccmo) = (cco @ (ccneg @ XB2) @ XN @ ccmo)))))))).
...
thf(aodz2prm2pw_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XN @ ccn) & (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) & ((cwne @ (cco @ (cco @ cc2 @ (cco @ cc2 @ XN @ ccexp) @ ccexp) @ XP @ ccmo) @ cc1) & ((cco @ (cco @ cc2 @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ ccexp) @ XP @ ccmo) = cc1))) => ((ccfv @ cc2 @ (ccfv @ XP @ ccodz)) = (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp)))))).
thf(cfmtnoprmfac1lem_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (cwbr @ XP @ (ccfv @ XN @ ccfmtno) @ ccdvds)) => ((ccfv @ cc2 @ (ccfv @ XP @ ccodz)) = (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp)))))).
