...
thf(agzrngunitlem_ax,axiom,(! [XA2:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (cco @ cccnfld @ ccgz @ ccress)) => ((cwcel @ XA2 @ (ccfv @ XZ @ ccui)) => (cwbr @ cc1 @ (ccfv @ XA2 @ ccabs) @ ccle)))))).
...
thf(agzcjcl_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccgz) => (cwcel @ (ccfv @ XA2 @ cccj) @ ccgz)))).
...
thf(cgzrngunit_conj,conjecture,(! [XA2:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (cco @ cccnfld @ ccgz @ ccress)) => ((cwcel @ XA2 @ (ccfv @ XZ @ ccui)) <=> ((cwcel @ XA2 @ ccgz) & ((ccfv @ XA2 @ ccabs) = cc1))))))).
