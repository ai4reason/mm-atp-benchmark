...
thf(adivcxpd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => (cwcel @ XC @ ccc)) => (Xph => ((cco @ (cco @ XA2 @ XB2 @ ccdiv) @ XC @ cccxp) = (cco @ (cco @ XA2 @ XC @ cccxp) @ (cco @ XB2 @ XC @ cccxp) @ ccdiv)))))))))))).
...
thf(arlimcxp_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ XA2)) => (cwcel @ (XB2 @ Xn) @ (XV @ Xn)))) => ((Xph => (cwbr @ (ccmpt @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (XB2 @ Xn))) @ ccc0 @ ccrli)) => ((Xph => (cwcel @ XC @ ccrp)) => (Xph => (cwbr @ (ccmpt @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (cco @ (XB2 @ Xn) @ XC @ cccxp))) @ ccc0 @ ccrli))))))))))).
...
thf(acxp2limlem_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ cc1 @ XA2 @ cclt)) => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccrp) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (cco @ XA2 @ (ccv @ Xn) @ cccxp) @ ccdiv))) @ ccc0 @ ccrli)))).
...
thf(ccxp2lim_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ cc1 @ XB2 @ cclt)) => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccrp) @ (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xn) @ XA2 @ cccxp) @ (cco @ XB2 @ (ccv @ Xn) @ cccxp) @ ccdiv))) @ ccc0 @ ccrli))))).
