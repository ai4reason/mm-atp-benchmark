...
thf(apjssmii_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => ((cwcel @ XG @ ccch) => ((cwss @ XH @ XG) => ((cco @ (ccfv @ XA2 @ (ccfv @ XG @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccmv) = (ccfv @ XA2 @ (ccfv @ (ccin @ XG @ (ccfv @ XH @ ccort)) @ ccpjh))))))))))).
