...
thf(ambfconst_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ XB2 @ ccc)) => (cwcel @ (ccxp @ XA2 @ (ccsn @ XB2)) @ ccmbf))))).
...
thf(cmbfmulc2lem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwf @ XA2 @ ccr @ XF)) => (Xph => (cwcel @ (cco @ (ccxp @ XA2 @ (ccsn @ XB2)) @ XF @ (ccof @ ccmul)) @ ccmbf)))))))))).
