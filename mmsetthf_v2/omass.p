...
thf(aomordi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XB2 @ ccon0) & (cwcel @ XC @ ccon0)) & (cwcel @ cc0 @ XC)) => ((cwcel @ XA2 @ XB2) => (cwcel @ (cco @ XC @ XA2 @ ccomu) @ (cco @ XC @ XB2 @ ccomu)))))))).
...
thf(aomordlim_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [Xx3:$i] : ((((cwcel @ XA2 @ ccon0) & ((cwcel @ XB2 @ (XD @ Xx3)) & (cwlim @ XB2))) & (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccomu))) => (cwrex @ (^ [Xx3:$i] : (cwcel @ XC @ (cco @ XA2 @ (ccv @ Xx3) @ ccomu))) @ (^ [Xx3:$i] : XB2))))))))).
...
thf(aexp4d_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => ((Xps & (Xch & Xth)) => Xta)) => (Xph => (Xps => (Xch => (Xth => Xta))))))))))).
...
thf(ampanlr1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (Xps => ((((Xph & (Xps & Xch)) & Xth) => Xta) => (((Xph & Xch) & Xth) => Xta))))))))).
thf(cc1o_tp,type,(cc1o : ($i > $o))).
thf(aomlimcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccon0) & ((cwcel @ XB2 @ XC) & (cwlim @ XB2))) & (cwcel @ cc0 @ XA2)) => (cwlim @ (cco @ XA2 @ XB2 @ ccomu))))))).
...
thf(anecon2bbid_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (Xps <=> (cwne @ XA2 @ XB2))) => (Xph => ((XA2 = XB2) <=> (~ Xps))))))))).
...
thf(aom0r_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cco @ cc0 @ XA2 @ ccomu) = cc0)))).
thf(asylan9eq_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xps => (XB2 = XC)) => ((Xph & Xps) => (XA2 = XC)))))))))).
thf(comass_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) => ((cco @ (cco @ XA2 @ XB2 @ ccomu) @ XC @ ccomu) = (cco @ XA2 @ (cco @ XB2 @ XC @ ccomu) @ ccomu))))))).
