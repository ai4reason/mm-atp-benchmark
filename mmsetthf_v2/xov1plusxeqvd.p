...
thf(cxov1plusxeqvd_conj,conjecture,(! [Xph:$o] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (cwne @ XX @ (ccneg @ cc1))) => (Xph => ((cwcel @ XX @ ccrp) <=> (cwcel @ (cco @ XX @ (cco @ cc1 @ XX @ ccaddc) @ ccdiv) @ (cco @ ccc0 @ cc1 @ ccioo))))))))).
