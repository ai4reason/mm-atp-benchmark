...
thf(aabs2sqlti_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwbr @ (ccfv @ XA2 @ ccabs) @ (ccfv @ XB2 @ ccabs) @ cclt) <=> (cwbr @ (cco @ (ccfv @ XA2 @ ccabs) @ cc2 @ ccexp) @ (cco @ (ccfv @ XB2 @ ccabs) @ cc2 @ ccexp) @ cclt))))))).
...
thf(cabs2sqlt_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cwbr @ (ccfv @ XA2 @ ccabs) @ (ccfv @ XB2 @ ccabs) @ cclt) <=> (cwbr @ (cco @ (ccfv @ XA2 @ ccabs) @ cc2 @ ccexp) @ (cco @ (ccfv @ XB2 @ ccabs) @ cc2 @ ccexp) @ cclt)))))).
