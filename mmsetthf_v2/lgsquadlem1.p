...
thf(clgsquadlem1_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((Xph => (cwcel @ XQ @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((Xph => (cwne @ XP @ XQ)) => ((XM = (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((XN = (cco @ (cco @ XQ @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((XS = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (cco @ cc1 @ XM @ ccfz)) & (cwcel @ (ccv @ Xy1) @ (cco @ cc1 @ XN @ ccfz))) & (cwbr @ (cco @ (ccv @ Xy1) @ XP @ ccmul) @ (cco @ (ccv @ Xx3) @ XQ @ ccmul) @ cclt)))))) => (Xph => ((cco @ (ccneg @ cc1) @ (ccsu @ (cco @ (cco @ (ccfv @ (cco @ XM @ cc2 @ ccdiv) @ ccfl) @ cc1 @ ccaddc) @ XM @ ccfz) @ (^ [Xu:$i] : (ccfv @ (cco @ (cco @ XQ @ XP @ ccdiv) @ (cco @ cc2 @ (ccv @ Xu) @ ccmul) @ ccmul) @ ccfl))) @ ccexp) = (cco @ (ccneg @ cc1) @ (ccfv @ (ccrab @ (^ [Xz:$i] : (~ (cwbr @ cc2 @ (ccfv @ (ccv @ Xz) @ cc1st) @ ccdvds))) @ (^ [Xz:$i] : XS)) @ cchash) @ ccexp)))))))))))))))).
