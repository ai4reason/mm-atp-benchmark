...
thf(ais1stc2_ax,axiom,(! [XJ:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XX @ Xy1 @ Xz @ Xw) = (ccuni @ (XJ @ Xw)))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((cwcel @ (XJ @ Xw) @ cc1stc) <=> ((cwcel @ (XJ @ Xw) @ cctop) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ ccom @ ccdom) & (cwral @ (^ [Xz:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xz)) => (cwrex @ (^ [Xw:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xw)) & (cwss @ (ccv @ Xw) @ (ccv @ Xz)))) @ (^ [Xw:$i] : (ccv @ Xy1))))) @ (^ [Xz:$i] : (XJ @ Xw))))) @ (^ [Xy1:$i] : (ccpw @ (XJ @ Xw))))) @ (^ [Xx3:$i] : (XX @ Xy1 @ Xz @ Xw)))))))))))).
