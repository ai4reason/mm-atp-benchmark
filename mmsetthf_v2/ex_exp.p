...
thf(asq4e2t8_ax,axiom,((cco @ cc4 @ cc2 @ ccexp) = (cco @ cc2 @ cc8 @ ccmul))).
...
thf(cex_exp_conj,conjecture,(((cco @ cc5 @ cc2 @ ccexp) = (ccdc @ cc2 @ cc5)) & ((cco @ (ccneg @ cc3) @ (ccneg @ cc2) @ ccexp) = (cco @ cc1 @ cc9 @ ccdiv)))).
