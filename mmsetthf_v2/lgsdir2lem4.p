...
thf(algsdir2lem1_ax,axiom,((((cco @ cc1 @ cc8 @ ccmo) = cc1) & ((cco @ (ccneg @ cc1) @ cc8 @ ccmo) = cc7)) & (((cco @ cc3 @ cc8 @ ccmo) = cc3) & ((cco @ (ccneg @ cc3) @ cc8 @ ccmo) = cc5)))).
thf(ccfl_tp,type,(ccfl : ($i > $o))).
thf(ccdiv_tp,type,(ccdiv : ($i > $o))).
thf(amodmul1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cw3a @ ((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) @ ((cwcel @ XC @ ccz) & (cwcel @ XD @ ccrp)) @ ((cco @ XA2 @ XD @ ccmo) = (cco @ XB2 @ XD @ ccmo))) => ((cco @ (cco @ XA2 @ XC @ ccmul) @ XD @ ccmo) = (cco @ (cco @ XB2 @ XC @ ccmul) @ XD @ ccmo)))))))).
...
thf(clgsdir2lem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) & (cwcel @ (cco @ XA2 @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7))) => ((cwcel @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)) <=> (cwcel @ (cco @ XB2 @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7))))))).
