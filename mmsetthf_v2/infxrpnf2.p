...
thf(ainfxrpnf_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => ((ccinf @ (ccun @ XA2 @ (ccsn @ ccpnf)) @ ccxr @ cclt) = (ccinf @ XA2 @ ccxr @ cclt))))).
...
thf(cinfxrpnf2_conj,conjecture,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => ((ccinf @ (ccdif @ XA2 @ (ccsn @ ccpnf)) @ ccxr @ cclt) = (ccinf @ XA2 @ ccxr @ cclt))))).
