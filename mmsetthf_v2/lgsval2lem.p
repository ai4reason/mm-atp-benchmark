...
thf(aseqid3_ax,axiom,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => ((cco @ XZ @ XZ @ Xc_pl) = XZ)) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XM @ XN @ ccfz))) => ((ccfv @ (ccv @ Xx3) @ XF) = XZ))) => (Xph => ((ccfv @ XN @ (ccseq @ Xc_pl @ XF @ XM)) = XZ)))))))))))).
...
thf(algsfval_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (ccif @ ((ccv @ Xn) = cc2) @ (ccif @ (cwbr @ cc2 @ XA2 @ ccdvds) @ ccc0 @ (ccif @ (cwcel @ (cco @ XA2 @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)) @ cc1 @ (ccneg @ cc1))) @ (cco @ (cco @ (cco @ (cco @ XA2 @ (cco @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ cc1 @ ccaddc) @ (ccv @ Xn) @ ccmo) @ cc1 @ ccmin)) @ (cco @ (ccv @ Xn) @ XN @ ccpc) @ ccexp) @ cc1))))) => (! [Xn:$i] : ((cwcel @ XM @ ccn) => ((ccfv @ XM @ (XF @ Xn)) = (ccif @ (cwcel @ XM @ ccprime) @ (cco @ (ccif @ (XM = cc2) @ (ccif @ (cwbr @ cc2 @ XA2 @ ccdvds) @ ccc0 @ (ccif @ (cwcel @ (cco @ XA2 @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)) @ cc1 @ (ccneg @ cc1))) @ (cco @ (cco @ (cco @ (cco @ XA2 @ (cco @ (cco @ XM @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ cc1 @ ccaddc) @ XM @ ccmo) @ cc1 @ ccmin)) @ (cco @ XM @ XN @ ccpc) @ ccexp) @ cc1)))))))))).
...
thf(algsfcl_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (ccif @ ((ccv @ Xn) = cc2) @ (ccif @ (cwbr @ cc2 @ XA2 @ ccdvds) @ ccc0 @ (ccif @ (cwcel @ (cco @ XA2 @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)) @ cc1 @ (ccneg @ cc1))) @ (cco @ (cco @ (cco @ (cco @ XA2 @ (cco @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ cc1 @ ccaddc) @ (ccv @ Xn) @ ccmo) @ cc1 @ ccmin)) @ (cco @ (ccv @ Xn) @ XN @ ccpc) @ ccexp) @ cc1))))) => (! [Xn:$i] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ ccz) @ (cwne @ XN @ ccc0)) => (cwf @ ccn @ ccz @ (XF @ Xn))))))))).
