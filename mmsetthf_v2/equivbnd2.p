...
thf(aequivtotbnd_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XM @ (ccfv @ XX @ cctotbnd))) => ((Xph => (cwcel @ XN @ (ccfv @ XX @ ccme))) => ((Xph => (cwcel @ XR @ ccrp)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xy1) @ XX))) => (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XN) @ (cco @ XR @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XM) @ ccmul) @ ccle)))) => (Xph => (cwcel @ XN @ (ccfv @ XX @ cctotbnd))))))))))))).
thf(asyldan_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => (((Xph & Xch) => Xth) => ((Xph & Xps) => Xth)))))))).
thf(aequivbnd_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XM @ (ccfv @ XX @ ccbnd))) => ((Xph => (cwcel @ XN @ (ccfv @ XX @ ccme))) => ((Xph => (cwcel @ XR @ ccrp)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xy1) @ XX))) => (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XN) @ (cco @ XR @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XM) @ ccmul) @ ccle)))) => (Xph => (cwcel @ XN @ (ccfv @ XX @ ccbnd))))))))))))).
