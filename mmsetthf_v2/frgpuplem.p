...
thf(aeqer_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((XA2 @ Xx3) = (XB2 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XR @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((XA2 @ Xx3) = (XB2 @ Xy1)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwer @ ccvv @ (XR @ Xx3 @ Xy1)))))))))).
