...
thf(aabsle_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ (ccfv @ XA2 @ ccabs) @ XB2 @ ccle) <=> ((cwbr @ (ccneg @ XB2) @ XA2 @ ccle) & (cwbr @ XA2 @ XB2 @ ccle))))))).
...
thf(avolsup_ax,axiom,(! [XF:($i > $o)] : (((cwf @ ccn @ (ccdm @ ccvol) @ XF) & (cwral @ (^ [Xn:$i] : (cwss @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF))) @ (^ [Xn:$i] : ccn))) => ((ccfv @ (ccuni @ (ccrn @ XF)) @ ccvol) = (ccsup @ (ccima @ ccvol @ (ccrn @ XF)) @ ccxr @ cclt))))).
...
thf(cvolsup2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XB2 @ (ccfv @ XA2 @ ccvol) @ cclt)) => (cwrex @ (^ [Xn:$i] : (cwbr @ XB2 @ (ccfv @ (ccin @ XA2 @ (cco @ (ccneg @ (ccv @ Xn)) @ (ccv @ Xn) @ ccicc)) @ ccvol) @ cclt)) @ (^ [Xn:$i] : ccn)))))).
