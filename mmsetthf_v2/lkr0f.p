...
thf(alkrval_ax,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XW @ ccsca)) => ((Xc_0 = (ccfv @ XD @ cc0g)) => ((XF = (ccfv @ XW @ cclfn)) => ((XK = (ccfv @ XW @ cclk)) => (((cwcel @ XW @ XX) & (cwcel @ XG @ XF)) => ((ccfv @ XG @ XK) = (ccima @ (cccnv @ XG) @ (ccsn @ Xc_0)))))))))))))))).
...
thf(afconst4_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ (ccsn @ XB2) @ XF) <=> ((cwfn @ XF @ XA2) & ((ccima @ (cccnv @ XF) @ (ccsn @ XB2)) = XA2))))))).
...
thf(clkr0f_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XW @ ccsca)) => ((Xc_0 = (ccfv @ XD @ cc0g)) => ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ cclfn)) => ((XK = (ccfv @ XW @ cclk)) => (((cwcel @ XW @ cclmod) & (cwcel @ XG @ XF)) => (((ccfv @ XG @ XK) = XV) <=> (XG = (ccxp @ XV @ (ccsn @ Xc_0)))))))))))))))))).
