...
thf(aislnm2_ax,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XS = (ccfv @ XM @ cclss)) => ((XN = (ccfv @ XM @ cclspn)) => ((cwcel @ XM @ cclnm) <=> ((cwcel @ XM @ cclmod) & (cwral @ (^ [Xi:$i] : (cwrex @ (^ [Xg1:$i] : ((ccv @ Xi) = (ccfv @ (ccv @ Xg1) @ XN))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XB2) @ ccfn)))) @ (^ [Xi:$i] : XS)))))))))))).
thf(cfilnm_conj,conjecture,(! [XB2:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => (((cwcel @ XW @ cclmod) & (cwcel @ XB2 @ ccfn)) => (cwcel @ XW @ cclnm)))))).
