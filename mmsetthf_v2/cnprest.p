...
thf(ccnprest_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => ((((cwcel @ XJ @ cctop) & (cwss @ XA2 @ XX)) & ((cwcel @ XP @ (ccfv @ XA2 @ (ccfv @ XJ @ ccnt))) & (cwf @ XX @ XY @ XF))) => ((cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) <=> (cwcel @ (ccres @ XF @ XA2) @ (ccfv @ XP @ (cco @ (cco @ XJ @ XA2 @ ccrest) @ XK @ cccnp))))))))))))))).
