...
thf(acmbr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((cwbr @ XA2 @ XB2 @ cccm) <=> (XA2 = (cco @ (ccin @ XA2 @ XB2) @ (ccin @ XA2 @ (ccfv @ XB2 @ ccort)) @ cchj))))))).
...
thf(achj4_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) & ((cwcel @ XC @ ccch) & (cwcel @ XD @ ccch))) => ((cco @ (cco @ XA2 @ XB2 @ cchj) @ (cco @ XC @ XD @ cchj) @ cchj) = (cco @ (cco @ XA2 @ XC @ cchj) @ (cco @ XB2 @ XD @ cchj) @ cchj)))))))).
...
thf(ccm2j_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) & ((cwbr @ XA2 @ XB2 @ cccm) & (cwbr @ XA2 @ XC @ cccm))) => (cwbr @ XA2 @ (cco @ XB2 @ XC @ cchj) @ cccm)))))).
