...
thf(cledivge1le_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccrp) @ ((cwcel @ XC @ ccrp) & (cwbr @ cc1 @ XC @ ccle))) => ((cwbr @ XA2 @ XB2 @ ccle) => (cwbr @ (cco @ XA2 @ XC @ ccdiv) @ XB2 @ ccle))))))).
