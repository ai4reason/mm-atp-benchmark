...
thf(amircinv_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((XS = (ccfv @ XG @ ccmir)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((XM = (ccfv @ XA2 @ XS)) => (Xph => ((ccfv @ XA2 @ XM) = XA2)))))))))))))))))))).
...
thf(amideulem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XL:($i > ($i > $o))] : (! [Xc_mi:($i > $o)] : (! [XO:($i > $o)] : ((! [Xx3:$i] : (XP = (ccfv @ (XG @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (Xc_mi = (ccfv @ (XG @ Xx3) @ ccds))) => ((! [Xx3:$i] : (XI = (ccfv @ (XG @ Xx3) @ ccitv))) => ((! [Xx3:$i] : ((XL @ Xx3) = (ccfv @ (XG @ Xx3) @ cclng))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XG @ Xx3) @ ccstrkg))) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccfv @ (XG @ Xx3) @ ccmir))) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwne @ XA2 @ XB2)) => ((Xph => (cwcel @ XQ @ XP)) => ((Xph => (cwcel @ XO @ XP)) => ((Xph => (cwcel @ XT @ XP)) => ((! [Xx3:$i] : (Xph => (cwbr @ (cco @ XA2 @ XB2 @ (XL @ Xx3)) @ (cco @ XQ @ XB2 @ (XL @ Xx3)) @ (ccfv @ (XG @ Xx3) @ ccperpg)))) => ((! [Xx3:$i] : (Xph => (cwbr @ (cco @ XA2 @ XB2 @ (XL @ Xx3)) @ (cco @ XA2 @ XO @ (XL @ Xx3)) @ (ccfv @ (XG @ Xx3) @ ccperpg)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XT @ (cco @ XA2 @ XB2 @ (XL @ Xx3))))) => ((Xph => (cwcel @ XT @ (cco @ XQ @ XO @ XI))) => ((! [Xx3:$i] : (Xph => (cwbr @ (cco @ XA2 @ XO @ Xc_mi) @ (cco @ XB2 @ XQ @ Xc_mi) @ (ccfv @ (XG @ Xx3) @ ccleg)))) => (Xph => (cwrex @ (^ [Xx3:$i] : (XB2 = (ccfv @ XA2 @ (ccfv @ (ccv @ Xx3) @ (XS @ Xx3))))) @ (^ [Xx3:$i] : XP))))))))))))))))))))))))))))))))).
...
thf(aperpcom_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ (ccrn @ XL))) => ((Xph => (cwcel @ XB2 @ (ccrn @ XL))) => ((Xph => (cwbr @ XA2 @ XB2 @ (ccfv @ XG @ ccperpg))) => (Xph => (cwbr @ XB2 @ XA2 @ (ccfv @ XG @ ccperpg)))))))))))))))))))).
...
thf(atglinecom_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XP @ XB2)) => ((Xph => (cwcel @ XQ @ XB2)) => ((Xph => (cwne @ XP @ XQ)) => (Xph => ((cco @ XP @ XQ @ XL) = (cco @ XQ @ XP @ XL)))))))))))))))))).
...
thf(amircom_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((XS = (ccfv @ XG @ ccmir)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((XM = (ccfv @ XA2 @ XS)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => ((ccfv @ XB2 @ XM) = XC)) => (Xph => ((ccfv @ XC @ XM) = XB2)))))))))))))))))))))))).
...
thf(acolperpex_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwne @ XA2 @ XB2)) => ((Xph => (cwbr @ XG @ cc2 @ ccstrkgld)) => (Xph => (cwrex @ (^ [Xp:$i] : ((cwbr @ (cco @ XA2 @ (ccv @ Xp) @ XL) @ (cco @ XA2 @ XB2 @ XL) @ (ccfv @ XG @ ccperpg)) & (cwrex @ (^ [Xt:$i] : (((cwcel @ (ccv @ Xt) @ (cco @ XA2 @ XB2 @ XL)) | (XA2 = XB2)) & (cwcel @ (ccv @ Xt) @ (cco @ XC @ (ccv @ Xp) @ XI)))) @ (^ [Xt:$i] : XP)))) @ (^ [Xp:$i] : XP))))))))))))))))))))))).
...
thf(cmidex_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((XS = (ccfv @ XG @ ccmir)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwbr @ XG @ cc2 @ ccstrkgld)) => (Xph => (cwrex @ (^ [Xx3:$i] : (XB2 = (ccfv @ XA2 @ (ccfv @ (ccv @ Xx3) @ XS)))) @ (^ [Xx3:$i] : XP)))))))))))))))))))))).
