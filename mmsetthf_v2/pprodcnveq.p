...
thf(adfpprod2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccpprod @ XA2 @ XB2) = (ccin @ (cccom @ (cccnv @ (ccres @ cc1st @ (ccxp @ ccvv @ ccvv))) @ (cccom @ XA2 @ (ccres @ cc1st @ (ccxp @ ccvv @ ccvv)))) @ (cccom @ (cccnv @ (ccres @ cc2nd @ (ccxp @ ccvv @ ccvv))) @ (cccom @ XB2 @ (ccres @ cc2nd @ (ccxp @ ccvv @ ccvv))))))))).
...
thf(acnvco1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cccnv @ (cccom @ (cccnv @ XA2) @ XB2)) = (cccom @ (cccnv @ XB2) @ XA2))))).
