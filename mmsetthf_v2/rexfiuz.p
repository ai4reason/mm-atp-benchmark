...
thf(arexanuz_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : ((Xph @ Xk) & (Xps @ Xk))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : ccz)) <=> ((cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (Xph @ Xk)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : ccz)) & (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (Xps @ Xk)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : ccz))))))).
