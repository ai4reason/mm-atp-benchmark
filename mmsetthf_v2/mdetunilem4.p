...
thf(cmdetunilem4_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xph => (cwcel @ XN @ ccfn)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwf @ XB2 @ XK @ XD)) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (((cwne @ (ccv @ Xy1) @ (ccv @ Xz)) & (cwral @ (^ [Xw:$i] : ((cco @ (ccv @ Xy1) @ (ccv @ Xw) @ (ccv @ Xx3)) = (cco @ (ccv @ Xz) @ (ccv @ Xw) @ (ccv @ Xx3)))) @ (^ [Xw:$i] : XN))) => ((ccfv @ (ccv @ Xx3) @ XD) = Xc_0))) @ (^ [Xz:$i] : XN))) @ (^ [Xy1:$i] : XN))) @ (^ [Xx3:$i] : XB2))) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((cw3a @ ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) = (cco @ (ccres @ (ccv @ Xy1) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccres @ (ccv @ Xz) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccof @ Xc_pl))) @ ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xy1) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN))) @ ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xz) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)))) => ((ccfv @ (ccv @ Xx3) @ XD) = (cco @ (ccfv @ (ccv @ Xy1) @ XD) @ (ccfv @ (ccv @ Xz) @ XD) @ Xc_pl)))) @ (^ [Xw:$i] : XN))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((((ccres @ (ccv @ Xx3) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) = (cco @ (ccxp @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN) @ (ccsn @ (ccv @ Xy1))) @ (ccres @ (ccv @ Xz) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccof @ Xc_x))) & ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xz) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)))) => ((ccfv @ (ccv @ Xx3) @ XD) = (cco @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xz) @ XD) @ Xc_x)))) @ (^ [Xw:$i] : XN))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XK))) @ (^ [Xx3:$i] : XB2))) => ((cw3a @ Xph @ (cw3a @ (cwcel @ XE @ XB2) @ (cwcel @ XF @ XK) @ (cwcel @ XG @ XB2)) @ (cw3a @ (cwcel @ XH @ XN) @ ((ccres @ XE @ (ccxp @ (ccsn @ XH) @ XN)) = (cco @ (ccxp @ (ccxp @ (ccsn @ XH) @ XN) @ (ccsn @ XF)) @ (ccres @ XG @ (ccxp @ (ccsn @ XH) @ XN)) @ (ccof @ Xc_x))) @ ((ccres @ XE @ (ccxp @ (ccdif @ XN @ (ccsn @ XH)) @ XN)) = (ccres @ XG @ (ccxp @ (ccdif @ XN @ (ccsn @ XH)) @ XN))))) => ((ccfv @ XE @ XD) = (cco @ XF @ (ccfv @ XG @ XD) @ Xc_x)))))))))))))))))))))))))))))))).
