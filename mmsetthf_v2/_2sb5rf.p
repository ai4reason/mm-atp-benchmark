...
thf(a_2ax6e_ax,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (? [Xz:$i] : (? [Xw:$i] : (((ccv @ Xz) = (ccv @ Xx3)) & ((ccv @ Xw) = (ccv @ Xy1)))))))).
thf(c_2sb5rf_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (cwnf @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwnf @ (^ [Xw:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) <=> (? [Xz:$i] : (? [Xw:$i] : ((((ccv @ Xz) = (ccv @ Xx3)) & ((ccv @ Xw) = (ccv @ Xy1))) & (cwsb @ (^ [Xx3:$i] : (cwsb @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)) @ Xw)) @ Xz))))))))))))).
