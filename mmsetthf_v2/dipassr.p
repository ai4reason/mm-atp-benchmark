...
thf(cdipassr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XS = (ccfv @ XU @ ccns)) => ((XP = (ccfv @ XU @ ccdip)) => (((cwcel @ XU @ cccphlo) & (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ XX))) => ((cco @ XA2 @ (cco @ XB2 @ XC @ XS) @ XP) = (cco @ (ccfv @ XB2 @ cccj) @ (cco @ XA2 @ XC @ XP) @ ccmul)))))))))))))).
