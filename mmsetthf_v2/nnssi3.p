...
thf(cnnssi3_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwss @ ccn @ XD) => (((cwcel @ XC @ ccn) => Xph) => ((((cw3a @ (cwcel @ XA2 @ XD) @ (cwcel @ XB2 @ XD) @ (cwcel @ XC @ XD)) & Xph) => Xps) => ((cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccn)) => Xps))))))))))).
