...
thf(aintmin3_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> Xps))) => (Xps => (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => (cwss @ (ccint @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3)))) @ XA2)))))))))).
thf(aanbi12d_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => (Xps <=> Xch)) => ((Xph => (Xth <=> Xta)) => (Xph => ((Xps & Xth) <=> (Xch & Xta))))))))))).
thf(asseq1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwss @ XA2 @ XC) <=> (cwss @ XB2 @ XC))))))).
thf(asylbi_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph <=> Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(aintnex_ax,axiom,(! [XA2:($i > $o)] : ((~ (cwcel @ (ccint @ XA2) @ ccvv)) <=> ((ccint @ XA2) = ccvv)))).
...
thf(cintabs_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccint @ (ccab @ (^ [Xy1:$i] : (Xps @ Xy1))))) => ((Xph @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xy1:$i] : ((cwss @ (ccint @ (ccab @ (^ [Xy1:$i] : (Xps @ Xy1)))) @ (XA2 @ Xy1)) & (Xch @ Xy1))) => (! [Xy1:$i] : ((ccint @ (ccab @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ (XA2 @ Xy1)) & (Xph @ Xx3))))) = (ccint @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3)))))))))))))).
