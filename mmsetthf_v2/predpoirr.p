...
thf(apredel_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XY @ (ccpred @ XA2 @ XR @ XX)) => (cwcel @ XY @ XA2))))))).
thf(cpredpoirr_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwpo @ XA2 @ XR) => (~ (cwcel @ XX @ (ccpred @ XA2 @ XR @ XX)))))))).
