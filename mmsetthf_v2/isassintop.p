...
thf(aassintopmap_ax,axiom,(! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xo:$i] : ((cwcel @ XM @ (XV @ Xo)) => ((ccfv @ XM @ ccassintop) = (ccrab @ (^ [Xo:$i] : (cwbr @ (ccv @ Xo) @ XM @ ccasslaw)) @ (^ [Xo:$i] : (cco @ XM @ (ccxp @ XM @ XM) @ ccmap))))))))).
...
thf(aisclintop_ax,axiom,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_op:($i > $o)] : ((cwcel @ XM @ XV) => ((cwcel @ Xc_op @ (ccfv @ XM @ ccclintop)) <=> (cwf @ (ccxp @ XM @ XM) @ XM @ Xc_op))))))).
