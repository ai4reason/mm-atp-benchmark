...
thf(ahaustsms_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > ($i > $o))] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xph => (cwcel @ XG @ cccmn)) => ((Xph => (cwcel @ XG @ cctps)) => ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3)))) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((XJ = (ccfv @ XG @ cctopn)) => ((Xph => (cwcel @ XJ @ ccha)) => (Xph => (cwmo @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (cco @ XG @ XF @ cctsu)))))))))))))))))))).
...
thf(ctaylf_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((! [Xk:$i] : (Xph => (cwf @ (XA2 @ Xk) @ ccc @ XF))) => ((! [Xk:$i] : (Xph => (cwss @ (XA2 @ Xk) @ XS))) => ((Xph => ((cwcel @ XN @ ccn0) | (XN = ccpnf))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (ccin @ (cco @ ccc0 @ XN @ ccicc) @ ccz))) => (cwcel @ XB2 @ (ccdm @ (ccfv @ (ccv @ Xk) @ (cco @ XS @ XF @ ccdvn)))))) => ((! [Xk:$i] : ((XT @ Xk) = (cco @ XN @ XB2 @ (cco @ XS @ XF @ cctayl)))) => (! [Xk:$i] : (Xph => (cwf @ (ccdm @ (XT @ Xk)) @ ccc @ (XT @ Xk)))))))))))))))))).
