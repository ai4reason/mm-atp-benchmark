...
thf(aonintss_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> Xps))) => ((cwcel @ XA2 @ ccon0) => (Xps => (cwss @ (ccint @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : ccon0))) @ XA2)))))))).
...
thf(cnoextenddif_conj,conjecture,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ (ccpr @ cc1o @ cc2o)) => ((cwcel @ XA2 @ ccsur) => ((ccint @ (ccrab @ (^ [Xx3:$i] : (cwne @ (ccfv @ (ccv @ Xx3) @ XA2) @ (ccfv @ (ccv @ Xx3) @ (ccun @ XA2 @ (ccsn @ (ccop @ (ccdm @ XA2) @ XX)))))) @ (^ [Xx3:$i] : ccon0))) = (ccdm @ XA2))))))).
