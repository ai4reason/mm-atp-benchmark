...
thf(acjne0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwne @ XA2 @ ccc0) <=> (cwne @ (ccfv @ XA2 @ cccj) @ ccc0))))).
...
thf(clogcj_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ (ccfv @ XA2 @ ccim) @ ccc0)) => ((ccfv @ (ccfv @ XA2 @ cccj) @ cclog) = (ccfv @ (ccfv @ XA2 @ cclog) @ cccj))))).
