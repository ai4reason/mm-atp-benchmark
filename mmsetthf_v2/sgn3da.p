...
thf(csgn3da_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((((ccfv @ XA2 @ ccsgn) = ccc0) => (Xps <=> Xch)) => ((((ccfv @ XA2 @ ccsgn) = cc1) => (Xps <=> Xth)) => ((((ccfv @ XA2 @ ccsgn) = (ccneg @ cc1)) => (Xps <=> Xta)) => (((Xph & (XA2 = ccc0)) => Xch) => (((Xph & (cwbr @ ccc0 @ XA2 @ cclt)) => Xth) => (((Xph & (cwbr @ XA2 @ ccc0 @ cclt)) => Xta) => (Xph => Xps))))))))))))))).
