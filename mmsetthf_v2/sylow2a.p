...
thf(asylow2alem2_ax,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xc_po:($i > ($i > $o))] : (! [Xc_sm:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xz:$i] : (! [Xu:$i] : (! [Xh:$i] : ((XX @ Xz) = (ccfv @ (XG @ Xz @ Xu @ Xh) @ ccbs))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) => (cwcel @ (Xc_po @ Xz) @ (cco @ (XG @ Xz @ Xu @ Xh) @ XY @ ccga))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) => (cwbr @ (XP @ Xx3 @ Xy1 @ Xu @ Xg1 @ Xh) @ (XG @ Xz @ Xu @ Xh) @ ccpgp)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xg1:$i] : ((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) => (cwcel @ (XX @ Xz) @ ccfn))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : ((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) => (cwcel @ XY @ ccfn)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((XZ @ Xx3 @ Xy1 @ Xu @ Xg1 @ Xh) = (ccrab @ (^ [Xu:$i] : (cwral @ (^ [Xh:$i] : ((cco @ (ccv @ Xh) @ (ccv @ Xu) @ (Xc_po @ Xz)) = (ccv @ Xu))) @ (^ [Xh:$i] : (XX @ Xz)))) @ (^ [Xu:$i] : XY))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xg1:$i] : ((Xc_sm @ Xx3 @ Xy1 @ Xu @ Xg1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwss @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XY) & (cwrex @ (^ [Xg1:$i] : ((cco @ (ccv @ Xg1) @ (ccv @ Xx3) @ (Xc_po @ Xz)) = (ccv @ Xy1))) @ (^ [Xg1:$i] : (XX @ Xz))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) => (cwbr @ (XP @ Xx3 @ Xy1 @ Xu @ Xg1 @ Xh) @ (ccsu @ (ccdif @ (ccqs @ XY @ (Xc_sm @ Xx3 @ Xy1 @ Xu @ Xg1)) @ (ccpw @ (XZ @ Xx3 @ Xy1 @ Xu @ Xg1 @ Xh))) @ (^ [Xz:$i] : (ccfv @ (ccv @ Xz) @ cchash))) @ ccdvds))))))))))))))))))))))).
...
thf(asylow2alem1_ax,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > $o)] : (! [XP:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xc_po:($i > $o)] : (! [Xc_sm:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xu:$i] : (! [Xh:$i] : (XX = (ccfv @ (XG @ Xu @ Xh) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) => (cwcel @ Xc_po @ (cco @ (XG @ Xu @ Xh) @ XY @ ccga)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) => (cwbr @ (XP @ Xx3 @ Xy1 @ Xu @ Xg1 @ Xh) @ (XG @ Xu @ Xh) @ ccpgp))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : ((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) => (cwcel @ XX @ ccfn)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : ((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) => (cwcel @ XY @ ccfn)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((XZ @ Xx3 @ Xy1 @ Xu @ Xg1 @ Xh) = (ccrab @ (^ [Xu:$i] : (cwral @ (^ [Xh:$i] : ((cco @ (ccv @ Xh) @ (ccv @ Xu) @ Xc_po) = (ccv @ Xu))) @ (^ [Xh:$i] : XX))) @ (^ [Xu:$i] : XY)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : ((Xc_sm @ Xx3 @ Xy1 @ Xu @ Xg1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwss @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XY) & (cwrex @ (^ [Xg1:$i] : ((cco @ (ccv @ Xg1) @ (ccv @ Xx3) @ Xc_po) = (ccv @ Xy1))) @ (^ [Xg1:$i] : XX))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xh:$i] : (((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) & (cwcel @ XA2 @ (XZ @ Xx3 @ Xy1 @ Xu @ Xg1 @ Xh))) => ((ccec @ XA2 @ (Xc_sm @ Xx3 @ Xy1 @ Xu @ Xg1)) = (ccsn @ XA2))))))))))))))))))))))))).
