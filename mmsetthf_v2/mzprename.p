...
thf(amzpsubst_ax,axiom,(! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xy1:$i] : ((cw3a @ (cwcel @ XW @ ccvv) @ (cwcel @ (XF @ Xy1) @ (ccfv @ XV @ ccmzp)) @ (cwral @ (^ [Xy1:$i] : (cwcel @ (XG @ Xy1) @ (ccfv @ XW @ ccmzp))) @ (^ [Xy1:$i] : XV))) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccz @ XW @ ccmap)) @ (^ [Xx3:$i] : (ccfv @ (ccmpt @ (^ [Xy1:$i] : XV) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xx3) @ (XG @ Xy1)))) @ (XF @ Xy1)))) @ (ccfv @ XW @ ccmzp))))))))).
thf(cmzprename_conj,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ ccvv) @ (cwcel @ XF @ (ccfv @ XV @ ccmzp)) @ (cwf @ XV @ XW @ XR)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccz @ XW @ ccmap)) @ (^ [Xx3:$i] : (ccfv @ (cccom @ (ccv @ Xx3) @ XR) @ XF))) @ (ccfv @ XW @ ccmzp)))))))).
