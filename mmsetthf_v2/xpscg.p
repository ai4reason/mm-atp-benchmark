...
thf(axpsc_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cccnv @ (cco @ (ccsn @ XA2) @ (ccsn @ XB2) @ cccda)) = (ccun @ (ccxp @ (ccsn @ cc0) @ (ccsn @ XA2)) @ (ccxp @ (ccsn @ cc1o) @ (ccsn @ XB2))))))).
thf(adf_pr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccpr @ XA2 @ XB2) = (ccun @ (ccsn @ XA2) @ (ccsn @ XB2)))))).
thf(cxpscg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cccnv @ (cco @ (ccsn @ XA2) @ (ccsn @ XB2) @ cccda)) = (ccpr @ (ccop @ cc0 @ XA2) @ (ccop @ cc1o @ XB2))))))))).
