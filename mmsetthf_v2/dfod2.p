...
thf(aodcong_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XX) @ ((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz))) => ((cwbr @ (ccfv @ XA2 @ XO) @ (cco @ XM @ XN @ ccmin) @ ccdvds) <=> ((cco @ XM @ XA2 @ Xc_x) = (cco @ XN @ XA2 @ Xc_x))))))))))))))))).
...
thf(aodinf_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccz) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ Xc_x))))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XX) @ ((ccfv @ XA2 @ XO) = ccc0)) => (~ (cwcel @ (ccrn @ (XF @ Xx3)) @ ccfn))))))))))))))).
...
thf(cdfod2_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccz) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ Xc_x))))) => (! [Xx3:$i] : (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX)) => ((ccfv @ XA2 @ XO) = (ccif @ (cwcel @ (ccrn @ (XF @ Xx3)) @ ccfn) @ (ccfv @ (ccrn @ (XF @ Xx3)) @ cchash) @ ccc0))))))))))))))).
