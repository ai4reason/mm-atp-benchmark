...
thf(amuladdi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwcel @ XC @ ccc) => ((cwcel @ XD @ ccc) => ((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XC @ XD @ ccaddc) @ ccmul) = (cco @ (cco @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XD @ XB2 @ ccmul) @ ccaddc) @ (cco @ (cco @ XA2 @ XD @ ccmul) @ (cco @ XC @ XB2 @ ccmul) @ ccaddc) @ ccaddc))))))))))).
...
thf(amul32i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwcel @ XC @ ccc) => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ XC @ ccmul) = (cco @ (cco @ XA2 @ XC @ ccmul) @ XB2 @ ccmul))))))))).
...
thf(ckaratsubaOLD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwcel @ XD @ ccn0) => ((cwcel @ XS @ ccn0) => ((cwcel @ XM @ ccn0) => (((cco @ XA2 @ XC @ ccmul) = XR) => (((cco @ XB2 @ XD @ ccmul) = XT) => (((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XC @ XD @ ccaddc) @ ccmul) = (cco @ (cco @ XR @ XS @ ccaddc) @ XT @ ccaddc)) => (((cco @ (cco @ XA2 @ (cco @ cc10 @ XM @ ccexp) @ ccmul) @ XB2 @ ccaddc) = XX) => (((cco @ (cco @ XC @ (cco @ cc10 @ XM @ ccexp) @ ccmul) @ XD @ ccaddc) = XY) => (((cco @ (cco @ XR @ (cco @ cc10 @ XM @ ccexp) @ ccmul) @ XS @ ccaddc) = XW) => (((cco @ (cco @ XW @ (cco @ cc10 @ XM @ ccexp) @ ccmul) @ XT @ ccaddc) = XZ) => ((cco @ XX @ XY @ ccmul) = XZ))))))))))))))))))))))))))).
