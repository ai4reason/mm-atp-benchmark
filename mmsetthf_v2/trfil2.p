...
thf(ctrfil2_conj,conjecture,(! [XA2:($i > $o)] : (! [XL:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XL @ (ccfv @ XY @ ccfil)) & (cwss @ XA2 @ XY)) => ((cwcel @ (cco @ XL @ XA2 @ ccrest) @ (ccfv @ XA2 @ ccfil)) <=> (cwral @ (^ [Xv:$i] : (cwne @ (ccin @ (ccv @ Xv) @ XA2) @ cc0)) @ (^ [Xv:$i] : XL)))))))).
