...
thf(aunisngl_ax,axiom,(! [XC:($i > $o)] : (! [XX:($i > $o)] : ((XC = (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xu) = (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XX))))) => (XX = (ccuni @ XC)))))).
...
thf(cdissnref_conj,conjecture,(! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XC = (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xu) = (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XX))))) => (((cwcel @ XX @ XV) & ((ccuni @ XY) = XX)) => (cwbr @ XC @ XY @ ccref)))))))).
