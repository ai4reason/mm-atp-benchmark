...
thf(aixpeq1d_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph @ Xx3) => (XA2 = XB2))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) = (ccixp @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3)))))))))))).
...
thf(aundifixp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cw3a @ (cwcel @ XF @ (ccixp @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3)))) @ (cwcel @ XG @ (ccixp @ (^ [Xx3:$i] : (ccdif @ XA2 @ XB2)) @ (^ [Xx3:$i] : (XC @ Xx3)))) @ (cwss @ XB2 @ XA2)) => (cwcel @ (ccun @ XF @ XG) @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))))))))).
...
thf(aptuncnv_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XK)) => ((XY = (ccuni @ XL)) => ((XJ = (ccfv @ XF @ ccpt)) => ((XK = (ccfv @ (ccres @ XF @ XA2) @ ccpt)) => ((XL = (ccfv @ (ccres @ XF @ XB2) @ ccpt)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XG @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XC @ (XV @ Xx3 @ Xy1))))) => ((Xph => (cwf @ XC @ cctop @ XF)) => ((Xph => (XC = (ccun @ XA2 @ XB2))) => ((Xph => ((ccin @ XA2 @ XB2) = cc0)) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((cccnv @ (XG @ Xx3 @ Xy1)) = (ccmpt @ (^ [Xz:$i] : (ccuni @ XJ)) @ (^ [Xz:$i] : (ccop @ (ccres @ (ccv @ Xz) @ XA2) @ (ccres @ (ccv @ Xz) @ XB2))))))))))))))))))))))))))))))).
thf(acnmpt1t_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cco @ XJ @ XK @ cccn))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cco @ XJ @ XL @ cccn))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccop @ (XA2 @ Xx3) @ (XB2 @ Xx3)))) @ (cco @ XJ @ (cco @ XK @ XL @ cctx) @ cccn)))))))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(ccfi_tp,type,(ccfi : ($i > $o))).
thf(aptrescn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (XX = (ccuni @ (XJ @ Xx3)))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ XF @ ccpt))) => ((XK = (ccfv @ (ccres @ XF @ XB2) @ ccpt)) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XA2 @ XV) @ (cwf @ XA2 @ cctop @ XF) @ (cwss @ XB2 @ XA2)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccres @ (ccv @ Xx3) @ XB2))) @ (cco @ (XJ @ Xx3) @ XK @ cccn))))))))))))))).
