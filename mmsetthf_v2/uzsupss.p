...
thf(cuzsupss_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xz:$i] : ((XZ @ Xy1 @ Xz) = (ccfv @ (XM @ Xz) @ ccuz)))) => (! [Xy1:$i] : (! [Xz:$i] : ((cw3a @ (cwcel @ (XM @ Xz) @ ccz) @ (cwss @ XA2 @ (XZ @ Xy1 @ Xz)) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccz))) => (cwrex @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt))) @ (^ [Xy1:$i] : XA2)) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ cclt) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ cclt)) @ (^ [Xz:$i] : XA2)))) @ (^ [Xy1:$i] : (XZ @ Xy1 @ Xz))))) @ (^ [Xx3:$i] : (XZ @ Xy1 @ Xz))))))))))).
