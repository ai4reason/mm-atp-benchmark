...
thf(chspdifhsp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((Xph => (cwne @ XX @ cc0)) => ((Xph => (cwf @ XX @ ccr @ XA2)) => ((Xph => (cwf @ XX @ ccr @ XB2)) => ((XH = (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xl:$i] : (^ [Xy1:$i] : (ccv @ Xx3))) @ (^ [Xl:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xl:$i] : (^ [Xy1:$i] : (ccixp @ (^ [Xi:$i] : (ccv @ Xx3)) @ (^ [Xi:$i] : (ccif @ ((ccv @ Xi) = (ccv @ Xl)) @ (cco @ ccmnf @ (ccv @ Xy1) @ ccioo) @ ccr))))))))) => (Xph => ((ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XA2) @ (ccfv @ (ccv @ Xi) @ XB2) @ ccico))) = (cciin @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (ccdif @ (cco @ (ccv @ Xi) @ (ccfv @ (ccv @ Xi) @ XB2) @ (ccfv @ XX @ XH)) @ (cco @ (ccv @ Xi) @ (ccfv @ (ccv @ Xi) @ XA2) @ (ccfv @ XX @ XH)))))))))))))))))).
