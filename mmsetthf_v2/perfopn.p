...
thf(aperftop_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ ccperf) => (cwcel @ XJ @ cctop)))).
...
thf(aperfi_ax,axiom,(! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ ccperf) & (cwcel @ XP @ XX)) => (~ (cwcel @ (ccsn @ XP) @ XJ)))))))).
