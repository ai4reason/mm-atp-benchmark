...
thf(cnmcn_conj,conjecture,(! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XN = (ccfv @ XG @ ccnm)) => ((XJ = (ccfv @ XG @ cctopn)) => ((XK = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((cwcel @ XG @ ccngp) => (cwcel @ XN @ (cco @ XJ @ XK @ cccn))))))))))).
