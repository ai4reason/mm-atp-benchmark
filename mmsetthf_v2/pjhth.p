...
thf(ashsss_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccsh) & (cwcel @ XB2 @ ccsh)) => (cwss @ (cco @ XA2 @ XB2 @ ccph) @ cchil))))).
...
thf(cpjhth_conj,conjecture,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cco @ XH @ (ccfv @ XH @ ccort) @ ccph) = cchil)))).
