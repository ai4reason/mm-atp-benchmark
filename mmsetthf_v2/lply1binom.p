...
thf(acrngbinom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : ((XS = (ccfv @ XR @ ccbs)) => ((Xc_xp = (ccfv @ XR @ ccmulr)) => ((Xc_x = (ccfv @ XR @ ccmg)) => ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((! [Xk:$i] : ((XG @ Xk) = (ccfv @ XR @ ccmgp))) => ((! [Xk:$i] : (Xc_ex = (ccfv @ (XG @ Xk) @ ccmg))) => ((((cwcel @ XR @ cccrg) & (cwcel @ XN @ ccn0)) & ((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS))) => ((cco @ XN @ (cco @ XA2 @ XB2 @ Xc_pl) @ Xc_ex) = (cco @ XR @ (ccmpt @ (^ [Xk:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ XA2 @ Xc_ex) @ (cco @ (ccv @ Xk) @ XB2 @ Xc_ex) @ Xc_xp) @ Xc_x))) @ ccgsu)))))))))))))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(clply1binom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_pl = (ccfv @ XP @ ccplusg)) => ((Xc_xp = (ccfv @ XP @ ccmulr)) => ((Xc_x = (ccfv @ XP @ ccmg)) => ((! [Xk:$i] : ((XG @ Xk) = (ccfv @ XP @ ccmgp))) => ((! [Xk:$i] : (Xc_ex = (ccfv @ (XG @ Xk) @ ccmg))) => ((! [Xk:$i] : ((XB2 @ Xk) = (ccfv @ XP @ ccbs))) => (! [Xk:$i] : ((cw3a @ (cwcel @ XR @ cccrg) @ (cwcel @ XN @ ccn0) @ (cwcel @ XA2 @ (XB2 @ Xk))) => ((cco @ XN @ (cco @ XX @ XA2 @ Xc_pl) @ Xc_ex) = (cco @ XP @ (ccmpt @ (^ [Xk:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ XA2 @ Xc_ex) @ (cco @ (ccv @ Xk) @ XX @ Xc_ex) @ Xc_xp) @ Xc_x))) @ ccgsu)))))))))))))))))))))))).
