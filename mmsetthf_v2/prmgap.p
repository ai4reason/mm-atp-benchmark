...
thf(afacmapnn_ax,axiom,(cwcel @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ ccfa))) @ (cco @ ccn @ ccn @ ccmap))).
...
thf(aprmgaplem2_ax,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XI @ (cco @ cc2 @ XN @ ccfz))) => (cwbr @ cc1 @ (cco @ (cco @ (ccfv @ XN @ ccfa) @ XI @ ccaddc) @ XI @ ccgcd) @ cclt))))).
