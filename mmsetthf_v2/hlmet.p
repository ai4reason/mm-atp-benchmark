...
thf(ahlcmet_ax,axiom,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XD = (ccfv @ XU @ ccims)) => ((cwcel @ XU @ cchlo) => (cwcel @ XD @ (ccfv @ XX @ ccms))))))))).
...
thf(chlmet_conj,conjecture,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XD = (ccfv @ XU @ ccims)) => ((cwcel @ XU @ cchlo) => (cwcel @ XD @ (ccfv @ XX @ ccme))))))))).
