...
thf(aopprirred_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : ((XS = (ccfv @ XR @ ccoppr)) => ((XI = (ccfv @ XR @ ccir)) => (XI = (ccfv @ XS @ ccir)))))))).
thf(ccdsr_tp,type,(ccdsr : ($i > $o))).
thf(cwbr_tp,type,(cwbr : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(aopprunit_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : ((XU = (ccfv @ XR @ ccui)) => ((XS = (ccfv @ XR @ ccoppr)) => (XU = (ccfv @ XS @ ccui)))))))).
thf(cirredlmul_conj,conjecture,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XI = (ccfv @ XR @ ccir)) => ((XU = (ccfv @ XR @ ccui)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XI)) => (cwcel @ (cco @ XX @ XY @ Xc_x) @ XI)))))))))))).
