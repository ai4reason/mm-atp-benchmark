...
thf(asmadiadetg0_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XR @ cccrg) => ((cw3a @ (cwcel @ XM @ (ccfv @ (cco @ XN @ XR @ ccmat) @ ccbs)) @ (cwcel @ XK @ XN) @ (cwcel @ XS @ (ccfv @ XR @ ccbs))) => ((ccfv @ (cco @ XK @ XK @ (cco @ XM @ XS @ (cco @ XN @ XR @ ccmarrep))) @ (cco @ XN @ XR @ ccmdat)) = (cco @ XS @ (ccfv @ (cco @ XK @ XK @ (ccfv @ XM @ (cco @ XN @ XR @ ccsubma))) @ (cco @ (ccdif @ XN @ (ccsn @ XK)) @ XR @ ccmdat)) @ (ccfv @ XR @ ccmulr))))))))))).
