...
thf(atotbndbnd_ax,axiom,(! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XM @ (ccfv @ XX @ cctotbnd)) => (cwcel @ XM @ (ccfv @ XX @ ccbnd)))))).
...
thf(a_0totbnd_ax,axiom,(! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XX = cc0) => ((cwcel @ XM @ (ccfv @ XX @ cctotbnd)) <=> (cwcel @ XM @ (ccfv @ XX @ ccme))))))).
...
thf(abnd2lem_ax,axiom,(! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XD = (ccres @ XM @ (ccxp @ XY @ XY))) => (((cwcel @ XM @ (ccfv @ XX @ ccme)) & (cwcel @ XD @ (ccfv @ XY @ ccbnd))) => (cwss @ XY @ XX)))))))).
thf(asimprl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & (Xps & Xch)) => Xps))))).
thf(assbnd_ax,axiom,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XN = (ccres @ XM @ (ccxp @ XY @ XY))) => (((cwcel @ XM @ (ccfv @ XX @ ccme)) & (cwcel @ XP @ XX)) => ((cwcel @ XN @ (ccfv @ XY @ ccbnd)) <=> (cwrex @ (^ [Xd:$i] : (cwss @ XY @ (cco @ XP @ (ccv @ Xd) @ (ccfv @ XM @ ccbl)))) @ (^ [Xd:$i] : ccr))))))))))).
...
thf(ablbnd_ax,axiom,(! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XM @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XY @ XX) @ (cwcel @ XR @ ccr)) => (cwcel @ (ccres @ XM @ (ccxp @ (cco @ XY @ XR @ (ccfv @ XM @ ccbl)) @ (cco @ XY @ XR @ (ccfv @ XM @ ccbl)))) @ (ccfv @ (cco @ XY @ XR @ (ccfv @ XM @ ccbl)) @ ccbnd)))))))).
...
thf(aprdsbl_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : ((XY @ Xx3) = (cco @ (XS @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XR @ Xx3))) @ ccprds))) => ((! [Xx3:$i] : (XB2 = (ccfv @ (XY @ Xx3) @ ccbs))) => ((! [Xx3:$i] : ((XV @ Xx3) = (ccfv @ (XR @ Xx3) @ ccbs))) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccres @ (ccfv @ (XR @ Xx3) @ ccds) @ (ccxp @ (XV @ Xx3) @ (XV @ Xx3))))) => ((! [Xx3:$i] : (XD = (ccfv @ (XY @ Xx3) @ ccds))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XS @ Xx3) @ (XW @ Xx3)))) => ((Xph => (cwcel @ XI @ ccfn)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwcel @ (XR @ Xx3) @ (XZ @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwcel @ (XE @ Xx3) @ (ccfv @ (XV @ Xx3) @ ccxmt)))) => ((Xph => (cwcel @ XP @ XB2)) => ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ cclt)) => (Xph => ((cco @ XP @ XA2 @ (ccfv @ XD @ ccbl)) = (ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XP) @ XA2 @ (ccfv @ (XE @ Xx3) @ ccbl)))))))))))))))))))))))))))))))).
thf(arpgt0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwbr @ ccc0 @ XA2 @ cclt)))).
thf(aprdsbas3_ax,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : ((XY @ Xx3) = (cco @ (XS @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XR @ Xx3))) @ ccprds))) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccfv @ (XY @ Xx3) @ ccbs))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XS @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XI @ (XW @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwral @ (^ [Xx3:$i] : (cwcel @ (XR @ Xx3) @ (XX @ Xx3))) @ (^ [Xx3:$i] : XI)))) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccfv @ (XR @ Xx3) @ ccbs))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((XB2 @ Xx3) = (ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XK @ Xx3))))))))))))))))))))))).
thf(ccuni_tp,type,(ccuni : (($i > $o) > ($i > $o)))).
thf(atotbndss_ax,axiom,(! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XM @ (ccfv @ XX @ cctotbnd)) & (cwss @ XS @ XX)) => (cwcel @ (ccres @ XM @ (ccxp @ XS @ XS)) @ (ccfv @ XS @ cctotbnd))))))).
thf(cprdsbnd2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > $o))] : ((! [Xy1:$i] : ((XY @ Xy1) = (cco @ (XS @ Xy1) @ XR @ ccprds))) => ((! [Xy1:$i] : (XB2 = (ccfv @ (XY @ Xy1) @ ccbs))) => ((! [Xx3:$i] : ((XV @ Xx3) = (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccbs))) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccres @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccds) @ (ccxp @ (XV @ Xx3) @ (XV @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XD @ Xx3) = (ccfv @ (XY @ Xy1) @ ccds)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XS @ Xy1) @ (XW @ Xx3 @ Xy1))))) => ((Xph => (cwcel @ XI @ ccfn)) => ((Xph => (cwfn @ XR @ XI)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XC @ Xx3 @ Xy1) = (ccres @ (XD @ Xx3) @ (ccxp @ (XA2 @ Xx3 @ Xy1) @ (XA2 @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwcel @ (XE @ Xx3) @ (ccfv @ (XV @ Xx3) @ ccme)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => ((cwcel @ (ccres @ (XE @ Xx3) @ (ccxp @ (ccv @ Xy1) @ (ccv @ Xy1))) @ (ccfv @ (ccv @ Xy1) @ cctotbnd)) <=> (cwcel @ (ccres @ (XE @ Xx3) @ (ccxp @ (ccv @ Xy1) @ (ccv @ Xy1))) @ (ccfv @ (ccv @ Xy1) @ ccbnd)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((cwcel @ (XC @ Xx3 @ Xy1) @ (ccfv @ (XA2 @ Xx3 @ Xy1) @ cctotbnd)) <=> (cwcel @ (XC @ Xx3 @ Xy1) @ (ccfv @ (XA2 @ Xx3 @ Xy1) @ ccbnd)))))))))))))))))))))))))))))).
