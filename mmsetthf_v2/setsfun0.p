...
thf(aresdifcom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccdif @ (ccres @ XA2 @ XB2) @ XC) = (ccres @ (ccdif @ XA2 @ XC) @ XB2)))))).
...
thf(aopnz_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwne @ (ccop @ XA2 @ XB2) @ cc0) <=> ((cwcel @ XA2 @ ccvv) & (cwcel @ XB2 @ ccvv)))))).
...
thf(asetsvalg_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XS @ XV) & (cwcel @ XA2 @ XW)) => ((cco @ XS @ XA2 @ ccsts) = (ccun @ (ccres @ XS @ (ccdif @ ccvv @ (ccdm @ (ccsn @ XA2)))) @ (ccsn @ XA2))))))))).
thf(csetsfun0_conj,conjecture,(! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((((cwcel @ XG @ XV) & (cwfun @ (ccdif @ XG @ (ccsn @ cc0)))) & ((cwcel @ XI @ XU) & (cwcel @ XE @ XW))) => (cwfun @ (ccdif @ (cco @ XG @ (ccop @ XI @ XE) @ ccsts) @ (ccsn @ cc0))))))))))).
