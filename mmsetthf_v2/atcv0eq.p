...
thf(aatcv0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccat) => (cwbr @ cc0h @ XA2 @ cccv)))).
...
thf(acvntr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) => (((cwbr @ XA2 @ XB2 @ cccv) & (cwbr @ XB2 @ XC @ cccv)) => (~ (cwbr @ XA2 @ XC @ cccv)))))))).
...
thf(achjidm_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cco @ XA2 @ XA2 @ cchj) = XA2)))).
thf(catcv0eq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccat) & (cwcel @ XB2 @ ccat)) => ((cwbr @ cc0h @ (cco @ XA2 @ XB2 @ cchj) @ cccv) <=> (XA2 = XB2)))))).
