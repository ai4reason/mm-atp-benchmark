...
thf(acgrtr3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee))) @ (cw3a @ (cwcel @ XD @ (ccfv @ XN @ ccee)) @ (cwcel @ XE @ (ccfv @ XN @ ccee)) @ (cwcel @ XF @ (ccfv @ XN @ ccee)))) => (((cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XE @ XF) @ cccgr) & (cwbr @ (ccop @ XC @ XD) @ (ccop @ XE @ XF) @ cccgr)) => (cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ cccgr))))))))))).
thf(ccgrtr3and_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XB2 @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XC @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XD @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XE @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XF @ (ccfv @ XN @ ccee))) => (((Xph & Xps) => (cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XE @ XF) @ cccgr)) => (((Xph & Xps) => (cwbr @ (ccop @ XC @ XD) @ (ccop @ XE @ XF) @ cccgr)) => ((Xph & Xps) => (cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ cccgr))))))))))))))))))))).
