...
thf(as1val_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((ccs1 @ XA2) = (ccsn @ (ccop @ ccc0 @ XA2))))))).
...
thf(cgsumws1_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((cwcel @ XS @ XB2) => ((cco @ XG @ (ccs1 @ XS) @ ccgsu) = XS))))))).
