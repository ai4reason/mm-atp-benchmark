...
thf(c_1hegrvtxdg1r_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ XX)) => ((Xph => (cwcel @ XB2 @ XV)) => ((Xph => (cwcel @ XC @ XV)) => ((Xph => (cwne @ XB2 @ XC)) => ((Xph => (cwcel @ XE @ (ccpw @ XV))) => ((Xph => ((ccfv @ XG @ cciedg) = (ccsn @ (ccop @ XA2 @ XE)))) => ((Xph => (cwss @ (ccpr @ XB2 @ XC) @ XE)) => ((Xph => ((ccfv @ XG @ ccvtx) = XV)) => (Xph => ((ccfv @ XC @ (ccfv @ XG @ ccvtxdg)) = cc1))))))))))))))))))).
