...
thf(ageoisum1_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) => ((ccsu @ ccn @ (^ [Xk:$i] : (cco @ XA2 @ (ccv @ Xk) @ ccexp))) = (cco @ XA2 @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv))))).
...
thf(cgeoisum1c_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XR @ ccc) @ (cwbr @ (ccfv @ XR @ ccabs) @ cc1 @ cclt)) => ((ccsu @ ccn @ (^ [Xk:$i] : (cco @ XA2 @ (cco @ XR @ (ccv @ Xk) @ ccexp) @ ccmul))) = (cco @ (cco @ XA2 @ XR @ ccmul) @ (cco @ cc1 @ XR @ ccmin) @ ccdiv)))))).
