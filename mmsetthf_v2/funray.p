...
thf(aaxdimuniq_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XN @ ccn) & (cwcel @ XA2 @ (ccfv @ XN @ ccee))) & ((cwcel @ XM @ ccn) & (cwcel @ XA2 @ (ccfv @ XM @ ccee)))) => (XN = XM)))))).
...
thf(adf_ray_ax,axiom,(ccray = (ccoprab @ (^ [Xp:$i] : (^ [Xa:$i] : (^ [Xr:$i] : (cwrex @ (^ [Xn:$i] : ((cw3a @ (cwcel @ (ccv @ Xp) @ (ccfv @ (ccv @ Xn) @ ccee)) @ (cwcel @ (ccv @ Xa) @ (ccfv @ (ccv @ Xn) @ ccee)) @ (cwne @ (ccv @ Xp) @ (ccv @ Xa))) & ((ccv @ Xr) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xp) @ (ccop @ (ccv @ Xa) @ (ccv @ Xx3)) @ ccoutsideof)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xn) @ ccee)))))) @ (^ [Xn:$i] : ccn)))))))).
thf(cfunray_conj,conjecture,(cwfun @ ccray)).
