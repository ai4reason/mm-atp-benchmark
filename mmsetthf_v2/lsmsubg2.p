...
thf(clsmsubg2_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((Xc_po = (ccfv @ XG @ cclsm)) => ((cw3a @ (cwcel @ XG @ ccabl) @ (cwcel @ XT @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => (cwcel @ (cco @ XT @ XU @ Xc_po) @ (ccfv @ XG @ ccsubg))))))))).
