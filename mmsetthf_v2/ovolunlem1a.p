...
thf(asermono_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XK @ (ccfv @ XM @ ccuz))) => ((Xph => (cwcel @ XN @ (ccfv @ XK @ ccuz))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XM @ XN @ ccfz))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ ccr))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ (cco @ XK @ cc1 @ ccaddc) @ XN @ ccfz))) => (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ XF) @ ccle))) => (Xph => (cwbr @ (ccfv @ XK @ (ccseq @ ccaddc @ XF @ XM)) @ (ccfv @ XN @ (ccseq @ ccaddc @ XF @ XM)) @ ccle)))))))))))).
...
thf(aflhalf_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => (cwbr @ XN @ (cco @ cc2 @ (ccfv @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccfl) @ ccmul) @ ccle)))).
...
thf(asupxrgtmnf_ax,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccr) & (cwne @ XA2 @ cc0)) => (cwbr @ ccmnf @ (ccsup @ XA2 @ ccxr @ cclt) @ cclt)))).
...
thf(ahalfnz_ax,axiom,(~ (cwcel @ (cco @ cc1 @ cc2 @ ccdiv) @ ccz))).
...
thf(adivcan3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0)) => ((cco @ (cco @ XB2 @ XA2 @ ccmul) @ XB2 @ ccdiv) = XA2))))).
...
thf(covolunlem1a_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : ((Xph => ((cwss @ XA2 @ ccr) & (cwcel @ (ccfv @ XA2 @ ccovol) @ ccr))) => ((Xph => ((cwss @ XB2 @ ccr) & (cwcel @ (ccfv @ XB2 @ ccovol) @ ccr))) => ((Xph => (cwcel @ XC @ ccrp)) => ((! [Xn:$i] : ((XS @ Xn) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1))) => ((! [Xn:$i] : ((XT @ Xn) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XG) @ cc1))) => ((! [Xn:$i] : ((XU @ Xn) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (XH @ Xn)) @ cc1))) => ((Xph => (cwcel @ XF @ (cco @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ ccn @ ccmap))) => ((Xph => (cwss @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF))))) => ((! [Xn:$i] : (Xph => (cwbr @ (ccsup @ (ccrn @ (XS @ Xn)) @ ccxr @ cclt) @ (cco @ (ccfv @ XA2 @ ccovol) @ (cco @ XC @ cc2 @ ccdiv) @ ccaddc) @ ccle))) => ((Xph => (cwcel @ XG @ (cco @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ ccn @ ccmap))) => ((Xph => (cwss @ XB2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ XG))))) => ((! [Xn:$i] : (Xph => (cwbr @ (ccsup @ (ccrn @ (XT @ Xn)) @ ccxr @ cclt) @ (cco @ (ccfv @ XB2 @ ccovol) @ (cco @ XC @ cc2 @ ccdiv) @ ccaddc) @ ccle))) => ((! [Xn:$i] : ((XH @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (cco @ (ccv @ Xn) @ cc2 @ ccdiv) @ ccn) @ (ccfv @ (cco @ (ccv @ Xn) @ cc2 @ ccdiv) @ XG) @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ XF)))))) => (! [Xk:$i] : (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn)) => (cwbr @ (ccfv @ (ccv @ Xk) @ (XU @ Xn)) @ (cco @ (cco @ (ccfv @ XA2 @ ccovol) @ (ccfv @ XB2 @ ccovol) @ ccaddc) @ XC @ ccaddc) @ ccle)))))))))))))))))))))))))))).
