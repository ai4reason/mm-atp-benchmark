...
thf(asnct_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwbr @ (ccsn @ XA2) @ ccom @ ccdom))))).
...
thf(coms0_conj,conjecture,(! [Xph:$o] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XM = (ccfv @ XR @ ccoms)) => ((Xph => (cwcel @ XQ @ XV)) => ((Xph => (cwf @ XQ @ (cco @ ccc0 @ ccpnf @ ccicc) @ XR)) => ((Xph => (cwcel @ cc0 @ (ccdm @ XR))) => ((Xph => ((ccfv @ cc0 @ XR) = ccc0)) => (Xph => ((ccfv @ cc0 @ XM) = ccc0))))))))))))).
