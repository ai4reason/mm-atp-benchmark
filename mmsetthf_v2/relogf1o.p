...
thf(aeff1o2_ax,axiom,(cwf1o @ (ccrn @ cclog) @ (ccdif @ ccc @ (ccsn @ ccc0)) @ (ccres @ cce @ (ccrn @ cclog)))).
...
thf(af1orescnv_ax,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (((cwfun @ (cccnv @ XF)) & (cwf1o @ XR @ XP @ (ccres @ XF @ XR))) => (cwf1o @ XP @ XR @ (ccres @ (cccnv @ XF) @ XP))))))).
thf(ccioc_tp,type,(ccioc : ($i > $o))).
thf(adflog2_ax,axiom,(cclog = (cccnv @ (ccres @ cce @ (ccrn @ cclog))))).
