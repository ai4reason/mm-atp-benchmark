...
thf(cpmapidclN_conj,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XU = (ccfv @ XK @ cclub)) => ((XM = (ccfv @ XK @ ccpmap)) => ((XC = (ccfv @ XK @ ccpscN)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XC)) => ((ccfv @ (ccfv @ XX @ XU) @ XM) = XX))))))))))).
