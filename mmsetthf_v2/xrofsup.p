...
thf(a_19_9d2r_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3) => (cwnf @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwnf @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3) => (Xps @ Xx3 @ Xy1)))))))))))).
...
thf(axlt2addrd_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xb @ Xc) => (cwcel @ XA2 @ ccr)))) => ((! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xb @ Xc) => (cwcel @ XB2 @ ccxr)))) => ((! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xb @ Xc) => (cwcel @ XC @ ccxr)))) => ((! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xb @ Xc) => (cwne @ XB2 @ ccmnf)))) => ((! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xb @ Xc) => (cwne @ XC @ ccmnf)))) => ((! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xb @ Xc) => (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccxad) @ cclt)))) => (! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xb @ Xc) => (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (cw3a @ (XA2 = (cco @ (ccv @ Xb) @ (ccv @ Xc) @ ccxad)) @ (cwbr @ (ccv @ Xb) @ XB2 @ cclt) @ (cwbr @ (ccv @ Xc) @ XC @ cclt))) @ (^ [Xc:$i] : ccxr))) @ (^ [Xb:$i] : ccxr)))))))))))))))).
thf(asimplr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) & Xch) => Xps))))).
thf(asimpr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(a_19_9d2rf_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (cwnf @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwnf @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwnf @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (Xps @ Xx3 @ Xy1))))))))))))).
...
thf(asupxr2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwss @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & ((cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XB2 @ ccle)) @ (^ [Xx3:$i] : XA2)) & (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ XB2 @ cclt) => (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt)) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : ccr)))) => ((ccsup @ XA2 @ ccxr @ cclt) = XB2))))).
thf(cxrofsup_conj,conjecture,(! [Xph:$o] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwss @ XX @ ccxr)) => ((Xph => (cwss @ XY @ ccxr)) => ((Xph => (cwne @ (ccsup @ XX @ ccxr @ cclt) @ ccmnf)) => ((Xph => (cwne @ (ccsup @ XY @ ccxr @ cclt) @ ccmnf)) => ((Xph => (XZ = (ccima @ ccxad @ (ccxp @ XX @ XY)))) => (Xph => ((ccsup @ XZ @ ccxr @ cclt) = (cco @ (ccsup @ XX @ ccxr @ cclt) @ (ccsup @ XY @ ccxr @ cclt) @ ccxad))))))))))))).
