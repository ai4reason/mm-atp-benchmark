...
thf(adf_pridl_ax,axiom,(ccpridl = (ccmpt @ (^ [Xr:$i] : ccrngo) @ (^ [Xr:$i] : (ccrab @ (^ [Xi:$i] : ((cwne @ (ccv @ Xi) @ (ccrn @ (ccfv @ (ccv @ Xr) @ cc1st))) & (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xr) @ cc2nd)) @ (ccv @ Xi))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xa))) => ((cwss @ (ccv @ Xa) @ (ccv @ Xi)) | (cwss @ (ccv @ Xb) @ (ccv @ Xi))))) @ (^ [Xb:$i] : (ccfv @ (ccv @ Xr) @ ccidl)))) @ (^ [Xa:$i] : (ccfv @ (ccv @ Xr) @ ccidl))))) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xr) @ ccidl))))))).
thf(arabex_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ ccvv))))).
thf(afvex_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(cpridlval_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XH:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XX:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XG @ Xx3 @ Xy1 @ Xi @ Xa @ Xb) = (ccfv @ XR @ cc1st))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XH @ Xx3 @ Xy1 @ Xa @ Xb) = (ccfv @ XR @ cc2nd)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XX @ Xx3 @ Xy1 @ Xa @ Xb) = (ccrn @ (XG @ Xx3 @ Xy1 @ Xi @ Xa @ Xb)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((cwcel @ XR @ ccrngo) => ((ccfv @ XR @ ccpridl) = (ccrab @ (^ [Xi:$i] : ((cwne @ (ccv @ Xi) @ (XX @ Xx3 @ Xy1 @ Xa @ Xb)) & (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XH @ Xx3 @ Xy1 @ Xa @ Xb)) @ (ccv @ Xi))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xa))) => ((cwss @ (ccv @ Xa) @ (ccv @ Xi)) | (cwss @ (ccv @ Xb) @ (ccv @ Xi))))) @ (^ [Xb:$i] : (ccfv @ XR @ ccidl)))) @ (^ [Xa:$i] : (ccfv @ XR @ ccidl))))) @ (^ [Xi:$i] : (ccfv @ XR @ ccidl))))))))))))))))).
