...
thf(aomopthlem2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccom) => ((cwcel @ XB2 @ ccom) => ((cwcel @ XC @ ccom) => ((cwcel @ XD @ ccom) => ((cwcel @ (cco @ XA2 @ XB2 @ ccoa) @ XC) => (~ ((cco @ (cco @ XC @ XC @ ccomu) @ XD @ ccoa) = (cco @ (cco @ (cco @ XA2 @ XB2 @ ccoa) @ (cco @ XA2 @ XB2 @ ccoa) @ ccomu) @ XB2 @ ccoa))))))))))))).
...
thf(comopthi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccom) => ((cwcel @ XB2 @ ccom) => ((cwcel @ XC @ ccom) => ((cwcel @ XD @ ccom) => (((cco @ (cco @ (cco @ XA2 @ XB2 @ ccoa) @ (cco @ XA2 @ XB2 @ ccoa) @ ccomu) @ XB2 @ ccoa) = (cco @ (cco @ (cco @ XC @ XD @ ccoa) @ (cco @ XC @ XD @ ccoa) @ ccomu) @ XD @ ccoa)) <=> ((XA2 = XC) & (XB2 = XD)))))))))))).
