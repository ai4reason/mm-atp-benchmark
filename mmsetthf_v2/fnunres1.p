...
thf(afunresdm1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwrel @ XA2) & ((ccin @ (ccdm @ XA2) @ (ccdm @ XB2)) = cc0)) => ((ccres @ (ccun @ XA2 @ XB2) @ (ccdm @ XA2)) = XA2))))).
thf(cfnunres1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cw3a @ (cwfn @ XF @ XA2) @ (cwfn @ XG @ XB2) @ ((ccin @ XA2 @ XB2) = cc0)) => ((ccres @ (ccun @ XF @ XG) @ XA2) = XF))))))).
