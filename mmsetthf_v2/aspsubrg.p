...
thf(asubrgint_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwss @ XS @ (ccfv @ XR @ ccsubrg)) & (cwne @ XS @ cc0)) => (cwcel @ (ccint @ XS) @ (ccfv @ XR @ ccsubrg)))))).
thf(caspsubrg_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XW @ ccasp)) => ((XV = (ccfv @ XW @ ccbs)) => (((cwcel @ XW @ ccasa) & (cwss @ XS @ XV)) => (cwcel @ (ccfv @ XS @ XA2) @ (ccfv @ XW @ ccsubrg)))))))))).
