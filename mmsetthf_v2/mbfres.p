...
thf(aismbf2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (Xph => (cwf @ (XA2 @ Xx3) @ ccr @ XF))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XA2 @ Xx3) @ (ccdm @ ccvol)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwcel @ (ccima @ (cccnv @ XF) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccioo)) @ (ccdm @ ccvol)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwcel @ (ccima @ (cccnv @ XF) @ (cco @ ccmnf @ (ccv @ Xx3) @ ccioo)) @ (ccdm @ ccvol)))) => (Xph => (cwcel @ XF @ ccmbf)))))))))).
...
thf(aismbf1_ax,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ ccmbf) <=> ((cwcel @ XF @ (cco @ ccc @ ccr @ ccpm)) & (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccima @ (cccnv @ (cccom @ ccre @ XF)) @ (ccv @ Xx3)) @ (ccdm @ ccvol)) & (cwcel @ (ccima @ (cccnv @ (cccom @ ccim @ XF)) @ (ccv @ Xx3)) @ (ccdm @ ccvol)))) @ (^ [Xx3:$i] : (ccrn @ ccioo))))))).
thf(cwrel_tp,type,(cwrel : (($i > $o) > $o))).
thf(cwfun_tp,type,(cwfun : (($i > $o) > $o))).
thf(ccxp_tp,type,(ccxp : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(cwfn_tp,type,(cwfn : (($i > $o) > (($i > $o) > $o)))).
thf(apmresg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XB2 @ XV) & (cwcel @ XF @ (cco @ XA2 @ XC @ ccpm))) => (cwcel @ (ccres @ XF @ XB2) @ (cco @ XA2 @ XB2 @ ccpm))))))))).
...
thf(cmbfres_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ ccmbf) & (cwcel @ XA2 @ (ccdm @ ccvol))) => (cwcel @ (ccres @ XF @ XA2) @ ccmbf))))).
