...
thf(awkslem2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (((XA2 = XB2) & ((cco @ XA2 @ cc1 @ ccaddc) = XC)) => ((cwif @ ((ccfv @ XA2 @ XP) = (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ XP)) @ ((ccfv @ (ccfv @ XA2 @ XF) @ XI) = (ccsn @ (ccfv @ XA2 @ XP))) @ (cwss @ (ccpr @ (ccfv @ XA2 @ XP) @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ XP)) @ (ccfv @ (ccfv @ XA2 @ XF) @ XI))) <=> (cwif @ ((ccfv @ XB2 @ XP) = (ccfv @ XC @ XP)) @ ((ccfv @ (ccfv @ XB2 @ XF) @ XI) = (ccsn @ (ccfv @ XB2 @ XP))) @ (cwss @ (ccpr @ (ccfv @ XB2 @ XP) @ (ccfv @ XC @ XP)) @ (ccfv @ (ccfv @ XB2 @ XF) @ XI)))))))))))).
...
thf(acrctcshwlkn0lem2_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XS @ (cco @ cc1 @ XN @ ccfzo))) => ((! [Xx3:$i] : ((XQ @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ XN @ XS @ ccmin) @ ccle) @ (ccfv @ (cco @ (ccv @ Xx3) @ XS @ ccaddc) @ XP) @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ XS @ ccaddc) @ XN @ ccmin) @ XP)))))) => (! [Xx3:$i] : ((Xph & (cwcel @ XJ @ (cco @ ccc0 @ (cco @ XN @ XS @ ccmin) @ ccfz))) => ((ccfv @ XJ @ (XQ @ Xx3)) = (ccfv @ (cco @ XJ @ XS @ ccaddc) @ XP))))))))))))).
...
thf(acrctcshwlkn0lem1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccn)) => (cwbr @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ cc1 @ ccaddc) @ XA2 @ ccle))))).
...
thf(acrctcshwlkn0lem3_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XS @ (cco @ cc1 @ XN @ ccfzo))) => ((! [Xx3:$i] : ((XQ @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ XN @ XS @ ccmin) @ ccle) @ (ccfv @ (cco @ (ccv @ Xx3) @ XS @ ccaddc) @ XP) @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ XS @ ccaddc) @ XN @ ccmin) @ XP)))))) => (! [Xx3:$i] : ((Xph & (cwcel @ XJ @ (cco @ (cco @ (cco @ XN @ XS @ ccmin) @ cc1 @ ccaddc) @ XN @ ccfz))) => ((ccfv @ XJ @ (XQ @ Xx3)) = (ccfv @ (cco @ (cco @ XJ @ XS @ ccaddc) @ XN @ ccmin) @ XP))))))))))))).
...
thf(ccrctcshwlkn0lem6_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XS @ (cco @ cc1 @ XN @ ccfzo))) => ((! [Xx3:$i] : (! [Xi:$i] : ((XQ @ Xx3 @ Xi) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ XN @ XS @ ccmin) @ ccle) @ (ccfv @ (cco @ (ccv @ Xx3) @ XS @ ccaddc) @ XP) @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ XS @ ccaddc) @ XN @ ccmin) @ XP))))))) => ((! [Xx3:$i] : (! [Xi:$i] : ((XH @ Xx3 @ Xi) = (cco @ (XF @ Xx3) @ XS @ cccsh)))) => ((! [Xx3:$i] : (XN = (ccfv @ (XF @ Xx3) @ cchash))) => ((! [Xx3:$i] : (! [Xi:$i] : (Xph => (cwcel @ (XF @ Xx3) @ (ccword @ (XA2 @ Xx3 @ Xi)))))) => ((! [Xx3:$i] : (Xph => (cwral @ (^ [Xi:$i] : (cwif @ ((ccfv @ (ccv @ Xi) @ XP) = (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP)) @ ((ccfv @ (ccfv @ (ccv @ Xi) @ (XF @ Xx3)) @ (XI @ Xx3)) = (ccsn @ (ccfv @ (ccv @ Xi) @ XP))) @ (cwss @ (ccpr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP)) @ (ccfv @ (ccfv @ (ccv @ Xi) @ (XF @ Xx3)) @ (XI @ Xx3))))) @ (^ [Xi:$i] : (cco @ ccc0 @ XN @ ccfzo))))) => ((Xph => ((ccfv @ XN @ XP) = (ccfv @ ccc0 @ XP))) => (! [Xx3:$i] : (! [Xi:$i] : ((Xph & ((XJ @ Xi) = (cco @ XN @ XS @ ccmin))) => (cwif @ ((ccfv @ (XJ @ Xi) @ (XQ @ Xx3 @ Xi)) = (ccfv @ (cco @ (XJ @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xx3 @ Xi))) @ ((ccfv @ (ccfv @ (XJ @ Xi) @ (XH @ Xx3 @ Xi)) @ (XI @ Xx3)) = (ccsn @ (ccfv @ (XJ @ Xi) @ (XQ @ Xx3 @ Xi)))) @ (cwss @ (ccpr @ (ccfv @ (XJ @ Xi) @ (XQ @ Xx3 @ Xi)) @ (ccfv @ (cco @ (XJ @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xx3 @ Xi))) @ (ccfv @ (ccfv @ (XJ @ Xi) @ (XH @ Xx3 @ Xi)) @ (XI @ Xx3))))))))))))))))))))))))).
