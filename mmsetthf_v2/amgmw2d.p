...
thf(aamgmwlem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : ((XM = (ccfv @ cccnfld @ ccmgp)) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwne @ XA2 @ cc0)) => ((Xph => (cwf @ XA2 @ ccrp @ XF)) => ((Xph => (cwf @ XA2 @ ccrp @ XW)) => ((Xph => ((cco @ cccnfld @ XW @ ccgsu) = cc1)) => (Xph => (cwbr @ (cco @ XM @ (cco @ XF @ XW @ (ccof @ cccxp)) @ ccgsu) @ (cco @ cccnfld @ (cco @ XF @ XW @ (ccof @ ccmul)) @ ccgsu) @ ccle)))))))))))))).
...
thf(aofs2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS)) & ((cwcel @ XC @ XT) & (cwcel @ XD @ XT))) => ((cco @ (ccs2 @ XA2 @ XB2) @ (ccs2 @ XC @ XD) @ (ccof @ XR)) = (ccs2 @ (cco @ XA2 @ XC @ XR) @ (cco @ XB2 @ XD @ XR)))))))))))).
...
thf(camgmw2d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwcel @ XP @ ccrp)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => (cwcel @ XQ @ ccrp)) => ((Xph => ((cco @ XP @ XQ @ ccaddc) = cc1)) => (Xph => (cwbr @ (cco @ (cco @ XA2 @ XP @ cccxp) @ (cco @ XB2 @ XQ @ cccxp) @ ccmul) @ (cco @ (cco @ XA2 @ XP @ ccmul) @ (cco @ XB2 @ XQ @ ccmul) @ ccaddc) @ ccle))))))))))))).
