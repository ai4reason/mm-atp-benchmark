...
thf(axltneg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (ccxne @ XB2) @ (ccxne @ XA2) @ cclt)))))).
...
thf(cxleneg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwbr @ (ccxne @ XB2) @ (ccxne @ XA2) @ ccle)))))).
