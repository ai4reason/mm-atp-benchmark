...
thf(csgrp2nmndlem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [Xc_op:($i > ($i > ($i > $o)))] : ((XS = (ccpr @ XA2 @ XB2)) => ((! [Xy1:$i] : ((ccfv @ (XM @ Xy1) @ ccbs) = XS)) => ((! [Xy1:$i] : ((ccfv @ (XM @ Xy1) @ ccplusg) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ ((ccv @ Xx3) = XA2) @ XA2 @ XB2)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_op @ Xx3 @ Xy1) = (ccfv @ (XM @ Xy1) @ ccplusg)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ (cwcel @ XC @ XS) @ (cwcel @ XB2 @ XS) @ (cwne @ XA2 @ XB2)) => ((cco @ XB2 @ XC @ (Xc_op @ Xx3 @ Xy1)) = XB2))))))))))))))).
