...
thf(amulgnn0di_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (((cwcel @ XG @ cccmn) & (cw3a @ (cwcel @ XM @ ccn0) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2))) => ((cco @ XM @ (cco @ XX @ XY @ Xc_pl) @ Xc_x) = (cco @ (cco @ XM @ XX @ Xc_x) @ (cco @ XM @ XY @ Xc_x) @ Xc_pl)))))))))))))).
...
thf(cmulgmhm_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => (((cwcel @ XG @ cccmn) & (cwcel @ XM @ ccn0)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ XM @ (ccv @ Xx3) @ Xc_x))) @ (cco @ XG @ XG @ ccmhm)))))))))).
