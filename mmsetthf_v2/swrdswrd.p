...
thf(aelfz0ubfz0_ax,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) & (cwcel @ XL @ (cco @ XK @ XN @ ccfz))) => (cwcel @ XK @ (cco @ ccc0 @ XL @ ccfz))))))).
...
thf(aswrdswrdlem_ax,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz)) @ (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz))) & ((cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfz)) & (cwcel @ XL @ (cco @ XK @ (cco @ XN @ XM @ ccmin) @ ccfz)))) => (cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ (cco @ XM @ XK @ ccaddc) @ (cco @ ccc0 @ (cco @ XM @ XL @ ccaddc) @ ccfz)) @ (cwcel @ (cco @ XM @ XL @ ccaddc) @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))))))))))).
