...
thf(aprmndvdsfaclt_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XN @ ccn0)) => ((cwbr @ XN @ XP @ cclt) => (~ (cwbr @ XP @ (ccfv @ XN @ ccfa) @ ccdvds))))))).
...
thf(cgausslemma2dlem0c_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XH:($i > $o)] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XH = (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => (Xph => ((cco @ (ccfv @ XH @ ccfa) @ XP @ ccgcd) = cc1)))))))).
