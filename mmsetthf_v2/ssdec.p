...
thf(cssdec_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xm:$i] : ((Xph & (cwcel @ (ccv @ Xm) @ (cco @ XM @ XN @ ccfzo))) => (cwss @ (ccfv @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc) @ XF) @ (ccfv @ (ccv @ Xm) @ XF)))) => (Xph => (cwss @ (ccfv @ XN @ XF) @ (ccfv @ XM @ XF)))))))))).
