...
thf(ctrfbas2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XF @ (ccfv @ XY @ ccfbas)) & (cwss @ XA2 @ XY)) => ((cwcel @ (cco @ XF @ XA2 @ ccrest) @ (ccfv @ XA2 @ ccfbas)) <=> (~ (cwcel @ cc0 @ (cco @ XF @ XA2 @ ccrest))))))))).
