...
thf(abj_inftyexpiinj_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc)) & (cwcel @ XB2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc))) => ((XA2 = XB2) <=> ((ccfv @ XA2 @ ccinftyexpi) = (ccfv @ XB2 @ ccinftyexpi))))))).
...
thf(cbj_pinftynminfty_conj,conjecture,(cwne @ ccpinfty @ ccminfty)).
