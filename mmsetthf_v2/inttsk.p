...
thf(atskpwss_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XT @ cctsk) & (cwcel @ XA2 @ XT)) => (cwss @ (ccpw @ XA2) @ XT))))).
...
thf(cinttsk_conj,conjecture,(! [XA2:($i > $o)] : (((cwss @ XA2 @ cctsk) & (cwne @ XA2 @ cc0)) => (cwcel @ (ccint @ XA2) @ cctsk)))).
