...
thf(clocfinnei_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xn:$i] : (! [Xs1:$i] : ((XX @ Xn @ Xs1) = (ccuni @ (XJ @ Xs1))))) => (! [Xn:$i] : (! [Xs1:$i] : (((cwcel @ XA2 @ (ccfv @ (XJ @ Xs1) @ cclocfin)) & (cwcel @ (XP @ Xs1) @ (XX @ Xn @ Xs1))) => (cwrex @ (^ [Xn:$i] : ((cwcel @ (XP @ Xs1) @ (ccv @ Xn)) & (cwcel @ (ccrab @ (^ [Xs1:$i] : (cwne @ (ccin @ (ccv @ Xs1) @ (ccv @ Xn)) @ cc0)) @ (^ [Xs1:$i] : XA2)) @ ccfn))) @ (^ [Xn:$i] : (XJ @ Xs1)))))))))))).
