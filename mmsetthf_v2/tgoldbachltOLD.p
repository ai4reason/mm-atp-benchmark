...
thf(atgblthelfgottOLD_ax,axiom,(! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccodd) @ (cwbr @ cc7 @ XN @ cclt) @ (cwbr @ XN @ (cco @ (ccdc @ cc8 @ cc8) @ (cco @ cc10 @ (ccdc @ cc2 @ cc9) @ ccexp) @ ccmul) @ cclt)) => (cwcel @ XN @ ccgbo)))).
...
thf(altaddposi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwbr @ ccc0 @ XA2 @ cclt) <=> (cwbr @ XB2 @ (cco @ XB2 @ XA2 @ ccaddc) @ cclt))))))).
...
thf(ctgoldbachltOLD_conj,conjecture,(cwrex @ (^ [Xm:$i] : ((cwbr @ (cco @ cc8 @ (cco @ cc10 @ (ccdc @ cc3 @ ccc0) @ ccexp) @ ccmul) @ (ccv @ Xm) @ cclt) & (cwral @ (^ [Xn:$i] : (((cwbr @ cc7 @ (ccv @ Xn) @ cclt) & (cwbr @ (ccv @ Xn) @ (ccv @ Xm) @ cclt)) => (cwcel @ (ccv @ Xn) @ ccgbo))) @ (^ [Xn:$i] : ccodd)))) @ (^ [Xm:$i] : ccn))).
