...
thf(cmptfzshft_conj,conjecture,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XK @ ccz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XN @ ccz)) => (Xph => (cwf1o @ (cco @ (cco @ XM @ XK @ ccaddc) @ (cco @ XN @ XK @ ccaddc) @ ccfz) @ (cco @ XM @ XN @ ccfz) @ (ccmpt @ (^ [Xj:$i] : (cco @ (cco @ XM @ XK @ ccaddc) @ (cco @ XN @ XK @ ccaddc) @ ccfz)) @ (^ [Xj:$i] : (cco @ (ccv @ Xj) @ XK @ ccmin))))))))))))).
