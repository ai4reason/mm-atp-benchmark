...
thf(apadd01_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => (((cwcel @ XK @ XB2) & (cwss @ XX @ XA2)) => ((cco @ XX @ cc0 @ Xc_pl) = XX)))))))))).
...
thf(apmodlem1_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XS = (ccfv @ XK @ ccpsubsp)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => ((cw3a @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwss @ XX @ XA2) @ (cwss @ XY @ XA2)) @ (cw3a @ (cwcel @ XZ @ XS) @ (cwss @ XX @ XZ) @ (cwcel @ (ccv @ Xp) @ XZ)) @ (cw3a @ (cwcel @ (ccv @ Xq) @ XX) @ (cwcel @ (ccv @ Xr) @ XY) @ (cwbr @ (ccv @ Xp) @ (cco @ (ccv @ Xq) @ (ccv @ Xr) @ Xc_or) @ Xc_le))) => (cwcel @ (ccv @ Xp) @ (cco @ XX @ (ccin @ XY @ XZ) @ Xc_pl))))))))))))))))))))).
thf(cpmodlem2_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XS = (ccfv @ XK @ ccpsubsp)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwss @ XX @ XA2) @ (cwss @ XY @ XA2) @ (cwcel @ XZ @ XS)) @ (cwss @ XX @ XZ)) => (cwss @ (ccin @ (cco @ XX @ XY @ Xc_pl) @ XZ) @ (cco @ XX @ (ccin @ XY @ XZ) @ Xc_pl)))))))))))))))))).
