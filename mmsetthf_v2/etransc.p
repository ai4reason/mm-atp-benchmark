...
thf(amt3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((~ Xps) => (((~ Xph) => Xps) => Xph))))).
...
thf(aneldif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ XB2) & (~ (cwcel @ XA2 @ (ccdif @ XB2 @ XC)))) => (cwcel @ XA2 @ XC)))))).
...
thf(aelaa2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdif @ ccaa @ (ccsn @ ccc0))) <=> ((cwcel @ XA2 @ ccc) & (cwrex @ (^ [Xf1:$i] : ((cwne @ (ccfv @ ccc0 @ (ccfv @ (ccv @ Xf1) @ cccoe)) @ ccc0) & ((ccfv @ XA2 @ (ccv @ Xf1)) = ccc0))) @ (^ [Xf1:$i] : (ccfv @ ccz @ ccply))))))).
...
thf(aetransclem48_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : ((! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : (Xph => (cwcel @ (XQ @ Xi @ Xk @ Xn) @ (ccdif @ (ccfv @ ccz @ ccply) @ (ccsn @ cc0p))))))) => ((! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : (Xph => ((ccfv @ cceu @ (XQ @ Xi @ Xk @ Xn)) = ccc0))))) => ((! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XA2 @ Xi) = (ccfv @ (XQ @ Xi @ Xk @ Xn) @ cccoe))))) => ((! [Xi:$i] : (Xph => (cwne @ (ccfv @ ccc0 @ (XA2 @ Xi)) @ ccc0))) => ((! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XM @ Xi) = (ccfv @ (XQ @ Xi @ Xk @ Xn) @ ccdgr))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XC @ Xj @ Xk) = (ccsu @ (cco @ ccc0 @ (XM @ Xi) @ ccfz) @ (^ [Xj:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ (XA2 @ Xi)) @ (cco @ cceu @ (ccv @ Xj) @ cccxp) @ ccmul) @ ccabs) @ (cco @ (XM @ Xi) @ (cco @ (XM @ Xi) @ (cco @ (XM @ Xi) @ cc1 @ ccaddc) @ ccexp) @ ccmul) @ ccmul))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XS @ Xj @ Xk @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (XC @ Xj @ Xk) @ (cco @ (cco @ (cco @ (XM @ Xi) @ (cco @ (XM @ Xi) @ cc1 @ ccaddc) @ ccexp) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv) @ ccmul)))))))) => ((! [Xj:$i] : (! [Xk:$i] : ((XI @ Xj @ Xk) = (ccinf @ (ccrab @ (^ [Xi:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xn) @ (XS @ Xj @ Xk @ Xn)) @ ccabs) @ cc1 @ cclt)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xi) @ ccuz)))) @ (^ [Xi:$i] : ccn0)) @ ccr @ cclt)))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XT @ Xi @ Xn) = (ccsup @ (cctp @ (ccfv @ (ccfv @ ccc0 @ (XA2 @ Xi)) @ ccabs) @ (ccfv @ (XM @ Xi) @ ccfa) @ (XI @ Xj @ Xk)) @ ccxr @ cclt)))))) => (Xph => (cwrex @ (^ [Xk:$i] : ((cwne @ (ccv @ Xk) @ ccc0) & (cwbr @ (ccfv @ (ccv @ Xk) @ ccabs) @ cc1 @ cclt))) @ (^ [Xk:$i] : ccz))))))))))))))))))))).
...
thf(an0p_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XP @ (ccfv @ ccz @ ccply)) @ (cwcel @ XN @ ccn0) @ (cwne @ (ccfv @ XN @ (ccfv @ XP @ cccoe)) @ ccc0)) => (cwne @ XP @ cc0p))))).
