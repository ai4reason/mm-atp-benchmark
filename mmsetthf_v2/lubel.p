...
thf(alubsn_ax,axiom,(! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XU = (ccfv @ XK @ cclub)) => (((cwcel @ XK @ cclat) & (cwcel @ XX @ XB2)) => ((ccfv @ (ccsn @ XX) @ XU) = XX))))))))).
...
thf(clubel_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XU = (ccfv @ XK @ cclub)) => ((cw3a @ (cwcel @ XK @ cccla) @ (cwcel @ XX @ XS) @ (cwss @ XS @ XB2)) => (cwbr @ XX @ (ccfv @ XS @ XU) @ Xc_le)))))))))))).
