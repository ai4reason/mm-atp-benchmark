...
thf(cun0addcl_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwss @ XS @ ccc)) => ((XT = (ccun @ XS @ (ccsn @ ccc0))) => (((Xph & ((cwcel @ XM @ XS) & (cwcel @ XN @ XS))) => (cwcel @ (cco @ XM @ XN @ ccaddc) @ XS)) => ((Xph & ((cwcel @ XM @ XT) & (cwcel @ XN @ XT))) => (cwcel @ (cco @ XM @ XN @ ccaddc) @ XT))))))))))).
