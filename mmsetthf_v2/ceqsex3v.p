...
thf(cceqsex3v_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [Xth:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3 @ Xy1 @ Xz) <=> (Xps @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = XB2) => ((Xps @ Xy1 @ Xz) <=> (Xch @ Xx3 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xz) = XC) => ((Xch @ Xx3 @ Xz) <=> (Xth @ Xx3 @ Xy1)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((? [Xx3:$i] : (? [Xy1:$i] : (? [Xz:$i] : ((cw3a @ ((ccv @ Xx3) = XA2) @ ((ccv @ Xy1) = XB2) @ ((ccv @ Xz) = XC)) & (Xph @ Xx3 @ Xy1 @ Xz))))) <=> (Xth @ Xx3 @ Xy1)))))))))))))))))).
