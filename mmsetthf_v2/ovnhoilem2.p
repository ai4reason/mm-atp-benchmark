...
thf(ahoidmvle_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xk:$i] : ((XL @ Xk) = (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ ((ccv @ Xx3) = cc0) @ ccc0 @ (ccprod @ (^ [Xk:$i] : (ccv @ Xx3)) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xb)) @ ccico) @ ccvol))))))))))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XX @ ccfn))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xk) => (cwf @ XX @ ccr @ (XA2 @ Xx3 @ Xj)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : ((Xph @ Xk) => (cwf @ XX @ ccr @ (XB2 @ Xx3 @ Xj @ Xa))))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xk) => (cwf @ ccn @ (cco @ ccr @ XX @ ccmap) @ (XC @ Xx3 @ Xa @ Xb))))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xk) => (cwf @ ccn @ (cco @ ccr @ XX @ ccmap) @ (XD @ Xx3 @ Xa @ Xb))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xk) => (cwss @ (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XA2 @ Xx3 @ Xj)) @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xx3 @ Xj @ Xa)) @ ccico))) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (XC @ Xx3 @ Xa @ Xb))) @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (XD @ Xx3 @ Xa @ Xb))) @ ccico)))))))))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xk) => (cwbr @ (cco @ (XA2 @ Xx3 @ Xj) @ (XB2 @ Xx3 @ Xj @ Xa) @ (ccfv @ XX @ (XL @ Xk))) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (cco @ (ccfv @ (ccv @ Xj) @ (XC @ Xx3 @ Xa @ Xb)) @ (ccfv @ (ccv @ Xj) @ (XD @ Xx3 @ Xa @ Xb)) @ (ccfv @ XX @ (XL @ Xk))))) @ ccsumge0) @ ccle)))))))))))))))))))))).
...
thf(aelmapex_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (cco @ XB2 @ XC @ ccmap)) => ((cwcel @ XB2 @ ccvv) & (cwcel @ XC @ ccvv))))))).
...
thf(aixpeq2dva_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => ((XB2 @ Xx3) = (XC @ Xx3)))) => (Xph => ((ccixp @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (ccixp @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3))))))))))).
...
thf(aovnn0val_ax,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XX:($i > $o)] : ((! [Xz:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xz @ Xi @ Xj @ Xk) => (cwcel @ XX @ ccfn)))))) => ((! [Xz:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xz @ Xi @ Xj @ Xk) => (cwne @ XX @ cc0)))))) => ((! [Xz:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xz @ Xi @ Xj @ Xk) => (cwss @ (XA2 @ Xj @ Xk) @ (cco @ ccr @ XX @ ccmap))))))) => ((! [Xz:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XM @ Xz @ Xi @ Xj @ Xk) = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xi:$i] : ((cwss @ (XA2 @ Xj @ Xk) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi))))))))) & ((ccv @ Xz) = (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi)))) @ ccvol))))) @ ccsumge0)))) @ (^ [Xi:$i] : (cco @ (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap) @ ccn @ ccmap)))) @ (^ [Xz:$i] : ccxr))))))) => (! [Xz:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xz @ Xi @ Xj @ Xk) => ((ccfv @ (XA2 @ Xj @ Xk) @ (ccfv @ XX @ ccovoln)) = (ccinf @ (XM @ Xz @ Xi @ Xj @ Xk) @ ccxr @ cclt)))))))))))))))).
thf(aeqsstrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (cwss @ XB2 @ XC)) => (Xph => (cwss @ XA2 @ XC))))))))).
thf(cwnf_tp,type,(cwnf : (($i > $o) > $o))).
thf(ahoissrrn2_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XX)) => (cwcel @ (XA2 @ Xk) @ ccr))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XX)) => (cwcel @ (XB2 @ Xk) @ ccxr))) => (! [Xk:$i] : ((Xph @ Xk) => (cwss @ (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (XA2 @ Xk) @ (XB2 @ Xk) @ ccico))) @ (cco @ ccr @ XX @ ccmap)))))))))))).
thf(anfv_ax,axiom,(! [Xph:$o] : (cwnf @ (^ [Xx3:$i] : Xph)))).
thf(arexrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => (cwcel @ XA2 @ ccxr)))))).
thf(covnhoilem2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XX:($i > $o)] : ((! [Xj:$i] : ((Xph @ Xj) => (cwcel @ XX @ ccfn))) => ((! [Xj:$i] : ((Xph @ Xj) => (cwne @ XX @ cc0))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xl:$i] : ((Xph @ Xj) => (cwf @ XX @ ccr @ (XA2 @ Xx3 @ Xj @ Xn @ Xl))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xl:$i] : ((Xph @ Xj) => (cwf @ XX @ ccr @ (XB2 @ Xx3 @ Xj @ Xn @ Xl))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xl:$i] : ((XI @ Xj @ Xk @ Xl) = (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XA2 @ Xx3 @ Xj @ Xn @ Xl)) @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xx3 @ Xj @ Xn @ Xl)) @ ccico))))))))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xl:$i] : ((XL @ Xj @ Xk @ Xl) = (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ ((ccv @ Xx3) = cc0) @ ccc0 @ (ccprod @ (^ [Xk:$i] : (ccv @ Xx3)) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xb)) @ ccico) @ ccvol))))))))))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xl:$i] : ((XM @ Xx3 @ Xj @ Xk @ Xn @ Xa @ Xb @ Xl) = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xi:$i] : ((cwss @ (XI @ Xj @ Xk @ Xl) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi))))))))) & ((ccv @ Xz) = (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi)))) @ ccvol))))) @ ccsumge0)))) @ (^ [Xi:$i] : (cco @ (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap) @ ccn @ ccmap)))) @ (^ [Xz:$i] : ccxr)))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xl:$i] : ((XF @ Xx3 @ Xz @ Xi @ Xj @ Xa @ Xb @ Xl) = (ccmpt @ (^ [Xi:$i] : (cco @ (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap) @ ccn @ ccmap)) @ (^ [Xi:$i] : (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xl:$i] : XX) @ (^ [Xl:$i] : (ccfv @ (ccfv @ (ccv @ Xl) @ (ccfv @ (ccv @ Xn) @ (ccv @ Xi))) @ cc1st))))))))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xl:$i] : ((XS @ Xx3 @ Xz @ Xi @ Xj @ Xa @ Xb @ Xl) = (ccmpt @ (^ [Xi:$i] : (cco @ (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap) @ ccn @ ccmap)) @ (^ [Xi:$i] : (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xl:$i] : XX) @ (^ [Xl:$i] : (ccfv @ (ccfv @ (ccv @ Xl) @ (ccfv @ (ccv @ Xn) @ (ccv @ Xi))) @ cc2nd))))))))))))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xl:$i] : ((Xph @ Xj) => (cwbr @ (cco @ (XA2 @ Xx3 @ Xj @ Xn @ Xl) @ (XB2 @ Xx3 @ Xj @ Xn @ Xl) @ (ccfv @ XX @ (XL @ Xj @ Xk @ Xl))) @ (ccfv @ (XI @ Xj @ Xk @ Xl) @ (ccfv @ XX @ ccovoln)) @ ccle)))))))))))))))))))))))))).
