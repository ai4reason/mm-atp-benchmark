...
thf(adom2lem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => ((cwcel @ (ccv @ Xx3) @ XA2) => (cwcel @ (XC @ Xx3) @ XB2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XA2)) => (((XC @ Xx3) = (XD @ Xy1)) <=> ((ccv @ Xx3) = (ccv @ Xy1))))))) => (Xph => (cwf1 @ XA2 @ XB2 @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))))))))))).
...
thf(ahausnei_ax,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xm:$i] : (! [Xn:$i] : ((XX @ Xm @ Xn) = (ccuni @ XJ)))) => (! [Xm:$i] : (! [Xn:$i] : (((cwcel @ XJ @ ccha) & (cw3a @ (cwcel @ XP @ (XX @ Xm @ Xn)) @ (cwcel @ XQ @ (XX @ Xm @ Xn)) @ (cwne @ XP @ XQ))) => (cwrex @ (^ [Xn:$i] : (cwrex @ (^ [Xm:$i] : (cw3a @ (cwcel @ XP @ (ccv @ Xn)) @ (cwcel @ XQ @ (ccv @ Xm)) @ ((ccin @ (ccv @ Xn) @ (ccv @ Xm)) = cc0))) @ (^ [Xm:$i] : XJ))) @ (^ [Xn:$i] : XJ))))))))))).
...
thf(anelneq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ XB2) & (~ (cwcel @ XA2 @ XC))) => (~ (XB2 = XC))))))).
...
thf(chauspwpwf1_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xa:$i] : ((XX @ Xa) = (ccuni @ XJ))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xa:$i] : ((XF @ Xx3 @ Xj @ Xa) = (ccmpt @ (^ [Xx3:$i] : (ccfv @ XA2 @ (ccfv @ XJ @ cccl))) @ (^ [Xx3:$i] : (ccab @ (^ [Xa:$i] : (cwrex @ (^ [Xj:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xj)) & ((ccv @ Xa) = (ccin @ (ccv @ Xj) @ XA2)))) @ (^ [Xj:$i] : XJ)))))))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xa:$i] : (((cwcel @ XJ @ ccha) & (cwss @ XA2 @ (XX @ Xa))) => (cwf1 @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (ccpw @ (ccpw @ XA2)) @ (XF @ Xx3 @ Xj @ Xa))))))))))))).
