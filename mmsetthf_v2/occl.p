...
thf(aoccllem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwss @ XA2 @ cchil)) => ((Xph => (cwcel @ XF @ cccau)) => ((Xph => (cwf @ ccn @ (ccfv @ XA2 @ ccort) @ XF)) => ((Xph => (cwcel @ XB2 @ XA2)) => (Xph => ((cco @ (ccfv @ XF @ cchli) @ XB2 @ ccsp) = ccc0))))))))))).
...
thf(aisch3_ax,axiom,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) <=> ((cwcel @ XH @ ccsh) & (cwral @ (^ [Xf1:$i] : ((cwf @ ccn @ XH @ (ccv @ Xf1)) => (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xf1) @ (ccv @ Xx3) @ cchli)) @ (^ [Xx3:$i] : XH)))) @ (^ [Xf1:$i] : cccau)))))).
