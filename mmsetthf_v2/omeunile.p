...
thf(comeunile_conj,conjecture,(! [Xph:$o] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XX = (ccuni @ (ccdm @ XO))) => ((Xph => (cwss @ XY @ (ccpw @ XX))) => ((Xph => (cwbr @ XY @ ccom @ ccdom)) => (Xph => (cwbr @ (ccfv @ (ccuni @ XY) @ XO) @ (ccfv @ (ccres @ XO @ XY) @ ccsumge0) @ ccle))))))))))).
