...
thf(aopi1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwcel @ (ccsn @ XA2) @ (ccop @ XA2 @ XB2))))))).
thf(aid_ax,axiom,(! [Xph:$o] : (Xph => Xph))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(aoprcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ (ccop @ XA2 @ XB2)) => ((cwcel @ XA2 @ ccvv) & (cwcel @ XB2 @ ccvv))))))).
...
thf(apreqr2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (((ccpr @ XC @ XA2) = (ccpr @ XC @ XB2)) => (XA2 = XB2)))))))).
...
thf(copth_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (((ccop @ XA2 @ XB2) = (ccop @ XC @ XD)) <=> ((XA2 = XC) & (XB2 = XD)))))))))).
