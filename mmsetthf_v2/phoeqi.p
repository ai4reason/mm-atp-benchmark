...
thf(aip2eqi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XP = (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => (((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => ((cwral @ (^ [Xx3:$i] : ((cco @ (ccv @ Xx3) @ XA2 @ XP) = (cco @ (ccv @ Xx3) @ XB2 @ XP))) @ (^ [Xx3:$i] : XX)) <=> (XA2 = XB2)))))))))))).
