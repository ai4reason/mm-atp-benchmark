...
thf(atrclfvcom_ax,axiom,(! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XR @ XV) => ((cccom @ (ccfv @ XR @ cctcl) @ XR) = (cccom @ XR @ (ccfv @ XR @ cctcl))))))).
thf(ctrclfvdecoml_conj,conjecture,(! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XR @ XV) => ((ccfv @ XR @ cctcl) = (ccun @ XR @ (cccom @ XR @ (ccfv @ XR @ cctcl)))))))).
