...
thf(aspanss2_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ cchil) => (cwss @ XA2 @ (ccfv @ XA2 @ ccspn))))).
...
thf(aelspani_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwss @ XA2 @ cchil) => ((cwcel @ XB2 @ (ccfv @ XA2 @ ccspn)) <=> (cwral @ (^ [Xx3:$i] : ((cwss @ XA2 @ (ccv @ Xx3)) => (cwcel @ XB2 @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccsh)))))))).
...
thf(cspanuni_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ cchil) => ((cwss @ XB2 @ cchil) => ((ccfv @ (ccun @ XA2 @ XB2) @ ccspn) = (cco @ (ccfv @ XA2 @ ccspn) @ (ccfv @ XB2 @ ccspn) @ ccph))))))).
