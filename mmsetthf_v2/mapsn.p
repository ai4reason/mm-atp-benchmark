...
thf(cmapsn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cco @ XA2 @ (ccsn @ XB2) @ ccmap) = (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xf1) = (ccsn @ (ccop @ XB2 @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : XA2)))))))))).
