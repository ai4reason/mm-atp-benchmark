...
thf(acmn12_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (((cwcel @ XG @ cccmn) & (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2))) => ((cco @ XX @ (cco @ XY @ XZ @ Xc_pl) @ Xc_pl) = (cco @ XY @ (cco @ XX @ XZ @ Xc_pl) @ Xc_pl)))))))))))).
...
thf(aringvcl_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ (cco @ XB2 @ XI @ ccmap)) @ (cwcel @ XY @ (cco @ XB2 @ XI @ ccmap))) => (cwcel @ (cco @ XX @ XY @ (ccof @ Xc_x)) @ (cco @ XB2 @ XI @ ccmap)))))))))))).
...
thf(cmamuvs2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XR @ cccrg)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XF = (cco @ XR @ (ccotp @ XM @ XN @ XO) @ ccmmul)) => ((Xph => (cwcel @ XM @ ccfn)) => ((Xph => (cwcel @ XN @ ccfn)) => ((Xph => (cwcel @ XO @ ccfn)) => ((Xph => (cwcel @ XX @ (cco @ XB2 @ (ccxp @ XM @ XN) @ ccmap))) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XZ @ (cco @ XB2 @ (ccxp @ XN @ XO) @ ccmap))) => (Xph => ((cco @ XX @ (cco @ (ccxp @ (ccxp @ XN @ XO) @ (ccsn @ XY)) @ XZ @ (ccof @ Xc_x)) @ XF) = (cco @ (ccxp @ (ccxp @ XM @ XO) @ (ccsn @ XY)) @ (cco @ XX @ XZ @ XF) @ (ccof @ Xc_x)))))))))))))))))))))))))).
