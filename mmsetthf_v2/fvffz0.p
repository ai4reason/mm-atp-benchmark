...
thf(cfvffz0_conj,conjecture,(! [XP:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (((cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XI @ ccn0) @ (cwbr @ XI @ XN @ cclt)) & (cwf @ (cco @ ccc0 @ XN @ ccfz) @ XV @ XP)) => (cwcel @ (ccfv @ XI @ XP) @ XV))))))).
