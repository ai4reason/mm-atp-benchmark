...
thf(acoe1ae0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : ((! [Xn:$i] : (! [Xs1:$i] : (XA2 = (ccfv @ (XF @ Xn @ Xs1) @ ccco1)))) => ((! [Xn:$i] : (! [Xs1:$i] : ((XB2 @ Xn @ Xs1) = (ccfv @ (XP @ Xn @ Xs1) @ ccbs)))) => ((! [Xn:$i] : (! [Xs1:$i] : ((XP @ Xn @ Xs1) = (ccfv @ (XR @ Xn @ Xs1) @ ccpl1)))) => ((! [Xn:$i] : (! [Xs1:$i] : (Xc_0 = (ccfv @ (XR @ Xn @ Xs1) @ cc0g)))) => (! [Xn:$i] : (! [Xs1:$i] : ((cwcel @ (XF @ Xn @ Xs1) @ (XB2 @ Xn @ Xs1)) => (cwrex @ (^ [Xs1:$i] : (cwral @ (^ [Xn:$i] : ((cwbr @ (ccv @ Xs1) @ (ccv @ Xn) @ cclt) => ((ccfv @ (ccv @ Xn) @ XA2) = Xc_0))) @ (^ [Xn:$i] : ccn0))) @ (^ [Xs1:$i] : ccn0)))))))))))))))).
