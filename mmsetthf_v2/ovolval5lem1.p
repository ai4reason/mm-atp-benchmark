...
thf(avolioore_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccioo) @ ccvol) = (ccif @ (cwbr @ XA2 @ XB2 @ ccle) @ (cco @ XB2 @ XA2 @ ccmin) @ ccc0)))))).
...
thf(asublevolico_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => (cwbr @ (cco @ XB2 @ XA2 @ ccmin) @ (ccfv @ (cco @ XA2 @ XB2 @ ccico) @ ccvol) @ ccle)))))))).
