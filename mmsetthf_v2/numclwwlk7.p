...
thf(anumclwwlk6_ax,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cw3a @ (cwbr @ XG @ XK @ ccrusgr) @ (cwcel @ XG @ ccfrgr) @ (cwcel @ XV @ ccfn)) & ((cwcel @ XP @ ccprime) & (cwbr @ XP @ (cco @ XK @ cc1 @ ccmin) @ ccdvds))) => ((cco @ (ccfv @ (cco @ XP @ XG @ ccclwwlkn) @ cchash) @ XP @ ccmo) = (cco @ (ccfv @ XV @ cchash) @ XP @ ccmo))))))))).
...
thf(afrrusgrord_ax,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XV @ ccfn) & (cwne @ XV @ cc0)) => (((cwcel @ XG @ ccfrgr) & (cwbr @ XG @ XK @ ccrusgr)) => ((ccfv @ XV @ cchash) = (cco @ (cco @ XK @ (cco @ XK @ cc1 @ ccmin) @ ccmul) @ cc1 @ ccaddc))))))))).
thf(anumclwwlk7lem_ax,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((((cwbr @ XG @ XK @ ccrusgr) & (cwcel @ XG @ ccfrgr)) & ((cwne @ XV @ cc0) & (cwcel @ XV @ ccfn))) => (cwcel @ XK @ ccn0))))))).
...
thf(amulmoddvds_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) => ((cwbr @ XN @ XA2 @ ccdvds) => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ XN @ ccmo) = ccc0))))))).
...
thf(cnumclwwlk7_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cw3a @ ((cwbr @ XG @ XK @ ccrusgr) & (cwcel @ XG @ ccfrgr)) @ ((cwne @ XV @ cc0) & (cwcel @ XV @ ccfn)) @ ((cwcel @ XP @ ccprime) & (cwbr @ XP @ (cco @ XK @ cc1 @ ccmin) @ ccdvds))) => ((cco @ (ccfv @ (cco @ XP @ XG @ ccclwwlkn) @ cchash) @ XP @ ccmo) = cc1)))))))).
