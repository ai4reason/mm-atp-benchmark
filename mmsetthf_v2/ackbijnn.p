...
thf(ahashgval2_ax,axiom,((ccres @ cchash @ ccom) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc1 @ ccaddc))) @ ccc0) @ ccom))).
...
thf(admhashres_ax,axiom,(! [XA2:($i > $o)] : ((ccdm @ (ccres @ cchash @ XA2)) = XA2))).
...
thf(ahashcard_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfn) => ((ccfv @ (ccfv @ XA2 @ cccrd) @ cchash) = (ccfv @ XA2 @ cchash))))).
...
thf(ainvdisj_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((XC @ Xy1) = (ccv @ Xx3))) @ (^ [Xy1:$i] : (XB2 @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (cwdisj @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))).
...
thf(ahashpw_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfn) => ((ccfv @ (ccpw @ XA2) @ cchash) = (cco @ cc2 @ (ccfv @ XA2 @ cchash) @ ccexp))))).
...
thf(cackbijnn_conj,conjecture,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccn0) @ ccfn)) @ (^ [Xx3:$i] : (ccsu @ (ccv @ Xx3) @ (^ [Xy1:$i] : (cco @ cc2 @ (ccv @ Xy1) @ ccexp)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwf1o @ (ccin @ (ccpw @ ccn0) @ ccfn) @ ccn0 @ (XF @ Xx3 @ Xy1))))))).
