...
thf(aovolfsval_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XG = (cccom @ (cccom @ ccabs @ ccmin) @ XF)) => (((cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF) & (cwcel @ XN @ ccn)) => ((ccfv @ XN @ XG) = (cco @ (ccfv @ (ccfv @ XN @ XF) @ cc2nd) @ (ccfv @ (ccfv @ XN @ XF) @ cc1st) @ ccmin)))))))).
...
thf(axpiundir_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((ccxp @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XC) = (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (ccxp @ (XB2 @ Xx3) @ XC)))))))).
...
thf(a_2ndconst_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwf1o @ (ccxp @ (ccsn @ XA2) @ XB2) @ XB2 @ (ccres @ cc2nd @ (ccxp @ (ccsn @ XA2) @ XB2)))))))).
...
thf(aelnnz1_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) <=> ((cwcel @ XN @ ccz) & (cwbr @ cc1 @ XN @ ccle))))).
...
thf(ageo2sum_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XA2 @ ccc)) => ((ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ XA2 @ (cco @ cc2 @ (ccv @ Xk) @ ccexp) @ ccdiv))) = (cco @ XA2 @ (cco @ XA2 @ (cco @ cc2 @ XN @ ccexp) @ ccdiv) @ ccmin)))))).
