...
thf(aslttrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccsur)) => ((Xph => (cwcel @ XB2 @ ccsur)) => ((Xph => (cwcel @ XC @ ccsur)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccslt)) => ((Xph => (cwbr @ XB2 @ XC @ ccslt)) => (Xph => (cwbr @ XA2 @ XC @ ccslt)))))))))))).
...
thf(csslttr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwbr @ XA2 @ XB2 @ ccsslt) @ (cwbr @ XB2 @ XC @ ccsslt) @ (cwne @ XB2 @ cc0)) => (cwbr @ XA2 @ XC @ ccsslt)))))).
