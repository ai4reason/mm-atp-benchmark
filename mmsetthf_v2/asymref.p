...
thf(aopeluu_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ (ccop @ XA2 @ XB2) @ XC) => ((cwcel @ XA2 @ (ccuni @ (ccuni @ XC))) & (cwcel @ XB2 @ (ccuni @ (ccuni @ XC))))))))))).
...
thf(casymref_conj,conjecture,(! [XR:($i > $o)] : (((ccin @ XR @ (cccnv @ XR)) = (ccres @ ccid @ (ccuni @ (ccuni @ XR)))) <=> (cwral @ (^ [Xx3:$i] : (! [Xy1:$i] : (((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR)) <=> ((ccv @ Xx3) = (ccv @ Xy1))))) @ (^ [Xx3:$i] : (ccuni @ (ccuni @ XR))))))).
