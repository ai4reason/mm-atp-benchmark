...
thf(cs3iunsndisj_conj,conjecture,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XB2 @ XX) => (cwdisj @ (^ [Xa:$i] : XY) @ (^ [Xa:$i] : (cciun @ (^ [Xc:$i] : (ccdif @ XZ @ (ccsn @ (ccv @ Xa)))) @ (^ [Xc:$i] : (ccsn @ (ccs3 @ (ccv @ Xa) @ XB2 @ (ccv @ Xc))))))))))))).
