...
thf(aaleph0_ax,axiom,((ccfv @ cc0 @ ccale) = ccom)).
...
thf(acardiun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((cwral @ (^ [Xx3:$i] : ((ccfv @ (XB2 @ Xx3) @ cccrd) = (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2)) => ((ccfv @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cccrd) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))))).
...
thf(calephcard_conj,conjecture,(! [XA2:($i > $o)] : ((ccfv @ (ccfv @ XA2 @ ccale) @ cccrd) = (ccfv @ XA2 @ ccale)))).
