...
thf(adf_locfin_ax,axiom,(cclocfin = (ccmpt @ (^ [Xx3:$i] : cctop) @ (^ [Xx3:$i] : (ccab @ (^ [Xy1:$i] : (((ccuni @ (ccv @ Xx3)) = (ccuni @ (ccv @ Xy1))) & (cwral @ (^ [Xp:$i] : (cwrex @ (^ [Xn:$i] : ((cwcel @ (ccv @ Xp) @ (ccv @ Xn)) & (cwcel @ (ccrab @ (^ [Xs1:$i] : (cwne @ (ccin @ (ccv @ Xs1) @ (ccv @ Xn)) @ cc0)) @ (^ [Xs1:$i] : (ccv @ Xy1))) @ ccfn))) @ (^ [Xn:$i] : (ccv @ Xx3)))) @ (^ [Xp:$i] : (ccuni @ (ccv @ Xx3))))))))))).
