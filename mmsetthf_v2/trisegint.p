...
thf(ctrisegint_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee))) @ (cw3a @ (cwcel @ XD @ (ccfv @ XN @ ccee)) @ (cwcel @ XE @ (ccfv @ XN @ ccee)) @ (cwcel @ XP @ (ccfv @ XN @ ccee)))) => ((cw3a @ (cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn) @ (cwbr @ XE @ (ccop @ XD @ XC) @ ccbtwn) @ (cwbr @ XP @ (ccop @ XA2 @ XD) @ ccbtwn)) => (cwrex @ (^ [Xq:$i] : ((cwbr @ (ccv @ Xq) @ (ccop @ XP @ XC) @ ccbtwn) & (cwbr @ (ccv @ Xq) @ (ccop @ XB2 @ XE) @ ccbtwn))) @ (^ [Xq:$i] : (ccfv @ XN @ ccee))))))))))))).
