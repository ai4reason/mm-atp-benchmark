...
thf(adomen_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwbr @ XA2 @ XB2 @ ccdom) <=> (? [Xx3:$i] : ((cwbr @ XA2 @ (ccv @ Xx3) @ ccen) & (cwss @ (ccv @ Xx3) @ XB2)))))))).
