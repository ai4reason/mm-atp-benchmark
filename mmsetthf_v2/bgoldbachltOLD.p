...
thf(cbgoldbachltOLD_conj,conjecture,(cwrex @ (^ [Xm:$i] : ((cwbr @ (cco @ cc4 @ (cco @ cc10 @ (ccdc @ cc1 @ cc8) @ ccexp) @ ccmul) @ (ccv @ Xm) @ ccle) & (cwral @ (^ [Xn:$i] : (((cwbr @ cc4 @ (ccv @ Xn) @ cclt) & (cwbr @ (ccv @ Xn) @ (ccv @ Xm) @ cclt)) => (cwcel @ (ccv @ Xn) @ ccgbe))) @ (^ [Xn:$i] : cceven)))) @ (^ [Xm:$i] : ccn))).
