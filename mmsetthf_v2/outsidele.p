...
thf(abrsegle2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ ((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ ((cwcel @ XC @ (ccfv @ XN @ ccee)) & (cwcel @ XD @ (ccfv @ XN @ ccee)))) => ((cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ ccsegle) <=> (cwrex @ (^ [Xx3:$i] : ((cwbr @ XB2 @ (ccop @ XA2 @ (ccv @ Xx3)) @ ccbtwn) & (cwbr @ (ccop @ XA2 @ (ccv @ Xx3)) @ (ccop @ XC @ XD) @ cccgr))) @ (^ [Xx3:$i] : (ccfv @ XN @ ccee))))))))))).
...
thf(aoutsideofcom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cw3a @ (cwcel @ XP @ (ccfv @ XN @ ccee)) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)))) => ((cwbr @ XP @ (ccop @ XA2 @ XB2) @ ccoutsideof) <=> (cwbr @ XP @ (ccop @ XB2 @ XA2) @ ccoutsideof)))))))).
...
thf(aoutsidene1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cw3a @ (cwcel @ XP @ (ccfv @ XN @ ccee)) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)))) => ((cwbr @ XP @ (ccop @ XA2 @ XB2) @ ccoutsideof) => (cwne @ XA2 @ XP)))))))).
...
thf(abtwncomand_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XB2 @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XC @ (ccfv @ XN @ ccee))) => (((Xph & Xps) => (cwbr @ XA2 @ (ccop @ XB2 @ XC) @ ccbtwn)) => ((Xph & Xps) => (cwbr @ XA2 @ (ccop @ XC @ XB2) @ ccbtwn)))))))))))))).
thf(asimpr2l_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xta & (cw3a @ Xch @ (Xph & Xps) @ Xth)) => Xph))))))).
thf(abtwnswapid2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee)))) => (((cwbr @ XA2 @ (ccop @ XB2 @ XC) @ ccbtwn) & (cwbr @ XC @ (ccop @ XB2 @ XA2) @ ccbtwn)) => (XA2 = XC)))))))).
...
thf(aoutsideofeq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XR @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ (cw3a @ (cwcel @ XC @ (ccfv @ XN @ ccee)) @ (cwcel @ XX @ (ccfv @ XN @ ccee)) @ (cwcel @ XY @ (ccfv @ XN @ ccee)))) => ((((cwbr @ XA2 @ (ccop @ XX @ XR) @ ccoutsideof) & (cwbr @ (ccop @ XA2 @ XX) @ (ccop @ XB2 @ XC) @ cccgr)) & ((cwbr @ XA2 @ (ccop @ XY @ XR) @ ccoutsideof) & (cwbr @ (ccop @ XA2 @ XY) @ (ccop @ XB2 @ XC) @ cccgr))) => (XX = XY))))))))))).
...
thf(abtwnsegle_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee)))) => ((cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn) => (cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XA2 @ XC) @ ccsegle)))))))).
thf(coutsidele_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cw3a @ (cwcel @ XP @ (ccfv @ XN @ ccee)) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)))) => ((cwbr @ XP @ (ccop @ XA2 @ XB2) @ ccoutsideof) => ((cwbr @ (ccop @ XP @ XA2) @ (ccop @ XP @ XB2) @ ccsegle) <=> (cwbr @ XA2 @ (ccop @ XP @ XB2) @ ccbtwn))))))))).
