...
thf(aitg2addnc_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((Xph => (cwcel @ (ccfv @ XF @ ccitg2) @ ccr)) => ((Xph => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XG)) => ((Xph => (cwcel @ (ccfv @ XG @ ccitg2) @ ccr)) => (Xph => ((ccfv @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ ccitg2) = (cco @ (ccfv @ XF @ ccitg2) @ (ccfv @ XG @ ccitg2) @ ccaddc)))))))))))).
