...
thf(adifopab_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : ((ccdif @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1))))) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((Xph @ Xx3 @ Xy1) & (~ (Xps @ Xx3 @ Xy1)))))))))).
...
thf(adf_eprel_ax,axiom,(ccep = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))))))).
...
thf(cdfnelbr2_conj,conjecture,(ccnelbr = (ccdif @ (ccxp @ ccvv @ ccvv) @ ccep))).
