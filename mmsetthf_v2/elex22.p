...
thf(aanim12ii_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => (Xps => Xch)) => ((Xth => (Xps => Xta)) => ((Xph & Xth) => (Xps => (Xch & Xta))))))))))).
...
thf(celex22_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ XB2) & (cwcel @ XA2 @ XC)) => (? [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XB2) & (cwcel @ (ccv @ Xx3) @ XC)))))))).
