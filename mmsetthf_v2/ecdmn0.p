...
thf(aecexr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XA2 @ (ccec @ XB2 @ XR)) => (cwcel @ XB2 @ ccvv)))))).
...
thf(cecdmn0_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ XR)) <=> (cwne @ (ccec @ XA2 @ XR) @ cc0))))).
