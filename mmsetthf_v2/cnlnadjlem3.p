...
thf(acnlnadjlem2_ax,axiom,(! [XT:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : ((cwcel @ XT @ cclo) => ((cwcel @ XT @ cccop) => ((! [Xy1:$i] : (! [Xg1:$i] : ((XG @ Xy1 @ Xg1) = (ccmpt @ (^ [Xg1:$i] : cchil) @ (^ [Xg1:$i] : (cco @ (ccfv @ (ccv @ Xg1) @ XT) @ (ccv @ Xy1) @ ccsp)))))) => (! [Xy1:$i] : (! [Xg1:$i] : ((cwcel @ (ccv @ Xy1) @ cchil) => ((cwcel @ (XG @ Xy1 @ Xg1) @ cclf) & (cwcel @ (XG @ Xy1 @ Xg1) @ cccnfn))))))))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(aelin_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccin @ XB2 @ XC)) <=> ((cwcel @ XA2 @ XB2) & (cwcel @ XA2 @ XC))))))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(ccxp_tp,type,(ccxp : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccif_tp,type,(ccif : ($o > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(ariesz4_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ (ccin @ cclf @ cccnfn)) => (cwreu @ (^ [Xw:$i] : (cwral @ (^ [Xv:$i] : ((ccfv @ (ccv @ Xv) @ XT) = (cco @ (ccv @ Xv) @ (ccv @ Xw) @ ccsp))) @ (^ [Xv:$i] : cchil))) @ (^ [Xw:$i] : cchil))))).
