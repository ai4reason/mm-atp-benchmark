...
thf(arng1nnzr_ax,axiom,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((XM = (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccsn @ XZ)) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (ccsn @ (ccop @ (ccop @ XZ @ XZ) @ XZ))) @ (ccop @ (ccfv @ ccnx @ ccmulr) @ (ccsn @ (ccop @ (ccop @ XZ @ XZ) @ XZ))))) => ((cwcel @ XZ @ XV) => (cwnel @ XM @ ccnzr))))))).
