...
thf(ametdsle_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwss @ XS @ XX)) & ((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XX))) => (cwbr @ (ccfv @ XB2 @ (XF @ Xx3 @ Xy1)) @ (cco @ XA2 @ XB2 @ XD) @ ccle)))))))))))).
...
thf(cmetdsre_conj,conjecture,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccme)) @ (cwss @ XS @ XX) @ (cwne @ XS @ cc0)) => (cwf @ XX @ ccr @ (XF @ Xx3 @ Xy1))))))))))).
