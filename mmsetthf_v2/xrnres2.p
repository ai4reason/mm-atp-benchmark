...
thf(ainres_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccin @ XA2 @ (ccres @ XB2 @ XC)) = (ccres @ (ccin @ XA2 @ XB2) @ XC)))))).
thf(cxrnres2_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((ccres @ (ccxrn @ XR @ XS) @ XA2) = (ccxrn @ XR @ (ccres @ XS @ XA2))))))).
