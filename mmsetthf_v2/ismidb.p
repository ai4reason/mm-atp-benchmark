...
thf(amideu_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((XS = (ccfv @ XG @ ccmir)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwbr @ XG @ cc2 @ ccstrkgld)) => (Xph => (cwreu @ (^ [Xx3:$i] : (XB2 = (ccfv @ XA2 @ (ccfv @ (ccv @ Xx3) @ XS)))) @ (^ [Xx3:$i] : XP)))))))))))))))))))))).
...
thf(adf_mid_ax,axiom,(ccmid = (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (ccfv @ (ccv @ Xg1) @ ccbs))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccfv @ (ccv @ Xg1) @ ccbs))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccrio @ (^ [Xm:$i] : ((ccv @ Xb) = (ccfv @ (ccv @ Xa) @ (ccfv @ (ccv @ Xm) @ (ccfv @ (ccv @ Xg1) @ ccmir))))) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xg1) @ ccbs)))))))))).
...
thf(cismidb_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwbr @ XG @ cc2 @ ccstrkgld)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((XS = (ccfv @ XG @ ccmir)) => ((Xph => (cwcel @ XM @ XP)) => (Xph => ((XB2 = (ccfv @ XA2 @ (ccfv @ XM @ XS))) <=> ((cco @ XA2 @ XB2 @ (ccfv @ XG @ ccmid)) = XM)))))))))))))))))))))).
