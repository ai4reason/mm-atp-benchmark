...
thf(acpmatelimp_ax,axiom,(! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XS @ Xi @ Xj @ Xk) = (cco @ XN @ XR @ cccpmat))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XP @ Xi @ Xj @ Xk) = (ccfv @ XR @ ccpl1))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XC @ Xi @ Xj @ Xk) = (cco @ XN @ (XP @ Xi @ Xj @ Xk) @ ccmat))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XB2 @ Xi @ Xj @ Xk) = (ccfv @ (XC @ Xi @ Xj @ Xk) @ ccbs))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) => ((cwcel @ XM @ (XS @ Xi @ Xj @ Xk)) => ((cwcel @ XM @ (XB2 @ Xi @ Xj @ Xk)) & (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : ((ccfv @ (ccv @ Xk) @ (ccfv @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM) @ ccco1)) = (ccfv @ XR @ cc0g))) @ (^ [Xk:$i] : ccn))) @ (^ [Xj:$i] : XN))) @ (^ [Xi:$i] : XN)))))))))))))))))))).
...
thf(acply1mul_ax,axiom,(! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [Xc_xp:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xc:$i] : ((XP @ Xc) = (ccfv @ (XR @ Xc) @ ccpl1))) => ((! [Xc:$i] : ((XB2 @ Xc) = (ccfv @ (XP @ Xc) @ ccbs))) => ((! [Xc:$i] : (Xc_0 = (ccfv @ (XR @ Xc) @ cc0g))) => ((! [Xc:$i] : (Xc_xp = (ccfv @ (XP @ Xc) @ ccmulr))) => (! [Xc:$i] : (((cwcel @ (XR @ Xc) @ ccrg) & ((cwcel @ XF @ (XB2 @ Xc)) & (cwcel @ XG @ (XB2 @ Xc)))) => ((cwral @ (^ [Xc:$i] : (((ccfv @ (ccv @ Xc) @ (ccfv @ XF @ ccco1)) = Xc_0) & ((ccfv @ (ccv @ Xc) @ (ccfv @ XG @ ccco1)) = Xc_0))) @ (^ [Xc:$i] : ccn)) => (cwral @ (^ [Xc:$i] : ((ccfv @ (ccv @ Xc) @ (ccfv @ (cco @ XF @ XG @ Xc_xp) @ ccco1)) = Xc_0)) @ (^ [Xc:$i] : ccn))))))))))))))))).
...
thf(ccpmatmcllem_conj,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : (! [XC:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XN:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xc:$i] : ((XS @ Xi @ Xj @ Xk @ Xc) = (cco @ XN @ XR @ cccpmat)))))) => ((! [Xi:$i] : (! [Xj:$i] : ((XP @ Xi @ Xj) = (ccfv @ XR @ ccpl1)))) => ((! [Xi:$i] : (! [Xj:$i] : (XC = (cco @ XN @ (XP @ Xi @ Xj) @ ccmat)))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xc:$i] : ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) & ((cwcel @ (ccv @ Xx3) @ (XS @ Xi @ Xj @ Xk @ Xc)) & (cwcel @ (ccv @ Xy1) @ (XS @ Xi @ Xj @ Xk @ Xc)))) => (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwral @ (^ [Xc:$i] : ((ccfv @ (ccv @ Xc) @ (ccfv @ (cco @ (XP @ Xi @ Xj) @ (ccmpt @ (^ [Xk:$i] : XN) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xi) @ (ccv @ Xk) @ (ccv @ Xx3)) @ (cco @ (ccv @ Xk) @ (ccv @ Xj) @ (ccv @ Xy1)) @ (ccfv @ (XP @ Xi @ Xj) @ ccmulr)))) @ ccgsu) @ ccco1)) = (ccfv @ XR @ cc0g))) @ (^ [Xc:$i] : ccn))) @ (^ [Xj:$i] : XN))) @ (^ [Xi:$i] : XN)))))))))))))))))).
