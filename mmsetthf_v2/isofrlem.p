...
thf(adffr3_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwfr @ XA2 @ XR) <=> (! [Xx3:$i] : (((cwss @ (ccv @ Xx3) @ XA2) & (cwne @ (ccv @ Xx3) @ cc0)) => (cwrex @ (^ [Xy1:$i] : ((ccin @ (ccv @ Xx3) @ (ccima @ (cccnv @ XR) @ (ccsn @ (ccv @ Xy1)))) = cc0)) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))).
...
thf(aisomin_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (((cwiso @ XA2 @ XB2 @ XR @ XS @ XH) & ((cwss @ XC @ XA2) & (cwcel @ XD @ XA2))) => (((ccin @ XC @ (ccima @ (cccnv @ XR) @ (ccsn @ XD))) = cc0) <=> ((ccin @ (ccima @ XH @ XC) @ (ccima @ (cccnv @ XS) @ (ccsn @ (ccfv @ XD @ XH)))) = cc0))))))))))).
...
thf(cisofrlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : ((Xph => (cwiso @ XA2 @ XB2 @ XR @ XS @ XH)) => ((! [Xx3:$i] : (Xph => (cwcel @ (ccima @ XH @ (ccv @ Xx3)) @ ccvv))) => (Xph => ((cwfr @ XB2 @ XS) => (cwfr @ XA2 @ XR)))))))))))).
