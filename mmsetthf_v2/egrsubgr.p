...
thf(aedg0iedg0_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => ((XE = (ccfv @ XG @ ccedg)) => ((cwfun @ XI) => ((XE = cc0) <=> (XI = cc0))))))))).
...
thf(cegrsubgr_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ ((cwcel @ XG @ XW) & (cwcel @ XS @ XU)) @ (cwss @ (ccfv @ XS @ ccvtx) @ (ccfv @ XG @ ccvtx)) @ ((cwfun @ (ccfv @ XS @ cciedg)) & ((ccfv @ XS @ ccedg) = cc0))) => (cwbr @ XS @ XG @ ccsubgr))))))).
