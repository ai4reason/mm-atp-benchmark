...
thf(ar111_ax,axiom,(cwf1 @ ccon0 @ ccvv @ ccr1)).
...
thf(atskr1om_ax,axiom,(! [XT:($i > $o)] : (((cwcel @ XT @ cctsk) & (cwne @ XT @ cc0)) => (cwss @ (ccima @ ccr1 @ ccom) @ XT)))).
...
thf(ctskinf_conj,conjecture,(! [XT:($i > $o)] : (((cwcel @ XT @ cctsk) & (cwne @ XT @ cc0)) => (cwbr @ ccom @ XT @ ccdom)))).
