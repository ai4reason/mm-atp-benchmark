...
thf(cnnsum3primesprm_conj,conjecture,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprime) => (cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xf1:$i] : ((cwbr @ (ccv @ Xd) @ cc3 @ ccle) & (XP = (ccsu @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1))))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ ccmap)))) @ (^ [Xd:$i] : ccn))))).
