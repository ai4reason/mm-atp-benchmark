...
thf(astrlem1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((~ (cwss @ XA2 @ XB2)) => (cwrex @ (^ [Xu:$i] : ((ccfv @ (ccv @ Xu) @ ccno) = cc1)) @ (^ [Xu:$i] : (ccdif @ XA2 @ XB2))))))))).
