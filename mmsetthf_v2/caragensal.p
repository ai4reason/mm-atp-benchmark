...
thf(acaragendifcl_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XS = (ccfv @ XO @ cccaragen)) => ((Xph => (cwcel @ XE @ XS)) => (Xph => (cwcel @ (ccdif @ (ccuni @ XS) @ XE) @ XS)))))))))).
...
thf(acaragenunicl_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XS = (ccfv @ XO @ cccaragen)) => ((Xph => (cwss @ XX @ XS)) => ((Xph => (cwbr @ XX @ ccom @ ccdom)) => (Xph => (cwcel @ (ccuni @ XX) @ XS))))))))))).
