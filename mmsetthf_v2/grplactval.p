...
thf(cgrplactval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xc_pl:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((! [Xg1:$i] : (! [Xa:$i] : ((XF @ Xg1 @ Xa) = (ccmpt @ (^ [Xg1:$i] : XX) @ (^ [Xg1:$i] : (ccmpt @ (^ [Xa:$i] : XX) @ (^ [Xa:$i] : (cco @ (ccv @ Xg1) @ (ccv @ Xa) @ Xc_pl)))))))) => ((XX = (ccfv @ XG @ ccbs)) => (! [Xg1:$i] : (! [Xa:$i] : (((cwcel @ XA2 @ XX) & (cwcel @ (XB2 @ Xg1) @ XX)) => ((ccfv @ (XB2 @ Xg1) @ (ccfv @ XA2 @ (XF @ Xg1 @ Xa))) = (cco @ XA2 @ (XB2 @ Xg1) @ Xc_pl)))))))))))))).
