...
thf(anmgt0_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XG @ ccnm)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cwcel @ XG @ ccngp) & (cwcel @ XA2 @ XX)) => ((cwne @ XA2 @ Xc_0) <=> (cwbr @ ccc0 @ (ccfv @ XA2 @ XN) @ cclt)))))))))))).
...
thf(ancvsge0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ ccnm)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((cw3a @ (cwcel @ XW @ (ccin @ ccnvc @ cccvs)) @ ((cwcel @ XA2 @ (ccin @ XK @ ccr)) & (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwcel @ XB2 @ XV)) => ((ccfv @ (cco @ XA2 @ XB2 @ Xc_x) @ XN) = (cco @ XA2 @ (ccfv @ XB2 @ XN) @ ccmul))))))))))))))))).
...
thf(cncvs1_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XG @ ccnm)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xc_x = (ccfv @ XG @ ccvsca)) => ((XF = (ccfv @ XG @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((cw3a @ (cwcel @ XG @ (ccin @ ccnvc @ cccvs)) @ ((cwcel @ XA2 @ XX) & (cwne @ XA2 @ Xc_0)) @ (cwcel @ (cco @ cc1 @ (ccfv @ XA2 @ XN) @ ccdiv) @ XK)) => ((ccfv @ (cco @ (cco @ cc1 @ (ccfv @ XA2 @ XN) @ ccdiv) @ XA2 @ Xc_x) @ XN) = cc1))))))))))))))))).
