...
thf(aoawordeu_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) & (cwss @ XA2 @ XB2)) => (cwreu @ (^ [Xx3:$i] : ((cco @ XA2 @ (ccv @ Xx3) @ ccoa) = XB2)) @ (^ [Xx3:$i] : ccon0)))))).
...
thf(coaf1o_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (cwf1o @ ccon0 @ (ccdif @ ccon0 @ XA2) @ (ccmpt @ (^ [Xx3:$i] : ccon0) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccoa))))))).
