...
thf(achj12_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) => ((cco @ XA2 @ (cco @ XB2 @ XC @ cchj) @ cchj) = (cco @ XB2 @ (cco @ XA2 @ XC @ cchj) @ cchj))))))).
...
thf(cchj4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) & ((cwcel @ XC @ ccch) & (cwcel @ XD @ ccch))) => ((cco @ (cco @ XA2 @ XB2 @ cchj) @ (cco @ XC @ XD @ cchj) @ cchj) = (cco @ (cco @ XA2 @ XC @ cchj) @ (cco @ XB2 @ XD @ cchj) @ cchj)))))))).
