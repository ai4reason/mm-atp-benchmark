...
thf(cgrpokerinj_conj,conjecture,(! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccrn @ XG)) => ((XW = (ccfv @ XG @ ccgi)) => ((XY = (ccrn @ XH)) => ((XU = (ccfv @ XH @ ccgi)) => ((cw3a @ (cwcel @ XG @ ccgr) @ (cwcel @ XH @ ccgr) @ (cwcel @ XF @ (cco @ XG @ XH @ ccghomOLD))) => ((cwf1 @ XX @ XY @ XF) <=> ((ccima @ (cccnv @ XF) @ (ccsn @ XU)) = (ccsn @ XW)))))))))))))))).
