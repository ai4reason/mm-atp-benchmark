...
thf(cqabvexp_conj,conjecture,(! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XQ = (cco @ cccnfld @ ccq @ ccress)) => ((XA2 = (ccfv @ XQ @ ccabv)) => ((cw3a @ (cwcel @ XF @ XA2) @ (cwcel @ XM @ ccq) @ (cwcel @ XN @ ccn0)) => ((ccfv @ (cco @ XM @ XN @ ccexp) @ XF) = (cco @ (ccfv @ XM @ XF) @ XN @ ccexp))))))))))).
