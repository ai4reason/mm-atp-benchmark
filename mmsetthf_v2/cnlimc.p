...
thf(ccnlimc_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwss @ XA2 @ ccc) => ((cwcel @ XF @ (cco @ XA2 @ ccc @ cccncf)) <=> ((cwf @ XA2 @ ccc @ XF) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (cco @ XF @ (ccv @ Xx3) @ cclimc))) @ (^ [Xx3:$i] : XA2)))))))).
