...
thf(abj_restn0_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ XV) & (cwcel @ XA2 @ XW)) => ((cwne @ XX @ cc0) => (cwne @ (cco @ XX @ XA2 @ ccrest) @ cc0)))))))).
thf(cbj_restn0b_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ (ccdif @ XV @ (ccsn @ cc0))) & (cwcel @ XA2 @ XW)) => (cwne @ (cco @ XX @ XA2 @ ccrest) @ cc0))))))).
