...
thf(asymghash_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((cwcel @ XA2 @ ccfn) => ((ccfv @ XB2 @ cchash) = (ccfv @ (ccfv @ XA2 @ cchash) @ ccfa))))))))).
...
thf(afacubnd_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => (cwbr @ (ccfv @ XN @ ccfa) @ (cco @ XN @ XN @ ccexp) @ ccle)))).
thf(asylancom_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => (((Xch & Xps) => Xth) => ((Xph & Xps) => Xth)))))))).
thf(cc4_tp,type,(cc4 : ($i > $o))).
thf(ccc_tp,type,(ccc : ($i > $o))).
thf(cw3o_tp,type,(cw3o : ($o > ($o > ($o > $o))))).
thf(aexple2lt6_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwbr @ XN @ cc2 @ ccle)) => (cwbr @ (cco @ XN @ XN @ ccexp) @ cc6 @ cclt)))).
...
thf(alt6abl_ax,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ ccgrp) & (cwbr @ (ccfv @ XB2 @ cchash) @ cc6 @ cclt)) => (cwcel @ XG @ ccabl)))))).
