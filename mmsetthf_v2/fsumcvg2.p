...
thf(cfsumcvg2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (ccfv @ XM @ ccuz))) => ((ccfv @ (ccv @ Xk) @ XF) = (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ ccc0)))) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccc))) => ((Xph => (cwss @ XA2 @ (cco @ XM @ XN @ ccfz))) => (Xph => (cwbr @ (ccseq @ ccaddc @ XF @ XM) @ (ccfv @ XN @ (ccseq @ ccaddc @ XF @ XM)) @ ccli))))))))))))).
