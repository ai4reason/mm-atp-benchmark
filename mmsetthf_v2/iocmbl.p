...
thf(aioc0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => (((cco @ XA2 @ XB2 @ ccioc) = cc0) <=> (cwbr @ XB2 @ XA2 @ ccle)))))).
thf(a_0mbl_ax,axiom,(cwcel @ cc0 @ (ccdm @ ccvol))).
thf(ciocmbl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccr)) => (cwcel @ (cco @ XA2 @ XB2 @ ccioc) @ (ccdm @ ccvol)))))).
