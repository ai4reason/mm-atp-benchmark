...
thf(afun2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cwf @ XA2 @ XC @ XF) & (cwf @ XB2 @ XC @ XG)) & ((ccin @ XA2 @ XB2) = cc0)) => (cwf @ (ccun @ XA2 @ XB2) @ XC @ (ccun @ XF @ XG))))))))).
...
thf(cac6sfi_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (((ccv @ Xy1) = (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1))) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xx3 @ Xf1)))))) => (! [Xy1:$i] : (((cwcel @ (XA2 @ Xy1) @ ccfn) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1)))) => (? [Xf1:$i] : ((cwf @ (XA2 @ Xy1) @ XB2 @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xf1)) @ (^ [Xx3:$i] : (XA2 @ Xy1))))))))))))).
