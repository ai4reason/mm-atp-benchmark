...
thf(ahash2exprb_ax,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XV @ XW) => (((ccfv @ XV @ cchash) = cc2) <=> (? [Xa:$i] : (? [Xb:$i] : ((cwne @ (ccv @ Xa) @ (ccv @ Xb)) & (XV = (ccpr @ (ccv @ Xa) @ (ccv @ Xb))))))))))).
...
thf(chash2prb_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XV @ XW) => (((ccfv @ XV @ cchash) = cc2) <=> (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : ((cwne @ (ccv @ Xa) @ (ccv @ Xb)) & (XV = (ccpr @ (ccv @ Xa) @ (ccv @ Xb))))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))).
