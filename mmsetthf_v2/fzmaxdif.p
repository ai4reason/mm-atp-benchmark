...
thf(cfzmaxdif_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ ((cwcel @ XC @ ccz) & (cwcel @ XA2 @ (cco @ XB2 @ XC @ ccfz))) @ ((cwcel @ XF @ ccz) & (cwcel @ XD @ (cco @ XE @ XF @ ccfz))) @ (cwbr @ (cco @ XC @ XE @ ccmin) @ (cco @ XF @ XB2 @ ccmin) @ ccle)) => (cwbr @ (ccfv @ (cco @ XA2 @ XD @ ccmin) @ ccabs) @ (cco @ XF @ XB2 @ ccmin) @ ccle))))))))).
