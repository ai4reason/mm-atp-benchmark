...
thf(ahoma1_ax,axiom,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XH = (ccfv @ XC @ cchoma)) => ((cwbr @ XZ @ XF @ (cco @ XX @ XY @ XH)) => (XZ = (ccop @ XX @ XY))))))))))).
thf(adf_ot_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccotp @ XA2 @ XB2 @ XC) = (ccop @ (ccop @ XA2 @ XB2) @ XC)))))).
thf(chomadmcd_conj,conjecture,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (ccfv @ XC @ cchoma)) => ((cwcel @ XF @ (cco @ XX @ XY @ XH)) => (XF = (ccotp @ XX @ XY @ (ccfv @ XF @ cc2nd))))))))))).
