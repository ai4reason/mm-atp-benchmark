...
thf(auzssd3_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((cwcel @ XN @ XZ) => (cwss @ (ccfv @ XN @ ccuz) @ XZ))))))).
...
thf(axrpnf_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccxr) => ((XA2 = ccpnf) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ ccle)) @ (^ [Xx3:$i] : ccr)))))).
