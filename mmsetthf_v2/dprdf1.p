...
thf(cdprdf1_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : ((Xph => (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((Xph => ((ccdm @ XS) = XI)) => ((Xph => (cwf1 @ XJ @ XI @ XF)) => (Xph => ((cwbr @ XG @ (cccom @ XS @ XF) @ (ccdm @ ccdprd)) & (cwss @ (cco @ XG @ (cccom @ XS @ XF) @ ccdprd) @ (cco @ XG @ XS @ ccdprd)))))))))))))).
