...
thf(adf_atl_ax,axiom,(ccal = (ccrab @ (^ [Xk:$i] : ((cwcel @ (ccfv @ (ccv @ Xk) @ ccbs) @ (ccdm @ (ccfv @ (ccv @ Xk) @ ccglb))) & (cwral @ (^ [Xx3:$i] : ((cwne @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xk) @ ccp0)) => (cwrex @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xk) @ ccple))) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xk) @ ccatm))))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xk) @ ccbs))))) @ (^ [Xk:$i] : cclat)))).
thf(a_3anass_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) <=> (Xph & (Xps & Xch))))))).
thf(cisatl_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccfv @ XK @ ccbs))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XG @ Xx3 @ Xy1) = (ccfv @ XK @ ccglb)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_le @ Xx3 @ Xy1) = (ccfv @ XK @ ccple)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_0 @ Xx3 @ Xy1) = (ccfv @ XK @ ccp0)))) => ((! [Xx3:$i] : ((XA2 @ Xx3) = (ccfv @ XK @ ccatm))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XK @ ccal) <=> (cw3a @ (cwcel @ XK @ cclat) @ (cwcel @ (XB2 @ Xy1) @ (ccdm @ (XG @ Xx3 @ Xy1))) @ (cwral @ (^ [Xx3:$i] : ((cwne @ (ccv @ Xx3) @ (Xc_0 @ Xx3 @ Xy1)) => (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ (Xc_le @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (XA2 @ Xx3))))) @ (^ [Xx3:$i] : (XB2 @ Xy1))))))))))))))))))).
