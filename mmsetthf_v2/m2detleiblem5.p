...
thf(am2detleiblem1_ax,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XN = (ccpr @ cc1 @ cc2)) => ((XP = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((XY = (ccfv @ XR @ cczrh)) => ((XS = (ccfv @ XN @ ccpsgn)) => ((Xc_1 = (ccfv @ XR @ ccur)) => (((cwcel @ XR @ ccrg) & (cwcel @ XQ @ XP)) => ((ccfv @ (ccfv @ XQ @ XS) @ XY) = (cco @ (ccfv @ XQ @ (ccfv @ XN @ ccpsgn)) @ Xc_1 @ (ccfv @ XR @ ccmg))))))))))))))))).
