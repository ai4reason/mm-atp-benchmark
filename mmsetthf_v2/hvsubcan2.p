...
thf(ahvmulcan_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ ((cwcel @ XA2 @ ccc) & (cwne @ XA2 @ ccc0)) @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil)) => (((cco @ XA2 @ XB2 @ ccsm) = (cco @ XA2 @ XC @ ccsm)) <=> (XB2 = XC))))))).
thf(aeqeq12d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((XA2 = XC) <=> (XB2 = XD))))))))))).
thf(ccif_tp,type,(ccif : ($o > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(ahvnegdi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => ((cco @ (ccneg @ cc1) @ (cco @ XA2 @ XB2 @ ccmv) @ ccsm) = (cco @ XB2 @ XA2 @ ccmv)))))).
thf(ahvsubcan_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil)) => (((cco @ XA2 @ XB2 @ ccmv) = (cco @ XA2 @ XC @ ccmv)) <=> (XB2 = XC))))))).
thf(chvsubcan2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil)) => (((cco @ XA2 @ XC @ ccmv) = (cco @ XB2 @ XC @ ccmv)) <=> (XA2 = XB2))))))).
