...
thf(amendsca_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((XA2 = (ccfv @ XM @ ccmend)) => ((XS = (ccfv @ XM @ ccsca)) => (XS = (ccfv @ XA2 @ ccsca)))))))).
...
thf(amendring_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : ((XA2 = (ccfv @ XM @ ccmend)) => ((cwcel @ XM @ cclmod) => (cwcel @ XA2 @ ccrg)))))).
...
thf(amendvsca_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (ccfv @ XM @ ccmend)) => ((Xc_x = (ccfv @ XM @ ccvsca)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XS = (ccfv @ XM @ ccsca)) => ((XK = (ccfv @ XS @ ccbs)) => ((XE = (ccfv @ XM @ ccbs)) => ((Xc_xb = (ccfv @ XA2 @ ccvsca)) => (((cwcel @ XX @ XK) & (cwcel @ XY @ XB2)) => ((cco @ XX @ XY @ Xc_xb) = (cco @ (ccxp @ XE @ (ccsn @ XX)) @ XY @ (ccof @ Xc_x)))))))))))))))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(a_3adant1l_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (((cw3a @ Xph @ Xps @ Xch) => Xth) => ((cw3a @ (Xta & Xph) @ Xps @ Xch) => Xth)))))))).
thf(almhmvsca_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XM @ ccbs)) => ((Xc_x = (ccfv @ XN @ ccvsca)) => ((XJ = (ccfv @ XN @ ccsca)) => ((XK = (ccfv @ XJ @ ccbs)) => ((cw3a @ (cwcel @ XJ @ cccrg) @ (cwcel @ XA2 @ XK) @ (cwcel @ XF @ (cco @ XM @ XN @ cclmhm))) => (cwcel @ (cco @ (ccxp @ XV @ (ccsn @ XA2)) @ XF @ (ccof @ Xc_x)) @ (cco @ XM @ XN @ cclmhm)))))))))))))))).
