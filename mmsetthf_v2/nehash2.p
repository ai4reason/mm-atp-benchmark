...
thf(cnehash2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XP @ XV)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwne @ XA2 @ XB2)) => (Xph => (cwbr @ cc2 @ (ccfv @ XP @ cchash) @ ccle)))))))))))).
