...
thf(a_1nuz2_ax,axiom,(~ (cwcel @ cc1 @ (ccfv @ cc2 @ ccuz)))).
thf(czgt1rpn0n1_conj,conjecture,(! [XB2:($i > $o)] : ((cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) => (cw3a @ (cwcel @ XB2 @ ccrp) @ (cwne @ XB2 @ ccc0) @ (cwne @ XB2 @ cc1))))).
