...
thf(azmodfzp1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccn)) => (cwcel @ (cco @ XA2 @ XB2 @ ccmo) @ (cco @ ccc0 @ XB2 @ ccfz)))))).
...
thf(ccshwlen_conj,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ ccz)) => ((ccfv @ (cco @ XW @ XN @ cccsh) @ cchash) = (ccfv @ XW @ cchash))))))).
