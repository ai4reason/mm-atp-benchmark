...
thf(cestrreslem2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (XC = (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ cchom) @ XH) @ (ccop @ (ccfv @ ccnx @ ccco) @ Xc_x)))) => ((Xph => (cwcel @ XB2 @ XV)) => ((Xph => (cwcel @ XH @ XX)) => ((Xph => (cwcel @ Xc_x @ XY)) => (Xph => (cwcel @ (ccfv @ ccnx @ ccbs) @ (ccdm @ XC)))))))))))))))).
