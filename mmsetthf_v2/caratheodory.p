...
thf(acaragensal_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XS = (ccfv @ XO @ cccaragen)) => (Xph => (cwcel @ XS @ ccsalg)))))))).
...
thf(aomef_ax,axiom,(! [Xph:$o] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XX = (ccuni @ (ccdm @ XO))) => (Xph => (cwf @ (ccpw @ XX) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XO)))))))).
...
thf(acaragenval_ax,axiom,(! [XO:($i > $o)] : ((cwcel @ XO @ ccome) => ((ccfv @ XO @ cccaragen) = (ccrab @ (^ [Xe:$i] : (cwral @ (^ [Xa:$i] : ((cco @ (ccfv @ (ccin @ (ccv @ Xa) @ (ccv @ Xe)) @ XO) @ (ccfv @ (ccdif @ (ccv @ Xa) @ (ccv @ Xe)) @ XO) @ ccxad) = (ccfv @ (ccv @ Xa) @ XO))) @ (^ [Xa:$i] : (ccpw @ (ccuni @ (ccdm @ XO)))))) @ (^ [Xe:$i] : (ccpw @ (ccuni @ (ccdm @ XO))))))))).
