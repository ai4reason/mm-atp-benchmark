...
thf(axpindir_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccxp @ (ccin @ XA2 @ XB2) @ XC) = (ccin @ (ccxp @ XA2 @ XC) @ (ccxp @ XB2 @ XC))))))).
...
thf(cimainrect_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XY:($i > $o)] : ((ccima @ (ccin @ XG @ (ccxp @ XA2 @ XB2)) @ XY) = (ccin @ (ccima @ XG @ (ccin @ XY @ XA2)) @ XB2))))))).
