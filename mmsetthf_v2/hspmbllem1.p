...
thf(avol0_ax,axiom,((ccfv @ cc0 @ ccvol) = ccc0)).
...
thf(chspmbllem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((! [Xa:$i] : (! [Xb:$i] : (Xph => (cwcel @ (XK @ Xa @ Xb) @ XX)))) => ((Xph => (cwcel @ XY @ ccr)) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwf @ XX @ ccr @ (XA2 @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwf @ XX @ ccr @ (XB2 @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((XL @ Xx3 @ Xy1 @ Xh @ Xk @ Xa @ Xb @ Xc) = (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ ((ccv @ Xx3) = cc0) @ ccc0 @ (ccprod @ (^ [Xk:$i] : (ccv @ Xx3)) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xb)) @ ccico) @ ccvol))))))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xh:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((XT @ Xx3 @ Xy1 @ Xh @ Xc) = (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (ccmpt @ (^ [Xc:$i] : (cco @ ccr @ XX @ ccmap)) @ (^ [Xc:$i] : (ccmpt @ (^ [Xh:$i] : XX) @ (^ [Xh:$i] : (ccif @ (cwcel @ (ccv @ Xh) @ (ccdif @ XX @ (ccsn @ (XK @ Xa @ Xb)))) @ (ccfv @ (ccv @ Xh) @ (ccv @ Xc)) @ (ccif @ (cwbr @ (ccfv @ (ccv @ Xh) @ (ccv @ Xc)) @ (ccv @ Xy1) @ ccle) @ (ccfv @ (ccv @ Xh) @ (ccv @ Xc)) @ (ccv @ Xy1)))))))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xh:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((XS @ Xx3 @ Xy1 @ Xh @ Xc) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xc:$i] : (cco @ ccr @ XX @ ccmap)) @ (^ [Xc:$i] : (ccmpt @ (^ [Xh:$i] : XX) @ (^ [Xh:$i] : (ccif @ ((ccv @ Xh) = (XK @ Xa @ Xb)) @ (ccif @ (cwbr @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xh) @ (ccv @ Xc)) @ ccle) @ (ccfv @ (ccv @ Xh) @ (ccv @ Xc)) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xh) @ (ccv @ Xc)))))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xh:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (Xph => ((cco @ (XA2 @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1) @ (ccfv @ XX @ (XL @ Xx3 @ Xy1 @ Xh @ Xk @ Xa @ Xb @ Xc))) = (cco @ (cco @ (XA2 @ Xx3 @ Xy1) @ (ccfv @ (XB2 @ Xx3 @ Xy1) @ (ccfv @ XY @ (XT @ Xx3 @ Xy1 @ Xh @ Xc))) @ (ccfv @ XX @ (XL @ Xx3 @ Xy1 @ Xh @ Xk @ Xa @ Xb @ Xc))) @ (cco @ (ccfv @ (XA2 @ Xx3 @ Xy1) @ (ccfv @ XY @ (XS @ Xx3 @ Xy1 @ Xh @ Xc))) @ (XB2 @ Xx3 @ Xy1) @ (ccfv @ XX @ (XL @ Xx3 @ Xy1 @ Xh @ Xk @ Xa @ Xb @ Xc))) @ ccxad)))))))))))))))))))))))))))).
