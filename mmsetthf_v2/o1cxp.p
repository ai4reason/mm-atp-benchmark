...
thf(aabscxpbnd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwbr @ ccc0 @ (ccfv @ XB2 @ ccre) @ ccle)) => ((Xph => (cwcel @ XM @ ccr)) => ((Xph => (cwbr @ (ccfv @ XA2 @ ccabs) @ XM @ ccle)) => (Xph => (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ cccxp) @ ccabs) @ (cco @ (cco @ XM @ (ccfv @ XB2 @ ccre) @ cccxp) @ (ccfv @ (cco @ (ccfv @ XB2 @ ccabs) @ ccpi @ ccmul) @ cce) @ ccmul) @ ccle)))))))))))).
...
thf(co1cxp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwbr @ ccc0 @ (ccfv @ XC @ ccre) @ ccle)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3)))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cco1)) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xx3) @ XC @ cccxp))) @ cco1)))))))))))).
