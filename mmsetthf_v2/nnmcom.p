...
thf(annm0r_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccom) => ((cco @ cc0 @ XA2 @ ccomu) = cc0)))).
...
thf(annmsucr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => ((cco @ (ccsuc @ XA2) @ XB2 @ ccomu) = (cco @ (cco @ XA2 @ XB2 @ ccomu) @ XB2 @ ccoa)))))).
...
thf(cnnmcom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => ((cco @ XA2 @ XB2 @ ccomu) = (cco @ XB2 @ XA2 @ ccomu)))))).
