...
thf(afrgr2wwlkn0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cw3a @ (cwcel @ XG @ ccfrgr) @ ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) @ (cwne @ XA2 @ XB2)) => (cwne @ (cco @ XA2 @ XB2 @ (cco @ cc2 @ XG @ ccwwlksnon)) @ cc0)))))))).
...
thf(aelwwlks2ons3_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XW @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwlksnon))) <=> (cwrex @ (^ [Xb:$i] : ((XW = (ccs3 @ XA2 @ (ccv @ Xb) @ XC)) & (cwcel @ (ccs3 @ XA2 @ (ccv @ Xb) @ XC) @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwlksnon))))) @ (^ [Xb:$i] : XV)))))))))).
...
thf(aeqeuel_ax,axiom,(! [XA2:($i > $o)] : (((cwne @ XA2 @ cc0) & (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XA2)) => ((ccv @ Xx3) = (ccv @ Xy1)))))) => (cweu @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2)))))).
...
thf(cfrgr2wwlk1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cw3a @ (cwcel @ XG @ ccfrgr) @ ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) @ (cwne @ XA2 @ XB2)) => ((ccfv @ (cco @ XA2 @ XB2 @ (cco @ cc2 @ XG @ ccwwlksnon)) @ cchash) = cc1)))))))).
