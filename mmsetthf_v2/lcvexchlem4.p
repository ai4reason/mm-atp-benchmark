...
thf(alcvexchlem1_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((XS = (ccfv @ XW @ cclss)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((XC = (ccfv @ XW @ cclcv)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XT @ XS)) => ((Xph => (cwcel @ XU @ XS)) => (Xph => ((cwpss @ XT @ (cco @ XT @ XU @ Xc_po)) <=> (cwpss @ (ccin @ XT @ XU) @ XU))))))))))))))))).
...
thf(alsmless1_ax,axiom,(! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((Xc_po = (ccfv @ XG @ cclsm)) => ((cw3a @ (cwcel @ XT @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XU @ (ccfv @ XG @ ccsubg)) @ (cwss @ XS @ XT)) => (cwss @ (cco @ XS @ XU @ Xc_po) @ (cco @ XT @ XU @ Xc_po)))))))))).
...
thf(alcvbr3_ax,axiom,(! [Xph:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : ((XS = (ccfv @ XW @ cclss)) => ((! [Xs1:$i] : ((XC @ Xs1) = (ccfv @ XW @ cclcv))) => ((! [Xs1:$i] : ((Xph @ Xs1) => (cwcel @ XW @ (XX @ Xs1)))) => ((! [Xs1:$i] : ((Xph @ Xs1) => (cwcel @ XT @ XS))) => ((! [Xs1:$i] : ((Xph @ Xs1) => (cwcel @ XU @ XS))) => (! [Xs1:$i] : ((Xph @ Xs1) => ((cwbr @ XT @ XU @ (XC @ Xs1)) <=> ((cwpss @ XT @ XU) & (cwral @ (^ [Xs1:$i] : (((cwss @ XT @ (ccv @ Xs1)) & (cwss @ (ccv @ Xs1) @ XU)) => (((ccv @ Xs1) = XT) | ((ccv @ Xs1) = XU)))) @ (^ [Xs1:$i] : XS))))))))))))))))))).
...
thf(alcvexchlem2_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((XS = (ccfv @ XW @ cclss)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((XC = (ccfv @ XW @ cclcv)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XT @ XS)) => ((Xph => (cwcel @ XU @ XS)) => ((Xph => (cwcel @ XR @ XS)) => ((Xph => (cwss @ (ccin @ XT @ XU) @ XR)) => ((Xph => (cwss @ XR @ XU)) => (Xph => ((ccin @ (cco @ XR @ XT @ Xc_po) @ XU) = XR)))))))))))))))))))).
...
thf(clcvexchlem4_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((XS = (ccfv @ XW @ cclss)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((XC = (ccfv @ XW @ cclcv)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XT @ XS)) => ((Xph => (cwcel @ XU @ XS)) => ((Xph => (cwbr @ XT @ (cco @ XT @ XU @ Xc_po) @ XC)) => (Xph => (cwbr @ (ccin @ XT @ XU) @ XU @ XC))))))))))))))))).
