...
thf(cmrsubcv_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XC = (ccfv @ XT @ ccmcn)) => ((XV = (ccfv @ XT @ ccmvar)) => ((XR = (ccfv @ XT @ ccmrex)) => ((XS = (ccfv @ XT @ ccmrsub)) => ((cw3a @ (cwf @ XA2 @ XR @ XF) @ (cwss @ XA2 @ XV) @ (cwcel @ XX @ (ccun @ XC @ XV))) => ((ccfv @ (ccs1 @ XX) @ (ccfv @ XF @ XS)) = (ccif @ (cwcel @ XX @ XA2) @ (ccfv @ XX @ XF) @ (ccs1 @ XX))))))))))))))))).
