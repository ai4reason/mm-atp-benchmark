...
thf(apsmetres2_ax,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) & (cwss @ XR @ XX)) => (cwcel @ (ccres @ XD @ (ccxp @ XR @ XR)) @ (ccfv @ XR @ ccpsmet))))))).
...
thf(afgval_ax,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccfbas)) => ((cco @ XX @ XF @ ccfg) = (ccrab @ (^ [Xx3:$i] : (cwne @ (ccin @ XF @ (ccpw @ (ccv @ Xx3))) @ cc0)) @ (^ [Xx3:$i] : (ccpw @ XX)))))))).
...
thf(crestmetu_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwne @ XA2 @ cc0) @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwss @ XA2 @ XX)) => ((cco @ (ccfv @ XD @ ccmetu) @ (ccxp @ XA2 @ XA2) @ ccrest) = (ccfv @ (ccres @ XD @ (ccxp @ XA2 @ XA2)) @ ccmetu))))))).
