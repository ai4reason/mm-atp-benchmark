...
thf(ccaovcan_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XC @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS)) => (((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) = (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ XF)) => ((ccv @ Xy1) = (ccv @ Xz))))))) => (((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS)) => (((cco @ XA2 @ XB2 @ XF) = (cco @ XA2 @ XC @ XF)) => (XB2 = XC))))))))))).
