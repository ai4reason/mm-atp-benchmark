...
thf(aiooinlbub_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccin @ (cco @ XA2 @ XB2 @ ccioo) @ (ccpr @ XA2 @ XB2)) = cc0)))).
...
thf(ciccdifprioo_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((ccdif @ (cco @ XA2 @ XB2 @ ccicc) @ (ccpr @ XA2 @ XB2)) = (cco @ XA2 @ XB2 @ ccioo)))))).
