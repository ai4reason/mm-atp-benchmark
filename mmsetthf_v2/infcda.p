...
thf(aunnum_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwcel @ XB2 @ (ccdm @ cccrd))) => (cwcel @ (ccun @ XA2 @ XB2) @ (ccdm @ cccrd)))))).
...
thf(ainfcdaabs_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwbr @ XB2 @ XA2 @ ccdom)) => (cwbr @ (cco @ XA2 @ XB2 @ cccda) @ XA2 @ ccen))))).
...
thf(cinfcda_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwcel @ XB2 @ (ccdm @ cccrd)) @ (cwbr @ ccom @ XA2 @ ccdom)) => (cwbr @ (cco @ XA2 @ XB2 @ cccda) @ (ccun @ XA2 @ XB2) @ ccen))))).
