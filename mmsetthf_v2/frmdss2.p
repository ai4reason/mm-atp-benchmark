...
thf(agsumwsubmcl_ax,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XS @ (ccfv @ XG @ ccsubmnd)) & (cwcel @ XW @ (ccword @ XS))) => (cwcel @ (cco @ XG @ XW @ ccgsu) @ XS)))))).
...
thf(cfrmdss2_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XM = (ccfv @ XI @ ccfrmd)) => ((XU = (ccfv @ XI @ ccvrmd)) => ((cw3a @ (cwcel @ XI @ XV) @ (cwss @ XJ @ XI) @ (cwcel @ XA2 @ (ccfv @ XM @ ccsubmnd))) => ((cwss @ (ccima @ XU @ XJ) @ XA2) <=> (cwss @ (ccword @ XJ) @ XA2)))))))))))).
