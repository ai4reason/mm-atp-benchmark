...
thf(alkrss_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XR = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XR @ ccbs)) => ((XF = (ccfv @ XW @ cclfn)) => ((XL = (ccfv @ XW @ cclk)) => ((XD = (ccfv @ XW @ ccld)) => ((Xc_x = (ccfv @ XD @ ccvsca)) => ((Xph => (cwcel @ XW @ cclvec)) => ((Xph => (cwcel @ XG @ XF)) => ((Xph => (cwcel @ XX @ XK)) => (Xph => (cwss @ (ccfv @ XG @ XL) @ (ccfv @ (cco @ XX @ XG @ Xc_x) @ XL))))))))))))))))))))))).
...
thf(aldualvsub_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XR = (ccfv @ XW @ ccsca)) => ((XN = (ccfv @ XR @ ccminusg)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((XF = (ccfv @ XW @ cclfn)) => ((XD = (ccfv @ XW @ ccld)) => ((Xc_pl = (ccfv @ XD @ ccplusg)) => ((Xc_x = (ccfv @ XD @ ccvsca)) => ((Xc_mi = (ccfv @ XD @ ccsg)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XG @ XF)) => ((Xph => (cwcel @ XH @ XF)) => (Xph => ((cco @ XG @ XH @ Xc_mi) = (cco @ XG @ (cco @ (ccfv @ Xc_1 @ XN) @ XH @ Xc_x) @ Xc_pl))))))))))))))))))))))))))).
thf(clcfrlem2_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XU @ ccbs)) => ((XS = (ccfv @ XU @ ccsca)) => ((Xc_xp = (ccfv @ XS @ ccmulr)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => ((XI = (ccfv @ XS @ ccinvr)) => ((XF = (ccfv @ XU @ cclfn)) => ((XD = (ccfv @ XU @ ccld)) => ((Xc_x = (ccfv @ XD @ ccvsca)) => ((Xc_mi = (ccfv @ XD @ ccsg)) => ((Xph => (cwcel @ XU @ cclvec)) => ((Xph => (cwcel @ XE @ XF)) => ((Xph => (cwcel @ XG @ XF)) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwne @ (ccfv @ XX @ XG) @ Xc_0)) => ((XH = (cco @ XE @ (cco @ (cco @ (ccfv @ (ccfv @ XX @ XG) @ XI) @ (ccfv @ XX @ XE) @ Xc_xp) @ XG @ Xc_x) @ Xc_mi)) => ((XL = (ccfv @ XU @ cclk)) => (Xph => (cwss @ (ccin @ (ccfv @ XE @ XL) @ (ccfv @ XG @ XL)) @ (ccfv @ XH @ XL)))))))))))))))))))))))))))))))))))).
