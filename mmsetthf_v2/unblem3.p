...
thf(aonmindif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => (cwcel @ XB2 @ (ccint @ (ccdif @ XA2 @ (ccsuc @ XB2)))))))).
...
thf(aunblem1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwss @ XB2 @ ccom) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : ccom))) & (cwcel @ XA2 @ XB2)) => (cwcel @ (ccint @ (ccdif @ XB2 @ (ccsuc @ XA2))) @ XB2))))).
