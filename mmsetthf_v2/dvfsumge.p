...
thf(advfsumle_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ XM @ XN @ ccicc)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cco @ (cco @ XM @ XN @ ccicc) @ ccr @ cccncf))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XM @ XN @ ccioo))) => (cwcel @ (XB2 @ Xx3 @ Xk) @ (XV @ Xk))))) => ((! [Xk:$i] : (Xph => ((cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : (cco @ XM @ XN @ ccioo)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : (cco @ XM @ XN @ ccioo)) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xk)))))) => ((! [Xx3:$i] : (! [Xk:$i] : (((ccv @ Xx3) = XM) => ((XA2 @ Xx3) = (XC @ Xk))))) => ((! [Xx3:$i] : (! [Xk:$i] : (((ccv @ Xx3) = XN) => ((XA2 @ Xx3) = (XD @ Xk))))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfzo))) => (cwcel @ (XX @ Xk) @ ccr))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & ((cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfzo)) & (cwcel @ (ccv @ Xx3) @ (cco @ (ccv @ Xk) @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ ccioo)))) => (cwbr @ (XX @ Xk) @ (XB2 @ Xx3 @ Xk) @ ccle)))) => (! [Xk:$i] : (Xph => (cwbr @ (ccsu @ (cco @ XM @ XN @ ccfzo) @ (^ [Xk:$i] : (XX @ Xk))) @ (cco @ (XD @ Xk) @ (XC @ Xk) @ ccmin) @ ccle))))))))))))))))))))).
...
thf(acncfmpt2ss_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((cwcel @ XF @ (cco @ (cco @ XJ @ XJ @ cctx) @ XJ @ cccn)) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cco @ XX @ XS @ cccncf))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cco @ XX @ XS @ cccncf))) => ((cwss @ XS @ ccc) => ((! [Xx3:$i] : (((cwcel @ (XA2 @ Xx3) @ XS) & (cwcel @ (XB2 @ Xx3) @ XS)) => (cwcel @ (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ XF) @ XS))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ XF))) @ (cco @ XX @ XS @ cccncf))))))))))))))))).
...
thf(aneg2subd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => (Xph => ((cco @ (ccneg @ XA2) @ (ccneg @ XB2) @ ccmin) = (cco @ XB2 @ XA2 @ ccmin))))))))).
...
thf(cdvfsumge_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ XM @ XN @ ccicc)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cco @ (cco @ XM @ XN @ ccicc) @ ccr @ cccncf))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XM @ XN @ ccioo))) => (cwcel @ (XB2 @ Xx3 @ Xk) @ (XV @ Xk))))) => ((! [Xk:$i] : (Xph => ((cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : (cco @ XM @ XN @ ccioo)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : (cco @ XM @ XN @ ccioo)) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xk)))))) => ((! [Xx3:$i] : (! [Xk:$i] : (((ccv @ Xx3) = XM) => ((XA2 @ Xx3) = (XC @ Xk))))) => ((! [Xx3:$i] : (! [Xk:$i] : (((ccv @ Xx3) = XN) => ((XA2 @ Xx3) = (XD @ Xk))))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfzo))) => (cwcel @ (XX @ Xk) @ ccr))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & ((cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfzo)) & (cwcel @ (ccv @ Xx3) @ (cco @ (ccv @ Xk) @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ ccioo)))) => (cwbr @ (XB2 @ Xx3 @ Xk) @ (XX @ Xk) @ ccle)))) => (! [Xk:$i] : (Xph => (cwbr @ (cco @ (XD @ Xk) @ (XC @ Xk) @ ccmin) @ (ccsu @ (cco @ XM @ XN @ ccfzo) @ (^ [Xk:$i] : (XX @ Xk))) @ ccle))))))))))))))))))))).
