...
thf(cbnj1154_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cw_bnj17 @ (cwfr @ XA2 @ XR) @ (cwss @ XB2 @ XA2) @ (cwne @ XB2 @ cc0) @ (cwcel @ XB2 @ ccvv)) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))))))).
