...
thf(adf_dde_ax,axiom,(ccdde = (ccmpt @ (^ [Xa:$i] : (ccpw @ ccr)) @ (^ [Xa:$i] : (ccif @ (cwcel @ ccc0 @ (ccv @ Xa)) @ cc1 @ ccc0))))).
...
thf(cddeval0_conj,conjecture,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccr) & (~ (cwcel @ ccc0 @ XA2))) => ((ccfv @ XA2 @ ccdde) = ccc0)))).
