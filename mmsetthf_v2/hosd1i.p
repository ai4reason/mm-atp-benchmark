...
thf(ahoaddid1i_ax,axiom,(! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((cco @ XT @ cch0o @ cchos) = XT)))).
thf(ahoaddsubi_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XR) => ((cwf @ cchil @ cchil @ XS) => ((cwf @ cchil @ cchil @ XT) => ((cco @ (cco @ XR @ XS @ cchos) @ XT @ cchod) = (cco @ (cco @ XR @ XT @ cchod) @ XS @ cchos))))))))).
thf(ahodseqi_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XS) => ((cwf @ cchil @ cchil @ XT) => ((cco @ XS @ (cco @ XT @ XS @ cchod) @ cchos) = XT)))))).
thf(ahodsi_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XR) => ((cwf @ cchil @ cchil @ XS) => ((cwf @ cchil @ cchil @ XT) => (((cco @ XR @ XS @ cchod) = XT) <=> ((cco @ XS @ XT @ cchos) = XR))))))))).
thf(chosd1i_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((cwf @ cchil @ cchil @ XU) => ((cco @ XT @ XU @ cchos) = (cco @ XT @ (cco @ cch0o @ XU @ cchod) @ cchod))))))).
