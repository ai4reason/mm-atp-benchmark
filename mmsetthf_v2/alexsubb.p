...
thf(calexsubb_conj,conjecture,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ ccufl) & (XX = (ccuni @ XB2))) => ((cwcel @ (ccfv @ (ccfv @ XB2 @ ccfi) @ cctg) @ cccmp) <=> (cwral @ (^ [Xx3:$i] : ((XX = (ccuni @ (ccv @ Xx3))) => (cwrex @ (^ [Xy1:$i] : (XX = (ccuni @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccin @ (ccpw @ (ccv @ Xx3)) @ ccfn))))) @ (^ [Xx3:$i] : (ccpw @ XB2)))))))).
