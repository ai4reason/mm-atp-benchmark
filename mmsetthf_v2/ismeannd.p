...
thf(annfoctbdj_ax,axiom,(! [Xph:($i > $o)] : (! [XX:($i > $o)] : ((! [Xf1:$i] : ((Xph @ Xf1) => (cwbr @ XX @ ccom @ ccdom))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwne @ XX @ cc0))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwdisj @ (^ [Xy1:$i] : XX) @ (^ [Xy1:$i] : (ccv @ Xy1))))) => (! [Xf1:$i] : ((Xph @ Xf1) => (? [Xf1:$i] : ((cwfo @ ccn @ (ccun @ XX @ (ccsn @ cc0)) @ (ccv @ Xf1)) & (cwdisj @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)))))))))))))).
...
thf(afouniiun0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwfo @ XA2 @ (ccun @ XB2 @ (ccsn @ cc0)) @ XF) => ((ccuni @ XB2) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))))))))).
...
thf(a_0sal_ax,axiom,(! [XS:($i > $o)] : ((cwcel @ XS @ ccsalg) => (cwcel @ cc0 @ XS)))).
...
thf(cismeannd_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : ((! [Xe:$i] : (! [Xn:$i] : (Xph => (cwcel @ (XS @ Xe @ Xn) @ ccsalg)))) => ((! [Xe:$i] : (! [Xn:$i] : (Xph => (cwf @ (XS @ Xe @ Xn) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)))) => ((Xph => ((ccfv @ cc0 @ XM) = ccc0)) => ((! [Xe:$i] : (! [Xn:$i] : ((cw3a @ Xph @ (cwf @ ccn @ (XS @ Xe @ Xn) @ (ccv @ Xe)) @ (cwdisj @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (ccv @ Xe))))) => ((ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ (ccv @ Xe)))) @ XM) = (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xe)) @ XM))) @ ccsumge0))))) => (Xph => (cwcel @ XM @ ccmea)))))))))).
