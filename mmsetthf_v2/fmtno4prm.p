...
thf(afmtno4prmfac193_ax,axiom,(! [XP:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprime) @ (cwbr @ XP @ (ccfv @ cc4 @ ccfmtno) @ ccdvds) @ (cwbr @ XP @ (ccfv @ (ccfv @ (ccfv @ cc4 @ ccfmtno) @ ccsqrt) @ ccfl) @ ccle)) => (XP = (ccdc @ (ccdc @ cc1 @ cc9) @ cc3))))).
thf(amtbiri_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((~ Xch) => ((Xph => (Xps <=> Xch)) => (Xph => (~ Xps)))))))).
thf(cc8_tp,type,(cc8 : ($i > $o))).
thf(cc7_tp,type,(cc7 : ($i > $o))).
thf(afmtno4nprmfac193_ax,axiom,(~ (cwbr @ (ccdc @ (ccdc @ cc1 @ cc9) @ cc3) @ (ccfv @ cc4 @ ccfmtno) @ ccdvds))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(abreq1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((XA2 = XB2) => ((cwbr @ XA2 @ XC @ XR) <=> (cwbr @ XB2 @ XC @ XR)))))))).
thf(aisprm7_ax,axiom,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprime) <=> ((cwcel @ XP @ (ccfv @ cc2 @ ccuz)) & (cwral @ (^ [Xz:$i] : (~ (cwbr @ (ccv @ Xz) @ XP @ ccdvds))) @ (^ [Xz:$i] : (ccin @ (cco @ cc2 @ (ccfv @ (ccfv @ XP @ ccsqrt) @ ccfl) @ ccfz) @ ccprime))))))).
thf(cfmtno4prm_conj,conjecture,(cwcel @ (ccfv @ cc4 @ ccfmtno) @ ccprime)).
