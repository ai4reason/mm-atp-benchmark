...
thf(asylow2a_ax,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xc_po:($i > $o)] : (! [Xc_sm:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xu:$i] : (! [Xh:$i] : (XX = (ccfv @ (XG @ Xu @ Xh) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) => (cwcel @ Xc_po @ (cco @ (XG @ Xu @ Xh) @ XY @ ccga)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) => (cwbr @ (XP @ Xx3 @ Xy1 @ Xu @ Xg1 @ Xh) @ (XG @ Xu @ Xh) @ ccpgp))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : ((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) => (cwcel @ XX @ ccfn)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : ((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) => (cwcel @ XY @ ccfn)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((XZ @ Xx3 @ Xy1 @ Xu @ Xg1 @ Xh) = (ccrab @ (^ [Xu:$i] : (cwral @ (^ [Xh:$i] : ((cco @ (ccv @ Xh) @ (ccv @ Xu) @ Xc_po) = (ccv @ Xu))) @ (^ [Xh:$i] : XX))) @ (^ [Xu:$i] : XY)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : ((Xc_sm @ Xx3 @ Xy1 @ Xu @ Xg1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwss @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XY) & (cwrex @ (^ [Xg1:$i] : ((cco @ (ccv @ Xg1) @ (ccv @ Xx3) @ Xc_po) = (ccv @ Xy1))) @ (^ [Xg1:$i] : XX))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((Xph @ Xx3 @ Xy1 @ Xu @ Xg1) => (cwbr @ (XP @ Xx3 @ Xy1 @ Xu @ Xg1 @ Xh) @ (cco @ (ccfv @ XY @ cchash) @ (ccfv @ (XZ @ Xx3 @ Xy1 @ Xu @ Xg1 @ Xh) @ cchash) @ ccmin) @ ccdvds))))))))))))))))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(ccres_tp,type,(ccres : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(asylow3lem5_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xph => (cwcel @ XG @ ccgrp)) => ((Xph => (cwcel @ XX @ ccfn)) => ((Xph => (cwcel @ XP @ ccprime)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((Xph => (cwcel @ XK @ (cco @ XP @ XG @ ccslw))) => ((Xc_po = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XK)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ XP @ XG @ ccslw))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrn @ (ccmpt @ (^ [Xz:$i] : (ccv @ Xy1)) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_pl) @ (ccv @ Xx3) @ Xc_mi)))))))) => (Xph => (cwcel @ Xc_po @ (cco @ (cco @ XG @ XK @ ccress) @ (cco @ XP @ XG @ ccslw) @ ccga)))))))))))))))))))).
...
thf(aconjnmzb_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [Xc_mi:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((! [Xz:$i] : ((Xc_mi @ Xz) = (ccfv @ XG @ ccsg))) => ((! [Xx3:$i] : (! [Xz:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (cco @ (cco @ XA2 @ (ccv @ Xx3) @ Xc_pl) @ XA2 @ (Xc_mi @ Xz))))))) => ((! [Xy1:$i] : (! [Xz:$i] : ((XN @ Xy1 @ Xz) = (ccrab @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_pl) @ XS) <=> (cwcel @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ Xc_pl) @ XS))) @ (^ [Xz:$i] : XX))) @ (^ [Xy1:$i] : XX))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ XS @ (ccfv @ XG @ ccsubg)) => ((cwcel @ XA2 @ (XN @ Xy1 @ Xz)) <=> ((cwcel @ XA2 @ XX) & (XS = (ccrn @ (XF @ Xx3))))))))))))))))))))))).
...
thf(asylow2_ax,axiom,(! [Xph:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XX @ ccfn))) => ((! [Xx3:$i] : (! [Xg1:$i] : ((Xph @ Xx3) => (cwcel @ XH @ (cco @ (XP @ Xx3 @ Xg1) @ XG @ ccslw))))) => ((! [Xx3:$i] : (! [Xg1:$i] : ((Xph @ Xx3) => (cwcel @ XK @ (cco @ (XP @ Xx3 @ Xg1) @ XG @ ccslw))))) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((! [Xg1:$i] : ((Xc_mi @ Xg1) = (ccfv @ XG @ ccsg))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwrex @ (^ [Xg1:$i] : (XH = (ccrn @ (ccmpt @ (^ [Xx3:$i] : XK) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xg1) @ (ccv @ Xx3) @ Xc_pl) @ (ccv @ Xg1) @ (Xc_mi @ Xg1))))))) @ (^ [Xg1:$i] : XX))))))))))))))))))).
...
thf(asubgslw_ax,axiom,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : ((XH = (cco @ XG @ XS @ ccress)) => ((cw3a @ (cwcel @ XS @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XK @ (cco @ XP @ XG @ ccslw)) @ (cwss @ XK @ XS)) => (cwcel @ XK @ (cco @ XP @ XH @ ccslw)))))))))).
thf(assnmz_ax,axiom,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XN @ Xx3 @ Xy1) = (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XS) <=> (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ Xc_pl) @ XS))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))))) => ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XS @ (ccfv @ XG @ ccsubg)) => (cwss @ XS @ (XN @ Xx3 @ Xy1)))))))))))))).
...
thf(aconjnsg_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (cco @ (cco @ XA2 @ (ccv @ Xx3) @ Xc_pl) @ XA2 @ Xc_mi))))) => (! [Xx3:$i] : (((cwcel @ XS @ (ccfv @ XG @ ccnsg)) & (cwcel @ XA2 @ XX)) => (XS = (ccrn @ (XF @ Xx3))))))))))))))))).
...
thf(amoddvds_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) => (((cco @ XA2 @ XN @ ccmo) = (cco @ XB2 @ XN @ ccmo)) <=> (cwbr @ XN @ (cco @ XA2 @ XB2 @ ccmin) @ ccdvds))))))).
...
thf(csylow3lem6_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > $o))] : ((! [Xs1:$i] : ((XX @ Xs1) = (ccfv @ XG @ ccbs))) => ((Xph => (cwcel @ XG @ ccgrp)) => ((! [Xs1:$i] : (Xph => (cwcel @ (XX @ Xs1) @ ccfn))) => ((Xph => (cwcel @ XP @ ccprime)) => ((! [Xs1:$i] : ((Xc_pl @ Xs1) = (ccfv @ XG @ ccplusg))) => ((! [Xs1:$i] : ((Xc_mi @ Xs1) = (ccfv @ XG @ ccsg))) => ((Xph => (cwcel @ XK @ (cco @ XP @ XG @ ccslw))) => ((! [Xs1:$i] : (Xc_po = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XK)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ XP @ XG @ ccslw))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrn @ (ccmpt @ (^ [Xz:$i] : (ccv @ Xy1)) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ (Xc_pl @ Xs1)) @ (ccv @ Xx3) @ (Xc_mi @ Xs1)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xs1:$i] : ((XN @ Xx3 @ Xy1 @ Xs1) = (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_pl @ Xs1)) @ (ccv @ Xs1)) <=> (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (Xc_pl @ Xs1)) @ (ccv @ Xs1)))) @ (^ [Xy1:$i] : (XX @ Xs1)))) @ (^ [Xx3:$i] : (XX @ Xs1))))))) => (Xph => ((cco @ (ccfv @ (cco @ XP @ XG @ ccslw) @ cchash) @ XP @ ccmo) = cc1))))))))))))))))))))).
