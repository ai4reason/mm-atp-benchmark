...
thf(asqgt0sr_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccnr) & (cwne @ XA2 @ cc0r)) => (cwbr @ cc0r @ (cco @ XA2 @ XA2 @ ccmr) @ ccltr)))).
...
thf(arecexsrlem_ax,axiom,(! [XA2:($i > $o)] : ((cwbr @ cc0r @ XA2 @ ccltr) => (cwrex @ (^ [Xx3:$i] : ((cco @ XA2 @ (ccv @ Xx3) @ ccmr) = cc1r)) @ (^ [Xx3:$i] : ccnr))))).
...
thf(crecexsr_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccnr) & (cwne @ XA2 @ cc0r)) => (cwrex @ (^ [Xx3:$i] : ((cco @ XA2 @ (ccv @ Xx3) @ ccmr) = cc1r)) @ (^ [Xx3:$i] : ccnr))))).
