...
thf(cfsets_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ ((cwcel @ XF @ XV) & (cwf @ XA2 @ XB2 @ XF)) @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XB2)) => (cwf @ XA2 @ XB2 @ (cco @ XF @ (ccop @ XX @ XY) @ ccsts)))))))))).
