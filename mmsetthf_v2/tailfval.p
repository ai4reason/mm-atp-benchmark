...
thf(adirdm_ax,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccdir) => ((ccdm @ XR) = (ccuni @ (ccuni @ XR)))))).
thf(ctailfval_conj,conjecture,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XD)) => ((cwcel @ XD @ ccdir) => ((ccfv @ XD @ cctail) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccima @ XD @ (ccsn @ (ccv @ Xx3))))))))))).
