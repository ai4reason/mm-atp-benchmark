...
thf(clmbr3v_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => (Xph => ((cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) <=> (cw3a @ (cwcel @ XF @ (cco @ XX @ ccc @ ccpm)) @ (cwcel @ XP @ XX) @ (cwral @ (^ [Xu:$i] : ((cwcel @ XP @ (ccv @ Xu)) => (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : ((cwcel @ (ccv @ Xk) @ (ccdm @ XF)) & (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ (ccv @ Xu)))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : ccz)))) @ (^ [Xu:$i] : XJ)))))))))))).
