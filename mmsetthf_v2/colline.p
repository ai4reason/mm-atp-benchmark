...
thf(atglowdim1i_ax,axiom,(! [Xph:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [Xc_mi:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (XP = (ccfv @ (XG @ Xy1) @ ccbs))) => ((! [Xy1:$i] : ((Xc_mi @ Xy1) = (ccfv @ (XG @ Xy1) @ ccds))) => ((! [Xy1:$i] : ((XI @ Xy1) = (ccfv @ (XG @ Xy1) @ ccitv))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ (XG @ Xy1) @ ccstrkg))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwbr @ cc2 @ (ccfv @ XP @ cchash) @ ccle))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XX @ XP))) => (! [Xy1:$i] : ((Xph @ Xy1) => (cwrex @ (^ [Xy1:$i] : (cwne @ XX @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XP))))))))))))))))).
...
thf(ccolline_conj,conjecture,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xa:$i] : ((XP @ Xa) = (ccfv @ (XG @ Xa) @ ccbs))) => ((! [Xa:$i] : ((XI @ Xa) = (ccfv @ (XG @ Xa) @ ccitv))) => ((! [Xa:$i] : (XL = (ccfv @ (XG @ Xa) @ cclng))) => ((! [Xa:$i] : (Xph => (cwcel @ (XG @ Xa) @ ccstrkg))) => ((! [Xa:$i] : (Xph => (cwcel @ XX @ (XP @ Xa)))) => ((! [Xa:$i] : (Xph => (cwcel @ XY @ (XP @ Xa)))) => ((! [Xa:$i] : (Xph => (cwcel @ XZ @ (XP @ Xa)))) => ((! [Xa:$i] : (Xph => (cwbr @ cc2 @ (ccfv @ (XP @ Xa) @ cchash) @ ccle))) => (Xph => (((cwcel @ XX @ (cco @ XY @ XZ @ XL)) | (XY = XZ)) <=> (cwrex @ (^ [Xa:$i] : (cw3a @ (cwcel @ XX @ (ccv @ Xa)) @ (cwcel @ XY @ (ccv @ Xa)) @ (cwcel @ XZ @ (ccv @ Xa)))) @ (^ [Xa:$i] : (ccrn @ XL)))))))))))))))))))))).
