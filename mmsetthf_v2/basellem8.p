...
thf(atangtx_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)) => (cwbr @ XA2 @ (ccfv @ XA2 @ cctan) @ cclt)))).
...
thf(asinltx_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwbr @ (ccfv @ XA2 @ ccsin) @ XA2 @ cclt)))).
...
thf(cbasellem8_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xn:$i] : ((XG @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccdiv))))) => ((XF = (ccseq @ ccaddc @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (ccneg @ cc2) @ ccexp))) @ cc1)) => ((! [Xn:$i] : ((XH @ Xn) = (cco @ (ccxp @ ccn @ (ccsn @ (cco @ (cco @ ccpi @ cc2 @ ccexp) @ cc6 @ ccdiv))) @ (cco @ (ccxp @ ccn @ (ccsn @ cc1)) @ (XG @ Xn) @ (ccof @ ccmin)) @ (ccof @ ccmul)))) => ((! [Xn:$i] : (XJ = (cco @ (XH @ Xn) @ (cco @ (ccxp @ ccn @ (ccsn @ cc1)) @ (cco @ (ccxp @ ccn @ (ccsn @ (ccneg @ cc2))) @ (XG @ Xn) @ (ccof @ ccmul)) @ (ccof @ ccaddc)) @ (ccof @ ccmul)))) => ((! [Xn:$i] : ((XK @ Xn) = (cco @ (XH @ Xn) @ (cco @ (ccxp @ ccn @ (ccsn @ cc1)) @ (XG @ Xn) @ (ccof @ ccaddc)) @ (ccof @ ccmul)))) => ((XN = (cco @ (cco @ cc2 @ XM @ ccmul) @ cc1 @ ccaddc)) => (! [Xn:$i] : ((cwcel @ XM @ ccn) => ((cwbr @ (ccfv @ XM @ XJ) @ (ccfv @ XM @ XF) @ ccle) & (cwbr @ (ccfv @ XM @ XF) @ (ccfv @ XM @ (XK @ Xn)) @ ccle)))))))))))))))))).
