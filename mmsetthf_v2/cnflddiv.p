...
thf(advrcan1_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XU = (ccfv @ XR @ ccui)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XU)) => ((cco @ (cco @ XX @ XY @ Xc_dv) @ XY @ Xc_x) = XX)))))))))))))).
...
thf(adivval_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0)) => ((cco @ XA2 @ XB2 @ ccdiv) = (ccrio @ (^ [Xx3:$i] : ((cco @ XB2 @ (ccv @ Xx3) @ ccmul) = XA2)) @ (^ [Xx3:$i] : ccc))))))).
...
thf(advrfval_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_dv:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XU = (ccfv @ XR @ ccui)) => ((XI = (ccfv @ XR @ ccinvr)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_dv @ Xx3 @ Xy1) = (ccfv @ XR @ ccdvr)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xc_dv @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XU)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XI) @ Xc_x))))))))))))))))))).
