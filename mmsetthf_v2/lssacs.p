...
thf(aislss4_ax,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XB2 = (ccfv @ XF @ ccbs)) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XS = (ccfv @ XW @ cclss)) => ((cwcel @ XW @ cclmod) => ((cwcel @ XU @ XS) <=> ((cwcel @ XU @ (ccfv @ XW @ ccsubg)) & (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwcel @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ Xc_x) @ XU)) @ (^ [Xb:$i] : XU))) @ (^ [Xa:$i] : XB2)))))))))))))))))).
...
thf(aacsfn1c_ax,axiom,(! [XE:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ XV) & (cwral @ (^ [Xb:$i] : (cwral @ (^ [Xc:$i] : (cwcel @ (XE @ Xb @ Xc) @ XX)) @ (^ [Xc:$i] : XX))) @ (^ [Xb:$i] : XK))) => (cwcel @ (ccrab @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwral @ (^ [Xc:$i] : (cwcel @ (XE @ Xb @ Xc) @ (ccv @ Xa))) @ (^ [Xc:$i] : (ccv @ Xa)))) @ (^ [Xb:$i] : XK))) @ (^ [Xa:$i] : (ccpw @ XX))) @ (ccfv @ XX @ ccacs)))))))).
thf(ccpr_tp,type,(ccpr : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(amreincl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwcel @ XA2 @ XC) @ (cwcel @ XB2 @ XC)) => (cwcel @ (ccin @ XA2 @ XB2) @ XC))))))).
thf(clssacs_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XS = (ccfv @ XW @ cclss)) => ((cwcel @ XW @ cclmod) => (cwcel @ XS @ (ccfv @ XB2 @ ccacs))))))))).
