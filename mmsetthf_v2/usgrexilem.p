...
thf(cusgrexilem_conj,conjecture,(! [XP:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : ((XP @ Xx3) = (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cchash) = cc2)) @ (^ [Xx3:$i] : (ccpw @ XV))))) => (! [Xx3:$i] : ((cwcel @ XV @ (XW @ Xx3)) => (cwf1 @ (ccdm @ (ccres @ ccid @ (XP @ Xx3))) @ (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cchash) = cc2)) @ (^ [Xx3:$i] : (ccpw @ XV))) @ (ccres @ ccid @ (XP @ Xx3)))))))))).
