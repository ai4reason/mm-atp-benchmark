...
thf(anbusgrfi_ax,axiom,(! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((cw3a @ (cwcel @ XG @ ccusgr) @ (cwcel @ XE @ ccfn) @ (cwcel @ XU @ XV)) => (cwcel @ (cco @ XG @ XU @ ccnbgr) @ ccfn))))))))).
