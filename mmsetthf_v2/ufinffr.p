...
thf(acfinfil_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xx3:$i] : ((cw3a @ (cwcel @ XX @ (XV @ Xx3)) @ (cwss @ XA2 @ XX) @ (~ (cwcel @ XA2 @ ccfn))) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccdif @ XA2 @ (ccv @ Xx3)) @ ccfn)) @ (^ [Xx3:$i] : (ccpw @ XX))) @ (ccfv @ XX @ ccfil)))))))).
...
thf(cufinffr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XX @ XB2) @ (cwss @ XA2 @ XX) @ (cwbr @ ccom @ XA2 @ ccdom)) => (cwrex @ (^ [Xf1:$i] : ((cwcel @ XA2 @ (ccv @ Xf1)) & ((ccint @ (ccv @ Xf1)) = cc0))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccufil)))))))).
