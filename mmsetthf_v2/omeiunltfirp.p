...
thf(asge0pnffigt_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (Xph => (cwcel @ XX @ (XV @ Xx3)))) => ((Xph => (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((Xph => ((ccfv @ XF @ ccsumge0) = ccpnf)) => ((Xph => (cwcel @ XY @ ccr)) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwbr @ XY @ (ccfv @ (ccres @ XF @ (ccv @ Xx3)) @ ccsumge0) @ cclt)) @ (^ [Xx3:$i] : (ccin @ (ccpw @ XX) @ ccfn)))))))))))))).
...
thf(aomexrcl_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XX = (ccuni @ (ccdm @ XO))) => ((Xph => (cwss @ XA2 @ XX)) => (Xph => (cwcel @ (ccfv @ XA2 @ XO) @ ccxr)))))))))).
