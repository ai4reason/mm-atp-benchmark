...
thf(alsmssv_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_po = (ccfv @ XG @ cclsm)) => ((cw3a @ (cwcel @ XG @ ccmnd) @ (cwss @ XT @ XB2) @ (cwss @ XU @ XB2)) => (cwss @ (cco @ XT @ XU @ Xc_po) @ XB2)))))))))).
...
thf(clsmass_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((Xc_po = (ccfv @ XG @ cclsm)) => ((cw3a @ (cwcel @ XR @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XT @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((cco @ (cco @ XR @ XT @ Xc_po) @ XU @ Xc_po) = (cco @ XR @ (cco @ XT @ XU @ Xc_po) @ Xc_po)))))))))).
