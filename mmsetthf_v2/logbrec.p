...
thf(azgt1rpn0n1_ax,axiom,(! [XB2:($i > $o)] : ((cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) => (cw3a @ (cwcel @ XB2 @ ccrp) @ (cwne @ XB2 @ ccc0) @ (cwne @ XB2 @ cc1))))).
...
thf(clogbrec_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XA2 @ ccrp)) => ((cco @ XB2 @ (cco @ cc1 @ XA2 @ ccdiv) @ cclogb) = (ccneg @ (cco @ XB2 @ XA2 @ cclogb))))))).
