...
thf(cex_opab_conj,conjecture,(! [XR:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (((XR @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cw3a @ (cwcel @ (ccv @ Xx3) @ ccc) @ (cwcel @ (ccv @ Xy1) @ ccc) @ ((cco @ (ccv @ Xx3) @ cc1 @ ccaddc) = (ccv @ Xy1))))))) => (cwbr @ cc3 @ cc4 @ (XR @ Xx3 @ Xy1))))))).
