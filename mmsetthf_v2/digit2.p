...
thf(cdigit2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XK @ ccn)) => ((cco @ (ccfv @ (cco @ (cco @ XB2 @ XK @ ccexp) @ XA2 @ ccmul) @ ccfl) @ XB2 @ ccmo) = (cco @ (ccfv @ (cco @ (cco @ XB2 @ XK @ ccexp) @ XA2 @ ccmul) @ ccfl) @ (cco @ XB2 @ (ccfv @ (cco @ (cco @ XB2 @ (cco @ XK @ cc1 @ ccmin) @ ccexp) @ XA2 @ ccmul) @ ccfl) @ ccmul) @ ccmin))))))).
