...
thf(achjvali_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cco @ XA2 @ XB2 @ cchj) = (ccfv @ (ccfv @ (ccun @ XA2 @ XB2) @ ccort) @ ccort))))))).
...
thf(cchj0i_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cco @ XA2 @ cc0h @ cchj) = XA2)))).
