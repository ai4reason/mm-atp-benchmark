...
thf(aevendiv2z_ax,axiom,(! [XZ:($i > $o)] : ((cwcel @ XZ @ cceven) => (cwcel @ (cco @ XZ @ cc2 @ ccdiv) @ ccz)))).
thf(aelnn0z_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) <=> ((cwcel @ XN @ ccz) & (cwbr @ ccc0 @ XN @ ccle))))).
thf(cnn0e_conj,conjecture,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XN @ cceven)) => (cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn0)))).
