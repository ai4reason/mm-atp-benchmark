...
thf(csubiwrdlen_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XS @ ccvv)) => ((Xph => (cwf @ ccn0 @ XS @ XF)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((ccfv @ (ccres @ XF @ (cco @ ccc0 @ XN @ ccfzo)) @ cchash) = XN)))))))))).
