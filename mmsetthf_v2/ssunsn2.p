...
thf(cssunsn2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwss @ XB2 @ XA2) & (cwss @ XA2 @ (ccun @ XC @ (ccsn @ XD)))) <=> (((cwss @ XB2 @ XA2) & (cwss @ XA2 @ XC)) | ((cwss @ (ccun @ XB2 @ (ccsn @ XD)) @ XA2) & (cwss @ XA2 @ (ccun @ XC @ (ccsn @ XD))))))))))).
