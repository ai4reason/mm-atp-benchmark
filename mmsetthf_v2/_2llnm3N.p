...
thf(a_2llnm2N_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XN = (ccfv @ XK @ cclln)) => ((XP = (ccfv @ XK @ cclpl)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwcel @ XX @ XN) @ (cwcel @ XY @ XN) @ (cwcel @ XW @ XP)) @ (cw3a @ (cwbr @ XX @ XW @ Xc_le) @ (cwbr @ XY @ XW @ Xc_le) @ (cwne @ XX @ XY))) => (cwcel @ (cco @ XX @ XY @ Xc_an) @ XA2))))))))))))))))).
...
thf(c_2llnm3N_conj,conjecture,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => ((XN = (ccfv @ XK @ cclln)) => ((XP = (ccfv @ XK @ cclpl)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwcel @ XX @ XN) @ (cwcel @ XY @ XN) @ (cwcel @ XW @ XP)) @ ((cwbr @ XX @ XW @ Xc_le) & (cwbr @ XY @ XW @ Xc_le))) => (cwne @ (cco @ XX @ XY @ Xc_an) @ Xc_0))))))))))))))))).
