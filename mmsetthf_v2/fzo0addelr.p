...
thf(afzo0addel_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ XC @ ccfzo)) & (cwcel @ XD @ ccz)) => (cwcel @ (cco @ XA2 @ XD @ ccaddc) @ (cco @ XD @ (cco @ XC @ XD @ ccaddc) @ ccfzo))))))).
...
thf(cfzo0addelr_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ XC @ ccfzo)) & (cwcel @ XD @ ccz)) => (cwcel @ (cco @ XA2 @ XD @ ccaddc) @ (cco @ XD @ (cco @ XD @ XC @ ccaddc) @ ccfzo))))))).
