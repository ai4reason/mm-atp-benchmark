...
thf(adf_iedg_ax,axiom,(cciedg = (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccif @ (cwcel @ (ccv @ Xg1) @ (ccxp @ ccvv @ ccvv)) @ (ccfv @ (ccv @ Xg1) @ cc2nd) @ (ccfv @ (ccv @ Xg1) @ ccedgf)))))).
...
thf(ciedgval_conj,conjecture,(! [XG:($i > $o)] : ((ccfv @ XG @ cciedg) = (ccif @ (cwcel @ XG @ (ccxp @ ccvv @ ccvv)) @ (ccfv @ XG @ cc2nd) @ (ccfv @ XG @ ccedgf))))).
