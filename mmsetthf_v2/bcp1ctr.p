...
thf(abcp1n_ax,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) => ((cco @ (cco @ XN @ cc1 @ ccaddc) @ XK @ ccbc) = (cco @ (cco @ XN @ XK @ ccbc) @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XK @ ccmin) @ ccdiv) @ ccmul)))))).
...
thf(cbcp1ctr_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cco @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccmul) @ (cco @ XN @ cc1 @ ccaddc) @ ccbc) = (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ (cco @ cc2 @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc) @ (cco @ XN @ cc1 @ ccaddc) @ ccdiv) @ ccmul) @ ccmul))))).
