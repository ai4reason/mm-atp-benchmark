...
thf(aissubg3_ax,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XI = (ccfv @ XG @ ccminusg)) => ((cwcel @ XG @ ccgrp) => ((cwcel @ XS @ (ccfv @ XG @ ccsubg)) <=> ((cwcel @ XS @ (ccfv @ XG @ ccsubmnd)) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XI) @ XS)) @ (^ [Xx3:$i] : XS)))))))))).
...
thf(aacsfn1_ax,axiom,(! [XE:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ XV) & (cwral @ (^ [Xb:$i] : (cwcel @ (XE @ Xb) @ XX)) @ (^ [Xb:$i] : XX))) => (cwcel @ (ccrab @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwcel @ (XE @ Xb) @ (ccv @ Xa))) @ (^ [Xb:$i] : (ccv @ Xa)))) @ (^ [Xa:$i] : (ccpw @ XX))) @ (ccfv @ XX @ ccacs))))))).
...
thf(csubgacs_conj,conjecture,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((cwcel @ XG @ ccgrp) => (cwcel @ (ccfv @ XG @ ccsubg) @ (ccfv @ XB2 @ ccacs))))))).
