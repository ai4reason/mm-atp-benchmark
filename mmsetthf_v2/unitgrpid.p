...
thf(aringidss_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XM:($i > $o)] : ((XM = (cco @ (ccfv @ XR @ ccmgp) @ XA2 @ ccress)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwss @ XA2 @ XB2) @ (cwcel @ Xc_1 @ XA2)) => (Xc_1 = (ccfv @ XM @ cc0g)))))))))))).
