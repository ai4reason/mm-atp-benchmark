...
thf(apjoml4i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cco @ XA2 @ (ccin @ XB2 @ (cco @ (ccfv @ XA2 @ ccort) @ (ccfv @ XB2 @ ccort) @ cchj)) @ cchj) = (cco @ XA2 @ XB2 @ cchj))))))).
...
thf(cosumcor2i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwbr @ XA2 @ XB2 @ cccm) => ((cco @ XA2 @ XB2 @ ccph) = (cco @ XA2 @ XB2 @ cchj)))))))).
