...
thf(ainfdif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwbr @ XB2 @ XA2 @ ccsdm)) => (cwbr @ (ccdif @ XA2 @ XB2) @ XA2 @ ccen))))).
...
thf(cinfdif2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwcel @ XB2 @ (ccdm @ cccrd)) @ (cwbr @ ccom @ XA2 @ ccdom)) => ((cwbr @ (ccdif @ XA2 @ XB2) @ XB2 @ ccdom) <=> (cwbr @ XA2 @ XB2 @ ccdom)))))).
