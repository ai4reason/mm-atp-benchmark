...
thf(aisconn_ax,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ ccconn) <=> ((cwcel @ XJ @ cctop) & ((ccin @ XJ @ (ccfv @ XJ @ cccld)) = (ccpr @ cc0 @ XX)))))))).
...
thf(cconndisj_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((Xph => (cwcel @ XJ @ ccconn)) => ((Xph => (cwcel @ XA2 @ XJ)) => ((Xph => (cwne @ XA2 @ cc0)) => ((Xph => (cwcel @ XB2 @ XJ)) => ((Xph => (cwne @ XB2 @ cc0)) => ((Xph => ((ccin @ XA2 @ XB2) = cc0)) => (Xph => (cwne @ (ccun @ XA2 @ XB2) @ XX))))))))))))))).
