...
thf(ccfinfil_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xx3:$i] : ((cw3a @ (cwcel @ XX @ (XV @ Xx3)) @ (cwss @ XA2 @ XX) @ (~ (cwcel @ XA2 @ ccfn))) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccdif @ XA2 @ (ccv @ Xx3)) @ ccfn)) @ (^ [Xx3:$i] : (ccpw @ XX))) @ (ccfv @ XX @ ccfil)))))))).
