...
thf(csplval_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XS @ XV) & (cw3a @ (cwcel @ XF @ XW) @ (cwcel @ XT @ XX) @ (cwcel @ XR @ XY))) => ((cco @ XS @ (ccotp @ XF @ XT @ XR) @ ccsplice) = (cco @ (cco @ (cco @ XS @ (ccop @ ccc0 @ XF) @ ccsubstr) @ XR @ ccconcat) @ (cco @ XS @ (ccop @ XT @ (ccfv @ XS @ cchash)) @ ccsubstr) @ ccconcat)))))))))))).
