...
thf(c_1vwmgr_conj,conjecture,(! [XA2:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : (! [Xw:$i] : (! [Xv:$i] : (! [Xh:$i] : (((cwcel @ XA2 @ (XX @ Xw @ Xv @ Xh)) & (XV = (ccsn @ XA2))) => (cwrex @ (^ [Xh:$i] : (cwral @ (^ [Xv:$i] : ((cwcel @ (ccpr @ (ccv @ Xv) @ (ccv @ Xh)) @ (XE @ Xw @ Xv)) & (cwreu @ (^ [Xw:$i] : (cwcel @ (ccpr @ (ccv @ Xv) @ (ccv @ Xw)) @ (XE @ Xw @ Xv))) @ (^ [Xw:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xh))))))) @ (^ [Xv:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xh)))))) @ (^ [Xh:$i] : XV))))))))))).
