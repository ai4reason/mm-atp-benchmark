...
thf(acrngm23_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XH = (ccfv @ XR @ cc2nd)) => ((XX = (ccrn @ XG)) => (((cwcel @ XR @ cccring) & (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX))) => ((cco @ (cco @ XA2 @ XB2 @ XH) @ XC @ XH) = (cco @ (cco @ XA2 @ XC @ XH) @ XB2 @ XH)))))))))))))).
...
thf(ccrngm4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XH = (ccfv @ XR @ cc2nd)) => ((XX = (ccrn @ XG)) => ((cw3a @ (cwcel @ XR @ cccring) @ ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) @ ((cwcel @ XC @ XX) & (cwcel @ XD @ XX))) => ((cco @ (cco @ XA2 @ XB2 @ XH) @ (cco @ XC @ XD @ XH) @ XH) = (cco @ (cco @ XA2 @ XC @ XH) @ (cco @ XB2 @ XD @ XH) @ XH))))))))))))))).
