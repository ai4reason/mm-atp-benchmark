...
thf(clogsqvma_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((ccsu @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XN @ ccdvds)) @ (^ [Xx3:$i] : ccn)) @ (^ [Xd:$i] : (cco @ (ccsu @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xd) @ ccdvds)) @ (^ [Xx3:$i] : ccn)) @ (^ [Xu:$i] : (cco @ (ccfv @ (ccv @ Xu) @ ccvma) @ (ccfv @ (cco @ (ccv @ Xd) @ (ccv @ Xu) @ ccdiv) @ ccvma) @ ccmul))) @ (cco @ (ccfv @ (ccv @ Xd) @ ccvma) @ (ccfv @ (ccv @ Xd) @ cclog) @ ccmul) @ ccaddc))) = (cco @ (ccfv @ XN @ cclog) @ cc2 @ ccexp))))).
