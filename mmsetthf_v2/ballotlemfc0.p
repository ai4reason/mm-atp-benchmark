...
thf(abiortn_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps <=> ((~ Xph) | Xps)))))).
...
thf(afimaxre_ax,axiom,(! [XA2:($i > $o)] : ((cw3a @ (cwss @ XA2 @ ccr) @ (cwcel @ XA2 @ ccfn) @ (cwne @ XA2 @ cc0)) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))))).
