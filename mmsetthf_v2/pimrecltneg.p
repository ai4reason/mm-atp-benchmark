...
thf(altdiv23neg_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XB2 @ ccc0 @ cclt)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwbr @ XC @ ccc0 @ cclt)) => (Xph => ((cwbr @ (cco @ XA2 @ XB2 @ ccdiv) @ XC @ cclt) <=> (cwbr @ (cco @ XA2 @ XC @ ccdiv) @ XB2 @ cclt))))))))))))).
...
thf(cpimrecltneg_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => (cwcel @ (XB2 @ Xx3) @ ccr))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => (cwne @ (XB2 @ Xx3) @ ccc0))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XC @ Xx3) @ ccr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwbr @ (XC @ Xx3) @ ccc0 @ cclt))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccrab @ (^ [Xx3:$i] : (cwbr @ (cco @ cc1 @ (XB2 @ Xx3) @ ccdiv) @ (XC @ Xx3) @ cclt)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) = (ccrab @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ (cco @ (cco @ cc1 @ (XC @ Xx3) @ ccdiv) @ ccc0 @ ccioo))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))))))))))).
