...
thf(aovollb2_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((XS = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1)) => (((cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF) & (cwss @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccicc @ XF))))) => (cwbr @ (ccfv @ XA2 @ ccovol) @ (ccsup @ (ccrn @ XS) @ ccxr @ cclt) @ ccle))))))).
...
thf(cuniiccvol_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : ((Xph => (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((Xph => (cwdisj @ (^ [Xx3:$i] : ccn) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccioo)))) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1))) => (! [Xx3:$i] : (Xph => ((ccfv @ (ccuni @ (ccrn @ (cccom @ ccicc @ XF))) @ ccovol) = (ccsup @ (ccrn @ (XS @ Xx3)) @ ccxr @ cclt))))))))))).
