...
thf(adfgrp2_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((cwcel @ XG @ ccgrp) <=> ((cwcel @ XG @ ccsgrp) & (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xx3:$i] : (((cco @ (ccv @ Xn) @ (ccv @ Xx3) @ Xc_pl) = (ccv @ Xx3)) & (cwrex @ (^ [Xi:$i] : ((cco @ (ccv @ Xi) @ (ccv @ Xx3) @ Xc_pl) = (ccv @ Xn))) @ (^ [Xi:$i] : XB2)))) @ (^ [Xx3:$i] : XB2))) @ (^ [Xn:$i] : XB2)))))))))).
