...
thf(cwfr3_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((XF = (ccwrecs @ XA2 @ XR @ XG)) => (((cwfn @ XH @ XA2) & (cwral @ (^ [Xz:$i] : ((ccfv @ (ccv @ Xz) @ XH) = (ccfv @ (ccres @ XH @ (ccpred @ XA2 @ XR @ (ccv @ Xz))) @ XG))) @ (^ [Xz:$i] : XA2))) => (XF = XH))))))))))).
