...
thf(a_0hashbc_ax,axiom,(! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > $o))] : ((! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XC @ Xi @ Xa @ Xb) = (ccmpt2 @ (^ [Xa:$i] : (^ [Xi:$i] : ccvv)) @ (^ [Xa:$i] : (^ [Xi:$i] : ccn0)) @ (^ [Xa:$i] : (^ [Xi:$i] : (ccrab @ (^ [Xb:$i] : ((ccfv @ (ccv @ Xb) @ cchash) = (ccv @ Xi))) @ (^ [Xb:$i] : (ccpw @ (ccv @ Xa))))))))))) => (! [Xi:$i] : (! [Xa:$i] : (! [Xb:$i] : ((cwcel @ (XN @ Xb) @ ccn) => ((cco @ cc0 @ (XN @ Xb) @ (XC @ Xi @ Xa @ Xb)) = cc0))))))))).
...
thf(cramz2_conj,conjecture,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (((cw3a @ (cwcel @ XM @ ccn) @ (cwcel @ XR @ XV) @ (cwf @ XR @ ccn0 @ XF)) & ((cwcel @ XC @ XR) & ((ccfv @ XC @ XF) = ccc0))) => ((cco @ XM @ XF @ ccram) = ccc0)))))))).
