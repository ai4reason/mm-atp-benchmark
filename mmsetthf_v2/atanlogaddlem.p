...
thf(aargimlt0_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwbr @ (ccfv @ XA2 @ ccim) @ ccc0 @ cclt)) => (cwcel @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ (cco @ (ccneg @ ccpi) @ ccc0 @ ccioo))))).
...
thf(catanlogaddlem_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccatan)) & (cwbr @ ccc0 @ (ccfv @ XA2 @ ccre) @ ccle)) => (cwcel @ (cco @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) @ cclog) @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccmin) @ cclog) @ ccaddc) @ (ccrn @ cclog))))).
