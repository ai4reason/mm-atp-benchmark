...
thf(csetsnidel_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((XR = (cco @ XS @ (ccop @ XA2 @ XB2) @ ccsts)) => ((Xph => (cwcel @ XC @ XX)) => ((Xph => (cwcel @ XD @ XY)) => ((Xph => (cwcel @ (ccop @ XC @ XD) @ XS)) => ((Xph => (cwne @ XA2 @ XC)) => (Xph => (cwcel @ (ccop @ XC @ XD) @ XR))))))))))))))))))))).
