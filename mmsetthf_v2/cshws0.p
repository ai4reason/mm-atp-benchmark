...
thf(ccshws0_conj,conjecture,(! [XM:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xw:$i] : (! [Xn:$i] : ((XM @ Xw @ Xn) = (ccrab @ (^ [Xw:$i] : (cwrex @ (^ [Xn:$i] : ((cco @ XW @ (ccv @ Xn) @ cccsh) = (ccv @ Xw))) @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)))) @ (^ [Xw:$i] : (ccword @ XV)))))) => (! [Xw:$i] : (! [Xn:$i] : ((XW = cc0) => ((ccfv @ (XM @ Xw @ Xn) @ cchash) = ccc0))))))))).
