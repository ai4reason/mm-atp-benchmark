...
thf(aovolval2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((Xph => (cwss @ XA2 @ ccr)) => ((! [Xy1:$i] : (! [Xf1:$i] : ((XM @ Xy1 @ Xf1) = (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xf1:$i] : ((cwss @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ (ccv @ Xf1))))) & ((ccv @ Xy1) = (ccfv @ (cccom @ (cccom @ ccabs @ ccmin) @ (ccv @ Xf1)) @ ccsumge0)))) @ (^ [Xf1:$i] : (cco @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ ccn @ ccmap)))) @ (^ [Xy1:$i] : ccxr))))) => (! [Xy1:$i] : (! [Xf1:$i] : (Xph => ((ccfv @ XA2 @ ccovol) = (ccinf @ (XM @ Xy1 @ Xf1) @ ccxr @ cclt))))))))))).
...
thf(avolioof_ax,axiom,(cwf @ (ccxp @ ccxr @ ccxr) @ (cco @ ccc0 @ ccpnf @ ccicc) @ (cccom @ ccvol @ ccioo))).
...
thf(arr2sscn2_ax,axiom,(cwss @ (ccxp @ ccr @ ccr) @ (ccxp @ ccc @ ccc))).
thf(covolval3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((Xph => (cwss @ XA2 @ ccr)) => ((! [Xy1:$i] : (! [Xf1:$i] : ((XM @ Xy1 @ Xf1) = (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xf1:$i] : ((cwss @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ (ccv @ Xf1))))) & ((ccv @ Xy1) = (ccfv @ (cccom @ (cccom @ ccvol @ ccioo) @ (ccv @ Xf1)) @ ccsumge0)))) @ (^ [Xf1:$i] : (cco @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ ccn @ ccmap)))) @ (^ [Xy1:$i] : ccxr))))) => (! [Xy1:$i] : (! [Xf1:$i] : (Xph => ((ccfv @ XA2 @ ccovol) = (ccinf @ (XM @ Xy1 @ Xf1) @ ccxr @ cclt))))))))))).
