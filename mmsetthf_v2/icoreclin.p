...
thf(aicoreelrnab_ax,axiom,(! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > $o))] : ((! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XI @ Xz @ Xa @ Xb) = (ccima @ ccico @ (ccxp @ ccr @ ccr)))))) => (! [Xz:$i] : (! [Xa:$i] : (! [Xb:$i] : ((cwcel @ (XX @ Xz) @ (XI @ Xz @ Xa @ Xb)) <=> (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : ((XX @ Xz) = (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xa) @ (ccv @ Xz) @ ccle) & (cwbr @ (ccv @ Xz) @ (ccv @ Xb) @ cclt))) @ (^ [Xz:$i] : ccr)))) @ (^ [Xb:$i] : ccr))) @ (^ [Xa:$i] : ccr)))))))))).
...
thf(aisbasisrelowllem1_ax,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (! [XI:($i > ($i > ($i > $o)))] : (! [Xa:$i] : (! [Xd:$i] : ((! [Xb:$i] : (! [Xc:$i] : ((XI @ Xb @ Xc) = (ccima @ ccico @ (ccxp @ ccr @ ccr))))) => (! [Xb:$i] : (! [Xc:$i] : ((((cw3a @ (cwcel @ (ccv @ Xa) @ ccr) @ (cwcel @ (ccv @ Xb) @ ccr) @ ((ccv @ Xx3) = (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xa) @ (ccv @ Xz) @ ccle) & (cwbr @ (ccv @ Xz) @ (ccv @ Xb) @ cclt))) @ (^ [Xz:$i] : ccr)))) & (cw3a @ (cwcel @ (ccv @ Xc) @ ccr) @ (cwcel @ (ccv @ Xd) @ ccr) @ ((ccv @ Xy1) = (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xc) @ (ccv @ Xz) @ ccle) & (cwbr @ (ccv @ Xz) @ (ccv @ Xd) @ cclt))) @ (^ [Xz:$i] : ccr))))) & ((cwbr @ (ccv @ Xa) @ (ccv @ Xc) @ ccle) & (cwbr @ (ccv @ Xb) @ (ccv @ Xd) @ ccle))) => (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (XI @ Xb @ Xc)))))))))))).
thf(aisbasisrelowllem2_ax,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [Xa:$i] : (! [Xb:$i] : ((! [Xz:$i] : (! [Xc:$i] : (! [Xd:$i] : ((XI @ Xz @ Xc @ Xd) = (ccima @ ccico @ (ccxp @ ccr @ ccr)))))) => (! [Xz:$i] : (! [Xc:$i] : (! [Xd:$i] : ((((cw3a @ (cwcel @ (ccv @ Xa) @ ccr) @ (cwcel @ (ccv @ Xb) @ ccr) @ ((ccv @ Xx3) = (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xa) @ (ccv @ Xz) @ ccle) & (cwbr @ (ccv @ Xz) @ (ccv @ Xb) @ cclt))) @ (^ [Xz:$i] : ccr)))) & (cw3a @ (cwcel @ (ccv @ Xc) @ ccr) @ (cwcel @ (ccv @ Xd) @ ccr) @ ((ccv @ Xy1) = (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xc) @ (ccv @ Xz) @ ccle) & (cwbr @ (ccv @ Xz) @ (ccv @ Xd) @ cclt))) @ (^ [Xz:$i] : ccr))))) & ((cwbr @ (ccv @ Xa) @ (ccv @ Xc) @ ccle) & (cwbr @ (ccv @ Xd) @ (ccv @ Xb) @ ccle))) => (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (XI @ Xz @ Xc @ Xd))))))))))))).
