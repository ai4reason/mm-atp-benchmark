...
thf(cpmtridfv2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XX @ XA2)) => ((Xph => (cwcel @ XY @ XA2)) => ((XT = (ccif @ (XX = XY) @ (ccres @ ccid @ XA2) @ (ccfv @ (ccpr @ XX @ XY) @ (ccfv @ XA2 @ ccpmtr)))) => (Xph => ((ccfv @ XY @ XT) = XX))))))))))))).
