...
thf(cnvscom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XS = (ccfv @ XU @ ccns)) => (((cwcel @ XU @ ccnv) & (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ XX))) => ((cco @ XA2 @ (cco @ XB2 @ XC @ XS) @ XS) = (cco @ XB2 @ (cco @ XA2 @ XC @ XS) @ XS)))))))))))).
