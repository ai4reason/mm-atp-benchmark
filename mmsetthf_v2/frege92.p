...
thf(afrege91_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XX @ XU) => ((cwcel @ XY @ XV) => ((cwcel @ XR @ XW) => ((cwbr @ XX @ XY @ XR) => (cwbr @ XX @ XY @ (ccfv @ XR @ cctcl))))))))))))).
...
thf(cfrege92_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XX @ XU) => ((cwcel @ XY @ XV) => ((cwcel @ XR @ XW) => ((XX = XZ) => ((cwbr @ XX @ XY @ XR) => (cwbr @ XZ @ XY @ (ccfv @ XR @ cctcl))))))))))))))).
