...
thf(ciprodefisumlem_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwf @ XZ @ ccc @ XF)) => (Xph => ((ccseq @ ccmul @ (cccom @ cce @ XF) @ XM) = (cccom @ cce @ (ccseq @ ccaddc @ XF @ XM)))))))))))).
