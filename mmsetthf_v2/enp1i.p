...
thf(adif1en_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XM @ ccom) @ (cwbr @ XA2 @ (ccsuc @ XM) @ ccen) @ (cwcel @ XX @ XA2)) => (cwbr @ (ccdif @ XA2 @ (ccsn @ XX)) @ XM @ ccen)))))).
thf(cenp1i_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (cwcel @ (XM @ Xx3) @ ccom)) => ((! [Xx3:$i] : (XN = (ccsuc @ (XM @ Xx3)))) => ((! [Xx3:$i] : ((cwbr @ (ccdif @ XA2 @ (ccsn @ (ccv @ Xx3))) @ (XM @ Xx3) @ ccen) => (Xph @ Xx3))) => ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) => ((Xph @ Xx3) => (Xps @ Xx3)))) => ((cwbr @ XA2 @ XN @ ccen) => (? [Xx3:$i] : (Xps @ Xx3))))))))))))).
