...
thf(cpmtrdifwrdellem2_conj,conjecture,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((! [Xx3:$i] : (XT = (ccrn @ (ccfv @ (ccdif @ XN @ (ccsn @ (XK @ Xx3))) @ ccpmtr)))) => ((XR = (ccrn @ (ccfv @ XN @ ccpmtr))) => ((! [Xx3:$i] : ((XU @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (ccdm @ (ccdif @ (ccfv @ (ccv @ Xx3) @ XW) @ ccid)) @ (ccfv @ XN @ ccpmtr)))))) => (! [Xx3:$i] : ((cwcel @ XW @ (ccword @ XT)) => ((ccfv @ XW @ cchash) = (ccfv @ (XU @ Xx3) @ cchash)))))))))))))).
