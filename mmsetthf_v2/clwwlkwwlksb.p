...
thf(aelfzom1elfzo_ax,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XI @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfzo))) => (cwcel @ XI @ (cco @ ccc0 @ XN @ ccfzo)))))).
...
thf(accat0_ax,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XS @ (ccword @ XB2)) & (cwcel @ XT @ (ccword @ XB2))) => (((cco @ XS @ XT @ ccconcat) = cc0) <=> ((XS = cc0) & (XT = cc0)))))))).
...
thf(cclwwlkwwlksb_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XW @ (ccword @ XV)) & (cwne @ XW @ cc0)) => ((cwcel @ XW @ (ccfv @ XG @ ccclwwlk)) <=> (cwcel @ (cco @ XW @ (ccs1 @ (ccfv @ ccc0 @ XW)) @ ccconcat) @ (ccfv @ XG @ ccwwlks))))))))).
