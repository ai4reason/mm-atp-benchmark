...
thf(adf_lines_ax,axiom,(cclines = (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccab @ (^ [Xs1:$i] : (cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : ((cwne @ (ccv @ Xq) @ (ccv @ Xr)) & ((ccv @ Xs1) = (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (cco @ (ccv @ Xq) @ (ccv @ Xr) @ (ccfv @ (ccv @ Xk) @ ccjn)) @ (ccfv @ (ccv @ Xk) @ ccple))) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xk) @ ccatm)))))) @ (^ [Xr:$i] : (ccfv @ (ccv @ Xk) @ ccatm)))) @ (^ [Xq:$i] : (ccfv @ (ccv @ Xk) @ ccatm))))))))).
...
thf(clineset_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_or:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((Xc_le @ Xr @ Xq @ Xp) = (ccfv @ XK @ ccple))))) => ((! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((Xc_or @ Xr @ Xq @ Xp) = (ccfv @ XK @ ccjn))))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xs1:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((XN @ Xs1 @ Xr @ Xq @ Xp) = (ccfv @ XK @ cclines)))))) => (! [Xs1:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((cwcel @ XK @ (XB2 @ Xs1 @ Xr @ Xq @ Xp)) => ((XN @ Xs1 @ Xr @ Xq @ Xp) = (ccab @ (^ [Xs1:$i] : (cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : ((cwne @ (ccv @ Xq) @ (ccv @ Xr)) & ((ccv @ Xs1) = (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (cco @ (ccv @ Xq) @ (ccv @ Xr) @ (Xc_or @ Xr @ Xq @ Xp)) @ (Xc_le @ Xr @ Xq @ Xp))) @ (^ [Xp:$i] : XA2))))) @ (^ [Xr:$i] : XA2))) @ (^ [Xq:$i] : XA2))))))))))))))))))))).
