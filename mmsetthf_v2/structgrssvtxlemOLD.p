...
thf(aslotsbaseefdif_ax,axiom,(cwne @ (ccfv @ ccnx @ ccbs) @ (ccfv @ ccnx @ ccedgf))).
...
thf(ahashge2el2difr_ax,axiom,(! [XD:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XD @ XV) & (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwne @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XD))) @ (^ [Xx3:$i] : XD))) => (cwbr @ cc2 @ (ccfv @ XD @ cchash) @ ccle))))).
thf(cstructgrssvtxlemOLD_conj,conjecture,(! [Xph:$o] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XG @ XX)) => ((Xph => (cwfun @ XG)) => ((Xph => (cwcel @ XV @ XY)) => ((Xph => (cwcel @ XE @ XZ)) => ((Xph => (cwss @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XV) @ (ccop @ (ccfv @ ccnx @ ccedgf) @ XE)) @ XG)) => (Xph => (cwbr @ cc2 @ (ccfv @ (ccdm @ XG) @ cchash) @ ccle))))))))))))))).
