...
thf(aax_groth_ax,axiom,(! [Xx3:$i] : (? [Xy1:$i] : (cw3a @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwral @ (^ [Xz:$i] : ((! [Xw:$i] : ((cwss @ (ccv @ Xw) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xw) @ (ccv @ Xy1)))) & (cwrex @ (^ [Xw:$i] : (! [Xv:$i] : ((cwss @ (ccv @ Xv) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xv) @ (ccv @ Xw))))) @ (^ [Xw:$i] : (ccv @ Xy1))))) @ (^ [Xz:$i] : (ccv @ Xy1))) @ (! [Xz:$i] : ((cwss @ (ccv @ Xz) @ (ccv @ Xy1)) => ((cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccen) | (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))))).
...
thf(apwss_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ (ccpw @ XA2) @ XB2) <=> (! [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) => (cwcel @ (ccv @ Xx3) @ XB2))))))).
...
thf(caxgroth5_conj,conjecture,(! [Xx3:$i] : (? [Xy1:$i] : (cw3a @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwral @ (^ [Xz:$i] : ((cwss @ (ccpw @ (ccv @ Xz)) @ (ccv @ Xy1)) & (cwrex @ (^ [Xw:$i] : (cwss @ (ccpw @ (ccv @ Xz)) @ (ccv @ Xw))) @ (^ [Xw:$i] : (ccv @ Xy1))))) @ (^ [Xz:$i] : (ccv @ Xy1))) @ (cwral @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccen) | (cwcel @ (ccv @ Xz) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : (ccpw @ (ccv @ Xy1)))))))).
