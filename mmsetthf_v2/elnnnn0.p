...
thf(aelnn0nn_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) <=> ((cwcel @ XN @ ccc) & (cwcel @ (cco @ XN @ cc1 @ ccaddc) @ ccn))))).
thf(celnnnn0_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) <=> ((cwcel @ XN @ ccc) & (cwcel @ (cco @ XN @ cc1 @ ccmin) @ ccn0))))).
