...
thf(cramtlecl_conj,conjecture,(! [Xph:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : ((XT = (ccrab @ (^ [Xn:$i] : (! [Xs1:$i] : ((cwbr @ (ccv @ Xn) @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccle) => (Xph @ Xs1)))) @ (^ [Xn:$i] : ccn0))) => ((cwcel @ XM @ XT) => (cwss @ (ccfv @ XM @ ccuz) @ XT))))))).
