...
thf(cdfimafnf_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => (! [Xx3:$i] : (((cwfun @ (XF @ Xx3)) & (cwss @ (XA2 @ Xx3) @ (ccdm @ (XF @ Xx3)))) => ((ccima @ (XF @ Xx3) @ (XA2 @ Xx3)) = (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xy1) = (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))))))).
