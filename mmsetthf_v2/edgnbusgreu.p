...
thf(ausgredg2vtxeu_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XG @ ccusgr) @ (cwcel @ XE @ (ccfv @ XG @ ccedg)) @ (cwcel @ XY @ XE)) => (cwreu @ (^ [Xy1:$i] : (XE = (ccpr @ XY @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccfv @ XG @ ccvtx)))))))).
...
thf(cedgnbusgreu_conj,conjecture,(! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((! [Xn:$i] : ((XN @ Xn) = (cco @ XG @ XM @ ccnbgr))) => ((((cwcel @ XG @ ccusgr) & (cwcel @ XM @ XV)) & ((cwcel @ XC @ XE) & (cwcel @ XM @ XC))) => (cwreu @ (^ [Xn:$i] : (XC = (ccpr @ XM @ (ccv @ Xn)))) @ (^ [Xn:$i] : (XN @ Xn)))))))))))))).
