...
thf(aisnsqf_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => (((ccfv @ XA2 @ ccmu) = ccc0) <=> (cwrex @ (^ [Xp:$i] : (cwbr @ (cco @ (ccv @ Xp) @ cc2 @ ccexp) @ XA2 @ ccdvds)) @ (^ [Xp:$i] : ccprime)))))).
thf(a_3ad2ant1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xch) => ((cw3a @ Xph @ Xps @ Xth) => Xch))))))).
thf(cdvdssqf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwbr @ XB2 @ XA2 @ ccdvds)) => ((cwne @ (ccfv @ XA2 @ ccmu) @ ccc0) => (cwne @ (ccfv @ XB2 @ ccmu) @ ccc0)))))).
