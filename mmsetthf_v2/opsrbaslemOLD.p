...
thf(aopsrval2_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((XO = (ccfv @ XT @ (cco @ XI @ XR @ ccopws))) => ((Xc_le = (ccfv @ XO @ ccple)) => ((Xph => (cwcel @ XI @ XV)) => ((Xph => (cwcel @ XR @ XW)) => ((Xph => (cwss @ XT @ (ccxp @ XI @ XI))) => (Xph => (XO = (cco @ XS @ (ccop @ (ccfv @ ccnx @ ccple) @ Xc_le) @ ccsts))))))))))))))))))).
...
thf(aplendxOLD_ax,axiom,((ccfv @ ccnx @ ccple) = cc10)).
