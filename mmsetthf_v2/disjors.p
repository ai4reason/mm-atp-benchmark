...
thf(cdisjors_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) <=> (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (((ccv @ Xi) = (ccv @ Xj)) | ((ccin @ (ccsb @ (ccv @ Xi) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccsb @ (ccv @ Xj) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) = cc0))) @ (^ [Xj:$i] : XA2))) @ (^ [Xi:$i] : XA2)))))).
