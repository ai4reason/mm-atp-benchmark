...
thf(apmat0op_ax,axiom,(! [XC:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : (XP = (ccfv @ (XR @ Xi @ Xj) @ ccpl1)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XC @ Xi @ Xj) = (cco @ XN @ XP @ ccmat)))) => ((! [Xi:$i] : (! [Xj:$i] : ((Xc_0 @ Xi @ Xj) = (ccfv @ XP @ cc0g)))) => (! [Xi:$i] : (! [Xj:$i] : (((cwcel @ XN @ ccfn) & (cwcel @ (XR @ Xi @ Xj) @ ccrg)) => ((ccfv @ (XC @ Xi @ Xj) @ cc0g) = (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (Xc_0 @ Xi @ Xj))))))))))))))))).
