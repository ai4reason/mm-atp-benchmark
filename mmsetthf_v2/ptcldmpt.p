...
thf(aptcld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XA2 @ cctop @ XF)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XC @ Xk) @ (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ cccld)))) => (Xph => (cwcel @ (ccixp @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))) @ (ccfv @ (ccfv @ XF @ ccpt) @ cccld)))))))))))).
