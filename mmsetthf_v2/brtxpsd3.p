...
thf(abrtxpsd2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : ((XR @ Xx3) = (ccdif @ (XC @ Xx3) @ (ccrn @ (ccsymdif @ (cctxp @ ccvv @ ccep) @ (cctxp @ XS @ ccvv)))))) => ((! [Xx3:$i] : (cwbr @ XA2 @ XB2 @ (XC @ Xx3))) => (! [Xx3:$i] : ((cwbr @ XA2 @ XB2 @ (XR @ Xx3)) <=> (! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XB2) <=> (cwbr @ (ccv @ Xx3) @ XA2 @ XS))))))))))))))).
