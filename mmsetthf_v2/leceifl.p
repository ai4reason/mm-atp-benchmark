...
thf(altflcei_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ (ccfv @ XA2 @ ccfl) @ XB2 @ cclt) <=> (cwbr @ XA2 @ (ccneg @ (ccfv @ (ccneg @ XB2) @ ccfl)) @ cclt)))))).
...
thf(cleceifl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ (ccneg @ (ccfv @ (ccneg @ XA2) @ ccfl)) @ XB2 @ ccle) <=> (cwbr @ XA2 @ (ccfv @ XB2 @ ccfl) @ ccle)))))).
