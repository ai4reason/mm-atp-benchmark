...
thf(caxlowdimlem9_conj,conjecture,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XP = (ccun @ (ccsn @ (ccop @ cc3 @ (ccneg @ cc1))) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ cc3)) @ (ccsn @ ccc0)))) => (((cwcel @ XK @ (cco @ cc1 @ XN @ ccfz)) & (cwne @ XK @ cc3)) => ((ccfv @ XK @ XP) = ccc0))))))).
