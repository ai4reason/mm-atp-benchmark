...
thf(alcfrlem4_ax,axiom,(! [Xph:$o] : (! [XD:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [Xc_pe:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xg1:$i] : ((XH @ Xg1) = (ccfv @ (XK @ Xg1) @ cclh))) => ((! [Xg1:$i] : ((Xc_pe @ Xg1) = (ccfv @ (XW @ Xg1) @ (ccfv @ (XK @ Xg1) @ ccoch)))) => ((! [Xg1:$i] : ((XU @ Xg1) = (ccfv @ (XW @ Xg1) @ (ccfv @ (XK @ Xg1) @ ccdvh)))) => ((! [Xg1:$i] : (XV = (ccfv @ (XU @ Xg1) @ ccbs))) => ((! [Xg1:$i] : ((XL @ Xg1) = (ccfv @ (XU @ Xg1) @ cclk))) => ((! [Xg1:$i] : ((XD @ Xg1) = (ccfv @ (XU @ Xg1) @ ccld))) => ((! [Xg1:$i] : ((XQ @ Xg1) = (ccfv @ (XD @ Xg1) @ cclss))) => ((! [Xg1:$i] : ((XE @ Xg1) = (cciun @ (^ [Xg1:$i] : (XG @ Xg1)) @ (^ [Xg1:$i] : (ccfv @ (ccfv @ (ccv @ Xg1) @ (XL @ Xg1)) @ (Xc_pe @ Xg1)))))) => ((! [Xg1:$i] : (Xph => ((cwcel @ (XK @ Xg1) @ cchlt) & (cwcel @ (XW @ Xg1) @ (XH @ Xg1))))) => ((! [Xg1:$i] : (Xph => (cwcel @ (XG @ Xg1) @ (XQ @ Xg1)))) => ((! [Xg1:$i] : (Xph => (cwcel @ (XX @ Xg1) @ (XE @ Xg1)))) => (! [Xg1:$i] : (Xph => (cwcel @ (XX @ Xg1) @ XV)))))))))))))))))))))))))))).
thf(ccur_tp,type,(ccur : ($i > $o))).
thf(alssvacl_ax,axiom,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_pl = (ccfv @ XW @ ccplusg)) => ((XS = (ccfv @ XW @ cclss)) => ((((cwcel @ XW @ cclmod) & (cwcel @ XU @ XS)) & ((cwcel @ XX @ XU) & (cwcel @ XY @ XU))) => (cwcel @ (cco @ XX @ XY @ Xc_pl) @ XU))))))))))).
thf(clcfrlem6_conj,conjecture,(! [Xph:$o] : (! [XD:($i > ($i > $o))] : (! [Xc_pl:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [Xc_pe:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xg1:$i] : ((XH @ Xg1) = (ccfv @ (XK @ Xg1) @ cclh))) => ((! [Xg1:$i] : ((Xc_pe @ Xg1) = (ccfv @ (XW @ Xg1) @ (ccfv @ (XK @ Xg1) @ ccoch)))) => ((! [Xg1:$i] : (XU = (ccfv @ (XW @ Xg1) @ (ccfv @ (XK @ Xg1) @ ccdvh)))) => ((Xc_pl = (ccfv @ XU @ ccplusg)) => ((! [Xg1:$i] : ((XN @ Xg1) = (ccfv @ XU @ cclspn))) => ((! [Xg1:$i] : ((XL @ Xg1) = (ccfv @ XU @ cclk))) => ((! [Xg1:$i] : ((XD @ Xg1) = (ccfv @ XU @ ccld))) => ((! [Xg1:$i] : ((XQ @ Xg1) = (ccfv @ (XD @ Xg1) @ cclss))) => ((! [Xg1:$i] : (Xph => ((cwcel @ (XK @ Xg1) @ cchlt) & (cwcel @ (XW @ Xg1) @ (XH @ Xg1))))) => ((! [Xg1:$i] : (Xph => (cwcel @ (XG @ Xg1) @ (XQ @ Xg1)))) => ((! [Xg1:$i] : ((XE @ Xg1) = (cciun @ (^ [Xg1:$i] : (XG @ Xg1)) @ (^ [Xg1:$i] : (ccfv @ (ccfv @ (ccv @ Xg1) @ (XL @ Xg1)) @ (Xc_pe @ Xg1)))))) => ((! [Xg1:$i] : (Xph => (cwcel @ XX @ (XE @ Xg1)))) => ((! [Xg1:$i] : (Xph => (cwcel @ XY @ (XE @ Xg1)))) => ((! [Xg1:$i] : (Xph => ((ccfv @ (ccsn @ XX) @ (XN @ Xg1)) = (ccfv @ (ccsn @ XY) @ (XN @ Xg1))))) => (! [Xg1:$i] : (Xph => (cwcel @ (cco @ XX @ XY @ Xc_pl) @ (XE @ Xg1)))))))))))))))))))))))))))))))))).
