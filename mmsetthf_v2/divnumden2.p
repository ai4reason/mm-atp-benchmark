...
thf(anumdenneg_ax,axiom,(! [XQ:($i > $o)] : ((cwcel @ XQ @ ccq) => (((ccfv @ (ccneg @ XQ) @ ccnumer) = (ccneg @ (ccfv @ XQ @ ccnumer))) & ((ccfv @ (ccneg @ XQ) @ ccdenom) = (ccfv @ XQ @ ccdenom)))))).
...
thf(cdivnumden2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ (ccneg @ XB2) @ ccn)) => (((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccnumer) = (ccneg @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv))) & ((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccdenom) = (ccneg @ (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv)))))))).
