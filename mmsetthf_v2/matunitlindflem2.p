...
thf(afrlmfibas_ax,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XF = (cco @ XR @ XI @ ccfrlm)) => ((XN = (ccfv @ XR @ ccbs)) => (((cwcel @ XR @ XV) & (cwcel @ XI @ ccfn)) => ((cco @ XN @ XI @ ccmap) = (ccfv @ XF @ ccbs))))))))))).
...
thf(acurf_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwf @ (ccxp @ XA2 @ XB2) @ XC @ XF) @ (cwcel @ XB2 @ (ccdif @ XV @ (ccsn @ cc0))) @ (cwcel @ XC @ XW)) => (cwf @ XA2 @ (cco @ XC @ XB2 @ ccmap) @ (cccur @ XF)))))))))).
...
thf(alindfrn_ax,axiom,(! [XF:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ cclmod) & (cwbr @ XF @ XW @ cclindf)) => (cwcel @ (ccrn @ XF) @ (ccfv @ XW @ cclinds)))))).
...
thf(alindff1_ax,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XL = (ccfv @ XW @ ccsca)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XL @ ccnzr) @ (cwbr @ XF @ XW @ cclindf)) => (cwf1 @ (ccdm @ XF) @ XB2 @ XF))))))))).
...
thf(alindsenlbs_ax,axiom,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (((cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XI @ ccfn) @ (cwcel @ XX @ (ccfv @ (cco @ XR @ XI @ ccfrlm) @ cclinds))) & (cwbr @ XX @ XI @ ccen)) => (cwcel @ XX @ (ccfv @ (cco @ XR @ XI @ ccfrlm) @ cclbs))))))).
...
thf(aelfilspd_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XN = (ccfv @ XM @ cclspn)) => ((XB2 = (ccfv @ XM @ ccbs)) => ((XK = (ccfv @ XS @ ccbs)) => ((XS = (ccfv @ XM @ ccsca)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => ((Xc_x = (ccfv @ XM @ ccvsca)) => ((Xph => (cwf @ XI @ XB2 @ XF)) => ((Xph => (cwcel @ XM @ cclmod)) => ((Xph => (cwcel @ XI @ ccfn)) => (Xph => ((cwcel @ XX @ (ccfv @ (ccima @ XF @ XI) @ XN)) <=> (cwrex @ (^ [Xf1:$i] : (XX = (cco @ XM @ (cco @ (ccv @ Xf1) @ XF @ (ccof @ Xc_x)) @ ccgsu))) @ (^ [Xf1:$i] : (cco @ XK @ XI @ ccmap)))))))))))))))))))))))))).
...
thf(afrlmvscafval_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XR @ XI @ ccfrlm)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XA2 @ XK)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xc_xb = (ccfv @ XY @ ccvsca)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (Xph => ((cco @ XA2 @ XX @ Xc_xb) = (cco @ (ccxp @ XI @ (ccsn @ XA2)) @ XX @ (ccof @ Xc_x)))))))))))))))))))))))).
...
thf(aad4ant24_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (((Xph & Xps) => Xch) => ((((Xth & Xph) & Xta) & Xps) => Xch)))))))).
...
thf(afndmfifsupp_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwfn @ XF @ XD)) => ((Xph => (cwcel @ XD @ ccfn)) => ((Xph => (cwcel @ XZ @ XV)) => (Xph => (cwbr @ XF @ XZ @ ccfsupp))))))))))).
...
thf(acurfv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cw3a @ (cwfn @ XF @ (ccxp @ XV @ XW)) @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW)) & (cwcel @ XW @ XX)) => ((ccfv @ XB2 @ (ccfv @ XA2 @ (cccur @ XF))) = (cco @ XA2 @ XB2 @ XF)))))))))).
...
thf(auncov_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cco @ XA2 @ XB2 @ (ccunc @ XF)) = (ccfv @ XB2 @ (ccfv @ XA2 @ XF)))))))))).
thf(aadantlr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => (((Xph & Xth) & Xps) => Xch))))))).
thf(aimp_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps => Xch)) => ((Xph & Xps) => Xch)))))).
thf(aexlimdv_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:$o] : ((! [Xx3:$i] : (Xph => ((Xps @ Xx3) => Xch))) => (Xph => ((? [Xx3:$i] : (Xps @ Xx3)) => Xch))))))).
thf(asylani_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xch) => ((Xps => ((Xch & Xth) => Xta)) => (Xps => ((Xph & Xth) => Xta)))))))))).
thf(ccmpt2_tp,type,(ccmpt2 : (($i > ($i > ($i > $o))) > (($i > ($i > ($i > $o))) > (($i > ($i > ($i > $o))) > ($i > $o)))))).
thf(auncf_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ (cco @ XC @ XB2 @ ccmap) @ XF) => (cwf @ (ccxp @ XA2 @ XB2) @ XC @ (ccunc @ XF)))))))).
...
thf(auvcvval_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XU = (cco @ XR @ XI @ ccuvc)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cw3a @ (cwcel @ XR @ XV) @ (cwcel @ XI @ XW) @ (cwcel @ XJ @ XI)) & (cwcel @ XK @ XI)) => ((ccfv @ XK @ (ccfv @ XJ @ XU)) = (ccif @ (XK = XJ) @ Xc_1 @ Xc_0)))))))))))))))).
...
thf(aad5ant23_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (((Xph & Xps) => Xch) => (((((Xth & Xph) & Xps) & Xta) & Xet) => Xch))))))))).
...
thf(amat1bas_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((Xc_1 = (ccfv @ (cco @ XN @ XR @ ccmat) @ ccur)) => (((cwcel @ XR @ ccrg) & (cwcel @ XN @ ccfn)) => (cwcel @ Xc_1 @ XB2))))))))))).
...
thf(amdetmul_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XD = (cco @ XN @ XR @ ccmdat)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_xb = (ccfv @ XA2 @ ccmulr)) => ((cw3a @ (cwcel @ XR @ cccrg) @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XB2)) => ((ccfv @ (cco @ XF @ XG @ Xc_xb) @ XD) = (cco @ (ccfv @ XF @ XD) @ (ccfv @ XG @ XD) @ Xc_x)))))))))))))))))).
thf(ccn0_tp,type,(ccn0 : ($i > $o))).
thf(ccsrg_tp,type,(ccsrg : ($i > $o))).
thf(ccmg_tp,type,(ccmg : ($i > $o))).
thf(cchash_tp,type,(cchash : ($i > $o))).
thf(amdet1_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((XD = (cco @ XN @ XR @ ccmdat)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XI = (ccfv @ XA2 @ ccur)) => ((Xc_1 = (ccfv @ XR @ ccur)) => (((cwcel @ XR @ cccrg) & (cwcel @ XN @ ccfn)) => ((ccfv @ XI @ XD) = Xc_1))))))))))))).
thf(ccoppr_tp,type,(ccoppr : ($i > $o))).
thf(acrngunit_ax,axiom,(! [Xc_pa:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XX:($i > $o)] : ((XU = (ccfv @ XR @ ccui)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((Xc_pa = (ccfv @ XR @ ccdsr)) => ((cwcel @ XR @ cccrg) => ((cwcel @ XX @ XU) <=> (cwbr @ XX @ Xc_1 @ Xc_pa)))))))))))).
thf(cmatunitlindflem2_conj,conjecture,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (((((cwcel @ XR @ ccfield) & (cwcel @ XM @ (ccfv @ (cco @ XI @ XR @ ccmat) @ ccbs))) & (cwne @ XI @ cc0)) & (cwbr @ (cccur @ XM) @ (cco @ XR @ XI @ ccfrlm) @ cclindf)) => (cwcel @ (ccfv @ XM @ (cco @ XI @ XR @ ccmdat)) @ (ccfv @ XR @ ccui))))))).
