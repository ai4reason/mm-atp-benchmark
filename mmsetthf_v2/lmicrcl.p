...
thf(abrlmic_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwbr @ XR @ XS @ cclmic) <=> (cwne @ (cco @ XR @ XS @ cclmim) @ cc0))))).
...
thf(almimlmhm_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (cco @ XR @ XS @ cclmim)) => (cwcel @ XF @ (cco @ XR @ XS @ cclmhm))))))).
thf(ccsca_tp,type,(ccsca : ($i > $o))).
thf(ccghm_tp,type,(ccghm : ($i > $o))).
thf(almhmlmod2_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) => (cwcel @ XT @ cclmod)))))).
thf(clmicrcl_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwbr @ XR @ XS @ cclmic) => (cwcel @ XS @ cclmod))))).
