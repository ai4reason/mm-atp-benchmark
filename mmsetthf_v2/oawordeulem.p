...
thf(aoacan_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) => (((cco @ XA2 @ XB2 @ ccoa) = (cco @ XA2 @ XC @ ccoa)) <=> (XB2 = XC))))))).
...
thf(coawordeulem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : ((cwcel @ XA2 @ ccon0) => ((cwcel @ XB2 @ ccon0) => ((! [Xy1:$i] : ((XS @ Xy1) = (ccrab @ (^ [Xy1:$i] : (cwss @ XB2 @ (cco @ XA2 @ (ccv @ Xy1) @ ccoa))) @ (^ [Xy1:$i] : ccon0)))) => ((cwss @ XA2 @ XB2) => (cwreu @ (^ [Xx3:$i] : ((cco @ XA2 @ (ccv @ Xx3) @ ccoa) = XB2)) @ (^ [Xx3:$i] : ccon0)))))))))).
