...
thf(csermono_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XK @ (ccfv @ XM @ ccuz))) => ((Xph => (cwcel @ XN @ (ccfv @ XK @ ccuz))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XM @ XN @ ccfz))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ ccr))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ (cco @ XK @ cc1 @ ccaddc) @ XN @ ccfz))) => (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ XF) @ ccle))) => (Xph => (cwbr @ (ccfv @ XK @ (ccseq @ ccaddc @ XF @ XM)) @ (ccfv @ XN @ (ccseq @ ccaddc @ XF @ XM)) @ ccle)))))))))))).
