...
thf(ainfssuni_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (~ (cwcel @ XA2 @ ccfn)) @ (cwcel @ XB2 @ ccfn) @ (cwss @ XA2 @ (ccuni @ XB2))) => (cwrex @ (^ [Xx3:$i] : (~ (cwcel @ (ccin @ XA2 @ (ccv @ Xx3)) @ ccfn))) @ (^ [Xx3:$i] : XB2)))))).
...
thf(cbwth_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwcel @ XJ @ cccmp) @ (cwss @ XA2 @ XX) @ (~ (cwcel @ XA2 @ ccfn))) => (cwrex @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (ccfv @ XA2 @ (ccfv @ XJ @ cclp)))) @ (^ [Xx3:$i] : XX)))))))).
