...
thf(aminvec_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XU @ ccbs)) => ((Xc_mi = (ccfv @ XU @ ccsg)) => ((XN = (ccfv @ XU @ ccnm)) => ((Xph => (cwcel @ XU @ cccph)) => ((Xph => (cwcel @ XY @ (ccfv @ XU @ cclss))) => ((Xph => (cwcel @ (cco @ XU @ XY @ ccress) @ cccms)) => ((Xph => (cwcel @ XA2 @ XX)) => (Xph => (cwreu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ Xc_mi) @ XN) @ (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ Xc_mi) @ XN) @ ccle)) @ (^ [Xy1:$i] : XY))) @ (^ [Xx3:$i] : XY)))))))))))))))))).
...
thf(ahlcms_ax,axiom,(! [XW:($i > $o)] : ((cwcel @ XW @ cchl) => (cwcel @ XW @ cccms)))).
