...
thf(afsuppunfi_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwbr @ XF @ XZ @ ccfsupp)) => ((Xph => (cwbr @ XG @ XZ @ ccfsupp)) => (Xph => (cwcel @ (ccun @ (cco @ XF @ XZ @ ccsupp) @ (cco @ XG @ XZ @ ccsupp)) @ ccfn))))))))).
