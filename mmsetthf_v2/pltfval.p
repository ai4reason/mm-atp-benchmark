...
thf(adf_plt_ax,axiom,(ccplt = (ccmpt @ (^ [Xp:$i] : ccvv) @ (^ [Xp:$i] : (ccdif @ (ccfv @ (ccv @ Xp) @ ccple) @ ccid))))).
...
thf(cpltfval_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_lt = (ccfv @ XK @ ccplt)) => ((cwcel @ XK @ XA2) => (Xc_lt = (ccdif @ Xc_le @ ccid)))))))))).
