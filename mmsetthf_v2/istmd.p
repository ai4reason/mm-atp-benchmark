...
thf(adf_tmd_ax,axiom,(cctmd = (ccrab @ (^ [Xf1:$i] : (cwsbc @ (^ [Xj:$i] : (cwcel @ (ccfv @ (ccv @ Xf1) @ ccplusf) @ (cco @ (cco @ (ccv @ Xj) @ (ccv @ Xj) @ cctx) @ (ccv @ Xj) @ cccn))) @ (ccfv @ (ccv @ Xf1) @ cctopn))) @ (^ [Xf1:$i] : (ccin @ ccmnd @ cctps))))).
thf(adf_3an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) <=> ((Xph & Xps) & Xch)))))).
thf(cistmd_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((XF = (ccfv @ XG @ ccplusf)) => ((XJ = (ccfv @ XG @ cctopn)) => ((cwcel @ XG @ cctmd) <=> (cw3a @ (cwcel @ XG @ ccmnd) @ (cwcel @ XG @ cctps) @ (cwcel @ XF @ (cco @ (cco @ XJ @ XJ @ cctx) @ XJ @ cccn)))))))))).
