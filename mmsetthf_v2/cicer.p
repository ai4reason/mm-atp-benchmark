...
thf(aisofn_ax,axiom,(! [XC:($i > $o)] : ((cwcel @ XC @ cccat) => (cwfn @ (ccfv @ XC @ cciso) @ (ccxp @ (ccfv @ XC @ ccbs) @ (ccfv @ XC @ ccbs)))))).
...
thf(acicfval_ax,axiom,(! [XC:($i > $o)] : ((cwcel @ XC @ cccat) => ((ccfv @ XC @ cccic) = (cco @ (ccfv @ XC @ cciso) @ cc0 @ ccsupp))))).
thf(acicsym_ax,axiom,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XC @ cccat) & (cwbr @ XR @ XS @ (ccfv @ XC @ cccic))) => (cwbr @ XS @ XR @ (ccfv @ XC @ cccic))))))).
thf(a_3expb_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((cw3a @ Xph @ Xps @ Xch) => Xth) => ((Xph & (Xps & Xch)) => Xth))))))).
thf(ccco_tp,type,(ccco : ($i > $o))).
thf(acictr_ax,axiom,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwcel @ XC @ cccat) @ (cwbr @ XR @ XS @ (ccfv @ XC @ cccic)) @ (cwbr @ XS @ XT @ (ccfv @ XC @ cccic))) => (cwbr @ XR @ XT @ (ccfv @ XC @ cccic)))))))).
thf(aimpbida_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) => Xch) => (((Xph & Xch) => Xps) => (Xph => (Xps <=> Xch)))))))).
thf(cchom_tp,type,(cchom : ($i > $o))).
thf(cccid_tp,type,(cccid : ($i > $o))).
thf(acicref_ax,axiom,(! [XC:($i > $o)] : (! [XO:($i > $o)] : (((cwcel @ XC @ cccat) & (cwcel @ XO @ (ccfv @ XC @ ccbs))) => (cwbr @ XO @ XO @ (ccfv @ XC @ cccic)))))).
thf(aciclcl_ax,axiom,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XC @ cccat) & (cwbr @ XR @ XS @ (ccfv @ XC @ cccic))) => (cwcel @ XR @ (ccfv @ XC @ ccbs))))))).
thf(ccicer_conj,conjecture,(! [XC:($i > $o)] : ((cwcel @ XC @ cccat) => (cwer @ (ccfv @ XC @ ccbs) @ (ccfv @ XC @ cccic))))).
