...
thf(abccp1k_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XK @ ccn0)) => (Xph => ((cco @ XC @ (cco @ XK @ cc1 @ ccaddc) @ ccbcc) = (cco @ (cco @ XC @ XK @ ccbcc) @ (cco @ (cco @ XC @ XK @ ccmin) @ (cco @ XK @ cc1 @ ccaddc) @ ccdiv) @ ccmul))))))))).
...
thf(abcccl_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XK @ ccn0)) => (Xph => (cwcel @ (cco @ XC @ XK @ ccbcc) @ ccc)))))))).
...
thf(abcc0_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XK @ ccn0)) => (Xph => (((cco @ XC @ XK @ ccbcc) = ccc0) <=> (cwcel @ XC @ (cco @ ccc0 @ (cco @ XK @ cc1 @ ccmin) @ ccfz)))))))))).
...
thf(abinomcxplemrat_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((! [Xk:$i] : (Xph => (cwcel @ (XA2 @ Xk) @ ccrp))) => ((! [Xk:$i] : (Xph => (cwcel @ (XB2 @ Xk) @ ccr))) => ((! [Xk:$i] : (Xph => (cwbr @ (ccfv @ (XB2 @ Xk) @ ccabs) @ (ccfv @ (XA2 @ Xk) @ ccabs) @ cclt))) => ((Xph => (cwcel @ XC @ ccc)) => (Xph => (cwbr @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (ccfv @ (cco @ (cco @ XC @ (ccv @ Xk) @ ccmin) @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ ccdiv) @ ccabs))) @ cc1 @ ccli))))))))))).
thf(cbinomcxplemfrat_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XA2 @ Xj @ Xk) @ ccrp)))) => ((! [Xj:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XB2 @ Xj @ Xk) @ ccr)))) => ((! [Xj:$i] : (! [Xk:$i] : (Xph => (cwbr @ (ccfv @ (XB2 @ Xj @ Xk) @ ccabs) @ (ccfv @ (XA2 @ Xj @ Xk) @ ccabs) @ cclt)))) => ((Xph => (cwcel @ XC @ ccc)) => ((! [Xj:$i] : (! [Xk:$i] : ((XF @ Xj @ Xk) = (ccmpt @ (^ [Xj:$i] : ccn0) @ (^ [Xj:$i] : (cco @ XC @ (ccv @ Xj) @ ccbcc)))))) => (! [Xj:$i] : ((Xph & (~ (cwcel @ XC @ ccn0))) => (cwbr @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (XF @ Xj @ Xk)) @ (ccfv @ (ccv @ Xk) @ (XF @ Xj @ Xk)) @ ccdiv) @ ccabs))) @ cc1 @ ccli)))))))))))))).
