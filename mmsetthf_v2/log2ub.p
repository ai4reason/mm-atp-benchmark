...
thf(alog2ublem1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwbr @ (cco @ (cco @ (cco @ cc3 @ cc7 @ ccexp) @ (cco @ cc5 @ cc7 @ ccmul) @ ccmul) @ XA2 @ ccmul) @ XB2 @ ccle) => ((cwcel @ XA2 @ ccr) => ((cwcel @ XD @ ccn0) => ((cwcel @ XE @ ccn) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XF @ ccn0) => ((XC = (cco @ XA2 @ (cco @ XD @ XE @ ccdiv) @ ccaddc)) => (((cco @ XB2 @ XF @ ccaddc) = XG) => ((cwbr @ (cco @ (cco @ (cco @ cc3 @ cc7 @ ccexp) @ (cco @ cc5 @ cc7 @ ccmul) @ ccmul) @ XD @ ccmul) @ (cco @ XE @ XF @ ccmul) @ ccle) => (cwbr @ (cco @ (cco @ (cco @ cc3 @ cc7 @ ccexp) @ (cco @ cc5 @ cc7 @ ccmul) @ ccmul) @ XC @ ccmul) @ XG @ ccle)))))))))))))))))).
thf(alog2ublem3_ax,axiom,(cwbr @ (cco @ (cco @ (cco @ cc3 @ cc7 @ ccexp) @ (cco @ cc5 @ cc7 @ ccmul) @ ccmul) @ (ccsu @ (cco @ ccc0 @ cc3 @ ccfz) @ (^ [Xn:$i] : (cco @ cc2 @ (cco @ (cco @ cc3 @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccmul) @ (cco @ cc9 @ (ccv @ Xn) @ ccexp) @ ccmul) @ ccdiv))) @ ccmul) @ (ccdc @ (ccdc @ (ccdc @ (ccdc @ cc5 @ cc3) @ ccc0) @ cc5) @ cc6) @ ccle)).
