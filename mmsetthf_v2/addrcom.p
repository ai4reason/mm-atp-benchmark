...
thf(aaddrfn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ XC) & (cwcel @ XB2 @ XD)) => (cwfn @ (cco @ XA2 @ XB2 @ ccplusr) @ ccr))))))).
...
thf(aaddcomgi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cco @ XA2 @ XB2 @ ccaddc) = (cco @ XB2 @ XA2 @ ccaddc))))).
thf(aaddrfv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XE) @ (cwcel @ XB2 @ XD) @ (cwcel @ XC @ ccr)) => ((ccfv @ XC @ (cco @ XA2 @ XB2 @ ccplusr)) = (cco @ (ccfv @ XC @ XA2) @ (ccfv @ XC @ XB2) @ ccaddc))))))))).
