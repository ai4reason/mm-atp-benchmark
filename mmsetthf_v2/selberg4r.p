...
thf(aselberg4_ax,axiom,(cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ ccchp) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ (cco @ (cco @ cc2 @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccdiv) @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccsu @ (cco @ cc1 @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ ccfl) @ ccfz) @ (^ [Xm:$i] : (cco @ (ccfv @ (ccv @ Xm) @ ccvma) @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ (ccv @ Xm) @ ccdiv) @ ccchp) @ ccmul))) @ ccmul))) @ ccmul) @ ccmin) @ (ccv @ Xx3) @ ccdiv))) @ cco1)).
...
thf(a_2vmadivsum_ax,axiom,(cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccv @ Xn) @ ccdiv) @ (ccsu @ (cco @ cc1 @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ ccfl) @ ccfz) @ (^ [Xm:$i] : (cco @ (ccfv @ (ccv @ Xm) @ ccvma) @ (ccv @ Xm) @ ccdiv))) @ ccmul))) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccdiv) @ (cco @ (ccfv @ (ccv @ Xx3) @ cclog) @ cc2 @ ccdiv) @ ccmin))) @ cco1)).
thf(cselberg4r_conj,conjecture,(! [XR:($i > ($i > $o))] : ((! [Xa:$i] : ((XR @ Xa) = (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin))))) => (! [Xa:$i] : (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ (XR @ Xa)) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ (cco @ (cco @ cc2 @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccdiv) @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccsu @ (cco @ cc1 @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ ccfl) @ ccfz) @ (^ [Xm:$i] : (cco @ (ccfv @ (ccv @ Xm) @ ccvma) @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ (ccv @ Xm) @ ccdiv) @ (XR @ Xa)) @ ccmul))) @ ccmul))) @ ccmul) @ ccmin) @ (ccv @ Xx3) @ ccdiv))) @ cco1))))).
