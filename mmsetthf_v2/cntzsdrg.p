...
thf(acntzsubr_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XM = (ccfv @ XR @ ccmgp)) => ((XZ = (ccfv @ XM @ cccntz)) => (((cwcel @ XR @ ccrg) & (cwss @ XS @ XB2)) => (cwcel @ (ccfv @ XS @ XZ) @ (ccfv @ XR @ ccsubrg)))))))))))).
...
thf(aissdrg2_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : ((XI @ Xx3) = (ccfv @ XR @ ccinvr))) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cwcel @ XS @ (ccfv @ XR @ ccsdrg)) <=> (cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XS @ (ccfv @ XR @ ccsubrg)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (XI @ Xx3)) @ XS)) @ (^ [Xx3:$i] : (ccdif @ XS @ (ccsn @ Xc_0))))))))))))).
