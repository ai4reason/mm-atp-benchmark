...
thf(asseqp1_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XS @ ccvv)) => ((Xph => (cwcel @ XM @ (ccword @ XS))) => ((XW = (ccin @ (ccword @ XS) @ (ccima @ (cccnv @ cchash) @ (ccfv @ (ccfv @ XM @ cchash) @ ccuz)))) => ((Xph => (cwf @ XW @ XS @ XF)) => ((Xph => (cwcel @ XN @ (ccfv @ (ccfv @ XM @ cchash) @ ccuz))) => (Xph => ((ccfv @ XN @ (cco @ XM @ XF @ ccsseq)) = (ccfv @ (ccres @ (cco @ XM @ XF @ ccsseq) @ (cco @ ccc0 @ XN @ ccfzo)) @ XF))))))))))))))).
...
thf(asubiwrd_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XS @ ccvv)) => ((Xph => (cwf @ ccn0 @ XS @ XF)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => (cwcel @ (ccres @ XF @ (cco @ ccc0 @ XN @ ccfzo)) @ (ccword @ XS))))))))))).
