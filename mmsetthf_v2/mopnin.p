...
thf(cmopnin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XA2 @ XJ) @ (cwcel @ XB2 @ XJ)) => (cwcel @ (ccin @ XA2 @ XB2) @ XJ))))))))).
