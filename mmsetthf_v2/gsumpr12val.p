...
thf(agsumprval_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xph => (cwcel @ XG @ XV)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (XN = (cco @ XM @ cc1 @ ccaddc))) => ((Xph => (cwf @ (ccpr @ XM @ XN) @ XB2 @ XF)) => (Xph => ((cco @ XG @ XF @ ccgsu) = (cco @ (ccfv @ XM @ XF) @ (ccfv @ XN @ XF) @ Xc_pl)))))))))))))))))).
