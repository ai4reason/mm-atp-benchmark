...
thf(asubfzo0_ax,axiom,(! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XI @ (cco @ ccc0 @ XN @ ccfzo)) & (cwcel @ XJ @ (cco @ ccc0 @ XN @ ccfzo))) => ((cwbr @ (ccneg @ XN) @ (cco @ XI @ XJ @ ccmin) @ cclt) & (cwbr @ (cco @ XI @ XJ @ ccmin) @ XN @ cclt))))))).
...
thf(apossumd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccaddc) @ cclt) <=> (cwbr @ (ccneg @ XB2) @ XA2 @ cclt))))))))).
...
thf(caddmodlteq_conj,conjecture,(! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XI @ (cco @ ccc0 @ XN @ ccfzo)) @ (cwcel @ XJ @ (cco @ ccc0 @ XN @ ccfzo)) @ (cwcel @ XS @ ccz)) => (((cco @ (cco @ XI @ XS @ ccaddc) @ XN @ ccmo) = (cco @ (cco @ XJ @ XS @ ccaddc) @ XN @ ccmo)) <=> (XI = XJ)))))))).
