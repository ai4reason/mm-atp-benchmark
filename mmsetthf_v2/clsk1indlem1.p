...
thf(adf3o2_ax,axiom,(cc3o = (cctp @ cc0 @ cc1o @ cc2o))).
...
thf(cclsk1indlem1_conj,conjecture,(! [XK:($i > ($i > $o))] : ((! [Xr:$i] : ((XK @ Xr) = (ccmpt @ (^ [Xr:$i] : (ccpw @ cc3o)) @ (^ [Xr:$i] : (ccif @ ((ccv @ Xr) = (ccsn @ cc0)) @ (ccpr @ cc0 @ cc1o) @ (ccv @ Xr)))))) => (! [Xr:$i] : (cwrex @ (^ [Xs1:$i] : (cwrex @ (^ [Xt:$i] : ((cwss @ (ccv @ Xs1) @ (ccv @ Xt)) & (~ (cwss @ (ccfv @ (ccv @ Xs1) @ (XK @ Xr)) @ (ccfv @ (ccv @ Xt) @ (XK @ Xr)))))) @ (^ [Xt:$i] : (ccpw @ cc3o)))) @ (^ [Xs1:$i] : (ccpw @ cc3o))))))).
