...
thf(crngcrescrhm_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XU @ XV)) => ((XC = (ccfv @ XU @ ccrngc)) => ((Xph => (XR = (ccin @ ccrg @ XU))) => ((XH = (ccres @ ccrh @ (ccxp @ XR @ XR))) => (Xph => ((cco @ XC @ XH @ ccresc) = (cco @ (cco @ XC @ XR @ ccress) @ (ccop @ (ccfv @ ccnx @ cchom) @ XH) @ ccsts)))))))))))))).
