...
thf(alcoel0_ax,axiom,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XM @ cclmod) & (cwcel @ XV @ (ccpw @ (ccfv @ XM @ ccbs)))) => (cwcel @ (ccfv @ XM @ cc0g) @ (cco @ XM @ XV @ cclinco)))))).
thf(ane0i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ XA2) => (cwne @ XA2 @ cc0))))).
thf(alincsumscmcl_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((Xc_x = (ccfv @ XM @ ccvsca)) => ((XR = (ccfv @ (ccfv @ XM @ ccsca) @ ccbs)) => ((Xc_pl = (ccfv @ XM @ ccplusg)) => ((((cwcel @ XM @ cclmod) & (cwcel @ XV @ (ccpw @ (ccfv @ XM @ ccbs)))) & (cw3a @ (cwcel @ XC @ XR) @ (cwcel @ XD @ (cco @ XM @ XV @ cclinco)) @ (cwcel @ XB2 @ (cco @ XM @ XV @ cclinco)))) => (cwcel @ (cco @ (cco @ XC @ XD @ Xc_x) @ XB2 @ Xc_pl) @ (cco @ XM @ XV @ cclinco))))))))))))))).
