...
thf(ashub2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccsh) & (cwcel @ XB2 @ ccsh)) => (cwss @ XA2 @ (cco @ XB2 @ XA2 @ cchj)))))).
thf(cshlub_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccsh) @ (cwcel @ XB2 @ ccsh) @ (cwcel @ XC @ ccch)) => (((cwss @ XA2 @ XC) & (cwss @ XB2 @ XC)) <=> (cwss @ (cco @ XA2 @ XB2 @ cchj) @ XC))))))).
