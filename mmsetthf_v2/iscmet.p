...
thf(adf_cmet_ax,axiom,(ccms = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccrab @ (^ [Xd:$i] : (cwral @ (^ [Xf1:$i] : (cwne @ (cco @ (ccfv @ (ccv @ Xd) @ ccmopn) @ (ccv @ Xf1) @ ccflim) @ cc0)) @ (^ [Xf1:$i] : (ccfv @ (ccv @ Xd) @ cccfil)))) @ (^ [Xd:$i] : (ccfv @ (ccv @ Xx3) @ ccme))))))).
...
thf(ciscmet_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((cwcel @ XD @ (ccfv @ XX @ ccms)) <=> ((cwcel @ XD @ (ccfv @ XX @ ccme)) & (cwral @ (^ [Xf1:$i] : (cwne @ (cco @ XJ @ (ccv @ Xf1) @ ccflim) @ cc0)) @ (^ [Xf1:$i] : (ccfv @ XD @ cccfil)))))))))).
