...
thf(adifpr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccdif @ XA2 @ (ccpr @ XB2 @ XC)) = (ccdif @ (ccdif @ XA2 @ (ccsn @ XB2)) @ (ccsn @ XC))))))).
thf(anbupgrel_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((((cwcel @ XG @ ccupgr) & (cwcel @ XK @ XV)) & ((cwcel @ XN @ XV) & (cwne @ XN @ XK))) => ((cwcel @ XN @ (cco @ XG @ XK @ ccnbgr)) <=> (cwcel @ (ccpr @ XN @ XK) @ XE))))))))))).
...
thf(aneleq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwnel @ XC @ XA2) <=> (cwnel @ XC @ XB2))))))).
...
thf(aupgrres1_ax,axiom,(! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : ((XF @ Xe) = (ccrab @ (^ [Xe:$i] : (cwnel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)))) => ((! [Xe:$i] : ((XS @ Xe) = (ccop @ (ccdif @ XV @ (ccsn @ XN)) @ (ccres @ ccid @ (XF @ Xe))))) => (! [Xe:$i] : (((cwcel @ XG @ ccupgr) & (cwcel @ XN @ XV)) => (cwcel @ (XS @ Xe) @ ccupgr)))))))))))))).
...
thf(cnbupgrres_conj,conjecture,(! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : ((XF @ Xe) = (ccrab @ (^ [Xe:$i] : (cwnel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)))) => ((! [Xe:$i] : ((XS @ Xe) = (ccop @ (ccdif @ XV @ (ccsn @ XN)) @ (ccres @ ccid @ (XF @ Xe))))) => (! [Xe:$i] : ((cw3a @ ((cwcel @ XG @ ccupgr) & (cwcel @ XN @ XV)) @ (cwcel @ XK @ (ccdif @ XV @ (ccsn @ XN))) @ (cwcel @ XM @ (ccdif @ XV @ (ccpr @ XN @ XK)))) => ((cwcel @ XM @ (cco @ XG @ XK @ ccnbgr)) => (cwcel @ XM @ (cco @ (XS @ Xe) @ XK @ ccnbgr)))))))))))))))))).
