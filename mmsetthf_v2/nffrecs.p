...
thf(anfpred_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XR @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XX @ Xx3))) => (cwnfc @ (^ [Xx3:$i] : (ccpred @ (XA2 @ Xx3) @ (XR @ Xx3) @ (XX @ Xx3))))))))))).
...
thf(cnffrecs_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XR @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => (cwnfc @ (^ [Xx3:$i] : (ccfrecs @ (XA2 @ Xx3) @ (XR @ Xx3) @ (XF @ Xx3))))))))))).
