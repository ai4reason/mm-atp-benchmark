...
thf(aaxrep2_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (? [Xx3:$i] : ((? [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xx3 @ Xy1 @ Xz) => ((ccv @ Xz) = (ccv @ Xy1))))) => (! [Xz:$i] : ((cwcel @ (ccv @ Xz) @ (ccv @ Xx3)) <=> (? [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (! [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))))))))).
thf(caxrep3_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xw:$i] : (? [Xx3:$i] : ((? [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) => ((ccv @ Xz) = (ccv @ Xy1))))) => (! [Xz:$i] : ((cwcel @ (ccv @ Xz) @ (ccv @ Xx3)) <=> (? [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xw)) & (! [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw))))))))))).
