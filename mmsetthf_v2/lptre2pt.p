...
thf(aiooabslt_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XA2 @ XB2 @ ccaddc) @ ccioo))) => (Xph => (cwbr @ (ccfv @ (cco @ XA2 @ XC @ ccmin) @ ccabs) @ XB2 @ cclt)))))))))).
...
thf(clptre2pt_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((Xph => (cwss @ XA2 @ ccr)) => ((Xph => (cwne @ (ccfv @ XA2 @ (ccfv @ XJ @ cclp)) @ cc0)) => ((Xph => (cwcel @ XE @ ccrp)) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmin) @ ccabs) @ XE @ cclt))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))))))))).
