...
thf(cxrge0subcld_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => ((Xph => (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => ((Xph => (cwbr @ XB2 @ XA2 @ ccle)) => (Xph => (cwcel @ (cco @ XA2 @ (ccxne @ XB2) @ ccxad) @ (cco @ ccc0 @ ccpnf @ ccicc)))))))))).
