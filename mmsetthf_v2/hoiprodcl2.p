...
thf(ahoiprodcl_ax,axiom,(! [Xph:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XX @ ccfn))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwf @ XX @ (ccxp @ ccr @ ccr) @ (XI @ Xk)))) => (! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (XI @ Xk))) @ ccvol))) @ (cco @ ccc0 @ ccpnf @ ccico))))))))))).
thf(choiprodcl2_conj,conjecture,(! [Xph:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XX @ ccfn))) => ((! [Xi:$i] : (! [Xk:$i] : ((XL @ Xi @ Xk) = (ccmpt @ (^ [Xi:$i] : (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap)) @ (^ [Xi:$i] : (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccv @ Xi))) @ ccvol)))))))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwf @ XX @ (ccxp @ ccr @ ccr) @ XI))) => (! [Xi:$i] : (! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (ccfv @ XI @ (XL @ Xi @ Xk)) @ (cco @ ccc0 @ ccpnf @ ccico)))))))))))))).
