...
thf(ciooabslt_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XA2 @ XB2 @ ccaddc) @ ccioo))) => (Xph => (cwbr @ (ccfv @ (cco @ XA2 @ XC @ ccmin) @ ccabs) @ XB2 @ cclt)))))))))).
