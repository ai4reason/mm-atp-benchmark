...
thf(acanthp1_ax,axiom,(! [XA2:($i > $o)] : ((cwbr @ cc1o @ XA2 @ ccsdm) => (cwbr @ (cco @ XA2 @ cc1o @ cccda) @ (ccpw @ XA2) @ ccsdm)))).
...
thf(cgchcda1_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccgch) & (~ (cwcel @ XA2 @ ccfn))) => (cwbr @ (cco @ XA2 @ cc1o @ cccda) @ XA2 @ ccen)))).
