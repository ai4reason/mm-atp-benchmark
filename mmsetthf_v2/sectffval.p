...
thf(adf_sect_ax,axiom,(ccsect = (ccmpt @ (^ [Xc:$i] : cccat) @ (^ [Xc:$i] : (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xc) @ ccbs))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xc) @ ccbs))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccopab @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cwsbc @ (^ [Xh:$i] : (((cwcel @ (ccv @ Xf1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xh))) & (cwcel @ (ccv @ Xg1) @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccv @ Xh)))) & ((cco @ (ccv @ Xg1) @ (ccv @ Xf1) @ (cco @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xc) @ ccco))) = (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xc) @ cccid))))) @ (ccfv @ (ccv @ Xc) @ cchom)))))))))))).
