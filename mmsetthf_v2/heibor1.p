...
thf(aheibor1lem_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((Xph => (cwcel @ XD @ (ccfv @ XX @ ccme))) => ((Xph => (cwcel @ XJ @ cccmp)) => ((Xph => (cwcel @ XF @ (ccfv @ XD @ ccca))) => ((Xph => (cwf @ ccn @ XX @ XF)) => (Xph => (cwcel @ XF @ (ccdm @ (ccfv @ XJ @ cclm))))))))))))))).
...
thf(cheibor1_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => (((cwcel @ XD @ (ccfv @ XX @ ccme)) & (cwcel @ XJ @ cccmp)) => ((cwcel @ XD @ (ccfv @ XX @ ccms)) & (cwcel @ XD @ (ccfv @ XX @ cctotbnd))))))))).
