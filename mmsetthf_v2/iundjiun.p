...
thf(auzwo4_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xk:$i] : (cwnf @ (^ [Xj:$i] : (Xps @ Xj @ Xk)))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xj) = (ccv @ Xk)) => ((Xph @ Xj) <=> (Xps @ Xj @ Xk))))) => (! [Xj:$i] : (((cwss @ XS @ (ccfv @ (XM @ Xj) @ ccuz)) & (cwrex @ (^ [Xj:$i] : (Xph @ Xj)) @ (^ [Xj:$i] : XS))) => (cwrex @ (^ [Xj:$i] : ((Xph @ Xj) & (cwral @ (^ [Xk:$i] : ((cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ cclt) => (~ (Xps @ Xj @ Xk)))) @ (^ [Xk:$i] : XS)))) @ (^ [Xj:$i] : XS))))))))))).
...
thf(aelfzolem1_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ XM @ XN @ ccfzo)) => (cwbr @ XK @ (cco @ XN @ cc1 @ ccmin) @ ccle)))))).
...
thf(aiuneqfzuz_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xm:$i] : (XZ = (ccfv @ (XN @ Xm) @ ccuz))) => ((cwral @ (^ [Xm:$i] : ((cciun @ (^ [Xn:$i] : (cco @ (XN @ Xm) @ (ccv @ Xm) @ ccfz)) @ (^ [Xn:$i] : (XA2 @ Xn))) = (cciun @ (^ [Xn:$i] : (cco @ (XN @ Xm) @ (ccv @ Xm) @ ccfz)) @ (^ [Xn:$i] : (XB2 @ Xn))))) @ (^ [Xm:$i] : XZ)) => ((cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (XA2 @ Xn))) = (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (XB2 @ Xn))))))))))).
...
thf(aad5ant2345_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (((((Xph & Xps) & Xch) & Xth) => Xta) => (((((Xet & Xph) & Xps) & Xch) & Xth) => Xta))))))))).
