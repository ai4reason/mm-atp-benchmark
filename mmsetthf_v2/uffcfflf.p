...
thf(afmufil_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XX @ XA2) @ (cwcel @ XL @ (ccfv @ XY @ ccufil)) @ (cwf @ XY @ XX @ XF)) => (cwcel @ (ccfv @ XL @ (cco @ XX @ XF @ ccfm)) @ (ccfv @ XX @ ccufil))))))))).
...
thf(cuffcfflf_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccufil)) @ (cwf @ XY @ XX @ XF)) => ((ccfv @ XF @ (cco @ XJ @ XL @ ccfcf)) = (ccfv @ XF @ (cco @ XJ @ XL @ ccflf)))))))))).
