...
thf(afin1a2lem9_ax,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwor @ XX @ ccrpss) @ (cwss @ XX @ ccfn) @ (cwcel @ XA2 @ ccom)) => (cwcel @ (ccrab @ (^ [Xb:$i] : (cwbr @ (ccv @ Xb) @ XA2 @ ccdom)) @ (^ [Xb:$i] : XX)) @ ccfn))))).
...
thf(afincssdom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XB2 @ ccfn) @ ((cwss @ XA2 @ XB2) | (cwss @ XB2 @ XA2))) => ((cwbr @ XA2 @ XB2 @ ccdom) <=> (cwss @ XA2 @ XB2)))))).
...
thf(cfin1a2lem11_conj,conjecture,(! [XA2:($i > $o)] : (((cwor @ XA2 @ ccrpss) & (cwss @ XA2 @ ccfn)) => ((ccrn @ (ccmpt @ (^ [Xb:$i] : ccom) @ (^ [Xb:$i] : (ccuni @ (ccrab @ (^ [Xc:$i] : (cwbr @ (ccv @ Xc) @ (ccv @ Xb) @ ccdom)) @ (^ [Xc:$i] : XA2)))))) = (ccun @ XA2 @ (ccsn @ cc0)))))).
