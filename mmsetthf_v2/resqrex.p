...
thf(a_01sqrex_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwbr @ XA2 @ cc1 @ ccle)) => (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ cc1 @ ccle) & ((cco @ (ccv @ Xx3) @ cc2 @ ccexp) = XA2))) @ (^ [Xx3:$i] : ccrp))))).
...
thf(asqrecd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwne @ XA2 @ ccc0)) => (Xph => ((cco @ (cco @ cc1 @ XA2 @ ccdiv) @ cc2 @ ccexp) = (cco @ cc1 @ (cco @ XA2 @ cc2 @ ccexp) @ ccdiv)))))))).
...
thf(cresqrex_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle)) => (cwrex @ (^ [Xx3:$i] : ((cwbr @ ccc0 @ (ccv @ Xx3) @ ccle) & ((cco @ (ccv @ Xx3) @ cc2 @ ccexp) = XA2))) @ (^ [Xx3:$i] : ccr))))).
