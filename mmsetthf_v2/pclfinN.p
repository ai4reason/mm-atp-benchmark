...
thf(apclbtwnN_ax,axiom,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XS = (ccfv @ XK @ ccpsubsp)) => ((XU = (ccfv @ XK @ ccpclN)) => ((((cwcel @ XK @ XV) & (cwcel @ XX @ XS)) & ((cwss @ XY @ XX) & (cwss @ XX @ (ccfv @ XY @ XU)))) => (XX = (ccfv @ XY @ XU)))))))))))).
