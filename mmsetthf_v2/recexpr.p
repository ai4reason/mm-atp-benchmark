...
thf(areclem2pr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccab @ (^ [Xx3:$i] : (? [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccltq) & (~ (cwcel @ (ccfv @ (ccv @ Xy1) @ ccrq) @ XA2)))))))) => (! [Xy1:$i] : ((cwcel @ XA2 @ ccnp) => (cwcel @ (XB2 @ Xy1) @ ccnp))))))).
...
thf(areclem4pr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccab @ (^ [Xx3:$i] : (? [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccltq) & (~ (cwcel @ (ccfv @ (ccv @ Xy1) @ ccrq) @ XA2)))))))) => (! [Xy1:$i] : ((cwcel @ XA2 @ ccnp) => ((cco @ XA2 @ (XB2 @ Xy1) @ ccmp) = cc1p))))))).
thf(arspcev_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> Xps))) => (((cwcel @ XA2 @ XB2) & Xps) => (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XB2))))))))).
thf(aeqeq1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((XA2 = XC) <=> (XB2 = XC))))))))).
thf(aoveq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))).
thf(crecexpr_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccnp) => (cwrex @ (^ [Xx3:$i] : ((cco @ XA2 @ (ccv @ Xx3) @ ccmp) = cc1p)) @ (^ [Xx3:$i] : ccnp))))).
