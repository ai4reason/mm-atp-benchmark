...
thf(cdfon2lem8_conj,conjecture,(! [XA2:($i > $o)] : (((cwne @ XA2 @ cc0) & (cwral @ (^ [Xx3:$i] : (! [Xy1:$i] : (((cwpss @ (ccv @ Xy1) @ (ccv @ Xx3)) & (cwtr @ (ccv @ Xy1))) => (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))) @ (^ [Xx3:$i] : XA2))) => ((! [Xz:$i] : (((cwpss @ (ccv @ Xz) @ (ccint @ XA2)) & (cwtr @ (ccv @ Xz))) => (cwcel @ (ccv @ Xz) @ (ccint @ XA2)))) & (cwcel @ (ccint @ XA2) @ XA2))))).
