...
thf(aelxnn0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccxnn0) <=> ((cwcel @ XA2 @ ccn0) | (XA2 = ccpnf))))).
...
thf(axnn0ge0_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccxnn0) => (cwbr @ ccc0 @ XN @ ccle)))).
...
thf(atsmsid_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => (cwcel @ XG @ cccmn)) => ((Xph => (cwcel @ XG @ cctps)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwbr @ XF @ Xc_0 @ ccfsupp)) => (Xph => (cwcel @ (cco @ XG @ XF @ ccgsu) @ (cco @ XG @ XF @ cctsu)))))))))))))))))).
