...
thf(cinfrpge_b1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xy1)))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwss @ XA2 @ ccxr))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwne @ XA2 @ cc0))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr)))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ (XB2 @ Xy1) @ ccrp))) => (! [Xy1:$i] : ((Xph @ Xy1) => (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (cco @ (ccinf @ XA2 @ ccxr @ cclt) @ (XB2 @ Xy1) @ ccxad) @ ccle)) @ (^ [Xx3:$i] : XA2))))))))))))).
