...
thf(aseeq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((XA2 = XB2) => ((cwse @ XA2 @ XR) <=> (cwse @ XB2 @ XR))))))).
...
thf(coieq2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((XA2 = XB2) => ((ccoi @ XA2 @ XR) = (ccoi @ XB2 @ XR))))))).
