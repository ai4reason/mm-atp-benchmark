...
thf(asrngmul_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_as = (ccfv @ XR @ ccstv)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((cw3a @ (cwcel @ XR @ ccsr) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => ((ccfv @ (cco @ XX @ XY @ Xc_x) @ Xc_as) = (cco @ (ccfv @ XY @ Xc_as) @ (ccfv @ XX @ Xc_as) @ Xc_x))))))))))))).
