...
thf(clgsdilem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XN @ ccz)) & ((cwne @ XA2 @ ccc0) & (cwne @ XB2 @ ccc0))) => ((ccif @ ((cwbr @ XN @ ccc0 @ cclt) & (cwbr @ (cco @ XA2 @ XB2 @ ccmul) @ ccc0 @ cclt)) @ (ccneg @ cc1) @ cc1) = (cco @ (ccif @ ((cwbr @ XN @ ccc0 @ cclt) & (cwbr @ XA2 @ ccc0 @ cclt)) @ (ccneg @ cc1) @ cc1) @ (ccif @ ((cwbr @ XN @ ccc0 @ cclt) & (cwbr @ XB2 @ ccc0 @ cclt)) @ (ccneg @ cc1) @ cc1) @ ccmul))))))).
