...
thf(adf_dsmm_ax,axiom,(ccdsmm = (ccmpt2 @ (^ [Xs1:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xs1:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xs1:$i] : (^ [Xr:$i] : (cco @ (cco @ (ccv @ Xs1) @ (ccv @ Xr) @ ccprds) @ (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwne @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xr)) @ cc0g))) @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xr)))) @ ccfn)) @ (^ [Xf1:$i] : (ccixp @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xr))) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xr)) @ ccbs))))) @ ccress)))))).
