...
thf(cotthg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XU) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XW)) => (((ccotp @ XA2 @ XB2 @ XC) = (ccotp @ XD @ XE @ XF)) <=> (cw3a @ (XA2 = XD) @ (XB2 = XE) @ (XC = XF)))))))))))))).
