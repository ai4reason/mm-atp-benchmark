...
thf(covolscalem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XA2 @ ccr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XC @ ccrp))) => ((! [Xx3:$i] : ((Xph @ Xx3) => ((XB2 @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ XC @ (ccv @ Xx3) @ ccmul) @ XA2)) @ (^ [Xx3:$i] : ccr))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (ccfv @ XA2 @ ccovol) @ ccr))) => ((! [Xn:$i] : ((XS @ Xn) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1))) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccop @ (cco @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ cc1st) @ XC @ ccdiv) @ (cco @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ cc2nd) @ XC @ ccdiv)))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF)))))) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph @ Xx3) => (cwcel @ (XR @ Xn) @ ccrp)))) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph @ Xx3) => (cwbr @ (ccsup @ (ccrn @ (XS @ Xn)) @ ccxr @ cclt) @ (cco @ (ccfv @ XA2 @ ccovol) @ (cco @ XC @ (XR @ Xn) @ ccmul) @ ccaddc) @ ccle)))) => (! [Xx3:$i] : (! [Xn:$i] : ((Xph @ Xx3) => (cwbr @ (ccfv @ (XB2 @ Xx3) @ ccovol) @ (cco @ (cco @ (ccfv @ XA2 @ ccovol) @ XC @ ccdiv) @ (XR @ Xn) @ ccaddc) @ ccle))))))))))))))))))))))).
