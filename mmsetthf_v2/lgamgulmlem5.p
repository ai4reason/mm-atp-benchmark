...
thf(aabslogle_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ XA2 @ ccc0)) => (cwbr @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccabs) @ (cco @ (ccfv @ (ccfv @ (ccfv @ XA2 @ ccabs) @ cclog) @ ccabs) @ ccpi @ ccaddc) @ ccle)))).
...
thf(arelogdiv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwcel @ XB2 @ ccrp)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ cclog) = (cco @ (ccfv @ XA2 @ cclog) @ (ccfv @ XB2 @ cclog) @ ccmin)))))).
...
thf(arecdiv2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwne @ XA2 @ ccc0)) => ((Xph => (cwne @ XB2 @ ccc0)) => (Xph => ((cco @ (cco @ cc1 @ XA2 @ ccdiv) @ XB2 @ ccdiv) = (cco @ cc1 @ (cco @ XA2 @ XB2 @ ccmul) @ ccdiv))))))))))).
