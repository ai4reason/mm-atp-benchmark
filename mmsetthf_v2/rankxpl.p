...
thf(aunixp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwne @ (ccxp @ XA2 @ XB2) @ cc0) => ((ccuni @ (ccuni @ (ccxp @ XA2 @ XB2))) = (ccun @ XA2 @ XB2)))))).
thf(asstri_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ XB2) => ((cwss @ XB2 @ XC) => (cwss @ XA2 @ XC))))))).
thf(cword_tp,type,(cword : (($i > $o) > $o))).
thf(arankuniss_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwss @ (ccfv @ (ccuni @ XA2) @ ccrnk) @ (ccfv @ XA2 @ ccrnk))))).
...
thf(crankxpl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwne @ (ccxp @ XA2 @ XB2) @ cc0) => (cwss @ (ccfv @ (ccun @ XA2 @ XB2) @ ccrnk) @ (ccfv @ (ccxp @ XA2 @ XB2) @ ccrnk)))))))).
