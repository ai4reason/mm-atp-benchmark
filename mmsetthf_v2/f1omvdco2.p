...
thf(cf1omvdco2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwf1o @ XA2 @ XA2 @ XF) @ (cwf1o @ XA2 @ XA2 @ XG) @ (cwxo @ (cwss @ (ccdm @ (ccdif @ XF @ ccid)) @ XX) @ (cwss @ (ccdm @ (ccdif @ XG @ ccid)) @ XX))) => (~ (cwss @ (ccdm @ (ccdif @ (cccom @ XF @ XG) @ ccid)) @ XX)))))))).
