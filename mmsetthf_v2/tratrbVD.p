...
thf(aalrim3con13v_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [Xch:$o] : (! [Xx3:$i] : (((Xph @ Xx3) => (! [Xx3:$i] : (Xph @ Xx3))) => ((cw3a @ Xps @ (Xph @ Xx3) @ Xch) => (! [Xx3:$i] : (cw3a @ Xps @ (Xph @ Xx3) @ Xch))))))))).
thf(ahbral_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ (XA2 @ Xx3 @ Xy1)) => (! [Xx3:$i] : (cwcel @ (ccv @ Xy1) @ (XA2 @ Xx3 @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (! [Xx3:$i] : (Xph @ Xx3 @ Xy1))))) => (! [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1))) => (! [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1))))))))))).
...
thf(ae223_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : ((cwvd2 @ Xph @ Xps @ Xch) => ((cwvd2 @ Xph @ Xps @ Xth) => ((cwvd3 @ Xph @ Xps @ Xta @ Xet) => ((Xch => (Xth => (Xet => Xze))) => (cwvd3 @ Xph @ Xps @ Xta @ Xze))))))))))))).
...
thf(ae121_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwvd1 @ Xph @ Xps) => ((cwvd2 @ Xph @ Xch @ Xth) => ((cwvd1 @ Xph @ Xta) => ((Xps => (Xth => (Xta => Xet))) => (cwvd2 @ Xph @ Xch @ Xet)))))))))))).
...
thf(ae122_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((cwvd1 @ Xph @ Xps) => ((cwvd2 @ Xph @ Xch @ Xth) => ((cwvd2 @ Xph @ Xch @ Xta) => ((Xps => (Xth => (Xta => Xet))) => (cwvd2 @ Xph @ Xch @ Xet)))))))))))).
...
thf(arspsbc2_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ (XA2 @ Xx3) @ (XB2 @ Xy1)) => ((cwcel @ (XC @ Xx3 @ Xy1) @ XD) => ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : XD))) @ (^ [Xx3:$i] : (XB2 @ Xy1))) => (cwsbc @ (^ [Xy1:$i] : (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ (XA2 @ Xx3))) @ (XC @ Xx3 @ Xy1))))))))))))).
...
thf(asbcoreleleq_ax,axiom,(! [Xx3:$i] : (! [XA2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : ((cwcel @ (XA2 @ Xy1) @ (XV @ Xy1)) => ((cwsbc @ (^ [Xy1:$i] : (cw3o @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)) @ ((ccv @ Xx3) = (ccv @ Xy1)))) @ (XA2 @ Xy1)) <=> (cw3o @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xy1)) @ (cwcel @ (XA2 @ Xy1) @ (ccv @ Xx3)) @ ((ccv @ Xx3) = (XA2 @ Xy1)))))))))).
thf(aex_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) => Xch) => (Xph => (Xps => Xch))))))).
thf(a_3ornot23_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((~ Xph) & (~ Xps)) => ((cw3o @ Xch @ Xph @ Xps) => Xch)))))).
...
thf(ctratrbVD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwtr @ XA2) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cw3o @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)) @ ((ccv @ Xx3) = (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ (cwcel @ XB2 @ XA2)) => (cwtr @ XB2))))).
