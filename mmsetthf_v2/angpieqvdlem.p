...
thf(axov1plusxeqvd_ax,axiom,(! [Xph:$o] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (cwne @ XX @ (ccneg @ cc1))) => (Xph => ((cwcel @ XX @ ccrp) <=> (cwcel @ (cco @ XX @ (cco @ cc1 @ XX @ ccaddc) @ ccdiv) @ (cco @ ccc0 @ cc1 @ ccioo))))))))).
...
thf(anegned_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwne @ XA2 @ XB2)) => (Xph => (cwne @ (ccneg @ XA2) @ (ccneg @ XB2)))))))))).
...
thf(cangpieqvdlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwne @ XA2 @ XB2)) => ((Xph => (cwne @ XA2 @ XC)) => (Xph => ((cwcel @ (ccneg @ (cco @ (cco @ XC @ XB2 @ ccmin) @ (cco @ XA2 @ XB2 @ ccmin) @ ccdiv)) @ ccrp) <=> (cwcel @ (cco @ (cco @ XC @ XB2 @ ccmin) @ (cco @ XC @ XA2 @ ccmin) @ ccdiv) @ (cco @ ccc0 @ cc1 @ ccioo)))))))))))))).
