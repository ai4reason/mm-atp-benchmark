...
thf(admmpt2g_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XA2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XC)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XC @ XV) => ((ccdm @ (XF @ Xx3 @ Xy1)) = (ccxp @ XA2 @ XB2)))))))))))).
...
thf(aaovfundmoveq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwdfat @ (ccop @ XA2 @ XB2) @ XF) => ((ccaov @ XA2 @ XB2 @ XF) = (cco @ XA2 @ XB2 @ XF))))))).
...
thf(caovmpt4g_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XA2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XC)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xy1) @ XB2) @ (cwcel @ XC @ XV)) => ((ccaov @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XF @ Xx3 @ Xy1)) = XC))))))))))).
