...
thf(anmopadjlei_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XT @ ccbo) => ((cwcel @ XA2 @ cchil) => (cwbr @ (ccfv @ (ccfv @ XA2 @ (ccfv @ XT @ ccado)) @ ccno) @ (cco @ (ccfv @ XT @ ccnop) @ (ccfv @ XA2 @ ccno) @ ccmul) @ ccle)))))).
...
thf(cnmopadjlem_conj,conjecture,(! [XT:($i > $o)] : ((cwcel @ XT @ ccbo) => (cwbr @ (ccfv @ (ccfv @ XT @ ccado) @ ccnop) @ (ccfv @ XT @ ccnop) @ ccle)))).
