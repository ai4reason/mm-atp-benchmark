...
thf(cumgr2adedgwlklem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : ((XE = (ccfv @ XG @ ccedg)) => ((cw3a @ (cwcel @ XG @ ccumgr) @ (cwcel @ (ccpr @ XA2 @ XB2) @ XE) @ (cwcel @ (ccpr @ XB2 @ XC) @ XE)) => (((cwne @ XA2 @ XB2) & (cwne @ XB2 @ XC)) & (cw3a @ (cwcel @ XA2 @ (ccfv @ XG @ ccvtx)) @ (cwcel @ XB2 @ (ccfv @ XG @ ccvtx)) @ (cwcel @ XC @ (ccfv @ XG @ ccvtx)))))))))))).
