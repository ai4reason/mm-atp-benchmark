...
thf(clenegsq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ ccc0 @ XB2 @ ccle)) => (((cwbr @ XA2 @ XB2 @ ccle) & (cwbr @ (ccneg @ XA2) @ XB2 @ ccle)) <=> (cwbr @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccle)))))).
