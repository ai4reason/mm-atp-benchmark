...
thf(arepr0_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XS @ ccn0)) => (Xph => ((cco @ XA2 @ XM @ (ccfv @ ccc0 @ ccrepr)) = (ccif @ (XM = ccc0) @ (ccsn @ cc0) @ cc0))))))))))).
