...
thf(advnply_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XN @ ccn0)) => (cwcel @ (ccfv @ XN @ (cco @ ccc @ XF @ ccdvn)) @ (ccfv @ ccc @ ccply))))))).
...
thf(cplycpn_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (ccfv @ XS @ ccply)) => (cwcel @ XF @ (ccint @ (ccrn @ (ccfv @ ccc @ cccpn)))))))).
