...
thf(athlval_ax,axiom,(! [XC:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XK = (ccfv @ XW @ ccthl)) => ((XC = (ccfv @ XW @ cccss)) => ((XI = (ccfv @ XC @ ccipo)) => ((Xc_pe = (ccfv @ XW @ ccocv)) => ((cwcel @ XW @ XV) => (XK = (cco @ XI @ (ccop @ (ccfv @ ccnx @ ccoc) @ Xc_pe) @ ccsts)))))))))))))).
...
thf(aocndx_ax,axiom,((ccfv @ ccnx @ ccoc) = (ccdc @ cc1 @ cc1))).
...
thf(aipolerval_ax,axiom,(! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XI = (ccfv @ XF @ ccipo)) => ((cwcel @ XF @ XV) => ((ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwss @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XF) & (cwss @ (ccv @ Xx3) @ (ccv @ Xy1)))))) = (ccfv @ XI @ ccple)))))))).
...
thf(cthlle_conj,conjecture,(! [XC:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((XK = (ccfv @ XW @ ccthl)) => ((XC = (ccfv @ XW @ cccss)) => ((XI = (ccfv @ XC @ ccipo)) => ((Xc_le = (ccfv @ XI @ ccple)) => (Xc_le = (ccfv @ XK @ ccple)))))))))))).
