...
thf(cenfixsn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XY) @ (cwbr @ XX @ XY @ ccen)) => (? [Xf1:$i] : ((cwf1o @ XX @ XY @ (ccv @ Xf1)) & ((ccfv @ XA2 @ (ccv @ Xf1)) = XB2))))))))).
