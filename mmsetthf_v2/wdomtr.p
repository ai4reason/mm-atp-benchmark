...
thf(a_0wdom_ax,axiom,(! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => (cwbr @ cc0 @ XX @ ccwdom))))).
...
thf(abrwdomn0_ax,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwne @ XX @ cc0) => ((cwbr @ XX @ XY @ ccwdom) <=> (? [Xz:$i] : (cwfo @ XY @ XX @ (ccv @ Xz)))))))).
...
thf(cwdomtr_conj,conjecture,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (((cwbr @ XX @ XY @ ccwdom) & (cwbr @ XY @ XZ @ ccwdom)) => (cwbr @ XX @ XZ @ ccwdom)))))).
