...
thf(arngcidALTV_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XC = (ccfv @ XU @ ccrngcALTV)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xc_1 = (ccfv @ XC @ cccid)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (cwcel @ XX @ XB2)) => ((XS = (ccfv @ XX @ ccbs)) => (Xph => ((ccfv @ XX @ Xc_1) = (ccres @ ccid @ XS)))))))))))))))))).
