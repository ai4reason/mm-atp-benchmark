...
thf(afsuppco_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwbr @ XF @ XZ @ ccfsupp)) => ((Xph => (cwf1 @ XX @ XY @ XG)) => ((Xph => (cwcel @ XZ @ XW)) => ((Xph => (cwcel @ XF @ XV)) => (Xph => (cwbr @ (cccom @ XF @ XG) @ XZ @ ccfsupp))))))))))))))).
thf(ccres_tp,type,(ccres : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(afsuppcor_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ Xc_0 @ XW)) => ((Xph => (cwcel @ XZ @ XB2)) => ((Xph => (cwf @ XA2 @ XC @ XF)) => ((Xph => (cwf @ XB2 @ XD @ XG)) => ((Xph => (cwss @ XC @ XB2)) => ((Xph => (cwcel @ XA2 @ XU)) => ((Xph => (cwcel @ XB2 @ XV)) => ((Xph => (cwbr @ XF @ XZ @ ccfsupp)) => ((Xph => ((ccfv @ XZ @ XG) = Xc_0)) => (Xph => (cwbr @ (cccom @ XG @ XF) @ Xc_0 @ ccfsupp)))))))))))))))))))))))).
