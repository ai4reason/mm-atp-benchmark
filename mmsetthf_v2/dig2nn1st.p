...
thf(afldivexpfllog2_ax,axiom,(! [XX:($i > $o)] : ((cwcel @ XX @ ccrp) => ((ccfv @ (cco @ XX @ (cco @ cc2 @ (ccfv @ (cco @ cc2 @ XX @ cclogb) @ ccfl) @ ccexp) @ ccdiv) @ ccfl) = cc1)))).
...
thf(cdig2nn1st_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cco @ (cco @ (ccfv @ XN @ ccblen) @ cc1 @ ccmin) @ XN @ (ccfv @ cc2 @ ccdig)) = cc1)))).
