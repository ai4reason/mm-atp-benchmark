...
thf(afbssfi_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XF @ (ccfv @ XX @ ccfbas)) & (cwcel @ XA2 @ (ccfv @ XF @ ccfi))) => (cwrex @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XA2)) @ (^ [Xx3:$i] : XF))))))).
thf(cfbssint_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) @ (cwss @ XA2 @ XF) @ (cwcel @ XA2 @ ccfn)) => (cwrex @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ (ccint @ XA2))) @ (^ [Xx3:$i] : XF))))))).
