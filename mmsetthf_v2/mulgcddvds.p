...
thf(cmulgcddvds_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) => (cwbr @ (cco @ XK @ (cco @ XM @ XN @ ccmul) @ ccgcd) @ (cco @ (cco @ XK @ XM @ ccgcd) @ (cco @ XK @ XN @ ccgcd) @ ccmul) @ ccdvds)))))).
