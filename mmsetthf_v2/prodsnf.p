...
thf(cprodsnf_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwnfc @ (^ [Xk:$i] : (XB2 @ Xk))) => ((! [Xk:$i] : (((ccv @ Xk) = XM) => ((XA2 @ Xk) = (XB2 @ Xk)))) => (! [Xk:$i] : (((cwcel @ XM @ XV) & (cwcel @ (XB2 @ Xk) @ ccc)) => ((ccprod @ (^ [Xk:$i] : (ccsn @ XM)) @ (^ [Xk:$i] : (XA2 @ Xk))) = (XB2 @ Xk))))))))))).
