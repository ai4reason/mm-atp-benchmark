...
thf(aeupthvdres_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XG @ cciedg)) => ((Xph => (cwcel @ XG @ XW)) => ((Xph => (cwfun @ XI)) => ((Xph => (cwbr @ XF @ XP @ (ccfv @ XG @ cceupth))) => ((XH = (ccop @ XV @ (ccres @ XI @ (ccima @ XF @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))))) => (Xph => ((ccfv @ XH @ ccvtxdg) = (ccfv @ XG @ ccvtxdg)))))))))))))))))).
