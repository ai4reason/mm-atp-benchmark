...
thf(aelpell1qr2_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) => ((cwcel @ XA2 @ (ccfv @ XD @ ccpell1qr)) <=> ((cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) & (cwbr @ cc1 @ XA2 @ ccle))))))).
...
thf(cpellfundglb_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((cw3a @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ ccr) @ (cwbr @ (ccfv @ XD @ ccpellfund) @ XA2 @ cclt)) => (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccfv @ XD @ ccpellfund) @ (ccv @ Xx3) @ ccle) & (cwbr @ (ccv @ Xx3) @ XA2 @ cclt))) @ (^ [Xx3:$i] : (ccfv @ XD @ ccpell1qr))))))).
