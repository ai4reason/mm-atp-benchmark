...
thf(afgfil_ax,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccfil)) => ((cco @ XX @ XF @ ccfg) = XF))))).
thf(celfilss_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XF @ (ccfv @ XX @ ccfil)) & (cwss @ XA2 @ XX)) => ((cwcel @ XA2 @ XF) <=> (cwrex @ (^ [Xt:$i] : (cwss @ (ccv @ Xt) @ XA2)) @ (^ [Xt:$i] : XF)))))))).
