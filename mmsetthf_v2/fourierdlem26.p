...
thf(adivlt0gt0d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => (cwbr @ XA2 @ ccc0 @ cclt)) => (Xph => (cwbr @ (cco @ XA2 @ XB2 @ ccdiv) @ ccc0 @ cclt))))))))).
...
thf(cfourierdlem26_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (Xph => (cwcel @ (XA2 @ Xx3) @ ccr))) => ((Xph => (cwcel @ XB2 @ ccr)) => ((! [Xx3:$i] : (Xph => (cwbr @ (XA2 @ Xx3) @ XB2 @ cclt))) => ((! [Xx3:$i] : (XT = (cco @ XB2 @ (XA2 @ Xx3) @ ccmin))) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (cco @ (ccfv @ (cco @ (cco @ XB2 @ (ccv @ Xx3) @ ccmin) @ XT @ ccdiv) @ ccfl) @ XT @ ccmul) @ ccaddc))))) => ((Xph => (cwcel @ XX @ ccr)) => ((! [Xx3:$i] : (Xph => ((ccfv @ XX @ (XE @ Xx3)) = XB2))) => ((Xph => (cwcel @ XY @ (cco @ XX @ (cco @ XX @ XT @ ccaddc) @ ccioc))) => (! [Xx3:$i] : (Xph => ((ccfv @ XY @ (XE @ Xx3)) = (cco @ (XA2 @ Xx3) @ (cco @ XY @ XX @ ccmin) @ ccaddc)))))))))))))))))))).
