...
thf(apjhf_ax,axiom,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => (cwf @ cchil @ cchil @ (ccfv @ XH @ ccpjh))))).
...
thf(apj11_ax,axiom,(! [XG:($i > $o)] : (! [XH:($i > $o)] : (((cwcel @ XG @ ccch) & (cwcel @ XH @ ccch)) => (((ccfv @ XG @ ccpjh) = (ccfv @ XH @ ccpjh)) <=> (XG = XH)))))).
