...
thf(awspthsnwspthsnon_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XW @ (cco @ XN @ XG @ ccwwspthsn)) <=> (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwcel @ XW @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (cco @ XN @ XG @ ccwwspthsnon)))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))))).
...
thf(ausgr2wspthon_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xb:$i] : ((XE @ Xb) = (ccfv @ XG @ ccedg))) => (((cwcel @ XG @ ccusgr) & ((cwcel @ XA2 @ XV) & (cwcel @ XC @ XV))) => ((cwcel @ XT @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwspthsnon))) <=> (cwrex @ (^ [Xb:$i] : (((XT = (ccs3 @ XA2 @ (ccv @ Xb) @ XC)) & (cwne @ XA2 @ XC)) & ((cwcel @ (ccpr @ XA2 @ (ccv @ Xb)) @ (XE @ Xb)) & (cwcel @ (ccpr @ (ccv @ Xb) @ XC) @ (XE @ Xb))))) @ (^ [Xb:$i] : XV))))))))))))).
...
thf(arspcebdv_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ XB2)) => ((! [Xx3:$i] : ((Xph & ((ccv @ Xx3) = XA2)) => ((Xps @ Xx3) <=> Xch))) => ((! [Xx3:$i] : ((Xph & (Xps @ Xx3)) => ((ccv @ Xx3) = XA2))) => (Xph => ((cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XB2)) <=> Xch))))))))))).
...
thf(as3eq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((XB2 = XD) => ((ccs3 @ XA2 @ XB2 @ XC) = (ccs3 @ XA2 @ XD @ XC)))))))).
