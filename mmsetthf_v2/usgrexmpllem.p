...
thf(cusgrexmpllem_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (cco @ ccc0 @ cc4 @ ccfz)) => ((XE = (ccs4 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ ccc0) @ (ccpr @ ccc0 @ cc3))) => ((XG = (ccop @ XV @ XE)) => (((ccfv @ XG @ ccvtx) = XV) & ((ccfv @ XG @ cciedg) = XE))))))))).
