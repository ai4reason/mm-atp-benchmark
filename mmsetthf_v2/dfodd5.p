...
thf(adfodd4_ax,axiom,(ccodd = (ccrab @ (^ [Xz:$i] : ((cco @ (ccv @ Xz) @ cc2 @ ccmo) = cc1)) @ (^ [Xz:$i] : ccz)))).
...
thf(aelmod2_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => (cwcel @ (cco @ XN @ cc2 @ ccmo) @ (ccpr @ ccc0 @ cc1))))).
...
thf(aelprneb_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ (ccpr @ XB2 @ XC)) & (cwne @ XB2 @ XC)) => ((XA2 = XB2) <=> (cwne @ XA2 @ XC))))))).
thf(cdfodd5_conj,conjecture,(ccodd = (ccrab @ (^ [Xz:$i] : (cwne @ (cco @ (ccv @ Xz) @ cc2 @ ccmo) @ ccc0)) @ (^ [Xz:$i] : ccz)))).
