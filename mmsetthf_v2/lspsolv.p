...
thf(almodvpncan_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => ((Xc_mi = (ccfv @ XW @ ccsg)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV)) => ((cco @ (cco @ XA2 @ XB2 @ Xc_pl) @ XB2 @ Xc_mi) = XA2)))))))))))).
...
thf(clspsolv_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XS = (ccfv @ XW @ cclss)) => ((XN = (ccfv @ XW @ cclspn)) => (((cwcel @ XW @ cclvec) & (cw3a @ (cwss @ XA2 @ XV) @ (cwcel @ XY @ XV) @ (cwcel @ XX @ (ccdif @ (ccfv @ (ccun @ XA2 @ (ccsn @ XY)) @ XN) @ (ccfv @ XA2 @ XN))))) => (cwcel @ XY @ (ccfv @ (ccun @ XA2 @ (ccsn @ XX)) @ XN)))))))))))))).
