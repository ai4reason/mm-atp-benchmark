...
thf(cuhgreq12g_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ cciedg)) => ((XW = (ccfv @ XH @ ccvtx)) => ((XF = (ccfv @ XH @ cciedg)) => ((((cwcel @ XG @ XX) & (cwcel @ XH @ XY)) & ((XV = XW) & (XE = XF))) => ((cwcel @ XG @ ccuhgr) <=> (cwcel @ XH @ ccuhgr)))))))))))))))).
