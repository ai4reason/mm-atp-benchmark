...
thf(chmeoimaf1o_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XJ) @ (^ [Xx3:$i] : (ccima @ XF @ (ccv @ Xx3)))))) => (! [Xx3:$i] : ((cwcel @ XF @ (cco @ XJ @ XK @ cchmeo)) => (cwf1o @ XJ @ XK @ (XG @ Xx3)))))))))).
