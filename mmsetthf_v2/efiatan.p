...
thf(aefsub_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ cce) = (cco @ (ccfv @ XA2 @ cce) @ (ccfv @ XB2 @ cce) @ ccdiv)))))).
...
thf(cefiatan_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccatan)) => ((ccfv @ (cco @ cci @ (ccfv @ XA2 @ ccatan) @ ccmul) @ cce) = (cco @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) @ ccsqrt) @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccmin) @ ccsqrt) @ ccdiv))))).
