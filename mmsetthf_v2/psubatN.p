...
thf(cpsubatN_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XS = (ccfv @ XK @ ccpsubsp)) => ((cw3a @ (cwcel @ XK @ XB2) @ (cwcel @ XX @ XS) @ (cwcel @ XY @ XX)) => (cwcel @ XY @ XA2))))))))))).
