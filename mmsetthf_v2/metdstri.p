...
thf(ablpnfctr_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX) @ (cwcel @ XA2 @ (cco @ XP @ ccpnf @ (ccfv @ XD @ ccbl)))) => ((cco @ XP @ ccpnf @ (ccfv @ XD @ ccbl)) = (cco @ XA2 @ ccpnf @ (ccfv @ XD @ ccbl))))))))).
