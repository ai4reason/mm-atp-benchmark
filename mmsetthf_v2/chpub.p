...
thf(alogge0_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ cc1 @ XA2 @ ccle)) => (cwbr @ ccc0 @ (ccfv @ XA2 @ cclog) @ ccle)))).
...
thf(appisval_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccin @ (cco @ ccc0 @ XA2 @ ccicc) @ ccprime) = (ccin @ (cco @ cc2 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ ccprime))))).
...
thf(cchpub_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ cc1 @ XA2 @ ccle)) => (cwbr @ (ccfv @ XA2 @ ccchp) @ (cco @ (ccfv @ XA2 @ cccht) @ (cco @ (ccfv @ XA2 @ ccsqrt) @ (ccfv @ XA2 @ cclog) @ ccmul) @ ccaddc) @ ccle)))).
