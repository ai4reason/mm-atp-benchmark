...
thf(aanabss4_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((((Xps & Xph) & Xps) => Xch) => ((Xph & Xps) => Xch)))))).
...
thf(cordtri3or_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cword @ XA2) & (cword @ XB2)) => (cw3o @ (cwcel @ XA2 @ XB2) @ (XA2 = XB2) @ (cwcel @ XB2 @ XA2)))))).
