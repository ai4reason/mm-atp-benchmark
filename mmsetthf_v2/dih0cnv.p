...
thf(cdih0cnv_conj,conjecture,(! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XZ = (ccfv @ XU @ cc0g)) => (((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) => ((ccfv @ (ccsn @ XZ) @ (cccnv @ XI)) = Xc_0))))))))))))))).
