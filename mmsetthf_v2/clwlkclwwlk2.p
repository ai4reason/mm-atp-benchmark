...
thf(alswccats1fst_ax,axiom,(! [XP:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XP @ (ccword @ XV)) & (cwbr @ cc1 @ (ccfv @ XP @ cchash) @ ccle)) => ((ccfv @ (cco @ XP @ (ccs1 @ (ccfv @ ccc0 @ XP)) @ ccconcat) @ cclsw) = (ccfv @ ccc0 @ (cco @ XP @ (ccs1 @ (ccfv @ ccc0 @ XP)) @ ccconcat))))))).
...
thf(aclwlkclwwlk_ax,axiom,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ cciedg)) => ((cw3a @ (cwcel @ XG @ ccuspgr) @ (cwcel @ XP @ (ccword @ XV)) @ (cwbr @ cc2 @ (ccfv @ XP @ cchash) @ ccle)) => ((? [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XG @ ccclwlks))) <=> (((ccfv @ XP @ cclsw) = (ccfv @ ccc0 @ XP)) & (cwcel @ (cco @ XP @ (ccop @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin)) @ ccsubstr) @ (ccfv @ XG @ ccclwwlk)))))))))))).
thf(cclwlkclwwlk2_conj,conjecture,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ cciedg)) => ((cw3a @ (cwcel @ XG @ ccuspgr) @ (cwcel @ XP @ (ccword @ XV)) @ (cwbr @ cc1 @ (ccfv @ XP @ cchash) @ ccle)) => ((? [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ (cco @ XP @ (ccs1 @ (ccfv @ ccc0 @ XP)) @ ccconcat) @ (ccfv @ XG @ ccclwlks))) <=> (cwcel @ XP @ (ccfv @ XG @ ccclwwlk))))))))))).
