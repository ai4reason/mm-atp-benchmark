...
thf(aphoeqi_ax,axiom,(! [XP:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xy1:$i] : (XX = (ccfv @ (XU @ Xy1) @ ccba))) => ((! [Xy1:$i] : ((XP @ Xy1) = (ccfv @ (XU @ Xy1) @ ccdip))) => ((! [Xy1:$i] : (cwcel @ (XU @ Xy1) @ cccphlo)) => (((cwf @ XY @ XX @ XS) & (cwf @ XY @ XX @ XT)) => ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XS) @ (XP @ Xy1)) = (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XT) @ (XP @ Xy1)))) @ (^ [Xy1:$i] : XY))) @ (^ [Xx3:$i] : XX)) <=> (XS = XT))))))))))))).
...
thf(cajmoi_conj,conjecture,(! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xy1:$i] : (! [Xs1:$i] : (XX = (ccfv @ (XU @ Xy1 @ Xs1) @ ccba)))) => ((! [Xy1:$i] : (! [Xs1:$i] : ((XP @ Xy1) = (ccfv @ (XU @ Xy1 @ Xs1) @ ccdip)))) => ((! [Xy1:$i] : (! [Xs1:$i] : (cwcel @ (XU @ Xy1 @ Xs1) @ cccphlo))) => (cwmo @ (^ [Xs1:$i] : ((cwf @ XY @ XX @ (ccv @ Xs1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xy1) @ (XQ @ Xx3 @ Xy1)) = (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xs1)) @ (XP @ Xy1)))) @ (^ [Xy1:$i] : XY))) @ (^ [Xx3:$i] : XX))))))))))))))).
