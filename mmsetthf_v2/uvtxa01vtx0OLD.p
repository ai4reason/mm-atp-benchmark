...
thf(afalseral0_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (((! [Xx3:$i] : (~ (Xph @ Xx3))) & (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2))) => (XA2 = cc0))))).
...
thf(anbgr0edg_ax,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (((ccfv @ XG @ ccedg) = cc0) => ((cco @ XG @ XK @ ccnbgr) = cc0))))).
...
thf(cuvtxa01vtx0OLD_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ XW) & (XE = cc0)) => ((cwne @ (ccfv @ XG @ ccuvtx) @ cc0) <=> ((ccfv @ XV @ cchash) = cc1)))))))))).
