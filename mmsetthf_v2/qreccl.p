...
thf(amsqznn_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwne @ XA2 @ ccc0)) => (cwcel @ (cco @ XA2 @ XA2 @ ccmul) @ ccn)))).
...
thf(cqreccl_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccq) & (cwne @ XA2 @ ccc0)) => (cwcel @ (cco @ cc1 @ XA2 @ ccdiv) @ ccq)))).
