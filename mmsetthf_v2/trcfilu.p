...
thf(ctrcfilu_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ ((cwcel @ XF @ (ccfv @ XU @ cccfilu)) & (~ (cwcel @ cc0 @ (cco @ XF @ XA2 @ ccrest)))) @ (cwss @ XA2 @ XX)) => (cwcel @ (cco @ XF @ XA2 @ ccrest) @ (ccfv @ (cco @ XU @ (ccxp @ XA2 @ XA2) @ ccrest) @ cccfilu)))))))).
