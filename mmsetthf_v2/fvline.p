...
thf(acolinearex_ax,axiom,(cwcel @ cccolin @ ccvv)).
...
thf(afunline_ax,axiom,(cwfun @ ccline2)).
...
thf(cfvline_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ (XN @ Xx3) @ ccn) & (cw3a @ (cwcel @ XA2 @ (ccfv @ (XN @ Xx3) @ ccee)) @ (cwcel @ XB2 @ (ccfv @ (XN @ Xx3) @ ccee)) @ (cwne @ XA2 @ XB2))) => ((cco @ XA2 @ XB2 @ ccline2) = (ccab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccop @ XA2 @ XB2) @ cccolin)))))))))).
