...
thf(cznbas_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XS = (ccfv @ czring @ ccrsp)) => ((XY = (ccfv @ XN @ cczn)) => ((XR = (cco @ czring @ (ccfv @ (ccsn @ XN) @ XS) @ ccqg)) => ((cwcel @ XN @ ccn0) => ((ccqs @ ccz @ XR) = (ccfv @ XY @ ccbs))))))))))).
