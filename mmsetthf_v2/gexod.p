...
thf(cgexod_conj,conjecture,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => ((XO = (ccfv @ XG @ ccod)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX)) => (cwbr @ (ccfv @ XA2 @ XO) @ XE @ ccdvds))))))))))).
