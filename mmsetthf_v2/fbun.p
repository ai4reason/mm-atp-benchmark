...
thf(acbvral2v_b_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccv @ Xz)) => ((Xph @ Xx3 @ Xy1) <=> (Xch @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccv @ Xx3)) => ((Xch @ Xy1 @ Xz) <=> (Xps @ Xx3 @ Xz)))))) => (! [Xy1:$i] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1))) <=> (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (^ [Xx3:$i] : XB2))) @ (^ [Xz:$i] : (XA2 @ Xy1))))))))))))).
