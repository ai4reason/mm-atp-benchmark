...
thf(acoe1mul2lem1_ax,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ ccn0) & (cwcel @ XX @ (cco @ ccn0 @ cc1o @ ccmap))) => ((cwbr @ XX @ (ccxp @ cc1o @ (ccsn @ XA2)) @ (ccofr @ ccle)) <=> (cwcel @ (ccfv @ cc0 @ XX) @ (cco @ ccc0 @ XA2 @ ccfz))))))).
...
thf(ccoe1mul2lem2_conj,conjecture,(! [XH:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (! [Xd:$i] : ((XH @ Xk @ Xd) = (ccrab @ (^ [Xd:$i] : (cwbr @ (ccv @ Xd) @ (ccxp @ cc1o @ (ccsn @ (ccv @ Xk))) @ (ccofr @ ccle))) @ (^ [Xd:$i] : (cco @ ccn0 @ cc1o @ ccmap)))))) => (! [Xk:$i] : (! [Xd:$i] : ((cwcel @ (ccv @ Xk) @ ccn0) => (cwf1o @ (XH @ Xk @ Xd) @ (cco @ ccc0 @ (ccv @ Xk) @ ccfz) @ (ccmpt @ (^ [Xc:$i] : (XH @ Xk @ Xd)) @ (^ [Xc:$i] : (ccfv @ cc0 @ (ccv @ Xc))))))))))).
