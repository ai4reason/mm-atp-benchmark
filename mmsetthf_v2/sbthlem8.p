...
thf(csbthlem8_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xg1:$i] : (cwcel @ (XA2 @ Xf1 @ Xg1) @ ccvv))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XD @ Xf1 @ Xg1) = (ccab @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ (XA2 @ Xf1 @ Xg1)) & (cwss @ (ccima @ (ccv @ Xg1) @ (ccdif @ (XB2 @ Xf1 @ Xg1) @ (ccima @ (ccv @ Xf1) @ (ccv @ Xx3)))) @ (ccdif @ (XA2 @ Xf1 @ Xg1) @ (ccv @ Xx3))))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((XH @ Xf1 @ Xg1) = (ccun @ (ccres @ (ccv @ Xf1) @ (ccuni @ (XD @ Xf1 @ Xg1))) @ (ccres @ (cccnv @ (ccv @ Xg1)) @ (ccdif @ (XA2 @ Xf1 @ Xg1) @ (ccuni @ (XD @ Xf1 @ Xg1)))))))) => (! [Xf1:$i] : (! [Xg1:$i] : (((cwfun @ (cccnv @ (ccv @ Xf1))) & ((((cwfun @ (ccv @ Xg1)) & ((ccdm @ (ccv @ Xg1)) = (XB2 @ Xf1 @ Xg1))) & (cwss @ (ccrn @ (ccv @ Xg1)) @ (XA2 @ Xf1 @ Xg1))) & (cwfun @ (cccnv @ (ccv @ Xg1))))) => (cwfun @ (cccnv @ (XH @ Xf1 @ Xg1)))))))))))))).
