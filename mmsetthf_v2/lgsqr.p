...
thf(anecon4bbid_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => ((~ Xps) <=> (cwne @ XA2 @ XB2))) => (Xph => (Xps <=> (XA2 = XB2))))))))).
...
thf(algsne0_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccz)) => ((cwne @ (cco @ XA2 @ XN @ cclgs) @ ccc0) <=> ((cco @ XA2 @ XN @ ccgcd) = cc1)))))).
...
thf(algsqrlem5_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) @ ((cco @ XA2 @ XP @ cclgs) = cc1)) => (cwrex @ (^ [Xx3:$i] : (cwbr @ XP @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ XA2 @ ccmin) @ ccdvds)) @ (^ [Xx3:$i] : ccz)))))).
...
thf(algsmod_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ ccn) @ (~ (cwbr @ cc2 @ XN @ ccdvds))) => ((cco @ (cco @ XA2 @ XN @ ccmo) @ XN @ cclgs) = (cco @ XA2 @ XN @ cclgs)))))).
thf(clgsqr_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => (((cco @ XA2 @ XP @ cclgs) = cc1) <=> ((~ (cwbr @ XP @ XA2 @ ccdvds)) & (cwrex @ (^ [Xx3:$i] : (cwbr @ XP @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ XA2 @ ccmin) @ ccdvds)) @ (^ [Xx3:$i] : ccz)))))))).
