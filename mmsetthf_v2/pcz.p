...
thf(apcge0_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XN @ ccz)) => (cwbr @ ccc0 @ (cco @ XP @ XN @ ccpc) @ ccle))))).
...
thf(cpcz_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccq) => ((cwcel @ XA2 @ ccz) <=> (cwral @ (^ [Xp:$i] : (cwbr @ ccc0 @ (cco @ (ccv @ Xp) @ XA2 @ ccpc) @ ccle)) @ (^ [Xp:$i] : ccprime)))))).
