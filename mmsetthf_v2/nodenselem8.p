...
thf(anofnbday_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccsur) => (cwfn @ XA2 @ (ccfv @ XA2 @ ccbday))))).
...
thf(cnodenselem8_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccsur) @ (cwcel @ XB2 @ ccsur) @ ((ccfv @ XA2 @ ccbday) = (ccfv @ XB2 @ ccbday))) => ((cwbr @ XA2 @ XB2 @ ccslt) <=> (((ccfv @ (ccint @ (ccrab @ (^ [Xa:$i] : (cwne @ (ccfv @ (ccv @ Xa) @ XA2) @ (ccfv @ (ccv @ Xa) @ XB2))) @ (^ [Xa:$i] : ccon0))) @ XA2) = cc1o) & ((ccfv @ (ccint @ (ccrab @ (^ [Xa:$i] : (cwne @ (ccfv @ (ccv @ Xa) @ XA2) @ (ccfv @ (ccv @ Xa) @ XB2))) @ (^ [Xa:$i] : ccon0))) @ XB2) = cc2o))))))).
