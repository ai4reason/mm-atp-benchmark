...
thf(cply1remlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_mi = (ccfv @ XP @ ccsg)) => ((XA2 = (ccfv @ XP @ ccascl)) => ((XG = (cco @ XX @ (ccfv @ XN @ XA2) @ Xc_mi)) => ((XO = (ccfv @ XR @ cce1)) => ((Xph => (cwcel @ XR @ ccnzr)) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XN @ XK)) => ((XU = (ccfv @ XR @ ccmn1)) => ((XD = (ccfv @ XR @ ccdg1)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (Xph => (cw3a @ (cwcel @ XG @ XU) @ ((ccfv @ XG @ XD) = cc1) @ ((ccima @ (cccnv @ (ccfv @ XG @ XO)) @ (ccsn @ Xc_0)) = (ccsn @ XN))))))))))))))))))))))))))))))))).
