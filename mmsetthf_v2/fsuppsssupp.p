...
thf(cfsuppsssupp_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((((cwcel @ XG @ XV) & (cwfun @ XG)) & ((cwbr @ XF @ XZ @ ccfsupp) & (cwss @ (cco @ XG @ XZ @ ccsupp) @ (cco @ XF @ XZ @ ccsupp)))) => (cwbr @ XG @ XZ @ ccfsupp))))))).
