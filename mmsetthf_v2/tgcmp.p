...
thf(ctgcmp_conj,conjecture,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XB2 @ cctb) & (XX = (ccuni @ XB2))) => ((cwcel @ (ccfv @ XB2 @ cctg) @ cccmp) <=> (cwral @ (^ [Xy1:$i] : ((XX = (ccuni @ (ccv @ Xy1))) => (cwrex @ (^ [Xz:$i] : (XX = (ccuni @ (ccv @ Xz)))) @ (^ [Xz:$i] : (ccin @ (ccpw @ (ccv @ Xy1)) @ ccfn))))) @ (^ [Xy1:$i] : (ccpw @ XB2)))))))).
