...
thf(aoddpwp1fsum_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (~ (cwbr @ cc2 @ XN @ ccdvds))) => (Xph => ((cco @ (cco @ XA2 @ XN @ ccexp) @ cc1 @ ccaddc) = (cco @ (cco @ XA2 @ cc1 @ ccaddc) @ (ccsu @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ (ccneg @ cc1) @ (ccv @ Xk) @ ccexp) @ (cco @ XA2 @ (ccv @ Xk) @ ccexp) @ ccmul))) @ ccmul)))))))))).
...
thf(a_2a1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (Xps => (Xch => Xph))))))).
...
thf(aeluz2b3_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) <=> ((cwcel @ XN @ ccn) & (cwne @ XN @ cc1))))).
thf(asimprr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & (Xps & Xch)) => Xch))))).
thf(ccr_tp,type,(ccr : ($i > $o))).
thf(ccdiv_tp,type,(ccdiv : ($i > $o))).
thf(cc3_tp,type,(cc3 : ($i > $o))).
thf(alighneallem4b_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XM @ (ccfv @ cc2 @ ccuz)) @ (~ (cwbr @ cc2 @ XM @ ccdvds))) => (cwcel @ (ccsu @ (cco @ ccc0 @ (cco @ XM @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ (ccneg @ cc1) @ (ccv @ Xk) @ ccexp) @ (cco @ XA2 @ (ccv @ Xk) @ ccexp) @ ccmul))) @ (ccfv @ cc2 @ ccuz)))))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(advdsprmpweqnn_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccn0)) => ((cwbr @ XA2 @ (cco @ XP @ XN @ ccexp) @ ccdvds) => (cwrex @ (^ [Xn:$i] : (XA2 = (cco @ XP @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn)))))))).
...
thf(aiddvdsexp_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccn)) => (cwbr @ XM @ (cco @ XM @ XN @ ccexp) @ ccdvds))))).
...
thf(aoddsumodd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccz))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (~ (cwbr @ cc2 @ (XB2 @ Xk) @ ccdvds)))) => ((Xph => (~ (cwbr @ cc2 @ (ccfv @ XA2 @ cchash) @ ccdvds))) => (Xph => (~ (cwbr @ cc2 @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccdvds))))))))))).
...
thf(an2dvdsm1_ax,axiom,(~ (cwbr @ cc2 @ (ccneg @ cc1) @ ccdvds))).
...
thf(aoddn2prm_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccdif @ ccprime @ (ccsn @ cc2))) => (~ (cwbr @ cc2 @ XN @ ccdvds))))).
thf(amp3an2ani_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (Xph => ((Xps => Xch) => (((Xps & Xth) => Xta) => (((cw3a @ Xph @ Xch @ Xta) => Xet) => ((Xps & Xth) => Xet)))))))))))).
...
thf(ahashfz0_ax,axiom,(! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccn0) => ((ccfv @ (cco @ ccc0 @ XB2 @ ccfz) @ cchash) = (cco @ XB2 @ cc1 @ ccaddc))))).
thf(anpcan1_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ (cco @ XA2 @ cc1 @ ccmin) @ cc1 @ ccaddc) = XA2)))).
thf(clighneallem4_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cw3a @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) @ ((~ (cwbr @ cc2 @ XN @ ccdvds)) & (~ (cwbr @ cc2 @ XM @ ccdvds))) @ ((cco @ (cco @ cc2 @ XN @ ccexp) @ cc1 @ ccmin) = (cco @ XP @ XM @ ccexp))) => (XM = cc1)))))).
