...
thf(ckgenval_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XX @ cctopon)) => ((ccfv @ XJ @ cckgen) = (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : ((cwcel @ (cco @ XJ @ (ccv @ Xk) @ ccrest) @ cccmp) => (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xk)) @ (cco @ XJ @ (ccv @ Xk) @ ccrest)))) @ (^ [Xk:$i] : (ccpw @ XX)))) @ (^ [Xx3:$i] : (ccpw @ XX)))))))).
