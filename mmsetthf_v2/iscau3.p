...
thf(axlt2add_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & ((cwcel @ XC @ ccxr) & (cwcel @ XD @ ccxr))) => (((cwbr @ XA2 @ XC @ cclt) & (cwbr @ XB2 @ XD @ cclt)) => (cwbr @ (cco @ XA2 @ XB2 @ ccxad) @ (cco @ XC @ XD @ ccxad) @ cclt)))))))).
...
thf(ciscau3_conj,conjecture,(! [Xph:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xk:$i] : (! [Xm:$i] : ((XZ @ Xm) = (ccfv @ (XM @ Xx3 @ Xk @ Xm) @ ccuz))))) => ((! [Xm:$i] : ((Xph @ Xm) => (cwcel @ XD @ (ccfv @ XX @ ccxmt)))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xm:$i] : ((Xph @ Xm) => (cwcel @ (XM @ Xx3 @ Xk @ Xm) @ ccz))))) => (! [Xm:$i] : ((Xph @ Xm) => ((cwcel @ XF @ (ccfv @ XD @ ccca)) <=> ((cwcel @ XF @ (cco @ XX @ ccc @ ccpm)) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cw3a @ (cwcel @ (ccv @ Xk) @ (ccdm @ XF)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ XX) @ (cwral @ (^ [Xm:$i] : (cwbr @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xm) @ XF) @ XD) @ (ccv @ Xx3) @ cclt)) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xk) @ ccuz))))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : (XZ @ Xm)))) @ (^ [Xx3:$i] : ccrp)))))))))))))))).
