...
thf(advds2subd_ax,axiom,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XK @ ccz)) => ((Xph => (cwbr @ XK @ XM @ ccdvds)) => ((Xph => (cwbr @ XK @ XN @ ccdvds)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XN @ ccz)) => (Xph => (cwbr @ XK @ (cco @ XM @ XN @ ccmin) @ ccdvds)))))))))))).
