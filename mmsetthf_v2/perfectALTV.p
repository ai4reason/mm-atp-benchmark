...
thf(a_2dvdseven_ax,axiom,(! [XZ:($i > $o)] : ((cwcel @ XZ @ cceven) => (cwbr @ cc2 @ XZ @ ccdvds)))).
...
thf(aperfectALTVlem2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccn)) => ((Xph => (cwcel @ XB2 @ ccn)) => ((Xph => (cwcel @ XB2 @ ccodd)) => ((Xph => ((cco @ cc1 @ (cco @ (cco @ cc2 @ XA2 @ ccexp) @ XB2 @ ccmul) @ ccsgm) = (cco @ cc2 @ (cco @ (cco @ cc2 @ XA2 @ ccexp) @ XB2 @ ccmul) @ ccmul))) => (Xph => ((cwcel @ XB2 @ ccprime) & (XB2 = (cco @ (cco @ cc2 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccexp) @ cc1 @ ccmin)))))))))))).
...
thf(aperfect1_ax,axiom,(! [XP:($i > $o)] : (((cwcel @ XP @ ccz) & (cwcel @ (cco @ (cco @ cc2 @ XP @ ccexp) @ cc1 @ ccmin) @ ccprime)) => ((cco @ cc1 @ (cco @ (cco @ cc2 @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (cco @ (cco @ cc2 @ XP @ ccexp) @ cc1 @ ccmin) @ ccmul) @ ccsgm) = (cco @ (cco @ cc2 @ XP @ ccexp) @ (cco @ (cco @ cc2 @ XP @ ccexp) @ cc1 @ ccmin) @ ccmul))))).
thf(aeqtrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XB2 = XC)) => (Xph => (XA2 = XC))))))))).
thf(a_2cn_ax,axiom,(cwcel @ cc2 @ ccc)).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(ccneg_tp,type,(ccneg : (($i > $o) > ($i > $o)))).
thf(amersenne_ax,axiom,(! [XP:($i > $o)] : (((cwcel @ XP @ ccz) & (cwcel @ (cco @ (cco @ cc2 @ XP @ ccexp) @ cc1 @ ccmin) @ ccprime)) => (cwcel @ XP @ ccprime)))).
...
thf(cperfectALTV_conj,conjecture,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XN @ cceven)) => (((cco @ cc1 @ XN @ ccsgm) = (cco @ cc2 @ XN @ ccmul)) <=> (cwrex @ (^ [Xp:$i] : ((cwcel @ (cco @ (cco @ cc2 @ (ccv @ Xp) @ ccexp) @ cc1 @ ccmin) @ ccprime) & (XN = (cco @ (cco @ cc2 @ (cco @ (ccv @ Xp) @ cc1 @ ccmin) @ ccexp) @ (cco @ (cco @ cc2 @ (ccv @ Xp) @ ccexp) @ cc1 @ ccmin) @ ccmul)))) @ (^ [Xp:$i] : ccz)))))).
