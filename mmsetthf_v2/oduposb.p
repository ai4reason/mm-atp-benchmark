...
thf(coduposb_conj,conjecture,(! [XD:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((XD = (ccfv @ XO @ ccodu)) => ((cwcel @ XO @ XV) => ((cwcel @ XO @ ccpo) <=> (cwcel @ XD @ ccpo)))))))).
