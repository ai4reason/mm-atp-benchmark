...
thf(czerdivemp1x_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xa:$i] : ((XG @ Xa) = (ccfv @ XR @ cc1st))) => ((XH = (ccfv @ XR @ cc2nd)) => ((! [Xa:$i] : (XZ = (ccfv @ (XG @ Xa) @ ccgi))) => ((! [Xa:$i] : (XX = (ccrn @ (XG @ Xa)))) => ((! [Xa:$i] : ((XU @ Xa) = (ccfv @ XH @ ccgi))) => ((cw3a @ (cwcel @ XR @ ccrngo) @ (cwcel @ XA2 @ XX) @ (cwrex @ (^ [Xa:$i] : ((cco @ (ccv @ Xa) @ XA2 @ XH) = (XU @ Xa))) @ (^ [Xa:$i] : XX))) => ((cwcel @ XB2 @ XX) => (((cco @ XA2 @ XB2 @ XH) = XZ) => (XB2 = XZ)))))))))))))))))).
