...
thf(aofmres_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((ccres @ (ccof @ XR) @ (ccxp @ XA2 @ XB2)) = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : XA2)) @ (^ [Xf1:$i] : (^ [Xg1:$i] : XB2)) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ (ccv @ Xf1) @ (ccv @ Xg1) @ (ccof @ XR)))))))))).
...
thf(cpsrplusgpropd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : ((Xph => (XB2 = (ccfv @ XR @ ccbs))) => ((Xph => (XB2 = (ccfv @ XS @ ccbs))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & (cwcel @ (ccv @ Xy1) @ XB2))) => ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XR @ ccplusg)) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XS @ ccplusg)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((ccfv @ (cco @ (XI @ Xx3 @ Xy1) @ XR @ ccmps) @ ccplusg) = (ccfv @ (cco @ (XI @ Xx3 @ Xy1) @ XS @ ccmps) @ ccplusg)))))))))))))).
