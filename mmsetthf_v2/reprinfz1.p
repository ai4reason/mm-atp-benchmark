...
thf(arabss3d_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XA2) & (Xps @ Xx3))) => (cwcel @ (ccv @ Xx3) @ XB2))) => (Xph => (cwss @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XB2)))))))))).
...
thf(creprinfz1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XS @ ccn0)) => ((Xph => (cwss @ XA2 @ ccn)) => (Xph => ((cco @ XA2 @ XN @ (ccfv @ XS @ ccrepr)) = (cco @ (ccin @ XA2 @ (cco @ cc1 @ XN @ ccfz)) @ XN @ (ccfv @ XS @ ccrepr)))))))))))).
