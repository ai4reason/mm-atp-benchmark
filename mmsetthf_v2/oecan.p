...
thf(coecan_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccdif @ ccon0 @ cc2o)) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) => (((cco @ XA2 @ XB2 @ ccoe) = (cco @ XA2 @ XC @ ccoe)) <=> (XB2 = XC))))))).
