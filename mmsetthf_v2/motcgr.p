...
thf(cmotcgr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((Xph => (cwcel @ XG @ XV)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XF @ (cco @ XG @ XG @ ccismt))) => (Xph => ((cco @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ Xc_mi) = (cco @ XA2 @ XB2 @ Xc_mi)))))))))))))))))).
