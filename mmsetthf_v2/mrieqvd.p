...
thf(cmrieqvd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (ccfv @ (XX @ Xx3) @ ccmre)))) => ((! [Xx3:$i] : ((XN @ Xx3) = (ccfv @ XA2 @ ccmrc))) => ((! [Xx3:$i] : ((XI @ Xx3) = (ccfv @ XA2 @ ccmri))) => ((! [Xx3:$i] : (Xph => (cwss @ XS @ (XX @ Xx3)))) => (! [Xx3:$i] : (Xph => ((cwcel @ XS @ (XI @ Xx3)) <=> (cwral @ (^ [Xx3:$i] : (cwne @ (ccfv @ (ccdif @ XS @ (ccsn @ (ccv @ Xx3))) @ (XN @ Xx3)) @ (ccfv @ XS @ (XN @ Xx3)))) @ (^ [Xx3:$i] : XS)))))))))))))))).
