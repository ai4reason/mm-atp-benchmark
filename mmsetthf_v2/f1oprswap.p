...
thf(acnvsng_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cccnv @ (ccsn @ (ccop @ XA2 @ XB2))) = (ccsn @ (ccop @ XB2 @ XA2))))))))).
...
thf(cf1oprswap_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => (cwf1o @ (ccpr @ XA2 @ XB2) @ (ccpr @ XA2 @ XB2) @ (ccpr @ (ccop @ XA2 @ XB2) @ (ccop @ XB2 @ XA2))))))))).
