...
thf(auzneg_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ XM @ ccuz)) => (cwcel @ (ccneg @ XM) @ (ccfv @ (ccneg @ XN) @ ccuz)))))).
...
thf(aeluzmn_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccn0)) => (cwcel @ XM @ (ccfv @ (cco @ XM @ XN @ ccmin) @ ccuz)))))).
