...
thf(ccvmliftiota_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : ((! [Xf1:$i] : ((XB2 @ Xf1) = (ccuni @ XC))) => ((! [Xf1:$i] : ((XH @ Xf1) = (ccrio @ (^ [Xf1:$i] : (((cccom @ XF @ (ccv @ Xf1)) = XG) & ((ccfv @ ccc0 @ (ccv @ Xf1)) = XP))) @ (^ [Xf1:$i] : (cco @ ccii @ XC @ cccn))))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XF @ (cco @ XC @ (XJ @ Xf1) @ cccvm)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XG @ (cco @ ccii @ (XJ @ Xf1) @ cccn)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XP @ (XB2 @ Xf1)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => ((ccfv @ XP @ XF) = (ccfv @ ccc0 @ XG)))) => (! [Xf1:$i] : ((Xph @ Xf1) => (cw3a @ (cwcel @ (XH @ Xf1) @ (cco @ ccii @ XC @ cccn)) @ ((cccom @ XF @ (XH @ Xf1)) = XG) @ ((ccfv @ ccc0 @ (XH @ Xf1)) = XP))))))))))))))))))).
