...
thf(aeqgid_ax,axiom,(! [Xc_sm:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_sm = (cco @ XG @ XY @ ccqg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((cwcel @ XY @ (ccfv @ XG @ ccsubg)) => ((ccec @ Xc_0 @ Xc_sm) = XY))))))))))).
...
thf(aecelqsg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XR @ XV) & (cwcel @ XB2 @ XA2)) => (cwcel @ (ccec @ XB2 @ XR) @ (ccqs @ XA2 @ XR)))))))).
thf(assequn2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ XB2) <=> ((ccun @ XB2 @ XA2) = XB2))))).
thf(ccdm_tp,type,(ccdm : (($i > $o) > ($i > $o)))).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(auniqs2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwer @ XA2 @ XR)) => ((Xph => (cwcel @ XR @ XV)) => (Xph => ((ccuni @ (ccqs @ XA2 @ XR)) = XA2))))))))).
...
thf(aelqs_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XB2 @ (ccqs @ XA2 @ XR)) <=> (cwrex @ (^ [Xx3:$i] : (XB2 = (ccec @ (ccv @ Xx3) @ XR))) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(aeqglact_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_sm = (cco @ XG @ XY @ ccqg)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((cw3a @ (cwcel @ XG @ ccgrp) @ (cwss @ XY @ XX) @ (cwcel @ XA2 @ XX)) => ((ccec @ XA2 @ Xc_sm) = (ccima @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ Xc_pl))) @ XY))))))))))))).
...
thf(aunicld_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XA2 @ ccfn) @ (cwss @ XA2 @ (ccfv @ XJ @ cccld))) => (cwcel @ (ccuni @ XA2) @ (ccfv @ XJ @ cccld)))))))).
...
thf(ccldsubg_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XG @ cctopn)) => ((XR = (cco @ XG @ XS @ ccqg)) => ((XX = (ccfv @ XG @ ccbs)) => ((cw3a @ (cwcel @ XG @ cctgp) @ (cwcel @ XS @ (ccfv @ XG @ ccsubg)) @ (cwcel @ (ccqs @ XX @ XR) @ ccfn)) => ((cwcel @ XS @ (ccfv @ XJ @ cccld)) <=> (cwcel @ XS @ XJ)))))))))))).
