...
thf(celpr2elpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV) @ (cwcel @ XA2 @ (ccpr @ XX @ XY))) => (cwrex @ (^ [Xb:$i] : ((ccpr @ XX @ XY) = (ccpr @ XA2 @ (ccv @ Xb)))) @ (^ [Xb:$i] : XV)))))))).
