...
thf(copnregcld_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XA2 @ XX)) => (((ccfv @ (ccfv @ XA2 @ (ccfv @ XJ @ ccnt)) @ (ccfv @ XJ @ cccl)) = XA2) <=> (cwrex @ (^ [Xo:$i] : (XA2 = (ccfv @ (ccv @ Xo) @ (ccfv @ XJ @ cccl)))) @ (^ [Xo:$i] : XJ))))))))).
