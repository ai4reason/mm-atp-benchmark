...
thf(arelun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwrel @ (ccun @ XA2 @ XB2)) <=> ((cwrel @ XA2) & (cwrel @ XB2)))))).
...
thf(cfunun_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cwfun @ XF) & (cwfun @ XG)) & ((ccin @ (ccdm @ XF) @ (ccdm @ XG)) = cc0)) => (cwfun @ (ccun @ XF @ XG)))))).
