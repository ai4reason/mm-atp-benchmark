...
thf(acncls2i_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccuni @ XK)) => (((cwcel @ XF @ (cco @ XJ @ XK @ cccn)) & (cwss @ XS @ XY)) => (cwss @ (ccfv @ (ccima @ (cccnv @ XF) @ XS) @ (ccfv @ XJ @ cccl)) @ (ccima @ (cccnv @ XF) @ (ccfv @ XS @ (ccfv @ XK @ cccl)))))))))))).
...
thf(apm5_74d_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps => (Xch <=> Xth))) => (Xph => ((Xps => Xch) <=> (Xps => Xth))))))))).
...
thf(ccncls2_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((cwcel @ XF @ (cco @ XJ @ XK @ cccn)) <=> ((cwf @ XX @ XY @ XF) & (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccv @ Xx3)) @ (ccfv @ XJ @ cccl)) @ (ccima @ (cccnv @ XF) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XK @ cccl))))) @ (^ [Xx3:$i] : (ccpw @ XY)))))))))))).
