...
thf(cmrcval_conj,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => (((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwss @ XU @ XX)) => ((ccfv @ XU @ XF) = (ccint @ (ccrab @ (^ [Xs1:$i] : (cwss @ XU @ (ccv @ Xs1))) @ (^ [Xs1:$i] : XC))))))))))).
