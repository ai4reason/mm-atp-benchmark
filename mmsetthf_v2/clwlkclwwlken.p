...
thf(aclwlkclwwlkf1o_ax,axiom,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XC = (ccrab @ (^ [Xw:$i] : (cwbr @ cc1 @ (ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) @ ccle)) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks)))) => ((XF = (ccmpt @ (^ [Xc:$i] : XC) @ (^ [Xc:$i] : (cco @ (ccfv @ (ccv @ Xc) @ cc2nd) @ (ccop @ ccc0 @ (cco @ (ccfv @ (ccfv @ (ccv @ Xc) @ cc2nd) @ cchash) @ cc1 @ ccmin)) @ ccsubstr)))) => ((cwcel @ XG @ ccuspgr) => (cwf1o @ XC @ (ccfv @ XG @ ccclwwlk) @ XF)))))))).
...
thf(cclwlkclwwlken_conj,conjecture,(! [XG:($i > $o)] : ((cwcel @ XG @ ccuspgr) => (cwbr @ (ccrab @ (^ [Xw:$i] : (cwbr @ cc1 @ (ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) @ ccle)) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks))) @ (ccfv @ XG @ ccclwwlk) @ ccen)))).
