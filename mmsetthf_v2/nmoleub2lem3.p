...
thf(aqre_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccq) => (cwcel @ XA2 @ ccr)))).
...
thf(aclmabs_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ ccclm) & (cwcel @ XA2 @ XK)) => ((ccfv @ XA2 @ ccabs) = (ccfv @ XA2 @ (ccfv @ XF @ ccnm))))))))))).
