...
thf(auzin_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((ccin @ (ccfv @ XM @ ccuz) @ (ccfv @ XN @ ccuz)) = (ccfv @ (ccif @ (cwbr @ XM @ XN @ ccle) @ XN @ XM) @ ccuz)))))).
...
thf(cuzin2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccrn @ ccuz)) & (cwcel @ XB2 @ (ccrn @ ccuz))) => (cwcel @ (ccin @ XA2 @ XB2) @ (ccrn @ ccuz)))))).
