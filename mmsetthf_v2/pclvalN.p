...
thf(apclfvalN_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XS = (ccfv @ XK @ ccpsubsp)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XU @ Xx3 @ Xy1) = (ccfv @ XK @ ccpclN)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XK @ (XV @ Xx3 @ Xy1)) => ((XU @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccint @ (ccrab @ (^ [Xy1:$i] : (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XS)))))))))))))))))).
...
thf(aatpsubN_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XS = (ccfv @ XK @ ccpsubsp)) => ((cwcel @ XK @ XV) => (cwcel @ XA2 @ XS))))))))).
...
thf(cpclvalN_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XS = (ccfv @ XK @ ccpsubsp)) => ((! [Xy1:$i] : ((XU @ Xy1) = (ccfv @ XK @ ccpclN))) => (! [Xy1:$i] : (((cwcel @ XK @ (XV @ Xy1)) & (cwss @ XX @ XA2)) => ((ccfv @ XX @ (XU @ Xy1)) = (ccint @ (ccrab @ (^ [Xy1:$i] : (cwss @ XX @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XS)))))))))))))))).
