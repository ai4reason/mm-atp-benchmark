...
thf(ceupth2lem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : ((cwcel @ XB2 @ ccvv) => (((cwne @ XB2 @ XC) & (XB2 = XU)) => ((~ (cwcel @ XU @ (ccif @ (XA2 = XB2) @ cc0 @ (ccpr @ XA2 @ XB2)))) <=> (cwcel @ XU @ (ccif @ (XA2 = XC) @ cc0 @ (ccpr @ XA2 @ XC))))))))))).
