...
thf(aisf32lem1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwf @ ccom @ (ccpw @ (XG @ Xx3)) @ XF))) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : ccom))) => ((Xph => (~ (cwcel @ (ccint @ (ccrn @ XF)) @ (ccrn @ XF)))) => ((((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) & ((cwss @ XB2 @ XA2) & Xph)) => (cwss @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF)))))))))))).
...
thf(cisf32lem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwf @ ccom @ (ccpw @ (XG @ Xx3)) @ XF))) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : ccom))) => ((Xph => (~ (cwcel @ (ccint @ (ccrn @ XF)) @ (ccrn @ XF)))) => ((Xph & (cwcel @ XA2 @ ccom)) => (cwrex @ (^ [Xa:$i] : ((cwcel @ XA2 @ (ccv @ Xa)) & (cwpss @ (ccfv @ (ccsuc @ (ccv @ Xa)) @ XF) @ (ccfv @ (ccv @ Xa) @ XF)))) @ (^ [Xa:$i] : ccom))))))))))).
