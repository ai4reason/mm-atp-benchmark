...
thf(aedgnbusgreu_ax,axiom,(! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((! [Xn:$i] : ((XN @ Xn) = (cco @ XG @ XM @ ccnbgr))) => ((((cwcel @ XG @ ccusgr) & (cwcel @ XM @ XV)) & ((cwcel @ XC @ XE) & (cwcel @ XM @ XC))) => (cwreu @ (^ [Xn:$i] : (XC = (ccpr @ XM @ (ccv @ Xn)))) @ (^ [Xn:$i] : (XN @ Xn)))))))))))))).
