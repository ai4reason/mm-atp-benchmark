...
thf(cisgbow_conj,conjecture,(! [XZ:($i > $o)] : ((cwcel @ XZ @ ccgbow) <=> ((cwcel @ XZ @ ccodd) & (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : (XZ = (cco @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccaddc) @ (ccv @ Xr) @ ccaddc))) @ (^ [Xr:$i] : ccprime))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime)))))).
