...
thf(cpjscji_conj,conjecture,(! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => ((cwss @ XG @ (ccfv @ XH @ ccort)) => ((ccfv @ (cco @ XG @ XH @ cchj) @ ccpjh) = (cco @ (ccfv @ XG @ ccpjh) @ (ccfv @ XH @ ccpjh) @ cchos)))))))).
