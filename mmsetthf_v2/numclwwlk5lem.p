...
thf(cnumclwwlk5lem_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cw3a @ (cwbr @ XG @ XK @ ccrusgr) @ (cwcel @ XX @ XV) @ (cwcel @ XK @ ccn0)) => ((cwbr @ cc2 @ (cco @ XK @ cc1 @ ccmin) @ ccdvds) => ((cco @ (ccfv @ (cco @ XX @ cc2 @ (ccfv @ XG @ ccclwwlknon)) @ cchash) @ cc2 @ ccmo) = cc1))))))))).
