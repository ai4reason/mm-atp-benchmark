...
thf(cpimiooltgt_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XL @ Xx3) @ ccxr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XR @ Xx3) @ ccxr))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccxr))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccrab @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ (cco @ (XL @ Xx3) @ (XR @ Xx3) @ ccioo))) @ (^ [Xx3:$i] : XA2)) = (ccin @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (XR @ Xx3) @ cclt)) @ (^ [Xx3:$i] : XA2)) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (XL @ Xx3) @ (XB2 @ Xx3) @ cclt)) @ (^ [Xx3:$i] : XA2)))))))))))))))).
