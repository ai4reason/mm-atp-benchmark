...
thf(afndmd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwfn @ XF @ XA2)) => (Xph => ((ccdm @ XF) = XA2))))))).
...
thf(cfnfvimad_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwfn @ XF @ XA2)) => ((Xph => (cwcel @ XB2 @ XA2)) => ((Xph => (cwcel @ XB2 @ XC)) => (Xph => (cwcel @ (ccfv @ XB2 @ XF) @ (ccima @ XF @ XC)))))))))))).
