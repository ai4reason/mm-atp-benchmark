...
thf(asge0sn_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ (ccsn @ XA2) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => (Xph => ((ccfv @ XF @ ccsumge0) = (ccfv @ XA2 @ XF)))))))))).
...
thf(csge0snmptf_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XA2 @ (XV @ Xk)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XC @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xk:$i] : (((ccv @ Xk) = XA2) => ((XB2 @ Xk) = XC))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccfv @ (ccmpt @ (^ [Xk:$i] : (ccsn @ XA2)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccsumge0) = XC))))))))))))).
