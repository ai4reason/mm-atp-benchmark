...
thf(acosval_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ cccos) = (cco @ (cco @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cce) @ (ccfv @ (cco @ (ccneg @ cci) @ XA2 @ ccmul) @ cce) @ ccaddc) @ cc2 @ ccdiv))))).
...
thf(ccosadd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cccos) = (cco @ (cco @ (ccfv @ XA2 @ cccos) @ (ccfv @ XB2 @ cccos) @ ccmul) @ (cco @ (ccfv @ XA2 @ ccsin) @ (ccfv @ XB2 @ ccsin) @ ccmul) @ ccmin)))))).
