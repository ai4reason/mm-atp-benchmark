...
thf(acnvdif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cccnv @ (ccdif @ XA2 @ XB2)) = (ccdif @ (cccnv @ XA2) @ (cccnv @ XB2)))))).
...
thf(ccnvin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cccnv @ (ccin @ XA2 @ XB2)) = (ccin @ (cccnv @ XA2) @ (cccnv @ XB2)))))).
