...
thf(a_1sgmprm_ax,axiom,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprime) => ((cco @ cc1 @ XP @ ccsgm) = (cco @ XP @ cc1 @ ccaddc))))).
...
thf(cperfect1_conj,conjecture,(! [XP:($i > $o)] : (((cwcel @ XP @ ccz) & (cwcel @ (cco @ (cco @ cc2 @ XP @ ccexp) @ cc1 @ ccmin) @ ccprime)) => ((cco @ cc1 @ (cco @ (cco @ cc2 @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (cco @ (cco @ cc2 @ XP @ ccexp) @ cc1 @ ccmin) @ ccmul) @ ccsgm) = (cco @ (cco @ cc2 @ XP @ ccexp) @ (cco @ (cco @ cc2 @ XP @ ccexp) @ cc1 @ ccmin) @ ccmul))))).
