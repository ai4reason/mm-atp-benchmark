...
thf(aissn_ax,axiom,(! [XA2:($i > $o)] : ((cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccv @ Xx3) = (ccv @ Xy1))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) => (? [Xz:$i] : (XA2 = (ccsn @ (ccv @ Xz))))))).
...
thf(cn0snor2el_conj,conjecture,(! [XA2:($i > $o)] : ((cwne @ XA2 @ cc0) => ((cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwne @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) | (? [Xz:$i] : (XA2 = (ccsn @ (ccv @ Xz)))))))).
