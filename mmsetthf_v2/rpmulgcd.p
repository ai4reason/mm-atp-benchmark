...
thf(crpmulgcd_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cw3a @ (cwcel @ XK @ ccn) @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) & ((cco @ XK @ XM @ ccgcd) = cc1)) => ((cco @ XK @ (cco @ XM @ XN @ ccmul) @ ccgcd) = (cco @ XK @ XN @ ccgcd))))))).
