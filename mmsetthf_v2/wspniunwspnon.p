...
thf(awspthsnonn0vne_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XN @ ccn) & (cwne @ (cco @ XX @ XY @ (cco @ XN @ XG @ ccwwspthsnon)) @ cc0)) => (cwne @ XX @ XY))))))).
...
thf(cwspniunwspnon_conj,conjecture,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XN @ ccn) & (cwcel @ XG @ XU)) => ((cco @ XN @ XG @ ccwwspthsn) = (cciun @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (cciun @ (^ [Xy1:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (cco @ XN @ XG @ ccwwspthsnon)))))))))))))).
