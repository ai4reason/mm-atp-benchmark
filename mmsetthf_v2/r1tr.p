...
thf(apwtr_ax,axiom,(! [XA2:($i > $o)] : ((cwtr @ XA2) <=> (cwtr @ (ccpw @ XA2))))).
thf(ar1sucg_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccr1)) => ((ccfv @ (ccsuc @ XA2) @ ccr1) = (ccpw @ (ccfv @ XA2 @ ccr1)))))).
...
thf(atriun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwral @ (^ [Xx3:$i] : (cwtr @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2)) => (cwtr @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))).
thf(aancoms_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) => Xch) => ((Xps & Xph) => Xch)))))).
thf(ccima_tp,type,(ccima : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ar1limg_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccr1)) & (cwlim @ XA2)) => ((ccfv @ XA2 @ ccr1) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ ccr1))))))).
thf(cr1tr_conj,conjecture,(! [XA2:($i > $o)] : (cwtr @ (ccfv @ XA2 @ ccr1)))).
