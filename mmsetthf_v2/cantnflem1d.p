...
thf(aifor_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccif @ (Xph | Xps) @ XA2 @ XB2) = (ccif @ Xph @ XA2 @ (ccif @ Xps @ XA2 @ XB2)))))))).
