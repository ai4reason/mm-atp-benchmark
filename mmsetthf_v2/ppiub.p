...
thf(appifl_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ (ccfv @ XA2 @ ccfl) @ ccppi) = (ccfv @ XA2 @ ccppi))))).
thf(appi3_ax,axiom,((ccfv @ cc3 @ ccppi) = cc2)).
...
thf(appidif_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ XM @ ccuz)) => ((cco @ (ccfv @ XN @ ccppi) @ (ccfv @ XM @ ccppi) @ ccmin) = (ccfv @ (ccin @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XN @ ccfz) @ ccprime) @ cchash)))))).
...
thf(appiublem2_ax,axiom,(! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwbr @ cc4 @ XP @ ccle)) => (cwcel @ (cco @ XP @ cc6 @ ccmo) @ (ccpr @ cc1 @ cc5))))).
...
thf(alenegi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwbr @ (ccneg @ XB2) @ (ccneg @ XA2) @ ccle))))))).
...
thf(appiwordi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ ccle)) => (cwbr @ (ccfv @ XA2 @ ccppi) @ (ccfv @ XB2 @ ccppi) @ ccle))))).
...
thf(cppiub_conj,conjecture,(! [XN:($i > $o)] : (((cwcel @ XN @ ccr) & (cwbr @ ccc0 @ XN @ ccle)) => (cwbr @ (ccfv @ XN @ ccppi) @ (cco @ (cco @ XN @ cc3 @ ccdiv) @ cc2 @ ccaddc) @ ccle)))).
