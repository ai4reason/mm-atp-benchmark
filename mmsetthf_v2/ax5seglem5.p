...
thf(cax5seglem5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [Xj:$i] : ((((cwcel @ XN @ ccn) & (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee)))) & (cw3a @ (cwne @ XA2 @ XB2) @ (cwcel @ (XT @ Xj) @ (cco @ ccc0 @ cc1 @ ccicc)) @ (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XB2) = (cco @ (cco @ (cco @ cc1 @ (XT @ Xj) @ ccmin) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmul) @ (cco @ (XT @ Xj) @ (ccfv @ (ccv @ Xi) @ XC) @ ccmul) @ ccaddc))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz))))) => (cwne @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xj:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xj) @ XA2) @ (ccfv @ (ccv @ Xj) @ XC) @ ccmin) @ cc2 @ ccexp))) @ ccc0))))))))).
