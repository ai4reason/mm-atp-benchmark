...
thf(acsbprg_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ (XC @ Xx3) @ (XV @ Xx3)) => ((ccsb @ (XC @ Xx3) @ (^ [Xx3:$i] : (ccpr @ (XA2 @ Xx3) @ (XB2 @ Xx3)))) = (ccpr @ (ccsb @ (XC @ Xx3) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccsb @ (XC @ Xx3) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))))).
thf(apreq12d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((ccpr @ XA2 @ XC) = (ccpr @ XB2 @ XD))))))))))).
thf(ccab_tp,type,(ccab : (($i > $o) > ($i > $o)))).
thf(acsbsng_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ (XA2 @ Xx3) @ (XV @ Xx3)) => ((ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (ccsn @ (XB2 @ Xx3)))) = (ccsn @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))))).
...
thf(adfopif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccop @ XA2 @ XB2) = (ccif @ ((cwcel @ XA2 @ ccvv) & (cwcel @ XB2 @ ccvv)) @ (ccpr @ (ccsn @ XA2) @ (ccpr @ XA2 @ XB2)) @ cc0))))).
thf(ccsbopg_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ (XA2 @ Xx3) @ (XV @ Xx3)) => ((ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (ccop @ (XC @ Xx3) @ (XD @ Xx3)))) = (ccop @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XD @ Xx3)))))))))))).
