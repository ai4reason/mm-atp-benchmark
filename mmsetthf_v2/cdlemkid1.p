...
thf(atrljat3_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ (cwcel @ XF @ XT) @ ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le)))) => ((cco @ XP @ (ccfv @ XF @ XR) @ Xc_or) = (cco @ (ccfv @ XP @ XF) @ (ccfv @ XF @ XR) @ Xc_or)))))))))))))))))))).
...
thf(atrljco_ax,axiom,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((Xc_or = (ccfv @ XK @ ccjn)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ (cwcel @ XF @ XT) @ (cwcel @ XG @ XT)) => ((cco @ (ccfv @ XF @ XR) @ (ccfv @ (cccom @ XF @ XG) @ XR) @ Xc_or) = (cco @ (ccfv @ XF @ XR) @ (ccfv @ XG @ XR) @ Xc_or)))))))))))))))).
thf(alatabs2_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((cw3a @ (cwcel @ XK @ cclat) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => ((cco @ XX @ (cco @ XX @ XY @ Xc_or) @ Xc_an) = XX)))))))))))).
thf(ccdlemkid1_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > ($i > $o))] : (! [Xc_an:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xb:$i] : ((XB2 @ Xb) = (ccfv @ (XK @ Xb) @ ccbs))) => ((! [Xb:$i] : ((Xc_le @ Xb) = (ccfv @ (XK @ Xb) @ ccple))) => ((! [Xb:$i] : ((Xc_or @ Xb) = (ccfv @ (XK @ Xb) @ ccjn))) => ((! [Xb:$i] : ((Xc_an @ Xb) = (ccfv @ (XK @ Xb) @ ccmee))) => ((! [Xb:$i] : ((XA2 @ Xb) = (ccfv @ (XK @ Xb) @ ccatm))) => ((! [Xb:$i] : ((XH @ Xb) = (ccfv @ (XK @ Xb) @ cclh))) => ((! [Xb:$i] : ((XT @ Xb) = (ccfv @ (XW @ Xb) @ (ccfv @ (XK @ Xb) @ ccltrn)))) => ((! [Xb:$i] : ((XR @ Xb) = (ccfv @ (XW @ Xb) @ (ccfv @ (XK @ Xb) @ cctrl)))) => ((! [Xb:$i] : ((XZ @ Xb) = (cco @ (cco @ (XP @ Xb) @ (ccfv @ (ccv @ Xb) @ (XR @ Xb)) @ (Xc_or @ Xb)) @ (cco @ (ccfv @ (XP @ Xb) @ (XN @ Xb)) @ (ccfv @ (cccom @ (ccv @ Xb) @ (cccnv @ (XF @ Xb))) @ (XR @ Xb)) @ (Xc_or @ Xb)) @ (Xc_an @ Xb)))) => (! [Xb:$i] : ((cw3a @ ((cwcel @ (XK @ Xb) @ cchlt) & (cwcel @ (XW @ Xb) @ (XH @ Xb))) @ (cw3a @ (cwcel @ (XF @ Xb) @ (XT @ Xb)) @ (cwcel @ (XN @ Xb) @ (XT @ Xb)) @ ((ccfv @ (XF @ Xb) @ (XR @ Xb)) = (ccfv @ (XN @ Xb) @ (XR @ Xb)))) @ (((cwcel @ (XP @ Xb) @ (XA2 @ Xb)) & (~ (cwbr @ (XP @ Xb) @ (XW @ Xb) @ (Xc_le @ Xb)))) & ((cwcel @ (ccv @ Xb) @ (XT @ Xb)) & (cwne @ (ccv @ Xb) @ (ccres @ ccid @ (XB2 @ Xb)))))) => ((cco @ (XZ @ Xb) @ (ccfv @ (ccv @ Xb) @ (XR @ Xb)) @ (Xc_or @ Xb)) = (cco @ (XP @ Xb) @ (ccfv @ (ccv @ Xb) @ (XR @ Xb)) @ (Xc_or @ Xb))))))))))))))))))))))))))))).
