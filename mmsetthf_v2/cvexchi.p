...
thf(acvexchlem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwbr @ (ccin @ XA2 @ XB2) @ XB2 @ cccv) => (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ cchj) @ cccv))))))).
...
thf(acvcon3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((cwbr @ XA2 @ XB2 @ cccv) <=> (cwbr @ (ccfv @ XB2 @ ccort) @ (ccfv @ XA2 @ ccort) @ cccv)))))).
