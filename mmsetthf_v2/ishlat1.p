...
thf(adf_hlat_ax,axiom,(cchlt = (ccrab @ (^ [Xl:$i] : ((cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : ((cwne @ (ccv @ Xa) @ (ccv @ Xb)) => (cwrex @ (^ [Xc:$i] : (cw3a @ (cwne @ (ccv @ Xc) @ (ccv @ Xa)) @ (cwne @ (ccv @ Xc) @ (ccv @ Xb)) @ (cwbr @ (ccv @ Xc) @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (ccfv @ (ccv @ Xl) @ ccjn)) @ (ccfv @ (ccv @ Xl) @ ccple)))) @ (^ [Xc:$i] : (ccfv @ (ccv @ Xl) @ ccatm))))) @ (^ [Xb:$i] : (ccfv @ (ccv @ Xl) @ ccatm)))) @ (^ [Xa:$i] : (ccfv @ (ccv @ Xl) @ ccatm))) & (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (((cwbr @ (ccfv @ (ccv @ Xl) @ ccp0) @ (ccv @ Xa) @ (ccfv @ (ccv @ Xl) @ ccplt)) & (cwbr @ (ccv @ Xa) @ (ccv @ Xb) @ (ccfv @ (ccv @ Xl) @ ccplt))) & ((cwbr @ (ccv @ Xb) @ (ccv @ Xc) @ (ccfv @ (ccv @ Xl) @ ccplt)) & (cwbr @ (ccv @ Xc) @ (ccfv @ (ccv @ Xl) @ ccp1) @ (ccfv @ (ccv @ Xl) @ ccplt))))) @ (^ [Xc:$i] : (ccfv @ (ccv @ Xl) @ ccbs)))) @ (^ [Xb:$i] : (ccfv @ (ccv @ Xl) @ ccbs)))) @ (^ [Xa:$i] : (ccfv @ (ccv @ Xl) @ ccbs))))) @ (^ [Xl:$i] : (ccin @ (ccin @ ccoml @ cccla) @ cclc))))).
...
thf(cishlat1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_lt:($i > ($i > ($i > ($i > $o))))] : (! [Xc_1:($i > ($i > ($i > ($i > $o))))] : (! [Xc_or:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > ($i > $o))))] : (! [Xc_0:($i > ($i > ($i > ($i > $o))))] : ((XB2 = (ccfv @ XK @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xc_le @ Xx3 @ Xy1 @ Xz) = (ccfv @ XK @ ccple))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xc_lt @ Xx3 @ Xy1 @ Xz) = (ccfv @ XK @ ccplt))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xc_or @ Xx3 @ Xy1 @ Xz) = (ccfv @ XK @ ccjn))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xc_0 @ Xx3 @ Xy1 @ Xz) = (ccfv @ XK @ ccp0))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xc_1 @ Xx3 @ Xy1 @ Xz) = (ccfv @ XK @ ccp1))))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((cwcel @ XK @ cchlt) <=> ((cw3a @ (cwcel @ XK @ ccoml) @ (cwcel @ XK @ cccla) @ (cwcel @ XK @ cclc)) & ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) => (cwrex @ (^ [Xz:$i] : (cw3a @ (cwne @ (ccv @ Xz) @ (ccv @ Xx3)) @ (cwne @ (ccv @ Xz) @ (ccv @ Xy1)) @ (cwbr @ (ccv @ Xz) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_or @ Xx3 @ Xy1 @ Xz)) @ (Xc_le @ Xx3 @ Xy1 @ Xz)))) @ (^ [Xz:$i] : XA2)))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) & (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (((cwbr @ (Xc_0 @ Xx3 @ Xy1 @ Xz) @ (ccv @ Xx3) @ (Xc_lt @ Xx3 @ Xy1 @ Xz)) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_lt @ Xx3 @ Xy1 @ Xz))) & ((cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ (Xc_lt @ Xx3 @ Xy1 @ Xz)) & (cwbr @ (ccv @ Xz) @ (Xc_1 @ Xx3 @ Xy1 @ Xz) @ (Xc_lt @ Xx3 @ Xy1 @ Xz))))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))))))))))))))))))))).
