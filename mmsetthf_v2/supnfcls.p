...
thf(csupnfcls_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [Xx3:$i] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XU @ XJ) @ (cwcel @ (XA2 @ Xx3) @ XU)) => (~ (cwcel @ (XA2 @ Xx3) @ (cco @ XJ @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccdif @ XX @ XU) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : (ccpw @ XX))) @ ccfcls)))))))))).
