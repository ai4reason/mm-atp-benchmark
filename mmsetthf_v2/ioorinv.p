...
thf(aioorinv2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccrn @ ccioo)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = cc0) @ (ccop @ ccc0 @ ccc0) @ (ccop @ (ccinf @ (ccv @ Xx3) @ ccxr @ cclt) @ (ccsup @ (ccv @ Xx3) @ ccxr @ cclt))))))) => (! [Xx3:$i] : ((cwne @ (cco @ XA2 @ XB2 @ ccioo) @ cc0) => ((ccfv @ (cco @ XA2 @ XB2 @ ccioo) @ (XF @ Xx3)) = (ccop @ XA2 @ XB2))))))))).
...
thf(cioorinv_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccrn @ ccioo)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = cc0) @ (ccop @ ccc0 @ ccc0) @ (ccop @ (ccinf @ (ccv @ Xx3) @ ccxr @ cclt) @ (ccsup @ (ccv @ Xx3) @ ccxr @ cclt))))))) => (! [Xx3:$i] : ((cwcel @ XA2 @ (ccrn @ ccioo)) => ((ccfv @ (ccfv @ XA2 @ (XF @ Xx3)) @ ccioo) = XA2))))))).
