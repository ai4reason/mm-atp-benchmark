...
thf(aareacirclem5_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XS @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ ccr) & (cwcel @ (ccv @ Xy1) @ ccr)) & (cwbr @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ XR @ cc2 @ ccexp) @ ccle)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : ((cw3a @ (cwcel @ XR @ ccr) @ (cwbr @ ccc0 @ XR @ ccle) @ (cwcel @ (ccv @ Xt) @ ccr)) => ((ccima @ (XS @ Xx3 @ Xy1) @ (ccsn @ (ccv @ Xt))) = (ccif @ (cwbr @ (ccfv @ (ccv @ Xt) @ ccabs) @ XR @ ccle) @ (cco @ (ccneg @ (ccfv @ (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccv @ Xt) @ cc2 @ ccexp) @ ccmin) @ ccsqrt)) @ (ccfv @ (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccv @ Xt) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccicc) @ cc0)))))))))).
...
thf(aareacirclem3_ax,axiom,(! [XR:($i > $o)] : (((cwcel @ XR @ ccr) & (cwbr @ ccc0 @ XR @ ccle)) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ (ccneg @ XR) @ XR @ ccicc)) @ (^ [Xt:$i] : (cco @ cc2 @ (ccfv @ (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccv @ Xt) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccmul))) @ ccibl)))).
...
thf(aitgss_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwss @ (XA2 @ Xx3) @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ (XB2 @ Xx3) @ (XA2 @ Xx3)))) => ((XC @ Xx3) = ccc0))) => (Xph => ((ccitg @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3))) = (ccitg @ (^ [Xx3:$i] : (XB2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3)))))))))))).
...
thf(aareacirclem4_ax,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccrp) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ (ccneg @ XR) @ XR @ ccicc)) @ (^ [Xt:$i] : (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ (ccv @ Xt) @ XR @ ccdiv) @ ccasin) @ (cco @ (cco @ (ccv @ Xt) @ XR @ ccdiv) @ (ccfv @ (cco @ cc1 @ (cco @ (cco @ (ccv @ Xt) @ XR @ ccdiv) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccmul) @ ccaddc) @ ccmul))) @ (cco @ (cco @ (ccneg @ XR) @ XR @ ccicc) @ ccc @ cccncf))))).
