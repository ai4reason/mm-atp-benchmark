...
thf(aelpreimad_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwfn @ XF @ XA2)) => ((Xph => (cwcel @ XB2 @ XA2)) => ((Xph => (cwcel @ (ccfv @ XB2 @ XF) @ XC)) => (Xph => (cwcel @ XB2 @ (ccima @ (cccnv @ XF) @ XC)))))))))))).
...
thf(aiocleubd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioc))) => (Xph => (cwbr @ XC @ XB2 @ ccle)))))))))).
...
thf(ainiin1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((cwne @ XA2 @ cc0) => ((ccin @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ XB2) = (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccin @ (XC @ Xx3) @ XB2))))))))).
thf(aeliind_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ (cciin @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3)))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XK @ XB2))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XK) => ((cwcel @ XA2 @ (XC @ Xx3)) <=> (cwcel @ XA2 @ XD)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ XD))))))))))))).
...
thf(asuprleubrnmpt_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwne @ XA2 @ cc0)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((Xph @ Xx3 @ Xy1) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xx3:$i] : XA2))) @ (^ [Xy1:$i] : ccr))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (XC @ Xy1) @ ccr)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => ((cwbr @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ ccr @ cclt) @ (XC @ Xy1) @ ccle) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (XC @ Xy1) @ ccle)) @ (^ [Xx3:$i] : XA2)))))))))))))))).
...
thf(auzct_ax,axiom,(! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XN @ ccuz)) => (cwbr @ XZ @ ccom @ ccdom))))).
thf(csmfsuplem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XM @ Xx3 @ Xy1) @ ccz)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XZ = (ccfv @ (XM @ Xx3 @ Xy1) @ ccuz)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XS @ Xx3 @ Xy1) @ ccsalg)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (Xph => (cwf @ XZ @ (ccfv @ (XS @ Xx3 @ Xy1) @ ccsmblfn) @ (XF @ Xn)))))) => ((XD = (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ (XF @ Xn))) @ (ccv @ Xy1) @ ccle)) @ (^ [Xn:$i] : XZ))) @ (^ [Xy1:$i] : ccr))) @ (^ [Xx3:$i] : (cciin @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccdm @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)))))))) => ((! [Xy1:$i] : ((XG @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)))))) @ ccr @ cclt))))) => ((! [Xy1:$i] : (Xph => (cwcel @ (XA2 @ Xy1) @ ccr))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwf @ XZ @ (XS @ Xx3 @ Xy1) @ XH)))) => ((! [Xy1:$i] : (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ XZ)) => ((ccima @ (cccnv @ (ccfv @ (ccv @ Xn) @ (XF @ Xn))) @ (cco @ ccmnf @ (XA2 @ Xy1) @ ccioc)) = (ccin @ (ccfv @ (ccv @ Xn) @ XH) @ (ccdm @ (ccfv @ (ccv @ Xn) @ (XF @ Xn)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (ccima @ (cccnv @ (XG @ Xy1)) @ (cco @ ccmnf @ (XA2 @ Xy1) @ ccioc)) @ (cco @ (XS @ Xx3 @ Xy1) @ XD @ ccrest)))))))))))))))))))))))).
