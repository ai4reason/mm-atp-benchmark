...
thf(aubmelm1fzo_ax,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ ccc0 @ XN @ ccfzo)) => (cwcel @ (cco @ (cco @ XN @ XK @ ccmin) @ cc1 @ ccmin) @ (cco @ ccc0 @ XN @ ccfzo)))))).
...
thf(annpcan_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) => ((cco @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ XC @ ccmin) @ XB2 @ ccaddc) = (cco @ XA2 @ XC @ ccmin))))))).
...
thf(ccshwidxm1_conj,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) => ((ccfv @ (cco @ (cco @ (ccfv @ XW @ cchash) @ XN @ ccmin) @ cc1 @ ccmin) @ (cco @ XW @ XN @ cccsh)) = (ccfv @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ XW))))))).
