...
thf(asnelpw_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XA2 @ XB2) <=> (cwcel @ (ccsn @ XA2) @ (ccpw @ XB2))))))).
...
thf(cdis2ndc_conj,conjecture,(! [XX:($i > $o)] : ((cwbr @ XX @ ccom @ ccdom) <=> (cwcel @ (ccpw @ XX) @ cc2ndc)))).
