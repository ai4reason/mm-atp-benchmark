...
thf(aodd2prm2_ax,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccodd) @ ((cwcel @ XP @ ccprime) & (cwcel @ XQ @ ccprime)) @ (XN = (cco @ XP @ XQ @ ccaddc))) => ((XP = cc2) | (XQ = cc2))))))).
thf(adf_3or_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3o @ Xph @ Xps @ Xch) <=> ((Xph | Xps) | Xch)))))).
thf(ceven3prm2_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ cceven) @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XQ @ ccprime) @ (cwcel @ XR @ ccprime)) @ (XN = (cco @ (cco @ XP @ XQ @ ccaddc) @ XR @ ccaddc))) => (cw3o @ (XP = cc2) @ (XQ = cc2) @ (XR = cc2)))))))).
