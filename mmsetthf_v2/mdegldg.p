...
thf(arexsupp_ax,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cw3a @ (cwfn @ XF @ XX) @ (cwcel @ XX @ XV) @ (cwcel @ XZ @ XW)) => ((cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (cco @ XF @ XZ @ ccsupp))) <=> (cwrex @ (^ [Xx3:$i] : ((cwne @ (ccfv @ (ccv @ Xx3) @ XF) @ XZ) & (Xph @ Xx3))) @ (^ [Xx3:$i] : XX))))))))))).
thf(cmdegldg_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > $o))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xh:$i] : (! [Xm:$i] : ((XD @ Xh @ Xm) = (cco @ (XI @ Xx3) @ (XR @ Xh @ Xm) @ ccmdg))))) => ((! [Xx3:$i] : (! [Xh:$i] : (! [Xm:$i] : ((XP @ Xx3 @ Xh @ Xm) = (cco @ (XI @ Xx3) @ (XR @ Xh @ Xm) @ ccmpl))))) => ((! [Xx3:$i] : (! [Xh:$i] : (! [Xm:$i] : ((XB2 @ Xh @ Xm) = (ccfv @ (XP @ Xx3 @ Xh @ Xm) @ ccbs))))) => ((! [Xh:$i] : (! [Xm:$i] : ((Xc_0 @ Xm) = (ccfv @ (XR @ Xh @ Xm) @ cc0g)))) => ((! [Xx3:$i] : (! [Xm:$i] : ((XA2 @ Xm) = (ccrab @ (^ [Xm:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xm)) @ ccn) @ ccfn)) @ (^ [Xm:$i] : (cco @ ccn0 @ (XI @ Xx3) @ ccmap)))))) => ((! [Xh:$i] : (! [Xm:$i] : ((XH @ Xh @ Xm) = (ccmpt @ (^ [Xh:$i] : (XA2 @ Xm)) @ (^ [Xh:$i] : (cco @ cccnfld @ (ccv @ Xh) @ ccgsu)))))) => ((! [Xx3:$i] : (! [Xh:$i] : (! [Xm:$i] : ((XY @ Xx3 @ Xh @ Xm) = (ccfv @ (XP @ Xx3 @ Xh @ Xm) @ cc0g))))) => (! [Xx3:$i] : (! [Xh:$i] : (! [Xm:$i] : ((cw3a @ (cwcel @ (XR @ Xh @ Xm) @ ccrg) @ (cwcel @ (XF @ Xh @ Xm) @ (XB2 @ Xh @ Xm)) @ (cwne @ (XF @ Xh @ Xm) @ (XY @ Xx3 @ Xh @ Xm))) => (cwrex @ (^ [Xx3:$i] : ((cwne @ (ccfv @ (ccv @ Xx3) @ (XF @ Xh @ Xm)) @ (Xc_0 @ Xm)) & ((ccfv @ (ccv @ Xx3) @ (XH @ Xh @ Xm)) = (ccfv @ (XF @ Xh @ Xm) @ (XD @ Xh @ Xm))))) @ (^ [Xx3:$i] : (XA2 @ Xm))))))))))))))))))))))))).
