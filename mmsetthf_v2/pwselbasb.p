...
thf(cpwselbasb_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XY = (cco @ XR @ XI @ ccpws)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XV = (ccfv @ XY @ ccbs)) => (((cwcel @ XR @ XW) & (cwcel @ XI @ XZ)) => ((cwcel @ XX @ XV) <=> (cwf @ XI @ XB2 @ XX))))))))))))))).
