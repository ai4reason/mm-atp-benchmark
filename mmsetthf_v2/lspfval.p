...
thf(adf_lsp_ax,axiom,(cclspn = (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccmpt @ (^ [Xs1:$i] : (ccpw @ (ccfv @ (ccv @ Xw) @ ccbs))) @ (^ [Xs1:$i] : (ccint @ (ccrab @ (^ [Xt:$i] : (cwss @ (ccv @ Xs1) @ (ccv @ Xt))) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xw) @ cclss)))))))))).
...
thf(clspfval_conj,conjecture,(! [XS:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xt:$i] : (XV = (ccfv @ (XW @ Xt) @ ccbs))) => ((! [Xt:$i] : (XS = (ccfv @ (XW @ Xt) @ cclss))) => ((! [Xt:$i] : (! [Xs1:$i] : ((XN @ Xt @ Xs1) = (ccfv @ (XW @ Xt) @ cclspn)))) => (! [Xt:$i] : (! [Xs1:$i] : ((cwcel @ (XW @ Xt) @ (XX @ Xt @ Xs1)) => ((XN @ Xt @ Xs1) = (ccmpt @ (^ [Xs1:$i] : (ccpw @ XV)) @ (^ [Xs1:$i] : (ccint @ (ccrab @ (^ [Xt:$i] : (cwss @ (ccv @ Xs1) @ (ccv @ Xt))) @ (^ [Xt:$i] : XS)))))))))))))))))).
