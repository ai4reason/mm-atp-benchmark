...
thf(aenrelmap_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => (cwbr @ (ccpw @ (ccxp @ XA2 @ XB2)) @ (cco @ (ccpw @ XB2) @ XA2 @ ccmap) @ ccen))))))).
thf(cwer_tp,type,(cwer : (($i > $o) > (($i > $o) > $o)))).
thf(aentr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccen) & (cwbr @ XB2 @ XC @ ccen)) => (cwbr @ XA2 @ XC @ ccen)))))).
thf(cenrelmapr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => (cwbr @ (ccpw @ (ccxp @ XA2 @ XB2)) @ (cco @ (ccpw @ XA2) @ XB2 @ ccmap) @ ccen))))))).
