...
thf(acaragensspw_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XX = (ccuni @ (ccdm @ XO))) => ((XS = (ccfv @ XO @ cccaragen)) => (Xph => (cwss @ XS @ (ccpw @ XX))))))))))).
