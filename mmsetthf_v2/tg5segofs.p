...
thf(abrafs_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XO:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((XO = (ccfv @ XG @ ccafs)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XD @ XP)) => ((Xph => (cwcel @ XX @ XP)) => ((Xph => (cwcel @ XY @ XP)) => ((Xph => (cwcel @ XZ @ XP)) => ((Xph => (cwcel @ XW @ XP)) => (Xph => ((cwbr @ (ccop @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD)) @ (ccop @ (ccop @ XX @ XY) @ (ccop @ XZ @ XW)) @ XO) <=> (cw3a @ ((cwcel @ XB2 @ (cco @ XA2 @ XC @ XI)) & (cwcel @ XY @ (cco @ XX @ XZ @ XI))) @ (((cco @ XA2 @ XB2 @ Xc_mi) = (cco @ XX @ XY @ Xc_mi)) & ((cco @ XB2 @ XC @ Xc_mi) = (cco @ XY @ XZ @ Xc_mi))) @ (((cco @ XA2 @ XD @ Xc_mi) = (cco @ XX @ XW @ Xc_mi)) & ((cco @ XB2 @ XD @ Xc_mi) = (cco @ XY @ XW @ Xc_mi)))))))))))))))))))))))))))))))))).
