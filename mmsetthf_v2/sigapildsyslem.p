...
thf(aiindif2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((cwne @ XA2 @ cc0) => ((cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccdif @ XB2 @ (XC @ Xx3)))) = (ccdif @ XB2 @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3)))))))))).
...
thf(ainelfi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XX @ XV) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) => (cwcel @ (ccin @ XA2 @ XB2) @ (ccfv @ XX @ ccfi)))))))).
...
thf(aiinfi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XC @ (XV @ Xx3)) & (cw3a @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ XC)) @ (^ [Xx3:$i] : XA2)) @ (cwne @ XA2 @ cc0) @ (cwcel @ XA2 @ ccfn))) => (cwcel @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccfv @ XC @ ccfi))))))))).
