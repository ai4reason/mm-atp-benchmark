...
thf(cevl1at0_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XO:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XO = (ccfv @ XR @ cce1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XZ = (ccfv @ XP @ cc0g)) => ((cwcel @ XR @ cccrg) => ((ccfv @ Xc_0 @ (ccfv @ XZ @ XO)) = Xc_0)))))))))))).
