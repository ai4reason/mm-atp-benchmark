...
thf(cswrdsb0eq_conj,conjecture,(! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ ((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XU @ (ccword @ XV))) @ ((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) @ (cwbr @ XN @ XM @ ccle)) => ((cco @ XW @ (ccop @ XM @ XN) @ ccsubstr) = (cco @ XU @ (ccop @ XM @ XN) @ ccsubstr))))))))).
