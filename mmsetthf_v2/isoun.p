...
thf(cisoun_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((! [Xz:$i] : (! [Xw:$i] : (Xph => (cwiso @ (XA2 @ Xz @ Xw) @ XB2 @ (XR @ Xz @ Xw) @ XS @ XH)))) => ((! [Xz:$i] : (! [Xw:$i] : (Xph => (cwiso @ (XC @ Xz @ Xw) @ XD @ (XR @ Xz @ Xw) @ XS @ XG)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xz @ Xw)) @ (cwcel @ (ccv @ Xy1) @ (XC @ Xz @ Xw))) => (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XR @ Xz @ Xw))))))) => ((! [Xz:$i] : (! [Xw:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xz) @ XB2) @ (cwcel @ (ccv @ Xw) @ XD)) => (cwbr @ (ccv @ Xz) @ (ccv @ Xw) @ XS)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ (XC @ Xz @ Xw)) @ (cwcel @ (ccv @ Xy1) @ (XA2 @ Xz @ Xw))) => (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XR @ Xz @ Xw)))))))) => ((! [Xz:$i] : (! [Xw:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xz) @ XD) @ (cwcel @ (ccv @ Xw) @ XB2)) => (~ (cwbr @ (ccv @ Xz) @ (ccv @ Xw) @ XS))))) => ((! [Xz:$i] : (! [Xw:$i] : (Xph => ((ccin @ (XA2 @ Xz @ Xw) @ (XC @ Xz @ Xw)) = cc0)))) => ((Xph => ((ccin @ XB2 @ XD) = cc0)) => (! [Xz:$i] : (! [Xw:$i] : (Xph => (cwiso @ (ccun @ (XA2 @ Xz @ Xw) @ (XC @ Xz @ Xw)) @ (ccun @ XB2 @ XD) @ (XR @ Xz @ Xw) @ XS @ (ccun @ XH @ XG))))))))))))))))))))))).
