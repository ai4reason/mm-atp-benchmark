...
thf(ah1dei_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ cchil) => ((cwcel @ XA2 @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) <=> ((cwcel @ XA2 @ cchil) & (cwral @ (^ [Xx3:$i] : (((cco @ XB2 @ (ccv @ Xx3) @ ccsp) = ccc0) => ((cco @ XA2 @ (ccv @ Xx3) @ ccsp) = ccc0))) @ (^ [Xx3:$i] : cchil)))))))).
...
thf(aorthcom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => (((cco @ XA2 @ XB2 @ ccsp) = ccc0) <=> ((cco @ XB2 @ XA2 @ ccsp) = ccc0)))))).
thf(amulcli_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => (cwcel @ (cco @ XA2 @ XB2 @ ccmul) @ ccc)))))).
thf(ccr_tp,type,(ccr : ($i > $o))).
thf(cc0v_tp,type,(cc0v : ($i > $o))).
thf(abcseqi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => (((cco @ (cco @ XA2 @ XB2 @ ccsp) @ (cco @ XB2 @ XA2 @ ccsp) @ ccmul) = (cco @ (cco @ XA2 @ XA2 @ ccsp) @ (cco @ XB2 @ XB2 @ ccsp) @ ccmul)) <=> ((cco @ (cco @ XB2 @ XB2 @ ccsp) @ XA2 @ ccsm) = (cco @ (cco @ XA2 @ XB2 @ ccsp) @ XB2 @ ccsm)))))))).
thf(ch1de2i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cwcel @ XA2 @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) => ((cco @ (cco @ XB2 @ XB2 @ ccsp) @ XA2 @ ccsm) = (cco @ (cco @ XA2 @ XB2 @ ccsp) @ XB2 @ ccsm)))))))).
