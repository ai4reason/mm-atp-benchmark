...
thf(celzrhunit_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XL = (ccfv @ XR @ cczrh)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((((cwcel @ XR @ ccdr) & ((ccfv @ XR @ ccchr) = ccc0)) & ((cwcel @ XM @ ccz) & (cwne @ XM @ ccc0))) => (cwcel @ (ccfv @ XM @ XL) @ (ccfv @ XR @ ccui)))))))))))).
