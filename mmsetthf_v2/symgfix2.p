...
thf(asymgmov2_ax,axiom,(! [XP:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : ((! [Xk:$i] : ((XP @ Xk) = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs))) => (! [Xk:$i] : ((cwcel @ XQ @ (XP @ Xk)) => (cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xk:$i] : ((ccfv @ (ccv @ Xk) @ XQ) = (ccv @ Xn))) @ (^ [Xk:$i] : XN))) @ (^ [Xn:$i] : XN))))))))).
...
thf(csymgfix2_conj,conjecture,(! [XP:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > ($i > $o))] : ((! [Xk:$i] : (! [Xq:$i] : ((XP @ Xk) = (ccfv @ (ccfv @ (XN @ Xq) @ ccsymg) @ ccbs)))) => (! [Xk:$i] : (! [Xq:$i] : ((cwcel @ XL @ (XN @ Xq)) => ((cwcel @ XQ @ (ccdif @ (XP @ Xk) @ (ccrab @ (^ [Xq:$i] : ((ccfv @ XK @ (ccv @ Xq)) = XL)) @ (^ [Xq:$i] : (XP @ Xk))))) => (cwrex @ (^ [Xk:$i] : ((ccfv @ (ccv @ Xk) @ XQ) = XL)) @ (^ [Xk:$i] : (ccdif @ (XN @ Xq) @ (ccsn @ XK))))))))))))))).
