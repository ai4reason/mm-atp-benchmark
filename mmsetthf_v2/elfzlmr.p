...
thf(aelfzr_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ XM @ XN @ ccfz)) => ((cwcel @ XK @ (cco @ XM @ XN @ ccfzo)) | (XK = XN))))))).
...
thf(celfzlmr_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ XM @ XN @ ccfz)) => (cw3o @ (XK = XM) @ (cwcel @ XK @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XN @ ccfzo)) @ (XK = XN))))))).
