...
thf(acdlemg47_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xh:$i] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((cw3a @ (cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ (cwcel @ XF @ XT) @ (cwcel @ XG @ XT)) @ ((cwcel @ (ccv @ Xh) @ XT) & ((ccfv @ XF @ XR) = (ccfv @ XG @ XR))) @ (cw3a @ (cwne @ XF @ (ccres @ ccid @ XB2)) @ (cwne @ (ccv @ Xh) @ (ccres @ ccid @ XB2)) @ (cwne @ (ccfv @ (ccv @ Xh) @ XR) @ (ccfv @ XF @ XR)))) => ((cccom @ XF @ XG) = (cccom @ XG @ XF))))))))))))))))).
thf(ccdlemg48_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ ((cwcel @ XF @ XT) & (cwcel @ XG @ XT)) @ ((cwne @ XF @ (ccres @ ccid @ XB2)) & ((ccfv @ XF @ XR) = (ccfv @ XG @ XR)))) => ((cccom @ XF @ XG) = (cccom @ XG @ XF)))))))))))))))).
