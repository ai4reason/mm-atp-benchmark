...
thf(copthprc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((ccun @ (ccxp @ XA2 @ (ccsn @ cc0)) @ (ccxp @ XB2 @ (ccsn @ (ccsn @ cc0)))) = (ccun @ (ccxp @ XC @ (ccsn @ cc0)) @ (ccxp @ XD @ (ccsn @ (ccsn @ cc0))))) <=> ((XA2 = XC) & (XB2 = XD)))))))).
