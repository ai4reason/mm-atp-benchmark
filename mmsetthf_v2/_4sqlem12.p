...
thf(a_4sqlem11_ax,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XN:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XS @ Xx3 @ Xy1 @ Xz @ Xw) = (ccab @ (^ [Xn:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : ((ccv @ Xn) = (cco @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ (cco @ (ccv @ Xw) @ cc2 @ ccexp) @ ccaddc) @ ccaddc))) @ (^ [Xw:$i] : ccz))) @ (^ [Xz:$i] : ccz))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) => (cwcel @ (XN @ Xx3 @ Xy1 @ Xz @ Xw) @ ccn)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) => ((XP @ Xx3 @ Xy1 @ Xz @ Xw) = (cco @ (cco @ cc2 @ (XN @ Xx3 @ Xy1 @ Xz @ Xw) @ ccmul) @ cc1 @ ccaddc))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) => (cwcel @ (XP @ Xx3 @ Xy1 @ Xz @ Xw) @ ccprime)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xu:$i] : (! [Xm:$i] : ((XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xu @ Xm) = (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xm:$i] : ((ccv @ Xu) = (cco @ (cco @ (ccv @ Xm) @ cc2 @ ccexp) @ (XP @ Xx3 @ Xy1 @ Xz @ Xw) @ ccmo))) @ (^ [Xm:$i] : (cco @ ccc0 @ (XN @ Xx3 @ Xy1 @ Xz @ Xw) @ ccfz)))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xm:$i] : ((XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xu @ Xm) = (ccmpt @ (^ [Xv:$i] : (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xu @ Xm)) @ (^ [Xv:$i] : (cco @ (cco @ (XP @ Xx3 @ Xy1 @ Xz @ Xw) @ cc1 @ ccmin) @ (ccv @ Xv) @ ccmin))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xm:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) => (cwne @ (ccin @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xu @ Xm) @ (ccrn @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xu @ Xm))) @ cc0)))))))))))))))))))))).
...
thf(amodsubdir_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccrp)) => ((cwbr @ (cco @ XB2 @ XC @ ccmo) @ (cco @ XA2 @ XC @ ccmo) @ ccle) <=> ((cco @ (cco @ XA2 @ XB2 @ ccmin) @ XC @ ccmo) = (cco @ (cco @ XA2 @ XC @ ccmo) @ (cco @ XB2 @ XC @ ccmo) @ ccmin)))))))).
...
thf(advdssubr_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwbr @ XM @ XN @ ccdvds) <=> (cwbr @ XM @ (cco @ XN @ XM @ ccmin) @ ccdvds)))))).
...
thf(agzreim_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => (cwcel @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccaddc) @ ccgz))))).
