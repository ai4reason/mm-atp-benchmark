...
thf(clatmlem12_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((cw3a @ (cwcel @ XK @ cclat) @ ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) @ ((cwcel @ XZ @ XB2) & (cwcel @ XW @ XB2))) => (((cwbr @ XX @ XY @ Xc_le) & (cwbr @ XZ @ XW @ Xc_le)) => (cwbr @ (cco @ XX @ XZ @ Xc_an) @ (cco @ XY @ XW @ Xc_an) @ Xc_le))))))))))))))).
