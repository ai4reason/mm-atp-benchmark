...
thf(crnelfmlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cw3a @ (cwcel @ XY @ XA2) @ (cwcel @ XL @ (ccfv @ XX @ ccfil)) @ (cwf @ XY @ XX @ XF)) & (cwcel @ (ccrn @ XF) @ XL)) => (cwcel @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XL) @ (^ [Xx3:$i] : (ccima @ (cccnv @ XF) @ (ccv @ Xx3))))) @ (ccfv @ XY @ ccfbas))))))))).
