...
thf(annsub_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn)) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwcel @ (cco @ XB2 @ XA2 @ ccmin) @ ccn)))))).
...
thf(annpw2evenALTV_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => (cwcel @ (cco @ cc2 @ XN @ ccexp) @ cceven)))).
thf(aevenm1odd_ax,axiom,(! [XZ:($i > $o)] : ((cwcel @ XZ @ cceven) => (cwcel @ (cco @ XZ @ cc1 @ ccmin) @ ccodd)))).
...
thf(cperfectALTVlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccn)) => ((Xph => (cwcel @ XB2 @ ccn)) => ((Xph => (cwcel @ XB2 @ ccodd)) => ((Xph => ((cco @ cc1 @ (cco @ (cco @ cc2 @ XA2 @ ccexp) @ XB2 @ ccmul) @ ccsgm) = (cco @ cc2 @ (cco @ (cco @ cc2 @ XA2 @ ccexp) @ XB2 @ ccmul) @ ccmul))) => (Xph => (cw3a @ (cwcel @ (cco @ cc2 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccexp) @ ccn) @ (cwcel @ (cco @ (cco @ cc2 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccexp) @ cc1 @ ccmin) @ ccn) @ (cwcel @ (cco @ XB2 @ (cco @ (cco @ cc2 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccexp) @ cc1 @ ccmin) @ ccdiv) @ ccn))))))))))).
