...
thf(chmeoclda_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (((cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XK @ cctop) @ (cwcel @ XF @ (cco @ XJ @ XK @ cchmeo))) & (cwcel @ XS @ (ccfv @ XJ @ cccld))) => (cwcel @ (ccima @ XF @ XS) @ (ccfv @ XK @ cccld)))))))).
