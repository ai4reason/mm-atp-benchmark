...
thf(aelvvuni_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccxp @ ccvv @ ccvv)) => (cwcel @ (ccuni @ XA2) @ XA2)))).
...
thf(cunielxp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccxp @ XB2 @ XC)) => (cwcel @ (ccuni @ XA2) @ (ccuni @ (ccxp @ XB2 @ XC)))))))).
