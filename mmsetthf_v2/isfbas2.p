...
thf(cisfbas2_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ XB2 @ (XA2 @ Xx3 @ Xy1 @ Xz)) => ((cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) <=> ((cwss @ XF @ (ccpw @ XB2)) & (cw3a @ (cwne @ XF @ cc0) @ (cwnel @ cc0 @ XF) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwss @ (ccv @ Xz) @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xz:$i] : XF))) @ (^ [Xy1:$i] : XF))) @ (^ [Xx3:$i] : XF))))))))))))).
