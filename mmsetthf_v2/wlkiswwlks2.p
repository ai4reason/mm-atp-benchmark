...
thf(ahashge1_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwne @ XA2 @ cc0)) => (cwbr @ cc1 @ (ccfv @ XA2 @ cchash) @ ccle))))).
...
thf(awlkiswwlks2lem6_ax,axiom,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (ccpr @ (ccfv @ (ccv @ Xx3) @ XP) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XP)) @ (cccnv @ XE)))))) => ((XE = (ccfv @ XG @ cciedg)) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XG @ ccuspgr) @ (cwcel @ XP @ (ccword @ XV)) @ (cwbr @ cc1 @ (ccfv @ XP @ cchash) @ ccle)) => ((cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP)) @ (ccrn @ XE))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccfzo))) => (cw3a @ (cwcel @ (XF @ Xx3) @ (ccword @ (ccdm @ XE))) @ (cwf @ (cco @ ccc0 @ (ccfv @ (XF @ Xx3) @ cchash) @ ccfz) @ XV @ XP) @ (cwral @ (^ [Xi:$i] : ((ccfv @ (ccfv @ (ccv @ Xi) @ (XF @ Xx3)) @ XE) = (ccpr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP)))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ (XF @ Xx3) @ cchash) @ ccfzo))))))))))))))).
...
thf(cwlkiswwlks2_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XG @ ccuspgr) => ((cwcel @ XP @ (ccfv @ XG @ ccwwlks)) => (? [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XG @ ccwlks)))))))).
