...
thf(cknoppndvlem18_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XC @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo))) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XD @ ccrp)) => ((Xph => (cwcel @ XE @ ccrp)) => ((Xph => (cwcel @ XG @ ccrp)) => ((Xph => (cwbr @ cc1 @ (cco @ XN @ (ccfv @ XC @ ccabs) @ ccmul) @ cclt)) => (Xph => (cwrex @ (^ [Xj:$i] : ((cwbr @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccneg @ (ccv @ Xj)) @ ccexp) @ cc2 @ ccdiv) @ XD @ cclt) & (cwbr @ XE @ (cco @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccfv @ XC @ ccabs) @ ccmul) @ (ccv @ Xj) @ ccexp) @ XG @ ccmul) @ ccle))) @ (^ [Xj:$i] : ccn0)))))))))))))))).
