...
thf(aeldm3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ XB2)) <=> (cwne @ (ccres @ XB2 @ (ccsn @ XA2)) @ cc0))))).
...
thf(acnveq0_ax,axiom,(! [XA2:($i > $o)] : ((cwrel @ XA2) => ((XA2 = cc0) <=> ((cccnv @ XA2) = cc0))))).
thf(celrn3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ (ccrn @ XB2)) <=> (cwne @ (ccin @ XB2 @ (ccxp @ ccvv @ (ccsn @ XA2))) @ cc0))))).
