...
thf(afgraphxp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => (XF = (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccfv @ (ccv @ Xx3) @ cc1st) @ XF) = (ccfv @ (ccv @ Xx3) @ cc2nd))) @ (^ [Xx3:$i] : (ccxp @ XA2 @ XB2))))))))).
thf(ccid_tp,type,(ccid : ($i > $o))).
thf(ahauseqlcld_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XK @ ccha)) => ((Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ XJ @ XK @ cccn))) => (Xph => (cwcel @ (ccdm @ (ccin @ XF @ XG)) @ (ccfv @ XJ @ cccld)))))))))))).
