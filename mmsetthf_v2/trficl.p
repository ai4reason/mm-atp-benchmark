...
thf(atrin2_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwss @ (cccom @ XR @ XR) @ XR) & (cwss @ (cccom @ XS @ XS) @ XS)) => (cwss @ (cccom @ (ccin @ XR @ XS) @ (ccin @ XR @ XS)) @ (ccin @ XR @ XS)))))).
thf(ctrficl_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xz:$i] : ((XA2 @ Xx3 @ Xz) = (ccab @ (^ [Xz:$i] : (cwss @ (cccom @ (ccv @ Xz) @ (ccv @ Xz)) @ (ccv @ Xz))))))) => (! [Xz:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (XA2 @ Xx3 @ Xz))) @ (^ [Xy1:$i] : (XA2 @ Xx3 @ Xz)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xz))))))).
