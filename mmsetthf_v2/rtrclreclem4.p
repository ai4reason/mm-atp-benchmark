...
thf(arelexp0d_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : ((Xph => (cwrel @ XR)) => ((Xph => (cwcel @ XR @ ccvv)) => (Xph => ((cco @ XR @ ccc0 @ ccrelexp) = (ccres @ ccid @ (ccuni @ (ccuni @ XR)))))))))).
...
thf(arelexpsucrd_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwrel @ XR)) => ((Xph => (cwcel @ XR @ ccvv)) => (Xph => ((cwcel @ XN @ ccn0) => ((cco @ XR @ (cco @ XN @ cc1 @ ccaddc) @ ccrelexp) = (cccom @ (cco @ XR @ XN @ ccrelexp) @ XR)))))))))).
...
thf(crtrclreclem4_conj,conjecture,(! [Xph:$o] : (! [XR:($i > ($i > $o))] : ((! [Xs1:$i] : (Xph => (cwrel @ (XR @ Xs1)))) => ((! [Xs1:$i] : (Xph => (cwcel @ (XR @ Xs1) @ ccvv))) => (Xph => (! [Xs1:$i] : ((cw3a @ (cwss @ (ccres @ ccid @ (ccun @ (ccdm @ (XR @ Xs1)) @ (ccrn @ (XR @ Xs1)))) @ (ccv @ Xs1)) @ (cwss @ (XR @ Xs1) @ (ccv @ Xs1)) @ (cwss @ (cccom @ (ccv @ Xs1) @ (ccv @ Xs1)) @ (ccv @ Xs1))) => (cwss @ (ccfv @ (XR @ Xs1) @ ccrtrcl) @ (ccv @ Xs1)))))))))).
