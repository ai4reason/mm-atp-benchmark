...
thf(cmodnegd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccrp)) => ((Xph => ((cco @ XA2 @ XC @ ccmo) = (cco @ XB2 @ XC @ ccmo))) => (Xph => ((cco @ (ccneg @ XA2) @ XC @ ccmo) = (cco @ (ccneg @ XB2) @ XC @ ccmo)))))))))))).
