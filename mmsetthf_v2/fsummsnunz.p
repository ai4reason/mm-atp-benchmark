...
thf(cfsummsnunz_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XZ:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xk) @ ccz)) @ (^ [Xk:$i] : (ccun @ XA2 @ (ccsn @ XZ))))) => (cwcel @ (ccsu @ (ccun @ XA2 @ (ccsn @ XZ)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccz)))))).
