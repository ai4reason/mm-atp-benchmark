...
thf(aacosf_ax,axiom,(cwf @ ccc @ ccc @ ccacos)).
...
thf(aiocmnfcld_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwcel @ (cco @ ccmnf @ XA2 @ ccioc) @ (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld))))).
thf(ccaddc_tp,type,(ccaddc : ($i > $o))).
thf(ccmul_tp,type,(ccmul : ($i > $o))).
thf(cci_tp,type,(cci : ($i > $o))).
thf(a_1re_ax,axiom,(cwcel @ cc1 @ ccr)).
thf(aicopnfcld_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwcel @ (cco @ XA2 @ ccpnf @ ccico) @ (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld))))).
thf(auncld_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ XJ @ cccld)) & (cwcel @ XB2 @ (ccfv @ XJ @ cccld))) => (cwcel @ (ccun @ XA2 @ XB2) @ (ccfv @ XJ @ cccld))))))).
thf(afveq2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))).
thf(ccmopn_tp,type,(ccmopn : ($i > $o))).
thf(atgioo2_ax,axiom,(! [XJ:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((ccfv @ (ccrn @ ccioo) @ cctg) = (cco @ XJ @ ccr @ ccrest))))).
thf(arestcldr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ XJ @ cccld)) & (cwcel @ XB2 @ (ccfv @ (cco @ XJ @ XA2 @ ccrest) @ cccld))) => (cwcel @ XB2 @ (ccfv @ XJ @ cccld))))))).
...
thf(aasindmre_ax,axiom,(! [XD:($i > $o)] : ((XD = (ccdif @ ccc @ (ccun @ (cco @ ccmnf @ (ccneg @ cc1) @ ccioc) @ (cco @ cc1 @ ccpnf @ ccico)))) => ((ccin @ XD @ ccr) = (cco @ (ccneg @ cc1) @ cc1 @ ccioo))))).
thf(aadantl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xch & Xph) => Xps)))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(aeldifi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccdif @ XB2 @ XC)) => (cwcel @ XA2 @ XB2)))))).
thf(aacoscl_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwcel @ (ccfv @ XA2 @ ccacos) @ ccc)))).
...
thf(advacos_ax,axiom,(! [XD:($i > $o)] : ((XD = (ccdif @ ccc @ (ccun @ (cco @ ccmnf @ (ccneg @ cc1) @ ccioc) @ (cco @ cc1 @ ccpnf @ ccico)))) => ((cco @ ccc @ (ccres @ ccacos @ XD) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (cco @ (ccneg @ cc1) @ (ccfv @ (cco @ cc1 @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccdiv))))))).
thf(adifssd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (Xph => (cwss @ (ccdif @ XA2 @ XB2) @ XA2)))))).
thf(cdvreacos_conj,conjecture,((cco @ ccr @ (ccres @ ccacos @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo)) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : (cco @ (ccneg @ cc1) @ cc1 @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccneg @ cc1) @ (ccfv @ (cco @ cc1 @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccdiv))))).
