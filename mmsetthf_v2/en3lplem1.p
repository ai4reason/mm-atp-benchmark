...
thf(cen3lplem1_conj,conjecture,(! [Xx3:$i] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XB2) @ (cwcel @ XB2 @ XC) @ (cwcel @ XC @ XA2)) => (((ccv @ Xx3) = XA2) => (cwne @ (ccin @ (ccv @ Xx3) @ (cctp @ XA2 @ XB2 @ XC)) @ cc0)))))))).
