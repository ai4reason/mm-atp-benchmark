...
thf(cf1oprg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) & ((cwcel @ XC @ XX) & (cwcel @ XD @ XY))) => (((cwne @ XA2 @ XC) & (cwne @ XB2 @ XD)) => (cwf1o @ (ccpr @ XA2 @ XC) @ (ccpr @ XB2 @ XD) @ (ccpr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD)))))))))))))).
