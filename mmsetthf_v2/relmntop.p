...
thf(adf_mntop_ax,axiom,(ccmntop = (ccopab @ (^ [Xn:$i] : (^ [Xj:$i] : ((cwcel @ (ccv @ Xn) @ ccn0) & (cw3a @ (cwcel @ (ccv @ Xj) @ cc2ndc) @ (cwcel @ (ccv @ Xj) @ ccha) @ (cwcel @ (ccv @ Xj) @ (cclly @ (ccec @ (ccfv @ (ccfv @ (ccv @ Xn) @ ccehl) @ cctopn) @ cchmph)))))))))).
