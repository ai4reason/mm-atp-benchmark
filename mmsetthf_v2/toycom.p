...
thf(ctoycom_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [Xc_pl:($i > ($i > $o))] : (! [XK:($i > $o)] : ((! [Xg1:$i] : ((XC @ Xg1) = (ccrab @ (^ [Xg1:$i] : ((ccfv @ (ccv @ Xg1) @ ccbs) = ccc)) @ (^ [Xg1:$i] : ccabl)))) => ((! [Xg1:$i] : ((Xc_pl @ Xg1) = (ccfv @ XK @ ccplusg))) => (! [Xg1:$i] : ((cw3a @ (cwcel @ XK @ (XC @ Xg1)) @ (cwcel @ (XA2 @ Xg1) @ ccc) @ (cwcel @ (XB2 @ Xg1) @ ccc)) => ((cco @ (XA2 @ Xg1) @ (XB2 @ Xg1) @ (Xc_pl @ Xg1)) = (cco @ (XB2 @ Xg1) @ (XA2 @ Xg1) @ (Xc_pl @ Xg1))))))))))))).
