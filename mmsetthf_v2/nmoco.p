...
thf(cnmoco_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ XS @ XU @ ccnmo)) => ((XL = (cco @ XT @ XU @ ccnmo)) => ((XM = (cco @ XS @ XT @ ccnmo)) => (((cwcel @ XF @ (cco @ XT @ XU @ ccnghm)) & (cwcel @ XG @ (cco @ XS @ XT @ ccnghm))) => (cwbr @ (ccfv @ (cccom @ XF @ XG) @ XN) @ (cco @ (ccfv @ XF @ XL) @ (ccfv @ XG @ XM) @ ccmul) @ ccle)))))))))))))).
