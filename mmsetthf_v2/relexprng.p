...
thf(arelexpnnrn_ax,axiom,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XR @ XV)) => (cwss @ (ccrn @ (cco @ XR @ XN @ ccrelexp)) @ (ccrn @ XR))))))).
...
thf(crelexprng_conj,conjecture,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XR @ XV)) => (cwss @ (ccrn @ (cco @ XR @ XN @ ccrelexp)) @ (ccun @ (ccdm @ XR) @ (ccrn @ XR)))))))).
