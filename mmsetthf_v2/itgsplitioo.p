...
thf(aiooid_ax,axiom,(! [XA2:($i > $o)] : ((cco @ XA2 @ XA2 @ ccioo) = cc0))).
thf(ccfn_tp,type,(ccfn : ($i > $o))).
thf(ccuz_tp,type,(ccuz : ($i > $o))).
thf(ccxp_tp,type,(ccxp : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aitg0_ax,axiom,(! [XA2:($i > ($i > $o))] : ((ccitg @ (^ [Xx3:$i] : cc0) @ (^ [Xx3:$i] : (XA2 @ Xx3))) = ccc0))).
...
thf(aioodisj_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & ((cwcel @ XC @ ccxr) & (cwcel @ XD @ ccxr))) & (cwbr @ XB2 @ XC @ ccle)) => ((ccin @ (cco @ XA2 @ XB2 @ ccioo) @ (cco @ XC @ XD @ ccioo)) = cc0))))))).
...
thf(aitgss3_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((Xph => (cwss @ XA2 @ XB2)) => ((Xph => (cwss @ XB2 @ ccr)) => ((Xph => ((ccfv @ (ccdif @ XB2 @ XA2) @ ccovol) = ccc0)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => (cwcel @ (XC @ Xx3) @ ccc))) => (Xph => (((cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ ccibl) <=> (cwcel @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ ccibl)) & ((ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) = (ccitg @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3))))))))))))))).
