...
thf(creuhypd_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ (XC @ Xx3))) => (cwcel @ (XB2 @ Xx3) @ (XC @ Xx3)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xx3) @ (XC @ Xx3)) @ (cwcel @ (ccv @ Xy1) @ (XC @ Xx3))) => (((ccv @ Xx3) = (XA2 @ Xx3 @ Xy1)) <=> ((ccv @ Xy1) = (XB2 @ Xx3)))))) => (! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ (XC @ Xx3))) => (cwreu @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XA2 @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (XC @ Xx3)))))))))))).
