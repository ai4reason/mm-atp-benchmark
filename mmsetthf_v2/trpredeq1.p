...
thf(apredeq1_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((XR = XS) => ((ccpred @ XA2 @ XR @ XX) = (ccpred @ XA2 @ XS @ XX)))))))).
...
thf(ctrpredeq1_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((XR = XS) => ((cctrpred @ XA2 @ XR @ XX) = (cctrpred @ XA2 @ XS @ XX)))))))).
