...
thf(cdvasinbx_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ ccc @ (ccmpt @ (^ [Xy1:$i] : ccc) @ (^ [Xy1:$i] : (cco @ XA2 @ (ccfv @ (cco @ XB2 @ (ccv @ Xy1) @ ccmul) @ ccsin) @ ccmul))) @ ccdv) = (ccmpt @ (^ [Xy1:$i] : ccc) @ (^ [Xy1:$i] : (cco @ (cco @ XA2 @ XB2 @ ccmul) @ (ccfv @ (cco @ XB2 @ (ccv @ Xy1) @ ccmul) @ cccos) @ ccmul)))))))).
