...
thf(alimenpsi_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwlim @ XA2) => ((cwcel @ XA2 @ XV) => (cwbr @ XA2 @ (ccdif @ XA2 @ (ccsn @ cc0)) @ ccen)))))).
...
thf(climensuci_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwlim @ XA2) => ((cwcel @ XA2 @ XV) => (cwbr @ XA2 @ (ccsuc @ XA2) @ ccen)))))).
