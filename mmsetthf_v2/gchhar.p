...
thf(aharwdom_ax,axiom,(! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => (cwbr @ (ccfv @ XX @ cchar) @ (ccpw @ (ccxp @ XX @ XX)) @ ccwdom))))).
...
thf(agchxpidm_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccgch) & (~ (cwcel @ XA2 @ ccfn))) => (cwbr @ (ccxp @ XA2 @ XA2) @ XA2 @ ccen)))).
...
thf(agchen2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccgch) & (~ (cwcel @ XA2 @ ccfn))) & ((cwbr @ XA2 @ XB2 @ ccsdm) & (cwbr @ XB2 @ (ccpw @ XA2) @ ccdom))) => (cwbr @ XB2 @ (ccpw @ XA2) @ ccen))))).
...
thf(cgchhar_conj,conjecture,(! [XA2:($i > $o)] : ((cw3a @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwcel @ XA2 @ ccgch) @ (cwcel @ (ccpw @ XA2) @ ccgch)) => (cwbr @ (ccfv @ XA2 @ cchar) @ (ccpw @ XA2) @ ccen)))).
