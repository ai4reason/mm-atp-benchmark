...
thf(abasellem1_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ (cco @ cc2 @ XM @ ccmul) @ cc1 @ ccaddc)) => (((cwcel @ XM @ ccn) & (cwcel @ XK @ (cco @ cc1 @ XM @ ccfz))) => (cwcel @ (cco @ (cco @ XK @ ccpi @ ccmul) @ XN @ ccdiv) @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)))))))).
thf(atanrpcl_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)) => (cwcel @ (ccfv @ XA2 @ cctan) @ ccrp)))).
...
thf(asinkpi_ax,axiom,(! [XK:($i > $o)] : ((cwcel @ XK @ ccz) => ((ccfv @ (cco @ XK @ ccpi @ ccmul) @ ccsin) = ccc0)))).
...
thf(asincosq1sgn_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)) => ((cwbr @ ccc0 @ (ccfv @ XA2 @ ccsin) @ cclt) & (cwbr @ ccc0 @ (ccfv @ XA2 @ cccos) @ cclt))))).
...
thf(aeqord2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((XA2 @ Xx3 @ Xy1) = (XB2 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XC) => ((XA2 @ Xx3 @ Xy1) = XM)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XD) => ((XA2 @ Xx3 @ Xy1) = XN)))) => ((cwss @ XS @ ccr) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XS)) => (cwcel @ (XA2 @ Xx3 @ Xy1) @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt) => (cwbr @ (XB2 @ Xy1) @ (XA2 @ Xx3 @ Xy1) @ cclt))))) => ((Xph & ((cwcel @ XC @ XS) & (cwcel @ XD @ XS))) => ((XC = XD) <=> (XM = XN)))))))))))))))))).
...
thf(aneghalfpirx_ax,axiom,(cwcel @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ ccxr)).
...
thf(ale0neg2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwbr @ ccc0 @ XA2 @ ccle) <=> (cwbr @ (ccneg @ XA2) @ ccc0 @ ccle))))).
