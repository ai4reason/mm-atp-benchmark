...
thf(afuncnvs4_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (((((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) & ((cwcel @ XC @ XV) & (cwcel @ XD @ XV))) & (cw3a @ (cw3a @ (cwne @ XA2 @ XB2) @ (cwne @ XA2 @ XC) @ (cwne @ XA2 @ XD)) @ ((cwne @ XB2 @ XC) & (cwne @ XB2 @ XD)) @ (cwne @ XC @ XD))) => (cwfun @ (cccnv @ (ccs4 @ XA2 @ XB2 @ XC @ XD)))))))))).
