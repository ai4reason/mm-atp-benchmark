...
thf(adfcoels_ax,axiom,(! [XA2:($i > $o)] : ((cccoels @ XA2) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xu)) & (cwcel @ (ccv @ Xy1) @ (ccv @ Xu)))) @ (^ [Xu:$i] : XA2)))))))).
thf(cbrcoels_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xu:$i] : (((cwcel @ XB2 @ (XV @ Xu)) & (cwcel @ XC @ (XW @ Xu))) => ((cwbr @ XB2 @ XC @ (cccoels @ XA2)) <=> (cwrex @ (^ [Xu:$i] : ((cwcel @ XB2 @ (ccv @ Xu)) & (cwcel @ XC @ (ccv @ Xu)))) @ (^ [Xu:$i] : XA2))))))))))).
