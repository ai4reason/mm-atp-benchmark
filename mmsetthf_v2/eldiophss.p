...
thf(aeldioph3b_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ XN @ ccdioph)) <=> ((cwcel @ XN @ ccn0) & (cwrex @ (^ [Xp:$i] : (XA2 = (ccab @ (^ [Xt:$i] : (cwrex @ (^ [Xu:$i] : (((ccv @ Xt) = (ccres @ (ccv @ Xu) @ (cco @ cc1 @ XN @ ccfz))) & ((ccfv @ (ccv @ Xu) @ (ccv @ Xp)) = ccc0))) @ (^ [Xu:$i] : (cco @ ccn0 @ ccn @ ccmap))))))) @ (^ [Xp:$i] : (ccfv @ ccn @ ccmzp)))))))).
