...
thf(alogimul_ax,axiom,(! [XA2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ ccre) @ ccle)) => ((ccfv @ (cco @ cci @ XA2 @ ccmul) @ cclog) = (cco @ (ccfv @ XA2 @ cclog) @ (cco @ cci @ (cco @ ccpi @ cc2 @ ccdiv) @ ccmul) @ ccaddc))))).
...
thf(alogneg2_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwbr @ ccc0 @ (ccfv @ XA2 @ ccim) @ cclt)) => ((ccfv @ (ccneg @ XA2) @ cclog) = (cco @ (ccfv @ XA2 @ cclog) @ (cco @ cci @ ccpi @ ccmul) @ ccmin))))).
...
thf(atanarg_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ (ccfv @ XA2 @ ccre) @ ccc0)) => ((ccfv @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ cctan) = (cco @ (ccfv @ XA2 @ ccim) @ (ccfv @ XA2 @ ccre) @ ccdiv))))).
thf(cccos_tp,type,(cccos : ($i > $o))).
thf(aargregt0_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwbr @ ccc0 @ (ccfv @ XA2 @ ccre) @ cclt)) => (cwcel @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))))).
...
thf(catanlogsublem_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccatan)) & (cwbr @ ccc0 @ (ccfv @ XA2 @ ccre) @ cclt)) => (cwcel @ (ccfv @ (cco @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) @ cclog) @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccmin) @ cclog) @ ccmin) @ ccim) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo))))).
