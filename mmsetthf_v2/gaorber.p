...
thf(cgaorber_conj,conjecture,(! [Xc_po:($i > $o)] : (! [Xc_sm:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xg1:$i] : ((Xc_sm @ Xx3 @ Xy1 @ Xg1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwss @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (XY @ Xg1)) & (cwrex @ (^ [Xg1:$i] : ((cco @ (ccv @ Xg1) @ (ccv @ Xx3) @ Xc_po) = (ccv @ Xy1))) @ (^ [Xg1:$i] : XX)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xg1:$i] : (XX = (ccfv @ (XG @ Xx3 @ Xy1 @ Xg1) @ ccbs))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xg1:$i] : ((cwcel @ Xc_po @ (cco @ (XG @ Xx3 @ Xy1 @ Xg1) @ (XY @ Xg1) @ ccga)) => (cwer @ (XY @ Xg1) @ (Xc_sm @ Xx3 @ Xy1 @ Xg1)))))))))))))).
