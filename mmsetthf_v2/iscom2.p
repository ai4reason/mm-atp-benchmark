...
thf(ciscom2_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xa:$i] : (! [Xb:$i] : (((cwcel @ XG @ (XA2 @ Xa @ Xb)) & (cwcel @ XH @ (XB2 @ Xa @ Xb))) => ((cwcel @ (ccop @ XG @ XH) @ cccm2) <=> (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : ((cco @ (ccv @ Xa) @ (ccv @ Xb) @ XH) = (cco @ (ccv @ Xb) @ (ccv @ Xa) @ XH))) @ (^ [Xb:$i] : (ccrn @ XG)))) @ (^ [Xa:$i] : (ccrn @ XG)))))))))))).
