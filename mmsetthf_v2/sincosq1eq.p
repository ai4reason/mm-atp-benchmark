...
thf(csincosq1eq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ ((cco @ XA2 @ XB2 @ ccaddc) = cc1)) => ((ccfv @ (cco @ XA2 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccmul) @ ccsin) = (ccfv @ (cco @ XB2 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccmul) @ cccos)))))).
