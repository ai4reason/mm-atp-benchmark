...
thf(cbj_lineq_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (cwcel @ XY @ ccc)) => ((Xph => (cwne @ XA2 @ ccc0)) => (Xph => (((cco @ (cco @ XA2 @ XX @ ccmul) @ XB2 @ ccaddc) = XY) <=> (XX = (cco @ (cco @ XY @ XB2 @ ccmin) @ XA2 @ ccdiv))))))))))))))).
