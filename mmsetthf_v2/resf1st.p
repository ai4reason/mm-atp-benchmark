...
thf(cresf1st_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XF @ XV)) => ((Xph => (cwcel @ XH @ XW)) => ((Xph => (cwfn @ XH @ (ccxp @ XS @ XS))) => (Xph => ((ccfv @ (cco @ XF @ XH @ ccresf) @ cc1st) = (ccres @ (ccfv @ XF @ cc1st) @ XS))))))))))))).
