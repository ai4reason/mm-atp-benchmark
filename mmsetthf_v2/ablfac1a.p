...
thf(aablfacrp2_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XO) @ XM @ ccdvds)) @ (^ [Xx3:$i] : XB2)))) => ((! [Xx3:$i] : ((XL @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XO) @ XN @ ccdvds)) @ (^ [Xx3:$i] : XB2)))) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => ((cco @ XM @ XN @ ccgcd) = cc1)) => ((Xph => ((ccfv @ XB2 @ cchash) = (cco @ XM @ XN @ ccmul))) => (! [Xx3:$i] : (Xph => (((ccfv @ (XK @ Xx3) @ cchash) = XM) & ((ccfv @ (XL @ Xx3) @ cchash) = XN)))))))))))))))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(aadantr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph & Xch) => Xps)))))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(asimp1d_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (cw3a @ Xps @ Xch @ Xth)) => (Xph => Xps))))))).
thf(ccgrp_tp,type,(ccgrp : ($i > $o))).
thf(aablfac1lem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XO:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((! [Xx3:$i] : (! [Xp:$i] : ((XS @ Xx3 @ Xp) = (ccmpt @ (^ [Xp:$i] : XA2) @ (^ [Xp:$i] : (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XO) @ (cco @ (ccv @ Xp) @ (cco @ (ccv @ Xp) @ (ccfv @ XB2 @ cchash) @ ccpc) @ ccexp) @ ccdvds)) @ (^ [Xx3:$i] : XB2))))))) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XB2 @ ccfn)) => ((Xph => (cwss @ XA2 @ ccprime)) => ((! [Xx3:$i] : (! [Xp:$i] : ((XM @ Xx3 @ Xp) = (cco @ XP @ (cco @ XP @ (ccfv @ XB2 @ cchash) @ ccpc) @ ccexp)))) => ((! [Xx3:$i] : (! [Xp:$i] : ((XN @ Xx3 @ Xp) = (cco @ (ccfv @ XB2 @ cchash) @ (XM @ Xx3 @ Xp) @ ccdiv)))) => (! [Xx3:$i] : (! [Xp:$i] : ((Xph & (cwcel @ XP @ XA2)) => (cw3a @ ((cwcel @ (XM @ Xx3 @ Xp) @ ccn) & (cwcel @ (XN @ Xx3 @ Xp) @ ccn)) @ ((cco @ (XM @ Xx3 @ Xp) @ (XN @ Xx3 @ Xp) @ ccgcd) = cc1) @ ((ccfv @ XB2 @ cchash) = (cco @ (XM @ Xx3 @ Xp) @ (XN @ Xx3 @ Xp) @ ccmul)))))))))))))))))))))))).
