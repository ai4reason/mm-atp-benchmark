...
thf(atendoco2_ax,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ ((cwcel @ XU @ XE) & (cwcel @ XV @ XE)) @ ((cwcel @ XF @ XT) & (cwcel @ XG @ XT))) => ((cccom @ (ccfv @ (cccom @ XF @ XG) @ XU) @ (ccfv @ (cccom @ XF @ XG) @ XV)) = (cccom @ (cccom @ (ccfv @ XF @ XU) @ (ccfv @ XF @ XV)) @ (cccom @ (ccfv @ XG @ XU) @ (ccfv @ XG @ XV)))))))))))))))))).
