...
thf(adf_cplgr_ax,axiom,(cccplgr = (ccab @ (^ [Xg1:$i] : ((ccfv @ (ccv @ Xg1) @ ccuvtx) = (ccfv @ (ccv @ Xg1) @ ccvtx)))))).
thf(ccplgruvtxb_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XG @ XW) => ((cwcel @ XG @ cccplgr) <=> ((ccfv @ XG @ ccuvtx) = XV)))))))).
