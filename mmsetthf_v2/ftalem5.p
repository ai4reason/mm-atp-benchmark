...
thf(aftalem4_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XN = (ccfv @ XF @ ccdgr)) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XF @ (ccfv @ (XS @ Xn) @ ccply)))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XN @ ccn))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwne @ (ccfv @ ccc0 @ XF) @ ccc0))) => ((XK = (ccinf @ (ccrab @ (^ [Xn:$i] : (cwne @ (ccfv @ (ccv @ Xn) @ XA2) @ ccc0)) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt)) => ((! [Xn:$i] : ((XT @ Xn) = (cco @ (ccneg @ (cco @ (ccfv @ ccc0 @ XF) @ (ccfv @ XK @ XA2) @ ccdiv)) @ (cco @ cc1 @ XK @ ccdiv) @ cccxp))) => ((! [Xk:$i] : (! [Xn:$i] : ((XU @ Xk @ Xn) = (cco @ (ccfv @ (ccfv @ ccc0 @ XF) @ ccabs) @ (cco @ (ccsu @ (cco @ (cco @ XK @ cc1 @ ccaddc) @ XN @ ccfz) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ (XT @ Xn) @ (ccv @ Xk) @ ccexp) @ ccmul) @ ccabs))) @ cc1 @ ccaddc) @ ccdiv)))) => ((! [Xk:$i] : (! [Xn:$i] : (XX = (ccif @ (cwbr @ cc1 @ (XU @ Xk @ Xn) @ ccle) @ cc1 @ (XU @ Xk @ Xn))))) => (! [Xk:$i] : (! [Xn:$i] : ((Xph @ Xn) => (((cwcel @ XK @ ccn) & (cwne @ (ccfv @ XK @ XA2) @ ccc0)) & (cw3a @ (cwcel @ (XT @ Xn) @ ccc) @ (cwcel @ (XU @ Xk @ Xn) @ ccrp) @ (cwcel @ XX @ ccrp))))))))))))))))))))))))).
