...
thf(c_1wlkdlem2_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccs2 @ XX @ XY)) => ((XF = (ccs1 @ XJ)) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwcel @ XY @ XV)) => (((Xph & (XX = XY)) => ((ccfv @ XJ @ XI) = (ccsn @ XX))) => (((Xph & (cwne @ XX @ XY)) => (cwss @ (ccpr @ XX @ XY) @ (ccfv @ XJ @ XI))) => (Xph => (cwcel @ XX @ (ccfv @ XJ @ XI)))))))))))))))))).
