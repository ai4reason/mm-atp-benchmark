...
thf(cmul2sq_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : ((! [Xw:$i] : ((XS @ Xw) = (ccrn @ (ccmpt @ (^ [Xw:$i] : ccgz) @ (^ [Xw:$i] : (cco @ (ccfv @ (ccv @ Xw) @ ccabs) @ cc2 @ ccexp)))))) => (! [Xw:$i] : (((cwcel @ (XA2 @ Xw) @ (XS @ Xw)) & (cwcel @ (XB2 @ Xw) @ (XS @ Xw))) => (cwcel @ (cco @ (XA2 @ Xw) @ (XB2 @ Xw) @ ccmul) @ (XS @ Xw))))))))).
