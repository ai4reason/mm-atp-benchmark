...
thf(asymgplusg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xg1:$i] : ((XG @ Xf1 @ Xg1) = (ccfv @ XA2 @ ccsymg)))) => ((! [Xf1:$i] : (! [Xg1:$i] : (XB2 = (ccfv @ (XG @ Xf1 @ Xg1) @ ccbs)))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((Xc_pl @ Xf1 @ Xg1) = (ccfv @ (XG @ Xf1 @ Xg1) @ ccplusg)))) => (! [Xf1:$i] : (! [Xg1:$i] : ((Xc_pl @ Xf1 @ Xg1) = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : XB2)) @ (^ [Xf1:$i] : (^ [Xg1:$i] : XB2)) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cccom @ (ccv @ Xf1) @ (ccv @ Xg1)))))))))))))))).
...
thf(agrpissubg_ax,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XS = (ccfv @ XH @ ccbs)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XH @ ccgrp)) => (((cwss @ XS @ XB2) & ((ccfv @ XH @ ccplusg) = (ccres @ (ccfv @ XG @ ccplusg) @ (ccxp @ XS @ XS)))) => (cwcel @ XS @ (ccfv @ XG @ ccsubg))))))))))).
thf(cpgrpsubgsymg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xg1:$i] : ((XG @ Xf1 @ Xg1) = (ccfv @ XA2 @ ccsymg)))) => ((! [Xf1:$i] : (! [Xg1:$i] : (XB2 = (ccfv @ (XG @ Xf1 @ Xg1) @ ccbs)))) => ((! [Xf1:$i] : (! [Xg1:$i] : (XF = (ccfv @ (XP @ Xf1 @ Xg1) @ ccbs)))) => (! [Xf1:$i] : (! [Xg1:$i] : ((cwcel @ XA2 @ (XV @ Xf1 @ Xg1)) => ((cw3a @ (cwcel @ (XP @ Xf1 @ Xg1) @ ccgrp) @ (cwss @ XF @ XB2) @ ((ccfv @ (XP @ Xf1 @ Xg1) @ ccplusg) = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : XF)) @ (^ [Xf1:$i] : (^ [Xg1:$i] : XF)) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cccom @ (ccv @ Xf1) @ (ccv @ Xg1))))))) => (cwcel @ XF @ (ccfv @ (XG @ Xf1 @ Xg1) @ ccsubg)))))))))))))))).
