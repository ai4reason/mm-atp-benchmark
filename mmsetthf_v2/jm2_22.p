...
thf(ajm2_21_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz) @ (cwcel @ XJ @ ccz)) => ((cco @ (cco @ XA2 @ (cco @ XN @ XJ @ ccmul) @ ccrmx) @ (cco @ (ccfv @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ ccsqrt) @ (cco @ XA2 @ (cco @ XN @ XJ @ ccmul) @ ccrmy) @ ccmul) @ ccaddc) = (cco @ (cco @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ (ccfv @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ ccsqrt) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul) @ ccaddc) @ XJ @ ccexp))))))).
...
thf(cjm2_22_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz) @ (cwcel @ XJ @ ccn0)) => ((cco @ XA2 @ (cco @ XN @ XJ @ ccmul) @ ccrmy) = (ccsu @ (ccrab @ (^ [Xx3:$i] : (~ (cwbr @ cc2 @ (ccv @ Xx3) @ ccdvds))) @ (^ [Xx3:$i] : (cco @ ccc0 @ XJ @ ccfz))) @ (^ [Xi:$i] : (cco @ (cco @ XJ @ (ccv @ Xi) @ ccbc) @ (cco @ (cco @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ XJ @ (ccv @ Xi) @ ccmin) @ ccexp) @ (cco @ (cco @ (cco @ XA2 @ XN @ ccrmy) @ (ccv @ Xi) @ ccexp) @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ (cco @ (cco @ (ccv @ Xi) @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ ccmul) @ ccmul) @ ccmul))))))))).
