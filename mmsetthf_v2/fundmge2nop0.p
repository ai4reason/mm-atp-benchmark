...
thf(aopwo0id_ax,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : ((ccop @ XX @ XY) = (ccdif @ (ccop @ XX @ XY) @ (ccsn @ cc0)))))).
...
thf(afunopdmsn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (ccop @ XX @ XY)) => ((cwcel @ XX @ XV) => ((cwcel @ XY @ XW) => ((cw3a @ (cwfun @ XG) @ (cwcel @ XA2 @ (ccdm @ XG)) @ (cwcel @ XB2 @ (ccdm @ XG))) => (XA2 = XB2))))))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(avex_ax,axiom,(! [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ ccvv))).
thf(aprcnel_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((~ (cwcel @ XA2 @ ccvv)) => (~ (cwcel @ XA2 @ XV)))))).
thf(cfundmge2nop0_conj,conjecture,(! [XG:($i > $o)] : (((cwfun @ (ccdif @ XG @ (ccsn @ cc0))) & (cwbr @ cc2 @ (ccfv @ (ccdm @ XG) @ cchash) @ ccle)) => (~ (cwcel @ XG @ (ccxp @ ccvv @ ccvv)))))).
