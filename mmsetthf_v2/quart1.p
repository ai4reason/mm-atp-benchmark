...
thf(abinom4_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ cc4 @ ccexp) = (cco @ (cco @ (cco @ XA2 @ cc4 @ ccexp) @ (cco @ cc4 @ (cco @ (cco @ XA2 @ cc3 @ ccexp) @ XB2 @ ccmul) @ ccmul) @ ccaddc) @ (cco @ (cco @ cc6 @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccmul) @ ccmul) @ (cco @ (cco @ cc4 @ (cco @ XA2 @ (cco @ XB2 @ cc3 @ ccexp) @ ccmul) @ ccmul) @ (cco @ XB2 @ cc4 @ ccexp) @ ccaddc) @ ccaddc) @ ccaddc)))))).
...
thf(aquart1lem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XD @ ccc)) => ((Xph => (XP = (cco @ XB2 @ (cco @ (cco @ cc3 @ cc8 @ ccdiv) @ (cco @ XA2 @ cc2 @ ccexp) @ ccmul) @ ccmin))) => ((Xph => (XQ = (cco @ (cco @ XC @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ cc2 @ ccdiv) @ ccmin) @ (cco @ (cco @ XA2 @ cc3 @ ccexp) @ cc8 @ ccdiv) @ ccaddc))) => ((Xph => (XR = (cco @ (cco @ XD @ (cco @ (cco @ XC @ XA2 @ ccmul) @ cc4 @ ccdiv) @ ccmin) @ (cco @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ XB2 @ ccmul) @ (ccdc @ cc1 @ cc6) @ ccdiv) @ (cco @ (cco @ cc3 @ (ccdc @ (ccdc @ cc2 @ cc5) @ cc6) @ ccdiv) @ (cco @ XA2 @ cc4 @ ccexp) @ ccmul) @ ccmin) @ ccaddc))) => ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (XY = (cco @ XX @ (cco @ XA2 @ cc4 @ ccdiv) @ ccaddc))) => (Xph => (XD = (cco @ (cco @ (cco @ (cco @ XA2 @ cc4 @ ccexp) @ (ccdc @ (ccdc @ cc2 @ cc5) @ cc6) @ ccdiv) @ (cco @ XP @ (cco @ (cco @ XA2 @ cc4 @ ccdiv) @ cc2 @ ccexp) @ ccmul) @ ccaddc) @ (cco @ (cco @ XQ @ (cco @ XA2 @ cc4 @ ccdiv) @ ccmul) @ XR @ ccaddc) @ ccaddc))))))))))))))))))))))).
thf(cquart1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XD @ ccc)) => ((Xph => (XP = (cco @ XB2 @ (cco @ (cco @ cc3 @ cc8 @ ccdiv) @ (cco @ XA2 @ cc2 @ ccexp) @ ccmul) @ ccmin))) => ((Xph => (XQ = (cco @ (cco @ XC @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ cc2 @ ccdiv) @ ccmin) @ (cco @ (cco @ XA2 @ cc3 @ ccexp) @ cc8 @ ccdiv) @ ccaddc))) => ((Xph => (XR = (cco @ (cco @ XD @ (cco @ (cco @ XC @ XA2 @ ccmul) @ cc4 @ ccdiv) @ ccmin) @ (cco @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ XB2 @ ccmul) @ (ccdc @ cc1 @ cc6) @ ccdiv) @ (cco @ (cco @ cc3 @ (ccdc @ (ccdc @ cc2 @ cc5) @ cc6) @ ccdiv) @ (cco @ XA2 @ cc4 @ ccexp) @ ccmul) @ ccmin) @ ccaddc))) => ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (XY = (cco @ XX @ (cco @ XA2 @ cc4 @ ccdiv) @ ccaddc))) => (Xph => ((cco @ (cco @ (cco @ XX @ cc4 @ ccexp) @ (cco @ XA2 @ (cco @ XX @ cc3 @ ccexp) @ ccmul) @ ccaddc) @ (cco @ (cco @ XB2 @ (cco @ XX @ cc2 @ ccexp) @ ccmul) @ (cco @ (cco @ XC @ XX @ ccmul) @ XD @ ccaddc) @ ccaddc) @ ccaddc) = (cco @ (cco @ (cco @ XY @ cc4 @ ccexp) @ (cco @ XP @ (cco @ XY @ cc2 @ ccexp) @ ccmul) @ ccaddc) @ (cco @ (cco @ XQ @ XY @ ccmul) @ XR @ ccaddc) @ ccaddc))))))))))))))))))))))).
