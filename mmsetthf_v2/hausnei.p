...
thf(chausnei_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xm:$i] : (! [Xn:$i] : ((XX @ Xm @ Xn) = (ccuni @ XJ)))) => (! [Xm:$i] : (! [Xn:$i] : (((cwcel @ XJ @ ccha) & (cw3a @ (cwcel @ XP @ (XX @ Xm @ Xn)) @ (cwcel @ XQ @ (XX @ Xm @ Xn)) @ (cwne @ XP @ XQ))) => (cwrex @ (^ [Xn:$i] : (cwrex @ (^ [Xm:$i] : (cw3a @ (cwcel @ XP @ (ccv @ Xn)) @ (cwcel @ XQ @ (ccv @ Xm)) @ ((ccin @ (ccv @ Xn) @ (ccv @ Xm)) = cc0))) @ (^ [Xm:$i] : XJ))) @ (^ [Xn:$i] : XJ))))))))))).
