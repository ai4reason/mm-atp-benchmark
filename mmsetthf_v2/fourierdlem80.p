...
thf(assfiunibd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xz:$i] : ((Xph & (cwcel @ (ccv @ Xz) @ (ccuni @ XA2))) => (cwcel @ (XB2 @ Xz) @ ccr))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (XB2 @ Xz) @ (ccv @ Xy1) @ ccle)) @ (^ [Xz:$i] : (ccv @ Xx3)))) @ (^ [Xy1:$i] : ccr)))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (Xph => (cwss @ (XC @ Xy1 @ Xz @ Xw) @ (ccuni @ XA2)))))) => (! [Xy1:$i] : (Xph => (cwrex @ (^ [Xw:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (XB2 @ Xz) @ (ccv @ Xw) @ ccle)) @ (^ [Xz:$i] : (XC @ Xy1 @ Xz @ Xw)))) @ (^ [Xw:$i] : ccr))))))))))))).
...
thf(arnffi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwf @ XA2 @ XB2 @ XF) & (cwcel @ XA2 @ ccfn)) => (cwcel @ (ccrn @ XF) @ ccfn)))))).
