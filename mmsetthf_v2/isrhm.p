...
thf(cisrhm_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (ccfv @ XR @ ccmgp)) => ((XN = (ccfv @ XS @ ccmgp)) => ((cwcel @ XF @ (cco @ XR @ XS @ ccrh)) <=> (((cwcel @ XR @ ccrg) & (cwcel @ XS @ ccrg)) & ((cwcel @ XF @ (cco @ XR @ XS @ ccghm)) & (cwcel @ XF @ (cco @ XM @ XN @ ccmhm))))))))))))).
