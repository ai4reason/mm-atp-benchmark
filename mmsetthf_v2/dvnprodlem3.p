...
thf(aprodeq1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((XA2 = XB2) => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))) = (ccprod @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (XC @ Xk))))))))).
...
thf(aprod0_ax,axiom,(! [XA2:($i > ($i > $o))] : ((ccprod @ (^ [Xk:$i] : cc0) @ (^ [Xk:$i] : (XA2 @ Xk))) = cc1))).
...
thf(arestsspw_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (cwss @ (cco @ XJ @ XA2 @ ccrest) @ (ccpw @ XA2))))).
...
thf(afn0_ax,axiom,(! [XF:($i > $o)] : ((cwfn @ XF @ cc0) <=> (XF = cc0)))).
...
thf(arabrsn_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [Xx3:$i] : (((XM @ Xx3) = (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccsn @ XA2)))) => (((XM @ Xx3) = cc0) | ((XM @ Xx3) = (ccsn @ XA2))))))))).
...
thf(advnmptconst_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwcel @ XX @ (cco @ (ccfv @ cccnfld @ cctopn) @ XS @ ccrest))) => ((Xph => (cwcel @ XA2 @ ccc)) => ((! [Xx3:$i] : (Xph => (cwcel @ (XN @ Xx3) @ ccn))) => (! [Xx3:$i] : (Xph => ((ccfv @ (XN @ Xx3) @ (cco @ XS @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : XA2)) @ ccdvn)) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : ccc0))))))))))))))).
