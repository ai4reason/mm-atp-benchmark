...
thf(acfil3i_ax,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XF @ (ccfv @ XD @ cccfil)) @ (cwcel @ XR @ ccrp)) => (cwrex @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ XR @ (ccfv @ XD @ ccbl)) @ XF)) @ (^ [Xx3:$i] : XX)))))))).
...
thf(afclsrest_ax,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwcel @ XY @ XF)) => ((cco @ (cco @ XJ @ XY @ ccrest) @ (cco @ XF @ XY @ ccrest) @ ccfcls) = (ccin @ (cco @ XJ @ XF @ ccfcls) @ XY)))))))).
...
thf(acfilfcls_ax,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((XX = (ccdm @ (ccdm @ XD))) => ((cwcel @ XF @ (ccfv @ XD @ cccfil)) => ((cco @ XJ @ XF @ ccfcls) = (cco @ XJ @ XF @ ccflim)))))))))).
...
thf(afclscmpi_ax,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cccmp) & (cwcel @ XF @ (ccfv @ XX @ ccfil))) => (cwne @ (cco @ XJ @ XF @ ccfcls) @ cc0))))))).
...
thf(crelcmpcmet_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((Xph => (cwcel @ XD @ (ccfv @ XX @ ccme))) => ((Xph => (cwcel @ XR @ ccrp)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (cco @ XJ @ (ccfv @ (cco @ (ccv @ Xx3) @ XR @ (ccfv @ XD @ ccbl)) @ (ccfv @ XJ @ cccl)) @ ccrest) @ cccmp))) => (Xph => (cwcel @ XD @ (ccfv @ XX @ ccms))))))))))))).
