...
thf(afprodm1s_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ XM @ XN @ ccfz))) => (cwcel @ (XA2 @ Xk) @ ccc))) => (Xph => ((ccprod @ (^ [Xk:$i] : (cco @ XM @ XN @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) = (cco @ (ccprod @ (^ [Xk:$i] : (cco @ XM @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (ccsb @ XN @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccmul)))))))))).
...
thf(cfprodeq0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XN @ XZ)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XA2 @ Xk) @ ccc))) => ((! [Xk:$i] : ((Xph & ((ccv @ Xk) = XN)) => ((XA2 @ Xk) = ccc0))) => ((Xph & (cwcel @ XK @ (ccfv @ XN @ ccuz))) => ((ccprod @ (^ [Xk:$i] : (cco @ XM @ XK @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) = ccc0))))))))))))).
