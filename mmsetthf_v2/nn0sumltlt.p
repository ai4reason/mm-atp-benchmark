...
thf(ann0resubcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn0) & (cwcel @ XB2 @ ccn0)) => (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ ccr))))).
...
thf(cnn0sumltlt_conj,conjecture,(! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((cw3a @ (cwcel @ (ccv @ Xa) @ ccn0) @ (cwcel @ (ccv @ Xb) @ ccn0) @ (cwcel @ (ccv @ Xc) @ ccn0)) => ((cwbr @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccaddc) @ (ccv @ Xc) @ cclt) => (cwbr @ (ccv @ Xb) @ (ccv @ Xc) @ cclt))))))).
