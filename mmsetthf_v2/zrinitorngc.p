...
thf(azrrnghm_ax,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XT @ ccbs)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : Xc_0)))) => (! [Xx3:$i] : (((cwcel @ XS @ ccrng) & (cwcel @ XT @ (ccdif @ ccrg @ ccnzr))) => (cwcel @ (XH @ Xx3) @ (cco @ XT @ XS @ ccrngh))))))))))))).
...
thf(arnghmghm_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (cco @ XR @ XS @ ccrngh)) => (cwcel @ XF @ (cco @ XR @ XS @ ccghm))))))).
...
thf(czrinitorngc_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XU @ XV)) => ((XC = (ccfv @ XU @ ccrngc)) => ((Xph => (cwcel @ XZ @ (ccdif @ ccrg @ ccnzr))) => ((Xph => (cwcel @ XZ @ XU)) => (Xph => (cwcel @ XZ @ (ccfv @ XC @ ccinito))))))))))))).
