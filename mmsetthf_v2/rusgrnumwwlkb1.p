...
thf(arusgrnumwwlkl1_ax,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwbr @ XG @ XK @ ccrusgr) & (cwcel @ XP @ XV)) => ((ccfv @ (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = XP)) @ (^ [Xw:$i] : (cco @ cc1 @ XG @ ccwwlksn))) @ cchash) = XK)))))))).
