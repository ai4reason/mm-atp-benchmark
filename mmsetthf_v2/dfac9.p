...
thf(adfac3_ax,axiom,(cwac <=> (! [Xx3:$i] : (? [Xf1:$i] : (cwral @ (^ [Xz:$i] : ((cwne @ (ccv @ Xz) @ cc0) => (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xf1)) @ (ccv @ Xz)))) @ (^ [Xz:$i] : (ccv @ Xx3))))))).
...
thf(cdfac9_conj,conjecture,(cwac <=> (! [Xf1:$i] : (((cwfun @ (ccv @ Xf1)) & (cwnel @ cc0 @ (ccrn @ (ccv @ Xf1)))) => (cwne @ (ccixp @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xf1))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)))) @ cc0))))).
