...
thf(casclinvg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XW @ ccascl)) => ((XR = (ccfv @ XW @ ccsca)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XI = (ccfv @ XR @ ccminusg)) => ((XJ = (ccfv @ XW @ ccminusg)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XW @ ccrg) @ (cwcel @ XC @ XB2)) => ((ccfv @ (ccfv @ XC @ XA2) @ XJ) = (ccfv @ (ccfv @ XC @ XI) @ XA2)))))))))))))))).
