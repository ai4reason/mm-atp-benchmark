...
thf(cnfrgr2v_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XY) @ (cwne @ XA2 @ XB2)) & ((ccfv @ XG @ ccvtx) = (ccpr @ XA2 @ XB2))) => (cwnel @ XG @ ccfrgr)))))))).
