...
thf(aadd20i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => (((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ ccc0 @ XB2 @ ccle)) => (((cco @ XA2 @ XB2 @ ccaddc) = ccc0) <=> ((XA2 = ccc0) & (XB2 = ccc0))))))))).
...
thf(cdscmet_conj,conjecture,(! [XD:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XD @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ ((ccv @ Xx3) = (ccv @ Xy1)) @ ccc0 @ cc1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XX @ (XV @ Xx3 @ Xy1)) => (cwcel @ (XD @ Xx3 @ Xy1) @ (ccfv @ XX @ ccme)))))))))).
