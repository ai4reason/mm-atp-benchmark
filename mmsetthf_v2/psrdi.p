...
thf(cpsrdi_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [Xc_pl:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [Xc_xp:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xf1:$i] : ((XS @ Xf1) = (cco @ XI @ XR @ ccmps))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XI @ (XV @ Xf1)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XR @ ccrg))) => ((! [Xf1:$i] : ((XD @ Xf1) = (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ XI @ ccmap))))) => ((! [Xf1:$i] : ((Xc_xp @ Xf1) = (ccfv @ (XS @ Xf1) @ ccmulr))) => ((! [Xf1:$i] : ((XB2 @ Xf1) = (ccfv @ (XS @ Xf1) @ ccbs))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XX @ (XB2 @ Xf1)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XY @ (XB2 @ Xf1)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XZ @ (XB2 @ Xf1)))) => ((! [Xf1:$i] : ((Xc_pl @ Xf1) = (ccfv @ (XS @ Xf1) @ ccplusg))) => (! [Xf1:$i] : ((Xph @ Xf1) => ((cco @ XX @ (cco @ XY @ XZ @ (Xc_pl @ Xf1)) @ (Xc_xp @ Xf1)) = (cco @ (cco @ XX @ XY @ (Xc_xp @ Xf1)) @ (cco @ XX @ XZ @ (Xc_xp @ Xf1)) @ (Xc_pl @ Xf1)))))))))))))))))))))))))))).
