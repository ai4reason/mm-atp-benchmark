...
thf(aclsval2_ax,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => ((ccfv @ XS @ (ccfv @ XJ @ cccl)) = (ccdif @ XX @ (ccfv @ (ccdif @ XX @ XS) @ (ccfv @ XJ @ ccnt)))))))))).
...
thf(abcth_ax,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccms)) @ (cwf @ ccn @ (ccfv @ XJ @ cccld) @ XM) @ (cwne @ (ccfv @ (ccuni @ (ccrn @ XM)) @ (ccfv @ XJ @ ccnt)) @ cc0)) => (cwrex @ (^ [Xk:$i] : (cwne @ (ccfv @ (ccfv @ (ccv @ Xk) @ XM) @ (ccfv @ XJ @ ccnt)) @ cc0)) @ (^ [Xk:$i] : ccn))))))))).
...
thf(aiundif2_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (ccdif @ XB2 @ (XC @ Xx3)))) = (ccdif @ XB2 @ (cciin @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3))))))))).
...
thf(cbcth3_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccms)) @ (cwf @ ccn @ XJ @ XM) @ (cwral @ (^ [Xk:$i] : ((ccfv @ (ccfv @ (ccv @ Xk) @ XM) @ (ccfv @ XJ @ cccl)) = XX)) @ (^ [Xk:$i] : ccn))) => ((ccfv @ (ccint @ (ccrn @ XM)) @ (ccfv @ XJ @ cccl)) = XX)))))))).
