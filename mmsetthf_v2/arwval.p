...
thf(adf_arw_ax,axiom,(ccarw = (ccmpt @ (^ [Xc:$i] : cccat) @ (^ [Xc:$i] : (ccuni @ (ccrn @ (ccfv @ (ccv @ Xc) @ cchoma))))))).
...
thf(carwval_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : ((XA2 = (ccfv @ XC @ ccarw)) => ((XH = (ccfv @ XC @ cchoma)) => (XA2 = (ccuni @ (ccrn @ XH))))))))).
