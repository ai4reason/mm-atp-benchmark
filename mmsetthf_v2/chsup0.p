...
thf(achsupss_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ ccch) & (cwss @ XB2 @ ccch)) => ((cwss @ XA2 @ XB2) => (cwss @ (ccfv @ XA2 @ cchsup) @ (ccfv @ XB2 @ cchsup))))))).
thf(ccuni_tp,type,(ccuni : (($i > $o) > ($i > $o)))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(ccint_tp,type,(ccint : (($i > $o) > ($i > $o)))).
thf(achsupsn_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((ccfv @ (ccsn @ XA2) @ cchsup) = XA2)))).
thf(achle0i_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwss @ XA2 @ cc0h) <=> (XA2 = cc0h))))).
thf(achsupcl_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccch) => (cwcel @ (ccfv @ XA2 @ cchsup) @ ccch)))).
