...
thf(a_2ndcsep_ax,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ cc2ndc) => (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) & ((ccfv @ (ccv @ Xx3) @ (ccfv @ XJ @ cccl)) = XX))) @ (^ [Xx3:$i] : (ccpw @ XX)))))))).
...
thf(amet2ndci_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cw3a @ (cwss @ XA2 @ XX) @ (cwbr @ XA2 @ ccom @ ccdom) @ ((ccfv @ XA2 @ (ccfv @ XJ @ cccl)) = XX))) => (cwcel @ XJ @ cc2ndc)))))))).
thf(cmet2ndc_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => ((cwcel @ XJ @ cc2ndc) <=> (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) & ((ccfv @ (ccv @ Xx3) @ (ccfv @ XJ @ cccl)) = XX))) @ (^ [Xx3:$i] : (ccpw @ XX)))))))))).
