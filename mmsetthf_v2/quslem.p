...
thf(cquslem_conj,conjecture,(! [Xph:$o] : (! [Xc_sm:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => ((XU @ Xx3) = (cco @ XR @ Xc_sm @ ccqus)))) => ((Xph => (XV = (ccfv @ XR @ ccbs))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (ccec @ (ccv @ Xx3) @ Xc_sm))))) => ((! [Xx3:$i] : (Xph => (cwcel @ Xc_sm @ (XW @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XR @ (XZ @ Xx3)))) => (! [Xx3:$i] : (Xph => (cwfo @ XV @ (ccqs @ XV @ Xc_sm) @ (XF @ Xx3)))))))))))))))))).
