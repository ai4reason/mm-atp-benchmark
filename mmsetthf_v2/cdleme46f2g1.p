...
thf(ccdleme46f2g1_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((cw3a @ (cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) @ ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le)))) @ (cw3a @ (cwne @ XP @ XQ) @ ((cwcel @ XR @ XA2) & (~ (cwbr @ XR @ XW @ Xc_le))) @ ((cwcel @ XS @ XA2) & (~ (cwbr @ XS @ XW @ Xc_le)))) @ ((cwbr @ XR @ (cco @ XP @ XQ @ Xc_or) @ Xc_le) & (~ (cwbr @ XS @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)))) => (cw3a @ (cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le))) @ ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le)))) @ (cw3a @ (cwne @ XQ @ XP) @ ((cwcel @ XR @ XA2) & (~ (cwbr @ XR @ XW @ Xc_le))) @ ((cwcel @ XS @ XA2) & (~ (cwbr @ XS @ XW @ Xc_le)))) @ ((cwbr @ XR @ (cco @ XQ @ XP @ Xc_or) @ Xc_le) & (~ (cwbr @ XS @ (cco @ XQ @ XP @ Xc_or) @ Xc_le)))))))))))))))))).
