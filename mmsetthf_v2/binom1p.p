...
thf(cbinom1p_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XN @ ccn0)) => ((cco @ (cco @ cc1 @ XA2 @ ccaddc) @ XN @ ccexp) = (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ XA2 @ (ccv @ Xk) @ ccexp) @ ccmul)))))))).
