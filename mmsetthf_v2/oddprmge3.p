...
thf(aoddprmgt2_ax,axiom,(! [XP:($i > $o)] : ((cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) => (cwbr @ cc2 @ XP @ cclt)))).
...
thf(coddprmge3_conj,conjecture,(! [XP:($i > $o)] : ((cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) => (cwcel @ XP @ (ccfv @ cc3 @ ccuz))))).
