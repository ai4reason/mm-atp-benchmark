...
thf(cdfoprab2_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : ((ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))) = (ccopab @ (^ [Xw:$i] : (^ [Xz:$i] : (? [Xx3:$i] : (? [Xy1:$i] : (((ccv @ Xw) = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) & (Xph @ Xx3 @ Xy1 @ Xz)))))))))).
