...
thf(anmfnleub_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (((cwf @ cchil @ ccc @ XT) & (cwcel @ XA2 @ ccxr)) => ((cwbr @ (ccfv @ XT @ ccnmf) @ XA2 @ ccle) <=> (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccfv @ (ccv @ Xx3) @ ccno) @ cc1 @ ccle) => (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XT) @ ccabs) @ XA2 @ ccle))) @ (^ [Xx3:$i] : cchil))))))).
thf(cnmfnleub2_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwf @ cchil @ ccc @ XT) @ ((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XT) @ ccabs) @ (cco @ XA2 @ (ccfv @ (ccv @ Xx3) @ ccno) @ ccmul) @ ccle)) @ (^ [Xx3:$i] : cchil))) => (cwbr @ (ccfv @ XT @ ccnmf) @ XA2 @ ccle))))).
