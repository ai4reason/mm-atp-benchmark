...
thf(aistotbnd3_ax,axiom,(! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XM @ (ccfv @ XX @ cctotbnd)) <=> ((cwcel @ XM @ (ccfv @ XX @ ccme)) & (cwral @ (^ [Xd:$i] : (cwrex @ (^ [Xv:$i] : ((cciun @ (^ [Xx3:$i] : (ccv @ Xv)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ (ccfv @ XM @ ccbl)))) = XX)) @ (^ [Xv:$i] : (ccin @ (ccpw @ XX) @ ccfn)))) @ (^ [Xd:$i] : ccrp))))))).
thf(c_0totbnd_conj,conjecture,(! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XX = cc0) => ((cwcel @ XM @ (ccfv @ XX @ cctotbnd)) <=> (cwcel @ XM @ (ccfv @ XX @ ccme))))))).
