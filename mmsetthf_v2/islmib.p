...
thf(adf_lmi_ax,axiom,(cclmi = (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccmpt @ (^ [Xm:$i] : (ccrn @ (ccfv @ (ccv @ Xg1) @ cclng))) @ (^ [Xm:$i] : (ccmpt @ (^ [Xa:$i] : (ccfv @ (ccv @ Xg1) @ ccbs)) @ (^ [Xa:$i] : (ccrio @ (^ [Xb:$i] : ((cwcel @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (ccfv @ (ccv @ Xg1) @ ccmid)) @ (ccv @ Xm)) & ((cwbr @ (ccv @ Xm) @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (ccfv @ (ccv @ Xg1) @ cclng)) @ (ccfv @ (ccv @ Xg1) @ ccperpg)) | ((ccv @ Xa) = (ccv @ Xb))))) @ (^ [Xb:$i] : (ccfv @ (ccv @ Xg1) @ ccbs))))))))))).
...
thf(almieu_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [Xc_mi:($i > ($i > $o))] : ((XP = (ccfv @ XG @ ccbs)) => ((! [Xb:$i] : ((Xc_mi @ Xb) = (ccfv @ XG @ ccds))) => ((! [Xb:$i] : ((XI @ Xb) = (ccfv @ XG @ ccitv))) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwbr @ XG @ cc2 @ ccstrkgld)) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XD @ (ccrn @ XL))) => ((Xph => (cwcel @ XA2 @ XP)) => (Xph => (cwreu @ (^ [Xb:$i] : ((cwcel @ (cco @ XA2 @ (ccv @ Xb) @ (ccfv @ XG @ ccmid)) @ XD) & ((cwbr @ XD @ (cco @ XA2 @ (ccv @ Xb) @ XL) @ (ccfv @ XG @ ccperpg)) | (XA2 = (ccv @ Xb))))) @ (^ [Xb:$i] : XP)))))))))))))))))))).
...
thf(cislmib_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwbr @ XG @ cc2 @ ccstrkgld)) => ((XM = (ccfv @ XD @ (ccfv @ XG @ cclmi))) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XD @ (ccrn @ XL))) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => (Xph => ((XB2 = (ccfv @ XA2 @ XM)) <=> ((cwcel @ (cco @ XA2 @ XB2 @ (ccfv @ XG @ ccmid)) @ XD) & ((cwbr @ XD @ (cco @ XA2 @ XB2 @ XL) @ (ccfv @ XG @ ccperpg)) | (XA2 = XB2)))))))))))))))))))))))))).
