...
thf(ahash2prb_ax,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XV @ XW) => (((ccfv @ XV @ cchash) = cc2) <=> (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : ((cwne @ (ccv @ Xa) @ (ccv @ Xb)) & (XV = (ccpr @ (ccv @ Xa) @ (ccv @ Xb))))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))).
...
thf(cnbgr2vtx1edg_conj,conjecture,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xv:$i] : ((XE @ Xv) = (ccfv @ XG @ ccedg))) => (! [Xv:$i] : ((((ccfv @ XV @ cchash) = cc2) & (cwcel @ XV @ (XE @ Xv))) => (cwral @ (^ [Xv:$i] : (cwral @ (^ [Xn:$i] : (cwcel @ (ccv @ Xn) @ (cco @ XG @ (ccv @ Xv) @ ccnbgr))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV)))))))))).
