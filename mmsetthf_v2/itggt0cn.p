...
thf(aitg2gt0cn_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwbr @ XX @ XY @ cclt)) => ((Xph => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XX @ XY @ ccioo))) => (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ XF) @ cclt))) => ((Xph => (cwcel @ (ccres @ XF @ (cco @ XX @ XY @ ccioo)) @ (cco @ (cco @ XX @ XY @ ccioo) @ ccc @ cccncf))) => (Xph => (cwbr @ ccc0 @ (ccfv @ XF @ ccitg2) @ cclt))))))))))).
