...
thf(arpnnen1_ax,axiom,((cwcel @ ccn @ ccvv) => ((cwcel @ ccq @ ccvv) => (cwbr @ ccr @ (cco @ ccq @ ccn @ ccmap) @ ccdom)))).
...
thf(aqnnen_ax,axiom,(cwbr @ ccq @ ccn @ ccen)).
...
thf(amapdom1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccdom) => (cwbr @ (cco @ XA2 @ XC @ ccmap) @ (cco @ XB2 @ XC @ ccmap) @ ccdom)))))).
...
thf(amapen_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccen) & (cwbr @ XC @ XD @ ccen)) => (cwbr @ (cco @ XA2 @ XC @ ccmap) @ (cco @ XB2 @ XD @ ccmap) @ ccen))))))).
thf(adomentr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccdom) & (cwbr @ XB2 @ XC @ ccen)) => (cwbr @ XA2 @ XC @ ccdom)))))).
thf(aentr4i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) => ((cwbr @ XC @ XB2 @ ccen) => (cwbr @ XA2 @ XC @ ccen))))))).
...
thf(amapxpen_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwcel @ XC @ XX)) => (cwbr @ (cco @ (cco @ XA2 @ XB2 @ ccmap) @ XC @ ccmap) @ (cco @ XA2 @ (ccxp @ XB2 @ XC) @ ccmap) @ ccen))))))))).
...
thf(arpnnen2_ax,axiom,(cwbr @ (ccpw @ ccn) @ (cco @ ccc0 @ cc1 @ ccicc) @ ccdom)).
...
thf(crpnnen_conj,conjecture,(cwbr @ ccr @ (ccpw @ ccn) @ ccen)).
