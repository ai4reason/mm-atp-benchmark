...
thf(asmadiadetlem0_ax,axiom,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [Xc_1:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xq:$i] : ((XA2 @ Xi @ Xj @ Xn @ Xq) = (cco @ (XN @ Xq) @ (XR @ Xq) @ ccmat)))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xq:$i] : ((XB2 @ Xq) = (ccfv @ (XA2 @ Xi @ Xj @ Xn @ Xq) @ ccbs)))))) => ((! [Xq:$i] : (cwcel @ (XR @ Xq) @ cccrg)) => ((! [Xq:$i] : ((Xc_0 @ Xq) = (ccfv @ (XR @ Xq) @ cc0g))) => ((! [Xq:$i] : ((Xc_1 @ Xq) = (ccfv @ (XR @ Xq) @ ccur))) => ((! [Xq:$i] : (XP = (ccfv @ (ccfv @ (XN @ Xq) @ ccsymg) @ ccbs))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xq:$i] : ((XG @ Xi @ Xj @ Xq) = (ccfv @ (XR @ Xq) @ ccmgp))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xq:$i] : ((cw3a @ (cwcel @ (XM @ Xq) @ (XB2 @ Xq)) @ (cwcel @ XK @ (XN @ Xq)) @ (cwcel @ XL @ (XN @ Xq))) => ((cwcel @ XQ @ (ccdif @ XP @ (ccrab @ (^ [Xq:$i] : ((ccfv @ XK @ (ccv @ Xq)) = XL)) @ (^ [Xq:$i] : XP)))) => ((cco @ (XG @ Xi @ Xj @ Xq) @ (ccmpt @ (^ [Xn:$i] : (XN @ Xq)) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (ccfv @ (ccv @ Xn) @ XQ) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xq))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xq))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = XK) @ (ccif @ ((ccv @ Xj) = XL) @ (Xc_1 @ Xq) @ (Xc_0 @ Xq)) @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (XM @ Xq))))))))) @ ccgsu) = (Xc_0 @ Xq))))))))))))))))))))))))))).
