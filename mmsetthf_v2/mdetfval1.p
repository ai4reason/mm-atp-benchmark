...
thf(anfimdetndef_ax,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : ((XD = (cco @ XN @ XR @ ccmdat)) => ((cwnel @ XN @ ccfn) => (XD = cc0))))))).
