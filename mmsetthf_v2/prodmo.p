...
thf(aprodmolem2_ax,axiom,(! [Xph:($i > $o)] : (! [Xx3:$i] : (! [Xz:$i] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XF @ Xy1) = (ccmpt @ (^ [Xk:$i] : ccz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xy1)) @ (XB2 @ Xy1 @ Xf1 @ Xk @ Xm @ Xn) @ cc1)))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : (((Xph @ Xy1) & (cwcel @ (ccv @ Xk) @ (XA2 @ Xy1))) => (cwcel @ (XB2 @ Xy1 @ Xf1 @ Xk @ Xm @ Xn) @ ccc))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XG @ Xy1 @ Xf1 @ Xk @ Xm @ Xn) = (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccsb @ (ccfv @ (ccv @ Xj) @ (ccv @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xy1 @ Xf1 @ Xk @ Xm @ Xn))))))))))) => (! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : (((Xph @ Xy1) & (cwrex @ (^ [Xm:$i] : (cw3a @ (cwss @ (XA2 @ Xy1) @ (ccfv @ (ccv @ Xm) @ ccuz)) @ (cwrex @ (^ [Xn:$i] : (? [Xy1:$i] : ((cwne @ (ccv @ Xy1) @ ccc0) & (cwbr @ (ccseq @ ccmul @ (XF @ Xy1) @ (ccv @ Xn)) @ (ccv @ Xy1) @ ccli)))) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xm) @ ccuz))) @ (cwbr @ (ccseq @ ccmul @ (XF @ Xy1) @ (ccv @ Xm)) @ (ccv @ Xx3) @ ccli))) @ (^ [Xm:$i] : ccz))) => ((cwrex @ (^ [Xm:$i] : (? [Xf1:$i] : ((cwf1o @ (cco @ cc1 @ (ccv @ Xm) @ ccfz) @ (XA2 @ Xy1) @ (ccv @ Xf1)) & ((ccv @ Xz) = (ccfv @ (ccv @ Xm) @ (ccseq @ ccmul @ (XG @ Xy1 @ Xf1 @ Xk @ Xm @ Xn) @ cc1)))))) @ (^ [Xm:$i] : ccn)) => ((ccv @ Xx3) = (ccv @ Xz)))))))))))))))))).
...
thf(amo4_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => ((cwmo @ (^ [Xx3:$i] : (Xph @ Xx3))) <=> (! [Xx3:$i] : (! [Xy1:$i] : (((Xph @ Xx3) & (Xps @ Xy1)) => ((ccv @ Xx3) = (ccv @ Xy1)))))))))).
...
thf(cprodmo_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((XF @ Xy1) = (ccmpt @ (^ [Xk:$i] : ccz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xy1)) @ (XB2 @ Xx3 @ Xy1 @ Xk @ Xn) @ cc1))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : (((Xph @ Xy1) & (cwcel @ (ccv @ Xk) @ (XA2 @ Xy1))) => (cwcel @ (XB2 @ Xx3 @ Xy1 @ Xk @ Xn) @ ccc)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XG @ Xy1 @ Xf1 @ Xk @ Xm @ Xn) = (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccsb @ (ccfv @ (ccv @ Xj) @ (ccv @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xx3 @ Xy1 @ Xk @ Xn)))))))))))) => (! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xph @ Xy1) => (cwmo @ (^ [Xx3:$i] : ((cwrex @ (^ [Xm:$i] : (cw3a @ (cwss @ (XA2 @ Xy1) @ (ccfv @ (ccv @ Xm) @ ccuz)) @ (cwrex @ (^ [Xn:$i] : (? [Xy1:$i] : ((cwne @ (ccv @ Xy1) @ ccc0) & (cwbr @ (ccseq @ ccmul @ (XF @ Xy1) @ (ccv @ Xn)) @ (ccv @ Xy1) @ ccli)))) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xm) @ ccuz))) @ (cwbr @ (ccseq @ ccmul @ (XF @ Xy1) @ (ccv @ Xm)) @ (ccv @ Xx3) @ ccli))) @ (^ [Xm:$i] : ccz)) | (cwrex @ (^ [Xm:$i] : (? [Xf1:$i] : ((cwf1o @ (cco @ cc1 @ (ccv @ Xm) @ ccfz) @ (XA2 @ Xy1) @ (ccv @ Xf1)) & ((ccv @ Xx3) = (ccfv @ (ccv @ Xm) @ (ccseq @ ccmul @ (XG @ Xy1 @ Xf1 @ Xk @ Xm @ Xn) @ cc1)))))) @ (^ [Xm:$i] : ccn)))))))))))))))))).
