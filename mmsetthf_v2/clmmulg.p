...
thf(aclm0vs_ax,axiom,(! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => (((cwcel @ XW @ ccclm) & (cwcel @ XX @ XV)) => ((cco @ ccc0 @ XX @ Xc_x) = Xc_0))))))))))))).
...
thf(cclmmulg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_xb = (ccfv @ XW @ ccmg)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((cw3a @ (cwcel @ XW @ ccclm) @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ XV)) => ((cco @ XA2 @ XB2 @ Xc_xb) = (cco @ XA2 @ XB2 @ Xc_x))))))))))))).
