...
thf(cclim2prod_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XN @ XZ)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((Xph => (cwbr @ (ccseq @ ccmul @ XF @ (cco @ XN @ cc1 @ ccaddc)) @ XA2 @ ccli)) => (Xph => (cwbr @ (ccseq @ ccmul @ XF @ XM) @ (cco @ (ccfv @ XN @ (ccseq @ ccmul @ XF @ XM)) @ XA2 @ ccmul) @ ccli))))))))))))).
