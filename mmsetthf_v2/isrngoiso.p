...
thf(arngoisoval_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xf1:$i] : ((XG @ Xf1) = (ccfv @ XR @ cc1st))) => ((! [Xf1:$i] : (XX = (ccrn @ (XG @ Xf1)))) => ((! [Xf1:$i] : ((XJ @ Xf1) = (ccfv @ XS @ cc1st))) => ((! [Xf1:$i] : (XY = (ccrn @ (XJ @ Xf1)))) => (((cwcel @ XR @ ccrngo) & (cwcel @ XS @ ccrngo)) => ((cco @ XR @ XS @ ccrngiso) = (ccrab @ (^ [Xf1:$i] : (cwf1o @ XX @ XY @ (ccv @ Xf1))) @ (^ [Xf1:$i] : (cco @ XR @ XS @ ccrnghom)))))))))))))))).
