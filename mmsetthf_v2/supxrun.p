...
thf(axrsupss_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => (cwrex @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt))) @ (^ [Xy1:$i] : XA2)) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ cclt) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ cclt)) @ (^ [Xz:$i] : XA2)))) @ (^ [Xy1:$i] : ccxr)))) @ (^ [Xx3:$i] : ccxr))))).
...
thf(asupxr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwss @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & ((cwral @ (^ [Xx3:$i] : (~ (cwbr @ XB2 @ (ccv @ Xx3) @ cclt))) @ (^ [Xx3:$i] : XA2)) & (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ XB2 @ cclt) => (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt)) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : ccr)))) => ((ccsup @ XA2 @ ccxr @ cclt) = XB2))))).
thf(csupxrun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwss @ XA2 @ ccxr) @ (cwss @ XB2 @ ccxr) @ (cwbr @ (ccsup @ XA2 @ ccxr @ cclt) @ (ccsup @ XB2 @ ccxr @ cclt) @ ccle)) => ((ccsup @ (ccun @ XA2 @ XB2) @ ccxr @ cclt) = (ccsup @ XB2 @ ccxr @ cclt)))))).
