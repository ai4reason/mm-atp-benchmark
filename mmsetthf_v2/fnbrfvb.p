...
thf(atz6_12c_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [Xy1:$i] : ((cweu @ (^ [Xy1:$i] : (cwbr @ XA2 @ (ccv @ Xy1) @ XF))) => (((ccfv @ XA2 @ XF) = (ccv @ Xy1)) <=> (cwbr @ XA2 @ (ccv @ Xy1) @ XF))))))).
...
thf(cfnbrfvb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XA2) & (cwcel @ XB2 @ XA2)) => (((ccfv @ XB2 @ XF) = XC) <=> (cwbr @ XB2 @ XC @ XF)))))))).
