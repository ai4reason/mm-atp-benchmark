...
thf(as5eqd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((Xph => (XA2 = XN)) => ((Xph => (XB2 = XO)) => ((Xph => (XC = XP)) => ((Xph => (XD = XQ)) => ((Xph => (XE = XR)) => (Xph => ((ccs5 @ XA2 @ XB2 @ XC @ XD @ XE) = (ccs5 @ XN @ XO @ XP @ XQ @ XR)))))))))))))))))))).
