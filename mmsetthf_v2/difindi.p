...
thf(adfin3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccin @ XA2 @ XB2) = (ccdif @ ccvv @ (ccun @ (ccdif @ ccvv @ XA2) @ (ccdif @ ccvv @ XB2))))))).
...
thf(cdifindi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccdif @ XA2 @ (ccin @ XB2 @ XC)) = (ccun @ (ccdif @ XA2 @ XB2) @ (ccdif @ XA2 @ XC))))))).
