...
thf(adf_pt_ax,axiom,(ccpt = (ccmpt @ (^ [Xf1:$i] : ccvv) @ (^ [Xf1:$i] : (ccfv @ (ccab @ (^ [Xx3:$i] : (? [Xg1:$i] : ((cw3a @ (cwfn @ (ccv @ Xg1) @ (ccdm @ (ccv @ Xf1))) @ (cwral @ (^ [Xy1:$i] : (cwcel @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)))) @ (^ [Xy1:$i] : (ccdm @ (ccv @ Xf1)))) @ (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xg1)) = (ccuni @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1))))) @ (^ [Xy1:$i] : (ccdif @ (ccdm @ (ccv @ Xf1)) @ (ccv @ Xz))))) @ (^ [Xz:$i] : ccfn))) & ((ccv @ Xx3) = (ccixp @ (^ [Xy1:$i] : (ccdm @ (ccv @ Xf1))) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ (ccv @ Xg1))))))))) @ cctg))))).
