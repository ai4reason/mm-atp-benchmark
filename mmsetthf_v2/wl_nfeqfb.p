...
thf(awl_aleq_ax,axiom,(! [Xy1:$i] : (! [Xz:$i] : ((! [Xx3:$i] : ((ccv @ Xy1) = (ccv @ Xz))) <=> (((ccv @ Xy1) = (ccv @ Xz)) & ((! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1))) <=> (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xz))))))))).
...
thf(anfnt_ax,axiom,(! [Xph:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => (cwnf @ (^ [Xx3:$i] : (~ (Xph @ Xx3))))))).
...
thf(awl_exeq_ax,axiom,(! [Xy1:$i] : (! [Xz:$i] : ((? [Xx3:$i] : ((ccv @ Xy1) = (ccv @ Xz))) <=> (cw3o @ ((ccv @ Xy1) = (ccv @ Xz)) @ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1))) @ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xz)))))))).
...
thf(apm5_21_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (((~ Xph) & (~ Xps)) => (Xph <=> Xps))))).
...
thf(anftht_ax,axiom,(! [Xph:($i > $o)] : ((! [Xx3:$i] : (Xph @ Xx3)) => (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3)))))).
thf(aex_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) => Xch) => (Xph => (Xps => Xch))))))).
thf(anfeqf_ax,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (((~ (! [Xz:$i] : ((ccv @ Xz) = (ccv @ Xx3)))) & (~ (! [Xz:$i] : ((ccv @ Xz) = (ccv @ Xy1))))) => (cwnf @ (^ [Xz:$i] : ((ccv @ Xx3) = (ccv @ Xy1)))))))).
thf(cwl_nfeqfb_conj,conjecture,(! [Xy1:$i] : (! [Xz:$i] : ((cwnf @ (^ [Xx3:$i] : ((ccv @ Xy1) = (ccv @ Xz)))) <=> ((! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1))) <=> (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xz)))))))).
