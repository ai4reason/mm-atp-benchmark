...
thf(cclimits_tp,type,(cclimits : ($i > $o))).
...
thf(aellimits_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XA2 @ cclimits) <=> (cwlim @ XA2))))).
...
thf(cdfom5b_conj,conjecture,(ccom = (ccin @ ccon0 @ (ccint @ cclimits)))).
