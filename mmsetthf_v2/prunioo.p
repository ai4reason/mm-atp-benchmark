...
thf(asnunico_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwbr @ XA2 @ XB2 @ ccle)) => ((ccun @ (cco @ XA2 @ XB2 @ ccico) @ (ccsn @ XB2)) = (cco @ XA2 @ XB2 @ ccicc)))))).
...
thf(cprunioo_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwbr @ XA2 @ XB2 @ ccle)) => ((ccun @ (cco @ XA2 @ XB2 @ ccioo) @ (ccpr @ XA2 @ XB2)) = (cco @ XA2 @ XB2 @ ccicc)))))).
