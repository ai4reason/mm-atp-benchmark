...
thf(areueubd_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (Xps @ Xx3)) => (cwcel @ (ccv @ Xx3) @ (XV @ Xx3)))) => (Xph => ((cwreu @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XV @ Xx3))) <=> (cweu @ (^ [Xx3:$i] : (Xps @ Xx3)))))))))).
...
thf(cfrgreu_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xb:$i] : ((XE @ Xb) = (ccfv @ XG @ ccedg))) => ((cwcel @ XG @ ccfrgr) => ((cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XC @ XV) @ (cwne @ XA2 @ XC)) => (cweu @ (^ [Xb:$i] : ((cwcel @ (ccpr @ XA2 @ (ccv @ Xb)) @ (XE @ Xb)) & (cwcel @ (ccpr @ (ccv @ Xb) @ XC) @ (XE @ Xb))))))))))))))).
