...
thf(abitsmod_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XM @ ccn0)) => ((ccfv @ (cco @ XN @ (cco @ cc2 @ XM @ ccexp) @ ccmo) @ ccbits) = (ccin @ (ccfv @ XN @ ccbits) @ (cco @ ccc0 @ XM @ ccfzo))))))).
thf(asylancr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (Xps => ((Xph => Xch) => (((Xps & Xch) => Xth) => (Xph => Xth))))))))).
thf(ccsu_tp,type,(ccsu : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(abitsf1o_ax,axiom,(cwf1o @ ccn0 @ (ccin @ (ccpw @ ccn0) @ ccfn) @ (ccres @ ccbits @ ccn0))).
...
thf(amoddifz_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccrp)) => (cwcel @ (cco @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccmo) @ ccmin) @ XB2 @ ccdiv) @ ccz))))).
...
thf(asadadd3_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwss @ (XA2 @ Xn) @ ccn0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwss @ (XB2 @ Xn) @ ccn0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XC @ Xm @ Xn @ Xc) = (ccseq @ (ccmpt2 @ (^ [Xc:$i] : (^ [Xm:$i] : cc2o)) @ (^ [Xc:$i] : (^ [Xm:$i] : ccn0)) @ (^ [Xc:$i] : (^ [Xm:$i] : (ccif @ (cwcad @ (cwcel @ (ccv @ Xm) @ (XA2 @ Xn)) @ (cwcel @ (ccv @ Xm) @ (XB2 @ Xn)) @ (cwcel @ cc0 @ (ccv @ Xc))) @ cc1o @ cc0)))) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ cc0 @ (cco @ (ccv @ Xn) @ cc1 @ ccmin)))) @ ccc0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwcel @ (XN @ Xm @ Xc) @ ccn0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XK @ Xm @ Xn @ Xc) = (cccnv @ (ccres @ ccbits @ ccn0)))))) => (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => ((cco @ (ccfv @ (ccin @ (cco @ (XA2 @ Xn) @ (XB2 @ Xn) @ ccsad) @ (cco @ ccc0 @ (XN @ Xm @ Xc) @ ccfzo)) @ (XK @ Xm @ Xn @ Xc)) @ (cco @ cc2 @ (XN @ Xm @ Xc) @ ccexp) @ ccmo) = (cco @ (cco @ (ccfv @ (ccin @ (XA2 @ Xn) @ (cco @ ccc0 @ (XN @ Xm @ Xc) @ ccfzo)) @ (XK @ Xm @ Xn @ Xc)) @ (ccfv @ (ccin @ (XB2 @ Xn) @ (cco @ ccc0 @ (XN @ Xm @ Xc) @ ccfzo)) @ (XK @ Xm @ Xn @ Xc)) @ ccaddc) @ (cco @ cc2 @ (XN @ Xm @ Xc) @ ccexp) @ ccmo)))))))))))))))))).
thf(asyl22anc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xph => Xps) => ((Xph => Xch) => ((Xph => Xth) => ((Xph => Xta) => ((((Xps & Xch) & (Xth & Xta)) => Xet) => (Xph => Xet))))))))))))).
thf(ann0red_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccn0)) => (Xph => (cwcel @ XA2 @ ccr)))))).
thf(asadcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ ccn0) & (cwss @ XB2 @ ccn0)) => (cwss @ (cco @ XA2 @ XB2 @ ccsad) @ ccn0))))).
...
thf(abitsfzo_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XM @ ccn0)) => ((cwcel @ XN @ (cco @ ccc0 @ (cco @ cc2 @ XM @ ccexp) @ ccfzo)) <=> (cwss @ (ccfv @ XN @ ccbits) @ (cco @ ccc0 @ XM @ ccfzo))))))).
thf(aelfzolt2_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ XM @ XN @ ccfzo)) => (cwbr @ XK @ XN @ cclt)))))).
thf(amodid_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccrp)) & ((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ XA2 @ XB2 @ cclt))) => ((cco @ XA2 @ XB2 @ ccmo) = XA2))))).
thf(csadaddlem_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XC @ Xm @ Xn @ Xc) = (ccseq @ (ccmpt2 @ (^ [Xc:$i] : (^ [Xm:$i] : cc2o)) @ (^ [Xc:$i] : (^ [Xm:$i] : ccn0)) @ (^ [Xc:$i] : (^ [Xm:$i] : (ccif @ (cwcad @ (cwcel @ (ccv @ Xm) @ (ccfv @ (XA2 @ Xn) @ ccbits)) @ (cwcel @ (ccv @ Xm) @ (ccfv @ (XB2 @ Xn) @ ccbits)) @ (cwcel @ cc0 @ (ccv @ Xc))) @ cc1o @ cc0)))) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ cc0 @ (cco @ (ccv @ Xn) @ cc1 @ ccmin)))) @ ccc0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XK @ Xm @ Xn @ Xc) = (cccnv @ (ccres @ ccbits @ ccn0)))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwcel @ (XA2 @ Xn) @ ccz))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwcel @ (XB2 @ Xn) @ ccz))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwcel @ (XN @ Xm @ Xc) @ ccn0))))) => (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => ((ccin @ (cco @ (ccfv @ (XA2 @ Xn) @ ccbits) @ (ccfv @ (XB2 @ Xn) @ ccbits) @ ccsad) @ (cco @ ccc0 @ (XN @ Xm @ Xc) @ ccfzo)) = (ccfv @ (cco @ (cco @ (XA2 @ Xn) @ (XB2 @ Xn) @ ccaddc) @ (cco @ cc2 @ (XN @ Xm @ Xc) @ ccexp) @ ccmo) @ ccbits)))))))))))))))))).
