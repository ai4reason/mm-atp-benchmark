...
thf(cltdiv23_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ ((cwcel @ XB2 @ ccr) & (cwbr @ ccc0 @ XB2 @ cclt)) @ ((cwcel @ XC @ ccr) & (cwbr @ ccc0 @ XC @ cclt))) => ((cwbr @ (cco @ XA2 @ XB2 @ ccdiv) @ XC @ cclt) <=> (cwbr @ (cco @ XA2 @ XC @ ccdiv) @ XB2 @ cclt))))))).
