...
thf(areprinfz1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XS @ ccn0)) => ((Xph => (cwss @ XA2 @ ccn)) => (Xph => ((cco @ XA2 @ XN @ (ccfv @ XS @ ccrepr)) = (cco @ (ccin @ XA2 @ (cco @ cc1 @ XN @ ccfz)) @ XN @ (ccfv @ XS @ ccrepr)))))))))))).
