...
thf(asupminfxrrnmpt_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccxr))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccsup @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ ccxr @ cclt) = (ccxne @ (ccinf @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxne @ (XB2 @ Xx3))))) @ ccxr @ cclt))))))))))).
...
thf(asupminfxr2_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XA2 @ ccxr))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccsup @ XA2 @ ccxr @ cclt) = (ccxne @ (ccinf @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccxne @ (ccv @ Xx3)) @ XA2)) @ (^ [Xx3:$i] : ccxr)) @ ccxr @ cclt))))))))).
...
thf(aelmptima_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XC @ (XV @ Xx3)) => ((cwcel @ XC @ (ccima @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XD)) <=> (cwrex @ (^ [Xx3:$i] : (XC = (XB2 @ Xx3))) @ (^ [Xx3:$i] : (ccin @ XA2 @ XD)))))))))))).
...
thf(axnegeqi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 = XB2) => ((ccxne @ XA2) = (ccxne @ XB2)))))).
...
thf(anfxneg_ax,axiom,(! [XA2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (cwnfc @ (^ [Xx3:$i] : (ccxne @ (XA2 @ Xx3))))))).
...
thf(climinfvalxr_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwf @ XA2 @ ccxr @ (XF @ Xx3)))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccfv @ (XF @ Xx3) @ cclsi) = (ccxne @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxne @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3))))) @ cclsp))))))))))))).
