...
thf(amat1dimmul_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (cco @ (ccsn @ XE) @ XR @ ccmat)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XO = (ccop @ XE @ XE)) => ((((cwcel @ XR @ ccrg) & (cwcel @ XE @ XV)) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2))) => ((cco @ (ccsn @ (ccop @ XO @ XX)) @ (ccsn @ (ccop @ XO @ XY)) @ (ccfv @ XA2 @ ccmulr)) = (ccsn @ (ccop @ XO @ (cco @ XX @ XY @ (ccfv @ XR @ ccmulr)))))))))))))))))).
