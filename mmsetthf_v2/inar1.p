...
thf(atfinds2_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:$o] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = cc0) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccsuc @ (ccv @ Xy1))) => ((Xph @ Xx3) <=> (Xth @ Xy1))))) => ((! [Xy1:$i] : (Xta => (Xps @ Xy1))) => ((! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ ccon0) => (Xta => ((Xch @ Xy1) => (Xth @ Xy1))))) => ((! [Xx3:$i] : ((cwlim @ (ccv @ Xx3)) => (Xta => ((cwral @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : (ccv @ Xx3))) => (Xph @ Xx3))))) => (! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ ccon0) => (Xta => (Xph @ Xx3)))))))))))))))).
...
thf(awinacard_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccwina) => ((ccfv @ XA2 @ cccrd) = XA2)))).
...
thf(ainfxpidm_ax,axiom,(! [XA2:($i > $o)] : ((cwbr @ ccom @ XA2 @ ccdom) => (cwbr @ (ccxp @ XA2 @ XA2) @ XA2 @ ccen)))).
thf(adomentr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccdom) & (cwbr @ XB2 @ XC @ ccen)) => (cwbr @ XA2 @ XC @ ccdom)))))).
thf(ampd_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => (Xps => Xch)) => (Xph => Xch))))))).
thf(amtord_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (~ Xch)) => ((Xph => (~ Xth)) => ((Xph => (Xps => (Xch | Xth))) => (Xph => (~ Xps)))))))))).
...
thf(acardf_ax,axiom,(cwf @ ccvv @ ccon0 @ cccrd)).
...
thf(awinainf_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccwina) => (cwss @ ccom @ XA2)))).
...
thf(cinar1_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccina) => (cwbr @ (ccfv @ XA2 @ ccr1) @ XA2 @ ccen)))).
