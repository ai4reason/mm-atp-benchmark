...
thf(aordsssuc2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cword @ XA2) & (cwcel @ XB2 @ ccon0)) => ((cwss @ XA2 @ XB2) <=> (cwcel @ XA2 @ (ccsuc @ XB2))))))).
...
thf(cordunisuc2_conj,conjecture,(! [XA2:($i > $o)] : ((cword @ XA2) => ((XA2 = (ccuni @ XA2)) <=> (cwral @ (^ [Xx3:$i] : (cwcel @ (ccsuc @ (ccv @ Xx3)) @ XA2)) @ (^ [Xx3:$i] : XA2)))))).
