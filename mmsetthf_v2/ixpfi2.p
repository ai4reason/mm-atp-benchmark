...
thf(aixpfi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (((cwcel @ XA2 @ ccfn) & (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccfn)) @ (^ [Xx3:$i] : XA2))) => (cwcel @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccfn))))).
...
thf(cixpfi2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : ((Xph => (cwcel @ XC @ ccfn)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccfn))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ XA2 @ XC))) => (cwss @ (XB2 @ Xx3) @ (ccsn @ (XD @ Xx3))))) => (Xph => (cwcel @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccfn))))))))))).
