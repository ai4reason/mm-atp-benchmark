...
thf(aax6e2nd_ax,axiom,(! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : ((~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1)))) => (? [Xx3:$i] : (? [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xu)) & ((ccv @ Xy1) = (ccv @ Xv)))))))))).
thf(ae000_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (Xph => (Xps => (Xch => ((Xph => (Xps => (Xch => Xth))) => Xth))))))))).
thf(aax6e2eq_ax,axiom,(! [Xv:$i] : (! [Xy1:$i] : (! [Xu:$i] : ((! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1))) => (((ccv @ Xu) = (ccv @ Xv)) => (? [Xx3:$i] : (? [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xu)) & ((ccv @ Xy1) = (ccv @ Xv))))))))))).
