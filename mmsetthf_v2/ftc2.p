...
thf(adveq0_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ cccncf))) => ((Xph => ((cco @ ccr @ XF @ ccdv) = (ccxp @ (cco @ XA2 @ XB2 @ ccioo) @ (ccsn @ ccc0)))) => (Xph => (XF = (ccxp @ (cco @ XA2 @ XB2 @ ccicc) @ (ccsn @ (ccfv @ XA2 @ XF)))))))))))))).
