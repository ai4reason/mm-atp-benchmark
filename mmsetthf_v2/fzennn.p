...
thf(aenref_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwbr @ XA2 @ XA2 @ ccen)))).
...
thf(aom2uz0i_ax,axiom,(! [XC:($i > $o)] : (! [XG:($i > ($i > $o))] : ((cwcel @ XC @ ccz) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc1 @ ccaddc))) @ XC) @ ccom))) => (! [Xx3:$i] : ((ccfv @ cc0 @ (XG @ Xx3)) = XC))))))).
...
thf(aom2uzsuci_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XG:($i > ($i > $o))] : ((cwcel @ XC @ ccz) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc1 @ ccaddc))) @ XC) @ ccom))) => (! [Xx3:$i] : ((cwcel @ (XA2 @ Xx3) @ ccom) => ((ccfv @ (ccsuc @ (XA2 @ Xx3)) @ (XG @ Xx3)) = (cco @ (ccfv @ (XA2 @ Xx3) @ (XG @ Xx3)) @ cc1 @ ccaddc)))))))))).
...
thf(cfzennn_conj,conjecture,(! [XG:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc1 @ ccaddc))) @ ccc0) @ ccom))) => (! [Xx3:$i] : ((cwcel @ (XN @ Xx3) @ ccn0) => (cwbr @ (cco @ cc1 @ (XN @ Xx3) @ ccfz) @ (ccfv @ (XN @ Xx3) @ (cccnv @ (XG @ Xx3))) @ ccen))))))).
