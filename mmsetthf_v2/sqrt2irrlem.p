...
thf(azesq_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccz) <=> (cwcel @ (cco @ (cco @ XN @ cc2 @ ccexp) @ cc2 @ ccdiv) @ ccz))))).
...
thf(annesq_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn) <=> (cwcel @ (cco @ (cco @ XN @ cc2 @ ccexp) @ cc2 @ ccdiv) @ ccn))))).
thf(csqrt2irrlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XB2 @ ccn)) => ((Xph => ((ccfv @ cc2 @ ccsqrt) = (cco @ XA2 @ XB2 @ ccdiv))) => (Xph => ((cwcel @ (cco @ XA2 @ cc2 @ ccdiv) @ ccz) & (cwcel @ (cco @ XB2 @ cc2 @ ccdiv) @ ccn)))))))))).
