...
thf(aiscmet3i_ax,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((cwcel @ XD @ (ccfv @ XX @ ccme)) => ((! [Xf1:$i] : (((cwcel @ (ccv @ Xf1) @ (ccfv @ XD @ ccca)) & (cwf @ ccn @ XX @ (ccv @ Xf1))) => (cwcel @ (ccv @ Xf1) @ (ccdm @ (ccfv @ XJ @ cclm))))) => (cwcel @ XD @ (ccfv @ XX @ ccms))))))))).
...
thf(chhcms_conj,conjecture,(! [XD:($i > $o)] : (! [XU:($i > $o)] : ((XU = (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((XD = (ccfv @ XU @ ccims)) => (cwcel @ XD @ (ccfv @ cchil @ ccms))))))).
