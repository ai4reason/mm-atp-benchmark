...
thf(adgraaval_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => ((ccfv @ XA2 @ ccdgraa) = (ccinf @ (ccrab @ (^ [Xd:$i] : (cwrex @ (^ [Xp:$i] : (((ccfv @ (ccv @ Xp) @ ccdgr) = (ccv @ Xd)) & ((ccfv @ XA2 @ (ccv @ Xp)) = ccc0))) @ (^ [Xp:$i] : (ccdif @ (ccfv @ ccq @ ccply) @ (ccsn @ cc0p))))) @ (^ [Xd:$i] : ccn)) @ ccr @ cclt))))).
...
thf(cdgraalem_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => ((cwcel @ (ccfv @ XA2 @ ccdgraa) @ ccn) & (cwrex @ (^ [Xp:$i] : (((ccfv @ (ccv @ Xp) @ ccdgr) = (ccfv @ XA2 @ ccdgraa)) & ((ccfv @ XA2 @ (ccv @ Xp)) = ccc0))) @ (^ [Xp:$i] : (ccdif @ (ccfv @ ccq @ ccply) @ (ccsn @ cc0p)))))))).
