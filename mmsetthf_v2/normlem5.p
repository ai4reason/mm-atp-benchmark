...
thf(anormlem4_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XS @ ccc) => ((cwcel @ XF @ cchil) => ((cwcel @ XG @ cchil) => ((XB2 = (ccneg @ (cco @ (cco @ (ccfv @ XS @ cccj) @ (cco @ XF @ XG @ ccsp) @ ccmul) @ (cco @ XS @ (cco @ XG @ XF @ ccsp) @ ccmul) @ ccaddc))) => ((XA2 = (cco @ XG @ XG @ ccsp)) => ((XC = (cco @ XF @ XF @ ccsp)) => ((cwcel @ XR @ ccr) => (((ccfv @ XS @ ccabs) = cc1) => ((cco @ (cco @ XF @ (cco @ (cco @ XS @ XR @ ccmul) @ XG @ ccsm) @ ccmv) @ (cco @ XF @ (cco @ (cco @ XS @ XR @ ccmul) @ XG @ ccsm) @ ccmv) @ ccsp) = (cco @ (cco @ (cco @ XA2 @ (cco @ XR @ cc2 @ ccexp) @ ccmul) @ (cco @ XB2 @ XR @ ccmul) @ ccaddc) @ XC @ ccaddc)))))))))))))))))).
