...
thf(aehlval_ax,axiom,(! [XE:($i > $o)] : (! [XN:($i > $o)] : ((XE = (ccfv @ XN @ ccehl)) => ((cwcel @ XN @ ccn0) => (XE = (ccfv @ (cco @ cc1 @ XN @ ccfz) @ ccrrx))))))).
...
thf(cehlbase_conj,conjecture,(! [XE:($i > $o)] : (! [XN:($i > $o)] : ((XE = (ccfv @ XN @ ccehl)) => ((cwcel @ XN @ ccn0) => ((cco @ ccr @ (cco @ cc1 @ XN @ ccfz) @ ccmap) = (ccfv @ XE @ ccbs))))))).
