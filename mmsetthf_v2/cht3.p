...
thf(achtprm_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ (cco @ XA2 @ cc1 @ ccaddc) @ ccprime)) => ((ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cccht) = (cco @ (ccfv @ XA2 @ cccht) @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cclog) @ ccaddc))))).
...
thf(acht2_ax,axiom,((ccfv @ cc2 @ cccht) = (ccfv @ cc2 @ cclog))).
thf(ccht3_conj,conjecture,((ccfv @ cc3 @ cccht) = (ccfv @ cc6 @ cclog))).
