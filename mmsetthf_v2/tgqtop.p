...
thf(aeltg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((cwcel @ XA2 @ (ccfv @ XB2 @ cctg)) <=> (cwss @ XA2 @ (ccuni @ (ccin @ XB2 @ (ccpw @ XA2)))))))))).
...
thf(ctgqtop_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctb) & (cwf1o @ XX @ XY @ XF)) => ((cco @ (ccfv @ XJ @ cctg) @ XF @ ccqtop) = (ccfv @ (cco @ XJ @ XF @ ccqtop) @ cctg))))))))).
