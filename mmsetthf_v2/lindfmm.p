...
thf(clindfmm_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XB2 = (ccfv @ XS @ ccbs)) => ((XC = (ccfv @ XT @ ccbs)) => ((cw3a @ (cwcel @ XG @ (cco @ XS @ XT @ cclmhm)) @ (cwf1 @ XB2 @ XC @ XG) @ (cwf @ XI @ XB2 @ XF)) => ((cwbr @ XF @ XS @ cclindf) <=> (cwbr @ (cccom @ XG @ XF) @ XT @ cclindf))))))))))))).
