...
thf(cint_leftdistd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwcel @ XD @ ccr)) => ((Xph => (XA2 = XB2)) => (Xph => ((cco @ (cco @ XC @ XD @ ccaddc) @ XB2 @ ccmul) = (cco @ (cco @ XC @ XA2 @ ccmul) @ (cco @ XD @ XA2 @ ccmul) @ ccaddc))))))))))))).
