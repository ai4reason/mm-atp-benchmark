...
thf(aabsimnre_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (~ (cwcel @ XA2 @ ccr))) => (Xph => (cwcel @ (ccfv @ (ccfv @ XA2 @ ccim) @ ccabs) @ ccrp))))))).
...
thf(aunfid_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwcel @ XB2 @ ccfn)) => (Xph => (cwcel @ (ccun @ XA2 @ XB2) @ ccfn)))))))).
...
thf(arpssxr_ax,axiom,(cwss @ ccrp @ ccxr)).
...
thf(aabsimlere_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => (cwbr @ (ccfv @ (ccfv @ XA2 @ ccim) @ ccabs) @ (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccabs) @ ccle)))))))).
