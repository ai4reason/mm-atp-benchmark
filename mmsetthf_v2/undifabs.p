...
thf(aundif3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccun @ XA2 @ (ccdif @ XB2 @ XC)) = (ccdif @ (ccun @ XA2 @ XB2) @ (ccdif @ XC @ XA2))))))).
...
thf(adifdif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccdif @ XA2 @ (ccdif @ XB2 @ XA2)) = XA2)))).
