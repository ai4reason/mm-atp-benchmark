...
thf(aisgrpd2_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((Xph => (XB2 = (ccfv @ XG @ ccbs))) => ((Xph => (Xc_pl = (ccfv @ XG @ ccplusg))) => ((! [Xx3:$i] : (Xph => ((Xc_0 @ Xx3) = (ccfv @ XG @ cc0g)))) => ((Xph => (cwcel @ XG @ ccmnd)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => (cwcel @ (XN @ Xx3) @ XB2))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => ((cco @ (XN @ Xx3) @ (ccv @ Xx3) @ Xc_pl) = (Xc_0 @ Xx3)))) => (Xph => (cwcel @ XG @ ccgrp))))))))))))))).
