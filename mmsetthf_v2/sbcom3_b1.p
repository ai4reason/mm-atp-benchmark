...
thf(adrsb2_b1_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xy1:$i] : ((! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1))) => ((cwsb @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ Xx3) <=> (cwsb @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ Xy1))))))).
...
thf(csbcom3_b1_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : ((cwsb @ (^ [Xy1:$i] : (cwsb @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ Xy1)) @ Xx3) <=> (cwsb @ (^ [Xy1:$i] : (cwsb @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ Xx3)) @ Xx3))))).
