...
thf(aprdsmgp_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((XM = (ccfv @ XY @ ccmgp)) => ((XZ = (cco @ XS @ (cccom @ ccmgp @ XR) @ ccprds)) => ((Xph => (cwcel @ XI @ XV)) => ((Xph => (cwcel @ XS @ XW)) => ((Xph => (cwfn @ XR @ XI)) => (Xph => (((ccfv @ XM @ ccbs) = (ccfv @ XZ @ ccbs)) & ((ccfv @ XM @ ccplusg) = (ccfv @ XZ @ ccplusg)))))))))))))))))))).
...
thf(amgpsca_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((XM = (ccfv @ XR @ ccmgp)) => ((XS = (ccfv @ XR @ ccsca)) => (XS = (ccfv @ XM @ ccsca)))))))).
