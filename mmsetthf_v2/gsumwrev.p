...
thf(cgsumwrev_conj,conjecture,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XO = (ccfv @ XM @ ccoppg)) => (((cwcel @ XM @ ccmnd) & (cwcel @ XW @ (ccword @ XB2))) => ((cco @ XO @ XW @ ccgsu) = (cco @ XM @ (ccfv @ XW @ ccreverse) @ ccgsu)))))))))).
