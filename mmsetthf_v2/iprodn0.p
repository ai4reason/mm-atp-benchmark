...
thf(ciprodn0_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : (Xph => (cwne @ (XX @ Xk) @ ccc0))) => ((! [Xk:$i] : (Xph => (cwbr @ (ccseq @ ccmul @ XF @ XM) @ (XX @ Xk) @ ccli))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XF) = (XB2 @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XB2 @ Xk) @ ccc))) => (! [Xk:$i] : (Xph => ((ccprod @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XB2 @ Xk))) = (XX @ Xk))))))))))))))))).
