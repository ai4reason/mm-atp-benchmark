...
thf(acj0_ax,axiom,((ccfv @ ccc0 @ cccj) = ccc0)).
thf(asylancl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => (Xch => (((Xps & Xch) => Xth) => (Xph => Xth))))))))).
thf(affvelrnda_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph & (cwcel @ XC @ XA2)) => (cwcel @ (ccfv @ XC @ XF) @ XB2))))))))).
thf(a_0cn_ax,axiom,(cwcel @ ccc0 @ ccc)).
thf(acj11_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => (((ccfv @ XA2 @ cccj) = (ccfv @ XB2 @ cccj)) <=> (XA2 = XB2)))))).
...
thf(adchreq_ax,axiom,(! [Xph:$o] : (! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : ((XG @ Xk) = (ccfv @ (XN @ Xk) @ ccdchr))) => ((! [Xk:$i] : (XZ = (ccfv @ (XN @ Xk) @ cczn))) => ((! [Xk:$i] : ((XD @ Xk) = (ccfv @ (XG @ Xk) @ ccbs))) => ((XU = (ccfv @ XZ @ ccui)) => ((! [Xk:$i] : (Xph => (cwcel @ XX @ (XD @ Xk)))) => ((! [Xk:$i] : (Xph => (cwcel @ XY @ (XD @ Xk)))) => (Xph => ((XX = XY) <=> (cwral @ (^ [Xk:$i] : ((ccfv @ (ccv @ Xk) @ XX) = (ccfv @ (ccv @ Xk) @ XY))) @ (^ [Xk:$i] : XU))))))))))))))))))).
thf(adchrmulcl_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XZ = (ccfv @ XN @ cczn)) => ((XD = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccplusg)) => ((Xph => (cwcel @ XX @ XD)) => ((Xph => (cwcel @ XY @ XD)) => (Xph => (cwcel @ (cco @ XX @ XY @ Xc_x) @ XD))))))))))))))))).
...
thf(cdchrinv_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XD = (ccfv @ XG @ ccbs)) => ((Xph => (cwcel @ XX @ XD)) => ((XI = (ccfv @ XG @ ccminusg)) => (Xph => ((ccfv @ XX @ XI) = (cccom @ cccj @ XX)))))))))))))).
