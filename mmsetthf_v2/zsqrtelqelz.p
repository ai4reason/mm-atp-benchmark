...
thf(asq11d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwbr @ ccc0 @ XB2 @ ccle)) => ((Xph => ((cco @ XA2 @ cc2 @ ccexp) = (cco @ XB2 @ cc2 @ ccexp))) => (Xph => (XA2 = XB2))))))))))).
...
thf(aqden1elz_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccq) => (((ccfv @ XA2 @ ccdenom) = cc1) <=> (cwcel @ XA2 @ ccz))))).
thf(adensq_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccq) => ((ccfv @ (cco @ XA2 @ cc2 @ ccexp) @ ccdenom) = (cco @ (ccfv @ XA2 @ ccdenom) @ cc2 @ ccexp))))).
thf(czsqrtelqelz_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ (ccfv @ XA2 @ ccsqrt) @ ccq)) => (cwcel @ (ccfv @ XA2 @ ccsqrt) @ ccz)))).
