...
thf(asqabs_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (((cco @ XA2 @ cc2 @ ccexp) = (cco @ XB2 @ cc2 @ ccexp)) <=> ((ccfv @ XA2 @ ccabs) = (ccfv @ XB2 @ ccabs))))))).
thf(aabs1_ax,axiom,((ccfv @ cc1 @ ccabs) = cc1)).
thf(ccoskpi_conj,conjecture,(! [XK:($i > $o)] : ((cwcel @ XK @ ccz) => ((ccfv @ (ccfv @ (cco @ XK @ ccpi @ ccmul) @ cccos) @ ccabs) = cc1)))).
