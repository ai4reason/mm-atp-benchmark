...
thf(aomoe_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (~ (cwbr @ cc2 @ XA2 @ ccdvds))) & ((cwcel @ XB2 @ ccz) & (~ (cwbr @ cc2 @ XB2 @ ccdvds)))) => (cwbr @ cc2 @ (cco @ XA2 @ XB2 @ ccmin) @ ccdvds))))).
...
thf(ajm2_22_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz) @ (cwcel @ XJ @ ccn0)) => ((cco @ XA2 @ (cco @ XN @ XJ @ ccmul) @ ccrmy) = (ccsu @ (ccrab @ (^ [Xx3:$i] : (~ (cwbr @ cc2 @ (ccv @ Xx3) @ ccdvds))) @ (^ [Xx3:$i] : (cco @ ccc0 @ XJ @ ccfz))) @ (^ [Xi:$i] : (cco @ (cco @ XJ @ (ccv @ Xi) @ ccbc) @ (cco @ (cco @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ XJ @ (ccv @ Xi) @ ccmin) @ ccexp) @ (cco @ (cco @ (cco @ XA2 @ XN @ ccrmy) @ (ccv @ Xi) @ ccexp) @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ (cco @ (cco @ (ccv @ Xi) @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ ccmul) @ ccmul) @ ccmul))))))))).
...
thf(armspecpos_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) => (cwcel @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ ccrp)))).
...
thf(abcn1_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cco @ XN @ cc1 @ ccbc) = XN)))).
...
thf(cjm2_23_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccz) @ (cwcel @ XJ @ ccn)) => (cwbr @ (cco @ (cco @ XA2 @ XN @ ccrmy) @ cc3 @ ccexp) @ (cco @ (cco @ XA2 @ (cco @ XN @ XJ @ ccmul) @ ccrmy) @ (cco @ XJ @ (cco @ (cco @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ XJ @ cc1 @ ccmin) @ ccexp) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul) @ ccmul) @ ccmin) @ ccdvds)))))).
