...
thf(cbcxmas_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XM @ ccn0)) => ((cco @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XM @ ccaddc) @ XM @ ccbc) = (ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xj:$i] : (cco @ (cco @ XN @ (ccv @ Xj) @ ccaddc) @ (ccv @ Xj) @ ccbc)))))))).
