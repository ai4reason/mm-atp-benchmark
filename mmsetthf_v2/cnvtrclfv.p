...
thf(acnviun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cccnv @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cccnv @ (XB2 @ Xx3)))))))).
thf(ccxp_tp,type,(ccxp : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(acnvexg_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwcel @ (cccnv @ XA2) @ ccvv))))).
thf(ccnvtrclfv_conj,conjecture,(! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XR @ XV) => ((cccnv @ (ccfv @ XR @ cctcl)) = (ccfv @ (cccnv @ XR) @ cctcl)))))).
