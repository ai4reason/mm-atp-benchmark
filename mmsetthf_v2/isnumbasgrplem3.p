...
thf(aisnumbasgrplem1_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => (((cwcel @ XR @ ccabl) & (cwbr @ XC @ XB2 @ ccen)) => (cwcel @ XC @ (ccima @ ccbs @ ccabl)))))))).
...
thf(afrlmpwfi_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((XR = (ccfv @ cc2 @ cczn)) => ((XY = (cco @ XR @ XI @ ccfrlm)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((cwcel @ XI @ XV) => (cwbr @ XB2 @ (ccin @ (ccpw @ XI) @ ccfn) @ ccen))))))))))).
thf(asimpll_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) & Xch) => Xph))))).
thf(aadantlr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => (((Xph & Xth) & Xps) => Xch))))))).
thf(ccsdm_tp,type,(ccsdm : ($i > $o))).
thf(anuminfctb_ax,axiom,(! [XS:($i > $o)] : (((cwcel @ XS @ (ccdm @ cccrd)) & (~ (cwcel @ XS @ ccfn))) => (cwbr @ ccom @ XS @ ccdom)))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(cciun_tp,type,(cciun : (($i > ($i > $o)) > (($i > ($i > $o)) > ($i > $o))))).
thf(ainfpwfien_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwbr @ ccom @ XA2 @ ccdom)) => (cwbr @ (ccin @ (ccpw @ XA2) @ ccfn) @ XA2 @ ccen)))).
thf(cwer_tp,type,(cwer : (($i > $o) > (($i > $o) > $o)))).
thf(aentr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccen) & (cwbr @ XB2 @ XC @ ccen)) => (cwbr @ XA2 @ XC @ ccen)))))).
thf(cisnumbasgrplem3_conj,conjecture,(! [XS:($i > $o)] : (((cwcel @ XS @ (ccdm @ cccrd)) & (cwne @ XS @ cc0)) => (cwcel @ XS @ (ccima @ ccbs @ ccabl))))).
