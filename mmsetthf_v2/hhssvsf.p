...
thf(chhssvsf_conj,conjecture,(! [XH:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccop @ (ccop @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ (ccres @ ccsm @ (ccxp @ ccc @ XH))) @ (ccres @ ccno @ XH))) => ((cwcel @ XH @ ccsh) => (cwf @ (ccxp @ XH @ XH) @ XH @ (ccres @ ccmv @ (ccxp @ XH @ XH)))))))).
