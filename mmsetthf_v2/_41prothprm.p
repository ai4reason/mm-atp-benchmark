...
thf(a_41prothprmlem2_ax,axiom,(! [XP:($i > $o)] : ((XP = (ccdc @ cc4 @ cc1)) => ((cco @ (cco @ cc3 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ XP @ ccmo) = (cco @ (ccneg @ cc1) @ XP @ ccmo))))).
...
thf(aproththd_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((! [Xx3:$i] : (Xph => (cwcel @ (XK @ Xx3) @ ccn))) => ((! [Xx3:$i] : (Xph => (XP = (cco @ (cco @ (XK @ Xx3) @ (cco @ cc2 @ XN @ ccexp) @ ccmul) @ cc1 @ ccaddc)))) => ((! [Xx3:$i] : (Xph => (cwbr @ (XK @ Xx3) @ (cco @ cc2 @ XN @ ccexp) @ cclt))) => ((Xph => (cwrex @ (^ [Xx3:$i] : ((cco @ (cco @ (ccv @ Xx3) @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ XP @ ccmo) = (cco @ (ccneg @ cc1) @ XP @ ccmo))) @ (^ [Xx3:$i] : ccz))) => (Xph => (cwcel @ XP @ ccprime)))))))))))).
...
thf(a_5lt8_ax,axiom,(cwbr @ cc5 @ cc8 @ cclt)).
...
thf(c_41prothprm_conj,conjecture,(! [XP:($i > $o)] : ((XP = (ccdc @ cc4 @ cc1)) => ((XP = (cco @ (cco @ cc5 @ (cco @ cc2 @ cc3 @ ccexp) @ ccmul) @ cc1 @ ccaddc)) & (cwcel @ XP @ ccprime))))).
