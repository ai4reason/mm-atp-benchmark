...
thf(cetransclem9_conj,conjecture,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XK @ ccz)) => ((Xph => (cwne @ XK @ ccc0)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XN @ ccz)) => ((Xph => (~ (cwbr @ XK @ XM @ ccdvds))) => ((Xph => (cwbr @ XK @ XN @ ccdvds)) => (Xph => (cwne @ (cco @ XM @ XN @ ccaddc) @ ccc0))))))))))))).
