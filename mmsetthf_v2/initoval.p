...
thf(cinitoval_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > $o))))] : ((! [Xh:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xh @ Xa @ Xb) => (cwcel @ XC @ cccat))))) => ((! [Xh:$i] : ((XB2 @ Xh) = (ccfv @ XC @ ccbs))) => ((! [Xh:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XH @ Xh @ Xa @ Xb) = (ccfv @ XC @ cchom))))) => (! [Xh:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xh @ Xa @ Xb) => ((ccfv @ XC @ ccinito) = (ccrab @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cweu @ (^ [Xh:$i] : (cwcel @ (ccv @ Xh) @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (XH @ Xh @ Xa @ Xb)))))) @ (^ [Xb:$i] : (XB2 @ Xh)))) @ (^ [Xa:$i] : (XB2 @ Xh)))))))))))))))).
