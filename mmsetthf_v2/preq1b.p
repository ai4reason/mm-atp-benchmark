...
thf(aoplem1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => (Xps | Xch)) => ((Xph => (Xth | Xta)) => ((Xps <=> Xth) => ((Xch => (Xth <=> Xta)) => (Xph => Xps))))))))))).
...
thf(cpreq1b_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => (Xph => (((ccpr @ XA2 @ XC) = (ccpr @ XB2 @ XC)) <=> (XA2 = XB2)))))))))))).
