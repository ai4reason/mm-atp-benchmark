...
thf(afisup2g_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (((cwor @ XA2 @ XR) & (cw3a @ (cwcel @ XB2 @ ccfn) @ (cwne @ XB2 @ cc0) @ (cwss @ XB2 @ XA2))) => (cwrex @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR))) @ (^ [Xy1:$i] : XB2)) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ XR)) @ (^ [Xz:$i] : XB2)))) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : XB2))))))).
...
thf(cssnn0ssfz_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccin @ (ccpw @ ccn0) @ ccfn)) => (cwrex @ (^ [Xn:$i] : (cwss @ XA2 @ (cco @ ccc0 @ (ccv @ Xn) @ ccfz))) @ (^ [Xn:$i] : ccn0))))).
