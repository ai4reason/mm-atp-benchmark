...
thf(cmat1dimbas_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (cco @ (ccsn @ XE) @ XR @ ccmat)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XO = (ccop @ XE @ XE)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XE @ XV) @ (cwcel @ XX @ XB2)) => (cwcel @ (ccsn @ (ccop @ XO @ XX)) @ (ccfv @ XA2 @ ccbs)))))))))))))).
