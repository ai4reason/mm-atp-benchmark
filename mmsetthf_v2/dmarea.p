...
thf(cdmarea_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccarea)) <=> (cw3a @ (cwss @ XA2 @ (ccxp @ ccr @ ccr)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccima @ XA2 @ (ccsn @ (ccv @ Xx3))) @ (ccima @ (cccnv @ ccvol) @ ccr))) @ (^ [Xx3:$i] : ccr)) @ (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (ccima @ XA2 @ (ccsn @ (ccv @ Xx3))) @ ccvol))) @ ccibl))))).
