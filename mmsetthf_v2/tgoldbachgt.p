...
thf(atgoldbachgtd_ax,axiom,(! [Xph:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccrab @ (^ [Xz:$i] : (~ (cwbr @ cc2 @ (ccv @ Xz) @ ccdvds))) @ (^ [Xz:$i] : ccz))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XN @ XO))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwbr @ (cco @ (ccdc @ cc1 @ ccc0) @ (ccdc @ cc2 @ cc7) @ ccexp) @ XN @ ccle))) => (! [Xz:$i] : ((Xph @ Xz) => (cwbr @ ccc0 @ (ccfv @ (cco @ (ccin @ XO @ ccprime) @ XN @ (ccfv @ cc3 @ ccrepr)) @ cchash) @ cclt)))))))))).
...
thf(ctgoldbachgt_conj,conjecture,(! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XO:($i > ($i > $o))] : ((! [Xn:$i] : ((XO @ Xn) = (ccrab @ (^ [Xz:$i] : (~ (cwbr @ cc2 @ (ccv @ Xz) @ ccdvds))) @ (^ [Xz:$i] : ccz)))) => ((! [Xz:$i] : (! [Xn:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((XG @ Xz @ Xn @ Xr @ Xq @ Xp) = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : ((cw3a @ (cwcel @ (ccv @ Xp) @ (XO @ Xn)) @ (cwcel @ (ccv @ Xq) @ (XO @ Xn)) @ (cwcel @ (ccv @ Xr) @ (XO @ Xn))) & ((ccv @ Xz) = (cco @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccaddc) @ (ccv @ Xr) @ ccaddc)))) @ (^ [Xr:$i] : ccprime))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime))) @ (^ [Xz:$i] : (XO @ Xn))))))))) => (! [Xz:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : (cwrex @ (^ [Xm:$i] : ((cwbr @ (ccv @ Xm) @ (cco @ (ccdc @ cc1 @ ccc0) @ (ccdc @ cc2 @ cc7) @ ccexp) @ ccle) & (cwral @ (^ [Xn:$i] : ((cwbr @ (ccv @ Xm) @ (ccv @ Xn) @ cclt) => (cwcel @ (ccv @ Xn) @ (XG @ Xz @ Xn @ Xr @ Xq @ Xp)))) @ (^ [Xn:$i] : (XO @ Xn))))) @ (^ [Xm:$i] : ccn))))))))))).
