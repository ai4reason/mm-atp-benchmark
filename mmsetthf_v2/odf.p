...
thf(codf_conj,conjecture,(! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => (cwf @ XX @ ccn0 @ XO))))))).
