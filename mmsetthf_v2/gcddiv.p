...
thf(cgcddiv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccn)) & ((cwbr @ XC @ XA2 @ ccdvds) & (cwbr @ XC @ XB2 @ ccdvds))) => ((cco @ (cco @ XA2 @ XB2 @ ccgcd) @ XC @ ccdiv) = (cco @ (cco @ XA2 @ XC @ ccdiv) @ (cco @ XB2 @ XC @ ccdiv) @ ccgcd))))))).
