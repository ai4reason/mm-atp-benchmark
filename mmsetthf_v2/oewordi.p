...
thf(aoeword_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ (ccdif @ ccon0 @ cc2o))) => ((cwss @ XA2 @ XB2) <=> (cwss @ (cco @ XC @ XA2 @ ccoe) @ (cco @ XC @ XB2 @ ccoe)))))))).
...
thf(coewordi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) & (cwcel @ cc0 @ XC)) => ((cwss @ XA2 @ XB2) => (cwss @ (cco @ XC @ XA2 @ ccoe) @ (cco @ XC @ XB2 @ ccoe)))))))).
