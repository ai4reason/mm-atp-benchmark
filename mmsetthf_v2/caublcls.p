...
thf(almcls_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwbr @ XF @ XP @ (ccfv @ XJ @ cclm))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ XS))) => ((Xph => (cwss @ XS @ XX)) => (Xph => (cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cccl))))))))))))))))))).
...
thf(ccaublcls_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XD @ (ccfv @ XX @ ccxmt)))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwf @ ccn @ (ccxp @ XX @ ccrp) @ XF))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwral @ (^ [Xn:$i] : (cwss @ (ccfv @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF) @ (ccfv @ XD @ ccbl)) @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ XD @ ccbl)))) @ (^ [Xn:$i] : ccn)))) => ((! [Xn:$i] : ((XJ @ Xn) = (ccfv @ XD @ ccmopn))) => (! [Xn:$i] : ((cw3a @ (Xph @ Xn) @ (cwbr @ (cccom @ cc1st @ XF) @ (XP @ Xn) @ (ccfv @ (XJ @ Xn) @ cclm)) @ (cwcel @ (XA2 @ Xn) @ ccn)) => (cwcel @ (XP @ Xn) @ (ccfv @ (ccfv @ (ccfv @ (XA2 @ Xn) @ XF) @ (ccfv @ XD @ ccbl)) @ (ccfv @ (XJ @ Xn) @ cccl))))))))))))))))).
