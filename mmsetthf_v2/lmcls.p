...
thf(clmcls_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwbr @ XF @ XP @ (ccfv @ XJ @ cclm))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ XS))) => ((Xph => (cwss @ XS @ XX)) => (Xph => (cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cccl))))))))))))))))))).
