...
thf(cfta1_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((XR = (ccima @ (cccnv @ XF) @ (ccsn @ ccc0))) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwne @ XF @ cc0p)) => ((cwcel @ XR @ ccfn) & (cwbr @ (ccfv @ XR @ cchash) @ (ccfv @ XF @ ccdgr) @ ccle)))))))).
