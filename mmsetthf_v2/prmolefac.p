...
thf(aifeqor_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((ccif @ Xph @ XA2 @ XB2) = XA2) | ((ccif @ Xph @ XA2 @ XB2) = XB2)))))).
...
thf(cprmolefac_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => (cwbr @ (ccfv @ XN @ ccprmo) @ (ccfv @ XN @ ccfa) @ ccle)))).
