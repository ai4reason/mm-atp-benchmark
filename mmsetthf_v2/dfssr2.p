...
thf(abrvdif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwbr @ XA2 @ XB2 @ (ccdif @ ccvv @ XR)) <=> (~ (cwbr @ XA2 @ XB2 @ XR))))))).
thf(adfss6_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ XB2) <=> (~ (? [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) & (~ (cwcel @ (ccv @ Xx3) @ XB2))))))))).
...
thf(arnxrn_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((ccrn @ (ccxrn @ XR @ XS)) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (? [Xu:$i] : ((cwbr @ (ccv @ Xu) @ (ccv @ Xx3) @ XR) & (cwbr @ (ccv @ Xu) @ (ccv @ Xy1) @ XS)))))))))).
thf(cwrel_tp,type,(cwrel : (($i > $o) > $o))).
thf(avvdifopab_ax,axiom,(! [Xph:($i > ($i > $o))] : ((ccdif @ (ccxp @ ccvv @ ccvv) @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (~ (Xph @ Xx3 @ Xy1)))))))).
thf(adf_ssr_ax,axiom,(ccssr = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))))))).
thf(cdfssr2_conj,conjecture,(ccssr = (ccdif @ (ccxp @ ccvv @ ccvv) @ (ccrn @ (ccxrn @ ccep @ (ccdif @ ccvv @ ccep)))))).
