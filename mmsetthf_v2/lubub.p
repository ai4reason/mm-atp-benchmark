...
thf(clubub_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XU = (ccfv @ XK @ cclub)) => ((cw3a @ (cwcel @ XK @ cccla) @ (cwss @ XS @ XB2) @ (cwcel @ XX @ XS)) => (cwbr @ XX @ (ccfv @ XS @ XU) @ Xc_le)))))))))))).
