...
thf(abernneq_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XN @ ccn0) @ (cwbr @ (ccneg @ cc1) @ XA2 @ ccle)) => (cwbr @ (cco @ cc1 @ (cco @ XA2 @ XN @ ccmul) @ ccaddc) @ (cco @ (cco @ cc1 @ XA2 @ ccaddc) @ XN @ ccexp) @ ccle))))).
...
thf(alediv12a_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ XA2 @ XB2 @ ccle))) & (((cwcel @ XC @ ccr) & (cwcel @ XD @ ccr)) & ((cwbr @ ccc0 @ XC @ cclt) & (cwbr @ XC @ XD @ ccle)))) => (cwbr @ (cco @ XA2 @ XD @ ccdiv) @ (cco @ XB2 @ XC @ ccdiv) @ ccle))))))).
thf(cstoweidlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XK @ ccn)) => ((Xph => (cwcel @ XD @ ccrp)) => ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwbr @ XA2 @ cc1 @ ccle)) => ((Xph => (cwbr @ XD @ XA2 @ ccle)) => (Xph => (cwbr @ (cco @ (cco @ cc1 @ (cco @ XA2 @ XN @ ccexp) @ ccmin) @ (cco @ XK @ XN @ ccexp) @ ccexp) @ (cco @ cc1 @ (cco @ (cco @ XK @ XD @ ccmul) @ XN @ ccexp) @ ccdiv) @ ccle))))))))))))))).
