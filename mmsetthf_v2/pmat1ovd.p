...
thf(cpmat1ovd_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XC = (cco @ XN @ XP @ ccmat)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((Xc_1 = (ccfv @ XP @ ccur)) => ((Xph => (cwcel @ XN @ ccfn)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XI @ XN)) => ((Xph => (cwcel @ XJ @ XN)) => ((XU = (ccfv @ XC @ ccur)) => (Xph => ((cco @ XI @ XJ @ XU) = (ccif @ (XI = XJ) @ Xc_1 @ Xc_0))))))))))))))))))))))).
