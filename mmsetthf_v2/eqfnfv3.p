...
thf(ceqfnfv3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfn @ XF @ XA2) & (cwfn @ XG @ XB2)) => ((XF = XG) <=> ((cwss @ XB2 @ XA2) & (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XB2) & ((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xx3) @ XG)))) @ (^ [Xx3:$i] : XA2)))))))))).
