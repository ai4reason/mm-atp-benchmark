...
thf(apttoponconst_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ (ccxp @ XA2 @ (ccsn @ XR)) @ ccpt)) => (((cwcel @ XA2 @ XV) & (cwcel @ XR @ (ccfv @ XX @ cctopon))) => (cwcel @ XJ @ (ccfv @ (cco @ XX @ XA2 @ ccmap) @ cctopon)))))))))).
...
thf(aelioo5_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo)) <=> ((cwbr @ XA2 @ XC @ cclt) & (cwbr @ XC @ XB2 @ cclt)))))))).
...
thf(aptpjcn_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (XY = (ccuni @ (XJ @ Xx3)))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ XF @ ccpt))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XA2 @ XV) @ (cwf @ XA2 @ cctop @ XF) @ (cwcel @ XI @ XA2)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XY) @ (^ [Xx3:$i] : (ccfv @ XI @ (ccv @ Xx3)))) @ (cco @ (XJ @ Xx3) @ (ccfv @ XI @ XF) @ cccn))))))))))))).
...
thf(aiscnp_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XK @ (ccfv @ XY @ cctopon)) @ (cwcel @ XP @ XX)) => ((cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) <=> ((cwf @ XX @ XY @ XF) & (cwral @ (^ [Xy1:$i] : ((cwcel @ (ccfv @ XP @ XF) @ (ccv @ Xy1)) => (cwrex @ (^ [Xx3:$i] : ((cwcel @ XP @ (ccv @ Xx3)) & (cwss @ (ccima @ XF @ (ccv @ Xx3)) @ (ccv @ Xy1)))) @ (^ [Xx3:$i] : XJ)))) @ (^ [Xy1:$i] : XK)))))))))))).
...
thf(aabsnid_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ XA2 @ ccc0 @ ccle)) => ((ccfv @ XA2 @ ccabs) = (ccneg @ XA2))))).
...
thf(arexpr_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> Xps))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XB2) => ((Xph @ Xx3) <=> Xch))) => ((cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccpr @ XA2 @ XB2))) <=> (Xps | Xch)))))))))))).
...
thf(afconstfv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ (ccsn @ XB2) @ XF) <=> ((cwfn @ XF @ XA2) & (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) = XB2)) @ (^ [Xx3:$i] : XA2)))))))).
thf(afconst2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwf @ XA2 @ (ccsn @ XB2) @ XF) <=> (XF = (ccxp @ XA2 @ (ccsn @ XB2))))))))).
thf(cpoimir_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((XI = (cco @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) => ((XR = (ccfv @ (ccxp @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (ccfv @ (ccrn @ ccioo) @ cctg))) @ ccpt)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XR @ XI @ ccrest) @ XR @ cccn))) => ((! [Xz:$i] : (! [Xn:$i] : ((Xph & (cw3a @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz)) @ (cwcel @ (ccv @ Xz) @ XI) @ ((ccfv @ (ccv @ Xn) @ (ccv @ Xz)) = ccc0))) => (cwbr @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xz) @ XF)) @ ccc0 @ ccle)))) => ((! [Xz:$i] : (! [Xn:$i] : ((Xph & (cw3a @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz)) @ (cwcel @ (ccv @ Xz) @ XI) @ ((ccfv @ (ccv @ Xn) @ (ccv @ Xz)) = cc1))) => (cwbr @ ccc0 @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xz) @ XF)) @ ccle)))) => (Xph => (cwrex @ (^ [Xc:$i] : ((ccfv @ (ccv @ Xc) @ XF) = (ccxp @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ ccc0)))) @ (^ [Xc:$i] : XI))))))))))))))).
