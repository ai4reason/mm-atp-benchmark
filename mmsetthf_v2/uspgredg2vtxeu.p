...
thf(cuspgredg2vtxeu_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XG @ ccuspgr) @ (cwcel @ XE @ (ccfv @ XG @ ccedg)) @ (cwcel @ XY @ XE)) => (cwreu @ (^ [Xy1:$i] : (XE = (ccpr @ XY @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccfv @ XG @ ccvtx)))))))).
