...
thf(atgldim0cgr_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => ((ccfv @ XP @ cchash) = cc1)) => ((Xph => (cwcel @ XD @ XP)) => (Xph => ((cco @ XA2 @ XB2 @ Xc_mi) = (cco @ XC @ XD @ Xc_mi)))))))))))))))))))))).
...
thf(aaxtg5seg_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XX @ XP)) => ((Xph => (cwcel @ XY @ XP)) => ((Xph => (cwcel @ XZ @ XP)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XU @ XP)) => ((Xph => (cwcel @ XV @ XP)) => ((Xph => (cwne @ XX @ XY)) => ((Xph => (cwcel @ XY @ (cco @ XX @ XZ @ XI))) => ((Xph => (cwcel @ XB2 @ (cco @ XA2 @ XC @ XI))) => ((Xph => ((cco @ XX @ XY @ Xc_mi) = (cco @ XA2 @ XB2 @ Xc_mi))) => ((Xph => ((cco @ XY @ XZ @ Xc_mi) = (cco @ XB2 @ XC @ Xc_mi))) => ((Xph => ((cco @ XX @ XU @ Xc_mi) = (cco @ XA2 @ XV @ Xc_mi))) => ((Xph => ((cco @ XY @ XU @ Xc_mi) = (cco @ XB2 @ XV @ Xc_mi))) => (Xph => ((cco @ XZ @ XU @ Xc_mi) = (cco @ XC @ XV @ Xc_mi)))))))))))))))))))))))))))))))))))).
...
thf(atgbtwnexch3_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XD @ XP)) => ((Xph => (cwcel @ XB2 @ (cco @ XA2 @ XC @ XI))) => ((Xph => (cwcel @ XC @ (cco @ XA2 @ XD @ XI))) => (Xph => (cwcel @ XC @ (cco @ XB2 @ XD @ XI))))))))))))))))))))))).
...
thf(atgldimor_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((XP = (ccfv @ XF @ XE)) => ((Xph => (cwcel @ XA2 @ XP)) => (Xph => (((ccfv @ XP @ cchash) = cc1) | (cwbr @ cc2 @ (ccfv @ XP @ cchash) @ ccle))))))))))).
thf(ctgifscgr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XD @ XP)) => ((Xph => (cwcel @ XE @ XP)) => ((Xph => (cwcel @ XF @ XP)) => ((Xph => (cwcel @ XK @ XP)) => ((Xph => (cwcel @ XH @ XP)) => ((Xph => (cwcel @ XB2 @ (cco @ XA2 @ XC @ XI))) => ((Xph => (cwcel @ XF @ (cco @ XE @ XK @ XI))) => ((Xph => ((cco @ XA2 @ XC @ Xc_mi) = (cco @ XE @ XK @ Xc_mi))) => ((Xph => ((cco @ XB2 @ XC @ Xc_mi) = (cco @ XF @ XK @ Xc_mi))) => ((Xph => ((cco @ XA2 @ XD @ Xc_mi) = (cco @ XE @ XH @ Xc_mi))) => ((Xph => ((cco @ XC @ XD @ Xc_mi) = (cco @ XK @ XH @ Xc_mi))) => (Xph => ((cco @ XB2 @ XD @ Xc_mi) = (cco @ XF @ XH @ Xc_mi))))))))))))))))))))))))))))))))))).
