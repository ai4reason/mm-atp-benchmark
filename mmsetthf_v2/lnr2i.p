...
thf(clnr2i_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((XU = (ccfv @ XR @ cclidl)) => ((XN = (ccfv @ XR @ ccrsp)) => (((cwcel @ XR @ cclnr) & (cwcel @ XI @ XU)) => (cwrex @ (^ [Xg1:$i] : (XI = (ccfv @ (ccv @ Xg1) @ XN))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XI) @ ccfn))))))))))).
