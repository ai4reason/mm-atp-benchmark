...
thf(anfunsn_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((~ (cwfun @ (ccres @ XF @ (ccsn @ XA2)))) => ((ccfv @ XA2 @ XF) = cc0))))).
...
thf(adffun3_ax,axiom,(! [XA2:($i > $o)] : ((cwfun @ XA2) <=> ((cwrel @ XA2) & (! [Xx3:$i] : (? [Xz:$i] : (! [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XA2) => ((ccv @ Xy1) = (ccv @ Xz)))))))))).
...
thf(aelimasni_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ (ccima @ XA2 @ (ccsn @ XB2))) => (cwbr @ XB2 @ XC @ XA2)))))).
...
thf(andmima_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((~ (cwcel @ XA2 @ (ccdm @ XB2))) => ((ccima @ XB2 @ (ccsn @ XA2)) = cc0))))).
thf(a_0dif_ax,axiom,(! [XA2:($i > $o)] : ((ccdif @ cc0 @ XA2) = cc0))).
thf(cdffv2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((ccfv @ XA2 @ XF) = (ccuni @ (ccdif @ (ccima @ XF @ (ccsn @ XA2)) @ (ccuni @ (ccuni @ (ccdif @ (cccom @ (ccres @ XF @ (ccsn @ XA2)) @ (cccnv @ (ccres @ XF @ (ccsn @ XA2)))) @ ccid))))))))).
