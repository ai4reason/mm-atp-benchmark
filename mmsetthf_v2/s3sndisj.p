...
thf(aeqwrds3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XV))) => ((XW = (ccs3 @ XA2 @ XB2 @ XC)) <=> (((ccfv @ XW @ cchash) = cc3) & (cw3a @ ((ccfv @ ccc0 @ XW) = XA2) @ ((ccfv @ cc1 @ XW) = XB2) @ ((ccfv @ cc2 @ XW) = XC))))))))))).
...
thf(cs3sndisj_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XY)) => (cwdisj @ (^ [Xc:$i] : XZ) @ (^ [Xc:$i] : (ccsn @ (ccs3 @ XA2 @ XB2 @ (ccv @ Xc)))))))))))).
