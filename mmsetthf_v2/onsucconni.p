...
thf(aonssneli_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cwss @ XA2 @ XB2) => (~ (cwcel @ XB2 @ XA2))))))).
...
thf(consucconni_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (cwcel @ (ccsuc @ XA2) @ ccconn)))).
