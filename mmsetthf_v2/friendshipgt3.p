...
thf(afusgrn0degnn0_ax,axiom,(! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xn:$i] : ((XV @ Xn) = (ccfv @ XG @ ccvtx))) => (! [Xn:$i] : (((cwcel @ XG @ ccfusgr) & (cwne @ (XV @ Xn) @ cc0)) => (cwrex @ (^ [Xv:$i] : (cwrex @ (^ [Xn:$i] : ((ccfv @ (ccv @ Xv) @ (ccfv @ XG @ ccvtxdg)) = (ccv @ Xn))) @ (^ [Xn:$i] : ccn0))) @ (^ [Xv:$i] : (XV @ Xn))))))))).
...
thf(cfriendshipgt3_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cw3a @ (cwcel @ XG @ ccfrgr) @ (cwcel @ XV @ ccfn) @ (cwbr @ cc3 @ (ccfv @ XV @ cchash) @ cclt)) => (cwrex @ (^ [Xv:$i] : (cwral @ (^ [Xw:$i] : (cwcel @ (ccpr @ (ccv @ Xv) @ (ccv @ Xw)) @ (ccfv @ XG @ ccedg))) @ (^ [Xw:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV))))))).
