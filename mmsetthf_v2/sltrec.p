...
thf(aslerec_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwbr @ XA2 @ XB2 @ ccsslt) & (cwbr @ XC @ XD @ ccsslt)) & ((XX = (cco @ XA2 @ XB2 @ ccscut)) & (XY = (cco @ XC @ XD @ ccscut)))) => ((cwbr @ XX @ XY @ ccsle) <=> ((cwral @ (^ [Xd:$i] : (cwbr @ XX @ (ccv @ Xd) @ ccslt)) @ (^ [Xd:$i] : XD)) & (cwral @ (^ [Xa:$i] : (cwbr @ (ccv @ Xa) @ XY @ ccslt)) @ (^ [Xa:$i] : XA2)))))))))))).
...
thf(asltnle_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccsur) & (cwcel @ XB2 @ ccsur)) => ((cwbr @ XA2 @ XB2 @ ccslt) <=> (~ (cwbr @ XB2 @ XA2 @ ccsle))))))).
