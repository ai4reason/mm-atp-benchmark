...
thf(cpmtrprfv2_conj,conjecture,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => (((cwcel @ XD @ XV) & (cw3a @ (cwcel @ XX @ XD) @ (cwcel @ XY @ XD) @ (cwne @ XX @ XY))) => ((ccfv @ XY @ (ccfv @ (ccpr @ XX @ XY) @ XT)) = XX))))))))).
