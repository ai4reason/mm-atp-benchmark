...
thf(amdsldmd1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwcel @ XD @ ccch) => ((((cwbr @ XA2 @ XB2 @ ccmd) & (cwbr @ XB2 @ XA2 @ ccdmd)) & ((cwss @ XA2 @ (ccin @ XC @ XD)) & (cwss @ (cco @ XC @ XD @ cchj) @ (cco @ XA2 @ XB2 @ cchj)))) => ((cwbr @ XC @ XD @ ccdmd) <=> (cwbr @ (ccin @ XC @ XB2) @ (ccin @ XD @ XB2) @ ccdmd)))))))))))).
