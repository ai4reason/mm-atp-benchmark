...
thf(coprssov_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cw3a @ (cwfun @ XF) @ (cwfn @ XG @ (ccxp @ XC @ XD)) @ (cwss @ XG @ XF)) & ((cwcel @ XA2 @ XC) & (cwcel @ XB2 @ XD))) => ((cco @ XA2 @ XB2 @ XF) = (cco @ XA2 @ XB2 @ XG)))))))))).
