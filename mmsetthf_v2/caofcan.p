...
thf(acaovcang_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph & (cw3a @ (cwcel @ (ccv @ Xx3) @ XT) @ (cwcel @ (ccv @ Xy1) @ XS) @ (cwcel @ (ccv @ Xz) @ XS))) => (((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) = (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ XF)) <=> ((ccv @ Xy1) = (ccv @ Xz))))))) => ((Xph & (cw3a @ (cwcel @ XA2 @ XT) @ (cwcel @ XB2 @ XS) @ (cwcel @ XC @ XS))) => (((cco @ XA2 @ XB2 @ XF) = (cco @ XA2 @ XC @ XF)) <=> (XB2 = XC)))))))))))).
...
thf(ccaofcan_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwcel @ (XA2 @ Xx3 @ Xy1 @ Xz) @ (XV @ Xx3 @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwf @ (XA2 @ Xx3 @ Xy1 @ Xz) @ XT @ XF))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwf @ (XA2 @ Xx3 @ Xy1 @ Xz) @ XS @ XG))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwf @ (XA2 @ Xx3 @ Xy1 @ Xz) @ XS @ XH))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph & (cw3a @ (cwcel @ (ccv @ Xx3) @ XT) @ (cwcel @ (ccv @ Xy1) @ XS) @ (cwcel @ (ccv @ Xz) @ XS))) => (((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) = (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ XR)) <=> ((ccv @ Xy1) = (ccv @ Xz))))))) => (Xph => (((cco @ XF @ XG @ (ccof @ XR)) = (cco @ XF @ XH @ (ccof @ XR))) <=> (XG = XH)))))))))))))))))).
