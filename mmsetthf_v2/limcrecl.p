...
thf(adstregt0_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ (ccdif @ ccc @ ccr)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ ccmin) @ ccabs) @ cclt)) @ (^ [Xy1:$i] : ccr))) @ (^ [Xx3:$i] : ccrp)))))))).
...
thf(alpbl_ax,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => (((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwss @ XS @ XX) @ (cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cclp)))) & (cwcel @ XR @ ccrp)) => (cwrex @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)))) @ (^ [Xx3:$i] : XS))))))))))).
...
thf(ajcn_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => (~ Xch)) => (Xph => (~ (Xps => Xch))))))))).
...
thf(climcrecl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : ((Xph => (cwf @ XA2 @ ccr @ XF)) => ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ (ccfv @ XA2 @ (ccfv @ (ccfv @ cccnfld @ cctopn) @ cclp)))) => ((Xph => (cwcel @ XL @ (cco @ XF @ XB2 @ cclimc))) => (Xph => (cwcel @ XL @ ccr)))))))))))).
