...
thf(arelexpsucnnl_ax,axiom,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XR @ XV) & (cwcel @ XN @ ccn)) => ((cco @ XR @ (cco @ XN @ cc1 @ ccaddc) @ ccrelexp) = (cccom @ XR @ (cco @ XR @ XN @ ccrelexp)))))))).
...
thf(crelexpsucl_conj,conjecture,(! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XR @ XV) @ (cwrel @ XR) @ (cwcel @ XN @ ccn0)) => ((cco @ XR @ (cco @ XN @ cc1 @ ccaddc) @ ccrelexp) = (cccom @ XR @ (cco @ XR @ XN @ ccrelexp)))))))).
