...
thf(acos2t_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (cco @ cc2 @ XA2 @ ccmul) @ cccos) = (cco @ (cco @ cc2 @ (cco @ (ccfv @ XA2 @ cccos) @ cc2 @ ccexp) @ ccmul) @ cc1 @ ccmin))))).
...
thf(apigt2lt4_ax,axiom,((cwbr @ cc2 @ ccpi @ cclt) & (cwbr @ ccpi @ cc4 @ cclt))).
...
thf(acos01bnd_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccioc)) => ((cwbr @ (cco @ cc1 @ (cco @ cc2 @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc3 @ ccdiv) @ ccmul) @ ccmin) @ (ccfv @ XA2 @ cccos) @ cclt) & (cwbr @ (ccfv @ XA2 @ cccos) @ (cco @ cc1 @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc3 @ ccdiv) @ ccmin) @ cclt))))).
...
thf(asubadd4d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XD @ ccc)) => (Xph => ((cco @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XD @ ccmin) @ ccmin) = (cco @ (cco @ XA2 @ XD @ ccaddc) @ (cco @ XB2 @ XC @ ccaddc) @ ccmin))))))))))))).
...
thf(asin2t_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (cco @ cc2 @ XA2 @ ccmul) @ ccsin) = (cco @ cc2 @ (cco @ (ccfv @ XA2 @ ccsin) @ (ccfv @ XA2 @ cccos) @ ccmul) @ ccmul))))).
...
thf(ctangtx_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)) => (cwbr @ XA2 @ (ccfv @ XA2 @ cctan) @ cclt)))).
