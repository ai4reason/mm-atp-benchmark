...
thf(cpjth_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((XO = (ccfv @ XW @ ccocv)) => ((XJ = (ccfv @ XW @ cctopn)) => ((XL = (ccfv @ XW @ cclss)) => ((cw3a @ (cwcel @ XW @ cchl) @ (cwcel @ XU @ XL) @ (cwcel @ XU @ (ccfv @ XJ @ cccld))) => ((cco @ XU @ (ccfv @ XU @ XO) @ Xc_po) = XV))))))))))))))).
