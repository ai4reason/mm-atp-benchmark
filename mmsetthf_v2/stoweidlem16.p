...
thf(cstoweidlem16_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xg1:$i] : (! [Xh:$i] : (cwnf @ (^ [Xt:$i] : (Xph @ Xt @ Xg1 @ Xh))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((XY @ Xt @ Xf1 @ Xg1 @ Xh) = (ccrab @ (^ [Xh:$i] : (cwral @ (^ [Xt:$i] : ((cwbr @ ccc0 @ (ccfv @ (ccv @ Xt) @ (ccv @ Xh)) @ ccle) & (cwbr @ (ccfv @ (ccv @ Xt) @ (ccv @ Xh)) @ cc1 @ ccle))) @ (^ [Xt:$i] : (XT @ Xg1)))) @ (^ [Xh:$i] : XA2))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XH @ Xt @ Xf1 @ Xg1) = (ccmpt @ (^ [Xt:$i] : (XT @ Xg1)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (((Xph @ Xt @ Xg1 @ Xh) & (cwcel @ (ccv @ Xf1) @ XA2)) => (cwf @ (XT @ Xg1) @ ccr @ (ccv @ Xf1))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((cw3a @ (Xph @ Xt @ Xg1 @ Xh) @ (cwcel @ (ccv @ Xf1) @ XA2) @ (cwcel @ (ccv @ Xg1) @ XA2)) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (XT @ Xg1)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul))) @ XA2)))))) => (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((cw3a @ (Xph @ Xt @ Xg1 @ Xh) @ (cwcel @ (ccv @ Xf1) @ (XY @ Xt @ Xf1 @ Xg1 @ Xh)) @ (cwcel @ (ccv @ Xg1) @ (XY @ Xt @ Xf1 @ Xg1 @ Xh))) => (cwcel @ (XH @ Xt @ Xf1 @ Xg1) @ (XY @ Xt @ Xf1 @ Xg1 @ Xh)))))))))))))))))).
