...
thf(cxralrple2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ ccxr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccico)))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ XA2 @ (cco @ (cco @ cc1 @ (ccv @ Xx3) @ ccaddc) @ XB2 @ ccmul) @ ccle)) @ (^ [Xx3:$i] : ccrp)))))))))))).
