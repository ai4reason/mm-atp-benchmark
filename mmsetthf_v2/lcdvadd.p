...
thf(clcdvadd_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pb:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XD = (ccfv @ XU @ ccld)) => ((Xc_pl = (ccfv @ XD @ ccplusg)) => ((XC = (ccfv @ XW @ (ccfv @ XK @ cclcd))) => ((Xc_pb = (ccfv @ XC @ ccplusg)) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => (Xph => (Xc_pb = Xc_pl))))))))))))))))))).
