...
thf(avdegp1ci_ax,axiom,(! [XP:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (XV = (ccfv @ (XG @ Xx3) @ ccvtx))) => ((cwcel @ XU @ XV) => ((! [Xx3:$i] : ((XI @ Xx3) = (ccfv @ (XG @ Xx3) @ cciedg))) => ((! [Xx3:$i] : (cwcel @ (XI @ Xx3) @ (ccword @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ cchash) @ cc2 @ ccle)) @ (^ [Xx3:$i] : (ccdif @ (ccpw @ XV) @ (ccsn @ cc0))))))) => ((! [Xx3:$i] : ((ccfv @ XU @ (ccfv @ (XG @ Xx3) @ ccvtxdg)) = (XP @ Xx3))) => ((! [Xx3:$i] : ((ccfv @ (XF @ Xx3) @ ccvtx) = XV)) => ((cwcel @ XX @ XV) => ((cwne @ XX @ XU) => ((! [Xx3:$i] : ((ccfv @ (XF @ Xx3) @ cciedg) = (cco @ (XI @ Xx3) @ (ccs1 @ (ccpr @ XX @ XU)) @ ccconcat))) => (! [Xx3:$i] : ((ccfv @ XU @ (ccfv @ (XF @ Xx3) @ ccvtxdg)) = (cco @ (XP @ Xx3) @ cc1 @ ccaddc)))))))))))))))))))).
...
thf(aopiedgfvi_ax,axiom,(! [XE:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XV @ ccvv) => ((cwcel @ XE @ ccvv) => ((ccfv @ (ccop @ XV @ XE) @ cciedg) = XE)))))).
...
thf(as3s4_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((ccs7 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG) = (cco @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccs4 @ XD @ XE @ XF @ XG) @ ccconcat)))))))))).
thf(as2s5_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((ccs7 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG) = (cco @ (ccs2 @ XA2 @ XB2) @ (ccs5 @ XC @ XD @ XE @ XF @ XG) @ ccconcat)))))))))).
...
thf(avtxdg0e_ax,axiom,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XG @ cciedg)) => (((cwcel @ XU @ XV) & (XI = cc0)) => ((ccfv @ XU @ (ccfv @ XG @ ccvtxdg)) = ccc0))))))))).
...
thf(a_1le3_ax,axiom,(cwbr @ cc1 @ cc3 @ ccle)).
...
thf(as0s1_ax,axiom,(! [XA2:($i > $o)] : ((ccs1 @ XA2) = (cco @ cc0 @ (ccs1 @ XA2) @ ccconcat)))).
...
thf(akonigsbergvtx_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (cco @ ccc0 @ cc3 @ ccfz)) => ((XE = (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3))) => ((XG = (ccop @ XV @ XE)) => ((ccfv @ XG @ ccvtx) = (cco @ ccc0 @ cc3 @ ccfz))))))))).
thf(akonigsbergiedg_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (cco @ ccc0 @ cc3 @ ccfz)) => ((XE = (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3))) => ((XG = (ccop @ XV @ XE)) => ((ccfv @ XG @ cciedg) = (ccs7 @ (ccpr @ ccc0 @ cc1) @ (ccpr @ ccc0 @ cc2) @ (ccpr @ ccc0 @ cc3) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc1 @ cc2) @ (ccpr @ cc2 @ cc3) @ (ccpr @ cc2 @ cc3)))))))))).
