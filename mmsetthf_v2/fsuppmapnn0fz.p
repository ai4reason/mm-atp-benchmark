...
thf(cfsuppmapnn0fz_conj,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XF @ (cco @ XR @ ccn0 @ ccmap)) & (cwcel @ XZ @ XV)) => ((cwbr @ XF @ XZ @ ccfsupp) => (cwrex @ (^ [Xm:$i] : (cwss @ (cco @ XF @ XZ @ ccsupp) @ (cco @ ccc0 @ (ccv @ Xm) @ ccfz))) @ (^ [Xm:$i] : ccn0))))))))).
