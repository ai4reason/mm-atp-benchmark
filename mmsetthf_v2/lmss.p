...
thf(almfss_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwbr @ XF @ XP @ (ccfv @ XJ @ cclm))) => (cwss @ XF @ (ccxp @ ccc @ XX)))))))).
...
thf(clmss_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XK = (cco @ XJ @ XY @ ccrest)) => ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XY @ XV)) => ((Xph => (cwcel @ XJ @ cctop)) => ((Xph => (cwcel @ XP @ XY)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwf @ XZ @ XY @ XF)) => (Xph => ((cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) <=> (cwbr @ XF @ XP @ (ccfv @ XK @ cclm))))))))))))))))))))).
