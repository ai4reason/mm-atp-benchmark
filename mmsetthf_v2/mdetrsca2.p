...
thf(cmdetrsca2_conj,conjecture,(! [Xph:$o] : (! [XD:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : ((XD @ Xi @ Xj) = (cco @ XN @ (XR @ Xi @ Xj) @ ccmdat)))) => ((! [Xi:$i] : (! [Xj:$i] : (XK = (ccfv @ (XR @ Xi @ Xj) @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xc_x = (ccfv @ (XR @ Xi @ Xj) @ ccmulr)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xph => (cwcel @ (XR @ Xi @ Xj) @ cccrg)))) => ((Xph => (cwcel @ XN @ ccfn)) => ((! [Xi:$i] : (! [Xj:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xi) @ XN) @ (cwcel @ (ccv @ Xj) @ XN)) => (cwcel @ (XX @ Xi @ Xj) @ XK)))) => ((! [Xi:$i] : (! [Xj:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xi) @ XN) @ (cwcel @ (ccv @ Xj) @ XN)) => (cwcel @ (XY @ Xi @ Xj) @ XK)))) => ((Xph => (cwcel @ XF @ XK)) => ((Xph => (cwcel @ XI @ XN)) => (! [Xi:$i] : (! [Xj:$i] : (Xph => ((ccfv @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = XI) @ (cco @ XF @ (XX @ Xi @ Xj) @ Xc_x) @ (XY @ Xi @ Xj))))) @ (XD @ Xi @ Xj)) = (cco @ XF @ (ccfv @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = XI) @ (XX @ Xi @ Xj) @ (XY @ Xi @ Xj))))) @ (XD @ Xi @ Xj)) @ Xc_x))))))))))))))))))))))))).
