...
thf(algamp1_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn))) => ((ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cclgam) = (cco @ (ccfv @ XA2 @ cclgam) @ (ccfv @ XA2 @ cclog) @ ccaddc))))).
...
thf(admgmaddnn0_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn)))) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => (cwcel @ (cco @ XA2 @ XN @ ccaddc) @ (ccdif @ ccc @ (ccdif @ ccz @ ccn)))))))))).
...
thf(cgamp1_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn))) => ((ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ ccgam) = (cco @ (ccfv @ XA2 @ ccgam) @ XA2 @ ccmul))))).
