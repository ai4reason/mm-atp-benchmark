...
thf(aopthg2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XC @ XV) & (cwcel @ XD @ XW)) => (((ccop @ XA2 @ XB2) = (ccop @ XC @ XD)) <=> ((XA2 = XC) & (XB2 = XD))))))))))).
...
thf(aelsnxp_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XX @ XV) => ((cwcel @ XZ @ (ccxp @ (ccsn @ XX) @ XA2)) <=> (cwrex @ (^ [Xy1:$i] : (XZ = (ccop @ XX @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))))))))).
...
thf(cprojf1o_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccop @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwf1o @ XB2 @ (ccxp @ (ccsn @ XA2) @ XB2) @ (XF @ Xx3)))))))))))).
