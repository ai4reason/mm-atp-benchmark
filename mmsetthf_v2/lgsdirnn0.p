...
thf(algscl_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccz)) => (cwcel @ (cco @ XA2 @ XN @ cclgs) @ ccz))))).
...
thf(algs1_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccz) => ((cco @ XA2 @ cc1 @ cclgs) = cc1)))).
...
thf(asyl3anl3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xph => Xth) => ((((cw3a @ Xps @ Xch @ Xth) & Xta) => Xet) => (((cw3a @ Xps @ Xch @ Xph) & Xta) => Xet)))))))))).
thf(algsdir_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XN @ ccz)) & ((cwne @ XA2 @ ccc0) & (cwne @ XB2 @ ccc0))) => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ XN @ cclgs) = (cco @ (cco @ XA2 @ XN @ cclgs) @ (cco @ XB2 @ XN @ cclgs) @ ccmul))))))).
thf(clgsdirnn0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XN @ ccn0)) => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ XN @ cclgs) = (cco @ (cco @ XA2 @ XN @ cclgs) @ (cco @ XB2 @ XN @ cclgs) @ ccmul))))))).
