...
thf(cpridl_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XH @ Xx3 @ Xy1) = (ccfv @ XR @ cc2nd)))) => (! [Xy1:$i] : ((((cwcel @ XR @ ccrngo) & (cwcel @ XP @ (ccfv @ XR @ ccpridl))) & (cw3a @ (cwcel @ (XA2 @ Xy1) @ (ccfv @ XR @ ccidl)) @ (cwcel @ XB2 @ (ccfv @ XR @ ccidl)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XH @ Xx3 @ Xy1)) @ XP)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1))))) => ((cwss @ (XA2 @ Xy1) @ XP) | (cwss @ XB2 @ XP))))))))))).
