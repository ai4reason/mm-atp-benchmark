...
thf(avtxdusgr0edgnel_ax,axiom,(! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : ((XD @ Xe) = (ccfv @ XG @ ccvtxdg))) => (! [Xe:$i] : (((cwcel @ XG @ ccusgr) & (cwcel @ XU @ XV)) => (((ccfv @ XU @ (XD @ Xe)) = ccc0) <=> (~ (cwrex @ (^ [Xe:$i] : (cwcel @ XU @ (ccv @ Xe))) @ (^ [Xe:$i] : XE))))))))))))))).
thf(c_1egrvtxdg0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => ((ccfv @ XG @ ccvtx) = XV)) => ((Xph => (cwcel @ XA2 @ XX)) => ((Xph => (cwcel @ XB2 @ XV)) => ((Xph => (cwcel @ XC @ XV)) => ((Xph => (cwne @ XB2 @ XC)) => ((Xph => (cwcel @ XD @ XV)) => ((Xph => (cwne @ XC @ XD)) => ((Xph => ((ccfv @ XG @ cciedg) = (ccsn @ (ccop @ XA2 @ (ccpr @ XB2 @ XD))))) => (Xph => ((ccfv @ XC @ (ccfv @ XG @ ccvtxdg)) = ccc0))))))))))))))))))).
