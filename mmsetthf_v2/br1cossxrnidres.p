...
thf(aideq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwbr @ XA2 @ XB2 @ ccid) <=> (XA2 = XB2))))))).
thf(cbr1cossxrnidres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XB2 @ XV) & (cwcel @ XC @ XW)) & ((cwcel @ XD @ XX) & (cwcel @ XE @ XY))) => ((cwbr @ (ccop @ XB2 @ XC) @ (ccop @ XD @ XE) @ (cccoss @ (ccxrn @ XR @ (ccres @ ccid @ XA2)))) <=> (cwrex @ (^ [Xu:$i] : ((((ccv @ Xu) = XC) & (cwbr @ (ccv @ Xu) @ XB2 @ XR)) & (((ccv @ Xu) = XE) & (cwbr @ (ccv @ Xu) @ XD @ XR)))) @ (^ [Xu:$i] : XA2))))))))))))))).
