...
thf(arankwflemb_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) <=> (cwrex @ (^ [Xx3:$i] : (cwcel @ XA2 @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ ccr1))) @ (^ [Xx3:$i] : ccon0))))).
...
thf(arecseq_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XF = XG) => ((ccrecs @ XF) = (ccrecs @ XG)))))).
...
thf(aonwf_ax,axiom,(cwss @ ccon0 @ (ccuni @ (ccima @ ccr1 @ ccon0)))).
thf(apwwf_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) <=> (cwcel @ (ccpw @ XA2) @ (ccuni @ (ccima @ ccr1 @ ccon0)))))).
thf(assel_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ XB2) => ((cwcel @ XC @ XA2) => (cwcel @ XC @ XB2))))))).
thf(cdfac12r_conj,conjecture,((cwral @ (^ [Xx3:$i] : (cwcel @ (ccpw @ (ccv @ Xx3)) @ (ccdm @ cccrd))) @ (^ [Xx3:$i] : ccon0)) <=> (cwss @ (ccuni @ (ccima @ ccr1 @ ccon0)) @ (ccdm @ cccrd)))).
