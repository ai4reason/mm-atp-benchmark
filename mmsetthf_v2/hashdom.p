...
thf(ahashgval_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc1 @ ccaddc))) @ ccc0) @ ccom))) => (! [Xx3:$i] : ((cwcel @ XA2 @ ccfn) => ((ccfv @ (ccfv @ XA2 @ cccrd) @ (XG @ Xx3)) = (ccfv @ XA2 @ cchash)))))))).
...
thf(ahashgadd_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc1 @ ccaddc))) @ ccc0) @ ccom))) => (! [Xx3:$i] : (((cwcel @ (XA2 @ Xx3) @ ccom) & (cwcel @ (XB2 @ Xx3) @ ccom)) => ((ccfv @ (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ ccoa) @ (XG @ Xx3)) = (cco @ (ccfv @ (XA2 @ Xx3) @ (XG @ Xx3)) @ (ccfv @ (XB2 @ Xx3) @ (XG @ Xx3)) @ ccaddc))))))))).
thf(ahashgf1o_ax,axiom,(! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc1 @ ccaddc))) @ ccc0) @ ccom))) => (! [Xx3:$i] : (cwf1o @ ccom @ ccn0 @ (XG @ Xx3)))))).
thf(annacl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => (cwcel @ (cco @ XA2 @ XB2 @ ccoa) @ ccom))))).
...
thf(annawordex_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => ((cwss @ XA2 @ XB2) <=> (cwrex @ (^ [Xx3:$i] : ((cco @ XA2 @ (ccv @ Xx3) @ ccoa) = XB2)) @ (^ [Xx3:$i] : ccom))))))).
...
thf(aisinffi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((~ (cwcel @ XA2 @ ccfn)) & (cwcel @ XB2 @ ccfn)) => (? [Xf1:$i] : (cwf1 @ XB2 @ XA2 @ (ccv @ Xf1))))))).
thf(abrdomg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [Xf1:$i] : ((cwcel @ XB2 @ (XC @ Xf1)) => ((cwbr @ XA2 @ XB2 @ ccdom) <=> (? [Xf1:$i] : (cwf1 @ XA2 @ XB2 @ (ccv @ Xf1)))))))))).
thf(chashdom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwcel @ XB2 @ XV)) => ((cwbr @ (ccfv @ XA2 @ cchash) @ (ccfv @ XB2 @ cchash) @ ccle) <=> (cwbr @ XA2 @ XB2 @ ccdom))))))).
