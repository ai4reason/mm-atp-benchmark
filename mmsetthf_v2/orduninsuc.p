...
thf(aonuninsuci_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((XA2 = (ccuni @ XA2)) <=> (~ (cwrex @ (^ [Xx3:$i] : (XA2 = (ccsuc @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0))))))).
...
thf(aunon_ax,axiom,((ccuni @ ccon0) = ccon0)).
...
thf(corduninsuc_conj,conjecture,(! [XA2:($i > $o)] : ((cword @ XA2) => ((XA2 = (ccuni @ XA2)) <=> (~ (cwrex @ (^ [Xx3:$i] : (XA2 = (ccsuc @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0))))))).
