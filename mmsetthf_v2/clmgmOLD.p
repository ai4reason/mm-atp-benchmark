...
thf(aismgmOLD_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ (ccdm @ XG))) => ((cwcel @ XG @ XA2) => ((cwcel @ XG @ ccmagm) <=> (cwf @ (ccxp @ XX @ XX) @ XX @ XG)))))))).
...
thf(cclmgmOLD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ (ccdm @ XG))) => ((cw3a @ (cwcel @ XG @ ccmagm) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) => (cwcel @ (cco @ XA2 @ XB2 @ XG) @ XX)))))))).
