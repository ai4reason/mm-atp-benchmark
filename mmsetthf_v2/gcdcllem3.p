...
thf(agcdcllem1_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xn:$i] : ((XS @ Xy1 @ Xz @ Xn) = (ccrab @ (^ [Xz:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xn:$i] : XA2))) @ (^ [Xz:$i] : ccz)))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xn:$i] : (((cwss @ XA2 @ ccz) & (cwrex @ (^ [Xn:$i] : (cwne @ (ccv @ Xn) @ ccc0)) @ (^ [Xn:$i] : XA2))) => ((cwne @ (XS @ Xy1 @ Xz @ Xn) @ cc0) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (XS @ Xy1 @ Xz @ Xn)))) @ (^ [Xx3:$i] : ccz))))))))))).
thf(agcdcllem2_ax,axiom,(! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xz:$i] : (! [Xn:$i] : ((XS @ Xz @ Xn) = (ccrab @ (^ [Xz:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xn:$i] : (ccpr @ XM @ XN)))) @ (^ [Xz:$i] : ccz))))) => ((! [Xz:$i] : (! [Xn:$i] : ((XR @ Xz @ Xn) = (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xz) @ XM @ ccdvds) & (cwbr @ (ccv @ Xz) @ XN @ ccdvds))) @ (^ [Xz:$i] : ccz))))) => (! [Xz:$i] : (! [Xn:$i] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((XR @ Xz @ Xn) = (XS @ Xz @ Xn)))))))))))).
...
thf(cgcdcllem3_conj,conjecture,(! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xz:$i] : (! [Xn:$i] : ((XS @ Xz @ Xn) = (ccrab @ (^ [Xz:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xn:$i] : (ccpr @ XM @ XN)))) @ (^ [Xz:$i] : ccz))))) => ((! [Xz:$i] : (! [Xn:$i] : ((XR @ Xz @ Xn) = (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xz) @ XM @ ccdvds) & (cwbr @ (ccv @ Xz) @ XN @ ccdvds))) @ (^ [Xz:$i] : ccz))))) => (! [Xz:$i] : (! [Xn:$i] : ((((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) & (~ ((XM = ccc0) & (XN = ccc0)))) => (cw3a @ (cwcel @ (ccsup @ (XR @ Xz @ Xn) @ ccr @ cclt) @ ccn) @ ((cwbr @ (ccsup @ (XR @ Xz @ Xn) @ ccr @ cclt) @ XM @ ccdvds) & (cwbr @ (ccsup @ (XR @ Xz @ Xn) @ ccr @ cclt) @ XN @ ccdvds)) @ ((cw3a @ (cwcel @ (XK @ Xn) @ ccz) @ (cwbr @ (XK @ Xn) @ XM @ ccdvds) @ (cwbr @ (XK @ Xn) @ XN @ ccdvds)) => (cwbr @ (XK @ Xn) @ (ccsup @ (XR @ Xz @ Xn) @ ccr @ cclt) @ ccle)))))))))))))).
