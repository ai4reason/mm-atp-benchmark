...
thf(azindbi_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [XA2:($i > $o)] : ((! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ ccz) => ((Xps @ Xy1) <=> (Xch @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) => ((Xph @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = ccc0) => ((Xph @ Xx3) <=> (Xth @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> (Xta @ Xy1))))) => (! [Xy1:$i] : ((cwcel @ XA2 @ ccz) => ((Xth @ Xy1) <=> (Xta @ Xy1)))))))))))))))).
...
thf(armxdbl_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccz)) => ((cco @ XA2 @ (cco @ cc2 @ XN @ ccmul) @ ccrmx) = (cco @ (cco @ cc2 @ (cco @ (cco @ XA2 @ XN @ ccrmx) @ cc2 @ ccexp) @ ccmul) @ cc1 @ ccmin)))))).
...
thf(armydbl_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccz)) => ((cco @ XA2 @ (cco @ cc2 @ XN @ ccmul) @ ccrmy) = (cco @ (cco @ cc2 @ (cco @ XA2 @ XN @ ccrmx) @ ccmul) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul)))))).
...
thf(armyadd_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) => ((cco @ XA2 @ (cco @ XM @ XN @ ccaddc) @ ccrmy) = (cco @ (cco @ (cco @ XA2 @ XM @ ccrmy) @ (cco @ XA2 @ XN @ ccrmx) @ ccmul) @ (cco @ (cco @ XA2 @ XM @ ccrmx) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul) @ ccaddc))))))).
