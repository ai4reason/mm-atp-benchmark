...
thf(aflimtopon_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim)) => ((cwcel @ XJ @ (ccfv @ XX @ cctopon)) <=> (cwcel @ XF @ (ccfv @ XX @ ccfil))))))))).
...
thf(cfclsfnflim_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccfil)) => ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) <=> (cwrex @ (^ [Xg1:$i] : ((cwss @ XF @ (ccv @ Xg1)) & (cwcel @ XA2 @ (cco @ XJ @ (ccv @ Xg1) @ ccflim)))) @ (^ [Xg1:$i] : (ccfv @ XX @ ccfil)))))))))).
