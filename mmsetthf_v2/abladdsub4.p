...
thf(agrpsubrcan_ax,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => (((cwcel @ XG @ ccgrp) & (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2))) => (((cco @ XX @ XZ @ Xc_mi) = (cco @ XY @ XZ @ Xc_mi)) <=> (XX = XY)))))))))))).
...
thf(cabladdsub4_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((cw3a @ (cwcel @ XG @ ccabl) @ ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) @ ((cwcel @ XZ @ XB2) & (cwcel @ XW @ XB2))) => (((cco @ XX @ XY @ Xc_pl) = (cco @ XZ @ XW @ Xc_pl)) <=> ((cco @ XX @ XZ @ Xc_mi) = (cco @ XW @ XY @ Xc_mi)))))))))))))))).
