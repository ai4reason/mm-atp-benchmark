...
thf(agrothtsk_ax,axiom,((ccuni @ cctsk) = ccvv)).
...
thf(assonprc_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccon0) => ((cwnel @ XA2 @ ccvv) <=> ((ccuni @ XA2) = ccon0))))).
thf(cinaprc_conj,conjecture,(cwnel @ ccina @ ccvv)).
