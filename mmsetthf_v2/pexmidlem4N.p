...
thf(apexmidlem3N_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [Xc_pl:($i > ($i > $o))] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [Xc_pe:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [Xr:$i] : (! [Xq:$i] : ((! [Xp:$i] : ((Xc_le @ Xp) = (ccfv @ (XK @ Xp) @ ccple))) => ((! [Xp:$i] : ((Xc_or @ Xp) = (ccfv @ (XK @ Xp) @ ccjn))) => ((! [Xp:$i] : ((XA2 @ Xp) = (ccfv @ (XK @ Xp) @ ccatm))) => ((! [Xp:$i] : ((Xc_pl @ Xp) = (ccfv @ (XK @ Xp) @ ccpadd))) => ((! [Xp:$i] : ((Xc_pe @ Xp) = (ccfv @ (XK @ Xp) @ ccpolN))) => ((! [Xp:$i] : ((XM @ Xp) = (cco @ (XX @ Xp) @ (ccsn @ (ccv @ Xp)) @ (Xc_pl @ Xp)))) => (! [Xp:$i] : ((cw3a @ (cw3a @ (cwcel @ (XK @ Xp) @ cchlt) @ (cwss @ (XX @ Xp) @ (XA2 @ Xp)) @ (cwcel @ (ccv @ Xp) @ (XA2 @ Xp))) @ ((cwcel @ (ccv @ Xr) @ (XX @ Xp)) & (cwcel @ (ccv @ Xq) @ (ccfv @ (XX @ Xp) @ (Xc_pe @ Xp)))) @ (cwbr @ (ccv @ Xq) @ (cco @ (ccv @ Xr) @ (ccv @ Xp) @ (Xc_or @ Xp)) @ (Xc_le @ Xp))) => (cwcel @ (ccv @ Xp) @ (cco @ (XX @ Xp) @ (ccfv @ (XX @ Xp) @ (Xc_pe @ Xp)) @ (Xc_pl @ Xp)))))))))))))))))))))).
