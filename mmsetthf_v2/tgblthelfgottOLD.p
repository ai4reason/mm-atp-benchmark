...
thf(aax_hgprmladderOLD_ax,axiom,(cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xf1:$i] : ((cw3a @ ((ccfv @ ccc0 @ (ccv @ Xf1)) = cc7) @ ((ccfv @ cc1 @ (ccv @ Xf1)) = (ccdc @ cc1 @ cc3)) @ ((ccfv @ (ccv @ Xd) @ (ccv @ Xf1)) = (cco @ (ccdc @ cc8 @ cc9) @ (cco @ cc10 @ (ccdc @ cc2 @ cc9) @ ccexp) @ ccmul))) & (cwral @ (^ [Xi:$i] : (cw3a @ (cwcel @ (ccfv @ (ccv @ Xi) @ (ccv @ Xf1)) @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (cwbr @ (cco @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xf1)) @ ccmin) @ (cco @ (cco @ cc4 @ (cco @ cc10 @ (ccdc @ cc1 @ cc8) @ ccexp) @ ccmul) @ cc4 @ ccmin) @ cclt) @ (cwbr @ cc4 @ (cco @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xf1)) @ ccmin) @ cclt))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xd) @ ccfzo))))) @ (^ [Xf1:$i] : (ccfv @ (ccv @ Xd) @ cciccp)))) @ (^ [Xd:$i] : (ccfv @ cc3 @ ccuz)))).
...
thf(adecltiOLD_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwbr @ XC @ cc10 @ cclt) => (cwbr @ XC @ (ccdc @ XA2 @ XB2) @ cclt))))))))).
thf(a_1lt10OLD_ax,axiom,(cwbr @ cc1 @ cc10 @ cclt)).
...
thf(a_10posOLD_ax,axiom,(cwbr @ ccc0 @ cc10 @ cclt)).
...
thf(a_1t10e1p1e11OLD_ax,axiom,((ccdc @ cc1 @ cc1) = (cco @ (cco @ cc1 @ (cco @ cc10 @ cc1 @ ccexp) @ ccmul) @ cc1 @ ccaddc))).
...
thf(aax_bgbltosilvaOLD_ax,axiom,(! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ cceven) @ (cwbr @ cc4 @ XN @ cclt) @ (cwbr @ XN @ (cco @ cc4 @ (cco @ cc10 @ (ccdc @ cc1 @ cc8) @ ccexp) @ ccmul) @ ccle)) => (cwcel @ XN @ ccgbe)))).
...
thf(ctgblthelfgottOLD_conj,conjecture,(! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccodd) @ (cwbr @ cc7 @ XN @ cclt) @ (cwbr @ XN @ (cco @ (ccdc @ cc8 @ cc8) @ (cco @ cc10 @ (ccdc @ cc2 @ cc9) @ ccexp) @ ccmul) @ cclt)) => (cwcel @ XN @ ccgbo)))).
