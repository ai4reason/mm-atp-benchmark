...
thf(abigoval_ax,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ (cco @ ccr @ ccr @ ccpm)) => ((ccfv @ XG @ ccbigo) = (ccrab @ (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (cco @ (ccv @ Xm) @ (ccfv @ (ccv @ Xy1) @ XG) @ ccmul) @ ccle)) @ (^ [Xy1:$i] : (ccin @ (ccdm @ (ccv @ Xf1)) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccico))))) @ (^ [Xm:$i] : ccr))) @ (^ [Xx3:$i] : ccr))) @ (^ [Xf1:$i] : (cco @ ccr @ ccr @ ccpm))))))).
...
thf(aelbigofrcl_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XF @ (ccfv @ XG @ ccbigo)) => (cwcel @ XG @ (cco @ ccr @ ccr @ ccpm)))))).
thf(a_3anan12_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) <=> (Xps & (Xph & Xch))))))).
thf(celbigo_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XF @ (ccfv @ XG @ ccbigo)) <=> (cw3a @ (cwcel @ XF @ (cco @ ccr @ ccr @ ccpm)) @ (cwcel @ XG @ (cco @ ccr @ ccr @ ccpm)) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ (ccv @ Xm) @ (ccfv @ (ccv @ Xy1) @ XG) @ ccmul) @ ccle)) @ (^ [Xy1:$i] : (ccin @ (ccdm @ XF) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccico))))) @ (^ [Xm:$i] : ccr))) @ (^ [Xx3:$i] : ccr))))))).
