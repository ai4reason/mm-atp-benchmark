...
thf(ckerunit_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_0:($i > $o)] : ((XU = (ccfv @ XR @ ccui)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => ((Xc_1 = (ccfv @ XS @ ccur)) => (((cwcel @ XF @ (cco @ XR @ XS @ ccrh)) & (cwne @ (ccin @ XU @ (ccima @ (cccnv @ XF) @ (ccsn @ Xc_0))) @ cc0)) => (Xc_1 = Xc_0)))))))))))).
