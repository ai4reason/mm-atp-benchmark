...
thf(aresfsupp_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ (ccdif @ (ccdm @ XF) @ XB2) @ ccfn)) => ((Xph => (cwcel @ XF @ XW)) => ((Xph => (cwfun @ XF)) => ((Xph => (XG = (ccres @ XF @ XB2))) => ((Xph => (cwbr @ XG @ XZ @ ccfsupp)) => ((Xph => (cwcel @ XZ @ XV)) => (Xph => (cwbr @ XF @ XZ @ ccfsupp)))))))))))))))).
