...
thf(cbroutsideof3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cw3a @ (cwcel @ XP @ (ccfv @ XN @ ccee)) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)))) => ((cwbr @ XP @ (ccop @ XA2 @ XB2) @ ccoutsideof) <=> (cw3a @ (cwne @ XA2 @ XP) @ (cwne @ XB2 @ XP) @ (cwrex @ (^ [Xc:$i] : (cw3a @ (cwne @ (ccv @ Xc) @ XP) @ (cwbr @ XP @ (ccop @ XA2 @ (ccv @ Xc)) @ ccbtwn) @ (cwbr @ XP @ (ccop @ XB2 @ (ccv @ Xc)) @ ccbtwn))) @ (^ [Xc:$i] : (ccfv @ XN @ ccee))))))))))).
