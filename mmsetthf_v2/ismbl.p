...
thf(adf_vol_ax,axiom,(ccvol = (ccres @ ccovol @ (ccab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ ccovol) = (cco @ (ccfv @ (ccin @ (ccv @ Xy1) @ (ccv @ Xx3)) @ ccovol) @ (ccfv @ (ccdif @ (ccv @ Xy1) @ (ccv @ Xx3)) @ ccovol) @ ccaddc))) @ (^ [Xy1:$i] : (ccima @ (cccnv @ ccovol) @ ccr)))))))).
