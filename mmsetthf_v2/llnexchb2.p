...
thf(aislln3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((! [Xq:$i] : (! [Xp:$i] : ((Xc_or @ Xq @ Xp) = (ccfv @ XK @ ccjn)))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xq:$i] : (! [Xp:$i] : ((XN @ Xq @ Xp) = (ccfv @ XK @ cclln)))) => (! [Xq:$i] : (! [Xp:$i] : (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XB2)) => ((cwcel @ XX @ (XN @ Xq @ Xp)) <=> (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : ((cwne @ (ccv @ Xp) @ (ccv @ Xq)) & (XX = (cco @ (ccv @ Xp) @ (ccv @ Xq) @ (Xc_or @ Xq @ Xp))))) @ (^ [Xq:$i] : XA2))) @ (^ [Xp:$i] : XA2))))))))))))))))).
...
thf(allni2_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XN = (ccfv @ XK @ cclln)) => (((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2)) & (cwne @ XP @ XQ)) => (cwcel @ (cco @ XP @ XQ @ Xc_or) @ XN)))))))))))).
...
thf(allnexchb2lem_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XN = (ccfv @ XK @ cclln)) => ((cw3a @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XN) @ (cwcel @ XY @ XN)) @ (cw3a @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2) @ (~ (cwbr @ XP @ XX @ Xc_le))) @ (cwcel @ (cco @ XX @ XY @ Xc_an) @ XA2)) => ((cwbr @ (cco @ XX @ XY @ Xc_an) @ (cco @ XP @ XQ @ Xc_or) @ Xc_le) <=> ((cco @ XX @ XY @ Xc_an) = (cco @ XX @ (cco @ XP @ XQ @ Xc_or) @ Xc_an)))))))))))))))))))).
...
thf(cllnexchb2_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XN = (ccfv @ XK @ cclln)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cw3a @ (cwcel @ XX @ XN) @ (cwcel @ XY @ XN) @ (cwcel @ XZ @ XN)) @ ((cwcel @ (cco @ XX @ XY @ Xc_an) @ XA2) & (cwne @ XX @ XZ))) => ((cwbr @ (cco @ XX @ XY @ Xc_an) @ XZ @ Xc_le) <=> ((cco @ XX @ XY @ Xc_an) = (cco @ XX @ XZ @ Xc_an))))))))))))))))))).
