...
thf(aismbl3_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccvol)) <=> ((cwss @ XA2 @ ccr) & (cwral @ (^ [Xx3:$i] : (cwbr @ (cco @ (ccfv @ (ccin @ (ccv @ Xx3) @ XA2) @ ccovol) @ (ccfv @ (ccdif @ (ccv @ Xx3) @ XA2) @ ccovol) @ ccxad) @ (ccfv @ (ccv @ Xx3) @ ccovol) @ ccle)) @ (^ [Xx3:$i] : (ccpw @ ccr))))))).
...
thf(aovolsplit_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwss @ XA2 @ ccr)) => (Xph => (cwbr @ (ccfv @ XA2 @ ccovol) @ (cco @ (ccfv @ (ccin @ XA2 @ XB2) @ ccovol) @ (ccfv @ (ccdif @ XA2 @ XB2) @ ccovol) @ ccxad) @ ccle))))))).
