...
thf(a_0idl_ax,axiom,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XZ = (ccfv @ XG @ ccgi)) => ((cwcel @ XR @ ccrngo) => (cwcel @ (ccsn @ XZ) @ (ccfv @ XR @ ccidl))))))))).
...
thf(accased_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xph => ((Xps & Xch) => Xet)) => ((Xph => ((Xth & Xch) => Xet)) => ((Xph => ((Xps & Xta) => Xet)) => ((Xph => ((Xth & Xta) => Xet)) => (Xph => (((Xps | Xth) & (Xch | Xta)) => Xet))))))))))))).
...
thf(arngolidm_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((XH = (ccfv @ XR @ cc2nd)) => ((XX = (ccrn @ (ccfv @ XR @ cc1st))) => ((XU = (ccfv @ XH @ ccgi)) => (((cwcel @ XR @ ccrngo) & (cwcel @ XA2 @ XX)) => ((cco @ XU @ XA2 @ XH) = XA2))))))))))).
...
thf(aisprrngo_ax,axiom,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XZ = (ccfv @ XG @ ccgi)) => ((cwcel @ XR @ ccprrng) <=> ((cwcel @ XR @ ccrngo) & (cwcel @ (ccsn @ XZ) @ (ccfv @ XR @ ccpridl)))))))))).
thf(csmprngopr_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XH = (ccfv @ XR @ cc2nd)) => ((XX = (ccrn @ XG)) => ((XZ = (ccfv @ XG @ ccgi)) => ((XU = (ccfv @ XH @ ccgi)) => ((cw3a @ (cwcel @ XR @ ccrngo) @ (cwne @ XU @ XZ) @ ((ccfv @ XR @ ccidl) = (ccpr @ (ccsn @ XZ) @ XX))) => (cwcel @ XR @ ccprrng)))))))))))))).
