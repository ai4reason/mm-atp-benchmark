...
thf(chmoval_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > ($i > $o))] : ((! [Xt:$i] : ((XH @ Xt) = (ccfv @ XU @ cchmo))) => ((XA2 = (cco @ XU @ XU @ ccaj)) => (! [Xt:$i] : ((cwcel @ XU @ ccnv) => ((XH @ Xt) = (ccrab @ (^ [Xt:$i] : ((ccfv @ (ccv @ Xt) @ XA2) = (ccv @ Xt))) @ (^ [Xt:$i] : (ccdm @ XA2)))))))))))).
