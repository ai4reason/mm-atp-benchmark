...
thf(agsumval2_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xph => (cwcel @ XG @ XV)) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((Xph => (cwf @ (cco @ XM @ XN @ ccfz) @ XB2 @ XF)) => (Xph => ((cco @ XG @ XF @ ccgsu) = (ccfv @ XN @ (ccseq @ Xc_pl @ XF @ XM)))))))))))))))))).
...
thf(cgsumccat_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((cw3a @ (cwcel @ XG @ ccmnd) @ (cwcel @ XW @ (ccword @ XB2)) @ (cwcel @ XX @ (ccword @ XB2))) => ((cco @ XG @ (cco @ XW @ XX @ ccconcat) @ ccgsu) = (cco @ (cco @ XG @ XW @ ccgsu) @ (cco @ XG @ XX @ ccgsu) @ Xc_pl))))))))))).
