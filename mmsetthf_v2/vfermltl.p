...
thf(aphiprm_ax,axiom,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprime) => ((ccfv @ XP @ ccphi) = (cco @ XP @ cc1 @ ccmin))))).
...
thf(cvfermltl_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ ccz) @ (~ (cwbr @ XP @ XA2 @ ccdvds))) => ((cco @ (cco @ XA2 @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ XP @ ccmo) = cc1))))).
