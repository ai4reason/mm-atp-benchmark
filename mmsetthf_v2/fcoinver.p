...
thf(afuncocnv2_ax,axiom,(! [XF:($i > $o)] : ((cwfun @ XF) => ((cccom @ XF @ (cccnv @ XF)) = (ccres @ ccid @ (ccrn @ XF)))))).
...
thf(cfcoinver_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwfn @ XF @ XX) => (cwer @ XX @ (cccom @ (cccnv @ XF) @ XF)))))).
