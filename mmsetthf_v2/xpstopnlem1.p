...
thf(apt1hmeo_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XK = (ccfv @ (ccsn @ (ccop @ XA2 @ XJ)) @ ccpt)) => ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3)))) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccsn @ (ccop @ XA2 @ (ccv @ Xx3))))) @ (cco @ XJ @ XK @ cchmeo))))))))))))).
...
thf(axpscg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cccnv @ (cco @ (ccsn @ XA2) @ (ccsn @ XB2) @ cccda)) = (ccpr @ (ccop @ cc0 @ XA2) @ (ccop @ cc1o @ XB2))))))))).
...
thf(axpscf_ax,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwf @ cc2o @ XA2 @ (cccnv @ (cco @ (ccsn @ XX) @ (ccsn @ XY) @ cccda))) <=> ((cwcel @ XX @ XA2) & (cwcel @ XY @ XA2))))))).
