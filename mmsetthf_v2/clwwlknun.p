...
thf(cclwwlknun_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XG @ ccusgr) => ((cco @ XN @ XG @ ccclwwlkn) = (cciun @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XN @ (ccfv @ XG @ ccclwwlknon))))))))))).
