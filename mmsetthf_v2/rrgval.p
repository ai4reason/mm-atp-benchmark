...
thf(adf_rlreg_ax,axiom,(ccrlreg = (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xr) @ ccmulr)) = (ccfv @ (ccv @ Xr) @ cc0g)) => ((ccv @ Xy1) = (ccfv @ (ccv @ Xr) @ cc0g)))) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xr) @ ccbs)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xr) @ ccbs))))))).
