...
thf(ccoe1subfv_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xc_mi = (ccfv @ XY @ ccsg)) => ((XN = (ccfv @ XR @ ccsg)) => (((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XB2)) & (cwcel @ XX @ ccn0)) => ((ccfv @ XX @ (ccfv @ (cco @ XF @ XG @ Xc_mi) @ ccco1)) = (cco @ (ccfv @ XX @ (ccfv @ XF @ ccco1)) @ (ccfv @ XX @ (ccfv @ XG @ ccco1)) @ XN)))))))))))))))).
