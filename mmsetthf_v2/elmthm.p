...
thf(amppspst_ax,axiom,(! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : ((XP = (ccfv @ XT @ ccmpst)) => ((XJ = (ccfv @ XT @ ccmpps)) => (cwss @ XJ @ XP))))))).
...
thf(amsrrcl_ax,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccfv @ XT @ ccmpst)) => ((XR = (ccfv @ XT @ ccmsr)) => (((ccfv @ XX @ XR) = (ccfv @ XY @ XR)) => ((cwcel @ XX @ XP) <=> (cwcel @ XY @ XP))))))))))).
thf(celmthm_conj,conjecture,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XR = (ccfv @ XT @ ccmsr)) => ((XJ = (ccfv @ XT @ ccmpps)) => ((! [Xx3:$i] : ((XU @ Xx3) = (ccfv @ XT @ ccmthm))) => (! [Xx3:$i] : ((cwcel @ XX @ (XU @ Xx3)) <=> (cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XR) = (ccfv @ XX @ XR))) @ (^ [Xx3:$i] : XJ))))))))))))).
