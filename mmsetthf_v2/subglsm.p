...
thf(alsmvalx_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_po:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_po @ Xx3 @ Xy1) = (ccfv @ XG @ cclsm)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ (cwcel @ XG @ (XV @ Xx3 @ Xy1)) @ (cwss @ XT @ XB2) @ (cwss @ XU @ XB2)) => ((cco @ XT @ XU @ (Xc_po @ Xx3 @ Xy1)) = (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XT)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XU)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl)))))))))))))))))))).
...
thf(csubglsm_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XH = (cco @ XG @ XS @ ccress)) => ((Xc_po = (ccfv @ XG @ cclsm)) => ((XA2 = (ccfv @ XH @ cclsm)) => ((cw3a @ (cwcel @ XS @ (ccfv @ XG @ ccsubg)) @ (cwss @ XT @ XS) @ (cwss @ XU @ XS)) => ((cco @ XT @ XU @ Xc_po) = (cco @ XT @ XU @ XA2)))))))))))))).
