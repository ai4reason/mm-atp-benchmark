...
thf(afnwelem_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : ((XT @ Xx3 @ Xy1 @ Xz @ Xv @ Xu) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XA2)) & ((cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ (XR @ Xz)) | (((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xy1) @ XF)) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XS @ Xz)))))))))))))) => ((! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xy1 @ Xv @ Xu) => (cwf @ XA2 @ XB2 @ XF))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xy1 @ Xv @ Xu) => (cwwe @ XB2 @ (XR @ Xz))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xy1 @ Xv @ Xu) => (cwwe @ XA2 @ (XS @ Xz))))))) => ((! [Xy1:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xy1 @ Xv @ Xu) => (cwcel @ (ccima @ XF @ (ccv @ Xw)) @ ccvv)))))) => ((! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : ((XQ @ Xz @ Xv @ Xu) = (ccopab @ (^ [Xu:$i] : (^ [Xv:$i] : (((cwcel @ (ccv @ Xu) @ (ccxp @ XB2 @ XA2)) & (cwcel @ (ccv @ Xv) @ (ccxp @ XB2 @ XA2))) & ((cwbr @ (ccfv @ (ccv @ Xu) @ cc1st) @ (ccfv @ (ccv @ Xv) @ cc1st) @ (XR @ Xz)) | (((ccfv @ (ccv @ Xu) @ cc1st) = (ccfv @ (ccv @ Xv) @ cc1st)) & (cwbr @ (ccfv @ (ccv @ Xu) @ cc2nd) @ (ccfv @ (ccv @ Xv) @ cc2nd) @ (XS @ Xz)))))))))))) => ((! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : ((XG @ Xz @ Xv @ Xu) = (ccmpt @ (^ [Xz:$i] : XA2) @ (^ [Xz:$i] : (ccop @ (ccfv @ (ccv @ Xz) @ XF) @ (ccv @ Xz)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xy1 @ Xv @ Xu) => (cwwe @ XA2 @ (XT @ Xx3 @ Xy1 @ Xz @ Xv @ Xu))))))))))))))))))))))))).
