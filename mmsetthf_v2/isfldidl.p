...
thf(adivrngidl_ax,axiom,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XH = (ccfv @ XR @ cc2nd)) => ((XX = (ccrn @ XG)) => ((XZ = (ccfv @ XG @ ccgi)) => ((cwcel @ XR @ ccdrng) => ((ccfv @ XR @ ccidl) = (ccpr @ (ccsn @ XZ) @ XX))))))))))))).
...
thf(aisdrngo3_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XG @ Xx3 @ Xy1) = (ccfv @ XR @ cc1st)))) => ((XH = (ccfv @ XR @ cc2nd)) => ((! [Xx3:$i] : (! [Xy1:$i] : (XZ = (ccfv @ (XG @ Xx3 @ Xy1) @ ccgi)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XX = (ccrn @ (XG @ Xx3 @ Xy1))))) => ((XU = (ccfv @ XH @ ccgi)) => ((cwcel @ XR @ ccdrng) <=> ((cwcel @ XR @ ccrngo) & ((cwne @ XU @ XZ) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XH) = XU)) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : (ccdif @ XX @ (ccsn @ XZ))))))))))))))))))).
thf(asimp1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) => Xph))))).
thf(aisfld2_ax,axiom,(! [XK:($i > $o)] : ((cwcel @ XK @ ccfld) <=> ((cwcel @ XK @ ccdrng) & (cwcel @ XK @ cccring))))).
thf(cisfldidl_conj,conjecture,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XK @ cc1st)) => ((XH = (ccfv @ XK @ cc2nd)) => ((XX = (ccrn @ XG)) => ((XZ = (ccfv @ XG @ ccgi)) => ((XU = (ccfv @ XH @ ccgi)) => ((cwcel @ XK @ ccfld) <=> (cw3a @ (cwcel @ XK @ cccring) @ (cwne @ XU @ XZ) @ ((ccfv @ XK @ ccidl) = (ccpr @ (ccsn @ XZ) @ XX)))))))))))))))).
