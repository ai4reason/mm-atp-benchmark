...
thf(aeucalgval2_ax,axiom,(! [XE:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XE @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ ((ccv @ Xy1) = ccc0) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccop @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmo))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) => ((cco @ XM @ XN @ (XE @ Xx3 @ Xy1)) = (ccif @ (XN = ccc0) @ (ccop @ XM @ XN) @ (ccop @ XN @ (cco @ XM @ XN @ ccmo)))))))))))).
...
thf(ceucalgval_conj,conjecture,(! [XE:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XE @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ ((ccv @ Xy1) = ccc0) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccop @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmo))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XX @ (ccxp @ ccn0 @ ccn0)) => ((ccfv @ XX @ (XE @ Xx3 @ Xy1)) = (ccif @ ((ccfv @ XX @ cc2nd) = ccc0) @ XX @ (ccop @ (ccfv @ XX @ cc2nd) @ (ccfv @ XX @ ccmo))))))))))).
