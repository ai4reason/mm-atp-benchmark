...
thf(apw2m1lepw2m1_ax,axiom,(! [XI:($i > $o)] : ((cwcel @ XI @ ccn) => (cwbr @ (cco @ cc2 @ (cco @ XI @ cc1 @ ccmin) @ ccexp) @ (cco @ (cco @ cc2 @ XI @ ccexp) @ cc1 @ ccmin) @ ccle)))).
...
thf(clogbpw2m1_conj,conjecture,(! [XI:($i > $o)] : ((cwcel @ XI @ ccn) => ((ccfv @ (cco @ cc2 @ (cco @ (cco @ cc2 @ XI @ ccexp) @ cc1 @ ccmin) @ cclogb) @ ccfl) = (cco @ XI @ cc1 @ ccmin))))).
