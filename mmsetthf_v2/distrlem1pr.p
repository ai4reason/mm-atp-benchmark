...
thf(cdistrlem1pr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccnp) @ (cwcel @ XB2 @ ccnp) @ (cwcel @ XC @ ccnp)) => (cwss @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccpp) @ ccmp) @ (cco @ (cco @ XA2 @ XB2 @ ccmp) @ (cco @ XA2 @ XC @ ccmp) @ ccpp))))))).
