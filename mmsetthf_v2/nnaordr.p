...
thf(cnnaordr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom) @ (cwcel @ XC @ ccom)) => ((cwcel @ XA2 @ XB2) <=> (cwcel @ (cco @ XA2 @ XC @ ccoa) @ (cco @ XB2 @ XC @ ccoa)))))))).
