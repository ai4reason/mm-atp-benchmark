...
thf(asinhalfpi_ax,axiom,((ccfv @ (cco @ ccpi @ cc2 @ ccdiv) @ ccsin) = cc1)).
...
thf(amsqge0i_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwbr @ ccc0 @ (cco @ XA2 @ XA2 @ ccmul) @ ccle)))).
...
thf(asqrt2re_ax,axiom,(cwcel @ (ccfv @ cc2 @ ccsqrt) @ ccr)).
...
thf(asqrtmsqi_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwbr @ ccc0 @ XA2 @ ccle) => ((ccfv @ (cco @ XA2 @ XA2 @ ccmul) @ ccsqrt) = XA2))))).
thf(csincos4thpi_conj,conjecture,(((ccfv @ (cco @ ccpi @ cc4 @ ccdiv) @ ccsin) = (cco @ cc1 @ (ccfv @ cc2 @ ccsqrt) @ ccdiv)) & ((ccfv @ (cco @ ccpi @ cc4 @ ccdiv) @ cccos) = (cco @ cc1 @ (ccfv @ cc2 @ ccsqrt) @ ccdiv)))).
