...
thf(areeftlcl_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : (((cwcel @ XA2 @ ccr) & (cwcel @ XM @ ccn0)) => (cwcel @ (ccsu @ (ccfv @ XM @ ccuz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xn)))) @ ccr)))))))).
...
thf(aiserabs_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((! [Xk:$i] : (Xph => (cwbr @ (ccseq @ ccaddc @ XF @ XM) @ (XA2 @ Xk) @ ccli))) => ((! [Xk:$i] : (Xph => (cwbr @ (ccseq @ ccaddc @ XG @ XM) @ (XB2 @ Xk) @ ccli))) => ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XG) = (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ ccabs)))) => (! [Xk:$i] : (Xph => (cwbr @ (ccfv @ (XA2 @ Xk) @ ccabs) @ (XB2 @ Xk) @ ccle))))))))))))))))).
...
thf(aeftabs_ax,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XK @ ccn0)) => ((ccfv @ (cco @ (cco @ XA2 @ XK @ ccexp) @ (ccfv @ XK @ ccfa) @ ccdiv) @ ccabs) = (cco @ (cco @ (ccfv @ XA2 @ ccabs) @ XK @ ccexp) @ (ccfv @ XK @ ccfa) @ ccdiv)))))).
...
thf(afaclbnd6_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XM @ ccn0)) => (cwbr @ (cco @ (ccfv @ XN @ ccfa) @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XM @ ccexp) @ ccmul) @ (ccfv @ (cco @ XN @ XM @ ccaddc) @ ccfa) @ ccle))))).
