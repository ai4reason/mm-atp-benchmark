...
thf(apjomli_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccsh) => (((cwss @ XA2 @ XB2) & ((ccin @ XB2 @ (ccfv @ XA2 @ ccort)) = cc0h)) => (XA2 = XB2))))))).
...
thf(cpjoml_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccsh)) & ((cwss @ XA2 @ XB2) & ((ccin @ XB2 @ (ccfv @ XA2 @ ccort)) = cc0h))) => (XA2 = XB2))))).
