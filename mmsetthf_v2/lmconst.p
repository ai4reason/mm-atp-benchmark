...
thf(clmconst_conj,conjecture,(! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XP @ XX) @ (cwcel @ XM @ ccz)) => (cwbr @ (ccxp @ XZ @ (ccsn @ XP)) @ XP @ (ccfv @ XJ @ cclm)))))))))).
