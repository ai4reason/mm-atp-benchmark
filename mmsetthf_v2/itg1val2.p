...
thf(citg1val2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ (ccdm @ ccitg1)) & (cw3a @ (cwcel @ XA2 @ ccfn) @ (cwss @ (ccdif @ (ccrn @ XF) @ (ccsn @ ccc0)) @ XA2) @ (cwss @ XA2 @ (ccdif @ ccr @ (ccsn @ ccc0))))) => ((ccfv @ XF @ ccitg1) = (ccsu @ XA2 @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xx3))) @ ccvol) @ ccmul)))))))).
