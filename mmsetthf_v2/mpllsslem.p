...
thf(amplsubglem_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XS @ Xx3) = (cco @ (XI @ Xx3 @ Xy1 @ Xg1) @ (XR @ Xx3 @ Xy1 @ Xf1 @ Xg1) @ ccmps)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xx3 @ Xy1) = (ccfv @ (XS @ Xx3) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (Xc_0 = (ccfv @ (XR @ Xx3 @ Xy1 @ Xf1 @ Xg1) @ cc0g)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XD @ Xx3 @ Xy1 @ Xf1) = (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ (XI @ Xx3 @ Xy1 @ Xg1) @ ccmap)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xf1 @ Xg1) => (cwcel @ (XI @ Xx3 @ Xy1 @ Xg1) @ (XW @ Xx3 @ Xy1 @ Xf1 @ Xg1))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xf1 @ Xg1) => (cwcel @ cc0 @ XA2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (((Xph @ Xf1 @ Xg1) & ((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XA2))) => (cwcel @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XA2)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (((Xph @ Xf1 @ Xg1) & ((cwcel @ (ccv @ Xx3) @ XA2) & (cwss @ (ccv @ Xy1) @ (ccv @ Xx3)))) => (cwcel @ (ccv @ Xy1) @ XA2)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xf1 @ Xg1) => ((XU @ Xx3 @ Xy1 @ Xf1 @ Xg1) = (ccrab @ (^ [Xg1:$i] : (cwcel @ (cco @ (ccv @ Xg1) @ Xc_0 @ ccsupp) @ XA2)) @ (^ [Xg1:$i] : (XB2 @ Xx3 @ Xy1))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xf1 @ Xg1) => (cwcel @ (XR @ Xx3 @ Xy1 @ Xf1 @ Xg1) @ ccgrp)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xf1 @ Xg1) => (cwcel @ (XU @ Xx3 @ Xy1 @ Xf1 @ Xg1) @ (ccfv @ (XS @ Xx3) @ ccsubg)))))))))))))))))))))))))))).
...
thf(aspcgv_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> Xps))) => (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((! [Xx3:$i] : (Xph @ Xx3)) => Xps))))))))).
