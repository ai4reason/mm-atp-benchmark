...
thf(clvoli_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XC = (ccfv @ XK @ cccvr)) => ((XP = (ccfv @ XK @ cclpl)) => ((XV = (ccfv @ XK @ cclvol)) => (((cw3a @ (cwcel @ XK @ XD) @ (cwcel @ XY @ XB2) @ (cwcel @ XX @ XP)) & (cwbr @ XX @ XY @ XC)) => (cwcel @ XY @ XV))))))))))))))).
