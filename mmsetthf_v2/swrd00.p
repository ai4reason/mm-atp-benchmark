...
thf(adf_substr_ax,axiom,(ccsubstr = (ccmpt2 @ (^ [Xs1:$i] : (^ [Xb:$i] : ccvv)) @ (^ [Xs1:$i] : (^ [Xb:$i] : (ccxp @ ccz @ ccz))) @ (^ [Xs1:$i] : (^ [Xb:$i] : (ccif @ (cwss @ (cco @ (ccfv @ (ccv @ Xb) @ cc1st) @ (ccfv @ (ccv @ Xb) @ cc2nd) @ ccfzo) @ (ccdm @ (ccv @ Xs1))) @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (cco @ (ccfv @ (ccv @ Xb) @ cc2nd) @ (ccfv @ (ccv @ Xb) @ cc1st) @ ccmin) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xb) @ cc1st) @ ccaddc) @ (ccv @ Xs1)))) @ cc0)))))).
...
thf(cswrd00_conj,conjecture,(! [XS:($i > $o)] : (! [XX:($i > $o)] : ((cco @ XS @ (ccop @ XX @ XX) @ ccsubstr) = cc0)))).
