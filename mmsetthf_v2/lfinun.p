...
thf(alocfintop_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ XJ @ cclocfin)) => (cwcel @ XJ @ cctop))))).
...
thf(clfinun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccfv @ XJ @ cclocfin)) @ (cwcel @ XB2 @ ccfn) @ (cwss @ (ccuni @ XB2) @ (ccuni @ XJ))) => (cwcel @ (ccun @ XA2 @ XB2) @ (ccfv @ XJ @ cclocfin))))))).
