...
thf(auzwo3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XB2 @ ccr) & ((cwss @ XA2 @ (ccrab @ (^ [Xz:$i] : (cwbr @ XB2 @ (ccv @ Xz) @ ccle)) @ (^ [Xz:$i] : ccz))) & (cwne @ XA2 @ cc0))) => (cwreu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
...
thf(czmin_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwreu @ (^ [Xx3:$i] : ((cwbr @ XA2 @ (ccv @ Xx3) @ ccle) & (cwral @ (^ [Xy1:$i] : ((cwbr @ XA2 @ (ccv @ Xy1) @ ccle) => (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle))) @ (^ [Xy1:$i] : ccz)))) @ (^ [Xx3:$i] : ccz))))).
