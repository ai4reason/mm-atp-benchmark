...
thf(anmoleub2lem_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (XN = (cco @ XS @ (XT @ Xx3) @ ccnmo))) => ((XV = (ccfv @ XS @ ccbs)) => ((XL = (ccfv @ XS @ ccnm)) => ((! [Xx3:$i] : (XM = (ccfv @ (XT @ Xx3) @ ccnm))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XG @ Xx3 @ Xy1) = (ccfv @ XS @ ccsca)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XK @ Xx3 @ Xy1) = (ccfv @ (XG @ Xx3 @ Xy1) @ ccbs)))) => ((Xph => (cwcel @ XS @ (ccin @ ccnlm @ ccclm))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XT @ Xx3) @ (ccin @ ccnlm @ ccclm)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XF @ (cco @ XS @ (XT @ Xx3) @ cclmhm)))) => ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XR @ ccrp)) => (((Xph & (cwral @ (^ [Xx3:$i] : ((Xps @ Xx3) => (cwbr @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XM) @ XR @ ccdiv) @ XA2 @ ccle))) @ (^ [Xx3:$i] : XV))) => (cwbr @ ccc0 @ XA2 @ ccle)) => ((! [Xy1:$i] : ((((Xph & (cwral @ (^ [Xx3:$i] : ((Xps @ Xx3) => (cwbr @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XM) @ XR @ ccdiv) @ XA2 @ ccle))) @ (^ [Xx3:$i] : XV))) & (cwcel @ XA2 @ ccr)) & ((cwcel @ (ccv @ Xy1) @ XV) & (cwne @ (ccv @ Xy1) @ (ccfv @ XS @ cc0g)))) => (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ XM) @ (cco @ XA2 @ (ccfv @ (ccv @ Xy1) @ XL) @ ccmul) @ ccle))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XV)) => ((Xps @ Xx3) => (cwbr @ (ccfv @ (ccv @ Xx3) @ XL) @ XR @ ccle)))) => (Xph => ((cwbr @ (ccfv @ XF @ XN) @ XA2 @ ccle) <=> (cwral @ (^ [Xx3:$i] : ((Xps @ Xx3) => (cwbr @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XM) @ XR @ ccdiv) @ XA2 @ ccle))) @ (^ [Xx3:$i] : XV)))))))))))))))))))))))))))))))).
