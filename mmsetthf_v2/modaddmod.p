...
thf(cmodaddmod_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XM @ ccrp)) => ((cco @ (cco @ (cco @ XA2 @ XM @ ccmo) @ XB2 @ ccaddc) @ XM @ ccmo) = (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XM @ ccmo))))))).
