...
thf(amzpval_ax,axiom,(! [XV:($i > $o)] : ((cwcel @ XV @ ccvv) => ((ccfv @ XV @ ccmzp) = (ccint @ (ccfv @ XV @ ccmzpcl)))))).
thf(ampbird_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xch) => ((Xph => (Xps <=> Xch)) => (Xph => Xps))))))).
thf(ajca32_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xph => Xch) => ((Xph => Xth) => (Xph => (Xps & (Xch & Xth))))))))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(cwf_tp,type,(cwf : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(amzpclall_ax,axiom,(! [XV:($i > $o)] : ((cwcel @ XV @ ccvv) => (cwcel @ (cco @ ccz @ (cco @ ccz @ XV @ ccmap) @ ccmap) @ (ccfv @ XV @ ccmzpcl))))).
...
thf(amzpcl1_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XP @ (ccfv @ XV @ ccmzpcl)) & (cwcel @ XF @ ccz)) => (cwcel @ (ccxp @ (cco @ ccz @ XV @ ccmap) @ (ccsn @ XF)) @ XP)))))).
...
thf(amzpcl2_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XP @ (ccfv @ XV @ ccmzpcl)) & (cwcel @ XF @ XV)) => (cwcel @ (ccmpt @ (^ [Xg1:$i] : (cco @ ccz @ XV @ ccmap)) @ (^ [Xg1:$i] : (ccfv @ XF @ (ccv @ Xg1)))) @ XP)))))).
...
thf(amzpcl34_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XP @ (ccfv @ XV @ ccmzpcl)) @ (cwcel @ XF @ XP) @ (cwcel @ XG @ XP)) => ((cwcel @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ XP) & (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ XP)))))))).
...
thf(aelmzpcl_b_ax,axiom,(! [XP:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XV @ ccvv) => ((cwcel @ XP @ (ccfv @ XV @ ccmzpcl)) <=> ((cwss @ XP @ (cco @ ccz @ (cco @ ccz @ XV @ ccmap) @ ccmap)) & (((cwral @ (^ [Xf1:$i] : (cwcel @ (ccxp @ (cco @ ccz @ XV @ ccmap) @ (ccsn @ (ccv @ Xf1))) @ XP)) @ (^ [Xf1:$i] : ccz)) & (cwral @ (^ [Xf1:$i] : (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccz @ XV @ ccmap)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xf1) @ (ccv @ Xx3)))) @ XP)) @ (^ [Xf1:$i] : XV))) & (cwral @ (^ [Xf1:$i] : (cwral @ (^ [Xx3:$i] : ((cwcel @ (cco @ (ccv @ Xf1) @ (ccv @ Xx3) @ (ccof @ ccaddc)) @ XP) & (cwcel @ (cco @ (ccv @ Xf1) @ (ccv @ Xx3) @ (ccof @ ccmul)) @ XP))) @ (^ [Xx3:$i] : XP))) @ (^ [Xf1:$i] : XP))))))))).
thf(cmzpincl_conj,conjecture,(! [XV:($i > $o)] : ((cwcel @ XV @ ccvv) => (cwcel @ (ccfv @ XV @ ccmzp) @ (ccfv @ XV @ ccmzpcl))))).
