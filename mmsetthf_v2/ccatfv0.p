...
thf(cccatfv0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV)) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ cchash) @ cclt)) => ((ccfv @ ccc0 @ (cco @ XA2 @ XB2 @ ccconcat)) = (ccfv @ ccc0 @ XA2))))))).
