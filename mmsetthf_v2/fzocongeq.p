...
thf(afzomaxdif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ (cco @ XC @ XD @ ccfzo)) & (cwcel @ XB2 @ (cco @ XC @ XD @ ccfzo))) => (cwcel @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ (cco @ ccc0 @ (cco @ XD @ XC @ ccmin) @ ccfzo)))))))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(ccn0_tp,type,(ccn0 : ($i > $o))).
thf(ccdif_tp,type,(ccdif : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccn_tp,type,(ccn : ($i > $o))).
thf(cclt_tp,type,(cclt : ($i > $o))).
thf(afzo0dvdseq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ (cco @ ccc0 @ XA2 @ ccfzo)) => ((cwbr @ XA2 @ XB2 @ ccdvds) <=> (XB2 = ccc0)))))).
