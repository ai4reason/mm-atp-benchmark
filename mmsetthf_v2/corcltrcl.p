...
thf(arelexpss1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwss @ XA2 @ XB2)) => ((Xph => (cwcel @ XB2 @ ccvv)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => (cwss @ (cco @ XA2 @ XN @ ccrelexp) @ (cco @ XB2 @ XN @ ccrelexp))))))))))).
...
thf(aiunrelexp0_ax,axiom,(! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cw3a @ (cwcel @ XR @ XV) @ (cwss @ XZ @ ccn0) @ (cwne @ (ccin @ (ccpr @ ccc0 @ cc1) @ XZ) @ cc0)) => ((cco @ (cciun @ (^ [Xx3:$i] : XZ) @ (^ [Xx3:$i] : (cco @ XR @ (ccv @ Xx3) @ ccrelexp))) @ ccc0 @ ccrelexp) = (cco @ XR @ ccc0 @ ccrelexp))))))).
