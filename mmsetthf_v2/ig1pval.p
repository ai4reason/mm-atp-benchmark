...
thf(adf_ig1p_ax,axiom,(ccig1p = (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccmpt @ (^ [Xi:$i] : (ccfv @ (ccfv @ (ccv @ Xr) @ ccpl1) @ cclidl)) @ (^ [Xi:$i] : (ccif @ ((ccv @ Xi) = (ccsn @ (ccfv @ (ccfv @ (ccv @ Xr) @ ccpl1) @ cc0g))) @ (ccfv @ (ccfv @ (ccv @ Xr) @ ccpl1) @ cc0g) @ (ccrio @ (^ [Xg1:$i] : ((ccfv @ (ccv @ Xg1) @ (ccfv @ (ccv @ Xr) @ ccdg1)) = (ccinf @ (ccima @ (ccfv @ (ccv @ Xr) @ ccdg1) @ (ccdif @ (ccv @ Xi) @ (ccsn @ (ccfv @ (ccfv @ (ccv @ Xr) @ ccpl1) @ cc0g)))) @ ccr @ cclt))) @ (^ [Xg1:$i] : (ccin @ (ccv @ Xi) @ (ccfv @ (ccv @ Xr) @ ccmn1))))))))))).
