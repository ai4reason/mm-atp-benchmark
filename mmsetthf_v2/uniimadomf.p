...
thf(auniimadom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (((cwfun @ XF) & (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ XB2 @ ccdom)) @ (^ [Xx3:$i] : XA2))) => (cwbr @ (ccuni @ (ccima @ XF @ XA2)) @ (ccxp @ XA2 @ XB2) @ ccdom)))))))).
thf(cuniimadomf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (! [Xx3:$i] : (((cwfun @ (XF @ Xx3)) & (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ XB2 @ ccdom)) @ (^ [Xx3:$i] : XA2))) => (cwbr @ (ccuni @ (ccima @ (XF @ Xx3) @ XA2)) @ (ccxp @ XA2 @ XB2) @ ccdom)))))))))).
