...
thf(agimco_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (cco @ XT @ XU @ ccgim)) & (cwcel @ XG @ (cco @ XS @ XT @ ccgim))) => (cwcel @ (cccom @ XF @ XG) @ (cco @ XS @ XU @ ccgim))))))))).
thf(abrgici_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (cco @ XR @ XS @ ccgim)) => (cwbr @ XR @ XS @ ccgic)))))).
thf(cgictr_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (((cwbr @ XR @ XS @ ccgic) & (cwbr @ XS @ XT @ ccgic)) => (cwbr @ XR @ XT @ ccgic)))))).
