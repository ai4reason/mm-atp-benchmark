...
thf(coddvdsnn0_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((cw3a @ (cwcel @ XG @ ccmnd) @ (cwcel @ XA2 @ XX) @ (cwcel @ XN @ ccn0)) => ((cwbr @ (ccfv @ XA2 @ XO) @ XN @ ccdvds) <=> ((cco @ XN @ XA2 @ Xc_x) = Xc_0))))))))))))))).
