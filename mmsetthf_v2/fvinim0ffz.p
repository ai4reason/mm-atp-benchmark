...
thf(cfvinim0ffz_conj,conjecture,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (((cwf @ (cco @ ccc0 @ XK @ ccfz) @ XV @ XF) & (cwcel @ XK @ ccn0)) => (((ccin @ (ccima @ XF @ (ccpr @ ccc0 @ XK)) @ (ccima @ XF @ (cco @ cc1 @ XK @ ccfzo))) = cc0) <=> ((cwnel @ (ccfv @ ccc0 @ XF) @ (ccima @ XF @ (cco @ cc1 @ XK @ ccfzo))) & (cwnel @ (ccfv @ XK @ XF) @ (ccima @ XF @ (cco @ cc1 @ XK @ ccfzo)))))))))).
