...
thf(cnlly2i_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : ((cw3a @ (cwcel @ XJ @ (ccnlly @ XA2)) @ (cwcel @ XU @ XJ) @ (cwcel @ XP @ XU)) => (cwrex @ (^ [Xs1:$i] : (cwrex @ (^ [Xu:$i] : (cw3a @ (cwcel @ XP @ (ccv @ Xu)) @ (cwss @ (ccv @ Xu) @ (ccv @ Xs1)) @ (cwcel @ (cco @ XJ @ (ccv @ Xs1) @ ccrest) @ XA2))) @ (^ [Xu:$i] : XJ))) @ (^ [Xs1:$i] : (ccpw @ XU))))))))).
