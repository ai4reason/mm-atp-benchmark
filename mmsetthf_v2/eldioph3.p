...
thf(celdioph3_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XP @ (ccfv @ ccn @ ccmzp))) => (cwcel @ (ccab @ (^ [Xt:$i] : (cwrex @ (^ [Xu:$i] : (((ccv @ Xt) = (ccres @ (ccv @ Xu) @ (cco @ cc1 @ XN @ ccfz))) & ((ccfv @ (ccv @ Xu) @ XP) = ccc0))) @ (^ [Xu:$i] : (cco @ ccn0 @ ccn @ ccmap))))) @ (ccfv @ XN @ ccdioph)))))).
