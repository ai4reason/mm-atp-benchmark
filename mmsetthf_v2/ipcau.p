...
thf(acphtchnm_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XW @ cctch)) => ((XN = (ccfv @ XW @ ccnm)) => ((cwcel @ XW @ cccph) => (XN = (ccfv @ XG @ ccnm))))))))).
thf(cipcau_conj,conjecture,(! [Xc_xi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((XN = (ccfv @ XW @ ccnm)) => ((cw3a @ (cwcel @ XW @ cccph) @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV)) => (cwbr @ (ccfv @ (cco @ XX @ XY @ Xc_xi) @ ccabs) @ (cco @ (ccfv @ XX @ XN) @ (ccfv @ XY @ XN) @ ccmul) @ ccle)))))))))))).
