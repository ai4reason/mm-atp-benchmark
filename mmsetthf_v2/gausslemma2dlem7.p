...
thf(agausslemma2dlem6_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XH = (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((! [Xx3:$i] : ((XR @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XH @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ cc2 @ ccdiv) @ cclt) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ ccmin)))))) => ((XM = (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => ((! [Xx3:$i] : ((XN @ Xx3) = (cco @ XH @ XM @ ccmin))) => (! [Xx3:$i] : (Xph => ((cco @ (ccfv @ XH @ ccfa) @ XP @ ccmo) = (cco @ (cco @ (cco @ (cco @ (ccneg @ cc1) @ (XN @ Xx3) @ ccexp) @ (cco @ cc2 @ XH @ ccexp) @ ccmul) @ (ccfv @ XH @ ccfa) @ ccmul) @ XP @ ccmo)))))))))))))))).
...
thf(agausslemma2dlem0c_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XH:($i > $o)] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XH = (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => (Xph => ((cco @ (ccfv @ XH @ ccfa) @ XP @ ccgcd) = cc1)))))))).
thf(acncongrcoprm_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz)) & ((cwcel @ XN @ ccn) & ((cco @ XC @ XN @ ccgcd) = cc1))) => (((cco @ (cco @ XA2 @ XC @ ccmul) @ XN @ ccmo) = (cco @ (cco @ XB2 @ XC @ ccmul) @ XN @ ccmo)) <=> ((cco @ XA2 @ XN @ ccmo) = (cco @ XB2 @ XN @ ccmo))))))))).
