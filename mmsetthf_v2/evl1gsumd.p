...
thf(aevl1gsumdlem_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > $o))] : (! [Xm:$i] : (! [XM:($i > ($i > ($i > $o)))] : (! [XO:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xa:$i] : ((XO @ Xa) = (ccfv @ (XR @ Xx3 @ Xa) @ cce1)))) => ((! [Xx3:$i] : (! [Xa:$i] : ((XP @ Xx3 @ Xa) = (ccfv @ (XR @ Xx3 @ Xa) @ ccpl1)))) => ((! [Xx3:$i] : (! [Xa:$i] : ((XB2 @ Xx3 @ Xa) = (ccfv @ (XR @ Xx3 @ Xa) @ ccbs)))) => ((! [Xx3:$i] : (! [Xa:$i] : ((XU @ Xa) = (ccfv @ (XP @ Xx3 @ Xa) @ ccbs)))) => ((! [Xx3:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xa) => (cwcel @ (XR @ Xx3 @ Xa) @ cccrg)))) => ((! [Xx3:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xa) => (cwcel @ (XY @ Xa) @ (XB2 @ Xx3 @ Xa))))) => (! [Xx3:$i] : (! [Xa:$i] : ((cw3a @ (cwcel @ (ccv @ Xm) @ ccfn) @ (~ (cwcel @ (ccv @ Xa) @ (ccv @ Xm))) @ (Xph @ Xx3 @ Xa)) => (((cwral @ (^ [Xx3:$i] : (cwcel @ (XM @ Xx3 @ Xa) @ (XU @ Xa))) @ (^ [Xx3:$i] : (ccv @ Xm))) => ((ccfv @ (XY @ Xa) @ (ccfv @ (cco @ (XP @ Xx3 @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xm)) @ (^ [Xx3:$i] : (XM @ Xx3 @ Xa))) @ ccgsu) @ (XO @ Xa))) = (cco @ (XR @ Xx3 @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xm)) @ (^ [Xx3:$i] : (ccfv @ (XY @ Xa) @ (ccfv @ (XM @ Xx3 @ Xa) @ (XO @ Xa))))) @ ccgsu))) => ((cwral @ (^ [Xx3:$i] : (cwcel @ (XM @ Xx3 @ Xa) @ (XU @ Xa))) @ (^ [Xx3:$i] : (ccun @ (ccv @ Xm) @ (ccsn @ (ccv @ Xa))))) => ((ccfv @ (XY @ Xa) @ (ccfv @ (cco @ (XP @ Xx3 @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccun @ (ccv @ Xm) @ (ccsn @ (ccv @ Xa)))) @ (^ [Xx3:$i] : (XM @ Xx3 @ Xa))) @ ccgsu) @ (XO @ Xa))) = (cco @ (XR @ Xx3 @ Xa) @ (ccmpt @ (^ [Xx3:$i] : (ccun @ (ccv @ Xm) @ (ccsn @ (ccv @ Xa)))) @ (^ [Xx3:$i] : (ccfv @ (XY @ Xa) @ (ccfv @ (XM @ Xx3 @ Xa) @ (XO @ Xa))))) @ ccgsu))))))))))))))))))))))).
thf(aimpexp_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) => Xch) <=> (Xph => (Xps => Xch))))))).
thf(cevl1gsumd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XY:($i > $o)] : ((XO = (ccfv @ XR @ cce1)) => ((! [Xx3:$i] : ((XP @ Xx3) = (ccfv @ XR @ ccpl1))) => ((XB2 = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : (XU = (ccfv @ (XP @ Xx3) @ ccbs))) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwcel @ (XM @ Xx3) @ XU)) @ (^ [Xx3:$i] : XN))) => ((Xph => (cwcel @ XN @ ccfn)) => (! [Xx3:$i] : (Xph => ((ccfv @ XY @ (ccfv @ (cco @ (XP @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XN) @ (^ [Xx3:$i] : (XM @ Xx3))) @ ccgsu) @ XO)) = (cco @ XR @ (ccmpt @ (^ [Xx3:$i] : XN) @ (^ [Xx3:$i] : (ccfv @ XY @ (ccfv @ (XM @ Xx3) @ XO)))) @ ccgsu)))))))))))))))))))))).
