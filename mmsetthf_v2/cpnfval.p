...
thf(adf_cpn_ax,axiom,(cccpn = (ccmpt @ (^ [Xs1:$i] : (ccpw @ ccc)) @ (^ [Xs1:$i] : (ccmpt @ (^ [Xx3:$i] : ccn0) @ (^ [Xx3:$i] : (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (cco @ (ccv @ Xs1) @ (ccv @ Xf1) @ ccdvn)) @ (cco @ (ccdm @ (ccv @ Xf1)) @ ccc @ cccncf))) @ (^ [Xf1:$i] : (cco @ ccc @ (ccv @ Xs1) @ ccpm))))))))).
...
thf(ccpnfval_conj,conjecture,(! [XS:($i > $o)] : ((cwss @ XS @ ccc) => ((ccfv @ XS @ cccpn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccfv @ (ccv @ Xn) @ (cco @ XS @ (ccv @ Xf1) @ ccdvn)) @ (cco @ (ccdm @ (ccv @ Xf1)) @ ccc @ cccncf))) @ (^ [Xf1:$i] : (cco @ ccc @ XS @ ccpm))))))))).
