...
thf(aupgrle_ax,axiom,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ cciedg)) => ((cw3a @ (cwcel @ XG @ ccupgr) @ (cwfn @ XE @ XA2) @ (cwcel @ XF @ XA2)) => (cwbr @ (ccfv @ (ccfv @ XF @ XE) @ cchash) @ cc2 @ ccle)))))))))).
...
thf(cupgrfi_conj,conjecture,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ cciedg)) => ((cw3a @ (cwcel @ XG @ ccupgr) @ (cwfn @ XE @ XA2) @ (cwcel @ XF @ XA2)) => (cwcel @ (ccfv @ XF @ XE) @ ccfn)))))))))).
