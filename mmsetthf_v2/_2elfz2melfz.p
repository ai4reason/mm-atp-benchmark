...
thf(c_2elfz2melfz_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ XN @ ccfz)) & (cwcel @ XB2 @ (cco @ ccc0 @ XN @ ccfz))) => ((cwbr @ XN @ (cco @ XA2 @ XB2 @ ccaddc) @ cclt) => (cwcel @ (cco @ XB2 @ (cco @ XN @ XA2 @ ccmin) @ ccmin) @ (cco @ ccc0 @ XA2 @ ccfz)))))))).
