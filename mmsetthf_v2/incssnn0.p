...
thf(cincssnn0_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [Xx3:$i] : ((cw3a @ (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XF))) @ (^ [Xx3:$i] : ccn0)) @ (cwcel @ (XA2 @ Xx3) @ ccn0) @ (cwcel @ (XB2 @ Xx3) @ (ccfv @ (XA2 @ Xx3) @ ccuz))) => (cwss @ (ccfv @ (XA2 @ Xx3) @ XF) @ (ccfv @ (XB2 @ Xx3) @ XF)))))))).
