...
thf(aelcncf1di_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XZ:($i > ($i > ($i > $o)))] : ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ ccrp)) => (cwcel @ (XZ @ Xx3 @ Xy1) @ ccrp))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (Xph => ((((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xw) @ XA2)) & (cwcel @ (ccv @ Xy1) @ ccrp)) => ((cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xw) @ ccmin) @ ccabs) @ (XZ @ Xx3 @ Xy1) @ cclt) => (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xw) @ XF) @ ccmin) @ ccabs) @ (ccv @ Xy1) @ cclt))))))) => (Xph => (((cwss @ XA2 @ ccc) & (cwss @ XB2 @ ccc)) => (cwcel @ XF @ (cco @ XA2 @ XB2 @ cccncf))))))))))))).
