...
thf(asuppval1_ax,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cw3a @ (cwfun @ XX) @ (cwcel @ XX @ XV) @ (cwcel @ XZ @ XW)) => ((cco @ XX @ XZ @ ccsupp) = (ccrab @ (^ [Xi:$i] : (cwne @ (ccfv @ (ccv @ Xi) @ XX) @ XZ)) @ (^ [Xi:$i] : (ccdm @ XX)))))))))).
...
thf(cmndpsuppss_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XR = (ccfv @ XM @ ccbs)) => ((((cwcel @ XM @ ccmnd) & (cwcel @ XV @ XX)) & ((cwcel @ XA2 @ (cco @ XR @ XV @ ccmap)) & (cwcel @ XB2 @ (cco @ XR @ XV @ ccmap)))) => (cwss @ (cco @ (cco @ XA2 @ XB2 @ (ccof @ (ccfv @ XM @ ccplusg))) @ (ccfv @ XM @ cc0g) @ ccsupp) @ (ccun @ (cco @ XA2 @ (ccfv @ XM @ cc0g) @ ccsupp) @ (cco @ XB2 @ (ccfv @ XM @ cc0g) @ ccsupp)))))))))))).
