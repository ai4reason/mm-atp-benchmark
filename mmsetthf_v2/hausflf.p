...
thf(chausflf_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwcel @ XJ @ ccha) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) => (cwmo @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf))))))))))))).
