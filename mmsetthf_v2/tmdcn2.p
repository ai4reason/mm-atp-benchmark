...
thf(atxcnpi_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwcel @ XJ @ (ccfv @ (XX @ Xv @ Xu) @ cctopon))))) => ((! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwcel @ XK @ (ccfv @ (XY @ Xv @ Xu) @ cctopon))))) => ((! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwcel @ XF @ (ccfv @ (ccop @ XA2 @ XB2) @ (cco @ (cco @ XJ @ XK @ cctx) @ (XL @ Xv @ Xu) @ cccnp)))))) => ((! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwcel @ XU @ (XL @ Xv @ Xu))))) => ((! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwcel @ XA2 @ (XX @ Xv @ Xu))))) => ((! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwcel @ XB2 @ (XY @ Xv @ Xu))))) => ((! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwcel @ (cco @ XA2 @ XB2 @ XF) @ XU)))) => (! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xv @ Xu) => (cwrex @ (^ [Xu:$i] : (cwrex @ (^ [Xv:$i] : (cw3a @ (cwcel @ XA2 @ (ccv @ Xu)) @ (cwcel @ XB2 @ (ccv @ Xv)) @ (cwss @ (ccxp @ (ccv @ Xu) @ (ccv @ Xv)) @ (ccima @ (cccnv @ XF) @ XU)))) @ (^ [Xv:$i] : XK))) @ (^ [Xu:$i] : XJ))))))))))))))))))))))).
...
thf(aplusffn_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pd = (ccfv @ XG @ ccplusf)) => (cwfn @ Xc_pd @ (ccxp @ XB2 @ XB2)))))))).
...
thf(ctmdcn2_conj,conjecture,(! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_pl:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : ((XB2 @ Xx3 @ Xy1 @ Xv @ Xu) = (ccfv @ XG @ ccbs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XJ @ Xx3 @ Xy1) = (ccfv @ XG @ cctopn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : ((Xc_pl @ Xx3 @ Xy1 @ Xv @ Xu) = (ccfv @ XG @ ccplusg)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : ((((cwcel @ XG @ cctmd) & (cwcel @ XU @ (XJ @ Xx3 @ Xy1))) & (cw3a @ (cwcel @ (XX @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1 @ Xv @ Xu)) @ (cwcel @ (XY @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1 @ Xv @ Xu)) @ (cwcel @ (cco @ (XX @ Xx3 @ Xy1) @ (XY @ Xx3 @ Xy1) @ (Xc_pl @ Xx3 @ Xy1 @ Xv @ Xu)) @ XU))) => (cwrex @ (^ [Xu:$i] : (cwrex @ (^ [Xv:$i] : (cw3a @ (cwcel @ (XX @ Xx3 @ Xy1) @ (ccv @ Xu)) @ (cwcel @ (XY @ Xx3 @ Xy1) @ (ccv @ Xv)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_pl @ Xx3 @ Xy1 @ Xv @ Xu)) @ XU)) @ (^ [Xy1:$i] : (ccv @ Xv)))) @ (^ [Xx3:$i] : (ccv @ Xu))))) @ (^ [Xv:$i] : (XJ @ Xx3 @ Xy1)))) @ (^ [Xu:$i] : (XJ @ Xx3 @ Xy1))))))))))))))))))).
