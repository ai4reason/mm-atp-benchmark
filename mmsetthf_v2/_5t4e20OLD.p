...
thf(adecaddci2OLD_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XN @ ccn0) => ((XM = (ccdc @ XA2 @ XB2)) => (((cco @ XA2 @ cc1 @ ccaddc) = XD) => (((cco @ XB2 @ XN @ ccaddc) = cc10) => ((cco @ XM @ XN @ ccaddc) = (ccdc @ XD @ ccc0)))))))))))))).
thf(a_1nn0_ax,axiom,(cwcel @ cc1 @ ccn0)).
thf(ccv_tp,type,(ccv : ($i > ($i > $o)))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(a_1p1e2_ax,axiom,((cco @ cc1 @ cc1 @ ccaddc) = cc2)).
thf(cc9_tp,type,(cc9 : ($i > $o))).
thf(a_5p5e10OLD_ax,axiom,((cco @ cc5 @ cc5 @ ccaddc) = cc10)).
thf(c_5t4e20OLD_conj,conjecture,((cco @ cc5 @ cc4 @ ccmul) = (ccdc @ cc2 @ ccc0))).
