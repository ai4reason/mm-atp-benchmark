...
thf(aipffval_ax,axiom,(! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_x @ Xx3 @ Xy1) = (ccfv @ XW @ ccipf)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xc_x @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XV)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XV)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_xi))))))))))))))).
...
thf(cphssip_conj,conjecture,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ XW @ XU @ ccress)) => ((XS = (ccfv @ XW @ cclss)) => ((Xc_x = (ccfv @ XW @ ccipf)) => ((XP = (ccfv @ XX @ ccipf)) => (((cwcel @ XW @ ccphl) & (cwcel @ XU @ XS)) => (XP = (ccres @ Xc_x @ (ccxp @ XU @ XU))))))))))))))).
