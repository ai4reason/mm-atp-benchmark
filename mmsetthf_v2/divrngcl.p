...
thf(asyl3an1b_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph <=> Xps) => (((cw3a @ Xps @ Xch @ Xth) => Xta) => ((cw3a @ Xph @ Xch @ Xth) => Xta))))))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(ccv_tp,type,(ccv : ($i > ($i > $o)))).
thf(cwrel_tp,type,(cwrel : (($i > $o) > $o))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aisdrngo1_ax,axiom,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XH = (ccfv @ XR @ cc2nd)) => ((XZ = (ccfv @ XG @ ccgi)) => ((XX = (ccrn @ XG)) => ((cwcel @ XR @ ccdrng) <=> ((cwcel @ XR @ ccrngo) & (cwcel @ (ccres @ XH @ (ccxp @ (ccdif @ XX @ (ccsn @ XZ)) @ (ccdif @ XX @ (ccsn @ XZ)))) @ ccgr))))))))))))).
...
thf(cdivrngcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XH = (ccfv @ XR @ cc2nd)) => ((XZ = (ccfv @ XG @ ccgi)) => ((XX = (ccrn @ XG)) => ((cw3a @ (cwcel @ XR @ ccdrng) @ (cwcel @ XA2 @ (ccdif @ XX @ (ccsn @ XZ))) @ (cwcel @ XB2 @ (ccdif @ XX @ (ccsn @ XZ)))) => (cwcel @ (cco @ XA2 @ XB2 @ XH) @ (ccdif @ XX @ (ccsn @ XZ)))))))))))))))).
