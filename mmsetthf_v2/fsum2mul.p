...
thf(cfsum2mul_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwcel @ XB2 @ ccfn)) => ((! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ XA2)) => (cwcel @ (XC @ Xj) @ ccc))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XB2)) => (cwcel @ (XD @ Xk) @ ccc))) => (Xph => ((ccsu @ XA2 @ (^ [Xj:$i] : (ccsu @ XB2 @ (^ [Xk:$i] : (cco @ (XC @ Xj) @ (XD @ Xk) @ ccmul))))) = (cco @ (ccsu @ XA2 @ (^ [Xj:$i] : (XC @ Xj))) @ (ccsu @ XB2 @ (^ [Xk:$i] : (XD @ Xk))) @ ccmul))))))))))))).
