...
thf(almodvsghm_ax,axiom,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccfv @ XW @ ccsca))) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((! [Xx3:$i] : (XK = (ccfv @ (XF @ Xx3) @ ccbs))) => (((cwcel @ XW @ cclmod) & (cwcel @ XR @ XK)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (cco @ XR @ (ccv @ Xx3) @ Xc_x))) @ (cco @ XW @ XW @ ccghm)))))))))))))).
...
thf(clmhmvsca_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XM @ ccbs)) => ((Xc_x = (ccfv @ XN @ ccvsca)) => ((XJ = (ccfv @ XN @ ccsca)) => ((XK = (ccfv @ XJ @ ccbs)) => ((cw3a @ (cwcel @ XJ @ cccrg) @ (cwcel @ XA2 @ XK) @ (cwcel @ XF @ (cco @ XM @ XN @ cclmhm))) => (cwcel @ (cco @ (ccxp @ XV @ (ccsn @ XA2)) @ XF @ (ccof @ Xc_x)) @ (cco @ XM @ XN @ cclmhm)))))))))))))))).
