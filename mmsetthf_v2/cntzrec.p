...
thf(ccntzrec_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XZ = (ccfv @ XM @ cccntz)) => (((cwss @ XS @ XB2) & (cwss @ XT @ XB2)) => ((cwss @ XS @ (ccfv @ XT @ XZ)) <=> (cwss @ XT @ (ccfv @ XS @ XZ)))))))))))).
