...
thf(af1eqcocnv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwf1 @ XA2 @ XB2 @ XF) & (cwf1 @ XA2 @ XB2 @ XG)) => ((XF = XG) <=> ((cccom @ (cccnv @ XF) @ XG) = (ccres @ ccid @ XA2))))))))).
thf(cweisoeq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cwwe @ XA2 @ XR) & (cwse @ XA2 @ XR)) & ((cwiso @ XA2 @ XB2 @ XR @ XS @ XF) & (cwiso @ XA2 @ XB2 @ XR @ XS @ XG))) => (XF = XG))))))))).
