...
thf(ameascnbl_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : ((XJ = (ccfv @ (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress) @ cctopn)) => ((Xph => (cwcel @ XM @ (ccfv @ XS @ ccmeas))) => ((Xph => (cwf @ ccn @ XS @ XF)) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwss @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF)))) => (Xph => (cwbr @ (cccom @ XM @ XF) @ (ccfv @ (ccuni @ (ccrn @ XF)) @ XM) @ (ccfv @ XJ @ cclm))))))))))))).
...
thf(aorvclteel_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XP @ ccprb)) => ((Xph => (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => (cwcel @ (cco @ XX @ XA2 @ (ccorvc @ ccle)) @ (ccdm @ XP))))))))))).
...
thf(aorvclteinc_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XP @ ccprb)) => ((Xph => (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => (Xph => (cwss @ (cco @ XX @ XA2 @ (ccorvc @ ccle)) @ (cco @ XX @ XB2 @ (ccorvc @ ccle))))))))))))))).
...
thf(ameasfn_ax,axiom,(! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwcel @ XM @ (ccfv @ XS @ ccmeas)) => (cwfn @ XM @ XS))))).
...
thf(adstfrvunirn_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XP @ ccprb)) => ((Xph => (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => (Xph => ((ccuni @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ XX @ (ccv @ Xn) @ (ccorvc @ ccle)))))) = (ccuni @ (ccdm @ XP)))))))))).
