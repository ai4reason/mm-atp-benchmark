...
thf(alemaxle_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ ((cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccr)) @ (cwcel @ XA2 @ ccr) @ (cwbr @ XA2 @ XB2 @ ccle)) => (cwbr @ XA2 @ (ccif @ (cwbr @ XC @ XB2 @ ccle) @ XB2 @ XC) @ ccle)))))).
...
thf(asetsfun0_ax,axiom,(! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((((cwcel @ XG @ XV) & (cwfun @ (ccdif @ XG @ (ccsn @ cc0)))) & ((cwcel @ XI @ XU) & (cwcel @ XE @ XW))) => (cwfun @ (ccdif @ (cco @ XG @ (ccop @ XI @ XE) @ ccsts) @ (ccsn @ cc0))))))))))).
...
thf(asetsdm_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XG @ XV) & (cwcel @ XE @ XW)) => ((ccdm @ (cco @ XG @ (ccop @ XI @ XE) @ ccsts)) = (ccun @ (ccdm @ XG) @ (ccsn @ XI)))))))))).
thf(asyl2an23an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xph => Xps) => ((Xph => Xch) => (((Xth & Xph) => Xta) => (((cw3a @ Xps @ Xch @ Xta) => Xet) => ((Xth & Xph) => Xet)))))))))))).
thf(asimp3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) => Xch))))).
thf(annz_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => (cwcel @ XN @ ccz)))).
thf(ccxr_tp,type,(ccxr : ($i > $o))).
thf(assfzunsn_ax,axiom,(! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwss @ XS @ (cco @ XM @ XN @ ccfz)) @ (cwcel @ XN @ ccz) @ (cwcel @ XI @ (ccfv @ XM @ ccuz))) => (cwss @ (ccun @ XS @ (ccsn @ XI)) @ (cco @ XM @ (ccif @ (cwbr @ XI @ XN @ ccle) @ XN @ XI) @ ccfz)))))))).
...
thf(csetsstructOLD_conj,conjecture,(! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XG @ XU) @ (cwcel @ XE @ XV) @ (cwcel @ XI @ (ccfv @ XM @ ccuz))) => ((cwbr @ XG @ (ccop @ XM @ XN) @ ccstr) => (cwbr @ (cco @ XG @ (ccop @ XI @ XE) @ ccsts) @ (ccop @ XM @ (ccif @ (cwbr @ XI @ XN @ ccle) @ XN @ XI)) @ ccstr))))))))))).
