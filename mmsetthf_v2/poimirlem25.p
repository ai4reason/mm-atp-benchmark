...
thf(aphpreu_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (((cwcel @ XA2 @ ccfn) & (cwbr @ XA2 @ XB2 @ ccen)) => ((cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XC @ Xy1))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2)) <=> (cwral @ (^ [Xx3:$i] : (cwreu @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XC @ Xy1))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(areubida_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => ((Xps @ Xx3) <=> (Xch @ Xx3)))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cwreu @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) <=> (cwreu @ (^ [Xx3:$i] : (Xch @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))))))).
thf(areurmo_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (cwrmo @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))).
thf(armo3_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : (cwnf @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))) => (! [Xy1:$i] : ((cwrmo @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : XA2)) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((Xph @ Xx3 @ Xy1) & (cwsb @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ Xy1)) => ((ccv @ Xx3) = (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(aeuhash1_ax,axiom,(! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [Xa:$i] : ((cwcel @ XV @ (XW @ Xa)) => (((ccfv @ XV @ cchash) = cc1) <=> (cweu @ (^ [Xa:$i] : (cwcel @ (ccv @ Xa) @ XV))))))))).
...
thf(cpoimirlem25_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((! [Xj:$i] : (! [Xs1:$i] : (! [Xp:$i] : (((ccv @ Xp) = (cco @ (ccfv @ (ccv @ Xs1) @ cc1st) @ (ccun @ (ccxp @ (ccima @ (ccfv @ (ccv @ Xs1) @ cc2nd) @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (ccfv @ (ccv @ Xs1) @ cc2nd) @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc))) => ((XB2 @ Xp) = (XC @ Xj @ Xs1)))))) => ((! [Xp:$i] : ((Xph & (cwf @ (cco @ cc1 @ XN @ ccfz) @ (cco @ ccc0 @ XK @ ccfz) @ (ccv @ Xp))) => (cwcel @ (XB2 @ Xp) @ (cco @ ccc0 @ XN @ ccfz)))) => ((Xph => (cwf @ (cco @ cc1 @ XN @ ccfz) @ (cco @ ccc0 @ XK @ ccfzo) @ XT)) => ((Xph => (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ XU)) => ((! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ (cco @ ccc0 @ XN @ ccfz))) => (cwne @ XN @ (ccsb @ (ccop @ XT @ XU) @ (^ [Xs1:$i] : (XC @ Xj @ Xs1)))))) => (Xph => (cwbr @ cc2 @ (ccfv @ (ccrab @ (^ [Xy1:$i] : (cwral @ (^ [Xi:$i] : (cwrex @ (^ [Xj:$i] : ((ccv @ Xi) = (ccsb @ (ccop @ XT @ XU) @ (^ [Xs1:$i] : (XC @ Xj @ Xs1))))) @ (^ [Xj:$i] : (ccdif @ (cco @ ccc0 @ XN @ ccfz) @ (ccsn @ (ccv @ Xy1)))))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)))) @ (^ [Xy1:$i] : (cco @ ccc0 @ XN @ ccfz))) @ cchash) @ ccdvds)))))))))))))))).
