...
thf(aabscxp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwcel @ XB2 @ ccc)) => ((ccfv @ (cco @ XA2 @ XB2 @ cccxp) @ ccabs) = (cco @ XA2 @ (ccfv @ XB2 @ ccre) @ cccxp)))))).
...
thf(acxplt3d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ cc1 @ cclt)) => ((Xph => (cwcel @ XC @ ccr)) => (Xph => ((cwbr @ XB2 @ XC @ cclt) <=> (cwbr @ (cco @ XA2 @ XC @ cccxp) @ (cco @ XA2 @ XB2 @ cccxp) @ cclt)))))))))))).
...
thf(ccxpcn3lem_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((XD = (ccima @ (cccnv @ ccre) @ ccrp)) => ((! [Xa:$i] : (! [Xb:$i] : ((XJ @ Xa @ Xb) = (ccfv @ cccnfld @ cctopn)))) => ((! [Xa:$i] : (! [Xb:$i] : (XK = (cco @ (XJ @ Xa @ Xb) @ (cco @ ccc0 @ ccpnf @ ccico) @ ccrest)))) => ((! [Xa:$i] : (! [Xb:$i] : (XL = (cco @ (XJ @ Xa @ Xb) @ XD @ ccrest)))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xd:$i] : ((XU @ Xa @ Xb @ Xd) = (cco @ (ccif @ (cwbr @ (ccfv @ XA2 @ ccre) @ cc1 @ ccle) @ (ccfv @ XA2 @ ccre) @ cc1) @ cc2 @ ccdiv))))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xd:$i] : (XT = (ccif @ (cwbr @ (XU @ Xa @ Xb @ Xd) @ (cco @ XE @ (cco @ cc1 @ (XU @ Xa @ Xb @ Xd) @ ccdiv) @ cccxp) @ ccle) @ (XU @ Xa @ Xb @ Xd) @ (cco @ XE @ (cco @ cc1 @ (XU @ Xa @ Xb @ Xd) @ ccdiv) @ cccxp)))))) => (((cwcel @ XA2 @ XD) & (cwcel @ XE @ ccrp)) => (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (((cwbr @ (ccfv @ (ccv @ Xa) @ ccabs) @ (ccv @ Xd) @ cclt) & (cwbr @ (ccfv @ (cco @ XA2 @ (ccv @ Xb) @ ccmin) @ ccabs) @ (ccv @ Xd) @ cclt)) => (cwbr @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ cccxp) @ ccabs) @ XE @ cclt))) @ (^ [Xb:$i] : XD))) @ (^ [Xa:$i] : (cco @ ccc0 @ ccpnf @ ccico)))) @ (^ [Xd:$i] : ccrp)))))))))))))))))).
