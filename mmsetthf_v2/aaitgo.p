...
thf(aitgoval_ax,axiom,(! [XS:($i > $o)] : ((cwss @ XS @ ccc) => ((ccfv @ XS @ ccitgo) = (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xp:$i] : (((ccfv @ (ccv @ Xx3) @ (ccv @ Xp)) = ccc0) & ((ccfv @ (ccfv @ (ccv @ Xp) @ ccdgr) @ (ccfv @ (ccv @ Xp) @ cccoe)) = cc1))) @ (^ [Xp:$i] : (ccfv @ XS @ ccply)))) @ (^ [Xx3:$i] : ccc)))))).
...
thf(ampaacl_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => (cwcel @ (ccfv @ XA2 @ ccmpaa) @ (ccfv @ ccq @ ccply))))).
thf(ampaaroot_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => ((ccfv @ XA2 @ (ccfv @ XA2 @ ccmpaa)) = ccc0)))).
thf(aeqtrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XB2 = XC)) => (Xph => (XA2 = XC))))))))).
thf(afveq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))))).
thf(ampaadgr_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => ((ccfv @ (ccfv @ XA2 @ ccmpaa) @ ccdgr) = (ccfv @ XA2 @ ccdgraa))))).
thf(ampaamn_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => ((ccfv @ (ccfv @ XA2 @ ccdgraa) @ (ccfv @ (ccfv @ XA2 @ ccmpaa) @ cccoe)) = cc1)))).
...
thf(anecon2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((XA2 = XB2) => (cwne @ XC @ XD)) => ((XC = XD) => (cwne @ XA2 @ XB2)))))))).
...
thf(aelqaa_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) <=> ((cwcel @ XA2 @ ccc) & (cwrex @ (^ [Xf1:$i] : ((ccfv @ XA2 @ (ccv @ Xf1)) = ccc0)) @ (^ [Xf1:$i] : (ccdif @ (ccfv @ ccq @ ccply) @ (ccsn @ cc0p)))))))).
thf(caaitgo_conj,conjecture,(ccaa = (ccfv @ ccq @ ccitgo))).
