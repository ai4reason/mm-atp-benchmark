...
thf(cseqomlem0_conj,conjecture,(! [XF:($i > $o)] : (! [XI:($i > $o)] : ((ccrdg @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : ccom)) @ (^ [Xa:$i] : (^ [Xb:$i] : ccvv)) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccop @ (ccsuc @ (ccv @ Xa)) @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ XF))))) @ (ccop @ cc0 @ (ccfv @ XI @ ccid))) = (ccrdg @ (ccmpt2 @ (^ [Xc:$i] : (^ [Xd:$i] : ccom)) @ (^ [Xc:$i] : (^ [Xd:$i] : ccvv)) @ (^ [Xc:$i] : (^ [Xd:$i] : (ccop @ (ccsuc @ (ccv @ Xc)) @ (cco @ (ccv @ Xc) @ (ccv @ Xd) @ XF))))) @ (ccop @ cc0 @ (ccfv @ XI @ ccid))))))).
