...
thf(aacsficl2d_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XA2 @ Xx3) @ (ccfv @ (XX @ Xx3) @ ccacs)))) => ((! [Xx3:$i] : (XN = (ccfv @ (XA2 @ Xx3) @ ccmrc))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XS @ (XX @ Xx3)))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cwcel @ XY @ (ccfv @ XS @ XN)) <=> (cwrex @ (^ [Xx3:$i] : (cwcel @ XY @ (ccfv @ (ccv @ Xx3) @ XN))) @ (^ [Xx3:$i] : (ccin @ (ccpw @ XS) @ ccfn)))))))))))))))).
