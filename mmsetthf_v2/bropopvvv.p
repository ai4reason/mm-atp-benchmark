...
thf(abrovpreldm_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((cwbr @ XD @ XE @ (cco @ XB2 @ XC @ XA2)) => (cwcel @ (ccop @ XB2 @ XC) @ (ccdm @ XA2))))))))).
...
thf(ampt2ndm0_ax,axiom,(! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((~ ((cwcel @ (XV @ Xx3 @ Xy1) @ XX) & (cwcel @ (XW @ Xx3 @ Xy1) @ XY))) => ((cco @ (XV @ Xx3 @ Xy1) @ (XW @ Xx3 @ Xy1) @ (XF @ Xx3 @ Xy1)) = cc0)))))))))))).
...
thf(ajaoi3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((((~ Xph) & Xch) => Xps) => ((Xph | Xch) => Xps))))))).
...
thf(aanor_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) <=> (~ ((~ Xph) | (~ Xps))))))).
...
thf(cbropopvvv_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xps:($i > ($i > ($i > ($i > $o))))] : (! [Xth:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XP:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XO:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XV:($i > $o)] : ((! [Xv:$i] : (! [Xe:$i] : (! [Xf1:$i] : (! [Xp:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XO @ Xv @ Xe @ Xf1 @ Xp @ Xa @ Xb) = (ccmpt2 @ (^ [Xv:$i] : (^ [Xe:$i] : ccvv)) @ (^ [Xv:$i] : (^ [Xe:$i] : ccvv)) @ (^ [Xv:$i] : (^ [Xe:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (ccv @ Xv))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccv @ Xv))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : (Xph @ Xv @ Xe @ Xf1 @ Xp @ Xa @ Xb))))))))))))))))) => ((! [Xv:$i] : (! [Xe:$i] : (! [Xf1:$i] : (! [Xp:$i] : (! [Xa:$i] : (! [Xb:$i] : ((((ccv @ Xv) = XV) & ((ccv @ Xe) = XE)) => ((Xph @ Xv @ Xe @ Xf1 @ Xp @ Xa @ Xb) <=> (Xps @ Xf1 @ Xp @ Xa @ Xb))))))))) => ((! [Xv:$i] : (! [Xe:$i] : (! [Xf1:$i] : (! [Xp:$i] : (! [Xa:$i] : (! [Xb:$i] : ((((cwcel @ XV @ ccvv) & (cwcel @ XE @ ccvv)) & ((cwcel @ (XA2 @ Xv @ Xe @ Xf1 @ Xp @ Xa @ Xb) @ XV) & (cwcel @ (XB2 @ Xv @ Xe @ Xf1 @ Xp @ Xa @ Xb) @ XV))) => ((cco @ (XA2 @ Xv @ Xe @ Xf1 @ Xp @ Xa @ Xb) @ (XB2 @ Xv @ Xe @ Xf1 @ Xp @ Xa @ Xb) @ (cco @ XV @ XE @ (XO @ Xv @ Xe @ Xf1 @ Xp @ Xa @ Xb))) = (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : (Xth @ Xv @ Xe @ Xf1 @ Xp @ Xa @ Xb)))))))))))) => (! [Xv:$i] : (! [Xe:$i] : (! [Xf1:$i] : (! [Xp:$i] : (! [Xa:$i] : (! [Xb:$i] : ((cwbr @ (XF @ Xv @ Xe @ Xf1 @ Xp @ Xa @ Xb) @ (XP @ Xv @ Xe @ Xf1 @ Xp @ Xa @ Xb) @ (cco @ (XA2 @ Xv @ Xe @ Xf1 @ Xp @ Xa @ Xb) @ (XB2 @ Xv @ Xe @ Xf1 @ Xp @ Xa @ Xb) @ (cco @ XV @ XE @ (XO @ Xv @ Xe @ Xf1 @ Xp @ Xa @ Xb)))) => (cw3a @ ((cwcel @ XV @ ccvv) & (cwcel @ XE @ ccvv)) @ ((cwcel @ (XF @ Xv @ Xe @ Xf1 @ Xp @ Xa @ Xb) @ ccvv) & (cwcel @ (XP @ Xv @ Xe @ Xf1 @ Xp @ Xa @ Xb) @ ccvv)) @ ((cwcel @ (XA2 @ Xv @ Xe @ Xf1 @ Xp @ Xa @ Xb) @ XV) & (cwcel @ (XB2 @ Xv @ Xe @ Xf1 @ Xp @ Xa @ Xb) @ XV)))))))))))))))))))))))).
