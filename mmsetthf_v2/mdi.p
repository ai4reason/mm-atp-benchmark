...
thf(cmdi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) & ((cwbr @ XA2 @ XB2 @ ccmd) & (cwss @ XC @ XB2))) => ((ccin @ (cco @ XC @ XA2 @ cchj) @ XB2) = (cco @ XC @ (ccin @ XA2 @ XB2) @ cchj))))))).
