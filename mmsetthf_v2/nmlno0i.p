...
thf(anmlno0lem_ax,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XN = (cco @ XU @ XW @ ccnmoo)) => ((XZ = (cco @ XU @ XW @ cc0o)) => ((XL = (cco @ XU @ XW @ cclno)) => ((cwcel @ XU @ ccnv) => ((cwcel @ XW @ ccnv) => ((cwcel @ XT @ XL) => ((XX = (ccfv @ XU @ ccba)) => ((XY = (ccfv @ XW @ ccba)) => ((XR = (ccfv @ XU @ ccns)) => ((XS = (ccfv @ XW @ ccns)) => ((XP = (ccfv @ XU @ ccn0v)) => ((XQ = (ccfv @ XW @ ccn0v)) => ((XK = (ccfv @ XU @ ccnmcv)) => ((XM = (ccfv @ XW @ ccnmcv)) => (((ccfv @ XT @ XN) = ccc0) <=> (XT = XZ))))))))))))))))))))))))))))))).
thf(aelimel_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XB2 @ XC) => (cwcel @ (ccif @ (cwcel @ XA2 @ XC) @ XA2 @ XB2) @ XC)))))).
thf(amp2an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (Xps => (((Xph & Xps) => Xch) => Xch))))))).
thf(ccpv_tp,type,(ccpv : ($i > $o))).
thf(a_0lno_ax,axiom,(! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (cco @ XU @ XW @ cc0o)) => ((XL = (cco @ XU @ XW @ cclno)) => (((cwcel @ XU @ ccnv) & (cwcel @ XW @ ccnv)) => (cwcel @ XZ @ XL))))))))).
