...
thf(cbnj96_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccsn @ (ccop @ cc0 @ (cc_bnj14 @ XA2 @ XR @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (((cw_bnj15 @ XA2 @ XR) & (cwcel @ (ccv @ Xx3) @ XA2)) => ((ccdm @ (XF @ Xx3)) = cc1o)))))))).
