...
thf(cvdwlem8_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((! [Xx3:$i] : (Xph => (cwcel @ (XR @ Xx3) @ ccfn))) => ((Xph => (cwcel @ XK @ (ccfv @ cc2 @ ccuz))) => ((Xph => (cwcel @ XW @ ccn)) => ((! [Xx3:$i] : (Xph => (cwf @ (cco @ cc1 @ (cco @ cc2 @ XW @ ccmul) @ ccfz) @ (XR @ Xx3) @ XF))) => ((cwcel @ XC @ ccvv) => ((Xph => (cwcel @ XA2 @ ccn)) => ((Xph => (cwcel @ XD @ ccn)) => ((! [Xx3:$i] : (Xph => (cwss @ (cco @ XA2 @ XD @ (ccfv @ XK @ ccvdwa)) @ (ccima @ (cccnv @ (XG @ Xx3)) @ (ccsn @ XC))))) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XW @ ccfz)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ XW @ ccaddc) @ XF))))) => (Xph => (cwbr @ (ccop @ cc1 @ XK) @ XF @ ccvdwp))))))))))))))))))))).
