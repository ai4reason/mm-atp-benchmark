...
thf(aatcvat4i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => (((cwcel @ XB2 @ ccat) & (cwcel @ XC @ ccat)) => (((cwne @ XA2 @ cc0h) & (cwss @ XB2 @ (cco @ XA2 @ XC @ cchj))) => (cwrex @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) & (cwss @ XB2 @ (cco @ XC @ (ccv @ Xx3) @ cchj)))) @ (^ [Xx3:$i] : ccat))))))))).
...
thf(achrelat2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((~ (cwss @ XA2 @ XB2)) <=> (cwrex @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) & (~ (cwss @ (ccv @ Xx3) @ XB2)))) @ (^ [Xx3:$i] : ccat))))))).
thf(cmdsymlem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((! [Xp:$i] : ((XC @ Xp) = (cco @ XA2 @ (ccv @ Xp) @ cchj))) => (! [Xp:$i] : (((((cwcel @ (ccv @ Xp) @ ccat) & (~ (cwss @ (ccin @ XB2 @ (XC @ Xp)) @ XA2))) & (cwss @ (ccv @ Xp) @ (cco @ XA2 @ XB2 @ cchj))) & (cwne @ XA2 @ cc0h)) => (cwrex @ (^ [Xr:$i] : (cwrex @ (^ [Xq:$i] : ((cwss @ (ccv @ Xp) @ (cco @ (ccv @ Xq) @ (ccv @ Xr) @ cchj)) & ((cwss @ (ccv @ Xq) @ XA2) & (cwss @ (ccv @ Xr) @ XB2)))) @ (^ [Xq:$i] : ccat))) @ (^ [Xr:$i] : ccat))))))))))).
