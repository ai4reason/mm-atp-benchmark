...
thf(apolsubclN_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pe = (ccfv @ XK @ ccpolN)) => ((XC = (ccfv @ XK @ ccpscN)) => (((cwcel @ XK @ cchlt) & (cwss @ XX @ XA2)) => (cwcel @ (ccfv @ XX @ Xc_pe) @ XC))))))))))).
