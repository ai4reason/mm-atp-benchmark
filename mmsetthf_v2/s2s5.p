...
thf(as1s2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccs3 @ XA2 @ XB2 @ XC) = (cco @ (ccs1 @ XA2) @ (ccs2 @ XB2 @ XC) @ ccconcat)))))).
...
thf(as1s4_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((ccs5 @ XA2 @ XB2 @ XC @ XD @ XE) = (cco @ (ccs1 @ XA2) @ (ccs4 @ XB2 @ XC @ XD @ XE) @ ccconcat)))))))).
...
thf(cs2s5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((ccs7 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG) = (cco @ (ccs2 @ XA2 @ XB2) @ (ccs5 @ XC @ XD @ XE @ XF @ XG) @ ccconcat)))))))))).
