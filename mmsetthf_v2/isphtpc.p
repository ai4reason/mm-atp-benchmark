...
thf(adf_phtpc_ax,axiom,(ccphtpc = (ccmpt @ (^ [Xx3:$i] : cctop) @ (^ [Xx3:$i] : (ccopab @ (^ [Xf1:$i] : (^ [Xg1:$i] : ((cwss @ (ccpr @ (ccv @ Xf1) @ (ccv @ Xg1)) @ (cco @ ccii @ (ccv @ Xx3) @ cccn)) & (cwne @ (cco @ (ccv @ Xf1) @ (ccv @ Xg1) @ (ccfv @ (ccv @ Xx3) @ ccphtpy)) @ cc0))))))))).
...
thf(cisphtpc_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((cwbr @ XF @ XG @ (ccfv @ XJ @ ccphtpc)) <=> (cw3a @ (cwcel @ XF @ (cco @ ccii @ XJ @ cccn)) @ (cwcel @ XG @ (cco @ ccii @ XJ @ cccn)) @ (cwne @ (cco @ XF @ XG @ (ccfv @ XJ @ ccphtpy)) @ cc0))))))).
