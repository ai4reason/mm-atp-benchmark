...
thf(caxdc_conj,conjecture,(! [Xx3:$i] : (((? [Xy1:$i] : (? [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ (ccv @ Xx3)))) & (cwss @ (ccrn @ (ccv @ Xx3)) @ (ccdm @ (ccv @ Xx3)))) => (? [Xf1:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ (ccfv @ (ccsuc @ (ccv @ Xn)) @ (ccv @ Xf1)) @ (ccv @ Xx3))) @ (^ [Xn:$i] : ccom)))))).
