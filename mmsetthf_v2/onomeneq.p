...
thf(aphp5_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccom) => (~ (cwbr @ XA2 @ (ccsuc @ XA2) @ ccen))))).
...
thf(conomeneq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccom)) => ((cwbr @ XA2 @ XB2 @ ccen) <=> (XA2 = XB2)))))).
