...
thf(aabvtrivd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XA2 @ Xx3 @ Xy1 @ Xz) = (ccfv @ XR @ ccabv))))) => ((! [Xy1:$i] : (! [Xz:$i] : ((XB2 @ Xy1 @ Xz) = (ccfv @ XR @ ccbs)))) => ((! [Xy1:$i] : (! [Xz:$i] : ((Xc_0 @ Xy1 @ Xz) = (ccfv @ XR @ cc0g)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (XB2 @ Xy1 @ Xz)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = (Xc_0 @ Xy1 @ Xz)) @ ccc0 @ cc1))))))) => ((! [Xy1:$i] : (! [Xz:$i] : ((Xc_x @ Xy1 @ Xz) = (ccfv @ XR @ ccmulr)))) => ((Xph => (cwcel @ XR @ ccrg)) => ((! [Xy1:$i] : (! [Xz:$i] : ((cw3a @ Xph @ ((cwcel @ (ccv @ Xy1) @ (XB2 @ Xy1 @ Xz)) & (cwne @ (ccv @ Xy1) @ (Xc_0 @ Xy1 @ Xz))) @ ((cwcel @ (ccv @ Xz) @ (XB2 @ Xy1 @ Xz)) & (cwne @ (ccv @ Xz) @ (Xc_0 @ Xy1 @ Xz)))) => (cwne @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (Xc_x @ Xy1 @ Xz)) @ (Xc_0 @ Xy1 @ Xz))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwcel @ (XF @ Xx3) @ (XA2 @ Xx3 @ Xy1 @ Xz))))))))))))))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(adomnring_ax,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccdomn) => (cwcel @ XR @ ccrg)))).
thf(adomnmuln0_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cw3a @ (cwcel @ XR @ ccdomn) @ ((cwcel @ XX @ XB2) & (cwne @ XX @ Xc_0)) @ ((cwcel @ XY @ XB2) & (cwne @ XY @ Xc_0))) => (cwne @ (cco @ XX @ XY @ Xc_x) @ Xc_0)))))))))))).
...
thf(aabvdom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (ccfv @ XR @ ccabv)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((cw3a @ (cwcel @ XF @ XA2) @ ((cwcel @ XX @ XB2) & (cwne @ XX @ Xc_0)) @ ((cwcel @ XY @ XB2) & (cwne @ XY @ Xc_0))) => (cwne @ (cco @ XX @ XY @ Xc_x) @ Xc_0))))))))))))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(cwsbc_tp,type,(cwsbc : (($i > $o) > (($i > $o) > $o)))).
thf(aisdomn_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_x @ Xx3 @ Xy1) = (ccfv @ XR @ ccmulr)))) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cwcel @ XR @ ccdomn) <=> ((cwcel @ XR @ ccnzr) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_x @ Xx3 @ Xy1)) = Xc_0) => (((ccv @ Xx3) = Xc_0) | ((ccv @ Xy1) = Xc_0)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)))))))))))).
thf(cabvn0b_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((XA2 = (ccfv @ XR @ ccabv)) => ((cwcel @ XR @ ccdomn) <=> ((cwcel @ XR @ ccnzr) & (cwne @ XA2 @ cc0))))))).
