...
thf(asetccatid_ax,axiom,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : ((XC = (ccfv @ XU @ ccsetc)) => ((cwcel @ XU @ XV) => ((cwcel @ XC @ cccat) & ((ccfv @ XC @ cccid) = (ccmpt @ (^ [Xx3:$i] : XU) @ (^ [Xx3:$i] : (ccres @ ccid @ (ccv @ Xx3)))))))))))).
...
thf(csetcid_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XC = (ccfv @ XU @ ccsetc)) => ((Xc_1 = (ccfv @ XC @ cccid)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (cwcel @ XX @ XU)) => (Xph => ((ccfv @ XX @ Xc_1) = (ccres @ ccid @ XX)))))))))))))).
