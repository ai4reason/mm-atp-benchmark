...
thf(aipnm_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XN = (ccfv @ XU @ ccnmcv)) => ((XP = (ccfv @ XU @ ccdip)) => (((cwcel @ XU @ ccnv) & (cwcel @ XA2 @ XX)) => ((ccfv @ XA2 @ XN) = (ccfv @ (cco @ XA2 @ XA2 @ XP) @ ccsqrt)))))))))))).
