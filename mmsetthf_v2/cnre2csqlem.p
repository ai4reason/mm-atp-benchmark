...
thf(aabsdiflt_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) => ((cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ XC @ cclt) <=> ((cwbr @ (cco @ XB2 @ XC @ ccmin) @ XA2 @ cclt) & (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ cclt)))))))).
...
thf(ccnre2csqlem_conj,conjecture,(! [XD:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xy1:$i] : ((ccres @ (XG @ Xy1) @ (ccxp @ ccr @ ccr)) = (cccom @ XH @ XF))) => ((cwfn @ XF @ (ccxp @ ccr @ ccr)) => ((! [Xy1:$i] : (cwfn @ (XG @ Xy1) @ ccvv)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccxp @ ccr @ ccr)) => (cwcel @ (ccfv @ (ccv @ Xx3) @ (XG @ Xy1)) @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (ccrn @ XF)) & (cwcel @ (ccv @ Xy1) @ (ccrn @ XF))) => ((ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmin) @ XH) = (cco @ (ccfv @ (ccv @ Xx3) @ XH) @ (ccfv @ (ccv @ Xy1) @ XH) @ ccmin))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ (cwcel @ XX @ (ccxp @ ccr @ ccr)) @ (cwcel @ XY @ (ccxp @ ccr @ ccr)) @ (cwcel @ (XD @ Xx3 @ Xy1) @ ccrp)) => ((cwcel @ XY @ (ccima @ (cccnv @ (ccres @ (XG @ Xy1) @ (ccxp @ ccr @ ccr))) @ (cco @ (cco @ (ccfv @ XX @ (XG @ Xy1)) @ (XD @ Xx3 @ Xy1) @ ccmin) @ (cco @ (ccfv @ XX @ (XG @ Xy1)) @ (XD @ Xx3 @ Xy1) @ ccaddc) @ ccioo))) => (cwbr @ (ccfv @ (ccfv @ (cco @ (ccfv @ XY @ XF) @ (ccfv @ XX @ XF) @ ccmin) @ XH) @ ccabs) @ (XD @ Xx3 @ Xy1) @ cclt))))))))))))))))).
