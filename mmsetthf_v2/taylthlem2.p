...
thf(advnfre_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwf @ XA2 @ ccr @ XF) @ (cwss @ XA2 @ ccr) @ (cwcel @ XN @ ccn0)) => (cwf @ (ccdm @ (ccfv @ XN @ (cco @ ccr @ XF @ ccdvn))) @ ccr @ (ccfv @ XN @ (cco @ ccr @ XF @ ccdvn)))))))).
...
thf(advnply2_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XS @ (ccfv @ cccnfld @ ccsubrg)) @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XN @ ccn0)) => (cwcel @ (ccfv @ XN @ (cco @ ccc @ XF @ ccdvn)) @ (ccfv @ XS @ ccply))))))).
thf(cccj_tp,type,(cccj : ($i > $o))).
thf(aplyreres_ax,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccfv @ ccr @ ccply)) => (cwf @ ccr @ ccr @ (ccres @ XF @ ccr))))).
...
thf(amulcn_ax,axiom,(! [XJ:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => (cwcel @ ccmul @ (cco @ (cco @ XJ @ XJ @ cctx) @ XJ @ cccn))))).
