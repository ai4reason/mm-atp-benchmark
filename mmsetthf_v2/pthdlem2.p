...
thf(apthdlem2lem_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : ((Xph => (cwcel @ XP @ (ccword @ ccvv))) => ((XR = (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin)) => ((Xph => (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : ((cwne @ (ccv @ Xi) @ (ccv @ Xj)) => (cwne @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (ccv @ Xj) @ XP)))) @ (^ [Xj:$i] : (cco @ cc1 @ XR @ ccfzo)))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XP @ cchash) @ ccfzo)))) => ((cw3a @ Xph @ (cwcel @ (ccfv @ XP @ cchash) @ ccn) @ ((XI = ccc0) | (XI = XR))) => (cwnel @ (ccfv @ XI @ XP) @ (ccima @ XP @ (cco @ cc1 @ XR @ ccfzo)))))))))))).
thf(aolci_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps | Xph))))).
thf(asyl2anc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xph => Xch) => (((Xps & Xch) => Xth) => (Xph => Xth))))))))).
thf(asylibr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xch <=> Xps) => (Xph => Xch))))))).
thf(aadantr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph & Xch) => Xps)))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(awrdffz_ax,axiom,(! [XS:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ (ccword @ XS)) => (cwf @ (cco @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ ccfz) @ XS @ XW))))).
...
thf(cpthdlem2_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (cwcel @ XP @ (ccword @ ccvv))) => ((XR = (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin)) => ((Xph => (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : ((cwne @ (ccv @ Xi) @ (ccv @ Xj)) => (cwne @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (ccv @ Xj) @ XP)))) @ (^ [Xj:$i] : (cco @ cc1 @ XR @ ccfzo)))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XP @ cchash) @ ccfzo)))) => (Xph => ((ccin @ (ccima @ XP @ (ccpr @ ccc0 @ XR)) @ (ccima @ XP @ (cco @ cc1 @ XR @ ccfzo))) = cc0))))))))).
