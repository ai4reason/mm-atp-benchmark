...
thf(amapdcnvordN_ax,axiom,(! [Xph:$o] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XM = (ccfv @ XW @ (ccfv @ XK @ ccmpd))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XX @ (ccrn @ XM))) => ((Xph => (cwcel @ XY @ (ccrn @ XM))) => (Xph => ((cwss @ (ccfv @ XX @ (cccnv @ XM)) @ (ccfv @ XY @ (cccnv @ XM))) <=> (cwss @ XX @ XY)))))))))))))))).
