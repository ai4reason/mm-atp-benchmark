...
thf(axpdifid_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (ccdif @ XB2 @ (ccsn @ (ccv @ Xx3)))))) = (ccdif @ (ccxp @ XA2 @ XB2) @ ccid))))).
...
thf(atglng_ax,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > $o))))] : ((XP = (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XL @ Xx3 @ Xy1 @ Xz) = (ccfv @ XG @ cclng))))) => ((XI = (ccfv @ XG @ ccitv)) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ XG @ ccstrkg) => ((XL @ Xx3 @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XP)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ XP @ (ccsn @ (ccv @ Xx3))))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xz:$i] : (cw3o @ (cwcel @ (ccv @ Xz) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XI)) @ (cwcel @ (ccv @ Xx3) @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ XI)) @ (cwcel @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ XI)))) @ (^ [Xz:$i] : XP)))))))))))))))))).
thf(ctglnfn_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((XL = (ccfv @ XG @ cclng)) => ((XI = (ccfv @ XG @ ccitv)) => ((cwcel @ XG @ ccstrkg) => (cwfn @ XL @ (ccdif @ (ccxp @ XP @ XP) @ ccid))))))))))).
