...
thf(achlejb1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwss @ XA2 @ XB2) <=> ((cco @ XA2 @ XB2 @ cchj) = XB2))))))).
thf(cmdexchi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cw3a @ (cwbr @ XA2 @ XB2 @ ccmd) @ (cwbr @ XC @ (cco @ XA2 @ XB2 @ cchj) @ ccmd) @ (cwss @ (ccin @ XC @ (cco @ XA2 @ XB2 @ cchj)) @ XA2)) => ((cwbr @ (cco @ XC @ XA2 @ cchj) @ XB2 @ ccmd) & ((ccin @ (cco @ XC @ XA2 @ cchj) @ XB2) = (ccin @ XA2 @ XB2))))))))))).
