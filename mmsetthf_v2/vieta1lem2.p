...
thf(afta1_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((XR = (ccima @ (cccnv @ XF) @ (ccsn @ ccc0))) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwne @ XF @ cc0p)) => ((cwcel @ XR @ ccfn) & (cwbr @ (ccfv @ XR @ cchash) @ (ccfv @ XF @ ccdgr) @ ccle)))))))).
...
thf(avieta1lem1_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xz:$i] : ((XA2 @ Xx3) = (ccfv @ (XF @ Xx3 @ Xz) @ cccoe)))) => ((! [Xx3:$i] : (! [Xz:$i] : ((XN @ Xx3) = (ccfv @ (XF @ Xx3 @ Xz) @ ccdgr)))) => ((! [Xx3:$i] : (! [Xz:$i] : (XR = (ccima @ (cccnv @ (XF @ Xx3 @ Xz)) @ (ccsn @ ccc0))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ (XF @ Xx3 @ Xz) @ (ccfv @ (XS @ Xx3 @ Xz @ Xf1) @ ccply)))))) => ((! [Xx3:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => ((ccfv @ XR @ cchash) = (XN @ Xx3))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ (XD @ Xx3 @ Xz) @ ccn))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => ((cco @ (XD @ Xx3 @ Xz) @ cc1 @ ccaddc) = (XN @ Xx3)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => (cwral @ (^ [Xf1:$i] : ((((XD @ Xx3 @ Xz) = (ccfv @ (ccv @ Xf1) @ ccdgr)) & ((ccfv @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ ccc0)) @ cchash) = (ccfv @ (ccv @ Xf1) @ ccdgr))) => ((ccsu @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ ccc0)) @ (^ [Xx3:$i] : (ccv @ Xx3))) = (ccneg @ (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xf1) @ ccdgr) @ cc1 @ ccmin) @ (ccfv @ (ccv @ Xf1) @ cccoe)) @ (ccfv @ (ccfv @ (ccv @ Xf1) @ ccdgr) @ (ccfv @ (ccv @ Xf1) @ cccoe)) @ ccdiv))))) @ (^ [Xf1:$i] : (ccfv @ ccc @ ccply))))))) => ((! [Xx3:$i] : (! [Xz:$i] : ((XQ @ Xz) = (cco @ (XF @ Xx3 @ Xz) @ (cco @ ccidp @ (ccxp @ ccc @ (ccsn @ (ccv @ Xz))) @ (ccof @ ccmin)) @ ccquot)))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : (((Xph @ Xf1) & (cwcel @ (ccv @ Xz) @ XR)) => ((cwcel @ (XQ @ Xz) @ (ccfv @ ccc @ ccply)) & ((XD @ Xx3 @ Xz) = (ccfv @ (XQ @ Xz) @ ccdgr))))))))))))))))))))))))).
...
thf(afacth_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (cco @ ccidp @ (ccxp @ ccc @ (ccsn @ XA2)) @ (ccof @ ccmin))) => ((cw3a @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XA2 @ ccc) @ ((ccfv @ XA2 @ XF) = ccc0)) => (XF = (cco @ XG @ (cco @ XF @ XG @ ccquot) @ (ccof @ ccmul)))))))))).
...
thf(ahashun2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwcel @ XB2 @ ccfn)) => (cwbr @ (ccfv @ (ccun @ XA2 @ XB2) @ cchash) @ (cco @ (ccfv @ XA2 @ cchash) @ (ccfv @ XB2 @ cchash) @ ccaddc) @ ccle))))).
...
thf(acoemulhi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XB2 = (ccfv @ XG @ cccoe)) => ((XM = (ccfv @ XF @ ccdgr)) => ((XN = (ccfv @ XG @ ccdgr)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XS @ ccply))) => ((ccfv @ (cco @ XM @ XN @ ccaddc) @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmul)) @ cccoe)) = (cco @ (ccfv @ XM @ XA2) @ (ccfv @ XN @ XB2) @ ccmul))))))))))))))).
thf(afveq1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (XF = XG)) => (Xph => ((ccfv @ XA2 @ XF) = (ccfv @ XA2 @ XG))))))))).
thf(amp2an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (Xps => (((Xph & Xps) => Xch) => Xch))))))).
thf(assid_ax,axiom,(! [XA2:($i > $o)] : (cwss @ XA2 @ XA2))).
thf(aplyid_ax,axiom,(! [XS:($i > $o)] : (((cwss @ XS @ ccc) & (cwcel @ cc1 @ XS)) => (cwcel @ ccidp @ (ccfv @ XS @ ccply))))).
...
thf(acoeidp_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((ccfv @ XA2 @ (ccfv @ ccidp @ cccoe)) = (ccif @ (XA2 = cc1) @ cc1 @ ccc0))))).
...
thf(a_0dgr_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (ccxp @ ccc @ (ccsn @ XA2)) @ ccdgr) = ccc0)))).
...
thf(adgrub_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XN = (ccfv @ XF @ ccdgr)) => ((cw3a @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XM @ ccn0) @ (cwne @ (ccfv @ XM @ XA2) @ ccc0)) => (cwbr @ XM @ XN @ ccle)))))))))).
...
thf(anegdid_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => (Xph => ((ccneg @ (cco @ XA2 @ XB2 @ ccaddc)) = (cco @ (ccneg @ XA2) @ (ccneg @ XB2) @ ccaddc))))))))).
...
thf(acoemul_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XB2 = (ccfv @ XG @ cccoe)) => ((cw3a @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XG @ (ccfv @ XS @ ccply)) @ (cwcel @ XN @ ccn0)) => ((ccfv @ XN @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmul)) @ cccoe)) = (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccfv @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ XB2) @ ccmul)))))))))))))).
...
thf(afsump1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccfz))) => (cwcel @ (XA2 @ Xk) @ ccc))) => ((! [Xk:$i] : (((ccv @ Xk) = (cco @ XN @ cc1 @ ccaddc)) => ((XA2 @ Xk) = XB2))) => (Xph => ((ccsu @ (cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (^ [Xk:$i] : (XA2 @ Xk))) = (cco @ (ccsu @ (cco @ XM @ XN @ ccfz) @ (^ [Xk:$i] : (XA2 @ Xk))) @ XB2 @ ccaddc)))))))))))).
...
thf(afsumss_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((Xph => (cwss @ XA2 @ XB2)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XC @ Xk) @ ccc))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (ccdif @ XB2 @ XA2))) => ((XC @ Xk) = ccc0))) => ((Xph => (cwcel @ XB2 @ ccfn)) => (Xph => ((ccsu @ XA2 @ (^ [Xk:$i] : (XC @ Xk))) = (ccsu @ XB2 @ (^ [Xk:$i] : (XC @ Xk)))))))))))))).
...
thf(acoefv0_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((cwcel @ XF @ (ccfv @ XS @ ccply)) => ((ccfv @ ccc0 @ XF) = (ccfv @ ccc0 @ XA2)))))))).
...
thf(cvieta1lem2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xz:$i] : ((XA2 @ Xx3) = (ccfv @ (XF @ Xx3 @ Xz) @ cccoe)))) => ((! [Xx3:$i] : (! [Xz:$i] : ((XN @ Xx3) = (ccfv @ (XF @ Xx3 @ Xz) @ ccdgr)))) => ((! [Xx3:$i] : (! [Xz:$i] : (XR = (ccima @ (cccnv @ (XF @ Xx3 @ Xz)) @ (ccsn @ ccc0))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ (XF @ Xx3 @ Xz) @ (ccfv @ (XS @ Xx3 @ Xz @ Xf1) @ ccply)))))) => ((! [Xx3:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => ((ccfv @ XR @ cchash) = (XN @ Xx3))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ (XD @ Xx3 @ Xz) @ ccn))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => ((cco @ (XD @ Xx3 @ Xz) @ cc1 @ ccaddc) = (XN @ Xx3)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => (cwral @ (^ [Xf1:$i] : ((((XD @ Xx3 @ Xz) = (ccfv @ (ccv @ Xf1) @ ccdgr)) & ((ccfv @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ ccc0)) @ cchash) = (ccfv @ (ccv @ Xf1) @ ccdgr))) => ((ccsu @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ ccc0)) @ (^ [Xx3:$i] : (ccv @ Xx3))) = (ccneg @ (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xf1) @ ccdgr) @ cc1 @ ccmin) @ (ccfv @ (ccv @ Xf1) @ cccoe)) @ (ccfv @ (ccfv @ (ccv @ Xf1) @ ccdgr) @ (ccfv @ (ccv @ Xf1) @ cccoe)) @ ccdiv))))) @ (^ [Xf1:$i] : (ccfv @ ccc @ ccply))))))) => ((! [Xx3:$i] : (! [Xz:$i] : ((XQ @ Xz) = (cco @ (XF @ Xx3 @ Xz) @ (cco @ ccidp @ (ccxp @ ccc @ (ccsn @ (ccv @ Xz))) @ (ccof @ ccmin)) @ ccquot)))) => (! [Xx3:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => ((ccsu @ XR @ (^ [Xx3:$i] : (ccv @ Xx3))) = (ccneg @ (cco @ (ccfv @ (cco @ (XN @ Xx3) @ cc1 @ ccmin) @ (XA2 @ Xx3)) @ (ccfv @ (XN @ Xx3) @ (XA2 @ Xx3)) @ ccdiv)))))))))))))))))))))))).
