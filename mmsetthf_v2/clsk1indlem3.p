...
thf(aelif_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccif @ Xph @ XB2 @ XC)) <=> ((Xph & (cwcel @ XA2 @ XB2)) | ((~ Xph) & (cwcel @ XA2 @ XC))))))))).
...
thf(auneqsn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((ccun @ XA2 @ XB2) = (ccsn @ XC)) <=> (cw3o @ ((XA2 = (ccsn @ XC)) & (XB2 = (ccsn @ XC))) @ ((XA2 = (ccsn @ XC)) & (XB2 = cc0)) @ ((XA2 = cc0) & (XB2 = (ccsn @ XC))))))))).
...
thf(aor4_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph | Xps) | (Xch | Xth)) <=> ((Xph | Xch) | (Xps | Xth)))))))).
...
thf(ajaoa_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => (Xps => Xch)) => ((Xth => (Xta => Xch)) => ((Xph | Xth) => ((Xps & Xta) => Xch)))))))))).
...
thf(aor42_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph | Xps) | (Xch | Xth)) <=> ((Xph | Xch) | (Xth | Xps)))))))).
thf(a_4exmid_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (((Xph & Xps) | ((~ Xph) & (~ Xps))) | ((Xph & (~ Xps)) | (Xps & (~ Xph))))))).
