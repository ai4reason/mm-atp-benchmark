...
thf(apjeq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : (((cwcel @ XH @ ccch) & (cwcel @ XA2 @ cchil)) => (((ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) = XB2) <=> ((cwcel @ XB2 @ XH) & (cwrex @ (^ [Xx3:$i] : (XA2 = (cco @ XB2 @ (ccv @ Xx3) @ ccva))) @ (^ [Xx3:$i] : (ccfv @ XH @ ccort)))))))))).
...
thf(achel_ax,axiom,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : (((cwcel @ XH @ ccch) & (cwcel @ XA2 @ XH)) => (cwcel @ XA2 @ cchil))))).
...
thf(aspansnsh_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ cchil) => (cwcel @ (ccfv @ (ccsn @ XA2) @ ccspn) @ ccsh)))).
thf(aspansnid_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ cchil) => (cwcel @ XA2 @ (ccfv @ (ccsn @ XA2) @ ccspn))))).
...
thf(aaxpjcl_ax,axiom,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : (((cwcel @ XH @ ccch) & (cwcel @ XA2 @ cchil)) => (cwcel @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ XH))))).
...
thf(cpjspansn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil) @ (cwne @ XA2 @ cc0v)) => ((ccfv @ XB2 @ (ccfv @ (ccfv @ (ccsn @ XA2) @ ccspn) @ ccpjh)) = (cco @ (cco @ (cco @ XB2 @ XA2 @ ccsp) @ (cco @ (ccfv @ XA2 @ ccno) @ cc2 @ ccexp) @ ccdiv) @ XA2 @ ccsm)))))).
