...
thf(cqsqueeze_conj,conjecture,(! [XA2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwral @ (^ [Xx3:$i] : ((cwbr @ ccc0 @ (ccv @ Xx3) @ cclt) => (cwbr @ XA2 @ (ccv @ Xx3) @ cclt))) @ (^ [Xx3:$i] : ccq))) => (XA2 = ccc0)))).
