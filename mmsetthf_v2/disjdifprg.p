...
thf(cdisjdifprg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XA2 @ (XV @ Xx3)) & (cwcel @ XB2 @ (XW @ Xx3))) => (cwdisj @ (^ [Xx3:$i] : (ccpr @ (ccdif @ XB2 @ XA2) @ XA2)) @ (^ [Xx3:$i] : (ccv @ Xx3)))))))))).
