...
thf(aftalem6_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XN = (ccfv @ XF @ ccdgr)) => ((! [Xx3:$i] : (Xph => (cwcel @ XF @ (ccfv @ (XS @ Xx3) @ ccply)))) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwne @ (ccfv @ ccc0 @ XF) @ ccc0)) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ (ccfv @ (ccfv @ ccc0 @ XF) @ ccabs) @ cclt)) @ (^ [Xx3:$i] : ccc)))))))))))))).
...
thf(cftalem7_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XN = (ccfv @ XF @ ccdgr)) => ((! [Xx3:$i] : (Xph => (cwcel @ XF @ (ccfv @ (XS @ Xx3) @ ccply)))) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (cwne @ (ccfv @ XX @ XF) @ ccc0)) => (Xph => (~ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ XX @ XF) @ ccabs) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ ccle)) @ (^ [Xx3:$i] : ccc))))))))))))))))).
