...
thf(azmod10_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cco @ XN @ cc1 @ ccmo) = ccc0)))).
...
thf(abitsinv1lem_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XM @ ccn0)) => ((cco @ XN @ (cco @ cc2 @ (cco @ XM @ cc1 @ ccaddc) @ ccexp) @ ccmo) = (cco @ (cco @ XN @ (cco @ cc2 @ XM @ ccexp) @ ccmo) @ (ccif @ (cwcel @ XM @ (ccfv @ XN @ ccbits)) @ (cco @ cc2 @ XM @ ccexp) @ ccc0) @ ccaddc)))))).
...
thf(cbitsinv1_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((ccsu @ (ccfv @ XN @ ccbits) @ (^ [Xn:$i] : (cco @ cc2 @ (ccv @ Xn) @ ccexp))) = XN)))).
