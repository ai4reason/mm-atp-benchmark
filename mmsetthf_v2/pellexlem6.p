...
thf(aabsmod0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccrp)) => (((cco @ XA2 @ XB2 @ ccmo) = ccc0) <=> ((cco @ (ccfv @ XA2 @ ccabs) @ XB2 @ ccmo) = ccc0)))))).
