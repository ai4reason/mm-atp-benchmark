...
thf(apsr1sca_ax,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((XP = (ccfv @ XR @ ccps1)) => ((cwcel @ XR @ XV) => (XR = (ccfv @ XP @ ccsca)))))))).
...
thf(cpsr1sca2_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : ((XP = (ccfv @ XR @ ccps1)) => ((ccfv @ XR @ ccid) = (ccfv @ XP @ ccsca)))))).
