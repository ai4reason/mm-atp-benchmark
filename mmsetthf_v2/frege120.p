...
thf(afrege119_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xa:$i] : (cwcel @ XX @ (XU @ Xa))) => ((! [Xa:$i] : (cwcel @ XY @ (XV @ Xa))) => (! [Xa:$i] : (((! [Xa:$i] : ((cwbr @ XY @ (ccv @ Xa) @ XR) => ((ccv @ Xa) = XX))) => ((cwbr @ XY @ (XA2 @ Xa) @ XR) => ((XA2 @ Xa) = XX))) => ((cwfun @ (cccnv @ (cccnv @ XR))) => ((cwbr @ XY @ XX @ XR) => ((cwbr @ XY @ (XA2 @ Xa) @ XR) => ((XA2 @ Xa) = XX))))))))))))))).
