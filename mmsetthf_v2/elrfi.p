...
thf(aelpwun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccvv) => ((cwcel @ XA2 @ (ccpw @ (ccun @ XB2 @ XC))) <=> (cwcel @ (ccdif @ XA2 @ XC) @ (ccpw @ XB2)))))))).
...
thf(aintsng_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((ccint @ (ccsn @ XA2)) = XA2))))).
...
thf(celrfi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XB2 @ XV) & (cwss @ XC @ (ccpw @ XB2))) => ((cwcel @ XA2 @ (ccfv @ (ccun @ (ccsn @ XB2) @ XC) @ ccfi)) <=> (cwrex @ (^ [Xv:$i] : (XA2 = (ccin @ XB2 @ (ccint @ (ccv @ Xv))))) @ (^ [Xv:$i] : (ccin @ (ccpw @ XC) @ ccfn)))))))))).
