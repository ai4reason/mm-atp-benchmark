...
thf(aoeworde_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdif @ ccon0 @ cc2o)) & (cwcel @ XB2 @ ccon0)) => (cwss @ XB2 @ (cco @ XA2 @ XB2 @ ccoe)))))).
...
thf(coeeulem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : ((XX @ Xx3) = (ccuni @ (ccint @ (ccrab @ (^ [Xx3:$i] : (cwcel @ XB2 @ (cco @ XA2 @ (ccv @ Xx3) @ ccoe))) @ (^ [Xx3:$i] : ccon0)))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ (ccdif @ ccon0 @ cc2o)) & (cwcel @ XB2 @ (ccdif @ ccon0 @ cc1o))) => (cw3a @ (cwcel @ (XX @ Xx3) @ ccon0) @ (cwss @ (cco @ XA2 @ (XX @ Xx3) @ ccoe) @ XB2) @ (cwcel @ XB2 @ (cco @ XA2 @ (ccsuc @ (XX @ Xx3)) @ ccoe)))))))))).
