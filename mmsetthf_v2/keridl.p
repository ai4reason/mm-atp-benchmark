...
thf(arngohomf_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XX = (ccrn @ XG)) => ((XJ = (ccfv @ XS @ cc1st)) => ((XY = (ccrn @ XJ)) => ((cw3a @ (cwcel @ XR @ ccrngo) @ (cwcel @ XS @ ccrngo) @ (cwcel @ XF @ (cco @ XR @ XS @ ccrnghom))) => (cwf @ XX @ XY @ XF)))))))))))))).
...
thf(arngohom0_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XZ = (ccfv @ XG @ ccgi)) => ((XJ = (ccfv @ XS @ cc1st)) => ((XW = (ccfv @ XJ @ ccgi)) => ((cw3a @ (cwcel @ XR @ ccrngo) @ (cwcel @ XS @ ccrngo) @ (cwcel @ XF @ (cco @ XR @ XS @ ccrnghom))) => ((ccfv @ XZ @ XF) = XW)))))))))))))).
...
thf(arngohomcl_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XX = (ccrn @ XG)) => ((XJ = (ccfv @ XS @ cc1st)) => ((XY = (ccrn @ XJ)) => (((cw3a @ (cwcel @ XR @ ccrngo) @ (cwcel @ XS @ ccrngo) @ (cwcel @ XF @ (cco @ XR @ XS @ ccrnghom))) & (cwcel @ XA2 @ XX)) => (cwcel @ (ccfv @ XA2 @ XF) @ XY))))))))))))))).
...
thf(ckeridl_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XS @ cc1st)) => ((XZ = (ccfv @ XG @ ccgi)) => ((cw3a @ (cwcel @ XR @ ccrngo) @ (cwcel @ XS @ ccrngo) @ (cwcel @ XF @ (cco @ XR @ XS @ ccrnghom))) => (cwcel @ (ccima @ (cccnv @ XF) @ (ccsn @ XZ)) @ (ccfv @ XR @ ccidl))))))))))).
