...
thf(areu8nf_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [XA2:($i > $o)] : ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xy1)))) => ((! [Xw:$i] : (cwnf @ (^ [Xx3:$i] : (Xch @ Xx3 @ Xw)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (((ccv @ Xx3) = (ccv @ Xw)) => ((Xph @ Xx3 @ Xy1) <=> (Xch @ Xx3 @ Xw)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (((ccv @ Xw) = (ccv @ Xy1)) => ((Xch @ Xx3 @ Xw) <=> (Xps @ Xx3 @ Xy1)))))) => (! [Xy1:$i] : ((cwreu @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : XA2)) <=> (cwrex @ (^ [Xx3:$i] : ((Xph @ Xx3 @ Xy1) & (cwral @ (^ [Xy1:$i] : ((Xps @ Xx3 @ Xy1) => ((ccv @ Xx3) = (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : XA2))))))))))))).
...
thf(anfreu_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)))) => ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))) => (cwnf @ (^ [Xx3:$i] : (cwreu @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1)))))))))).
...
thf(areuccats1lem_ax,axiom,(! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xx3:$i] : (! [Xs1:$i] : (((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ (XU @ Xs1) @ XX) @ (cwcel @ (cco @ XW @ (ccs1 @ (XS @ Xx3)) @ ccconcat) @ XX)) & ((cwral @ (^ [Xs1:$i] : ((cwcel @ (cco @ XW @ (ccs1 @ (ccv @ Xs1)) @ ccconcat) @ XX) => ((XS @ Xx3) = (ccv @ Xs1)))) @ (^ [Xs1:$i] : XV)) & (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (ccword @ XV)) & ((ccfv @ (ccv @ Xx3) @ cchash) = (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc)))) @ (^ [Xx3:$i] : XX)))) => ((XW = (cco @ (XU @ Xs1) @ (ccop @ ccc0 @ (ccfv @ XW @ cchash)) @ ccsubstr)) => ((XU @ Xs1) = (cco @ XW @ (ccs1 @ (XS @ Xx3)) @ ccconcat)))))))))))).
...
thf(creuccats1_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : ((cwnfc @ (^ [Xv:$i] : (XX @ Xv))) => (! [Xv:$i] : (((cwcel @ XW @ (ccword @ XV)) & (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (ccword @ XV)) & ((ccfv @ (ccv @ Xx3) @ cchash) = (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc)))) @ (^ [Xx3:$i] : (XX @ Xv)))) => ((cwreu @ (^ [Xv:$i] : (cwcel @ (cco @ XW @ (ccs1 @ (ccv @ Xv)) @ ccconcat) @ (XX @ Xv))) @ (^ [Xv:$i] : XV)) => (cwreu @ (^ [Xx3:$i] : (XW = (cco @ (ccv @ Xx3) @ (ccop @ ccc0 @ (ccfv @ XW @ cchash)) @ ccsubstr))) @ (^ [Xx3:$i] : (XX @ Xv))))))))))).
