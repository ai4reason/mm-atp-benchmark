...
thf(agexcl_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => ((cwcel @ XG @ XV) => (cwcel @ XE @ ccn0))))))))).
...
thf(agexdvds3_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XX @ ccfn)) => (cwbr @ XE @ (ccfv @ XX @ cchash) @ ccdvds)))))))).
...
thf(agexod_ax,axiom,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => ((XO = (ccfv @ XG @ ccod)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX)) => (cwbr @ (ccfv @ XA2 @ XO) @ XE @ ccdvds))))))))))).
