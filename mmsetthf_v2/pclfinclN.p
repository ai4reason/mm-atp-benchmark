...
thf(apcl0N_ax,axiom,(! [XU:($i > $o)] : (! [XK:($i > $o)] : ((XU = (ccfv @ XK @ ccpclN)) => ((cwcel @ XK @ cchlt) => ((ccfv @ cc0 @ XU) = cc0)))))).
thf(a_0psubclN_ax,axiom,(! [XC:($i > $o)] : (! [XK:($i > $o)] : ((XC = (ccfv @ XK @ ccpscN)) => ((cwcel @ XK @ cchlt) => (cwcel @ cc0 @ XC)))))).
...
thf(aatpsubclN_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XK:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XC = (ccfv @ XK @ ccpscN)) => (((cwcel @ XK @ cchlt) & (cwcel @ XQ @ XA2)) => (cwcel @ (ccsn @ XQ) @ XC))))))))).
...
thf(apclssidN_ax,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XU = (ccfv @ XK @ ccpclN)) => (((cwcel @ XK @ XV) & (cwss @ XX @ XA2)) => (cwss @ XX @ (ccfv @ XX @ XU))))))))))).
...
thf(apsubclsubN_ax,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XS = (ccfv @ XK @ ccpsubsp)) => ((XC = (ccfv @ XK @ ccpscN)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XC)) => (cwcel @ XX @ XS))))))))).
...
thf(apcl0bN_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XU = (ccfv @ XK @ ccpclN)) => (((cwcel @ XK @ cchlt) & (cwss @ XP @ XA2)) => (((ccfv @ XP @ XU) = cc0) <=> (XP = cc0)))))))))).
...
thf(aelpcliN_ax,axiom,(! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XS = (ccfv @ XK @ ccpsubsp)) => ((XU = (ccfv @ XK @ ccpclN)) => (((cw3a @ (cwcel @ XK @ XV) @ (cwss @ XX @ XY) @ (cwcel @ XY @ XS)) & (cwcel @ XQ @ (ccfv @ XX @ XU))) => (cwcel @ XQ @ XY)))))))))))).
...
thf(apsubspi2N_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XS = (ccfv @ XK @ ccpsubsp)) => (((cw3a @ (cwcel @ XK @ XD) @ (cwcel @ XX @ XS) @ (cwcel @ XP @ XA2)) & (cw3a @ (cwcel @ XQ @ XX) @ (cwcel @ XR @ XX) @ (cwbr @ XP @ (cco @ XQ @ XR @ Xc_or) @ Xc_le))) => (cwcel @ XP @ XX))))))))))))))))).
thf(asylib_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps <=> Xch) => (Xph => Xch))))))).
thf(ajca_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => Xch) => (Xph => (Xps & Xch)))))))).
thf(asimplrr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & (Xps & Xch)) & Xth) => Xch)))))).
thf(aelpclN_ax,axiom,(! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XS = (ccfv @ XK @ ccpsubsp)) => ((! [Xy1:$i] : ((XU @ Xy1) = (ccfv @ XK @ ccpclN))) => ((cwcel @ XQ @ ccvv) => (! [Xy1:$i] : (((cwcel @ XK @ XV) & (cwss @ XX @ XA2)) => ((cwcel @ XQ @ (ccfv @ XX @ (XU @ Xy1))) <=> (cwral @ (^ [Xy1:$i] : ((cwss @ XX @ (ccv @ Xy1)) => (cwcel @ XQ @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XS))))))))))))))))).
thf(cpclfinclN_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XU = (ccfv @ XK @ ccpclN)) => ((XS = (ccfv @ XK @ ccpscN)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cwss @ XX @ XA2) @ (cwcel @ XX @ ccfn)) => (cwcel @ (ccfv @ XX @ XU) @ XS))))))))))).
