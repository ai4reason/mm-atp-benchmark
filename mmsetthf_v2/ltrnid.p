...
thf(altrnval1_ax,axiom,(! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((cw3a @ ((cwcel @ XK @ XV) & (cwcel @ XW @ XH)) @ (cwcel @ XF @ XT) @ ((cwcel @ XX @ XB2) & (cwbr @ XX @ XW @ Xc_le))) => ((ccfv @ XX @ XF) = XX)))))))))))))))).
thf(apm2_61_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph => Xps) => (((~ Xph) => Xps) => Xps))))).
thf(alauteq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XI = (ccfv @ XK @ cclaut)) => (((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XF @ XI) @ (cwcel @ XX @ XB2)) & (cwral @ (^ [Xp:$i] : ((ccfv @ (ccv @ Xp) @ XF) = (ccv @ Xp))) @ (^ [Xp:$i] : XA2))) => ((ccfv @ XX @ XF) = XX)))))))))))).
...
thf(cltrnid_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((! [Xp:$i] : ((Xc_le @ Xp) = (ccfv @ XK @ ccple))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwcel @ XF @ XT)) => ((cwral @ (^ [Xp:$i] : ((~ (cwbr @ (ccv @ Xp) @ XW @ (Xc_le @ Xp))) => ((ccfv @ (ccv @ Xp) @ XF) = (ccv @ Xp)))) @ (^ [Xp:$i] : XA2)) <=> (XF = (ccres @ ccid @ XB2)))))))))))))))))).
