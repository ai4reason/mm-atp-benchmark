...
thf(areschomf_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((XD = (cco @ XC @ XH @ ccresc)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XC @ XV)) => ((Xph => (cwfn @ XH @ (ccxp @ XS @ XS))) => ((Xph => (cwss @ XS @ XB2)) => (Xph => (XH = (ccfv @ XD @ cchomf)))))))))))))))).
thf(cwsbc_tp,type,(cwsbc : (($i > $o) > (($i > $o) > $o)))).
thf(ccab_tp,type,(ccab : (($i > $o) > ($i > $o)))).
thf(asubcrcl_ax,axiom,(! [XC:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ (ccfv @ XC @ ccsubc)) => (cwcel @ XC @ cccat))))).
thf(asubcfn_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XC @ ccsubc))) => ((Xph => (XS = (ccdm @ (ccdm @ XJ)))) => (Xph => (cwfn @ XJ @ (ccxp @ XS @ XS)))))))))).
...
thf(assctr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccssc) & (cwbr @ XB2 @ XC @ ccssc)) => (cwbr @ XA2 @ XC @ ccssc)))))).
...
thf(aissubc3_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((XH = (ccfv @ XC @ cchomf)) => ((! [Xx3:$i] : ((Xc_1 @ Xx3) = (ccfv @ XC @ cccid))) => ((XD = (cco @ XC @ XJ @ ccresc)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwfn @ XJ @ (ccxp @ XS @ XS))) => (Xph => ((cwcel @ XJ @ (ccfv @ XC @ ccsubc)) <=> (cw3a @ (cwbr @ XJ @ XH @ ccssc) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (Xc_1 @ Xx3)) @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ XJ))) @ (^ [Xx3:$i] : XS)) @ (cwcel @ XD @ cccat))))))))))))))))).
