...
thf(accatw2s1ass_ax,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV)) => ((cco @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ (ccs1 @ XY) @ ccconcat) = (cco @ XW @ (cco @ (ccs1 @ XX) @ (ccs1 @ XY) @ ccconcat) @ ccconcat)))))))).
...
thf(cccat2s1fvw_conj,conjecture,(! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XI @ ccn0) @ (cwbr @ XI @ (ccfv @ XW @ cchash) @ cclt)) & ((cwcel @ XX @ XV) & (cwcel @ XY @ XV))) => ((ccfv @ XI @ (cco @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ (ccs1 @ XY) @ ccconcat)) = (ccfv @ XI @ XW))))))))).
