...
thf(cupbdrech_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : ((! [Xz:$i] : ((Xph @ Xz) => (cwne @ XA2 @ cc0))) => ((! [Xx3:$i] : (! [Xz:$i] : (((Xph @ Xz) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccr)))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xx3:$i] : XA2))) @ (^ [Xy1:$i] : ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XC @ Xx3 @ Xy1 @ Xz) = (ccsup @ (ccab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xz) = (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2)))) @ ccr @ cclt))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xz) => ((cwcel @ (XC @ Xx3 @ Xy1 @ Xz) @ ccr) & (cwral @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (XC @ Xx3 @ Xy1 @ Xz) @ ccle)) @ (^ [Xx3:$i] : XA2)))))))))))))))).
