...
thf(asplcl_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XS @ (ccword @ XA2)) & (cwcel @ XR @ (ccword @ XA2))) => (cwcel @ (cco @ XS @ (ccotp @ XF @ XT @ XR) @ ccsplice) @ (ccword @ XA2))))))))).
...
thf(apncan2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XA2 @ ccmin) = XB2))))).
...
thf(asplid_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XS @ (ccword @ XA2)) & ((cwcel @ XX @ (cco @ ccc0 @ XY @ ccfz)) & (cwcel @ XY @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz)))) => ((cco @ XS @ (ccotp @ XX @ XY @ (cco @ XS @ (ccop @ XX @ XY) @ ccsubstr)) @ ccsplice) = XS))))))).
thf(agsumspl_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xph => (cwcel @ XM @ ccmnd)) => ((Xph => (cwcel @ XS @ (ccword @ XB2))) => ((Xph => (cwcel @ XF @ (cco @ ccc0 @ XT @ ccfz))) => ((Xph => (cwcel @ XT @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) => ((Xph => (cwcel @ XX @ (ccword @ XB2))) => ((Xph => (cwcel @ XY @ (ccword @ XB2))) => ((Xph => ((cco @ XM @ XX @ ccgsu) = (cco @ XM @ XY @ ccgsu))) => (Xph => ((cco @ XM @ (cco @ XS @ (ccotp @ XF @ XT @ XX) @ ccsplice) @ ccgsu) = (cco @ XM @ (cco @ XS @ (ccotp @ XF @ XT @ XY) @ ccsplice) @ ccgsu)))))))))))))))))))).
...
thf(aswrds2_ax,axiom,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XA2)) @ (cwcel @ XI @ ccn0) @ (cwcel @ (cco @ XI @ cc1 @ ccaddc) @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) => ((cco @ XW @ (ccop @ XI @ (cco @ XI @ cc2 @ ccaddc)) @ ccsubstr) = (ccs2 @ (ccfv @ XI @ XW) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XW)))))))).
...
thf(agsumws2_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((cw3a @ (cwcel @ XG @ ccmnd) @ (cwcel @ XS @ XB2) @ (cwcel @ XT @ XB2)) => ((cco @ XG @ (ccs2 @ XS @ XT) @ ccgsu) = (cco @ XS @ XT @ Xc_pl))))))))))).
thf(asyl2anc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xph => Xch) => (((Xps & Xch) => Xth) => (Xph => Xth))))))))).
thf(asymgov_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) => ((cco @ XX @ XY @ Xc_pl) = (cccom @ XX @ XY))))))))))))).
...
thf(asplfv2a_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccword @ XA2))) => ((Xph => (cwcel @ XF @ (cco @ ccc0 @ XT @ ccfz))) => ((Xph => (cwcel @ XT @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) => ((Xph => (cwcel @ XR @ (ccword @ XA2))) => ((Xph => (cwcel @ XX @ (cco @ ccc0 @ (ccfv @ XR @ cchash) @ ccfzo))) => (Xph => ((ccfv @ (cco @ XF @ XX @ ccaddc) @ (cco @ XS @ (ccotp @ XF @ XT @ XR) @ ccsplice)) = (ccfv @ XX @ XR)))))))))))))))).
...
thf(afzosplitsni_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XB2 @ (ccfv @ XA2 @ ccuz)) => ((cwcel @ XC @ (cco @ XA2 @ (cco @ XB2 @ cc1 @ ccaddc) @ ccfzo)) <=> ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccfzo)) | (XC = XB2)))))))).
...
thf(asplfv1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccword @ XA2))) => ((Xph => (cwcel @ XF @ (cco @ ccc0 @ XT @ ccfz))) => ((Xph => (cwcel @ XT @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) => ((Xph => (cwcel @ XR @ (ccword @ XA2))) => ((Xph => (cwcel @ XX @ (cco @ ccc0 @ XF @ ccfzo))) => (Xph => ((ccfv @ XX @ (cco @ XS @ (ccotp @ XF @ XT @ XR) @ ccsplice)) = (ccfv @ XX @ XS)))))))))))))))).
...
thf(apsgnunilem1_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xs1:$i] : (! [Xr:$i] : (XT = (ccrn @ (ccfv @ (XD @ Xs1 @ Xr) @ ccpmtr))))) => ((! [Xs1:$i] : (! [Xr:$i] : ((Xph @ Xs1 @ Xr) => (cwcel @ (XD @ Xs1 @ Xr) @ (XV @ Xs1 @ Xr))))) => ((! [Xs1:$i] : (! [Xr:$i] : ((Xph @ Xs1 @ Xr) => (cwcel @ XP @ XT)))) => ((! [Xs1:$i] : (! [Xr:$i] : ((Xph @ Xs1 @ Xr) => (cwcel @ XQ @ XT)))) => ((! [Xs1:$i] : (! [Xr:$i] : ((Xph @ Xs1 @ Xr) => (cwcel @ XA2 @ (ccdm @ (ccdif @ XP @ ccid)))))) => (! [Xs1:$i] : (! [Xr:$i] : ((Xph @ Xs1 @ Xr) => (((cccom @ XP @ XQ) = (ccres @ ccid @ (XD @ Xs1 @ Xr))) | (cwrex @ (^ [Xr:$i] : (cwrex @ (^ [Xs1:$i] : (cw3a @ ((cccom @ XP @ XQ) = (cccom @ (ccv @ Xr) @ (ccv @ Xs1))) @ (cwcel @ XA2 @ (ccdm @ (ccdif @ (ccv @ Xs1) @ ccid))) @ (~ (cwcel @ XA2 @ (ccdm @ (ccdif @ (ccv @ Xr) @ ccid)))))) @ (^ [Xs1:$i] : XT))) @ (^ [Xr:$i] : XT))))))))))))))))))).
thf(cpsgnunilem2_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XW:($i > $o)] : ((! [Xk:$i] : (XG = (ccfv @ (XD @ Xk) @ ccsymg))) => ((! [Xk:$i] : ((XT @ Xk) = (ccrn @ (ccfv @ (XD @ Xk) @ ccpmtr)))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xw @ Xk) => (cwcel @ (XD @ Xk) @ (XV @ Xx3 @ Xw @ Xj @ Xk))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xw @ Xk) => (cwcel @ XW @ (ccword @ (XT @ Xk))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xw @ Xk) => ((cco @ XG @ XW @ ccgsu) = (ccres @ ccid @ (XD @ Xk))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xw @ Xk) => ((ccfv @ XW @ cchash) = (XL @ Xj @ Xk))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xw @ Xk) => (cwcel @ XI @ (cco @ ccc0 @ (XL @ Xj @ Xk) @ ccfzo))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xw @ Xk) => (cwcel @ (XA2 @ Xx3) @ (ccdm @ (ccdif @ (ccfv @ XI @ XW) @ ccid))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xw @ Xk) => (cwral @ (^ [Xk:$i] : (~ (cwcel @ (XA2 @ Xx3) @ (ccdm @ (ccdif @ (ccfv @ (ccv @ Xk) @ XW) @ ccid))))) @ (^ [Xk:$i] : (cco @ ccc0 @ XI @ ccfzo))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xw @ Xk) => (~ (cwrex @ (^ [Xx3:$i] : (((ccfv @ (ccv @ Xx3) @ cchash) = (cco @ (XL @ Xj @ Xk) @ cc2 @ ccmin)) & ((cco @ XG @ (ccv @ Xx3) @ ccgsu) = (ccres @ ccid @ (XD @ Xk))))) @ (^ [Xx3:$i] : (ccword @ (XT @ Xk)))))))))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xw @ Xk) => (cwrex @ (^ [Xw:$i] : ((((cco @ XG @ (ccv @ Xw) @ ccgsu) = (ccres @ ccid @ (XD @ Xk))) & ((ccfv @ (ccv @ Xw) @ cchash) = (XL @ Xj @ Xk))) & (cw3a @ (cwcel @ (cco @ XI @ cc1 @ ccaddc) @ (cco @ ccc0 @ (XL @ Xj @ Xk) @ ccfzo)) @ (cwcel @ (XA2 @ Xx3) @ (ccdm @ (ccdif @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ (ccv @ Xw)) @ ccid))) @ (cwral @ (^ [Xj:$i] : (~ (cwcel @ (XA2 @ Xx3) @ (ccdm @ (ccdif @ (ccfv @ (ccv @ Xj) @ (ccv @ Xw)) @ ccid))))) @ (^ [Xj:$i] : (cco @ ccc0 @ (cco @ XI @ cc1 @ ccaddc) @ ccfzo)))))) @ (^ [Xw:$i] : (ccword @ (XT @ Xk))))))))))))))))))))))))))))).
