...
thf(a_0nei_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cctop) => (cwcel @ cc0 @ (ccfv @ cc0 @ (ccfv @ XJ @ ccnei)))))).
...
thf(aco01_ax,axiom,(! [XA2:($i > $o)] : ((cccom @ cc0 @ XA2) = cc0))).
...
thf(aneitx_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => ((((cwcel @ XJ @ cctop) & (cwcel @ XK @ cctop)) & ((cwcel @ XA2 @ (ccfv @ XC @ (ccfv @ XJ @ ccnei))) & (cwcel @ XB2 @ (ccfv @ XD @ (ccfv @ XK @ ccnei))))) => (cwcel @ (ccxp @ XA2 @ XB2) @ (ccfv @ (ccxp @ XC @ XD) @ (ccfv @ (cco @ XJ @ XK @ cctx) @ ccnei))))))))))))))).
...
thf(austrel_ax,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ XV @ XU)) => (cwrel @ XV)))))).
...
thf(axpcoid_ax,axiom,(! [XA2:($i > $o)] : ((cccom @ (ccxp @ XA2 @ XA2) @ (ccxp @ XA2 @ XA2)) = (ccxp @ XA2 @ XA2)))).
...
thf(aneips_ax,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX) @ (cwne @ XS @ cc0)) => ((cwcel @ XN @ (ccfv @ XS @ (ccfv @ XJ @ ccnei))) <=> (cwral @ (^ [Xp:$i] : (cwcel @ XN @ (ccfv @ (ccsn @ (ccv @ Xp)) @ (ccfv @ XJ @ ccnei)))) @ (^ [Xp:$i] : XS)))))))))).
thf(cutop2nei_conj,conjecture,(! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XU @ ccutop)) => ((cw3a @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ ((cwcel @ XV @ XU) & ((cccnv @ XV) = XV)) @ (cwss @ XM @ (ccxp @ XX @ XX))) => (cwcel @ (cccom @ XV @ (cccom @ XM @ XV)) @ (ccfv @ XM @ (ccfv @ (cco @ XJ @ XJ @ cctx) @ ccnei))))))))))).
