...
thf(ampnanrd_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => (~ (Xps & Xch))) => (Xph => (~ Xch)))))))).
...
thf(consucuni3_conj,conjecture,(! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XB2 @ ccon0) @ (cwne @ XB2 @ cc0) @ (~ (cwlim @ XB2))) => (XB2 = (ccsuc @ (ccuni @ XB2)))))).
