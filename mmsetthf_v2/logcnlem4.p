...
thf(atanabsge_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)) => (cwbr @ (ccfv @ XA2 @ ccabs) @ (ccfv @ (ccfv @ XA2 @ cctan) @ ccabs) @ ccle)))).
