...
thf(aasymref_ax,axiom,(! [XR:($i > $o)] : (((ccin @ XR @ (cccnv @ XR)) = (ccres @ ccid @ (ccuni @ (ccuni @ XR)))) <=> (cwral @ (^ [Xx3:$i] : (! [Xy1:$i] : (((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR)) <=> ((ccv @ Xx3) = (ccv @ Xy1))))) @ (^ [Xx3:$i] : (ccuni @ (ccuni @ XR))))))).
...
thf(aalbiim_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) <=> (Xps @ Xx3))) <=> ((! [Xx3:$i] : ((Xph @ Xx3) => (Xps @ Xx3))) & (! [Xx3:$i] : ((Xps @ Xx3) => (Xph @ Xx3)))))))).
