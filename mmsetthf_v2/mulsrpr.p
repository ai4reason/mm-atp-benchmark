...
thf(amulsrmo_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccqs @ (ccxp @ ccnp @ ccnp) @ ccer)) & (cwcel @ XB2 @ (ccqs @ (ccxp @ ccnp @ ccnp) @ ccer))) => (cwmo @ (^ [Xz:$i] : (? [Xw:$i] : (? [Xv:$i] : (? [Xu:$i] : (? [Xt:$i] : (((XA2 = (ccec @ (ccop @ (ccv @ Xw) @ (ccv @ Xv)) @ ccer)) & (XB2 = (ccec @ (ccop @ (ccv @ Xu) @ (ccv @ Xt)) @ ccer))) & ((ccv @ Xz) = (ccec @ (ccop @ (cco @ (cco @ (ccv @ Xw) @ (ccv @ Xu) @ ccmp) @ (cco @ (ccv @ Xv) @ (ccv @ Xt) @ ccmp) @ ccpp) @ (cco @ (cco @ (ccv @ Xw) @ (ccv @ Xt) @ ccmp) @ (cco @ (ccv @ Xv) @ (ccv @ Xu) @ ccmp) @ ccpp)) @ ccer))))))))))))).
