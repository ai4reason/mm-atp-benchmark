...
thf(abezoutr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) & ((cwcel @ XX @ ccz) & (cwcel @ XY @ ccz))) => (cwbr @ (cco @ XA2 @ XB2 @ ccgcd) @ (cco @ (cco @ XA2 @ XX @ ccmul) @ (cco @ XB2 @ XY @ ccmul) @ ccaddc) @ ccdvds))))))).
