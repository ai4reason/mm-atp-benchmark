...
thf(afvclss_ax,axiom,(! [XF:($i > $o)] : (cwss @ (ccab @ (^ [Xy1:$i] : (? [Xx3:$i] : ((ccv @ Xy1) = (ccfv @ (ccv @ Xx3) @ XF))))) @ (ccun @ (ccrn @ XF) @ (ccsn @ cc0))))).
thf(cfvclex_conj,conjecture,(! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwcel @ (ccab @ (^ [Xy1:$i] : (? [Xx3:$i] : ((ccv @ Xy1) = (ccfv @ (ccv @ Xx3) @ XF))))) @ ccvv)))).
