...
thf(aoawordex_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((cwss @ XA2 @ XB2) <=> (cwrex @ (^ [Xx3:$i] : ((cco @ XA2 @ (ccv @ Xx3) @ ccoa) = XB2)) @ (^ [Xx3:$i] : ccon0))))))).
...
thf(coaordex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((cwcel @ XA2 @ XB2) <=> (cwrex @ (^ [Xx3:$i] : ((cwcel @ cc0 @ (ccv @ Xx3)) & ((cco @ XA2 @ (ccv @ Xx3) @ ccoa) = XB2))) @ (^ [Xx3:$i] : ccon0))))))).
