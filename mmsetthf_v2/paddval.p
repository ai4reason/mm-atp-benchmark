...
thf(apaddfval_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xc_pl:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xc_or:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xm:$i] : (! [Xn:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((Xc_le @ Xm @ Xn @ Xr @ Xq @ Xp) = (ccfv @ XK @ ccple))))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((Xc_or @ Xm @ Xn @ Xr @ Xq @ Xp) = (ccfv @ XK @ ccjn))))))) => ((! [Xr:$i] : (! [Xq:$i] : ((XA2 @ Xr @ Xq) = (ccfv @ XK @ ccatm)))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((Xc_pl @ Xm @ Xn @ Xr @ Xq @ Xp) = (ccfv @ XK @ ccpadd))))))) => (! [Xm:$i] : (! [Xn:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((cwcel @ XK @ (XB2 @ Xm @ Xn @ Xr @ Xq @ Xp)) => ((Xc_pl @ Xm @ Xn @ Xr @ Xq @ Xp) = (ccmpt2 @ (^ [Xm:$i] : (^ [Xn:$i] : (ccpw @ (XA2 @ Xr @ Xq)))) @ (^ [Xm:$i] : (^ [Xn:$i] : (ccpw @ (XA2 @ Xr @ Xq)))) @ (^ [Xm:$i] : (^ [Xn:$i] : (ccun @ (ccun @ (ccv @ Xm) @ (ccv @ Xn)) @ (ccrab @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : (cwbr @ (ccv @ Xp) @ (cco @ (ccv @ Xq) @ (ccv @ Xr) @ (Xc_or @ Xm @ Xn @ Xr @ Xq @ Xp)) @ (Xc_le @ Xm @ Xn @ Xr @ Xq @ Xp))) @ (^ [Xr:$i] : (ccv @ Xn)))) @ (^ [Xq:$i] : (ccv @ Xm)))) @ (^ [Xp:$i] : (XA2 @ Xr @ Xq))))))))))))))))))))))))).
...
thf(aovmpt2g_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XA2) => ((XR @ Xx3 @ Xy1) = (XG @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xy1) = XB2) => ((XG @ Xx3 @ Xy1) = XS)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XC)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XD)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XR @ Xx3 @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ (cwcel @ XA2 @ XC) @ (cwcel @ XB2 @ XD) @ (cwcel @ XS @ (XH @ Xx3 @ Xy1))) => ((cco @ XA2 @ XB2 @ (XF @ Xx3 @ Xy1)) = XS))))))))))))))))).
...
thf(cpaddval_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [Xc_pl:($i > ($i > ($i > ($i > $o))))] : (! [Xc_or:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((Xc_le @ Xr @ Xq @ Xp) = (ccfv @ XK @ ccple))))) => ((! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((Xc_or @ Xr @ Xq @ Xp) = (ccfv @ XK @ ccjn))))) => ((! [Xr:$i] : (! [Xq:$i] : ((XA2 @ Xr @ Xq) = (ccfv @ XK @ ccatm)))) => ((! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((Xc_pl @ Xr @ Xq @ Xp) = (ccfv @ XK @ ccpadd))))) => (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((cw3a @ (cwcel @ XK @ (XB2 @ Xr @ Xq @ Xp)) @ (cwss @ (XX @ Xr) @ (XA2 @ Xr @ Xq)) @ (cwss @ XY @ (XA2 @ Xr @ Xq))) => ((cco @ (XX @ Xr) @ XY @ (Xc_pl @ Xr @ Xq @ Xp)) = (ccun @ (ccun @ (XX @ Xr) @ XY) @ (ccrab @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : (cwbr @ (ccv @ Xp) @ (cco @ (ccv @ Xq) @ (ccv @ Xr) @ (Xc_or @ Xr @ Xq @ Xp)) @ (Xc_le @ Xr @ Xq @ Xp))) @ (^ [Xr:$i] : XY))) @ (^ [Xq:$i] : (XX @ Xr)))) @ (^ [Xp:$i] : (XA2 @ Xr @ Xq)))))))))))))))))))))).
