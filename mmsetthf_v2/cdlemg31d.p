...
thf(atrl0_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) @ ((cwcel @ XF @ XT) & ((ccfv @ XP @ XF) = XP))) => ((ccfv @ XF @ XR) = Xc_0))))))))))))))))))).
...
thf(acdlemg31c_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > ($i > $o))] : (! [Xc_an:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xv:$i] : ((Xc_le @ Xv) = (ccfv @ (XK @ Xv) @ ccple))) => ((! [Xv:$i] : ((Xc_or @ Xv) = (ccfv @ (XK @ Xv) @ ccjn))) => ((! [Xv:$i] : ((Xc_an @ Xv) = (ccfv @ (XK @ Xv) @ ccmee))) => ((! [Xv:$i] : ((XA2 @ Xv) = (ccfv @ (XK @ Xv) @ ccatm))) => ((! [Xv:$i] : ((XH @ Xv) = (ccfv @ (XK @ Xv) @ cclh))) => ((! [Xv:$i] : ((XT @ Xv) = (ccfv @ (XW @ Xv) @ (ccfv @ (XK @ Xv) @ ccltrn)))) => ((! [Xv:$i] : ((XR @ Xv) = (ccfv @ (XW @ Xv) @ (ccfv @ (XK @ Xv) @ cctrl)))) => ((! [Xv:$i] : ((XN @ Xv) = (cco @ (cco @ (XP @ Xv) @ (ccv @ Xv) @ (Xc_or @ Xv)) @ (cco @ (XQ @ Xv) @ (ccfv @ (XF @ Xv) @ (XR @ Xv)) @ (Xc_or @ Xv)) @ (Xc_an @ Xv)))) => (! [Xv:$i] : ((cw3a @ (cw3a @ ((cwcel @ (XK @ Xv) @ cchlt) & (cwcel @ (XW @ Xv) @ (XH @ Xv))) @ ((cwcel @ (XP @ Xv) @ (XA2 @ Xv)) & (~ (cwbr @ (XP @ Xv) @ (XW @ Xv) @ (Xc_le @ Xv)))) @ ((cwcel @ (XQ @ Xv) @ (XA2 @ Xv)) & (~ (cwbr @ (XQ @ Xv) @ (XW @ Xv) @ (Xc_le @ Xv))))) @ (((cwcel @ (ccv @ Xv) @ (XA2 @ Xv)) & (cwbr @ (ccv @ Xv) @ (XW @ Xv) @ (Xc_le @ Xv))) & (cwcel @ (XF @ Xv) @ (XT @ Xv))) @ (cw3a @ (cwne @ (ccv @ Xv) @ (ccfv @ (XF @ Xv) @ (XR @ Xv))) @ (cwne @ (ccfv @ (XP @ Xv) @ (XF @ Xv)) @ (XP @ Xv)) @ (cwcel @ (XN @ Xv) @ (XA2 @ Xv)))) => (~ (cwbr @ (XN @ Xv) @ (XW @ Xv) @ (Xc_le @ Xv))))))))))))))))))))))))))).
thf(ccdlemg31d_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > ($i > $o))] : (! [Xc_an:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xv:$i] : ((Xc_le @ Xv) = (ccfv @ (XK @ Xv) @ ccple))) => ((! [Xv:$i] : ((Xc_or @ Xv) = (ccfv @ (XK @ Xv) @ ccjn))) => ((! [Xv:$i] : ((Xc_an @ Xv) = (ccfv @ (XK @ Xv) @ ccmee))) => ((! [Xv:$i] : ((XA2 @ Xv) = (ccfv @ (XK @ Xv) @ ccatm))) => ((! [Xv:$i] : ((XH @ Xv) = (ccfv @ (XK @ Xv) @ cclh))) => ((! [Xv:$i] : ((XT @ Xv) = (ccfv @ (XW @ Xv) @ (ccfv @ (XK @ Xv) @ ccltrn)))) => ((! [Xv:$i] : ((XR @ Xv) = (ccfv @ (XW @ Xv) @ (ccfv @ (XK @ Xv) @ cctrl)))) => ((! [Xv:$i] : ((XN @ Xv) = (cco @ (cco @ (XP @ Xv) @ (ccv @ Xv) @ (Xc_or @ Xv)) @ (cco @ (XQ @ Xv) @ (ccfv @ (XF @ Xv) @ (XR @ Xv)) @ (Xc_or @ Xv)) @ (Xc_an @ Xv)))) => (! [Xv:$i] : ((cw3a @ ((cwcel @ (XK @ Xv) @ cchlt) & (cwcel @ (XW @ Xv) @ (XH @ Xv))) @ (cw3a @ ((cwcel @ (XP @ Xv) @ (XA2 @ Xv)) & (~ (cwbr @ (XP @ Xv) @ (XW @ Xv) @ (Xc_le @ Xv)))) @ ((cwcel @ (XQ @ Xv) @ (XA2 @ Xv)) & (~ (cwbr @ (XQ @ Xv) @ (XW @ Xv) @ (Xc_le @ Xv)))) @ ((cwcel @ (ccv @ Xv) @ (XA2 @ Xv)) & (cwbr @ (ccv @ Xv) @ (XW @ Xv) @ (Xc_le @ Xv)))) @ (cw3a @ (cwcel @ (XF @ Xv) @ (XT @ Xv)) @ (cwne @ (ccv @ Xv) @ (ccfv @ (XF @ Xv) @ (XR @ Xv))) @ (cwcel @ (XN @ Xv) @ (XA2 @ Xv)))) => (~ (cwbr @ (XN @ Xv) @ (XW @ Xv) @ (Xc_le @ Xv))))))))))))))))))))))))))).
