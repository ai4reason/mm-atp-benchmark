...
thf(cinfpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((cw3a @ (cwor @ XA2 @ XR) @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2)) => ((ccinf @ (ccpr @ XB2 @ XC) @ XA2 @ XR) = (ccif @ (cwbr @ XB2 @ XC @ XR) @ XB2 @ XC)))))))).
