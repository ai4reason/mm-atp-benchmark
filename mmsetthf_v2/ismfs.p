...
thf(adf_mfs_ax,axiom,(ccmfs = (ccab @ (^ [Xt:$i] : ((((ccin @ (ccfv @ (ccv @ Xt) @ ccmcn) @ (ccfv @ (ccv @ Xt) @ ccmvar)) = cc0) & (cwf @ (ccfv @ (ccv @ Xt) @ ccmvar) @ (ccfv @ (ccv @ Xt) @ ccmtc) @ (ccfv @ (ccv @ Xt) @ ccmty))) & ((cwss @ (ccfv @ (ccv @ Xt) @ ccmax) @ (ccfv @ (ccv @ Xt) @ ccmsta)) & (cwral @ (^ [Xv:$i] : (~ (cwcel @ (ccima @ (cccnv @ (ccfv @ (ccv @ Xt) @ ccmty)) @ (ccsn @ (ccv @ Xv))) @ ccfn))) @ (^ [Xv:$i] : (ccfv @ (ccv @ Xt) @ ccmvt))))))))).
