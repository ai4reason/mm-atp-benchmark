...
thf(atposmpt2_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cctpos @ (XF @ Xx3 @ Xy1)) = (ccmpt2 @ (^ [Xy1:$i] : (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (^ [Xx3:$i] : (XC @ Xx3 @ Xy1))))))))))))).
...
thf(atposeqd_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (XF = XG)) => (Xph => ((cctpos @ XF) = (cctpos @ XG)))))))).
...
thf(atposmap_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : ((cwcel @ XA2 @ (cco @ XB2 @ (ccxp @ XI @ XJ) @ ccmap)) => (cwcel @ (cctpos @ XA2) @ (cco @ XB2 @ (ccxp @ XJ @ XI) @ ccmap)))))))).
thf(cmamutpos_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XF = (cco @ XR @ (ccotp @ XM @ XN @ XP) @ ccmmul)) => ((XG = (cco @ XR @ (ccotp @ XP @ XN @ XM) @ ccmmul)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XM @ ccfn)) => ((Xph => (cwcel @ XN @ ccfn)) => ((Xph => (cwcel @ XP @ ccfn)) => ((Xph => (cwcel @ XX @ (cco @ XB2 @ (ccxp @ XM @ XN) @ ccmap))) => ((Xph => (cwcel @ XY @ (cco @ XB2 @ (ccxp @ XN @ XP) @ ccmap))) => (Xph => ((cctpos @ (cco @ XX @ XY @ XF)) = (cco @ (cctpos @ XY) @ (cctpos @ XX) @ XG))))))))))))))))))))))).
