...
thf(ctrfbas_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XY:($i > ($i > $o))] : (! [Xv:$i] : (((cwcel @ XF @ (ccfv @ (XY @ Xv) @ ccfbas)) & (cwss @ XA2 @ (XY @ Xv))) => ((cwcel @ (cco @ XF @ XA2 @ ccrest) @ (ccfv @ XA2 @ ccfbas)) <=> (cwral @ (^ [Xv:$i] : (cwne @ (ccin @ (ccv @ Xv) @ XA2) @ cc0)) @ (^ [Xv:$i] : XF))))))))).
