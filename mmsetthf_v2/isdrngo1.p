...
thf(cisdrngo1_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XH = (ccfv @ XR @ cc2nd)) => ((XZ = (ccfv @ XG @ ccgi)) => ((XX = (ccrn @ XG)) => ((cwcel @ XR @ ccdrng) <=> ((cwcel @ XR @ ccrngo) & (cwcel @ (ccres @ XH @ (ccxp @ (ccdif @ XX @ (ccsn @ XZ)) @ (ccdif @ XX @ (ccsn @ XZ)))) @ ccgr))))))))))))).
