...
thf(aax13b_b_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xz:$i] : (((~ ((ccv @ Xx3) = (ccv @ Xx3))) => (((ccv @ Xx3) = (ccv @ Xz)) => (Xph @ Xx3 @ Xz))) <=> ((~ ((ccv @ Xx3) = (ccv @ Xx3))) => ((~ ((ccv @ Xx3) = (ccv @ Xz))) => (((ccv @ Xx3) = (ccv @ Xz)) => (Xph @ Xx3 @ Xz))))))))).
thf(cax13_b_conj,conjecture,(! [Xx3:$i] : (! [Xz:$i] : ((~ ((ccv @ Xx3) = (ccv @ Xx3))) => (((ccv @ Xx3) = (ccv @ Xz)) => (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xz)))))))).
