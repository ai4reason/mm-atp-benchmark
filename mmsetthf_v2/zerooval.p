...
thf(czerooval_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : ((Xph => (cwcel @ XC @ cccat)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => (Xph => ((ccfv @ XC @ cczeroo) = (ccin @ (ccfv @ XC @ ccinito) @ (ccfv @ XC @ cctermo)))))))))))).
