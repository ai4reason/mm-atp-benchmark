...
thf(afzo12sn_ax,axiom,((cco @ cc1 @ cc2 @ ccfzo) = (ccsn @ cc1))).
...
thf(aprmcyg_ax,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ ccgrp) & (cwcel @ (ccfv @ XB2 @ cchash) @ ccprime)) => (cwcel @ XG @ cccyg)))))).
...
thf(agexdvds2_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => ((! [Xx3:$i] : ((XO @ Xx3) = (ccfv @ XG @ ccod))) => (((cwcel @ XG @ ccgrp) & (cwcel @ XN @ ccz)) => ((cwbr @ XE @ XN @ ccdvds) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (XO @ Xx3)) @ XN @ ccdvds)) @ (^ [Xx3:$i] : XX))))))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(agex2abl_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => (((cwcel @ XG @ ccgrp) & (cwbr @ XE @ cc2 @ ccdvds)) => (cwcel @ XG @ ccabl)))))))).
...
thf(aiscygodd_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xph => (cwcel @ XG @ ccgrp)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => ((ccfv @ XX @ XO) = (ccfv @ XB2 @ cchash))) => (Xph => (cwcel @ XG @ cccyg))))))))))))).
...
thf(clt6abl_conj,conjecture,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ ccgrp) & (cwbr @ (ccfv @ XB2 @ cchash) @ cc6 @ cclt)) => (cwcel @ XG @ ccabl)))))).
