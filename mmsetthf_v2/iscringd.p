...
thf(aiscom2_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xa:$i] : (! [Xb:$i] : (((cwcel @ XG @ (XA2 @ Xa @ Xb)) & (cwcel @ XH @ (XB2 @ Xa @ Xb))) => ((cwcel @ (ccop @ XG @ XH) @ cccm2) <=> (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : ((cco @ (ccv @ Xa) @ (ccv @ Xb) @ XH) = (cco @ (ccv @ Xb) @ (ccv @ Xa) @ XH))) @ (^ [Xb:$i] : (ccrn @ XG)))) @ (^ [Xa:$i] : (ccrn @ XG)))))))))))).
thf(aiscrngo_ax,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ cccring) <=> ((cwcel @ XR @ ccrngo) & (cwcel @ XR @ cccm2))))).
thf(ciscringd_conj,conjecture,(! [Xph:$o] : (! [XU:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XG @ ccablo)) => ((Xph => (XX = (ccrn @ XG))) => ((Xph => (cwf @ (ccxp @ XX @ XX) @ XX @ XH)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph & (cw3a @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX) @ (cwcel @ (ccv @ Xz) @ XX))) => ((cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XH) @ (ccv @ Xz) @ XH) = (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XH) @ XH)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph & (cw3a @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX) @ (cwcel @ (ccv @ Xz) @ XX))) => ((cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ XH) = (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XH) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ XH) @ XG)))))) => ((! [Xz:$i] : (Xph => (cwcel @ (XU @ Xz) @ XX))) => ((! [Xy1:$i] : (! [Xz:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XX)) => ((cco @ (ccv @ Xy1) @ (XU @ Xz) @ XH) = (ccv @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xy1) @ XX))) => ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XH) = (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XH))))) => (Xph => (cwcel @ (ccop @ XG @ XH) @ cccring)))))))))))))))).
