...
thf(cmatsubg_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XG = (cco @ XR @ (ccxp @ XN @ XN) @ ccfrlm)) => (((cwcel @ XN @ ccfn) & (cwcel @ XR @ XV)) => ((ccfv @ XG @ ccsg) = (ccfv @ XA2 @ ccsg))))))))))).
