...
thf(astji1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XS @ ccst) => ((ccfv @ (cco @ (ccfv @ XA2 @ ccort) @ (ccin @ XA2 @ XB2) @ cchj) @ XS) = (cco @ (ccfv @ (ccfv @ XA2 @ ccort) @ XS) @ (ccfv @ (ccin @ XA2 @ XB2) @ XS) @ ccaddc))))))))).
thf(aoveq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))))).
thf(afveq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))))).
thf(aimp_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps => Xch)) => ((Xph & Xps) => Xch)))))).
thf(astcltr2i_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) <=> ((cwcel @ XS @ ccst) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((((ccfv @ (ccv @ Xx3) @ XS) = cc1) => ((ccfv @ (ccv @ Xy1) @ XS) = cc1)) => (cwss @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : ccch))) @ (^ [Xx3:$i] : ccch)))))) => ((cwcel @ XA2 @ ccch) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (((ccfv @ XA2 @ XS) = cc1) => (XA2 = cchil))))))))))).
thf(asyl6eq_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((XB2 = XC) => (Xph => (XA2 = XC))))))))).
thf(aineq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((ccin @ XC @ XA2) = (ccin @ XC @ XB2))))))).
thf(achm1i_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((ccin @ XA2 @ cchil) = XA2)))).
...
thf(astcl_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XS @ ccst) => ((cwcel @ XA2 @ ccch) => (cwcel @ (ccfv @ XA2 @ XS) @ ccr)))))).
thf(ccsh_tp,type,(ccsh : ($i > $o))).
thf(asto1i_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XS @ ccst) => ((cco @ (ccfv @ XA2 @ XS) @ (ccfv @ (ccfv @ XA2 @ ccort) @ XS) @ ccaddc) = cc1)))))).
