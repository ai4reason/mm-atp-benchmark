...
thf(acmspropd_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((Xph => (XB2 = (ccfv @ XK @ ccbs))) => ((Xph => (XB2 = (ccfv @ XL @ ccbs))) => ((Xph => ((ccres @ (ccfv @ XK @ ccds) @ (ccxp @ XB2 @ XB2)) = (ccres @ (ccfv @ XL @ ccds) @ (ccxp @ XB2 @ XB2)))) => ((Xph => ((ccfv @ XK @ cctopn) = (ccfv @ XL @ cctopn))) => (Xph => ((cwcel @ XK @ cccms) <=> (cwcel @ XL @ cccms)))))))))))).
...
thf(acmsss_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XK = (cco @ XM @ XA2 @ ccress)) => ((XX = (ccfv @ XM @ ccbs)) => ((XJ = (ccfv @ XM @ cctopn)) => (((cwcel @ XM @ cccms) & (cwss @ XA2 @ XX)) => ((cwcel @ XK @ cccms) <=> (cwcel @ XA2 @ (ccfv @ XJ @ cccld))))))))))))).
...
thf(aisnvc2_ax,axiom,(! [XF:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((cwcel @ XW @ ccnvc) <=> ((cwcel @ XW @ ccnlm) & (cwcel @ XF @ ccdr))))))).
thf(csrabn_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XS @ (ccfv @ XW @ ccsra))) => ((XJ = (ccfv @ XW @ cctopn)) => ((cw3a @ (cwcel @ XW @ ccnrg) @ (cwcel @ XW @ cccms) @ (cwcel @ XS @ (ccfv @ XW @ ccsubrg))) => ((cwcel @ XA2 @ ccbn) <=> ((cwcel @ XS @ (ccfv @ XJ @ cccld)) & (cwcel @ (cco @ XW @ XS @ ccress) @ ccdr))))))))))).
