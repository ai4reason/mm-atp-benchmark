...
thf(cle2tri3i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwcel @ XC @ ccr) => ((cw3a @ (cwbr @ XA2 @ XB2 @ ccle) @ (cwbr @ XB2 @ XC @ ccle) @ (cwbr @ XC @ XA2 @ ccle)) <=> (cw3a @ (XA2 = XB2) @ (XB2 = XC) @ (XC = XA2)))))))))).
