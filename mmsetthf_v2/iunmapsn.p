...
thf(aiunmapss_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ (XW @ Xx3)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xx3) @ XC @ ccmap))) @ (cco @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XC @ ccmap)))))))))))))).
...
thf(amapsnd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xf1:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xy1 @ Xf1))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (Xph => (cwcel @ XB2 @ (XW @ Xy1 @ Xf1))))) => (Xph => ((cco @ XA2 @ (ccsn @ XB2) @ ccmap) = (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xf1) = (ccsn @ (ccop @ XB2 @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : XA2)))))))))))))).
