...
thf(af1dom2g_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwf1 @ XA2 @ XB2 @ XF)) => (cwbr @ XA2 @ XB2 @ ccdom)))))))).
...
thf(adifsnen_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XX @ XV) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) => (cwbr @ (ccdif @ XX @ (ccsn @ XA2)) @ (ccdif @ XX @ (ccsn @ XB2)) @ ccen))))))).
...
thf(cdomdifsn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccsdm) => (cwbr @ XA2 @ (ccdif @ XB2 @ (ccsn @ XC)) @ ccdom)))))).
