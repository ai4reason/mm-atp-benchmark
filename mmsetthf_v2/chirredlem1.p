...
thf(achlej1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) & (cwss @ XA2 @ XB2)) => (cwss @ (cco @ XA2 @ XC @ cchj) @ (cco @ XB2 @ XC @ cchj))))))).
...
thf(cchirredlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((cwcel @ XA2 @ ccch) => ((((cwcel @ (ccv @ Xp) @ ccat) & ((cwcel @ (ccv @ Xq) @ ccch) & (cwss @ (ccv @ Xq) @ (ccfv @ XA2 @ ccort)))) & (((cwcel @ (ccv @ Xr) @ ccat) & (cwss @ (ccv @ Xr) @ XA2)) & (cwss @ (ccv @ Xr) @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ cchj)))) => ((ccin @ (ccv @ Xp) @ (ccfv @ (ccv @ Xr) @ ccort)) = cc0h)))))))).
