...
thf(achprpcl_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ cc2 @ XA2 @ ccle)) => (cwcel @ (ccfv @ XA2 @ ccchp) @ ccrp)))).
...
thf(apnt3_ax,axiom,(cwbr @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccchp) @ (ccv @ Xx3) @ ccdiv))) @ cc1 @ ccrli)).
thf(cco1_tp,type,(cco1 : ($i > $o))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(ccof_tp,type,(ccof : (($i > $o) > ($i > $o)))).
thf(cccxp_tp,type,(cccxp : ($i > $o))).
thf(ccsqrt_tp,type,(ccsqrt : ($i > $o))).
thf(achpchtlim_ax,axiom,(cwbr @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc2 @ ccpnf @ ccico)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccchp) @ (ccfv @ (ccv @ Xx3) @ cccht) @ ccdiv))) @ cc1 @ ccrli)).
