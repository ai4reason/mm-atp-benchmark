...
thf(ahashge0_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwbr @ ccc0 @ (ccfv @ XA2 @ cchash) @ ccle))))).
...
thf(axrltlen_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwbr @ XA2 @ XB2 @ cclt) <=> ((cwbr @ XA2 @ XB2 @ ccle) & (cwne @ XB2 @ XA2))))))).
thf(chashgt0_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwne @ XA2 @ cc0)) => (cwbr @ ccc0 @ (ccfv @ XA2 @ cchash) @ cclt))))).
