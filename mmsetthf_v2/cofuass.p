...
thf(acofu1st_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XF @ (cco @ XC @ XD @ ccfunc))) => ((Xph => (cwcel @ XG @ (cco @ XD @ XE @ ccfunc))) => (Xph => ((ccfv @ (cco @ XG @ XF @ cccofu) @ cc1st) = (cccom @ (ccfv @ XG @ cc1st) @ (ccfv @ XF @ cc1st))))))))))))))).
...
thf(ccofuass_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XG @ (cco @ XC @ XD @ ccfunc))) => ((Xph => (cwcel @ XH @ (cco @ XD @ XE @ ccfunc))) => ((Xph => (cwcel @ XK @ (cco @ XE @ XF @ ccfunc))) => (Xph => ((cco @ (cco @ XK @ XH @ cccofu) @ XG @ cccofu) = (cco @ XK @ (cco @ XH @ XG @ cccofu) @ cccofu))))))))))))))).
