...
thf(ctendospdi1_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((((cwcel @ XK @ XV) & (cwcel @ XW @ XH)) & (cw3a @ (cwcel @ XU @ XE) @ (cwcel @ XF @ XT) @ (cwcel @ XG @ XT))) => ((ccfv @ (cccom @ XF @ XG) @ XU) = (cccom @ (ccfv @ XF @ XU) @ (ccfv @ XG @ XU))))))))))))))))).
