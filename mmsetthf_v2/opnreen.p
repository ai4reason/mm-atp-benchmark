...
thf(aiccen_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ cclt)) => (cwbr @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ XA2 @ XB2 @ ccicc) @ ccen))))).
...
thf(copnreen_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ (ccrn @ ccioo) @ cctg)) & (cwne @ XA2 @ cc0)) => (cwbr @ XA2 @ (ccpw @ ccn) @ ccen)))).
