...
thf(aidomsubgmo_ax,axiom,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XG = (cco @ (ccfv @ XR @ ccmgp) @ (ccfv @ XR @ ccui) @ ccress)) => (((cwcel @ XR @ ccidom) & (cwcel @ XN @ ccn)) => (cwrmo @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ cchash) = XN)) @ (^ [Xy1:$i] : (ccfv @ XG @ ccsubg))))))))).
...
thf(aodhash2_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => ((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XX) @ (cwcel @ (ccfv @ XA2 @ XO) @ ccn)) => ((ccfv @ (ccfv @ (ccsn @ XA2) @ XK) @ cchash) = (ccfv @ XA2 @ XO)))))))))))).
