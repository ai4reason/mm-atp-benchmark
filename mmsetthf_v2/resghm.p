...
thf(cresghm_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XS @ XX @ ccress)) => (((cwcel @ XF @ (cco @ XS @ XT @ ccghm)) & (cwcel @ XX @ (ccfv @ XS @ ccsubg))) => (cwcel @ (ccres @ XF @ XX) @ (cco @ XU @ XT @ ccghm)))))))))).
