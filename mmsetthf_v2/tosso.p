...
thf(apospo_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_lt = (ccfv @ XK @ ccplt)) => ((cwcel @ XK @ XV) => ((cwcel @ XK @ ccpo) <=> ((cwpo @ XB2 @ Xc_lt) & (cwss @ (ccres @ ccid @ XB2) @ Xc_le))))))))))))).
