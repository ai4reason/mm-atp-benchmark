...
thf(covolfsval_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XG = (cccom @ (cccom @ ccabs @ ccmin) @ XF)) => (((cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF) & (cwcel @ XN @ ccn)) => ((ccfv @ XN @ XG) = (cco @ (ccfv @ (ccfv @ XN @ XF) @ cc2nd) @ (ccfv @ (ccfv @ XN @ XF) @ cc1st) @ ccmin)))))))).
