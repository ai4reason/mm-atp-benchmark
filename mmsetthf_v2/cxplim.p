...
thf(altrec1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => (cwbr @ (cco @ cc1 @ XA2 @ ccdiv) @ XB2 @ cclt)) => (Xph => (cwbr @ (cco @ cc1 @ XB2 @ ccdiv) @ XA2 @ cclt))))))))).
...
thf(acxprecd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwcel @ XB2 @ ccc)) => (Xph => ((cco @ (cco @ cc1 @ XA2 @ ccdiv) @ XB2 @ cccxp) = (cco @ cc1 @ (cco @ XA2 @ XB2 @ cccxp) @ ccdiv))))))))).
...
thf(adivneg2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwne @ XB2 @ ccc0)) => (Xph => ((ccneg @ (cco @ XA2 @ XB2 @ ccdiv)) = (cco @ XA2 @ (ccneg @ XB2) @ ccdiv)))))))))).
...
thf(acxplt2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XB2 @ ccle)) => ((Xph => (cwcel @ XC @ ccrp)) => (Xph => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (cco @ XA2 @ XC @ cccxp) @ (cco @ XB2 @ XC @ cccxp) @ cclt))))))))))))).
...
thf(ccxplim_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccrp) @ (^ [Xn:$i] : (cco @ cc1 @ (cco @ (ccv @ Xn) @ XA2 @ cccxp) @ ccdiv))) @ ccc0 @ ccrli)))).
