...
thf(cgsumws2_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((cw3a @ (cwcel @ XG @ ccmnd) @ (cwcel @ XS @ XB2) @ (cwcel @ XT @ XB2)) => ((cco @ XG @ (ccs2 @ XS @ XT) @ ccgsu) = (cco @ XS @ XT @ Xc_pl))))))))))).
