...
thf(clgslem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (~ (cwbr @ XP @ XA2 @ ccdvds))) => (cwcel @ (cco @ (cco @ (cco @ XA2 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ cc1 @ ccaddc) @ XP @ ccmo) @ (ccpr @ ccc0 @ cc2)))))).
