...
thf(anvinvfval_ax,axiom,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XG = (ccfv @ XU @ ccpv)) => ((XS = (ccfv @ XU @ ccns)) => ((XN = (cccom @ XS @ (cccnv @ (ccres @ cc2nd @ (ccxp @ (ccsn @ (ccneg @ cc1)) @ ccvv))))) => ((cwcel @ XU @ ccnv) => (XN = (ccfv @ XG @ ccgn))))))))))).
