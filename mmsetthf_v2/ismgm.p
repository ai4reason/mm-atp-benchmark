...
thf(adf_mgm_ax,axiom,(ccmgm = (ccab @ (^ [Xg1:$i] : (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xo:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xo)) @ (ccv @ Xb))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xb)))) @ (ccfv @ (ccv @ Xg1) @ ccplusg))) @ (ccfv @ (ccv @ Xg1) @ ccbs)))))).
