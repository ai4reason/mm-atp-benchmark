...
thf(acopsex2g_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((((ccv @ Xx3) = XA2) & ((ccv @ Xy1) = XB2)) => ((Xph @ Xx3 @ Xy1) <=> Xps)))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XA2 @ (XV @ Xx3 @ Xy1)) & (cwcel @ XB2 @ (XW @ Xx3 @ Xy1))) => ((? [Xx3:$i] : (? [Xy1:$i] : (((ccop @ XA2 @ XB2) = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) & (Xph @ Xx3 @ Xy1)))) <=> Xps)))))))))))).
...
thf(cov6g_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) = (ccop @ XA2 @ XB2)) => ((XR @ Xx3 @ Xy1) = XS)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XF @ Xx3 @ Xy1 @ Xz) = (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : ((cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XC) & ((ccv @ Xz) = (XR @ Xx3 @ Xy1))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((cw3a @ (cwcel @ XA2 @ (XG @ Xx3 @ Xy1 @ Xz)) @ (cwcel @ XB2 @ (XH @ Xx3 @ Xy1 @ Xz)) @ (cwcel @ (ccop @ XA2 @ XB2) @ XC)) & (cwcel @ XS @ (XJ @ Xx3 @ Xy1 @ Xz))) => ((cco @ XA2 @ XB2 @ (XF @ Xx3 @ Xy1 @ Xz)) = XS))))))))))))))))).
