...
thf(alpfval_ax,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ cctop) => ((ccfv @ XJ @ cclp) = (ccmpt @ (^ [Xx3:$i] : (ccpw @ XX)) @ (^ [Xx3:$i] : (ccab @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xy1) @ (ccfv @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xy1))) @ (ccfv @ XJ @ cccl))))))))))))).
...
thf(clpval_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => ((ccfv @ XS @ (ccfv @ XJ @ cclp)) = (ccab @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccdif @ XS @ (ccsn @ (ccv @ Xx3))) @ (ccfv @ XJ @ cccl)))))))))))).
