...
thf(callbutfi_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xm:$i] : (! [Xn:$i] : ((XZ @ Xm @ Xn) = (ccfv @ (XM @ Xm @ Xn) @ ccuz)))) => ((! [Xm:$i] : (! [Xn:$i] : ((XA2 @ Xm @ Xn) = (cciun @ (^ [Xn:$i] : (XZ @ Xm @ Xn)) @ (^ [Xn:$i] : (cciin @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)) @ (^ [Xm:$i] : (XB2 @ Xm @ Xn)))))))) => (! [Xm:$i] : (! [Xn:$i] : ((cwcel @ XX @ (XA2 @ Xm @ Xn)) <=> (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xm:$i] : (cwcel @ XX @ (XB2 @ Xm @ Xn))) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)))) @ (^ [Xn:$i] : (XZ @ Xm @ Xn)))))))))))))).
