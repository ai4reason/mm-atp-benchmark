...
thf(ablocn_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((XC = (ccfv @ XU @ ccims)) => ((XD = (ccfv @ XW @ ccims)) => ((XJ = (ccfv @ XC @ ccmopn)) => ((XK = (ccfv @ XD @ ccmopn)) => ((XB2 = (cco @ XU @ XW @ ccblo)) => ((cwcel @ XU @ ccnv) => ((cwcel @ XW @ ccnv) => ((XL = (cco @ XU @ XW @ cclno)) => ((cwcel @ XT @ XL) => ((cwcel @ XT @ (cco @ XJ @ XK @ cccn)) <=> (cwcel @ XT @ XB2))))))))))))))))))))).
