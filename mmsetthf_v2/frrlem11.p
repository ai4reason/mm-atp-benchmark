...
thf(afrrlem10_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : ((cwfr @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((! [Xy1:$i] : (! [Xf1:$i] : ((XB2 @ Xy1 @ Xf1) = (ccab @ (^ [Xf1:$i] : (? [Xx3:$i] : (cw3a @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) @ ((cwss @ (ccv @ Xx3) @ XA2) & (cwral @ (^ [Xy1:$i] : (cwss @ (ccpred @ XA2 @ XR @ (ccv @ Xy1)) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) = (cco @ (ccv @ Xy1) @ (ccres @ (ccv @ Xf1) @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ XG))) @ (^ [Xy1:$i] : (ccv @ Xx3)))))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : ((XF @ Xy1 @ Xf1) = (ccfrecs @ XA2 @ XR @ XG)))) => (! [Xy1:$i] : (! [Xf1:$i] : (cwfun @ (XF @ Xy1 @ Xf1)))))))))))))).
...
thf(cfrrlem11_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : ((cwfr @ XA2 @ XR) => ((cwse @ XA2 @ XR) => ((! [Xy1:$i] : (! [Xf1:$i] : ((XB2 @ Xy1 @ Xf1) = (ccab @ (^ [Xf1:$i] : (? [Xx3:$i] : (cw3a @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) @ ((cwss @ (ccv @ Xx3) @ XA2) & (cwral @ (^ [Xy1:$i] : (cwss @ (ccpred @ XA2 @ XR @ (ccv @ Xy1)) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) = (cco @ (ccv @ Xy1) @ (ccres @ (ccv @ Xf1) @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ XG))) @ (^ [Xy1:$i] : (ccv @ Xx3)))))))))) => ((! [Xy1:$i] : ((XF @ Xy1) = (ccfrecs @ XA2 @ XR @ XG))) => (! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ (ccdm @ (XF @ Xy1))) => ((ccfv @ (ccv @ Xy1) @ (XF @ Xy1)) = (cco @ (ccv @ Xy1) @ (ccres @ (XF @ Xy1) @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ XG)))))))))))))).
