...
thf(agrpn0_ax,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ ccgrp) => (cwne @ XG @ cc0)))).
...
thf(clactghmga_conj,conjecture,(! [Xc_po:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XH = (ccfv @ XY @ ccsymg)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_po @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xx3) @ XF)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XF @ (cco @ XG @ XH @ ccghm)) => (cwcel @ (Xc_po @ Xx3 @ Xy1) @ (cco @ XG @ XY @ ccga))))))))))))))).
