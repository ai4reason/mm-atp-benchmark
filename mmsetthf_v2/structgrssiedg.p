...
thf(aedgfiedgval_ax,axiom,(! [Xph:$o] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwbr @ XG @ XX @ ccstr)) => ((Xph => (cwbr @ cc2 @ (ccfv @ (ccdm @ XG) @ cchash) @ ccle)) => ((Xph => (cwcel @ XE @ XY)) => ((Xph => (cwcel @ (ccop @ (ccfv @ ccnx @ ccedgf) @ XE) @ XG)) => (Xph => ((ccfv @ XG @ cciedg) = XE)))))))))))).
