...
thf(aan42_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) & (Xch & Xth)) <=> ((Xph & Xch) & (Xth & Xps)))))))).
...
thf(cisbasisrelowllem2_conj,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [Xa:$i] : (! [Xb:$i] : ((! [Xz:$i] : (! [Xc:$i] : (! [Xd:$i] : ((XI @ Xz @ Xc @ Xd) = (ccima @ ccico @ (ccxp @ ccr @ ccr)))))) => (! [Xz:$i] : (! [Xc:$i] : (! [Xd:$i] : ((((cw3a @ (cwcel @ (ccv @ Xa) @ ccr) @ (cwcel @ (ccv @ Xb) @ ccr) @ ((ccv @ Xx3) = (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xa) @ (ccv @ Xz) @ ccle) & (cwbr @ (ccv @ Xz) @ (ccv @ Xb) @ cclt))) @ (^ [Xz:$i] : ccr)))) & (cw3a @ (cwcel @ (ccv @ Xc) @ ccr) @ (cwcel @ (ccv @ Xd) @ ccr) @ ((ccv @ Xy1) = (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xc) @ (ccv @ Xz) @ ccle) & (cwbr @ (ccv @ Xz) @ (ccv @ Xd) @ cclt))) @ (^ [Xz:$i] : ccr))))) & ((cwbr @ (ccv @ Xa) @ (ccv @ Xc) @ ccle) & (cwbr @ (ccv @ Xd) @ (ccv @ Xb) @ ccle))) => (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (XI @ Xz @ Xc @ Xd))))))))))))).
