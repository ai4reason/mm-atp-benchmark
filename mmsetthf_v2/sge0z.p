...
thf(apwfin0_ax,axiom,(! [XA2:($i > $o)] : (cwne @ (ccin @ (ccpw @ XA2) @ ccfn) @ cc0))).
...
thf(csge0z_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XA2 @ (XV @ Xk)))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccfv @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : ccc0)) @ ccsumge0) = ccc0))))))))).
