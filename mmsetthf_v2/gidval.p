...
thf(adf_gid_ax,axiom,(ccgi = (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccrio @ (^ [Xu:$i] : (cwral @ (^ [Xx3:$i] : (((cco @ (ccv @ Xu) @ (ccv @ Xx3) @ (ccv @ Xg1)) = (ccv @ Xx3)) & ((cco @ (ccv @ Xx3) @ (ccv @ Xu) @ (ccv @ Xg1)) = (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccrn @ (ccv @ Xg1))))) @ (^ [Xu:$i] : (ccrn @ (ccv @ Xg1)))))))).
thf(ccio_tp,type,(ccio : (($i > $o) > ($i > $o)))).
thf(ariotaex_ax,axiom,(! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (cwcel @ (ccrio @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ccvv)))).
thf(cgidval_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => (! [Xx3:$i] : (! [Xu:$i] : ((cwcel @ XG @ (XV @ Xx3 @ Xu)) => ((ccfv @ XG @ ccgi) = (ccrio @ (^ [Xu:$i] : (cwral @ (^ [Xx3:$i] : (((cco @ (ccv @ Xu) @ (ccv @ Xx3) @ XG) = (ccv @ Xx3)) & ((cco @ (ccv @ Xx3) @ (ccv @ Xu) @ XG) = (ccv @ Xx3)))) @ (^ [Xx3:$i] : XX))) @ (^ [Xu:$i] : XX))))))))))).
