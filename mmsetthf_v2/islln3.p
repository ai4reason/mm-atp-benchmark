...
thf(aislln4_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xp:$i] : ((XB2 @ Xp) = (ccfv @ XK @ ccbs))) => ((! [Xp:$i] : ((XC @ Xp) = (ccfv @ XK @ cccvr))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xp:$i] : ((XN @ Xp) = (ccfv @ XK @ cclln))) => (! [Xp:$i] : (((cwcel @ XK @ (XD @ Xp)) & (cwcel @ XX @ (XB2 @ Xp))) => ((cwcel @ XX @ (XN @ Xp)) <=> (cwrex @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XX @ (XC @ Xp))) @ (^ [Xp:$i] : XA2))))))))))))))))).
...
thf(aatncmp_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((cw3a @ (cwcel @ XK @ ccal) @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2)) => ((~ (cwbr @ XP @ XQ @ Xc_le)) <=> (cwne @ XP @ XQ))))))))))).
