...
thf(azhmnrg_ax,axiom,(! [XG:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccfv @ XG @ cczlm)) => ((cwcel @ XG @ ccnrg) => (cwcel @ XW @ ccnrg)))))).
...
thf(azringnrg_ax,axiom,(cwcel @ czring @ ccnrg)).
...
thf(aressnm_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XH = (cco @ XG @ XA2 @ ccress)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((XN = (ccfv @ XG @ ccnm)) => ((cw3a @ (cwcel @ XG @ ccmnd) @ (cwcel @ Xc_0 @ XA2) @ (cwss @ XA2 @ XB2)) => ((ccres @ XN @ XA2) = (ccfv @ XH @ ccnm)))))))))))))).
...
thf(azringnm_ax,axiom,((ccfv @ czring @ ccnm) = (ccres @ ccabs @ ccz))).
