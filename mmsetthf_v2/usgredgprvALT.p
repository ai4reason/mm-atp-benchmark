...
thf(ausgrss_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XE = (ccfv @ XG @ cciedg)) => ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ ccusgr) & (cwcel @ XX @ (ccdm @ XE))) => (cwss @ (ccfv @ XX @ XE) @ XV))))))))).
thf(ccumgr_tp,type,(ccumgr : ($i > $o))).
thf(ausgredg2_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XE = (ccfv @ XG @ cciedg)) => (((cwcel @ XG @ ccusgr) & (cwcel @ XX @ (ccdm @ XE))) => ((ccfv @ (ccfv @ XX @ XE) @ cchash) = cc2))))))).
