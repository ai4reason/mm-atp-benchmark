...
thf(aeuop2_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xy1:$i] : (cwcel @ (XA2 @ Xy1) @ ccvv)) => ((cweu @ (^ [Xx3:$i] : (? [Xy1:$i] : (((ccv @ Xx3) = (ccop @ (XA2 @ Xy1) @ (ccv @ Xy1))) & (Xph @ Xy1))))) <=> (cweu @ (^ [Xy1:$i] : (Xph @ Xy1)))))))).
thf(cdfac5lem1_conj,conjecture,(! [Xy1:$i] : (! [Xw:$i] : ((cweu @ (^ [Xv:$i] : (cwcel @ (ccv @ Xv) @ (ccin @ (ccxp @ (ccsn @ (ccv @ Xw)) @ (ccv @ Xw)) @ (ccv @ Xy1))))) <=> (cweu @ (^ [Xg1:$i] : ((cwcel @ (ccv @ Xg1) @ (ccv @ Xw)) & (cwcel @ (ccop @ (ccv @ Xw) @ (ccv @ Xg1)) @ (ccv @ Xy1))))))))).
