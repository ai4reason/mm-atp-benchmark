...
thf(cexpnbnd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ cc1 @ XB2 @ cclt)) => (cwrex @ (^ [Xk:$i] : (cwbr @ XA2 @ (cco @ XB2 @ (ccv @ Xk) @ ccexp) @ cclt)) @ (^ [Xk:$i] : ccn)))))).
