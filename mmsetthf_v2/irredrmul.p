...
thf(aunitdvcl_ax,axiom,(! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XU = (ccfv @ XR @ ccui)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XU)) => (cwcel @ (cco @ XX @ XY @ Xc_dv) @ XU)))))))))).
...
thf(aisnirred_ax,axiom,(! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xx3 @ Xy1) = (ccfv @ XR @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XU @ Xx3 @ Xy1) = (ccfv @ XR @ ccui)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XI @ Xx3 @ Xy1) = (ccfv @ XR @ ccir)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XN = (ccdif @ (XB2 @ Xx3 @ Xy1) @ (XU @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_x @ Xx3 @ Xy1) = (ccfv @ XR @ ccmulr)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XX @ (XB2 @ Xx3 @ Xy1)) => ((~ (cwcel @ XX @ (XI @ Xx3 @ Xy1))) <=> ((cwcel @ XX @ (XU @ Xx3 @ Xy1)) | (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_x @ Xx3 @ Xy1)) = XX)) @ (^ [Xy1:$i] : XN))) @ (^ [Xx3:$i] : XN)))))))))))))))))))).
thf(cirredrmul_conj,conjecture,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XI = (ccfv @ XR @ ccir)) => ((XU = (ccfv @ XR @ ccui)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XI) @ (cwcel @ XY @ XU)) => (cwcel @ (cco @ XX @ XY @ Xc_x) @ XI)))))))))))).
