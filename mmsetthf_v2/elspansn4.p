...
thf(celspansn4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccsh) & (cwcel @ XB2 @ cchil)) & ((cwcel @ XC @ (ccfv @ (ccsn @ XB2) @ ccspn)) & (cwne @ XC @ cc0v))) => ((cwcel @ XB2 @ XA2) <=> (cwcel @ XC @ XA2))))))).
