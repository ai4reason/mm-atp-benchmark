...
thf(adf_gbe_ax,axiom,(ccgbe = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cw3a @ (cwcel @ (ccv @ Xp) @ ccodd) @ (cwcel @ (ccv @ Xq) @ ccodd) @ ((ccv @ Xz) = (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccaddc)))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime))) @ (^ [Xz:$i] : cceven)))).
thf(cisgbe_conj,conjecture,(! [XZ:($i > $o)] : ((cwcel @ XZ @ ccgbe) <=> ((cwcel @ XZ @ cceven) & (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cw3a @ (cwcel @ (ccv @ Xp) @ ccodd) @ (cwcel @ (ccv @ Xq) @ ccodd) @ (XZ = (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccaddc)))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime)))))).
