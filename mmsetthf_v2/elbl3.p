...
thf(celbl3_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XR @ ccxr)) & ((cwcel @ XP @ XX) & (cwcel @ XA2 @ XX))) => ((cwcel @ XA2 @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl))) <=> (cwbr @ (cco @ XA2 @ XP @ XD) @ XR @ cclt))))))))).
