...
thf(anexple_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccr) @ (cwbr @ cc2 @ XB2 @ ccle)) => (cwbr @ XA2 @ (cco @ XB2 @ XA2 @ ccexp) @ ccle))))).
