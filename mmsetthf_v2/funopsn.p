...
thf(afuniun_ax,axiom,(! [XF:($i > $o)] : ((cwfun @ XF) => (XF = (cciun @ (^ [Xx3:$i] : (ccdm @ XF)) @ (^ [Xx3:$i] : (ccsn @ (ccop @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ XF))))))))).
...
thf(aiunopeqop_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xz:$i] : (cwcel @ (XB2 @ Xx3 @ Xz) @ ccvv))) => ((! [Xz:$i] : (cwcel @ (XC @ Xz) @ ccvv)) => ((! [Xz:$i] : (cwcel @ (XD @ Xz) @ ccvv)) => (! [Xz:$i] : ((cwne @ XA2 @ cc0) => (((cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccsn @ (ccop @ (ccv @ Xx3) @ (XB2 @ Xx3 @ Xz))))) = (ccop @ (XC @ Xz) @ (XD @ Xz))) => (? [Xz:$i] : (XA2 = (ccsn @ (ccv @ Xz))))))))))))))).
...
thf(asnopeqop_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XD @ ccvv) => (((ccsn @ (ccop @ XA2 @ XB2)) = (ccop @ XC @ XD)) <=> (cw3a @ (XA2 = XB2) @ (XC = XD) @ (XC = (ccsn @ XA2))))))))))))).
