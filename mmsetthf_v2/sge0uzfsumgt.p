...
thf(asge0gtfsumgt_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xy1:$i] : (! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XA2 @ (XV @ Xy1 @ Xk))))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccico)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XC @ Xk) @ ccr))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwbr @ (XC @ Xk) @ (ccfv @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccsumge0) @ cclt))) => (! [Xk:$i] : ((Xph @ Xk) => (cwrex @ (^ [Xy1:$i] : (cwbr @ (XC @ Xk) @ (ccsu @ (ccv @ Xy1) @ (^ [Xk:$i] : (XB2 @ Xk))) @ cclt)) @ (^ [Xy1:$i] : (ccin @ (ccpw @ XA2) @ ccfn)))))))))))))))).
...
thf(afsumreclf_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XA2 @ ccfn))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccr))) => (! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccr)))))))))).
...
thf(afsumlessf_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XA2 @ ccfn))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccr))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XA2)) => (cwbr @ ccc0 @ (XB2 @ Xk) @ ccle))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwss @ XC @ XA2))) => (! [Xk:$i] : ((Xph @ Xk) => (cwbr @ (ccsu @ XC @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccle))))))))))))).
...
thf(csge0uzfsumgt_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XZ:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XK @ ccz))) => ((XZ = (ccfv @ XK @ ccuz)) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccico)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XC @ Xk) @ ccr))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwbr @ (XC @ Xk) @ (ccfv @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccsumge0) @ cclt))) => (! [Xk:$i] : ((Xph @ Xk) => (cwrex @ (^ [Xm:$i] : (cwbr @ (XC @ Xk) @ (ccsu @ (cco @ XK @ (ccv @ Xm) @ ccfz) @ (^ [Xk:$i] : (XB2 @ Xk))) @ cclt)) @ (^ [Xm:$i] : XZ)))))))))))))))).
