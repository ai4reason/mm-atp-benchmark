...
thf(adf_ltxr_ax,axiom,(cclt = (ccun @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cw3a @ (cwcel @ (ccv @ Xx3) @ ccr) @ (cwcel @ (ccv @ Xy1) @ ccr) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccltrr))))) @ (ccun @ (ccxp @ (ccun @ ccr @ (ccsn @ ccmnf)) @ (ccsn @ ccpnf)) @ (ccxp @ (ccsn @ ccmnf) @ ccr))))).
