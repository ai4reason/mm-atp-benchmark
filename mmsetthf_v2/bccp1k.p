...
thf(cbccp1k_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XK @ ccn0)) => (Xph => ((cco @ XC @ (cco @ XK @ cc1 @ ccaddc) @ ccbcc) = (cco @ (cco @ XC @ XK @ ccbcc) @ (cco @ (cco @ XC @ XK @ ccmin) @ (cco @ XK @ cc1 @ ccaddc) @ ccdiv) @ ccmul))))))))).
