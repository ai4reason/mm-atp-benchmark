...
thf(cgrpoinvid1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((XU = (ccfv @ XG @ ccgi)) => ((XN = (ccfv @ XG @ ccgn)) => ((cw3a @ (cwcel @ XG @ ccgr) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) => (((ccfv @ XA2 @ XN) = XB2) <=> ((cco @ XA2 @ XB2 @ XG) = XU))))))))))))).
