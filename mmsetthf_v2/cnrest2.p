...
thf(ccnrest2_conj,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XK @ (ccfv @ XY @ cctopon)) @ (cwss @ (ccrn @ XF) @ XB2) @ (cwss @ XB2 @ XY)) => ((cwcel @ XF @ (cco @ XJ @ XK @ cccn)) <=> (cwcel @ XF @ (cco @ XJ @ (cco @ XK @ XB2 @ ccrest) @ cccn)))))))))).
