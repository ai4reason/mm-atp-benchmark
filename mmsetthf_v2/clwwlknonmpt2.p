...
thf(adf_clwwlknon_ax,axiom,(ccclwwlknon = (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : (ccfv @ (ccv @ Xg1) @ ccvtx))) @ (^ [Xv:$i] : (^ [Xn:$i] : ccn0)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = (ccv @ Xv))) @ (^ [Xw:$i] : (cco @ (ccv @ Xn) @ (ccv @ Xg1) @ ccclwwlkn)))))))))).
...
thf(cclwwlknonmpt2_conj,conjecture,(! [XG:($i > $o)] : ((ccfv @ XG @ ccclwwlknon) = (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : (ccfv @ XG @ ccvtx))) @ (^ [Xv:$i] : (^ [Xn:$i] : ccn0)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = (ccv @ Xv))) @ (^ [Xw:$i] : (cco @ (ccv @ Xn) @ XG @ ccclwwlkn))))))))).
