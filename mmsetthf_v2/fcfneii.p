...
thf(afcfnei_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xs1:$i] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) => ((cwcel @ (XA2 @ Xs1) @ (ccfv @ XF @ (cco @ XJ @ XL @ ccfcf))) <=> ((cwcel @ (XA2 @ Xs1) @ XX) & (cwral @ (^ [Xn:$i] : (cwral @ (^ [Xs1:$i] : (cwne @ (ccin @ (ccv @ Xn) @ (ccima @ XF @ (ccv @ Xs1))) @ cc0)) @ (^ [Xs1:$i] : XL))) @ (^ [Xn:$i] : (ccfv @ (ccsn @ (XA2 @ Xs1)) @ (ccfv @ XJ @ ccnei))))))))))))))).
...
thf(cfcfneii_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) & (cw3a @ (cwcel @ XA2 @ (ccfv @ XF @ (cco @ XJ @ XL @ ccfcf))) @ (cwcel @ XN @ (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ ccnei))) @ (cwcel @ XS @ XL))) => (cwne @ (ccin @ XN @ (ccima @ XF @ XS)) @ cc0))))))))))).
