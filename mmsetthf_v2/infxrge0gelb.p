...
thf(ainfxrge0glb_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc)))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cwbr @ (ccinf @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ cclt) @ XB2 @ cclt) <=> (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XB2 @ cclt)) @ (^ [Xx3:$i] : XA2))))))))))).
