...
thf(assimaexg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [Xx3:$i] : ((cw3a @ (cwcel @ XA2 @ (XC @ Xx3)) @ (cwfun @ XF) @ (cwss @ XB2 @ (ccima @ XF @ XA2))) => (? [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) & (XB2 = (ccima @ XF @ (ccv @ Xx3)))))))))))).
...
thf(ccmpfi_conj,conjecture,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cctop) => ((cwcel @ XJ @ cccmp) <=> (cwral @ (^ [Xx3:$i] : ((~ (cwcel @ cc0 @ (ccfv @ (ccv @ Xx3) @ ccfi))) => (cwne @ (ccint @ (ccv @ Xx3)) @ cc0))) @ (^ [Xx3:$i] : (ccpw @ (ccfv @ XJ @ cccld)))))))).
