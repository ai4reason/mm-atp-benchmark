...
thf(ciscsgrpALT_conj,conjecture,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_op:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_op = (ccfv @ XM @ ccplusg)) => ((cwcel @ XM @ cccsgrp2) <=> ((cwcel @ XM @ ccsgrp2) & (cwbr @ Xc_op @ XB2 @ cccomlaw))))))))).
