...
thf(aconndisj_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((Xph => (cwcel @ XJ @ ccconn)) => ((Xph => (cwcel @ XA2 @ XJ)) => ((Xph => (cwne @ XA2 @ cc0)) => ((Xph => (cwcel @ XB2 @ XJ)) => ((Xph => (cwne @ XB2 @ cc0)) => ((Xph => ((ccin @ XA2 @ XB2) = cc0)) => (Xph => (cwne @ (ccun @ XA2 @ XB2) @ XX))))))))))))))).
...
thf(aisconn2_ax,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ ccconn) <=> ((cwcel @ XJ @ cctop) & (cwss @ (ccin @ XJ @ (ccfv @ XJ @ cccld)) @ (ccpr @ cc0 @ XX)))))))).
...
thf(cdfconn2_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XX @ cctopon)) => ((cwcel @ XJ @ ccconn) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cw3a @ (cwne @ (ccv @ Xx3) @ cc0) @ (cwne @ (ccv @ Xy1) @ cc0) @ ((ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) = cc0)) => (cwne @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XX))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XJ))))))).
