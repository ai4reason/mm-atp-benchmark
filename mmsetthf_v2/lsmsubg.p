...
thf(alsmsubm_ax,axiom,(! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_po = (ccfv @ XG @ cclsm)) => ((XZ = (ccfv @ XG @ cccntz)) => ((cw3a @ (cwcel @ XT @ (ccfv @ XG @ ccsubmnd)) @ (cwcel @ XU @ (ccfv @ XG @ ccsubmnd)) @ (cwss @ XT @ (ccfv @ XU @ XZ))) => (cwcel @ (cco @ XT @ XU @ Xc_po) @ (ccfv @ XG @ ccsubmnd))))))))))).
...
thf(clsmsubg_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_po = (ccfv @ XG @ cclsm)) => ((XZ = (ccfv @ XG @ cccntz)) => ((cw3a @ (cwcel @ XT @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XU @ (ccfv @ XG @ ccsubg)) @ (cwss @ XT @ (ccfv @ XU @ XZ))) => (cwcel @ (cco @ XT @ XU @ Xc_po) @ (ccfv @ XG @ ccsubg))))))))))).
