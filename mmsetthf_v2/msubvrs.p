...
thf(aelmsubrn_ax,axiom,(! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : ((! [Xf1:$i] : (XE = (ccfv @ (XT @ Xf1) @ ccmex))) => ((! [Xf1:$i] : (XO = (ccfv @ (XT @ Xf1) @ ccmrsub))) => ((! [Xe:$i] : (! [Xf1:$i] : ((XS @ Xe @ Xf1) = (ccfv @ (XT @ Xf1) @ ccmsub)))) => (! [Xe:$i] : (! [Xf1:$i] : ((ccrn @ (XS @ Xe @ Xf1)) = (ccrn @ (ccmpt @ (^ [Xf1:$i] : (ccrn @ XO)) @ (^ [Xf1:$i] : (ccmpt @ (^ [Xe:$i] : XE) @ (^ [Xe:$i] : (ccop @ (ccfv @ (ccv @ Xe) @ cc1st) @ (ccfv @ (ccfv @ (ccv @ Xe) @ cc2nd) @ (ccv @ Xf1))))))))))))))))))).
...
thf(amrsubvrs_ax,axiom,(! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XS = (ccfv @ XT @ ccmrsub)) => ((XV = (ccfv @ XT @ ccmvar)) => ((! [Xx3:$i] : ((XR @ Xx3) = (ccfv @ XT @ ccmrex))) => (! [Xx3:$i] : (((cwcel @ XF @ (ccrn @ XS)) & (cwcel @ XX @ (XR @ Xx3))) => ((ccin @ (ccrn @ (ccfv @ XX @ XF)) @ XV) = (cciun @ (^ [Xx3:$i] : (ccin @ (ccrn @ XX) @ XV)) @ (^ [Xx3:$i] : (ccin @ (ccrn @ (ccfv @ (ccs1 @ (ccv @ Xx3)) @ XF)) @ XV)))))))))))))))).
...
thf(amvrsval_ax,axiom,(! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XT @ ccmvar)) => ((XE = (ccfv @ XT @ ccmex)) => ((XW = (ccfv @ XT @ ccmvrs)) => ((cwcel @ XX @ XE) => ((ccfv @ XX @ XW) = (ccin @ (ccrn @ (ccfv @ XX @ cc2nd)) @ XV)))))))))))).
