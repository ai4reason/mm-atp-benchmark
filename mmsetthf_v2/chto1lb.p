...
thf(ao1mul_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ cco1) & (cwcel @ XG @ cco1)) => (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ cco1))))).
thf(cchto1lb_conj,conjecture,(cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc2 @ ccpnf @ ccico)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ cccht) @ ccdiv))) @ cco1)).
