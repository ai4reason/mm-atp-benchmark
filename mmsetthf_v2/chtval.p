...
thf(adf_cht_ax,axiom,(cccht = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccsu @ (ccin @ (cco @ ccc0 @ (ccv @ Xx3) @ ccicc) @ ccprime) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xp) @ cclog))))))).
...
thf(cchtval_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ XA2 @ cccht) = (ccsu @ (ccin @ (cco @ ccc0 @ XA2 @ ccicc) @ ccprime) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xp) @ cclog))))))).
