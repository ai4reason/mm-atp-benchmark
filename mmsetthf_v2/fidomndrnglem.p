...
thf(cfidomndrnglem_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pa:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((XB2 = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : ((Xc_0 @ Xx3) = (ccfv @ XR @ cc0g))) => ((! [Xx3:$i] : ((Xc_1 @ Xx3) = (ccfv @ XR @ ccur))) => ((! [Xx3:$i] : ((Xc_pa @ Xx3) = (ccfv @ XR @ ccdsr))) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XR @ ccdomn))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XB2 @ ccfn))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ (ccdif @ XB2 @ (ccsn @ (Xc_0 @ Xx3)))))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ Xc_x))))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwbr @ XA2 @ (Xc_1 @ Xx3) @ (Xc_pa @ Xx3))))))))))))))))))))))).
