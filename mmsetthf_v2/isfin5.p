...
thf(adf_fin5_ax,axiom,(ccfin5 = (ccab @ (^ [Xx3:$i] : (((ccv @ Xx3) = cc0) | (cwbr @ (ccv @ Xx3) @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ cccda) @ ccsdm)))))).
...
thf(cisfin5_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfin5) <=> ((XA2 = cc0) | (cwbr @ XA2 @ (cco @ XA2 @ XA2 @ cccda) @ ccsdm))))).
