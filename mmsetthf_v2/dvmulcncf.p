...
thf(advmulf_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwf @ XX @ ccc @ XF)) => ((Xph => (cwf @ XX @ ccc @ XG)) => ((Xph => ((ccdm @ (cco @ XS @ XF @ ccdv)) = XX)) => ((Xph => ((ccdm @ (cco @ XS @ XG @ ccdv)) = XX)) => (Xph => ((cco @ XS @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccdv) = (cco @ (cco @ (cco @ XS @ XF @ ccdv) @ XG @ (ccof @ ccmul)) @ (cco @ (cco @ XS @ XG @ ccdv) @ XF @ (ccof @ ccmul)) @ (ccof @ ccaddc))))))))))))))).
...
thf(aaddcncff_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ XX @ ccc @ cccncf))) => ((Xph => (cwcel @ XG @ (cco @ XX @ ccc @ cccncf))) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ (cco @ XX @ ccc @ cccncf)))))))))).
thf(amulcncff_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ XX @ ccc @ cccncf))) => ((Xph => (cwcel @ XG @ (cco @ XX @ ccc @ cccncf))) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ (cco @ XX @ ccc @ cccncf)))))))))).
