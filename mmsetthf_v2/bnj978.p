...
thf(cbnj978_conj,conjecture,(! [Xth:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (! [Xz:$i] : ((Xth @ Xy1 @ Xz) <=> (cw_bnj17 @ (cw_bnj15 @ XA2 @ XR) @ (cwcel @ XX @ XA2) @ (cwcel @ (ccv @ Xy1) @ (cc_bnj18 @ XA2 @ XR @ XX)) @ (cwcel @ (ccv @ Xz) @ (cc_bnj14 @ XA2 @ XR @ (ccv @ Xy1))))))) => ((! [Xy1:$i] : (! [Xz:$i] : ((Xth @ Xy1 @ Xz) => (cwcel @ (ccv @ Xz) @ (cc_bnj18 @ XA2 @ XR @ XX))))) => (((cw_bnj15 @ XA2 @ XR) & (cwcel @ XX @ XA2)) => (cw_bnj19 @ XA2 @ (cc_bnj18 @ XA2 @ XR @ XX) @ XR))))))))).
