...
thf(adihvalc_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [Xc_po:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [Xc_an:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((! [Xu:$i] : (! [Xq:$i] : ((XB2 @ Xu @ Xq) = (ccfv @ XK @ ccbs)))) => ((! [Xu:$i] : (! [Xq:$i] : ((Xc_le @ Xu @ Xq) = (ccfv @ XK @ ccple)))) => ((! [Xu:$i] : (! [Xq:$i] : ((Xc_or @ Xu @ Xq) = (ccfv @ XK @ ccjn)))) => ((! [Xu:$i] : (! [Xq:$i] : ((Xc_an @ Xu @ Xq) = (ccfv @ XK @ ccmee)))) => ((! [Xu:$i] : ((XA2 @ Xu) = (ccfv @ XK @ ccatm))) => ((! [Xu:$i] : (! [Xq:$i] : ((XH @ Xu @ Xq) = (ccfv @ XK @ cclh)))) => ((! [Xu:$i] : (! [Xq:$i] : ((XI @ Xu @ Xq) = (ccfv @ XW @ (ccfv @ XK @ ccdih))))) => ((! [Xu:$i] : (! [Xq:$i] : ((XD @ Xu @ Xq) = (ccfv @ XW @ (ccfv @ XK @ ccdib))))) => ((! [Xu:$i] : (! [Xq:$i] : ((XC @ Xu @ Xq) = (ccfv @ XW @ (ccfv @ XK @ ccdic))))) => ((! [Xu:$i] : (! [Xq:$i] : ((XU @ Xu @ Xq) = (ccfv @ XW @ (ccfv @ XK @ ccdvh))))) => ((! [Xu:$i] : (! [Xq:$i] : ((XS @ Xq) = (ccfv @ (XU @ Xu @ Xq) @ cclss)))) => ((! [Xu:$i] : (! [Xq:$i] : ((Xc_po @ Xu @ Xq) = (ccfv @ (XU @ Xu @ Xq) @ cclsm)))) => (! [Xu:$i] : (! [Xq:$i] : ((((cwcel @ XK @ (XV @ Xu @ Xq)) & (cwcel @ XW @ (XH @ Xu @ Xq))) & ((cwcel @ XX @ (XB2 @ Xu @ Xq)) & (~ (cwbr @ XX @ XW @ (Xc_le @ Xu @ Xq))))) => ((ccfv @ XX @ (XI @ Xu @ Xq)) = (ccrio @ (^ [Xu:$i] : (cwral @ (^ [Xq:$i] : (((~ (cwbr @ (ccv @ Xq) @ XW @ (Xc_le @ Xu @ Xq))) & ((cco @ (ccv @ Xq) @ (cco @ XX @ XW @ (Xc_an @ Xu @ Xq)) @ (Xc_or @ Xu @ Xq)) = XX)) => ((ccv @ Xu) = (cco @ (ccfv @ (ccv @ Xq) @ (XC @ Xu @ Xq)) @ (ccfv @ (cco @ XX @ XW @ (Xc_an @ Xu @ Xq)) @ (XD @ Xu @ Xq)) @ (Xc_po @ Xu @ Xq))))) @ (^ [Xq:$i] : (XA2 @ Xu)))) @ (^ [Xu:$i] : (XS @ Xq)))))))))))))))))))))))))))))))))))).
...
thf(adihjust_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdib))) => ((XJ = (ccfv @ XW @ (ccfv @ XK @ ccdic))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((Xc_po = (ccfv @ XU @ cclsm)) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ (cw3a @ ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le))) @ ((cwcel @ XR @ XA2) & (~ (cwbr @ XR @ XW @ Xc_le))) @ (cwcel @ XX @ XB2)) @ ((cco @ XQ @ (cco @ XX @ XW @ Xc_an) @ Xc_or) = (cco @ XR @ (cco @ XX @ XW @ Xc_an) @ Xc_or))) => ((cco @ (ccfv @ XQ @ XJ) @ (ccfv @ (cco @ XX @ XW @ Xc_an) @ XI) @ Xc_po) = (cco @ (ccfv @ XR @ XJ) @ (ccfv @ (cco @ XX @ XW @ Xc_an) @ XI) @ Xc_po))))))))))))))))))))))))))))).
...
thf(areusv3_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccv @ Xz)) => ((Xph @ Xy1) <=> (Xps @ Xz))))) => ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccv @ Xz)) => ((XC @ Xy1) = (XD @ Xz))))) => ((cwrex @ (^ [Xy1:$i] : ((Xph @ Xy1) & (cwcel @ (XC @ Xy1) @ XA2))) @ (^ [Xy1:$i] : XB2)) => ((cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (((Xph @ Xy1) & (Xps @ Xz)) => ((XC @ Xy1) = (XD @ Xz)))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2)) <=> (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((Xph @ Xy1) => ((ccv @ Xx3) = (XC @ Xy1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))))))))).
...
thf(cdihlsscpre_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((XD = (ccfv @ XW @ (ccfv @ XK @ ccdib))) => ((XC = (ccfv @ XW @ (ccfv @ XK @ ccdic))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XS = (ccfv @ XU @ cclss)) => ((Xc_po = (ccfv @ XU @ cclsm)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XX @ XB2) & (~ (cwbr @ XX @ XW @ Xc_le)))) => (cwcel @ (ccfv @ XX @ XI) @ XS)))))))))))))))))))))))))))))).
