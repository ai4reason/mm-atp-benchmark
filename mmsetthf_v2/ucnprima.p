...
thf(aucnima_ax,axiom,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((Xph => (cwcel @ XU @ (ccfv @ XX @ ccust))) => ((! [Xy1:$i] : (Xph => (cwcel @ (XV @ Xy1) @ (ccfv @ (XY @ Xy1) @ ccust)))) => ((! [Xy1:$i] : (Xph => (cwcel @ XF @ (cco @ XU @ (XV @ Xy1) @ ccucn)))) => ((! [Xy1:$i] : (Xph => (cwcel @ XW @ (XV @ Xy1)))) => ((! [Xr:$i] : ((XG @ Xr) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF))))))) => (Xph => (cwrex @ (^ [Xr:$i] : (cwss @ (ccima @ (XG @ Xr) @ (ccv @ Xr)) @ XW)) @ (^ [Xr:$i] : XU))))))))))))))))).
