...
thf(afriendshipgt3_ax,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cw3a @ (cwcel @ XG @ ccfrgr) @ (cwcel @ XV @ ccfn) @ (cwbr @ cc3 @ (ccfv @ XV @ cchash) @ cclt)) => (cwrex @ (^ [Xv:$i] : (cwral @ (^ [Xw:$i] : (cwcel @ (ccpr @ (ccv @ Xv) @ (ccv @ Xw)) @ (ccfv @ XG @ ccedg))) @ (^ [Xw:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV))))))).
...
thf(ahash1to3_ax,axiom,(! [XV:($i > $o)] : ((cw3a @ (cwcel @ XV @ ccfn) @ (cwbr @ cc1 @ (ccfv @ XV @ cchash) @ ccle) @ (cwbr @ (ccfv @ XV @ cchash) @ cc3 @ ccle)) => (? [Xa:$i] : (? [Xb:$i] : (? [Xc:$i] : (cw3o @ (XV = (ccsn @ (ccv @ Xa))) @ (XV = (ccpr @ (ccv @ Xa) @ (ccv @ Xb))) @ (XV = (cctp @ (ccv @ Xa) @ (ccv @ Xb) @ (ccv @ Xc)))))))))).
...
thf(a_1to3vfriendship_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xv:$i] : (XV = (ccfv @ (XG @ Xv) @ ccvtx))) => ((! [Xv:$i] : (XE = (ccfv @ (XG @ Xv) @ ccedg))) => (! [Xv:$i] : (((cwcel @ XA2 @ (XX @ Xv)) & (cw3o @ (XV = (ccsn @ XA2)) @ (XV = (ccpr @ XA2 @ XB2)) @ (XV = (cctp @ XA2 @ XB2 @ XC)))) => ((cwcel @ (XG @ Xv) @ ccfrgr) => (cwrex @ (^ [Xv:$i] : (cwral @ (^ [Xw:$i] : (cwcel @ (ccpr @ (ccv @ Xv) @ (ccv @ Xw)) @ XE)) @ (^ [Xw:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV))))))))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(cfriendship_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cw3a @ (cwcel @ XG @ ccfrgr) @ (cwne @ XV @ cc0) @ (cwcel @ XV @ ccfn)) => (cwrex @ (^ [Xv:$i] : (cwral @ (^ [Xw:$i] : (cwcel @ (ccpr @ (ccv @ Xv) @ (ccv @ Xw)) @ (ccfv @ XG @ ccedg))) @ (^ [Xw:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV))))))).
