...
thf(asmcnlem_ax,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : ((XC = (ccfv @ XU @ ccims)) => ((XJ = (ccfv @ XC @ ccmopn)) => ((XS = (ccfv @ XU @ ccns)) => ((XK = (ccfv @ cccnfld @ cctopn)) => ((XX = (ccfv @ XU @ ccba)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xr:$i] : ((XN @ Xx3 @ Xy1 @ Xr) = (ccfv @ XU @ ccnmcv))))) => ((cwcel @ XU @ ccnv) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xr:$i] : ((XT @ Xx3 @ Xy1 @ Xr) = (cco @ cc1 @ (cco @ cc1 @ (cco @ (cco @ (cco @ (ccfv @ (ccv @ Xy1) @ (XN @ Xx3 @ Xy1 @ Xr)) @ (ccfv @ (ccv @ Xx3) @ ccabs) @ ccaddc) @ cc1 @ ccaddc) @ (ccv @ Xr) @ ccdiv) @ ccaddc) @ ccdiv))))) => (cwcel @ XS @ (cco @ (cco @ XK @ XJ @ cctx) @ XJ @ cccn))))))))))))))))))).
