...
thf(aelsingles_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccsingles) <=> (? [Xx3:$i] : (XA2 = (ccsn @ (ccv @ Xx3))))))).
thf(cdfsingles2_conj,conjecture,(ccsingles = (ccab @ (^ [Xx3:$i] : (? [Xy1:$i] : ((ccv @ Xx3) = (ccsn @ (ccv @ Xy1)))))))).
