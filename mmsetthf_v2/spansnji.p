...
thf(ashjshsi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => ((cco @ XA2 @ XB2 @ cchj) = (ccfv @ (ccfv @ (cco @ XA2 @ XB2 @ ccph) @ ccort) @ ccort))))))).
...
thf(aspansnpji_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => (cwss @ XA2 @ (ccfv @ (ccfv @ (ccsn @ (ccfv @ XB2 @ (ccfv @ (ccfv @ XA2 @ ccort) @ ccpjh))) @ ccspn) @ ccort))))))).
...
thf(aspanunsni_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ cchil) => ((ccfv @ (ccun @ XA2 @ (ccsn @ XB2)) @ ccspn) = (ccfv @ (ccun @ XA2 @ (ccsn @ (ccfv @ XB2 @ (ccfv @ (ccfv @ XA2 @ ccort) @ ccpjh)))) @ ccspn))))))).
thf(achjcli_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwcel @ (cco @ XA2 @ XB2 @ cchj) @ ccch)))))).
thf(cspansnji_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ cchil) => ((cco @ XA2 @ (ccfv @ (ccsn @ XB2) @ ccspn) @ ccph) = (cco @ XA2 @ (ccfv @ (ccsn @ XB2) @ ccspn) @ cchj))))))).
