...
thf(acnfval_ax,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((cco @ XJ @ XK @ cccn) = (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccv @ Xy1)) @ XJ)) @ (^ [Xy1:$i] : XK))) @ (^ [Xf1:$i] : (cco @ XY @ XX @ ccmap)))))))))).
...
thf(amapvalg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [Xf1:$i] : (((cwcel @ XA2 @ (XC @ Xf1)) & (cwcel @ XB2 @ (XD @ Xf1))) => ((cco @ XA2 @ XB2 @ ccmap) = (ccab @ (^ [Xf1:$i] : (cwf @ XB2 @ XA2 @ (ccv @ Xf1)))))))))))).
...
thf(ccnfex_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XJ @ cctop) & (cwcel @ XK @ cctop)) => (cwcel @ (cco @ XJ @ XK @ cccn) @ ccvv))))).
