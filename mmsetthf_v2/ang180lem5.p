...
thf(aang180lem4_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccdiv) @ cclog) @ ccim))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwne @ XA2 @ cc1)) => (cwcel @ (cco @ (cco @ (cco @ (cco @ cc1 @ XA2 @ ccmin) @ cc1 @ (XF @ Xx3 @ Xy1)) @ (cco @ XA2 @ (cco @ XA2 @ cc1 @ ccmin) @ (XF @ Xx3 @ Xy1)) @ ccaddc) @ (cco @ cc1 @ XA2 @ (XF @ Xx3 @ Xy1)) @ ccaddc) @ (ccpr @ (ccneg @ ccpi) @ ccpi))))))))).
thf(cang180lem5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccdif @ ccc @ (ccsn @ ccc0)))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccdiv) @ cclog) @ ccim))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ ((cwcel @ XA2 @ ccc) & (cwne @ XA2 @ ccc0)) @ ((cwcel @ XB2 @ ccc) & (cwne @ XB2 @ ccc0)) @ (cwne @ XA2 @ XB2)) => (cwcel @ (cco @ (cco @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ XA2 @ (XF @ Xx3 @ Xy1)) @ (cco @ XB2 @ (cco @ XB2 @ XA2 @ ccmin) @ (XF @ Xx3 @ Xy1)) @ ccaddc) @ (cco @ XA2 @ XB2 @ (XF @ Xx3 @ Xy1)) @ ccaddc) @ (ccpr @ (ccneg @ ccpi) @ ccpi)))))))))).
