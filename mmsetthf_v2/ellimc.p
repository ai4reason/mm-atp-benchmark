...
thf(alimcfval_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : ((! [Xz:$i] : ((XJ @ Xz) = (cco @ XK @ (ccun @ XA2 @ (ccsn @ XB2)) @ ccrest))) => ((XK = (ccfv @ cccnfld @ cctopn)) => (! [Xz:$i] : ((cw3a @ (cwf @ XA2 @ ccc @ XF) @ (cwss @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) => (((cco @ XF @ XB2 @ cclimc) = (ccab @ (^ [Xy1:$i] : (cwcel @ (ccmpt @ (^ [Xz:$i] : (ccun @ XA2 @ (ccsn @ XB2))) @ (^ [Xz:$i] : (ccif @ ((ccv @ Xz) = XB2) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xz) @ XF)))) @ (ccfv @ XB2 @ (cco @ (XJ @ Xz) @ XK @ cccnp)))))) & (cwss @ (cco @ XF @ XB2 @ cclimc) @ ccc)))))))))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(cctopon_tp,type,(cctopon : ($i > $o))).
thf(cwral_tp,type,(cwral : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(alimcvallem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : ((! [Xz:$i] : ((XJ @ Xz) = (cco @ XK @ (ccun @ XA2 @ (ccsn @ XB2)) @ ccrest))) => ((XK = (ccfv @ cccnfld @ cctopn)) => ((! [Xz:$i] : ((XG @ Xz) = (ccmpt @ (^ [Xz:$i] : (ccun @ XA2 @ (ccsn @ XB2))) @ (^ [Xz:$i] : (ccif @ ((ccv @ Xz) = XB2) @ XC @ (ccfv @ (ccv @ Xz) @ XF)))))) => (! [Xz:$i] : ((cw3a @ (cwf @ XA2 @ ccc @ XF) @ (cwss @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) => ((cwcel @ (XG @ Xz) @ (ccfv @ XB2 @ (cco @ (XJ @ Xz) @ XK @ cccnp))) => (cwcel @ XC @ ccc))))))))))))))).
