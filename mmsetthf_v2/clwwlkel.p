...
thf(accatws1n0_ax,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XW @ (ccword @ XV)) => (cwne @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ cc0)))))).
...
thf(aelfzo0z_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ XB2 @ ccfzo)) <=> (cw3a @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccz) @ (cwbr @ XA2 @ XB2 @ cclt)))))).
