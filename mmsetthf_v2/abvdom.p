...
thf(cabvdom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (ccfv @ XR @ ccabv)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((cw3a @ (cwcel @ XF @ XA2) @ ((cwcel @ XX @ XB2) & (cwne @ XX @ Xc_0)) @ ((cwcel @ XY @ XB2) & (cwne @ XY @ Xc_0))) => (cwne @ (cco @ XX @ XY @ Xc_x) @ Xc_0))))))))))))))).
