...
thf(cwrdred1hash_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ (ccword @ XS)) & (cwbr @ cc1 @ (ccfv @ XF @ cchash) @ ccle)) => ((ccfv @ (ccres @ XF @ (cco @ ccc0 @ (cco @ (ccfv @ XF @ cchash) @ cc1 @ ccmin) @ ccfzo)) @ cchash) = (cco @ (ccfv @ XF @ cchash) @ cc1 @ ccmin)))))).
