...
thf(aretopconn_ax,axiom,(cwcel @ (ccfv @ (ccrn @ ccioo) @ cctg) @ ccconn)).
...
thf(aopnmbllem0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ (ccrn @ ccioo) @ cctg)) => ((ccuni @ (ccima @ ccicc @ (ccrab @ (^ [Xz:$i] : (cwss @ (ccfv @ (ccv @ Xz) @ ccicc) @ XA2)) @ (^ [Xz:$i] : (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccv @ Xy1) @ ccexp) @ ccdiv)))))))))) = XA2)))).
...
thf(aqexpcl_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccq) & (cwcel @ XN @ ccn0)) => (cwcel @ (cco @ XA2 @ XN @ ccexp) @ ccq))))).
