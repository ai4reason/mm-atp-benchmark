...
thf(ainfxrlbrnmpt2_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccxr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XC @ XA2))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XD @ ccxr))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XC) => ((XB2 @ Xx3) = XD))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwbr @ (ccinf @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ ccxr @ cclt) @ XD @ ccle)))))))))))))).
...
thf(climsuplesup_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XF @ XV)) => ((Xph => (cwcel @ XK @ ccr)) => (Xph => (cwbr @ (ccfv @ XF @ cclsp) @ (ccsup @ (ccin @ (ccima @ XF @ (cco @ XK @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt) @ ccle))))))))).
