...
thf(asconntop_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ ccsconn) => (cwcel @ XJ @ cctop)))).
thf(asimpl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xph)))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(ccqs_tp,type,(ccqs : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aelpi1_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (cco @ XJ @ XY @ ccpi1)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XY @ XX)) => (Xph => ((cwcel @ XF @ XB2) <=> (cwrex @ (^ [Xf1:$i] : ((((ccfv @ ccc0 @ (ccv @ Xf1)) = XY) & ((ccfv @ cc1 @ (ccv @ Xf1)) = XY)) & (XF = (ccec @ (ccv @ Xf1) @ (ccfv @ XJ @ ccphtpc))))) @ (^ [Xf1:$i] : (cco @ ccii @ XJ @ cccn))))))))))))))))).
...
thf(asconnpht_ax,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : ((cw3a @ (cwcel @ XJ @ ccsconn) @ (cwcel @ XF @ (cco @ ccii @ XJ @ cccn)) @ ((ccfv @ ccc0 @ XF) = (ccfv @ cc1 @ XF))) => (cwbr @ XF @ (ccxp @ (cco @ ccc0 @ cc1 @ ccicc) @ (ccsn @ (ccfv @ ccc0 @ XF))) @ (ccfv @ XJ @ ccphtpc)))))).
...
thf(api1id_ax,axiom,(! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XG = (cco @ XJ @ XY @ ccpi1)) => ((Xc_0 = (ccxp @ (cco @ ccc0 @ cc1 @ ccicc) @ (ccsn @ XY))) => (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XY @ XX)) => ((ccec @ Xc_0 @ (ccfv @ XJ @ ccphtpc)) = (ccfv @ XG @ cc0g))))))))))).
...
thf(api1grp_ax,axiom,(! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (cco @ XJ @ XY @ ccpi1)) => (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XY @ XX)) => (cwcel @ XG @ ccgrp)))))))).
...
thf(aensn1_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwbr @ (ccsn @ XA2) @ cc1o @ ccen)))).
...
thf(apconnpi1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XP = (cco @ XJ @ XA2 @ ccpi1)) => ((XQ = (cco @ XJ @ XB2 @ ccpi1)) => ((XS = (ccfv @ XP @ ccbs)) => ((XT = (ccfv @ XQ @ ccbs)) => ((cw3a @ (cwcel @ XJ @ ccpconn) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) => (cwbr @ XP @ XQ @ ccgic)))))))))))))))).
thf(agicen_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XC = (ccfv @ XS @ ccbs)) => ((cwbr @ XR @ XS @ ccgic) => (cwbr @ XB2 @ XC @ ccen))))))))).
...
thf(aissconn_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ ccsconn) <=> ((cwcel @ XJ @ ccpconn) & (cwral @ (^ [Xf1:$i] : (((ccfv @ ccc0 @ (ccv @ Xf1)) = (ccfv @ cc1 @ (ccv @ Xf1))) => (cwbr @ (ccv @ Xf1) @ (ccxp @ (cco @ ccc0 @ cc1 @ ccicc) @ (ccsn @ (ccfv @ ccc0 @ (ccv @ Xf1)))) @ (ccfv @ XJ @ ccphtpc)))) @ (^ [Xf1:$i] : (cco @ ccii @ XJ @ cccn))))))).
thf(csconnpi1_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ ccpconn) & (cwcel @ XY @ XX)) => ((cwcel @ XJ @ ccsconn) <=> (cwbr @ (ccfv @ (cco @ XJ @ XY @ ccpi1) @ ccbs) @ cc1o @ ccen)))))))).
