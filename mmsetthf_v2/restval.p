...
thf(crestval_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XJ @ (XV @ Xx3)) & (cwcel @ XA2 @ (XW @ Xx3))) => ((cco @ XJ @ XA2 @ ccrest) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : XJ) @ (^ [Xx3:$i] : (ccin @ (ccv @ Xx3) @ XA2)))))))))))).
