...
thf(cewlkinedg_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => (((cwcel @ XF @ (cco @ XG @ XS @ ccewlks)) & (cwcel @ XK @ (cco @ cc1 @ (ccfv @ XF @ cchash) @ ccfzo))) => (cwbr @ XS @ (ccfv @ (ccin @ (ccfv @ (ccfv @ (cco @ XK @ cc1 @ ccmin) @ XF) @ XI) @ (ccfv @ (ccfv @ XK @ XF) @ XI)) @ cchash) @ ccle))))))))).
