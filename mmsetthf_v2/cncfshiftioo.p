...
thf(ccncfshiftioo_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((! [Xx3:$i] : ((XC @ Xx3) = (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => (cwcel @ XT @ ccr)) => ((XD = (cco @ (cco @ XA2 @ XT @ ccaddc) @ (cco @ XB2 @ XT @ ccaddc) @ ccioo)) => ((! [Xx3:$i] : (Xph => (cwcel @ XF @ (cco @ (XC @ Xx3) @ ccc @ cccncf)))) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ XT @ ccmin) @ XF))))) => (! [Xx3:$i] : (Xph => (cwcel @ (XG @ Xx3) @ (cco @ XD @ ccc @ cccncf)))))))))))))))))))).
