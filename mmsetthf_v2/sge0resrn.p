...
thf(asge0resrnlem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((Xph => (cwf @ XA2 @ XB2 @ XG)) => ((Xph => (cwcel @ XX @ (ccpw @ XA2))) => ((Xph => (cwf1o @ XX @ (ccrn @ XG) @ (ccres @ XG @ XX))) => (Xph => (cwbr @ (ccfv @ (ccres @ XF @ (ccrn @ XG)) @ ccsumge0) @ (ccfv @ (cccom @ XF @ XG) @ ccsumge0) @ ccle))))))))))))))).
