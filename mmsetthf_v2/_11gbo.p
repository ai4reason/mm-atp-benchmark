...
thf(aepoo_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cceven) & (cwcel @ XB2 @ ccodd)) => (cwcel @ (cco @ XA2 @ XB2 @ ccaddc) @ ccodd))))).
...
thf(agbpart11_ax,axiom,((ccdc @ cc1 @ cc1) = (cco @ (cco @ cc3 @ cc3 @ ccaddc) @ cc5 @ ccaddc))).
...
thf(c_11gbo_conj,conjecture,(cwcel @ (ccdc @ cc1 @ cc1) @ ccgbo)).
