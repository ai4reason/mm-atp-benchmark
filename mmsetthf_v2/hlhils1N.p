...
thf(chlhils1N_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XL = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XS = (ccfv @ XL @ ccsca)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ cchlh))) => ((XR = (ccfv @ XU @ ccsca)) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xc_1 = (ccfv @ XS @ ccur)) => (Xph => (Xc_1 = (ccfv @ XR @ ccur)))))))))))))))))))).
