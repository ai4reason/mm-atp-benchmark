...
thf(adf_srng_ax,axiom,(ccsr = (ccab @ (^ [Xf1:$i] : (cwsbc @ (^ [Xi:$i] : ((cwcel @ (ccv @ Xi) @ (cco @ (ccv @ Xf1) @ (ccfv @ (ccv @ Xf1) @ ccoppr) @ ccrh)) & ((ccv @ Xi) = (cccnv @ (ccv @ Xi))))) @ (ccfv @ (ccv @ Xf1) @ ccstf)))))).
...
thf(cissrng_conj,conjecture,(! [XR:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XR @ ccoppr)) => ((Xc_as = (ccfv @ XR @ ccstf)) => ((cwcel @ XR @ ccsr) <=> ((cwcel @ Xc_as @ (cco @ XR @ XO @ ccrh)) & (Xc_as = (cccnv @ Xc_as)))))))))).
