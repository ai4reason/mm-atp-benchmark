...
thf(cpsgnco_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XS = (ccfv @ XD @ ccsymg)) => ((XN = (ccfv @ XD @ ccpsgn)) => ((XP = (ccfv @ XS @ ccbs)) => ((cw3a @ (cwcel @ XD @ ccfn) @ (cwcel @ XF @ XP) @ (cwcel @ XG @ XP)) => ((ccfv @ (cccom @ XF @ XG) @ XN) = (cco @ (ccfv @ XF @ XN) @ (ccfv @ XG @ XN) @ ccmul))))))))))))).
