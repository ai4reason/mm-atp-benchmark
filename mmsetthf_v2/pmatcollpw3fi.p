...
thf(apmatcollpwfi_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [Xc_ex:($i > ($i > $o))] : (! [Xc_as:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xs1:$i] : ((XP @ Xs1) = (ccfv @ XR @ ccpl1))) => ((! [Xs1:$i] : ((XC @ Xs1) = (cco @ XN @ (XP @ Xs1) @ ccmat))) => ((! [Xs1:$i] : (XB2 = (ccfv @ (XC @ Xs1) @ ccbs))) => ((! [Xn:$i] : (! [Xs1:$i] : ((Xc_as @ Xn @ Xs1) = (ccfv @ (XC @ Xs1) @ ccvsca)))) => ((! [Xs1:$i] : ((Xc_ex @ Xs1) = (ccfv @ (ccfv @ (XP @ Xs1) @ ccmgp) @ ccmg))) => ((! [Xs1:$i] : ((XX @ Xs1) = (ccfv @ XR @ ccv1))) => ((! [Xn:$i] : (! [Xs1:$i] : ((XT @ Xn @ Xs1) = (cco @ XN @ XR @ ccmat2pmat)))) => ((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ cccrg) @ (cwcel @ XM @ XB2)) => (cwrex @ (^ [Xs1:$i] : (XM = (cco @ (XC @ Xs1) @ (ccmpt @ (^ [Xn:$i] : (cco @ ccc0 @ (ccv @ Xs1) @ ccfz)) @ (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xn) @ (XX @ Xs1) @ (Xc_ex @ Xs1)) @ (ccfv @ (cco @ XM @ (ccv @ Xn) @ ccdecpmat) @ (XT @ Xn @ Xs1)) @ (Xc_as @ Xn @ Xs1)))) @ ccgsu))) @ (^ [Xs1:$i] : ccn0))))))))))))))))))))).
