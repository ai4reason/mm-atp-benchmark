...
thf(ccntzval_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccfv @ XM @ ccbs))) => ((Xc_pl = (ccfv @ XM @ ccplusg)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XZ @ Xx3 @ Xy1) = (ccfv @ XM @ cccntz)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwss @ XS @ (XB2 @ Xy1)) => ((ccfv @ XS @ (XZ @ Xx3 @ Xy1)) = (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) = (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ Xc_pl))) @ (^ [Xy1:$i] : XS))) @ (^ [Xx3:$i] : (XB2 @ Xy1)))))))))))))))).
