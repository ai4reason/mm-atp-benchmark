...
thf(aatsseq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccat) & (cwcel @ XB2 @ ccat)) => ((cwss @ XA2 @ XB2) <=> (XA2 = XB2)))))).
...
thf(catnemeq0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccat) & (cwcel @ XB2 @ ccat)) => ((cwne @ XA2 @ XB2) <=> ((ccin @ XA2 @ XB2) = cc0h)))))).
