...
thf(cdfrngc2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((XC = (ccfv @ XU @ ccrngc)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (XB2 = (ccin @ XU @ ccrng))) => ((Xph => (XH = (ccres @ ccrngh @ (ccxp @ XB2 @ XB2)))) => ((Xph => (Xc_x = (ccfv @ (ccfv @ XU @ ccestrc) @ ccco))) => (Xph => (XC = (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ cchom) @ XH) @ (ccop @ (ccfv @ ccnx @ ccco) @ Xc_x))))))))))))))))).
