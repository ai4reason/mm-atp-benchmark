...
thf(anbuhgr2vtx1edgblem_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [Xa:$i] : (! [Xb:$i] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((cw3a @ (cwcel @ XG @ ccuhgr) @ (XV = (ccpr @ (ccv @ Xa) @ (ccv @ Xb))) @ (cwcel @ (ccv @ Xa) @ (cco @ XG @ (ccv @ Xb) @ ccnbgr))) => (cwcel @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)) @ XE)))))))))).
