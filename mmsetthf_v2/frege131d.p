...
thf(cfrege131d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XF @ ccvv)) => ((Xph => (XA2 = (ccun @ XU @ (ccun @ (ccima @ (cccnv @ (ccfv @ XF @ cctcl)) @ XU) @ (ccima @ (ccfv @ XF @ cctcl) @ XU))))) => ((Xph => (cwfun @ XF)) => (Xph => (cwss @ (ccima @ XF @ XA2) @ XA2)))))))))).
