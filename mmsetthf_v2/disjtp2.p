...
thf(cdisjtp2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cw3a @ (cwne @ XA2 @ XD) @ (cwne @ XB2 @ XD) @ (cwne @ XC @ XD)) @ (cw3a @ (cwne @ XA2 @ XE) @ (cwne @ XB2 @ XE) @ (cwne @ XC @ XE)) @ (cw3a @ (cwne @ XA2 @ XF) @ (cwne @ XB2 @ XF) @ (cwne @ XC @ XF))) => ((ccin @ (cctp @ XA2 @ XB2 @ XC) @ (cctp @ XD @ XE @ XF)) = cc0))))))))).
