...
thf(csigaclfu2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) & (cwral @ (^ [Xk:$i] : (cwcel @ (XA2 @ Xk) @ XS)) @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfzo)))) => (cwcel @ (cciun @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfzo)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ XS)))))).
