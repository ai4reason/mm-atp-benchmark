...
thf(asca2rab_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XA2 @ ccr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XC @ ccrp))) => ((! [Xx3:$i] : ((Xph @ Xx3) => ((XB2 @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ XC @ (ccv @ Xx3) @ ccmul) @ XA2)) @ (^ [Xx3:$i] : ccr))))) => (! [Xx3:$i] : ((Xph @ Xx3) => (XA2 = (ccrab @ (^ [Xy1:$i] : (cwcel @ (cco @ (cco @ cc1 @ XC @ ccdiv) @ (ccv @ Xy1) @ ccmul) @ (XB2 @ Xx3))) @ (^ [Xy1:$i] : ccr))))))))))))).
