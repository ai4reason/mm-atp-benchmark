...
thf(cblres_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XC = (ccres @ XD @ (ccxp @ XY @ XY))) => ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ (ccin @ XX @ XY)) @ (cwcel @ XR @ ccxr)) => ((cco @ XP @ XR @ (ccfv @ XC @ ccbl)) = (ccin @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ XY))))))))))).
