...
thf(asblpnf_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((XD = (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XS @ XS))) => ((Xph & (cwcel @ XP @ XS)) => ((cco @ XP @ ccpnf @ (ccfv @ XD @ ccbl)) = XS))))))))).
...
thf(advsconst_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XS @ (ccpr @ ccr @ ccc)) & (cwcel @ XA2 @ ccc)) => ((cco @ XS @ (ccxp @ XS @ (ccsn @ XA2)) @ ccdv) = (ccxp @ XS @ (ccsn @ ccc0))))))).
