...
thf(crexraleqim_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xth:($i > $o)] : (! [XA2:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccv @ Xz)) => ((Xps @ Xx3) <=> (Xph @ Xz))))) => ((! [Xx3:$i] : (! [Xz:$i] : (((ccv @ Xz) = XY) => ((Xph @ Xz) <=> (Xth @ Xx3))))) => (! [Xx3:$i] : (((cwrex @ (^ [Xz:$i] : (Xph @ Xz)) @ (^ [Xz:$i] : XA2)) & (cwral @ (^ [Xx3:$i] : ((Xps @ Xx3) => ((ccv @ Xx3) = XY))) @ (^ [Xx3:$i] : XA2))) => (Xth @ Xx3))))))))))).
