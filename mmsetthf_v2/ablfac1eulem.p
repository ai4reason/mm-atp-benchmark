...
thf(adifindir_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccdif @ (ccin @ XA2 @ XB2) @ XC) = (ccin @ (ccdif @ XA2 @ XC) @ (ccdif @ XB2 @ XC))))))).
...
thf(adprddisj2_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xph => (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((Xph => ((ccdm @ XS) = XI)) => ((Xph => (cwss @ XC @ XI)) => ((Xph => (cwss @ XD @ XI)) => ((Xph => ((ccin @ XC @ XD) = cc0)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (Xph => ((ccin @ (cco @ XG @ (ccres @ XS @ XC) @ ccdprd) @ (cco @ XG @ (ccres @ XS @ XD) @ ccdprd)) = (ccsn @ Xc_0))))))))))))))))).
...
thf(aprmdvdsexpr_ax,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XQ @ ccprime) @ (cwcel @ XN @ ccn0)) => ((cwbr @ XP @ (cco @ XQ @ XN @ ccexp) @ ccdvds) => (XP = XQ))))))).
