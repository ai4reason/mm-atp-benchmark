...
thf(arnin_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (ccrn @ (ccin @ XA2 @ XB2)) @ (ccin @ (ccrn @ XA2) @ (ccrn @ XB2)))))).
...
thf(aresindir_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccres @ (ccin @ XA2 @ XB2) @ XC) = (ccin @ (ccres @ XA2 @ XC) @ (ccres @ XB2 @ XC))))))).
thf(aineq12i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((XA2 = XB2) => ((XC = XD) => ((ccin @ XA2 @ XC) = (ccin @ XB2 @ XD))))))))).
thf(cinimass_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwss @ (ccima @ (ccin @ XA2 @ XB2) @ XC) @ (ccin @ (ccima @ XA2 @ XC) @ (ccima @ XB2 @ XC))))))).
