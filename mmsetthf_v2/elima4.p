...
thf(asnnzb_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) <=> (cwne @ (ccsn @ XA2) @ cc0)))).
...
thf(celima4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XA2 @ (ccima @ XR @ XB2)) <=> (cwne @ (ccin @ XR @ (ccxp @ XB2 @ (ccsn @ XA2))) @ cc0)))))).
