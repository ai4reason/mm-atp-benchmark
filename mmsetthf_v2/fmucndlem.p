...
thf(cfmucndlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwfn @ XF @ XX) & (cwss @ XA2 @ XX)) => ((ccima @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF))))) @ (ccxp @ XA2 @ XA2)) = (ccxp @ (ccima @ XF @ XA2) @ (ccima @ XF @ XA2)))))))).
