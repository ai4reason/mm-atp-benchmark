...
thf(ctfrlem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ ccon0))) => ((! [Xx3:$i] : ((Xph @ Xx3) => ((cwfun @ XF) & (cwss @ XA2 @ (ccdm @ XF))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => ((cwfun @ XG) & (cwss @ XA2 @ (ccdm @ XG))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccres @ XF @ (ccv @ Xx3)) @ XB2))) @ (^ [Xx3:$i] : XA2)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XG) = (ccfv @ (ccres @ XG @ (ccv @ Xx3)) @ XB2))) @ (^ [Xx3:$i] : XA2)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xx3) @ XG))) @ (^ [Xx3:$i] : XA2))))))))))))))).
