...
thf(c_1mavmul_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (cco @ XR @ (ccop @ XN @ XN) @ ccmvmul)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XN @ ccfn)) => ((Xph => (cwcel @ XY @ (cco @ XB2 @ XN @ ccmap))) => (Xph => ((cco @ (ccfv @ XA2 @ ccur) @ XY @ Xc_x) = XY)))))))))))))))).
