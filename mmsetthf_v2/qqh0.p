...
thf(aqqhvval_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((XL = (ccfv @ XR @ cczrh)) => ((((cwcel @ XR @ ccdr) & ((ccfv @ XR @ ccchr) = ccc0)) & (cwcel @ XQ @ ccq)) => ((ccfv @ XQ @ (ccfv @ XR @ ccqqh)) = (cco @ (ccfv @ (ccfv @ XQ @ ccnumer) @ XL) @ (ccfv @ (ccfv @ XQ @ ccdenom) @ XL) @ Xc_dv)))))))))))).
...
thf(agcd0id_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cco @ ccc0 @ XN @ ccgcd) = (ccfv @ XN @ ccabs))))).
...
thf(azrh0_ax,axiom,(! [XR:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_0:($i > $o)] : ((XL = (ccfv @ XR @ cczrh)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cwcel @ XR @ ccrg) => ((ccfv @ ccc0 @ XL) = Xc_0)))))))).
...
thf(advr1_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((Xc_1 = (ccfv @ XR @ ccur)) => (((cwcel @ XR @ ccrg) & (cwcel @ XX @ XB2)) => ((cco @ XX @ Xc_1 @ Xc_dv) = XX))))))))))).
thf(cqqh0_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((XL = (ccfv @ XR @ cczrh)) => (((cwcel @ XR @ ccdr) & ((ccfv @ XR @ ccchr) = ccc0)) => ((ccfv @ ccc0 @ (ccfv @ XR @ ccqqh)) = (ccfv @ XR @ cc0g))))))))))).
