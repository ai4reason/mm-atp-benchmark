...
thf(acncfmptss_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XF @ Xx3) @ (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ cccncf)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XC @ (XA2 @ Xx3)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)))) @ (cco @ XC @ (XB2 @ Xx3) @ cccncf))))))))))))).
...
thf(aexpcnfg_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XF @ Xx3) @ (cco @ XA2 @ ccc @ cccncf)))) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ XN @ ccexp))) @ (cco @ XA2 @ ccc @ cccncf))))))))))).
...
thf(anegfcncf_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccneg @ (ccfv @ (ccv @ Xx3) @ XF)))))) => (! [Xx3:$i] : ((cwcel @ XF @ (cco @ XA2 @ ccc @ cccncf)) => (cwcel @ (XG @ Xx3) @ (cco @ XA2 @ ccc @ cccncf))))))))).
...
thf(advsinexp_ax,axiom,(! [Xph:$o] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => (Xph => ((cco @ ccc @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ XN @ ccexp))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (cco @ XN @ (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccmul) @ (ccfv @ (ccv @ Xx3) @ cccos) @ ccmul))))))))).
...
thf(asinpi_ax,axiom,((ccfv @ ccpi @ ccsin) = ccc0)).
...
thf(asqval_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ XA2 @ cc2 @ ccexp) = (cco @ XA2 @ XA2 @ ccmul))))).
