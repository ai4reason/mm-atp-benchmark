...
thf(annneo_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom) @ (XC = (cco @ cc2o @ XA2 @ ccomu))) => (~ ((ccsuc @ XC) = (cco @ cc2o @ XB2 @ ccomu)))))))).
...
thf(acon1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (((~ Xph) => Xps) => ((~ Xps) => Xph))))).
thf(cnneob_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccom) => ((cwrex @ (^ [Xx3:$i] : (XA2 = (cco @ cc2o @ (ccv @ Xx3) @ ccomu))) @ (^ [Xx3:$i] : ccom)) <=> (~ (cwrex @ (^ [Xx3:$i] : ((ccsuc @ XA2) = (cco @ cc2o @ (ccv @ Xx3) @ ccomu))) @ (^ [Xx3:$i] : ccom))))))).
