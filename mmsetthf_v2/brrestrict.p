...
thf(abrtxp2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwbr @ XA2 @ XB2 @ (cctxp @ XR @ XS)) <=> (? [Xx3:$i] : (? [Xy1:$i] : (cw3a @ (XB2 = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (cwbr @ XA2 @ (ccv @ Xx3) @ XR) @ (cwbr @ XA2 @ (ccv @ Xy1) @ XS))))))))))).
...
thf(abrrange_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwbr @ XA2 @ XB2 @ ccrange) <=> (XB2 = (ccrn @ XA2)))))))).
...
thf(abrcart_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwbr @ (ccop @ XA2 @ XB2) @ XC @ cccart) <=> (XC = (ccxp @ XA2 @ XB2)))))))))).
thf(axpex_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwcel @ (ccxp @ XA2 @ XB2) @ ccvv)))))).
thf(cccnv_tp,type,(cccnv : (($i > $o) > ($i > $o)))).
thf(abrcap_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwbr @ (ccop @ XA2 @ XB2) @ XC @ cccap) <=> (XC = (ccin @ XA2 @ XB2)))))))))).
thf(abreqi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((XR = XS) => ((cwbr @ XA2 @ XB2 @ XR) <=> (cwbr @ XA2 @ XB2 @ XS)))))))).
thf(adf_restrict_ax,axiom,(ccrestrict = (cccom @ cccap @ (cctxp @ cc1st @ (cccom @ cccart @ (cctxp @ cc2nd @ (cccom @ ccrange @ cc1st))))))).
thf(aeqeq2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((XC = XA2) <=> (XC = XB2))))))).
thf(adfres3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccres @ XA2 @ XB2) = (ccin @ XA2 @ (ccxp @ XB2 @ (ccrn @ XA2))))))).
thf(cbrrestrict_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwbr @ (ccop @ XA2 @ XB2) @ XC @ ccrestrict) <=> (XC = (ccres @ XA2 @ XB2)))))))))).
