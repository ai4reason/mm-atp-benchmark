...
thf(adivcnvshft_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccz)) => ((! [Xk:$i] : (Xph => (cwcel @ XF @ (XV @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XF) = (cco @ XA2 @ (cco @ (ccv @ Xk) @ XB2 @ ccaddc) @ ccdiv)))) => (Xph => (cwbr @ XF @ ccc0 @ ccli)))))))))))))))).
...
thf(aabsnegi_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (ccneg @ XA2) @ ccabs) = (ccfv @ XA2 @ ccabs))))).
thf(aabs1_ax,axiom,((ccfv @ cc1 @ ccabs) = cc1)).
thf(cbinomcxplemrat_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((! [Xk:$i] : (Xph => (cwcel @ (XA2 @ Xk) @ ccrp))) => ((! [Xk:$i] : (Xph => (cwcel @ (XB2 @ Xk) @ ccr))) => ((! [Xk:$i] : (Xph => (cwbr @ (ccfv @ (XB2 @ Xk) @ ccabs) @ (ccfv @ (XA2 @ Xk) @ ccabs) @ cclt))) => ((Xph => (cwcel @ XC @ ccc)) => (Xph => (cwbr @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (ccfv @ (cco @ (cco @ XC @ (ccv @ Xk) @ ccmin) @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ ccdiv) @ ccabs))) @ cc1 @ ccli))))))))))).
