...
thf(csupcvg_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xn:$i] : (cwcel @ (XX @ Xy1 @ Xn) @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((XS @ Xx3 @ Xy1 @ Xf1) = (ccsup @ (XA2 @ Xf1 @ Xn) @ ccr @ cclt)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((XR @ Xy1 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (XS @ Xx3 @ Xy1 @ Xf1) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccmin)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xy1) => (cwne @ (XX @ Xy1 @ Xn) @ cc0))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xy1) => (cwfo @ (XX @ Xy1 @ Xn) @ (XA2 @ Xf1 @ Xn) @ (XF @ Xy1 @ Xn))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xy1) => (cwss @ (XA2 @ Xf1 @ Xn) @ ccr)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xy1) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (XA2 @ Xf1 @ Xn)))) @ (^ [Xx3:$i] : ccr))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xy1) => (? [Xf1:$i] : ((cwf @ ccn @ (XX @ Xy1 @ Xn) @ (ccv @ Xf1)) & (cwbr @ (cccom @ (XF @ Xy1 @ Xn) @ (ccv @ Xf1)) @ (XS @ Xx3 @ Xy1 @ Xf1) @ ccli))))))))))))))))))))).
