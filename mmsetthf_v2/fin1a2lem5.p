...
thf(anneob_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccom) => ((cwrex @ (^ [Xx3:$i] : (XA2 = (cco @ cc2o @ (ccv @ Xx3) @ ccomu))) @ (^ [Xx3:$i] : ccom)) <=> (~ (cwrex @ (^ [Xx3:$i] : ((ccsuc @ XA2) = (cco @ cc2o @ (ccv @ Xx3) @ ccomu))) @ (^ [Xx3:$i] : ccom))))))).
thf(abitri_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph <=> Xps) => ((Xps <=> Xch) => (Xph <=> Xch))))))).
thf(aax_mp_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((Xph => Xps) => Xps))))).
thf(cwral_tp,type,(cwral : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(cwf_tp,type,(cwf : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(afin1a2lem4_ax,axiom,(! [XE:($i > ($i > $o))] : ((! [Xx3:$i] : ((XE @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccom) @ (^ [Xx3:$i] : (cco @ cc2o @ (ccv @ Xx3) @ ccomu))))) => (! [Xx3:$i] : (cwf1 @ ccom @ ccom @ (XE @ Xx3)))))).
