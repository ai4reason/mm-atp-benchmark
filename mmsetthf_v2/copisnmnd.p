...
thf(ahashgt12el2_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [Xb:$i] : ((cw3a @ (cwcel @ XV @ (XW @ Xb)) @ (cwbr @ cc1 @ (ccfv @ XV @ cchash) @ cclt) @ (cwcel @ XA2 @ XV)) => (cwrex @ (^ [Xb:$i] : (cwne @ XA2 @ (ccv @ Xb))) @ (^ [Xb:$i] : XV)))))))).
...
thf(ccopisnmnd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (XB2 = (ccfv @ (XM @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((ccfv @ (XM @ Xx3 @ Xy1) @ ccplusg) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XC)))))) => ((Xph => (cwcel @ XC @ XB2)) => ((Xph => (cwbr @ cc1 @ (ccfv @ XB2 @ cchash) @ cclt)) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwnel @ (XM @ Xx3 @ Xy1) @ ccmnd))))))))))))).
