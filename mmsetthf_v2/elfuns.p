...
thf(a_19_41vvvv_ax,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xps:$o] : ((? [Xw:$i] : (? [Xx3:$i] : (? [Xy1:$i] : (? [Xz:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) & Xps))))) <=> ((? [Xw:$i] : (? [Xx3:$i] : (? [Xy1:$i] : (? [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw))))) & Xps))))).
thf(aanbi1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph <=> Xps) => ((Xph & Xch) <=> (Xps & Xch))))))).
thf(aee4anv_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : ((? [Xx3:$i] : (? [Xy1:$i] : (? [Xz:$i] : (? [Xw:$i] : ((Xph @ Xx3 @ Xy1) & (Xps @ Xz @ Xw)))))) <=> ((? [Xx3:$i] : (? [Xy1:$i] : (Xph @ Xx3 @ Xy1))) & (? [Xz:$i] : (? [Xw:$i] : (Xps @ Xz @ Xw)))))))).
...
thf(aexrot4_ax,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : ((? [Xx3:$i] : (? [Xy1:$i] : (? [Xz:$i] : (? [Xw:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw))))) <=> (? [Xz:$i] : (? [Xw:$i] : (? [Xx3:$i] : (? [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)))))))).
...
thf(abrtxp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ ccvv) => ((cwcel @ XZ @ ccvv) => ((cwbr @ XX @ (ccop @ XY @ XZ) @ (cctxp @ XA2 @ XB2)) <=> ((cwbr @ XX @ XY @ XA2) & (cwbr @ XX @ XZ @ XB2)))))))))))).
...
thf(abrv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwbr @ XA2 @ XB2 @ ccvv)))).
...
thf(adf_funs_ax,axiom,(ccfuns = (ccdif @ (ccpw @ (ccxp @ ccvv @ ccvv)) @ (ccfix @ (cccom @ ccep @ (cccom @ (cctxp @ cc1st @ (cccom @ (ccdif @ ccvv @ ccid) @ cc2nd)) @ (cccnv @ ccep))))))).
...
thf(aelfix_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XA2 @ (ccfix @ XR)) <=> (cwbr @ XA2 @ XA2 @ XR)))))).
thf(acoep_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwbr @ XA2 @ XB2 @ (cccom @ ccep @ XR)) <=> (cwrex @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ XR)) @ (^ [Xx3:$i] : XB2))))))))).
...
thf(acoepr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwbr @ XA2 @ XB2 @ (cccom @ XR @ (cccnv @ ccep))) <=> (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XB2 @ XR)) @ (^ [Xx3:$i] : XA2))))))))).
thf(ar2ex_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : ((cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) <=> (? [Xx3:$i] : (? [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3 @ Xy1))) & (Xph @ Xx3 @ Xy1))))))))).
thf(celfuns_conj,conjecture,(! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => ((cwcel @ XF @ ccfuns) <=> (cwfun @ XF))))).
