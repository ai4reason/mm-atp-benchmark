...
thf(afsumsplitf_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XU:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : ((Xph @ Xk) => ((ccin @ XA2 @ XB2) = cc0))) => ((! [Xk:$i] : ((Xph @ Xk) => (XU = (ccun @ XA2 @ XB2)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XU @ ccfn))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XU)) => (cwcel @ (XC @ Xk) @ ccc))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccsu @ XU @ (^ [Xk:$i] : (XC @ Xk))) = (cco @ (ccsu @ XA2 @ (^ [Xk:$i] : (XC @ Xk))) @ (ccsu @ XB2 @ (^ [Xk:$i] : (XC @ Xk))) @ ccaddc))))))))))))))).
...
thf(asumsnf_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwnfc @ (^ [Xk:$i] : (XB2 @ Xk))) => ((! [Xk:$i] : (((ccv @ Xk) = XM) => ((XA2 @ Xk) = (XB2 @ Xk)))) => (! [Xk:$i] : (((cwcel @ XM @ XV) & (cwcel @ (XB2 @ Xk) @ ccc)) => ((ccsu @ (ccsn @ XM) @ (^ [Xk:$i] : (XA2 @ Xk))) = (XB2 @ Xk))))))))))).
