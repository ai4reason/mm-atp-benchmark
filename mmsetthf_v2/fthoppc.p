...
thf(cfthoppc_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XC @ ccoppc)) => ((XP = (ccfv @ XD @ ccoppc)) => ((Xph => (cwbr @ XF @ XG @ (cco @ XC @ XD @ ccfth))) => (Xph => (cwbr @ XF @ (cctpos @ XG) @ (cco @ XO @ XP @ ccfth)))))))))))))).
