...
thf(cnndivtr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccc)) & ((cwcel @ (cco @ XB2 @ XA2 @ ccdiv) @ ccn) & (cwcel @ (cco @ XC @ XB2 @ ccdiv) @ ccn))) => (cwcel @ (cco @ XC @ XA2 @ ccdiv) @ ccn)))))).
