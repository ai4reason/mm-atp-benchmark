...
thf(aosumcllem11N_ax,axiom,(! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_pl = (ccfv @ XK @ ccpadd)) => ((Xc_pe = (ccfv @ XK @ ccpolN)) => ((XC = (ccfv @ XK @ ccpscN)) => (((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XC) @ (cwcel @ XY @ XC)) & ((cwss @ XX @ (ccfv @ XY @ Xc_pe)) & (cwne @ XX @ cc0))) => ((cco @ XX @ XY @ Xc_pl) = (ccfv @ (ccfv @ (cco @ XX @ XY @ Xc_pl) @ Xc_pe) @ Xc_pe))))))))))))).
...
thf(cosumclN_conj,conjecture,(! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_pl = (ccfv @ XK @ ccpadd)) => ((Xc_pe = (ccfv @ XK @ ccpolN)) => ((XC = (ccfv @ XK @ ccpscN)) => (((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XC) @ (cwcel @ XY @ XC)) & (cwss @ XX @ (ccfv @ XY @ Xc_pe))) => (cwcel @ (cco @ XX @ XY @ Xc_pl) @ XC)))))))))))).
