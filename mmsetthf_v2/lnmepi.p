...
thf(almhmfgima_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XT @ (ccima @ XF @ XA2) @ ccress)) => ((XX = (cco @ XS @ XA2 @ ccress)) => ((XU = (ccfv @ XS @ cclss)) => ((Xph => (cwcel @ XX @ cclfig)) => ((Xph => (cwcel @ XA2 @ XU)) => ((Xph => (cwcel @ XF @ (cco @ XS @ XT @ cclmhm))) => (Xph => (cwcel @ XY @ cclfig))))))))))))))))).
...
thf(clnmepi_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((XB2 = (ccfv @ XT @ ccbs)) => ((cw3a @ (cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) @ (cwcel @ XS @ cclnm) @ ((ccrn @ XF) = XB2)) => (cwcel @ XT @ cclnm)))))))).
