...
thf(ahstle_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : ((((cwcel @ XS @ cchst) & (cwcel @ XA2 @ ccch)) & ((cwcel @ XB2 @ ccch) & (cwss @ XA2 @ XB2))) => (cwbr @ (ccfv @ (ccfv @ XA2 @ XS) @ ccno) @ (ccfv @ (ccfv @ XB2 @ XS) @ ccno) @ ccle)))))).
