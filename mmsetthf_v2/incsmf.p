...
thf(aincsmflem_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xb:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1 @ Xb))))) => ((! [Xx3:$i] : (! [Xb:$i] : (cwnf @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xb))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xb:$i] : ((Xph @ Xx3 @ Xy1 @ Xb) => (cwss @ XA2 @ ccr))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xb:$i] : ((Xph @ Xx3 @ Xy1 @ Xb) => (cwf @ XA2 @ ccxr @ (XF @ Xb)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xb:$i] : ((Xph @ Xx3 @ Xy1 @ Xb) => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle) => (cwbr @ (ccfv @ (ccv @ Xx3) @ (XF @ Xb)) @ (ccfv @ (ccv @ Xy1) @ (XF @ Xb)) @ ccle))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xb:$i] : ((XJ @ Xx3 @ Xy1 @ Xb) = (ccfv @ (ccrn @ ccioo) @ cctg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xb:$i] : ((XB2 @ Xx3 @ Xy1) = (ccfv @ (XJ @ Xx3 @ Xy1 @ Xb) @ ccsalgen))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xb:$i] : ((Xph @ Xx3 @ Xy1 @ Xb) => (cwcel @ (XR @ Xb) @ ccxr))))) => ((! [Xx3:$i] : (! [Xb:$i] : ((XY @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (XF @ Xb)) @ (XR @ Xb) @ cclt)) @ (^ [Xx3:$i] : XA2))))) => ((! [Xx3:$i] : (! [Xb:$i] : ((XC @ Xb) = (ccsup @ (XY @ Xx3) @ ccxr @ cclt)))) => ((! [Xb:$i] : (XD = (cco @ ccmnf @ (XC @ Xb) @ ccioo))) => ((! [Xb:$i] : (XE = (cco @ ccmnf @ (XC @ Xb) @ ccioc))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xb:$i] : ((Xph @ Xx3 @ Xy1 @ Xb) => (cwrex @ (^ [Xb:$i] : ((XY @ Xx3) = (ccin @ (ccv @ Xb) @ XA2))) @ (^ [Xb:$i] : (XB2 @ Xx3 @ Xy1)))))))))))))))))))))))))))))).
