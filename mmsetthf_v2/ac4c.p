...
thf(aac4_ax,axiom,(! [Xx3:$i] : (? [Xf1:$i] : (cwral @ (^ [Xz:$i] : ((cwne @ (ccv @ Xz) @ cc0) => (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xf1)) @ (ccv @ Xz)))) @ (^ [Xz:$i] : (ccv @ Xx3)))))).
thf(cac4c_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (? [Xf1:$i] : (cwral @ (^ [Xx3:$i] : ((cwne @ (ccv @ Xx3) @ cc0) => (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2)))))).
