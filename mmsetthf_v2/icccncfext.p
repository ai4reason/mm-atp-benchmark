...
thf(aifeq123d_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (Xps <=> Xch)) => ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((ccif @ Xps @ XA2 @ XC) = (ccif @ Xch @ XB2 @ XD)))))))))))))).
...
thf(aunima_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwfn @ XF @ XA2) @ (cwss @ XB2 @ XA2) @ (cwss @ XC @ XA2)) => ((ccima @ XF @ (ccun @ XB2 @ XC)) = (ccun @ (ccima @ XF @ XB2) @ (ccima @ XF @ XC))))))))).
...
thf(a_3adantll2_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (((((Xph & Xps) & Xch) & Xth) => Xta) => ((((cw3a @ Xph @ Xet @ Xps) & Xch) & Xth) => Xta))))))))).
