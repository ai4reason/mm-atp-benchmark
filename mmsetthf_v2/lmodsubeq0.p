...
thf(clmodsubeq0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((Xc_mi = (ccfv @ XW @ ccsg)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV)) => (((cco @ XA2 @ XB2 @ Xc_mi) = Xc_0) <=> (XA2 = XB2))))))))))))).
