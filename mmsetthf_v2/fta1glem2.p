...
thf(afacth1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pa:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_mi = (ccfv @ XP @ ccsg)) => ((XA2 = (ccfv @ XP @ ccascl)) => ((XG = (cco @ XX @ (ccfv @ XN @ XA2) @ Xc_mi)) => ((XO = (ccfv @ XR @ cce1)) => ((Xph => (cwcel @ XR @ ccnzr)) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XN @ XK)) => ((Xph => (cwcel @ XF @ XB2)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_pa = (ccfv @ XP @ ccdsr)) => (Xph => ((cwbr @ XG @ XF @ Xc_pa) <=> ((ccfv @ XN @ (ccfv @ XF @ XO)) = Xc_0)))))))))))))))))))))))))))))))).
...
thf(advdsq1p_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pa:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_pa = (ccfv @ XP @ ccdsr)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XC = (ccfv @ XR @ ccuc1p)) => ((Xc_x = (ccfv @ XP @ ccmulr)) => ((XQ = (ccfv @ XR @ ccq1p)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XC)) => ((cwbr @ XG @ XF @ Xc_pa) <=> (XF = (cco @ (cco @ XF @ XG @ XQ) @ XG @ Xc_x)))))))))))))))))))).
...
thf(adomneq0_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cw3a @ (cwcel @ XR @ ccdomn) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => (((cco @ XX @ XY @ Xc_x) = Xc_0) <=> ((XX = Xc_0) | (XY = Xc_0)))))))))))))).
