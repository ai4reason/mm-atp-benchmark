...
thf(aoms0_ax,axiom,(! [Xph:$o] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XM = (ccfv @ XR @ ccoms)) => ((Xph => (cwcel @ XQ @ XV)) => ((Xph => (cwf @ XQ @ (cco @ ccc0 @ ccpnf @ ccicc) @ XR)) => ((Xph => (cwcel @ cc0 @ (ccdm @ XR))) => ((Xph => ((ccfv @ cc0 @ XR) = ccc0)) => (Xph => ((ccfv @ cc0 @ XM) = ccc0))))))))))))).
...
thf(aomsmon_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XM = (ccfv @ XR @ ccoms)) => ((Xph => (cwcel @ XQ @ XV)) => ((Xph => (cwf @ XQ @ (cco @ ccc0 @ ccpnf @ ccicc) @ XR)) => ((Xph => (cwss @ XA2 @ XB2)) => ((Xph => (cwss @ XB2 @ (ccuni @ XQ))) => (Xph => (cwbr @ (ccfv @ XA2 @ XM) @ (ccfv @ XB2 @ XM) @ ccle))))))))))))))).
...
thf(aesumpad2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ XV)) => ((! [Xk:$i] : (Xph => (cwcel @ XB2 @ (XW @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XC @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XB2)) => ((XC @ Xk) = ccc0))) => (Xph => ((ccesum @ (^ [Xk:$i] : (ccdif @ XA2 @ XB2)) @ (^ [Xk:$i] : (XC @ Xk))) = (ccesum @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk)))))))))))))))).
