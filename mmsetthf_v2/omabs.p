...
thf(aomabslem_ax,axiom,(! [XA2:($i > $o)] : ((cw3a @ (cwcel @ ccom @ ccon0) @ (cwcel @ XA2 @ ccom) @ (cwcel @ cc0 @ XA2)) => ((cco @ XA2 @ ccom @ ccomu) = ccom)))).
...
thf(aoe1_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cco @ XA2 @ cc1o @ ccoe) = XA2)))).
...
thf(aomass_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) => ((cco @ (cco @ XA2 @ XB2 @ ccomu) @ XC @ ccomu) = (cco @ XA2 @ (cco @ XB2 @ XC @ ccomu) @ ccomu))))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(asimprr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & (Xps & Xch)) => Xch))))).
thf(aon0eqel_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((XA2 = cc0) | (cwcel @ cc0 @ XA2))))).
...
thf(aondif2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdif @ ccon0 @ cc2o)) <=> ((cwcel @ XA2 @ ccon0) & (cwcel @ cc1o @ XA2))))).
thf(aoelimcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ (ccdif @ ccon0 @ cc2o)) & ((cwcel @ XB2 @ XC) & (cwlim @ XB2))) => (cwlim @ (cco @ XA2 @ XB2 @ ccoe))))))).
...
thf(aoelim2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XA2 @ ccon0) & ((cwcel @ XB2 @ (XC @ Xx3)) & (cwlim @ XB2))) => ((cco @ XA2 @ XB2 @ ccoe) = (cciun @ (^ [Xx3:$i] : (ccdif @ XB2 @ cc1o)) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccoe)))))))))).
...
thf(aontr1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccon0) => (((cwcel @ XA2 @ XB2) & (cwcel @ XB2 @ XC)) => (cwcel @ XA2 @ XC))))))).
...
thf(aomword2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) & (cwcel @ cc0 @ XB2)) => (cwss @ XA2 @ (cco @ XB2 @ XA2 @ ccomu)))))).
thf(annm0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccom) => ((cco @ XA2 @ cc0 @ ccomu) = cc0)))).
...
thf(afnoe_ax,axiom,(cwfn @ ccoe @ (ccxp @ ccon0 @ ccon0))).
thf(cwfun_tp,type,(cwfun : (($i > $o) > $o))).
thf(afndm_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ XA2) => ((ccdm @ XF) = XA2))))).
thf(comabs_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccom) & (cwcel @ cc0 @ XA2)) & ((cwcel @ XB2 @ ccon0) & (cwcel @ cc0 @ XB2))) => ((cco @ XA2 @ (cco @ ccom @ XB2 @ ccoe) @ ccomu) = (cco @ ccom @ XB2 @ ccoe)))))).
