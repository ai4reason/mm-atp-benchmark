...
thf(afndmeng_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XA2) & (cwcel @ XA2 @ XC)) => (cwbr @ XA2 @ XF @ ccen)))))).
...
thf(chashfn_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ XA2) => ((ccfv @ XF @ cchash) = (ccfv @ XA2 @ cchash)))))).
