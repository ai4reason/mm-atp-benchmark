...
thf(apf1subrg_ax,axiom,(! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XQ = (ccrn @ (ccfv @ XR @ cce1))) => ((cwcel @ XR @ cccrg) => (cwcel @ XQ @ (ccfv @ (cco @ XR @ XB2 @ ccpws) @ ccsubrg))))))))).
...
thf(cpf1mulcl_conj,conjecture,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XQ = (ccrn @ (ccfv @ XR @ cce1))) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (((cwcel @ XF @ XQ) & (cwcel @ XG @ XQ)) => (cwcel @ (cco @ XF @ XG @ (ccof @ Xc_x)) @ XQ)))))))))).
