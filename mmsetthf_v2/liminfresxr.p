...
thf(assrind_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwss @ XA2 @ XB2)) => (Xph => (cwss @ (ccin @ XA2 @ XC) @ (ccin @ XB2 @ XC))))))))).
thf(aa1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(aresimass_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwss @ (ccima @ (ccres @ XA2 @ XB2) @ XC) @ (ccima @ XA2 @ XC)))))).
...
thf(afvelima2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XA2) & (cwcel @ XB2 @ (ccima @ XF @ XC))) => (cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) = XB2)) @ (^ [Xx3:$i] : (ccin @ XA2 @ XC))))))))).
...
thf(afunresd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwfun @ XF)) => (Xph => (cwfun @ (ccres @ XF @ XA2)))))))).
...
thf(aresexd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => (Xph => (cwcel @ (ccres @ XA2 @ XB2) @ ccvv)))))))).
thf(aliminfval_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xk:$i] : ((XG @ Xk) = (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccinf @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))) => (! [Xk:$i] : ((cwcel @ XF @ (XV @ Xk)) => ((ccfv @ XF @ cclsi) = (ccsup @ (ccrn @ (XG @ Xk)) @ ccxr @ cclt))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(climinfresxr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XF @ XV)) => ((Xph => (cwfun @ XF)) => ((XA2 = (ccima @ (cccnv @ XF) @ ccxr)) => (Xph => ((ccfv @ (ccres @ XF @ XA2) @ cclsi) = (ccfv @ XF @ cclsi))))))))))).
