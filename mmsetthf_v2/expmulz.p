...
thf(cexpmulz_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwne @ XA2 @ ccc0)) & ((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz))) => ((cco @ XA2 @ (cco @ XM @ XN @ ccmul) @ ccexp) = (cco @ (cco @ XA2 @ XM @ ccexp) @ XN @ ccexp))))))).
