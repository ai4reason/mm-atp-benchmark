...
thf(a_19_29r_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (((? [Xx3:$i] : (Xph @ Xx3)) & (! [Xx3:$i] : (Xps @ Xx3))) => (? [Xx3:$i] : ((Xph @ Xx3) & (Xps @ Xx3))))))).
thf(adf_rex_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) <=> (? [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) & (Xph @ Xx3))))))).
thf(ckmlem6_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : (! [XA2:($i > ($i > ($i > $o)))] : (((cwral @ (^ [Xz:$i] : (cwne @ (ccv @ Xz) @ cc0)) @ (^ [Xz:$i] : (ccv @ Xx3))) & (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((Xph @ Xz @ Xw) => ((XA2 @ Xz @ Xw) = cc0))) @ (^ [Xw:$i] : (ccv @ Xx3)))) @ (^ [Xz:$i] : (ccv @ Xx3)))) => (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xv:$i] : (cwral @ (^ [Xw:$i] : ((Xph @ Xz @ Xw) => (~ (cwcel @ (ccv @ Xv) @ (XA2 @ Xz @ Xw))))) @ (^ [Xw:$i] : (ccv @ Xx3)))) @ (^ [Xv:$i] : (ccv @ Xz)))) @ (^ [Xz:$i] : (ccv @ Xx3)))))))).
