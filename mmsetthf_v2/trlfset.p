...
thf(adf_trl_ax,axiom,(cctrl = (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccmpt @ (^ [Xw:$i] : (ccfv @ (ccv @ Xk) @ cclh)) @ (^ [Xw:$i] : (ccmpt @ (^ [Xf1:$i] : (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccltrn))) @ (^ [Xf1:$i] : (ccrio @ (^ [Xx3:$i] : (cwral @ (^ [Xp:$i] : ((~ (cwbr @ (ccv @ Xp) @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccple))) => ((ccv @ Xx3) = (cco @ (cco @ (ccv @ Xp) @ (ccfv @ (ccv @ Xp) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xk) @ ccjn)) @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccmee))))) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xk) @ ccatm)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xk) @ ccbs))))))))))).
thf(amptex_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(aeqeltri_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwcel @ XB2 @ XC) => (cwcel @ XA2 @ XC))))))).
thf(afvex_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(ctrlfset_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [Xc_or:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_an:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xw:$i] : (! [Xf1:$i] : (! [Xp:$i] : ((XB2 @ Xw @ Xf1 @ Xp) = (ccfv @ XK @ ccbs))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xp:$i] : ((Xc_le @ Xx3 @ Xw @ Xf1 @ Xp) = (ccfv @ XK @ ccple)))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xp:$i] : ((Xc_or @ Xx3 @ Xw @ Xf1 @ Xp) = (ccfv @ XK @ ccjn)))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xp:$i] : ((Xc_an @ Xx3 @ Xw @ Xf1 @ Xp) = (ccfv @ XK @ ccmee)))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xf1:$i] : ((XA2 @ Xx3 @ Xw @ Xf1) = (ccfv @ XK @ ccatm))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xp:$i] : ((XH @ Xx3 @ Xf1 @ Xp) = (ccfv @ XK @ cclh))))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xp:$i] : ((cwcel @ XK @ (XC @ Xx3 @ Xw @ Xf1 @ Xp)) => ((ccfv @ XK @ cctrl) = (ccmpt @ (^ [Xw:$i] : (XH @ Xx3 @ Xf1 @ Xp)) @ (^ [Xw:$i] : (ccmpt @ (^ [Xf1:$i] : (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccltrn))) @ (^ [Xf1:$i] : (ccrio @ (^ [Xx3:$i] : (cwral @ (^ [Xp:$i] : ((~ (cwbr @ (ccv @ Xp) @ (ccv @ Xw) @ (Xc_le @ Xx3 @ Xw @ Xf1 @ Xp))) => ((ccv @ Xx3) = (cco @ (cco @ (ccv @ Xp) @ (ccfv @ (ccv @ Xp) @ (ccv @ Xf1)) @ (Xc_or @ Xx3 @ Xw @ Xf1 @ Xp)) @ (ccv @ Xw) @ (Xc_an @ Xx3 @ Xw @ Xf1 @ Xp))))) @ (^ [Xp:$i] : (XA2 @ Xx3 @ Xw @ Xf1)))) @ (^ [Xx3:$i] : (XB2 @ Xw @ Xf1 @ Xp)))))))))))))))))))))))))))).
