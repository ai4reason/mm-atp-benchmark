...
thf(arexdifpr_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccdif @ (XA2 @ Xx3) @ (ccpr @ (XB2 @ Xx3) @ (XC @ Xx3))))) <=> (cwrex @ (^ [Xx3:$i] : (cw3a @ (cwne @ (ccv @ Xx3) @ (XB2 @ Xx3)) @ (cwne @ (ccv @ Xx3) @ (XC @ Xx3)) @ (Xph @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))).
...
thf(arexdifsn_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccdif @ (XA2 @ Xx3) @ (ccsn @ (XB2 @ Xx3))))) <=> (cwrex @ (^ [Xx3:$i] : ((cwne @ (ccv @ Xx3) @ (XB2 @ Xx3)) & (Xph @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))).
thf(cusgr2pth0_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XG @ cciedg)) => ((cwcel @ XG @ ccusgr) => (((cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) & ((ccfv @ XF @ cchash) = cc2)) <=> (cw3a @ (cwf1 @ (cco @ ccc0 @ cc2 @ ccfzo) @ (ccdm @ XI) @ XF) @ (cwf1 @ (cco @ ccc0 @ cc2 @ ccfz) @ XV @ XP) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((cw3a @ ((ccfv @ ccc0 @ XP) = (ccv @ Xx3)) @ ((ccfv @ cc1 @ XP) = (ccv @ Xz)) @ ((ccfv @ cc2 @ XP) = (ccv @ Xy1))) & (((ccfv @ (ccfv @ ccc0 @ XF) @ XI) = (ccpr @ (ccv @ Xx3) @ (ccv @ Xz))) & ((ccfv @ (ccfv @ cc1 @ XF) @ XI) = (ccpr @ (ccv @ Xz) @ (ccv @ Xy1)))))) @ (^ [Xz:$i] : (ccdif @ XV @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)))))) @ (^ [Xy1:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : XV))))))))))))).
