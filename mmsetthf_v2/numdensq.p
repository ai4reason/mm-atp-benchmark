...
thf(aqnumdencoprm_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccq) => ((cco @ (ccfv @ XA2 @ ccnumer) @ (ccfv @ XA2 @ ccdenom) @ ccgcd) = cc1)))).
...
thf(azgcdsq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => ((cco @ (cco @ XA2 @ XB2 @ ccgcd) @ cc2 @ ccexp) = (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccgcd)))))).
