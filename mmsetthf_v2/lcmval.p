...
thf(adf_lcm_ax,axiom,(cclcm = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (((ccv @ Xx3) = ccc0) | ((ccv @ Xy1) = ccc0)) @ ccc0 @ (ccinf @ (ccrab @ (^ [Xn:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdvds) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xn) @ ccdvds))) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt))))))).
...
thf(clcmval_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ XM @ XN @ cclcm) = (ccif @ ((XM = ccc0) | (XN = ccc0)) @ ccc0 @ (ccinf @ (ccrab @ (^ [Xn:$i] : ((cwbr @ XM @ (ccv @ Xn) @ ccdvds) & (cwbr @ XN @ (ccv @ Xn) @ ccdvds))) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt))))))).
