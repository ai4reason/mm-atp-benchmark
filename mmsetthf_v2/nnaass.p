...
thf(cnnaass_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom) @ (cwcel @ XC @ ccom)) => ((cco @ (cco @ XA2 @ XB2 @ ccoa) @ XC @ ccoa) = (cco @ XA2 @ (cco @ XB2 @ XC @ ccoa) @ ccoa))))))).
