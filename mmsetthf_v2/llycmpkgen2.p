...
thf(cllycmpkgen2_conj,conjecture,(! [Xph:$o] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : ((XX @ Xx3) = (ccuni @ XJ))) => ((Xph => (cwcel @ XJ @ cctop)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (XX @ Xx3))) => (cwrex @ (^ [Xk:$i] : (cwcel @ (cco @ XJ @ (ccv @ Xk) @ ccrest) @ cccmp)) @ (^ [Xk:$i] : (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)))))) => (Xph => (cwcel @ XJ @ (ccrn @ cckgen)))))))))).
