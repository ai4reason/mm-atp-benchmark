...
thf(chtpyco2_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ XJ @ XK @ cccn))) => ((Xph => (cwcel @ XP @ (cco @ XK @ XL @ cccn))) => ((Xph => (cwcel @ XH @ (cco @ XF @ XG @ (cco @ XJ @ XK @ cchtpy)))) => (Xph => (cwcel @ (cccom @ XP @ XH) @ (cco @ (cccom @ XP @ XF) @ (cccom @ XP @ XG) @ (cco @ XJ @ XL @ cchtpy))))))))))))))))).
