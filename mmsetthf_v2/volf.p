...
thf(avolres_ax,axiom,(ccvol = (ccres @ ccovol @ (ccdm @ ccvol)))).
...
thf(afunssxp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwfun @ XF) & (cwss @ XF @ (ccxp @ XA2 @ XB2))) <=> ((cwf @ (ccdm @ XF) @ XB2 @ XF) & (cwss @ (ccdm @ XF) @ XA2))))))).
thf(cvolf_conj,conjecture,(cwf @ (ccdm @ ccvol) @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccvol)).
