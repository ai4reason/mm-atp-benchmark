...
thf(aisprm4_ax,axiom,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprime) <=> ((cwcel @ XP @ (ccfv @ cc2 @ ccuz)) & (cwral @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xz) @ XP @ ccdvds) => ((ccv @ Xz) = XP))) @ (^ [Xz:$i] : (ccfv @ cc2 @ ccuz))))))).
...
thf(ajc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => Xch) => (Xph => (~ (Xps => (~ Xch)))))))))).
...
thf(cisprm5_conj,conjecture,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprime) <=> ((cwcel @ XP @ (ccfv @ cc2 @ ccuz)) & (cwral @ (^ [Xz:$i] : ((cwbr @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ XP @ ccle) => (~ (cwbr @ (ccv @ Xz) @ XP @ ccdvds)))) @ (^ [Xz:$i] : ccprime)))))).
