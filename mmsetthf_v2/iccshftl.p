...
thf(ciccshftl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cco @ XA2 @ XR @ ccmin) = XC) => (((cco @ XB2 @ XR @ ccmin) = XD) => ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwcel @ XX @ ccr) & (cwcel @ XR @ ccr))) => ((cwcel @ XX @ (cco @ XA2 @ XB2 @ ccicc)) <=> (cwcel @ (cco @ XX @ XR @ ccmin) @ (cco @ XC @ XD @ ccicc))))))))))))).
