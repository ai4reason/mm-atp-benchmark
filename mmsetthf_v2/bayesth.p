...
thf(acndprob01_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (((cw3a @ (cwcel @ XP @ ccprb) @ (cwcel @ XA2 @ (ccdm @ XP)) @ (cwcel @ XB2 @ (ccdm @ XP))) & (cwne @ (ccfv @ XB2 @ XP) @ ccc0)) => (cwcel @ (ccfv @ (ccop @ XA2 @ XB2) @ (ccfv @ XP @ cccprob)) @ (cco @ ccc0 @ cc1 @ ccicc))))))).
...
thf(acndprobin_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (((cw3a @ (cwcel @ XP @ ccprb) @ (cwcel @ XA2 @ (ccdm @ XP)) @ (cwcel @ XB2 @ (ccdm @ XP))) & (cwne @ (ccfv @ XB2 @ XP) @ ccc0)) => ((cco @ (ccfv @ (ccop @ XA2 @ XB2) @ (ccfv @ XP @ cccprob)) @ (ccfv @ XB2 @ XP) @ ccmul) = (ccfv @ (ccin @ XA2 @ XB2) @ XP))))))).
...
thf(cbayesth_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((cw3a @ (cw3a @ (cwcel @ XP @ ccprb) @ (cwcel @ XA2 @ (ccdm @ XP)) @ (cwcel @ XB2 @ (ccdm @ XP))) @ (cwne @ (ccfv @ XA2 @ XP) @ ccc0) @ (cwne @ (ccfv @ XB2 @ XP) @ ccc0)) => ((ccfv @ (ccop @ XA2 @ XB2) @ (ccfv @ XP @ cccprob)) = (cco @ (cco @ (ccfv @ (ccop @ XB2 @ XA2) @ (ccfv @ XP @ cccprob)) @ (ccfv @ XA2 @ XP) @ ccmul) @ (ccfv @ XB2 @ XP) @ ccdiv))))))).
