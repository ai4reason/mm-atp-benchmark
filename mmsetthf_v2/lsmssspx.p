...
thf(alsmless2x_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_po = (ccfv @ XG @ cclsm)) => (((cw3a @ (cwcel @ XG @ XV) @ (cwss @ XR @ XB2) @ (cwss @ XU @ XB2)) & (cwss @ XT @ XU)) => (cwss @ (cco @ XR @ XT @ Xc_po) @ (cco @ XR @ XU @ Xc_po))))))))))))).
...
thf(clsmssspx_conj,conjecture,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((Xph => (cwss @ XT @ XV)) => ((Xph => (cwss @ XU @ XV)) => ((Xph => (cwcel @ XW @ cclmod)) => (Xph => (cwss @ (cco @ XT @ XU @ Xc_po) @ (ccfv @ (ccun @ XT @ XU) @ XN))))))))))))))))).
