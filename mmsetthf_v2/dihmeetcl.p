...
thf(cdihmeetcl_conj,conjecture,(! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XX @ (ccrn @ XI)) & (cwcel @ XY @ (ccrn @ XI)))) => (cwcel @ (ccin @ XX @ XY) @ (ccrn @ XI)))))))))))).
