...
thf(afzctr_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => (cwcel @ XN @ (cco @ ccc0 @ (cco @ cc2 @ XN @ ccmul) @ ccfz))))).
...
thf(arpcxpcld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => (cwcel @ (cco @ XA2 @ XB2 @ cccxp) @ ccrp)))))))).
...
thf(arpcxpcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwcel @ XB2 @ ccr)) => (cwcel @ (cco @ XA2 @ XB2 @ cccxp) @ ccrp))))).
...
thf(abclbnd_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ cc4 @ ccuz)) => (cwbr @ (cco @ (cco @ cc4 @ XN @ ccexp) @ XN @ ccdiv) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ cclt)))).
...
thf(apccl_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XN @ ccn)) => (cwcel @ (cco @ XP @ XN @ ccpc) @ ccn0))))).
thf(cc9_tp,type,(cc9 : ($i > $o))).
thf(abposlem4_ax,axiom,(! [Xph:$o] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ (ccfv @ cc5 @ ccuz))) => ((Xph => (~ (cwrex @ (^ [Xp:$i] : ((cwbr @ XN @ (ccv @ Xp) @ cclt) & (cwbr @ (ccv @ Xp) @ (cco @ cc2 @ XN @ ccmul) @ ccle))) @ (^ [Xp:$i] : ccprime)))) => ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (ccv @ Xn) @ (cco @ (ccv @ Xn) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ ccpc) @ ccexp) @ cc1))))) => ((XK = (ccfv @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc3 @ ccdiv) @ ccfl)) => ((! [Xn:$i] : ((XM @ Xn) = (ccfv @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ ccsqrt) @ ccfl))) => (! [Xn:$i] : (Xph => (cwcel @ (XM @ Xn) @ (cco @ cc3 @ XK @ ccfz))))))))))))))).
...
thf(abposlem3_ax,axiom,(! [Xph:$o] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ (ccfv @ cc5 @ ccuz))) => ((Xph => (~ (cwrex @ (^ [Xp:$i] : ((cwbr @ XN @ (ccv @ Xp) @ cclt) & (cwbr @ (ccv @ Xp) @ (cco @ cc2 @ XN @ ccmul) @ ccle))) @ (^ [Xp:$i] : ccprime)))) => ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (ccv @ Xn) @ (cco @ (ccv @ Xn) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ ccpc) @ ccexp) @ cc1))))) => ((XK = (ccfv @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc3 @ ccdiv) @ ccfl)) => (! [Xn:$i] : (Xph => ((ccfv @ XK @ (ccseq @ ccmul @ (XF @ Xn) @ cc1)) = (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc))))))))))))).
...
thf(auztrn_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ (ccfv @ XK @ ccuz)) & (cwcel @ XK @ (ccfv @ XN @ ccuz))) => (cwcel @ XM @ (ccfv @ XN @ ccuz))))))).
...
thf(aefchtdvds_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ ccle)) => (cwbr @ (ccfv @ (ccfv @ XA2 @ cccht) @ cce) @ (ccfv @ (ccfv @ XB2 @ cccht) @ cce) @ ccdvds))))).
thf(ccicc_tp,type,(ccicc : ($i > $o))).
thf(aefchtcl_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwcel @ (ccfv @ (ccfv @ XA2 @ cccht) @ cce) @ ccn)))).
...
thf(afllt_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccz)) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (ccfv @ XA2 @ ccfl) @ XB2 @ cclt)))))).
...
thf(abposlem1_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XP @ ccprime)) => (cwbr @ (cco @ XP @ (cco @ XP @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ ccpc) @ ccexp) @ (cco @ cc2 @ XN @ ccmul) @ ccle))))).
...
thf(aprmorcht_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (ccv @ Xn) @ cc1))))) => (! [Xn:$i] : ((cwcel @ (XA2 @ Xn) @ ccn) => ((ccfv @ (ccfv @ (XA2 @ Xn) @ cccht) @ cce) = (ccfv @ (XA2 @ Xn) @ (ccseq @ ccmul @ (XF @ Xn) @ cc1))))))))).
...
thf(apc2dvds_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => ((cwbr @ XA2 @ XB2 @ ccdvds) <=> (cwral @ (^ [Xp:$i] : (cwbr @ (cco @ (ccv @ Xp) @ XA2 @ ccpc) @ (cco @ (ccv @ Xp) @ XB2 @ ccpc) @ ccle)) @ (^ [Xp:$i] : ccprime))))))).
...
thf(a_4lt6_ax,axiom,(cwbr @ cc4 @ cc6 @ cclt)).
...
thf(acht3_ax,axiom,((ccfv @ cc3 @ cccht) = (ccfv @ cc6 @ cclog))).
...
thf(achtwordi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ ccle)) => (cwbr @ (ccfv @ XA2 @ cccht) @ (ccfv @ XB2 @ cccht) @ ccle))))).
...
thf(altdiv2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ ((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ cclt)) @ ((cwcel @ XB2 @ ccr) & (cwbr @ ccc0 @ XB2 @ cclt)) @ ((cwcel @ XC @ ccr) & (cwbr @ ccc0 @ XC @ cclt))) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (cco @ XC @ XB2 @ ccdiv) @ (cco @ XC @ XA2 @ ccdiv) @ cclt))))))).
...
thf(achtub_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccr) & (cwbr @ cc2 @ XN @ cclt)) => (cwbr @ (ccfv @ XN @ cccht) @ (cco @ (ccfv @ cc2 @ cclog) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc3 @ ccmin) @ ccmul) @ cclt)))).
...
thf(aeflt_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (ccfv @ XA2 @ cce) @ (ccfv @ XB2 @ cce) @ cclt)))))).
thf(areexplog_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwcel @ XN @ ccz)) => ((cco @ XA2 @ XN @ ccexp) = (ccfv @ (cco @ XN @ (ccfv @ XA2 @ cclog) @ ccmul) @ cce)))))).
...
thf(asubsub_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccmin) = (cco @ (cco @ XA2 @ XB2 @ ccmin) @ XC @ ccaddc))))))).
thf(amp3an12_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (Xph => (Xps => (((cw3a @ Xph @ Xps @ Xch) => Xth) => (Xch => Xth))))))))).
thf(a_2ne0_ax,axiom,(cwne @ cc2 @ ccc0)).
thf(acxpexpz_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwcel @ XB2 @ ccz)) => ((cco @ XA2 @ XB2 @ cccxp) = (cco @ XA2 @ XB2 @ ccexp)))))).
...
thf(acxpadd_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ ((cwcel @ XA2 @ ccc) & (cwne @ XA2 @ ccc0)) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ cccxp) = (cco @ (cco @ XA2 @ XB2 @ cccxp) @ (cco @ XA2 @ XC @ cccxp) @ ccmul))))))).
...
thf(altdivmul_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ ((cwcel @ XC @ ccr) & (cwbr @ ccc0 @ XC @ cclt))) => ((cwbr @ (cco @ XA2 @ XC @ ccdiv) @ XB2 @ cclt) <=> (cwbr @ XA2 @ (cco @ XC @ XB2 @ ccmul) @ cclt))))))).
thf(ccppi_tp,type,(ccppi : ($i > $o))).
thf(abposlem5_ax,axiom,(! [Xph:$o] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ (ccfv @ cc5 @ ccuz))) => ((Xph => (~ (cwrex @ (^ [Xp:$i] : ((cwbr @ XN @ (ccv @ Xp) @ cclt) & (cwbr @ (ccv @ Xp) @ (cco @ cc2 @ XN @ ccmul) @ ccle))) @ (^ [Xp:$i] : ccprime)))) => ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (ccv @ Xn) @ (cco @ (ccv @ Xn) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ ccpc) @ ccexp) @ cc1))))) => ((XK = (ccfv @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc3 @ ccdiv) @ ccfl)) => ((! [Xn:$i] : ((XM @ Xn) = (ccfv @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ ccsqrt) @ ccfl))) => (! [Xn:$i] : (Xph => (cwbr @ (ccfv @ (XM @ Xn) @ (ccseq @ ccmul @ (XF @ Xn) @ cc1)) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (cco @ (cco @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ ccsqrt) @ cc3 @ ccdiv) @ cc2 @ ccaddc) @ cccxp) @ ccle)))))))))))))).
...
thf(acxpled_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ cc1 @ XA2 @ cclt)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => (Xph => ((cwbr @ XB2 @ XC @ ccle) <=> (cwbr @ (cco @ XA2 @ XB2 @ cccxp) @ (cco @ XA2 @ XC @ cccxp) @ ccle)))))))))))).
...
thf(cbposlem6_conj,conjecture,(! [Xph:$o] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ (ccfv @ cc5 @ ccuz))) => ((Xph => (~ (cwrex @ (^ [Xp:$i] : ((cwbr @ XN @ (ccv @ Xp) @ cclt) & (cwbr @ (ccv @ Xp) @ (cco @ cc2 @ XN @ ccmul) @ ccle))) @ (^ [Xp:$i] : ccprime)))) => ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (cco @ (ccv @ Xn) @ (cco @ (ccv @ Xn) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ ccpc) @ ccexp) @ cc1))))) => ((XK = (ccfv @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc3 @ ccdiv) @ ccfl)) => ((! [Xn:$i] : ((XM @ Xn) = (ccfv @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ ccsqrt) @ ccfl))) => (Xph => (cwbr @ (cco @ (cco @ cc4 @ XN @ ccexp) @ XN @ ccdiv) @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (cco @ (cco @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ ccsqrt) @ cc3 @ ccdiv) @ cc2 @ ccaddc) @ cccxp) @ (cco @ cc2 @ (cco @ (cco @ (cco @ cc4 @ XN @ ccmul) @ cc3 @ ccdiv) @ cc5 @ ccmin) @ cccxp) @ ccmul) @ cclt))))))))))))).
