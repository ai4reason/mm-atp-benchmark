...
thf(acnfnc_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwcel @ XT @ cccnfn) @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ ccrp)) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccfv @ (cco @ (ccv @ Xy1) @ XA2 @ ccmv) @ ccno) @ (ccv @ Xx3) @ cclt) => (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XT) @ (ccfv @ XA2 @ XT) @ ccmin) @ ccabs) @ XB2 @ cclt))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : ccrp))))))).
...
thf(alnfn0i_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ cclf) => ((ccfv @ cc0v @ XT) = ccc0)))).
...
thf(cnmcfnexi_conj,conjecture,(! [XT:($i > $o)] : ((cwcel @ XT @ cclf) => ((cwcel @ XT @ cccnfn) => (cwcel @ (ccfv @ XT @ ccnmf) @ ccr))))).
