...
thf(asstotbnd2_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XN = (ccres @ XM @ (ccxp @ XY @ XY))) => (((cwcel @ XM @ (ccfv @ XX @ ccme)) & (cwss @ XY @ XX)) => ((cwcel @ XN @ (ccfv @ XY @ cctotbnd)) <=> (cwral @ (^ [Xd:$i] : (cwrex @ (^ [Xv:$i] : (cwss @ XY @ (cciun @ (^ [Xx3:$i] : (ccv @ Xv)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ (ccfv @ XM @ ccbl)))))) @ (^ [Xv:$i] : (ccin @ (ccpw @ XX) @ ccfn)))) @ (^ [Xd:$i] : ccrp)))))))))).
...
thf(csstotbnd_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xb:$i] : ((XN @ Xb) = (ccres @ XM @ (ccxp @ XY @ XY)))) => (! [Xb:$i] : (((cwcel @ XM @ (ccfv @ XX @ ccme)) & (cwss @ XY @ XX)) => ((cwcel @ (XN @ Xb) @ (ccfv @ XY @ cctotbnd)) <=> (cwral @ (^ [Xd:$i] : (cwrex @ (^ [Xv:$i] : ((cwss @ XY @ (ccuni @ (ccv @ Xv))) & (cwral @ (^ [Xb:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xb) = (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ (ccfv @ XM @ ccbl)))) @ (^ [Xx3:$i] : XX))) @ (^ [Xb:$i] : (ccv @ Xv))))) @ (^ [Xv:$i] : ccfn))) @ (^ [Xd:$i] : ccrp))))))))))).
