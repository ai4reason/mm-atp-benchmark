...
thf(aelspansni_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ (ccfv @ (ccsn @ XA2) @ ccspn)) <=> (cwrex @ (^ [Xx3:$i] : (XB2 = (cco @ (ccv @ Xx3) @ XA2 @ ccsm))) @ (^ [Xx3:$i] : ccc))))))).
...
thf(aspansnmul_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ ccc)) => (cwcel @ (cco @ XB2 @ XA2 @ ccsm) @ (ccfv @ (ccsn @ XA2) @ ccspn)))))).
...
thf(ahvm1neg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ cchil)) => ((cco @ (ccneg @ cc1) @ (cco @ XA2 @ XB2 @ ccsm) @ ccsm) = (cco @ (ccneg @ XA2) @ XB2 @ ccsm)))))).
...
thf(aspanuni_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ cchil) => ((cwss @ XB2 @ cchil) => ((ccfv @ (ccun @ XA2 @ XB2) @ ccspn) = (cco @ (ccfv @ XA2 @ ccspn) @ (ccfv @ XB2 @ ccspn) @ ccph))))))).
thf(achssii_ax,axiom,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => (cwss @ XH @ cchil)))).
thf(aax_mp_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((Xph => Xps) => Xps))))).
thf(aoveq1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XC @ XF)))))))).
thf(aspanid_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((ccfv @ XA2 @ ccspn) = XA2)))).
thf(cspanunsni_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ cchil) => ((ccfv @ (ccun @ XA2 @ (ccsn @ XB2)) @ ccspn) = (ccfv @ (ccun @ XA2 @ (ccsn @ (ccfv @ XB2 @ (ccfv @ (ccfv @ XA2 @ ccort) @ ccpjh)))) @ ccspn))))))).
