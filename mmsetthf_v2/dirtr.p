...
thf(areldir_ax,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccdir) => (cwrel @ XR)))).
...
thf(cdirtr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XR @ ccdir) & (cwcel @ XC @ XV)) & ((cwbr @ XA2 @ XB2 @ XR) & (cwbr @ XB2 @ XC @ XR))) => (cwbr @ XA2 @ XC @ XR)))))))).
