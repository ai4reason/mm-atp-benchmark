...
thf(aexpcan_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) & (cwbr @ cc1 @ XA2 @ cclt)) => (((cco @ XA2 @ XM @ ccexp) = (cco @ XA2 @ XN @ ccexp)) <=> (XM = XN))))))).
...
thf(cfmtnof1_conj,conjecture,(cwf1 @ ccn0 @ ccn @ ccfmtno)).
