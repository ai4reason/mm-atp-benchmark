...
thf(aevennn2n_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cwbr @ cc2 @ XN @ ccdvds) <=> (cwrex @ (^ [Xn:$i] : ((cco @ cc2 @ (ccv @ Xn) @ ccmul) = XN)) @ (^ [Xn:$i] : ccn)))))).
...
thf(adivle1le_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccrp)) => ((cwbr @ (cco @ XA2 @ XB2 @ ccdiv) @ cc1 @ ccle) <=> (cwbr @ XA2 @ XB2 @ ccle)))))).
...
thf(adifsqpwdvds_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn0) @ (cwbr @ (cco @ XB2 @ cc1 @ ccaddc) @ XA2 @ cclt)) & ((cwcel @ XC @ ccprime) & (cwcel @ XD @ ccn0))) => (((cco @ XC @ XD @ ccexp) = (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccmin)) => (cwbr @ XC @ (cco @ cc2 @ XB2 @ ccmul) @ ccdvds)))))))).
...
thf(clighneallem2_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cw3a @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) @ (cwbr @ cc2 @ XN @ ccdvds) @ ((cco @ (cco @ cc2 @ XN @ ccexp) @ cc1 @ ccmin) = (cco @ XP @ XM @ ccexp))) => (XM = cc1)))))).
