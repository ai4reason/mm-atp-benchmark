...
thf(clpigen_conj,conjecture,(! [Xc_pa:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : ((XU = (ccfv @ XR @ cclidl)) => ((XP = (ccfv @ XR @ cclpidl)) => ((Xc_pa = (ccfv @ XR @ ccdsr)) => (((cwcel @ XR @ ccrg) & (cwcel @ XI @ XU)) => ((cwcel @ XI @ XP) <=> (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pa)) @ (^ [Xy1:$i] : XI))) @ (^ [Xx3:$i] : XI))))))))))))).
