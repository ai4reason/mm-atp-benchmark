...
thf(alogrncn_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccrn @ cclog)) => (cwcel @ XA2 @ ccc)))).
...
thf(clogrnaddcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccrn @ cclog)) & (cwcel @ XB2 @ ccr)) => (cwcel @ (cco @ XA2 @ XB2 @ ccaddc) @ (ccrn @ cclog)))))).
