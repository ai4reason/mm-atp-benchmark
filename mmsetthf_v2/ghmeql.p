...
thf(amhmeql_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (cco @ XS @ XT @ ccmhm)) & (cwcel @ XG @ (cco @ XS @ XT @ ccmhm))) => (cwcel @ (ccdm @ (ccin @ XF @ XG)) @ (ccfv @ XS @ ccsubmnd)))))))).
...
thf(cghmeql_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (cco @ XS @ XT @ ccghm)) & (cwcel @ XG @ (cco @ XS @ XT @ ccghm))) => (cwcel @ (ccdm @ (ccin @ XF @ XG)) @ (ccfv @ XS @ ccsubg)))))))).
