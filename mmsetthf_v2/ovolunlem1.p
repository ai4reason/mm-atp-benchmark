...
thf(asupxrbnd2_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => ((cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr)) <=> (cwbr @ (ccsup @ XA2 @ ccxr @ cclt) @ ccpnf @ cclt))))).
thf(asupxrbnd_ax,axiom,(! [XA2:($i > $o)] : ((cw3a @ (cwss @ XA2 @ ccr) @ (cwne @ XA2 @ cc0) @ (cwbr @ (ccsup @ XA2 @ ccxr @ cclt) @ ccpnf @ cclt)) => (cwcel @ (ccsup @ XA2 @ ccxr @ cclt) @ ccr)))).
...
thf(annnn0addcl_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn) & (cwcel @ XN @ ccn0)) => (cwcel @ (cco @ XM @ XN @ ccaddc) @ ccn))))).
...
thf(aovolfioo_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwss @ XA2 @ ccr) & (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((cwss @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF)))) <=> (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xn:$i] : ((cwbr @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ cc1st) @ (ccv @ Xz) @ cclt) & (cwbr @ (ccv @ Xz) @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ cc2nd) @ cclt))) @ (^ [Xn:$i] : ccn))) @ (^ [Xz:$i] : XA2))))))).
...
thf(covolunlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : ((Xph => ((cwss @ XA2 @ ccr) & (cwcel @ (ccfv @ XA2 @ ccovol) @ ccr))) => ((Xph => ((cwss @ XB2 @ ccr) & (cwcel @ (ccfv @ XB2 @ ccovol) @ ccr))) => ((Xph => (cwcel @ XC @ ccrp)) => ((! [Xn:$i] : ((XS @ Xn) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1))) => ((! [Xn:$i] : ((XT @ Xn) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XG) @ cc1))) => ((! [Xn:$i] : ((XU @ Xn) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (XH @ Xn)) @ cc1))) => ((Xph => (cwcel @ XF @ (cco @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ ccn @ ccmap))) => ((Xph => (cwss @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF))))) => ((! [Xn:$i] : (Xph => (cwbr @ (ccsup @ (ccrn @ (XS @ Xn)) @ ccxr @ cclt) @ (cco @ (ccfv @ XA2 @ ccovol) @ (cco @ XC @ cc2 @ ccdiv) @ ccaddc) @ ccle))) => ((Xph => (cwcel @ XG @ (cco @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ ccn @ ccmap))) => ((Xph => (cwss @ XB2 @ (ccuni @ (ccrn @ (cccom @ ccioo @ XG))))) => ((! [Xn:$i] : (Xph => (cwbr @ (ccsup @ (ccrn @ (XT @ Xn)) @ ccxr @ cclt) @ (cco @ (ccfv @ XB2 @ ccovol) @ (cco @ XC @ cc2 @ ccdiv) @ ccaddc) @ ccle))) => ((! [Xn:$i] : ((XH @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (cco @ (ccv @ Xn) @ cc2 @ ccdiv) @ ccn) @ (ccfv @ (cco @ (ccv @ Xn) @ cc2 @ ccdiv) @ XG) @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ XF)))))) => (Xph => (cwbr @ (ccfv @ (ccun @ XA2 @ XB2) @ ccovol) @ (cco @ (cco @ (ccfv @ XA2 @ ccovol) @ (ccfv @ XB2 @ ccovol) @ ccaddc) @ XC @ ccaddc) @ ccle)))))))))))))))))))))))))).
