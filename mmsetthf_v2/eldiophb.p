...
thf(adf_dioph_ax,axiom,(ccdioph = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccrn @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xp:$i] : (ccfv @ (ccv @ Xn) @ ccuz))) @ (^ [Xk:$i] : (^ [Xp:$i] : (ccfv @ (cco @ cc1 @ (ccv @ Xk) @ ccfz) @ ccmzp))) @ (^ [Xk:$i] : (^ [Xp:$i] : (ccab @ (^ [Xt:$i] : (cwrex @ (^ [Xu:$i] : (((ccv @ Xt) = (ccres @ (ccv @ Xu) @ (cco @ cc1 @ (ccv @ Xn) @ ccfz))) & ((ccfv @ (ccv @ Xu) @ (ccv @ Xp)) = ccc0))) @ (^ [Xu:$i] : (cco @ ccn0 @ (cco @ cc1 @ (ccv @ Xk) @ ccfz) @ ccmap))))))))))))).
...
thf(celdiophb_conj,conjecture,(! [XD:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [Xu:$i] : (! [Xt:$i] : ((cwcel @ (XD @ Xu @ Xt) @ (ccfv @ XN @ ccdioph)) <=> ((cwcel @ XN @ ccn0) & (cwrex @ (^ [Xk:$i] : (cwrex @ (^ [Xp:$i] : ((XD @ Xu @ Xt) = (ccab @ (^ [Xt:$i] : (cwrex @ (^ [Xu:$i] : (((ccv @ Xt) = (ccres @ (ccv @ Xu) @ (cco @ cc1 @ XN @ ccfz))) & ((ccfv @ (ccv @ Xu) @ (ccv @ Xp)) = ccc0))) @ (^ [Xu:$i] : (cco @ ccn0 @ (cco @ cc1 @ (ccv @ Xk) @ ccfz) @ ccmap))))))) @ (^ [Xp:$i] : (ccfv @ (cco @ cc1 @ (ccv @ Xk) @ ccfz) @ ccmzp)))) @ (^ [Xk:$i] : (ccfv @ XN @ ccuz)))))))))).
