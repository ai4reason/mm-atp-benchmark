...
thf(cstoweidlem28_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > $o)))] : ((cwnfc @ (^ [Xt:$i] : (XU @ Xt))) => ((! [Xd:$i] : (cwnf @ (^ [Xt:$i] : (Xph @ Xt @ Xd)))) => ((! [Xt:$i] : (! [Xd:$i] : ((XK @ Xt @ Xd) = (ccfv @ (ccrn @ ccioo) @ cctg)))) => ((! [Xd:$i] : (XT = (ccuni @ (XJ @ Xd)))) => ((! [Xt:$i] : (! [Xd:$i] : ((Xph @ Xt @ Xd) => (cwcel @ (XJ @ Xd) @ cccmp)))) => ((! [Xt:$i] : (! [Xd:$i] : ((Xph @ Xt @ Xd) => (cwcel @ XP @ (cco @ (XJ @ Xd) @ (XK @ Xt @ Xd) @ cccn))))) => ((! [Xt:$i] : (! [Xd:$i] : ((Xph @ Xt @ Xd) => (cwral @ (^ [Xt:$i] : (cwbr @ ccc0 @ (ccfv @ (ccv @ Xt) @ XP) @ cclt)) @ (^ [Xt:$i] : (ccdif @ XT @ (XU @ Xt))))))) => ((! [Xt:$i] : (! [Xd:$i] : ((Xph @ Xt @ Xd) => (cwcel @ (XU @ Xt) @ (XJ @ Xd))))) => (! [Xt:$i] : (! [Xd:$i] : ((Xph @ Xt @ Xd) => (? [Xd:$i] : (cw3a @ (cwcel @ (ccv @ Xd) @ ccrp) @ (cwbr @ (ccv @ Xd) @ cc1 @ cclt) @ (cwral @ (^ [Xt:$i] : (cwbr @ (ccv @ Xd) @ (ccfv @ (ccv @ Xt) @ XP) @ ccle)) @ (^ [Xt:$i] : (ccdif @ XT @ (XU @ Xt)))))))))))))))))))))))).
