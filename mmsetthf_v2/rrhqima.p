...
thf(acnextfres_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XC = (ccuni @ XJ)) => ((XB2 = (ccuni @ XK)) => ((Xph => (cwcel @ XJ @ cctop)) => ((Xph => (cwcel @ XK @ ccha)) => ((Xph => (cwss @ XA2 @ XC)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XJ @ XA2 @ ccrest) @ XK @ cccn))) => ((Xph => (cwcel @ XX @ XA2)) => (Xph => ((ccfv @ XX @ (ccfv @ XF @ (cco @ XJ @ XK @ cccnext))) = (ccfv @ XX @ XF))))))))))))))))))).
...
thf(arrexthaus_ax,axiom,(! [XR:($i > $o)] : (! [XK:($i > $o)] : ((XK = (ccfv @ XR @ cctopn)) => ((cwcel @ XR @ ccrrext) => (cwcel @ XK @ ccha)))))).
...
thf(aqqhcn_ax,axiom,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XZ:($i > $o)] : ((XQ = (cco @ cccnfld @ ccq @ ccress)) => ((XJ = (ccfv @ XQ @ cctopn)) => ((XZ = (ccfv @ XR @ cczlm)) => ((XK = (ccfv @ XR @ cctopn)) => ((cw3a @ (cwcel @ XR @ (ccin @ ccnrg @ ccdr)) @ (cwcel @ XZ @ ccnlm) @ ((ccfv @ XR @ ccchr) = ccc0)) => (cwcel @ (ccfv @ XR @ ccqqh) @ (cco @ XJ @ XK @ cccn))))))))))))).
thf(aqqtopn_ax,axiom,((cco @ (ccfv @ ccrefld @ cctopn) @ ccq @ ccrest) = (ccfv @ (cco @ cccnfld @ ccq @ ccress) @ cctopn))).
