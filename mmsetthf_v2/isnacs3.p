...
thf(anacsacs_ax,axiom,(! [XC:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XC @ (ccfv @ XX @ ccnacs)) => (cwcel @ XC @ (ccfv @ XX @ ccacs)))))).
...
thf(aacsdrsel_ax,axiom,(! [XC:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XC @ (ccfv @ XX @ ccacs)) @ (cwss @ XY @ XC) @ (cwcel @ (ccfv @ XY @ ccipo) @ ccdrs)) => (cwcel @ (ccuni @ XY) @ XC)))))).
thf(anacsfg_ax,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => (((cwcel @ XC @ (ccfv @ XX @ ccnacs)) & (cwcel @ XS @ XC)) => (cwrex @ (^ [Xg1:$i] : (XS = (ccfv @ (ccv @ Xg1) @ XF))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XX) @ ccfn)))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(amrefg2_ax,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => ((cwcel @ XC @ (ccfv @ XX @ ccmre)) => ((cwrex @ (^ [Xg1:$i] : (XS = (ccfv @ (ccv @ Xg1) @ XF))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XX) @ ccfn))) <=> (cwrex @ (^ [Xg1:$i] : (XS = (ccfv @ (ccv @ Xg1) @ XF))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XS) @ ccfn))))))))))).
...
thf(afissuni_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ (ccuni @ XB2)) & (cwcel @ XA2 @ ccfn)) => (cwrex @ (^ [Xc:$i] : (cwss @ XA2 @ (ccuni @ (ccv @ Xc)))) @ (^ [Xc:$i] : (ccin @ (ccpw @ XB2) @ ccfn))))))).
...
thf(aipodrsfi_ax,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ (ccfv @ XA2 @ ccipo) @ ccdrs) @ (cwss @ XX @ XA2) @ (cwcel @ XX @ ccfn)) => (cwrex @ (^ [Xz:$i] : (cwss @ (ccuni @ XX) @ (ccv @ Xz))) @ (^ [Xz:$i] : XA2)))))).
...
thf(aisacs3_ax,axiom,(! [XC:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XC @ (ccfv @ XX @ ccacs)) <=> ((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwral @ (^ [Xs1:$i] : ((cwcel @ (ccfv @ (ccv @ Xs1) @ ccipo) @ ccdrs) => (cwcel @ (ccuni @ (ccv @ Xs1)) @ XC))) @ (^ [Xs1:$i] : (ccpw @ XC)))))))).
...
thf(afpwipodrs_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwcel @ (ccfv @ (ccin @ (ccpw @ XA2) @ ccfn) @ ccipo) @ ccdrs))))).
...
thf(aisnacs_ax,axiom,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => ((cwcel @ XC @ (ccfv @ XX @ ccnacs)) <=> ((cwcel @ XC @ (ccfv @ XX @ ccacs)) & (cwral @ (^ [Xs1:$i] : (cwrex @ (^ [Xg1:$i] : ((ccv @ Xs1) = (ccfv @ (ccv @ Xg1) @ XF))) @ (^ [Xg1:$i] : (ccin @ (ccpw @ XX) @ ccfn)))) @ (^ [Xs1:$i] : XC))))))))).
thf(cisnacs3_conj,conjecture,(! [XC:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XC @ (ccfv @ XX @ ccnacs)) <=> ((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwral @ (^ [Xs1:$i] : ((cwcel @ (ccfv @ (ccv @ Xs1) @ ccipo) @ ccdrs) => (cwcel @ (ccuni @ (ccv @ Xs1)) @ (ccv @ Xs1)))) @ (^ [Xs1:$i] : (ccpw @ XC)))))))).
