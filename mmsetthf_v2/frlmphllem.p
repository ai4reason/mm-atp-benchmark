...
thf(asuppofss1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3)))) => ((Xph => (cwcel @ XZ @ XB2)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwf @ XA2 @ XB2 @ XG)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => ((cco @ XZ @ (ccv @ Xx3) @ XX) = XZ))) => (Xph => (cwss @ (cco @ (cco @ XF @ XG @ (ccof @ XX)) @ XZ @ ccsupp) @ (cco @ XF @ XZ @ ccsupp))))))))))))))))).
...
thf(cfrlmphllem_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xh:$i] : (! [Xc_xi:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_as:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XY = (cco @ XR @ XI @ ccfrlm)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XV = (ccfv @ XY @ ccbs)) => ((Xc_xi = (ccfv @ XY @ ccip)) => ((! [Xx3:$i] : ((XO @ Xx3) = (ccfv @ XY @ cc0g))) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((! [Xg1:$i] : ((Xc_as @ Xg1) = (ccfv @ XR @ ccstv))) => ((Xph => (cwcel @ XR @ ccfield)) => ((! [Xx3:$i] : (! [Xg1:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xg1) @ XV) @ ((cco @ (ccv @ Xg1) @ (ccv @ Xg1) @ Xc_xi) = Xc_0)) => ((ccv @ Xg1) = (XO @ Xx3))))) => ((! [Xx3:$i] : (! [Xg1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => ((ccfv @ (ccv @ Xx3) @ (Xc_as @ Xg1)) = (ccv @ Xx3))))) => ((Xph => (cwcel @ XI @ XW)) => (! [Xg1:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xg1) @ XV) @ (cwcel @ (ccv @ Xh) @ XV)) => (cwbr @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xh)) @ Xc_x))) @ Xc_0 @ ccfsupp))))))))))))))))))))))))))))).
