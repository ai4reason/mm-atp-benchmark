...
thf(cdffr2_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwfr @ XA2 @ XR) <=> (! [Xx3:$i] : (((cwss @ (ccv @ Xx3) @ XA2) & (cwne @ (ccv @ Xx3) @ cc0)) => (cwrex @ (^ [Xy1:$i] : ((ccrab @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ XR)) @ (^ [Xz:$i] : (ccv @ Xx3))) = cc0)) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))).
