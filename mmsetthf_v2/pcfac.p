...
thf(aolcs_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph | Xps) => Xch) => (Xps => Xch)))))).
...
thf(apcfaclem_ax,axiom,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XM @ (ccfv @ XN @ ccuz)) @ (cwcel @ XP @ ccprime)) => ((ccfv @ (cco @ XN @ (cco @ XP @ XM @ ccexp) @ ccdiv) @ ccfl) = ccc0)))))).
...
thf(apc1_ax,axiom,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprime) => ((cco @ XP @ cc1 @ ccpc) = ccc0)))).
...
thf(afldivp1_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccn)) => ((cco @ (ccfv @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XN @ ccdiv) @ ccfl) @ (ccfv @ (cco @ XM @ XN @ ccdiv) @ ccfl) @ ccmin) = (ccif @ (cwbr @ XN @ (cco @ XM @ cc1 @ ccaddc) @ ccdvds) @ cc1 @ ccc0)))))).
...
thf(amt4d_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => ((~ Xch) => (~ Xps))) => (Xph => Xch))))))).
...
thf(cpcfac_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XM @ (ccfv @ XN @ ccuz)) @ (cwcel @ XP @ ccprime)) => ((cco @ XP @ (ccfv @ XN @ ccfa) @ ccpc) = (ccsu @ (cco @ cc1 @ XM @ ccfz) @ (^ [Xk:$i] : (ccfv @ (cco @ XN @ (cco @ XP @ (ccv @ Xk) @ ccexp) @ ccdiv) @ ccfl))))))))).
