...
thf(cxmstri2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XM @ ccbs)) => ((XD = (ccfv @ XM @ ccds)) => (((cwcel @ XM @ ccxme) & (cw3a @ (cwcel @ XC @ XX) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX))) => (cwbr @ (cco @ XA2 @ XB2 @ XD) @ (cco @ (cco @ XC @ XA2 @ XD) @ (cco @ XC @ XB2 @ XD) @ ccxad) @ ccle))))))))))).
