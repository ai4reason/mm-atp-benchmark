...
thf(alsateln0_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XW @ cc0g)) => ((! [Xv:$i] : ((XA2 @ Xv) = (ccfv @ XW @ cclsa))) => ((Xph => (cwcel @ XW @ cclmod)) => ((! [Xv:$i] : (Xph => (cwcel @ XU @ (XA2 @ Xv)))) => (Xph => (cwrex @ (^ [Xv:$i] : (cwne @ (ccv @ Xv) @ Xc_0)) @ (^ [Xv:$i] : XU))))))))))))).
...
thf(adochkrsat2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((Xc_pe = (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((XA2 = (ccfv @ XU @ cclsa)) => ((XF = (ccfv @ XU @ cclfn)) => ((XL = (ccfv @ XU @ cclk)) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XG @ XF)) => (Xph => ((cwne @ (ccfv @ (ccfv @ (ccfv @ XG @ XL) @ Xc_pe) @ Xc_pe) @ XV) <=> (cwcel @ (ccfv @ (ccfv @ XG @ XL) @ Xc_pe) @ XA2)))))))))))))))))))))))).
...
thf(adochfln0_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((Xc_pe = (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((XR = (ccfv @ XU @ ccsca)) => ((XN = (ccfv @ XR @ cc0g)) => ((Xc_0 = (ccfv @ XU @ cc0g)) => ((XF = (ccfv @ XU @ cclfn)) => ((XL = (ccfv @ XU @ cclk)) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XG @ XF)) => ((Xph => (cwcel @ XX @ (ccdif @ (ccfv @ (ccfv @ XG @ XL) @ Xc_pe) @ (ccsn @ Xc_0)))) => (Xph => (cwne @ (ccfv @ XX @ XG) @ XN))))))))))))))))))))))))))))).
...
thf(adrnginvrn0_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XI = (ccfv @ XR @ ccinvr)) => ((cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XX @ XB2) @ (cwne @ XX @ Xc_0)) => (cwne @ (ccfv @ XX @ XI) @ Xc_0))))))))))).
...
thf(alvecvsn0_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((XO = (ccfv @ XF @ cc0g)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((Xph => (cwcel @ XW @ cclvec)) => ((Xph => (cwcel @ XA2 @ XK)) => ((Xph => (cwcel @ XX @ XV)) => (Xph => ((cwne @ (cco @ XA2 @ XX @ Xc_x) @ Xc_0) <=> ((cwne @ XA2 @ XO) & (cwne @ XX @ Xc_0)))))))))))))))))))))))).
...
thf(cdochkr1_conj,conjecture,(! [Xph:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : ((XH @ Xx3) = (ccfv @ (XK @ Xx3) @ cclh))) => ((! [Xx3:$i] : (Xc_pe = (ccfv @ (XW @ Xx3) @ (ccfv @ (XK @ Xx3) @ ccoch)))) => ((! [Xx3:$i] : (XU = (ccfv @ (XW @ Xx3) @ (ccfv @ (XK @ Xx3) @ ccdvh)))) => ((! [Xx3:$i] : ((XV @ Xx3) = (ccfv @ XU @ ccbs))) => ((XR = (ccfv @ XU @ ccsca)) => ((Xc_0 = (ccfv @ XU @ cc0g)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccfv @ XU @ cclfn))) => ((XL = (ccfv @ XU @ cclk)) => ((! [Xx3:$i] : ((Xph @ Xx3) => ((cwcel @ (XK @ Xx3) @ cchlt) & (cwcel @ (XW @ Xx3) @ (XH @ Xx3))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XG @ (XF @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwne @ (ccfv @ (ccfv @ (ccfv @ XG @ XL) @ Xc_pe) @ Xc_pe) @ (XV @ Xx3)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XG) = Xc_1)) @ (^ [Xx3:$i] : (ccdif @ (ccfv @ (ccfv @ XG @ XL) @ Xc_pe) @ (ccsn @ Xc_0)))))))))))))))))))))))))))))))).
