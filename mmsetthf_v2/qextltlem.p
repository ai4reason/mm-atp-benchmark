...
thf(cqextltlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwbr @ XA2 @ XB2 @ cclt) => (cwrex @ (^ [Xx3:$i] : ((~ ((cwbr @ (ccv @ Xx3) @ XA2 @ cclt) <=> (cwbr @ (ccv @ Xx3) @ XB2 @ cclt))) & (~ ((cwbr @ (ccv @ Xx3) @ XA2 @ ccle) <=> (cwbr @ (ccv @ Xx3) @ XB2 @ ccle))))) @ (^ [Xx3:$i] : ccq))))))).
