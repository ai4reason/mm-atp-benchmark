...
thf(afldivnn0le_ax,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (((cwcel @ XK @ ccn0) & (cwcel @ XL @ ccn)) => (cwbr @ (ccfv @ (cco @ XK @ XL @ ccdiv) @ ccfl) @ (cco @ XK @ XL @ ccdiv) @ ccle))))).
...
thf(cflltdivnn0lt_conj,conjecture,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccn0) @ (cwcel @ XN @ ccn0) @ (cwcel @ XL @ ccn)) => ((cwbr @ XK @ XN @ cclt) => (cwbr @ (ccfv @ (cco @ XK @ XL @ ccdiv) @ ccfl) @ (cco @ XN @ XL @ ccdiv) @ cclt))))))).
