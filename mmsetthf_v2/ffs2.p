...
thf(cffs2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XC = (ccdif @ XB2 @ (ccsn @ XZ))) => ((cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XZ @ XW) @ (cwf @ XA2 @ XB2 @ XF)) => ((cco @ XF @ XZ @ ccsupp) = (ccima @ (cccnv @ XF) @ XC)))))))))))).
