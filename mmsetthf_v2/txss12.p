...
thf(atgss_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XC @ XV) & (cwss @ XB2 @ XC)) => (cwss @ (ccfv @ XB2 @ cctg) @ (ccfv @ XC @ cctg))))))).
...
thf(ctxss12_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((((cwcel @ XB2 @ XV) & (cwcel @ XD @ XW)) & ((cwss @ XA2 @ XB2) & (cwss @ XC @ XD))) => (cwss @ (cco @ XA2 @ XC @ cctx) @ (cco @ XB2 @ XD @ cctx)))))))))).
