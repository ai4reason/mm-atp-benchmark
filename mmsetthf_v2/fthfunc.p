...
thf(adf_fth_ax,axiom,(ccfth = (ccmpt2 @ (^ [Xc:$i] : (^ [Xd:$i] : cccat)) @ (^ [Xc:$i] : (^ [Xd:$i] : cccat)) @ (^ [Xc:$i] : (^ [Xd:$i] : (ccopab @ (^ [Xf1:$i] : (^ [Xg1:$i] : ((cwbr @ (ccv @ Xf1) @ (ccv @ Xg1) @ (cco @ (ccv @ Xc) @ (ccv @ Xd) @ ccfunc)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwfun @ (cccnv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xg1))))) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xc) @ ccbs)))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xc) @ ccbs)))))))))))).
...
thf(cfthfunc_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (cwss @ (cco @ XC @ XD @ ccfth) @ (cco @ XC @ XD @ ccfunc))))).
