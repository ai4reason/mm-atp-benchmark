...
thf(adf_irred_ax,axiom,(ccir = (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccsb @ (ccdif @ (ccfv @ (ccv @ Xw) @ ccbs) @ (ccfv @ (ccv @ Xw) @ ccui)) @ (^ [Xb:$i] : (ccrab @ (^ [Xz:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwne @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xw) @ ccmulr)) @ (ccv @ Xz))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xb)))) @ (^ [Xz:$i] : (ccv @ Xb))))))))).
...
thf(cisirred_conj,conjecture,(! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xx3 @ Xy1) = (ccfv @ XR @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XU @ Xx3 @ Xy1) = (ccfv @ XR @ ccui)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XI @ Xx3 @ Xy1) = (ccfv @ XR @ ccir)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XN = (ccdif @ (XB2 @ Xx3 @ Xy1) @ (XU @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_x @ Xx3 @ Xy1) = (ccfv @ XR @ ccmulr)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XX @ (XI @ Xx3 @ Xy1)) <=> ((cwcel @ XX @ XN) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwne @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_x @ Xx3 @ Xy1)) @ XX)) @ (^ [Xy1:$i] : XN))) @ (^ [Xx3:$i] : XN))))))))))))))))))).
