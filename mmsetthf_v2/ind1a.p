...
thf(aindfval_ax,axiom,(! [XA2:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XO @ XV) @ (cwss @ XA2 @ XO) @ (cwcel @ XX @ XO)) => ((ccfv @ XX @ (ccfv @ XA2 @ (ccfv @ XO @ ccind))) = (ccif @ (cwcel @ XX @ XA2) @ cc1 @ ccc0)))))))).
...
thf(cind1a_conj,conjecture,(! [XA2:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XO @ XV) @ (cwss @ XA2 @ XO) @ (cwcel @ XX @ XO)) => (((ccfv @ XX @ (ccfv @ XA2 @ (ccfv @ XO @ ccind))) = cc1) <=> (cwcel @ XX @ XA2)))))))).
