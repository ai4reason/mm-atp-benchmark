...
thf(ainitoeu2lem1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_op:($i > $o)] : ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XC @ ccinito))) => ((XX = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => ((XI = (ccfv @ XC @ cciso)) => ((Xc_op = (ccfv @ XC @ ccco)) => ((cw3a @ Xph @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XD @ XX)) @ ((cwcel @ XK @ (cco @ XB2 @ XA2 @ XI)) & (cwcel @ (cco @ XF @ XK @ (cco @ (ccop @ XB2 @ XA2) @ XD @ Xc_op)) @ (cco @ XB2 @ XD @ XH)))) => ((cw3a @ (cweu @ (^ [Xf1:$i] : (cwcel @ (ccv @ Xf1) @ (cco @ XA2 @ XD @ XH)))) @ (cwcel @ XF @ (cco @ XA2 @ XD @ XH)) @ (cwcel @ XG @ (cco @ XB2 @ XD @ XH))) => (XG = (cco @ XF @ XK @ (cco @ (ccop @ XB2 @ XA2) @ XD @ Xc_op)))))))))))))))))))))))).
...
thf(cinitoeu2lem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_op:($i > $o)] : ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XC @ ccinito))) => ((XX = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => ((XI = (ccfv @ XC @ cciso)) => ((Xc_op = (ccfv @ XC @ ccco)) => ((cw3a @ Xph @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XD @ XX)) @ (cw3a @ (cwcel @ XK @ (cco @ XB2 @ XA2 @ XI)) @ (cwcel @ XF @ (cco @ XA2 @ XD @ XH)) @ (cwcel @ (cco @ XF @ XK @ (cco @ (ccop @ XB2 @ XA2) @ XD @ Xc_op)) @ (cco @ XB2 @ XD @ XH)))) => ((cweu @ (^ [Xf1:$i] : (cwcel @ (ccv @ Xf1) @ (cco @ XA2 @ XD @ XH)))) => (cweu @ (^ [Xg1:$i] : (cwcel @ (ccv @ Xg1) @ (cco @ XB2 @ XD @ XH)))))))))))))))))))))))).
