...
thf(cabs3dif_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) => (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ (cco @ (ccfv @ (cco @ XA2 @ XC @ ccmin) @ ccabs) @ (ccfv @ (cco @ XC @ XB2 @ ccmin) @ ccabs) @ ccaddc) @ ccle)))))).
