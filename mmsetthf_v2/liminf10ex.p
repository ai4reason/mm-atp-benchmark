...
thf(aliminfval5_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XA2 @ Xk) @ (XV @ Xk)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwf @ (XA2 @ Xk) @ ccxr @ XF))) => ((! [Xk:$i] : ((XG @ Xk) = (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccinf @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr @ cclt))))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccfv @ XF @ cclsi) = (ccsup @ (ccrn @ (XG @ Xk)) @ ccxr @ cclt)))))))))))))).
...
thf(alimsup10exlem_ax,axiom,(! [Xph:$o] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwbr @ cc2 @ (ccv @ Xn) @ ccdvds) @ ccc0 @ cc1))))) => ((Xph => (cwcel @ XK @ ccr)) => (! [Xn:$i] : (Xph => ((ccima @ (XF @ Xn) @ (cco @ XK @ ccpnf @ ccico)) = (ccpr @ ccc0 @ cc1)))))))))).
...
thf(ainfpr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((cw3a @ (cwor @ XA2 @ XR) @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2)) => ((ccinf @ (ccpr @ XB2 @ XC) @ XA2 @ XR) = (ccif @ (cwbr @ XB2 @ XC @ XR) @ XB2 @ XC)))))))).
