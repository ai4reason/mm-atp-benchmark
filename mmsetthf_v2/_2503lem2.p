...
thf(a_8t3e24_ax,axiom,((cco @ cc8 @ cc3 @ ccmul) = (ccdc @ cc2 @ cc4))).
...
thf(c_2503lem2_conj,conjecture,(! [XN:($i > $o)] : ((XN = (ccdc @ (ccdc @ (ccdc @ cc2 @ cc5) @ ccc0) @ cc3)) => ((cco @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ XN @ ccmo) = (cco @ cc1 @ XN @ ccmo))))).
