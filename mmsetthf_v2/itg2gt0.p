...
thf(aitg2const2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ XB2 @ ccrp)) => ((cwcel @ (ccfv @ XA2 @ ccvol) @ ccr) <=> (cwcel @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ XB2 @ ccc0))) @ ccitg2) @ ccr)))))).
