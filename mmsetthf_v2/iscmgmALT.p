...
thf(ciscmgmALT_conj,conjecture,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_op:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_op = (ccfv @ XM @ ccplusg)) => ((cwcel @ XM @ cccmgm2) <=> ((cwcel @ XM @ ccmgm2) & (cwbr @ Xc_op @ XB2 @ cccomlaw))))))))).
