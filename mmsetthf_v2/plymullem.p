...
thf(afsumcllem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : ((Xph => (cwss @ XS @ ccc)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccaddc) @ XS)))) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ XS))) => ((Xph => (cwcel @ ccc0 @ XS)) => (Xph => (cwcel @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ XS)))))))))))).
...
thf(aun0mulcl_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwss @ XS @ ccc)) => ((XT = (ccun @ XS @ (ccsn @ ccc0))) => (((Xph & ((cwcel @ XM @ XS) & (cwcel @ XN @ XS))) => (cwcel @ (cco @ XM @ XN @ ccmul) @ XS)) => ((Xph & ((cwcel @ XM @ XT) & (cwcel @ XN @ XT))) => (cwcel @ (cco @ XM @ XN @ ccmul) @ XT))))))))))).
