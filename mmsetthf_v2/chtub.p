...
thf(achtfl_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ (ccfv @ XA2 @ ccfl) @ cccht) = (ccfv @ XA2 @ cccht))))).
...
thf(achtublem_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => (cwbr @ (ccfv @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccmin) @ cccht) @ (cco @ (ccfv @ XN @ cccht) @ (cco @ (ccfv @ cc4 @ cclog) @ (cco @ XN @ cc1 @ ccmin) @ ccmul) @ ccaddc) @ ccle)))).
...
thf(achtnprm_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (~ (cwcel @ (cco @ XA2 @ cc1 @ ccaddc) @ ccprime))) => ((ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cccht) = (ccfv @ XA2 @ cccht))))).
...
thf(cchtub_conj,conjecture,(! [XN:($i > $o)] : (((cwcel @ XN @ ccr) & (cwbr @ cc2 @ XN @ cclt)) => (cwbr @ (ccfv @ XN @ cccht) @ (cco @ (ccfv @ cc2 @ cclog) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc3 @ ccmin) @ ccmul) @ cclt)))).
