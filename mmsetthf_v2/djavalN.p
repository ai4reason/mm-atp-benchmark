...
thf(cdjavalN_conj,conjecture,(! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdia))) => ((Xc_pe = (ccfv @ XW @ (ccfv @ XK @ ccocaN))) => ((XJ = (ccfv @ XW @ (ccfv @ XK @ ccdjaN))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwss @ XX @ XT) & (cwss @ XY @ XT))) => ((cco @ XX @ XY @ XJ) = (ccfv @ (ccin @ (ccfv @ XX @ Xc_pe) @ (ccfv @ XY @ Xc_pe)) @ Xc_pe)))))))))))))))))).
