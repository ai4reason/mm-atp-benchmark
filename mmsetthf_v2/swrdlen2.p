...
thf(cswrdlen2_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XS @ (ccword @ XV)) @ ((cwcel @ XF @ ccn0) & (cwcel @ XL @ (ccfv @ XF @ ccuz))) @ (cwbr @ XL @ (ccfv @ XS @ cchash) @ ccle)) => ((ccfv @ (cco @ XS @ (ccop @ XF @ XL) @ ccsubstr) @ cchash) = (cco @ XL @ XF @ ccmin)))))))).
