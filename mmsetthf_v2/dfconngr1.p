...
thf(adf_conngr_ax,axiom,(ccconngr = (ccab @ (^ [Xg1:$i] : (cwsbc @ (^ [Xv:$i] : (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xn:$i] : (? [Xf1:$i] : (? [Xp:$i] : (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (cco @ (ccv @ Xk) @ (ccv @ Xn) @ (ccfv @ (ccv @ Xg1) @ ccpthson)))))) @ (^ [Xn:$i] : (ccv @ Xv)))) @ (^ [Xk:$i] : (ccv @ Xv)))) @ (ccfv @ (ccv @ Xg1) @ ccvtx)))))).
...
thf(a_0pthonv_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xp:$i] : ((XV @ Xf1 @ Xp) = (ccfv @ XG @ ccvtx)))) => (! [Xf1:$i] : (! [Xp:$i] : ((cwcel @ XN @ (XV @ Xf1 @ Xp)) => (? [Xf1:$i] : (? [Xp:$i] : (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (cco @ XN @ XN @ (ccfv @ XG @ ccpthson))))))))))))).
...
thf(asbcbi1_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [Xx3:$i] : ((cwsbc @ (^ [Xx3:$i] : ((Xph @ Xx3) <=> (Xps @ Xx3))) @ (XA2 @ Xx3)) => ((cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (XA2 @ Xx3)) <=> (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (XA2 @ Xx3))))))))).
thf(cdfconngr1_conj,conjecture,(ccconngr = (ccab @ (^ [Xg1:$i] : (cwsbc @ (^ [Xv:$i] : (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xn:$i] : (? [Xf1:$i] : (? [Xp:$i] : (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (cco @ (ccv @ Xk) @ (ccv @ Xn) @ (ccfv @ (ccv @ Xg1) @ ccpthson)))))) @ (^ [Xn:$i] : (ccdif @ (ccv @ Xv) @ (ccsn @ (ccv @ Xk)))))) @ (^ [Xk:$i] : (ccv @ Xv)))) @ (ccfv @ (ccv @ Xg1) @ ccvtx)))))).
