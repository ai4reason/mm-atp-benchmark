...
thf(clcdvsub_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XS = (ccfv @ XU @ ccsca)) => ((XN = (ccfv @ XS @ ccminusg)) => ((Xc_1 = (ccfv @ XS @ ccur)) => ((XC = (ccfv @ XW @ (ccfv @ XK @ cclcd))) => ((XV = (ccfv @ XC @ ccbs)) => ((Xc_pl = (ccfv @ XC @ ccplusg)) => ((Xc_x = (ccfv @ XC @ ccvsca)) => ((Xc_mi = (ccfv @ XC @ ccsg)) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XF @ XV)) => ((Xph => (cwcel @ XG @ XV)) => (Xph => ((cco @ XF @ XG @ Xc_mi) = (cco @ XF @ (cco @ (ccfv @ Xc_1 @ XN) @ XG @ Xc_x) @ Xc_pl)))))))))))))))))))))))))))))))).
