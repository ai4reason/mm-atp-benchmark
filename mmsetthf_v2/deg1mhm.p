...
thf(aply1domn_ax,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((cwcel @ XR @ ccdomn) => (cwcel @ XP @ ccdomn)))))).
thf(asimprbi_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph <=> (Xps & Xch)) => (Xph => Xch)))))).
thf(aisdomn3_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XU = (ccfv @ XR @ ccmgp)) => ((cwcel @ XR @ ccdomn) <=> ((cwcel @ XR @ ccrg) & (cwcel @ (ccdif @ XB2 @ (ccsn @ Xc_0)) @ (ccfv @ XU @ ccsubmnd)))))))))))).
...
thf(adeg1ldgdomn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XE = (ccfv @ XR @ ccrlreg)) => ((XA2 = (ccfv @ XF @ ccco1)) => ((cw3a @ (cwcel @ XR @ ccdomn) @ (cwcel @ XF @ XB2) @ (cwne @ XF @ Xc_0)) => (cwcel @ (ccfv @ (ccfv @ XF @ XD) @ XA2) @ XE))))))))))))))))).
...
thf(amon1pid_ax,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XM:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_1 = (ccfv @ XP @ ccur)) => ((XM = (ccfv @ XR @ ccmn1)) => ((XD = (ccfv @ XR @ ccdg1)) => ((cwcel @ XR @ ccnzr) => ((cwcel @ Xc_1 @ XM) & ((ccfv @ Xc_1 @ XD) = ccc0))))))))))))).
