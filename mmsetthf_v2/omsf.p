...
thf(afmpt2d_b_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3)))) => ((Xph => (XF = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ XC))) => (Xph => (cwf @ XA2 @ XC @ XF)))))))))))).
...
thf(aomsval_ax,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccvv) => ((ccfv @ XR @ ccoms) = (ccmpt @ (^ [Xa:$i] : (ccpw @ (ccuni @ (ccdm @ XR)))) @ (^ [Xa:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (ccrab @ (^ [Xz:$i] : ((cwss @ (ccv @ Xa) @ (ccuni @ (ccv @ Xz))) & (cwbr @ (ccv @ Xz) @ ccom @ ccdom))) @ (^ [Xz:$i] : (ccpw @ (ccdm @ XR))))) @ (^ [Xx3:$i] : (ccesum @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XR)))))) @ (cco @ ccc0 @ ccpnf @ ccicc) @ cclt))))))).
