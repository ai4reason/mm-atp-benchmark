...
thf(crspceov_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ (cwcel @ XC @ (XA2 @ Xy1)) @ (cwcel @ (XD @ Xx3) @ XB2) @ (XS = (cco @ XC @ (XD @ Xx3) @ XF))) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (XS = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1))))))))))))).
