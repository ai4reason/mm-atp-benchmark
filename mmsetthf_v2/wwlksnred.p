...
thf(aswrdn0_ax,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XN @ ccn) @ (cwbr @ XN @ (ccfv @ XW @ cchash) @ ccle)) => (cwne @ (cco @ XW @ (ccop @ ccc0 @ XN) @ ccsubstr) @ cc0)))))).
...
thf(aswrd0len0_ax,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XN @ ccn0) @ ((ccfv @ XW @ cchash) = (cco @ XN @ cc1 @ ccaddc))) => ((ccfv @ (cco @ XW @ (ccop @ ccc0 @ XN) @ ccsubstr) @ cchash) = XN)))))).
...
thf(cwwlksnred_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cwcel @ XW @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XG @ ccwwlksn)) => (cwcel @ (cco @ XW @ (ccop @ ccc0 @ (cco @ XN @ cc1 @ ccaddc)) @ ccsubstr) @ (cco @ XN @ XG @ ccwwlksn)))))))).
