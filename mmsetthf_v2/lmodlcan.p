...
thf(clmodlcan_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => (((cwcel @ XW @ cclmod) & (cw3a @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV) @ (cwcel @ XZ @ XV))) => (((cco @ XZ @ XX @ Xc_pl) = (cco @ XZ @ XY @ Xc_pl)) <=> (XX = XY)))))))))))).
