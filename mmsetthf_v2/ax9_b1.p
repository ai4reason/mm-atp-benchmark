...
thf(aax9v2_ax,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((cwcel @ (ccv @ Xz) @ (ccv @ Xx3)) => (cwcel @ (ccv @ Xz) @ (ccv @ Xy1)))))))).
thf(aax9v1_b_ax,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)) => (cwcel @ (ccv @ Xy1) @ (ccv @ Xy1))))))).
thf(cax9_b1_conj,conjecture,(! [Xy1:$i] : (! [Xx3:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)) => (cwcel @ (ccv @ Xy1) @ (ccv @ Xy1))))))).
