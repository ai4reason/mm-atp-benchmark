...
thf(aesumnul_ax,axiom,(! [XA2:($i > ($i > $o))] : ((ccesum @ (^ [Xx3:$i] : cc0) @ (^ [Xx3:$i] : (XA2 @ Xx3))) = ccc0))).
...
thf(adisjuniel_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XB2 @ XA2))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XC @ (ccdif @ XA2 @ XB2)))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccin @ (ccuni @ XB2) @ XC) = cc0))))))))))).
