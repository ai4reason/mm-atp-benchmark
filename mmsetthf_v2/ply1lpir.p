...
thf(aig1prsp_ax,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XG = (ccfv @ XR @ ccig1p)) => ((XU = (ccfv @ XP @ cclidl)) => ((XK = (ccfv @ XP @ ccrsp)) => (((cwcel @ XR @ ccdr) & (cwcel @ XI @ XU)) => (XI = (ccfv @ (ccsn @ (ccfv @ XI @ XG)) @ XK)))))))))))))).
