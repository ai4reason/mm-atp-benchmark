...
thf(ckmlem11_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xu:$i] : (! [Xt:$i] : ((XA2 @ Xx3 @ Xu @ Xt) = (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xt:$i] : ((ccv @ Xu) = (ccdif @ (ccv @ Xt) @ (ccuni @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xt))))))) @ (^ [Xt:$i] : (ccv @ Xx3))))))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xt:$i] : ((cwcel @ (ccv @ Xz) @ (ccv @ Xx3)) => ((ccin @ (ccv @ Xz) @ (ccuni @ (XA2 @ Xx3 @ Xu @ Xt))) = (ccdif @ (ccv @ Xz) @ (ccuni @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xz)))))))))))))).
