...
thf(aafvfv0bi_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((ccfv @ XA2 @ XF) = cc0) <=> (((ccafv @ XA2 @ XF) = cc0) | ((ccafv @ XA2 @ XF) = ccvv)))))).
...
thf(caovov0bi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cco @ XA2 @ XB2 @ XF) = cc0) <=> (((ccaov @ XA2 @ XB2 @ XF) = cc0) | ((ccaov @ XA2 @ XB2 @ XF) = ccvv))))))).
