...
thf(ccoprmdvds2_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwcel @ XK @ ccz)) & ((cco @ XM @ XN @ ccgcd) = cc1)) => (((cwbr @ XM @ XK @ ccdvds) & (cwbr @ XN @ XK @ ccdvds)) => (cwbr @ (cco @ XM @ XN @ ccmul) @ XK @ ccdvds))))))).
