...
thf(aiccssioo_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & ((cwbr @ XA2 @ XC @ cclt) & (cwbr @ XD @ XB2 @ cclt))) => (cwss @ (cco @ XC @ XD @ ccicc) @ (cco @ XA2 @ XB2 @ ccioo)))))))).
...
thf(aditgeq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : ((XA2 = XB2) => ((ccdit @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XD @ Xx3))) = (ccdit @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XD @ Xx3)))))))))).
thf(aditgex_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (cwcel @ (ccdit @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3))) @ ccvv))))).
thf(aditgsplit_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XX @ ccr)) => ((Xph => (cwcel @ XY @ ccr)) => ((Xph => (cwcel @ XA2 @ (cco @ XX @ XY @ ccicc))) => ((Xph => (cwcel @ XB2 @ (cco @ XX @ XY @ ccicc))) => ((Xph => (cwcel @ XC @ (cco @ XX @ XY @ ccicc))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XX @ XY @ ccioo))) => (cwcel @ (XD @ Xx3) @ XV))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ XX @ XY @ ccioo)) @ (^ [Xx3:$i] : (XD @ Xx3))) @ ccibl)) => (Xph => ((ccdit @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (XD @ Xx3))) = (cco @ (ccdit @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XD @ Xx3))) @ (ccdit @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (XD @ Xx3))) @ ccaddc))))))))))))))))))).
