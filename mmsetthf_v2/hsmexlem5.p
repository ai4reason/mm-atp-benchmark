...
thf(aitunitc_ax,axiom,(! [XA2:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XU @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccres @ (ccrdg @ (ccmpt @ (^ [Xy1:$i] : ccvv) @ (^ [Xy1:$i] : (ccuni @ (ccv @ Xy1)))) @ (ccv @ Xx3)) @ ccom)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((ccfv @ XA2 @ cctc) = (ccuni @ (ccrn @ (ccfv @ XA2 @ (XU @ Xx3 @ Xy1))))))))))).
...
thf(aoiid_ax,axiom,(! [XA2:($i > $o)] : ((cword @ XA2) => ((ccoi @ XA2 @ ccep) = (ccres @ ccid @ XA2))))).
