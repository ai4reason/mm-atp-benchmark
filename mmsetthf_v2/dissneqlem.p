...
thf(amptsnun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xu:$i] : ((XF @ Xx3 @ Xu) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccsn @ (ccv @ Xx3))))))) => ((! [Xx3:$i] : (! [Xu:$i] : ((XR @ Xx3 @ Xu) = (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xu) = (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2))))))) => (! [Xx3:$i] : (! [Xu:$i] : ((cwss @ XB2 @ XA2) => (XB2 = (ccuni @ (ccima @ (XF @ Xx3 @ Xu) @ XB2))))))))))))).
...
thf(cdissneqlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xu:$i] : ((XC @ Xu) = (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xu) = (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2)))))) => (! [Xu:$i] : (((cwss @ (XC @ Xu) @ (XB2 @ Xu)) & (cwcel @ (XB2 @ Xu) @ (ccfv @ XA2 @ cctopon))) => ((XB2 @ Xu) = (ccpw @ XA2))))))))).
