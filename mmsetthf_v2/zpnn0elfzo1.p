...
thf(azpnn0elfzo_ax,axiom,(! [XN:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XZ @ ccz) & (cwcel @ XN @ ccn0)) => (cwcel @ (cco @ XZ @ XN @ ccaddc) @ (cco @ XZ @ (cco @ (cco @ XZ @ XN @ ccaddc) @ cc1 @ ccaddc) @ ccfzo)))))).
...
thf(czpnn0elfzo1_conj,conjecture,(! [XN:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XZ @ ccz) & (cwcel @ XN @ ccn0)) => (cwcel @ (cco @ XZ @ XN @ ccaddc) @ (cco @ XZ @ (cco @ XZ @ (cco @ XN @ cc1 @ ccaddc) @ ccaddc) @ ccfzo)))))).
