...
thf(cmodmul1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cw3a @ ((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) @ ((cwcel @ XC @ ccz) & (cwcel @ XD @ ccrp)) @ ((cco @ XA2 @ XD @ ccmo) = (cco @ XB2 @ XD @ ccmo))) => ((cco @ (cco @ XA2 @ XC @ ccmul) @ XD @ ccmo) = (cco @ (cco @ XB2 @ XC @ ccmul) @ XD @ ccmo)))))))).
