...
thf(axmetdcn_ax,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((XK = (ccfv @ ccle @ ccordt)) => ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => (cwcel @ XD @ (cco @ (cco @ XJ @ XJ @ cctx) @ XK @ cccn)))))))))).
...
thf(cmetdcn2_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((XK = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((cwcel @ XD @ (ccfv @ XX @ ccme)) => (cwcel @ XD @ (cco @ (cco @ XJ @ XJ @ cctx) @ XK @ cccn)))))))))).
