...
thf(alnophmi_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => ((cwral @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ XT) @ ccsp) @ ccr)) @ (^ [Xx3:$i] : cchil)) => (cwcel @ XT @ ccho))))).
...
thf(clnophm_conj,conjecture,(! [XT:($i > $o)] : (((cwcel @ XT @ cclo) & (cwral @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ XT) @ ccsp) @ ccr)) @ (^ [Xx3:$i] : cchil))) => (cwcel @ XT @ ccho)))).
