...
thf(cchebbnd1lem2_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (ccfv @ (cco @ XN @ cc2 @ ccdiv) @ ccfl)) => (((cwcel @ XN @ ccr) & (cwbr @ cc8 @ XN @ ccle)) => (cwbr @ (cco @ (ccfv @ (cco @ cc2 @ XM @ ccmul) @ cclog) @ (cco @ cc2 @ XM @ ccmul) @ ccdiv) @ (cco @ cc2 @ (cco @ (ccfv @ XN @ cclog) @ XN @ ccdiv) @ ccmul) @ cclt)))))).
