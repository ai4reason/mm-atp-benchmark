...
thf(agsumlsscl_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((XS = (ccfv @ XM @ cclss)) => ((XR = (ccfv @ XM @ ccsca)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((cw3a @ (cwcel @ XM @ cclmod) @ (cwcel @ XZ @ XS) @ (cwss @ XV @ XZ)) => (((cwcel @ XF @ (cco @ XB2 @ XV @ ccmap)) & (cwbr @ XF @ (ccfv @ XR @ cc0g) @ ccfsupp)) => (cwcel @ (cco @ XM @ (ccmpt @ (^ [Xv:$i] : XV) @ (^ [Xv:$i] : (cco @ (ccfv @ (ccv @ Xv) @ XF) @ (ccv @ Xv) @ (ccfv @ XM @ ccvsca)))) @ ccgsu) @ XZ)))))))))))))).
thf(clincellss_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XM @ cclmod) @ (cwcel @ XS @ (ccfv @ XM @ cclss)) @ (cwss @ XV @ XS)) => (((cwcel @ XF @ (cco @ (ccfv @ (ccfv @ XM @ ccsca) @ ccbs) @ XV @ ccmap)) & (cwbr @ XF @ (ccfv @ (ccfv @ XM @ ccsca) @ cc0g) @ ccfsupp)) => (cwcel @ (cco @ XF @ XV @ (ccfv @ XM @ cclinc)) @ XS)))))))).
