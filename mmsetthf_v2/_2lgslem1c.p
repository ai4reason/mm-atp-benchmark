...
thf(aoddnn02np1_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((~ (cwbr @ cc2 @ XN @ ccdvds)) <=> (cwrex @ (^ [Xn:$i] : ((cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) = XN)) @ (^ [Xn:$i] : ccn0)))))).
...
thf(ann0ledivnn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn0) & (cwcel @ XB2 @ ccn)) => (cwbr @ (cco @ XA2 @ XB2 @ ccdiv) @ XA2 @ ccle))))).
...
thf(aflodddiv4_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (XN = (cco @ (cco @ cc2 @ XM @ ccmul) @ cc1 @ ccaddc))) => ((ccfv @ (cco @ XN @ cc4 @ ccdiv) @ ccfl) = (ccif @ (cwbr @ cc2 @ XM @ ccdvds) @ (cco @ XM @ cc2 @ ccdiv) @ (cco @ (cco @ XM @ cc1 @ ccmin) @ cc2 @ ccdiv))))))).
...
thf(c_2lgslem1c_conj,conjecture,(! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (~ (cwbr @ cc2 @ XP @ ccdvds))) => (cwbr @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccle)))).
