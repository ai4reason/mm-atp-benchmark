...
thf(cblssec_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((Xc_sm = (ccima @ (cccnv @ XD) @ ccr)) => ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX) @ (cwcel @ XS @ ccxr)) => (cwss @ (cco @ XP @ XS @ (ccfv @ XD @ ccbl)) @ (ccec @ XP @ Xc_sm)))))))))).
