...
thf(amul0ori_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => (((cco @ XA2 @ XB2 @ ccmul) = ccc0) <=> ((XA2 = ccc0) | (XB2 = ccc0)))))))).
...
thf(csqeqori_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => (((cco @ XA2 @ cc2 @ ccexp) = (cco @ XB2 @ cc2 @ ccexp)) <=> ((XA2 = XB2) | (XA2 = (ccneg @ XB2))))))))).
