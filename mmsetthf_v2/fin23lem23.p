...
thf(afin23lem26_ax,axiom,(! [XS:($i > $o)] : (! [Xi:$i] : ((((cwss @ XS @ ccom) & (~ (cwcel @ XS @ ccfn))) & (cwcel @ (ccv @ Xi) @ ccom)) => (cwrex @ (^ [Xj:$i] : (cwbr @ (ccin @ (ccv @ Xj) @ XS) @ (ccv @ Xi) @ ccen)) @ (^ [Xj:$i] : XS)))))).
...
thf(afin23lem25_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XB2 @ ccfn) @ ((cwss @ XA2 @ XB2) | (cwss @ XB2 @ XA2))) => ((cwbr @ XA2 @ XB2 @ ccen) <=> (XA2 = XB2)))))).
thf(ampanl1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (Xph => ((((Xph & Xps) & Xch) => Xth) => ((Xps & Xch) => Xth)))))))).
thf(cwlim_tp,type,(cwlim : (($i > $o) > $o))).
thf(cwtr_tp,type,(cwtr : (($i > $o) > $o))).
thf(aordom_ax,axiom,(cword @ ccom)).
thf(afin23lem24_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cword @ XA2) & (cwss @ XB2 @ XA2)) & ((cwcel @ XC @ XB2) & (cwcel @ XD @ XB2))) => (((ccin @ XC @ XB2) = (ccin @ XD @ XB2)) <=> (XC = XD)))))))).
