...
thf(agausslemma2dlem4_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XH = (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((! [Xx3:$i] : ((XR @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XH @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ cc2 @ ccdiv) @ cclt) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ ccmin)))))) => ((XM = (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => (! [Xx3:$i] : (Xph => ((ccfv @ XH @ ccfa) = (cco @ (ccprod @ (^ [Xk:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XR @ Xx3)))) @ (ccprod @ (^ [Xk:$i] : (cco @ (cco @ XM @ cc1 @ ccaddc) @ XH @ ccfz)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XR @ Xx3)))) @ ccmul)))))))))))))).
...
thf(agausslemma2dlem2_ax,axiom,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xk:$i] : (Xph => (cwcel @ (XP @ Xk) @ (ccdif @ ccprime @ (ccsn @ cc2))))) => ((! [Xk:$i] : (XH = (cco @ (cco @ (XP @ Xk) @ cc1 @ ccmin) @ cc2 @ ccdiv))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XR @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XH @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ (XP @ Xk) @ cc2 @ ccdiv) @ cclt) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ (XP @ Xk) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ ccmin))))))) => ((! [Xk:$i] : ((XM @ Xk) = (ccfv @ (cco @ (XP @ Xk) @ cc4 @ ccdiv) @ ccfl))) => (! [Xx3:$i] : (Xph => (cwral @ (^ [Xk:$i] : ((ccfv @ (ccv @ Xk) @ (XR @ Xx3)) = (cco @ (ccv @ Xk) @ cc2 @ ccmul))) @ (^ [Xk:$i] : (cco @ cc1 @ (XM @ Xk) @ ccfz))))))))))))))).
...
thf(agausslemma2dlem3_ax,axiom,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xk:$i] : (Xph => (cwcel @ (XP @ Xk) @ (ccdif @ ccprime @ (ccsn @ cc2))))) => ((! [Xk:$i] : (XH = (cco @ (cco @ (XP @ Xk) @ cc1 @ ccmin) @ cc2 @ ccdiv))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XR @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XH @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ (XP @ Xk) @ cc2 @ ccdiv) @ cclt) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ (XP @ Xk) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ ccmin))))))) => ((! [Xk:$i] : ((XM @ Xk) = (ccfv @ (cco @ (XP @ Xk) @ cc4 @ ccdiv) @ ccfl))) => (! [Xx3:$i] : (Xph => (cwral @ (^ [Xk:$i] : ((ccfv @ (ccv @ Xk) @ (XR @ Xx3)) = (cco @ (XP @ Xk) @ (cco @ (ccv @ Xk) @ cc2 @ ccmul) @ ccmin))) @ (^ [Xk:$i] : (cco @ (cco @ (XM @ Xk) @ cc1 @ ccaddc) @ XH @ ccfz))))))))))))))).
thf(asyl2an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xps) => ((Xta => Xch) => (((Xps & Xch) => Xth) => ((Xph & Xta) => Xth)))))))))).
thf(annzd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccn)) => (Xph => (cwcel @ XA2 @ ccz)))))).
thf(agausslemma2dlem0a_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => (Xph => (cwcel @ XP @ ccn)))))).
thf(azsubcl_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => (cwcel @ (cco @ XM @ XN @ ccmin) @ ccz))))).
thf(a_3syl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xps => Xch) => ((Xch => Xth) => (Xph => Xth))))))))).
thf(annoddn2prm_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccdif @ ccprime @ (ccsn @ cc2))) => ((cwcel @ XN @ ccn) & (~ (cwbr @ cc2 @ XN @ ccdvds)))))).
thf(annrp_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => (cwcel @ XA2 @ ccrp)))).
thf(aeqcomd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => (XB2 = XA2))))))).
thf(amodmulmodr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XM @ ccrp)) => ((cco @ (cco @ XA2 @ (cco @ XB2 @ XM @ ccmo) @ ccmul) @ XM @ ccmo) = (cco @ (cco @ XA2 @ XB2 @ ccmul) @ XM @ ccmo))))))).
thf(aoveq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))))).
thf(agausslemma2dlem5_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XH = (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((! [Xx3:$i] : ((XR @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XH @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ cc2 @ ccdiv) @ cclt) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ ccmin)))))) => ((XM = (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => ((! [Xx3:$i] : (! [Xk:$i] : ((XN @ Xx3 @ Xk) = (cco @ XH @ XM @ ccmin)))) => (! [Xx3:$i] : (! [Xk:$i] : (Xph => ((cco @ (ccprod @ (^ [Xk:$i] : (cco @ (cco @ XM @ cc1 @ ccaddc) @ XH @ ccfz)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XR @ Xx3)))) @ XP @ ccmo) = (cco @ (cco @ (cco @ (ccneg @ cc1) @ (XN @ Xx3 @ Xk) @ ccexp) @ (ccprod @ (^ [Xk:$i] : (cco @ (cco @ XM @ cc1 @ ccaddc) @ XH @ ccfz)) @ (^ [Xk:$i] : (cco @ (ccv @ Xk) @ cc2 @ ccmul))) @ ccmul) @ XP @ ccmo))))))))))))))))).
...
thf(agausslemma2dlem0h_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XM = (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => ((XH = (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((XN = (cco @ XH @ XM @ ccmin)) => (Xph => (cwcel @ XN @ ccn0)))))))))))).
thf(a_3eqtr4d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XA2)) => ((Xph => (XD = XB2)) => (Xph => (XC = XD))))))))))).
thf(aeqtrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XB2 = XC)) => (Xph => (XA2 = XC))))))))).
thf(aprodeq2d_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xk:$i] : ((Xph @ Xk) => (cwral @ (^ [Xk:$i] : ((XB2 @ Xk) = (XC @ Xk))) @ (^ [Xk:$i] : XA2)))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) = (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk)))))))))))).
...
thf(afprodsplit_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XU:($i > $o)] : ((Xph => ((ccin @ XA2 @ XB2) = cc0)) => ((Xph => (XU = (ccun @ XA2 @ XB2))) => ((Xph => (cwcel @ XU @ ccfn)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XU)) => (cwcel @ (XC @ Xk) @ ccc))) => (Xph => ((ccprod @ (^ [Xk:$i] : XU) @ (^ [Xk:$i] : (XC @ Xk))) = (cco @ (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))) @ (ccprod @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (XC @ Xk))) @ ccmul))))))))))))).
...
thf(agausslemma2dlem0d_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XM = (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => (Xph => (cwcel @ XM @ ccn0)))))))).
...
thf(ann0pzuz_ax,axiom,(! [XN:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XZ @ ccz)) => (cwcel @ (cco @ XN @ XZ @ ccaddc) @ (ccfv @ XZ @ ccuz)))))).
...
thf(agausslemma2dlem0g_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XM = (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => ((XH = (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => (Xph => (cwbr @ XM @ XH @ ccle)))))))))).
...
thf(ann0oddm1d2_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((~ (cwbr @ cc2 @ XN @ ccdvds)) <=> (cwcel @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn0))))).
