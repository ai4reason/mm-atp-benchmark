...
thf(aisrim0_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XR @ XV) & (cwcel @ XS @ XW)) => ((cwcel @ XF @ (cco @ XR @ XS @ ccrs)) <=> ((cwcel @ XF @ (cco @ XR @ XS @ ccrh)) & (cwcel @ (cccnv @ XF) @ (cco @ XS @ XR @ ccrh))))))))))).
