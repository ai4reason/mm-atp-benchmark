...
thf(cwrdeqs1cat_conj,conjecture,(! [XA2:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XA2)) & (cwne @ XW @ cc0)) => (XW = (cco @ (ccs1 @ (ccfv @ ccc0 @ XW)) @ (cco @ XW @ (ccop @ cc1 @ (ccfv @ XW @ cchash)) @ ccsubstr) @ ccconcat)))))).
