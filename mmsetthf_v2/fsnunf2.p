...
thf(cfsnunf2_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwf @ (ccdif @ XS @ (ccsn @ XX)) @ XT @ XF) @ (cwcel @ XX @ XS) @ (cwcel @ XY @ XT)) => (cwf @ XS @ XT @ (ccun @ XF @ (ccsn @ (ccop @ XX @ XY))))))))))).
