...
thf(arereb_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XA2 @ ccr) <=> ((ccfv @ XA2 @ ccre) = XA2))))).
...
thf(crennim_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwnel @ (cco @ cci @ XA2 @ ccmul) @ ccrp)))).
