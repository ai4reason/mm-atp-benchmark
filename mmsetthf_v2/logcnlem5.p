...
thf(aelcncf1ii_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XZ:($i > ($i > ($i > $o)))] : ((cwf @ XA2 @ XB2 @ XF) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ ccrp)) => (cwcel @ (XZ @ Xx3 @ Xy1) @ ccrp)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xw) @ XA2)) & (cwcel @ (ccv @ Xy1) @ ccrp)) => ((cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xw) @ ccmin) @ ccabs) @ (XZ @ Xx3 @ Xy1) @ cclt) => (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xw) @ XF) @ ccmin) @ ccabs) @ (ccv @ Xy1) @ cclt)))))) => (((cwss @ XA2 @ ccc) & (cwss @ XB2 @ ccc)) => (cwcel @ XF @ (cco @ XA2 @ XB2 @ cccncf))))))))))).
...
thf(alogcnlem2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((XS = (ccif @ (cwcel @ XA2 @ ccrp) @ XA2 @ (ccfv @ (ccfv @ XA2 @ ccim) @ ccabs))) => ((XT = (cco @ (ccfv @ XA2 @ ccabs) @ (cco @ XR @ (cco @ cc1 @ XR @ ccaddc) @ ccdiv) @ ccmul)) => ((Xph => (cwcel @ XA2 @ XD)) => ((Xph => (cwcel @ XR @ ccrp)) => (Xph => (cwcel @ (ccif @ (cwbr @ XS @ XT @ ccle) @ XS @ XT) @ ccrp)))))))))))))).
