...
thf(cdisjxun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((XC @ Xx3) = (XD @ Xy1))))) => (((ccin @ XA2 @ XB2) = cc0) => ((cwdisj @ (^ [Xx3:$i] : (ccun @ XA2 @ XB2)) @ (^ [Xx3:$i] : (XC @ Xx3))) <=> (cw3a @ (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (cwdisj @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccin @ (XC @ Xx3) @ (XD @ Xy1)) = cc0)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))))))).
