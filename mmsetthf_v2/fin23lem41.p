...
thf(afin23lem33_ax,axiom,(! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xb:$i] : ((XF @ Xx3 @ Xf1 @ Xg1 @ Xb) = (ccab @ (^ [Xg1:$i] : (cwral @ (^ [Xa:$i] : ((cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xa)))) @ (^ [Xx3:$i] : ccom)) => (cwcel @ (ccint @ (ccrn @ (ccv @ Xa))) @ (ccrn @ (ccv @ Xa))))) @ (^ [Xa:$i] : (cco @ (ccpw @ (ccv @ Xg1)) @ ccom @ ccmap)))))))))) => (! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xb:$i] : ((cwcel @ XG @ (XF @ Xx3 @ Xf1 @ Xg1 @ Xb)) => (? [Xf1:$i] : (! [Xb:$i] : (((cwf1 @ ccom @ ccvv @ (ccv @ Xb)) & (cwss @ (ccuni @ (ccrn @ (ccv @ Xb))) @ XG)) => ((cwf1 @ ccom @ ccvv @ (ccfv @ (ccv @ Xb) @ (ccv @ Xf1))) & (cwpss @ (ccuni @ (ccrn @ (ccfv @ (ccv @ Xb) @ (ccv @ Xf1)))) @ (ccuni @ (ccrn @ (ccv @ Xb))))))))))))))))).
thf(afin23lem39_ax,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XG:($i > $o)] : (! [XY:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xi:$i] : (! [Xj:$i] : ((XF @ Xx3 @ Xg1 @ Xh @ Xi @ Xj) = (ccab @ (^ [Xg1:$i] : (cwral @ (^ [Xa:$i] : ((cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xa)))) @ (^ [Xx3:$i] : ccom)) => (cwcel @ (ccint @ (ccrn @ (ccv @ Xa))) @ (ccrn @ (ccv @ Xa))))) @ (^ [Xa:$i] : (cco @ (ccpw @ (ccv @ Xg1)) @ ccom @ ccmap))))))))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xx3 @ Xg1 @ Xh @ Xi) => (cwf1 @ ccom @ ccvv @ (ccv @ Xh))))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xx3 @ Xg1 @ Xh @ Xi) => (cwss @ (ccuni @ (ccrn @ (ccv @ Xh))) @ XG)))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xx3 @ Xg1 @ Xh @ Xi) => (! [Xj:$i] : (((cwf1 @ ccom @ ccvv @ (ccv @ Xj)) & (cwss @ (ccuni @ (ccrn @ (ccv @ Xj))) @ XG)) => ((cwf1 @ ccom @ ccvv @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi))) & (cwpss @ (ccuni @ (ccrn @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi)))) @ (ccuni @ (ccrn @ (ccv @ Xj)))))))))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xi:$i] : ((XY @ Xx3 @ Xg1 @ Xh @ Xi) = (ccres @ (ccrdg @ (ccv @ Xi) @ (ccv @ Xh)) @ ccom)))))) => (! [Xx3:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xi:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xg1 @ Xh @ Xi) => (~ (cwcel @ XG @ (XF @ Xx3 @ Xg1 @ Xh @ Xi @ Xj))))))))))))))))))).
...
thf(aisfin4_2_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XA2 @ ccfin4) <=> (~ (cwbr @ ccom @ XA2 @ ccdom))))))).
thf(aisfin3_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfin3) <=> (cwcel @ (ccpw @ XA2) @ ccfin4)))).
thf(cfin23lem41_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xg1:$i] : ((XF @ Xx3 @ Xg1) = (ccab @ (^ [Xg1:$i] : (cwral @ (^ [Xa:$i] : ((cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xa)))) @ (^ [Xx3:$i] : ccom)) => (cwcel @ (ccint @ (ccrn @ (ccv @ Xa))) @ (ccrn @ (ccv @ Xa))))) @ (^ [Xa:$i] : (cco @ (ccpw @ (ccv @ Xg1)) @ ccom @ ccmap)))))))) => (! [Xx3:$i] : (! [Xg1:$i] : ((cwcel @ XA2 @ (XF @ Xx3 @ Xg1)) => (cwcel @ XA2 @ ccfin3)))))))).
