...
thf(atopbnd_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XA2 @ XX)) => ((ccin @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (ccfv @ (ccdif @ XX @ XA2) @ (ccfv @ XJ @ cccl))) = (ccdif @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (ccfv @ XA2 @ (ccfv @ XJ @ ccnt)))))))))).
