...
thf(adpval3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccr) => ((cco @ XA2 @ XB2 @ ccdp) = (ccdp2 @ XA2 @ XB2))))))).
...
thf(cdpmul100_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccr) => ((cco @ (cco @ XA2 @ (ccdp2 @ XB2 @ XC) @ ccdp) @ (ccdc @ (ccdc @ cc1 @ ccc0) @ ccc0) @ ccmul) = (ccdc @ (ccdc @ XA2 @ XB2) @ XC))))))))).
