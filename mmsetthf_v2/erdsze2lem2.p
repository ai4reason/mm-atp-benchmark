...
thf(aerdsze_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwf1 @ (cco @ cc1 @ XN @ ccfz) @ ccr @ XF)) => ((Xph => (cwcel @ XR @ ccn)) => ((Xph => (cwcel @ XS @ ccn)) => ((Xph => (cwbr @ (cco @ (cco @ XR @ cc1 @ ccmin) @ (cco @ XS @ cc1 @ ccmin) @ ccmul) @ XN @ cclt)) => (Xph => (cwrex @ (^ [Xs1:$i] : (((cwbr @ XR @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccle) & (cwiso @ (ccv @ Xs1) @ (ccima @ XF @ (ccv @ Xs1)) @ cclt @ cclt @ (ccres @ XF @ (ccv @ Xs1)))) | ((cwbr @ XS @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccle) & (cwiso @ (ccv @ Xs1) @ (ccima @ XF @ (ccv @ Xs1)) @ cclt @ (cccnv @ cclt) @ (ccres @ XF @ (ccv @ Xs1)))))) @ (^ [Xs1:$i] : (ccpw @ (cco @ cc1 @ XN @ ccfz)))))))))))))))).
...
thf(af1imaen_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XC @ ccvv) => (((cwf1 @ XA2 @ XB2 @ XF) & (cwss @ XC @ XA2)) => (cwbr @ (ccima @ XF @ XC) @ XC @ ccen)))))))).
...
thf(cerdsze2lem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XR @ ccn)) => ((Xph => (cwcel @ XS @ ccn)) => ((Xph => (cwf1 @ XA2 @ ccr @ XF)) => ((Xph => (cwss @ XA2 @ ccr)) => ((XN = (cco @ (cco @ XR @ cc1 @ ccmin) @ (cco @ XS @ cc1 @ ccmin) @ ccmul)) => ((Xph => (cwbr @ XN @ (ccfv @ XA2 @ cchash) @ cclt)) => ((Xph => (cwf1 @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ XA2 @ XG)) => ((Xph => (cwiso @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (ccrn @ XG) @ cclt @ cclt @ XG)) => (Xph => (cwrex @ (^ [Xs1:$i] : (((cwbr @ XR @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccle) & (cwiso @ (ccv @ Xs1) @ (ccima @ XF @ (ccv @ Xs1)) @ cclt @ cclt @ (ccres @ XF @ (ccv @ Xs1)))) | ((cwbr @ XS @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccle) & (cwiso @ (ccv @ Xs1) @ (ccima @ XF @ (ccv @ Xs1)) @ cclt @ (cccnv @ cclt) @ (ccres @ XF @ (ccv @ Xs1)))))) @ (^ [Xs1:$i] : (ccpw @ XA2)))))))))))))))))))).
