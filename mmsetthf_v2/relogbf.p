...
thf(arpcndif0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwcel @ XA2 @ (ccdif @ ccc @ (ccsn @ ccc0)))))).
...
thf(alogbfval_ax,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (((cw3a @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0) @ (cwne @ XB2 @ cc1)) & (cwcel @ XX @ (ccdif @ ccc @ (ccsn @ ccc0)))) => ((ccfv @ XX @ (ccfv @ XB2 @ (cccur @ cclogb))) = (cco @ XB2 @ XX @ cclogb)))))).
...
thf(alogbf_ax,axiom,(! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0) @ (cwne @ XB2 @ cc1)) => (cwf @ (ccdif @ ccc @ (ccsn @ ccc0)) @ ccc @ (ccfv @ XB2 @ (cccur @ cclogb)))))).
...
thf(crelogbf_conj,conjecture,(! [XB2:($i > $o)] : (((cwcel @ XB2 @ ccrp) & (cwbr @ cc1 @ XB2 @ cclt)) => (cwf @ ccrp @ ccr @ (ccres @ (ccfv @ XB2 @ (cccur @ cclogb)) @ ccrp))))).
