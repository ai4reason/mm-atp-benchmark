...
thf(ambfsub_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwcel @ XG @ ccmbf)) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ ccmin)) @ ccmbf)))))))).
...
thf(ambfulm_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwf @ XZ @ ccmbf @ XF)) => ((Xph => (cwbr @ XF @ XG @ (ccfv @ XS @ cculm))) => (Xph => (cwcel @ XG @ ccmbf))))))))))))).
...
thf(abddibl_ax,axiom,(! [XF:($i > $o)] : ((cw3a @ (cwcel @ XF @ ccmbf) @ (cwcel @ (ccfv @ (ccdm @ XF) @ ccvol) @ ccr) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xy1) @ XF) @ ccabs) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : (ccdm @ XF)))) @ (^ [Xx3:$i] : ccr))) => (cwcel @ XF @ ccibl)))).
thf(ciblulm_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwf @ XZ @ ccibl @ XF)) => ((Xph => (cwbr @ XF @ XG @ (ccfv @ XS @ cculm))) => ((Xph => (cwcel @ (ccfv @ XS @ ccvol) @ ccr)) => (Xph => (cwcel @ XG @ ccibl)))))))))))))).
