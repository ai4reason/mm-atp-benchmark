...
thf(aralnex3_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [Xy1:$i] : (! [Xz:$i] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (~ (Xph @ Xx3 @ Xy1 @ Xz))) @ (^ [Xz:$i] : (XC @ Xx3 @ Xy1 @ Xz)))) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1 @ Xz)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1 @ Xz))) <=> (~ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)) @ (^ [Xz:$i] : (XC @ Xx3 @ Xy1 @ Xz)))) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1 @ Xz)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1 @ Xz)))))))))))).
...
thf(caxtgupdim2_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XX @ XP)) => ((Xph => (cwcel @ XY @ XP)) => ((Xph => (cwcel @ XZ @ XP)) => ((Xph => (cwcel @ XU @ XP)) => ((Xph => (cwcel @ XV @ XP)) => ((Xph => (cwne @ XU @ XV)) => ((Xph => ((cco @ XU @ XX @ Xc_mi) = (cco @ XV @ XX @ Xc_mi))) => ((Xph => ((cco @ XU @ XY @ Xc_mi) = (cco @ XV @ XY @ Xc_mi))) => ((Xph => ((cco @ XU @ XZ @ Xc_mi) = (cco @ XV @ XZ @ Xc_mi))) => ((Xph => (cwcel @ XG @ XV)) => ((Xph => (~ (cwbr @ XG @ cc3 @ ccstrkgld))) => (Xph => (cw3o @ (cwcel @ XZ @ (cco @ XX @ XY @ XI)) @ (cwcel @ XX @ (cco @ XZ @ XY @ XI)) @ (cwcel @ XY @ (cco @ XX @ XZ @ XI))))))))))))))))))))))))))))).
