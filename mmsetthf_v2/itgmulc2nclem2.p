...
thf(amax0sub_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cco @ (ccif @ (cwbr @ ccc0 @ XA2 @ ccle) @ XA2 @ ccc0) @ (ccif @ (cwbr @ ccc0 @ (ccneg @ XA2) @ ccle) @ (ccneg @ XA2) @ ccc0) @ ccmin) = XA2)))).
...
thf(aiblre_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccr))) => (Xph => ((cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccibl) <=> ((cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccif @ (cwbr @ ccc0 @ (XB2 @ Xx3) @ ccle) @ (XB2 @ Xx3) @ ccc0))) @ ccibl) & (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccif @ (cwbr @ ccc0 @ (ccneg @ (XB2 @ Xx3)) @ ccle) @ (ccneg @ (XB2 @ Xx3)) @ ccc0))) @ ccibl))))))))).
...
thf(aitgreval_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccr))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccibl)) => (Xph => ((ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (cco @ (ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccif @ (cwbr @ ccc0 @ (XB2 @ Xx3) @ ccle) @ (XB2 @ Xx3) @ ccc0))) @ (ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccif @ (cwbr @ ccc0 @ (ccneg @ (XB2 @ Xx3)) @ ccle) @ (ccneg @ (XB2 @ Xx3)) @ ccc0))) @ ccmin))))))))).
