...
thf(acjmulrcld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => (Xph => (cwcel @ (cco @ XA2 @ (ccfv @ XA2 @ cccj) @ ccmul) @ ccr)))))).
...
thf(acjmulge0d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => (Xph => (cwbr @ ccc0 @ (cco @ XA2 @ (ccfv @ XA2 @ cccj) @ ccmul) @ ccle)))))).
...
thf(aipassr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((XV = (ccfv @ XW @ ccbs)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((Xc_xp = (ccfv @ XF @ ccmulr)) => ((Xc_as = (ccfv @ XF @ ccstv)) => (((cwcel @ XW @ ccphl) & (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XK))) => ((cco @ XA2 @ (cco @ XC @ XB2 @ Xc_x) @ Xc_xi) = (cco @ (cco @ XA2 @ XB2 @ Xc_xi) @ (ccfv @ XC @ Xc_as) @ Xc_xp)))))))))))))))))))))).
...
thf(aclmmul_ax,axiom,(! [XF:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((cwcel @ XW @ ccclm) => (ccmul = (ccfv @ XF @ ccmulr))))))).
...
thf(aclmcj_ax,axiom,(! [XF:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((cwcel @ XW @ ccclm) => (cccj = (ccfv @ XF @ ccstv))))))).
...
thf(ctchcphlem2_conj,conjecture,(! [Xph:$o] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (ccfv @ XW @ cctch)) => ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xph => (cwcel @ XW @ ccphl)) => ((! [Xx3:$i] : (Xph => (XF = (cco @ cccnfld @ (XK @ Xx3) @ ccress)))) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((! [Xx3:$i] : ((Xph & (cw3a @ (cwcel @ (ccv @ Xx3) @ (XK @ Xx3)) @ (cwcel @ (ccv @ Xx3) @ ccr) @ (cwbr @ ccc0 @ (ccv @ Xx3) @ ccle))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ ccsqrt) @ (XK @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XV)) => (cwbr @ ccc0 @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ Xc_xi) @ ccle))) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccfv @ XF @ ccbs))) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((! [Xx3:$i] : (Xph => (cwcel @ XX @ (XK @ Xx3)))) => ((Xph => (cwcel @ XY @ XV)) => (Xph => ((ccfv @ (cco @ (cco @ XX @ XY @ Xc_x) @ (cco @ XX @ XY @ Xc_x) @ Xc_xi) @ ccsqrt) = (cco @ (ccfv @ XX @ ccabs) @ (ccfv @ (cco @ XY @ XY @ Xc_xi) @ ccsqrt) @ ccmul)))))))))))))))))))))))))).
