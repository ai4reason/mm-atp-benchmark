...
thf(adfarea_ax,axiom,(ccarea = (ccmpt @ (^ [Xs1:$i] : (ccdm @ ccarea)) @ (^ [Xs1:$i] : (ccitg @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (ccima @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xx3))) @ ccvol))))))).
...
thf(aareambl_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XS @ (ccdm @ ccarea)) & (cwcel @ XA2 @ ccr)) => ((cwcel @ (ccima @ XS @ (ccsn @ XA2)) @ (ccdm @ ccvol)) & (cwcel @ (ccfv @ (ccima @ XS @ (ccsn @ XA2)) @ ccvol) @ ccr)))))).
