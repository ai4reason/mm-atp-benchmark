...
thf(afimaproj_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((XH = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XA2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XG)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwfn @ XF @ XA2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwfn @ XG @ XB2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwss @ (XX @ Xx3 @ Xy1) @ XA2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwss @ (XY @ Xx3 @ Xy1) @ XB2)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => ((ccima @ XH @ (ccxp @ (XX @ Xx3 @ Xy1) @ (XY @ Xx3 @ Xy1))) = (ccxp @ (ccima @ XF @ (XX @ Xx3 @ Xy1)) @ (ccima @ XG @ (XY @ Xx3 @ Xy1))))))))))))))))))))).
...
thf(ctxomap_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwf @ XX @ (XZ @ Xx3 @ Xy1) @ XF)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwf @ XY @ (XT @ Xx3 @ Xy1) @ XG)))) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XL @ (ccfv @ (XZ @ Xx3 @ Xy1) @ cctopon))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XM @ (ccfv @ (XT @ Xx3 @ Xy1) @ cctopon))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XJ)) => (cwcel @ (ccima @ XF @ (ccv @ Xx3)) @ XL))) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XK)) => (cwcel @ (ccima @ XG @ (ccv @ Xy1)) @ XM))) => ((Xph => (cwcel @ XA2 @ (cco @ XJ @ XK @ cctx))) => ((XH = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XG)))))) => (Xph => (cwcel @ (ccima @ XH @ XA2) @ (cco @ XL @ XM @ cctx))))))))))))))))))))))))))).
