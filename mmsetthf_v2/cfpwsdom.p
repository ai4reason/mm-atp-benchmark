...
thf(aficard_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XA2 @ ccfn) <=> (cwcel @ (ccfv @ XA2 @ cccrd) @ ccom)))))).
...
thf(adom0_ax,axiom,(! [XA2:($i > $o)] : ((cwbr @ XA2 @ cc0 @ ccdom) <=> (XA2 = cc0)))).
...
thf(ccfpwsdom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwbr @ cc2o @ XB2 @ ccdom) => (cwbr @ (ccfv @ XA2 @ ccale) @ (ccfv @ (ccfv @ (cco @ XB2 @ (ccfv @ XA2 @ ccale) @ ccmap) @ cccrd) @ cccf) @ ccsdm)))))).
