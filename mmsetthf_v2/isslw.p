...
thf(cisslw_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ (cco @ XP @ XG @ ccslw)) <=> (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XH @ (ccfv @ XG @ ccsubg)) @ (cwral @ (^ [Xk:$i] : (((cwss @ XH @ (ccv @ Xk)) & (cwbr @ XP @ (cco @ XG @ (ccv @ Xk) @ ccress) @ ccpgp)) <=> (XH = (ccv @ Xk)))) @ (^ [Xk:$i] : (ccfv @ XG @ ccsubg))))))))).
