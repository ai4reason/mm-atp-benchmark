...
thf(atdeglem2_ax,axiom,((ccmpt @ (^ [Xh:$i] : (cco @ ccn0 @ cc1o @ ccmap)) @ (^ [Xh:$i] : (ccfv @ cc0 @ (ccv @ Xh)))) = (ccmpt @ (^ [Xh:$i] : (cco @ ccn0 @ cc1o @ ccmap)) @ (^ [Xh:$i] : (cco @ cccnfld @ (ccv @ Xh) @ ccgsu))))).
...
thf(afvcoe1_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XF @ ccco1)) => (((cwcel @ XF @ XV) & (cwcel @ XX @ (cco @ ccn0 @ cc1o @ ccmap))) => ((ccfv @ XX @ XF) = (ccfv @ (ccfv @ cc0 @ XX) @ XA2))))))))).
thf(cdeg1leb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : ((XD @ Xx3) = (ccfv @ (XR @ Xx3) @ ccdg1))) => ((! [Xx3:$i] : ((XP @ Xx3) = (ccfv @ (XR @ Xx3) @ ccpl1))) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccfv @ (XP @ Xx3) @ ccbs))) => ((! [Xx3:$i] : (Xc_0 = (ccfv @ (XR @ Xx3) @ cc0g))) => ((! [Xx3:$i] : (XA2 = (ccfv @ (XF @ Xx3) @ ccco1))) => (! [Xx3:$i] : (((cwcel @ (XF @ Xx3) @ (XB2 @ Xx3)) & (cwcel @ XG @ ccxr)) => ((cwbr @ (ccfv @ (XF @ Xx3) @ (XD @ Xx3)) @ XG @ ccle) <=> (cwral @ (^ [Xx3:$i] : ((cwbr @ XG @ (ccv @ Xx3) @ cclt) => ((ccfv @ (ccv @ Xx3) @ XA2) = Xc_0))) @ (^ [Xx3:$i] : ccn0))))))))))))))))))).
