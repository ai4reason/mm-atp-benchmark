...
thf(achpval2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ XA2 @ ccchp) = (ccsu @ (ccin @ (cco @ ccc0 @ XA2 @ ccicc) @ ccprime) @ (^ [Xp:$i] : (cco @ (ccfv @ (ccv @ Xp) @ cclog) @ (ccfv @ (cco @ (ccfv @ XA2 @ cclog) @ (ccfv @ (ccv @ Xp) @ cclog) @ ccdiv) @ ccfl) @ ccmul))))))).
...
thf(achtval_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ XA2 @ cccht) = (ccsu @ (ccin @ (cco @ ccc0 @ XA2 @ ccicc) @ ccprime) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xp) @ cclog))))))).
...
thf(arelogexp_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwcel @ XN @ ccz)) => ((ccfv @ (cco @ XA2 @ XN @ ccexp) @ cclog) = (cco @ XN @ (ccfv @ XA2 @ cclog) @ ccmul)))))).
...
thf(acxpge0d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ cccxp) @ ccle))))))))).
...
thf(abernneq3_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccn0)) => (cwbr @ XN @ (cco @ XP @ XN @ ccexp) @ cclt))))).
...
thf(aleexp2ad_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ cc1 @ XA2 @ ccle)) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => (Xph => (cwbr @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccle)))))))))).
...
thf(cchpchtsum_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ XA2 @ ccchp) = (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xk:$i] : (ccfv @ (cco @ XA2 @ (cco @ cc1 @ (ccv @ Xk) @ ccdiv) @ cccxp) @ cccht))))))).
