...
thf(acshfn_ax,axiom,(! [XN:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xf1:$i] : (! [Xl:$i] : (((cwcel @ (XW @ Xf1 @ Xl) @ (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xl:$i] : (cwfn @ (ccv @ Xf1) @ (cco @ ccc0 @ (ccv @ Xl) @ ccfzo))) @ (^ [Xl:$i] : ccn0))))) & (cwcel @ (XN @ Xf1 @ Xl) @ ccz)) => ((cco @ (XW @ Xf1 @ Xl) @ (XN @ Xf1 @ Xl) @ cccsh) = (ccif @ ((XW @ Xf1 @ Xl) = cc0) @ cc0 @ (cco @ (cco @ (XW @ Xf1 @ Xl) @ (ccop @ (cco @ (XN @ Xf1 @ Xl) @ (ccfv @ (XW @ Xf1 @ Xl) @ cchash) @ ccmo) @ (ccfv @ (XW @ Xf1 @ Xl) @ cchash)) @ ccsubstr) @ (cco @ (XW @ Xf1 @ Xl) @ (ccop @ ccc0 @ (cco @ (XN @ Xf1 @ Xl) @ (ccfv @ (XW @ Xf1 @ Xl) @ cchash) @ ccmo)) @ ccsubstr) @ ccconcat))))))))).
...
thf(aswrd0_ax,axiom,(! [XF:($i > $o)] : (! [XL:($i > $o)] : ((cco @ cc0 @ (ccop @ XF @ XL) @ ccsubstr) = cc0)))).
thf(apfx0_ax,axiom,(! [XL:($i > $o)] : ((cco @ cc0 @ XL @ ccpfx) = cc0))).
...
thf(ccshword2_conj,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ ccz)) => ((cco @ XW @ XN @ cccsh) = (cco @ (cco @ XW @ (ccop @ (cco @ XN @ (ccfv @ XW @ cchash) @ ccmo) @ (ccfv @ XW @ cchash)) @ ccsubstr) @ (cco @ XW @ (cco @ XN @ (ccfv @ XW @ cchash) @ ccmo) @ ccpfx) @ ccconcat))))))).
