...
thf(aiccnct_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((XC = (cco @ XA2 @ XB2 @ ccicc)) => (Xph => (~ (cwbr @ XC @ ccom @ ccdom)))))))))))).
...
thf(aiocnct_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((XC = (cco @ XA2 @ XB2 @ ccioc)) => (Xph => (~ (cwbr @ XC @ ccom @ ccdom)))))))))))).
...
thf(aiccdificc_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwcel @ XC @ ccxr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => (Xph => ((ccdif @ (cco @ XA2 @ XC @ ccicc) @ (cco @ XA2 @ XB2 @ ccicc)) = (cco @ XB2 @ XC @ ccioc)))))))))))).
