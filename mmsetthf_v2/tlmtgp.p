...
thf(atlmlmod_ax,axiom,(! [XW:($i > $o)] : ((cwcel @ XW @ cctlm) => (cwcel @ XW @ cclmod)))).
thf(ccmulr_tp,type,(ccmulr : ($i > $o))).
thf(ccplusg_tp,type,(ccplusg : ($i > $o))).
thf(cwral_tp,type,(cwral : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(almodgrp_ax,axiom,(! [XW:($i > $o)] : ((cwcel @ XW @ cclmod) => (cwcel @ XW @ ccgrp)))).
thf(atlmtmd_ax,axiom,(! [XW:($i > $o)] : ((cwcel @ XW @ cctlm) => (cwcel @ XW @ cctmd)))).
...
thf(almodvneg1_ax,axiom,(! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ ccminusg)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((Xc_1 = (ccfv @ XF @ ccur)) => ((XM = (ccfv @ XF @ ccminusg)) => (((cwcel @ XW @ cclmod) & (cwcel @ XX @ XV)) => ((cco @ (ccfv @ Xc_1 @ XM) @ XX @ Xc_x) = (ccfv @ XX @ XN)))))))))))))))))).
thf(acnmpt1vsca_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((! [Xx3:$i] : ((Xc_x @ Xx3) = (ccfv @ XW @ ccvsca))) => ((XJ = (ccfv @ XW @ cctopn)) => ((XK = (ccfv @ XF @ cctopn)) => ((Xph => (cwcel @ XW @ cctlm)) => ((Xph => (cwcel @ XL @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (cco @ XL @ XK @ cccn))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cco @ XL @ XJ @ cccn))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ (Xc_x @ Xx3)))) @ (cco @ XL @ XJ @ cccn)))))))))))))))))))))).
...
thf(ctlmtgp_conj,conjecture,(! [XW:($i > $o)] : ((cwcel @ XW @ cctlm) => (cwcel @ XW @ cctgp)))).
