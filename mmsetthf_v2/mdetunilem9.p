...
thf(amdetunilem8_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : (XA2 = (cco @ XN @ (XR @ Xa @ Xb) @ ccmat)))) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((! [Xa:$i] : (! [Xb:$i] : (XK = (ccfv @ (XR @ Xa @ Xb) @ ccbs)))) => ((! [Xa:$i] : (! [Xb:$i] : (Xc_0 = (ccfv @ (XR @ Xa @ Xb) @ cc0g)))) => ((! [Xa:$i] : (! [Xb:$i] : (Xc_1 = (ccfv @ (XR @ Xa @ Xb) @ ccur)))) => ((! [Xa:$i] : (! [Xb:$i] : (Xc_pl = (ccfv @ (XR @ Xa @ Xb) @ ccplusg)))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xc_x @ Xa @ Xb) = (ccfv @ (XR @ Xa @ Xb) @ ccmulr)))) => ((Xph => (cwcel @ XN @ ccfn)) => ((! [Xa:$i] : (! [Xb:$i] : (Xph => (cwcel @ (XR @ Xa @ Xb) @ ccrg)))) => ((Xph => (cwf @ XB2 @ XK @ XD)) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (((cwne @ (ccv @ Xy1) @ (ccv @ Xz)) & (cwral @ (^ [Xw:$i] : ((cco @ (ccv @ Xy1) @ (ccv @ Xw) @ (ccv @ Xx3)) = (cco @ (ccv @ Xz) @ (ccv @ Xw) @ (ccv @ Xx3)))) @ (^ [Xw:$i] : XN))) => ((ccfv @ (ccv @ Xx3) @ XD) = Xc_0))) @ (^ [Xz:$i] : XN))) @ (^ [Xy1:$i] : XN))) @ (^ [Xx3:$i] : XB2))) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((cw3a @ ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) = (cco @ (ccres @ (ccv @ Xy1) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccres @ (ccv @ Xz) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccof @ Xc_pl))) @ ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xy1) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN))) @ ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xz) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)))) => ((ccfv @ (ccv @ Xx3) @ XD) = (cco @ (ccfv @ (ccv @ Xy1) @ XD) @ (ccfv @ (ccv @ Xz) @ XD) @ Xc_pl)))) @ (^ [Xw:$i] : XN))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))) => ((! [Xa:$i] : (! [Xb:$i] : (Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((((ccres @ (ccv @ Xx3) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) = (cco @ (ccxp @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN) @ (ccsn @ (ccv @ Xy1))) @ (ccres @ (ccv @ Xz) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccof @ (Xc_x @ Xa @ Xb)))) & ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xz) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)))) => ((ccfv @ (ccv @ Xx3) @ XD) = (cco @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xz) @ XD) @ (Xc_x @ Xa @ Xb))))) @ (^ [Xw:$i] : XN))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XK))) @ (^ [Xx3:$i] : XB2))))) => ((Xph => ((ccfv @ (ccfv @ XA2 @ ccur) @ XD) = Xc_0)) => ((Xph & (cwf @ XN @ XN @ XE)) => ((ccfv @ (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : XN)) @ (^ [Xa:$i] : (^ [Xb:$i] : XN)) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ ((ccfv @ (ccv @ Xa) @ XE) = (ccv @ Xb)) @ Xc_1 @ Xc_0)))) @ XD) = Xc_0))))))))))))))))))))))))))))).
...
thf(afsets_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ ((cwcel @ XF @ XV) & (cwf @ XA2 @ XB2 @ XF)) @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XB2)) => (cwf @ XA2 @ XB2 @ (cco @ XF @ (ccop @ XX @ XY) @ ccsts)))))))))).
thf(asyl6bb_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps <=> Xch)) => ((Xch <=> Xth) => (Xph => (Xps <=> Xth))))))))).
thf(asyl6eq_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((XB2 = XC) => (Xph => (XA2 = XC))))))))).
thf(amp3an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (Xph => (Xps => (Xch => (((cw3a @ Xph @ Xps @ Xch) => Xth) => Xth))))))))).
thf(ccdm_tp,type,(ccdm : (($i > $o) > ($i > $o)))).
thf(afvsetsid_ax,axiom,(! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XF @ XV) @ (cwcel @ XX @ XW) @ (cwcel @ XY @ XU)) => ((ccfv @ XX @ (cco @ XF @ (ccop @ XX @ XY) @ ccsts)) = XY))))))))).
...
thf(asetsres_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XS @ XV) => ((ccres @ (cco @ XS @ (ccop @ XA2 @ XB2) @ ccsts) @ (ccdif @ ccvv @ (ccsn @ XA2))) = (ccres @ XS @ (ccdif @ ccvv @ (ccsn @ XA2)))))))))).
...
thf(cmdetunilem9_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_0:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xph => (cwcel @ XN @ ccfn)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwf @ XB2 @ XK @ XD)) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (((cwne @ (ccv @ Xy1) @ (ccv @ Xz)) & (cwral @ (^ [Xw:$i] : ((cco @ (ccv @ Xy1) @ (ccv @ Xw) @ (ccv @ Xx3)) = (cco @ (ccv @ Xz) @ (ccv @ Xw) @ (ccv @ Xx3)))) @ (^ [Xw:$i] : XN))) => ((ccfv @ (ccv @ Xx3) @ XD) = Xc_0))) @ (^ [Xz:$i] : XN))) @ (^ [Xy1:$i] : XN))) @ (^ [Xx3:$i] : XB2))) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((cw3a @ ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) = (cco @ (ccres @ (ccv @ Xy1) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccres @ (ccv @ Xz) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccof @ Xc_pl))) @ ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xy1) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN))) @ ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xz) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)))) => ((ccfv @ (ccv @ Xx3) @ XD) = (cco @ (ccfv @ (ccv @ Xy1) @ XD) @ (ccfv @ (ccv @ Xz) @ XD) @ Xc_pl)))) @ (^ [Xw:$i] : XN))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((((ccres @ (ccv @ Xx3) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) = (cco @ (ccxp @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN) @ (ccsn @ (ccv @ Xy1))) @ (ccres @ (ccv @ Xz) @ (ccxp @ (ccsn @ (ccv @ Xw)) @ XN)) @ (ccof @ Xc_x))) & ((ccres @ (ccv @ Xx3) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)) = (ccres @ (ccv @ Xz) @ (ccxp @ (ccdif @ XN @ (ccsn @ (ccv @ Xw))) @ XN)))) => ((ccfv @ (ccv @ Xx3) @ XD) = (cco @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xz) @ XD) @ Xc_x)))) @ (^ [Xw:$i] : XN))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XK))) @ (^ [Xx3:$i] : XB2))) => ((Xph => ((ccfv @ (ccfv @ XA2 @ ccur) @ XD) = Xc_0)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XY @ Xx3 @ Xy1 @ Xz @ Xw) = (ccab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((cwral @ (^ [Xw:$i] : ((ccfv @ (ccv @ Xw) @ (ccv @ Xy1)) = (ccif @ (cwcel @ (ccv @ Xw) @ (ccv @ Xz)) @ Xc_1 @ Xc_0))) @ (^ [Xw:$i] : (ccv @ Xx3))) => ((ccfv @ (ccv @ Xy1) @ XD) = Xc_0))) @ (^ [Xz:$i] : (cco @ XN @ XN @ ccmap)))) @ (^ [Xy1:$i] : XB2))))))))) => (Xph => (XD = (ccxp @ XB2 @ (ccsn @ Xc_0)))))))))))))))))))))))))))))))).
