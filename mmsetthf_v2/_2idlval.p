...
thf(adf_2idl_ax,axiom,(cc2idl = (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccin @ (ccfv @ (ccv @ Xr) @ cclidl) @ (ccfv @ (ccfv @ (ccv @ Xr) @ ccoppr) @ cclidl)))))).
...
thf(c_2idlval_conj,conjecture,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XO:($i > $o)] : ((XI = (ccfv @ XR @ cclidl)) => ((XO = (ccfv @ XR @ ccoppr)) => ((XJ = (ccfv @ XO @ cclidl)) => ((XT = (ccfv @ XR @ cc2idl)) => (XT = (ccin @ XI @ XJ)))))))))))).
