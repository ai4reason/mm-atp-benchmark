...
thf(acnlimci_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ XA2 @ XD @ cccncf))) => ((Xph => (cwcel @ XB2 @ XA2)) => (Xph => (cwcel @ (ccfv @ XB2 @ XF) @ (cco @ XF @ XB2 @ cclimc))))))))))).
thf(a_3eltr3d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XA2 @ XB2)) => ((Xph => (XA2 = XC)) => ((Xph => (XB2 = XD)) => (Xph => (cwcel @ XC @ XD))))))))))).
thf(alimccnp_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwf @ XA2 @ XD @ XF)) => ((Xph => (cwss @ XD @ ccc)) => ((XK = (ccfv @ cccnfld @ cctopn)) => ((XJ = (cco @ XK @ XD @ ccrest)) => ((Xph => (cwcel @ XC @ (cco @ XF @ XB2 @ cclimc))) => ((Xph => (cwcel @ XG @ (ccfv @ XC @ (cco @ XJ @ XK @ cccnp)))) => (Xph => (cwcel @ (ccfv @ XC @ XG) @ (cco @ (cccom @ XG @ XF) @ XB2 @ cclimc))))))))))))))))))).
...
thf(adivcn_ax,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((XK = (cco @ XJ @ (ccdif @ ccc @ (ccsn @ ccc0)) @ ccrest)) => (cwcel @ ccdiv @ (cco @ (cco @ XJ @ XK @ cctx) @ XJ @ cccn))))))).
