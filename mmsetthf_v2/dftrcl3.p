...
thf(aov2ssiunov2_ax,axiom,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [Xc_ex:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((XC = (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (cciun @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xn) @ Xc_ex)))))) => (! [Xr:$i] : ((cw3a @ (cwcel @ XR @ (XU @ Xr)) @ (cwcel @ XN @ (XV @ Xr)) @ (cwcel @ (XM @ Xr) @ XN)) => (cwss @ (cco @ XR @ (XM @ Xr) @ Xc_ex) @ (ccfv @ XR @ XC))))))))))))).
...
thf(aiunrelexpuztr_ax,axiom,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((XC = (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (cciun @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xn) @ ccrelexp)))))) => (! [Xr:$i] : ((cw3a @ (cwcel @ XR @ (XV @ Xr)) @ (XN = (ccfv @ (XM @ Xr) @ ccuz)) @ (cwcel @ (XM @ Xr) @ ccn0)) => (cwss @ (cccom @ (ccfv @ XR @ XC) @ (ccfv @ XR @ XC)) @ (ccfv @ XR @ XC))))))))))).
...
thf(aelabgt_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XA2 @ (XB2 @ Xx3)) & (! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> Xps)))) => ((cwcel @ XA2 @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3)))) <=> Xps)))))))).
...
thf(aiunrelexpmin1_ax,axiom,(! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((! [Xs1:$i] : ((XC @ Xs1) = (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (cciun @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xn) @ ccrelexp))))))) => (((cwcel @ XR @ XV) & (XN = ccn)) => (! [Xs1:$i] : (((cwss @ XR @ (ccv @ Xs1)) & (cwss @ (cccom @ (ccv @ Xs1) @ (ccv @ Xs1)) @ (ccv @ Xs1))) => (cwss @ (ccfv @ XR @ (XC @ Xs1)) @ (ccv @ Xs1))))))))))).
...
thf(cdftrcl3_conj,conjecture,(cctcl = (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xn) @ ccrelexp))))))).
