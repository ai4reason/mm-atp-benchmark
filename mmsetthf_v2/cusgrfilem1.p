...
thf(acusgredg_ax,axiom,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccfv @ XG @ ccedg))) => (! [Xx3:$i] : ((cwcel @ XG @ cccusgr) => ((XE @ Xx3) = (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cchash) = cc2)) @ (^ [Xx3:$i] : (ccpw @ XV)))))))))))).
...
thf(ccusgrfilem1_conj,conjecture,(! [XP:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((! [Xa:$i] : (XV = (ccfv @ (XG @ Xa) @ ccvtx))) => ((! [Xx3:$i] : (! [Xa:$i] : ((XP @ Xx3 @ Xa) = (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xa:$i] : ((cwne @ (ccv @ Xa) @ XN) & ((ccv @ Xx3) = (ccpr @ (ccv @ Xa) @ XN)))) @ (^ [Xa:$i] : XV))) @ (^ [Xx3:$i] : (ccpw @ XV)))))) => (! [Xx3:$i] : (! [Xa:$i] : (((cwcel @ (XG @ Xa) @ cccusgr) & (cwcel @ XN @ XV)) => (cwss @ (XP @ Xx3 @ Xa) @ (ccfv @ (XG @ Xa) @ ccedg)))))))))))).
