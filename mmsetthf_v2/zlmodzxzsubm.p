...
thf(czlmodzxzsubm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => ((Xc_mi = (ccfv @ XZ @ ccsg)) => ((((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) & ((cwcel @ XC @ ccz) & (cwcel @ XD @ ccz))) => ((cco @ (ccpr @ (ccop @ ccc0 @ XA2) @ (ccop @ cc1 @ XC)) @ (ccpr @ (ccop @ ccc0 @ XB2) @ (ccop @ cc1 @ XD)) @ Xc_mi) = (cco @ (ccpr @ (ccop @ ccc0 @ XA2) @ (ccop @ cc1 @ XC)) @ (cco @ (ccneg @ cc1) @ (ccpr @ (ccop @ ccc0 @ XB2) @ (ccop @ cc1 @ XD)) @ (ccfv @ XZ @ ccvsca)) @ (ccfv @ XZ @ ccplusg))))))))))))).
