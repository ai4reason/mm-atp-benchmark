...
thf(aindf1o_ax,axiom,(! [XO:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XO @ XV) => (cwf1o @ (ccpw @ XO) @ (cco @ (ccpr @ ccc0 @ cc1) @ XO @ ccmap) @ (ccfv @ XO @ ccind)))))).
...
thf(aindpi1_ax,axiom,(! [XA2:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XO @ XV) & (cwss @ XA2 @ XO)) => ((ccima @ (cccnv @ (ccfv @ XA2 @ (ccfv @ XO @ ccind))) @ (ccsn @ cc1)) = XA2)))))).
...
thf(aindpreima_ax,axiom,(! [XF:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XO @ XV) & (cwf @ XO @ (ccpr @ ccc0 @ cc1) @ XF)) => (XF = (ccfv @ (ccima @ (cccnv @ XF) @ (ccsn @ cc1)) @ (ccfv @ XO @ ccind)))))))).
