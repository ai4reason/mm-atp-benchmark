...
thf(ccnres2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => ((cw3a @ ((cwcel @ XJ @ cctop) & (cwcel @ XK @ cctop)) @ ((cwss @ XA2 @ XX) & (cwss @ XB2 @ XY)) @ ((cwcel @ XF @ (cco @ XJ @ XK @ cccn)) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ XB2)) @ (^ [Xx3:$i] : XA2)))) => (cwcel @ (ccres @ XF @ XA2) @ (cco @ (cco @ XJ @ XA2 @ ccrest) @ (cco @ XK @ XB2 @ ccrest) @ cccn))))))))))))).
