...
thf(csge0ad2en_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccico))) => (Xph => ((ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ XA2 @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv))) @ ccsumge0) = XA2)))))).
