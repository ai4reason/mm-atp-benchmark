...
thf(ann01to3_ax,axiom,(! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn0) @ (cwbr @ cc1 @ XN @ ccle) @ (cwbr @ XN @ cc3 @ ccle)) => (cw3o @ (XN = cc1) @ (XN = cc2) @ (XN = cc3))))).
...
thf(ahash2pr_ax,axiom,(! [XV:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xa:$i] : (! [Xb:$i] : (((cwcel @ XV @ (XW @ Xa @ Xb)) & ((ccfv @ XV @ cchash) = cc2)) => (? [Xa:$i] : (? [Xb:$i] : (XV = (ccpr @ (ccv @ Xa) @ (ccv @ Xb))))))))))).
thf(a_3mix2_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (cw3o @ Xps @ Xph @ Xch)))))).
thf(cc3o_tp,type,(cc3o : ($i > $o))).
thf(ahash3tr_ax,axiom,(! [XV:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (((cwcel @ XV @ (XW @ Xa @ Xb @ Xc)) & ((ccfv @ XV @ cchash) = cc3)) => (? [Xa:$i] : (? [Xb:$i] : (? [Xc:$i] : (XV = (cctp @ (ccv @ Xa) @ (ccv @ Xb) @ (ccv @ Xc))))))))))))).
thf(a_3mix3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (cw3o @ Xps @ Xch @ Xph)))))).
thf(chash1to3_conj,conjecture,(! [XV:($i > $o)] : ((cw3a @ (cwcel @ XV @ ccfn) @ (cwbr @ cc1 @ (ccfv @ XV @ cchash) @ ccle) @ (cwbr @ (ccfv @ XV @ cchash) @ cc3 @ ccle)) => (? [Xa:$i] : (? [Xb:$i] : (? [Xc:$i] : (cw3o @ (XV = (ccsn @ (ccv @ Xa))) @ (XV = (ccpr @ (ccv @ Xa) @ (ccv @ Xb))) @ (XV = (cctp @ (ccv @ Xa) @ (ccv @ Xb) @ (ccv @ Xc)))))))))).
