...
thf(aeldioph4b_ax,axiom,(! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ ccvv) => ((~ (cwcel @ XW @ ccfn)) => (((ccin @ XW @ ccn) = cc0) => ((cwcel @ XS @ (ccfv @ XN @ ccdioph)) <=> ((cwcel @ XN @ ccn0) & (cwrex @ (^ [Xp:$i] : (XS = (ccrab @ (^ [Xt:$i] : (cwrex @ (^ [Xw:$i] : ((ccfv @ (ccun @ (ccv @ Xt) @ (ccv @ Xw)) @ (ccv @ Xp)) = ccc0)) @ (^ [Xw:$i] : (cco @ ccn0 @ XW @ ccmap)))) @ (^ [Xt:$i] : (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap))))) @ (^ [Xp:$i] : (ccfv @ (ccun @ XW @ (cco @ cc1 @ XN @ ccfz)) @ ccmzp)))))))))))).
