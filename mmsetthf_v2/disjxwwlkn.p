...
thf(awwlkssswwlksn_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (cwss @ (cco @ XN @ XG @ ccwwlksn) @ (ccfv @ XG @ ccwwlks))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(awwlkssswrd_ax,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (cwss @ (ccfv @ XG @ ccwwlks) @ (ccword @ XV)))))).
...
thf(cdisjxwwlkn_conj,conjecture,(! [XP:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xw:$i] : ((XX @ Xw) = (cco @ (cco @ XN @ cc1 @ ccaddc) @ (XG @ Xy1) @ ccwwlksn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((XE @ Xx3 @ Xw) = (ccfv @ (XG @ Xy1) @ ccedg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((XY @ Xx3 @ Xw) = (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = (XP @ Xx3))) @ (^ [Xw:$i] : (cco @ XN @ (XG @ Xy1) @ ccwwlksn))))))) => (! [Xx3:$i] : (! [Xw:$i] : (cwdisj @ (^ [Xy1:$i] : (XY @ Xx3 @ Xw)) @ (^ [Xy1:$i] : (ccrab @ (^ [Xx3:$i] : (cw3a @ ((cco @ (ccv @ Xx3) @ (ccop @ ccc0 @ (XM @ Xx3 @ Xw)) @ ccsubstr) = (ccv @ Xy1)) @ ((ccfv @ ccc0 @ (ccv @ Xy1)) = (XP @ Xx3)) @ (cwcel @ (ccpr @ (ccfv @ (ccv @ Xy1) @ cclsw) @ (ccfv @ (ccv @ Xx3) @ cclsw)) @ (XE @ Xx3 @ Xw)))) @ (^ [Xx3:$i] : (XX @ Xw)))))))))))))))))).
