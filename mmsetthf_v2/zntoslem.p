...
thf(aznleval2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XN @ cczn)) => ((XF = (ccres @ (ccfv @ XY @ cczrh) @ XW)) => ((XW = (ccif @ (XN = ccc0) @ ccz @ (cco @ ccc0 @ XN @ ccfzo))) => ((Xc_le = (ccfv @ XY @ ccple)) => ((XX = (ccfv @ XY @ ccbs)) => ((cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) => ((cwbr @ XA2 @ XB2 @ Xc_le) <=> (cwbr @ (ccfv @ XA2 @ (cccnv @ XF)) @ (ccfv @ XB2 @ (cccnv @ XF)) @ ccle))))))))))))))))).
