...
thf(ah1de2ctlem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cwcel @ XA2 @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) <=> (cwrex @ (^ [Xx3:$i] : (XA2 = (cco @ (ccv @ Xx3) @ XB2 @ ccsm))) @ (^ [Xx3:$i] : ccc)))))))).
thf(aifhvhv0_ax,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccif @ (cwcel @ XA2 @ cchil) @ XA2 @ cc0v) @ cchil))).
thf(ch1de2ci_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ cchil) => ((cwcel @ XA2 @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) <=> (cwrex @ (^ [Xx3:$i] : (XA2 = (cco @ (ccv @ Xx3) @ XB2 @ ccsm))) @ (^ [Xx3:$i] : ccc))))))).
