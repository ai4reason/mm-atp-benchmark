...
thf(crpdvds_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) & (((cco @ XK @ XN @ ccgcd) = cc1) & (cwbr @ XM @ XN @ ccdvds))) => ((cco @ XK @ XM @ ccgcd) = cc1)))))).
