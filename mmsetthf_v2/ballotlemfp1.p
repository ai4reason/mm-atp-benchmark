...
thf(afzspl_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ XM @ ccuz)) => ((cco @ XM @ XN @ ccfz) = (ccun @ (cco @ XM @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (ccsn @ XN))))))).
...
thf(auznfz_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (ccfv @ XN @ ccuz)) => (~ (cwcel @ XK @ (cco @ XM @ (cco @ XN @ cc1 @ ccmin) @ ccfz)))))))).
