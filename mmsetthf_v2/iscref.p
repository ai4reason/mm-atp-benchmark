...
thf(adf_cref_ax,axiom,(! [XA2:($i > $o)] : ((cccref @ XA2) = (ccrab @ (^ [Xj:$i] : (cwral @ (^ [Xy1:$i] : (((ccuni @ (ccv @ Xj)) = (ccuni @ (ccv @ Xy1))) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccref)) @ (^ [Xz:$i] : (ccin @ (ccpw @ (ccv @ Xj)) @ XA2))))) @ (^ [Xy1:$i] : (ccpw @ (ccv @ Xj))))) @ (^ [Xj:$i] : cctop))))).
thf(ciscref_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xz:$i] : ((XX @ Xy1 @ Xz) = (ccuni @ XJ)))) => (! [Xz:$i] : ((cwcel @ XJ @ (cccref @ XA2)) <=> ((cwcel @ XJ @ cctop) & (cwral @ (^ [Xy1:$i] : (((XX @ Xy1 @ Xz) = (ccuni @ (ccv @ Xy1))) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccref)) @ (^ [Xz:$i] : (ccin @ (ccpw @ XJ) @ XA2))))) @ (^ [Xy1:$i] : (ccpw @ XJ))))))))))).
