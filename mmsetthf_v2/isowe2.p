...
thf(aisosolem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : ((cwiso @ XA2 @ XB2 @ XR @ XS @ XH) => ((cwor @ XB2 @ XS) => (cwor @ XA2 @ XR))))))))).
thf(adf_we_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwwe @ XA2 @ XR) <=> ((cwfr @ XA2 @ XR) & (cwor @ XA2 @ XR)))))).
thf(cisowe2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (((cwiso @ XA2 @ XB2 @ XR @ XS @ XH) & (! [Xx3:$i] : (cwcel @ (ccima @ XH @ (ccv @ Xx3)) @ ccvv))) => ((cwwe @ XB2 @ XS) => (cwwe @ XA2 @ XR))))))))).
