...
thf(ashsub2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccsh) & (cwcel @ XB2 @ ccsh)) => (cwss @ XA2 @ (cco @ XB2 @ XA2 @ ccph)))))).
...
thf(aspansn0_ax,axiom,((ccfv @ (ccsn @ cc0v) @ ccspn) = cc0h)).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ashs0i_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cco @ XA2 @ cc0h @ ccph) = XA2)))).
...
thf(asumdmdlem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (((cwcel @ XC @ cchil) & (~ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccph)))) => ((ccin @ (cco @ XB2 @ (ccfv @ (ccsn @ XC) @ ccspn) @ ccph) @ XA2) = (ccin @ XB2 @ XA2))))))))).
thf(ashsub2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => (cwss @ XA2 @ (cco @ XB2 @ XA2 @ ccph))))))).
thf(apm2_18_ax,axiom,(! [Xph:$o] : (((~ Xph) => Xph) => Xph))).
...
thf(csumdmdlem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwral @ (^ [Xx3:$i] : (cwss @ (ccin @ (cco @ (ccv @ Xx3) @ XB2 @ cchj) @ (cco @ XA2 @ XB2 @ cchj)) @ (cco @ (ccin @ (cco @ (ccv @ Xx3) @ XB2 @ cchj) @ XA2) @ XB2 @ cchj))) @ (^ [Xx3:$i] : ccat)) => ((cco @ XA2 @ XB2 @ ccph) = (cco @ XA2 @ XB2 @ cchj)))))))).
