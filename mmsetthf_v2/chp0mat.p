...
thf(cchp0mat_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XC = (cco @ XN @ XR @ ccchpmat)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XX = (ccfv @ XR @ ccv1)) => ((XG = (ccfv @ XP @ ccmgp)) => ((Xc_ex = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XA2 @ cc0g)) => (((cwcel @ XN @ ccfn) & (cwcel @ XR @ cccrg)) => ((ccfv @ Xc_0 @ XC) = (cco @ (ccfv @ XN @ cchash) @ XX @ Xc_ex)))))))))))))))))))).
