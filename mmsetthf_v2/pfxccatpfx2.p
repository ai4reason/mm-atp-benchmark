...
thf(cpfxccatpfx2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XL = (ccfv @ XA2 @ cchash)) => ((XM = (ccfv @ XB2 @ cchash)) => ((cw3a @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV)) @ (cwcel @ XN @ (cco @ (cco @ XL @ cc1 @ ccaddc) @ (cco @ XL @ XM @ ccaddc) @ ccfz))) => ((cco @ (cco @ XA2 @ XB2 @ ccconcat) @ XN @ ccpfx) = (cco @ XA2 @ (cco @ XB2 @ (cco @ XN @ XL @ ccmin) @ ccpfx) @ ccconcat)))))))))))).
