...
thf(apockthg_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccn)) => ((! [Xx3:$i] : (! [Xp:$i] : (Xph => (cwcel @ (XB2 @ Xx3 @ Xp) @ ccn)))) => ((! [Xx3:$i] : (! [Xp:$i] : (Xph => (cwbr @ (XB2 @ Xx3 @ Xp) @ XA2 @ cclt)))) => ((! [Xx3:$i] : (! [Xp:$i] : (Xph => (XN = (cco @ (cco @ XA2 @ (XB2 @ Xx3 @ Xp) @ ccmul) @ cc1 @ ccaddc))))) => ((Xph => (cwral @ (^ [Xp:$i] : ((cwbr @ (ccv @ Xp) @ XA2 @ ccdvds) => (cwrex @ (^ [Xx3:$i] : (((cco @ (cco @ (ccv @ Xx3) @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ XN @ ccmo) = cc1) & ((cco @ (cco @ (cco @ (ccv @ Xx3) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ (ccv @ Xp) @ ccdiv) @ ccexp) @ cc1 @ ccmin) @ XN @ ccgcd) = cc1))) @ (^ [Xx3:$i] : ccz)))) @ (^ [Xp:$i] : ccprime))) => (Xph => (cwcel @ XN @ ccprime)))))))))))).
...
thf(aprmdvdsexpb_ax,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XQ @ ccprime) @ (cwcel @ XN @ ccn)) => ((cwbr @ XP @ (cco @ XQ @ XN @ ccexp) @ ccdvds) <=> (XP = XQ))))))).
...
thf(aproththdlem_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XK @ ccn)) => ((Xph => (XP = (cco @ (cco @ XK @ (cco @ cc2 @ XN @ ccexp) @ ccmul) @ cc1 @ ccaddc))) => (Xph => (cw3a @ (cwcel @ XP @ ccn) @ (cwbr @ cc1 @ XP @ cclt) @ (cwcel @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn))))))))))).
...
thf(amodexp2m1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XE:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XE @ ccrp)) => ((Xph => (cwbr @ cc1 @ XE @ cclt)) => ((Xph => ((cco @ XA2 @ XE @ ccmo) = (cco @ (ccneg @ cc1) @ XE @ ccmo))) => (Xph => ((cco @ (cco @ XA2 @ cc2 @ ccexp) @ XE @ ccmo) = cc1)))))))))).
...
thf(amodsub12d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwcel @ XD @ ccr)) => ((Xph => (cwcel @ XE @ ccrp)) => ((Xph => ((cco @ XA2 @ XE @ ccmo) = (cco @ XB2 @ XE @ ccmo))) => ((Xph => ((cco @ XC @ XE @ ccmo) = (cco @ XD @ XE @ ccmo))) => (Xph => ((cco @ (cco @ XA2 @ XC @ ccmin) @ XE @ ccmo) = (cco @ (cco @ XB2 @ XD @ ccmin) @ XE @ ccmo))))))))))))))))).
...
thf(amodgcd_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccn)) => ((cco @ (cco @ XM @ XN @ ccmo) @ XN @ ccgcd) = (cco @ XM @ XN @ ccgcd)))))).
...
thf(aneggcd_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ (ccneg @ XM) @ XN @ ccgcd) = (cco @ XM @ XN @ ccgcd)))))).
...
thf(aoddm1d2_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((~ (cwbr @ cc2 @ XN @ ccdvds)) <=> (cwcel @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccz))))).
thf(aisoddgcd1_ax,axiom,(! [XZ:($i > $o)] : ((cwcel @ XZ @ ccz) => ((~ (cwbr @ cc2 @ XZ @ ccdvds)) <=> ((cco @ cc2 @ XZ @ ccgcd) = cc1))))).
thf(cproththd_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((! [Xx3:$i] : (Xph => (cwcel @ (XK @ Xx3) @ ccn))) => ((! [Xx3:$i] : (Xph => (XP = (cco @ (cco @ (XK @ Xx3) @ (cco @ cc2 @ XN @ ccexp) @ ccmul) @ cc1 @ ccaddc)))) => ((! [Xx3:$i] : (Xph => (cwbr @ (XK @ Xx3) @ (cco @ cc2 @ XN @ ccexp) @ cclt))) => ((Xph => (cwrex @ (^ [Xx3:$i] : ((cco @ (cco @ (ccv @ Xx3) @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ XP @ ccmo) = (cco @ (ccneg @ cc1) @ XP @ ccmo))) @ (^ [Xx3:$i] : ccz))) => (Xph => (cwcel @ XP @ ccprime)))))))))))).
