...
thf(clogbfval_conj,conjecture,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (((cw3a @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0) @ (cwne @ XB2 @ cc1)) & (cwcel @ XX @ (ccdif @ ccc @ (ccsn @ ccc0)))) => ((ccfv @ XX @ (ccfv @ XB2 @ (cccur @ cclogb))) = (cco @ XB2 @ XX @ cclogb)))))).
