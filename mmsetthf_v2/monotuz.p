...
thf(cmonotuz_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XH)) => (cwbr @ (XF @ Xy1) @ (XG @ Xy1) @ cclt))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XH)) => (cwcel @ (XC @ Xx3) @ ccr))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XH = (ccfv @ (XI @ Xx3 @ Xy1) @ ccuz)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) => ((XC @ Xx3) = (XG @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((XC @ Xx3) = (XF @ Xy1))))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((XC @ Xx3) = XD))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XB2) => ((XC @ Xx3) = XE))) => ((Xph & ((cwcel @ XA2 @ XH) & (cwcel @ XB2 @ XH))) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ XD @ XE @ cclt))))))))))))))))))))).
