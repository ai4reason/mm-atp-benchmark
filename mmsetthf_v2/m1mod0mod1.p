...
thf(amodsubmod_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XM @ ccrp)) => ((cco @ (cco @ (cco @ XA2 @ XM @ ccmo) @ XB2 @ ccmin) @ XM @ ccmo) = (cco @ (cco @ XA2 @ XB2 @ ccmin) @ XM @ ccmo))))))).
thf(a_0mod_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccrp) => ((cco @ ccc0 @ XN @ ccmo) = ccc0)))).
thf(cm1mod0mod1_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XN @ ccr) @ (cwbr @ cc1 @ XN @ cclt)) => (((cco @ (cco @ XA2 @ cc1 @ ccmin) @ XN @ ccmo) = ccc0) <=> ((cco @ XA2 @ XN @ ccmo) = cc1)))))).
