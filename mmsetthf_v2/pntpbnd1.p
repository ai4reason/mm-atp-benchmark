...
thf(aefgt0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwbr @ ccc0 @ (ccfv @ XA2 @ cce) @ cclt)))).
...
thf(aabsnidd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ XA2 @ ccc0 @ ccle)) => (Xph => ((ccfv @ XA2 @ ccabs) = (ccneg @ XA2)))))))).
...
thf(ale0neg1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => ((cwbr @ XA2 @ ccc0 @ ccle) <=> (cwbr @ ccc0 @ (ccneg @ XA2) @ ccle))))))).
...
thf(aefgt1_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwbr @ cc1 @ (ccfv @ XA2 @ cce) @ cclt)))).
...
thf(aflword2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ ccle)) => (cwcel @ (ccfv @ XB2 @ ccfl) @ (ccfv @ (ccfv @ XA2 @ ccfl) @ ccuz)))))).
...
thf(aelfzuzb_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ XM @ XN @ ccfz)) <=> ((cwcel @ XK @ (ccfv @ XM @ ccuz)) & (cwcel @ XN @ (ccfv @ XK @ ccuz)))))))).
thf(afzind2_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XM) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) => ((Xph @ Xx3) <=> (Xth @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XK @ Xy1)) => ((Xph @ Xx3) <=> (Xta @ Xy1))))) => ((! [Xy1:$i] : ((cwcel @ XN @ (ccfv @ XM @ ccuz)) => (Xps @ Xy1))) => ((! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ (cco @ XM @ XN @ ccfzo)) => ((Xch @ Xy1) => (Xth @ Xy1)))) => (! [Xy1:$i] : ((cwcel @ (XK @ Xy1) @ (cco @ XM @ XN @ ccfz)) => (Xta @ Xy1)))))))))))))))))).
...
thf(aelfzle3_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ XM @ XN @ ccfz)) => (cwbr @ XM @ XN @ ccle)))))).
...
thf(aletrid_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((cwbr @ XA2 @ XB2 @ ccle) | (cwbr @ XB2 @ XA2 @ ccle))))))))).
...
thf(aflge_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccz)) => ((cwbr @ XB2 @ XA2 @ ccle) <=> (cwbr @ XB2 @ (ccfv @ XA2 @ ccfl) @ ccle)))))).
thf(cc3_tp,type,(cc3 : ($i > $o))).
thf(cceu_tp,type,(cceu : ($i > $o))).
thf(ccvma_tp,type,(ccvma : ($i > $o))).
thf(cclog_tp,type,(cclog : ($i > $o))).
thf(apntpbnd1a_ax,axiom,(! [Xph:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xa:$i] : ((XR @ Xa) = (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin))))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwcel @ (XE @ Xa) @ (cco @ ccc0 @ cc1 @ ccioo)))) => ((! [Xa:$i] : ((XX @ Xa) = (ccfv @ (cco @ cc2 @ (XE @ Xa) @ ccdiv) @ cce))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwcel @ (XY @ Xa) @ (cco @ (XX @ Xa) @ ccpnf @ ccioo)))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwcel @ XN @ ccn))) => ((! [Xa:$i] : ((Xph @ Xa) => ((cwbr @ (XY @ Xa) @ XN @ cclt) & (cwbr @ XN @ (cco @ (XK @ Xa) @ (XY @ Xa) @ ccmul) @ ccle)))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwbr @ (ccfv @ (ccfv @ XN @ (XR @ Xa)) @ ccabs) @ (ccfv @ (cco @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ (XR @ Xa)) @ (ccfv @ XN @ (XR @ Xa)) @ ccmin) @ ccabs) @ ccle))) => (! [Xa:$i] : ((Xph @ Xa) => (cwbr @ (ccfv @ (cco @ (ccfv @ XN @ (XR @ Xa)) @ XN @ ccdiv) @ ccabs) @ (XE @ Xa) @ ccle)))))))))))))))))).
...
thf(aaddge02d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((cwbr @ ccc0 @ XB2 @ ccle) <=> (cwbr @ XA2 @ (cco @ XB2 @ XA2 @ ccaddc) @ ccle))))))))).
...
thf(cpntpbnd1_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XR:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XY:($i > ($i > $o))] : ((! [Xa:$i] : ((XR @ Xa) = (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xi @ Xj @ Xa) => (cwcel @ (XE @ Xi @ Xj @ Xa) @ (cco @ ccc0 @ cc1 @ ccioo))))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : ((XX @ Xy1 @ Xi @ Xj @ Xn @ Xa) = (ccfv @ (cco @ cc2 @ (XE @ Xi @ Xj @ Xa) @ ccdiv) @ cce))))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xi @ Xj @ Xa) => (cwcel @ (XY @ Xa) @ (cco @ (XX @ Xy1 @ Xi @ Xj @ Xn @ Xa) @ ccpnf @ ccioo)))))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xi @ Xj @ Xa) => (cwcel @ XA2 @ ccrp)))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xi @ Xj @ Xa) => (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwbr @ (ccfv @ (ccsu @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ ccfz) @ (^ [Xy1:$i] : (cco @ (ccfv @ (ccv @ Xy1) @ (XR @ Xa)) @ (cco @ (ccv @ Xy1) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ ccmul) @ ccdiv))) @ ccabs) @ XA2 @ ccle)) @ (^ [Xj:$i] : ccz))) @ (^ [Xi:$i] : ccn))))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : ((XC @ Xy1 @ Xi @ Xj @ Xn @ Xa) = (cco @ XA2 @ cc2 @ ccaddc))))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xi @ Xj @ Xa) => (cwcel @ (XK @ Xa) @ (cco @ (ccfv @ (cco @ (XC @ Xy1 @ Xi @ Xj @ Xn @ Xa) @ (XE @ Xi @ Xj @ Xa) @ ccdiv) @ cce) @ ccpnf @ ccico)))))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xi @ Xj @ Xa) => (~ (cwrex @ (^ [Xy1:$i] : (((cwbr @ (XY @ Xa) @ (ccv @ Xy1) @ cclt) & (cwbr @ (ccv @ Xy1) @ (cco @ (XK @ Xa) @ (XY @ Xa) @ ccmul) @ ccle)) & (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ (XR @ Xa)) @ (ccv @ Xy1) @ ccdiv) @ ccabs) @ (XE @ Xi @ Xj @ Xa) @ ccle))) @ (^ [Xy1:$i] : ccn)))))))) => (! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xi @ Xj @ Xa) => (cwbr @ (ccsu @ (cco @ (cco @ (ccfv @ (XY @ Xa) @ ccfl) @ cc1 @ ccaddc) @ (ccfv @ (cco @ (XK @ Xa) @ (XY @ Xa) @ ccmul) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xn) @ (XR @ Xa)) @ (cco @ (ccv @ Xn) @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccmul) @ ccdiv) @ ccabs))) @ XA2 @ ccle)))))))))))))))))))))))).
