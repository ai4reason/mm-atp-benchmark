...
thf(adia0_ax,axiom,(! [XB2:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdia))) => (((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) => ((ccfv @ Xc_0 @ XI) = (ccsn @ (ccres @ ccid @ XB2))))))))))))))).
