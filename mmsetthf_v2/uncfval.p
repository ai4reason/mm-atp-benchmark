...
thf(adf_uncf_ax,axiom,(ccuncf = (ccmpt2 @ (^ [Xc:$i] : (^ [Xf1:$i] : ccvv)) @ (^ [Xc:$i] : (^ [Xf1:$i] : ccvv)) @ (^ [Xc:$i] : (^ [Xf1:$i] : (cco @ (cco @ (ccfv @ cc1 @ (ccv @ Xc)) @ (ccfv @ cc2 @ (ccv @ Xc)) @ ccevlf) @ (cco @ (cco @ (ccv @ Xf1) @ (cco @ (ccfv @ ccc0 @ (ccv @ Xc)) @ (ccfv @ cc1 @ (ccv @ Xc)) @ cc1stf) @ cccofu) @ (cco @ (ccfv @ ccc0 @ (ccv @ Xc)) @ (ccfv @ cc1 @ (ccv @ Xc)) @ cc2ndf) @ ccprf) @ cccofu)))))).
...
thf(cuncfval_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XF = (cco @ (ccs3 @ XC @ XD @ XE) @ XG @ ccuncf)) => ((Xph => (cwcel @ XD @ cccat)) => ((Xph => (cwcel @ XE @ cccat)) => ((Xph => (cwcel @ XG @ (cco @ XC @ (cco @ XD @ XE @ ccfuc) @ ccfunc))) => (Xph => (XF = (cco @ (cco @ XD @ XE @ ccevlf) @ (cco @ (cco @ XG @ (cco @ XC @ XD @ cc1stf) @ cccofu) @ (cco @ XC @ XD @ cc2ndf) @ ccprf) @ cccofu)))))))))))))).
