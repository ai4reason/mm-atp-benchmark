...
thf(afin33i_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccfin3) @ (cwf @ ccom @ (ccpw @ XA2) @ XF) @ (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : ccom))) => (cwcel @ (ccint @ (ccrn @ XF)) @ (ccrn @ XF)))))).
...
thf(aisf34lem5_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ XV) & ((cwss @ (XX @ Xx3) @ (ccpw @ XA2)) & (cwne @ (XX @ Xx3) @ cc0))) => ((ccfv @ (ccint @ (XX @ Xx3)) @ (XF @ Xx3)) = (ccuni @ (ccima @ (XF @ Xx3) @ (XX @ Xx3)))))))))))).
...
thf(cisf34lem7_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XA2 @ ccfin3) @ (cwf @ ccom @ (ccpw @ XA2) @ (XG @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (cwss @ (ccfv @ (ccv @ Xy1) @ (XG @ Xx3)) @ (ccfv @ (ccsuc @ (ccv @ Xy1)) @ (XG @ Xx3)))) @ (^ [Xy1:$i] : ccom))) => (cwcel @ (ccuni @ (ccrn @ (XG @ Xx3))) @ (ccrn @ (XG @ Xx3)))))))))).
