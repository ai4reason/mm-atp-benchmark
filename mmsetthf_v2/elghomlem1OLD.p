...
thf(afabexg_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccab @ (^ [Xx3:$i] : ((cwf @ XA2 @ XB2 @ (ccv @ Xx3)) & (Xph @ Xx3)))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ (XC @ Xx3)) & (cwcel @ XB2 @ (XD @ Xx3))) => (cwcel @ (XF @ Xx3) @ ccvv))))))))))).
...
thf(adf_ghomOLD_ax,axiom,(ccghomOLD = (ccmpt2 @ (^ [Xg1:$i] : (^ [Xh:$i] : ccgr)) @ (^ [Xg1:$i] : (^ [Xh:$i] : ccgr)) @ (^ [Xg1:$i] : (^ [Xh:$i] : (ccab @ (^ [Xf1:$i] : ((cwf @ (ccrn @ (ccv @ Xg1)) @ (ccrn @ (ccv @ Xh)) @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccv @ Xh)) = (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xg1)) @ (ccv @ Xf1)))) @ (^ [Xy1:$i] : (ccrn @ (ccv @ Xg1))))) @ (^ [Xx3:$i] : (ccrn @ (ccv @ Xg1)))))))))))).
thf(celghomlem1OLD_conj,conjecture,(! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : ((XS @ Xx3 @ Xy1 @ Xf1) = (ccab @ (^ [Xf1:$i] : ((cwf @ (ccrn @ XG) @ (ccrn @ XH) @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ XH) = (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) @ (ccv @ Xf1)))) @ (^ [Xy1:$i] : (ccrn @ XG)))) @ (^ [Xx3:$i] : (ccrn @ XG)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (((cwcel @ XG @ ccgr) & (cwcel @ XH @ ccgr)) => ((cco @ XG @ XH @ ccghomOLD) = (XS @ Xx3 @ Xy1 @ Xf1))))))))))).
