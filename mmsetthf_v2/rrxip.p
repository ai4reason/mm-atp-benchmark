...
thf(arrxprds_ax,axiom,(! [XB2:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XH = (ccfv @ XI @ ccrrx)) => ((XB2 = (ccfv @ XH @ ccbs)) => ((cwcel @ XI @ XV) => (XH = (ccfv @ (cco @ (cco @ ccrefld @ (ccxp @ XI @ (ccsn @ (ccfv @ ccr @ (ccfv @ ccrefld @ ccsra)))) @ ccprds) @ XB2 @ ccress) @ cctch)))))))))).
thf(asyl5eqr_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XB2 = XA2) => ((Xph => (XB2 = XC)) => (Xph => (XA2 = XC))))))))).
thf(ccsqrt_tp,type,(ccsqrt : ($i > $o))).
thf(atchip_ax,axiom,(! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XW @ cctch)) => ((Xc_x = (ccfv @ XW @ ccip)) => (Xc_x = (ccfv @ XG @ ccip)))))))).
...
thf(aprdsip_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_xi:($i > ($i > ($i > ($i > $o))))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : ((XP = (cco @ XS @ XR @ ccprds)) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (Xph => (cwcel @ XS @ (XV @ Xx3 @ Xf1 @ Xg1)))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (Xph => (cwcel @ XR @ (XW @ Xx3 @ Xf1 @ Xg1)))))) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xph => ((ccdm @ XR) = XI)) => ((! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xc_xi @ Xx3 @ Xf1 @ Xg1) = (ccfv @ XP @ ccip))))) => (! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (Xph => ((Xc_xi @ Xx3 @ Xf1 @ Xg1) = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : XB2)) @ (^ [Xf1:$i] : (^ [Xg1:$i] : XB2)) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ XS @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccip)))) @ ccgsu))))))))))))))))))))))))).
thf(aa1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(ccsubrg_tp,type,(ccsubrg : ($i > $o))).
thf(cccnfld_tp,type,(cccnfld : ($i > $o))).
thf(cccrg_tp,type,(cccrg : ($i > $o))).
thf(ccdr_tp,type,(ccdr : ($i > $o))).
thf(arefld_ax,axiom,(cwcel @ ccrefld @ ccfield)).
...
thf(aremulr_ax,axiom,(ccmul = (ccfv @ ccrefld @ ccmulr))).
thf(ccsts_tp,type,(ccsts : ($i > $o))).
thf(asraip_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (XA2 = (ccfv @ XS @ (ccfv @ XW @ ccsra)))) => ((Xph => (cwss @ XS @ (ccfv @ XW @ ccbs))) => (Xph => ((ccfv @ XW @ ccmulr) = (ccfv @ XA2 @ ccip)))))))))).
