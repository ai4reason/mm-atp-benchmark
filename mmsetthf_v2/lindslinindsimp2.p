...
thf(alspeqlco_ax,axiom,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => (((cwcel @ XM @ cclmod) & (cwcel @ XV @ (ccpw @ XB2))) => ((cco @ XM @ XV @ cclinco) = (ccfv @ XV @ (ccfv @ XM @ cclspn))))))))).
