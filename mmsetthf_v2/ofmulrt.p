...
thf(cofmulrt_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XV) @ (cwf @ XA2 @ ccc @ XF) @ (cwf @ XA2 @ ccc @ XG)) => ((ccima @ (cccnv @ (cco @ XF @ XG @ (ccof @ ccmul))) @ (ccsn @ ccc0)) = (ccun @ (ccima @ (cccnv @ XF) @ (ccsn @ ccc0)) @ (ccima @ (cccnv @ XG) @ (ccsn @ ccc0)))))))))).
