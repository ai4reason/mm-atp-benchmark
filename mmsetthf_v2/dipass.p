...
thf(aelimphu_ax,axiom,(! [XU:($i > $o)] : (cwcel @ (ccif @ (cwcel @ XU @ cccphlo) @ XU @ (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs)) @ cccphlo))).
thf(cdipass_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XS = (ccfv @ XU @ ccns)) => ((XP = (ccfv @ XU @ ccdip)) => (((cwcel @ XU @ cccphlo) & (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX))) => ((cco @ (cco @ XA2 @ XB2 @ XS) @ XC @ XP) = (cco @ XA2 @ (cco @ XB2 @ XC @ XP) @ ccmul)))))))))))))).
