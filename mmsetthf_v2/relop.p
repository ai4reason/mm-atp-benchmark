...
thf(aelop_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XA2 @ (ccop @ XB2 @ XC)) <=> ((XA2 = (ccsn @ XB2)) | (XA2 = (ccpr @ XB2 @ XC)))))))))).
...
thf(aopeqsn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => (((ccop @ XA2 @ XB2) = (ccsn @ XC)) <=> ((XA2 = XB2) & (XC = (ccsn @ XA2))))))))))).
...
thf(aopeqpr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XD @ ccvv) => (((ccop @ XA2 @ XB2) = (ccpr @ XC @ XD)) <=> (((XC = (ccsn @ XA2)) & (XD = (ccpr @ XA2 @ XB2))) | ((XC = (ccpr @ XA2 @ XB2)) & (XD = (ccsn @ XA2)))))))))))))).
...
thf(apreqsn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => (((ccpr @ XA2 @ XB2) = (ccsn @ XC)) <=> ((XA2 = XB2) & (XB2 = XC)))))))))).
...
thf(crelop_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwrel @ (ccop @ XA2 @ XB2)) <=> (? [Xx3:$i] : (? [Xy1:$i] : ((XA2 = (ccsn @ (ccv @ Xx3))) & (XB2 = (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)))))))))))).
