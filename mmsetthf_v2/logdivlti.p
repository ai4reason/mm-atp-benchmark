...
thf(clogdivlti_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ cceu @ XA2 @ ccle)) & (cwbr @ XA2 @ XB2 @ cclt)) => (cwbr @ (cco @ (ccfv @ XB2 @ cclog) @ XB2 @ ccdiv) @ (cco @ (ccfv @ XA2 @ cclog) @ XA2 @ ccdiv) @ cclt))))).
