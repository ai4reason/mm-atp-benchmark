...
thf(aovoliun_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xn:$i] : ((XT @ Xn) = (ccseq @ ccaddc @ (XG @ Xn) @ cc1))) => ((! [Xn:$i] : ((XG @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (XA2 @ Xn) @ ccovol))))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwss @ (XA2 @ Xn) @ ccr))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwcel @ (ccfv @ (XA2 @ Xn) @ ccovol) @ ccr))) => (! [Xn:$i] : (Xph => (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccovol) @ (ccsup @ (ccrn @ (XT @ Xn)) @ ccxr @ cclt) @ ccle)))))))))))).
...
thf(avoliunlem1_ax,axiom,(! [Xph:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : ((Xph @ Xi) => (cwf @ ccn @ (ccdm @ ccvol) @ XF))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwdisj @ (^ [Xi:$i] : ccn) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XF))))) => ((! [Xi:$i] : (! [Xn:$i] : ((XH @ Xi @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccin @ (XE @ Xi) @ (ccfv @ (ccv @ Xn) @ XF)) @ ccovol)))))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwss @ (XE @ Xi) @ ccr))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwcel @ (ccfv @ (XE @ Xi) @ ccovol) @ ccr))) => (! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : (((Xph @ Xi) & (cwcel @ (ccv @ Xk) @ ccn)) => (cwbr @ (cco @ (ccfv @ (ccv @ Xk) @ (ccseq @ ccaddc @ (XH @ Xi @ Xn) @ cc1)) @ (ccfv @ (ccdif @ (XE @ Xi) @ (ccuni @ (ccrn @ XF))) @ ccovol) @ ccaddc) @ (ccfv @ (XE @ Xi) @ ccovol) @ ccle))))))))))))))).
...
thf(aismbl_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccvol)) <=> ((cwss @ XA2 @ ccr) & (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccfv @ (ccv @ Xx3) @ ccovol) @ ccr) => ((ccfv @ (ccv @ Xx3) @ ccovol) = (cco @ (ccfv @ (ccin @ (ccv @ Xx3) @ XA2) @ ccovol) @ (ccfv @ (ccdif @ (ccv @ Xx3) @ XA2) @ ccovol) @ ccaddc)))) @ (^ [Xx3:$i] : (ccpw @ ccr))))))).
thf(cvoliunlem2_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : ((Xph @ Xi) => (cwf @ ccn @ (ccdm @ ccvol) @ XF))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwdisj @ (^ [Xi:$i] : ccn) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XF))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xn:$i] : ((XH @ Xx3 @ Xi @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccin @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF)) @ ccovol))))))) => (! [Xi:$i] : ((Xph @ Xi) => (cwcel @ (ccuni @ (ccrn @ XF)) @ (ccdm @ ccvol))))))))))).
