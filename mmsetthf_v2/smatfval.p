...
thf(csmatfval_conj,conjecture,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xi:$i] : (! [Xj:$i] : ((cw3a @ (cwcel @ XK @ ccn) @ (cwcel @ XL @ ccn) @ (cwcel @ (XM @ Xi @ Xj) @ (XV @ Xi @ Xj))) => ((cco @ XK @ XL @ (ccfv @ (XM @ Xi @ Xj) @ ccsmat)) = (cccom @ (XM @ Xi @ Xj) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : ccn)) @ (^ [Xi:$i] : (^ [Xj:$i] : ccn)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccop @ (ccif @ (cwbr @ (ccv @ Xi) @ XK @ cclt) @ (ccv @ Xi) @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc)) @ (ccif @ (cwbr @ (ccv @ Xj) @ XL @ cclt) @ (ccv @ Xj) @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc)))))))))))))))).
