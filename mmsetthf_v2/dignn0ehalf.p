...
thf(cdignn0ehalf_conj,conjecture,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : ((cw3a @ (cwcel @ (cco @ XA2 @ cc2 @ ccdiv) @ ccn0) @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XI @ ccn0)) => ((cco @ (cco @ XI @ cc1 @ ccaddc) @ XA2 @ (ccfv @ cc2 @ ccdig)) = (cco @ XI @ (cco @ XA2 @ cc2 @ ccdiv) @ (ccfv @ cc2 @ ccdig))))))).
