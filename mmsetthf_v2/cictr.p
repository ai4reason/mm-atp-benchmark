...
thf(acicrcl_ax,axiom,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XC @ cccat) & (cwbr @ XR @ XS @ (ccfv @ XC @ cccic))) => (cwcel @ XS @ (ccfv @ XC @ ccbs))))))).
...
thf(abrcici_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XI = (ccfv @ XC @ cciso)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XF @ (cco @ XX @ XY @ XI))) => (Xph => (cwbr @ XX @ XY @ (ccfv @ XC @ cccic))))))))))))))))).
thf(ccinv_tp,type,(ccinv : ($i > $o))).
thf(aisoco_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((Xc_x = (ccfv @ XC @ ccco)) => ((XI = (ccfv @ XC @ cciso)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XZ @ XB2)) => ((Xph => (cwcel @ XF @ (cco @ XX @ XY @ XI))) => ((Xph => (cwcel @ XG @ (cco @ XY @ XZ @ XI))) => (Xph => (cwcel @ (cco @ XG @ XF @ (cco @ (ccop @ XX @ XY) @ XZ @ Xc_x)) @ (cco @ XX @ XZ @ XI))))))))))))))))))))))).
thf(ccictr_conj,conjecture,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwcel @ XC @ cccat) @ (cwbr @ XR @ XS @ (ccfv @ XC @ cccic)) @ (cwbr @ XS @ XT @ (ccfv @ XC @ cccic))) => (cwbr @ XR @ XT @ (ccfv @ XC @ cccic)))))))).
