...
thf(amrsubvr_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XT @ ccmvar)) => ((XR = (ccfv @ XT @ ccmrex)) => ((XS = (ccfv @ XT @ ccmrsub)) => ((cw3a @ (cwf @ XA2 @ XR @ XF) @ (cwss @ XA2 @ XV) @ (cwcel @ XX @ XA2)) => ((ccfv @ (ccs1 @ XX) @ (ccfv @ XF @ XS)) = (ccfv @ XX @ XF)))))))))))))).
...
thf(cmrsubff1_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XT @ ccmvar)) => ((XR = (ccfv @ XT @ ccmrex)) => ((XS = (ccfv @ XT @ ccmrsub)) => ((cwcel @ XT @ XW) => (cwf1 @ (cco @ XR @ XV @ ccmap) @ (cco @ XR @ XR @ ccmap) @ (ccres @ XS @ (cco @ XR @ XV @ ccmap))))))))))))).
