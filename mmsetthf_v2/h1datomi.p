...
thf(ah1de2ci_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ cchil) => ((cwcel @ XA2 @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) <=> (cwrex @ (^ [Xx3:$i] : (XA2 = (cco @ (ccv @ Xx3) @ XB2 @ ccsm))) @ (^ [Xx3:$i] : ccc))))))).
...
thf(ch1datomi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ cchil) => ((cwss @ XA2 @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) => ((XA2 = (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) | (XA2 = cc0h)))))))).
