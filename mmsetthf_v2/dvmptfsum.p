...
thf(arspc2_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xch @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (cwnf @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3 @ Xy1) <=> (Xch @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xy1) = (XB2 @ Xx3)) => ((Xch @ Xx3 @ Xy1) <=> (Xps @ Xx3 @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XA2 @ (XC @ Xy1)) & (cwcel @ (XB2 @ Xx3) @ XD)) => ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : XD))) @ (^ [Xx3:$i] : (XC @ Xy1))) => (Xps @ Xx3 @ Xy1))))))))))))))))).
...
thf(cdvmptfsum_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xi:$i] : ((XJ @ Xx3 @ Xi) = (cco @ (XK @ Xx3 @ Xi) @ XS @ ccrest)))) => ((! [Xx3:$i] : (! [Xi:$i] : ((XK @ Xx3 @ Xi) = (ccfv @ cccnfld @ cctopn)))) => ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((! [Xx3:$i] : (! [Xi:$i] : (Xph => (cwcel @ XX @ (XJ @ Xx3 @ Xi))))) => ((Xph => (cwcel @ XI @ ccfn)) => ((! [Xx3:$i] : (! [Xi:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xi) @ XI) @ (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XA2 @ Xx3 @ Xi) @ ccc)))) => ((! [Xx3:$i] : (! [Xi:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xi) @ XI) @ (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XB2 @ Xx3 @ Xi) @ ccc)))) => ((! [Xi:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ XI)) => ((cco @ XS @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xi))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xi)))))) => (Xph => ((cco @ XS @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccsu @ XI @ (^ [Xi:$i] : (XA2 @ Xx3 @ Xi))))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccsu @ XI @ (^ [Xi:$i] : (XB2 @ Xx3 @ Xi)))))))))))))))))))))))).
