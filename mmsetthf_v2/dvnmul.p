...
thf(amptelpm_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ XC))) => ((! [Xx3:$i] : (Xph => (cwss @ XA2 @ (XD @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XC @ (XV @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XD @ Xx3) @ (XW @ Xx3)))) => (! [Xx3:$i] : (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cco @ XC @ (XD @ Xx3) @ ccpm)))))))))))))))).
...
thf(afzdifsuc2_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ (cco @ XM @ cc1 @ ccmin) @ ccuz)) => ((cco @ XM @ XN @ ccfz) = (ccdif @ (cco @ XM @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (ccsn @ (cco @ XN @ cc1 @ ccaddc)))))))).
