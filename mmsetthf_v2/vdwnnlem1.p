...
thf(avdw_ax,axiom,(! [XR:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xm:$i] : (((cwcel @ (XR @ Xm) @ ccfn) & (cwcel @ XK @ ccn0)) => (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xf1:$i] : (cwrex @ (^ [Xc:$i] : (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xm:$i] : (cwcel @ (cco @ (ccv @ Xa) @ (cco @ (ccv @ Xm) @ (ccv @ Xd) @ ccmul) @ ccaddc) @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ (ccv @ Xc))))) @ (^ [Xm:$i] : (cco @ ccc0 @ (cco @ XK @ cc1 @ ccmin) @ ccfz)))) @ (^ [Xd:$i] : ccn))) @ (^ [Xa:$i] : ccn))) @ (^ [Xc:$i] : (XR @ Xm)))) @ (^ [Xf1:$i] : (cco @ (XR @ Xm) @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ ccmap)))) @ (^ [Xn:$i] : ccn))))))).
...
thf(cvdwnnlem1_conj,conjecture,(! [XR:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [Xm:$i] : ((cw3a @ (cwcel @ (XR @ Xm) @ ccfn) @ (cwf @ ccn @ (XR @ Xm) @ XF) @ (cwcel @ XK @ ccn0)) => (cwrex @ (^ [Xc:$i] : (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xm:$i] : (cwcel @ (cco @ (ccv @ Xa) @ (cco @ (ccv @ Xm) @ (ccv @ Xd) @ ccmul) @ ccaddc) @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xc))))) @ (^ [Xm:$i] : (cco @ ccc0 @ (cco @ XK @ cc1 @ ccmin) @ ccfz)))) @ (^ [Xd:$i] : ccn))) @ (^ [Xa:$i] : ccn))) @ (^ [Xc:$i] : (XR @ Xm))))))))).
