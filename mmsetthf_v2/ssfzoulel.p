...
thf(assfzo12_ax,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XL @ ccz) @ (cwbr @ XK @ XL @ cclt)) => ((cwss @ (cco @ XK @ XL @ ccfzo) @ (cco @ XM @ XN @ ccfzo)) => ((cwbr @ XM @ XK @ ccle) & (cwbr @ XL @ XN @ ccle))))))))).
...
thf(cssfzoulel_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) => (((cwbr @ XN @ XA2 @ ccle) | (cwbr @ XB2 @ ccc0 @ ccle)) => ((cwss @ (cco @ XA2 @ XB2 @ ccfzo) @ (cco @ ccc0 @ XN @ ccfzo)) => (cwbr @ XB2 @ XA2 @ ccle)))))))).
