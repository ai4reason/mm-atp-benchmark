...
thf(adihmeetlem9N_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xp:$i] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XH = (ccfv @ XK @ cclh)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((Xc_po = (ccfv @ XU @ cclsm)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) @ (cwcel @ (ccv @ Xp) @ XA2)) => ((ccin @ (cco @ (ccfv @ (ccv @ Xp) @ XI) @ (ccfv @ (cco @ XX @ XY @ Xc_an) @ XI) @ Xc_po) @ (ccfv @ XY @ XI)) = (cco @ (ccfv @ (cco @ XX @ XY @ Xc_an) @ XI) @ (ccin @ (ccfv @ (ccv @ Xp) @ XI) @ (ccfv @ XY @ XI)) @ Xc_po))))))))))))))))))))))))))).
thf(cdihmeetlem12N_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xp:$i] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XH = (ccfv @ XK @ cclh)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((Xc_po = (ccfv @ XU @ cclsm)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => (((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) & (cw3a @ ((cwcel @ (ccv @ Xp) @ XA2) & (~ (cwbr @ (ccv @ Xp) @ XW @ Xc_le))) @ (cwbr @ (ccv @ Xp) @ XX @ Xc_le) @ (cwbr @ (cco @ XX @ XY @ Xc_an) @ XW @ Xc_le))) => ((cco @ (ccfv @ (cco @ XX @ XY @ Xc_an) @ XI) @ (ccin @ (ccfv @ (ccv @ Xp) @ XI) @ (ccfv @ XY @ XI)) @ Xc_po) = (ccin @ (ccfv @ XX @ XI) @ (ccfv @ XY @ XI)))))))))))))))))))))))))))).
