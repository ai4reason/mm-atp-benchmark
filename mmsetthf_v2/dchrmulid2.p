...
thf(cdchrmulid2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : ((XG @ Xk) = (ccfv @ XN @ ccdchr))) => ((XZ = (ccfv @ XN @ cczn)) => ((! [Xk:$i] : ((XD @ Xk) = (ccfv @ (XG @ Xk) @ ccbs))) => ((XB2 = (ccfv @ XZ @ ccbs)) => ((XU = (ccfv @ XZ @ ccui)) => ((! [Xk:$i] : ((Xc_1 @ Xk) = (ccmpt @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XU) @ cc1 @ ccc0))))) => ((! [Xk:$i] : ((Xc_x @ Xk) = (ccfv @ (XG @ Xk) @ ccplusg))) => ((! [Xk:$i] : (Xph => (cwcel @ XX @ (XD @ Xk)))) => (! [Xk:$i] : (Xph => ((cco @ (Xc_1 @ Xk) @ XX @ (Xc_x @ Xk)) = XX)))))))))))))))))))))).
