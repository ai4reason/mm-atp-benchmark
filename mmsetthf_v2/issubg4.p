...
thf(cissubg4_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((cwcel @ XG @ ccgrp) => ((cwcel @ XS @ (ccfv @ XG @ ccsubg)) <=> (cw3a @ (cwss @ XS @ XB2) @ (cwne @ XS @ cc0) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_mi) @ XS)) @ (^ [Xy1:$i] : XS))) @ (^ [Xx3:$i] : XS)))))))))))).
