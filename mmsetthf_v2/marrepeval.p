...
thf(cmarrepeval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XQ = (cco @ XN @ XR @ ccmarrep)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cw3a @ ((cwcel @ XM @ XB2) & (cwcel @ XS @ (ccfv @ XR @ ccbs))) @ ((cwcel @ XK @ XN) & (cwcel @ XL @ XN)) @ ((cwcel @ XI @ XN) & (cwcel @ XJ @ XN))) => ((cco @ XI @ XJ @ (cco @ XK @ XL @ (cco @ XM @ XS @ XQ))) = (ccif @ (XI = XK) @ (ccif @ (XJ = XL) @ XS @ Xc_0) @ (cco @ XI @ XJ @ XM))))))))))))))))))))).
