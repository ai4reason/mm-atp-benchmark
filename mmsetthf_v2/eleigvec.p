...
thf(aeigvecval_ax,axiom,(! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((ccfv @ XT @ ccei) = (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xx3) @ XT) = (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccsm))) @ (^ [Xy1:$i] : ccc))) @ (^ [Xx3:$i] : (ccdif @ cchil @ cc0h))))))).
...
thf(celeigvec_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((cwcel @ XA2 @ (ccfv @ XT @ ccei)) <=> (cw3a @ (cwcel @ XA2 @ cchil) @ (cwne @ XA2 @ cc0v) @ (cwrex @ (^ [Xx3:$i] : ((ccfv @ XA2 @ XT) = (cco @ (ccv @ Xx3) @ XA2 @ ccsm))) @ (^ [Xx3:$i] : ccc)))))))).
