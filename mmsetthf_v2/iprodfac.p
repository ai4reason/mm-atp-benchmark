...
thf(afaclim_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ cc1 @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ XA2 @ ccexp) @ (cco @ cc1 @ (cco @ XA2 @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ ccdiv))))) => (! [Xn:$i] : ((cwcel @ XA2 @ ccn0) => (cwbr @ (ccseq @ ccmul @ (XF @ Xn) @ cc1) @ (ccfv @ XA2 @ ccfa) @ ccli))))))).
