...
thf(arankdmr1_ax,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccfv @ XA2 @ ccrnk) @ (ccdm @ ccr1)))).
thf(ar1ord3g_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccr1)) & (cwcel @ XB2 @ (ccdm @ ccr1))) => ((cwss @ XA2 @ XB2) => (cwss @ (ccfv @ XA2 @ ccr1) @ (ccfv @ XB2 @ ccr1))))))).
