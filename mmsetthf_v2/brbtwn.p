...
thf(adf_btwn_ax,axiom,(ccbtwn = (cccnv @ (ccoprab @ (^ [Xx3:$i] : (^ [Xz:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xn:$i] : ((cw3a @ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ ccee)) @ (cwcel @ (ccv @ Xz) @ (ccfv @ (ccv @ Xn) @ ccee)) @ (cwcel @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xn) @ ccee))) & (cwrex @ (^ [Xt:$i] : (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ (ccv @ Xy1)) = (cco @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xx3)) @ ccmul) @ (cco @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xz)) @ ccmul) @ ccaddc))) @ (^ [Xi:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccfz)))) @ (^ [Xt:$i] : (cco @ ccc0 @ cc1 @ ccicc))))) @ (^ [Xn:$i] : ccn))))))))).
...
thf(cbrbtwn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee))) => ((cwbr @ XA2 @ (ccop @ XB2 @ XC) @ ccbtwn) <=> (cwrex @ (^ [Xt:$i] : (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XA2) = (cco @ (cco @ (cco @ cc1 @ (ccv @ Xt) @ ccmin) @ (ccfv @ (ccv @ Xi) @ XB2) @ ccmul) @ (cco @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ XC) @ ccmul) @ ccaddc))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz)))) @ (^ [Xt:$i] : (cco @ ccc0 @ cc1 @ ccicc)))))))))).
