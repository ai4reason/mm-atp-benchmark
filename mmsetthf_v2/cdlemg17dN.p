...
thf(ccdlemg17dN_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [Xc_or:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > ($i > $o))] : (! [XW:($i > $o)] : ((! [Xr:$i] : (Xc_le = (ccfv @ (XK @ Xr) @ ccple))) => ((! [Xr:$i] : (Xc_or = (ccfv @ (XK @ Xr) @ ccjn))) => ((! [Xr:$i] : ((Xc_an @ Xr) = (ccfv @ (XK @ Xr) @ ccmee))) => ((! [Xr:$i] : (XA2 = (ccfv @ (XK @ Xr) @ ccatm))) => ((! [Xr:$i] : ((XH @ Xr) = (ccfv @ (XK @ Xr) @ cclh))) => ((! [Xr:$i] : ((XT @ Xr) = (ccfv @ XW @ (ccfv @ (XK @ Xr) @ ccltrn)))) => ((! [Xr:$i] : ((XR @ Xr) = (ccfv @ XW @ (ccfv @ (XK @ Xr) @ cctrl)))) => (! [Xr:$i] : ((cw3a @ (cw3a @ (cwcel @ (XK @ Xr) @ cchlt) @ (cwcel @ XW @ (XH @ Xr)) @ (cwcel @ XG @ (XT @ Xr))) @ (cw3a @ ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) @ ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le))) @ (cwne @ XP @ XQ)) @ (cw3a @ (cwbr @ (ccfv @ XG @ (XR @ Xr)) @ (cco @ XP @ XQ @ Xc_or) @ Xc_le) @ (~ (cwrex @ (^ [Xr:$i] : ((~ (cwbr @ (ccv @ Xr) @ XW @ Xc_le)) & ((cco @ XP @ (ccv @ Xr) @ Xc_or) = (cco @ XQ @ (ccv @ Xr) @ Xc_or)))) @ (^ [Xr:$i] : XA2))) @ (cwne @ (ccfv @ XP @ XG) @ XP))) => ((ccfv @ XG @ (XR @ Xr)) = (cco @ (cco @ XP @ XQ @ Xc_or) @ XW @ (Xc_an @ Xr))))))))))))))))))))))))).
