...
thf(aidresperm_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((cwcel @ XA2 @ XV) => (cwcel @ (ccres @ ccid @ XA2) @ (ccfv @ XG @ ccbs)))))))).
...
thf(cfzto1st_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((XD = (cco @ cc1 @ XN @ ccfz)) => ((! [Xi:$i] : ((XP @ Xi) = (ccmpt @ (^ [Xi:$i] : XD) @ (^ [Xi:$i] : (ccif @ ((ccv @ Xi) = cc1) @ XI @ (ccif @ (cwbr @ (ccv @ Xi) @ XI @ ccle) @ (cco @ (ccv @ Xi) @ cc1 @ ccmin) @ (ccv @ Xi))))))) => ((! [Xi:$i] : ((XG @ Xi) = (ccfv @ XD @ ccsymg))) => ((! [Xi:$i] : (XB2 = (ccfv @ (XG @ Xi) @ ccbs))) => (! [Xi:$i] : ((cwcel @ XI @ XD) => (cwcel @ (XP @ Xi) @ XB2)))))))))))))).
