...
thf(axppreima_ax,axiom,(! [XF:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (((cwfun @ XF) & (cwss @ (ccrn @ XF) @ (ccxp @ ccvv @ ccvv))) => ((ccima @ (cccnv @ XF) @ (ccxp @ XY @ XZ)) = (ccin @ (ccima @ (cccnv @ (cccom @ cc1st @ XF)) @ XY) @ (ccima @ (cccnv @ (cccom @ cc2nd @ XF)) @ XZ)))))))).
...
thf(aopfv_ax,axiom,(! [Xx3:$i] : (! [XF:($i > $o)] : ((((cwfun @ XF) & (cwss @ (ccrn @ XF) @ (ccxp @ ccvv @ ccvv))) & (cwcel @ (ccv @ Xx3) @ (ccdm @ XF))) => ((ccfv @ (ccv @ Xx3) @ XF) = (ccop @ (ccfv @ (ccv @ Xx3) @ (cccom @ cc1st @ XF)) @ (ccfv @ (ccv @ Xx3) @ (cccom @ cc2nd @ XF)))))))).
...
thf(cxppreima2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwf @ XA2 @ XC @ XG)) => ((XH = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG))))) => (! [Xx3:$i] : (Xph => ((ccima @ (cccnv @ XH) @ (ccxp @ (XY @ Xx3) @ (XZ @ Xx3))) = (ccin @ (ccima @ (cccnv @ XF) @ (XY @ Xx3)) @ (ccima @ (cccnv @ XG) @ (XZ @ Xx3))))))))))))))))))).
