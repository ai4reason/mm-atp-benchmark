...
thf(aprmgaplem8_ax,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((! [Xi:$i] : ((Xph @ Xi) => (cwcel @ XN @ ccn))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwcel @ XF @ (cco @ ccn @ ccn @ ccmap)))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwral @ (^ [Xi:$i] : (cwbr @ cc1 @ (cco @ (cco @ (ccfv @ XN @ XF) @ (ccv @ Xi) @ ccaddc) @ (ccv @ Xi) @ ccgcd) @ cclt)) @ (^ [Xi:$i] : (cco @ cc2 @ XN @ ccfz))))) => (! [Xi:$i] : ((Xph @ Xi) => (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : ((cwbr @ XN @ (cco @ (ccv @ Xq) @ (ccv @ Xp) @ ccmin) @ ccle) & (cwral @ (^ [Xz:$i] : (cwnel @ (ccv @ Xz) @ ccprime)) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xp) @ cc1 @ ccaddc) @ (ccv @ Xq) @ ccfzo))))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime))))))))))).
...
thf(afprodnncl_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccn))) => (Xph => (cwcel @ (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccn)))))))).
...
thf(aprmgapprmolem_ax,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XI @ (cco @ cc2 @ XN @ ccfz))) => (cwbr @ cc1 @ (cco @ (cco @ (ccfv @ XN @ ccprmo) @ XI @ ccaddc) @ XI @ ccgcd) @ cclt))))).
...
thf(aprmoval_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((ccfv @ XN @ ccprmo) = (ccprod @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ ccprime) @ (ccv @ Xk) @ cc1))))))).
thf(cprmgapprmo_conj,conjecture,(cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : ((cwbr @ (ccv @ Xn) @ (cco @ (ccv @ Xq) @ (ccv @ Xp) @ ccmin) @ ccle) & (cwral @ (^ [Xz:$i] : (cwnel @ (ccv @ Xz) @ ccprime)) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xp) @ cc1 @ ccaddc) @ (ccv @ Xq) @ ccfzo))))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime))) @ (^ [Xn:$i] : ccn))).
