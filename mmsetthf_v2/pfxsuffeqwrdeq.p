...
thf(apfxeq_ax,axiom,(! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ ((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XU @ (ccword @ XV))) @ ((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) @ ((cwbr @ XM @ (ccfv @ XW @ cchash) @ ccle) & (cwbr @ XN @ (ccfv @ XU @ cchash) @ ccle))) => (((cco @ XW @ XM @ ccpfx) = (cco @ XU @ XN @ ccpfx)) <=> ((XM = XN) & (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XW) = (ccfv @ (ccv @ Xi) @ XU))) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfzo)))))))))))).
...
thf(aswrdspsleq_ax,axiom,(! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ ((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XU @ (ccword @ XV))) @ ((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) @ ((cwbr @ XN @ (ccfv @ XW @ cchash) @ ccle) & (cwbr @ XN @ (ccfv @ XU @ cchash) @ ccle))) => (((cco @ XW @ (ccop @ XM @ XN) @ ccsubstr) = (cco @ XU @ (ccop @ XM @ XN) @ ccsubstr)) <=> (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XW) = (ccfv @ (ccv @ Xi) @ XU))) @ (^ [Xi:$i] : (cco @ XM @ XN @ ccfzo))))))))))).
thf(cpfxsuffeqwrdeq_conj,conjecture,(! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XS @ (ccword @ XV)) @ (cwcel @ XI @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) => ((XW = XS) <=> (((ccfv @ XW @ cchash) = (ccfv @ XS @ cchash)) & (((cco @ XW @ XI @ ccpfx) = (cco @ XS @ XI @ ccpfx)) & ((cco @ XW @ (ccop @ XI @ (ccfv @ XW @ cchash)) @ ccsubstr) = (cco @ XS @ (ccop @ XI @ (ccfv @ XW @ cchash)) @ ccsubstr))))))))))).
