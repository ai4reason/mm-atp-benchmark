...
thf(csoisores_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : ((((cwor @ (XB2 @ Xx3 @ Xy1) @ XR) & (cwor @ (XC @ Xx3 @ Xy1) @ XS)) & ((cwf @ (XB2 @ Xx3 @ Xy1) @ (XC @ Xx3 @ Xy1) @ XF) & (cwss @ XA2 @ (XB2 @ Xx3 @ Xy1)))) => ((cwiso @ XA2 @ (ccima @ XF @ XA2) @ XR @ XS @ (ccres @ XF @ XA2)) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) => (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ XS))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))))))))))))).
