...
thf(afullres2c_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (ccfv @ XC @ ccbs)) => ((XE = (cco @ XD @ XS @ ccress)) => ((Xph => (cwcel @ XD @ cccat)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwf @ XA2 @ XS @ XF)) => (Xph => ((cwbr @ XF @ XG @ (cco @ XC @ XD @ ccful)) <=> (cwbr @ XF @ XG @ (cco @ XC @ XE @ ccful))))))))))))))))))).
thf(cccnv_tp,type,(cccnv : (($i > $o) > ($i > $o)))).
thf(cwfun_tp,type,(cwfun : (($i > $o) > $o))).
thf(afthres2c_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (ccfv @ XC @ ccbs)) => ((XE = (cco @ XD @ XS @ ccress)) => ((Xph => (cwcel @ XD @ cccat)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwf @ XA2 @ XS @ XF)) => (Xph => ((cwbr @ XF @ XG @ (cco @ XC @ XD @ ccfth)) <=> (cwbr @ XF @ XG @ (cco @ XC @ XE @ ccfth))))))))))))))))))).
