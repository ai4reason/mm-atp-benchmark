...
thf(aisnum3_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ cccrd)) <=> (cwbr @ (ccfv @ XA2 @ cccrd) @ XA2 @ ccen)))).
...
thf(cttukey2g_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ (ccuni @ XA2) @ (ccdm @ cccrd)) @ (cwcel @ XB2 @ XA2) @ (! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) <=> (cwss @ (ccin @ (ccpw @ (ccv @ Xx3)) @ ccfn) @ XA2)))) => (cwrex @ (^ [Xx3:$i] : ((cwss @ XB2 @ (ccv @ Xx3)) & (cwral @ (^ [Xy1:$i] : (~ (cwpss @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : XA2)))))).
