...
thf(adissneq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xu:$i] : ((XC @ Xx3 @ Xu) = (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xu) = (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2))))))) => (! [Xx3:$i] : (! [Xu:$i] : (((cwss @ (XC @ Xx3 @ Xu) @ (XB2 @ Xx3 @ Xu)) & (cwcel @ (XB2 @ Xx3 @ Xu) @ (ccfv @ XA2 @ cctopon))) => ((XB2 @ Xx3 @ Xu) = (ccpw @ XA2)))))))))).
thf(aexellimddv_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > ($i > $o))] : ((Xph => (? [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)))) => ((! [Xx3:$i] : (Xph => ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) => Xps))) => (Xph => Xps))))))).
...
thf(ctopdifinffinlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((XT = (ccrab @ (^ [Xx3:$i] : ((~ (cwcel @ (ccdif @ XA2 @ (ccv @ Xx3)) @ ccfn)) | (((ccv @ Xx3) = cc0) | ((ccv @ Xx3) = XA2)))) @ (^ [Xx3:$i] : (ccpw @ XA2)))) => ((cwcel @ XT @ (ccfv @ XA2 @ cctopon)) => (cwcel @ XA2 @ ccfn)))))).
