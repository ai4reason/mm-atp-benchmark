...
thf(adya2ub_ax,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccrp) => (cwbr @ (cco @ cc1 @ (cco @ cc2 @ (ccfv @ (cco @ cc1 @ (cco @ cc2 @ XR @ cclogb) @ ccmin) @ ccfl) @ ccexp) @ ccdiv) @ XR @ cclt)))).
