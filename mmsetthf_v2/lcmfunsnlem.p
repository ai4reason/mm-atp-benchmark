...
thf(alcmf0_ax,axiom,((ccfv @ cc0 @ cclcmf) = cc1)).
...
thf(alcmfsn_ax,axiom,(! [XM:($i > $o)] : ((cwcel @ XM @ ccz) => ((ccfv @ (ccsn @ XM) @ cclcmf) = (ccfv @ XM @ ccabs))))).
...
thf(alcmcom_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ XM @ XN @ cclcm) = (cco @ XN @ XM @ cclcm)))))).
thf(ccn0_tp,type,(ccn0 : ($i > $o))).
thf(ccgcd_tp,type,(ccgcd : ($i > $o))).
thf(alcm1_ax,axiom,(! [XM:($i > $o)] : ((cwcel @ XM @ ccz) => ((cco @ XM @ cc1 @ cclcm) = (ccfv @ XM @ ccabs))))).
...
thf(alcmfunsnlem1_ax,axiom,(! [Xy1:$i] : (! [Xz:$i] : (((cw3a @ (cwcel @ (ccv @ Xz) @ ccz) @ (cwss @ (ccv @ Xy1) @ ccz) @ (cwcel @ (ccv @ Xy1) @ ccfn)) & ((cwral @ (^ [Xk:$i] : ((cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xk) @ ccdvds)) @ (^ [Xm:$i] : (ccv @ Xy1))) => (cwbr @ (ccfv @ (ccv @ Xy1) @ cclcmf) @ (ccv @ Xk) @ ccdvds))) @ (^ [Xk:$i] : ccz)) & (cwral @ (^ [Xn:$i] : ((ccfv @ (ccun @ (ccv @ Xy1) @ (ccsn @ (ccv @ Xn))) @ cclcmf) = (cco @ (ccfv @ (ccv @ Xy1) @ cclcmf) @ (ccv @ Xn) @ cclcm))) @ (^ [Xn:$i] : ccz)))) => (cwral @ (^ [Xk:$i] : ((cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xk) @ ccdvds)) @ (^ [Xm:$i] : (ccun @ (ccv @ Xy1) @ (ccsn @ (ccv @ Xz))))) => (cwbr @ (ccfv @ (ccun @ (ccv @ Xy1) @ (ccsn @ (ccv @ Xz))) @ cclcmf) @ (ccv @ Xk) @ ccdvds))) @ (^ [Xk:$i] : ccz)))))).
thf(alcmfunsnlem2_ax,axiom,(! [Xy1:$i] : (! [Xz:$i] : (((cw3a @ (cwcel @ (ccv @ Xz) @ ccz) @ (cwss @ (ccv @ Xy1) @ ccz) @ (cwcel @ (ccv @ Xy1) @ ccfn)) & ((cwral @ (^ [Xk:$i] : ((cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xk) @ ccdvds)) @ (^ [Xm:$i] : (ccv @ Xy1))) => (cwbr @ (ccfv @ (ccv @ Xy1) @ cclcmf) @ (ccv @ Xk) @ ccdvds))) @ (^ [Xk:$i] : ccz)) & (cwral @ (^ [Xn:$i] : ((ccfv @ (ccun @ (ccv @ Xy1) @ (ccsn @ (ccv @ Xn))) @ cclcmf) = (cco @ (ccfv @ (ccv @ Xy1) @ cclcmf) @ (ccv @ Xn) @ cclcm))) @ (^ [Xn:$i] : ccz)))) => (cwral @ (^ [Xn:$i] : ((ccfv @ (ccun @ (ccun @ (ccv @ Xy1) @ (ccsn @ (ccv @ Xz))) @ (ccsn @ (ccv @ Xn))) @ cclcmf) = (cco @ (ccfv @ (ccun @ (ccv @ Xy1) @ (ccsn @ (ccv @ Xz))) @ cclcmf) @ (ccv @ Xn) @ cclcm))) @ (^ [Xn:$i] : ccz)))))).
thf(clcmfunsnlem_conj,conjecture,(! [XY:($i > $o)] : (((cwss @ XY @ ccz) & (cwcel @ XY @ ccfn)) => ((cwral @ (^ [Xk:$i] : ((cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xk) @ ccdvds)) @ (^ [Xm:$i] : XY)) => (cwbr @ (ccfv @ XY @ cclcmf) @ (ccv @ Xk) @ ccdvds))) @ (^ [Xk:$i] : ccz)) & (cwral @ (^ [Xn:$i] : ((ccfv @ (ccun @ XY @ (ccsn @ (ccv @ Xn))) @ cclcmf) = (cco @ (ccfv @ XY @ cclcmf) @ (ccv @ Xn) @ cclcm))) @ (^ [Xn:$i] : ccz)))))).
