...
thf(cnumexp2x_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XM @ ccn0) => (((cco @ cc2 @ XM @ ccmul) = XN) => (((cco @ XA2 @ XM @ ccexp) = XD) => (((cco @ XD @ XD @ ccmul) = XC) => ((cco @ XA2 @ XN @ ccexp) = XC)))))))))))).
