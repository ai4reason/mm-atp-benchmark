...
thf(asmflim_ax,axiom,(! [Xph:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (cwnfc @ (^ [Xm:$i] : (XF @ Xx3 @ Xm)))) => ((! [Xm:$i] : (cwnfc @ (^ [Xx3:$i] : (XF @ Xx3 @ Xm)))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3) => (cwcel @ (XM @ Xx3 @ Xm @ Xn) @ ccz))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : (XZ = (ccfv @ (XM @ Xx3 @ Xm @ Xn) @ ccuz))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XS @ Xx3) @ ccsalg))) => ((! [Xx3:$i] : (! [Xm:$i] : ((Xph @ Xx3) => (cwf @ XZ @ (ccfv @ (XS @ Xx3) @ ccsmblfn) @ (XF @ Xx3 @ Xm))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XD @ Xx3 @ Xm @ Xn) = (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccmpt @ (^ [Xm:$i] : XZ) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ (XF @ Xx3 @ Xm))))) @ (ccdm @ ccli))) @ (^ [Xx3:$i] : (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (cciin @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)) @ (^ [Xm:$i] : (ccdm @ (ccfv @ (ccv @ Xm) @ (XF @ Xx3 @ Xm))))))))))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XG @ Xx3 @ Xm @ Xn) = (ccmpt @ (^ [Xx3:$i] : (XD @ Xx3 @ Xm @ Xn)) @ (^ [Xx3:$i] : (ccfv @ (ccmpt @ (^ [Xm:$i] : XZ) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ (XF @ Xx3 @ Xm))))) @ ccli))))))) => (! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3) => (cwcel @ (XG @ Xx3 @ Xm @ Xn) @ (ccfv @ (XS @ Xx3) @ ccsmblfn)))))))))))))))))))))).
...
thf(csmflim2_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (cwnfc @ (^ [Xm:$i] : (XF @ Xx3 @ Xm)))) => ((! [Xm:$i] : (cwnfc @ (^ [Xx3:$i] : (XF @ Xx3 @ Xm)))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwcel @ (XM @ Xx3 @ Xm @ Xn) @ ccz))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : (XZ = (ccfv @ (XM @ Xx3 @ Xm @ Xn) @ ccuz))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwcel @ (XS @ Xx3 @ Xm @ Xn) @ ccsalg))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwf @ XZ @ (ccfv @ (XS @ Xx3 @ Xm @ Xn) @ ccsmblfn) @ (XF @ Xx3 @ Xm)))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XD @ Xx3 @ Xm @ Xn) = (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccmpt @ (^ [Xm:$i] : XZ) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ (XF @ Xx3 @ Xm))))) @ (ccdm @ ccli))) @ (^ [Xx3:$i] : (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (cciin @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)) @ (^ [Xm:$i] : (ccdm @ (ccfv @ (ccv @ Xm) @ (XF @ Xx3 @ Xm))))))))))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XG @ Xx3 @ Xm @ Xn) = (ccmpt @ (^ [Xx3:$i] : (XD @ Xx3 @ Xm @ Xn)) @ (^ [Xx3:$i] : (ccfv @ (ccmpt @ (^ [Xm:$i] : XZ) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ (XF @ Xx3 @ Xm))))) @ ccli))))))) => (! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwcel @ (XG @ Xx3 @ Xm @ Xn) @ (ccfv @ (XS @ Xx3 @ Xm @ Xn) @ ccsmblfn)))))))))))))))))))))).
