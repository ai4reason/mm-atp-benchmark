...
thf(apm2_43cbi_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps => (Xch => (Xph => Xth)))) <=> (Xps => (Xch => (Xph => Xth))))))))).
thf(cee233_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : ((Xph => (Xps => Xch)) => ((Xph => (Xps => (Xth => Xta))) => ((Xph => (Xps => (Xth => Xet))) => ((Xch => (Xta => (Xet => Xze))) => (Xph => (Xps => (Xth => Xze))))))))))))))).
