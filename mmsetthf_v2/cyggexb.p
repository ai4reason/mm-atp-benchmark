...
thf(acyggex_ax,axiom,(! [XB2:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => (((cwcel @ XG @ cccyg) & (cwcel @ XB2 @ ccfn)) => (XE = (ccfv @ XB2 @ cchash))))))))).
...
thf(ccyggexb_conj,conjecture,(! [XB2:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => (((cwcel @ XG @ ccabl) & (cwcel @ XB2 @ ccfn)) => ((cwcel @ XG @ cccyg) <=> (XE = (ccfv @ XB2 @ cchash)))))))))).
