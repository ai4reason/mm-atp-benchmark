...
thf(cclwwlknunOLD_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xw:$i] : ((XV @ Xw) = (ccfv @ XG @ ccvtx))) => (! [Xw:$i] : (((cwcel @ XG @ ccusgr) & (cwcel @ XN @ ccn0)) => ((cco @ XN @ XG @ ccclwwlkn) = (cciun @ (^ [Xx3:$i] : (XV @ Xw)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = (ccv @ Xx3))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccclwwlkn))))))))))))).
