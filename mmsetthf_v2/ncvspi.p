...
thf(anvclmod_ax,axiom,(! [XW:($i > $o)] : ((cwcel @ XW @ ccnvc) => (cwcel @ XW @ cclmod)))).
...
thf(aclmfgrp_ax,axiom,(! [XF:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((cwcel @ XW @ ccclm) => (cwcel @ XF @ ccgrp)))))).
