...
thf(aelo1mpt_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((Xph => (cwss @ XA2 @ ccr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccc))) => (Xph => ((cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cco1) <=> (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle) => (cwbr @ (ccfv @ (XB2 @ Xx3) @ ccabs) @ (ccv @ Xm) @ ccle))) @ (^ [Xx3:$i] : XA2))) @ (^ [Xm:$i] : ccr))) @ (^ [Xy1:$i] : ccr)))))))))).
...
thf(co1lo1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccr))) => (Xph => ((cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cco1) <=> ((cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cclo1) & (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccneg @ (XB2 @ Xx3)))) @ cclo1))))))))).
