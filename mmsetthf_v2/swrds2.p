...
thf(cswrds2_conj,conjecture,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XA2)) @ (cwcel @ XI @ ccn0) @ (cwcel @ (cco @ XI @ cc1 @ ccaddc) @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) => ((cco @ XW @ (ccop @ XI @ (cco @ XI @ cc2 @ ccaddc)) @ ccsubstr) = (ccs2 @ (ccfv @ XI @ XW) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XW)))))))).
