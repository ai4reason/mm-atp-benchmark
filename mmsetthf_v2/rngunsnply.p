...
thf(acnsrplycl_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccfv @ cccnfld @ ccsubrg))) => ((Xph => (cwcel @ XP @ (ccfv @ XC @ ccply))) => ((Xph => (cwcel @ XX @ XS)) => ((Xph => (cwss @ XC @ XS)) => (Xph => (cwcel @ (ccfv @ XX @ XP) @ XS)))))))))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(argspncl_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (XB2 = (ccfv @ XR @ ccbs))) => ((Xph => (cwss @ XA2 @ XB2)) => ((Xph => (XN = (ccfv @ XR @ ccrgspn))) => ((Xph => (XU = (ccfv @ XA2 @ XN))) => (Xph => (cwcel @ XU @ (ccfv @ XR @ ccsubrg))))))))))))))).
...
thf(crngunsnply_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XB2 @ (ccfv @ cccnfld @ ccsubrg))) => ((Xph => (cwcel @ XX @ ccc)) => ((! [Xp:$i] : (Xph => ((XS @ Xp) = (ccfv @ (ccun @ XB2 @ (ccsn @ XX)) @ (ccfv @ cccnfld @ ccrgspn))))) => (! [Xp:$i] : (Xph => ((cwcel @ XV @ (XS @ Xp)) <=> (cwrex @ (^ [Xp:$i] : (XV = (ccfv @ XX @ (ccv @ Xp)))) @ (^ [Xp:$i] : (ccfv @ XB2 @ ccply))))))))))))))).
