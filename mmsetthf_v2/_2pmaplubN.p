...
thf(c_2pmaplubN_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : ((XU = (ccfv @ XK @ cclub)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XM = (ccfv @ XK @ ccpmap)) => (((cwcel @ XK @ cchlt) & (cwss @ XS @ XA2)) => ((ccfv @ (ccfv @ (ccfv @ (ccfv @ XS @ XU) @ XM) @ XU) @ XM) = (ccfv @ (ccfv @ XS @ XU) @ XM)))))))))))).
