...
thf(alo1le_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : ((Xph => (cwcel @ XM @ ccr)) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cclo1)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XC @ Xx3) @ ccr))) => ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XA2) & (cwbr @ XM @ (ccv @ Xx3) @ ccle))) => (cwbr @ (XC @ Xx3) @ (XB2 @ Xx3) @ ccle))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ cclo1)))))))))))))).
thf(a_1red_ax,axiom,(! [Xph:$o] : (Xph => (cwcel @ cc1 @ ccr)))).
thf(ampbii_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xps => ((Xph => (Xps <=> Xch)) => (Xph => Xch))))))).
thf(ccc_tp,type,(ccc : ($i > $o))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(cc2_tp,type,(cc2 : ($i > $o))).
thf(aselberg34r_ax,axiom,(! [XR:($i > ($i > $o))] : ((! [Xa:$i] : ((XR @ Xa) = (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin))))) => (! [Xa:$i] : (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ (XR @ Xa)) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ (XR @ Xa)) @ (cco @ (ccsu @ (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xy1:$i] : ccn)) @ (^ [Xm:$i] : (cco @ (ccfv @ (ccv @ Xm) @ ccvma) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xm) @ ccdiv) @ ccvma) @ ccmul))) @ (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccmul) @ ccmin) @ ccmul))) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccdiv) @ ccmin) @ (ccv @ Xx3) @ ccdiv))) @ cco1))))).
...
thf(advdsdivcl_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XA2 @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XN @ ccdvds)) @ (^ [Xx3:$i] : ccn)))) => (cwcel @ (cco @ XN @ XA2 @ ccdiv) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XN @ ccdvds)) @ (^ [Xx3:$i] : ccn))))))).
...
thf(apntsf_ax,axiom,(! [XS:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xa:$i] : ((XS @ Xi @ Xa) = (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xa) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul)))))))) => (! [Xi:$i] : (! [Xa:$i] : (cwf @ ccr @ ccr @ (XS @ Xi @ Xa))))))).
...
thf(asumeq12rdv_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((Xph => (XA2 = XB2)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XB2)) => ((XC @ Xk) = (XD @ Xk)))) => (Xph => ((ccsu @ XA2 @ (^ [Xk:$i] : (XC @ Xk))) = (ccsu @ XB2 @ (^ [Xk:$i] : (XD @ Xk))))))))))))).
...
thf(apntsval2_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xa:$i] : ((XS @ Xi @ Xa) = (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xa) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul)))))))) => (! [Xi:$i] : (! [Xa:$i] : ((cwcel @ XA2 @ ccr) => ((ccfv @ XA2 @ (XS @ Xi @ Xa)) = (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccmul) @ (ccsu @ (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xy1:$i] : ccn)) @ (^ [Xm:$i] : (cco @ (ccfv @ (ccv @ Xm) @ ccvma) @ (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xm) @ ccdiv) @ ccvma) @ ccmul))) @ ccaddc))))))))))).
...
thf(alogge0d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ cc1 @ XA2 @ ccle)) => (Xph => (cwbr @ ccc0 @ (ccfv @ XA2 @ cclog) @ ccle))))))).
...
thf(cpntrlog2bndlem1_conj,conjecture,(! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xa:$i] : ((XS @ Xi @ Xa) = (ccmpt @ (^ [Xa:$i] : ccr) @ (^ [Xa:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xa) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul)))))))) => ((! [Xi:$i] : (! [Xa:$i] : ((XR @ Xi @ Xa) = (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin)))))) => (! [Xi:$i] : (! [Xa:$i] : (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XR @ Xi @ Xa)) @ ccabs) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ (XR @ Xi @ Xa)) @ ccabs) @ (cco @ (ccfv @ (ccv @ Xn) @ (XS @ Xi @ Xa)) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ (XS @ Xi @ Xa)) @ ccmin) @ ccmul))) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccdiv) @ ccmin) @ (ccv @ Xx3) @ ccdiv))) @ cclo1)))))))).
