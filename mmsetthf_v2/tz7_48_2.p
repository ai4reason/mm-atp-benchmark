...
thf(atz7_48lem_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ ccon0) => (((cwss @ XA2 @ ccon0) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ ((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xy1) @ XF)))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2))) => (cwfun @ (cccnv @ (ccres @ XF @ XA2)))))))).
...
thf(ctz7_48_2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((cwfn @ XF @ ccon0) => ((cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccdif @ (XA2 @ Xx3) @ (ccima @ XF @ (ccv @ Xx3))))) @ (^ [Xx3:$i] : ccon0)) => (cwfun @ (cccnv @ XF))))))).
