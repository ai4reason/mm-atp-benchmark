...
thf(aiccf1o_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ XB2 @ ccmul) @ (cco @ (cco @ cc1 @ (ccv @ Xx3) @ ccmin) @ XA2 @ ccmul) @ ccaddc)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ cclt)) => ((cwf1o @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ XA2 @ XB2 @ ccicc) @ (XF @ Xx3 @ Xy1)) & ((cccnv @ (XF @ Xx3 @ Xy1)) = (ccmpt @ (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xy1:$i] : (cco @ (cco @ (ccv @ Xy1) @ XA2 @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ ccdiv))))))))))))).
...
thf(cicchmeo_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ XB2 @ ccmul) @ (cco @ (cco @ cc1 @ (ccv @ Xx3) @ ccmin) @ XA2 @ ccmul) @ ccaddc))))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ cclt)) => (cwcel @ (XF @ Xx3) @ (cco @ ccii @ (cco @ XJ @ (cco @ XA2 @ XB2 @ ccicc) @ ccrest) @ cchmeo))))))))))).
