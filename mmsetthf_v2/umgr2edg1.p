...
thf(aumgr2edg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XE @ Xx3 @ Xy1) = (ccfv @ XG @ ccedg)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((((cwcel @ XG @ ccumgr) & (cwne @ XA2 @ XB2)) & ((cwcel @ (ccpr @ XN @ XA2) @ (XE @ Xx3 @ Xy1)) & (cwcel @ (ccpr @ XB2 @ XN) @ (XE @ Xx3 @ Xy1)))) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cw3a @ (cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwcel @ XN @ (ccfv @ (ccv @ Xx3) @ XI)) @ (cwcel @ XN @ (ccfv @ (ccv @ Xy1) @ XI)))) @ (^ [Xy1:$i] : (ccdm @ XI)))) @ (^ [Xx3:$i] : (ccdm @ XI))))))))))))))).
...
thf(cumgr2edg1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccfv @ XG @ ccedg))) => (! [Xx3:$i] : ((((cwcel @ XG @ ccumgr) & (cwne @ XA2 @ XB2)) & ((cwcel @ (ccpr @ XN @ XA2) @ (XE @ Xx3)) & (cwcel @ (ccpr @ XB2 @ XN) @ (XE @ Xx3)))) => (~ (cwreu @ (^ [Xx3:$i] : (cwcel @ XN @ (ccfv @ (ccv @ Xx3) @ XI))) @ (^ [Xx3:$i] : (ccdm @ XI))))))))))))))).
