...
thf(aisfild_b_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (Xph => ((cwcel @ (ccv @ Xx3) @ XF) <=> ((cwss @ (ccv @ Xx3) @ XA2) & (Xps @ Xx3))))) => ((Xph => (cwcel @ XA2 @ ccvv)) => ((Xph => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ XA2)) => ((Xph => (~ (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ cc0))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ Xph @ (cwss @ (ccv @ Xy1) @ XA2) @ (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))) => ((cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (ccv @ Xx3)) => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (ccv @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ Xph @ (cwss @ (ccv @ Xy1) @ XA2) @ (cwss @ (ccv @ Xx3) @ XA2)) => (((cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (ccv @ Xy1)) & (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (ccv @ Xx3))) => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (ccin @ (ccv @ Xy1) @ (ccv @ Xx3))))))) => (Xph => (cwcel @ XF @ (ccfv @ XA2 @ ccfil)))))))))))))).
...
thf(csnfil_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ XB2) & (cwne @ XA2 @ cc0)) => (cwcel @ (ccsn @ XA2) @ (ccfv @ XA2 @ ccfil)))))).
