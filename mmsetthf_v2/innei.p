...
thf(cinnei_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XN @ (ccfv @ XS @ (ccfv @ XJ @ ccnei))) @ (cwcel @ XM @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)))) => (cwcel @ (ccin @ XN @ XM) @ (ccfv @ XS @ (ccfv @ XJ @ ccnei))))))))).
