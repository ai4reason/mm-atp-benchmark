...
thf(abnj707_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xch => Xta) => ((cw_bnj17 @ Xph @ Xps @ Xch @ Xth) => Xta)))))))).
...
thf(abianir_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & (Xps <=> Xph)) => Xps)))).
thf(cbnj1001_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xps:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xch:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xth:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xta:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xet:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [Xbnjwchn:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xch @ Xy1 @ Xf1 @ Xi @ Xm @ Xn @ Xp) <=> (cw_bnj17 @ (cwcel @ (ccv @ Xn) @ (XD @ Xy1 @ Xf1 @ Xi @ Xm @ Xn @ Xp)) @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) @ (Xph @ Xy1 @ Xf1 @ Xi @ Xm @ Xn @ Xp) @ (Xps @ Xy1 @ Xf1 @ Xi @ Xm @ Xn @ Xp))))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xta @ Xy1 @ Xf1 @ Xi @ Xm @ Xn @ Xp) <=> (cw3a @ (cwcel @ (ccv @ Xm) @ ccom) @ ((ccv @ Xn) = (ccsuc @ (ccv @ Xm))) @ ((ccv @ Xp) = (ccsuc @ (ccv @ Xn))))))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xet @ Xy1 @ Xf1 @ Xi @ Xm @ Xn @ Xp) <=> ((cwcel @ (ccv @ Xi) @ (ccv @ Xn)) & (cwcel @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xf1))))))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XD @ Xy1 @ Xf1 @ Xi @ Xm @ Xn @ Xp) = (ccdif @ ccom @ (ccsn @ cc0))))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((cw_bnj17 @ (Xth @ Xy1 @ Xf1 @ Xi @ Xm @ Xn @ Xp) @ (Xch @ Xy1 @ Xf1 @ Xi @ Xm @ Xn @ Xp) @ (Xta @ Xy1 @ Xf1 @ Xi @ Xm @ Xn @ Xp) @ (Xet @ Xy1 @ Xf1 @ Xi @ Xm @ Xn @ Xp)) => (Xbnjwchn @ Xy1 @ Xf1 @ Xi @ Xm @ Xn @ Xp)))))))) => (! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((cw_bnj17 @ (Xth @ Xy1 @ Xf1 @ Xi @ Xm @ Xn @ Xp) @ (Xch @ Xy1 @ Xf1 @ Xi @ Xm @ Xn @ Xp) @ (Xta @ Xy1 @ Xf1 @ Xi @ Xm @ Xn @ Xp) @ (Xet @ Xy1 @ Xf1 @ Xi @ Xm @ Xn @ Xp)) => (cw3a @ (Xbnjwchn @ Xy1 @ Xf1 @ Xi @ Xm @ Xn @ Xp) @ (cwcel @ (ccv @ Xi) @ ccom) @ (cwcel @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xp)))))))))))))))))))))))).
