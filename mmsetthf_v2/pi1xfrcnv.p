...
thf(api1xfrcnvlem_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((XP = (cco @ XJ @ (ccfv @ ccc0 @ XF) @ ccpi1)) => ((XQ = (cco @ XJ @ (ccfv @ cc1 @ XF) @ ccpi1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((! [Xx3:$i] : (! [Xg1:$i] : ((XG @ Xx3 @ Xg1) = (ccrn @ (ccmpt @ (^ [Xg1:$i] : (ccuni @ XB2)) @ (^ [Xg1:$i] : (ccop @ (ccec @ (ccv @ Xg1) @ (ccfv @ XJ @ ccphtpc)) @ (ccec @ (cco @ XI @ (cco @ (ccv @ Xg1) @ XF @ (ccfv @ XJ @ ccpco)) @ (ccfv @ XJ @ ccpco)) @ (ccfv @ XJ @ ccphtpc))))))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xh:$i] : (Xph => (cwcel @ XJ @ (ccfv @ (XX @ Xx3 @ Xg1 @ Xh) @ cctopon)))))) => ((Xph => (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((XI = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccfv @ (cco @ cc1 @ (ccv @ Xx3) @ ccmin) @ XF)))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((XH @ Xx3 @ Xg1 @ Xh) = (ccrn @ (ccmpt @ (^ [Xh:$i] : (ccuni @ (ccfv @ XQ @ ccbs))) @ (^ [Xh:$i] : (ccop @ (ccec @ (ccv @ Xh) @ (ccfv @ XJ @ ccphtpc)) @ (ccec @ (cco @ XF @ (cco @ (ccv @ Xh) @ XI @ (ccfv @ XJ @ ccpco)) @ (ccfv @ XJ @ ccpco)) @ (ccfv @ XJ @ ccphtpc)))))))))) => (! [Xx3:$i] : (! [Xg1:$i] : (! [Xh:$i] : (Xph => (cwss @ (cccnv @ (XG @ Xx3 @ Xg1)) @ (XH @ Xx3 @ Xg1 @ Xh))))))))))))))))))))))))).
thf(aeqsstr3d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XB2 = XA2)) => ((Xph => (cwss @ XB2 @ XC)) => (Xph => (cwss @ XA2 @ XC))))))))).
thf(asylib_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps <=> Xch) => (Xph => Xch))))))).
thf(asylibr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xch <=> Xps) => (Xph => Xch))))))).
thf(afliftrel_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccop @ (XA2 @ Xx3) @ (XB2 @ Xx3))))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XA2 @ Xx3) @ XR))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XB2 @ Xx3) @ XS))) => (! [Xx3:$i] : (Xph => (cwss @ (XF @ Xx3) @ (ccxp @ XR @ XS))))))))))))))).
...
thf(api1xfr_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((XP = (cco @ XJ @ (ccfv @ ccc0 @ XF) @ ccpi1)) => ((XQ = (cco @ XJ @ (ccfv @ cc1 @ XF) @ ccpi1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((! [Xx3:$i] : (! [Xg1:$i] : ((XG @ Xx3 @ Xg1) = (ccrn @ (ccmpt @ (^ [Xg1:$i] : (ccuni @ XB2)) @ (^ [Xg1:$i] : (ccop @ (ccec @ (ccv @ Xg1) @ (ccfv @ XJ @ ccphtpc)) @ (ccec @ (cco @ XI @ (cco @ (ccv @ Xg1) @ XF @ (ccfv @ XJ @ ccpco)) @ (ccfv @ XJ @ ccpco)) @ (ccfv @ XJ @ ccphtpc))))))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (Xph => (cwcel @ XJ @ (ccfv @ (XX @ Xx3 @ Xg1) @ cctopon))))) => ((Xph => (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((XI = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccfv @ (cco @ cc1 @ (ccv @ Xx3) @ ccmin) @ XF)))) => (! [Xx3:$i] : (! [Xg1:$i] : (Xph => (cwcel @ (XG @ Xx3 @ Xg1) @ (cco @ XP @ XQ @ ccghm)))))))))))))))))))))).
thf(cpi1xfrcnv_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((XP = (cco @ XJ @ (ccfv @ ccc0 @ XF) @ ccpi1)) => ((XQ = (cco @ XJ @ (ccfv @ cc1 @ XF) @ ccpi1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((! [Xx3:$i] : (! [Xg1:$i] : ((XG @ Xx3 @ Xg1) = (ccrn @ (ccmpt @ (^ [Xg1:$i] : (ccuni @ XB2)) @ (^ [Xg1:$i] : (ccop @ (ccec @ (ccv @ Xg1) @ (ccfv @ XJ @ ccphtpc)) @ (ccec @ (cco @ XI @ (cco @ (ccv @ Xg1) @ XF @ (ccfv @ XJ @ ccpco)) @ (ccfv @ XJ @ ccpco)) @ (ccfv @ XJ @ ccphtpc))))))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xh:$i] : (Xph => (cwcel @ XJ @ (ccfv @ (XX @ Xx3 @ Xg1 @ Xh) @ cctopon)))))) => ((Xph => (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((XI = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccfv @ (cco @ cc1 @ (ccv @ Xx3) @ ccmin) @ XF)))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xh:$i] : ((XH @ Xx3 @ Xg1 @ Xh) = (ccrn @ (ccmpt @ (^ [Xh:$i] : (ccuni @ (ccfv @ XQ @ ccbs))) @ (^ [Xh:$i] : (ccop @ (ccec @ (ccv @ Xh) @ (ccfv @ XJ @ ccphtpc)) @ (ccec @ (cco @ XF @ (cco @ (ccv @ Xh) @ XI @ (ccfv @ XJ @ ccpco)) @ (ccfv @ XJ @ ccpco)) @ (ccfv @ XJ @ ccphtpc)))))))))) => (! [Xx3:$i] : (! [Xg1:$i] : (! [Xh:$i] : (Xph => (((cccnv @ (XG @ Xx3 @ Xg1)) = (XH @ Xx3 @ Xg1 @ Xh)) & (cwcel @ (cccnv @ (XG @ Xx3 @ Xg1)) @ (cco @ XQ @ XP @ ccghm)))))))))))))))))))))))))).
