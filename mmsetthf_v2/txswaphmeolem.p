...
thf(ctxswaphmeolem_conj,conjecture,(! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cccom @ (ccmpt2 @ (^ [Xy1:$i] : (^ [Xx3:$i] : XY)) @ (^ [Xy1:$i] : (^ [Xx3:$i] : XX)) @ (^ [Xy1:$i] : (^ [Xx3:$i] : (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))))) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (ccv @ Xy1) @ (ccv @ Xx3)))))) = (ccres @ ccid @ (ccxp @ XX @ XY)))))).
