...
thf(abnj551_ax,axiom,(! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : ((((ccv @ Xm) = (ccsuc @ (ccv @ Xp))) & ((ccv @ Xm) = (ccsuc @ (ccv @ Xi)))) => ((ccv @ Xp) = (ccv @ Xi))))))).
...
thf(abnj240_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xbnjwpsm:$o] : (! [Xbnjwchm:$o] : ((Xps => Xbnjwpsm) => ((Xch => Xbnjwchm) => ((cw3a @ Xph @ Xps @ Xch) => (Xbnjwpsm & Xbnjwchm)))))))))).
...
thf(abnj658_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cw_bnj17 @ Xph @ Xps @ Xch @ Xth) => (cw3a @ Xph @ Xps @ Xch))))))).
thf(adf_bnj17_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cw_bnj17 @ Xph @ Xps @ Xch @ Xth) <=> ((cw3a @ Xph @ Xps @ Xch) & Xth))))))).
thf(ccdm_tp,type,(ccdm : (($i > $o) > ($i > $o)))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(abnj945_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [Xp:$i] : ((! [Xf1:$i] : (! [Xn:$i] : ((XG @ Xf1 @ Xn) = (ccun @ (ccv @ Xf1) @ (ccsn @ (ccop @ (ccv @ Xn) @ (XC @ Xf1 @ Xn))))))) => (! [Xf1:$i] : (! [Xn:$i] : ((cw_bnj17 @ (cwcel @ (XC @ Xf1 @ Xn) @ ccvv) @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) @ ((ccv @ Xp) = (ccsuc @ (ccv @ Xn))) @ (cwcel @ (XA2 @ Xf1 @ Xn) @ (ccv @ Xn))) => ((ccfv @ (XA2 @ Xf1 @ Xn) @ (XG @ Xf1 @ Xn)) = (ccfv @ (XA2 @ Xf1 @ Xn) @ (ccv @ Xf1)))))))))))).
