...
thf(accatval21sw_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV)) @ (cwne @ XB2 @ cc0)) => ((ccfv @ (ccfv @ XA2 @ cchash) @ (cco @ XA2 @ XB2 @ ccconcat)) = (ccfv @ ccc0 @ XB2))))))).
...
thf(afzosplitsnm1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ ccuz))) => ((cco @ XA2 @ XB2 @ ccfzo) = (ccun @ (cco @ XA2 @ (cco @ XB2 @ cc1 @ ccmin) @ ccfzo) @ (ccsn @ (cco @ XB2 @ cc1 @ ccmin)))))))).
...
thf(aelfzomelpfzo_ax,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) & ((cwcel @ XK @ ccz) & (cwcel @ XL @ ccz))) => ((cwcel @ XK @ (cco @ (cco @ XM @ XL @ ccmin) @ (cco @ XN @ XL @ ccmin) @ ccfzo)) <=> (cwcel @ (cco @ XK @ XL @ ccaddc) @ (cco @ XM @ XN @ ccfzo))))))))).
...
thf(afzoun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XB2 @ (ccfv @ XA2 @ ccuz)) & (cwcel @ XC @ ccn0)) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ ccfzo) = (ccun @ (cco @ XA2 @ XB2 @ ccfzo) @ (cco @ XB2 @ (cco @ XB2 @ XC @ ccaddc) @ ccfzo)))))))).
thf(cclwwlkccatlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((cw3a @ (cw3a @ ((cwcel @ XA2 @ (ccword @ (ccfv @ XG @ ccvtx))) & (cwne @ XA2 @ cc0)) @ (cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ XA2) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XA2)) @ (ccfv @ XG @ ccedg))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XA2 @ cchash) @ cc1 @ ccmin) @ ccfzo))) @ (cwcel @ (ccpr @ (ccfv @ XA2 @ cclsw) @ (ccfv @ ccc0 @ XA2)) @ (ccfv @ XG @ ccedg))) @ (cw3a @ ((cwcel @ XB2 @ (ccword @ (ccfv @ XG @ ccvtx))) & (cwne @ XB2 @ cc0)) @ (cwral @ (^ [Xj:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xj) @ XB2) @ (ccfv @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XB2)) @ (ccfv @ XG @ ccedg))) @ (^ [Xj:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XB2 @ cchash) @ cc1 @ ccmin) @ ccfzo))) @ (cwcel @ (ccpr @ (ccfv @ XB2 @ cclsw) @ (ccfv @ ccc0 @ XB2)) @ (ccfv @ XG @ ccedg))) @ ((ccfv @ ccc0 @ XA2) = (ccfv @ ccc0 @ XB2))) => (cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ (cco @ XA2 @ XB2 @ ccconcat)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (cco @ XA2 @ XB2 @ ccconcat))) @ (ccfv @ XG @ ccedg))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccconcat) @ cchash) @ cc1 @ ccmin) @ ccfzo)))))))).
