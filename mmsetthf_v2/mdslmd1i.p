...
thf(achlubi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => (((cwss @ XA2 @ XC) & (cwss @ XB2 @ XC)) <=> (cwss @ (cco @ XA2 @ XB2 @ cchj) @ XC))))))))).
...
thf(amdsl2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwbr @ XA2 @ XB2 @ ccmd) <=> (cwral @ (^ [Xx3:$i] : (((cwss @ (ccin @ XA2 @ XB2) @ (ccv @ Xx3)) & (cwss @ (ccv @ Xx3) @ XB2)) => (cwss @ (ccin @ (cco @ (ccv @ Xx3) @ XA2 @ cchj) @ XB2) @ (cco @ (ccv @ Xx3) @ (ccin @ XA2 @ XB2) @ cchj)))) @ (^ [Xx3:$i] : ccch)))))))).
