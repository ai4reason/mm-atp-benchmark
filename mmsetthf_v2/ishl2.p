...
thf(acphnvc_ax,axiom,(! [XW:($i > $o)] : ((cwcel @ XW @ cccph) => (cwcel @ XW @ ccnvc)))).
...
thf(acncdrg_ax,axiom,(! [XF:($i > $o)] : (! [XK:($i > $o)] : ((XF = (cco @ cccnfld @ XK @ ccress)) => ((cw3a @ (cwcel @ XK @ (ccfv @ cccnfld @ ccsubrg)) @ (cwcel @ XF @ ccdr) @ (cwcel @ XF @ cccms)) => (cwcel @ XK @ (ccpr @ ccr @ ccc))))))).
...
thf(acncms_ax,axiom,(cwcel @ cccnfld @ cccms)).
...
thf(cishl2_conj,conjecture,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((cwcel @ XW @ cchl) <=> (cw3a @ (cwcel @ XW @ cccms) @ (cwcel @ XW @ cccph) @ (cwcel @ XK @ (ccpr @ ccr @ ccc)))))))))).
