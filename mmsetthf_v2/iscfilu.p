...
thf(aelrnust_ax,axiom,(! [XU:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XU @ (ccfv @ XX @ ccust)) => (cwcel @ XU @ (ccuni @ (ccrn @ ccust))))))).
...
thf(adf_cfilu_ax,axiom,(cccfilu = (ccmpt @ (^ [Xu:$i] : (ccuni @ (ccrn @ ccust))) @ (^ [Xu:$i] : (ccrab @ (^ [Xf1:$i] : (cwral @ (^ [Xv:$i] : (cwrex @ (^ [Xa:$i] : (cwss @ (ccxp @ (ccv @ Xa) @ (ccv @ Xa)) @ (ccv @ Xv))) @ (^ [Xa:$i] : (ccv @ Xf1)))) @ (^ [Xv:$i] : (ccv @ Xu)))) @ (^ [Xf1:$i] : (ccfv @ (ccdm @ (ccuni @ (ccv @ Xu))) @ ccfbas))))))).
...
thf(austbas2_ax,axiom,(! [XU:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XU @ (ccfv @ XX @ ccust)) => (XX = (ccdm @ (ccuni @ XU))))))).
thf(ciscfilu_conj,conjecture,(! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [Xv:$i] : (! [Xa:$i] : ((cwcel @ (XU @ Xa) @ (ccfv @ (XX @ Xv @ Xa) @ ccust)) => ((cwcel @ XF @ (ccfv @ (XU @ Xa) @ cccfilu)) <=> ((cwcel @ XF @ (ccfv @ (XX @ Xv @ Xa) @ ccfbas)) & (cwral @ (^ [Xv:$i] : (cwrex @ (^ [Xa:$i] : (cwss @ (ccxp @ (ccv @ Xa) @ (ccv @ Xa)) @ (ccv @ Xv))) @ (^ [Xa:$i] : XF))) @ (^ [Xv:$i] : (XU @ Xa)))))))))))).
