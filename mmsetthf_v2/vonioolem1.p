...
thf(arecnnltrp_ax,axiom,(! [XE:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ (ccfv @ (cco @ cc1 @ XE @ ccdiv) @ ccfl) @ cc1 @ ccaddc)) => ((cwcel @ XE @ ccrp) => ((cwcel @ XN @ ccn) & (cwbr @ (cco @ cc1 @ XN @ ccdiv) @ XE @ cclt))))))).
...
thf(ainfrefilb_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwss @ XB2 @ ccr) @ (cwcel @ XB2 @ ccfn) @ (cwcel @ XA2 @ XB2)) => (cwbr @ (ccinf @ XB2 @ ccr @ cclt) @ XA2 @ ccle))))).
