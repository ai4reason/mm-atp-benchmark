...
thf(aleabsi_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwbr @ XA2 @ (ccfv @ XA2 @ ccabs) @ ccle)))).
...
thf(anormlem6_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XS @ ccc) => ((cwcel @ XF @ cchil) => ((cwcel @ XG @ cchil) => ((XB2 = (ccneg @ (cco @ (cco @ (ccfv @ XS @ cccj) @ (cco @ XF @ XG @ ccsp) @ ccmul) @ (cco @ XS @ (cco @ XG @ XF @ ccsp) @ ccmul) @ ccaddc))) => ((XA2 = (cco @ XG @ XG @ ccsp)) => ((XC = (cco @ XF @ XF @ ccsp)) => (((ccfv @ XS @ ccabs) = cc1) => (cwbr @ (ccfv @ XB2 @ ccabs) @ (cco @ cc2 @ (cco @ (ccfv @ XA2 @ ccsqrt) @ (ccfv @ XC @ ccsqrt) @ ccmul) @ ccmul) @ ccle))))))))))))))).
