...
thf(aelriin_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwcel @ XB2 @ (ccin @ XA2 @ (cciin @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XS @ Xx3))))) <=> ((cwcel @ XB2 @ XA2) & (cwral @ (^ [Xx3:$i] : (cwcel @ XB2 @ (XS @ Xx3))) @ (^ [Xx3:$i] : XX))))))))).
...
thf(aimaeq12d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((ccima @ XA2 @ XC) = (ccima @ XB2 @ XD))))))))))).
...
thf(arintopn_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XA2 @ XJ) @ (cwcel @ XA2 @ ccfn)) => (cwcel @ (ccin @ XX @ (ccint @ XA2)) @ XJ))))))).
...
thf(aelrint_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [Xy1:$i] : ((cwcel @ XX @ (ccin @ (XA2 @ Xy1) @ (ccint @ XB2))) <=> ((cwcel @ XX @ (XA2 @ Xy1)) & (cwral @ (^ [Xy1:$i] : (cwcel @ XX @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XB2))))))))).
...
thf(climciun_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ ccfn))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwral @ (^ [Xx3:$i] : (cwss @ (XB2 @ Xx3) @ ccc)) @ (^ [Xx3:$i] : XA2)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwf @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccc @ XF))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XC @ ccc))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cco @ XF @ XC @ cclimc) = (ccin @ ccc @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (ccres @ XF @ (XB2 @ Xx3)) @ XC @ cclimc))))))))))))))))).
