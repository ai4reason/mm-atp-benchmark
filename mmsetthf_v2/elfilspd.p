...
thf(aellspd_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XN = (ccfv @ XM @ cclspn)) => ((XB2 = (ccfv @ XM @ ccbs)) => ((XK = (ccfv @ XS @ ccbs)) => ((XS = (ccfv @ XM @ ccsca)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => ((Xc_x = (ccfv @ XM @ ccvsca)) => ((Xph => (cwf @ XI @ XB2 @ XF)) => ((Xph => (cwcel @ XM @ cclmod)) => ((Xph => (cwcel @ XI @ ccvv)) => (Xph => ((cwcel @ XX @ (ccfv @ (ccima @ XF @ XI) @ XN)) <=> (cwrex @ (^ [Xf1:$i] : ((cwbr @ (ccv @ Xf1) @ Xc_0 @ ccfsupp) & (XX = (cco @ XM @ (cco @ (ccv @ Xf1) @ XF @ (ccof @ Xc_x)) @ ccgsu)))) @ (^ [Xf1:$i] : (cco @ XK @ XI @ ccmap)))))))))))))))))))))))))).
