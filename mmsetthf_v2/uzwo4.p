...
thf(cuzwo4_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xk:$i] : (cwnf @ (^ [Xj:$i] : (Xps @ Xj @ Xk)))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xj) = (ccv @ Xk)) => ((Xph @ Xj) <=> (Xps @ Xj @ Xk))))) => (! [Xj:$i] : (((cwss @ XS @ (ccfv @ (XM @ Xj) @ ccuz)) & (cwrex @ (^ [Xj:$i] : (Xph @ Xj)) @ (^ [Xj:$i] : XS))) => (cwrex @ (^ [Xj:$i] : ((Xph @ Xj) & (cwral @ (^ [Xk:$i] : ((cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ cclt) => (~ (Xps @ Xj @ Xk)))) @ (^ [Xk:$i] : XS)))) @ (^ [Xj:$i] : XS))))))))))).
