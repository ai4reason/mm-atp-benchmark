...
thf(ct0sep_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cct0) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX))) => ((cwral @ (^ [Xx3:$i] : ((cwcel @ XA2 @ (ccv @ Xx3)) <=> (cwcel @ XB2 @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XJ)) => (XA2 = XB2))))))))).
