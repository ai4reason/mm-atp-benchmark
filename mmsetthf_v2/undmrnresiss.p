...
thf(cundmrnresiss_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ (ccres @ ccid @ (ccun @ (ccdm @ XA2) @ (ccrn @ XA2))) @ XB2) <=> (! [Xx3:$i] : (! [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XA2) => ((cwbr @ (ccv @ Xx3) @ (ccv @ Xx3) @ XB2) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xy1) @ XB2))))))))).
