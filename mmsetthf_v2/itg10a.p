...
thf(citg10a_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XF @ (ccdm @ ccitg1))) => ((Xph => (cwss @ XA2 @ ccr)) => ((Xph => ((ccfv @ XA2 @ ccovol) = ccc0)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ ccr @ XA2))) => ((ccfv @ (ccv @ Xx3) @ XF) = ccc0))) => (Xph => ((ccfv @ XF @ ccitg1) = ccc0)))))))))).
