...
thf(adf_frgr_ax,axiom,(ccfrgr = (ccab @ (^ [Xg1:$i] : ((cwcel @ (ccv @ Xg1) @ ccusgr) & (cwsbc @ (^ [Xv:$i] : (cwsbc @ (^ [Xe:$i] : (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xl:$i] : (cwreu @ (^ [Xx3:$i] : (cwss @ (ccpr @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xk)) @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xl))) @ (ccv @ Xe))) @ (^ [Xx3:$i] : (ccv @ Xv)))) @ (^ [Xl:$i] : (ccdif @ (ccv @ Xv) @ (ccsn @ (ccv @ Xk)))))) @ (^ [Xk:$i] : (ccv @ Xv)))) @ (ccfv @ (ccv @ Xg1) @ ccedg))) @ (ccfv @ (ccv @ Xg1) @ ccvtx))))))).
