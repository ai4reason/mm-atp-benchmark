...
thf(aqmuldeneqnum_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccq) => ((cco @ XA2 @ (ccfv @ XA2 @ ccdenom) @ ccmul) = (ccfv @ XA2 @ ccnumer))))).
thf(cqnumgt0_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccq) => ((cwbr @ ccc0 @ XA2 @ cclt) <=> (cwbr @ ccc0 @ (ccfv @ XA2 @ ccnumer) @ cclt))))).
