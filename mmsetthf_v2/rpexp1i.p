...
thf(arpexp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XN @ ccn)) => (((cco @ (cco @ XA2 @ XN @ ccexp) @ XB2 @ ccgcd) = cc1) <=> ((cco @ XA2 @ XB2 @ ccgcd) = cc1))))))).
...
thf(crpexp1i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XM @ ccn0)) => (((cco @ XA2 @ XB2 @ ccgcd) = cc1) => ((cco @ (cco @ XA2 @ XM @ ccexp) @ XB2 @ ccgcd) = cc1))))))).
