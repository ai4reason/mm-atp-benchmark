...
thf(awilthlem2_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((XT = (ccfv @ cccnfld @ ccmgp)) => ((XA2 = (ccrab @ (^ [Xx3:$i] : ((cwcel @ (cco @ XP @ cc1 @ ccmin) @ (ccv @ Xx3)) & (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (cco @ (ccv @ Xy1) @ (cco @ XP @ cc2 @ ccmin) @ ccexp) @ XP @ ccmo) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3))))) @ (^ [Xx3:$i] : (ccpw @ (cco @ cc1 @ (cco @ XP @ cc1 @ ccmin) @ ccfz))))) => ((! [Xs1:$i] : ((Xph @ Xs1) => (cwcel @ XP @ ccprime))) => ((! [Xs1:$i] : ((Xph @ Xs1) => (cwcel @ XS @ XA2))) => ((! [Xs1:$i] : ((Xph @ Xs1) => (cwral @ (^ [Xs1:$i] : ((cwpss @ (ccv @ Xs1) @ XS) => ((cco @ (cco @ XT @ (ccres @ ccid @ (ccv @ Xs1)) @ ccgsu) @ XP @ ccmo) = (cco @ (ccneg @ cc1) @ XP @ ccmo)))) @ (^ [Xs1:$i] : XA2)))) => (! [Xs1:$i] : ((Xph @ Xs1) => ((cco @ (cco @ XT @ (ccres @ ccid @ XS) @ ccgsu) @ XP @ ccmo) = (cco @ (ccneg @ cc1) @ XP @ ccmo))))))))))))))).
