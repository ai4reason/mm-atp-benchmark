...
thf(clshpcmp_conj,conjecture,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XW @ cclsh)) => ((Xph => (cwcel @ XW @ cclvec)) => ((Xph => (cwcel @ XT @ XH)) => ((Xph => (cwcel @ XU @ XH)) => (Xph => ((cwss @ XT @ XU) <=> (XT = XU))))))))))))).
