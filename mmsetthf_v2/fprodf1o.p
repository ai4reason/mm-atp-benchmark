...
thf(afo00_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfo @ cc0 @ XA2 @ XF) <=> ((XF = cc0) & (XA2 = cc0)))))).
...
thf(afprod_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : ((! [Xk:$i] : (! [Xn:$i] : (((ccv @ Xk) = (ccfv @ (ccv @ Xn) @ XF)) => ((XB2 @ Xk) = (XC @ Xn))))) => ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwf1o @ (cco @ cc1 @ XM @ ccfz) @ XA2 @ XF)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccc))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XM @ ccfz))) => ((ccfv @ (ccv @ Xn) @ XG) = (XC @ Xn)))) => (Xph => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) = (ccfv @ XM @ (ccseq @ ccmul @ XG @ cc1))))))))))))))))).
...
thf(afvmpti_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((XB2 @ Xx3) = XC))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => (! [Xx3:$i] : ((cwcel @ XA2 @ XD) => ((ccfv @ XA2 @ (XF @ Xx3)) = (ccfv @ XC @ ccid)))))))))))).
thf(afvmpt2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => (! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) => ((ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) = (ccfv @ (XB2 @ Xx3) @ ccid))))))))).
