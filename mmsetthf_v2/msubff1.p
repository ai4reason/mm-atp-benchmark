...
thf(amsubff_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XT @ ccmvar)) => ((XR = (ccfv @ XT @ ccmrex)) => ((XS = (ccfv @ XT @ ccmsub)) => ((XE = (ccfv @ XT @ ccmex)) => ((cwcel @ XT @ XW) => (cwf @ (cco @ XR @ XV @ ccpm) @ (cco @ XE @ XE @ ccmap) @ XS))))))))))))).
...
thf(amrsubff1_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XT @ ccmvar)) => ((XR = (ccfv @ XT @ ccmrex)) => ((XS = (ccfv @ XT @ ccmrsub)) => ((cwcel @ XT @ XW) => (cwf1 @ (cco @ XR @ XV @ ccmap) @ (cco @ XR @ XR @ ccmap) @ (ccres @ XS @ (cco @ XR @ XV @ ccmap))))))))))))).
...
thf(cmsubff1_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XT @ ccmvar)) => ((XR = (ccfv @ XT @ ccmrex)) => ((XS = (ccfv @ XT @ ccmsub)) => ((XE = (ccfv @ XT @ ccmex)) => ((cwcel @ XT @ ccmfs) => (cwf1 @ (cco @ XR @ XV @ ccmap) @ (cco @ XE @ XE @ ccmap) @ (ccres @ XS @ (cco @ XR @ XV @ ccmap)))))))))))))).
