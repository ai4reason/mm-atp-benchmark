...
thf(clsmcom2_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_po = (ccfv @ XG @ cclsm)) => ((XZ = (ccfv @ XG @ cccntz)) => ((cw3a @ (cwcel @ XT @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XU @ (ccfv @ XG @ ccsubg)) @ (cwss @ XT @ (ccfv @ XU @ XZ))) => ((cco @ XT @ XU @ Xc_po) = (cco @ XU @ XT @ Xc_po))))))))))).
