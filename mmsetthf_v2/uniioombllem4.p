...
thf(aovolun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwss @ XA2 @ ccr) & (cwcel @ (ccfv @ XA2 @ ccovol) @ ccr)) & ((cwss @ XB2 @ ccr) & (cwcel @ (ccfv @ XB2 @ ccovol) @ ccr))) => (cwbr @ (ccfv @ (ccun @ XA2 @ XB2) @ ccovol) @ (cco @ (ccfv @ XA2 @ ccovol) @ (ccfv @ XB2 @ ccovol) @ ccaddc) @ ccle))))).
...
thf(aovolfiniun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (((cwcel @ XA2 @ ccfn) & (cwral @ (^ [Xk:$i] : ((cwss @ (XB2 @ Xk) @ ccr) & (cwcel @ (ccfv @ (XB2 @ Xk) @ ccovol) @ ccr))) @ (^ [Xk:$i] : XA2))) => (cwbr @ (ccfv @ (cciun @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccovol) @ (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (XB2 @ Xk) @ ccovol))) @ ccle))))).
...
thf(auzdisj_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((ccin @ (cco @ XM @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (ccfv @ XN @ ccuz)) = cc0)))).
thf(cwrmo_tp,type,(cwrmo : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(adisjiun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) & (cw3a @ (cwss @ XC @ XA2) @ (cwss @ XD @ XA2) @ ((ccin @ XC @ XD) = cc0))) => ((ccin @ (cciun @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cciun @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) = cc0))))))).
...
thf(avolfiniun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cw3a @ (cwcel @ XA2 @ ccfn) @ (cwral @ (^ [Xk:$i] : ((cwcel @ (XB2 @ Xk) @ (ccdm @ ccvol)) & (cwcel @ (ccfv @ (XB2 @ Xk) @ ccvol) @ ccr))) @ (^ [Xk:$i] : XA2)) @ (cwdisj @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk)))) => ((ccfv @ (cciun @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccvol) = (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (XB2 @ Xk) @ ccvol)))))))).
