...
thf(alplnnleat_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XP = (ccfv @ XK @ cclpl)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XP) @ (cwcel @ XQ @ XA2)) => (~ (cwbr @ XX @ XQ @ Xc_le))))))))))))).
...
thf(clplnn0N_conj,conjecture,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XK @ ccp0)) => ((XP = (ccfv @ XK @ cclpl)) => (((cwcel @ XK @ cchlt) & (cwcel @ XX @ XP)) => (cwne @ XX @ Xc_0))))))))).
