...
thf(ahauscmp_ax,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwcel @ XJ @ ccha) @ (cwss @ XS @ XX) @ (cwcel @ (cco @ XJ @ XS @ ccrest) @ cccmp)) => (cwcel @ XS @ (ccfv @ XJ @ cccld)))))))).
