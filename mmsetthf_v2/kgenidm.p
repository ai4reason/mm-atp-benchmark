...
thf(akgencmp2_ax,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwcel @ XJ @ cctop) => ((cwcel @ (cco @ XJ @ XK @ ccrest) @ cccmp) <=> (cwcel @ (cco @ (ccfv @ XJ @ cckgen) @ XK @ ccrest) @ cccmp)))))).
...
thf(ckgenidm_conj,conjecture,(! [XJ:($i > $o)] : ((cwcel @ XJ @ (ccrn @ cckgen)) => ((ccfv @ XJ @ cckgen) = XJ)))).
