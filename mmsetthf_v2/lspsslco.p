...
thf(alincolss_ax,axiom,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XM @ cclmod) & (cwcel @ XV @ (ccpw @ (ccfv @ XM @ ccbs)))) => (cwcel @ (cco @ XM @ XV @ cclinco) @ (ccfv @ XM @ cclss)))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(cwf_tp,type,(cwf : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(ccur_tp,type,(ccur : ($i > $o))).
thf(ccif_tp,type,(ccif : ($o > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(ccmpt_tp,type,(ccmpt : (($i > ($i > $o)) > (($i > ($i > $o)) > ($i > $o))))).
thf(alcoss_ax,axiom,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XM @ cclmod) & (cwcel @ XV @ (ccpw @ (ccfv @ XM @ ccbs)))) => (cwss @ XV @ (cco @ XM @ XV @ cclinco)))))).
...
thf(clspsslco_conj,conjecture,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => (((cwcel @ XM @ cclmod) & (cwcel @ XV @ (ccpw @ XB2))) => (cwss @ (ccfv @ XV @ (ccfv @ XM @ cclspn)) @ (cco @ XM @ XV @ cclinco)))))))).
