...
thf(afunresfunco_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfun @ (ccres @ XF @ (ccrn @ XG))) & (cwfun @ XG)) => (cwfun @ (cccom @ XF @ XG)))))).
...
thf(cfnresfnco_conj,conjecture,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfn @ (ccres @ XF @ (ccrn @ XG)) @ (ccrn @ XG)) & (cwfn @ XG @ XB2)) => (cwfn @ (cccom @ XF @ XG) @ XB2)))))).
