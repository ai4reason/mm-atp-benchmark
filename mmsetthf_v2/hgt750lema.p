...
thf(afsumiunle_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccfn))) => ((! [Xx3:$i] : (! [Xk:$i] : (((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) & (cwcel @ (ccv @ Xk) @ (XB2 @ Xx3))) => (cwcel @ (XC @ Xk) @ ccr)))) => ((! [Xx3:$i] : (! [Xk:$i] : (((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) & (cwcel @ (ccv @ Xk) @ (XB2 @ Xx3))) => (cwbr @ ccc0 @ (XC @ Xk) @ ccle)))) => (Xph => (cwbr @ (ccsu @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (^ [Xk:$i] : (XC @ Xk))) @ (ccsu @ XA2 @ (^ [Xx3:$i] : (ccsu @ (XB2 @ Xx3) @ (^ [Xk:$i] : (XC @ Xk))))) @ ccle))))))))))).
...
thf(areprdifc_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((! [Xx3:$i] : (! [Xc:$i] : ((XC @ Xx3 @ Xc) = (ccrab @ (^ [Xc:$i] : (~ (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xc)) @ XB2))) @ (^ [Xc:$i] : (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr))))))) => ((! [Xc:$i] : ((Xph @ Xc) => (cwss @ XA2 @ ccn))) => ((! [Xc:$i] : ((Xph @ Xc) => (cwss @ XB2 @ ccn))) => ((! [Xc:$i] : ((Xph @ Xc) => (cwcel @ XM @ ccn0))) => ((! [Xc:$i] : ((Xph @ Xc) => (cwcel @ XS @ ccn0))) => (! [Xc:$i] : ((Xph @ Xc) => ((ccdif @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)) @ (cco @ XB2 @ XM @ (ccfv @ XS @ ccrepr))) = (cciun @ (^ [Xx3:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xc)))))))))))))))))).
...
thf(areprpmtf1o_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ ccn)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwss @ XA2 @ ccn)) => ((Xph => (cwcel @ XX @ (cco @ ccc0 @ XS @ ccfzo))) => ((! [Xc:$i] : ((XO @ Xc) = (ccrab @ (^ [Xc:$i] : (~ (cwcel @ (ccfv @ ccc0 @ (ccv @ Xc)) @ XB2))) @ (^ [Xc:$i] : (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)))))) => ((XP = (ccrab @ (^ [Xc:$i] : (~ (cwcel @ (ccfv @ XX @ (ccv @ Xc)) @ XB2))) @ (^ [Xc:$i] : (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr))))) => ((XT = (ccif @ (XX = ccc0) @ (ccres @ ccid @ (cco @ ccc0 @ XS @ ccfzo)) @ (ccfv @ (ccpr @ XX @ ccc0) @ (ccfv @ (cco @ ccc0 @ XS @ ccfzo) @ ccpmtr)))) => ((! [Xc:$i] : ((XF @ Xc) = (ccmpt @ (^ [Xc:$i] : XP) @ (^ [Xc:$i] : (cccom @ (ccv @ Xc) @ XT))))) => (! [Xc:$i] : (Xph => (cwf1o @ XP @ (XO @ Xc) @ (XF @ Xc))))))))))))))))))))))).
...
thf(ahgt750lemg_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xc:$i] : ((XF @ Xc) = (ccmpt @ (^ [Xc:$i] : XR) @ (^ [Xc:$i] : (cccom @ (ccv @ Xc) @ XT))))) => ((Xph => (cwf1o @ (cco @ ccc0 @ cc3 @ ccfzo) @ (cco @ ccc0 @ cc3 @ ccfzo) @ XT)) => ((Xph => (cwf @ (cco @ ccc0 @ cc3 @ ccfzo) @ ccn @ XN)) => ((! [Xc:$i] : (Xph => (cwf @ ccn @ ccr @ (XL @ Xc)))) => ((Xph => (cwcel @ XN @ XR)) => (! [Xc:$i] : (Xph => ((cco @ (ccfv @ (ccfv @ ccc0 @ (ccfv @ XN @ (XF @ Xc))) @ (XL @ Xc)) @ (cco @ (ccfv @ (ccfv @ cc1 @ (ccfv @ XN @ (XF @ Xc))) @ (XL @ Xc)) @ (ccfv @ (ccfv @ cc2 @ (ccfv @ XN @ (XF @ Xc))) @ (XL @ Xc)) @ ccmul) @ ccmul) = (cco @ (ccfv @ (ccfv @ ccc0 @ XN) @ (XL @ Xc)) @ (cco @ (ccfv @ (ccfv @ cc1 @ XN) @ (XL @ Xc)) @ (ccfv @ (ccfv @ cc2 @ XN) @ (XL @ Xc)) @ ccmul) @ ccmul)))))))))))))))).
thf(ccen_tp,type,(ccen : ($i > $o))).
thf(cc2o_tp,type,(cc2o : ($i > $o))).
thf(apmtridf1o_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XX @ XA2)) => ((Xph => (cwcel @ XY @ XA2)) => ((XT = (ccif @ (XX = XY) @ (ccres @ ccid @ XA2) @ (ccfv @ (ccpr @ XX @ XY) @ (ccfv @ XA2 @ ccpmtr)))) => (Xph => (cwf1o @ XA2 @ XA2 @ XT))))))))))))).
