...
thf(clspvadd_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => ((XN = (ccfv @ XW @ cclspn)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV)) => (cwss @ (ccfv @ (ccsn @ (cco @ XX @ XY @ Xc_pl)) @ XN) @ (ccfv @ (ccpr @ XX @ XY) @ XN))))))))))))).
