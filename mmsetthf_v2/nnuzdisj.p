...
thf(ann0disj_ax,axiom,(! [XN:($i > $o)] : ((ccin @ (cco @ ccc0 @ XN @ ccfz) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccuz)) = cc0))).
thf(asseq0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ XB2) & (XB2 = cc0)) => (XA2 = cc0))))).
thf(cnnuzdisj_conj,conjecture,(! [XN:($i > $o)] : ((ccin @ (cco @ cc1 @ XN @ ccfz) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccuz)) = cc0))).
