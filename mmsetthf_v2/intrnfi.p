...
thf(cintrnfi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XB2 @ XV) & (cw3a @ (cwf @ XA2 @ XB2 @ XF) @ (cwne @ XA2 @ cc0) @ (cwcel @ XA2 @ ccfn))) => (cwcel @ (ccint @ (ccrn @ XF)) @ (ccfv @ XB2 @ ccfi)))))))).
