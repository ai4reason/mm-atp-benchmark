...
thf(asupcnvlimsupmpt_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (cwnf @ (^ [Xj:$i] : (Xph @ Xj @ Xk)))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwcel @ (XM @ Xj @ Xk) @ ccz)))) => ((! [Xj:$i] : (! [Xk:$i] : (XZ = (ccfv @ (XM @ Xj @ Xk) @ ccuz)))) => ((! [Xj:$i] : (! [Xk:$i] : (((Xph @ Xj @ Xk) & (cwcel @ (ccv @ Xj) @ XZ)) => (cwcel @ (XB2 @ Xj) @ ccr)))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwcel @ (ccfv @ (ccmpt @ (^ [Xj:$i] : XZ) @ (^ [Xj:$i] : (XB2 @ Xj))) @ cclsp) @ ccr)))) => (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccsup @ (ccrn @ (ccmpt @ (^ [Xj:$i] : (ccfv @ (ccv @ Xk) @ ccuz)) @ (^ [Xj:$i] : (XB2 @ Xj)))) @ ccxr @ cclt))) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : XZ) @ (^ [Xj:$i] : (XB2 @ Xj))) @ cclsp) @ ccli)))))))))))))).
thf(aeluzelz2_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((cwcel @ XN @ XZ) => (cwcel @ XN @ ccz))))))).
thf(csmflimsuplem5_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xm:$i] : (cwnf @ (^ [Xn:$i] : (Xph @ Xx3 @ Xm @ Xn))))) => ((! [Xx3:$i] : (! [Xn:$i] : (cwnf @ (^ [Xm:$i] : (Xph @ Xx3 @ Xm @ Xn))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwcel @ (XM @ Xx3 @ Xn) @ ccz))))) => ((! [Xx3:$i] : (! [Xn:$i] : (XZ = (ccfv @ (XM @ Xx3 @ Xn) @ ccuz)))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwcel @ (XS @ Xx3 @ Xm @ Xn) @ ccsalg))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwf @ XZ @ (ccfv @ (XS @ Xx3 @ Xm @ Xn) @ ccsmblfn) @ (XF @ Xm)))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XE @ Xx3 @ Xm @ Xn) = (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ (XF @ Xm)))))) @ ccxr @ cclt) @ ccr)) @ (^ [Xx3:$i] : (cciin @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)) @ (^ [Xm:$i] : (ccdm @ (ccfv @ (ccv @ Xm) @ (XF @ Xm))))))))))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XH @ Xx3 @ Xm @ Xn) = (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccmpt @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xn) @ (XE @ Xx3 @ Xm @ Xn))) @ (^ [Xx3:$i] : (ccsup @ (ccrn @ (ccmpt @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ (XF @ Xm)))))) @ ccxr @ cclt))))))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwcel @ (ccfv @ (ccmpt @ (^ [Xm:$i] : XZ) @ (^ [Xm:$i] : (ccfv @ (XX @ Xx3) @ (ccfv @ (ccv @ Xm) @ (XF @ Xm))))) @ cclsp) @ ccr))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwcel @ (XN @ Xx3) @ XZ))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwcel @ (XX @ Xx3) @ (cciin @ (^ [Xm:$i] : (ccfv @ (XN @ Xx3) @ ccuz)) @ (^ [Xm:$i] : (ccdm @ (ccfv @ (ccv @ Xm) @ (XF @ Xm)))))))))) => (! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwbr @ (ccmpt @ (^ [Xn:$i] : (ccfv @ (XN @ Xx3) @ ccuz)) @ (^ [Xn:$i] : (ccfv @ (XX @ Xx3) @ (ccfv @ (ccv @ Xn) @ (XH @ Xx3 @ Xm @ Xn))))) @ (ccfv @ (ccmpt @ (^ [Xm:$i] : (ccfv @ (XN @ Xx3) @ ccuz)) @ (^ [Xm:$i] : (ccfv @ (XX @ Xx3) @ (ccfv @ (ccv @ Xm) @ (XF @ Xm))))) @ cclsp) @ ccli)))))))))))))))))))))))))).
