...
thf(adivcncff_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ XX @ ccc @ cccncf))) => ((Xph => (cwcel @ XG @ (cco @ XX @ (ccdif @ ccc @ (ccsn @ ccc0)) @ cccncf))) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ ccdiv)) @ (cco @ XX @ ccc @ cccncf)))))))))).
