...
thf(ambfconstlem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ XC @ ccr)) => (cwcel @ (ccima @ (cccnv @ (ccxp @ XA2 @ (ccsn @ XC))) @ XB2) @ (ccdm @ ccvol))))))).
...
thf(cismbf_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ ccr @ XF) => ((cwcel @ XF @ ccmbf) <=> (cwral @ (^ [Xx3:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xx3)) @ (ccdm @ ccvol))) @ (^ [Xx3:$i] : (ccrn @ ccioo)))))))).
