...
thf(acfpwsdom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwbr @ cc2o @ XB2 @ ccdom) => (cwbr @ (ccfv @ XA2 @ ccale) @ (ccfv @ (ccfv @ (cco @ XB2 @ (ccfv @ XA2 @ ccale) @ ccmap) @ cccrd) @ cccf) @ ccsdm)))))).
...
thf(aalephsing_ax,axiom,(! [XA2:($i > $o)] : ((cwlim @ XA2) => ((ccfv @ (ccfv @ XA2 @ ccale) @ cccf) = (ccfv @ XA2 @ cccf))))).
thf(acfom_ax,axiom,((ccfv @ ccom @ cccf) = ccom)).
thf(calephom_conj,conjecture,(cwne @ (ccfv @ (cco @ cc2o @ ccom @ ccmap) @ cccrd) @ (ccfv @ ccom @ ccale))).
