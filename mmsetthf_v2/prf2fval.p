...
thf(cprf2fval_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xh:$i] : ((XP @ Xh) = (cco @ XF @ XG @ ccprf))) => ((! [Xh:$i] : (XB2 = (ccfv @ (XC @ Xh) @ ccbs))) => ((! [Xh:$i] : (XH = (ccfv @ (XC @ Xh) @ cchom))) => ((! [Xh:$i] : (Xph => (cwcel @ XF @ (cco @ (XC @ Xh) @ (XD @ Xh) @ ccfunc)))) => ((! [Xh:$i] : (Xph => (cwcel @ XG @ (cco @ (XC @ Xh) @ (XE @ Xh) @ ccfunc)))) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => (! [Xh:$i] : (Xph => ((cco @ XX @ XY @ (ccfv @ (XP @ Xh) @ cc2nd)) = (ccmpt @ (^ [Xh:$i] : (cco @ XX @ XY @ XH)) @ (^ [Xh:$i] : (ccop @ (ccfv @ (ccv @ Xh) @ (cco @ XX @ XY @ (ccfv @ XF @ cc2nd))) @ (ccfv @ (ccv @ Xh) @ (cco @ XX @ XY @ (ccfv @ XG @ cc2nd)))))))))))))))))))))))))))).
