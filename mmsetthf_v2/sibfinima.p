...
thf(ameasbasedom_ax,axiom,(! [XM:($i > $o)] : ((cwcel @ XM @ (ccuni @ (ccrn @ ccmeas))) <=> (cwcel @ XM @ (ccfv @ (ccdm @ XM) @ ccmeas))))).
...
thf(acldssbrsiga_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cctop) => (cwss @ (ccfv @ XJ @ cccld) @ (ccfv @ XJ @ ccsigagen))))).
thf(asibff_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XJ = (ccfv @ XW @ cctopn)) => ((XS = (ccfv @ XJ @ ccsigagen)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XH = (ccfv @ (ccfv @ XW @ ccsca) @ ccrrh)) => ((Xph => (cwcel @ XW @ XV)) => ((Xph => (cwcel @ XM @ (ccuni @ (ccrn @ ccmeas)))) => ((Xph => (cwcel @ XF @ (ccdm @ (cco @ XW @ XM @ ccsitg)))) => (Xph => (cwf @ (ccuni @ (ccdm @ XM)) @ (ccuni @ XJ) @ XF))))))))))))))))))))))).
thf(cwfn_tp,type,(cwfn : (($i > $o) > (($i > $o) > $o)))).
thf(afrn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => (cwss @ (ccrn @ XF) @ XB2)))))).
thf(asimp2_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) => Xps))))).
thf(at1sncld_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cct1) & (cwcel @ XA2 @ XX)) => (cwcel @ (ccsn @ XA2) @ (ccfv @ XJ @ cccld)))))))).
...
thf(csibfinima_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XJ = (ccfv @ XW @ cctopn)) => ((XS = (ccfv @ XJ @ ccsigagen)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XH = (ccfv @ (ccfv @ XW @ ccsca) @ ccrrh)) => ((Xph => (cwcel @ XW @ XV)) => ((Xph => (cwcel @ XM @ (ccuni @ (ccrn @ ccmeas)))) => ((Xph => (cwcel @ XF @ (ccdm @ (cco @ XW @ XM @ ccsitg)))) => ((Xph => (cwcel @ XG @ (ccdm @ (cco @ XW @ XM @ ccsitg)))) => ((Xph => (cwcel @ XW @ cctps)) => ((Xph => (cwcel @ XJ @ cct1)) => (((cw3a @ Xph @ (cwcel @ XX @ (ccrn @ XF)) @ (cwcel @ XY @ (ccrn @ XG))) & ((cwne @ XX @ Xc_0) | (cwne @ XY @ Xc_0))) => (cwcel @ (ccfv @ (ccin @ (ccima @ (cccnv @ XF) @ (ccsn @ XX)) @ (ccima @ (cccnv @ XG) @ (ccsn @ XY))) @ XM) @ (cco @ ccc0 @ ccpnf @ ccico)))))))))))))))))))))))))))))).
