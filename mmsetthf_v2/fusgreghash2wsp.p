...
thf(afusgreg2wsp_ax,axiom,(! [XG:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > $o))] : ((! [Xw:$i] : ((XV @ Xw) = (ccfv @ XG @ ccvtx))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xa:$i] : ((XM @ Xx3 @ Xw @ Xa) = (ccmpt @ (^ [Xa:$i] : (XV @ Xw)) @ (^ [Xa:$i] : (ccrab @ (^ [Xw:$i] : ((ccfv @ cc1 @ (ccv @ Xw)) = (ccv @ Xa))) @ (^ [Xw:$i] : (cco @ cc2 @ XG @ ccwwspthsn))))))))) => (! [Xw:$i] : (! [Xa:$i] : ((cwcel @ XG @ ccfusgr) => ((cco @ cc2 @ XG @ ccwwspthsn) = (cciun @ (^ [Xx3:$i] : (XV @ Xw)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (XM @ Xx3 @ Xw @ Xa)))))))))))))).
...
thf(ahashiun_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccfn))) => ((Xph => (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) => (Xph => ((ccfv @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cchash) = (ccsu @ XA2 @ (^ [Xx3:$i] : (ccfv @ (XB2 @ Xx3) @ cchash)))))))))))).
...
thf(awspthnfi_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ (ccfv @ XG @ ccvtx) @ ccfn) => (cwcel @ (cco @ XN @ XG @ ccwwspthsn) @ ccfn))))).
thf(ccab_tp,type,(ccab : (($i > $o) > ($i > $o)))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(arabfi_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfn) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ ccfn))))).
thf(aa1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(a_2wspmdisj_ax,axiom,(! [XG:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xw:$i] : (! [Xa:$i] : ((XM @ Xw @ Xa) = (ccmpt @ (^ [Xa:$i] : XV) @ (^ [Xa:$i] : (ccrab @ (^ [Xw:$i] : ((ccfv @ cc1 @ (ccv @ Xw)) = (ccv @ Xa))) @ (^ [Xw:$i] : (cco @ cc2 @ XG @ ccwwspthsn)))))))) => (! [Xw:$i] : (! [Xa:$i] : (cwdisj @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (XM @ Xw @ Xa)))))))))))).
...
thf(akcnktkm1cn_ax,axiom,(! [XK:($i > $o)] : ((cwcel @ XK @ ccc) => (cwcel @ (cco @ XK @ (cco @ XK @ cc1 @ ccmin) @ ccmul) @ ccc)))).
...
thf(cfusgreghash2wsp_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ ccfusgr) & (cwne @ XV @ cc0)) => ((cwral @ (^ [Xv:$i] : ((ccfv @ (ccv @ Xv) @ (ccfv @ XG @ ccvtxdg)) = XK)) @ (^ [Xv:$i] : XV)) => ((ccfv @ (cco @ cc2 @ XG @ ccwwspthsn) @ cchash) = (cco @ (ccfv @ XV @ cchash) @ (cco @ XK @ (cco @ XK @ cc1 @ ccmin) @ ccmul) @ ccmul))))))))).
