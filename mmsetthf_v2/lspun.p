...
thf(clspun_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwss @ XT @ XV) @ (cwss @ XU @ XV)) => ((ccfv @ (ccun @ XT @ XU) @ XN) = (ccfv @ (ccun @ (ccfv @ XT @ XN) @ (ccfv @ XU @ XN)) @ XN))))))))))).
