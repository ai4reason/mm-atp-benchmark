...
thf(cesumpmono_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn)) => (cwcel @ (XA2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccico)))) => (Xph => (cwbr @ (ccesum @ (^ [Xk:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ (ccesum @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccle)))))))))).
