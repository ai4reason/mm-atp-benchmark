...
thf(ainfleinflem2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwss @ XA2 @ ccxr)) => ((Xph => (cwss @ XB2 @ ccxr)) => ((Xph => (cwcel @ XR @ ccr)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwbr @ XX @ (cco @ XR @ cc2 @ ccmin) @ cclt)) => ((Xph => (cwcel @ XZ @ XA2)) => ((Xph => (cwbr @ XZ @ (cco @ XX @ cc1 @ ccxad) @ ccle)) => (Xph => (cwbr @ XZ @ XR @ cclt)))))))))))))))).
...
thf(ainfrpge_b2_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XA2 @ ccxr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwne @ XA2 @ cc0))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XB2 @ Xx3) @ ccrp))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (cco @ (ccinf @ XA2 @ ccxr @ cclt) @ (XB2 @ Xx3) @ ccxad) @ ccle)) @ (^ [Xy1:$i] : XA2))))))))))))).
...
thf(ainfxrbnd2_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => ((cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr)) <=> (cwbr @ ccmnf @ (ccinf @ XA2 @ ccxr @ cclt) @ cclt))))).
...
thf(ainfleinflem1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwss @ XA2 @ ccxr)) => ((Xph => (cwss @ XB2 @ ccxr)) => ((Xph => (cwcel @ XW @ ccrp)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwbr @ XX @ (cco @ (ccinf @ XB2 @ ccxr @ cclt) @ (cco @ XW @ cc2 @ ccdiv) @ ccxad) @ ccle)) => ((Xph => (cwcel @ XZ @ XA2)) => ((Xph => (cwbr @ XZ @ (cco @ XX @ (cco @ XW @ cc2 @ ccdiv) @ ccxad) @ ccle)) => (Xph => (cwbr @ (ccinf @ XA2 @ ccxr @ cclt) @ (cco @ (ccinf @ XB2 @ ccxr @ cclt) @ XW @ ccxad) @ ccle)))))))))))))))).
...
thf(cinfleinf_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwss @ XA2 @ ccxr)) => ((Xph => (cwss @ XB2 @ ccxr)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwcel @ (ccv @ Xy1) @ ccrp)) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccxad) @ ccle)) @ (^ [Xz:$i] : XA2))))) => (Xph => (cwbr @ (ccinf @ XA2 @ ccxr @ cclt) @ (ccinf @ XB2 @ ccxr @ cclt) @ ccle))))))))).
