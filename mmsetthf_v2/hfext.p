...
thf(astoic1b_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xth:$o] : (((Xph & Xps) => Xth) => ((Xps & (~ Xth)) => (~ Xph))))))).
thf(ccom_tp,type,(ccom : ($i > $o))).
thf(ccrnk_tp,type,(ccrnk : ($i > $o))).
thf(ccfv_tp,type,(ccfv : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ahfelhf_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ XB2) & (cwcel @ XB2 @ cchf)) => (cwcel @ XA2 @ cchf))))).
...
thf(chfext_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cchf) & (cwcel @ XB2 @ cchf)) => ((XA2 = XB2) <=> (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) <=> (cwcel @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : cchf))))))).
