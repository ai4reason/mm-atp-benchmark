...
thf(a_3vfriswmgrlem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XY) @ (cwne @ XA2 @ XB2)) & ((XV = (cctp @ XA2 @ XB2 @ XC)) & (cwcel @ XG @ ccusgr))) => ((cwcel @ (ccpr @ XA2 @ XB2) @ XE) => (cwreu @ (^ [Xw:$i] : (cwcel @ (ccpr @ XA2 @ (ccv @ Xw)) @ XE)) @ (^ [Xw:$i] : (ccpr @ XA2 @ XB2)))))))))))))))).
