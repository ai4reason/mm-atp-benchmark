...
thf(asscoid_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ (cccom @ ccid @ XB2)) <=> ((cwrel @ XA2) & (cwss @ XA2 @ XB2)))))).
thf(cdffun10_conj,conjecture,(! [XF:($i > $o)] : ((cwfun @ XF) <=> (cwss @ XF @ (cccom @ ccid @ (ccdif @ ccvv @ (cccom @ (ccdif @ ccvv @ ccid) @ XF))))))).
