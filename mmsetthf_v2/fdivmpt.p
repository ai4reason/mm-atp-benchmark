...
thf(afdivval_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XF @ XV) & (cwcel @ XG @ XW)) => ((cco @ XF @ XG @ ccfdiv) = (ccres @ (cco @ XF @ XG @ (ccof @ ccdiv)) @ (cco @ XG @ ccc0 @ ccsupp))))))))).
...
thf(cfdivmpt_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwf @ XA2 @ ccc @ XF) @ (cwf @ XA2 @ ccc @ XG) @ (cwcel @ XA2 @ XV)) => ((cco @ XF @ XG @ ccfdiv) = (ccmpt @ (^ [Xx3:$i] : (cco @ XG @ ccc0 @ ccsupp)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG) @ ccdiv)))))))))).
