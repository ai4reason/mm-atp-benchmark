...
thf(cismrer1_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : ((XR @ Xx3) = (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ ccr @ ccr)))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ XA2) @ (ccsn @ (ccv @ Xx3))))))) => (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => (cwcel @ (XF @ Xx3) @ (cco @ (XR @ Xx3) @ (ccfv @ (ccsn @ XA2) @ ccrrn) @ ccismty))))))))))).
