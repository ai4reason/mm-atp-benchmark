...
thf(cfta1b_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XO:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XD = (ccfv @ XR @ ccdg1)) => ((XO = (ccfv @ XR @ cce1)) => ((XW = (ccfv @ XR @ cc0g)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((cwcel @ XR @ ccidom) <=> (cw3a @ (cwcel @ XR @ cccrg) @ (cwcel @ XR @ ccnzr) @ (cwral @ (^ [Xf1:$i] : (cwbr @ (ccfv @ (ccima @ (cccnv @ (ccfv @ (ccv @ Xf1) @ XO)) @ (ccsn @ XW)) @ cchash) @ (ccfv @ (ccv @ Xf1) @ XD) @ ccle)) @ (^ [Xf1:$i] : (ccdif @ XB2 @ (ccsn @ Xc_0)))))))))))))))))))).
