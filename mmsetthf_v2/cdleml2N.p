...
thf(acdleml1N_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [Xf1:$i] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ (cw3a @ (cwcel @ XU @ XE) @ (cwcel @ XV @ XE) @ (cwcel @ (ccv @ Xf1) @ XT)) @ (cw3a @ (cwne @ (ccv @ Xf1) @ (ccres @ ccid @ XB2)) @ (cwne @ (ccfv @ (ccv @ Xf1) @ XU) @ (ccres @ ccid @ XB2)) @ (cwne @ (ccfv @ (ccv @ Xf1) @ XV) @ (ccres @ ccid @ XB2)))) => ((ccfv @ (ccfv @ (ccv @ Xf1) @ XU) @ XR) = (ccfv @ (ccfv @ (ccv @ Xf1) @ XV) @ XR))))))))))))))))))).
