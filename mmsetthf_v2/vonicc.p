...
thf(ahoidmv0val_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XL @ Xx3 @ Xk @ Xa @ Xb) = (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cco @ ccr @ (ccv @ Xx3) @ ccmap))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ ((ccv @ Xx3) = cc0) @ ccc0 @ (ccprod @ (^ [Xk:$i] : (ccv @ Xx3)) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xb)) @ ccico) @ ccvol)))))))))))))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph @ Xk) => (cwf @ cc0 @ ccr @ (XA2 @ Xx3))))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph @ Xk) => (cwf @ cc0 @ ccr @ (XB2 @ Xx3))))) => (! [Xx3:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xk) => ((cco @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ (ccfv @ cc0 @ (XL @ Xx3 @ Xk @ Xa @ Xb))) = ccc0)))))))))))))).
...
thf(avon0val_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ (ccdm @ (ccfv @ cc0 @ ccvoln)))) => (Xph => ((ccfv @ XA2 @ (ccfv @ cc0 @ ccvoln)) = ccc0)))))).
thf(aiccvonmbl_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((! [Xi:$i] : ((XS @ Xi) = (ccdm @ (ccfv @ XX @ ccvoln)))) => ((Xph => (cwf @ XX @ ccr @ XA2)) => ((Xph => (cwf @ XX @ ccr @ XB2)) => (! [Xi:$i] : (Xph => (cwcel @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XA2) @ (ccfv @ (ccv @ Xi) @ XB2) @ ccicc))) @ (XS @ Xi)))))))))))))).
...
thf(avolico2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccico) @ ccvol) = (ccif @ (cwbr @ XA2 @ XB2 @ ccle) @ (cco @ XB2 @ XA2 @ ccmin) @ ccc0)))))).
...
thf(anfixp1_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (cwnfc @ (^ [Xx3:$i] : (ccixp @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))).
...
thf(anfcprod1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xk:$i] : XA2)) => (cwnfc @ (^ [Xk:$i] : (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))))))))).
...
thf(amea0_ax,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccmea)) => (Xph => ((ccfv @ cc0 @ XM) = ccc0)))))).
...
thf(aicc0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => (((cco @ XA2 @ XB2 @ ccicc) = cc0) <=> (cwbr @ XB2 @ XA2 @ cclt)))))).
thf(arspe_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) & (Xph @ Xx3)) => (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))).
thf(aixp0_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwrex @ (^ [Xx3:$i] : ((XB2 @ Xx3) = cc0)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((ccixp @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = cc0))))).
...
thf(afprodeq0g_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XA2 @ ccfn))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccc))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XC @ XA2))) => ((! [Xk:$i] : (((Xph @ Xk) & ((ccv @ Xk) = XC)) => ((XB2 @ Xk) = ccc0))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) = ccc0))))))))))))).
