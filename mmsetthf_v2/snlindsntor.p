...
thf(araldifsni_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwral @ (^ [Xx3:$i] : (~ (Xph @ Xx3))) @ (^ [Xx3:$i] : (ccdif @ (XA2 @ Xx3) @ (ccsn @ (XB2 @ Xx3))))) <=> (cwral @ (^ [Xx3:$i] : ((Xph @ Xx3) => ((ccv @ Xx3) = (XB2 @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))).
...
thf(asnlindsntorlem_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((! [Xf1:$i] : (! [Xs1:$i] : ((XR @ Xf1 @ Xs1) = (ccfv @ XM @ ccsca)))) => ((! [Xf1:$i] : (! [Xs1:$i] : (XS = (ccfv @ (XR @ Xf1 @ Xs1) @ ccbs)))) => ((! [Xf1:$i] : (! [Xs1:$i] : (Xc_0 = (ccfv @ (XR @ Xf1 @ Xs1) @ cc0g)))) => ((XZ = (ccfv @ XM @ cc0g)) => ((Xc_x = (ccfv @ XM @ ccvsca)) => (((cwcel @ XM @ cclmod) & (cwcel @ XX @ XB2)) => ((cwral @ (^ [Xf1:$i] : (((cco @ (ccv @ Xf1) @ (ccsn @ XX) @ (ccfv @ XM @ cclinc)) = XZ) => ((ccfv @ XX @ (ccv @ Xf1)) = Xc_0))) @ (^ [Xf1:$i] : (cco @ XS @ (ccsn @ XX) @ ccmap))) => (cwral @ (^ [Xs1:$i] : (((cco @ (ccv @ Xs1) @ XX @ Xc_x) = XZ) => ((ccv @ Xs1) = Xc_0))) @ (^ [Xs1:$i] : XS))))))))))))))))))).
