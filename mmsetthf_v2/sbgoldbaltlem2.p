...
thf(asbgoldbaltlem1_ax,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XQ @ ccprime)) => ((cw3a @ (cwcel @ XN @ cceven) @ (cwbr @ cc4 @ XN @ cclt) @ (XN = (cco @ XP @ XQ @ ccaddc))) => (cwcel @ XQ @ ccodd))))))).
thf(csbgoldbaltlem2_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XQ @ ccprime)) => ((cw3a @ (cwcel @ XN @ cceven) @ (cwbr @ cc4 @ XN @ cclt) @ (XN = (cco @ XP @ XQ @ ccaddc))) => ((cwcel @ XP @ ccodd) & (cwcel @ XQ @ ccodd)))))))).
