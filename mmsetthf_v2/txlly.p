...
thf(ctxlly_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : ((! [Xj:$i] : (! [Xk:$i] : (((cwcel @ (ccv @ Xj) @ XA2) & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (cco @ (ccv @ Xj) @ (ccv @ Xk) @ cctx) @ XA2)))) => (! [Xj:$i] : (((cwcel @ XR @ (cclly @ XA2)) & (cwcel @ (XS @ Xj) @ (cclly @ XA2))) => (cwcel @ (cco @ XR @ (XS @ Xj) @ cctx) @ (cclly @ XA2))))))))).
