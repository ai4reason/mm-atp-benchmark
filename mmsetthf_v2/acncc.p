...
thf(aaxcc2_ax,axiom,(! [XF:($i > $o)] : (? [Xg1:$i] : ((cwfn @ (ccv @ Xg1) @ ccom) & (cwral @ (^ [Xn:$i] : ((cwne @ (ccfv @ (ccv @ Xn) @ XF) @ cc0) => (cwcel @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xn) @ XF)))) @ (^ [Xn:$i] : ccom)))))).
...
thf(cacncc_conj,conjecture,((cwacn @ ccom) = ccvv)).
