...
thf(cm2cpminvid2lem_conj,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XS = (cco @ XN @ XR @ cccpmat)) => ((XP = (ccfv @ XR @ ccpl1)) => (((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg) @ (cwcel @ XM @ XS)) & ((cwcel @ (ccv @ Xx3) @ XN) & (cwcel @ (ccv @ Xy1) @ XN))) => (cwral @ (^ [Xn:$i] : ((ccfv @ (ccv @ Xn) @ (ccfv @ (ccfv @ (ccfv @ ccc0 @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XM) @ ccco1)) @ (ccfv @ XP @ ccascl)) @ ccco1)) = (ccfv @ (ccv @ Xn) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XM) @ ccco1)))) @ (^ [Xn:$i] : ccn0))))))))))))).
