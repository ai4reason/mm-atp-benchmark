...
thf(arelexpmulnn_ax,axiom,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XR @ XV) & (XI = (cco @ XJ @ XK @ ccmul))) & ((cwcel @ XJ @ ccn) & (cwcel @ XK @ ccn))) => ((cco @ (cco @ XR @ XJ @ ccrelexp) @ XK @ ccrelexp) = (cco @ XR @ XI @ ccrelexp))))))))).
...
thf(annnle0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => (~ (cwbr @ XA2 @ ccc0 @ ccle))))).
...
thf(crelexpmulg_conj,conjecture,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (((cw3a @ (cwcel @ XR @ XV) @ (XI = (cco @ XJ @ XK @ ccmul)) @ ((XI = ccc0) => (cwbr @ XJ @ XK @ ccle))) & ((cwcel @ XJ @ ccn0) & (cwcel @ XK @ ccn0))) => ((cco @ (cco @ XR @ XJ @ ccrelexp) @ XK @ ccrelexp) = (cco @ XR @ XI @ ccrelexp))))))))).
