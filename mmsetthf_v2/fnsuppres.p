...
thf(cfnsuppres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((cw3a @ (cwfn @ XF @ (ccun @ XA2 @ XB2)) @ ((cwcel @ XF @ XW) & (cwcel @ XZ @ XV)) @ ((ccin @ XA2 @ XB2) = cc0)) => ((cwss @ (cco @ XF @ XZ @ ccsupp) @ XA2) <=> ((ccres @ XF @ XB2) = (ccxp @ XB2 @ (ccsn @ XZ)))))))))))).
