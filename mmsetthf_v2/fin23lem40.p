...
thf(aporpss_ax,axiom,(! [XA2:($i > $o)] : (cwpo @ XA2 @ ccrpss))).
thf(acnvpo_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwpo @ XA2 @ XR) <=> (cwpo @ XA2 @ (cccnv @ XR)))))).
thf(cword_tp,type,(cword : (($i > $o) > $o))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(cw3o_tp,type,(cw3o : ($o > ($o > ($o > $o))))).
thf(asornom_ax,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwfn @ XF @ ccom) @ (cwral @ (^ [Xa:$i] : ((cwbr @ (ccfv @ (ccv @ Xa) @ XF) @ (ccfv @ (ccsuc @ (ccv @ Xa)) @ XF) @ XR) | ((ccfv @ (ccv @ Xa) @ XF) = (ccfv @ (ccsuc @ (ccv @ Xa)) @ XF)))) @ (^ [Xa:$i] : ccom)) @ (cwpo @ (ccrn @ XF) @ XR)) => (cwor @ (ccrn @ XF) @ XR))))).
thf(acnvso_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwor @ XA2 @ XR) <=> (cwor @ XA2 @ (cccnv @ XR)))))).
thf(ccuni_tp,type,(ccuni : (($i > $o) > ($i > $o)))).
thf(ccdif_tp,type,(ccdif : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(afin2i2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccfin2) & (cwss @ XB2 @ (ccpw @ XA2))) & ((cwne @ XB2 @ cc0) & (cwor @ XB2 @ ccrpss))) => (cwcel @ (ccint @ XB2) @ XB2))))).
...
thf(cfin23lem40_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xg1:$i] : ((XF @ Xx3 @ Xg1) = (ccab @ (^ [Xg1:$i] : (cwral @ (^ [Xa:$i] : ((cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xa)))) @ (^ [Xx3:$i] : ccom)) => (cwcel @ (ccint @ (ccrn @ (ccv @ Xa))) @ (ccrn @ (ccv @ Xa))))) @ (^ [Xa:$i] : (cco @ (ccpw @ (ccv @ Xg1)) @ ccom @ ccmap)))))))) => (! [Xx3:$i] : (! [Xg1:$i] : ((cwcel @ XA2 @ ccfin2) => (cwcel @ XA2 @ (XF @ Xx3 @ Xg1))))))))).
