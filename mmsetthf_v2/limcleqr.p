...
thf(climcleqr_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((XK = (ccfv @ cccnfld @ cctopn)) => ((Xph => (cwss @ XA2 @ ccr)) => ((XJ = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XL @ (cco @ (ccres @ XF @ (cco @ ccmnf @ XB2 @ ccioo)) @ XB2 @ cclimc))) => ((Xph => (cwcel @ XR @ (cco @ (ccres @ XF @ (cco @ XB2 @ ccpnf @ ccioo)) @ XB2 @ cclimc))) => ((Xph => (XL = XR)) => (Xph => (cwcel @ XL @ (cco @ XF @ XB2 @ cclimc)))))))))))))))))))).
