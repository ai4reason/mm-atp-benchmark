...
thf(cxrge0infss_conj,conjecture,(! [XA2:($i > $o)] : ((cwss @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc)) => (cwrex @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ cclt))) @ (^ [Xy1:$i] : XA2)) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ cclt)) @ (^ [Xz:$i] : XA2)))) @ (^ [Xy1:$i] : (cco @ ccc0 @ ccpnf @ ccicc))))) @ (^ [Xx3:$i] : (cco @ ccc0 @ ccpnf @ ccicc)))))).
