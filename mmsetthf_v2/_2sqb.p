...
thf(abezout_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cco @ XA2 @ XB2 @ ccgcd) = (cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ (cco @ XB2 @ (ccv @ Xy1) @ ccmul) @ ccaddc))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz)))))).
...
thf(a_2sqblem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => ((cwcel @ XP @ ccprime) & (cwne @ XP @ cc2))) => ((Xph => ((cwcel @ XX @ ccz) & (cwcel @ XY @ ccz))) => ((Xph => (XP = (cco @ (cco @ XX @ cc2 @ ccexp) @ (cco @ XY @ cc2 @ ccexp) @ ccaddc))) => ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XB2 @ ccz)) => ((Xph => ((cco @ XP @ XY @ ccgcd) = (cco @ (cco @ XP @ XA2 @ ccmul) @ (cco @ XY @ XB2 @ ccmul) @ ccaddc))) => (Xph => ((cco @ XP @ cc4 @ ccmo) = cc1))))))))))))))).
...
thf(a_2sq_ax,axiom,(! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & ((cco @ XP @ cc4 @ ccmo) = cc1)) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (XP = (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))))).
thf(c_2sqb_conj,conjecture,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprime) => ((cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (XP = (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz)) <=> ((XP = cc2) | ((cco @ XP @ cc4 @ ccmo) = cc1)))))).
