...
thf(aeliin2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((cwne @ XB2 @ cc0) => ((cwcel @ XA2 @ (cciin @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3)))) <=> (cwral @ (^ [Xx3:$i] : (cwcel @ XA2 @ (XC @ Xx3))) @ (^ [Xx3:$i] : XB2)))))))).
thf(arspe_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) & (Xph @ Xx3)) => (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))).
thf(celiuniin2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((cwnfc @ (^ [Xx3:$i] : (XC @ Xx3))) => ((! [Xy1:$i] : ((XA2 @ Xy1) = (cciun @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : (cciin @ (^ [Xy1:$i] : (XC @ Xx3)) @ (^ [Xy1:$i] : (XD @ Xx3 @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwne @ (XC @ Xx3) @ cc0) => ((cwcel @ XZ @ (XA2 @ Xy1)) <=> (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ XZ @ (XD @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (XC @ Xx3)))) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1))))))))))))))).
