...
thf(acgrrflx2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XN @ ccee))) => ((Xph => (cwcel @ XB2 @ (ccfv @ XN @ ccee))) => (Xph => (cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XB2 @ XA2) @ cccgr)))))))))).
...
thf(aseglecgr12_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ (cw3a @ (cwcel @ XC @ (ccfv @ XN @ ccee)) @ (cwcel @ XD @ (ccfv @ XN @ ccee)) @ (cwcel @ XE @ (ccfv @ XN @ ccee))) @ (cw3a @ (cwcel @ XF @ (ccfv @ XN @ ccee)) @ (cwcel @ XG @ (ccfv @ XN @ ccee)) @ (cwcel @ XH @ (ccfv @ XN @ ccee)))) => (((cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XE @ XF) @ cccgr) & (cwbr @ (ccop @ XC @ XD) @ (ccop @ XG @ XH) @ cccgr)) => ((cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ ccsegle) <=> (cwbr @ (ccop @ XE @ XF) @ (ccop @ XG @ XH) @ ccsegle)))))))))))))).
...
thf(asegleantisym_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ ((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ ((cwcel @ XC @ (ccfv @ XN @ ccee)) & (cwcel @ XD @ (ccfv @ XN @ ccee)))) => (((cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ ccsegle) & (cwbr @ (ccop @ XC @ XD) @ (ccop @ XA2 @ XB2) @ ccsegle)) => (cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ cccgr))))))))).
...
thf(abtwntriv2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee))) => (cwbr @ XB2 @ (ccop @ XA2 @ XB2) @ ccbtwn)))))).
thf(ccolinbtwnle_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee)))) => ((cwbr @ XA2 @ (ccop @ XB2 @ XC) @ cccolin) => ((cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn) <=> ((cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XA2 @ XC) @ ccsegle) & (cwbr @ (ccop @ XB2 @ XC) @ (ccop @ XA2 @ XC) @ ccsegle)))))))))).
