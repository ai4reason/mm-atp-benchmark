...
thf(abj_elid_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccid) <=> ((cwcel @ XA2 @ (ccxp @ ccvv @ ccvv)) & ((ccfv @ XA2 @ cc1st) = (ccfv @ XA2 @ cc2nd)))))).
...
thf(cbj_elid3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ (ccop @ XA2 @ XB2) @ ccid) <=> ((cwcel @ XA2 @ ccvv) & (XA2 = XB2)))))).
