...
thf(avolivth_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ XB2 @ (cco @ ccc0 @ (ccfv @ XA2 @ ccvol) @ ccicc))) => (cwrex @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) & ((ccfv @ (ccv @ Xx3) @ ccvol) = XB2))) @ (^ [Xx3:$i] : (ccdm @ ccvol))))))).
...
thf(citg2const2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ XB2 @ ccrp)) => ((cwcel @ (ccfv @ XA2 @ ccvol) @ ccr) <=> (cwcel @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ XB2 @ ccc0))) @ ccitg2) @ ccr)))))).
