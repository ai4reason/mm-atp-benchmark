...
thf(aiocssioo_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & ((cwbr @ XA2 @ XC @ ccle) & (cwbr @ XD @ XB2 @ cclt))) => (cwss @ (cco @ XC @ XD @ ccioc) @ (cco @ XA2 @ XB2 @ ccioo)))))))).
...
thf(ciooiinioc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((cciin @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ XA2 @ (cco @ XB2 @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc) @ ccioo))) = (cco @ XA2 @ XB2 @ ccioc))))))))).
