...
thf(apsrbaglesupp_ax,axiom,(! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xf1:$i] : ((XD @ Xf1) = (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ XI @ ccmap))))) => (! [Xf1:$i] : (((cwcel @ XI @ (XV @ Xf1)) & (cw3a @ (cwcel @ XF @ (XD @ Xf1)) @ (cwf @ XI @ ccn0 @ XG) @ (cwbr @ XG @ XF @ (ccofr @ ccle)))) => (cwss @ (ccima @ (cccnv @ XG) @ ccn) @ (ccima @ (cccnv @ XF) @ ccn))))))))))).
...
thf(cpsrbagcon_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xf1:$i] : ((XD @ Xf1) = (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ XI @ ccmap))))) => (! [Xf1:$i] : (((cwcel @ XI @ (XV @ Xf1)) & (cw3a @ (cwcel @ XF @ (XD @ Xf1)) @ (cwf @ XI @ ccn0 @ XG) @ (cwbr @ XG @ XF @ (ccofr @ ccle)))) => ((cwcel @ (cco @ XF @ XG @ (ccof @ ccmin)) @ (XD @ Xf1)) & (cwbr @ (cco @ XF @ XG @ (ccof @ ccmin)) @ XF @ (ccofr @ ccle)))))))))))).
