...
thf(amdbr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((cwbr @ XA2 @ XB2 @ ccmd) <=> (cwral @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XB2) => ((ccin @ (cco @ (ccv @ Xx3) @ XA2 @ cchj) @ XB2) = (cco @ (ccv @ Xx3) @ (ccin @ XA2 @ XB2) @ cchj)))) @ (^ [Xx3:$i] : ccch))))))).
...
thf(cmdbr3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((cwbr @ XA2 @ XB2 @ ccmd) <=> (cwral @ (^ [Xx3:$i] : ((ccin @ (cco @ (ccin @ (ccv @ Xx3) @ XB2) @ XA2 @ cchj) @ XB2) = (cco @ (ccin @ (ccv @ Xx3) @ XB2) @ (ccin @ XA2 @ XB2) @ cchj))) @ (^ [Xx3:$i] : ccch))))))).
