...
thf(assdifsn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ (ccdif @ XB2 @ (ccsn @ XC))) <=> ((cwss @ XA2 @ XB2) & (~ (cwcel @ XC @ XA2)))))))).
...
thf(celsetrecslem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((XB2 = (ccsetrecs @ XF)) => ((cwcel @ XA2 @ XB2) => (? [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XB2) & (cwcel @ XA2 @ (ccfv @ (ccv @ Xx3) @ XF)))))))))).
