...
thf(af1imapss_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (((cwf1 @ XA2 @ XB2 @ XF) & ((cwss @ XC @ XA2) & (cwss @ XD @ XA2))) => ((cwpss @ (ccima @ XF @ XC) @ (ccima @ XF @ XD)) <=> (cwpss @ XC @ XD))))))))).
...
thf(afin4i_ax,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (((cwpss @ XX @ XA2) & (cwbr @ XX @ XA2 @ ccen)) => (~ (cwcel @ XA2 @ ccfin4)))))).
