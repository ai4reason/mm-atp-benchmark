...
thf(alogdiflbnd_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwbr @ (cco @ cc1 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccdiv) @ (cco @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cclog) @ (ccfv @ XA2 @ cclog) @ ccmin) @ ccle)))).
...
thf(asubrecd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwne @ XA2 @ ccc0)) => ((Xph => (cwne @ XB2 @ ccc0)) => (Xph => ((cco @ (cco @ cc1 @ XA2 @ ccdiv) @ (cco @ cc1 @ XB2 @ ccdiv) @ ccmin) = (cco @ (cco @ XB2 @ XA2 @ ccmin) @ (cco @ XA2 @ XB2 @ ccmul) @ ccdiv))))))))))).
