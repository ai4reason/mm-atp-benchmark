...
thf(aisrisc_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XR @ ccvv) => ((cwcel @ XS @ ccvv) => ((cwbr @ XR @ XS @ ccrisc) <=> (((cwcel @ XR @ ccrngo) & (cwcel @ XS @ ccrngo)) & (? [Xf1:$i] : (cwcel @ (ccv @ Xf1) @ (cco @ XR @ XS @ ccrngiso)))))))))).
...
thf(arngoisocnv_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwcel @ XR @ ccrngo) @ (cwcel @ XS @ ccrngo) @ (cwcel @ XF @ (cco @ XR @ XS @ ccrngiso))) => (cwcel @ (cccnv @ XF) @ (cco @ XS @ XR @ ccrngiso))))))).
thf(aancoms_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) => Xch) => ((Xps & Xph) => Xch)))))).
thf(arisci_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwcel @ XR @ ccrngo) @ (cwcel @ XS @ ccrngo) @ (cwcel @ XF @ (cco @ XR @ XS @ ccrngiso))) => (cwbr @ XR @ XS @ ccrisc)))))).
...
thf(arngoisoco_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cw3a @ (cwcel @ XR @ ccrngo) @ (cwcel @ XS @ ccrngo) @ (cwcel @ XT @ ccrngo)) & ((cwcel @ XF @ (cco @ XR @ XS @ ccrngiso)) & (cwcel @ XG @ (cco @ XS @ XT @ ccrngiso)))) => (cwcel @ (cccom @ XG @ XF) @ (cco @ XR @ XT @ ccrngiso))))))))).
