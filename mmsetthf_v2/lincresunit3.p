...
thf(alincresunit3lem2_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((XB2 = (ccfv @ XM @ ccbs)) => ((! [Xs1:$i] : ((XR @ Xs1) = (ccfv @ XM @ ccsca))) => ((! [Xs1:$i] : (XE = (ccfv @ (XR @ Xs1) @ ccbs))) => ((! [Xs1:$i] : (XU = (ccfv @ (XR @ Xs1) @ ccui))) => ((! [Xs1:$i] : (Xc_0 = (ccfv @ (XR @ Xs1) @ cc0g))) => ((! [Xs1:$i] : ((XZ @ Xs1) = (ccfv @ XM @ cc0g))) => ((! [Xs1:$i] : (XN = (ccfv @ (XR @ Xs1) @ ccminusg))) => ((! [Xz:$i] : (! [Xs1:$i] : ((XI @ Xz) = (ccfv @ (XR @ Xs1) @ ccinvr)))) => ((! [Xz:$i] : (! [Xs1:$i] : ((Xc_x @ Xz) = (ccfv @ (XR @ Xs1) @ ccmulr)))) => ((! [Xz:$i] : (! [Xs1:$i] : ((XG @ Xs1) = (ccmpt @ (^ [Xs1:$i] : (ccdif @ XS @ (ccsn @ XX))) @ (^ [Xs1:$i] : (cco @ (ccfv @ (ccfv @ (ccfv @ XX @ XF) @ XN) @ (XI @ Xz)) @ (ccfv @ (ccv @ Xs1) @ XF) @ (Xc_x @ Xz))))))) => (! [Xs1:$i] : (((cw3a @ (cwcel @ XS @ (ccpw @ XB2)) @ (cwcel @ XM @ cclmod) @ (cwcel @ XX @ XS)) & (cw3a @ (cwcel @ XF @ (cco @ XE @ XS @ ccmap)) @ (cwcel @ (ccfv @ XX @ XF) @ XU) @ (cwbr @ XF @ Xc_0 @ ccfsupp))) => ((cco @ (ccfv @ (ccfv @ XX @ XF) @ XN) @ (cco @ XM @ (ccmpt @ (^ [Xz:$i] : (ccdif @ XS @ (ccsn @ XX))) @ (^ [Xz:$i] : (cco @ (ccfv @ (ccv @ Xz) @ (XG @ Xs1)) @ (ccv @ Xz) @ (ccfv @ XM @ ccvsca)))) @ ccgsu) @ (ccfv @ XM @ ccvsca)) = (cco @ (ccres @ XF @ (ccdif @ XS @ (ccsn @ XX))) @ (ccdif @ XS @ (ccsn @ XX)) @ (ccfv @ XM @ cclinc)))))))))))))))))))))))))))))).
...
thf(ascmfsupp_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((! [Xv:$i] : ((XS @ Xv) = (ccfv @ XM @ ccsca))) => ((! [Xv:$i] : (XR = (ccfv @ (XS @ Xv) @ ccbs))) => (! [Xv:$i] : ((cw3a @ ((cwcel @ XM @ cclmod) & (cwcel @ XV @ (ccpw @ (ccfv @ XM @ ccbs)))) @ (cwcel @ XA2 @ (cco @ XR @ XV @ ccmap)) @ (cwbr @ XA2 @ (ccfv @ (XS @ Xv) @ cc0g) @ ccfsupp)) => (cwbr @ (ccmpt @ (^ [Xv:$i] : XV) @ (^ [Xv:$i] : (cco @ (ccfv @ (ccv @ Xv) @ XA2) @ (ccv @ Xv) @ (ccfv @ XM @ ccvsca)))) @ (ccfv @ XM @ cc0g) @ ccfsupp))))))))))).
...
thf(alincresunit3lem3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XR = (ccfv @ XM @ ccsca)) => ((XE = (ccfv @ XR @ ccbs)) => ((XU = (ccfv @ XR @ ccui)) => ((XN = (ccfv @ XR @ ccminusg)) => ((Xc_x = (ccfv @ XM @ ccvsca)) => (((cw3a @ (cwcel @ XM @ cclmod) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) & (cwcel @ XA2 @ XU)) => (((cco @ (ccfv @ XA2 @ XN) @ XX @ Xc_x) = (cco @ (ccfv @ XA2 @ XN) @ XY @ Xc_x)) <=> (XX = XY)))))))))))))))))))).
thf(aeqcom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 = XB2) <=> (XB2 = XA2))))).
thf(clincresunit3_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XR = (ccfv @ XM @ ccsca)) => ((XE = (ccfv @ XR @ ccbs)) => ((XU = (ccfv @ XR @ ccui)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XZ = (ccfv @ XM @ cc0g)) => ((XN = (ccfv @ XR @ ccminusg)) => ((XI = (ccfv @ XR @ ccinvr)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XG = (ccmpt @ (^ [Xs1:$i] : (ccdif @ XS @ (ccsn @ XX))) @ (^ [Xs1:$i] : (cco @ (ccfv @ (ccfv @ (ccfv @ XX @ XF) @ XN) @ XI) @ (ccfv @ (ccv @ Xs1) @ XF) @ Xc_x)))) => ((cw3a @ (cw3a @ (cwcel @ XS @ (ccpw @ XB2)) @ (cwcel @ XM @ cclmod) @ (cwcel @ XX @ XS)) @ (cw3a @ (cwcel @ XF @ (cco @ XE @ XS @ ccmap)) @ (cwcel @ (ccfv @ XX @ XF) @ XU) @ (cwbr @ XF @ Xc_0 @ ccfsupp)) @ ((cco @ XF @ XS @ (ccfv @ XM @ cclinc)) = XZ)) => ((cco @ XG @ (ccdif @ XS @ (ccsn @ XX)) @ (ccfv @ XM @ cclinc)) = XX))))))))))))))))))))))))))).
