...
thf(aabsef_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (ccfv @ XA2 @ cce) @ ccabs) = (ccfv @ (ccfv @ XA2 @ ccre) @ cce))))).
...
thf(czetacvg_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XS @ ccc)) => ((Xph => (cwbr @ cc1 @ (ccfv @ XS @ ccre) @ cclt)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn)) => ((ccfv @ (ccv @ Xk) @ XF) = (cco @ (ccv @ Xk) @ (ccneg @ XS) @ cccxp)))) => (Xph => (cwcel @ (ccseq @ ccaddc @ XF @ cc1) @ (ccdm @ ccli)))))))))).
