...
thf(alinethru_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ cclines2) @ ((cwcel @ XP @ XA2) & (cwcel @ XQ @ XA2)) @ (cwne @ XP @ XQ)) => (XA2 = (cco @ XP @ XQ @ ccline2))))))).
...
thf(chilbert1_2_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : ((cwne @ XP @ XQ) => (cwrmo @ (^ [Xx3:$i] : ((cwcel @ XP @ (ccv @ Xx3)) & (cwcel @ XQ @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : cclines2)))))).
