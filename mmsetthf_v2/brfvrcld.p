...
thf(cbrfvrcld_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (cwcel @ XR @ ccvv)) => (Xph => ((cwbr @ XA2 @ XB2 @ (ccfv @ XR @ ccrcl)) <=> ((cwbr @ XA2 @ XB2 @ (cco @ XR @ ccc0 @ ccrelexp)) | (cwbr @ XA2 @ XB2 @ (cco @ XR @ cc1 @ ccrelexp))))))))))).
