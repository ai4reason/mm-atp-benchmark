...
thf(amarrepfval_ax,axiom,(! [XA2:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XQ:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xl:$i] : ((XA2 @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl) = (cco @ XN @ XR @ ccmat)))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xl:$i] : ((XB2 @ Xi @ Xj @ Xk @ Xl) = (ccfv @ (XA2 @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl) @ ccbs)))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xl:$i] : ((XQ @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl) = (cco @ XN @ XR @ ccmarrep)))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xl:$i] : ((Xc_0 @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl) = (ccfv @ XR @ cc0g)))))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xs1:$i] : (! [Xl:$i] : ((XQ @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl) = (ccmpt2 @ (^ [Xm:$i] : (^ [Xs1:$i] : (XB2 @ Xi @ Xj @ Xk @ Xl))) @ (^ [Xm:$i] : (^ [Xs1:$i] : (ccfv @ XR @ ccbs))) @ (^ [Xm:$i] : (^ [Xs1:$i] : (ccmpt2 @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : XN)) @ (^ [Xk:$i] : (^ [Xl:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = (ccv @ Xk)) @ (ccif @ ((ccv @ Xj) = (ccv @ Xl)) @ (ccv @ Xs1) @ (Xc_0 @ Xi @ Xj @ Xk @ Xm @ Xs1 @ Xl)) @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccv @ Xm)))))))))))))))))))))))))))))).
