...
thf(aprlem934_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XA2 @ ccnp) => (cwrex @ (^ [Xx3:$i] : (~ (cwcel @ (cco @ (ccv @ Xx3) @ XB2 @ ccplq) @ XA2))) @ (^ [Xx3:$i] : XA2))))))).
...
thf(cltaddpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccnp) & (cwcel @ XB2 @ ccnp)) => (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ ccpp) @ ccltp))))).
