...
thf(a_3halfnz_ax,axiom,(~ (cwcel @ (cco @ cc3 @ cc2 @ ccdiv) @ ccz))).
...
thf(cnn0o1gt2_conj,conjecture,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn0)) => ((XN = cc1) | (cwbr @ cc2 @ XN @ cclt))))).
