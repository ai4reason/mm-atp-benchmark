...
thf(akmlem11_ax,axiom,(! [XA2:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xu:$i] : (! [Xt:$i] : ((XA2 @ Xx3 @ Xu @ Xt) = (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xt:$i] : ((ccv @ Xu) = (ccdif @ (ccv @ Xt) @ (ccuni @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xt))))))) @ (^ [Xt:$i] : (ccv @ Xx3))))))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xu:$i] : (! [Xt:$i] : ((cwcel @ (ccv @ Xz) @ (ccv @ Xx3)) => ((ccin @ (ccv @ Xz) @ (ccuni @ (XA2 @ Xx3 @ Xu @ Xt))) = (ccdif @ (ccv @ Xz) @ (ccuni @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xz)))))))))))))).
...
thf(ckmlem12_conj,conjecture,(! [Xy1:$i] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xu:$i] : (! [Xt:$i] : ((XA2 @ Xx3 @ Xu @ Xt) = (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xt:$i] : ((ccv @ Xu) = (ccdif @ (ccv @ Xt) @ (ccuni @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xt))))))) @ (^ [Xt:$i] : (ccv @ Xx3))))))))) => (! [Xx3:$i] : (! [Xu:$i] : (! [Xt:$i] : ((cwral @ (^ [Xz:$i] : (cwne @ (ccdif @ (ccv @ Xz) @ (ccuni @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xz))))) @ cc0)) @ (^ [Xz:$i] : (ccv @ Xx3))) => ((cwral @ (^ [Xz:$i] : ((cwne @ (ccv @ Xz) @ cc0) => (cweu @ (^ [Xv:$i] : (cwcel @ (ccv @ Xv) @ (ccin @ (ccv @ Xz) @ (ccv @ Xy1))))))) @ (^ [Xz:$i] : (XA2 @ Xx3 @ Xu @ Xt))) => (cwral @ (^ [Xz:$i] : ((cwne @ (ccv @ Xz) @ cc0) => (cweu @ (^ [Xv:$i] : (cwcel @ (ccv @ Xv) @ (ccin @ (ccv @ Xz) @ (ccin @ (ccv @ Xy1) @ (ccuni @ (XA2 @ Xx3 @ Xu @ Xt))))))))) @ (^ [Xz:$i] : (ccv @ Xx3)))))))))))).
