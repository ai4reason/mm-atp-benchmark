...
thf(aregt1loggt0_ax,axiom,(! [XB2:($i > $o)] : ((cwcel @ XB2 @ (cco @ cc1 @ ccpnf @ ccioo)) => (cwbr @ ccc0 @ (ccfv @ XB2 @ cclog) @ cclt)))).
...
thf(alogbval_ax,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XB2 @ (ccdif @ ccc @ (ccpr @ ccc0 @ cc1))) & (cwcel @ XX @ (ccdif @ ccc @ (ccsn @ ccc0)))) => ((cco @ XB2 @ XX @ cclogb) = (cco @ (ccfv @ XX @ cclog) @ (ccfv @ XB2 @ cclog) @ ccdiv)))))).
thf(crege1logbrege0_conj,conjecture,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XB2 @ (cco @ cc1 @ ccpnf @ ccioo)) & (cwcel @ XX @ (cco @ cc1 @ ccpnf @ ccico))) => (cwbr @ ccc0 @ (cco @ XB2 @ XX @ cclogb) @ ccle))))).
