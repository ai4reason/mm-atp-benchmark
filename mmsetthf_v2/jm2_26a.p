...
thf(ajm2_25_ax,axiom,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ ((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) @ (cwcel @ XI @ ccz)) => ((cwbr @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ (cco @ XA2 @ (cco @ XM @ (cco @ XI @ (cco @ cc2 @ XN @ ccmul) @ ccmul) @ ccaddc) @ ccrmy) @ (cco @ XA2 @ XM @ ccrmy) @ ccmin) @ ccdvds) | (cwbr @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ (cco @ XA2 @ (cco @ XM @ (cco @ XI @ (cco @ cc2 @ XN @ ccmul) @ ccmul) @ ccaddc) @ ccrmy) @ (ccneg @ (cco @ XA2 @ XM @ ccrmy)) @ ccmin) @ ccdvds)))))))).
thf(aacongeq12d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((Xph => (XB2 = XC)) => ((Xph => (XD = XE)) => (Xph => (((cwbr @ XA2 @ (cco @ XB2 @ XD @ ccmin) @ ccdvds) | (cwbr @ XA2 @ (cco @ XB2 @ (ccneg @ XD) @ ccmin) @ ccdvds)) <=> ((cwbr @ XA2 @ (cco @ XC @ XE @ ccmin) @ ccdvds) | (cwbr @ XA2 @ (cco @ XC @ (ccneg @ XE) @ ccmin) @ ccdvds))))))))))))).
...
thf(aacongneg2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz)) & ((cwbr @ XA2 @ (cco @ XB2 @ (ccneg @ XC) @ ccmin) @ ccdvds) | (cwbr @ XA2 @ (cco @ XB2 @ (ccneg @ (ccneg @ XC)) @ ccmin) @ ccdvds))) => ((cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccdvds) | (cwbr @ XA2 @ (cco @ XB2 @ (ccneg @ XC) @ ccmin) @ ccdvds))))))).
