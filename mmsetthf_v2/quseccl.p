...
thf(cquseccl_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XH = (cco @ XG @ (cco @ XG @ XS @ ccqg) @ ccqus)) => ((XV = (ccfv @ XG @ ccbs)) => ((XB2 = (ccfv @ XH @ ccbs)) => (((cwcel @ XS @ (ccfv @ XG @ ccnsg)) & (cwcel @ XX @ XV)) => (cwcel @ (ccec @ XX @ (cco @ XG @ XS @ ccqg)) @ XB2)))))))))))).
