...
thf(ahashfun_ax,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ ccfn) => ((cwfun @ XF) <=> ((ccfv @ XF @ cchash) = (ccfv @ (ccdm @ XF) @ cchash)))))).
...
thf(aiswrdsymb_ax,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ ccvv)) & (cwral @ (^ [Xi:$i] : (cwcel @ (ccfv @ (ccv @ Xi) @ XW) @ XV)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)))) => (cwcel @ XW @ (ccword @ XV)))))).
...
thf(aelincfzoext_ax,axiom,(! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XZ @ (cco @ XM @ XN @ ccfzo)) & (cwcel @ XI @ ccn0)) => (cwcel @ (cco @ XZ @ XI @ ccaddc) @ (cco @ XM @ (cco @ XN @ XI @ ccaddc) @ ccfzo)))))))).
...
thf(aintn3an3d_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (~ Xps)) => (Xph => (~ (cw3a @ Xch @ Xth @ Xps))))))))).
...
thf(cccatalpha_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XA2 @ (ccword @ ccvv)) & (cwcel @ XB2 @ (ccword @ ccvv))) => ((cwcel @ (cco @ XA2 @ XB2 @ ccconcat) @ (ccword @ XS)) <=> ((cwcel @ XA2 @ (ccword @ XS)) & (cwcel @ XB2 @ (ccword @ XS))))))))).
