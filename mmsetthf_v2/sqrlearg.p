...
thf(aiccgelbd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc))) => (Xph => (cwbr @ XA2 @ XC @ ccle)))))))))).
thf(a_0xr_ax,axiom,(cwcel @ ccc0 @ ccxr)).
thf(arexrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => (cwcel @ XA2 @ ccxr)))))).
thf(aid_ax,axiom,(! [Xph:$o] : (Xph => Xph))).
thf(aiccleubd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc))) => (Xph => (cwbr @ XC @ XB2 @ ccle)))))))))).
thf(csqrlearg_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => ((cwbr @ (cco @ XA2 @ cc2 @ ccexp) @ XA2 @ ccle) <=> (cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccicc)))))))).
