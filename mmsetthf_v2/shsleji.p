...
thf(ashunssji_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => (cwss @ (ccun @ XA2 @ XB2) @ (cco @ XA2 @ XB2 @ cchj))))))).
...
thf(ashjcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccsh) & (cwcel @ XB2 @ ccsh)) => (cwcel @ (cco @ XA2 @ XB2 @ cchj) @ ccch))))).
...
thf(cshsleji_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => (cwss @ (cco @ XA2 @ XB2 @ ccph) @ (cco @ XA2 @ XB2 @ cchj))))))).
