...
thf(awrdres_ax,axiom,(! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XS)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) => (cwcel @ (ccres @ XW @ (cco @ ccc0 @ XN @ ccfzo)) @ (ccword @ XS))))))).
...
thf(asignstfvc_ax,axiom,(! [Xc_pd:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XN:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : ((Xc_pd @ Xf1 @ Xi @ Xj @ Xn) = (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (cctp @ (ccneg @ cc1) @ ccc0 @ cc1))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cctp @ (ccneg @ cc1) @ ccc0 @ cc1))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ ((ccv @ Xb) = ccc0) @ (ccv @ Xa) @ (ccv @ Xb)))))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XW @ Xj @ Xa @ Xb) = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ (cctp @ (ccneg @ cc1) @ ccc0 @ cc1)) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (Xc_pd @ Xf1 @ Xi @ Xj @ Xn)))))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XT @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) = (ccmpt @ (^ [Xf1:$i] : (ccword @ ccr)) @ (^ [Xf1:$i] : (ccmpt @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfzo)) @ (^ [Xn:$i] : (cco @ (XW @ Xj @ Xa @ Xb) @ (ccmpt @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xn) @ ccfz)) @ (^ [Xi:$i] : (ccfv @ (ccfv @ (ccv @ Xi) @ (ccv @ Xf1)) @ ccsgn))) @ ccgsu)))))))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XV @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) = (ccmpt @ (^ [Xf1:$i] : (ccword @ ccr)) @ (^ [Xf1:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfzo) @ (^ [Xj:$i] : (ccif @ (cwne @ (ccfv @ (ccv @ Xj) @ (ccfv @ (ccv @ Xf1) @ (XT @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb))) @ (ccfv @ (cco @ (ccv @ Xj) @ cc1 @ ccmin) @ (ccfv @ (ccv @ Xf1) @ (XT @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb)))) @ cc1 @ ccc0)))))))))))) => (! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : ((cw3a @ (cwcel @ (XF @ Xj @ Xa @ Xb) @ (ccword @ ccr)) @ (cwcel @ (XG @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ (ccword @ ccr)) @ (cwcel @ (XN @ Xf1 @ Xj @ Xa @ Xb) @ (cco @ ccc0 @ (ccfv @ (XF @ Xj @ Xa @ Xb) @ cchash) @ ccfzo))) => ((ccfv @ (XN @ Xf1 @ Xj @ Xa @ Xb) @ (ccfv @ (cco @ (XF @ Xj @ Xa @ Xb) @ (XG @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) @ ccconcat) @ (XT @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb))) = (ccfv @ (XN @ Xf1 @ Xj @ Xa @ Xb) @ (ccfv @ (XF @ Xj @ Xa @ Xb) @ (XT @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb))))))))))))))))))))))).
thf(ccsubstr_tp,type,(ccsubstr : ($i > $o))).
thf(awrdsplex_ax,axiom,(! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XS)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) => (cwrex @ (^ [Xv:$i] : (XW = (cco @ (ccres @ XW @ (cco @ ccc0 @ XN @ ccfzo)) @ (ccv @ Xv) @ ccconcat))) @ (^ [Xv:$i] : (ccword @ XS)))))))).
thf(csignstres_conj,conjecture,(! [Xc_pd:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : ((Xc_pd @ Xf1 @ Xi @ Xj @ Xn) = (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (cctp @ (ccneg @ cc1) @ ccc0 @ cc1))) @ (^ [Xa:$i] : (^ [Xb:$i] : (cctp @ (ccneg @ cc1) @ ccc0 @ cc1))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccif @ ((ccv @ Xb) = ccc0) @ (ccv @ Xa) @ (ccv @ Xb)))))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XW @ Xj @ Xa @ Xb) = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ (cctp @ (ccneg @ cc1) @ ccc0 @ cc1)) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (Xc_pd @ Xf1 @ Xi @ Xj @ Xn)))))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XT @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) = (ccmpt @ (^ [Xf1:$i] : (ccword @ ccr)) @ (^ [Xf1:$i] : (ccmpt @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfzo)) @ (^ [Xn:$i] : (cco @ (XW @ Xj @ Xa @ Xb) @ (ccmpt @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xn) @ ccfz)) @ (^ [Xi:$i] : (ccfv @ (ccfv @ (ccv @ Xi) @ (ccv @ Xf1)) @ ccsgn))) @ ccgsu)))))))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XV @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb) = (ccmpt @ (^ [Xf1:$i] : (ccword @ ccr)) @ (^ [Xf1:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfzo) @ (^ [Xj:$i] : (ccif @ (cwne @ (ccfv @ (ccv @ Xj) @ (ccfv @ (ccv @ Xf1) @ (XT @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb))) @ (ccfv @ (cco @ (ccv @ Xj) @ cc1 @ ccmin) @ (ccfv @ (ccv @ Xf1) @ (XT @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb)))) @ cc1 @ ccc0)))))))))))) => (! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (((cwcel @ (XF @ Xj @ Xa @ Xb) @ (ccword @ ccr)) & (cwcel @ (XN @ Xj @ Xa @ Xb) @ (cco @ ccc0 @ (ccfv @ (XF @ Xj @ Xa @ Xb) @ cchash) @ ccfz))) => ((ccres @ (ccfv @ (XF @ Xj @ Xa @ Xb) @ (XT @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb)) @ (cco @ ccc0 @ (XN @ Xj @ Xa @ Xb) @ ccfzo)) = (ccfv @ (ccres @ (XF @ Xj @ Xa @ Xb) @ (cco @ ccc0 @ (XN @ Xj @ Xa @ Xb) @ ccfzo)) @ (XT @ Xf1 @ Xi @ Xj @ Xn @ Xa @ Xb))))))))))))))))))))).
