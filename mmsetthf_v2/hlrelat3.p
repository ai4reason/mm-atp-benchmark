...
thf(chlrelat3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [Xc_lt:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_lt = (ccfv @ XK @ ccplt)) => ((! [Xp:$i] : ((Xc_or @ Xp) = (ccfv @ XK @ ccjn))) => ((! [Xp:$i] : ((XC @ Xp) = (ccfv @ XK @ cccvr))) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) & (cwbr @ XX @ XY @ Xc_lt)) => (cwrex @ (^ [Xp:$i] : ((cwbr @ XX @ (cco @ XX @ (ccv @ Xp) @ (Xc_or @ Xp)) @ (XC @ Xp)) & (cwbr @ (cco @ XX @ (ccv @ Xp) @ (Xc_or @ Xp)) @ XY @ Xc_le))) @ (^ [Xp:$i] : XA2))))))))))))))))))).
