...
thf(aasincl_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwcel @ (ccfv @ XA2 @ ccasin) @ ccc)))).
...
thf(advreasin_ax,axiom,((cco @ ccr @ (ccres @ ccasin @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo)) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : (cco @ (ccneg @ cc1) @ cc1 @ ccioo)) @ (^ [Xx3:$i] : (cco @ cc1 @ (ccfv @ (cco @ cc1 @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccdiv))))).
...
thf(aasinf_ax,axiom,(cwf @ ccc @ ccc @ ccasin)).
...
thf(asqr00d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => ((ccfv @ XA2 @ ccsqrt) = ccc0)) => (Xph => (XA2 = ccc0))))))).
