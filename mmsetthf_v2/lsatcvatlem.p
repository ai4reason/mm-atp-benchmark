...
thf(alcvnbtwn3_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XS = (ccfv @ XW @ cclss)) => ((XC = (ccfv @ XW @ cclcv)) => ((Xph => (cwcel @ XW @ XX)) => ((Xph => (cwcel @ XR @ XS)) => ((Xph => (cwcel @ XT @ XS)) => ((Xph => (cwcel @ XU @ XS)) => ((Xph => (cwbr @ XR @ XT @ XC)) => ((Xph => (cwss @ XR @ XU)) => ((Xph => (cwpss @ XU @ XT)) => (Xph => (XU = XR)))))))))))))))))))).
...
thf(alsatexch1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : ((Xc_po = (ccfv @ XW @ cclsm)) => ((XA2 = (ccfv @ XW @ cclsa)) => ((Xph => (cwcel @ XW @ cclvec)) => ((Xph => (cwcel @ XQ @ XA2)) => ((Xph => (cwcel @ XR @ XA2)) => ((Xph => (cwcel @ XS @ XA2)) => ((Xph => (cwss @ XQ @ (cco @ XS @ XR @ Xc_po))) => ((Xph => (cwne @ XQ @ XS)) => (Xph => (cwss @ XR @ (cco @ XS @ XQ @ Xc_po))))))))))))))))))).
...
thf(clsatcvatlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XS = (ccfv @ XW @ cclss)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((XA2 = (ccfv @ XW @ cclsa)) => ((Xph => (cwcel @ XW @ cclvec)) => ((Xph => (cwcel @ XU @ XS)) => ((Xph => (cwcel @ XQ @ XA2)) => ((Xph => (cwcel @ XR @ XA2)) => ((Xph => (cwne @ XU @ (ccsn @ Xc_0))) => ((Xph => (cwpss @ XU @ (cco @ XQ @ XR @ Xc_po))) => ((Xph => (~ (cwss @ XQ @ XU))) => (Xph => (cwcel @ XU @ XA2))))))))))))))))))))))).
