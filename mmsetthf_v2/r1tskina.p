...
thf(atsken_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XT @ cctsk) & (cwss @ XA2 @ XT)) => ((cwbr @ XA2 @ XT @ ccen) | (cwcel @ XA2 @ XT)))))).
...
thf(atsksdom_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XT @ cctsk) & (cwcel @ XA2 @ XT)) => (cwbr @ XA2 @ XT @ ccsdm))))).
...
thf(atskcard_ax,axiom,(! [XT:($i > $o)] : (((cwcel @ XT @ cctsk) & (cwne @ XT @ cc0)) => (cwcel @ (ccfv @ XT @ cccrd) @ ccina)))).
...
thf(cr1tskina_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cwcel @ (ccfv @ XA2 @ ccr1) @ cctsk) <=> ((XA2 = cc0) | (cwcel @ XA2 @ ccina)))))).
