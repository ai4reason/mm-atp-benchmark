...
thf(alnop0i_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => ((ccfv @ cc0v @ XT) = cc0v)))).
...
thf(cnmcoplbi_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => ((cwcel @ XT @ cccop) => ((cwcel @ XA2 @ cchil) => (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ ccno) @ (cco @ (ccfv @ XT @ ccnop) @ (ccfv @ XA2 @ ccno) @ ccmul) @ ccle))))))).
