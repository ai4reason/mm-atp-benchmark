...
thf(adomdifsn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccsdm) => (cwbr @ XA2 @ (ccdif @ XB2 @ (ccsn @ XC)) @ ccdom)))))).
...
thf(adomunfican_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XA2 @ ccfn) & (cwbr @ XB2 @ XA2 @ ccen)) & (((ccin @ XA2 @ XX) = cc0) & ((ccin @ XB2 @ XY) = cc0))) => ((cwbr @ (ccun @ XA2 @ XX) @ (ccun @ XB2 @ XY) @ ccdom) <=> (cwbr @ XX @ XY @ ccdom)))))))).
...
thf(cmarypha1lem_conj,conjecture,(! [XA2:($i > $o)] : (! [Xb:$i] : ((cwcel @ XA2 @ ccfn) => ((cwcel @ (ccv @ Xb) @ ccfn) => (cwral @ (^ [Xc:$i] : ((cwral @ (^ [Xd:$i] : (cwbr @ (ccv @ Xd) @ (ccima @ (ccv @ Xc) @ (ccv @ Xd)) @ ccdom)) @ (^ [Xd:$i] : (ccpw @ XA2))) => (cwrex @ (^ [Xe:$i] : (cwf1 @ XA2 @ ccvv @ (ccv @ Xe))) @ (^ [Xe:$i] : (ccpw @ (ccv @ Xc)))))) @ (^ [Xc:$i] : (ccpw @ (ccxp @ XA2 @ (ccv @ Xb)))))))))).
