...
thf(azfregs2_ax,axiom,(! [XA2:($i > $o)] : ((cwne @ XA2 @ cc0) => (~ (cwral @ (^ [Xx3:$i] : (? [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ XA2) & (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))) @ (^ [Xx3:$i] : XA2)))))).
...
thf(aen3lplem2VD_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xx3:$i] : ((cw3a @ (cwcel @ XA2 @ XB2) @ (cwcel @ XB2 @ XC) @ (cwcel @ XC @ XA2)) => ((cwcel @ (ccv @ Xx3) @ (cctp @ XA2 @ XB2 @ XC)) => (? [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ (cctp @ XA2 @ XB2 @ XC)) & (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))))))).
...
thf(cen3lpVD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (~ (cw3a @ (cwcel @ XA2 @ XB2) @ (cwcel @ XB2 @ XC) @ (cwcel @ XC @ XA2))))))).
