...
thf(aiccsconn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (cwcel @ (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ (cco @ XA2 @ XB2 @ ccicc) @ ccrest) @ ccsconn))))).
thf(ciisconn_conj,conjecture,(cwcel @ ccii @ ccsconn)).
