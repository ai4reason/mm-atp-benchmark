...
thf(asbc4rex_ax,axiom,(! [Xph:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XE:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xe:$i] : (! [Xa:$i] : (! [Xc:$i] : (! [Xd:$i] : ((cwsbc @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xe:$i] : (Xph @ Xe @ Xa @ Xb @ Xc @ Xd)) @ (^ [Xe:$i] : (XE @ Xe @ Xb @ Xc @ Xd)))) @ (^ [Xd:$i] : (XD @ Xe @ Xb @ Xc @ Xd)))) @ (^ [Xc:$i] : (XC @ Xe @ Xb @ Xc @ Xd)))) @ (^ [Xb:$i] : (XB2 @ Xe @ Xb @ Xc @ Xd)))) @ (XA2 @ Xa)) <=> (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xe:$i] : (cwsbc @ (^ [Xa:$i] : (Xph @ Xe @ Xa @ Xb @ Xc @ Xd)) @ (XA2 @ Xa))) @ (^ [Xe:$i] : (XE @ Xe @ Xb @ Xc @ Xd)))) @ (^ [Xd:$i] : (XD @ Xe @ Xb @ Xc @ Xd)))) @ (^ [Xc:$i] : (XC @ Xe @ Xb @ Xc @ Xd)))) @ (^ [Xb:$i] : (XB2 @ Xe @ Xb @ Xc @ Xd))))))))))))))).
...
thf(asbcrot5_ax,axiom,(! [Xph:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XE:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xe:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((cwsbc @ (^ [Xa:$i] : (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xc:$i] : (cwsbc @ (^ [Xd:$i] : (cwsbc @ (^ [Xe:$i] : (Xph @ Xe @ Xa @ Xb @ Xc @ Xd)) @ (XE @ Xe @ Xb @ Xc @ Xd))) @ (XD @ Xe @ Xb @ Xc @ Xd))) @ (XC @ Xe @ Xb @ Xc @ Xd))) @ (XB2 @ Xe @ Xb @ Xc @ Xd))) @ (XA2 @ Xa)) <=> (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xc:$i] : (cwsbc @ (^ [Xd:$i] : (cwsbc @ (^ [Xe:$i] : (cwsbc @ (^ [Xa:$i] : (Xph @ Xe @ Xa @ Xb @ Xc @ Xd)) @ (XA2 @ Xa))) @ (XE @ Xe @ Xb @ Xc @ Xd))) @ (XD @ Xe @ Xb @ Xc @ Xd))) @ (XC @ Xe @ Xb @ Xc @ Xd))) @ (XB2 @ Xe @ Xb @ Xc @ Xd))))))))))))))).
...
thf(c_6rexfrabdioph_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (cco @ XN @ cc1 @ ccaddc)) => ((XL = (cco @ XM @ cc1 @ ccaddc)) => ((XK = (cco @ XL @ cc1 @ ccaddc)) => ((XJ = (cco @ XK @ cc1 @ ccaddc)) => ((XI = (cco @ XJ @ cc1 @ ccaddc)) => ((XH = (cco @ XI @ cc1 @ ccaddc)) => (((cwcel @ XN @ ccn0) & (cwcel @ (ccrab @ (^ [Xt:$i] : (cwsbc @ (^ [Xu:$i] : (cwsbc @ (^ [Xv:$i] : (cwsbc @ (^ [Xw:$i] : (cwsbc @ (^ [Xx3:$i] : (cwsbc @ (^ [Xy1:$i] : (cwsbc @ (^ [Xz:$i] : (cwsbc @ (^ [Xp:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xu @ Xp)) @ (ccfv @ XH @ (ccv @ Xt)))) @ (ccfv @ XI @ (ccv @ Xt)))) @ (ccfv @ XJ @ (ccv @ Xt)))) @ (ccfv @ XK @ (ccv @ Xt)))) @ (ccfv @ XL @ (ccv @ Xt)))) @ (ccfv @ XM @ (ccv @ Xt)))) @ (ccres @ (ccv @ Xt) @ (cco @ cc1 @ XN @ ccfz)))) @ (^ [Xt:$i] : (cco @ ccn0 @ (cco @ cc1 @ XH @ ccfz) @ ccmap))) @ (ccfv @ XH @ ccdioph))) => (cwcel @ (ccrab @ (^ [Xu:$i] : (cwrex @ (^ [Xv:$i] : (cwrex @ (^ [Xw:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xp:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw @ Xv @ Xu @ Xp)) @ (^ [Xp:$i] : ccn0))) @ (^ [Xz:$i] : ccn0))) @ (^ [Xy1:$i] : ccn0))) @ (^ [Xx3:$i] : ccn0))) @ (^ [Xw:$i] : ccn0))) @ (^ [Xv:$i] : ccn0))) @ (^ [Xu:$i] : (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap))) @ (ccfv @ XN @ ccdioph)))))))))))))))))).
