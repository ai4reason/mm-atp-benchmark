...
thf(aeldmcoss_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XA2 @ (ccdm @ (cccoss @ XR))) <=> (? [Xu:$i] : (cwbr @ (ccv @ Xu) @ XA2 @ XR)))))))).
...
thf(celdm1cossres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((cwcel @ XB2 @ (ccdm @ (cccoss @ (ccres @ XR @ XA2)))) <=> (cwrex @ (^ [Xu:$i] : (cwbr @ (ccv @ Xu) @ XB2 @ XR)) @ (^ [Xu:$i] : XA2))))))))).
