...
thf(clediv2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ ((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ cclt)) @ ((cwcel @ XB2 @ ccr) & (cwbr @ ccc0 @ XB2 @ cclt)) @ ((cwcel @ XC @ ccr) & (cwbr @ ccc0 @ XC @ cclt))) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwbr @ (cco @ XC @ XB2 @ ccdiv) @ (cco @ XC @ XA2 @ ccdiv) @ ccle))))))).
