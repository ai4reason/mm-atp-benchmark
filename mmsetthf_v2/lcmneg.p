...
thf(advdslcm_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwbr @ XM @ (cco @ XM @ XN @ cclcm) @ ccdvds) & (cwbr @ XN @ (cco @ XM @ XN @ cclcm) @ ccdvds)))))).
...
thf(alcmledvds_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cw3a @ (cwcel @ XK @ ccn) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) & (~ ((XM = ccc0) | (XN = ccc0)))) => (((cwbr @ XM @ XK @ ccdvds) & (cwbr @ XN @ XK @ ccdvds)) => (cwbr @ (cco @ XM @ XN @ cclcm) @ XK @ ccle))))))).
...
thf(clcmneg_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ XM @ (ccneg @ XN) @ cclcm) = (cco @ XM @ XN @ cclcm)))))).
