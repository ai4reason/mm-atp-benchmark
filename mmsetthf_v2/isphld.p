...
thf(aislmhm2_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [Xc_xp:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((XB2 = (ccfv @ XS @ ccbs)) => ((XC = (ccfv @ XT @ ccbs)) => ((XK = (ccfv @ XS @ ccsca)) => ((XL = (ccfv @ XT @ ccsca)) => ((XE = (ccfv @ XK @ ccbs)) => ((Xc_pl = (ccfv @ XS @ ccplusg)) => ((Xc_pd = (ccfv @ XT @ ccplusg)) => ((! [Xy1:$i] : ((Xc_x @ Xy1) = (ccfv @ XS @ ccvsca))) => ((! [Xy1:$i] : ((Xc_xp @ Xy1) = (ccfv @ XT @ ccvsca))) => (((cwcel @ XS @ cclmod) & (cwcel @ XT @ cclmod)) => ((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) <=> (cw3a @ (cwf @ XB2 @ XC @ XF) @ (XL = XK) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((ccfv @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_x @ Xy1)) @ (ccv @ Xz) @ Xc_pl) @ XF) = (cco @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XF) @ (Xc_xp @ Xy1)) @ (ccfv @ (ccv @ Xz) @ XF) @ Xc_pd))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XE))))))))))))))))))))))))))).
...
thf(cisphld_conj,conjecture,(! [Xph:$o] : (! [Xc_pl:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_pd:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_x:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_xp:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XI:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_as:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XK:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XO:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XW:($i > $o)] : (! [Xc_0:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xq:$i] : (Xph => ((XV @ Xx3 @ Xy1 @ Xz @ Xq) = (ccfv @ XW @ ccbs))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xq:$i] : (Xph => ((Xc_pl @ Xx3 @ Xy1 @ Xz @ Xq) = (ccfv @ XW @ ccplusg))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xq:$i] : (Xph => ((Xc_x @ Xx3 @ Xy1 @ Xz @ Xq) = (ccfv @ XW @ ccvsca))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xq:$i] : (Xph => ((XI @ Xx3 @ Xy1 @ Xz @ Xq) = (ccfv @ XW @ ccip))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xq:$i] : (Xph => ((Xc_0 @ Xx3 @ Xy1 @ Xz @ Xq) = (ccfv @ XW @ cc0g))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xq:$i] : (Xph => ((XF @ Xx3 @ Xy1 @ Xz @ Xq) = (ccfv @ XW @ ccsca))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xq:$i] : (Xph => ((XK @ Xx3 @ Xy1 @ Xz @ Xq) = (ccfv @ (XF @ Xx3 @ Xy1 @ Xz @ Xq) @ ccbs))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xq:$i] : (Xph => ((Xc_pd @ Xx3 @ Xy1 @ Xz @ Xq) = (ccfv @ (XF @ Xx3 @ Xy1 @ Xz @ Xq) @ ccplusg))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xq:$i] : (Xph => ((Xc_xp @ Xx3 @ Xy1 @ Xz @ Xq) = (ccfv @ (XF @ Xx3 @ Xy1 @ Xz @ Xq) @ ccmulr))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xq:$i] : (Xph => ((Xc_as @ Xx3 @ Xy1 @ Xz @ Xq) = (ccfv @ (XF @ Xx3 @ Xy1 @ Xz @ Xq) @ ccstv))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xq:$i] : (Xph => ((XO @ Xx3 @ Xy1 @ Xz @ Xq) = (ccfv @ (XF @ Xx3 @ Xy1 @ Xz @ Xq) @ cc0g))))))) => ((Xph => (cwcel @ XW @ cclvec)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xq:$i] : (Xph => (cwcel @ (XF @ Xx3 @ Xy1 @ Xz @ Xq) @ ccsr)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xq:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ (XV @ Xx3 @ Xy1 @ Xz @ Xq)) @ (cwcel @ (ccv @ Xy1) @ (XV @ Xx3 @ Xy1 @ Xz @ Xq))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XI @ Xx3 @ Xy1 @ Xz @ Xq)) @ (XK @ Xx3 @ Xy1 @ Xz @ Xq))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xq:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xq) @ (XK @ Xx3 @ Xy1 @ Xz @ Xq)) @ (cw3a @ (cwcel @ (ccv @ Xx3) @ (XV @ Xx3 @ Xy1 @ Xz @ Xq)) @ (cwcel @ (ccv @ Xy1) @ (XV @ Xx3 @ Xy1 @ Xz @ Xq)) @ (cwcel @ (ccv @ Xz) @ (XV @ Xx3 @ Xy1 @ Xz @ Xq)))) => ((cco @ (cco @ (cco @ (ccv @ Xq) @ (ccv @ Xx3) @ (Xc_x @ Xx3 @ Xy1 @ Xz @ Xq)) @ (ccv @ Xy1) @ (Xc_pl @ Xx3 @ Xy1 @ Xz @ Xq)) @ (ccv @ Xz) @ (XI @ Xx3 @ Xy1 @ Xz @ Xq)) = (cco @ (cco @ (ccv @ Xq) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ (XI @ Xx3 @ Xy1 @ Xz @ Xq)) @ (Xc_xp @ Xx3 @ Xy1 @ Xz @ Xq)) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (XI @ Xx3 @ Xy1 @ Xz @ Xq)) @ (Xc_pd @ Xx3 @ Xy1 @ Xz @ Xq)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xq:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ (XV @ Xx3 @ Xy1 @ Xz @ Xq)) @ ((cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ (XI @ Xx3 @ Xy1 @ Xz @ Xq)) = (XO @ Xx3 @ Xy1 @ Xz @ Xq))) => ((ccv @ Xx3) = (Xc_0 @ Xx3 @ Xy1 @ Xz @ Xq))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xq:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ (XV @ Xx3 @ Xy1 @ Xz @ Xq)) @ (cwcel @ (ccv @ Xy1) @ (XV @ Xx3 @ Xy1 @ Xz @ Xq))) => ((ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XI @ Xx3 @ Xy1 @ Xz @ Xq)) @ (Xc_as @ Xx3 @ Xy1 @ Xz @ Xq)) = (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (XI @ Xx3 @ Xy1 @ Xz @ Xq)))))))) => (Xph => (cwcel @ XW @ ccphl))))))))))))))))))))))))))))))))).
