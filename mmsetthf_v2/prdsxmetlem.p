...
thf(aisxmet2d_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccvv)) => ((Xph => (cwf @ (ccxp @ XX @ XX) @ ccxr @ XD)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xy1) @ XX))) => (cwbr @ ccc0 @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ ccle)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xy1) @ XX))) => ((cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ ccc0 @ ccle) <=> ((ccv @ Xx3) = (ccv @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cw3a @ Xph @ (cw3a @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX) @ (cwcel @ (ccv @ Xz) @ XX)) @ ((cwcel @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ XD) @ ccr) & (cwcel @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ XD) @ ccr))) => (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) @ (cco @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ XD) @ (cco @ (ccv @ Xz) @ (ccv @ Xy1) @ XD) @ ccaddc) @ ccle))))) => (Xph => (cwcel @ XD @ (ccfv @ XX @ ccxmt)))))))))))).
...
thf(axmeteq0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) => (((cco @ XA2 @ XB2 @ XD) = ccc0) <=> (XA2 = XB2)))))))).
...
thf(aelabrex_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccvv)) => (! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) => (cwcel @ (XB2 @ Xx3) @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xy1) = (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2))))))))))).
