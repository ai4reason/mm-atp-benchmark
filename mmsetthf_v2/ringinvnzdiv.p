...
thf(cringinvnzdiv_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xa:$i] : ((XB2 @ Xa) = (ccfv @ (XR @ Xa) @ ccbs))) => ((! [Xa:$i] : (Xc_x = (ccfv @ (XR @ Xa) @ ccmulr))) => ((! [Xa:$i] : (Xc_1 = (ccfv @ (XR @ Xa) @ ccur))) => ((! [Xa:$i] : (Xc_0 = (ccfv @ (XR @ Xa) @ cc0g))) => ((! [Xa:$i] : (Xph => (cwcel @ (XR @ Xa) @ ccrg))) => ((! [Xa:$i] : (Xph => (cwcel @ XX @ (XB2 @ Xa)))) => ((Xph => (cwrex @ (^ [Xa:$i] : ((cco @ (ccv @ Xa) @ XX @ Xc_x) = Xc_1)) @ (^ [Xa:$i] : (XB2 @ Xa)))) => ((! [Xa:$i] : (Xph => (cwcel @ XY @ (XB2 @ Xa)))) => (Xph => (((cco @ XX @ XY @ Xc_x) = Xc_0) <=> (XY = Xc_0)))))))))))))))))))).
