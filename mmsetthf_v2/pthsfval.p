...
thf(adf_pths_ax,axiom,(ccpths = (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : (cw3a @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ (ccv @ Xg1) @ cctrls)) @ (cwfun @ (cccnv @ (ccres @ (ccv @ Xp) @ (cco @ cc1 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfzo)))) @ ((ccin @ (ccima @ (ccv @ Xp) @ (ccpr @ ccc0 @ (ccfv @ (ccv @ Xf1) @ cchash))) @ (ccima @ (ccv @ Xp) @ (cco @ cc1 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfzo))) = cc0))))))))).
...
thf(cpthsfval_conj,conjecture,(! [XG:($i > $o)] : ((ccfv @ XG @ ccpths) = (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : (cw3a @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ cctrls)) @ (cwfun @ (cccnv @ (ccres @ (ccv @ Xp) @ (cco @ cc1 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfzo)))) @ ((ccin @ (ccima @ (ccv @ Xp) @ (ccpr @ ccc0 @ (ccfv @ (ccv @ Xf1) @ cchash))) @ (ccima @ (ccv @ Xp) @ (cco @ cc1 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfzo))) = cc0)))))))).
