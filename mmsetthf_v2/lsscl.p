...
thf(clsscl_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XB2 = (ccfv @ XF @ ccbs)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XS = (ccfv @ XW @ cclss)) => (((cwcel @ XU @ XS) & (cw3a @ (cwcel @ XZ @ XB2) @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XU))) => (cwcel @ (cco @ (cco @ XZ @ XX @ Xc_x) @ XY @ Xc_pl) @ XU)))))))))))))))))).
