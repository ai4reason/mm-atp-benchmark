...
thf(aesum_ax,axiom,(cceu = (ccsu @ ccn0 @ (^ [Xk:$i] : (cco @ cc1 @ (ccfv @ (ccv @ Xk) @ ccfa) @ ccdiv))))).
...
thf(afacdiv_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn) @ (cwbr @ XN @ XM @ ccle)) => (cwcel @ (cco @ (ccfv @ XM @ ccfa) @ XN @ ccdiv) @ ccn))))).
