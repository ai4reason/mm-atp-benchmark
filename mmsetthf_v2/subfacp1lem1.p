...
thf(csubfacp1lem1_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : ((XD @ Xx3 @ Xy1 @ Xf1) = (ccmpt @ (^ [Xx3:$i] : ccfn) @ (^ [Xx3:$i] : (ccfv @ (ccab @ (^ [Xf1:$i] : ((cwf1o @ (ccv @ Xx3) @ (ccv @ Xx3) @ (ccv @ Xf1)) & (cwral @ (^ [Xy1:$i] : (cwne @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccv @ Xx3)))))) @ cchash))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : ((XS @ Xf1) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccfv @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ (XD @ Xx3 @ Xy1 @ Xf1)))))))) => ((XA2 = (ccab @ (^ [Xf1:$i] : ((cwf1o @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (ccv @ Xf1)) & (cwral @ (^ [Xy1:$i] : (cwne @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz))))))) => ((! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xf1 @ Xn) => (cwcel @ XN @ ccn)))) => ((! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xf1 @ Xn) => (cwcel @ (XM @ Xn) @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz))))) => ((! [Xn:$i] : (cwcel @ (XM @ Xn) @ ccvv)) => ((! [Xn:$i] : (XK = (ccdif @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ (ccsn @ (XM @ Xn))))) => (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xf1 @ Xn) => (cw3a @ ((ccin @ XK @ (ccpr @ cc1 @ (XM @ Xn))) = cc0) @ ((ccun @ XK @ (ccpr @ cc1 @ (XM @ Xn))) = (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz)) @ ((ccfv @ XK @ cchash) = (cco @ XN @ cc1 @ ccmin))))))))))))))))))))).
