...
thf(asizusglecusglem1_ax,axiom,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((XV = (ccfv @ XH @ ccvtx)) => ((XF = (ccfv @ XH @ ccedg)) => (((cwcel @ XG @ ccusgr) & (cwcel @ XH @ cccusgr)) => (cwf1 @ XE @ XF @ (ccres @ ccid @ XE))))))))))))).
...
thf(asizusglecusglem2_ax,axiom,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((XV = (ccfv @ XH @ ccvtx)) => ((XF = (ccfv @ XH @ ccedg)) => ((cw3a @ (cwcel @ XG @ ccusgr) @ (cwcel @ XH @ cccusgr) @ (cwcel @ XF @ ccfn)) => (cwcel @ XE @ ccfn)))))))))))).
...
thf(anfile_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (~ (cwcel @ XB2 @ ccfn))) => (cwbr @ (ccfv @ XA2 @ cchash) @ (ccfv @ XB2 @ cchash) @ ccle))))))).
thf(csizusglecusg_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((XV = (ccfv @ XH @ ccvtx)) => ((XF = (ccfv @ XH @ ccedg)) => (((cwcel @ XG @ ccusgr) & (cwcel @ XH @ cccusgr)) => (cwbr @ (ccfv @ XE @ cchash) @ (ccfv @ XF @ cchash) @ ccle)))))))))))).
