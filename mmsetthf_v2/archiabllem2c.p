...
thf(aogrpinvlt_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_lt = (ccfv @ XG @ ccplt)) => ((XI = (ccfv @ XG @ ccminusg)) => ((cw3a @ ((cwcel @ XG @ ccogrp) & (cwcel @ (ccfv @ XG @ ccoppg) @ ccogrp)) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => ((cwbr @ XX @ XY @ Xc_lt) <=> (cwbr @ (ccfv @ XY @ XI) @ (ccfv @ XX @ XI) @ Xc_lt))))))))))))).
