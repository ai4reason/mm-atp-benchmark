...
thf(cfin23lem7_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cw3a @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwss @ XB2 @ (ccpw @ XA2)) @ (cwne @ XB2 @ cc0)) => (cwne @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccdif @ XA2 @ (ccv @ Xx3)) @ XB2)) @ (^ [Xx3:$i] : (ccpw @ XA2))) @ cc0))))))).
