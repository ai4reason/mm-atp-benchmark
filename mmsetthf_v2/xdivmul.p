...
thf(cxdivmul_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ ((cwcel @ XC @ ccr) & (cwne @ XC @ ccc0))) => (((cco @ XA2 @ XC @ ccxdiv) = XB2) <=> ((cco @ XC @ XB2 @ ccxmu) = XA2))))))).
