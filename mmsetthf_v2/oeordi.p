...
thf(atfindsg2_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccsuc @ XB2)) => ((Xph @ Xx3) <=> (Xps @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccsuc @ (ccv @ Xy1))) => ((Xph @ Xx3) <=> (Xth @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XA2 @ Xy1)) => ((Xph @ Xx3) <=> (Xta @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XB2 @ ccon0) => (Xps @ Xx3 @ Xy1)))) => ((! [Xy1:$i] : (((cwcel @ (ccv @ Xy1) @ ccon0) & (cwcel @ XB2 @ (ccv @ Xy1))) => ((Xch @ Xy1) => (Xth @ Xy1)))) => ((! [Xx3:$i] : (((cwlim @ (ccv @ Xx3)) & (cwcel @ XB2 @ (ccv @ Xx3))) => ((cwral @ (^ [Xy1:$i] : ((cwcel @ XB2 @ (ccv @ Xy1)) => (Xch @ Xy1))) @ (^ [Xy1:$i] : (ccv @ Xx3))) => (Xph @ Xx3)))) => (! [Xy1:$i] : (((cwcel @ (XA2 @ Xy1) @ ccon0) & (cwcel @ XB2 @ (XA2 @ Xy1))) => (Xta @ Xy1)))))))))))))))))).
...
thf(aeliuni_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((XB2 @ Xx3) = XC))) => (((cwcel @ XA2 @ XD) & (cwcel @ XE @ XC)) => (cwcel @ XE @ (cciun @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))))).
...
thf(coeordi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XB2 @ ccon0) & (cwcel @ XC @ (ccdif @ ccon0 @ cc2o))) => ((cwcel @ XA2 @ XB2) => (cwcel @ (cco @ XC @ XA2 @ ccoe) @ (cco @ XC @ XB2 @ ccoe)))))))).
