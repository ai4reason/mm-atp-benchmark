...
thf(adf_2ndc_ax,axiom,(cc2ndc = (ccab @ (^ [Xj:$i] : (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) & ((ccfv @ (ccv @ Xx3) @ cctg) = (ccv @ Xj)))) @ (^ [Xx3:$i] : cctb)))))).
...
thf(cis2ndc_conj,conjecture,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cc2ndc) <=> (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) & ((ccfv @ (ccv @ Xx3) @ cctg) = XJ))) @ (^ [Xx3:$i] : cctb))))).
