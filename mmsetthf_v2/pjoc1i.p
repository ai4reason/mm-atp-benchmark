...
thf(apjopi_ax,axiom,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => ((ccfv @ XA2 @ (ccfv @ (ccfv @ XH @ ccort) @ ccpjh)) = (cco @ XA2 @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccmv))))))).
...
thf(cpjoc1i_conj,conjecture,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => ((cwcel @ XA2 @ XH) <=> ((ccfv @ XA2 @ (ccfv @ (ccfv @ XH @ ccort) @ ccpjh)) = cc0v))))))).
