...
thf(adf_sh_ax,axiom,(ccsh = (ccrab @ (^ [Xh:$i] : (cw3a @ (cwcel @ cc0v @ (ccv @ Xh)) @ (cwss @ (ccima @ ccva @ (ccxp @ (ccv @ Xh) @ (ccv @ Xh))) @ (ccv @ Xh)) @ (cwss @ (ccima @ ccsm @ (ccxp @ ccc @ (ccv @ Xh))) @ (ccv @ Xh)))) @ (^ [Xh:$i] : (ccpw @ cchil))))).
thf(aanass_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) & Xch) <=> (Xph & (Xps & Xch))))))).
thf(cissh_conj,conjecture,(! [XH:($i > $o)] : ((cwcel @ XH @ ccsh) <=> (((cwss @ XH @ cchil) & (cwcel @ cc0v @ XH)) & ((cwss @ (ccima @ ccva @ (ccxp @ XH @ XH)) @ XH) & (cwss @ (ccima @ ccsm @ (ccxp @ ccc @ XH)) @ XH)))))).
