...
thf(ar1ord_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccon0) => ((cwcel @ XA2 @ XB2) => (cwcel @ (ccfv @ XA2 @ ccr1) @ (ccfv @ XB2 @ ccr1))))))).
thf(ar1elwf_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ XB2 @ ccr1)) => (cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))))))).
thf(ccrnk_tp,type,(ccrnk : ($i > $o))).
thf(awfelirr_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) => (~ (cwcel @ XA2 @ XA2))))).
...
thf(ar1limwun_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwlim @ XA2)) => (cwcel @ (ccfv @ XA2 @ ccr1) @ ccwun))))).
thf(cr1wunlim_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ (ccfv @ XA2 @ ccr1) @ ccwun) <=> (cwlim @ XA2)))))).
