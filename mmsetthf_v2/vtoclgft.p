...
thf(cvtoclgft_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cw3a @ ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) & (cwnf @ (^ [Xx3:$i] : (Xps @ Xx3)))) @ ((! [Xx3:$i] : (((ccv @ Xx3) = (XA2 @ Xx3)) => ((Xph @ Xx3) <=> (Xps @ Xx3)))) & (! [Xx3:$i] : (Xph @ Xx3))) @ (cwcel @ (XA2 @ Xx3) @ (XV @ Xx3))) => (Xps @ Xx3)))))))).
