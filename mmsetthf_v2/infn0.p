...
thf(ainfsdomnn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwbr @ ccom @ XA2 @ ccdom) & (cwcel @ XB2 @ ccom)) => (cwbr @ XB2 @ XA2 @ ccsdm))))).
...
thf(cinfn0_conj,conjecture,(! [XA2:($i > $o)] : ((cwbr @ ccom @ XA2 @ ccdom) => (cwne @ XA2 @ cc0)))).
