...
thf(cpthdlem1_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (cwcel @ XP @ (ccword @ ccvv))) => ((XR = (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin)) => ((Xph => (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : ((cwne @ (ccv @ Xi) @ (ccv @ Xj)) => (cwne @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (ccv @ Xj) @ XP)))) @ (^ [Xj:$i] : (cco @ cc1 @ XR @ ccfzo)))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XP @ cchash) @ ccfzo)))) => (Xph => (cwfun @ (cccnv @ (ccres @ XP @ (cco @ cc1 @ XR @ ccfzo)))))))))))).
