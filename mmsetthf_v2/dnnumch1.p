...
thf(arecsval_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((ccfv @ XA2 @ (ccrecs @ XF)) = (ccfv @ (ccres @ (ccrecs @ XF) @ XA2) @ XF)))))).
...
thf(atz7_49c_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((cwfn @ XF @ ccon0) => (! [Xx3:$i] : (((cwcel @ XA2 @ (XB2 @ Xx3)) & (cwral @ (^ [Xx3:$i] : ((cwne @ (ccdif @ XA2 @ (ccima @ XF @ (ccv @ Xx3))) @ cc0) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccdif @ XA2 @ (ccima @ XF @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : ccon0))) => (cwrex @ (^ [Xx3:$i] : (cwf1o @ (ccv @ Xx3) @ XA2 @ (ccres @ XF @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0))))))))).
thf(cdnnumch1_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xz:$i] : ((XF @ Xz) = (ccrecs @ (ccmpt @ (^ [Xz:$i] : ccvv) @ (^ [Xz:$i] : (ccfv @ (ccdif @ XA2 @ (ccrn @ (ccv @ Xz))) @ XG)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xy1 @ Xz) => (cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xz)))))) => ((! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xy1 @ Xz) => (cwral @ (^ [Xy1:$i] : ((cwne @ (ccv @ Xy1) @ cc0) => (cwcel @ (ccfv @ (ccv @ Xy1) @ XG) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccpw @ XA2)))))) => (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xy1 @ Xz) => (cwrex @ (^ [Xx3:$i] : (cwf1o @ (ccv @ Xx3) @ XA2 @ (ccres @ (XF @ Xz) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0)))))))))))))).
