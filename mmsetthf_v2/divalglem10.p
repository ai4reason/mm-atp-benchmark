...
thf(adivalglem9_ax,axiom,(! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cwcel @ XD @ ccz) => ((cwne @ XD @ ccc0) => ((! [Xr:$i] : ((XS @ Xr) = (ccrab @ (^ [Xr:$i] : (cwbr @ XD @ (cco @ XN @ (ccv @ Xr) @ ccmin) @ ccdvds)) @ (^ [Xr:$i] : ccn0)))) => ((! [Xr:$i] : ((XR @ Xr) = (ccinf @ (XS @ Xr) @ ccr @ cclt))) => (! [Xr:$i] : (cwreu @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ XD @ ccabs) @ cclt)) @ (^ [Xx3:$i] : (XS @ Xr)))))))))))))).
...
thf(adivalglem4_ax,axiom,(! [XD:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cwcel @ XD @ ccz) => ((cwne @ XD @ ccc0) => ((! [Xr:$i] : (! [Xq:$i] : ((XS @ Xr @ Xq) = (ccrab @ (^ [Xr:$i] : (cwbr @ XD @ (cco @ XN @ (ccv @ Xr) @ ccmin) @ ccdvds)) @ (^ [Xr:$i] : ccn0))))) => (! [Xr:$i] : (! [Xq:$i] : ((XS @ Xr @ Xq) = (ccrab @ (^ [Xr:$i] : (cwrex @ (^ [Xq:$i] : (XN = (cco @ (cco @ (ccv @ Xq) @ XD @ ccmul) @ (ccv @ Xr) @ ccaddc))) @ (^ [Xq:$i] : ccz))) @ (^ [Xr:$i] : ccn0))))))))))))).
...
thf(cdivalglem10_conj,conjecture,(! [XD:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cwcel @ XD @ ccz) => ((cwne @ XD @ ccc0) => ((! [Xr:$i] : (! [Xq:$i] : ((XS @ Xr @ Xq) = (ccrab @ (^ [Xr:$i] : (cwbr @ XD @ (cco @ XN @ (ccv @ Xr) @ ccmin) @ ccdvds)) @ (^ [Xr:$i] : ccn0))))) => (cwreu @ (^ [Xr:$i] : (cwrex @ (^ [Xq:$i] : (cw3a @ (cwbr @ ccc0 @ (ccv @ Xr) @ ccle) @ (cwbr @ (ccv @ Xr) @ (ccfv @ XD @ ccabs) @ cclt) @ (XN = (cco @ (cco @ (ccv @ Xq) @ XD @ ccmul) @ (ccv @ Xr) @ ccaddc)))) @ (^ [Xq:$i] : ccz))) @ (^ [Xr:$i] : ccz)))))))))).
