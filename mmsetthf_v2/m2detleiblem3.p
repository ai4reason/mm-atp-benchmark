...
thf(agsumpr12val_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xph => (cwcel @ XG @ XV)) => ((Xph => (cwf @ (ccpr @ cc1 @ cc2) @ XB2 @ XF)) => (Xph => ((cco @ XG @ XF @ ccgsu) = (cco @ (ccfv @ cc1 @ XF) @ (ccfv @ cc2 @ XF) @ Xc_pl)))))))))))))).
