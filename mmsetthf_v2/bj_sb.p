...
thf(abj_eqs_ax,axiom,(! [Xph:$o] : (! [Xy1:$i] : (Xph <=> (! [Xx3:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => Xph)))))).
thf(cbj_sb_conj,conjecture,(! [Xph:($i > $o)] : (! [Xx3:$i] : ((Xph @ Xx3) <=> (! [Xy1:$i] : (((ccv @ Xy1) = (ccv @ Xx3)) => (! [Xx3:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => (Xph @ Xx3))))))))).
