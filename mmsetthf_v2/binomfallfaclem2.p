...
thf(afallfacp1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccfallfac) = (cco @ (cco @ XA2 @ XN @ ccfallfac) @ (cco @ XA2 @ XN @ ccmin) @ ccmul))))))))).
...
thf(abinomfallfaclem1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph & (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz))) => (cwcel @ (cco @ (cco @ XN @ XK @ ccbc) @ (cco @ (cco @ XA2 @ (cco @ XN @ XK @ ccmin) @ ccfallfac) @ (cco @ XB2 @ (cco @ XK @ cc1 @ ccaddc) @ ccfallfac) @ ccmul) @ ccmul) @ ccc))))))))))).
