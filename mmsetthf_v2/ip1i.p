...
thf(aip1ilem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XG = (ccfv @ XU @ ccpv)) => ((XS = (ccfv @ XU @ ccns)) => ((XP = (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => ((cwcel @ XA2 @ XX) => ((cwcel @ XB2 @ XX) => ((cwcel @ XC @ XX) => ((XN = (ccfv @ XU @ ccnmcv)) => ((cwcel @ XJ @ ccc) => ((cco @ (cco @ (cco @ XA2 @ XB2 @ XG) @ XC @ XP) @ (cco @ (cco @ XA2 @ (cco @ (ccneg @ cc1) @ XB2 @ XS) @ XG) @ XC @ XP) @ ccaddc) = (cco @ cc2 @ (cco @ XA2 @ XC @ XP) @ ccmul))))))))))))))))))))))).
