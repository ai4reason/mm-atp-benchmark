...
thf(aanc2li_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps => Xch)) => (Xph => (Xps => (Xph & Xch)))))))).
...
thf(azgt0ge1_ax,axiom,(! [XZ:($i > $o)] : ((cwcel @ XZ @ ccz) => ((cwbr @ ccc0 @ XZ @ cclt) <=> (cwbr @ cc1 @ XZ @ ccle))))).
...
thf(aclwlkclwwlk2_ax,axiom,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ cciedg)) => ((cw3a @ (cwcel @ XG @ ccuspgr) @ (cwcel @ XP @ (ccword @ XV)) @ (cwbr @ cc1 @ (ccfv @ XP @ cchash) @ ccle)) => ((? [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ (cco @ XP @ (ccs1 @ (ccfv @ ccc0 @ XP)) @ ccconcat) @ (ccfv @ XG @ ccclwlks))) <=> (cwcel @ XP @ (ccfv @ XG @ ccclwwlk))))))))))).
...
thf(awrdlenccats1lenm1_ax,axiom,(! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ (ccword @ XV)) => ((cco @ (ccfv @ (cco @ XW @ (ccs1 @ XS) @ ccconcat) @ cchash) @ cc1 @ ccmin) = (ccfv @ XW @ cchash))))))).
thf(asimpll_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) & Xch) => Xph))))).
thf(as1cld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ XB2)) => (Xph => (cwcel @ (ccs1 @ XA2) @ (ccword @ XB2)))))))).
thf(awrdsymb1_ax,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwbr @ cc1 @ (ccfv @ XW @ cchash) @ ccle)) => (cwcel @ (ccfv @ ccc0 @ XW) @ XV))))).
thf(aeqidd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (Xph => (XA2 = XA2))))).
thf(ccfz_tp,type,(ccfz : ($i > $o))).
thf(ccif_tp,type,(ccif : ($o > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(aswrdccatid_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV)) @ (XN = (ccfv @ XA2 @ cchash))) => ((cco @ (cco @ XA2 @ XB2 @ ccconcat) @ (ccop @ ccc0 @ XN) @ ccsubstr) = XA2))))))).
...
thf(cclwlkclwwlkfo_conj,conjecture,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XC = (ccrab @ (^ [Xw:$i] : (cwbr @ cc1 @ (ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) @ ccle)) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks)))) => ((XF = (ccmpt @ (^ [Xc:$i] : XC) @ (^ [Xc:$i] : (cco @ (ccfv @ (ccv @ Xc) @ cc2nd) @ (ccop @ ccc0 @ (cco @ (ccfv @ (ccfv @ (ccv @ Xc) @ cc2nd) @ cchash) @ cc1 @ ccmin)) @ ccsubstr)))) => ((cwcel @ XG @ ccuspgr) => (cwfo @ XC @ (ccfv @ XG @ ccclwwlk) @ XF)))))))).
