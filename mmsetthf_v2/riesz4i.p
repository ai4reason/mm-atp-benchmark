...
thf(ariesz3i_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ cclf) => ((cwcel @ XT @ cccnfn) => (cwrex @ (^ [Xw:$i] : (cwral @ (^ [Xv:$i] : ((ccfv @ (ccv @ Xv) @ XT) = (cco @ (ccv @ Xv) @ (ccv @ Xw) @ ccsp))) @ (^ [Xv:$i] : cchil))) @ (^ [Xw:$i] : cchil)))))).
...
thf(ahis2sub2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil)) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccmv) @ ccsp) = (cco @ (cco @ XA2 @ XB2 @ ccsp) @ (cco @ XA2 @ XC @ ccsp) @ ccmin))))))).
...
thf(criesz4i_conj,conjecture,(! [XT:($i > $o)] : ((cwcel @ XT @ cclf) => ((cwcel @ XT @ cccnfn) => (cwreu @ (^ [Xw:$i] : (cwral @ (^ [Xv:$i] : ((ccfv @ (ccv @ Xv) @ XT) = (cco @ (ccv @ Xv) @ (ccv @ Xw) @ ccsp))) @ (^ [Xv:$i] : cchil))) @ (^ [Xw:$i] : cchil)))))).
