...
thf(alcmfun_ax,axiom,(! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((((cwss @ XY @ ccz) & (cwcel @ XY @ ccfn)) & ((cwss @ XZ @ ccz) & (cwcel @ XZ @ ccfn))) => ((ccfv @ (ccun @ XY @ XZ) @ cclcmf) = (cco @ (ccfv @ XY @ cclcmf) @ (ccfv @ XZ @ cclcmf) @ cclcm)))))).
thf(asylan2_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xch) => (((Xps & Xch) => Xth) => ((Xps & Xph) => Xth)))))))).
thf(clcmfass_conj,conjecture,(! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((((cwss @ XY @ ccz) & (cwcel @ XY @ ccfn)) & ((cwss @ XZ @ ccz) & (cwcel @ XZ @ ccfn))) => ((ccfv @ (ccun @ (ccsn @ (ccfv @ XY @ cclcmf)) @ XZ) @ cclcmf) = (ccfv @ (ccun @ XY @ (ccsn @ (ccfv @ XZ @ cclcmf))) @ cclcmf)))))).
