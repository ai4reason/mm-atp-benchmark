...
thf(cefif1olem3_conj,conjecture,(! [Xph:$o] : (! [Xx3:$i] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xw:$i] : ((XF @ Xw) = (ccmpt @ (^ [Xw:$i] : XD) @ (^ [Xw:$i] : (ccfv @ (cco @ cci @ (ccv @ Xw) @ ccmul) @ cce))))) => ((XC = (ccima @ (cccnv @ ccabs) @ (ccsn @ cc1))) => ((Xph & (cwcel @ (ccv @ Xx3) @ XC)) => (cwcel @ (ccfv @ (ccfv @ (ccv @ Xx3) @ ccsqrt) @ ccim) @ (cco @ (ccneg @ cc1) @ cc1 @ ccicc))))))))))).
