...
thf(aneg11_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => (((ccneg @ XA2) = (ccneg @ XB2)) <=> (XA2 = XB2)))))).
...
thf(csubeqrev_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) & ((cwcel @ XC @ ccc) & (cwcel @ XD @ ccc))) => (((cco @ XA2 @ XB2 @ ccmin) = (cco @ XC @ XD @ ccmin)) <=> ((cco @ XB2 @ XA2 @ ccmin) = (cco @ XD @ XC @ ccmin))))))))).
