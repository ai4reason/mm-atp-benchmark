...
thf(ainfunsdom1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XX @ (ccdm @ cccrd)) & (cwbr @ ccom @ XX @ ccdom)) & ((cwbr @ XA2 @ XB2 @ ccdom) & (cwbr @ XB2 @ XX @ ccsdm))) => (cwbr @ (ccun @ XA2 @ XB2) @ XX @ ccsdm)))))).
