...
thf(adf_made_ax,axiom,(ccmade = (ccrecs @ (ccmpt @ (^ [Xf1:$i] : ccvv) @ (^ [Xf1:$i] : (ccima @ ccscut @ (ccxp @ (ccpw @ (ccuni @ (ccrn @ (ccv @ Xf1)))) @ (ccpw @ (ccuni @ (ccrn @ (ccv @ Xf1))))))))))).
...
thf(cmadeval_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((ccfv @ XA2 @ ccmade) = (ccima @ ccscut @ (ccxp @ (ccpw @ (ccuni @ (ccima @ ccmade @ XA2))) @ (ccpw @ (ccuni @ (ccima @ ccmade @ XA2))))))))).
