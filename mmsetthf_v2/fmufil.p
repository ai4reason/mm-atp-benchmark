...
thf(afmfnfm_ax,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XB2 @ (ccfv @ XY @ ccfbas)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XL @ (ccfv @ XX @ ccfil)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwf @ XY @ XX @ XF))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwss @ (ccfv @ XB2 @ (cco @ XX @ XF @ ccfm)) @ XL))) => (! [Xf1:$i] : ((Xph @ Xf1) => (cwrex @ (^ [Xf1:$i] : ((cwss @ XB2 @ (ccv @ Xf1)) & (XL = (ccfv @ (ccv @ Xf1) @ (cco @ XX @ XF @ ccfm))))) @ (^ [Xf1:$i] : (ccfv @ XY @ ccfil)))))))))))))))).
...
thf(aufilmax_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XF @ (ccfv @ XX @ ccufil)) @ (cwcel @ XG @ (ccfv @ XX @ ccfil)) @ (cwss @ XF @ XG)) => (XF = XG)))))).
thf(asimprrr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph & (Xps & (Xch & Xth))) => Xth)))))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(aisufil2_ax,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccufil)) <=> ((cwcel @ XF @ (ccfv @ XX @ ccfil)) & (cwral @ (^ [Xf1:$i] : ((cwss @ XF @ (ccv @ Xf1)) => (XF = (ccv @ Xf1)))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil)))))))).
thf(cfmufil_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XX @ XA2) @ (cwcel @ XL @ (ccfv @ XY @ ccufil)) @ (cwf @ XY @ XX @ XF)) => (cwcel @ (ccfv @ XL @ (cco @ XX @ XF @ ccfm)) @ (ccfv @ XX @ ccufil))))))))).
