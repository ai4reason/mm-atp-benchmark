...
thf(cisercolllem1_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xk:$i] : ((XZ @ Xk) = (ccfv @ XM @ ccuz))) => ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : (Xph => (cwf @ ccn @ (XZ @ Xk) @ XG))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn)) => (cwbr @ (ccfv @ (ccv @ Xk) @ XG) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XG) @ cclt))) => (! [Xk:$i] : ((Xph & (cwss @ (XS @ Xk) @ ccn)) => (cwiso @ (XS @ Xk) @ (ccima @ XG @ (XS @ Xk)) @ cclt @ cclt @ (ccres @ XG @ (XS @ Xk))))))))))))))).
