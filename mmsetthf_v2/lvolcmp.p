...
thf(aislvol4_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccfv @ XK @ ccbs))) => ((! [Xy1:$i] : ((XC @ Xy1) = (ccfv @ XK @ cccvr))) => ((XP = (ccfv @ XK @ cclpl)) => ((! [Xy1:$i] : ((XV @ Xy1) = (ccfv @ XK @ cclvol))) => (! [Xy1:$i] : (((cwcel @ XK @ (XA2 @ Xy1)) & (cwcel @ XX @ (XB2 @ Xy1))) => ((cwcel @ XX @ (XV @ Xy1)) <=> (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ XX @ (XC @ Xy1))) @ (^ [Xy1:$i] : XP))))))))))))))))).
...
thf(clvolcmp_conj,conjecture,(! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XV = (ccfv @ XK @ cclvol)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV)) => ((cwbr @ XX @ XY @ Xc_le) <=> (XX = XY))))))))))).
