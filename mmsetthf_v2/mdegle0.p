...
thf(atdeglem4_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xm:$i] : ((XA2 @ Xm) = (ccrab @ (^ [Xm:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xm)) @ ccn) @ ccfn)) @ (^ [Xm:$i] : (cco @ ccn0 @ XI @ ccmap))))) => ((! [Xh:$i] : (! [Xm:$i] : ((XH @ Xh @ Xm) = (ccmpt @ (^ [Xh:$i] : (XA2 @ Xm)) @ (^ [Xh:$i] : (cco @ cccnfld @ (ccv @ Xh) @ ccgsu)))))) => (! [Xh:$i] : (! [Xm:$i] : (((cwcel @ XI @ (XV @ Xm)) & (cwcel @ XX @ (XA2 @ Xm))) => (((ccfv @ XX @ (XH @ Xh @ Xm)) = ccc0) <=> (XX = (ccxp @ XI @ (ccsn @ ccc0))))))))))))))).
...
thf(cmdegle0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XI @ XR @ ccmpl)) => ((XD = (cco @ XI @ XR @ ccmdg)) => ((Xph => (cwcel @ XI @ XV)) => ((Xph => (cwcel @ XR @ ccrg)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XA2 = (ccfv @ XY @ ccascl)) => ((Xph => (cwcel @ XF @ XB2)) => (Xph => ((cwbr @ (ccfv @ XF @ XD) @ ccc0 @ ccle) <=> (XF = (ccfv @ (ccfv @ (ccxp @ XI @ (ccsn @ ccc0)) @ XF) @ XA2))))))))))))))))))))).
