...
thf(adivalglem2_ax,axiom,(! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cwcel @ XD @ ccz) => ((cwne @ XD @ ccc0) => ((! [Xr:$i] : ((XS @ Xr) = (ccrab @ (^ [Xr:$i] : (cwbr @ XD @ (cco @ XN @ (ccv @ Xr) @ ccmin) @ ccdvds)) @ (^ [Xr:$i] : ccn0)))) => (! [Xr:$i] : (cwcel @ (ccinf @ (XS @ Xr) @ ccr @ cclt) @ (XS @ Xr))))))))))).
thf(asimpri_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(cc1_tp,type,(cc1 : ($i > $o))).
thf(adivalglem5_ax,axiom,(! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cwcel @ XD @ ccz) => ((cwne @ XD @ ccc0) => ((! [Xr:$i] : ((XS @ Xr) = (ccrab @ (^ [Xr:$i] : (cwbr @ XD @ (cco @ XN @ (ccv @ Xr) @ ccmin) @ ccdvds)) @ (^ [Xr:$i] : ccn0)))) => ((! [Xr:$i] : ((XR @ Xr) = (ccinf @ (XS @ Xr) @ ccr @ cclt))) => (! [Xr:$i] : ((cwbr @ ccc0 @ (XR @ Xr) @ ccle) & (cwbr @ (XR @ Xr) @ (ccfv @ XD @ ccabs) @ cclt))))))))))))).
...
thf(cdivalglem9_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cwcel @ XD @ ccz) => ((cwne @ XD @ ccc0) => ((! [Xr:$i] : ((XS @ Xr) = (ccrab @ (^ [Xr:$i] : (cwbr @ XD @ (cco @ XN @ (ccv @ Xr) @ ccmin) @ ccdvds)) @ (^ [Xr:$i] : ccn0)))) => ((! [Xr:$i] : ((XR @ Xr) = (ccinf @ (XS @ Xr) @ ccr @ cclt))) => (! [Xr:$i] : (cwreu @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ XD @ ccabs) @ cclt)) @ (^ [Xx3:$i] : (XS @ Xr)))))))))))))).
