...
thf(ceqeu_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> Xps))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XA2 @ (XB2 @ Xx3)) @ Xps @ (! [Xx3:$i] : ((Xph @ Xx3) => ((ccv @ Xx3) = XA2)))) => (cweu @ (^ [Xx3:$i] : (Xph @ Xx3))))))))))).
