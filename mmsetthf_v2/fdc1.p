...
thf(afdc_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > ($i > ($i > $o))))] : (! [Xch:($i > ($i > $o))] : (! [Xth:($i > ($i > ($i > $o)))] : (! [Xta:($i > ($i > ($i > $o)))] : (! [Xet:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (cwcel @ (XA2 @ Xk) @ ccvv)) => ((cwcel @ XM @ ccz) => ((! [Xf1:$i] : (! [Xk:$i] : ((XZ @ Xf1 @ Xk) = (ccfv @ XM @ ccuz)))) => ((XN = (cco @ XM @ cc1 @ ccaddc)) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (((ccv @ Xa) = (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ (ccv @ Xf1))) => ((Xph @ Xn @ Xa @ Xb) <=> (Xps @ Xf1 @ Xk @ Xn @ Xb)))))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xb:$i] : (((ccv @ Xb) = (ccfv @ (ccv @ Xk) @ (ccv @ Xf1))) => ((Xps @ Xf1 @ Xk @ Xn @ Xb) <=> (Xch @ Xf1 @ Xk))))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (((ccv @ Xa) = (ccfv @ (ccv @ Xn) @ (ccv @ Xf1))) => ((Xth @ Xk @ Xa @ Xb) <=> (Xta @ Xf1 @ Xk @ Xn)))))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xet @ Xf1 @ Xk @ Xn) => (cwcel @ (XC @ Xk @ Xa @ Xb) @ (XA2 @ Xk)))))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xet @ Xf1 @ Xk @ Xn) => (cwfr @ (XA2 @ Xk) @ (XR @ Xf1 @ Xk @ Xn)))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (((Xet @ Xf1 @ Xk @ Xn) & (cwcel @ (ccv @ Xa) @ (XA2 @ Xk))) => ((Xth @ Xk @ Xa @ Xb) | (cwrex @ (^ [Xb:$i] : (Xph @ Xn @ Xa @ Xb)) @ (^ [Xb:$i] : (XA2 @ Xk)))))))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : ((((Xet @ Xf1 @ Xk @ Xn) & (Xph @ Xn @ Xa @ Xb)) & ((cwcel @ (ccv @ Xa) @ (XA2 @ Xk)) & (cwcel @ (ccv @ Xb) @ (XA2 @ Xk)))) => (cwbr @ (ccv @ Xb) @ (ccv @ Xa) @ (XR @ Xf1 @ Xk @ Xn)))))))) => (! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xet @ Xf1 @ Xk @ Xn) => (cwrex @ (^ [Xn:$i] : (? [Xf1:$i] : (cw3a @ (cwf @ (cco @ XM @ (ccv @ Xn) @ ccfz) @ (XA2 @ Xk) @ (ccv @ Xf1)) @ (((ccfv @ XM @ (ccv @ Xf1)) = (XC @ Xk @ Xa @ Xb)) & (Xta @ Xf1 @ Xk @ Xn)) @ (cwral @ (^ [Xk:$i] : (Xch @ Xf1 @ Xk)) @ (^ [Xk:$i] : (cco @ XN @ (ccv @ Xn) @ ccfz)))))) @ (^ [Xn:$i] : (XZ @ Xf1 @ Xk))))))))))))))))))))))))))))))))).
...
thf(asbhypf_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XA2 @ Xy1)) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xx3 @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xy1) = (XA2 @ Xy1)) => ((cwsb @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ Xy1) <=> (Xps @ Xx3 @ Xy1))))))))))).
...
thf(cfdc1_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > ($i > ($i > $o))))] : (! [Xch:($i > ($i > $o))] : (! [Xth:($i > ($i > ($i > $o)))] : (! [Xta:($i > ($i > ($i > $o)))] : (! [Xet:($i > $o)] : (! [Xze:($i > ($i > $o))] : (! [Xsi:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (cwcel @ (XA2 @ Xk) @ ccvv)) => ((cwcel @ XM @ ccz) => ((! [Xf1:$i] : (! [Xk:$i] : ((XZ @ Xf1 @ Xk) = (ccfv @ XM @ ccuz)))) => ((XN = (cco @ XM @ cc1 @ ccaddc)) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (((ccv @ Xa) = (ccfv @ XM @ (ccv @ Xf1))) => ((Xze @ Xk @ Xa) <=> (Xsi @ Xf1 @ Xk @ Xn @ Xb)))))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (((ccv @ Xa) = (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ (ccv @ Xf1))) => ((Xph @ Xn @ Xa @ Xb) <=> (Xps @ Xf1 @ Xk @ Xn @ Xb)))))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xb:$i] : (((ccv @ Xb) = (ccfv @ (ccv @ Xk) @ (ccv @ Xf1))) => ((Xps @ Xf1 @ Xk @ Xn @ Xb) <=> (Xch @ Xf1 @ Xk))))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (((ccv @ Xa) = (ccfv @ (ccv @ Xn) @ (ccv @ Xf1))) => ((Xth @ Xk @ Xa @ Xb) <=> (Xta @ Xf1 @ Xk @ Xn)))))))) => ((! [Xk:$i] : ((Xet @ Xk) => (cwrex @ (^ [Xa:$i] : (Xze @ Xk @ Xa)) @ (^ [Xa:$i] : (XA2 @ Xk))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xet @ Xk) => (cwfr @ (XA2 @ Xk) @ (XR @ Xf1 @ Xk @ Xn)))))) => ((! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (((Xet @ Xk) & (cwcel @ (ccv @ Xa) @ (XA2 @ Xk))) => ((Xth @ Xk @ Xa @ Xb) | (cwrex @ (^ [Xb:$i] : (Xph @ Xn @ Xa @ Xb)) @ (^ [Xb:$i] : (XA2 @ Xk))))))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : ((((Xet @ Xk) & (Xph @ Xn @ Xa @ Xb)) & ((cwcel @ (ccv @ Xa) @ (XA2 @ Xk)) & (cwcel @ (ccv @ Xb) @ (XA2 @ Xk)))) => (cwbr @ (ccv @ Xb) @ (ccv @ Xa) @ (XR @ Xf1 @ Xk @ Xn)))))))) => (! [Xf1:$i] : (! [Xk:$i] : (! [Xb:$i] : ((Xet @ Xk) => (cwrex @ (^ [Xn:$i] : (? [Xf1:$i] : (cw3a @ (cwf @ (cco @ XM @ (ccv @ Xn) @ ccfz) @ (XA2 @ Xk) @ (ccv @ Xf1)) @ ((Xsi @ Xf1 @ Xk @ Xn @ Xb) & (Xta @ Xf1 @ Xk @ Xn)) @ (cwral @ (^ [Xk:$i] : (Xch @ Xf1 @ Xk)) @ (^ [Xk:$i] : (cco @ XN @ (ccv @ Xn) @ ccfz)))))) @ (^ [Xn:$i] : (XZ @ Xf1 @ Xk))))))))))))))))))))))))))))))))).
