...
thf(abrafval_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((ccfv @ XA2 @ ccbr) = (ccmpt @ (^ [Xx3:$i] : cchil) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ ccsp))))))).
...
thf(cbra0_conj,conjecture,((ccfv @ cc0v @ ccbr) = (ccxp @ cchil @ (ccsn @ ccc0)))).
