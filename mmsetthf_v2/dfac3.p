...
thf(afunfvima3_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfun @ XF) & (cwss @ XF @ XG)) => ((cwcel @ XA2 @ (ccdm @ XF)) => (cwcel @ (ccfv @ XA2 @ XF) @ (ccima @ XG @ (ccsn @ XA2))))))))).
