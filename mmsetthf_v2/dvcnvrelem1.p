...
thf(aevthicc2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccrn @ XF) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccicc))) @ (^ [Xy1:$i] : ccr))) @ (^ [Xx3:$i] : ccr)))))))))))).
...
thf(cdvcnvrelem1_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ XX @ ccr @ cccncf))) => ((Xph => ((ccdm @ (cco @ ccr @ XF @ ccdv)) = XX)) => ((Xph => (~ (cwcel @ ccc0 @ (ccrn @ (cco @ ccr @ XF @ ccdv))))) => ((Xph => (cwf1o @ XX @ XY @ XF)) => ((Xph => (cwcel @ XC @ XX)) => ((Xph => (cwcel @ XR @ ccrp)) => ((Xph => (cwss @ (cco @ (cco @ XC @ XR @ ccmin) @ (cco @ XC @ XR @ ccaddc) @ ccicc) @ XX)) => (Xph => (cwcel @ (ccfv @ XC @ XF) @ (ccfv @ (ccima @ XF @ (cco @ (cco @ XC @ XR @ ccmin) @ (cco @ XC @ XR @ ccaddc) @ ccicc)) @ (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ ccnt)))))))))))))))))).
