...
thf(asorpssi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwor @ XA2 @ ccrpss) & ((cwcel @ XB2 @ XA2) & (cwcel @ XC @ XA2))) => ((cwss @ XB2 @ XC) | (cwss @ XC @ XB2))))))).
...
thf(csorpssint_conj,conjecture,(! [XY:($i > $o)] : ((cwor @ XY @ ccrpss) => ((cwrex @ (^ [Xu:$i] : (cwral @ (^ [Xv:$i] : (~ (cwpss @ (ccv @ Xv) @ (ccv @ Xu)))) @ (^ [Xv:$i] : XY))) @ (^ [Xu:$i] : XY)) <=> (cwcel @ (ccint @ XY) @ XY))))).
