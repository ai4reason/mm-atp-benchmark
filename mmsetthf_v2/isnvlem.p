...
thf(adf_nv_ax,axiom,(ccnv = (ccoprab @ (^ [Xg1:$i] : (^ [Xs1:$i] : (^ [Xn:$i] : (cw3a @ (cwcel @ (ccop @ (ccv @ Xg1) @ (ccv @ Xs1)) @ ccvc) @ (cwf @ (ccrn @ (ccv @ Xg1)) @ ccr @ (ccv @ Xn)) @ (cwral @ (^ [Xx3:$i] : (cw3a @ (((ccfv @ (ccv @ Xx3) @ (ccv @ Xn)) = ccc0) => ((ccv @ Xx3) = (ccfv @ (ccv @ Xg1) @ ccgi))) @ (cwral @ (^ [Xy1:$i] : ((ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccv @ Xs1)) @ (ccv @ Xn)) = (cco @ (ccfv @ (ccv @ Xy1) @ ccabs) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xn)) @ ccmul))) @ (^ [Xy1:$i] : ccc)) @ (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xg1)) @ (ccv @ Xn)) @ (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xn)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xn)) @ ccaddc) @ ccle)) @ (^ [Xy1:$i] : (ccrn @ (ccv @ Xg1)))))) @ (^ [Xx3:$i] : (ccrn @ (ccv @ Xg1))))))))))).
