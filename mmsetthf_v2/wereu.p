...
thf(cwereu_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (((cwwe @ XA2 @ XR) & (cw3a @ (cwcel @ XB2 @ (XV @ Xx3 @ Xy1)) @ (cwss @ XB2 @ XA2) @ (cwne @ XB2 @ cc0))) => (cwreu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)))))))))).
