...
thf(a_0nrp_ax,axiom,(~ (cwcel @ ccc0 @ ccrp))).
...
thf(asuppdm_ax,axiom,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : (((cw3a @ (cwfun @ XF) @ (cwcel @ XF @ XV) @ (cwcel @ XZ @ XW)) & (cwnel @ XZ @ (ccrn @ XF))) => ((cco @ XF @ XZ @ ccsupp) = (ccdm @ XF)))))))).
thf(afdm_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => ((ccdm @ XF) = XA2)))))).
thf(ccmpt_tp,type,(ccmpt : (($i > ($i > $o)) > (($i > ($i > $o)) > ($i > $o))))).
thf(arefdivmptfv_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cw3a @ (cwf @ XA2 @ ccr @ XF) @ (cwf @ XA2 @ ccr @ XG) @ (cwcel @ XA2 @ XV)) & (cwcel @ XX @ (cco @ XG @ ccc0 @ ccsupp))) => ((ccfv @ XX @ (cco @ XF @ XG @ ccfdiv)) = (cco @ (ccfv @ XX @ XF) @ (ccfv @ XX @ XG) @ ccdiv))))))))).
...
thf(aelbigo2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cwf @ XA2 @ ccr @ XG) & (cwss @ XA2 @ ccr)) & ((cwf @ XB2 @ ccr @ XF) & (cwss @ XB2 @ XA2))) => ((cwcel @ XF @ (ccfv @ XG @ ccbigo)) <=> (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle) => (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ (ccv @ Xm) @ (ccfv @ (ccv @ Xy1) @ XG) @ ccmul) @ ccle))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xm:$i] : ccr))) @ (^ [Xx3:$i] : ccr))))))))).
thf(ampbird_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xch) => ((Xph => (Xps <=> Xch)) => (Xph => Xps))))))).
thf(arefdivmptf_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwf @ XA2 @ ccr @ XF) @ (cwf @ XA2 @ ccr @ XG) @ (cwcel @ XA2 @ XV)) => (cwf @ (cco @ XG @ ccc0 @ ccsupp) @ ccr @ (cco @ XF @ XG @ ccfdiv)))))))).
...
thf(aello12_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwf @ XA2 @ ccr @ XF) & (cwss @ XA2 @ ccr)) => ((cwcel @ XF @ cclo1) <=> (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle) => (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccv @ Xm) @ ccle))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xm:$i] : ccr))) @ (^ [Xx3:$i] : ccr))))))).
thf(celbigolo1_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cw3a @ (cwss @ XA2 @ ccr) @ (cwf @ XA2 @ ccrp @ XG) @ (cwf @ XA2 @ ccrp @ XF)) => ((cwcel @ XF @ (ccfv @ XG @ ccbigo)) <=> (cwcel @ (cco @ XF @ XG @ ccfdiv) @ cclo1))))))).
