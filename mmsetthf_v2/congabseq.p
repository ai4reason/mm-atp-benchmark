...
thf(ccongabseq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz)) & (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccdvds)) => ((cwbr @ (ccfv @ (cco @ XB2 @ XC @ ccmin) @ ccabs) @ XA2 @ cclt) <=> (XB2 = XC))))))).
