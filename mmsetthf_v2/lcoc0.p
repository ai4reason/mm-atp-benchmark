...
thf(amptsuppd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XZ @ (XW @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ (XU @ Xx3)))) => (! [Xx3:$i] : (Xph => ((cco @ (XF @ Xx3) @ XZ @ ccsupp) = (ccrab @ (^ [Xx3:$i] : (cwne @ (XB2 @ Xx3) @ XZ)) @ (^ [Xx3:$i] : XA2)))))))))))))))))).
...
thf(alincvalsc0_ax,axiom,(! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((XB2 = (ccfv @ XM @ ccbs)) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccfv @ XM @ ccsca))) => ((! [Xx3:$i] : (Xc_0 = (ccfv @ (XS @ Xx3) @ cc0g))) => ((! [Xx3:$i] : ((XZ @ Xx3) = (ccfv @ XM @ cc0g))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : Xc_0)))) => (! [Xx3:$i] : (((cwcel @ XM @ cclmod) & (cwcel @ XV @ (ccpw @ XB2))) => ((cco @ (XF @ Xx3) @ XV @ (ccfv @ XM @ cclinc)) = (XZ @ Xx3))))))))))))))))).
thf(clcoc0_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((XB2 = (ccfv @ XM @ ccbs)) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccfv @ XM @ ccsca))) => ((! [Xx3:$i] : (Xc_0 = (ccfv @ (XS @ Xx3) @ cc0g))) => ((! [Xx3:$i] : ((XZ @ Xx3) = (ccfv @ XM @ cc0g))) => ((XF = (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : Xc_0))) => ((! [Xx3:$i] : (XR = (ccfv @ (XS @ Xx3) @ ccbs))) => (! [Xx3:$i] : (((cwcel @ XM @ cclmod) & (cwcel @ XV @ (ccpw @ XB2))) => (cw3a @ (cwcel @ XF @ (cco @ XR @ XV @ ccmap)) @ (cwbr @ XF @ Xc_0 @ ccfsupp) @ ((cco @ XF @ XV @ (ccfv @ XM @ cclinc)) = (XZ @ Xx3)))))))))))))))))))).
