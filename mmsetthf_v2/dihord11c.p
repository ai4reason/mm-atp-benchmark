...
thf(cdihord11c_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [Xc_pl:($i > ($i > $o))] : (! [Xc_po:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [Xf1:$i] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((! [Xh:$i] : ((Xc_or @ Xh) = (ccfv @ XK @ ccjn))) => ((! [Xh:$i] : ((Xc_an @ Xh) = (ccfv @ XK @ ccmee))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((! [Xh:$i] : ((XI @ Xh) = (ccfv @ XW @ (ccfv @ XK @ ccdib)))) => ((! [Xh:$i] : ((XJ @ Xh) = (ccfv @ XW @ (ccfv @ XK @ ccdic)))) => ((! [Xh:$i] : ((XU @ Xh) = (ccfv @ XW @ (ccfv @ XK @ ccdvh)))) => ((! [Xh:$i] : ((Xc_po @ Xh) = (ccfv @ (XU @ Xh) @ cclsm))) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xh:$i] : ((XR @ Xh) = (ccfv @ XW @ (ccfv @ XK @ cctrl)))) => ((! [Xh:$i] : ((XO @ Xh) = (ccmpt @ (^ [Xh:$i] : XT) @ (^ [Xh:$i] : (ccres @ ccid @ XB2))))) => ((! [Xy1:$i] : (! [Xz:$i] : ((XP @ Xy1 @ Xz) = (ccfv @ XW @ (ccfv @ XK @ ccoc))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xh:$i] : ((XE @ Xy1 @ Xz @ Xh) = (ccfv @ XW @ (ccfv @ XK @ cctendo)))))) => ((! [Xh:$i] : ((Xc_pl @ Xh) = (ccfv @ (XU @ Xh) @ ccplusg))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xh:$i] : ((XG @ Xy1 @ Xz @ Xh) = (ccrio @ (^ [Xh:$i] : ((ccfv @ (XP @ Xy1 @ Xz) @ (ccv @ Xh)) = XN)) @ (^ [Xh:$i] : XT)))))) => (! [Xh:$i] : ((cw3a @ (cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ ((cwcel @ (XQ @ Xh) @ XA2) & (~ (cwbr @ (XQ @ Xh) @ XW @ Xc_le))) @ ((cwcel @ XN @ XA2) & (~ (cwbr @ XN @ XW @ Xc_le)))) @ ((cwcel @ (XX @ Xh) @ XB2) & (cwcel @ (XY @ Xh) @ XB2)) @ (cw3a @ (cwss @ (cco @ (ccfv @ (XQ @ Xh) @ (XJ @ Xh)) @ (ccfv @ (cco @ (XX @ Xh) @ XW @ (Xc_an @ Xh)) @ (XI @ Xh)) @ (Xc_po @ Xh)) @ (cco @ (ccfv @ XN @ (XJ @ Xh)) @ (ccfv @ (cco @ (XY @ Xh) @ XW @ (Xc_an @ Xh)) @ (XI @ Xh)) @ (Xc_po @ Xh))) @ (cwcel @ (ccv @ Xf1) @ XT) @ (cwbr @ (ccfv @ (ccv @ Xf1) @ (XR @ Xh)) @ (cco @ (XX @ Xh) @ XW @ (Xc_an @ Xh)) @ Xc_le))) => (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((ccop @ (ccv @ Xf1) @ (XO @ Xh)) = (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ (Xc_pl @ Xh)))) @ (^ [Xz:$i] : (ccfv @ (cco @ (XY @ Xh) @ XW @ (Xc_an @ Xh)) @ (XI @ Xh))))) @ (^ [Xy1:$i] : (ccfv @ XN @ (XJ @ Xh)))))))))))))))))))))))))))))))))))))))))))))))).
