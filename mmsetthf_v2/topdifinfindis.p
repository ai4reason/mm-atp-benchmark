...
thf(ctopdifinfindis_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > ($i > $o))] : ((! [Xx3:$i] : ((XT @ Xx3) = (ccrab @ (^ [Xx3:$i] : ((~ (cwcel @ (ccdif @ XA2 @ (ccv @ Xx3)) @ ccfn)) | (((ccv @ Xx3) = cc0) | ((ccv @ Xx3) = XA2)))) @ (^ [Xx3:$i] : (ccpw @ XA2))))) => (! [Xx3:$i] : ((cwcel @ XA2 @ ccfn) => ((XT @ Xx3) = (ccpr @ cc0 @ XA2)))))))).
