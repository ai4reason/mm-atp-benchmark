...
thf(assunpr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwss @ XB2 @ XA2) & (cwss @ XA2 @ (ccun @ XB2 @ (ccpr @ XC @ XD)))) <=> (((XA2 = XB2) | (XA2 = (ccun @ XB2 @ (ccsn @ XC)))) | ((XA2 = (ccun @ XB2 @ (ccsn @ XD))) | (XA2 = (ccun @ XB2 @ (ccpr @ XC @ XD))))))))))).
...
thf(csspr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ (ccpr @ XB2 @ XC)) <=> (((XA2 = cc0) | (XA2 = (ccsn @ XB2))) | ((XA2 = (ccsn @ XC)) | (XA2 = (ccpr @ XB2 @ XC))))))))).
