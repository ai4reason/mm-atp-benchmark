...
thf(awinalim2_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccwina) & (cwne @ XA2 @ ccom)) => (? [Xx3:$i] : (((ccfv @ (ccv @ Xx3) @ ccale) = XA2) & (cwlim @ (ccv @ Xx3))))))).
...
thf(cwinafp_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccwina) & (cwne @ XA2 @ ccom)) => ((ccfv @ XA2 @ ccale) = XA2)))).
