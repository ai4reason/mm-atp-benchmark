...
thf(aontgval_ax,axiom,(! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccon0) => ((ccfv @ XB2 @ cctg) = (ccsuc @ (ccuni @ XB2)))))).
...
thf(contgsucval_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((ccfv @ (ccsuc @ XA2) @ cctg) = (ccsuc @ XA2))))).
