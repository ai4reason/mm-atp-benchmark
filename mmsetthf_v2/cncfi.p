...
thf(acncfrss2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (cco @ XA2 @ XB2 @ cccncf)) => (cwss @ XB2 @ ccc)))))).
...
thf(ccncfi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwcel @ XF @ (cco @ XA2 @ XB2 @ cccncf)) @ (cwcel @ XC @ XA2) @ (cwcel @ XR @ ccrp)) => (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((cwbr @ (ccfv @ (cco @ (ccv @ Xw) @ XC @ ccmin) @ ccabs) @ (ccv @ Xz) @ cclt) => (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xw) @ XF) @ (ccfv @ XC @ XF) @ ccmin) @ ccabs) @ XR @ cclt))) @ (^ [Xw:$i] : XA2))) @ (^ [Xz:$i] : ccrp))))))))).
