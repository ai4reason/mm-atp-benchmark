...
thf(admadjrn_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ (ccdm @ ccado)) => (cwcel @ (ccfv @ XT @ ccado) @ (ccdm @ ccado))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(cwfun_tp,type,(cwfun : (($i > $o) > $o))).
thf(ccopab_tp,type,(ccopab : (($i > ($i > $o)) > ($i > $o)))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aadj1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwcel @ XT @ (ccdm @ ccado)) @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil)) => ((cco @ XA2 @ (ccfv @ XB2 @ XT) @ ccsp) = (cco @ (ccfv @ XA2 @ (ccfv @ XT @ ccado)) @ XB2 @ ccsp))))))).
thf(asyl2anc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xph => Xch) => (((Xps & Xch) => Xth) => (Xph => Xth))))))))).
thf(a_3syl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xps => Xch) => ((Xch => Xth) => (Xph => Xth))))))))).
thf(ccmap_tp,type,(ccmap : ($i > $o))).
thf(admadjop_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ (ccdm @ ccado)) => (cwf @ cchil @ cchil @ XT)))).
thf(cwfn_tp,type,(cwfn : (($i > $o) > (($i > $o) > $o)))).
thf(ahoeq1_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (((cwf @ cchil @ cchil @ XS) & (cwf @ cchil @ cchil @ XT)) => ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccfv @ (ccv @ Xx3) @ XS) @ (ccv @ Xy1) @ ccsp) = (cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xy1) @ ccsp))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : cchil)) <=> (XS = XT)))))).
thf(cadjadj_conj,conjecture,(! [XT:($i > $o)] : ((cwcel @ XT @ (ccdm @ ccado)) => ((ccfv @ (ccfv @ XT @ ccado) @ ccado) = XT)))).
