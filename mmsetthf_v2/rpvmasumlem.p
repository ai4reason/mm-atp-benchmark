...
thf(adchr1re_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XZ = (ccfv @ XN @ cczn)) => ((Xc_1 = (ccfv @ XG @ cc0g)) => ((XB2 = (ccfv @ XZ @ ccbs)) => ((Xph => (cwcel @ XN @ ccn)) => (Xph => (cwf @ XB2 @ ccr @ Xc_1)))))))))))))).
...
thf(adchrn0_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XZ = (ccfv @ XN @ cczn)) => ((XD = (ccfv @ XG @ ccbs)) => ((XB2 = (ccfv @ XZ @ ccbs)) => ((XU = (ccfv @ XZ @ ccui)) => ((Xph => (cwcel @ XX @ XD)) => ((Xph => (cwcel @ XA2 @ XB2)) => (Xph => ((cwne @ (ccfv @ XA2 @ XX) @ ccc0) <=> (cwcel @ XA2 @ XU)))))))))))))))))))).
...
thf(asylanr1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xch) => (((Xps & (Xch & Xth)) => Xta) => ((Xps & (Xph & Xth)) => Xta))))))))).
...
thf(arpexp1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XM @ ccn0)) => (((cco @ XA2 @ XB2 @ ccgcd) = cc1) => ((cco @ (cco @ XA2 @ XM @ ccexp) @ XB2 @ ccgcd) = cc1))))))).
thf(aadantlrr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((((Xph & Xps) & Xch) => Xth) => (((Xph & (Xps & Xta)) & Xch) => Xth)))))))).
thf(ccrh_tp,type,(ccrh : ($i > $o))).
thf(ccdsr_tp,type,(ccdsr : ($i > $o))).
thf(aznunit_ax,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XN @ cczn)) => ((XU = (ccfv @ XY @ ccui)) => ((XL = (ccfv @ XY @ cczrh)) => (((cwcel @ XN @ ccn0) & (cwcel @ XA2 @ ccz)) => ((cwcel @ (ccfv @ XA2 @ XL) @ XU) <=> ((cco @ XA2 @ XN @ ccgcd) = cc1)))))))))))).
...
thf(appifi_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwcel @ (ccin @ (cco @ ccc0 @ XA2 @ ccicc) @ ccprime) @ ccfn)))).
...
thf(avmappw_ax,axiom,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XK @ ccn)) => ((ccfv @ (cco @ XP @ XK @ ccexp) @ ccvma) = (ccfv @ XP @ cclog)))))).
...
thf(asubge02_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ ccc0 @ XB2 @ ccle) <=> (cwbr @ (cco @ XA2 @ XB2 @ ccmin) @ XA2 @ ccle)))))).
...
thf(ageoserg_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwne @ XA2 @ cc1)) => ((Xph => (cwcel @ XM @ ccn0)) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => (Xph => ((ccsu @ (cco @ XM @ XN @ ccfzo) @ (^ [Xk:$i] : (cco @ XA2 @ (ccv @ Xk) @ ccexp))) = (cco @ (cco @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccmin) @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv)))))))))))).
...
thf(ao1sub_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ cco1) & (cwcel @ XG @ cco1)) => (cwcel @ (cco @ XF @ XG @ (ccof @ ccmin)) @ cco1))))).
