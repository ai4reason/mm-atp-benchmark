...
thf(asimpl2im_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps & Xch)) => ((Xch => Xth) => (Xph => Xth)))))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(awwlkbp_ax,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XW @ (ccfv @ XG @ ccwwlks)) => ((cwcel @ XG @ ccvv) & (cwcel @ XW @ (ccword @ XV))))))))).
...
thf(awwlksm1edg_ax,axiom,(! [XG:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccfv @ XG @ ccwwlks)) & (cwbr @ cc2 @ (ccfv @ XW @ cchash) @ ccle)) => (cwcel @ (cco @ XW @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin)) @ ccsubstr) @ (ccfv @ XG @ ccwwlks)))))).
...
thf(awwlksnextproplem1_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ (cco @ XN @ cc1 @ ccaddc) @ XG @ ccwwlksn)) => (((cwcel @ XW @ XX) & (cwcel @ XN @ ccn0)) => ((ccfv @ ccc0 @ (cco @ XW @ (ccop @ ccc0 @ (cco @ XN @ cc1 @ ccaddc)) @ ccsubstr)) = (ccfv @ ccc0 @ XW))))))))).
...
thf(cwwlksnextproplem3_conj,conjecture,(! [XP:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xw:$i] : ((XX @ Xw) = (cco @ (cco @ XN @ cc1 @ ccaddc) @ XG @ ccwwlksn))) => ((! [Xw:$i] : ((XE @ Xw) = (ccfv @ XG @ ccedg))) => ((! [Xw:$i] : ((XY @ Xw) = (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = XP)) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))))) => (! [Xw:$i] : ((cw3a @ (cwcel @ XW @ (XX @ Xw)) @ ((ccfv @ ccc0 @ XW) = XP) @ (cwcel @ XN @ ccn0)) => (cwcel @ (cco @ XW @ (ccop @ ccc0 @ (cco @ XN @ cc1 @ ccaddc)) @ ccsubstr) @ (XY @ Xw))))))))))))))).
