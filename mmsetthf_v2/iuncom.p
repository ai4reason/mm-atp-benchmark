...
thf(ciuncom_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : ((cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (cciun @ (^ [Xy1:$i] : (XB2 @ Xy1)) @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))) = (cciun @ (^ [Xy1:$i] : (XB2 @ Xy1)) @ (^ [Xy1:$i] : (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xy1)))))))))).
