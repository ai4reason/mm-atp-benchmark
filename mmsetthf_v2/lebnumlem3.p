...
thf(ametdsval_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XA2 @ XX) => ((ccfv @ XA2 @ (XF @ Xx3 @ Xy1)) = (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ XA2 @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))))))))).
...
thf(apssdifn0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ XB2) & (cwne @ XA2 @ XB2)) => (cwne @ (ccdif @ XB2 @ XA2) @ cc0))))).
thf(ametdsre_ax,axiom,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccme)) @ (cwss @ XS @ XX) @ (cwne @ XS @ cc0)) => (cwf @ XX @ ccr @ (XF @ Xx3 @ Xy1))))))))))).
...
thf(adifin0ss_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((ccin @ (ccdif @ XA2 @ XB2) @ XC) = cc0) => ((cwss @ XC @ XA2) => (cwss @ XC @ XB2))))))).
