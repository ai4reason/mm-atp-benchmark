...
thf(aclwwlkf_ax,axiom,(! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((! [Xw:$i] : ((XD @ Xw) = (ccrab @ (^ [Xw:$i] : ((ccfv @ (ccv @ Xw) @ cclsw) = (ccfv @ ccc0 @ (ccv @ Xw)))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))))) => ((! [Xw:$i] : (! [Xt:$i] : ((XF @ Xw @ Xt) = (ccmpt @ (^ [Xt:$i] : (XD @ Xw)) @ (^ [Xt:$i] : (cco @ (ccv @ Xt) @ (ccop @ ccc0 @ XN) @ ccsubstr)))))) => (! [Xw:$i] : (! [Xt:$i] : ((cwcel @ XN @ ccn) => (cwf @ (XD @ Xw) @ (cco @ XN @ XG @ ccclwwlkn) @ (XF @ Xw @ Xt)))))))))))).
thf(aralrimiva_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => (Xps @ Xx3))) => (Xph => (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))).
thf(ampbird_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xch) => ((Xph => (Xps <=> Xch)) => (Xph => Xps))))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(aimpcom_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps => Xch)) => ((Xps & Xph) => Xch)))))).
thf(aclwwlknp_ax,axiom,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : ((! [Xi:$i] : ((XV @ Xi) = (ccfv @ XG @ ccvtx))) => ((! [Xi:$i] : ((XE @ Xi) = (ccfv @ XG @ ccedg))) => (! [Xi:$i] : ((cwcel @ XW @ (cco @ XN @ XG @ ccclwwlkn)) => (cw3a @ ((cwcel @ XW @ (ccword @ (XV @ Xi))) & ((ccfv @ XW @ cchash) = XN)) @ (cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ XW) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XW)) @ (XE @ Xi))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfzo))) @ (cwcel @ (ccpr @ (ccfv @ XW @ cclsw) @ (ccfv @ ccc0 @ XW)) @ (XE @ Xi))))))))))))).
...
thf(afstwrdne0_ax,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XN @ ccn) & ((cwcel @ XW @ (ccword @ XV)) & ((ccfv @ XW @ cchash) = XN))) => (cwcel @ (ccfv @ ccc0 @ XW) @ XV)))))).
...
thf(aclwwlkfv_ax,axiom,(! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xw:$i] : ((XD @ Xw) = (ccrab @ (^ [Xw:$i] : ((ccfv @ (ccv @ Xw) @ cclsw) = (ccfv @ ccc0 @ (ccv @ Xw)))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))))) => ((! [Xw:$i] : (! [Xt:$i] : ((XF @ Xw @ Xt) = (ccmpt @ (^ [Xt:$i] : (XD @ Xw)) @ (^ [Xt:$i] : (cco @ (ccv @ Xt) @ (ccop @ ccc0 @ XN) @ ccsubstr)))))) => (! [Xw:$i] : (! [Xt:$i] : ((cwcel @ (XW @ Xw) @ (XD @ Xw)) => ((ccfv @ (XW @ Xw) @ (XF @ Xw @ Xt)) = (cco @ (XW @ Xw) @ (ccop @ ccc0 @ XN) @ ccsubstr))))))))))))).
