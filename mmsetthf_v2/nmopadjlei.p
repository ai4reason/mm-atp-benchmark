...
thf(abdopssadj_ax,axiom,(cwss @ ccbo @ (ccdm @ ccado))).
thf(aadjvalval_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XT @ (ccdm @ ccado)) & (cwcel @ XA2 @ cchil)) => ((ccfv @ XA2 @ (ccfv @ XT @ ccado)) = (ccrio @ (^ [Xw:$i] : (cwral @ (^ [Xx3:$i] : ((cco @ (ccfv @ (ccv @ Xx3) @ XT) @ XA2 @ ccsp) = (cco @ (ccv @ Xx3) @ (ccv @ Xw) @ ccsp))) @ (^ [Xx3:$i] : cchil))) @ (^ [Xw:$i] : cchil))))))).
...
thf(alncnbd_ax,axiom,((ccin @ cclo @ cccop) = ccbo)).
...
thf(cnmopadjlei_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XT @ ccbo) => ((cwcel @ XA2 @ cchil) => (cwbr @ (ccfv @ (ccfv @ XA2 @ (ccfv @ XT @ ccado)) @ ccno) @ (cco @ (ccfv @ XT @ ccnop) @ (ccfv @ XA2 @ ccno) @ ccmul) @ ccle)))))).
