...
thf(adf_gic_ax,axiom,(ccgic = (ccima @ (cccnv @ ccgim) @ (ccdif @ ccvv @ cc1o)))).
...
thf(agimfn_ax,axiom,(cwfn @ ccgim @ (ccxp @ ccgrp @ ccgrp))).
...
thf(agicref_ax,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccgrp) => (cwbr @ XR @ XR @ ccgic)))).
thf(agiclcl_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwbr @ XR @ XS @ ccgic) => (cwcel @ XR @ ccgrp))))).
