...
thf(ann0prpwlem_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => (cwral @ (^ [Xk:$i] : ((cwbr @ (ccv @ Xk) @ XA2 @ cclt) => (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xn:$i] : (~ ((cwbr @ (cco @ (ccv @ Xp) @ (ccv @ Xn) @ ccexp) @ (ccv @ Xk) @ ccdvds) <=> (cwbr @ (cco @ (ccv @ Xp) @ (ccv @ Xn) @ ccexp) @ XA2 @ ccdvds)))) @ (^ [Xn:$i] : ccn))) @ (^ [Xp:$i] : ccprime)))) @ (^ [Xk:$i] : ccn))))).
...
thf(cnn0prpw_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn0) & (cwcel @ XB2 @ ccn0)) => ((XA2 = XB2) <=> (cwral @ (^ [Xp:$i] : (cwral @ (^ [Xn:$i] : ((cwbr @ (cco @ (ccv @ Xp) @ (ccv @ Xn) @ ccexp) @ XA2 @ ccdvds) <=> (cwbr @ (cco @ (ccv @ Xp) @ (ccv @ Xn) @ ccexp) @ XB2 @ ccdvds))) @ (^ [Xn:$i] : ccn))) @ (^ [Xp:$i] : ccprime))))))).
