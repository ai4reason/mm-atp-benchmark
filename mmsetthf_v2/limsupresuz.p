...
thf(auzinico_ax,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XM @ ccz)) => ((XZ = (ccfv @ XM @ ccuz)) => (Xph => (XZ = (ccin @ ccz @ (cco @ XM @ ccpnf @ ccico)))))))))).
...
thf(alimsupresico_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XM @ ccr)) => ((XZ = (cco @ XM @ ccpnf @ ccico)) => ((Xph => (cwcel @ XF @ XV)) => (Xph => ((ccfv @ (ccres @ XF @ XZ) @ cclsp) = (ccfv @ XF @ cclsp)))))))))))).
...
thf(alimsupresre_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XF @ XV)) => (Xph => ((ccfv @ (ccres @ XF @ ccr) @ cclsp) = (ccfv @ XF @ cclsp)))))))).
