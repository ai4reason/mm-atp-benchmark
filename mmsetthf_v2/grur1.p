...
thf(atcrank_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) => ((ccfv @ XA2 @ ccrnk) = (ccima @ ccrnk @ (ccfv @ XA2 @ cctc)))))).
...
thf(agruelss_ax,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (((cwcel @ XU @ ccgru) & (cwcel @ XA2 @ XU)) => (cwss @ XA2 @ XU))))).
...
thf(asyl6eqbrr_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (XB2 = XA2)) => ((cwbr @ XB2 @ XC @ XR) => (Xph => (cwbr @ XA2 @ XC @ XR)))))))))).
...
thf(agrudomon_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : ((cw3a @ (cwcel @ XU @ ccgru) @ (cwcel @ XA2 @ ccon0) @ ((cwcel @ XB2 @ XU) & (cwbr @ XA2 @ XB2 @ ccdom))) => (cwcel @ XA2 @ XU)))))).
...
thf(agrur1a_ax,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : ((XA2 = (ccin @ XU @ ccon0)) => ((cwcel @ XU @ ccgru) => (cwss @ (ccfv @ XA2 @ ccr1) @ XU)))))).
thf(cgrur1_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : ((XA2 = (ccin @ XU @ ccon0)) => (((cwcel @ XU @ ccgru) & (cwcel @ XU @ (ccuni @ (ccima @ ccr1 @ ccon0)))) => (XU = (ccfv @ XA2 @ ccr1))))))).
