...
thf(afvn0elsuppb_ax,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XB2 @ XV) @ (cwcel @ XX @ XB2) @ (cwfn @ XG @ XB2)) => ((cwne @ (ccfv @ XX @ XG) @ cc0) <=> (cwcel @ XX @ (cco @ XG @ cc0 @ ccsupp))))))))).
thf(cbrcic_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XI = (ccfv @ XC @ cciso)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => (Xph => ((cwbr @ XX @ XY @ (ccfv @ XC @ cccic)) <=> (cwne @ (cco @ XX @ XY @ XI) @ cc0))))))))))))))).
