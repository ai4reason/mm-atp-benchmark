...
thf(cssficl_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XA2 @ Xx3 @ Xz) = (ccab @ (^ [Xz:$i] : (cwss @ (ccv @ Xz) @ (XB2 @ Xx3 @ Xy1)))))))) => (! [Xz:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (XA2 @ Xx3 @ Xz))) @ (^ [Xy1:$i] : (XA2 @ Xx3 @ Xz)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xz)))))))).
