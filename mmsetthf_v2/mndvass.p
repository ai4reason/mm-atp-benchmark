...
thf(cmndvass_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_pl = (ccfv @ XM @ ccplusg)) => (((cwcel @ XM @ ccmnd) & (cw3a @ (cwcel @ XX @ (cco @ XB2 @ XI @ ccmap)) @ (cwcel @ XY @ (cco @ XB2 @ XI @ ccmap)) @ (cwcel @ XZ @ (cco @ XB2 @ XI @ ccmap)))) => ((cco @ (cco @ XX @ XY @ (ccof @ Xc_pl)) @ XZ @ (ccof @ Xc_pl)) = (cco @ XX @ (cco @ XY @ XZ @ (ccof @ Xc_pl)) @ (ccof @ Xc_pl)))))))))))))).
