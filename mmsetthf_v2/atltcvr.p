...
thf(aatnlt_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : ((Xc_lt = (ccfv @ XK @ ccplt)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((cw3a @ (cwcel @ XK @ ccal) @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2)) => (~ (cwbr @ XP @ XQ @ Xc_lt))))))))))).
...
thf(catltcvr_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : ((Xc_lt = (ccfv @ XK @ ccplt)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XC = (ccfv @ XK @ cccvr)) => (((cwcel @ XK @ cchlt) & (cw3a @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2) @ (cwcel @ XR @ XA2))) => ((cwbr @ XP @ (cco @ XQ @ XR @ Xc_or) @ Xc_lt) <=> (cwbr @ XP @ (cco @ XQ @ XR @ Xc_or) @ XC)))))))))))))))).
