...
thf(apellex_ax,axiom,(! [XD:($i > $o)] : (((cwcel @ XD @ ccn) & (~ (cwcel @ (ccfv @ XD @ ccsqrt) @ ccq))) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ XD @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccmul) @ ccmin) = cc1)) @ (^ [Xy1:$i] : ccn))) @ (^ [Xx3:$i] : ccn))))).
