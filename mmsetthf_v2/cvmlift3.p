...
thf(acvmlift3lem9_ax,axiom,(! [Xph:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > ($i > $o))))] : (! [XO:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xk:$i] : (! [Xs1:$i] : (! [Xc:$i] : ((XB2 @ Xk @ Xs1 @ Xc) = (ccuni @ XC))))) => ((! [Xk:$i] : (! [Xs1:$i] : (! [Xc:$i] : (! [Xd:$i] : ((XY @ Xk @ Xs1 @ Xc @ Xd) = (ccuni @ (XK @ Xk @ Xs1 @ Xd))))))) => ((! [Xz:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xs1:$i] : (! [Xc:$i] : (! [Xd:$i] : ((Xph @ Xz @ Xg1 @ Xk @ Xs1 @ Xc @ Xd) => (cwcel @ XF @ (cco @ XC @ (XJ @ Xz) @ cccvm))))))))) => ((! [Xz:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xs1:$i] : (! [Xc:$i] : (! [Xd:$i] : ((Xph @ Xz @ Xg1 @ Xk @ Xs1 @ Xc @ Xd) => (cwcel @ (XK @ Xk @ Xs1 @ Xd) @ ccsconn)))))))) => ((! [Xz:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xs1:$i] : (! [Xc:$i] : (! [Xd:$i] : ((Xph @ Xz @ Xg1 @ Xk @ Xs1 @ Xc @ Xd) => (cwcel @ (XK @ Xk @ Xs1 @ Xd) @ (ccnlly @ ccpconn))))))))) => ((! [Xz:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xs1:$i] : (! [Xc:$i] : (! [Xd:$i] : ((Xph @ Xz @ Xg1 @ Xk @ Xs1 @ Xc @ Xd) => (cwcel @ (XO @ Xk @ Xs1 @ Xd) @ (XY @ Xk @ Xs1 @ Xc @ Xd))))))))) => ((! [Xz:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xs1:$i] : (! [Xc:$i] : (! [Xd:$i] : ((Xph @ Xz @ Xg1 @ Xk @ Xs1 @ Xc @ Xd) => (cwcel @ (XG @ Xs1) @ (cco @ (XK @ Xk @ Xs1 @ Xd) @ (XJ @ Xz) @ cccn))))))))) => ((! [Xz:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xs1:$i] : (! [Xc:$i] : (! [Xd:$i] : ((Xph @ Xz @ Xg1 @ Xk @ Xs1 @ Xc @ Xd) => (cwcel @ (XP @ Xk @ Xs1) @ (XB2 @ Xk @ Xs1 @ Xc))))))))) => ((! [Xz:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xs1:$i] : (! [Xc:$i] : (! [Xd:$i] : ((Xph @ Xz @ Xg1 @ Xk @ Xs1 @ Xc @ Xd) => ((ccfv @ (XP @ Xk @ Xs1) @ XF) = (ccfv @ (XO @ Xk @ Xs1 @ Xd) @ (XG @ Xs1)))))))))) => ((! [Xk:$i] : (! [Xs1:$i] : (! [Xc:$i] : (! [Xd:$i] : ((XH @ Xk @ Xs1) = (ccmpt @ (^ [Xx3:$i] : (XY @ Xk @ Xs1 @ Xc @ Xd)) @ (^ [Xx3:$i] : (ccrio @ (^ [Xz:$i] : (cwrex @ (^ [Xf1:$i] : (cw3a @ ((ccfv @ ccc0 @ (ccv @ Xf1)) = (XO @ Xk @ Xs1 @ Xd)) @ ((ccfv @ cc1 @ (ccv @ Xf1)) = (ccv @ Xx3)) @ ((ccfv @ cc1 @ (ccrio @ (^ [Xg1:$i] : (((cccom @ XF @ (ccv @ Xg1)) = (cccom @ (XG @ Xs1) @ (ccv @ Xf1))) & ((ccfv @ ccc0 @ (ccv @ Xg1)) = (XP @ Xk @ Xs1)))) @ (^ [Xg1:$i] : (cco @ ccii @ XC @ cccn)))) = (ccv @ Xz)))) @ (^ [Xf1:$i] : (cco @ ccii @ (XK @ Xk @ Xs1 @ Xd) @ cccn)))) @ (^ [Xz:$i] : (XB2 @ Xk @ Xs1 @ Xc)))))))))) => ((! [Xz:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xs1:$i] : (! [Xc:$i] : (! [Xd:$i] : ((XS @ Xz @ Xg1 @ Xk @ Xs1 @ Xc @ Xd) = (ccmpt @ (^ [Xk:$i] : (XJ @ Xz)) @ (^ [Xk:$i] : (ccrab @ (^ [Xs1:$i] : (((ccuni @ (ccv @ Xs1)) = (ccima @ (cccnv @ XF) @ (ccv @ Xk))) & (cwral @ (^ [Xc:$i] : ((cwral @ (^ [Xd:$i] : ((ccin @ (ccv @ Xc) @ (ccv @ Xd)) = cc0)) @ (^ [Xd:$i] : (ccdif @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xc))))) & (cwcel @ (ccres @ XF @ (ccv @ Xc)) @ (cco @ (cco @ XC @ (ccv @ Xc) @ ccrest) @ (cco @ (XJ @ Xz) @ (ccv @ Xk) @ ccrest) @ cchmeo)))) @ (^ [Xc:$i] : (ccv @ Xs1))))) @ (^ [Xs1:$i] : (ccdif @ (ccpw @ XC) @ (ccsn @ cc0))))))))))))) => (! [Xz:$i] : (! [Xg1:$i] : (! [Xk:$i] : (! [Xs1:$i] : (! [Xc:$i] : (! [Xd:$i] : ((Xph @ Xz @ Xg1 @ Xk @ Xs1 @ Xc @ Xd) => (cwrex @ (^ [Xf1:$i] : (((cccom @ XF @ (ccv @ Xf1)) = (XG @ Xs1)) & ((ccfv @ (XO @ Xk @ Xs1 @ Xd) @ (ccv @ Xf1)) = (XP @ Xk @ Xs1)))) @ (^ [Xf1:$i] : (cco @ (XK @ Xk @ Xs1 @ Xd) @ XC @ cccn)))))))))))))))))))))))))))))))))).
...
thf(anllyss_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ XB2) => (cwss @ (ccnlly @ XA2) @ (ccnlly @ XB2)))))).
...
thf(ccvmlift3_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccuni @ XC)) => ((XY = (ccuni @ XK)) => ((Xph => (cwcel @ XF @ (cco @ XC @ XJ @ cccvm))) => ((Xph => (cwcel @ XK @ ccsconn)) => ((Xph => (cwcel @ XK @ (ccnlly @ ccpconn))) => ((Xph => (cwcel @ XO @ XY)) => ((Xph => (cwcel @ XG @ (cco @ XK @ XJ @ cccn))) => ((Xph => (cwcel @ XP @ XB2)) => ((Xph => ((ccfv @ XP @ XF) = (ccfv @ XO @ XG))) => (Xph => (cwreu @ (^ [Xf1:$i] : (((cccom @ XF @ (ccv @ Xf1)) = XG) & ((ccfv @ XO @ (ccv @ Xf1)) = XP))) @ (^ [Xf1:$i] : (cco @ XK @ XC @ cccn)))))))))))))))))))))))).
