...
thf(cleexp2a_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwbr @ cc1 @ XA2 @ ccle) @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => (cwbr @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccle)))))).
