...
thf(cipfval_conj,conjecture,(! [Xc_x:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((Xc_x = (ccfv @ XW @ ccipf)) => (((cwcel @ XX @ XV) & (cwcel @ XY @ XV)) => ((cco @ XX @ XY @ Xc_x) = (cco @ XX @ XY @ Xc_xi))))))))))))).
