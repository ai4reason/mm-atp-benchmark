...
thf(cswrdccat3b_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XL = (ccfv @ XA2 @ cchash)) => (((cwcel @ XA2 @ (ccword @ XV)) & (cwcel @ XB2 @ (ccword @ XV))) => ((cwcel @ XM @ (cco @ ccc0 @ (cco @ XL @ (ccfv @ XB2 @ cchash) @ ccaddc) @ ccfz)) => ((cco @ (cco @ XA2 @ XB2 @ ccconcat) @ (ccop @ XM @ (cco @ XL @ (ccfv @ XB2 @ cchash) @ ccaddc)) @ ccsubstr) = (ccif @ (cwbr @ XL @ XM @ ccle) @ (cco @ XB2 @ (ccop @ (cco @ XM @ XL @ ccmin) @ (ccfv @ XB2 @ cchash)) @ ccsubstr) @ (cco @ (cco @ XA2 @ (ccop @ XM @ XL) @ ccsubstr) @ XB2 @ ccconcat)))))))))))).
