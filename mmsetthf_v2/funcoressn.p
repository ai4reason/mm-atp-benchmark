...
thf(admressnsn_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ XF)) => ((ccdm @ (ccres @ XF @ (ccsn @ XA2))) = (ccsn @ XA2)))))).
...
thf(afnresfnco_ax,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfn @ (ccres @ XF @ (ccrn @ XG)) @ (ccrn @ XG)) & (cwfn @ XG @ XB2)) => (cwfn @ (cccom @ XF @ XG) @ XB2)))))).
...
thf(cfuncoressn_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ (ccfv @ XX @ XG) @ (ccdm @ XF)) & (cwfun @ (ccres @ XF @ (ccsn @ (ccfv @ XX @ XG))))) & ((cwfn @ XG @ XA2) & (cwcel @ XX @ XA2))) => (cwfun @ (ccres @ (cccom @ XF @ XG) @ (ccsn @ XX))))))))).
