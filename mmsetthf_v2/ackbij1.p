...
thf(aackbij1lem18_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((XF = (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => ((cwcel @ XA2 @ (ccin @ (ccpw @ ccom) @ ccfn)) => (cwrex @ (^ [Xb:$i] : ((ccfv @ (ccv @ Xb) @ XF) = (ccsuc @ (ccfv @ XA2 @ XF)))) @ (^ [Xb:$i] : (ccin @ (ccpw @ ccom) @ ccfn)))))))).
...
thf(cackbij1_conj,conjecture,(! [XF:($i > $o)] : ((XF = (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => (cwf1o @ (ccin @ (ccpw @ ccom) @ ccfn) @ ccom @ XF)))).
