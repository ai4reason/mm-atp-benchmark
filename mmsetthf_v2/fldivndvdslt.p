...
thf(cfldivndvdslt_conj,conjecture,(! [XK:($i > $o)] : (! [XL:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccz) @ ((cwcel @ XL @ ccz) & (cwne @ XL @ ccc0)) @ (~ (cwbr @ XL @ XK @ ccdvds))) => (cwbr @ (ccfv @ (cco @ XK @ XL @ ccdiv) @ ccfl) @ (cco @ XK @ XL @ ccdiv) @ cclt))))).
