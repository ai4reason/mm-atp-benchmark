...
thf(awspthnp_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xf1:$i] : ((cwcel @ XW @ (cco @ (XN @ Xf1) @ XG @ ccwwspthsn)) => (cw3a @ ((cwcel @ (XN @ Xf1) @ ccn0) & (cwcel @ XG @ ccvv)) @ (cwcel @ XW @ (cco @ (XN @ Xf1) @ XG @ ccwwlksn)) @ (? [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XW @ (ccfv @ XG @ ccspths)))))))))).
