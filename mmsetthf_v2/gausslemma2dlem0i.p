...
thf(am1modge3gt1_ax,axiom,(! [XM:($i > $o)] : ((cwcel @ XM @ (ccfv @ cc3 @ ccuz)) => (cwbr @ cc1 @ (cco @ (ccneg @ cc1) @ XM @ ccmo) @ cclt)))).
...
thf(cgausslemma2dlem0i_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XM = (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => ((XH = (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((XN = (cco @ XH @ XM @ ccmin)) => (Xph => (((cco @ (cco @ cc2 @ XP @ cclgs) @ XP @ ccmo) = (cco @ (cco @ (ccneg @ cc1) @ XN @ ccexp) @ XP @ ccmo)) => ((cco @ cc2 @ XP @ cclgs) = (cco @ (ccneg @ cc1) @ XN @ ccexp)))))))))))))).
