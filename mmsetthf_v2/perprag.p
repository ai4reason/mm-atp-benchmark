...
thf(cperprag_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ (cco @ XA2 @ XB2 @ XL))) => ((Xph => (cwcel @ XD @ XP)) => ((Xph => (cwbr @ (cco @ XA2 @ XB2 @ XL) @ (cco @ XC @ XD @ XL) @ (ccfv @ XG @ ccperpg))) => (Xph => (cwcel @ (ccs3 @ XA2 @ XC @ XD) @ (ccfv @ XG @ ccrag)))))))))))))))))))))))).
