...
thf(adf_image_ax,axiom,(! [XA2:($i > $o)] : ((ccimage @ XA2) = (ccdif @ (ccxp @ ccvv @ ccvv) @ (ccrn @ (ccsymdif @ (cctxp @ ccvv @ ccep) @ (cctxp @ (cccom @ ccep @ (cccnv @ XA2)) @ ccvv))))))).
...
thf(cbrimage_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwbr @ XA2 @ XB2 @ (ccimage @ XR)) <=> (XB2 = (ccima @ XR @ XA2))))))))).
