...
thf(agausslemma2dlem0e_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XM = (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => (Xph => (cwbr @ (cco @ XM @ cc2 @ ccmul) @ (cco @ XP @ cc2 @ ccdiv) @ cclt)))))))).
...
thf(cgausslemma2dlem2_conj,conjecture,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xk:$i] : (Xph => (cwcel @ (XP @ Xk) @ (ccdif @ ccprime @ (ccsn @ cc2))))) => ((! [Xk:$i] : (XH = (cco @ (cco @ (XP @ Xk) @ cc1 @ ccmin) @ cc2 @ ccdiv))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XR @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XH @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ (XP @ Xk) @ cc2 @ ccdiv) @ cclt) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ (XP @ Xk) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ ccmin))))))) => ((! [Xk:$i] : ((XM @ Xk) = (ccfv @ (cco @ (XP @ Xk) @ cc4 @ ccdiv) @ ccfl))) => (! [Xx3:$i] : (Xph => (cwral @ (^ [Xk:$i] : ((ccfv @ (ccv @ Xk) @ (XR @ Xx3)) = (cco @ (ccv @ Xk) @ cc2 @ ccmul))) @ (^ [Xk:$i] : (cco @ cc1 @ (XM @ Xk) @ ccfz))))))))))))))).
