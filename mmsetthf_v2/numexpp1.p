...
thf(cnumexpp1_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XM @ ccn0) => (((cco @ XM @ cc1 @ ccaddc) = XN) => (((cco @ (cco @ XA2 @ XM @ ccexp) @ XA2 @ ccmul) = XC) => ((cco @ XA2 @ XN @ ccexp) = XC)))))))))).
