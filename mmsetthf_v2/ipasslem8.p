...
thf(aipasslem5_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XG = (ccfv @ XU @ ccpv)) => ((XS = (ccfv @ XU @ ccns)) => ((XP = (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => ((cwcel @ XB2 @ XX) => (((cwcel @ XC @ ccq) & (cwcel @ XA2 @ XX)) => ((cco @ (cco @ XC @ XA2 @ XS) @ XB2 @ XP) = (cco @ XC @ (cco @ XA2 @ XB2 @ XP) @ ccmul)))))))))))))))))).
...
thf(aipasslem7_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((! [Xw:$i] : ((XG @ Xw) = (ccfv @ XU @ ccpv))) => ((XS = (ccfv @ XU @ ccns)) => ((XP = (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => ((cwcel @ XA2 @ XX) => ((cwcel @ XB2 @ XX) => ((! [Xw:$i] : ((XF @ Xw) = (ccmpt @ (^ [Xw:$i] : ccr) @ (^ [Xw:$i] : (cco @ (cco @ (cco @ (ccv @ Xw) @ XA2 @ XS) @ XB2 @ XP) @ (cco @ (ccv @ Xw) @ (cco @ XA2 @ XB2 @ XP) @ ccmul) @ ccmin))))) => ((! [Xw:$i] : ((XJ @ Xw) = (ccfv @ (ccrn @ ccioo) @ cctg))) => ((XK = (ccfv @ cccnfld @ cctopn)) => (! [Xw:$i] : (cwcel @ (XF @ Xw) @ (cco @ (XJ @ Xw) @ XK @ cccn)))))))))))))))))))))))).
thf(cccld_tp,type,(cccld : ($i > $o))).
thf(adnsconst_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => ((((cwcel @ XK @ cct1) & (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) & (cw3a @ (cwcel @ XP @ XY) @ (cwss @ XA2 @ (ccima @ (cccnv @ XF) @ (ccsn @ XP))) @ ((ccfv @ XA2 @ (ccfv @ XJ @ cccl)) = XX))) => (cwf @ XX @ (ccsn @ XP) @ XF)))))))))))).
