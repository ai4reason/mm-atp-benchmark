...
thf(aobsss_ax,axiom,(! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((cwcel @ XB2 @ (ccfv @ XW @ ccobs)) => (cwss @ XB2 @ XV))))))).
...
thf(aobs2ocv_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_pe = (ccfv @ XW @ ccocv)) => ((XV = (ccfv @ XW @ ccbs)) => ((cwcel @ XB2 @ (ccfv @ XW @ ccobs)) => ((ccfv @ (ccfv @ XB2 @ Xc_pe) @ Xc_pe) = XV))))))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(ccab_tp,type,(ccab : (($i > $o) > ($i > $o)))).
thf(aiscss_ax,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((Xc_pe = (ccfv @ XW @ ccocv)) => ((XC = (ccfv @ XW @ cccss)) => ((cwcel @ XW @ XX) => ((cwcel @ XS @ XC) <=> (XS = (ccfv @ (ccfv @ XS @ Xc_pe) @ Xc_pe)))))))))))).
...
thf(aobselocv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : ((Xc_pe = (ccfv @ XW @ ccocv)) => ((cw3a @ (cwcel @ XB2 @ (ccfv @ XW @ ccobs)) @ (cwss @ XC @ XB2) @ (cwcel @ XA2 @ XB2)) => ((cwcel @ XA2 @ (ccfv @ XC @ Xc_pe)) <=> (~ (cwcel @ XA2 @ XC))))))))))).
thf(ccdr_tp,type,(ccdr : ($i > $o))).
thf(aobsne0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XW @ cc0g)) => (((cwcel @ XB2 @ (ccfv @ XW @ ccobs)) & (cwcel @ XA2 @ XB2)) => (cwne @ XA2 @ Xc_0)))))))).
...
thf(aislbs3_ax,axiom,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XJ = (ccfv @ XW @ cclbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((cwcel @ XW @ cclvec) => ((cwcel @ XB2 @ XJ) <=> (cw3a @ (cwss @ XB2 @ XV) @ ((ccfv @ XB2 @ XN) = XV) @ (! [Xs1:$i] : ((cwpss @ (ccv @ Xs1) @ XB2) => (cwpss @ (ccfv @ (ccv @ Xs1) @ XN) @ XV))))))))))))))).
