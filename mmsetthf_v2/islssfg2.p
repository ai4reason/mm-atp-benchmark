...
thf(cislssfg2_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ XW @ XU @ ccress)) => ((XS = (ccfv @ XW @ cclss)) => ((XN = (ccfv @ XW @ cclspn)) => ((! [Xb:$i] : ((XB2 @ Xb) = (ccfv @ XW @ ccbs))) => (((cwcel @ XW @ cclmod) & (cwcel @ XU @ XS)) => ((cwcel @ XX @ cclfig) <=> (cwrex @ (^ [Xb:$i] : ((ccfv @ (ccv @ Xb) @ XN) = XU)) @ (^ [Xb:$i] : (ccin @ (ccpw @ (XB2 @ Xb)) @ ccfn)))))))))))))))).
