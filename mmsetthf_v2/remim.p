...
thf(acjval_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ cccj) = (ccrio @ (^ [Xx3:$i] : ((cwcel @ (cco @ XA2 @ (ccv @ Xx3) @ ccaddc) @ ccr) & (cwcel @ (cco @ cci @ (cco @ XA2 @ (ccv @ Xx3) @ ccmin) @ ccmul) @ ccr))) @ (^ [Xx3:$i] : ccc)))))).
...
thf(acju_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwreu @ (^ [Xx3:$i] : ((cwcel @ (cco @ XA2 @ (ccv @ Xx3) @ ccaddc) @ ccr) & (cwcel @ (cco @ cci @ (cco @ XA2 @ (ccv @ Xx3) @ ccmin) @ ccmul) @ ccr))) @ (^ [Xx3:$i] : ccc))))).
...
thf(cremim_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ cccj) = (cco @ (ccfv @ XA2 @ ccre) @ (cco @ cci @ (ccfv @ XA2 @ ccim) @ ccmul) @ ccmin))))).
