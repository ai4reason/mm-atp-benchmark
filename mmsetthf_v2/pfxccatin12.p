...
thf(aelfz0fzfz0_ax,axiom,(! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XM @ (cco @ ccc0 @ XL @ ccfz)) & (cwcel @ XN @ (cco @ XL @ XX @ ccfz))) => (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz)))))))).
...
thf(aswrdvalfn_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XS @ (ccword @ XV)) @ (cwcel @ XF @ (cco @ ccc0 @ XL @ ccfz)) @ (cwcel @ XL @ (cco @ ccc0 @ (ccfv @ XS @ cchash) @ ccfz))) => (cwfn @ (cco @ XS @ (ccop @ XF @ XL) @ ccsubstr) @ (cco @ ccc0 @ (cco @ XL @ XF @ ccmin) @ ccfzo)))))))).
...
thf(accatvalfn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ (ccword @ XV)) & (cwcel @ XB2 @ (ccword @ XV))) => (cwfn @ (cco @ XA2 @ XB2 @ ccconcat) @ (cco @ ccc0 @ (cco @ (ccfv @ XA2 @ cchash) @ (ccfv @ XB2 @ cchash) @ ccaddc) @ ccfzo))))))).
...
thf(aelfzmlbp_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XK @ (cco @ XM @ (cco @ XM @ XN @ ccaddc) @ ccfz))) => (cwcel @ (cco @ XK @ XM @ ccmin) @ (cco @ ccc0 @ XN @ ccfz))))))).
...
thf(anpncan3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) => ((cco @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XA2 @ ccmin) @ ccaddc) = (cco @ XC @ XB2 @ ccmin))))))).
...
thf(aswrdccatin12lem1_ax,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XL @ ccn0) @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccz)) => (((cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfzo)) & (~ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XL @ XM @ ccmin) @ ccfzo)))) => (cwcel @ XK @ (cco @ (cco @ XL @ XM @ ccmin) @ (cco @ (cco @ XL @ XM @ ccmin) @ (cco @ XN @ XL @ ccmin) @ ccaddc) @ ccfzo))))))))).
