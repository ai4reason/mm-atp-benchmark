...
thf(ascottex_ax,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwss @ (ccfv @ (ccv @ Xx3) @ ccrnk) @ (ccfv @ (ccv @ Xy1) @ ccrnk))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ ccvv))).
thf(ckardex_conj,conjecture,(! [XA2:($i > $o)] : (cwcel @ (ccab @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ XA2 @ ccen) & (! [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ XA2 @ ccen) => (cwss @ (ccfv @ (ccv @ Xx3) @ ccrnk) @ (ccfv @ (ccv @ Xy1) @ ccrnk))))))) @ ccvv))).
