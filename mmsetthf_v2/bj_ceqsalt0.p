...
thf(aimim3i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps => Xch)) => ((Xth => Xph) => ((Xth => Xps) => (Xth => Xch))))))))).
thf(abiimp_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph <=> Xps) => (Xph => Xps))))).
thf(a_3ad2ant1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xch) => ((cw3a @ Xph @ Xps @ Xth) => Xch))))))).
thf(a_19_23t_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xx3:$i] : ((cwnf @ (^ [Xx3:$i] : (Xps @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (Xps @ Xx3))) <=> ((? [Xx3:$i] : (Xph @ Xx3)) => (Xps @ Xx3)))))))).
...
thf(cbj_ceqsalt0_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xth:($i > $o)] : (! [Xx3:$i] : ((cw3a @ (cwnf @ (^ [Xx3:$i] : (Xps @ Xx3))) @ (! [Xx3:$i] : ((Xth @ Xx3) => ((Xph @ Xx3) <=> (Xps @ Xx3)))) @ (? [Xx3:$i] : (Xth @ Xx3))) => ((! [Xx3:$i] : ((Xth @ Xx3) => (Xph @ Xx3))) <=> (Xps @ Xx3)))))))).
