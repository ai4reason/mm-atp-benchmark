...
thf(ametnrmlem2_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ XD @ ccmopn))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XD @ (ccfv @ XX @ ccxmt))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XS @ (ccfv @ (XJ @ Xx3) @ cccld))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XT @ (ccfv @ (XJ @ Xx3) @ cccld))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => ((ccin @ XS @ XT) = cc0)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : ((XU @ Xx3 @ Xy1 @ Xt) = (cciun @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccv @ Xt) @ (cco @ (ccif @ (cwbr @ cc1 @ (ccfv @ (ccv @ Xt) @ (XF @ Xx3 @ Xy1)) @ ccle) @ cc1 @ (ccfv @ (ccv @ Xt) @ (XF @ Xx3 @ Xy1))) @ cc2 @ ccdiv) @ (ccfv @ XD @ ccbl)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xt:$i] : ((Xph @ Xx3 @ Xy1) => ((cwcel @ (XU @ Xx3 @ Xy1 @ Xt) @ (XJ @ Xx3)) & (cwss @ XT @ (XU @ Xx3 @ Xy1 @ Xt))))))))))))))))))))))).
...
thf(ametnrmlem1a_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ XD @ ccmopn))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XD @ (ccfv @ XX @ ccxmt))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XS @ (ccfv @ (XJ @ Xx3) @ cccld))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XT @ (ccfv @ (XJ @ Xx3) @ cccld))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => ((ccin @ XS @ XT) = cc0)))) => (! [Xx3:$i] : (! [Xy1:$i] : (((Xph @ Xx3 @ Xy1) & (cwcel @ XA2 @ XT)) => ((cwbr @ ccc0 @ (ccfv @ XA2 @ (XF @ Xx3 @ Xy1)) @ cclt) & (cwcel @ (ccif @ (cwbr @ cc1 @ (ccfv @ XA2 @ (XF @ Xx3 @ Xy1)) @ ccle) @ cc1 @ (ccfv @ XA2 @ (XF @ Xx3 @ Xy1))) @ ccrp)))))))))))))))))))).
...
thf(ametnrmlem1_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ XD @ ccmopn))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XD @ (ccfv @ XX @ ccxmt))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XS @ (ccfv @ (XJ @ Xx3) @ cccld))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XT @ (ccfv @ (XJ @ Xx3) @ cccld))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => ((ccin @ XS @ XT) = cc0)))) => (! [Xx3:$i] : (! [Xy1:$i] : (((Xph @ Xx3 @ Xy1) & ((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XT))) => (cwbr @ (ccif @ (cwbr @ cc1 @ (ccfv @ XB2 @ (XF @ Xx3 @ Xy1)) @ ccle) @ cc1 @ (ccfv @ XB2 @ (XF @ Xx3 @ Xy1))) @ (cco @ XA2 @ XB2 @ XD) @ ccle)))))))))))))))))))).
...
thf(axle2add_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & ((cwcel @ XC @ ccxr) & (cwcel @ XD @ ccxr))) => (((cwbr @ XA2 @ XC @ ccle) & (cwbr @ XB2 @ XD @ ccle)) => (cwbr @ (cco @ XA2 @ XB2 @ ccxad) @ (cco @ XC @ XD @ ccxad) @ ccle)))))))).
...
thf(ax2times_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccxr) => ((cco @ cc2 @ XA2 @ ccxmu) = (cco @ XA2 @ XA2 @ ccxad))))).
thf(arexrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => (cwcel @ XA2 @ ccxr)))))).
thf(a_2rp_ax,axiom,(cwcel @ cc2 @ ccrp)).
thf(axlemul2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccrp)) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwbr @ (cco @ XC @ XA2 @ ccxmu) @ (cco @ XC @ XB2 @ ccxmu) @ ccle))))))).
thf(abldisj_ax,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX) @ (cwcel @ XQ @ XX)) & (cw3a @ (cwcel @ XR @ ccxr) @ (cwcel @ XS @ ccxr) @ (cwbr @ (cco @ XR @ XS @ ccxad) @ (cco @ XP @ XQ @ XD) @ ccle))) => ((ccin @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (cco @ XQ @ XS @ (ccfv @ XD @ ccbl))) = cc0))))))))).
...
thf(cmetnrmlem3_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XJ:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ XD @ ccmopn))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) => (cwcel @ XD @ (ccfv @ XX @ ccxmt))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) => (cwcel @ XS @ (ccfv @ (XJ @ Xx3) @ cccld))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) => (cwcel @ XT @ (ccfv @ (XJ @ Xx3) @ cccld))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) => ((ccin @ XS @ XT) = cc0)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xt:$i] : ((XU @ Xx3 @ Xy1 @ Xz @ Xt) = (cciun @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccv @ Xt) @ (cco @ (ccif @ (cwbr @ cc1 @ (ccfv @ (ccv @ Xt) @ (XF @ Xx3 @ Xy1)) @ ccle) @ cc1 @ (ccfv @ (ccv @ Xt) @ (XF @ Xx3 @ Xy1))) @ cc2 @ ccdiv) @ (ccfv @ XD @ ccbl))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XG @ Xx3 @ Xy1 @ Xz @ Xw) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XT) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xs1:$i] : ((XV @ Xx3 @ Xy1 @ Xt @ Xs1) = (cciun @ (^ [Xs1:$i] : XS) @ (^ [Xs1:$i] : (cco @ (ccv @ Xs1) @ (cco @ (ccif @ (cwbr @ cc1 @ (ccfv @ (ccv @ Xs1) @ (XG @ Xx3 @ Xy1 @ Xz @ Xw)) @ ccle) @ cc1 @ (ccfv @ (ccv @ Xs1) @ (XG @ Xx3 @ Xy1 @ Xz @ Xw))) @ cc2 @ ccdiv) @ (ccfv @ XD @ ccbl))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) => (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cw3a @ (cwss @ XS @ (ccv @ Xz)) @ (cwss @ XT @ (ccv @ Xw)) @ ((ccin @ (ccv @ Xz) @ (ccv @ Xw)) = cc0))) @ (^ [Xw:$i] : (XJ @ Xx3)))) @ (^ [Xz:$i] : (XJ @ Xx3)))))))))))))))))))))))))))).
