...
thf(admmpt2ssx2_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xy1))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwss @ (ccdm @ (XF @ Xx3 @ Xy1)) @ (cciun @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (ccxp @ (XA2 @ Xy1) @ (ccsn @ (ccv @ Xy1)))))))))))))).
