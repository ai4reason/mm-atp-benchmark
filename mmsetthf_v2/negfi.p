...
thf(afundmfibi_ax,axiom,(! [XF:($i > $o)] : ((cwfun @ XF) => ((cwcel @ XF @ ccfn) <=> (cwcel @ (ccdm @ XF) @ ccfn))))).
...
thf(anegf1o_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xn:$i] : ((XF @ Xx3 @ Xn) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccneg @ (ccv @ Xx3))))))) => (! [Xx3:$i] : (! [Xn:$i] : ((cwss @ XA2 @ ccr) => (cwf1o @ XA2 @ (ccrab @ (^ [Xn:$i] : (cwcel @ (ccneg @ (ccv @ Xn)) @ XA2)) @ (^ [Xn:$i] : ccr)) @ (XF @ Xx3 @ Xn))))))))).
