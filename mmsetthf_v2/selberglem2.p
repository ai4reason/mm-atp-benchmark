...
thf(alogexprlim_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => (cwbr @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ cclog) @ XN @ ccexp))) @ (ccv @ Xx3) @ ccdiv))) @ (ccfv @ XN @ ccfa) @ ccrli)))).
...
thf(alog2sumbnd_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwbr @ cc1 @ XA2 @ ccle)) => (cwbr @ (ccfv @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ cclog) @ cc2 @ ccexp))) @ (cco @ XA2 @ (cco @ (cco @ (ccfv @ XA2 @ cclog) @ cc2 @ ccexp) @ (cco @ cc2 @ (cco @ cc2 @ (ccfv @ XA2 @ cclog) @ ccmul) @ ccmin) @ ccaddc) @ ccmul) @ ccmin) @ ccabs) @ (cco @ (cco @ (ccfv @ XA2 @ cclog) @ cc2 @ ccexp) @ cc2 @ ccaddc) @ ccle)))).
