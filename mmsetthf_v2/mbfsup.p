...
thf(aismbf3d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (Xph => (cwf @ (XA2 @ Xx3) @ ccr @ XF))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwcel @ (ccima @ (cccnv @ XF) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccioo)) @ (ccdm @ ccvol)))) => (Xph => (cwcel @ XF @ ccmbf)))))))).
