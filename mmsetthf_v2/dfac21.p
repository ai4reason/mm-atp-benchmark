...
thf(akelac2_ax,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwcel @ (XS @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwne @ (XS @ Xx3) @ cc0))) => ((Xph => (cwcel @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (ccfv @ (ccpr @ (XS @ Xx3) @ (ccsn @ (ccpw @ (ccuni @ (XS @ Xx3))))) @ cctg))) @ ccpt) @ cccmp)) => (Xph => (cwne @ (ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XS @ Xx3))) @ cc0)))))))))).
...
thf(adfac9_ax,axiom,(cwac <=> (! [Xf1:$i] : (((cwfun @ (ccv @ Xf1)) & (cwnel @ cc0 @ (ccrn @ (ccv @ Xf1)))) => (cwne @ (ccixp @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xf1))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)))) @ cc0))))).
