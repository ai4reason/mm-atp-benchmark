...
thf(arrnval_ax,axiom,(! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ ccr @ XI @ ccmap)) => ((cwcel @ XI @ ccfn) => ((ccfv @ XI @ ccrrn) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccsu @ XI @ (^ [Xk:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xy1)) @ ccmin) @ cc2 @ ccexp))) @ ccsqrt)))))))))).
...
thf(crrnmval_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ ccr @ XI @ ccmap)) => ((cw3a @ (cwcel @ XI @ ccfn) @ (cwcel @ XF @ XX) @ (cwcel @ XG @ XX)) => ((cco @ XF @ XG @ (ccfv @ XI @ ccrrn)) = (ccfv @ (ccsu @ XI @ (^ [Xk:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xk) @ XG) @ ccmin) @ cc2 @ ccexp))) @ ccsqrt))))))))).
