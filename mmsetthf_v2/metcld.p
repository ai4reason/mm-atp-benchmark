...
thf(ametelcls_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((XJ = (ccfv @ XD @ ccmopn)) => ((! [Xf1:$i] : (Xph => (cwcel @ XD @ (ccfv @ (XX @ Xf1) @ ccxmt)))) => ((! [Xf1:$i] : (Xph => (cwss @ XS @ (XX @ Xf1)))) => (Xph => ((cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cccl))) <=> (? [Xf1:$i] : ((cwf @ ccn @ XS @ (ccv @ Xf1)) & (cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XJ @ cclm)))))))))))))))).
