...
thf(af1dmvrnfibi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwf1 @ XA2 @ XB2 @ XF)) => ((cwcel @ XF @ ccfn) <=> (cwcel @ (ccrn @ XF) @ ccfn)))))))).
thf(cf1vrnfibi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XF @ XV) & (cwf1 @ XA2 @ XB2 @ XF)) => ((cwcel @ XF @ ccfn) <=> (cwcel @ (ccrn @ XF) @ ccfn)))))))).
