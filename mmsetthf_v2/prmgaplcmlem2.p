...
thf(aprmgaplcmlem1_ax,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XI @ (cco @ cc2 @ XN @ ccfz))) => (cwbr @ XI @ (cco @ (ccfv @ (cco @ cc1 @ XN @ ccfz) @ cclcmf) @ XI @ ccaddc) @ ccdvds))))).
...
thf(ancoprmgcdgt1b_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn)) => ((cwrex @ (^ [Xi:$i] : ((cwbr @ (ccv @ Xi) @ XA2 @ ccdvds) & (cwbr @ (ccv @ Xi) @ XB2 @ ccdvds))) @ (^ [Xi:$i] : (ccfv @ cc2 @ ccuz))) <=> (cwbr @ cc1 @ (cco @ XA2 @ XB2 @ ccgcd) @ cclt)))))).
thf(cprmgaplcmlem2_conj,conjecture,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XI @ (cco @ cc2 @ XN @ ccfz))) => (cwbr @ cc1 @ (cco @ (cco @ (ccfv @ (cco @ cc1 @ XN @ ccfz) @ cclcmf) @ XI @ ccaddc) @ XI @ ccgcd) @ cclt))))).
