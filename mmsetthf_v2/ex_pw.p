...
thf(apwtp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccpw @ (cctp @ XA2 @ XB2 @ XC)) = (ccun @ (ccun @ (ccpr @ cc0 @ (ccsn @ XA2)) @ (ccpr @ (ccsn @ XB2) @ (ccpr @ XA2 @ XB2))) @ (ccun @ (ccpr @ (ccsn @ XC) @ (ccpr @ XA2 @ XC)) @ (ccpr @ (ccpr @ XB2 @ XC) @ (cctp @ XA2 @ XB2 @ XC))))))))).
...
thf(aun4_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((ccun @ (ccun @ XA2 @ XB2) @ (ccun @ XC @ XD)) = (ccun @ (ccun @ XA2 @ XC) @ (ccun @ XB2 @ XD)))))))).
