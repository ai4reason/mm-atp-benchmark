...
thf(ctendoicbv_conj,conjecture,(! [XT:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xu:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xs1:$i] : ((XI @ Xu @ Xf1 @ Xg1 @ Xs1) = (ccmpt @ (^ [Xs1:$i] : (XE @ Xf1 @ Xg1)) @ (^ [Xs1:$i] : (ccmpt @ (^ [Xf1:$i] : XT) @ (^ [Xf1:$i] : (cccnv @ (ccfv @ (ccv @ Xf1) @ (ccv @ Xs1)))))))))))) => (! [Xu:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xs1:$i] : ((XI @ Xu @ Xf1 @ Xg1 @ Xs1) = (ccmpt @ (^ [Xu:$i] : (XE @ Xf1 @ Xg1)) @ (^ [Xu:$i] : (ccmpt @ (^ [Xg1:$i] : XT) @ (^ [Xg1:$i] : (cccnv @ (ccfv @ (ccv @ Xg1) @ (ccv @ Xu))))))))))))))))).
