...
thf(ausgrres1_ax,axiom,(! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : ((XF @ Xe) = (ccrab @ (^ [Xe:$i] : (cwnel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)))) => ((! [Xe:$i] : ((XS @ Xe) = (ccop @ (ccdif @ XV @ (ccsn @ XN)) @ (ccres @ ccid @ (XF @ Xe))))) => (! [Xe:$i] : (((cwcel @ XG @ ccusgr) & (cwcel @ XN @ XV)) => (cwcel @ (XS @ Xe) @ ccusgr)))))))))))))).
...
thf(afusgrfisbase_ax,axiom,(! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ ((cwcel @ XV @ XX) & (cwcel @ XE @ XY)) @ (cwcel @ (ccop @ XV @ XE) @ ccusgr) @ ((ccfv @ XV @ cchash) = ccc0)) => (cwcel @ XE @ ccfn))))))).
...
thf(aopfusgr_ax,axiom,(! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XV @ XX) & (cwcel @ XE @ XY)) => ((cwcel @ (ccop @ XV @ XE) @ ccfusgr) <=> ((cwcel @ (ccop @ XV @ XE) @ ccusgr) & (cwcel @ XV @ ccfn))))))))).
thf(asimprr3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xta & (Xth & (cw3a @ Xph @ Xps @ Xch))) => Xch))))))).
thf(afusgrfisstep_ax,axiom,(! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [Xp:$i] : ((cw3a @ ((cwcel @ XV @ (XX @ Xp)) & (cwcel @ XE @ (XY @ Xp))) @ (cwcel @ (ccop @ XV @ XE) @ ccfusgr) @ (cwcel @ XN @ XV)) => ((cwcel @ (ccres @ ccid @ (ccrab @ (^ [Xp:$i] : (cwnel @ XN @ (ccv @ Xp))) @ (^ [Xp:$i] : (ccfv @ (ccop @ XV @ XE) @ ccedg)))) @ ccfn) => (cwcel @ XE @ ccfn)))))))))).
thf(ausgredgffibi_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => ((XE = (ccfv @ XG @ ccedg)) => ((cwcel @ XG @ ccusgr) => ((cwcel @ XE @ ccfn) <=> (cwcel @ XI @ ccfn))))))))).
