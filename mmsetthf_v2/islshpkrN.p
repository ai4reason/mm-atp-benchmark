...
thf(cislshpkrN_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XV = (ccfv @ XW @ ccbs)) => ((! [Xg1:$i] : ((XD @ Xg1) = (ccfv @ XW @ ccsca))) => ((! [Xg1:$i] : ((Xc_0 @ Xg1) = (ccfv @ (XD @ Xg1) @ cc0g))) => ((XH = (ccfv @ XW @ cclsh)) => ((XF = (ccfv @ XW @ cclfn)) => ((XK = (ccfv @ XW @ cclk)) => ((cwcel @ XW @ cclvec) => ((cwcel @ XU @ XH) <=> (cwrex @ (^ [Xg1:$i] : ((cwne @ (ccv @ Xg1) @ (ccxp @ XV @ (ccsn @ (Xc_0 @ Xg1)))) & (XU = (ccfv @ (ccv @ Xg1) @ XK)))) @ (^ [Xg1:$i] : XF))))))))))))))))))).
