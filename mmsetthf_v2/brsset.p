...
thf(arelsset_ax,axiom,(cwrel @ ccsset)).
...
thf(adf_sset_ax,axiom,(ccsset = (ccdif @ (ccxp @ ccvv @ ccvv) @ (ccrn @ (cctxp @ ccep @ (ccdif @ ccvv @ ccep)))))).
...
thf(cbrsset_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwbr @ XA2 @ XB2 @ ccsset) <=> (cwss @ XA2 @ XB2)))))).
