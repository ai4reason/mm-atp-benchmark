...
thf(cpell1qrval_conj,conjecture,(! [XD:($i > $o)] : ((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) => ((ccfv @ XD @ ccpell1qr) = (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (((ccv @ Xy1) = (cco @ (ccv @ Xz) @ (cco @ (ccfv @ XD @ ccsqrt) @ (ccv @ Xw) @ ccmul) @ ccaddc)) & ((cco @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ (cco @ XD @ (cco @ (ccv @ Xw) @ cc2 @ ccexp) @ ccmul) @ ccmin) = cc1))) @ (^ [Xw:$i] : ccn0))) @ (^ [Xz:$i] : ccn0))) @ (^ [Xy1:$i] : ccr)))))).
