...
thf(coddcomabszz_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccz)) => (cwcel @ (XA2 @ Xx3) @ ccr))) => ((! [Xx3:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ ccz) @ (cwbr @ ccc0 @ (ccv @ Xx3) @ ccle)) => (cwbr @ ccc0 @ (XA2 @ Xx3) @ ccle))) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ ccz)) => ((XC @ Xy1) = (ccneg @ (XB2 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((XA2 @ Xx3) = (XB2 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccneg @ (ccv @ Xy1))) => ((XA2 @ Xx3) = (XC @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XD) => ((XA2 @ Xx3) = (XE @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccfv @ XD @ ccabs)) => ((XA2 @ Xx3) = (XF @ Xy1))))) => (! [Xy1:$i] : ((Xph & (cwcel @ XD @ ccz)) => ((ccfv @ (XE @ Xy1) @ ccabs) = (XF @ Xy1))))))))))))))))))).
