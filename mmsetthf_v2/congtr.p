...
thf(ccongtr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cw3a @ ((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) @ ((cwcel @ XC @ ccz) & (cwcel @ XD @ ccz)) @ ((cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccdvds) & (cwbr @ XA2 @ (cco @ XC @ XD @ ccmin) @ ccdvds))) => (cwbr @ XA2 @ (cco @ XB2 @ XD @ ccmin) @ ccdvds))))))).
