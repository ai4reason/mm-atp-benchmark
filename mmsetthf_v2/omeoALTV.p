...
thf(aenege_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ cceven) => (cwcel @ (ccneg @ XA2) @ cceven)))).
thf(ccmul_tp,type,(ccmul : ($i > $o))).
thf(ccv_tp,type,(ccv : ($i > ($i > $o)))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(aopeoALTV_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccodd) & (cwcel @ XB2 @ cceven)) => (cwcel @ (cco @ XA2 @ XB2 @ ccaddc) @ ccodd))))).
