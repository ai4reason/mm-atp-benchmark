...
thf(cpellfund14gap_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((cw3a @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) @ ((cwbr @ cc1 @ XA2 @ ccle) & (cwbr @ XA2 @ (ccfv @ XD @ ccpellfund) @ cclt))) => (XA2 = cc1))))).
