...
thf(cpjo_conj,conjecture,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : (((cwcel @ XH @ ccch) & (cwcel @ XA2 @ cchil)) => ((ccfv @ XA2 @ (ccfv @ (ccfv @ XH @ ccort) @ ccpjh)) = (cco @ (ccfv @ XA2 @ (ccfv @ cchil @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccmv)))))).
