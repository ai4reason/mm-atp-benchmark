...
thf(arankuni_ax,axiom,(! [XA2:($i > $o)] : ((ccfv @ (ccuni @ XA2) @ ccrnk) = (ccuni @ (ccfv @ XA2 @ ccrnk))))).
...
thf(aorduniss_ax,axiom,(! [XA2:($i > $o)] : ((cword @ XA2) => (cwss @ (ccuni @ XA2) @ XA2)))).
...
thf(auniwf_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) <=> (cwcel @ (ccuni @ XA2) @ (ccuni @ (ccima @ ccr1 @ ccon0)))))).
...
thf(ar1pwcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwlim @ XB2) => ((cwcel @ XA2 @ (ccfv @ XB2 @ ccr1)) <=> (cwcel @ (ccpw @ XA2) @ (ccfv @ XB2 @ ccr1))))))).
thf(aeqeltrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (cwcel @ XB2 @ XC)) => (Xph => (cwcel @ XA2 @ XC))))))))).
thf(aad2antlr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => (((Xch & Xph) & Xth) => Xps))))))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(arankprb_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) & (cwcel @ XB2 @ (ccuni @ (ccima @ ccr1 @ ccon0)))) => ((ccfv @ (ccpr @ XA2 @ XB2) @ ccrnk) = (ccsuc @ (ccun @ (ccfv @ XA2 @ ccrnk) @ (ccfv @ XB2 @ ccrnk)))))))).
...
thf(aprwf_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) & (cwcel @ XB2 @ (ccuni @ (ccima @ ccr1 @ ccon0)))) => (cwcel @ (ccpr @ XA2 @ XB2) @ (ccuni @ (ccima @ ccr1 @ ccon0))))))).
...
thf(cr1limwun_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwlim @ XA2)) => (cwcel @ (ccfv @ XA2 @ ccr1) @ ccwun))))).
