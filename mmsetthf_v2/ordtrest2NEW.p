...
thf(aposprs_ax,axiom,(! [XK:($i > $o)] : ((cwcel @ XK @ ccpo) => (cwcel @ XK @ ccpreset)))).
thf(aordtrestNEW_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2))) => (((cwcel @ XK @ ccpreset) & (cwss @ XA2 @ XB2)) => (cwss @ (ccfv @ (ccin @ Xc_le @ (ccxp @ XA2 @ XA2)) @ ccordt) @ (cco @ (ccfv @ Xc_le @ ccordt) @ XA2 @ ccrest)))))))))).
...
thf(aprsssdm_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2))) => (((cwcel @ XK @ ccpreset) & (cwss @ XA2 @ XB2)) => ((ccdm @ (ccin @ Xc_le @ (ccxp @ XA2 @ XA2))) = XA2))))))))).
...
thf(aodutos_ax,axiom,(! [XD:($i > $o)] : (! [XK:($i > $o)] : ((XD = (ccfv @ XK @ ccodu)) => ((cwcel @ XK @ cctos) => (cwcel @ XD @ cctos)))))).
...
thf(aordtcnvNEW_ax,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2))) => ((cwcel @ XK @ ccpreset) => ((ccfv @ (cccnv @ Xc_le) @ ccordt) = (ccfv @ Xc_le @ ccordt))))))))).
