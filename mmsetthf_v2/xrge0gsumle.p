...
thf(cxrge0gsumle_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XG = (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((Xph => (cwcel @ XB2 @ (ccin @ (ccpw @ XA2) @ ccfn))) => ((Xph => (cwss @ XC @ XB2)) => (Xph => (cwbr @ (cco @ XG @ (ccres @ XF @ XC) @ ccgsu) @ (cco @ XG @ (ccres @ XF @ XB2) @ ccgsu) @ ccle))))))))))))))).
