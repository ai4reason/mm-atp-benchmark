...
thf(acshword_ax,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ ccz)) => ((cco @ XW @ XN @ cccsh) = (cco @ (cco @ XW @ (ccop @ (cco @ XN @ (ccfv @ XW @ cchash) @ ccmo) @ (ccfv @ XW @ cchash)) @ ccsubstr) @ (cco @ XW @ (ccop @ ccc0 @ (cco @ XN @ (ccfv @ XW @ cchash) @ ccmo)) @ ccsubstr) @ ccconcat))))))).
...
thf(acshnz_ax,axiom,(! [XN:($i > $o)] : (! [XW:($i > $o)] : ((~ (cwcel @ XN @ ccz)) => ((cco @ XW @ XN @ cccsh) = cc0))))).
thf(awrd0_ax,axiom,(! [XS:($i > $o)] : (cwcel @ cc0 @ (ccword @ XS)))).
thf(ccshwcl_conj,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ (ccword @ XV)) => (cwcel @ (cco @ XW @ XN @ cccsh) @ (ccword @ XV))))))).
