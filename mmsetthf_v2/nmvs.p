...
thf(cnmvs_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ ccnm)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((XA2 = (ccfv @ XF @ ccnm)) => ((cw3a @ (cwcel @ XW @ ccnlm) @ (cwcel @ XX @ XK) @ (cwcel @ XY @ XV)) => ((ccfv @ (cco @ XX @ XY @ Xc_x) @ XN) = (cco @ (ccfv @ XX @ XA2) @ (ccfv @ XY @ XN) @ ccmul))))))))))))))))))).
