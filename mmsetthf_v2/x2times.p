...
thf(axadddi2r_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ ((cwcel @ XA2 @ ccxr) & (cwbr @ ccc0 @ XA2 @ ccle)) @ ((cwcel @ XB2 @ ccxr) & (cwbr @ ccc0 @ XB2 @ ccle)) @ (cwcel @ XC @ ccxr)) => ((cco @ (cco @ XA2 @ XB2 @ ccxad) @ XC @ ccxmu) = (cco @ (cco @ XA2 @ XC @ ccxmu) @ (cco @ XB2 @ XC @ ccxmu) @ ccxad))))))).
thf(aoveq12d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XD @ XF)))))))))))).
thf(axmulid2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccxr) => ((cco @ cc1 @ XA2 @ ccxmu) = XA2)))).
thf(cx2times_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccxr) => ((cco @ cc2 @ XA2 @ ccxmu) = (cco @ XA2 @ XA2 @ ccxad))))).
