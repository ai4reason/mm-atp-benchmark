...
thf(awwlksn_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cco @ XN @ XG @ ccwwlksn) = (ccrab @ (^ [Xw:$i] : ((ccfv @ (ccv @ Xw) @ cchash) = (cco @ XN @ cc1 @ ccaddc))) @ (^ [Xw:$i] : (ccfv @ XG @ ccwwlks)))))))).
...
thf(awrdnfi_ax,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XV @ ccfn) & (cwcel @ XN @ ccn0)) => (cwcel @ (ccrab @ (^ [Xw:$i] : ((ccfv @ (ccv @ Xw) @ cchash) = XN)) @ (^ [Xw:$i] : (ccword @ XV))) @ ccfn))))).
...
thf(awwlksnndef_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (((cwnel @ XG @ ccvv) | (cwnel @ XN @ ccn0)) => ((cco @ XN @ XG @ ccwwlksn) = cc0))))).
...
thf(cwwlksnfi_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ (ccfv @ XG @ ccvtx) @ ccfn) => (cwcel @ (cco @ XN @ XG @ ccwwlksn) @ ccfn))))).
