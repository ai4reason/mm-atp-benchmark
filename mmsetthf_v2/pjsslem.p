...
thf(apjo_ax,axiom,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : (((cwcel @ XH @ ccch) & (cwcel @ XA2 @ cchil)) => ((ccfv @ XA2 @ (ccfv @ (ccfv @ XH @ ccort) @ ccpjh)) = (cco @ (ccfv @ XA2 @ (ccfv @ cchil @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccmv)))))).
...
thf(ahv2negi_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cco @ cc0v @ XA2 @ ccmv) = (cco @ (ccneg @ cc1) @ XA2 @ ccsm))))).
...
thf(cpjsslem_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => ((cwcel @ XG @ ccch) => ((cco @ (ccfv @ XA2 @ (ccfv @ (ccfv @ XH @ ccort) @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ (ccfv @ XG @ ccort) @ ccpjh)) @ ccmv) = (cco @ (ccfv @ XA2 @ (ccfv @ XG @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccmv))))))))).
