...
thf(afzonlt0_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((~ (cwbr @ XM @ XN @ cclt)) <=> ((cco @ XM @ XN @ ccfzo) = cc0)))))).
...
thf(afzo0n_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwbr @ XN @ XM @ ccle) <=> ((cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfzo) = cc0)))))).
