...
thf(anbgrcl_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XN @ (cco @ XG @ XX @ ccnbgr)) => (cwcel @ XX @ XV)))))))).
...
thf(cnbgrel_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((cwcel @ XN @ (cco @ XG @ XX @ ccnbgr)) <=> (cw3a @ ((cwcel @ XN @ XV) & (cwcel @ XX @ XV)) @ (cwne @ XN @ XX) @ (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ XX @ XN) @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)))))))))))).
