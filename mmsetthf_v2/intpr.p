...
thf(aclel4_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XA2 @ XB2) <=> (! [Xx3:$i] : (((ccv @ Xx3) = XB2) => (cwcel @ XA2 @ (ccv @ Xx3))))))))).
thf(aelint_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XA2 @ (ccint @ XB2)) <=> (! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XB2) => (cwcel @ XA2 @ (ccv @ Xx3))))))))).
thf(aelin_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccin @ XB2 @ XC)) <=> ((cwcel @ XA2 @ XB2) & (cwcel @ XA2 @ XC))))))).
thf(cintpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((ccint @ (ccpr @ XA2 @ XB2)) = (ccin @ XA2 @ XB2))))))).
