...
thf(adrnginvrr_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((XI = (ccfv @ XR @ ccinvr)) => ((cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XX @ XB2) @ (cwne @ XX @ Xc_0)) => ((cco @ XX @ (ccfv @ XX @ XI) @ Xc_x) = Xc_1))))))))))))))).
...
thf(ctendorinv_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XO:($i > ($i > $o))] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xh:$i] : ((XE @ Xh) = (ccfv @ XW @ (ccfv @ XK @ cctendo)))) => ((! [Xh:$i] : ((XO @ Xh) = (ccmpt @ (^ [Xh:$i] : XT) @ (^ [Xh:$i] : (ccres @ ccid @ XB2))))) => ((! [Xh:$i] : ((XU @ Xh) = (ccfv @ XW @ (ccfv @ XK @ ccdvh)))) => ((! [Xh:$i] : ((XF @ Xh) = (ccfv @ (XU @ Xh) @ ccsca))) => ((! [Xh:$i] : ((XN @ Xh) = (ccfv @ (XF @ Xh) @ ccinvr))) => (! [Xh:$i] : ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ (cwcel @ (XS @ Xh) @ (XE @ Xh)) @ (cwne @ (XS @ Xh) @ (XO @ Xh))) => ((cccom @ (XS @ Xh) @ (ccfv @ (XS @ Xh) @ (XN @ Xh))) = (ccres @ ccid @ XT)))))))))))))))))))))))).
