...
thf(cuvtxel_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XN @ (ccfv @ XG @ ccuvtx)) <=> ((cwcel @ XN @ XV) & (cwral @ (^ [Xn:$i] : (cwcel @ (ccv @ Xn) @ (cco @ XG @ XN @ ccnbgr))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ XN))))))))))).
