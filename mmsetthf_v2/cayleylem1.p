...
thf(agaid2_ax,axiom,(! [Xc_pl:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XG @ ccgrp) => (cwcel @ (XF @ Xx3 @ Xy1) @ (cco @ XG @ XX @ ccga))))))))))))).
...
thf(agalactghm_ax,axiom,(! [Xc_po:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((! [Xy1:$i] : ((XH @ Xy1) = (ccfv @ XY @ ccsymg))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_po)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ Xc_po @ (cco @ XG @ XY @ ccga)) => (cwcel @ (XF @ Xx3 @ Xy1) @ (cco @ XG @ (XH @ Xy1) @ ccghm))))))))))))))).
...
thf(ccayleylem1_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((! [Xg1:$i] : ((Xc_0 @ Xg1) = (ccfv @ XG @ cc0g))) => ((! [Xa:$i] : ((XH @ Xa) = (ccfv @ XX @ ccsymg))) => ((! [Xg1:$i] : (! [Xa:$i] : ((XS @ Xg1 @ Xa) = (ccfv @ (XH @ Xa) @ ccbs)))) => ((! [Xg1:$i] : (! [Xa:$i] : ((XF @ Xg1 @ Xa) = (ccmpt @ (^ [Xg1:$i] : XX) @ (^ [Xg1:$i] : (ccmpt @ (^ [Xa:$i] : XX) @ (^ [Xa:$i] : (cco @ (ccv @ Xg1) @ (ccv @ Xa) @ Xc_pl)))))))) => (! [Xg1:$i] : (! [Xa:$i] : ((cwcel @ XG @ ccgrp) => (cwcel @ (XF @ Xg1 @ Xa) @ (cco @ XG @ (XH @ Xa) @ ccghm))))))))))))))))))).
