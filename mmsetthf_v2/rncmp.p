...
thf(acncmp_ax,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccuni @ XK)) => ((cw3a @ (cwcel @ XJ @ cccmp) @ (cwfo @ XX @ XY @ XF) @ (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => (cwcel @ XK @ cccmp))))))))).
thf(crncmp_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XJ @ cccmp) & (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => (cwcel @ (cco @ XK @ (ccrn @ XF) @ ccrest) @ cccmp)))))).
