...
thf(aghmeql_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (cco @ XS @ XT @ ccghm)) & (cwcel @ XG @ (cco @ XS @ XT @ ccghm))) => (cwcel @ (ccdm @ (ccin @ XF @ XG)) @ (ccfv @ XS @ ccsubg)))))))).
...
thf(clmhmeql_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XU = (ccfv @ XS @ cclss)) => (((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) & (cwcel @ XG @ (cco @ XS @ XT @ cclmhm))) => (cwcel @ (ccdm @ (ccin @ XF @ XG)) @ XU))))))))).
