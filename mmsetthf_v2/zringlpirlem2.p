...
thf(czringlpirlem2_conj,conjecture,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((Xph => (cwcel @ XI @ (ccfv @ czring @ cclidl))) => ((Xph => (cwne @ XI @ (ccsn @ ccc0))) => ((XG = (ccinf @ (ccin @ XI @ ccn) @ ccr @ cclt)) => (Xph => (cwcel @ XG @ XI))))))))).
