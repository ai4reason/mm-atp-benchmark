...
thf(afinds1_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = cc0) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccsuc @ (ccv @ Xy1))) => ((Xph @ Xx3) <=> (Xth @ Xy1))))) => ((! [Xy1:$i] : (Xps @ Xy1)) => ((! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ ccom) => ((Xch @ Xy1) => (Xth @ Xy1)))) => (! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ ccom) => (Xph @ Xx3))))))))))))).
...
thf(awdomimag_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwfun @ XF) & (cwcel @ XA2 @ XV)) => (cwbr @ (ccima @ XF @ XA2) @ XA2 @ ccwdom)))))).
...
thf(ahsmexlem1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccoi @ XA2 @ ccep)) => (((cwss @ XA2 @ ccon0) & (cwbr @ XA2 @ XB2 @ ccwdom)) => (cwcel @ (ccdm @ XO) @ (ccfv @ (ccpw @ XB2) @ cchar)))))))).
...
thf(aituniiun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XU @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccres @ (ccrdg @ (ccmpt @ (^ [Xy1:$i] : ccvv) @ (^ [Xy1:$i] : (ccuni @ (ccv @ Xy1)))) @ (ccv @ Xx3)) @ ccom)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xa:$i] : ((cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xa)) => ((ccfv @ (ccsuc @ XB2) @ (ccfv @ XA2 @ (XU @ Xx3 @ Xy1))) = (cciun @ (^ [Xa:$i] : XA2) @ (^ [Xa:$i] : (ccfv @ XB2 @ (ccfv @ (ccv @ Xa) @ (XU @ Xx3 @ Xy1)))))))))))))))).
...
thf(ahsmexlem9_ax,axiom,(! [XH:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xa:$i] : ((! [Xz:$i] : ((XH @ Xz) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xz:$i] : ccvv) @ (^ [Xz:$i] : (ccfv @ (ccpw @ (ccxp @ XX @ (ccv @ Xz))) @ cchar))) @ (ccfv @ (ccpw @ XX) @ cchar)) @ ccom))) => (! [Xz:$i] : ((cwcel @ (ccv @ Xa) @ ccom) => (cwcel @ (ccfv @ (ccv @ Xa) @ (XH @ Xz)) @ ccon0)))))))).
...
thf(atcss_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwss @ XB2 @ XA2) => (cwss @ (ccfv @ XB2 @ cctc) @ (ccfv @ XA2 @ cctc))))))).
thf(amp1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => ((Xph => Xps) => (Xch => Xps))))))).
thf(atcel_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ XA2) => (cwss @ (ccfv @ XB2 @ cctc) @ (ccfv @ XA2 @ cctc))))))).
