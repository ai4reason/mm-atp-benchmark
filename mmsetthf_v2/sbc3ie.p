...
thf(csbc3ie_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccvv)) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ (XC @ Xx3 @ Xy1) @ ccvv))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cw3a @ ((ccv @ Xx3) = XA2) @ ((ccv @ Xy1) = (XB2 @ Xx3)) @ ((ccv @ Xz) = (XC @ Xx3 @ Xy1))) => ((Xph @ Xx3 @ Xy1 @ Xz) <=> Xps))))) => ((cwsbc @ (^ [Xx3:$i] : (cwsbc @ (^ [Xy1:$i] : (cwsbc @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)) @ (XC @ Xx3 @ Xy1))) @ (XB2 @ Xx3))) @ XA2) <=> Xps))))))))))).
