...
thf(afrege131_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XM @ XU) => ((cwcel @ XR @ XV) => ((cwfun @ (cccnv @ (cccnv @ XR))) => (cwhe @ (ccun @ (ccima @ (cccnv @ (ccfv @ XR @ cctcl)) @ (ccsn @ XM)) @ (ccima @ (ccun @ (ccfv @ XR @ cctcl) @ ccid) @ (ccsn @ XM))) @ XR))))))))).
