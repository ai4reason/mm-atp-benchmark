...
thf(ccmpcov2_conj,conjecture,(! [Xph:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xs1:$i] : ((XX @ Xy1 @ Xs1) = (ccuni @ XJ)))) => (! [Xy1:$i] : (! [Xs1:$i] : (((cwcel @ XJ @ cccmp) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (Xph @ Xy1))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : (XX @ Xy1 @ Xs1)))) => (cwrex @ (^ [Xs1:$i] : (((XX @ Xy1 @ Xs1) = (ccuni @ (ccv @ Xs1))) & (cwral @ (^ [Xy1:$i] : (Xph @ Xy1)) @ (^ [Xy1:$i] : (ccv @ Xs1))))) @ (^ [Xs1:$i] : (ccin @ (ccpw @ XJ) @ ccfn))))))))))).
