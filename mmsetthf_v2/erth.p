...
thf(aersymb_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwer @ XX @ XR)) => (Xph => ((cwbr @ XA2 @ XB2 @ XR) <=> (cwbr @ XB2 @ XA2 @ XR)))))))))).
...
thf(aereldm_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwer @ XX @ XR)) => ((Xph => ((ccec @ XA2 @ XR) = (ccec @ XB2 @ XR))) => (Xph => ((cwcel @ XA2 @ XX) <=> (cwcel @ XB2 @ XX))))))))))).
thf(certh_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwer @ XX @ XR)) => ((Xph => (cwcel @ XA2 @ XX)) => (Xph => ((cwbr @ XA2 @ XB2 @ XR) <=> ((ccec @ XA2 @ XR) = (ccec @ XB2 @ XR)))))))))))).
