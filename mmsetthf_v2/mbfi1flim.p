...
thf(ambfi1flimlem_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwf @ ccr @ ccr @ XF)) => (Xph => (? [Xg1:$i] : ((cwf @ ccn @ (ccdm @ ccitg1) @ (ccv @ Xg1)) & (cwral @ (^ [Xx3:$i] : (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1))))) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccli)) @ (^ [Xx3:$i] : ccr)))))))))).
