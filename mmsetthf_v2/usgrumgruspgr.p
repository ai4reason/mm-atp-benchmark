...
thf(a_3sstr3g_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwss @ XA2 @ XB2)) => ((XA2 = XC) => ((XB2 = XD) => (Xph => (cwss @ XC @ XD))))))))))).
thf(aumgredgss_ax,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ ccumgr) => (cwss @ (ccfv @ XG @ ccedg) @ (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cchash) = cc2)) @ (^ [Xx3:$i] : (ccpw @ (ccfv @ XG @ ccvtx)))))))).
...
thf(cusgrumgruspgr_conj,conjecture,(! [XG:($i > $o)] : ((cwcel @ XG @ ccusgr) <=> ((cwcel @ XG @ ccumgr) & (cwcel @ XG @ ccuspgr))))).
