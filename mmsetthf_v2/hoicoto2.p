...
thf(choicoto2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xk:$i] : (Xph => (cwf @ XX @ (ccxp @ ccr @ ccr) @ (XI @ Xk)))) => ((! [Xk:$i] : ((XA2 @ Xk) = (ccmpt @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (XI @ Xk)) @ cc1st))))) => ((! [Xk:$i] : ((XB2 @ Xk) = (ccmpt @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (XI @ Xk)) @ cc2nd))))) => (Xph => ((ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (XI @ Xk))))) = (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XA2 @ Xk)) @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xk)) @ ccico)))))))))))))).
