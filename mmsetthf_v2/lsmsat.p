...
thf(clsmsat_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xp:$i] : ((Xc_0 @ Xp) = (ccfv @ XW @ cc0g))) => ((! [Xp:$i] : ((XS @ Xp) = (ccfv @ XW @ cclss))) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((XA2 = (ccfv @ XW @ cclsa)) => ((! [Xp:$i] : ((Xph @ Xp) => (cwcel @ XW @ cclmod))) => ((! [Xp:$i] : ((Xph @ Xp) => (cwcel @ XT @ (XS @ Xp)))) => ((! [Xp:$i] : ((Xph @ Xp) => (cwcel @ XU @ (XS @ Xp)))) => ((! [Xp:$i] : ((Xph @ Xp) => (cwcel @ XQ @ XA2))) => ((! [Xp:$i] : ((Xph @ Xp) => (cwne @ XT @ (ccsn @ (Xc_0 @ Xp))))) => ((! [Xp:$i] : ((Xph @ Xp) => (cwss @ XQ @ (cco @ XT @ XU @ Xc_po)))) => (! [Xp:$i] : ((Xph @ Xp) => (cwrex @ (^ [Xp:$i] : ((cwss @ (ccv @ Xp) @ XT) & (cwss @ XQ @ (cco @ (ccv @ Xp) @ XU @ Xc_po)))) @ (^ [Xp:$i] : XA2)))))))))))))))))))))))).
