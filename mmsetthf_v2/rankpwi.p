...
thf(arankidn_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) => (~ (cwcel @ XA2 @ (ccfv @ (ccfv @ XA2 @ ccrnk) @ ccr1)))))).
...
thf(ar1rankidb_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) => (cwss @ XA2 @ (ccfv @ (ccfv @ XA2 @ ccrnk) @ ccr1))))).
