...
thf(aresmgmhm2_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XT @ XX @ ccress)) => (((cwcel @ XF @ (cco @ XS @ XU @ ccmgmhm)) & (cwcel @ XX @ (ccfv @ XT @ ccsubmgm))) => (cwcel @ XF @ (cco @ XS @ XT @ ccmgmhm)))))))))).
