...
thf(cisipodrs_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ (ccfv @ XA2 @ ccipo) @ ccdrs) <=> (cw3a @ (cwcel @ XA2 @ ccvv) @ (cwne @ XA2 @ cc0) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwss @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz))) @ (^ [Xz:$i] : XA2))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
