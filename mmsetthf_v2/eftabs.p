...
thf(ceftabs_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XK @ ccn0)) => ((ccfv @ (cco @ (cco @ XA2 @ XK @ ccexp) @ (ccfv @ XK @ ccfa) @ ccdiv) @ ccabs) = (cco @ (cco @ (ccfv @ XA2 @ ccabs) @ XK @ ccexp) @ (ccfv @ XK @ ccfa) @ ccdiv)))))).
