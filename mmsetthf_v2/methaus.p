...
thf(amopnex_ax,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => (cwrex @ (^ [Xd:$i] : (XJ = (ccfv @ (ccv @ Xd) @ ccmopn))) @ (^ [Xd:$i] : (ccfv @ XX @ ccme))))))))).
...
thf(ametgt0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccme)) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) => ((cwne @ XA2 @ XB2) <=> (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ XD) @ cclt)))))))).
...
thf(cmethaus_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => (cwcel @ XJ @ ccha))))))).
