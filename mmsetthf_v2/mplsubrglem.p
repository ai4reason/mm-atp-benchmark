...
thf(afsuppxpfi_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : (((cwbr @ XF @ XZ @ ccfsupp) & (cwbr @ XG @ XZ @ ccfsupp)) => (cwcel @ (ccxp @ (cco @ XF @ XZ @ ccsupp) @ (cco @ XG @ XZ @ ccsupp)) @ ccfn)))))).
