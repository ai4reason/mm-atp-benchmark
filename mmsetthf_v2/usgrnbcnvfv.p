...
thf(ausgrf1o_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : ((XE = (ccfv @ XG @ cciedg)) => ((cwcel @ XG @ ccusgr) => (cwf1o @ (ccdm @ XE) @ (ccrn @ XE) @ XE)))))).
...
thf(cusgrnbcnvfv_conj,conjecture,(! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => (((cwcel @ XG @ ccusgr) & (cwcel @ XN @ (cco @ XG @ XK @ ccnbgr))) => ((ccfv @ (ccfv @ (ccpr @ XK @ XN) @ (cccnv @ XI)) @ XI) = (ccpr @ XK @ XN))))))))).
