...
thf(ccgsexg_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => (Xch @ Xx3))) => ((! [Xx3:$i] : ((Xch @ Xx3) => ((Xph @ Xx3) <=> Xps))) => (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((? [Xx3:$i] : ((Xch @ Xx3) & (Xph @ Xx3))) <=> Xps))))))))))).
