...
thf(catanlogsub_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccatan)) & (cwne @ (ccfv @ XA2 @ ccre) @ ccc0)) => (cwcel @ (cco @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) @ cclog) @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccmin) @ cclog) @ ccmin) @ (ccrn @ cclog))))).
