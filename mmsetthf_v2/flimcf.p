...
thf(aflimss1_ax,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwss @ XJ @ XK)) => (cwss @ (cco @ XK @ XF @ ccflim) @ (cco @ XJ @ XF @ ccflim)))))))).
...
thf(aopnnei_ax,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : ((cwcel @ XJ @ cctop) => ((cwcel @ XS @ XJ) <=> (cwral @ (^ [Xx3:$i] : (cwcel @ XS @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)))) @ (^ [Xx3:$i] : XS))))))).
thf(cflimcf_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XK @ (ccfv @ XX @ cctopon))) => ((cwss @ XJ @ XK) <=> (cwral @ (^ [Xf1:$i] : (cwss @ (cco @ XK @ (ccv @ Xf1) @ ccflim) @ (cco @ XJ @ (ccv @ Xf1) @ ccflim))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil))))))))).
