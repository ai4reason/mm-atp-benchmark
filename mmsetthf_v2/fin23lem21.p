...
thf(afin23lem14_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : ((! [Xt:$i] : ((XU @ Xt) = (ccseqom @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xu:$i] : ccom)) @ (^ [Xi:$i] : (^ [Xu:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xu:$i] : (ccif @ ((ccin @ (ccfv @ (ccv @ Xi) @ (ccv @ Xt)) @ (ccv @ Xu)) = cc0) @ (ccv @ Xu) @ (ccin @ (ccfv @ (ccv @ Xi) @ (ccv @ Xt)) @ (ccv @ Xu)))))) @ (ccuni @ (ccrn @ (ccv @ Xt)))))) => (! [Xt:$i] : (((cwcel @ (XA2 @ Xt) @ ccom) & (cwne @ (ccuni @ (ccrn @ (ccv @ Xt))) @ cc0)) => (cwne @ (ccfv @ (XA2 @ Xt) @ (XU @ Xt)) @ cc0))))))).
thf(aneeq1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwne @ XA2 @ XC) <=> (cwne @ XB2 @ XC))))))).
thf(cfin23lem21_conj,conjecture,(! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xt:$i] : (! [Xg1:$i] : ((XU @ Xx3 @ Xt @ Xg1) = (ccseqom @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xu:$i] : ccom)) @ (^ [Xi:$i] : (^ [Xu:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xu:$i] : (ccif @ ((ccin @ (ccfv @ (ccv @ Xi) @ (ccv @ Xt)) @ (ccv @ Xu)) = cc0) @ (ccv @ Xu) @ (ccin @ (ccfv @ (ccv @ Xi) @ (ccv @ Xt)) @ (ccv @ Xu)))))) @ (ccuni @ (ccrn @ (ccv @ Xt)))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((XF @ Xx3 @ Xu @ Xg1 @ Xi) = (ccab @ (^ [Xg1:$i] : (cwral @ (^ [Xa:$i] : ((cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xa)))) @ (^ [Xx3:$i] : ccom)) => (cwcel @ (ccint @ (ccrn @ (ccv @ Xa))) @ (ccrn @ (ccv @ Xa))))) @ (^ [Xa:$i] : (cco @ (ccpw @ (ccv @ Xg1)) @ ccom @ ccmap)))))))))) => (! [Xx3:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xg1:$i] : (! [Xi:$i] : (((cwcel @ (ccuni @ (ccrn @ (ccv @ Xt))) @ (XF @ Xx3 @ Xu @ Xg1 @ Xi)) & (cwf1 @ ccom @ (XV @ Xx3 @ Xu @ Xt @ Xg1 @ Xi) @ (ccv @ Xt))) => (cwne @ (ccint @ (ccrn @ (XU @ Xx3 @ Xt @ Xg1))) @ cc0))))))))))))).
