...
thf(cdisjen_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => (((ccin @ XA2 @ (ccxp @ XB2 @ (ccsn @ (ccpw @ (ccuni @ (ccrn @ XA2)))))) = cc0) & (cwbr @ (ccxp @ XB2 @ (ccsn @ (ccpw @ (ccuni @ (ccrn @ XA2))))) @ XB2 @ ccen)))))))).
