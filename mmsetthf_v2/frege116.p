...
thf(adffrege115_ax,axiom,(! [XR:($i > $o)] : ((! [Xc:$i] : (! [Xb:$i] : ((cwbr @ (ccv @ Xb) @ (ccv @ Xc) @ XR) => (! [Xa:$i] : ((cwbr @ (ccv @ Xb) @ (ccv @ Xa) @ XR) => ((ccv @ Xa) = (ccv @ Xc))))))) <=> (cwfun @ (cccnv @ (cccnv @ XR)))))).
...
thf(cfrege116_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : (cwcel @ XX @ (XU @ Xa @ Xb)))) => ((cwfun @ (cccnv @ (cccnv @ XR))) => (! [Xb:$i] : ((cwbr @ (ccv @ Xb) @ XX @ XR) => (! [Xa:$i] : ((cwbr @ (ccv @ Xb) @ (ccv @ Xa) @ XR) => ((ccv @ Xa) = XX))))))))))).
