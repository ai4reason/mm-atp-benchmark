...
thf(arescfth_ax,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : ((XD = (cco @ XC @ XJ @ ccresc)) => ((XI = (ccfv @ XD @ ccidfu)) => ((cwcel @ XJ @ (ccfv @ XC @ ccsubc)) => (cwcel @ XI @ (cco @ XD @ XC @ ccfth)))))))))).
...
thf(aidfusubc_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : ((XS = (cco @ XC @ XJ @ ccresc)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XI @ Xx3 @ Xy1) = (ccfv @ XS @ ccidfu)))) => ((XB2 = (ccfv @ XS @ ccbs)) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XJ @ (ccfv @ XC @ ccsubc)) => ((XI @ Xx3 @ Xy1) = (ccop @ (ccres @ ccid @ XB2) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccres @ ccid @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XJ))))))))))))))))))).
