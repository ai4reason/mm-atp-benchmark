...
thf(adfun2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccun @ XA2 @ XB2) = (ccdif @ ccvv @ (ccdif @ (ccdif @ ccvv @ XA2) @ XB2)))))).
...
thf(cdfin3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccin @ XA2 @ XB2) = (ccdif @ ccvv @ (ccun @ (ccdif @ ccvv @ XA2) @ (ccdif @ ccvv @ XB2))))))).
