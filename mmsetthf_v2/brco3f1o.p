...
thf(abrcofffn_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwfn @ XC @ XZ)) => ((Xph => (cwf @ XY @ XZ @ XD)) => ((Xph => (cwf @ XX @ XY @ XE)) => ((Xph => (cwbr @ XA2 @ XB2 @ (cccom @ XC @ (cccom @ XD @ XE)))) => (Xph => (cw3a @ (cwbr @ XA2 @ (ccfv @ XA2 @ XE) @ XE) @ (cwbr @ (ccfv @ XA2 @ XE) @ (ccfv @ (ccfv @ XA2 @ XE) @ XD) @ XD) @ (cwbr @ (ccfv @ (ccfv @ XA2 @ XE) @ XD) @ XB2 @ XC))))))))))))))))).
