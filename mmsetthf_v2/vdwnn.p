...
thf(avdwnnlem3_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xk:$i] : (! [Xm:$i] : ((Xph @ Xk @ Xm) => (cwcel @ (XR @ Xk @ Xm) @ ccfn)))) => ((! [Xk:$i] : (! [Xm:$i] : ((Xph @ Xk @ Xm) => (cwf @ ccn @ (XR @ Xk @ Xm) @ XF)))) => ((! [Xc:$i] : ((XS @ Xc) = (ccrab @ (^ [Xk:$i] : (~ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xm:$i] : (cwcel @ (cco @ (ccv @ Xa) @ (cco @ (ccv @ Xm) @ (ccv @ Xd) @ ccmul) @ ccaddc) @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xc))))) @ (^ [Xm:$i] : (cco @ ccc0 @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ ccfz)))) @ (^ [Xd:$i] : ccn))) @ (^ [Xa:$i] : ccn)))) @ (^ [Xk:$i] : ccn)))) => ((! [Xk:$i] : (! [Xm:$i] : ((Xph @ Xk @ Xm) => (cwral @ (^ [Xc:$i] : (cwne @ (XS @ Xc) @ cc0)) @ (^ [Xc:$i] : (XR @ Xk @ Xm)))))) => (! [Xk:$i] : (! [Xm:$i] : (~ (Xph @ Xk @ Xm))))))))))))).
...
thf(cvdwnn_conj,conjecture,(! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > $o)] : (! [Xk:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xd:$i] : (((cwcel @ (XR @ Xk @ Xm @ Xa @ Xd) @ ccfn) & (cwf @ ccn @ (XR @ Xk @ Xm @ Xa @ Xd) @ XF)) => (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xm:$i] : (cwcel @ (cco @ (ccv @ Xa) @ (cco @ (ccv @ Xm) @ (ccv @ Xd) @ ccmul) @ ccaddc) @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xc))))) @ (^ [Xm:$i] : (cco @ ccc0 @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ ccfz)))) @ (^ [Xd:$i] : ccn))) @ (^ [Xa:$i] : ccn))) @ (^ [Xk:$i] : ccn))) @ (^ [Xc:$i] : (XR @ Xk @ Xm @ Xa @ Xd))))))))))).
