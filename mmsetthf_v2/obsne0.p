...
thf(aobsipid_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XW:($i > $o)] : ((Xc_xi = (ccfv @ XW @ ccip)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_1 = (ccfv @ XF @ ccur)) => (((cwcel @ XB2 @ (ccfv @ XW @ ccobs)) & (cwcel @ XA2 @ XB2)) => ((cco @ XA2 @ XA2 @ Xc_xi) = Xc_1)))))))))))).
...
thf(cobsne0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XW @ cc0g)) => (((cwcel @ XB2 @ (ccfv @ XW @ ccobs)) & (cwcel @ XA2 @ XB2)) => (cwne @ XA2 @ Xc_0)))))))).
