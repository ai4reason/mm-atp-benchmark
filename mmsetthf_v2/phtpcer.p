...
thf(aphtpcrel_ax,axiom,(! [XJ:($i > $o)] : (cwrel @ (ccfv @ XJ @ ccphtpc)))).
...
thf(aphtpycom_ax,axiom,(! [Xph:$o] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XF @ Xx3 @ Xy1) @ (cco @ ccii @ XJ @ cccn))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XG @ Xx3 @ Xy1) @ (cco @ ccii @ XJ @ cccn))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XK @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ ccc0 @ cc1 @ ccicc))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ ccc0 @ cc1 @ ccicc))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (cco @ cc1 @ (ccv @ Xy1) @ ccmin) @ XH))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XH @ (cco @ (XF @ Xx3 @ Xy1) @ (XG @ Xx3 @ Xy1) @ (ccfv @ XJ @ ccphtpy)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XK @ Xx3 @ Xy1) @ (cco @ (XG @ Xx3 @ Xy1) @ (XF @ Xx3 @ Xy1) @ (ccfv @ XJ @ ccphtpy))))))))))))))))).
...
thf(aphtpyid_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XG @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ ccc0 @ cc1 @ ccicc))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ ccc0 @ cc1 @ ccicc))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xx3) @ XF))))))) => ((Xph => (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XG @ Xx3 @ Xy1) @ (cco @ XF @ XF @ (ccfv @ XJ @ ccphtpy))))))))))))).
