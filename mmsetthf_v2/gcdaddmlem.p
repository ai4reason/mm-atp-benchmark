...
thf(apm4_57_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((~ ((~ Xph) & (~ Xps))) <=> (Xph | Xps))))).
...
thf(cgcdaddmlem_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ ccz) => ((cwcel @ XM @ ccz) => ((cwcel @ XN @ ccz) => ((cco @ XM @ XN @ ccgcd) = (cco @ XM @ (cco @ (cco @ XK @ XM @ ccmul) @ XN @ ccaddc) @ ccgcd))))))))).
