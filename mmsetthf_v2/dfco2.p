...
thf(aopelco2g_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XA2 @ (XV @ Xx3)) & (cwcel @ XB2 @ (XW @ Xx3))) => ((cwcel @ (ccop @ XA2 @ XB2) @ (cccom @ XC @ XD)) <=> (? [Xx3:$i] : ((cwcel @ (ccop @ XA2 @ (ccv @ Xx3)) @ XD) & (cwcel @ (ccop @ (ccv @ Xx3) @ XB2) @ XC))))))))))))).
...
thf(cdfco2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cccom @ XA2 @ XB2) = (cciun @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccxp @ (ccima @ (cccnv @ XB2) @ (ccsn @ (ccv @ Xx3))) @ (ccima @ XA2 @ (ccsn @ (ccv @ Xx3)))))))))).
