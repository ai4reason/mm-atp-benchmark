...
thf(crrxbase_conj,conjecture,(! [XB2:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((! [Xf1:$i] : ((XH @ Xf1) = (ccfv @ XI @ ccrrx))) => ((! [Xf1:$i] : (XB2 = (ccfv @ (XH @ Xf1) @ ccbs))) => ((cwcel @ XI @ XV) => (XB2 = (ccrab @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ ccc0 @ ccfsupp)) @ (^ [Xf1:$i] : (cco @ ccr @ XI @ ccmap)))))))))))).
