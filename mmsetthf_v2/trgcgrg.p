...
thf(araltpd_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & ((ccv @ Xx3) = XA2)) => ((Xps @ Xx3) <=> Xch))) => ((! [Xx3:$i] : ((Xph & ((ccv @ Xx3) = XB2)) => ((Xps @ Xx3) <=> Xth))) => ((! [Xx3:$i] : ((Xph & ((ccv @ Xx3) = XC)) => ((Xps @ Xx3) <=> Xta))) => ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XB2 @ (XW @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XC @ (XX @ Xx3)))) => (Xph => ((cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (cctp @ XA2 @ XB2 @ XC))) <=> (cw3a @ Xch @ Xth @ Xta))))))))))))))))))))).
...
thf(aan33rean_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : (! [Xsi:$o] : (! [Xrh:$o] : ((cw3a @ (cw3a @ Xph @ Xps @ Xch) @ (cw3a @ Xth @ Xta @ Xet) @ (cw3a @ Xze @ Xsi @ Xrh)) <=> ((cw3a @ Xph @ Xta @ Xrh) & (cw3a @ (Xps & Xth) @ (Xet & Xsi) @ (Xch & Xze)))))))))))))).
...
thf(atgcgrtriv_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => (Xph => ((cco @ XA2 @ XA2 @ Xc_mi) = (cco @ XB2 @ XB2 @ Xc_mi))))))))))))))))).
...
thf(ctrgcgrg_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((Xc_sm = (ccfv @ XG @ cccgrg)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XD @ XP)) => ((Xph => (cwcel @ XE @ XP)) => ((Xph => (cwcel @ XF @ XP)) => (Xph => ((cwbr @ (ccs3 @ XA2 @ XB2 @ XC) @ (ccs3 @ XD @ XE @ XF) @ Xc_sm) <=> (cw3a @ ((cco @ XA2 @ XB2 @ Xc_mi) = (cco @ XD @ XE @ Xc_mi)) @ ((cco @ XB2 @ XC @ Xc_mi) = (cco @ XE @ XF @ Xc_mi)) @ ((cco @ XC @ XA2 @ Xc_mi) = (cco @ XF @ XD @ Xc_mi))))))))))))))))))))))))))).
