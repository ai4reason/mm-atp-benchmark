...
thf(alighneallem4a_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XM @ (ccfv @ cc3 @ ccuz)) @ (XS = (cco @ (cco @ (cco @ XA2 @ XM @ ccexp) @ cc1 @ ccaddc) @ (cco @ XA2 @ cc1 @ ccaddc) @ ccdiv))) => (cwbr @ cc2 @ XS @ ccle)))))).
thf(clighneallem4b_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XM @ (ccfv @ cc2 @ ccuz)) @ (~ (cwbr @ cc2 @ XM @ ccdvds))) => (cwcel @ (ccsu @ (cco @ ccc0 @ (cco @ XM @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ (ccneg @ cc1) @ (ccv @ Xk) @ ccexp) @ (cco @ XA2 @ (ccv @ Xk) @ ccexp) @ ccmul))) @ (ccfv @ cc2 @ ccuz)))))).
