...
thf(apjspansn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil) @ (cwne @ XA2 @ cc0v)) => ((ccfv @ XB2 @ (ccfv @ (ccfv @ (ccsn @ XA2) @ ccspn) @ ccpjh)) = (cco @ (cco @ (cco @ XB2 @ XA2 @ ccsp) @ (cco @ (ccfv @ XA2 @ ccno) @ cc2 @ ccexp) @ ccdiv) @ XA2 @ ccsm)))))).
...
thf(akbop_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => (cwf @ cchil @ cchil @ (cco @ XA2 @ XB2 @ cck)))))).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(affn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => (cwfn @ XF @ XA2)))))).
thf(aspansnch_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ cchil) => (cwcel @ (ccfv @ (ccsn @ XA2) @ ccspn) @ ccch)))).
thf(apjfn_ax,axiom,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => (cwfn @ (ccfv @ XH @ ccpjh) @ cchil)))).
...
thf(ckbpj_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ cchil) & ((ccfv @ XA2 @ ccno) = cc1)) => ((cco @ XA2 @ XA2 @ cck) = (ccfv @ (ccfv @ (ccsn @ XA2) @ ccspn) @ ccpjh))))).
