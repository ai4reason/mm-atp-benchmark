...
thf(atskwe2_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ cctsk) => (cwcel @ XT @ (ccdm @ cccrd))))).
...
thf(atskuni_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwcel @ XT @ cctsk) @ (cwtr @ XT) @ (cwcel @ XA2 @ XT)) => (cwcel @ (ccuni @ XA2) @ XT))))).
thf(ctskurn_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ ((cwcel @ XT @ cctsk) & (cwtr @ XT)) @ (cwcel @ XA2 @ XT) @ (cwf @ XA2 @ XT @ XF)) => (cwcel @ (ccuni @ (ccrn @ XF)) @ XT)))))).
