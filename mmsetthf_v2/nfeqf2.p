...
thf(aax13lem2_ax,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((~ ((ccv @ Xx3) = (ccv @ Xy1))) => ((? [Xx3:$i] : ((ccv @ Xz) = (ccv @ Xy1))) => ((ccv @ Xz) = (ccv @ Xy1)))))))).
...
thf(cnfeqf2_conj,conjecture,(! [Xy1:$i] : (! [Xz:$i] : ((~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1)))) => (cwnf @ (^ [Xx3:$i] : ((ccv @ Xz) = (ccv @ Xy1)))))))).
