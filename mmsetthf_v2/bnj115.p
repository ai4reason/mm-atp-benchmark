...
thf(cbnj115_conj,conjecture,(! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [Xet:($i > $o)] : (! [XD:($i > ($i > $o))] : ((! [Xn:$i] : ((Xet @ Xn) <=> (cwral @ (^ [Xn:$i] : ((Xta @ Xn) => (Xth @ Xn))) @ (^ [Xn:$i] : (XD @ Xn))))) => (! [Xn:$i] : ((Xet @ Xn) <=> (! [Xn:$i] : (((cwcel @ (ccv @ Xn) @ (XD @ Xn)) & (Xta @ Xn)) => (Xth @ Xn))))))))))).
