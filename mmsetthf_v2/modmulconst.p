...
thf(cmodmulconst_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccn)) & (cwcel @ XM @ ccn)) => (((cco @ XA2 @ XM @ ccmo) = (cco @ XB2 @ XM @ ccmo)) <=> ((cco @ (cco @ XC @ XA2 @ ccmul) @ (cco @ XC @ XM @ ccmul) @ ccmo) = (cco @ (cco @ XC @ XB2 @ ccmul) @ (cco @ XC @ XM @ ccmul) @ ccmo))))))))).
