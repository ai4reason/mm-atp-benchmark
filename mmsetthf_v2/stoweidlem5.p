...
thf(cstoweidlem5_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > $o)))] : ((! [Xd:$i] : (cwnf @ (^ [Xt:$i] : (Xph @ Xt @ Xd)))) => ((! [Xt:$i] : (! [Xd:$i] : (XD = (ccif @ (cwbr @ (XC @ Xt @ Xd) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccle) @ (XC @ Xt @ Xd) @ (cco @ cc1 @ cc2 @ ccdiv))))) => ((! [Xt:$i] : (! [Xd:$i] : ((Xph @ Xt @ Xd) => (cwf @ (XT @ Xt @ Xd) @ ccr @ (XP @ Xt))))) => ((! [Xt:$i] : (! [Xd:$i] : ((Xph @ Xt @ Xd) => (cwss @ (XQ @ Xt) @ (XT @ Xt @ Xd))))) => ((! [Xt:$i] : (! [Xd:$i] : ((Xph @ Xt @ Xd) => (cwcel @ (XC @ Xt @ Xd) @ ccrp)))) => ((! [Xt:$i] : (! [Xd:$i] : ((Xph @ Xt @ Xd) => (cwral @ (^ [Xt:$i] : (cwbr @ (XC @ Xt @ Xd) @ (ccfv @ (ccv @ Xt) @ (XP @ Xt)) @ ccle)) @ (^ [Xt:$i] : (XQ @ Xt)))))) => (! [Xt:$i] : (! [Xd:$i] : ((Xph @ Xt @ Xd) => (? [Xd:$i] : (cw3a @ (cwcel @ (ccv @ Xd) @ ccrp) @ (cwbr @ (ccv @ Xd) @ cc1 @ cclt) @ (cwral @ (^ [Xt:$i] : (cwbr @ (ccv @ Xd) @ (ccfv @ (ccv @ Xt) @ (XP @ Xt)) @ ccle)) @ (^ [Xt:$i] : (XQ @ Xt))))))))))))))))))))).
