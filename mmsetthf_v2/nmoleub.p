...
thf(anmrpcl_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XG @ ccnm)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((cw3a @ (cwcel @ XG @ ccngp) @ (cwcel @ XA2 @ XX) @ (cwne @ XA2 @ Xc_0)) => (cwcel @ (ccfv @ XA2 @ XN) @ ccrp))))))))))).
thf(asyl3anc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xps) => ((Xph => Xch) => ((Xph => Xth) => (((cw3a @ Xps @ Xch @ Xth) => Xta) => (Xph => Xta))))))))))).
thf(anmocl_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ XS @ XT @ ccnmo)) => ((cw3a @ (cwcel @ XS @ ccngp) @ (cwcel @ XT @ ccngp) @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm))) => (cwcel @ (ccfv @ XF @ XN) @ ccxr)))))))).
thf(a_3jca_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xph => Xch) => ((Xph => Xth) => (Xph => (cw3a @ Xps @ Xch @ Xth)))))))))).
thf(ccxmu_tp,type,(ccxmu : ($i > $o))).
thf(cc1_tp,type,(cc1 : ($i > $o))).
thf(anmoi2_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XN = (cco @ XS @ XT @ ccnmo)) => ((XV = (ccfv @ XS @ ccbs)) => ((XL = (ccfv @ XS @ ccnm)) => ((XM = (ccfv @ XT @ ccnm)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => (((cw3a @ (cwcel @ XS @ ccngp) @ (cwcel @ XT @ ccngp) @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm))) & ((cwcel @ XX @ XV) & (cwne @ XX @ Xc_0))) => (cwbr @ (cco @ (ccfv @ (ccfv @ XX @ XF) @ XM) @ (ccfv @ XX @ XL) @ ccdiv) @ (ccfv @ XF @ XN) @ ccle))))))))))))))))).
...
thf(anm0_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XN = (ccfv @ XG @ ccnm)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((cwcel @ XG @ ccngp) => ((ccfv @ Xc_0 @ XN) = ccc0)))))))).
...
thf(anmolb_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XN = (cco @ XS @ XT @ ccnmo)) => ((XV = (ccfv @ XS @ ccbs)) => ((XL = (ccfv @ XS @ ccnm)) => ((XM = (ccfv @ XT @ ccnm)) => ((cw3a @ (cw3a @ (cwcel @ XS @ ccngp) @ (cwcel @ XT @ ccngp) @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm))) @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ ccle)) => ((cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XM) @ (cco @ XA2 @ (ccfv @ (ccv @ Xx3) @ XL) @ ccmul) @ ccle)) @ (^ [Xx3:$i] : XV)) => (cwbr @ (ccfv @ XF @ XN) @ XA2 @ ccle)))))))))))))))).
...
thf(cnmoleub_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XN = (cco @ XS @ XT @ ccnmo)) => ((XV = (ccfv @ XS @ ccbs)) => ((XL = (ccfv @ XS @ ccnm)) => ((XM = (ccfv @ XT @ ccnm)) => ((! [Xx3:$i] : ((Xc_0 @ Xx3) = (ccfv @ XS @ cc0g))) => ((Xph => (cwcel @ XS @ ccngp)) => ((Xph => (cwcel @ XT @ ccngp)) => ((Xph => (cwcel @ XF @ (cco @ XS @ XT @ ccghm))) => ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => (Xph => ((cwbr @ (ccfv @ XF @ XN) @ XA2 @ ccle) <=> (cwral @ (^ [Xx3:$i] : ((cwne @ (ccv @ Xx3) @ (Xc_0 @ Xx3)) => (cwbr @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XM) @ (ccfv @ (ccv @ Xx3) @ XL) @ ccdiv) @ XA2 @ ccle))) @ (^ [Xx3:$i] : XV))))))))))))))))))))))))).
