...
thf(ann0ssz_ax,axiom,(cwss @ ccn0 @ ccz)).
...
thf(aexpfac_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : ((cwcel @ XA2 @ ccc) => (cwbr @ (XF @ Xn) @ ccc0 @ ccli))))))).
...
thf(aclim0cf_ax,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > ($i > $o))] : ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XZ @ Xx3) = (ccfv @ (XM @ Xx3 @ Xk) @ ccuz)))) => ((! [Xx3:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XM @ Xx3 @ Xk) @ ccz)))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XF @ Xk) @ (XV @ Xx3 @ Xj @ Xk)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (XZ @ Xx3))) => ((ccfv @ (ccv @ Xk) @ (XF @ Xk)) = (XB2 @ Xx3 @ Xj @ Xk)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (XZ @ Xx3))) => (cwcel @ (XB2 @ Xx3 @ Xj @ Xk) @ ccc))))) => (! [Xk:$i] : (Xph => ((cwbr @ (XF @ Xk) @ ccc0 @ ccli) <=> (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ (XB2 @ Xx3 @ Xj @ Xk) @ ccabs) @ (ccv @ Xx3) @ cclt)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : (XZ @ Xx3)))) @ (^ [Xx3:$i] : ccrp)))))))))))))))))).
...
thf(atpnzd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => (Xph => (cwne @ (cctp @ XA2 @ XB2 @ XC) @ cc0))))))))).
...
thf(aprmunb_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => (cwrex @ (^ [Xp:$i] : (cwbr @ XN @ (ccv @ Xp) @ cclt)) @ (^ [Xp:$i] : ccprime))))).
...
thf(atpid3g_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ XB2) => (cwcel @ XA2 @ (cctp @ XC @ XD @ XA2)))))))).
...
thf(cetransclem48_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : ((! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : (Xph => (cwcel @ (XQ @ Xi @ Xk @ Xn) @ (ccdif @ (ccfv @ ccz @ ccply) @ (ccsn @ cc0p))))))) => ((! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : (Xph => ((ccfv @ cceu @ (XQ @ Xi @ Xk @ Xn)) = ccc0))))) => ((! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XA2 @ Xi) = (ccfv @ (XQ @ Xi @ Xk @ Xn) @ cccoe))))) => ((! [Xi:$i] : (Xph => (cwne @ (ccfv @ ccc0 @ (XA2 @ Xi)) @ ccc0))) => ((! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XM @ Xi) = (ccfv @ (XQ @ Xi @ Xk @ Xn) @ ccdgr))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XC @ Xj @ Xk) = (ccsu @ (cco @ ccc0 @ (XM @ Xi) @ ccfz) @ (^ [Xj:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ (XA2 @ Xi)) @ (cco @ cceu @ (ccv @ Xj) @ cccxp) @ ccmul) @ ccabs) @ (cco @ (XM @ Xi) @ (cco @ (XM @ Xi) @ (cco @ (XM @ Xi) @ cc1 @ ccaddc) @ ccexp) @ ccmul) @ ccmul))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XS @ Xj @ Xk @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (XC @ Xj @ Xk) @ (cco @ (cco @ (cco @ (XM @ Xi) @ (cco @ (XM @ Xi) @ cc1 @ ccaddc) @ ccexp) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv) @ ccmul)))))))) => ((! [Xj:$i] : (! [Xk:$i] : ((XI @ Xj @ Xk) = (ccinf @ (ccrab @ (^ [Xi:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xn) @ (XS @ Xj @ Xk @ Xn)) @ ccabs) @ cc1 @ cclt)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xi) @ ccuz)))) @ (^ [Xi:$i] : ccn0)) @ ccr @ cclt)))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XT @ Xi @ Xn) = (ccsup @ (cctp @ (ccfv @ (ccfv @ ccc0 @ (XA2 @ Xi)) @ ccabs) @ (ccfv @ (XM @ Xi) @ ccfa) @ (XI @ Xj @ Xk)) @ ccxr @ cclt)))))) => (Xph => (cwrex @ (^ [Xk:$i] : ((cwne @ (ccv @ Xk) @ ccc0) & (cwbr @ (ccfv @ (ccv @ Xk) @ ccabs) @ cc1 @ cclt))) @ (^ [Xk:$i] : ccz))))))))))))))))))))).
