...
thf(acxploglim2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccrp)) => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccrp) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ cclog) @ XA2 @ cccxp) @ (cco @ (ccv @ Xn) @ XB2 @ cccxp) @ ccdiv))) @ ccc0 @ ccrli))))).
...
thf(aadvlogexp_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwcel @ XN @ ccn0)) => ((cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccdiv) @ cclog) @ (ccv @ Xk) @ ccexp) @ (ccfv @ (ccv @ Xk) @ ccfa) @ ccdiv))) @ ccmul))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccdiv) @ cclog) @ XN @ ccexp) @ (ccfv @ XN @ ccfa) @ ccdiv)))))))).
...
thf(clogexprlim_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => (cwbr @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ cclog) @ XN @ ccexp))) @ (ccv @ Xx3) @ ccdiv))) @ (ccfv @ XN @ ccfa) @ ccrli)))).
