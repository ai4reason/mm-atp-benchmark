...
thf(ann0sumshdiglemA_ax,axiom,(! [Xy1:$i] : (! [Xa:$i] : ((((cwcel @ (ccv @ Xa) @ ccn) & (cwcel @ (cco @ (ccv @ Xa) @ cc2 @ ccdiv) @ ccn)) & (cwcel @ (ccv @ Xy1) @ ccn)) => ((cwral @ (^ [Xx3:$i] : (((ccfv @ (ccv @ Xx3) @ ccblen) = (ccv @ Xy1)) => ((ccv @ Xx3) = (ccsu @ (cco @ ccc0 @ (ccv @ Xy1) @ ccfzo) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ (ccv @ Xx3) @ (ccfv @ cc2 @ ccdig)) @ (cco @ cc2 @ (ccv @ Xk) @ ccexp) @ ccmul)))))) @ (^ [Xx3:$i] : ccn0)) => (((ccfv @ (ccv @ Xa) @ ccblen) = (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) => ((ccv @ Xa) = (ccsu @ (cco @ ccc0 @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ ccfzo) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ (ccv @ Xa) @ (ccfv @ cc2 @ ccdig)) @ (cco @ cc2 @ (ccv @ Xk) @ ccexp) @ ccmul)))))))))).
thf(ccfl_tp,type,(ccfl : ($i > $o))).
thf(ccpr_tp,type,(ccpr : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(ann0sumshdiglemB_ax,axiom,(! [Xy1:$i] : (! [Xa:$i] : ((((cwcel @ (ccv @ Xa) @ ccn) & (cwcel @ (cco @ (cco @ (ccv @ Xa) @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn0)) & (cwcel @ (ccv @ Xy1) @ ccn)) => ((cwral @ (^ [Xx3:$i] : (((ccfv @ (ccv @ Xx3) @ ccblen) = (ccv @ Xy1)) => ((ccv @ Xx3) = (ccsu @ (cco @ ccc0 @ (ccv @ Xy1) @ ccfzo) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ (ccv @ Xx3) @ (ccfv @ cc2 @ ccdig)) @ (cco @ cc2 @ (ccv @ Xk) @ ccexp) @ ccmul)))))) @ (^ [Xx3:$i] : ccn0)) => (((ccfv @ (ccv @ Xa) @ ccblen) = (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) => ((ccv @ Xa) = (ccsu @ (cco @ ccc0 @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ ccfzo) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ (ccv @ Xa) @ (ccfv @ cc2 @ ccdig)) @ (cco @ cc2 @ (ccv @ Xk) @ ccexp) @ ccmul)))))))))).
thf(anneom_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn) | (cwcel @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn0))))).
...
thf(adig0_ax,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XB2 @ ccn) & (cwcel @ XK @ ccz)) => ((cco @ XK @ ccc0 @ (ccfv @ XB2 @ ccdig)) = ccc0))))).
...
thf(ablen0_ax,axiom,((ccfv @ ccc0 @ ccblen) = cc1)).
thf(cnn0sumshdiglem1_conj,conjecture,(! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ ccn) => ((cwral @ (^ [Xa:$i] : (((ccfv @ (ccv @ Xa) @ ccblen) = (ccv @ Xy1)) => ((ccv @ Xa) = (ccsu @ (cco @ ccc0 @ (ccv @ Xy1) @ ccfzo) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ (ccv @ Xa) @ (ccfv @ cc2 @ ccdig)) @ (cco @ cc2 @ (ccv @ Xk) @ ccexp) @ ccmul)))))) @ (^ [Xa:$i] : ccn0)) => (cwral @ (^ [Xa:$i] : (((ccfv @ (ccv @ Xa) @ ccblen) = (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) => ((ccv @ Xa) = (ccsu @ (cco @ ccc0 @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ ccfzo) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ (ccv @ Xa) @ (ccfv @ cc2 @ ccdig)) @ (cco @ cc2 @ (ccv @ Xk) @ ccexp) @ ccmul)))))) @ (^ [Xa:$i] : ccn0)))))).
