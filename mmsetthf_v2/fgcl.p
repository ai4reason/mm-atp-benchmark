...
thf(aisfild_ax,axiom,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (! [Xz:$i] : (Xph => ((cwcel @ (ccv @ Xx3) @ XF) <=> ((cwss @ (ccv @ Xx3) @ XA2) & (Xps @ Xx3 @ Xz)))))) => ((Xph => (cwcel @ XA2 @ ccvv)) => ((! [Xz:$i] : (Xph => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ XA2))) => ((! [Xz:$i] : (Xph => (~ (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ cc0)))) => ((! [Xy1:$i] : (! [Xz:$i] : ((cw3a @ Xph @ (cwss @ (ccv @ Xy1) @ XA2) @ (cwss @ (ccv @ Xz) @ (ccv @ Xy1))) => ((cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xz)) => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xy1)))))) => ((! [Xy1:$i] : (! [Xz:$i] : ((cw3a @ Xph @ (cwss @ (ccv @ Xy1) @ XA2) @ (cwss @ (ccv @ Xz) @ XA2)) => (((cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xy1)) & (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccv @ Xz))) => (cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xz)) @ (ccin @ (ccv @ Xy1) @ (ccv @ Xz))))))) => (Xph => (cwcel @ XF @ (ccfv @ XA2 @ ccfil)))))))))))))).
...
thf(afbasne0_ax,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) => (cwne @ XF @ cc0))))).
...
thf(afbasssin_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XF @ (ccfv @ XX @ ccfbas)) @ (cwcel @ XA2 @ XF) @ (cwcel @ XB2 @ XF)) => (cwrex @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ (ccin @ XA2 @ XB2))) @ (^ [Xx3:$i] : XF)))))))).
...
thf(cfgcl_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccfbas)) => (cwcel @ (cco @ XX @ XF @ ccfg) @ (ccfv @ XX @ ccfil)))))).
