...
thf(afpmg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwf @ XA2 @ XB2 @ XF)) => (cwcel @ XF @ (cco @ XB2 @ XA2 @ ccpm))))))))).
thf(asyl5eqel_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((Xph => (cwcel @ XB2 @ XC)) => (Xph => (cwcel @ XA2 @ XC))))))))).
thf(aeqtri_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((XB2 = XC) => (XA2 = XC))))))).
thf(cwfo_tp,type,(cwfo : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aalgrflem_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cco @ XB2 @ XC @ (cccom @ XF @ cc1st)) = (ccfv @ XB2 @ XF)))))))).
...
thf(advnfval_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ XS @ (ccv @ Xx3) @ ccdv))))) => (! [Xx3:$i] : (((cwss @ XS @ ccc) & (cwcel @ XF @ (cco @ ccc @ XS @ ccpm))) => ((cco @ XS @ XF @ ccdvn) = (ccseq @ (cccom @ (XG @ Xx3) @ cc1st) @ (ccxp @ ccn0 @ (ccsn @ XF)) @ ccc0))))))))).
thf(cdvnff_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XS @ (ccpr @ ccr @ ccc)) & (cwcel @ XF @ (cco @ ccc @ XS @ ccpm))) => (cwf @ ccn0 @ (cco @ ccc @ (ccdm @ XF) @ ccpm) @ (cco @ XS @ XF @ ccdvn)))))).
