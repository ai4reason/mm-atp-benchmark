...
thf(cunblimceq0lem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xc:$i] : (Xph => (cwss @ (XS @ Xc) @ ccc))) => ((! [Xc:$i] : (Xph => (cwf @ (XS @ Xc) @ ccc @ (XF @ Xc)))) => ((! [Xc:$i] : (Xph => (cwcel @ (XA2 @ Xc) @ ccc))) => ((! [Xc:$i] : (Xph => (cwral @ (^ [Xb:$i] : (cwral @ (^ [Xd:$i] : (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ (XA2 @ Xc) @ ccmin) @ ccabs) @ (ccv @ Xd) @ cclt) & (cwbr @ (ccv @ Xb) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XF @ Xc)) @ ccabs) @ ccle))) @ (^ [Xx3:$i] : (XS @ Xc)))) @ (^ [Xd:$i] : ccrp))) @ (^ [Xb:$i] : ccrp)))) => (Xph => (cwral @ (^ [Xc:$i] : (cwral @ (^ [Xd:$i] : (cwrex @ (^ [Xy1:$i] : (cw3a @ (cwne @ (ccv @ Xy1) @ (XA2 @ Xc)) @ (cwbr @ (ccfv @ (cco @ (ccv @ Xy1) @ (XA2 @ Xc) @ ccmin) @ ccabs) @ (ccv @ Xd) @ cclt) @ (cwbr @ (ccv @ Xc) @ (ccfv @ (ccfv @ (ccv @ Xy1) @ (XF @ Xc)) @ ccabs) @ ccle))) @ (^ [Xy1:$i] : (XS @ Xc)))) @ (^ [Xd:$i] : ccrp))) @ (^ [Xc:$i] : ccrp)))))))))))).
