...
thf(cwuntp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : ((Xph => (cwcel @ XU @ ccwun)) => ((Xph => (cwcel @ XA2 @ XU)) => ((Xph => (cwcel @ XB2 @ XU)) => ((Xph => (cwcel @ XC @ XU)) => (Xph => (cwcel @ (cctp @ XA2 @ XB2 @ XC) @ XU)))))))))))).
