...
thf(acolinearalg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee))) => ((cw3o @ (cwbr @ XA2 @ (ccop @ XB2 @ XC) @ ccbtwn) @ (cwbr @ XB2 @ (ccop @ XC @ XA2) @ ccbtwn) @ (cwbr @ XC @ (ccop @ XA2 @ XB2) @ ccbtwn)) <=> (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : ((cco @ (cco @ (ccfv @ (ccv @ Xi) @ XB2) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmin) @ (cco @ (ccfv @ (ccv @ Xj) @ XC) @ (ccfv @ (ccv @ Xj) @ XA2) @ ccmin) @ ccmul) = (cco @ (cco @ (ccfv @ (ccv @ Xj) @ XB2) @ (ccfv @ (ccv @ Xj) @ XA2) @ ccmin) @ (cco @ (ccfv @ (ccv @ Xi) @ XC) @ (ccfv @ (ccv @ Xi) @ XA2) @ ccmin) @ ccmul))) @ (^ [Xj:$i] : (cco @ cc1 @ XN @ ccfz)))) @ (^ [Xi:$i] : (cco @ cc1 @ XN @ ccfz)))))))))).
...
thf(caxlowdimlem6_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (ccun @ (ccpr @ (ccop @ cc1 @ ccc0) @ (ccop @ cc2 @ ccc0)) @ (ccxp @ (cco @ cc3 @ XN @ ccfz) @ (ccsn @ ccc0)))) => ((XB2 = (ccun @ (ccpr @ (ccop @ cc1 @ cc1) @ (ccop @ cc2 @ ccc0)) @ (ccxp @ (cco @ cc3 @ XN @ ccfz) @ (ccsn @ ccc0)))) => ((XC = (ccun @ (ccpr @ (ccop @ cc1 @ ccc0) @ (ccop @ cc2 @ cc1)) @ (ccxp @ (cco @ cc3 @ XN @ ccfz) @ (ccsn @ ccc0)))) => ((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) => (~ (cw3o @ (cwbr @ XA2 @ (ccop @ XB2 @ XC) @ ccbtwn) @ (cwbr @ XB2 @ (ccop @ XC @ XA2) @ ccbtwn) @ (cwbr @ XC @ (ccop @ XA2 @ XB2) @ ccbtwn)))))))))))).
