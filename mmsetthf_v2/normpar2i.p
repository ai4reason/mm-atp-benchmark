...
thf(ahvsubcan2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cco @ (cco @ XA2 @ XB2 @ ccva) @ (cco @ XA2 @ XB2 @ ccmv) @ ccva) = (cco @ cc2 @ XA2 @ ccsm))))))).
...
thf(anormpari_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno) @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccva) @ ccno) @ cc2 @ ccexp) @ ccaddc) = (cco @ (cco @ cc2 @ (cco @ (ccfv @ XA2 @ ccno) @ cc2 @ ccexp) @ ccmul) @ (cco @ cc2 @ (cco @ (ccfv @ XB2 @ ccno) @ cc2 @ ccexp) @ ccmul) @ ccaddc))))))).
