...
thf(asncld_ax,axiom,(! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ ccha) & (cwcel @ XP @ XX)) => (cwcel @ (ccsn @ XP) @ (ccfv @ XJ @ cccld)))))))).
...
thf(cabelth_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > $o)] : ((! [Xz:$i] : ((Xph @ Xz) => (cwf @ ccn0 @ ccc @ XA2))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ (ccseq @ ccaddc @ XA2 @ ccc0) @ (ccdm @ ccli)))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XM @ ccr))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwbr @ ccc0 @ XM @ ccle))) => ((! [Xz:$i] : ((XS @ Xz) = (ccrab @ (^ [Xz:$i] : (cwbr @ (ccfv @ (cco @ cc1 @ (ccv @ Xz) @ ccmin) @ ccabs) @ (cco @ XM @ (cco @ cc1 @ (ccfv @ (ccv @ Xz) @ ccabs) @ ccmin) @ ccmul) @ ccle)) @ (^ [Xz:$i] : ccc)))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xn:$i] : ((XF @ Xx3 @ Xz @ Xn) = (ccmpt @ (^ [Xx3:$i] : (XS @ Xz)) @ (^ [Xx3:$i] : (ccsu @ ccn0 @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ XA2) @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccexp) @ ccmul))))))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xn:$i] : ((Xph @ Xz) => (cwcel @ (XF @ Xx3 @ Xz @ Xn) @ (cco @ (XS @ Xz) @ ccc @ cccncf)))))))))))))))))).
