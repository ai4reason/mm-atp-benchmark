...
thf(asyl6mpi_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => (Xps => Xch)) => (Xth => ((Xch => (Xth => Xta)) => (Xph => (Xps => Xta))))))))))).
...
thf(aee121_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xph => Xps) => ((Xph => (Xch => Xth)) => ((Xph => Xta) => ((Xps => (Xth => (Xta => Xet))) => (Xph => (Xch => Xet))))))))))))).
thf(aee122_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xph => Xps) => ((Xph => (Xch => Xth)) => ((Xph => (Xch => Xta)) => ((Xps => (Xth => (Xta => Xet))) => (Xph => (Xch => Xet))))))))))))).
...
thf(ctratrb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwtr @ XA2) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cw3o @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)) @ ((ccv @ Xx3) = (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ (cwcel @ XB2 @ XA2)) => (cwtr @ XB2))))).
