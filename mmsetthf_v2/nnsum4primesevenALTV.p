...
thf(aeluzsub_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XK @ ccz) @ (cwcel @ XN @ (ccfv @ (cco @ XM @ XK @ ccaddc) @ ccuz))) => (cwcel @ (cco @ XN @ XK @ ccmin) @ (ccfv @ XM @ ccuz))))))).
...
thf(aemoo_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cceven) & (cwcel @ XB2 @ ccodd)) => (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ ccodd))))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(cctp_tp,type,(cctp : (($i > $o) > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(annsum4primesoddALTV_ax,axiom,(! [XN:($i > $o)] : ((cwral @ (^ [Xm:$i] : ((cwbr @ cc7 @ (ccv @ Xm) @ cclt) => (cwcel @ (ccv @ Xm) @ ccgbo))) @ (^ [Xm:$i] : ccodd)) => (((cwcel @ XN @ (ccfv @ cc8 @ ccuz)) & (cwcel @ XN @ ccodd)) => (cwrex @ (^ [Xf1:$i] : (XN = (ccsu @ (cco @ cc1 @ cc3 @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ cc3 @ ccfz) @ ccmap))))))).
...
thf(afsnunf_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwf @ XS @ XT @ XF) @ ((cwcel @ XX @ XV) & (~ (cwcel @ XX @ XS))) @ (cwcel @ XY @ XT)) => (cwf @ (ccun @ XS @ (ccsn @ XX)) @ XT @ (ccun @ XF @ (ccsn @ (ccop @ XX @ XY)))))))))))).
...
thf(aevengpoap3_ax,axiom,(! [XN:($i > $o)] : ((cwral @ (^ [Xm:$i] : ((cwbr @ cc7 @ (ccv @ Xm) @ cclt) => (cwcel @ (ccv @ Xm) @ ccgbo))) @ (^ [Xm:$i] : ccodd)) => (((cwcel @ XN @ (ccfv @ (ccdc @ cc1 @ cc2) @ ccuz)) & (cwcel @ XN @ cceven)) => (cwrex @ (^ [Xo:$i] : (XN = (cco @ (ccv @ Xo) @ cc3 @ ccaddc))) @ (^ [Xo:$i] : ccgbo)))))).
