...
thf(adissnlocfin_ax,axiom,(! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XC = (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xu) = (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XX))))) => ((cwcel @ XX @ XV) => (cwcel @ XC @ (ccfv @ (ccpw @ XX) @ cclocfin)))))))).
...
thf(adissnref_ax,axiom,(! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XC = (ccab @ (^ [Xu:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xu) = (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XX))))) => (((cwcel @ XX @ XV) & ((ccuni @ XY) = XX)) => (cwbr @ XC @ XY @ ccref)))))))).
...
thf(aispcmp_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ ccpcmp) <=> (cwcel @ XJ @ (cccref @ (ccfv @ XJ @ cclocfin)))))).
