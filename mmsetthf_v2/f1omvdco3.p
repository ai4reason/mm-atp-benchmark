...
thf(af1omvdco2_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwf1o @ XA2 @ XA2 @ XF) @ (cwf1o @ XA2 @ XA2 @ XG) @ (cwxo @ (cwss @ (ccdm @ (ccdif @ XF @ ccid)) @ XX) @ (cwss @ (ccdm @ (ccdif @ XG @ ccid)) @ XX))) => (~ (cwss @ (ccdm @ (ccdif @ (cccom @ XF @ XG) @ ccid)) @ XX)))))))).
thf(acon2bii_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph <=> (~ Xps)) => (Xps <=> (~ Xph)))))).
thf(cf1omvdco3_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwf1o @ XA2 @ XA2 @ XF) @ (cwf1o @ XA2 @ XA2 @ XG) @ (cwxo @ (cwcel @ XX @ (ccdm @ (ccdif @ XF @ ccid))) @ (cwcel @ XX @ (ccdm @ (ccdif @ XG @ ccid))))) => (cwcel @ XX @ (ccdm @ (ccdif @ (cccom @ XF @ XG) @ ccid))))))))).
