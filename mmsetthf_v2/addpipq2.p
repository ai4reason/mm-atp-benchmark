...
thf(caddpipq2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccxp @ ccnpi @ ccnpi)) & (cwcel @ XB2 @ (ccxp @ ccnpi @ ccnpi))) => ((cco @ XA2 @ XB2 @ ccplpq) = (ccop @ (cco @ (cco @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XB2 @ cc2nd) @ ccmi) @ (cco @ (ccfv @ XB2 @ cc1st) @ (ccfv @ XA2 @ cc2nd) @ ccmi) @ ccpli) @ (cco @ (ccfv @ XA2 @ cc2nd) @ (ccfv @ XB2 @ cc2nd) @ ccmi))))))).
