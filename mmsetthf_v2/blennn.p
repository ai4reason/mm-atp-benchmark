...
thf(ablenn0_ax,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XN @ XV) & (cwne @ XN @ ccc0)) => ((ccfv @ XN @ ccblen) = (cco @ (ccfv @ (cco @ cc2 @ (ccfv @ XN @ ccabs) @ cclogb) @ ccfl) @ cc1 @ ccaddc)))))).
...
thf(cblennn_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((ccfv @ XN @ ccblen) = (cco @ (ccfv @ (cco @ cc2 @ XN @ cclogb) @ ccfl) @ cc1 @ ccaddc))))).
