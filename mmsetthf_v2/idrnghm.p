...
thf(aidmgmhm_ax,axiom,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((cwcel @ XM @ ccmgm) => (cwcel @ (ccres @ ccid @ XB2) @ (cco @ XM @ XM @ ccmgmhm))))))).
...
thf(cidrnghm_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((cwcel @ XR @ ccrng) => (cwcel @ (ccres @ ccid @ XB2) @ (cco @ XR @ XR @ ccrngh))))))).
