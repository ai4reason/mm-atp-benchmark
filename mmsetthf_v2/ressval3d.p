...
thf(asetsidvald_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XE = (ccslot @ XN)) => ((cwcel @ XN @ ccn) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwfun @ XS)) => ((Xph => (cwcel @ (ccfv @ ccnx @ XE) @ (ccdm @ XS))) => (Xph => (XS = (cco @ XS @ (ccop @ (ccfv @ ccnx @ XE) @ (ccfv @ XS @ XE)) @ ccsts)))))))))))))).
