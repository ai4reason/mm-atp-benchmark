...
thf(arhmdvd_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XU = (ccfv @ XS @ ccui)) => ((XX = (ccfv @ XR @ ccbs)) => ((Xc_dv = (ccfv @ XS @ ccdvr)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((cw3a @ (cwcel @ XF @ (cco @ XR @ XS @ ccrh)) @ (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX)) @ ((cwcel @ (ccfv @ XB2 @ XF) @ XU) & (cwcel @ (ccfv @ XC @ XF) @ XU))) => ((cco @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ Xc_dv) = (cco @ (ccfv @ (cco @ XA2 @ XC @ Xc_x) @ XF) @ (ccfv @ (cco @ XB2 @ XC @ Xc_x) @ XF) @ Xc_dv)))))))))))))))))).
...
thf(adivnumden_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccn)) => (((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccnumer) = (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv)) & ((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccdenom) = (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv))))))).
...
thf(adivnumden2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ (ccneg @ XB2) @ ccn)) => (((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccnumer) = (ccneg @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv))) & ((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccdenom) = (ccneg @ (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv)))))))).
