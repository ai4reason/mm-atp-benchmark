...
thf(aswrd0fv_ax,axiom,(! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XL @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz)) @ (cwcel @ XI @ (cco @ ccc0 @ XL @ ccfzo))) => ((ccfv @ XI @ (cco @ XW @ (ccop @ ccc0 @ XL) @ ccsubstr)) = (ccfv @ XI @ XW)))))))).
thf(asyl5ib_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xch => (Xps <=> Xth)) => (Xch => (Xph => Xth))))))))).
thf(afzonn0p1p1_ax,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XI @ (cco @ ccc0 @ XN @ ccfzo)) => (cwcel @ (cco @ XI @ cc1 @ ccaddc) @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccaddc) @ ccfzo)))))).
