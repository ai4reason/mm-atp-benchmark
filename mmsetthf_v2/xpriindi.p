...
thf(axpindi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccxp @ XA2 @ (ccin @ XB2 @ XC)) = (ccin @ (ccxp @ XA2 @ XB2) @ (ccxp @ XA2 @ XC))))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(cwrel_tp,type,(cwrel : (($i > $o) > $o))).
thf(axpiindi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((cwne @ XA2 @ cc0) => ((ccxp @ XC @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) = (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ XC @ (XB2 @ Xx3)))))))))).
thf(cxpriindi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [Xx3:$i] : ((ccxp @ XC @ (ccin @ (XD @ Xx3) @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) = (ccin @ (ccxp @ XC @ (XD @ Xx3)) @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ XC @ (XB2 @ Xx3)))))))))))).
