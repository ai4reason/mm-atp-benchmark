...
thf(ciccshift_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((! [Xw:$i] : ((Xph @ Xw) => (cwcel @ XA2 @ ccr))) => ((! [Xw:$i] : ((Xph @ Xw) => (cwcel @ XB2 @ ccr))) => ((! [Xw:$i] : ((Xph @ Xw) => (cwcel @ XT @ ccr))) => (! [Xw:$i] : ((Xph @ Xw) => ((cco @ (cco @ XA2 @ XT @ ccaddc) @ (cco @ XB2 @ XT @ ccaddc) @ ccicc) = (ccrab @ (^ [Xw:$i] : (cwrex @ (^ [Xz:$i] : ((ccv @ Xw) = (cco @ (ccv @ Xz) @ XT @ ccaddc))) @ (^ [Xz:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xw:$i] : ccc))))))))))))).
