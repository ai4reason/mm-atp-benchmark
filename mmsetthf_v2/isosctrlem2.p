...
thf(anegrebd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ (ccneg @ XA2) @ ccr)) => (Xph => (cwcel @ XA2 @ ccr))))))).
...
thf(acjnegd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => (Xph => ((ccfv @ (ccneg @ XA2) @ cccj) = (ccneg @ (ccfv @ XA2 @ cccj)))))))).
...
thf(aisosctrlem1_ax,axiom,(! [XA2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ ((ccfv @ XA2 @ ccabs) = cc1) @ (~ (cc1 = XA2))) => (cwne @ (ccfv @ (ccfv @ (cco @ cc1 @ XA2 @ ccmin) @ cclog) @ ccim) @ ccpi)))).
thf(alogrec_ax,axiom,(! [XA2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwne @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ ccpi)) => ((ccfv @ XA2 @ cclog) = (ccneg @ (ccfv @ (cco @ cc1 @ XA2 @ ccdiv) @ cclog)))))).
...
thf(cisosctrlem2_conj,conjecture,(! [XA2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ ((ccfv @ XA2 @ ccabs) = cc1) @ (~ (cc1 = XA2))) => ((ccfv @ (ccfv @ (cco @ cc1 @ XA2 @ ccmin) @ cclog) @ ccim) = (ccfv @ (ccfv @ (cco @ (ccneg @ XA2) @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv) @ cclog) @ ccim))))).
