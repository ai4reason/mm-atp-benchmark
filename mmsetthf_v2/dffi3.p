...
thf(adffi2_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((ccfv @ XA2 @ ccfi) = (ccint @ (ccab @ (^ [Xz:$i] : ((cwss @ XA2 @ (ccv @ Xz)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz))) @ (^ [Xy1:$i] : (ccv @ Xz)))) @ (^ [Xx3:$i] : (ccv @ Xz))))))))))))).
...
thf(afr0g_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ XB2) => ((ccfv @ cc0 @ (ccres @ (ccrdg @ XF @ XA2) @ ccom)) = XA2)))))).
...
thf(aonsseleq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((cwss @ XA2 @ XB2) <=> ((cwcel @ XA2 @ XB2) | (XA2 = XB2))))))).
...
thf(cdffi3_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xz:$i] : (! [Xu:$i] : ((XR @ Xz @ Xu) = (ccmpt @ (^ [Xu:$i] : ccvv) @ (^ [Xu:$i] : (ccrn @ (ccmpt2 @ (^ [Xy1:$i] : (^ [Xz:$i] : (ccv @ Xu))) @ (^ [Xy1:$i] : (^ [Xz:$i] : (ccv @ Xu))) @ (^ [Xy1:$i] : (^ [Xz:$i] : (ccin @ (ccv @ Xy1) @ (ccv @ Xz))))))))))) => (! [Xz:$i] : (! [Xu:$i] : ((cwcel @ (XA2 @ Xz @ Xu) @ (XV @ Xz @ Xu)) => ((ccfv @ (XA2 @ Xz @ Xu) @ ccfi) = (ccuni @ (ccima @ (ccrdg @ (XR @ Xz @ Xu) @ (XA2 @ Xz @ Xu)) @ ccom))))))))))).
