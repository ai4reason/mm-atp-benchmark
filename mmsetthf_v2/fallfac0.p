...
thf(afallrisefac_ax,axiom,(! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ ccc) & (cwcel @ XN @ ccn0)) => ((cco @ XX @ XN @ ccfallfac) = (cco @ (cco @ (ccneg @ cc1) @ XN @ ccexp) @ (cco @ (ccneg @ XX) @ XN @ ccrisefac) @ ccmul)))))).
...
thf(arisefac0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ XA2 @ ccc0 @ ccrisefac) = cc1)))).
thf(a_1t1e1_ax,axiom,((cco @ cc1 @ cc1 @ ccmul) = cc1)).
thf(cfallfac0_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ XA2 @ ccc0 @ ccfallfac) = cc1)))).
