...
thf(amat1f_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((XK = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : ((XA2 @ Xx3) = (cco @ (ccsn @ XE) @ XR @ ccmat))) => ((! [Xx3:$i] : (XB2 = (ccfv @ (XA2 @ Xx3) @ ccbs))) => ((XO = (ccop @ XE @ XE)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XK) @ (^ [Xx3:$i] : (ccsn @ (ccop @ XO @ (ccv @ Xx3))))))) => (! [Xx3:$i] : (((cwcel @ XR @ ccrg) & (cwcel @ XE @ XV)) => (cwf @ XK @ XB2 @ (XF @ Xx3)))))))))))))))))).
...
thf(agsumsnd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xk:$i] : ((XB2 @ Xk) = (ccfv @ (XG @ Xk) @ ccbs))) => ((! [Xk:$i] : (Xph => (cwcel @ (XG @ Xk) @ ccmnd))) => ((! [Xk:$i] : (Xph => (cwcel @ XM @ (XV @ Xk)))) => ((! [Xk:$i] : (Xph => (cwcel @ XC @ (XB2 @ Xk)))) => ((! [Xk:$i] : ((Xph & ((ccv @ Xk) = XM)) => ((XA2 @ Xk) = XC))) => (! [Xk:$i] : (Xph => ((cco @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : (ccsn @ XM)) @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccgsu) = XC)))))))))))))))).
...
thf(amat1rhmcl_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XK = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : ((XA2 @ Xx3) = (cco @ (ccsn @ XE) @ XR @ ccmat))) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccfv @ (XA2 @ Xx3) @ ccbs))) => ((XO = (ccop @ XE @ XE)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XK) @ (^ [Xx3:$i] : (ccsn @ (ccop @ XO @ (ccv @ Xx3))))))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XE @ XV) @ (cwcel @ XX @ XK)) => (cwcel @ (ccfv @ XX @ (XF @ Xx3)) @ (XB2 @ Xx3))))))))))))))))))).
...
thf(amat1rhmelval_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XK = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : ((XA2 @ Xx3) = (cco @ (ccsn @ XE) @ XR @ ccmat))) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccfv @ (XA2 @ Xx3) @ ccbs))) => ((XO = (ccop @ XE @ XE)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XK) @ (^ [Xx3:$i] : (ccsn @ (ccop @ XO @ (ccv @ Xx3))))))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XE @ XV) @ (cwcel @ XX @ XK)) => ((cco @ XE @ XE @ (ccfv @ XX @ (XF @ Xx3))) = XX)))))))))))))))))).
thf(amatmulcell_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [Xc_xp:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xj:$i] : ((XA2 @ Xj) = (cco @ XN @ XR @ ccmat))) => ((! [Xj:$i] : (XB2 = (ccfv @ (XA2 @ Xj) @ ccbs))) => ((! [Xj:$i] : ((Xc_x @ Xj) = (ccfv @ XR @ ccmulr))) => ((! [Xj:$i] : ((Xc_xp @ Xj) = (ccfv @ (XA2 @ Xj) @ ccmulr))) => (! [Xj:$i] : ((cw3a @ (cwcel @ XR @ ccrg) @ ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) @ ((cwcel @ XI @ XN) & (cwcel @ XJ @ XN))) => ((cco @ XI @ XJ @ (cco @ XX @ XY @ (Xc_xp @ Xj))) = (cco @ XR @ (ccmpt @ (^ [Xj:$i] : XN) @ (^ [Xj:$i] : (cco @ (cco @ XI @ (ccv @ Xj) @ XX) @ (cco @ (ccv @ Xj) @ XJ @ XY) @ (ccfv @ XR @ ccmulr)))) @ ccgsu))))))))))))))))))).
thf(asylancom_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => (((Xch & Xps) => Xth) => ((Xph & Xps) => Xth)))))))).
thf(a_2ralsng_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xy1) = XB2) => ((Xps @ Xy1) <=> (Xch @ Xx3))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XA2 @ (XV @ Xx3 @ Xy1)) & (cwcel @ XB2 @ (XW @ Xx3 @ Xy1))) => ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (ccsn @ XB2)))) @ (^ [Xx3:$i] : (ccsn @ XA2))) <=> (Xch @ Xx3))))))))))))))).
...
thf(amat1rhmval_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XK = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : ((XA2 @ Xx3) = (cco @ (ccsn @ XE) @ XR @ ccmat))) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccfv @ (XA2 @ Xx3) @ ccbs))) => ((XO = (ccop @ XE @ XE)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XK) @ (^ [Xx3:$i] : (ccsn @ (ccop @ XO @ (ccv @ Xx3))))))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XE @ XV) @ (cwcel @ XX @ XK)) => ((ccfv @ XX @ (XF @ Xx3)) = (ccsn @ (ccop @ XO @ XX)))))))))))))))))))).
thf(amat1dimid_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (cco @ (ccsn @ XE) @ XR @ ccmat)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XO = (ccop @ XE @ XE)) => (((cwcel @ XR @ ccrg) & (cwcel @ XE @ XV)) => ((ccfv @ XA2 @ ccur) = (ccsn @ (ccop @ XO @ (ccfv @ XR @ ccur))))))))))))))).
...
thf(cmat1mhm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((XK = (ccfv @ XR @ ccbs)) => ((XA2 = (cco @ (ccsn @ XE) @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XO = (ccop @ XE @ XE)) => ((XF = (ccmpt @ (^ [Xx3:$i] : XK) @ (^ [Xx3:$i] : (ccsn @ (ccop @ XO @ (ccv @ Xx3)))))) => ((XM = (ccfv @ XR @ ccmgp)) => ((XN = (ccfv @ XA2 @ ccmgp)) => (((cwcel @ XR @ ccrg) & (cwcel @ XE @ XV)) => (cwcel @ XF @ (cco @ XM @ XN @ ccmhm))))))))))))))))))))).
