...
thf(ccxplea_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ ((cwcel @ XA2 @ ccr) & (cwbr @ cc1 @ XA2 @ ccle)) @ ((cwcel @ XB2 @ ccr) & (cwcel @ XC @ ccr)) @ (cwbr @ XB2 @ XC @ ccle)) => (cwbr @ (cco @ XA2 @ XB2 @ cccxp) @ (cco @ XA2 @ XC @ cccxp) @ ccle)))))).
