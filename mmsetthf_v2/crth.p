...
thf(ccrth_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XS = (cco @ ccc0 @ (cco @ XM @ XN @ ccmul) @ ccfzo)) => ((XT = (ccxp @ (cco @ ccc0 @ XM @ ccfzo) @ (cco @ ccc0 @ XN @ ccfzo))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (ccop @ (cco @ (ccv @ Xx3) @ XM @ ccmo) @ (cco @ (ccv @ Xx3) @ XN @ ccmo)))))) => ((Xph => (cw3a @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn) @ ((cco @ XM @ XN @ ccgcd) = cc1))) => (! [Xx3:$i] : (Xph => (cwf1o @ XS @ XT @ (XF @ Xx3))))))))))))))).
