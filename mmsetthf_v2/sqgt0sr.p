...
thf(amulasssr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cco @ (cco @ XA2 @ XB2 @ ccmr) @ XC @ ccmr) = (cco @ XA2 @ (cco @ XB2 @ XC @ ccmr) @ ccmr)))))).
thf(am1m1sr_ax,axiom,((cco @ ccm1r @ ccm1r @ ccmr) = cc1r)).
thf(a_1idsr_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccnr) => ((cco @ XA2 @ cc1r @ ccmr) = XA2)))).
thf(aa1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(csqgt0sr_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccnr) & (cwne @ XA2 @ cc0r)) => (cwbr @ cc0r @ (cco @ XA2 @ XA2 @ ccmr) @ ccltr)))).
