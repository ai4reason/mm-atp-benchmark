...
thf(aisfin6_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfin6) <=> ((cwbr @ XA2 @ cc2o @ ccsdm) | (cwbr @ XA2 @ (ccxp @ XA2 @ XA2) @ ccsdm))))).
...
thf(afin17_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfn) => (cwcel @ XA2 @ ccfin7)))).
...
thf(ainfxpidm2_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwbr @ ccom @ XA2 @ ccdom)) => (cwbr @ (ccxp @ XA2 @ XA2) @ XA2 @ ccen)))).
...
thf(aisfin7_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : ((cwcel @ XA2 @ (XV @ Xy1)) => ((cwcel @ XA2 @ ccfin7) <=> (~ (cwrex @ (^ [Xy1:$i] : (cwbr @ XA2 @ (ccv @ Xy1) @ ccen)) @ (^ [Xy1:$i] : (ccdif @ ccon0 @ ccom)))))))))).
thf(cfin67_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfin6) => (cwcel @ XA2 @ ccfin7)))).
