...
thf(acnindis_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XA2 @ XV)) => ((cco @ XJ @ (ccpr @ cc0 @ XA2) @ cccn) = (cco @ XA2 @ XX @ ccmap)))))))).
...
thf(cindishmph_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) => (cwbr @ (ccpr @ cc0 @ XA2) @ (ccpr @ cc0 @ XB2) @ cchmph))))).
