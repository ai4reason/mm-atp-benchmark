...
thf(ccayleyth_conj,conjecture,(! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XH = (ccfv @ XX @ ccsymg)) => ((cwcel @ XG @ ccgrp) => (cwrex @ (^ [Xs1:$i] : (cwrex @ (^ [Xf1:$i] : (cwf1o @ XX @ (ccv @ Xs1) @ (ccv @ Xf1))) @ (^ [Xf1:$i] : (cco @ XG @ (cco @ XH @ (ccv @ Xs1) @ ccress) @ ccghm)))) @ (^ [Xs1:$i] : (ccfv @ XH @ ccsubg)))))))))).
