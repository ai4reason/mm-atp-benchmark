...
thf(admdbr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((cwbr @ XA2 @ XB2 @ ccdmd) <=> (cwral @ (^ [Xx3:$i] : ((cwss @ XB2 @ (ccv @ Xx3)) => ((cco @ (ccin @ (ccv @ Xx3) @ XA2) @ XB2 @ cchj) = (ccin @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ cchj))))) @ (^ [Xx3:$i] : ccch))))))).
...
thf(cdmdi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) & ((cwbr @ XA2 @ XB2 @ ccdmd) & (cwss @ XB2 @ XC))) => ((cco @ (ccin @ XC @ XA2) @ XB2 @ cchj) = (ccin @ XC @ (cco @ XA2 @ XB2 @ cchj)))))))).
