...
thf(azringinvg_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccz) => ((ccneg @ XA2) = (ccfv @ XA2 @ (ccfv @ czring @ ccminusg)))))).
thf(azrh1_ax,axiom,(! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XL:($i > $o)] : ((XL = (ccfv @ XR @ cczrh)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((cwcel @ XR @ ccrg) => ((ccfv @ cc1 @ XL) = Xc_1)))))))).
thf(czrhpsgnodpm_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XR @ cczrh)) => ((XS = (ccfv @ XN @ ccpsgn)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((XP = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((XI = (ccfv @ XR @ ccminusg)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XN @ ccfn) @ (cwcel @ XF @ (ccdif @ XP @ (ccfv @ XN @ ccevpm)))) => ((ccfv @ XF @ (cccom @ XY @ XS)) = (ccfv @ Xc_1 @ XI))))))))))))))))).
