...
thf(awlkwwlkfun_ax,axiom,(! [XP:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xp:$i] : ((XT @ Xp) = (ccrab @ (^ [Xp:$i] : (((ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) = XN) & ((ccfv @ ccc0 @ (ccfv @ (ccv @ Xp) @ cc2nd)) = XP))) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks))))) => ((! [Xw:$i] : (! [Xp:$i] : ((XW @ Xw @ Xp) = (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = XP)) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn)))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xp:$i] : ((XF @ Xw @ Xt @ Xp) = (ccmpt @ (^ [Xt:$i] : (XT @ Xp)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ cc2nd))))))) => (! [Xw:$i] : (! [Xt:$i] : (! [Xp:$i] : ((cw3a @ (cwcel @ XG @ ccupgr) @ (cwcel @ XP @ (XV @ Xw @ Xp)) @ (cwcel @ XN @ ccn0)) => (cwf @ (XT @ Xp) @ (XW @ Xw @ Xp) @ (XF @ Xw @ Xt @ Xp))))))))))))))))).
