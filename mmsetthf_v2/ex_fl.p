...
thf(altnegi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (ccneg @ XB2) @ (ccneg @ XA2) @ cclt))))))).
...
thf(altnegcon1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwbr @ (ccneg @ XA2) @ XB2 @ cclt) <=> (cwbr @ (ccneg @ XB2) @ XA2 @ cclt))))))).
...
thf(cex_fl_conj,conjecture,(((ccfv @ (cco @ cc3 @ cc2 @ ccdiv) @ ccfl) = cc1) & ((ccfv @ (ccneg @ (cco @ cc3 @ cc2 @ ccdiv)) @ ccfl) = (ccneg @ cc2)))).
