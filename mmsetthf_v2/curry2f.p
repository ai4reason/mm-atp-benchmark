...
thf(ccurry2f_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (cccom @ XF @ (cccnv @ (ccres @ cc1st @ (ccxp @ ccvv @ (ccsn @ XC)))))) => (((cwf @ (ccxp @ XA2 @ XB2) @ XD @ XF) & (cwcel @ XC @ XB2)) => (cwf @ XA2 @ XD @ XG)))))))))).
