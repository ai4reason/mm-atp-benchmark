...
thf(amod2xnegi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XA2 @ ccn) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XD @ ccz) => ((cwcel @ XK @ ccn) => ((cwcel @ XM @ ccn0) => ((cwcel @ XL @ ccn0) => (((cco @ (cco @ XA2 @ XB2 @ ccexp) @ XN @ ccmo) = (cco @ XL @ XN @ ccmo)) => (((cco @ cc2 @ XB2 @ ccmul) = XE) => (((cco @ XL @ XK @ ccaddc) = XN) => (((cco @ (cco @ XD @ XN @ ccmul) @ XM @ ccaddc) = (cco @ XK @ XK @ ccmul)) => ((cco @ (cco @ XA2 @ XE @ ccexp) @ XN @ ccmo) = (cco @ XM @ XN @ ccmo))))))))))))))))))))).
...
thf(a_1259lem3_ax,axiom,(! [XN:($i > $o)] : ((XN = (ccdc @ (ccdc @ (ccdc @ cc1 @ cc2) @ cc5) @ cc9)) => ((cco @ (cco @ cc2 @ (ccdc @ cc7 @ cc6) @ ccexp) @ XN @ ccmo) = (cco @ cc5 @ XN @ ccmo))))).
...
thf(adecsucc_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XA2 @ ccn0) => (((cco @ XA2 @ cc1 @ ccaddc) = XB2) => ((XN = (ccdc @ XA2 @ cc9)) => ((cco @ XN @ cc1 @ ccaddc) = (ccdc @ XB2 @ ccc0))))))))).
...
thf(a_1259lem1_ax,axiom,(! [XN:($i > $o)] : ((XN = (ccdc @ (ccdc @ (ccdc @ cc1 @ cc2) @ cc5) @ cc9)) => ((cco @ (cco @ cc2 @ (ccdc @ cc1 @ cc7) @ ccexp) @ XN @ ccmo) = (cco @ (ccdc @ (ccdc @ cc1 @ cc3) @ cc6) @ XN @ ccmo))))).
...
thf(c_1259lem4_conj,conjecture,(! [XN:($i > $o)] : ((XN = (ccdc @ (ccdc @ (ccdc @ cc1 @ cc2) @ cc5) @ cc9)) => ((cco @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ XN @ ccmo) = (cco @ cc1 @ XN @ ccmo))))).
