...
thf(ahashgcdeq_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn) & (cwcel @ XN @ ccn)) => ((ccfv @ (ccrab @ (^ [Xx3:$i] : ((cco @ (ccv @ Xx3) @ XM @ ccgcd) = XN)) @ (^ [Xx3:$i] : (cco @ ccc0 @ XM @ ccfzo))) @ cchash) = (ccif @ (cwbr @ XN @ XM @ ccdvds) @ (ccfv @ (cco @ XM @ XN @ ccdiv) @ ccphi) @ ccc0)))))).
