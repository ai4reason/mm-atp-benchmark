...
thf(atposfn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ (ccxp @ XA2 @ XB2)) => (cwfn @ (cctpos @ XF) @ (ccxp @ XB2 @ XA2))))))).
...
thf(aoppcid_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XC @ ccoppc)) => ((XB2 = (ccfv @ XC @ cccid)) => ((cwcel @ XC @ cccat) => ((ccfv @ XO @ cccid) = XB2)))))))).
