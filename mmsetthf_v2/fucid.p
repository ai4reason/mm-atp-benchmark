...
thf(afuccatid_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : ((XQ = (cco @ XC @ XD @ ccfuc)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XD @ cccat)) => ((! [Xf1:$i] : ((Xc_1 @ Xf1) = (ccfv @ XD @ cccid))) => (Xph => ((cwcel @ XQ @ cccat) & ((ccfv @ XQ @ cccid) = (ccmpt @ (^ [Xf1:$i] : (cco @ XC @ XD @ ccfunc)) @ (^ [Xf1:$i] : (cccom @ (Xc_1 @ Xf1) @ (ccfv @ (ccv @ Xf1) @ cc1st))))))))))))))))).
...
thf(cfucid_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : ((XQ = (cco @ XC @ XD @ ccfuc)) => ((XI = (ccfv @ XQ @ cccid)) => ((Xc_1 = (ccfv @ XD @ cccid)) => ((Xph => (cwcel @ XF @ (cco @ XC @ XD @ ccfunc))) => (Xph => ((ccfv @ XF @ XI) = (cccom @ Xc_1 @ (ccfv @ XF @ cc1st)))))))))))))))).
