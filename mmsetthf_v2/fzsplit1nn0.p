...
thf(cfzsplit1nn0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn0) @ (cwbr @ XA2 @ XB2 @ ccle)) => ((cco @ cc1 @ XB2 @ ccfz) = (ccun @ (cco @ cc1 @ XA2 @ ccfz) @ (cco @ (cco @ XA2 @ cc1 @ ccaddc) @ XB2 @ ccfz))))))).
