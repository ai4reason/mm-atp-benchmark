...
thf(cgeoreclim_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwbr @ cc1 @ (ccfv @ XA2 @ ccabs) @ cclt)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn0)) => ((ccfv @ (ccv @ Xk) @ XF) = (cco @ (cco @ cc1 @ XA2 @ ccdiv) @ (ccv @ Xk) @ ccexp)))) => (Xph => (cwbr @ (ccseq @ ccaddc @ XF @ ccc0) @ (cco @ XA2 @ (cco @ XA2 @ cc1 @ ccmin) @ ccdiv) @ ccli))))))))).
