...
thf(ariotaclbBAD_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) <=> (cwcel @ (ccrio @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ XA2)))))).
thf(aeqeltri_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwcel @ XB2 @ XC) => (cwcel @ XA2 @ XC))))))).
thf(ccio_tp,type,(ccio : (($i > $o) > ($i > $o)))).
thf(afvex_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(ariotaocN_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_pe = (ccfv @ XK @ ccoc)) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccfv @ (ccv @ Xy1) @ Xc_pe)) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => (((cwcel @ XK @ ccops) & (cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XB2))) => ((ccrio @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XB2)) = (ccfv @ (ccrio @ (^ [Xy1:$i] : (Xps @ Xy1)) @ (^ [Xy1:$i] : XB2)) @ Xc_pe)))))))))))).
...
thf(cglbconN_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [Xc_pe:($i > $o)] : ((! [Xx3:$i] : (XB2 = (ccfv @ (XK @ Xx3) @ ccbs))) => ((! [Xx3:$i] : ((XU @ Xx3) = (ccfv @ (XK @ Xx3) @ cclub))) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccfv @ (XK @ Xx3) @ ccglb))) => ((! [Xx3:$i] : (Xc_pe = (ccfv @ (XK @ Xx3) @ ccoc))) => (! [Xx3:$i] : (((cwcel @ (XK @ Xx3) @ cchlt) & (cwss @ XS @ XB2)) => ((ccfv @ XS @ (XG @ Xx3)) = (ccfv @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ Xc_pe) @ XS)) @ (^ [Xx3:$i] : XB2)) @ (XU @ Xx3)) @ Xc_pe))))))))))))))).
