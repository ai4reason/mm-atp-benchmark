...
thf(celcnop_conj,conjecture,(! [XT:($i > $o)] : ((cwcel @ XT @ cccop) <=> ((cwf @ cchil @ cchil @ XT) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((cwbr @ (ccfv @ (cco @ (ccv @ Xw) @ (ccv @ Xx3) @ ccmv) @ ccno) @ (ccv @ Xz) @ cclt) => (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xw) @ XT) @ (ccfv @ (ccv @ Xx3) @ XT) @ ccmv) @ ccno) @ (ccv @ Xy1) @ cclt))) @ (^ [Xw:$i] : cchil))) @ (^ [Xz:$i] : ccrp))) @ (^ [Xy1:$i] : ccrp))) @ (^ [Xx3:$i] : cchil)))))).
