...
thf(ctchclm_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XW @ cctch)) => ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xph => (cwcel @ XW @ ccphl)) => ((Xph => (XF = (cco @ cccnfld @ XK @ ccress))) => (Xph => (cwcel @ XW @ ccclm)))))))))))))).
