...
thf(cfzosubel2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ (cco @ (cco @ XB2 @ XC @ ccaddc) @ (cco @ XB2 @ XD @ ccaddc) @ ccfzo)) & (cw3a @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz) @ (cwcel @ XD @ ccz))) => (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XD @ ccfzo)))))))).
