...
thf(amonotoddzzfi_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccz)) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ ccr))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccz)) => ((ccfv @ (ccneg @ (ccv @ Xx3)) @ XF) = (ccneg @ (ccfv @ (ccv @ Xx3) @ XF))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ ccn0) @ (cwcel @ (ccv @ Xy1) @ ccn0)) => ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt) => (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ cclt))))) => ((cw3a @ Xph @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ cclt))))))))))).
...
thf(cmonotoddzz_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ ccn0) @ (cwcel @ (ccv @ Xy1) @ ccn0)) => ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt) => (cwbr @ (XE @ Xx3) @ (XF @ Xy1) @ cclt))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccz)) => (cwcel @ (XE @ Xx3) @ ccr))) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ ccz)) => ((XG @ Xy1) = (ccneg @ (XF @ Xy1))))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((XE @ Xx3) = XC))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XB2) => ((XE @ Xx3) = XD))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((XE @ Xx3) = (XF @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccneg @ (ccv @ Xy1))) => ((XE @ Xx3) = (XG @ Xy1))))) => ((cw3a @ Xph @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ XC @ XD @ cclt))))))))))))))))))).
