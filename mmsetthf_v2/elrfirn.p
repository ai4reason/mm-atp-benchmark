...
thf(aelrfi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XB2 @ XV) & (cwss @ XC @ (ccpw @ XB2))) => ((cwcel @ XA2 @ (ccfv @ (ccun @ (ccsn @ XB2) @ XC) @ ccfi)) <=> (cwrex @ (^ [Xv:$i] : (XA2 = (ccin @ XB2 @ (ccint @ (ccv @ Xv))))) @ (^ [Xv:$i] : (ccin @ (ccpw @ XC) @ ccfn)))))))))).
...
thf(aimaiinfv_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xx3:$i] : (((cwfn @ XF @ (XA2 @ Xx3)) & (cwss @ XB2 @ (XA2 @ Xx3))) => ((cciin @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))) = (ccint @ (ccima @ XF @ XB2))))))))).
thf(celrfirn_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : (((cwcel @ (XB2 @ Xy1) @ (XV @ Xy1)) & (cwf @ (XI @ Xy1) @ (ccpw @ (XB2 @ Xy1)) @ XF)) => ((cwcel @ (XA2 @ Xy1) @ (ccfv @ (ccun @ (ccsn @ (XB2 @ Xy1)) @ (ccrn @ XF)) @ ccfi)) <=> (cwrex @ (^ [Xv:$i] : ((XA2 @ Xy1) = (ccin @ (XB2 @ Xy1) @ (cciin @ (^ [Xy1:$i] : (ccv @ Xv)) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XF)))))) @ (^ [Xv:$i] : (ccin @ (ccpw @ (XI @ Xy1)) @ ccfn)))))))))))).
