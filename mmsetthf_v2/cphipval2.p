...
thf(acphassir_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XW @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((cw3a @ ((cwcel @ XW @ cccph) & (cwcel @ cci @ XK)) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) => ((cco @ XA2 @ (cco @ cci @ XB2 @ Xc_x) @ Xc_xi) = (cco @ (ccneg @ cci) @ (cco @ XA2 @ XB2 @ Xc_xi) @ ccmul))))))))))))))))).
thf(acphassi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XW @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((cw3a @ ((cwcel @ XW @ cccph) & (cwcel @ cci @ XK)) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) => ((cco @ (cco @ cci @ XB2 @ Xc_x) @ XA2 @ Xc_xi) = (cco @ cci @ (cco @ XB2 @ XA2 @ Xc_xi) @ ccmul))))))))))))))))).
