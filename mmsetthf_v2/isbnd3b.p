...
thf(aisbnd3_ax,axiom,(! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XM @ (ccfv @ XX @ ccbnd)) <=> ((cwcel @ XM @ (ccfv @ XX @ ccme)) & (cwrex @ (^ [Xx3:$i] : (cwf @ (ccxp @ XX @ XX) @ (cco @ ccc0 @ (ccv @ Xx3) @ ccicc) @ XM)) @ (^ [Xx3:$i] : ccr))))))).
...
thf(cisbnd3b_conj,conjecture,(! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XM @ (ccfv @ XX @ ccbnd)) <=> ((cwcel @ XM @ (ccfv @ XX @ ccme)) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XM) @ (ccv @ Xx3) @ ccle)) @ (^ [Xz:$i] : XX))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : ccr))))))).
