...
thf(ceqvinop_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((XA2 = (ccop @ XB2 @ XC)) <=> (? [Xx3:$i] : (? [Xy1:$i] : ((XA2 = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) & ((ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) = (ccop @ XB2 @ XC)))))))))))).
