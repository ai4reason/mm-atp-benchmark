...
thf(aevl1gsumaddval_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((XQ = (ccfv @ XR @ cce1)) => ((XK = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : ((XW @ Xx3) = (ccfv @ XR @ ccpl1))) => ((! [Xx3:$i] : ((XP @ Xx3) = (cco @ XR @ XK @ ccpws))) => ((! [Xx3:$i] : (XB2 = (ccfv @ (XW @ Xx3) @ ccbs))) => ((Xph => (cwcel @ XR @ cccrg)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XN)) => (cwcel @ (XY @ Xx3) @ XB2))) => ((Xph => (cwss @ XN @ ccn0)) => ((Xph => (cwcel @ XN @ ccfn)) => ((Xph => (cwcel @ XC @ XK)) => (! [Xx3:$i] : (Xph => ((ccfv @ XC @ (ccfv @ (cco @ (XW @ Xx3) @ (ccmpt @ (^ [Xx3:$i] : XN) @ (^ [Xx3:$i] : (XY @ Xx3))) @ ccgsu) @ XQ)) = (cco @ XR @ (ccmpt @ (^ [Xx3:$i] : XN) @ (^ [Xx3:$i] : (ccfv @ XC @ (ccfv @ (XY @ Xx3) @ XQ)))) @ ccgsu))))))))))))))))))))))))).
...
thf(aevl1scvarpwval_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XQ = (ccfv @ XR @ cce1)) => ((XW = (ccfv @ XR @ ccpl1)) => ((XG = (ccfv @ XW @ ccmgp)) => ((XX = (ccfv @ XR @ ccv1)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_ex = (ccfv @ XG @ ccmg)) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xc_xp = (ccfv @ XW @ ccvsca)) => ((Xph => (cwcel @ XA2 @ XB2)) => ((Xph => (cwcel @ XC @ XB2)) => ((XH = (ccfv @ XR @ ccmgp)) => ((XE = (ccfv @ XH @ ccmg)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (Xph => ((ccfv @ XC @ (ccfv @ (cco @ XA2 @ (cco @ XN @ XX @ Xc_ex) @ Xc_xp) @ XQ)) = (cco @ XA2 @ (cco @ XN @ XC @ XE) @ Xc_x))))))))))))))))))))))))))))))))).
