...
thf(aitg1val_ax,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ ccitg1)) => ((ccfv @ XF @ ccitg1) = (ccsu @ (ccdif @ (ccrn @ XF) @ (ccsn @ ccc0)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xx3))) @ ccvol) @ ccmul))))))).
thf(citg1ge0_conj,conjecture,(! [XF:($i > $o)] : (((cwcel @ XF @ (ccdm @ ccitg1)) & (cwbr @ cc0p @ XF @ (ccofr @ ccle))) => (cwbr @ ccc0 @ (ccfv @ XF @ ccitg1) @ ccle)))).
