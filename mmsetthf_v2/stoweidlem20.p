...
thf(aletrp1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ ccle)) => (cwbr @ XA2 @ (cco @ XB2 @ cc1 @ ccaddc) @ ccle))))).
...
thf(astoweidlem8_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((cw3a @ (Xph @ Xt) @ (cwcel @ (ccv @ Xf1) @ (XA2 @ Xt)) @ (cwcel @ (ccv @ Xg1) @ (XA2 @ Xt))) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (XT @ Xt)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccaddc))) @ (XA2 @ Xt)))))) => ((cwnfc @ (^ [Xt:$i] : (XF @ Xt))) => ((! [Xf1:$i] : (cwnfc @ (^ [Xt:$i] : (XG @ Xt @ Xf1)))) => (! [Xt:$i] : (! [Xf1:$i] : ((cw3a @ (Xph @ Xt) @ (cwcel @ (XF @ Xt) @ (XA2 @ Xt)) @ (cwcel @ (XG @ Xt @ Xf1) @ (XA2 @ Xt))) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (XT @ Xt)) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (XF @ Xt)) @ (ccfv @ (ccv @ Xt) @ (XG @ Xt @ Xf1)) @ ccaddc))) @ (XA2 @ Xt)))))))))))))).
thf(ccopab_tp,type,(ccopab : (($i > ($i > $o)) > ($i > $o)))).
thf(anfmpt1_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (cwnfc @ (^ [Xx3:$i] : (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))).
thf(cstoweidlem20_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((cwnf @ (^ [Xt:$i] : (Xph @ Xt))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((XF @ Xt @ Xf1 @ Xg1 @ Xi) = (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccsu @ (cco @ cc1 @ (XM @ Xf1 @ Xg1) @ ccfz) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ XG))))))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xph @ Xt) => (cwcel @ (XM @ Xf1 @ Xg1) @ ccn))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((Xph @ Xt) => (cwf @ (cco @ cc1 @ (XM @ Xf1 @ Xg1) @ ccfz) @ (XA2 @ Xt @ Xi) @ XG)))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((cw3a @ (Xph @ Xt) @ (cwcel @ (ccv @ Xf1) @ (XA2 @ Xt @ Xi)) @ (cwcel @ (ccv @ Xg1) @ (XA2 @ Xt @ Xi))) => (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccaddc))) @ (XA2 @ Xt @ Xi))))))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xi:$i] : (((Xph @ Xt) & (cwcel @ (ccv @ Xf1) @ (XA2 @ Xt @ Xi))) => (cwf @ XT @ ccr @ (ccv @ Xf1)))))) => (! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xi:$i] : ((Xph @ Xt) => (cwcel @ (XF @ Xt @ Xf1 @ Xg1 @ Xi) @ (XA2 @ Xt @ Xi)))))))))))))))))))).
