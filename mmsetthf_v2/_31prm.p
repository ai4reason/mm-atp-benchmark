...
thf(a_4nprm_ax,axiom,(~ (cwcel @ cc4 @ ccprime))).
...
thf(aflsqrt5_ax,axiom,(! [XX:($i > $o)] : (((cwcel @ XX @ ccr) & (cwbr @ ccc0 @ XX @ ccle)) => (((cwbr @ (ccdc @ cc2 @ cc5) @ XX @ ccle) & (cwbr @ XX @ (ccdc @ cc3 @ cc6) @ cclt)) <=> ((ccfv @ (ccfv @ XX @ ccsqrt) @ ccfl) = cc5))))).
...
thf(c_31prm_conj,conjecture,(cwcel @ (ccdc @ cc3 @ cc1) @ ccprime)).
