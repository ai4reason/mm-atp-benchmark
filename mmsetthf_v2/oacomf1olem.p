...
thf(aoaf1o_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (cwf1o @ ccon0 @ (ccdif @ ccon0 @ XA2) @ (ccmpt @ (^ [Xx3:$i] : ccon0) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccoa))))))).
...
thf(coacomf1olem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ XB2 @ (ccv @ Xx3) @ ccoa))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((cwf1o @ XA2 @ (ccrn @ (XF @ Xx3)) @ (XF @ Xx3)) & ((ccin @ (ccrn @ (XF @ Xx3)) @ XB2) = cc0))))))))).
