...
thf(aigenidl_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XX = (ccrn @ XG)) => (((cwcel @ XR @ ccrngo) & (cwss @ XS @ XX)) => (cwcel @ (cco @ XR @ XS @ ccigen) @ (ccfv @ XR @ ccidl)))))))))).
...
thf(aprnc_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XH = (ccfv @ XR @ cc2nd)) => ((XX = (ccrn @ XG)) => (((cwcel @ XR @ cccring) & (cwcel @ XA2 @ XX)) => ((cco @ XR @ (ccsn @ XA2) @ ccigen) = (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ XA2 @ XH))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))))))))))))).
...
thf(acrngm4_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XH = (ccfv @ XR @ cc2nd)) => ((XX = (ccrn @ XG)) => ((cw3a @ (cwcel @ XR @ cccring) @ ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) @ ((cwcel @ XC @ XX) & (cwcel @ XD @ XX))) => ((cco @ (cco @ XA2 @ XB2 @ XH) @ (cco @ XC @ XD @ XH) @ XH) = (cco @ (cco @ XA2 @ XC @ XH) @ (cco @ XB2 @ XD @ XH) @ XH))))))))))))))).
...
thf(aigenss_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XX = (ccrn @ XG)) => (((cwcel @ XR @ ccrngo) & (cwss @ XS @ XX)) => (cwss @ XS @ (cco @ XR @ XS @ ccigen)))))))))).
...
thf(aispridl2_ax,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : ((XG @ Xa @ Xb) = (ccfv @ XR @ cc1st)))) => ((! [Xa:$i] : (! [Xb:$i] : ((XH @ Xa @ Xb) = (ccfv @ XR @ cc2nd)))) => ((! [Xa:$i] : (! [Xb:$i] : (XX = (ccrn @ (XG @ Xa @ Xb))))) => (((cwcel @ XR @ ccrngo) & (cw3a @ (cwcel @ XP @ (ccfv @ XR @ ccidl)) @ (cwne @ XP @ XX) @ (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : ((cwcel @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (XH @ Xa @ Xb)) @ XP) => ((cwcel @ (ccv @ Xa) @ XP) | (cwcel @ (ccv @ Xb) @ XP)))) @ (^ [Xb:$i] : XX))) @ (^ [Xa:$i] : XX)))) => (cwcel @ XP @ (ccfv @ XR @ ccpridl)))))))))))).
thf(cispridlc_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : ((XG @ Xa @ Xb) = (ccfv @ XR @ cc1st)))) => ((XH = (ccfv @ XR @ cc2nd)) => ((! [Xa:$i] : (! [Xb:$i] : (XX = (ccrn @ (XG @ Xa @ Xb))))) => ((cwcel @ XR @ cccring) => ((cwcel @ XP @ (ccfv @ XR @ ccpridl)) <=> (cw3a @ (cwcel @ XP @ (ccfv @ XR @ ccidl)) @ (cwne @ XP @ XX) @ (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : ((cwcel @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ XH) @ XP) => ((cwcel @ (ccv @ Xa) @ XP) | (cwcel @ (ccv @ Xb) @ XP)))) @ (^ [Xb:$i] : XX))) @ (^ [Xa:$i] : XX)))))))))))))).
