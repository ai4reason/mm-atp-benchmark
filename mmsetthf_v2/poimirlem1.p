...
thf(cpoimirlem1_conj,conjecture,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (XF = (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xy1:$i] : (ccsb @ (ccif @ (cwbr @ (ccv @ Xy1) @ XM @ cclt) @ (ccv @ Xy1) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (^ [Xj:$i] : (cco @ XT @ (ccun @ (ccxp @ (ccima @ XU @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ XU @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc)))))))) => ((Xph => (cwf @ (cco @ cc1 @ XN @ ccfz) @ ccz @ XT)) => ((Xph => (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ XU)) => ((Xph => (cwcel @ XM @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) => (Xph => (~ (cwrmo @ (^ [Xn:$i] : (cwne @ (ccfv @ (ccv @ Xn) @ (ccfv @ (cco @ XM @ cc1 @ ccmin) @ XF)) @ (ccfv @ (ccv @ Xn) @ (ccfv @ XM @ XF)))) @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz))))))))))))))))).
