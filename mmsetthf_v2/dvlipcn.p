...
thf(ablcvx_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((XS = (cco @ XP @ XR @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl))) => ((((cwcel @ XP @ ccc) & (cwcel @ XR @ ccxr)) & (cw3a @ (cwcel @ XA2 @ XS) @ (cwcel @ XB2 @ XS) @ (cwcel @ XT @ (cco @ ccc0 @ cc1 @ ccicc)))) => (cwcel @ (cco @ (cco @ XT @ XA2 @ ccmul) @ (cco @ (cco @ cc1 @ XT @ ccmin) @ XB2 @ ccmul) @ ccaddc) @ XS)))))))))).
...
thf(advfcn_ax,axiom,(! [XF:($i > $o)] : (cwf @ (ccdm @ (cco @ ccc @ XF @ ccdv)) @ ccc @ (cco @ ccc @ XF @ ccdv)))).
...
thf(cdvlipcn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwss @ (XX @ Xx3) @ ccc))) => ((! [Xx3:$i] : (Xph => (cwf @ (XX @ Xx3) @ ccc @ XF))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XA2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XR @ Xx3) @ ccxr))) => ((! [Xx3:$i] : (XB2 = (cco @ (XA2 @ Xx3) @ (XR @ Xx3) @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl)))) => ((Xph => (cwss @ XB2 @ (ccdm @ (cco @ ccc @ XF @ ccdv)))) => ((Xph => (cwcel @ XM @ ccr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (cco @ ccc @ XF @ ccdv)) @ ccabs) @ XM @ ccle))) => (! [Xx3:$i] : ((Xph & ((cwcel @ (XY @ Xx3) @ XB2) & (cwcel @ (XZ @ Xx3) @ XB2))) => (cwbr @ (ccfv @ (cco @ (ccfv @ (XY @ Xx3) @ XF) @ (ccfv @ (XZ @ Xx3) @ XF) @ ccmin) @ ccabs) @ (cco @ XM @ (ccfv @ (cco @ (XY @ Xx3) @ (XZ @ Xx3) @ ccmin) @ ccabs) @ ccmul) @ ccle))))))))))))))))))))).
