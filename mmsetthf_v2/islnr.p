...
thf(adf_lnr_ax,axiom,(cclnr = (ccrab @ (^ [Xa:$i] : (cwcel @ (ccfv @ (ccv @ Xa) @ ccrglmod) @ cclnm)) @ (^ [Xa:$i] : ccrg)))).
thf(cislnr_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ cclnr) <=> ((cwcel @ XA2 @ ccrg) & (cwcel @ (ccfv @ XA2 @ ccrglmod) @ cclnm))))).
