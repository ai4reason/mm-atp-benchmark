...
thf(adoch11_ax,axiom,(! [Xph:$o] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((Xc_pe = (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XX @ (ccrn @ XI))) => ((Xph => (cwcel @ XY @ (ccrn @ XI))) => (Xph => (((ccfv @ XX @ Xc_pe) = (ccfv @ XY @ Xc_pe)) <=> (XX = XY)))))))))))))))))).
...
thf(adih0rn_ax,axiom,(! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((Xc_0 = (ccfv @ XU @ cc0g)) => (((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) => (cwcel @ (ccsn @ Xc_0) @ (ccrn @ XI)))))))))))))).
...
thf(adjhcom_ax,axiom,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((Xc_or = (ccfv @ XW @ (ccfv @ XK @ ccdjh))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwss @ XX @ XV)) => ((Xph => (cwss @ XY @ XV)) => (Xph => ((cco @ XX @ XY @ Xc_or) = (cco @ XY @ XX @ Xc_or)))))))))))))))))))).
...
thf(adjhexmid_ax,axiom,(! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((Xc_pe = (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((Xc_or = (ccfv @ XW @ (ccfv @ XK @ ccdjh))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwss @ XX @ XV)) => ((cco @ XX @ (ccfv @ XX @ Xc_pe) @ Xc_or) = XV)))))))))))))))).
...
thf(aislshp_ax,axiom,(! [XS:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : ((XV = (ccfv @ XW @ ccbs)) => ((! [Xv:$i] : ((XN @ Xv) = (ccfv @ XW @ cclspn))) => ((! [Xv:$i] : ((XS @ Xv) = (ccfv @ XW @ cclss))) => ((! [Xv:$i] : ((XH @ Xv) = (ccfv @ XW @ cclsh))) => (! [Xv:$i] : ((cwcel @ XW @ (XX @ Xv)) => ((cwcel @ XU @ (XH @ Xv)) <=> (cw3a @ (cwcel @ XU @ (XS @ Xv)) @ (cwne @ XU @ XV) @ (cwrex @ (^ [Xv:$i] : ((ccfv @ (ccun @ XU @ (ccsn @ (ccv @ Xv))) @ (XN @ Xv)) = XV)) @ (^ [Xv:$i] : XV)))))))))))))))))).
