...
thf(admresexg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => (cwcel @ (ccdm @ (ccres @ XA2 @ XB2)) @ ccvv)))))).
thf(afunimaexg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwfun @ XA2) & (cwcel @ XB2 @ XC)) => (cwcel @ (ccima @ XA2 @ XB2) @ ccvv)))))).
thf(cresfunexg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwfun @ XA2) & (cwcel @ XB2 @ XC)) => (cwcel @ (ccres @ XA2 @ XB2) @ ccvv)))))).
