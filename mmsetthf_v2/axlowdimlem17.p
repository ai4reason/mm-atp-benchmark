...
thf(aaxlowdimlem9_ax,axiom,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XP = (ccun @ (ccsn @ (ccop @ cc3 @ (ccneg @ cc1))) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ cc3)) @ (ccsn @ ccc0)))) => (((cwcel @ XK @ (cco @ cc1 @ XN @ ccfz)) & (cwne @ XK @ cc3)) => ((ccfv @ XK @ XP) = ccc0))))))).
...
thf(aaxlowdimlem12_ax,axiom,(! [XQ:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XQ = (ccun @ (ccsn @ (ccop @ (cco @ XI @ cc1 @ ccaddc) @ cc1)) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (cco @ XI @ cc1 @ ccaddc))) @ (ccsn @ ccc0)))) => (((cwcel @ XK @ (cco @ cc1 @ XN @ ccfz)) & (cwne @ XK @ (cco @ XI @ cc1 @ ccaddc))) => ((ccfv @ XK @ XQ) = ccc0)))))))).
thf(ccfn_tp,type,(ccfn : ($i > $o))).
thf(aaxlowdimlem16_ax,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((XP = (ccun @ (ccsn @ (ccop @ cc3 @ (ccneg @ cc1))) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ cc3)) @ (ccsn @ ccc0)))) => ((XQ = (ccun @ (ccsn @ (ccop @ (cco @ XI @ cc1 @ ccaddc) @ cc1)) @ (ccxp @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (cco @ XI @ cc1 @ ccaddc))) @ (ccsn @ ccc0)))) => (((cwcel @ XN @ (ccfv @ cc3 @ ccuz)) & (cwcel @ XI @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) => ((ccsu @ (cco @ cc3 @ XN @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XP) @ cc2 @ ccexp))) = (ccsu @ (cco @ cc3 @ XN @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XQ) @ cc2 @ ccexp)))))))))))).
...
thf(aaxlowdimlem2_ax,axiom,(! [XN:($i > $o)] : ((ccin @ (cco @ cc1 @ cc2 @ ccfz) @ (cco @ cc3 @ XN @ ccfz)) = cc0))).
thf(amp3an12_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (Xph => (Xps => (((cw3a @ Xph @ Xps @ Xch) => Xth) => (Xch => Xth))))))))).
thf(aaxlowdimlem4_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => (cwf @ (cco @ cc1 @ cc2 @ ccfz) @ ccr @ (ccpr @ (ccop @ cc1 @ XA2) @ (ccop @ cc2 @ XB2)))))))).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(affn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => (cwfn @ XF @ XA2)))))).
thf(aaxlowdimlem1_ax,axiom,(! [XN:($i > $o)] : (cwf @ (cco @ cc3 @ XN @ ccfz) @ ccr @ (ccxp @ (cco @ cc3 @ XN @ ccfz) @ (ccsn @ ccc0))))).
...
thf(aaxlowdimlem5_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) => (cwcel @ (ccun @ (ccpr @ (ccop @ cc1 @ XA2) @ (ccop @ cc2 @ XB2)) @ (ccxp @ (cco @ cc3 @ XN @ ccfz) @ (ccsn @ ccc0))) @ (ccfv @ XN @ ccee))))))))).
