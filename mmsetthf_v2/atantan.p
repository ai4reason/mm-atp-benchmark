...
thf(aatandmtan_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ (ccfv @ XA2 @ cccos) @ ccc0)) => (cwcel @ (ccfv @ XA2 @ cctan) @ (ccdm @ ccatan))))).
...
thf(atanregt0_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ (ccfv @ XA2 @ ccre) @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))) => (cwbr @ ccc0 @ (ccfv @ (ccfv @ XA2 @ cctan) @ ccre) @ cclt)))).
thf(atanneg_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ (ccfv @ XA2 @ cccos) @ ccc0)) => ((ccfv @ (ccneg @ XA2) @ cctan) = (ccneg @ (ccfv @ XA2 @ cctan)))))).
thf(aatanlogsub_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccatan)) & (cwne @ (ccfv @ XA2 @ ccre) @ ccc0)) => (cwcel @ (cco @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) @ cclog) @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccmin) @ cclog) @ ccmin) @ (ccrn @ cclog))))).
...
thf(areim_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ ccre) = (ccfv @ (cco @ cci @ XA2 @ ccmul) @ ccim))))).
thf(atanhbnd_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwcel @ (cco @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cctan) @ cci @ ccdiv) @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo))))).
...
thf(aimmul2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccc)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ ccim) = (cco @ XA2 @ (ccfv @ XB2 @ ccim) @ ccmul)))))).
