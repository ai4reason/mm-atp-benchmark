...
thf(asqrtlt_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle)) & ((cwcel @ XB2 @ ccr) & (cwbr @ ccc0 @ XB2 @ ccle))) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (ccfv @ XA2 @ ccsqrt) @ (ccfv @ XB2 @ ccsqrt) @ cclt)))))).
...
thf(altmul1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccrp)) => (Xph => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XC @ ccmul) @ cclt))))))))))).
...
thf(csqsscirc1_conj,conjecture,(! [XD:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((((cwcel @ XX @ ccr) & (cwbr @ ccc0 @ XX @ ccle)) & ((cwcel @ XY @ ccr) & (cwbr @ ccc0 @ XY @ ccle))) & (cwcel @ XD @ ccrp)) => (((cwbr @ XX @ (cco @ XD @ cc2 @ ccdiv) @ cclt) & (cwbr @ XY @ (cco @ XD @ cc2 @ ccdiv) @ cclt)) => (cwbr @ (ccfv @ (cco @ (cco @ XX @ cc2 @ ccexp) @ (cco @ XY @ cc2 @ ccexp) @ ccaddc) @ ccsqrt) @ XD @ cclt))))))).
