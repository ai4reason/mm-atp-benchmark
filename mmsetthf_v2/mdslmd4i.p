...
thf(assmd1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwss @ XA2 @ XB2)) => (cwbr @ XA2 @ XB2 @ ccmd))))).
...
thf(amdslmd3i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwcel @ XD @ ccch) => ((((cwbr @ XA2 @ XB2 @ ccmd) & (cwbr @ (ccin @ XA2 @ XB2) @ XC @ ccmd)) & ((cwss @ (ccin @ XA2 @ XC) @ XD) & (cwss @ XD @ XA2))) => (cwbr @ XD @ (ccin @ XB2 @ XC) @ ccmd))))))))))).
thf(aadantl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xch & Xph) => Xps)))))).
thf(abiimpi_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph <=> Xps) => (Xph => Xps))))).
thf(asseqin2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ XB2) <=> ((ccin @ XB2 @ XA2) = XA2))))).
thf(cmdslmd4i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwcel @ XD @ ccch) => ((cw3a @ (cwbr @ XA2 @ XB2 @ ccmd) @ ((cwss @ (ccin @ XA2 @ XB2) @ XC) & (cwss @ XC @ XA2)) @ ((cwss @ (ccin @ XA2 @ XB2) @ XD) & (cwss @ XD @ XB2))) => (cwbr @ XC @ XD @ ccmd))))))))))).
