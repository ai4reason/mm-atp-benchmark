...
thf(afzrev_ax,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) & ((cwcel @ XJ @ ccz) & (cwcel @ XK @ ccz))) => ((cwcel @ XK @ (cco @ (cco @ XJ @ XN @ ccmin) @ (cco @ XJ @ XM @ ccmin) @ ccfz)) <=> (cwcel @ (cco @ XJ @ XK @ ccmin) @ (cco @ XM @ XN @ ccfz))))))))).
...
thf(afzrev2_ax,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) & ((cwcel @ XJ @ ccz) & (cwcel @ XK @ ccz))) => ((cwcel @ XK @ (cco @ XM @ XN @ ccfz)) <=> (cwcel @ (cco @ XJ @ XK @ ccmin) @ (cco @ (cco @ XJ @ XN @ ccmin) @ (cco @ XJ @ XM @ ccmin) @ ccfz))))))))).
...
thf(cfprodrev_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XK @ ccz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XN @ ccz)) => ((! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ (cco @ XM @ XN @ ccfz))) => (cwcel @ (XA2 @ Xj) @ ccc))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xj) = (cco @ XK @ (ccv @ Xk) @ ccmin)) => ((XA2 @ Xj) = (XB2 @ Xk))))) => (Xph => ((ccprod @ (^ [Xj:$i] : (cco @ XM @ XN @ ccfz)) @ (^ [Xj:$i] : (XA2 @ Xj))) = (ccprod @ (^ [Xk:$i] : (cco @ (cco @ XK @ XN @ ccmin) @ (cco @ XK @ XM @ ccmin) @ ccfz)) @ (^ [Xk:$i] : (XB2 @ Xk))))))))))))))))).
