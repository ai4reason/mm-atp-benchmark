...
thf(agexlem2_ax,axiom,(! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((cw3a @ (cwcel @ XG @ XV) @ (cwcel @ XN @ ccn) @ (cwral @ (^ [Xx3:$i] : ((cco @ XN @ (ccv @ Xx3) @ Xc_x) = Xc_0)) @ (^ [Xx3:$i] : XX))) => (cwcel @ XE @ (cco @ cc1 @ XN @ ccfz))))))))))))))).
thf(aelfznn_ax,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ cc1 @ XN @ ccfz)) => (cwcel @ XK @ ccn))))).
thf(cgexcl3_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => ((! [Xx3:$i] : ((XO @ Xx3) = (ccfv @ XG @ ccod))) => (((cwcel @ XG @ ccgrp) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (XO @ Xx3)) @ (cco @ cc1 @ XN @ ccfz))) @ (^ [Xx3:$i] : XX))) => (cwcel @ XE @ ccn))))))))))).
