...
thf(cvciOLD_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (XG = (ccfv @ (XW @ Xx3 @ Xy1 @ Xz) @ cc1st))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (XS = (ccfv @ (XW @ Xx3 @ Xy1 @ Xz) @ cc2nd))))) => ((XX = (ccrn @ XG)) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ (XW @ Xx3 @ Xy1 @ Xz) @ ccvc) => (cw3a @ (cwcel @ XG @ ccablo) @ (cwf @ (ccxp @ ccc @ XX) @ XX @ XS) @ (cwral @ (^ [Xx3:$i] : (((cco @ cc1 @ (ccv @ Xx3) @ XS) = (ccv @ Xx3)) & (cwral @ (^ [Xy1:$i] : ((cwral @ (^ [Xz:$i] : ((cco @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ XG) @ XS) = (cco @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XS) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XS) @ XG))) @ (^ [Xz:$i] : XX)) & (cwral @ (^ [Xz:$i] : (((cco @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ ccaddc) @ (ccv @ Xx3) @ XS) = (cco @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XS) @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ XS) @ XG)) & ((cco @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ ccmul) @ (ccv @ Xx3) @ XS) = (cco @ (ccv @ Xy1) @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ XS) @ XS)))) @ (^ [Xz:$i] : ccc)))) @ (^ [Xy1:$i] : ccc)))) @ (^ [Xx3:$i] : XX))))))))))))))).
