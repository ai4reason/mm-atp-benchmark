...
thf(cofc1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((Xph => (cwfn @ XF @ XA2)) => (((Xph & (cwcel @ XX @ XA2)) => ((ccfv @ XX @ XF) = XC)) => ((Xph & (cwcel @ XX @ XA2)) => ((ccfv @ XX @ (cco @ (ccxp @ XA2 @ (ccsn @ XB2)) @ XF @ (ccof @ XR))) = (cco @ XB2 @ XC @ XR))))))))))))))))).
