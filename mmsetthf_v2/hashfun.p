...
thf(afidomdm_ax,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ ccfn) => (cwbr @ (ccdm @ XF) @ XF @ ccdom)))).
...
thf(a_2nalexn_ax,axiom,(! [Xph:($i > ($i > $o))] : ((~ (! [Xx3:$i] : (! [Xy1:$i] : (Xph @ Xx3 @ Xy1)))) <=> (? [Xx3:$i] : (? [Xy1:$i] : (~ (Xph @ Xx3 @ Xy1))))))).
...
thf(admprop_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XD @ ccvv) => ((ccdm @ (ccpr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD))) = (ccpr @ XA2 @ XC))))))))).
...
thf(chashfun_conj,conjecture,(! [XF:($i > $o)] : ((cwcel @ XF @ ccfn) => ((cwfun @ XF) <=> ((ccfv @ XF @ cchash) = (ccfv @ (ccdm @ XF) @ cchash)))))).
