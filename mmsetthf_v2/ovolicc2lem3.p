...
thf(aeqord1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((XA2 @ Xx3 @ Xy1) = (XB2 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XC) => ((XA2 @ Xx3 @ Xy1) = XM)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XD) => ((XA2 @ Xx3 @ Xy1) = XN)))) => ((cwss @ XS @ ccr) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XS)) => (cwcel @ (XA2 @ Xx3 @ Xy1) @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt) => (cwbr @ (XA2 @ Xx3 @ Xy1) @ (XB2 @ Xy1) @ cclt))))) => ((Xph & ((cwcel @ XC @ XS) & (cwcel @ XD @ XS))) => ((XC = XD) <=> (XM = XN)))))))))))))))))).
...
thf(annnlt1_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => (~ (cwbr @ XA2 @ cc1 @ cclt))))).
...
thf(aovolicc2lem2_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XA2 @ ccr))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XB2 @ ccr))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwbr @ XA2 @ XB2 @ ccle))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : ((XS @ Xu @ Xt @ Xn) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (XF @ Xu)) @ cc1))))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ (XF @ Xu)))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XU @ (ccin @ (ccpw @ (ccrn @ (cccom @ ccioo @ (XF @ Xu)))) @ ccfn)))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ (ccuni @ XU)))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwf @ XU @ ccn @ (XG @ Xu)))) => ((! [Xu:$i] : (! [Xt:$i] : (((Xph @ Xu) & (cwcel @ (ccv @ Xt) @ XU)) => ((ccfv @ (ccfv @ (ccv @ Xt) @ (XG @ Xu)) @ (cccom @ ccioo @ (XF @ Xu))) = (ccv @ Xt))))) => ((! [Xu:$i] : ((XT @ Xu) = (ccrab @ (^ [Xu:$i] : (cwne @ (ccin @ (ccv @ Xu) @ (cco @ XA2 @ XB2 @ ccicc)) @ cc0)) @ (^ [Xu:$i] : XU)))) => ((! [Xu:$i] : (! [Xn:$i] : ((Xph @ Xu) => (cwf @ (XT @ Xu) @ (XT @ Xu) @ (XH @ Xu @ Xn))))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (((Xph @ Xu) & (cwcel @ (ccv @ Xt) @ (XT @ Xu))) => (cwcel @ (ccif @ (cwbr @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xt) @ (XG @ Xu)) @ (XF @ Xu)) @ cc2nd) @ XB2 @ ccle) @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xt) @ (XG @ Xu)) @ (XF @ Xu)) @ cc2nd) @ XB2) @ (ccfv @ (ccv @ Xt) @ (XH @ Xu @ Xn))))))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XA2 @ (XC @ Xu)))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ (XC @ Xu) @ (XT @ Xu)))) => ((! [Xu:$i] : (! [Xn:$i] : (XK = (ccseq @ (cccom @ (XH @ Xu @ Xn) @ cc1st) @ (ccxp @ ccn @ (ccsn @ (XC @ Xu))) @ cc1)))) => ((! [Xu:$i] : (! [Xt:$i] : ((XW @ Xu @ Xt) = (ccrab @ (^ [Xn:$i] : (cwcel @ XB2 @ (ccfv @ (ccv @ Xn) @ XK))) @ (^ [Xn:$i] : ccn))))) => (! [Xu:$i] : (! [Xt:$i] : (((Xph @ Xu) & ((cwcel @ XN @ ccn) & (~ (cwcel @ XN @ (XW @ Xu @ Xt))))) => (cwbr @ (ccfv @ (ccfv @ (ccfv @ (ccfv @ XN @ XK) @ (XG @ Xu)) @ (XF @ Xu)) @ cc2nd) @ XB2 @ ccle)))))))))))))))))))))))))))))))))).
...
thf(aovolicc2lem1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((! [Xt:$i] : ((XS @ Xt) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1))) => ((Xph => (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((Xph => (cwcel @ XU @ (ccin @ (ccpw @ (ccrn @ (cccom @ ccioo @ XF))) @ ccfn))) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ (ccuni @ XU))) => ((Xph => (cwf @ XU @ ccn @ XG)) => ((! [Xt:$i] : ((Xph & (cwcel @ (ccv @ Xt) @ XU)) => ((ccfv @ (ccfv @ (ccv @ Xt) @ XG) @ (cccom @ ccioo @ XF)) = (ccv @ Xt)))) => (! [Xt:$i] : ((Xph & (cwcel @ XX @ XU)) => ((cwcel @ (XP @ Xt) @ XX) <=> (cw3a @ (cwcel @ (XP @ Xt) @ ccr) @ (cwbr @ (ccfv @ (ccfv @ (ccfv @ XX @ XG) @ XF) @ cc1st) @ (XP @ Xt) @ cclt) @ (cwbr @ (XP @ Xt) @ (ccfv @ (ccfv @ (ccfv @ XX @ XG) @ XF) @ cc2nd) @ cclt)))))))))))))))))))))))).
...
thf(covolicc2lem3_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XA2 @ ccr))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XB2 @ ccr))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwbr @ XA2 @ XB2 @ ccle))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XS @ Xu @ Xt @ Xm @ Xn) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (XF @ Xu @ Xm)) @ cc1)))))) => ((! [Xu:$i] : (! [Xm:$i] : ((Xph @ Xu) => (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ (XF @ Xu @ Xm))))) => ((! [Xu:$i] : (! [Xm:$i] : ((Xph @ Xu) => (cwcel @ (XU @ Xm) @ (ccin @ (ccpw @ (ccrn @ (cccom @ ccioo @ (XF @ Xu @ Xm)))) @ ccfn))))) => ((! [Xu:$i] : (! [Xm:$i] : ((Xph @ Xu) => (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ (ccuni @ (XU @ Xm)))))) => ((! [Xu:$i] : (! [Xm:$i] : ((Xph @ Xu) => (cwf @ (XU @ Xm) @ ccn @ (XG @ Xu @ Xm))))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xm:$i] : (((Xph @ Xu) & (cwcel @ (ccv @ Xt) @ (XU @ Xm))) => ((ccfv @ (ccfv @ (ccv @ Xt) @ (XG @ Xu @ Xm)) @ (cccom @ ccioo @ (XF @ Xu @ Xm))) = (ccv @ Xt)))))) => ((! [Xu:$i] : (! [Xm:$i] : ((XT @ Xu @ Xm) = (ccrab @ (^ [Xu:$i] : (cwne @ (ccin @ (ccv @ Xu) @ (cco @ XA2 @ XB2 @ ccicc)) @ cc0)) @ (^ [Xu:$i] : (XU @ Xm)))))) => ((! [Xu:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xu) => (cwf @ (XT @ Xu @ Xm) @ (XT @ Xu @ Xm) @ (XH @ Xu @ Xm @ Xn)))))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xm:$i] : (! [Xn:$i] : (((Xph @ Xu) & (cwcel @ (ccv @ Xt) @ (XT @ Xu @ Xm))) => (cwcel @ (ccif @ (cwbr @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xt) @ (XG @ Xu @ Xm)) @ (XF @ Xu @ Xm)) @ cc2nd) @ XB2 @ ccle) @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xt) @ (XG @ Xu @ Xm)) @ (XF @ Xu @ Xm)) @ cc2nd) @ XB2) @ (ccfv @ (ccv @ Xt) @ (XH @ Xu @ Xm @ Xn)))))))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XA2 @ (XC @ Xu)))) => ((! [Xu:$i] : (! [Xm:$i] : ((Xph @ Xu) => (cwcel @ (XC @ Xu) @ (XT @ Xu @ Xm))))) => ((! [Xu:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XK @ Xm) = (ccseq @ (cccom @ (XH @ Xu @ Xm @ Xn) @ cc1st) @ (ccxp @ ccn @ (ccsn @ (XC @ Xu))) @ cc1))))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xm:$i] : ((XW @ Xu @ Xt) = (ccrab @ (^ [Xn:$i] : (cwcel @ XB2 @ (ccfv @ (ccv @ Xn) @ (XK @ Xm)))) @ (^ [Xn:$i] : ccn)))))) => (! [Xu:$i] : (! [Xt:$i] : (! [Xm:$i] : (! [Xn:$i] : (((Xph @ Xu) & ((cwcel @ (XN @ Xm) @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xn) @ (ccv @ Xm) @ ccle)) @ (^ [Xm:$i] : (XW @ Xu @ Xt)))) @ (^ [Xn:$i] : ccn))) & (cwcel @ (XP @ Xu @ Xt @ Xm @ Xn) @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xn) @ (ccv @ Xm) @ ccle)) @ (^ [Xm:$i] : (XW @ Xu @ Xt)))) @ (^ [Xn:$i] : ccn))))) => (((XN @ Xm) = (XP @ Xu @ Xt @ Xm @ Xn)) <=> ((ccfv @ (ccfv @ (ccfv @ (ccfv @ (XN @ Xm) @ (XK @ Xm)) @ (XG @ Xu @ Xm)) @ (XF @ Xu @ Xm)) @ cc2nd) = (ccfv @ (ccfv @ (ccfv @ (ccfv @ (XP @ Xu @ Xt @ Xm @ Xn) @ (XK @ Xm)) @ (XG @ Xu @ Xm)) @ (XF @ Xu @ Xm)) @ cc2nd))))))))))))))))))))))))))))))))))))))).
