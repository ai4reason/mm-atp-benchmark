...
thf(agrpsgrp_ax,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ ccgrp) => (cwcel @ XG @ ccsgrp)))).
...
thf(agrpinvex_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XB2 = (ccfv @ XG @ ccbs)) => ((! [Xy1:$i] : ((Xc_pl @ Xy1) = (ccfv @ XG @ ccplusg))) => ((! [Xy1:$i] : ((Xc_0 @ Xy1) = (ccfv @ XG @ cc0g))) => (((cwcel @ XG @ ccgrp) & (cwcel @ XX @ XB2)) => (cwrex @ (^ [Xy1:$i] : ((cco @ (ccv @ Xy1) @ XX @ (Xc_pl @ Xy1)) = (Xc_0 @ Xy1))) @ (^ [Xy1:$i] : XB2)))))))))))).
...
thf(amgmcl_ax,axiom,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_op:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_op = (ccfv @ XM @ ccplusg)) => ((cw3a @ (cwcel @ XM @ ccmgm) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => (cwcel @ (cco @ XX @ XY @ Xc_op) @ XB2)))))))))).
thf(aadantll_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => (((Xth & Xph) & Xps) => Xch))))))).
thf(asgrpass_ax,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_op:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_op = (ccfv @ XG @ ccplusg)) => (((cwcel @ XG @ ccsgrp) & (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2))) => ((cco @ (cco @ XX @ XY @ Xc_op) @ XZ @ Xc_op) = (cco @ XX @ (cco @ XY @ XZ @ Xc_op) @ Xc_op)))))))))))).
...
thf(cdfgrp2_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((cwcel @ XG @ ccgrp) <=> ((cwcel @ XG @ ccsgrp) & (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xx3:$i] : (((cco @ (ccv @ Xn) @ (ccv @ Xx3) @ Xc_pl) = (ccv @ Xx3)) & (cwrex @ (^ [Xi:$i] : ((cco @ (ccv @ Xi) @ (ccv @ Xx3) @ Xc_pl) = (ccv @ Xn))) @ (^ [Xi:$i] : XB2)))) @ (^ [Xx3:$i] : XB2))) @ (^ [Xn:$i] : XB2)))))))))).
