...
thf(cfclsopni_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (((cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) & (cw3a @ (cwcel @ XU @ XJ) @ (cwcel @ XA2 @ XU) @ (cwcel @ XS @ XF))) => (cwne @ (ccin @ XU @ XS) @ cc0)))))))).
