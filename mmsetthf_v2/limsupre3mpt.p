...
thf(climsupre3mpt_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xk:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1 @ Xk))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xy1 @ Xk) => (cwss @ XA2 @ ccr))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (((Xph @ Xx3 @ Xy1 @ Xk) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccxr))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xy1 @ Xk) => ((cwcel @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cclsp) @ ccr) <=> ((cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xk) @ (ccv @ Xx3) @ ccle) & (cwbr @ (ccv @ Xy1) @ (XB2 @ Xx3) @ ccle))) @ (^ [Xx3:$i] : XA2))) @ (^ [Xk:$i] : ccr))) @ (^ [Xy1:$i] : ccr)) & (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xk) @ (ccv @ Xx3) @ ccle) => (cwbr @ (XB2 @ Xx3) @ (ccv @ Xy1) @ ccle))) @ (^ [Xx3:$i] : XA2))) @ (^ [Xk:$i] : ccr))) @ (^ [Xy1:$i] : ccr))))))))))))))).
