...
thf(aonsucuni_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccon0) => (cwss @ XA2 @ (ccsuc @ (ccuni @ XA2)))))).
...
thf(acfslbn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cw3a @ (cwlim @ XA2) @ (cwss @ XB2 @ XA2) @ (cwbr @ XB2 @ (ccfv @ XA2 @ cccf) @ ccsdm)) => (cwcel @ (ccuni @ XB2) @ XA2)))))).
...
thf(afoeq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cwfo @ XA2 @ XC @ XF) <=> (cwfo @ XB2 @ XC @ XF)))))))).
...
thf(ccfslb2n_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (((cwlim @ XA2) & (cwral @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) & (cwbr @ (ccv @ Xx3) @ (ccfv @ XA2 @ cccf) @ ccsdm))) @ (^ [Xx3:$i] : XB2))) => ((cwbr @ XB2 @ (ccfv @ XA2 @ cccf) @ ccsdm) => (cwne @ (ccuni @ XB2) @ XA2))))))).
