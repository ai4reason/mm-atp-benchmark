...
thf(as2cl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) => (cwcel @ (ccs2 @ XA2 @ XB2) @ (ccword @ XX))))))).
...
thf(as2prop_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS)) => ((ccs2 @ XA2 @ XB2) = (ccpr @ (ccop @ ccc0 @ XA2) @ (ccop @ cc1 @ XB2)))))))).
...
thf(cs3tpop_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XS) @ (cwcel @ XB2 @ XS) @ (cwcel @ XC @ XS)) => ((ccs3 @ XA2 @ XB2 @ XC) = (cctp @ (ccop @ ccc0 @ XA2) @ (ccop @ cc1 @ XB2) @ (ccop @ cc2 @ XC))))))))).
