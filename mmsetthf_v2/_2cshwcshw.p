...
thf(adifelfznle_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) @ (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz)) @ (~ (cwbr @ XK @ XM @ ccle))) => (cwcel @ (cco @ (cco @ XM @ XN @ ccaddc) @ XK @ ccmin) @ (cco @ ccc0 @ XN @ ccfz))))))).
...
thf(acshwsublen_ax,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ ccz)) => ((cco @ XW @ XN @ cccsh) = (cco @ XW @ (cco @ XN @ (ccfv @ XW @ cchash) @ ccmin) @ cccsh))))))).
...
thf(acshw0_ax,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ (ccword @ XV)) => ((cco @ XW @ ccc0 @ cccsh) = XW))))).
...
thf(adifelfzle_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) @ (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz)) @ (cwbr @ XK @ XM @ ccle)) => (cwcel @ (cco @ XM @ XK @ ccmin) @ (cco @ ccc0 @ XN @ ccfz))))))).
...
thf(c_2cshwcshw_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XY @ (ccword @ XV)) & ((ccfv @ XY @ cchash) = XN)) => ((cw3a @ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) @ (XX = (cco @ XY @ XK @ cccsh)) @ (cwrex @ (^ [Xm:$i] : (XZ = (cco @ XY @ (ccv @ Xm) @ cccsh))) @ (^ [Xm:$i] : (cco @ ccc0 @ XN @ ccfz)))) => (cwrex @ (^ [Xn:$i] : (XZ = (cco @ XX @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz)))))))))))).
