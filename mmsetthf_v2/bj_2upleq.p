...
thf(abj_1upleq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 = XB2) => ((cbj_c1upl @ XA2) = (cbj_c1upl @ XB2)))))).
thf(abj_xtageq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((ccxp @ XC @ (cbj_ctag @ XA2)) = (ccxp @ XC @ (cbj_ctag @ XB2)))))))).
