...
thf(atchsca_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XW @ cctch)) => ((XF = (ccfv @ XW @ ccsca)) => (XF = (ccfv @ XG @ ccsca)))))))).
thf(atchvsca_ax,axiom,(! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XW @ cctch)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => (Xc_x = (ccfv @ XG @ ccvsca)))))))).
