...
thf(ann0sumltlt_ax,axiom,(! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((cw3a @ (cwcel @ (ccv @ Xa) @ ccn0) @ (cwcel @ (ccv @ Xb) @ ccn0) @ (cwcel @ (ccv @ Xc) @ ccn0)) => ((cwbr @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccaddc) @ (ccv @ Xc) @ cclt) => (cwbr @ (ccv @ Xb) @ (ccv @ Xc) @ cclt))))))).
