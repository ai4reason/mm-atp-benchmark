...
thf(acnpart_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ XA2 @ ccc0)) => (((cwbr @ ccc0 @ (ccfv @ XA2 @ ccre) @ ccle) & (cwnel @ (cco @ cci @ XA2 @ ccmul) @ ccrp)) <=> (~ ((cwbr @ ccc0 @ (ccfv @ (ccneg @ XA2) @ ccre) @ ccle) & (cwnel @ (cco @ cci @ (ccneg @ XA2) @ ccmul) @ ccrp))))))).
...
thf(csqrmo_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwrmo @ (^ [Xx3:$i] : (cw3a @ ((cco @ (ccv @ Xx3) @ cc2 @ ccexp) = XA2) @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ ccre) @ ccle) @ (cwnel @ (cco @ cci @ (ccv @ Xx3) @ ccmul) @ ccrp))) @ (^ [Xx3:$i] : ccc))))).
