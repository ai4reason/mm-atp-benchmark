...
thf(aisacs1i_ax,axiom,(! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xs1:$i] : (((cwcel @ XX @ (XV @ Xs1)) & (cwf @ (ccpw @ XX) @ (ccpw @ XX) @ XF)) => (cwcel @ (ccrab @ (^ [Xs1:$i] : (cwss @ (ccuni @ (ccima @ XF @ (ccin @ (ccpw @ (ccv @ Xs1)) @ ccfn))) @ (ccv @ Xs1))) @ (^ [Xs1:$i] : (ccpw @ XX))) @ (ccfv @ XX @ ccacs)))))))).
