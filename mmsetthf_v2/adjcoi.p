...
thf(aadjbdln_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ ccbo) => (cwcel @ (ccfv @ XT @ ccado) @ ccbo)))).
...
thf(ahoeq2_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (((cwf @ cchil @ cchil @ XS) & (cwf @ cchil @ cchil @ XT)) => ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XS) @ ccsp) = (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XT) @ ccsp))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : cchil)) <=> (XS = XT)))))).
thf(cadjcoi_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XS @ ccbo) => ((cwcel @ XT @ ccbo) => ((ccfv @ (cccom @ XS @ XT) @ ccado) = (cccom @ (ccfv @ XT @ ccado) @ (ccfv @ XS @ ccado)))))))).
