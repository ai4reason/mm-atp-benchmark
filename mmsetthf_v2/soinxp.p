...
thf(apoinxp_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwpo @ XA2 @ XR) <=> (cwpo @ XA2 @ (ccin @ XR @ (ccxp @ XA2 @ XA2))))))).
...
thf(csoinxp_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwor @ XA2 @ XR) <=> (cwor @ XA2 @ (ccin @ XR @ (ccxp @ XA2 @ XA2))))))).
