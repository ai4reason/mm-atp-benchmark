...
thf(cproththdlem_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XK @ ccn)) => ((Xph => (XP = (cco @ (cco @ XK @ (cco @ cc2 @ XN @ ccexp) @ ccmul) @ cc1 @ ccaddc))) => (Xph => (cw3a @ (cwcel @ XP @ ccn) @ (cwbr @ cc1 @ XP @ cclt) @ (cwcel @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn))))))))))).
