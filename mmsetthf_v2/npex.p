...
thf(adf_np_ax,axiom,(ccnp = (ccab @ (^ [Xx3:$i] : (((cwpss @ cc0 @ (ccv @ Xx3)) & (cwpss @ (ccv @ Xx3) @ ccnq)) & (cwral @ (^ [Xy1:$i] : ((! [Xz:$i] : ((cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccltq) => (cwcel @ (ccv @ Xz) @ (ccv @ Xx3)))) & (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccltq)) @ (^ [Xz:$i] : (ccv @ Xx3))))) @ (^ [Xy1:$i] : (ccv @ Xx3)))))))).
thf(adf_pw_ax,axiom,(! [XA2:($i > $o)] : ((ccpw @ XA2) = (ccab @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XA2)))))).
thf(cnpex_conj,conjecture,(cwcel @ ccnp @ ccvv)).
