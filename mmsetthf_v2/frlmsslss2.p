...
thf(afnsuppres_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((cw3a @ (cwfn @ XF @ (ccun @ XA2 @ XB2)) @ ((cwcel @ XF @ XW) & (cwcel @ XZ @ XV)) @ ((ccin @ XA2 @ XB2) = cc0)) => ((cwss @ (cco @ XF @ XZ @ ccsupp) @ XA2) <=> ((ccres @ XF @ XB2) = (ccxp @ XB2 @ (ccsn @ XZ)))))))))))).
...
thf(afrlmsslss_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XY = (cco @ XR @ XI @ ccfrlm)) => ((XU = (ccfv @ XY @ cclss)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((! [Xx3:$i] : ((XC @ Xx3) = (ccrab @ (^ [Xx3:$i] : ((ccres @ (ccv @ Xx3) @ XJ) = (ccxp @ XJ @ (ccsn @ Xc_0)))) @ (^ [Xx3:$i] : XB2)))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XV) @ (cwss @ XJ @ XI)) => (cwcel @ (XC @ Xx3) @ XU)))))))))))))))))).
thf(cfrlmsslss2_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XY = (cco @ XR @ XI @ ccfrlm)) => ((XU = (ccfv @ XY @ cclss)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((! [Xx3:$i] : ((XC @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwss @ (cco @ (ccv @ Xx3) @ Xc_0 @ ccsupp) @ XJ)) @ (^ [Xx3:$i] : XB2)))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XV) @ (cwss @ XJ @ XI)) => (cwcel @ (XC @ Xx3) @ XU)))))))))))))))))).
