...
thf(alogreclem_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ (ccrn @ cclog)) & (~ ((ccfv @ XA2 @ ccim) = ccpi))) => (cwcel @ (ccneg @ XA2) @ (ccrn @ cclog))))).
thf(clogrec_conj,conjecture,(! [XA2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwne @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ ccpi)) => ((ccfv @ XA2 @ cclog) = (ccneg @ (ccfv @ (cco @ cc1 @ XA2 @ ccdiv) @ cclog)))))).
