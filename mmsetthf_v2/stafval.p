...
thf(cstafval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_as:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_as = (ccfv @ XR @ ccstv)) => ((Xc_xb = (ccfv @ XR @ ccstf)) => ((cwcel @ XA2 @ XB2) => ((ccfv @ XA2 @ Xc_xb) = (ccfv @ XA2 @ Xc_as)))))))))))).
