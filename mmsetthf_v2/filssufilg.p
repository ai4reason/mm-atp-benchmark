...
thf(afiluni_ax,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwss @ XF @ (ccfv @ XX @ ccfil)) @ (cwne @ XF @ cc0) @ (cwral @ (^ [Xf1:$i] : (cwral @ (^ [Xg1:$i] : (cwcel @ (ccun @ (ccv @ Xf1) @ (ccv @ Xg1)) @ XF)) @ (^ [Xg1:$i] : XF))) @ (^ [Xf1:$i] : XF))) => (cwcel @ (ccuni @ XF) @ (ccfv @ XX @ ccfil)))))).
