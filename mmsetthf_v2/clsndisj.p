...
thf(cclsndisj_conj,conjecture,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX) @ (cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cccl)))) & ((cwcel @ XU @ XJ) & (cwcel @ XP @ XU))) => (cwne @ (ccin @ XU @ XS) @ cc0))))))))).
