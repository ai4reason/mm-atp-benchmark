...
thf(csuppss_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (Xph => (cwf @ (XA2 @ Xk) @ (XB2 @ Xk) @ XF))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (ccdif @ (XA2 @ Xk) @ XW))) => ((ccfv @ (ccv @ Xk) @ XF) = XZ))) => (Xph => (cwss @ (cco @ XF @ XZ @ ccsupp) @ XW))))))))))).
