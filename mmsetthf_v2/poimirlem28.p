...
thf(afnn0ind_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = ccc0) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) => ((Xph @ Xx3) <=> (Xth @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XK @ Xy1)) => ((Xph @ Xx3) <=> (Xta @ Xy1))))) => ((! [Xy1:$i] : ((cwcel @ XN @ ccn0) => (Xps @ Xy1))) => ((! [Xy1:$i] : ((cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ (ccv @ Xy1) @ ccn0) @ (cwbr @ (ccv @ Xy1) @ XN @ cclt)) => ((Xch @ Xy1) => (Xth @ Xy1)))) => (! [Xy1:$i] : ((cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ (XK @ Xy1) @ ccn0) @ (cwbr @ (XK @ Xy1) @ XN @ ccle)) => (Xta @ Xy1))))))))))))))))).
...
thf(arabeqbidva_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (XA2 = XB2)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => ((Xps @ Xx3) <=> (Xch @ Xx3)))) => (Xph => ((ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)) = (ccrab @ (^ [Xx3:$i] : (Xch @ Xx3)) @ (^ [Xx3:$i] : XB2)))))))))))).
...
thf(afz10_ax,axiom,((cco @ cc1 @ ccc0 @ ccfz) = cc0)).
thf(aeqtri_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((XB2 = XC) => (XA2 = XC))))))).
thf(aax_mp_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((Xph => Xps) => Xps))))).
thf(ccpw_tp,type,(ccpw : (($i > $o) > ($i > $o)))).
thf(afzofi_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwcel @ (cco @ XM @ XN @ ccfzo) @ ccfn)))).
thf(amap0e_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cco @ XA2 @ cc0 @ ccmap) = cc1o))))).
...
thf(af1o00_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwf1o @ cc0 @ XA2 @ XF) <=> ((XF = cc0) & (XA2 = cc0)))))).
...
thf(af0_ax,axiom,(! [XA2:($i > $o)] : (cwf @ cc0 @ XA2 @ cc0))).
...
thf(arexsn_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> Xps))) => ((cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccsn @ XA2))) <=> Xps))))))).
thf(ac0ex_ax,axiom,(cwcel @ ccc0 @ ccvv)).
thf(ccres_tp,type,(ccres : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aima0_ax,axiom,(! [XA2:($i > $o)] : ((ccima @ XA2 @ cc0) = cc0))).
thf(a_0xp_ax,axiom,(! [XA2:($i > $o)] : ((ccxp @ cc0 @ XA2) = cc0))).
...
thf(amapval_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cco @ XA2 @ XB2 @ ccmap) = (ccab @ (^ [Xf1:$i] : (cwf @ XB2 @ XA2 @ (ccv @ Xf1)))))))))).
...
thf(apoimirlem27_ax,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XN @ ccn))) => ((! [Xf1:$i] : (! [Xj:$i] : (! [Xs1:$i] : (! [Xp:$i] : (((ccv @ Xp) = (cco @ (ccfv @ (ccv @ Xs1) @ cc1st) @ (ccun @ (ccxp @ (ccima @ (ccfv @ (ccv @ Xs1) @ cc2nd) @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (ccfv @ (ccv @ Xs1) @ cc2nd) @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc))) => ((XB2 @ Xp) = (XC @ Xf1 @ Xj @ Xs1))))))) => ((! [Xf1:$i] : (! [Xp:$i] : (((Xph @ Xf1) & (cwf @ (cco @ cc1 @ XN @ ccfz) @ (cco @ ccc0 @ XK @ ccfz) @ (ccv @ Xp))) => (cwcel @ (XB2 @ Xp) @ (cco @ ccc0 @ XN @ ccfz))))) => ((! [Xf1:$i] : (! [Xn:$i] : (! [Xp:$i] : (((Xph @ Xf1) & (cw3a @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz)) @ (cwf @ (cco @ cc1 @ XN @ ccfz) @ (cco @ ccc0 @ XK @ ccfz) @ (ccv @ Xp)) @ ((ccfv @ (ccv @ Xn) @ (ccv @ Xp)) = ccc0))) => (cwbr @ (XB2 @ Xp) @ (ccv @ Xn) @ cclt))))) => ((! [Xf1:$i] : (! [Xn:$i] : (! [Xp:$i] : (((Xph @ Xf1) & (cw3a @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz)) @ (cwf @ (cco @ cc1 @ XN @ ccfz) @ (cco @ ccc0 @ XK @ ccfz) @ (ccv @ Xp)) @ ((ccfv @ (ccv @ Xn) @ (ccv @ Xp)) = XK))) => (cwne @ (XB2 @ Xp) @ (cco @ (ccv @ Xn) @ cc1 @ ccmin)))))) => (! [Xf1:$i] : ((Xph @ Xf1) => (cwbr @ cc2 @ (cco @ (ccfv @ (ccrab @ (^ [Xt:$i] : (cwral @ (^ [Xi:$i] : (cwrex @ (^ [Xj:$i] : ((ccv @ Xi) = (ccsb @ (ccfv @ (ccv @ Xt) @ cc1st) @ (^ [Xs1:$i] : (XC @ Xf1 @ Xj @ Xs1))))) @ (^ [Xj:$i] : (ccdif @ (cco @ ccc0 @ XN @ ccfz) @ (ccsn @ (ccfv @ (ccv @ Xt) @ cc2nd)))))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)))) @ (^ [Xt:$i] : (ccxp @ (ccxp @ (cco @ (cco @ ccc0 @ XK @ ccfzo) @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ (ccab @ (^ [Xf1:$i] : (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))) @ (cco @ ccc0 @ XN @ ccfz)))) @ cchash) @ (ccfv @ (ccrab @ (^ [Xs1:$i] : (cw3a @ (cwral @ (^ [Xi:$i] : (cwrex @ (^ [Xj:$i] : ((ccv @ Xi) = (XC @ Xf1 @ Xj @ Xs1))) @ (^ [Xj:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) @ ((ccfv @ XN @ (ccfv @ (ccv @ Xs1) @ cc1st)) = ccc0) @ ((ccfv @ XN @ (ccfv @ (ccv @ Xs1) @ cc2nd)) = XN))) @ (^ [Xs1:$i] : (ccxp @ (cco @ (cco @ ccc0 @ XK @ ccfzo) @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ (ccab @ (^ [Xf1:$i] : (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))))) @ cchash) @ ccmin) @ ccdvds)))))))))))))).
...
thf(afzdisj_ax,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwbr @ XK @ XM @ cclt) => ((ccin @ (cco @ XJ @ XK @ ccfz) @ (cco @ XM @ XN @ ccfz)) = cc0))))))).
...
thf(apoimirlem26_ax,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XN @ ccn))) => ((! [Xf1:$i] : (! [Xj:$i] : (! [Xs1:$i] : (! [Xp:$i] : (((ccv @ Xp) = (cco @ (ccfv @ (ccv @ Xs1) @ cc1st) @ (ccun @ (ccxp @ (ccima @ (ccfv @ (ccv @ Xs1) @ cc2nd) @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (ccfv @ (ccv @ Xs1) @ cc2nd) @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc))) => ((XB2 @ Xp) = (XC @ Xf1 @ Xj @ Xs1))))))) => ((! [Xf1:$i] : (! [Xp:$i] : (((Xph @ Xf1) & (cwf @ (cco @ cc1 @ XN @ ccfz) @ (cco @ ccc0 @ XK @ ccfz) @ (ccv @ Xp))) => (cwcel @ (XB2 @ Xp) @ (cco @ ccc0 @ XN @ ccfz))))) => (! [Xf1:$i] : ((Xph @ Xf1) => (cwbr @ cc2 @ (cco @ (ccfv @ (ccrab @ (^ [Xt:$i] : (cwral @ (^ [Xi:$i] : (cwrex @ (^ [Xj:$i] : ((ccv @ Xi) = (ccsb @ (ccfv @ (ccv @ Xt) @ cc1st) @ (^ [Xs1:$i] : (XC @ Xf1 @ Xj @ Xs1))))) @ (^ [Xj:$i] : (ccdif @ (cco @ ccc0 @ XN @ ccfz) @ (ccsn @ (ccfv @ (ccv @ Xt) @ cc2nd)))))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)))) @ (^ [Xt:$i] : (ccxp @ (ccxp @ (cco @ (cco @ ccc0 @ XK @ ccfzo) @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ (ccab @ (^ [Xf1:$i] : (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))) @ (cco @ ccc0 @ XN @ ccfz)))) @ cchash) @ (ccfv @ (ccrab @ (^ [Xs1:$i] : (cwral @ (^ [Xi:$i] : (cwrex @ (^ [Xj:$i] : ((ccv @ Xi) = (XC @ Xf1 @ Xj @ Xs1))) @ (^ [Xj:$i] : (cco @ ccc0 @ XN @ ccfz)))) @ (^ [Xi:$i] : (cco @ ccc0 @ XN @ ccfz)))) @ (^ [Xs1:$i] : (ccxp @ (cco @ (cco @ ccc0 @ XK @ ccfzo) @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ (ccab @ (^ [Xf1:$i] : (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))))) @ cchash) @ ccmin) @ ccdvds)))))))))))).
...
thf(advds2sub_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) => (((cwbr @ XK @ XM @ ccdvds) & (cwbr @ XK @ XN @ ccdvds)) => (cwbr @ XK @ (cco @ XM @ XN @ ccmin) @ ccdvds))))))).
thf(ann0cni_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => (cwcel @ XA2 @ ccc)))).
thf(annncan1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) => ((cco @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XA2 @ XC @ ccmin) @ ccmin) = (cco @ XC @ XB2 @ ccmin))))))).
thf(advdssub2_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) & (cwbr @ XK @ (cco @ XM @ XN @ ccmin) @ ccdvds)) => ((cwbr @ XK @ XM @ ccdvds) <=> (cwbr @ XK @ XN @ ccdvds))))))).
...
thf(apoimirlem4_ax,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XN @ ccn))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XK @ ccn))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XM @ ccn0))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwbr @ XM @ XN @ cclt))) => (! [Xf1:$i] : ((Xph @ Xf1) => (cwbr @ (ccrab @ (^ [Xs1:$i] : (cwral @ (^ [Xi:$i] : (cwrex @ (^ [Xj:$i] : ((ccv @ Xi) = (ccsb @ (ccun @ (cco @ (ccfv @ (ccv @ Xs1) @ cc1st) @ (ccun @ (ccxp @ (ccima @ (ccfv @ (ccv @ Xs1) @ cc2nd) @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (ccfv @ (ccv @ Xs1) @ cc2nd) @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XM @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc)) @ (ccxp @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XN @ ccfz) @ (ccsn @ ccc0))) @ (^ [Xp:$i] : (XB2 @ Xp))))) @ (^ [Xj:$i] : (cco @ ccc0 @ XM @ ccfz)))) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfz)))) @ (^ [Xs1:$i] : (ccxp @ (cco @ (cco @ ccc0 @ XK @ ccfzo) @ (cco @ cc1 @ XM @ ccfz) @ ccmap) @ (ccab @ (^ [Xf1:$i] : (cwf1o @ (cco @ cc1 @ XM @ ccfz) @ (cco @ cc1 @ XM @ ccfz) @ (ccv @ Xf1))))))) @ (ccrab @ (^ [Xs1:$i] : (cw3a @ (cwral @ (^ [Xi:$i] : (cwrex @ (^ [Xj:$i] : ((ccv @ Xi) = (ccsb @ (ccun @ (cco @ (ccfv @ (ccv @ Xs1) @ cc1st) @ (ccun @ (ccxp @ (ccima @ (ccfv @ (ccv @ Xs1) @ cc2nd) @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (ccfv @ (ccv @ Xs1) @ cc2nd) @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ (cco @ XM @ cc1 @ ccaddc) @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc)) @ (ccxp @ (cco @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ cc1 @ ccaddc) @ XN @ ccfz) @ (ccsn @ ccc0))) @ (^ [Xp:$i] : (XB2 @ Xp))))) @ (^ [Xj:$i] : (cco @ ccc0 @ XM @ ccfz)))) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfz))) @ ((ccfv @ (cco @ XM @ cc1 @ ccaddc) @ (ccfv @ (ccv @ Xs1) @ cc1st)) = ccc0) @ ((ccfv @ (cco @ XM @ cc1 @ ccaddc) @ (ccfv @ (ccv @ Xs1) @ cc2nd)) = (cco @ XM @ cc1 @ ccaddc)))) @ (^ [Xs1:$i] : (ccxp @ (cco @ (cco @ ccc0 @ XK @ ccfzo) @ (cco @ cc1 @ (cco @ XM @ cc1 @ ccaddc) @ ccfz) @ ccmap) @ (ccab @ (^ [Xf1:$i] : (cwf1o @ (cco @ cc1 @ (cco @ XM @ cc1 @ ccaddc) @ ccfz) @ (cco @ cc1 @ (cco @ XM @ cc1 @ ccaddc) @ ccfz) @ (ccv @ Xf1))))))) @ ccen))))))))))))).
...
thf(cpoimirlem28_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XN @ ccn))) => ((! [Xf1:$i] : (! [Xj:$i] : (! [Xs1:$i] : (! [Xp:$i] : (((ccv @ Xp) = (cco @ (ccfv @ (ccv @ Xs1) @ cc1st) @ (ccun @ (ccxp @ (ccima @ (ccfv @ (ccv @ Xs1) @ cc2nd) @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (ccfv @ (ccv @ Xs1) @ cc2nd) @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc))) => ((XB2 @ Xp) = (XC @ Xf1 @ Xj @ Xs1))))))) => ((! [Xf1:$i] : (! [Xp:$i] : (((Xph @ Xf1) & (cwf @ (cco @ cc1 @ XN @ ccfz) @ (cco @ ccc0 @ XK @ ccfz) @ (ccv @ Xp))) => (cwcel @ (XB2 @ Xp) @ (cco @ ccc0 @ XN @ ccfz))))) => ((! [Xf1:$i] : (! [Xn:$i] : (! [Xp:$i] : (((Xph @ Xf1) & (cw3a @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz)) @ (cwf @ (cco @ cc1 @ XN @ ccfz) @ (cco @ ccc0 @ XK @ ccfz) @ (ccv @ Xp)) @ ((ccfv @ (ccv @ Xn) @ (ccv @ Xp)) = ccc0))) => (cwbr @ (XB2 @ Xp) @ (ccv @ Xn) @ cclt))))) => ((! [Xf1:$i] : (! [Xn:$i] : (! [Xp:$i] : (((Xph @ Xf1) & (cw3a @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz)) @ (cwf @ (cco @ cc1 @ XN @ ccfz) @ (cco @ ccc0 @ XK @ ccfz) @ (ccv @ Xp)) @ ((ccfv @ (ccv @ Xn) @ (ccv @ Xp)) = XK))) => (cwne @ (XB2 @ Xp) @ (cco @ (ccv @ Xn) @ cc1 @ ccmin)))))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XK @ ccn))) => (! [Xf1:$i] : ((Xph @ Xf1) => (cwrex @ (^ [Xs1:$i] : (cwral @ (^ [Xi:$i] : (cwrex @ (^ [Xj:$i] : ((ccv @ Xi) = (XC @ Xf1 @ Xj @ Xs1))) @ (^ [Xj:$i] : (cco @ ccc0 @ XN @ ccfz)))) @ (^ [Xi:$i] : (cco @ ccc0 @ XN @ ccfz)))) @ (^ [Xs1:$i] : (ccxp @ (cco @ (cco @ ccc0 @ XK @ ccfzo) @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ (ccab @ (^ [Xf1:$i] : (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))))))))))))))))))).
