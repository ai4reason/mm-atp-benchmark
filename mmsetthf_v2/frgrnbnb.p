...
thf(cfrgrnbnb_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XE = (ccfv @ XG @ ccedg)) => ((XD = (cco @ XG @ XX @ ccnbgr)) => ((cw3a @ (cwcel @ XG @ ccfrgr) @ ((cwcel @ XU @ XD) & (cwcel @ XW @ XD)) @ (cwne @ XU @ XW)) => (((cwcel @ (ccpr @ XU @ XA2) @ XE) & (cwcel @ (ccpr @ XW @ XA2) @ XE)) => (XA2 = XX))))))))))))).
