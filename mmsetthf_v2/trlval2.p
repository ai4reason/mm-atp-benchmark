...
thf(atrlval_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [Xc_an:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : ((! [Xp:$i] : ((XB2 @ Xp) = (ccfv @ XK @ ccbs))) => ((! [Xx3:$i] : (! [Xp:$i] : ((Xc_le @ Xx3 @ Xp) = (ccfv @ XK @ ccple)))) => ((! [Xx3:$i] : (! [Xp:$i] : ((Xc_or @ Xx3 @ Xp) = (ccfv @ XK @ ccjn)))) => ((! [Xx3:$i] : (! [Xp:$i] : ((Xc_an @ Xx3 @ Xp) = (ccfv @ XK @ ccmee)))) => ((! [Xx3:$i] : ((XA2 @ Xx3) = (ccfv @ XK @ ccatm))) => ((! [Xx3:$i] : (! [Xp:$i] : ((XH @ Xx3 @ Xp) = (ccfv @ XK @ cclh)))) => ((! [Xx3:$i] : (! [Xp:$i] : ((XT @ Xx3 @ Xp) = (ccfv @ XW @ (ccfv @ XK @ ccltrn))))) => ((! [Xx3:$i] : (! [Xp:$i] : ((XR @ Xx3 @ Xp) = (ccfv @ XW @ (ccfv @ XK @ cctrl))))) => (! [Xx3:$i] : (! [Xp:$i] : ((((cwcel @ XK @ (XV @ Xx3 @ Xp)) & (cwcel @ XW @ (XH @ Xx3 @ Xp))) & (cwcel @ XF @ (XT @ Xx3 @ Xp))) => ((ccfv @ XF @ (XR @ Xx3 @ Xp)) = (ccrio @ (^ [Xx3:$i] : (cwral @ (^ [Xp:$i] : ((~ (cwbr @ (ccv @ Xp) @ XW @ (Xc_le @ Xx3 @ Xp))) => ((ccv @ Xx3) = (cco @ (cco @ (ccv @ Xp) @ (ccfv @ (ccv @ Xp) @ XF) @ (Xc_or @ Xx3 @ Xp)) @ XW @ (Xc_an @ Xx3 @ Xp))))) @ (^ [Xp:$i] : (XA2 @ Xx3)))) @ (^ [Xx3:$i] : (XB2 @ Xp)))))))))))))))))))))))))))).
