...
thf(csupaddc_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwss @ XA2 @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwne @ XA2 @ cc0)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ XB2 @ ccr)))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : ((XC @ Xy1 @ Xz @ Xv) = (ccab @ (^ [Xz:$i] : (cwrex @ (^ [Xv:$i] : ((ccv @ Xz) = (cco @ (ccv @ Xv) @ XB2 @ ccaddc))) @ (^ [Xv:$i] : XA2)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : ((Xph @ Xx3 @ Xy1) => ((cco @ (ccsup @ XA2 @ ccr @ cclt) @ XB2 @ ccaddc) = (ccsup @ (XC @ Xy1 @ Xz @ Xv) @ ccr @ cclt))))))))))))))))).
