...
thf(avdwlem2_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XR @ ccfn)) => ((Xph => (cwcel @ XK @ ccn0)) => ((Xph => (cwcel @ XW @ ccn)) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwf @ (cco @ cc1 @ XM @ ccfz) @ XR @ XF)) => ((Xph => (cwcel @ XM @ (ccfv @ (cco @ XW @ XN @ ccaddc) @ ccuz))) => ((XG = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XW @ ccfz)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ XN @ ccaddc) @ XF)))) => (Xph => ((cwbr @ XK @ XG @ ccvdwm) => (cwbr @ XK @ XF @ ccvdwm))))))))))))))))))).
