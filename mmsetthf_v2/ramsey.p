...
thf(aramcl_ax,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XM @ ccn0) @ (cwcel @ XR @ ccfn) @ (cwf @ XR @ ccn0 @ XF)) => (cwcel @ (cco @ XM @ XF @ ccram) @ ccn0)))))).
