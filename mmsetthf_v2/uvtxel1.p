...
thf(aisuvtx_ax,axiom,(! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xv:$i] : (! [Xk:$i] : ((XE @ Xv @ Xk) = (ccfv @ XG @ ccedg)))) => ((ccfv @ XG @ ccuvtx) = (ccrab @ (^ [Xv:$i] : (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ (ccv @ Xk) @ (ccv @ Xv)) @ (ccv @ Xe))) @ (^ [Xe:$i] : (XE @ Xv @ Xk)))) @ (^ [Xk:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV))))))))).
