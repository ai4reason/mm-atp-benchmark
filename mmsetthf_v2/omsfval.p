...
thf(ainfexd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (cwor @ XA2 @ XR)) => (Xph => (cwcel @ (ccinf @ XB2 @ XA2 @ XR) @ ccvv)))))))).
