...
thf(afingch_ax,axiom,(cwss @ ccfn @ ccgch)).
...
thf(adfac12_ax,axiom,(cwac <=> (cwral @ (^ [Xx3:$i] : (cwcel @ (ccpw @ (ccfv @ (ccv @ Xx3) @ ccale)) @ (ccdm @ cccrd))) @ (^ [Xx3:$i] : ccon0)))).
...
thf(aengch_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) => ((cwcel @ XA2 @ ccgch) <=> (cwcel @ XB2 @ ccgch)))))).
