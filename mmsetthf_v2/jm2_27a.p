...
thf(acongsym_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) & ((cwcel @ XC @ ccz) & (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccdvds))) => (cwbr @ XA2 @ (cco @ XC @ XB2 @ ccmin) @ ccdvds)))))).
...
thf(alermy_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) => ((cwbr @ XM @ XN @ ccle) <=> (cwbr @ (cco @ XA2 @ XM @ ccrmy) @ (cco @ XA2 @ XN @ ccrmy) @ ccle))))))).
thf(aelnn0z_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) <=> ((cwcel @ XN @ ccz) & (cwbr @ ccc0 @ XN @ ccle))))).
thf(ajm2_16nn0_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccn0)) => (cwbr @ (cco @ XA2 @ cc1 @ ccmin) @ (cco @ (cco @ XA2 @ XN @ ccrmy) @ XN @ ccmin) @ ccdvds))))).
...
thf(advdstr_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) => (((cwbr @ XK @ XM @ ccdvds) & (cwbr @ XM @ XN @ ccdvds)) => (cwbr @ XK @ XN @ ccdvds))))))).
thf(acongtr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cw3a @ ((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) @ ((cwcel @ XC @ ccz) & (cwcel @ XD @ ccz)) @ ((cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccdvds) & (cwbr @ XA2 @ (cco @ XC @ XD @ ccmin) @ ccdvds))) => (cwbr @ XA2 @ (cco @ XB2 @ XD @ ccmin) @ ccdvds))))))).
...
thf(ajm2_20nn_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) => ((cwbr @ (cco @ (cco @ XA2 @ XN @ ccrmy) @ cc2 @ ccexp) @ (cco @ XA2 @ XM @ ccrmy) @ ccdvds) <=> (cwbr @ (cco @ XN @ (cco @ XA2 @ XN @ ccrmy) @ ccmul) @ XM @ ccdvds))))))).
thf(aeqeltrrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (cwcel @ XA2 @ XC)) => (Xph => (cwcel @ XB2 @ XC))))))))).
thf(amuldvds2_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) => ((cwbr @ (cco @ XK @ XM @ ccmul) @ XN @ ccdvds) => (cwbr @ XM @ XN @ ccdvds))))))).
...
thf(ajm2_15nn0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccn0)) => (cwbr @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ (cco @ XA2 @ XN @ ccrmy) @ (cco @ XB2 @ XN @ ccrmy) @ ccmin) @ ccdvds)))))).
thf(aoveq12d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XD @ XF)))))))))))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(ajm2_26_ax,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccn)) & ((cwcel @ XK @ ccz) & (cwcel @ XM @ ccz))) => (((cwbr @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ (cco @ XA2 @ XK @ ccrmy) @ (cco @ XA2 @ XM @ ccrmy) @ ccmin) @ ccdvds) | (cwbr @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ (cco @ XA2 @ XK @ ccrmy) @ (ccneg @ (cco @ XA2 @ XM @ ccrmy)) @ ccmin) @ ccdvds)) <=> ((cwbr @ (cco @ cc2 @ XN @ ccmul) @ (cco @ XK @ XM @ ccmin) @ ccdvds) | (cwbr @ (cco @ cc2 @ XN @ ccmul) @ (cco @ XK @ (ccneg @ XM) @ ccmin) @ ccdvds))))))))).
thf(advdsacongtr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cw3a @ ((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) @ ((cwcel @ XC @ ccz) & (cwcel @ XD @ ccz)) @ ((cwbr @ XD @ XA2 @ ccdvds) & ((cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccdvds) | (cwbr @ XA2 @ (cco @ XB2 @ (ccneg @ XC) @ ccmin) @ ccdvds)))) => ((cwbr @ XD @ (cco @ XB2 @ XC @ ccmin) @ ccdvds) | (cwbr @ XD @ (cco @ XB2 @ (ccneg @ XC) @ ccmin) @ ccdvds)))))))).
...
thf(armygeid_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccn0)) => (cwbr @ XN @ (cco @ XA2 @ XN @ ccrmy) @ ccle))))).
thf(ccrp_tp,type,(ccrp : ($i > $o))).
thf(ccabs_tp,type,(ccabs : ($i > $o))).
thf(aacongeq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ (cco @ ccc0 @ XA2 @ ccfz)) @ (cwcel @ XC @ (cco @ ccc0 @ XA2 @ ccfz))) => ((XB2 = XC) <=> ((cwbr @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ XB2 @ XC @ ccmin) @ ccdvds) | (cwbr @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ XB2 @ (ccneg @ XC) @ ccmin) @ ccdvds)))))))).
