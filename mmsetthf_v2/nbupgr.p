...
thf(anbgrval_ax,axiom,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xn:$i] : ((XE @ Xn) = (ccfv @ XG @ ccedg))) => ((cwcel @ XN @ XV) => ((cco @ XG @ XN @ ccnbgr) = (ccrab @ (^ [Xn:$i] : (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ XN @ (ccv @ Xn)) @ (ccv @ Xe))) @ (^ [Xe:$i] : (XE @ Xn)))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ XN))))))))))))).
...
thf(aupgredgpr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cw3a @ (cwcel @ XG @ ccupgr) @ (cwcel @ XC @ XE) @ (cwss @ (ccpr @ XA2 @ XB2) @ XC)) & (cw3a @ (cwcel @ XA2 @ XU) @ (cwcel @ XB2 @ XW) @ (cwne @ XA2 @ XB2))) => ((ccpr @ XA2 @ XB2) = XC))))))))))))).
...
thf(cnbupgr_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ ccupgr) & (cwcel @ XN @ XV)) => ((cco @ XG @ XN @ ccnbgr) = (ccrab @ (^ [Xn:$i] : (cwcel @ (ccpr @ XN @ (ccv @ Xn)) @ XE)) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ XN))))))))))))).
