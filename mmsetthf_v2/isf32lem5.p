...
thf(aisf32lem2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwf @ ccom @ (ccpw @ (XG @ Xx3)) @ XF))) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : ccom))) => ((Xph => (~ (cwcel @ (ccint @ (ccrn @ XF)) @ (ccrn @ XF)))) => ((Xph & (cwcel @ XA2 @ ccom)) => (cwrex @ (^ [Xa:$i] : ((cwcel @ XA2 @ (ccv @ Xa)) & (cwpss @ (ccfv @ (ccsuc @ (ccv @ Xa)) @ XF) @ (ccfv @ (ccv @ Xa) @ XF)))) @ (^ [Xa:$i] : ccom))))))))))).
