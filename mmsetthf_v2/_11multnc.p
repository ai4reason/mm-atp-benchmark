...
thf(adecmulnc_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cco @ XN @ (ccdc @ XA2 @ XB2) @ ccmul) = (ccdc @ (cco @ XN @ XA2 @ ccmul) @ (cco @ XN @ XB2 @ ccmul)))))))))).
thf(a_1nn0_ax,axiom,(cwcel @ cc1 @ ccn0)).
thf(adeceq12i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((XA2 = XB2) => ((XC = XD) => ((ccdc @ XA2 @ XC) = (ccdc @ XB2 @ XD))))))))).
