...
thf(ctgcnp_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XJ @ (ccfv @ XX @ cctopon)))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (XK = (ccfv @ XB2 @ cctg)))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XK @ (ccfv @ XY @ cctopon)))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XP @ XX))) => (! [Xy1:$i] : ((Xph @ Xy1) => ((cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) <=> ((cwf @ XX @ XY @ XF) & (cwral @ (^ [Xy1:$i] : ((cwcel @ (ccfv @ XP @ XF) @ (ccv @ Xy1)) => (cwrex @ (^ [Xx3:$i] : ((cwcel @ XP @ (ccv @ Xx3)) & (cwss @ (ccima @ XF @ (ccv @ Xx3)) @ (ccv @ Xy1)))) @ (^ [Xx3:$i] : XJ)))) @ (^ [Xy1:$i] : XB2))))))))))))))))))).
