...
thf(cdomnrrg_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XE = (ccfv @ XR @ ccrlreg)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cw3a @ (cwcel @ XR @ ccdomn) @ (cwcel @ XX @ XB2) @ (cwne @ XX @ Xc_0)) => (cwcel @ XX @ XE))))))))))).
