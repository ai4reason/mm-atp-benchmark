...
thf(aispridlc_ax,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : ((XG @ Xa @ Xb) = (ccfv @ XR @ cc1st)))) => ((XH = (ccfv @ XR @ cc2nd)) => ((! [Xa:$i] : (! [Xb:$i] : (XX = (ccrn @ (XG @ Xa @ Xb))))) => ((cwcel @ XR @ cccring) => ((cwcel @ XP @ (ccfv @ XR @ ccpridl)) <=> (cw3a @ (cwcel @ XP @ (ccfv @ XR @ ccidl)) @ (cwne @ XP @ XX) @ (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : ((cwcel @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ XH) @ XP) => ((cwcel @ (ccv @ Xa) @ XP) | (cwcel @ (ccv @ Xb) @ XP)))) @ (^ [Xb:$i] : XX))) @ (^ [Xa:$i] : XX)))))))))))))).
