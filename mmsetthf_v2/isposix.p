...
thf(cisposix_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > ($i > ($i > ($i > $o))))] : (! [Xc_le:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ Xc_le @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XK @ Xx3 @ Xy1 @ Xz) = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccple) @ Xc_le)))))) => ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XB2) => (cwbr @ (ccv @ Xx3) @ (ccv @ Xx3) @ Xc_le))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XB2) & (cwcel @ (ccv @ Xy1) @ XB2)) => (((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_le) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ Xc_le)) => ((ccv @ Xx3) = (ccv @ Xy1)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cw3a @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwcel @ (ccv @ Xy1) @ XB2) @ (cwcel @ (ccv @ Xz) @ XB2)) => (((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_le) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ Xc_le)) => (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ Xc_le)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwcel @ (XK @ Xx3 @ Xy1 @ Xz) @ ccpo)))))))))))))).
