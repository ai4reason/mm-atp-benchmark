...
thf(aisclwwlknOLD_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XN @ ccn) => ((cwcel @ XW @ (cco @ XN @ XG @ ccclwwlknold)) <=> ((cwcel @ XW @ (ccfv @ XG @ ccclwwlk)) & ((ccfv @ XW @ cchash) = XN)))))))).
thf(aanbi1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph <=> Xps) => ((Xph & Xch) <=> (Xps & Xch))))))).
thf(aisclwwlk_ax,axiom,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : ((! [Xi:$i] : ((XV @ Xi) = (ccfv @ XG @ ccvtx))) => ((! [Xi:$i] : ((XE @ Xi) = (ccfv @ XG @ ccedg))) => (! [Xi:$i] : ((cwcel @ XW @ (ccfv @ XG @ ccclwwlk)) <=> (cw3a @ ((cwcel @ XW @ (ccword @ (XV @ Xi))) & (cwne @ XW @ cc0)) @ (cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ XW) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XW)) @ (XE @ Xi))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ ccfzo))) @ (cwcel @ (ccpr @ (ccfv @ XW @ cclsw) @ (ccfv @ ccc0 @ XW)) @ (XE @ Xi)))))))))))).
...
thf(cclwwlknwwlksnOLD_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XW @ (cco @ XN @ XG @ ccclwwlknold))) => (cwcel @ XW @ (cco @ (cco @ XN @ cc1 @ ccmin) @ XG @ ccwwlksn))))))).
