...
thf(ann0addge2i_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XN @ ccn0) => (cwbr @ XA2 @ (cco @ XN @ XA2 @ ccaddc) @ ccle)))))).
