...
thf(azrdivrng_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (~ (cwcel @ (ccop @ (ccsn @ (ccop @ (ccop @ XA2 @ XA2) @ XA2)) @ (ccsn @ (ccop @ (ccop @ XA2 @ XA2) @ XA2))) @ ccdrng))))).
...
thf(arngoueqz_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XH = (ccfv @ XR @ cc2nd)) => ((XZ = (ccfv @ XG @ ccgi)) => ((XU = (ccfv @ XH @ ccgi)) => ((XX = (ccrn @ XG)) => ((cwcel @ XR @ ccrngo) => ((cwbr @ XX @ cc1o @ ccen) <=> (XU = XZ))))))))))))))).
...
thf(arngosn6_ax,axiom,(! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XX = (ccrn @ XG)) => ((XZ = (ccfv @ XG @ ccgi)) => ((cwcel @ XR @ ccrngo) => ((cwbr @ XX @ cc1o @ ccen) <=> (XR = (ccop @ (ccsn @ (ccop @ (ccop @ XZ @ XZ) @ XZ)) @ (ccsn @ (ccop @ (ccop @ XZ @ XZ) @ XZ)))))))))))))).
thf(abiimpd_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps <=> Xch)) => (Xph => (Xps => Xch))))))).
thf(aeleq1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwcel @ XA2 @ XC) <=> (cwcel @ XB2 @ XC))))))).
thf(cdvrunz_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XH = (ccfv @ XR @ cc2nd)) => ((XX = (ccrn @ XG)) => ((XZ = (ccfv @ XG @ ccgi)) => ((XU = (ccfv @ XH @ ccgi)) => ((cwcel @ XR @ ccdrng) => (cwne @ XU @ XZ)))))))))))))).
