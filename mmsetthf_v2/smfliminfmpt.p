...
thf(csmfliminfmpt_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xn:$i] : (cwnf @ (^ [Xm:$i] : (Xph @ Xx3 @ Xm @ Xn))))) => ((! [Xm:$i] : (! [Xn:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xm @ Xn))))) => ((! [Xx3:$i] : (! [Xm:$i] : (cwnf @ (^ [Xn:$i] : (Xph @ Xx3 @ Xm @ Xn))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwcel @ (XM @ Xx3 @ Xn) @ ccz))))) => ((! [Xx3:$i] : (! [Xn:$i] : (XZ = (ccfv @ (XM @ Xx3 @ Xn) @ ccuz)))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwcel @ (XS @ Xx3 @ Xn) @ ccsalg))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((cw3a @ (Xph @ Xx3 @ Xm @ Xn) @ (cwcel @ (ccv @ Xm) @ XZ) @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xm))) => (cwcel @ (XB2 @ Xx3 @ Xm) @ (XV @ Xx3 @ Xm @ Xn)))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : (((Xph @ Xx3 @ Xm @ Xn) & (cwcel @ (ccv @ Xm) @ XZ)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xm)) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xm))) @ (ccfv @ (XS @ Xx3 @ Xn) @ ccsmblfn)))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XD @ Xx3 @ Xm @ Xn) = (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccmpt @ (^ [Xm:$i] : XZ) @ (^ [Xm:$i] : (XB2 @ Xx3 @ Xm))) @ cclsi) @ ccr)) @ (^ [Xx3:$i] : (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (cciin @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)) @ (^ [Xm:$i] : (XA2 @ Xm))))))))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XG @ Xx3 @ Xm @ Xn) = (ccmpt @ (^ [Xx3:$i] : (XD @ Xx3 @ Xm @ Xn)) @ (^ [Xx3:$i] : (ccfv @ (ccmpt @ (^ [Xm:$i] : XZ) @ (^ [Xm:$i] : (XB2 @ Xx3 @ Xm))) @ cclsi))))))) => (! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwcel @ (XG @ Xx3 @ Xm @ Xn) @ (ccfv @ (XS @ Xx3 @ Xn) @ ccsmblfn)))))))))))))))))))))))))).
