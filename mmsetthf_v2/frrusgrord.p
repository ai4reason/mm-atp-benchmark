...
thf(afrrusgrord0_ax,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cw3a @ (cwcel @ XG @ ccfrgr) @ (cwcel @ XV @ ccfn) @ (cwne @ XV @ cc0)) => ((cwral @ (^ [Xv:$i] : ((ccfv @ (ccv @ Xv) @ (ccfv @ XG @ ccvtxdg)) = XK)) @ (^ [Xv:$i] : XV)) => ((ccfv @ XV @ cchash) = (cco @ (cco @ XK @ (cco @ XK @ cc1 @ ccmin) @ ccmul) @ cc1 @ ccaddc))))))))).
thf(cfrrusgrord_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XV @ ccfn) & (cwne @ XV @ cc0)) => (((cwcel @ XG @ ccfrgr) & (cwbr @ XG @ XK @ ccrusgr)) => ((ccfv @ XV @ cchash) = (cco @ (cco @ XK @ (cco @ XK @ cc1 @ ccmin) @ ccmul) @ cc1 @ ccaddc))))))))).
