...
thf(cadd20_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle)) & ((cwcel @ XB2 @ ccr) & (cwbr @ ccc0 @ XB2 @ ccle))) => (((cco @ XA2 @ XB2 @ ccaddc) = ccc0) <=> ((XA2 = ccc0) & (XB2 = ccc0))))))).
