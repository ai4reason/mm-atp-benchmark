...
thf(acaragenuni_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XO:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XS = (ccfv @ XO @ cccaragen)) => (Xph => ((ccuni @ XS) = (ccuni @ (ccdm @ XO)))))))))).
...
thf(aeliccelicod_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc))) => ((Xph => (cwne @ XC @ XB2)) => (Xph => (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico)))))))))))).
...
thf(aomelesplit_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((XX = (ccuni @ (ccdm @ XO))) => ((Xph => (cwss @ XA2 @ XX)) => (Xph => (cwbr @ (ccfv @ XA2 @ XO) @ (cco @ (ccfv @ (ccin @ XA2 @ XE) @ XO) @ (ccfv @ (ccdif @ XA2 @ XE) @ XO) @ ccxad) @ ccle))))))))))).
thf(ccarageniuncl_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XO @ ccome)) => ((! [Xn:$i] : ((XS @ Xn) = (ccfv @ XO @ cccaragen))) => ((Xph => (cwcel @ XM @ ccz)) => ((XZ = (ccfv @ XM @ ccuz)) => ((! [Xn:$i] : (Xph => (cwf @ XZ @ (XS @ Xn) @ XE))) => (! [Xn:$i] : (Xph => (cwcel @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XE))) @ (XS @ Xn)))))))))))))))).
