...
thf(cf1ocnt_conj,conjecture,(! [XA2:($i > $o)] : ((cwbr @ XA2 @ ccom @ ccdom) => (? [Xf1:$i] : ((cwf1o @ (ccdm @ (ccv @ Xf1)) @ XA2 @ (ccv @ Xf1)) & (((ccdm @ (ccv @ Xf1)) = ccn) | ((ccdm @ (ccv @ Xf1)) = (cco @ cc1 @ (cco @ (ccfv @ XA2 @ cchash) @ cc1 @ ccaddc) @ ccfzo)))))))).
