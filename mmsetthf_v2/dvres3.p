...
thf(advres2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((((cwss @ XS @ ccc) & (cwf @ XA2 @ ccc @ XF)) & ((cwss @ XA2 @ XS) & (cwss @ XB2 @ XS))) => (cwss @ (ccres @ (cco @ XS @ XF @ ccdv) @ XB2) @ (cco @ XB2 @ (ccres @ XF @ XB2) @ ccdv)))))))).
thf(cweu_tp,type,(cweu : (($i > $o) > $o))).
thf(afunssres_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfun @ XF) & (cwss @ XG @ XF)) => ((ccres @ XF @ (ccdm @ XG)) = XG))))).
thf(cdvres3_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((((cwcel @ XS @ (ccpr @ ccr @ ccc)) & (cwf @ XA2 @ ccc @ XF)) & ((cwss @ XA2 @ ccc) & (cwss @ XS @ (ccdm @ (cco @ ccc @ XF @ ccdv))))) => ((cco @ XS @ (ccres @ XF @ XS) @ ccdv) = (ccres @ (cco @ ccc @ XF @ ccdv) @ XS))))))).
