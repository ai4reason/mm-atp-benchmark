...
thf(cprodeq2ii_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwral @ (^ [Xk:$i] : ((ccfv @ (XB2 @ Xk) @ ccid) = (ccfv @ (XC @ Xk) @ ccid))) @ (^ [Xk:$i] : XA2)) => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) = (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))))))))).
