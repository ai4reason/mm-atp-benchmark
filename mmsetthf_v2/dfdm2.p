...
thf(acocnvcnv2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cccom @ XA2 @ (cccnv @ (cccnv @ XB2))) = (cccom @ XA2 @ XB2))))).
thf(aunidmrn_ax,axiom,(! [XA2:($i > $o)] : ((ccuni @ (ccuni @ (cccnv @ XA2))) = (ccun @ (ccdm @ XA2) @ (ccrn @ XA2))))).
...
thf(arncoeq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((ccdm @ XA2) = (ccrn @ XB2)) => ((ccrn @ (cccom @ XA2 @ XB2)) = (ccrn @ XA2)))))).
