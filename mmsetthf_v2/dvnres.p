...
thf(advres3a_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((((cwcel @ XS @ (ccpr @ ccr @ ccc)) & (cwf @ XA2 @ ccc @ XF)) & ((cwcel @ XA2 @ XJ) & ((ccdm @ (cco @ ccc @ XF @ ccdv)) = XA2))) => ((cco @ XS @ (ccres @ XF @ XS) @ ccdv) = (ccres @ (cco @ ccc @ XF @ ccdv) @ XS))))))))).
thf(cdvnres_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (((cw3a @ (cwcel @ XS @ (ccpr @ ccr @ ccc)) @ (cwcel @ XF @ (cco @ ccc @ ccc @ ccpm)) @ (cwcel @ XN @ ccn0)) & ((ccdm @ (ccfv @ XN @ (cco @ ccc @ XF @ ccdvn))) = (ccdm @ XF))) => ((ccfv @ XN @ (cco @ XS @ (ccres @ XF @ XS) @ ccdvn)) = (ccres @ (ccfv @ XN @ (cco @ ccc @ XF @ ccdvn)) @ XS))))))).
