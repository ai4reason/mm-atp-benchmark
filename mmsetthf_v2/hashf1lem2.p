...
thf(ahashf1lem1_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ (XA2 @ Xz) @ ccfn))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ (XB2 @ Xz) @ ccfn))) => ((! [Xz:$i] : ((Xph @ Xz) => (~ (cwcel @ (ccv @ Xz) @ (XA2 @ Xz))))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwbr @ (cco @ (ccfv @ (XA2 @ Xz) @ cchash) @ cc1 @ ccaddc) @ (ccfv @ (XB2 @ Xz) @ cchash) @ ccle))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwf1 @ (XA2 @ Xz) @ (XB2 @ Xz) @ (XF @ Xz)))) => (! [Xz:$i] : ((Xph @ Xz) => (cwbr @ (ccab @ (^ [Xf1:$i] : (((ccres @ (ccv @ Xf1) @ (XA2 @ Xz)) = (XF @ Xz)) & (cwf1 @ (ccun @ (XA2 @ Xz) @ (ccsn @ (ccv @ Xz))) @ (XB2 @ Xz) @ (ccv @ Xf1))))) @ (ccdif @ (XB2 @ Xz) @ (ccrn @ (XF @ Xz))) @ ccen))))))))))))).
...
thf(chashf1lem2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ (XA2 @ Xz) @ ccfn))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ (XB2 @ Xz) @ ccfn))) => ((! [Xz:$i] : ((Xph @ Xz) => (~ (cwcel @ (ccv @ Xz) @ (XA2 @ Xz))))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwbr @ (cco @ (ccfv @ (XA2 @ Xz) @ cchash) @ cc1 @ ccaddc) @ (ccfv @ (XB2 @ Xz) @ cchash) @ ccle))) => (! [Xz:$i] : ((Xph @ Xz) => ((ccfv @ (ccab @ (^ [Xf1:$i] : (cwf1 @ (ccun @ (XA2 @ Xz) @ (ccsn @ (ccv @ Xz))) @ (XB2 @ Xz) @ (ccv @ Xf1)))) @ cchash) = (cco @ (cco @ (ccfv @ (XB2 @ Xz) @ cchash) @ (ccfv @ (XA2 @ Xz) @ cchash) @ ccmin) @ (ccfv @ (ccab @ (^ [Xf1:$i] : (cwf1 @ (XA2 @ Xz) @ (XB2 @ Xz) @ (ccv @ Xf1)))) @ cchash) @ ccmul)))))))))))).
