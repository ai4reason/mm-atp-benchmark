...
thf(appisval2_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ cc2 @ (ccfv @ XM @ ccuz))) => ((ccin @ (cco @ ccc0 @ XA2 @ ccicc) @ ccprime) = (ccin @ (cco @ XM @ (ccfv @ XA2 @ ccfl) @ ccfz) @ ccprime)))))).
...
thf(cprmorcht_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (ccv @ Xn) @ cc1))))) => (! [Xn:$i] : ((cwcel @ (XA2 @ Xn) @ ccn) => ((ccfv @ (ccfv @ (XA2 @ Xn) @ cccht) @ cce) = (ccfv @ (XA2 @ Xn) @ (ccseq @ ccmul @ (XF @ Xn) @ cc1))))))))).
