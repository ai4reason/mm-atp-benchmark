...
thf(cbpolyval_conj,conjecture,(! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XX @ ccc)) => ((cco @ XN @ XX @ ccbp) = (cco @ (cco @ XX @ XN @ ccexp) @ (ccsu @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (cco @ (ccv @ Xk) @ XX @ ccbp) @ (cco @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ cc1 @ ccaddc) @ ccdiv) @ ccmul))) @ ccmin)))))).
