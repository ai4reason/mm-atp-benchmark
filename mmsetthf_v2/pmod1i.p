...
thf(cpmod1i_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XS = (ccfv @ XK @ ccpsubsp)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => (((cwcel @ XK @ cchlt) & (cw3a @ (cwss @ XX @ XA2) @ (cwss @ XY @ XA2) @ (cwcel @ XZ @ XS))) => ((cwss @ XX @ XZ) => ((ccin @ (cco @ XX @ XY @ Xc_pl) @ XZ) = (cco @ XX @ (ccin @ XY @ XZ) @ Xc_pl))))))))))))))).
