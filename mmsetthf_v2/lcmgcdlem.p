...
thf(alcmn0val_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) & (~ ((XM = ccc0) | (XN = ccc0)))) => ((cco @ XM @ XN @ cclcm) = (ccinf @ (ccrab @ (^ [Xn:$i] : ((cwbr @ XM @ (ccv @ Xn) @ ccdvds) & (cwbr @ XN @ (ccv @ Xn) @ ccdvds))) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt)))))).
thf(ainfmin_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (cwor @ XA2 @ XR)) => ((Xph => (cwcel @ XC @ XA2)) => ((Xph => (cwcel @ XC @ XB2)) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XB2)) => (~ (cwbr @ (ccv @ Xy1) @ XC @ XR)))) => (Xph => ((ccinf @ XB2 @ XA2 @ XR) = XC)))))))))))).
...
thf(clcmgcdlem_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn) & (cwcel @ XN @ ccn)) => (((cco @ (cco @ XM @ XN @ cclcm) @ (cco @ XM @ XN @ ccgcd) @ ccmul) = (ccfv @ (cco @ XM @ XN @ ccmul) @ ccabs)) & (((cwcel @ XK @ ccn) & ((cwbr @ XM @ XK @ ccdvds) & (cwbr @ XN @ XK @ ccdvds))) => (cwbr @ (cco @ XM @ XN @ cclcm) @ XK @ ccdvds)))))))).
