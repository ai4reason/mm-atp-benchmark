...
thf(a_19_36v_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : ((? [Xx3:$i] : ((Xph @ Xx3) => Xps)) <=> ((! [Xx3:$i] : (Xph @ Xx3)) => Xps))))).
thf(cbj_spcimdvv_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ XB2)) => ((! [Xx3:$i] : ((Xph & ((ccv @ Xx3) = XA2)) => ((Xps @ Xx3) => Xch))) => (Xph => ((! [Xx3:$i] : (Xps @ Xx3)) => Xch)))))))))).
