...
thf(awl_ax11_lem1_ax,axiom,(! [Xz:$i] : (! [Xy1:$i] : ((! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1))) => ((! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xz))) <=> (! [Xy1:$i] : ((ccv @ Xy1) = (ccv @ Xz)))))))).
...
thf(awl_ax11_lem4_ax,axiom,(! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : ((! [Xu:$i] : ((ccv @ Xu) = (ccv @ Xy1))) & (~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1))))))))).
...
thf(awl_ax11_lem7_ax,axiom,(! [Xph:($i > $o)] : (! [Xy1:$i] : ((! [Xx3:$i] : ((~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1)))) & (Xph @ Xx3))) <=> ((~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1)))) & (! [Xx3:$i] : (Xph @ Xx3))))))).
thf(apm5_32_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps <=> Xch)) <=> ((Xph & Xps) <=> (Xph & Xch))))))).
thf(cwl_ax11_lem8_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (! [Xu:$i] : (((! [Xu:$i] : ((ccv @ Xu) = (ccv @ Xy1))) & (~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1))))) => ((! [Xu:$i] : (! [Xx3:$i] : (cwsb @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xu)) @ Xu))) <=> (! [Xy1:$i] : (! [Xx3:$i] : (Xph @ Xx3 @ Xy1 @ Xu))))))))).
