...
thf(afuncnv_ax,axiom,(! [XA2:($i > $o)] : ((cwfun @ (cccnv @ XA2)) <=> (cwral @ (^ [Xy1:$i] : (cwmo @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XA2)))) @ (^ [Xy1:$i] : (ccrn @ XA2)))))).
...
thf(cfncnv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwfn @ (cccnv @ (ccin @ XR @ (ccxp @ XA2 @ XB2))) @ XB2) <=> (cwral @ (^ [Xy1:$i] : (cwreu @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR)) @ (^ [Xx3:$i] : XA2))) @ (^ [Xy1:$i] : XB2))))))).
