...
thf(acardnueq0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ cccrd)) => (((ccfv @ XA2 @ cccrd) = cc0) <=> (XA2 = cc0))))).
...
thf(ccarddomi2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwcel @ XB2 @ XV)) => ((cwss @ (ccfv @ XA2 @ cccrd) @ (ccfv @ XB2 @ cccrd)) => (cwbr @ XA2 @ XB2 @ ccdom))))))).
