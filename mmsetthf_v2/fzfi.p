...
thf(afzen2_ax,axiom,(! [XG:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc1 @ ccaddc))) @ ccc0) @ ccom))) => (! [Xx3:$i] : ((cwcel @ (XN @ Xx3) @ (ccfv @ (XM @ Xx3) @ ccuz)) => (cwbr @ (cco @ (XM @ Xx3) @ (XN @ Xx3) @ ccfz) @ (ccfv @ (cco @ (cco @ (XN @ Xx3) @ cc1 @ ccaddc) @ (XM @ Xx3) @ ccmin) @ (cccnv @ (XG @ Xx3))) @ ccen)))))))).
thf(aenfii_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XB2 @ ccfn) & (cwbr @ XA2 @ XB2 @ ccen)) => (cwcel @ XA2 @ ccfn))))).
thf(cfzfi_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwcel @ (cco @ XM @ XN @ ccfz) @ ccfn)))).
