...
thf(avdwlem1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XR @ ccfn)) => ((Xph => (cwcel @ XK @ ccn)) => ((Xph => (cwcel @ XW @ ccn)) => ((Xph => (cwf @ (cco @ cc1 @ XW @ ccfz) @ XR @ XF)) => ((Xph => (cwcel @ XA2 @ ccn)) => ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwf @ (cco @ cc1 @ XM @ ccfz) @ ccn @ XD)) => ((Xph => (cwral @ (^ [Xi:$i] : (cwss @ (cco @ (cco @ XA2 @ (ccfv @ (ccv @ Xi) @ XD) @ ccaddc) @ (ccfv @ (ccv @ Xi) @ XD) @ (ccfv @ XK @ ccvdwa)) @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccfv @ (cco @ XA2 @ (ccfv @ (ccv @ Xi) @ XD) @ ccaddc) @ XF))))) @ (^ [Xi:$i] : (cco @ cc1 @ XM @ ccfz)))) => ((Xph => (cwcel @ XI @ (cco @ cc1 @ XM @ ccfz))) => ((Xph => ((ccfv @ XA2 @ XF) = (ccfv @ (cco @ XA2 @ (ccfv @ XI @ XD) @ ccaddc) @ XF))) => (Xph => (cwbr @ (cco @ XK @ cc1 @ ccaddc) @ XF @ ccvdwm)))))))))))))))))))))).
