...
thf(aulmclm_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwf @ XZ @ (cco @ ccc @ XS @ ccmap) @ XF)) => ((Xph => (cwcel @ XA2 @ XS)) => ((! [Xk:$i] : (Xph => (cwcel @ XH @ (XW @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ XA2 @ (ccfv @ (ccv @ Xk) @ XF)) = (ccfv @ (ccv @ Xk) @ XH)))) => ((Xph => (cwbr @ XF @ XG @ (ccfv @ XS @ cculm))) => (Xph => (cwbr @ XH @ (ccfv @ XA2 @ XG) @ ccli))))))))))))))))))).
...
thf(amopni3_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => (((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XA2 @ XJ) @ (cwcel @ XP @ XA2)) & (cwcel @ XR @ ccrp)) => (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ XR @ cclt) & (cwss @ (cco @ XP @ (ccv @ Xx3) @ (ccfv @ XD @ ccbl)) @ XA2))) @ (^ [Xx3:$i] : ccrp))))))))))).
thf(asimpr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(culmdvlem3_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xz:$i] : (XZ = (ccfv @ (XM @ Xz) @ ccuz))) => ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((! [Xz:$i] : (Xph => (cwcel @ (XM @ Xz) @ ccz))) => ((Xph => (cwf @ XZ @ (cco @ ccc @ XX @ ccmap) @ XF)) => ((! [Xk:$i] : (Xph => (cwf @ XX @ ccc @ (XG @ Xk)))) => ((! [Xz:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xz) @ XX)) => (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xz) @ (ccfv @ (ccv @ Xk) @ XF)))) @ (ccfv @ (ccv @ Xz) @ (XG @ Xk)) @ ccli)))) => ((! [Xk:$i] : (Xph => (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (cco @ XS @ (ccfv @ (ccv @ Xk) @ XF) @ ccdv))) @ (XH @ Xk) @ (ccfv @ XX @ cculm)))) => (! [Xz:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xz) @ XX)) => (cwbr @ (ccv @ Xz) @ (ccfv @ (ccv @ Xz) @ (XH @ Xk)) @ (cco @ XS @ (XG @ Xk) @ ccdv))))))))))))))))))))).
