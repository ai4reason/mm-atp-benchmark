...
thf(acvpss_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((cwbr @ XA2 @ XB2 @ cccv) => (cwpss @ XA2 @ XB2)))))).
thf(cchsup_tp,type,(cchsup : ($i > $o))).
thf(ccfv_tp,type,(ccfv : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(cwral_tp,type,(cwral : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(achpssati_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwpss @ XA2 @ XB2) => (cwrex @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XB2) & (~ (cwss @ (ccv @ Xx3) @ XA2)))) @ (^ [Xx3:$i] : ccat)))))))).
...
thf(achcv1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccat)) => ((~ (cwss @ XB2 @ XA2)) <=> (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ cchj) @ cccv)))))).
...
thf(achabs1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cco @ XA2 @ (ccin @ XA2 @ XB2) @ cchj) = XA2)))))).
...
thf(achnle_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((~ (cwss @ XB2 @ XA2)) <=> (cwpss @ XA2 @ (cco @ XA2 @ XB2 @ cchj))))))).
...
thf(acvnbtwn2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) => ((cwbr @ XA2 @ XB2 @ cccv) => (((cwpss @ XA2 @ XC) & (cwss @ XC @ XB2)) => (XC = XB2)))))))).
thf(ccvexchlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwbr @ (ccin @ XA2 @ XB2) @ XB2 @ cccv) => (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ cchj) @ cccv))))))).
