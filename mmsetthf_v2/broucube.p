...
thf(ale0neg2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => ((cwbr @ ccc0 @ XA2 @ ccle) <=> (cwbr @ (ccneg @ XA2) @ ccc0 @ ccle))))))).
...
thf(cbroucube_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((XI = (cco @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) => ((XR = (ccfv @ (ccxp @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (ccfv @ (ccrn @ ccioo) @ cctg))) @ ccpt)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XR @ XI @ ccrest) @ (cco @ XR @ XI @ ccrest) @ cccn))) => (Xph => (cwrex @ (^ [Xc:$i] : ((ccv @ Xc) = (ccfv @ (ccv @ Xc) @ XF))) @ (^ [Xc:$i] : XI))))))))))))).
