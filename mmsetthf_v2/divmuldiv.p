...
thf(cdivmuldiv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) & (((cwcel @ XC @ ccc) & (cwne @ XC @ ccc0)) & ((cwcel @ XD @ ccc) & (cwne @ XD @ ccc0)))) => ((cco @ (cco @ XA2 @ XC @ ccdiv) @ (cco @ XB2 @ XD @ ccdiv) @ ccmul) = (cco @ (cco @ XA2 @ XB2 @ ccmul) @ (cco @ XC @ XD @ ccmul) @ ccdiv)))))))).
