...
thf(acxpsub_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ ((cwcel @ XA2 @ ccc) & (cwne @ XA2 @ ccc0)) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ cccxp) = (cco @ (cco @ XA2 @ XB2 @ cccxp) @ (cco @ XA2 @ XC @ cccxp) @ ccdiv))))))).
...
thf(achebbnd1_ax,axiom,(cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc2 @ ccpnf @ ccico)) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccdiv) @ (ccfv @ (ccv @ Xx3) @ ccppi) @ ccdiv))) @ cco1)).
thf(ccres_tp,type,(ccres : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(arlimres2_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XA2 @ XB2))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwbr @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (XD @ Xx3) @ ccrli))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwbr @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (XD @ Xx3) @ ccrli))))))))))).
...
thf(ao1rlimmul_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ cco1) & (cwbr @ XG @ ccc0 @ ccrli)) => (cwbr @ (cco @ XF @ XG @ (ccof @ ccmul)) @ ccc0 @ ccrli))))).
...
thf(achtppilimlem1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwbr @ XA2 @ cc1 @ cclt)) => ((Xph => (cwcel @ XN @ (cco @ cc2 @ ccpnf @ ccico))) => ((Xph => (cwbr @ (cco @ (cco @ XN @ XA2 @ cccxp) @ (ccfv @ XN @ ccppi) @ ccdiv) @ (cco @ cc1 @ XA2 @ ccmin) @ cclt)) => (Xph => (cwbr @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ (ccfv @ XN @ ccppi) @ (ccfv @ XN @ cclog) @ ccmul) @ ccmul) @ (ccfv @ XN @ cccht) @ cclt)))))))))).
thf(asimprl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & (Xps & Xch)) => Xps))))).
thf(asimprr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & (Xps & Xch)) => Xch))))).
thf(cchtppilimlem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwbr @ XA2 @ cc1 @ cclt)) => (Xph => (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xz) @ (ccv @ Xx3) @ ccle) => (cwbr @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ (ccfv @ (ccv @ Xx3) @ ccppi) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ ccmul) @ (ccfv @ (ccv @ Xx3) @ cccht) @ cclt))) @ (^ [Xx3:$i] : (cco @ cc2 @ ccpnf @ ccico)))) @ (^ [Xz:$i] : ccr)))))))).
