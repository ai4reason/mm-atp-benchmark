...
thf(awwlknbp2OLD_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) => ((cwcel @ XW @ (ccword @ (ccfv @ XG @ ccvtx))) & ((ccfv @ XW @ cchash) = (cco @ XN @ cc1 @ ccaddc)))))))).
...
thf(awwlknonOLD_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) => ((cwcel @ XW @ (cco @ XA2 @ XB2 @ (cco @ XN @ XG @ ccwwlksnon))) <=> (cw3a @ (cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) @ ((ccfv @ ccc0 @ XW) = XA2) @ ((ccfv @ XN @ XW) = XB2)))))))))))).
thf(cwwlksnwwlksnonOLD_conj,conjecture,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XN @ ccn0) & (cwcel @ XG @ XU)) => ((cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) <=> (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwcel @ XW @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (cco @ XN @ XG @ ccwwlksnon)))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))))))).
