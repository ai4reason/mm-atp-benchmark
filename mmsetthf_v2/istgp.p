...
thf(adf_tgp_ax,axiom,(cctgp = (ccrab @ (^ [Xf1:$i] : (cwsbc @ (^ [Xj:$i] : (cwcel @ (ccfv @ (ccv @ Xf1) @ ccminusg) @ (cco @ (ccv @ Xj) @ (ccv @ Xj) @ cccn))) @ (ccfv @ (ccv @ Xf1) @ cctopn))) @ (^ [Xf1:$i] : (ccin @ ccgrp @ cctmd))))).
thf(adf_3an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) <=> ((Xph & Xps) & Xch)))))).
thf(cistgp_conj,conjecture,(! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ XG @ cctopn)) => ((XI = (ccfv @ XG @ ccminusg)) => ((cwcel @ XG @ cctgp) <=> (cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XG @ cctmd) @ (cwcel @ XI @ (cco @ XJ @ XJ @ cccn)))))))))).
