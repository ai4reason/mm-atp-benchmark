...
thf(ahst0h_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XS @ cchst) & (cwcel @ XA2 @ ccch)) => (((ccfv @ (ccfv @ XA2 @ XS) @ ccno) = ccc0) <=> ((ccfv @ XA2 @ XS) = cc0v)))))).
thf(chstoh_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : ((cw3a @ (cwcel @ XS @ cchst) @ (cwcel @ XA2 @ ccch) @ ((cco @ (ccfv @ XA2 @ XS) @ (ccfv @ cchil @ XS) @ ccsp) = ccc0)) => ((ccfv @ XA2 @ XS) = cc0v))))).
