...
thf(azfun_ax,axiom,(! [Xz:$i] : (? [Xx3:$i] : (! [Xy1:$i] : ((? [Xx3:$i] : ((cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)) & (cwcel @ (ccv @ Xx3) @ (ccv @ Xz)))) => (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))).
...
thf(cuniex2_conj,conjecture,(! [Xx3:$i] : (? [Xy1:$i] : ((ccv @ Xy1) = (ccuni @ (ccv @ Xx3)))))).
