...
thf(arecid_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ XA2 @ ccc0)) => ((cco @ XA2 @ (cco @ cc1 @ XA2 @ ccdiv) @ ccmul) = cc1)))).
...
thf(amulcan_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ ((cwcel @ XC @ ccc) & (cwne @ XC @ ccc0))) => (((cco @ XC @ XA2 @ ccmul) = (cco @ XC @ XB2 @ ccmul)) <=> (XA2 = XB2))))))).
thf(asyl5bb_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph <=> Xps) => ((Xch => (Xps <=> Xth)) => (Xch => (Xph <=> Xth))))))))).
thf(aeqcom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 = XB2) <=> (XB2 = XA2))))).
thf(amuleqadd_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => (((cco @ XA2 @ XB2 @ ccmul) = (cco @ XA2 @ XB2 @ ccaddc)) <=> ((cco @ (cco @ XA2 @ cc1 @ ccmin) @ (cco @ XB2 @ cc1 @ ccmin) @ ccmul) = cc1)))))).
thf(cconjmul_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : ((((cwcel @ XP @ ccc) & (cwne @ XP @ ccc0)) & ((cwcel @ XQ @ ccc) & (cwne @ XQ @ ccc0))) => (((cco @ (cco @ cc1 @ XP @ ccdiv) @ (cco @ cc1 @ XQ @ ccdiv) @ ccaddc) = cc1) <=> ((cco @ (cco @ XP @ cc1 @ ccmin) @ (cco @ XQ @ cc1 @ ccmin) @ ccmul) = cc1)))))).
