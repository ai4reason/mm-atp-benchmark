...
thf(afvn0elsupp_ax,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XB2 @ XV) & (cwcel @ XX @ XB2)) & ((cwfn @ XG @ XB2) & (cwne @ (ccfv @ XX @ XG) @ cc0))) => (cwcel @ XX @ (cco @ XG @ cc0 @ ccsupp)))))))).
...
thf(aordunifi_ax,axiom,(! [XA2:($i > $o)] : ((cw3a @ (cwss @ XA2 @ ccon0) @ (cwcel @ XA2 @ ccfn) @ (cwne @ XA2 @ cc0)) => (cwcel @ (ccuni @ XA2) @ XA2)))).
...
thf(assonuni_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwss @ XA2 @ ccon0) => (cwcel @ (ccuni @ XA2) @ ccon0)))))).
