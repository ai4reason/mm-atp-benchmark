...
thf(crestcld_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => ((cwcel @ XA2 @ (ccfv @ (cco @ XJ @ XS @ ccrest) @ cccld)) <=> (cwrex @ (^ [Xx3:$i] : (XA2 = (ccin @ (ccv @ Xx3) @ XS))) @ (^ [Xx3:$i] : (ccfv @ XJ @ cccld))))))))))).
