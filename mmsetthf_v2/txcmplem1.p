...
thf(atxtube_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XR)) => ((XY = (ccuni @ XS)) => ((Xph => (cwcel @ XR @ cccmp)) => ((Xph => (cwcel @ XS @ cctop)) => ((Xph => (cwcel @ XU @ (cco @ XR @ XS @ cctx))) => ((Xph => (cwss @ (ccxp @ XX @ (ccsn @ XA2)) @ XU)) => ((Xph => (cwcel @ XA2 @ XY)) => (Xph => (cwrex @ (^ [Xu:$i] : ((cwcel @ XA2 @ (ccv @ Xu)) & (cwss @ (ccxp @ XX @ (ccv @ Xu)) @ XU))) @ (^ [Xu:$i] : XS)))))))))))))))))).
...
thf(ctxcmplem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xv:$i] : (XX = (ccuni @ (XR @ Xv)))) => ((XY = (ccuni @ XS)) => ((! [Xv:$i] : ((Xph @ Xv) => (cwcel @ (XR @ Xv) @ cccmp))) => ((! [Xv:$i] : ((Xph @ Xv) => (cwcel @ XS @ cccmp))) => ((! [Xv:$i] : ((Xph @ Xv) => (cwss @ XW @ (cco @ (XR @ Xv) @ XS @ cctx)))) => ((! [Xv:$i] : ((Xph @ Xv) => ((ccxp @ XX @ XY) = (ccuni @ XW)))) => ((! [Xv:$i] : ((Xph @ Xv) => (cwcel @ (XA2 @ Xv) @ XY))) => (! [Xv:$i] : ((Xph @ Xv) => (cwrex @ (^ [Xu:$i] : ((cwcel @ (XA2 @ Xv) @ (ccv @ Xu)) & (cwrex @ (^ [Xv:$i] : (cwss @ (ccxp @ XX @ (ccv @ Xu)) @ (ccuni @ (ccv @ Xv)))) @ (^ [Xv:$i] : (ccin @ (ccpw @ XW) @ ccfn))))) @ (^ [Xu:$i] : XS))))))))))))))))))).
