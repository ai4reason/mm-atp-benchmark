...
thf(afunray_ax,axiom,(cwfun @ ccray)).
thf(cweu_tp,type,(cweu : (($i > $o) > $o))).
thf(cwrel_tp,type,(cwrel : (($i > $o) > $o))).
thf(afunbrfv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwfun @ XF) => ((cwbr @ XA2 @ XB2 @ XF) => ((ccfv @ XA2 @ XF) = XB2))))))).
thf(cfvray_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cw3a @ (cwcel @ XP @ (ccfv @ XN @ ccee)) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwne @ XP @ XA2))) => ((cco @ XP @ XA2 @ ccray) = (ccrab @ (^ [Xx3:$i] : (cwbr @ XP @ (ccop @ XA2 @ (ccv @ Xx3)) @ ccoutsideof)) @ (^ [Xx3:$i] : (ccfv @ XN @ ccee))))))))).
