...
thf(aipz_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XZ = (ccfv @ XU @ ccn0v)) => ((XP = (ccfv @ XU @ ccdip)) => (((cwcel @ XU @ ccnv) & (cwcel @ XA2 @ XX)) => (((cco @ XA2 @ XA2 @ XP) = ccc0) <=> (XA2 = XZ)))))))))))).
