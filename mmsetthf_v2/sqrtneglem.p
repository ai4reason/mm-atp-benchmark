...
thf(csqrtneglem_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle)) => (cw3a @ ((cco @ (cco @ cci @ (ccfv @ XA2 @ ccsqrt) @ ccmul) @ cc2 @ ccexp) = (ccneg @ XA2)) @ (cwbr @ ccc0 @ (ccfv @ (cco @ cci @ (ccfv @ XA2 @ ccsqrt) @ ccmul) @ ccre) @ ccle) @ (cwnel @ (cco @ cci @ (cco @ cci @ (ccfv @ XA2 @ ccsqrt) @ ccmul) @ ccmul) @ ccrp))))).
