...
thf(cchrcong_conj,conjecture,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XC = (ccfv @ XR @ ccchr)) => ((XL = (ccfv @ XR @ cczrh)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) => ((cwbr @ XC @ (cco @ XM @ XN @ ccmin) @ ccdvds) <=> ((ccfv @ XM @ XL) = (ccfv @ XN @ XL)))))))))))))).
