...
thf(aiirevcn_ax,axiom,(cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (cco @ cc1 @ (ccv @ Xx3) @ ccmin))) @ (cco @ ccii @ ccii @ cccn))).
thf(aoveq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))).
thf(aoveq2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))).
thf(adfii3_ax,axiom,(! [XJ:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => (ccii = (cco @ XJ @ (cco @ ccc0 @ cc1 @ ccicc) @ ccrest))))).
...
thf(aicccvx_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cw3a @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc)) @ (cwcel @ XD @ (cco @ XA2 @ XB2 @ ccicc)) @ (cwcel @ XT @ (cco @ ccc0 @ cc1 @ ccicc))) => (cwcel @ (cco @ (cco @ (cco @ cc1 @ XT @ ccmin) @ XC @ ccmul) @ (cco @ XT @ XD @ ccmul) @ ccaddc) @ (cco @ XA2 @ XB2 @ ccicc)))))))))).
...
thf(creparphti_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ ccii @ ccii @ cccn))) => ((Xph => ((ccfv @ ccc0 @ XG) = ccc0)) => ((Xph => ((ccfv @ cc1 @ XG) = cc1)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XH @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ ccc0 @ cc1 @ ccicc))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ ccc0 @ cc1 @ ccicc))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (cco @ (cco @ (cco @ cc1 @ (ccv @ Xy1) @ ccmin) @ (ccfv @ (ccv @ Xx3) @ XG) @ ccmul) @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccmul) @ ccaddc) @ XF))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XH @ Xx3 @ Xy1) @ (cco @ (cccom @ XF @ XG) @ XF @ (ccfv @ XJ @ ccphtpy))))))))))))))))).
