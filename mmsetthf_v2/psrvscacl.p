...
thf(cpsrvscacl_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((Xc_x = (ccfv @ XS @ ccvsca)) => ((XK = (ccfv @ XR @ ccbs)) => ((XB2 = (ccfv @ XS @ ccbs)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XX @ XK)) => ((Xph => (cwcel @ XF @ XB2)) => (Xph => (cwcel @ (cco @ XX @ XF @ Xc_x) @ XB2))))))))))))))))))).
