...
thf(aforesf1o_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XA2 @ (XV @ Xx3)) & (cwfo @ XA2 @ XB2 @ XF)) => (cwrex @ (^ [Xx3:$i] : (cwf1o @ (ccv @ Xx3) @ XB2 @ (ccres @ XF @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccpw @ XA2)))))))))).
thf(crabfodom_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2) @ ((ccv @ Xy1) = (ccfv @ (ccv @ Xx3) @ XF))) => ((Xch @ Xy1) <=> (Xps @ Xx3))))) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwfo @ XA2 @ XB2 @ XF)) => (Xph => (cwbr @ (ccrab @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : XB2)) @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ ccdom))))))))))))).
