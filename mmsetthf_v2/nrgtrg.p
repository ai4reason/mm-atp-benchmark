...
thf(anrgtgp_ax,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccnrg) => (cwcel @ XR @ cctgp)))).
...
thf(arlmnlm_ax,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccnrg) => (cwcel @ (ccfv @ XR @ ccrglmod) @ ccnlm)))).
...
thf(arlmscaf_ax,axiom,(! [XR:($i > $o)] : ((ccfv @ (ccfv @ XR @ ccmgp) @ ccplusf) = (ccfv @ (ccfv @ XR @ ccrglmod) @ ccscaf)))).
thf(arlmtopn_ax,axiom,(! [XR:($i > $o)] : ((ccfv @ XR @ cctopn) = (ccfv @ (ccfv @ XR @ ccrglmod) @ cctopn)))).
...
thf(cnrgtrg_conj,conjecture,(! [XR:($i > $o)] : ((cwcel @ XR @ ccnrg) => (cwcel @ XR @ cctrg)))).
