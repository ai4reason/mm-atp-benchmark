...
thf(ct1sep2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwcel @ XJ @ cct1) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) => ((cwral @ (^ [Xo:$i] : ((cwcel @ XA2 @ (ccv @ Xo)) => (cwcel @ XB2 @ (ccv @ Xo)))) @ (^ [Xo:$i] : XJ)) => (XA2 = XB2))))))))).
