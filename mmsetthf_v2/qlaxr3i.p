...
thf(afh1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwbr @ XA2 @ XB2 @ cccm) => ((cwbr @ XA2 @ XC @ cccm) => ((ccin @ XA2 @ (cco @ XB2 @ XC @ cchj)) = (cco @ (ccin @ XA2 @ XB2) @ (ccin @ XA2 @ XC) @ cchj))))))))))).
...
thf(acmcmii_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwbr @ XA2 @ XB2 @ cccm) => (cwbr @ XB2 @ XA2 @ cccm))))))).
thf(acmj1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ cchj) @ cccm)))))).
thf(acmj2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (cwbr @ XB2 @ (cco @ XA2 @ XB2 @ cchj) @ cccm)))))).
thf(a_3eqtr4i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((XA2 = XB2) => ((XC = XA2) => ((XD = XB2) => (XC = XD))))))))).
thf(achjoi_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cco @ XA2 @ (ccfv @ XA2 @ ccort) @ cchj) = cchil)))).
...
thf(achj00i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (((XA2 = cc0h) & (XB2 = cc0h)) <=> ((cco @ XA2 @ XB2 @ cchj) = cc0h))))))).
...
thf(cqlaxr3i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => (((cco @ XC @ (ccfv @ XC @ ccort) @ cchj) = (cco @ (ccfv @ (cco @ (ccfv @ XA2 @ ccort) @ (ccfv @ XB2 @ ccort) @ cchj) @ ccort) @ (ccfv @ (cco @ XA2 @ XB2 @ cchj) @ ccort) @ cchj)) => (XA2 = XB2))))))))).
