...
thf(aply1nz_ax,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((cwcel @ XR @ ccnzr) => (cwcel @ XP @ ccnzr)))))).
...
thf(cply1nzb_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((cwcel @ XR @ ccrg) => ((cwcel @ XR @ ccnzr) <=> (cwcel @ XP @ ccnzr))))))).
