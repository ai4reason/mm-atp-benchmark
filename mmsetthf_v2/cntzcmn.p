...
thf(acntzel_ax,axiom,(! [XB2:($i > ($i > $o))] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccfv @ XM @ ccbs))) => ((Xc_pl = (ccfv @ XM @ ccplusg)) => ((! [Xy1:$i] : ((XZ @ Xy1) = (ccfv @ XM @ cccntz))) => (! [Xy1:$i] : (((cwss @ XS @ (XB2 @ Xy1)) & (cwcel @ XX @ (XB2 @ Xy1))) => ((cwcel @ XX @ (ccfv @ XS @ (XZ @ Xy1))) <=> (cwral @ (^ [Xy1:$i] : ((cco @ XX @ (ccv @ Xy1) @ Xc_pl) = (cco @ (ccv @ Xy1) @ XX @ Xc_pl))) @ (^ [Xy1:$i] : XS))))))))))))))).
thf(ccntzcmn_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XZ = (ccfv @ XG @ cccntz)) => (((cwcel @ XG @ cccmn) & (cwss @ XS @ XB2)) => ((ccfv @ XS @ XZ) = XB2))))))))).
