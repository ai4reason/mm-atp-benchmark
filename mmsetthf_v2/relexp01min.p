...
thf(crelexp01min_conj,conjecture,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XR @ XV) & (XI = (ccif @ (cwbr @ XJ @ XK @ cclt) @ XJ @ XK))) & ((cwcel @ XJ @ (ccpr @ ccc0 @ cc1)) & (cwcel @ XK @ (ccpr @ ccc0 @ cc1)))) => ((cco @ (cco @ XR @ XJ @ ccrelexp) @ XK @ ccrelexp) = (cco @ XR @ XI @ ccrelexp))))))))).
