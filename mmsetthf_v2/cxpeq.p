...
thf(aexplog_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwcel @ XN @ ccz)) => ((cco @ XA2 @ XN @ ccexp) = (ccfv @ (cco @ XN @ (ccfv @ XA2 @ cclog) @ ccmul) @ cce)))))).
...
thf(aeflogeq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwne @ XB2 @ ccc0)) => (((ccfv @ XA2 @ cce) = XB2) <=> (cwrex @ (^ [Xn:$i] : (XA2 = (cco @ (ccfv @ XB2 @ cclog) @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (ccv @ Xn) @ ccmul) @ ccaddc))) @ (^ [Xn:$i] : ccz))))))).
...
thf(acxpmul2zd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwne @ XA2 @ ccc0)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccz)) => (Xph => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ cccxp) = (cco @ (cco @ XA2 @ XB2 @ cccxp) @ XC @ ccexp)))))))))))).
...
thf(adiveq1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwne @ XB2 @ ccc0)) => ((Xph => ((cco @ XA2 @ XB2 @ ccdiv) = cc1)) => (Xph => (XA2 = XB2)))))))))).
...
thf(aroot1id_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cco @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ XN @ ccdiv) @ cccxp) @ XN @ ccexp) = cc1)))).
...
thf(ccxpeq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn) @ (cwcel @ XB2 @ ccc)) => (((cco @ XA2 @ XN @ ccexp) = XB2) <=> (cwrex @ (^ [Xn:$i] : (XA2 = (cco @ (cco @ XB2 @ (cco @ cc1 @ XN @ ccdiv) @ cccxp) @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ XN @ ccdiv) @ cccxp) @ (ccv @ Xn) @ ccexp) @ ccmul))) @ (^ [Xn:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))))))))).
