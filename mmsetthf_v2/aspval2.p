...
thf(aissubassa2_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XW @ ccascl)) => ((XL = (ccfv @ XW @ cclss)) => (((cwcel @ XW @ ccasa) & (cwcel @ XS @ (ccfv @ XW @ ccsubrg))) => ((cwcel @ XS @ XL) <=> (cwss @ (ccrn @ XA2) @ XS)))))))))).
...
thf(asubrgmre_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((cwcel @ XR @ ccrg) => (cwcel @ (ccfv @ XR @ ccsubrg) @ (ccfv @ XB2 @ ccmre))))))).
...
thf(caspval2_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XW @ ccasp)) => ((XC = (ccfv @ XW @ ccascl)) => ((XR = (ccfv @ (ccfv @ XW @ ccsubrg) @ ccmrc)) => ((XV = (ccfv @ XW @ ccbs)) => (((cwcel @ XW @ ccasa) & (cwss @ XS @ XV)) => ((ccfv @ XS @ XA2) = (ccfv @ (ccun @ (ccrn @ XC) @ XS) @ XR)))))))))))))).
