...
thf(adiagcl_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > $o)] : (! [XL:($i > $o)] : ((XL = (cco @ XC @ XD @ ccdiag)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XD @ cccat)) => ((XQ = (cco @ XD @ XC @ ccfuc)) => (Xph => (cwcel @ XL @ (cco @ XC @ XQ @ ccfunc))))))))))))).
thf(a_1st2ndbr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwrel @ XB2) & (cwcel @ XA2 @ XB2)) => (cwbr @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XA2 @ cc2nd) @ XB2))))).
thf(cdiag2cl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XL = (cco @ XC @ XD @ ccdiag)) => ((XA2 = (ccfv @ XC @ ccbs)) => ((XB2 = (ccfv @ XD @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XD @ cccat)) => ((Xph => (cwcel @ XX @ XA2)) => ((Xph => (cwcel @ XY @ XA2)) => ((Xph => (cwcel @ XF @ (cco @ XX @ XY @ XH))) => ((XN = (cco @ XD @ XC @ ccnat)) => (Xph => (cwcel @ (ccxp @ XB2 @ (ccsn @ XF)) @ (cco @ (ccfv @ XX @ (ccfv @ XL @ cc1st)) @ (ccfv @ XY @ (ccfv @ XL @ cc1st)) @ XN))))))))))))))))))))))))).
