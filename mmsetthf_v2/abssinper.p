...
thf(cabssinper_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XK @ ccz)) => ((ccfv @ (ccfv @ (cco @ XA2 @ (cco @ XK @ ccpi @ ccmul) @ ccaddc) @ ccsin) @ ccabs) = (ccfv @ (ccfv @ XA2 @ ccsin) @ ccabs)))))).
