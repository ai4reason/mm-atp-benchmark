...
thf(aresmhm_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XS @ XX @ ccress)) => (((cwcel @ XF @ (cco @ XS @ XT @ ccmhm)) & (cwcel @ XX @ (ccfv @ XS @ ccsubmnd))) => (cwcel @ (ccres @ XF @ XX) @ (cco @ XU @ XT @ ccmhm)))))))))).
...
thf(aresmhm2b_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XT @ XX @ ccress)) => (((cwcel @ XX @ (ccfv @ XT @ ccsubmnd)) & (cwss @ (ccrn @ XF) @ XX)) => ((cwcel @ XF @ (cco @ XS @ XT @ ccmhm)) <=> (cwcel @ XF @ (cco @ XS @ XU @ ccmhm))))))))))).
...
thf(acnmgpabl_ax,axiom,(! [XM:($i > $o)] : ((XM = (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccdif @ ccc @ (ccsn @ ccc0)) @ ccress)) => (cwcel @ XM @ ccabl)))).
...
thf(cdchrghm_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XZ = (ccfv @ XN @ cczn)) => ((XD = (ccfv @ XG @ ccbs)) => ((XU = (ccfv @ XZ @ ccui)) => ((XH = (cco @ (ccfv @ XZ @ ccmgp) @ XU @ ccress)) => ((XM = (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccdif @ ccc @ (ccsn @ ccc0)) @ ccress)) => ((Xph => (cwcel @ XX @ XD)) => (Xph => (cwcel @ (ccres @ XX @ XU) @ (cco @ XH @ XM @ ccghm)))))))))))))))))))).
