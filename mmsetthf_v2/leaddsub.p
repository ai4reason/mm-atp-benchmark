...
thf(cleaddsub_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) => ((cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ ccle) <=> (cwbr @ XA2 @ (cco @ XC @ XB2 @ ccmin) @ ccle))))))).
