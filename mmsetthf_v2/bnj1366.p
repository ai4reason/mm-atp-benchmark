...
thf(cbnj1366_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xps @ Xx3 @ Xy1) <=> (cw3a @ (cwcel @ XA2 @ ccvv) @ (cwral @ (^ [Xx3:$i] : (cweu @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : XA2)) @ ((XB2 @ Xx3 @ Xy1) = (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : XA2))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xps @ Xx3 @ Xy1) => (cwcel @ (XB2 @ Xx3 @ Xy1) @ ccvv)))))))))).
