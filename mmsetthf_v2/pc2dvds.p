...
thf(apcdvdstr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwbr @ XA2 @ XB2 @ ccdvds))) => (cwbr @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc) @ ccle)))))).
...
thf(apcabs_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccq)) => ((cco @ XP @ (ccfv @ XA2 @ ccabs) @ ccpc) = (cco @ XP @ XA2 @ ccpc)))))).
...
thf(apcgcd_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) => ((cco @ XP @ (cco @ XA2 @ XB2 @ ccgcd) @ ccpc) = (ccif @ (cwbr @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc) @ ccle) @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc)))))))).
...
thf(cpc2dvds_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => ((cwbr @ XA2 @ XB2 @ ccdvds) <=> (cwral @ (^ [Xp:$i] : (cwbr @ (cco @ (ccv @ Xp) @ XA2 @ ccpc) @ (cco @ (ccv @ Xp) @ XB2 @ ccpc) @ ccle)) @ (^ [Xp:$i] : ccprime))))))).
