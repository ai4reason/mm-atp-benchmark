...
thf(aoddprmdvds_ax,axiom,(! [XK:($i > $o)] : (((cwcel @ XK @ ccn) & (~ (cwrex @ (^ [Xn:$i] : (XK = (cco @ cc2 @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn0)))) => (cwrex @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XK @ ccdvds)) @ (^ [Xp:$i] : (ccdif @ ccprime @ (ccsn @ cc2))))))).
...
thf(anndivides_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn) & (cwcel @ XN @ ccn)) => ((cwbr @ XM @ XN @ ccdvds) <=> (cwrex @ (^ [Xn:$i] : ((cco @ (ccv @ Xn) @ XM @ ccmul) = XN)) @ (^ [Xn:$i] : ccn))))))).
...
thf(advdsnprmd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwbr @ cc1 @ XA2 @ cclt)) => ((Xph => (cwbr @ XA2 @ XN @ cclt)) => ((Xph => (cwbr @ XA2 @ XN @ ccdvds)) => (Xph => (~ (cwcel @ XN @ ccprime)))))))))).
...
thf(c_2pwp1prm_conj,conjecture,(! [XK:($i > $o)] : (((cwcel @ XK @ ccn) & (cwcel @ (cco @ (cco @ cc2 @ XK @ ccexp) @ cc1 @ ccaddc) @ ccprime)) => (cwrex @ (^ [Xn:$i] : (XK = (cco @ cc2 @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn0))))).
