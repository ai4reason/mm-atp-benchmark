...
thf(adisjord_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : (((ccv @ Xa) = (ccv @ Xb)) => ((XA2 @ Xa) = (XB2 @ Xb))))) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ (XA2 @ Xa)) @ (cwcel @ (ccv @ Xx3) @ (XB2 @ Xb))) => ((ccv @ Xa) = (ccv @ Xb)))))) => (Xph => (cwdisj @ (^ [Xa:$i] : XV) @ (^ [Xa:$i] : (XA2 @ Xa))))))))))).
