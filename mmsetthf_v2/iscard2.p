...
thf(acardonle_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (cwss @ (ccfv @ XA2 @ cccrd) @ XA2)))).
...
thf(aoncardval_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((ccfv @ XA2 @ cccrd) = (ccint @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ ccen)) @ (^ [Xx3:$i] : ccon0))))))).
...
thf(ciscard2_conj,conjecture,(! [XA2:($i > $o)] : (((ccfv @ XA2 @ cccrd) = XA2) <=> ((cwcel @ XA2 @ ccon0) & (cwral @ (^ [Xx3:$i] : ((cwbr @ XA2 @ (ccv @ Xx3) @ ccen) => (cwss @ XA2 @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0)))))).
