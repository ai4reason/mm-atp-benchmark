...
thf(a_2pthnloop_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => (((cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) & (cwbr @ cc1 @ (ccfv @ XF @ cchash) @ cclt)) => (cwral @ (^ [Xi:$i] : (cwbr @ cc2 @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xi) @ XF) @ XI) @ cchash) @ ccle)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)))))))))).
...
thf(a_3imp3i2an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (((cw3a @ Xph @ Xps @ Xch) => Xth) => (((Xph & Xch) => Xta) => (((Xth & Xta) => Xet) => ((cw3a @ Xph @ Xps @ Xch) => Xet))))))))))).
...
thf(aupgrle2_ax,axiom,(! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => (((cwcel @ XG @ ccupgr) & (cwcel @ XX @ (ccdm @ XI))) => (cwbr @ (ccfv @ (ccfv @ XX @ XI) @ cchash) @ cc2 @ ccle))))))).
...
thf(cupgr2pthnlp_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => ((cw3a @ (cwcel @ XG @ ccupgr) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) @ (cwbr @ cc1 @ (ccfv @ XF @ cchash) @ cclt)) => (cwral @ (^ [Xi:$i] : ((ccfv @ (ccfv @ (ccfv @ (ccv @ Xi) @ XF) @ XI) @ cchash) = cc2)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)))))))))).
