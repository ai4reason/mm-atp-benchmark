...
thf(adf_ofc_ax,axiom,(! [XR:($i > $o)] : ((ccofc @ XR) = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xc:$i] : ccvv)) @ (^ [Xf1:$i] : (^ [Xc:$i] : ccvv)) @ (^ [Xf1:$i] : (^ [Xc:$i] : (ccmpt @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xf1))) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccv @ Xc) @ XR))))))))).
...
thf(cofcfval_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwfn @ XF @ (XA2 @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XA2 @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XC @ (XW @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => ((ccfv @ (ccv @ Xx3) @ XF) = (XB2 @ Xx3)))) => (Xph => ((cco @ XF @ XC @ (ccofc @ XR)) = (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xx3) @ XC @ XR)))))))))))))))))).
