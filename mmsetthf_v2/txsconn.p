...
thf(atxpconn_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XR @ ccpconn) & (cwcel @ XS @ ccpconn)) => (cwcel @ (cco @ XR @ XS @ cctx) @ ccpconn))))).
...
thf(ctxsconn_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XR @ ccsconn) & (cwcel @ XS @ ccsconn)) => (cwcel @ (cco @ XR @ XS @ cctx) @ ccsconn))))).
