...
thf(cfvmptrabfv_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xx3) @ XG)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XX) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((ccfv @ XX @ (XF @ Xx3 @ Xy1)) = (ccrab @ (^ [Xy1:$i] : (Xps @ Xy1)) @ (^ [Xy1:$i] : (ccfv @ XX @ XG)))))))))))))).
