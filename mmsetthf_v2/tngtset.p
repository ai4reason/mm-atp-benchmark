...
thf(atngval_ax,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XT = (cco @ XG @ XN @ cctng)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((XD = (cccom @ XN @ Xc_mi)) => ((XJ = (ccfv @ XD @ ccmopn)) => (((cwcel @ XG @ XV) & (cwcel @ XN @ XW)) => (XT = (cco @ (cco @ XG @ (ccop @ (ccfv @ ccnx @ ccds) @ XD) @ ccsts) @ (ccop @ (ccfv @ ccnx @ ccts) @ XJ) @ ccsts)))))))))))))))).
