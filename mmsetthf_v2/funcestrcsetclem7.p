...
thf(aestrcbasbas_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : ((XC = (ccfv @ XU @ ccestrc)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XU @ ccwun)) => ((Xph & (cwcel @ XE @ XB2)) => (cwcel @ (ccfv @ XE @ ccbs) @ XU))))))))))).
