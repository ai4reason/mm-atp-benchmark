...
thf(axkoco2cn_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XR @ cctop)) => ((Xph => (cwcel @ XF @ (cco @ XS @ XT @ cccn))) => (Xph => (cwcel @ (ccmpt @ (^ [Xg1:$i] : (cco @ XR @ XS @ cccn)) @ (^ [Xg1:$i] : (cccom @ XF @ (ccv @ Xg1)))) @ (cco @ (cco @ XS @ XR @ ccxko) @ (cco @ XT @ XR @ ccxko) @ cccn))))))))))).
