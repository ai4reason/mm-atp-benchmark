...
thf(atrclfvdecoml_ax,axiom,(! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XR @ XV) => ((ccfv @ XR @ cctcl) = (ccun @ XR @ (cccom @ XR @ (ccfv @ XR @ cctcl)))))))).
...
thf(crntrclfv_conj,conjecture,(! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XR @ XV) => ((ccrn @ (ccfv @ XR @ cctcl)) = (ccrn @ XR)))))).
