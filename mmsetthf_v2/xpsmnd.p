...
thf(aprdsmndd_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwf @ XI @ ccmnd @ XR)) => (Xph => (cwcel @ XY @ ccmnd)))))))))))))).
...
thf(aimasmndf1_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((XU = (cco @ XF @ XR @ ccimas)) => ((XV = (ccfv @ XR @ ccbs)) => (((cwf1 @ XV @ XB2 @ XF) & (cwcel @ XR @ ccmnd)) => (cwcel @ XU @ ccmnd)))))))))).
thf(cxpsmnd_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((XT = (cco @ XR @ XS @ ccxps)) => (((cwcel @ XR @ ccmnd) & (cwcel @ XS @ ccmnd)) => (cwcel @ XT @ ccmnd))))))).
