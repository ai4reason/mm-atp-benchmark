...
thf(almodfopnelem2_ax,axiom,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_x = (ccfv @ XW @ ccscaf)) => ((Xc_pl = (ccfv @ XW @ ccplusf)) => ((XV = (ccfv @ XW @ ccbs)) => ((XS = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XS @ ccbs)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => ((Xc_1 = (ccfv @ XS @ ccur)) => (((cwcel @ XW @ cclmod) & (Xc_pl = Xc_x)) => ((cwcel @ Xc_0 @ XV) & (cwcel @ Xc_1 @ XV))))))))))))))))))).
...
thf(clmodfopne_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_x = (ccfv @ XW @ ccscaf)) => ((Xc_pl = (ccfv @ XW @ ccplusf)) => ((XV = (ccfv @ XW @ ccbs)) => ((XS = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XS @ ccbs)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => ((Xc_1 = (ccfv @ XS @ ccur)) => (((cwcel @ XW @ cclmod) & (cwne @ Xc_1 @ Xc_0)) => (cwne @ Xc_pl @ Xc_x)))))))))))))))))).
