...
thf(cwwlksnextproplem1_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ (cco @ XN @ cc1 @ ccaddc) @ XG @ ccwwlksn)) => (((cwcel @ XW @ XX) & (cwcel @ XN @ ccn0)) => ((ccfv @ ccc0 @ (cco @ XW @ (ccop @ ccc0 @ (cco @ XN @ cc1 @ ccaddc)) @ ccsubstr)) = (ccfv @ ccc0 @ XW))))))))).
