...
thf(arbropap_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xch:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xp:$i] : ((Xph @ Xf1 @ Xp) => ((XM @ Xf1 @ Xp) = (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : ((cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ XW) & (Xps @ Xf1 @ Xp))))))))) => ((! [Xf1:$i] : (! [Xp:$i] : ((((ccv @ Xf1) = XF) & ((ccv @ Xp) = XP)) => ((Xps @ Xf1 @ Xp) <=> Xch)))) => (! [Xf1:$i] : (! [Xp:$i] : ((cw3a @ (Xph @ Xf1 @ Xp) @ (cwcel @ XF @ (XX @ Xf1 @ Xp)) @ (cwcel @ XP @ (XY @ Xf1 @ Xp))) => ((cwbr @ XF @ XP @ (XM @ Xf1 @ Xp)) <=> ((cwbr @ XF @ XP @ XW) & Xch))))))))))))))))).
thf(aa1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(cbrfvopabrbr_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((ccfv @ XZ @ (XA2 @ Xx3 @ Xy1)) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XZ @ XB2)) & (Xph @ Xx3 @ Xy1)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((((ccv @ Xx3) = XX) & ((ccv @ Xy1) = XY)) => ((Xph @ Xx3 @ Xy1) <=> Xps)))) => ((cwrel @ (ccfv @ XZ @ XB2)) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwbr @ XX @ XY @ (ccfv @ XZ @ (XA2 @ Xx3 @ Xy1))) <=> ((cwbr @ XX @ XY @ (ccfv @ XZ @ XB2)) & Xps))))))))))))))).
