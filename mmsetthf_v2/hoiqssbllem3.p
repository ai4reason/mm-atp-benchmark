...
thf(aqinioo_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => (Xph => (((ccin @ ccq @ (cco @ XA2 @ XB2 @ ccioo)) = cc0) <=> (cwbr @ XB2 @ XA2 @ ccle))))))))).
...
thf(ahoiqssbllem1_ax,axiom,(! [Xph:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwnf @ (^ [Xi:$i] : (Xph @ Xi))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwcel @ XX @ ccfn))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwne @ XX @ cc0))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwcel @ XY @ (cco @ ccr @ XX @ ccmap)))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwf @ XX @ ccr @ (XC @ Xi)))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwf @ XX @ ccr @ (XD @ Xi)))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwcel @ (XE @ Xi) @ ccrp))) => ((! [Xi:$i] : (((Xph @ Xi) & (cwcel @ (ccv @ Xi) @ XX)) => (cwcel @ (ccfv @ (ccv @ Xi) @ (XC @ Xi)) @ (cco @ (cco @ (ccfv @ (ccv @ Xi) @ XY) @ (cco @ (XE @ Xi) @ (cco @ cc2 @ (ccfv @ (ccfv @ XX @ cchash) @ ccsqrt) @ ccmul) @ ccdiv) @ ccmin) @ (ccfv @ (ccv @ Xi) @ XY) @ ccioo)))) => ((! [Xi:$i] : (((Xph @ Xi) & (cwcel @ (ccv @ Xi) @ XX)) => (cwcel @ (ccfv @ (ccv @ Xi) @ (XD @ Xi)) @ (cco @ (ccfv @ (ccv @ Xi) @ XY) @ (cco @ (ccfv @ (ccv @ Xi) @ XY) @ (cco @ (XE @ Xi) @ (cco @ cc2 @ (ccfv @ (ccfv @ XX @ cchash) @ ccsqrt) @ ccmul) @ ccdiv) @ ccaddc) @ ccioo)))) => (! [Xi:$i] : ((Xph @ Xi) => (cwcel @ XY @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (XC @ Xi)) @ (ccfv @ (ccv @ Xi) @ (XD @ Xi)) @ ccico)))))))))))))))))))))).
...
thf(ahoiqssbllem2_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwnf @ (^ [Xi:$i] : Xph)) => ((Xph => (cwcel @ XX @ ccfn)) => ((Xph => (cwne @ XX @ cc0)) => ((Xph => (cwcel @ XY @ (cco @ ccr @ XX @ ccmap))) => ((Xph => (cwf @ XX @ ccr @ XC)) => ((Xph => (cwf @ XX @ ccr @ XD)) => ((Xph => (cwcel @ XE @ ccrp)) => ((! [Xi:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ XX)) => (cwcel @ (ccfv @ (ccv @ Xi) @ XC) @ (cco @ (cco @ (ccfv @ (ccv @ Xi) @ XY) @ (cco @ XE @ (cco @ cc2 @ (ccfv @ (ccfv @ XX @ cchash) @ ccsqrt) @ ccmul) @ ccdiv) @ ccmin) @ (ccfv @ (ccv @ Xi) @ XY) @ ccioo)))) => ((! [Xi:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ XX)) => (cwcel @ (ccfv @ (ccv @ Xi) @ XD) @ (cco @ (ccfv @ (ccv @ Xi) @ XY) @ (cco @ (ccfv @ (ccv @ Xi) @ XY) @ (cco @ XE @ (cco @ cc2 @ (ccfv @ (ccfv @ XX @ cchash) @ ccsqrt) @ ccmul) @ ccdiv) @ ccaddc) @ ccioo)))) => (Xph => (cwss @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XC) @ (ccfv @ (ccv @ Xi) @ XD) @ ccico))) @ (cco @ XY @ XE @ (ccfv @ (ccfv @ (ccfv @ XX @ ccrrx) @ ccds) @ ccbl)))))))))))))))))))).
thf(asylanbr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xps <=> Xph) => (((Xps & Xch) => Xth) => ((Xph & Xch) => Xth)))))))).
thf(choiqssbllem3_conj,conjecture,(! [Xph:$o] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((Xph => (cwne @ XX @ cc0)) => ((Xph => (cwcel @ XY @ (cco @ ccr @ XX @ ccmap))) => ((Xph => (cwcel @ XE @ ccrp)) => (Xph => (cwrex @ (^ [Xc:$i] : (cwrex @ (^ [Xd:$i] : ((cwcel @ XY @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ ccico)))) & (cwss @ (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ ccico))) @ (cco @ XY @ XE @ (ccfv @ (ccfv @ (ccfv @ XX @ ccrrx) @ ccds) @ ccbl))))) @ (^ [Xd:$i] : (cco @ ccq @ XX @ ccmap)))) @ (^ [Xc:$i] : (cco @ ccq @ XX @ ccmap))))))))))))).
