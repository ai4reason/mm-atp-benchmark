...
thf(abnj1219_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : ((Xch <=> (cw3a @ Xph @ Xps @ Xze)) => ((Xth <=> (cw3a @ Xch @ Xta @ Xet)) => (Xth => Xps))))))))))).
...
thf(cbnj1379_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xth:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xta:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XA2:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xf1) <=> (cwral @ (^ [Xf1:$i] : (cwfun @ (ccv @ Xf1))) @ (^ [Xf1:$i] : XA2))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XD @ Xy1 @ Xz @ Xf1 @ Xg1) = (ccin @ (ccdm @ (ccv @ Xf1)) @ (ccdm @ (ccv @ Xg1)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xps @ Xf1 @ Xg1) <=> ((Xph @ Xx3 @ Xy1 @ Xz @ Xf1) & (cwral @ (^ [Xf1:$i] : (cwral @ (^ [Xg1:$i] : ((ccres @ (ccv @ Xf1) @ (XD @ Xy1 @ Xz @ Xf1 @ Xg1)) = (ccres @ (ccv @ Xg1) @ (XD @ Xy1 @ Xz @ Xf1 @ Xg1)))) @ (^ [Xg1:$i] : XA2))) @ (^ [Xf1:$i] : XA2))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xch @ Xx3 @ Xy1 @ Xz @ Xf1 @ Xg1) <=> (cw3a @ (Xps @ Xf1 @ Xg1) @ (cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccuni @ XA2)) @ (cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xz)) @ (ccuni @ XA2))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xth @ Xx3 @ Xy1 @ Xz @ Xf1 @ Xg1) <=> (cw3a @ (Xch @ Xx3 @ Xy1 @ Xz @ Xf1 @ Xg1) @ (cwcel @ (ccv @ Xf1) @ XA2) @ (cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xf1))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((Xta @ Xx3 @ Xy1 @ Xz @ Xf1 @ Xg1) <=> (cw3a @ (Xth @ Xx3 @ Xy1 @ Xz @ Xf1 @ Xg1) @ (cwcel @ (ccv @ Xg1) @ XA2) @ (cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xz)) @ (ccv @ Xg1))))))))) => (! [Xf1:$i] : (! [Xg1:$i] : ((Xps @ Xf1 @ Xg1) => (cwfun @ (ccuni @ XA2))))))))))))))))))).
