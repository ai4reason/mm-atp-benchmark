...
thf(cdmdbr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((cwbr @ XA2 @ XB2 @ ccdmd) <=> (cwral @ (^ [Xx3:$i] : ((cwss @ XB2 @ (ccv @ Xx3)) => ((cco @ (ccin @ (ccv @ Xx3) @ XA2) @ XB2 @ cchj) = (ccin @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ cchj))))) @ (^ [Xx3:$i] : ccch))))))).
