...
thf(annq_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => (cwcel @ XA2 @ ccq)))).
...
thf(aqabvexp_ax,axiom,(! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XQ = (cco @ cccnfld @ ccq @ ccress)) => ((XA2 = (ccfv @ XQ @ ccabv)) => ((cw3a @ (cwcel @ XF @ XA2) @ (cwcel @ XM @ ccq) @ (cwcel @ XN @ ccn0)) => ((ccfv @ (cco @ XM @ XN @ ccexp) @ XF) = (cco @ (ccfv @ XM @ XF) @ XN @ ccexp))))))))))).
...
thf(aostth2lem2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xq:$i] : ((XQ @ Xq) = (cco @ cccnfld @ ccq @ ccress))) => ((! [Xq:$i] : (XA2 = (ccfv @ (XQ @ Xq) @ ccabv))) => ((! [Xx3:$i] : (! [Xq:$i] : ((XJ @ Xx3 @ Xq) = (ccmpt @ (^ [Xq:$i] : ccprime) @ (^ [Xq:$i] : (ccmpt @ (^ [Xx3:$i] : ccq) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = ccc0) @ ccc0 @ (cco @ (ccv @ Xq) @ (ccneg @ (cco @ (ccv @ Xq) @ (ccv @ Xx3) @ ccpc)) @ ccexp))))))))) => ((! [Xx3:$i] : (! [Xq:$i] : ((XK @ Xx3 @ Xq) = (ccmpt @ (^ [Xx3:$i] : ccq) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = ccc0) @ ccc0 @ cc1)))))) => ((Xph => (cwcel @ XF @ XA2)) => ((! [Xq:$i] : (Xph => (cwcel @ (XN @ Xq) @ (ccfv @ cc2 @ ccuz)))) => ((! [Xq:$i] : (Xph => (cwbr @ cc1 @ (ccfv @ (XN @ Xq) @ XF) @ cclt))) => ((! [Xx3:$i] : (! [Xq:$i] : ((XR @ Xx3) = (cco @ (ccfv @ (ccfv @ (XN @ Xq) @ XF) @ cclog) @ (ccfv @ (XN @ Xq) @ cclog) @ ccdiv)))) => ((! [Xq:$i] : (Xph => (cwcel @ (XM @ Xq) @ (ccfv @ cc2 @ ccuz)))) => ((! [Xx3:$i] : (! [Xq:$i] : ((XS @ Xx3 @ Xq) = (cco @ (ccfv @ (ccfv @ (XM @ Xq) @ XF) @ cclog) @ (ccfv @ (XM @ Xq) @ cclog) @ ccdiv)))) => ((! [Xq:$i] : ((XT @ Xq) = (ccif @ (cwbr @ (ccfv @ (XM @ Xq) @ XF) @ cc1 @ ccle) @ cc1 @ (ccfv @ (XM @ Xq) @ XF)))) => (! [Xx3:$i] : (! [Xq:$i] : ((cw3a @ Xph @ (cwcel @ (XX @ Xq) @ ccn0) @ (cwcel @ (XY @ Xx3 @ Xq) @ (cco @ ccc0 @ (cco @ (cco @ (XM @ Xq) @ (XX @ Xq) @ ccexp) @ cc1 @ ccmin) @ ccfz))) => (cwbr @ (ccfv @ (XY @ Xx3 @ Xq) @ XF) @ (cco @ (cco @ (XM @ Xq) @ (XX @ Xq) @ ccmul) @ (cco @ (XT @ Xq) @ (XX @ Xq) @ ccexp) @ ccmul) @ ccle))))))))))))))))))))))))))))).
...
thf(acxplead_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ cc1 @ XA2 @ ccle)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwbr @ XB2 @ XC @ ccle)) => (Xph => (cwbr @ (cco @ XA2 @ XB2 @ cccxp) @ (cco @ XA2 @ XC @ cccxp) @ ccle)))))))))))).
...
thf(acxpmuld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccc)) => (Xph => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ cccxp) = (cco @ (cco @ XA2 @ XB2 @ cccxp) @ XC @ cccxp))))))))))).
