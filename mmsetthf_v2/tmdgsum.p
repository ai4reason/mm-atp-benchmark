...
thf(atmdmnd_ax,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ cctmd) => (cwcel @ XG @ ccmnd)))).
...
thf(axpssres_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XC @ XA2) => ((ccres @ (ccxp @ XA2 @ XB2) @ XC) = (ccxp @ XC @ XB2))))))).
...
thf(axkopt_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XR @ cctop) & (cwcel @ XA2 @ XV)) => ((cco @ XR @ (ccpw @ XA2) @ ccxko) = (ccfv @ (ccxp @ XA2 @ (ccsn @ XR)) @ ccpt))))))).
thf(ctmdgsum_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ XG @ cctopn)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((cw3a @ (cwcel @ XG @ cccmn) @ (cwcel @ XG @ cctmd) @ (cwcel @ XA2 @ ccfn)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ XB2 @ XA2 @ ccmap)) @ (^ [Xx3:$i] : (cco @ XG @ (ccv @ Xx3) @ ccgsu))) @ (cco @ (cco @ XJ @ (ccpw @ XA2) @ ccxko) @ XJ @ cccn)))))))))).
