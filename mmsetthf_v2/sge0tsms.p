...
thf(agsumge0cl_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XG = (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress)) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((Xph => (cwbr @ XF @ ccc0 @ ccfsupp)) => (Xph => (cwcel @ (cco @ XG @ XF @ ccgsu) @ (cco @ ccc0 @ ccpnf @ ccicc))))))))))))).
...
thf(asupxrpnf_ax,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccxr) & (cwcel @ ccpnf @ XA2)) => ((ccsup @ XA2 @ ccxr @ cclt) = ccpnf)))).
...
thf(asrgacl_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((cw3a @ (cwcel @ XR @ ccsrg) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => (cwcel @ (cco @ XX @ XY @ Xc_pl) @ XB2)))))))))).
...
thf(axrge0tsms_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : ((XG = (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress)) => ((! [Xs1:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xs1)))) => ((Xph => (cwf @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((! [Xs1:$i] : ((XS @ Xs1) = (ccsup @ (ccrn @ (ccmpt @ (^ [Xs1:$i] : (ccin @ (ccpw @ XA2) @ ccfn)) @ (^ [Xs1:$i] : (cco @ XG @ (ccres @ XF @ (ccv @ Xs1)) @ ccgsu)))) @ ccxr @ cclt))) => (! [Xs1:$i] : (Xph => ((cco @ XG @ XF @ cctsu) = (ccsn @ (XS @ Xs1)))))))))))))))).
thf(csge0tsms_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XG = (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress)) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => (Xph => (cwcel @ (ccfv @ XF @ ccsumge0) @ (cco @ XG @ XF @ cctsu)))))))))))).
