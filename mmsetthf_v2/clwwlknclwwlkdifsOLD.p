...
thf(cclwwlknclwwlkdifsOLD_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xw:$i] : ((XA2 @ Xw) = (ccrab @ (^ [Xw:$i] : (((ccfv @ ccc0 @ (ccv @ Xw)) = (XX @ Xw)) & (cwne @ (ccfv @ (ccv @ Xw) @ cclsw) @ (XX @ Xw)))) @ (^ [Xw:$i] : (cco @ (XN @ Xw) @ (XG @ Xw) @ ccwwlksn))))) => ((! [Xw:$i] : ((XB2 @ Xw) = (ccrab @ (^ [Xw:$i] : (((ccfv @ (ccv @ Xw) @ cclsw) = (ccfv @ ccc0 @ (ccv @ Xw))) & ((ccfv @ ccc0 @ (ccv @ Xw)) = (XX @ Xw)))) @ (^ [Xw:$i] : (cco @ (XN @ Xw) @ (XG @ Xw) @ ccwwlksn))))) => (! [Xw:$i] : ((XA2 @ Xw) = (ccdif @ (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = (XX @ Xw))) @ (^ [Xw:$i] : (cco @ (XN @ Xw) @ (XG @ Xw) @ ccwwlksn))) @ (XB2 @ Xw)))))))))))).
