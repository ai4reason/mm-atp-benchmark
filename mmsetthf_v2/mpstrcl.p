...
thf(cmpstrcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : ((XP = (ccfv @ XT @ ccmpst)) => ((cwcel @ (ccotp @ XD @ XH @ XA2) @ XP) => (cw3a @ (cwcel @ XD @ ccvv) @ (cwcel @ XH @ ccvv) @ (cwcel @ XA2 @ ccvv)))))))))).
