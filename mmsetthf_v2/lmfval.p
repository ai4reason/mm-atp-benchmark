...
thf(adf_lm_ax,axiom,(cclm = (ccmpt @ (^ [Xj:$i] : cctop) @ (^ [Xj:$i] : (ccopab @ (^ [Xf1:$i] : (^ [Xx3:$i] : (cw3a @ (cwcel @ (ccv @ Xf1) @ (cco @ (ccuni @ (ccv @ Xj)) @ ccc @ ccpm)) @ (cwcel @ (ccv @ Xx3) @ (ccuni @ (ccv @ Xj))) @ (cwral @ (^ [Xu:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xu)) => (cwrex @ (^ [Xy1:$i] : (cwf @ (ccv @ Xy1) @ (ccv @ Xu) @ (ccres @ (ccv @ Xf1) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccrn @ ccuz))))) @ (^ [Xu:$i] : (ccv @ Xj))))))))))).
...
thf(clmfval_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xu:$i] : ((cwcel @ XJ @ (ccfv @ (XX @ Xu) @ cctopon)) => ((ccfv @ XJ @ cclm) = (ccopab @ (^ [Xf1:$i] : (^ [Xx3:$i] : (cw3a @ (cwcel @ (ccv @ Xf1) @ (cco @ (XX @ Xu) @ ccc @ ccpm)) @ (cwcel @ (ccv @ Xx3) @ (XX @ Xu)) @ (cwral @ (^ [Xu:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xu)) => (cwrex @ (^ [Xy1:$i] : (cwf @ (ccv @ Xy1) @ (ccv @ Xu) @ (ccres @ (ccv @ Xf1) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccrn @ ccuz))))) @ (^ [Xu:$i] : XJ)))))))))))).
