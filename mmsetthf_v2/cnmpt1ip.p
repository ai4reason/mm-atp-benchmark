...
thf(aipcn_ax,axiom,(! [Xc_xi:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((Xc_xi = (ccfv @ XW @ ccipf)) => ((XJ = (ccfv @ XW @ cctopn)) => ((XK = (ccfv @ cccnfld @ cctopn)) => ((cwcel @ XW @ cccph) => (cwcel @ Xc_xi @ (cco @ (cco @ XJ @ XJ @ cctx) @ XK @ cccn))))))))))).
