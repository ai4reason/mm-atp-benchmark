...
thf(aimasf1oxms_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (XU = (cco @ XF @ XR @ ccimas))) => ((Xph => (XV = (ccfv @ XR @ ccbs))) => ((Xph => (cwf1o @ XV @ XB2 @ XF)) => ((Xph => (cwcel @ XR @ ccxme)) => (Xph => (cwcel @ XU @ ccxme))))))))))))).
...
thf(aprdsxms_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((cw3a @ (cwcel @ XS @ XW) @ (cwcel @ XI @ ccfn) @ (cwf @ XI @ ccxme @ XR)) => (cwcel @ XY @ ccxme))))))))).
