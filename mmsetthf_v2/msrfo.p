...
thf(amstaval_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((XR = (ccfv @ XT @ ccmsr)) => ((XS = (ccfv @ XT @ ccmsta)) => (XS = (ccrn @ XR)))))))).
thf(afoeq3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cwfo @ XC @ XA2 @ XF) <=> (cwfo @ XC @ XB2 @ XF)))))))).
thf(cmsrfo_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((XR = (ccfv @ XT @ ccmsr)) => ((XS = (ccfv @ XT @ ccmsta)) => ((XP = (ccfv @ XT @ ccmpst)) => (cwfo @ XP @ XS @ XR))))))))).
