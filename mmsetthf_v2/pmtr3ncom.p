...
thf(ahashge3el3dif_ax,axiom,(! [XD:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((cwcel @ XD @ (XV @ Xx3 @ Xy1 @ Xz)) & (cwbr @ cc3 @ (ccfv @ XD @ cchash) @ ccle)) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cw3a @ (cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwne @ (ccv @ Xx3) @ (ccv @ Xz)) @ (cwne @ (ccv @ Xy1) @ (ccv @ Xz)))) @ (^ [Xz:$i] : XD))) @ (^ [Xy1:$i] : XD))) @ (^ [Xx3:$i] : XD))))))))).
...
thf(apmtr3ncomlem2_ax,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((XF = (ccfv @ (ccpr @ XX @ XY) @ XT)) => ((XG = (ccfv @ (ccpr @ XY @ XZ) @ XT)) => ((cw3a @ (cwcel @ XD @ XV) @ (cw3a @ (cwcel @ XX @ XD) @ (cwcel @ XY @ XD) @ (cwcel @ XZ @ XD)) @ (cw3a @ (cwne @ XX @ XY) @ (cwne @ XX @ XZ) @ (cwne @ XY @ XZ))) => (cwne @ (cccom @ XG @ XF) @ (cccom @ XF @ XG))))))))))))))).
...
thf(cpmtr3ncom_conj,conjecture,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((XT = (ccfv @ XD @ ccpmtr)) => (! [Xf1:$i] : (! [Xg1:$i] : (((cwcel @ XD @ (XV @ Xf1 @ Xg1)) & (cwbr @ cc3 @ (ccfv @ XD @ cchash) @ ccle)) => (cwrex @ (^ [Xf1:$i] : (cwrex @ (^ [Xg1:$i] : (cwne @ (cccom @ (ccv @ Xg1) @ (ccv @ Xf1)) @ (cccom @ (ccv @ Xf1) @ (ccv @ Xg1)))) @ (^ [Xg1:$i] : (ccrn @ XT)))) @ (^ [Xf1:$i] : (ccrn @ XT))))))))))).
