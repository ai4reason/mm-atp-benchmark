...
thf(aereq1_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((XR = XS) => ((cwer @ XA2 @ XR) <=> (cwer @ XA2 @ XS))))))).
thf(asimpl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xph)))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(aiiner_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (((cwne @ XA2 @ cc0) & (cwral @ (^ [Xx3:$i] : (cwer @ XB2 @ (XR @ Xx3))) @ (^ [Xx3:$i] : XA2))) => (cwer @ XB2 @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XR @ Xx3))))))))).
