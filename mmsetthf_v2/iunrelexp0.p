...
thf(arelexp0eq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XU) & (cwcel @ XB2 @ XV)) => (((ccun @ (ccdm @ XA2) @ (ccrn @ XA2)) = (ccun @ (ccdm @ XB2) @ (ccrn @ XB2))) <=> ((cco @ XA2 @ ccc0 @ ccrelexp) = (cco @ XB2 @ ccc0 @ ccrelexp))))))))).
thf(ciunrelexp0_conj,conjecture,(! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cw3a @ (cwcel @ XR @ XV) @ (cwss @ XZ @ ccn0) @ (cwne @ (ccin @ (ccpr @ ccc0 @ cc1) @ XZ) @ cc0)) => ((cco @ (cciun @ (^ [Xx3:$i] : XZ) @ (^ [Xx3:$i] : (cco @ XR @ (ccv @ Xx3) @ ccrelexp))) @ ccc0 @ ccrelexp) = (cco @ XR @ ccc0 @ ccrelexp))))))).
