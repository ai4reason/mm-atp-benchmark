...
thf(csymgfvne_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((cw3a @ (cwcel @ XF @ XB2) @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XA2)) => (((ccfv @ XX @ XF) = XZ) => ((cwne @ XY @ XX) => (cwne @ (ccfv @ XY @ XF) @ XZ)))))))))))))).
