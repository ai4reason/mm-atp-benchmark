...
thf(asnopsuppss_ax,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (cwss @ (cco @ (ccsn @ (ccop @ XX @ XY)) @ XZ @ ccsupp) @ (ccsn @ XX)))))).
...
thf(csnopfsupp_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cw3a @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XW) @ (cwcel @ XZ @ XU)) => (cwbr @ (ccsn @ (ccop @ XX @ XY)) @ XZ @ ccfsupp))))))))).
