...
thf(ahoicvr_ax,axiom,(! [Xph:$o] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : ((XI @ Xx3 @ Xi @ Xj) = (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccop @ (ccneg @ (ccv @ Xj)) @ (ccv @ Xj)))))))))) => ((Xph => (cwcel @ XX @ ccfn)) => (! [Xx3:$i] : (Xph => (cwss @ (cco @ ccr @ XX @ ccmap) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (XI @ Xx3 @ Xi @ Xj))))))))))))))))).
...
thf(aneglt_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwbr @ (ccneg @ XA2) @ XA2 @ cclt)))).
...
thf(asge0rpcpnf_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3)))) => ((Xph => (~ (cwcel @ XA2 @ ccfn))) => ((Xph => (cwcel @ XB2 @ ccrp)) => (Xph => ((ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2)) @ ccsumge0) = ccpnf)))))))))).
thf(annnfi_ax,axiom,(~ (cwcel @ ccn @ ccfn))).
