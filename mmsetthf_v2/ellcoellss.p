...
thf(alincellss_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XM @ cclmod) @ (cwcel @ XS @ (ccfv @ XM @ cclss)) @ (cwss @ XV @ XS)) => (((cwcel @ XF @ (cco @ (ccfv @ (ccfv @ XM @ ccsca) @ ccbs) @ XV @ ccmap)) & (cwbr @ XF @ (ccfv @ (ccfv @ XM @ ccsca) @ cc0g) @ ccfsupp)) => (cwcel @ (cco @ XF @ XV @ (ccfv @ XM @ cclinc)) @ XS)))))))).
thf(aeleq1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwcel @ XA2 @ XC) <=> (cwcel @ XB2 @ XC))))))).
thf(cellcoellss_conj,conjecture,(! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XM @ cclmod) @ (cwcel @ XS @ (ccfv @ XM @ cclss)) @ (cwss @ XV @ XS)) => (cwral @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XS)) @ (^ [Xx3:$i] : (cco @ XM @ XV @ cclinco)))))))).
