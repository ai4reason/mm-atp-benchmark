...
thf(abnj563_ax,axiom,(! [Xet:($i > ($i > ($i > ($i > $o))))] : (! [Xrh:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xet @ Xi @ Xm @ Xn @ Xp) <=> (cw_bnj17 @ (cwcel @ (ccv @ Xm) @ (XD @ Xi @ Xm @ Xn @ Xp)) @ ((ccv @ Xn) = (ccsuc @ (ccv @ Xm))) @ (cwcel @ (ccv @ Xp) @ ccom) @ ((ccv @ Xm) = (ccsuc @ (ccv @ Xp))))))))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xrh @ Xi @ Xm @ Xn @ Xp) <=> (cw3a @ (cwcel @ (ccv @ Xi) @ ccom) @ (cwcel @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xn)) @ (cwne @ (ccv @ Xm) @ (ccsuc @ (ccv @ Xi))))))))) => (! [Xi:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xp:$i] : (((Xet @ Xi @ Xm @ Xn @ Xp) & (Xrh @ Xi @ Xm @ Xn @ Xp)) => (cwcel @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xm))))))))))))).
thf(aimp32_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps => (Xch => Xth))) => ((Xph & (Xps & Xch)) => Xth))))))).
thf(asylbi_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph <=> Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(abnj946_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph @ Xx3) <=> (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))) => (! [Xx3:$i] : ((Xph @ Xx3) <=> (! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) => (Xps @ Xx3)))))))))).
...
thf(abnj721_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (((cw3a @ Xph @ Xps @ Xch) => Xta) => ((cw_bnj17 @ Xph @ Xps @ Xch @ Xth) => Xta)))))))).
...
thf(abnj667_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cw_bnj17 @ Xph @ Xps @ Xch @ Xth) => (cw3a @ Xps @ Xch @ Xth))))))).
thf(a_3impb_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & (Xps & Xch)) => Xth) => ((cw3a @ Xph @ Xps @ Xch) => Xth))))))).
thf(abnj564_ax,axiom,(! [Xta:($i > ($i > $o))] : (! [Xbnjwphm:($i > ($i > $o))] : (! [Xbnjwpsm:($i > ($i > $o))] : ((! [Xf1:$i] : (! [Xm:$i] : ((Xta @ Xf1 @ Xm) <=> (cw3a @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xm)) @ (Xbnjwphm @ Xf1 @ Xm) @ (Xbnjwpsm @ Xf1 @ Xm))))) => (! [Xf1:$i] : (! [Xm:$i] : ((Xta @ Xf1 @ Xm) => ((ccdm @ (ccv @ Xf1)) = (ccv @ Xm)))))))))).
...
thf(abnj252_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cw_bnj17 @ Xph @ Xps @ Xch @ Xth) <=> (Xph & (cw3a @ Xps @ Xch @ Xth)))))))).
