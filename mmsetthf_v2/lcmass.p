...
thf(alcmeq0_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => (((cco @ XM @ XN @ cclcm) = ccc0) <=> ((XM = ccc0) | (XN = ccc0))))))).
...
thf(alcmdvdsb_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) => (((cwbr @ XM @ XK @ ccdvds) & (cwbr @ XN @ XK @ ccdvds)) <=> (cwbr @ (cco @ XM @ XN @ cclcm) @ XK @ ccdvds))))))).
...
thf(clcmass_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XP @ ccz)) => ((cco @ (cco @ XN @ XM @ cclcm) @ XP @ cclcm) = (cco @ XN @ (cco @ XM @ XP @ cclcm) @ cclcm))))))).
