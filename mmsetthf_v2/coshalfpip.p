...
thf(acoshalfpi_ax,axiom,((ccfv @ (cco @ ccpi @ cc2 @ ccdiv) @ cccos) = ccc0)).
...
thf(ccoshalfpip_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (cco @ (cco @ ccpi @ cc2 @ ccdiv) @ XA2 @ ccaddc) @ cccos) = (ccneg @ (ccfv @ XA2 @ ccsin)))))).
