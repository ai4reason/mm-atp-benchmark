...
thf(amulexp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XN @ ccn0)) => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ XN @ ccexp) = (cco @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XB2 @ XN @ ccexp) @ ccmul))))))).
thf(cexpubnd_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XN @ ccn0) @ (cwbr @ cc2 @ XA2 @ ccle)) => (cwbr @ (cco @ XA2 @ XN @ ccexp) @ (cco @ (cco @ cc2 @ XN @ ccexp) @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ XN @ ccexp) @ ccmul) @ ccle))))).
