...
thf(ccfval_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((ccfv @ XA2 @ cccf) = (ccint @ (ccab @ (^ [Xx3:$i] : (? [Xy1:$i] : (((ccv @ Xx3) = (ccfv @ (ccv @ Xy1) @ cccrd)) & ((cwss @ (ccv @ Xy1) @ XA2) & (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccv @ Xw))) @ (^ [Xw:$i] : (ccv @ Xy1)))) @ (^ [Xz:$i] : XA2)))))))))))).
