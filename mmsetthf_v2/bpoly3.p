...
thf(cbpoly3_conj,conjecture,(! [XX:($i > $o)] : ((cwcel @ XX @ ccc) => ((cco @ cc3 @ XX @ ccbp) = (cco @ (cco @ (cco @ XX @ cc3 @ ccexp) @ (cco @ (cco @ cc3 @ cc2 @ ccdiv) @ (cco @ XX @ cc2 @ ccexp) @ ccmul) @ ccmin) @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ XX @ ccmul) @ ccaddc))))).
