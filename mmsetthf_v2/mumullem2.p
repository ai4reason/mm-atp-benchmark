...
thf(cmumullem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ ((cco @ XA2 @ XB2 @ ccgcd) = cc1)) & ((cwne @ (ccfv @ XA2 @ ccmu) @ ccc0) & (cwne @ (ccfv @ XB2 @ ccmu) @ ccc0))) => (cwne @ (ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ ccmu) @ ccc0))))).
