...
thf(aresdmdfsn_ax,axiom,(! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwrel @ XR) => ((ccres @ XR @ (ccdif @ ccvv @ (ccsn @ XX))) = (ccres @ XR @ (ccdif @ (ccdm @ XR) @ (ccsn @ XX)))))))).
...
thf(cfunresdfunsn_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwfun @ XF) & (cwcel @ XX @ (ccdm @ XF))) => ((ccun @ (ccres @ XF @ (ccdif @ ccvv @ (ccsn @ XX))) @ (ccsn @ (ccop @ XX @ (ccfv @ XX @ XF)))) = XF))))).
