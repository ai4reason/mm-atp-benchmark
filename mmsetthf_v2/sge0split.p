...
thf(asge0resplit_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((XU = (ccun @ XA2 @ XB2)) => ((Xph => ((ccin @ XA2 @ XB2) = cc0)) => ((Xph => (cwf @ XU @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((Xph => (cwcel @ (ccfv @ XF @ ccsumge0) @ ccr)) => (Xph => ((ccfv @ XF @ ccsumge0) = (cco @ (ccfv @ (ccres @ XF @ XA2) @ ccsumge0) @ (ccfv @ (ccres @ XF @ XB2) @ ccsumge0) @ ccaddc))))))))))))))))).
thf(aadantr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph & Xch) => Xps)))))).
thf(asimpr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(aeqcomd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => (XB2 = XA2))))))).
thf(asyl2anc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xph => Xch) => (((Xps & Xch) => Xth) => (Xph => Xth))))))))).
thf(asge0ssre_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((Xph => (cwcel @ (ccfv @ XF @ ccsumge0) @ ccr)) => (Xph => (cwcel @ (ccfv @ (ccres @ XF @ XY) @ ccsumge0) @ ccr))))))))))).
...
thf(axreqle_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (XA2 = XB2)) => (cwbr @ XA2 @ XB2 @ ccle))))).
...
thf(age0nemnf2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc)) => (cwne @ XA2 @ ccmnf)))).
...
thf(apm4_56_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (((~ Xph) & (~ Xps)) <=> (~ (Xph | Xps)))))).
thf(aelun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccun @ XB2 @ XC)) <=> ((cwcel @ XA2 @ XB2) | (cwcel @ XA2 @ XC))))))).
thf(a_3eqtrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XB2 = XC)) => ((Xph => (XC = XD)) => (Xph => (XA2 = XD))))))))))).
thf(arnresun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((ccrn @ (ccres @ XF @ (ccun @ XA2 @ XB2))) = (ccun @ (ccrn @ (ccres @ XF @ XA2)) @ (ccrn @ (ccres @ XF @ XB2)))))))).
...
thf(asge0reval_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (XX @ Xy1) @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwf @ (XX @ Xy1) @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => ((ccfv @ XF @ ccsumge0) = (ccsup @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ (XX @ Xy1)) @ ccfn)) @ (^ [Xx3:$i] : (ccsu @ (ccv @ Xx3) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XF)))))) @ ccxr @ cclt)))))))))))).
thf(ampbid_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => (Xps <=> Xch)) => (Xph => Xch))))))).
thf(afsumlesge0_ax,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XX @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwf @ (XX @ Xx3) @ (cco @ ccc0 @ ccpnf @ ccico) @ XF))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XY @ (XX @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XY @ ccfn))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwbr @ (ccsu @ XY @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF))) @ (ccfv @ XF @ ccsumge0) @ ccle))))))))))))).
...
thf(asge0rnre_ax,axiom,(! [Xph:$o] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccico) @ (XF @ Xx3 @ Xy1))))) => (Xph => (cwss @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ XX) @ ccfn)) @ (^ [Xx3:$i] : (ccsu @ (ccv @ Xx3) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ (XF @ Xx3 @ Xy1))))))) @ ccr))))))).
...
thf(csge0split_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((XU = (ccun @ XA2 @ XB2)) => ((Xph => ((ccin @ XA2 @ XB2) = cc0)) => ((Xph => (cwf @ XU @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => (Xph => ((ccfv @ XF @ ccsumge0) = (cco @ (ccfv @ (ccres @ XF @ XA2) @ ccsumge0) @ (ccfv @ (ccres @ XF @ XB2) @ ccsumge0) @ ccxad)))))))))))))))).
