...
thf(adrsdirfi_ax,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((cw3a @ (cwcel @ XK @ ccdrs) @ (cwss @ XX @ XB2) @ (cwcel @ XX @ ccfn)) => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ Xc_le)) @ (^ [Xz:$i] : XX))) @ (^ [Xy1:$i] : XB2)))))))))).
