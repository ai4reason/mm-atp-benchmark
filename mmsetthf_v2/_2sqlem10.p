...
thf(a_2sqlem1_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : ((! [Xw:$i] : ((XS @ Xw) = (ccrn @ (ccmpt @ (^ [Xw:$i] : ccgz) @ (^ [Xw:$i] : (cco @ (ccfv @ (ccv @ Xw) @ ccabs) @ cc2 @ ccexp)))))) => (! [Xw:$i] : ((cwcel @ (XA2 @ Xw) @ (XS @ Xw)) <=> (cwrex @ (^ [Xx3:$i] : ((XA2 @ Xw) = (cco @ (ccfv @ (ccv @ Xx3) @ ccabs) @ cc2 @ ccexp))) @ (^ [Xx3:$i] : ccgz)))))))).
...
thf(c_2sqlem10_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xw:$i] : ((XS @ Xw) = (ccrn @ (ccmpt @ (^ [Xw:$i] : ccgz) @ (^ [Xw:$i] : (cco @ (ccfv @ (ccv @ Xw) @ ccabs) @ cc2 @ ccexp)))))) => ((! [Xz:$i] : (! [Xw:$i] : ((XY @ Xz @ Xw) = (ccab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccgcd) = cc1) & ((ccv @ Xz) = (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc)))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))))))) => (! [Xz:$i] : (! [Xw:$i] : ((cw3a @ (cwcel @ (XA2 @ Xw) @ (XY @ Xz @ Xw)) @ (cwcel @ (XB2 @ Xz @ Xw) @ ccn) @ (cwbr @ (XB2 @ Xz @ Xw) @ (XA2 @ Xw) @ ccdvds)) => (cwcel @ (XB2 @ Xz @ Xw) @ (XS @ Xw)))))))))))).
