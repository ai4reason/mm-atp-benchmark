...
thf(cfunressnfv_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XX @ (ccdm @ (cccom @ XF @ XG))) & (cwfun @ (ccres @ (cccom @ XF @ XG) @ (ccsn @ XX)))) & ((cwfn @ XG @ XA2) & (cwcel @ XX @ XA2))) => (cwfun @ (ccres @ XF @ (ccsn @ (ccfv @ XX @ XG)))))))))).
