...
thf(asqreu_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwreu @ (^ [Xx3:$i] : (cw3a @ ((cco @ (ccv @ Xx3) @ cc2 @ ccexp) = XA2) @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ ccre) @ ccle) @ (cwnel @ (cco @ cci @ (ccv @ Xx3) @ ccmul) @ ccrp))) @ (^ [Xx3:$i] : ccc))))).
...
thf(asqrtthlem_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cw3a @ ((cco @ (ccfv @ XA2 @ ccsqrt) @ cc2 @ ccexp) = XA2) @ (cwbr @ ccc0 @ (ccfv @ (ccfv @ XA2 @ ccsqrt) @ ccre) @ ccle) @ (cwnel @ (cco @ cci @ (ccfv @ XA2 @ ccsqrt) @ ccmul) @ ccrp))))).
...
thf(ceqsqrtd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => ((cco @ XA2 @ cc2 @ ccexp) = XB2)) => ((Xph => (cwbr @ ccc0 @ (ccfv @ XA2 @ ccre) @ ccle)) => ((Xph => (~ (cwcel @ (cco @ cci @ XA2 @ ccmul) @ ccrp))) => (Xph => (XA2 = (ccfv @ XB2 @ ccsqrt)))))))))))).
