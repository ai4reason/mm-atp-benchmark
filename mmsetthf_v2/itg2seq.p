...
thf(altsub13_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) => ((cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ cclt) <=> (cwbr @ XC @ (cco @ XB2 @ XA2 @ ccmin) @ cclt))))))).
...
thf(citg2seq_conj,conjecture,(! [XF:($i > $o)] : ((cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF) => (? [Xg1:$i] : (cw3a @ (cwf @ ccn @ (ccdm @ ccitg1) @ (ccv @ Xg1)) @ (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ XF @ (ccofr @ ccle))) @ (^ [Xn:$i] : ccn)) @ ((ccfv @ XF @ ccitg2) = (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ ccitg1)))) @ ccxr @ cclt))))))).
