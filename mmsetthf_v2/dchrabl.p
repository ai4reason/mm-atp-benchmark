...
thf(adchrinvcl_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : ((XG @ Xk) = (ccfv @ XN @ ccdchr))) => ((XZ = (ccfv @ XN @ cczn)) => ((! [Xk:$i] : ((XD @ Xk) = (ccfv @ (XG @ Xk) @ ccbs))) => ((XB2 = (ccfv @ XZ @ ccbs)) => ((XU = (ccfv @ XZ @ ccui)) => ((! [Xk:$i] : ((Xc_1 @ Xk) = (ccmpt @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XU) @ cc1 @ ccc0))))) => ((! [Xk:$i] : ((Xc_x @ Xk) = (ccfv @ (XG @ Xk) @ ccplusg))) => ((! [Xk:$i] : (Xph => (cwcel @ XX @ (XD @ Xk)))) => ((! [Xk:$i] : ((XK @ Xk) = (ccmpt @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XU) @ (cco @ cc1 @ (ccfv @ (ccv @ Xk) @ XX) @ ccdiv) @ ccc0))))) => (! [Xk:$i] : (Xph => ((cwcel @ (XK @ Xk) @ (XD @ Xk)) & ((cco @ (XK @ Xk) @ XX @ (Xc_x @ Xk)) = (Xc_1 @ Xk)))))))))))))))))))))))))).
thf(asimprd_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps & Xch)) => (Xph => Xch)))))).
thf(acaofcom_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XA2 @ Xx3 @ Xy1) @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwf @ (XA2 @ Xx3 @ Xy1) @ XS @ XF)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwf @ (XA2 @ Xx3 @ Xy1) @ XS @ XG)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) = (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR))))) => (Xph => ((cco @ XF @ XG @ (ccof @ XR)) = (cco @ XG @ XF @ (ccof @ XR)))))))))))))))).
thf(amulcom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ XA2 @ XB2 @ ccmul) = (cco @ XB2 @ XA2 @ ccmul)))))).
thf(cdchrabl_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((cwcel @ XN @ ccn) => (cwcel @ XG @ ccabl)))))).
