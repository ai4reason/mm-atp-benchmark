...
thf(aerrn_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwer @ XA2 @ XR) => ((ccrn @ XR) = XA2))))).
thf(cuniqs2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwer @ XA2 @ XR)) => ((Xph => (cwcel @ XR @ XV)) => (Xph => ((ccuni @ (ccqs @ XA2 @ XR)) = XA2))))))))).
