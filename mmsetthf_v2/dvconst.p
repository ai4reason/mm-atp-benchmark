...
thf(advidlem_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ ccc @ ccc @ XF)) => ((! [Xx3:$i] : (! [Xz:$i] : ((Xph & (cw3a @ (cwcel @ (ccv @ Xx3) @ ccc) @ (cwcel @ (ccv @ Xz) @ ccc) @ (cwne @ (ccv @ Xz) @ (ccv @ Xx3)))) => ((cco @ (cco @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccmin) @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ ccmin) @ ccdiv) = XB2)))) => ((cwcel @ XB2 @ ccc) => (Xph => ((cco @ ccc @ XF @ ccdv) = (ccxp @ ccc @ (ccsn @ XB2))))))))))).
