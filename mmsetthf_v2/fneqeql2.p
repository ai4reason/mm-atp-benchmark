...
thf(afneqeql_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfn @ XF @ XA2) & (cwfn @ XG @ XA2)) => ((XF = XG) <=> ((ccdm @ (ccin @ XF @ XG)) = XA2))))))).
...
thf(cfneqeql2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfn @ XF @ XA2) & (cwfn @ XG @ XA2)) => ((XF = XG) <=> (cwss @ XA2 @ (ccdm @ (ccin @ XF @ XG))))))))).
