...
thf(aequivbnd2_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XM @ Xx3 @ Xy1) @ (ccfv @ (XX @ Xx3 @ Xy1) @ ccme))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XN @ Xx3 @ Xy1) @ (ccfv @ (XX @ Xx3 @ Xy1) @ ccme))))) => ((Xph => (cwcel @ XR @ ccrp)) => ((Xph => (cwcel @ XS @ ccrp)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ (XX @ Xx3 @ Xy1)) & (cwcel @ (ccv @ Xy1) @ (XX @ Xx3 @ Xy1)))) => (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XN @ Xx3 @ Xy1)) @ (cco @ XR @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XM @ Xx3 @ Xy1)) @ ccmul) @ ccle)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ (XX @ Xx3 @ Xy1)) & (cwcel @ (ccv @ Xy1) @ (XX @ Xx3 @ Xy1)))) => (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XM @ Xx3 @ Xy1)) @ (cco @ XS @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XN @ Xx3 @ Xy1)) @ ccmul) @ ccle)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XC = (ccres @ (XM @ Xx3 @ Xy1) @ (ccxp @ XY @ XY))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XD = (ccres @ (XN @ Xx3 @ Xy1) @ (ccxp @ XY @ XY))))) => ((Xph => ((cwcel @ XC @ (ccfv @ XY @ cctotbnd)) <=> (cwcel @ XC @ (ccfv @ XY @ ccbnd)))) => (Xph => ((cwcel @ XD @ (ccfv @ XY @ cctotbnd)) <=> (cwcel @ XD @ (ccfv @ XY @ ccbnd))))))))))))))))))))))).
...
thf(arepwsmet_ax,axiom,(! [XD:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ (cco @ cccnfld @ ccr @ ccress) @ XI @ ccpws)) => ((XD = (ccfv @ XY @ ccds)) => ((XX = (cco @ ccr @ XI @ ccmap)) => ((cwcel @ XI @ ccfn) => (cwcel @ XD @ (ccfv @ XX @ ccme))))))))))).
...
thf(arrnequiv_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ (cco @ cccnfld @ ccr @ ccress) @ XI @ ccpws)) => ((XD = (ccfv @ XY @ ccds)) => ((XX = (cco @ ccr @ XI @ ccmap)) => ((Xph => (cwcel @ XI @ ccfn)) => ((Xph & ((cwcel @ XF @ XX) & (cwcel @ XG @ XX))) => ((cwbr @ (cco @ XF @ XG @ XD) @ (cco @ XF @ XG @ (ccfv @ XI @ ccrrn)) @ ccle) & (cwbr @ (cco @ XF @ XG @ (ccfv @ XI @ ccrrn)) @ (cco @ (ccfv @ (ccfv @ XI @ cchash) @ ccsqrt) @ (cco @ XF @ XG @ XD) @ ccmul) @ ccle))))))))))))))).
...
thf(acnpwstotbnd_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ (cco @ cccnfld @ XA2 @ ccress) @ XI @ ccpws)) => ((XD = (ccres @ (ccfv @ XY @ ccds) @ (ccxp @ XX @ XX))) => (((cwss @ XA2 @ ccc) & (cwcel @ XI @ ccfn)) => ((cwcel @ XD @ (ccfv @ XX @ cctotbnd)) <=> (cwcel @ XD @ (ccfv @ XX @ ccbnd)))))))))))).
