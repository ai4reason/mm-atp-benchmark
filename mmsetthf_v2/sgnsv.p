...
thf(csgnsv_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [Xc_lt:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_lt = (ccfv @ XR @ ccplt)) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccfv @ XR @ ccsgns))) => (! [Xx3:$i] : ((cwcel @ XR @ XV) => ((XS @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = Xc_0) @ ccc0 @ (ccif @ (cwbr @ Xc_0 @ (ccv @ Xx3) @ Xc_lt) @ cc1 @ (ccneg @ cc1))))))))))))))))))).
