...
thf(cbrcoss_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwbr @ XA2 @ XB2 @ (cccoss @ XR)) <=> (? [Xu:$i] : ((cwbr @ (ccv @ Xu) @ XA2 @ XR) & (cwbr @ (ccv @ Xu) @ XB2 @ XR))))))))))).
