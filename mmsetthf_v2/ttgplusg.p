...
thf(attglem_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : ((XG = (ccfv @ XH @ ccttg)) => ((XE = (ccslot @ XN)) => ((cwcel @ XN @ ccn) => ((cwbr @ XN @ (ccdc @ cc1 @ cc6) @ cclt) => ((ccfv @ XH @ XE) = (ccfv @ XG @ XE))))))))))).
...
thf(cttgplusg_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XG = (ccfv @ XH @ ccttg)) => ((Xc_pl = (ccfv @ XH @ ccplusg)) => (Xc_pl = (ccfv @ XG @ ccplusg)))))))).
