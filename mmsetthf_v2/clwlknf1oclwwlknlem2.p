...
thf(cclwlknf1oclwwlknlem2_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((ccrab @ (^ [Xw:$i] : ((ccfv @ (ccfv @ (ccv @ Xw) @ cc1st) @ cchash) = XN)) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwlks))) = (ccrab @ (^ [Xc:$i] : ((cwbr @ cc1 @ (ccfv @ (ccfv @ (ccv @ Xc) @ cc1st) @ cchash) @ ccle) & ((ccfv @ (ccfv @ (ccv @ Xc) @ cc1st) @ cchash) = XN))) @ (^ [Xc:$i] : (ccfv @ XG @ ccclwlks)))))))).
