...
thf(ahdmapffval_ax,axiom,(! [XH:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XK:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))))] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xe:$i] : (! [Xi:$i] : (! [Xa:$i] : ((XH @ Xy1 @ Xz @ Xv @ Xu @ Xt @ Xe @ Xi @ Xa) = (ccfv @ XK @ cclh)))))))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xe:$i] : (! [Xi:$i] : (! [Xa:$i] : ((cwcel @ XK @ (XX @ Xy1 @ Xz @ Xw @ Xv @ Xu @ Xt @ Xe @ Xi @ Xa)) => ((ccfv @ XK @ cchdma) = (ccmpt @ (^ [Xw:$i] : (XH @ Xy1 @ Xz @ Xv @ Xu @ Xt @ Xe @ Xi @ Xa)) @ (^ [Xw:$i] : (ccab @ (^ [Xa:$i] : (cwsbc @ (^ [Xe:$i] : (cwsbc @ (^ [Xu:$i] : (cwsbc @ (^ [Xv:$i] : (cwsbc @ (^ [Xi:$i] : (cwcel @ (ccv @ Xa) @ (ccmpt @ (^ [Xt:$i] : (ccv @ Xv)) @ (^ [Xt:$i] : (ccrio @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((~ (cwcel @ (ccv @ Xz) @ (ccun @ (ccfv @ (ccsn @ (ccv @ Xe)) @ (ccfv @ (ccv @ Xu) @ cclspn)) @ (ccfv @ (ccsn @ (ccv @ Xt)) @ (ccfv @ (ccv @ Xu) @ cclspn))))) => ((ccv @ Xy1) = (ccfv @ (ccotp @ (ccv @ Xz) @ (ccfv @ (ccotp @ (ccv @ Xe) @ (ccfv @ (ccv @ Xe) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ cchvm))) @ (ccv @ Xz)) @ (ccv @ Xi)) @ (ccv @ Xt)) @ (ccv @ Xi))))) @ (^ [Xz:$i] : (ccv @ Xv)))) @ (^ [Xy1:$i] : (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ cclcd)) @ ccbs))))))) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ cchdma1)))) @ (ccfv @ (ccv @ Xu) @ ccbs))) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh)))) @ (ccop @ (ccres @ ccid @ (ccfv @ XK @ ccbs)) @ (ccres @ ccid @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccltrn))))))))))))))))))))))))).
...
thf(aoteq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((ccotp @ XC @ XA2 @ XD) = (ccotp @ XC @ XB2 @ XD)))))))))).
...
thf(aoteq1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((ccotp @ XA2 @ XC @ XD) = (ccotp @ XB2 @ XC @ XD)))))))))).
