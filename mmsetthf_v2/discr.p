...
thf(adiscr1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwbr @ ccc0 @ (cco @ (cco @ (cco @ XA2 @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccmul) @ (cco @ XB2 @ (ccv @ Xx3) @ ccmul) @ ccaddc) @ XC @ ccaddc) @ ccle))) => ((XX = (ccif @ (cwbr @ cc1 @ (cco @ (cco @ (cco @ XB2 @ (ccif @ (cwbr @ ccc0 @ XC @ ccle) @ XC @ ccc0) @ ccaddc) @ cc1 @ ccaddc) @ (ccneg @ XA2) @ ccdiv) @ ccle) @ (cco @ (cco @ (cco @ XB2 @ (ccif @ (cwbr @ ccc0 @ XC @ ccle) @ XC @ ccc0) @ ccaddc) @ cc1 @ ccaddc) @ (ccneg @ XA2) @ ccdiv) @ cc1)) => (Xph => (cwbr @ ccc0 @ XA2 @ ccle))))))))))))).
