...
thf(adisjf1o_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ XV))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((XC = (ccrab @ (^ [Xx3:$i] : (cwne @ (XB2 @ Xx3) @ cc0)) @ (^ [Xx3:$i] : XA2))) => ((! [Xx3:$i] : (XD = (ccdif @ (ccrn @ (XF @ Xx3)) @ (ccsn @ cc0)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwf1o @ XC @ XD @ (ccres @ (XF @ Xx3) @ XC)))))))))))))))))).
