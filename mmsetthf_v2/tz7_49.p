...
thf(atz7_48_3_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ ccon0) => ((cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccdif @ XA2 @ (ccima @ XF @ (ccv @ Xx3))))) @ (^ [Xx3:$i] : ccon0)) => (~ (cwcel @ XA2 @ ccvv))))))).
...
thf(ctz7_49_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : ((cwfn @ XF @ ccon0) => ((! [Xx3:$i] : ((Xph @ Xx3) <=> (cwral @ (^ [Xx3:$i] : ((cwne @ (ccdif @ XA2 @ (ccima @ XF @ (ccv @ Xx3))) @ cc0) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccdif @ XA2 @ (ccima @ XF @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : ccon0)))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XA2 @ (XB2 @ Xx3 @ Xy1)) & (Xph @ Xx3)) => (cwrex @ (^ [Xx3:$i] : (cw3a @ (cwral @ (^ [Xy1:$i] : (cwne @ (ccdif @ XA2 @ (ccima @ XF @ (ccv @ Xy1))) @ cc0)) @ (^ [Xy1:$i] : (ccv @ Xx3))) @ ((ccima @ XF @ (ccv @ Xx3)) = XA2) @ (cwfun @ (cccnv @ (ccres @ XF @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : ccon0)))))))))))).
