...
thf(amapdordlem2_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xg1:$i] : ((XH @ Xg1) = (ccfv @ XK @ cclh))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((! [Xg1:$i] : ((XS @ Xg1) = (ccfv @ XU @ cclss))) => ((! [Xg1:$i] : ((XM @ Xg1) = (ccfv @ XW @ (ccfv @ XK @ ccmpd)))) => ((! [Xg1:$i] : ((Xph @ Xg1) => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ (XH @ Xg1))))) => ((! [Xg1:$i] : ((Xph @ Xg1) => (cwcel @ (XX @ Xg1) @ (XS @ Xg1)))) => ((! [Xg1:$i] : ((Xph @ Xg1) => (cwcel @ (XY @ Xg1) @ (XS @ Xg1)))) => ((XO = (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((! [Xg1:$i] : ((XA2 @ Xg1) = (ccfv @ XU @ cclsa))) => ((XF = (ccfv @ XU @ cclfn)) => ((XJ = (ccfv @ XU @ cclsh)) => ((XL = (ccfv @ XU @ cclk)) => ((! [Xg1:$i] : ((XT @ Xg1) = (ccrab @ (^ [Xg1:$i] : (cwcel @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xg1) @ XL) @ XO) @ XO) @ XJ)) @ (^ [Xg1:$i] : XF)))) => ((! [Xg1:$i] : ((XC @ Xg1) = (ccrab @ (^ [Xg1:$i] : ((ccfv @ (ccfv @ (ccfv @ (ccv @ Xg1) @ XL) @ XO) @ XO) = (ccfv @ (ccv @ Xg1) @ XL))) @ (^ [Xg1:$i] : XF)))) => (! [Xg1:$i] : ((Xph @ Xg1) => ((cwss @ (ccfv @ (XX @ Xg1) @ (XM @ Xg1)) @ (ccfv @ (XY @ Xg1) @ (XM @ Xg1))) <=> (cwss @ (XX @ Xg1) @ (XY @ Xg1)))))))))))))))))))))))))))))))))))).
