...
thf(crngogrphom_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XJ = (ccfv @ XS @ cc1st)) => ((cw3a @ (cwcel @ XR @ ccrngo) @ (cwcel @ XS @ ccrngo) @ (cwcel @ XF @ (cco @ XR @ XS @ ccrnghom))) => (cwcel @ XF @ (cco @ XG @ XJ @ ccghomOLD))))))))))).
