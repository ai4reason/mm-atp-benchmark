...
thf(cocvsscon_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_pe = (ccfv @ XW @ ccocv)) => ((cw3a @ (cwcel @ XW @ ccphl) @ (cwss @ XS @ XV) @ (cwss @ XT @ XV)) => ((cwss @ XS @ (ccfv @ XT @ Xc_pe)) <=> (cwss @ XT @ (ccfv @ XS @ Xc_pe)))))))))))).
