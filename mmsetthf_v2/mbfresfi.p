...
thf(avtocl2g_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xy1) = (XB2 @ Xx3)) => ((Xps @ Xy1) <=> (Xch @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph @ Xx3 @ Xy1))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XA2 @ (XV @ Xx3 @ Xy1)) & (cwcel @ (XB2 @ Xx3) @ (XW @ Xx3 @ Xy1))) => (Xch @ Xx3))))))))))))))).
...
thf(afindcard2_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [Xth:($i > ($i > $o))] : (! [Xta:($i > ($i > $o))] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = cc0) => ((Xph @ Xx3) <=> (Xps @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xch @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccun @ (ccv @ Xy1) @ (ccsn @ (ccv @ Xz)))) => ((Xph @ Xx3) <=> (Xth @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> (Xta @ Xy1 @ Xz)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (Xps @ Xy1 @ Xz))) => ((! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ (ccv @ Xy1) @ ccfn) => ((Xch @ Xy1 @ Xz) => (Xth @ Xy1 @ Xz))))) => (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ XA2 @ ccfn) => (Xta @ Xy1 @ Xz))))))))))))))))).
...
thf(acbval2v_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((((ccv @ Xx3) = (ccv @ Xz)) & ((ccv @ Xy1) = (ccv @ Xw))) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xz @ Xw))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph @ Xx3 @ Xy1))) <=> (! [Xz:$i] : (! [Xw:$i] : (Xps @ Xz @ Xw)))))))).
...
thf(areldm0_ax,axiom,(! [XA2:($i > $o)] : ((cwrel @ XA2) => ((XA2 = cc0) <=> ((ccdm @ XA2) = cc0))))).
thf(ccvol_tp,type,(ccvol : ($i > $o))).
thf(cc1_tp,type,(cc1 : ($i > $o))).
thf(a_0mbf_ax,axiom,(cwcel @ cc0 @ ccmbf)).
...
thf(arecncf_ax,axiom,(cwcel @ ccre @ (cco @ ccc @ ccr @ cccncf))).
...
thf(afeq123_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cw3a @ (XF = XG) @ (XA2 = XC) @ (XB2 = XD)) => ((cwf @ XA2 @ XB2 @ XF) <=> (cwf @ XC @ XD @ XG)))))))))).
...
thf(afresin_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => (cwf @ (ccin @ XA2 @ XX) @ XB2 @ (ccres @ XF @ XX)))))))).
...
thf(aimcncf_ax,axiom,(cwcel @ ccim @ (cco @ ccc @ ccr @ cccncf))).
...
thf(cmbfresfi_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwcel @ XS @ ccfn)) => ((Xph => (cwral @ (^ [Xs1:$i] : (cwcel @ (ccres @ XF @ (ccv @ Xs1)) @ ccmbf)) @ (^ [Xs1:$i] : XS))) => ((Xph => ((ccuni @ XS) = XA2)) => (Xph => (cwcel @ XF @ ccmbf))))))))))).
