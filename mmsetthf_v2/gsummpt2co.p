...
thf(agsummptf1o_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (cwnfc @ (^ [Xx3:$i] : (XH @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xy1) = (ccfv @ (XG @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_0 @ Xx3 @ Xy1) = (ccfv @ (XG @ Xx3 @ Xy1) @ cc0g)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XE @ Xy1)) => ((XC @ Xx3) = (XH @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XG @ Xx3 @ Xy1) @ cccmn)))) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwss @ (XF @ Xx3 @ Xy1) @ (XB2 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XC @ Xx3) @ (XF @ Xx3 @ Xy1))))) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XD)) => (cwcel @ (XE @ Xy1) @ XA2))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwreu @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XE @ Xy1))) @ (^ [Xy1:$i] : XD)))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((cco @ (XG @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ ccgsu) = (cco @ (XG @ Xx3 @ Xy1) @ (ccmpt @ (^ [Xy1:$i] : XD) @ (^ [Xy1:$i] : (XH @ Xx3 @ Xy1))) @ ccgsu)))))))))))))))))))))))))).
...
thf(aelcnv_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XA2 @ (cccnv @ XR)) <=> (? [Xx3:$i] : (? [Xy1:$i] : ((XA2 = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) & (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ XR)))))))).
...
thf(afuncnvcnv_ax,axiom,(! [XA2:($i > $o)] : ((cwfun @ XA2) => (cwfun @ (cccnv @ (cccnv @ XA2)))))).
...
thf(afcnvgreu_ax,axiom,(! [XA2:($i > $o)] : (! [XY:($i > $o)] : ((((cwrel @ XA2) & (cwfun @ (cccnv @ XA2))) & (cwcel @ XY @ (ccrn @ XA2))) => (cwreu @ (^ [Xp:$i] : (XY = (ccfv @ (ccv @ Xp) @ cc2nd))) @ (^ [Xp:$i] : XA2)))))).
...
thf(adfcnv2_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwss @ (ccrn @ XR) @ XA2) => ((cccnv @ XR) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (ccima @ (cccnv @ XR) @ (ccsn @ (ccv @ Xx3))))))))))).
thf(ccoprab_tp,type,(ccoprab : (($i > ($i > ($i > $o))) > ($i > $o)))).
thf(ampt2mptxf_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xz:$i] : (cwnfc @ (^ [Xx3:$i] : (XC @ Xx3 @ Xy1 @ Xz))))) => ((! [Xx3:$i] : (! [Xz:$i] : (cwnfc @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1 @ Xz))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xz) = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) => ((XC @ Xx3 @ Xy1 @ Xz) = (XD @ Xx3 @ Xy1)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((ccmpt @ (^ [Xz:$i] : (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (XB2 @ Xx3))))) @ (^ [Xz:$i] : (XC @ Xx3 @ Xy1 @ Xz))) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XA2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XB2 @ Xx3))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XD @ Xx3 @ Xy1))))))))))))))).
...
thf(agsum2d2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => (cwcel @ XG @ cccmn)) => ((! [Xk:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xk)))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ XA2)) => (cwcel @ (XC @ Xj) @ (XW @ Xj @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph & ((cwcel @ (ccv @ Xj) @ XA2) & (cwcel @ (ccv @ Xk) @ (XC @ Xj)))) => (cwcel @ (XX @ Xj @ Xk) @ XB2)))) => ((Xph => (cwcel @ XU @ ccfn)) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph & (((cwcel @ (ccv @ Xj) @ XA2) & (cwcel @ (ccv @ Xk) @ (XC @ Xj))) & (~ (cwbr @ (ccv @ Xj) @ (ccv @ Xk) @ XU)))) => ((XX @ Xj @ Xk) = Xc_0)))) => (Xph => ((cco @ XG @ (ccmpt2 @ (^ [Xj:$i] : (^ [Xk:$i] : XA2)) @ (^ [Xj:$i] : (^ [Xk:$i] : (XC @ Xj))) @ (^ [Xj:$i] : (^ [Xk:$i] : (XX @ Xj @ Xk)))) @ ccgsu) = (cco @ XG @ (ccmpt @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (cco @ XG @ (ccmpt @ (^ [Xk:$i] : (XC @ Xj)) @ (^ [Xk:$i] : (XX @ Xj @ Xk))) @ ccgsu))) @ ccgsu)))))))))))))))))))))).
...
thf(cgsummpt2co_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XW @ cccmn))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XA2 @ ccfn))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XE @ (XV @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((Xph @ Xy1) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XC @ Xx3) @ XB2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((Xph @ Xy1) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XD @ Xx3 @ Xy1) @ XE)))) => ((! [Xy1:$i] : (XF = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XD @ Xx3 @ Xy1))))) => (! [Xy1:$i] : ((Xph @ Xy1) => ((cco @ XW @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ ccgsu) = (cco @ XW @ (ccmpt @ (^ [Xy1:$i] : XE) @ (^ [Xy1:$i] : (cco @ XW @ (ccmpt @ (^ [Xx3:$i] : (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xy1)))) @ (^ [Xx3:$i] : (XC @ Xx3))) @ ccgsu))) @ ccgsu))))))))))))))))))))))).
