...
thf(apwundif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccpw @ (ccun @ XA2 @ XB2)) = (ccun @ (ccdif @ (ccpw @ (ccun @ XA2 @ XB2)) @ (ccpw @ XA2)) @ (ccpw @ XA2)))))).
...
thf(cpwfilem_b_conj,conjecture,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xc:$i] : ((XF @ Xx3 @ Xc) = (ccmpt @ (^ [Xc:$i] : (ccpw @ (ccv @ Xx3))) @ (^ [Xc:$i] : (ccun @ (ccv @ Xc) @ (ccsn @ (ccv @ Xx3)))))))) => (! [Xx3:$i] : ((cwcel @ (ccpw @ (ccv @ Xx3)) @ ccfn) => (cwcel @ (ccpw @ (ccun @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xx3)))) @ ccfn)))))).
