...
thf(cislinds_conj,conjecture,(! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((cwcel @ XW @ XV) => ((cwcel @ XX @ (ccfv @ XW @ cclinds)) <=> ((cwss @ XX @ XB2) & (cwbr @ (ccres @ ccid @ XX) @ XW @ cclindf)))))))))).
