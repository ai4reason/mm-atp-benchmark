...
thf(arestcls_ax,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XK = (cco @ XJ @ XY @ ccrest)) => ((cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XY @ XX) @ (cwss @ XS @ XY)) => ((ccfv @ XS @ (ccfv @ XK @ cccl)) = (ccin @ (ccfv @ XS @ (ccfv @ XJ @ cccl)) @ XY))))))))))).
...
thf(crestlp_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XK = (cco @ XJ @ XY @ ccrest)) => ((cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XY @ XX) @ (cwss @ XS @ XY)) => ((ccfv @ XS @ (ccfv @ XK @ cclp)) = (ccin @ (ccfv @ XS @ (ccfv @ XJ @ cclp)) @ XY))))))))))).
