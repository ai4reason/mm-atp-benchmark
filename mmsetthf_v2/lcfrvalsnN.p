...
thf(alkrss2N_ax,axiom,(! [Xph:$o] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XS = (ccfv @ XW @ ccsca)) => ((XR = (ccfv @ XS @ ccbs)) => ((XF = (ccfv @ XW @ cclfn)) => ((XK = (ccfv @ XW @ cclk)) => ((! [Xr:$i] : ((XD @ Xr) = (ccfv @ XW @ ccld))) => ((! [Xr:$i] : (Xc_x = (ccfv @ (XD @ Xr) @ ccvsca))) => ((Xph => (cwcel @ XW @ cclvec)) => ((Xph => (cwcel @ XG @ XF)) => ((Xph => (cwcel @ XH @ XF)) => (Xph => ((cwss @ (ccfv @ XG @ XK) @ (ccfv @ XH @ XK)) <=> (cwrex @ (^ [Xr:$i] : (XH = (cco @ (ccv @ Xr) @ XG @ Xc_x))) @ (^ [Xr:$i] : XR)))))))))))))))))))))))).
...
thf(clcfrvalsnN_conj,conjecture,(! [Xph:$o] : (! [XD:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [Xc_pe:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xf1:$i] : ((XH @ Xf1) = (ccfv @ (XK @ Xf1) @ cclh))) => ((! [Xf1:$i] : (Xc_pe = (ccfv @ (XW @ Xf1) @ (ccfv @ (XK @ Xf1) @ ccoch)))) => ((! [Xf1:$i] : ((XU @ Xf1) = (ccfv @ (XW @ Xf1) @ (ccfv @ (XK @ Xf1) @ ccdvh)))) => ((! [Xf1:$i] : ((XF @ Xf1) = (ccfv @ (XU @ Xf1) @ cclfn))) => ((! [Xf1:$i] : (XL = (ccfv @ (XU @ Xf1) @ cclk))) => ((! [Xf1:$i] : ((XD @ Xf1) = (ccfv @ (XU @ Xf1) @ ccld))) => ((! [Xf1:$i] : ((XN @ Xf1) = (ccfv @ (XD @ Xf1) @ cclspn))) => ((! [Xf1:$i] : (Xph => ((cwcel @ (XK @ Xf1) @ cchlt) & (cwcel @ (XW @ Xf1) @ (XH @ Xf1))))) => ((! [Xf1:$i] : (Xph => (cwcel @ XG @ (XF @ Xf1)))) => ((! [Xf1:$i] : ((XQ @ Xf1) = (cciun @ (^ [Xf1:$i] : XR) @ (^ [Xf1:$i] : (ccfv @ (ccfv @ (ccv @ Xf1) @ XL) @ Xc_pe))))) => ((! [Xf1:$i] : (XR = (ccfv @ (ccsn @ XG) @ (XN @ Xf1)))) => (! [Xf1:$i] : (Xph => ((XQ @ Xf1) = (ccfv @ (ccfv @ XG @ XL) @ Xc_pe))))))))))))))))))))))))))))).
