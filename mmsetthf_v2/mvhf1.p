...
thf(amvhval_ax,axiom,(! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XT @ ccmvar)) => ((XY = (ccfv @ XT @ ccmty)) => ((XH = (ccfv @ XT @ ccmvh)) => ((cwcel @ XX @ XV) => ((ccfv @ XX @ XH) = (ccop @ (ccfv @ XX @ XY) @ (ccs1 @ XX))))))))))))).
...
thf(cmvhf1_conj,conjecture,(! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XT @ ccmvar)) => ((XE = (ccfv @ XT @ ccmex)) => ((XH = (ccfv @ XT @ ccmvh)) => ((cwcel @ XT @ ccmfs) => (cwf1 @ XV @ XE @ XH)))))))))).
