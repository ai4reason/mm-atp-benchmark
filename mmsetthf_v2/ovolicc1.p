...
thf(covolicc1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((XG = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = cc1) @ (ccop @ XA2 @ XB2) @ (ccop @ ccc0 @ ccc0))))) => (Xph => (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccicc) @ ccovol) @ (cco @ XB2 @ XA2 @ ccmin) @ ccle))))))))))).
