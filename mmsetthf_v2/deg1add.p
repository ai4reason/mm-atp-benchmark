...
thf(adeg1lt_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XA2 = (ccfv @ XF @ ccco1)) => ((cw3a @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ ccn0) @ (cwbr @ (ccfv @ XF @ XD) @ XG @ cclt)) => ((ccfv @ XG @ XA2) = Xc_0)))))))))))))))).
