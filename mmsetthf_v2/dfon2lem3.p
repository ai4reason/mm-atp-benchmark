...
thf(adfon2lem2_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (cwss @ (ccuni @ (ccab @ (^ [Xx3:$i] : (cw3a @ (cwss @ (ccv @ Xx3) @ XA2) @ (Xph @ Xx3) @ (Xps @ Xx3))))) @ XA2))))).
...
thf(adfon2lem1_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (cwtr @ (ccuni @ (ccab @ (^ [Xx3:$i] : (cw3a @ (Xph @ Xx3) @ (cwtr @ (ccv @ Xx3)) @ (Xps @ Xx3))))))))).
...
thf(auntuni_ax,axiom,(! [XA2:($i > $o)] : ((cwral @ (^ [Xx3:$i] : (~ (cwcel @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccuni @ XA2))) <=> (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (~ (cwcel @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))))).
thf(cwnfc_tp,type,(cwnfc : (($i > ($i > $o)) > $o))).
thf(auntsucf_ax,axiom,(! [XA2:($i > ($i > $o))] : ((cwnfc @ (^ [Xy1:$i] : (XA2 @ Xy1))) => (! [Xy1:$i] : ((cwral @ (^ [Xx3:$i] : (~ (cwcel @ (ccv @ Xx3) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (XA2 @ Xy1))) => (cwral @ (^ [Xy1:$i] : (~ (cwcel @ (ccv @ Xy1) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccsuc @ (XA2 @ Xy1))))))))).
...
thf(anfsuc_ax,axiom,(! [XA2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (cwnfc @ (^ [Xx3:$i] : (ccsuc @ (XA2 @ Xx3))))))).
thf(acbvabv_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => ((ccab @ (^ [Xx3:$i] : (Xph @ Xx3))) = (ccab @ (^ [Xy1:$i] : (Xps @ Xy1)))))))).
thf(asucexg_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwcel @ (ccsuc @ XA2) @ ccvv))))).
...
thf(cdfon2lem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xz:$i] : ((cwcel @ XA2 @ (XV @ Xx3 @ Xz)) => ((! [Xx3:$i] : (((cwpss @ (ccv @ Xx3) @ XA2) & (cwtr @ (ccv @ Xx3))) => (cwcel @ (ccv @ Xx3) @ XA2))) => ((cwtr @ XA2) & (cwral @ (^ [Xz:$i] : (~ (cwcel @ (ccv @ Xz) @ (ccv @ Xz)))) @ (^ [Xz:$i] : XA2)))))))))).
