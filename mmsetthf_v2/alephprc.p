...
thf(acardprc_ax,axiom,(cwnel @ (ccab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cccrd) = (ccv @ Xx3)))) @ ccvv)).
thf(aeleq1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwcel @ XA2 @ XC) <=> (cwcel @ XB2 @ XC))))))).
thf(acardnum_ax,axiom,((ccab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cccrd) = (ccv @ Xx3)))) = (ccun @ ccom @ (ccrn @ ccale)))).
