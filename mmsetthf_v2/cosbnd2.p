...
thf(acosbnd_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwbr @ (ccneg @ cc1) @ (ccfv @ XA2 @ cccos) @ ccle) & (cwbr @ (ccfv @ XA2 @ cccos) @ cc1 @ ccle))))).
...
thf(ccosbnd2_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwcel @ (ccfv @ XA2 @ cccos) @ (cco @ (ccneg @ cc1) @ cc1 @ ccicc))))).
