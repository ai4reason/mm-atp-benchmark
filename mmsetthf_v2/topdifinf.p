...
thf(atopdifinffin_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > ($i > $o))] : ((! [Xx3:$i] : ((XT @ Xx3) = (ccrab @ (^ [Xx3:$i] : ((~ (cwcel @ (ccdif @ XA2 @ (ccv @ Xx3)) @ ccfn)) | (((ccv @ Xx3) = cc0) | ((ccv @ Xx3) = XA2)))) @ (^ [Xx3:$i] : (ccpw @ XA2))))) => (! [Xx3:$i] : ((cwcel @ (XT @ Xx3) @ (ccfv @ XA2 @ cctopon)) => (cwcel @ XA2 @ ccfn))))))).
thf(aeqeltrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (cwcel @ XB2 @ XC)) => (Xph => (cwcel @ XA2 @ XC))))))))).
thf(atopdifinfindis_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > ($i > $o))] : ((! [Xx3:$i] : ((XT @ Xx3) = (ccrab @ (^ [Xx3:$i] : ((~ (cwcel @ (ccdif @ XA2 @ (ccv @ Xx3)) @ ccfn)) | (((ccv @ Xx3) = cc0) | ((ccv @ Xx3) = XA2)))) @ (^ [Xx3:$i] : (ccpw @ XA2))))) => (! [Xx3:$i] : ((cwcel @ XA2 @ ccfn) => ((XT @ Xx3) = (ccpr @ cc0 @ XA2)))))))).
