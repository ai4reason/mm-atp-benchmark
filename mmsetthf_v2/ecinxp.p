...
thf(aimainrect_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XY:($i > $o)] : ((ccima @ (ccin @ XG @ (ccxp @ XA2 @ XB2)) @ XY) = (ccin @ (ccima @ XG @ (ccin @ XY @ XA2)) @ XB2))))))).
thf(adf_ec_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((ccec @ XA2 @ XR) = (ccima @ XR @ (ccsn @ XA2)))))).
thf(cecinxp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (((cwss @ (ccima @ XR @ XA2) @ XA2) & (cwcel @ XB2 @ XA2)) => ((ccec @ XB2 @ XR) = (ccec @ XB2 @ (ccin @ XR @ (ccxp @ XA2 @ XA2))))))))).
