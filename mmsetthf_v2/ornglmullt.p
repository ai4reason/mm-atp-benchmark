...
thf(aornglmulle_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xph => (cwcel @ XR @ ccorng)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XZ @ XB2)) => ((Xc_le = (ccfv @ XR @ ccple)) => ((Xph => (cwbr @ XX @ XY @ Xc_le)) => ((Xph => (cwbr @ Xc_0 @ XZ @ Xc_le)) => (Xph => (cwbr @ (cco @ XZ @ XX @ Xc_x) @ (cco @ XZ @ XY @ Xc_x) @ Xc_le)))))))))))))))))))))).
...
thf(cornglmullt_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xph => (cwcel @ XR @ ccorng)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XZ @ XB2)) => ((Xc_lt = (ccfv @ XR @ ccplt)) => ((Xph => (cwcel @ XR @ ccdr)) => ((Xph => (cwbr @ XX @ XY @ Xc_lt)) => ((Xph => (cwbr @ Xc_0 @ XZ @ Xc_lt)) => (Xph => (cwbr @ (cco @ XZ @ XX @ Xc_x) @ (cco @ XZ @ XY @ Xc_x) @ Xc_lt))))))))))))))))))))))).
