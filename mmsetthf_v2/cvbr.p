...
thf(ccvbr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((cwbr @ XA2 @ XB2 @ cccv) <=> ((cwpss @ XA2 @ XB2) & (~ (cwrex @ (^ [Xx3:$i] : ((cwpss @ XA2 @ (ccv @ Xx3)) & (cwpss @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : ccch))))))))).
