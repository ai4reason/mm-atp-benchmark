...
thf(awlknewwlksn_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((((cwcel @ XG @ ccupgr) & (cwcel @ XW @ (ccfv @ XG @ ccwlks))) & ((cwcel @ XN @ ccn0) & ((ccfv @ (ccfv @ XW @ cc1st) @ cchash) = XN))) => (cwcel @ (ccfv @ XW @ cc2nd) @ (cco @ XN @ XG @ ccwwlksn))))))).
