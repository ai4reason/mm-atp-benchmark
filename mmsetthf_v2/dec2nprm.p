...
thf(anumlti_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XT @ ccn) => ((cwcel @ XA2 @ ccn) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwbr @ XC @ XT @ cclt) => (cwbr @ XC @ (cco @ (cco @ XT @ XA2 @ ccmul) @ XB2 @ ccaddc) @ cclt))))))))))).
...
thf(cdec2nprm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn) => ((cwcel @ XB2 @ ccn0) => (((cco @ XB2 @ cc2 @ ccmul) = XC) => (~ (cwcel @ (ccdc @ XA2 @ XC) @ ccprime))))))))).
