...
thf(adf_clm_ax,axiom,(ccclm = (ccrab @ (^ [Xw:$i] : (cwsbc @ (^ [Xf1:$i] : (cwsbc @ (^ [Xk:$i] : (((ccv @ Xf1) = (cco @ cccnfld @ (ccv @ Xk) @ ccress)) & (cwcel @ (ccv @ Xk) @ (ccfv @ cccnfld @ ccsubrg)))) @ (ccfv @ (ccv @ Xf1) @ ccbs))) @ (ccfv @ (ccv @ Xw) @ ccsca))) @ (^ [Xw:$i] : cclmod)))).
thf(a_3anass_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) <=> (Xph & (Xps & Xch))))))).
thf(cisclm_conj,conjecture,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((cwcel @ XW @ ccclm) <=> (cw3a @ (cwcel @ XW @ cclmod) @ (XF = (cco @ cccnfld @ XK @ ccress)) @ (cwcel @ XK @ (ccfv @ cccnfld @ ccsubrg)))))))))).
