...
thf(cgrpvlinv_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((XN = (ccfv @ XG @ ccminusg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XX @ (cco @ XB2 @ XI @ ccmap))) => ((cco @ (cccom @ XN @ XX) @ XX @ (ccof @ Xc_pl)) = (ccxp @ XI @ (ccsn @ Xc_0)))))))))))))))).
