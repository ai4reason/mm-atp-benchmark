...
thf(aprlem936_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccnp) & (cwbr @ cc1q @ XB2 @ ccltq)) => (cwrex @ (^ [Xx3:$i] : (~ (cwcel @ (cco @ (ccv @ Xx3) @ XB2 @ ccmq) @ XA2))) @ (^ [Xx3:$i] : XA2)))))).
...
thf(creclem3pr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccab @ (^ [Xx3:$i] : (? [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccltq) & (~ (cwcel @ (ccfv @ (ccv @ Xy1) @ ccrq) @ XA2)))))))) => (! [Xy1:$i] : ((cwcel @ XA2 @ ccnp) => (cwss @ cc1p @ (cco @ XA2 @ (XB2 @ Xy1) @ ccmp)))))))).
