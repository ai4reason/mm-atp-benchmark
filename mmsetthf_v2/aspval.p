...
thf(caspval_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xt:$i] : ((XA2 @ Xt) = (ccfv @ XW @ ccasp))) => ((XV = (ccfv @ XW @ ccbs)) => ((XL = (ccfv @ XW @ cclss)) => (! [Xt:$i] : (((cwcel @ XW @ ccasa) & (cwss @ XS @ XV)) => ((ccfv @ XS @ (XA2 @ Xt)) = (ccint @ (ccrab @ (^ [Xt:$i] : (cwss @ XS @ (ccv @ Xt))) @ (^ [Xt:$i] : (ccin @ (ccfv @ XW @ ccsubrg) @ XL)))))))))))))))).
