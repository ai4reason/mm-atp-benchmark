...
thf(addeval0_ax,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccr) & (~ (cwcel @ ccc0 @ XA2))) => ((ccfv @ XA2 @ ccdde) = ccc0)))).
...
thf(arabsnel_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => (((ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) = (ccsn @ XB2)) => (cwcel @ XB2 @ XA2))))))).
thf(avex_ax,axiom,(! [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ ccvv))).
thf(arabsnt_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : (((ccv @ Xx3) = XB2) => ((Xph @ Xx3) <=> Xps))) => (((ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) = (ccsn @ XB2)) => Xps)))))))).
...
thf(addeval1_ax,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccr) & (cwcel @ ccc0 @ XA2)) => ((ccfv @ XA2 @ ccdde) = cc1)))).
...
thf(cddemeas_conj,conjecture,(cwcel @ ccdde @ (ccfv @ (ccpw @ ccr) @ ccmeas))).
