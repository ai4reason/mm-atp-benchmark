...
thf(cbnj970_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xm:$i] : (! [XX:($i > ($i > ($i > $o)))] : (! [Xp:$i] : ((! [Xf1:$i] : (! [Xn:$i] : ((Xch @ Xf1 @ Xn) <=> (cw_bnj17 @ (cwcel @ (ccv @ Xn) @ (XD @ Xf1 @ Xn)) @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) @ (Xph @ Xf1 @ Xn) @ (Xps @ Xf1 @ Xn))))) => ((! [Xf1:$i] : (! [Xn:$i] : ((XD @ Xf1 @ Xn) = (ccdif @ ccom @ (ccsn @ cc0))))) => (! [Xf1:$i] : (! [Xn:$i] : ((((cw_bnj15 @ (XA2 @ Xf1 @ Xn) @ (XR @ Xf1 @ Xn)) & (cwcel @ (XX @ Xf1 @ Xn) @ (XA2 @ Xf1 @ Xn))) & (cw3a @ (Xch @ Xf1 @ Xn) @ ((ccv @ Xn) = (ccsuc @ (ccv @ Xm))) @ ((ccv @ Xp) = (ccsuc @ (ccv @ Xn))))) => (cwcel @ (ccv @ Xp) @ (XD @ Xf1 @ Xn))))))))))))))))).
