...
thf(aitg1ge0a_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XF @ (ccdm @ ccitg1))) => ((Xph => (cwss @ XA2 @ ccr)) => ((Xph => ((ccfv @ XA2 @ ccovol) = ccc0)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ ccr @ XA2))) => (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ XF) @ ccle))) => (Xph => (cwbr @ ccc0 @ (ccfv @ XF @ ccitg1) @ ccle)))))))))).
...
thf(aitg1sub_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (ccdm @ ccitg1)) & (cwcel @ XG @ (ccdm @ ccitg1))) => ((ccfv @ (cco @ XF @ XG @ (ccof @ ccmin)) @ ccitg1) = (cco @ (ccfv @ XF @ ccitg1) @ (ccfv @ XG @ ccitg1) @ ccmin)))))).
thf(aitg1cl_ax,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ ccitg1)) => (cwcel @ (ccfv @ XF @ ccitg1) @ ccr)))).
thf(citg1lea_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ (ccdm @ ccitg1))) => ((Xph => (cwss @ XA2 @ ccr)) => ((Xph => ((ccfv @ XA2 @ ccovol) = ccc0)) => ((Xph => (cwcel @ XG @ (ccdm @ ccitg1))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ ccr @ XA2))) => (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG) @ ccle))) => (Xph => (cwbr @ (ccfv @ XF @ ccitg1) @ (ccfv @ XG @ ccitg1) @ ccle)))))))))))).
