...
thf(abitsinv_ax,axiom,(! [XA2:($i > $o)] : (! [XK:($i > ($i > $o))] : ((! [Xk:$i] : ((XK @ Xk) = (cccnv @ (ccres @ ccbits @ ccn0)))) => (! [Xk:$i] : ((cwcel @ XA2 @ (ccin @ (ccpw @ ccn0) @ ccfn)) => ((ccfv @ XA2 @ (XK @ Xk)) = (ccsu @ XA2 @ (^ [Xk:$i] : (cco @ cc2 @ (ccv @ Xk) @ ccexp)))))))))).
...
thf(cbitsinvp1_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XK = (cccnv @ (ccres @ ccbits @ ccn0))) => (((cwss @ XA2 @ ccn0) & (cwcel @ XN @ ccn0)) => ((ccfv @ (ccin @ XA2 @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccaddc) @ ccfzo)) @ XK) = (cco @ (ccfv @ (ccin @ XA2 @ (cco @ ccc0 @ XN @ ccfzo)) @ XK) @ (ccif @ (cwcel @ XN @ XA2) @ (cco @ cc2 @ XN @ ccexp) @ ccc0) @ ccaddc)))))))).
