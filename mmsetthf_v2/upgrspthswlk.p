...
thf(aspthsfval_ax,axiom,(! [XG:($i > $o)] : ((ccfv @ XG @ ccspths) = (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : ((cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ cctrls)) & (cwfun @ (cccnv @ (ccv @ Xp)))))))))).
...
thf(aupgrwlkdvde_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cw3a @ (cwcel @ XG @ ccupgr) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) @ (cwfun @ (cccnv @ XP))) => (cwfun @ (cccnv @ XF))))))).
thf(aistrl_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwbr @ XF @ XP @ (ccfv @ XG @ cctrls)) <=> ((cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) & (cwfun @ (cccnv @ XF)))))))).
thf(cupgrspthswlk_conj,conjecture,(! [XG:($i > $o)] : ((cwcel @ XG @ ccupgr) => ((ccfv @ XG @ ccspths) = (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : ((cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ ccwlks)) & (cwfun @ (cccnv @ (ccv @ Xp))))))))))).
