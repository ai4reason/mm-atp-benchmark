...
thf(cwwlknbp_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) => (cw3a @ (cwcel @ XG @ ccvv) @ (cwcel @ XN @ ccn0) @ (cwcel @ XW @ (ccword @ XV)))))))))).
