...
thf(advcof_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwcel @ XT @ (ccpr @ ccr @ ccc))) => ((Xph => (cwf @ XX @ ccc @ XF)) => ((Xph => (cwf @ XY @ XX @ XG)) => ((Xph => ((ccdm @ (cco @ XS @ XF @ ccdv)) = XX)) => ((Xph => ((ccdm @ (cco @ XT @ XG @ ccdv)) = XY)) => (Xph => ((cco @ XT @ (cccom @ XF @ XG) @ ccdv) = (cco @ (cccom @ (cco @ XS @ XF @ ccdv) @ XG) @ (cco @ XT @ XG @ ccdv) @ (ccof @ ccmul)))))))))))))))))).
...
thf(aoffval3_ax,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XF @ XV) & (cwcel @ XG @ XW)) => ((cco @ XF @ XG @ (ccof @ XR)) = (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccdm @ XF) @ (ccdm @ XG))) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG) @ XR))))))))))).
...
thf(advcmulf_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwf @ XX @ ccc @ XF)) => ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => ((ccdm @ (cco @ XS @ XF @ ccdv)) = XX)) => (Xph => ((cco @ XS @ (cco @ (ccxp @ XS @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul)) @ ccdv) = (cco @ (ccxp @ XS @ (ccsn @ XA2)) @ (cco @ XS @ XF @ ccdv) @ (ccof @ ccmul)))))))))))))).
