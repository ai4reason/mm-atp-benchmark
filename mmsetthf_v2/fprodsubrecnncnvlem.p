...
thf(afprodsub2cncf_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XA2 @ ccfn))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccc))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XF @ Xx3 @ Xk) = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (cco @ (XB2 @ Xk) @ (ccv @ Xx3) @ ccmin)))))))) => (! [Xx3:$i] : (! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XF @ Xx3 @ Xk) @ (cco @ ccc @ ccc @ cccncf)))))))))))))).
