...
thf(a_0mhm_ax,axiom,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XN @ cc0g)) => ((XB2 = (ccfv @ XM @ ccbs)) => (((cwcel @ XM @ ccmnd) & (cwcel @ XN @ ccmnd)) => (cwcel @ (ccxp @ XB2 @ (ccsn @ Xc_0)) @ (cco @ XM @ XN @ ccmhm)))))))))).
