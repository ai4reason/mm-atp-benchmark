...
thf(amp3anr3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (Xth => (((Xph & (cw3a @ Xps @ Xch @ Xth)) => Xta) => ((Xph & (Xps & Xch)) => Xta))))))))).
thf(aneg1rr_ax,axiom,(cwcel @ (ccneg @ cc1) @ ccr)).
thf(arelogbmulexp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (((cwcel @ XB2 @ (ccdif @ ccc @ (ccpr @ ccc0 @ cc1))) & (cw3a @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XC @ ccrp) @ (cwcel @ XE @ ccr))) => ((cco @ XB2 @ (cco @ XA2 @ (cco @ XC @ XE @ cccxp) @ ccmul) @ cclogb) = (cco @ (cco @ XB2 @ XA2 @ cclogb) @ (cco @ XE @ (cco @ XB2 @ XC @ cclogb) @ ccmul) @ ccaddc)))))))).
...
thf(alogbcl_ax,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XB2 @ (ccdif @ ccc @ (ccpr @ ccc0 @ cc1))) & (cwcel @ XX @ (ccdif @ ccc @ (ccsn @ ccc0)))) => (cwcel @ (cco @ XB2 @ XX @ cclogb) @ ccc))))).
