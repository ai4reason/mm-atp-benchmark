...
thf(a_0ov_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cco @ XA2 @ XB2 @ cc0) = cc0)))).
...
thf(awwlksnon_ax,axiom,(! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xw:$i] : ((XV @ Xw) = (ccfv @ XG @ ccvtx))) => (! [Xw:$i] : (! [Xa:$i] : (! [Xb:$i] : (((cwcel @ XN @ ccn0) & (cwcel @ XG @ (XU @ Xw @ Xa @ Xb))) => ((cco @ XN @ XG @ ccwwlksnon) = (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (XV @ Xw))) @ (^ [Xa:$i] : (^ [Xb:$i] : (XV @ Xw))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccrab @ (^ [Xw:$i] : (((ccfv @ ccc0 @ (ccv @ Xw)) = (ccv @ Xa)) & ((ccfv @ XN @ (ccv @ Xw)) = (ccv @ Xb)))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))))))))))))))))).
...
thf(acon3rr3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps => Xch)) => ((~ Xch) => (Xph => (~ Xps)))))))).
thf(asyl5ibrcom_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xth) => ((Xch => (Xps <=> Xth)) => (Xph => (Xch => Xps))))))))).
thf(ccfz_tp,type,(ccfz : ($i > $o))).
thf(ccword_tp,type,(ccword : (($i > $o) > ($i > $o)))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(awwlknllvtx_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) => ((cwcel @ (ccfv @ ccc0 @ XW) @ XV) & (cwcel @ (ccfv @ XN @ XW) @ XV))))))))).
...
thf(ciswwlksnon_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cco @ XA2 @ XB2 @ (cco @ XN @ XG @ ccwwlksnon)) = (ccrab @ (^ [Xw:$i] : (((ccfv @ ccc0 @ (ccv @ Xw)) = XA2) & ((ccfv @ XN @ (ccv @ Xw)) = XB2))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))))))))))).
