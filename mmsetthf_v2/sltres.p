...
thf(asltintdifex_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccsur) & (cwcel @ XB2 @ ccsur)) => ((cwbr @ XA2 @ XB2 @ ccslt) => (cwcel @ (ccint @ (ccrab @ (^ [Xa:$i] : (cwne @ (ccfv @ (ccv @ Xa) @ XA2) @ (ccfv @ (ccv @ Xa) @ XB2))) @ (^ [Xa:$i] : ccon0))) @ ccvv)))))).
...
thf(afvresval_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((ccfv @ XA2 @ (ccres @ XF @ XB2)) = (ccfv @ XA2 @ XF)) | ((ccfv @ XA2 @ (ccres @ XF @ XB2)) = cc0)))))).
...
thf(csltres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccsur) @ (cwcel @ XB2 @ ccsur) @ (cwcel @ XX @ ccon0)) => ((cwbr @ (ccres @ XA2 @ XX) @ (ccres @ XB2 @ XX) @ ccslt) => (cwbr @ XA2 @ XB2 @ ccslt))))))).
