...
thf(aefopnlem2_ax,axiom,(! [XR:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => (((cwcel @ XR @ ccrp) & (cwbr @ XR @ ccpi @ cclt)) => (cwcel @ (ccima @ cce @ (cco @ ccc0 @ XR @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl))) @ XJ)))))).
...
thf(cefopn_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((cwcel @ XS @ XJ) => (cwcel @ (ccima @ cce @ XS) @ XJ)))))).
