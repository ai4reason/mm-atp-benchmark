...
thf(cdvmptconst_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwcel @ XA2 @ (cco @ (ccfv @ cccnfld @ cctopn) @ XS @ ccrest))) => ((Xph => (cwcel @ XB2 @ ccc)) => (Xph => ((cco @ XS @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2)) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : ccc0)))))))))))).
