...
thf(amulpqnq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccnq) & (cwcel @ XB2 @ ccnq)) => ((cco @ XA2 @ XB2 @ ccmq) = (ccfv @ (cco @ XA2 @ XB2 @ ccmpq) @ ccerq)))))).
...
thf(aenqer_ax,axiom,(cwer @ (ccxp @ ccnpi @ ccnpi) @ cceq)).
thf(aadantr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph & Xch) => Xps)))))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(cwf_tp,type,(cwf : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(anqerrel_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccxp @ ccnpi @ ccnpi)) => (cwbr @ XA2 @ (ccfv @ XA2 @ ccerq) @ cceq)))).
...
thf(amulerpqlem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccxp @ ccnpi @ ccnpi)) @ (cwcel @ XB2 @ (ccxp @ ccnpi @ ccnpi)) @ (cwcel @ XC @ (ccxp @ ccnpi @ ccnpi))) => ((cwbr @ XA2 @ XB2 @ cceq) <=> (cwbr @ (cco @ XA2 @ XC @ ccmpq) @ (cco @ XB2 @ XC @ ccmpq) @ cceq))))))).
...
thf(amulcompq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cco @ XA2 @ XB2 @ ccmpq) = (cco @ XB2 @ XA2 @ ccmpq))))).
...
thf(amulpqf_ax,axiom,(cwf @ (ccxp @ (ccxp @ ccnpi @ ccnpi) @ (ccxp @ ccnpi @ ccnpi)) @ (ccxp @ ccnpi @ ccnpi) @ ccmpq)).
...
thf(anqerf_ax,axiom,(cwf @ (ccxp @ ccnpi @ ccnpi) @ ccnq @ ccerq)).
...
thf(cmulerpq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cco @ (ccfv @ XA2 @ ccerq) @ (ccfv @ XB2 @ ccerq) @ ccmq) = (ccfv @ (cco @ XA2 @ XB2 @ ccmpq) @ ccerq))))).
