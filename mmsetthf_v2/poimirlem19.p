...
thf(adff1o3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf1o @ XA2 @ XB2 @ XF) <=> ((cwfo @ XA2 @ XB2 @ XF) & (cwfun @ (cccnv @ XF)))))))).
thf(aimain_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwfun @ (cccnv @ XF)) => ((ccima @ XF @ (ccin @ XA2 @ XB2)) = (ccin @ (ccima @ XF @ XA2) @ (ccima @ XF @ XB2)))))))).
...
thf(afzaddel_ax,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) & ((cwcel @ XJ @ ccz) & (cwcel @ XK @ ccz))) => ((cwcel @ XJ @ (cco @ XM @ XN @ ccfz)) <=> (cwcel @ (cco @ XJ @ XK @ ccaddc) @ (cco @ (cco @ XM @ XK @ ccaddc) @ (cco @ XN @ XK @ ccaddc) @ ccfz))))))))).
...
thf(af1osng_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => (cwf1o @ (ccsn @ XA2) @ (ccsn @ XB2) @ (ccsn @ (ccop @ XA2 @ XB2))))))))).
...
thf(azrei_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccz) => (cwcel @ XA2 @ ccr)))).
...
thf(afmptapd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccvv)) => ((Xph => (cwcel @ XB2 @ ccvv)) => ((Xph => ((ccun @ XR @ (ccsn @ XA2)) = XS)) => ((! [Xx3:$i] : ((Xph & ((ccv @ Xx3) = XA2)) => ((XC @ Xx3) = XB2))) => (Xph => ((ccun @ (ccmpt @ (^ [Xx3:$i] : XR) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (ccsn @ (ccop @ XA2 @ XB2))) = (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (XC @ Xx3)))))))))))))))).
thf(assv_ax,axiom,(! [XA2:($i > $o)] : (cwss @ XA2 @ ccvv))).
thf(asyl6req_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((XB2 = XC) => (Xph => (XC = XA2))))))))).
thf(afzpred_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ XM @ ccuz)) => ((cco @ XM @ XN @ ccfz) = (ccun @ (ccsn @ XM) @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XN @ ccfz))))))).
...
thf(axpundir_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccxp @ (ccun @ XA2 @ XB2) @ XC) = (ccun @ (ccxp @ XA2 @ XC) @ (ccxp @ XB2 @ XC))))))).
...
thf(adffn5f_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => (! [Xx3:$i] : ((cwfn @ (XF @ Xx3) @ XA2) <=> ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (XF @ Xx3))))))))))).
thf(anfun_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => (cwnfc @ (^ [Xx3:$i] : (ccun @ (XA2 @ Xx3) @ (XB2 @ Xx3))))))))).
thf(anfxp_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => (cwnfc @ (^ [Xx3:$i] : (ccxp @ (XA2 @ Xx3) @ (XB2 @ Xx3))))))))).
thf(anfima_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => (cwnfc @ (^ [Xx3:$i] : (ccima @ (XA2 @ Xx3) @ (XB2 @ Xx3))))))))).
...
thf(cpoimirlem19_conj,conjecture,(! [Xph:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XN @ ccn))) => ((! [Xy1:$i] : (! [Xf1:$i] : ((XS @ Xf1) = (ccrab @ (^ [Xt:$i] : (XF = (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xy1:$i] : (ccsb @ (ccif @ (cwbr @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xt) @ cc2nd) @ cclt) @ (ccv @ Xy1) @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (^ [Xj:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xt) @ cc1st) @ cc1st) @ (ccun @ (ccxp @ (ccima @ (ccfv @ (ccfv @ (ccv @ Xt) @ cc1st) @ cc2nd) @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (ccfv @ (ccfv @ (ccv @ Xt) @ cc1st) @ cc2nd) @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc)))))))) @ (^ [Xt:$i] : (ccxp @ (ccxp @ (cco @ (cco @ ccc0 @ (XK @ Xy1) @ ccfzo) @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ (ccab @ (^ [Xf1:$i] : (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))) @ (cco @ ccc0 @ XN @ ccfz))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => (cwf @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (cco @ (cco @ ccc0 @ (XK @ Xy1) @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ XF)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XT @ (XS @ Xf1)))) => ((! [Xf1:$i] : (! [Xn:$i] : (((Xph @ Xf1) & (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz))) => (cwrex @ (^ [Xp:$i] : (cwne @ (ccfv @ (ccv @ Xn) @ (ccv @ Xp)) @ ccc0)) @ (^ [Xp:$i] : (ccrn @ XF)))))) => ((! [Xf1:$i] : ((Xph @ Xf1) => ((ccfv @ XT @ cc2nd) = XN))) => (! [Xf1:$i] : ((Xph @ Xf1) => (XF = (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ (^ [Xy1:$i] : (cco @ (ccmpt @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccfv @ XT @ cc1st) @ cc1st)) @ (ccif @ ((ccv @ Xn) = (ccfv @ XN @ (ccfv @ (ccfv @ XT @ cc1st) @ cc2nd))) @ cc1 @ ccc0) @ ccmin))) @ (ccun @ (ccxp @ (ccima @ (cccom @ (ccfv @ (ccfv @ XT @ cc1st) @ cc2nd) @ (ccmpt @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = cc1) @ XN @ (cco @ (ccv @ Xn) @ cc1 @ ccmin))))) @ (cco @ cc1 @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (cccom @ (ccfv @ (ccfv @ XT @ cc1st) @ cc2nd) @ (ccmpt @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = cc1) @ XN @ (cco @ (ccv @ Xn) @ cc1 @ ccmin))))) @ (cco @ (cco @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc)))))))))))))))))))).
