...
thf(aswrdccatin12lem2a_ax,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XM @ (cco @ ccc0 @ XL @ ccfz)) & (cwcel @ XN @ (cco @ XL @ XX @ ccfz))) => (((cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfzo)) & (~ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XL @ XM @ ccmin) @ ccfzo)))) => (cwcel @ (cco @ XK @ XM @ ccaddc) @ (cco @ XL @ XX @ ccfzo)))))))))).
...
thf(alesubadd2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) => ((cwbr @ (cco @ XA2 @ XB2 @ ccmin) @ XC @ ccle) <=> (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ ccle))))))).
thf(aswrdccatin12lem2b_ax,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XM @ (cco @ ccc0 @ XL @ ccfz)) & (cwcel @ XN @ (cco @ XL @ XX @ ccfz))) => (((cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfzo)) & (~ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XL @ XM @ ccmin) @ ccfzo)))) => (cwcel @ (cco @ XK @ (cco @ XL @ XM @ ccmin) @ ccmin) @ (cco @ ccc0 @ (cco @ (cco @ XN @ XL @ ccmin) @ ccc0 @ ccmin) @ ccfzo)))))))))).
