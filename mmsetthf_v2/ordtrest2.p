...
thf(aordtrest_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XR @ ccps) & (cwcel @ XA2 @ XV)) => (cwss @ (ccfv @ (ccin @ XR @ (ccxp @ XA2 @ XA2)) @ ccordt) @ (cco @ (ccfv @ XR @ ccordt) @ XA2 @ ccrest))))))).
...
thf(atgrest_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XB2 @ XV) & (cwcel @ XA2 @ XW)) => ((ccfv @ (cco @ XB2 @ XA2 @ ccrest) @ cctg) = (cco @ (ccfv @ XB2 @ cctg) @ XA2 @ ccrest)))))))).
...
thf(afirest_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : ((ccfv @ (cco @ XJ @ XA2 @ ccrest) @ ccfi) = (cco @ (ccfv @ XJ @ ccfi) @ XA2 @ ccrest))))).
thf(ainex1g_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwcel @ (ccin @ XA2 @ XB2) @ ccvv)))))).
thf(aordttop_ax,axiom,(! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XR @ XV) => (cwcel @ (ccfv @ XR @ ccordt) @ cctop))))).
...
thf(aordttopon_ax,axiom,(! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XR)) => ((cwcel @ XR @ XV) => (cwcel @ (ccfv @ XR @ ccordt) @ (ccfv @ XX @ cctopon)))))))).
thf(afveq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))))).
thf(apsssdm_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XR)) => (((cwcel @ XR @ ccps) & (cwss @ XA2 @ XX)) => ((ccdm @ (ccin @ XR @ (ccxp @ XA2 @ XA2))) = XA2))))))).
...
thf(aordtrest2lem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XR)) => ((Xph => (cwcel @ XR @ cctsr)) => ((Xph => (cwss @ XA2 @ XX)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XA2))) => (cwss @ (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ XR) & (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ XR))) @ (^ [Xz:$i] : XX)) @ XA2)))) => (Xph => (cwral @ (^ [Xv:$i] : (cwcel @ (ccin @ (ccv @ Xv) @ XA2) @ (ccfv @ (ccin @ XR @ (ccxp @ XA2 @ XA2)) @ ccordt))) @ (^ [Xv:$i] : (ccrn @ (ccmpt @ (^ [Xz:$i] : XX) @ (^ [Xz:$i] : (ccrab @ (^ [Xw:$i] : (~ (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ XR))) @ (^ [Xw:$i] : XX))))))))))))))))).
thf(ampbird_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xch) => ((Xph => (Xps <=> Xch)) => (Xph => Xps))))))).
thf(adf_rn_ax,axiom,(! [XA2:($i > $o)] : ((ccrn @ XA2) = (ccdm @ (cccnv @ XA2))))).
thf(acnvtsr_ax,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ cctsr) => (cwcel @ (cccnv @ XR) @ cctsr)))).
thf(asseqtrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwss @ XA2 @ XB2)) => ((Xph => (XB2 = XC)) => (Xph => (cwss @ XA2 @ XC))))))))).
thf(apsrn_ax,axiom,(! [XR:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XR)) => ((cwcel @ XR @ ccps) => (XX = (ccrn @ XR))))))).
...
thf(apsss_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XR @ ccps) => (cwcel @ (ccin @ XR @ (ccxp @ XA2 @ XA2)) @ ccps))))).
thf(aordtcnv_ax,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccps) => ((ccfv @ (cccnv @ XR) @ ccordt) = (ccfv @ XR @ ccordt))))).
...
thf(cordtrest2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XR)) => ((Xph => (cwcel @ XR @ cctsr)) => ((Xph => (cwss @ XA2 @ XX)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XA2))) => (cwss @ (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ XR) & (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ XR))) @ (^ [Xz:$i] : XX)) @ XA2)))) => (Xph => ((ccfv @ (ccin @ XR @ (ccxp @ XA2 @ XA2)) @ ccordt) = (cco @ (ccfv @ XR @ ccordt) @ XA2 @ ccrest)))))))))))).
