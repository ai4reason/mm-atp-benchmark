...
thf(aaxdc4uzlem_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XM:($i > $o)] : (! [XZ:($i > ($i > ($i > $o)))] : ((cwcel @ XM @ ccz) => ((! [Xy1:$i] : (! [Xk:$i] : ((XZ @ Xy1 @ Xk) = (ccfv @ XM @ ccuz)))) => ((! [Xy1:$i] : (cwcel @ (XA2 @ Xy1) @ ccvv)) => ((! [Xy1:$i] : ((XG @ Xy1) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xy1:$i] : ccvv) @ (^ [Xy1:$i] : (cco @ (ccv @ Xy1) @ cc1 @ ccaddc))) @ XM) @ ccom))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xg1:$i] : (! [Xn:$i] : ((XH @ Xx3 @ Xy1 @ Xg1 @ Xn) = (ccmpt2 @ (^ [Xn:$i] : (^ [Xx3:$i] : ccom)) @ (^ [Xn:$i] : (^ [Xx3:$i] : (XA2 @ Xy1))) @ (^ [Xn:$i] : (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xn) @ (XG @ Xy1)) @ (ccv @ Xx3) @ (XF @ Xy1)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : (((cwcel @ (XC @ Xx3 @ Xy1 @ Xk @ Xn) @ (XA2 @ Xy1)) & (cwf @ (ccxp @ (XZ @ Xy1 @ Xk) @ (XA2 @ Xy1)) @ (ccdif @ (ccpw @ (XA2 @ Xy1)) @ (ccsn @ cc0)) @ (XF @ Xy1))) => (? [Xg1:$i] : (cw3a @ (cwf @ (XZ @ Xy1 @ Xk) @ (XA2 @ Xy1) @ (ccv @ Xg1)) @ ((ccfv @ XM @ (ccv @ Xg1)) = (XC @ Xx3 @ Xy1 @ Xk @ Xn)) @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (ccv @ Xg1)) @ (cco @ (ccv @ Xk) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xg1)) @ (XF @ Xy1)))) @ (^ [Xk:$i] : (XZ @ Xy1 @ Xk))))))))))))))))))))))).
thf(avex_ax,axiom,(! [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ ccvv))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(caxdc4uz_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > $o))] : ((cwcel @ XM @ ccz) => ((! [Xk:$i] : ((XZ @ Xk) = (ccfv @ XM @ ccuz))) => (! [Xg1:$i] : (! [Xk:$i] : ((cw3a @ (cwcel @ XA2 @ (XV @ Xg1 @ Xk)) @ (cwcel @ (XC @ Xk) @ XA2) @ (cwf @ (ccxp @ (XZ @ Xk) @ XA2) @ (ccdif @ (ccpw @ XA2) @ (ccsn @ cc0)) @ XF)) => (? [Xg1:$i] : (cw3a @ (cwf @ (XZ @ Xk) @ XA2 @ (ccv @ Xg1)) @ ((ccfv @ XM @ (ccv @ Xg1)) = (XC @ Xk)) @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (ccv @ Xg1)) @ (cco @ (ccv @ Xk) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xg1)) @ XF))) @ (^ [Xk:$i] : (XZ @ Xk))))))))))))))))).
