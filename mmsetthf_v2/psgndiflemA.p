...
thf(apsgnuni_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XD @ ccsymg)) => ((XT = (ccrn @ (ccfv @ XD @ ccpmtr))) => ((Xph => (cwcel @ XD @ XV)) => ((Xph => (cwcel @ XW @ (ccword @ XT))) => ((Xph => (cwcel @ XX @ (ccword @ XT))) => ((Xph => ((cco @ XG @ XW @ ccgsu) = (cco @ XG @ XX @ ccgsu))) => (Xph => ((cco @ (ccneg @ cc1) @ (ccfv @ XW @ cchash) @ ccexp) = (cco @ (ccneg @ cc1) @ (ccfv @ XX @ cchash) @ ccexp))))))))))))))))).
...
thf(apsgndiflemB_ax,axiom,(! [XP:($i > ($i > ($i > $o)))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xi:$i] : (! [Xn:$i] : (! [Xq:$i] : ((XP @ Xi @ Xn) = (ccfv @ (ccfv @ (XN @ Xq) @ ccsymg) @ ccbs))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xq:$i] : ((XT @ Xi @ Xn @ Xq) = (ccrn @ (ccfv @ (ccdif @ (XN @ Xq) @ (ccsn @ XK)) @ ccpmtr)))))) => ((! [Xq:$i] : ((XS @ Xq) = (ccfv @ (ccdif @ (XN @ Xq) @ (ccsn @ XK)) @ ccsymg))) => ((! [Xq:$i] : ((XZ @ Xq) = (ccfv @ (XN @ Xq) @ ccsymg))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xq:$i] : ((XR @ Xi @ Xn @ Xq) = (ccrn @ (ccfv @ (XN @ Xq) @ ccpmtr)))))) => (! [Xi:$i] : (! [Xn:$i] : (! [Xq:$i] : ((((cwcel @ (XN @ Xq) @ ccfn) & (cwcel @ XK @ (XN @ Xq))) & (cwcel @ (XQ @ Xi @ Xn) @ (ccrab @ (^ [Xq:$i] : ((ccfv @ XK @ (ccv @ Xq)) = XK)) @ (^ [Xq:$i] : (XP @ Xi @ Xn))))) => (((cwcel @ (XW @ Xq) @ (ccword @ (XT @ Xi @ Xn @ Xq))) & ((ccres @ (XQ @ Xi @ Xn) @ (ccdif @ (XN @ Xq) @ (ccsn @ XK))) = (cco @ (XS @ Xq) @ (XW @ Xq) @ ccgsu))) => ((cw3a @ (cwcel @ (XU @ Xq) @ (ccword @ (XR @ Xi @ Xn @ Xq))) @ ((ccfv @ (XW @ Xq) @ cchash) = (ccfv @ (XU @ Xq) @ cchash)) @ (cwral @ (^ [Xi:$i] : (((ccfv @ XK @ (ccfv @ (ccv @ Xi) @ (XU @ Xq))) = XK) & (cwral @ (^ [Xn:$i] : ((ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xi) @ (XW @ Xq))) = (ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xi) @ (XU @ Xq))))) @ (^ [Xn:$i] : (ccdif @ (XN @ Xq) @ (ccsn @ XK)))))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ (XW @ Xq) @ cchash) @ ccfzo)))) => ((XQ @ Xi @ Xn) = (cco @ (XZ @ Xq) @ (XU @ Xq) @ ccgsu)))))))))))))))))))))))).
thf(asyl6eq_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((XB2 = XC) => (Xph => (XA2 = XC))))))))).
thf(aid_ax,axiom,(! [Xph:$o] : (Xph => Xph))).
thf(aoveq1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XC @ XF)))))))).
thf(aeqcomi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 = XB2) => (XB2 = XA2))))).
thf(cpsgndiflemA_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xq:$i] : (XP = (ccfv @ (ccfv @ (XN @ Xq) @ ccsymg) @ ccbs))) => ((! [Xq:$i] : ((XT @ Xq) = (ccrn @ (ccfv @ (ccdif @ (XN @ Xq) @ (ccsn @ XK)) @ ccpmtr)))) => ((! [Xq:$i] : ((XS @ Xq) = (ccfv @ (ccdif @ (XN @ Xq) @ (ccsn @ XK)) @ ccsymg))) => ((! [Xq:$i] : ((XZ @ Xq) = (ccfv @ (XN @ Xq) @ ccsymg))) => ((! [Xq:$i] : ((XR @ Xq) = (ccrn @ (ccfv @ (XN @ Xq) @ ccpmtr)))) => (! [Xq:$i] : ((((cwcel @ (XN @ Xq) @ ccfn) & (cwcel @ XK @ (XN @ Xq))) & (cwcel @ XQ @ (ccrab @ (^ [Xq:$i] : ((ccfv @ XK @ (ccv @ Xq)) = XK)) @ (^ [Xq:$i] : XP)))) => ((cw3a @ (cwcel @ (XW @ Xq) @ (ccword @ (XT @ Xq))) @ ((ccres @ XQ @ (ccdif @ (XN @ Xq) @ (ccsn @ XK))) = (cco @ (XS @ Xq) @ (XW @ Xq) @ ccgsu)) @ (cwcel @ (XU @ Xq) @ (ccword @ (XR @ Xq)))) => ((XQ = (cco @ (ccfv @ (XN @ Xq) @ ccsymg) @ (XU @ Xq) @ ccgsu)) => ((cco @ (ccneg @ cc1) @ (ccfv @ (XW @ Xq) @ cchash) @ ccexp) = (cco @ (ccneg @ cc1) @ (ccfv @ (XU @ Xq) @ cchash) @ ccexp)))))))))))))))))))))).
