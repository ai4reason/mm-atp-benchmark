...
thf(abnj882_ax,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xps:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xf1 @ Xi @ Xn) <=> ((ccfv @ cc0 @ (ccv @ Xf1)) = (cc_bnj14 @ XA2 @ XR @ XX))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((Xps @ Xy1 @ Xf1 @ Xi @ Xn) <=> (cwral @ (^ [Xi:$i] : ((cwcel @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xn)) => ((ccfv @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xf1)) = (cciun @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xi) @ (ccv @ Xf1))) @ (^ [Xy1:$i] : (cc_bnj14 @ XA2 @ XR @ (ccv @ Xy1))))))) @ (^ [Xi:$i] : ccom))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((XD @ Xy1 @ Xf1 @ Xi @ Xn) = (ccdif @ ccom @ (ccsn @ cc0))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((XB2 @ Xy1 @ Xf1 @ Xi @ Xn) = (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xn:$i] : (cw3a @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) @ (Xph @ Xy1 @ Xf1 @ Xi @ Xn) @ (Xps @ Xy1 @ Xf1 @ Xi @ Xn))) @ (^ [Xn:$i] : (XD @ Xy1 @ Xf1 @ Xi @ Xn)))))))))) => (! [Xy1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((cc_bnj18 @ XA2 @ XR @ XX) = (cciun @ (^ [Xf1:$i] : (XB2 @ Xy1 @ Xf1 @ Xi @ Xn)) @ (^ [Xf1:$i] : (cciun @ (^ [Xi:$i] : (ccdm @ (ccv @ Xf1))) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (ccv @ Xf1)))))))))))))))))))))).
...
thf(abnj1083_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xn:$i] : ((Xch @ Xf1 @ Xn) <=> (cw_bnj17 @ (cwcel @ (ccv @ Xn) @ (XD @ Xf1 @ Xn)) @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) @ (Xph @ Xf1 @ Xn) @ (Xps @ Xf1 @ Xn))))) => ((! [Xf1:$i] : (! [Xn:$i] : ((XK @ Xf1 @ Xn) = (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xn:$i] : (cw3a @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) @ (Xph @ Xf1 @ Xn) @ (Xps @ Xf1 @ Xn))) @ (^ [Xn:$i] : (XD @ Xf1 @ Xn)))))))) => (! [Xf1:$i] : (! [Xn:$i] : ((cwcel @ (ccv @ Xf1) @ (XK @ Xf1 @ Xn)) <=> (? [Xn:$i] : (Xch @ Xf1 @ Xn))))))))))))).
...
thf(abnj1109_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((? [Xx3:$i] : (((cwne @ (XA2 @ Xx3) @ (XB2 @ Xx3)) & (Xph @ Xx3)) => (Xps @ Xx3))) => ((! [Xx3:$i] : ((((XA2 @ Xx3) = (XB2 @ Xx3)) & (Xph @ Xx3)) => (Xps @ Xx3))) => (? [Xx3:$i] : ((Xph @ Xx3) => (Xps @ Xx3)))))))))).
...
thf(abnj1262_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ XB2) => ((Xph => (XC = XA2)) => (Xph => (cwss @ XC @ XB2))))))))).
thf(abnj226_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((! [Xx3:$i] : (cwss @ (XB2 @ Xx3) @ XC)) => (cwss @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XC)))))).
thf(cwbr_tp,type,(cwbr : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(abnj213_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwss @ (cc_bnj14 @ XA2 @ XR @ XX) @ XA2))))).
...
thf(abnj832_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xet <=> (Xph & Xps)) => ((Xph => Xta) => (Xet => Xta)))))))).
...
thf(abnj589_ax,axiom,(! [Xps:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xps @ Xy1 @ Xf1 @ Xi @ Xk @ Xn) <=> (cwral @ (^ [Xi:$i] : ((cwcel @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xn)) => ((ccfv @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xf1)) = (cciun @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xi) @ (ccv @ Xf1))) @ (^ [Xy1:$i] : (cc_bnj14 @ (XA2 @ Xy1 @ Xf1 @ Xn) @ (XR @ Xy1 @ Xf1 @ Xn) @ (ccv @ Xy1))))))) @ (^ [Xi:$i] : ccom)))))))) => (! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xps @ Xy1 @ Xf1 @ Xi @ Xk @ Xn) <=> (cwral @ (^ [Xk:$i] : ((cwcel @ (ccsuc @ (ccv @ Xk)) @ (ccv @ Xn)) => ((ccfv @ (ccsuc @ (ccv @ Xk)) @ (ccv @ Xf1)) = (cciun @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1))) @ (^ [Xy1:$i] : (cc_bnj14 @ (XA2 @ Xy1 @ Xf1 @ Xn) @ (XR @ Xy1 @ Xf1 @ Xn) @ (ccv @ Xy1))))))) @ (^ [Xk:$i] : ccom))))))))))))).
...
thf(abnj771_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xet <=> (cw_bnj17 @ Xph @ Xps @ Xch @ Xth)) => ((Xch => Xta) => (Xet => Xta)))))))))).
...
thf(abnj1143_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2)) @ XB2)))).
thf(abnj1146_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ (XA2 @ Xx3)) => (! [Xx3:$i] : (cwcel @ (ccv @ Xy1) @ (XA2 @ Xx3)))))) => (cwss @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : XB2)) @ XB2))))).
...
thf(cbnj1145_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xps:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xch:($i > ($i > ($i > ($i > $o))))] : (! [Xth:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xj:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xf1 @ Xj @ Xn) <=> ((ccfv @ cc0 @ (ccv @ Xf1)) = (cc_bnj14 @ XA2 @ XR @ (XX @ Xj)))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : ((Xps @ Xy1 @ Xf1 @ Xi @ Xj @ Xn) <=> (cwral @ (^ [Xi:$i] : ((cwcel @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xn)) => ((ccfv @ (ccsuc @ (ccv @ Xi)) @ (ccv @ Xf1)) = (cciun @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xi) @ (ccv @ Xf1))) @ (^ [Xy1:$i] : (cc_bnj14 @ XA2 @ XR @ (ccv @ Xy1))))))) @ (^ [Xi:$i] : ccom)))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((XD @ Xy1 @ Xf1 @ Xn) = (ccdif @ ccom @ (ccsn @ cc0)))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : ((XB2 @ Xy1 @ Xf1 @ Xi @ Xj @ Xn) = (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xn:$i] : (cw3a @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) @ (Xph @ Xy1 @ Xf1 @ Xj @ Xn) @ (Xps @ Xy1 @ Xf1 @ Xi @ Xj @ Xn))) @ (^ [Xn:$i] : (XD @ Xy1 @ Xf1 @ Xn))))))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : ((Xch @ Xy1 @ Xf1 @ Xi @ Xn) <=> (cw_bnj17 @ (cwcel @ (ccv @ Xn) @ (XD @ Xy1 @ Xf1 @ Xn)) @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) @ (Xph @ Xy1 @ Xf1 @ Xj @ Xn) @ (Xps @ Xy1 @ Xf1 @ Xi @ Xj @ Xn)))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xn:$i] : ((Xth @ Xy1 @ Xf1 @ Xi @ Xj @ Xn) <=> ((cw3a @ (cwne @ (ccv @ Xi) @ cc0) @ (cwcel @ (ccv @ Xi) @ (ccv @ Xn)) @ (Xch @ Xy1 @ Xf1 @ Xi @ Xn)) & ((cwcel @ (ccv @ Xj) @ (ccv @ Xn)) & ((ccv @ Xi) = (ccsuc @ (ccv @ Xj))))))))))) => (! [Xj:$i] : (cwss @ (cc_bnj18 @ XA2 @ XR @ (XX @ Xj)) @ XA2)))))))))))))))))).
