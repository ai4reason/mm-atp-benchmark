...
thf(asnfil_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ XB2) & (cwne @ XA2 @ cc0)) => (cwcel @ (ccsn @ XA2) @ (ccfv @ XA2 @ ccfil)))))).
...
thf(csnfbas_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwss @ XA2 @ XB2) @ (cwne @ XA2 @ cc0) @ (cwcel @ XB2 @ XV)) => (cwcel @ (ccsn @ XA2) @ (ccfv @ XB2 @ ccfbas))))))).
