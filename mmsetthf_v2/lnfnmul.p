...
thf(clnfnmul_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwcel @ XT @ cclf) @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ cchil)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccsm) @ XT) = (cco @ XA2 @ (ccfv @ XB2 @ XT) @ ccmul))))))).
