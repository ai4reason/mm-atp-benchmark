...
thf(aodeq1_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XO = (ccfv @ XG @ ccod)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((XX = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX)) => (((ccfv @ XA2 @ XO) = cc1) <=> (XA2 = Xc_0)))))))))))).
...
thf(aodmulgid_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => (((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XX) @ (cwcel @ XN @ ccz)) & (cwcel @ XK @ ccz)) => ((cwbr @ (ccfv @ (cco @ XN @ XA2 @ Xc_x) @ XO) @ XK @ ccdvds) <=> (cwbr @ (ccfv @ XA2 @ XO) @ (cco @ XK @ XN @ ccmul) @ ccdvds)))))))))))))).
