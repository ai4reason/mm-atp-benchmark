...
thf(acantnf0_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : ((XS = (ccdm @ (cco @ XA2 @ XB2 @ cccnf))) => ((Xph => (cwcel @ XA2 @ ccon0)) => ((Xph => (cwcel @ XB2 @ ccon0)) => ((Xph => (cwcel @ cc0 @ XA2)) => (Xph => ((ccfv @ (ccxp @ XB2 @ (ccsn @ cc0)) @ (cco @ XA2 @ XB2 @ cccnf)) = cc0))))))))))).
