...
thf(aleordtvallem1_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XA2 @ Xx3 @ Xy1) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ ccpnf @ ccioc))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((XA2 @ Xx3 @ Xy1) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle))) @ (^ [Xy1:$i] : ccxr))))))))))).
thf(aleordtvallem2_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XA2 @ Xx3 @ Xy1) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ ccpnf @ ccioc))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xx3 @ Xy1) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (cco @ ccmnf @ (ccv @ Xx3) @ ccico))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xx3 @ Xy1) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle))) @ (^ [Xy1:$i] : ccxr))))))))))))).
...
thf(aiocssxr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (cco @ XA2 @ XB2 @ ccioc) @ ccxr)))).
...
thf(a_3sstr3i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwss @ XA2 @ XB2) => ((XA2 = XC) => ((XB2 = XD) => (cwss @ XC @ XD))))))))).
...
thf(aiccmax_ax,axiom,((cco @ ccmnf @ ccpnf @ ccicc) = ccxr)).
...
thf(atgcl_ax,axiom,(! [XB2:($i > $o)] : ((cwcel @ XB2 @ cctb) => (cwcel @ (ccfv @ XB2 @ cctg) @ cctop)))).
thf(afitop_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cctop) => ((ccfv @ XJ @ ccfi) = XJ)))).
thf(a_2basgen_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwss @ XB2 @ XC) & (cwss @ XC @ (ccfv @ XB2 @ cctg))) => ((ccfv @ XB2 @ cctg) = (ccfv @ XC @ cctg)))))).
thf(cleordtval2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : ((XA2 @ Xx3) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ ccpnf @ ccioc)))))) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (cco @ ccmnf @ (ccv @ Xx3) @ ccico)))))) => (! [Xx3:$i] : ((ccfv @ ccle @ ccordt) = (ccfv @ (ccfv @ (ccun @ (XA2 @ Xx3) @ (XB2 @ Xx3)) @ ccfi) @ cctg)))))))).
