...
thf(arimul_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ (cco @ cci @ XA2 @ ccmul) @ ccr)) => (XA2 = ccc0)))).
...
thf(atanval3_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ (cco @ (ccfv @ (cco @ cc2 @ (cco @ cci @ XA2 @ ccmul) @ ccmul) @ cce) @ cc1 @ ccaddc) @ ccc0)) => ((ccfv @ XA2 @ cctan) = (cco @ (cco @ (ccfv @ (cco @ cc2 @ (cco @ cci @ XA2 @ ccmul) @ ccmul) @ cce) @ cc1 @ ccmin) @ (cco @ cci @ (cco @ (ccfv @ (cco @ cc2 @ (cco @ cci @ XA2 @ ccmul) @ ccmul) @ cce) @ cc1 @ ccaddc) @ ccmul) @ ccdiv))))).
...
thf(ctanarg_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ (ccfv @ XA2 @ ccre) @ ccc0)) => ((ccfv @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ cctan) = (cco @ (ccfv @ XA2 @ ccim) @ (ccfv @ XA2 @ ccre) @ ccdiv))))).
