...
thf(ane3anior_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwne @ XA2 @ XB2) @ (cwne @ XC @ XD) @ (cwne @ XE @ XF)) <=> (~ (cw3o @ (XA2 = XB2) @ (XC = XD) @ (XE = XF))))))))))).
thf(celdiftp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((cwcel @ XA2 @ (ccdif @ XB2 @ (cctp @ XC @ XD @ XE))) <=> ((cwcel @ XA2 @ XB2) & (cw3a @ (cwne @ XA2 @ XC) @ (cwne @ XA2 @ XD) @ (cwne @ XA2 @ XE)))))))))).
