...
thf(adf_tng_ax,axiom,(cctng = (ccmpt2 @ (^ [Xg1:$i] : (^ [Xf1:$i] : ccvv)) @ (^ [Xg1:$i] : (^ [Xf1:$i] : ccvv)) @ (^ [Xg1:$i] : (^ [Xf1:$i] : (cco @ (cco @ (ccv @ Xg1) @ (ccop @ (ccfv @ ccnx @ ccds) @ (cccom @ (ccv @ Xf1) @ (ccfv @ (ccv @ Xg1) @ ccsg))) @ ccsts) @ (ccop @ (ccfv @ ccnx @ ccts) @ (ccfv @ (cccom @ (ccv @ Xf1) @ (ccfv @ (ccv @ Xg1) @ ccsg)) @ ccmopn)) @ ccsts)))))).
thf(aovex_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(ctngval_conj,conjecture,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XT = (cco @ XG @ XN @ cctng)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((XD = (cccom @ XN @ Xc_mi)) => ((XJ = (ccfv @ XD @ ccmopn)) => (((cwcel @ XG @ XV) & (cwcel @ XN @ XW)) => (XT = (cco @ (cco @ XG @ (ccop @ (ccfv @ ccnx @ ccds) @ XD) @ ccsts) @ (ccop @ (ccfv @ ccnx @ ccts) @ XJ) @ ccsts)))))))))))))))).
