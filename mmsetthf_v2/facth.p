...
thf(aplyrem_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (cco @ ccidp @ (ccxp @ ccc @ (ccsn @ XA2)) @ (ccof @ ccmin))) => ((XR = (cco @ XF @ (cco @ XG @ (cco @ XF @ XG @ ccquot) @ (ccof @ ccmul)) @ (ccof @ ccmin))) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XA2 @ ccc)) => (XR = (ccxp @ ccc @ (ccsn @ (ccfv @ XA2 @ XF))))))))))))).
...
thf(cfacth_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (cco @ ccidp @ (ccxp @ ccc @ (ccsn @ XA2)) @ (ccof @ ccmin))) => ((cw3a @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XA2 @ ccc) @ ((ccfv @ XA2 @ XF) = ccc0)) => (XF = (cco @ XG @ (cco @ XF @ XG @ ccquot) @ (ccof @ ccmul)))))))))).
