...
thf(arevval_ax,axiom,(! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xx3:$i] : ((cwcel @ XW @ (XV @ Xx3)) => ((ccfv @ XW @ ccreverse) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ (ccv @ Xx3) @ ccmin) @ XW))))))))).
thf(crevco_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XA2)) & (cwf @ XA2 @ XB2 @ XF)) => ((cccom @ XF @ (ccfv @ XW @ ccreverse)) = (ccfv @ (cccom @ XF @ XW) @ ccreverse)))))))).
