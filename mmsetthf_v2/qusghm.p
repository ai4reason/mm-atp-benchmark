...
thf(cqusghm_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XH = (cco @ XG @ (cco @ XG @ XY @ ccqg) @ ccqus)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccec @ (ccv @ Xx3) @ (cco @ XG @ XY @ ccqg)))))) => (! [Xx3:$i] : ((cwcel @ XY @ (ccfv @ XG @ ccnsg)) => (cwcel @ (XF @ Xx3) @ (cco @ XG @ XH @ ccghm))))))))))))).
