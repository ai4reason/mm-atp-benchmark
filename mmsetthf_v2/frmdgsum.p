...
thf(afrmd0_ax,axiom,(! [XI:($i > $o)] : (! [XM:($i > $o)] : ((XM = (ccfv @ XI @ ccfrmd)) => (cc0 = (ccfv @ XM @ cc0g)))))).
...
thf(avrmdval_ax,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XU = (ccfv @ XI @ ccvrmd)) => (((cwcel @ XI @ XV) & (cwcel @ XA2 @ XI)) => ((ccfv @ XA2 @ XU) = (ccs1 @ XA2))))))))).
...
thf(cfrmdgsum_conj,conjecture,(! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XM = (ccfv @ XI @ ccfrmd)) => ((XU = (ccfv @ XI @ ccvrmd)) => (((cwcel @ XI @ XV) & (cwcel @ XW @ (ccword @ XI))) => ((cco @ XM @ (cccom @ XU @ XW) @ ccgsu) = XW)))))))))).
