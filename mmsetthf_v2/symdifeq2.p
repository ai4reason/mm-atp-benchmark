...
thf(asymdifeq1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((ccsymdif @ XA2 @ XC) = (ccsymdif @ XB2 @ XC))))))).
thf(asymdifcom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccsymdif @ XA2 @ XB2) = (ccsymdif @ XB2 @ XA2))))).
