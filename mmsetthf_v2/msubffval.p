...
thf(adf_msub_ax,axiom,(ccmsub = (ccmpt @ (^ [Xt:$i] : ccvv) @ (^ [Xt:$i] : (ccmpt @ (^ [Xf1:$i] : (cco @ (ccfv @ (ccv @ Xt) @ ccmrex) @ (ccfv @ (ccv @ Xt) @ ccmvar) @ ccpm)) @ (^ [Xf1:$i] : (ccmpt @ (^ [Xe:$i] : (ccfv @ (ccv @ Xt) @ ccmex)) @ (^ [Xe:$i] : (ccop @ (ccfv @ (ccv @ Xe) @ cc1st) @ (ccfv @ (ccfv @ (ccv @ Xe) @ cc2nd) @ (ccfv @ (ccv @ Xf1) @ (ccfv @ (ccv @ Xt) @ ccmrsub)))))))))))).
