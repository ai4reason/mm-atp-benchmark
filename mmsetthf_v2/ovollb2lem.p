...
thf(aovolficc_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwss @ XA2 @ ccr) & (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((cwss @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccicc @ XF)))) <=> (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xn:$i] : ((cwbr @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ cc1st) @ (ccv @ Xz) @ ccle) & (cwbr @ (ccv @ Xz) @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ cc2nd) @ ccle))) @ (^ [Xn:$i] : ccn))) @ (^ [Xz:$i] : XA2))))))).
...
thf(covollb2lem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((XS = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1)) => ((! [Xn:$i] : ((XG @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccop @ (cco @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ cc1st) @ (cco @ (cco @ XB2 @ cc2 @ ccdiv) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccmin) @ (cco @ (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ cc2nd) @ (cco @ (cco @ XB2 @ cc2 @ ccdiv) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccaddc)))))) => ((! [Xn:$i] : ((XT @ Xn) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (XG @ Xn)) @ cc1))) => ((Xph => (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((Xph => (cwss @ XA2 @ (ccuni @ (ccrn @ (cccom @ ccicc @ XF))))) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => (cwcel @ (ccsup @ (ccrn @ XS) @ ccxr @ cclt) @ ccr)) => (Xph => (cwbr @ (ccfv @ XA2 @ ccovol) @ (cco @ (ccsup @ (ccrn @ XS) @ ccxr @ cclt) @ XB2 @ ccaddc) @ ccle))))))))))))))))).
