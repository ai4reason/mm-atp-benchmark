...
thf(cbnj1307_b_conj,conjecture,(! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xw:$i] : (! [Xd:$i] : ((XC @ Xx3 @ Xw @ Xd) = (ccab @ (^ [Xw:$i] : (cwrex @ (^ [Xd:$i] : ((cwfn @ (ccv @ Xw) @ (ccv @ Xd)) & (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (ccv @ Xw)) = (ccfv @ (XY @ Xx3 @ Xw @ Xd) @ (XG @ Xx3 @ Xw @ Xd)))) @ (^ [Xx3:$i] : (ccv @ Xd))))) @ (^ [Xd:$i] : (XB2 @ Xx3 @ Xd))))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xd:$i] : ((cwcel @ (ccv @ Xw) @ (XB2 @ Xx3 @ Xd)) => (! [Xx3:$i] : (cwcel @ (ccv @ Xw) @ (XB2 @ Xx3 @ Xd))))))) => (! [Xx3:$i] : (! [Xw:$i] : (! [Xd:$i] : ((cwcel @ (ccv @ Xw) @ (XC @ Xx3 @ Xw @ Xd)) => (! [Xx3:$i] : (cwcel @ (ccv @ Xw) @ (XC @ Xx3 @ Xw @ Xd)))))))))))))).
