...
thf(cintab_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xy1:$i] : (cwcel @ (XA2 @ Xy1) @ ccvv)) => ((cwcel @ (ccab @ (^ [Xx3:$i] : (? [Xy1:$i] : ((Xph @ Xy1) & ((ccv @ Xx3) = (XA2 @ Xy1)))))) @ ccvv) => ((ccint @ (ccab @ (^ [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ (XA2 @ Xy1) @ (ccv @ Xx3))))))) = (ccab @ (^ [Xx3:$i] : (? [Xy1:$i] : ((Xph @ Xy1) & ((ccv @ Xx3) = (XA2 @ Xy1)))))))))))).
