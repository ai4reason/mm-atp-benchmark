...
thf(a_37prm_ax,axiom,(cwcel @ (ccdc @ cc3 @ cc7) @ ccprime)).
...
thf(a_4lt7_ax,axiom,(cwbr @ cc4 @ cc7 @ cclt)).
thf(a_1259lem4_ax,axiom,(! [XN:($i > $o)] : ((XN = (ccdc @ (ccdc @ (ccdc @ cc1 @ cc2) @ cc5) @ cc9)) => ((cco @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ XN @ ccmo) = (cco @ cc1 @ XN @ ccmo))))).
thf(a_1259lem5_ax,axiom,(! [XN:($i > $o)] : ((XN = (ccdc @ (ccdc @ (ccdc @ cc1 @ cc2) @ cc5) @ cc9)) => ((cco @ (cco @ (cco @ cc2 @ (ccdc @ cc3 @ cc4) @ ccexp) @ cc1 @ ccmin) @ XN @ ccgcd) = cc1)))).
