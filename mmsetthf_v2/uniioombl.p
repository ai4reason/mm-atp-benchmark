...
thf(cuniioombl_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : ((Xph => (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((Xph => (cwdisj @ (^ [Xx3:$i] : ccn) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccioo)))) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1))) => (Xph => (cwcel @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF))) @ (ccdm @ ccvol)))))))))).
