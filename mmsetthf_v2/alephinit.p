...
thf(aoncardid_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (cwbr @ (ccfv @ XA2 @ cccrd) @ XA2 @ ccen)))).
...
thf(calephinit_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwss @ ccom @ XA2)) => ((cwcel @ XA2 @ (ccrn @ ccale)) <=> (cwral @ (^ [Xx3:$i] : ((cwbr @ XA2 @ (ccv @ Xx3) @ ccdom) => (cwss @ XA2 @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0)))))).
