...
thf(cisflf_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xs1:$i] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) => ((cwcel @ (XA2 @ Xs1) @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf))) <=> ((cwcel @ (XA2 @ Xs1) @ XX) & (cwral @ (^ [Xo:$i] : ((cwcel @ (XA2 @ Xs1) @ (ccv @ Xo)) => (cwrex @ (^ [Xs1:$i] : (cwss @ (ccima @ XF @ (ccv @ Xs1)) @ (ccv @ Xo))) @ (^ [Xs1:$i] : XL)))) @ (^ [Xo:$i] : XJ))))))))))))).
