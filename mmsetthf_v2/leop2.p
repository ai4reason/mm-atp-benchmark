...
thf(cleop2_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (((cwcel @ XT @ ccho) & (cwcel @ XU @ ccho)) => ((cwbr @ XT @ XU @ ccleo) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ (cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xx3) @ ccsp) @ (cco @ (ccfv @ (ccv @ Xx3) @ XU) @ (ccv @ Xx3) @ ccsp) @ ccle)) @ (^ [Xx3:$i] : cchil))))))).
