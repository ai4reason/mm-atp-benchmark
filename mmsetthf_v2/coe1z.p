...
thf(aply1mpl0_ax,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((XM = (cco @ cc1o @ XR @ ccmpl)) => ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => (Xc_0 = (ccfv @ XM @ cc0g)))))))))).
...
thf(acoe1fval2_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xy1:$i] : ((XA2 @ Xy1) = (ccfv @ XF @ ccco1))) => ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccfv @ (XP @ Xy1) @ ccbs))) => ((! [Xy1:$i] : ((XP @ Xy1) = (ccfv @ (XR @ Xy1) @ ccpl1))) => ((! [Xy1:$i] : ((XG @ Xy1) = (ccmpt @ (^ [Xy1:$i] : ccn0) @ (^ [Xy1:$i] : (ccxp @ cc1o @ (ccsn @ (ccv @ Xy1))))))) => (! [Xy1:$i] : ((cwcel @ XF @ (XB2 @ Xy1)) => ((XA2 @ Xy1) = (cccom @ XF @ (XG @ Xy1)))))))))))))))).
thf(ccoe1z_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((XY = (ccfv @ XR @ cc0g)) => ((cwcel @ XR @ ccrg) => ((ccfv @ Xc_0 @ ccco1) = (ccxp @ ccn0 @ (ccsn @ XY)))))))))))).
