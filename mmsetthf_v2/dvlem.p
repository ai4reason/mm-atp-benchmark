...
thf(cdvlem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XD @ ccc @ XF)) => ((Xph => (cwss @ XD @ ccc)) => ((Xph => (cwcel @ XB2 @ XD)) => ((Xph & (cwcel @ XA2 @ (ccdif @ XD @ (ccsn @ XB2)))) => (cwcel @ (cco @ (cco @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ ccmin) @ (cco @ XA2 @ XB2 @ ccmin) @ ccdiv) @ ccc))))))))))).
