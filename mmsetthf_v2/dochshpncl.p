...
thf(aislshpsm_ax,axiom,(! [Xph:$o] : (! [Xc_po:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((! [Xv:$i] : ((XN @ Xv) = (ccfv @ XW @ cclspn))) => ((XS = (ccfv @ XW @ cclss)) => ((! [Xv:$i] : ((Xc_po @ Xv) = (ccfv @ XW @ cclsm))) => ((! [Xv:$i] : ((XH @ Xv) = (ccfv @ XW @ cclsh))) => ((Xph => (cwcel @ XW @ cclmod)) => (! [Xv:$i] : (Xph => ((cwcel @ XU @ (XH @ Xv)) <=> (cw3a @ (cwcel @ XU @ XS) @ (cwne @ XU @ XV) @ (cwrex @ (^ [Xv:$i] : ((cco @ XU @ (ccfv @ (ccsn @ (ccv @ Xv)) @ (XN @ Xv)) @ (Xc_po @ Xv)) = XV)) @ (^ [Xv:$i] : XV))))))))))))))))))))).
...
thf(adochocss_ax,axiom,(! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((Xc_pe = (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwss @ XX @ XV)) => (cwss @ XX @ (ccfv @ (ccfv @ XX @ Xc_pe) @ Xc_pe))))))))))))))).
...
thf(alshpne_ax,axiom,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XH = (ccfv @ XW @ cclsh)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XU @ XH)) => (Xph => (cwne @ XU @ XV)))))))))))).
thf(cdochshpncl_conj,conjecture,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((Xc_pe = (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((XY = (ccfv @ XU @ cclsh)) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XX @ XY)) => (Xph => ((cwne @ (ccfv @ (ccfv @ XX @ Xc_pe) @ Xc_pe) @ XX) <=> ((ccfv @ (ccfv @ XX @ Xc_pe) @ Xc_pe) = XV)))))))))))))))))))).
