...
thf(cwwlknp_conj,conjecture,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : ((! [Xi:$i] : ((XV @ Xi) = (ccfv @ XG @ ccvtx))) => ((! [Xi:$i] : ((XE @ Xi) = (ccfv @ XG @ ccedg))) => (! [Xi:$i] : ((cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) => (cw3a @ (cwcel @ XW @ (ccword @ (XV @ Xi))) @ ((ccfv @ XW @ cchash) = (cco @ XN @ cc1 @ ccaddc)) @ (cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ XW) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XW)) @ (XE @ Xi))) @ (^ [Xi:$i] : (cco @ ccc0 @ XN @ ccfzo)))))))))))))).
