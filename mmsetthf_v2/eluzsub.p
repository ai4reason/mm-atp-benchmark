...
thf(aeluzsubi_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XM @ ccz) => ((cwcel @ XK @ ccz) => ((cwcel @ XN @ (ccfv @ (cco @ XM @ XK @ ccaddc) @ ccuz)) => (cwcel @ (cco @ XN @ XK @ ccmin) @ (ccfv @ XM @ ccuz))))))))).
...
thf(celuzsub_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XK @ ccz) @ (cwcel @ XN @ (ccfv @ (cco @ XM @ XK @ ccaddc) @ ccuz))) => (cwcel @ (cco @ XN @ XK @ ccmin) @ (ccfv @ XM @ ccuz))))))).
