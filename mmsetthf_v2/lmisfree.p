...
thf(albslcic_ax,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XJ = (ccfv @ XW @ cclbs)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XB2 @ XJ) @ (cwbr @ XI @ XB2 @ ccen)) => (cwbr @ XW @ (cco @ XF @ XI @ ccfrlm) @ cclmic)))))))))).
...
thf(almicsym_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwbr @ XR @ XS @ cclmic) => (cwbr @ XS @ XR @ cclmic))))).
thf(cclmhm_tp,type,(cclmhm : ($i > $o))).
thf(almiclcl_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwbr @ XR @ XS @ cclmic) => (cwcel @ XR @ cclmod))))).
...
thf(almiclbs_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (ccfv @ XS @ cclbs)) => ((XK = (ccfv @ XT @ cclbs)) => ((cwbr @ XS @ XT @ cclmic) => ((cwne @ XJ @ cc0) => (cwne @ XK @ cc0)))))))))).
thf(clmisfree_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > $o)] : ((XJ = (ccfv @ XW @ cclbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((cwcel @ XW @ cclmod) => ((cwne @ XJ @ cc0) <=> (? [Xk:$i] : (cwbr @ XW @ (cco @ XF @ (ccv @ Xk) @ ccfrlm) @ cclmic)))))))))).
