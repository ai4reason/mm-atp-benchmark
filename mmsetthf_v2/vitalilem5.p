...
thf(avitalilem1_ax,axiom,(! [Xc_sm:($i > $o)] : ((Xc_sm = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (cco @ ccc0 @ cc1 @ ccicc)) & (cwcel @ (ccv @ Xy1) @ (cco @ ccc0 @ cc1 @ ccicc))) & (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmin) @ ccq)))))) => (cwer @ (cco @ ccc0 @ cc1 @ ccicc) @ Xc_sm)))).
