...
thf(coev_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XA2 @ ccon0) & (cwcel @ (XB2 @ Xx3) @ ccon0)) => ((cco @ XA2 @ (XB2 @ Xx3) @ ccoe) = (ccif @ (XA2 = cc0) @ (ccdif @ cc1o @ (XB2 @ Xx3)) @ (ccfv @ (XB2 @ Xx3) @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ ccomu))) @ cc1o))))))))).
