...
thf(aprmop1_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccprmo) = (ccif @ (cwcel @ (cco @ XN @ cc1 @ ccaddc) @ ccprime) @ (cco @ (ccfv @ XN @ ccprmo) @ (cco @ XN @ cc1 @ ccaddc) @ ccmul) @ (ccfv @ XN @ ccprmo)))))).
...
thf(cprmonn2_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((ccfv @ XN @ ccprmo) = (ccif @ (cwcel @ XN @ ccprime) @ (cco @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ ccprmo) @ XN @ ccmul) @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ ccprmo)))))).
