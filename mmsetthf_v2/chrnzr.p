...
thf(advds1_ax,axiom,(! [XM:($i > $o)] : ((cwcel @ XM @ ccn0) => ((cwbr @ XM @ cc1 @ ccdvds) <=> (XM = cc1))))).
...
thf(cchrnzr_conj,conjecture,(! [XR:($i > $o)] : ((cwcel @ XR @ ccrg) => ((cwcel @ XR @ ccnzr) <=> (cwne @ (ccfv @ XR @ ccchr) @ cc1))))).
