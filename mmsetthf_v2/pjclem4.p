...
thf(apjcocli_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => (cwcel @ (ccfv @ XA2 @ (cccom @ (ccfv @ XG @ ccpjh) @ (ccfv @ XH @ ccpjh))) @ XG)))))))).
...
thf(apjcohcli_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => (cwcel @ (ccfv @ XA2 @ (cccom @ (ccfv @ XG @ ccpjh) @ (ccfv @ XH @ ccpjh))) @ cchil)))))))).
...
thf(apjadjcoi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => ((cco @ (ccfv @ XA2 @ (cccom @ (ccfv @ XG @ ccpjh) @ (ccfv @ XH @ ccpjh))) @ XB2 @ ccsp) = (cco @ XA2 @ (ccfv @ XB2 @ (cccom @ (ccfv @ XH @ ccpjh) @ (ccfv @ XG @ ccpjh))) @ ccsp)))))))))).
thf(aoveq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))))).
thf(apjclem4a_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ (ccin @ XG @ XH)) => ((ccfv @ XA2 @ (cccom @ (ccfv @ XG @ ccpjh) @ (ccfv @ XH @ ccpjh))) = XA2)))))))).
...
thf(apjvi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => (((cwcel @ XA2 @ XH) & (cwcel @ XB2 @ (ccfv @ XH @ ccort))) => ((ccfv @ (cco @ XA2 @ XB2 @ ccva) @ (ccfv @ XH @ ccpjh)) = XA2))))))).
...
thf(cpjclem4_conj,conjecture,(! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => (((cccom @ (ccfv @ XG @ ccpjh) @ (ccfv @ XH @ ccpjh)) = (cccom @ (ccfv @ XH @ ccpjh) @ (ccfv @ XG @ ccpjh))) => ((cccom @ (ccfv @ XG @ ccpjh) @ (ccfv @ XH @ ccpjh)) = (ccfv @ (ccin @ XG @ XH) @ ccpjh)))))))).
