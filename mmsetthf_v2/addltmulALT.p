...
thf(caddltmulALT_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwbr @ cc2 @ XA2 @ cclt) & (cwbr @ cc2 @ XB2 @ cclt))) => (cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XA2 @ XB2 @ ccmul) @ cclt))))).
