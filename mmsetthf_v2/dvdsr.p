...
thf(areldvdsr_ax,axiom,(! [Xc_pa:($i > $o)] : (! [XR:($i > $o)] : ((Xc_pa = (ccfv @ XR @ ccdsr)) => (cwrel @ Xc_pa))))).
...
thf(advdsrval_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pa:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((! [Xz:$i] : ((Xc_pa @ Xz) = (ccfv @ XR @ ccdsr))) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (! [Xz:$i] : ((Xc_pa @ Xz) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ XB2) & (cwrex @ (^ [Xz:$i] : ((cco @ (ccv @ Xz) @ (ccv @ Xx3) @ Xc_x) = (ccv @ Xy1))) @ (^ [Xz:$i] : XB2)))))))))))))))).
thf(cdvdsr_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pa:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((! [Xz:$i] : ((Xc_pa @ Xz) = (ccfv @ XR @ ccdsr))) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (! [Xz:$i] : ((cwbr @ XX @ XY @ (Xc_pa @ Xz)) <=> ((cwcel @ XX @ XB2) & (cwrex @ (^ [Xz:$i] : ((cco @ (ccv @ Xz) @ XX @ Xc_x) = XY)) @ (^ [Xz:$i] : XB2))))))))))))))).
