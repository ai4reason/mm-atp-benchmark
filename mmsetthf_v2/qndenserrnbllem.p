...
thf(aqbtwnxr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwbr @ XA2 @ XB2 @ cclt)) => (cwrex @ (^ [Xx3:$i] : ((cwbr @ XA2 @ (ccv @ Xx3) @ cclt) & (cwbr @ (ccv @ Xx3) @ XB2 @ cclt))) @ (^ [Xx3:$i] : ccq)))))).
...
thf(arrndistlt_ax,axiom,(! [Xph:$o] : (! [XD:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XI @ ccfn)) => ((Xph => (cwne @ XI @ cc0)) => ((! [Xi:$i] : ((XN @ Xi) = (ccfv @ XI @ cchash))) => ((Xph => (cwcel @ XX @ (cco @ ccr @ XI @ ccmap))) => ((Xph => (cwcel @ XY @ (cco @ ccr @ XI @ ccmap))) => ((! [Xi:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ XI)) => (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xi) @ XX) @ (ccfv @ (ccv @ Xi) @ XY) @ ccmin) @ ccabs) @ XE @ cclt))) => ((Xph => (cwcel @ XE @ ccrp)) => ((! [Xi:$i] : ((XD @ Xi) = (ccfv @ (ccfv @ XI @ ccrrx) @ ccds))) => (! [Xi:$i] : (Xph => (cwbr @ (cco @ XX @ XY @ (XD @ Xi)) @ (cco @ (ccfv @ (XN @ Xi) @ ccsqrt) @ XE @ ccmul) @ cclt))))))))))))))))))).
...
thf(aelioored_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ (cco @ XB2 @ XC @ ccioo))) => (Xph => (cwcel @ XA2 @ ccr)))))))).
thf(asimp2_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) => Xps))))).
thf(asqrtgt0_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ cclt)) => (cwbr @ ccc0 @ (ccfv @ XA2 @ ccsqrt) @ cclt)))).
...
thf(cqndenserrnbllem_conj,conjecture,(! [Xph:$o] : (! [XD:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XI @ ccfn)) => ((Xph => (cwne @ XI @ cc0)) => ((Xph => (cwcel @ XX @ (cco @ ccr @ XI @ ccmap))) => ((! [Xy1:$i] : ((XD @ Xy1) = (ccfv @ (ccfv @ XI @ ccrrx) @ ccds))) => ((Xph => (cwcel @ XE @ ccrp)) => (Xph => (cwrex @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xy1) @ (cco @ XX @ XE @ (ccfv @ (XD @ Xy1) @ ccbl)))) @ (^ [Xy1:$i] : (cco @ ccq @ XI @ ccmap))))))))))))))).
