...
thf(afvcofneq_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [Xx3:$i] : (((cwfn @ XG @ (XA2 @ Xx3)) & (cwfn @ XK @ (XB2 @ Xx3))) => ((cw3a @ (cwcel @ XX @ (ccin @ (XA2 @ Xx3) @ (XB2 @ Xx3))) @ ((ccfv @ XX @ XG) = (ccfv @ XX @ XK)) @ (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xx3) @ XH))) @ (^ [Xx3:$i] : (ccin @ (ccrn @ XG) @ (ccrn @ XK))))) => ((ccfv @ XX @ (cccom @ XF @ XG)) = (ccfv @ XX @ (cccom @ XH @ XK)))))))))))))).
thf(cfvcosymgeq_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xn:$i] : ((XS @ Xn) = (ccfv @ (XN @ Xn) @ ccsymg))) => ((! [Xn:$i] : ((XB2 @ Xn) = (ccfv @ (XS @ Xn) @ ccbs))) => ((! [Xn:$i] : ((XZ @ Xn) = (ccfv @ (XM @ Xn) @ ccsymg))) => ((! [Xn:$i] : ((XP @ Xn) = (ccfv @ (XZ @ Xn) @ ccbs))) => ((! [Xn:$i] : (XI = (ccin @ (XN @ Xn) @ (XM @ Xn)))) => (! [Xn:$i] : (((cwcel @ XG @ (XB2 @ Xn)) & (cwcel @ XK @ (XP @ Xn))) => ((cw3a @ (cwcel @ XX @ XI) @ ((ccfv @ XX @ XG) = (ccfv @ XX @ XK)) @ (cwral @ (^ [Xn:$i] : ((ccfv @ (ccv @ Xn) @ XF) = (ccfv @ (ccv @ Xn) @ XH))) @ (^ [Xn:$i] : XI))) => ((ccfv @ XX @ (cccom @ XF @ XG)) = (ccfv @ XX @ (cccom @ XH @ XK)))))))))))))))))))))))).
