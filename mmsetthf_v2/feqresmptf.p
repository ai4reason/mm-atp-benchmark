...
thf(cfeqresmptf_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwf @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ (XF @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XC @ (XA2 @ Xx3)))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccres @ (XF @ Xx3) @ XC) = (ccmpt @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)))))))))))))))).
