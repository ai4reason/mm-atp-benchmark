...
thf(aperfectALTVlem1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccn)) => ((Xph => (cwcel @ XB2 @ ccn)) => ((Xph => (cwcel @ XB2 @ ccodd)) => ((Xph => ((cco @ cc1 @ (cco @ (cco @ cc2 @ XA2 @ ccexp) @ XB2 @ ccmul) @ ccsgm) = (cco @ cc2 @ (cco @ (cco @ cc2 @ XA2 @ ccexp) @ XB2 @ ccmul) @ ccmul))) => (Xph => (cw3a @ (cwcel @ (cco @ cc2 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccexp) @ ccn) @ (cwcel @ (cco @ (cco @ cc2 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccexp) @ cc1 @ ccmin) @ ccn) @ (cwcel @ (cco @ XB2 @ (cco @ (cco @ cc2 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccexp) @ cc1 @ ccmin) @ ccdiv) @ ccn))))))))))).
...
thf(altdiv2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => (cwcel @ XC @ ccrp)) => (Xph => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (cco @ XC @ XB2 @ ccdiv) @ (cco @ XC @ XA2 @ ccdiv) @ cclt))))))))))).
...
thf(aposdif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ ccc0 @ (cco @ XB2 @ XA2 @ ccmin) @ cclt)))))).
...
thf(aisodd7_ax,axiom,(! [XZ:($i > $o)] : ((cwcel @ XZ @ ccodd) <=> ((cwcel @ XZ @ ccz) & ((cco @ cc2 @ XZ @ ccgcd) = cc1))))).
...
thf(asgmmul_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cw3a @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn) @ ((cco @ XM @ XN @ ccgcd) = cc1))) => ((cco @ XA2 @ (cco @ XM @ XN @ ccmul) @ ccsgm) = (cco @ (cco @ XA2 @ XM @ ccsgm) @ (cco @ XA2 @ XN @ ccsgm) @ ccmul))))))).
...
thf(a_1sgm2ppw_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cco @ cc1 @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccsgm) = (cco @ (cco @ cc2 @ XN @ ccexp) @ cc1 @ ccmin))))).
thf(a_1nn0_ax,axiom,(cwcel @ cc1 @ ccn0)).
thf(asgmnncl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn0) & (cwcel @ XB2 @ ccn)) => (cwcel @ (cco @ XA2 @ XB2 @ ccsgm) @ ccn))))).
thf(asgmval_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccn)) => ((cco @ XA2 @ XB2 @ ccsgm) = (ccsu @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XB2 @ ccdvds)) @ (^ [Xp:$i] : ccn)) @ (^ [Xk:$i] : (cco @ (ccv @ Xk) @ XA2 @ cccxp)))))))).
...
thf(aisprm2_ax,axiom,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprime) <=> ((cwcel @ XP @ (ccfv @ cc2 @ ccuz)) & (cwral @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xz) @ XP @ ccdvds) => (((ccv @ Xz) = cc1) | ((ccv @ Xz) = XP)))) @ (^ [Xz:$i] : ccn)))))).
...
thf(cperfectALTVlem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccn)) => ((Xph => (cwcel @ XB2 @ ccn)) => ((Xph => (cwcel @ XB2 @ ccodd)) => ((Xph => ((cco @ cc1 @ (cco @ (cco @ cc2 @ XA2 @ ccexp) @ XB2 @ ccmul) @ ccsgm) = (cco @ cc2 @ (cco @ (cco @ cc2 @ XA2 @ ccexp) @ XB2 @ ccmul) @ ccmul))) => (Xph => ((cwcel @ XB2 @ ccprime) & (XB2 = (cco @ (cco @ cc2 @ (cco @ XA2 @ cc1 @ ccaddc) @ ccexp) @ cc1 @ ccmin)))))))))))).
