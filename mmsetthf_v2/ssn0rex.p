...
thf(an0rex_ax,axiom,(! [XA2:($i > $o)] : ((cwne @ XA2 @ cc0) => (cwrex @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2)) @ (^ [Xx3:$i] : XA2))))).
thf(cssn0rex_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ XB2) & (cwne @ XA2 @ cc0)) => (cwrex @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2)) @ (^ [Xx3:$i] : XB2)))))).
