...
thf(afzm1_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ XM @ ccuz)) => ((cwcel @ XK @ (cco @ XM @ XN @ ccfz)) <=> ((cwcel @ XK @ (cco @ XM @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) | (XK = XN)))))))).
...
thf(csubmateqlem2_conj,conjecture,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XK @ (cco @ cc1 @ XN @ ccfz))) => ((Xph => (cwcel @ XM @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) => ((Xph => (cwbr @ XM @ XK @ cclt)) => (Xph => ((cwcel @ XM @ (cco @ cc1 @ XK @ ccfzo)) & (cwcel @ XM @ (ccdif @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ XK)))))))))))))).
