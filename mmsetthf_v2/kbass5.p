...
thf(ckbass5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) & ((cwcel @ XC @ cchil) & (cwcel @ XD @ cchil))) => ((cccom @ (cco @ XA2 @ XB2 @ cck) @ (cco @ XC @ XD @ cck)) = (cco @ (ccfv @ XC @ (cco @ XA2 @ XB2 @ cck)) @ XD @ cck)))))))).
