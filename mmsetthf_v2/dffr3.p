...
thf(ainiseg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XB2 @ (XV @ Xx3)) => ((ccima @ (cccnv @ XA2) @ (ccsn @ XB2)) = (ccab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XB2 @ XA2)))))))))).
thf(adfrab3_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) = (ccin @ XA2 @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3)))))))).
thf(cdffr3_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwfr @ XA2 @ XR) <=> (! [Xx3:$i] : (((cwss @ (ccv @ Xx3) @ XA2) & (cwne @ (ccv @ Xx3) @ cc0)) => (cwrex @ (^ [Xy1:$i] : ((ccin @ (ccv @ Xx3) @ (ccima @ (cccnv @ XR) @ (ccsn @ (ccv @ Xy1)))) = cc0)) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))).
