...
thf(azextle_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwral @ (^ [Xk:$i] : ((cwbr @ (ccv @ Xk) @ XM @ ccle) <=> (cwbr @ (ccv @ Xk) @ XN @ ccle))) @ (^ [Xk:$i] : ccz))) => (XM = XN))))).
...
thf(czextlt_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwral @ (^ [Xk:$i] : ((cwbr @ (ccv @ Xk) @ XM @ cclt) <=> (cwbr @ (ccv @ Xk) @ XN @ cclt))) @ (^ [Xk:$i] : ccz))) => (XM = XN))))).
