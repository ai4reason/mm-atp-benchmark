...
thf(cello12r_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ ((cwf @ XA2 @ ccr @ XF) & (cwss @ XA2 @ ccr)) @ ((cwcel @ XC @ ccr) & (cwcel @ XM @ ccr)) @ (cwral @ (^ [Xx3:$i] : ((cwbr @ XC @ (ccv @ Xx3) @ ccle) => (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ XM @ ccle))) @ (^ [Xx3:$i] : XA2))) => (cwcel @ XF @ cclo1))))))).
