...
thf(advds2lem_ax,axiom,(! [Xph:$o] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > ($i > ($i > $o)))] : ((Xph => ((cwcel @ XI @ ccz) & (cwcel @ XJ @ ccz))) => ((Xph => ((cwcel @ XK @ ccz) & (cwcel @ XL @ ccz))) => ((Xph => ((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ ccz) & (cwcel @ (ccv @ Xy1) @ ccz))) => (cwcel @ (XZ @ Xx3 @ Xy1) @ ccz)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ ccz) & (cwcel @ (ccv @ Xy1) @ ccz))) => ((((cco @ (ccv @ Xx3) @ XI @ ccmul) = XJ) & ((cco @ (ccv @ Xy1) @ XK @ ccmul) = XL)) => ((cco @ (XZ @ Xx3 @ Xy1) @ XM @ ccmul) = XN))))) => (Xph => (((cwbr @ XI @ XJ @ ccdvds) & (cwbr @ XK @ XL @ ccdvds)) => (cwbr @ XM @ XN @ ccdvds))))))))))))))))).
...
thf(cdvds2add_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) => (((cwbr @ XK @ XM @ ccdvds) & (cwbr @ XK @ XN @ ccdvds)) => (cwbr @ XK @ (cco @ XM @ XN @ ccaddc) @ ccdvds))))))).
