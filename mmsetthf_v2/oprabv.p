...
thf(areloprab_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (cwrel @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))))))).
...
thf(coprabv_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwbr @ (ccop @ XX @ XY) @ XZ @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))))) => (cw3a @ (cwcel @ XX @ ccvv) @ (cwcel @ XY @ ccvv) @ (cwcel @ XZ @ ccvv)))))))).
