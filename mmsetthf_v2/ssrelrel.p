...
thf(cssrelrel_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ (ccxp @ (ccxp @ ccvv @ ccvv) @ ccvv)) => ((cwss @ XA2 @ XB2) <=> (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ (ccop @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz)) @ XA2) => (cwcel @ (ccop @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz)) @ XB2)))))))))).
