...
thf(ainfpwfidom_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ (ccin @ (ccpw @ XA2) @ ccfn) @ ccvv) => (cwbr @ XA2 @ (ccin @ (ccpw @ XA2) @ ccfn) @ ccdom)))).
