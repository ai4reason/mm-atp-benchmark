...
thf(cfovrnda_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ (ccxp @ XR @ XS) @ XC @ XF)) => ((Xph & ((cwcel @ XA2 @ XR) & (cwcel @ XB2 @ XS))) => (cwcel @ (cco @ XA2 @ XB2 @ XF) @ XC))))))))))).
