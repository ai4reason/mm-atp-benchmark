...
thf(cbr2ndeqgOLD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwcel @ XC @ XX)) => ((cwbr @ (ccop @ XA2 @ XB2) @ XC @ cc2nd) <=> (XC = XB2)))))))))).
