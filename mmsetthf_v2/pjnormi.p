...
thf(apjorthi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cwcel @ XH @ ccch) => ((cco @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ (ccfv @ XB2 @ (ccfv @ (ccfv @ XH @ ccort) @ ccpjh)) @ ccsp) = ccc0)))))))).
thf(ccr_tp,type,(ccr : ($i > $o))).
thf(ccaddc_tp,type,(ccaddc : ($i > $o))).
thf(ccexp_tp,type,(ccexp : ($i > $o))).
thf(cc2_tp,type,(cc2 : ($i > $o))).
thf(anormpyc_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => (((cco @ XA2 @ XB2 @ ccsp) = ccc0) => (cwbr @ (ccfv @ XA2 @ ccno) @ (ccfv @ (cco @ XA2 @ XB2 @ ccva) @ ccno) @ ccle)))))).
