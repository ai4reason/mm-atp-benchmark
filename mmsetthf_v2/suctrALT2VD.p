...
thf(ae03_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (Xph => ((cwvd3 @ Xps @ Xch @ Xth @ Xta) => ((Xph => (Xta => Xet)) => (cwvd3 @ Xps @ Xch @ Xth @ Xet))))))))))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(asssucid_ax,axiom,(! [XA2:($i > $o)] : (cwss @ XA2 @ (ccsuc @ XA2)))).
thf(ae123_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : ((cwvd1 @ Xph @ Xps) => ((cwvd2 @ Xph @ Xch @ Xth) => ((cwvd3 @ Xph @ Xch @ Xta @ Xet) => ((Xps => (Xth => (Xet => Xze))) => (cwvd3 @ Xph @ Xch @ Xta @ Xze))))))))))))).
...
thf(csuctrALT2VD_conj,conjecture,(! [XA2:($i > $o)] : ((cwtr @ XA2) => (cwtr @ (ccsuc @ XA2))))).
