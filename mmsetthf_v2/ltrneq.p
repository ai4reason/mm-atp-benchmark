...
thf(are1tbw2_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
...
thf(cltrneq_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XW:($i > $o)] : ((! [Xp:$i] : ((Xc_le @ Xp) = (ccfv @ XK @ ccple))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ (cwcel @ XF @ XT) @ (cwcel @ XG @ XT)) => ((cwral @ (^ [Xp:$i] : ((~ (cwbr @ (ccv @ Xp) @ XW @ (Xc_le @ Xp))) => ((ccfv @ (ccv @ Xp) @ XF) = (ccfv @ (ccv @ Xp) @ XG)))) @ (^ [Xp:$i] : XA2)) <=> (XF = XG)))))))))))))))).
