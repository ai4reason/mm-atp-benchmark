...
thf(alincvalsng_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XS = (ccfv @ XM @ ccsca)) => ((XR = (ccfv @ XS @ ccbs)) => ((Xc_x = (ccfv @ XM @ ccvsca)) => ((cw3a @ (cwcel @ XM @ cclmod) @ (cwcel @ XV @ XB2) @ (cwcel @ XY @ XR)) => ((cco @ (ccsn @ (ccop @ XV @ XY)) @ (ccsn @ XV) @ (ccfv @ XM @ cclinc)) = (cco @ XY @ XV @ Xc_x))))))))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(asimpri_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(aax_mp_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((Xph => Xps) => Xps))))).
thf(ccprime_tp,type,(ccprime : ($i > $o))).
thf(ccmul_tp,type,(ccmul : ($i > $o))).
thf(azlmodzxznm_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [Xc_xb:($i > ($i > $o))] : (! [Xc_mi:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xi:$i] : ((XZ @ Xi) = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm))) => ((! [Xi:$i] : ((Xc_0 @ Xi) = (ccpr @ (ccop @ ccc0 @ ccc0) @ (ccop @ cc1 @ ccc0)))) => ((! [Xi:$i] : ((Xc_xb @ Xi) = (ccfv @ (XZ @ Xi) @ ccvsca))) => ((! [Xi:$i] : ((Xc_mi @ Xi) = (ccfv @ (XZ @ Xi) @ ccsg))) => ((! [Xi:$i] : ((XA2 @ Xi) = (ccpr @ (ccop @ ccc0 @ cc3) @ (ccop @ cc1 @ cc6)))) => ((! [Xi:$i] : ((XB2 @ Xi) = (ccpr @ (ccop @ ccc0 @ cc2) @ (ccop @ cc1 @ cc4)))) => (cwral @ (^ [Xi:$i] : ((cwne @ (cco @ (ccv @ Xi) @ (XA2 @ Xi) @ (Xc_xb @ Xi)) @ (XB2 @ Xi)) & (cwne @ (cco @ (ccv @ Xi) @ (XB2 @ Xi) @ (Xc_xb @ Xi)) @ (XA2 @ Xi)))) @ (^ [Xi:$i] : ccz))))))))))))))).
...
thf(cldepsnlinclem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => ((XA2 = (ccpr @ (ccop @ ccc0 @ cc3) @ (ccop @ cc1 @ cc6))) => ((XB2 = (ccpr @ (ccop @ ccc0 @ cc2) @ (ccop @ cc1 @ cc4))) => ((cwcel @ XF @ (cco @ (ccfv @ czring @ ccbs) @ (ccsn @ XB2) @ ccmap)) => (cwne @ (cco @ XF @ (ccsn @ XB2) @ (ccfv @ XZ @ cclinc)) @ XA2)))))))))).
