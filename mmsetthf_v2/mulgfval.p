...
thf(adf_mulg_ax,axiom,(ccmg = (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccmpt2 @ (^ [Xn:$i] : (^ [Xx3:$i] : ccz)) @ (^ [Xn:$i] : (^ [Xx3:$i] : (ccfv @ (ccv @ Xg1) @ ccbs))) @ (^ [Xn:$i] : (^ [Xx3:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ (ccfv @ (ccv @ Xg1) @ cc0g) @ (ccsb @ (ccseq @ (ccfv @ (ccv @ Xg1) @ ccplusg) @ (ccxp @ ccn @ (ccsn @ (ccv @ Xx3))) @ cc1) @ (^ [Xs1:$i] : (ccif @ (cwbr @ ccc0 @ (ccv @ Xn) @ cclt) @ (ccfv @ (ccv @ Xn) @ (ccv @ Xs1)) @ (ccfv @ (ccfv @ (ccneg @ (ccv @ Xn)) @ (ccv @ Xs1)) @ (ccfv @ (ccv @ Xg1) @ ccminusg))))))))))))).
