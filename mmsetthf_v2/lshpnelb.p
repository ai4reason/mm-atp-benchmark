...
thf(alshpnel_ax,axiom,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((XH = (ccfv @ XW @ cclsh)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XU @ XH)) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => ((cco @ XU @ (ccfv @ (ccsn @ XX) @ XN) @ Xc_po) = XV)) => (Xph => (~ (cwcel @ XX @ XU)))))))))))))))))))).
thf(clshpnelb_conj,conjecture,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((XH = (ccfv @ XW @ cclsh)) => ((Xph => (cwcel @ XW @ cclvec)) => ((Xph => (cwcel @ XU @ XH)) => ((Xph => (cwcel @ XX @ XV)) => (Xph => ((~ (cwcel @ XX @ XU)) <=> ((cco @ XU @ (ccfv @ (ccsn @ XX) @ XN) @ Xc_po) = XV))))))))))))))))))).
