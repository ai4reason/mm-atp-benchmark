...
thf(codeq1_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XO = (ccfv @ XG @ ccod)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((XX = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX)) => (((ccfv @ XA2 @ XO) = cc1) <=> (XA2 = Xc_0)))))))))))).
