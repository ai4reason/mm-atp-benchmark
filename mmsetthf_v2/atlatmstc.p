...
thf(alubid_ax,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (XB2 = (ccfv @ (XK @ Xy1) @ ccbs))) => ((! [Xy1:$i] : (Xc_le = (ccfv @ (XK @ Xy1) @ ccple))) => ((! [Xy1:$i] : ((XU @ Xy1) = (ccfv @ (XK @ Xy1) @ cclub))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ (XK @ Xy1) @ ccpo))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XX @ XB2))) => (! [Xy1:$i] : ((Xph @ Xy1) => ((ccfv @ (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ XX @ Xc_le)) @ (^ [Xy1:$i] : XB2)) @ (XU @ Xy1)) = XX))))))))))))))).
...
thf(catlatmstc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (XB2 = (ccfv @ (XK @ Xy1) @ ccbs))) => ((! [Xy1:$i] : (Xc_le = (ccfv @ (XK @ Xy1) @ ccple))) => ((! [Xy1:$i] : ((Xc_1 @ Xy1) = (ccfv @ (XK @ Xy1) @ cclub))) => ((! [Xy1:$i] : (XA2 = (ccfv @ (XK @ Xy1) @ ccatm))) => (! [Xy1:$i] : (((cw3a @ (cwcel @ (XK @ Xy1) @ ccoml) @ (cwcel @ (XK @ Xy1) @ cccla) @ (cwcel @ (XK @ Xy1) @ ccal)) & (cwcel @ XX @ XB2)) => ((ccfv @ (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ XX @ Xc_le)) @ (^ [Xy1:$i] : XA2)) @ (Xc_1 @ Xy1)) = XX)))))))))))))).
