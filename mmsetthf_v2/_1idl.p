...
thf(aidlrmulcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XH = (ccfv @ XR @ cc2nd)) => ((XX = (ccrn @ XG)) => ((((cwcel @ XR @ ccrngo) & (cwcel @ XI @ (ccfv @ XR @ ccidl))) & ((cwcel @ XA2 @ XI) & (cwcel @ XB2 @ XX))) => (cwcel @ (cco @ XA2 @ XB2 @ XH) @ XI))))))))))))).
