...
thf(amulne0b_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => (((cwne @ XA2 @ ccc0) & (cwne @ XB2 @ ccc0)) <=> (cwne @ (cco @ XA2 @ XB2 @ ccmul) @ ccc0)))))).
...
thf(advcnp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (cco @ XK @ XA2 @ ccrest)) => ((XK = (ccfv @ cccnfld @ cctopn)) => ((! [Xz:$i] : ((XG @ Xz) = (ccmpt @ (^ [Xz:$i] : XA2) @ (^ [Xz:$i] : (ccif @ ((ccv @ Xz) = XB2) @ (ccfv @ XB2 @ (cco @ XS @ XF @ ccdv)) @ (cco @ (cco @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ XB2 @ XF) @ ccmin) @ (cco @ (ccv @ Xz) @ XB2 @ ccmin) @ ccdiv)))))) => (! [Xz:$i] : (((cw3a @ (cwcel @ XS @ (ccpr @ ccr @ ccc)) @ (cwf @ XA2 @ ccc @ XF) @ (cwss @ XA2 @ XS)) & (cwcel @ XB2 @ (ccdm @ (cco @ XS @ XF @ ccdv)))) => (cwcel @ (XG @ Xz) @ (ccfv @ XB2 @ (cco @ XJ @ XK @ cccnp)))))))))))))))).
...
thf(arlimcnp3_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : ((Xph => (cwcel @ XC @ ccc)) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ ccrp)) => (cwcel @ (XS @ Xy1) @ ccc))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xy1) = (cco @ cc1 @ (ccv @ Xx3) @ ccdiv)) => ((XS @ Xy1) = (XR @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XJ @ Xx3 @ Xy1) = (ccfv @ cccnfld @ cctopn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XK @ Xx3 @ Xy1) = (cco @ (XJ @ Xx3 @ Xy1) @ (cco @ ccc0 @ ccpnf @ ccico) @ ccrest)))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((cwbr @ (ccmpt @ (^ [Xy1:$i] : ccrp) @ (^ [Xy1:$i] : (XS @ Xy1))) @ XC @ ccrli) <=> (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ ccpnf @ ccico)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = ccc0) @ XC @ (XR @ Xx3)))) @ (ccfv @ ccc0 @ (cco @ (XK @ Xx3 @ Xy1) @ (XJ @ Xx3 @ Xy1) @ cccnp))))))))))))))))))).
thf(arpcn_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwcel @ XA2 @ ccc)))).
thf(arpne0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwne @ XA2 @ ccc0)))).
thf(cefrlim_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : ((! [Xk:$i] : ((XS @ Xk) = (cco @ ccc0 @ (cco @ cc1 @ (cco @ (ccfv @ XA2 @ ccabs) @ cc1 @ ccaddc) @ ccdiv) @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl)))) => ((cwcel @ XA2 @ ccc) => (cwbr @ (ccmpt @ (^ [Xk:$i] : ccrp) @ (^ [Xk:$i] : (cco @ (cco @ cc1 @ (cco @ XA2 @ (ccv @ Xk) @ ccdiv) @ ccaddc) @ (ccv @ Xk) @ cccxp))) @ (ccfv @ XA2 @ cce) @ ccrli)))))).
