...
thf(afrege56c_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : (cwcel @ XB2 @ (XC @ Xx3))) => (((XA2 = XB2) => ((cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ XA2) => (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ XB2))) => ((XB2 = XA2) => ((cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ XA2) => (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ XB2)))))))))).
