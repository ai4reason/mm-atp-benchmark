...
thf(adf_archi_ax,axiom,(ccarchi = (ccab @ (^ [Xw:$i] : ((ccfv @ (ccv @ Xw) @ ccinftm) = cc0))))).
...
thf(ainftmrel_ax,axiom,(! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((cwcel @ XW @ XV) => (cwss @ (ccfv @ XW @ ccinftm) @ (ccxp @ XB2 @ XB2)))))))).
...
thf(assrel2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwss @ XR @ (ccxp @ XA2 @ XB2)) => ((cwss @ XR @ XS) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XR) => (cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XS))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))))).
