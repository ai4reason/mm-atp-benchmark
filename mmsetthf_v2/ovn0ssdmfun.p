...
thf(afvn0ssdmfun_ax,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : ((cwral @ (^ [Xa:$i] : (cwne @ (ccfv @ (ccv @ Xa) @ XF) @ cc0)) @ (^ [Xa:$i] : XD)) => ((cwss @ XD @ (ccdm @ XF)) & (cwfun @ (ccres @ XF @ XD))))))).
thf(covn0ssdmfun_conj,conjecture,(! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwne @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ XF) @ cc0)) @ (^ [Xb:$i] : XE))) @ (^ [Xa:$i] : XD)) => ((cwss @ (ccxp @ XD @ XE) @ (ccdm @ XF)) & (cwfun @ (ccres @ XF @ (ccxp @ XD @ XE))))))))).
