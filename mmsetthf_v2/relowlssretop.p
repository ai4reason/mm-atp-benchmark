...
thf(aicoreelrn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XI:($i > ($i > $o))] : ((! [Xz:$i] : ((XI @ Xz) = (ccima @ ccico @ (ccxp @ ccr @ ccr)))) => (! [Xz:$i] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (cwcel @ (ccrab @ (^ [Xz:$i] : ((cwbr @ XA2 @ (ccv @ Xz) @ ccle) & (cwbr @ (ccv @ Xz) @ XB2 @ cclt))) @ (^ [Xz:$i] : ccr)) @ (XI @ Xz))))))))).
...
thf(crelowlssretop_conj,conjecture,(! [XI:($i > $o)] : ((XI = (ccima @ ccico @ (ccxp @ ccr @ ccr))) => (cwss @ (ccfv @ (ccrn @ ccioo) @ cctg) @ (ccfv @ XI @ cctg))))).
