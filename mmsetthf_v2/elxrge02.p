...
thf(aeliccioo_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwbr @ XA2 @ XB2 @ ccle)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc)) <=> (cw3o @ (XC = XA2) @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo)) @ (XC = XB2)))))))).
...
thf(celxrge02_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc)) <=> (cw3o @ (XA2 = ccc0) @ (cwcel @ XA2 @ ccrp) @ (XA2 = ccpnf))))).
