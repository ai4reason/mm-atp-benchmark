...
thf(aditgeq1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : ((XA2 = XB2) => ((ccdit @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (XD @ Xx3))) = (ccdit @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (XD @ Xx3)))))))))).
