...
thf(aiooin_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & ((cwcel @ XC @ ccxr) & (cwcel @ XD @ ccxr))) => ((ccin @ (cco @ XA2 @ XB2 @ ccioo) @ (cco @ XC @ XD @ ccioo)) = (cco @ (ccif @ (cwbr @ XA2 @ XC @ ccle) @ XC @ XA2) @ (ccif @ (cwbr @ XB2 @ XD @ ccle) @ XB2 @ XD) @ ccioo)))))))).
...
thf(aislptre_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((Xph => (cwss @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((cwcel @ XB2 @ (ccfv @ XA2 @ (ccfv @ XJ @ cclp))) <=> (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : ((cwcel @ XB2 @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccioo)) => (cwne @ (ccin @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccioo) @ (ccdif @ XA2 @ (ccsn @ XB2))) @ cc0))) @ (^ [Xb:$i] : ccxr))) @ (^ [Xa:$i] : ccxr)))))))))))).
thf(aa1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(aioossre_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ ccr)))).
thf(clptioo2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => (Xph => (cwcel @ XB2 @ (ccfv @ (cco @ XA2 @ XB2 @ ccioo) @ (ccfv @ XJ @ cclp))))))))))))).
