...
thf(cimacosupp_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XF @ XV) & (cwcel @ XG @ XW)) => (((cwfun @ XG) & (cwss @ (cco @ XF @ XZ @ ccsupp) @ (ccrn @ XG))) => ((ccima @ XG @ (cco @ (cccom @ XF @ XG) @ XZ @ ccsupp)) = (cco @ XF @ XZ @ ccsupp)))))))))).
