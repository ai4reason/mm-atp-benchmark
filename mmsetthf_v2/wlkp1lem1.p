...
thf(cwlkp1lem1_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XG @ cciedg)) => ((Xph => (cwfun @ XI)) => ((Xph => (cwcel @ XI @ ccfn)) => ((Xph => (cwcel @ XB2 @ ccvv)) => ((Xph => (cwcel @ XC @ XV)) => ((Xph => (~ (cwcel @ XB2 @ (ccdm @ XI)))) => ((Xph => (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks))) => ((XN = (ccfv @ XF @ cchash)) => (Xph => (~ (cwcel @ (cco @ XN @ cc1 @ ccaddc) @ (ccdm @ XP))))))))))))))))))))))).
