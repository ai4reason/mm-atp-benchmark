...
thf(abrinxprnres_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XC @ XV) => ((cwbr @ XB2 @ XC @ (ccin @ XR @ (ccxp @ XA2 @ (ccrn @ (ccres @ XR @ XA2))))) <=> ((cwcel @ XB2 @ XA2) & (cwbr @ XB2 @ XC @ XR)))))))))).
thf(adf_br_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwbr @ XA2 @ XB2 @ XR) <=> (cwcel @ (ccop @ XA2 @ XB2) @ XR)))))).
thf(cinxprnres_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((ccin @ XR @ (ccxp @ XA2 @ (ccrn @ (ccres @ XR @ XA2)))) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR))))))))).
