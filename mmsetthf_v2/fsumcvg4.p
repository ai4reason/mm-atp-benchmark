...
thf(affs2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XC = (ccdif @ XB2 @ (ccsn @ XZ))) => ((cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XZ @ XW) @ (cwf @ XA2 @ XB2 @ XF)) => ((cco @ XF @ XZ @ ccsupp) = (ccima @ (cccnv @ XF) @ XC)))))))))))).
...
thf(cfsumcvg4_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((XS = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwf @ XS @ ccc @ XF)) => ((Xph => (cwcel @ (ccima @ (cccnv @ XF) @ (ccdif @ ccc @ (ccsn @ ccc0))) @ ccfn)) => (Xph => (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli)))))))))))).
