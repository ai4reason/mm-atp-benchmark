...
thf(cfnmptfvd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwfn @ XM @ XA2)) => ((! [Xi:$i] : (! [Xa:$i] : (((ccv @ Xi) = (ccv @ Xa)) => ((XD @ Xi) = (XC @ Xa))))) => ((! [Xi:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ XA2)) => (cwcel @ (XD @ Xi) @ XU))) => ((! [Xa:$i] : ((Xph & (cwcel @ (ccv @ Xa) @ XA2)) => (cwcel @ (XC @ Xa) @ XV))) => (Xph => ((XM = (ccmpt @ (^ [Xa:$i] : XA2) @ (^ [Xa:$i] : (XC @ Xa)))) <=> (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XM) = (XD @ Xi))) @ (^ [Xi:$i] : XA2)))))))))))))))).
