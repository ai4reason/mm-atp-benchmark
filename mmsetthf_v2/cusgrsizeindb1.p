...
thf(ausgr1v0e_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ ccusgr) & ((ccfv @ XV @ cchash) = cc1)) => ((ccfv @ XE @ cchash) = ccc0)))))))).
...
thf(ccusgrsizeindb1_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ ccusgr) & ((ccfv @ XV @ cchash) = cc1)) => ((ccfv @ XE @ cchash) = (cco @ (ccfv @ XV @ cchash) @ cc2 @ ccbc))))))))).
