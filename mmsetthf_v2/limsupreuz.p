...
thf(auzub_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xk:$i] : (cwnf @ (^ [Xj:$i] : (Xph @ Xx3 @ Xj @ Xk))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xj @ Xk) => (cwcel @ (XM @ Xx3 @ Xk) @ ccz))))) => ((! [Xx3:$i] : (! [Xk:$i] : (XZ = (ccfv @ (XM @ Xx3 @ Xk) @ ccuz)))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (((Xph @ Xx3 @ Xj @ Xk) & (cwcel @ (ccv @ Xj) @ XZ)) => (cwcel @ (XB2 @ Xj) @ ccr))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xj @ Xk) => ((cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : (cwbr @ (XB2 @ Xj) @ (ccv @ Xx3) @ ccle)) @ (^ [Xj:$i] : (ccfv @ (ccv @ Xk) @ ccuz)))) @ (^ [Xk:$i] : XZ))) @ (^ [Xx3:$i] : ccr)) <=> (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xj:$i] : (cwbr @ (XB2 @ Xj) @ (ccv @ Xx3) @ ccle)) @ (^ [Xj:$i] : XZ))) @ (^ [Xx3:$i] : ccr)))))))))))))))).
