...
thf(adscmet_ax,axiom,(! [XD:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XD @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ ((ccv @ Xx3) = (ccv @ Xy1)) @ ccc0 @ cc1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XX @ (XV @ Xx3 @ Xy1)) => (cwcel @ (XD @ Xx3 @ Xy1) @ (ccfv @ XX @ ccme)))))))))).
