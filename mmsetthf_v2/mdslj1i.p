...
thf(alediri_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => (cwss @ (cco @ (ccin @ XA2 @ XC) @ (ccin @ XB2 @ XC) @ cchj) @ (ccin @ (cco @ XA2 @ XB2 @ cchj) @ XC))))))))).
thf(cmdslj1i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwcel @ XD @ ccch) => ((((cwbr @ XA2 @ XB2 @ ccmd) & (cwbr @ XB2 @ XA2 @ ccdmd)) & ((cwss @ XA2 @ (ccin @ XC @ XD)) & (cwss @ (cco @ XC @ XD @ cchj) @ (cco @ XA2 @ XB2 @ cchj)))) => ((ccin @ (cco @ XC @ XD @ cchj) @ XB2) = (cco @ (ccin @ XC @ XB2) @ (ccin @ XD @ XB2) @ cchj)))))))))))).
