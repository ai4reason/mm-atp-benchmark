...
thf(adeg1val_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XA2 = (ccfv @ XF @ ccco1)) => ((cwcel @ XF @ XB2) => ((ccfv @ XF @ XD) = (ccsup @ (cco @ XA2 @ Xc_0 @ ccsupp) @ ccxr @ cclt)))))))))))))))).
thf(cdeg1mul3le_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XK = (ccfv @ XR @ ccbs)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xc_x = (ccfv @ XP @ ccmulr)) => ((XA2 = (ccfv @ XP @ ccascl)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XK) @ (cwcel @ XG @ XB2)) => (cwbr @ (ccfv @ (cco @ (ccfv @ XF @ XA2) @ XG @ Xc_x) @ XD) @ (ccfv @ XG @ XD) @ ccle)))))))))))))))))).
