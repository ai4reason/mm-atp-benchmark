...
thf(acnlnadjeui_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => ((cwcel @ XT @ cccop) => (cwreu @ (^ [Xt:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xy1) @ ccsp) = (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xt)) @ ccsp))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : cchil))) @ (^ [Xt:$i] : (ccin @ cclo @ cccop))))))).
...
thf(a_0cnop_ax,axiom,(cwcel @ cch0o @ cccop)).
