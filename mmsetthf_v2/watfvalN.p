...
thf(adf_watsN_ax,axiom,(ccwpointsN = (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccmpt @ (^ [Xd:$i] : (ccfv @ (ccv @ Xk) @ ccatm)) @ (^ [Xd:$i] : (ccdif @ (ccfv @ (ccv @ Xk) @ ccatm) @ (ccfv @ (ccsn @ (ccv @ Xd)) @ (ccfv @ (ccv @ Xk) @ ccpolN))))))))).
thf(amptex_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv))))).
thf(aeqeltri_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwcel @ XB2 @ XC) => (cwcel @ XA2 @ XC))))))).
thf(afvex_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(cwatfvalN_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XW:($i > ($i > $o))] : ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xd:$i] : ((XP @ Xd) = (ccfv @ XK @ ccpolN))) => ((! [Xd:$i] : ((XW @ Xd) = (ccfv @ XK @ ccwpointsN))) => (! [Xd:$i] : ((cwcel @ XK @ (XB2 @ Xd)) => ((XW @ Xd) = (ccmpt @ (^ [Xd:$i] : XA2) @ (^ [Xd:$i] : (ccdif @ XA2 @ (ccfv @ (ccsn @ (ccv @ Xd)) @ (ccfv @ XK @ ccpolN))))))))))))))))).
