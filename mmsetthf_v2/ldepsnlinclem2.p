...
thf(cldepsnlinclem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (cco @ czring @ (ccpr @ ccc0 @ cc1) @ ccfrlm)) => ((XA2 = (ccpr @ (ccop @ ccc0 @ cc3) @ (ccop @ cc1 @ cc6))) => ((XB2 = (ccpr @ (ccop @ ccc0 @ cc2) @ (ccop @ cc1 @ cc4))) => ((cwcel @ XF @ (cco @ (ccfv @ czring @ ccbs) @ (ccsn @ XA2) @ ccmap)) => (cwne @ (cco @ XF @ (ccsn @ XA2) @ (ccfv @ XZ @ cclinc)) @ XB2)))))))))).
