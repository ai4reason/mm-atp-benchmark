...
thf(cislptre_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((Xph => (cwss @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((cwcel @ XB2 @ (ccfv @ XA2 @ (ccfv @ XJ @ cclp))) <=> (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : ((cwcel @ XB2 @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccioo)) => (cwne @ (ccin @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccioo) @ (ccdif @ XA2 @ (ccsn @ XB2))) @ cc0))) @ (^ [Xb:$i] : ccxr))) @ (^ [Xa:$i] : ccxr)))))))))))).
