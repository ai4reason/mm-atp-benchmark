...
thf(cchmatval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XY = (cco @ XN @ XP @ ccmat)) => ((XX = (ccfv @ XR @ ccv1)) => ((XT = (cco @ XN @ XR @ ccmat2pmat)) => ((Xc_mi = (ccfv @ XY @ ccsg)) => ((Xc_x = (ccfv @ XY @ ccvsca)) => ((Xc_1 = (ccfv @ XY @ ccur)) => ((XH = (cco @ (cco @ XX @ Xc_1 @ Xc_x) @ (ccfv @ XM @ XT) @ Xc_mi)) => ((Xc_sm = (ccfv @ XP @ ccsg)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => (((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg) @ (cwcel @ XM @ XB2)) & ((cwcel @ XI @ XN) & (cwcel @ XJ @ XN))) => ((cco @ XI @ XJ @ XH) = (ccif @ (XI = XJ) @ (cco @ XX @ (cco @ XI @ XJ @ (ccfv @ XM @ XT)) @ Xc_sm) @ (cco @ Xc_0 @ (cco @ XI @ XJ @ (ccfv @ XM @ XT)) @ Xc_sm)))))))))))))))))))))))))))))))))).
