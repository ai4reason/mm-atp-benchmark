...
thf(cf13dfv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XA2 = (cctp @ XX @ XY @ XZ)) => (((cw3a @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XV) @ (cwcel @ XZ @ XW)) & (cw3a @ (cwne @ XX @ XY) @ (cwne @ XX @ XZ) @ (cwne @ XY @ XZ))) => ((cwf1 @ XA2 @ XB2 @ XF) <=> ((cwf @ XA2 @ XB2 @ XF) & (cw3a @ (cwne @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF)) @ (cwne @ (ccfv @ XX @ XF) @ (ccfv @ XZ @ XF)) @ (cwne @ (ccfv @ XY @ XF) @ (ccfv @ XZ @ XF))))))))))))))))).
