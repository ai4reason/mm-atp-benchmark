...
thf(acnmsubglem_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : ((XM = (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccdif @ ccc @ (ccsn @ ccc0)) @ ccress)) => ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) => (cwcel @ (ccv @ Xx3) @ ccc))) => ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) => (cwne @ (ccv @ Xx3) @ ccc0))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XA2)) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmul) @ XA2)))) => ((cwcel @ cc1 @ XA2) => ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) => (cwcel @ (cco @ cc1 @ (ccv @ Xx3) @ ccdiv) @ XA2))) => (cwcel @ XA2 @ (ccfv @ XM @ ccsubg))))))))))).
