...
thf(adfconn2_ax,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XX @ cctopon)) => ((cwcel @ XJ @ ccconn) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cw3a @ (cwne @ (ccv @ Xx3) @ cc0) @ (cwne @ (ccv @ Xy1) @ cc0) @ ((ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) = cc0)) => (cwne @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XX))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XJ))))))).
...
thf(cconnsuba_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwss @ XA2 @ XX)) => ((cwcel @ (cco @ XJ @ XA2 @ ccrest) @ ccconn) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cw3a @ (cwne @ (ccin @ (ccv @ Xx3) @ XA2) @ cc0) @ (cwne @ (ccin @ (ccv @ Xy1) @ XA2) @ cc0) @ ((ccin @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XA2) = cc0)) => (cwne @ (ccin @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XA2) @ XA2))) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XJ)))))))).
