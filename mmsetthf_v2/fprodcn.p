...
thf(anfcprod_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xk)))) => ((! [Xk:$i] : (cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xk)))) => (cwnfc @ (^ [Xx3:$i] : (ccprod @ (^ [Xk:$i] : (XA2 @ Xx3 @ Xk)) @ (^ [Xk:$i] : (XB2 @ Xx3 @ Xk)))))))))).
...
thf(aprodeq2sdv_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xk:$i] : (Xph => ((XB2 @ Xk) = (XC @ Xk)))) => (Xph => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) = (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))))))))))).
thf(cfprodcn_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (cwnf @ (^ [Xk:$i] : (Xph @ Xx3 @ Xk)))) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccfv @ cccnfld @ cctopn))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xk) => (cwcel @ (XJ @ Xx3) @ (ccfv @ XX @ cctopon))))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xk) => (cwcel @ XA2 @ ccfn)))) => ((! [Xx3:$i] : (! [Xk:$i] : (((Xph @ Xx3 @ Xk) & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xk))) @ (cco @ (XJ @ Xx3) @ (XK @ Xx3) @ cccn))))) => (! [Xx3:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xk) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xx3 @ Xk))))) @ (cco @ (XJ @ Xx3) @ (XK @ Xx3) @ cccn))))))))))))))))).
