...
thf(apwpwab_ax,axiom,(! [XA2:($i > $o)] : ((ccpw @ (ccpw @ XA2)) = (ccab @ (^ [Xx3:$i] : (cwss @ (ccuni @ (ccv @ Xx3)) @ XA2)))))).
thf(cpwpwssunieq_conj,conjecture,(! [XA2:($i > $o)] : (cwss @ (ccab @ (^ [Xx3:$i] : ((ccuni @ (ccv @ Xx3)) = XA2))) @ (ccpw @ (ccpw @ XA2))))).
