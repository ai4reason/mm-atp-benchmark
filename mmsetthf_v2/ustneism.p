...
thf(axpco_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwne @ XB2 @ cc0) => ((cccom @ (ccxp @ XB2 @ XC) @ (ccxp @ XA2 @ XB2)) = (ccxp @ XA2 @ XC))))))).
...
thf(custneism_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwss @ XV @ (ccxp @ XX @ XX)) & (cwcel @ XA2 @ XX)) => (cwss @ (ccxp @ (ccima @ XV @ (ccsn @ XA2)) @ (ccima @ XV @ (ccsn @ XA2))) @ (cccom @ XV @ (cccnv @ XV)))))))).
