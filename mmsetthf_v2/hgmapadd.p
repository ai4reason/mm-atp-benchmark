...
thf(almodacl_ax,axiom,(! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_pl = (ccfv @ XF @ ccplusg)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XX @ XK) @ (cwcel @ XY @ XK)) => (cwcel @ (cco @ XX @ XY @ Xc_pl) @ XK)))))))))))).
...
thf(alcdsadd_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pb:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XF = (ccfv @ XU @ ccsca)) => ((Xc_pl = (ccfv @ XF @ ccplusg)) => ((XC = (ccfv @ XW @ (ccfv @ XK @ cclcd))) => ((XS = (ccfv @ XC @ ccsca)) => ((Xc_pb = (ccfv @ XS @ ccplusg)) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => (Xph => (Xc_pb = Xc_pl))))))))))))))))))))).
