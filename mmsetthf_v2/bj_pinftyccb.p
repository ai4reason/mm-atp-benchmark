...
thf(abj_ccinftyssccbar_ax,axiom,(cwss @ ccccinfty @ ccccbar)).
...
thf(abj_elccinfty_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc)) => (cwcel @ (ccfv @ XA2 @ ccinftyexpi) @ ccccinfty)))).
thf(cbj_pinftyccb_conj,conjecture,(cwcel @ ccpinfty @ ccccbar)).
