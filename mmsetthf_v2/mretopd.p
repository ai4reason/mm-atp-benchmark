...
thf(acldval_ax,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ cctop) => ((ccfv @ XJ @ cccld) = (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccdif @ XX @ (ccv @ Xx3)) @ XJ)) @ (^ [Xx3:$i] : (ccpw @ XX))))))))).
...
thf(cmretopd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ (ccfv @ XB2 @ ccmre))) => ((Xph => (cwcel @ cc0 @ XM)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XM) @ (cwcel @ (ccv @ Xy1) @ XM)) => (cwcel @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XM)))) => ((! [Xz:$i] : ((XJ @ Xz) = (ccrab @ (^ [Xz:$i] : (cwcel @ (ccdif @ XB2 @ (ccv @ Xz)) @ XM)) @ (^ [Xz:$i] : (ccpw @ XB2))))) => (! [Xz:$i] : (Xph => ((cwcel @ (XJ @ Xz) @ (ccfv @ XB2 @ cctopon)) & (XM = (ccfv @ (XJ @ Xz) @ cccld)))))))))))))).
