...
thf(aclsf2_ax,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XK = (ccfv @ XJ @ cccl)) => ((cwcel @ XJ @ cctop) => (cwf @ (ccpw @ XX) @ (ccpw @ XX) @ XK)))))))).
...
thf(cclselmap_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XK = (ccfv @ XJ @ cccl)) => ((cwcel @ XJ @ cctop) => (cwcel @ XK @ (cco @ (ccpw @ XX) @ (ccpw @ XX) @ ccmap))))))))).
