...
thf(awfrlem8_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccwrecs @ XA2 @ XR @ XG)) => (((ccpred @ (ccdif @ XA2 @ (ccdm @ XF)) @ XR @ XX) = cc0) <=> ((ccpred @ XA2 @ XR @ XX) = (ccpred @ (ccdm @ XF) @ XR @ XX)))))))))).
...
thf(awfrdmcl_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccwrecs @ XA2 @ XR @ XG)) => ((cwcel @ XX @ (ccdm @ XF)) => (cwss @ (ccpred @ XA2 @ XR @ XX) @ (ccdm @ XF)))))))))).
...
thf(awfrdmss_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XF = (ccwrecs @ XA2 @ XR @ XG)) => (cwss @ (ccdm @ XF) @ XA2))))))).
...
thf(cwfrlem10_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xz:$i] : (cwwe @ XA2 @ (XR @ Xz))) => ((! [Xz:$i] : ((XF @ Xz) = (ccwrecs @ XA2 @ (XR @ Xz) @ (XG @ Xz)))) => (! [Xz:$i] : (((cwcel @ (ccv @ Xz) @ (ccdif @ XA2 @ (ccdm @ (XF @ Xz)))) & ((ccpred @ (ccdif @ XA2 @ (ccdm @ (XF @ Xz))) @ (XR @ Xz) @ (ccv @ Xz)) = cc0)) => ((ccpred @ XA2 @ (XR @ Xz) @ (ccv @ Xz)) = (ccdm @ (XF @ Xz)))))))))))).
