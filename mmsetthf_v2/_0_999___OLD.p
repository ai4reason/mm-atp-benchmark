...
thf(ageoisum1c_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XR @ ccc) @ (cwbr @ (ccfv @ XR @ ccabs) @ cc1 @ cclt)) => ((ccsu @ ccn @ (^ [Xk:$i] : (cco @ XA2 @ (cco @ XR @ (ccv @ Xk) @ ccexp) @ ccmul))) = (cco @ (cco @ XA2 @ XR @ ccmul) @ (cco @ cc1 @ XR @ ccmin) @ ccdiv)))))).
...
thf(c_0_999___OLD_conj,conjecture,((ccsu @ ccn @ (^ [Xk:$i] : (cco @ cc9 @ (cco @ cc10 @ (ccv @ Xk) @ ccexp) @ ccdiv))) = cc1)).
