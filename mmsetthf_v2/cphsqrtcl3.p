...
thf(asqrtnegd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => (Xph => ((ccfv @ (ccneg @ XA2) @ ccsqrt) = (cco @ cci @ (ccfv @ XA2 @ ccsqrt) @ ccmul)))))))).
...
thf(acphsqrtcl2_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((cw3a @ (cwcel @ XW @ cccph) @ (cwcel @ XA2 @ XK) @ (~ (cwcel @ (ccneg @ XA2) @ ccrp))) => (cwcel @ (ccfv @ XA2 @ ccsqrt) @ XK))))))))).
thf(ccphsqrtcl3_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((cw3a @ (cwcel @ XW @ cccph) @ (cwcel @ cci @ XK) @ (cwcel @ XA2 @ XK)) => (cwcel @ (ccfv @ XA2 @ ccsqrt) @ XK))))))))).
