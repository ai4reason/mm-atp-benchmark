...
thf(aiunsuc_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((XB2 @ Xx3) = XC))) => ((cciun @ (^ [Xx3:$i] : (ccsuc @ XA2)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (ccun @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XC)))))))).
...
thf(annaordr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccom) @ (cwcel @ XB2 @ ccom) @ (cwcel @ XC @ ccom)) => ((cwcel @ XA2 @ XB2) <=> (cwcel @ (cco @ XA2 @ XC @ ccoa) @ (cco @ XB2 @ XC @ ccoa)))))))).
...
thf(cpwsdompw_conj,conjecture,(! [XB2:($i > $o)] : (! [Xn:$i] : (((cwcel @ (ccv @ Xn) @ ccom) & (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ (ccv @ Xk) @ XB2) @ (ccpw @ (ccv @ Xk)) @ ccen)) @ (^ [Xk:$i] : (ccsuc @ (ccv @ Xn))))) => (cwbr @ (cciun @ (^ [Xk:$i] : (ccv @ Xn)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ XB2))) @ (ccfv @ (ccv @ Xn) @ XB2) @ ccsdm))))).
