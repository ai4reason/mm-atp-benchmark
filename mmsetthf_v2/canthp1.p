...
thf(a_1sdom2_ax,axiom,(cwbr @ cc1o @ cc2o @ ccsdm)).
thf(asdomdom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccsdm) => (cwbr @ XA2 @ XB2 @ ccdom))))).
thf(acdadom2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccdom) => (cwbr @ (cco @ XC @ XA2 @ cccda) @ (cco @ XC @ XB2 @ cccda) @ ccdom)))))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccpr_tp,type,(ccpr : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(acanthp1lem1_ax,axiom,(! [XA2:($i > $o)] : ((cwbr @ cc1o @ XA2 @ ccsdm) => (cwbr @ (cco @ XA2 @ cc2o @ cccda) @ (ccpw @ XA2) @ ccdom)))).
...
thf(acda1dif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ (cco @ XA2 @ cc1o @ cccda)) => (cwbr @ (ccdif @ (cco @ XA2 @ cc1o @ cccda) @ (ccsn @ XB2)) @ XA2 @ ccen))))).
