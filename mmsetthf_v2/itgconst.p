...
thf(citgconst_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwcel @ (ccfv @ XA2 @ ccvol) @ ccr) @ (cwcel @ XB2 @ ccc)) => ((ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2)) = (cco @ XB2 @ (ccfv @ XA2 @ ccvol) @ ccmul)))))).
