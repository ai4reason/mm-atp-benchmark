...
thf(afununfun_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwfun @ (ccun @ XF @ XG)) => ((cwfun @ XF) & (cwfun @ XG)))))).
...
thf(cfsuppunbi_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwfun @ (ccun @ XF @ XG))) => (Xph => ((cwbr @ (ccun @ XF @ XG) @ XZ @ ccfsupp) <=> ((cwbr @ XF @ XZ @ ccfsupp) & (cwbr @ XG @ XZ @ ccfsupp)))))))))).
