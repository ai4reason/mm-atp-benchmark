...
thf(acusgrcplgr_ax,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ cccusgr) => (cwcel @ XG @ cccplgr)))).
thf(ccuvtx_tp,type,(ccuvtx : ($i > $o))).
thf(anbcplgr_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ cccplgr) & (cwcel @ XN @ XV)) => ((cco @ XG @ XN @ ccnbgr) = (ccdif @ XV @ (ccsn @ XN))))))))).
...
thf(afusgrfis_ax,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ ccfusgr) => (cwcel @ (ccfv @ XG @ ccedg) @ ccfn)))).
thf(ccen_tp,type,(ccen : ($i > $o))).
thf(cwbr_tp,type,(cwbr : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(ahasheqf1o_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwcel @ XB2 @ ccfn)) => (((ccfv @ XA2 @ cchash) = (ccfv @ XB2 @ cchash)) <=> (? [Xf1:$i] : (cwf1o @ XA2 @ XB2 @ (ccv @ Xf1)))))))).
...
thf(ccusgrsizeindslem_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((cw3a @ (cwcel @ XG @ cccusgr) @ (cwcel @ XV @ ccfn) @ (cwcel @ XN @ XV)) => ((ccfv @ (ccrab @ (^ [Xe:$i] : (cwcel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)) @ cchash) = (cco @ (ccfv @ XV @ cchash) @ cc1 @ ccmin)))))))))).
