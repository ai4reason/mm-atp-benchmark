...
thf(aaxc9_b_ax,axiom,(! [Xx3:$i] : ((~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3)))) => ((~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3)))) => (((ccv @ Xx3) = (ccv @ Xx3)) => (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3)))))))).
...
thf(chbae_b_conj,conjecture,((! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3))) => (! [Xx3:$i] : (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3)))))).
