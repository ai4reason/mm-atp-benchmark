...
thf(acsbcom_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : ((ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (ccsb @ (XB2 @ Xy1) @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))) = (ccsb @ (XB2 @ Xy1) @ (^ [Xy1:$i] : (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xy1)))))))))))).
