...
thf(acosseqd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cccoss @ XA2) = (cccoss @ XB2)))))))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(aresdm_ax,axiom,(! [XA2:($i > $o)] : ((cwrel @ XA2) => ((ccres @ XA2 @ (ccdm @ XA2)) = XA2)))).
thf(aadantr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph & Xch) => Xps)))))).
thf(abr1cossres2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XB2 @ XV) & (cwcel @ XC @ XW)) => ((cwbr @ XB2 @ XC @ (cccoss @ (ccres @ XR @ XA2))) <=> (cwrex @ (^ [Xx3:$i] : ((cwcel @ XB2 @ (ccec @ (ccv @ Xx3) @ XR)) & (cwcel @ XC @ (ccec @ (ccv @ Xx3) @ XR)))) @ (^ [Xx3:$i] : XA2))))))))))).
