...
thf(aax13b_b1_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xy1:$i] : (((~ ((ccv @ Xx3) = (ccv @ Xy1))) => (((ccv @ Xy1) = (ccv @ Xx3)) => (Xph @ Xx3 @ Xy1))) <=> ((~ ((ccv @ Xx3) = (ccv @ Xy1))) => ((~ ((ccv @ Xx3) = (ccv @ Xx3))) => (((ccv @ Xy1) = (ccv @ Xx3)) => (Xph @ Xx3 @ Xy1))))))))).
thf(cax13_b1_conj,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : ((~ ((ccv @ Xx3) = (ccv @ Xy1))) => (((ccv @ Xy1) = (ccv @ Xx3)) => (! [Xx3:$i] : ((ccv @ Xy1) = (ccv @ Xx3)))))))).
