...
thf(amspropd_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((Xph => (XB2 = (ccfv @ XK @ ccbs))) => ((Xph => (XB2 = (ccfv @ XL @ ccbs))) => ((Xph => ((ccres @ (ccfv @ XK @ ccds) @ (ccxp @ XB2 @ XB2)) = (ccres @ (ccfv @ XL @ ccds) @ (ccxp @ XB2 @ XB2)))) => ((Xph => ((ccfv @ XK @ cctopn) = (ccfv @ XL @ cctopn))) => (Xph => ((cwcel @ XK @ ccmt) <=> (cwcel @ XL @ ccmt)))))))))))).
...
thf(azlmds_ax,axiom,(! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccfv @ XG @ cczlm)) => ((XD = (ccfv @ XG @ ccds)) => ((cwcel @ XG @ XV) => (XD = (ccfv @ XW @ ccds)))))))))).
...
thf(azlmtset_ax,axiom,(! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccfv @ XG @ cczlm)) => ((XJ = (ccfv @ XG @ ccts)) => ((cwcel @ XG @ XV) => (XJ = (ccfv @ XW @ ccts)))))))))).
...
thf(aabvpropd2_ax,axiom,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((Xph => ((ccfv @ XK @ ccbs) = (ccfv @ XL @ ccbs))) => ((Xph => ((ccfv @ XK @ ccplusg) = (ccfv @ XL @ ccplusg))) => ((Xph => ((ccfv @ XK @ ccmulr) = (ccfv @ XL @ ccmulr))) => (Xph => ((ccfv @ XK @ ccabv) = (ccfv @ XL @ ccabv)))))))))).
...
thf(czhmnrg_conj,conjecture,(! [XG:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccfv @ XG @ cczlm)) => ((cwcel @ XG @ ccnrg) => (cwcel @ XW @ ccnrg)))))).
