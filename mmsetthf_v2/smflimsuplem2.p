...
thf(alimsupubuzmpt_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (cwnf @ (^ [Xj:$i] : (Xph @ Xx3 @ Xj)))) => ((! [Xx3:$i] : (XZ = (ccfv @ (XM @ Xx3) @ ccuz))) => ((! [Xx3:$i] : (! [Xj:$i] : (((Xph @ Xx3 @ Xj) & (cwcel @ (ccv @ Xj) @ XZ)) => (cwcel @ (XB2 @ Xj) @ ccr)))) => ((! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xj) => (cwne @ (ccfv @ (ccmpt @ (^ [Xj:$i] : XZ) @ (^ [Xj:$i] : (XB2 @ Xj))) @ cclsp) @ ccpnf)))) => (! [Xx3:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xj) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xj:$i] : (cwbr @ (XB2 @ Xj) @ (ccv @ Xx3) @ ccle)) @ (^ [Xj:$i] : XZ))) @ (^ [Xx3:$i] : ccr)))))))))))))).
...
thf(alimsupequz_ax,axiom,(! [Xph:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XG @ Xk))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XM @ Xk) @ ccz))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwfn @ (XF @ Xk) @ (ccfv @ (XM @ Xk) @ ccuz)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XN @ Xk) @ ccz))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwfn @ (XG @ Xk) @ (ccfv @ (XN @ Xk) @ ccuz)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XK @ ccz))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ (ccfv @ XK @ ccuz))) => ((ccfv @ (ccv @ Xk) @ (XF @ Xk)) = (ccfv @ (ccv @ Xk) @ (XG @ Xk))))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccfv @ (XF @ Xk) @ cclsp) = (ccfv @ (XG @ Xk) @ cclsp)))))))))))))))))))).
...
thf(amptfnd_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwfn @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (XA2 @ Xx3)))))))))))).
...
thf(amptexf_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((! [Xx3:$i] : (cwcel @ (XA2 @ Xx3) @ ccvv)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccvv)))))).
...
thf(csmflimsuplem2_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xn:$i] : (cwnf @ (^ [Xm:$i] : (Xph @ Xx3 @ Xm @ Xn))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwcel @ (XM @ Xx3 @ Xn) @ ccz))))) => ((! [Xx3:$i] : (! [Xn:$i] : (XZ = (ccfv @ (XM @ Xx3 @ Xn) @ ccuz)))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwcel @ (XS @ Xx3 @ Xm @ Xn) @ ccsalg))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwf @ XZ @ (ccfv @ (XS @ Xx3 @ Xm @ Xn) @ ccsmblfn) @ (XF @ Xm @ Xn)))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XE @ Xx3 @ Xm @ Xn) = (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ (XF @ Xm @ Xn)))))) @ ccxr @ cclt) @ ccr)) @ (^ [Xx3:$i] : (cciin @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)) @ (^ [Xm:$i] : (ccdm @ (ccfv @ (ccv @ Xm) @ (XF @ Xm @ Xn))))))))))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XH @ Xx3 @ Xm @ Xn) = (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccmpt @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xn) @ (XE @ Xx3 @ Xm @ Xn))) @ (^ [Xx3:$i] : (ccsup @ (ccrn @ (ccmpt @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xm) @ (XF @ Xm @ Xn)))))) @ ccxr @ cclt))))))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwcel @ (ccv @ Xn) @ XZ))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwcel @ (ccfv @ (ccmpt @ (^ [Xm:$i] : XZ) @ (^ [Xm:$i] : (ccfv @ (XX @ Xx3 @ Xn) @ (ccfv @ (ccv @ Xm) @ (XF @ Xm @ Xn))))) @ cclsp) @ ccr))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwcel @ (XX @ Xx3 @ Xn) @ (cciin @ (^ [Xm:$i] : (ccfv @ (ccv @ Xn) @ ccuz)) @ (^ [Xm:$i] : (ccdm @ (ccfv @ (ccv @ Xm) @ (XF @ Xm @ Xn)))))))))) => (! [Xx3:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xm @ Xn) => (cwcel @ (XX @ Xx3 @ Xn) @ (ccdm @ (ccfv @ (ccv @ Xn) @ (XH @ Xx3 @ Xm @ Xn))))))))))))))))))))))))))).
