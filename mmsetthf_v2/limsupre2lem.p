...
thf(axrre4_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccxr) => ((cwcel @ XA2 @ ccr) <=> ((cwne @ XA2 @ ccmnf) & (cwne @ XA2 @ ccpnf)))))).
...
thf(alimsupmnf_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xj:$i] : (XF @ Xj))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xj @ Xk) => (cwss @ XA2 @ ccr))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xj @ Xk) => (cwf @ XA2 @ ccxr @ (XF @ Xj)))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xj @ Xk) => (((ccfv @ (XF @ Xj) @ cclsp) = ccmnf) <=> (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : ((cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) => (cwbr @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ (ccv @ Xx3) @ ccle))) @ (^ [Xj:$i] : XA2))) @ (^ [Xk:$i] : ccr))) @ (^ [Xx3:$i] : ccr)))))))))))))).
...
thf(alimsuppnf_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xj:$i] : (XF @ Xj))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xj @ Xk) => (cwss @ XA2 @ ccr))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xj @ Xk) => (cwf @ XA2 @ ccxr @ (XF @ Xj)))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xj @ Xk) => (((ccfv @ (XF @ Xj) @ cclsp) = ccpnf) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xj:$i] : ((cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) & (cwbr @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xj) @ (XF @ Xj)) @ ccle))) @ (^ [Xj:$i] : XA2))) @ (^ [Xk:$i] : ccr))) @ (^ [Xx3:$i] : ccr)))))))))))))).
