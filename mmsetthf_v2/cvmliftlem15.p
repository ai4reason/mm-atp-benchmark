...
thf(afunimacnv_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfun @ XF) => ((ccima @ XF @ (ccima @ (cccnv @ XF) @ XA2)) = (ccin @ XA2 @ (ccrn @ XF))))))).
...
thf(alebnumii_ax,axiom,(! [XU:($i > $o)] : (((cwss @ XU @ ccii) & ((cco @ ccc0 @ cc1 @ ccicc) = (ccuni @ XU))) => (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xu:$i] : (cwss @ (cco @ (cco @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ (ccv @ Xn) @ ccdiv) @ (cco @ (ccv @ Xk) @ (ccv @ Xn) @ ccdiv) @ ccicc) @ (ccv @ Xu))) @ (^ [Xu:$i] : XU))) @ (^ [Xk:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccfz)))) @ (^ [Xn:$i] : ccn))))).
...
thf(arexiunxp_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccop @ (ccv @ Xy1) @ (ccv @ Xz))) => ((Xph @ Xx3) <=> (Xps @ Xy1 @ Xz)))))) => ((cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (cciun @ (^ [Xy1:$i] : XA2) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (XB2 @ Xy1)))))) <=> (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (Xps @ Xy1 @ Xz)) @ (^ [Xz:$i] : (XB2 @ Xy1)))) @ (^ [Xy1:$i] : XA2))))))))).
