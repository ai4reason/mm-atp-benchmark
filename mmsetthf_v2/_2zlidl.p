...
thf(aislidl_ax,axiom,(! [XB2:($i > ($i > ($i > $o)))] : (! [Xc_pl:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XI:($i > $o)] : ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XU @ Xx3 @ Xa @ Xb) = (ccfv @ XR @ cclidl))))) => ((! [Xa:$i] : (! [Xb:$i] : ((XB2 @ Xa @ Xb) = (ccfv @ XR @ ccbs)))) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xc_pl @ Xx3 @ Xa @ Xb) = (ccfv @ XR @ ccplusg))))) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xc_x @ Xx3 @ Xa @ Xb) = (ccfv @ XR @ ccmulr))))) => (! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : ((cwcel @ XI @ (XU @ Xx3 @ Xa @ Xb)) <=> (cw3a @ (cwss @ XI @ (XB2 @ Xa @ Xb)) @ (cwne @ XI @ cc0) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwcel @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xa) @ (Xc_x @ Xx3 @ Xa @ Xb)) @ (ccv @ Xb) @ (Xc_pl @ Xx3 @ Xa @ Xb)) @ XI)) @ (^ [Xb:$i] : XI))) @ (^ [Xa:$i] : XI))) @ (^ [Xx3:$i] : (XB2 @ Xa @ Xb))))))))))))))))))).
...
thf(c_2zlidl_conj,conjecture,(! [XU:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xz:$i] : ((XE @ Xx3 @ Xz) = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xz) = (cco @ cc2 @ (ccv @ Xx3) @ ccmul))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccz))))) => ((! [Xx3:$i] : (! [Xz:$i] : ((XU @ Xx3 @ Xz) = (ccfv @ czring @ cclidl)))) => (! [Xx3:$i] : (! [Xz:$i] : (cwcel @ (XE @ Xx3 @ Xz) @ (XU @ Xx3 @ Xz))))))))).
