...
thf(cdecpmatmullem_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > $o)] : ((! [Xl:$i] : ((XP @ Xl) = (ccfv @ XR @ ccpl1))) => ((! [Xt:$i] : (! [Xl:$i] : ((XC @ Xt @ Xl) = (cco @ (XN @ Xl) @ (XP @ Xl) @ ccmat)))) => ((! [Xt:$i] : (! [Xl:$i] : ((XB2 @ Xl) = (ccfv @ (XC @ Xt @ Xl) @ ccbs)))) => (! [Xt:$i] : (! [Xl:$i] : ((cw3a @ ((cwcel @ (XN @ Xl) @ ccfn) & (cwcel @ XR @ ccrg)) @ ((cwcel @ XU @ (XB2 @ Xl)) & (cwcel @ XW @ (XB2 @ Xl))) @ (cw3a @ (cwcel @ XI @ (XN @ Xl)) @ (cwcel @ XJ @ (XN @ Xl)) @ (cwcel @ XK @ ccn0))) => ((cco @ XI @ XJ @ (cco @ (cco @ XU @ XW @ (ccfv @ (XC @ Xt @ Xl) @ ccmulr)) @ XK @ ccdecpmat)) = (cco @ XR @ (ccmpt @ (^ [Xt:$i] : (XN @ Xl)) @ (^ [Xt:$i] : (cco @ XR @ (ccmpt @ (^ [Xl:$i] : (cco @ ccc0 @ XK @ ccfz)) @ (^ [Xl:$i] : (cco @ (ccfv @ (ccv @ Xl) @ (ccfv @ (cco @ XI @ (ccv @ Xt) @ XU) @ ccco1)) @ (ccfv @ (cco @ XK @ (ccv @ Xl) @ ccmin) @ (ccfv @ (cco @ (ccv @ Xt) @ XJ @ XW) @ ccco1)) @ (ccfv @ XR @ ccmulr)))) @ ccgsu))) @ ccgsu))))))))))))))))))).
