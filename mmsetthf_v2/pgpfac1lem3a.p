...
thf(apgphash_ax,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => (((cwbr @ XP @ XG @ ccpgp) & (cwcel @ XX @ ccfn)) => ((ccfv @ XX @ cchash) = (cco @ XP @ (cco @ XP @ (ccfv @ XX @ cchash) @ ccpc) @ ccexp)))))))).
...
thf(asubgmulgcl_ax,axiom,(! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xc_x = (ccfv @ XG @ ccmg)) => ((cw3a @ (cwcel @ XS @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XN @ ccz) @ (cwcel @ XX @ XS)) => (cwcel @ (cco @ XN @ XX @ Xc_x) @ XS))))))))).
