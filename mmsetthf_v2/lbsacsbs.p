...
thf(clbsacsbs_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XW @ cclss)) => ((XN = (ccfv @ XA2 @ ccmrc)) => ((XX = (ccfv @ XW @ ccbs)) => ((XI = (ccfv @ XA2 @ ccmri)) => ((XJ = (ccfv @ XW @ cclbs)) => ((cwcel @ XW @ cclvec) => ((cwcel @ XS @ XJ) <=> ((cwcel @ XS @ XI) & ((ccfv @ XS @ XN) = XX))))))))))))))))).
