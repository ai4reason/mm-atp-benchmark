...
thf(cfvcofneq_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [Xx3:$i] : (((cwfn @ XG @ (XA2 @ Xx3)) & (cwfn @ XK @ (XB2 @ Xx3))) => ((cw3a @ (cwcel @ XX @ (ccin @ (XA2 @ Xx3) @ (XB2 @ Xx3))) @ ((ccfv @ XX @ XG) = (ccfv @ XX @ XK)) @ (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xx3) @ XH))) @ (^ [Xx3:$i] : (ccin @ (ccrn @ XG) @ (ccrn @ XK))))) => ((ccfv @ XX @ (cccom @ XF @ XG)) = (ccfv @ XX @ (cccom @ XH @ XK)))))))))))))).
