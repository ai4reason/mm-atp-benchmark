...
thf(acnzh_ax,axiom,(cwcel @ (ccfv @ cccnfld @ cczlm) @ ccnlm)).
...
thf(asubrgchr_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) => ((ccfv @ (cco @ XR @ XA2 @ ccress) @ ccchr) = (ccfv @ XR @ ccchr)))))).
thf(cccms_tp,type,(cccms : ($i > $o))).
thf(acnfldcusp_ax,axiom,(cwcel @ cccnfld @ cccusp)).
