...
thf(avdwpc_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : (! [Xa:$i] : (! [Xd:$i] : (cwcel @ (XX @ Xi @ Xa @ Xd) @ ccvv)))) => ((! [Xi:$i] : (! [Xa:$i] : (! [Xd:$i] : ((Xph @ Xi @ Xa @ Xd) => (cwcel @ XK @ ccn0))))) => ((! [Xi:$i] : (! [Xa:$i] : (! [Xd:$i] : ((Xph @ Xi @ Xa @ Xd) => (cwf @ (XX @ Xi @ Xa @ Xd) @ (XR @ Xi @ Xa @ Xd) @ XF))))) => ((! [Xi:$i] : (! [Xa:$i] : (! [Xd:$i] : ((Xph @ Xi @ Xa @ Xd) => (cwcel @ XM @ ccn))))) => ((! [Xa:$i] : ((XJ @ Xa) = (cco @ cc1 @ XM @ ccfz))) => (! [Xi:$i] : (! [Xa:$i] : (! [Xd:$i] : ((Xph @ Xi @ Xa @ Xd) => ((cwbr @ (ccop @ XM @ XK) @ XF @ ccvdwp) <=> (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xd:$i] : ((cwral @ (^ [Xi:$i] : (cwss @ (cco @ (cco @ (ccv @ Xa) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ ccaddc) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ (ccfv @ XK @ ccvdwa)) @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccfv @ (cco @ (ccv @ Xa) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ ccaddc) @ XF))))) @ (^ [Xi:$i] : (XJ @ Xa))) & ((ccfv @ (ccrn @ (ccmpt @ (^ [Xi:$i] : (XJ @ Xa)) @ (^ [Xi:$i] : (ccfv @ (cco @ (ccv @ Xa) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xd)) @ ccaddc) @ XF)))) @ cchash) = XM))) @ (^ [Xd:$i] : (cco @ ccn @ (XJ @ Xa) @ ccmap)))) @ (^ [Xa:$i] : ccn)))))))))))))))))))).
