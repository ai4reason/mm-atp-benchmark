...
thf(acdj3lem1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => ((cwrex @ (^ [Xx3:$i] : ((cwbr @ ccc0 @ (ccv @ Xx3) @ cclt) & (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (cco @ (ccfv @ (ccv @ Xy1) @ ccno) @ (ccfv @ (ccv @ Xz) @ ccno) @ ccaddc) @ (cco @ (ccv @ Xx3) @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ ccva) @ ccno) @ ccmul) @ ccle)) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : ccr)) => ((ccin @ XA2 @ XB2) = cc0h))))))).
...
thf(ashseli_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccph)) <=> (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (XC = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccva))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))))).
...
thf(acdj3lem2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XS @ Xx3 @ Xz @ Xw) = (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccph)) @ (^ [Xx3:$i] : (ccrio @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xz) @ (ccv @ Xw) @ ccva))) @ (^ [Xw:$i] : XB2))) @ (^ [Xz:$i] : XA2)))))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : ((cw3a @ (cwcel @ XC @ XA2) @ (cwcel @ XD @ XB2) @ ((ccin @ XA2 @ XB2) = cc0h)) => ((ccfv @ (cco @ XC @ XD @ ccva) @ (XS @ Xx3 @ Xz @ Xw)) = XC)))))))))))))).
...
thf(aaddge01_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ ccc0 @ XB2 @ ccle) <=> (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ ccaddc) @ ccle)))))).
...
thf(ccdj3lem2b_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XS @ Xx3 @ Xy1 @ Xz @ Xw) = (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccph)) @ (^ [Xx3:$i] : (ccrio @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xz) @ (ccv @ Xw) @ ccva))) @ (^ [Xw:$i] : XB2))) @ (^ [Xz:$i] : XA2))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((cwrex @ (^ [Xv:$i] : ((cwbr @ ccc0 @ (ccv @ Xv) @ cclt) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (cco @ (ccfv @ (ccv @ Xx3) @ ccno) @ (ccfv @ (ccv @ Xy1) @ ccno) @ ccaddc) @ (cco @ (ccv @ Xv) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccva) @ ccno) @ ccmul) @ ccle)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2)))) @ (^ [Xv:$i] : ccr)) => (cwrex @ (^ [Xv:$i] : ((cwbr @ ccc0 @ (ccv @ Xv) @ cclt) & (cwral @ (^ [Xu:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xu) @ (XS @ Xx3 @ Xy1 @ Xz @ Xw)) @ ccno) @ (cco @ (ccv @ Xv) @ (ccfv @ (ccv @ Xu) @ ccno) @ ccmul) @ ccle)) @ (^ [Xu:$i] : (cco @ XA2 @ XB2 @ ccph))))) @ (^ [Xv:$i] : ccr)))))))))))))).
