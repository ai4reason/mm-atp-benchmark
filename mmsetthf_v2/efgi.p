...
thf(aefgval_ax,axiom,(! [Xc_sm:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccfv @ (ccword @ (ccxp @ XI @ cc2o)) @ ccid)) => ((! [Xn:$i] : ((Xc_sm @ Xn) = (ccfv @ XI @ ccefg))) => (! [Xn:$i] : ((Xc_sm @ Xn) = (ccint @ (ccab @ (^ [Xr:$i] : ((cwer @ XW @ (ccv @ Xr)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xn:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccv @ Xx3) @ (cco @ (ccv @ Xx3) @ (ccotp @ (ccv @ Xn) @ (ccv @ Xn) @ (ccs2 @ (ccop @ (ccv @ Xy1) @ (ccv @ Xz)) @ (ccop @ (ccv @ Xy1) @ (ccdif @ cc1o @ (ccv @ Xz))))) @ ccsplice) @ (ccv @ Xr))) @ (^ [Xz:$i] : cc2o))) @ (^ [Xy1:$i] : XI))) @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xx3) @ cchash) @ ccfz)))) @ (^ [Xx3:$i] : XW)))))))))))))).
thf(cefgi_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccfv @ (ccword @ (ccxp @ XI @ cc2o)) @ ccid)) => ((Xc_sm = (ccfv @ XI @ ccefg)) => ((((cwcel @ XA2 @ XW) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XA2 @ cchash) @ ccfz))) & ((cwcel @ XJ @ XI) & (cwcel @ XK @ cc2o))) => (cwbr @ XA2 @ (cco @ XA2 @ (ccotp @ XN @ XN @ (ccs2 @ (ccop @ XJ @ XK) @ (ccop @ XJ @ (ccdif @ cc1o @ XK)))) @ ccsplice) @ Xc_sm)))))))))))).
