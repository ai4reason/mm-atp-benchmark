...
thf(advdsflip_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : ((XA2 @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XN @ ccdvds)) @ (^ [Xx3:$i] : ccn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xy1:$i] : (XA2 @ Xx3)) @ (^ [Xy1:$i] : (cco @ XN @ (ccv @ Xy1) @ ccdiv)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XN @ ccn) => (cwf1o @ (XA2 @ Xx3) @ (XA2 @ Xx3) @ (XF @ Xx3 @ Xy1))))))))))).
...
thf(addcan_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwne @ XA2 @ ccc0)) & ((cwcel @ XB2 @ ccc) & (cwne @ XB2 @ ccc0))) => ((cco @ XA2 @ (cco @ XA2 @ XB2 @ ccdiv) @ ccdiv) = XB2))))).
