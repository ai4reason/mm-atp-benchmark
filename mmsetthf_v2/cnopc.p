...
thf(ccnopc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwcel @ XT @ cccop) @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ ccrp)) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccfv @ (cco @ (ccv @ Xy1) @ XA2 @ ccmv) @ ccno) @ (ccv @ Xx3) @ cclt) => (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XT) @ (ccfv @ XA2 @ XT) @ ccmv) @ ccno) @ XB2 @ cclt))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : ccrp))))))).
