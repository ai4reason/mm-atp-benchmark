...
thf(aacnrcl_ax,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ (cwacn @ XA2)) => (cwcel @ XA2 @ ccvv))))).
...
thf(aisacn_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (((cwcel @ XX @ (XV @ Xx3 @ Xf1 @ Xg1)) & (cwcel @ XA2 @ (XW @ Xx3 @ Xf1 @ Xg1))) => ((cwcel @ XX @ (cwacn @ XA2)) <=> (cwral @ (^ [Xf1:$i] : (? [Xg1:$i] : (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)))) @ (^ [Xx3:$i] : XA2)))) @ (^ [Xf1:$i] : (cco @ (ccdif @ (ccpw @ XX) @ (ccsn @ cc0)) @ XA2 @ ccmap))))))))))))).
...
thf(cacni_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ (cwacn @ XA2)) & (cwf @ XA2 @ (ccdif @ (ccpw @ XX) @ (ccsn @ cc0)) @ XF)) => (? [Xg1:$i] : (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : XA2)))))))).
