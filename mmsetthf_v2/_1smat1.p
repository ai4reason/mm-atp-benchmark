...
thf(asmatlem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XS = (cco @ XK @ XL @ (ccfv @ XA2 @ ccsmat))) => ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XK @ (cco @ cc1 @ XM @ ccfz))) => ((Xph => (cwcel @ XL @ (cco @ cc1 @ XN @ ccfz))) => ((Xph => (cwcel @ XA2 @ (cco @ XB2 @ (ccxp @ (cco @ cc1 @ XM @ ccfz) @ (cco @ cc1 @ XN @ ccfz)) @ ccmap))) => ((Xph => (cwcel @ XI @ ccn)) => ((Xph => (cwcel @ XJ @ ccn)) => ((Xph => ((ccif @ (cwbr @ XI @ XK @ cclt) @ XI @ (cco @ XI @ cc1 @ ccaddc)) = XX)) => ((Xph => ((ccif @ (cwbr @ XJ @ XL @ cclt) @ XJ @ (cco @ XJ @ cc1 @ ccaddc)) = XY)) => (Xph => ((cco @ XI @ XJ @ XS) = (cco @ XX @ XY @ XA2)))))))))))))))))))))))))).
...
thf(afznatpl1_ax,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XI @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))) => (cwcel @ (cco @ XI @ cc1 @ ccaddc) @ (cco @ cc1 @ XN @ ccfz)))))).
...
thf(aaddcan2ad_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => ((cco @ XA2 @ XC @ ccaddc) = (cco @ XB2 @ XC @ ccaddc))) => (Xph => (XA2 = XB2))))))))))).
...
thf(asmatrcl_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XS = (cco @ XK @ XL @ (ccfv @ XA2 @ ccsmat))) => ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XK @ (cco @ cc1 @ XM @ ccfz))) => ((Xph => (cwcel @ XL @ (cco @ cc1 @ XN @ ccfz))) => ((Xph => (cwcel @ XA2 @ (cco @ XB2 @ (ccxp @ (cco @ cc1 @ XM @ ccfz) @ (cco @ cc1 @ XN @ ccfz)) @ ccmap))) => (Xph => (cwcel @ XS @ (cco @ XB2 @ (ccxp @ (cco @ cc1 @ (cco @ XM @ cc1 @ ccmin) @ ccfz) @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) @ ccmap)))))))))))))))))).
...
thf(c_1smat1_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((Xc_1 = (ccfv @ (cco @ (cco @ cc1 @ XN @ ccfz) @ XR @ ccmat) @ ccur)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XI @ (cco @ cc1 @ XN @ ccfz))) => (Xph => ((cco @ XI @ XI @ (ccfv @ Xc_1 @ ccsmat)) = (ccfv @ (cco @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ XR @ ccmat) @ ccur))))))))))))).
