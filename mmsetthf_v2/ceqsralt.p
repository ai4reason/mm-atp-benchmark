...
thf(cceqsralt_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xx3:$i] : ((cw3a @ (cwnf @ (^ [Xx3:$i] : (Xps @ Xx3))) @ (! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> (Xps @ Xx3)))) @ (cwcel @ XA2 @ XB2)) => ((cwral @ (^ [Xx3:$i] : (((ccv @ Xx3) = XA2) => (Xph @ Xx3))) @ (^ [Xx3:$i] : XB2)) <=> (Xps @ Xx3))))))))).
