...
thf(cfresf1o_conj,conjecture,(! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwfun @ XF) @ (cwss @ XC @ (ccrn @ XF)) @ (cwfun @ (ccres @ (cccnv @ XF) @ XC))) => (cwf1o @ (ccima @ (cccnv @ XF) @ XC) @ XC @ (ccres @ XF @ (ccima @ (cccnv @ XF) @ XC))))))).
