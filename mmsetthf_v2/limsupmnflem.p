...
thf(alimsupval3_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XA2 @ Xk) @ (XV @ Xk)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwf @ (XA2 @ Xk) @ ccxr @ XF))) => ((! [Xk:$i] : ((XG @ Xk) = (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccsup @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr @ cclt))))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccfv @ XF @ cclsp) = (ccinf @ (ccrn @ (XG @ Xk)) @ ccxr @ cclt)))))))))))))).
...
thf(ainfxrunb3rnmpt_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (cwnf @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((Xph @ Xx3 @ Xy1) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccxr)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => ((cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xx3:$i] : XA2))) @ (^ [Xy1:$i] : ccr)) <=> ((ccinf @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) @ ccxr @ cclt) = ccmnf)))))))))))).
thf(asupxrcld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwss @ XA2 @ ccxr)) => (Xph => (cwcel @ (ccsup @ XA2 @ ccxr @ cclt) @ ccxr)))))).
thf(aadantr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph & Xch) => Xps)))))).
thf(afimassd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwf @ XA2 @ XB2 @ XF)) => (Xph => (cwss @ (ccima @ XF @ XX) @ XB2))))))))).
...
thf(aadantl4r_ax,axiom,(! [Xph:$o] : (! [Xze:$o] : (! [Xsi:$o] : (! [Xrh:$o] : (! [Xmu:$o] : (! [Xla:$o] : (! [Xka:$o] : ((((((Xph & Xsi) & Xrh) & Xmu) & Xla) => Xka) => ((((((Xph & Xze) & Xsi) & Xrh) & Xmu) & Xla) => Xka)))))))))).
thf(aadantllr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((((Xph & Xps) & Xch) => Xth) => ((((Xph & Xta) & Xps) & Xch) => Xth)))))))).
thf(ccdm_tp,type,(ccdm : (($i > $o) > ($i > $o)))).
thf(cwfun_tp,type,(cwfun : (($i > $o) > $o))).
thf(afnfvimad_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwfn @ XF @ XA2)) => ((Xph => (cwcel @ XB2 @ XA2)) => ((Xph => (cwcel @ XB2 @ XC)) => (Xph => (cwcel @ (ccfv @ XB2 @ XF) @ (ccima @ XF @ XC)))))))))))).
...
thf(afvelimad_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwfn @ (XF @ Xx3) @ XA2))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XC @ (ccima @ (XF @ Xx3) @ XB2)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) = XC)) @ (^ [Xx3:$i] : (ccin @ XA2 @ XB2)))))))))))))).
...
thf(aicogelbd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico))) => (Xph => (cwbr @ XA2 @ XC @ ccle)))))))))).
...
thf(climsupmnflem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xk:$i] : (Xph => (cwss @ (XA2 @ Xx3 @ Xk) @ ccr)))) => ((! [Xx3:$i] : (! [Xk:$i] : (Xph => (cwf @ (XA2 @ Xx3 @ Xk) @ ccxr @ XF)))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XG @ Xx3 @ Xj @ Xk) = (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccsup @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr @ cclt))))))) => (Xph => (((ccfv @ XF @ cclsp) = ccmnf) <=> (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : ((cwbr @ (ccv @ Xk) @ (ccv @ Xj) @ ccle) => (cwbr @ (ccfv @ (ccv @ Xj) @ XF) @ (ccv @ Xx3) @ ccle))) @ (^ [Xj:$i] : (XA2 @ Xx3 @ Xk)))) @ (^ [Xk:$i] : ccr))) @ (^ [Xx3:$i] : ccr)))))))))))).
