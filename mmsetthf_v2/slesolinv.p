...
thf(a_1mavmul_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (cco @ XR @ (ccop @ XN @ XN) @ ccmvmul)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XN @ ccfn)) => ((Xph => (cwcel @ XY @ (cco @ XB2 @ XN @ ccmap))) => (Xph => ((cco @ (ccfv @ XA2 @ ccur) @ XY @ Xc_x) = XY)))))))))))))))).
thf(aoveq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))).
thf(cslesolinv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XV = (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => ((Xc_x = (cco @ XR @ (ccop @ XN @ XN) @ ccmvmul)) => ((XD = (cco @ XN @ XR @ ccmdat)) => ((XI = (ccfv @ XA2 @ ccinvr)) => ((cw3a @ ((cwne @ XN @ cc0) & (cwcel @ XR @ cccrg)) @ ((cwcel @ XX @ XB2) & (cwcel @ XY @ XV)) @ ((cwcel @ (ccfv @ XX @ XD) @ (ccfv @ XR @ ccui)) & ((cco @ XX @ XZ @ Xc_x) = XY))) => (XZ = (cco @ (ccfv @ XX @ XI) @ XY @ Xc_x))))))))))))))))))))).
