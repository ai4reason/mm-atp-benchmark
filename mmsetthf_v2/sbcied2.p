...
thf(csbcied2_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (Xph => (XA2 = (XB2 @ Xx3)))) => ((! [Xx3:$i] : ((Xph & ((ccv @ Xx3) = (XB2 @ Xx3))) => ((Xps @ Xx3) <=> Xch))) => (Xph => ((cwsbc @ (^ [Xx3:$i] : (Xps @ Xx3)) @ XA2) <=> Xch)))))))))))).
