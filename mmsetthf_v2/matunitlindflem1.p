...
thf(aabl32_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XZ @ XB2)) => (Xph => ((cco @ (cco @ XX @ XY @ Xc_pl) @ XZ @ Xc_pl) = (cco @ (cco @ XX @ XZ @ Xc_pl) @ XY @ Xc_pl))))))))))))))))).
...
thf(amdetero_ax,axiom,(! [Xph:$o] : (! [XD:($i > ($i > ($i > $o)))] : (! [Xc_pl:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : ((XD @ Xi @ Xj) = (cco @ XN @ (XR @ Xi @ Xj) @ ccmdat)))) => ((! [Xi:$i] : (! [Xj:$i] : (XK = (ccfv @ (XR @ Xi @ Xj) @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xc_pl = (ccfv @ (XR @ Xi @ Xj) @ ccplusg)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xc_x = (ccfv @ (XR @ Xi @ Xj) @ ccmulr)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xph => (cwcel @ (XR @ Xi @ Xj) @ cccrg)))) => ((Xph => (cwcel @ XN @ ccfn)) => ((! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ XN)) => (cwcel @ (XX @ Xj) @ XK))) => ((! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ XN)) => (cwcel @ (XY @ Xj) @ XK))) => ((! [Xi:$i] : (! [Xj:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xi) @ XN) @ (cwcel @ (ccv @ Xj) @ XN)) => (cwcel @ (XZ @ Xi @ Xj) @ XK)))) => ((Xph => (cwcel @ XW @ XK)) => ((Xph => (cwcel @ XI @ XN)) => ((Xph => (cwcel @ XJ @ XN)) => ((Xph => (cwne @ XI @ XJ)) => (! [Xi:$i] : (! [Xj:$i] : (Xph => ((ccfv @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = XI) @ (cco @ (XX @ Xj) @ (cco @ XW @ (XY @ Xj) @ Xc_x) @ Xc_pl) @ (ccif @ ((ccv @ Xi) = XJ) @ (XY @ Xj) @ (XZ @ Xi @ Xj)))))) @ (XD @ Xi @ Xj)) = (ccfv @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = XI) @ (XX @ Xj) @ (ccif @ ((ccv @ Xi) = XJ) @ (XY @ Xj) @ (XZ @ Xi @ Xj)))))) @ (XD @ Xi @ Xj))))))))))))))))))))))))))))))))).
...
thf(agsumdifsnd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((! [Xk:$i] : ((Xc_pl @ Xk) = (ccfv @ XG @ ccplusg))) => ((Xph => (cwcel @ XG @ cccmn)) => ((! [Xk:$i] : (Xph => (cwcel @ XA2 @ (XW @ Xk)))) => ((Xph => (cwbr @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XX @ Xk))) @ (ccfv @ XG @ cc0g) @ ccfsupp)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XX @ Xk) @ XB2))) => ((Xph => (cwcel @ XM @ XA2)) => ((Xph => (cwcel @ XY @ XB2)) => ((! [Xk:$i] : ((Xph & ((ccv @ Xk) = XM)) => ((XX @ Xk) = XY))) => (! [Xk:$i] : (Xph => ((cco @ XG @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XX @ Xk))) @ ccgsu) = (cco @ (cco @ XG @ (ccmpt @ (^ [Xk:$i] : (ccdif @ XA2 @ (ccsn @ XM))) @ (^ [Xk:$i] : (XX @ Xk))) @ ccgsu) @ XY @ (Xc_pl @ Xk)))))))))))))))))))))))).
...
thf(amdetr0_ax,axiom,(! [Xph:$o] : (! [XD:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : ((XD @ Xi @ Xj) = (cco @ XN @ XR @ ccmdat)))) => ((XK = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XN @ ccfn)) => ((! [Xi:$i] : (! [Xj:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xi) @ XN) @ (cwcel @ (ccv @ Xj) @ XN)) => (cwcel @ (XX @ Xi @ Xj) @ XK)))) => ((Xph => (cwcel @ XI @ XN)) => (! [Xi:$i] : (! [Xj:$i] : (Xph => ((ccfv @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = XI) @ Xc_0 @ (XX @ Xi @ Xj))))) @ (XD @ Xi @ Xj)) = Xc_0)))))))))))))))))))).
thf(aad3antrrr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xps) => ((((Xph & Xch) & Xth) & Xta) => Xps)))))))).
thf(cmatunitlindflem1_conj,conjecture,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : ((((cwcel @ XR @ ccfield) & (cwf @ (ccxp @ XI @ XI) @ (ccfv @ XR @ ccbs) @ XM)) & (cwcel @ XI @ (ccdif @ ccfn @ (ccsn @ cc0)))) => ((~ (cwbr @ (cccur @ XM) @ (cco @ XR @ XI @ ccfrlm) @ cclindf)) => ((ccfv @ XM @ (cco @ XI @ XR @ ccmdat)) = (ccfv @ XR @ cc0g)))))))).
