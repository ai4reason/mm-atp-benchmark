...
thf(aabnex_ax,axiom,(! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : ((! [Xx3:$i] : ((cwcel @ (XF @ Xx3) @ (XV @ Xx3 @ Xy1)) & (cwcel @ (ccv @ Xx3) @ (XF @ Xx3)))) => (~ (cwcel @ (ccab @ (^ [Xy1:$i] : (? [Xx3:$i] : ((ccv @ Xy1) = (XF @ Xx3))))) @ ccvv))))))).
...
thf(cpwnex_conj,conjecture,(cwnel @ (ccab @ (^ [Xx3:$i] : (? [Xy1:$i] : ((ccv @ Xx3) = (ccpw @ (ccv @ Xy1)))))) @ ccvv)).
