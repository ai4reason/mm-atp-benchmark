...
thf(adprddomprc_ax,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : ((cwnel @ (ccdm @ XS) @ ccvv) => (~ (cwbr @ XG @ XS @ (ccdm @ ccdprd))))))).
thf(adprdw_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xh:$i] : (! [Xi:$i] : ((XW @ Xx3 @ Xh @ Xi) = (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ (Xc_0 @ Xx3 @ Xi) @ ccfsupp)) @ (^ [Xh:$i] : (ccixp @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XS))))))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwbr @ (XG @ Xh @ Xi) @ XS @ (ccdm @ ccdprd))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => ((ccdm @ XS) = XI)))) => (! [Xx3:$i] : (! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => ((cwcel @ (XF @ Xi) @ (XW @ Xx3 @ Xh @ Xi)) <=> (cw3a @ (cwfn @ (XF @ Xi) @ XI) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (XF @ Xi)) @ (ccfv @ (ccv @ Xx3) @ XS))) @ (^ [Xx3:$i] : XI)) @ (cwbr @ (XF @ Xi) @ (Xc_0 @ Xx3 @ Xi) @ ccfsupp)))))))))))))))))).
...
thf(cdprdsubg_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : ((cwbr @ XG @ XS @ (ccdm @ ccdprd)) => (cwcel @ (cco @ XG @ XS @ ccdprd) @ (ccfv @ XG @ ccsubg)))))).
