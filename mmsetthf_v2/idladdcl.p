...
thf(cidladdcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((((cwcel @ XR @ ccrngo) & (cwcel @ XI @ (ccfv @ XR @ ccidl))) & ((cwcel @ XA2 @ XI) & (cwcel @ XB2 @ XI))) => (cwcel @ (cco @ XA2 @ XB2 @ XG) @ XI))))))))).
