...
thf(adeg1sublt_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xc_mi = (ccfv @ XP @ ccsg)) => ((Xph => (cwcel @ XL @ ccn0)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XF @ XB2)) => ((Xph => (cwbr @ (ccfv @ XF @ XD) @ XL @ ccle)) => ((Xph => (cwcel @ XG @ XB2)) => ((Xph => (cwbr @ (ccfv @ XG @ XD) @ XL @ ccle)) => ((XA2 = (ccfv @ XF @ ccco1)) => ((XC = (ccfv @ XG @ ccco1)) => ((Xph => ((ccfv @ XL @ (ccfv @ XF @ ccco1)) = (ccfv @ XL @ (ccfv @ XG @ ccco1)))) => (Xph => (cwbr @ (ccfv @ (cco @ XF @ XG @ Xc_mi) @ XD) @ XL @ cclt))))))))))))))))))))))))))).
