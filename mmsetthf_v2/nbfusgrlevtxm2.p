...
thf(anbgrssvwo2_ax,axiom,(! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwnel @ XM @ (cco @ XG @ XX @ ccnbgr)) => (cwss @ (cco @ XG @ XX @ ccnbgr) @ (ccdif @ XV @ (ccpr @ XM @ XX)))))))))).
...
thf(ahashdifpr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cw3a @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2) @ (cwne @ XB2 @ XC))) => ((ccfv @ (ccdif @ XA2 @ (ccpr @ XB2 @ XC)) @ cchash) = (cco @ (ccfv @ XA2 @ cchash) @ cc2 @ ccmin))))))).
thf(cnbfusgrlevtxm2_conj,conjecture,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((((cwcel @ XG @ ccfusgr) & (cwcel @ XU @ XV)) & (cw3a @ (cwcel @ XM @ XV) @ (cwne @ XM @ XU) @ (cwnel @ XM @ (cco @ XG @ XU @ ccnbgr)))) => (cwbr @ (ccfv @ (cco @ XG @ XU @ ccnbgr) @ cchash) @ (cco @ (ccfv @ XV @ cchash) @ cc2 @ ccmin) @ ccle)))))))).
