...
thf(aafvfvn0fveq_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwne @ (ccfv @ XA2 @ XF) @ cc0) => ((ccafv @ XA2 @ XF) = (ccfv @ XA2 @ XF)))))).
thf(adf_aov_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((ccaov @ XA2 @ XB2 @ XF) = (ccafv @ (ccop @ XA2 @ XB2) @ XF)))))).
thf(caovovn0oveq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwne @ (cco @ XA2 @ XB2 @ XF) @ cc0) => ((ccaov @ XA2 @ XB2 @ XF) = (cco @ XA2 @ XB2 @ XF))))))).
