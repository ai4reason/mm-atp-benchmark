...
thf(afneq12_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((XF = XG) & (XA2 = XB2)) => ((cwfn @ XF @ XA2) <=> (cwfn @ XG @ XB2)))))))).
thf(acbvraldva2_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((ccv @ Xx3) = (ccv @ Xy1))) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((ccv @ Xx3) = (ccv @ Xy1))) => ((XA2 @ Xx3) = (XB2 @ Xy1))))) => (Xph => ((cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) <=> (cwral @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xy1))))))))))))).
...
thf(ctfrlem3a_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xf1:$i] : ((XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xf1) = (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xx3:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) = (ccfv @ (ccres @ (ccv @ Xf1) @ (ccv @ Xy1)) @ XF))) @ (^ [Xy1:$i] : (ccv @ Xx3))))) @ (^ [Xx3:$i] : ccon0)))))))))) => ((cwcel @ XG @ ccvv) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xf1:$i] : ((cwcel @ XG @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw @ Xf1)) <=> (cwrex @ (^ [Xz:$i] : ((cwfn @ XG @ (ccv @ Xz)) & (cwral @ (^ [Xw:$i] : ((ccfv @ (ccv @ Xw) @ XG) = (ccfv @ (ccres @ XG @ (ccv @ Xw)) @ XF))) @ (^ [Xw:$i] : (ccv @ Xz))))) @ (^ [Xz:$i] : ccon0)))))))))))))).
