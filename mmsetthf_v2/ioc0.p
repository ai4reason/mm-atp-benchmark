...
thf(aiocval_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cco @ XA2 @ XB2 @ ccioc) = (ccrab @ (^ [Xx3:$i] : ((cwbr @ XA2 @ (ccv @ Xx3) @ cclt) & (cwbr @ (ccv @ Xx3) @ XB2 @ ccle))) @ (^ [Xx3:$i] : ccxr))))))).
...
thf(cioc0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => (((cco @ XA2 @ XB2 @ ccioc) = cc0) <=> (cwbr @ XB2 @ XA2 @ ccle)))))).
