...
thf(cpmltpc_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ (cco @ ccr @ ccr @ ccpm)) & (cwss @ XA2 @ (ccdm @ XF))) => (cw3o @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle) => (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ ccle))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle) => (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccle))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) @ (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (cw3a @ (cwbr @ (ccv @ Xa) @ (ccv @ Xb) @ cclt) @ (cwbr @ (ccv @ Xb) @ (ccv @ Xc) @ cclt) @ (((cwbr @ (ccfv @ (ccv @ Xa) @ XF) @ (ccfv @ (ccv @ Xb) @ XF) @ cclt) & (cwbr @ (ccfv @ (ccv @ Xc) @ XF) @ (ccfv @ (ccv @ Xb) @ XF) @ cclt)) | ((cwbr @ (ccfv @ (ccv @ Xb) @ XF) @ (ccfv @ (ccv @ Xa) @ XF) @ cclt) & (cwbr @ (ccfv @ (ccv @ Xb) @ XF) @ (ccfv @ (ccv @ Xc) @ XF) @ cclt))))) @ (^ [Xc:$i] : XA2))) @ (^ [Xb:$i] : XA2))) @ (^ [Xa:$i] : XA2))))))).
