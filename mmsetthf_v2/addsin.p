...
thf(caddsin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ (ccfv @ XA2 @ ccsin) @ (ccfv @ XB2 @ ccsin) @ ccaddc) = (cco @ cc2 @ (cco @ (ccfv @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ cc2 @ ccdiv) @ ccsin) @ (ccfv @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ cc2 @ ccdiv) @ cccos) @ ccmul) @ ccmul)))))).
