...
thf(afzosubel3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ (cco @ XB2 @ (cco @ XB2 @ XD @ ccaddc) @ ccfzo)) & (cwcel @ XD @ ccz)) => (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ ccc0 @ XD @ ccfzo))))))).
...
thf(cfargshiftfo_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XF))))) => (! [Xx3:$i] : (((cwcel @ XN @ ccn0) & (cwfo @ (cco @ cc1 @ XN @ ccfz) @ (ccdm @ XE) @ XF)) => (cwfo @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XE) @ (XG @ Xx3)))))))))).
