...
thf(cissalgend_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (Xph => (cwcel @ XX @ (XV @ Xy1)))) => ((Xph => (cwcel @ XS @ ccsalg)) => ((Xph => ((ccuni @ XS) = (ccuni @ XX))) => ((Xph => (cwss @ XX @ XS)) => ((! [Xy1:$i] : ((Xph & (cw3a @ (cwcel @ (ccv @ Xy1) @ ccsalg) @ ((ccuni @ (ccv @ Xy1)) = (ccuni @ XX)) @ (cwss @ XX @ (ccv @ Xy1)))) => (cwss @ XS @ (ccv @ Xy1)))) => (Xph => ((ccfv @ XX @ ccsalgen) = XS)))))))))))).
