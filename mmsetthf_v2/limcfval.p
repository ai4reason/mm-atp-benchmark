...
thf(adf_limc_ax,axiom,(cclimc = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xx3:$i] : (cco @ ccc @ ccc @ ccpm))) @ (^ [Xf1:$i] : (^ [Xx3:$i] : ccc)) @ (^ [Xf1:$i] : (^ [Xx3:$i] : (ccab @ (^ [Xy1:$i] : (cwsbc @ (^ [Xj:$i] : (cwcel @ (ccmpt @ (^ [Xz:$i] : (ccun @ (ccdm @ (ccv @ Xf1)) @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xz:$i] : (ccif @ ((ccv @ Xz) = (ccv @ Xx3)) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xf1))))) @ (ccfv @ (ccv @ Xx3) @ (cco @ (cco @ (ccv @ Xj) @ (ccun @ (ccdm @ (ccv @ Xf1)) @ (ccsn @ (ccv @ Xx3))) @ ccrest) @ (ccv @ Xj) @ cccnp)))) @ (ccfv @ cccnfld @ cctopn))))))))).
...
thf(climcfval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : ((! [Xz:$i] : ((XJ @ Xz) = (cco @ XK @ (ccun @ XA2 @ (ccsn @ XB2)) @ ccrest))) => ((XK = (ccfv @ cccnfld @ cctopn)) => (! [Xz:$i] : ((cw3a @ (cwf @ XA2 @ ccc @ XF) @ (cwss @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) => (((cco @ XF @ XB2 @ cclimc) = (ccab @ (^ [Xy1:$i] : (cwcel @ (ccmpt @ (^ [Xz:$i] : (ccun @ XA2 @ (ccsn @ XB2))) @ (^ [Xz:$i] : (ccif @ ((ccv @ Xz) = XB2) @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xz) @ XF)))) @ (ccfv @ XB2 @ (cco @ (XJ @ Xz) @ XK @ cccnp)))))) & (cwss @ (cco @ XF @ XB2 @ cclimc) @ ccc)))))))))))).
