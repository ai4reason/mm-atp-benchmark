...
thf(abcval3_ax,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XK @ ccz) @ (~ (cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)))) => ((cco @ XN @ XK @ ccbc) = ccc0))))).
...
thf(cbccmpl_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XK @ ccz)) => ((cco @ XN @ XK @ ccbc) = (cco @ XN @ (cco @ XN @ XK @ ccmin) @ ccbc)))))).
