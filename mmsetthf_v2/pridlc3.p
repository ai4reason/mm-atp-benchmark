...
thf(apridlc2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XH = (ccfv @ XR @ cc2nd)) => ((XX = (ccrn @ XG)) => ((((cwcel @ XR @ cccring) & (cwcel @ XP @ (ccfv @ XR @ ccpridl))) & (cw3a @ (cwcel @ XA2 @ (ccdif @ XX @ XP)) @ (cwcel @ XB2 @ XX) @ (cwcel @ (cco @ XA2 @ XB2 @ XH) @ XP))) => (cwcel @ XB2 @ XP))))))))))))).
