...
thf(cbrfae_conj,conjecture,(! [Xph:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : ((! [Xx3:$i] : ((ccdm @ XR) = (XD @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XR @ ccvv))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XM @ (ccuni @ (ccrn @ ccmeas))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XF @ (cco @ (XD @ Xx3) @ (ccuni @ (ccdm @ XM)) @ ccmap)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XG @ (cco @ (XD @ Xx3) @ (ccuni @ (ccdm @ XM)) @ ccmap)))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cwbr @ XF @ XG @ (cco @ XR @ XM @ ccfae)) <=> (cwbr @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG) @ XR)) @ (^ [Xx3:$i] : (ccuni @ (ccdm @ XM)))) @ XM @ ccae)))))))))))))))).
