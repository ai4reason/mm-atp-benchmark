...
thf(abpolydif_ax,axiom,(! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XX @ ccc)) => ((cco @ (cco @ XN @ (cco @ XX @ cc1 @ ccaddc) @ ccbp) @ (cco @ XN @ XX @ ccbp) @ ccmin) = (cco @ XN @ (cco @ XX @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccmul)))))).
