...
thf(alfl1_ax,axiom,(! [XD:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XD = (ccfv @ XW @ ccsca)) => ((! [Xx3:$i] : ((Xc_0 @ Xx3) = (ccfv @ XD @ cc0g))) => ((Xc_1 = (ccfv @ XD @ ccur)) => ((XV = (ccfv @ XW @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccfv @ XW @ cclfn))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XW @ cclvec) @ (cwcel @ XG @ (XF @ Xx3)) @ (cwne @ XG @ (ccxp @ XV @ (ccsn @ (Xc_0 @ Xx3))))) => (cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XG) = Xc_1)) @ (^ [Xx3:$i] : XV))))))))))))))))).
...
thf(alkrlsp3_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((XF = (ccfv @ XW @ cclfn)) => ((XK = (ccfv @ XW @ cclk)) => ((cw3a @ (cwcel @ XW @ cclvec) @ ((cwcel @ XX @ XV) & (cwcel @ XG @ XF)) @ (~ (cwcel @ XX @ (ccfv @ XG @ XK)))) => ((ccfv @ (ccun @ (ccfv @ XG @ XK) @ (ccsn @ XX)) @ XN) = XV)))))))))))))).
...
thf(clkrshp_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XD = (ccfv @ XW @ ccsca)) => ((Xc_0 = (ccfv @ XD @ cc0g)) => ((XH = (ccfv @ XW @ cclsh)) => ((XF = (ccfv @ XW @ cclfn)) => ((XK = (ccfv @ XW @ cclk)) => ((cw3a @ (cwcel @ XW @ cclvec) @ (cwcel @ XG @ XF) @ (cwne @ XG @ (ccxp @ XV @ (ccsn @ Xc_0)))) => (cwcel @ (ccfv @ XG @ XK) @ XH))))))))))))))))).
