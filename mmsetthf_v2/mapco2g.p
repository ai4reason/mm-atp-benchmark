...
thf(cmapco2g_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((cw3a @ (cwcel @ XE @ ccvv) @ (cwcel @ XA2 @ (cco @ XB2 @ XC @ ccmap)) @ (cwf @ XE @ XC @ XD)) => (cwcel @ (cccom @ XA2 @ XD) @ (cco @ XB2 @ XE @ ccmap))))))))).
