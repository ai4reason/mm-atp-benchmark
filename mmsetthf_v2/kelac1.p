...
thf(aboxriin_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XI:($i > $o)] : ((cwral @ (^ [Xx3:$i] : (cwss @ (XA2 @ Xx3) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XI)) => ((ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XA2 @ Xx3))) = (ccin @ (ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cciin @ (^ [Xy1:$i] : XI) @ (^ [Xy1:$i] : (ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = (ccv @ Xy1)) @ (XA2 @ Xx3) @ (XB2 @ Xx3))))))))))))).
...
thf(aptunimpt_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XK @ Xx3))) @ ccpt))) => (! [Xx3:$i] : (((cwcel @ XA2 @ (XV @ Xx3)) & (cwral @ (^ [Xx3:$i] : (cwcel @ (XK @ Xx3) @ cctop)) @ (^ [Xx3:$i] : XA2))) => ((ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccuni @ (XK @ Xx3)))) = (ccuni @ (XJ @ Xx3))))))))))).
thf(ccfi_tp,type,(ccfi : ($i > $o))).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(ccint_tp,type,(ccint : (($i > $o) > ($i > $o)))).
thf(acmpfiiin_ax,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((Xph => (cwcel @ XJ @ cccmp)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XI)) => (cwcel @ (XS @ Xk) @ (ccfv @ XJ @ cccld)))) => ((! [Xl:$i] : ((Xph & ((cwss @ (ccv @ Xl) @ XI) & (cwcel @ (ccv @ Xl) @ ccfn))) => (cwne @ (ccin @ XX @ (cciin @ (^ [Xk:$i] : (ccv @ Xl)) @ (^ [Xk:$i] : (XS @ Xk)))) @ cc0))) => (Xph => (cwne @ (ccin @ XX @ (cciin @ (^ [Xk:$i] : XI) @ (^ [Xk:$i] : (XS @ Xk)))) @ cc0)))))))))))).
...
thf(ckelac1_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwne @ (XS @ Xx3) @ cc0))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwcel @ (XJ @ Xx3) @ cctop))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwcel @ (XC @ Xx3) @ (ccfv @ (XJ @ Xx3) @ cccld)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwf1o @ (XS @ Xx3) @ (XC @ Xx3) @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwcel @ (XU @ Xx3) @ (ccuni @ (XJ @ Xx3))))) => ((Xph => (cwcel @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XJ @ Xx3))) @ ccpt) @ cccmp)) => (Xph => (cwne @ (ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XS @ Xx3))) @ cc0)))))))))))))))).
