...
thf(aelno3_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccsur) <=> ((cwf @ (ccdm @ XA2) @ (ccpr @ cc1o @ cc2o) @ XA2) & (cwcel @ (ccdm @ XA2) @ ccon0))))).
...
thf(cnoseponlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccsur) @ (cwcel @ XB2 @ ccsur) @ (cwcel @ (ccdm @ XA2) @ (ccdm @ XB2))) => (~ (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XA2) = (ccfv @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : ccon0))))))).
