...
thf(abrwdom3i_ax,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwbr @ XX @ XY @ ccwdom) => (? [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)))) @ (^ [Xy1:$i] : XY))) @ (^ [Xx3:$i] : XX))))))).
...
thf(cxpwdomg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccwdom) & (cwbr @ XC @ XD @ ccwdom)) => (cwbr @ (ccxp @ XA2 @ XC) @ (ccxp @ XB2 @ XD) @ ccwdom))))))).
