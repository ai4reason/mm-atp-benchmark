...
thf(cxmetlecl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) @ ((cwcel @ XC @ ccr) & (cwbr @ (cco @ XA2 @ XB2 @ XD) @ XC @ ccle))) => (cwcel @ (cco @ XA2 @ XB2 @ XD) @ ccr)))))))).
