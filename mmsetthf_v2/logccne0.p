...
thf(alogeq0im1_ax,axiom,(! [XA2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ ((ccfv @ XA2 @ cclog) = ccc0)) => (XA2 = cc1)))).
thf(clogccne0_conj,conjecture,(! [XA2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwne @ XA2 @ cc1)) => (cwne @ (ccfv @ XA2 @ cclog) @ ccc0)))).
