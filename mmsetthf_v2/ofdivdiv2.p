...
thf(cofdivdiv2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XA2 @ XV) & (cwf @ XA2 @ ccc @ XF)) & ((cwf @ XA2 @ (ccdif @ ccc @ (ccsn @ ccc0)) @ XG) & (cwf @ XA2 @ (ccdif @ ccc @ (ccsn @ ccc0)) @ XH))) => ((cco @ XF @ (cco @ XG @ XH @ (ccof @ ccdiv)) @ (ccof @ ccdiv)) = (cco @ (cco @ XF @ XH @ (ccof @ ccmul)) @ XG @ (ccof @ ccdiv)))))))))).
