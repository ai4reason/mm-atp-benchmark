...
thf(clnopsubi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ XT) = (cco @ (ccfv @ XA2 @ XT) @ (ccfv @ XB2 @ XT) @ ccmv)))))))).
