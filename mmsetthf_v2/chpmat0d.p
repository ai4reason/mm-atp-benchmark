...
thf(amdet0pr_ax,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccrg) => ((cco @ cc0 @ XR @ ccmdat) = (ccsn @ (ccop @ cc0 @ (ccfv @ XR @ ccur))))))).
...
thf(amat0dimscm_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (cco @ cc0 @ XR @ ccmat)) => (((cwcel @ XR @ ccrg) & (cwcel @ XX @ (ccfv @ XR @ ccbs))) => ((cco @ XX @ cc0 @ (ccfv @ XA2 @ ccvsca)) = cc0))))))).
thf(ccascl_tp,type,(ccascl : ($i > $o))).
thf(ccmpt2_tp,type,(ccmpt2 : (($i > ($i > ($i > $o))) > (($i > ($i > ($i > $o))) > (($i > ($i > ($i > $o))) > ($i > $o)))))).
thf(ad0mat2pmat_ax,axiom,(! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XR @ XV) => ((ccfv @ cc0 @ (cco @ cc0 @ XR @ ccmat2pmat)) = cc0))))).
...
thf(amat0dim0_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((XA2 = (cco @ cc0 @ XR @ ccmat)) => ((cwcel @ XR @ ccrg) => ((ccfv @ XA2 @ cc0g) = cc0)))))).
...
thf(cchpmat0d_conj,conjecture,(! [XC:($i > $o)] : (! [XR:($i > $o)] : ((XC = (cco @ cc0 @ XR @ ccchpmat)) => ((cwcel @ XR @ ccrg) => ((ccfv @ cc0 @ XC) = (ccfv @ (ccfv @ XR @ ccpl1) @ ccur))))))).
