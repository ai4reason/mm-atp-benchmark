...
thf(anbgr0vtxlem_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : ((! [Xe:$i] : (! [Xn:$i] : ((Xph @ Xe @ Xn) => (cwral @ (^ [Xn:$i] : (~ (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ XK @ (ccv @ Xn)) @ (ccv @ Xe))) @ (^ [Xe:$i] : (ccfv @ XG @ ccedg))))) @ (^ [Xn:$i] : (ccdif @ (ccfv @ XG @ ccvtx) @ (ccsn @ XK))))))) => (! [Xe:$i] : (! [Xn:$i] : ((Xph @ Xe @ Xn) => ((cco @ XG @ XK @ ccnbgr) = cc0))))))))).
...
thf(anbgrnvtx0_ax,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwnel @ XX @ XV) => ((cco @ XG @ XX @ ccnbgr) = cc0))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(cnbgr1vtx_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (((ccfv @ (ccfv @ XG @ ccvtx) @ cchash) = cc1) => ((cco @ XG @ XK @ ccnbgr) = cc0))))).
