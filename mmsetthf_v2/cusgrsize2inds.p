...
thf(ahashnn0n0nn_ax,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XV @ XW) & (cwcel @ XY @ ccn0)) & (((ccfv @ XV @ cchash) = XY) & (cwcel @ XN @ XV))) => (cwcel @ XY @ ccn))))))).
...
thf(acusgrsizeinds_ax,axiom,(! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : ((XF @ Xe) = (ccrab @ (^ [Xe:$i] : (cwnel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)))) => (! [Xe:$i] : ((cw3a @ (cwcel @ XG @ cccusgr) @ (cwcel @ XV @ ccfn) @ (cwcel @ XN @ XV)) => ((ccfv @ XE @ cchash) = (cco @ (cco @ (ccfv @ XV @ cchash) @ cc1 @ ccmin) @ (ccfv @ (XF @ Xe) @ cchash) @ ccaddc))))))))))))).
...
thf(abcn2m1_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cco @ (cco @ XN @ cc1 @ ccmin) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccbc) @ ccaddc) = (cco @ XN @ cc2 @ ccbc))))).
