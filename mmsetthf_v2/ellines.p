...
thf(adf_line2_ax,axiom,(ccline2 = (ccoprab @ (^ [Xa:$i] : (^ [Xb:$i] : (^ [Xl:$i] : (cwrex @ (^ [Xn:$i] : ((cw3a @ (cwcel @ (ccv @ Xa) @ (ccfv @ (ccv @ Xn) @ ccee)) @ (cwcel @ (ccv @ Xb) @ (ccfv @ (ccv @ Xn) @ ccee)) @ (cwne @ (ccv @ Xa) @ (ccv @ Xb))) & ((ccv @ Xl) = (ccec @ (ccop @ (ccv @ Xa) @ (ccv @ Xb)) @ (cccnv @ cccolin))))) @ (^ [Xn:$i] : ccn)))))))).
thf(ccopab_tp,type,(ccopab : (($i > ($i > $o)) > ($i > $o)))).
thf(arnoprab_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : ((ccrn @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))))) = (ccab @ (^ [Xz:$i] : (? [Xx3:$i] : (? [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))))))).
...
thf(cellines_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ cclines2) <=> (cwrex @ (^ [Xn:$i] : (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : ((cwne @ (ccv @ Xp) @ (ccv @ Xq)) & (XA2 = (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccline2)))) @ (^ [Xq:$i] : (ccfv @ (ccv @ Xn) @ ccee)))) @ (^ [Xp:$i] : (ccfv @ (ccv @ Xn) @ ccee)))) @ (^ [Xn:$i] : ccn))))).
