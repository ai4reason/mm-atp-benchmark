...
thf(ccusgrexilem1_conj,conjecture,(! [XP:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : ((XP @ Xx3) = (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cchash) = cc2)) @ (^ [Xx3:$i] : (ccpw @ XV))))) => (! [Xx3:$i] : ((cwcel @ XV @ (XW @ Xx3)) => (cwcel @ (ccres @ ccid @ (XP @ Xx3)) @ ccvv)))))))).
