...
thf(aac4c_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (? [Xf1:$i] : (cwral @ (^ [Xx3:$i] : ((cwne @ (ccv @ Xx3) @ cc0) => (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2)))))).
