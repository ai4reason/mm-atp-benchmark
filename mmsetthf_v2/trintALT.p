...
thf(aee323_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : ((Xph => (Xps => (Xch => Xth))) => ((Xph => (Xps => Xta)) => ((Xph => (Xps => (Xch => Xet))) => ((Xth => (Xta => (Xet => Xze))) => (Xph => (Xps => (Xch => Xze))))))))))))))).
thf(aee33_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xph => (Xps => (Xch => Xth))) => ((Xph => (Xps => (Xch => Xta))) => ((Xth => (Xta => Xet)) => (Xph => (Xps => (Xch => Xet))))))))))))).
thf(aiidn3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (Xps => (Xch => Xch))))))).
thf(aee31_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xph => (Xps => (Xch => Xth))) => ((Xph => Xta) => ((Xth => (Xta => Xet)) => (Xph => (Xps => (Xch => Xet))))))))))))).
...
thf(ctrintALT_conj,conjecture,(! [XA2:($i > $o)] : ((cwral @ (^ [Xx3:$i] : (cwtr @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2)) => (cwtr @ (ccint @ XA2))))).
