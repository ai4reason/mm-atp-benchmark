...
thf(adfrefrels3_ax,axiom,(ccrefrels = (ccrab @ (^ [Xr:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xr)))) @ (^ [Xy1:$i] : (ccrn @ (ccv @ Xr))))) @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xr))))) @ (^ [Xr:$i] : ccrels)))).
...
thf(celrefrels3_conj,conjecture,(! [XR:($i > $o)] : ((cwcel @ XR @ ccrefrels) <=> ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR))) @ (^ [Xy1:$i] : (ccrn @ XR)))) @ (^ [Xx3:$i] : (ccdm @ XR))) & (cwcel @ XR @ ccrels))))).
