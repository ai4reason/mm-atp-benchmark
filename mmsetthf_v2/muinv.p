...
thf(amusum_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((ccsu @ (ccrab @ (^ [Xn:$i] : (cwbr @ (ccv @ Xn) @ XN @ ccdvds)) @ (^ [Xn:$i] : ccn)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ ccmu))) = (ccif @ (XN = cc1) @ cc1 @ ccc0))))).
