...
thf(aonsucsuccmpi_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (cwcel @ (ccsuc @ (ccsuc @ XA2)) @ cccmp)))).
...
thf(consucsuccmp_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (cwcel @ (ccsuc @ (ccsuc @ XA2)) @ cccmp)))).
