...
thf(aeltrpred_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XY @ (cctrpred @ XA2 @ XR @ XX)) <=> (cwrex @ (^ [Xi:$i] : (cwcel @ XY @ (ccfv @ (ccv @ Xi) @ (ccres @ (ccrdg @ (ccmpt @ (^ [Xa:$i] : ccvv) @ (^ [Xa:$i] : (cciun @ (^ [Xy1:$i] : (ccv @ Xa)) @ (^ [Xy1:$i] : (ccpred @ XA2 @ XR @ (ccv @ Xy1)))))) @ (ccpred @ XA2 @ XR @ XX)) @ ccom)))) @ (^ [Xi:$i] : ccom)))))))).
...
thf(asetlikespec_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ XA2) & (cwse @ XA2 @ XR)) => (cwcel @ (ccpred @ XA2 @ XR @ XX) @ ccvv)))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(atrpredlem1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [Xi:$i] : (! [XX:($i > ($i > $o))] : (! [Xy1:$i] : (! [Xa:$i] : ((cwcel @ (ccpred @ XA2 @ XR @ (XX @ Xy1)) @ (XB2 @ Xy1 @ Xa)) => (cwss @ (ccfv @ (ccv @ Xi) @ (ccres @ (ccrdg @ (ccmpt @ (^ [Xa:$i] : ccvv) @ (^ [Xa:$i] : (cciun @ (^ [Xy1:$i] : (ccv @ Xa)) @ (^ [Xy1:$i] : (ccpred @ XA2 @ XR @ (ccv @ Xy1)))))) @ (ccpred @ XA2 @ XR @ (XX @ Xy1))) @ ccom)) @ XA2)))))))))).
...
thf(adftrpred2_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cctrpred @ XA2 @ XR @ XX) = (cciun @ (^ [Xi:$i] : ccom) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (ccres @ (ccrdg @ (ccmpt @ (^ [Xa:$i] : ccvv) @ (^ [Xa:$i] : (cciun @ (^ [Xy1:$i] : (ccv @ Xa)) @ (^ [Xy1:$i] : (ccpred @ XA2 @ XR @ (ccv @ Xy1)))))) @ (ccpred @ XA2 @ XR @ XX)) @ ccom))))))))).
thf(ctrpredtr_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XX @ XA2) & (cwse @ XA2 @ XR)) => ((cwcel @ XY @ (cctrpred @ XA2 @ XR @ XX)) => (cwss @ (ccpred @ XA2 @ XR @ XY) @ (cctrpred @ XA2 @ XR @ XX))))))))).
