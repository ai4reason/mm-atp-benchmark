...
thf(clcmcllem_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) & (~ ((XM = ccc0) | (XN = ccc0)))) => (cwcel @ (cco @ XM @ XN @ cclcm) @ (ccrab @ (^ [Xn:$i] : ((cwbr @ XM @ (ccv @ Xn) @ ccdvds) & (cwbr @ XN @ (ccv @ Xn) @ ccdvds))) @ (^ [Xn:$i] : ccn))))))).
