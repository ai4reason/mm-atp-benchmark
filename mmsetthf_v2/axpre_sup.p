...
thf(aelreal2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) <=> ((cwcel @ (ccfv @ XA2 @ cc1st) @ ccnr) & (XA2 = (ccop @ (ccfv @ XA2 @ cc1st) @ cc0r)))))).
...
thf(altresr2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ XA2 @ XB2 @ ccltrr) <=> (cwbr @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XB2 @ cc1st) @ ccltr)))))).
...
thf(asupsr_ax,axiom,(! [XA2:($i > $o)] : (((cwne @ XA2 @ cc0) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccltr)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccnr))) => (cwrex @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccltr))) @ (^ [Xy1:$i] : XA2)) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccltr) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccltr)) @ (^ [Xz:$i] : XA2)))) @ (^ [Xy1:$i] : ccnr)))) @ (^ [Xx3:$i] : ccnr))))).
...
thf(caxpre_sup_conj,conjecture,(! [XA2:($i > $o)] : ((cw3a @ (cwss @ XA2 @ ccr) @ (cwne @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccltrr)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr))) => (cwrex @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccltrr))) @ (^ [Xy1:$i] : XA2)) & (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccltrr) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccltrr)) @ (^ [Xz:$i] : XA2)))) @ (^ [Xy1:$i] : ccr)))) @ (^ [Xx3:$i] : ccr))))).
