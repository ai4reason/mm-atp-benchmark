...
thf(adivadddivi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwcel @ XC @ ccc) => ((cwcel @ XD @ ccc) => ((cwne @ XB2 @ ccc0) => ((cwne @ XD @ ccc0) => ((cco @ (cco @ XA2 @ XB2 @ ccdiv) @ (cco @ XC @ XD @ ccdiv) @ ccaddc) = (cco @ (cco @ (cco @ XA2 @ XD @ ccmul) @ (cco @ XC @ XB2 @ ccmul) @ ccaddc) @ (cco @ XB2 @ XD @ ccmul) @ ccdiv))))))))))))).
...
thf(cstoweidlem13_conj,conjecture,(! [Xph:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xj:$i] : ((Xph @ Xj) => (cwcel @ (XE @ Xj) @ ccrp))) => ((! [Xj:$i] : ((Xph @ Xj) => (cwcel @ (XX @ Xj) @ ccr))) => ((! [Xj:$i] : ((Xph @ Xj) => (cwcel @ (XY @ Xj) @ ccr))) => ((! [Xj:$i] : ((Xph @ Xj) => (cwcel @ (ccv @ Xj) @ ccr))) => ((! [Xj:$i] : ((Xph @ Xj) => (cwbr @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc4 @ cc3 @ ccdiv) @ ccmin) @ (XE @ Xj) @ ccmul) @ (XX @ Xj) @ cclt))) => ((! [Xj:$i] : ((Xph @ Xj) => (cwbr @ (XX @ Xj) @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc1 @ cc3 @ ccdiv) @ ccmin) @ (XE @ Xj) @ ccmul) @ ccle))) => ((! [Xj:$i] : ((Xph @ Xj) => (cwbr @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc4 @ cc3 @ ccdiv) @ ccmin) @ (XE @ Xj) @ ccmul) @ (XY @ Xj) @ cclt))) => ((! [Xj:$i] : ((Xph @ Xj) => (cwbr @ (XY @ Xj) @ (cco @ (cco @ (ccv @ Xj) @ (cco @ cc1 @ cc3 @ ccdiv) @ ccaddc) @ (XE @ Xj) @ ccmul) @ cclt))) => (! [Xj:$i] : ((Xph @ Xj) => (cwbr @ (ccfv @ (cco @ (XY @ Xj) @ (XX @ Xj) @ ccmin) @ ccabs) @ (cco @ cc2 @ (XE @ Xj) @ ccmul) @ cclt)))))))))))))))).
