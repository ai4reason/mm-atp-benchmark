...
thf(cminveclem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XU @ ccbs)) => ((Xc_mi = (ccfv @ XU @ ccsg)) => ((XN = (ccfv @ XU @ ccnm)) => ((Xph => (cwcel @ XU @ cccph)) => ((Xph => (cwcel @ XY @ (ccfv @ XU @ cclss))) => ((Xph => (cwcel @ (cco @ XU @ XY @ ccress) @ cccms)) => ((Xph => (cwcel @ XA2 @ XX)) => ((XJ = (ccfv @ XU @ cctopn)) => ((XR = (ccrn @ (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ Xc_mi) @ XN))))) => (Xph => (cw3a @ (cwss @ XR @ ccr) @ (cwne @ XR @ cc0) @ (cwral @ (^ [Xw:$i] : (cwbr @ ccc0 @ (ccv @ Xw) @ ccle)) @ (^ [Xw:$i] : XR))))))))))))))))))))))).
