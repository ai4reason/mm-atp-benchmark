...
thf(aacncc_ax,axiom,((cwacn @ ccom) = ccvv)).
...
thf(ciunctb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (((cwbr @ XA2 @ ccom @ ccdom) & (cwral @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ ccom @ ccdom)) @ (^ [Xx3:$i] : XA2))) => (cwbr @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccom @ ccdom))))).
