...
thf(ahartogslem1_ax,axiom,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xs1:$i] : (! [Xr:$i] : ((XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xt @ Xf1 @ Xs1 @ Xr) = (ccopab @ (^ [Xr:$i] : (^ [Xy1:$i] : (((cw3a @ (cwss @ (ccdm @ (ccv @ Xr)) @ (XA2 @ Xz @ Xw @ Xt @ Xs1)) @ (cwss @ (ccres @ ccid @ (ccdm @ (ccv @ Xr))) @ (ccv @ Xr)) @ (cwss @ (ccv @ Xr) @ (ccxp @ (ccdm @ (ccv @ Xr)) @ (ccdm @ (ccv @ Xr))))) & (cwwe @ (ccdm @ (ccv @ Xr)) @ (ccdif @ (ccv @ Xr) @ ccid))) & ((ccv @ Xy1) = (ccdm @ (ccoi @ (ccdm @ (ccv @ Xr)) @ (ccdif @ (ccv @ Xr) @ ccid))))))))))))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xs1:$i] : ((XR @ Xy1 @ Xz @ Xw @ Xt @ Xf1 @ Xs1) = (ccopab @ (^ [Xs1:$i] : (^ [Xt:$i] : (cwrex @ (^ [Xw:$i] : (cwrex @ (^ [Xz:$i] : ((((ccv @ Xs1) = (ccfv @ (ccv @ Xw) @ (ccv @ Xf1))) & ((ccv @ Xt) = (ccfv @ (ccv @ Xz) @ (ccv @ Xf1)))) & (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ ccep))) @ (^ [Xz:$i] : (ccv @ Xy1)))) @ (^ [Xw:$i] : (ccv @ Xy1))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xt:$i] : (! [Xf1:$i] : (! [Xs1:$i] : (! [Xr:$i] : (cw3a @ (cwss @ (ccdm @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xt @ Xf1 @ Xs1 @ Xr)) @ (ccpw @ (ccxp @ (XA2 @ Xz @ Xw @ Xt @ Xs1) @ (XA2 @ Xz @ Xw @ Xt @ Xs1)))) @ (cwfun @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xt @ Xf1 @ Xs1 @ Xr)) @ ((cwcel @ (XA2 @ Xz @ Xw @ Xt @ Xs1) @ (XV @ Xx3 @ Xz @ Xw @ Xt @ Xf1 @ Xs1)) => ((ccrn @ (XF @ Xx3 @ Xy1 @ Xz @ Xw @ Xt @ Xf1 @ Xs1 @ Xr)) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (XA2 @ Xz @ Xw @ Xt @ Xs1) @ ccdom)) @ (^ [Xx3:$i] : ccon0)))))))))))))))))))).
...
thf(aharval_ax,axiom,(! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xy1:$i] : ((cwcel @ XX @ (XV @ Xy1)) => ((ccfv @ XX @ cchar) = (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ XX @ ccdom)) @ (^ [Xy1:$i] : ccon0)))))))).
...
thf(awdomtr_ax,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (((cwbr @ XX @ XY @ ccwdom) & (cwbr @ XY @ XZ @ ccwdom)) => (cwbr @ XX @ XZ @ ccwdom)))))).
