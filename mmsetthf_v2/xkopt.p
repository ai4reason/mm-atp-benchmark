...
thf(arestdis_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwss @ XB2 @ XA2)) => ((cco @ (ccpw @ XA2) @ XB2 @ ccrest) = (ccpw @ XB2))))))).
...
thf(axkoptsub_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XR)) => ((XJ = (ccfv @ (ccxp @ XX @ (ccsn @ XS)) @ ccpt)) => (((cwcel @ XR @ cctop) & (cwcel @ XS @ cctop)) => (cwss @ (cco @ XJ @ (cco @ XR @ XS @ cccn) @ ccrest) @ (cco @ XS @ XR @ ccxko)))))))))).
