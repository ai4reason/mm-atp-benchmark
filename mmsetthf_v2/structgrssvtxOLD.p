...
thf(abasvtxvalOLD_ax,axiom,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XG @ XX)) => ((Xph => (cwfun @ XG)) => ((Xph => (cwbr @ cc2 @ (ccfv @ (ccdm @ XG) @ cchash) @ ccle)) => ((Xph => (cwcel @ XV @ XY)) => ((Xph => (cwcel @ (ccop @ (ccfv @ ccnx @ ccbs) @ XV) @ XG)) => (Xph => ((ccfv @ XG @ ccvtx) = XV))))))))))))).
