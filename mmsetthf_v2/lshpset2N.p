...
thf(alkrshp3_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XD = (ccfv @ XW @ ccsca)) => ((Xc_0 = (ccfv @ XD @ cc0g)) => ((XH = (ccfv @ XW @ cclsh)) => ((XF = (ccfv @ XW @ cclfn)) => ((XK = (ccfv @ XW @ cclk)) => ((Xph => (cwcel @ XW @ cclvec)) => ((Xph => (cwcel @ XG @ XF)) => (Xph => ((cwcel @ (ccfv @ XG @ XK) @ XH) <=> (cwne @ XG @ (ccxp @ XV @ (ccsn @ Xc_0))))))))))))))))))))))).
