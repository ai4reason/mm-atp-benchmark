...
thf(asxuni_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) & (cwcel @ XT @ (ccuni @ (ccrn @ ccsiga)))) => ((ccxp @ (ccuni @ XS) @ (ccuni @ XT)) = (ccuni @ (cco @ XS @ XT @ ccsx))))))).
...
thf(axppreima2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwf @ XA2 @ XC @ XG)) => ((XH = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG))))) => (! [Xx3:$i] : (Xph => ((ccima @ (cccnv @ XH) @ (ccxp @ (XY @ Xx3) @ (XZ @ Xx3))) = (ccin @ (ccima @ (cccnv @ XF) @ (XY @ Xx3)) @ (ccima @ (cccnv @ XG) @ (XZ @ Xx3))))))))))))))))))).
...
thf(aimambfm_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XK @ ccvv)) => ((Xph => (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga)))) => ((Xph => (XT = (ccfv @ XK @ ccsigagen))) => (Xph => ((cwcel @ XF @ (cco @ XS @ XT @ ccmbfm)) <=> ((cwf @ (ccuni @ XS) @ (ccuni @ XT) @ XF) & (cwral @ (^ [Xa:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xa)) @ XS)) @ (^ [Xa:$i] : XK)))))))))))))).
thf(atxbasex_ax,axiom,(! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xx3 @ Xy1) = (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XR)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccxp @ (ccv @ Xx3) @ (ccv @ Xy1))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XR @ (XV @ Xx3 @ Xy1)) & (cwcel @ XS @ (XW @ Xx3 @ Xy1))) => (cwcel @ (XB2 @ Xx3 @ Xy1) @ ccvv))))))))))).
