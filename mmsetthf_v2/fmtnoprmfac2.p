...
thf(afmtnoodd_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => (~ (cwbr @ cc2 @ (ccfv @ XN @ ccfmtno) @ ccdvds))))).
...
thf(afmtnoprmfac2lem1_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (cwbr @ XP @ (ccfv @ XN @ ccfmtno) @ ccdvds)) => ((cco @ (cco @ cc2 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ XP @ ccmo) = cc1))))).
...
thf(afmtnoprmfac1lem_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (cwbr @ XP @ (ccfv @ XN @ ccfmtno) @ ccdvds)) => ((ccfv @ cc2 @ (ccfv @ XP @ ccodz)) = (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp)))))).
...
thf(cfmtnoprmfac2_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XP @ ccprime) @ (cwbr @ XP @ (ccfv @ XN @ ccfmtno) @ ccdvds)) => (cwrex @ (^ [Xk:$i] : (XP = (cco @ (cco @ (ccv @ Xk) @ (cco @ cc2 @ (cco @ XN @ cc2 @ ccaddc) @ ccexp) @ ccmul) @ cc1 @ ccaddc))) @ (^ [Xk:$i] : ccn)))))).
