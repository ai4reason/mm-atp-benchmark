...
thf(ametds0_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccinf @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XS) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD)))) @ ccxr @ cclt)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwss @ XS @ XX) @ (cwcel @ XA2 @ XS)) => ((ccfv @ XA2 @ (XF @ Xx3 @ Xy1)) = ccc0))))))))))).
