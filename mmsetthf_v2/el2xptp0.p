...
thf(cel2xptp0_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cw3a @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XV) @ (cwcel @ XZ @ XW)) => (((cwcel @ XA2 @ (ccxp @ (ccxp @ XU @ XV) @ XW)) & (cw3a @ ((ccfv @ (ccfv @ XA2 @ cc1st) @ cc1st) = XX) @ ((ccfv @ (ccfv @ XA2 @ cc1st) @ cc2nd) = XY) @ ((ccfv @ XA2 @ cc2nd) = XZ))) <=> (XA2 = (ccotp @ XX @ XY @ XZ)))))))))))).
