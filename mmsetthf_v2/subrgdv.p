...
thf(csubrgdv_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((XU = (ccfv @ XS @ ccui)) => ((XE = (ccfv @ XS @ ccdvr)) => ((cw3a @ (cwcel @ XA2 @ (ccfv @ XR @ ccsubrg)) @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XU)) => ((cco @ XX @ XY @ Xc_dv) = (cco @ XX @ XY @ XE)))))))))))))))).
