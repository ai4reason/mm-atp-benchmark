...
thf(aabsefi_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cce) @ ccabs) = cc1)))).
...
thf(aefif1o_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xw:$i] : ((XF @ Xw) = (ccmpt @ (^ [Xw:$i] : XD) @ (^ [Xw:$i] : (ccfv @ (cco @ cci @ (ccv @ Xw) @ ccmul) @ cce))))) => ((XC = (ccima @ (cccnv @ ccabs) @ (ccsn @ cc1))) => ((XD = (cco @ XA2 @ (cco @ XA2 @ (cco @ cc2 @ ccpi @ ccmul) @ ccaddc) @ ccioc)) => (! [Xw:$i] : ((cwcel @ XA2 @ ccr) => (cwf1o @ XD @ XC @ (XF @ Xw)))))))))))).
...
thf(cefifo_conj,conjecture,(! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xz:$i] : ((XF @ Xz) = (ccmpt @ (^ [Xz:$i] : ccr) @ (^ [Xz:$i] : (ccfv @ (cco @ cci @ (ccv @ Xz) @ ccmul) @ cce))))) => ((XC = (ccima @ (cccnv @ ccabs) @ (ccsn @ cc1))) => (! [Xz:$i] : (cwfo @ ccr @ XC @ (XF @ Xz)))))))).
