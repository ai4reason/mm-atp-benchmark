...
thf(aprmgaplem1_ax,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XI @ (cco @ cc2 @ XN @ ccfz))) => (cwbr @ XI @ (cco @ (ccfv @ XN @ ccfa) @ XI @ ccaddc) @ ccdvds))))).
...
thf(cprmgaplem2_conj,conjecture,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XI @ (cco @ cc2 @ XN @ ccfz))) => (cwbr @ cc1 @ (cco @ (cco @ (ccfv @ XN @ ccfa) @ XI @ ccaddc) @ XI @ ccgcd) @ cclt))))).
