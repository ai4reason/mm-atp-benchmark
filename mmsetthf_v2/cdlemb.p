...
thf(a_1cvratlt_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_lt = (ccfv @ XK @ ccplt)) => ((Xc_1 = (ccfv @ XK @ ccp1)) => ((XC = (ccfv @ XK @ cccvr)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XP @ XA2) @ (cwcel @ XX @ XB2)) & ((cwbr @ XX @ Xc_1 @ XC) & (cwbr @ XP @ XX @ Xc_le))) => (cwbr @ XP @ XX @ Xc_lt)))))))))))))))))).
thf(ccpo_tp,type,(ccpo : ($i > $o))).
thf(a_2atlt_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_lt = (ccfv @ XK @ ccplt)) => ((XA2 = (ccfv @ XK @ ccatm)) => (((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XP @ XA2) @ (cwcel @ XX @ XB2)) & (cwbr @ XP @ XX @ Xc_lt)) => (cwrex @ (^ [Xq:$i] : ((cwne @ (ccv @ Xq) @ XP) & (cwbr @ (ccv @ Xq) @ XX @ Xc_lt))) @ (^ [Xq:$i] : XA2))))))))))))).
