...
thf(ametidval_ax,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) => ((ccfv @ XD @ ccmetid) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XX) & (cwcel @ (ccv @ Xy1) @ XX)) & ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XD) = ccc0)))))))))).
thf(aibar_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps <=> (Xph & Xps)))))).
thf(cmetidv_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX))) => ((cwbr @ XA2 @ XB2 @ (ccfv @ XD @ ccmetid)) <=> ((cco @ XA2 @ XB2 @ XD) = ccc0)))))))).
