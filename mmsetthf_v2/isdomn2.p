...
thf(aisrrg_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xy1:$i] : ((XE @ Xy1) = (ccfv @ XR @ ccrlreg))) => ((XB2 = (ccfv @ XR @ ccbs)) => ((! [Xy1:$i] : ((Xc_x @ Xy1) = (ccfv @ XR @ ccmulr))) => ((! [Xy1:$i] : ((Xc_0 @ Xy1) = (ccfv @ XR @ cc0g))) => (! [Xy1:$i] : ((cwcel @ XX @ (XE @ Xy1)) <=> ((cwcel @ XX @ XB2) & (cwral @ (^ [Xy1:$i] : (((cco @ XX @ (ccv @ Xy1) @ (Xc_x @ Xy1)) = (Xc_0 @ Xy1)) => ((ccv @ Xy1) = (Xc_0 @ Xy1)))) @ (^ [Xy1:$i] : XB2)))))))))))))))).
