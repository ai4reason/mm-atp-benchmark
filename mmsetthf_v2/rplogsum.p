...
thf(arpvmasum_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XN @ cczn)) => ((XL = (ccfv @ XZ @ cczrh)) => ((Xph => (cwcel @ XN @ ccn)) => ((XU = (ccfv @ XZ @ ccui)) => ((Xph => (cwcel @ XA2 @ XU)) => ((XT = (ccima @ (cccnv @ XL) @ (ccsn @ XA2))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ XN @ ccphi) @ (ccsu @ (ccin @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ XT) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccv @ Xn) @ ccdiv))) @ ccmul) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmin))) @ cco1)))))))))))))))).
...
thf(avmaprm_ax,axiom,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprime) => ((ccfv @ XP @ ccvma) = (ccfv @ XP @ cclog))))).
thf(aeqle_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (XA2 = XB2)) => (cwbr @ XA2 @ XB2 @ ccle))))).
...
thf(arplogsumlem2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccz) => (cwbr @ (ccsu @ (cco @ cc1 @ XA2 @ ccfz) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccif @ (cwcel @ (ccv @ Xn) @ ccprime) @ (ccfv @ (ccv @ Xn) @ cclog) @ ccc0) @ ccmin) @ (ccv @ Xn) @ ccdiv))) @ cc2 @ ccle)))).
thf(crplogsum_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XN @ cczn)) => ((XL = (ccfv @ XZ @ cczrh)) => ((Xph => (cwcel @ XN @ ccn)) => ((XU = (ccfv @ XZ @ ccui)) => ((Xph => (cwcel @ XA2 @ XU)) => ((XT = (ccima @ (cccnv @ XL) @ (ccsn @ XA2))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ XN @ ccphi) @ (ccsu @ (ccin @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (ccin @ ccprime @ XT)) @ (^ [Xp:$i] : (cco @ (ccfv @ (ccv @ Xp) @ cclog) @ (ccv @ Xp) @ ccdiv))) @ ccmul) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmin))) @ cco1)))))))))))))))).
