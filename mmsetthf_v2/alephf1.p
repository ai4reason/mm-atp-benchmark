...
thf(aaleph11_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => (((ccfv @ XA2 @ ccale) = (ccfv @ XB2 @ ccale)) <=> (XA2 = XB2)))))).
...
thf(calephf1_conj,conjecture,(cwf1 @ ccon0 @ ccon0 @ ccale)).
