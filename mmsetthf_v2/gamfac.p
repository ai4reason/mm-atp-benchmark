...
thf(afacgam_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((ccfv @ XN @ ccfa) = (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccgam))))).
...
thf(cgamfac_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((ccfv @ XN @ ccgam) = (ccfv @ (cco @ XN @ cc1 @ ccmin) @ ccfa))))).
