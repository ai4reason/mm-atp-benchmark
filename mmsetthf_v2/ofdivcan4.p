...
thf(cofdivcan4_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XV) @ (cwf @ XA2 @ ccc @ XF) @ (cwf @ XA2 @ (ccdif @ ccc @ (ccsn @ ccc0)) @ XG)) => ((cco @ (cco @ XF @ XG @ (ccof @ ccmul)) @ XG @ (ccof @ ccdiv)) = XF))))))).
