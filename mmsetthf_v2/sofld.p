...
thf(asossfld_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (((cwor @ XA2 @ XR) & (cwcel @ XB2 @ XA2)) => (cwss @ (ccdif @ XA2 @ (ccsn @ XB2)) @ (ccun @ (ccdm @ XR) @ (ccrn @ XR)))))))).
...
thf(csofld_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cw3a @ (cwor @ XA2 @ XR) @ (cwss @ XR @ (ccxp @ XA2 @ XA2)) @ (cwne @ XR @ cc0)) => (XA2 = (ccun @ (ccdm @ XR) @ (ccrn @ XR))))))).
