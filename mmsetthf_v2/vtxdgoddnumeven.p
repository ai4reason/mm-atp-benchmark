...
thf(afinsumvtxdgeven_ax,axiom,(! [XD:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xv:$i] : ((XI @ Xv) = (ccfv @ XG @ cciedg))) => ((! [Xv:$i] : ((XD @ Xv) = (ccfv @ XG @ ccvtxdg))) => (! [Xv:$i] : ((cw3a @ (cwcel @ XG @ ccupgr) @ (cwcel @ XV @ ccfn) @ (cwcel @ (XI @ Xv) @ ccfn)) => (cwbr @ cc2 @ (ccsu @ XV @ (^ [Xv:$i] : (ccfv @ (ccv @ Xv) @ (XD @ Xv)))) @ ccdvds))))))))))).
...
thf(asumeven_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccz))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwbr @ cc2 @ (XB2 @ Xk) @ ccdvds))) => (Xph => (cwbr @ cc2 @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccdvds))))))))).
...
thf(cvtxdgoddnumeven_conj,conjecture,(! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XG @ cciedg)) => ((XD = (ccfv @ XG @ ccvtxdg)) => ((cw3a @ (cwcel @ XG @ ccupgr) @ (cwcel @ XV @ ccfn) @ (cwcel @ XI @ ccfn)) => (cwbr @ cc2 @ (ccfv @ (ccrab @ (^ [Xv:$i] : (~ (cwbr @ cc2 @ (ccfv @ (ccv @ Xv) @ XD) @ ccdvds))) @ (^ [Xv:$i] : XV)) @ cchash) @ ccdvds)))))))))).
