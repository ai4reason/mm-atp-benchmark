...
thf(ai1fmullem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ (ccdm @ ccitg1))) => ((Xph => (cwcel @ XG @ (ccdm @ ccitg1))) => ((Xph & (cwcel @ XA2 @ (ccdif @ ccc @ (ccsn @ ccc0)))) => ((ccima @ (cccnv @ (cco @ XF @ XG @ (ccof @ ccmul))) @ (ccsn @ XA2)) = (cciun @ (^ [Xy1:$i] : (ccdif @ (ccrn @ XG) @ (ccsn @ ccc0))) @ (^ [Xy1:$i] : (ccin @ (ccima @ (cccnv @ XF) @ (ccsn @ (cco @ XA2 @ (ccv @ Xy1) @ ccdiv))) @ (ccima @ (cccnv @ XG) @ (ccsn @ (ccv @ Xy1))))))))))))))).
