...
thf(alswlgt0cl_ax,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XN @ ccn) & ((cwcel @ XW @ (ccword @ XV)) & ((ccfv @ XW @ cchash) = XN))) => (cwcel @ (ccfv @ XW @ cclsw) @ XV)))))).
...
thf(awwlksext2clwwlk_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) & (cwcel @ XZ @ XV)) => (((cwcel @ (ccpr @ (ccfv @ XW @ cclsw) @ XZ) @ XE) & (cwcel @ (ccpr @ XZ @ (ccfv @ ccc0 @ XW)) @ XE)) => (cwcel @ (cco @ XW @ (ccs1 @ XZ) @ ccconcat) @ (cco @ (cco @ XN @ cc2 @ ccaddc) @ XG @ ccclwwlkn))))))))))))).
...
thf(aclwwlkext2edg_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XZ @ XV) @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz))) & (cwcel @ (cco @ XW @ (ccs1 @ XZ) @ ccconcat) @ (cco @ XN @ XG @ ccclwwlkn))) => ((cwcel @ (ccpr @ (ccfv @ XW @ cclsw) @ XZ) @ XE) & (cwcel @ (ccpr @ XZ @ (ccfv @ ccc0 @ XW)) @ XE)))))))))))).
...
thf(anumclwwlk2lem1lem_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XX @ (ccfv @ XG @ ccvtx)) @ (cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) @ (cwne @ (ccfv @ XW @ cclsw) @ (ccfv @ ccc0 @ XW))) => (((ccfv @ ccc0 @ (cco @ XW @ (ccs1 @ XX) @ ccconcat)) = (ccfv @ ccc0 @ XW)) & (cwne @ (ccfv @ XN @ (cco @ XW @ (ccs1 @ XX) @ ccconcat)) @ (ccfv @ ccc0 @ XW))))))))).
...
thf(anumclwwlkovh_ax,axiom,(! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((XH @ Xw @ Xv @ Xn) = (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : (XV @ Xw))) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccfv @ cc2 @ ccuz))) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccrab @ (^ [Xw:$i] : (cwne @ (ccfv @ (cco @ (ccv @ Xn) @ cc2 @ ccmin) @ (ccv @ Xw)) @ (ccv @ Xv))) @ (^ [Xw:$i] : (cco @ (ccv @ Xv) @ (ccv @ Xn) @ (ccfv @ XG @ ccclwwlknon))))))))))) => (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : (((cwcel @ XX @ (XV @ Xw)) & (cwcel @ XN @ (ccfv @ cc2 @ ccuz))) => ((cco @ XX @ XN @ (XH @ Xw @ Xv @ Xn)) = (ccrab @ (^ [Xw:$i] : (((ccfv @ ccc0 @ (ccv @ Xw)) = XX) & (cwne @ (ccfv @ (cco @ XN @ cc2 @ ccmin) @ (ccv @ Xw)) @ (ccfv @ ccc0 @ (ccv @ Xw))))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccclwwlkn))))))))))))))).
thf(aneeq12d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((cwne @ XA2 @ XC) <=> (cwne @ XB2 @ XD))))))))))).
thf(cnumclwwlk2lem1_conj,conjecture,(! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((XQ @ Xw @ Xv @ Xn) = (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : XV)) @ (^ [Xv:$i] : (^ [Xn:$i] : ccn)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccrab @ (^ [Xw:$i] : (((ccfv @ ccc0 @ (ccv @ Xw)) = (ccv @ Xv)) & (cwne @ (ccfv @ (ccv @ Xw) @ cclsw) @ (ccv @ Xv)))) @ (^ [Xw:$i] : (cco @ (ccv @ Xn) @ XG @ ccwwlksn)))))))))) => ((! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((XH @ Xw @ Xv @ Xn) = (ccmpt2 @ (^ [Xv:$i] : (^ [Xn:$i] : XV)) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccfv @ cc2 @ ccuz))) @ (^ [Xv:$i] : (^ [Xn:$i] : (ccrab @ (^ [Xw:$i] : (cwne @ (ccfv @ (cco @ (ccv @ Xn) @ cc2 @ ccmin) @ (ccv @ Xw)) @ (ccv @ Xv))) @ (^ [Xw:$i] : (cco @ (ccv @ Xv) @ (ccv @ Xn) @ (ccfv @ XG @ ccclwwlknon))))))))))) => (! [Xw:$i] : (! [Xv:$i] : (! [Xn:$i] : ((cw3a @ (cwcel @ XG @ ccfrgr) @ (cwcel @ XX @ XV) @ (cwcel @ XN @ ccn)) => ((cwcel @ (XW @ Xn) @ (cco @ XX @ XN @ (XQ @ Xw @ Xv @ Xn))) => (cwreu @ (^ [Xv:$i] : (cwcel @ (cco @ (XW @ Xn) @ (ccs1 @ (ccv @ Xv)) @ ccconcat) @ (cco @ XX @ (cco @ XN @ cc2 @ ccaddc) @ (XH @ Xw @ Xv @ Xn)))) @ (^ [Xv:$i] : XV)))))))))))))))))).
