...
thf(aprobcun_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprb) @ (cwcel @ XA2 @ (ccpw @ (ccdm @ XP))) @ ((cwbr @ XA2 @ ccom @ ccdom) & (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3))))) => ((ccfv @ (ccuni @ XA2) @ XP) = (ccesum @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XP)))))))).
...
thf(aunitssxrge0_ax,axiom,(cwss @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ ccc0 @ ccpnf @ ccicc))).
...
thf(cprobun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprb) @ (cwcel @ XA2 @ (ccdm @ XP)) @ (cwcel @ XB2 @ (ccdm @ XP))) => (((ccin @ XA2 @ XB2) = cc0) => ((ccfv @ (ccun @ XA2 @ XB2) @ XP) = (cco @ (ccfv @ XA2 @ XP) @ (ccfv @ XB2 @ XP) @ ccaddc)))))))).
