...
thf(afrpomin2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (((cw3a @ (cwfr @ XA2 @ XR) @ (cwpo @ XA2 @ XR) @ (cwse @ XA2 @ XR)) & ((cwss @ XB2 @ XA2) & (cwne @ XB2 @ cc0))) => (cwrex @ (^ [Xx3:$i] : ((ccpred @ XB2 @ XR @ (ccv @ Xx3)) = cc0)) @ (^ [Xx3:$i] : XB2))))))).
...
thf(cfrpoind_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (((cw3a @ (cwfr @ XA2 @ XR) @ (cwpo @ XA2 @ XR) @ (cwse @ XA2 @ XR)) & ((cwss @ XB2 @ XA2) & (cwral @ (^ [Xy1:$i] : ((cwss @ (ccpred @ XA2 @ XR @ (ccv @ Xy1)) @ XB2) => (cwcel @ (ccv @ Xy1) @ XB2))) @ (^ [Xy1:$i] : XA2)))) => (XA2 = XB2)))))).
