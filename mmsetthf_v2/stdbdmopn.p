...
thf(astdbdxmet_ax,axiom,(! [XC:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XD @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XC) @ XR @ ccle) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XC) @ XR))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ (cwcel @ XC @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XR @ ccxr) @ (cwbr @ ccc0 @ XR @ cclt)) => (cwcel @ (XD @ Xx3 @ Xy1) @ (ccfv @ XX @ ccxmt))))))))))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(ametequiv2_ax,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XC @ ccmopn)) => ((XK = (ccfv @ XD @ ccmopn)) => (((cwcel @ XC @ (ccfv @ XX @ ccxmt)) & (cwcel @ XD @ (ccfv @ XX @ ccxmt))) => ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xr:$i] : (cwrex @ (^ [Xs1:$i] : ((cwbr @ (ccv @ Xs1) @ (ccv @ Xr) @ ccle) & ((cco @ (ccv @ Xx3) @ (ccv @ Xs1) @ (ccfv @ XC @ ccbl)) = (cco @ (ccv @ Xx3) @ (ccv @ Xs1) @ (ccfv @ XD @ ccbl))))) @ (^ [Xs1:$i] : ccrp))) @ (^ [Xr:$i] : ccrp))) @ (^ [Xx3:$i] : XX)) => (XJ = XK))))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(cstdbdmopn_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XD @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XC) @ XR @ ccle) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XC) @ XR))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XJ @ Xx3 @ Xy1) = (ccfv @ XC @ ccmopn)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ (cwcel @ XC @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XR @ ccxr) @ (cwbr @ ccc0 @ XR @ cclt)) => ((XJ @ Xx3 @ Xy1) = (ccfv @ (XD @ Xx3 @ Xy1) @ ccmopn))))))))))))).
