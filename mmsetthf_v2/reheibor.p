...
thf(aismrer1_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : ((XR @ Xx3) = (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ ccr @ ccr)))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ XA2) @ (ccsn @ (ccv @ Xx3))))))) => (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => (cwcel @ (XF @ Xx3) @ (cco @ (XR @ Xx3) @ (ccfv @ (ccsn @ XA2) @ ccrrn) @ ccismty))))))))))).
...
thf(aisismty_ax,axiom,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XM @ (ccfv @ XX @ ccxmt)) & (cwcel @ XN @ (ccfv @ XY @ ccxmt))) => ((cwcel @ XF @ (cco @ XM @ XN @ ccismty)) <=> ((cwf1o @ XX @ XY @ XF) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XM) = (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ XN))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))))))))))).
...
thf(arrnheibor_ax,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (cco @ ccr @ XI @ ccmap)) => ((XM = (ccres @ (ccfv @ XI @ ccrrn) @ (ccxp @ XY @ XY))) => ((XT = (ccfv @ XM @ ccmopn)) => ((XU = (ccfv @ (ccfv @ XI @ ccrrn) @ ccmopn)) => (((cwcel @ XI @ ccfn) & (cwss @ XY @ XX)) => ((cwcel @ XT @ cccmp) <=> ((cwcel @ XY @ (ccfv @ XU @ cccld)) & (cwcel @ XM @ (ccfv @ XY @ ccbnd)))))))))))))))).
...
thf(aismtyhmeo_ax,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XJ = (ccfv @ XM @ ccmopn)) => ((XK = (ccfv @ XN @ ccmopn)) => (((cwcel @ XM @ (ccfv @ XX @ ccxmt)) & (cwcel @ XN @ (ccfv @ XY @ ccxmt))) => (cwss @ (cco @ XM @ XN @ ccismty) @ (cco @ XJ @ XK @ cchmeo)))))))))))).
thf(aeleqtrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ XB2)) => ((Xph => (XB2 = XC)) => (Xph => (cwcel @ XA2 @ XC))))))))).
thf(asyl22anc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xph => Xps) => ((Xph => Xch) => ((Xph => Xth) => ((Xph => Xta) => ((((Xps & Xch) & (Xth & Xta)) => Xet) => (Xph => Xet))))))))))))).
thf(cwfo_tp,type,(cwfo : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(cwfun_tp,type,(cwfun : (($i > $o) > $o))).
thf(aismtyres_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccima @ XF @ XA2)) => ((XS = (ccres @ XM @ (ccxp @ XA2 @ XA2))) => ((XT = (ccres @ XN @ (ccxp @ XB2 @ XB2))) => ((((cwcel @ XM @ (ccfv @ XX @ ccxmt)) & (cwcel @ XN @ (ccfv @ XY @ ccxmt))) & ((cwcel @ XF @ (cco @ XM @ XN @ ccismty)) & (cwss @ XA2 @ XX))) => (cwcel @ (ccres @ XF @ XA2) @ (cco @ XS @ XT @ ccismty)))))))))))))))).
...
thf(acmphmph_ax,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwbr @ XJ @ XK @ cchmph) => ((cwcel @ XJ @ cccmp) => (cwcel @ XK @ cccmp)))))).
...
thf(ahmeocld_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XF @ (cco @ XJ @ XK @ cchmeo)) & (cwss @ XA2 @ XX)) => ((cwcel @ XA2 @ (ccfv @ XJ @ cccld)) <=> (cwcel @ (ccima @ XF @ XA2) @ (ccfv @ XK @ cccld))))))))))).
...
thf(aismtybnd_ax,axiom,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XM @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XN @ (ccfv @ XY @ ccxmt)) @ (cwcel @ XF @ (cco @ XM @ XN @ ccismty))) => ((cwcel @ XM @ (ccfv @ XX @ ccbnd)) <=> (cwcel @ XN @ (ccfv @ XY @ ccbnd)))))))))).
thf(creheibor_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XY:($i > $o)] : ((XM = (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XY @ XY))) => ((XT = (ccfv @ XM @ ccmopn)) => ((XU = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((cwss @ XY @ ccr) => ((cwcel @ XT @ cccmp) <=> ((cwcel @ XY @ (ccfv @ XU @ cccld)) & (cwcel @ XM @ (ccfv @ XY @ ccbnd))))))))))))).
