...
thf(adf_transport_ax,axiom,(cctransport = (ccoprab @ (^ [Xp:$i] : (^ [Xq:$i] : (^ [Xx3:$i] : (cwrex @ (^ [Xn:$i] : ((cw3a @ (cwcel @ (ccv @ Xp) @ (ccxp @ (ccfv @ (ccv @ Xn) @ ccee) @ (ccfv @ (ccv @ Xn) @ ccee))) @ (cwcel @ (ccv @ Xq) @ (ccxp @ (ccfv @ (ccv @ Xn) @ ccee) @ (ccfv @ (ccv @ Xn) @ ccee))) @ (cwne @ (ccfv @ (ccv @ Xq) @ cc1st) @ (ccfv @ (ccv @ Xq) @ cc2nd))) & ((ccv @ Xx3) = (ccrio @ (^ [Xr:$i] : ((cwbr @ (ccfv @ (ccv @ Xq) @ cc2nd) @ (ccop @ (ccfv @ (ccv @ Xq) @ cc1st) @ (ccv @ Xr)) @ ccbtwn) & (cwbr @ (ccop @ (ccfv @ (ccv @ Xq) @ cc2nd) @ (ccv @ Xr)) @ (ccv @ Xp) @ cccgr))) @ (^ [Xr:$i] : (ccfv @ (ccv @ Xn) @ ccee)))))) @ (^ [Xn:$i] : ccn)))))))).
