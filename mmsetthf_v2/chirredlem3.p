...
thf(achirredlem2_ax,axiom,(! [XA2:($i > $o)] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((cwcel @ XA2 @ ccch) => (((((cwcel @ (ccv @ Xp) @ ccat) & (cwss @ (ccv @ Xp) @ XA2)) & ((cwcel @ (ccv @ Xq) @ ccch) & (cwss @ (ccv @ Xq) @ (ccfv @ XA2 @ ccort)))) & (((cwcel @ (ccv @ Xr) @ ccat) & (cwss @ (ccv @ Xr) @ XA2)) & (cwss @ (ccv @ Xr) @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ cchj)))) => ((ccin @ (ccfv @ (ccv @ Xr) @ ccort) @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ cchj)) = (ccv @ Xq))))))))).
...
thf(apjoml2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwss @ XA2 @ XB2)) => ((cco @ XA2 @ (ccin @ (ccfv @ XA2 @ ccort) @ XB2) @ cchj) = XB2))))).
...
thf(afh1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) & ((cwbr @ XA2 @ XB2 @ cccm) & (cwbr @ XA2 @ XC @ cccm))) => ((ccin @ XA2 @ (cco @ XB2 @ XC @ cchj)) = (cco @ (ccin @ XA2 @ XB2) @ (ccin @ XA2 @ XC) @ cchj))))))).
