...
thf(anolt02olem_ax,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccsur) @ (cwcel @ XX @ ccon0) @ ((ccfv @ XX @ XA2) = cc0)) => (cwss @ (ccdm @ XA2) @ XX))))).
...
thf(a_3oran_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3o @ Xph @ Xps @ Xch) <=> (~ (cw3a @ (~ Xph) @ (~ Xps) @ (~ Xch)))))))).
...
thf(cnolt02o_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cw3a @ (cwcel @ XA2 @ ccsur) @ (cwcel @ XB2 @ ccsur) @ (cwcel @ XX @ ccon0)) @ (((ccres @ XA2 @ XX) = (ccres @ XB2 @ XX)) & (cwbr @ XA2 @ XB2 @ ccslt)) @ ((ccfv @ XX @ XA2) = cc0)) => ((ccfv @ XX @ XB2) = cc2o)))))).
