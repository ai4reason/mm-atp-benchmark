...
thf(cumgrnloopv_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XE = (ccfv @ XG @ cciedg)) => (((cwcel @ XG @ ccumgr) & (cwcel @ XM @ XW)) => (((ccfv @ XX @ XE) = (ccpr @ XM @ XN)) => (cwne @ XM @ XN))))))))))).
