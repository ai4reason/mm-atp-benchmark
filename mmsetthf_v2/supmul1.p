...
thf(aprodgt02_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwbr @ ccc0 @ XB2 @ ccle) & (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul) @ cclt))) => (cwbr @ ccc0 @ XA2 @ cclt))))).
...
thf(csupmul1_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : ((XC @ Xy1 @ Xz @ Xv) = (ccab @ (^ [Xz:$i] : (cwrex @ (^ [Xv:$i] : ((ccv @ Xz) = (cco @ (XA2 @ Xy1) @ (ccv @ Xv) @ ccmul))) @ (^ [Xv:$i] : XB2)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xv) <=> ((cw3a @ (cwcel @ (XA2 @ Xy1) @ ccr) @ (cwbr @ ccc0 @ (XA2 @ Xy1) @ ccle) @ (cwral @ (^ [Xx3:$i] : (cwbr @ ccc0 @ (ccv @ Xx3) @ ccle)) @ (^ [Xx3:$i] : XB2))) & (cw3a @ (cwss @ XB2 @ ccr) @ (cwne @ XB2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : ccr))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xv) => ((cco @ (XA2 @ Xy1) @ (ccsup @ XB2 @ ccr @ cclt) @ ccmul) = (ccsup @ (XC @ Xy1 @ Xz @ Xv) @ ccr @ cclt)))))))))))))).
