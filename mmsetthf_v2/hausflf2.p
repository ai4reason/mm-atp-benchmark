...
thf(chausflf2_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cw3a @ (cwcel @ XJ @ ccha) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) & (cwne @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf)) @ cc0)) => (cwbr @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf)) @ cc1o @ ccen))))))))).
