...
thf(asuprzub_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xy1:$i] : ((cw3a @ (cwss @ XA2 @ ccz) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccz)) @ (cwcel @ (XB2 @ Xy1) @ XA2)) => (cwbr @ (XB2 @ Xy1) @ (ccsup @ XA2 @ ccr @ cclt) @ ccle)))))).
