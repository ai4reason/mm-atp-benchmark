...
thf(aefrn2lp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwfr @ XA2 @ ccep) & ((cwcel @ XB2 @ XA2) & (cwcel @ XC @ XA2))) => (~ ((cwcel @ XB2 @ XC) & (cwcel @ XC @ XB2)))))))).
...
thf(cen2lp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (~ ((cwcel @ XA2 @ XB2) & (cwcel @ XB2 @ XA2)))))).
