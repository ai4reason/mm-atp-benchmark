...
thf(afsuppmapnn0fiublem_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((XU = (cciun @ (^ [Xf1:$i] : XM) @ (^ [Xf1:$i] : (cco @ (ccv @ Xf1) @ XZ @ ccsupp)))) => ((! [Xf1:$i] : ((XS @ Xf1) = (ccsup @ XU @ ccr @ cclt))) => (! [Xf1:$i] : ((cw3a @ (cwss @ XM @ (cco @ XR @ ccn0 @ ccmap)) @ (cwcel @ XM @ ccfn) @ (cwcel @ XZ @ XV)) => (((cwral @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XZ @ ccfsupp)) @ (^ [Xf1:$i] : XM)) & (cwne @ XU @ cc0)) => (cwcel @ (XS @ Xf1) @ ccn0))))))))))))).
thf(asupfirege_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : ((Xph => (cwss @ XB2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccfn)) => ((Xph => (cwcel @ XC @ XB2)) => ((Xph => (XS = (ccsup @ XB2 @ ccr @ cclt))) => (Xph => (cwbr @ XC @ XS @ ccle))))))))))).
...
thf(cfsuppmapnn0fiubOLD_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((XU = (cciun @ (^ [Xf1:$i] : XM) @ (^ [Xf1:$i] : (cco @ (ccv @ Xf1) @ XZ @ ccsupp)))) => ((! [Xf1:$i] : ((XS @ Xf1) = (ccsup @ XU @ ccr @ cclt))) => ((cw3a @ (cwss @ XM @ (cco @ XR @ ccn0 @ ccmap)) @ (cwcel @ XM @ ccfn) @ (cwcel @ XZ @ XV)) => (((cwral @ (^ [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XZ @ ccfsupp)) @ (^ [Xf1:$i] : XM)) & (cwne @ XU @ cc0)) => (cwral @ (^ [Xf1:$i] : (cwss @ (cco @ (ccv @ Xf1) @ XZ @ ccsupp) @ (cco @ ccc0 @ (XS @ Xf1) @ ccfz))) @ (^ [Xf1:$i] : XM))))))))))))).
