...
thf(cseqcl2_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((Xph => (cwcel @ (ccfv @ XM @ XF) @ XC)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XC) & (cwcel @ (ccv @ Xy1) @ XD))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XC)))) => ((! [Xy1:$i] : (Xph => (cwcel @ (XN @ Xy1) @ (ccfv @ XM @ ccuz)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ (XN @ Xy1) @ ccfz))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ XD)))) => (! [Xy1:$i] : (Xph => (cwcel @ (ccfv @ (XN @ Xy1) @ (ccseq @ Xc_pl @ XF @ XM)) @ XC))))))))))))))).
