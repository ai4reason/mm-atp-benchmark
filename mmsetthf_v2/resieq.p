...
thf(aopres_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XA2 @ XD) => ((cwcel @ (ccop @ XA2 @ XB2) @ (ccres @ XC @ XD)) <=> (cwcel @ (ccop @ XA2 @ XB2) @ XC))))))))).
...
thf(cresieq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XB2 @ XA2) & (cwcel @ XC @ XA2)) => ((cwbr @ XB2 @ XC @ (ccres @ ccid @ XA2)) <=> (XB2 = XC))))))).
