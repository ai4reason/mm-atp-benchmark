...
thf(adf_ushgr_ax,axiom,(ccushgr = (ccab @ (^ [Xg1:$i] : (cwsbc @ (^ [Xv:$i] : (cwsbc @ (^ [Xe:$i] : (cwf1 @ (ccdm @ (ccv @ Xe)) @ (ccdif @ (ccpw @ (ccv @ Xv)) @ (ccsn @ cc0)) @ (ccv @ Xe))) @ (ccfv @ (ccv @ Xg1) @ cciedg))) @ (ccfv @ (ccv @ Xg1) @ ccvtx)))))).
...
thf(cisushgr_conj,conjecture,(! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ cciedg)) => ((cwcel @ XG @ XU) => ((cwcel @ XG @ ccushgr) <=> (cwf1 @ (ccdm @ XE) @ (ccdif @ (ccpw @ XV) @ (ccsn @ cc0)) @ XE)))))))))).
