...
thf(acdleme19d_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XU = (cco @ (cco @ XP @ XQ @ Xc_or) @ XW @ Xc_an)) => ((XF = (cco @ (cco @ XS @ XU @ Xc_or) @ (cco @ XQ @ (cco @ (cco @ XP @ XS @ Xc_or) @ XW @ Xc_an) @ Xc_or) @ Xc_an)) => ((XG = (cco @ (cco @ XT @ XU @ Xc_or) @ (cco @ XQ @ (cco @ (cco @ XP @ XT @ Xc_or) @ XW @ Xc_an) @ Xc_or) @ Xc_an)) => ((XD = (cco @ (cco @ XR @ XS @ Xc_or) @ XW @ Xc_an)) => ((XY = (cco @ (cco @ XR @ XT @ Xc_or) @ XW @ Xc_an)) => ((cw3a @ (cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) @ ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le)))) @ (cw3a @ ((cwcel @ XS @ XA2) & (~ (cwbr @ XS @ XW @ Xc_le))) @ ((cwcel @ XT @ XA2) & (~ (cwbr @ XT @ XW @ Xc_le))) @ (cwcel @ XR @ XA2)) @ (cw3a @ ((cwne @ XP @ XQ) & (cwne @ XS @ XT)) @ ((~ (cwbr @ XS @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)) & (~ (cwbr @ XT @ (cco @ XP @ XQ @ Xc_or) @ Xc_le))) @ ((cwbr @ XR @ (cco @ XP @ XQ @ Xc_or) @ Xc_le) & (cwbr @ XR @ (cco @ XS @ XT @ Xc_or) @ Xc_le)))) => ((cco @ XF @ XD @ Xc_or) = (cco @ XF @ XG @ Xc_or))))))))))))))))))))))))))))))).
