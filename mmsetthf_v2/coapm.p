...
thf(admcoass_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : ((Xc_x = (ccfv @ XC @ cccoa)) => ((XA2 = (ccfv @ XC @ ccarw)) => (cwss @ (ccdm @ Xc_x) @ (ccxp @ XA2 @ XA2)))))))).
...
thf(acoahom_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_x = (ccfv @ XC @ cccoa)) => ((XH = (ccfv @ XC @ cchoma)) => ((Xph => (cwcel @ XF @ (cco @ XX @ XY @ XH))) => ((Xph => (cwcel @ XG @ (cco @ XY @ XZ @ XH))) => (Xph => (cwcel @ (cco @ XG @ XF @ Xc_x) @ (cco @ XX @ XZ @ XH))))))))))))))))).
...
thf(aeldmcoa_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xc_x = (ccfv @ XC @ cccoa)) => ((XA2 = (ccfv @ XC @ ccarw)) => ((cwbr @ XG @ XF @ (ccdm @ Xc_x)) <=> (cw3a @ (cwcel @ XF @ XA2) @ (cwcel @ XG @ XA2) @ ((ccfv @ XF @ cccoda) = (ccfv @ XG @ ccdoma)))))))))))).
