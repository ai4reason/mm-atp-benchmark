...
thf(a_2zrngaabl_ax,axiom,(! [XR:($i > $o)] : (! [XE:($i > $o)] : ((XE = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xz) = (cco @ cc2 @ (ccv @ Xx3) @ ccmul))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccz))) => ((XR = (cco @ cccnfld @ XE @ ccress)) => (cwcel @ XR @ ccabl)))))).
thf(ccbs_tp,type,(ccbs : ($i > $o))).
thf(ccmgm_tp,type,(ccmgm : ($i > $o))).
thf(a_2zrngmsgrp_ax,axiom,(! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : ((XE = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xz) = (cco @ cc2 @ (ccv @ Xx3) @ ccmul))) @ (^ [Xx3:$i] : ccz))) @ (^ [Xz:$i] : ccz))) => ((XR = (cco @ cccnfld @ XE @ ccress)) => ((! [Xx3:$i] : (! [Xz:$i] : ((XM @ Xx3 @ Xz) = (ccfv @ XR @ ccmgp)))) => (! [Xx3:$i] : (! [Xz:$i] : (cwcel @ (XM @ Xx3 @ Xz) @ ccsgrp)))))))))).
