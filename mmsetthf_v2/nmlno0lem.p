...
thf(anvmul0or_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XS = (ccfv @ XU @ ccns)) => ((XZ = (ccfv @ XU @ ccn0v)) => ((cw3a @ (cwcel @ XU @ ccnv) @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ XX)) => (((cco @ XA2 @ XB2 @ XS) = XZ) <=> ((XA2 = ccc0) | (XB2 = XZ)))))))))))))).
...
thf(anmoo0_ax,axiom,(! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XN = (cco @ XU @ XW @ ccnmoo)) => ((XZ = (cco @ XU @ XW @ cc0o)) => (((cwcel @ XU @ ccnv) & (cwcel @ XW @ ccnv)) => ((ccfv @ XZ @ XN) = ccc0))))))))).
