...
thf(aordzsl_ax,axiom,(! [XA2:($i > $o)] : ((cword @ XA2) <=> (cw3o @ (XA2 = cc0) @ (cwrex @ (^ [Xx3:$i] : (XA2 = (ccsuc @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0)) @ (cwlim @ XA2))))).
...
thf(aoaabslem_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ ccom @ ccon0) & (cwcel @ XA2 @ ccom)) => ((cco @ XA2 @ ccom @ ccoa) = ccom)))).
