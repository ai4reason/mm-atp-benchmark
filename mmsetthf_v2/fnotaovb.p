...
thf(afnopafvb_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XA2) & (cwcel @ XB2 @ XA2)) => (((ccafv @ XB2 @ XF) = XC) <=> (cwcel @ (ccop @ XB2 @ XC) @ XF)))))))).
...
thf(cfnotaovb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwfn @ XF @ (ccxp @ XA2 @ XB2)) @ (cwcel @ XC @ XA2) @ (cwcel @ XD @ XB2)) => (((ccaov @ XC @ XD @ XF) = XR) <=> (cwcel @ (ccotp @ XC @ XD @ XR) @ XF)))))))))).
