...
thf(alimcmpt2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ XA2)) => ((! [Xz:$i] : ((Xph & ((cwcel @ (ccv @ Xz) @ XA2) & (cwne @ (ccv @ Xz) @ XB2))) => (cwcel @ (XD @ Xz) @ ccc))) => ((! [Xz:$i] : ((XJ @ Xz) = (cco @ (XK @ Xz) @ XA2 @ ccrest))) => ((! [Xz:$i] : ((XK @ Xz) = (ccfv @ cccnfld @ cctopn))) => (! [Xz:$i] : (Xph => ((cwcel @ XC @ (cco @ (ccmpt @ (^ [Xz:$i] : (ccdif @ XA2 @ (ccsn @ XB2))) @ (^ [Xz:$i] : (XD @ Xz))) @ XB2 @ cclimc)) <=> (cwcel @ (ccmpt @ (^ [Xz:$i] : XA2) @ (^ [Xz:$i] : (ccif @ ((ccv @ Xz) = XB2) @ XC @ (XD @ Xz)))) @ (ccfv @ XB2 @ (cco @ (XJ @ Xz) @ (XK @ Xz) @ cccnp))))))))))))))))))).
...
thf(cdvcnp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (cco @ XK @ XA2 @ ccrest)) => ((XK = (ccfv @ cccnfld @ cctopn)) => ((! [Xz:$i] : ((XG @ Xz) = (ccmpt @ (^ [Xz:$i] : XA2) @ (^ [Xz:$i] : (ccif @ ((ccv @ Xz) = XB2) @ (ccfv @ XB2 @ (cco @ XS @ XF @ ccdv)) @ (cco @ (cco @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ XB2 @ XF) @ ccmin) @ (cco @ (ccv @ Xz) @ XB2 @ ccmin) @ ccdiv)))))) => (! [Xz:$i] : (((cw3a @ (cwcel @ XS @ (ccpr @ ccr @ ccc)) @ (cwf @ XA2 @ ccc @ XF) @ (cwss @ XA2 @ XS)) & (cwcel @ XB2 @ (ccdm @ (cco @ XS @ XF @ ccdv)))) => (cwcel @ (XG @ Xz) @ (ccfv @ XB2 @ (cco @ XJ @ XK @ cccnp)))))))))))))))).
