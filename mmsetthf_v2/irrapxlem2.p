...
thf(airrapxlem1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwcel @ XB2 @ ccn)) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt) & ((ccfv @ (cco @ XB2 @ (cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ cc1 @ ccmo) @ ccmul) @ ccfl) = (ccfv @ (cco @ XB2 @ (cco @ (cco @ XA2 @ (ccv @ Xy1) @ ccmul) @ cc1 @ ccmo) @ ccmul) @ ccfl)))) @ (^ [Xy1:$i] : (cco @ ccc0 @ XB2 @ ccfz)))) @ (^ [Xx3:$i] : (cco @ ccc0 @ XB2 @ ccfz))))))).
...
thf(aintfrac_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (XA2 = (cco @ (ccfv @ XA2 @ ccfl) @ (cco @ XA2 @ cc1 @ ccmo) @ ccaddc))))).
thf(aadantl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xch & Xph) => Xps)))))).
thf(aoveq1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XC @ XF)))))))))).
thf(asimpr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(apnpcand_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => (Xph => ((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XA2 @ XC @ ccaddc) @ ccmin) = (cco @ XB2 @ XC @ ccmin))))))))))).
...
thf(amodelico_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccrp)) => (cwcel @ (cco @ XA2 @ XB2 @ ccmo) @ (cco @ ccc0 @ XB2 @ ccico)))))).
thf(ccneg_tp,type,(ccneg : (($i > $o) > ($i > $o)))).
thf(aicodiamlt_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico)) & (cwcel @ XD @ (cco @ XA2 @ XB2 @ ccico)))) => (cwbr @ (ccfv @ (cco @ XC @ XD @ ccmin) @ ccabs) @ (cco @ XB2 @ XA2 @ ccmin) @ cclt))))))).
...
thf(cirrapxlem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwcel @ XB2 @ ccn)) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ cclt) & (cwbr @ (ccfv @ (cco @ (cco @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ cc1 @ ccmo) @ (cco @ (cco @ XA2 @ (ccv @ Xy1) @ ccmul) @ cc1 @ ccmo) @ ccmin) @ ccabs) @ (cco @ cc1 @ XB2 @ ccdiv) @ cclt))) @ (^ [Xy1:$i] : (cco @ ccc0 @ XB2 @ ccfz)))) @ (^ [Xx3:$i] : (cco @ ccc0 @ XB2 @ ccfz))))))).
