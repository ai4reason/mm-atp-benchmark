...
thf(afmtnorec2_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccfmtno) = (cco @ (ccprod @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ ccfmtno))) @ cc2 @ ccaddc))))).
...
thf(afmtno_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((ccfv @ XN @ ccfmtno) = (cco @ (cco @ cc2 @ (cco @ cc2 @ XN @ ccexp) @ ccexp) @ cc1 @ ccaddc))))).
...
thf(afmtnom1nn_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cco @ (ccfv @ XN @ ccfmtno) @ cc1 @ ccmin) = (cco @ cc2 @ (cco @ cc2 @ XN @ ccexp) @ ccexp))))).
...
thf(cfmtnorec3_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) => ((ccfv @ XN @ ccfmtno) = (cco @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ ccfmtno) @ (cco @ (cco @ cc2 @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccexp) @ (ccprod @ (^ [Xn:$i] : (cco @ ccc0 @ (cco @ XN @ cc2 @ ccmin) @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ ccfmtno))) @ ccmul) @ ccaddc))))).
