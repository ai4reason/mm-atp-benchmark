...
thf(cisf34lem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ XV) & (cwss @ (XX @ Xx3) @ (ccpw @ XA2))) => ((ccima @ (XF @ Xx3) @ (ccima @ (XF @ Xx3) @ (XX @ Xx3))) = (XX @ Xx3)))))))))).
