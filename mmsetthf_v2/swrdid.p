...
thf(aswrd0f_ax,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) => (cwf @ (cco @ ccc0 @ XN @ ccfzo) @ XV @ (cco @ XW @ (ccop @ ccc0 @ XN) @ ccsubstr))))))).
...
thf(cswrdid_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XS @ (ccword @ XA2)) => ((cco @ XS @ (ccop @ ccc0 @ (ccfv @ XS @ cchash)) @ ccsubstr) = XS))))).
