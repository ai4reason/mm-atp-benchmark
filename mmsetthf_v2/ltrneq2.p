...
thf(ahlateq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => ((cwral @ (^ [Xp:$i] : ((cwbr @ (ccv @ Xp) @ XX @ Xc_le) <=> (cwbr @ (ccv @ Xp) @ XY @ Xc_le))) @ (^ [Xp:$i] : XA2)) <=> (XX = XY))))))))))))).
...
thf(cltrneq2_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xp:$i] : (XA2 = (ccfv @ (XK @ Xp) @ ccatm))) => ((! [Xp:$i] : ((XH @ Xp) = (ccfv @ (XK @ Xp) @ cclh))) => ((! [Xp:$i] : ((XT @ Xp) = (ccfv @ (XW @ Xp) @ (ccfv @ (XK @ Xp) @ ccltrn)))) => (! [Xp:$i] : ((cw3a @ ((cwcel @ (XK @ Xp) @ cchlt) & (cwcel @ (XW @ Xp) @ (XH @ Xp))) @ (cwcel @ XF @ (XT @ Xp)) @ (cwcel @ XG @ (XT @ Xp))) => ((cwral @ (^ [Xp:$i] : ((ccfv @ (ccv @ Xp) @ XF) = (ccfv @ (ccv @ Xp) @ XG))) @ (^ [Xp:$i] : XA2)) <=> (XF = XG))))))))))))))).
