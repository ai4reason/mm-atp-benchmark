...
thf(apo0_ax,axiom,(! [XR:($i > $o)] : (cwpo @ cc0 @ XR))).
thf(apoeq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((XA2 = XB2) => ((cwpo @ XA2 @ XR) <=> (cwpo @ XB2 @ XR))))))).
thf(cipo0_conj,conjecture,(! [XA2:($i > $o)] : ((cwpo @ XA2 @ ccid) <=> (XA2 = cc0)))).
