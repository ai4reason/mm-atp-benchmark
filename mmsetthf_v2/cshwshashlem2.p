...
thf(afzonmapblen_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (cco @ ccc0 @ XN @ ccfzo)) @ (cwcel @ XB2 @ (cco @ ccc0 @ XN @ ccfzo)) @ (cwbr @ XB2 @ XA2 @ cclt)) => (cwbr @ (cco @ XB2 @ (cco @ XN @ XA2 @ ccmin) @ ccaddc) @ XN @ cclt)))))).
...
thf(a_2cshw_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) => ((cco @ (cco @ XW @ XM @ cccsh) @ XN @ cccsh) = (cco @ XW @ (cco @ XM @ XN @ ccaddc) @ cccsh)))))))).
thf(asyl2an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xps) => ((Xta => Xch) => (((Xps & Xch) => Xth) => ((Xph & Xta) => Xth)))))))))).
thf(asylan2_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xch) => (((Xps & Xch) => Xth) => ((Xps & Xph) => Xth)))))))).
thf(a_2cshwid_ax,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ ccz)) => ((cco @ (cco @ XW @ XN @ cccsh) @ (cco @ (ccfv @ XW @ cchash) @ XN @ ccmin) @ cccsh) = XW)))))).
...
thf(aelfzo1_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (cco @ cc1 @ XM @ ccfzo)) <=> (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XM @ ccn) @ (cwbr @ XN @ XM @ cclt)))))).
thf(ccreps_tp,type,(ccreps : ($i > $o))).
thf(acshwshashlem1_ax,axiom,(! [Xph:$o] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => ((cwcel @ XW @ (ccword @ XV)) & (cwcel @ (ccfv @ XW @ cchash) @ ccprime))) => ((cw3a @ Xph @ (cwrex @ (^ [Xi:$i] : (cwne @ (ccfv @ (ccv @ Xi) @ XW) @ (ccfv @ ccc0 @ XW))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) @ (cwcel @ XL @ (cco @ cc1 @ (ccfv @ XW @ cchash) @ ccfzo))) => (cwne @ (cco @ XW @ XL @ cccsh) @ XW)))))))).
thf(a_2a1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (Xps => (Xch => Xph))))))).
thf(ccshwshashlem2_conj,conjecture,(! [Xph:$o] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => ((cwcel @ XW @ (ccword @ XV)) & (cwcel @ (ccfv @ XW @ cchash) @ ccprime))) => ((Xph & (cwrex @ (^ [Xi:$i] : (cwne @ (ccfv @ (ccv @ Xi) @ XW) @ (ccfv @ ccc0 @ XW))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)))) => ((cw3a @ (cwcel @ XL @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)) @ (cwcel @ XK @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)) @ (cwbr @ XK @ XL @ cclt)) => (cwne @ (cco @ XW @ XL @ cccsh) @ (cco @ XW @ XK @ cccsh))))))))))).
