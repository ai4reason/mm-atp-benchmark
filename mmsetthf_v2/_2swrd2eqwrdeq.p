...
thf(a_2swrdeqwrdeq_ax,axiom,(! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XS @ (ccword @ XV)) @ (cwcel @ XI @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) => ((XW = XS) <=> (((ccfv @ XW @ cchash) = (ccfv @ XS @ cchash)) & (((cco @ XW @ (ccop @ ccc0 @ XI) @ ccsubstr) = (cco @ XS @ (ccop @ ccc0 @ XI) @ ccsubstr)) & ((cco @ XW @ (ccop @ XI @ (ccfv @ XW @ cchash)) @ ccsubstr) = (cco @ XS @ (ccop @ XI @ (ccfv @ XW @ cchash)) @ ccsubstr))))))))))).
...
thf(aswrd2lsw_ax,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwbr @ cc1 @ (ccfv @ XW @ cchash) @ cclt)) => ((cco @ XW @ (ccop @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin) @ (ccfv @ XW @ cchash)) @ ccsubstr) = (ccs2 @ (ccfv @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin) @ XW) @ (ccfv @ XW @ cclsw))))))).
...
thf(as2eq2s1eq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : ((((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) & ((cwcel @ XC @ XV) & (cwcel @ XD @ XV))) => (((ccs2 @ XA2 @ XB2) = (ccs2 @ XC @ XD)) <=> (((ccs1 @ XA2) = (ccs1 @ XC)) & ((ccs1 @ XB2) = (ccs1 @ XD))))))))))).
thf(aanbi12d_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => (Xps <=> Xch)) => ((Xph => (Xth <=> Xta)) => (Xph => ((Xps & Xth) <=> (Xch & Xta))))))))))).
thf(ccio_tp,type,(ccio : (($i > $o) > ($i > $o)))).
thf(afvex_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(as111_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XS @ XA2) & (cwcel @ XT @ XA2)) => (((ccs1 @ XS) = (ccs1 @ XT)) <=> (XS = XT))))))).
...
thf(c_2swrd2eqwrdeq_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XU @ (ccword @ XV)) @ (cwbr @ cc1 @ (ccfv @ XW @ cchash) @ cclt)) => ((XW = XU) <=> (((ccfv @ XW @ cchash) = (ccfv @ XU @ cchash)) & (cw3a @ ((cco @ XW @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin)) @ ccsubstr) = (cco @ XU @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin)) @ ccsubstr)) @ ((ccfv @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin) @ XW) = (ccfv @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin) @ XU)) @ ((ccfv @ XW @ cclsw) = (ccfv @ XU @ cclsw)))))))))).
