...
thf(alnopco0i_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XS @ cclo) => ((cwcel @ XT @ cclo) => (((ccfv @ XT @ ccnop) = ccc0) => ((ccfv @ (cccom @ XS @ XT) @ ccnop) = ccc0))))))).
thf(cclno_tp,type,(cclno : ($i > $o))).
thf(cc0o_tp,type,(cc0o : ($i > $o))).
thf(ccnmoo_tp,type,(ccnmoo : ($i > $o))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(anmlnop0iHIL_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => (((ccfv @ XT @ ccnop) = ccc0) <=> (XT = cch0o))))).
...
thf(aho0val_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((ccfv @ XA2 @ cch0o) = cc0v)))).
thf(ccsqrt_tp,type,(ccsqrt : ($i > $o))).
thf(ccsp_tp,type,(ccsp : ($i > $o))).
thf(anorm0_ax,axiom,((ccfv @ cc0v @ ccno) = ccc0)).
...
thf(anmopgt0_ax,axiom,(! [XT:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((cwne @ (ccfv @ XT @ ccnop) @ ccc0) <=> (cwbr @ ccc0 @ (ccfv @ XT @ ccnop) @ cclt))))).
thf(arecgt0i_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwbr @ ccc0 @ XA2 @ cclt) => (cwbr @ ccc0 @ (cco @ cc1 @ XA2 @ ccdiv) @ cclt))))).
...
thf(arecclzi_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwne @ XA2 @ ccc0) => (cwcel @ (cco @ cc1 @ XA2 @ ccdiv) @ ccc))))).
...
thf(anmoplb_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwf @ cchil @ cchil @ XT) @ (cwcel @ XA2 @ cchil) @ (cwbr @ (ccfv @ XA2 @ ccno) @ cc1 @ ccle)) => (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ ccno) @ (ccfv @ XT @ ccnop) @ ccle))))).
...
thf(cnmopcoi_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XS @ ccbo) => ((cwcel @ XT @ ccbo) => (cwbr @ (ccfv @ (cccom @ XS @ XT) @ ccnop) @ (cco @ (ccfv @ XS @ ccnop) @ (ccfv @ XT @ ccnop) @ ccmul) @ ccle)))))).
