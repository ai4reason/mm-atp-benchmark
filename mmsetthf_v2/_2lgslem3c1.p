...
thf(amodmuladdnn0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XA2 @ ccn0) & (cwcel @ XM @ ccrp)) => (((cco @ XA2 @ XM @ ccmo) = XB2) => (cwrex @ (^ [Xk:$i] : (XA2 = (cco @ (cco @ (ccv @ Xk) @ XM @ ccmul) @ XB2 @ ccaddc))) @ (^ [Xk:$i] : ccn0)))))))).
...
thf(a_2lgslem3c_ax,axiom,(! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin)) => (((cwcel @ XK @ ccn0) & (XP = (cco @ (cco @ cc8 @ XK @ ccmul) @ cc5 @ ccaddc))) => (XN = (cco @ (cco @ cc2 @ XK @ ccmul) @ cc1 @ ccaddc)))))))).
...
thf(a_2tp1odd_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (XB2 = (cco @ (cco @ cc2 @ XA2 @ ccmul) @ cc1 @ ccaddc))) => (~ (cwbr @ cc2 @ XB2 @ ccdvds)))))).
...
thf(c_2lgslem3c1_conj,conjecture,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin)) => (((cwcel @ XP @ ccn) & ((cco @ XP @ cc8 @ ccmo) = cc5)) => ((cco @ XN @ cc2 @ ccmo) = cc1)))))).
