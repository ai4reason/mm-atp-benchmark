...
thf(amreexexd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XI:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (! [Xq:$i] : (Xph => (cwcel @ (XA2 @ Xy1 @ Xz @ Xs1 @ Xq) @ (ccfv @ (XX @ Xq) @ ccmre))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (! [Xq:$i] : ((XN @ Xq) = (ccfv @ (XA2 @ Xy1 @ Xz @ Xs1 @ Xq) @ ccmrc)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (! [Xq:$i] : (XI = (ccfv @ (XA2 @ Xy1 @ Xz @ Xs1 @ Xq) @ ccmri)))))) => ((! [Xq:$i] : (Xph => (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwcel @ (ccv @ Xy1) @ (ccfv @ (ccun @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xz))) @ (XN @ Xq)))) @ (^ [Xz:$i] : (ccdif @ (ccfv @ (ccun @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xy1))) @ (XN @ Xq)) @ (ccfv @ (ccv @ Xs1) @ (XN @ Xq)))))) @ (^ [Xy1:$i] : (XX @ Xq)))) @ (^ [Xs1:$i] : (ccpw @ (XX @ Xq)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (! [Xq:$i] : (Xph => (cwss @ (XF @ Xy1 @ Xz @ Xs1) @ (ccdif @ (XX @ Xq) @ (XH @ Xy1 @ Xz @ Xs1)))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (! [Xq:$i] : (Xph => (cwss @ (XG @ Xy1 @ Xz @ Xs1) @ (ccdif @ (XX @ Xq) @ (XH @ Xy1 @ Xz @ Xs1)))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (! [Xq:$i] : (Xph => (cwss @ (XF @ Xy1 @ Xz @ Xs1) @ (ccfv @ (ccun @ (XG @ Xy1 @ Xz @ Xs1) @ (XH @ Xy1 @ Xz @ Xs1)) @ (XN @ Xq)))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (Xph => (cwcel @ (ccun @ (XF @ Xy1 @ Xz @ Xs1) @ (XH @ Xy1 @ Xz @ Xs1)) @ XI))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (Xph => ((cwcel @ (XF @ Xy1 @ Xz @ Xs1) @ ccfn) | (cwcel @ (XG @ Xy1 @ Xz @ Xs1) @ ccfn)))))) => (! [Xy1:$i] : (! [Xz:$i] : (! [Xs1:$i] : (Xph => (cwrex @ (^ [Xq:$i] : ((cwbr @ (XF @ Xy1 @ Xz @ Xs1) @ (ccv @ Xq) @ ccen) & (cwcel @ (ccun @ (ccv @ Xq) @ (XH @ Xy1 @ Xz @ Xs1)) @ XI))) @ (^ [Xq:$i] : (ccpw @ (XG @ Xy1 @ Xz @ Xs1)))))))))))))))))))))))))).
...
thf(alssmre_ax,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XS = (ccfv @ XW @ cclss)) => ((cwcel @ XW @ cclmod) => (cwcel @ XS @ (ccfv @ XB2 @ ccmre))))))))).
...
thf(alinds1_ax,axiom,(! [XB2:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((cwcel @ XX @ (ccfv @ XW @ cclinds)) => (cwss @ XX @ XB2))))))).
...
thf(afrlmlbs_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : ((XF = (cco @ XR @ XI @ ccfrlm)) => ((XU = (cco @ XR @ XI @ ccuvc)) => ((XJ = (ccfv @ XF @ cclbs)) => (((cwcel @ XR @ ccrg) & (cwcel @ XI @ XV)) => (cwcel @ (ccrn @ XU) @ XJ)))))))))))).
...
thf(alindsind2_ax,axiom,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((XK = (ccfv @ XW @ cclspn)) => ((XL = (ccfv @ XW @ ccsca)) => ((cw3a @ ((cwcel @ XW @ cclmod) & (cwcel @ XL @ ccnzr)) @ (cwcel @ XF @ (ccfv @ XW @ cclinds)) @ (cwcel @ XE @ XF)) => (~ (cwcel @ XE @ (ccfv @ (ccdif @ XF @ (ccsn @ XE)) @ XK)))))))))))).
thf(aad2antrr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => (((Xph & Xch) & Xth) => Xps))))))).
thf(aeleq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cwcel @ XC @ XA2) <=> (cwcel @ XC @ XB2))))))))).
thf(asyl2an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xps) => ((Xta => Xch) => (((Xps & Xch) => Xth) => ((Xph & Xta) => Xth)))))))))).
thf(aismri2_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : ((XN @ Xx3) = (ccfv @ XA2 @ ccmrc))) => ((! [Xx3:$i] : ((XI @ Xx3) = (ccfv @ XA2 @ ccmri))) => (! [Xx3:$i] : (((cwcel @ XA2 @ (ccfv @ (XX @ Xx3) @ ccmre)) & (cwss @ XS @ (XX @ Xx3))) => ((cwcel @ XS @ (XI @ Xx3)) <=> (cwral @ (^ [Xx3:$i] : (~ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccdif @ XS @ (ccsn @ (ccv @ Xx3))) @ (XN @ Xx3))))) @ (^ [Xx3:$i] : XS))))))))))))).
thf(aolcd_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => (Xph => (Xch | Xps))))))).
thf(ampbid_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => (Xps <=> Xch)) => (Xph => Xch))))))).
thf(asimpr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(cwf1o_tp,type,(cwf1o : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(auvcendim_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((XU = (cco @ XR @ XI @ ccuvc)) => (((cwcel @ XR @ ccnzr) & (cwcel @ XI @ XW)) => (cwbr @ XI @ (ccrn @ XU) @ ccen)))))))).
...
thf(clindsdom_conj,conjecture,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XI @ ccfn) @ (cwcel @ XX @ (ccfv @ (cco @ XR @ XI @ ccfrlm) @ cclinds))) => (cwbr @ XX @ XI @ ccdom)))))).
