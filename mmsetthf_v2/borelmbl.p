...
thf(asalgenss_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ XV)) => ((XG = (ccfv @ XX @ ccsalgen)) => ((Xph => (cwcel @ XS @ ccsalg)) => ((Xph => (cwss @ XX @ XS)) => ((Xph => ((ccuni @ XS) = (ccuni @ XX))) => (Xph => (cwss @ XG @ XS))))))))))))).
...
thf(aunidmvon_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((XS = (ccdm @ (ccfv @ XX @ ccvoln))) => (Xph => ((ccuni @ XS) = (cco @ ccr @ XX @ ccmap))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(aa1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(aunieqi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 = XB2) => ((ccuni @ XA2) = (ccuni @ XB2)))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(cctopon_tp,type,(cctopon : ($i > $o))).
thf(arrxunitopnfi_ax,axiom,(! [XX:($i > $o)] : ((cwcel @ XX @ ccfn) => ((ccuni @ (ccfv @ (ccfv @ XX @ ccrrx) @ cctopn)) = (cco @ ccr @ XX @ ccmap))))).
