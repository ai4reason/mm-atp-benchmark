...
thf(cralab_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : (! [Xch:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xy1) = (ccv @ Xx3)) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xx3))))) => (! [Xy1:$i] : ((cwral @ (^ [Xx3:$i] : (Xch @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : (ccab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))) <=> (! [Xx3:$i] : ((Xps @ Xx3) => (Xch @ Xx3 @ Xy1)))))))))).
