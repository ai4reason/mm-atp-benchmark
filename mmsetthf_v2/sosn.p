...
thf(aposn_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwrel @ XR) => ((cwpo @ (ccsn @ XA2) @ XR) <=> (~ (cwbr @ XA2 @ XA2 @ XR))))))).
thf(csosn_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwrel @ XR) => ((cwor @ (ccsn @ XA2) @ XR) <=> (~ (cwbr @ XA2 @ XA2 @ XR))))))).
