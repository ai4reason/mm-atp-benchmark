...
thf(aige2m1fz1_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) => (cwcel @ (cco @ XN @ cc1 @ ccmin) @ (cco @ cc1 @ XN @ ccfz))))).
...
thf(asub1m1_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccc) => ((cco @ (cco @ XN @ cc1 @ ccmin) @ cc1 @ ccmin) = (cco @ XN @ cc2 @ ccmin))))).
thf(cswrdtrcfvl_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwbr @ cc2 @ (ccfv @ XW @ cchash) @ ccle)) => ((ccfv @ (cco @ XW @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin)) @ ccsubstr) @ cclsw) = (ccfv @ (cco @ (ccfv @ XW @ cchash) @ cc2 @ ccmin) @ XW)))))).
