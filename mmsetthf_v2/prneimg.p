...
thf(aorddi_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) | (Xch & Xth)) <=> (((Xph | Xch) & (Xph | Xth)) & ((Xps | Xch) & (Xps | Xth))))))))).
...
thf(cprneimg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XA2 @ XU) & (cwcel @ XB2 @ XV)) & ((cwcel @ XC @ XX) & (cwcel @ XD @ XY))) => ((((cwne @ XA2 @ XC) & (cwne @ XA2 @ XD)) | ((cwne @ XB2 @ XC) & (cwne @ XB2 @ XD))) => (cwne @ (ccpr @ XA2 @ XB2) @ (ccpr @ XC @ XD))))))))))))).
