...
thf(axaddnemnf_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwne @ XA2 @ ccmnf)) & ((cwcel @ XB2 @ ccxr) & (cwne @ XB2 @ ccmnf))) => (cwne @ (cco @ XA2 @ XB2 @ ccxad) @ ccmnf))))).
...
thf(cxrs1mnd_conj,conjecture,(! [XR:($i > $o)] : ((XR = (cco @ ccxrs @ (ccdif @ ccxr @ (ccsn @ ccmnf)) @ ccress)) => (cwcel @ XR @ ccmnd)))).
