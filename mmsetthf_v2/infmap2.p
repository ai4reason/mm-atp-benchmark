...
thf(amapdom3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwne @ XB2 @ cc0)) => (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ ccmap) @ ccdom))))))).
thf(ccon0_tp,type,(ccon0 : ($i > $o))).
thf(anumdom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwbr @ XB2 @ XA2 @ ccdom)) => (cwcel @ XB2 @ (ccdm @ cccrd)))))).
thf(asimpl1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((cw3a @ Xph @ Xps @ Xch) & Xth) => Xph)))))).
thf(ainfxpabs_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwbr @ ccom @ XA2 @ ccdom)) & ((cwne @ XB2 @ cc0) & (cwbr @ XB2 @ XA2 @ ccdom))) => (cwbr @ (ccxp @ XA2 @ XB2) @ XA2 @ ccen))))).
...
thf(assenen_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) => (cwbr @ (ccab @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) & (cwbr @ (ccv @ Xx3) @ XC @ ccen)))) @ (ccab @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XB2) & (cwbr @ (ccv @ Xx3) @ XC @ ccen)))) @ ccen)))))).
...
thf(cinfmap2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwbr @ XB2 @ XA2 @ ccdom) @ (cwcel @ (cco @ XA2 @ XB2 @ ccmap) @ (ccdm @ cccrd))) => (cwbr @ (cco @ XA2 @ XB2 @ ccmap) @ (ccab @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) & (cwbr @ (ccv @ Xx3) @ XB2 @ ccen)))) @ ccen))))).
