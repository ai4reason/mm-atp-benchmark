...
thf(aclsk1indlem0_ax,axiom,(! [XK:($i > ($i > $o))] : ((! [Xr:$i] : ((XK @ Xr) = (ccmpt @ (^ [Xr:$i] : (ccpw @ cc3o)) @ (^ [Xr:$i] : (ccif @ ((ccv @ Xr) = (ccsn @ cc0)) @ (ccpr @ cc0 @ cc1o) @ (ccv @ Xr)))))) => (! [Xr:$i] : ((ccfv @ cc0 @ (XK @ Xr)) = cc0))))).
thf(aclsk1indlem2_ax,axiom,(! [XK:($i > ($i > ($i > $o)))] : ((! [Xs1:$i] : (! [Xr:$i] : ((XK @ Xs1 @ Xr) = (ccmpt @ (^ [Xr:$i] : (ccpw @ cc3o)) @ (^ [Xr:$i] : (ccif @ ((ccv @ Xr) = (ccsn @ cc0)) @ (ccpr @ cc0 @ cc1o) @ (ccv @ Xr))))))) => (! [Xr:$i] : (cwral @ (^ [Xs1:$i] : (cwss @ (ccv @ Xs1) @ (ccfv @ (ccv @ Xs1) @ (XK @ Xs1 @ Xr)))) @ (^ [Xs1:$i] : (ccpw @ cc3o))))))).
thf(cw3o_tp,type,(cw3o : ($o > ($o > ($o > $o))))).
thf(aclsk1indlem3_ax,axiom,(! [XK:($i > ($i > ($i > ($i > $o))))] : ((! [Xt:$i] : (! [Xs1:$i] : (! [Xr:$i] : ((XK @ Xt @ Xs1 @ Xr) = (ccmpt @ (^ [Xr:$i] : (ccpw @ cc3o)) @ (^ [Xr:$i] : (ccif @ ((ccv @ Xr) = (ccsn @ cc0)) @ (ccpr @ cc0 @ cc1o) @ (ccv @ Xr)))))))) => (! [Xr:$i] : (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xt:$i] : (cwss @ (ccfv @ (ccun @ (ccv @ Xs1) @ (ccv @ Xt)) @ (XK @ Xt @ Xs1 @ Xr)) @ (ccun @ (ccfv @ (ccv @ Xs1) @ (XK @ Xt @ Xs1 @ Xr)) @ (ccfv @ (ccv @ Xt) @ (XK @ Xt @ Xs1 @ Xr))))) @ (^ [Xt:$i] : (ccpw @ cc3o)))) @ (^ [Xs1:$i] : (ccpw @ cc3o))))))).
thf(cctp_tp,type,(cctp : (($i > $o) > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(aclsk1indlem4_ax,axiom,(! [XK:($i > ($i > ($i > $o)))] : ((! [Xs1:$i] : (! [Xr:$i] : ((XK @ Xs1 @ Xr) = (ccmpt @ (^ [Xr:$i] : (ccpw @ cc3o)) @ (^ [Xr:$i] : (ccif @ ((ccv @ Xr) = (ccsn @ cc0)) @ (ccpr @ cc0 @ cc1o) @ (ccv @ Xr))))))) => (! [Xr:$i] : (cwral @ (^ [Xs1:$i] : ((ccfv @ (ccfv @ (ccv @ Xs1) @ (XK @ Xs1 @ Xr)) @ (XK @ Xs1 @ Xr)) = (ccfv @ (ccv @ Xs1) @ (XK @ Xs1 @ Xr)))) @ (^ [Xs1:$i] : (ccpw @ cc3o))))))).
thf(aclsk1indlem1_ax,axiom,(! [XK:($i > ($i > $o))] : ((! [Xr:$i] : ((XK @ Xr) = (ccmpt @ (^ [Xr:$i] : (ccpw @ cc3o)) @ (^ [Xr:$i] : (ccif @ ((ccv @ Xr) = (ccsn @ cc0)) @ (ccpr @ cc0 @ cc1o) @ (ccv @ Xr)))))) => (! [Xr:$i] : (cwrex @ (^ [Xs1:$i] : (cwrex @ (^ [Xt:$i] : ((cwss @ (ccv @ Xs1) @ (ccv @ Xt)) & (~ (cwss @ (ccfv @ (ccv @ Xs1) @ (XK @ Xr)) @ (ccfv @ (ccv @ Xt) @ (XK @ Xr)))))) @ (^ [Xt:$i] : (ccpw @ cc3o)))) @ (^ [Xs1:$i] : (ccpw @ cc3o))))))).
...
thf(arexnal2_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : ((cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (~ (Xph @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1))) <=> (~ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)))))))))).
...
thf(apm4_61_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((~ (Xph => Xps)) <=> (Xph & (~ Xps)))))).
...
thf(aralv_ax,axiom,(! [Xph:($i > $o)] : ((cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : ccvv)) <=> (! [Xx3:$i] : (Xph @ Xx3))))).
