...
thf(aabvneg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XR @ ccabv)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XN = (ccfv @ XR @ ccminusg)) => (((cwcel @ XF @ XA2) & (cwcel @ XX @ XB2)) => ((ccfv @ (ccfv @ XX @ XN) @ XF) = (ccfv @ XX @ XF))))))))))))).
thf(aeqeltrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (cwcel @ XB2 @ XC)) => (Xph => (cwcel @ XA2 @ XC))))))))).
thf(aqrngneg_ax,axiom,(! [XQ:($i > $o)] : (! [XX:($i > $o)] : ((XQ = (cco @ cccnfld @ ccq @ ccress)) => ((cwcel @ XX @ ccq) => ((ccfv @ XX @ (ccfv @ XQ @ ccminusg)) = (ccneg @ XX))))))).
