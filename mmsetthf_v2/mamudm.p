...
thf(cmamudm_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XE = (cco @ XR @ (ccxp @ XM @ XN) @ ccfrlm)) => ((XB2 = (ccfv @ XE @ ccbs)) => ((XF = (cco @ XR @ (ccxp @ XN @ XP) @ ccfrlm)) => ((XC = (ccfv @ XF @ ccbs)) => ((Xc_xp = (cco @ XR @ (ccotp @ XM @ XN @ XP) @ ccmmul)) => (((cwcel @ XR @ XV) & (cw3a @ (cwcel @ XM @ ccfn) @ (cwcel @ XN @ ccfn) @ (cwcel @ XP @ ccfn))) => ((ccdm @ Xc_xp) = (ccxp @ XB2 @ XC))))))))))))))))))).
