...
thf(as4cld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ XX)) => ((Xph => (cwcel @ XB2 @ XX)) => ((Xph => (cwcel @ XC @ XX)) => ((Xph => (cwcel @ XD @ XX)) => (Xph => (cwcel @ (ccs4 @ XA2 @ XB2 @ XC @ XD) @ (ccword @ XX)))))))))))))).
...
thf(awrdmap_ax,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XV @ XX) & (cwcel @ XN @ ccn0)) => (((cwcel @ XW @ (ccword @ XV)) & ((ccfv @ XW @ cchash) = XN)) <=> (cwcel @ XW @ (cco @ XV @ (cco @ ccc0 @ XN @ ccfzo) @ ccmap))))))))).
...
thf(as4fv0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((ccfv @ ccc0 @ (ccs4 @ XA2 @ XB2 @ XC @ XD)) = XA2)))))))).
thf(as4fv1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((ccfv @ cc1 @ (ccs4 @ XA2 @ XB2 @ XC @ XD)) = XB2)))))))).
thf(aadantlr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => (((Xph & Xth) & Xps) => Xch))))))).
thf(as4fv2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XC @ XV) => ((ccfv @ cc2 @ (ccs4 @ XA2 @ XB2 @ XC @ XD)) = XC)))))))).
thf(as4fv3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XD @ XV) => ((ccfv @ cc3 @ (ccs4 @ XA2 @ XB2 @ XC @ XD)) = XD)))))))).
thf(ccicc_tp,type,(ccicc : ($i > $o))).
thf(ccexp_tp,type,(ccexp : ($i > $o))).
thf(asmfmullem1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XU @ ccr)) => ((Xph => (cwcel @ XV @ ccr)) => ((Xph => (cwbr @ (cco @ XU @ XV @ ccmul) @ XA2 @ cclt)) => ((XX = (cco @ (cco @ XA2 @ (cco @ XU @ XV @ ccmul) @ ccmin) @ (cco @ cc1 @ (cco @ (ccfv @ XU @ ccabs) @ (ccfv @ XV @ ccabs) @ ccaddc) @ ccaddc) @ ccdiv)) => ((XY = (ccif @ (cwbr @ cc1 @ XX @ ccle) @ cc1 @ XX)) => ((Xph => (cwcel @ XP @ (cco @ (cco @ XU @ XY @ ccmin) @ XU @ ccioo))) => ((Xph => (cwcel @ XR @ (cco @ XU @ (cco @ XU @ XY @ ccaddc) @ ccioo))) => ((Xph => (cwcel @ XS @ (cco @ (cco @ XV @ XY @ ccmin) @ XV @ ccioo))) => ((Xph => (cwcel @ XZ @ (cco @ XV @ (cco @ XV @ XY @ ccaddc) @ ccioo))) => ((Xph => (cwcel @ XH @ (cco @ XP @ XR @ ccioo))) => ((Xph => (cwcel @ XI @ (cco @ XS @ XZ @ ccioo))) => (Xph => (cwbr @ (cco @ XH @ XI @ ccmul) @ XA2 @ cclt))))))))))))))))))))))))))).
...
thf(arspcef_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xps @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => ((! [Xx3:$i] : (((ccv @ Xx3) = (XA2 @ Xx3)) => ((Xph @ Xx3) <=> (Xps @ Xx3)))) => (! [Xx3:$i] : (((cwcel @ (XA2 @ Xx3) @ (XB2 @ Xx3)) & (Xps @ Xx3)) => (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))))))).
