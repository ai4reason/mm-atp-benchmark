...
thf(aaxaddf_ax,axiom,(cwf @ (ccxp @ ccc @ ccc) @ ccc @ ccaddc)).
thf(cax_addcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => (cwcel @ (cco @ XA2 @ XB2 @ ccaddc) @ ccc))))).
