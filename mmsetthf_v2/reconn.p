...
thf(areconnlem1_ax,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwss @ XA2 @ ccr) & (cwcel @ (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ XA2 @ ccrest) @ ccconn)) & ((cwcel @ XX @ XA2) & (cwcel @ XY @ XA2))) => (cwss @ (cco @ XX @ XY @ ccicc) @ XA2)))))).
...
thf(creconn_conj,conjecture,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccr) => ((cwcel @ (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ XA2 @ ccrest) @ ccconn) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwss @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccicc) @ XA2)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
