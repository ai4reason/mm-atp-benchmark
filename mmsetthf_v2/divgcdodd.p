...
thf(advdsgcdb_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) => (((cwbr @ XK @ XM @ ccdvds) & (cwbr @ XK @ XN @ ccdvds)) <=> (cwbr @ XK @ (cco @ XM @ XN @ ccgcd) @ ccdvds))))))).
...
thf(cdivgcdodd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn)) => ((~ (cwbr @ cc2 @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv) @ ccdvds)) | (~ (cwbr @ cc2 @ (cco @ XB2 @ (cco @ XA2 @ XB2 @ ccgcd) @ ccdiv) @ ccdvds))))))).
