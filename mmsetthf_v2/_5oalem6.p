...
thf(a_5oalem1_ax,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => ((cwcel @ XC @ ccsh) => ((cwcel @ XR @ ccsh) => (((((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XB2)) & ((ccv @ Xv) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccva))) & ((cwcel @ (ccv @ Xz) @ XC) & (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xz) @ ccmv) @ XR))) => (cwcel @ (ccv @ Xv) @ (cco @ XB2 @ (ccin @ XA2 @ (cco @ XC @ XR @ ccph)) @ ccph)))))))))))))))).
