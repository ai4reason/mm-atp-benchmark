...
thf(adf_maxidl_ax,axiom,(ccmaxidl = (ccmpt @ (^ [Xr:$i] : ccrngo) @ (^ [Xr:$i] : (ccrab @ (^ [Xi:$i] : ((cwne @ (ccv @ Xi) @ (ccrn @ (ccfv @ (ccv @ Xr) @ cc1st))) & (cwral @ (^ [Xj:$i] : ((cwss @ (ccv @ Xi) @ (ccv @ Xj)) => (((ccv @ Xj) = (ccv @ Xi)) | ((ccv @ Xj) = (ccrn @ (ccfv @ (ccv @ Xr) @ cc1st)))))) @ (^ [Xj:$i] : (ccfv @ (ccv @ Xr) @ ccidl))))) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xr) @ ccidl))))))).
thf(arabex_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ ccvv))))).
thf(afvex_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(cmaxidlval_conj,conjecture,(! [XR:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : ((XG @ Xi @ Xj) = (ccfv @ XR @ cc1st)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XX @ Xi @ Xj) = (ccrn @ (XG @ Xi @ Xj))))) => (! [Xj:$i] : ((cwcel @ XR @ ccrngo) => ((ccfv @ XR @ ccmaxidl) = (ccrab @ (^ [Xi:$i] : ((cwne @ (ccv @ Xi) @ (XX @ Xi @ Xj)) & (cwral @ (^ [Xj:$i] : ((cwss @ (ccv @ Xi) @ (ccv @ Xj)) => (((ccv @ Xj) = (ccv @ Xi)) | ((ccv @ Xj) = (XX @ Xi @ Xj))))) @ (^ [Xj:$i] : (ccfv @ XR @ ccidl))))) @ (^ [Xi:$i] : (ccfv @ XR @ ccidl)))))))))))).
