...
thf(afproddvdsd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwcel @ (XA2 @ Xx3) @ ccfn))) => ((! [Xx3:$i] : (Xph => (cwss @ (XA2 @ Xx3) @ ccz))) => (Xph => (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccprod @ (^ [Xk:$i] : (XA2 @ Xx3)) @ (^ [Xk:$i] : (ccv @ Xk))) @ ccdvds)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))).
