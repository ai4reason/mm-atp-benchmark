...
thf(cfntpg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cw3a @ (cw3a @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XV) @ (cwcel @ XZ @ XW)) @ (cw3a @ (cwcel @ XA2 @ XF) @ (cwcel @ XB2 @ XG) @ (cwcel @ XC @ XH)) @ (cw3a @ (cwne @ XX @ XY) @ (cwne @ XX @ XZ) @ (cwne @ XY @ XZ))) => (cwfn @ (cctp @ (ccop @ XX @ XA2) @ (ccop @ XY @ XB2) @ (ccop @ XZ @ XC)) @ (cctp @ XX @ XY @ XZ)))))))))))))))).
