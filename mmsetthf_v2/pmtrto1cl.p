...
thf(cpmtrto1cl_conj,conjecture,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XD = (cco @ cc1 @ XN @ ccfz)) => ((XT = (ccfv @ XD @ ccpmtr)) => (((cwcel @ XK @ ccn) & (cwcel @ (cco @ XK @ cc1 @ ccaddc) @ XD)) => (cwcel @ (ccfv @ (ccpr @ XK @ (cco @ XK @ cc1 @ ccaddc)) @ XT) @ (ccrn @ XT)))))))))).
