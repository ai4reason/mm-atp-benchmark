...
thf(afninfp_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ XA2) => ((ccdm @ (ccin @ XF @ ccid)) = (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) = (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2))))))).
...
thf(cfnelfp_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwfn @ XF @ XA2) & (cwcel @ XX @ XA2)) => ((cwcel @ XX @ (ccdm @ (ccin @ XF @ ccid))) <=> ((ccfv @ XX @ XF) = XX))))))).
