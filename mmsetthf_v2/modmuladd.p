...
thf(cmodmuladd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ (cco @ ccc0 @ XM @ ccico)) @ (cwcel @ XM @ ccrp)) => (((cco @ XA2 @ XM @ ccmo) = XB2) <=> (cwrex @ (^ [Xk:$i] : (XA2 = (cco @ (cco @ (ccv @ Xk) @ XM @ ccmul) @ XB2 @ ccaddc))) @ (^ [Xk:$i] : ccz)))))))).
