...
thf(apw2f1o2val2_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc2o @ XA2 @ ccmap)) @ (^ [Xx3:$i] : (ccima @ (cccnv @ (ccv @ Xx3)) @ (ccsn @ cc1o)))))) => (! [Xx3:$i] : (((cwcel @ XX @ (cco @ cc2o @ XA2 @ ccmap)) & (cwcel @ XY @ XA2)) => ((cwcel @ XY @ (ccfv @ XX @ (XF @ Xx3))) <=> ((ccfv @ XY @ XX) = cc1o)))))))))).
