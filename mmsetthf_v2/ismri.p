...
thf(amrisval_ax,axiom,(! [XA2:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xs1:$i] : ((XN @ Xx3 @ Xs1) = (ccfv @ XA2 @ ccmrc)))) => ((! [Xx3:$i] : (! [Xs1:$i] : ((XI @ Xx3 @ Xs1) = (ccfv @ XA2 @ ccmri)))) => (! [Xx3:$i] : (! [Xs1:$i] : ((cwcel @ XA2 @ (ccfv @ (XX @ Xx3) @ ccmre)) => ((XI @ Xx3 @ Xs1) = (ccrab @ (^ [Xs1:$i] : (cwral @ (^ [Xx3:$i] : (~ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccdif @ (ccv @ Xs1) @ (ccsn @ (ccv @ Xx3))) @ (XN @ Xx3 @ Xs1))))) @ (^ [Xx3:$i] : (ccv @ Xs1)))) @ (^ [Xs1:$i] : (ccpw @ (XX @ Xx3))))))))))))))).
...
thf(cismri_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : ((XN @ Xx3) = (ccfv @ XA2 @ ccmrc))) => ((! [Xx3:$i] : ((XI @ Xx3) = (ccfv @ XA2 @ ccmri))) => (! [Xx3:$i] : ((cwcel @ XA2 @ (ccfv @ (XX @ Xx3) @ ccmre)) => ((cwcel @ XS @ (XI @ Xx3)) <=> ((cwss @ XS @ (XX @ Xx3)) & (cwral @ (^ [Xx3:$i] : (~ (cwcel @ (ccv @ Xx3) @ (ccfv @ (ccdif @ XS @ (ccsn @ (ccv @ Xx3))) @ (XN @ Xx3))))) @ (^ [Xx3:$i] : XS)))))))))))))).
