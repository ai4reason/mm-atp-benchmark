...
thf(adf_lnm_ax,axiom,(cclnm = (ccrab @ (^ [Xw:$i] : (cwral @ (^ [Xi:$i] : (cwcel @ (cco @ (ccv @ Xw) @ (ccv @ Xi) @ ccress) @ cclfig)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xw) @ cclss)))) @ (^ [Xw:$i] : cclmod)))).
thf(cislnm_conj,conjecture,(! [XS:($i > $o)] : (! [XM:($i > $o)] : ((XS = (ccfv @ XM @ cclss)) => ((cwcel @ XM @ cclnm) <=> ((cwcel @ XM @ cclmod) & (cwral @ (^ [Xi:$i] : (cwcel @ (cco @ XM @ (ccv @ Xi) @ ccress) @ cclfig)) @ (^ [Xi:$i] : XS)))))))).
