...
thf(avolicc_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ ccle)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccicc) @ ccvol) = (cco @ XB2 @ XA2 @ ccmin)))))).
...
thf(cvoliccico_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((ccfv @ (cco @ XA2 @ XB2 @ ccicc) @ ccvol) = (ccfv @ (cco @ XA2 @ XB2 @ ccico) @ ccvol))))))))).
