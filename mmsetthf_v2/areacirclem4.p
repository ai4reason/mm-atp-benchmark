...
thf(aasinval_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ ccasin) = (cco @ (ccneg @ cci) @ (ccfv @ (cco @ (cco @ cci @ XA2 @ ccmul) @ (ccfv @ (cco @ cc1 @ (cco @ XA2 @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccaddc) @ cclog) @ ccmul))))).
...
thf(asq0_ax,axiom,((cco @ ccc0 @ cc2 @ ccexp) = ccc0)).
...
thf(ainelr_ax,axiom,(~ (cwcel @ cci @ ccr))).
...
thf(asqrtmuld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XB2 @ ccle)) => (Xph => ((ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ ccsqrt) = (cco @ (ccfv @ XA2 @ ccsqrt) @ (ccfv @ XB2 @ ccsqrt) @ ccmul))))))))))).
...
thf(asqrtsqd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => (Xph => ((ccfv @ (cco @ XA2 @ cc2 @ ccexp) @ ccsqrt) = XA2))))))).
thf(ccab_tp,type,(ccab : (($i > $o) > ($i > $o)))).
thf(ccico_tp,type,(ccico : ($i > $o))).
thf(aareacirclem2_ax,axiom,(! [XR:($i > $o)] : (((cwcel @ XR @ ccr) & (cwbr @ ccc0 @ XR @ ccle)) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ (ccneg @ XR) @ XR @ ccicc)) @ (^ [Xt:$i] : (ccfv @ (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccv @ Xt) @ cc2 @ ccexp) @ ccmin) @ ccsqrt))) @ (cco @ (cco @ (ccneg @ XR) @ XR @ ccicc) @ ccc @ cccncf))))).
...
thf(careacirclem4_conj,conjecture,(! [XR:($i > $o)] : ((cwcel @ XR @ ccrp) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ (ccneg @ XR) @ XR @ ccicc)) @ (^ [Xt:$i] : (cco @ (cco @ XR @ cc2 @ ccexp) @ (cco @ (ccfv @ (cco @ (ccv @ Xt) @ XR @ ccdiv) @ ccasin) @ (cco @ (cco @ (ccv @ Xt) @ XR @ ccdiv) @ (ccfv @ (cco @ cc1 @ (cco @ (cco @ (ccv @ Xt) @ XR @ ccdiv) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccmul) @ ccaddc) @ ccmul))) @ (cco @ (cco @ (ccneg @ XR) @ XR @ ccicc) @ ccc @ cccncf))))).
