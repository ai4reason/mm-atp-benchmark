...
thf(cmplmon_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > $o))] : (! [Xc_1:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xy1:$i] : (! [Xf1:$i] : ((XP @ Xy1 @ Xf1) = (cco @ (XI @ Xy1) @ (XR @ Xf1) @ ccmpl)))) => ((! [Xy1:$i] : (! [Xf1:$i] : ((XB2 @ Xy1 @ Xf1) = (ccfv @ (XP @ Xy1 @ Xf1) @ ccbs)))) => ((! [Xf1:$i] : ((Xc_0 @ Xf1) = (ccfv @ (XR @ Xf1) @ cc0g))) => ((! [Xf1:$i] : ((Xc_1 @ Xf1) = (ccfv @ (XR @ Xf1) @ ccur))) => ((! [Xy1:$i] : (! [Xf1:$i] : ((XD @ Xf1) = (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ (XI @ Xy1) @ ccmap)))))) => ((! [Xy1:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ (XI @ Xy1) @ (XW @ Xy1 @ Xf1))))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ (XR @ Xf1) @ ccrg))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XX @ (XD @ Xf1)))) => (! [Xy1:$i] : (! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ (ccmpt @ (^ [Xy1:$i] : (XD @ Xf1)) @ (^ [Xy1:$i] : (ccif @ ((ccv @ Xy1) = XX) @ (Xc_1 @ Xf1) @ (Xc_0 @ Xf1)))) @ (XB2 @ Xy1 @ Xf1)))))))))))))))))))))))).
