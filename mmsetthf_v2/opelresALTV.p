...
thf(aanbi1cd_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps <=> Xch)) => (Xph => ((Xth & Xps) <=> (Xch & Xth))))))))).
...
thf(copelresALTV_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XC @ XV) => ((cwcel @ (ccop @ XB2 @ XC) @ (ccres @ XR @ XA2)) <=> ((cwcel @ XB2 @ XA2) & (cwcel @ (ccop @ XB2 @ XC) @ XR)))))))))).
