...
thf(apm2_61dda_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & (~ Xps)) => Xth) => (((Xph & (~ Xch)) => Xth) => (((Xph & (Xps & Xch)) => Xth) => (Xph => Xth))))))))).
...
thf(clhpexle1lem_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwrex @ (^ [Xp:$i] : ((cwbr @ (ccv @ Xp) @ XW @ Xc_le) & (Xps @ Xp))) @ (^ [Xp:$i] : XA2))) => (((Xph & ((cwcel @ XX @ XA2) & (cwbr @ XX @ XW @ Xc_le))) => (cwrex @ (^ [Xp:$i] : (cw3a @ (cwbr @ (ccv @ Xp) @ XW @ Xc_le) @ (Xps @ Xp) @ (cwne @ (ccv @ Xp) @ XX))) @ (^ [Xp:$i] : XA2))) => (Xph => (cwrex @ (^ [Xp:$i] : (cw3a @ (cwbr @ (ccv @ Xp) @ XW @ Xc_le) @ (Xps @ Xp) @ (cwne @ (ccv @ Xp) @ XX))) @ (^ [Xp:$i] : XA2)))))))))))).
