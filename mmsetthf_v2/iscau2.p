...
thf(aiscau_ax,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => ((cwcel @ XF @ (ccfv @ XD @ ccca)) <=> ((cwcel @ XF @ (cco @ XX @ ccc @ ccpm)) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xk:$i] : (cwf @ (ccfv @ (ccv @ Xk) @ ccuz) @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccv @ Xx3) @ (ccfv @ XD @ ccbl)) @ (ccres @ XF @ (ccfv @ (ccv @ Xk) @ ccuz)))) @ (^ [Xk:$i] : ccz))) @ (^ [Xx3:$i] : ccrp))))))))).
...
thf(aelpmg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccpm)) <=> ((cwfun @ XC) & (cwss @ XC @ (ccxp @ XB2 @ XA2))))))))))).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(cwfn_tp,type,(cwfn : (($i > $o) > (($i > $o) > $o)))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(affvresb_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwfun @ XF) => ((cwf @ XA2 @ XB2 @ (ccres @ XF @ XA2)) <=> (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (ccdm @ XF)) & (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ XB2))) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(andmovg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((((ccdm @ XF) = (ccxp @ XR @ XS)) & (~ ((cwcel @ XA2 @ XR) & (cwcel @ XB2 @ XS)))) => ((cco @ XA2 @ XB2 @ XF) = cc0)))))))).
...
thf(ciscau2_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => ((cwcel @ XF @ (ccfv @ XD @ ccca)) <=> ((cwcel @ XF @ (cco @ XX @ ccc @ ccpm)) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cw3a @ (cwcel @ (ccv @ Xk) @ (ccdm @ XF)) @ (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ XX) @ (cwbr @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xj) @ XF) @ XD) @ (ccv @ Xx3) @ cclt))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : ccz))) @ (^ [Xx3:$i] : ccrp))))))))).
