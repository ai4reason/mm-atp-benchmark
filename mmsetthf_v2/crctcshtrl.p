...
thf(acshinj_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cw3a @ (cwcel @ XF @ (ccword @ XA2)) @ (cwfun @ (cccnv @ XF)) @ (cwcel @ XS @ ccz)) => ((XG = (cco @ XF @ XS @ cccsh)) => (cwfun @ (cccnv @ XG))))))))).
