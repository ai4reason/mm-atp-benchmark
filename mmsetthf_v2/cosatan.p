...
thf(aefiatan2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccatan)) => ((ccfv @ (cco @ cci @ (ccfv @ XA2 @ ccatan) @ ccmul) @ cce) = (cco @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) @ (ccfv @ (cco @ cc1 @ (cco @ XA2 @ cc2 @ ccexp) @ ccaddc) @ ccsqrt) @ ccdiv))))).
