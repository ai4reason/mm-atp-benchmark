...
thf(cbasellem1_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ (cco @ cc2 @ XM @ ccmul) @ cc1 @ ccaddc)) => (((cwcel @ XM @ ccn) & (cwcel @ XK @ (cco @ cc1 @ XM @ ccfz))) => (cwcel @ (cco @ (cco @ XK @ ccpi @ ccmul) @ XN @ ccdiv) @ (cco @ ccc0 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo)))))))).
