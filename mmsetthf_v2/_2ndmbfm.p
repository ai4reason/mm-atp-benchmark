...
thf(aelsx_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((((cwcel @ XS @ XV) & (cwcel @ XT @ XW)) & ((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XT))) => (cwcel @ (ccxp @ XA2 @ XB2) @ (cco @ XS @ XT @ ccsx)))))))))).
...
thf(c_2ndmbfm_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((Xph => (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga)))) => ((Xph => (cwcel @ XT @ (ccuni @ (ccrn @ ccsiga)))) => (Xph => (cwcel @ (ccres @ cc2nd @ (ccxp @ (ccuni @ XS) @ (ccuni @ XT))) @ (cco @ (cco @ XS @ XT @ ccsx) @ XT @ ccmbfm))))))))).
