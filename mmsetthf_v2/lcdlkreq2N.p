...
thf(clcdlkreq2N_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XS = (ccfv @ XU @ ccsca)) => ((XR = (ccfv @ XS @ ccbs)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => ((XL = (ccfv @ XU @ cclk)) => ((XC = (ccfv @ XW @ (ccfv @ XK @ cclcd))) => ((XV = (ccfv @ XC @ ccbs)) => ((Xc_x = (ccfv @ XC @ ccvsca)) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XA2 @ (ccdif @ XR @ (ccsn @ Xc_0)))) => ((Xph => (cwcel @ XI @ XV)) => ((Xph => (XG = (cco @ XA2 @ XI @ Xc_x))) => (Xph => ((ccfv @ XG @ XL) = (ccfv @ XI @ XL)))))))))))))))))))))))))))))))).
