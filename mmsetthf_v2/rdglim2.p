...
thf(ardglim_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XB2 @ XC) & (cwlim @ XB2)) => ((ccfv @ XB2 @ (ccrdg @ XF @ XA2)) = (ccuni @ (ccima @ (ccrdg @ XF @ XA2) @ XB2))))))))).
...
thf(crdglim2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XB2 @ (XC @ Xx3 @ Xy1)) & (cwlim @ XB2)) => ((ccfv @ XB2 @ (ccrdg @ XF @ XA2)) = (ccuni @ (ccab @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xy1) = (ccfv @ (ccv @ Xx3) @ (ccrdg @ XF @ XA2)))) @ (^ [Xx3:$i] : XB2)))))))))))))).
