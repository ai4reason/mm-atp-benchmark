...
thf(as5len_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((ccfv @ (ccs5 @ XA2 @ XB2 @ XC @ XD @ XE) @ cchash) = cc5))))))).
thf(a_5p1e6_ax,axiom,((cco @ cc5 @ cc1 @ ccaddc) = cc6)).
thf(cs6len_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((ccfv @ (ccs6 @ XA2 @ XB2 @ XC @ XD @ XE @ XF) @ cchash) = cc6)))))))).
