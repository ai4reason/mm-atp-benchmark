...
thf(appival2g_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ cc2 @ (ccfv @ XM @ ccuz))) => ((ccfv @ XA2 @ ccppi) = (ccfv @ (ccin @ (cco @ XM @ XA2 @ ccfz) @ ccprime) @ cchash)))))).
...
thf(cppidif_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ XM @ ccuz)) => ((cco @ (ccfv @ XN @ ccppi) @ (ccfv @ XM @ ccppi) @ ccmin) = (ccfv @ (ccin @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XN @ ccfz) @ ccprime) @ cchash)))))).
