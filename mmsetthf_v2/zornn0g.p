...
thf(azorng_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (! [Xz:$i] : (((cwss @ (ccv @ Xz) @ XA2) & (cwor @ (ccv @ Xz) @ ccrpss)) => (cwcel @ (ccuni @ (ccv @ Xz)) @ XA2)))) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwpss @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))))).
...
thf(czornn0g_conj,conjecture,(! [XA2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwne @ XA2 @ cc0) @ (! [Xz:$i] : ((cw3a @ (cwss @ (ccv @ Xz) @ XA2) @ (cwne @ (ccv @ Xz) @ cc0) @ (cwor @ (ccv @ Xz) @ ccrpss)) => (cwcel @ (ccuni @ (ccv @ Xz)) @ XA2)))) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwpss @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))))).
