...
thf(agausslemma2dlem7_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XH = (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((! [Xx3:$i] : ((XR @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XH @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ cc2 @ ccdiv) @ cclt) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ ccmin)))))) => ((XM = (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => ((! [Xx3:$i] : ((XN @ Xx3) = (cco @ XH @ XM @ ccmin))) => (! [Xx3:$i] : (Xph => ((cco @ (cco @ (cco @ (ccneg @ cc1) @ (XN @ Xx3) @ ccexp) @ (cco @ cc2 @ XH @ ccexp) @ ccmul) @ XP @ ccmo) = cc1))))))))))))))).
...
thf(agausslemma2dlem0i_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XM = (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => ((XH = (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((XN = (cco @ XH @ XM @ ccmin)) => (Xph => (((cco @ (cco @ cc2 @ XP @ cclgs) @ XP @ ccmo) = (cco @ (cco @ (ccneg @ cc1) @ XN @ ccexp) @ XP @ ccmo)) => ((cco @ cc2 @ XP @ cclgs) = (cco @ (ccneg @ cc1) @ XN @ ccexp)))))))))))))).
