...
thf(asdom1_ax,axiom,(! [XA2:($i > $o)] : ((cwbr @ XA2 @ cc1o @ ccsdm) <=> (XA2 = cc0)))).
...
thf(a_0frgp_ax,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((XG = (ccfv @ cc0 @ ccfrgp)) => ((XB2 = (ccfv @ XG @ ccbs)) => (cwbr @ XB2 @ cc1o @ ccen)))))).
thf(ccc0_tp,type,(ccc0 : ($i > $o))).
thf(a_0cyg_ax,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ ccgrp) & (cwbr @ XB2 @ cc1o @ ccen)) => (cwcel @ XG @ cccyg)))))).
...
thf(aen1uniel_ax,axiom,(! [XS:($i > $o)] : ((cwbr @ XS @ cc1o @ ccen) => (cwcel @ (ccuni @ XS) @ XS)))).
...
thf(aen1b_ax,axiom,(! [XA2:($i > $o)] : ((cwbr @ XA2 @ cc1o @ ccen) <=> (XA2 = (ccsn @ (ccuni @ XA2)))))).
thf(ccgsu_tp,type,(ccgsu : ($i > $o))).
thf(ccminusg_tp,type,(ccminusg : ($i > $o))).
thf(ccif_tp,type,(ccif : ($o > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(ccmpt2_tp,type,(ccmpt2 : (($i > ($i > ($i > $o))) > (($i > ($i > ($i > $o))) > (($i > ($i > ($i > $o))) > ($i > $o)))))).
thf(afrgpup3_ax,axiom,(! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XG = (ccfv @ XI @ ccfrgp)) => ((XB2 = (ccfv @ XH @ ccbs)) => ((XU = (ccfv @ XI @ ccvrgp)) => ((cw3a @ (cwcel @ XH @ ccgrp) @ (cwcel @ XI @ XV) @ (cwf @ XI @ XB2 @ XF)) => (cwreu @ (^ [Xm:$i] : ((cccom @ (ccv @ Xm) @ XU) = XF)) @ (^ [Xm:$i] : (cco @ XG @ XH @ ccghm))))))))))))))).
...
thf(aidghm_ax,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((cwcel @ XG @ ccgrp) => (cwcel @ (ccres @ ccid @ XB2) @ (cco @ XG @ XG @ ccghm))))))).
...
thf(amulgghm2_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > $o))] : ((Xc_x = (ccfv @ XR @ ccmg)) => ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccz) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ Xc_1 @ Xc_x))))) => ((XB2 = (ccfv @ XR @ ccbs)) => (! [Xn:$i] : (((cwcel @ XR @ ccgrp) & (cwcel @ Xc_1 @ XB2)) => (cwcel @ (XF @ Xn) @ (cco @ czring @ XR @ ccghm))))))))))))).
...
thf(acygabl_ax,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ cccyg) => (cwcel @ XG @ ccabl)))).
...
thf(afrgpnabl_ax,axiom,(! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XG = (ccfv @ XI @ ccfrgp)) => ((cwbr @ cc1o @ XI @ ccsdm) => (~ (cwcel @ XG @ ccabl))))))).
...
thf(cfrgpcyg_conj,conjecture,(! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XG = (ccfv @ XI @ ccfrgp)) => ((cwbr @ XI @ cc1o @ ccdom) <=> (cwcel @ XG @ cccyg)))))).
