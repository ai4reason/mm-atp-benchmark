...
thf(celiccelioc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccxr)) => (Xph => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioc)) <=> ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc)) & (cwne @ XC @ XA2)))))))))))).
