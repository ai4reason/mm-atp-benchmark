...
thf(chashunsng_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => (((cwcel @ XA2 @ ccfn) & (~ (cwcel @ XB2 @ XA2))) => ((ccfv @ (ccun @ XA2 @ (ccsn @ XB2)) @ cchash) = (cco @ (ccfv @ XA2 @ cchash) @ cc1 @ ccaddc)))))))).
