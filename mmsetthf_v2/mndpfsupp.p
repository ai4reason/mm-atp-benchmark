...
thf(cmndpfsupp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XR = (ccfv @ XM @ ccbs)) => ((cw3a @ ((cwcel @ XM @ ccmnd) & (cwcel @ XV @ XX)) @ ((cwcel @ XA2 @ (cco @ XR @ XV @ ccmap)) & (cwcel @ XB2 @ (cco @ XR @ XV @ ccmap))) @ ((cwbr @ XA2 @ (ccfv @ XM @ cc0g) @ ccfsupp) & (cwbr @ XB2 @ (ccfv @ XM @ cc0g) @ ccfsupp))) => (cwbr @ (cco @ XA2 @ XB2 @ (ccof @ (ccfv @ XM @ ccplusg))) @ (ccfv @ XM @ cc0g) @ ccfsupp)))))))))).
