...
thf(aacongrep_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XN @ ccz)) => (cwrex @ (^ [Xa:$i] : ((cwbr @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ (ccv @ Xa) @ XN @ ccmin) @ ccdvds) | (cwbr @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ (ccv @ Xa) @ (ccneg @ XN) @ ccmin) @ ccdvds))) @ (^ [Xa:$i] : (cco @ ccc0 @ XA2 @ ccfz))))))).
...
thf(ajm2_26a_ax,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccz)) & ((cwcel @ XK @ ccz) & (cwcel @ XM @ ccz))) => (((cwbr @ (cco @ cc2 @ XN @ ccmul) @ (cco @ XK @ XM @ ccmin) @ ccdvds) | (cwbr @ (cco @ cc2 @ XN @ ccmul) @ (cco @ XK @ (ccneg @ XM) @ ccmin) @ ccdvds)) => ((cwbr @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ (cco @ XA2 @ XK @ ccrmy) @ (cco @ XA2 @ XM @ ccrmy) @ ccmin) @ ccdvds) | (cwbr @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ (cco @ XA2 @ XK @ ccrmy) @ (ccneg @ (cco @ XA2 @ XM @ ccrmy)) @ ccmin) @ ccdvds))))))))).
