...
thf(ar0weon_ax,axiom,(! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XL @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (ccxp @ ccon0 @ ccon0)) & (cwcel @ (ccv @ Xy1) @ (ccxp @ ccon0 @ ccon0))) & ((cwcel @ (ccfv @ (ccv @ Xx3) @ cc1st) @ (ccfv @ (ccv @ Xy1) @ cc1st)) | (((ccfv @ (ccv @ Xx3) @ cc1st) = (ccfv @ (ccv @ Xy1) @ cc1st)) & (cwcel @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ (ccfv @ (ccv @ Xy1) @ cc2nd))))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XR @ Xx3 @ Xy1 @ Xz @ Xw) = (ccopab @ (^ [Xz:$i] : (^ [Xw:$i] : (((cwcel @ (ccv @ Xz) @ (ccxp @ ccon0 @ ccon0)) & (cwcel @ (ccv @ Xw) @ (ccxp @ ccon0 @ ccon0))) & ((cwcel @ (ccun @ (ccfv @ (ccv @ Xz) @ cc1st) @ (ccfv @ (ccv @ Xz) @ cc2nd)) @ (ccun @ (ccfv @ (ccv @ Xw) @ cc1st) @ (ccfv @ (ccv @ Xw) @ cc2nd))) | (((ccun @ (ccfv @ (ccv @ Xz) @ cc1st) @ (ccfv @ (ccv @ Xz) @ cc2nd)) = (ccun @ (ccfv @ (ccv @ Xw) @ cc1st) @ (ccfv @ (ccv @ Xw) @ cc2nd))) & (cwbr @ (ccv @ Xz) @ (ccv @ Xw) @ (XL @ Xx3 @ Xy1))))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((cwwe @ (ccxp @ ccon0 @ ccon0) @ (XR @ Xx3 @ Xy1 @ Xz @ Xw)) & (cwse @ (ccxp @ ccon0 @ ccon0) @ (XR @ Xx3 @ Xy1 @ Xz @ Xw)))))))))))).
...
thf(aisoini_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (((cwiso @ XA2 @ XB2 @ XR @ XS @ XH) & (cwcel @ XD @ XA2)) => ((ccima @ XH @ (ccin @ XA2 @ (ccima @ (cccnv @ XR) @ (ccsn @ XD)))) = (ccin @ XB2 @ (ccima @ (cccnv @ XS) @ (ccsn @ (ccfv @ XD @ XH))))))))))))).
thf(asyl5eq_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((Xph => (XB2 = XC)) => (Xph => (XA2 = XC))))))))).
thf(aineq2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((ccin @ XC @ XA2) = (ccin @ XC @ XB2))))))).
thf(aepini_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((ccima @ (cccnv @ ccep) @ (ccsn @ XA2)) = XA2)))).
