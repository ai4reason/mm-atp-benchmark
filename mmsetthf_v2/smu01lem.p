...
thf(asmucl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ ccn0) & (cwss @ XB2 @ ccn0)) => (cwss @ (cco @ XA2 @ XB2 @ ccsmu) @ ccn0))))).
