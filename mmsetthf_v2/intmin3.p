...
thf(cintmin3_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> Xps))) => (Xps => (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => (cwss @ (ccint @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3)))) @ XA2)))))))))).
