...
thf(aleaddsub2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) => ((cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ ccle) <=> (cwbr @ XB2 @ (cco @ XC @ XA2 @ ccmin) @ ccle))))))).
...
thf(cabsdifle_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) => ((cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ XC @ ccle) <=> ((cwbr @ (cco @ XB2 @ XC @ ccmin) @ XA2 @ ccle) & (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ ccle)))))))).
