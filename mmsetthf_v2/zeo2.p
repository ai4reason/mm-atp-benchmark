...
thf(azneo_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => (cwne @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ (cco @ cc2 @ XB2 @ ccmul) @ cc1 @ ccaddc)))))).
...
thf(czeo2_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccz) <=> (~ (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccz)))))).
