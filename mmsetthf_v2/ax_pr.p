...
thf(azfpair_ax,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ ccvv)))).
...
thf(cax_pr_conj,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : (? [Xz:$i] : (! [Xw:$i] : ((((ccv @ Xw) = (ccv @ Xx3)) | ((ccv @ Xw) = (ccv @ Xy1))) => (cwcel @ (ccv @ Xw) @ (ccv @ Xz)))))))).
