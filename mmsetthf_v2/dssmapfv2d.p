...
thf(cdssmapfv2d_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XO:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xf1:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XO @ Xf1 @ Xs1 @ Xb) = (ccmpt @ (^ [Xb:$i] : ccvv) @ (^ [Xb:$i] : (ccmpt @ (^ [Xf1:$i] : (cco @ (ccpw @ (ccv @ Xb)) @ (ccpw @ (ccv @ Xb)) @ ccmap)) @ (^ [Xf1:$i] : (ccmpt @ (^ [Xs1:$i] : (ccpw @ (ccv @ Xb))) @ (^ [Xs1:$i] : (ccdif @ (ccv @ Xb) @ (ccfv @ (ccdif @ (ccv @ Xb) @ (ccv @ Xs1)) @ (ccv @ Xf1))))))))))))) => ((! [Xf1:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XD @ Xf1 @ Xs1 @ Xb) = (ccfv @ XB2 @ (XO @ Xf1 @ Xs1 @ Xb)))))) => ((! [Xf1:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((Xph @ Xs1) => (cwcel @ XB2 @ (XV @ Xf1 @ Xs1 @ Xb)))))) => ((! [Xs1:$i] : (! [Xb:$i] : ((Xph @ Xs1) => (cwcel @ (XF @ Xb) @ (cco @ (ccpw @ XB2) @ (ccpw @ XB2) @ ccmap))))) => ((! [Xf1:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XG @ Xf1 @ Xs1 @ Xb) = (ccfv @ (XF @ Xb) @ (XD @ Xf1 @ Xs1 @ Xb)))))) => (! [Xf1:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((Xph @ Xs1) => ((XG @ Xf1 @ Xs1 @ Xb) = (ccmpt @ (^ [Xs1:$i] : (ccpw @ XB2)) @ (^ [Xs1:$i] : (ccdif @ XB2 @ (ccfv @ (ccdif @ XB2 @ (ccv @ Xs1)) @ (XF @ Xb))))))))))))))))))))))).
