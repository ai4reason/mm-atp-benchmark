...
thf(annarcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((cwcel @ (cco @ XA2 @ XB2 @ ccoa) @ ccom) <=> ((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom))))))).
...
thf(a_1oequni2o_ax,axiom,(cc1o = (ccuni @ cc2o))).
thf(amp3an12_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (Xph => (Xps => (((cw3a @ Xph @ Xps @ Xch) => Xth) => (Xch => Xth))))))))).
thf(a_1on_ax,axiom,(cwcel @ cc1o @ ccon0)).
thf(ardgeqoa_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccon0) @ (cwcel @ XM @ ccon0) @ (cwcel @ XX @ ccom)) => (((ccfv @ XN @ (ccrdg @ XF @ XA2)) = (ccfv @ XM @ (ccrdg @ XF @ XB2))) => ((ccfv @ (cco @ XN @ XX @ ccoa) @ (ccrdg @ XF @ XA2)) = (ccfv @ (cco @ XM @ XX @ ccoa) @ (ccrdg @ XF @ XB2)))))))))))).
