...
thf(cpwsvscaval_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XR @ XI @ ccpws)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccvsca)) => ((Xc_xb = (ccfv @ XY @ ccvsca)) => ((XF = (ccfv @ XR @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xph => (cwcel @ XR @ XV)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XA2 @ XK)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XJ @ XI)) => (Xph => ((ccfv @ XJ @ (cco @ XA2 @ XX @ Xc_xb)) = (cco @ XA2 @ (ccfv @ XJ @ XX) @ Xc_x))))))))))))))))))))))))))))).
