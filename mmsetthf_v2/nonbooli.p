...
thf(ashsleji_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => (cwss @ (cco @ XA2 @ XB2 @ ccph) @ (cco @ XA2 @ XB2 @ cchj))))))).
...
thf(asumspansn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => ((cwcel @ (cco @ XA2 @ XB2 @ ccva) @ (ccfv @ (ccsn @ XA2) @ ccspn)) <=> (cwcel @ XB2 @ (ccfv @ (ccsn @ XA2) @ ccspn))))))).
...
thf(aspansnm0i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((~ (cwcel @ XA2 @ (ccfv @ (ccsn @ XB2) @ ccspn))) => ((ccin @ (ccfv @ (ccsn @ XA2) @ ccspn) @ (ccfv @ (ccsn @ XB2) @ ccspn)) = cc0h))))))).
...
thf(ahvcomi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cco @ XA2 @ XB2 @ ccva) = (cco @ XB2 @ XA2 @ ccva))))))).
thf(achj0i_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cco @ XA2 @ cc0h @ cchj) = XA2)))).
...
thf(cnonbooli_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((XF = (ccfv @ (ccsn @ XA2) @ ccspn)) => ((XG = (ccfv @ (ccsn @ XB2) @ ccspn)) => ((XH = (ccfv @ (ccsn @ (cco @ XA2 @ XB2 @ ccva)) @ ccspn)) => ((~ ((cwcel @ XA2 @ XG) | (cwcel @ XB2 @ XF))) => (cwne @ (ccin @ XH @ (cco @ XF @ XG @ cchj)) @ (cco @ (ccin @ XH @ XF) @ (ccin @ XH @ XG) @ cchj)))))))))))))).
