...
thf(aswrdrlen_ax,axiom,(! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XI @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) => ((ccfv @ (cco @ XW @ (ccop @ XI @ (ccfv @ XW @ cchash)) @ ccsubstr) @ cchash) = (cco @ (ccfv @ XW @ cchash) @ XI @ ccmin))))))).
...
thf(caddlenrevswrd_conj,conjecture,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XM @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) => ((cco @ (ccfv @ (cco @ XW @ (ccop @ XM @ (ccfv @ XW @ cchash)) @ ccsubstr) @ cchash) @ (ccfv @ (cco @ XW @ (ccop @ ccc0 @ XM) @ ccsubstr) @ cchash) @ ccaddc) = (ccfv @ XW @ cchash))))))).
