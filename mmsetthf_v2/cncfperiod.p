...
thf(aelcncf_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwss @ XA2 @ ccc) & (cwss @ XB2 @ ccc)) => ((cwcel @ XF @ (cco @ XA2 @ XB2 @ cccncf)) <=> ((cwf @ XA2 @ XB2 @ XF) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : ((cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xw) @ ccmin) @ ccabs) @ (ccv @ Xz) @ cclt) => (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xw) @ XF) @ ccmin) @ ccabs) @ (ccv @ Xy1) @ cclt))) @ (^ [Xw:$i] : XA2))) @ (^ [Xz:$i] : ccrp))) @ (^ [Xy1:$i] : ccrp))) @ (^ [Xx3:$i] : XA2))))))))).
...
thf(ccncfperiod_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwcel @ XT @ ccr)) => ((XB2 = (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ XT @ ccaddc))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccc))) => ((Xph => (cwf @ (ccdm @ XF) @ ccc @ XF)) => ((Xph => (cwss @ XB2 @ (ccdm @ XF))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => ((ccfv @ (cco @ (ccv @ Xx3) @ XT @ ccaddc) @ XF) = (ccfv @ (ccv @ Xx3) @ XF)))) => ((Xph => (cwcel @ (ccres @ XF @ XA2) @ (cco @ XA2 @ ccc @ cccncf))) => (Xph => (cwcel @ (ccres @ XF @ XB2) @ (cco @ XB2 @ ccc @ cccncf)))))))))))))))).
