...
thf(agrplactf1o_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((! [Xg1:$i] : (! [Xa:$i] : ((XF @ Xg1 @ Xa) = (ccmpt @ (^ [Xg1:$i] : XX) @ (^ [Xg1:$i] : (ccmpt @ (^ [Xa:$i] : XX) @ (^ [Xa:$i] : (cco @ (ccv @ Xg1) @ (ccv @ Xa) @ Xc_pl)))))))) => ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (! [Xg1:$i] : (! [Xa:$i] : (((cwcel @ XG @ ccgrp) & (cwcel @ XA2 @ XX)) => (cwf1o @ XX @ XX @ (ccfv @ XA2 @ (XF @ Xg1 @ Xa))))))))))))))).
...
thf(cdchrsum2_conj,conjecture,(! [Xph:$o] : (! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xa:$i] : ((XG @ Xa) = (ccfv @ (XN @ Xa) @ ccdchr))) => ((! [Xa:$i] : (XZ = (ccfv @ (XN @ Xa) @ cczn))) => ((! [Xa:$i] : ((XD @ Xa) = (ccfv @ (XG @ Xa) @ ccbs))) => ((! [Xa:$i] : (Xc_1 = (ccfv @ (XG @ Xa) @ cc0g))) => ((! [Xa:$i] : (Xph => (cwcel @ XX @ (XD @ Xa)))) => ((XU = (ccfv @ XZ @ ccui)) => (! [Xa:$i] : (Xph => ((ccsu @ XU @ (^ [Xa:$i] : (ccfv @ (ccv @ Xa) @ XX))) = (ccif @ (XX = Xc_1) @ (ccfv @ (XN @ Xa) @ ccphi) @ ccc0))))))))))))))))))).
