...
thf(attgbas_ax,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XG = (ccfv @ XH @ ccttg)) => ((XB2 = (ccfv @ XH @ ccbs)) => (XB2 = (ccfv @ XG @ ccbs)))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(cc2_tp,type,(cc2 : ($i > $o))).
thf(attgplusg_ax,axiom,(! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XG = (ccfv @ XH @ ccttg)) => ((Xc_pl = (ccfv @ XH @ ccplusg)) => (Xc_pl = (ccfv @ XG @ ccplusg)))))))).
