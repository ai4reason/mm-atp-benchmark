...
thf(cdigvalnn0_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : ((cw3a @ (cwcel @ XB2 @ ccn) @ (cwcel @ XK @ ccz) @ (cwcel @ XR @ (cco @ ccc0 @ ccpnf @ ccico))) => (cwcel @ (cco @ XK @ XR @ (ccfv @ XB2 @ ccdig)) @ ccn0)))))).
