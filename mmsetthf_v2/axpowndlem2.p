...
thf(caxpowndlem2_conj,conjecture,(! [Xy1:$i] : (! [Xz:$i] : ((~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1)))) => ((~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xz)))) => (? [Xx3:$i] : (! [Xy1:$i] : ((! [Xx3:$i] : ((? [Xz:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))) => (! [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xz))))) => (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)))))))))).
