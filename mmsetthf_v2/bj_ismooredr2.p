...
thf(abj_ismoore_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((cwcel @ XA2 @ ccmoore) <=> (cwral @ (^ [Xx3:$i] : (cwcel @ (ccin @ (ccuni @ XA2) @ (ccint @ (ccv @ Xx3))) @ XA2)) @ (^ [Xx3:$i] : (ccpw @ XA2))))))))).
thf(cbj_ismooredr2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3)))) => ((Xph => (cwcel @ (ccuni @ XA2) @ XA2)) => ((! [Xx3:$i] : (((Xph & (cwss @ (ccv @ Xx3) @ XA2)) & (cwne @ (ccv @ Xx3) @ cc0)) => (cwcel @ (ccint @ (ccv @ Xx3)) @ XA2))) => (Xph => (cwcel @ XA2 @ ccmoore))))))))).
