...
thf(arpefcl_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwcel @ (ccfv @ XA2 @ cce) @ ccrp)))).
...
thf(areef11_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (((ccfv @ XA2 @ cce) = (ccfv @ XB2 @ cce)) <=> (XA2 = XB2)))))).
...
thf(creeff1_conj,conjecture,(cwf1 @ ccr @ ccrp @ (ccres @ cce @ ccr))).
