...
thf(aprmdvdsprmop_ax,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XI @ (cco @ cc2 @ XN @ ccfz))) => (cwrex @ (^ [Xp:$i] : (cw3a @ (cwbr @ (ccv @ Xp) @ XN @ ccle) @ (cwbr @ (ccv @ Xp) @ XI @ ccdvds) @ (cwbr @ (ccv @ Xp) @ (cco @ (ccfv @ XN @ ccprmo) @ XI @ ccaddc) @ ccdvds))) @ (^ [Xp:$i] : ccprime)))))).
...
thf(aprmocl_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => (cwcel @ (ccfv @ XN @ ccprmo) @ ccn)))).
...
thf(cprmgapprmolem_conj,conjecture,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XI @ (cco @ cc2 @ XN @ ccfz))) => (cwbr @ cc1 @ (cco @ (cco @ (ccfv @ XN @ ccprmo) @ XI @ ccaddc) @ XI @ ccgcd) @ cclt))))).
