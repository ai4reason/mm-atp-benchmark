...
thf(alnopl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : ((((cwcel @ XT @ cclo) & (cwcel @ XA2 @ ccc)) & ((cwcel @ XB2 @ cchil) & (cwcel @ XC @ cchil))) => ((ccfv @ (cco @ (cco @ XA2 @ XB2 @ ccsm) @ XC @ ccva) @ XT) = (cco @ (cco @ XA2 @ (ccfv @ XB2 @ XT) @ ccsm) @ (ccfv @ XC @ XT) @ ccva)))))))).
...
thf(ahvpncan_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => ((cco @ (cco @ XA2 @ XB2 @ ccva) @ XB2 @ ccmv) = XA2))))).
thf(clnop0_conj,conjecture,(! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => ((ccfv @ cc0v @ XT) = cc0v)))).
