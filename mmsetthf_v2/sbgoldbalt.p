...
thf(asbgoldbaltlem2_ax,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XQ @ ccprime)) => ((cw3a @ (cwcel @ XN @ cceven) @ (cwbr @ cc4 @ XN @ cclt) @ (XN = (cco @ XP @ XQ @ ccaddc))) => ((cwcel @ XP @ ccodd) & (cwcel @ XQ @ ccodd)))))))).
thf(csbgoldbalt_conj,conjecture,((cwral @ (^ [Xn:$i] : ((cwbr @ cc4 @ (ccv @ Xn) @ cclt) => (cwcel @ (ccv @ Xn) @ ccgbe))) @ (^ [Xn:$i] : cceven)) <=> (cwral @ (^ [Xn:$i] : ((cwbr @ cc2 @ (ccv @ Xn) @ cclt) => (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : ((ccv @ Xn) = (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccaddc))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime)))) @ (^ [Xn:$i] : cceven)))).
