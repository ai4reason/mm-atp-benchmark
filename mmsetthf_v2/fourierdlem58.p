...
thf(advdivcncf_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwf @ XX @ ccc @ XF)) => ((Xph => (cwf @ XX @ (ccdif @ ccc @ (ccsn @ ccc0)) @ XG)) => ((Xph => (cwcel @ (cco @ XS @ XF @ ccdv) @ (cco @ XX @ ccc @ cccncf))) => ((Xph => (cwcel @ (cco @ XS @ XG @ ccdv) @ (cco @ XX @ ccc @ cccncf))) => (Xph => (cwcel @ (cco @ XS @ (cco @ XF @ XG @ (ccof @ ccdiv)) @ ccdv) @ (cco @ XX @ ccc @ cccncf)))))))))))))).
...
thf(cfourierdlem58_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XK:($i > ($i > $o))] : ((! [Xs1:$i] : ((XK @ Xs1) = (ccmpt @ (^ [Xs1:$i] : XA2) @ (^ [Xs1:$i] : (cco @ (ccv @ Xs1) @ (cco @ cc2 @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv))))) => ((Xph => (cwss @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc))) => ((Xph => (~ (cwcel @ ccc0 @ XA2))) => ((Xph => (cwcel @ XA2 @ (ccfv @ (ccrn @ ccioo) @ cctg))) => (! [Xs1:$i] : (Xph => (cwcel @ (cco @ ccr @ (XK @ Xs1) @ ccdv) @ (cco @ XA2 @ ccr @ cccncf)))))))))))).
