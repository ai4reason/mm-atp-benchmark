...
thf(aqtopbas_ax,axiom,(cwcel @ (ccima @ ccioo @ (ccxp @ ccq @ ccq)) @ cctb)).
...
thf(ctgqioo_conj,conjecture,(! [XQ:($i > $o)] : ((XQ = (ccfv @ (ccima @ ccioo @ (ccxp @ ccq @ ccq)) @ cctg)) => ((ccfv @ (ccrn @ ccioo) @ cctg) = XQ)))).
