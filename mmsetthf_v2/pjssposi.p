...
thf(apjinormi_ax,axiom,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => ((cco @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ XA2 @ ccsp) = (cco @ (ccfv @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccno) @ cc2 @ ccexp))))))).
...
thf(apjnormssi_ax,axiom,(! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => ((cwss @ XG @ XH) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XG @ ccpjh)) @ ccno) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XH @ ccpjh)) @ ccno) @ ccle)) @ (^ [Xx3:$i] : cchil)))))))).
