...
thf(adf_inag_ax,axiom,(ccinag = (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccopab @ (^ [Xp:$i] : (^ [Xt:$i] : (((cwcel @ (ccv @ Xp) @ (ccfv @ (ccv @ Xg1) @ ccbs)) & (cwcel @ (ccv @ Xt) @ (cco @ (ccfv @ (ccv @ Xg1) @ ccbs) @ (cco @ ccc0 @ cc3 @ ccfzo) @ ccmap))) & ((cw3a @ (cwne @ (ccfv @ ccc0 @ (ccv @ Xt)) @ (ccfv @ cc1 @ (ccv @ Xt))) @ (cwne @ (ccfv @ cc2 @ (ccv @ Xt)) @ (ccfv @ cc1 @ (ccv @ Xt))) @ (cwne @ (ccv @ Xp) @ (ccfv @ cc1 @ (ccv @ Xt)))) & (cwrex @ (^ [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (cco @ (ccfv @ ccc0 @ (ccv @ Xt)) @ (ccfv @ cc2 @ (ccv @ Xt)) @ (ccfv @ (ccv @ Xg1) @ ccitv))) & (((ccv @ Xx3) = (ccfv @ cc1 @ (ccv @ Xt))) | (cwbr @ (ccv @ Xx3) @ (ccv @ Xp) @ (ccfv @ (ccfv @ cc1 @ (ccv @ Xt)) @ (ccfv @ (ccv @ Xg1) @ cchlg)))))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xg1) @ ccbs)))))))))))).
