...
thf(aabsfun_ax,axiom,(cwfun @ ccabs)).
...
thf(admfco_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfun @ XG) & (cwcel @ XA2 @ (ccdm @ XG))) => ((cwcel @ XA2 @ (ccdm @ (cccom @ XF @ XG))) <=> (cwcel @ (ccfv @ XA2 @ XG) @ (ccdm @ XF)))))))).
