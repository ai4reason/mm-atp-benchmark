...
thf(achpscmat0_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_ex:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XI:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XM:($i > $o)] : (! [Xc_mi:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XN:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XC @ Xi @ Xj @ Xm @ Xn @ Xc) = (cco @ XN @ XR @ ccchpmat))))))) => ((! [Xm:$i] : (! [Xc:$i] : ((XP @ Xm @ Xc) = (ccfv @ XR @ ccpl1)))) => ((! [Xn:$i] : ((XA2 @ Xn) = (cco @ XN @ XR @ ccmat))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XX @ Xm @ Xn @ Xc) = (ccfv @ XR @ ccv1))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XG @ Xi @ Xj @ Xm @ Xn @ Xc) = (ccfv @ (XP @ Xm @ Xc) @ ccmgp))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xc_ex @ Xi @ Xj @ Xm @ Xn @ Xc) = (ccfv @ (XG @ Xi @ Xj @ Xm @ Xn @ Xc) @ ccmg))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XD @ Xi @ Xj @ Xm @ Xc) = (ccrab @ (^ [Xm:$i] : (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : ((cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccv @ Xm)) = (ccif @ ((ccv @ Xi) = (ccv @ Xj)) @ (ccv @ Xc) @ (ccfv @ XR @ cc0g)))) @ (^ [Xj:$i] : XN))) @ (^ [Xi:$i] : XN))) @ (^ [Xc:$i] : (ccfv @ XR @ ccbs)))) @ (^ [Xm:$i] : (ccfv @ (XA2 @ Xn) @ ccbs))))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (! [Xc:$i] : ((XS @ Xi @ Xj @ Xm @ Xc) = (ccfv @ (XP @ Xm @ Xc) @ ccascl)))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xc_mi @ Xi @ Xj @ Xm @ Xn @ Xc) = (ccfv @ (XP @ Xm @ Xc) @ ccsg))))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ cccrg)) & (cw3a @ (cwcel @ XM @ (XD @ Xi @ Xj @ Xm @ Xc)) @ (cwcel @ (XI @ Xi @ Xj @ Xm @ Xc) @ XN) @ (cwral @ (^ [Xn:$i] : ((cco @ (ccv @ Xn) @ (ccv @ Xn) @ XM) = (cco @ (XI @ Xi @ Xj @ Xm @ Xc) @ (XI @ Xi @ Xj @ Xm @ Xc) @ XM))) @ (^ [Xn:$i] : XN)))) => ((ccfv @ XM @ (XC @ Xi @ Xj @ Xm @ Xn @ Xc)) = (cco @ (ccfv @ XN @ cchash) @ (cco @ (XX @ Xm @ Xn @ Xc) @ (ccfv @ (cco @ (XI @ Xi @ Xj @ Xm @ Xc) @ (XI @ Xi @ Xj @ Xm @ Xc) @ XM) @ (XS @ Xi @ Xj @ Xm @ Xc)) @ (Xc_mi @ Xi @ Xj @ Xm @ Xn @ Xc)) @ (Xc_ex @ Xi @ Xj @ Xm @ Xn @ Xc)))))))))))))))))))))))))))))))).
...
thf(aasclinvg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XW @ ccascl)) => ((XR = (ccfv @ XW @ ccsca)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((XI = (ccfv @ XR @ ccminusg)) => ((XJ = (ccfv @ XW @ ccminusg)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XW @ ccrg) @ (cwcel @ XC @ XB2)) => ((ccfv @ (ccfv @ XC @ XA2) @ XJ) = (ccfv @ (ccfv @ XC @ XI) @ XA2)))))))))))))))).
...
thf(alply1binomsc_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [Xc_ex:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_pl = (ccfv @ XP @ ccplusg)) => ((Xc_xp = (ccfv @ XP @ ccmulr)) => ((Xc_x = (ccfv @ XP @ ccmg)) => ((! [Xk:$i] : ((XG @ Xk) = (ccfv @ XP @ ccmgp))) => ((! [Xk:$i] : (Xc_ex = (ccfv @ (XG @ Xk) @ ccmg))) => ((XK = (ccfv @ XR @ ccbs)) => ((XS = (ccfv @ XP @ ccascl)) => ((! [Xk:$i] : ((XH @ Xk) = (ccfv @ XR @ ccmgp))) => ((! [Xk:$i] : ((XE @ Xk) = (ccfv @ (XH @ Xk) @ ccmg))) => ((cw3a @ (cwcel @ XR @ cccrg) @ (cwcel @ XN @ ccn0) @ (cwcel @ XA2 @ XK)) => ((cco @ XN @ (cco @ XX @ (ccfv @ XA2 @ XS) @ Xc_pl) @ Xc_ex) = (cco @ XP @ (ccmpt @ (^ [Xk:$i] : (cco @ ccc0 @ XN @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ XN @ (ccv @ Xk) @ ccbc) @ (cco @ (ccfv @ (cco @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ XA2 @ (XE @ Xk)) @ XS) @ (cco @ (ccv @ Xk) @ XX @ Xc_ex) @ Xc_xp) @ Xc_x))) @ ccgsu))))))))))))))))))))))))))))).
