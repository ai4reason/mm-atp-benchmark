...
thf(aeusv1_ax,axiom,(! [XA2:($i > ($i > $o))] : ((cweu @ (^ [Xy1:$i] : (! [Xx3:$i] : ((ccv @ Xy1) = (XA2 @ Xx3))))) <=> (? [Xy1:$i] : (! [Xx3:$i] : ((ccv @ Xy1) = (XA2 @ Xx3))))))).
thf(ceusvnfb_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [Xx3:$i] : ((cweu @ (^ [Xy1:$i] : (! [Xx3:$i] : ((ccv @ Xy1) = (XA2 @ Xx3))))) <=> ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) & (cwcel @ (XA2 @ Xx3) @ ccvv)))))).
