...
thf(aprproe_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XC @ (ccpr @ XA2 @ XB2)) @ (cwne @ XA2 @ XB2) @ ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV))) => (cwrex @ (^ [Xv:$i] : (cwcel @ (ccv @ Xv) @ (ccpr @ XA2 @ XB2))) @ (^ [Xv:$i] : (ccdif @ XV @ (ccsn @ XC)))))))))).
