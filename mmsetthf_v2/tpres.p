...
thf(ctpres_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (XT = (cctp @ (ccop @ XA2 @ XD) @ (ccop @ XB2 @ XE) @ (ccop @ XC @ XF)))) => ((Xph => (cwcel @ XB2 @ XV)) => ((Xph => (cwcel @ XC @ XV)) => ((Xph => (cwcel @ XE @ XV)) => ((Xph => (cwcel @ XF @ XV)) => ((Xph => (cwne @ XB2 @ XA2)) => ((Xph => (cwne @ XC @ XA2)) => (Xph => ((ccres @ XT @ (ccdif @ ccvv @ (ccsn @ XA2))) = (ccpr @ (ccop @ XB2 @ XE) @ (ccop @ XC @ XF))))))))))))))))))))).
