...
thf(aalephislim_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) <=> (cwlim @ (ccfv @ XA2 @ ccale))))).
...
thf(aalephsucdom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccon0) => ((cwbr @ XA2 @ (ccfv @ XB2 @ ccale) @ ccdom) <=> (cwbr @ XA2 @ (ccfv @ (ccsuc @ XB2) @ ccale) @ ccsdm)))))).
thf(cwacn_tp,type,(cwacn : (($i > $o) > ($i > $o)))).
thf(ccmap_tp,type,(ccmap : ($i > $o))).
thf(cco_tp,type,(cco : (($i > $o) > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(aiundom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XA2 @ (XV @ Xx3)) & (cwral @ (^ [Xx3:$i] : (cwbr @ (XC @ Xx3) @ XB2 @ ccdom)) @ (^ [Xx3:$i] : XA2))) => (cwbr @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (ccxp @ XA2 @ XB2) @ ccdom)))))))).
...
thf(ainfxpen_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwss @ ccom @ XA2)) => (cwbr @ (ccxp @ XA2 @ XA2) @ XA2 @ ccen)))).
thf(asyl6_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps => Xch)) => ((Xch => Xth) => (Xph => (Xps => Xth))))))))).
thf(axpdom1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccvv) => ((cwbr @ XA2 @ XB2 @ ccdom) => (cwbr @ (ccxp @ XA2 @ XC) @ (ccxp @ XB2 @ XC) @ ccdom))))))).
...
thf(calephreg_conj,conjecture,(! [XA2:($i > $o)] : ((ccfv @ (ccfv @ (ccsuc @ XA2) @ ccale) @ cccf) = (ccfv @ (ccsuc @ XA2) @ ccale)))).
