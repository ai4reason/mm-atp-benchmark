...
thf(armx0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) => ((cco @ XA2 @ ccc0 @ ccrmx) = cc1)))).
...
thf(armxluc_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccz)) => ((cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccrmx) = (cco @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ XA2 @ XN @ ccrmx) @ ccmul) @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccmin) @ ccrmx) @ ccmin)))))).
...
thf(cjm2_18_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XK @ ccn0) @ (cwcel @ XN @ ccn0)) => (cwbr @ (cco @ (cco @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ XK @ ccmul) @ (cco @ XK @ cc2 @ ccexp) @ ccmin) @ cc1 @ ccmin) @ (cco @ (cco @ (cco @ XA2 @ XN @ ccrmx) @ (cco @ (cco @ XA2 @ XK @ ccmin) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul) @ ccmin) @ (cco @ XK @ XN @ ccexp) @ ccmin) @ ccdvds)))))).
