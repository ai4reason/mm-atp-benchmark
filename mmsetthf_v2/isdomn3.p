...
thf(cisdomn3_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XU = (ccfv @ XR @ ccmgp)) => ((cwcel @ XR @ ccdomn) <=> ((cwcel @ XR @ ccrg) & (cwcel @ (ccdif @ XB2 @ (ccsn @ Xc_0)) @ (ccfv @ XU @ ccsubmnd)))))))))))).
