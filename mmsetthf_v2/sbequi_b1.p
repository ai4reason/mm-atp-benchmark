...
thf(aequtr_b2_ax,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => (((ccv @ Xy1) = (ccv @ Xx3)) => ((ccv @ Xx3) = (ccv @ Xx3))))))).
...
thf(aax13_b1_ax,axiom,(! [Xx3:$i] : (! [Xy1:$i] : ((~ ((ccv @ Xx3) = (ccv @ Xy1))) => (((ccv @ Xy1) = (ccv @ Xx3)) => (! [Xx3:$i] : ((ccv @ Xy1) = (ccv @ Xx3)))))))).
...
thf(csbequi_b1_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((cwsb @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ Xx3) => (cwsb @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ Xy1))))))).
