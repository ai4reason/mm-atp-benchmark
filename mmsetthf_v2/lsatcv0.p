...
thf(alspsncv0_ax,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xy1:$i] : ((XV @ Xy1) = (ccfv @ (XW @ Xy1) @ ccbs))) => ((! [Xy1:$i] : ((Xc_0 @ Xy1) = (ccfv @ (XW @ Xy1) @ cc0g))) => ((! [Xy1:$i] : ((XS @ Xy1) = (ccfv @ (XW @ Xy1) @ cclss))) => ((! [Xy1:$i] : ((XN @ Xy1) = (ccfv @ (XW @ Xy1) @ cclspn))) => ((! [Xy1:$i] : (Xph => (cwcel @ (XW @ Xy1) @ cclvec))) => ((! [Xy1:$i] : (Xph => (cwcel @ (XX @ Xy1) @ (XV @ Xy1)))) => ((! [Xy1:$i] : (Xph => (cwne @ (XX @ Xy1) @ (Xc_0 @ Xy1)))) => (Xph => (~ (cwrex @ (^ [Xy1:$i] : ((cwpss @ (ccsn @ (Xc_0 @ Xy1)) @ (ccv @ Xy1)) & (cwpss @ (ccv @ Xy1) @ (ccfv @ (ccsn @ (XX @ Xy1)) @ (XN @ Xy1))))) @ (^ [Xy1:$i] : (XS @ Xy1)))))))))))))))))))).
...
thf(clsatcv0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XA2 = (ccfv @ XW @ cclsa)) => ((XC = (ccfv @ XW @ cclcv)) => ((Xph => (cwcel @ XW @ cclvec)) => ((Xph => (cwcel @ XQ @ XA2)) => (Xph => (cwbr @ (ccsn @ Xc_0) @ XQ @ XC)))))))))))))).
