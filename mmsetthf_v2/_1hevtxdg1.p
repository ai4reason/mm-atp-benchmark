...
thf(c_1hevtxdg1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => ((ccfv @ XG @ cciedg) = (ccsn @ (ccop @ XA2 @ XE)))) => ((Xph => ((ccfv @ XG @ ccvtx) = XV)) => ((Xph => (cwcel @ XA2 @ XX)) => ((Xph => (cwcel @ XD @ XV)) => ((Xph => (cwcel @ XE @ (ccpw @ XV))) => ((Xph => (cwcel @ XD @ XE)) => ((Xph => (cwbr @ cc2 @ (ccfv @ XE @ cchash) @ ccle)) => (Xph => ((ccfv @ XD @ (ccfv @ XG @ ccvtxdg)) = cc1))))))))))))))))).
