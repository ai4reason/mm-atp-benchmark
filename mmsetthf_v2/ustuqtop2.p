...
thf(asimp_7l_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : (! [Xsi:$o] : ((((((((Xph & Xps) & Xch) & Xth) & Xta) & Xet) & Xze) & Xsi) => Xph)))))))))).
...
thf(austincl_ax,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XU @ (ccfv @ XX @ ccust)) @ (cwcel @ XV @ XU) @ (cwcel @ XW @ XU)) => (cwcel @ (ccin @ XV @ XW) @ XU))))))).
...
thf(ainimasn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XC @ XV) => ((ccima @ (ccin @ XA2 @ XB2) @ (ccsn @ XC)) = (ccin @ (ccima @ XA2 @ (ccsn @ XC)) @ (ccima @ XB2 @ (ccsn @ XC)))))))))).
...
thf(custuqtop2_conj,conjecture,(! [XU:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xv:$i] : ((XN @ Xv) = (ccmpt @ (^ [Xp:$i] : XX) @ (^ [Xp:$i] : (ccrn @ (ccmpt @ (^ [Xv:$i] : XU) @ (^ [Xv:$i] : (ccima @ (ccv @ Xv) @ (ccsn @ (ccv @ Xp)))))))))) => (! [Xv:$i] : (! [Xp:$i] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ (ccv @ Xp) @ XX)) => (cwss @ (ccfv @ (ccfv @ (ccv @ Xp) @ (XN @ Xv)) @ ccfi) @ (ccfv @ (ccv @ Xp) @ (XN @ Xv))))))))))).
