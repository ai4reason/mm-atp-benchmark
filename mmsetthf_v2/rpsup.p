...
thf(aioopnfsup_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwne @ XA2 @ ccpnf)) => ((ccsup @ (cco @ XA2 @ ccpnf @ ccioo) @ ccxr @ cclt) = ccpnf)))).
thf(crpsup_conj,conjecture,((ccsup @ ccrp @ ccxr @ cclt) = ccpnf)).
