...
thf(aopabex2_ax,axiom,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XB2 @ (XW @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (Xps @ Xx3 @ Xy1)) => (cwcel @ (ccv @ Xx3) @ XA2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (Xps @ Xx3 @ Xy1)) => (cwcel @ (ccv @ Xy1) @ XB2)))) => (Xph => (cwcel @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)))) @ ccvv))))))))))))).
...
thf(aprsssprel_ax,axiom,(! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwss @ XP @ (ccfv @ XV @ ccspr)) @ (cwcel @ (ccpr @ XX @ XY) @ XP) @ ((cwcel @ XX @ XU) & (cwcel @ XY @ XW))) => ((cwcel @ XX @ XV) & (cwcel @ XY @ XV)))))))))).
...
thf(csprsymrelfvlem_conj,conjecture,(! [XP:($i > $o)] : (! [XV:($i > $o)] : ((cwss @ XP @ (ccfv @ XV @ ccspr)) => (cwcel @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xc:$i] : ((ccv @ Xc) = (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xc:$i] : XP))))) @ (ccpw @ (ccxp @ XV @ XV))))))).
