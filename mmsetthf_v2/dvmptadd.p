...
thf(advaddf_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwf @ XX @ ccc @ XF)) => ((Xph => (cwf @ XX @ ccc @ XG)) => ((Xph => ((ccdm @ (cco @ XS @ XF @ ccdv)) = XX)) => ((Xph => ((ccdm @ (cco @ XS @ XG @ ccdv)) = XX)) => (Xph => ((cco @ XS @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ ccdv) = (cco @ (cco @ XS @ XF @ ccdv) @ (cco @ XS @ XG @ ccdv) @ (ccof @ ccaddc))))))))))))))).
