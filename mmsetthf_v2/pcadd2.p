...
thf(apcadd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((Xph => (cwcel @ XP @ ccprime)) => ((Xph => (cwcel @ XA2 @ ccq)) => ((Xph => (cwcel @ XB2 @ ccq)) => ((Xph => (cwbr @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc) @ ccle)) => (Xph => (cwbr @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ (cco @ XA2 @ XB2 @ ccaddc) @ ccpc) @ ccle))))))))))).
thf(ampd_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => (Xps => Xch)) => (Xph => Xch))))))).
thf(asyl2anc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xph => Xch) => (((Xps & Xch) => Xth) => (Xph => Xth))))))))).
thf(apcxcl_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XN @ ccq)) => (cwcel @ (cco @ XP @ XN @ ccpc) @ ccxr))))).
...
thf(apcneg_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccq)) => ((cco @ XP @ (ccneg @ XA2) @ ccpc) = (cco @ XP @ XA2 @ ccpc)))))).
...
thf(cpcadd2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((Xph => (cwcel @ XP @ ccprime)) => ((Xph => (cwcel @ XA2 @ ccq)) => ((Xph => (cwcel @ XB2 @ ccq)) => ((Xph => (cwbr @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc) @ cclt)) => (Xph => ((cco @ XP @ XA2 @ ccpc) = (cco @ XP @ (cco @ XA2 @ XB2 @ ccaddc) @ ccpc)))))))))))).
