...
thf(aivth2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XU @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ XD)) => ((Xph => (cwcel @ XF @ (cco @ XD @ ccc @ cccncf))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccicc))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ ccr))) => ((Xph => ((cwbr @ (ccfv @ XB2 @ XF) @ XU @ cclt) & (cwbr @ XU @ (ccfv @ XA2 @ XF) @ cclt))) => (Xph => (cwrex @ (^ [Xc:$i] : ((ccfv @ (ccv @ Xc) @ XF) = XU)) @ (^ [Xc:$i] : (cco @ XA2 @ XB2 @ ccioo))))))))))))))))))).
...
thf(asin4lt0_ax,axiom,(cwbr @ (ccfv @ cc4 @ ccsin) @ ccc0 @ cclt)).
thf(asimpli_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xph)))).
thf(cc7_tp,type,(cc7 : ($i > $o))).
thf(cc9_tp,type,(cc9 : ($i > $o))).
thf(ccioc_tp,type,(ccioc : ($i > $o))).
thf(asincos2sgn_ax,axiom,((cwbr @ ccc0 @ (ccfv @ cc2 @ ccsin) @ cclt) & (cwbr @ (ccfv @ cc2 @ cccos) @ ccc0 @ cclt))).
...
thf(apilem1_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccin @ ccrp @ (ccima @ (cccnv @ ccsin) @ (ccsn @ ccc0)))) <=> ((cwcel @ XA2 @ ccrp) & ((ccfv @ XA2 @ ccsin) = ccc0))))).
...
thf(apilem2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ (cco @ cc2 @ cc4 @ ccioo))) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => ((ccfv @ XA2 @ ccsin) = ccc0)) => ((Xph => ((ccfv @ XB2 @ ccsin) = ccc0)) => ((Xph => (cwbr @ ccpi @ XA2 @ cclt)) => (Xph => (cwbr @ (cco @ (cco @ ccpi @ XA2 @ ccaddc) @ cc2 @ ccdiv) @ XB2 @ ccle))))))))))).
...
thf(ainfregelb_b_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xy1:$i] : (((cw3a @ (cwss @ XA2 @ ccr) @ (cwne @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr))) & (cwcel @ (XB2 @ Xy1) @ ccr)) => ((cwbr @ (XB2 @ Xy1) @ (ccinf @ XA2 @ ccr @ cclt) @ ccle) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(aavgle2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwbr @ (cco @ (cco @ XA2 @ XB2 @ ccaddc) @ cc2 @ ccdiv) @ XB2 @ ccle)))))).
...
thf(cpilem3_conj,conjecture,((cwcel @ ccpi @ (cco @ cc2 @ cc4 @ ccioo)) & ((ccfv @ ccpi @ ccsin) = ccc0))).
