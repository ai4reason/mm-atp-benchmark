...
thf(aeu2ndop1stv_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cweu @ (^ [Xy1:$i] : (cwcel @ (ccop @ XA2 @ (ccv @ Xy1)) @ XV))) => (cwcel @ XA2 @ ccvv))))).
...
thf(afveu_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cweu @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ XF))) => ((ccfv @ XA2 @ XF) = (ccuni @ (ccab @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ XF))))))))).
thf(cafveu_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cweu @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ XF))) => ((ccafv @ XA2 @ XF) = (ccuni @ (ccab @ (^ [Xx3:$i] : (cwbr @ XA2 @ (ccv @ Xx3) @ XF))))))))).
