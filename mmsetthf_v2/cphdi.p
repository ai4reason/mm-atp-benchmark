...
thf(ccphdi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_xi = (ccfv @ XW @ ccip)) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => (((cwcel @ XW @ cccph) & (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XV))) => ((cco @ XA2 @ (cco @ XB2 @ XC @ Xc_pl) @ Xc_xi) = (cco @ (cco @ XA2 @ XB2 @ Xc_xi) @ (cco @ XA2 @ XC @ Xc_xi) @ ccaddc)))))))))))))).
