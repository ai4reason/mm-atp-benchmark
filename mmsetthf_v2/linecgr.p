...
thf(acgr3rflx_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee)))) => (cwbr @ (ccop @ XA2 @ (ccop @ XB2 @ XC)) @ (ccop @ XA2 @ (ccop @ XB2 @ XC)) @ cccgr3))))))).
...
thf(abrfs_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ (cw3a @ (cwcel @ XC @ (ccfv @ XN @ ccee)) @ (cwcel @ XD @ (ccfv @ XN @ ccee)) @ (cwcel @ XE @ (ccfv @ XN @ ccee))) @ (cw3a @ (cwcel @ XF @ (ccfv @ XN @ ccee)) @ (cwcel @ XG @ (ccfv @ XN @ ccee)) @ (cwcel @ XH @ (ccfv @ XN @ ccee)))) => ((cwbr @ (ccop @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD)) @ (ccop @ (ccop @ XE @ XF) @ (ccop @ XG @ XH)) @ ccfs) <=> (cw3a @ (cwbr @ XA2 @ (ccop @ XB2 @ XC) @ cccolin) @ (cwbr @ (ccop @ XA2 @ (ccop @ XB2 @ XC)) @ (ccop @ XE @ (ccop @ XF @ XG)) @ cccgr3) @ ((cwbr @ (ccop @ XA2 @ XD) @ (ccop @ XE @ XH) @ cccgr) & (cwbr @ (ccop @ XB2 @ XD) @ (ccop @ XF @ XH) @ cccgr))))))))))))))).
thf(ccifs_tp,type,(ccifs : ($i > $o))).
thf(ccofs_tp,type,(ccofs : ($i > $o))).
thf(ccbtwn_tp,type,(ccbtwn : ($i > $o))).
thf(cw3o_tp,type,(cw3o : ($o > ($o > ($o > $o))))).
thf(afscgr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ (cw3a @ (cwcel @ XC @ (ccfv @ XN @ ccee)) @ (cwcel @ XD @ (ccfv @ XN @ ccee)) @ (cwcel @ XE @ (ccfv @ XN @ ccee))) @ (cw3a @ (cwcel @ XF @ (ccfv @ XN @ ccee)) @ (cwcel @ XG @ (ccfv @ XN @ ccee)) @ (cwcel @ XH @ (ccfv @ XN @ ccee)))) => (((cwbr @ (ccop @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD)) @ (ccop @ (ccop @ XE @ XF) @ (ccop @ XG @ XH)) @ ccfs) & (cwne @ XA2 @ XB2)) => (cwbr @ (ccop @ XC @ XD) @ (ccop @ XG @ XH) @ cccgr))))))))))))).
thf(clinecgr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee))) @ ((cwcel @ XP @ (ccfv @ XN @ ccee)) & (cwcel @ XQ @ (ccfv @ XN @ ccee)))) => ((((cwne @ XA2 @ XB2) & (cwbr @ XA2 @ (ccop @ XB2 @ XC) @ cccolin)) & ((cwbr @ (ccop @ XA2 @ XP) @ (ccop @ XA2 @ XQ) @ cccgr) & (cwbr @ (ccop @ XB2 @ XP) @ (ccop @ XB2 @ XQ) @ cccgr))) => (cwbr @ (ccop @ XC @ XP) @ (ccop @ XC @ XQ) @ cccgr)))))))))).
