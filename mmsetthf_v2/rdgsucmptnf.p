...
thf(ardgsucg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XB2 @ (ccdm @ (ccrdg @ XF @ XA2))) => ((ccfv @ (ccsuc @ XB2) @ (ccrdg @ XF @ XA2)) = (ccfv @ (ccfv @ XB2 @ (ccrdg @ XF @ XA2)) @ XF))))))).
thf(afveq2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))).
thf(ccid_tp,type,(ccid : ($i > $o))).
thf(afvmptnf_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XC @ Xx3))) => ((! [Xx3:$i] : (((ccv @ Xx3) = (XA2 @ Xx3)) => ((XB2 @ Xx3) = (XC @ Xx3)))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => (! [Xx3:$i] : ((~ (cwcel @ (XC @ Xx3) @ ccvv)) => ((ccfv @ (XA2 @ Xx3) @ (XF @ Xx3)) = cc0))))))))))))).
