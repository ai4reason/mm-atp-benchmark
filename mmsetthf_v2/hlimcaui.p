...
thf(ahhxmet_ax,axiom,(! [XD:($i > $o)] : (! [XU:($i > $o)] : ((XU = (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((XD = (ccfv @ XU @ ccims)) => (cwcel @ XD @ (ccfv @ cchil @ ccxmt))))))).
...
thf(almcau_ax,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => (cwss @ (ccdm @ (ccfv @ XJ @ cclm)) @ (ccfv @ XD @ ccca)))))))).
...
thf(ahhcau_ax,axiom,(! [XD:($i > $o)] : (! [XU:($i > $o)] : ((XU = (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((XD = (ccfv @ XU @ ccims)) => (cccau = (ccin @ (ccfv @ XD @ ccca) @ (cco @ cchil @ ccn @ ccmap)))))))).
...
thf(chlimcaui_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwbr @ XF @ XA2 @ cchli) => (cwcel @ XF @ cccau))))).
