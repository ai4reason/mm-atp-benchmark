...
thf(acjrebd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => ((ccfv @ XA2 @ cccj) = XA2)) => (Xph => (cwcel @ XA2 @ ccr))))))).
...
thf(ctchcphlem3_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XW @ cctch)) => ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xph => (cwcel @ XW @ ccphl)) => ((Xph => (XF = (cco @ cccnfld @ XK @ ccress))) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((Xph & (cwcel @ XX @ XV)) => (cwcel @ (cco @ XX @ XX @ Xc_xi) @ ccr))))))))))))))))).
