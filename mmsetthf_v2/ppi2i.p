...
thf(appinprm_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (~ (cwcel @ (cco @ XA2 @ cc1 @ ccaddc) @ ccprime))) => ((ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ ccppi) = (ccfv @ XA2 @ ccppi))))).
thf(cppi2i_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XM @ ccn0) => ((XN = (cco @ XM @ cc1 @ ccaddc)) => (((ccfv @ XM @ ccppi) = XK) => ((~ (cwcel @ XN @ ccprime)) => ((ccfv @ XN @ ccppi) = XK))))))))).
