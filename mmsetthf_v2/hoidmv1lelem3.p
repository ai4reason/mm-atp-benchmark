...
thf(amin1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (cwbr @ (ccif @ (cwbr @ XA2 @ XB2 @ ccle) @ XA2 @ XB2) @ XA2 @ ccle))))).
...
thf(ahoidmv1lelem1_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XU:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (XA2 @ Xx3) @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (XB2 @ Xj) @ ccr))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xy1) => (cwbr @ (XA2 @ Xx3) @ (XB2 @ Xj) @ cclt))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xy1) => (cwf @ ccn @ ccr @ (XC @ Xx3 @ Xy1 @ Xj)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xj:$i] : ((Xph @ Xx3 @ Xy1) => (cwf @ ccn @ ccr @ (XD @ Xx3 @ Xy1 @ Xj)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ (XC @ Xx3 @ Xy1 @ Xj)) @ (ccfv @ (ccv @ Xj) @ (XD @ Xx3 @ Xy1 @ Xj)) @ ccico) @ ccvol))) @ ccsumge0) @ ccr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xj:$i] : (XU = (ccrab @ (^ [Xz:$i] : (cwbr @ (cco @ (ccv @ Xz) @ (XA2 @ Xx3) @ ccmin) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ (XC @ Xx3 @ Xy1 @ Xj)) @ (ccif @ (cwbr @ (ccfv @ (ccv @ Xj) @ (XD @ Xx3 @ Xy1 @ Xj)) @ (ccv @ Xz) @ ccle) @ (ccfv @ (ccv @ Xj) @ (XD @ Xx3 @ Xy1 @ Xj)) @ (ccv @ Xz)) @ ccico) @ ccvol))) @ ccsumge0) @ ccle)) @ (^ [Xz:$i] : (cco @ (XA2 @ Xx3) @ (XB2 @ Xj) @ ccicc))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XS @ Xx3 @ Xy1) = (ccsup @ XU @ ccr @ cclt)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cw3a @ (cwcel @ (XS @ Xx3 @ Xy1) @ XU) @ (cwcel @ (XA2 @ Xx3) @ XU) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XU))) @ (^ [Xx3:$i] : ccr)))))))))))))))))))))).
...
thf(ahoidmv1lelem2_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : ((! [Xz:$i] : (! [Xu:$i] : (! [Xj:$i] : ((Xph @ Xz @ Xu) => (cwcel @ (XA2 @ Xu @ Xj) @ ccr))))) => ((! [Xz:$i] : (! [Xu:$i] : (! [Xj:$i] : ((Xph @ Xz @ Xu) => (cwcel @ (XB2 @ Xu @ Xj) @ ccr))))) => ((! [Xz:$i] : (! [Xu:$i] : ((Xph @ Xz @ Xu) => (cwf @ ccn @ ccr @ (XC @ Xu))))) => ((! [Xz:$i] : (! [Xu:$i] : ((Xph @ Xz @ Xu) => (cwf @ ccn @ ccr @ (XD @ Xu))))) => ((! [Xz:$i] : (! [Xu:$i] : ((Xph @ Xz @ Xu) => (cwcel @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ (XC @ Xu)) @ (ccfv @ (ccv @ Xj) @ (XD @ Xu)) @ ccico) @ ccvol))) @ ccsumge0) @ ccr)))) => ((! [Xz:$i] : (! [Xu:$i] : (! [Xj:$i] : ((XU @ Xz @ Xj) = (ccrab @ (^ [Xz:$i] : (cwbr @ (cco @ (ccv @ Xz) @ (XA2 @ Xu @ Xj) @ ccmin) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ (XC @ Xu)) @ (ccif @ (cwbr @ (ccfv @ (ccv @ Xj) @ (XD @ Xu)) @ (ccv @ Xz) @ ccle) @ (ccfv @ (ccv @ Xj) @ (XD @ Xu)) @ (ccv @ Xz)) @ ccico) @ ccvol))) @ ccsumge0) @ ccle)) @ (^ [Xz:$i] : (cco @ (XA2 @ Xu @ Xj) @ (XB2 @ Xu @ Xj) @ ccicc))))))) => ((! [Xz:$i] : (! [Xu:$i] : (! [Xj:$i] : ((Xph @ Xz @ Xu) => (cwcel @ XS @ (XU @ Xz @ Xj)))))) => ((! [Xz:$i] : (! [Xu:$i] : (! [Xj:$i] : ((Xph @ Xz @ Xu) => (cwbr @ (XA2 @ Xu @ Xj) @ XS @ ccle))))) => ((! [Xz:$i] : (! [Xu:$i] : (! [Xj:$i] : ((Xph @ Xz @ Xu) => (cwbr @ XS @ (XB2 @ Xu @ Xj) @ cclt))))) => ((! [Xz:$i] : (! [Xu:$i] : ((Xph @ Xz @ Xu) => (cwcel @ (XK @ Xz @ Xu) @ ccn)))) => ((! [Xz:$i] : (! [Xu:$i] : ((Xph @ Xz @ Xu) => (cwcel @ XS @ (cco @ (ccfv @ (XK @ Xz @ Xu) @ (XC @ Xu)) @ (ccfv @ (XK @ Xz @ Xu) @ (XD @ Xu)) @ ccico))))) => ((! [Xz:$i] : (! [Xu:$i] : (! [Xj:$i] : (XM = (ccif @ (cwbr @ (ccfv @ (XK @ Xz @ Xu) @ (XD @ Xu)) @ (XB2 @ Xu @ Xj) @ ccle) @ (ccfv @ (XK @ Xz @ Xu) @ (XD @ Xu)) @ (XB2 @ Xu @ Xj)))))) => (! [Xz:$i] : (! [Xu:$i] : (! [Xj:$i] : ((Xph @ Xz @ Xu) => (cwrex @ (^ [Xu:$i] : (cwbr @ XS @ (ccv @ Xu) @ cclt)) @ (^ [Xu:$i] : (XU @ Xz @ Xj))))))))))))))))))))))))))))).
...
thf(choidmv1lelem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwf @ ccn @ ccr @ XC)) => ((Xph => (cwf @ ccn @ ccr @ XD)) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccico) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (cco @ (ccfv @ (ccv @ Xj) @ XC) @ (ccfv @ (ccv @ Xj) @ XD) @ ccico))))) => ((Xph => (cwcel @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ XC) @ (ccfv @ (ccv @ Xj) @ XD) @ ccico) @ ccvol))) @ ccsumge0) @ ccr)) => ((XU = (ccrab @ (^ [Xz:$i] : (cwbr @ (cco @ (ccv @ Xz) @ XA2 @ ccmin) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ XC) @ (ccif @ (cwbr @ (ccfv @ (ccv @ Xj) @ XD) @ (ccv @ Xz) @ ccle) @ (ccfv @ (ccv @ Xj) @ XD) @ (ccv @ Xz)) @ ccico) @ ccvol))) @ ccsumge0) @ ccle)) @ (^ [Xz:$i] : (cco @ XA2 @ XB2 @ ccicc)))) => ((XS = (ccsup @ XU @ ccr @ cclt)) => (Xph => (cwbr @ (cco @ XB2 @ XA2 @ ccmin) @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xj) @ XC) @ (ccfv @ (ccv @ Xj) @ XD) @ ccico) @ ccvol))) @ ccsumge0) @ ccle))))))))))))))))))).
