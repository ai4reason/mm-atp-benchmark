...
thf(anmbdoplb_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XT @ ccbo) & (cwcel @ XA2 @ cchil)) => (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ ccno) @ (cco @ (ccfv @ XT @ ccnop) @ (ccfv @ XA2 @ ccno) @ ccmul) @ ccle))))).
...
thf(ahoif_ax,axiom,(cwf1o @ cchil @ cchil @ cchio)).
...
thf(ahoival_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((ccfv @ XA2 @ cchio) = XA2)))).
...
thf(cleopnmid_conj,conjecture,(! [XT:($i > $o)] : (((cwcel @ XT @ ccho) & (cwcel @ (ccfv @ XT @ ccnop) @ ccr)) => (cwbr @ XT @ (cco @ (ccfv @ XT @ ccnop) @ cchio @ cchot) @ ccleo)))).
