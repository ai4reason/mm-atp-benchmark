...
thf(accatfv0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV)) @ (cwbr @ ccc0 @ (ccfv @ XA2 @ cchash) @ cclt)) => ((ccfv @ ccc0 @ (cco @ XA2 @ XB2 @ ccconcat)) = (ccfv @ ccc0 @ XA2))))))).
...
thf(accatval1lsw_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccword @ XV)) @ (cwcel @ XB2 @ (ccword @ XV)) @ (cwne @ XA2 @ cc0)) => ((ccfv @ (cco @ (ccfv @ XA2 @ cchash) @ cc1 @ ccmin) @ (cco @ XA2 @ XB2 @ ccconcat)) = (ccfv @ XA2 @ cclsw))))))).
thf(cnumclwwlk2lem1lem_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XX @ (ccfv @ XG @ ccvtx)) @ (cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) @ (cwne @ (ccfv @ XW @ cclsw) @ (ccfv @ ccc0 @ XW))) => (((ccfv @ ccc0 @ (cco @ XW @ (ccs1 @ XX) @ ccconcat)) = (ccfv @ ccc0 @ XW)) & (cwne @ (ccfv @ XN @ (cco @ XW @ (ccs1 @ XX) @ ccconcat)) @ (ccfv @ ccc0 @ XW))))))))).
