...
thf(admcnvcnv_ax,axiom,(! [XA2:($i > $o)] : ((ccdm @ (cccnv @ (cccnv @ XA2))) = (ccdm @ XA2)))).
...
thf(cf1cnvcnv_conj,conjecture,(! [XA2:($i > $o)] : ((cwf1 @ (ccdm @ XA2) @ ccvv @ (cccnv @ (cccnv @ XA2))) <=> ((cwfun @ (cccnv @ XA2)) & (cwfun @ (cccnv @ (cccnv @ XA2))))))).
