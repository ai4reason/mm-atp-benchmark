...
thf(cesummulc2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((Xph => (cwcel @ XC @ (cco @ ccc0 @ ccpnf @ ccico))) => (Xph => ((cco @ XC @ (ccesum @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccxmu) = (ccesum @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (cco @ XC @ (XB2 @ Xk) @ ccxmu)))))))))))))).
