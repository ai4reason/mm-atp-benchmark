...
thf(ccsboprabg_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ (XA2 @ Xx3) @ (XV @ Xx3)) => ((ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (ccoprab @ (^ [Xy1:$i] : (^ [Xz:$i] : (^ [Xd:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xd))))))) = (ccoprab @ (^ [Xy1:$i] : (^ [Xz:$i] : (^ [Xd:$i] : (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xd)) @ (XA2 @ Xx3))))))))))))).
