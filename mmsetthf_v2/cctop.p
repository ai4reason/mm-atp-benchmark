...
thf(auni0c_ax,axiom,(! [XA2:($i > $o)] : (((ccuni @ XA2) = cc0) <=> (cwral @ (^ [Xx3:$i] : ((ccv @ Xx3) = cc0)) @ (^ [Xx3:$i] : XA2))))).
...
thf(accase2_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (((Xph & Xps) => Xta) => ((Xch => Xta) => ((Xth => Xta) => (((Xph | Xch) & (Xps | Xth)) => Xta)))))))))).
...
thf(ccctop_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => (cwcel @ (ccrab @ (^ [Xx3:$i] : ((cwbr @ (ccdif @ XA2 @ (ccv @ Xx3)) @ ccom @ ccdom) | ((ccv @ Xx3) = cc0))) @ (^ [Xx3:$i] : (ccpw @ XA2))) @ (ccfv @ XA2 @ cctopon))))))).
