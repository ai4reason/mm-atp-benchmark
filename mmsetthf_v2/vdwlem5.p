...
thf(avdwapid1_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccn) @ (cwcel @ XA2 @ ccn) @ (cwcel @ XD @ ccn)) => (cwcel @ XA2 @ (cco @ XA2 @ XD @ (ccfv @ XK @ ccvdwa)))))))).
