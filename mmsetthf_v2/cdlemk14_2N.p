...
thf(acdlemk14_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [Xc_or:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > ($i > $o))] : (! [Xc_an:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : ((! [Xf1:$i] : (! [Xi:$i] : ((XB2 @ Xf1 @ Xi) = (ccfv @ (XK @ Xf1) @ ccbs)))) => ((! [Xf1:$i] : ((Xc_le @ Xf1) = (ccfv @ (XK @ Xf1) @ ccple))) => ((! [Xf1:$i] : (Xc_or = (ccfv @ (XK @ Xf1) @ ccjn))) => ((! [Xf1:$i] : (Xc_an = (ccfv @ (XK @ Xf1) @ ccmee))) => ((! [Xf1:$i] : ((XA2 @ Xf1) = (ccfv @ (XK @ Xf1) @ ccatm))) => ((! [Xf1:$i] : ((XH @ Xf1) = (ccfv @ (XK @ Xf1) @ cclh))) => ((! [Xf1:$i] : (XT = (ccfv @ XW @ (ccfv @ (XK @ Xf1) @ ccltrn)))) => ((! [Xf1:$i] : (XR = (ccfv @ XW @ (ccfv @ (XK @ Xf1) @ cctrl)))) => ((! [Xf1:$i] : (! [Xi:$i] : ((XS @ Xf1 @ Xi) = (ccmpt @ (^ [Xf1:$i] : XT) @ (^ [Xf1:$i] : (ccrio @ (^ [Xi:$i] : ((ccfv @ XP @ (ccv @ Xi)) = (cco @ (cco @ XP @ (ccfv @ (ccv @ Xf1) @ XR) @ Xc_or) @ (cco @ (ccfv @ XP @ XN) @ (ccfv @ (cccom @ (ccv @ Xf1) @ (cccnv @ XF)) @ XR) @ Xc_or) @ Xc_an))) @ (^ [Xi:$i] : XT))))))) => ((! [Xf1:$i] : (! [Xi:$i] : ((XO @ Xf1 @ Xi) = (ccfv @ XD @ (XS @ Xf1 @ Xi))))) => (! [Xf1:$i] : (! [Xi:$i] : ((cw3a @ (cw3a @ ((cwcel @ (XK @ Xf1) @ cchlt) & (cwcel @ XW @ (XH @ Xf1))) @ (cwcel @ XF @ XT) @ (cwcel @ XD @ XT)) @ (cw3a @ (cwcel @ XN @ XT) @ ((cwcel @ XP @ (XA2 @ Xf1)) & (~ (cwbr @ XP @ XW @ (Xc_le @ Xf1)))) @ ((ccfv @ XF @ XR) = (ccfv @ XN @ XR))) @ (cw3a @ (cwne @ XF @ (ccres @ ccid @ (XB2 @ Xf1 @ Xi))) @ (cwne @ XD @ (ccres @ ccid @ (XB2 @ Xf1 @ Xi))) @ (cwne @ (ccfv @ XD @ XR) @ (ccfv @ XF @ XR)))) => (cwbr @ (ccfv @ XP @ XN) @ (cco @ (ccfv @ XP @ (XO @ Xf1 @ Xi)) @ (ccfv @ (cccom @ XF @ (cccnv @ XD)) @ XR) @ Xc_or) @ (Xc_le @ Xf1)))))))))))))))))))))))))))))))).
thf(ccdlemk14_2N_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [Xc_or:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > ($i > $o))] : (! [Xc_an:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((! [Xf1:$i] : (! [Xi:$i] : ((XB2 @ Xf1 @ Xi) = (ccfv @ (XK @ Xf1) @ ccbs)))) => ((! [Xf1:$i] : ((Xc_le @ Xf1) = (ccfv @ (XK @ Xf1) @ ccple))) => ((! [Xf1:$i] : (Xc_or = (ccfv @ (XK @ Xf1) @ ccjn))) => ((! [Xf1:$i] : (Xc_an = (ccfv @ (XK @ Xf1) @ ccmee))) => ((! [Xf1:$i] : ((XA2 @ Xf1) = (ccfv @ (XK @ Xf1) @ ccatm))) => ((! [Xf1:$i] : ((XH @ Xf1) = (ccfv @ (XK @ Xf1) @ cclh))) => ((! [Xf1:$i] : (XT = (ccfv @ XW @ (ccfv @ (XK @ Xf1) @ ccltrn)))) => ((! [Xf1:$i] : (XR = (ccfv @ XW @ (ccfv @ (XK @ Xf1) @ cctrl)))) => ((! [Xf1:$i] : (! [Xi:$i] : ((XS @ Xf1 @ Xi) = (ccmpt @ (^ [Xf1:$i] : XT) @ (^ [Xf1:$i] : (ccrio @ (^ [Xi:$i] : ((ccfv @ XP @ (ccv @ Xi)) = (cco @ (cco @ XP @ (ccfv @ (ccv @ Xf1) @ XR) @ Xc_or) @ (cco @ (ccfv @ XP @ XN) @ (ccfv @ (cccom @ (ccv @ Xf1) @ (cccnv @ XF)) @ XR) @ Xc_or) @ Xc_an))) @ (^ [Xi:$i] : XT))))))) => ((! [Xf1:$i] : (! [Xi:$i] : ((XQ @ Xf1 @ Xi) = (ccfv @ XC @ (XS @ Xf1 @ Xi))))) => (! [Xf1:$i] : (! [Xi:$i] : ((cw3a @ (cw3a @ (cwcel @ (XK @ Xf1) @ cchlt) @ (cwcel @ XW @ (XH @ Xf1)) @ ((ccfv @ XF @ XR) = (ccfv @ XN @ XR))) @ (cw3a @ (cwcel @ XF @ XT) @ (cwcel @ XC @ XT) @ (cwcel @ XN @ XT)) @ (cw3a @ (cwne @ (ccfv @ XC @ XR) @ (ccfv @ XF @ XR)) @ ((cwne @ XF @ (ccres @ ccid @ (XB2 @ Xf1 @ Xi))) & (cwne @ XC @ (ccres @ ccid @ (XB2 @ Xf1 @ Xi)))) @ ((cwcel @ XP @ (XA2 @ Xf1)) & (~ (cwbr @ XP @ XW @ (Xc_le @ Xf1)))))) => (cwbr @ (ccfv @ XP @ XN) @ (cco @ (ccfv @ XP @ (XQ @ Xf1 @ Xi)) @ (ccfv @ (cccom @ XF @ (cccnv @ XC)) @ XR) @ Xc_or) @ (Xc_le @ Xf1)))))))))))))))))))))))))))))))).
