...
thf(adf_sgm_ax,axiom,(ccsgm = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xn:$i] : ccc)) @ (^ [Xx3:$i] : (^ [Xn:$i] : ccn)) @ (^ [Xx3:$i] : (^ [Xn:$i] : (ccsu @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xp:$i] : ccn)) @ (^ [Xk:$i] : (cco @ (ccv @ Xk) @ (ccv @ Xx3) @ cccxp)))))))).
...
thf(csgmval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccn)) => ((cco @ XA2 @ XB2 @ ccsgm) = (ccsu @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XB2 @ ccdvds)) @ (^ [Xp:$i] : ccn)) @ (^ [Xk:$i] : (cco @ (ccv @ Xk) @ XA2 @ cccxp)))))))).
