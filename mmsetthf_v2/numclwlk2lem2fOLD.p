...
thf(awwlksubclwwlk_ax,axiom,(! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XM @ ccn) & (cwcel @ XN @ (ccfv @ (cco @ XM @ cc1 @ ccaddc) @ ccuz))) => ((cwcel @ XX @ (cco @ XN @ XG @ ccclwwlkn)) => (cwcel @ (cco @ XX @ (ccop @ ccc0 @ XM) @ ccsubstr) @ (cco @ (cco @ XM @ cc1 @ ccmin) @ XG @ ccwwlksn))))))))).
...
thf(aelfzp1b_ax,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ ccz) & (cwcel @ XN @ ccz)) => ((cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz)) <=> (cwcel @ (cco @ XK @ cc1 @ ccaddc) @ (cco @ cc1 @ XN @ ccfz))))))).
