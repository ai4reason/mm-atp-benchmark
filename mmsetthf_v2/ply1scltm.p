...
thf(cply1scltm_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XK = (ccfv @ XR @ ccbs)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_x = (ccfv @ XP @ ccvsca)) => ((XN = (ccfv @ XP @ ccmgp)) => ((Xc_ex = (ccfv @ XN @ ccmg)) => ((XA2 = (ccfv @ XP @ ccascl)) => (((cwcel @ XR @ ccrg) & (cwcel @ XF @ XK)) => ((ccfv @ XF @ XA2) = (cco @ XF @ (cco @ ccc0 @ XX @ Xc_ex) @ Xc_x)))))))))))))))))))).
