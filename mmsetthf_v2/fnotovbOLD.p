...
thf(cfnotovbOLD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwfn @ XF @ (ccxp @ XA2 @ XB2)) @ (cwcel @ XC @ XA2) @ (cwcel @ XD @ XB2)) => (((cco @ XC @ XD @ XF) = XR) <=> (cwcel @ (ccotp @ XC @ XD @ XR) @ XF)))))))))).
