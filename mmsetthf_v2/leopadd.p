...
thf(aleoppos_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ ccho) => ((cwbr @ cch0o @ XT @ ccleo) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ ccc0 @ (cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xx3) @ ccsp) @ ccle)) @ (^ [Xx3:$i] : cchil)))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(ahmops_ax,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (((cwcel @ XT @ ccho) & (cwcel @ XU @ ccho)) => (cwcel @ (cco @ XT @ XU @ cchos) @ ccho))))).
thf(cleopadd_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : ((((cwcel @ XT @ ccho) & (cwcel @ XU @ ccho)) & ((cwbr @ cch0o @ XT @ ccleo) & (cwbr @ cch0o @ XU @ ccleo))) => (cwbr @ cch0o @ (cco @ XT @ XU @ cchos) @ ccleo))))).
