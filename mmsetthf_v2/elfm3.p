...
thf(celfm3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XL = (cco @ XY @ XB2 @ ccfg)) => (((cwcel @ XB2 @ (ccfv @ XY @ ccfbas)) & (cwfo @ XY @ XX @ XF)) => ((cwcel @ XA2 @ (ccfv @ XB2 @ (cco @ XX @ XF @ ccfm))) <=> (cwrex @ (^ [Xx3:$i] : (XA2 = (ccima @ XF @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XL)))))))))))).
