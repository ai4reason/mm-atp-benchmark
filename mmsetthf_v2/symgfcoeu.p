...
thf(csymgfcoeu_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XG = (ccfv @ (ccfv @ XD @ ccsymg) @ ccbs)) => ((cw3a @ (cwcel @ XD @ XV) @ (cwcel @ XP @ XG) @ (cwcel @ XQ @ XG)) => (cwreu @ (^ [Xp:$i] : (XQ = (cccom @ XP @ (ccv @ Xp)))) @ (^ [Xp:$i] : XG)))))))))).
