...
thf(clediv12a_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ XA2 @ XB2 @ ccle))) & (((cwcel @ XC @ ccr) & (cwcel @ XD @ ccr)) & ((cwbr @ ccc0 @ XC @ cclt) & (cwbr @ XC @ XD @ ccle)))) => (cwbr @ (cco @ XA2 @ XD @ ccdiv) @ (cco @ XB2 @ XC @ ccdiv) @ ccle))))))).
