...
thf(ainfpn_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => (cwrex @ (^ [Xj:$i] : ((cwbr @ XN @ (ccv @ Xj) @ cclt) & (cwral @ (^ [Xk:$i] : ((cwcel @ (cco @ (ccv @ Xj) @ (ccv @ Xk) @ ccdiv) @ ccn) => (((ccv @ Xk) = cc1) | ((ccv @ Xk) = (ccv @ Xj))))) @ (^ [Xk:$i] : ccn)))) @ (^ [Xj:$i] : ccn))))).
...
thf(aunben_ax,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccn) & (cwral @ (^ [Xm:$i] : (cwrex @ (^ [Xn:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xn) @ cclt)) @ (^ [Xn:$i] : XA2))) @ (^ [Xm:$i] : ccn))) => (cwbr @ XA2 @ ccn @ ccen)))).
thf(cinfpn2_conj,conjecture,(! [XS:($i > ($i > ($i > $o)))] : ((! [Xm:$i] : (! [Xn:$i] : ((XS @ Xm @ Xn) = (ccrab @ (^ [Xn:$i] : ((cwbr @ cc1 @ (ccv @ Xn) @ cclt) & (cwral @ (^ [Xm:$i] : ((cwcel @ (cco @ (ccv @ Xn) @ (ccv @ Xm) @ ccdiv) @ ccn) => (((ccv @ Xm) = cc1) | ((ccv @ Xm) = (ccv @ Xn))))) @ (^ [Xm:$i] : ccn)))) @ (^ [Xn:$i] : ccn))))) => (! [Xm:$i] : (! [Xn:$i] : (cwbr @ (XS @ Xm @ Xn) @ ccn @ ccen)))))).
