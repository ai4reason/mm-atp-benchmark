...
thf(anfpw_ax,axiom,(! [XA2:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (cwnfc @ (^ [Xx3:$i] : (ccpw @ (XA2 @ Xx3))))))).
...
thf(afge0iccico_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((Xph => (~ (cwcel @ ccpnf @ (ccrn @ XF)))) => (Xph => (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)))))))).
...
thf(asge0rern_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((Xph => (cwcel @ (ccfv @ XF @ ccsumge0) @ ccr)) => (Xph => (~ (cwcel @ ccpnf @ (ccrn @ XF)))))))))))).
...
thf(afsumiunss_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ (XV @ Xk))))) => ((Xph => (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) => ((! [Xx3:$i] : (! [Xk:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xk) @ (XB2 @ Xx3))) => (cwcel @ (XC @ Xk) @ ccc)))) => ((Xph => (cwcel @ XD @ ccfn)) => (Xph => ((ccsu @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccin @ (XB2 @ Xx3) @ XD))) @ (^ [Xk:$i] : (XC @ Xk))) = (ccsu @ (ccrab @ (^ [Xx3:$i] : (cwne @ (ccin @ (XB2 @ Xx3) @ XD) @ cc0)) @ (^ [Xx3:$i] : XA2)) @ (^ [Xx3:$i] : (ccsu @ (ccin @ (XB2 @ Xx3) @ XD) @ (^ [Xk:$i] : (XC @ Xk)))))))))))))))))).
...
thf(adisjinfi_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ XV))) => ((Xph => (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) => ((Xph => (cwcel @ XC @ ccfn)) => (Xph => (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwne @ (ccin @ (XB2 @ Xx3) @ XC) @ cc0)) @ (^ [Xx3:$i] : XA2)) @ ccfn))))))))))).
thf(afsumge0cl_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccico)))) => (Xph => (cwcel @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) @ (cco @ ccc0 @ ccpnf @ ccico))))))))).
...
thf(anfsum_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xk)))) => ((! [Xk:$i] : (cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xk)))) => (! [Xk:$i] : (cwnfc @ (^ [Xx3:$i] : (ccsu @ (XA2 @ Xx3 @ Xk) @ (^ [Xk:$i] : (XB2 @ Xx3 @ Xk))))))))))).
thf(aineq1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((ccin @ XA2 @ XC) = (ccin @ XB2 @ XC))))))))).
thf(acbvsum_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xj) = (ccv @ Xk)) => ((XB2 @ Xj @ Xk) = (XC @ Xj @ Xk))))) => ((! [Xj:$i] : (cwnfc @ (^ [Xk:$i] : (XA2 @ Xj @ Xk)))) => ((! [Xk:$i] : (cwnfc @ (^ [Xj:$i] : (XA2 @ Xj @ Xk)))) => ((! [Xj:$i] : (cwnfc @ (^ [Xk:$i] : (XB2 @ Xj @ Xk)))) => ((! [Xk:$i] : (cwnfc @ (^ [Xj:$i] : (XC @ Xj @ Xk)))) => (! [Xj:$i] : (! [Xk:$i] : ((ccsu @ (XA2 @ Xj @ Xk) @ (^ [Xj:$i] : (XB2 @ Xj @ Xk))) = (ccsu @ (XA2 @ Xj @ Xk) @ (^ [Xk:$i] : (XC @ Xj @ Xk))))))))))))))).
...
thf(asge0lefi_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (Xph => (cwcel @ XX @ (XV @ Xx3)))) => ((Xph => (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((Xph => (cwcel @ XA2 @ ccxr)) => (Xph => ((cwbr @ (ccfv @ XF @ ccsumge0) @ XA2 @ ccle) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccres @ XF @ (ccv @ Xx3)) @ ccsumge0) @ XA2 @ ccle)) @ (^ [Xx3:$i] : (ccin @ (ccpw @ XX) @ ccfn)))))))))))))).
...
thf(asge0ge0_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwf @ XX @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => (Xph => (cwbr @ ccc0 @ (ccfv @ XF @ ccsumge0) @ ccle))))))))).
thf(ccltrr_tp,type,(ccltrr : ($i > $o))).
thf(altpnf_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwbr @ XA2 @ ccpnf @ cclt)))).
thf(asge0gerpmpt_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XC @ Xx3) @ ccxr))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xy1) @ ccrp)) => (cwrex @ (^ [Xz:$i] : (cwbr @ (XC @ Xx3) @ (cco @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : (ccv @ Xz)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccsumge0) @ (ccv @ Xy1) @ ccxad) @ ccle)) @ (^ [Xz:$i] : (ccin @ (ccpw @ XA2) @ ccfn)))))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwbr @ (XC @ Xx3) @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccsumge0) @ ccle)))))))))))))).
...
thf(asge0ssrempt_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccsumge0) @ ccr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XC @ XA2))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccsumge0) @ ccr)))))))))))))).
