...
thf(agcdadd_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ XM @ XN @ ccgcd) = (cco @ XM @ (cco @ XN @ XM @ ccaddc) @ ccgcd)))))).
...
thf(cpythagtriplem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccn)) @ ((cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) = (cco @ XC @ cc2 @ ccexp)) @ (((cco @ XA2 @ XB2 @ ccgcd) = cc1) & (~ (cwbr @ cc2 @ XA2 @ ccdvds)))) => ((cco @ XB2 @ XC @ ccgcd) = cc1)))))).
