...
thf(astrfvnd_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XE = (ccslot @ XN)) => ((Xph => (cwcel @ XS @ XV)) => (Xph => ((ccfv @ XS @ XE) = (ccfv @ XN @ XS))))))))))).
thf(andxid_ax,axiom,(! [XE:($i > $o)] : (! [XN:($i > $o)] : ((XE = (ccslot @ XN)) => ((cwcel @ XN @ ccn) => (XE = (ccslot @ (ccfv @ ccnx @ XE)))))))).
thf(asyl2anc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xph => Xch) => (((Xps & Xch) => Xth) => (Xph => Xth))))))))).
thf(cwfn_tp,type,(cwfn : (($i > $o) > (($i > $o) > $o)))).
thf(cwrel_tp,type,(cwrel : (($i > $o) > $o))).
thf(afunresdfunsn_ax,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwfun @ XF) & (cwcel @ XX @ (ccdm @ XF))) => ((ccun @ (ccres @ XF @ (ccdif @ ccvv @ (ccsn @ XX))) @ (ccsn @ (ccop @ XX @ (ccfv @ XX @ XF)))) = XF))))).
thf(csetsidvald_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XE = (ccslot @ XN)) => ((cwcel @ XN @ ccn) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwfun @ XS)) => ((Xph => (cwcel @ (ccfv @ ccnx @ XE) @ (ccdm @ XS))) => (Xph => (XS = (cco @ XS @ (ccop @ (ccfv @ ccnx @ XE) @ (ccfv @ XS @ XE)) @ ccsts)))))))))))))).
