...
thf(adf_op_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccop @ XA2 @ XB2) = (ccab @ (^ [Xx3:$i] : (cw3a @ (cwcel @ XA2 @ ccvv) @ (cwcel @ XB2 @ ccvv) @ (cwcel @ (ccv @ Xx3) @ (ccpr @ (ccsn @ XA2) @ (ccpr @ XA2 @ XB2)))))))))).
...
thf(cdfopif_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccop @ XA2 @ XB2) = (ccif @ ((cwcel @ XA2 @ ccvv) & (cwcel @ XB2 @ ccvv)) @ (ccpr @ (ccsn @ XA2) @ (ccpr @ XA2 @ XB2)) @ cc0))))).
