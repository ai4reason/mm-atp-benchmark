...
thf(aharn0_ax,axiom,(! [XS:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XS @ XV) => (cwne @ (ccfv @ XS @ cchar) @ cc0))))).
...
thf(aisnumbasgrplem3_ax,axiom,(! [XS:($i > $o)] : (((cwcel @ XS @ (ccdm @ cccrd)) & (cwne @ XS @ cc0)) => (cwcel @ XS @ (ccima @ ccbs @ ccabl))))).
...
thf(aisnumbasgrplem2_ax,axiom,(! [XS:($i > $o)] : ((cwcel @ (ccun @ XS @ (ccfv @ XS @ cchar)) @ (ccima @ ccbs @ ccgrp)) => (cwcel @ XS @ (ccdm @ cccrd))))).
thf(cisnumbasabl_conj,conjecture,(! [XS:($i > $o)] : ((cwcel @ XS @ (ccdm @ cccrd)) <=> (cwcel @ (ccun @ XS @ (ccfv @ XS @ cchar)) @ (ccima @ ccbs @ ccabl))))).
