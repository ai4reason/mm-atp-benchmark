...
thf(cnosupbnd2lem1_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : (! [Xy1:$i] : ((cw3a @ ((cwcel @ (XU @ Xy1) @ (XA2 @ Xy1)) & (cwral @ (^ [Xy1:$i] : (~ (cwbr @ (XU @ Xy1) @ (ccv @ Xy1) @ ccslt))) @ (^ [Xy1:$i] : (XA2 @ Xy1)))) @ (cw3a @ (cwss @ (XA2 @ Xy1) @ ccsur) @ (cwcel @ (XA2 @ Xy1) @ ccvv) @ (cwcel @ (XZ @ Xy1) @ ccsur)) @ (cwral @ (^ [Xa:$i] : (cwbr @ (ccv @ Xa) @ (XZ @ Xy1) @ ccslt)) @ (^ [Xa:$i] : (XA2 @ Xy1)))) => (~ (cwbr @ (ccres @ (XZ @ Xy1) @ (ccsuc @ (ccdm @ (XU @ Xy1)))) @ (ccun @ (XU @ Xy1) @ (ccsn @ (ccop @ (ccdm @ (XU @ Xy1)) @ cc2o))) @ ccslt)))))))).
