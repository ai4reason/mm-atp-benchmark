...
thf(aselberg2b_ax,axiom,(cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (cco @ (cco @ (cco @ (cco @ (ccfv @ (ccv @ Xx3) @ ccchp) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ ccchp) @ ccmul))) @ ccaddc) @ (ccv @ Xx3) @ ccdiv) @ (cco @ cc2 @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ ccmin) @ ccabs) @ (ccv @ Xc) @ ccle)) @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccico)))) @ (^ [Xc:$i] : ccrp))).
