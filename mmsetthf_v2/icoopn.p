...
thf(cicoopn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XC @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((XK = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((XJ = (cco @ XK @ (cco @ XA2 @ XB2 @ ccico) @ ccrest)) => ((Xph => (cwbr @ XC @ XB2 @ ccle)) => (Xph => (cwcel @ (cco @ XA2 @ XC @ ccico) @ XJ))))))))))))))).
