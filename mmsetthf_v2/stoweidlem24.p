...
thf(astoweidlem10_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XN @ ccn0) @ (cwbr @ XA2 @ cc1 @ ccle)) => (cwbr @ (cco @ cc1 @ (cco @ XN @ XA2 @ ccmul) @ ccmin) @ (cco @ (cco @ cc1 @ XA2 @ ccmin) @ XN @ ccexp) @ ccle))))).
