...
thf(abj_rexcom4a_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : ((? [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((Xph @ Xy1) & (Xps @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (XA2 @ Xy1)))) <=> (cwrex @ (^ [Xy1:$i] : ((Xph @ Xy1) & (? [Xx3:$i] : (Xps @ Xx3 @ Xy1)))) @ (^ [Xy1:$i] : (XA2 @ Xy1)))))))).
...
thf(abj_isseti_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (cwcel @ XA2 @ (XV @ Xx3))) => (? [Xx3:$i] : ((ccv @ Xx3) = XA2)))))).
