...
thf(aequtr_ax,axiom,(! [Xz:$i] : (! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => (((ccv @ Xy1) = (ccv @ Xz)) => ((ccv @ Xx3) = (ccv @ Xz)))))))).
...
thf(cax_sep_conj,conjecture,(! [Xph:($i > $o)] : (! [Xz:$i] : (? [Xy1:$i] : (! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) <=> ((cwcel @ (ccv @ Xx3) @ (ccv @ Xz)) & (Xph @ Xx3)))))))).
