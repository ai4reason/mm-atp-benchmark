...
thf(colm12_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((Xc_1 = (ccfv @ XK @ ccp1)) => (((cwcel @ XK @ ccol) & (cwcel @ XX @ XB2)) => ((cco @ Xc_1 @ XX @ Xc_an) = XX))))))))))).
