...
thf(assblex_ax,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XP @ XX)) & ((cwcel @ XR @ ccrp) & (cwcel @ XS @ ccrp))) => (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ XR @ cclt) & (cwss @ (cco @ XP @ (ccv @ Xx3) @ (ccfv @ XD @ ccbl)) @ (cco @ XP @ XS @ (ccfv @ XD @ ccbl))))) @ (^ [Xx3:$i] : ccrp))))))))).
...
thf(cmopni3_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => (((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XA2 @ XJ) @ (cwcel @ XP @ XA2)) & (cwcel @ XR @ ccrp)) => (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ XR @ cclt) & (cwss @ (cco @ XP @ (ccv @ Xx3) @ (ccfv @ XD @ ccbl)) @ XA2))) @ (^ [Xx3:$i] : ccrp))))))))))).
