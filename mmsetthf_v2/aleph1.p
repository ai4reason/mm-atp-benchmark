...
thf(aalephsucpw_ax,axiom,(! [XA2:($i > $o)] : (cwbr @ (ccfv @ (ccsuc @ XA2) @ ccale) @ (ccpw @ (ccfv @ XA2 @ ccale)) @ ccdom))).
...
thf(caleph1_conj,conjecture,(cwbr @ (ccfv @ cc1o @ ccale) @ (cco @ cc2o @ (ccfv @ cc0 @ ccale) @ ccmap) @ ccdom)).
