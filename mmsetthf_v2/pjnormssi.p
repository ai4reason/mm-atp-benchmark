...
thf(apjssmi_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => ((cwss @ XH @ XG) => ((cco @ (ccfv @ XA2 @ (ccfv @ XG @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccmv) = (ccfv @ XA2 @ (ccfv @ (ccin @ XG @ (ccfv @ XH @ ccort)) @ ccpjh))))))))))).
thf(apjssge0i_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => (((cco @ (ccfv @ XA2 @ (ccfv @ XG @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccmv) = (ccfv @ XA2 @ (ccfv @ (ccin @ XG @ (ccfv @ XH @ ccort)) @ ccpjh))) => (cwbr @ ccc0 @ (cco @ (cco @ (ccfv @ XA2 @ (ccfv @ XG @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccmv) @ XA2 @ ccsp) @ ccle))))))))).
thf(apjdifnormi_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => ((cwcel @ XA2 @ cchil) => ((cwbr @ ccc0 @ (cco @ (cco @ (ccfv @ XA2 @ (ccfv @ XG @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccmv) @ XA2 @ ccsp) @ ccle) <=> (cwbr @ (ccfv @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccno) @ (ccfv @ (ccfv @ XA2 @ (ccfv @ XG @ ccpjh)) @ ccno) @ ccle))))))))).
...
thf(aanabsi6_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => ((Xps & Xph) => Xch)) => ((Xph & Xps) => Xch)))))).
thf(asylan2i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xth) => ((Xps => ((Xch & Xth) => Xta)) => (Xps => ((Xch & Xph) => Xta)))))))))).
...
thf(apjoc2_ax,axiom,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : (((cwcel @ XH @ ccch) & (cwcel @ XA2 @ cchil)) => ((cwcel @ XA2 @ (ccfv @ XH @ ccort)) <=> ((ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) = cc0v)))))).
...
thf(achsscon3i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwss @ XA2 @ XB2) <=> (cwss @ (ccfv @ XB2 @ ccort) @ (ccfv @ XA2 @ ccort)))))))).
thf(cpjnormssi_conj,conjecture,(! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => ((cwss @ XG @ XH) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XG @ ccpjh)) @ ccno) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XH @ ccpjh)) @ ccno) @ ccle)) @ (^ [Xx3:$i] : cchil)))))))).
