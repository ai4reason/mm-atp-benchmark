...
thf(axrlttri2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwne @ XA2 @ XB2) <=> ((cwbr @ XA2 @ XB2 @ cclt) | (cwbr @ XB2 @ XA2 @ cclt))))))).
...
thf(aqextltlem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwbr @ XA2 @ XB2 @ cclt) => (cwrex @ (^ [Xx3:$i] : ((~ ((cwbr @ (ccv @ Xx3) @ XA2 @ cclt) <=> (cwbr @ (ccv @ Xx3) @ XB2 @ cclt))) & (~ ((cwbr @ (ccv @ Xx3) @ XA2 @ ccle) <=> (cwbr @ (ccv @ Xx3) @ XB2 @ ccle))))) @ (^ [Xx3:$i] : ccq))))))).
...
thf(cqextlt_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((XA2 = XB2) <=> (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ XA2 @ cclt) <=> (cwbr @ (ccv @ Xx3) @ XB2 @ cclt))) @ (^ [Xx3:$i] : ccq))))))).
