...
thf(aexpp1z_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwcel @ XN @ ccz)) => ((cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) = (cco @ (cco @ XA2 @ XN @ ccexp) @ XA2 @ ccmul)))))).
...
thf(cdpexpp1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccrp) => (((cco @ XP @ cc1 @ ccaddc) = XQ) => ((cwcel @ XP @ ccz) => ((cwcel @ XQ @ ccz) => ((cco @ (cco @ XA2 @ XB2 @ ccdp) @ (cco @ (ccdc @ cc1 @ ccc0) @ XP @ ccexp) @ ccmul) = (cco @ (cco @ ccc0 @ (ccdp2 @ XA2 @ XB2) @ ccdp) @ (cco @ (ccdc @ cc1 @ ccc0) @ XQ @ ccexp) @ ccmul)))))))))))).
