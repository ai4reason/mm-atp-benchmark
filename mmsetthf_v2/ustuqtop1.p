...
thf(custuqtop1_conj,conjecture,(! [XU:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xv:$i] : ((XN @ Xv) = (ccmpt @ (^ [Xp:$i] : XX) @ (^ [Xp:$i] : (ccrn @ (ccmpt @ (^ [Xv:$i] : XU) @ (^ [Xv:$i] : (ccima @ (ccv @ Xv) @ (ccsn @ (ccv @ Xp)))))))))) => (! [Xv:$i] : (! [Xp:$i] : (! [Xa:$i] : (! [Xb:$i] : (((cw3a @ ((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ (ccv @ Xp) @ XX)) @ (cwss @ (ccv @ Xa) @ (ccv @ Xb)) @ (cwss @ (ccv @ Xb) @ XX)) & (cwcel @ (ccv @ Xa) @ (ccfv @ (ccv @ Xp) @ (XN @ Xv)))) => (cwcel @ (ccv @ Xb) @ (ccfv @ (ccv @ Xp) @ (XN @ Xv))))))))))))).
