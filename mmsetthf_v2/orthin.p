...
thf(ashincl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccsh) & (cwcel @ XB2 @ ccsh)) => (cwcel @ (ccin @ XA2 @ XB2) @ ccsh))))).
...
thf(corthin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccsh) & (cwcel @ XB2 @ ccsh)) => ((cwss @ XA2 @ (ccfv @ XB2 @ ccort)) => ((ccin @ XA2 @ XB2) = cc0h)))))).
