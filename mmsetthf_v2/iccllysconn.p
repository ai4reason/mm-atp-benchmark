...
thf(aioosconn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwcel @ (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ (cco @ XA2 @ XB2 @ ccioo) @ ccrest) @ ccsconn)))).
...
thf(areconn_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccr) => ((cwcel @ (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ XA2 @ ccrest) @ ccconn) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwss @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccicc) @ XA2)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
...
thf(asubislly_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XJ @ cctop) & (cwcel @ XB2 @ XV)) => ((cwcel @ (cco @ XJ @ XB2 @ ccrest) @ (cclly @ XA2)) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : (cw3a @ (cwss @ (ccin @ (ccv @ Xu) @ XB2) @ (ccv @ Xx3)) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xu)) @ (cwcel @ (cco @ XJ @ (ccin @ (ccv @ Xu) @ XB2) @ ccrest) @ XA2))) @ (^ [Xu:$i] : XJ))) @ (^ [Xy1:$i] : (ccin @ (ccv @ Xx3) @ XB2)))) @ (^ [Xx3:$i] : XJ))))))))).
thf(ciccllysconn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (cwcel @ (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ (cco @ XA2 @ XB2 @ ccicc) @ ccrest) @ (cclly @ ccsconn)))))).
