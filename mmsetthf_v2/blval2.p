...
thf(ablvalps_ax,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwcel @ XP @ XX) @ (cwcel @ XR @ ccxr)) => ((cco @ XP @ XR @ (ccfv @ XD @ ccbl)) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (cco @ XP @ (ccv @ Xx3) @ XD) @ XR @ cclt)) @ (^ [Xx3:$i] : XX))))))))).
...
thf(cblval2_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwcel @ XP @ XX) @ (cwcel @ XR @ ccrp)) => ((cco @ XP @ XR @ (ccfv @ XD @ ccbl)) = (ccima @ (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ XR @ ccico)) @ (ccsn @ XP))))))))).
