...
thf(crecreclt_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ cclt)) => ((cwbr @ (cco @ cc1 @ (cco @ cc1 @ (cco @ cc1 @ XA2 @ ccdiv) @ ccaddc) @ ccdiv) @ cc1 @ cclt) & (cwbr @ (cco @ cc1 @ (cco @ cc1 @ (cco @ cc1 @ XA2 @ ccdiv) @ ccaddc) @ ccdiv) @ XA2 @ cclt))))).
