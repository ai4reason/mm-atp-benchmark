...
thf(aeqif_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = (ccif @ Xph @ XB2 @ XC)) <=> ((Xph & (XA2 = XB2)) | ((~ Xph) & (XA2 = XC))))))))).
...
thf(afin23lem22_ax,axiom,(! [XC:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : ((XC @ Xi @ Xj) = (ccmpt @ (^ [Xi:$i] : ccom) @ (^ [Xi:$i] : (ccrio @ (^ [Xj:$i] : (cwbr @ (ccin @ (ccv @ Xj) @ XS) @ (ccv @ Xi) @ ccen)) @ (^ [Xj:$i] : XS))))))) => (! [Xi:$i] : (! [Xj:$i] : (((cwss @ XS @ ccom) & (~ (cwcel @ XS @ ccfn))) => (cwf1o @ ccom @ XS @ (XC @ Xi @ Xj))))))))).
...
thf(af1co_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwf1 @ XB2 @ XC @ XF) & (cwf1 @ XA2 @ XB2 @ XG)) => (cwf1 @ XA2 @ XC @ (cccom @ XF @ XG))))))))).
...
thf(cfin23lem28_b_conj,conjecture,(! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XQ:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XZ:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : ((! [Xx3:$i] : (! [Xw:$i] : (! [Xt:$i] : ((XU @ Xx3 @ Xw @ Xt) = (ccseqom @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xu:$i] : ccom)) @ (^ [Xi:$i] : (^ [Xu:$i] : ccvv)) @ (^ [Xi:$i] : (^ [Xu:$i] : (ccif @ ((ccin @ (ccfv @ (ccv @ Xi) @ (ccv @ Xt)) @ (ccv @ Xu)) = cc0) @ (ccv @ Xu) @ (ccin @ (ccfv @ (ccv @ Xi) @ (ccv @ Xt)) @ (ccv @ Xu)))))) @ (ccuni @ (ccrn @ (ccv @ Xt)))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xi:$i] : ((XF @ Xx3 @ Xz @ Xw @ Xv @ Xu @ Xi) = (ccab @ (^ [Xw:$i] : (cwral @ (^ [Xa:$i] : ((cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ (ccv @ Xa)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xa)))) @ (^ [Xx3:$i] : ccom)) => (cwcel @ (ccint @ (ccrn @ (ccv @ Xa))) @ (ccrn @ (ccv @ Xa))))) @ (^ [Xa:$i] : (cco @ (ccpw @ (ccv @ Xw)) @ ccom @ ccmap)))))))))))) => ((! [Xx3:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xi:$i] : ((XP @ Xv @ Xu @ Xt @ Xi) = (ccrab @ (^ [Xv:$i] : (cwss @ (ccint @ (ccrn @ (XU @ Xx3 @ Xw @ Xt))) @ (ccfv @ (ccv @ Xv) @ (ccv @ Xt)))) @ (^ [Xv:$i] : ccom))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xi:$i] : (! [Xa:$i] : ((XQ @ Xx3 @ Xz @ Xw @ Xv @ Xu @ Xt @ Xi @ Xa) = (ccmpt @ (^ [Xw:$i] : ccom) @ (^ [Xw:$i] : (ccrio @ (^ [Xx3:$i] : (cwbr @ (ccin @ (ccv @ Xx3) @ (XP @ Xv @ Xu @ Xt @ Xi)) @ (ccv @ Xw) @ ccen)) @ (^ [Xx3:$i] : (XP @ Xv @ Xu @ Xt @ Xi)))))))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xi:$i] : ((XR @ Xx3 @ Xz @ Xw @ Xt) = (ccmpt @ (^ [Xw:$i] : ccom) @ (^ [Xw:$i] : (ccrio @ (^ [Xx3:$i] : (cwbr @ (ccin @ (ccv @ Xx3) @ (ccdif @ ccom @ (XP @ Xv @ Xu @ Xt @ Xi))) @ (ccv @ Xw) @ ccen)) @ (^ [Xx3:$i] : (ccdif @ ccom @ (XP @ Xv @ Xu @ Xt @ Xi)))))))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xi:$i] : (! [Xa:$i] : ((XZ @ Xx3 @ Xz @ Xw @ Xv @ Xu @ Xt @ Xi) = (ccif @ (cwcel @ (XP @ Xv @ Xu @ Xt @ Xi) @ ccfn) @ (cccom @ (ccv @ Xt) @ (XR @ Xx3 @ Xz @ Xw @ Xt)) @ (cccom @ (ccmpt @ (^ [Xz:$i] : (XP @ Xv @ Xu @ Xt @ Xi)) @ (^ [Xz:$i] : (ccdif @ (ccfv @ (ccv @ Xz) @ (ccv @ Xt)) @ (ccint @ (ccrn @ (XU @ Xx3 @ Xw @ Xt)))))) @ (XQ @ Xx3 @ Xz @ Xw @ Xv @ Xu @ Xt @ Xi @ Xa)))))))))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xi:$i] : ((cwf1 @ ccom @ ccvv @ (ccv @ Xt)) => (cwf1 @ ccom @ ccvv @ (XZ @ Xx3 @ Xz @ Xw @ Xv @ Xu @ Xt @ Xi))))))))))))))))))))))).
