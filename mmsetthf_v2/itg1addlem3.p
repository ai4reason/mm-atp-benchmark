...
thf(citg1addlem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : ((Xph => (cwcel @ XF @ (ccdm @ ccitg1))) => ((Xph => (cwcel @ XG @ (ccdm @ ccitg1))) => ((! [Xi:$i] : (! [Xj:$i] : ((XI @ Xi @ Xj) = (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : ccr)) @ (^ [Xi:$i] : (^ [Xj:$i] : ccr)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ (((ccv @ Xi) = ccc0) & ((ccv @ Xj) = ccc0)) @ ccc0 @ (ccfv @ (ccin @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xi))) @ (ccima @ (cccnv @ XG) @ (ccsn @ (ccv @ Xj)))) @ ccvol)))))))) => (! [Xi:$i] : (! [Xj:$i] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & (~ ((XA2 = ccc0) & (XB2 = ccc0)))) => ((cco @ XA2 @ XB2 @ (XI @ Xi @ Xj)) = (ccfv @ (ccin @ (ccima @ (cccnv @ XF) @ (ccsn @ XA2)) @ (ccima @ (cccnv @ XG) @ (ccsn @ XB2))) @ ccvol))))))))))))))).
