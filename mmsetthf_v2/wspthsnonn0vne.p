...
thf(aspthonepeq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwbr @ XF @ XP @ (cco @ XA2 @ XB2 @ (ccfv @ XG @ ccspthson))) => ((XA2 = XB2) <=> ((ccfv @ XF @ cchash) = ccc0))))))))).
thf(cwspthsnonn0vne_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XN @ ccn) & (cwne @ (cco @ XX @ XY @ (cco @ XN @ XG @ ccwwspthsnon)) @ cc0)) => (cwne @ XX @ XY))))))).
