...
thf(alcvexchlem3_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((XS = (ccfv @ XW @ cclss)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((XC = (ccfv @ XW @ cclcv)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XT @ XS)) => ((Xph => (cwcel @ XU @ XS)) => ((Xph => (cwcel @ XR @ XS)) => ((Xph => (cwss @ XT @ XR)) => ((Xph => (cwss @ XR @ (cco @ XT @ XU @ Xc_po))) => (Xph => ((cco @ (ccin @ XR @ XU) @ XT @ Xc_po) = XR)))))))))))))))))))).
