...
thf(amppsval_ax,axiom,(! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : ((XP = (ccfv @ XT @ ccmpst)) => ((! [Xh:$i] : (! [Xa:$i] : (! [Xd:$i] : ((XJ @ Xh @ Xa @ Xd) = (ccfv @ XT @ ccmpps))))) => ((XC = (ccfv @ XT @ ccmcls)) => (! [Xh:$i] : (! [Xa:$i] : (! [Xd:$i] : ((XJ @ Xh @ Xa @ Xd) = (ccoprab @ (^ [Xd:$i] : (^ [Xh:$i] : (^ [Xa:$i] : ((cwcel @ (ccotp @ (ccv @ Xd) @ (ccv @ Xh) @ (ccv @ Xa)) @ XP) & (cwcel @ (ccv @ Xa) @ (cco @ (ccv @ Xd) @ (ccv @ Xh) @ XC))))))))))))))))))).
...
thf(aoprabss_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (cwss @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))) @ (ccxp @ (ccxp @ ccvv @ ccvv) @ ccvv)))).
