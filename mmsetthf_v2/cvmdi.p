...
thf(acvnbtwn4_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) => ((cwbr @ XA2 @ XB2 @ cccv) => (((cwss @ XA2 @ XC) & (cwss @ XC @ XB2)) => ((XC = XA2) | (XC = XB2))))))))).
...
thf(achabs2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((ccin @ XA2 @ (cco @ XA2 @ XB2 @ cchj)) = XA2)))))).
thf(aoveq2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))).
thf(amdsl1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwral @ (^ [Xx3:$i] : (((cwss @ (ccin @ XA2 @ XB2) @ (ccv @ Xx3)) & (cwss @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ cchj))) => ((cwss @ (ccv @ Xx3) @ XB2) => ((ccin @ (cco @ (ccv @ Xx3) @ XA2 @ cchj) @ XB2) = (cco @ (ccv @ Xx3) @ (ccin @ XA2 @ XB2) @ cchj))))) @ (^ [Xx3:$i] : ccch)) <=> (cwbr @ XA2 @ XB2 @ ccmd))))))).
thf(ccvmdi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwbr @ (ccin @ XA2 @ XB2) @ XB2 @ cccv) => (cwbr @ XA2 @ XB2 @ ccmd))))))).
