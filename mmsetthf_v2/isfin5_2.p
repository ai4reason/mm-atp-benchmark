...
thf(aisfin5_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfin5) <=> ((XA2 = cc0) | (cwbr @ XA2 @ (cco @ XA2 @ XA2 @ cccda) @ ccsdm))))).
thf(aianor_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((~ (Xph & Xps)) <=> ((~ Xph) | (~ Xps)))))).
thf(cisfin5_2_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XA2 @ ccfin5) <=> (~ ((cwne @ XA2 @ cc0) & (cwbr @ XA2 @ (cco @ XA2 @ XA2 @ cccda) @ ccen)))))))).
