...
thf(amgpval_ax,axiom,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XM:($i > $o)] : ((XM = (ccfv @ XR @ ccmgp)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (XM = (cco @ XR @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_x) @ ccsts)))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(cmgplem_conj,conjecture,(! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (ccfv @ XR @ ccmgp)) => ((XE = (ccslot @ XN)) => ((cwcel @ XN @ ccn) => ((cwne @ XN @ cc2) => ((ccfv @ XR @ XE) = (ccfv @ XM @ XE))))))))))).
