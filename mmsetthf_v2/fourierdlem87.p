...
thf(aitgrecl_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccr))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccibl)) => (Xph => (cwcel @ (ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccr)))))))).
thf(ccico_tp,type,(ccico : ($i > $o))).
thf(ccof_tp,type,(ccof : (($i > $o) > ($i > $o)))).
thf(ccim_tp,type,(ccim : ($i > $o))).
thf(cccom_tp,type,(cccom : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aiblabs_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3)))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccibl)) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (XB2 @ Xx3) @ ccabs))) @ ccibl))))))))).
...
thf(aitgabs_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ XV))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccibl)) => (Xph => (cwbr @ (ccfv @ (ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccabs) @ (ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (XB2 @ Xx3) @ ccabs))) @ ccle))))))))).
...
thf(avolf_ax,axiom,(cwf @ (ccdm @ ccvol) @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccvol)).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(aiccvolcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (cwcel @ (ccfv @ (cco @ XA2 @ XB2 @ ccicc) @ ccvol) @ ccr))))).
...
thf(aiccmbl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (cwcel @ (cco @ XA2 @ XB2 @ ccicc) @ (ccdm @ ccvol)))))).
...
thf(aiblconstmpt_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwcel @ (ccfv @ XA2 @ ccvol) @ ccr) @ (cwcel @ XB2 @ ccc)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2)) @ ccibl))))).
thf(aitgle_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccibl)) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ ccibl)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccr))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XC @ Xx3) @ ccr))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwbr @ (XB2 @ Xx3) @ (XC @ Xx3) @ ccle))) => (Xph => (cwbr @ (ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ ccle)))))))))))).
thf(asimpl3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((cw3a @ Xph @ Xps @ Xch) & Xth) => Xch)))))).
thf(aitgconst_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwcel @ (ccfv @ XA2 @ ccvol) @ ccr) @ (cwcel @ XB2 @ ccc)) => ((ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2)) = (cco @ XB2 @ (ccfv @ XA2 @ ccvol) @ ccmul)))))).
...
thf(cfourierdlem87_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xch:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XH:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XK:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XW:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XX:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : (! [XY:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))))] : ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xd:$i] : ((Xph @ Xe @ Xk) => (cwf @ ccr @ ccr @ (XF @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd))))))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xd:$i] : ((Xph @ Xe @ Xk) => (cwcel @ (XX @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd) @ ccr)))))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xd:$i] : ((Xph @ Xe @ Xk) => (cwcel @ (XY @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd) @ ccr)))))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xd:$i] : ((Xph @ Xe @ Xk) => (cwcel @ (XW @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd) @ ccr)))))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xd:$i] : ((XH @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd) = (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (ccif @ ((ccv @ Xs1) = ccc0) @ ccc0 @ (cco @ (cco @ (ccfv @ (cco @ (XX @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd) @ (ccv @ Xs1) @ ccaddc) @ (XF @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd)) @ (ccif @ (cwbr @ ccc0 @ (ccv @ Xs1) @ cclt) @ (XY @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd) @ (XW @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd)) @ ccmin) @ (ccv @ Xs1) @ ccdiv))))))))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xd:$i] : ((XK @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xd) = (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (ccif @ ((ccv @ Xs1) = ccc0) @ cc1 @ (cco @ (ccv @ Xs1) @ (cco @ cc2 @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv))))))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xd:$i] : ((XU @ Xu @ Xe @ Xs1 @ Xd) = (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (cco @ (ccfv @ (ccv @ Xs1) @ (XH @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd)) @ (ccfv @ (ccv @ Xs1) @ (XK @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xd)) @ ccmul)))))))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xd:$i] : ((XS @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd) = (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xs1) @ ccmul) @ ccsin)))))))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xd:$i] : ((XG @ Xx3 @ Xe @ Xk @ Xn) = (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (cco @ (ccfv @ (ccv @ Xs1) @ (XU @ Xu @ Xe @ Xs1 @ Xd)) @ (ccfv @ (ccv @ Xs1) @ (XS @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd)) @ ccmul))))))))))) => ((! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xd:$i] : ((Xph @ Xe @ Xk) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xs1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xs1) @ (XH @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xs1 @ Xa @ Xd)) @ ccabs) @ (ccv @ Xx3) @ ccle)) @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)))) @ (^ [Xx3:$i] : ccr))))))))) => ((! [Xx3:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (((Xph @ Xe @ Xk) & (cwcel @ (ccv @ Xn) @ ccn)) => (cwcel @ (XG @ Xx3 @ Xe @ Xk @ Xn) @ ccibl)))))) => ((! [Xx3:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xs1:$i] : (! [Xa:$i] : ((XD @ Xx3 @ Xe @ Xk @ Xs1 @ Xa) = (cco @ (cco @ (ccv @ Xe) @ cc3 @ ccdiv) @ (ccv @ Xa) @ ccdiv))))))) => ((! [Xx3:$i] : (! [Xu:$i] : (! [Xe:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xd:$i] : ((Xch @ Xx3 @ Xu @ Xe @ Xk @ Xn @ Xa @ Xd) <=> ((((cw3a @ ((Xph @ Xe @ Xk) & (cwcel @ (ccv @ Xe) @ ccrp)) @ (cwcel @ (ccv @ Xa) @ ccrp) @ (cwral @ (^ [Xn:$i] : (cwral @ (^ [Xs1:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xs1) @ (XG @ Xx3 @ Xe @ Xk @ Xn)) @ ccabs) @ (ccv @ Xa) @ ccle)) @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)))) @ (^ [Xn:$i] : ccn))) & (cwcel @ (ccv @ Xu) @ (ccdm @ ccvol))) & ((cwss @ (ccv @ Xu) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) & (cwbr @ (ccfv @ (ccv @ Xu) @ ccvol) @ (XD @ Xx3 @ Xe @ Xk @ Xs1 @ Xa) @ ccle))) & (cwcel @ (ccv @ Xn) @ ccn))))))))))) => (! [Xe:$i] : (! [Xk:$i] : (((Xph @ Xe @ Xk) & (cwcel @ (ccv @ Xe) @ ccrp)) => (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xu:$i] : (((cwss @ (ccv @ Xu) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) & (cwbr @ (ccfv @ (ccv @ Xu) @ ccvol) @ (ccv @ Xd) @ ccle)) => (cwral @ (^ [Xk:$i] : (cwbr @ (ccfv @ (ccitg @ (^ [Xs1:$i] : (ccv @ Xu)) @ (^ [Xs1:$i] : (cco @ (ccfv @ (ccv @ Xs1) @ (XU @ Xu @ Xe @ Xs1 @ Xd)) @ (ccfv @ (cco @ (cco @ (ccv @ Xk) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xs1) @ ccmul) @ ccsin) @ ccmul))) @ ccabs) @ (cco @ (ccv @ Xe) @ cc2 @ ccdiv) @ cclt)) @ (^ [Xk:$i] : ccn)))) @ (^ [Xu:$i] : (ccdm @ ccvol)))) @ (^ [Xd:$i] : ccrp))))))))))))))))))))))))))))))).
