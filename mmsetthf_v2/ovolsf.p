...
thf(covolsf_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (cccom @ (cccom @ ccabs @ ccmin) @ XF)) => ((XS = (ccseq @ ccaddc @ XG @ cc1)) => ((cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF) => (cwf @ ccn @ (cco @ ccc0 @ ccpnf @ ccico) @ XS)))))))).
