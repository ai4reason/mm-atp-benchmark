...
thf(comcan_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) & (cwcel @ cc0 @ XA2)) => (((cco @ XA2 @ XB2 @ ccomu) = (cco @ XA2 @ XC @ ccomu)) <=> (XB2 = XC))))))).
