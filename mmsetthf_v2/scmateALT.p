...
thf(cscmateALT_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xc:$i] : ((XA2 @ Xc) = (cco @ XN @ XR @ ccmat))) => ((! [Xc:$i] : (XB2 = (ccfv @ (XA2 @ Xc) @ ccbs))) => ((XS = (cco @ XN @ XR @ ccscmat)) => ((XK = (ccfv @ XR @ ccbs)) => ((! [Xc:$i] : ((Xc_0 @ Xc) = (ccfv @ XR @ cc0g))) => (((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg) @ (cwcel @ XM @ XS)) & ((cwcel @ XI @ XN) & (cwcel @ XJ @ XN))) => (cwrex @ (^ [Xc:$i] : ((cco @ XI @ XJ @ XM) = (ccif @ (XI = XJ) @ (ccv @ Xc) @ (Xc_0 @ Xc)))) @ (^ [Xc:$i] : XK))))))))))))))))))).
