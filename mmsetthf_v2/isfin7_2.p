...
thf(aisnum2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ cccrd)) <=> (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ ccen)) @ (^ [Xx3:$i] : ccon0))))).
...
thf(aonfin_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cwcel @ XA2 @ ccfn) <=> (cwcel @ XA2 @ ccom))))).
...
thf(cisfin7_2_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XA2 @ ccfin7) <=> ((cwcel @ XA2 @ (ccdm @ cccrd)) => (cwcel @ XA2 @ ccfn))))))).
