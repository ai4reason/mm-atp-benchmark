...
thf(afgabs_ax,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XF @ (ccfv @ XY @ ccfbas)) & (cwss @ XY @ XX)) => ((cco @ XX @ (cco @ XY @ XF @ ccfg) @ ccfg) = (cco @ XX @ XF @ ccfg))))))).
thf(asylib_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps <=> Xch) => (Xph => Xch))))))).
thf(axmstps_ax,axiom,(! [XM:($i > $o)] : ((cwcel @ XM @ ccxme) => (cwcel @ XM @ cctps)))).
...
thf(afbsspw_ax,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) => (cwss @ XF @ (ccpw @ XB2)))))).
...
thf(aminveclem3a_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XU @ ccbs)) => ((Xc_mi = (ccfv @ XU @ ccsg)) => ((XN = (ccfv @ XU @ ccnm)) => ((Xph => (cwcel @ XU @ cccph)) => ((Xph => (cwcel @ XY @ (ccfv @ XU @ cclss))) => ((Xph => (cwcel @ (cco @ XU @ XY @ ccress) @ cccms)) => ((Xph => (cwcel @ XA2 @ XX)) => ((XJ = (ccfv @ XU @ cctopn)) => ((XR = (ccrn @ (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ Xc_mi) @ XN))))) => ((XS = (ccinf @ XR @ ccr @ cclt)) => ((XD = (ccres @ (ccfv @ XU @ ccds) @ (ccxp @ XX @ XX))) => (Xph => (cwcel @ (ccres @ XD @ (ccxp @ XY @ XY)) @ (ccfv @ XY @ ccms)))))))))))))))))))))))))).
...
thf(aminveclem3_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [Xc_mi:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xr:$i] : (XX = (ccfv @ (XU @ Xr) @ ccbs))) => ((! [Xr:$i] : ((Xc_mi @ Xr) = (ccfv @ (XU @ Xr) @ ccsg))) => ((! [Xr:$i] : ((XN @ Xr) = (ccfv @ (XU @ Xr) @ ccnm))) => ((! [Xr:$i] : (Xph => (cwcel @ (XU @ Xr) @ cccph))) => ((! [Xr:$i] : (Xph => (cwcel @ XY @ (ccfv @ (XU @ Xr) @ cclss)))) => ((! [Xr:$i] : (Xph => (cwcel @ (cco @ (XU @ Xr) @ XY @ ccress) @ cccms))) => ((Xph => (cwcel @ XA2 @ XX)) => ((! [Xr:$i] : (XJ = (ccfv @ (XU @ Xr) @ cctopn))) => ((! [Xr:$i] : ((XR @ Xr) = (ccrn @ (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ (Xc_mi @ Xr)) @ (XN @ Xr))))))) => ((! [Xr:$i] : (XS = (ccinf @ (XR @ Xr) @ ccr @ cclt))) => ((! [Xr:$i] : (XD = (ccres @ (ccfv @ (XU @ Xr) @ ccds) @ (ccxp @ XX @ XX)))) => ((! [Xr:$i] : ((XF @ Xr) = (ccrn @ (ccmpt @ (^ [Xr:$i] : ccrp) @ (^ [Xr:$i] : (ccrab @ (^ [Xy1:$i] : (cwbr @ (cco @ (cco @ XA2 @ (ccv @ Xy1) @ XD) @ cc2 @ ccexp) @ (cco @ (cco @ XS @ cc2 @ ccexp) @ (ccv @ Xr) @ ccaddc) @ ccle)) @ (^ [Xy1:$i] : XY))))))) => (! [Xr:$i] : (Xph => (cwcel @ (cco @ XY @ (XF @ Xr) @ ccfg) @ (ccfv @ (ccres @ XD @ (ccxp @ XY @ XY)) @ cccfil))))))))))))))))))))))))))))).
...
thf(an0moeu_ax,axiom,(! [XA2:($i > $o)] : ((cwne @ XA2 @ cc0) => ((cwmo @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2))) <=> (cweu @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ XA2))))))).
...
thf(asssn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ (ccsn @ XB2)) <=> ((XA2 = cc0) | (XA2 = (ccsn @ XB2))))))).
