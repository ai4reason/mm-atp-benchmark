...
thf(aitg2monolem2_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF))))) @ ccr @ cclt)))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwcel @ (ccfv @ (ccv @ Xn) @ XF) @ ccmbf))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ (ccfv @ (ccv @ Xn) @ XF)))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwbr @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF) @ (ccofr @ ccle)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF)) @ (ccv @ Xy1) @ ccle)) @ (^ [Xn:$i] : ccn))) @ (^ [Xy1:$i] : ccr)))) => ((XS = (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ ccitg2)))) @ ccxr @ cclt)) => ((Xph => (cwcel @ XP @ (ccdm @ ccitg1))) => ((Xph => (cwbr @ XP @ XG @ (ccofr @ ccle))) => ((Xph => (~ (cwbr @ (ccfv @ XP @ ccitg1) @ XS @ ccle))) => (Xph => (cwcel @ XS @ ccr))))))))))))))))).
...
thf(aitg2ge0_ax,axiom,(! [XF:($i > $o)] : ((cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF) => (cwbr @ ccc0 @ (ccfv @ XF @ ccitg2) @ ccle)))).
...
thf(aitg2monolem1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XG = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF))))) @ ccr @ cclt)))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwcel @ (ccfv @ (ccv @ Xn) @ XF) @ ccmbf))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ (ccfv @ (ccv @ Xn) @ XF)))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwbr @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF) @ (ccofr @ ccle)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF)) @ (ccv @ Xy1) @ ccle)) @ (^ [Xn:$i] : ccn))) @ (^ [Xy1:$i] : ccr)))) => ((XS = (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ ccitg2)))) @ ccxr @ cclt)) => ((Xph => (cwcel @ XT @ (cco @ ccc0 @ cc1 @ ccioo))) => ((Xph => (cwcel @ XH @ (ccdm @ ccitg1))) => ((Xph => (cwbr @ XH @ XG @ (ccofr @ ccle))) => ((Xph => (cwcel @ XS @ ccr)) => ((! [Xy1:$i] : (! [Xn:$i] : ((XA2 @ Xy1 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccrab @ (^ [Xx3:$i] : (cwbr @ (cco @ XT @ (ccfv @ (ccv @ Xx3) @ XH) @ ccmul) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF)) @ ccle)) @ (^ [Xx3:$i] : ccr))))))) => (Xph => (cwbr @ (cco @ XT @ (ccfv @ XH @ ccitg1) @ ccmul) @ XS @ ccle))))))))))))))))))))).
...
thf(citg2monolem3_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF))))) @ ccr @ cclt)))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwcel @ (ccfv @ (ccv @ Xn) @ XF) @ ccmbf))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ (ccfv @ (ccv @ Xn) @ XF)))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwbr @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF) @ (ccofr @ ccle)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xn:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ XF)) @ (ccv @ Xy1) @ ccle)) @ (^ [Xn:$i] : ccn))) @ (^ [Xy1:$i] : ccr)))) => ((XS = (ccsup @ (ccrn @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XF) @ ccitg2)))) @ ccxr @ cclt)) => ((Xph => (cwcel @ XP @ (ccdm @ ccitg1))) => ((Xph => (cwbr @ XP @ XG @ (ccofr @ ccle))) => ((Xph => (~ (cwbr @ (ccfv @ XP @ ccitg1) @ XS @ ccle))) => (Xph => (cwbr @ (ccfv @ XP @ ccitg1) @ XS @ ccle))))))))))))))))).
