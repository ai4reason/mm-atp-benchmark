...
thf(ctchds_conj,conjecture,(! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XW @ cctch)) => ((XN = (ccfv @ XG @ ccnm)) => ((Xc_mi = (ccfv @ XW @ ccsg)) => ((cwcel @ XW @ ccgrp) => ((cccom @ XN @ Xc_mi) = (ccfv @ XG @ ccds))))))))))).
