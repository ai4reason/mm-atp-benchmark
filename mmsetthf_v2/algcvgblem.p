...
thf(apm3_34_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xps => Xch) & (Xph => Xps)) => (Xph => Xch)))))).
...
thf(calgcvgblem_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) => (((cwne @ XN @ ccc0) => (cwbr @ XN @ XM @ cclt)) <=> (((cwne @ XM @ ccc0) => (cwbr @ XN @ XM @ cclt)) & ((XM = ccc0) => (XN = ccc0)))))))).
