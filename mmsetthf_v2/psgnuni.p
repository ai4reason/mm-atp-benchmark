...
thf(am1expaddsub_ax,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XX @ ccz) & (cwcel @ XY @ ccz)) => ((cco @ (ccneg @ cc1) @ (cco @ XX @ XY @ ccmin) @ ccexp) = (cco @ (ccneg @ cc1) @ (cco @ XX @ XY @ ccaddc) @ ccexp)))))).
...
thf(apsgnunilem4_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XD @ ccsymg)) => ((XT = (ccrn @ (ccfv @ XD @ ccpmtr))) => ((Xph => (cwcel @ XD @ XV)) => ((Xph => (cwcel @ XW @ (ccword @ XT))) => ((Xph => ((cco @ XG @ XW @ ccgsu) = (ccres @ ccid @ XD))) => (Xph => ((cco @ (ccneg @ cc1) @ (ccfv @ XW @ cchash) @ ccexp) = cc1)))))))))))))).
...
thf(asymgtrinv_ax,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XT = (ccrn @ (ccfv @ XD @ ccpmtr))) => ((XG = (ccfv @ XD @ ccsymg)) => ((XI = (ccfv @ XG @ ccminusg)) => (((cwcel @ XD @ XV) & (cwcel @ XW @ (ccword @ XT))) => ((ccfv @ (cco @ XG @ XW @ ccgsu) @ XI) = (cco @ XG @ (ccfv @ XW @ ccreverse) @ ccgsu))))))))))))).
