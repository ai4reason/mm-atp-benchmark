...
thf(aaxunndlem1_ax,axiom,(! [Xz:$i] : (? [Xx3:$i] : (! [Xy1:$i] : ((? [Xx3:$i] : ((cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)) & (cwcel @ (ccv @ Xx3) @ (ccv @ Xz)))) => (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))).
...
thf(caxunnd_conj,conjecture,(! [Xz:$i] : (? [Xx3:$i] : (! [Xy1:$i] : ((? [Xx3:$i] : ((cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)) & (cwcel @ (ccv @ Xx3) @ (ccv @ Xz)))) => (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))).
