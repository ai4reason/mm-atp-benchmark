...
thf(cfsumneg_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccc))) => (Xph => ((ccsu @ XA2 @ (^ [Xk:$i] : (ccneg @ (XB2 @ Xk)))) = (ccneg @ (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk)))))))))))).
