...
thf(adifgtsumgt_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccn0) @ (cwcel @ XC @ ccr)) => ((cwbr @ XC @ (cco @ XA2 @ XB2 @ ccmin) @ cclt) => (cwbr @ XC @ (cco @ XA2 @ XB2 @ ccaddc) @ cclt))))))).
...
thf(cdifsqpwdvds_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn0) @ (cwbr @ (cco @ XB2 @ cc1 @ ccaddc) @ XA2 @ cclt)) & ((cwcel @ XC @ ccprime) & (cwcel @ XD @ ccn0))) => (((cco @ XC @ XD @ ccexp) = (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccmin)) => (cwbr @ XC @ (cco @ cc2 @ XB2 @ ccmul) @ ccdvds)))))))).
