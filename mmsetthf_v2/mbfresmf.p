...
thf(ambfdmssre_ax,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ ccmbf) => (cwss @ (ccdm @ XF) @ ccr)))).
...
thf(apreimaioomnf_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ ccr @ XF)) => ((Xph => (cwcel @ XB2 @ ccxr)) => (Xph => ((ccima @ (cccnv @ XF) @ (cco @ ccmnf @ XB2 @ ccioo)) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ XB2 @ cclt)) @ (^ [Xx3:$i] : XA2))))))))))).
...
thf(cmbfresmf_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwss @ (ccrn @ XF) @ ccr)) => ((XS = (ccdm @ ccvol)) => (Xph => (cwcel @ XF @ (ccfv @ XS @ ccsmblfn)))))))))).
