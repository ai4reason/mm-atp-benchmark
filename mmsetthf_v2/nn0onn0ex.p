...
thf(cnn0onn0ex_conj,conjecture,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn0)) => (cwrex @ (^ [Xm:$i] : (XN = (cco @ (cco @ cc2 @ (ccv @ Xm) @ ccmul) @ cc1 @ ccaddc))) @ (^ [Xm:$i] : ccn0))))).
