...
thf(adfid2_ax,axiom,(ccid = (ccopab @ (^ [Xx3:$i] : (^ [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xx3))))))).
...
thf(aelopab_b_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccopab @ (^ [Xx3:$i] : (^ [Xx3:$i] : (Xph @ Xx3))))) <=> (? [Xx3:$i] : (? [Xx3:$i] : ((XA2 = (ccop @ (ccv @ Xx3) @ (ccv @ Xx3))) & (Xph @ Xx3)))))))).
