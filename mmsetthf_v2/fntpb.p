...
thf(apm2_61iine_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwne @ XA2 @ XC) & (cwne @ XB2 @ XD)) => Xph) => (((XA2 = XC) => Xph) => (((XB2 = XD) => Xph) => Xph))))))))).
...
thf(atpidm13_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cctp @ XA2 @ XB2 @ XA2) = (ccpr @ XA2 @ XB2))))).
thf(cfntpb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwfn @ XF @ (cctp @ XA2 @ XB2 @ XC)) <=> (XF = (cctp @ (ccop @ XA2 @ (ccfv @ XA2 @ XF)) @ (ccop @ XB2 @ (ccfv @ XB2 @ XF)) @ (ccop @ XC @ (ccfv @ XC @ XF))))))))))))).
