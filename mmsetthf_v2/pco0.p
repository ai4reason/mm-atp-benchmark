...
thf(cpco0_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => (Xph => ((ccfv @ ccc0 @ (cco @ XF @ XG @ (ccfv @ XJ @ ccpco))) = (ccfv @ ccc0 @ XF)))))))))).
