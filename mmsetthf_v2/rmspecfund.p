...
thf(apellqrexplicit_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (((cw3a @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccn0)) & ((cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XD @ (cco @ XB2 @ cc2 @ ccexp) @ ccmul) @ ccmin) = cc1)) => (cwcel @ (cco @ XA2 @ (cco @ (ccfv @ XD @ ccsqrt) @ XB2 @ ccmul) @ ccaddc) @ (ccfv @ XD @ ccpell1qr))))))).
...
thf(apellfundlb_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((cw3a @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) @ (cwbr @ cc1 @ XA2 @ cclt)) => (cwbr @ (ccfv @ XD @ ccpellfund) @ XA2 @ ccle))))).
...
thf(apellfundge_ax,axiom,(! [XD:($i > $o)] : ((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) => (cwbr @ (cco @ (ccfv @ (cco @ XD @ cc1 @ ccaddc) @ ccsqrt) @ (ccfv @ XD @ ccsqrt) @ ccaddc) @ (ccfv @ XD @ ccpellfund) @ ccle)))).
...
thf(apellfundre_ax,axiom,(! [XD:($i > $o)] : ((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) => (cwcel @ (ccfv @ XD @ ccpellfund) @ ccr)))).
thf(crmspecfund_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) => ((ccfv @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ ccpellfund) = (cco @ XA2 @ (ccfv @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ ccsqrt) @ ccaddc))))).
