...
thf(axltadd2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccr)) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (cco @ XC @ XA2 @ ccxad) @ (cco @ XC @ XB2 @ ccxad) @ cclt))))))).
...
thf(axnpcan_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccr)) => ((cco @ (cco @ XA2 @ (ccxne @ XB2) @ ccxad) @ XB2 @ ccxad) = XA2))))).
...
thf(axaddmnf1_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwne @ XA2 @ ccpnf)) => ((cco @ XA2 @ ccmnf @ ccxad) = ccmnf)))).
...
thf(apnfaddmnf_ax,axiom,((cco @ ccpnf @ ccmnf @ ccxad) = ccc0)).
...
thf(cxblss2_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XD @ (ccfv @ XX @ ccxmt))) => ((Xph => (cwcel @ XP @ XX)) => ((Xph => (cwcel @ XQ @ XX)) => ((Xph => (cwcel @ XR @ ccxr)) => ((Xph => (cwcel @ XS @ ccxr)) => ((Xph => (cwcel @ (cco @ XP @ XQ @ XD) @ ccr)) => ((Xph => (cwbr @ (cco @ XP @ XQ @ XD) @ (cco @ XS @ (ccxne @ XR) @ ccxad) @ ccle)) => (Xph => (cwss @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (cco @ XQ @ XS @ (ccfv @ XD @ ccbl))))))))))))))))))).
