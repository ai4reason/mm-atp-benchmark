...
thf(ahisubcomi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cwcel @ XC @ cchil) => ((cwcel @ XD @ cchil) => ((cco @ (cco @ XA2 @ XB2 @ ccmv) @ (cco @ XC @ XD @ ccmv) @ ccsp) = (cco @ (cco @ XB2 @ XA2 @ ccmv) @ (cco @ XD @ XC @ ccmv) @ ccsp))))))))))).
...
thf(ahvsubdistr1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ cchil) => ((cwcel @ XC @ cchil) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccmv) @ ccsm) = (cco @ (cco @ XA2 @ XB2 @ ccsm) @ (cco @ XA2 @ XC @ ccsm) @ ccmv))))))))).
...
thf(alnophmlem1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cwcel @ XT @ cclo) => ((cwral @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ XT) @ ccsp) @ ccr)) @ (^ [Xx3:$i] : cchil)) => (cwcel @ (cco @ XA2 @ (ccfv @ XA2 @ XT) @ ccsp) @ ccr))))))))).
...
thf(alnopmulsubi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil)) => ((ccfv @ (cco @ (cco @ XA2 @ XB2 @ ccsm) @ XC @ ccmv) @ XT) = (cco @ (cco @ XA2 @ (ccfv @ XB2 @ XT) @ ccsm) @ (ccfv @ XC @ XT) @ ccmv))))))))).
