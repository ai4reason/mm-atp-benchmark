...
thf(annmcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) => (cwcel @ (cco @ XA2 @ XB2 @ ccomu) @ ccom))))).
...
thf(afin1a2lem3_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : ((! [Xx3:$i] : ((XE @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccom) @ (^ [Xx3:$i] : (cco @ cc2o @ (ccv @ Xx3) @ ccomu))))) => (! [Xx3:$i] : ((cwcel @ (XA2 @ Xx3) @ ccom) => ((ccfv @ (XA2 @ Xx3) @ (XE @ Xx3)) = (cco @ cc2o @ (XA2 @ Xx3) @ ccomu)))))))).
...
thf(aomcan_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) & (cwcel @ cc0 @ XA2)) => (((cco @ XA2 @ XB2 @ ccomu) = (cco @ XA2 @ XC @ ccomu)) <=> (XB2 = XC))))))).
...
thf(cfin1a2lem4_conj,conjecture,(! [XE:($i > ($i > $o))] : ((! [Xx3:$i] : ((XE @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccom) @ (^ [Xx3:$i] : (cco @ cc2o @ (ccv @ Xx3) @ ccomu))))) => (! [Xx3:$i] : (cwf1 @ ccom @ ccom @ (XE @ Xx3)))))).
