...
thf(adf_struct_ax,axiom,(ccstr = (ccopab @ (^ [Xf1:$i] : (^ [Xx3:$i] : (cw3a @ (cwcel @ (ccv @ Xx3) @ (ccin @ ccle @ (ccxp @ ccn @ ccn))) @ (cwfun @ (ccdif @ (ccv @ Xf1) @ (ccsn @ cc0))) @ (cwss @ (ccdm @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xx3) @ ccfz)))))))).
thf(cisstruct2_conj,conjecture,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwbr @ XF @ XX @ ccstr) <=> (cw3a @ (cwcel @ XX @ (ccin @ ccle @ (ccxp @ ccn @ ccn))) @ (cwfun @ (ccdif @ XF @ (ccsn @ cc0))) @ (cwss @ (ccdm @ XF) @ (ccfv @ XX @ ccfz))))))).
