...
thf(adirkertrigeqlem1_ax,axiom,(! [XK:($i > $o)] : ((cwcel @ XK @ ccn) => ((ccsu @ (cco @ cc1 @ (cco @ cc2 @ XK @ ccmul) @ ccfz) @ (^ [Xn:$i] : (ccfv @ (cco @ (ccv @ Xn) @ ccpi @ ccmul) @ cccos))) = ccc0)))).
...
thf(ahalffl_ax,axiom,((ccfv @ (cco @ cc1 @ cc2 @ ccdiv) @ ccfl) = ccc0)).
...
thf(annne1ge2_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwne @ XN @ cc1)) => (cwbr @ cc2 @ XN @ ccle)))).
