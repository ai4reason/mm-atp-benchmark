...
thf(asupxrmnf_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => ((ccsup @ (ccun @ XA2 @ (ccsn @ ccmnf)) @ ccxr @ cclt) = (ccsup @ XA2 @ ccxr @ cclt))))).
...
thf(csupxrmnf2_conj,conjecture,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => ((ccsup @ (ccdif @ XA2 @ (ccsn @ ccmnf)) @ ccxr @ cclt) = (ccsup @ XA2 @ ccxr @ cclt))))).
