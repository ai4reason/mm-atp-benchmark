...
thf(afrgrwopreglem3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XD = (ccfv @ XG @ ccvtxdg)) => ((XA2 = (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XD) = XK)) @ (^ [Xx3:$i] : XV))) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccdif @ XV @ XA2))) => (! [Xx3:$i] : (((cwcel @ XX @ XA2) & (cwcel @ XY @ (XB2 @ Xx3))) => (cwne @ (ccfv @ XX @ XD) @ (ccfv @ XY @ XD))))))))))))))))).
thf(ccusgr_tp,type,(ccusgr : ($i > $o))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(ccnbgr_tp,type,(ccnbgr : ($i > $o))).
thf(cco_tp,type,(cco : (($i > $o) > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(cwnel_tp,type,(cwnel : (($i > $o) > (($i > $o) > $o)))).
thf(afrgrwopreglem4a_ax,axiom,(! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XD = (ccfv @ XG @ ccvtxdg)) => ((XE = (ccfv @ XG @ ccedg)) => ((cw3a @ (cwcel @ XG @ ccfrgr) @ ((cwcel @ XX @ XV) & (cwcel @ XY @ XV)) @ (cwne @ (ccfv @ XX @ XD) @ (ccfv @ XY @ XD))) => (cwcel @ (ccpr @ XX @ XY) @ XE)))))))))))).
