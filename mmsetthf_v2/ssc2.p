...
thf(cssc2_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwfn @ XH @ (ccxp @ XS @ XS))) => ((Xph => (cwbr @ XH @ XJ @ ccssc)) => ((Xph => (cwcel @ XX @ XS)) => ((Xph => (cwcel @ XY @ XS)) => (Xph => (cwss @ (cco @ XX @ XY @ XH) @ (cco @ XX @ XY @ XJ)))))))))))))).
