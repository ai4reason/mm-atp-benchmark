...
thf(anolesgn2o_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cw3a @ (cwcel @ XA2 @ ccsur) @ (cwcel @ XB2 @ ccsur) @ (cwcel @ XX @ ccon0)) @ (((ccres @ XA2 @ XX) = (ccres @ XB2 @ XX)) & ((ccfv @ XX @ XA2) = cc2o)) @ (~ (cwbr @ XB2 @ XA2 @ ccslt))) => ((ccfv @ XX @ XB2) = cc2o)))))).
...
thf(cnolesgn2ores_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cw3a @ (cwcel @ XA2 @ ccsur) @ (cwcel @ XB2 @ ccsur) @ (cwcel @ XX @ ccon0)) @ (((ccres @ XA2 @ XX) = (ccres @ XB2 @ XX)) & ((ccfv @ XX @ XA2) = cc2o)) @ (~ (cwbr @ XB2 @ XA2 @ ccslt))) => ((ccres @ XA2 @ (ccsuc @ XX)) = (ccres @ XB2 @ (ccsuc @ XX)))))))).
