...
thf(anepnfltpnf_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwne @ XA2 @ ccpnf)) => ((Xph => (cwcel @ XA2 @ ccxr)) => (Xph => (cwbr @ XA2 @ ccpnf @ cclt))))))).
...
thf(cinfrpge_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwss @ XA2 @ ccxr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwne @ XA2 @ cc0)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (XB2 @ Xx3 @ Xy1) @ ccrp)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (cco @ (ccinf @ XA2 @ ccxr @ cclt) @ (XB2 @ Xx3 @ Xy1) @ ccxad) @ ccle)) @ (^ [Xz:$i] : XA2)))))))))))))).
