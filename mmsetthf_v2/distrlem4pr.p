...
thf(cdistrlem4pr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xf1:$i] : (((cw3a @ (cwcel @ XA2 @ ccnp) @ (cwcel @ XB2 @ ccnp) @ (cwcel @ XC @ ccnp)) & (((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XB2)) & ((cwcel @ (ccv @ Xf1) @ XA2) & (cwcel @ (ccv @ Xz) @ XC)))) => (cwcel @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmq) @ (cco @ (ccv @ Xf1) @ (ccv @ Xz) @ ccmq) @ ccplq) @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccpp) @ ccmp))))))))))).
