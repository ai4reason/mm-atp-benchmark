...
thf(cioodisj_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & ((cwcel @ XC @ ccxr) & (cwcel @ XD @ ccxr))) & (cwbr @ XB2 @ XC @ ccle)) => ((ccin @ (cco @ XA2 @ XB2 @ ccioo) @ (cco @ XC @ XD @ ccioo)) = cc0))))))).
