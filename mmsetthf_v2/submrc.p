...
thf(asubmre_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwcel @ XA2 @ XC)) => (cwcel @ (ccin @ XC @ (ccpw @ XA2)) @ (ccfv @ XA2 @ ccmre))))))).
...
thf(csubmrc_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => ((XG = (ccfv @ (ccin @ XC @ (ccpw @ XD)) @ ccmrc)) => ((cw3a @ (cwcel @ XC @ (ccfv @ XX @ ccmre)) @ (cwcel @ XD @ XC) @ (cwss @ XU @ XD)) => ((ccfv @ XU @ XG) = (ccfv @ XU @ XF)))))))))))).
