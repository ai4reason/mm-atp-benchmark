...
thf(ak0004lem3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XU) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XB2)) => (((cwcel @ XF @ (cco @ XB2 @ (ccsn @ XA2) @ ccmap)) & ((ccfv @ XA2 @ XF) = XC)) <=> (XF = (ccsn @ (ccop @ XA2 @ XC)))))))))))).
