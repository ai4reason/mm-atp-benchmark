...
thf(adrsbn0_ax,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((cwcel @ XK @ ccdrs) => (cwne @ XB2 @ cc0)))))).
...
thf(adrsprs_ax,axiom,(! [XK:($i > $o)] : ((cwcel @ XK @ ccdrs) => (cwcel @ XK @ ccpreset)))).
...
thf(aprstr_ax,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((cw3a @ (cwcel @ XK @ ccpreset) @ (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2)) @ ((cwbr @ XX @ XY @ Xc_le) & (cwbr @ XY @ XZ @ Xc_le))) => (cwbr @ XX @ XZ @ Xc_le))))))))))).
...
thf(adrsdir_ax,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((cw3a @ (cwcel @ XK @ ccdrs) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => (cwrex @ (^ [Xz:$i] : ((cwbr @ XX @ (ccv @ Xz) @ Xc_le) & (cwbr @ XY @ (ccv @ Xz) @ Xc_le))) @ (^ [Xz:$i] : XB2))))))))))).
thf(cdrsdirfi_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((cw3a @ (cwcel @ XK @ ccdrs) @ (cwss @ XX @ XB2) @ (cwcel @ XX @ ccfn)) => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ Xc_le)) @ (^ [Xz:$i] : XX))) @ (^ [Xy1:$i] : XB2)))))))))).
