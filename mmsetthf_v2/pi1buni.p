...
thf(api1bas_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (cco @ XJ @ XY @ ccpi1)) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XY @ XX)) => ((XO = (cco @ XJ @ XY @ ccomi)) => ((Xph => (XB2 = (ccfv @ XG @ ccbs))) => ((Xph => (XK = (ccfv @ XO @ ccbs))) => (Xph => (XB2 = (ccqs @ XK @ (ccfv @ XJ @ ccphtpc))))))))))))))))))).
...
thf(aqsinxp_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwss @ (ccima @ XR @ XA2) @ XA2) => ((ccqs @ XA2 @ XR) = (ccqs @ XA2 @ (ccin @ XR @ (ccxp @ XA2 @ XA2)))))))).
...
thf(cpi1buni_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (cco @ XJ @ XY @ ccpi1)) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XY @ XX)) => ((XO = (cco @ XJ @ XY @ ccomi)) => ((Xph => (XB2 = (ccfv @ XG @ ccbs))) => ((Xph => (XK = (ccfv @ XO @ ccbs))) => (Xph => ((ccuni @ XB2) = XK))))))))))))))))).
