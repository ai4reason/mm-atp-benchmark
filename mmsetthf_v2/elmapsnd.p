...
thf(celmapsnd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwfn @ XF @ (ccsn @ XA2))) => ((Xph => (cwcel @ XB2 @ XV)) => ((Xph => (cwcel @ (ccfv @ XA2 @ XF) @ XB2)) => (Xph => (cwcel @ XF @ (cco @ XB2 @ (ccsn @ XA2) @ ccmap)))))))))))).
