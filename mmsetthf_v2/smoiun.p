...
thf(asmofvon_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwsmo @ XB2) & (cwcel @ XA2 @ (ccdm @ XB2))) => (cwcel @ (ccfv @ XA2 @ XB2) @ ccon0))))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(a_3expia_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((cw3a @ Xph @ Xps @ Xch) => Xth) => ((Xph & Xps) => (Xch => Xth)))))))).
thf(asmoel_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwsmo @ XB2) @ (cwcel @ XA2 @ (ccdm @ XB2)) @ (cwcel @ XC @ XA2)) => (cwcel @ (ccfv @ XC @ XB2) @ (ccfv @ XA2 @ XB2))))))).
...
thf(csmoiun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwsmo @ XB2) & (cwcel @ XA2 @ (ccdm @ XB2))) => (cwss @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XB2))) @ (ccfv @ XA2 @ XB2)))))).
