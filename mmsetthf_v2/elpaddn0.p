...
thf(aelpadd_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xc_pl:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xr:$i] : (! [Xq:$i] : ((Xc_le @ Xr @ Xq) = (ccfv @ XK @ ccple)))) => ((! [Xr:$i] : (! [Xq:$i] : ((Xc_or @ Xr @ Xq) = (ccfv @ XK @ ccjn)))) => ((! [Xr:$i] : (! [Xq:$i] : ((XA2 @ Xr @ Xq) = (ccfv @ XK @ ccatm)))) => ((! [Xr:$i] : (! [Xq:$i] : ((Xc_pl @ Xr @ Xq) = (ccfv @ XK @ ccpadd)))) => (! [Xr:$i] : (! [Xq:$i] : ((cw3a @ (cwcel @ XK @ (XB2 @ Xr @ Xq)) @ (cwss @ (XX @ Xr) @ (XA2 @ Xr @ Xq)) @ (cwss @ XY @ (XA2 @ Xr @ Xq))) => ((cwcel @ XS @ (cco @ (XX @ Xr) @ XY @ (Xc_pl @ Xr @ Xq))) <=> (((cwcel @ XS @ (XX @ Xr)) | (cwcel @ XS @ XY)) | ((cwcel @ XS @ (XA2 @ Xr @ Xq)) & (cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : (cwbr @ XS @ (cco @ (ccv @ Xq) @ (ccv @ Xr) @ (Xc_or @ Xr @ Xq)) @ (Xc_le @ Xr @ Xq))) @ (^ [Xr:$i] : XY))) @ (^ [Xq:$i] : (XX @ Xr))))))))))))))))))))))).
...
thf(areximdva0_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (Xps @ Xx3))) => ((Xph & (cwne @ XA2 @ cc0)) => (cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(apm4_72_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph => Xps) <=> (Xps <=> (Xph | Xps)))))).
thf(celpaddn0_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((! [Xr:$i] : (! [Xq:$i] : ((Xc_pl @ Xr @ Xq) = (ccfv @ XK @ ccpadd)))) => (! [Xr:$i] : (! [Xq:$i] : (((cw3a @ (cwcel @ XK @ cclat) @ (cwss @ XX @ XA2) @ (cwss @ XY @ XA2)) & ((cwne @ XX @ cc0) & (cwne @ XY @ cc0))) => ((cwcel @ XS @ (cco @ XX @ XY @ (Xc_pl @ Xr @ Xq))) <=> ((cwcel @ XS @ XA2) & (cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : (cwbr @ XS @ (cco @ (ccv @ Xq) @ (ccv @ Xr) @ Xc_or) @ Xc_le)) @ (^ [Xr:$i] : XY))) @ (^ [Xq:$i] : XX)))))))))))))))))))).
