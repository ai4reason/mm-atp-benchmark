...
thf(adf_ldgis_ax,axiom,(ccldgis = (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (ccmpt @ (^ [Xi:$i] : (ccfv @ (ccfv @ (ccv @ Xr) @ ccpl1) @ cclidl)) @ (^ [Xi:$i] : (ccmpt @ (^ [Xx3:$i] : ccn0) @ (^ [Xx3:$i] : (ccab @ (^ [Xj:$i] : (cwrex @ (^ [Xk:$i] : ((cwbr @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xr) @ ccdg1)) @ (ccv @ Xx3) @ ccle) & ((ccv @ Xj) = (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xk) @ ccco1))))) @ (^ [Xk:$i] : (ccv @ Xi))))))))))))).
...
thf(ahbtlem2_ax,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XU = (ccfv @ XP @ cclidl)) => ((XS = (ccfv @ XR @ ccldgis)) => ((XT = (ccfv @ XR @ cclidl)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XU) @ (cwcel @ XX @ ccn0)) => (cwcel @ (ccfv @ XX @ (ccfv @ XI @ XS)) @ XT)))))))))))))).
thf(affnfv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) <=> ((cwfn @ XF @ XA2) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ XB2)) @ (^ [Xx3:$i] : XA2)))))))).
thf(chbtlem7_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XU = (ccfv @ XP @ cclidl)) => ((XS = (ccfv @ XR @ ccldgis)) => ((XT = (ccfv @ XR @ cclidl)) => (((cwcel @ XR @ ccrg) & (cwcel @ XI @ XU)) => (cwf @ ccn0 @ XT @ (ccfv @ XI @ XS)))))))))))))).
