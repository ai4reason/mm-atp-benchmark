...
thf(apjclem1_ax,axiom,(! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => ((cwbr @ XG @ XH @ cccm) => ((cccom @ (ccfv @ XG @ ccpjh) @ (ccfv @ XH @ ccpjh)) = (ccfv @ (ccin @ XG @ XH) @ ccpjh)))))))).
thf(asylbi_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph <=> Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(acmcmi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwbr @ XA2 @ XB2 @ cccm) <=> (cwbr @ XB2 @ XA2 @ cccm))))))).
