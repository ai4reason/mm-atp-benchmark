...
thf(apfxccatin12lem1_ax,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XM @ (cco @ ccc0 @ XL @ ccfz)) & (cwcel @ XN @ (cco @ XL @ XX @ ccfz))) => (((cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfzo)) & (~ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XL @ XM @ ccmin) @ ccfzo)))) => (cwcel @ (cco @ XK @ (cco @ XL @ XM @ ccmin) @ ccmin) @ (cco @ ccc0 @ (cco @ XN @ XL @ ccmin) @ ccfzo)))))))))).
