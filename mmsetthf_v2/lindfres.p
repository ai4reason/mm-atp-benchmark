...
thf(af1lindf_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ cclmod) @ (cwbr @ XF @ XW @ cclindf) @ (cwf1 @ XK @ (ccdm @ XF) @ XG)) => (cwbr @ (cccom @ XF @ XG) @ XW @ cclindf))))))).
thf(clindfres_conj,conjecture,(! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XW @ cclmod) & (cwbr @ XF @ XW @ cclindf)) => (cwbr @ (ccres @ XF @ XX) @ XW @ cclindf)))))).
