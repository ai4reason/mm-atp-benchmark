...
thf(am1modnnsub1_ax,axiom,(! [XM:($i > $o)] : ((cwcel @ XM @ ccn) => ((cco @ (ccneg @ cc1) @ XM @ ccmo) = (cco @ XM @ cc1 @ ccmin))))).
thf(cm1modge3gt1_conj,conjecture,(! [XM:($i > $o)] : ((cwcel @ XM @ (ccfv @ cc3 @ ccuz)) => (cwbr @ cc1 @ (cco @ (ccneg @ cc1) @ XM @ ccmo) @ cclt)))).
