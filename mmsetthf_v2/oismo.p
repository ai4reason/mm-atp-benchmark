...
thf(aoiiniseg_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XF = (ccoi @ XA2 @ XR)) => ((((cwwe @ XA2 @ XR) & (cwse @ XA2 @ XR)) & ((cwcel @ XN @ XA2) & (cwcel @ XM @ (ccdm @ XF)))) => ((cwbr @ (ccfv @ XM @ XF) @ XN @ XR) | (cwcel @ XN @ (ccrn @ XF))))))))))).
...
thf(asmogt_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwfn @ XF @ XA2) @ (cwsmo @ XF) @ (cwcel @ XC @ XA2)) => (cwss @ XC @ (ccfv @ XC @ XF))))))).
...
thf(aordtype2_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((XF = (ccoi @ XA2 @ XR)) => ((cw3a @ (cwwe @ XA2 @ XR) @ (cwse @ XA2 @ XR) @ (cwcel @ XF @ ccvv)) => (cwiso @ (ccdm @ XF) @ XA2 @ ccep @ XR @ XF))))))).
