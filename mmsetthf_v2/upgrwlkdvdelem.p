...
thf(aanim12d1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => (Xps => Xch)) => ((Xth => Xta) => (Xph => ((Xps & Xth) => (Xch & Xta))))))))))).
...
thf(aaddn0nid_ax,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XX @ ccc) @ (cwcel @ XY @ ccc) @ (cwne @ XY @ ccc0)) => (cwne @ (cco @ XX @ XY @ ccaddc) @ XX))))).
