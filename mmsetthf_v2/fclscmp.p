...
thf(afclssscls_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : ((cwcel @ XS @ XF) => (cwss @ (cco @ XJ @ XF @ ccfcls) @ (ccfv @ XS @ (ccfv @ XJ @ cccl)))))))).
...
thf(acmpfi_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cctop) => ((cwcel @ XJ @ cccmp) <=> (cwral @ (^ [Xx3:$i] : ((~ (cwcel @ cc0 @ (ccfv @ (ccv @ Xx3) @ ccfi))) => (cwne @ (ccint @ (ccv @ Xx3)) @ cc0))) @ (^ [Xx3:$i] : (ccpw @ (ccfv @ XJ @ cccld)))))))).
thf(cfclscmp_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XX @ cctopon)) => ((cwcel @ XJ @ cccmp) <=> (cwral @ (^ [Xf1:$i] : (cwne @ (cco @ XJ @ (ccv @ Xf1) @ ccfcls) @ cc0)) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil)))))))).
