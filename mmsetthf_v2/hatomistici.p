...
thf(achsupid_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((ccfv @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XA2)) @ (^ [Xx3:$i] : ccch)) @ cchsup) = XA2)))).
...
thf(achsupunss_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccch) => (cwss @ (ccuni @ XA2) @ (ccfv @ XA2 @ cchsup))))).
