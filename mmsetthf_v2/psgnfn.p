...
thf(cpsgnfn_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xp:$i] : ((XG @ Xp) = (ccfv @ (XD @ Xp) @ ccsymg))) => ((! [Xp:$i] : (XB2 = (ccfv @ (XG @ Xp) @ ccbs))) => ((! [Xp:$i] : ((XF @ Xp) = (ccrab @ (^ [Xp:$i] : (cwcel @ (ccdm @ (ccdif @ (ccv @ Xp) @ ccid)) @ ccfn)) @ (^ [Xp:$i] : XB2)))) => ((! [Xp:$i] : ((XN @ Xp) = (ccfv @ (XD @ Xp) @ ccpsgn))) => (! [Xp:$i] : (cwfn @ (XN @ Xp) @ (XF @ Xp))))))))))))).
