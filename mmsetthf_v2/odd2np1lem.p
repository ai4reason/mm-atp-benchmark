...
thf(codd2np1lem_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cwrex @ (^ [Xn:$i] : ((cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) = XN)) @ (^ [Xn:$i] : ccz)) | (cwrex @ (^ [Xk:$i] : ((cco @ (ccv @ Xk) @ cc2 @ ccmul) = XN)) @ (^ [Xk:$i] : ccz)))))).
