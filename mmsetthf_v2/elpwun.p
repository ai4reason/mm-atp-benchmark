...
thf(adifex2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XB2 @ XC) => ((cwcel @ XA2 @ ccvv) <=> (cwcel @ (ccdif @ XA2 @ XB2) @ ccvv))))))).
...
thf(celpwun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccvv) => ((cwcel @ XA2 @ (ccpw @ (ccun @ XB2 @ XC))) <=> (cwcel @ (ccdif @ XA2 @ XC) @ (ccpw @ XB2)))))))).
