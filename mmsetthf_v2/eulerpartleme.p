...
thf(ceulerpartleme_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : ((! [Xf1:$i] : (! [Xk:$i] : ((XP @ Xf1 @ Xk) = (ccrab @ (^ [Xf1:$i] : ((cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn) & ((ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul))) = (XN @ Xk)))) @ (^ [Xf1:$i] : (cco @ ccn0 @ ccn @ ccmap)))))) => (! [Xf1:$i] : (! [Xk:$i] : ((cwcel @ XA2 @ (XP @ Xf1 @ Xk)) <=> (cw3a @ (cwf @ ccn @ ccn0 @ XA2) @ (cwcel @ (ccima @ (cccnv @ XA2) @ ccn) @ ccfn) @ ((ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccv @ Xk) @ ccmul))) = (XN @ Xk))))))))))).
