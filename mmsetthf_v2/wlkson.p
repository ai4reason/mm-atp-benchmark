...
thf(amptmpt2opabbrd_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xch:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xth:($i > ($i > ($i > $o)))] : (! [Xta:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XM:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XW:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xg1 @ Xa @ Xb) => (cwcel @ XG @ (XW @ Xf1 @ Xh @ Xa @ Xb)))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xg1 @ Xa @ Xb) => (cwcel @ XX @ (ccfv @ XG @ (XA2 @ Xf1 @ Xh))))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xg1 @ Xa @ Xb) => (cwcel @ XY @ (ccfv @ XG @ (XB2 @ Xf1 @ Xh))))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xg1 @ Xa @ Xb) => (cwcel @ (ccopab @ (^ [Xf1:$i] : (^ [Xh:$i] : (Xps @ Xf1 @ Xg1 @ Xh @ Xa @ Xb)))) @ (XV @ Xf1 @ Xg1 @ Xh @ Xa @ Xb)))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xa:$i] : (! [Xb:$i] : (((Xph @ Xg1 @ Xa @ Xb) & (cwbr @ (ccv @ Xf1) @ (ccv @ Xh) @ (ccfv @ XG @ (XD @ Xf1 @ Xh)))) => (Xps @ Xf1 @ Xg1 @ Xh @ Xa @ Xb))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xa:$i] : (! [Xb:$i] : ((((ccv @ Xa) = XX) & ((ccv @ Xb) = XY)) => ((Xta @ Xf1 @ Xh @ Xa @ Xb) <=> (Xth @ Xf1 @ Xg1 @ Xh)))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xa:$i] : (! [Xb:$i] : (((ccv @ Xg1) = XG) => ((Xch @ Xf1 @ Xg1 @ Xh @ Xa @ Xb) <=> (Xta @ Xf1 @ Xh @ Xa @ Xb)))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XM @ Xf1 @ Xg1 @ Xh @ Xa @ Xb) = (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccmpt2 @ (^ [Xa:$i] : (^ [Xb:$i] : (ccfv @ (ccv @ Xg1) @ (XA2 @ Xf1 @ Xh)))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccfv @ (ccv @ Xg1) @ (XB2 @ Xf1 @ Xh)))) @ (^ [Xa:$i] : (^ [Xb:$i] : (ccopab @ (^ [Xf1:$i] : (^ [Xh:$i] : ((Xch @ Xf1 @ Xg1 @ Xh @ Xa @ Xb) & (cwbr @ (ccv @ Xf1) @ (ccv @ Xh) @ (ccfv @ (ccv @ Xg1) @ (XD @ Xf1 @ Xh)))))))))))))))))) => (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xg1 @ Xa @ Xb) => ((cco @ XX @ XY @ (ccfv @ XG @ (XM @ Xf1 @ Xg1 @ Xh @ Xa @ Xb))) = (ccopab @ (^ [Xf1:$i] : (^ [Xh:$i] : ((Xth @ Xf1 @ Xg1 @ Xh) & (cwbr @ (ccv @ Xf1) @ (ccv @ Xh) @ (ccfv @ XG @ (XD @ Xf1 @ Xh))))))))))))))))))))))))))))))))))))).
thf(aadantr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph & Xch) => Xps)))))).
thf(a_1vgrex_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XN @ XV) => (cwcel @ XG @ ccvv))))))).
...
thf(cwlkson_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) => ((cco @ XA2 @ XB2 @ (ccfv @ XG @ ccwlkson)) = (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : (cw3a @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ ccwlks)) @ ((ccfv @ ccc0 @ (ccv @ Xp)) = XA2) @ ((ccfv @ (ccfv @ (ccv @ Xf1) @ cchash) @ (ccv @ Xp)) = XB2))))))))))))).
