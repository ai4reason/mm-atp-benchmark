...
thf(a_0subg_ax,axiom,(! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XG @ cc0g)) => ((cwcel @ XG @ ccgrp) => (cwcel @ (ccsn @ Xc_0) @ (ccfv @ XG @ ccsubg))))))).
...
thf(atsmsgsum_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => (cwcel @ XG @ cccmn)) => ((Xph => (cwcel @ XG @ cctps)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwbr @ XF @ Xc_0 @ ccfsupp)) => ((XJ = (ccfv @ XG @ cctopn)) => (Xph => ((cco @ XG @ XF @ cctsu) = (ccfv @ (ccsn @ (cco @ XG @ XF @ ccgsu)) @ (ccfv @ XJ @ cccl))))))))))))))))))))).
...
thf(aeqgabl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((Xc_sm = (cco @ XG @ XS @ ccqg)) => (((cwcel @ XG @ ccabl) & (cwss @ XS @ XX)) => ((cwbr @ XA2 @ XB2 @ Xc_sm) <=> (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ (cco @ XB2 @ XA2 @ Xc_mi) @ XS))))))))))))))).
thf(aax_mp_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((Xph => Xps) => Xps))))).
thf(ccpr_tp,type,(ccpr : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(areleqg_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : ((XR = (cco @ XG @ XS @ ccqg)) => (cwrel @ XR)))))).
thf(arelelec_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwrel @ XR) => ((cwcel @ XA2 @ (ccec @ XB2 @ XR)) <=> (cwbr @ XB2 @ XA2 @ XR))))))).
thf(ccab_tp,type,(ccab : (($i > $o) > ($i > $o)))).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(cchmeo_tp,type,(cchmeo : ($i > $o))).
thf(asnclseqg_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XJ = (ccfv @ XG @ cctopn)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xc_sm = (cco @ XG @ XS @ ccqg)) => ((XS = (ccfv @ (ccsn @ Xc_0) @ (ccfv @ XJ @ cccl))) => (((cwcel @ XG @ cctgp) & (cwcel @ XA2 @ XX)) => ((ccec @ XA2 @ Xc_sm) = (ccfv @ (ccsn @ XA2) @ (ccfv @ XJ @ cccl))))))))))))))))).
...
thf(atsmscls_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XJ = (ccfv @ XG @ cctopn)) => ((Xph => (cwcel @ XG @ cccmn)) => ((Xph => (cwcel @ XG @ cctps)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwcel @ XX @ (cco @ XG @ XF @ cctsu))) => (Xph => (cwss @ (ccfv @ (ccsn @ XX) @ (ccfv @ XJ @ cccl)) @ (cco @ XG @ XF @ cctsu))))))))))))))))))).
thf(ctgptsmscls_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XJ = (ccfv @ XG @ cctopn)) => ((Xph => (cwcel @ XG @ cccmn)) => ((Xph => (cwcel @ XG @ cctgp)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwcel @ XX @ (cco @ XG @ XF @ cctsu))) => (Xph => ((cco @ XG @ XF @ cctsu) = (ccfv @ (ccsn @ XX) @ (ccfv @ XJ @ cccl)))))))))))))))))))).
