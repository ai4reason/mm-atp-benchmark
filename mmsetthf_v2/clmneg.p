...
thf(asubginv_ax,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XH = (cco @ XG @ XS @ ccress)) => ((XI = (ccfv @ XG @ ccminusg)) => ((XJ = (ccfv @ XH @ ccminusg)) => (((cwcel @ XS @ (ccfv @ XG @ ccsubg)) & (cwcel @ XX @ XS)) => ((ccfv @ XX @ XI) = (ccfv @ XX @ XJ))))))))))))).
...
thf(cclmneg_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (((cwcel @ XW @ ccclm) & (cwcel @ XA2 @ XK)) => ((ccneg @ XA2) = (ccfv @ XA2 @ (ccfv @ XF @ ccminusg))))))))))).
