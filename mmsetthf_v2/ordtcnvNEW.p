...
thf(cordtcnvNEW_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2))) => ((cwcel @ XK @ ccpreset) => ((ccfv @ (cccnv @ Xc_le) @ ccordt) = (ccfv @ Xc_le @ ccordt))))))))).
