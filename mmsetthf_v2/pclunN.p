...
thf(apclclN_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XS = (ccfv @ XK @ ccpsubsp)) => ((XU = (ccfv @ XK @ ccpclN)) => (((cwcel @ XK @ XV) & (cwss @ XX @ XA2)) => (cwcel @ (ccfv @ XX @ XU) @ XS)))))))))))).
...
thf(cpclunN_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => ((XU = (ccfv @ XK @ ccpclN)) => ((cw3a @ (cwcel @ XK @ XV) @ (cwss @ XX @ XA2) @ (cwss @ XY @ XA2)) => ((ccfv @ (ccun @ XX @ XY) @ XU) = (ccfv @ (cco @ XX @ XY @ Xc_pl) @ XU)))))))))))))).
