...
thf(achdmm2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((ccfv @ (ccin @ (ccfv @ XA2 @ ccort) @ XB2) @ ccort) = (cco @ XA2 @ (ccfv @ XB2 @ ccort) @ cchj))))))).
...
thf(cpjoml6i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwss @ XA2 @ XB2) => (cwrex @ (^ [Xx3:$i] : ((cwss @ XA2 @ (ccfv @ (ccv @ Xx3) @ ccort)) & ((cco @ XA2 @ (ccv @ Xx3) @ cchj) = XB2))) @ (^ [Xx3:$i] : ccch)))))))).
