...
thf(atglnne0_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ (ccrn @ XL))) => (Xph => (cwne @ XA2 @ cc0)))))))))).
...
thf(atglndim0_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => ((ccfv @ XB2 @ cchash) = cc1)) => (Xph => (~ (cwcel @ XA2 @ (ccrn @ XL)))))))))))))))).
...
thf(chpgerlem_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XO:($i > ($i > $o))] : ((XP = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccitv)) => ((! [Xt:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((XL @ Xt @ Xa @ Xb @ Xc) = (ccfv @ XG @ cclng)))))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwcel @ XG @ ccstrkg)))) => ((! [Xt:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((Xph @ Xa @ Xb) => (cwcel @ XD @ (ccrn @ (XL @ Xt @ Xa @ Xb @ Xc)))))))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwcel @ (XA2 @ Xa @ Xb) @ XP)))) => ((! [Xc:$i] : ((XO @ Xc) = (ccopab @ (^ [Xa:$i] : (^ [Xb:$i] : (((cwcel @ (ccv @ Xa) @ (ccdif @ XP @ XD)) & (cwcel @ (ccv @ Xb) @ (ccdif @ XP @ XD))) & (cwrex @ (^ [Xt:$i] : (cwcel @ (ccv @ Xt) @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ XI))) @ (^ [Xt:$i] : XD)))))))) => ((! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (~ (cwcel @ (XA2 @ Xa @ Xb) @ XD))))) => (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xa @ Xb) => (cwrex @ (^ [Xc:$i] : (cwbr @ (XA2 @ Xa @ Xb) @ (ccv @ Xc) @ (XO @ Xc))) @ (^ [Xc:$i] : XP)))))))))))))))))))))).
