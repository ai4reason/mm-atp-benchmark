...
thf(cdford2_conj,conjecture,(! [XA2:($i > $o)] : ((cword @ XA2) <=> ((cwtr @ XA2) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cw3o @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ ((ccv @ Xx3) = (ccv @ Xy1)) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))))).
