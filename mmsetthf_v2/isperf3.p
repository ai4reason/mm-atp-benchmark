...
thf(aisperf2_ax,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ ccperf) <=> ((cwcel @ XJ @ cctop) & (cwss @ XX @ (ccfv @ XX @ (ccfv @ XJ @ cclp))))))))).
...
thf(amaxlp_ax,axiom,(! [XP:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ cctop) => ((cwcel @ XP @ (ccfv @ XX @ (ccfv @ XJ @ cclp))) <=> ((cwcel @ XP @ XX) & (~ (cwcel @ (ccsn @ XP) @ XJ)))))))))).
thf(cisperf3_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ ccperf) <=> ((cwcel @ XJ @ cctop) & (cwral @ (^ [Xx3:$i] : (~ (cwcel @ (ccsn @ (ccv @ Xx3)) @ XJ))) @ (^ [Xx3:$i] : XX)))))))).
