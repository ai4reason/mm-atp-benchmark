...
thf(acbvral3v_ax,axiom,(! [Xph:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xps:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xch:($i > ($i > ($i > ($i > $o))))] : (! [Xth:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (((ccv @ Xx3) = (ccv @ Xw)) => ((Xph @ Xx3 @ Xy1 @ Xz @ Xv @ Xu) <=> (Xch @ Xy1 @ Xz @ Xw @ Xu))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (((ccv @ Xy1) = (ccv @ Xv)) => ((Xch @ Xy1 @ Xz @ Xw @ Xu) <=> (Xth @ Xx3 @ Xz @ Xw @ Xv))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (((ccv @ Xz) = (ccv @ Xu)) => ((Xth @ Xx3 @ Xz @ Xw @ Xv) <=> (Xps @ Xx3 @ Xy1 @ Xw @ Xv @ Xu))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xv @ Xu)) @ (^ [Xz:$i] : XC))) @ (^ [Xy1:$i] : (XB2 @ Xz @ Xu)))) @ (^ [Xx3:$i] : (XA2 @ Xy1 @ Xz @ Xv @ Xu))) <=> (cwral @ (^ [Xw:$i] : (cwral @ (^ [Xv:$i] : (cwral @ (^ [Xu:$i] : (Xps @ Xx3 @ Xy1 @ Xw @ Xv @ Xu)) @ (^ [Xu:$i] : XC))) @ (^ [Xv:$i] : (XB2 @ Xz @ Xu)))) @ (^ [Xw:$i] : (XA2 @ Xy1 @ Xz @ Xv @ Xu)))))))))))))))))))).
