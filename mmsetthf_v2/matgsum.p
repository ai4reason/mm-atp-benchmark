...
thf(amat0_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XG = (cco @ XR @ (ccxp @ XN @ XN) @ ccfrlm)) => (((cwcel @ XN @ ccfn) & (cwcel @ XR @ XV)) => ((ccfv @ XG @ cc0g) = (ccfv @ XA2 @ cc0g))))))))))).
...
thf(acsbmpt2_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : ((cwcel @ (XA2 @ Xx3) @ (XV @ Xx3)) => ((ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (XZ @ Xx3 @ Xy1))))) = (ccmpt @ (^ [Xy1:$i] : XY) @ (^ [Xy1:$i] : (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XZ @ Xx3 @ Xy1))))))))))))).
thf(cmatgsum_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [Xc_0:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : ((XA2 @ Xy1 @ Xi @ Xj) = (cco @ XN @ XR @ ccmat))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : ((XB2 @ Xy1 @ Xi @ Xj) = (ccfv @ (XA2 @ Xy1 @ Xi @ Xj) @ ccbs))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : ((Xc_0 @ Xy1 @ Xi @ Xj) = (ccfv @ (XA2 @ Xy1 @ Xi @ Xj) @ cc0g))))) => ((! [Xi:$i] : (! [Xj:$i] : ((Xph @ Xi @ Xj) => (cwcel @ XN @ ccfn)))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : ((Xph @ Xi @ Xj) => (cwcel @ XJ @ (XW @ Xy1 @ Xi @ Xj)))))) => ((! [Xi:$i] : (! [Xj:$i] : ((Xph @ Xi @ Xj) => (cwcel @ XR @ ccrg)))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : (((Xph @ Xi @ Xj) & (cwcel @ (ccv @ Xy1) @ XJ)) => (cwcel @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (XU @ Xy1 @ Xi @ Xj)))) @ (XB2 @ Xy1 @ Xi @ Xj)))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : ((Xph @ Xi @ Xj) => (cwbr @ (ccmpt @ (^ [Xy1:$i] : XJ) @ (^ [Xy1:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (XU @ Xy1 @ Xi @ Xj)))))) @ (Xc_0 @ Xy1 @ Xi @ Xj) @ ccfsupp))))) => (! [Xy1:$i] : (! [Xi:$i] : (! [Xj:$i] : ((Xph @ Xi @ Xj) => ((cco @ (XA2 @ Xy1 @ Xi @ Xj) @ (ccmpt @ (^ [Xy1:$i] : XJ) @ (^ [Xy1:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (XU @ Xy1 @ Xi @ Xj)))))) @ ccgsu) = (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ XR @ (ccmpt @ (^ [Xy1:$i] : XJ) @ (^ [Xy1:$i] : (XU @ Xy1 @ Xi @ Xj))) @ ccgsu))))))))))))))))))))))))))).
