...
thf(aasclfn_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XW @ ccascl)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => (cwfn @ XA2 @ XK))))))))).
...
thf(csubrgascl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((XP = (cco @ XI @ XR @ ccmpl)) => ((XA2 = (ccfv @ XP @ ccascl)) => ((XH = (cco @ XR @ XT @ ccress)) => ((XU = (cco @ XI @ XH @ ccmpl)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XT @ (ccfv @ XR @ ccsubrg))) => ((XC = (ccfv @ XU @ ccascl)) => (Xph => (XC = (ccres @ XA2 @ XT))))))))))))))))))))).
