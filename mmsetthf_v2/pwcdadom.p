...
thf(acanthwdom_ax,axiom,(! [XA2:($i > $o)] : (~ (cwbr @ (ccpw @ XA2) @ XA2 @ ccwdom)))).
...
thf(aunxpwdom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwbr @ (ccxp @ XA2 @ XA2) @ (ccun @ XB2 @ XC) @ ccdom) => ((cwbr @ XA2 @ XB2 @ ccwdom) | (cwbr @ XA2 @ XC @ ccdom))))))).
