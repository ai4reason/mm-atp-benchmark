...
thf(csymggen2_conj,conjecture,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : ((XT = (ccrn @ (ccfv @ XD @ ccpmtr))) => ((XG = (ccfv @ XD @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubmnd) @ ccmrc)) => ((cwcel @ XD @ ccfn) => ((ccfv @ XT @ XK) = XB2)))))))))))).
