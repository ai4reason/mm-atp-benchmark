...
thf(apsrlmod_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((Xph => (cwcel @ XI @ XV)) => ((Xph => (cwcel @ XR @ ccrg)) => (Xph => (cwcel @ XS @ cclmod))))))))))).
...
thf(apsrring_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((Xph => (cwcel @ XI @ XV)) => ((Xph => (cwcel @ XR @ ccrg)) => (Xph => (cwcel @ XS @ ccrg))))))))))).
...
thf(apsrass23_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [Xc_x:($i > ($i > $o))] : (! [Xc_xp:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xf1:$i] : ((XS @ Xf1) = (cco @ XI @ XR @ ccmps))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XI @ (XV @ Xf1)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XR @ ccrg))) => ((! [Xf1:$i] : ((XD @ Xf1) = (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn)) @ (^ [Xf1:$i] : (cco @ ccn0 @ XI @ ccmap))))) => ((! [Xf1:$i] : ((Xc_xp @ Xf1) = (ccfv @ (XS @ Xf1) @ ccmulr))) => ((! [Xf1:$i] : ((XB2 @ Xf1) = (ccfv @ (XS @ Xf1) @ ccbs))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XX @ (XB2 @ Xf1)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XY @ (XB2 @ Xf1)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XR @ cccrg))) => ((! [Xf1:$i] : ((XK @ Xf1) = (ccfv @ XR @ ccbs))) => ((! [Xf1:$i] : ((Xc_x @ Xf1) = (ccfv @ (XS @ Xf1) @ ccvsca))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ (XA2 @ Xf1) @ (XK @ Xf1)))) => (! [Xf1:$i] : ((Xph @ Xf1) => (((cco @ (cco @ (XA2 @ Xf1) @ XX @ (Xc_x @ Xf1)) @ XY @ (Xc_xp @ Xf1)) = (cco @ (XA2 @ Xf1) @ (cco @ XX @ XY @ (Xc_xp @ Xf1)) @ (Xc_x @ Xf1))) & ((cco @ XX @ (cco @ (XA2 @ Xf1) @ XY @ (Xc_x @ Xf1)) @ (Xc_xp @ Xf1)) = (cco @ (XA2 @ Xf1) @ (cco @ XX @ XY @ (Xc_xp @ Xf1)) @ (Xc_x @ Xf1)))))))))))))))))))))))))))))))).
...
thf(cpsrassa_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((Xph => (cwcel @ XI @ XV)) => ((Xph => (cwcel @ XR @ cccrg)) => (Xph => (cwcel @ XS @ ccasa))))))))))).
