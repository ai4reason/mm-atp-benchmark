...
thf(amrcssid_ax,axiom,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => (((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwss @ XU @ XX)) => (cwss @ XU @ (ccfv @ XU @ XF))))))))).
...
thf(amrcssv_ax,axiom,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => ((cwcel @ XC @ (ccfv @ XX @ ccmre)) => (cwss @ (ccfv @ XU @ XF) @ XX)))))))).
...
thf(amrcidm_ax,axiom,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => (((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwss @ XU @ XX)) => ((ccfv @ (ccfv @ XU @ XF) @ XF) = (ccfv @ XU @ XF))))))))).
thf(cmrcuni_conj,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => (((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwss @ XU @ (ccpw @ XX))) => ((ccfv @ (ccuni @ XU) @ XF) = (ccfv @ (ccuni @ (ccima @ XF @ XU)) @ XF))))))))).
