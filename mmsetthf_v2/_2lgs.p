...
thf(aprm2orodd_ax,axiom,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprime) => ((XP = cc2) | (~ (cwbr @ cc2 @ XP @ ccdvds)))))).
...
thf(a_2lgslem4_ax,axiom,(((cco @ cc2 @ cc2 @ cclgs) = cc1) <=> (cwcel @ (cco @ cc2 @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)))).
...
thf(advdsprime_ax,axiom,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XM @ ccn)) => ((cwbr @ XM @ XP @ ccdvds) <=> ((XM = XP) | (XM = cc1))))))).
thf(acom12_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps => Xch)) => (Xps => (Xph => Xch))))))).
thf(ampbiri_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xch => ((Xph => (Xps <=> Xch)) => (Xph => Xps))))))).
thf(az2even_ax,axiom,(cwbr @ cc2 @ cc2 @ ccdvds)).
...
thf(a_1nprm_ax,axiom,(~ (cwcel @ cc1 @ ccprime))).
thf(a_2z_ax,axiom,(cwcel @ cc2 @ ccz)).
thf(aeqcomd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => (XB2 = XA2))))))).
thf(cwf1o_tp,type,(cwf1o : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(ccaddc_tp,type,(ccaddc : ($i > $o))).
thf(a_2lgslem1_ax,axiom,(! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (~ (cwbr @ cc2 @ XP @ ccdvds))) => ((ccfv @ (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xi:$i] : (((ccv @ Xx3) = (cco @ (ccv @ Xi) @ cc2 @ ccmul)) & (cwbr @ (cco @ XP @ cc2 @ ccdiv) @ (cco @ (ccv @ Xx3) @ XP @ ccmo) @ cclt))) @ (^ [Xi:$i] : (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz)))) @ (^ [Xx3:$i] : ccz)) @ cchash) = (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin))))).
thf(ccc_tp,type,(ccc : ($i > $o))).
thf(agausslemma2d_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XH = (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((! [Xx3:$i] : ((XR @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XH @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ cc2 @ ccdiv) @ cclt) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ ccmin)))))) => ((XM = (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl)) => ((! [Xx3:$i] : ((XN @ Xx3) = (cco @ XH @ XM @ ccmin))) => (! [Xx3:$i] : (Xph => ((cco @ cc2 @ XP @ cclgs) = (cco @ (ccneg @ cc1) @ (XN @ Xx3) @ ccexp)))))))))))))))).
thf(a_3ad2ant1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xch) => ((cw3a @ Xph @ Xps @ Xth) => Xch))))))).
thf(abiimpri_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph <=> Xps) => (Xps => Xph))))).
thf(annoddn2prmb_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccdif @ ccprime @ (ccsn @ cc2))) <=> ((cwcel @ XN @ ccprime) & (~ (cwbr @ cc2 @ XN @ ccdvds)))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(a_2lgslem2_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin)) => (((cwcel @ XP @ ccprime) & (~ (cwbr @ cc2 @ XP @ ccdvds))) => (cwcel @ XN @ ccz)))))).
thf(am1exp1_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => (((cco @ (ccneg @ cc1) @ XN @ ccexp) = cc1) <=> (cwbr @ cc2 @ XN @ ccdvds))))).
...
thf(a_2lgslem3_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin)) => (((cwcel @ XP @ ccn) & (~ (cwbr @ cc2 @ XP @ ccdvds))) => ((cco @ XN @ cc2 @ ccmo) = (ccif @ (cwcel @ (cco @ XP @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)) @ ccc0 @ cc1))))))).
...
thf(c_2lgs_conj,conjecture,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprime) => (((cco @ cc2 @ XP @ cclgs) = cc1) <=> (cwcel @ (cco @ XP @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)))))).
