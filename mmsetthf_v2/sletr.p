...
thf(csletr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccsur) @ (cwcel @ XB2 @ ccsur) @ (cwcel @ XC @ ccsur)) => (((cwbr @ XA2 @ XB2 @ ccsle) & (cwbr @ XB2 @ XC @ ccsle)) => (cwbr @ XA2 @ XC @ ccsle))))))).
