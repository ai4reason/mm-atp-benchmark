...
thf(aimasf1omet_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (XU = (cco @ XF @ XR @ ccimas))) => ((Xph => (XV = (ccfv @ XR @ ccbs))) => ((Xph => (cwf1o @ XV @ XB2 @ XF)) => ((Xph => (cwcel @ XR @ XZ)) => ((XE = (ccres @ (ccfv @ XR @ ccds) @ (ccxp @ XV @ XV))) => ((XD = (ccfv @ XU @ ccds)) => ((Xph => (cwcel @ XE @ (ccfv @ XV @ ccme))) => (Xph => (cwcel @ XD @ (ccfv @ XB2 @ ccme)))))))))))))))))))).
