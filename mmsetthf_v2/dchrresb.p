...
thf(cdchrresb_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XZ = (ccfv @ XN @ cczn)) => ((XD = (ccfv @ XG @ ccbs)) => ((XU = (ccfv @ XZ @ ccui)) => ((Xph => (cwcel @ XX @ XD)) => ((Xph => (cwcel @ XY @ XD)) => (Xph => (((ccres @ XX @ XU) = (ccres @ XY @ XU)) <=> (XX = XY)))))))))))))))))).
