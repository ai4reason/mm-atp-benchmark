...
thf(ashftfval_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => ((cwcel @ XA2 @ ccc) => ((cco @ XF @ XA2 @ ccshi) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ ccc) & (cwbr @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ (ccv @ Xy1) @ XF))))))))))).
...
thf(c_2shfti_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ (cco @ XF @ XA2 @ ccshi) @ XB2 @ ccshi) = (cco @ XF @ (cco @ XA2 @ XB2 @ ccaddc) @ ccshi)))))))).
