...
thf(aznegclb_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XA2 @ ccz) <=> (cwcel @ (ccneg @ XA2) @ ccz))))).
...
thf(cabsz_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XA2 @ ccz) <=> (cwcel @ (ccfv @ XA2 @ ccabs) @ ccz))))).
