...
thf(cclwwlkn2_conj,conjecture,(! [XG:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ (cco @ cc2 @ XG @ ccclwwlkn)) <=> (cw3a @ ((ccfv @ XW @ cchash) = cc2) @ (cwcel @ XW @ (ccword @ (ccfv @ XG @ ccvtx))) @ (cwcel @ (ccpr @ (ccfv @ ccc0 @ XW) @ (ccfv @ cc1 @ XW)) @ (ccfv @ XG @ ccedg))))))).
