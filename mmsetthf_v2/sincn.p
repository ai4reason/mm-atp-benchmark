...
thf(adf_sin_ax,axiom,(ccsin = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ (cco @ cci @ (ccv @ Xx3) @ ccmul) @ cce) @ (ccfv @ (cco @ (ccneg @ cci) @ (ccv @ Xx3) @ ccmul) @ cce) @ ccmin) @ (cco @ cc2 @ cci @ ccmul) @ ccdiv))))).
