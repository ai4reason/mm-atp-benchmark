...
thf(acarden2a_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((ccfv @ XA2 @ cccrd) = (ccfv @ XB2 @ cccrd)) & (cwne @ (ccfv @ XA2 @ cccrd) @ cc0)) => (cwbr @ XA2 @ XB2 @ ccen))))).
...
thf(ccard1_conj,conjecture,(! [XA2:($i > $o)] : (((ccfv @ XA2 @ cccrd) = cc1o) <=> (? [Xx3:$i] : (XA2 = (ccsn @ (ccv @ Xx3))))))).
