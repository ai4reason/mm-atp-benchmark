...
thf(csubsubg_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((XH = (cco @ XG @ XS @ ccress)) => ((cwcel @ XS @ (ccfv @ XG @ ccsubg)) => ((cwcel @ XA2 @ (ccfv @ XH @ ccsubg)) <=> ((cwcel @ XA2 @ (ccfv @ XG @ ccsubg)) & (cwss @ XA2 @ XS)))))))))).
