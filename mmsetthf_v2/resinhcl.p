...
thf(asinhval_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ ccsin) @ cci @ ccdiv) = (cco @ (cco @ (ccfv @ XA2 @ cce) @ (ccfv @ (ccneg @ XA2) @ cce) @ ccmin) @ cc2 @ ccdiv))))).
...
thf(cresinhcl_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwcel @ (cco @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ ccsin) @ cci @ ccdiv) @ ccr)))).
