...
thf(ameetat2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((cw3a @ (cwcel @ XK @ ccol) @ (cwcel @ XX @ XB2) @ (cwcel @ XP @ XA2)) => ((cwcel @ (cco @ XX @ XP @ Xc_an) @ XA2) | ((cco @ XX @ XP @ Xc_an) = Xc_0))))))))))))))).
thf(catmod1i1m_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XP @ XA2)) @ (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2)) @ (cwbr @ (cco @ XX @ XP @ Xc_an) @ XZ @ Xc_le)) => ((cco @ (cco @ XX @ XP @ Xc_an) @ (cco @ XY @ XZ @ Xc_an) @ Xc_or) = (cco @ (cco @ (cco @ XX @ XP @ Xc_an) @ XY @ Xc_or) @ XZ @ Xc_an))))))))))))))))))).
