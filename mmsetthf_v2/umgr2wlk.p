...
thf(cumgr2wlk_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : ((! [Xf1:$i] : (! [Xp:$i] : ((XE @ Xf1 @ Xp) = (ccfv @ XG @ ccedg)))) => (! [Xf1:$i] : (! [Xp:$i] : ((cw3a @ (cwcel @ XG @ ccumgr) @ (cwcel @ (ccpr @ XA2 @ XB2) @ (XE @ Xf1 @ Xp)) @ (cwcel @ (ccpr @ XB2 @ XC) @ (XE @ Xf1 @ Xp))) => (? [Xf1:$i] : (? [Xp:$i] : (cw3a @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ ccwlks)) @ ((ccfv @ (ccv @ Xf1) @ cchash) = cc2) @ (cw3a @ (XA2 = (ccfv @ ccc0 @ (ccv @ Xp))) @ (XB2 = (ccfv @ cc1 @ (ccv @ Xp))) @ (XC = (ccfv @ cc2 @ (ccv @ Xp))))))))))))))))).
