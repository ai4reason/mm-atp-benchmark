...
thf(a_2ndvdsodd_ax,axiom,(! [XZ:($i > $o)] : ((cwcel @ XZ @ ccodd) => (~ (cwbr @ cc2 @ XZ @ ccdvds))))).
...
thf(c_2dvdsoddm1_conj,conjecture,(! [XZ:($i > $o)] : ((cwcel @ XZ @ ccodd) => (cwbr @ cc2 @ (cco @ XZ @ cc1 @ ccmin) @ ccdvds)))).
