...
thf(apoleloe_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((cwbr @ XA2 @ XB2 @ (ccun @ XR @ ccid)) <=> ((cwbr @ XA2 @ XB2 @ XR) | (XA2 = XB2))))))))).
thf(csomin1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwor @ XX @ XR) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX))) => (cwbr @ (ccif @ (cwbr @ XA2 @ XB2 @ XR) @ XA2 @ XB2) @ XA2 @ (ccun @ XR @ ccid)))))))).
