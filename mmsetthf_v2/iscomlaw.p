...
thf(ciscomlaw_conj,conjecture,(! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xc_op:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ Xc_op @ (XV @ Xx3 @ Xy1)) & (cwcel @ XM @ (XW @ Xx3 @ Xy1))) => ((cwbr @ Xc_op @ XM @ cccomlaw) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_op) = (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ Xc_op))) @ (^ [Xy1:$i] : XM))) @ (^ [Xx3:$i] : XM))))))))))).
