...
thf(aovolicc1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((XG = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = cc1) @ (ccop @ XA2 @ XB2) @ (ccop @ ccc0 @ ccc0))))) => (Xph => (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccicc) @ ccovol) @ (cco @ XB2 @ XA2 @ ccmin) @ ccle))))))))))).
...
thf(aovolicc2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((! [Xf1:$i] : ((XM @ Xf1) = (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xf1:$i] : ((cwss @ (cco @ XA2 @ XB2 @ ccicc) @ (ccuni @ (ccrn @ (cccom @ ccioo @ (ccv @ Xf1))))) & ((ccv @ Xy1) = (ccsup @ (ccrn @ (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (ccv @ Xf1)) @ cc1)) @ ccxr @ cclt)))) @ (^ [Xf1:$i] : (cco @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ ccn @ ccmap)))) @ (^ [Xy1:$i] : ccxr)))) => (Xph => (cwbr @ (cco @ XB2 @ XA2 @ ccmin) @ (ccfv @ (cco @ XA2 @ XB2 @ ccicc) @ ccovol) @ ccle))))))))))).
...
thf(covolicc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ ccle)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccicc) @ ccovol) = (cco @ XB2 @ XA2 @ ccmin)))))).
