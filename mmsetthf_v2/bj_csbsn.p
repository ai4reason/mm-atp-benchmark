...
thf(abj_csbsnlem_ax,axiom,(! [XA2:($i > $o)] : ((ccsb @ XA2 @ (^ [Xx3:$i] : (ccsn @ (ccv @ Xx3)))) = (ccsn @ XA2)))).
...
thf(cbj_csbsn_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [Xx3:$i] : ((ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (ccsn @ (ccv @ Xx3)))) = (ccsn @ (XA2 @ Xx3)))))).
