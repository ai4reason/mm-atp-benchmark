...
thf(amrcuni_ax,axiom,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => (((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwss @ XU @ (ccpw @ XX))) => ((ccfv @ (ccuni @ XU) @ XF) = (ccfv @ (ccuni @ (ccima @ XF @ XU)) @ XF))))))))).
...
thf(cisacs4lem_conj,conjecture,(! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccfv @ XC @ ccmrc)) => (((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwral @ (^ [Xs1:$i] : ((cwcel @ (ccfv @ (ccv @ Xs1) @ ccipo) @ ccdrs) => (cwcel @ (ccuni @ (ccv @ Xs1)) @ XC))) @ (^ [Xs1:$i] : (ccpw @ XC)))) => ((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwral @ (^ [Xt:$i] : ((cwcel @ (ccfv @ (ccv @ Xt) @ ccipo) @ ccdrs) => ((ccfv @ (ccuni @ (ccv @ Xt)) @ XF) = (ccuni @ (ccima @ XF @ (ccv @ Xt)))))) @ (^ [Xt:$i] : (ccpw @ (ccpw @ XX))))))))))).
