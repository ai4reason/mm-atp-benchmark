...
thf(ar1pval_ax,axiom,(! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XE = (ccfv @ XR @ ccr1p)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XQ = (ccfv @ XR @ ccq1p)) => ((Xc_x = (ccfv @ XP @ ccmulr)) => ((Xc_mi = (ccfv @ XP @ ccsg)) => (((cwcel @ XF @ XB2) & (cwcel @ XG @ XB2)) => ((cco @ XF @ XG @ XE) = (cco @ XF @ (cco @ (cco @ XF @ XG @ XQ) @ XG @ Xc_x) @ Xc_mi))))))))))))))))))).
...
thf(cr1pid_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XC = (ccfv @ XR @ ccuc1p)) => ((XQ = (ccfv @ XR @ ccq1p)) => ((XE = (ccfv @ XR @ ccr1p)) => ((Xc_x = (ccfv @ XP @ ccmulr)) => ((Xc_pl = (ccfv @ XP @ ccplusg)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XC)) => (XF = (cco @ (cco @ (cco @ XF @ XG @ XQ) @ XG @ Xc_x) @ (cco @ XF @ XG @ XE) @ Xc_pl))))))))))))))))))))).
