...
thf(algsqrlem2_ax,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [Xc_ex:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [Xc_mi:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((XY = (ccfv @ XP @ cczn)) => ((! [Xy1:$i] : ((XS @ Xy1) = (ccfv @ XY @ ccpl1))) => ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccfv @ (XS @ Xy1) @ ccbs))) => ((! [Xy1:$i] : ((XD @ Xy1) = (ccfv @ XY @ ccdg1))) => ((XO = (ccfv @ XY @ cce1)) => ((! [Xy1:$i] : ((Xc_ex @ Xy1) = (ccfv @ (ccfv @ (XS @ Xy1) @ ccmgp) @ ccmg))) => ((! [Xy1:$i] : ((XX @ Xy1) = (ccfv @ XY @ ccv1))) => ((! [Xy1:$i] : ((Xc_mi @ Xy1) = (ccfv @ (XS @ Xy1) @ ccsg))) => ((! [Xy1:$i] : ((Xc_1 @ Xy1) = (ccfv @ (XS @ Xy1) @ ccur))) => ((! [Xy1:$i] : (XT = (cco @ (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (XX @ Xy1) @ (Xc_ex @ Xy1)) @ (Xc_1 @ Xy1) @ (Xc_mi @ Xy1)))) => ((XL = (ccfv @ XY @ cczrh)) => ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((! [Xy1:$i] : ((XG @ Xy1) = (ccmpt @ (^ [Xy1:$i] : (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz)) @ (^ [Xy1:$i] : (ccfv @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ XL))))) => (! [Xy1:$i] : (Xph => (cwf1 @ (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz) @ (ccima @ (cccnv @ (ccfv @ XT @ XO)) @ (ccsn @ (ccfv @ XY @ cc0g))) @ (XG @ Xy1)))))))))))))))))))))))))))))))).
...
thf(aznfld_ax,axiom,(! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XN @ cczn)) => ((cwcel @ XN @ ccprime) => (cwcel @ XY @ ccfield)))))).
thf(ccdr_tp,type,(ccdr : ($i > $o))).
thf(afldidom_ax,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccfield) => (cwcel @ XR @ ccidom)))).
...
thf(adeg1scl_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XK = (ccfv @ XR @ ccbs)) => ((XA2 = (ccfv @ XP @ ccascl)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XK) @ (cwne @ XF @ Xc_0)) => ((ccfv @ (ccfv @ XF @ XA2) @ XD) = ccc0))))))))))))))).
...
thf(af1finf1o_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccen) & (cwcel @ XB2 @ ccfn)) => ((cwf1 @ XA2 @ XB2 @ XF) <=> (cwf1o @ XA2 @ XB2 @ XF))))))).
...
thf(algsqrlem3_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [Xc_ex:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [Xc_mi:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((XY = (ccfv @ XP @ cczn)) => ((! [Xy1:$i] : ((XS @ Xy1) = (ccfv @ XY @ ccpl1))) => ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccfv @ (XS @ Xy1) @ ccbs))) => ((! [Xy1:$i] : ((XD @ Xy1) = (ccfv @ XY @ ccdg1))) => ((XO = (ccfv @ XY @ cce1)) => ((! [Xy1:$i] : ((Xc_ex @ Xy1) = (ccfv @ (ccfv @ (XS @ Xy1) @ ccmgp) @ ccmg))) => ((! [Xy1:$i] : ((XX @ Xy1) = (ccfv @ XY @ ccv1))) => ((! [Xy1:$i] : ((Xc_mi @ Xy1) = (ccfv @ (XS @ Xy1) @ ccsg))) => ((! [Xy1:$i] : ((Xc_1 @ Xy1) = (ccfv @ (XS @ Xy1) @ ccur))) => ((! [Xy1:$i] : (XT = (cco @ (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (XX @ Xy1) @ (Xc_ex @ Xy1)) @ (Xc_1 @ Xy1) @ (Xc_mi @ Xy1)))) => ((XL = (ccfv @ XY @ cczrh)) => ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((! [Xy1:$i] : ((XG @ Xy1) = (ccmpt @ (^ [Xy1:$i] : (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz)) @ (^ [Xy1:$i] : (ccfv @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ XL))))) => ((! [Xy1:$i] : (Xph => (cwcel @ (XA2 @ Xy1) @ ccz))) => ((! [Xy1:$i] : (Xph => ((cco @ (XA2 @ Xy1) @ XP @ cclgs) = cc1))) => (! [Xy1:$i] : (Xph => (cwcel @ (ccfv @ (XA2 @ Xy1) @ XL) @ (ccima @ (cccnv @ (ccfv @ XT @ XO)) @ (ccsn @ (ccfv @ XY @ cc0g))))))))))))))))))))))))))))))))))))).
...
thf(clgsqrlem4_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > $o))] : (! [Xc_1:($i > ($i > ($i > $o)))] : (! [Xc_ex:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [Xc_mi:($i > ($i > ($i > $o)))] : (! [XO:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > $o)] : ((XY = (ccfv @ XP @ cczn)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XS @ Xx3 @ Xy1) = (ccfv @ XY @ ccpl1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xx3 @ Xy1) = (ccfv @ (XS @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XD @ Xx3 @ Xy1) = (ccfv @ XY @ ccdg1)))) => ((! [Xx3:$i] : ((XO @ Xx3) = (ccfv @ XY @ cce1))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_ex @ Xx3 @ Xy1) = (ccfv @ (ccfv @ (XS @ Xx3 @ Xy1) @ ccmgp) @ ccmg)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XX @ Xx3 @ Xy1) = (ccfv @ XY @ ccv1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_mi @ Xx3 @ Xy1) = (ccfv @ (XS @ Xx3 @ Xy1) @ ccsg)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_1 @ Xx3 @ Xy1) = (ccfv @ (XS @ Xx3 @ Xy1) @ ccur)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XT @ Xx3) = (cco @ (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (XX @ Xx3 @ Xy1) @ (Xc_ex @ Xx3 @ Xy1)) @ (Xc_1 @ Xx3 @ Xy1) @ (Xc_mi @ Xx3 @ Xy1))))) => ((XL = (ccfv @ XY @ cczrh)) => ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((! [Xy1:$i] : ((XG @ Xy1) = (ccmpt @ (^ [Xy1:$i] : (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz)) @ (^ [Xy1:$i] : (ccfv @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ XL))))) => ((! [Xy1:$i] : (Xph => (cwcel @ (XA2 @ Xy1) @ ccz))) => ((! [Xy1:$i] : (Xph => ((cco @ (XA2 @ Xy1) @ XP @ cclgs) = cc1))) => (! [Xy1:$i] : (Xph => (cwrex @ (^ [Xx3:$i] : (cwbr @ XP @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (XA2 @ Xy1) @ ccmin) @ ccdvds)) @ (^ [Xx3:$i] : ccz))))))))))))))))))))))))))))))))))).
