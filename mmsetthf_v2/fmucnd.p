...
thf(acfilufbas_ax,axiom,(! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ XF @ (ccfv @ XU @ cccfilu))) => (cwcel @ XF @ (ccfv @ XX @ ccfbas))))))).
...
thf(afbasrn_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : ((XC @ Xx3) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccima @ XF @ (ccv @ Xx3))))))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XB2 @ (ccfv @ XX @ ccfbas)) @ (cwf @ XX @ XY @ XF) @ (cwcel @ XY @ XV)) => (cwcel @ (XC @ Xx3) @ (ccfv @ XY @ ccfbas)))))))))))).
...
thf(afbelss_ax,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XF @ (ccfv @ XB2 @ ccfbas)) & (cwcel @ XX @ XF)) => (cwss @ XX @ XB2)))))).
thf(cc2nd_tp,type,(cc2nd : ($i > $o))).
thf(cc1st_tp,type,(cc1st : ($i > $o))).
thf(afmucndlem_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwfn @ XF @ XX) & (cwss @ XA2 @ XX)) => ((ccima @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF))))) @ (ccxp @ XA2 @ XA2)) = (ccxp @ (ccima @ XF @ XA2) @ (ccima @ XF @ XA2)))))))).
...
thf(aucnprima_ax,axiom,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((Xph => (cwcel @ XU @ (ccfv @ XX @ ccust))) => ((! [Xy1:$i] : (Xph => (cwcel @ (XV @ Xy1) @ (ccfv @ (XY @ Xy1) @ ccust)))) => ((! [Xy1:$i] : (Xph => (cwcel @ XF @ (cco @ XU @ (XV @ Xy1) @ ccucn)))) => ((! [Xy1:$i] : (Xph => (cwcel @ XW @ (XV @ Xy1)))) => ((XG = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF)))))) => (Xph => (cwcel @ (ccima @ (cccnv @ XG) @ XW) @ XU)))))))))))))))).
...
thf(acfiluexsm_ax,axiom,(! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xa:$i] : ((cw3a @ (cwcel @ (XU @ Xa) @ (ccfv @ (XX @ Xa) @ ccust)) @ (cwcel @ XF @ (ccfv @ (XU @ Xa) @ cccfilu)) @ (cwcel @ XV @ (XU @ Xa))) => (cwrex @ (^ [Xa:$i] : (cwss @ (ccxp @ (ccv @ Xa) @ (ccv @ Xa)) @ XV)) @ (^ [Xa:$i] : XF))))))))).
...
thf(cfmucnd_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xa:$i] : (Xph => (cwcel @ (XU @ Xa) @ (ccfv @ XX @ ccust)))) => ((Xph => (cwcel @ XV @ (ccfv @ XY @ ccust))) => ((! [Xa:$i] : (Xph => (cwcel @ XF @ (cco @ (XU @ Xa) @ XV @ ccucn)))) => ((! [Xa:$i] : (Xph => (cwcel @ XC @ (ccfv @ (XU @ Xa) @ cccfilu)))) => ((XD = (ccrn @ (ccmpt @ (^ [Xa:$i] : XC) @ (^ [Xa:$i] : (ccima @ XF @ (ccv @ Xa)))))) => (Xph => (cwcel @ XD @ (ccfv @ XV @ cccfilu))))))))))))))))).
