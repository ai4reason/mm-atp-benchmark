...
thf(adifcom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ (ccdif @ XA2 @ XB2) @ XC) <=> (cwss @ (ccdif @ XA2 @ XC) @ XB2)))))).
thf(adfpss3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwpss @ XA2 @ XB2) <=> ((cwss @ XA2 @ XB2) & (~ (cwss @ XB2 @ XA2))))))).
thf(cpssdifcom2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwss @ XA2 @ XC) & (cwss @ XB2 @ XC)) => ((cwpss @ XB2 @ (ccdif @ XC @ XA2)) <=> (cwpss @ XA2 @ (ccdif @ XC @ XB2)))))))).
