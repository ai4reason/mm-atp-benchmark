...
thf(aelss2prb_ax,axiom,(! [XP:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XP @ (ccrab @ (^ [Xz:$i] : ((ccfv @ (ccv @ Xz) @ cchash) = cc2)) @ (^ [Xz:$i] : (ccpw @ XV)))) <=> (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) & (XP = (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : XV))) @ (^ [Xx3:$i] : XV)))))).
...
thf(chash2sspr_conj,conjecture,(! [XP:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XP @ (ccpw @ XV)) & ((ccfv @ XP @ cchash) = cc2)) => (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (XP = (ccpr @ (ccv @ Xa) @ (ccv @ Xb)))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV)))))).
