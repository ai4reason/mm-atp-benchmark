...
thf(cfsumshftm_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XK @ ccz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XN @ ccz)) => ((! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ (cco @ XM @ XN @ ccfz))) => (cwcel @ (XA2 @ Xj) @ ccc))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xj) = (cco @ (ccv @ Xk) @ XK @ ccaddc)) => ((XA2 @ Xj) = (XB2 @ Xk))))) => (Xph => ((ccsu @ (cco @ XM @ XN @ ccfz) @ (^ [Xj:$i] : (XA2 @ Xj))) = (ccsu @ (cco @ (cco @ XM @ XK @ ccmin) @ (cco @ XN @ XK @ ccmin) @ ccfz) @ (^ [Xk:$i] : (XB2 @ Xk))))))))))))))))).
