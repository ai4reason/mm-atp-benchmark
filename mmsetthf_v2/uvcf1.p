...
thf(auvcvv1_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XU = (cco @ XR @ XI @ ccuvc)) => ((Xph => (cwcel @ XR @ XV)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XJ @ XI)) => ((Xc_1 = (ccfv @ XR @ ccur)) => (Xph => ((ccfv @ XJ @ (ccfv @ XJ @ XU)) = Xc_1)))))))))))))))).
...
thf(cuvcf1_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XU = (cco @ XR @ XI @ ccuvc)) => ((XY = (cco @ XR @ XI @ ccfrlm)) => ((XB2 = (ccfv @ XY @ ccbs)) => (((cwcel @ XR @ ccnzr) & (cwcel @ XI @ XW)) => (cwf1 @ XI @ XB2 @ XU)))))))))))).
