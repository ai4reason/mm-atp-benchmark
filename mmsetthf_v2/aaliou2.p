...
thf(aaaliou_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xq:$i] : (! [Xp:$i] : ((XN @ Xq @ Xp) = (ccfv @ XF @ ccdgr)))) => ((Xph => (cwcel @ XF @ (ccfv @ ccz @ ccply))) => ((! [Xq:$i] : (! [Xp:$i] : (Xph => (cwcel @ (XN @ Xq @ Xp) @ ccn)))) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => ((ccfv @ XA2 @ XF) = ccc0)) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xp:$i] : (cwral @ (^ [Xq:$i] : ((XA2 = (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv)) | (cwbr @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xq) @ (XN @ Xq @ Xp) @ ccexp) @ ccdiv) @ (ccfv @ (cco @ XA2 @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv) @ ccmin) @ ccabs) @ cclt))) @ (^ [Xq:$i] : ccn))) @ (^ [Xp:$i] : ccz))) @ (^ [Xx3:$i] : ccrp))))))))))))).
...
thf(caaliou2_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccin @ ccaa @ ccr)) => (cwrex @ (^ [Xk:$i] : (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xp:$i] : (cwral @ (^ [Xq:$i] : ((XA2 = (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv)) | (cwbr @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xq) @ (ccv @ Xk) @ ccexp) @ ccdiv) @ (ccfv @ (cco @ XA2 @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv) @ ccmin) @ ccabs) @ cclt))) @ (^ [Xq:$i] : ccn))) @ (^ [Xp:$i] : ccz))) @ (^ [Xx3:$i] : ccrp))) @ (^ [Xk:$i] : ccn))))).
