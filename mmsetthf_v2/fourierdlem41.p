...
thf(aeqleltd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((XA2 = XB2) <=> ((cwbr @ XA2 @ XB2 @ ccle) & (~ (cwbr @ XA2 @ XB2 @ cclt))))))))))).
...
thf(anegsubdid_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => (Xph => ((ccneg @ (cco @ XA2 @ XB2 @ ccmin)) = (cco @ (ccneg @ XA2) @ XB2 @ ccaddc))))))))).
...
thf(asubaddd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => (Xph => (((cco @ XA2 @ XB2 @ ccmin) = XC) <=> ((cco @ XB2 @ XC @ ccaddc) = XA2))))))))))).
...
thf(asubsub23d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => (Xph => (((cco @ XA2 @ XB2 @ ccmin) = XC) <=> ((cco @ XA2 @ XC @ ccmin) = XB2))))))))))).
...
thf(aneneq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwne @ XA2 @ XB2) => (~ (XA2 = XB2)))))).
...
thf(cfourierdlem41_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwcel @ (XA2 @ Xy1 @ Xi @ Xk) @ ccr))))))) => ((! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwcel @ XB2 @ ccr)))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwbr @ (XA2 @ Xy1 @ Xi @ Xk) @ XB2 @ cclt))))))) => ((! [Xy1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : ((XT @ Xi @ Xm @ Xp) = (cco @ XB2 @ (XA2 @ Xy1 @ Xi @ Xk) @ ccmin))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : ((cw3a @ (Xph @ Xm @ Xp) @ (cwcel @ (ccv @ Xx3) @ (XD @ Xm @ Xp)) @ (cwcel @ (ccv @ Xk) @ ccz)) => (cwcel @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xk) @ (XT @ Xi @ Xm @ Xp) @ ccmul) @ ccaddc) @ (XD @ Xm @ Xp)))))))) => ((! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwcel @ (XX @ Xm @ Xp) @ ccr)))) => ((! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : ((XZ @ Xi @ Xm @ Xp) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (ccfv @ (cco @ (cco @ XB2 @ (ccv @ Xx3) @ ccmin) @ (XT @ Xi @ Xm @ Xp) @ ccdiv) @ ccfl) @ (XT @ Xi @ Xm @ Xp) @ ccmul))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : ((XE @ Xx3 @ Xm @ Xp) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ (XZ @ Xi @ Xm @ Xp)) @ ccaddc)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : ((XP @ Xx3 @ Xy1 @ Xi @ Xk @ Xm @ Xp) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccrab @ (^ [Xp:$i] : ((((ccfv @ ccc0 @ (ccv @ Xp)) = (XA2 @ Xy1 @ Xi @ Xk)) & ((ccfv @ (ccv @ Xm) @ (ccv @ Xp)) = XB2)) & (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xm) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ ccr @ (cco @ ccc0 @ (ccv @ Xm) @ ccfz) @ ccmap)))))))))))) => ((! [Xx3:$i] : (! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwcel @ (XM @ Xx3) @ ccn))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => (cwcel @ (XQ @ Xx3 @ Xm) @ (ccfv @ (XM @ Xx3) @ (XP @ Xx3 @ Xy1 @ Xi @ Xk @ Xm @ Xp)))))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xm:$i] : (! [Xp:$i] : (((Xph @ Xm @ Xp) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ (XM @ Xx3) @ ccfzo))) => (cwss @ (cco @ (ccfv @ (ccv @ Xi) @ (XQ @ Xx3 @ Xm)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XQ @ Xx3 @ Xm)) @ ccioo) @ (XD @ Xm @ Xp))))))) => (! [Xm:$i] : (! [Xp:$i] : ((Xph @ Xm @ Xp) => ((cwrex @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xy1) @ (XX @ Xm @ Xp) @ cclt) & (cwss @ (cco @ (ccv @ Xy1) @ (XX @ Xm @ Xp) @ ccioo) @ (XD @ Xm @ Xp)))) @ (^ [Xy1:$i] : ccr)) & (cwrex @ (^ [Xy1:$i] : ((cwbr @ (XX @ Xm @ Xp) @ (ccv @ Xy1) @ cclt) & (cwss @ (cco @ (XX @ Xm @ Xp) @ (ccv @ Xy1) @ ccioo) @ (XD @ Xm @ Xp)))) @ (^ [Xy1:$i] : ccr)))))))))))))))))))))))))))))).
