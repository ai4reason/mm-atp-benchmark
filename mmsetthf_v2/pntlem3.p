...
thf(ainfregelb_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (((cw3a @ (cwss @ XA2 @ ccr) @ (cwne @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr))) & (cwcel @ (XB2 @ Xx3 @ Xy1) @ ccr)) => ((cwbr @ (XB2 @ Xx3 @ Xy1) @ (ccinf @ XA2 @ ccr @ cclt) @ ccle) <=> (cwral @ (^ [Xz:$i] : (cwbr @ (XB2 @ Xx3 @ Xy1) @ (ccv @ Xz) @ ccle)) @ (^ [Xz:$i] : XA2))))))))).
