...
thf(aac7_ax,axiom,(! [Xx3:$i] : (? [Xf1:$i] : ((cwss @ (ccv @ Xf1) @ (ccv @ Xx3)) & (cwfn @ (ccv @ Xf1) @ (ccdm @ (ccv @ Xx3))))))).
thf(cac7g_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [Xf1:$i] : ((cwcel @ XR @ (XA2 @ Xf1)) => (? [Xf1:$i] : ((cwss @ (ccv @ Xf1) @ XR) & (cwfn @ (ccv @ Xf1) @ (ccdm @ XR))))))))).
