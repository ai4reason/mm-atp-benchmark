...
thf(ao1co_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwcel @ XF @ cco1)) => ((Xph => (cwf @ XB2 @ XA2 @ XG)) => ((Xph => (cwss @ XB2 @ ccr)) => ((! [Xm:$i] : ((Xph & (cwcel @ (ccv @ Xm) @ ccr)) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle) => (cwbr @ (ccv @ Xm) @ (ccfv @ (ccv @ Xy1) @ XG) @ ccle))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : ccr)))) => (Xph => (cwcel @ (cccom @ XF @ XG) @ cco1))))))))))))).
