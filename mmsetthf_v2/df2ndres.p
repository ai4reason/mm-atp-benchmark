...
thf(adf2nd2_ax,axiom,((ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : ((ccv @ Xz) = (ccv @ Xy1)))))) = (ccres @ cc2nd @ (ccxp @ ccvv @ ccvv)))).
thf(aresoprab_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccres @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))) @ (ccxp @ XA2 @ XB2)) = (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XB2)) & (Xph @ Xx3 @ Xy1 @ Xz))))))))))).
...
thf(cdf2ndres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccres @ cc2nd @ (ccxp @ XA2 @ XB2)) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XA2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xy1)))))))).
