...
thf(ahalfpos2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwbr @ ccc0 @ XA2 @ cclt) <=> (cwbr @ ccc0 @ (cco @ XA2 @ cc2 @ ccdiv) @ cclt))))).
...
thf(asincosq1lem_ax,axiom,(! [XA2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwbr @ ccc0 @ XA2 @ cclt) @ (cwbr @ XA2 @ (cco @ ccpi @ cc2 @ ccdiv) @ cclt)) => (cwbr @ ccc0 @ (ccfv @ XA2 @ ccsin) @ cclt)))).
...
thf(altsubpos_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ ccc0 @ XA2 @ cclt) <=> (cwbr @ (cco @ XB2 @ XA2 @ ccmin) @ XB2 @ cclt)))))).
...
thf(asinhalfpim_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (cco @ (cco @ ccpi @ cc2 @ ccdiv) @ XA2 @ ccmin) @ ccsin) = (ccfv @ XA2 @ cccos))))).
...
thf(aaxmulgt0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (((cwbr @ ccc0 @ XA2 @ cclt) & (cwbr @ ccc0 @ XB2 @ cclt)) => (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul) @ cclt)))))).
...
thf(csinq12gt0_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ ccpi @ ccioo)) => (cwbr @ ccc0 @ (ccfv @ XA2 @ ccsin) @ cclt)))).
