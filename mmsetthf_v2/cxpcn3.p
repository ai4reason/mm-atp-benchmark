...
thf(acnmpt2res_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XK @ Xx3 @ Xy1) = (cco @ (XJ @ Xx3 @ Xy1) @ XY @ ccrest)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (XJ @ Xx3 @ Xy1) @ (ccfv @ XX @ cctopon))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwss @ XY @ XX)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XN @ Xx3 @ Xy1) = (cco @ (XM @ Xx3 @ Xy1) @ XW @ ccrest)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (XM @ Xx3 @ Xy1) @ (ccfv @ XZ @ cctopon))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwss @ XW @ XZ)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XZ)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1)))) @ (cco @ (cco @ (XJ @ Xx3 @ Xy1) @ (XM @ Xx3 @ Xy1) @ cctx) @ (XL @ Xx3 @ Xy1) @ cccn))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwcel @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XW)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1)))) @ (cco @ (cco @ (XK @ Xx3 @ Xy1) @ (XN @ Xx3 @ Xy1) @ cctx) @ (XL @ Xx3 @ Xy1) @ cccn)))))))))))))))))))))))).
...
thf(acxpcn2_ax,axiom,(! [XJ:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XK @ Xx3 @ Xy1) = (cco @ XJ @ ccrp @ ccrest)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccrp)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccc)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ cccxp)))) @ (cco @ (cco @ (XK @ Xx3 @ Xy1) @ XJ @ cctx) @ XJ @ cccn))))))))).
...
thf(acxpcn3lem_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > ($i > $o))))] : (! [XE:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((XD = (ccima @ (cccnv @ ccre) @ ccrp)) => ((! [Xa:$i] : (! [Xb:$i] : ((XJ @ Xa @ Xb) = (ccfv @ cccnfld @ cctopn)))) => ((! [Xa:$i] : (! [Xb:$i] : (XK = (cco @ (XJ @ Xa @ Xb) @ (cco @ ccc0 @ ccpnf @ ccico) @ ccrest)))) => ((! [Xa:$i] : (! [Xb:$i] : (XL = (cco @ (XJ @ Xa @ Xb) @ XD @ ccrest)))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xd:$i] : ((XU @ Xa @ Xb @ Xd) = (cco @ (ccif @ (cwbr @ (ccfv @ XA2 @ ccre) @ cc1 @ ccle) @ (ccfv @ XA2 @ ccre) @ cc1) @ cc2 @ ccdiv))))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xd:$i] : (XT = (ccif @ (cwbr @ (XU @ Xa @ Xb @ Xd) @ (cco @ XE @ (cco @ cc1 @ (XU @ Xa @ Xb @ Xd) @ ccdiv) @ cccxp) @ ccle) @ (XU @ Xa @ Xb @ Xd) @ (cco @ XE @ (cco @ cc1 @ (XU @ Xa @ Xb @ Xd) @ ccdiv) @ cccxp)))))) => (((cwcel @ XA2 @ XD) & (cwcel @ XE @ ccrp)) => (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (((cwbr @ (ccfv @ (ccv @ Xa) @ ccabs) @ (ccv @ Xd) @ cclt) & (cwbr @ (ccfv @ (cco @ XA2 @ (ccv @ Xb) @ ccmin) @ ccabs) @ (ccv @ Xd) @ cclt)) => (cwbr @ (ccfv @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ cccxp) @ ccabs) @ XE @ cclt))) @ (^ [Xb:$i] : XD))) @ (^ [Xa:$i] : (cco @ ccc0 @ ccpnf @ ccico)))) @ (^ [Xd:$i] : ccrp)))))))))))))))))).
...
thf(a_0cxpd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwne @ XA2 @ ccc0)) => (Xph => ((cco @ ccc0 @ XA2 @ cccxp) = ccc0))))))).
...
thf(are0_ax,axiom,((ccfv @ ccc0 @ ccre) = ccc0)).
...
thf(ccxpcn3_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > $o)))] : ((XD = (ccima @ (cccnv @ ccre) @ ccrp)) => ((XJ = (ccfv @ cccnfld @ cctopn)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XK @ Xx3 @ Xy1) = (cco @ XJ @ (cco @ ccc0 @ ccpnf @ ccico) @ ccrest)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XL @ Xx3 @ Xy1) = (cco @ XJ @ XD @ ccrest)))) => (! [Xx3:$i] : (! [Xy1:$i] : (cwcel @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ ccc0 @ ccpnf @ ccico))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XD)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ cccxp)))) @ (cco @ (cco @ (XK @ Xx3 @ Xy1) @ (XL @ Xx3 @ Xy1) @ cctx) @ XJ @ cccn))))))))))))).
