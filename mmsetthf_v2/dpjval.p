...
thf(adpjfval_ax,axiom,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((Xph => (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((Xph => ((ccdm @ XS) = XI)) => ((! [Xi:$i] : ((XP @ Xi) = (cco @ XG @ XS @ ccdpj))) => ((! [Xi:$i] : ((XQ @ Xi) = (ccfv @ XG @ ccpj1))) => (! [Xi:$i] : (Xph => ((XP @ Xi) = (ccmpt @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XS) @ (cco @ XG @ (ccres @ XS @ (ccdif @ XI @ (ccsn @ (ccv @ Xi)))) @ ccdprd) @ (XQ @ Xi)))))))))))))))))).
...
thf(cdpjval_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((Xph => ((ccdm @ XS) = XI)) => ((XP = (cco @ XG @ XS @ ccdpj)) => ((XQ = (ccfv @ XG @ ccpj1)) => ((Xph => (cwcel @ XX @ XI)) => (Xph => ((ccfv @ XX @ XP) = (cco @ (ccfv @ XX @ XS) @ (cco @ XG @ (ccres @ XS @ (ccdif @ XI @ (ccsn @ XX))) @ ccdprd) @ XQ)))))))))))))))).
