...
thf(ahvmulassi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwcel @ XC @ cchil) => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ XC @ ccsm) = (cco @ XA2 @ (cco @ XB2 @ XC @ ccsm) @ ccsm))))))))).
...
thf(chvnegdii_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cco @ (ccneg @ cc1) @ (cco @ XA2 @ XB2 @ ccmv) @ ccsm) = (cco @ XB2 @ XA2 @ ccmv))))))).
