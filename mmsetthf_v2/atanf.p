...
thf(adf_atan_ax,axiom,(ccatan = (ccmpt @ (^ [Xx3:$i] : (ccdif @ ccc @ (ccpr @ (ccneg @ cci) @ cci))) @ (^ [Xx3:$i] : (cco @ (cco @ cci @ cc2 @ ccdiv) @ (cco @ (ccfv @ (cco @ cc1 @ (cco @ cci @ (ccv @ Xx3) @ ccmul) @ ccmin) @ cclog) @ (ccfv @ (cco @ cc1 @ (cco @ cci @ (ccv @ Xx3) @ ccmul) @ ccaddc) @ cclog) @ ccmin) @ ccmul))))).
...
thf(catanf_conj,conjecture,(cwf @ (ccdif @ ccc @ (ccpr @ (ccneg @ cci) @ cci)) @ ccc @ ccatan)).
