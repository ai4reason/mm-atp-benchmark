...
thf(aalephreg_ax,axiom,(! [XA2:($i > $o)] : ((ccfv @ (ccfv @ (ccsuc @ XA2) @ ccale) @ cccf) = (ccfv @ (ccsuc @ XA2) @ ccale)))).
...
thf(acoflim_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwlim @ XA2) & (cwss @ XB2 @ XA2)) => (((ccuni @ XB2) = XA2) <=> (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))).
...
thf(akonigth_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => ((! [Xi:$i] : ((XS @ Xi) = (cciun @ (^ [Xi:$i] : XA2) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (XM @ Xi)))))) => ((! [Xi:$i] : ((XP @ Xi) = (ccixp @ (^ [Xi:$i] : XA2) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (XN @ Xi)))))) => (! [Xi:$i] : ((cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (XM @ Xi)) @ (ccfv @ (ccv @ Xi) @ (XN @ Xi)) @ ccsdm)) @ (^ [Xi:$i] : XA2)) => (cwbr @ (XS @ Xi) @ (XP @ Xi) @ ccsdm)))))))))))).
