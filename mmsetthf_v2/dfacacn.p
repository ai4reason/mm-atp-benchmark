...
thf(aacneq_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XC) => ((cwacn @ XA2) = (cwacn @ XC)))))).
...
thf(adfac4_ax,axiom,(cwac <=> (! [Xx3:$i] : (? [Xf1:$i] : ((cwfn @ (ccv @ Xf1) @ (ccv @ Xx3)) & (cwral @ (^ [Xz:$i] : ((cwne @ (ccv @ Xz) @ cc0) => (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xf1)) @ (ccv @ Xz)))) @ (^ [Xz:$i] : (ccv @ Xx3)))))))).
thf(cdfacacn_conj,conjecture,(cwac <=> (! [Xx3:$i] : ((cwacn @ (ccv @ Xx3)) = ccvv)))).
