...
thf(asin2h_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ (cco @ cc2 @ ccpi @ ccmul) @ ccicc)) => ((ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ ccsin) = (ccfv @ (cco @ (cco @ cc1 @ (ccfv @ XA2 @ cccos) @ ccmin) @ cc2 @ ccdiv) @ ccsqrt))))).
...
thf(acos2h_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) => ((ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ cccos) = (ccfv @ (cco @ (cco @ cc1 @ (ccfv @ XA2 @ cccos) @ ccaddc) @ cc2 @ ccdiv) @ ccsqrt))))).
...
thf(asinq12gt0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ ccpi @ ccioo)) => (cwbr @ ccc0 @ (ccfv @ XA2 @ ccsin) @ cclt)))).
