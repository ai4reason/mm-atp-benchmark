...
thf(aindifundif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccun @ (ccdif @ (ccin @ XA2 @ XB2) @ XC) @ (ccdif @ XA2 @ XB2)) = (ccdif @ XA2 @ (ccin @ XB2 @ XC))))))).
...
thf(axrge0addass_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc)) @ (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc)) @ (cwcel @ XC @ (cco @ ccc0 @ ccpnf @ ccicc))) => ((cco @ (cco @ XA2 @ XB2 @ ccxad) @ XC @ ccxad) = (cco @ XA2 @ (cco @ XB2 @ XC @ ccxad) @ ccxad))))))).
