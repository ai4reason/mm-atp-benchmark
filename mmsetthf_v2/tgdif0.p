...
thf(aunidif0_ax,axiom,(! [XA2:($i > $o)] : ((ccuni @ (ccdif @ XA2 @ (ccsn @ cc0))) = (ccuni @ XA2)))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(adifexg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwcel @ (ccdif @ XA2 @ XB2) @ ccvv)))))).
thf(atgval_ax,axiom,(! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((ccfv @ XB2 @ cctg) = (ccab @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ (ccuni @ (ccin @ XB2 @ (ccpw @ (ccv @ Xx3)))))))))))).
...
thf(ctgdif0_conj,conjecture,(! [XB2:($i > $o)] : ((ccfv @ (ccdif @ XB2 @ (ccsn @ cc0)) @ cctg) = (ccfv @ XB2 @ cctg)))).
