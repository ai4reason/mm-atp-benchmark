...
thf(apjhmop_ax,axiom,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => (cwcel @ (ccfv @ XH @ ccpjh) @ ccho)))).
thf(apjidmco_ax,axiom,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cccom @ (ccfv @ XH @ ccpjh) @ (ccfv @ XH @ ccpjh)) = (ccfv @ XH @ ccpjh))))).
