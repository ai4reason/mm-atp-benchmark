...
thf(aelrng_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((cwcel @ XA2 @ (ccrn @ XB2)) <=> (? [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ XB2))))))))).
...
thf(ctrpredpred_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ (ccpred @ XA2 @ XR @ XX) @ XB2) => (cwss @ (ccpred @ XA2 @ XR @ XX) @ (cctrpred @ XA2 @ XR @ XX)))))))).
