...
thf(alenco_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XA2)) & (cwf @ XA2 @ XB2 @ XF)) => ((ccfv @ (cccom @ XF @ XW) @ cchash) = (ccfv @ XW @ cchash)))))))).
...
thf(cccatco_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwcel @ XS @ (ccword @ XA2)) @ (cwcel @ XT @ (ccword @ XA2)) @ (cwf @ XA2 @ XB2 @ XF)) => ((cccom @ XF @ (cco @ XS @ XT @ ccconcat)) = (cco @ (cccom @ XF @ XS) @ (cccom @ XF @ XT) @ ccconcat))))))))).
