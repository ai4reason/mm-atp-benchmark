...
thf(apnrmtop_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ ccpnrm) => (cwcel @ XJ @ cctop)))).
thf(aopncld_ax,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwcel @ XS @ XJ)) => (cwcel @ (ccdif @ XX @ XS) @ (ccfv @ XJ @ cccld)))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(apnrmcld_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (((cwcel @ XJ @ ccpnrm) & (cwcel @ XA2 @ (ccfv @ XJ @ cccld))) => (cwrex @ (^ [Xf1:$i] : (XA2 = (ccint @ (ccrn @ (ccv @ Xf1))))) @ (^ [Xf1:$i] : (cco @ XJ @ ccn @ ccmap))))))).
