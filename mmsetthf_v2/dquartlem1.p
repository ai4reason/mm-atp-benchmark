...
thf(cdquartlem1_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (cwcel @ XS @ ccc)) => ((Xph => (XM = (cco @ (cco @ cc2 @ XS @ ccmul) @ cc2 @ ccexp))) => ((Xph => (cwne @ XM @ ccc0)) => ((Xph => (cwcel @ XI @ ccc)) => ((Xph => ((cco @ XI @ cc2 @ ccexp) = (cco @ (cco @ (ccneg @ (cco @ XS @ cc2 @ ccexp)) @ (cco @ XB2 @ cc2 @ ccdiv) @ ccmin) @ (cco @ (cco @ XC @ cc4 @ ccdiv) @ XS @ ccdiv) @ ccaddc))) => (Xph => (((cco @ (cco @ (cco @ XX @ cc2 @ ccexp) @ (cco @ (cco @ XM @ XB2 @ ccaddc) @ cc2 @ ccdiv) @ ccaddc) @ (cco @ (cco @ (cco @ (cco @ XM @ cc2 @ ccdiv) @ XX @ ccmul) @ (cco @ XC @ cc4 @ ccdiv) @ ccmin) @ XS @ ccdiv) @ ccaddc) = ccc0) <=> ((XX = (cco @ (ccneg @ XS) @ XI @ ccaddc)) | (XX = (cco @ (ccneg @ XS) @ XI @ ccmin))))))))))))))))))))).
