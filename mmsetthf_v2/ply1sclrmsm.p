...
thf(aply1ass23l_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_xp = (ccfv @ XP @ ccmulr)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XP @ ccvsca)) => (((cwcel @ XR @ ccrg) & (cw3a @ (cwcel @ XA2 @ XK) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2))) => ((cco @ (cco @ XA2 @ XX @ Xc_x) @ XY @ Xc_xp) = (cco @ XA2 @ (cco @ XX @ XY @ Xc_xp) @ Xc_x)))))))))))))))))).
...
thf(cply1sclrmsm_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XK = (ccfv @ XR @ ccbs)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XE = (ccfv @ XP @ ccbs)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_x = (ccfv @ XP @ ccvsca)) => ((Xc_xp = (ccfv @ XP @ ccmulr)) => ((XN = (ccfv @ XP @ ccmgp)) => ((Xc_ex = (ccfv @ XN @ ccmg)) => ((XA2 = (ccfv @ XP @ ccascl)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XK) @ (cwcel @ XZ @ XE)) => ((cco @ (ccfv @ XF @ XA2) @ XZ @ Xc_xp) = (cco @ XF @ XZ @ Xc_x))))))))))))))))))))))))).
