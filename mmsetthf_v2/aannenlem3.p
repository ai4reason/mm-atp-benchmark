...
thf(aaannenlem2_ax,axiom,(! [XH:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xe:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((XH @ Xe @ Xa @ Xb @ Xc @ Xd) = (ccmpt @ (^ [Xa:$i] : ccn0) @ (^ [Xa:$i] : (ccrab @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : ((ccfv @ (ccv @ Xb) @ (ccv @ Xc)) = ccc0)) @ (^ [Xc:$i] : (ccrab @ (^ [Xd:$i] : (cw3a @ (cwne @ (ccv @ Xd) @ cc0p) @ (cwbr @ (ccfv @ (ccv @ Xd) @ ccdgr) @ (ccv @ Xa) @ ccle) @ (cwral @ (^ [Xe:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xe) @ (ccfv @ (ccv @ Xd) @ cccoe)) @ ccabs) @ (ccv @ Xa) @ ccle)) @ (^ [Xe:$i] : ccn0)))) @ (^ [Xd:$i] : (ccfv @ ccz @ ccply)))))) @ (^ [Xb:$i] : ccc)))))))))) => (! [Xe:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (ccaa = (ccuni @ (ccrn @ (XH @ Xe @ Xa @ Xb @ Xc @ Xd)))))))))))).
...
thf(aaannenlem1_ax,axiom,(! [XA2:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xe:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((XH @ Xe @ Xa @ Xb @ Xc @ Xd) = (ccmpt @ (^ [Xa:$i] : ccn0) @ (^ [Xa:$i] : (ccrab @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : ((ccfv @ (ccv @ Xb) @ (ccv @ Xc)) = ccc0)) @ (^ [Xc:$i] : (ccrab @ (^ [Xd:$i] : (cw3a @ (cwne @ (ccv @ Xd) @ cc0p) @ (cwbr @ (ccfv @ (ccv @ Xd) @ ccdgr) @ (ccv @ Xa) @ ccle) @ (cwral @ (^ [Xe:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xe) @ (ccfv @ (ccv @ Xd) @ cccoe)) @ ccabs) @ (ccv @ Xa) @ ccle)) @ (^ [Xe:$i] : ccn0)))) @ (^ [Xd:$i] : (ccfv @ ccz @ ccply)))))) @ (^ [Xb:$i] : ccc)))))))))) => (! [Xe:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((cwcel @ XA2 @ ccn0) => (cwcel @ (ccfv @ XA2 @ (XH @ Xe @ Xa @ Xb @ Xc @ Xd)) @ ccfn))))))))))).
thf(aeleq1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwcel @ XA2 @ XC) <=> (cwcel @ XB2 @ XC))))))).
thf(aeqsstr3i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XB2 = XA2) => ((cwss @ XB2 @ XC) => (cwss @ XA2 @ XC))))))).
thf(aaasscn_ax,axiom,(cwss @ ccaa @ ccc)).
...
thf(aiunfictbso_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwbr @ XA2 @ ccom @ ccdom) @ (cwss @ XA2 @ ccfn) @ (cwor @ (ccuni @ XA2) @ XB2)) => (cwbr @ (ccuni @ XA2) @ ccom @ ccdom))))).
thf(ccpw_tp,type,(ccpw : (($i > $o) > ($i > $o)))).
thf(ccopab_tp,type,(ccopab : (($i > ($i > $o)) > ($i > $o)))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(acnso_ax,axiom,(? [Xx3:$i] : (cwor @ ccc @ (ccv @ Xx3)))).
...
thf(annssq_ax,axiom,(cwss @ ccn @ ccq)).
thf(aqssaa_ax,axiom,(cwss @ ccq @ ccaa)).
...
thf(caannenlem3_conj,conjecture,(! [XH:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xe:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((XH @ Xe @ Xa @ Xb @ Xc @ Xd) = (ccmpt @ (^ [Xa:$i] : ccn0) @ (^ [Xa:$i] : (ccrab @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : ((ccfv @ (ccv @ Xb) @ (ccv @ Xc)) = ccc0)) @ (^ [Xc:$i] : (ccrab @ (^ [Xd:$i] : (cw3a @ (cwne @ (ccv @ Xd) @ cc0p) @ (cwbr @ (ccfv @ (ccv @ Xd) @ ccdgr) @ (ccv @ Xa) @ ccle) @ (cwral @ (^ [Xe:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xe) @ (ccfv @ (ccv @ Xd) @ cccoe)) @ ccabs) @ (ccv @ Xa) @ ccle)) @ (^ [Xe:$i] : ccn0)))) @ (^ [Xd:$i] : (ccfv @ ccz @ ccply)))))) @ (^ [Xb:$i] : ccc)))))))))) => (cwbr @ ccaa @ ccn @ ccen)))).
