...
thf(amt4_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (((~ Xps) => (~ Xph)) => Xps))))).
...
thf(aatne0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccat) => (cwne @ XA2 @ cc0h)))).
...
thf(achssoc_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwss @ XA2 @ (ccfv @ XA2 @ ccort)) <=> (XA2 = cc0h))))).
...
thf(asuperpos_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccat) @ (cwcel @ XB2 @ ccat) @ (cwne @ XA2 @ XB2)) => (cwrex @ (^ [Xx3:$i] : (cw3a @ (cwne @ (ccv @ Xx3) @ XA2) @ (cwne @ (ccv @ Xx3) @ XB2) @ (cwss @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ cchj)))) @ (^ [Xx3:$i] : ccat)))))).
...
thf(achirredlem4_ax,axiom,(! [XA2:($i > $o)] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((cwcel @ XA2 @ ccch) => ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ ccch) => (cwbr @ XA2 @ (ccv @ Xx3) @ cccm))) => (((((cwcel @ (ccv @ Xp) @ ccat) & (cwss @ (ccv @ Xp) @ XA2)) & ((cwcel @ (ccv @ Xq) @ ccat) & (cwss @ (ccv @ Xq) @ (ccfv @ XA2 @ ccort)))) & ((cwcel @ (ccv @ Xr) @ ccat) & (cwss @ (ccv @ Xr) @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ cchj)))) => (((ccv @ Xr) = (ccv @ Xp)) | ((ccv @ Xr) = (ccv @ Xq))))))))))).
...
thf(cchirredi_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ ccch) => (cwbr @ XA2 @ (ccv @ Xx3) @ cccm))) => ((XA2 = cc0h) | (XA2 = cchil)))))).
