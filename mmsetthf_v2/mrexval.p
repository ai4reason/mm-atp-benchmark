...
thf(adf_mrex_ax,axiom,(ccmrex = (ccmpt @ (^ [Xt:$i] : ccvv) @ (^ [Xt:$i] : (ccword @ (ccun @ (ccfv @ (ccv @ Xt) @ ccmcn) @ (ccfv @ (ccv @ Xt) @ ccmvar))))))).
...
thf(cmrexval_conj,conjecture,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XC = (ccfv @ XT @ ccmcn)) => ((XV = (ccfv @ XT @ ccmvar)) => ((XR = (ccfv @ XT @ ccmrex)) => ((cwcel @ XT @ XW) => (XR = (ccword @ (ccun @ XC @ XV))))))))))))).
