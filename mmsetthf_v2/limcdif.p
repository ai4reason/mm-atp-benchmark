...
thf(apm5_61_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (((Xph | Xps) & (~ Xps)) <=> (Xph & (~ Xps)))))).
...
thf(climcdif_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => (Xph => ((cco @ XF @ XB2 @ cclimc) = (cco @ (ccres @ XF @ (ccdif @ XA2 @ (ccsn @ XB2))) @ XB2 @ cclimc))))))))).
