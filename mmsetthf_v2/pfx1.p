...
thf(aswrds1_ax,axiom,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XA2)) & (cwcel @ XI @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) => ((cco @ XW @ (ccop @ XI @ (cco @ XI @ cc1 @ ccaddc)) @ ccsubstr) = (ccs1 @ (ccfv @ XI @ XW)))))))).
thf(cpfx1_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwne @ XW @ cc0)) => ((cco @ XW @ cc1 @ ccpfx) = (ccs1 @ (ccfv @ ccc0 @ XW))))))).
