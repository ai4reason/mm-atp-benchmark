...
thf(asubgruhgredgd_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XS @ ccvtx)) => ((XI = (ccfv @ XS @ cciedg)) => ((Xph => (cwcel @ XG @ ccuhgr)) => ((Xph => (cwbr @ XS @ XG @ ccsubgr)) => ((Xph => (cwcel @ XX @ (ccdm @ XI))) => (Xph => (cwcel @ (ccfv @ XX @ XI) @ (ccdif @ (ccpw @ XV) @ (ccsn @ cc0)))))))))))))))).
