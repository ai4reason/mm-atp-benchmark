...
thf(crefdivmptfv_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cw3a @ (cwf @ XA2 @ ccr @ XF) @ (cwf @ XA2 @ ccr @ XG) @ (cwcel @ XA2 @ XV)) & (cwcel @ XX @ (cco @ XG @ ccc0 @ ccsupp))) => ((ccfv @ XX @ (cco @ XF @ XG @ ccfdiv)) = (cco @ (ccfv @ XX @ XF) @ (ccfv @ XX @ XG) @ ccdiv))))))))).
