...
thf(atrpredpred_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ (ccpred @ XA2 @ XR @ XX) @ XB2) => (cwss @ (ccpred @ XA2 @ XR @ XX) @ (cctrpred @ XA2 @ XR @ XX)))))))).
...
thf(atrpredex_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (cwcel @ (cctrpred @ XA2 @ XR @ XX) @ ccvv))))).
...
thf(adffr4_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwfr @ XA2 @ XR) <=> (! [Xx3:$i] : (((cwss @ (ccv @ Xx3) @ XA2) & (cwne @ (ccv @ Xx3) @ cc0)) => (cwrex @ (^ [Xy1:$i] : ((ccpred @ (ccv @ Xx3) @ XR @ (ccv @ Xy1)) = cc0)) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))).
...
thf(asspred_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cwss @ XB2 @ XA2) & (cwss @ (ccpred @ XA2 @ XR @ XX) @ XB2)) => ((ccpred @ XA2 @ XR @ XX) = (ccpred @ XB2 @ XR @ XX)))))))).
thf(assrexv_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ XB2) => ((cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) => (cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XB2)))))))).
thf(cfrmin_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xy1:$i] : ((((cwfr @ (XA2 @ Xy1) @ XR) & (cwse @ (XA2 @ Xy1) @ XR)) & ((cwss @ XB2 @ (XA2 @ Xy1)) & (cwne @ XB2 @ cc0))) => (cwrex @ (^ [Xy1:$i] : ((ccpred @ XB2 @ XR @ (ccv @ Xy1)) = cc0)) @ (^ [Xy1:$i] : XB2)))))))).
