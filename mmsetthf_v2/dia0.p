...
thf(aatlle0_ax,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => (((cwcel @ XK @ ccal) & (cwcel @ XX @ XB2)) => ((cwbr @ XX @ Xc_0 @ Xc_le) <=> (XX = Xc_0)))))))))))).
...
thf(cdia0_conj,conjecture,(! [XB2:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_0 = (ccfv @ XK @ ccp0)) => ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdia))) => (((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) => ((ccfv @ Xc_0 @ XI) = (ccsn @ (ccres @ ccid @ XB2))))))))))))))).
