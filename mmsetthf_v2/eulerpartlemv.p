...
thf(ceulerpartlemv_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xf1:$i] : ((XP @ Xf1) = (ccrab @ (^ [Xf1:$i] : ((cwcel @ (ccima @ (cccnv @ (ccv @ Xf1)) @ ccn) @ ccfn) & ((ccsu @ ccn @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (ccv @ Xk) @ ccmul))) = XN))) @ (^ [Xf1:$i] : (cco @ ccn0 @ ccn @ ccmap))))) => (! [Xf1:$i] : ((cwcel @ XA2 @ (XP @ Xf1)) <=> (cw3a @ (cwf @ ccn @ ccn0 @ XA2) @ (cwcel @ (ccima @ (cccnv @ XA2) @ ccn) @ ccfn) @ ((ccsu @ (ccima @ (cccnv @ XA2) @ ccn) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (ccv @ Xk) @ ccmul))) = XN))))))))).
