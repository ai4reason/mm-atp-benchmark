...
thf(asetrec2fun_ax,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xa:$i] : (XF @ Xa))) => ((! [Xa:$i] : ((XB2 @ Xa) = (ccsetrecs @ (XF @ Xa)))) => ((! [Xa:$i] : (cwfun @ (XF @ Xa))) => ((! [Xa:$i] : ((Xph @ Xa) => (! [Xa:$i] : ((cwss @ (ccv @ Xa) @ XC) => (cwss @ (ccfv @ (ccv @ Xa) @ (XF @ Xa)) @ XC))))) => (! [Xa:$i] : ((Xph @ Xa) => (cwss @ (XB2 @ Xa) @ XC)))))))))))).
...
thf(asetrec2lem1_ax,axiom,(! [XF:($i > ($i > $o))] : (! [Xa:$i] : ((ccfv @ (ccv @ Xa) @ (ccres @ (XF @ Xa) @ (ccab @ (^ [Xx3:$i] : (cweu @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XF @ Xa)))))))) = (ccfv @ (ccv @ Xa) @ (XF @ Xa)))))).
...
thf(asetrec2lem2_ax,axiom,(! [XF:($i > $o)] : (cwfun @ (ccres @ XF @ (ccab @ (^ [Xx3:$i] : (cweu @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF))))))))).
