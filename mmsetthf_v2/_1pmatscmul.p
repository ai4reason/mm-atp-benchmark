...
thf(c_1pmatscmul_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XN:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XC = (cco @ XN @ XP @ ccmat)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((XE = (ccfv @ XP @ ccbs)) => ((Xc_as = (ccfv @ XC @ ccvsca)) => ((Xc_1 = (ccfv @ XC @ ccur)) => ((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg) @ (cwcel @ XQ @ XE)) => (cwcel @ (cco @ XQ @ Xc_1 @ Xc_as) @ XB2)))))))))))))))))).
