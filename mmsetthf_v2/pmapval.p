...
thf(apmapfval_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : ((! [Xa:$i] : ((XB2 @ Xa) = (ccfv @ XK @ ccbs))) => ((! [Xx3:$i] : (! [Xa:$i] : ((Xc_le @ Xx3 @ Xa) = (ccfv @ XK @ ccple)))) => ((! [Xx3:$i] : ((XA2 @ Xx3) = (ccfv @ XK @ ccatm))) => ((! [Xx3:$i] : (! [Xa:$i] : ((XM @ Xx3 @ Xa) = (ccfv @ XK @ ccpmap)))) => (! [Xx3:$i] : (! [Xa:$i] : ((cwcel @ XK @ (XC @ Xx3 @ Xa)) => ((XM @ Xx3 @ Xa) = (ccmpt @ (^ [Xx3:$i] : (XB2 @ Xa)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xa:$i] : (cwbr @ (ccv @ Xa) @ (ccv @ Xx3) @ (Xc_le @ Xx3 @ Xa))) @ (^ [Xa:$i] : (XA2 @ Xx3)))))))))))))))))))).
