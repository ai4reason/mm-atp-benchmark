...
thf(arelexpxpnnidm_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XN @ ccn) => ((cw3a @ (cwcel @ XA2 @ XU) @ (cwcel @ XB2 @ XV) @ (cwne @ (ccin @ XA2 @ XB2) @ cc0)) => ((cco @ (ccxp @ XA2 @ XB2) @ XN @ ccrelexp) = (ccxp @ XA2 @ XB2)))))))))).
...
thf(arelexpiidm_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XN @ ccn0)) => ((cco @ (ccres @ ccid @ XA2) @ XN @ ccrelexp) = (ccres @ ccid @ XA2))))))).
...
thf(crelexpxpmin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ XU) @ (cwcel @ XB2 @ XV) @ (cwne @ (ccin @ XA2 @ XB2) @ cc0)) & (cw3a @ (XI = (ccif @ (cwbr @ XJ @ XK @ cclt) @ XJ @ XK)) @ (cwcel @ XJ @ ccn0) @ (cwcel @ XK @ ccn0))) => ((cco @ (cco @ (ccxp @ XA2 @ XB2) @ XJ @ ccrelexp) @ XK @ ccrelexp) = (cco @ (ccxp @ XA2 @ XB2) @ XI @ ccrelexp))))))))))).
