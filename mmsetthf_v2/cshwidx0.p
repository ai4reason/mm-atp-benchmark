...
thf(acshwidx0mod_ax,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwne @ XW @ cc0) @ (cwcel @ XN @ ccz)) => ((ccfv @ ccc0 @ (cco @ XW @ XN @ cccsh)) = (ccfv @ (cco @ XN @ (ccfv @ XW @ cchash) @ ccmo) @ XW))))))).
thf(afveq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))))).
thf(azmodidfzoimp_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XM @ (cco @ ccc0 @ XN @ ccfzo)) => ((cco @ XM @ XN @ ccmo) = XM))))).
thf(ccshwidx0_conj,conjecture,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) => ((ccfv @ ccc0 @ (cco @ XW @ XN @ cccsh)) = (ccfv @ XN @ XW))))))).
