...
thf(crmsuppss_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XR = (ccfv @ XM @ ccbs)) => (((cw3a @ (cwcel @ XM @ ccrg) @ (cwcel @ XV @ XX) @ (cwcel @ XC @ XR)) & (cwcel @ XA2 @ (cco @ XR @ XV @ ccmap))) => (cwss @ (cco @ (ccmpt @ (^ [Xv:$i] : XV) @ (^ [Xv:$i] : (cco @ XC @ (ccfv @ (ccv @ Xv) @ XA2) @ (ccfv @ XM @ ccmulr)))) @ (ccfv @ XM @ cc0g) @ ccsupp) @ (cco @ XA2 @ (ccfv @ XM @ cc0g) @ ccsupp))))))))))).
