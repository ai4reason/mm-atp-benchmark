...
thf(arhmsscrnghm_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XU @ XV)) => ((Xph => (XR = (ccin @ ccrg @ XU))) => ((Xph => (XS = (ccin @ ccrng @ XU))) => (Xph => (cwbr @ (ccres @ ccrh @ (ccxp @ XR @ XR)) @ (ccres @ ccrngh @ (ccxp @ XS @ XS)) @ ccssc))))))))))).
...
thf(arngchomfeqhom_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : ((XC = (ccfv @ XU @ ccrngc)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XU @ XV)) => (Xph => ((ccfv @ XC @ cchomf) = (ccfv @ XC @ cchom)))))))))))).
