...
thf(acos2kpi_ax,axiom,(! [XK:($i > $o)] : ((cwcel @ XK @ ccz) => ((ccfv @ (cco @ XK @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ cccos) = cc1)))).
...
thf(acosper_ax,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XK @ ccz)) => ((ccfv @ (cco @ XA2 @ (cco @ XK @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ ccaddc) @ cccos) = (ccfv @ XA2 @ cccos)))))).
thf(ccexp_tp,type,(ccexp : ($i > $o))).
thf(acospi_ax,axiom,((ccfv @ ccpi @ cccos) = (ccneg @ cc1))).
thf(aiffalse_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((~ Xph) => ((ccif @ Xph @ XA2 @ XB2) = XB2)))))).
thf(ccoskpi2_conj,conjecture,(! [XK:($i > $o)] : ((cwcel @ XK @ ccz) => ((ccfv @ (cco @ XK @ ccpi @ ccmul) @ cccos) = (ccif @ (cwbr @ cc2 @ XK @ ccdvds) @ cc1 @ (ccneg @ cc1)))))).
