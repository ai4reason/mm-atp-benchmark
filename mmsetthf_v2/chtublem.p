...
thf(advdsfac_ax,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XK @ ccn) & (cwcel @ XN @ (ccfv @ XK @ ccuz))) => (cwbr @ XK @ (ccfv @ XN @ ccfa) @ ccdvds))))).
thf(aid_ax,axiom,(! [Xph:$o] : (Xph => Xph))).
thf(afaccl_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => (cwcel @ (ccfv @ XN @ ccfa) @ ccn)))).
thf(apcelnn_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XN @ ccn)) => ((cwcel @ (cco @ XP @ XN @ ccpc) @ ccn) <=> (cwbr @ XP @ XN @ ccdvds)))))).
...
thf(abcval2_ax,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) => ((cco @ XN @ XK @ ccbc) = (cco @ (ccfv @ XN @ ccfa) @ (cco @ (ccfv @ (cco @ XN @ XK @ ccmin) @ ccfa) @ (ccfv @ XK @ ccfa) @ ccmul) @ ccdiv)))))).
...
thf(apcdiv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprime) @ ((cwcel @ XA2 @ ccz) & (cwne @ XA2 @ ccc0)) @ (cwcel @ XB2 @ ccn)) => ((cco @ XP @ (cco @ XA2 @ XB2 @ ccdiv) @ ccpc) = (cco @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc) @ ccmin))))))).
...
thf(aprmfac1_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XP @ ccprime) @ (cwbr @ XP @ (ccfv @ XN @ ccfa) @ ccdvds)) => (cwbr @ XP @ XN @ ccle))))).
...
thf(afacnn2_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((ccfv @ XN @ ccfa) = (cco @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ ccfa) @ XN @ ccmul))))).
thf(apceq0_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XN @ ccn)) => (((cco @ XP @ XN @ ccpc) = ccc0) <=> (~ (cwbr @ XP @ XN @ ccdvds))))))).
...
thf(abccmpl_ax,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XK @ ccz)) => ((cco @ XN @ XK @ ccbc) = (cco @ XN @ (cco @ XN @ XK @ ccmin) @ ccbc)))))).
...
thf(abinom11_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cco @ cc2 @ XN @ ccexp) = (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ XN @ (ccv @ Xk) @ ccbc))))))).
...
thf(cchtublem_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => (cwbr @ (ccfv @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccmin) @ cccht) @ (cco @ (ccfv @ XN @ cccht) @ (cco @ (ccfv @ cc4 @ cclog) @ (cco @ XN @ cc1 @ ccmin) @ ccmul) @ ccaddc) @ ccle)))).
