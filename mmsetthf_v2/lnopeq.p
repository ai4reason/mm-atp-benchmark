...
thf(alnopeqi_ax,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : ((cwcel @ XT @ cclo) => ((cwcel @ XU @ cclo) => ((cwral @ (^ [Xx3:$i] : ((cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xx3) @ ccsp) = (cco @ (ccfv @ (ccv @ Xx3) @ XU) @ (ccv @ Xx3) @ ccsp))) @ (^ [Xx3:$i] : cchil)) <=> (XT = XU))))))).
...
thf(clnopeq_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (((cwcel @ XT @ cclo) & (cwcel @ XU @ cclo)) => ((cwral @ (^ [Xx3:$i] : ((cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xx3) @ ccsp) = (cco @ (ccfv @ (ccv @ Xx3) @ XU) @ (ccv @ Xx3) @ ccsp))) @ (^ [Xx3:$i] : cchil)) <=> (XT = XU)))))).
