...
thf(cdprdres_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((Xph => (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((Xph => ((ccdm @ XS) = XI)) => ((Xph => (cwss @ XA2 @ XI)) => (Xph => ((cwbr @ XG @ (ccres @ XS @ XA2) @ (ccdm @ ccdprd)) & (cwss @ (cco @ XG @ (ccres @ XS @ XA2) @ ccdprd) @ (cco @ XG @ XS @ ccdprd))))))))))))).
