...
thf(aaalioulem2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xq:$i] : (! [Xp:$i] : ((XN @ Xx3 @ Xq @ Xp) = (ccfv @ XF @ ccdgr))))) => ((Xph => (cwcel @ XF @ (ccfv @ ccz @ ccply))) => ((! [Xx3:$i] : (! [Xq:$i] : (! [Xp:$i] : (Xph => (cwcel @ (XN @ Xx3 @ Xq @ Xp) @ ccn))))) => ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xp:$i] : (cwral @ (^ [Xq:$i] : (((ccfv @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv) @ XF) = ccc0) => ((XA2 = (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv)) | (cwbr @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xq) @ (XN @ Xx3 @ Xq @ Xp) @ ccexp) @ ccdiv) @ (ccfv @ (cco @ XA2 @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv) @ ccmin) @ ccabs) @ ccle)))) @ (^ [Xq:$i] : ccn))) @ (^ [Xp:$i] : ccz))) @ (^ [Xx3:$i] : ccrp)))))))))))).
thf(ccmul_tp,type,(ccmul : ($i > $o))).
thf(aaalioulem5_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xq:$i] : (! [Xp:$i] : ((XN @ Xq @ Xp) = (ccfv @ XF @ ccdgr)))) => ((Xph => (cwcel @ XF @ (ccfv @ ccz @ ccply))) => ((! [Xq:$i] : (! [Xp:$i] : (Xph => (cwcel @ (XN @ Xq @ Xp) @ ccn)))) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => ((ccfv @ XA2 @ XF) = ccc0)) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xp:$i] : (cwral @ (^ [Xq:$i] : ((cwne @ (ccfv @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv) @ XF) @ ccc0) => ((XA2 = (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv)) | (cwbr @ (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xq) @ (XN @ Xq @ Xp) @ ccexp) @ ccdiv) @ (ccfv @ (cco @ XA2 @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccdiv) @ ccmin) @ ccabs) @ ccle)))) @ (^ [Xq:$i] : ccn))) @ (^ [Xp:$i] : ccz))) @ (^ [Xx3:$i] : ccrp))))))))))))).
