...
thf(amndodconglem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => (cwcel @ XG @ ccmnd)) => ((Xph => (cwcel @ XA2 @ XX)) => ((Xph => (cwcel @ (ccfv @ XA2 @ XO) @ ccn)) => ((Xph => (cwcel @ XM @ ccn0)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwbr @ XM @ (ccfv @ XA2 @ XO) @ cclt)) => ((Xph => (cwbr @ XN @ (ccfv @ XA2 @ XO) @ cclt)) => ((Xph => ((cco @ XM @ XA2 @ Xc_x) = (cco @ XN @ XA2 @ Xc_x))) => ((Xph & (cwbr @ XM @ XN @ ccle)) => (XM = XN)))))))))))))))))))))))).
...
thf(aodmodnn0_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cw3a @ (cwcel @ XG @ ccmnd) @ (cwcel @ XA2 @ XX) @ (cwcel @ XN @ ccn0)) & (cwcel @ (ccfv @ XA2 @ XO) @ ccn)) => ((cco @ (cco @ XN @ (ccfv @ XA2 @ XO) @ ccmo) @ XA2 @ Xc_x) = (cco @ XN @ XA2 @ Xc_x))))))))))))))).
thf(cmndodcong_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((cw3a @ ((cwcel @ XG @ ccmnd) & (cwcel @ XA2 @ XX)) @ ((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0)) @ (cwcel @ (ccfv @ XA2 @ XO) @ ccn)) => ((cwbr @ (ccfv @ XA2 @ XO) @ (cco @ XM @ XN @ ccmin) @ ccdvds) <=> ((cco @ XM @ XA2 @ Xc_x) = (cco @ XN @ XA2 @ Xc_x))))))))))))))))).
