...
thf(aatordi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => (((cwcel @ XB2 @ ccat) & (cwbr @ XA2 @ XB2 @ cccm)) => ((cwss @ XB2 @ XA2) | (cwss @ XB2 @ (ccfv @ XA2 @ ccort)))))))).
...
thf(catord_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccat) @ (cwbr @ XA2 @ XB2 @ cccm)) => ((cwss @ XB2 @ XA2) | (cwss @ XB2 @ (ccfv @ XA2 @ ccort))))))).
