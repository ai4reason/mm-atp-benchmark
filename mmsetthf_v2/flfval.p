...
thf(aflffval_ax,axiom,(! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XL @ (ccfv @ XY @ ccfil))) => ((cco @ XJ @ XL @ ccflf) = (ccmpt @ (^ [Xf1:$i] : (cco @ XX @ XY @ ccmap)) @ (^ [Xf1:$i] : (cco @ XJ @ (ccfv @ XL @ (cco @ XX @ (ccv @ Xf1) @ ccfm)) @ ccflim)))))))))).
...
thf(cflfval_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) => ((ccfv @ XF @ (cco @ XJ @ XL @ ccflf)) = (cco @ XJ @ (ccfv @ XL @ (cco @ XX @ XF @ ccfm)) @ ccflim))))))))).
