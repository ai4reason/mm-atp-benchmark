...
thf(acoiun1_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((cccom @ (cciun @ (^ [Xx3:$i] : (XC @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ XB2) = (cciun @ (^ [Xx3:$i] : (XC @ Xx3)) @ (^ [Xx3:$i] : (cccom @ (XA2 @ Xx3) @ XB2)))))))).
thf(acbviuneq12dv_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XC)) => (cwcel @ (XX @ Xy1) @ XA2))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XY @ Xx3) @ XC))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xy1) @ XC) @ ((ccv @ Xx3) = (XX @ Xy1))) => ((XB2 @ Xx3) = (XF @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2) @ ((ccv @ Xy1) = (XY @ Xx3))) => ((XD @ Xy1) = (XG @ Xx3))))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => ((XB2 @ Xx3) = (XG @ Xx3)))) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XC)) => ((XD @ Xy1) = (XF @ Xy1)))) => (Xph => ((cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (cciun @ (^ [Xy1:$i] : XC) @ (^ [Xy1:$i] : (XD @ Xy1))))))))))))))))))))).
...
thf(ctrclfvdecomr_conj,conjecture,(! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XR @ XV) => ((ccfv @ XR @ cctcl) = (ccun @ XR @ (cccom @ (ccfv @ XR @ cctcl) @ XR))))))).
