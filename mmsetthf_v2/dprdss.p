...
thf(cdprdss_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((Xph => (cwbr @ XG @ XT @ (ccdm @ ccdprd))) => ((Xph => ((ccdm @ XT) = XI)) => ((Xph => (cwf @ XI @ (ccfv @ XG @ ccsubg) @ XS)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XI)) => (cwss @ (ccfv @ (ccv @ Xk) @ XS) @ (ccfv @ (ccv @ Xk) @ XT)))) => (Xph => ((cwbr @ XG @ XS @ (ccdm @ ccdprd)) & (cwss @ (cco @ XG @ XS @ ccdprd) @ (cco @ XG @ XT @ ccdprd)))))))))))))).
