...
thf(arngoid_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XH = (ccfv @ XR @ cc2nd)) => ((XX = (ccrn @ XG)) => (((cwcel @ XR @ ccrngo) & (cwcel @ XA2 @ XX)) => (cwrex @ (^ [Xu:$i] : (((cco @ (ccv @ Xu) @ XA2 @ XH) = XA2) & ((cco @ XA2 @ (ccv @ Xu) @ XH) = XA2))) @ (^ [Xu:$i] : XX)))))))))))).
