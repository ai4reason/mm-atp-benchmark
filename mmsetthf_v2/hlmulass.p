...
thf(chlmulass_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XS = (ccfv @ XU @ ccns)) => (((cwcel @ XU @ cchlo) & (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ XX))) => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ XC @ XS) = (cco @ XA2 @ (cco @ XB2 @ XC @ XS) @ XS)))))))))))).
