...
thf(afodomfi2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ ccfn) @ (cwfo @ XA2 @ XB2 @ XF)) => (cwbr @ XB2 @ XA2 @ ccdom))))))).
thf(ccsdm_tp,type,(ccsdm : ($i > $o))).
thf(adomwdom_ax,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwbr @ XX @ XY @ ccdom) => (cwbr @ XX @ XY @ ccwdom))))).
thf(cwdomfil_conj,conjecture,(! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XX @ ccfn) => ((cwbr @ XX @ XY @ ccwdom) <=> (cwbr @ XX @ XY @ ccdom)))))).
