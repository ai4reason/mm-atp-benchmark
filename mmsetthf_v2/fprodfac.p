...
thf(afacnn_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((ccfv @ XN @ ccfa) = (ccfv @ XN @ (ccseq @ ccmul @ ccid @ cc1)))))).
...
thf(cfprodfac_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((ccfv @ XA2 @ ccfa) = (ccprod @ (^ [Xk:$i] : (cco @ cc1 @ XA2 @ ccfz)) @ (^ [Xk:$i] : (ccv @ Xk))))))).
