...
thf(ccncfres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwss @ XA2 @ ccc) => ((cwss @ XB2 @ ccc) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (XC @ Xx3))))) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))) => ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) => (cwcel @ (XC @ Xx3) @ XB2))) => ((! [Xx3:$i] : (cwcel @ (XF @ Xx3) @ (cco @ ccc @ ccc @ cccncf))) => ((XJ = (ccfv @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XA2 @ XA2)) @ ccmopn)) => ((XK = (ccfv @ (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XB2 @ XB2)) @ ccmopn)) => (! [Xx3:$i] : (cwcel @ (XG @ Xx3) @ (cco @ XJ @ XK @ cccn))))))))))))))))))).
