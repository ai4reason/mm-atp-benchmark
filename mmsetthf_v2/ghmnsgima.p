...
thf(cghmnsgima_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XT @ ccbs)) => ((cw3a @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm)) @ (cwcel @ XU @ (ccfv @ XS @ ccnsg)) @ ((ccrn @ XF) = XY)) => (cwcel @ (ccima @ XF @ XU) @ (ccfv @ XT @ ccnsg)))))))))).
