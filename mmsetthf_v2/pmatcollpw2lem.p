...
thf(asuppvalfn_ax,axiom,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cw3a @ (cwfn @ XF @ XX) @ (cwcel @ XX @ XV) @ (cwcel @ XZ @ XW)) => ((cco @ XF @ XZ @ ccsupp) = (ccrab @ (^ [Xi:$i] : (cwne @ (ccfv @ (ccv @ Xi) @ XF) @ XZ)) @ (^ [Xi:$i] : XX)))))))))).
...
thf(apmatcoe1fsupp_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xs1:$i] : ((XP @ Xx3 @ Xi @ Xj @ Xs1) = (ccfv @ XR @ ccpl1)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xs1:$i] : ((XC @ Xx3 @ Xi @ Xj @ Xs1) = (cco @ XN @ (XP @ Xx3 @ Xi @ Xj @ Xs1) @ ccmat)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xs1:$i] : (XB2 = (ccfv @ (XC @ Xx3 @ Xi @ Xj @ Xs1) @ ccbs)))))) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg) @ (cwcel @ XM @ XB2)) => (cwrex @ (^ [Xs1:$i] : (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xs1) @ (ccv @ Xx3) @ cclt) => (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : ((ccfv @ (ccv @ Xx3) @ (ccfv @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM) @ ccco1)) = Xc_0)) @ (^ [Xj:$i] : XN))) @ (^ [Xi:$i] : XN)))) @ (^ [Xx3:$i] : ccn0))) @ (^ [Xs1:$i] : ccn0))))))))))))))).
...
thf(aply10s0_ax,axiom,(! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xc_as = (ccfv @ XP @ ccvsca)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccrg) & (cwcel @ XM @ XB2)) => ((cco @ Xc_0 @ XM @ Xc_as) = (ccfv @ XP @ cc0g)))))))))))))).
...
thf(adecpmate_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XC = (cco @ XN @ XP @ ccmat)) => ((XB2 = (ccfv @ XC @ ccbs)) => (((cw3a @ (cwcel @ XR @ XV) @ (cwcel @ XM @ XB2) @ (cwcel @ XK @ ccn0)) & ((cwcel @ XI @ XN) & (cwcel @ XJ @ XN))) => ((cco @ XI @ XJ @ (cco @ XM @ XK @ ccdecpmat)) = (ccfv @ XK @ (ccfv @ (cco @ XI @ XJ @ XM) @ ccco1)))))))))))))))))).
...
thf(ampt2eq123_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (((XA2 = XD) & (cwral @ (^ [Xx3:$i] : (((XB2 @ Xx3) = (XE @ Xx3)) & (cwral @ (^ [Xy1:$i] : ((XC @ Xx3 @ Xy1) = (XF @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (XB2 @ Xx3))))) @ (^ [Xx3:$i] : XA2))) => ((ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XA2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XB2 @ Xx3))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1)))) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XD)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XE @ Xx3))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XF @ Xx3 @ Xy1))))))))))))).
...
thf(amat0op_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : ((XA2 @ Xi @ Xj) = (cco @ XN @ XR @ ccmat)))) => ((! [Xi:$i] : (! [Xj:$i] : ((Xc_0 @ Xi @ Xj) = (ccfv @ XR @ cc0g)))) => (! [Xi:$i] : (! [Xj:$i] : (((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) => ((ccfv @ (XA2 @ Xi @ Xj) @ cc0g) = (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : XN)) @ (^ [Xi:$i] : (^ [Xj:$i] : (Xc_0 @ Xi @ Xj))))))))))))))).
...
thf(arabssnn0fi_ax,axiom,(! [Xph:($i > $o)] : ((cwcel @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : ccn0)) @ ccfn) <=> (cwrex @ (^ [Xs1:$i] : (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xs1) @ (ccv @ Xx3) @ cclt) => (~ (Xph @ Xx3)))) @ (^ [Xx3:$i] : ccn0))) @ (^ [Xs1:$i] : ccn0))))).
