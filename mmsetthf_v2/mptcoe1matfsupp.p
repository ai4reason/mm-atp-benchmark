...
thf(cmptcoe1matfsupp_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : ((! [Xk:$i] : ((XA2 @ Xk) = (cco @ XN @ XR @ ccmat))) => ((! [Xk:$i] : ((XQ @ Xk) = (ccfv @ (XA2 @ Xk) @ ccpl1))) => ((! [Xk:$i] : (XL = (ccfv @ (XQ @ Xk) @ ccbs))) => ((cw3a @ (cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg) @ (cwcel @ XO @ XL)) @ (cwcel @ XI @ XN) @ (cwcel @ XJ @ XN)) => (cwbr @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ XI @ XJ @ (ccfv @ (ccv @ Xk) @ (ccfv @ XO @ ccco1))))) @ (ccfv @ XR @ cc0g) @ ccfsupp)))))))))))))).
