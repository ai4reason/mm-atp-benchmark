...
thf(cfmpt2co_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((Xph @ Xz) & ((cwcel @ (ccv @ Xx3) @ (XA2 @ Xz)) & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xz)))) => (cwcel @ (XR @ Xx3 @ Xy1) @ XC))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xz) => ((XF @ Xx3 @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xz))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XB2 @ Xz))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XR @ Xx3 @ Xy1))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xz) => ((XG @ Xx3 @ Xy1 @ Xz) = (ccmpt @ (^ [Xz:$i] : XC) @ (^ [Xz:$i] : (XS @ Xz)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xz) = (XR @ Xx3 @ Xy1)) => ((XS @ Xz) = (XT @ Xx3 @ Xy1)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xz) => ((cccom @ (XG @ Xx3 @ Xy1 @ Xz) @ (XF @ Xx3 @ Xy1 @ Xz)) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XA2 @ Xz))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XB2 @ Xz))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XT @ Xx3 @ Xy1))))))))))))))))))))))).
