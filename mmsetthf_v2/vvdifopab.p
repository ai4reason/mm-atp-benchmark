...
thf(aopelvvdif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwcel @ (ccop @ XA2 @ XB2) @ (ccdif @ (ccxp @ ccvv @ ccvv) @ XR)) <=> (~ (cwcel @ (ccop @ XA2 @ XB2) @ XR)))))))))).
...
thf(aeqrelf_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)))) => ((! [Xy1:$i] : (cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (cwnfc @ (^ [Xy1:$i] : (XA2 @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (cwnfc @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwrel @ (XA2 @ Xx3 @ Xy1)) & (cwrel @ (XB2 @ Xx3 @ Xy1))) => (((XA2 @ Xx3 @ Xy1) = (XB2 @ Xx3 @ Xy1)) <=> (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (XA2 @ Xx3 @ Xy1)) <=> (cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (XB2 @ Xx3 @ Xy1)))))))))))))))).
