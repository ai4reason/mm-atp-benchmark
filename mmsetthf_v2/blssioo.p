...
thf(ablpnf_ax,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XD @ (ccfv @ XX @ ccme)) & (cwcel @ XP @ XX)) => ((cco @ XP @ ccpnf @ (ccfv @ XD @ ccbl)) = XX)))))).
...
thf(cblssioo_conj,conjecture,(! [XD:($i > $o)] : ((XD = (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ ccr @ ccr))) => (cwss @ (ccrn @ (ccfv @ XD @ ccbl)) @ (ccrn @ ccioo))))).
