...
thf(amapunen_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwcel @ XC @ XX)) & ((ccin @ XA2 @ XB2) = cc0)) => (cwbr @ (cco @ XC @ (ccun @ XA2 @ XB2) @ ccmap) @ (ccxp @ (cco @ XC @ XA2 @ ccmap) @ (cco @ XC @ XB2 @ ccmap)) @ ccen))))))))).
thf(amp2an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (Xps => (((Xph & Xps) => Xch) => Xch))))))).
thf(aenref_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwbr @ XA2 @ XA2 @ ccen)))).
thf(aovex_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ XF) @ ccvv))))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(amapsnen_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (cwbr @ (cco @ XA2 @ (ccsn @ XB2) @ ccmap) @ XA2 @ ccen)))))).
...
thf(axp2cda_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((ccxp @ XA2 @ cc2o) = (cco @ XA2 @ XA2 @ cccda)))))).
...
thf(cackbij1lem5_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccom) => ((ccfv @ (ccpw @ (ccsuc @ XA2)) @ cccrd) = (cco @ (ccfv @ (ccpw @ XA2) @ cccrd) @ (ccfv @ (ccpw @ XA2) @ cccrd) @ ccoa))))).
