...
thf(as1s5_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((ccs6 @ XA2 @ XB2 @ XC @ XD @ XE @ XF) = (cco @ (ccs1 @ XA2) @ (ccs5 @ XB2 @ XC @ XD @ XE @ XF) @ ccconcat))))))))).
thf(cs1s6_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((ccs7 @ XA2 @ XB2 @ XC @ XD @ XE @ XF @ XG) = (cco @ (ccs1 @ XA2) @ (ccs6 @ XB2 @ XC @ XD @ XE @ XF @ XG) @ ccconcat)))))))))).
