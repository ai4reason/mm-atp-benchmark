...
thf(aig1peu_ax,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XU = (ccfv @ XP @ cclidl)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((XM = (ccfv @ XR @ ccmn1)) => ((XD = (ccfv @ XR @ ccdg1)) => ((cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XI @ XU) @ (cwne @ XI @ (ccsn @ Xc_0))) => (cwreu @ (^ [Xg1:$i] : ((ccfv @ (ccv @ Xg1) @ XD) = (ccinf @ (ccima @ XD @ (ccdif @ XI @ (ccsn @ Xc_0))) @ ccr @ cclt))) @ (^ [Xg1:$i] : (ccin @ XI @ XM))))))))))))))))).
...
thf(cig1pval3_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XG = (ccfv @ XR @ ccig1p)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((XU = (ccfv @ XP @ cclidl)) => ((XD = (ccfv @ XR @ ccdg1)) => ((XM = (ccfv @ XR @ ccmn1)) => ((cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XI @ XU) @ (cwne @ XI @ (ccsn @ Xc_0))) => (cw3a @ (cwcel @ (ccfv @ XI @ XG) @ XI) @ (cwcel @ (ccfv @ XI @ XG) @ XM) @ ((ccfv @ (ccfv @ XI @ XG) @ XD) = (ccinf @ (ccima @ XD @ (ccdif @ XI @ (ccsn @ Xc_0))) @ ccr @ cclt))))))))))))))))))).
