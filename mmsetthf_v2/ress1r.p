...
thf(arngurd_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : ((Xph => (XB2 = (ccfv @ XR @ ccbs))) => ((Xph => (Xc_x = (ccfv @ XR @ ccmulr))) => ((Xph => (cwcel @ Xc_1 @ XB2)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => ((cco @ Xc_1 @ (ccv @ Xx3) @ Xc_x) = (ccv @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => ((cco @ (ccv @ Xx3) @ Xc_1 @ Xc_x) = (ccv @ Xx3)))) => (Xph => (Xc_1 = (ccfv @ XR @ ccur)))))))))))))).
...
thf(cress1r_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : ((XS = (cco @ XR @ XA2 @ ccress)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ Xc_1 @ XA2) @ (cwss @ XA2 @ XB2)) => (Xc_1 = (ccfv @ XS @ ccur)))))))))))).
