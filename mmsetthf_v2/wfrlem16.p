...
thf(atz6_26i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwwe @ XA2 @ XR) => ((cwse @ XA2 @ XR) => (((cwss @ XB2 @ XA2) & (cwne @ XB2 @ cc0)) => (cwrex @ (^ [Xy1:$i] : ((ccpred @ XB2 @ XR @ (ccv @ Xy1)) = cc0)) @ (^ [Xy1:$i] : XB2))))))))).
