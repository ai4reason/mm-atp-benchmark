...
thf(aatcvat2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => (((cwcel @ XB2 @ ccat) & (cwcel @ XC @ ccat)) => (((~ (XB2 = XC)) & (cwbr @ XA2 @ (cco @ XB2 @ XC @ cchj) @ cccv)) => (cwcel @ XA2 @ ccat)))))))).
...
thf(catcvat2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccat) @ (cwcel @ XC @ ccat)) => (((~ (XB2 = XC)) & (cwbr @ XA2 @ (cco @ XB2 @ XC @ cchj) @ cccv)) => (cwcel @ XA2 @ ccat))))))).
