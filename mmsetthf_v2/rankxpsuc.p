...
thf(arankxplim2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwlim @ (ccfv @ (ccxp @ XA2 @ XB2) @ ccrnk)) => (cwlim @ (ccfv @ (ccun @ XA2 @ XB2) @ ccrnk)))))))).
...
thf(arankxplim3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwlim @ (ccfv @ (ccxp @ XA2 @ XB2) @ ccrnk)) <=> (cwlim @ (ccuni @ (ccfv @ (ccxp @ XA2 @ XB2) @ ccrnk))))))))).
thf(a_3bitri_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph <=> Xps) => ((Xps <=> Xch) => ((Xch <=> Xth) => (Xph <=> Xth))))))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aunixp0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((ccxp @ XA2 @ XB2) = cc0) <=> ((ccuni @ (ccxp @ XA2 @ XB2)) = cc0))))).
...
thf(crankxpsuc_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((((ccfv @ (ccun @ XA2 @ XB2) @ ccrnk) = (ccsuc @ XC)) & (cwne @ (ccxp @ XA2 @ XB2) @ cc0)) => ((ccfv @ (ccxp @ XA2 @ XB2) @ ccrnk) = (ccsuc @ (ccsuc @ (ccfv @ (ccun @ XA2 @ XB2) @ ccrnk))))))))))).
