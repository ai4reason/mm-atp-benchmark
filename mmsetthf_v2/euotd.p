...
thf(ceuotd_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccvv)) => ((Xph => (cwcel @ XB2 @ ccvv)) => ((Xph => (cwcel @ XC @ ccvv)) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (Xph => ((Xps @ Xx3 @ Xa @ Xb @ Xc) <=> (cw3a @ ((ccv @ Xa) = XA2) @ ((ccv @ Xb) = XB2) @ ((ccv @ Xc) = XC)))))))) => (Xph => (cweu @ (^ [Xx3:$i] : (? [Xa:$i] : (? [Xb:$i] : (? [Xc:$i] : (((ccv @ Xx3) = (ccotp @ (ccv @ Xa) @ (ccv @ Xb) @ (ccv @ Xc))) & (Xps @ Xx3 @ Xa @ Xb @ Xc)))))))))))))))))).
