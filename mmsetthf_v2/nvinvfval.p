...
thf(acurry1f_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (cccom @ XF @ (cccnv @ (ccres @ cc2nd @ (ccxp @ (ccsn @ XC) @ ccvv))))) => (((cwf @ (ccxp @ XA2 @ XB2) @ XD @ XF) & (cwcel @ XC @ XA2)) => (cwf @ XB2 @ XD @ XG)))))))))).
...
thf(agrpoinvf_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((XN = (ccfv @ XG @ ccgn)) => ((cwcel @ XG @ ccgr) => (cwf1o @ XX @ XX @ XN)))))))).
...
thf(acurry1val_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (cccom @ XF @ (cccnv @ (ccres @ cc2nd @ (ccxp @ (ccsn @ XC) @ ccvv))))) => (((cwfn @ XF @ (ccxp @ XA2 @ XB2)) & (cwcel @ XC @ XA2)) => ((ccfv @ XD @ XG) = (cco @ XC @ XD @ XF))))))))))).
...
thf(cnvinvfval_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XG = (ccfv @ XU @ ccpv)) => ((XS = (ccfv @ XU @ ccns)) => ((XN = (cccom @ XS @ (cccnv @ (ccres @ cc2nd @ (ccxp @ (ccsn @ (ccneg @ cc1)) @ ccvv))))) => ((cwcel @ XU @ ccnv) => (XN = (ccfv @ XG @ ccgn))))))))))).
