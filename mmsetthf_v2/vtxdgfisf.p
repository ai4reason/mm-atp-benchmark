...
thf(avtxdgf_ax,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XG @ XW) => (cwf @ XV @ ccxnn0 @ (ccfv @ XG @ ccvtxdg)))))))).
...
thf(cvtxdgfisf_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XG @ cciedg)) => ((XA2 = (ccdm @ XI)) => (((cwcel @ XG @ XW) & (cwcel @ XA2 @ ccfn)) => (cwf @ XV @ ccn0 @ (ccfv @ XG @ ccvtxdg)))))))))))).
