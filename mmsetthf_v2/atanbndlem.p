...
thf(aimre_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ ccim) = (ccfv @ (cco @ (ccneg @ cci) @ XA2 @ ccmul) @ ccre))))).
...
thf(aatanlogsublem_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccatan)) & (cwbr @ ccc0 @ (ccfv @ XA2 @ ccre) @ cclt)) => (cwcel @ (ccfv @ (cco @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccaddc) @ cclog) @ (ccfv @ (cco @ cc1 @ (cco @ cci @ XA2 @ ccmul) @ ccmin) @ cclog) @ ccmin) @ ccim) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo))))).
...
thf(catanbndlem_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwcel @ (ccfv @ XA2 @ ccatan) @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))))).
