...
thf(aisppw2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => ((cwne @ (ccfv @ XA2 @ ccvma) @ ccc0) <=> (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xk:$i] : (XA2 = (cco @ (ccv @ Xp) @ (ccv @ Xk) @ ccexp))) @ (^ [Xk:$i] : ccn))) @ (^ [Xp:$i] : ccprime)))))).
...
thf(cvmalelog_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => (cwbr @ (ccfv @ XA2 @ ccvma) @ (ccfv @ XA2 @ cclog) @ ccle)))).
