...
thf(aaddccncf_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ ccaddc))))) => (! [Xx3:$i] : ((cwcel @ XA2 @ ccc) => (cwcel @ (XF @ Xx3) @ (cco @ ccc @ ccc @ cccncf)))))))).
...
thf(apm3_44_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xps => Xph) & (Xch => Xph)) => ((Xps | Xch) => Xph)))))).
...
thf(aellimc_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > $o)] : ((! [Xz:$i] : ((XJ @ Xz) = (cco @ XK @ (ccun @ XA2 @ (ccsn @ XB2)) @ ccrest))) => ((XK = (ccfv @ cccnfld @ cctopn)) => ((! [Xz:$i] : ((XG @ Xz) = (ccmpt @ (^ [Xz:$i] : (ccun @ XA2 @ (ccsn @ XB2))) @ (^ [Xz:$i] : (ccif @ ((ccv @ Xz) = XB2) @ XC @ (ccfv @ (ccv @ Xz) @ XF)))))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwf @ XA2 @ ccc @ XF))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwss @ XA2 @ ccc))) => ((! [Xz:$i] : ((Xph @ Xz) => (cwcel @ XB2 @ ccc))) => (! [Xz:$i] : ((Xph @ Xz) => ((cwcel @ XC @ (cco @ XF @ XB2 @ cclimc)) <=> (cwcel @ (XG @ Xz) @ (ccfv @ XB2 @ (cco @ (XJ @ Xz) @ XK @ cccnp))))))))))))))))))))).
