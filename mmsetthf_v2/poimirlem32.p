...
thf(aimdistand_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps => (Xch => Xth))) => (Xph => ((Xps & Xch) => (Xps & Xth))))))))).
...
thf(aralun_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (((cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) & (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) => (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (ccun @ (XA2 @ Xx3) @ (XB2 @ Xx3))))))))).
...
thf(asuprubii_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : ((cw3a @ (cwss @ XA2 @ ccr) @ (cwne @ XA2 @ cc0) @ (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccr))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ (XB2 @ Xx3 @ Xy1) @ XA2) => (cwbr @ (XB2 @ Xx3 @ Xy1) @ (ccsup @ XA2 @ ccr @ cclt) @ ccle)))))))).
...
thf(aixpconst_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : XB2)) = (cco @ XB2 @ XA2 @ ccmap))))))).
...
thf(ann0ennn_ax,axiom,(cwbr @ ccn0 @ ccn @ ccen)).
...
thf(afinixpnum_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (((cwcel @ XA2 @ ccfn) & (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ (ccdm @ cccrd))) @ (^ [Xx3:$i] : XA2))) => (cwcel @ (ccixp @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccdm @ cccrd)))))).
...
thf(assnum_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwss @ XB2 @ XA2)) => (cwcel @ XB2 @ (ccdm @ cccrd)))))).
thf(ccuni_tp,type,(ccuni : (($i > $o) > ($i > $o)))).
thf(aac6num_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : (((ccv @ Xy1) = (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1))) => ((Xph @ Xx3 @ Xy1) <=> (Xps @ Xx3 @ Xf1)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : ((cw3a @ (cwcel @ (XA2 @ Xy1) @ (XV @ Xx3 @ Xy1 @ Xf1)) @ (cwcel @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xy1)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : XB2)))) @ (ccdm @ cccrd)) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1)))) => (? [Xf1:$i] : ((cwf @ (XA2 @ Xy1) @ XB2 @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xf1)) @ (^ [Xx3:$i] : (XA2 @ Xy1)))))))))))))))).
...
thf(apoimirlem30_ax,axiom,(! [Xph:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XN @ ccn))) => ((XI = (cco @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) => ((XR = (ccfv @ (ccxp @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (ccfv @ (ccrn @ ccioo) @ cctg))) @ ccpt)) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XF @ (cco @ (cco @ XR @ XI @ ccrest) @ XR @ cccn)))) => ((! [Xj:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XX @ Xj @ Xk @ Xn) = (ccfv @ (ccv @ Xn) @ (ccfv @ (cco @ (cco @ (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ cc1st) @ (ccun @ (ccxp @ (ccima @ (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ cc2nd) @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ cc2nd) @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc)) @ (ccxp @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (ccv @ Xk))) @ (ccof @ ccdiv)) @ XF)))))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwf @ ccn @ (ccxp @ (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ (ccab @ (^ [Xf1:$i] : (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))) @ XG))) => ((! [Xf1:$i] : (! [Xk:$i] : (((Xph @ Xf1) & (cwcel @ (ccv @ Xk) @ ccn)) => (cwss @ (ccrn @ (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ cc1st)) @ (cco @ ccc0 @ (ccv @ Xk) @ ccfzo))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xr:$i] : (((Xph @ Xf1) & (cw3a @ (cwcel @ (ccv @ Xk) @ ccn) @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz)) @ (cwcel @ (ccv @ Xr) @ (ccpr @ ccle @ (cccnv @ ccle))))) => (cwrex @ (^ [Xj:$i] : (cwbr @ ccc0 @ (XX @ Xj @ Xk @ Xn) @ (ccv @ Xr))) @ (^ [Xj:$i] : (cco @ ccc0 @ XN @ ccfz)))))))) => (! [Xf1:$i] : ((Xph @ Xf1) => (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xn:$i] : (cwral @ (^ [Xv:$i] : ((cwcel @ (ccv @ Xc) @ (ccv @ Xv)) => (cwral @ (^ [Xr:$i] : (cwrex @ (^ [Xz:$i] : (cwbr @ ccc0 @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xz) @ XF)) @ (ccv @ Xr))) @ (^ [Xz:$i] : (ccv @ Xv)))) @ (^ [Xr:$i] : (ccpr @ ccle @ (cccnv @ ccle)))))) @ (^ [Xv:$i] : (cco @ XR @ XI @ ccrest)))) @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)))) @ (^ [Xc:$i] : XI)))))))))))))))))))).
...
thf(apoimirlem31_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [Xr:$i] : ((! [Xf1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xf1 @ Xa @ Xb) => (cwcel @ XN @ ccn))))) => ((XI = (cco @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) => ((XR = (ccfv @ (ccxp @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (ccfv @ (ccrn @ ccioo) @ cctg))) @ ccpt)) => ((! [Xf1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xf1 @ Xa @ Xb) => (cwcel @ XF @ (cco @ (cco @ XR @ XI @ ccrest) @ XR @ cccn)))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (((Xph @ Xf1 @ Xa @ Xb) & (cw3a @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz)) @ (cwcel @ (ccv @ Xz) @ XI) @ ((ccfv @ (ccv @ Xn) @ (ccv @ Xz)) = ccc0))) => (cwbr @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xz) @ XF)) @ ccc0 @ ccle))))))) => ((! [Xj:$i] : (! [Xk:$i] : ((XP @ Xj @ Xk) = (cco @ (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ cc1st) @ (ccun @ (ccxp @ (ccima @ (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ cc2nd) @ (cco @ cc1 @ (ccv @ Xj) @ ccfz)) @ (ccsn @ cc1)) @ (ccxp @ (ccima @ (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ cc2nd) @ (cco @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XN @ ccfz)) @ (ccsn @ ccc0))) @ (ccof @ ccaddc))))) => ((! [Xf1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xph @ Xf1 @ Xa @ Xb) => (cwf @ ccn @ (ccxp @ (cco @ ccn0 @ (cco @ cc1 @ XN @ ccfz) @ ccmap) @ (ccab @ (^ [Xf1:$i] : (cwf1o @ (cco @ cc1 @ XN @ ccfz) @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xf1))))) @ XG))))) => ((! [Xf1:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (((Xph @ Xf1 @ Xa @ Xb) & (cwcel @ (ccv @ Xk) @ ccn)) => (cwss @ (ccrn @ (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ cc1st)) @ (cco @ ccc0 @ (ccv @ Xk) @ ccfzo))))))) => ((! [Xf1:$i] : (! [Xi:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xb:$i] : (((Xph @ Xf1 @ Xa @ Xb) & ((cwcel @ (ccv @ Xk) @ ccn) & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ XN @ ccfz)))) => (cwrex @ (^ [Xj:$i] : ((ccv @ Xi) = (ccsup @ (ccun @ (ccsn @ ccc0) @ (ccrab @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : ((cwbr @ ccc0 @ (ccfv @ (ccv @ Xb) @ (ccfv @ (cco @ (XP @ Xj @ Xk) @ (ccxp @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (ccv @ Xk))) @ (ccof @ ccdiv)) @ XF)) @ ccle) & (cwne @ (ccfv @ (ccv @ Xb) @ (XP @ Xj @ Xk)) @ ccc0))) @ (^ [Xb:$i] : (cco @ cc1 @ (ccv @ Xa) @ ccfz)))) @ (^ [Xa:$i] : (cco @ cc1 @ XN @ ccfz)))) @ ccr @ cclt))) @ (^ [Xj:$i] : (cco @ ccc0 @ XN @ ccfz))))))))) => (! [Xf1:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xa:$i] : (! [Xb:$i] : (((Xph @ Xf1 @ Xa @ Xb) & (cw3a @ (cwcel @ (ccv @ Xk) @ ccn) @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz)) @ (cwcel @ (ccv @ Xr) @ (ccpr @ ccle @ (cccnv @ ccle))))) => (cwrex @ (^ [Xj:$i] : (cwbr @ ccc0 @ (ccfv @ (ccv @ Xn) @ (ccfv @ (cco @ (XP @ Xj @ Xk) @ (ccxp @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (ccv @ Xk))) @ (ccof @ ccdiv)) @ XF)) @ (ccv @ Xr))) @ (^ [Xj:$i] : (cco @ ccc0 @ XN @ ccfz))))))))))))))))))))))))))).
...
thf(cpoimirlem32_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((XI = (cco @ (cco @ ccc0 @ cc1 @ ccicc) @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) => ((XR = (ccfv @ (ccxp @ (cco @ cc1 @ XN @ ccfz) @ (ccsn @ (ccfv @ (ccrn @ ccioo) @ cctg))) @ ccpt)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XR @ XI @ ccrest) @ XR @ cccn))) => ((! [Xz:$i] : (! [Xn:$i] : ((Xph & (cw3a @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz)) @ (cwcel @ (ccv @ Xz) @ XI) @ ((ccfv @ (ccv @ Xn) @ (ccv @ Xz)) = ccc0))) => (cwbr @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xz) @ XF)) @ ccc0 @ ccle)))) => ((! [Xz:$i] : (! [Xn:$i] : ((Xph & (cw3a @ (cwcel @ (ccv @ Xn) @ (cco @ cc1 @ XN @ ccfz)) @ (cwcel @ (ccv @ Xz) @ XI) @ ((ccfv @ (ccv @ Xn) @ (ccv @ Xz)) = cc1))) => (cwbr @ ccc0 @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xz) @ XF)) @ ccle)))) => (Xph => (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xn:$i] : (cwral @ (^ [Xv:$i] : ((cwcel @ (ccv @ Xc) @ (ccv @ Xv)) => (cwral @ (^ [Xr:$i] : (cwrex @ (^ [Xz:$i] : (cwbr @ ccc0 @ (ccfv @ (ccv @ Xn) @ (ccfv @ (ccv @ Xz) @ XF)) @ (ccv @ Xr))) @ (^ [Xz:$i] : (ccv @ Xv)))) @ (^ [Xr:$i] : (ccpr @ ccle @ (cccnv @ ccle)))))) @ (^ [Xv:$i] : (cco @ XR @ XI @ ccrest)))) @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)))) @ (^ [Xc:$i] : XI))))))))))))))).
