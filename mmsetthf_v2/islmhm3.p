...
thf(cislmhm3_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > ($i > ($i > $o)))] : (! [Xc_xp:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XK @ Xx3 @ Xy1) = (ccfv @ XS @ ccsca)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XL @ Xx3 @ Xy1) = (ccfv @ XT @ ccsca)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xy1) = (ccfv @ (XK @ Xx3 @ Xy1) @ ccbs)))) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccfv @ XS @ ccbs))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_x @ Xx3 @ Xy1) = (ccfv @ XS @ ccvsca)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_xp @ Xx3 @ Xy1) = (ccfv @ XT @ ccvsca)))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XS @ cclmod) & (cwcel @ XT @ cclmod)) => ((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) <=> (cw3a @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm)) @ ((XL @ Xx3 @ Xy1) = (XK @ Xx3 @ Xy1)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_x @ Xx3 @ Xy1)) @ XF) = (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ XF) @ (Xc_xp @ Xx3 @ Xy1)))) @ (^ [Xy1:$i] : (XE @ Xx3)))) @ (^ [Xx3:$i] : (XB2 @ Xy1)))))))))))))))))))))))).
