...
thf(a_2lgslem1a_ax,axiom,(! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (~ (cwbr @ cc2 @ XP @ ccdvds))) => ((ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xi:$i] : (((ccv @ Xx3) = (cco @ (ccv @ Xi) @ cc2 @ ccmul)) & (cwbr @ (cco @ XP @ cc2 @ ccdiv) @ (cco @ (ccv @ Xx3) @ XP @ ccmo) @ cclt))) @ (^ [Xi:$i] : (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz)))) @ (^ [Xx3:$i] : ccz)) = (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xi:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xi) @ cc2 @ ccmul))) @ (^ [Xi:$i] : (cco @ (cco @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ cc1 @ ccaddc) @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz)))) @ (^ [Xx3:$i] : ccz)))))).
...
thf(a_2lgslem1c_ax,axiom,(! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (~ (cwbr @ cc2 @ XP @ ccdvds))) => (cwbr @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccle)))).
thf(aeluz2_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ XM @ ccuz)) <=> (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwbr @ XM @ XN @ ccle)))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(ahashfzp1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ (ccfv @ XA2 @ ccuz)) => ((ccfv @ (cco @ (cco @ XA2 @ cc1 @ ccaddc) @ XB2 @ ccfz) @ cchash) = (cco @ XB2 @ XA2 @ ccmin)))))).
thf(c_2lgslem1_conj,conjecture,(! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (~ (cwbr @ cc2 @ XP @ ccdvds))) => ((ccfv @ (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xi:$i] : (((ccv @ Xx3) = (cco @ (ccv @ Xi) @ cc2 @ ccmul)) & (cwbr @ (cco @ XP @ cc2 @ ccdiv) @ (cco @ (ccv @ Xx3) @ XP @ ccmo) @ cclt))) @ (^ [Xi:$i] : (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz)))) @ (^ [Xx3:$i] : ccz)) @ cchash) = (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ ccmin))))).
