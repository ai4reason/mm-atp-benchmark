...
thf(aclim1fr1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccmul) @ XB2 @ ccaddc) @ (cco @ XA2 @ (ccv @ Xn) @ ccmul) @ ccdiv))))) => ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwne @ XA2 @ ccc0)) => ((Xph => (cwcel @ XB2 @ ccc)) => (! [Xn:$i] : (Xph => (cwbr @ (XF @ Xn) @ cc1 @ ccli)))))))))))).
...
thf(awallispilem3_ax,axiom,(! [XI:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xn:$i] : ((XI @ Xx3 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ (ccv @ Xn) @ ccexp)))))))) => (! [Xx3:$i] : (! [Xn:$i] : ((cwcel @ (XN @ Xx3 @ Xn) @ ccn0) => (cwcel @ (ccfv @ (XN @ Xx3 @ Xn) @ (XI @ Xx3 @ Xn)) @ ccrp)))))))).
...
thf(awallispilem1_ax,axiom,(! [Xph:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xn:$i] : ((XI @ Xx3 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ (ccv @ Xn) @ ccexp)))))))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XN @ ccn0))) => (! [Xx3:$i] : (! [Xn:$i] : ((Xph @ Xn) => (cwbr @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ (XI @ Xx3 @ Xn)) @ (ccfv @ XN @ (XI @ Xx3 @ Xn)) @ ccle)))))))))).
...
thf(aitgsinexp_ax,axiom,(! [Xph:$o] : (! [XI:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xn:$i] : ((XI @ Xx3 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ ccpi @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ (ccv @ Xn) @ ccexp)))))))) => ((Xph => (cwcel @ XN @ (ccfv @ cc2 @ ccuz))) => (! [Xx3:$i] : (! [Xn:$i] : (Xph => ((ccfv @ XN @ (XI @ Xx3 @ Xn)) = (cco @ (cco @ (cco @ XN @ cc1 @ ccmin) @ XN @ ccdiv) @ (ccfv @ (cco @ XN @ cc2 @ ccmin) @ (XI @ Xx3 @ Xn)) @ ccmul))))))))))).
