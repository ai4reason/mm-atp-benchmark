...
thf(adfopg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((ccop @ XA2 @ XB2) = (ccpr @ (ccsn @ XA2) @ (ccpr @ XA2 @ XB2))))))))).
...
thf(arankunb_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) & (cwcel @ XB2 @ (ccuni @ (ccima @ ccr1 @ ccon0)))) => ((ccfv @ (ccun @ XA2 @ XB2) @ ccrnk) = (ccun @ (ccfv @ XA2 @ ccrnk) @ (ccfv @ XB2 @ ccrnk))))))).
