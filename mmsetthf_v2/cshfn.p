...
thf(adf_csh_ax,axiom,(cccsh = (ccmpt2 @ (^ [Xw:$i] : (^ [Xn:$i] : (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xl:$i] : (cwfn @ (ccv @ Xf1) @ (cco @ ccc0 @ (ccv @ Xl) @ ccfzo))) @ (^ [Xl:$i] : ccn0)))))) @ (^ [Xw:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xw:$i] : (^ [Xn:$i] : (ccif @ ((ccv @ Xw) = cc0) @ cc0 @ (cco @ (cco @ (ccv @ Xw) @ (ccop @ (cco @ (ccv @ Xn) @ (ccfv @ (ccv @ Xw) @ cchash) @ ccmo) @ (ccfv @ (ccv @ Xw) @ cchash)) @ ccsubstr) @ (cco @ (ccv @ Xw) @ (ccop @ ccc0 @ (cco @ (ccv @ Xn) @ (ccfv @ (ccv @ Xw) @ cchash) @ ccmo)) @ ccsubstr) @ ccconcat))))))).
...
thf(ccshfn_conj,conjecture,(! [XN:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xf1:$i] : (! [Xl:$i] : (((cwcel @ (XW @ Xf1 @ Xl) @ (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xl:$i] : (cwfn @ (ccv @ Xf1) @ (cco @ ccc0 @ (ccv @ Xl) @ ccfzo))) @ (^ [Xl:$i] : ccn0))))) & (cwcel @ (XN @ Xf1 @ Xl) @ ccz)) => ((cco @ (XW @ Xf1 @ Xl) @ (XN @ Xf1 @ Xl) @ cccsh) = (ccif @ ((XW @ Xf1 @ Xl) = cc0) @ cc0 @ (cco @ (cco @ (XW @ Xf1 @ Xl) @ (ccop @ (cco @ (XN @ Xf1 @ Xl) @ (ccfv @ (XW @ Xf1 @ Xl) @ cchash) @ ccmo) @ (ccfv @ (XW @ Xf1 @ Xl) @ cchash)) @ ccsubstr) @ (cco @ (XW @ Xf1 @ Xl) @ (ccop @ ccc0 @ (cco @ (XN @ Xf1 @ Xl) @ (ccfv @ (XW @ Xf1 @ Xl) @ cchash) @ ccmo)) @ ccsubstr) @ ccconcat))))))))).
