...
thf(afrmin_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xy1:$i] : ((((cwfr @ (XA2 @ Xy1) @ XR) & (cwse @ (XA2 @ Xy1) @ XR)) & ((cwss @ XB2 @ (XA2 @ Xy1)) & (cwne @ XB2 @ cc0))) => (cwrex @ (^ [Xy1:$i] : ((ccpred @ XB2 @ XR @ (ccv @ Xy1)) = cc0)) @ (^ [Xy1:$i] : XB2)))))))).
