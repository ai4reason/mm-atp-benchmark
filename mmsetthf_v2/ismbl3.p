...
thf(cismbl3_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccvol)) <=> ((cwss @ XA2 @ ccr) & (cwral @ (^ [Xx3:$i] : (cwbr @ (cco @ (ccfv @ (ccin @ (ccv @ Xx3) @ XA2) @ ccovol) @ (ccfv @ (ccdif @ (ccv @ Xx3) @ XA2) @ ccovol) @ ccxad) @ (ccfv @ (ccv @ Xx3) @ ccovol) @ ccle)) @ (^ [Xx3:$i] : (ccpw @ ccr))))))).
