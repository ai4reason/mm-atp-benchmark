...
thf(cchpscmat_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XE:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_ex:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XI:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XM:($i > $o)] : (! [Xc_mi:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XN:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XC @ Xi @ Xj @ Xm @ Xn @ Xc) = (cco @ XN @ XR @ ccchpmat))))))) => ((! [Xm:$i] : (! [Xc:$i] : ((XP @ Xm @ Xc) = (ccfv @ XR @ ccpl1)))) => ((! [Xn:$i] : ((XA2 @ Xn) = (cco @ XN @ XR @ ccmat))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XX @ Xm @ Xn @ Xc) = (ccfv @ XR @ ccv1))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XG @ Xi @ Xj @ Xm @ Xn @ Xc) = (ccfv @ (XP @ Xm @ Xc) @ ccmgp))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xc_ex @ Xi @ Xj @ Xm @ Xn @ Xc) = (ccfv @ (XG @ Xi @ Xj @ Xm @ Xn @ Xc) @ ccmg))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XD @ Xi @ Xj @ Xm @ Xc) = (ccrab @ (^ [Xm:$i] : (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : ((cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccv @ Xm)) = (ccif @ ((ccv @ Xi) = (ccv @ Xj)) @ (ccv @ Xc) @ (ccfv @ XR @ cc0g)))) @ (^ [Xj:$i] : XN))) @ (^ [Xi:$i] : XN))) @ (^ [Xc:$i] : (ccfv @ XR @ ccbs)))) @ (^ [Xm:$i] : (ccfv @ (XA2 @ Xn) @ ccbs))))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (! [Xc:$i] : ((XS @ Xi @ Xj @ Xm @ Xc) = (ccfv @ (XP @ Xm @ Xc) @ ccascl)))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xc_mi @ Xi @ Xj @ Xm @ Xn @ Xc) = (ccfv @ (XP @ Xm @ Xc) @ ccsg))))))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ cccrg)) & (cw3a @ (cwcel @ XM @ (XD @ Xi @ Xj @ Xm @ Xc)) @ (cwcel @ (XI @ Xi @ Xj @ Xm @ Xc) @ XN) @ (cwral @ (^ [Xn:$i] : ((cco @ (ccv @ Xn) @ (ccv @ Xn) @ XM) = (XE @ Xi @ Xj @ Xm @ Xc))) @ (^ [Xn:$i] : XN)))) => ((ccfv @ XM @ (XC @ Xi @ Xj @ Xm @ Xn @ Xc)) = (cco @ (ccfv @ XN @ cchash) @ (cco @ (XX @ Xm @ Xn @ Xc) @ (ccfv @ (XE @ Xi @ Xj @ Xm @ Xc) @ (XS @ Xi @ Xj @ Xm @ Xc)) @ (Xc_mi @ Xi @ Xj @ Xm @ Xn @ Xc)) @ (Xc_ex @ Xi @ Xj @ Xm @ Xn @ Xc))))))))))))))))))))))))))))))))).
