...
thf(adfateq12d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (XF = XG)) => ((Xph => (XA2 = XB2)) => (Xph => ((cwdfat @ XA2 @ XF) <=> (cwdfat @ XB2 @ XG))))))))))).
...
thf(adfafv2_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((ccafv @ XA2 @ XF) = (ccif @ (cwdfat @ XA2 @ XF) @ (ccfv @ XA2 @ XF) @ ccvv))))).
thf(cafveq12d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (XF = XG)) => ((Xph => (XA2 = XB2)) => (Xph => ((ccafv @ XA2 @ XF) = (ccafv @ XB2 @ XG))))))))))).
