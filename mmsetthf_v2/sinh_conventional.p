...
thf(asinhval_named_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ ccsinh) = (cco @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ ccsin) @ cci @ ccdiv))))).
...
thf(airec_ax,axiom,((cco @ cc1 @ cci @ ccdiv) = (ccneg @ cci))).
thf(csinh_conventional_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ ccsinh) = (cco @ (ccneg @ cci) @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ ccsin) @ ccmul))))).
