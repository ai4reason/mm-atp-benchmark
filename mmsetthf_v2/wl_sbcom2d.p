...
thf(awl_sbcom2d_lem2_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : ((~ (! [Xy1:$i] : ((ccv @ Xy1) = (ccv @ Xx3)))) => ((cwsb @ (^ [Xx3:$i] : (cwsb @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ Xv)) @ Xu) <=> (! [Xx3:$i] : (! [Xy1:$i] : ((((ccv @ Xx3) = (ccv @ Xu)) & ((ccv @ Xy1) = (ccv @ Xv))) => (Xph @ Xx3 @ Xy1))))))))))).
...
thf(awl_sbcom2d_lem1_ax,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xy1:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : ((((ccv @ Xu) = (ccv @ Xy1)) & ((ccv @ Xv) = (ccv @ Xw))) => ((~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xw)))) => ((cwsb @ (^ [Xx3:$i] : (cwsb @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)) @ Xv)) @ Xu) <=> (cwsb @ (^ [Xx3:$i] : (cwsb @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)) @ Xw)) @ Xy1)))))))))).
thf(aancoms_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) => Xch) => ((Xps & Xph) => Xch)))))).
thf(cwl_sbcom2d_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xps:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) => (~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xw))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) => (~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xz))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) => (~ (! [Xz:$i] : ((ccv @ Xz) = (ccv @ Xy1))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) => ((cwsb @ (^ [Xz:$i] : (cwsb @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xy1 @ Xz @ Xw)) @ Xy1)) @ Xw) <=> (cwsb @ (^ [Xx3:$i] : (cwsb @ (^ [Xz:$i] : (Xps @ Xx3 @ Xy1 @ Xz @ Xw)) @ Xw)) @ Xy1))))))))))))).
