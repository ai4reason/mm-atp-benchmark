...
thf(cfsummsnunzOLD_conj,conjecture,(! [Xz:$i] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (((cwcel @ XA2 @ ccfn) & (cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xk) @ ccz)) @ (^ [Xk:$i] : (ccun @ XA2 @ (ccsn @ (ccv @ Xz)))))) => (cwcel @ (ccsu @ (ccun @ XA2 @ (ccsn @ (ccv @ Xz))) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccz)))))).
