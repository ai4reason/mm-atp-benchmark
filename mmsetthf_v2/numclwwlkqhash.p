...
thf(awwlknlsw_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) => ((ccfv @ XN @ XW) = (ccfv @ XW @ cclsw))))))).
...
thf(aclwwlkvbij_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xw:$i] : ((XV @ Xw) = (ccfv @ XG @ ccvtx))) => (! [Xw:$i] : (((cwcel @ XX @ (XV @ Xw)) & (cwcel @ XN @ ccn)) => (? [Xf1:$i] : (cwf1o @ (ccrab @ (^ [Xw:$i] : (((ccfv @ (ccv @ Xw) @ cclsw) = (ccfv @ ccc0 @ (ccv @ Xw))) & ((ccfv @ ccc0 @ (ccv @ Xw)) = XX))) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))) @ (cco @ XX @ XN @ (ccfv @ XG @ ccclwwlknon)) @ (ccv @ Xf1))))))))))).
