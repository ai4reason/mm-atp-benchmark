...
thf(crgspnmin_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (XB2 = (ccfv @ XR @ ccbs))) => ((Xph => (cwss @ XA2 @ XB2)) => ((Xph => (XN = (ccfv @ XR @ ccrgspn))) => ((Xph => (XU = (ccfv @ XA2 @ XN))) => ((Xph => (cwcel @ XS @ (ccfv @ XR @ ccsubrg))) => ((Xph => (cwss @ XA2 @ XS)) => (Xph => (cwss @ XU @ XS))))))))))))))))).
