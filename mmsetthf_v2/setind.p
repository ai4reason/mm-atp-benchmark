...
thf(assindif0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ XB2) <=> ((ccin @ XA2 @ (ccdif @ ccvv @ XB2)) = cc0))))).
...
thf(azfregs_ax,axiom,(! [XA2:($i > $o)] : ((cwne @ XA2 @ cc0) => (cwrex @ (^ [Xx3:$i] : ((ccin @ (ccv @ Xx3) @ XA2) = cc0)) @ (^ [Xx3:$i] : XA2))))).
thf(avdif0_ax,axiom,(! [XA2:($i > $o)] : ((XA2 = ccvv) <=> ((ccdif @ ccvv @ XA2) = cc0)))).
thf(csetind_conj,conjecture,(! [XA2:($i > $o)] : ((! [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) => (cwcel @ (ccv @ Xx3) @ XA2))) => (XA2 = ccvv)))).
