...
thf(adf_salgen_ax,axiom,(ccsalgen = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccint @ (ccrab @ (^ [Xs1:$i] : (((ccuni @ (ccv @ Xs1)) = (ccuni @ (ccv @ Xx3))) & (cwss @ (ccv @ Xx3) @ (ccv @ Xs1)))) @ (^ [Xs1:$i] : ccsalg))))))).
...
thf(csalgenval_conj,conjecture,(! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xs1:$i] : ((cwcel @ XX @ (XV @ Xs1)) => ((ccfv @ XX @ ccsalgen) = (ccint @ (ccrab @ (^ [Xs1:$i] : (((ccuni @ (ccv @ Xs1)) = (ccuni @ XX)) & (cwss @ XX @ (ccv @ Xs1)))) @ (^ [Xs1:$i] : ccsalg))))))))).
