...
thf(clnocoi_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XL = (cco @ XU @ XW @ cclno)) => ((XM = (cco @ XW @ XX @ cclno)) => ((XN = (cco @ XU @ XX @ cclno)) => ((cwcel @ XU @ ccnv) => ((cwcel @ XW @ ccnv) => ((cwcel @ XX @ ccnv) => ((cwcel @ XS @ XL) => ((cwcel @ XT @ XM) => (cwcel @ (cccom @ XT @ XS) @ XN)))))))))))))))))).
