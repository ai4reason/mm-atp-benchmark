...
thf(cupgrunop_conj,conjecture,(! [Xph:$o] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XG @ ccupgr)) => ((Xph => (cwcel @ XH @ ccupgr)) => ((XE = (ccfv @ XG @ cciedg)) => ((XF = (ccfv @ XH @ cciedg)) => ((XV = (ccfv @ XG @ ccvtx)) => ((Xph => ((ccfv @ XH @ ccvtx) = XV)) => ((Xph => ((ccin @ (ccdm @ XE) @ (ccdm @ XF)) = cc0)) => (Xph => (cwcel @ (ccop @ XV @ (ccun @ XE @ XF)) @ ccupgr)))))))))))))))).
