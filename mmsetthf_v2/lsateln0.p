...
thf(clsateln0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XW @ cc0g)) => ((! [Xv:$i] : ((XA2 @ Xv) = (ccfv @ XW @ cclsa))) => ((Xph => (cwcel @ XW @ cclmod)) => ((! [Xv:$i] : (Xph => (cwcel @ XU @ (XA2 @ Xv)))) => (Xph => (cwrex @ (^ [Xv:$i] : (cwne @ (ccv @ Xv) @ Xc_0)) @ (^ [Xv:$i] : XU))))))))))))).
