...
thf(alimsssuc_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwlim @ XA2) => ((cwss @ XA2 @ XB2) <=> (cwss @ XA2 @ (ccsuc @ XB2))))))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(ainfensuc_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwss @ ccom @ XA2)) => (cwbr @ XA2 @ (ccsuc @ XA2) @ ccen)))).
...
thf(acardne_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ XB2 @ cccrd)) => (~ (cwbr @ XA2 @ XB2 @ ccen)))))).
...
thf(ccardlim_conj,conjecture,(! [XA2:($i > $o)] : ((cwss @ ccom @ (ccfv @ XA2 @ cccrd)) <=> (cwlim @ (ccfv @ XA2 @ cccrd))))).
