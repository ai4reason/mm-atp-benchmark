...
thf(aincexc_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwss @ XA2 @ ccfn)) => ((ccfv @ (ccuni @ XA2) @ cchash) = (ccsu @ (ccdif @ (ccpw @ XA2) @ (ccsn @ cc0)) @ (^ [Xs1:$i] : (cco @ (cco @ (ccneg @ cc1) @ (cco @ (ccfv @ (ccv @ Xs1) @ cchash) @ cc1 @ ccmin) @ ccexp) @ (ccfv @ (ccint @ (ccv @ Xs1)) @ cchash) @ ccmul))))))).
