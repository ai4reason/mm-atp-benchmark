...
thf(ansmallnq_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccnq) => (? [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XA2 @ ccltq))))).
...
thf(cltbtwnnq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccltq) <=> (? [Xx3:$i] : ((cwbr @ XA2 @ (ccv @ Xx3) @ ccltq) & (cwbr @ (ccv @ Xx3) @ XB2 @ ccltq))))))).
