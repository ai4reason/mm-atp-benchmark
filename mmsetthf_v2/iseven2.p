...
thf(adfeven2_ax,axiom,(cceven = (ccrab @ (^ [Xz:$i] : (cwbr @ cc2 @ (ccv @ Xz) @ ccdvds)) @ (^ [Xz:$i] : ccz)))).
thf(ciseven2_conj,conjecture,(! [XZ:($i > $o)] : ((cwcel @ XZ @ cceven) <=> ((cwcel @ XZ @ ccz) & (cwbr @ cc2 @ XZ @ ccdvds))))).
