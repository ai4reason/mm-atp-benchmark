...
thf(comndmul_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_le = (ccfv @ XM @ ccple)) => ((Xc_x = (ccfv @ XM @ ccmg)) => ((Xph => (cwcel @ XM @ ccomnd)) => ((Xph => (cwcel @ XM @ cccmn)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwbr @ XX @ XY @ Xc_le)) => (Xph => (cwbr @ (cco @ XN @ XX @ Xc_x) @ (cco @ XN @ XY @ Xc_x) @ Xc_le)))))))))))))))))))).
