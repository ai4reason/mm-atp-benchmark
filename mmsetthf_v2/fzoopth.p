...
thf(aelfzolt3b_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ XM @ XN @ ccfzo)) => (cwcel @ XM @ (cco @ XM @ XN @ ccfzo))))))).
thf(asimpl1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((cw3a @ Xph @ Xps @ Xch) & Xth) => Xph)))))).
thf(ccr_tp,type,(ccr : ($i > $o))).
thf(auz11_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XM @ ccz) => (((ccfv @ XM @ ccuz) = (ccfv @ XN @ ccuz)) <=> (XM = XN)))))).
thf(ampcom_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xps => Xph) => ((Xph => (Xps => Xch)) => (Xps => Xch))))))).
thf(ccfz_tp,type,(ccfz : ($i > $o))).
thf(afzoend_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ (cco @ XA2 @ XB2 @ ccfzo)) => (cwcel @ (cco @ XB2 @ cc1 @ ccmin) @ (cco @ XA2 @ XB2 @ ccfzo)))))).
...
thf(cfzoopth_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwbr @ XM @ XN @ cclt)) => (((cco @ XM @ XN @ ccfzo) = (cco @ XJ @ XK @ ccfzo)) <=> ((XM = XJ) & (XN = XK))))))))).
