...
thf(aglbconN_ax,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [Xc_pe:($i > $o)] : ((! [Xx3:$i] : (XB2 = (ccfv @ (XK @ Xx3) @ ccbs))) => ((! [Xx3:$i] : ((XU @ Xx3) = (ccfv @ (XK @ Xx3) @ cclub))) => ((! [Xx3:$i] : ((XG @ Xx3) = (ccfv @ (XK @ Xx3) @ ccglb))) => ((! [Xx3:$i] : (Xc_pe = (ccfv @ (XK @ Xx3) @ ccoc))) => (! [Xx3:$i] : (((cwcel @ (XK @ Xx3) @ cchlt) & (cwss @ XS @ XB2)) => ((ccfv @ XS @ (XG @ Xx3)) = (ccfv @ (ccfv @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ Xc_pe) @ XS)) @ (^ [Xx3:$i] : XB2)) @ (XU @ Xx3)) @ Xc_pe))))))))))))))).
