...
thf(ckgen2ss_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XK @ (ccfv @ XX @ cctopon)) @ (cwss @ XJ @ XK)) => (cwss @ (ccfv @ XJ @ cckgen) @ (ccfv @ XK @ cckgen))))))).
