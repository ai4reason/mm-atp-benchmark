...
thf(aelxp4_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (ccxp @ XB2 @ XC)) <=> ((XA2 = (ccop @ (ccuni @ (ccdm @ (ccsn @ XA2))) @ (ccuni @ (ccrn @ (ccsn @ XA2))))) & ((cwcel @ (ccuni @ (ccdm @ (ccsn @ XA2))) @ XB2) & (cwcel @ (ccuni @ (ccrn @ (ccsn @ XA2))) @ XC)))))))).
...
thf(aop1sta_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((ccuni @ (ccdm @ (ccsn @ (ccop @ XA2 @ XB2)))) = XA2)))))).
...
thf(cxpdom2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccvv) => ((cwbr @ XA2 @ XB2 @ ccdom) => (cwbr @ (ccxp @ XC @ XA2) @ (ccxp @ XC @ XB2) @ ccdom))))))).
