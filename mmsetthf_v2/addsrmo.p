...
thf(aprsrlem1_ax,axiom,(! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xf1:$i] : (! [Xg1:$i] : (! [Xh:$i] : (! [Xs1:$i] : ((((cwcel @ XA2 @ (ccqs @ (ccxp @ ccnp @ ccnp) @ ccer)) & (cwcel @ XB2 @ (ccqs @ (ccxp @ ccnp @ ccnp) @ ccer))) & (((XA2 = (ccec @ (ccop @ (ccv @ Xw) @ (ccv @ Xv)) @ ccer)) & (XB2 = (ccec @ (ccop @ (ccv @ Xu) @ (ccv @ Xt)) @ ccer))) & ((XA2 = (ccec @ (ccop @ (ccv @ Xs1) @ (ccv @ Xf1)) @ ccer)) & (XB2 = (ccec @ (ccop @ (ccv @ Xg1) @ (ccv @ Xh)) @ ccer))))) => (((((cwcel @ (ccv @ Xw) @ ccnp) & (cwcel @ (ccv @ Xv) @ ccnp)) & ((cwcel @ (ccv @ Xs1) @ ccnp) & (cwcel @ (ccv @ Xf1) @ ccnp))) & (((cwcel @ (ccv @ Xu) @ ccnp) & (cwcel @ (ccv @ Xt) @ ccnp)) & ((cwcel @ (ccv @ Xg1) @ ccnp) & (cwcel @ (ccv @ Xh) @ ccnp)))) & (((cco @ (ccv @ Xw) @ (ccv @ Xf1) @ ccpp) = (cco @ (ccv @ Xv) @ (ccv @ Xs1) @ ccpp)) & ((cco @ (ccv @ Xu) @ (ccv @ Xh) @ ccpp) = (cco @ (ccv @ Xt) @ (ccv @ Xg1) @ ccpp)))))))))))))))).
thf(aimp_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps => Xch)) => ((Xph & Xps) => Xch)))))).
thf(aaddcmpblnr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((((cwcel @ XA2 @ ccnp) & (cwcel @ XB2 @ ccnp)) & ((cwcel @ XC @ ccnp) & (cwcel @ XD @ ccnp))) & (((cwcel @ XF @ ccnp) & (cwcel @ XG @ ccnp)) & ((cwcel @ XR @ ccnp) & (cwcel @ XS @ ccnp)))) => ((((cco @ XA2 @ XD @ ccpp) = (cco @ XB2 @ XC @ ccpp)) & ((cco @ XF @ XS @ ccpp) = (cco @ XG @ XR @ ccpp))) => (cwbr @ (ccop @ (cco @ XA2 @ XF @ ccpp) @ (cco @ XB2 @ XG @ ccpp)) @ (ccop @ (cco @ XC @ XR @ ccpp) @ (cco @ XD @ XS @ ccpp)) @ ccer)))))))))))).
...
thf(caddsrmo_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccqs @ (ccxp @ ccnp @ ccnp) @ ccer)) & (cwcel @ XB2 @ (ccqs @ (ccxp @ ccnp @ ccnp) @ ccer))) => (cwmo @ (^ [Xz:$i] : (? [Xw:$i] : (? [Xv:$i] : (? [Xu:$i] : (? [Xt:$i] : (((XA2 = (ccec @ (ccop @ (ccv @ Xw) @ (ccv @ Xv)) @ ccer)) & (XB2 = (ccec @ (ccop @ (ccv @ Xu) @ (ccv @ Xt)) @ ccer))) & ((ccv @ Xz) = (ccec @ (ccop @ (cco @ (ccv @ Xw) @ (ccv @ Xu) @ ccpp) @ (cco @ (ccv @ Xv) @ (ccv @ Xt) @ ccpp)) @ ccer))))))))))))).
