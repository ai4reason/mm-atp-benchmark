...
thf(adeg1addle2_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XR @ ccpl1)) => ((XD = (ccfv @ XR @ ccdg1)) => ((Xph => (cwcel @ XR @ ccrg)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xc_pl = (ccfv @ XY @ ccplusg)) => ((Xph => (cwcel @ XF @ XB2)) => ((Xph => (cwcel @ XG @ XB2)) => ((Xph => (cwcel @ XL @ ccxr)) => ((Xph => (cwbr @ (ccfv @ XF @ XD) @ XL @ ccle)) => ((Xph => (cwbr @ (ccfv @ XG @ XD) @ XL @ ccle)) => (Xph => (cwbr @ (ccfv @ (cco @ XF @ XG @ Xc_pl) @ XD) @ XL @ ccle)))))))))))))))))))))).
...
thf(adeg1mul3le_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XK = (ccfv @ XR @ ccbs)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xc_x = (ccfv @ XP @ ccmulr)) => ((XA2 = (ccfv @ XP @ ccascl)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XK) @ (cwcel @ XG @ XB2)) => (cwbr @ (ccfv @ (cco @ (ccfv @ XF @ XA2) @ XG @ Xc_x) @ XD) @ (ccfv @ XG @ XD) @ ccle)))))))))))))))))).
...
thf(acoe1sclmulfv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((XA2 = (ccfv @ XP @ ccascl)) => ((Xc_xb = (ccfv @ XP @ ccmulr)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((cw3a @ (cwcel @ XR @ ccrg) @ ((cwcel @ XX @ XK) & (cwcel @ XY @ XB2)) @ (cwcel @ Xc_0 @ ccn0)) => ((ccfv @ Xc_0 @ (ccfv @ (cco @ (ccfv @ XX @ XA2) @ XY @ Xc_xb) @ ccco1)) = (cco @ XX @ (ccfv @ Xc_0 @ (ccfv @ XY @ ccco1)) @ Xc_x)))))))))))))))))))).
...
thf(chbtlem2_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XU = (ccfv @ XP @ cclidl)) => ((XS = (ccfv @ XR @ ccldgis)) => ((XT = (ccfv @ XR @ cclidl)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XU) @ (cwcel @ XX @ ccn0)) => (cwcel @ (ccfv @ XX @ (ccfv @ XI @ XS)) @ XT)))))))))))))).
