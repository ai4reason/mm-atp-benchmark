...
thf(aclatl_ax,axiom,(! [XK:($i > $o)] : ((cwcel @ XK @ cccla) => (cwcel @ XK @ cclat)))).
...
thf(alubel_ax,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XU = (ccfv @ XK @ cclub)) => ((cw3a @ (cwcel @ XK @ cccla) @ (cwcel @ XX @ XS) @ (cwss @ XS @ XB2)) => (cwbr @ XX @ (ccfv @ XS @ XU) @ Xc_le)))))))))))).
...
thf(clubun_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XU = (ccfv @ XK @ cclub)) => ((cw3a @ (cwcel @ XK @ cccla) @ (cwss @ XS @ XB2) @ (cwss @ XT @ XB2)) => ((ccfv @ (ccun @ XS @ XT) @ XU) = (cco @ (ccfv @ XS @ XU) @ (ccfv @ XT @ XU) @ Xc_or))))))))))))).
