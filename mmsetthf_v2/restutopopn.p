...
thf(arestutop_ax,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwss @ XA2 @ XX)) => (cwss @ (cco @ (ccfv @ XU @ ccutop) @ XA2 @ ccrest) @ (ccfv @ (cco @ XU @ (ccxp @ XA2 @ XA2) @ ccrest) @ ccutop))))))).
...
thf(atrust_ax,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwss @ XA2 @ XX)) => (cwcel @ (cco @ XU @ (ccxp @ XA2 @ XA2) @ ccrest) @ (ccfv @ XA2 @ ccust))))))).
...
thf(asimp_9l_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : (! [Xsi:$o] : (! [Xrh:$o] : (! [Xmu:$o] : ((((((((((Xph & Xps) & Xch) & Xth) & Xta) & Xet) & Xze) & Xsi) & Xrh) & Xmu) => Xph)))))))))))).
...
thf(ainimass_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwss @ (ccima @ (ccin @ XA2 @ XB2) @ XC) @ (ccin @ (ccima @ XA2 @ XC) @ (ccima @ XB2 @ XC))))))).
...
thf(crestutopopn_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ XA2 @ (ccfv @ XU @ ccutop))) => ((cco @ (ccfv @ XU @ ccutop) @ XA2 @ ccrest) = (ccfv @ (cco @ XU @ (ccxp @ XA2 @ XA2) @ ccrest) @ ccutop))))))).
