...
thf(afvline2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwne @ XA2 @ XB2))) => ((cco @ XA2 @ XB2 @ ccline2) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccop @ XA2 @ XB2) @ cccolin)) @ (^ [Xx3:$i] : (ccfv @ XN @ ccee))))))))).
...
thf(clinecom_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cw3a @ (cwcel @ XP @ (ccfv @ XN @ ccee)) @ (cwcel @ XQ @ (ccfv @ XN @ ccee)) @ (cwne @ XP @ XQ))) => ((cco @ XP @ XQ @ ccline2) = (cco @ XQ @ XP @ ccline2))))))).
