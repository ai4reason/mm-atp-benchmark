...
thf(aeclclwwlkn1_ax,axiom,(! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [Xc_sm:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (XW = (cco @ XN @ (XG @ Xy1 @ Xu @ Xt @ Xn) @ ccclwwlkn)))))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : ((Xc_sm @ Xu @ Xt @ Xn) = (ccopab @ (^ [Xt:$i] : (^ [Xu:$i] : (cw3a @ (cwcel @ (ccv @ Xt) @ XW) @ (cwcel @ (ccv @ Xu) @ XW) @ (cwrex @ (^ [Xn:$i] : ((ccv @ Xt) = (cco @ (ccv @ Xu) @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz))))))))))) => (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : ((cwcel @ (XB2 @ Xu @ Xt @ Xn) @ (XX @ Xu @ Xt @ Xn)) => ((cwcel @ (XB2 @ Xu @ Xt @ Xn) @ (ccqs @ XW @ (Xc_sm @ Xu @ Xt @ Xn))) <=> (cwrex @ (^ [Xx3:$i] : ((XB2 @ Xu @ Xt @ Xn) = (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xn:$i] : ((ccv @ Xy1) = (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz)))) @ (^ [Xy1:$i] : XW)))) @ (^ [Xx3:$i] : XW)))))))))))))))).
...
thf(aclwwlknscsh_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XW @ (cco @ XN @ XG @ ccclwwlkn))) => ((ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xn:$i] : ((ccv @ Xy1) = (cco @ XW @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz)))) @ (^ [Xy1:$i] : (cco @ XN @ XG @ ccclwwlkn))) = (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xn:$i] : ((ccv @ Xy1) = (cco @ XW @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz)))) @ (^ [Xy1:$i] : (ccword @ (ccfv @ XG @ ccvtx)))))))))).
...
thf(ascshwfzeqfzo_ax,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XX @ (ccword @ XV)) @ (cwne @ XX @ cc0) @ (XN = (ccfv @ XX @ cchash))) => ((ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xn:$i] : ((ccv @ Xy1) = (cco @ XX @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz)))) @ (^ [Xy1:$i] : (ccword @ XV))) = (ccrab @ (^ [Xy1:$i] : (cwrex @ (^ [Xn:$i] : ((ccv @ Xy1) = (cco @ XX @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfzo)))) @ (^ [Xy1:$i] : (ccword @ XV))))))))).
...
thf(acshwshash_ax,axiom,(! [XM:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xw:$i] : (! [Xn:$i] : ((XM @ Xw @ Xn) = (ccrab @ (^ [Xw:$i] : (cwrex @ (^ [Xn:$i] : ((cco @ XW @ (ccv @ Xn) @ cccsh) = (ccv @ Xw))) @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)))) @ (^ [Xw:$i] : (ccword @ XV)))))) => (! [Xw:$i] : (! [Xn:$i] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ (ccfv @ XW @ cchash) @ ccprime)) => (((ccfv @ (XM @ Xw @ Xn) @ cchash) = (ccfv @ XW @ cchash)) | ((ccfv @ (XM @ Xw @ Xn) @ cchash) = cc1)))))))))).
...
thf(chashecclwwlkn1_conj,conjecture,(! [Xc_sm:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((! [Xt:$i] : (XW = (cco @ XN @ (XG @ Xt) @ ccclwwlkn))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : ((Xc_sm @ Xu @ Xt @ Xn) = (ccopab @ (^ [Xt:$i] : (^ [Xu:$i] : (cw3a @ (cwcel @ (ccv @ Xt) @ XW) @ (cwcel @ (ccv @ Xu) @ XW) @ (cwrex @ (^ [Xn:$i] : ((ccv @ Xt) = (cco @ (ccv @ Xu) @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz))))))))))) => (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (((cwcel @ XN @ ccprime) & (cwcel @ (XU @ Xt) @ (ccqs @ XW @ (Xc_sm @ Xu @ Xt @ Xn)))) => (((ccfv @ (XU @ Xt) @ cchash) = cc1) | ((ccfv @ (XU @ Xt) @ cchash) = XN)))))))))))))).
