...
thf(anbusgrf1o1_ax,axiom,(! [XU:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xf1:$i] : ((XV @ Xf1) = (ccfv @ (XG @ Xf1) @ ccvtx))) => ((! [Xf1:$i] : ((XE @ Xf1) = (ccfv @ (XG @ Xf1) @ ccedg))) => ((! [Xf1:$i] : (XN = (cco @ (XG @ Xf1) @ XU @ ccnbgr))) => ((! [Xf1:$i] : (XI = (ccrab @ (^ [Xe:$i] : (cwcel @ XU @ (ccv @ Xe))) @ (^ [Xe:$i] : (XE @ Xf1))))) => (! [Xf1:$i] : (((cwcel @ (XG @ Xf1) @ ccusgr) & (cwcel @ XU @ (XV @ Xf1))) => (? [Xf1:$i] : (cwf1o @ XN @ XI @ (ccv @ Xf1)))))))))))))))).
