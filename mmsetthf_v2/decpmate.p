...
thf(cdecpmate_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XC = (cco @ XN @ XP @ ccmat)) => ((XB2 = (ccfv @ XC @ ccbs)) => (((cw3a @ (cwcel @ XR @ XV) @ (cwcel @ XM @ XB2) @ (cwcel @ XK @ ccn0)) & ((cwcel @ XI @ XN) & (cwcel @ XJ @ XN))) => ((cco @ XI @ XJ @ (cco @ XM @ XK @ ccdecpmat)) = (ccfv @ XK @ (ccfv @ (cco @ XI @ XJ @ XM) @ ccco1)))))))))))))))))).
