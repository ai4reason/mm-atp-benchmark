...
thf(cfldiv2_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XM @ ccn) @ (cwcel @ XN @ ccn)) => ((ccfv @ (cco @ (ccfv @ (cco @ XA2 @ XM @ ccdiv) @ ccfl) @ XN @ ccdiv) @ ccfl) = (ccfv @ (cco @ XA2 @ (cco @ XM @ XN @ ccmul) @ ccdiv) @ ccfl))))))).
