...
thf(abasgen2_ax,axiom,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : ((cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XB2 @ XJ) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((cwcel @ (ccv @ Xy1) @ (ccv @ Xz)) & (cwss @ (ccv @ Xz) @ (ccv @ Xx3)))) @ (^ [Xz:$i] : XB2))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XJ))) => ((ccfv @ XB2 @ cctg) = XJ))))).
thf(asylibr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xch <=> Xps) => (Xph => Xch))))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(atgclb_ax,axiom,(! [XB2:($i > $o)] : ((cwcel @ XB2 @ cctb) <=> (cwcel @ (ccfv @ XB2 @ cctg) @ cctop)))).
...
thf(a_2ndci_ax,axiom,(! [XB2:($i > $o)] : (((cwcel @ XB2 @ cctb) & (cwbr @ XB2 @ ccom @ ccdom)) => (cwcel @ (ccfv @ XB2 @ cctg) @ cc2ndc)))).
thf(ais2ndc_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cc2ndc) <=> (cwrex @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) & ((ccfv @ (ccv @ Xx3) @ cctg) = XJ))) @ (^ [Xx3:$i] : cctb))))).
thf(c_2ndcomap_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : ((XY @ Xx3) = (ccuni @ XK))) => ((Xph => (cwcel @ XJ @ cc2ndc)) => ((Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((! [Xx3:$i] : (Xph => ((ccrn @ XF) = (XY @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XJ)) => (cwcel @ (ccima @ XF @ (ccv @ Xx3)) @ XK))) => (Xph => (cwcel @ XK @ cc2ndc))))))))))))).
