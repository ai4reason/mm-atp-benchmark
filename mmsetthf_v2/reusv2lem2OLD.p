...
thf(creusv2lem2OLD_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cweu @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XB2 @ Xy1))) @ (^ [Xy1:$i] : XA2)))) => (cweu @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (XB2 @ Xy1))) @ (^ [Xy1:$i] : XA2)))))))).
