...
thf(aeluz2cnn0n1_ax,axiom,(! [XB2:($i > $o)] : ((cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) => (cwcel @ XB2 @ (ccdif @ ccc @ (ccpr @ ccc0 @ cc1)))))).
...
thf(acxplogb_ax,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XB2 @ (ccdif @ ccc @ (ccpr @ ccc0 @ cc1))) & (cwcel @ XX @ (ccdif @ ccc @ (ccsn @ ccc0)))) => ((cco @ XB2 @ (cco @ XB2 @ XX @ cclogb) @ cccxp) = XX))))).
...
thf(aeluz2n0_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) => (cwne @ XN @ ccc0)))).
...
thf(cdignn0ldlem_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccn) @ (cwcel @ XK @ (ccfv @ (cco @ (ccfv @ (cco @ XB2 @ XN @ cclogb) @ ccfl) @ cc1 @ ccaddc) @ ccuz))) => (cwbr @ XN @ (cco @ XB2 @ XK @ ccexp) @ cclt)))))).
