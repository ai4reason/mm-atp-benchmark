...
thf(aedgumgr_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XG @ ccumgr) & (cwcel @ XE @ (ccfv @ XG @ ccedg))) => ((cwcel @ XE @ (ccpw @ (ccfv @ XG @ ccvtx))) & ((ccfv @ XE @ cchash) = cc2)))))).
thf(cumgrres1lem_conj,conjecture,(! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xp:$i] : ((XE @ Xp) = (ccfv @ XG @ ccedg))) => ((! [Xe:$i] : (! [Xp:$i] : ((XF @ Xe) = (ccrab @ (^ [Xe:$i] : (cwnel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : (XE @ Xp)))))) => (! [Xe:$i] : (((cwcel @ XG @ ccumgr) & (cwcel @ XN @ XV)) => (cwss @ (ccrn @ (ccres @ ccid @ (XF @ Xe))) @ (ccrab @ (^ [Xp:$i] : ((ccfv @ (ccv @ Xp) @ cchash) = cc2)) @ (^ [Xp:$i] : (ccpw @ (ccdif @ XV @ (ccsn @ XN))))))))))))))))).
