...
thf(arpmsubg_ax,axiom,(! [XM:($i > $o)] : ((XM = (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccdif @ ccc @ (ccsn @ ccc0)) @ ccress)) => (cwcel @ ccrp @ (ccfv @ XM @ ccsubg))))).
...
thf(creefgim_conj,conjecture,(! [XP:($i > $o)] : ((XP = (cco @ (ccfv @ cccnfld @ ccmgp) @ ccrp @ ccress)) => (cwcel @ (ccres @ cce @ ccr) @ (cco @ ccrefld @ XP @ ccgim))))).
