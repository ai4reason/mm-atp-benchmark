...
thf(ausgrf1_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : ((XE = (ccfv @ XG @ cciedg)) => ((cwcel @ XG @ ccusgr) => (cwf1 @ (ccdm @ XE) @ (ccrn @ XE) @ XE)))))).
...
thf(apreq12bg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) & ((cwcel @ XC @ XX) & (cwcel @ XD @ XY))) => (((ccpr @ XA2 @ XB2) = (ccpr @ XC @ XD)) <=> (((XA2 = XC) & (XB2 = XD)) | ((XA2 = XD) & (XB2 = XC)))))))))))))).
...
thf(apm2_24i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((~ Xph) => Xps))))).
