...
thf(aovelimab_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XA2) & (cwss @ (ccxp @ XB2 @ XC) @ XA2)) => ((cwcel @ XD @ (ccima @ XF @ (ccxp @ XB2 @ XC))) <=> (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (XD = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF))) @ (^ [Xy1:$i] : XC))) @ (^ [Xx3:$i] : XB2)))))))))).
thf(cofrn2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwf @ XA2 @ XB2 @ XG)) => ((Xph => (cwf @ (ccxp @ XB2 @ XB2) @ XC @ Xc_pl)) => ((Xph => (cwcel @ XA2 @ XV)) => (Xph => (cwss @ (ccrn @ (cco @ XF @ XG @ (ccof @ Xc_pl))) @ (ccima @ Xc_pl @ (ccxp @ (ccrn @ XF) @ (ccrn @ XG)))))))))))))))))).
