...
thf(adf_sseq_ax,axiom,(ccsseq = (ccmpt2 @ (^ [Xm:$i] : (^ [Xf1:$i] : ccvv)) @ (^ [Xm:$i] : (^ [Xf1:$i] : ccvv)) @ (^ [Xm:$i] : (^ [Xf1:$i] : (ccun @ (ccv @ Xm) @ (cccom @ cclsw @ (ccseq @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccs1 @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1))) @ ccconcat)))) @ (ccxp @ ccn0 @ (ccsn @ (cco @ (ccv @ Xm) @ (ccs1 @ (ccfv @ (ccv @ Xm) @ (ccv @ Xf1))) @ ccconcat))) @ (ccfv @ (ccv @ Xm) @ cchash))))))))).
