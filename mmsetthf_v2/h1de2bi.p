...
thf(ah1de2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cwcel @ XA2 @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) => ((cco @ (cco @ XB2 @ XB2 @ ccsp) @ XA2 @ ccsm) = (cco @ (cco @ XA2 @ XB2 @ ccsp) @ XB2 @ ccsm)))))))).
...
thf(ch1de2bi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cwne @ XB2 @ cc0v) => ((cwcel @ XA2 @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) <=> (XA2 = (cco @ (cco @ (cco @ XA2 @ XB2 @ ccsp) @ (cco @ XB2 @ XB2 @ ccsp) @ ccdiv) @ XB2 @ ccsm))))))))).
