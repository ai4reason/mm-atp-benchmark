...
thf(apmtrdifwrdel2lem1_ax,axiom,(! [XR:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((! [Xx3:$i] : (XT = (ccrn @ (ccfv @ (ccdif @ XN @ (ccsn @ (XK @ Xx3))) @ ccpmtr)))) => ((! [Xi:$i] : ((XR @ Xi) = (ccrn @ (ccfv @ XN @ ccpmtr)))) => ((! [Xx3:$i] : (! [Xi:$i] : ((XU @ Xx3 @ Xi) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (ccdm @ (ccdif @ (ccfv @ (ccv @ Xx3) @ XW) @ ccid)) @ (ccfv @ XN @ ccpmtr))))))) => (! [Xx3:$i] : (((cwcel @ XW @ (ccword @ XT)) & (cwcel @ (XK @ Xx3) @ XN)) => (cwral @ (^ [Xi:$i] : ((ccfv @ (XK @ Xx3) @ (ccfv @ (ccv @ Xi) @ (XU @ Xx3 @ Xi))) = (XK @ Xx3))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))))))))))))))).
