...
thf(azringsubgval_ax,axiom,(! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_mi = (ccfv @ czring @ ccsg)) => (((cwcel @ XX @ ccz) & (cwcel @ XY @ ccz)) => ((cco @ XX @ XY @ ccmin) = (cco @ XX @ XY @ Xc_mi)))))))).
