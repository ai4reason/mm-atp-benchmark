...
thf(arnghmfn_ax,axiom,(cwfn @ ccrngh @ (ccxp @ ccrng @ ccrng))).
...
thf(arhmfn_ax,axiom,(cwfn @ ccrh @ (ccxp @ ccrg @ ccrg))).
...
thf(adfringc2_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((XC = (ccfv @ XU @ ccringc)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (XB2 = (ccin @ XU @ ccrg))) => ((Xph => (XH = (ccres @ ccrh @ (ccxp @ XB2 @ XB2)))) => ((Xph => (Xc_x = (ccfv @ (ccfv @ XU @ ccestrc) @ ccco))) => (Xph => (XC = (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ cchom) @ XH) @ (ccop @ (ccfv @ ccnx @ ccco) @ Xc_x))))))))))))))))).
thf(crngcresringcat_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((XC = (ccfv @ XU @ ccrngc)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (XB2 = (ccin @ ccrg @ XU))) => ((Xph => (XH = (ccres @ ccrh @ (ccxp @ XB2 @ XB2)))) => (Xph => ((cco @ XC @ XH @ ccresc) = (ccfv @ XU @ ccringc)))))))))))))).
