...
thf(adf_bj_sngl_ax,axiom,(! [XA2:($i > $o)] : ((cbj_csngl @ XA2) = (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (ccsn @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2))))))).
...
thf(cbj_elsngl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ (cbj_csngl @ XB2)) <=> (cwrex @ (^ [Xx3:$i] : (XA2 = (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XB2)))))).
