...
thf(aatcv1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccat) @ (cwcel @ XC @ ccat)) & (cwbr @ XA2 @ (cco @ XB2 @ XC @ cchj) @ cccv)) => ((XA2 = cc0h) <=> (XB2 = XC))))))).
...
thf(aatcvati_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => (((cwcel @ XB2 @ ccat) & (cwcel @ XC @ ccat)) => (((cwne @ XA2 @ cc0h) & (cwpss @ XA2 @ (cco @ XB2 @ XC @ cchj))) => (cwcel @ XA2 @ ccat)))))))).
thf(catcvat2i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => (((cwcel @ XB2 @ ccat) & (cwcel @ XC @ ccat)) => (((~ (XB2 = XC)) & (cwbr @ XA2 @ (cco @ XB2 @ XC @ cchj) @ cccv)) => (cwcel @ XA2 @ ccat)))))))).
