...
thf(aleop_ax,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (((cwcel @ XT @ ccho) & (cwcel @ XU @ ccho)) => ((cwbr @ XT @ XU @ ccleo) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ ccc0 @ (cco @ (ccfv @ (ccv @ Xx3) @ (cco @ XU @ XT @ cchod)) @ (ccv @ Xx3) @ ccsp) @ ccle)) @ (^ [Xx3:$i] : cchil))))))).
...
thf(cleop3_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (((cwcel @ XT @ ccho) & (cwcel @ XU @ ccho)) => ((cwbr @ XT @ XU @ ccleo) <=> (cwbr @ cch0o @ (cco @ XU @ XT @ cchod) @ ccleo)))))).
