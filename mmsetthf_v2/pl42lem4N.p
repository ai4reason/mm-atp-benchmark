...
thf(apmapsub_ax,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XS = (ccfv @ XK @ ccpsubsp)) => ((XM = (ccfv @ XK @ ccpmap)) => (((cwcel @ XK @ cclat) & (cwcel @ XX @ XB2)) => (cwcel @ (ccfv @ XX @ XM) @ XS))))))))))).
...
thf(apmodl42N_ax,axiom,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XS = (ccfv @ XK @ ccpsubsp)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => (((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XS) @ (cwcel @ XY @ XS)) & ((cwcel @ XZ @ XS) & (cwcel @ XW @ XS))) => ((ccin @ (cco @ (cco @ XX @ XY @ Xc_pl) @ XZ @ Xc_pl) @ (cco @ (cco @ XX @ XY @ Xc_pl) @ XW @ Xc_pl)) = (cco @ (cco @ XX @ XY @ Xc_pl) @ (ccin @ (cco @ XX @ XZ @ Xc_pl) @ (cco @ XY @ XW @ Xc_pl)) @ Xc_pl))))))))))))).
thf(apl42lem2N_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((Xc_pe = (ccfv @ XK @ ccoc)) => ((XF = (ccfv @ XK @ ccpmap)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => (((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) & (cw3a @ (cwcel @ XZ @ XB2) @ (cwcel @ XW @ XB2) @ (cwcel @ XV @ XB2))) => (cwss @ (cco @ (cco @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ Xc_pl) @ (ccin @ (cco @ (ccfv @ XX @ XF) @ (ccfv @ XW @ XF) @ Xc_pl) @ (cco @ (ccfv @ XY @ XF) @ (ccfv @ XV @ XF) @ Xc_pl)) @ Xc_pl) @ (ccfv @ (cco @ (cco @ XX @ XY @ Xc_or) @ (cco @ (cco @ XX @ XW @ Xc_or) @ (cco @ XY @ XV @ Xc_or) @ Xc_an) @ Xc_or) @ XF)))))))))))))))))))))))).
thf(cpl42lem4N_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((Xc_pe = (ccfv @ XK @ ccoc)) => ((XF = (ccfv @ XK @ ccpmap)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => (((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) & (cw3a @ (cwcel @ XZ @ XB2) @ (cwcel @ XW @ XB2) @ (cwcel @ XV @ XB2))) => (((cwbr @ XX @ (ccfv @ XY @ Xc_pe) @ Xc_le) & (cwbr @ XZ @ (ccfv @ XW @ Xc_pe) @ Xc_le)) => (cwss @ (ccfv @ (cco @ (cco @ (cco @ (cco @ XX @ XY @ Xc_or) @ XZ @ Xc_an) @ XW @ Xc_or) @ XV @ Xc_an) @ XF) @ (ccfv @ (cco @ (cco @ XX @ XY @ Xc_or) @ (cco @ (cco @ XX @ XW @ Xc_or) @ (cco @ XY @ XV @ Xc_or) @ Xc_an) @ Xc_or) @ XF))))))))))))))))))))))))).
