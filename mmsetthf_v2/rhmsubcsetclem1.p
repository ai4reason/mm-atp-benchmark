...
thf(crhmsubcsetclem1_conj,conjecture,(! [Xph:$o] : (! [Xx3:$i] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((XC = (ccfv @ XU @ ccestrc)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (XB2 = (ccin @ ccrg @ XU))) => ((Xph => (XH = (ccres @ ccrh @ (ccxp @ XB2 @ XB2)))) => ((Xph & (cwcel @ (ccv @ Xx3) @ XB2)) => (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XC @ cccid)) @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ XH))))))))))))))).
