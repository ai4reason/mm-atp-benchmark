...
thf(aopidonOLD_ax,axiom,(! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ (ccdm @ XG))) => ((cwcel @ XG @ (ccin @ ccmagm @ ccexid)) => (cwfo @ (ccxp @ XX @ XX) @ XX @ XG)))))).
...
thf(copidon2OLD_conj,conjecture,(! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((cwcel @ XG @ (ccin @ ccmagm @ ccexid)) => (cwfo @ (ccxp @ XX @ XX) @ XX @ XG)))))).
