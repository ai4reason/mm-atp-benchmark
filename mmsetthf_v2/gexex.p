...
thf(agexexlem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => ((XO = (ccfv @ XG @ ccod)) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XE @ ccn)) => ((Xph => (cwcel @ XA2 @ XX)) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XX)) => (cwbr @ (ccfv @ (ccv @ Xy1) @ XO) @ (ccfv @ XA2 @ XO) @ ccle))) => (Xph => ((ccfv @ XA2 @ XO) = XE)))))))))))))))).
