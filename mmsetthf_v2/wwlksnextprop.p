...
thf(awwlksnextproplem2_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ (cco @ XN @ cc1 @ ccaddc) @ XG @ ccwwlksn)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XW @ XX) & (cwcel @ XN @ ccn0)) => (cwcel @ (ccpr @ (ccfv @ (cco @ XW @ (ccop @ ccc0 @ (cco @ XN @ cc1 @ ccaddc)) @ ccsubstr) @ cclsw) @ (ccfv @ XW @ cclsw)) @ XE)))))))))).
...
thf(cwwlksnextprop_conj,conjecture,(! [XP:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((XX @ Xx3 @ Xw) = (cco @ (cco @ XN @ cc1 @ ccaddc) @ (XG @ Xx3 @ Xy1) @ ccwwlksn))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((XE @ Xx3 @ Xw) = (ccfv @ (XG @ Xx3 @ Xy1) @ ccedg))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((XY @ Xx3 @ Xw) = (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = (XP @ Xx3))) @ (^ [Xw:$i] : (cco @ XN @ (XG @ Xx3 @ Xy1) @ ccwwlksn))))))) => (! [Xw:$i] : ((cwcel @ XN @ ccn0) => ((ccrab @ (^ [Xx3:$i] : ((ccfv @ ccc0 @ (ccv @ Xx3)) = (XP @ Xx3))) @ (^ [Xx3:$i] : (XX @ Xx3 @ Xw))) = (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cw3a @ ((cco @ (ccv @ Xx3) @ (ccop @ ccc0 @ (cco @ XN @ cc1 @ ccaddc)) @ ccsubstr) = (ccv @ Xy1)) @ ((ccfv @ ccc0 @ (ccv @ Xy1)) = (XP @ Xx3)) @ (cwcel @ (ccpr @ (ccfv @ (ccv @ Xy1) @ cclsw) @ (ccfv @ (ccv @ Xx3) @ cclsw)) @ (XE @ Xx3 @ Xw)))) @ (^ [Xy1:$i] : (XY @ Xx3 @ Xw)))) @ (^ [Xx3:$i] : (XX @ Xx3 @ Xw)))))))))))))))).
