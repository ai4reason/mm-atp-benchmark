...
thf(cramubcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (((cw3a @ (cwcel @ XM @ ccn0) @ (cwcel @ XR @ XV) @ (cwf @ XR @ ccn0 @ XF)) & ((cwcel @ XA2 @ ccn0) & (cwbr @ (cco @ XM @ XF @ ccram) @ XA2 @ ccle))) => (cwcel @ (cco @ XM @ XF @ ccram) @ ccn0)))))))).
