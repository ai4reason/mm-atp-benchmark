...
thf(cfourierdlem32_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccc @ cccncf))) => ((Xph => (cwcel @ XR @ (cco @ XF @ XA2 @ cclimc))) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwcel @ XD @ ccr)) => ((Xph => (cwbr @ XC @ XD @ cclt)) => ((Xph => (cwss @ (cco @ XC @ XD @ ccioo) @ (cco @ XA2 @ XB2 @ ccioo))) => ((XY = (ccif @ (XC = XA2) @ XR @ (ccfv @ XC @ XF))) => ((XJ = (cco @ (ccfv @ cccnfld @ cctopn) @ (cco @ XA2 @ XB2 @ ccico) @ ccrest)) => (Xph => (cwcel @ XY @ (cco @ (ccres @ XF @ (cco @ XC @ XD @ ccioo)) @ XC @ cclimc)))))))))))))))))))))))).
