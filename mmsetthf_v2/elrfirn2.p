...
thf(aelrfirn_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : (((cwcel @ (XB2 @ Xy1) @ (XV @ Xy1)) & (cwf @ (XI @ Xy1) @ (ccpw @ (XB2 @ Xy1)) @ XF)) => ((cwcel @ (XA2 @ Xy1) @ (ccfv @ (ccun @ (ccsn @ (XB2 @ Xy1)) @ (ccrn @ XF)) @ ccfi)) <=> (cwrex @ (^ [Xv:$i] : ((XA2 @ Xy1) = (ccin @ (XB2 @ Xy1) @ (cciin @ (^ [Xy1:$i] : (ccv @ Xv)) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XF)))))) @ (^ [Xv:$i] : (ccin @ (ccpw @ (XI @ Xy1)) @ ccfn)))))))))))).
...
thf(aiineq2_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwral @ (^ [Xx3:$i] : ((XB2 @ Xx3) = (XC @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cciin @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (cciin @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3))))))))).
thf(celrfirn2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [Xy1:$i] : (((cwcel @ XB2 @ XV) & (cwral @ (^ [Xy1:$i] : (cwss @ (XC @ Xy1) @ XB2)) @ (^ [Xy1:$i] : XI))) => ((cwcel @ (XA2 @ Xy1) @ (ccfv @ (ccun @ (ccsn @ XB2) @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : XI) @ (^ [Xy1:$i] : (XC @ Xy1))))) @ ccfi)) <=> (cwrex @ (^ [Xv:$i] : ((XA2 @ Xy1) = (ccin @ XB2 @ (cciin @ (^ [Xy1:$i] : (ccv @ Xv)) @ (^ [Xy1:$i] : (XC @ Xy1)))))) @ (^ [Xv:$i] : (ccin @ (ccpw @ XI) @ ccfn)))))))))))).
