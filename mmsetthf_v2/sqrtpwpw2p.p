...
thf(aaddge0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ ccc0 @ XB2 @ ccle))) => (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccaddc) @ ccle))))).
...
thf(csqrtpwpw2p_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XM @ ccn0) @ (cwbr @ XM @ (cco @ (cco @ cc2 @ (cco @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ cc1 @ ccaddc) @ ccexp) @ cc1 @ ccaddc) @ cclt)) => ((ccfv @ (ccfv @ (cco @ (cco @ cc2 @ (cco @ cc2 @ XN @ ccexp) @ ccexp) @ XM @ ccaddc) @ ccsqrt) @ ccfl) = (cco @ cc2 @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccexp)))))).
