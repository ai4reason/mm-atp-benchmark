...
thf(aeqsqrt2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => ((cco @ XA2 @ cc2 @ ccexp) = XB2)) => ((Xph => (cwbr @ ccc0 @ (ccfv @ XA2 @ ccre) @ cclt)) => (Xph => (XA2 = (ccfv @ XB2 @ ccsqrt))))))))))).
...
thf(aasinsinlem_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ (ccfv @ XA2 @ ccre) @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccioo))) => (cwbr @ ccc0 @ (ccfv @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cce) @ ccre) @ cclt)))).
