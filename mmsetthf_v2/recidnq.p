...
thf(arecmulnq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccnq) => (((ccfv @ XA2 @ ccrq) = XB2) <=> ((cco @ XA2 @ XB2 @ ccmq) = cc1q)))))).
thf(crecidnq_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccnq) => ((cco @ XA2 @ (ccfv @ XA2 @ ccrq) @ ccmq) = cc1q)))).
