...
thf(allycmpkgen2_ax,axiom,(! [Xph:$o] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : ((XX @ Xx3) = (ccuni @ XJ))) => ((Xph => (cwcel @ XJ @ cctop)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (XX @ Xx3))) => (cwrex @ (^ [Xk:$i] : (cwcel @ (cco @ XJ @ (ccv @ Xk) @ ccrest) @ cccmp)) @ (^ [Xk:$i] : (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)))))) => (Xph => (cwcel @ XJ @ (ccrn @ cckgen)))))))))).
...
thf(anllyi_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : ((cw3a @ (cwcel @ XJ @ (ccnlly @ XA2)) @ (cwcel @ XU @ XJ) @ (cwcel @ XP @ XU)) => (cwrex @ (^ [Xu:$i] : ((cwss @ (ccv @ Xu) @ XU) & (cwcel @ (cco @ XJ @ (ccv @ Xu) @ ccrest) @ XA2))) @ (^ [Xu:$i] : (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei)))))))))).
