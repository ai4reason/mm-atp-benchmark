...
thf(apntrsumbnd_ax,axiom,(! [XR:($i > ($i > $o))] : ((! [Xa:$i] : ((XR @ Xa) = (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccv @ Xa) @ ccchp) @ (ccv @ Xa) @ ccmin))))) => (! [Xa:$i] : (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xm:$i] : (cwbr @ (ccfv @ (ccsu @ (cco @ cc1 @ (ccv @ Xm) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ (XR @ Xa)) @ (cco @ (ccv @ Xn) @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ ccmul) @ ccdiv))) @ ccabs) @ (ccv @ Xc) @ ccle)) @ (^ [Xm:$i] : ccz))) @ (^ [Xc:$i] : ccrp)))))).
