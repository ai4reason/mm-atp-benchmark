...
thf(aressnop0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((~ (cwcel @ XA2 @ XC)) => ((ccres @ (ccsn @ (ccop @ XA2 @ XB2)) @ XC) = cc0)))))).
...
thf(cfsnunres_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwfn @ XF @ XS) & (~ (cwcel @ XX @ XS))) => ((ccres @ (ccun @ XF @ (ccsn @ (ccop @ XX @ XY))) @ XS) = XF))))))).
