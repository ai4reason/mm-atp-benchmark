...
thf(cslmdacl_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_pl = (ccfv @ XF @ ccplusg)) => ((cw3a @ (cwcel @ XW @ ccslmd) @ (cwcel @ XX @ XK) @ (cwcel @ XY @ XK)) => (cwcel @ (cco @ XX @ XY @ Xc_pl) @ XK)))))))))))).
