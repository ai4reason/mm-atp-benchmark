...
thf(apjssdif2i_ax,axiom,(! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => ((cwss @ XG @ XH) <=> ((cco @ (ccfv @ XH @ ccpjh) @ (ccfv @ XG @ ccpjh) @ cchod) = (ccfv @ (ccin @ XH @ (ccfv @ XG @ ccort)) @ ccpjh)))))))).
...
thf(apjmfn_ax,axiom,(cwfn @ ccpjh @ ccch)).
...
thf(apjige0_ax,axiom,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : (((cwcel @ XH @ ccch) & (cwcel @ XA2 @ cchil)) => (cwbr @ ccc0 @ (cco @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ XA2 @ ccsp) @ ccle))))).
...
thf(cpjssdif1i_conj,conjecture,(! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XG @ ccch) => ((cwcel @ XH @ ccch) => ((cwss @ XG @ XH) <=> (cwcel @ (cco @ (ccfv @ XH @ ccpjh) @ (ccfv @ XG @ ccpjh) @ cchod) @ (ccrn @ ccpjh)))))))).
