...
thf(adf_exp_ax,axiom,(ccexp = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccc)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccz)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ ((ccv @ Xy1) = ccc0) @ cc1 @ (ccif @ (cwbr @ ccc0 @ (ccv @ Xy1) @ cclt) @ (ccfv @ (ccv @ Xy1) @ (ccseq @ ccmul @ (ccxp @ ccn @ (ccsn @ (ccv @ Xx3))) @ cc1)) @ (cco @ cc1 @ (ccfv @ (ccneg @ (ccv @ Xy1)) @ (ccseq @ ccmul @ (ccxp @ ccn @ (ccsn @ (ccv @ Xx3))) @ cc1)) @ ccdiv)))))))).
...
thf(cexpval_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XN @ ccz)) => ((cco @ XA2 @ XN @ ccexp) = (ccif @ (XN = ccc0) @ cc1 @ (ccif @ (cwbr @ ccc0 @ XN @ cclt) @ (ccfv @ XN @ (ccseq @ ccmul @ (ccxp @ ccn @ (ccsn @ XA2)) @ cc1)) @ (cco @ cc1 @ (ccfv @ (ccneg @ XN) @ (ccseq @ ccmul @ (ccxp @ ccn @ (ccsn @ XA2)) @ cc1)) @ ccdiv)))))))).
