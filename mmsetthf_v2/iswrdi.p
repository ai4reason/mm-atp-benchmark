...
thf(afzo0n0_ax,axiom,(! [XA2:($i > $o)] : ((cwne @ (cco @ ccc0 @ XA2 @ ccfzo) @ cc0) <=> (cwcel @ XA2 @ ccn)))).
...
thf(ciswrdi_conj,conjecture,(! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((cwf @ (cco @ ccc0 @ XL @ ccfzo) @ XS @ XW) => (cwcel @ XW @ (ccword @ XS))))))).
