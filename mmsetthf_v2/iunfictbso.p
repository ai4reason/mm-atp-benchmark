...
thf(afinnisoeu_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (((cwor @ XA2 @ XR) & (cwcel @ XA2 @ ccfn)) => (cweu @ (^ [Xf1:$i] : (cwiso @ (ccfv @ XA2 @ cccrd) @ XA2 @ ccep @ XR @ (ccv @ Xf1)))))))).
...
thf(ciunfictbso_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwbr @ XA2 @ ccom @ ccdom) @ (cwss @ XA2 @ ccfn) @ (cwor @ (ccuni @ XA2) @ XB2)) => (cwbr @ (ccuni @ XA2) @ ccom @ ccdom))))).
