...
thf(af1omvdmvd_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwf1o @ XA2 @ XA2 @ XF) & (cwcel @ XX @ (ccdm @ (ccdif @ XF @ ccid)))) => (cwcel @ (ccfv @ XX @ XF) @ (ccdif @ (ccdm @ (ccdif @ XF @ ccid)) @ (ccsn @ XX)))))))).
...
thf(afnelnfp_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwfn @ XF @ XA2) & (cwcel @ XX @ XA2)) => ((cwcel @ XX @ (ccdm @ (ccdif @ XF @ ccid))) <=> (cwne @ (ccfv @ XX @ XF) @ XX))))))).
...
thf(apmtrmvd_ax,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((cw3a @ (cwcel @ XD @ XV) @ (cwss @ XP @ XD) @ (cwbr @ XP @ cc2o @ ccen)) => ((ccdm @ (ccdif @ (ccfv @ XP @ XT) @ ccid)) = XP)))))))).
