...
thf(csumsnd_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xk:$i] : ((Xph @ Xk) => (cwnfc @ (^ [Xk:$i] : (XB2 @ Xk))))) => ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (((Xph @ Xk) & ((ccv @ Xk) = XM)) => ((XA2 @ Xk) = (XB2 @ Xk)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XM @ (XV @ Xk)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XB2 @ Xk) @ ccc))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccsu @ (ccsn @ XM) @ (^ [Xk:$i] : (XA2 @ Xk))) = (XB2 @ Xk))))))))))))))).
