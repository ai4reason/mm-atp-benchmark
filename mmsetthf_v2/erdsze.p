...
thf(aerdszelem11_ax,axiom,(! [Xph:$o] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwf1 @ (cco @ cc1 @ XN @ ccfz) @ ccr @ XF)) => ((XI = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xx3:$i] : (ccsup @ (ccima @ cchash @ (ccrab @ (^ [Xy1:$i] : ((cwiso @ (ccv @ Xy1) @ (ccima @ XF @ (ccv @ Xy1)) @ cclt @ cclt @ (ccres @ XF @ (ccv @ Xy1))) & (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccpw @ (cco @ cc1 @ (ccv @ Xx3) @ ccfz))))) @ ccr @ cclt)))) => ((XJ = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xx3:$i] : (ccsup @ (ccima @ cchash @ (ccrab @ (^ [Xy1:$i] : ((cwiso @ (ccv @ Xy1) @ (ccima @ XF @ (ccv @ Xy1)) @ cclt @ (cccnv @ cclt) @ (ccres @ XF @ (ccv @ Xy1))) & (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccpw @ (cco @ cc1 @ (ccv @ Xx3) @ ccfz))))) @ ccr @ cclt)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((XT @ Xx3 @ Xy1 @ Xn) = (ccmpt @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xn:$i] : (ccop @ (ccfv @ (ccv @ Xn) @ XI) @ (ccfv @ (ccv @ Xn) @ XJ)))))))) => ((! [Xn:$i] : (Xph => (cwcel @ (XR @ Xn) @ ccn))) => ((! [Xn:$i] : (Xph => (cwcel @ (XS @ Xn) @ ccn))) => ((! [Xn:$i] : (Xph => (cwbr @ (cco @ (cco @ (XR @ Xn) @ cc1 @ ccmin) @ (cco @ (XS @ Xn) @ cc1 @ ccmin) @ ccmul) @ XN @ cclt))) => (! [Xn:$i] : (Xph => (cwrex @ (^ [Xs1:$i] : (((cwbr @ (XR @ Xn) @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccle) & (cwiso @ (ccv @ Xs1) @ (ccima @ XF @ (ccv @ Xs1)) @ cclt @ cclt @ (ccres @ XF @ (ccv @ Xs1)))) | ((cwbr @ (XS @ Xn) @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccle) & (cwiso @ (ccv @ Xs1) @ (ccima @ XF @ (ccv @ Xs1)) @ cclt @ (cccnv @ cclt) @ (ccres @ XF @ (ccv @ Xs1)))))) @ (^ [Xs1:$i] : (ccpw @ (cco @ cc1 @ XN @ ccfz))))))))))))))))))))))).
