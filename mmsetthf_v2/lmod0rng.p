...
thf(a_0ringnnzr_ax,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ ccrg) => (((ccfv @ (ccfv @ XR @ ccbs) @ cchash) = cc1) <=> (~ (cwcel @ XR @ ccnzr)))))).
thf(aex_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) => Xch) => (Xph => (Xps => Xch))))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(a_0ring01eq_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_1 = (ccfv @ XR @ ccur)) => (((cwcel @ XR @ ccrg) & ((ccfv @ XB2 @ cchash) = cc1)) => (Xc_0 = Xc_1)))))))))).
...
thf(almodbn0_ax,axiom,(! [XB2:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((cwcel @ XW @ cclmod) => (cwne @ XB2 @ cc0)))))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(aeqsn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwne @ XA2 @ cc0) => ((XA2 = (ccsn @ XB2)) <=> (cwral @ (^ [Xx3:$i] : ((ccv @ Xx3) = XB2)) @ (^ [Xx3:$i] : XA2))))))).
thf(clmod0rng_conj,conjecture,(! [XM:($i > $o)] : (((cwcel @ XM @ cclmod) & (~ (cwcel @ (ccfv @ XM @ ccsca) @ ccnzr))) => ((ccfv @ XM @ ccbs) = (ccsn @ (ccfv @ XM @ cc0g)))))).
