...
thf(a_0cxp_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ XA2 @ ccc0)) => ((cco @ ccc0 @ XA2 @ cccxp) = ccc0)))).
...
thf(cmulcxplem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => (Xph => ((cco @ ccc0 @ XC @ cccxp) = (cco @ (cco @ XA2 @ XC @ cccxp) @ (cco @ ccc0 @ XC @ cccxp) @ ccmul))))))))).
