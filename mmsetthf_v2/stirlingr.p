...
thf(astirling_ax,axiom,(! [XS:($i > ($i > $o))] : ((! [Xn:$i] : ((XS @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccfv @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccv @ Xn) @ ccmul) @ ccsqrt) @ (cco @ (cco @ (ccv @ Xn) @ cceu @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul))))) => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (ccfv @ (ccv @ Xn) @ (XS @ Xn)) @ ccdiv))) @ cc1 @ ccli)))).
