...
thf(cwlklnwwlkln2lem_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((Xph => ((cwcel @ XP @ (ccfv @ XG @ ccwwlks)) => (? [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XG @ ccwlks))))) => (Xph => ((cwcel @ XP @ (cco @ XN @ XG @ ccwwlksn)) => (? [Xf1:$i] : ((cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XG @ ccwlks)) & ((ccfv @ (ccv @ Xf1) @ cchash) = XN))))))))))).
