...
thf(aiinss1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((cwss @ XA2 @ XB2) => (cwss @ (cciin @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))))))).
thf(asslin_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ XB2) => (cwss @ (ccin @ XC @ XA2) @ (ccin @ XC @ XB2))))))).
thf(a_3adant3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => ((cw3a @ Xph @ Xps @ Xth) => Xch))))))).
thf(ccmpt_tp,type,(ccmpt : (($i > ($i > $o)) > (($i > ($i > $o)) > ($i > $o))))).
thf(ccpw_tp,type,(ccpw : (($i > $o) > ($i > $o)))).
thf(apolvalN_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [Xc_pe:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xp:$i] : ((Xc_pe @ Xp) = (ccfv @ XK @ ccoc))) => ((! [Xp:$i] : ((XA2 @ Xp) = (ccfv @ XK @ ccatm))) => ((! [Xp:$i] : ((XM @ Xp) = (ccfv @ XK @ ccpmap))) => ((! [Xp:$i] : ((XP @ Xp) = (ccfv @ XK @ ccpolN))) => (! [Xp:$i] : (((cwcel @ XK @ (XB2 @ Xp)) & (cwss @ XX @ (XA2 @ Xp))) => ((ccfv @ XX @ (XP @ Xp)) = (ccin @ (XA2 @ Xp) @ (cciin @ (^ [Xp:$i] : XX) @ (^ [Xp:$i] : (ccfv @ (ccfv @ (ccv @ Xp) @ (Xc_pe @ Xp)) @ (XM @ Xp)))))))))))))))))))).
...
thf(cpolcon3N_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pe = (ccfv @ XK @ ccpolN)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cwss @ XY @ XA2) @ (cwss @ XX @ XY)) => (cwss @ (ccfv @ XY @ Xc_pe) @ (ccfv @ XX @ Xc_pe))))))))))).
