...
thf(aswrdrn_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz)) @ (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) => (cwss @ (ccrn @ (cco @ XW @ (ccop @ XM @ XN) @ ccsubstr)) @ XV))))))).
...
thf(aelfzodifsumelfzo_ax,axiom,(! [XP:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz)) & (cwcel @ XN @ (cco @ ccc0 @ XP @ ccfz))) => ((cwcel @ XI @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfzo)) => (cwcel @ (cco @ XI @ XM @ ccaddc) @ (cco @ ccc0 @ XP @ ccfzo))))))))).
...
thf(cswrdco_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XA2)) @ ((cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz)) & (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfz))) @ (cwf @ XA2 @ XB2 @ XF)) => ((cccom @ XF @ (cco @ XW @ (ccop @ XM @ XN) @ ccsubstr)) = (cco @ (cccom @ XF @ XW) @ (ccop @ XM @ XN) @ ccsubstr)))))))))).
