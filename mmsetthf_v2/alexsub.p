...
thf(aalexsublem_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccufl)) => ((Xph => (XX = (ccuni @ XB2))) => ((Xph => (XJ = (ccfv @ (ccfv @ XB2 @ ccfi) @ cctg))) => ((! [Xx3:$i] : ((Xph & ((cwss @ (ccv @ Xx3) @ XB2) & (XX = (ccuni @ (ccv @ Xx3))))) => (cwrex @ (^ [Xy1:$i] : (XX = (ccuni @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccin @ (ccpw @ (ccv @ Xx3)) @ ccfn))))) => ((Xph => (cwcel @ XF @ (ccfv @ XX @ ccufil))) => ((Xph => ((cco @ XJ @ XF @ ccflim) = cc0)) => (~ Xph))))))))))))).
...
thf(aufilcmp_ax,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ ccufl) & (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwcel @ XJ @ cccmp) <=> (cwral @ (^ [Xf1:$i] : (cwne @ (cco @ XJ @ (ccv @ Xf1) @ ccflim) @ cc0)) @ (^ [Xf1:$i] : (ccfv @ XX @ ccufil)))))))).
