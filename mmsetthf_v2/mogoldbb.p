...
thf(aevenltle_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ cceven) @ (cwcel @ XM @ cceven) @ (cwbr @ XM @ XN @ cclt)) => (cwbr @ (cco @ XM @ cc2 @ ccaddc) @ XN @ ccle))))).
...
thf(amogoldbblem_ax,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XQ @ ccprime) @ (cwcel @ XR @ ccprime)) @ (cwcel @ XN @ cceven) @ ((cco @ XN @ cc2 @ ccaddc) = (cco @ (cco @ XP @ XQ @ ccaddc) @ XR @ ccaddc))) => (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (XN = (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccaddc))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime)))))))).
