...
thf(adf_lgs_ax,axiom,(cclgs = (ccmpt2 @ (^ [Xa:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xa:$i] : (^ [Xn:$i] : ccz)) @ (^ [Xa:$i] : (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ (ccif @ ((cco @ (ccv @ Xa) @ cc2 @ ccexp) = cc1) @ cc1 @ ccc0) @ (cco @ (ccif @ ((cwbr @ (ccv @ Xn) @ ccc0 @ cclt) & (cwbr @ (ccv @ Xa) @ ccc0 @ cclt)) @ (ccneg @ cc1) @ cc1) @ (ccfv @ (ccfv @ (ccv @ Xn) @ ccabs) @ (ccseq @ ccmul @ (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccif @ (cwcel @ (ccv @ Xm) @ ccprime) @ (cco @ (ccif @ ((ccv @ Xm) = cc2) @ (ccif @ (cwbr @ cc2 @ (ccv @ Xa) @ ccdvds) @ ccc0 @ (ccif @ (cwcel @ (cco @ (ccv @ Xa) @ cc8 @ ccmo) @ (ccpr @ cc1 @ cc7)) @ cc1 @ (ccneg @ cc1))) @ (cco @ (cco @ (cco @ (cco @ (ccv @ Xa) @ (cco @ (cco @ (ccv @ Xm) @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ cc1 @ ccaddc) @ (ccv @ Xm) @ ccmo) @ cc1 @ ccmin)) @ (cco @ (ccv @ Xm) @ (ccv @ Xn) @ ccpc) @ ccexp) @ cc1))) @ cc1)) @ ccmul))))))).
