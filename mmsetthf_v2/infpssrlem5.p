...
thf(ainfpssrlem4_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwss @ XB2 @ XA2)) => ((Xph => (cwf1o @ XB2 @ XA2 @ XF)) => ((Xph => (cwcel @ XC @ (ccdif @ XA2 @ XB2))) => ((XG = (ccres @ (ccrdg @ (cccnv @ XF) @ XC) @ ccom)) => ((cw3a @ Xph @ (cwcel @ XM @ ccom) @ (cwcel @ XN @ XM)) => (cwne @ (ccfv @ XM @ XG) @ (ccfv @ XN @ XG)))))))))))))))).
