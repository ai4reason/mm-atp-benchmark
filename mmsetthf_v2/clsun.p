...
thf(antrdif_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XA2 @ XX)) => ((ccfv @ (ccdif @ XX @ XA2) @ (ccfv @ XJ @ ccnt)) = (ccdif @ XX @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)))))))))).
...
thf(cclsun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XA2 @ XX) @ (cwss @ XB2 @ XX)) => ((ccfv @ (ccun @ XA2 @ XB2) @ (ccfv @ XJ @ cccl)) = (ccun @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (ccfv @ XB2 @ (ccfv @ XJ @ cccl))))))))))).
