...
thf(avdgfrgrgt2_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ ccfrgr) & (cwcel @ XN @ XV)) => ((cwbr @ cc1 @ (ccfv @ XV @ cchash) @ cclt) => (cwbr @ cc2 @ (ccfv @ XN @ (ccfv @ XG @ ccvtxdg)) @ ccle)))))))).
...
thf(cfrgrwopreglem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : ((XD @ Xx3) = (ccfv @ XG @ ccvtxdg))) => ((XA2 = (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (XD @ Xx3)) = XK)) @ (^ [Xx3:$i] : XV))) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccdif @ XV @ XA2))) => ((cw3a @ (cwcel @ XG @ ccfrgr) @ (cwbr @ cc1 @ (ccfv @ XV @ cchash) @ cclt) @ (cwne @ XA2 @ cc0)) => (cwbr @ cc2 @ XK @ ccle))))))))))))).
