...
thf(clsmsp2_conj,conjecture,(! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwss @ XT @ XV) @ (cwss @ XU @ XV)) => ((cco @ (ccfv @ XT @ XN) @ (ccfv @ XU @ XN) @ Xc_po) = (ccfv @ (ccun @ XT @ XU) @ XN))))))))))))).
