...
thf(aaddgtge0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwbr @ ccc0 @ XA2 @ cclt) & (cwbr @ ccc0 @ XB2 @ ccle))) => (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccaddc) @ cclt))))).
...
thf(crecp1lt1_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle)) => (cwbr @ (cco @ XA2 @ (cco @ cc1 @ XA2 @ ccaddc) @ ccdiv) @ cc1 @ cclt)))).
