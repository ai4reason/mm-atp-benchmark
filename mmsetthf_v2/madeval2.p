...
thf(amadeval_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((ccfv @ XA2 @ ccmade) = (ccima @ ccscut @ (ccxp @ (ccpw @ (ccuni @ (ccima @ ccmade @ XA2))) @ (ccpw @ (ccuni @ (ccima @ ccmade @ XA2))))))))).
...
thf(aimaindm_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((ccima @ XR @ XA2) = (ccima @ XR @ (ccin @ XA2 @ (ccdm @ XR))))))).
...
thf(ascutf_ax,axiom,(cwf @ ccsslt @ ccsur @ ccscut)).
...
thf(cmadeval2_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((ccfv @ XA2 @ ccmade) = (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : ((cwbr @ (ccv @ Xa) @ (ccv @ Xb) @ ccsslt) & ((cco @ (ccv @ Xa) @ (ccv @ Xb) @ ccscut) = (ccv @ Xx3)))) @ (^ [Xb:$i] : (ccpw @ (ccuni @ (ccima @ ccmade @ XA2)))))) @ (^ [Xa:$i] : (ccpw @ (ccuni @ (ccima @ ccmade @ XA2)))))) @ (^ [Xx3:$i] : ccsur)))))).
