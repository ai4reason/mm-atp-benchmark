...
thf(cstoweidlem9_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xt:$i] : (! [Xg1:$i] : ((Xph @ Xt @ Xg1) => (XT = cc0)))) => ((! [Xt:$i] : (! [Xg1:$i] : ((Xph @ Xt @ Xg1) => (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : cc1)) @ (XA2 @ Xt))))) => (! [Xt:$i] : (! [Xg1:$i] : ((Xph @ Xt @ Xg1) => (cwrex @ (^ [Xg1:$i] : (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xt) @ (XF @ Xt)) @ ccmin) @ ccabs) @ (XE @ Xt) @ cclt)) @ (^ [Xt:$i] : XT))) @ (^ [Xg1:$i] : (XA2 @ Xt)))))))))))))).
