...
thf(cupgr3v3e3cycl_conj,conjecture,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (XE = (ccfv @ (XG @ Xa @ Xb @ Xc) @ ccedg))))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (XV = (ccfv @ (XG @ Xa @ Xb @ Xc) @ ccvtx))))) => (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((cw3a @ (cwcel @ (XG @ Xa @ Xb @ Xc) @ ccupgr) @ (cwbr @ (XF @ Xa @ Xb @ Xc) @ XP @ (ccfv @ (XG @ Xa @ Xb @ Xc) @ cccycls)) @ ((ccfv @ (XF @ Xa @ Xb @ Xc) @ cchash) = cc3)) => (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : ((cw3a @ (cwcel @ (ccpr @ (ccv @ Xa) @ (ccv @ Xb)) @ XE) @ (cwcel @ (ccpr @ (ccv @ Xb) @ (ccv @ Xc)) @ XE) @ (cwcel @ (ccpr @ (ccv @ Xc) @ (ccv @ Xa)) @ XE)) & (cw3a @ (cwne @ (ccv @ Xa) @ (ccv @ Xb)) @ (cwne @ (ccv @ Xb) @ (ccv @ Xc)) @ (cwne @ (ccv @ Xc) @ (ccv @ Xa))))) @ (^ [Xc:$i] : XV))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV)))))))))))))).
