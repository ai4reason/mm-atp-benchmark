...
thf(auhgredgiedgb_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : ((! [Xx3:$i] : (XI = (ccfv @ (XG @ Xx3) @ cciedg))) => (! [Xx3:$i] : ((cwcel @ (XG @ Xx3) @ ccuhgr) => ((cwcel @ XE @ (ccfv @ (XG @ Xx3) @ ccedg)) <=> (cwrex @ (^ [Xx3:$i] : (XE = (ccfv @ (ccv @ Xx3) @ XI))) @ (^ [Xx3:$i] : (ccdm @ XI))))))))))).
...
thf(auhgr3cyclexlem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((XI = (ccfv @ XG @ cciedg)) => (((((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) & (cwne @ XA2 @ XB2)) & (((cwcel @ XJ @ (ccdm @ XI)) & ((ccpr @ XB2 @ XC) = (ccfv @ XJ @ XI))) & ((cwcel @ XK @ (ccdm @ XI)) & ((ccpr @ XC @ XA2) = (ccfv @ XK @ XI))))) => (cwne @ XJ @ XK))))))))))))))).
