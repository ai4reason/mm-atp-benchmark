...
thf(asdomsdomcardi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ (ccfv @ XB2 @ cccrd) @ ccsdm) => (cwbr @ XA2 @ XB2 @ ccsdm))))).
thf(csdomsdomcard_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccsdm) <=> (cwbr @ XA2 @ (ccfv @ XB2 @ cccrd) @ ccsdm))))).
