...
thf(aswrd00_ax,axiom,(! [XS:($i > $o)] : (! [XX:($i > $o)] : ((cco @ XS @ (ccop @ XX @ XX) @ ccsubstr) = cc0)))).
...
thf(aleaddle0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ (cco @ XA2 @ XB2 @ ccaddc) @ XA2 @ ccle) <=> (cwbr @ XB2 @ ccc0 @ ccle)))))).
thf(apm2_24_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((~ Xph) => Xps))))).
thf(cswrdccat3blem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XL = (ccfv @ XA2 @ cchash)) => (((((cwcel @ XA2 @ (ccword @ XV)) & (cwcel @ XB2 @ (ccword @ XV))) & (cwcel @ XM @ (cco @ ccc0 @ (cco @ XL @ (ccfv @ XB2 @ cchash) @ ccaddc) @ ccfz))) & (cwbr @ (cco @ XL @ (ccfv @ XB2 @ cchash) @ ccaddc) @ XL @ ccle)) => ((ccif @ (cwbr @ XL @ XM @ ccle) @ (cco @ XB2 @ (ccop @ (cco @ XM @ XL @ ccmin) @ (ccfv @ XB2 @ cchash)) @ ccsubstr) @ (cco @ (cco @ XA2 @ (ccop @ XM @ XL) @ ccsubstr) @ XB2 @ ccconcat)) = (cco @ XA2 @ (ccop @ XM @ (cco @ XL @ (ccfv @ XB2 @ cchash) @ ccaddc)) @ ccsubstr)))))))))).
