...
thf(awwlksnredwwlkn0_ax,axiom,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XN @ ccn0) & (cwcel @ XW @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XG @ ccwwlksn))) => (((ccfv @ ccc0 @ XW) = XP) <=> (cwrex @ (^ [Xy1:$i] : (cw3a @ ((cco @ XW @ (ccop @ ccc0 @ (cco @ XN @ cc1 @ ccaddc)) @ ccsubstr) = (ccv @ Xy1)) @ ((ccfv @ ccc0 @ (ccv @ Xy1)) = XP) @ (cwcel @ (ccpr @ (ccfv @ (ccv @ Xy1) @ cclsw) @ (ccfv @ XW @ cclsw)) @ XE))) @ (^ [Xy1:$i] : (cco @ XN @ XG @ ccwwlksn)))))))))))).
...
thf(arusgrnumwwlkslem_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XY @ (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = XP)) @ (^ [Xw:$i] : XZ))) => ((ccrab @ (^ [Xw:$i] : ((Xph @ Xw) & (Xps @ Xw))) @ (^ [Xw:$i] : (XX @ Xw))) = (ccrab @ (^ [Xw:$i] : (cw3a @ (Xph @ Xw) @ ((ccfv @ ccc0 @ XY) = XP) @ (Xps @ Xw))) @ (^ [Xw:$i] : (XX @ Xw)))))))))))).
...
thf(ahashle00_ax,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XV @ XW) => ((cwbr @ (ccfv @ XV @ cchash) @ ccc0 @ ccle) <=> (XV = cc0)))))).
