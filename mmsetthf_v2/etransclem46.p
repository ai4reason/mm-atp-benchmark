...
thf(aitgeq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => ((XB2 @ Xx3) = (XC @ Xx3)))) => (Xph => ((ccitg @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (ccitg @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3))))))))))).
...
thf(aetransclem33_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwcel @ XX @ (cco @ (ccfv @ cccnfld @ cctopn) @ XS @ ccrest))) => ((Xph => (cwcel @ XP @ ccn)) => ((Xph => (cwcel @ XM @ ccn0)) => ((! [Xx3:$i] : (! [Xj:$i] : ((XF @ Xx3 @ Xj) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ XP @ ccexp))) @ ccmul)))))) => ((Xph => (cwcel @ XN @ ccn0)) => (! [Xx3:$i] : (! [Xj:$i] : (Xph => (cwf @ XX @ ccc @ (ccfv @ XN @ (cco @ XS @ (XF @ Xx3 @ Xj) @ ccdvn)))))))))))))))))))).
...
thf(aetransclem8_ax,axiom,(! [Xph:$o] : (! [XP:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwss @ XX @ ccc)) => ((! [Xx3:$i] : (! [Xj:$i] : (Xph => (cwcel @ (XP @ Xx3 @ Xj) @ ccn)))) => ((! [Xx3:$i] : (! [Xj:$i] : ((XF @ Xx3 @ Xj) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ (XP @ Xx3 @ Xj) @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ (XM @ Xx3) @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ (XP @ Xx3 @ Xj) @ ccexp))) @ ccmul)))))) => (! [Xx3:$i] : (! [Xj:$i] : (Xph => (cwf @ XX @ ccc @ (XF @ Xx3 @ Xj)))))))))))))).
...
thf(arecxpcld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => (cwcel @ (cco @ XA2 @ XB2 @ cccxp) @ ccr))))))))).
...
thf(aepos_ax,axiom,(cwbr @ ccc0 @ cceu @ cclt)).
...
thf(advcxp2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => ((cco @ ccc @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ cccxp))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccfv @ XA2 @ cclog) @ (cco @ XA2 @ (ccv @ Xx3) @ cccxp) @ ccmul))))))).
...
thf(aetransclem39_ax,axiom,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > $o))] : ((! [Xi:$i] : (Xph => (cwcel @ (XP @ Xi) @ ccn))) => ((! [Xi:$i] : (Xph => (cwcel @ (XM @ Xi) @ ccn0))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : ((XF @ Xx3 @ Xi @ Xj) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ (XP @ Xi) @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ (XM @ Xi) @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ (XP @ Xi) @ ccexp))) @ ccmul))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : ((XG @ Xx3 @ Xi @ Xj) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccsu @ (cco @ ccc0 @ XR @ ccfz) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xi) @ (cco @ ccr @ (XF @ Xx3 @ Xi @ Xj) @ ccdvn))))))))))) => (! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (Xph => (cwf @ ccr @ ccc @ (XG @ Xx3 @ Xi @ Xj))))))))))))))))).
thf(cwnfc_tp,type,(cwnfc : (($i > ($i > $o)) > $o))).
thf(aetransclem2_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((! [Xx3:$i] : (Xph => (cwf @ ccr @ ccc @ (XF @ Xx3)))) => ((! [Xx3:$i] : (! [Xi:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ (cco @ ccc0 @ (cco @ XR @ cc1 @ ccaddc) @ ccfz))) => (cwf @ ccr @ ccc @ (ccfv @ (ccv @ Xi) @ (cco @ ccr @ (XF @ Xx3) @ ccdvn)))))) => ((! [Xx3:$i] : (! [Xi:$i] : ((XG @ Xx3 @ Xi) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccsu @ (cco @ ccc0 @ XR @ ccfz) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xi) @ (cco @ ccr @ (XF @ Xx3) @ ccdvn)))))))))) => (! [Xx3:$i] : (! [Xi:$i] : (Xph => ((cco @ ccr @ (XG @ Xx3 @ Xi) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccsu @ (cco @ ccc0 @ XR @ ccfz) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (cco @ ccr @ (XF @ Xx3) @ ccdvn)))))))))))))))))))).
...
thf(aetransclem32_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwcel @ XX @ (cco @ (ccfv @ cccnfld @ cctopn) @ XS @ ccrest))) => ((Xph => (cwcel @ XP @ ccn)) => ((Xph => (cwcel @ XM @ ccn0)) => ((! [Xx3:$i] : (! [Xj:$i] : ((XF @ Xx3 @ Xj) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ XP @ ccexp))) @ ccmul)))))) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwbr @ (cco @ (cco @ XM @ XP @ ccmul) @ (cco @ XP @ cc1 @ ccmin) @ ccaddc) @ XN @ cclt)) => ((XH = (ccmpt @ (^ [Xj:$i] : (cco @ ccc0 @ XM @ ccfz)) @ (^ [Xj:$i] : (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ (ccif @ ((ccv @ Xj) = ccc0) @ (cco @ XP @ cc1 @ ccmin) @ XP) @ ccexp)))))) => (! [Xx3:$i] : (! [Xj:$i] : (Xph => ((ccfv @ XN @ (cco @ XS @ (XF @ Xx3 @ Xj) @ ccdvn)) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : ccc0))))))))))))))))))))))).
...
thf(advn0_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (((cwss @ XS @ ccc) & (cwcel @ XF @ (cco @ ccc @ XS @ ccpm))) => ((ccfv @ ccc0 @ (cco @ XS @ XF @ ccdvn)) = XF))))).
...
thf(agtnelioc_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccxr)) => ((Xph => (cwbr @ XB2 @ XC @ cclt)) => (Xph => (~ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioc))))))))))))).
...
thf(acxpcncf2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ cccxp))) @ (cco @ ccc @ ccc @ cccncf))))).
thf(anegcncf_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccneg @ (ccv @ Xx3)))))) => (! [Xx3:$i] : ((cwss @ XA2 @ ccc) => (cwcel @ (XF @ Xx3) @ (cco @ XA2 @ ccc @ cccncf)))))))).
thf(aetransclem13_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwss @ XX @ ccc)) => ((Xph => (cwcel @ XP @ ccn)) => ((Xph => (cwcel @ XM @ ccn0)) => ((! [Xx3:$i] : (! [Xj:$i] : ((XF @ Xx3 @ Xj) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ XP @ ccexp))) @ ccmul)))))) => ((Xph => (cwcel @ XY @ XX)) => (! [Xx3:$i] : (! [Xj:$i] : (Xph => ((ccfv @ XY @ (XF @ Xx3 @ Xj)) = (ccprod @ (^ [Xj:$i] : (cco @ ccc0 @ XM @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ XY @ (ccv @ Xj) @ ccmin) @ (ccif @ ((ccv @ Xj) = ccc0) @ (cco @ XP @ cc1 @ ccmin) @ XP) @ ccexp))))))))))))))))))).
thf(aad2antrr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => (((Xph & Xch) & Xth) => Xps))))))).
thf(aetransclem6_ax,axiom,(! [XP:($i > $o)] : (! [XM:($i > $o)] : ((ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ XP @ ccexp))) @ ccmul))) = (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (cco @ (cco @ (ccv @ Xy1) @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xk:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xy1) @ (ccv @ Xk) @ ccmin) @ XP @ ccexp))) @ ccmul))))))).
thf(afprodcncf_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccfn)) => ((! [Xx3:$i] : (! [Xk:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2) @ (cwcel @ (ccv @ Xk) @ XB2)) => (cwcel @ (XC @ Xx3 @ Xk) @ ccc)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XB2)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xk))) @ (cco @ XA2 @ ccc @ cccncf)))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccprod @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (XC @ Xx3 @ Xk))))) @ (cco @ XA2 @ ccc @ cccncf)))))))))))).
...
thf(aetransclem18_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : ((Xph => (cwcel @ ccr @ (ccpr @ ccr @ ccc))) => ((Xph => (cwcel @ ccr @ (cco @ (ccfv @ cccnfld @ cctopn) @ ccr @ ccrest))) => ((Xph => (cwcel @ XP @ ccn)) => ((Xph => (cwcel @ XM @ ccn0)) => ((! [Xx3:$i] : (! [Xj:$i] : ((XF @ Xx3 @ Xj) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ XP @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ XP @ ccexp))) @ ccmul)))))) => ((! [Xj:$i] : (Xph => (cwcel @ (XA2 @ Xj) @ ccr))) => ((! [Xj:$i] : (Xph => (cwcel @ (XB2 @ Xj) @ ccr))) => (! [Xj:$i] : (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ (XA2 @ Xj) @ (XB2 @ Xj) @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ cceu @ (ccneg @ (ccv @ Xx3)) @ cccxp) @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3 @ Xj)) @ ccmul))) @ ccibl))))))))))))))))).
...
thf(aetransclem43_ax,axiom,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xi:$i] : (Xph => (cwcel @ (XS @ Xi) @ (ccpr @ ccr @ ccc)))) => ((! [Xi:$i] : (Xph => (cwcel @ XX @ (cco @ (ccfv @ cccnfld @ cctopn) @ (XS @ Xi) @ ccrest)))) => ((! [Xi:$i] : (Xph => (cwcel @ (XP @ Xi) @ ccn))) => ((! [Xi:$i] : (Xph => (cwcel @ (XM @ Xi) @ ccn0))) => ((! [Xi:$i] : (! [Xj:$i] : ((XF @ Xi @ Xj) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ (XP @ Xi) @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ (XM @ Xi) @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ (XP @ Xi) @ ccexp))) @ ccmul)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : ((XG @ Xx3 @ Xi @ Xj) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccsu @ (cco @ ccc0 @ XR @ ccfz) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xi) @ (cco @ (XS @ Xi) @ (XF @ Xi @ Xj) @ ccdvn))))))))))) => (! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (Xph => (cwcel @ (XG @ Xx3 @ Xi @ Xj) @ (cco @ XX @ ccc @ cccncf))))))))))))))))))))).
...
thf(aubicc2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwbr @ XA2 @ XB2 @ ccle)) => (cwcel @ XB2 @ (cco @ XA2 @ XB2 @ ccicc)))))).
...
thf(acxp0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ XA2 @ ccc0 @ cccxp) = cc1)))).
...
thf(acoef2_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ ccc0 @ XS)) => (cwf @ ccn0 @ XS @ XA2))))))).
thf(a_3eqtr3rd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XA2 = XC)) => ((Xph => (XB2 = XD)) => (Xph => (XD = XC))))))))))).
thf(asylancl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => (Xch => (((Xps & Xch) => Xth) => (Xph => Xth))))))))).
thf(acoeid2_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XN = (ccfv @ XF @ ccdgr)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XX @ ccc)) => ((ccfv @ XX @ XF) = (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ XX @ (ccv @ Xk) @ ccexp) @ ccmul))))))))))))).
thf(acxpexp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccn0)) => ((cco @ XA2 @ XB2 @ cccxp) = (cco @ XA2 @ XB2 @ ccexp)))))).
...
thf(acxpaddd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwne @ XA2 @ ccc0)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => (Xph => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ cccxp) = (cco @ (cco @ XA2 @ XB2 @ cccxp) @ (cco @ XA2 @ XC @ cccxp) @ ccmul)))))))))))).
...
thf(afsumxp_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > $o))] : ((! [Xz:$i] : (! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xz) = (ccop @ (ccv @ Xj) @ (ccv @ Xk))) => ((XD @ Xz) = (XC @ Xj @ Xk)))))) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwcel @ XB2 @ ccfn)) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph & ((cwcel @ (ccv @ Xj) @ XA2) & (cwcel @ (ccv @ Xk) @ XB2))) => (cwcel @ (XC @ Xj @ Xk) @ ccc)))) => (Xph => ((ccsu @ XA2 @ (^ [Xj:$i] : (ccsu @ XB2 @ (^ [Xk:$i] : (XC @ Xj @ Xk))))) = (ccsu @ (ccxp @ XA2 @ XB2) @ (^ [Xz:$i] : (XD @ Xz))))))))))))))).
...
thf(cetransclem46_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XM:($i > $o)] : (! [XO:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xi:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XQ @ Xx3 @ Xi @ Xk) @ (ccdif @ (ccfv @ ccz @ ccply) @ (ccsn @ cc0p))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xk:$i] : (Xph => ((ccfv @ cceu @ (XQ @ Xx3 @ Xi @ Xk)) = ccc0))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xk:$i] : ((XA2 @ Xx3) = (ccfv @ (XQ @ Xx3 @ Xi @ Xk) @ cccoe))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xk:$i] : (XM = (ccfv @ (XQ @ Xx3 @ Xi @ Xk) @ ccdgr))))) => ((Xph => (cwss @ ccr @ ccr)) => ((Xph => (cwcel @ ccr @ (ccpr @ ccr @ ccc))) => ((Xph => (cwcel @ ccr @ (cco @ (ccfv @ cccnfld @ cctopn) @ ccr @ ccrest))) => ((! [Xi:$i] : (Xph => (cwcel @ (XP @ Xi) @ ccn))) => ((! [Xi:$i] : (XF = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (cco @ (XP @ Xi) @ cc1 @ ccmin) @ ccexp) @ (ccprod @ (^ [Xj:$i] : (cco @ cc1 @ XM @ ccfz)) @ (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ (XP @ Xi) @ ccexp))) @ ccmul))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XL @ Xx3 @ Xi @ Xj @ Xk) = (ccsu @ (cco @ ccc0 @ XM @ ccfz) @ (^ [Xj:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xj) @ (XA2 @ Xx3)) @ (cco @ cceu @ (ccv @ Xj) @ cccxp) @ ccmul) @ (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccv @ Xj) @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ cceu @ (ccneg @ (ccv @ Xx3)) @ cccxp) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccmul))) @ ccmul)))))))) => ((! [Xi:$i] : (XR = (cco @ (cco @ XM @ (XP @ Xi) @ ccmul) @ (cco @ (XP @ Xi) @ cc1 @ ccmin) @ ccaddc))) => ((! [Xi:$i] : (! [Xk:$i] : ((XG @ Xi @ Xk) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccsu @ (cco @ ccc0 @ XR @ ccfz) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xi) @ (cco @ ccr @ XF @ ccdvn)))))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XO @ Xi @ Xj @ Xk) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccv @ Xj) @ ccicc)) @ (^ [Xx3:$i] : (ccneg @ (cco @ (cco @ cceu @ (ccneg @ (ccv @ Xx3)) @ cccxp) @ (ccfv @ (ccv @ Xx3) @ (XG @ Xi @ Xk)) @ ccmul)))))))) => (! [Xx3:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (Xph => ((cco @ (XL @ Xx3 @ Xi @ Xj @ Xk) @ (ccfv @ (cco @ (XP @ Xi) @ cc1 @ ccmin) @ ccfa) @ ccdiv) = (cco @ (ccneg @ (ccsu @ (ccxp @ (cco @ ccc0 @ XM @ ccfz) @ (cco @ ccc0 @ XR @ ccfz)) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xk) @ cc1st) @ (XA2 @ Xx3)) @ (ccfv @ (ccfv @ (ccv @ Xk) @ cc1st) @ (ccfv @ (ccfv @ (ccv @ Xk) @ cc2nd) @ (cco @ ccr @ XF @ ccdvn))) @ ccmul)))) @ (ccfv @ (cco @ (XP @ Xi) @ cc1 @ ccmin) @ ccfa) @ ccdiv))))))))))))))))))))))))))))))).
