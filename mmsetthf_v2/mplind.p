...
thf(amplbas2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XP = (cco @ XI @ XR @ ccmpl)) => ((XS = (cco @ XI @ XR @ ccmps)) => ((XV = (cco @ XI @ XR @ ccmvr)) => ((XA2 = (ccfv @ XS @ ccasp)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XR @ cccrg)) => (Xph => ((ccfv @ (ccrn @ XV) @ XA2) = (ccfv @ XP @ ccbs)))))))))))))))))).
