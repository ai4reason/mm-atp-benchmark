...
thf(clgsquad_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : ((cw3a @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (cwcel @ XQ @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (cwne @ XP @ XQ)) => ((cco @ (cco @ XP @ XQ @ cclgs) @ (cco @ XQ @ XP @ cclgs) @ ccmul) = (cco @ (ccneg @ cc1) @ (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (cco @ (cco @ XQ @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccmul) @ ccexp)))))).
