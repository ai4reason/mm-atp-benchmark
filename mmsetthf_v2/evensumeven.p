...
thf(aepee_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cceven) & (cwcel @ XB2 @ cceven)) => (cwcel @ (cco @ XA2 @ XB2 @ ccaddc) @ cceven))))).
...
thf(cevensumeven_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ cceven)) => ((cwcel @ XA2 @ cceven) <=> (cwcel @ (cco @ XA2 @ XB2 @ ccaddc) @ cceven)))))).
