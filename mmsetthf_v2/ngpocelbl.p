...
thf(angpmet_ax,axiom,(! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XD = (ccres @ (ccfv @ XG @ ccds) @ (ccxp @ XX @ XX))) => ((cwcel @ XG @ ccngp) => (cwcel @ XD @ (ccfv @ XX @ ccme))))))))).
...
thf(cngpocelbl_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XN = (ccfv @ XG @ ccnm)) => ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((XD = (ccres @ (ccfv @ XG @ ccds) @ (ccxp @ XX @ XX))) => ((cw3a @ (cwcel @ XG @ ccnlm) @ (cwcel @ XR @ ccxr) @ ((cwcel @ XP @ XX) & (cwcel @ XA2 @ XX))) => ((cwcel @ (cco @ XP @ XA2 @ Xc_pl) @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl))) <=> (cwbr @ (ccfv @ XA2 @ XN) @ XR @ cclt)))))))))))))))).
