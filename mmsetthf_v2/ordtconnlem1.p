...
thf(anconnsubb_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwss @ XA2 @ XX)) => ((Xph => (cwcel @ XU @ XJ)) => ((Xph => (cwcel @ XV @ XJ)) => ((Xph => (cwne @ (ccin @ XU @ XA2) @ cc0)) => ((Xph => (cwne @ (ccin @ XV @ XA2) @ cc0)) => ((Xph => ((ccin @ (ccin @ XU @ XV) @ XA2) = cc0)) => ((Xph => (cwss @ XA2 @ (ccun @ XU @ XV))) => (Xph => (~ (cwcel @ (cco @ XJ @ XA2 @ ccrest) @ ccconn)))))))))))))))))).
...
thf(atrleile_ax,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2))) => ((cw3a @ (cwcel @ XK @ cctos) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => ((cwbr @ XX @ XY @ Xc_le) | (cwbr @ XY @ XX @ Xc_le))))))))))).
thf(aoran_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph | Xps) <=> (~ ((~ Xph) & (~ Xps))))))).
...
thf(aposrasymb_ax,axiom,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2))) => ((cw3a @ (cwcel @ XK @ ccpo) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => (((cwbr @ XX @ XY @ Xc_le) & (cwbr @ XY @ XX @ Xc_le)) <=> (XX = XY))))))))))).
...
thf(cordtconnlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : ((XB2 = (ccfv @ XK @ ccbs)) => ((! [Xr:$i] : ((Xc_le @ Xr) = (ccin @ (ccfv @ XK @ ccple) @ (ccxp @ XB2 @ XB2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xr:$i] : ((XJ @ Xx3 @ Xy1) = (ccfv @ (Xc_le @ Xr) @ ccordt))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XK @ cctos) & (cwss @ XA2 @ XB2)) => ((cwcel @ (cco @ (XJ @ Xx3 @ Xy1) @ XA2 @ ccrest) @ ccconn) => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xr:$i] : (((cwbr @ (ccv @ Xx3) @ (ccv @ Xr) @ (Xc_le @ Xr)) & (cwbr @ (ccv @ Xr) @ (ccv @ Xy1) @ (Xc_le @ Xr))) => (cwcel @ (ccv @ Xr) @ XA2))) @ (^ [Xr:$i] : XB2))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))))))))))))))).
