...
thf(acshf1_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cw3a @ (cwf1 @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ XA2 @ XF) @ (cwcel @ XS @ ccz) @ (XG = (cco @ XF @ XS @ cccsh))) => (cwf1 @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ XA2 @ XG))))))).
thf(asimprbi_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph <=> (Xps & Xch)) => (Xph => Xch)))))).
thf(ccshinj_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cw3a @ (cwcel @ XF @ (ccword @ XA2)) @ (cwfun @ (cccnv @ XF)) @ (cwcel @ XS @ ccz)) => ((XG = (cco @ XF @ XS @ cccsh)) => (cwfun @ (cccnv @ XG))))))))).
