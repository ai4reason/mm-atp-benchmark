...
thf(aalexsubALTlem1_ax,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ cccmp) => (? [Xx3:$i] : ((XJ = (ccfv @ (ccfv @ (ccv @ Xx3) @ ccfi) @ cctg)) & (cwral @ (^ [Xc:$i] : ((XX = (ccuni @ (ccv @ Xc))) => (cwrex @ (^ [Xd:$i] : (XX = (ccuni @ (ccv @ Xd)))) @ (^ [Xd:$i] : (ccin @ (ccpw @ (ccv @ Xc)) @ ccfn))))) @ (^ [Xc:$i] : (ccpw @ (ccv @ Xx3))))))))))).
...
thf(aalexsubALTlem4_ax,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (! [Xx3:$i] : ((XJ = (ccfv @ (ccfv @ (ccv @ Xx3) @ ccfi) @ cctg)) => ((cwral @ (^ [Xc:$i] : ((XX = (ccuni @ (ccv @ Xc))) => (cwrex @ (^ [Xd:$i] : (XX = (ccuni @ (ccv @ Xd)))) @ (^ [Xd:$i] : (ccin @ (ccpw @ (ccv @ Xc)) @ ccfn))))) @ (^ [Xc:$i] : (ccpw @ (ccv @ Xx3)))) => (cwral @ (^ [Xa:$i] : ((XX = (ccuni @ (ccv @ Xa))) => (cwrex @ (^ [Xb:$i] : (XX = (ccuni @ (ccv @ Xb)))) @ (^ [Xb:$i] : (ccin @ (ccpw @ (ccv @ Xa)) @ ccfn))))) @ (^ [Xa:$i] : (ccpw @ (ccfv @ (ccv @ Xx3) @ ccfi))))))))))).
...
thf(calexsubALT_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ cccmp) <=> (? [Xx3:$i] : ((XJ = (ccfv @ (ccfv @ (ccv @ Xx3) @ ccfi) @ cctg)) & (cwral @ (^ [Xc:$i] : ((XX = (ccuni @ (ccv @ Xc))) => (cwrex @ (^ [Xd:$i] : (XX = (ccuni @ (ccv @ Xd)))) @ (^ [Xd:$i] : (ccin @ (ccpw @ (ccv @ Xc)) @ ccfn))))) @ (^ [Xc:$i] : (ccpw @ (ccv @ Xx3))))))))))).
