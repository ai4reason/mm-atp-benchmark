...
thf(cpwsbas_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XR @ XI @ ccpws)) => ((XB2 = (ccfv @ XR @ ccbs)) => (((cwcel @ XR @ XV) & (cwcel @ XI @ XW)) => ((cco @ XB2 @ XI @ ccmap) = (ccfv @ XY @ ccbs)))))))))))).
