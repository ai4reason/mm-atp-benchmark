...
thf(cexpcllem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((cwss @ XF @ ccc) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XF) & (cwcel @ (ccv @ Xy1) @ XF)) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmul) @ XF)))) => ((cwcel @ cc1 @ XF) => (! [Xy1:$i] : (((cwcel @ XA2 @ XF) & (cwcel @ (XB2 @ Xy1) @ ccn0)) => (cwcel @ (cco @ XA2 @ (XB2 @ Xy1) @ ccexp) @ XF)))))))))).
