...
thf(acnextfun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XC = (ccuni @ XJ)) => ((XB2 = (ccuni @ XK)) => ((((cwcel @ XJ @ cctop) & (cwcel @ XK @ ccha)) & ((cwf @ XA2 @ XB2 @ XF) & (cwss @ XA2 @ XC))) => (cwfun @ (ccfv @ XF @ (cco @ XJ @ XK @ cccnext))))))))))))).
...
thf(adfdm3_ax,axiom,(! [XA2:($i > $o)] : ((ccdm @ XA2) = (ccab @ (^ [Xx3:$i] : (? [Xy1:$i] : (cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XA2))))))).
...
thf(arniun_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((ccrn @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) = (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (ccrn @ (XB2 @ Xx3)))))))).
...
thf(aflfelbas_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) & (cwcel @ XA2 @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf)))) => (cwcel @ XA2 @ XX))))))))).
...
thf(ccnextf_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XC = (ccuni @ XJ)) => ((XB2 = (ccuni @ XK)) => ((Xph => (cwcel @ XJ @ cctop)) => ((Xph => (cwcel @ XK @ ccha)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwss @ XA2 @ XC)) => ((Xph => ((ccfv @ XA2 @ (ccfv @ XJ @ cccl)) = XC)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XC)) => (cwne @ (ccfv @ XF @ (cco @ XK @ (cco @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest) @ ccflf)) @ cc0))) => (Xph => (cwf @ XC @ XB2 @ (ccfv @ XF @ (cco @ XJ @ XK @ cccnext)))))))))))))))))))).
