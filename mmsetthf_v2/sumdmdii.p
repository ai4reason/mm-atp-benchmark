...
thf(achslej_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => (cwss @ (cco @ XA2 @ XB2 @ ccph) @ (cco @ XA2 @ XB2 @ cchj)))))).
...
thf(csumdmdii_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (((cco @ XA2 @ XB2 @ ccph) = (cco @ XA2 @ XB2 @ cchj)) => (cwbr @ XA2 @ XB2 @ ccdmd))))))).
