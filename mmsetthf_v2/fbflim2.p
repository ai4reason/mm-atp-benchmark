...
thf(afbflim_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XF = (cco @ XX @ XB2 @ ccfg)) => (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XB2 @ (ccfv @ XX @ ccfbas))) => ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim)) <=> ((cwcel @ XA2 @ XX) & (cwral @ (^ [Xx3:$i] : ((cwcel @ XA2 @ (ccv @ Xx3)) => (cwrex @ (^ [Xy1:$i] : (cwss @ (ccv @ Xy1) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : XB2)))) @ (^ [Xx3:$i] : XJ)))))))))))).
