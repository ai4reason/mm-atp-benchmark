...
thf(agrplmulf1o_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ XX @ (ccv @ Xx3) @ Xc_pl))))) => (! [Xx3:$i] : (((cwcel @ XG @ ccgrp) & (cwcel @ XX @ XB2)) => (cwf1o @ XB2 @ XB2 @ (XF @ Xx3))))))))))))).
...
thf(af1ssres_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwf1 @ XA2 @ XB2 @ XF) & (cwss @ XC @ XA2)) => (cwf1 @ XC @ XB2 @ (ccres @ XF @ XC)))))))).
