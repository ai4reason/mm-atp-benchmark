...
thf(cist0_3_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XX @ cctopon)) => ((cwcel @ XJ @ cct0) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) => (cwrex @ (^ [Xo:$i] : (((cwcel @ (ccv @ Xx3) @ (ccv @ Xo)) & (~ (cwcel @ (ccv @ Xy1) @ (ccv @ Xo)))) | ((~ (cwcel @ (ccv @ Xx3) @ (ccv @ Xo))) & (cwcel @ (ccv @ Xy1) @ (ccv @ Xo))))) @ (^ [Xo:$i] : XJ)))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))))))).
