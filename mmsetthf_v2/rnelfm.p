...
thf(afmf_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XB2) @ (cwf @ XY @ XX @ XF)) => (cwf @ (ccfv @ XY @ ccfbas) @ (ccfv @ XX @ ccfil) @ (cco @ XX @ XF @ ccfm))))))))).
...
thf(crnelfm_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XY @ XA2) @ (cwcel @ XL @ (ccfv @ XX @ ccfil)) @ (cwf @ XY @ XX @ XF)) => ((cwcel @ XL @ (ccrn @ (cco @ XX @ XF @ ccfm))) <=> (cwcel @ (ccrn @ XF) @ XL))))))))).
