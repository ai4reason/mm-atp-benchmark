...
thf(aissmo_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwf @ (XB2 @ Xx3 @ Xy1) @ ccon0 @ XA2))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cword @ (XB2 @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (XB2 @ Xx3 @ Xy1)) & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3 @ Xy1))) => ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XA2) @ (ccfv @ (ccv @ Xy1) @ XA2)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((ccdm @ XA2) = (XB2 @ Xx3 @ Xy1)))) => (cwsmo @ XA2)))))))).
...
thf(acardf2_ax,axiom,(cwf @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccen)) @ (^ [Xy1:$i] : ccon0)))) @ ccon0 @ cccrd)).
...
thf(adftr5_ax,axiom,(! [XA2:($i > $o)] : ((cwtr @ XA2) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xy1) @ XA2)) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XA2))))).
...
thf(ar1sdom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ XA2)) => (cwbr @ (ccfv @ XB2 @ ccr1) @ (ccfv @ XA2 @ ccr1) @ ccsdm))))).
thf(acardsdom2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwcel @ XB2 @ (ccdm @ cccrd))) => ((cwcel @ (ccfv @ XA2 @ cccrd) @ (ccfv @ XB2 @ cccrd)) <=> (cwbr @ XA2 @ XB2 @ ccsdm)))))).
...
thf(csmobeth_conj,conjecture,(cwsmo @ (cccom @ cccrd @ ccr1))).
