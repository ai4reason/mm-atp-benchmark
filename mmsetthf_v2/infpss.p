...
thf(ainfdifsn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ ccom @ XA2 @ ccdom) => (cwbr @ (ccdif @ XA2 @ (ccsn @ XB2)) @ XA2 @ ccen))))).
...
thf(cinfpss_conj,conjecture,(! [XA2:($i > $o)] : ((cwbr @ ccom @ XA2 @ ccdom) => (? [Xx3:$i] : ((cwpss @ (ccv @ Xx3) @ XA2) & (cwbr @ (ccv @ Xx3) @ XA2 @ ccen)))))).
