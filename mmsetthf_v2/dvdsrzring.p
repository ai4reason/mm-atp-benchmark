...
thf(adf_dvds_ax,axiom,(ccdvds = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ ccz) & (cwcel @ (ccv @ Xy1) @ ccz)) & (cwrex @ (^ [Xn:$i] : ((cco @ (ccv @ Xn) @ (ccv @ Xx3) @ ccmul) = (ccv @ Xy1))) @ (^ [Xn:$i] : ccz)))))))).
...
thf(cdvdsrzring_conj,conjecture,(ccdvds = (ccfv @ czring @ ccdsr))).
