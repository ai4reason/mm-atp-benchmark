...
thf(ashftfib_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccima @ (cco @ XF @ XA2 @ ccshi) @ (ccsn @ XB2)) = (ccima @ XF @ (ccsn @ (cco @ XB2 @ XA2 @ ccmin)))))))))).
thf(cweu_tp,type,(cweu : (($i > $o) > $o))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(adffv3_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((ccfv @ XA2 @ XF) = (ccio @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (ccima @ XF @ (ccsn @ XA2))))))))).
thf(cshftval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccfv @ XB2 @ (cco @ XF @ XA2 @ ccshi)) = (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ XF)))))))).
