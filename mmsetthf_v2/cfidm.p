...
thf(acfsmo_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (? [Xf1:$i] : (cw3a @ (cwf @ (ccfv @ XA2 @ cccf) @ XA2 @ (ccv @ Xf1)) @ (cwsmo @ (ccv @ Xf1)) @ (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xf1)))) @ (^ [Xw:$i] : (ccfv @ XA2 @ cccf)))) @ (^ [Xz:$i] : XA2))))))).
...
thf(acff_ax,axiom,(cwf @ ccon0 @ ccon0 @ cccf)).
thf(cwbr_tp,type,(cwbr : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(cweu_tp,type,(cweu : (($i > $o) > $o))).
thf(andmfv_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((~ (cwcel @ XA2 @ (ccdm @ XF))) => ((ccfv @ XA2 @ XF) = cc0))))).
thf(ccfidm_conj,conjecture,(! [XA2:($i > $o)] : ((ccfv @ (ccfv @ XA2 @ cccf) @ cccf) = (ccfv @ XA2 @ cccf)))).
