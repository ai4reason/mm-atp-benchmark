...
thf(avtxdgfusgr_ax,axiom,(! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xv:$i] : ((XV @ Xv) = (ccfv @ XG @ ccvtx))) => ((cwcel @ XG @ ccfusgr) => (cwral @ (^ [Xv:$i] : (cwcel @ (ccfv @ (ccv @ Xv) @ (ccfv @ XG @ ccvtxdg)) @ ccn0)) @ (^ [Xv:$i] : (XV @ Xv)))))))).
...
thf(cfusgrregdegfi_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xv:$i] : ((XD @ Xv) = (ccfv @ XG @ ccvtxdg))) => (((cwcel @ XG @ ccfusgr) & (cwne @ XV @ cc0)) => ((cwral @ (^ [Xv:$i] : ((ccfv @ (ccv @ Xv) @ (XD @ Xv)) = XK)) @ (^ [Xv:$i] : XV)) => (cwcel @ XK @ ccn0)))))))))).
