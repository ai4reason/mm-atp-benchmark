...
thf(aiedgedg_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XE = (ccfv @ XG @ cciedg)) => (((cwfun @ XE) & (cwcel @ XI @ (ccdm @ XE))) => (cwcel @ (ccfv @ XI @ XE) @ (ccfv @ XG @ ccedg)))))))).
...
thf(a_3elpr2eq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (((cw3a @ (cwcel @ XX @ (ccpr @ XA2 @ XB2)) @ (cwcel @ XY @ (ccpr @ XA2 @ XB2)) @ (cwcel @ XZ @ (ccpr @ XA2 @ XB2))) & ((cwne @ XY @ XX) & (cwne @ XZ @ XX))) => (XY = XZ)))))))).
