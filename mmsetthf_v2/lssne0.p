...
thf(clssne0_conj,conjecture,(! [XS:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xy1:$i] : (Xc_0 = (ccfv @ (XW @ Xy1) @ cc0g))) => ((! [Xy1:$i] : ((XS @ Xy1) = (ccfv @ (XW @ Xy1) @ cclss))) => (! [Xy1:$i] : ((cwcel @ XX @ (XS @ Xy1)) => ((cwne @ XX @ (ccsn @ Xc_0)) <=> (cwrex @ (^ [Xy1:$i] : (cwne @ (ccv @ Xy1) @ Xc_0)) @ (^ [Xy1:$i] : XX)))))))))))).
