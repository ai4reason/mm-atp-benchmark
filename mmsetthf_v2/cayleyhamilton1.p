...
thf(acayleyhamilton_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((! [Xn:$i] : ((Xc_0 @ Xn) = (ccfv @ XA2 @ cc0g))) => ((XC = (cco @ XN @ XR @ ccchpmat)) => ((! [Xn:$i] : ((XK @ Xn) = (ccfv @ (ccfv @ XM @ XC) @ ccco1))) => ((Xc_as = (ccfv @ XA2 @ ccvsca)) => ((Xc_ex = (ccfv @ (ccfv @ XA2 @ ccmgp) @ ccmg)) => (! [Xn:$i] : ((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ cccrg) @ (cwcel @ XM @ XB2)) => ((cco @ XA2 @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ (XK @ Xn)) @ (cco @ (ccv @ Xn) @ XM @ Xc_ex) @ Xc_as))) @ ccgsu) = (Xc_0 @ Xn)))))))))))))))))))))).
