...
thf(alhpexle3_ax,axiom,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => (((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) => (cwrex @ (^ [Xp:$i] : ((cwbr @ (ccv @ Xp) @ XW @ Xc_le) & (cw3a @ (cwne @ (ccv @ Xp) @ XX) @ (cwne @ (ccv @ Xp) @ XY) @ (cwne @ (ccv @ Xp) @ XZ)))) @ (^ [Xp:$i] : XA2))))))))))))))).
