...
thf(alinerflx2_ax,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cw3a @ (cwcel @ XP @ (ccfv @ XN @ ccee)) @ (cwcel @ XQ @ (ccfv @ XN @ ccee)) @ (cwne @ XP @ XQ))) => (cwcel @ XQ @ (cco @ XP @ XQ @ ccline2))))))).
thf(aeleq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwcel @ XC @ XA2) <=> (cwcel @ XC @ XB2))))))).
thf(chilbert1_1_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ (XN @ Xx3) @ ccn) & (cw3a @ (cwcel @ XP @ (ccfv @ (XN @ Xx3) @ ccee)) @ (cwcel @ XQ @ (ccfv @ (XN @ Xx3) @ ccee)) @ (cwne @ XP @ XQ))) => (cwrex @ (^ [Xx3:$i] : ((cwcel @ XP @ (ccv @ Xx3)) & (cwcel @ XQ @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : cclines2)))))))).
