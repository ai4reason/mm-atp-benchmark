...
thf(adfimafn2_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwfun @ XF) & (cwss @ XA2 @ (ccdm @ XF))) => ((ccima @ XF @ XA2) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccsn @ (ccfv @ (ccv @ Xx3) @ XF))))))))).
thf(afnima_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ XA2) => ((ccima @ XF @ XA2) = (ccrn @ XF)))))).
thf(arnco2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccrn @ (cccom @ XA2 @ XB2)) = (ccima @ XA2 @ (ccrn @ XB2)))))).
...
thf(afores_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwfun @ XF) & (cwss @ XA2 @ (ccdm @ XF))) => (cwfo @ XA2 @ (ccima @ XF @ XA2) @ (ccres @ XF @ XA2)))))).
thf(asylib_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps <=> Xch) => (Xph => Xch))))))).
thf(adffn4_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ XA2) <=> (cwfo @ XA2 @ (ccrn @ XF) @ XF))))).
thf(afoco_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfo @ XB2 @ XC @ XF) & (cwfo @ XA2 @ XB2 @ XG)) => (cwfo @ XA2 @ XC @ (cccom @ XF @ XG))))))))).
...
thf(aunctb_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwbr @ XA2 @ ccom @ ccdom) & (cwbr @ XB2 @ ccom @ ccdom)) => (cwbr @ (ccun @ XA2 @ XB2) @ ccom @ ccdom))))).
...
thf(aovolctb2_ax,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccr) & (cwbr @ XA2 @ ccn @ ccdom)) => ((ccfv @ XA2 @ ccovol) = ccc0)))).
thf(cuniiccdif_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : ((Xph => (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => (Xph => ((cwss @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF))) @ (ccuni @ (ccrn @ (cccom @ ccicc @ XF)))) & ((ccfv @ (ccdif @ (ccuni @ (ccrn @ (cccom @ ccicc @ XF))) @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF)))) @ ccovol) = ccc0))))))).
