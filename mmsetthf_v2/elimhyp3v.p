...
thf(celimhyp3v_conj,conjecture,(! [Xph:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : (! [Xsi:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (((XA2 = (ccif @ Xph @ XA2 @ XD)) => (Xph <=> Xch)) => (((XB2 = (ccif @ Xph @ XB2 @ XR)) => (Xch <=> Xth)) => (((XC = (ccif @ Xph @ XC @ XS)) => (Xth <=> Xta)) => (((XD = (ccif @ Xph @ XA2 @ XD)) => (Xet <=> Xze)) => (((XR = (ccif @ Xph @ XB2 @ XR)) => (Xze <=> Xsi)) => (((XS = (ccif @ Xph @ XC @ XS)) => (Xsi <=> Xta)) => (Xet => Xta))))))))))))))))))))).
