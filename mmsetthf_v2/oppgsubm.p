...
thf(aoppgmndb_ax,axiom,(! [XR:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XR @ ccoppg)) => ((cwcel @ XR @ ccmnd) <=> (cwcel @ XO @ ccmnd)))))).
...
thf(coppgsubm_conj,conjecture,(! [XG:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XG @ ccoppg)) => ((ccfv @ XG @ ccsubmnd) = (ccfv @ XO @ ccsubmnd)))))).
