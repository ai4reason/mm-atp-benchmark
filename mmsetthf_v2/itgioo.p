...
thf(aovolfi_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwss @ XA2 @ ccr)) => ((ccfv @ XA2 @ ccovol) = ccc0)))).
thf(aovolssnul_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwss @ XA2 @ XB2) @ (cwss @ XB2 @ ccr) @ ((ccfv @ XB2 @ ccovol) = ccc0)) => ((ccfv @ XA2 @ ccovol) = ccc0))))).
thf(citgioo_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccicc))) => (cwcel @ (XC @ Xx3) @ ccc))) => (Xph => ((ccitg @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xx3:$i] : (XC @ Xx3))) = (ccitg @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (XC @ Xx3))))))))))))).
