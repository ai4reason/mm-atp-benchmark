...
thf(anvz0_ax,axiom,(! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XU @ ccn0v)) => ((XN = (ccfv @ XU @ ccnmcv)) => ((cwcel @ XU @ ccnv) => ((ccfv @ XZ @ XN) = ccc0)))))))).
...
thf(cnmoo0_conj,conjecture,(! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XN = (cco @ XU @ XW @ ccnmoo)) => ((XZ = (cco @ XU @ XW @ cc0o)) => (((cwcel @ XU @ ccnv) & (cwcel @ XW @ ccnv)) => ((ccfv @ XZ @ XN) = ccc0))))))))).
