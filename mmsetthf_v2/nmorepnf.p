...
thf(anmosetn0_ax,axiom,(! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (XX = (ccfv @ (XU @ Xx3 @ Xy1) @ ccba)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XZ = (ccfv @ (XU @ Xx3 @ Xy1) @ ccn0v)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XM = (ccfv @ (XU @ Xx3 @ Xy1) @ ccnmcv)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ (XU @ Xx3 @ Xy1) @ ccnv) => (cwcel @ (ccfv @ (ccfv @ XZ @ XT) @ XN) @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwbr @ (ccfv @ (ccv @ Xy1) @ XM) @ cc1 @ ccle) & ((ccv @ Xx3) = (ccfv @ (ccfv @ (ccv @ Xy1) @ XT) @ XN)))) @ (^ [Xy1:$i] : XX)))))))))))))))))).
...
thf(anmooval_ax,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : ((XX @ Xx3) = (ccfv @ XU @ ccba))) => ((! [Xz:$i] : ((XY @ Xz) = (ccfv @ XW @ ccba))) => ((! [Xx3:$i] : (! [Xz:$i] : ((XL @ Xx3 @ Xz) = (ccfv @ XU @ ccnmcv)))) => ((! [Xx3:$i] : (! [Xz:$i] : ((XM @ Xx3 @ Xz) = (ccfv @ XW @ ccnmcv)))) => ((! [Xx3:$i] : (! [Xz:$i] : ((XN @ Xx3 @ Xz) = (cco @ XU @ XW @ ccnmoo)))) => (! [Xx3:$i] : (! [Xz:$i] : ((cw3a @ (cwcel @ XU @ ccnv) @ (cwcel @ XW @ ccnv) @ (cwf @ (XX @ Xx3) @ (XY @ Xz) @ XT)) => ((ccfv @ XT @ (XN @ Xx3 @ Xz)) = (ccsup @ (ccab @ (^ [Xx3:$i] : (cwrex @ (^ [Xz:$i] : ((cwbr @ (ccfv @ (ccv @ Xz) @ (XL @ Xx3 @ Xz)) @ cc1 @ ccle) & ((ccv @ Xx3) = (ccfv @ (ccfv @ (ccv @ Xz) @ XT) @ (XM @ Xx3 @ Xz))))) @ (^ [Xz:$i] : (XX @ Xx3))))) @ ccxr @ cclt))))))))))))))))))).
thf(aneeq1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cwne @ XA2 @ XC) <=> (cwne @ XB2 @ XC))))))))).
thf(cnmorepnf_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XY = (ccfv @ XW @ ccba)) => ((XN = (cco @ XU @ XW @ ccnmoo)) => ((cw3a @ (cwcel @ XU @ ccnv) @ (cwcel @ XW @ ccnv) @ (cwf @ XX @ XY @ XT)) => ((cwcel @ (ccfv @ XT @ XN) @ ccr) <=> (cwne @ (ccfv @ XT @ XN) @ ccpnf))))))))))))).
