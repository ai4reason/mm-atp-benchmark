...
thf(apsgn0fv0_ax,axiom,((ccfv @ cc0 @ (ccfv @ cc0 @ ccpsgn)) = cc1)).
thf(ccab_tp,type,(ccab : (($i > $o) > ($i > $o)))).
thf(asymgbas0_ax,axiom,((ccfv @ (ccfv @ cc0 @ ccsymg) @ ccbs) = (ccsn @ cc0))).
...
thf(azrhpsgnevpm_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XR @ cczrh)) => ((XS = (ccfv @ XN @ ccpsgn)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XN @ ccfn) @ (cwcel @ XF @ (ccfv @ XN @ ccevpm))) => ((ccfv @ XF @ (cccom @ XY @ XS)) = Xc_1)))))))))))).
