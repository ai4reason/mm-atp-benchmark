...
thf(alcmgcdlem_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn) & (cwcel @ XN @ ccn)) => (((cco @ (cco @ XM @ XN @ cclcm) @ (cco @ XM @ XN @ ccgcd) @ ccmul) = (ccfv @ (cco @ XM @ XN @ ccmul) @ ccabs)) & (((cwcel @ XK @ ccn) & ((cwbr @ XM @ XK @ ccdvds) & (cwbr @ XN @ XK @ ccdvds))) => (cwbr @ (cco @ XM @ XN @ cclcm) @ XK @ ccdvds)))))))).
...
thf(clcmgcd_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ (cco @ XM @ XN @ cclcm) @ (cco @ XM @ XN @ ccgcd) @ ccmul) = (ccfv @ (cco @ XM @ XN @ ccmul) @ ccabs)))))).
