...
thf(aeldprd_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [Xc_0:($i > ($i > ($i > ($i > $o))))] : ((! [Xf1:$i] : (! [Xh:$i] : (! [Xi:$i] : ((Xc_0 @ Xf1 @ Xh @ Xi) = (ccfv @ XG @ cc0g))))) => ((! [Xf1:$i] : (! [Xh:$i] : (! [Xi:$i] : ((XW @ Xf1 @ Xh @ Xi) = (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ (Xc_0 @ Xf1 @ Xh @ Xi) @ ccfsupp)) @ (^ [Xh:$i] : (ccixp @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XS))))))))) => (! [Xh:$i] : (! [Xi:$i] : (((ccdm @ XS) = XI) => ((cwcel @ (XA2 @ Xh @ Xi) @ (cco @ XG @ XS @ ccdprd)) <=> ((cwbr @ XG @ XS @ (ccdm @ ccdprd)) & (cwrex @ (^ [Xf1:$i] : ((XA2 @ Xh @ Xi) = (cco @ XG @ (ccv @ Xf1) @ ccgsu))) @ (^ [Xf1:$i] : (XW @ Xf1 @ Xh @ Xi))))))))))))))))).
...
thf(adpjf_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((Xph => ((ccdm @ XS) = XI)) => ((XP = (cco @ XG @ XS @ ccdpj)) => ((Xph => (cwcel @ XX @ XI)) => (Xph => (cwf @ (cco @ XG @ XS @ ccdprd) @ (ccfv @ XX @ XS) @ (ccfv @ XX @ XP)))))))))))))).
...
thf(adpjval_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((Xph => ((ccdm @ XS) = XI)) => ((XP = (cco @ XG @ XS @ ccdpj)) => ((XQ = (ccfv @ XG @ ccpj1)) => ((Xph => (cwcel @ XX @ XI)) => (Xph => ((ccfv @ XX @ XP) = (cco @ (ccfv @ XX @ XS) @ (cco @ XG @ (ccres @ XS @ (ccdif @ XI @ (ccsn @ XX))) @ ccdprd) @ XQ)))))))))))))))).
...
thf(aeldprdi_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xi:$i] : ((Xc_0 @ Xi) = (ccfv @ XG @ cc0g))) => ((! [Xh:$i] : (! [Xi:$i] : ((XW @ Xh @ Xi) = (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ (Xc_0 @ Xi) @ ccfsupp)) @ (^ [Xh:$i] : (ccixp @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XS)))))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwbr @ XG @ XS @ (ccdm @ ccdprd))))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => ((ccdm @ XS) = XI)))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwcel @ (XF @ Xi) @ (XW @ Xh @ Xi))))) => (! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh @ Xi) => (cwcel @ (cco @ XG @ (XF @ Xi) @ ccgsu) @ (cco @ XG @ XS @ ccdprd)))))))))))))))))).
...
thf(afsuppsssupp_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((((cwcel @ XG @ XV) & (cwfun @ XG)) & ((cwbr @ XF @ XZ @ ccfsupp) & (cwss @ (cco @ XG @ XZ @ ccsupp) @ (cco @ XF @ XZ @ ccsupp)))) => (cwbr @ XG @ XZ @ ccfsupp))))))).
thf(asylanl2_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xch) => ((((Xps & Xch) & Xth) => Xta) => (((Xps & Xph) & Xth) => Xta))))))))).
thf(apj1rid_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_po = (ccfv @ XG @ cclsm)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((XZ = (ccfv @ XG @ cccntz)) => ((Xph => (cwcel @ XT @ (ccfv @ XG @ ccsubg))) => ((Xph => (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((Xph => ((ccin @ XT @ XU) = (ccsn @ Xc_0))) => ((Xph => (cwss @ XT @ (ccfv @ XU @ XZ))) => ((XP = (ccfv @ XG @ ccpj1)) => ((Xph & (cwcel @ XX @ XU)) => ((ccfv @ XX @ (cco @ XT @ XU @ XP)) = Xc_0)))))))))))))))))))))).
thf(ccof_tp,type,(ccof : (($i > $o) > ($i > $o)))).
thf(ccxp_tp,type,(ccxp : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccsg_tp,type,(ccsg : ($i > $o))).
thf(adprdsubg_ax,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : ((cwbr @ XG @ XS @ (ccdm @ ccdprd)) => (cwcel @ (cco @ XG @ XS @ ccdprd) @ (ccfv @ XG @ ccsubg)))))).
thf(adpjdisj_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xph => (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((Xph => ((ccdm @ XS) = XI)) => ((Xph => (cwcel @ XX @ XI)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (Xph => ((ccin @ (ccfv @ XX @ XS) @ (cco @ XG @ (ccres @ XS @ (ccdif @ XI @ (ccsn @ XX))) @ ccdprd)) = (ccsn @ Xc_0)))))))))))))).
thf(adpjcntz_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((Xph => ((ccdm @ XS) = XI)) => ((Xph => (cwcel @ XX @ XI)) => ((XZ = (ccfv @ XG @ cccntz)) => (Xph => (cwss @ (ccfv @ XX @ XS) @ (ccfv @ (cco @ XG @ (ccres @ XS @ (ccdif @ XI @ (ccsn @ XX))) @ ccdprd) @ XZ)))))))))))))).
...
thf(adpjlsm_ax,axiom,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwbr @ XG @ XS @ (ccdm @ ccdprd))) => ((Xph => ((ccdm @ XS) = XI)) => ((Xph => (cwcel @ XX @ XI)) => ((Xc_po = (ccfv @ XG @ cclsm)) => (Xph => ((cco @ XG @ XS @ ccdprd) = (cco @ (ccfv @ XX @ XS) @ (cco @ XG @ (ccres @ XS @ (ccdif @ XI @ (ccsn @ XX))) @ ccdprd) @ Xc_po)))))))))))))).
thf(cdpjidcl_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xh:$i] : ((Xph @ Xh) => (cwbr @ XG @ XS @ (ccdm @ ccdprd)))) => ((! [Xh:$i] : ((Xph @ Xh) => ((ccdm @ XS) = XI))) => ((! [Xi:$i] : ((XP @ Xi) = (cco @ XG @ XS @ ccdpj))) => ((! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh) => (cwcel @ (XA2 @ Xi) @ (cco @ XG @ XS @ ccdprd))))) => ((! [Xi:$i] : ((Xc_0 @ Xi) = (ccfv @ XG @ cc0g))) => ((! [Xh:$i] : (! [Xi:$i] : ((XW @ Xh @ Xi) = (ccrab @ (^ [Xh:$i] : (cwbr @ (ccv @ Xh) @ (Xc_0 @ Xi) @ ccfsupp)) @ (^ [Xh:$i] : (ccixp @ (^ [Xi:$i] : XI) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XS)))))))) => (! [Xh:$i] : (! [Xi:$i] : ((Xph @ Xh) => ((cwcel @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (ccfv @ (XA2 @ Xi) @ (ccfv @ (ccv @ Xx3) @ (XP @ Xi))))) @ (XW @ Xh @ Xi)) & ((XA2 @ Xi) = (cco @ XG @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (ccfv @ (XA2 @ Xi) @ (ccfv @ (ccv @ Xx3) @ (XP @ Xi))))) @ ccgsu))))))))))))))))))))).
