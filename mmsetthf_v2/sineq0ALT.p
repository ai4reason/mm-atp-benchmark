...
thf(aeel1111_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xph => Xps) => ((Xph => Xch) => ((Xph => Xth) => ((Xph => Xta) => (((((Xps & Xch) & Xth) & Xta) => Xet) => (Xph => Xet))))))))))))).
...
thf(aabsefib_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XA2 @ ccr) <=> ((ccfv @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cce) @ ccabs) = cc1))))).
thf(a_4an31_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (((((Xch & Xps) & Xph) & Xth) => Xta) => ((((Xph & Xps) & Xch) & Xth) => Xta)))))))).
thf(a_4animp1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (((cw3a @ Xph @ Xps @ Xch) => (Xta <=> Xth)) => ((((Xph & Xps) & Xch) & Xth) => Xta)))))))).
thf(amulre_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccr) @ (cwne @ XB2 @ ccc0)) => ((cwcel @ XA2 @ ccr) <=> (cwcel @ (cco @ XB2 @ XA2 @ ccmul) @ ccr)))))).
...
thf(a_4an4132_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (((((Xth & Xch) & Xps) & Xph) => Xta) => ((((Xph & Xps) & Xch) & Xth) => Xta)))))))).
...
thf(anot12an2impnot1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (((~ (Xph & Xps)) & Xps) => (~ Xph))))).
