...
thf(aussval_ax,axiom,(! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XU = (ccfv @ XW @ ccunif)) => ((cco @ XU @ (ccxp @ XB2 @ XB2) @ ccrest) = (ccfv @ XW @ ccuss)))))))).
...
thf(aressunif_ax,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((XH = (cco @ XG @ XA2 @ ccress)) => ((XU = (ccfv @ XG @ ccunif)) => ((cwcel @ XA2 @ XV) => (XU = (ccfv @ XH @ ccunif))))))))))).
thf(cressuss_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XA2 @ XV) => ((ccfv @ (cco @ XW @ XA2 @ ccress) @ ccuss) = (cco @ (ccfv @ XW @ ccuss) @ (ccxp @ XA2 @ XA2) @ ccrest))))))).
