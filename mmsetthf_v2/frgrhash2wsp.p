...
thf(awspniunwspnon_ax,axiom,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XN @ ccn) & (cwcel @ XG @ XU)) => ((cco @ XN @ XG @ ccwwspthsn) = (cciun @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (cciun @ (^ [Xy1:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (cco @ XN @ XG @ ccwwspthsnon)))))))))))))).
...
thf(awspthnonfi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ (ccfv @ XG @ ccvtx) @ ccfn) => (cwcel @ (cco @ XA2 @ XB2 @ (cco @ XN @ XG @ ccwwspthsnon)) @ ccfn))))))).
thf(aa1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(a_2wspiundisj_ax,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (cwdisj @ (^ [Xa:$i] : XV) @ (^ [Xa:$i] : (cciun @ (^ [Xb:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xa)))) @ (^ [Xb:$i] : (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (cco @ cc2 @ XG @ ccwwspthsnon))))))))).
thf(a_2wspdisj_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (cwdisj @ (^ [Xb:$i] : (ccdif @ XV @ (ccsn @ XA2))) @ (^ [Xb:$i] : (cco @ XA2 @ (ccv @ Xb) @ (cco @ cc2 @ XG @ ccwwspthsnon)))))))).
...
thf(afrgr2wsp1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cw3a @ (cwcel @ XG @ ccfrgr) @ ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) @ (cwne @ XA2 @ XB2)) => ((ccfv @ (cco @ XA2 @ XB2 @ (cco @ cc2 @ XG @ ccwwspthsnon)) @ cchash) = cc1)))))))).
