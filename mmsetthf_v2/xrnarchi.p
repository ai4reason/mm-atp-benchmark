...
thf(apnfinf_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwbr @ XA2 @ ccpnf @ (ccfv @ ccxrs @ ccinftm))))).
...
thf(aisarchi_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_lt:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((XB2 = (ccfv @ XW @ ccbs)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_0 @ Xx3 @ Xy1) = (ccfv @ XW @ cc0g)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_lt @ Xx3 @ Xy1) = (ccfv @ XW @ ccinftm)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XW @ (XV @ Xx3 @ Xy1)) => ((cwcel @ XW @ ccarchi) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (~ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_lt @ Xx3 @ Xy1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2))))))))))))))).
thf(axrsbas_ax,axiom,(ccxr = (ccfv @ ccxrs @ ccbs))).
thf(axrs0_ax,axiom,(ccc0 = (ccfv @ ccxrs @ cc0g))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(cxrnarchi_conj,conjecture,(~ (cwcel @ ccxrs @ ccarchi))).
