...
thf(aalephord2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((cwcel @ XA2 @ XB2) <=> (cwcel @ (ccfv @ XA2 @ ccale) @ (ccfv @ XB2 @ ccale))))))).
...
thf(calephval3_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((ccfv @ XA2 @ ccale) = (ccint @ (ccab @ (^ [Xx3:$i] : (cw3a @ ((ccfv @ (ccv @ Xx3) @ cccrd) = (ccv @ Xx3)) @ (cwss @ ccom @ (ccv @ Xx3)) @ (cwral @ (^ [Xy1:$i] : (~ ((ccv @ Xx3) = (ccfv @ (ccv @ Xy1) @ ccale)))) @ (^ [Xy1:$i] : XA2)))))))))).
