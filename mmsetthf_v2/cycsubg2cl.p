...
thf(ccycsubg2cl_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => ((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XX) @ (cwcel @ XN @ ccz)) => (cwcel @ (cco @ XN @ XA2 @ Xc_x) @ (ccfv @ (ccsn @ XA2) @ XK))))))))))))).
