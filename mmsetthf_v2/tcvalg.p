...
thf(atz9_1c_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccint @ (ccab @ (^ [Xx3:$i] : ((cwss @ XA2 @ (ccv @ Xx3)) & (cwtr @ (ccv @ Xx3)))))) @ ccvv)))).
...
thf(adf_tc_ax,axiom,(cctc = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccint @ (ccab @ (^ [Xy1:$i] : ((cwss @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwtr @ (ccv @ Xy1)))))))))).
thf(ctcvalg_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((ccfv @ XA2 @ cctc) = (ccint @ (ccab @ (^ [Xx3:$i] : ((cwss @ XA2 @ (ccv @ Xx3)) & (cwtr @ (ccv @ Xx3)))))))))))).
