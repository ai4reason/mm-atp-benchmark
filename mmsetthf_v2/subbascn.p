...
thf(aelfi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwcel @ XA2 @ (ccfv @ XB2 @ ccfi)) <=> (cwrex @ (^ [Xx3:$i] : (XA2 = (ccint @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccin @ (ccpw @ XB2) @ ccfn)))))))))).
...
thf(aintpreima_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwfun @ XF) & (cwne @ XA2 @ cc0)) => ((ccima @ (cccnv @ XF) @ (ccint @ XA2)) = (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccima @ (cccnv @ XF) @ (ccv @ Xx3))))))))).
...
thf(aiinopn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XJ:($i > $o)] : (((cwcel @ XJ @ cctop) & (cw3a @ (cwcel @ XA2 @ ccfn) @ (cwne @ XA2 @ cc0) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ XJ)) @ (^ [Xx3:$i] : XA2)))) => (cwcel @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XJ)))))).
