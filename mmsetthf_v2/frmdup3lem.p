...
thf(cfrmdup3lem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XM = (ccfv @ XI @ ccfrmd)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((XU = (ccfv @ XI @ ccvrmd)) => (((cw3a @ (cwcel @ XG @ ccmnd) @ (cwcel @ XI @ XV) @ (cwf @ XI @ XB2 @ XA2)) & ((cwcel @ XF @ (cco @ XM @ XG @ ccmhm)) & ((cccom @ XF @ XU) = XA2))) => (XF = (ccmpt @ (^ [Xx3:$i] : (ccword @ XI)) @ (^ [Xx3:$i] : (cco @ XG @ (cccom @ XA2 @ (ccv @ Xx3)) @ ccgsu))))))))))))))))).
