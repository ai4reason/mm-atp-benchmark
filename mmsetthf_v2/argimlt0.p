...
thf(alogcj_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ (ccfv @ XA2 @ ccim) @ ccc0)) => ((ccfv @ (ccfv @ XA2 @ cccj) @ cclog) = (ccfv @ (ccfv @ XA2 @ cclog) @ cccj))))).
...
thf(aimcj_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (ccfv @ XA2 @ cccj) @ ccim) = (ccneg @ (ccfv @ XA2 @ ccim)))))).
thf(ccicc_tp,type,(ccicc : ($i > $o))).
thf(ccdiv_tp,type,(ccdiv : ($i > $o))).
thf(ccabs_tp,type,(ccabs : ($i > $o))).
thf(ccsin_tp,type,(ccsin : ($i > $o))).
thf(aargimgt0_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwbr @ ccc0 @ (ccfv @ XA2 @ ccim) @ cclt)) => (cwcel @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ (cco @ ccc0 @ ccpi @ ccioo))))).
...
thf(cargimlt0_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwbr @ (ccfv @ XA2 @ ccim) @ ccc0 @ cclt)) => (cwcel @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ (cco @ (ccneg @ ccpi) @ ccc0 @ ccioo))))).
