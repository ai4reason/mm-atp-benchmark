...
thf(axpnnen_ax,axiom,(cwbr @ (ccxp @ ccn @ ccn) @ ccn @ ccen)).
...
thf(airrapx1_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdif @ ccrp @ ccq)) => (cwbr @ (ccrab @ (^ [Xy1:$i] : ((cwbr @ ccc0 @ (ccv @ Xy1) @ cclt) & (cwbr @ (ccfv @ (cco @ (ccv @ Xy1) @ XA2 @ ccmin) @ ccabs) @ (cco @ (ccfv @ (ccv @ Xy1) @ ccdenom) @ (ccneg @ cc2) @ ccexp) @ cclt))) @ (^ [Xy1:$i] : ccq)) @ ccn @ ccen)))).
thf(aensym_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) => (cwbr @ XB2 @ XA2 @ ccen))))).
thf(ccdiv_tp,type,(ccdiv : ($i > $o))).
thf(ccnumer_tp,type,(ccnumer : ($i > $o))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(apellexlem3_ax,axiom,(! [XD:($i > $o)] : (((cwcel @ XD @ ccn) & (~ (cwcel @ (ccfv @ XD @ ccsqrt) @ ccq))) => (cwbr @ (ccrab @ (^ [Xx3:$i] : ((cwbr @ ccc0 @ (ccv @ Xx3) @ cclt) & (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccfv @ XD @ ccsqrt) @ ccmin) @ ccabs) @ (cco @ (ccfv @ (ccv @ Xx3) @ ccdenom) @ (ccneg @ cc2) @ ccexp) @ cclt))) @ (^ [Xx3:$i] : ccq)) @ (ccopab @ (^ [Xy1:$i] : (^ [Xz:$i] : (((cwcel @ (ccv @ Xy1) @ ccn) & (cwcel @ (ccv @ Xz) @ ccn)) & ((cwne @ (cco @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ (cco @ XD @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ ccmul) @ ccmin) @ ccc0) & (cwbr @ (ccfv @ (cco @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ (cco @ XD @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ ccmul) @ ccmin) @ ccabs) @ (cco @ cc1 @ (cco @ cc2 @ (ccfv @ XD @ ccsqrt) @ ccmul) @ ccaddc) @ cclt)))))) @ ccdom)))).
...
thf(cpellexlem4_conj,conjecture,(! [XD:($i > $o)] : (((cwcel @ XD @ ccn) & (~ (cwcel @ (ccfv @ XD @ ccsqrt) @ ccq))) => (cwbr @ (ccopab @ (^ [Xy1:$i] : (^ [Xz:$i] : (((cwcel @ (ccv @ Xy1) @ ccn) & (cwcel @ (ccv @ Xz) @ ccn)) & ((cwne @ (cco @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ (cco @ XD @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ ccmul) @ ccmin) @ ccc0) & (cwbr @ (ccfv @ (cco @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ (cco @ XD @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ ccmul) @ ccmin) @ ccabs) @ (cco @ cc1 @ (cco @ cc2 @ (ccfv @ XD @ ccsqrt) @ ccmul) @ ccaddc) @ cclt)))))) @ ccn @ ccen)))).
