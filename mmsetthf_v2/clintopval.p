...
thf(aintopval_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XM @ XV) & (cwcel @ XN @ XW)) => ((cco @ XM @ XN @ ccintop) = (cco @ XN @ (ccxp @ XM @ XM) @ ccmap)))))))).
...
thf(cclintopval_conj,conjecture,(! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XM @ XV) => ((ccfv @ XM @ ccclintop) = (cco @ XM @ (ccxp @ XM @ XM) @ ccmap)))))).
