...
thf(csumsplit_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => ((ccin @ XA2 @ XB2) = cc0)) => ((Xph => (cwss @ (ccun @ XA2 @ XB2) @ XZ)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XF) = (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XC @ Xk) @ ccc0)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XG) = (ccif @ (cwcel @ (ccv @ Xk) @ XB2) @ (XC @ Xk) @ ccc0)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (ccun @ XA2 @ XB2))) => (cwcel @ (XC @ Xk) @ ccc))) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli))) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XG @ XM) @ (ccdm @ ccli))) => (Xph => ((ccsu @ (ccun @ XA2 @ XB2) @ (^ [Xk:$i] : (XC @ Xk))) = (cco @ (ccsu @ XA2 @ (^ [Xk:$i] : (XC @ Xk))) @ (ccsu @ XB2 @ (^ [Xk:$i] : (XC @ Xk))) @ ccaddc))))))))))))))))))))).
