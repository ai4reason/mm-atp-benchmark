...
thf(aclwwlkn0_ax,axiom,(! [XG:($i > $o)] : ((cco @ ccc0 @ XG @ ccclwwlkn) = cc0))).
thf(cclwwlkneq0_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (((cwnel @ XG @ ccvv) | (cwnel @ XN @ ccn)) => ((cco @ XN @ XG @ ccclwwlkn) = cc0))))).
