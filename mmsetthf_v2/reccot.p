...
thf(acotval_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ (ccfv @ XA2 @ ccsin) @ ccc0)) => ((ccfv @ XA2 @ cccot) = (cco @ (ccfv @ XA2 @ cccos) @ (ccfv @ XA2 @ ccsin) @ ccdiv))))).
...
thf(creccot_conj,conjecture,(! [XA2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ (ccfv @ XA2 @ ccsin) @ ccc0) @ (cwne @ (ccfv @ XA2 @ cccos) @ ccc0)) => ((ccfv @ XA2 @ cctan) = (cco @ cc1 @ (ccfv @ XA2 @ cccot) @ ccdiv))))).
