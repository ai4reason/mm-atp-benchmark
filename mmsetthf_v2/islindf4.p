...
thf(almodvsinv_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XN = (ccfv @ XW @ ccminusg)) => ((XM = (ccfv @ XF @ ccminusg)) => ((XK = (ccfv @ XF @ ccbs)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XR @ XK) @ (cwcel @ XX @ XB2)) => ((cco @ (ccfv @ XR @ XM) @ XX @ Xc_x) = (ccfv @ (cco @ XR @ XX @ Xc_x) @ XN))))))))))))))))))).
...
thf(afsnunf2_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwf @ (ccdif @ XS @ (ccsn @ XX)) @ XT @ XF) @ (cwcel @ XX @ XS) @ (cwcel @ XY @ XT)) => (cwf @ XS @ XT @ (ccun @ XF @ (ccsn @ (ccop @ XX @ XY))))))))))).
...
thf(afunsnfsupp_ax,axiom,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((((cwcel @ XX @ XV) & (cwcel @ XY @ XW)) & ((cwfun @ XF) & (cwnel @ XX @ (ccdm @ XF)))) => ((cwbr @ (ccun @ XF @ (ccsn @ (ccop @ XX @ XY))) @ XZ @ ccfsupp) <=> (cwbr @ XF @ XZ @ ccfsupp)))))))))).
...
thf(afsnunres_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwfn @ XF @ XS) & (~ (cwcel @ XX @ XS))) => ((ccres @ (ccun @ XF @ (ccsn @ (ccop @ XX @ XY))) @ XS) = XF))))))).
...
thf(aralxpmap_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (((ccv @ Xf1) = (ccun @ (ccv @ Xg1) @ (ccsn @ (ccop @ XJ @ (ccv @ Xy1))))) => ((Xph @ Xf1) <=> (Xps @ Xy1 @ Xg1)))))) => ((cwcel @ XJ @ XT) => ((cwral @ (^ [Xf1:$i] : (Xph @ Xf1)) @ (^ [Xf1:$i] : (cco @ XS @ XT @ ccmap))) <=> (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xg1:$i] : (Xps @ Xy1 @ Xg1)) @ (^ [Xg1:$i] : (cco @ XS @ (ccdif @ XT @ (ccsn @ XJ)) @ ccmap)))) @ (^ [Xy1:$i] : XS))))))))))).
...
thf(cislindf4_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XR = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XY = (ccfv @ XR @ cc0g)) => ((XL = (ccfv @ (cco @ XR @ XI @ ccfrlm) @ ccbs)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XI @ XX) @ (cwf @ XI @ XB2 @ XF)) => ((cwbr @ XF @ XW @ cclindf) <=> (cwral @ (^ [Xx3:$i] : (((cco @ XW @ (cco @ (ccv @ Xx3) @ XF @ (ccof @ Xc_x)) @ ccgsu) = Xc_0) => ((ccv @ Xx3) = (ccxp @ XI @ (ccsn @ XY))))) @ (^ [Xx3:$i] : XL))))))))))))))))))))).
