...
thf(asqrt9_ax,axiom,((ccfv @ cc9 @ ccsqrt) = cc3)).
...
thf(appiprm_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ (cco @ XA2 @ cc1 @ ccaddc) @ ccprime)) => ((ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ ccppi) = (cco @ (ccfv @ XA2 @ ccppi) @ cc1 @ ccaddc))))).
...
thf(appiub_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccr) & (cwbr @ ccc0 @ XN @ ccle)) => (cwbr @ (ccfv @ XN @ ccppi) @ (cco @ (cco @ XN @ cc3 @ ccdiv) @ cc2 @ ccaddc) @ ccle)))).
