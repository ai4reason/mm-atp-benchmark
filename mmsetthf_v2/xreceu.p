...
thf(axrecex_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwne @ XA2 @ ccc0)) => (cwrex @ (^ [Xx3:$i] : ((cco @ XA2 @ (ccv @ Xx3) @ ccxmu) = cc1)) @ (^ [Xx3:$i] : ccr))))).
...
thf(axmulcand_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwne @ XC @ ccc0)) => (Xph => (((cco @ XC @ XA2 @ ccxmu) = (cco @ XC @ XB2 @ ccxmu)) <=> (XA2 = XB2)))))))))))).
...
thf(cxreceu_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccr) @ (cwne @ XB2 @ ccc0)) => (cwreu @ (^ [Xx3:$i] : ((cco @ XB2 @ (ccv @ Xx3) @ ccxmu) = XA2)) @ (^ [Xx3:$i] : ccxr)))))).
