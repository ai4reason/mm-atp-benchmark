...
thf(areldmprds_ax,axiom,(cwrel @ (ccdm @ ccprds))).
...
thf(afndmdif_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfn @ XF @ XA2) & (cwfn @ XG @ XA2)) => ((ccdm @ (ccdif @ XF @ XG)) = (ccrab @ (^ [Xx3:$i] : (cwne @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG))) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(adsmmbase_ax,axiom,(! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xf1:$i] : ((XB2 @ Xx3 @ Xf1) = (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwne @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ cc0g))) @ (^ [Xx3:$i] : (ccdm @ XR))) @ ccfn)) @ (^ [Xf1:$i] : (ccfv @ (cco @ XS @ XR @ ccprds) @ ccbs)))))) => (! [Xx3:$i] : (! [Xf1:$i] : ((cwcel @ XR @ (XV @ Xx3 @ Xf1)) => ((XB2 @ Xx3 @ Xf1) = (ccfv @ (cco @ XS @ XR @ ccdsmm) @ ccbs))))))))))).
thf(cdsmmbas2_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XP = (cco @ XS @ XR @ ccprds)) => ((! [Xf1:$i] : ((XB2 @ Xf1) = (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccdm @ (ccdif @ (ccv @ Xf1) @ (cccom @ cc0g @ XR))) @ ccfn)) @ (^ [Xf1:$i] : (ccfv @ XP @ ccbs))))) => (! [Xf1:$i] : (((cwfn @ XR @ XI) & (cwcel @ XI @ XV)) => ((XB2 @ Xf1) = (ccfv @ (cco @ XS @ XR @ ccdsmm) @ ccbs))))))))))))).
