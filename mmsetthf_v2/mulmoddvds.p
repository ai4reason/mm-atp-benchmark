...
thf(cmulmoddvds_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) => ((cwbr @ XN @ XA2 @ ccdvds) => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ XN @ ccmo) = ccc0))))))).
