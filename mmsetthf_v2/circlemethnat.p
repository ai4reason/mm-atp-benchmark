...
thf(ahashrepr_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn)) => ((Xph => (cwcel @ XM @ ccn0)) => ((Xph => (cwcel @ XS @ ccn0)) => (Xph => ((ccfv @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)) @ cchash) = (ccsu @ (cco @ ccn @ XM @ (ccfv @ XS @ ccrepr)) @ (^ [Xc:$i] : (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xc)) @ (ccfv @ XA2 @ (ccfv @ ccn @ ccind))))))))))))))))).
