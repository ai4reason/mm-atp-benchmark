...
thf(adf_wwlks_ax,axiom,(ccwwlks = (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccrab @ (^ [Xw:$i] : ((cwne @ (ccv @ Xw) @ cc0) & (cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xw)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xw))) @ (ccfv @ (ccv @ Xg1) @ ccedg))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ (ccfv @ (ccv @ Xw) @ cchash) @ cc1 @ ccmin) @ ccfzo))))) @ (^ [Xw:$i] : (ccword @ (ccfv @ (ccv @ Xg1) @ ccvtx)))))))).
...
thf(a_0wrd0_ax,axiom,(! [XW:($i > $o)] : ((cwcel @ XW @ (ccword @ cc0)) <=> (XW = cc0)))).
...
thf(cwwlks_conj,conjecture,(! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xi:$i] : ((XV @ Xi) = (ccfv @ XG @ ccvtx))) => ((! [Xw:$i] : (! [Xi:$i] : ((XE @ Xw @ Xi) = (ccfv @ XG @ ccedg)))) => (! [Xi:$i] : ((ccfv @ XG @ ccwwlks) = (ccrab @ (^ [Xw:$i] : ((cwne @ (ccv @ Xw) @ cc0) & (cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xw)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xw))) @ (XE @ Xw @ Xi))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ (ccfv @ (ccv @ Xw) @ cchash) @ cc1 @ ccmin) @ ccfzo))))) @ (^ [Xw:$i] : (ccword @ (XV @ Xi)))))))))))).
