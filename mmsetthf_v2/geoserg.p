...
thf(cgeoserg_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwne @ XA2 @ cc1)) => ((Xph => (cwcel @ XM @ ccn0)) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => (Xph => ((ccsu @ (cco @ XM @ XN @ ccfzo) @ (^ [Xk:$i] : (cco @ XA2 @ (ccv @ Xk) @ ccexp))) = (cco @ (cco @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccmin) @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv)))))))))))).
