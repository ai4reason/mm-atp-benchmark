...
thf(apjlnopi_ax,axiom,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => (cwcel @ (ccfv @ XH @ ccpjh) @ cclo)))).
...
thf(apjnmopi_ax,axiom,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((cwne @ XH @ cc0h) => ((ccfv @ (ccfv @ XH @ ccpjh) @ ccnop) = cc1))))).
...
thf(cpjbdlni_conj,conjecture,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => (cwcel @ (ccfv @ XH @ ccpjh) @ ccbo)))).
