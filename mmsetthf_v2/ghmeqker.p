...
thf(cghmeqker_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XS @ ccbs)) => ((Xc_0 = (ccfv @ XT @ cc0g)) => ((XK = (ccima @ (cccnv @ XF) @ (ccsn @ Xc_0))) => ((Xc_mi = (ccfv @ XS @ ccsg)) => ((cw3a @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm)) @ (cwcel @ XU @ XB2) @ (cwcel @ XV @ XB2)) => (((ccfv @ XU @ XF) = (ccfv @ XV @ XF)) <=> (cwcel @ (cco @ XU @ XV @ Xc_mi) @ XK))))))))))))))))).
