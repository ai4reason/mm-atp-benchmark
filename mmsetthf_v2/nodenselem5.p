...
thf(cnodenselem5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccsur) & (cwcel @ XB2 @ ccsur)) & (((ccfv @ XA2 @ ccbday) = (ccfv @ XB2 @ ccbday)) & (cwbr @ XA2 @ XB2 @ ccslt))) => (cwcel @ (ccint @ (ccrab @ (^ [Xa:$i] : (cwne @ (ccfv @ (ccv @ Xa) @ XA2) @ (ccfv @ (ccv @ Xa) @ XB2))) @ (^ [Xa:$i] : ccon0))) @ (ccfv @ XA2 @ ccbday)))))).
