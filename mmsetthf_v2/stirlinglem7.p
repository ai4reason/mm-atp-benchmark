...
thf(astirlinglem6_ax,axiom,(! [XH:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xj:$i] : ((XH @ Xj) = (ccmpt @ (^ [Xj:$i] : ccn0) @ (^ [Xj:$i] : (cco @ cc2 @ (cco @ (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xj) @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ (cco @ (cco @ cc1 @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ (cco @ (cco @ cc2 @ (ccv @ Xj) @ ccmul) @ cc1 @ ccaddc) @ ccexp) @ ccmul) @ ccmul))))) => (! [Xj:$i] : ((cwcel @ XN @ ccn) => (cwbr @ (ccseq @ ccaddc @ (XH @ Xj) @ ccc0) @ (ccfv @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XN @ ccdiv) @ cclog) @ ccli))))))).
