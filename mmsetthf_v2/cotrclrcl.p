...
thf(arelexpaddss_ax,axiom,(! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XM @ ccn0) @ (cwcel @ XR @ XV)) => (cwss @ (cccom @ (cco @ XR @ XN @ ccrelexp) @ (cco @ XR @ XM @ ccrelexp)) @ (cco @ XR @ (cco @ XN @ XM @ ccaddc) @ ccrelexp)))))))).
