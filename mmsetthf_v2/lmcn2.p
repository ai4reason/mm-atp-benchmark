...
thf(almcn_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwbr @ XF @ XP @ (ccfv @ XJ @ cclm))) => ((Xph => (cwcel @ XG @ (cco @ XJ @ XK @ cccn))) => (Xph => (cwbr @ (cccom @ XG @ XF) @ (ccfv @ XP @ XG) @ (ccfv @ XK @ cclm)))))))))))).
thf(ampbi2and_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xph => Xch) => ((Xph => ((Xps & Xch) <=> Xth)) => (Xph => Xth))))))))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(atxlm_ax,axiom,(! [Xph:$o] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xn:$i] : (XZ = (ccfv @ (XM @ Xn) @ ccuz))) => ((! [Xn:$i] : (Xph => (cwcel @ (XM @ Xn) @ ccz))) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((Xph => (cwf @ XZ @ XX @ XF)) => ((Xph => (cwf @ XZ @ XY @ XG)) => ((! [Xn:$i] : ((XH @ Xn) = (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccop @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (ccv @ Xn) @ XG)))))) => (! [Xn:$i] : (Xph => (((cwbr @ XF @ (XR @ Xn) @ (ccfv @ XJ @ cclm)) & (cwbr @ XG @ (XS @ Xn) @ (ccfv @ XK @ cclm))) <=> (cwbr @ (XH @ Xn) @ (ccop @ (XR @ Xn) @ (XS @ Xn)) @ (ccfv @ (cco @ XJ @ XK @ cctx) @ cclm))))))))))))))))))))))))).
thf(clmcn2_conj,conjecture,(! [Xph:$o] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xn:$i] : (XZ = (ccfv @ (XM @ Xn) @ ccuz))) => ((! [Xn:$i] : (Xph => (cwcel @ (XM @ Xn) @ ccz))) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((Xph => (cwf @ XZ @ XX @ XF)) => ((Xph => (cwf @ XZ @ XY @ XG)) => ((! [Xn:$i] : (Xph => (cwbr @ XF @ (XR @ Xn) @ (ccfv @ XJ @ cclm)))) => ((! [Xn:$i] : (Xph => (cwbr @ XG @ (XS @ Xn) @ (ccfv @ XK @ cclm)))) => ((! [Xn:$i] : (Xph => (cwcel @ XO @ (cco @ (cco @ XJ @ XK @ cctx) @ (XN @ Xn) @ cccn)))) => ((! [Xn:$i] : ((XH @ Xn) = (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (ccv @ Xn) @ XG) @ XO))))) => (! [Xn:$i] : (Xph => (cwbr @ (XH @ Xn) @ (cco @ (XR @ Xn) @ (XS @ Xn) @ XO) @ (ccfv @ (XN @ Xn) @ cclm))))))))))))))))))))))))))))).
