...
thf(aopelinxp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ (ccop @ XC @ XD) @ (ccin @ XR @ (ccxp @ XA2 @ XB2))) <=> (((cwcel @ XC @ XA2) & (cwcel @ XD @ XB2)) & (cwcel @ (ccop @ XC @ XD) @ XR))))))))).
...
thf(ciss2_conj,conjecture,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccid) <=> (XA2 = (ccin @ ccid @ (ccxp @ (ccdm @ XA2) @ (ccrn @ XA2))))))).
