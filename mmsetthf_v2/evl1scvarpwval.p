...
thf(aevl1varpwval_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XQ = (ccfv @ XR @ cce1)) => ((XW = (ccfv @ XR @ ccpl1)) => ((XG = (ccfv @ XW @ ccmgp)) => ((XX = (ccfv @ XR @ ccv1)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_ex = (ccfv @ XG @ ccmg)) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XC @ XB2)) => ((XH = (ccfv @ XR @ ccmgp)) => ((XE = (ccfv @ XH @ ccmg)) => (Xph => ((ccfv @ XC @ (ccfv @ (cco @ XN @ XX @ Xc_ex) @ XQ)) = (cco @ XN @ XC @ XE))))))))))))))))))))))))))).
thf(cevl1scvarpwval_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XQ = (ccfv @ XR @ cce1)) => ((XW = (ccfv @ XR @ ccpl1)) => ((XG = (ccfv @ XW @ ccmgp)) => ((XX = (ccfv @ XR @ ccv1)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_ex = (ccfv @ XG @ ccmg)) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xc_xp = (ccfv @ XW @ ccvsca)) => ((Xph => (cwcel @ XA2 @ XB2)) => ((Xph => (cwcel @ XC @ XB2)) => ((XH = (ccfv @ XR @ ccmgp)) => ((XE = (ccfv @ XH @ ccmg)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => (Xph => ((ccfv @ XC @ (ccfv @ (cco @ XA2 @ (cco @ XN @ XX @ Xc_ex) @ Xc_xp) @ XQ)) = (cco @ XA2 @ (cco @ XN @ XC @ XE) @ Xc_x))))))))))))))))))))))))))))))))).
