...
thf(areldmevls_ax,axiom,(cwrel @ (ccdm @ cces))).
thf(cevlval_conj,conjecture,(! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XI:($i > $o)] : ((XQ = (cco @ XI @ XR @ ccevl)) => ((XB2 = (ccfv @ XR @ ccbs)) => (XQ = (ccfv @ XB2 @ (cco @ XI @ XR @ cces)))))))))).
