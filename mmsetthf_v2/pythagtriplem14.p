...
thf(cpythagtriplem14_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ (cco @ (ccfv @ (cco @ XC @ XB2 @ ccaddc) @ ccsqrt) @ (ccfv @ (cco @ XC @ XB2 @ ccmin) @ ccsqrt) @ ccmin) @ cc2 @ ccdiv)) => ((cw3a @ (cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccn)) @ ((cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) = (cco @ XC @ cc2 @ ccexp)) @ (((cco @ XA2 @ XB2 @ ccgcd) = cc1) & (~ (cwbr @ cc2 @ XA2 @ ccdvds)))) => ((cco @ XN @ cc2 @ ccexp) = (cco @ (cco @ XC @ XA2 @ ccmin) @ cc2 @ ccdiv))))))))).
