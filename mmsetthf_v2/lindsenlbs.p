...
thf(alindsdom_ax,axiom,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XI @ ccfn) @ (cwcel @ XX @ (ccfv @ (cco @ XR @ XI @ ccfrlm) @ cclinds))) => (cwbr @ XX @ XI @ ccdom)))))).
thf(adomfi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwbr @ XB2 @ XA2 @ ccdom)) => (cwcel @ XB2 @ ccfn))))).
...
thf(ansspssun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((~ (cwss @ XA2 @ XB2)) <=> (cwpss @ XB2 @ (ccun @ XA2 @ XB2)))))).
...
thf(aislbs4_ax,axiom,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XJ = (ccfv @ XW @ cclbs)) => ((XK = (ccfv @ XW @ cclspn)) => ((cwcel @ XX @ XJ) <=> ((cwcel @ XX @ (ccfv @ XW @ cclinds)) & ((ccfv @ XX @ XK) = XB2)))))))))))).
thf(clindsenlbs_conj,conjecture,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (((cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XI @ ccfn) @ (cwcel @ XX @ (ccfv @ (cco @ XR @ XI @ ccfrlm) @ cclinds))) & (cwbr @ XX @ XI @ ccen)) => (cwcel @ XX @ (ccfv @ (cco @ XR @ XI @ ccfrlm) @ cclbs))))))).
