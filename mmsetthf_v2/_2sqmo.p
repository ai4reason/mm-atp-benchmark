...
thf(a_2sqmod_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : ((Xph => (cwcel @ XP @ ccprime)) => ((Xph => (cwcel @ XA2 @ ccn0)) => ((Xph => (cwcel @ XB2 @ ccn0)) => ((Xph => (cwcel @ XC @ ccn0)) => ((Xph => (cwcel @ XD @ ccn0)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((Xph => (cwbr @ XC @ XD @ ccle)) => ((Xph => ((cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) = XP)) => ((Xph => ((cco @ (cco @ XC @ cc2 @ ccexp) @ (cco @ XD @ cc2 @ ccexp) @ ccaddc) = XP)) => (Xph => ((XA2 = XC) & (XB2 = XD))))))))))))))))))).
thf(asimp_8l_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : (! [Xsi:$o] : (! [Xrh:$o] : (((((((((Xph & Xps) & Xch) & Xth) & Xta) & Xet) & Xze) & Xsi) & Xrh) => Xph))))))))))).
