...
thf(afmtnonn_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => (cwcel @ (ccfv @ XN @ ccfmtno) @ ccn)))).
...
thf(amuldvds1_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) => ((cwbr @ (cco @ XK @ XM @ ccmul) @ XN @ ccdvds) => (cwbr @ XK @ XN @ ccdvds))))))).
...
thf(amuladd11r_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ (cco @ XA2 @ cc1 @ ccaddc) @ (cco @ XB2 @ cc1 @ ccaddc) @ ccmul) = (cco @ (cco @ (cco @ XA2 @ XB2 @ ccmul) @ (cco @ XA2 @ XB2 @ ccaddc) @ ccaddc) @ cc1 @ ccaddc)))))).
