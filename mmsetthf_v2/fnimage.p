...
thf(afunimage_ax,axiom,(! [XA2:($i > $o)] : (cwfun @ (ccimage @ XA2)))).
...
thf(abrimageg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwbr @ XA2 @ XB2 @ (ccimage @ XR)) <=> (XB2 = (ccima @ XR @ XA2)))))))))).
...
thf(cfnimage_conj,conjecture,(! [XR:($i > $o)] : (cwfn @ (ccimage @ XR) @ (ccab @ (^ [Xx3:$i] : (cwcel @ (ccima @ XR @ (ccv @ Xx3)) @ ccvv)))))).
