...
thf(abj_pr2eq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 = XB2) => ((cbj_cpr2 @ XA2) = (cbj_cpr2 @ XB2)))))).
thf(abj_pr2un_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cbj_cpr2 @ (ccun @ XA2 @ XB2)) = (ccun @ (cbj_cpr2 @ XA2) @ (cbj_cpr2 @ XB2)))))).
...
thf(abj_pr2val_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cbj_cpr2 @ (ccxp @ (ccsn @ XA2) @ (cbj_ctag @ XB2))) = (ccif @ (XA2 = cc1o) @ XB2 @ cc0))))).
