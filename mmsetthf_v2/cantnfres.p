...
thf(aextmptsuppeq_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xn:$i] : (Xph => (cwcel @ XB2 @ (XW @ Xn)))) => ((Xph => (cwss @ XA2 @ XB2)) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ (ccdif @ XB2 @ XA2))) => ((XX @ Xn) = XZ))) => (Xph => ((cco @ (ccmpt @ (^ [Xn:$i] : XA2) @ (^ [Xn:$i] : (XX @ Xn))) @ XZ @ ccsupp) = (cco @ (ccmpt @ (^ [Xn:$i] : XB2) @ (^ [Xn:$i] : (XX @ Xn))) @ XZ @ ccsupp))))))))))))).
...
thf(aoieq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((XA2 = XB2) => ((ccoi @ XA2 @ XR) = (ccoi @ XB2 @ XR))))))).
...
thf(acantnfval2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : ((XS = (ccdm @ (cco @ XA2 @ XB2 @ cccnf))) => ((Xph => (cwcel @ XA2 @ ccon0)) => ((Xph => (cwcel @ XB2 @ ccon0)) => ((XG = (ccoi @ (cco @ XF @ cc0 @ ccsupp) @ ccep)) => ((Xph => (cwcel @ XF @ XS)) => ((! [Xz:$i] : (! [Xk:$i] : ((XH @ Xz @ Xk) = (ccseqom @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xz:$i] : ccvv)) @ (^ [Xk:$i] : (^ [Xz:$i] : ccvv)) @ (^ [Xk:$i] : (^ [Xz:$i] : (cco @ (cco @ (cco @ XA2 @ (ccfv @ (ccv @ Xk) @ XG) @ ccoe) @ (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ XF) @ ccomu) @ (ccv @ Xz) @ ccoa)))) @ cc0)))) => (Xph => ((ccfv @ XF @ (cco @ XA2 @ XB2 @ cccnf)) = (ccfv @ (ccdm @ XG) @ (ccseqom @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xz:$i] : (ccdm @ XG))) @ (^ [Xk:$i] : (^ [Xz:$i] : ccon0)) @ (^ [Xk:$i] : (^ [Xz:$i] : (cco @ (cco @ (cco @ XA2 @ (ccfv @ (ccv @ Xk) @ XG) @ ccoe) @ (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ XF) @ ccomu) @ (ccv @ Xz) @ ccoa)))) @ cc0)))))))))))))))))).
thf(ampbid_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => (Xps <=> Xch)) => (Xph => Xch))))))).
thf(cwfun_tp,type,(cwfun : (($i > $o) > $o))).
thf(ccfsupp_tp,type,(ccfsupp : ($i > $o))).
thf(acantnfrescl_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xn:$i] : ((XS @ Xn) = (ccdm @ (cco @ XA2 @ XB2 @ cccnf)))) => ((Xph => (cwcel @ XA2 @ ccon0)) => ((Xph => (cwcel @ XB2 @ ccon0)) => ((Xph => (cwcel @ XD @ ccon0)) => ((Xph => (cwss @ XB2 @ XD)) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ (ccdif @ XD @ XB2))) => ((XX @ Xn) = cc0))) => ((Xph => (cwcel @ cc0 @ XA2)) => ((! [Xn:$i] : ((XT @ Xn) = (ccdm @ (cco @ XA2 @ XD @ cccnf)))) => (! [Xn:$i] : (Xph => ((cwcel @ (ccmpt @ (^ [Xn:$i] : XB2) @ (^ [Xn:$i] : (XX @ Xn))) @ (XS @ Xn)) <=> (cwcel @ (ccmpt @ (^ [Xn:$i] : XD) @ (^ [Xn:$i] : (XX @ Xn))) @ (XT @ Xn))))))))))))))))))))).
thf(ccantnfres_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xn:$i] : ((XS @ Xn) = (ccdm @ (cco @ XA2 @ XB2 @ cccnf)))) => ((Xph => (cwcel @ XA2 @ ccon0)) => ((Xph => (cwcel @ XB2 @ ccon0)) => ((Xph => (cwcel @ XD @ ccon0)) => ((Xph => (cwss @ XB2 @ XD)) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ (ccdif @ XD @ XB2))) => ((XX @ Xn) = cc0))) => ((Xph => (cwcel @ cc0 @ XA2)) => ((! [Xn:$i] : ((XT @ Xn) = (ccdm @ (cco @ XA2 @ XD @ cccnf)))) => ((! [Xn:$i] : (Xph => (cwcel @ (ccmpt @ (^ [Xn:$i] : XB2) @ (^ [Xn:$i] : (XX @ Xn))) @ (XS @ Xn)))) => (Xph => ((ccfv @ (ccmpt @ (^ [Xn:$i] : XB2) @ (^ [Xn:$i] : (XX @ Xn))) @ (cco @ XA2 @ XB2 @ cccnf)) = (ccfv @ (ccmpt @ (^ [Xn:$i] : XD) @ (^ [Xn:$i] : (XX @ Xn))) @ (cco @ XA2 @ XD @ cccnf))))))))))))))))))))).
