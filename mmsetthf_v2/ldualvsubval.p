...
thf(aldualneg_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XR = (ccfv @ XW @ ccsca)) => ((XM = (ccfv @ XR @ ccminusg)) => ((XD = (ccfv @ XW @ ccld)) => ((XS = (ccfv @ XD @ ccsca)) => ((XN = (ccfv @ XS @ ccminusg)) => ((Xph => (cwcel @ XW @ cclmod)) => (Xph => (XN = XM)))))))))))))))).
thf(aldual1_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((XR = (ccfv @ XW @ ccsca)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((XD = (ccfv @ XW @ ccld)) => ((XS = (ccfv @ XD @ ccsca)) => ((XI = (ccfv @ XS @ ccur)) => ((Xph => (cwcel @ XW @ cclmod)) => (Xph => (XI = Xc_1)))))))))))))))).
