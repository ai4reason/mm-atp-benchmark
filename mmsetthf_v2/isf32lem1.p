...
thf(cisf32lem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwf @ ccom @ (ccpw @ (XG @ Xx3)) @ XF))) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : ccom))) => ((Xph => (~ (cwcel @ (ccint @ (ccrn @ XF)) @ (ccrn @ XF)))) => ((((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom)) & ((cwss @ XB2 @ XA2) & Xph)) => (cwss @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF)))))))))))).
