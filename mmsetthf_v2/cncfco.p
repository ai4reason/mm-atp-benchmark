...
thf(ccncfco_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ XA2 @ XB2 @ cccncf))) => ((Xph => (cwcel @ XG @ (cco @ XB2 @ XC @ cccncf))) => (Xph => (cwcel @ (cccom @ XG @ XF) @ (cco @ XA2 @ XC @ cccncf)))))))))))).
