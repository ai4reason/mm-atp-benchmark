...
thf(aqmulz_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccq) => (cwrex @ (^ [Xx3:$i] : (cwcel @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ ccz)) @ (^ [Xx3:$i] : ccn))))).
