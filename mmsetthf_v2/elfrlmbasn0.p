...
thf(celfrlmbasn0_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XF = (cco @ XR @ XI @ ccfrlm)) => ((XN = (ccfv @ XR @ ccbs)) => ((XB2 = (ccfv @ XF @ ccbs)) => (((cwcel @ XI @ XV) & (cwne @ XI @ cc0)) => ((cwcel @ XX @ XB2) => (cwne @ XX @ cc0)))))))))))))).
