...
thf(aiccshift_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((! [Xw:$i] : ((Xph @ Xw) => (cwcel @ XA2 @ ccr))) => ((! [Xw:$i] : ((Xph @ Xw) => (cwcel @ XB2 @ ccr))) => ((! [Xw:$i] : ((Xph @ Xw) => (cwcel @ XT @ ccr))) => (! [Xw:$i] : ((Xph @ Xw) => ((cco @ (cco @ XA2 @ XT @ ccaddc) @ (cco @ XB2 @ XT @ ccaddc) @ ccicc) = (ccrab @ (^ [Xw:$i] : (cwrex @ (^ [Xz:$i] : ((ccv @ Xw) = (cco @ (ccv @ Xz) @ XT @ ccaddc))) @ (^ [Xz:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xw:$i] : ccc))))))))))))).
thf(acncfshift_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwcel @ XT @ ccc)) => ((XB2 = (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ XT @ ccaddc))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccc))) => ((! [Xy1:$i] : (Xph => (cwcel @ (XF @ Xy1) @ (cco @ XA2 @ ccc @ cccncf)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XG @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ XT @ ccmin) @ (XF @ Xy1))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XG @ Xx3 @ Xy1) @ (cco @ XB2 @ ccc @ cccncf))))))))))))))))).
