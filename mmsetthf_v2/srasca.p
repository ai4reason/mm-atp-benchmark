...
thf(aipndx_ax,axiom,((ccfv @ ccnx @ ccip) = cc8)).
...
thf(asraval_ax,axiom,(! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ XV) & (cwss @ XS @ (ccfv @ XW @ ccbs))) => ((ccfv @ XS @ (ccfv @ XW @ ccsra)) = (cco @ (cco @ (cco @ XW @ (ccop @ (ccfv @ ccnx @ ccsca) @ (cco @ XW @ XS @ ccress)) @ ccsts) @ (ccop @ (ccfv @ ccnx @ ccvsca) @ (ccfv @ XW @ ccmulr)) @ ccsts) @ (ccop @ (ccfv @ ccnx @ ccip) @ (ccfv @ XW @ ccmulr)) @ ccsts))))))).
...
thf(areldmress_ax,axiom,(cwrel @ (ccdm @ ccress))).
...
thf(csrasca_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (XA2 = (ccfv @ XS @ (ccfv @ XW @ ccsra)))) => ((Xph => (cwss @ XS @ (ccfv @ XW @ ccbs))) => (Xph => ((cco @ XW @ XS @ ccress) = (ccfv @ XA2 @ ccsca)))))))))).
