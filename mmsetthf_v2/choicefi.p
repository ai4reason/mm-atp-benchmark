...
thf(cchoicefi_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XA2 @ ccfn))) => ((! [Xx3:$i] : (! [Xf1:$i] : (((Xph @ Xf1) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ (XW @ Xx3 @ Xf1))))) => ((! [Xx3:$i] : (! [Xf1:$i] : (((Xph @ Xf1) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwne @ (XB2 @ Xx3) @ cc0)))) => (! [Xf1:$i] : ((Xph @ Xf1) => (? [Xf1:$i] : ((cwfn @ (ccv @ Xf1) @ XA2) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (XB2 @ Xx3))) @ (^ [Xx3:$i] : XA2)))))))))))))).
