...
thf(a_1fpid3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) => Xch) => ((cwif @ Xph @ Xps @ Xch) => Xch)))))).
...
thf(cifpsnprss_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XE:($i > $o)] : ((cwif @ (XA2 = XB2) @ (XE = (ccsn @ XA2)) @ (cwss @ (ccpr @ XA2 @ XB2) @ XE)) => (cwss @ (ccpr @ XA2 @ XB2) @ XE)))))).
