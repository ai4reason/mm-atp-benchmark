...
thf(achrelat3i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwss @ XA2 @ XB2) <=> (cwral @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) => (cwss @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : ccat)))))))).
...
thf(cchrelat4i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((XA2 = XB2) <=> (cwral @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) <=> (cwss @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : ccat)))))))).
