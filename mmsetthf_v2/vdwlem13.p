...
thf(avdwap1_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XD @ ccn)) => ((cco @ XA2 @ XD @ (ccfv @ cc1 @ ccvdwa)) = (ccsn @ XA2)))))).
...
thf(avdwmc_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xa:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwcel @ (XX @ Xa @ Xc @ Xd) @ ccvv)))) => ((! [Xa:$i] : (! [Xd:$i] : ((Xph @ Xa @ Xd) => (cwcel @ XK @ ccn0)))) => ((! [Xa:$i] : (! [Xc:$i] : (! [Xd:$i] : ((Xph @ Xa @ Xd) => (cwf @ (XX @ Xa @ Xc @ Xd) @ (XR @ Xa @ Xc @ Xd) @ XF))))) => (! [Xa:$i] : (! [Xd:$i] : ((Xph @ Xa @ Xd) => ((cwbr @ XK @ XF @ ccvdwm) <=> (? [Xc:$i] : (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xd:$i] : (cwss @ (cco @ (ccv @ Xa) @ (ccv @ Xd) @ (ccfv @ XK @ ccvdwa)) @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xc))))) @ (^ [Xd:$i] : ccn))) @ (^ [Xa:$i] : ccn)))))))))))))))).
...
thf(avdwlem12_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XR @ ccfn)) => ((Xph => (cwf @ (cco @ cc1 @ (cco @ (ccfv @ XR @ cchash) @ cc1 @ ccaddc) @ ccfz) @ XR @ XF)) => ((Xph => (~ (cwbr @ cc2 @ XF @ ccvdwm))) => (~ Xph)))))))).
...
thf(avdwlem11_ax,axiom,(! [Xph:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : ((! [Xs1:$i] : ((Xph @ Xs1) => (cwcel @ XR @ ccfn))) => ((! [Xs1:$i] : ((Xph @ Xs1) => (cwcel @ XK @ (ccfv @ cc2 @ ccuz)))) => ((! [Xs1:$i] : ((Xph @ Xs1) => (cwral @ (^ [Xs1:$i] : (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xf1:$i] : (cwbr @ XK @ (ccv @ Xf1) @ ccvdwm)) @ (^ [Xf1:$i] : (cco @ (ccv @ Xs1) @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ ccmap)))) @ (^ [Xn:$i] : ccn))) @ (^ [Xs1:$i] : ccfn)))) => (! [Xs1:$i] : ((Xph @ Xs1) => (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xf1:$i] : (cwbr @ (cco @ XK @ cc1 @ ccaddc) @ (ccv @ Xf1) @ ccvdwm)) @ (^ [Xf1:$i] : (cco @ XR @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ ccmap)))) @ (^ [Xn:$i] : ccn))))))))))).
...
thf(cvdwlem13_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XR @ ccfn)) => ((Xph => (cwcel @ XK @ ccn0)) => (Xph => (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xf1:$i] : (cwbr @ XK @ (ccv @ Xf1) @ ccvdwm)) @ (^ [Xf1:$i] : (cco @ XR @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ ccmap)))) @ (^ [Xn:$i] : ccn))))))))).
