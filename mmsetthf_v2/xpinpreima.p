...
thf(afncnvima2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ XA2) => ((ccima @ (cccnv @ XF) @ XB2) = (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ XB2)) @ (^ [Xx3:$i] : XA2)))))))).
...
thf(axp2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccxp @ XA2 @ XB2) = (ccrab @ (^ [Xx3:$i] : ((cwcel @ (ccfv @ (ccv @ Xx3) @ cc1st) @ XA2) & (cwcel @ (ccfv @ (ccv @ Xx3) @ cc2nd) @ XB2))) @ (^ [Xx3:$i] : (ccxp @ ccvv @ ccvv))))))).
thf(cxpinpreima_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccxp @ XA2 @ XB2) = (ccin @ (ccima @ (cccnv @ (ccres @ cc1st @ (ccxp @ ccvv @ ccvv))) @ XA2) @ (ccima @ (cccnv @ (ccres @ cc2nd @ (ccxp @ ccvv @ ccvv))) @ XB2)))))).
