...
thf(anegsubdi3d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => (Xph => ((ccneg @ (cco @ XA2 @ XB2 @ ccmin)) = (cco @ (ccneg @ XA2) @ (ccneg @ XB2) @ ccmin))))))))).
