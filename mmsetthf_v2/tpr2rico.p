...
thf(afnovrn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwfn @ XF @ (ccxp @ XA2 @ XB2)) @ (cwcel @ XC @ XA2) @ (cwcel @ XD @ XB2)) => (cwcel @ (cco @ XC @ XD @ XF) @ (ccrn @ XF))))))))).
...
thf(acnre2csqima_ax,axiom,(! [XD:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccv @ Xx3) @ (cco @ cci @ (ccv @ Xy1) @ ccmul) @ ccaddc))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ (cwcel @ (XX @ Xx3 @ Xy1) @ (ccxp @ ccr @ ccr)) @ (cwcel @ (XY @ Xx3 @ Xy1) @ (ccxp @ ccr @ ccr)) @ (cwcel @ (XD @ Xx3 @ Xy1) @ ccrp)) => ((cwcel @ (XY @ Xx3 @ Xy1) @ (ccxp @ (cco @ (cco @ (ccfv @ (XX @ Xx3 @ Xy1) @ cc1st) @ (XD @ Xx3 @ Xy1) @ ccmin) @ (cco @ (ccfv @ (XX @ Xx3 @ Xy1) @ cc1st) @ (XD @ Xx3 @ Xy1) @ ccaddc) @ ccioo) @ (cco @ (cco @ (ccfv @ (XX @ Xx3 @ Xy1) @ cc2nd) @ (XD @ Xx3 @ Xy1) @ ccmin) @ (cco @ (ccfv @ (XX @ Xx3 @ Xy1) @ cc2nd) @ (XD @ Xx3 @ Xy1) @ ccaddc) @ ccioo))) => ((cwbr @ (ccfv @ (ccfv @ (cco @ (ccfv @ (XY @ Xx3 @ Xy1) @ (XF @ Xx3 @ Xy1)) @ (ccfv @ (XX @ Xx3 @ Xy1) @ (XF @ Xx3 @ Xy1)) @ ccmin) @ ccre) @ ccabs) @ (XD @ Xx3 @ Xy1) @ cclt) & (cwbr @ (ccfv @ (ccfv @ (cco @ (ccfv @ (XY @ Xx3 @ Xy1) @ (XF @ Xx3 @ Xy1)) @ (ccfv @ (XX @ Xx3 @ Xy1) @ (XF @ Xx3 @ Xy1)) @ ccmin) @ ccim) @ ccabs) @ (XD @ Xx3 @ Xy1) @ cclt)))))))))))).
...
thf(asqsscirc2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) & (cwcel @ XD @ ccrp)) => (((cwbr @ (ccfv @ (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccre) @ ccabs) @ (cco @ XD @ cc2 @ ccdiv) @ cclt) & (cwbr @ (ccfv @ (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccim) @ ccabs) @ (cco @ XD @ cc2 @ ccdiv) @ cclt)) => (cwbr @ (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccabs) @ XD @ cclt))))))).
...
thf(ahmeoima_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XF @ (cco @ XJ @ XK @ cchmeo)) & (cwcel @ XA2 @ XJ)) => (cwcel @ (ccima @ XF @ XA2) @ XK))))))).
thf(asimprbi_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph <=> (Xps & Xch)) => (Xph => Xch)))))).
thf(ccmopn_tp,type,(ccmopn : ($i > $o))).
thf(aelmopn2_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XJ @ Xx3 @ Xy1) = (ccfv @ XD @ ccmopn)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => ((cwcel @ XA2 @ (XJ @ Xx3 @ Xy1)) <=> ((cwss @ XA2 @ XX) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XD @ ccbl)) @ XA2)) @ (^ [Xy1:$i] : ccrp))) @ (^ [Xx3:$i] : XA2))))))))))))).
...
thf(ctpr2rico_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XJ:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xr:$i] : ((XJ @ Xy1 @ Xv @ Xu @ Xr) = (ccfv @ (ccrn @ ccioo) @ cctg)))))) => ((! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xr:$i] : ((XG @ Xy1 @ Xv @ Xu @ Xr) = (ccmpt2 @ (^ [Xu:$i] : (^ [Xv:$i] : ccr)) @ (^ [Xu:$i] : (^ [Xv:$i] : ccr)) @ (^ [Xu:$i] : (^ [Xv:$i] : (cco @ (ccv @ Xu) @ (cco @ cci @ (ccv @ Xv) @ ccmul) @ ccaddc))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : ((XB2 @ Xx3 @ Xy1 @ Xv @ Xu) = (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrn @ ccioo))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrn @ ccioo))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccxp @ (ccv @ Xx3) @ (ccv @ Xy1))))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : (! [Xr:$i] : (((cwcel @ (XA2 @ Xy1 @ Xv @ Xu) @ (cco @ (XJ @ Xy1 @ Xv @ Xu @ Xr) @ (XJ @ Xy1 @ Xv @ Xu @ Xr) @ cctx)) & (cwcel @ (XX @ Xv @ Xu) @ (XA2 @ Xy1 @ Xv @ Xu))) => (cwrex @ (^ [Xr:$i] : ((cwcel @ (XX @ Xv @ Xu) @ (ccv @ Xr)) & (cwss @ (ccv @ Xr) @ (XA2 @ Xy1 @ Xv @ Xu)))) @ (^ [Xr:$i] : (XB2 @ Xx3 @ Xy1 @ Xv @ Xu)))))))))))))))))).
