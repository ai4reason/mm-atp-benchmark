...
thf(a_3dec_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((ccdc @ (ccdc @ XA2 @ XB2) @ XC) = (cco @ (cco @ (cco @ (cco @ (ccdc @ cc1 @ ccc0) @ cc2 @ ccexp) @ XA2 @ ccmul) @ (cco @ (ccdc @ cc1 @ ccc0) @ XB2 @ ccmul) @ ccaddc) @ XC @ ccaddc)))))))).
thf(aoveq1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XC @ XF)))))))).
thf(aoveq12i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((XC = XD) => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XD @ XF)))))))))).
thf(asq10e99m1_ax,axiom,((cco @ (ccdc @ cc1 @ ccc0) @ cc2 @ ccexp) = (cco @ (ccdc @ cc9 @ cc9) @ cc1 @ ccaddc))).
