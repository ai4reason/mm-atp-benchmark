...
thf(aisf34lem1_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ XV) & (cwss @ (XX @ Xx3) @ XA2)) => ((ccfv @ (XX @ Xx3) @ (XF @ Xx3)) = (ccdif @ XA2 @ (XX @ Xx3))))))))))).
...
thf(aisfin3_3_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xf1:$i] : ((cwcel @ XA2 @ (XV @ Xf1)) => ((cwcel @ XA2 @ ccfin3) <=> (cwral @ (^ [Xf1:$i] : ((cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)))) @ (^ [Xx3:$i] : ccom)) => (cwcel @ (ccint @ (ccrn @ (ccv @ Xf1))) @ (ccrn @ (ccv @ Xf1))))) @ (^ [Xf1:$i] : (cco @ (ccpw @ XA2) @ ccom @ ccmap))))))))).
