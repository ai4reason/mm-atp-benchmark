...
thf(csubgsub_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_mi = (ccfv @ XG @ ccsg)) => ((XH = (cco @ XG @ XS @ ccress)) => ((XN = (ccfv @ XH @ ccsg)) => ((cw3a @ (cwcel @ XS @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XX @ XS) @ (cwcel @ XY @ XS)) => ((cco @ XX @ XY @ Xc_mi) = (cco @ XX @ XY @ XN)))))))))))))).
