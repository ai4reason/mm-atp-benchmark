...
thf(aeel2122old_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (((Xph & Xps) => Xch) => ((Xps => Xth) => ((Xps => Xta) => (((cw3a @ Xch @ Xth @ Xta) => Xet) => ((Xph & Xps) => Xet)))))))))))).
thf(a_3expia_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((cw3a @ Xph @ Xps @ Xch) => Xth) => ((Xph & Xps) => (Xch => Xth)))))))).
thf(aeel0321old_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (Xph => (((cw3a @ Xps @ Xch @ Xth) => Xta) => (((Xph & Xta) => Xet) => ((cw3a @ Xps @ Xch @ Xth) => Xet))))))))))).
