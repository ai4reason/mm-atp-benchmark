...
thf(aeven2n_ax,axiom,(! [XN:($i > $o)] : ((cwbr @ cc2 @ XN @ ccdvds) <=> (cwrex @ (^ [Xn:$i] : ((cco @ cc2 @ (ccv @ Xn) @ ccmul) = XN)) @ (^ [Xn:$i] : ccz))))).
thf(cevennn02n_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cwbr @ cc2 @ XN @ ccdvds) <=> (cwrex @ (^ [Xn:$i] : ((cco @ cc2 @ (ccv @ Xn) @ ccmul) = XN)) @ (^ [Xn:$i] : ccn0)))))).
