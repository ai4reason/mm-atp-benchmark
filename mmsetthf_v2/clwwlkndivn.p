...
thf(afusgrhashclwwlkn_ax,axiom,(! [Xc_sm:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((! [Xt:$i] : (XW = (cco @ XN @ (XG @ Xt) @ ccclwwlkn))) => ((! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : ((Xc_sm @ Xu @ Xt @ Xn) = (ccopab @ (^ [Xt:$i] : (^ [Xu:$i] : (cw3a @ (cwcel @ (ccv @ Xt) @ XW) @ (cwcel @ (ccv @ Xu) @ XW) @ (cwrex @ (^ [Xn:$i] : ((ccv @ Xt) = (cco @ (ccv @ Xu) @ (ccv @ Xn) @ cccsh))) @ (^ [Xn:$i] : (cco @ ccc0 @ XN @ ccfz))))))))))) => (! [Xu:$i] : (! [Xt:$i] : (! [Xn:$i] : (((cwcel @ (XG @ Xt) @ ccfusgr) & (cwcel @ XN @ ccprime)) => ((ccfv @ XW @ cchash) = (cco @ (ccfv @ (ccqs @ XW @ (Xc_sm @ Xu @ Xt @ Xn)) @ cchash) @ XN @ ccmul))))))))))))).
thf(cclwwlkndivn_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XG @ ccfusgr) & (cwcel @ XN @ ccprime)) => (cwbr @ XN @ (ccfv @ (cco @ XN @ XG @ ccclwwlkn) @ cchash) @ ccdvds))))).
