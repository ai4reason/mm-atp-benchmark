...
thf(adfif6_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccif @ Xph @ XA2 @ XB2) = (ccun @ (ccrab @ (^ [Xx3:$i] : Xph) @ (^ [Xx3:$i] : XA2)) @ (ccrab @ (^ [Xx3:$i] : (~ Xph)) @ (^ [Xx3:$i] : XB2)))))))).
...
thf(anotab_ax,axiom,(! [Xph:($i > $o)] : ((ccab @ (^ [Xx3:$i] : (~ (Xph @ Xx3)))) = (ccdif @ ccvv @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3))))))).
thf(adifeq2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((ccdif @ XC @ XA2) = (ccdif @ XC @ XB2))))))).
thf(cdfif3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((! [Xx3:$i] : ((XC @ Xx3) = (ccab @ (^ [Xx3:$i] : Xph)))) => (! [Xx3:$i] : ((ccif @ Xph @ (XA2 @ Xx3) @ (XB2 @ Xx3)) = (ccun @ (ccin @ (XA2 @ Xx3) @ (XC @ Xx3)) @ (ccin @ (XB2 @ Xx3) @ (ccdif @ ccvv @ (XC @ Xx3)))))))))))).
