...
thf(amatsubg_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XG = (cco @ XR @ (ccxp @ XN @ XN) @ ccfrlm)) => (((cwcel @ XN @ ccfn) & (cwcel @ XR @ XV)) => ((ccfv @ XG @ ccsg) = (ccfv @ XA2 @ ccsg))))))))))).
...
thf(cmatsubgcell_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XS = (ccfv @ XA2 @ ccsg)) => ((Xc_mi = (ccfv @ XR @ ccsg)) => ((cw3a @ (cwcel @ XR @ ccrg) @ ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) @ ((cwcel @ XI @ XN) & (cwcel @ XJ @ XN))) => ((cco @ XI @ XJ @ (cco @ XX @ XY @ XS)) = (cco @ (cco @ XI @ XJ @ XX) @ (cco @ XI @ XJ @ XY) @ Xc_mi)))))))))))))))))).
