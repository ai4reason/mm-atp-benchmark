...
thf(arnghmresel_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (XH = (ccres @ ccrngh @ (ccxp @ XB2 @ XB2)))) => ((cw3a @ Xph @ ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) @ (cwcel @ XF @ (cco @ XX @ XY @ XH))) => (cwcel @ XF @ (cco @ XX @ XY @ ccrngh))))))))))).
