...
thf(afacndiv_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn)) & ((cwbr @ cc1 @ XN @ cclt) & (cwbr @ XN @ XM @ ccle))) => (~ (cwcel @ (cco @ (cco @ (ccfv @ XM @ ccfa) @ cc1 @ ccaddc) @ XN @ ccdiv) @ ccz)))))).
...
thf(anndivtr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccn) @ (cwcel @ XC @ ccc)) & ((cwcel @ (cco @ XB2 @ XA2 @ ccdiv) @ ccn) & (cwcel @ (cco @ XC @ XB2 @ ccdiv) @ ccn))) => (cwcel @ (cco @ XC @ XA2 @ ccdiv) @ ccn)))))).
...
thf(aprime_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => ((cwral @ (^ [Xx3:$i] : ((cwcel @ (cco @ XA2 @ (ccv @ Xx3) @ ccdiv) @ ccn) => (((ccv @ Xx3) = cc1) | ((ccv @ Xx3) = XA2)))) @ (^ [Xx3:$i] : ccn)) <=> (cwral @ (^ [Xx3:$i] : ((cw3a @ (cwbr @ cc1 @ (ccv @ Xx3) @ cclt) @ (cwbr @ (ccv @ Xx3) @ XA2 @ ccle) @ (cwcel @ (cco @ XA2 @ (ccv @ Xx3) @ ccdiv) @ ccn)) => ((ccv @ Xx3) = XA2))) @ (^ [Xx3:$i] : ccn)))))).
thf(cinfpnlem1_conj,conjecture,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XK = (cco @ (ccfv @ XN @ ccfa) @ cc1 @ ccaddc)) => (((cwcel @ XN @ ccn) & (cwcel @ XM @ ccn)) => ((((cwbr @ cc1 @ XM @ cclt) & (cwcel @ (cco @ XK @ XM @ ccdiv) @ ccn)) & (cwral @ (^ [Xj:$i] : (((cwbr @ cc1 @ (ccv @ Xj) @ cclt) & (cwcel @ (cco @ XK @ (ccv @ Xj) @ ccdiv) @ ccn)) => (cwbr @ XM @ (ccv @ Xj) @ ccle))) @ (^ [Xj:$i] : ccn))) => ((cwbr @ XN @ XM @ cclt) & (cwral @ (^ [Xj:$i] : ((cwcel @ (cco @ XM @ (ccv @ Xj) @ ccdiv) @ ccn) => (((ccv @ Xj) = cc1) | ((ccv @ Xj) = XM)))) @ (^ [Xj:$i] : ccn)))))))))).
