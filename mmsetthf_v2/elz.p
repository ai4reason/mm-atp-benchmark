...
thf(adf_z_ax,axiom,(ccz = (ccrab @ (^ [Xn:$i] : (cw3o @ ((ccv @ Xn) = ccc0) @ (cwcel @ (ccv @ Xn) @ ccn) @ (cwcel @ (ccneg @ (ccv @ Xn)) @ ccn))) @ (^ [Xn:$i] : ccr)))).
thf(celz_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) <=> ((cwcel @ XN @ ccr) & (cw3o @ (XN = ccc0) @ (cwcel @ XN @ ccn) @ (cwcel @ (ccneg @ XN) @ ccn)))))).
