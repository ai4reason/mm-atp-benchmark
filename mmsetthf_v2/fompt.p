...
thf(adffo3f_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => (! [Xx3:$i] : ((cwfo @ XA2 @ XB2 @ (XF @ Xx3)) <=> ((cwf @ XA2 @ XB2 @ (XF @ Xx3)) & (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xy1) = (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)))) @ (^ [Xx3:$i] : XA2))) @ (^ [Xy1:$i] : XB2)))))))))).
...
thf(afoelrnf_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => (! [Xx3:$i] : (((cwfo @ XA2 @ XB2 @ (XF @ Xx3)) & (cwcel @ XC @ XB2)) => (cwrex @ (^ [Xx3:$i] : (XC = (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)))) @ (^ [Xx3:$i] : XA2)))))))))).
...
thf(anffo_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => (cwnf @ (^ [Xx3:$i] : (cwfo @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ (XF @ Xx3))))))))))).
...
thf(cfompt_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))))) => (! [Xx3:$i] : ((cwfo @ XA2 @ XB2 @ (XF @ Xx3)) <=> ((cwral @ (^ [Xx3:$i] : (cwcel @ (XC @ Xx3) @ XB2)) @ (^ [Xx3:$i] : XA2)) & (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xx3:$i] : ((ccv @ Xy1) = (XC @ Xx3))) @ (^ [Xx3:$i] : XA2))) @ (^ [Xy1:$i] : XB2))))))))))).
