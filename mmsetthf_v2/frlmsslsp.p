...
thf(auvcresum_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XU = (cco @ XR @ XI @ ccuvc)) => ((XY = (cco @ XR @ XI @ ccfrlm)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xc_x = (ccfv @ XY @ ccvsca)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XI @ XW) @ (cwcel @ XX @ XB2)) => (XX = (cco @ XY @ (cco @ XX @ XU @ (ccof @ Xc_x)) @ ccgsu)))))))))))))))).
thf(ccsubmnd_tp,type,(ccsubmnd : ($i > $o))).
thf(cccmn_tp,type,(cccmn : ($i > $o))).
thf(agsumsubgcl_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XS @ (ccfv @ XG @ ccsubg))) => ((Xph => (cwf @ XA2 @ XS @ XF)) => ((Xph => (cwbr @ XF @ Xc_0 @ ccfsupp)) => (Xph => (cwcel @ (cco @ XG @ XF @ ccgsu) @ XS)))))))))))))))).
