...
thf(akerf1hrm_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (ccfv @ XR @ ccbs)) => ((XB2 = (ccfv @ XS @ ccbs)) => ((XN = (ccfv @ XR @ cc0g)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => ((cwcel @ XF @ (cco @ XR @ XS @ ccrh)) => ((cwf1 @ XA2 @ XB2 @ XF) <=> ((ccima @ (cccnv @ XF) @ (ccsn @ Xc_0)) = (ccsn @ XN)))))))))))))))).
