...
thf(afunfni_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((((cwfun @ XF) & (cwcel @ XB2 @ (ccdm @ XF))) => Xph) => (((cwfn @ XF @ XA2) & (cwcel @ XB2 @ XA2)) => Xph))))))).
...
thf(celpreima_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ XA2) => ((cwcel @ XB2 @ (ccima @ (cccnv @ XF) @ XC)) <=> ((cwcel @ XB2 @ XA2) & (cwcel @ (ccfv @ XB2 @ XF) @ XC))))))))).
