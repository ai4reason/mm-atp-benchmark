...
thf(arefrelcosslem_ax,axiom,(! [XR:($i > ($i > $o))] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xx3) @ (cccoss @ (XR @ Xx3)))) @ (^ [Xx3:$i] : (ccdm @ (cccoss @ (XR @ Xx3))))))).
thf(ccxp_tp,type,(ccxp : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccid_tp,type,(ccid : ($i > $o))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(aidinxpssinxp4_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) <=> (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xx3) @ XR)) @ (^ [Xx3:$i] : XA2)))))).
...
thf(arncossdmcoss_ax,axiom,(! [XR:($i > $o)] : ((ccrn @ (cccoss @ XR)) = (ccdm @ (cccoss @ XR))))).
