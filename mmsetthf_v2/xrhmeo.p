...
thf(axle0neg1_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccxr) => ((cwbr @ XA2 @ ccc0 @ ccle) <=> (cwbr @ ccc0 @ (ccxne @ XA2) @ ccle))))).
...
thf(aiccneg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc)) <=> (cwcel @ (ccneg @ XC) @ (cco @ (ccneg @ XB2) @ (ccneg @ XA2) @ ccicc)))))))).
...
thf(axle0neg2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccxr) => ((cwbr @ ccc0 @ XA2 @ ccle) <=> (cwbr @ (ccxne @ XA2) @ ccc0 @ ccle))))).
...
thf(axlt0neg2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccxr) => ((cwbr @ ccc0 @ XA2 @ cclt) <=> (cwbr @ (ccxne @ XA2) @ ccc0 @ cclt))))).
...
thf(axnegex_ax,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccxne @ XA2) @ ccvv))).
