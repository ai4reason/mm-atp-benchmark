...
thf(afrins2g_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((! [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ XA2) => ((cwral @ (^ [Xz:$i] : (Xps @ Xz)) @ (^ [Xz:$i] : (ccpred @ XA2 @ XR @ (ccv @ Xy1)))) => (Xph @ Xy1)))) => ((! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xy1) = (ccv @ Xz)) => ((Xph @ Xy1) <=> (Xps @ Xz))))) => (((cwfr @ XA2 @ XR) & (cwse @ XA2 @ XR)) => (cwral @ (^ [Xy1:$i] : (Xph @ Xy1)) @ (^ [Xy1:$i] : XA2)))))))))).
thf(asyl5_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xch => (Xps => Xth)) => (Xch => (Xph => Xth))))))))).
thf(ara4v_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((cwral @ (^ [Xx3:$i] : (Xph => (Xps @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (Xph => (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))).
...
thf(cfrr3g_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cw3a @ ((cwfr @ XA2 @ XR) & (cwse @ XA2 @ XR)) @ ((cwfn @ XF @ XA2) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ XF) = (cco @ (ccv @ Xy1) @ (ccres @ XF @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ XH))) @ (^ [Xy1:$i] : XA2))) @ ((cwfn @ XG @ XA2) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccv @ Xy1) @ XG) = (cco @ (ccv @ Xy1) @ (ccres @ XG @ (ccpred @ XA2 @ XR @ (ccv @ Xy1))) @ XH))) @ (^ [Xy1:$i] : XA2)))) => (XF = XG)))))))).
