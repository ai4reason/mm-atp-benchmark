...
thf(achintcli_ax,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccch) & (cwne @ XA2 @ cc0)) => (cwcel @ (ccint @ XA2) @ ccch)))).
...
thf(cchintcl_conj,conjecture,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccch) & (cwne @ XA2 @ cc0)) => (cwcel @ (ccint @ XA2) @ ccch)))).
