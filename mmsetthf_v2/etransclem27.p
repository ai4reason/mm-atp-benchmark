...
thf(aetransclem20_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xj:$i] : (Xph => (cwcel @ (XS @ Xj) @ (ccpr @ ccr @ ccc)))) => ((! [Xj:$i] : (Xph => (cwcel @ XX @ (cco @ (ccfv @ cccnfld @ cctopn) @ (XS @ Xj) @ ccrest)))) => ((Xph => (cwcel @ XP @ ccn)) => ((! [Xx3:$i] : (! [Xj:$i] : ((XH @ Xx3 @ Xj) = (ccmpt @ (^ [Xj:$i] : (cco @ ccc0 @ XM @ ccfz)) @ (^ [Xj:$i] : (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ (ccif @ ((ccv @ Xj) = ccc0) @ (cco @ XP @ cc1 @ ccmin) @ XP) @ ccexp)))))))) => ((Xph => (cwcel @ XJ @ (cco @ ccc0 @ XM @ ccfz))) => ((! [Xj:$i] : (Xph => (cwcel @ (XN @ Xj) @ ccn0))) => (! [Xx3:$i] : (! [Xj:$i] : (Xph => (cwf @ XX @ ccc @ (ccfv @ (XN @ Xj) @ (cco @ (XS @ Xj) @ (ccfv @ XJ @ (XH @ Xx3 @ Xj)) @ ccdvn))))))))))))))))))))).
...
thf(aetransclem21_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xj:$i] : (Xph => (cwcel @ (XS @ Xj) @ (ccpr @ ccr @ ccc)))) => ((! [Xj:$i] : (Xph => (cwcel @ XX @ (cco @ (ccfv @ cccnfld @ cctopn) @ (XS @ Xj) @ ccrest)))) => ((Xph => (cwcel @ XP @ ccn)) => ((! [Xx3:$i] : (! [Xj:$i] : ((XH @ Xx3 @ Xj) = (ccmpt @ (^ [Xj:$i] : (cco @ ccc0 @ XM @ ccfz)) @ (^ [Xj:$i] : (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ (ccif @ ((ccv @ Xj) = ccc0) @ (cco @ XP @ cc1 @ ccmin) @ XP) @ ccexp)))))))) => ((Xph => (cwcel @ XJ @ (cco @ ccc0 @ XM @ ccfz))) => ((! [Xj:$i] : (Xph => (cwcel @ (XN @ Xj) @ ccn0))) => ((! [Xj:$i] : (Xph => (cwcel @ (XY @ Xj) @ XX))) => (! [Xx3:$i] : (! [Xj:$i] : (Xph => ((ccfv @ (XY @ Xj) @ (ccfv @ (XN @ Xj) @ (cco @ (XS @ Xj) @ (ccfv @ XJ @ (XH @ Xx3 @ Xj)) @ ccdvn))) = (ccif @ (cwbr @ (ccif @ (XJ = ccc0) @ (cco @ XP @ cc1 @ ccmin) @ XP) @ (XN @ Xj) @ cclt) @ ccc0 @ (cco @ (cco @ (ccfv @ (ccif @ (XJ = ccc0) @ (cco @ XP @ cc1 @ ccmin) @ XP) @ ccfa) @ (ccfv @ (cco @ (ccif @ (XJ = ccc0) @ (cco @ XP @ cc1 @ ccmin) @ XP) @ (XN @ Xj) @ ccmin) @ ccfa) @ ccdiv) @ (cco @ (cco @ (XY @ Xj) @ XJ @ ccmin) @ (cco @ (ccif @ (XJ = ccc0) @ (cco @ XP @ cc1 @ ccmin) @ XP) @ (XN @ Xj) @ ccmin) @ ccexp) @ ccmul))))))))))))))))))))))).
...
thf(apermnn_ax,axiom,(! [XR:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XR @ (cco @ ccc0 @ XN @ ccfz)) => (cwcel @ (cco @ (ccfv @ XN @ ccfa) @ (ccfv @ XR @ ccfa) @ ccdiv) @ ccn))))).
...
thf(cetransclem27_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xj:$i] : (! [Xl:$i] : (Xph => (cwcel @ (XS @ Xj @ Xl) @ (ccpr @ ccr @ ccc))))) => ((! [Xj:$i] : (! [Xl:$i] : (Xph => (cwcel @ (XX @ Xl) @ (cco @ (ccfv @ cccnfld @ cctopn) @ (XS @ Xj @ Xl) @ ccrest))))) => ((! [Xl:$i] : (Xph => (cwcel @ (XP @ Xl) @ ccn))) => ((! [Xj:$i] : (! [Xl:$i] : ((XH @ Xj @ Xl) = (ccmpt @ (^ [Xj:$i] : (cco @ ccc0 @ (XM @ Xl) @ ccfz)) @ (^ [Xj:$i] : (ccmpt @ (^ [Xx3:$i] : (XX @ Xl)) @ (^ [Xx3:$i] : (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xj) @ ccmin) @ (ccif @ ((ccv @ Xj) = ccc0) @ (cco @ (XP @ Xl) @ cc1 @ ccmin) @ (XP @ Xl)) @ ccexp)))))))) => ((Xph => (cwcel @ XC @ ccfn)) => ((! [Xl:$i] : (Xph => (cwf @ (ccdm @ XC) @ (cco @ ccn0 @ (cco @ ccc0 @ (XM @ Xl) @ ccfz) @ ccmap) @ XC))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xl:$i] : ((XG @ Xx3 @ Xj @ Xl) = (ccmpt @ (^ [Xx3:$i] : (XX @ Xl)) @ (^ [Xx3:$i] : (ccsu @ (ccdm @ XC) @ (^ [Xl:$i] : (ccprod @ (^ [Xj:$i] : (cco @ ccc0 @ (XM @ Xl) @ ccfz)) @ (^ [Xj:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccfv @ (ccv @ Xj) @ (ccfv @ (ccv @ Xl) @ XC)) @ (cco @ (XS @ Xj @ Xl) @ (ccfv @ (ccv @ Xj) @ (XH @ Xj @ Xl)) @ ccdvn))))))))))))) => ((! [Xl:$i] : (Xph => (cwcel @ XJ @ (XX @ Xl)))) => ((Xph => (cwcel @ XJ @ ccz)) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xl:$i] : (Xph => (cwcel @ (ccfv @ XJ @ (XG @ Xx3 @ Xj @ Xl)) @ ccz)))))))))))))))))))))))).
