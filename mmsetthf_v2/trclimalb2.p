...
thf(aimaiun1_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : ((ccima @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XC) = (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (ccima @ (XB2 @ Xx3) @ XC)))))))).
...
thf(ctrclimalb2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XR @ XV) & (cwss @ (ccima @ XR @ (ccun @ XA2 @ XB2)) @ XB2)) => (cwss @ (ccima @ (ccfv @ XR @ cctcl) @ XA2) @ XB2))))))).
