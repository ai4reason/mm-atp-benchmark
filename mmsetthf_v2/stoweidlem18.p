...
thf(cstoweidlem18_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : ((! [Xa:$i] : (cwnfc @ (^ [Xt:$i] : (XD @ Xt @ Xa)))) => ((! [Xx3:$i] : (cwnf @ (^ [Xt:$i] : (Xph @ Xx3 @ Xt)))) => ((! [Xt:$i] : (! [Xa:$i] : ((XF @ Xt @ Xa) = (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : cc1))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xa:$i] : (XT = (ccuni @ (XJ @ Xx3 @ Xt @ Xa)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xa:$i] : (((Xph @ Xx3 @ Xt) & (cwcel @ (ccv @ Xa) @ ccr)) => (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccv @ Xa))) @ (XA2 @ Xt)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xt) => (cwcel @ (XB2 @ Xt @ Xa) @ (ccfv @ (XJ @ Xx3 @ Xt @ Xa) @ cccld)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xt) => (cwcel @ (XE @ Xt @ Xa) @ ccrp))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xt) => ((XD @ Xt @ Xa) = cc0))))) => (! [Xx3:$i] : (! [Xt:$i] : (! [Xa:$i] : ((Xph @ Xx3 @ Xt) => (cwrex @ (^ [Xx3:$i] : (cw3a @ (cwral @ (^ [Xt:$i] : ((cwbr @ ccc0 @ (ccfv @ (ccv @ Xt) @ (ccv @ Xx3)) @ ccle) & (cwbr @ (ccfv @ (ccv @ Xt) @ (ccv @ Xx3)) @ cc1 @ ccle))) @ (^ [Xt:$i] : XT)) @ (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (ccv @ Xt) @ (ccv @ Xx3)) @ (XE @ Xt @ Xa) @ cclt)) @ (^ [Xt:$i] : (XD @ Xt @ Xa))) @ (cwral @ (^ [Xt:$i] : (cwbr @ (cco @ cc1 @ (XE @ Xt @ Xa) @ ccmin) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xx3)) @ cclt)) @ (^ [Xt:$i] : (XB2 @ Xt @ Xa))))) @ (^ [Xx3:$i] : (XA2 @ Xt)))))))))))))))))))))))).
