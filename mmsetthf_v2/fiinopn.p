...
thf(aistop2g_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : ((cwcel @ XJ @ XA2) => ((cwcel @ XJ @ cctop) <=> ((! [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XJ) => (cwcel @ (ccuni @ (ccv @ Xx3)) @ XJ))) & (! [Xx3:$i] : ((cw3a @ (cwss @ (ccv @ Xx3) @ XJ) @ (cwne @ (ccv @ Xx3) @ cc0) @ (cwcel @ (ccv @ Xx3) @ ccfn)) => (cwcel @ (ccint @ (ccv @ Xx3)) @ XJ))))))))).
thf(cfiinopn_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : ((cwcel @ XJ @ cctop) => ((cw3a @ (cwss @ XA2 @ XJ) @ (cwne @ XA2 @ cc0) @ (cwcel @ XA2 @ ccfn)) => (cwcel @ (ccint @ XA2) @ XJ)))))).
