...
thf(afun2cnv_ax,axiom,(! [XA2:($i > $o)] : ((cwfun @ (cccnv @ (cccnv @ XA2))) <=> (! [Xx3:$i] : (cwmo @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XA2))))))).
...
thf(aalrot4_ax,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw))))) <=> (! [Xz:$i] : (! [Xw:$i] : (! [Xx3:$i] : (! [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz @ Xw)))))))).
