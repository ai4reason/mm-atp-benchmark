...
thf(alimsupcld_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XF @ XV)) => (Xph => (cwcel @ (ccfv @ XF @ cclsp) @ ccxr))))))).
thf(afexd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwcel @ XA2 @ XC)) => (Xph => (cwcel @ XF @ ccvv)))))))))).
...
thf(aliminflelimsupuz_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XM @ ccz)) => ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwf @ XZ @ ccxr @ XF)) => (Xph => (cwbr @ (ccfv @ XF @ cclsi) @ (ccfv @ XF @ cclsp) @ ccle)))))))))).
...
thf(climinflimsupclim_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XM @ ccz)) => ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwf @ XZ @ ccr @ XF)) => ((Xph => (cwcel @ (ccfv @ XF @ cclsi) @ ccr)) => ((Xph => (cwbr @ (ccfv @ XF @ cclsp) @ (ccfv @ XF @ cclsi) @ ccle)) => (Xph => (cwcel @ XF @ (ccdm @ ccli))))))))))))).
