...
thf(aisbndx_ax,axiom,(! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XM @ (ccfv @ XX @ ccbnd)) <=> ((cwcel @ XM @ (ccfv @ XX @ ccxmt)) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xr:$i] : (XX = (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ (ccfv @ XM @ ccbl)))) @ (^ [Xr:$i] : ccrp))) @ (^ [Xx3:$i] : XX))))))).
...
thf(cisbnd2_conj,conjecture,(! [XM:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XM @ (ccfv @ XX @ ccbnd)) & (cwne @ XX @ cc0)) <=> ((cwcel @ XM @ (ccfv @ XX @ ccxmt)) & (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xr:$i] : (XX = (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ (ccfv @ XM @ ccbl)))) @ (^ [Xr:$i] : ccrp))) @ (^ [Xx3:$i] : XX))))))).
