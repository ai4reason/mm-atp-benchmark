...
thf(auhgr0e_ax,axiom,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XG @ XW)) => ((Xph => ((ccfv @ XG @ cciedg) = cc0)) => (Xph => (cwcel @ XG @ ccuhgr)))))))).
thf(asimpl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xph)))).
thf(asimpr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(cuhgr0vb_conj,conjecture,(! [XG:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XG @ XW) & ((ccfv @ XG @ ccvtx) = cc0)) => ((cwcel @ XG @ ccuhgr) <=> ((ccfv @ XG @ cciedg) = cc0)))))).
