...
thf(cnrmsep2_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (((cwcel @ XJ @ ccnrm) & (cw3a @ (cwcel @ XC @ (ccfv @ XJ @ cccld)) @ (cwcel @ XD @ (ccfv @ XJ @ cccld)) @ ((ccin @ XC @ XD) = cc0))) => (cwrex @ (^ [Xx3:$i] : ((cwss @ XC @ (ccv @ Xx3)) & ((ccin @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XJ @ cccl)) @ XD) = cc0))) @ (^ [Xx3:$i] : XJ))))))).
