...
thf(cdvcosax_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ ccc @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ cccos))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccneg @ (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ ccsin)) @ ccmul))))))).
