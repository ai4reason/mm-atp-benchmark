...
thf(aslmdvs0_ax,axiom,(! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => (((cwcel @ XW @ ccslmd) & (cwcel @ XX @ XK)) => ((cco @ XX @ Xc_0 @ Xc_x) = Xc_0))))))))))))).
