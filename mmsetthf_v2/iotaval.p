...
thf(asbeqalb_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => (((! [Xx3:$i] : ((Xph @ Xx3) <=> ((ccv @ Xx3) = XA2))) & (! [Xx3:$i] : ((Xph @ Xx3) <=> ((ccv @ Xx3) = XB2)))) => (XA2 = XB2))))))))).
...
thf(auniabio_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xy1:$i] : ((! [Xx3:$i] : ((Xph @ Xx3 @ Xy1) <=> ((ccv @ Xx3) = (ccv @ Xy1)))) => ((ccuni @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))) = (ccv @ Xy1)))))).
