...
thf(acompss_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : ((ccima @ (XF @ Xx3) @ (XG @ Xx3)) = (ccrab @ (^ [Xy1:$i] : (cwcel @ (ccdif @ XA2 @ (ccv @ Xy1)) @ (XG @ Xx3))) @ (^ [Xy1:$i] : (ccpw @ XA2)))))))))).
thf(cisf34lem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ XV) & ((cwss @ (XX @ Xx3) @ (ccpw @ XA2)) & (cwne @ (XX @ Xx3) @ cc0))) => ((ccfv @ (ccuni @ (XX @ Xx3)) @ (XF @ Xx3)) = (ccint @ (ccima @ (XF @ Xx3) @ (XX @ Xx3)))))))))))).
