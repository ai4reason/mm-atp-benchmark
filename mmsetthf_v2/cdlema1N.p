...
thf(alatjlej12_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((cw3a @ (cwcel @ XK @ cclat) @ ((cwcel @ XX @ XB2) & (cwcel @ XY @ XB2)) @ ((cwcel @ XZ @ XB2) & (cwcel @ XW @ XB2))) => (((cwbr @ XX @ XY @ Xc_le) & (cwbr @ XZ @ XW @ Xc_le)) => (cwbr @ (cco @ XX @ XZ @ Xc_or) @ (cco @ XY @ XW @ Xc_or) @ Xc_le))))))))))))))).
...
thf(ccdlema1N_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XN = (ccfv @ XK @ cclines)) => ((XF = (ccfv @ XK @ ccpmap)) => ((cw3a @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) @ (cw3a @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2) @ (cwcel @ XR @ XA2)) @ (cw3a @ ((cwne @ XR @ XP) & (cwbr @ XR @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)) @ ((cwbr @ XP @ XX @ Xc_le) & (cwbr @ XQ @ XY @ Xc_le)) @ (cw3a @ (cwcel @ (ccfv @ XY @ XF) @ XN) @ (cwcel @ (cco @ XX @ XY @ Xc_an) @ XA2) @ (~ (cwbr @ XQ @ XX @ Xc_le))))) => ((cco @ XX @ XR @ Xc_or) = (cco @ XX @ XY @ Xc_or)))))))))))))))))))))))).
