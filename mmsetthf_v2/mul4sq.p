...
thf(a_4sqlem4_ax,axiom,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XS @ Xx3 @ Xy1 @ Xz @ Xw) = (ccab @ (^ [Xn:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : ((ccv @ Xn) = (cco @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ (cco @ (ccv @ Xw) @ cc2 @ ccexp) @ ccaddc) @ ccaddc))) @ (^ [Xw:$i] : ccz))) @ (^ [Xz:$i] : ccz))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((cwcel @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw) @ (XS @ Xx3 @ Xy1 @ Xz @ Xw)) <=> (cwrex @ (^ [Xu:$i] : (cwrex @ (^ [Xv:$i] : ((XA2 @ Xx3 @ Xy1 @ Xz @ Xw) = (cco @ (cco @ (ccfv @ (ccv @ Xu) @ ccabs) @ cc2 @ ccexp) @ (cco @ (ccfv @ (ccv @ Xv) @ ccabs) @ cc2 @ ccexp) @ ccaddc))) @ (^ [Xv:$i] : ccgz))) @ (^ [Xu:$i] : ccgz))))))))))).
...
thf(agzsubcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccgz) & (cwcel @ XB2 @ ccgz)) => (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ ccgz))))).
...
thf(cmul4sq_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XS @ Xx3 @ Xy1 @ Xz @ Xw) = (ccab @ (^ [Xn:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : ((ccv @ Xn) = (cco @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ (cco @ (ccv @ Xw) @ cc2 @ ccexp) @ ccaddc) @ ccaddc))) @ (^ [Xw:$i] : ccz))) @ (^ [Xz:$i] : ccz))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (((cwcel @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw) @ (XS @ Xx3 @ Xy1 @ Xz @ Xw)) & (cwcel @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xw) @ (XS @ Xx3 @ Xy1 @ Xz @ Xw))) => (cwcel @ (cco @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw) @ (XB2 @ Xx3 @ Xy1 @ Xz @ Xw) @ ccmul) @ (XS @ Xx3 @ Xy1 @ Xz @ Xw)))))))))))).
