...
thf(afmtno4prmfac_ax,axiom,(! [XP:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprime) @ (cwbr @ XP @ (ccfv @ cc4 @ ccfmtno) @ ccdvds) @ (cwbr @ XP @ (ccfv @ (ccfv @ (ccfv @ cc4 @ ccfmtno) @ ccsqrt) @ ccfl) @ ccle)) => (cw3o @ (XP = (ccdc @ cc6 @ cc5)) @ (XP = (ccdc @ (ccdc @ cc1 @ cc2) @ cc9)) @ (XP = (ccdc @ (ccdc @ cc1 @ cc9) @ cc3)))))).
...
thf(cfmtno4prmfac193_conj,conjecture,(! [XP:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprime) @ (cwbr @ XP @ (ccfv @ cc4 @ ccfmtno) @ ccdvds) @ (cwbr @ XP @ (ccfv @ (ccfv @ (ccfv @ cc4 @ ccfmtno) @ ccsqrt) @ ccfl) @ ccle)) => (XP = (ccdc @ (ccdc @ cc1 @ cc9) @ cc3))))).
