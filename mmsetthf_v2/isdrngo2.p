...
thf(advrunz_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XH = (ccfv @ XR @ cc2nd)) => ((XX = (ccrn @ XG)) => ((XZ = (ccfv @ XG @ ccgi)) => ((XU = (ccfv @ XH @ ccgi)) => ((cwcel @ XR @ ccdrng) => (cwne @ XU @ XZ)))))))))))))).
...
thf(agrpomndo_ax,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ ccgr) => (cwcel @ XG @ ccmndo)))).
thf(ccsem_tp,type,(ccsem : ($i > $o))).
thf(amndoismgmOLD_ax,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ ccmndo) => (cwcel @ XG @ ccmagm)))).
thf(aexidresid_ax,axiom,(! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccrn @ XG)) => ((XU = (ccfv @ XG @ ccgi)) => ((XH = (ccres @ XG @ (ccxp @ XY @ XY))) => (((cw3a @ (cwcel @ XG @ (ccin @ ccmagm @ ccexid)) @ (cwss @ XY @ XX) @ (cwcel @ XU @ XY)) & (cwcel @ XH @ ccmagm)) => ((ccfv @ XH @ ccgi) = XU))))))))))).
...
thf(aisgrpda_ax,axiom,(! [Xph:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XX @ ccvv))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwf @ (ccxp @ XX @ XX) @ XX @ XG))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xn:$i] : (((Xph @ Xn) & (cw3a @ (cwcel @ (ccv @ Xx3) @ XX) @ (cwcel @ (ccv @ Xy1) @ XX) @ (cwcel @ (ccv @ Xz) @ XX))) => ((cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XG) @ (ccv @ Xz) @ XG) = (cco @ (ccv @ Xx3) @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XG) @ XG))))))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XU @ XX))) => ((! [Xx3:$i] : (! [Xn:$i] : (((Xph @ Xn) & (cwcel @ (ccv @ Xx3) @ XX)) => ((cco @ XU @ (ccv @ Xx3) @ XG) = (ccv @ Xx3))))) => ((! [Xx3:$i] : (! [Xn:$i] : (((Xph @ Xn) & (cwcel @ (ccv @ Xx3) @ XX)) => (cwrex @ (^ [Xn:$i] : ((cco @ (ccv @ Xn) @ (ccv @ Xx3) @ XG) = XU)) @ (^ [Xn:$i] : XX))))) => (! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XG @ ccgr)))))))))))))).
...
thf(azerdivemp1x_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xa:$i] : ((XG @ Xa) = (ccfv @ XR @ cc1st))) => ((XH = (ccfv @ XR @ cc2nd)) => ((! [Xa:$i] : (XZ = (ccfv @ (XG @ Xa) @ ccgi))) => ((! [Xa:$i] : (XX = (ccrn @ (XG @ Xa)))) => ((! [Xa:$i] : ((XU @ Xa) = (ccfv @ XH @ ccgi))) => ((cw3a @ (cwcel @ XR @ ccrngo) @ (cwcel @ XA2 @ XX) @ (cwrex @ (^ [Xa:$i] : ((cco @ (ccv @ Xa) @ XA2 @ XH) = (XU @ Xa))) @ (^ [Xa:$i] : XX))) => ((cwcel @ XB2 @ XX) => (((cco @ XA2 @ XB2 @ XH) = XZ) => (XB2 = XZ)))))))))))))))))).
...
thf(cisdrngo2_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XG @ Xx3 @ Xy1) = (ccfv @ XR @ cc1st)))) => ((XH = (ccfv @ XR @ cc2nd)) => ((! [Xx3:$i] : (! [Xy1:$i] : (XZ = (ccfv @ (XG @ Xx3 @ Xy1) @ ccgi)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (XX = (ccrn @ (XG @ Xx3 @ Xy1))))) => ((XU = (ccfv @ XH @ ccgi)) => ((cwcel @ XR @ ccdrng) <=> ((cwcel @ XR @ ccrngo) & ((cwne @ XU @ XZ) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XH) = XU)) @ (^ [Xy1:$i] : (ccdif @ XX @ (ccsn @ XZ))))) @ (^ [Xx3:$i] : (ccdif @ XX @ (ccsn @ XZ))))))))))))))))))).
