...
thf(ahashsn01_ax,axiom,(! [XA2:($i > $o)] : (((ccfv @ (ccsn @ XA2) @ cchash) = ccc0) | ((ccfv @ (ccsn @ XA2) @ cchash) = cc1)))).
...
thf(alfgredgge2_ax,axiom,(! [XA2:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : (XI = (ccfv @ (XG @ Xx3) @ cciedg))) => ((XA2 = (ccdm @ XI)) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ cchash) @ ccle)) @ (^ [Xx3:$i] : (ccpw @ XV))))) => (! [Xx3:$i] : (((cwf @ XA2 @ (XE @ Xx3) @ XI) & (cwcel @ (XX @ Xx3) @ XA2)) => (cwbr @ cc2 @ (ccfv @ (ccfv @ (XX @ Xx3) @ XI) @ cchash) @ ccle))))))))))))).
