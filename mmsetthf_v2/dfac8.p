...
thf(adfac8b_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ cccrd)) => (? [Xx3:$i] : (cwwe @ XA2 @ (ccv @ Xx3)))))).
...
thf(adfac8c_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xz:$i] : (! [Xf1:$i] : ((cwcel @ XA2 @ (XB2 @ Xz @ Xf1)) => ((? [Xr:$i] : (cwwe @ (ccuni @ XA2) @ (ccv @ Xr))) => (? [Xf1:$i] : (cwral @ (^ [Xz:$i] : ((cwne @ (ccv @ Xz) @ cc0) => (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xf1)) @ (ccv @ Xz)))) @ (^ [Xz:$i] : XA2)))))))))).
thf(cdfac8_conj,conjecture,(cwac <=> (! [Xx3:$i] : (? [Xr:$i] : (cwwe @ (ccv @ Xx3) @ (ccv @ Xr)))))).
