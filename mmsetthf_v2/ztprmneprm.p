...
thf(amul2lt0bi_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((cwbr @ (cco @ XA2 @ XB2 @ ccmul) @ ccc0 @ cclt) <=> (((cwbr @ XA2 @ ccc0 @ cclt) & (cwbr @ ccc0 @ XB2 @ cclt)) | ((cwbr @ ccc0 @ XA2 @ cclt) & (cwbr @ XB2 @ ccc0 @ cclt))))))))))).
...
thf(cztprmneprm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XZ:($i > $o)] : ((cw3a @ (cwcel @ XZ @ ccz) @ (cwcel @ XA2 @ ccprime) @ (cwcel @ XB2 @ ccprime)) => (((cco @ XZ @ XA2 @ ccmul) = XB2) => (XA2 = XB2))))))).
