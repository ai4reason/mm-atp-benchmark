...
thf(aigenmin_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : ((cw3a @ (cwcel @ XR @ ccrngo) @ (cwcel @ XI @ (ccfv @ XR @ ccidl)) @ (cwss @ XS @ XI)) => (cwss @ (cco @ XR @ XS @ ccigen) @ XI)))))).
...
thf(cigenval2_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xj:$i] : ((XG @ Xj) = (ccfv @ XR @ cc1st))) => ((! [Xj:$i] : ((XX @ Xj) = (ccrn @ (XG @ Xj)))) => (! [Xj:$i] : (((cwcel @ XR @ ccrngo) & (cwss @ XS @ (XX @ Xj))) => (((cco @ XR @ XS @ ccigen) = XI) <=> (cw3a @ (cwcel @ XI @ (ccfv @ XR @ ccidl)) @ (cwss @ XS @ XI) @ (cwral @ (^ [Xj:$i] : ((cwss @ XS @ (ccv @ Xj)) => (cwss @ XI @ (ccv @ Xj)))) @ (^ [Xj:$i] : (ccfv @ XR @ ccidl))))))))))))))).
