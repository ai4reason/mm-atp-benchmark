...
thf(ccdlemefrs29pre00_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [Xc_le:($i > ($i > $o))] : (! [Xc_an:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xs1:$i] : ((XB2 @ Xs1) = (ccfv @ (XK @ Xs1) @ ccbs))) => ((! [Xs1:$i] : ((Xc_le @ Xs1) = (ccfv @ (XK @ Xs1) @ ccple))) => ((! [Xs1:$i] : ((Xc_or @ Xs1) = (ccfv @ (XK @ Xs1) @ ccjn))) => ((! [Xs1:$i] : ((Xc_an @ Xs1) = (ccfv @ (XK @ Xs1) @ ccmee))) => ((! [Xs1:$i] : ((XA2 @ Xs1) = (ccfv @ (XK @ Xs1) @ ccatm))) => ((! [Xs1:$i] : ((XH @ Xs1) = (ccfv @ (XK @ Xs1) @ cclh))) => ((! [Xs1:$i] : (((ccv @ Xs1) = (XR @ Xs1)) => ((Xph @ Xs1) <=> (Xps @ Xs1)))) => (! [Xs1:$i] : (((cw3a @ ((cwcel @ (XK @ Xs1) @ cchlt) & (cwcel @ (XW @ Xs1) @ (XH @ Xs1))) @ ((cwcel @ (XR @ Xs1) @ (XA2 @ Xs1)) & (~ (cwbr @ (XR @ Xs1) @ (XW @ Xs1) @ (Xc_le @ Xs1)))) @ (Xps @ Xs1)) & (cwcel @ (ccv @ Xs1) @ (XA2 @ Xs1))) => ((((~ (cwbr @ (ccv @ Xs1) @ (XW @ Xs1) @ (Xc_le @ Xs1))) & (Xph @ Xs1)) & ((cco @ (ccv @ Xs1) @ (cco @ (XR @ Xs1) @ (XW @ Xs1) @ (Xc_an @ Xs1)) @ (Xc_or @ Xs1)) = (XR @ Xs1))) <=> ((~ (cwbr @ (ccv @ Xs1) @ (XW @ Xs1) @ (Xc_le @ Xs1))) & ((cco @ (ccv @ Xs1) @ (cco @ (XR @ Xs1) @ (XW @ Xs1) @ (Xc_an @ Xs1)) @ (Xc_or @ Xs1)) = (XR @ Xs1))))))))))))))))))))))))).
