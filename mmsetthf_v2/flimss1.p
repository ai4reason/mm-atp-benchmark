...
thf(atopssnei_ax,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => (((cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XK @ cctop) @ (XX = XY)) & (cwss @ XJ @ XK)) => (cwss @ (ccfv @ XS @ (ccfv @ XJ @ ccnei)) @ (ccfv @ XS @ (ccfv @ XK @ ccnei)))))))))))).
...
thf(cflimss1_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwss @ XJ @ XK)) => (cwss @ (cco @ XK @ XF @ ccflim) @ (cco @ XJ @ XF @ ccflim)))))))).
