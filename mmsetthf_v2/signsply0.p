...
thf(aplyrecld_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XF @ (ccfv @ ccr @ ccply))) => ((Xph => (cwcel @ XX @ ccr)) => (Xph => (cwcel @ (ccfv @ XX @ XF) @ ccr)))))))).
...
thf(anegelrp_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ (ccneg @ XA2) @ ccrp) <=> (cwbr @ XA2 @ ccc0 @ cclt))))).
...
thf(asignsplypnf_ax,axiom,(! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XD = (ccfv @ XF @ ccdgr)) => ((XC = (ccfv @ XF @ cccoe)) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccfv @ XD @ XC))) => ((XG = (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XD @ ccexp)))) => (! [Xx3:$i] : ((cwcel @ XF @ (ccfv @ ccr @ ccply)) => (cwbr @ (cco @ XF @ XG @ (ccof @ ccdiv)) @ (XB2 @ Xx3) @ ccrli))))))))))))).
...
thf(agt0divd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccrp)) => (Xph => ((cwbr @ ccc0 @ XA2 @ cclt) <=> (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccdiv) @ cclt))))))))).
...
thf(csignsply0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : ((! [Xz:$i] : ((XD @ Xz) = (ccfv @ XF @ ccdgr))) => ((! [Xz:$i] : ((XC @ Xz) = (ccfv @ XF @ cccoe))) => ((! [Xz:$i] : (XB2 = (ccfv @ (XD @ Xz) @ (XC @ Xz)))) => ((! [Xz:$i] : ((XA2 @ Xz) = (ccfv @ ccc0 @ (XC @ Xz)))) => ((Xph => (cwcel @ XF @ (ccfv @ ccr @ ccply))) => ((Xph => (cwne @ XF @ cc0p)) => ((! [Xz:$i] : (Xph => (cwbr @ (cco @ (XA2 @ Xz) @ XB2 @ ccmul) @ ccc0 @ cclt))) => (Xph => (cwrex @ (^ [Xz:$i] : ((ccfv @ (ccv @ Xz) @ XF) = ccc0)) @ (^ [Xz:$i] : ccrp))))))))))))))))).
