...
thf(aofldlt1_ax,axiom,(! [Xc_lt:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XF @ cc0g)) => ((Xc_1 = (ccfv @ XF @ ccur)) => ((Xc_lt = (ccfv @ XF @ ccplt)) => ((cwcel @ XF @ ccofld) => (cwbr @ Xc_0 @ Xc_1 @ Xc_lt)))))))))).
...
thf(aorngrmullt_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xph => (cwcel @ XR @ ccorng)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XZ @ XB2)) => ((Xc_lt = (ccfv @ XR @ ccplt)) => ((Xph => (cwcel @ XR @ ccdr)) => ((Xph => (cwbr @ XX @ XY @ Xc_lt)) => ((Xph => (cwbr @ Xc_0 @ XZ @ Xc_lt)) => (Xph => (cwbr @ (cco @ XX @ XZ @ Xc_x) @ (cco @ XY @ XZ @ Xc_x) @ Xc_lt))))))))))))))))))))))).
...
thf(cisarchiofld_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((! [Xn:$i] : ((XH @ Xn) = (ccfv @ XW @ cczrh))) => ((Xc_lt = (ccfv @ XW @ ccplt)) => ((cwcel @ XW @ ccofld) => ((cwcel @ XW @ ccarchi) <=> (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xn:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ (XH @ Xn)) @ Xc_lt)) @ (^ [Xn:$i] : ccn))) @ (^ [Xx3:$i] : XB2)))))))))))).
