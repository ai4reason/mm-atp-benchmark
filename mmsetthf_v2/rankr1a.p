...
thf(assrankr1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccon0) => ((cwss @ XB2 @ (ccfv @ XA2 @ ccrnk)) <=> (~ (cwcel @ XA2 @ (ccfv @ XB2 @ ccr1))))))))).
...
thf(crankr1a_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccon0) => ((cwcel @ XA2 @ (ccfv @ XB2 @ ccr1)) <=> (cwcel @ (ccfv @ XA2 @ ccrnk) @ XB2))))))).
