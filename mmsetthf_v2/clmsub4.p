...
thf(aclmvsdi_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => (((cwcel @ XW @ ccclm) & (cw3a @ (cwcel @ XA2 @ XK) @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV))) => ((cco @ XA2 @ (cco @ XX @ XY @ Xc_pl) @ Xc_x) = (cco @ (cco @ XA2 @ XX @ Xc_x) @ (cco @ XA2 @ XY @ Xc_x) @ Xc_pl)))))))))))))))))).
...
thf(cclmsub4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => ((cw3a @ (cwcel @ XW @ ccclm) @ ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) @ ((cwcel @ XC @ XV) & (cwcel @ XD @ XV))) => ((cco @ (cco @ XA2 @ XB2 @ Xc_pl) @ (cco @ (ccneg @ cc1) @ (cco @ XC @ XD @ Xc_pl) @ Xc_x) @ Xc_pl) = (cco @ (cco @ XA2 @ (cco @ (ccneg @ cc1) @ XC @ Xc_x) @ Xc_pl) @ (cco @ XB2 @ (cco @ (ccneg @ cc1) @ XD @ Xc_x) @ Xc_pl) @ Xc_pl))))))))))))))).
