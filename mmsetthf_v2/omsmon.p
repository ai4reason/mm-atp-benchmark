...
thf(axrge0infssd_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwss @ XC @ XB2)) => ((Xph => (cwss @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => (Xph => (cwbr @ (ccinf @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ cclt) @ (ccinf @ XC @ (cco @ ccc0 @ ccpnf @ ccicc) @ cclt) @ ccle)))))))).
...
thf(comsmon_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XM = (ccfv @ XR @ ccoms)) => ((Xph => (cwcel @ XQ @ XV)) => ((Xph => (cwf @ XQ @ (cco @ ccc0 @ ccpnf @ ccicc) @ XR)) => ((Xph => (cwss @ XA2 @ XB2)) => ((Xph => (cwss @ XB2 @ (ccuni @ XQ))) => (Xph => (cwbr @ (ccfv @ XA2 @ XM) @ (ccfv @ XB2 @ XM) @ ccle))))))))))))))).
