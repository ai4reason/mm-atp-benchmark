...
thf(adifinf_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((~ (cwcel @ XA2 @ ccfn)) & (cwcel @ XB2 @ ccfn)) => (~ (cwcel @ (ccdif @ XA2 @ XB2) @ ccfn)))))).
...
thf(aonnmin_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ ccon0) & (cwcel @ XB2 @ XA2)) => (~ (cwcel @ XB2 @ (ccint @ XA2))))))).
