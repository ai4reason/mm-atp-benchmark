...
thf(aresqrex_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle)) => (cwrex @ (^ [Xx3:$i] : ((cwbr @ ccc0 @ (ccv @ Xx3) @ ccle) & ((cco @ (ccv @ Xx3) @ cc2 @ ccexp) = XA2))) @ (^ [Xx3:$i] : ccr))))).
...
thf(arennim_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwnel @ (cco @ cci @ XA2 @ ccmul) @ ccrp)))).
