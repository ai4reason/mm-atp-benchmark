...
thf(asadcaddlem_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwss @ (XA2 @ Xn) @ ccn0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwss @ (XB2 @ Xn) @ ccn0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XC @ Xm @ Xn @ Xc) = (ccseq @ (ccmpt2 @ (^ [Xc:$i] : (^ [Xm:$i] : cc2o)) @ (^ [Xc:$i] : (^ [Xm:$i] : ccn0)) @ (^ [Xc:$i] : (^ [Xm:$i] : (ccif @ (cwcad @ (cwcel @ (ccv @ Xm) @ (XA2 @ Xn)) @ (cwcel @ (ccv @ Xm) @ (XB2 @ Xn)) @ (cwcel @ cc0 @ (ccv @ Xc))) @ cc1o @ cc0)))) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ cc0 @ (cco @ (ccv @ Xn) @ cc1 @ ccmin)))) @ ccc0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwcel @ (XN @ Xm @ Xc) @ ccn0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XK @ Xm @ Xn @ Xc) = (cccnv @ (ccres @ ccbits @ ccn0)))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => ((cwcel @ cc0 @ (ccfv @ (XN @ Xm @ Xc) @ (XC @ Xm @ Xn @ Xc))) <=> (cwbr @ (cco @ cc2 @ (XN @ Xm @ Xc) @ ccexp) @ (cco @ (ccfv @ (ccin @ (XA2 @ Xn) @ (cco @ ccc0 @ (XN @ Xm @ Xc) @ ccfzo)) @ (XK @ Xm @ Xn @ Xc)) @ (ccfv @ (ccin @ (XB2 @ Xn) @ (cco @ ccc0 @ (XN @ Xm @ Xc) @ ccfzo)) @ (XK @ Xm @ Xn @ Xc)) @ ccaddc) @ ccle)))))) => (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => ((cwcel @ cc0 @ (ccfv @ (cco @ (XN @ Xm @ Xc) @ cc1 @ ccaddc) @ (XC @ Xm @ Xn @ Xc))) <=> (cwbr @ (cco @ cc2 @ (cco @ (XN @ Xm @ Xc) @ cc1 @ ccaddc) @ ccexp) @ (cco @ (ccfv @ (ccin @ (XA2 @ Xn) @ (cco @ ccc0 @ (cco @ (XN @ Xm @ Xc) @ cc1 @ ccaddc) @ ccfzo)) @ (XK @ Xm @ Xn @ Xc)) @ (ccfv @ (ccin @ (XB2 @ Xn) @ (cco @ ccc0 @ (cco @ (XN @ Xm @ Xc) @ cc1 @ ccaddc) @ ccfzo)) @ (XK @ Xm @ Xn @ Xc)) @ ccaddc) @ ccle))))))))))))))))))).
thf(aad2antrr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => (((Xph & Xch) & Xth) => Xps))))))).
thf(asimplr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) & Xch) => Xps))))).
thf(asimpr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(csadcadd_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwss @ (XA2 @ Xn) @ ccn0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwss @ (XB2 @ Xn) @ ccn0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XC @ Xm @ Xn @ Xc) = (ccseq @ (ccmpt2 @ (^ [Xc:$i] : (^ [Xm:$i] : cc2o)) @ (^ [Xc:$i] : (^ [Xm:$i] : ccn0)) @ (^ [Xc:$i] : (^ [Xm:$i] : (ccif @ (cwcad @ (cwcel @ (ccv @ Xm) @ (XA2 @ Xn)) @ (cwcel @ (ccv @ Xm) @ (XB2 @ Xn)) @ (cwcel @ cc0 @ (ccv @ Xc))) @ cc1o @ cc0)))) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ cc0 @ (cco @ (ccv @ Xn) @ cc1 @ ccmin)))) @ ccc0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => (cwcel @ (XN @ Xm @ Xc) @ ccn0))))) => ((! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((XK @ Xm @ Xn @ Xc) = (cccnv @ (ccres @ ccbits @ ccn0)))))) => (! [Xm:$i] : (! [Xn:$i] : (! [Xc:$i] : ((Xph @ Xm @ Xn @ Xc) => ((cwcel @ cc0 @ (ccfv @ (XN @ Xm @ Xc) @ (XC @ Xm @ Xn @ Xc))) <=> (cwbr @ (cco @ cc2 @ (XN @ Xm @ Xc) @ ccexp) @ (cco @ (ccfv @ (ccin @ (XA2 @ Xn) @ (cco @ ccc0 @ (XN @ Xm @ Xc) @ ccfzo)) @ (XK @ Xm @ Xn @ Xc)) @ (ccfv @ (ccin @ (XB2 @ Xn) @ (cco @ ccc0 @ (XN @ Xm @ Xc) @ ccfzo)) @ (XK @ Xm @ Xn @ Xc)) @ ccaddc) @ ccle)))))))))))))))))).
