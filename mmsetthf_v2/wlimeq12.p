...
thf(ainfeq123d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XD)) => ((Xph => (XB2 = XE)) => ((Xph => (XC = XF)) => (Xph => ((ccinf @ XA2 @ XB2 @ XC) = (ccinf @ XD @ XE @ XF)))))))))))))).
...
thf(asupeq123d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XD)) => ((Xph => (XB2 = XE)) => ((Xph => (XC = XF)) => (Xph => ((ccsup @ XA2 @ XB2 @ XC) = (ccsup @ XD @ XE @ XF)))))))))))))).
...
thf(apredeq123_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (XR = XS) @ (XA2 = XB2) @ (XX = XY)) => ((ccpred @ XA2 @ XR @ XX) = (ccpred @ XB2 @ XS @ XY)))))))))).
...
thf(cwlimeq12_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (((XR = XS) & (XA2 = XB2)) => ((ccwlim @ XA2 @ XR) = (ccwlim @ XB2 @ XS)))))))).
