...
thf(annsum3primesle9_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) & (cwbr @ XN @ cc8 @ ccle)) => (cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xf1:$i] : ((cwbr @ (ccv @ Xd) @ cc3 @ ccle) & (XN = (ccsu @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1))))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ ccmap)))) @ (^ [Xd:$i] : ccn))))).
...
thf(annsum3primesgbe_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccgbe) => (cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xf1:$i] : ((cwbr @ (ccv @ Xd) @ cc3 @ ccle) & (XN = (ccsu @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1))))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ ccmap)))) @ (^ [Xd:$i] : ccn))))).
...
thf(annsum4primesodd_ax,axiom,(! [XN:($i > $o)] : ((cwral @ (^ [Xm:$i] : ((cwbr @ cc5 @ (ccv @ Xm) @ cclt) => (cwcel @ (ccv @ Xm) @ ccgbow))) @ (^ [Xm:$i] : ccodd)) => (((cwcel @ XN @ (ccfv @ cc6 @ ccuz)) & (cwcel @ XN @ ccodd)) => (cwrex @ (^ [Xf1:$i] : (XN = (ccsu @ (cco @ cc1 @ cc3 @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ cc3 @ ccfz) @ ccmap))))))).
...
thf(asbgoldbwt_ax,axiom,((cwral @ (^ [Xn:$i] : ((cwbr @ cc4 @ (ccv @ Xn) @ cclt) => (cwcel @ (ccv @ Xn) @ ccgbe))) @ (^ [Xn:$i] : cceven)) => (cwral @ (^ [Xm:$i] : ((cwbr @ cc5 @ (ccv @ Xm) @ cclt) => (cwcel @ (ccv @ Xm) @ ccgbow))) @ (^ [Xm:$i] : ccodd)))).
...
thf(cbgoldbnnsum3prm_conj,conjecture,((cwral @ (^ [Xm:$i] : ((cwbr @ cc4 @ (ccv @ Xm) @ cclt) => (cwcel @ (ccv @ Xm) @ ccgbe))) @ (^ [Xm:$i] : cceven)) => (cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xf1:$i] : ((cwbr @ (ccv @ Xd) @ cc3 @ ccle) & ((ccv @ Xn) = (ccsu @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1))))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ ccmap)))) @ (^ [Xd:$i] : ccn))) @ (^ [Xn:$i] : (ccfv @ cc2 @ ccuz))))).
