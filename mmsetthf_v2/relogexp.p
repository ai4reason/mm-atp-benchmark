...
thf(arelogef_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ (ccfv @ XA2 @ cce) @ cclog) = XA2)))).
thf(crelogexp_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwcel @ XN @ ccz)) => ((ccfv @ (cco @ XA2 @ XN @ ccexp) @ cclog) = (cco @ XN @ (ccfv @ XA2 @ cclog) @ ccmul)))))).
