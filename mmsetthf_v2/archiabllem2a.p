...
thf(agrpaddsubass_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => (((cwcel @ XG @ ccgrp) & (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2))) => ((cco @ (cco @ XX @ XY @ Xc_pl) @ XZ @ Xc_mi) = (cco @ XX @ (cco @ XY @ XZ @ Xc_mi) @ Xc_pl)))))))))))))).
...
thf(agrpnpcan_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => ((cco @ (cco @ XX @ XY @ Xc_mi) @ XY @ Xc_pl) = XX)))))))))))).
...
thf(atlt2_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_lt = (ccfv @ XK @ ccplt)) => ((cw3a @ (cwcel @ XK @ cctos) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => ((cwbr @ XX @ XY @ Xc_le) | (cwbr @ XY @ XX @ Xc_lt))))))))))))).
...
thf(carchiabllem2a_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [Xc_x:($i > ($i > ($i > ($i > $o))))] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((Xc_le = (ccfv @ XW @ ccple)) => ((Xc_lt = (ccfv @ XW @ ccplt)) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((Xc_x @ Xa @ Xb @ Xc) = (ccfv @ XW @ ccmg))))) => ((! [Xc:$i] : ((Xph @ Xc) => (cwcel @ XW @ ccogrp))) => ((! [Xc:$i] : ((Xph @ Xc) => (cwcel @ XW @ ccarchi))) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => ((! [Xc:$i] : ((Xph @ Xc) => (cwcel @ (ccfv @ XW @ ccoppg) @ ccogrp))) => ((! [Xa:$i] : (! [Xc:$i] : ((cw3a @ (Xph @ Xc) @ (cwcel @ (ccv @ Xa) @ XB2) @ (cwbr @ Xc_0 @ (ccv @ Xa) @ Xc_lt)) => (cwrex @ (^ [Xb:$i] : ((cwbr @ Xc_0 @ (ccv @ Xb) @ Xc_lt) & (cwbr @ (ccv @ Xb) @ (ccv @ Xa) @ Xc_lt))) @ (^ [Xb:$i] : XB2))))) => ((! [Xc:$i] : ((Xph @ Xc) => (cwcel @ XX @ XB2))) => ((! [Xc:$i] : ((Xph @ Xc) => (cwbr @ Xc_0 @ XX @ Xc_lt))) => (! [Xc:$i] : ((Xph @ Xc) => (cwrex @ (^ [Xc:$i] : ((cwbr @ Xc_0 @ (ccv @ Xc) @ Xc_lt) & (cwbr @ (cco @ (ccv @ Xc) @ (ccv @ Xc) @ Xc_pl) @ XX @ Xc_le))) @ (^ [Xc:$i] : XB2)))))))))))))))))))))))))).
