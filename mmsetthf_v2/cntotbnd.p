...
thf(aredivd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwne @ XA2 @ ccc0)) => (Xph => ((ccfv @ (cco @ XB2 @ XA2 @ ccdiv) @ ccre) = (cco @ (ccfv @ XB2 @ ccre) @ XA2 @ ccdiv)))))))))).
thf(arpred_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => (Xph => (cwcel @ XA2 @ ccr)))))).
thf(aimdivd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwne @ XA2 @ ccc0)) => (Xph => ((ccfv @ (cco @ XB2 @ XA2 @ ccdiv) @ ccim) = (cco @ (ccfv @ XB2 @ ccim) @ XA2 @ ccdiv)))))))))).
...
thf(asstotbnd3_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XN = (ccres @ XM @ (ccxp @ XY @ XY))) => (((cwcel @ XM @ (ccfv @ XX @ ccme)) & (cwss @ XY @ XX)) => ((cwcel @ XN @ (ccfv @ XY @ cctotbnd)) <=> (cwral @ (^ [Xd:$i] : (cwrex @ (^ [Xv:$i] : ((cwss @ XY @ (cciun @ (^ [Xx3:$i] : (ccv @ Xv)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ (ccfv @ XM @ ccbl))))) & (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwne @ (ccin @ (cco @ (ccv @ Xx3) @ (ccv @ Xd) @ (ccfv @ XM @ ccbl)) @ XY) @ cc0)) @ (^ [Xx3:$i] : (ccv @ Xv))) @ ccfn))) @ (^ [Xv:$i] : (ccpw @ XX)))) @ (^ [Xd:$i] : ccrp)))))))))).
thf(ccntotbnd_conj,conjecture,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((XD = (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XX @ XX))) => ((cwcel @ XD @ (ccfv @ XX @ cctotbnd)) <=> (cwcel @ XD @ (ccfv @ XX @ ccbnd))))))).
