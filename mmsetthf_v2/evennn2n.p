...
thf(aprodgt0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul) @ cclt))) => (cwbr @ ccc0 @ XB2 @ cclt))))).
...
thf(cevennn2n_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cwbr @ cc2 @ XN @ ccdvds) <=> (cwrex @ (^ [Xn:$i] : ((cco @ cc2 @ (ccv @ Xn) @ ccmul) = XN)) @ (^ [Xn:$i] : ccn)))))).
