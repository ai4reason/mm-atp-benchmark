...
thf(assrexr_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwss @ XA2 @ ccr)) => (Xph => (cwss @ XA2 @ ccxr)))))).
...
thf(aliminfgf_ax,axiom,(! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xk:$i] : ((XG @ Xk) = (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccinf @ (ccin @ (ccima @ (XF @ Xk) @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))) => (! [Xk:$i] : (cwf @ ccr @ ccxr @ (XG @ Xk))))))).
...
thf(aliminfgord_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ ccle)) => (cwbr @ (ccinf @ (ccin @ (ccima @ XF @ (cco @ XA2 @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt) @ (ccinf @ (ccin @ (ccima @ XF @ (cco @ XB2 @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt) @ ccle)))))).
...
thf(aliminfgval_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XM:($i > $o)] : ((! [Xk:$i] : ((XG @ Xk) = (ccmpt @ (^ [Xk:$i] : ccr) @ (^ [Xk:$i] : (ccinf @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xk) @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))) => (! [Xk:$i] : ((cwcel @ XM @ ccr) => ((ccfv @ XM @ (XG @ Xk)) = (ccinf @ (ccin @ (ccima @ XF @ (cco @ XM @ ccpnf @ ccico)) @ ccxr) @ ccxr @ cclt))))))))).
