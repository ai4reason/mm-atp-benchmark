...
thf(csrgmulgass_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmg)) => ((Xc_xp = (ccfv @ XR @ ccmulr)) => (((cwcel @ XR @ ccsrg) & (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2))) => ((cco @ (cco @ XN @ XX @ Xc_x) @ XY @ Xc_xp) = (cco @ XN @ (cco @ XX @ XY @ Xc_xp) @ Xc_x)))))))))))))).
