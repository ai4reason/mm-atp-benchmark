...
thf(afrgrncvvdeq_ax,axiom,(! [XD:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XD @ Xx3 @ Xy1) = (ccfv @ XG @ ccvtxdg)))) => ((cwcel @ XG @ ccfrgr) => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwnel @ (ccv @ Xy1) @ (cco @ XG @ (ccv @ Xx3) @ ccnbgr)) => ((ccfv @ (ccv @ Xx3) @ (XD @ Xx3 @ Xy1)) = (ccfv @ (ccv @ Xy1) @ (XD @ Xx3 @ Xy1))))) @ (^ [Xy1:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : XV))))))))).
...
thf(arspc2vd_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = XA2) => ((Xth @ Xx3 @ Xy1) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xy1) = (XB2 @ Xx3)) => ((Xch @ Xy1) <=> (Xps @ Xx3))))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XA2 @ (XC @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((Xph @ Xy1) & ((ccv @ Xx3) = XA2)) => ((XD @ Xx3) = (XE @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ (XB2 @ Xx3) @ (XE @ Xy1))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xy1) => ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (Xth @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XD @ Xx3)))) @ (^ [Xx3:$i] : (XC @ Xy1))) => (Xps @ Xx3)))))))))))))))))))).
...
thf(cfrgrwopreglem4a_conj,conjecture,(! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XD = (ccfv @ XG @ ccvtxdg)) => ((XE = (ccfv @ XG @ ccedg)) => ((cw3a @ (cwcel @ XG @ ccfrgr) @ ((cwcel @ XX @ XV) & (cwcel @ XY @ XV)) @ (cwne @ (ccfv @ XX @ XD) @ (ccfv @ XY @ XD))) => (cwcel @ (ccpr @ XX @ XY) @ XE)))))))))))).
