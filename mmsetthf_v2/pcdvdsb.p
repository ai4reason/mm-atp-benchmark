...
thf(aimpcon4bid_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps => Xch)) => ((Xph => ((~ Xps) => (~ Xch))) => (Xph => (Xps <=> Xch)))))))).
...
thf(advdsexp_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ (ccfv @ XM @ ccuz))) => (cwbr @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccdvds)))))).
thf(ampan2d_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xch) => ((Xph => ((Xps & Xch) => Xth)) => (Xph => (Xps => Xth))))))))).
thf(apczdvds_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & ((cwcel @ XN @ ccz) & (cwne @ XN @ ccc0))) => (cwbr @ (cco @ XP @ (cco @ XP @ XN @ ccpc) @ ccexp) @ XN @ ccdvds))))).
...
thf(apczndvds_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & ((cwcel @ XN @ ccz) & (cwne @ XN @ ccc0))) => (~ (cwbr @ (cco @ XP @ (cco @ (cco @ XP @ XN @ ccpc) @ cc1 @ ccaddc) @ ccexp) @ XN @ ccdvds)))))).
...
thf(apc0_ax,axiom,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprime) => ((cco @ XP @ ccc0 @ ccpc) = ccpnf)))).
thf(advds0_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => (cwbr @ XN @ ccc0 @ ccdvds)))).
thf(cpcdvdsb_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XN @ ccz) @ (cwcel @ XA2 @ ccn0)) => ((cwbr @ XA2 @ (cco @ XP @ XN @ ccpc) @ ccle) <=> (cwbr @ (cco @ XP @ XA2 @ ccexp) @ XN @ ccdvds))))))).
