...
thf(cseqfveq2_conj,conjecture,(! [Xph:$o] : (! [Xc_pl:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xk:$i] : (Xph => (cwcel @ XK @ (ccfv @ (XM @ Xk) @ ccuz)))) => ((! [Xk:$i] : (Xph => ((ccfv @ XK @ (ccseq @ (Xc_pl @ Xk) @ XF @ (XM @ Xk))) = (ccfv @ XK @ XG)))) => ((Xph => (cwcel @ XN @ (ccfv @ XK @ ccuz))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (cco @ (cco @ XK @ cc1 @ ccaddc) @ XN @ ccfz))) => ((ccfv @ (ccv @ Xk) @ XF) = (ccfv @ (ccv @ Xk) @ XG)))) => (! [Xk:$i] : (Xph => ((ccfv @ XN @ (ccseq @ (Xc_pl @ Xk) @ XF @ (XM @ Xk))) = (ccfv @ XN @ (ccseq @ (Xc_pl @ Xk) @ XG @ XK))))))))))))))))).
