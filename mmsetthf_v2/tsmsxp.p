...
thf(atmdcn2_ax,axiom,(! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_pl:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : ((XB2 @ Xx3 @ Xy1 @ Xv @ Xu) = (ccfv @ XG @ ccbs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XJ @ Xx3 @ Xy1) = (ccfv @ XG @ cctopn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : ((Xc_pl @ Xx3 @ Xy1 @ Xv @ Xu) = (ccfv @ XG @ ccplusg)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : ((((cwcel @ XG @ cctmd) & (cwcel @ XU @ (XJ @ Xx3 @ Xy1))) & (cw3a @ (cwcel @ (XX @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1 @ Xv @ Xu)) @ (cwcel @ (XY @ Xx3 @ Xy1) @ (XB2 @ Xx3 @ Xy1 @ Xv @ Xu)) @ (cwcel @ (cco @ (XX @ Xx3 @ Xy1) @ (XY @ Xx3 @ Xy1) @ (Xc_pl @ Xx3 @ Xy1 @ Xv @ Xu)) @ XU))) => (cwrex @ (^ [Xu:$i] : (cwrex @ (^ [Xv:$i] : (cw3a @ (cwcel @ (XX @ Xx3 @ Xy1) @ (ccv @ Xu)) @ (cwcel @ (XY @ Xx3 @ Xy1) @ (ccv @ Xv)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (Xc_pl @ Xx3 @ Xy1 @ Xv @ Xu)) @ XU)) @ (^ [Xy1:$i] : (ccv @ Xv)))) @ (^ [Xx3:$i] : (ccv @ Xu))))) @ (^ [Xv:$i] : (XJ @ Xx3 @ Xy1)))) @ (^ [Xu:$i] : (XJ @ Xx3 @ Xy1))))))))))))))))))).
