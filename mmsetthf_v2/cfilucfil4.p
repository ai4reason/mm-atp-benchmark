...
thf(acfilucfil3_ax,axiom,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : (((cwne @ XX @ cc0) & (cwcel @ XD @ (ccfv @ XX @ ccxmt))) => (((cwcel @ XC @ (ccfv @ XX @ ccfil)) & (cwcel @ XC @ (ccfv @ (ccfv @ XD @ ccmetu) @ cccfilu))) <=> (cwcel @ XC @ (ccfv @ XD @ cccfil)))))))).
...
thf(ccfilucfil4_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwne @ XX @ cc0) @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XC @ (ccfv @ XX @ ccfil))) => ((cwcel @ XC @ (ccfv @ (ccfv @ XD @ ccmetu) @ cccfilu)) <=> (cwcel @ XC @ (ccfv @ XD @ cccfil)))))))).
