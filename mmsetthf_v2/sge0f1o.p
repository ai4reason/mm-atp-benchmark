...
thf(aelrnmpt1sf_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XC @ Xx3))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XD) => ((XB2 @ Xx3) = (XC @ Xx3)))) => (! [Xx3:$i] : (((cwcel @ XD @ XA2) & (cwcel @ (XC @ Xx3) @ (XV @ Xx3))) => (cwcel @ (XC @ Xx3) @ (ccrn @ (XF @ Xx3))))))))))))))).
...
thf(aeliccnelico_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc))) => ((Xph => (~ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico)))) => (Xph => (XC = XB2))))))))))).
