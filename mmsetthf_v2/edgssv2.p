...
thf(aedgusgr_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XG @ ccusgr) & (cwcel @ XE @ (ccfv @ XG @ ccedg))) => ((cwcel @ XE @ (ccpw @ (ccfv @ XG @ ccvtx))) & ((ccfv @ XE @ cchash) = cc2)))))).
...
thf(cedgssv2_conj,conjecture,(! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ ccusgr) & (cwcel @ XC @ XE)) => ((cwss @ XC @ XV) & ((ccfv @ XC @ cchash) = cc2)))))))))).
