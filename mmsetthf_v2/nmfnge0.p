...
thf(anmfnxr_ax,axiom,(! [XT:($i > $o)] : ((cwf @ cchil @ ccc @ XT) => (cwcel @ (ccfv @ XT @ ccnmf) @ ccxr)))).
...
thf(cnmfnge0_conj,conjecture,(! [XT:($i > $o)] : ((cwf @ cchil @ ccc @ XT) => (cwbr @ ccc0 @ (ccfv @ XT @ ccnmf) @ ccle)))).
