...
thf(apm4_82_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (((Xph => Xps) & (Xph => (~ Xps))) <=> (~ Xph))))).
...
thf(calimp_no_surprise_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (~ (cw3a @ (! [Xx3:$i] : ((Xph @ Xx3) => (Xps @ Xx3))) @ (! [Xx3:$i] : ((Xph @ Xx3) => (~ (Xps @ Xx3)))) @ (? [Xx3:$i] : (Xph @ Xx3))))))).
