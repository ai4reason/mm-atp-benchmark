...
thf(cdihsslss_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((XS = (ccfv @ XU @ cclss)) => (((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) => (cwss @ (ccrn @ XI) @ XS))))))))))))).
