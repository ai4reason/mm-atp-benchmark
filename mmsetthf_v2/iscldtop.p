...
thf(afncld_ax,axiom,(cwfn @ cccld @ cctop)).
...
thf(acldmreon_ax,axiom,(! [XB2:($i > $o)] : (! [XJ:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XB2 @ cctopon)) => (cwcel @ (ccfv @ XJ @ cccld) @ (ccfv @ XB2 @ ccmre)))))).
...
thf(ciscldtop_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : ((cwcel @ XK @ (ccima @ cccld @ (ccfv @ XB2 @ cctopon))) <=> (cw3a @ (cwcel @ XK @ (ccfv @ XB2 @ ccmre)) @ (cwcel @ cc0 @ XK) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XK)) @ (^ [Xy1:$i] : XK))) @ (^ [Xx3:$i] : XK))))))).
