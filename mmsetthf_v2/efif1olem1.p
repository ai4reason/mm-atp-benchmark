...
thf(cefif1olem1_conj,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((XD = (cco @ XA2 @ (cco @ XA2 @ (cco @ cc2 @ ccpi @ ccmul) @ ccaddc) @ ccioc)) => (((cwcel @ XA2 @ ccr) & ((cwcel @ (ccv @ Xx3) @ XD) & (cwcel @ (ccv @ Xy1) @ XD))) => (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmin) @ ccabs) @ (cco @ cc2 @ ccpi @ ccmul) @ cclt)))))))).
