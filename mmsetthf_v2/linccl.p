...
thf(clinccl_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XR = (ccfv @ (ccfv @ XM @ ccsca) @ ccbs)) => (((cwcel @ XM @ cclmod) & (cw3a @ (cwcel @ XV @ ccfn) @ (cwss @ XV @ XB2) @ (cwcel @ XS @ (cco @ XR @ XV @ ccmap)))) => (cwcel @ (cco @ XS @ XV @ (ccfv @ XM @ cclinc)) @ XB2)))))))))).
