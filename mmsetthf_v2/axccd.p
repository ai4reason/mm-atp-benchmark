...
thf(aencv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccen) => ((cwcel @ XA2 @ ccvv) & (cwcel @ XB2 @ ccvv)))))).
...
thf(caxccd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwbr @ XA2 @ ccom @ ccen)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwne @ (ccv @ Xx3) @ cc0))) => (Xph => (? [Xf1:$i] : (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2))))))))).
