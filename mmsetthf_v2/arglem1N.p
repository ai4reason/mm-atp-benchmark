...
thf(carglem1N_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XF = (cco @ (cco @ XP @ XQ @ Xc_or) @ (cco @ XS @ XT @ Xc_or) @ Xc_an)) => ((XG = (cco @ (cco @ XP @ XS @ Xc_or) @ (cco @ XQ @ XT @ Xc_or) @ Xc_an)) => (((cw3a @ (cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XP @ XA2) @ (cwcel @ XQ @ XA2)) @ (cw3a @ (cwcel @ XS @ XA2) @ (cwcel @ XT @ XA2) @ (cwne @ XP @ XQ)) @ (cw3a @ (cwne @ XP @ XS) @ (cwne @ XQ @ XT) @ (cwne @ XS @ XT))) & (cwcel @ XG @ XA2)) => (cwcel @ XF @ XA2)))))))))))))))))).
