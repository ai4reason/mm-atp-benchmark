...
thf(aordtri2or3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cword @ XA2) & (cword @ XB2)) => ((XA2 = (ccin @ XA2 @ XB2)) | (XB2 = (ccin @ XA2 @ XB2))))))).
...
thf(cordelinel_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cword @ XA2) @ (cword @ XB2) @ (cword @ XC)) => ((cwcel @ (ccin @ XA2 @ XB2) @ XC) <=> ((cwcel @ XA2 @ XC) | (cwcel @ XB2 @ XC)))))))).
