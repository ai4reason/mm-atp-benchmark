...
thf(atrlsfval_ax,axiom,(! [XG:($i > $o)] : ((ccfv @ XG @ cctrls) = (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : ((cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ ccwlks)) & (cwfun @ (cccnv @ (ccv @ Xf1)))))))))).
