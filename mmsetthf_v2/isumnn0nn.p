...
thf(cisumnn0nn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((! [Xk:$i] : (((ccv @ Xk) = ccc0) => ((XA2 @ Xk) = XB2))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn0)) => ((ccfv @ (ccv @ Xk) @ XF) = (XA2 @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ ccn0)) => (cwcel @ (XA2 @ Xk) @ ccc))) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XF @ ccc0) @ (ccdm @ ccli))) => (Xph => ((ccsu @ ccn0 @ (^ [Xk:$i] : (XA2 @ Xk))) = (cco @ XB2 @ (ccsu @ ccn @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccaddc)))))))))))).
