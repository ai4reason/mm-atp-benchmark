...
thf(aprmdvdsfmtnof1_ax,axiom,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xp:$i] : ((XF @ Xf1 @ Xp) = (ccmpt @ (^ [Xf1:$i] : (ccrn @ ccfmtno)) @ (^ [Xf1:$i] : (ccinf @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (ccv @ Xf1) @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ ccr @ cclt)))))) => (! [Xf1:$i] : (! [Xp:$i] : (cwf1 @ (ccrn @ ccfmtno) @ ccprime @ (XF @ Xf1 @ Xp))))))).
...
thf(afmtnoinf_ax,axiom,(cwnel @ (ccrn @ ccfmtno) @ ccfn)).
