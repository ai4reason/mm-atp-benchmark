...
thf(anmcfnexi_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ cclf) => ((cwcel @ XT @ cccnfn) => (cwcel @ (ccfv @ XT @ ccnmf) @ ccr))))).
...
thf(anorm1_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwne @ XA2 @ cc0v)) => ((ccfv @ (cco @ (cco @ cc1 @ (ccfv @ XA2 @ ccno) @ ccdiv) @ XA2 @ ccsm) @ ccno) = cc1)))).
...
thf(anmfnlb_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwf @ cchil @ ccc @ XT) @ (cwcel @ XA2 @ cchil) @ (cwbr @ (ccfv @ XA2 @ ccno) @ cc1 @ ccle)) => (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ ccabs) @ (ccfv @ XT @ ccnmf) @ ccle))))).
...
thf(cnmcfnlbi_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XT @ cclf) => ((cwcel @ XT @ cccnfn) => ((cwcel @ XA2 @ cchil) => (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ ccabs) @ (cco @ (ccfv @ XT @ ccnmf) @ (ccfv @ XA2 @ ccno) @ ccmul) @ ccle))))))).
