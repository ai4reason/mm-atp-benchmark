...
thf(aipblnfi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XP = (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => ((! [Xx3:$i] : ((XC @ Xx3) = (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs))) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (cco @ XU @ (XC @ Xx3) @ ccblo))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ XP))))) => (! [Xx3:$i] : ((cwcel @ XA2 @ XX) => (cwcel @ (XF @ Xx3) @ (XB2 @ Xx3)))))))))))))))))).
...
thf(anmooge0_ax,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XY = (ccfv @ XW @ ccba)) => ((XN = (cco @ XU @ XW @ ccnmoo)) => ((cw3a @ (cwcel @ XU @ ccnv) @ (cwcel @ XW @ ccnv) @ (cwf @ XX @ XY @ XT)) => (cwbr @ ccc0 @ (ccfv @ XT @ XN) @ ccle)))))))))))).
...
thf(aisblo_ax,axiom,(! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XN = (cco @ XU @ XW @ ccnmoo)) => ((XL = (cco @ XU @ XW @ cclno)) => ((XB2 = (cco @ XU @ XW @ ccblo)) => (((cwcel @ XU @ ccnv) & (cwcel @ XW @ ccnv)) => ((cwcel @ XT @ XB2) <=> ((cwcel @ XT @ XL) & (cwbr @ (ccfv @ XT @ XN) @ ccpnf @ cclt)))))))))))))).
