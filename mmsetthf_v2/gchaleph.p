...
thf(cgchaleph_conj,conjecture,(! [XA2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ (ccfv @ XA2 @ ccale) @ ccgch) @ (cwcel @ (ccpw @ (ccfv @ XA2 @ ccale)) @ (ccdm @ cccrd))) => (cwbr @ (ccfv @ (ccsuc @ XA2) @ ccale) @ (ccpw @ (ccfv @ XA2 @ ccale)) @ ccen)))).
