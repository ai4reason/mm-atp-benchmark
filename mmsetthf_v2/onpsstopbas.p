...
thf(aonsstopbas_ax,axiom,(cwss @ ccon0 @ cctb)).
...
thf(asnsn0non_ax,axiom,(~ (cwcel @ (ccsn @ (ccsn @ cc0)) @ ccon0))).
...
thf(assnelpss_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ XB2) => (((cwcel @ XC @ XB2) & (~ (cwcel @ XC @ XA2))) => (cwpss @ XA2 @ XB2))))))).
thf(conpsstopbas_conj,conjecture,(cwpss @ ccon0 @ cctb)).
