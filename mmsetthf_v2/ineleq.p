...
thf(cineleq_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (! [Xz:$i] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) | ((ccin @ (XC @ Xx3 @ Xy1) @ (XD @ Xx3 @ Xy1)) = cc0))) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1 @ Xz))) <=> (cwral @ (^ [Xx3:$i] : (! [Xz:$i] : (cwral @ (^ [Xy1:$i] : (((cwcel @ (ccv @ Xz) @ (XC @ Xx3 @ Xy1)) & (cwcel @ (ccv @ Xz) @ (XD @ Xx3 @ Xy1))) => ((ccv @ Xx3) = (ccv @ Xy1)))) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1))))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1 @ Xz))))))))))).
