...
thf(afzmaxdif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ ((cwcel @ XC @ ccz) & (cwcel @ XA2 @ (cco @ XB2 @ XC @ ccfz))) @ ((cwcel @ XF @ ccz) & (cwcel @ XD @ (cco @ XE @ XF @ ccfz))) @ (cwbr @ (cco @ XC @ XE @ ccmin) @ (cco @ XF @ XB2 @ ccmin) @ ccle)) => (cwbr @ (ccfv @ (cco @ XA2 @ XD @ ccmin) @ ccabs) @ (cco @ XF @ XB2 @ ccmin) @ ccle))))))))).
...
thf(acongabseq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz)) & (cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccdvds)) => ((cwbr @ (ccfv @ (cco @ XB2 @ XC @ ccmin) @ ccabs) @ XA2 @ cclt) <=> (XB2 = XC))))))).
...
thf(afzneg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz)) => ((cwcel @ XA2 @ (cco @ XB2 @ XC @ ccfz)) <=> (cwcel @ (ccneg @ XA2) @ (cco @ (ccneg @ XC) @ (ccneg @ XB2) @ ccfz)))))))).
...
thf(cacongeq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccn) @ (cwcel @ XB2 @ (cco @ ccc0 @ XA2 @ ccfz)) @ (cwcel @ XC @ (cco @ ccc0 @ XA2 @ ccfz))) => ((XB2 = XC) <=> ((cwbr @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ XB2 @ XC @ ccmin) @ ccdvds) | (cwbr @ (cco @ cc2 @ XA2 @ ccmul) @ (cco @ XB2 @ (ccneg @ XC) @ ccmin) @ ccdvds)))))))).
