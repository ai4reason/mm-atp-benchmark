...
thf(abtwnconn2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ ((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ ((cwcel @ XC @ (ccfv @ XN @ ccee)) & (cwcel @ XD @ (ccfv @ XN @ ccee)))) => ((cw3a @ (cwne @ XA2 @ XB2) @ (cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn) @ (cwbr @ XB2 @ (ccop @ XA2 @ XD) @ ccbtwn)) => ((cwbr @ XC @ (ccop @ XB2 @ XD) @ ccbtwn) | (cwbr @ XD @ (ccop @ XB2 @ XC) @ ccbtwn)))))))))).
...
thf(abtwnouttr2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ ((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ ((cwcel @ XC @ (ccfv @ XN @ ccee)) & (cwcel @ XD @ (ccfv @ XN @ ccee)))) => ((cw3a @ (cwne @ XB2 @ XC) @ (cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn) @ (cwbr @ XC @ (ccop @ XB2 @ XD) @ ccbtwn)) => (cwbr @ XC @ (ccop @ XA2 @ XD) @ ccbtwn))))))))).
...
thf(cbtwnoutside_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ ((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ ((cwcel @ XC @ (ccfv @ XN @ ccee)) & (cwcel @ XP @ (ccfv @ XN @ ccee)))) => (((cw3a @ (cwne @ XA2 @ XP) @ (cwne @ XB2 @ XP) @ (cwne @ XC @ XP)) & (cwbr @ XP @ (ccop @ XA2 @ XC) @ ccbtwn)) => ((cwbr @ XP @ (ccop @ XB2 @ XC) @ ccbtwn) <=> (cwbr @ XP @ (ccop @ XA2 @ XB2) @ ccoutsideof)))))))))).
