...
thf(algsdchrval_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xh:$i] : (! [Xm:$i] : ((XG @ Xy1 @ Xh @ Xm) = (ccfv @ XN @ ccdchr))))) => ((! [Xh:$i] : (! [Xm:$i] : ((XZ @ Xh @ Xm) = (ccfv @ XN @ cczn)))) => ((! [Xy1:$i] : (! [Xh:$i] : (! [Xm:$i] : ((XD @ Xy1 @ Xh @ Xm) = (ccfv @ (XG @ Xy1 @ Xh @ Xm) @ ccbs))))) => ((! [Xh:$i] : (! [Xm:$i] : ((XB2 @ Xh @ Xm) = (ccfv @ (XZ @ Xh @ Xm) @ ccbs)))) => ((! [Xh:$i] : (! [Xm:$i] : (XL = (ccfv @ (XZ @ Xh @ Xm) @ cczrh)))) => ((! [Xh:$i] : (! [Xm:$i] : ((XX @ Xh @ Xm) = (ccmpt @ (^ [Xy1:$i] : (XB2 @ Xh @ Xm)) @ (^ [Xy1:$i] : (ccio @ (^ [Xh:$i] : (cwrex @ (^ [Xm:$i] : (((ccv @ Xy1) = (ccfv @ (ccv @ Xm) @ XL)) & ((ccv @ Xh) = (cco @ (ccv @ Xm) @ XN @ cclgs)))) @ (^ [Xm:$i] : ccz))))))))) => (! [Xh:$i] : (! [Xm:$i] : ((((cwcel @ XN @ ccn) & (~ (cwbr @ cc2 @ XN @ ccdvds))) & (cwcel @ XA2 @ ccz)) => ((ccfv @ (ccfv @ XA2 @ XL) @ (XX @ Xh @ Xm)) = (cco @ XA2 @ XN @ cclgs)))))))))))))))))))).
...
thf(algsdirnn0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XN @ ccn0)) => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ XN @ cclgs) = (cco @ (cco @ XA2 @ XN @ cclgs) @ (cco @ XB2 @ XN @ cclgs) @ ccmul))))))).
...
thf(a_1lgs_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cco @ cc1 @ XN @ cclgs) = cc1)))).
