...
thf(areupick3_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [Xx3:$i] : ((cw3a @ (cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (cwrex @ (^ [Xx3:$i] : ((Xph @ Xx3) & (Xps @ Xx3))) @ (^ [Xx3:$i] : XA2)) @ (cwcel @ (ccv @ Xx3) @ XA2)) => ((Xph @ Xx3) => (Xps @ Xx3)))))))).
...
thf(creupick2_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > $o)] : (! [Xx3:$i] : (((cw3a @ (cwral @ (^ [Xx3:$i] : ((Xps @ Xx3) => (Xph @ Xx3))) @ (^ [Xx3:$i] : XA2)) @ (cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ (cwreu @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2))) & (cwcel @ (ccv @ Xx3) @ XA2)) => ((Xph @ Xx3) <=> (Xps @ Xx3)))))))).
