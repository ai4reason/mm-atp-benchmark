...
thf(cfunimaeq_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwfun @ XF))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwfun @ XG))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XA2 @ (ccdm @ XF)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XA2 @ (ccdm @ XG)))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ XA2)) => ((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xx3) @ XG)))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccima @ XF @ XA2) = (ccima @ XG @ XA2))))))))))))))).
