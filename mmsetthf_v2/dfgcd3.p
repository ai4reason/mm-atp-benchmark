...
thf(adfgcd2_ax,axiom,(! [XD:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((XD = (cco @ XM @ XN @ ccgcd)) <=> (cw3a @ (cwbr @ ccc0 @ XD @ ccle) @ ((cwbr @ XD @ XM @ ccdvds) & (cwbr @ XD @ XN @ ccdvds)) @ (cwral @ (^ [Xe:$i] : (((cwbr @ (ccv @ Xe) @ XM @ ccdvds) & (cwbr @ (ccv @ Xe) @ XN @ ccdvds)) => (cwbr @ (ccv @ Xe) @ XD @ ccdvds))) @ (^ [Xe:$i] : ccz))))))))).
...
thf(aad4ant124_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (((cw3a @ Xph @ Xps @ Xch) => Xth) => ((((Xph & Xps) & Xta) & Xch) => Xth)))))))).
...
thf(cdfgcd3_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ XM @ XN @ ccgcd) = (ccrio @ (^ [Xd:$i] : (cwral @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xz) @ (ccv @ Xd) @ ccdvds) <=> ((cwbr @ (ccv @ Xz) @ XM @ ccdvds) & (cwbr @ (ccv @ Xz) @ XN @ ccdvds)))) @ (^ [Xz:$i] : ccz))) @ (^ [Xd:$i] : ccn0))))))).
