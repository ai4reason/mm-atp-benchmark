...
thf(aelznn_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) <=> ((cwcel @ XN @ ccr) & ((cwcel @ XN @ ccn) | (cwcel @ (ccneg @ XN) @ ccn0)))))).
...
thf(celdmgm_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn))) <=> ((cwcel @ XA2 @ ccc) & (~ (cwcel @ (ccneg @ XA2) @ ccn0)))))).
