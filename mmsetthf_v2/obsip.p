...
thf(aisobs_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [Xc_xi:($i > $o)] : (! [Xc_pe:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [XY:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XV @ Xx3 @ Xy1) = (ccfv @ XW @ ccbs)))) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3 @ Xy1) = (ccfv @ XW @ ccsca)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xc_1 = (ccfv @ (XF @ Xx3 @ Xy1) @ ccur)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xc_0 = (ccfv @ (XF @ Xx3 @ Xy1) @ cc0g)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xc_pe @ Xx3 @ Xy1) = (ccfv @ XW @ ccocv)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XY @ Xx3 @ Xy1) = (ccfv @ XW @ cc0g)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XB2 @ (ccfv @ XW @ ccobs)) <=> (cw3a @ (cwcel @ XW @ ccphl) @ (cwss @ XB2 @ (XV @ Xx3 @ Xy1)) @ ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_xi) = (ccif @ ((ccv @ Xx3) = (ccv @ Xy1)) @ Xc_1 @ Xc_0))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)) & ((ccfv @ XB2 @ (Xc_pe @ Xx3 @ Xy1)) = (ccsn @ (XY @ Xx3 @ Xy1))))))))))))))))))))))))).
...
thf(cobsip_conj,conjecture,(! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_1 = (ccfv @ XF @ ccur)) => ((Xc_0 = (ccfv @ XF @ cc0g)) => ((cw3a @ (cwcel @ XB2 @ (ccfv @ XW @ ccobs)) @ (cwcel @ XP @ XB2) @ (cwcel @ XQ @ XB2)) => ((cco @ XP @ XQ @ Xc_xi) = (ccif @ (XP = XQ) @ Xc_1 @ Xc_0)))))))))))))))))).
