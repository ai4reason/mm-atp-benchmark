...
thf(aac5num_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ (ccuni @ XA2) @ (ccdm @ cccrd)) & (~ (cwcel @ cc0 @ XA2))) => (? [Xf1:$i] : ((cwf @ XA2 @ (ccuni @ XA2) @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2))))))).
