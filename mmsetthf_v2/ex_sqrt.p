...
thf(aex_exp_ax,axiom,(((cco @ cc5 @ cc2 @ ccexp) = (ccdc @ cc2 @ cc5)) & ((cco @ (ccneg @ cc3) @ (ccneg @ cc2) @ ccexp) = (cco @ cc1 @ cc9 @ ccdiv)))).
...
thf(cex_sqrt_conj,conjecture,((ccfv @ (ccdc @ cc2 @ cc5) @ ccsqrt) = cc5)).
