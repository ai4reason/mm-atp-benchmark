...
thf(afeq12i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XF = XG) => ((XA2 = XB2) => ((cwf @ XA2 @ XC @ XF) <=> (cwf @ XB2 @ XC @ XG)))))))))).
...
thf(a_0cnv_ax,axiom,((cwcel @ cc0 @ ccc) => (cwbr @ cc0 @ cc0 @ ccli))).
...
thf(cclimlimsupcex_conj,conjecture,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((~ (cwcel @ XM @ ccz)) => ((XZ = (ccfv @ XM @ ccuz)) => ((XF = cc0) => (((cwcel @ cc0 @ ccc) & (~ (cwcel @ ccmnf @ ccc))) => (cw3a @ (cwf @ XZ @ ccr @ XF) @ (cwcel @ XF @ (ccdm @ ccli)) @ (~ (cwbr @ XF @ (ccfv @ XF @ cclsp) @ ccli))))))))))).
