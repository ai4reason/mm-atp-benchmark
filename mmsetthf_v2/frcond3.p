...
thf(cfrcond3_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((cwcel @ XG @ ccfrgr) => ((cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XC @ XV) @ (cwne @ XA2 @ XC)) => (cwrex @ (^ [Xx3:$i] : ((ccin @ (cco @ XG @ XA2 @ ccnbgr) @ (cco @ XG @ XC @ ccnbgr)) = (ccsn @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : XV)))))))))))).
