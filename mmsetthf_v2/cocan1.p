...
thf(ccocan1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : ((cw3a @ (cwf1 @ XB2 @ XC @ XF) @ (cwf @ XA2 @ XB2 @ XH) @ (cwf @ XA2 @ XB2 @ XK)) => (((cccom @ XF @ XH) = (cccom @ XF @ XK)) <=> (XH = XK)))))))))).
