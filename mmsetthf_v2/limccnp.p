...
thf(climccnp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwf @ XA2 @ XD @ XF)) => ((Xph => (cwss @ XD @ ccc)) => ((XK = (ccfv @ cccnfld @ cctopn)) => ((XJ = (cco @ XK @ XD @ ccrest)) => ((Xph => (cwcel @ XC @ (cco @ XF @ XB2 @ cclimc))) => ((Xph => (cwcel @ XG @ (ccfv @ XC @ (cco @ XJ @ XK @ cccnp)))) => (Xph => (cwcel @ (ccfv @ XC @ XG) @ (cco @ (cccom @ XG @ XF) @ XB2 @ cclimc))))))))))))))))))).
