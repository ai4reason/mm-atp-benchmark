...
thf(cpsgninv_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XS = (ccfv @ XD @ ccsymg)) => ((XN = (ccfv @ XD @ ccpsgn)) => ((XP = (ccfv @ XS @ ccbs)) => (((cwcel @ XD @ ccfn) & (cwcel @ XF @ XP)) => ((ccfv @ (cccnv @ XF) @ XN) = (ccfv @ XF @ XN)))))))))))).
