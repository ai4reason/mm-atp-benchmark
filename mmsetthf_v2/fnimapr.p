...
thf(cfnimapr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwfn @ XF @ XA2) @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2)) => ((ccima @ XF @ (ccpr @ XB2 @ XC)) = (ccpr @ (ccfv @ XB2 @ XF) @ (ccfv @ XC @ XF))))))))).
