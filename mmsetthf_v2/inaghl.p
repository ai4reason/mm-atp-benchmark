...
thf(ahlpasch_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccitv)) => ((XK = (ccfv @ XG @ cchlg)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwcel @ XC @ XP)) => ((Xph => (cwcel @ XX @ XP)) => ((Xph => (cwcel @ XD @ XP)) => ((Xph => (cwne @ XA2 @ XB2)) => ((Xph => (cwbr @ XC @ XD @ (ccfv @ XB2 @ XK))) => ((Xph => (cwcel @ XA2 @ (cco @ XX @ XC @ XI))) => (Xph => (cwrex @ (^ [Xe:$i] : ((cwbr @ XA2 @ (ccv @ Xe) @ (ccfv @ XB2 @ XK)) & (cwcel @ (ccv @ Xe) @ (cco @ XX @ XD @ XI)))) @ (^ [Xe:$i] : XP)))))))))))))))))))))))))).
