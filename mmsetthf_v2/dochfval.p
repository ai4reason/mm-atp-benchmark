...
thf(adochffval_ax,axiom,(! [XB2:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_pe:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xw:$i] : ((XB2 @ Xx3 @ Xw) = (ccfv @ XK @ ccbs)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((XG @ Xx3 @ Xy1 @ Xw) = (ccfv @ XK @ ccglb))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((Xc_pe @ Xx3 @ Xy1 @ Xw) = (ccfv @ XK @ ccoc))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XH @ Xx3 @ Xy1) = (ccfv @ XK @ cclh)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((cwcel @ XK @ (XV @ Xx3 @ Xy1 @ Xw)) => ((ccfv @ XK @ ccoch) = (ccmpt @ (^ [Xw:$i] : (XH @ Xx3 @ Xy1)) @ (^ [Xw:$i] : (ccmpt @ (^ [Xx3:$i] : (ccpw @ (ccfv @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdvh)) @ ccbs))) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccfv @ (ccrab @ (^ [Xy1:$i] : (cwss @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdih))))) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xw))) @ (XG @ Xx3 @ Xy1 @ Xw)) @ (Xc_pe @ Xx3 @ Xy1 @ Xw)) @ (ccfv @ (ccv @ Xw) @ (ccfv @ XK @ ccdih))))))))))))))))))))))).
