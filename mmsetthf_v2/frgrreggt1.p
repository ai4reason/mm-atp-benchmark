...
thf(anumclwwlk8_ax,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XG @ ccfusgr) & (cwcel @ XP @ ccprime)) => ((cco @ (ccfv @ (cco @ XP @ XG @ ccclwwlkn) @ cchash) @ XP @ ccmo) = ccc0))))).
...
thf(anumclwwlk7_ax,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cw3a @ ((cwbr @ XG @ XK @ ccrusgr) & (cwcel @ XG @ ccfrgr)) @ ((cwne @ XV @ cc0) & (cwcel @ XV @ ccfn)) @ ((cwcel @ XP @ ccprime) & (cwbr @ XP @ (cco @ XK @ cc1 @ ccmin) @ ccdvds))) => ((cco @ (ccfv @ (cco @ XP @ XG @ ccclwwlkn) @ cchash) @ XP @ ccmo) = cc1)))))))).
...
thf(cfrgrreggt1_conj,conjecture,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cw3a @ (cwcel @ XG @ ccfrgr) @ (cwcel @ XV @ ccfn) @ (cwne @ XV @ cc0)) => (((cwbr @ XG @ XK @ ccrusgr) & (cwbr @ cc1 @ XK @ cclt)) => (XK = cc2)))))))).
