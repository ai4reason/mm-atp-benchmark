...
thf(adfrelog_ax,axiom,((ccres @ cclog @ ccrp) = (cccnv @ (ccres @ cce @ ccr)))).
...
thf(advcnvre_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ XX @ ccr @ cccncf))) => ((Xph => ((ccdm @ (cco @ ccr @ XF @ ccdv)) = XX)) => ((Xph => (~ (cwcel @ ccc0 @ (ccrn @ (cco @ ccr @ XF @ ccdv))))) => ((Xph => (cwf1o @ XX @ XY @ XF)) => (Xph => ((cco @ ccr @ (cccnv @ XF) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XY) @ (^ [Xx3:$i] : (cco @ cc1 @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (cccnv @ XF)) @ (cco @ ccr @ XF @ ccdv)) @ ccdiv)))))))))))))).
...
thf(areeff1o_ax,axiom,(cwf1o @ ccr @ ccrp @ (ccres @ cce @ ccr))).
...
thf(cdvrelog_conj,conjecture,((cco @ ccr @ (ccres @ cclog @ ccrp) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ cc1 @ (ccv @ Xx3) @ ccdiv))))).
