...
thf(aflpmodeq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccrp)) => ((cco @ (cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccfl) @ XB2 @ ccmul) @ (cco @ XA2 @ XB2 @ ccmo) @ ccaddc) = XA2))))).
...
thf(cmodn0mul_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccn)) => ((cwne @ (cco @ XA2 @ XN @ ccmo) @ ccc0) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (XA2 = (cco @ (cco @ (ccv @ Xx3) @ XN @ ccmul) @ (ccv @ Xy1) @ ccaddc))) @ (^ [Xy1:$i] : (cco @ cc1 @ XN @ ccfzo)))) @ (^ [Xx3:$i] : ccz))))))).
