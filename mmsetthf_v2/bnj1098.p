...
thf(cbnj1098_conj,conjecture,(! [XD:($i > $o)] : (! [Xi:$i] : (! [Xn:$i] : ((XD = (ccdif @ ccom @ (ccsn @ cc0))) => (? [Xj:$i] : ((cw3a @ (cwne @ (ccv @ Xi) @ cc0) @ (cwcel @ (ccv @ Xi) @ (ccv @ Xn)) @ (cwcel @ (ccv @ Xn) @ XD)) => ((cwcel @ (ccv @ Xj) @ (ccv @ Xn)) & ((ccv @ Xi) = (ccsuc @ (ccv @ Xj))))))))))).
