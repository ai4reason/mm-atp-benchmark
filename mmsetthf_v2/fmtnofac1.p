...
thf(afmtnofac2_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XM @ ccn) @ (cwbr @ XM @ (ccfv @ XN @ ccfmtno) @ ccdvds)) => (cwrex @ (^ [Xk:$i] : (XM = (cco @ (cco @ (ccv @ Xk) @ (cco @ cc2 @ (cco @ XN @ cc2 @ ccaddc) @ ccexp) @ ccmul) @ cc1 @ ccaddc))) @ (^ [Xk:$i] : ccn0)))))).
...
thf(cfmtnofac1_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XM @ ccn) @ (cwbr @ XM @ (ccfv @ XN @ ccfmtno) @ ccdvds)) => (cwrex @ (^ [Xk:$i] : (XM = (cco @ (cco @ (ccv @ Xk) @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ ccmul) @ cc1 @ ccaddc))) @ (^ [Xk:$i] : ccn0)))))).
