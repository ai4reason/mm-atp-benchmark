...
thf(aphicl_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => (cwcel @ (ccfv @ XN @ ccphi) @ ccn)))).
thf(ccmul_tp,type,(ccmul : ($i > $o))).
thf(aplypow_ax,axiom,(! [XS:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwss @ XS @ ccc) @ (cwcel @ cc1 @ XS) @ (cwcel @ XN @ ccn0)) => (cwcel @ (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (cco @ (ccv @ Xz) @ XN @ ccexp))) @ (ccfv @ XS @ ccply)))))).
...
thf(ane0p_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ (ccfv @ XA2 @ XF) @ ccc0)) => (cwne @ XF @ cc0p))))).
...
thf(aznfi_ax,axiom,(! [XB2:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XN @ cczn)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((cwcel @ XN @ ccn) => (cwcel @ XB2 @ ccfn)))))))).
...
thf(amhmmulg_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_xp = (ccfv @ XH @ ccmg)) => ((cw3a @ (cwcel @ XF @ (cco @ XG @ XH @ ccmhm)) @ (cwcel @ XN @ ccn0) @ (cwcel @ XX @ XB2)) => ((ccfv @ (cco @ XN @ XX @ Xc_x) @ XF) = (cco @ XN @ (ccfv @ XX @ XF) @ Xc_xp))))))))))))))).
...
thf(aznunithash_ax,axiom,(! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XN @ cczn)) => ((XU = (ccfv @ XY @ ccui)) => ((cwcel @ XN @ ccn) => ((ccfv @ XU @ cchash) = (ccfv @ XN @ ccphi))))))))).
...
thf(aoddvds2_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XX @ ccfn) @ (cwcel @ XA2 @ XX)) => (cwbr @ (ccfv @ XA2 @ XO) @ (ccfv @ XX @ cchash) @ ccdvds))))))))).
...
thf(aunitsubm_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : ((XU = (ccfv @ XR @ ccui)) => ((XM = (ccfv @ XR @ ccmgp)) => ((cwcel @ XR @ ccrg) => (cwcel @ XU @ (ccfv @ XM @ ccsubmnd))))))))).
thf(ccseq_tp,type,(ccseq : (($i > $o) > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(asubmmulg_ax,axiom,(! [XS:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xc_xb = (ccfv @ XG @ ccmg)) => ((XH = (cco @ XG @ XS @ ccress)) => ((Xc_x = (ccfv @ XH @ ccmg)) => ((cw3a @ (cwcel @ XS @ (ccfv @ XG @ ccsubmnd)) @ (cwcel @ XN @ ccn0) @ (cwcel @ XX @ XS)) => ((cco @ XN @ XX @ Xc_xb) = (cco @ XN @ XX @ Xc_x)))))))))))))).
...
thf(acnfldexp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccn0)) => ((cco @ XB2 @ XA2 @ (ccfv @ (ccfv @ cccnfld @ ccmgp) @ ccmg)) = (cco @ XA2 @ XB2 @ ccexp)))))).
...
thf(cdchrfi_conj,conjecture,(! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XD = (ccfv @ XG @ ccbs)) => ((cwcel @ XN @ ccn) => (cwcel @ XD @ ccfn)))))))).
