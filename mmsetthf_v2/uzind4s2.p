...
thf(cuzind4s2_conj,conjecture,(! [Xph:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : ((cwcel @ (XM @ Xj) @ ccz) => (cwsbc @ (^ [Xj:$i] : (Xph @ Xj)) @ (XM @ Xj)))) => ((! [Xj:$i] : (! [Xk:$i] : ((cwcel @ (ccv @ Xk) @ (ccfv @ (XM @ Xj) @ ccuz)) => ((cwsbc @ (^ [Xj:$i] : (Xph @ Xj)) @ (ccv @ Xk)) => (cwsbc @ (^ [Xj:$i] : (Xph @ Xj)) @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc)))))) => (! [Xj:$i] : (! [Xk:$i] : ((cwcel @ (XN @ Xj @ Xk) @ (ccfv @ (XM @ Xj) @ ccuz)) => (cwsbc @ (^ [Xj:$i] : (Xph @ Xj)) @ (XN @ Xj @ Xk))))))))))).
