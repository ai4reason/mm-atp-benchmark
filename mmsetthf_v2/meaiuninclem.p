...
thf(afzoct_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwbr @ (cco @ XN @ XM @ ccfzo) @ ccom @ ccdom)))).
...
thf(afzossuz_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwss @ (cco @ XM @ XN @ ccfzo) @ (ccfv @ XM @ ccuz))))).
...
thf(aiunincfi_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ (cco @ XM @ XN @ ccfzo))) => (cwss @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XF)))) => (Xph => ((cciun @ (^ [Xn:$i] : (cco @ XM @ XN @ ccfz)) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XF))) = (ccfv @ XN @ XF)))))))))).
...
thf(afzct_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwbr @ (cco @ XN @ XM @ ccfz) @ ccom @ ccdom)))).
