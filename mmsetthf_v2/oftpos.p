...
thf(adftpos4_ax,axiom,(! [XF:($i > $o)] : ((cctpos @ XF) = (cccom @ XF @ (ccmpt @ (^ [Xx3:$i] : (ccun @ (ccxp @ ccvv @ ccvv) @ (ccsn @ cc0))) @ (^ [Xx3:$i] : (ccuni @ (cccnv @ (ccsn @ (ccv @ Xx3)))))))))).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(atposexg_ax,axiom,(! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XF @ XV) => (cwcel @ (cctpos @ XF) @ ccvv))))).
thf(cwral_tp,type,(cwral : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(cwfn_tp,type,(cwfn : (($i > $o) > (($i > $o) > $o)))).
thf(ccfv_tp,type,(ccfv : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccima_tp,type,(ccima : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aofco2_ax,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((((cwcel @ XF @ ccvv) & (cwcel @ XG @ ccvv)) & (cw3a @ (cwfun @ XH) @ (cwcel @ (cccom @ XF @ XH) @ ccvv) @ (cwcel @ (cccom @ XG @ XH) @ ccvv))) => ((cccom @ (cco @ XF @ XG @ (ccof @ XR)) @ XH) = (cco @ (cccom @ XF @ XH) @ (cccom @ XG @ XH) @ (ccof @ XR))))))))).
thf(aoveq12i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((XC = XD) => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XD @ XF)))))))))).
thf(coftpos_conj,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XF @ XV) & (cwcel @ XG @ XW)) => ((cctpos @ (cco @ XF @ XG @ (ccof @ XR))) = (cco @ (cctpos @ XF) @ (cctpos @ XG) @ (ccof @ XR)))))))))).
