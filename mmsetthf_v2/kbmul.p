...
thf(ckbmul_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil)) => ((cco @ (cco @ XA2 @ XB2 @ ccsm) @ XC @ cck) = (cco @ XB2 @ (cco @ (ccfv @ XA2 @ cccj) @ XC @ ccsm) @ cck))))))).
