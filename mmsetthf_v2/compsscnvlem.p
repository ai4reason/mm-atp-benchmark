...
thf(ccompsscnvlem_conj,conjecture,(! [Xx3:$i] : (! [XA2:($i > $o)] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (ccpw @ XA2)) & ((ccv @ Xy1) = (ccdif @ XA2 @ (ccv @ Xx3)))) => ((cwcel @ (ccv @ Xy1) @ (ccpw @ XA2)) & ((ccv @ Xx3) = (ccdif @ XA2 @ (ccv @ Xy1))))))))).
