...
thf(aislshpat_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XS = (ccfv @ XW @ cclss)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((! [Xq:$i] : ((XH @ Xq) = (ccfv @ XW @ cclsh))) => ((! [Xq:$i] : ((XA2 @ Xq) = (ccfv @ XW @ cclsa))) => ((Xph => (cwcel @ XW @ cclmod)) => (! [Xq:$i] : (Xph => ((cwcel @ XU @ (XH @ Xq)) <=> (cw3a @ (cwcel @ XU @ XS) @ (cwne @ XU @ XV) @ (cwrex @ (^ [Xq:$i] : ((cco @ XU @ (ccv @ Xq) @ Xc_po) = XV)) @ (^ [Xq:$i] : (XA2 @ Xq)))))))))))))))))))))).
...
thf(alcv2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((XS = (ccfv @ XW @ cclss)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((XA2 = (ccfv @ XW @ cclsa)) => ((XC = (ccfv @ XW @ cclcv)) => ((Xph => (cwcel @ XW @ cclvec)) => ((Xph => (cwcel @ XU @ XS)) => ((Xph => (cwcel @ XQ @ XA2)) => (Xph => ((cwpss @ XU @ (cco @ XU @ XQ @ Xc_po)) <=> (cwbr @ XU @ (cco @ XU @ XQ @ Xc_po) @ XC))))))))))))))))))).
...
thf(alcvat_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [Xc_po:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : ((XS = (ccfv @ XW @ cclss)) => ((! [Xq:$i] : ((Xc_po @ Xq) = (ccfv @ XW @ cclsm))) => ((XA2 = (ccfv @ XW @ cclsa)) => ((! [Xq:$i] : ((XC @ Xq) = (ccfv @ XW @ cclcv))) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XT @ XS)) => ((Xph => (cwcel @ XU @ XS)) => ((! [Xq:$i] : (Xph => (cwbr @ XT @ XU @ (XC @ Xq)))) => (Xph => (cwrex @ (^ [Xq:$i] : ((cco @ XT @ (ccv @ Xq) @ (Xc_po @ Xq)) = XU)) @ (^ [Xq:$i] : XA2)))))))))))))))))))).
thf(cislshpcv_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XS = (ccfv @ XW @ cclss)) => ((XH = (ccfv @ XW @ cclsh)) => ((XC = (ccfv @ XW @ cclcv)) => ((Xph => (cwcel @ XW @ cclvec)) => (Xph => ((cwcel @ XU @ XH) <=> ((cwcel @ XU @ XS) & (cwbr @ XU @ XV @ XC))))))))))))))))).
