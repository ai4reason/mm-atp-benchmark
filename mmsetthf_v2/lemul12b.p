...
thf(clemul12b_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle)) & (cwcel @ XB2 @ ccr)) & ((cwcel @ XC @ ccr) & ((cwcel @ XD @ ccr) & (cwbr @ ccc0 @ XD @ ccle)))) => (((cwbr @ XA2 @ XB2 @ ccle) & (cwbr @ XC @ XD @ ccle)) => (cwbr @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XD @ ccmul) @ ccle)))))))).
