...
thf(anpss0_ax,axiom,(! [XA2:($i > $o)] : (~ (cwpss @ XA2 @ cc0)))).
...
thf(aorddif_ax,axiom,(! [XA2:($i > $o)] : ((cword @ XA2) => (XA2 = (ccdif @ (ccsuc @ XA2) @ (ccsn @ XA2)))))).
...
thf(aeqelsuc_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((XA2 = XB2) => (cwcel @ XA2 @ (ccsuc @ XB2))))))).
...
thf(cpssnn_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccom) & (cwpss @ XB2 @ XA2)) => (cwrex @ (^ [Xx3:$i] : (cwbr @ XB2 @ (ccv @ Xx3) @ ccen)) @ (^ [Xx3:$i] : XA2)))))).
