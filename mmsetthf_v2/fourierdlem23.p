...
thf(aaddccncf2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ XB2 @ (ccv @ Xx3) @ ccaddc))))) => (! [Xx3:$i] : (((cwss @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => (cwcel @ (XF @ Xx3) @ (cco @ XA2 @ ccc @ cccncf))))))))).
