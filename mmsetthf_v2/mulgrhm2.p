...
thf(aghmmulg_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_xp = (ccfv @ XH @ ccmg)) => ((cw3a @ (cwcel @ XF @ (cco @ XG @ XH @ ccghm)) @ (cwcel @ XN @ ccz) @ (cwcel @ XX @ XB2)) => ((ccfv @ (cco @ XN @ XX @ Xc_x) @ XF) = (cco @ XN @ (ccfv @ XX @ XF) @ Xc_xp))))))))))))))).
...
thf(azringmulg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => ((cco @ XA2 @ XB2 @ (ccfv @ czring @ ccmg)) = (cco @ XA2 @ XB2 @ ccmul)))))).
...
thf(amulgrhm_ax,axiom,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > $o))] : ((Xc_x = (ccfv @ XR @ ccmg)) => ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccz) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ Xc_1 @ Xc_x))))) => ((Xc_1 = (ccfv @ XR @ ccur)) => (! [Xn:$i] : ((cwcel @ XR @ ccrg) => (cwcel @ (XF @ Xn) @ (cco @ czring @ XR @ ccrh)))))))))))).
thf(cmulgrhm2_conj,conjecture,(! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > $o))] : ((Xc_x = (ccfv @ XR @ ccmg)) => ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccz) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ Xc_1 @ Xc_x))))) => ((Xc_1 = (ccfv @ XR @ ccur)) => (! [Xn:$i] : ((cwcel @ XR @ ccrg) => ((cco @ czring @ XR @ ccrh) = (ccsn @ (XF @ Xn))))))))))))).
