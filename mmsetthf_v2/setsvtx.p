...
thf(asetsn0fun_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwbr @ XS @ XX @ ccstr)) => ((Xph => (cwcel @ XI @ XU)) => ((Xph => (cwcel @ XE @ XW)) => (Xph => (cwfun @ (ccdif @ (cco @ XS @ (ccop @ XI @ XE) @ ccsts) @ (ccsn @ cc0))))))))))))))).
...
thf(abasprssdmsets_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwbr @ XS @ XX @ ccstr)) => ((Xph => (cwcel @ XI @ XU)) => ((Xph => (cwcel @ XE @ XW)) => ((Xph => (cwcel @ (ccfv @ ccnx @ ccbs) @ (ccdm @ XS))) => (Xph => (cwss @ (ccpr @ (ccfv @ ccnx @ ccbs) @ XI) @ (ccdm @ (cco @ XS @ (ccop @ XI @ XE) @ ccsts)))))))))))))))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(afunvtxval_ax,axiom,(! [XG:($i > $o)] : (((cwfun @ (ccdif @ XG @ (ccsn @ cc0))) & (cwss @ (ccpr @ (ccfv @ ccnx @ ccbs) @ (ccfv @ ccnx @ ccedgf)) @ (ccdm @ XG))) => ((ccfv @ XG @ ccvtx) = (ccfv @ XG @ ccbs))))).
