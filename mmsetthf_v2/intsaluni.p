...
thf(cintsaluni_conj,conjecture,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwss @ XG @ ccsalg)) => ((Xph => (cwne @ XG @ cc0)) => ((! [Xs1:$i] : ((Xph & (cwcel @ (ccv @ Xs1) @ XG)) => ((ccuni @ (ccv @ Xs1)) = XX))) => (Xph => ((ccuni @ (ccint @ XG)) = XX))))))))).
