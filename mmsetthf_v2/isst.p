...
thf(achex_ax,axiom,(cwcel @ ccch @ ccvv)).
...
thf(cisst_conj,conjecture,(! [XS:($i > $o)] : ((cwcel @ XS @ ccst) <=> (cw3a @ (cwf @ ccch @ (cco @ ccc0 @ cc1 @ ccicc) @ XS) @ ((ccfv @ cchil @ XS) = cc1) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwss @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ ccort)) => ((ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ cchj) @ XS) = (cco @ (ccfv @ (ccv @ Xx3) @ XS) @ (ccfv @ (ccv @ Xy1) @ XS) @ ccaddc)))) @ (^ [Xy1:$i] : ccch))) @ (^ [Xx3:$i] : ccch)))))).
