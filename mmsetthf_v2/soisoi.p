...
thf(csoisoi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : ((((cwor @ XA2 @ XR) & (cwpo @ XB2 @ XS)) & ((cwfo @ XA2 @ XB2 @ XH) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) => (cwbr @ (ccfv @ (ccv @ Xx3) @ XH) @ (ccfv @ (ccv @ Xy1) @ XH) @ XS))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)))) => (cwiso @ XA2 @ XB2 @ XR @ XS @ XH)))))))).
