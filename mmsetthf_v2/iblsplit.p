...
thf(ambfres2cn_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwcel @ (ccres @ XF @ XB2) @ ccmbf)) => ((Xph => (cwcel @ (ccres @ XF @ XC) @ ccmbf)) => ((Xph => ((ccun @ XB2 @ XC) = XA2)) => (Xph => (cwcel @ XF @ ccmbf)))))))))))).
...
thf(ciblsplit_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XU:($i > $o)] : ((Xph => ((ccfv @ (ccin @ XA2 @ XB2) @ ccovol) = ccc0)) => ((Xph => (XU = (ccun @ XA2 @ XB2))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XU)) => (cwcel @ (XC @ Xx3) @ ccc))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ ccibl)) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3))) @ ccibl)) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XU) @ (^ [Xx3:$i] : (XC @ Xx3))) @ ccibl))))))))))))).
