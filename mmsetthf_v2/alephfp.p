...
thf(aalephfplem4_ax,axiom,(! [XH:($i > $o)] : ((XH = (ccres @ (ccrdg @ ccale @ ccom) @ ccom)) => (cwcel @ (ccuni @ (ccima @ XH @ ccom)) @ (ccrn @ ccale))))).
thf(asylbir_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xps <=> Xph) => ((Xps => Xch) => (Xph => Xch))))))).
thf(aisinfcard_ax,axiom,(! [XA2:($i > $o)] : (((cwss @ ccom @ XA2) & ((ccfv @ XA2 @ cccrd) = XA2)) <=> (cwcel @ XA2 @ (ccrn @ ccale))))).
...
thf(aalephle_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (cwss @ XA2 @ (ccfv @ XA2 @ ccale))))).
...
thf(aalephsson_ax,axiom,(cwss @ (ccrn @ ccale) @ ccon0)).
thf(aalephfplem3_ax,axiom,(! [XH:($i > $o)] : ((XH = (ccres @ (ccrdg @ ccale @ ccom) @ ccom)) => (! [Xv:$i] : ((cwcel @ (ccv @ Xv) @ ccom) => (cwcel @ (ccfv @ (ccv @ Xv) @ XH) @ (ccrn @ ccale))))))).
thf(aalephord2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccon0) => ((cwcel @ XA2 @ XB2) => (cwcel @ (ccfv @ XA2 @ ccale) @ (ccfv @ XB2 @ ccale))))))).
thf(asseld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwss @ XA2 @ XB2)) => (Xph => ((cwcel @ XC @ XA2) => (cwcel @ XC @ XB2))))))))).
thf(aeqeltrrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (cwcel @ XA2 @ XC)) => (Xph => (cwcel @ XB2 @ XC))))))))).
thf(aalephfplem2_ax,axiom,(! [Xw:$i] : (! [XH:($i > $o)] : ((XH = (ccres @ (ccrdg @ ccale @ ccom) @ ccom)) => ((cwcel @ (ccv @ Xw) @ ccom) => ((ccfv @ (ccsuc @ (ccv @ Xw)) @ XH) = (ccfv @ (ccfv @ (ccv @ Xw) @ XH) @ ccale))))))).
...
thf(aordtri4_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cword @ XA2) & (cword @ XB2)) => ((XA2 = XB2) <=> ((cwss @ XA2 @ XB2) & (~ (cwcel @ XA2 @ XB2)))))))).
thf(aadantl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xch & Xph) => Xps)))))).
thf(aeqeq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((XC = XA2) <=> (XC = XB2))))))).
thf(calephfp_conj,conjecture,(! [XH:($i > $o)] : ((XH = (ccres @ (ccrdg @ ccale @ ccom) @ ccom)) => ((ccfv @ (ccuni @ (ccima @ XH @ ccom)) @ ccale) = (ccuni @ (ccima @ XH @ ccom)))))).
