...
thf(afnessex_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : ((cw3a @ (cwbr @ XA2 @ XB2 @ ccfne) @ (cwcel @ XS @ XA2) @ (cwcel @ XP @ XS)) => (cwrex @ (^ [Xx3:$i] : ((cwcel @ XP @ (ccv @ Xx3)) & (cwss @ (ccv @ Xx3) @ XS))) @ (^ [Xx3:$i] : XB2)))))))).
...
thf(cfnessref_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XA2)) => ((XY = (ccuni @ XB2)) => ((XX = XY) => ((cwbr @ XA2 @ XB2 @ ccfne) <=> (? [Xc:$i] : ((cwss @ (ccv @ Xc) @ XB2) & ((cwbr @ XA2 @ (ccv @ Xc) @ ccfne) & (cwbr @ (ccv @ Xc) @ XA2 @ ccref))))))))))))).
