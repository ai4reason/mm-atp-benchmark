...
thf(cghmf1_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XS @ ccbs)) => ((XY = (ccfv @ XT @ ccbs)) => ((Xc_0 = (ccfv @ XS @ cc0g)) => ((XU = (ccfv @ XT @ cc0g)) => ((cwcel @ XF @ (cco @ XS @ XT @ ccghm)) => ((cwf1 @ XX @ XY @ XF) <=> (cwral @ (^ [Xx3:$i] : (((ccfv @ (ccv @ Xx3) @ XF) = XU) => ((ccv @ Xx3) = Xc_0))) @ (^ [Xx3:$i] : XX)))))))))))))))).
