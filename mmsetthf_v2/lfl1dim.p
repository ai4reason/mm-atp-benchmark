...
thf(apm2_61da2ne_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((Xph & (XA2 = XB2)) => Xps) => (((Xph & (XC = XD)) => Xps) => (((Xph & ((cwne @ XA2 @ XB2) & (cwne @ XC @ XD))) => Xps) => (Xph => Xps))))))))))).
...
thf(alfl0sc_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XD = (ccfv @ XW @ ccsca)) => ((XF = (ccfv @ XW @ cclfn)) => ((XK = (ccfv @ XD @ ccbs)) => ((Xc_x = (ccfv @ XD @ ccmulr)) => ((Xc_0 = (ccfv @ XD @ cc0g)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XG @ XF)) => (Xph => ((cco @ XG @ (ccxp @ XV @ (ccsn @ Xc_0)) @ (ccof @ Xc_x)) = (ccxp @ XV @ (ccsn @ Xc_0)))))))))))))))))))))).
...
thf(alkrshp_ax,axiom,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XD = (ccfv @ XW @ ccsca)) => ((Xc_0 = (ccfv @ XD @ cc0g)) => ((XH = (ccfv @ XW @ cclsh)) => ((XF = (ccfv @ XW @ cclfn)) => ((XK = (ccfv @ XW @ cclk)) => ((cw3a @ (cwcel @ XW @ cclvec) @ (cwcel @ XG @ XF) @ (cwne @ XG @ (ccxp @ XV @ (ccsn @ Xc_0)))) => (cwcel @ (ccfv @ XG @ XK) @ XH))))))))))))))))).
...
thf(aeqlkr2_ax,axiom,(! [XD:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XD = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XD @ ccbs)) => ((Xc_x = (ccfv @ XD @ ccmulr)) => ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ cclfn)) => ((XL = (ccfv @ XW @ cclk)) => ((cw3a @ (cwcel @ XW @ cclvec) @ ((cwcel @ XG @ XF) & (cwcel @ XH @ XF)) @ ((ccfv @ XG @ XL) = (ccfv @ XH @ XL))) => (cwrex @ (^ [Xr:$i] : (XH = (cco @ XG @ (ccxp @ XV @ (ccsn @ (ccv @ Xr))) @ (ccof @ Xc_x)))) @ (^ [Xr:$i] : XK))))))))))))))))))).
...
thf(alflvscl_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XD = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XD @ ccbs)) => ((Xc_x = (ccfv @ XD @ ccmulr)) => ((XF = (ccfv @ XW @ cclfn)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XG @ XF)) => ((Xph => (cwcel @ XR @ XK)) => (Xph => (cwcel @ (cco @ XG @ (ccxp @ XV @ (ccsn @ XR)) @ (ccof @ Xc_x)) @ XF)))))))))))))))))))).
