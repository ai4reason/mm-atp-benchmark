...
thf(aranksng_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((ccfv @ (ccsn @ XA2) @ ccrnk) = (ccsuc @ (ccfv @ XA2 @ ccrnk))))))).
...
thf(aelhf2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XA2 @ cchf) <=> (cwcel @ (ccfv @ XA2 @ ccrnk) @ ccom))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(ccpr_tp,type,(ccpr : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(asnex_ax,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccsn @ XA2) @ ccvv))).
thf(chfsn_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ cchf) => (cwcel @ (ccsn @ XA2) @ cchf)))).
