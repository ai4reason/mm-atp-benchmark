...
thf(cfunvtxvalOLD_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XG @ XV) @ (cwfun @ (ccdif @ XG @ (ccsn @ cc0))) @ (cwss @ (ccpr @ (ccfv @ ccnx @ ccbs) @ (ccfv @ ccnx @ ccedgf)) @ (ccdm @ XG))) => ((ccfv @ XG @ ccvtx) = (ccfv @ XG @ ccbs)))))).
