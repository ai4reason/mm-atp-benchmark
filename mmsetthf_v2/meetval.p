...
thf(ameetfval2_ax,axiom,(! [XG:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_an:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XG @ Xx3 @ Xy1) = (ccfv @ XK @ ccglb)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xc_an @ Xx3 @ Xy1 @ Xz) = (ccfv @ XK @ ccmee))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ XK @ (XV @ Xx3 @ Xy1 @ Xz)) => ((Xc_an @ Xx3 @ Xy1 @ Xz) = (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : ((cwcel @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccdm @ (XG @ Xx3 @ Xy1))) & ((ccv @ Xz) = (ccfv @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (XG @ Xx3 @ Xy1)))))))))))))))))))).
...
thf(aovigg_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cw3a @ ((ccv @ Xx3) = XA2) @ ((ccv @ Xy1) = XB2) @ ((ccv @ Xz) = XC)) => ((Xph @ Xx3 @ Xy1 @ Xz) <=> Xps))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwmo @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XF @ Xx3 @ Xy1 @ Xz) = (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cw3a @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xz)) @ (cwcel @ XB2 @ (XW @ Xx3 @ Xy1 @ Xz)) @ (cwcel @ XC @ (XX @ Xx3 @ Xy1 @ Xz))) => (Xps => ((cco @ XA2 @ XB2 @ (XF @ Xx3 @ Xy1 @ Xz)) = XC))))))))))))))))))).
...
thf(cmeetval_conj,conjecture,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XK @ ccglb)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((Xph => (cwcel @ XK @ XV)) => ((Xph => (cwcel @ XX @ XW)) => ((Xph => (cwcel @ XY @ XZ)) => (Xph => ((cco @ XX @ XY @ Xc_an) = (ccfv @ (ccpr @ XX @ XY) @ XG)))))))))))))))))).
