...
thf(acantnfp1lem1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XS = (ccdm @ (cco @ XA2 @ XB2 @ cccnf))) => ((Xph => (cwcel @ XA2 @ ccon0)) => ((Xph => (cwcel @ XB2 @ ccon0)) => ((Xph => (cwcel @ XG @ XS)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XA2)) => ((Xph => (cwss @ (cco @ XG @ cc0 @ ccsupp) @ XX)) => ((! [Xt:$i] : ((XF @ Xt) = (ccmpt @ (^ [Xt:$i] : XB2) @ (^ [Xt:$i] : (ccif @ ((ccv @ Xt) = XX) @ XY @ (ccfv @ (ccv @ Xt) @ XG)))))) => (! [Xt:$i] : (Xph => (cwcel @ (XF @ Xt) @ XS)))))))))))))))))))).
...
thf(aunizlim_ax,axiom,(! [XA2:($i > $o)] : ((cword @ XA2) => ((XA2 = (ccuni @ XA2)) <=> ((XA2 = cc0) | (cwlim @ XA2)))))).
...
thf(ccantnfp1lem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XS = (ccdm @ (cco @ XA2 @ XB2 @ cccnf))) => ((Xph => (cwcel @ XA2 @ ccon0)) => ((Xph => (cwcel @ XB2 @ ccon0)) => ((Xph => (cwcel @ XG @ XS)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XA2)) => ((Xph => (cwss @ (cco @ XG @ cc0 @ ccsupp) @ XX)) => ((! [Xt:$i] : ((XF @ Xt) = (ccmpt @ (^ [Xt:$i] : XB2) @ (^ [Xt:$i] : (ccif @ ((ccv @ Xt) = XX) @ XY @ (ccfv @ (ccv @ Xt) @ XG)))))) => ((Xph => (cwcel @ cc0 @ XY)) => ((! [Xt:$i] : ((XO @ Xt) = (ccoi @ (cco @ (XF @ Xt) @ cc0 @ ccsupp) @ ccep))) => (! [Xt:$i] : (Xph => ((ccdm @ (XO @ Xt)) = (ccsuc @ (ccuni @ (ccdm @ (XO @ Xt))))))))))))))))))))))))))).
