...
thf(crabdiophlem2_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (cco @ XN @ cc1 @ ccaddc)) => (((cwcel @ XN @ ccn0) & (cwcel @ (ccmpt @ (^ [Xu:$i] : (cco @ ccz @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) @ (^ [Xu:$i] : (XA2 @ Xu))) @ (ccfv @ (cco @ cc1 @ XN @ ccfz) @ ccmzp))) => (cwcel @ (ccmpt @ (^ [Xt:$i] : (cco @ ccz @ (cco @ cc1 @ XM @ ccfz) @ ccmap)) @ (^ [Xt:$i] : (ccsb @ (ccres @ (ccv @ Xt) @ (cco @ cc1 @ XN @ ccfz)) @ (^ [Xu:$i] : (XA2 @ Xu))))) @ (ccfv @ (cco @ cc1 @ XM @ ccfz) @ ccmzp)))))))).
