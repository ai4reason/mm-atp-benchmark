...
thf(crngoa4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XX = (ccrn @ XG)) => ((cw3a @ (cwcel @ XR @ ccrngo) @ ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX)) @ ((cwcel @ XC @ XX) & (cwcel @ XD @ XX))) => ((cco @ (cco @ XA2 @ XB2 @ XG) @ (cco @ XC @ XD @ XG) @ XG) = (cco @ (cco @ XA2 @ XC @ XG) @ (cco @ XB2 @ XD @ XG) @ XG))))))))))))).
