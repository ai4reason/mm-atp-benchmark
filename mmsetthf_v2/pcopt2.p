...
thf(aiihalf2_ax,axiom,(! [XX:($i > $o)] : ((cwcel @ XX @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ cc1 @ ccicc)) => (cwcel @ (cco @ (cco @ cc2 @ XX @ ccmul) @ cc1 @ ccmin) @ (cco @ ccc0 @ cc1 @ ccicc))))).
...
thf(aelii1_ax,axiom,(! [XX:($i > $o)] : ((cwcel @ XX @ (cco @ ccc0 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccicc)) <=> ((cwcel @ XX @ (cco @ ccc0 @ cc1 @ ccicc)) & (cwbr @ XX @ (cco @ cc1 @ cc2 @ ccdiv) @ ccle))))).
thf(aiihalf1_ax,axiom,(! [XX:($i > $o)] : ((cwcel @ XX @ (cco @ ccc0 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccicc)) => (cwcel @ (cco @ cc2 @ XX @ ccmul) @ (cco @ ccc0 @ cc1 @ ccicc))))).
...
thf(acnmpt2c_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XJ @ Xx3 @ Xy1) @ (ccfv @ XX @ cctopon))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XK @ Xx3 @ Xy1) @ (ccfv @ XY @ cctopon))))) => ((Xph => (cwcel @ XL @ (ccfv @ XZ @ cctopon))) => ((Xph => (cwcel @ XP @ XZ)) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XY)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XP))) @ (cco @ (cco @ (XJ @ Xx3 @ Xy1) @ (XK @ Xx3 @ Xy1) @ cctx) @ XL @ cccn)))))))))))))))))).
...
thf(cpcopt2_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccxp @ (cco @ ccc0 @ cc1 @ ccicc) @ (ccsn @ XY))) => (((cwcel @ XF @ (cco @ ccii @ XJ @ cccn)) & ((ccfv @ cc1 @ XF) = XY)) => (cwbr @ (cco @ XF @ XP @ (ccfv @ XJ @ ccpco)) @ XF @ (ccfv @ XJ @ ccphtpc))))))))).
