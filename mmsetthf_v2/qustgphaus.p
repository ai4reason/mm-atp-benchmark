...
thf(aqus0_ax,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_0:($i > $o)] : ((XH = (cco @ XG @ (cco @ XG @ XS @ ccqg) @ ccqus)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((cwcel @ XS @ (ccfv @ XG @ ccnsg)) => ((ccec @ Xc_0 @ (cco @ XG @ XS @ ccqg)) = (ccfv @ XH @ cc0g)))))))))).
...
thf(aqustgp_ax,axiom,(! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XY:($i > $o)] : ((XH = (cco @ XG @ (cco @ XG @ XY @ ccqg) @ ccqus)) => (((cwcel @ XG @ cctgp) & (cwcel @ XY @ (ccfv @ XG @ ccnsg))) => (cwcel @ XH @ cctgp))))))).
thf(ccxp_tp,type,(ccxp : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(cctx_tp,type,(cctx : ($i > $o))).
thf(ccid_tp,type,(ccid : ($i > $o))).
thf(atgphaus_ax,axiom,(! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XG @ cc0g)) => ((XJ = (ccfv @ XG @ cctopn)) => ((cwcel @ XG @ cctgp) => ((cwcel @ XJ @ ccha) <=> (cwcel @ (ccsn @ Xc_0) @ (ccfv @ XJ @ cccld)))))))))).
thf(cqustgphaus_conj,conjecture,(! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XY:($i > $o)] : ((XH = (cco @ XG @ (cco @ XG @ XY @ ccqg) @ ccqus)) => ((XJ = (ccfv @ XG @ cctopn)) => ((XK = (ccfv @ XH @ cctopn)) => ((cw3a @ (cwcel @ XG @ cctgp) @ (cwcel @ XY @ (ccfv @ XG @ ccnsg)) @ (cwcel @ XY @ (ccfv @ XJ @ cccld))) => (cwcel @ XK @ ccha))))))))))).
