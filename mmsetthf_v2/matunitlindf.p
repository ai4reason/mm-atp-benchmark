...
thf(amat0dimbas0_ax,axiom,(! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XR @ XV) => ((ccfv @ (cco @ cc0 @ XR @ ccmat) @ ccbs) = (ccsn @ cc0)))))).
...
thf(amat0dimid_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((XA2 = (cco @ cc0 @ XR @ ccmat)) => ((cwcel @ XR @ ccrg) => ((ccfv @ XA2 @ ccur) = cc0)))))).
...
thf(acureq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 = XB2) => ((cccur @ XA2) = (cccur @ XB2)))))).
thf(a_3eqtri_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((XA2 = XB2) => ((XB2 = XC) => ((XC = XD) => (XA2 = XD))))))))).
thf(adf_cur_ax,axiom,(! [XF:($i > $o)] : ((cccur @ XF) = (ccmpt @ (^ [Xx3:$i] : (ccdm @ (ccdm @ XF))) @ (^ [Xx3:$i] : (ccopab @ (^ [Xy1:$i] : (^ [Xz:$i] : (cwbr @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz) @ XF))))))))).
...
thf(amatunit_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XD = (cco @ XN @ XR @ ccmdat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XU = (ccfv @ XA2 @ ccui)) => ((XV = (ccfv @ XR @ ccui)) => (((cwcel @ XR @ cccrg) & (cwcel @ XM @ XB2)) => ((cwcel @ XM @ XU) <=> (cwcel @ (ccfv @ XM @ XD) @ XV))))))))))))))))).
...
thf(amatunitlindflem1_ax,axiom,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : ((((cwcel @ XR @ ccfield) & (cwf @ (ccxp @ XI @ XI) @ (ccfv @ XR @ ccbs) @ XM)) & (cwcel @ XI @ (ccdif @ ccfn @ (ccsn @ cc0)))) => ((~ (cwbr @ (cccur @ XM) @ (cco @ XR @ XI @ ccfrlm) @ cclindf)) => ((ccfv @ XM @ (cco @ XI @ XR @ ccmdat)) = (ccfv @ XR @ cc0g)))))))).
...
thf(amatunitlindflem2_ax,axiom,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (((((cwcel @ XR @ ccfield) & (cwcel @ XM @ (ccfv @ (cco @ XI @ XR @ ccmat) @ ccbs))) & (cwne @ XI @ cc0)) & (cwbr @ (cccur @ XM) @ (cco @ XR @ XI @ ccfrlm) @ cclindf)) => (cwcel @ (ccfv @ XM @ (cco @ XI @ XR @ ccmdat)) @ (ccfv @ XR @ ccui))))))).
thf(cmatunitlindf_conj,conjecture,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XR @ ccfield) & (cwcel @ XM @ (ccfv @ (cco @ XI @ XR @ ccmat) @ ccbs))) => ((cwcel @ XM @ (ccfv @ (cco @ XI @ XR @ ccmat) @ ccui)) <=> (cwbr @ (cccur @ XM) @ (cco @ XR @ XI @ ccfrlm) @ cclindf))))))).
