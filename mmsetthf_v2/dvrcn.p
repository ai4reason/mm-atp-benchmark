...
thf(ainvrcn_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ XR @ cctopn)) => ((XI = (ccfv @ XR @ ccinvr)) => ((XU = (ccfv @ XR @ ccui)) => ((cwcel @ XR @ cctdrg) => (cwcel @ XI @ (cco @ (cco @ XJ @ XU @ ccrest) @ XJ @ cccn))))))))))).
