...
thf(areperf_ax,axiom,(! [XJ:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => (cwcel @ (cco @ XJ @ ccr @ ccrest) @ ccperf)))).
...
thf(acnperf_ax,axiom,(! [XJ:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => (cwcel @ XJ @ ccperf)))).
thf(crecnperf_conj,conjecture,(! [XS:($i > $o)] : (! [XK:($i > $o)] : ((XK = (ccfv @ cccnfld @ cctopn)) => ((cwcel @ XS @ (ccpr @ ccr @ ccc)) => (cwcel @ (cco @ XK @ XS @ ccrest) @ ccperf)))))).
