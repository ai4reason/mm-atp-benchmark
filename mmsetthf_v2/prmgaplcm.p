...
thf(a_0nelfz1_ax,axiom,(! [XN:($i > $o)] : (cwnel @ ccc0 @ (cco @ cc1 @ XN @ ccfz)))).
thf(ccdvds_tp,type,(ccdvds : ($i > $o))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(alcmfn0cl_ax,axiom,(! [XZ:($i > $o)] : ((cw3a @ (cwss @ XZ @ ccz) @ (cwcel @ XZ @ ccfn) @ (cwnel @ ccc0 @ XZ)) => (cwcel @ (ccfv @ XZ @ cclcmf) @ ccn)))).
...
thf(aprmgaplcmlem2_ax,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XI @ (cco @ cc2 @ XN @ ccfz))) => (cwbr @ cc1 @ (cco @ (cco @ (ccfv @ (cco @ cc1 @ XN @ ccfz) @ cclcmf) @ XI @ ccaddc) @ XI @ ccgcd) @ cclt))))).
...
thf(cprmgaplcm_conj,conjecture,(cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : ((cwbr @ (ccv @ Xn) @ (cco @ (ccv @ Xq) @ (ccv @ Xp) @ ccmin) @ ccle) & (cwral @ (^ [Xz:$i] : (cwnel @ (ccv @ Xz) @ ccprime)) @ (^ [Xz:$i] : (cco @ (cco @ (ccv @ Xp) @ cc1 @ ccaddc) @ (ccv @ Xq) @ ccfzo))))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime))) @ (^ [Xn:$i] : ccn))).
