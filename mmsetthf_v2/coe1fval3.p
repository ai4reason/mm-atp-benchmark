...
thf(acoe1fval_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xn:$i] : ((XA2 @ Xn) = (ccfv @ XF @ ccco1))) => (! [Xn:$i] : ((cwcel @ XF @ (XV @ Xn)) => ((XA2 @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccfv @ (ccxp @ cc1o @ (ccsn @ (ccv @ Xn))) @ XF))))))))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(asylancl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => (Xch => (((Xps & Xch) => Xth) => (Xph => Xth))))))))).
thf(apsr1basf_ax,axiom,(! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : ((XP = (ccfv @ XR @ ccps1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((cwcel @ XF @ XB2) => (cwf @ (cco @ ccn0 @ cc1o @ ccmap) @ XK @ XF))))))))))).
...
thf(ccoe1fval3_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xy1:$i] : ((XA2 @ Xy1) = (ccfv @ XF @ ccco1))) => ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccfv @ (XP @ Xy1) @ ccbs))) => ((! [Xy1:$i] : ((XP @ Xy1) = (ccfv @ (XR @ Xy1) @ ccps1))) => ((! [Xy1:$i] : ((XG @ Xy1) = (ccmpt @ (^ [Xy1:$i] : ccn0) @ (^ [Xy1:$i] : (ccxp @ cc1o @ (ccsn @ (ccv @ Xy1))))))) => (! [Xy1:$i] : ((cwcel @ XF @ (XB2 @ Xy1)) => ((XA2 @ Xy1) = (cccom @ XF @ (XG @ Xy1)))))))))))))))).
