...
thf(anlelshi_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ cclf) => (cwcel @ (ccfv @ XT @ ccnl) @ ccsh)))).
...
thf(ahlimveci_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwbr @ XF @ XA2 @ cchli) => (cwcel @ XA2 @ cchil)))))).
...
thf(almmo_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : ((Xph => (cwcel @ XJ @ ccha)) => ((Xph => (cwbr @ XF @ XA2 @ (ccfv @ XJ @ cclm))) => ((Xph => (cwbr @ XF @ XB2 @ (ccfv @ XJ @ cclm))) => (Xph => (XA2 = XB2))))))))))).
...
thf(ahhlm_ax,axiom,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : ((XU = (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((XD = (ccfv @ XU @ ccims)) => ((XJ = (ccfv @ XD @ ccmopn)) => (cchli = (ccres @ (ccfv @ XJ @ cclm) @ (cco @ cchil @ ccn @ ccmap)))))))))).
...
thf(ahhcnf_ax,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XD = (cccom @ ccno @ ccmv)) => ((XJ = (ccfv @ XD @ ccmopn)) => ((XK = (ccfv @ cccnfld @ cctopn)) => (cccnfn = (cco @ XJ @ XK @ cccn))))))))).
