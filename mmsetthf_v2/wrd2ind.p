...
thf(acbvraldva_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((ccv @ Xx3) = (ccv @ Xy1))) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => (Xph => ((cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)) <=> (cwral @ (^ [Xy1:$i] : (Xch @ Xy1)) @ (^ [Xy1:$i] : XA2)))))))))).
...
thf(awrdlenge1n0_ax,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ (ccword @ XV)) => ((cwne @ XW @ cc0) <=> (cwbr @ cc1 @ (ccfv @ XW @ cchash) @ ccle)))))).
...
thf(avtocl4ga_ax,axiom,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [Xps:($i > ($i > ($i > $o)))] : (! [Xch:($i > ($i > ($i > $o)))] : (! [Xth:($i > ($i > ($i > $o)))] : (! [Xrh:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3 @ Xy1 @ Xz @ Xw) <=> (Xps @ Xy1 @ Xz @ Xw))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (((ccv @ Xy1) = (XB2 @ Xx3)) => ((Xps @ Xy1 @ Xz @ Xw) <=> (Xch @ Xx3 @ Xz @ Xw))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (((ccv @ Xz) = (XC @ Xx3 @ Xy1)) => ((Xch @ Xx3 @ Xz @ Xw) <=> (Xrh @ Xx3 @ Xy1 @ Xw))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (((ccv @ Xw) = (XD @ Xx3 @ Xy1 @ Xz)) => ((Xrh @ Xx3 @ Xy1 @ Xw) <=> (Xth @ Xx3 @ Xy1 @ Xz))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((((cwcel @ (ccv @ Xx3) @ XQ) & (cwcel @ (ccv @ Xy1) @ XR)) & ((cwcel @ (ccv @ Xz) @ XS) & (cwcel @ (ccv @ Xw) @ XT))) => (Xph @ Xx3 @ Xy1 @ Xz @ Xw)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((((cwcel @ XA2 @ XQ) & (cwcel @ (XB2 @ Xx3) @ XR)) & ((cwcel @ (XC @ Xx3 @ Xy1) @ XS) & (cwcel @ (XD @ Xx3 @ Xy1 @ Xz) @ XT))) => (Xth @ Xx3 @ Xy1 @ Xz)))))))))))))))))))))))).
thf(asyl6bb_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps <=> Xch)) => ((Xch <=> Xth) => (Xph => (Xps <=> Xth))))))))).
thf(asbccom_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xy1:$i] : ((cwsbc @ (^ [Xx3:$i] : (cwsbc @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (XB2 @ Xy1))) @ (XA2 @ Xx3)) <=> (cwsbc @ (^ [Xy1:$i] : (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ (XA2 @ Xx3))) @ (XB2 @ Xy1))))))))).
