...
thf(advid_ax,axiom,((cco @ ccc @ (ccres @ ccid @ ccc) @ ccdv) = (ccxp @ ccc @ (ccsn @ cc1)))).
...
thf(cdvexp_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cco @ ccc @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XN @ ccexp))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ XN @ (cco @ (ccv @ Xx3) @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccmul))))))).
