...
thf(aefopnlem1_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((((cwcel @ XR @ ccrp) & (cwbr @ XR @ ccpi @ cclt)) & (cwcel @ XA2 @ (cco @ ccc0 @ XR @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl)))) => (cwbr @ (ccfv @ (ccfv @ XA2 @ ccim) @ ccabs) @ ccpi @ cclt))))).
...
thf(alogf1o2_ax,axiom,(! [XD:($i > $o)] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwf1o @ XD @ (ccima @ (cccnv @ ccim) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo)) @ (ccres @ cclog @ XD))))).
