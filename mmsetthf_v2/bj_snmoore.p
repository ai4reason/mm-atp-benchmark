...
thf(abj_ismooredr2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3)))) => ((Xph => (cwcel @ (ccuni @ XA2) @ XA2)) => ((! [Xx3:$i] : (((Xph & (cwss @ (ccv @ Xx3) @ XA2)) & (cwne @ (ccv @ Xx3) @ cc0)) => (cwcel @ (ccint @ (ccv @ Xx3)) @ XA2))) => (Xph => (cwcel @ XA2 @ ccmoore))))))))).
...
thf(abj_0nmoore_ax,axiom,(~ (cwcel @ cc0 @ ccmoore))).
thf(cbj_snmoore_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) <=> (cwcel @ (ccsn @ XA2) @ ccmoore)))).
