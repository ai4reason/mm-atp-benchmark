...
thf(aclatglb_ax,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XG = (ccfv @ XK @ ccglb)) => (((cwcel @ XK @ cccla) & (cwss @ XS @ XB2)) => ((cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ XS @ XG) @ (ccv @ Xy1) @ Xc_le)) @ (^ [Xy1:$i] : XS)) & (cwral @ (^ [Xz:$i] : ((cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ Xc_le)) @ (^ [Xy1:$i] : XS)) => (cwbr @ (ccv @ Xz) @ (ccfv @ XS @ XG) @ Xc_le))) @ (^ [Xz:$i] : XB2))))))))))))).
...
thf(cclatleglb_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XG = (ccfv @ XK @ ccglb)) => ((cw3a @ (cwcel @ XK @ cccla) @ (cwcel @ XX @ XB2) @ (cwss @ XS @ XB2)) => ((cwbr @ XX @ (ccfv @ XS @ XG) @ Xc_le) <=> (cwral @ (^ [Xy1:$i] : (cwbr @ XX @ (ccv @ Xy1) @ Xc_le)) @ (^ [Xy1:$i] : XS)))))))))))))).
