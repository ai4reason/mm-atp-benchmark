...
thf(arecos4p_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ cci @ XA2 @ ccmul) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : ((cwcel @ XA2 @ ccr) => ((ccfv @ XA2 @ cccos) = (cco @ (cco @ cc1 @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc2 @ ccdiv) @ ccmin) @ (ccfv @ (ccsu @ (ccfv @ cc4 @ ccuz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xn)))) @ ccre) @ ccaddc)))))))).
...
thf(aeftlcl_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : (((cwcel @ XA2 @ ccc) & (cwcel @ XM @ ccn0)) => (cwcel @ (ccsu @ (ccfv @ XM @ ccuz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xn)))) @ ccc)))))))).
...
thf(aef01bndlem_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (cco @ cci @ XA2 @ ccmul) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : ((cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccioc)) => (cwbr @ (ccfv @ (ccsu @ (ccfv @ cc4 @ ccuz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xn)))) @ ccabs) @ (cco @ (cco @ XA2 @ cc4 @ ccexp) @ cc6 @ ccdiv) @ cclt))))))).
thf(aleexp2rd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XM @ ccn0)) => ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwbr @ XA2 @ cc1 @ ccle)) => (Xph => (cwbr @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XA2 @ XM @ ccexp) @ ccle)))))))))))).
...
thf(ahalfpm6th_ax,axiom,(((cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (cco @ cc1 @ cc6 @ ccdiv) @ ccmin) = (cco @ cc1 @ cc3 @ ccdiv)) & ((cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (cco @ cc1 @ cc6 @ ccdiv) @ ccaddc) = (cco @ cc2 @ cc3 @ ccdiv)))).
...
thf(ccos01bnd_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccioc)) => ((cwbr @ (cco @ cc1 @ (cco @ cc2 @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc3 @ ccdiv) @ ccmul) @ ccmin) @ (ccfv @ XA2 @ cccos) @ cclt) & (cwbr @ (ccfv @ XA2 @ cccos) @ (cco @ cc1 @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc3 @ ccdiv) @ ccmin) @ cclt))))).
