...
thf(agrppropstr_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (((ccfv @ XK @ ccbs) = XB2) => (((ccfv @ XK @ ccplusg) = Xc_pl) => ((XL = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl))) => ((cwcel @ XK @ ccgrp) <=> (cwcel @ XL @ ccgrp)))))))))).
...
thf(arngplusg_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XV:($i > $o)] : ((XR = (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl) @ (ccop @ (ccfv @ ccnx @ ccmulr) @ Xc_x))) => ((cwcel @ Xc_pl @ XV) => (Xc_pl = (ccfv @ XR @ ccplusg)))))))))).
thf(ccsgrp_tp,type,(ccsgrp : ($i > $o))).
thf(amnd1_ax,axiom,(! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((XM = (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccsn @ XI)) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (ccsn @ (ccop @ (ccop @ XI @ XI) @ XI))))) => ((cwcel @ XI @ XV) => (cwcel @ XM @ ccmnd))))))).
thf(amndprop_ax,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (((ccfv @ XK @ ccbs) = (ccfv @ XL @ ccbs)) => (((ccfv @ XK @ ccplusg) = (ccfv @ XL @ ccplusg)) => ((cwcel @ XK @ ccmnd) <=> (cwcel @ XL @ ccmnd))))))).
...
thf(arngmulr_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XV:($i > $o)] : ((XR = (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ XB2) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ Xc_pl) @ (ccop @ (ccfv @ ccnx @ ccmulr) @ Xc_x))) => ((cwcel @ Xc_x @ XV) => (Xc_x = (ccfv @ XR @ ccmulr)))))))))).
...
thf(cring1_conj,conjecture,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((XM = (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccsn @ XZ)) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (ccsn @ (ccop @ (ccop @ XZ @ XZ) @ XZ))) @ (ccop @ (ccfv @ ccnx @ ccmulr) @ (ccsn @ (ccop @ (ccop @ XZ @ XZ) @ XZ))))) => ((cwcel @ XZ @ XV) => (cwcel @ XM @ ccrg))))))).
