...
thf(acantnfp1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XS = (ccdm @ (cco @ XA2 @ XB2 @ cccnf))) => ((Xph => (cwcel @ XA2 @ ccon0)) => ((Xph => (cwcel @ XB2 @ ccon0)) => ((Xph => (cwcel @ XG @ XS)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XA2)) => ((Xph => (cwss @ (cco @ XG @ cc0 @ ccsupp) @ XX)) => ((! [Xt:$i] : ((XF @ Xt) = (ccmpt @ (^ [Xt:$i] : XB2) @ (^ [Xt:$i] : (ccif @ ((ccv @ Xt) = XX) @ XY @ (ccfv @ (ccv @ Xt) @ XG)))))) => (! [Xt:$i] : (Xph => ((cwcel @ (XF @ Xt) @ XS) & ((ccfv @ (XF @ Xt) @ (cco @ XA2 @ XB2 @ cccnf)) = (cco @ (cco @ (cco @ XA2 @ XX @ ccoe) @ XY @ ccomu) @ (ccfv @ XG @ (cco @ XA2 @ XB2 @ cccnf)) @ ccoa)))))))))))))))))))))).
