...
thf(a_19_30_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) | (Xps @ Xx3))) => ((! [Xx3:$i] : (Xph @ Xx3)) | (? [Xx3:$i] : (Xps @ Xx3))))))).
thf(aorc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xph | Xps))))).
thf(a_19_33_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (((! [Xx3:$i] : (Xph @ Xx3)) | (! [Xx3:$i] : (Xps @ Xx3))) => (! [Xx3:$i] : ((Xph @ Xx3) | (Xps @ Xx3))))))).
