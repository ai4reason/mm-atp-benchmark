...
thf(ciocopn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XC @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((XK = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((XJ = (cco @ XK @ (cco @ XA2 @ XB2 @ ccioc) @ ccrest)) => ((Xph => (cwbr @ XA2 @ XC @ ccle)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => (cwcel @ (cco @ XC @ XB2 @ ccioc) @ XJ)))))))))))))))).
