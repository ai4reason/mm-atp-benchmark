...
thf(cmzpcl34_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XP @ (ccfv @ XV @ ccmzpcl)) @ (cwcel @ XF @ XP) @ (cwcel @ XG @ XP)) => ((cwcel @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ XP) & (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ XP)))))))).
