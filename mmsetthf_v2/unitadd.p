...
thf(cunitadd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cco @ XA2 @ XB2 @ ccaddc) = XF) => (((cco @ XC @ cc1 @ ccaddc) = XB2) => ((cwcel @ XA2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cco @ (cco @ XA2 @ XC @ ccaddc) @ cc1 @ ccaddc) = XF)))))))))).
