...
thf(ccnlimci_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ XA2 @ XD @ cccncf))) => ((Xph => (cwcel @ XB2 @ XA2)) => (Xph => (cwcel @ (ccfv @ XB2 @ XF) @ (cco @ XF @ XB2 @ cclimc))))))))))).
