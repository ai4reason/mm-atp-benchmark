...
thf(abrtpos2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((cwbr @ XA2 @ XB2 @ (cctpos @ XF)) <=> ((cwcel @ XA2 @ (ccun @ (cccnv @ (ccdm @ XF)) @ (ccsn @ cc0))) & (cwbr @ (ccuni @ (cccnv @ (ccsn @ XA2))) @ XB2 @ XF))))))))).
...
thf(abrtpos0_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwbr @ cc0 @ XA2 @ (cctpos @ XF)) <=> (cwbr @ cc0 @ XA2 @ XF))))))).
thf(abibi12d_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => (Xps <=> Xch)) => ((Xph => (Xth <=> Xta)) => (Xph => ((Xps <=> Xth) <=> (Xch <=> Xta))))))))))).
thf(abreq1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cwbr @ XA2 @ XC @ XR) <=> (cwbr @ XB2 @ XC @ XR)))))))))).
thf(aopprc_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((~ ((cwcel @ XA2 @ ccvv) & (cwcel @ XB2 @ ccvv))) => ((ccop @ XA2 @ XB2) = cc0))))).
thf(asylnbi_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph <=> Xps) => (((~ Xps) => Xch) => ((~ Xph) => Xch))))))).
thf(aancom_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) <=> (Xps & Xph))))).
thf(cbrtpos_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XC @ XV) => ((cwbr @ (ccop @ XA2 @ XB2) @ XC @ (cctpos @ XF)) <=> (cwbr @ (ccop @ XB2 @ XA2) @ XC @ XF))))))))).
