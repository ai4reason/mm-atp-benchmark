...
thf(anbgrclOLD_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XN @ (cco @ XG @ XX @ ccnbgr)) => (cwcel @ XX @ (ccfv @ XG @ ccvtx))))))).
...
thf(cnbgrelOLD_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (! [Xe:$i] : ((cwcel @ XG @ (XW @ Xe)) => ((cwcel @ XK @ (cco @ XG @ XN @ ccnbgr)) <=> (cw3a @ ((cwcel @ XK @ XV) & (cwcel @ XN @ XV)) @ (cwne @ XK @ XN) @ (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ XN @ XK) @ (ccv @ Xe))) @ (^ [Xe:$i] : XE))))))))))))))).
