...
thf(aamgmlem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((XM = (ccfv @ cccnfld @ ccmgp)) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwne @ XA2 @ cc0)) => ((Xph => (cwf @ XA2 @ ccrp @ XF)) => (Xph => (cwbr @ (cco @ (cco @ XM @ XF @ ccgsu) @ (cco @ cc1 @ (ccfv @ XA2 @ cchash) @ ccdiv) @ cccxp) @ (cco @ (cco @ cccnfld @ XF @ ccgsu) @ (ccfv @ XA2 @ cchash) @ ccdiv) @ ccle))))))))))).
...
thf(agsumws4_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (((cwcel @ XG @ ccmnd) & ((cwcel @ XS @ XB2) & ((cwcel @ XT @ XB2) & ((cwcel @ XU @ XB2) & (cwcel @ XV @ XB2))))) => ((cco @ XG @ (ccs4 @ XS @ XT @ XU @ XV) @ ccgsu) = (cco @ XS @ (cco @ XT @ (cco @ XU @ XV @ Xc_pl) @ Xc_pl) @ Xc_pl))))))))))))).
...
thf(camgm4d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => (cwcel @ XC @ ccrp)) => ((Xph => (cwcel @ XD @ ccrp)) => (Xph => (cwbr @ (cco @ (cco @ XA2 @ (cco @ XB2 @ (cco @ XC @ XD @ ccmul) @ ccmul) @ ccmul) @ (cco @ cc1 @ cc4 @ ccdiv) @ cccxp) @ (cco @ (cco @ XA2 @ (cco @ XB2 @ (cco @ XC @ XD @ ccaddc) @ ccaddc) @ ccaddc) @ cc4 @ ccdiv) @ ccle)))))))))))).
