...
thf(cofresid_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwf @ XA2 @ XB2 @ XG)) => ((Xph => (cwcel @ XA2 @ XV)) => (Xph => ((cco @ XF @ XG @ (ccof @ XR)) = (cco @ XF @ XG @ (ccof @ (ccres @ XR @ (ccxp @ XB2 @ XB2))))))))))))))))).
