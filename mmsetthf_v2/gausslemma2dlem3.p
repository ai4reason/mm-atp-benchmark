...
thf(cgausslemma2dlem3_conj,conjecture,(! [Xph:$o] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XM:($i > ($i > $o))] : ((! [Xk:$i] : (Xph => (cwcel @ (XP @ Xk) @ (ccdif @ ccprime @ (ccsn @ cc2))))) => ((! [Xk:$i] : (XH = (cco @ (cco @ (XP @ Xk) @ cc1 @ ccmin) @ cc2 @ ccdiv))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XR @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XH @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ (XP @ Xk) @ cc2 @ ccdiv) @ cclt) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ (XP @ Xk) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ ccmin))))))) => ((! [Xk:$i] : ((XM @ Xk) = (ccfv @ (cco @ (XP @ Xk) @ cc4 @ ccdiv) @ ccfl))) => (! [Xx3:$i] : (Xph => (cwral @ (^ [Xk:$i] : ((ccfv @ (ccv @ Xk) @ (XR @ Xx3)) = (cco @ (XP @ Xk) @ (cco @ (ccv @ Xk) @ cc2 @ ccmul) @ ccmin))) @ (^ [Xk:$i] : (cco @ (cco @ (XM @ Xk) @ cc1 @ ccaddc) @ XH @ ccfz))))))))))))))).
