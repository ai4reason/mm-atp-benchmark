...
thf(afrgrregord13_ax,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cw3a @ (cwcel @ XG @ ccfrgr) @ (cwcel @ XV @ ccfn) @ (cwne @ XV @ cc0)) & (cwbr @ XG @ XK @ ccrusgr)) => (((ccfv @ XV @ cchash) = cc1) | ((ccfv @ XV @ cchash) = cc3)))))))).
...
thf(cfrgrogt3nreg_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cw3a @ (cwcel @ XG @ ccfrgr) @ (cwcel @ XV @ ccfn) @ (cwbr @ cc3 @ (ccfv @ XV @ cchash) @ cclt)) => (cwral @ (^ [Xk:$i] : (~ (cwbr @ XG @ (ccv @ Xk) @ ccrusgr))) @ (^ [Xk:$i] : ccn0))))))).
