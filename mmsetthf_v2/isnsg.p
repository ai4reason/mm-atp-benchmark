...
thf(adf_nsg_ax,axiom,(ccnsg = (ccmpt @ (^ [Xw:$i] : ccgrp) @ (^ [Xw:$i] : (ccrab @ (^ [Xs1:$i] : (cwsbc @ (^ [Xb:$i] : (cwsbc @ (^ [Xp:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xp)) @ (ccv @ Xs1)) <=> (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccv @ Xp)) @ (ccv @ Xs1)))) @ (^ [Xy1:$i] : (ccv @ Xb)))) @ (^ [Xx3:$i] : (ccv @ Xb)))) @ (ccfv @ (ccv @ Xw) @ ccplusg))) @ (ccfv @ (ccv @ Xw) @ ccbs))) @ (^ [Xs1:$i] : (ccfv @ (ccv @ Xw) @ ccsubg))))))).
...
thf(cisnsg_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((cwcel @ XS @ (ccfv @ XG @ ccnsg)) <=> ((cwcel @ XS @ (ccfv @ XG @ ccsubg)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XS) <=> (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ Xc_pl) @ XS))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX))))))))))).
