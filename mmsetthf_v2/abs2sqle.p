...
thf(aabs2sqlei_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwbr @ (ccfv @ XA2 @ ccabs) @ (ccfv @ XB2 @ ccabs) @ ccle) <=> (cwbr @ (cco @ (ccfv @ XA2 @ ccabs) @ cc2 @ ccexp) @ (cco @ (ccfv @ XB2 @ ccabs) @ cc2 @ ccexp) @ ccle))))))).
