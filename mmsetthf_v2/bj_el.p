...
thf(abj_zfpow_ax,axiom,(! [Xz:$i] : (? [Xx3:$i] : (! [Xy1:$i] : ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) => (cwcel @ (ccv @ Xx3) @ (ccv @ Xz)))) => (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))).
thf(abj_spimvv_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3 @ Xy1) => (Xps @ Xy1))))) => (! [Xy1:$i] : ((! [Xx3:$i] : (Xph @ Xx3 @ Xy1)) => (Xps @ Xy1))))))).
...
thf(cbj_el_conj,conjecture,(! [Xx3:$i] : (? [Xy1:$i] : (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1))))).
