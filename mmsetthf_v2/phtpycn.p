...
thf(cphtpycn_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => (Xph => (cwss @ (cco @ XF @ XG @ (ccfv @ XJ @ ccphtpy)) @ (cco @ (cco @ ccii @ ccii @ cctx) @ XJ @ cccn)))))))))).
