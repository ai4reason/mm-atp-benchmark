...
thf(adirkertrigeq_ax,axiom,(! [Xph:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > $o))] : ((! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((XD @ Xk @ Xn @ Xs1) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xs1:$i] : ccr) @ (^ [Xs1:$i] : (ccif @ ((cco @ (ccv @ Xs1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) = ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xs1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))))))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ (XN @ Xn) @ ccn))) => ((! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((XF @ Xk @ Xn @ Xs1) = (ccfv @ (XN @ Xn) @ (XD @ Xk @ Xn @ Xs1)))))) => ((! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((XH @ Xk @ Xn @ Xs1) = (ccmpt @ (^ [Xs1:$i] : ccr) @ (^ [Xs1:$i] : (cco @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (ccsu @ (cco @ cc1 @ (XN @ Xn) @ ccfz) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccv @ Xk) @ (ccv @ Xs1) @ ccmul) @ cccos))) @ ccaddc) @ ccpi @ ccdiv))))))) => (! [Xk:$i] : (! [Xn:$i] : (! [Xs1:$i] : ((Xph @ Xn) => ((XF @ Xk @ Xn @ Xs1) = (XH @ Xk @ Xn @ Xs1)))))))))))))))).
...
thf(advmptfsum_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xi:$i] : ((XJ @ Xx3 @ Xi) = (cco @ (XK @ Xx3 @ Xi) @ XS @ ccrest)))) => ((! [Xx3:$i] : (! [Xi:$i] : ((XK @ Xx3 @ Xi) = (ccfv @ cccnfld @ cctopn)))) => ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((! [Xx3:$i] : (! [Xi:$i] : (Xph => (cwcel @ XX @ (XJ @ Xx3 @ Xi))))) => ((Xph => (cwcel @ XI @ ccfn)) => ((! [Xx3:$i] : (! [Xi:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xi) @ XI) @ (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XA2 @ Xx3 @ Xi) @ ccc)))) => ((! [Xx3:$i] : (! [Xi:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xi) @ XI) @ (cwcel @ (ccv @ Xx3) @ XX)) => (cwcel @ (XB2 @ Xx3 @ Xi) @ ccc)))) => ((! [Xi:$i] : ((Xph & (cwcel @ (ccv @ Xi) @ XI)) => ((cco @ XS @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xi))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xi)))))) => (Xph => ((cco @ XS @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccsu @ XI @ (^ [Xi:$i] : (XA2 @ Xx3 @ Xi))))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccsu @ XI @ (^ [Xi:$i] : (XB2 @ Xx3 @ Xi)))))))))))))))))))))))).
...
thf(advsinax_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ ccc @ (ccmpt @ (^ [Xy1:$i] : ccc) @ (^ [Xy1:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ ccmul) @ ccsin))) @ ccdv) = (ccmpt @ (^ [Xy1:$i] : ccc) @ (^ [Xy1:$i] : (cco @ XA2 @ (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ ccmul) @ cccos) @ ccmul))))))).
...
thf(afsumcncf_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XX @ ccc))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ ccfn))) => ((! [Xx3:$i] : (! [Xk:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xk))) @ (cco @ XX @ ccc @ cccncf))))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xx3 @ Xk))))) @ (cco @ XX @ ccc @ cccncf)))))))))))).
...
thf(amulc1cncf_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccmul))))) => (! [Xx3:$i] : ((cwcel @ XA2 @ ccc) => (cwcel @ (XF @ Xx3) @ (cco @ ccc @ ccc @ cccncf)))))))).
...
thf(cdirkeritg_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XD @ Xx3 @ Xk @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ ((cco @ (ccv @ Xx3) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) = ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xx3) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))))))) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xn) => (cwcel @ (XN @ Xn) @ ccn)))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XF @ Xk @ Xn) = (ccfv @ (XN @ Xn) @ (XD @ Xx3 @ Xk @ Xn)))))) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xn) => (cwcel @ (XA2 @ Xn) @ ccr)))) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xn) => (cwcel @ (XB2 @ Xn) @ ccr)))) => ((! [Xx3:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xn) => (cwbr @ (XA2 @ Xn) @ (XB2 @ Xn) @ ccle)))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XG @ Xx3 @ Xk @ Xn) = (ccmpt @ (^ [Xx3:$i] : (cco @ (XA2 @ Xn) @ (XB2 @ Xn) @ ccicc)) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccdiv) @ (ccsu @ (cco @ cc1 @ (XN @ Xn) @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (cco @ (ccv @ Xk) @ (ccv @ Xx3) @ ccmul) @ ccsin) @ (ccv @ Xk) @ ccdiv))) @ ccaddc) @ ccpi @ ccdiv))))))) => (! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xph @ Xx3 @ Xn) => ((ccitg @ (^ [Xx3:$i] : (cco @ (XA2 @ Xn) @ (XB2 @ Xn) @ ccioo)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (XF @ Xk @ Xn)))) = (cco @ (ccfv @ (XB2 @ Xn) @ (XG @ Xx3 @ Xk @ Xn)) @ (ccfv @ (XA2 @ Xn) @ (XG @ Xx3 @ Xk @ Xn)) @ ccmin))))))))))))))))))))).
