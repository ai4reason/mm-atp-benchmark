...
thf(adfon2_ax,axiom,(ccon0 = (ccab @ (^ [Xx3:$i] : (! [Xy1:$i] : (((cwpss @ (ccv @ Xy1) @ (ccv @ Xx3)) & (cwtr @ (ccv @ Xy1))) => (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)))))))).
...
thf(abrsset_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwbr @ XA2 @ XB2 @ ccsset) <=> (cwss @ XA2 @ XB2)))))).
...
thf(aeltrans_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XA2 @ cctrans) <=> (cwtr @ XA2))))).
