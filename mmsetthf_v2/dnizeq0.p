...
thf(aflzadd_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XA2 @ ccr)) => ((ccfv @ (cco @ XN @ XA2 @ ccaddc) @ ccfl) = (cco @ XN @ (ccfv @ XA2 @ ccfl) @ ccaddc)))))).
...
thf(aico01fl0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccico)) => ((ccfv @ XA2 @ ccfl) = ccc0)))).
...
thf(cdnizeq0_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XT:($i > ($i > $o))] : ((! [Xx3:$i] : ((XT @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (ccv @ Xx3) @ ccmin) @ ccabs))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ ccz))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccfv @ XA2 @ (XT @ Xx3)) = ccc0))))))))).
