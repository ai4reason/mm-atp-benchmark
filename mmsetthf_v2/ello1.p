...
thf(cello1_conj,conjecture,(! [XF:($i > $o)] : ((cwcel @ XF @ cclo1) <=> ((cwcel @ XF @ (cco @ ccr @ ccr @ ccpm)) & (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccv @ Xm) @ ccle)) @ (^ [Xy1:$i] : (ccin @ (ccdm @ XF) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccico))))) @ (^ [Xm:$i] : ccr))) @ (^ [Xx3:$i] : ccr)))))).
