...
thf(afargshiftf_ax,axiom,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XF))))) => (! [Xx3:$i] : (((cwcel @ (XN @ Xx3) @ ccn0) & (cwf @ (cco @ cc1 @ (XN @ Xx3) @ ccfz) @ (ccdm @ XE) @ XF)) => (cwf @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XE) @ (XG @ Xx3)))))))))).
thf(ampcom_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xps => Xph) => ((Xph => (Xps => Xch)) => (Xps => Xch))))))).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(affn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => (cwfn @ XF @ XA2)))))).
thf(afseq1hash_ax,axiom,(! [XF:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwfn @ XF @ (cco @ cc1 @ XN @ ccfz))) => ((ccfv @ XF @ cchash) = XN))))).
...
thf(aralrimdvv_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (Xps => (((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3 @ Xy1))) => (Xch @ Xx3 @ Xy1)))))) => (Xph => (Xps => (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (Xch @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))))))).
...
thf(afargshiftfv_ax,axiom,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XF))))) => (! [Xx3:$i] : (((cwcel @ (XN @ Xx3) @ ccn0) & (cwf @ (cco @ cc1 @ (XN @ Xx3) @ ccfz) @ (ccdm @ XE) @ XF)) => ((cwcel @ XX @ (cco @ ccc0 @ (XN @ Xx3) @ ccfzo)) => ((ccfv @ XX @ (XG @ Xx3)) = (ccfv @ (cco @ XX @ cc1 @ ccaddc) @ XF)))))))))))).
...
thf(cfargshiftf1_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XF))))) => (! [Xx3:$i] : (((cwcel @ (XN @ Xx3) @ ccn0) & (cwf1 @ (cco @ cc1 @ (XN @ Xx3) @ ccfz) @ (ccdm @ XE) @ XF)) => (cwf1 @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XE) @ (XG @ Xx3)))))))))).
