...
thf(alimsucncmp_ax,axiom,(! [XA2:($i > $o)] : ((cwlim @ XA2) => (~ (cwcel @ (ccsuc @ XA2) @ cccmp))))).
...
thf(aonsucsuccmp_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (cwcel @ (ccsuc @ (ccsuc @ XA2)) @ cccmp)))).
...
thf(cordcmp_conj,conjecture,(! [XA2:($i > $o)] : ((cword @ XA2) => ((cwcel @ XA2 @ cccmp) <=> (((ccuni @ XA2) = (ccuni @ (ccuni @ XA2))) => (XA2 = cc1o)))))).
