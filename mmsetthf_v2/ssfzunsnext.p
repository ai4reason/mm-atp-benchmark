...
thf(cssfzunsnext_conj,conjecture,(! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwss @ XS @ (cco @ XM @ XN @ ccfz)) & (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwcel @ XI @ ccz))) => (cwss @ (ccun @ XS @ (ccsn @ XI)) @ (cco @ (ccif @ (cwbr @ XI @ XM @ ccle) @ XI @ XM) @ (ccif @ (cwbr @ XI @ XN @ ccle) @ XN @ XI) @ ccfz)))))))).
