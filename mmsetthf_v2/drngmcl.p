...
thf(adrngmgp_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XG = (cco @ (ccfv @ XR @ ccmgp) @ (ccdif @ XB2 @ (ccsn @ Xc_0)) @ ccress)) => ((cwcel @ XR @ ccdr) => (cwcel @ XG @ ccgrp)))))))))).
...
thf(cdrngmcl_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XX @ (ccdif @ XB2 @ (ccsn @ Xc_0))) @ (cwcel @ XY @ (ccdif @ XB2 @ (ccsn @ Xc_0)))) => (cwcel @ (cco @ XX @ XY @ Xc_x) @ (ccdif @ XB2 @ (ccsn @ Xc_0)))))))))))))).
