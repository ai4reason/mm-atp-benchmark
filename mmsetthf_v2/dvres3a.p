...
thf(cdvres3a_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((((cwcel @ XS @ (ccpr @ ccr @ ccc)) & (cwf @ XA2 @ ccc @ XF)) & ((cwcel @ XA2 @ XJ) & ((ccdm @ (cco @ ccc @ XF @ ccdv)) = XA2))) => ((cco @ XS @ (ccres @ XF @ XS) @ ccdv) = (ccres @ (cco @ ccc @ XF @ ccdv) @ XS))))))))).
