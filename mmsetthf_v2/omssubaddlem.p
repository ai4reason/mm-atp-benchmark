...
thf(comssubaddlem_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : ((! [Xz:$i] : (! [Xw:$i] : ((XM @ Xz @ Xw) = (ccfv @ XR @ ccoms)))) => ((! [Xw:$i] : ((Xph @ Xw) => (cwcel @ XQ @ XV))) => ((! [Xw:$i] : ((Xph @ Xw) => (cwf @ XQ @ (cco @ ccc0 @ ccpnf @ ccicc) @ XR))) => ((! [Xw:$i] : ((Xph @ Xw) => (cwss @ XA2 @ (ccuni @ XQ)))) => ((! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xw) => (cwcel @ (ccfv @ XA2 @ (XM @ Xz @ Xw)) @ ccr)))) => ((! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xw) => (cwcel @ (XE @ Xz @ Xw) @ ccrp)))) => (! [Xz:$i] : (! [Xw:$i] : ((Xph @ Xw) => (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccesum @ (^ [Xw:$i] : (ccv @ Xx3)) @ (^ [Xw:$i] : (ccfv @ (ccv @ Xw) @ XR))) @ (cco @ (ccfv @ XA2 @ (XM @ Xz @ Xw)) @ (XE @ Xz @ Xw) @ ccaddc) @ cclt)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xz:$i] : ((cwss @ XA2 @ (ccuni @ (ccv @ Xz))) & (cwbr @ (ccv @ Xz) @ ccom @ ccdom))) @ (^ [Xz:$i] : (ccpw @ (ccdm @ XR))))))))))))))))))))))).
