...
thf(cmdandyv5_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xph <=> $false) => ((Xps <=> $true) => ((Xch <=> $true) => ((Xth <=> $false) => ((Xta <=> $true) => ((Xet <=> $false) => ((((Xch <=> Xps) & (Xth <=> Xph)) & (Xta <=> Xps)) & (Xet <=> Xph))))))))))))))).
