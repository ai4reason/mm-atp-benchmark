...
thf(agasubg_ax,axiom,(! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XY:($i > $o)] : ((XH = (cco @ XG @ XS @ ccress)) => (((cwcel @ Xc_po @ (cco @ XG @ XY @ ccga)) & (cwcel @ XS @ (ccfv @ XG @ ccsubg))) => (cwcel @ (ccres @ Xc_po @ (ccxp @ XS @ XY)) @ (cco @ XH @ XY @ ccga)))))))))).
