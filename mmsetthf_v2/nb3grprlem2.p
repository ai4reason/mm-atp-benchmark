...
thf(anbgrnself2_ax,axiom,(! [XG:($i > $o)] : (! [XX:($i > $o)] : (cwnel @ XX @ (cco @ XG @ XX @ ccnbgr))))).
...
thf(a_3bior1fd_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (~ Xth)) => (Xph => ((Xch | Xps) <=> (cw3o @ Xth @ Xch @ Xps))))))))).
...
thf(cnb3grprlem2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > ($i > $o)))] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xw:$i] : ((XE @ Xw) = (ccfv @ XG @ ccedg))) => ((! [Xw:$i] : ((Xph @ Xw) => (cwcel @ XG @ ccusgr))) => ((! [Xw:$i] : ((Xph @ Xw) => (XV = (cctp @ XA2 @ XB2 @ XC)))) => ((! [Xw:$i] : (! [Xv:$i] : ((Xph @ Xw) => (cw3a @ (cwcel @ XA2 @ (XX @ Xw @ Xv)) @ (cwcel @ XB2 @ (XY @ Xw @ Xv)) @ (cwcel @ XC @ (XZ @ Xw @ Xv)))))) => ((! [Xw:$i] : ((Xph @ Xw) => (cw3a @ (cwne @ XA2 @ XB2) @ (cwne @ XA2 @ XC) @ (cwne @ XB2 @ XC)))) => (! [Xw:$i] : ((Xph @ Xw) => (((cco @ XG @ XA2 @ ccnbgr) = (ccpr @ XB2 @ XC)) <=> (cwrex @ (^ [Xv:$i] : (cwrex @ (^ [Xw:$i] : ((cco @ XG @ XA2 @ ccnbgr) = (ccpr @ (ccv @ Xv) @ (ccv @ Xw)))) @ (^ [Xw:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV)))))))))))))))))))))).
