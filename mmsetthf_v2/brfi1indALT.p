...
thf(cbrfi1indALT_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > ($i > ($i > $o))))] : (! [Xth:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((cwrel @ XG) => ((! [Xy1:$i] : (! [Xv:$i] : (! [Xe:$i] : (! [Xn:$i] : (cwcel @ (XF @ Xy1 @ Xv @ Xe @ Xn) @ ccvv))))) => ((! [Xy1:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xe:$i] : (! [Xf1:$i] : ((((ccv @ Xv) = (XV @ Xy1 @ Xw @ Xf1)) & ((ccv @ Xe) = (XE @ Xy1 @ Xw @ Xf1))) => ((Xps @ Xv @ Xe) <=> (Xph @ Xy1 @ Xw @ Xf1)))))))) => ((! [Xy1:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xe:$i] : (! [Xf1:$i] : ((((ccv @ Xv) = (ccv @ Xw)) & ((ccv @ Xe) = (ccv @ Xf1))) => ((Xps @ Xv @ Xe) <=> (Xth @ Xy1 @ Xw @ Xf1)))))))) => ((! [Xy1:$i] : (! [Xv:$i] : (! [Xe:$i] : (! [Xn:$i] : (((cwbr @ (ccv @ Xv) @ (ccv @ Xe) @ XG) & (cwcel @ (ccv @ Xn) @ (ccv @ Xv))) => (cwbr @ (ccdif @ (ccv @ Xv) @ (ccsn @ (ccv @ Xn))) @ (XF @ Xy1 @ Xv @ Xe @ Xn) @ XG)))))) => ((! [Xy1:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xe:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((((ccv @ Xw) = (ccdif @ (ccv @ Xv) @ (ccsn @ (ccv @ Xn)))) & ((ccv @ Xf1) = (XF @ Xy1 @ Xv @ Xe @ Xn))) => ((Xth @ Xy1 @ Xw @ Xf1) <=> (Xch @ Xy1 @ Xv @ Xe @ Xn))))))))) => ((! [Xv:$i] : (! [Xe:$i] : (((cwbr @ (ccv @ Xv) @ (ccv @ Xe) @ XG) & ((ccfv @ (ccv @ Xv) @ cchash) = ccc0)) => (Xps @ Xv @ Xe)))) => ((! [Xy1:$i] : (! [Xv:$i] : (! [Xe:$i] : (! [Xn:$i] : ((((cwcel @ (cco @ (ccv @ Xy1) @ cc1 @ ccaddc) @ ccn0) & (cw3a @ (cwbr @ (ccv @ Xv) @ (ccv @ Xe) @ XG) @ ((ccfv @ (ccv @ Xv) @ cchash) = (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) @ (cwcel @ (ccv @ Xn) @ (ccv @ Xv)))) & (Xch @ Xy1 @ Xv @ Xe @ Xn)) => (Xps @ Xv @ Xe)))))) => (! [Xy1:$i] : (! [Xw:$i] : (! [Xf1:$i] : (((cwbr @ (XV @ Xy1 @ Xw @ Xf1) @ (XE @ Xy1 @ Xw @ Xf1) @ XG) & (cwcel @ (XV @ Xy1 @ Xw @ Xf1) @ ccfn)) => (Xph @ Xy1 @ Xw @ Xf1)))))))))))))))))))))).
