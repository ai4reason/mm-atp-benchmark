...
thf(aitgsbtaddcnst_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((Xph => (cwcel @ XX @ ccr)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ cccncf))) => (Xph => ((ccdit @ (^ [Xs1:$i] : (cco @ XA2 @ XX @ ccmin)) @ (^ [Xs1:$i] : (cco @ XB2 @ XX @ ccmin)) @ (^ [Xs1:$i] : (ccfv @ (cco @ XX @ (ccv @ Xs1) @ ccaddc) @ XF))) = (ccdit @ (^ [Xt:$i] : XA2) @ (^ [Xt:$i] : XB2) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ XF)))))))))))))))).
...
thf(alimcicciooub_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwf @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ XF)) => (Xph => ((cco @ (ccres @ XF @ (cco @ XA2 @ XB2 @ ccioo)) @ XB2 @ cclimc) = (cco @ XF @ XB2 @ cclimc)))))))))))).
thf(ccico_tp,type,(ccico : ($i > $o))).
thf(alimciccioolb_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwf @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ XF)) => (Xph => ((cco @ (ccres @ XF @ (cco @ XA2 @ XB2 @ ccioo)) @ XA2 @ cclimc) = (cco @ XF @ XA2 @ cclimc)))))))))))).
...
thf(cfourierdlem82_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xt:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = XA2) @ (XR @ Xt) @ (ccif @ ((ccv @ Xx3) = XB2) @ (XL @ Xt) @ (ccfv @ (ccv @ Xx3) @ (ccres @ (XF @ Xt) @ (cco @ XA2 @ XB2 @ ccioo)))))))))) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((! [Xt:$i] : (Xph => (cwf @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ (XF @ Xt)))) => ((! [Xt:$i] : (Xph => (cwcel @ (ccres @ (XF @ Xt) @ (cco @ XA2 @ XB2 @ ccioo)) @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccc @ cccncf)))) => ((! [Xt:$i] : (Xph => (cwcel @ (XL @ Xt) @ (cco @ (XF @ Xt) @ XB2 @ cclimc)))) => ((! [Xt:$i] : (Xph => (cwcel @ (XR @ Xt) @ (cco @ (XF @ Xt) @ XA2 @ cclimc)))) => ((Xph => (cwcel @ XX @ ccr)) => (Xph => ((ccitg @ (^ [Xt:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ (XF @ Xt)))) = (ccitg @ (^ [Xt:$i] : (cco @ (cco @ XA2 @ XX @ ccmin) @ (cco @ XB2 @ XX @ ccmin) @ ccicc)) @ (^ [Xt:$i] : (ccfv @ (cco @ XX @ (ccv @ Xt) @ ccaddc) @ (XF @ Xt)))))))))))))))))))))))).
