...
thf(antrtop_ax,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ cctop) => ((ccfv @ XX @ (ccfv @ XJ @ ccnt)) = XX)))))).
...
thf(altmin_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) => ((cwbr @ XA2 @ (ccif @ (cwbr @ XB2 @ XC @ ccle) @ XB2 @ XC) @ cclt) <=> ((cwbr @ XA2 @ XB2 @ cclt) & (cwbr @ XA2 @ XC @ cclt)))))))).
...
thf(aefval2_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ cce) = (ccsu @ ccn0 @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xn))))))))))).
...
thf(afac2_ax,axiom,((ccfv @ cc2 @ ccfa) = cc2)).
...
thf(aeff_ax,axiom,(cwf @ ccc @ ccc @ cce)).
thf(cdveflem_conj,conjecture,(cwbr @ ccc0 @ cc1 @ (cco @ ccc @ cce @ ccdv))).
