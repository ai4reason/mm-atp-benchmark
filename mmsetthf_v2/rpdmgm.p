...
thf(admlogdmgm_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn)))))).
thf(crpdmgm_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn)))))).
