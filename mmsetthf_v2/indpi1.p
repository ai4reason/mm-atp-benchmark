...
thf(aind1a_ax,axiom,(! [XA2:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XO @ XV) @ (cwss @ XA2 @ XO) @ (cwcel @ XX @ XO)) => (((ccfv @ XX @ (ccfv @ XA2 @ (ccfv @ XO @ ccind))) = cc1) <=> (cwcel @ XX @ XA2)))))))).
...
thf(cindpi1_conj,conjecture,(! [XA2:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XO @ XV) & (cwss @ XA2 @ XO)) => ((ccima @ (cccnv @ (ccfv @ XA2 @ (ccfv @ XO @ ccind))) @ (ccsn @ cc1)) = XA2)))))).
