...
thf(cunichnidl_conj,conjecture,(! [XC:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [Xj:$i] : (((cwcel @ (XR @ Xj) @ ccrngo) & (cw3a @ (cwne @ XC @ cc0) @ (cwss @ XC @ (ccfv @ (XR @ Xj) @ ccidl)) @ (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : ((cwss @ (ccv @ Xi) @ (ccv @ Xj)) | (cwss @ (ccv @ Xj) @ (ccv @ Xi)))) @ (^ [Xj:$i] : XC))) @ (^ [Xi:$i] : XC)))) => (cwcel @ (ccuni @ XC) @ (ccfv @ (XR @ Xj) @ ccidl))))))).
