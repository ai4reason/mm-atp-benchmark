...
thf(af1sng_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => (cwf1 @ (ccsn @ XA2) @ XW @ (ccsn @ (ccop @ XA2 @ XB2))))))))).
...
thf(a_0wlkon_ax,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwf @ (cco @ ccc0 @ ccc0 @ ccfz) @ XV @ XP) & ((ccfv @ ccc0 @ XP) = XN)) => (cwbr @ cc0 @ XP @ (cco @ XN @ XN @ (ccfv @ XG @ ccwlkson)))))))))).
thf(c_0wlkons1_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XN @ XV) => (cwbr @ cc0 @ (ccs1 @ XN) @ (cco @ XN @ XN @ (ccfv @ XG @ ccwlkson))))))))).
