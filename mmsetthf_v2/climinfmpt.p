...
thf(ccliminfmpt_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (! [Xj:$i] : (cwnf @ (^ [Xk:$i] : (Xph @ Xx3 @ Xj @ Xk))))) => ((! [Xx3:$i] : (! [Xk:$i] : (cwnf @ (^ [Xj:$i] : (Xph @ Xx3 @ Xj @ Xk))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xj @ Xk) => (cwcel @ (XM @ Xx3 @ Xj @ Xk) @ ccz))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (XZ = (ccfv @ (XM @ Xx3 @ Xj @ Xk) @ ccuz))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (((Xph @ Xx3 @ Xj @ Xk) & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XB2 @ Xk) @ ccr))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xk) = (ccv @ Xj)) => ((XB2 @ Xk) = (XC @ Xx3 @ Xj)))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((cw3a @ (Xph @ Xx3 @ Xj @ Xk) @ (cwcel @ (ccv @ Xk) @ XZ) @ ((ccv @ Xj) = (cco @ (ccv @ Xk) @ cc1 @ ccaddc))) => (cwbr @ (XC @ Xx3 @ Xj) @ (XB2 @ Xk) @ ccle))))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xj @ Xk) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccv @ Xx3) @ (XB2 @ Xk) @ ccle)) @ (^ [Xk:$i] : XZ))) @ (^ [Xx3:$i] : ccr)))))) => (! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xj @ Xk) => (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (ccinf @ (ccrn @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XB2 @ Xk)))) @ ccxr @ cclt) @ ccli))))))))))))))))))).
