...
thf(awwlksnredwwlkn_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XE = (ccfv @ XG @ ccedg)) => ((cwcel @ XN @ ccn0) => ((cwcel @ XW @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XG @ ccwwlksn)) => (cwrex @ (^ [Xy1:$i] : (((cco @ XW @ (ccop @ ccc0 @ (cco @ XN @ cc1 @ ccaddc)) @ ccsubstr) = (ccv @ Xy1)) & (cwcel @ (ccpr @ (ccfv @ (ccv @ Xy1) @ cclsw) @ (ccfv @ XW @ cclsw)) @ XE))) @ (^ [Xy1:$i] : (cco @ XN @ XG @ ccwwlksn))))))))))).
