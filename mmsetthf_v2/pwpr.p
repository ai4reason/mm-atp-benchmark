...
thf(asspr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ (ccpr @ XB2 @ XC)) <=> (((XA2 = cc0) | (XA2 = (ccsn @ XB2))) | ((XA2 = (ccsn @ XC)) | (XA2 = (ccpr @ XB2 @ XC))))))))).
...
thf(cpwpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccpw @ (ccpr @ XA2 @ XB2)) = (ccun @ (ccpr @ cc0 @ (ccsn @ XA2)) @ (ccpr @ (ccsn @ XB2) @ (ccpr @ XA2 @ XB2))))))).
