...
thf(carchiabllem1b_conj,conjecture,(! [Xph:$o] : (! [Xy1:$i] : (! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((! [Xn:$i] : ((Xc_le @ Xn) = (ccfv @ XW @ ccple))) => ((Xc_lt = (ccfv @ XW @ ccplt)) => ((Xc_x = (ccfv @ XW @ ccmg)) => ((Xph => (cwcel @ XW @ ccogrp)) => ((Xph => (cwcel @ XW @ ccarchi)) => ((Xph => (cwcel @ XU @ XB2)) => ((Xph => (cwbr @ Xc_0 @ XU @ Xc_lt)) => ((! [Xx3:$i] : (! [Xn:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwbr @ Xc_0 @ (ccv @ Xx3) @ Xc_lt)) => (cwbr @ XU @ (ccv @ Xx3) @ (Xc_le @ Xn))))) => ((Xph & (cwcel @ (ccv @ Xy1) @ XB2)) => (cwrex @ (^ [Xn:$i] : ((ccv @ Xy1) = (cco @ (ccv @ Xn) @ XU @ Xc_x))) @ (^ [Xn:$i] : ccz))))))))))))))))))))))).
