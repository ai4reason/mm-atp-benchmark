...
thf(a_3o1cs_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((cw3o @ Xph @ Xps @ Xch) => Xth) => (Xph => Xth))))))).
...
thf(a_3o2cs_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((cw3o @ Xph @ Xps @ Xch) => Xth) => (Xps => Xth))))))).
thf(cclt_tp,type,(cclt : ($i > $o))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(ccxmu_tp,type,(ccxmu : ($i > $o))).
thf(ccv_tp,type,(ccv : ($i > ($i > $o)))).
thf(ccrio_tp,type,(ccrio : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(axdivpnfrp_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => ((cco @ ccpnf @ XA2 @ ccxdiv) = ccpnf)))).
thf(a_3o3cs_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((cw3o @ Xph @ Xps @ Xch) => Xth) => (Xch => Xth))))))).
