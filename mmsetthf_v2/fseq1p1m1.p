...
thf(cfseq1p1m1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : ((XH = (ccsn @ (ccop @ (cco @ XN @ cc1 @ ccaddc) @ XB2))) => ((cwcel @ XN @ ccn0) => ((cw3a @ (cwf @ (cco @ cc1 @ XN @ ccfz) @ XA2 @ XF) @ (cwcel @ XB2 @ XA2) @ (XG = (ccun @ XF @ XH))) <=> (cw3a @ (cwf @ (cco @ cc1 @ (cco @ XN @ cc1 @ ccaddc) @ ccfz) @ XA2 @ XG) @ ((ccfv @ (cco @ XN @ cc1 @ ccaddc) @ XG) = XB2) @ (XF = (ccres @ XG @ (cco @ cc1 @ XN @ ccfz)))))))))))))).
