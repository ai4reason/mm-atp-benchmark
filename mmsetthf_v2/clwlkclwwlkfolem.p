...
thf(aclwlkiswlk_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwbr @ XF @ XP @ (ccfv @ XG @ ccclwlks)) => (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks))))))).
