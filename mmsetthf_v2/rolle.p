...
thf(aevthicc_b1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => (Xph => ((cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccle)) @ (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc))) & (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ ccle)) @ (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xz:$i] : (cco @ XA2 @ XB2 @ ccicc)))))))))))))).
...
thf(aecased_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => ((~ Xps) => Xth)) => ((Xph => ((~ Xch) => Xth)) => ((Xph => ((Xps & Xch) => Xth)) => (Xph => Xth))))))))).
thf(aexpr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & (Xps & Xch)) => Xth) => ((Xph & Xps) => (Xch => Xth)))))))).
thf(ccun_tp,type,(ccun : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(arollelem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => ((Xph => ((ccdm @ (cco @ ccr @ XF @ ccdv)) = (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ XU @ XF) @ ccle)) @ (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccicc)))) => ((Xph => (cwcel @ XU @ (cco @ XA2 @ XB2 @ ccicc))) => ((Xph => (~ (cwcel @ XU @ (ccpr @ XA2 @ XB2)))) => (Xph => (cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) = ccc0)) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccioo)))))))))))))))))).
...
thf(anegeq0d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => (Xph => ((XA2 = ccc0) <=> ((ccneg @ XA2) = ccc0))))))).
...
thf(crolle_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => ((Xph => ((ccdm @ (cco @ ccr @ XF @ ccdv)) = (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))) => (Xph => (cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) = ccc0)) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccioo))))))))))))))).
