...
thf(clindsind_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XN = (ccfv @ XW @ cclspn)) => ((XL = (ccfv @ XW @ ccsca)) => ((Xc_0 = (ccfv @ XL @ cc0g)) => ((XK = (ccfv @ XL @ ccbs)) => ((((cwcel @ XF @ (ccfv @ XW @ cclinds)) & (cwcel @ XE @ XF)) & ((cwcel @ XA2 @ XK) & (cwne @ XA2 @ Xc_0))) => (~ (cwcel @ (cco @ XA2 @ XE @ Xc_x) @ (ccfv @ (ccdif @ XF @ (ccsn @ XE)) @ XN))))))))))))))))))).
