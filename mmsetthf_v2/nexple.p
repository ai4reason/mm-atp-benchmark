...
thf(aexpge1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwbr @ cc1 @ XA2 @ ccle)) => (Xph => (cwbr @ cc1 @ (cco @ XA2 @ XN @ ccexp) @ ccle))))))))).
...
thf(atimes2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => (Xph => ((cco @ XA2 @ cc2 @ ccmul) = (cco @ XA2 @ XA2 @ ccaddc))))))).
...
thf(cnexple_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccr) @ (cwbr @ cc2 @ XB2 @ ccle)) => (cwbr @ XA2 @ (cco @ XB2 @ XA2 @ ccexp) @ ccle))))).
