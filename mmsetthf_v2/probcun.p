...
thf(cprobcun_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprb) @ (cwcel @ XA2 @ (ccpw @ (ccdm @ XP))) @ ((cwbr @ XA2 @ ccom @ ccdom) & (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3))))) => ((ccfv @ (ccuni @ XA2) @ XP) = (ccesum @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XP)))))))).
