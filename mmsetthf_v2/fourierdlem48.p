...
thf(amulsubfacd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => (Xph => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ XB2 @ ccmin) = (cco @ (cco @ XA2 @ cc1 @ ccmin) @ XB2 @ ccmul))))))))).
...
thf(arexlim2d_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xch:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (cwnf @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)) & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3 @ Xy1))) => ((Xps @ Xx3 @ Xy1) => Xch))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => ((cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) => Xch))))))))))))).
...
thf(afrel_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => (cwrel @ XF)))))).
thf(aresindm_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwrel @ XA2) => ((ccres @ XA2 @ (ccin @ XB2 @ (ccdm @ XA2))) = (ccres @ XA2 @ XB2)))))).
...
thf(altadd1dd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => (Xph => (cwbr @ (cco @ XA2 @ XC @ ccaddc) @ (cco @ XB2 @ XC @ ccaddc) @ cclt))))))))))).
...
thf(aicossre_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccxr)) => (cwss @ (cco @ XA2 @ XB2 @ ccico) @ ccr))))).
thf(aicoltub_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccico))) => (cwbr @ XC @ XB2 @ cclt)))))).
thf(asnunioo1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwbr @ XA2 @ XB2 @ cclt)) => ((ccun @ (cco @ XA2 @ XB2 @ ccioo) @ (ccsn @ XA2)) = (cco @ XA2 @ XB2 @ ccico)))))).
...
thf(alimcperiod_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ (ccdm @ XF) @ ccc @ XF)) => ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwss @ XA2 @ (ccdm @ XF))) => ((Xph => (cwcel @ XT @ ccc)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xx3 @ Xy1) = (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ XT @ ccaddc))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccc))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwss @ (XB2 @ Xx3 @ Xy1) @ (ccdm @ XF))))) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XA2)) => ((ccfv @ (cco @ (ccv @ Xy1) @ XT @ ccaddc) @ XF) = (ccfv @ (ccv @ Xy1) @ XF)))) => ((Xph => (cwcel @ XC @ (cco @ (ccres @ XF @ XA2) @ XD @ cclimc))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XC @ (cco @ (ccres @ XF @ (XB2 @ Xx3 @ Xy1)) @ (cco @ XD @ XT @ ccaddc) @ cclimc))))))))))))))))))))).
...
thf(aiooshift_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((! [Xw:$i] : ((Xph @ Xw) => (cwcel @ XA2 @ ccr))) => ((! [Xw:$i] : ((Xph @ Xw) => (cwcel @ XB2 @ ccr))) => ((! [Xw:$i] : ((Xph @ Xw) => (cwcel @ XT @ ccr))) => (! [Xw:$i] : ((Xph @ Xw) => ((cco @ (cco @ XA2 @ XT @ ccaddc) @ (cco @ XB2 @ XT @ ccaddc) @ ccioo) = (ccrab @ (^ [Xw:$i] : (cwrex @ (^ [Xz:$i] : ((ccv @ Xw) = (cco @ (ccv @ Xz) @ XT @ ccaddc))) @ (^ [Xz:$i] : (cco @ XA2 @ XB2 @ ccioo)))) @ (^ [Xw:$i] : ccc))))))))))))).
...
thf(afourierdlem32_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccc @ cccncf))) => ((Xph => (cwcel @ XR @ (cco @ XF @ XA2 @ cclimc))) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwcel @ XD @ ccr)) => ((Xph => (cwbr @ XC @ XD @ cclt)) => ((Xph => (cwss @ (cco @ XC @ XD @ ccioo) @ (cco @ XA2 @ XB2 @ ccioo))) => ((XY = (ccif @ (XC = XA2) @ XR @ (ccfv @ XC @ XF))) => ((XJ = (cco @ (ccfv @ cccnfld @ cctopn) @ (cco @ XA2 @ XB2 @ ccico) @ ccrest)) => (Xph => (cwcel @ XY @ (cco @ (ccres @ XF @ (cco @ XC @ XD @ ccioo)) @ XC @ cclimc)))))))))))))))))))))))).
...
thf(aiocgtlb_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioc))) => (cwbr @ XA2 @ XC @ cclt)))))).
...
thf(aeliocd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((Xph => (cwcel @ XC @ ccxr)) => ((Xph => (cwbr @ XA2 @ XC @ cclt)) => ((Xph => (cwbr @ XC @ XB2 @ ccle)) => (Xph => (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioc))))))))))))).
...
thf(afourierdlem25_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwcel @ XM @ ccn)))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwf @ (cco @ ccc0 @ XM @ ccfz) @ ccr @ XQ)))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwcel @ XC @ (cco @ (ccfv @ ccc0 @ XQ) @ (ccfv @ XM @ XQ) @ ccicc))))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (~ (cwcel @ XC @ (ccrn @ XQ)))))) => ((XI = (ccsup @ (ccrab @ (^ [Xk:$i] : (cwbr @ (ccfv @ (ccv @ Xk) @ XQ) @ XC @ cclt)) @ (^ [Xk:$i] : (cco @ ccc0 @ XM @ ccfzo))) @ ccr @ cclt)) => (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwrex @ (^ [Xj:$i] : (cwcel @ XC @ (cco @ (ccfv @ (ccv @ Xj) @ XQ) @ (ccfv @ (cco @ (ccv @ Xj) @ cc1 @ ccaddc) @ XQ) @ ccioo))) @ (^ [Xj:$i] : (cco @ ccc0 @ XM @ ccfzo))))))))))))))))).
...
thf(aioossioc_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ (cco @ XA2 @ XB2 @ ccioc))))).
...
thf(aelfzonn0_ax,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ ccc0 @ XN @ ccfzo)) => (cwcel @ XK @ ccn0))))).
...
thf(aelfzop1le2_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ XM @ XN @ ccfzo)) => (cwbr @ (cco @ XK @ cc1 @ ccaddc) @ XN @ ccle)))))).
...
thf(aiocleub_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioc))) => (cwbr @ XC @ XB2 @ ccle)))))).
