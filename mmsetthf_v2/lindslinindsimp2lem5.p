...
thf(afsuppres_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwbr @ XF @ XZ @ ccfsupp)) => ((Xph => (cwcel @ XZ @ XV)) => (Xph => (cwbr @ (ccres @ XF @ XX) @ XZ @ ccfsupp)))))))))).
...
thf(alindslinindimp2lem4_ax,axiom,(! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : (! [Xc_0:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XR @ Xy1) = (ccfv @ (XM @ Xx3) @ ccsca)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xx3) = (ccfv @ (XR @ Xy1) @ ccbs)))) => ((! [Xy1:$i] : (Xc_0 = (ccfv @ (XR @ Xy1) @ cc0g))) => ((! [Xx3:$i] : ((XZ @ Xx3) = (ccfv @ (XM @ Xx3) @ cc0g))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : ((XY @ Xx3 @ Xy1 @ Xf1) = (ccfv @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (XR @ Xy1) @ ccminusg)))))) => ((! [Xx3:$i] : (! [Xf1:$i] : ((XG @ Xx3 @ Xf1) = (ccres @ (ccv @ Xf1) @ (ccdif @ XS @ (ccsn @ (ccv @ Xx3))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xf1:$i] : ((cw3a @ ((cwcel @ XS @ (XV @ Xx3 @ Xf1)) & (cwcel @ (XM @ Xx3) @ cclmod)) @ ((cwss @ XS @ (ccfv @ (XM @ Xx3) @ ccbs)) & (cwcel @ (ccv @ Xx3) @ XS)) @ (cw3a @ (cwcel @ (ccv @ Xf1) @ (cco @ (XB2 @ Xx3) @ XS @ ccmap)) @ (cwbr @ (ccv @ Xf1) @ Xc_0 @ ccfsupp) @ ((cco @ (ccv @ Xf1) @ XS @ (ccfv @ (XM @ Xx3) @ cclinc)) = (XZ @ Xx3)))) => ((cco @ (XM @ Xx3) @ (ccmpt @ (^ [Xy1:$i] : (ccdif @ XS @ (ccsn @ (ccv @ Xx3)))) @ (^ [Xy1:$i] : (cco @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccv @ Xy1) @ (ccfv @ (XM @ Xx3) @ ccvsca)))) @ ccgsu) = (cco @ (XY @ Xx3 @ Xy1 @ Xf1) @ (ccv @ Xx3) @ (ccfv @ (XM @ Xx3) @ ccvsca))))))))))))))))))))))).
thf(clindslinindsimp2lem5_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : (XR = (ccfv @ (XM @ Xx3) @ ccsca))) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccfv @ XR @ ccbs))) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((! [Xx3:$i] : ((XZ @ Xx3) = (ccfv @ (XM @ Xx3) @ cc0g))) => (! [Xx3:$i] : (! [Xf1:$i] : ((((cwcel @ XS @ (XV @ Xx3 @ Xf1)) & (cwcel @ (XM @ Xx3) @ cclmod)) & ((cwss @ XS @ (ccfv @ (XM @ Xx3) @ ccbs)) & (cwcel @ (ccv @ Xx3) @ XS))) => (((cwcel @ (ccv @ Xf1) @ (cco @ (XB2 @ Xx3) @ XS @ ccmap)) & ((cwbr @ (ccv @ Xf1) @ Xc_0 @ ccfsupp) & ((cco @ (ccv @ Xf1) @ XS @ (ccfv @ (XM @ Xx3) @ cclinc)) = (XZ @ Xx3)))) => ((cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xg1:$i] : ((~ (cwbr @ (ccv @ Xg1) @ Xc_0 @ ccfsupp)) | (~ ((cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccfv @ (XM @ Xx3) @ ccvsca)) = (cco @ (ccv @ Xg1) @ (ccdif @ XS @ (ccsn @ (ccv @ Xx3))) @ (ccfv @ (XM @ Xx3) @ cclinc)))))) @ (^ [Xg1:$i] : (cco @ (XB2 @ Xx3) @ (ccdif @ XS @ (ccsn @ (ccv @ Xx3))) @ ccmap)))) @ (^ [Xy1:$i] : (ccdif @ (XB2 @ Xx3) @ (ccsn @ Xc_0)))) => ((ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) = Xc_0)))))))))))))))))).
