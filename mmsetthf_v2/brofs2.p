...
thf(cbrofs2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ (cw3a @ (cwcel @ XC @ (ccfv @ XN @ ccee)) @ (cwcel @ XD @ (ccfv @ XN @ ccee)) @ (cwcel @ XE @ (ccfv @ XN @ ccee))) @ (cw3a @ (cwcel @ XF @ (ccfv @ XN @ ccee)) @ (cwcel @ XG @ (ccfv @ XN @ ccee)) @ (cwcel @ XH @ (ccfv @ XN @ ccee)))) => ((cwbr @ (ccop @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD)) @ (ccop @ (ccop @ XE @ XF) @ (ccop @ XG @ XH)) @ ccofs) <=> (cw3a @ (cwbr @ XB2 @ (ccop @ XA2 @ XC) @ ccbtwn) @ (cwbr @ (ccop @ XA2 @ (ccop @ XB2 @ XC)) @ (ccop @ XE @ (ccop @ XF @ XG)) @ cccgr3) @ ((cwbr @ (ccop @ XA2 @ XD) @ (ccop @ XE @ XH) @ cccgr) & (cwbr @ (ccop @ XB2 @ XD) @ (ccop @ XF @ XH) @ cccgr))))))))))))))).
