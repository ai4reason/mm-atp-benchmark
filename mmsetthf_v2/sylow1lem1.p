...
thf(abcp1nk_ax,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) => ((cco @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ XK @ cc1 @ ccaddc) @ ccbc) = (cco @ (cco @ XN @ XK @ ccbc) @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ XK @ cc1 @ ccaddc) @ ccdiv) @ ccmul)))))).
...
thf(abcxmaslem1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = XB2) => ((cco @ (cco @ XN @ XA2 @ ccaddc) @ XA2 @ ccbc) = (cco @ (cco @ XN @ XB2 @ ccaddc) @ XB2 @ ccbc))))))).
...
thf(apcadd2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((Xph => (cwcel @ XP @ ccprime)) => ((Xph => (cwcel @ XA2 @ ccq)) => ((Xph => (cwcel @ XB2 @ ccq)) => ((Xph => (cwbr @ (cco @ XP @ XA2 @ ccpc) @ (cco @ XP @ XB2 @ ccpc) @ cclt)) => (Xph => ((cco @ XP @ XA2 @ ccpc) = (cco @ XP @ (cco @ XA2 @ XB2 @ ccaddc) @ ccpc)))))))))))).
