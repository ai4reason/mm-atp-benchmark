...
thf(aisgrpinv_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((XN = (ccfv @ XG @ ccminusg)) => ((cwcel @ XG @ ccgrp) => (((cwf @ XB2 @ XB2 @ XM) & (cwral @ (^ [Xx3:$i] : ((cco @ (ccfv @ (ccv @ Xx3) @ XM) @ (ccv @ Xx3) @ Xc_pl) = Xc_0)) @ (^ [Xx3:$i] : XB2))) <=> (XN = XM)))))))))))))).
...
thf(coppginv_conj,conjecture,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XR @ ccoppg)) => ((XI = (ccfv @ XR @ ccminusg)) => ((cwcel @ XR @ ccgrp) => (XI = (ccfv @ XO @ ccminusg))))))))).
