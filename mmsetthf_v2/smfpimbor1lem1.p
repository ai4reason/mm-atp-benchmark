...
thf(atgqioo2_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((! [Xq:$i] : ((XJ @ Xq) = (ccfv @ (ccrn @ ccioo) @ cctg))) => ((! [Xq:$i] : ((Xph @ Xq) => (cwcel @ XA2 @ (XJ @ Xq)))) => (! [Xq:$i] : ((Xph @ Xq) => (? [Xq:$i] : ((cwss @ (ccv @ Xq) @ (ccima @ ccioo @ (ccxp @ ccq @ ccq))) & (XA2 = (ccuni @ (ccv @ Xq))))))))))))).
...
thf(asalunicl_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : ((Xph => (cwcel @ XS @ ccsalg)) => ((Xph => (cwcel @ XT @ (ccpw @ XS))) => ((Xph => (cwbr @ XT @ ccom @ ccdom)) => (Xph => (cwcel @ (ccuni @ XT) @ XS))))))))).
...
thf(asmfresal_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XS @ ccsalg)) => ((Xph => (cwcel @ XF @ (ccfv @ XS @ ccsmblfn))) => ((XD = (ccdm @ XF)) => ((! [Xe:$i] : ((XT @ Xe) = (ccrab @ (^ [Xe:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xe)) @ (cco @ XS @ XD @ ccrest))) @ (^ [Xe:$i] : (ccpw @ ccr))))) => (! [Xe:$i] : (Xph => (cwcel @ (XT @ Xe) @ ccsalg))))))))))))).
...
thf(aimaexi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwcel @ (ccima @ XA2 @ XB2) @ ccvv)))))).
...
thf(aioofun_ax,axiom,(cwfun @ ccioo)).
...
thf(asmfpimioo_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XS @ ccsalg)) => ((Xph => (cwcel @ XF @ (ccfv @ XS @ ccsmblfn))) => ((XD = (ccdm @ XF)) => ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => (Xph => (cwcel @ (ccima @ (cccnv @ XF) @ (cco @ XA2 @ XB2 @ ccioo)) @ (cco @ XS @ XD @ ccrest))))))))))))))).
thf(arexrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => (cwcel @ XA2 @ ccxr)))))).
thf(aqred_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccq)) => (Xph => (cwcel @ XA2 @ ccr)))))).
...
thf(afimact_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwbr @ XA2 @ ccom @ ccdom) & (cwfun @ XF)) => (cwbr @ (ccima @ XF @ XA2) @ ccom @ ccdom))))).
