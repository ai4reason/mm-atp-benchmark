...
thf(aghmrn_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (cco @ XS @ XT @ ccghm)) => (cwcel @ (ccrn @ XF) @ (ccfv @ XT @ ccsubg))))))).
...
thf(acayleylem2_ax,axiom,(! [Xc_pl:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((! [Xg1:$i] : ((Xc_0 @ Xg1) = (ccfv @ XG @ cc0g))) => ((! [Xa:$i] : ((XH @ Xa) = (ccfv @ XX @ ccsymg))) => ((! [Xg1:$i] : (! [Xa:$i] : ((XS @ Xg1 @ Xa) = (ccfv @ (XH @ Xa) @ ccbs)))) => ((! [Xg1:$i] : (! [Xa:$i] : ((XF @ Xg1 @ Xa) = (ccmpt @ (^ [Xg1:$i] : XX) @ (^ [Xg1:$i] : (ccmpt @ (^ [Xa:$i] : XX) @ (^ [Xa:$i] : (cco @ (ccv @ Xg1) @ (ccv @ Xa) @ Xc_pl)))))))) => (! [Xg1:$i] : (! [Xa:$i] : ((cwcel @ XG @ ccgrp) => (cwf1 @ XX @ (XS @ Xg1 @ Xa) @ (XF @ Xg1 @ Xa))))))))))))))))))).
