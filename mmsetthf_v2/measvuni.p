...
thf(ameasvunilem0_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XM @ (ccfv @ XS @ ccmeas)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ (ccsn @ cc0))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ((cwbr @ (XA2 @ Xx3) @ ccom @ ccdom) & (cwdisj @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((ccfv @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XM) = (ccesum @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (ccfv @ (XB2 @ Xx3) @ XM)))))))))))).
thf(ccpw_tp,type,(ccpw : (($i > $o) > ($i > $o)))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(ameasvunilem_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XM @ (ccfv @ XS @ ccmeas)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ (ccdif @ XS @ (ccsn @ cc0)))) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ ((cwbr @ (XA2 @ Xx3) @ ccom @ ccdom) & (cwdisj @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((ccfv @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XM) = (ccesum @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (ccfv @ (XB2 @ Xx3) @ XM)))))))))))).
...
thf(ameasun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XM @ (ccfv @ XS @ ccmeas)) @ ((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS)) @ ((ccin @ XA2 @ XB2) = cc0)) => ((ccfv @ (ccun @ XA2 @ XB2) @ XM) = (cco @ (ccfv @ XA2 @ XM) @ (ccfv @ XB2 @ XM) @ ccxad)))))))).
...
thf(cmeasvuni_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XM @ (ccfv @ XS @ ccmeas)) @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ XS)) @ (^ [Xx3:$i] : XA2)) @ ((cwbr @ XA2 @ ccom @ ccdom) & (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((ccfv @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XM) = (ccesum @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (XB2 @ Xx3) @ XM)))))))))).
