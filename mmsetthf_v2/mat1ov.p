...
thf(cmat1ov_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xph => (cwcel @ XN @ ccfn)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XI @ XN)) => ((Xph => (cwcel @ XJ @ XN)) => ((XU = (ccfv @ XA2 @ ccur)) => (Xph => ((cco @ XI @ XJ @ XU) = (ccif @ (XI = XJ) @ Xc_1 @ Xc_0))))))))))))))))))))).
