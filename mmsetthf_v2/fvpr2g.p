...
thf(cfvpr2g_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XB2 @ XV) @ (cwcel @ XD @ XW) @ (cwne @ XA2 @ XB2)) => ((ccfv @ XB2 @ (ccpr @ (ccop @ XA2 @ XC) @ (ccop @ XB2 @ XD))) = XD))))))))).
