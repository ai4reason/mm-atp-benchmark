...
thf(afunoprab_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (cwmo @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))) => (cwfun @ (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))))))).
thf(amoani_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((cwmo @ (^ [Xx3:$i] : (Xph @ Xx3))) => (cwmo @ (^ [Xx3:$i] : ((Xps @ Xx3) & (Xph @ Xx3)))))))).
thf(amosubop_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : ((! [Xy1:$i] : (! [Xz:$i] : (cwmo @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1 @ Xz))))) => (cwmo @ (^ [Xx3:$i] : (? [Xy1:$i] : (? [Xz:$i] : ((XA2 = (ccop @ (ccv @ Xy1) @ (ccv @ Xz))) & (Xph @ Xx3 @ Xy1 @ Xz)))))))))).
...
thf(cax_mulf_conj,conjecture,(cwf @ (ccxp @ ccc @ ccc) @ ccc @ ccmul)).
