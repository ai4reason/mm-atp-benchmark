...
thf(aflltnz_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (~ (cwcel @ XA2 @ ccz))) => (cwbr @ (ccfv @ XA2 @ ccfl) @ XA2 @ cclt)))).
...
thf(cdirkercncflem4_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xn:$i] : ((XD @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (ccif @ ((cco @ (ccv @ Xy1) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) = ccc0) @ (cco @ (cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ (cco @ (ccfv @ (cco @ (cco @ (ccv @ Xn) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (ccv @ Xy1) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (ccv @ Xy1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ (XN @ Xn) @ ccn))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ (XY @ Xn) @ ccr))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwne @ (cco @ (XY @ Xn) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) @ ccc0))) => ((! [Xy1:$i] : (! [Xn:$i] : ((XA2 @ Xy1 @ Xn) = (ccfv @ (cco @ (XY @ Xn) @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ ccfl)))) => ((! [Xy1:$i] : (! [Xn:$i] : ((XB2 @ Xy1 @ Xn) = (cco @ (XA2 @ Xy1 @ Xn) @ cc1 @ ccaddc)))) => ((! [Xy1:$i] : (! [Xn:$i] : ((XC @ Xn) = (cco @ (XA2 @ Xy1 @ Xn) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul)))) => ((! [Xy1:$i] : (! [Xn:$i] : ((XE @ Xn) = (cco @ (XB2 @ Xy1 @ Xn) @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul)))) => (! [Xn:$i] : ((Xph @ Xn) => (cwcel @ (ccfv @ (XN @ Xn) @ (XD @ Xn)) @ (ccfv @ (XY @ Xn) @ (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccnp)))))))))))))))))))))).
