...
thf(cresfval_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwcel @ XF @ (XV @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XH @ (XW @ Xx3)))) => (Xph => ((cco @ XF @ XH @ ccresf) = (ccop @ (ccres @ (ccfv @ XF @ cc1st) @ (ccdm @ (ccdm @ XH))) @ (ccmpt @ (^ [Xx3:$i] : (ccdm @ XH)) @ (^ [Xx3:$i] : (ccres @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XF @ cc2nd)) @ (ccfv @ (ccv @ Xx3) @ XH))))))))))))))).
