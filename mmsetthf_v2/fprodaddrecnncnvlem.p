...
thf(afprodadd2cncf_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XA2 @ ccfn))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccc))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XF @ Xx3 @ Xk) = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (cco @ (XB2 @ Xk) @ (ccv @ Xx3) @ ccaddc)))))))) => (! [Xx3:$i] : (! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XF @ Xx3 @ Xk) @ (cco @ ccc @ ccc @ cccncf)))))))))))))).
...
thf(aprodex_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (cwcel @ (ccprod @ (^ [Xk:$i] : (XA2 @ Xk)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccvv)))).
...
thf(cfprodaddrecnncnvlem_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (! [Xn:$i] : ((Xph @ Xk) => (cwcel @ (XA2 @ Xn) @ ccfn)))) => ((! [Xk:$i] : (! [Xn:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ (XA2 @ Xn))) => (cwcel @ (XB2 @ Xk @ Xn) @ ccc)))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XS @ Xx3 @ Xk @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccprod @ (^ [Xk:$i] : (XA2 @ Xn)) @ (^ [Xk:$i] : (cco @ (XB2 @ Xk @ Xn) @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ ccaddc))))))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XF @ Xx3 @ Xk) = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccprod @ (^ [Xk:$i] : (XA2 @ Xn)) @ (^ [Xk:$i] : (cco @ (XB2 @ Xk @ Xn) @ (ccv @ Xx3) @ ccaddc))))))))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XG @ Xx3 @ Xk) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccdiv)))))) => (! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xph @ Xk) => (cwbr @ (XS @ Xx3 @ Xk @ Xn) @ (ccprod @ (^ [Xk:$i] : (XA2 @ Xn)) @ (^ [Xk:$i] : (XB2 @ Xk @ Xn))) @ ccli)))))))))))))))))).
