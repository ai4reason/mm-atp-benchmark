...
thf(adsmmbas2_ax,axiom,(! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XP = (cco @ XS @ XR @ ccprds)) => ((! [Xf1:$i] : ((XB2 @ Xf1) = (ccrab @ (^ [Xf1:$i] : (cwcel @ (ccdm @ (ccdif @ (ccv @ Xf1) @ (cccom @ cc0g @ XR))) @ ccfn)) @ (^ [Xf1:$i] : (ccfv @ XP @ ccbs))))) => (! [Xf1:$i] : (((cwfn @ XR @ XI) & (cwcel @ XI @ XV)) => ((XB2 @ Xf1) = (ccfv @ (cco @ XS @ XR @ ccdsmm) @ ccbs))))))))))))).
