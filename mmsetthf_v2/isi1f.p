...
thf(adf_itg1_ax,axiom,(ccitg1 = (ccmpt @ (^ [Xf1:$i] : (ccrab @ (^ [Xg1:$i] : (cw3a @ (cwf @ ccr @ ccr @ (ccv @ Xg1)) @ (cwcel @ (ccrn @ (ccv @ Xg1)) @ ccfn) @ (cwcel @ (ccfv @ (ccima @ (cccnv @ (ccv @ Xg1)) @ (ccdif @ ccr @ (ccsn @ ccc0))) @ ccvol) @ ccr))) @ (^ [Xg1:$i] : ccmbf))) @ (^ [Xf1:$i] : (ccsu @ (ccdif @ (ccrn @ (ccv @ Xf1)) @ (ccsn @ ccc0)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (ccfv @ (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ (ccv @ Xx3))) @ ccvol) @ ccmul))))))).
thf(cisi1f_conj,conjecture,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ ccitg1)) <=> ((cwcel @ XF @ ccmbf) & (cw3a @ (cwf @ ccr @ ccr @ XF) @ (cwcel @ (ccrn @ XF) @ ccfn) @ (cwcel @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccdif @ ccr @ (ccsn @ ccc0))) @ ccvol) @ ccr)))))).
