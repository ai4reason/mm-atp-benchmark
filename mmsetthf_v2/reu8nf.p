...
thf(creu8nf_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [XA2:($i > $o)] : ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xy1)))) => ((! [Xw:$i] : (cwnf @ (^ [Xx3:$i] : (Xch @ Xx3 @ Xw)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (((ccv @ Xx3) = (ccv @ Xw)) => ((Xph @ Xx3 @ Xy1) <=> (Xch @ Xx3 @ Xw)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (((ccv @ Xw) = (ccv @ Xy1)) => ((Xch @ Xx3 @ Xw) <=> (Xps @ Xx3 @ Xy1)))))) => (! [Xy1:$i] : ((cwreu @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : XA2)) <=> (cwrex @ (^ [Xx3:$i] : ((Xph @ Xx3 @ Xy1) & (cwral @ (^ [Xy1:$i] : ((Xps @ Xx3 @ Xy1) => ((ccv @ Xx3) = (ccv @ Xy1)))) @ (^ [Xy1:$i] : XA2)))) @ (^ [Xx3:$i] : XA2))))))))))))).
