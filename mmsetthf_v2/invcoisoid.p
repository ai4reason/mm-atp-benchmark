...
thf(ainvisoinvr_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XI = (ccfv @ XC @ cciso)) => ((XN = (ccfv @ XC @ ccinv)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XF @ (cco @ XX @ XY @ XI))) => (Xph => (cwbr @ XF @ (ccfv @ XF @ (cco @ XX @ XY @ XN)) @ (cco @ XX @ XY @ XN))))))))))))))))))).
...
thf(cinvcoisoid_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_op:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XI = (ccfv @ XC @ cciso)) => ((XN = (ccfv @ XC @ ccinv)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XF @ (cco @ XX @ XY @ XI))) => ((Xc_1 = (ccfv @ XC @ cccid)) => ((Xc_op = (cco @ (ccop @ XX @ XY) @ XX @ (ccfv @ XC @ ccco))) => (Xph => ((cco @ (ccfv @ XF @ (cco @ XX @ XY @ XN)) @ XF @ Xc_op) = (ccfv @ XX @ Xc_1))))))))))))))))))))))).
