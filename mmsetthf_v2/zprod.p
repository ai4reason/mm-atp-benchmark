...
thf(afz1iso_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (((cwor @ XA2 @ XR) & (cwcel @ XA2 @ ccfn)) => (? [Xf1:$i] : (cwiso @ (cco @ cc1 @ (ccfv @ XA2 @ cchash) @ ccfz) @ XA2 @ cclt @ XR @ (ccv @ Xf1))))))).
thf(aexpr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & (Xps & Xch)) => Xth) => ((Xph & Xps) => (Xch => Xth)))))))).
thf(ccdif_tp,type,(ccdif : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccxr_tp,type,(ccxr : ($i > $o))).
thf(ccle_tp,type,(ccle : ($i > $o))).
thf(cwf_tp,type,(cwf : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(aprodmolem2a_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xf1:$i] : (! [Xj:$i] : ((XF @ Xf1 @ Xj) = (ccmpt @ (^ [Xk:$i] : ccz) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ (XA2 @ Xf1)) @ (XB2 @ Xf1 @ Xk) @ cc1)))))) => ((! [Xf1:$i] : (! [Xk:$i] : (((Xph @ Xf1) & (cwcel @ (ccv @ Xk) @ (XA2 @ Xf1))) => (cwcel @ (XB2 @ Xf1 @ Xk) @ ccc)))) => ((! [Xf1:$i] : (! [Xk:$i] : ((XG @ Xf1 @ Xk) = (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccsb @ (ccfv @ (ccv @ Xj) @ (ccv @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xf1 @ Xk)))))))) => ((! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XH @ Xf1 @ Xj @ Xk) = (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccsb @ (ccfv @ (ccv @ Xj) @ (XK @ Xf1)) @ (^ [Xk:$i] : (XB2 @ Xf1 @ Xk))))))))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ (XN @ Xf1) @ ccn))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ (XM @ Xf1) @ ccz))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwss @ (XA2 @ Xf1) @ (ccfv @ (XM @ Xf1) @ ccuz)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwf1o @ (cco @ cc1 @ (XN @ Xf1) @ ccfz) @ (XA2 @ Xf1) @ (ccv @ Xf1)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwiso @ (cco @ cc1 @ (ccfv @ (XA2 @ Xf1) @ cchash) @ ccfz) @ (XA2 @ Xf1) @ cclt @ cclt @ (XK @ Xf1)))) => (! [Xf1:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xf1) => (cwbr @ (ccseq @ ccmul @ (XF @ Xf1 @ Xj) @ (XM @ Xf1)) @ (ccfv @ (XN @ Xf1) @ (ccseq @ ccmul @ (XG @ Xf1 @ Xk) @ cc1)) @ ccli)))))))))))))))))))))))).
...
thf(czprod_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((XZ @ Xy1 @ Xk) = (ccfv @ (XM @ Xn) @ ccuz))))) => ((! [Xn:$i] : (Xph => (cwcel @ (XM @ Xn) @ ccz))) => ((! [Xy1:$i] : (! [Xk:$i] : (Xph => (cwrex @ (^ [Xn:$i] : (? [Xy1:$i] : ((cwne @ (ccv @ Xy1) @ ccc0) & (cwbr @ (ccseq @ ccmul @ (XF @ Xy1 @ Xn) @ (ccv @ Xn)) @ (ccv @ Xy1) @ ccli)))) @ (^ [Xn:$i] : (XZ @ Xy1 @ Xk)))))) => ((! [Xy1:$i] : (! [Xk:$i] : (Xph => (cwss @ XA2 @ (XZ @ Xy1 @ Xk))))) => ((! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (XZ @ Xy1 @ Xk))) => ((ccfv @ (ccv @ Xk) @ (XF @ Xy1 @ Xn)) = (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ cc1)))))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccc))) => (! [Xy1:$i] : (! [Xn:$i] : (Xph => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) = (ccfv @ (ccseq @ ccmul @ (XF @ Xy1 @ Xn) @ (XM @ Xn)) @ ccli)))))))))))))))))).
