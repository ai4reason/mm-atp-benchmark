...
thf(admdprdsplit2lem_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwf @ XI @ (ccfv @ XG @ ccsubg) @ XS)) => ((Xph => ((ccin @ XC @ XD) = cc0)) => ((Xph => (XI = (ccun @ XC @ XD))) => ((XZ = (ccfv @ XG @ cccntz)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => (cwbr @ XG @ (ccres @ XS @ XC) @ (ccdm @ ccdprd))) => ((Xph => (cwbr @ XG @ (ccres @ XS @ XD) @ (ccdm @ ccdprd))) => ((Xph => (cwss @ (cco @ XG @ (ccres @ XS @ XC) @ ccdprd) @ (ccfv @ (cco @ XG @ (ccres @ XS @ XD) @ ccdprd) @ XZ))) => ((Xph => ((ccin @ (cco @ XG @ (ccres @ XS @ XC) @ ccdprd) @ (cco @ XG @ (ccres @ XS @ XD) @ ccdprd)) = (ccsn @ Xc_0))) => ((XK = (ccfv @ (ccfv @ XG @ ccsubg) @ ccmrc)) => ((Xph & (cwcel @ XX @ XC)) => (((cwcel @ XY @ XI) => ((cwne @ XX @ XY) => (cwss @ (ccfv @ XX @ XS) @ (ccfv @ (ccfv @ XY @ XS) @ XZ)))) & (cwss @ (ccin @ (ccfv @ XX @ XS) @ (ccfv @ (ccuni @ (ccima @ XS @ (ccdif @ XI @ (ccsn @ XX)))) @ XK)) @ (ccsn @ Xc_0)))))))))))))))))))))))))).
