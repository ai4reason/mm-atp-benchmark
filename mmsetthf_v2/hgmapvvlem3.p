...
thf(adochsnnz_ax,axiom,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((Xc_pe = (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((Xc_0 = (ccfv @ XU @ cc0g)) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XX @ XV)) => (Xph => (cwne @ (ccfv @ (ccsn @ XX) @ Xc_pe) @ (ccsn @ Xc_0)))))))))))))))))))).
...
thf(alssne0_ax,axiom,(! [XS:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xy1:$i] : (Xc_0 = (ccfv @ (XW @ Xy1) @ cc0g))) => ((! [Xy1:$i] : ((XS @ Xy1) = (ccfv @ (XW @ Xy1) @ cclss))) => (! [Xy1:$i] : ((cwcel @ XX @ (XS @ Xy1)) => ((cwne @ XX @ (ccsn @ Xc_0)) <=> (cwrex @ (^ [Xy1:$i] : (cwne @ (ccv @ Xy1) @ Xc_0)) @ (^ [Xy1:$i] : XX)))))))))))).
