...
thf(afssres2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwf @ XA2 @ XB2 @ (ccres @ XF @ XA2)) & (cwss @ XC @ XA2)) => (cwf @ XC @ XB2 @ (ccres @ XF @ XC)))))))).
...
thf(atailfb_ax,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccdm @ XD)) => (((cwcel @ XD @ ccdir) & (cwne @ XX @ cc0)) => (cwcel @ (ccrn @ (ccfv @ XD @ cctail)) @ (ccfv @ XX @ ccfbas))))))).
