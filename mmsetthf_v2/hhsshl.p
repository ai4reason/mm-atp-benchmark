...
thf(ahhssbn_ax,axiom,(! [XH:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccop @ (ccop @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ (ccres @ ccsm @ (ccxp @ ccc @ XH))) @ (ccres @ ccno @ XH))) => ((cwcel @ XH @ ccch) => (cwcel @ XW @ cccbn)))))).
thf(ccss_tp,type,(ccss : ($i > $o))).
thf(ccsh_tp,type,(ccsh : ($i > $o))).
thf(ahhssph_ax,axiom,(! [XH:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccop @ (ccop @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ (ccres @ ccsm @ (ccxp @ ccc @ XH))) @ (ccres @ ccno @ XH))) => ((cwcel @ XH @ ccsh) => (cwcel @ XW @ cccphlo)))))).
