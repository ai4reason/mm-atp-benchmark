...
thf(ahlbn_ax,axiom,(! [XW:($i > $o)] : ((cwcel @ XW @ cchl) => (cwcel @ XW @ ccbn)))).
thf(ccnvc_tp,type,(ccnvc : ($i > $o))).
thf(abnsca_ax,axiom,(! [XF:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((cwcel @ XW @ ccbn) => (cwcel @ XF @ cccms)))))).
thf(chlprlem_conj,conjecture,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((cwcel @ XW @ cchl) => (cw3a @ (cwcel @ XK @ (ccfv @ cccnfld @ ccsubrg)) @ (cwcel @ (cco @ cccnfld @ XK @ ccress) @ ccdr) @ (cwcel @ (cco @ cccnfld @ XK @ ccress) @ cccms))))))))).
