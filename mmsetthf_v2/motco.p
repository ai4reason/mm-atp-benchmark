...
thf(cmotco_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((Xph => (cwcel @ XG @ XV)) => ((Xph => (cwcel @ XF @ (cco @ XG @ XG @ ccismt))) => ((Xph => (cwcel @ XH @ (cco @ XG @ XG @ ccismt))) => (Xph => (cwcel @ (cccom @ XF @ XH) @ (cco @ XG @ XG @ ccismt)))))))))))))))).
