...
thf(axmulcld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => (Xph => (cwcel @ (cco @ XA2 @ XB2 @ ccxmu) @ ccxr)))))))).
...
thf(axreceu_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccr) @ (cwne @ XB2 @ ccc0)) => (cwreu @ (^ [Xx3:$i] : ((cco @ XB2 @ (ccv @ Xx3) @ ccxmu) = XA2)) @ (^ [Xx3:$i] : ccxr)))))).
...
thf(axmulcom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cco @ XA2 @ XB2 @ ccxmu) = (cco @ XB2 @ XA2 @ ccxmu)))))).
...
thf(axlemul1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccrp)) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwbr @ (cco @ XA2 @ XC @ ccxmu) @ (cco @ XB2 @ XC @ ccxmu) @ ccle))))))).
...
thf(aordthmeolem_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccdm @ XR)) => ((XY = (ccdm @ XS)) => ((cw3a @ (cwcel @ XR @ XV) @ (cwcel @ XS @ XW) @ (cwiso @ XX @ XY @ XR @ XS @ XF)) => (cwcel @ XF @ (cco @ (ccfv @ XR @ ccordt) @ (ccfv @ XS @ ccordt) @ cccn))))))))))))).
...
thf(cxrmulc1cn_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ ccle @ ccordt))) => ((XF = (ccmpt @ (^ [Xx3:$i] : ccxr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XC @ ccxmu)))) => ((Xph => (cwcel @ XC @ ccrp)) => (! [Xx3:$i] : (Xph => (cwcel @ XF @ (cco @ (XJ @ Xx3) @ (XJ @ Xx3) @ cccn)))))))))))).
