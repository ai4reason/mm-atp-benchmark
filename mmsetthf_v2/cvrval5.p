...
thf(ccvrval5_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((! [Xp:$i] : ((Xc_or @ Xp) = (ccfv @ XK @ ccjn))) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XC = (ccfv @ XK @ cccvr)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => ((cwbr @ (cco @ XX @ XY @ Xc_an) @ XX @ XC) <=> (cwrex @ (^ [Xp:$i] : ((~ (cwbr @ (ccv @ Xp) @ XY @ Xc_le)) & ((cco @ (ccv @ Xp) @ (cco @ XX @ XY @ Xc_an) @ (Xc_or @ Xp)) = XX))) @ (^ [Xp:$i] : XA2)))))))))))))))))))).
