...
thf(aznlidl_ax,axiom,(! [XS:($i > $o)] : (! [XN:($i > $o)] : ((XS = (ccfv @ czring @ ccrsp)) => ((cwcel @ XN @ ccz) => (cwcel @ (ccfv @ (ccsn @ XN) @ XS) @ (ccfv @ czring @ cclidl))))))).
...
thf(aqusrhm_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XU = (cco @ XR @ (cco @ XR @ XS @ ccqg) @ ccqus)) => ((XI = (ccfv @ XR @ cc2idl)) => ((XX = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccec @ (ccv @ Xx3) @ (cco @ XR @ XS @ ccqg)))))) => (! [Xx3:$i] : (((cwcel @ XR @ ccrg) & (cwcel @ XS @ XI)) => (cwcel @ (XF @ Xx3) @ (cco @ XR @ XU @ ccrh))))))))))))))).
...
thf(aeceq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((ccec @ XC @ XA2) = (ccec @ XC @ XB2))))))).
thf(a_4syl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xps) => ((Xps => Xch) => ((Xch => Xth) => ((Xth => Xta) => (Xph => Xta))))))))))).
thf(azncrng2_ax,axiom,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : ((XS = (ccfv @ czring @ ccrsp)) => ((XU = (cco @ czring @ (cco @ czring @ (ccfv @ (ccsn @ XN) @ XS) @ ccqg) @ ccqus)) => ((cwcel @ XN @ ccz) => (cwcel @ XU @ cccrg)))))))).
thf(cccmn_tp,type,(cccmn : ($i > $o))).
thf(ccmgp_tp,type,(ccmgp : ($i > $o))).
thf(acrngring_ax,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ cccrg) => (cwcel @ XR @ ccrg)))).
thf(ccmg_tp,type,(ccmg : ($i > $o))).
thf(azrhrhmb_ax,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : ((XL = (ccfv @ XR @ cczrh)) => ((cwcel @ XR @ ccrg) => ((cwcel @ XF @ (cco @ czring @ XR @ ccrh)) <=> (XF = XL)))))))).
