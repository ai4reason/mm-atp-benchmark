...
thf(accat2s1fvw_ax,axiom,(! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XI @ ccn0) @ (cwbr @ XI @ (ccfv @ XW @ cchash) @ cclt)) & ((cwcel @ XX @ XV) & (cwcel @ XY @ XV))) => ((ccfv @ XI @ (cco @ (cco @ XW @ (ccs1 @ XX) @ ccconcat) @ (ccs1 @ XY) @ ccconcat)) = (ccfv @ XI @ XW))))))))).
