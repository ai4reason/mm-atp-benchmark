...
thf(aiccdil_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cco @ XA2 @ XR @ ccmul) = XC) => (((cco @ XB2 @ XR @ ccmul) = XD) => ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwcel @ XX @ ccr) & (cwcel @ XR @ ccrp))) => ((cwcel @ XX @ (cco @ XA2 @ XB2 @ ccicc)) <=> (cwcel @ (cco @ XX @ XR @ ccmul) @ (cco @ XC @ XD @ ccicc))))))))))))).
...
thf(aiccshftr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (((cco @ XA2 @ XR @ ccaddc) = XC) => (((cco @ XB2 @ XR @ ccaddc) = XD) => ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwcel @ XX @ ccr) & (cwcel @ XR @ ccr))) => ((cwcel @ XX @ (cco @ XA2 @ XB2 @ ccicc)) <=> (cwcel @ (cco @ XX @ XR @ ccaddc) @ (cco @ XC @ XD @ ccicc))))))))))))).
...
thf(clincmb01cmp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ cclt)) & (cwcel @ XT @ (cco @ ccc0 @ cc1 @ ccicc))) => (cwcel @ (cco @ (cco @ (cco @ cc1 @ XT @ ccmin) @ XA2 @ ccmul) @ (cco @ XT @ XB2 @ ccmul) @ ccaddc) @ (cco @ XA2 @ XB2 @ ccicc))))))).
