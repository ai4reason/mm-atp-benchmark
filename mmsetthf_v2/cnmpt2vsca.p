...
thf(atlmscatps_ax,axiom,(! [XF:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((cwcel @ XW @ cctlm) => (cwcel @ XF @ cctps)))))).
...
thf(atlmtps_ax,axiom,(! [XW:($i > $o)] : ((cwcel @ XW @ cctlm) => (cwcel @ XW @ cctps)))).
...
thf(avscacn_ax,axiom,(! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((Xc_x = (ccfv @ XW @ ccscaf)) => ((XJ = (ccfv @ XW @ cctopn)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ cctopn)) => ((cwcel @ XW @ cctlm) => (cwcel @ Xc_x @ (cco @ (cco @ XK @ XJ @ cctx) @ XJ @ cccn))))))))))))).
