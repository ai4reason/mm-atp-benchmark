...
thf(adf_ginv_ax,axiom,(ccgn = (ccmpt @ (^ [Xg1:$i] : ccgr) @ (^ [Xg1:$i] : (ccmpt @ (^ [Xx3:$i] : (ccrn @ (ccv @ Xg1))) @ (^ [Xx3:$i] : (ccrio @ (^ [Xz:$i] : ((cco @ (ccv @ Xz) @ (ccv @ Xx3) @ (ccv @ Xg1)) = (ccfv @ (ccv @ Xg1) @ ccgi))) @ (^ [Xz:$i] : (ccrn @ (ccv @ Xg1)))))))))).
thf(cgrpoinvfval_conj,conjecture,(! [XU:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((! [Xy1:$i] : ((XU @ Xy1) = (ccfv @ XG @ ccgi))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XN @ Xx3 @ Xy1) = (ccfv @ XG @ ccgn)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XG @ ccgr) => ((XN @ Xx3 @ Xy1) = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrio @ (^ [Xy1:$i] : ((cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ XG) = (XU @ Xy1))) @ (^ [Xy1:$i] : XX)))))))))))))))).
