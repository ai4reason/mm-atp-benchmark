...
thf(aelfzomin_ax,axiom,(! [XZ:($i > $o)] : ((cwcel @ XZ @ ccz) => (cwcel @ XZ @ (cco @ XZ @ (cco @ XZ @ cc1 @ ccaddc) @ ccfzo))))).
...
thf(czpnn0elfzo_conj,conjecture,(! [XN:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XZ @ ccz) & (cwcel @ XN @ ccn0)) => (cwcel @ (cco @ XZ @ XN @ ccaddc) @ (cco @ XZ @ (cco @ (cco @ XZ @ XN @ ccaddc) @ cc1 @ ccaddc) @ ccfzo)))))).
