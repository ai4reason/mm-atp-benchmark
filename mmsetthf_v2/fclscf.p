...
thf(afclstopon_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) => ((cwcel @ XJ @ (ccfv @ XX @ cctopon)) <=> (cwcel @ XF @ (ccfv @ XX @ ccfil))))))))).
thf(asimprl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph & (Xps & Xch)) => Xps))))).
thf(afclsss1_ax,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwss @ XJ @ XK)) => (cwss @ (cco @ XK @ XF @ ccfcls) @ (cco @ XJ @ XF @ ccfcls)))))))).
...
thf(asupnfcls_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [Xx3:$i] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XU @ XJ) @ (cwcel @ (XA2 @ Xx3) @ XU)) => (~ (cwcel @ (XA2 @ Xx3) @ (cco @ XJ @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccdif @ XX @ XU) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : (ccpw @ XX))) @ ccfcls)))))))))).
...
thf(asupfil_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cw3a @ (cwcel @ XA2 @ (XV @ Xx3)) @ (cwss @ XB2 @ XA2) @ (cwne @ XB2 @ cc0)) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwss @ XB2 @ (ccv @ Xx3))) @ (^ [Xx3:$i] : (ccpw @ XA2))) @ (ccfv @ XA2 @ ccfil)))))))).
...
thf(cfclscf_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XK @ (ccfv @ XX @ cctopon))) => ((cwss @ XJ @ XK) <=> (cwral @ (^ [Xf1:$i] : (cwss @ (cco @ XK @ (ccv @ Xf1) @ ccfcls) @ (cco @ XJ @ (ccv @ Xf1) @ ccfcls))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil))))))))).
