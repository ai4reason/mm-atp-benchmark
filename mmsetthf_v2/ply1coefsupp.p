...
thf(acoe1sfi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (ccfv @ XF @ ccco1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((cwcel @ XF @ XB2) => (cwbr @ XA2 @ Xc_0 @ ccfsupp))))))))))))).
