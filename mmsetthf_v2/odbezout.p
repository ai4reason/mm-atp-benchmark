...
thf(codbezout_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => (((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XX) @ (cwcel @ XN @ ccz)) & ((cco @ XN @ (ccfv @ XA2 @ XO) @ ccgcd) = cc1)) => (cwrex @ (^ [Xx3:$i] : ((cco @ (ccv @ Xx3) @ (cco @ XN @ XA2 @ Xc_x) @ Xc_x) = XA2)) @ (^ [Xx3:$i] : ccz))))))))))))).
