...
thf(cfvsnun2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((XG = (ccun @ (ccsn @ (ccop @ XA2 @ XB2)) @ (ccres @ XF @ (ccdif @ XC @ (ccsn @ XA2))))) => ((cwcel @ XD @ (ccdif @ XC @ (ccsn @ XA2))) => ((ccfv @ XD @ XG) = (ccfv @ XD @ XF))))))))))))).
