...
thf(ccevathlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc))) => ((Xph => (cw3a @ (cwcel @ XD @ ccc) @ (cwcel @ XE @ ccc) @ (cwcel @ XF @ ccc))) => ((Xph => (cw3a @ (cwcel @ XG @ ccc) @ (cwcel @ XH @ ccc) @ (cwcel @ XK @ ccc))) => ((Xph => (cw3a @ (cwne @ XA2 @ ccc0) @ (cwne @ XE @ ccc0) @ (cwne @ XC @ ccc0))) => ((Xph => (cw3a @ ((cco @ XA2 @ XB2 @ ccmul) = (cco @ XC @ XD @ ccmul)) @ ((cco @ XE @ XF @ ccmul) = (cco @ XA2 @ XG @ ccmul)) @ ((cco @ XC @ XH @ ccmul) = (cco @ XE @ XK @ ccmul)))) => (Xph => ((cco @ (cco @ XB2 @ XF @ ccmul) @ XH @ ccmul) = (cco @ (cco @ XD @ XG @ ccmul) @ XK @ ccmul))))))))))))))))))).
