...
thf(cneitx_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => ((((cwcel @ XJ @ cctop) & (cwcel @ XK @ cctop)) & ((cwcel @ XA2 @ (ccfv @ XC @ (ccfv @ XJ @ ccnei))) & (cwcel @ XB2 @ (ccfv @ XD @ (ccfv @ XK @ ccnei))))) => (cwcel @ (ccxp @ XA2 @ XB2) @ (ccfv @ (ccxp @ XC @ XD) @ (ccfv @ (cco @ XJ @ XK @ cctx) @ ccnei))))))))))))))).
