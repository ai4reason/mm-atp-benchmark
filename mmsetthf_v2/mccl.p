...
thf(cmccl_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwnfc @ (^ [Xk:$i] : (XB2 @ Xk))) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((! [Xk:$i] : (Xph => (cwcel @ (XB2 @ Xk) @ (cco @ ccn0 @ XA2 @ ccmap)))) => (Xph => (cwcel @ (cco @ (ccfv @ (ccsu @ XA2 @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XB2 @ Xk)))) @ ccfa) @ (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xk)) @ ccfa))) @ ccdiv) @ ccn))))))))).
