...
thf(algsqrmod_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => (((cco @ XA2 @ XP @ cclgs) = cc1) => (cwrex @ (^ [Xx3:$i] : ((cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ XP @ ccmo) = (cco @ XA2 @ XP @ ccmo))) @ (^ [Xx3:$i] : ccz))))))).
...
thf(algsprme0_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XP @ ccprime)) => (((cco @ XA2 @ XP @ cclgs) = ccc0) <=> ((cco @ XA2 @ XP @ ccmo) = ccc0)))))).
...
thf(clgsqrmodndvds_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => (((cco @ XA2 @ XP @ cclgs) = cc1) => (cwrex @ (^ [Xx3:$i] : (((cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ XP @ ccmo) = (cco @ XA2 @ XP @ ccmo)) & (~ (cwbr @ XP @ (ccv @ Xx3) @ ccdvds)))) @ (^ [Xx3:$i] : ccz))))))).
