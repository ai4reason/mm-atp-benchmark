...
thf(adf_bases_ax,axiom,(cctb = (ccab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwss @ (ccin @ (ccv @ Xy1) @ (ccv @ Xz)) @ (ccuni @ (ccin @ (ccv @ Xx3) @ (ccpw @ (ccin @ (ccv @ Xy1) @ (ccv @ Xz))))))) @ (^ [Xz:$i] : (ccv @ Xx3)))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))).
