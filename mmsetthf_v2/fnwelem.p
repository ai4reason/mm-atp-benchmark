...
thf(asylanblrc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => (Xch => ((Xth <=> (Xps & Xch)) => (Xph => Xth))))))))).
...
thf(af1oiso2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XS @ Xx3 @ Xy1) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XB2) & (cwcel @ (ccv @ Xy1) @ XB2)) & (cwbr @ (ccfv @ (ccv @ Xx3) @ (cccnv @ XH)) @ (ccfv @ (ccv @ Xy1) @ (cccnv @ XH)) @ XR)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwf1o @ XA2 @ XB2 @ XH) => (cwiso @ XA2 @ XB2 @ XR @ (XS @ Xx3 @ Xy1) @ XH))))))))))).
...
thf(aisoeq3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : ((XS = XT) => ((cwiso @ XA2 @ XB2 @ XR @ XS @ XH) <=> (cwiso @ XA2 @ XB2 @ XR @ XT @ XH)))))))))).
...
thf(aimacnvcnv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccima @ (cccnv @ (cccnv @ XA2)) @ XB2) = (ccima @ XA2 @ XB2))))).
...
thf(aisowe2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (((cwiso @ XA2 @ XB2 @ XR @ XS @ XH) & (! [Xx3:$i] : (cwcel @ (ccima @ XH @ (ccv @ Xx3)) @ ccvv))) => ((cwwe @ XB2 @ XS) => (cwwe @ XA2 @ XR))))))))).
thf(cfnwelem_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : ((XT @ Xx3 @ Xy1 @ Xz @ Xv @ Xu) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XA2) & (cwcel @ (ccv @ Xy1) @ XA2)) & ((cwbr @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ (XR @ Xz)) | (((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xy1) @ XF)) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XS @ Xz)))))))))))))) => ((! [Xy1:$i] : (! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xy1 @ Xv @ Xu) => (cwf @ XA2 @ XB2 @ XF))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xy1 @ Xv @ Xu) => (cwwe @ XB2 @ (XR @ Xz))))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xy1 @ Xv @ Xu) => (cwwe @ XA2 @ (XS @ Xz))))))) => ((! [Xy1:$i] : (! [Xw:$i] : (! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xy1 @ Xv @ Xu) => (cwcel @ (ccima @ XF @ (ccv @ Xw)) @ ccvv)))))) => ((! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : ((XQ @ Xz @ Xv @ Xu) = (ccopab @ (^ [Xu:$i] : (^ [Xv:$i] : (((cwcel @ (ccv @ Xu) @ (ccxp @ XB2 @ XA2)) & (cwcel @ (ccv @ Xv) @ (ccxp @ XB2 @ XA2))) & ((cwbr @ (ccfv @ (ccv @ Xu) @ cc1st) @ (ccfv @ (ccv @ Xv) @ cc1st) @ (XR @ Xz)) | (((ccfv @ (ccv @ Xu) @ cc1st) = (ccfv @ (ccv @ Xv) @ cc1st)) & (cwbr @ (ccfv @ (ccv @ Xu) @ cc2nd) @ (ccfv @ (ccv @ Xv) @ cc2nd) @ (XS @ Xz)))))))))))) => ((! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : ((XG @ Xz @ Xv @ Xu) = (ccmpt @ (^ [Xz:$i] : XA2) @ (^ [Xz:$i] : (ccop @ (ccfv @ (ccv @ Xz) @ XF) @ (ccv @ Xz)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : ((Xph @ Xy1 @ Xv @ Xu) => (cwwe @ XA2 @ (XT @ Xx3 @ Xy1 @ Xz @ Xv @ Xu))))))))))))))))))))))))).
