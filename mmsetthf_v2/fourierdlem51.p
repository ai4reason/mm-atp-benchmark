...
thf(afourierdlem6_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((XT = (cco @ XB2 @ XA2 @ ccmin)) => ((Xph => (cwcel @ XX @ ccr)) => ((Xph => (cwcel @ XI @ ccz)) => ((Xph => (cwcel @ XJ @ ccz)) => ((Xph => (cwbr @ XI @ XJ @ cclt)) => ((Xph => (cwcel @ (cco @ XX @ (cco @ XI @ XT @ ccmul) @ ccaddc) @ (cco @ XA2 @ XB2 @ ccicc))) => ((Xph => (cwcel @ (cco @ XX @ (cco @ XJ @ XT @ ccmul) @ ccaddc) @ (cco @ XA2 @ XB2 @ ccicc))) => (Xph => (XJ = (cco @ XI @ cc1 @ ccaddc))))))))))))))))))))).
...
thf(aeliccelioc_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccxr)) => (Xph => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioc)) <=> ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc)) & (cwne @ XC @ XA2)))))))))))).
thf(afourierdlem35_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((XT = (cco @ XB2 @ XA2 @ ccmin)) => ((Xph => (cwcel @ XX @ ccr)) => ((Xph => (cwcel @ XI @ ccz)) => ((Xph => (cwcel @ XJ @ ccz)) => ((Xph => (cwcel @ (cco @ XX @ (cco @ XI @ XT @ ccmul) @ ccaddc) @ (cco @ XA2 @ XB2 @ ccioc))) => ((Xph => (cwcel @ (cco @ XX @ (cco @ XJ @ XT @ ccmul) @ ccaddc) @ (cco @ XA2 @ XB2 @ ccioc))) => (Xph => (XI = XJ))))))))))))))))))).
