...
thf(aiccpartgel_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XP @ (ccfv @ XM @ cciccp))) => (Xph => (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ ccc0 @ XP) @ (ccfv @ (ccv @ Xi) @ XP) @ ccle)) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfz)))))))))).
...
thf(aiccpartleu_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XP @ (ccfv @ XM @ cciccp))) => (Xph => (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ XM @ XP) @ ccle)) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfz)))))))))).
...
thf(aicceuelpart_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XP @ (ccfv @ XM @ cciccp))) => ((Xph & (cwcel @ XX @ (cco @ (ccfv @ ccc0 @ XP) @ (ccfv @ XM @ XP) @ ccico))) => (cwreu @ (^ [Xi:$i] : (cwcel @ XX @ (cco @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP) @ ccico))) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfzo))))))))))).
...
thf(ciccpartdisj_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XP @ (ccfv @ XM @ cciccp))) => (Xph => (cwdisj @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfzo)) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP) @ ccico)))))))))).
