...
thf(areefiso_ax,axiom,(cwiso @ ccr @ ccrp @ cclt @ cclt @ (ccres @ cce @ ccr))).
...
thf(cefcvx_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ cclt)) & (cwcel @ XT @ (cco @ ccc0 @ cc1 @ ccioo))) => (cwbr @ (ccfv @ (cco @ (cco @ XT @ XA2 @ ccmul) @ (cco @ (cco @ cc1 @ XT @ ccmin) @ XB2 @ ccmul) @ ccaddc) @ cce) @ (cco @ (cco @ XT @ (ccfv @ XA2 @ cce) @ ccmul) @ (cco @ (cco @ cc1 @ XT @ ccmin) @ (ccfv @ XB2 @ cce) @ ccmul) @ ccaddc) @ cclt)))))).
