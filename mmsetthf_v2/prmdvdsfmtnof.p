...
thf(afmtnorn_ax,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccrn @ ccfmtno)) <=> (cwrex @ (^ [Xn:$i] : ((ccfv @ (ccv @ Xn) @ ccfmtno) = XF)) @ (^ [Xn:$i] : ccn0))))).
...
thf(afmtnoge3_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => (cwcel @ (ccfv @ XN @ ccfmtno) @ (ccfv @ cc3 @ ccuz))))).
...
thf(cprmdvdsfmtnof_conj,conjecture,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xp:$i] : ((XF @ Xf1 @ Xp) = (ccmpt @ (^ [Xf1:$i] : (ccrn @ ccfmtno)) @ (^ [Xf1:$i] : (ccinf @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (ccv @ Xf1) @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ ccr @ cclt)))))) => (! [Xf1:$i] : (! [Xp:$i] : (cwf @ (ccrn @ ccfmtno) @ ccprime @ (XF @ Xf1 @ Xp))))))).
