...
thf(asge0split_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((XU = (ccun @ XA2 @ XB2)) => ((Xph => ((ccin @ XA2 @ XB2) = cc0)) => ((Xph => (cwf @ XU @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => (Xph => ((ccfv @ XF @ ccsumge0) = (cco @ (ccfv @ (ccres @ XF @ XA2) @ ccsumge0) @ (ccfv @ (ccres @ XF @ XB2) @ ccsumge0) @ ccxad)))))))))))))))).
