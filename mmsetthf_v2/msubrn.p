...
thf(amsubfval_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XT @ ccmvar)) => ((XR = (ccfv @ XT @ ccmrex)) => ((! [Xe:$i] : ((XS @ Xe) = (ccfv @ XT @ ccmsub))) => ((XE = (ccfv @ XT @ ccmex)) => ((XO = (ccfv @ XT @ ccmrsub)) => (! [Xe:$i] : (((cwf @ XA2 @ XR @ XF) & (cwss @ XA2 @ XV)) => ((ccfv @ XF @ (XS @ Xe)) = (ccmpt @ (^ [Xe:$i] : XE) @ (^ [Xe:$i] : (ccop @ (ccfv @ (ccv @ Xe) @ cc1st) @ (ccfv @ (ccfv @ (ccv @ Xe) @ cc2nd) @ (ccfv @ XF @ XO)))))))))))))))))))))).
