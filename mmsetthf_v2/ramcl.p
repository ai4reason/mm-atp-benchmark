...
thf(a_0ramcl_ax,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XR @ ccfn) & (cwf @ XR @ ccn0 @ XF)) => (cwcel @ (cco @ ccc0 @ XF @ ccram) @ ccn0))))).
...
thf(aram0_ax,axiom,(! [XM:($i > $o)] : ((cwcel @ XM @ ccn0) => ((cco @ XM @ cc0 @ ccram) = XM)))).
...
thf(aramz_ax,axiom,(! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XM @ ccn0) @ (cwcel @ XR @ XV) @ (cwne @ XR @ cc0)) => ((cco @ XM @ (ccxp @ XR @ (ccsn @ ccc0)) @ ccram) = ccc0)))))).
...
thf(asumhash_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XB2 @ ccfn) & (cwss @ XA2 @ XB2)) => ((ccsu @ XB2 @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ cc1 @ ccc0))) = (ccfv @ XA2 @ cchash)))))).
...
thf(aramub1_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XR @ ccfn)) => ((Xph => (cwf @ XR @ ccn @ XF)) => ((XG = (ccmpt @ (^ [Xx3:$i] : XR) @ (^ [Xx3:$i] : (cco @ XM @ (ccmpt @ (^ [Xy1:$i] : XR) @ (^ [Xy1:$i] : (ccif @ ((ccv @ Xy1) = (ccv @ Xx3)) @ (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ cc1 @ ccmin) @ (ccfv @ (ccv @ Xy1) @ XF)))) @ ccram)))) => ((Xph => (cwf @ XR @ ccn0 @ XG)) => ((Xph => (cwcel @ (cco @ (cco @ XM @ cc1 @ ccmin) @ XG @ ccram) @ ccn0)) => (Xph => (cwbr @ (cco @ XM @ XF @ ccram) @ (cco @ (cco @ (cco @ XM @ cc1 @ ccmin) @ XG @ ccram) @ cc1 @ ccaddc) @ ccle)))))))))))))).
...
thf(aramz2_ax,axiom,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (((cw3a @ (cwcel @ XM @ ccn) @ (cwcel @ XR @ XV) @ (cwf @ XR @ ccn0 @ XF)) & ((cwcel @ XC @ XR) & ((ccfv @ XC @ XF) = ccc0))) => ((cco @ XM @ XF @ ccram) = ccc0)))))))).
...
thf(cramcl_conj,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XM @ ccn0) @ (cwcel @ XR @ ccfn) @ (cwf @ XR @ ccn0 @ XF)) => (cwcel @ (cco @ XM @ XF @ ccram) @ ccn0)))))).
