...
thf(atrclfv_ax,axiom,(! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XR @ (XV @ Xx3)) => ((ccfv @ XR @ cctcl) = (ccint @ (ccab @ (^ [Xx3:$i] : ((cwss @ XR @ (ccv @ Xx3)) & (cwss @ (cccom @ (ccv @ Xx3) @ (ccv @ Xx3)) @ (ccv @ Xx3)))))))))))).
thf(a_3adant3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => ((cw3a @ Xph @ Xps @ Xth) => Xch))))))).
thf(aelimasng_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XB2 @ XV) & (cwcel @ XC @ XW)) => ((cwcel @ XC @ (ccima @ XA2 @ (ccsn @ XB2))) <=> (cwcel @ (ccop @ XB2 @ XC) @ XA2))))))))).
...
thf(atrclfvlb_ax,axiom,(! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XR @ XV) => (cwss @ XR @ (ccfv @ XR @ cctcl)))))).
...
thf(atrclimalb2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XR @ XV) & (cwss @ (ccima @ XR @ (ccun @ XA2 @ XB2)) @ XB2)) => (cwss @ (ccima @ (ccfv @ XR @ cctcl) @ XA2) @ XB2))))))).
...
thf(asseq12i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((XA2 = XB2) => ((XC = XD) => ((cwss @ XA2 @ XC) <=> (cwss @ XB2 @ XD))))))))).
...
thf(acsbcog_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ (XA2 @ Xx3) @ (XV @ Xx3)) => ((ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (cccom @ (XB2 @ Xx3) @ (XC @ Xx3)))) = (cccom @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XC @ Xx3)))))))))))).
...
thf(acsbima12_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [Xx3:$i] : ((ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (ccima @ (XF @ Xx3) @ (XB2 @ Xx3)))) = (ccima @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XF @ Xx3))) @ (ccsb @ (XA2 @ Xx3) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))).
...
thf(arexab2_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => ((cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (ccab @ (^ [Xy1:$i] : (Xph @ Xy1))))) <=> (? [Xy1:$i] : ((Xph @ Xy1) & (Xch @ Xy1))))))))).
...
thf(cbrtrclfv2_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XV) @ (cwcel @ XR @ XW)) => ((cwbr @ XX @ XY @ (ccfv @ XR @ cctcl)) <=> (cwcel @ XY @ (ccint @ (ccab @ (^ [Xf1:$i] : (cwss @ (ccima @ XR @ (ccun @ (ccsn @ XX) @ (ccv @ Xf1))) @ (ccv @ Xf1))))))))))))))).
