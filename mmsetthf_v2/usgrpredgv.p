...
thf(cusgrpredgv_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XE = (ccfv @ XG @ ccedg)) => ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ ccusgr) & (cwcel @ (ccpr @ XM @ XN) @ XE)) => ((cwcel @ XM @ XV) & (cwcel @ XN @ XV))))))))))).
