...
thf(clpvtx_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => ((cw3a @ (cwcel @ XG @ ccuhgr) @ (cwcel @ XJ @ (ccdm @ XI)) @ ((ccfv @ XJ @ XI) = (ccsn @ XA2))) => (cwcel @ XA2 @ (ccfv @ XG @ ccvtx))))))))).
