...
thf(alcmfn0val_ax,axiom,(! [XZ:($i > $o)] : ((cw3a @ (cwss @ XZ @ ccz) @ (cwcel @ XZ @ ccfn) @ (cwnel @ ccc0 @ XZ)) => ((ccfv @ XZ @ cclcmf) = (ccinf @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xm:$i] : XZ))) @ (^ [Xn:$i] : ccn)) @ ccr @ cclt))))).
