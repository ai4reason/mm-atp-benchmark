...
thf(csotr3_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (((cwor @ XA2 @ XR) & (cw3a @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XA2) @ (cwcel @ XZ @ XA2))) => (((cwbr @ XX @ XY @ XR) & (~ (cwbr @ XZ @ XY @ XR))) => (cwbr @ XX @ XZ @ XR))))))))).
