...
thf(ahvadd12i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cwcel @ XC @ cchil) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccva) @ ccva) = (cco @ XB2 @ (cco @ XA2 @ XC @ ccva) @ ccva))))))))).
...
thf(ahvaddcani_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cwcel @ XC @ cchil) => (((cco @ XA2 @ XB2 @ ccva) = (cco @ XA2 @ XC @ ccva)) <=> (XB2 = XC))))))))).
