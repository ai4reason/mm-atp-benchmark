...
thf(a_2timesgt_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwbr @ XA2 @ (cco @ cc2 @ XA2 @ ccmul) @ cclt)))).
...
thf(altnegcon1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ (ccneg @ XA2) @ XB2 @ cclt)) => (Xph => (cwbr @ (ccneg @ XB2) @ XA2 @ cclt))))))))).
...
thf(cfourierdlem24_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ (ccsn @ ccc0))) => (cwne @ (cco @ XA2 @ (cco @ cc2 @ ccpi @ ccmul) @ ccmo) @ ccc0)))).
