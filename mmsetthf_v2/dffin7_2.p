...
thf(aisfin7_2_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XA2 @ ccfin7) <=> ((cwcel @ XA2 @ (ccdm @ cccrd)) => (cwcel @ XA2 @ ccfn))))))).
...
thf(cdffin7_2_conj,conjecture,(ccfin7 = (ccun @ ccfn @ (ccdif @ ccvv @ (ccdm @ cccrd))))).
