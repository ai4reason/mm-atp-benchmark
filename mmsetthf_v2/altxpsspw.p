...
thf(aelaltxp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ (ccaltxp @ XA2 @ XB2)) <=> (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (XX = (ccaltop @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))))))).
...
thf(assun3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ XB2) => (cwss @ XA2 @ (ccun @ XB2 @ XC))))))).
...
thf(aprsspw_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwss @ (ccpr @ XA2 @ XB2) @ (ccpw @ XC)) <=> ((cwss @ XA2 @ XC) & (cwss @ XB2 @ XC))))))))).
thf(aeleq1a_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ XB2) => ((XC = XA2) => (cwcel @ XC @ XB2))))))).
thf(caltxpsspw_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (ccaltxp @ XA2 @ XB2) @ (ccpw @ (ccpw @ (ccun @ XA2 @ (ccpw @ XB2)))))))).
