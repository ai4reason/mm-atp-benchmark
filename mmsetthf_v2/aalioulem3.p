...
thf(ac1lip3_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ (ccres @ XF @ ccr) @ (ccfv @ cc1 @ (ccfv @ ccr @ cccpn)))) => ((Xph => (cwss @ (ccima @ XF @ ccr) @ ccr)) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ (ccdm @ XF))) => (Xph => (cwrex @ (^ [Xk:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccmin) @ ccabs) @ (cco @ (ccv @ Xk) @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccmin) @ ccabs) @ ccmul) @ ccle)) @ (^ [Xy1:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)))) @ (^ [Xk:$i] : ccr))))))))))))).
...
thf(aplycpn_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (ccfv @ XS @ ccply)) => (cwcel @ XF @ (ccint @ (ccrn @ (ccfv @ ccc @ cccpn)))))))).
thf(acpnres_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XS @ (ccpr @ ccr @ ccc)) & (cwcel @ XF @ (ccfv @ XN @ (ccfv @ ccc @ cccpn)))) => (cwcel @ (ccres @ XF @ XS) @ (ccfv @ XN @ (ccfv @ XS @ cccpn)))))))).
...
thf(aelicc4abs_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) => ((cwcel @ XC @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XA2 @ XB2 @ ccaddc) @ ccicc)) <=> (cwbr @ (ccfv @ (cco @ XC @ XA2 @ ccmin) @ ccabs) @ XB2 @ ccle))))))).
...
thf(caalioulem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xr:$i] : ((XN @ Xx3 @ Xr) = (ccfv @ XF @ ccdgr)))) => ((Xph => (cwcel @ XF @ (ccfv @ ccz @ ccply))) => ((! [Xx3:$i] : (! [Xr:$i] : (Xph => (cwcel @ (XN @ Xx3 @ Xr) @ ccn)))) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => ((ccfv @ XA2 @ XF) = ccc0)) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xr:$i] : ((cwbr @ (ccfv @ (cco @ XA2 @ (ccv @ Xr) @ ccmin) @ ccabs) @ cc1 @ ccle) => (cwbr @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccfv @ (ccv @ Xr) @ XF) @ ccabs) @ ccmul) @ (ccfv @ (cco @ XA2 @ (ccv @ Xr) @ ccmin) @ ccabs) @ ccle))) @ (^ [Xr:$i] : ccr))) @ (^ [Xx3:$i] : ccrp))))))))))))).
