...
thf(avtxdgfisf_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XG @ cciedg)) => ((XA2 = (ccdm @ XI)) => (((cwcel @ XG @ XW) & (cwcel @ XA2 @ ccfn)) => (cwf @ XV @ ccn0 @ (ccfv @ XG @ ccvtxdg)))))))))))).
