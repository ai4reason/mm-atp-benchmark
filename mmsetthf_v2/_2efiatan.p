...
thf(c_2efiatan_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccatan)) => ((ccfv @ (cco @ cc2 @ (cco @ cci @ (ccfv @ XA2 @ ccatan) @ ccmul) @ ccmul) @ cce) = (cco @ (cco @ (cco @ cc2 @ cci @ ccmul) @ (cco @ XA2 @ cci @ ccaddc) @ ccdiv) @ cc1 @ ccmin))))).
