...
thf(atxpss3v_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (cctxp @ XA2 @ XB2) @ (ccxp @ ccvv @ (ccxp @ ccvv @ ccvv)))))).
...
thf(cbrtxp2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwbr @ XA2 @ XB2 @ (cctxp @ XR @ XS)) <=> (? [Xx3:$i] : (? [Xy1:$i] : (cw3a @ (XB2 = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (cwbr @ XA2 @ (ccv @ Xx3) @ XR) @ (cwbr @ XA2 @ (ccv @ Xy1) @ XS))))))))))).
