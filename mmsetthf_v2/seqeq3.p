...
thf(adf_seq_ax,axiom,(! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : ((ccseq @ Xc_pl @ XF @ XM) = (ccima @ (ccrdg @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccop @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ (cco @ (ccv @ Xy1) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XF) @ Xc_pl))))) @ (ccop @ XM @ (ccfv @ XM @ XF))) @ ccom)))))).
thf(cseqeq3_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : ((XF = XG) => ((ccseq @ Xc_pl @ XF @ XM) = (ccseq @ Xc_pl @ XG @ XM)))))))).
