...
thf(cwlksnwwlknvbij_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XG @ ccusgr) @ (cwcel @ XN @ ccn0) @ (cwcel @ XX @ (ccfv @ XG @ ccvtx))) => (? [Xf1:$i] : (cwf1o @ (ccrab @ (^ [Xp:$i] : (((ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) = XN) & ((ccfv @ ccc0 @ (ccfv @ (ccv @ Xp) @ cc2nd)) = XX))) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks))) @ (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = XX)) @ (^ [Xw:$i] : (cco @ XN @ XG @ ccwwlksn))) @ (ccv @ Xf1)))))))).
