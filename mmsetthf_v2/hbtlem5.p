...
thf(adeg1lt0_ax,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((XB2 = (ccfv @ XP @ ccbs)) => (((cwcel @ XR @ ccrg) & (cwcel @ XF @ XB2)) => ((cwbr @ (ccfv @ XF @ XD) @ ccc0 @ cclt) <=> (XF = Xc_0)))))))))))))).
...
thf(adegltp1le_ax,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XX @ (ccun @ ccn0 @ (ccsn @ ccmnf))) & (cwcel @ XY @ ccz)) => ((cwbr @ XX @ (cco @ XY @ cc1 @ ccaddc) @ cclt) <=> (cwbr @ XX @ XY @ ccle)))))).
...
thf(chbtlem5_conj,conjecture,(! [Xph:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : ((! [Xx3:$i] : ((XP @ Xx3) = (ccfv @ (XR @ Xx3) @ ccpl1))) => ((! [Xx3:$i] : ((XU @ Xx3) = (ccfv @ (XP @ Xx3) @ cclidl))) => ((! [Xx3:$i] : (XS = (ccfv @ (XR @ Xx3) @ ccldgis))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XR @ Xx3) @ ccrg))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XI @ (XU @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XJ @ (XU @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XI @ XJ))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XJ @ XS)) @ (ccfv @ (ccv @ Xx3) @ (ccfv @ XI @ XS)))) @ (^ [Xx3:$i] : ccn0)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (XI = XJ))))))))))))))))))).
