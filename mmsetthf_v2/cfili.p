...
thf(ccfili_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ (ccfv @ XD @ cccfil)) & (cwcel @ XR @ ccrp)) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (cco @ (ccv @ Xy1) @ (ccv @ Xz) @ XD) @ XR @ cclt)) @ (^ [Xz:$i] : (ccv @ Xx3)))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : XF))))))).
