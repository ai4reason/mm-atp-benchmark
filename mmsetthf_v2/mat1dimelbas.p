...
thf(af1o2sn_ax,axiom,(! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XE @ XV) & (cwcel @ XX @ XW)) => (cwf1o @ (ccxp @ (ccsn @ XE) @ (ccsn @ XE)) @ (ccsn @ XX) @ (ccsn @ (ccop @ (ccop @ XE @ XE) @ XX))))))))).
...
thf(cmat1dimelbas_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xr:$i] : ((XA2 @ Xr) = (cco @ (ccsn @ XE) @ XR @ ccmat))) => ((XB2 = (ccfv @ XR @ ccbs)) => ((! [Xr:$i] : ((XO @ Xr) = (ccop @ XE @ XE))) => (! [Xr:$i] : (((cwcel @ XR @ ccrg) & (cwcel @ XE @ XV)) => ((cwcel @ XM @ (ccfv @ (XA2 @ Xr) @ ccbs)) <=> (cwrex @ (^ [Xr:$i] : (XM = (ccsn @ (ccop @ (XO @ Xr) @ (ccv @ Xr))))) @ (^ [Xr:$i] : XB2)))))))))))))))).
