...
thf(apm5_17_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (((Xph | Xps) & (~ (Xph & Xps))) <=> (Xph <=> (~ Xps)))))).
...
thf(aifbieq12i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph <=> Xps) => ((XA2 = XC) => ((XB2 = XD) => ((ccif @ Xph @ XA2 @ XB2) = (ccif @ Xps @ XC @ XD)))))))))))).
...
thf(csgnneg_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ (ccneg @ XA2) @ ccsgn) = (ccneg @ (ccfv @ XA2 @ ccsgn)))))).
