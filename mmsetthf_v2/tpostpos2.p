...
thf(atpostpos_ax,axiom,(! [XF:($i > $o)] : ((cctpos @ (cctpos @ XF)) = (ccin @ XF @ (ccxp @ (ccun @ (ccxp @ ccvv @ ccvv) @ (ccsn @ cc0)) @ ccvv))))).
...
thf(ctpostpos2_conj,conjecture,(! [XF:($i > $o)] : (((cwrel @ XF) & (cwrel @ (ccdm @ XF))) => ((cctpos @ (cctpos @ XF)) = XF)))).
