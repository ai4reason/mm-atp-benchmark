...
thf(a_2polatN_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XK:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XP = (ccfv @ XK @ ccpolN)) => (((cwcel @ XK @ cchlt) & (cwcel @ XQ @ XA2)) => ((ccfv @ (ccfv @ (ccsn @ XQ) @ XP) @ XP) = (ccsn @ XQ)))))))))).
...
thf(catpsubclN_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XK:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XC = (ccfv @ XK @ ccpscN)) => (((cwcel @ XK @ cchlt) & (cwcel @ XQ @ XA2)) => (cwcel @ (ccsn @ XQ) @ XC))))))))).
