...
thf(aisf34lem2_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : ((cwcel @ XA2 @ XV) => (cwf @ (ccpw @ XA2) @ (ccpw @ XA2) @ (XF @ Xx3))))))))).
...
thf(aisf34lem4_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ XV) & ((cwss @ (XX @ Xx3) @ (ccpw @ XA2)) & (cwne @ (XX @ Xx3) @ cc0))) => ((ccfv @ (ccuni @ (XX @ Xx3)) @ (XF @ Xx3)) = (ccint @ (ccima @ (XF @ Xx3) @ (XX @ Xx3)))))))))))).
...
thf(aisf34lem3_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ XV) & (cwss @ (XX @ Xx3) @ (ccpw @ XA2))) => ((ccima @ (XF @ Xx3) @ (ccima @ (XF @ Xx3) @ (XX @ Xx3))) = (XX @ Xx3)))))))))).
...
thf(acompsscnv_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : ((cccnv @ (XF @ Xx3)) = (XF @ Xx3))))))).
...
thf(cisf34lem5_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccpw @ XA2)) @ (^ [Xx3:$i] : (ccdif @ XA2 @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ XV) & ((cwss @ (XX @ Xx3) @ (ccpw @ XA2)) & (cwne @ (XX @ Xx3) @ cc0))) => ((ccfv @ (ccint @ (XX @ Xx3)) @ (XF @ Xx3)) = (ccuni @ (ccima @ (XF @ Xx3) @ (XX @ Xx3)))))))))))).
