...
thf(amrsub0_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((XS = (ccfv @ XT @ ccmrsub)) => ((cwcel @ XF @ (ccrn @ XS)) => ((ccfv @ cc0 @ XF) = cc0))))))).
...
thf(accatrn_ax,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XS @ (ccword @ XB2)) & (cwcel @ XT @ (ccword @ XB2))) => ((ccrn @ (cco @ XS @ XT @ ccconcat)) = (ccun @ (ccrn @ XS) @ (ccrn @ XT)))))))).
...
thf(as1rn_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((ccrn @ (ccs1 @ XA2)) = (ccsn @ XA2)))))).
...
thf(cmrsubvrs_conj,conjecture,(! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XS = (ccfv @ XT @ ccmrsub)) => ((XV = (ccfv @ XT @ ccmvar)) => ((! [Xx3:$i] : ((XR @ Xx3) = (ccfv @ XT @ ccmrex))) => (! [Xx3:$i] : (((cwcel @ XF @ (ccrn @ XS)) & (cwcel @ XX @ (XR @ Xx3))) => ((ccin @ (ccrn @ (ccfv @ XX @ XF)) @ XV) = (cciun @ (^ [Xx3:$i] : (ccin @ (ccrn @ XX) @ XV)) @ (^ [Xx3:$i] : (ccin @ (ccrn @ (ccfv @ (ccs1 @ (ccv @ Xx3)) @ XF)) @ XV)))))))))))))))).
