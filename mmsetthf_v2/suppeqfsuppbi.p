...
thf(csuppeqfsuppbi_conj,conjecture,(! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((((cwcel @ XF @ XU) & (cwfun @ XF)) & ((cwcel @ XG @ XV) & (cwfun @ XG))) => (((cco @ XF @ XZ @ ccsupp) = (cco @ XG @ XZ @ ccsupp)) => ((cwbr @ XF @ XZ @ ccfsupp) <=> (cwbr @ XG @ XZ @ ccfsupp)))))))))).
