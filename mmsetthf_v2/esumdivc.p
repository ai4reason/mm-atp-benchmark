...
thf(aesummulc1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((Xph => (cwcel @ XC @ (cco @ ccc0 @ ccpnf @ ccico))) => (Xph => ((cco @ (ccesum @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ XC @ ccxmu) = (ccesum @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (cco @ (XB2 @ Xk) @ XC @ ccxmu)))))))))))))).
...
thf(arexdiv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwne @ XB2 @ ccc0)) => ((cco @ XA2 @ XB2 @ ccxdiv) = (cco @ XA2 @ XB2 @ ccdiv)))))).
...
thf(axdivrec_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccr) @ (cwne @ XB2 @ ccc0)) => ((cco @ XA2 @ XB2 @ ccxdiv) = (cco @ XA2 @ (cco @ cc1 @ XB2 @ ccxdiv) @ ccxmu)))))).
...
thf(cesumdivc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((Xph => (cwcel @ XC @ ccrp)) => (Xph => ((cco @ (ccesum @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ XC @ ccxdiv) = (ccesum @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (cco @ (XB2 @ Xk) @ XC @ ccxdiv)))))))))))))).
