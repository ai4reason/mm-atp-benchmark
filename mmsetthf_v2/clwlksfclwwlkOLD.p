...
thf(aclwlkclwwlklem2_ax,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ ((cwf1 @ (ccdm @ XE) @ XR @ XE) & (cwcel @ XF @ (ccword @ (ccdm @ XE)))) @ ((cwf @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz) @ XV @ XP) & (cwbr @ cc2 @ (ccfv @ XP @ cchash) @ ccle)) @ ((cwral @ (^ [Xi:$i] : ((ccfv @ (ccfv @ (ccv @ Xi) @ XF) @ XE) = (ccpr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP)))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))) & ((ccfv @ ccc0 @ XP) = (ccfv @ (ccfv @ XF @ cchash) @ XP)))) => (cw3a @ ((ccfv @ XP @ cclsw) = (ccfv @ ccc0 @ XP)) @ (cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP)) @ (ccrn @ XE))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XF @ cchash) @ cc1 @ ccmin) @ ccfzo))) @ (cwcel @ (ccpr @ (ccfv @ (cco @ (ccfv @ XF @ cchash) @ cc1 @ ccmin) @ XP) @ (ccfv @ ccc0 @ XP)) @ (ccrn @ XE)))))))))).
...
thf(aelfzom1elp1fzo_ax,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XI @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfzo))) => (cwcel @ (cco @ XI @ cc1 @ ccaddc) @ (cco @ ccc0 @ XN @ ccfzo)))))).
...
thf(aclwlksfclwwlk2sswdOLD_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((! [Xc:$i] : ((XA2 @ Xc) = (ccfv @ (ccv @ Xc) @ cc1st))) => ((! [Xc:$i] : ((XB2 @ Xc) = (ccfv @ (ccv @ Xc) @ cc2nd))) => ((! [Xc:$i] : ((XC @ Xc) = (ccrab @ (^ [Xc:$i] : ((ccfv @ (XA2 @ Xc) @ cchash) = XN)) @ (^ [Xc:$i] : (ccfv @ XG @ ccclwlks))))) => ((! [Xc:$i] : ((XF @ Xc) = (ccmpt @ (^ [Xc:$i] : (XC @ Xc)) @ (^ [Xc:$i] : (cco @ (XB2 @ Xc) @ (ccop @ ccc0 @ (ccfv @ (XA2 @ Xc) @ cchash)) @ ccsubstr))))) => (! [Xc:$i] : ((cwcel @ (ccv @ Xc) @ (XC @ Xc)) => ((ccfv @ (XA2 @ Xc) @ cchash) = (ccfv @ (cco @ (XB2 @ Xc) @ (ccop @ ccc0 @ (ccfv @ (XA2 @ Xc) @ cchash)) @ ccsubstr) @ cchash))))))))))))))).
