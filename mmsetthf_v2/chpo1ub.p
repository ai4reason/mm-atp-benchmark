...
thf(achto1ub_ax,axiom,(cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ cccht) @ (ccv @ Xx3) @ ccdiv))) @ cco1)).
...
thf(cchpo1ub_conj,conjecture,(cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccchp) @ (ccv @ Xx3) @ ccdiv))) @ cco1)).
