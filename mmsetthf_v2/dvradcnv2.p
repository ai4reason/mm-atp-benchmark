...
thf(aseqshft_ax,axiom,(! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XF @ ccvv) => (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((ccseq @ Xc_pl @ (cco @ XF @ XN @ ccshi) @ XM) = (cco @ (ccseq @ Xc_pl @ XF @ (cco @ XM @ XN @ ccmin)) @ XN @ ccshi))))))))).
...
thf(aclimshft_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XF @ XV)) => ((cwbr @ (cco @ XF @ XM @ ccshi) @ XA2 @ ccli) <=> (cwbr @ XF @ XA2 @ ccli)))))))).
