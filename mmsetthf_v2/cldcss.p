...
thf(acsscld_ax,axiom,(! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > $o)] : ((XC = (ccfv @ XW @ cccss)) => ((XJ = (ccfv @ XW @ cctopn)) => (((cwcel @ XW @ cccph) & (cwcel @ XS @ XC)) => (cwcel @ XS @ (ccfv @ XJ @ cccld)))))))))).
...
thf(ccldcss_conj,conjecture,(! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XJ = (ccfv @ XW @ cctopn)) => ((XL = (ccfv @ XW @ cclss)) => ((XC = (ccfv @ XW @ cccss)) => ((cwcel @ XW @ cchl) => ((cwcel @ XU @ XC) <=> ((cwcel @ XU @ XL) & (cwcel @ XU @ (ccfv @ XJ @ cccld)))))))))))))))).
