...
thf(aelfzonelfzo_ax,axiom,(! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => (((cwcel @ XK @ (cco @ XM @ XR @ ccfzo)) & (~ (cwcel @ XK @ (cco @ XM @ XN @ ccfzo)))) => (cwcel @ XK @ (cco @ XN @ XR @ ccfzo))))))))).
...
thf(anpncan3d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => (Xph => ((cco @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XA2 @ ccmin) @ ccaddc) = (cco @ XC @ XB2 @ ccmin))))))))))).
...
thf(afzosubel2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ (cco @ (cco @ XB2 @ XC @ ccaddc) @ (cco @ XB2 @ XD @ ccaddc) @ ccfzo)) & (cw3a @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccz) @ (cwcel @ XD @ ccz))) => (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ (cco @ XC @ XD @ ccfzo)))))))).
thf(cswrdccatin12lem2b_conj,conjecture,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XM @ (cco @ ccc0 @ XL @ ccfz)) & (cwcel @ XN @ (cco @ XL @ XX @ ccfz))) => (((cwcel @ XK @ (cco @ ccc0 @ (cco @ XN @ XM @ ccmin) @ ccfzo)) & (~ (cwcel @ XK @ (cco @ ccc0 @ (cco @ XL @ XM @ ccmin) @ ccfzo)))) => (cwcel @ (cco @ XK @ (cco @ XL @ XM @ ccmin) @ ccmin) @ (cco @ ccc0 @ (cco @ (cco @ XN @ XL @ ccmin) @ ccc0 @ ccmin) @ ccfzo)))))))))).
