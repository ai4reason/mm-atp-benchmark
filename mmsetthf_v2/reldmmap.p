...
thf(adf_map_ax,axiom,(ccmap = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccvv)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccab @ (^ [Xf1:$i] : (cwf @ (ccv @ Xy1) @ (ccv @ Xx3) @ (ccv @ Xf1))))))))).
thf(creldmmap_conj,conjecture,(cwrel @ (ccdm @ ccmap))).
