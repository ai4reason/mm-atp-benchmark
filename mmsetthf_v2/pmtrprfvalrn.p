...
thf(apmtrprfval_ax,axiom,((ccfv @ (ccpr @ cc1 @ cc2) @ ccpmtr) = (ccmpt @ (^ [Xp:$i] : (ccsn @ (ccpr @ cc1 @ cc2))) @ (^ [Xp:$i] : (ccmpt @ (^ [Xz:$i] : (ccpr @ cc1 @ cc2)) @ (^ [Xz:$i] : (ccif @ ((ccv @ Xz) = cc1) @ cc2 @ cc1))))))).
...
thf(cpmtrprfvalrn_conj,conjecture,((ccrn @ (ccfv @ (ccpr @ cc1 @ cc2) @ ccpmtr)) = (ccsn @ (ccpr @ (ccop @ cc1 @ cc2) @ (ccop @ cc2 @ cc1))))).
