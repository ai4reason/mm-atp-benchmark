...
thf(ahvaddid2i_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cco @ cc0v @ XA2 @ ccva) = XA2)))).
thf(aax_hv0cl_ax,axiom,(cwcel @ cc0v @ cchil)).
thf(agrpoid_ax,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((XU = (ccfv @ XG @ ccgi)) => (((cwcel @ XG @ ccgr) & (cwcel @ XA2 @ XX)) => ((XA2 = XU) <=> ((cco @ XA2 @ XA2 @ XG) = XA2)))))))))).
...
thf(ashaddcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : ((cw3a @ (cwcel @ XH @ ccsh) @ (cwcel @ XA2 @ XH) @ (cwcel @ XB2 @ XH)) => (cwcel @ (cco @ XA2 @ XB2 @ ccva) @ XH)))))).
...
thf(anormf_ax,axiom,(cwf @ cchil @ ccr @ ccno)).
...
thf(anorm_ii_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccva) @ ccno) @ (cco @ (ccfv @ XA2 @ ccno) @ (ccfv @ XB2 @ ccno) @ ccaddc) @ ccle))))).
...
thf(chhssnv_conj,conjecture,(! [XH:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccop @ (ccop @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ (ccres @ ccsm @ (ccxp @ ccc @ XH))) @ (ccres @ ccno @ XH))) => ((cwcel @ XH @ ccsh) => (cwcel @ XW @ ccnv)))))).
