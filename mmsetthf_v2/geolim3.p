...
thf(ashftval4_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccfv @ XB2 @ (cco @ XF @ (ccneg @ XA2) @ ccshi)) = (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ XF)))))))).
...
thf(aisershft_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XF @ ccvv) => (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cwbr @ (ccseq @ Xc_pl @ XF @ XM) @ XA2 @ ccli) <=> (cwbr @ (ccseq @ Xc_pl @ (cco @ XF @ XN @ ccshi) @ (cco @ XM @ XN @ ccaddc)) @ XA2 @ ccli)))))))))).
thf(cgeolim3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccz)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwbr @ (ccfv @ XB2 @ ccabs) @ cc1 @ cclt)) => ((Xph => (cwcel @ XC @ ccc)) => ((! [Xk:$i] : ((XF @ Xk) = (ccmpt @ (^ [Xk:$i] : (ccfv @ XA2 @ ccuz)) @ (^ [Xk:$i] : (cco @ XC @ (cco @ XB2 @ (cco @ (ccv @ Xk) @ XA2 @ ccmin) @ ccexp) @ ccmul))))) => (! [Xk:$i] : (Xph => (cwbr @ (ccseq @ ccaddc @ (XF @ Xk) @ XA2) @ (cco @ XC @ (cco @ cc1 @ XB2 @ ccmin) @ ccdiv) @ ccli)))))))))))))).
