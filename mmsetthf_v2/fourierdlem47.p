...
thf(aitgge0_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccibl)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccr))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwbr @ ccc0 @ (XB2 @ Xx3) @ ccle))) => (Xph => (cwbr @ ccc0 @ (ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ ccle))))))))).
...
thf(afourierdlem30_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (cco @ (XF @ Xx3) @ (ccneg @ (XG @ Xx3)) @ ccmul))) @ ccibl)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwcel @ (XF @ Xx3) @ ccc))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwcel @ (XG @ Xx3) @ ccc))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XA2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : ((XX @ Xx3) = (ccfv @ (XA2 @ Xx3) @ ccabs))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XC @ Xx3) @ ccc))) => ((! [Xx3:$i] : ((XY @ Xx3) = (ccfv @ (XC @ Xx3) @ ccabs))) => ((! [Xx3:$i] : ((XZ @ Xx3) = (ccfv @ (ccitg @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (cco @ (XF @ Xx3) @ (ccneg @ (XG @ Xx3)) @ ccmul))) @ ccabs))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XE @ Xx3) @ ccrp))) => ((Xph => (cwcel @ XR @ ccr)) => ((! [Xx3:$i] : (Xph => (cwbr @ (cco @ (cco @ (cco @ (cco @ (XX @ Xx3) @ (XY @ Xx3) @ ccaddc) @ (XZ @ Xx3) @ ccaddc) @ (XE @ Xx3) @ ccdiv) @ cc1 @ ccaddc) @ XR @ ccle))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XB2 @ Xx3) @ ccc))) => ((! [Xx3:$i] : (Xph => (cwbr @ (ccfv @ (XB2 @ Xx3) @ ccabs) @ cc1 @ ccle))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XD @ Xx3) @ ccc))) => ((! [Xx3:$i] : (Xph => (cwbr @ (ccfv @ (XD @ Xx3) @ ccabs) @ cc1 @ ccle))) => (! [Xx3:$i] : (Xph => (cwbr @ (ccfv @ (cco @ (cco @ (cco @ (XA2 @ Xx3) @ (ccneg @ (cco @ (XB2 @ Xx3) @ XR @ ccdiv)) @ ccmul) @ (cco @ (XC @ Xx3) @ (ccneg @ (cco @ (XD @ Xx3) @ XR @ ccdiv)) @ ccmul) @ ccmin) @ (ccitg @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (cco @ (XF @ Xx3) @ (ccneg @ (cco @ (XG @ Xx3) @ XR @ ccdiv)) @ ccmul))) @ ccmin) @ ccabs) @ (XE @ Xx3) @ cclt)))))))))))))))))))))))))))))))).
