...
thf(aeucalgval_ax,axiom,(! [XE:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XE @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ ((ccv @ Xy1) = ccc0) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccop @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmo))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XX @ (ccxp @ ccn0 @ ccn0)) => ((ccfv @ XX @ (XE @ Xx3 @ Xy1)) = (ccif @ ((ccfv @ XX @ cc2nd) = ccc0) @ XX @ (ccop @ (ccfv @ XX @ cc2nd) @ (ccfv @ XX @ ccmo))))))))))).
...
thf(ceucalglt_conj,conjecture,(! [XE:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XE @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccn0)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ ((ccv @ Xy1) = ccc0) @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccop @ (ccv @ Xy1) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmo))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XX @ (ccxp @ ccn0 @ ccn0)) => ((cwne @ (ccfv @ (ccfv @ XX @ (XE @ Xx3 @ Xy1)) @ cc2nd) @ ccc0) => (cwbr @ (ccfv @ (ccfv @ XX @ (XE @ Xx3 @ Xy1)) @ cc2nd) @ (ccfv @ XX @ cc2nd) @ cclt))))))))).
