...
thf(aressuppss_ax,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XF @ XV) & (cwcel @ XZ @ XW)) => (cwss @ (cco @ (ccres @ XF @ XB2) @ XZ @ ccsupp) @ (cco @ XF @ XZ @ ccsupp))))))))).
