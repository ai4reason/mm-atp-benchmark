...
thf(aabs00d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => ((ccfv @ XA2 @ ccabs) = ccc0)) => (Xph => (XA2 = ccc0))))))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(asyl3anc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xps) => ((Xph => Xch) => ((Xph => Xth) => (((cw3a @ Xps @ Xch @ Xth) => Xta) => (Xph => Xta))))))))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(ccbn_tp,type,(ccbn : ($i > $o))).
thf(ahlcph_ax,axiom,(! [XW:($i > $o)] : ((cwcel @ XW @ cchl) => (cwcel @ XW @ cccph)))).
...
thf(asqeq0d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => ((cco @ XA2 @ cc2 @ ccexp) = ccc0)) => (Xph => (XA2 = ccc0))))))).
...
thf(aipge0_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_xi = (ccfv @ XW @ ccip)) => (((cwcel @ XW @ cccph) & (cwcel @ XA2 @ XV)) => (cwbr @ ccc0 @ (cco @ XA2 @ XA2 @ Xc_xi) @ ccle))))))))).
...
thf(ahlress_ax,axiom,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((cwcel @ XW @ cchl) => (cwss @ ccr @ XK)))))))).
...
thf(anmcl_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XG @ ccnm)) => (((cwcel @ XG @ ccngp) & (cwcel @ XA2 @ XX)) => (cwcel @ (ccfv @ XA2 @ XN) @ ccr))))))))).
...
thf(anmge0_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XN = (ccfv @ XG @ ccnm)) => (((cwcel @ XG @ ccngp) & (cwcel @ XA2 @ XX)) => (cwbr @ ccc0 @ (ccfv @ XA2 @ XN) @ ccle))))))))).
...
thf(acphsubdir_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_xi = (ccfv @ XW @ ccip)) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_mi = (ccfv @ XW @ ccsg)) => (((cwcel @ XW @ cccph) & (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XV))) => ((cco @ (cco @ XA2 @ XB2 @ Xc_mi) @ XC @ Xc_xi) = (cco @ (cco @ XA2 @ XC @ Xc_xi) @ (cco @ XB2 @ XC @ Xc_xi) @ ccmin)))))))))))))).
thf(aoveq1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XC @ XF)))))))))).
thf(acphsubdi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_xi = (ccfv @ XW @ ccip)) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_mi = (ccfv @ XW @ ccsg)) => (((cwcel @ XW @ cccph) & (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XV))) => ((cco @ XA2 @ (cco @ XB2 @ XC @ Xc_mi) @ Xc_xi) = (cco @ (cco @ XA2 @ XB2 @ Xc_xi) @ (cco @ XA2 @ XC @ Xc_xi) @ ccmin)))))))))))))).
...
thf(adivcan5d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwne @ XB2 @ ccc0)) => ((Xph => (cwne @ XC @ ccc0)) => (Xph => ((cco @ (cco @ XC @ XA2 @ ccmul) @ (cco @ XC @ XB2 @ ccmul) @ ccdiv) = (cco @ XA2 @ XB2 @ ccdiv))))))))))))).
...
thf(acph2ass_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_xi = (ccfv @ XW @ ccip)) => ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((cw3a @ (cwcel @ XW @ cccph) @ ((cwcel @ XA2 @ XK) & (cwcel @ XB2 @ XK)) @ ((cwcel @ XC @ XV) & (cwcel @ XD @ XV))) => ((cco @ (cco @ XA2 @ XC @ Xc_x) @ (cco @ XB2 @ XD @ Xc_x) @ Xc_xi) = (cco @ (cco @ XA2 @ (ccfv @ XB2 @ cccj) @ ccmul) @ (cco @ XC @ XD @ Xc_xi) @ ccmul))))))))))))))))))).
...
thf(age0divd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccrp)) => (Xph => ((cwbr @ ccc0 @ XA2 @ ccle) <=> (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccdiv) @ ccle))))))))).
thf(amulneg12_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((cco @ (ccneg @ XA2) @ XB2 @ ccmul) = (cco @ XA2 @ (ccneg @ XB2) @ ccmul)))))).
thf(aprodge02_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwbr @ ccc0 @ XB2 @ cclt) & (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul) @ ccle))) => (cwbr @ ccc0 @ XA2 @ ccle))))).
...
thf(cpjthlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_xi:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ ccnm)) => ((! [Xx3:$i] : ((Xc_pl @ Xx3) = (ccfv @ XW @ ccplusg))) => ((Xc_mi = (ccfv @ XW @ ccsg)) => ((! [Xx3:$i] : ((Xc_xi @ Xx3) = (ccfv @ XW @ ccip))) => ((! [Xx3:$i] : ((XL @ Xx3) = (ccfv @ XW @ cclss))) => ((Xph => (cwcel @ XW @ cchl)) => ((! [Xx3:$i] : (Xph => (cwcel @ XU @ (XL @ Xx3)))) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XU)) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ XA2 @ XN) @ (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ Xc_mi) @ XN) @ ccle)) @ (^ [Xx3:$i] : XU))) => ((! [Xx3:$i] : (XT = (cco @ (cco @ XA2 @ XB2 @ (Xc_xi @ Xx3)) @ (cco @ (cco @ XB2 @ XB2 @ (Xc_xi @ Xx3)) @ cc1 @ ccaddc) @ ccdiv))) => (! [Xx3:$i] : (Xph => ((cco @ XA2 @ XB2 @ (Xc_xi @ Xx3)) = ccc0)))))))))))))))))))))))))))).
