...
thf(asadadd_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => ((cco @ (ccfv @ XA2 @ ccbits) @ (ccfv @ XB2 @ ccbits) @ ccsad) = (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ ccbits)))))).
...
thf(asadass_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwss @ XA2 @ ccn0) @ (cwss @ XB2 @ ccn0) @ (cwss @ XC @ ccn0)) => ((cco @ (cco @ XA2 @ XB2 @ ccsad) @ XC @ ccsad) = (cco @ XA2 @ (cco @ XB2 @ XC @ ccsad) @ ccsad))))))).
...
thf(asaddisj_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn0)) => ((Xph => (cwss @ XB2 @ ccn0)) => ((Xph => ((ccin @ XA2 @ XB2) = cc0)) => (Xph => ((cco @ XA2 @ XB2 @ ccsad) = (ccun @ XA2 @ XB2)))))))))).
...
thf(asadid2_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccn0) => ((cco @ cc0 @ XA2 @ ccsad) = XA2)))).
...
thf(amoddiffl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccrp)) => ((cco @ (cco @ XA2 @ (cco @ XA2 @ XB2 @ ccmo) @ ccmin) @ XB2 @ ccdiv) = (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccfl)))))).
thf(cbitsres_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccn0)) => ((ccin @ (ccfv @ XA2 @ ccbits) @ (ccfv @ XN @ ccuz)) = (ccfv @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cc2 @ XN @ ccexp) @ ccdiv) @ ccfl) @ (cco @ cc2 @ XN @ ccexp) @ ccmul) @ ccbits)))))).
