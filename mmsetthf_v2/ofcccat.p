...
thf(aofccat_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((Xph => (cwcel @ XE @ (ccword @ XS))) => ((Xph => (cwcel @ XF @ (ccword @ XS))) => ((Xph => (cwcel @ XG @ (ccword @ XT))) => ((Xph => (cwcel @ XH @ (ccword @ XT))) => ((Xph => ((ccfv @ XE @ cchash) = (ccfv @ XG @ cchash))) => ((Xph => ((ccfv @ XF @ cchash) = (ccfv @ XH @ cchash))) => (Xph => ((cco @ (cco @ XE @ XF @ ccconcat) @ (cco @ XG @ XH @ ccconcat) @ (ccof @ XR)) = (cco @ (cco @ XE @ XG @ (ccof @ XR)) @ (cco @ XF @ XH @ (ccof @ XR)) @ ccconcat)))))))))))))))))).
...
thf(aofcof_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XC @ XW)) => (Xph => ((cco @ XF @ XC @ (ccofc @ XR)) = (cco @ XF @ (ccxp @ XA2 @ (ccsn @ XC)) @ (ccof @ XR)))))))))))))))).
...
thf(accatmulgnn0dir_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (ccxp @ (cco @ ccc0 @ XM @ ccfzo) @ (ccsn @ XK))) => ((XB2 = (ccxp @ (cco @ ccc0 @ XN @ ccfzo) @ (ccsn @ XK))) => ((XC = (ccxp @ (cco @ ccc0 @ (cco @ XM @ XN @ ccaddc) @ ccfzo) @ (ccsn @ XK))) => ((Xph => (cwcel @ XK @ XS)) => ((Xph => (cwcel @ XM @ ccn0)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((cco @ XA2 @ XB2 @ ccconcat) = XC))))))))))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(aa1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(cofcccat_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XF @ (ccword @ XS))) => ((Xph => (cwcel @ XG @ (ccword @ XS))) => ((Xph => (cwcel @ XK @ XT)) => (Xph => ((cco @ (cco @ XF @ XG @ ccconcat) @ XK @ (ccofc @ XR)) = (cco @ (cco @ XF @ XK @ (ccofc @ XR)) @ (cco @ XG @ XK @ (ccofc @ XR)) @ ccconcat)))))))))))))).
