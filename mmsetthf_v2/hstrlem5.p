...
thf(ahstrlem2_ax,axiom,(! [XC:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xu:$i] : ((XS @ Xx3 @ Xu) = (ccmpt @ (^ [Xx3:$i] : ccch) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xu) @ (ccfv @ (ccv @ Xx3) @ ccpjh))))))) => (! [Xx3:$i] : (! [Xu:$i] : ((cwcel @ (XC @ Xu) @ ccch) => ((ccfv @ (XC @ Xu) @ (XS @ Xx3 @ Xu)) = (ccfv @ (ccv @ Xu) @ (ccfv @ (XC @ Xu) @ ccpjh)))))))))).
