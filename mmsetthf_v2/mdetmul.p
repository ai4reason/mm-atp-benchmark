...
thf(amdetf_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XD = (cco @ XN @ XR @ ccmdat)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((cwcel @ XR @ cccrg) => (cwf @ XB2 @ XK @ XD))))))))))))).
...
thf(amdetralt_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xa:$i] : ((XD @ Xa) = (cco @ XN @ (XR @ Xa) @ ccmdat))) => ((! [Xa:$i] : ((XA2 @ Xa) = (cco @ XN @ (XR @ Xa) @ ccmat))) => ((! [Xa:$i] : ((XB2 @ Xa) = (ccfv @ (XA2 @ Xa) @ ccbs))) => ((! [Xa:$i] : ((Xc_0 @ Xa) = (ccfv @ (XR @ Xa) @ cc0g))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwcel @ (XR @ Xa) @ cccrg))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwcel @ XX @ (XB2 @ Xa)))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwcel @ XI @ XN))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwcel @ XJ @ XN))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwne @ XI @ XJ))) => ((! [Xa:$i] : ((Xph @ Xa) => (cwral @ (^ [Xa:$i] : ((cco @ XI @ (ccv @ Xa) @ XX) = (cco @ XJ @ (ccv @ Xa) @ XX))) @ (^ [Xa:$i] : XN)))) => (! [Xa:$i] : ((Xph @ Xa) => ((ccfv @ XX @ (XD @ Xa)) = (Xc_0 @ Xa))))))))))))))))))))))))).
...
thf(amamudi_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xph => (cwcel @ XR @ ccrg)) => ((XF = (cco @ XR @ (ccotp @ XM @ XN @ XO) @ ccmmul)) => ((Xph => (cwcel @ XM @ ccfn)) => ((Xph => (cwcel @ XN @ ccfn)) => ((Xph => (cwcel @ XO @ ccfn)) => ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((Xph => (cwcel @ XX @ (cco @ XB2 @ (ccxp @ XM @ XN) @ ccmap))) => ((Xph => (cwcel @ XY @ (cco @ XB2 @ (ccxp @ XM @ XN) @ ccmap))) => ((Xph => (cwcel @ XZ @ (cco @ XB2 @ (ccxp @ XN @ XO) @ ccmap))) => (Xph => ((cco @ (cco @ XX @ XY @ (ccof @ Xc_pl)) @ XZ @ XF) = (cco @ (cco @ XX @ XZ @ XF) @ (cco @ XY @ XZ @ XF) @ (ccof @ Xc_pl)))))))))))))))))))))))))).
...
thf(cmdetmul_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XD = (cco @ XN @ XR @ ccmdat)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_xb = (ccfv @ XA2 @ ccmulr)) => ((cw3a @ (cwcel @ XR @ cccrg) @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XB2)) => ((ccfv @ (cco @ XF @ XG @ Xc_xb) @ XD) = (cco @ (ccfv @ XF @ XD) @ (ccfv @ XG @ XD) @ Xc_x)))))))))))))))))).
