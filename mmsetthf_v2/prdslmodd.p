...
thf(aprdssca_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XP = (cco @ XS @ XR @ ccprds)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwcel @ XR @ XW)) => (Xph => (XS = (ccfv @ XP @ ccsca))))))))))))).
...
thf(aprdsgrpd_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwf @ XI @ ccgrp @ XR)) => (Xph => (cwcel @ XY @ ccgrp)))))))))))))).
...
thf(aprdsvscacl_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((! [Xx3:$i] : ((Xc_x @ Xx3) = (ccfv @ XY @ ccvsca))) => ((XK = (ccfv @ XS @ ccbs)) => ((Xph => (cwcel @ XS @ ccrg)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwf @ XI @ cclmod @ XR)) => ((Xph => (cwcel @ XF @ XK)) => ((Xph => (cwcel @ XG @ XB2)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => ((ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccsca) = XS))) => (! [Xx3:$i] : (Xph => (cwcel @ (cco @ XF @ XG @ (Xc_x @ Xx3)) @ XB2))))))))))))))))))))))))).
...
thf(aprdsbasprj_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwfn @ XR @ XI)) => ((Xph => (cwcel @ XT @ XB2)) => ((Xph => (cwcel @ XJ @ XI)) => (Xph => (cwcel @ (ccfv @ XJ @ XT) @ (ccfv @ (ccfv @ XJ @ XR) @ ccbs))))))))))))))))))))).
...
thf(aprdsplusgfval_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwfn @ XR @ XI)) => ((Xph => (cwcel @ XF @ XB2)) => ((Xph => (cwcel @ XG @ XB2)) => ((Xc_pl = (ccfv @ XY @ ccplusg)) => ((Xph => (cwcel @ XJ @ XI)) => (Xph => ((ccfv @ XJ @ (cco @ XF @ XG @ Xc_pl)) = (cco @ (ccfv @ XJ @ XF) @ (ccfv @ XJ @ XG) @ (ccfv @ (ccfv @ XJ @ XR) @ ccplusg)))))))))))))))))))))))))).
thf(aoveq12d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XD @ XF)))))))))))).
thf(aprdsvscafval_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xc_x = (ccfv @ XY @ ccvsca)) => ((XK = (ccfv @ XS @ ccbs)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwfn @ XR @ XI)) => ((Xph => (cwcel @ XF @ XK)) => ((Xph => (cwcel @ XG @ XB2)) => ((Xph => (cwcel @ XJ @ XI)) => (Xph => ((ccfv @ XJ @ (cco @ XF @ XG @ Xc_x)) = (cco @ XF @ (ccfv @ XJ @ XG) @ (ccfv @ (ccfv @ XJ @ XR) @ ccvsca)))))))))))))))))))))))))))).
thf(aprdsvscaval_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((! [Xx3:$i] : ((Xc_x @ Xx3) = (ccfv @ XY @ ccvsca))) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccfv @ XS @ ccbs))) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwfn @ XR @ XI)) => ((! [Xx3:$i] : (Xph => (cwcel @ XF @ (XK @ Xx3)))) => ((Xph => (cwcel @ XG @ XB2)) => (! [Xx3:$i] : (Xph => ((cco @ XF @ XG @ (Xc_x @ Xx3)) = (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (cco @ XF @ (ccfv @ (ccv @ Xx3) @ XG) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccvsca))))))))))))))))))))))))))))).
...
thf(aprdsplusgval_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwfn @ XR @ XI)) => ((Xph => (cwcel @ XF @ XB2)) => ((Xph => (cwcel @ XG @ XB2)) => ((! [Xx3:$i] : ((Xc_pl @ Xx3) = (ccfv @ XY @ ccplusg))) => (! [Xx3:$i] : (Xph => ((cco @ XF @ XG @ (Xc_pl @ Xx3)) = (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xx3) @ XG) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccplusg))))))))))))))))))))))))))).
...
thf(aprdsbasfn_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwfn @ XR @ XI)) => ((Xph => (cwcel @ XT @ XB2)) => (Xph => (cwfn @ XT @ XI)))))))))))))))))).
thf(cwrel_tp,type,(cwrel : (($i > $o) > $o))).
thf(adffn5_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ XA2) <=> (XF = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ XF)))))))).
thf(cprdslmodd_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((Xph => (cwcel @ XS @ ccrg)) => ((! [Xy1:$i] : (Xph => (cwcel @ XI @ (XV @ Xy1)))) => ((Xph => (cwf @ XI @ cclmod @ XR)) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XI)) => ((ccfv @ (ccfv @ (ccv @ Xy1) @ XR) @ ccsca) = XS))) => (Xph => (cwcel @ XY @ cclmod)))))))))))))).
