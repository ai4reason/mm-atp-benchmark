...
thf(asge0seq_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XM @ ccz)) => ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwf @ XZ @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((XG = (ccseq @ ccaddc @ XF @ XM)) => (Xph => ((ccfv @ XF @ ccsumge0) = (ccsup @ (ccrn @ XG) @ ccxr @ cclt))))))))))))).
...
thf(aabsfico_ax,axiom,(cwf @ ccc @ (cco @ ccc0 @ ccpnf @ ccico) @ ccabs)).
