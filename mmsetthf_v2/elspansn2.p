...
thf(ah1de2bi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ cchil) => ((cwne @ XB2 @ cc0v) => ((cwcel @ XA2 @ (ccfv @ (ccfv @ (ccsn @ XB2) @ ccort) @ ccort)) <=> (XA2 = (cco @ (cco @ (cco @ XA2 @ XB2 @ ccsp) @ (cco @ XB2 @ XB2 @ ccsp) @ ccdiv) @ XB2 @ ccsm))))))))).
thf(aifhvhv0_ax,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccif @ (cwcel @ XA2 @ cchil) @ XA2 @ cc0v) @ cchil))).
thf(celspansn2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil) @ (cwne @ XB2 @ cc0v)) => ((cwcel @ XA2 @ (ccfv @ (ccsn @ XB2) @ ccspn)) <=> (XA2 = (cco @ (cco @ (cco @ XA2 @ XB2 @ ccsp) @ (cco @ XB2 @ XB2 @ ccsp) @ ccdiv) @ XB2 @ ccsm))))))).
