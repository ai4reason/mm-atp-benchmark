...
thf(aodd2np1ALTV_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cwcel @ XN @ ccodd) <=> (cwrex @ (^ [Xn:$i] : ((cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) = XN)) @ (^ [Xn:$i] : ccz)))))).
...
thf(aprodge0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) & ((cwbr @ ccc0 @ XA2 @ cclt) & (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccmul) @ ccle))) => (cwbr @ ccc0 @ XB2 @ ccle))))).
...
thf(coexpnegALTV_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn) @ (cwcel @ XN @ ccodd)) => ((cco @ (ccneg @ XA2) @ XN @ ccexp) = (ccneg @ (cco @ XA2 @ XN @ ccexp))))))).
