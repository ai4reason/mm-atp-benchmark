...
thf(afclstop_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) => (cwcel @ XJ @ cctop)))))).
...
thf(afclsopni_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (((cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) & (cw3a @ (cwcel @ XU @ XJ) @ (cwcel @ XA2 @ XU) @ (cwcel @ XS @ XF))) => (cwne @ (ccin @ XU @ XS) @ cc0)))))))).
