...
thf(cscutbday_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccsslt) => ((ccfv @ (cco @ XA2 @ XB2 @ ccscut) @ ccbday) = (ccint @ (ccima @ ccbday @ (ccrab @ (^ [Xx3:$i] : ((cwbr @ XA2 @ (ccsn @ (ccv @ Xx3)) @ ccsslt) & (cwbr @ (ccsn @ (ccv @ Xx3)) @ XB2 @ ccsslt))) @ (^ [Xx3:$i] : ccsur))))))))).
