...
thf(aodcl2_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XX @ ccfn) @ (cwcel @ XA2 @ XX)) => (cwcel @ (ccfv @ XA2 @ XO) @ ccn))))))))).
thf(abitr4d_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps <=> Xch)) => ((Xph => (Xth <=> Xch)) => (Xph => (Xps <=> Xth))))))))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(ccle_tp,type,(ccle : ($i > $o))).
thf(apcprmpw2_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccn)) => ((cwrex @ (^ [Xn:$i] : (cwbr @ XA2 @ (cco @ XP @ (ccv @ Xn) @ ccexp) @ ccdvds)) @ (^ [Xn:$i] : ccn0)) <=> (XA2 = (cco @ XP @ (cco @ XP @ XA2 @ ccpc) @ ccexp))))))).
...
thf(aispgp_ax,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : ((! [Xn:$i] : ((XX @ Xn) = (ccfv @ XG @ ccbs))) => ((! [Xx3:$i] : (! [Xn:$i] : ((XO @ Xx3 @ Xn) = (ccfv @ XG @ ccod)))) => (! [Xn:$i] : ((cwbr @ XP @ XG @ ccpgp) <=> (cw3a @ (cwcel @ XP @ ccprime) @ (cwcel @ XG @ ccgrp) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xn:$i] : ((ccfv @ (ccv @ Xx3) @ (XO @ Xx3 @ Xn)) = (cco @ XP @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn0))) @ (^ [Xx3:$i] : (XX @ Xn))))))))))))).
thf(cpgpfi1_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XP @ ccprime) @ (cwcel @ XN @ ccn0)) => (((ccfv @ XX @ cchash) = (cco @ XP @ XN @ ccexp)) => (cwbr @ XP @ XG @ ccpgp))))))))).
