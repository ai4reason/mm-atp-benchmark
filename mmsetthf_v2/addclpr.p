...
thf(aaddclprlem2_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xg1:$i] : (! [Xh:$i] : (((((cwcel @ (XA2 @ Xg1 @ Xh) @ ccnp) & (cwcel @ (ccv @ Xg1) @ (XA2 @ Xg1 @ Xh))) & ((cwcel @ (XB2 @ Xg1 @ Xh) @ ccnp) & (cwcel @ (ccv @ Xh) @ (XB2 @ Xg1 @ Xh)))) & (cwcel @ (ccv @ Xx3) @ ccnq)) => ((cwbr @ (ccv @ Xx3) @ (cco @ (ccv @ Xg1) @ (ccv @ Xh) @ ccplq) @ ccltq) => (cwcel @ (ccv @ Xx3) @ (cco @ (XA2 @ Xg1 @ Xh) @ (XB2 @ Xg1 @ Xh) @ ccpp)))))))))).
thf(caddclpr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccnp) & (cwcel @ XB2 @ ccnp)) => (cwcel @ (cco @ XA2 @ XB2 @ ccpp) @ ccnp))))).
