...
thf(cablfac1lem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XO:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((! [Xx3:$i] : (! [Xp:$i] : ((XS @ Xx3 @ Xp) = (ccmpt @ (^ [Xp:$i] : XA2) @ (^ [Xp:$i] : (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ XO) @ (cco @ (ccv @ Xp) @ (cco @ (ccv @ Xp) @ (ccfv @ XB2 @ cchash) @ ccpc) @ ccexp) @ ccdvds)) @ (^ [Xx3:$i] : XB2))))))) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XB2 @ ccfn)) => ((Xph => (cwss @ XA2 @ ccprime)) => ((! [Xx3:$i] : (! [Xp:$i] : ((XM @ Xx3 @ Xp) = (cco @ XP @ (cco @ XP @ (ccfv @ XB2 @ cchash) @ ccpc) @ ccexp)))) => ((! [Xx3:$i] : (! [Xp:$i] : ((XN @ Xx3 @ Xp) = (cco @ (ccfv @ XB2 @ cchash) @ (XM @ Xx3 @ Xp) @ ccdiv)))) => (! [Xx3:$i] : (! [Xp:$i] : ((Xph & (cwcel @ XP @ XA2)) => (cw3a @ ((cwcel @ (XM @ Xx3 @ Xp) @ ccn) & (cwcel @ (XN @ Xx3 @ Xp) @ ccn)) @ ((cco @ (XM @ Xx3 @ Xp) @ (XN @ Xx3 @ Xp) @ ccgcd) = cc1) @ ((ccfv @ XB2 @ cchash) = (cco @ (XM @ Xx3 @ Xp) @ (XN @ Xx3 @ Xp) @ ccmul)))))))))))))))))))))))).
