...
thf(aacnlem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [Xx3:$i] : (! [Xf1:$i] : (! [Xg1:$i] : (((cwcel @ XA2 @ (XV @ Xx3 @ Xf1 @ Xg1)) & (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3 @ Xf1) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)))) @ (^ [Xx3:$i] : XA2))) => (? [Xg1:$i] : (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xg1)) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)))) @ (^ [Xx3:$i] : XA2))))))))))).
...
thf(afinacn_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfn) => ((cwacn @ XA2) = ccvv)))).
