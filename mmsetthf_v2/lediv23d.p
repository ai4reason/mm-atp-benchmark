...
thf(clediv23d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => (cwcel @ XC @ ccrp)) => ((Xph => (cwbr @ (cco @ XA2 @ XB2 @ ccdiv) @ XC @ ccle)) => (Xph => (cwbr @ (cco @ XA2 @ XC @ ccdiv) @ XB2 @ ccle))))))))))).
