...
thf(acnextf_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XC = (ccuni @ XJ)) => ((XB2 = (ccuni @ XK)) => ((Xph => (cwcel @ XJ @ cctop)) => ((Xph => (cwcel @ XK @ ccha)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwss @ XA2 @ XC)) => ((Xph => ((ccfv @ XA2 @ (ccfv @ XJ @ cccl)) = XC)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XC)) => (cwne @ (ccfv @ XF @ (cco @ XK @ (cco @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest) @ ccflf)) @ cc0))) => (Xph => (cwf @ XC @ XB2 @ (ccfv @ XF @ (cco @ XJ @ XK @ cccnext)))))))))))))))))))).
...
thf(acnextfvval_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XC = (ccuni @ XJ)) => ((XB2 = (ccuni @ XK)) => ((Xph => (cwcel @ XJ @ cctop)) => ((Xph => (cwcel @ XK @ ccha)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwss @ XA2 @ XC)) => ((Xph => ((ccfv @ XA2 @ (ccfv @ XJ @ cccl)) = XC)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XC)) => (cwne @ (ccfv @ XF @ (cco @ XK @ (cco @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest) @ ccflf)) @ cc0))) => ((Xph & (cwcel @ XX @ XC)) => ((ccfv @ XX @ (ccfv @ XF @ (cco @ XJ @ XK @ cccnext))) = (ccuni @ (ccfv @ XF @ (cco @ XK @ (cco @ (ccfv @ (ccsn @ XX) @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest) @ ccflf)))))))))))))))))))))).
...
thf(acnnei_ax,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => ((cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XK @ cctop) @ (cwf @ XX @ XY @ XF)) => ((cwcel @ XF @ (cco @ XJ @ XK @ cccn)) <=> (cwral @ (^ [Xp:$i] : (cwral @ (^ [Xw:$i] : (cwrex @ (^ [Xv:$i] : (cwss @ (ccima @ XF @ (ccv @ Xv)) @ (ccv @ Xw))) @ (^ [Xv:$i] : (ccfv @ (ccsn @ (ccv @ Xp)) @ (ccfv @ XJ @ ccnei))))) @ (^ [Xw:$i] : (ccfv @ (ccsn @ (ccfv @ (ccv @ Xp) @ XF)) @ (ccfv @ XK @ ccnei))))) @ (^ [Xp:$i] : XX)))))))))))).
...
thf(aneitr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XA2 @ XX) @ (cwss @ XB2 @ XA2)) => ((ccfv @ XB2 @ (ccfv @ (cco @ XJ @ XA2 @ ccrest) @ ccnei)) = (cco @ (ccfv @ XB2 @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest))))))))).
...
thf(aflfnei_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xs1:$i] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) => ((cwcel @ (XA2 @ Xs1) @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf))) <=> ((cwcel @ (XA2 @ Xs1) @ XX) & (cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xs1:$i] : (cwss @ (ccima @ XF @ (ccv @ Xs1)) @ (ccv @ Xn))) @ (^ [Xs1:$i] : XL))) @ (^ [Xn:$i] : (ccfv @ (ccsn @ (XA2 @ Xs1)) @ (ccfv @ XJ @ ccnei))))))))))))))).
...
thf(ahausflf2_ax,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cw3a @ (cwcel @ XJ @ ccha) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) & (cwne @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf)) @ cc0)) => (cwbr @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf)) @ cc1o @ ccen))))))))).
...
thf(ccnextfres1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XC = (ccuni @ XJ)) => ((XB2 = (ccuni @ XK)) => ((Xph => (cwcel @ XJ @ cctop)) => ((Xph => (cwcel @ XK @ ccha)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwss @ XA2 @ XC)) => ((Xph => ((ccfv @ XA2 @ (ccfv @ XJ @ cccl)) = XC)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XC)) => (cwne @ (ccfv @ XF @ (cco @ XK @ (cco @ (ccfv @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ XJ @ ccnei)) @ XA2 @ ccrest) @ ccflf)) @ cc0))) => ((Xph => (cwcel @ XK @ ccreg)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XJ @ XA2 @ ccrest) @ XK @ cccn))) => (Xph => ((ccres @ (ccfv @ XF @ (cco @ XJ @ XK @ cccnext)) @ XA2) = XF)))))))))))))))))))).
