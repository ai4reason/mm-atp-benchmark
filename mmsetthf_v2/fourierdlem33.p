...
thf(asnunioo2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwbr @ XA2 @ XB2 @ cclt)) => ((ccun @ (cco @ XA2 @ XB2 @ ccioo) @ (ccsn @ XB2)) = (cco @ XA2 @ XB2 @ ccioc)))))).
...
thf(cfourierdlem33_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccc @ cccncf))) => ((Xph => (cwcel @ XL @ (cco @ XF @ XB2 @ cclimc))) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwcel @ XD @ ccr)) => ((Xph => (cwbr @ XC @ XD @ cclt)) => ((Xph => (cwss @ (cco @ XC @ XD @ ccioo) @ (cco @ XA2 @ XB2 @ ccioo))) => ((XY = (ccif @ (XD = XB2) @ XL @ (ccfv @ XD @ XF))) => ((XJ = (cco @ (ccfv @ cccnfld @ cctopn) @ (ccun @ (cco @ XA2 @ XB2 @ ccioo) @ (ccsn @ XB2)) @ ccrest)) => (Xph => (cwcel @ XY @ (cco @ (ccres @ XF @ (cco @ XC @ XD @ ccioo)) @ XD @ cclimc)))))))))))))))))))))))).
