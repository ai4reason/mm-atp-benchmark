...
thf(annsum4primesle9_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) & (cwbr @ XN @ cc8 @ ccle)) => (cwrex @ (^ [Xd:$i] : (cwrex @ (^ [Xf1:$i] : ((cwbr @ (ccv @ Xd) @ cc4 @ ccle) & (XN = (ccsu @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1))))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ (ccv @ Xd) @ ccfz) @ ccmap)))) @ (^ [Xd:$i] : ccn))))).
...
thf(annsum4primeseven_ax,axiom,(! [XN:($i > $o)] : ((cwral @ (^ [Xm:$i] : ((cwbr @ cc5 @ (ccv @ Xm) @ cclt) => (cwcel @ (ccv @ Xm) @ ccgbow))) @ (^ [Xm:$i] : ccodd)) => (((cwcel @ XN @ (ccfv @ cc9 @ ccuz)) & (cwcel @ XN @ cceven)) => (cwrex @ (^ [Xf1:$i] : (XN = (ccsu @ (cco @ cc1 @ cc4 @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ cc4 @ ccfz) @ ccmap))))))).
