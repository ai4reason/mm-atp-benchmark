...
thf(csubmcl_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_pl = (ccfv @ XM @ ccplusg)) => ((cw3a @ (cwcel @ XS @ (ccfv @ XM @ ccsubmnd)) @ (cwcel @ XX @ XS) @ (cwcel @ XY @ XS)) => (cwcel @ (cco @ XX @ XY @ Xc_pl) @ XS))))))))).
