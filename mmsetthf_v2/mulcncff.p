...
thf(cmulcncff_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ XX @ ccc @ cccncf))) => ((Xph => (cwcel @ XG @ (cco @ XX @ ccc @ cccncf))) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ (cco @ XX @ ccc @ cccncf)))))))))).
