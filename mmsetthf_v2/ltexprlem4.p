...
thf(aprnmax_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccnp) & (cwcel @ XB2 @ XA2)) => (cwrex @ (^ [Xx3:$i] : (cwbr @ XB2 @ (ccv @ Xx3) @ ccltq)) @ (^ [Xx3:$i] : XA2)))))).
...
thf(altrelnq_ax,axiom,(cwss @ ccltq @ (ccxp @ ccnq @ ccnq))).
...
thf(altaddnq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccnq) & (cwcel @ XB2 @ ccnq)) => (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ ccplq) @ ccltq))))).
...
thf(altexnq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccnq) => ((cwbr @ XA2 @ XB2 @ ccltq) <=> (? [Xx3:$i] : ((cco @ XA2 @ (ccv @ Xx3) @ ccplq) = XB2))))))).
...
thf(andmovordi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (((ccdm @ XF) = (ccxp @ XS @ XS)) => ((cwss @ XR @ (ccxp @ XS @ XS)) => ((~ (cwcel @ cc0 @ XS)) => (((cwcel @ XC @ XS) => ((cwbr @ XA2 @ XB2 @ XR) <=> (cwbr @ (cco @ XC @ XA2 @ XF) @ (cco @ XC @ XB2 @ XF) @ XR))) => ((cwbr @ (cco @ XC @ XA2 @ XF) @ (cco @ XC @ XB2 @ XF) @ XR) => (cwbr @ XA2 @ XB2 @ XR))))))))))))).
thf(altanq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XC @ ccnq) => ((cwbr @ XA2 @ XB2 @ ccltq) <=> (cwbr @ (cco @ XC @ XA2 @ ccplq) @ (cco @ XC @ XB2 @ ccplq) @ ccltq))))))).
...
thf(cltexprlem4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((! [Xy1:$i] : ((XC @ Xy1) = (ccab @ (^ [Xx3:$i] : (? [Xy1:$i] : ((~ (cwcel @ (ccv @ Xy1) @ XA2)) & (cwcel @ (cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccplq) @ XB2))))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XB2 @ ccnp) => ((cwcel @ (ccv @ Xx3) @ (XC @ Xy1)) => (? [Xz:$i] : ((cwcel @ (ccv @ Xz) @ (XC @ Xy1)) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ ccltq)))))))))))).
