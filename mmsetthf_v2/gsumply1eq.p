...
thf(cgsumply1eq_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XK:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_ex = (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg)) => ((Xph => (cwcel @ XR @ ccrg)) => ((XK = (ccfv @ XR @ ccbs)) => ((Xc_as = (ccfv @ XP @ ccvsca)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xph => (cwral @ (^ [Xk:$i] : (cwcel @ (XA2 @ Xk) @ XK)) @ (^ [Xk:$i] : ccn0))) => ((Xph => (cwbr @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (XA2 @ Xk))) @ Xc_0 @ ccfsupp)) => ((Xph => (cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xk) @ XK)) @ (^ [Xk:$i] : ccn0))) => ((Xph => (cwbr @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (XB2 @ Xk))) @ Xc_0 @ ccfsupp)) => ((Xph => (XO = (cco @ XP @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (XA2 @ Xk) @ (cco @ (ccv @ Xk) @ XX @ Xc_ex) @ Xc_as))) @ ccgsu))) => ((Xph => (XQ = (cco @ XP @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (XB2 @ Xk) @ (cco @ (ccv @ Xk) @ XX @ Xc_ex) @ Xc_as))) @ ccgsu))) => (Xph => ((XO = XQ) <=> (cwral @ (^ [Xk:$i] : ((XA2 @ Xk) = (XB2 @ Xk))) @ (^ [Xk:$i] : ccn0)))))))))))))))))))))))))))))).
