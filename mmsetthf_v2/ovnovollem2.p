...
thf(afvco_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfun @ XG) & (cwcel @ XA2 @ (ccdm @ XG))) => ((ccfv @ XA2 @ (cccom @ XF @ XG)) = (ccfv @ (ccfv @ XA2 @ XG) @ XF))))))).
...
thf(aiunmapsn_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ (XW @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XC @ (XZ @ Xx3)))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (XB2 @ Xx3) @ (ccsn @ XC) @ ccmap))) = (cco @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccsn @ XC) @ ccmap)))))))))))))))).
thf(anfv_ax,axiom,(! [Xph:$o] : (cwnf @ (^ [Xx3:$i] : Xph)))).
thf(amapss2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((Xph => (cwcel @ XC @ XZ)) => ((Xph => (cwne @ XC @ cc0)) => (Xph => ((cwss @ XA2 @ XB2) <=> (cwss @ (cco @ XA2 @ XC @ ccmap) @ (cco @ XB2 @ XC @ ccmap)))))))))))))))).
...
thf(afcoss_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwss @ XC @ XA2)) => ((Xph => (cwf @ XD @ XC @ XG)) => (Xph => (cwf @ XD @ XB2 @ (cccom @ XF @ XG)))))))))))))).
thf(cclt_tp,type,(cclt : ($i > $o))).
thf(ccle_tp,type,(ccle : ($i > $o))).
thf(aicof_ax,axiom,(cwf @ (ccxp @ ccxr @ ccxr) @ (ccpw @ ccxr) @ ccico)).
...
thf(avolicofmpt_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((! [Xx3:$i] : (Xph => (cwf @ XA2 @ (ccxp @ ccr @ ccxr) @ (XF @ Xx3)))) => (! [Xx3:$i] : (Xph => ((cccom @ (cccom @ ccvol @ ccico) @ (XF @ Xx3)) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ cc1st) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ cc2nd) @ ccico) @ ccvol)))))))))))).
