...
thf(cfislw_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XX @ ccfn) @ (cwcel @ XP @ ccprime)) => ((cwcel @ XH @ (cco @ XP @ XG @ ccslw)) <=> ((cwcel @ XH @ (ccfv @ XG @ ccsubg)) & ((ccfv @ XH @ cchash) = (cco @ XP @ (cco @ XP @ (ccfv @ XX @ cchash) @ ccpc) @ ccexp))))))))))).
