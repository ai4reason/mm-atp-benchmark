...
thf(celintd_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ XB2)) => (cwcel @ XA2 @ (ccv @ Xx3)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ (ccint @ XB2)))))))))))).
