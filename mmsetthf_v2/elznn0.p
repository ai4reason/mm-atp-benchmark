...
thf(anegcon1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => (((ccneg @ XA2) = XB2) <=> ((ccneg @ XB2) = XA2)))))).
...
thf(celznn0_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) <=> ((cwcel @ XN @ ccr) & ((cwcel @ XN @ ccn0) | (cwcel @ (ccneg @ XN) @ ccn0)))))).
