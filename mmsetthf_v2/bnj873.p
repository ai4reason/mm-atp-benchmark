...
thf(cbnj873_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > $o))] : (! [Xbnjwphm:($i > ($i > ($i > $o)))] : (! [Xbnjwpsm:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xn:$i] : ((XB2 @ Xf1 @ Xg1 @ Xn) = (ccab @ (^ [Xf1:$i] : (cwrex @ (^ [Xn:$i] : (cw3a @ (cwfn @ (ccv @ Xf1) @ (ccv @ Xn)) @ (Xph @ Xf1 @ Xn) @ (Xps @ Xf1 @ Xn))) @ (^ [Xn:$i] : (XD @ Xn))))))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xn:$i] : ((Xbnjwphm @ Xf1 @ Xg1 @ Xn) <=> (cwsbc @ (^ [Xf1:$i] : (Xph @ Xf1 @ Xn)) @ (ccv @ Xg1)))))) => ((! [Xf1:$i] : (! [Xg1:$i] : (! [Xn:$i] : ((Xbnjwpsm @ Xf1 @ Xg1 @ Xn) <=> (cwsbc @ (^ [Xf1:$i] : (Xps @ Xf1 @ Xn)) @ (ccv @ Xg1)))))) => (! [Xf1:$i] : (! [Xg1:$i] : (! [Xn:$i] : ((XB2 @ Xf1 @ Xg1 @ Xn) = (ccab @ (^ [Xg1:$i] : (cwrex @ (^ [Xn:$i] : (cw3a @ (cwfn @ (ccv @ Xg1) @ (ccv @ Xn)) @ (Xbnjwphm @ Xf1 @ Xg1 @ Xn) @ (Xbnjwpsm @ Xf1 @ Xg1 @ Xn))) @ (^ [Xn:$i] : (XD @ Xn))))))))))))))))))).
