...
thf(aisfin1a_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : ((cwcel @ XA2 @ (XV @ Xy1)) => ((cwcel @ XA2 @ ccfin1a) <=> (cwral @ (^ [Xy1:$i] : ((cwcel @ (ccv @ Xy1) @ ccfn) | (cwcel @ (ccdif @ XA2 @ (ccv @ Xy1)) @ ccfn))) @ (^ [Xy1:$i] : (ccpw @ XA2))))))))).
thf(cfin11a_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccfn) => (cwcel @ XA2 @ ccfin1a)))).
