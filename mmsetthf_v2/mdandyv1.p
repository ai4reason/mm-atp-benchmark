...
thf(cmdandyv1_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xph <=> $false) => ((Xps <=> $true) => ((Xch <=> $true) => ((Xth <=> $false) => ((Xta <=> $false) => ((Xet <=> $false) => ((((Xch <=> Xps) & (Xth <=> Xph)) & (Xta <=> Xph)) & (Xet <=> Xph))))))))))))))).
