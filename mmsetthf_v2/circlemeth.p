...
thf(avtsprod_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (cwcel @ XS @ ccn0)) => ((Xph => (cwf @ (cco @ ccc0 @ XS @ ccfzo) @ (cco @ ccc @ ccn @ ccmap) @ XL)) => (Xph => ((ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ XX @ (cco @ (ccfv @ (ccv @ Xa) @ XL) @ XN @ ccvts)))) = (ccsu @ (cco @ ccc0 @ (cco @ XS @ XN @ ccmul) @ ccfz) @ (^ [Xm:$i] : (ccsu @ (cco @ (cco @ cc1 @ XN @ ccfz) @ (ccv @ Xm) @ (ccfv @ XS @ ccrepr)) @ (^ [Xc:$i] : (cco @ (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xa) @ XL)))) @ (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (cco @ (ccv @ Xm) @ XX @ ccmul) @ ccmul) @ cce) @ ccmul))))))))))))))))).
...
thf(aefcld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => (Xph => (cwcel @ (ccfv @ XA2 @ cce) @ ccc)))))).
...
thf(aefmul2picn_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (cco @ XA2 @ ccc @ cccncf))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (XB2 @ Xx3) @ ccmul) @ cce))) @ (cco @ XA2 @ ccc @ cccncf)))))))).
...
thf(aunitsscn_ax,axiom,(cwss @ (cco @ ccc0 @ cc1 @ ccicc) @ ccc)).
...
thf(aifeq3da_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((((ccif @ Xps @ XE @ XF) = XE) => (XC = XG)) => ((((ccif @ Xps @ XE @ XF) = XF) => (XC = XH)) => ((Xph => (XG = XA2)) => ((Xph => (XH = XB2)) => (Xph => ((ccif @ Xps @ XA2 @ XB2) = XC)))))))))))))))).
...
thf(aitgexpif_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccioo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (cco @ XN @ (ccv @ Xx3) @ ccmul) @ ccmul) @ cce))) = (ccif @ (XN = ccc0) @ cc1 @ ccc0))))).
...
thf(annmulge_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn) & (cwcel @ XN @ ccn0)) => (cwbr @ XN @ (cco @ XM @ XN @ ccmul) @ ccle))))).
thf(aelfz4_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwcel @ XK @ ccz)) & ((cwbr @ XM @ XK @ ccle) & (cwbr @ XK @ XN @ ccle))) => (cwcel @ XK @ (cco @ XM @ XN @ ccfz))))))).
...
thf(areprfz1_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XS @ ccn0)) => (Xph => ((cco @ ccn @ XN @ (ccfv @ XS @ ccrepr)) = (cco @ (cco @ cc1 @ XN @ ccfz) @ XN @ (ccfv @ XS @ ccrepr)))))))))).
thf(ccirclemeth_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XS @ ccn)) => ((Xph => (cwf @ (cco @ ccc0 @ XS @ ccfzo) @ (cco @ ccc @ ccn @ ccmap) @ XL)) => (Xph => ((ccsu @ (cco @ ccn @ XN @ (ccfv @ XS @ ccrepr)) @ (^ [Xc:$i] : (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccfv @ (ccv @ Xa) @ (ccv @ Xc)) @ (ccfv @ (ccv @ Xa) @ XL)))))) = (ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccioo)) @ (^ [Xx3:$i] : (cco @ (ccprod @ (^ [Xa:$i] : (cco @ ccc0 @ XS @ ccfzo)) @ (^ [Xa:$i] : (ccfv @ (ccv @ Xx3) @ (cco @ (ccfv @ (ccv @ Xa) @ XL) @ XN @ ccvts)))) @ (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (cco @ (ccneg @ XN) @ (ccv @ Xx3) @ ccmul) @ ccmul) @ cce) @ ccmul))))))))))))).
