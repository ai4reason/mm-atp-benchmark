...
thf(acdlemf1_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((! [Xq:$i] : ((Xc_or @ Xq) = (ccfv @ XK @ ccjn))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ ((cwcel @ XU @ XA2) & (cwbr @ XU @ XW @ Xc_le)) @ ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le)))) => (cwrex @ (^ [Xq:$i] : (cw3a @ (cwne @ XP @ (ccv @ Xq)) @ (~ (cwbr @ (ccv @ Xq) @ XW @ Xc_le)) @ (cwbr @ XU @ (cco @ XP @ (ccv @ Xq) @ (Xc_or @ Xq)) @ Xc_le))) @ (^ [Xq:$i] : XA2)))))))))))))))).
...
thf(ccdlemf2_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((! [Xq:$i] : (! [Xp:$i] : ((Xc_or @ Xq @ Xp) = (ccfv @ XK @ ccjn)))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((! [Xq:$i] : (! [Xp:$i] : ((Xc_an @ Xq @ Xp) = (ccfv @ XK @ ccmee)))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XU @ XA2) & (cwbr @ XU @ XW @ Xc_le))) => (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (((~ (cwbr @ (ccv @ Xp) @ XW @ Xc_le)) & (~ (cwbr @ (ccv @ Xq) @ XW @ Xc_le))) & (XU = (cco @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ (Xc_or @ Xq @ Xp)) @ XW @ (Xc_an @ Xq @ Xp))))) @ (^ [Xq:$i] : XA2))) @ (^ [Xp:$i] : XA2))))))))))))))))).
