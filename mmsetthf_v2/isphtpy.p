...
thf(cisphtpy_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : ((Xph => (cwcel @ XF @ (cco @ ccii @ XJ @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ ccii @ XJ @ cccn))) => (Xph => ((cwcel @ XH @ (cco @ XF @ XG @ (ccfv @ XJ @ ccphtpy))) <=> ((cwcel @ XH @ (cco @ XF @ XG @ (cco @ ccii @ XJ @ cchtpy))) & (cwral @ (^ [Xs1:$i] : (((cco @ ccc0 @ (ccv @ Xs1) @ XH) = (ccfv @ ccc0 @ XF)) & ((cco @ cc1 @ (ccv @ Xs1) @ XH) = (ccfv @ cc1 @ XF)))) @ (^ [Xs1:$i] : (cco @ ccc0 @ cc1 @ ccicc)))))))))))))).
