...
thf(aelwwlks2s3_ax,axiom,(! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (XV = (ccfv @ (XG @ Xa @ Xb @ Xc) @ ccvtx))))) => (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((cwcel @ XW @ (cco @ cc2 @ (XG @ Xa @ Xb @ Xc) @ ccwwlksn)) => (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (XW = (ccs3 @ (ccv @ Xa) @ (ccv @ Xb) @ (ccv @ Xc)))) @ (^ [Xc:$i] : XV))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))))))).
