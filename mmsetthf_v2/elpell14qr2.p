...
thf(apell1234qrdich_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) & (cwcel @ XA2 @ (ccfv @ XD @ ccpell1234qr))) => ((cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) | (cwcel @ (ccneg @ XA2) @ (ccfv @ XD @ ccpell14qr))))))).
