...
thf(asubsub23_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) => (((cco @ XA2 @ XB2 @ ccmin) = XC) <=> ((cco @ XA2 @ XC @ ccmin) = XB2))))))).
...
thf(cdquartlem2_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (cwcel @ XS @ ccc)) => ((Xph => (XM = (cco @ (cco @ cc2 @ XS @ ccmul) @ cc2 @ ccexp))) => ((Xph => (cwne @ XM @ ccc0)) => ((Xph => (cwcel @ XI @ ccc)) => ((Xph => ((cco @ XI @ cc2 @ ccexp) = (cco @ (cco @ (ccneg @ (cco @ XS @ cc2 @ ccexp)) @ (cco @ XB2 @ cc2 @ ccdiv) @ ccmin) @ (cco @ (cco @ XC @ cc4 @ ccdiv) @ XS @ ccdiv) @ ccaddc))) => ((Xph => (cwcel @ XD @ ccc)) => ((Xph => ((cco @ (cco @ (cco @ XM @ cc3 @ ccexp) @ (cco @ (cco @ cc2 @ XB2 @ ccmul) @ (cco @ XM @ cc2 @ ccexp) @ ccmul) @ ccaddc) @ (cco @ (cco @ (cco @ (cco @ XB2 @ cc2 @ ccexp) @ (cco @ cc4 @ XD @ ccmul) @ ccmin) @ XM @ ccmul) @ (ccneg @ (cco @ XC @ cc2 @ ccexp)) @ ccaddc) @ ccaddc) = ccc0)) => (Xph => ((cco @ (cco @ (cco @ (cco @ XM @ XB2 @ ccaddc) @ cc2 @ ccdiv) @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ XC @ cc2 @ ccexp) @ cc4 @ ccdiv) @ XM @ ccdiv) @ ccmin) = XD))))))))))))))))))))).
