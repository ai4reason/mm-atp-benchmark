...
thf(acantnfvalf_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xz:$i] : (! [Xk:$i] : ((XF @ Xz @ Xk) = (ccseqom @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xz:$i] : XA2)) @ (^ [Xk:$i] : (^ [Xz:$i] : XB2)) @ (^ [Xk:$i] : (^ [Xz:$i] : (cco @ (XC @ Xz @ Xk) @ (XD @ Xz @ Xk) @ ccoa)))) @ cc0)))) => (! [Xz:$i] : (! [Xk:$i] : (cwf @ ccom @ ccon0 @ (XF @ Xz @ Xk))))))))))).
thf(aoacomf1o_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccun @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ XB2 @ (ccv @ Xx3) @ ccoa))) @ (cccnv @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccoa))))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => (cwf1o @ (cco @ XA2 @ XB2 @ ccoa) @ (cco @ XB2 @ XA2 @ ccoa) @ (XF @ Xx3))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(aeqtrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XB2 = XC)) => (Xph => (XA2 = XC))))))))).
thf(ccid_tp,type,(ccid : ($i > $o))).
thf(ccrdg_tp,type,(ccrdg : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(aseqomsuc_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XG = (ccseqom @ XF @ XI)) => ((cwcel @ XA2 @ ccom) => ((ccfv @ (ccsuc @ XA2) @ XG) = (cco @ XA2 @ (ccfv @ XA2 @ XG) @ XF))))))))).
...
thf(acbvmpt2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : (cwnfc @ (^ [Xz:$i] : (XC @ Xx3 @ Xy1 @ Xz @ Xw)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (cwnfc @ (^ [Xw:$i] : (XC @ Xx3 @ Xy1 @ Xz @ Xw)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwnfc @ (^ [Xx3:$i] : (XD @ Xx3 @ Xy1 @ Xz @ Xw)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xw:$i] : (cwnfc @ (^ [Xy1:$i] : (XD @ Xx3 @ Xy1 @ Xz @ Xw)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((((ccv @ Xx3) = (ccv @ Xz)) & ((ccv @ Xy1) = (ccv @ Xw))) => ((XC @ Xx3 @ Xy1 @ Xz @ Xw) = (XD @ Xx3 @ Xy1 @ Xz @ Xw))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XA2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1 @ Xz @ Xw)))) = (ccmpt2 @ (^ [Xz:$i] : (^ [Xw:$i] : XA2)) @ (^ [Xz:$i] : (^ [Xw:$i] : XB2)) @ (^ [Xz:$i] : (^ [Xw:$i] : (XD @ Xx3 @ Xy1 @ Xz @ Xw))))))))))))))))))).
...
thf(aepelg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((cwbr @ XA2 @ XB2 @ ccep) <=> (cwcel @ XA2 @ XB2))))))).
...
thf(aomword1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) & (cwcel @ cc0 @ XB2)) => (cwss @ XA2 @ (cco @ XA2 @ XB2 @ ccomu)))))).
thf(cc2o_tp,type,(cc2o : ($i > $o))).
thf(ccdif_tp,type,(ccdif : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(cw3o_tp,type,(cw3o : ($o > ($o > ($o > $o))))).
thf(cwreu_tp,type,(cwreu : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(aoaabs2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ (cco @ ccom @ XC @ ccoe)) & (cwcel @ XB2 @ ccon0)) & (cwss @ (cco @ ccom @ XC @ ccoe) @ XB2)) => ((cco @ XA2 @ XB2 @ ccoa) = XB2)))))).
thf(af1oeq3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cwf1o @ XC @ XA2 @ XF) <=> (cwf1o @ XC @ XB2 @ XF)))))))).
thf(ccnfcomlem_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > $o))] : (! [XK:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XO:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xf1:$i] : ((XS @ Xx3 @ Xf1) = (ccdm @ (cco @ ccom @ (XA2 @ Xf1) @ cccnf))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xz @ Xf1 @ Xk) => (cwcel @ (XA2 @ Xf1) @ ccon0)))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xz @ Xf1 @ Xk) => (cwcel @ (XB2 @ Xx3 @ Xz @ Xf1 @ Xk) @ (cco @ ccom @ (XA2 @ Xf1) @ ccoe))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xk:$i] : (XF = (ccfv @ (XB2 @ Xx3 @ Xz @ Xf1 @ Xk) @ (cccnv @ (cco @ ccom @ (XA2 @ Xf1) @ cccnf)))))))) => ((XG = (ccoi @ (cco @ XF @ cc0 @ ccsupp) @ ccep)) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((XH @ Xz @ Xk) = (ccseqom @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xz:$i] : ccvv)) @ (^ [Xk:$i] : (^ [Xz:$i] : ccvv)) @ (^ [Xk:$i] : (^ [Xz:$i] : (cco @ (XM @ Xz @ Xf1 @ Xk) @ (ccv @ Xz) @ ccoa)))) @ cc0))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((XT @ Xx3 @ Xf1 @ Xk) = (ccseqom @ (ccmpt2 @ (^ [Xk:$i] : (^ [Xf1:$i] : ccvv)) @ (^ [Xk:$i] : (^ [Xf1:$i] : ccvv)) @ (^ [Xk:$i] : (^ [Xf1:$i] : (XK @ Xx3 @ Xz @ Xf1 @ Xk)))) @ cc0)))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((XM @ Xz @ Xf1 @ Xk) = (cco @ (cco @ ccom @ (ccfv @ (ccv @ Xk) @ XG) @ ccoe) @ (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ XF) @ ccomu))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((XK @ Xx3 @ Xz @ Xf1 @ Xk) = (ccun @ (ccmpt @ (^ [Xx3:$i] : (XM @ Xz @ Xf1 @ Xk)) @ (^ [Xx3:$i] : (cco @ (ccdm @ (ccv @ Xf1)) @ (ccv @ Xx3) @ ccoa))) @ (cccnv @ (ccmpt @ (^ [Xx3:$i] : (ccdm @ (ccv @ Xf1))) @ (^ [Xx3:$i] : (cco @ (XM @ Xz @ Xf1 @ Xk) @ (ccv @ Xx3) @ ccoa)))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xz @ Xf1 @ Xk) => (cwcel @ (XI @ Xf1) @ (ccdm @ XG))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xz @ Xf1 @ Xk) => (cwcel @ (XO @ Xx3 @ Xz @ Xf1 @ Xk) @ (cco @ ccom @ (ccfv @ (XI @ Xf1) @ XG) @ ccoe))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xz @ Xf1 @ Xk) => (cwf1o @ (ccfv @ (XI @ Xf1) @ (XH @ Xz @ Xk)) @ (XO @ Xx3 @ Xz @ Xf1 @ Xk) @ (ccfv @ (XI @ Xf1) @ (XT @ Xx3 @ Xf1 @ Xk)))))))) => (! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xk:$i] : ((Xph @ Xx3 @ Xz @ Xf1 @ Xk) => (cwf1o @ (ccfv @ (ccsuc @ (XI @ Xf1)) @ (XH @ Xz @ Xk)) @ (cco @ (cco @ ccom @ (ccfv @ (XI @ Xf1) @ XG) @ ccoe) @ (ccfv @ (ccfv @ (XI @ Xf1) @ XG) @ XF) @ ccomu) @ (ccfv @ (ccsuc @ (XI @ Xf1)) @ (XT @ Xx3 @ Xf1 @ Xk))))))))))))))))))))))))))))))))).
