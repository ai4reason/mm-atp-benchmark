...
thf(aelfzom1p1elfzo_ax,axiom,(! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XX @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfzo))) => (cwcel @ (cco @ XX @ cc1 @ ccaddc) @ (cco @ ccc0 @ XN @ ccfzo)))))).
