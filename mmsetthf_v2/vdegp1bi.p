...
thf(ap1evtxdp1_ax,axiom,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XG @ cciedg)) => ((Xph => (cwfun @ XI)) => ((Xph => ((ccfv @ XF @ ccvtx) = XV)) => ((Xph => ((ccfv @ XF @ cciedg) = (ccun @ XI @ (ccsn @ (ccop @ XK @ XE))))) => ((Xph => (cwcel @ XK @ XX)) => ((Xph => (cwnel @ XK @ (ccdm @ XI))) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (cwcel @ XE @ (ccpw @ XV))) => ((Xph => (cwcel @ XU @ XE)) => ((Xph => (cwbr @ cc2 @ (ccfv @ XE @ cchash) @ ccle)) => (Xph => ((ccfv @ XU @ (ccfv @ XF @ ccvtxdg)) = (cco @ (ccfv @ XU @ (ccfv @ XG @ ccvtxdg)) @ cc1 @ ccxad)))))))))))))))))))))))).
...
thf(aeqlei_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((XA2 = XB2) => (cwbr @ XA2 @ XB2 @ ccle)))))).
