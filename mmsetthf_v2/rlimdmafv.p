...
thf(arlimuni_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => ((ccsup @ XA2 @ ccxr @ cclt) = ccpnf)) => ((Xph => (cwbr @ XF @ XB2 @ ccrli)) => ((Xph => (cwbr @ XF @ XC @ ccrli)) => (Xph => (XB2 = XC)))))))))))).
...
thf(adfdfat2_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwdfat @ XA2 @ XF) <=> ((cwcel @ XA2 @ (ccdm @ XF)) & (cweu @ (^ [Xy1:$i] : (cwbr @ XA2 @ (ccv @ Xy1) @ XF)))))))).
...
thf(crlimdmafv_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => ((ccsup @ XA2 @ ccxr @ cclt) = ccpnf)) => (Xph => ((cwcel @ XF @ (ccdm @ ccrli)) <=> (cwbr @ XF @ (ccafv @ XF @ ccrli) @ ccrli))))))))).
