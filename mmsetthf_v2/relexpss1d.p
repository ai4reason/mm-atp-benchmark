...
thf(crelexpss1d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwss @ XA2 @ XB2)) => ((Xph => (cwcel @ XB2 @ ccvv)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => (cwss @ (cco @ XA2 @ XN @ ccrelexp) @ (cco @ XB2 @ XN @ ccrelexp))))))))))).
