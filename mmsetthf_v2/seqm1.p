...
thf(cseqm1_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ (ccfv @ (cco @ XM @ cc1 @ ccaddc) @ ccuz))) => ((ccfv @ XN @ (ccseq @ Xc_pl @ XF @ XM)) = (cco @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ (ccseq @ Xc_pl @ XF @ XM)) @ (ccfv @ XN @ XF) @ Xc_pl)))))))).
