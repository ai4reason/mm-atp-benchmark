...
thf(a_2eluzge0_ax,axiom,(cwcel @ cc2 @ (ccfv @ ccc0 @ ccuz))).
...
thf(abpolycl_ax,axiom,(! [XN:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XX @ ccc)) => (cwcel @ (cco @ XN @ XX @ ccbp) @ ccc))))).
...
thf(a_4bc3eq4_ax,axiom,((cco @ cc4 @ cc3 @ ccbc) = cc4)).
...
thf(a_4bc2eq6_ax,axiom,((cco @ cc4 @ cc2 @ ccbc) = cc6)).
...
thf(abpoly0_ax,axiom,(! [XX:($i > $o)] : ((cwcel @ XX @ ccc) => ((cco @ ccc0 @ XX @ ccbp) = cc1)))).
...
thf(abpoly1_ax,axiom,(! [XX:($i > $o)] : ((cwcel @ XX @ ccc) => ((cco @ cc1 @ XX @ ccbp) = (cco @ XX @ (cco @ cc1 @ cc2 @ ccdiv) @ ccmin))))).
...
thf(abpoly2_ax,axiom,(! [XX:($i > $o)] : ((cwcel @ XX @ ccc) => ((cco @ cc2 @ XX @ ccbp) = (cco @ (cco @ (cco @ XX @ cc2 @ ccexp) @ XX @ ccmin) @ (cco @ cc1 @ cc6 @ ccdiv) @ ccaddc))))).
...
thf(abpoly3_ax,axiom,(! [XX:($i > $o)] : ((cwcel @ XX @ ccc) => ((cco @ cc3 @ XX @ ccbp) = (cco @ (cco @ (cco @ XX @ cc3 @ ccexp) @ (cco @ (cco @ cc3 @ cc2 @ ccdiv) @ (cco @ XX @ cc2 @ ccexp) @ ccmul) @ ccmin) @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ XX @ ccmul) @ ccaddc))))).
...
thf(ahalfthird_ax,axiom,((cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (cco @ cc1 @ cc3 @ ccdiv) @ ccmin) = (cco @ cc1 @ cc6 @ ccdiv))).
thf(a_5recm6rec_ax,axiom,((cco @ (cco @ cc1 @ cc5 @ ccdiv) @ (cco @ cc1 @ cc6 @ ccdiv) @ ccmin) = (cco @ cc1 @ (ccdc @ cc3 @ ccc0) @ ccdiv))).
