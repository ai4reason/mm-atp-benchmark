...
thf(ctfisi_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XA2 @ Xy1) @ (XV @ Xx3 @ Xy1))))) => ((Xph => (cwcel @ XT @ ccon0)) => ((! [Xx3:$i] : ((cw3a @ Xph @ ((cwcel @ (XR @ Xx3) @ ccon0) & (cwss @ (XR @ Xx3) @ XT)) @ (! [Xy1:$i] : ((cwcel @ (XS @ Xy1) @ (XR @ Xx3)) => (Xch @ Xy1)))) => (Xps @ Xx3))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xps @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XA2 @ Xy1)) => ((Xps @ Xx3) <=> (Xth @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((XR @ Xx3) = (XS @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XA2 @ Xy1)) => ((XR @ Xx3) = XT)))) => (! [Xy1:$i] : (Xph => (Xth @ Xy1)))))))))))))))))))).
