...
thf(agam1_ax,axiom,((ccfv @ cc1 @ ccgam) = cc1)).
...
thf(agamp1_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn))) => ((ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ ccgam) = (cco @ (ccfv @ XA2 @ ccgam) @ XA2 @ ccmul))))).
thf(cfacgam_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((ccfv @ XN @ ccfa) = (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ ccgam))))).
