...
thf(ahauseqcn_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((Xph => (cwcel @ XK @ ccha)) => ((Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) => ((Xph => (cwcel @ XG @ (cco @ XJ @ XK @ cccn))) => ((Xph => ((ccres @ XF @ XA2) = (ccres @ XG @ XA2))) => ((Xph => (cwss @ XA2 @ XX)) => ((Xph => ((ccfv @ XA2 @ (ccfv @ XJ @ cccl)) = XX)) => (Xph => (XF = XG))))))))))))))))).
...
thf(arerrext_ax,axiom,(cwcel @ ccrefld @ ccrrext)).
thf(ccbs_tp,type,(ccbs : ($i > $o))).
thf(cctopn_tp,type,(cctopn : ($i > $o))).
thf(arrhcne_ax,axiom,(! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((XK = (ccfv @ XR @ cctopn)) => ((cwcel @ XR @ ccrrext) => (cwcel @ (ccfv @ XR @ ccrrh) @ (cco @ XJ @ XK @ cccn))))))))).
...
thf(aqdensere_ax,axiom,((ccfv @ ccq @ (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccl)) = ccr)).
...
thf(aqex_ax,axiom,(cwcel @ ccq @ ccvv)).
...
thf(aresiima_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XB2 @ XA2) => ((ccima @ (ccres @ ccid @ XA2) @ XB2) = XB2))))).
...
thf(aisflf_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xs1:$i] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) => ((cwcel @ (XA2 @ Xs1) @ (ccfv @ XF @ (cco @ XJ @ XL @ ccflf))) <=> ((cwcel @ (XA2 @ Xs1) @ XX) & (cwral @ (^ [Xo:$i] : ((cwcel @ (XA2 @ Xs1) @ (ccv @ Xo)) => (cwrex @ (^ [Xs1:$i] : (cwss @ (ccima @ XF @ (ccv @ Xs1)) @ (ccv @ Xo))) @ (^ [Xs1:$i] : XL)))) @ (^ [Xo:$i] : XJ))))))))))))).
...
thf(acuspusp_ax,axiom,(! [XW:($i > $o)] : ((cwcel @ XW @ cccusp) => (cwcel @ XW @ ccusp)))).
thf(ccust_tp,type,(ccust : ($i > $o))).
thf(ccutop_tp,type,(ccutop : ($i > $o))).
thf(auspreg_ax,axiom,(! [XJ:($i > $o)] : (! [XW:($i > $o)] : ((XJ = (ccfv @ XW @ cctopn)) => (((cwcel @ XW @ ccusp) & (cwcel @ XJ @ ccha)) => (cwcel @ XJ @ ccreg)))))).
...
thf(arecms_ax,axiom,(cwcel @ ccrefld @ cccms)).
thf(arrhval_ax,axiom,(! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XJ = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((XK = (ccfv @ XR @ cctopn)) => ((cwcel @ XR @ XV) => ((ccfv @ XR @ ccrrh) = (ccfv @ (ccfv @ XR @ ccqqh) @ (cco @ XJ @ XK @ cccnext))))))))))).
...
thf(aqqhre_ax,axiom,((ccfv @ ccrefld @ ccqqh) = (ccres @ ccid @ ccq))).
thf(crrhre_conj,conjecture,((ccfv @ ccrefld @ ccrrh) = (ccres @ ccid @ ccr))).
