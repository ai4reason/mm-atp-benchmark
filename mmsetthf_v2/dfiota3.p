...
thf(adfsingles2_ax,axiom,(ccsingles = (ccab @ (^ [Xx3:$i] : (? [Xy1:$i] : ((ccv @ Xx3) = (ccsn @ (ccv @ Xy1)))))))).
...
thf(cdfiota3_conj,conjecture,(! [Xph:($i > $o)] : ((ccio @ (^ [Xx3:$i] : (Xph @ Xx3))) = (ccuni @ (ccuni @ (ccin @ (ccsn @ (ccab @ (^ [Xx3:$i] : (Xph @ Xx3)))) @ ccsingles)))))).
