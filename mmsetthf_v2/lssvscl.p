...
thf(clssvscl_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XB2 = (ccfv @ XF @ ccbs)) => ((XS = (ccfv @ XW @ cclss)) => ((((cwcel @ XW @ cclmod) & (cwcel @ XU @ XS)) & ((cwcel @ XX @ XB2) & (cwcel @ XY @ XU))) => (cwcel @ (cco @ XX @ XY @ Xc_x) @ XU))))))))))))))).
