...
thf(alcmf0val_ax,axiom,(! [XZ:($i > $o)] : (((cwss @ XZ @ ccz) & (cwcel @ ccc0 @ XZ)) => ((ccfv @ XZ @ cclcmf) = ccc0)))).
...
thf(alcmfcllem_ax,axiom,(! [XZ:($i > $o)] : ((cw3a @ (cwss @ XZ @ ccz) @ (cwcel @ XZ @ ccfn) @ (cwnel @ ccc0 @ XZ)) => (cwcel @ (ccfv @ XZ @ cclcmf) @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xm:$i] : XZ))) @ (^ [Xn:$i] : ccn)))))).
...
thf(cdvdslcmf_conj,conjecture,(! [XZ:($i > $o)] : (((cwss @ XZ @ ccz) & (cwcel @ XZ @ ccfn)) => (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ XZ @ cclcmf) @ ccdvds)) @ (^ [Xx3:$i] : XZ))))).
