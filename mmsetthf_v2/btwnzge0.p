...
thf(cbtwnzge0_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XN @ ccz)) & ((cwbr @ XN @ XA2 @ ccle) & (cwbr @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ cclt))) => ((cwbr @ ccc0 @ XA2 @ ccle) <=> (cwbr @ ccc0 @ XN @ ccle)))))).
