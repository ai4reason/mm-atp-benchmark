...
thf(asyl3an3b_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph <=> Xth) => (((cw3a @ Xps @ Xch @ Xth) => Xta) => ((cw3a @ Xps @ Xch @ Xph) => Xta))))))))).
...
thf(aisdrng2_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((XG = (cco @ (ccfv @ XR @ ccmgp) @ (ccdif @ XB2 @ (ccsn @ Xc_0)) @ ccress)) => ((cwcel @ XR @ ccdr) <=> ((cwcel @ XR @ ccrg) & (cwcel @ XG @ ccgrp))))))))))).
thf(cisdrngd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((Xph => (XB2 = (ccfv @ XR @ ccbs))) => ((Xph => (Xc_x = (ccfv @ XR @ ccmulr))) => ((Xph => (Xc_0 = (ccfv @ XR @ cc0g))) => ((Xph => (Xc_1 = (ccfv @ XR @ ccur))) => ((Xph => (cwcel @ XR @ ccrg)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ Xph @ ((cwcel @ (ccv @ Xx3) @ XB2) & (cwne @ (ccv @ Xx3) @ Xc_0)) @ ((cwcel @ (ccv @ Xy1) @ XB2) & (cwne @ (ccv @ Xy1) @ Xc_0))) => (cwne @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_x) @ Xc_0)))) => ((Xph => (cwne @ Xc_1 @ Xc_0)) => ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & (cwne @ (ccv @ Xx3) @ Xc_0))) => (cwcel @ (XI @ Xx3) @ XB2))) => ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & (cwne @ (ccv @ Xx3) @ Xc_0))) => (cwne @ (XI @ Xx3) @ Xc_0))) => ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XB2) & (cwne @ (ccv @ Xx3) @ Xc_0))) => ((cco @ (XI @ Xx3) @ (ccv @ Xx3) @ Xc_x) = Xc_1))) => (Xph => (cwcel @ XR @ ccdr)))))))))))))))))))).
