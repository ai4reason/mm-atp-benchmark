...
thf(ashftfn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (((cwfn @ XF @ XB2) & (cwcel @ XA2 @ ccc)) => (cwfn @ (cco @ XF @ XA2 @ ccshi) @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ XB2)) @ (^ [Xx3:$i] : ccc))))))))).
...
thf(ashftuz_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccz)) => ((ccrab @ (^ [Xx3:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ (ccfv @ XB2 @ ccuz))) @ (^ [Xx3:$i] : ccc)) = (ccfv @ (cco @ XB2 @ XA2 @ ccaddc) @ ccuz)))))).
...
thf(ashftval_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccfv @ XB2 @ (cco @ XF @ XA2 @ ccshi)) = (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ XF)))))))).
thf(aancoms_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) => Xch) => ((Xps & Xph) => Xch)))))).
thf(cseqshft_conj,conjecture,(! [Xc_pl:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XF @ ccvv) => (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((ccseq @ Xc_pl @ (cco @ XF @ XN @ ccshi) @ XM) = (cco @ (ccseq @ Xc_pl @ XF @ (cco @ XM @ XN @ ccmin)) @ XN @ ccshi))))))))).
