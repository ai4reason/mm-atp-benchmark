...
thf(alidlrng_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((XL = (ccfv @ XR @ cclidl)) => ((XI = (cco @ XR @ XU @ ccress)) => (((cwcel @ XR @ ccrg) & (cwcel @ XU @ XL)) => (cwcel @ XI @ ccrng))))))))).
...
thf(alidlbas_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((XL = (ccfv @ XR @ cclidl)) => ((XI = (cco @ XR @ XU @ ccress)) => ((cwcel @ XU @ XL) => ((ccfv @ XI @ ccbs) = XU))))))))).
...
thf(aisringrng_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((cwcel @ XR @ ccrg) <=> ((cwcel @ XR @ ccrng) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_x) = (ccv @ Xy1)) & ((cco @ (ccv @ Xy1) @ (ccv @ Xx3) @ Xc_x) = (ccv @ Xy1)))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XB2)))))))))).
thf(czlidlring_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_0:($i > $o)] : ((XL = (ccfv @ XR @ cclidl)) => ((XI = (cco @ XR @ XU @ ccress)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccrg) & (XU = (ccsn @ Xc_0))) => (cwcel @ XI @ ccrg))))))))))))).
