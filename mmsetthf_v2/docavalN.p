...
thf(cdocavalN_conj,conjecture,(! [XT:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_an:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [Xc_pe:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((! [Xz:$i] : ((Xc_or @ Xz) = (ccfv @ XK @ ccjn))) => ((! [Xz:$i] : ((Xc_an @ Xz) = (ccfv @ XK @ ccmee))) => ((! [Xz:$i] : ((Xc_pe @ Xz) = (ccfv @ XK @ ccoc))) => ((! [Xz:$i] : ((XH @ Xz) = (ccfv @ XK @ cclh))) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdia))) => ((! [Xz:$i] : ((XN @ Xz) = (ccfv @ XW @ (ccfv @ XK @ ccocaN)))) => (! [Xz:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ (XH @ Xz))) & (cwss @ XX @ XT)) => ((ccfv @ XX @ (XN @ Xz)) = (ccfv @ (cco @ (cco @ (ccfv @ (ccfv @ (ccint @ (ccrab @ (^ [Xz:$i] : (cwss @ XX @ (ccv @ Xz))) @ (^ [Xz:$i] : (ccrn @ XI)))) @ (cccnv @ XI)) @ (Xc_pe @ Xz)) @ (ccfv @ XW @ (Xc_pe @ Xz)) @ (Xc_or @ Xz)) @ XW @ (Xc_an @ Xz)) @ XI)))))))))))))))))))))).
