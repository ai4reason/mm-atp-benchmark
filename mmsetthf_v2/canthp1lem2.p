...
thf(ainfcda1_ax,axiom,(! [XA2:($i > $o)] : ((cwbr @ ccom @ XA2 @ ccdom) => (cwbr @ (cco @ XA2 @ cc1o @ cccda) @ XA2 @ ccen)))).
thf(a_2onn_ax,axiom,(cwcel @ cc2o @ ccom)).
thf(annsdom_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccom) => (cwbr @ XA2 @ ccom @ ccsdm)))).
thf(acdafi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwbr @ XA2 @ ccom @ ccsdm) & (cwbr @ XB2 @ ccom @ ccsdm)) => (cwbr @ (cco @ XA2 @ XB2 @ cccda) @ ccom @ ccsdm))))).
