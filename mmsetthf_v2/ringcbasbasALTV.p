...
thf(cringcbasbasALTV_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : ((XC = (ccfv @ XU @ ccringcALTV)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XU @ ccwun)) => ((Xph & (cwcel @ XR @ XB2)) => (cwcel @ (ccfv @ XR @ ccbs) @ XU))))))))))).
