...
thf(aleibpilem1_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & ((~ (XN = ccc0)) & (~ (cwbr @ cc2 @ XN @ ccdvds)))) => ((cwcel @ XN @ ccn) & (cwcel @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn0))))).
...
thf(aiseralt_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwf @ XZ @ ccr @ XG)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwbr @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XG) @ (ccfv @ (ccv @ Xk) @ XG) @ ccle))) => ((Xph => (cwbr @ XG @ ccc0 @ ccli)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XF) = (cco @ (cco @ (ccneg @ cc1) @ (ccv @ Xk) @ ccexp) @ (ccfv @ (ccv @ Xk) @ XG) @ ccmul)))) => (Xph => (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli))))))))))))))).
...
thf(aabelth2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((Xph => (cwf @ ccn0 @ ccc @ XA2)) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XA2 @ ccc0) @ (ccdm @ ccli))) => ((! [Xx3:$i] : (! [Xn:$i] : ((XF @ Xx3 @ Xn) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccsu @ ccn0 @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ XA2) @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccexp) @ ccmul)))))))) => (! [Xx3:$i] : (! [Xn:$i] : (Xph => (cwcel @ (XF @ Xx3 @ Xn) @ (cco @ (cco @ ccc0 @ cc1 @ ccicc) @ ccc @ cccncf)))))))))))).
...
thf(aatancn_ax,axiom,(! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((! [Xy1:$i] : ((XS @ Xy1) = (ccrab @ (^ [Xy1:$i] : (cwcel @ (cco @ cc1 @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ XD)) @ (^ [Xy1:$i] : ccc)))) => (! [Xy1:$i] : (cwcel @ (ccres @ ccatan @ (XS @ Xy1)) @ (cco @ (XS @ Xy1) @ ccc @ cccncf)))))))).
...
thf(aressatans_ax,axiom,(! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((! [Xy1:$i] : ((XS @ Xy1) = (ccrab @ (^ [Xy1:$i] : (cwcel @ (cco @ cc1 @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ XD)) @ (^ [Xy1:$i] : ccc)))) => (! [Xy1:$i] : (cwss @ ccr @ (XS @ Xy1)))))))).
...
thf(aatan1_ax,axiom,((ccfv @ cc1 @ ccatan) = (cco @ ccpi @ cc4 @ ccdiv))).
