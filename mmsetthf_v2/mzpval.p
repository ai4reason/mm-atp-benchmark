...
thf(amzpcln0_ax,axiom,(! [XV:($i > $o)] : ((cwcel @ XV @ ccvv) => (cwne @ (ccfv @ XV @ ccmzpcl) @ cc0)))).
...
thf(adf_mzp_ax,axiom,(ccmzp = (ccmpt @ (^ [Xv:$i] : ccvv) @ (^ [Xv:$i] : (ccint @ (ccfv @ (ccv @ Xv) @ ccmzpcl)))))).
thf(cmzpval_conj,conjecture,(! [XV:($i > $o)] : ((cwcel @ XV @ ccvv) => ((ccfv @ XV @ ccmzp) = (ccint @ (ccfv @ XV @ ccmzpcl)))))).
