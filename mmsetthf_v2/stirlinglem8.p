...
thf(aclimdivf_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XG @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XH @ Xk))) => ((! [Xk:$i] : (XZ = (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XM @ Xk) @ ccz))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwbr @ (XF @ Xk) @ (XA2 @ Xk) @ ccli))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XH @ Xk) @ (XX @ Xk)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwbr @ (XG @ Xk) @ (XB2 @ Xk) @ ccli))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwne @ (XB2 @ Xk) @ ccc0))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ (XF @ Xk)) @ ccc))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ (XG @ Xk)) @ (ccdif @ ccc @ (ccsn @ ccc0))))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ (XH @ Xk)) = (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xk)) @ (ccfv @ (ccv @ Xk) @ (XG @ Xk)) @ ccdiv)))) => (! [Xk:$i] : ((Xph @ Xk) => (cwbr @ (XH @ Xk) @ (cco @ (XA2 @ Xk) @ (XB2 @ Xk) @ ccdiv) @ ccli)))))))))))))))))))))))))).
