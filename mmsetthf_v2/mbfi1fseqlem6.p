...
thf(ambfi1fseqlem4_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > $o)))] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XJ @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xm:$i] : (^ [Xy1:$i] : ccn)) @ (^ [Xm:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xm:$i] : (^ [Xy1:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccmul) @ ccfl) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccdiv))))))) => ((! [Xy1:$i] : (! [Xm:$i] : ((XG @ Xy1 @ Xm) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (cco @ (ccneg @ (ccv @ Xm)) @ (ccv @ Xm) @ ccicc)) @ (ccif @ (cwbr @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ (ccv @ Xm) @ ccle) @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ (ccv @ Xm)) @ ccc0)))))))) => (! [Xy1:$i] : (! [Xm:$i] : (Xph => (cwf @ ccn @ (ccdm @ ccitg1) @ (XG @ Xy1 @ Xm)))))))))))))).
thf(aralrimiva_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => (Xps @ Xx3))) => (Xph => (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))).
thf(ambfi1fseqlem5_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > $o)))] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XJ @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xm:$i] : (^ [Xy1:$i] : ccn)) @ (^ [Xm:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xm:$i] : (^ [Xy1:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccmul) @ ccfl) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccdiv))))))) => ((! [Xy1:$i] : (! [Xm:$i] : ((XG @ Xy1 @ Xm) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (cco @ (ccneg @ (ccv @ Xm)) @ (ccv @ Xm) @ ccicc)) @ (ccif @ (cwbr @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ (ccv @ Xm) @ ccle) @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ (ccv @ Xm)) @ ccc0)))))))) => (! [Xy1:$i] : (! [Xm:$i] : ((Xph & (cwcel @ XA2 @ ccn)) => ((cwbr @ cc0p @ (ccfv @ XA2 @ (XG @ Xy1 @ Xm)) @ (ccofr @ ccle)) & (cwbr @ (ccfv @ XA2 @ (XG @ Xy1 @ Xm)) @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ (XG @ Xy1 @ Xm)) @ (ccofr @ ccle)))))))))))))))).
...
thf(aclimsubc2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwbr @ XF @ XA2 @ ccli)) => ((Xph => (cwcel @ XC @ ccc)) => ((! [Xk:$i] : (Xph => (cwcel @ XG @ (XW @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XG) = (cco @ XC @ (ccfv @ (ccv @ Xk) @ XF) @ ccmin)))) => (Xph => (cwbr @ XG @ (cco @ XC @ XA2 @ ccmin) @ ccli)))))))))))))))))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(annuz_ax,axiom,(ccn = (ccfv @ cc1 @ ccuz))).
thf(a_1zzd_ax,axiom,(! [Xph:$o] : (Xph => (cwcel @ cc1 @ ccz)))).
thf(aexpcnv_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XA2 @ ccc))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt))) => (! [Xn:$i] : ((Xph @ Xn) => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ XA2 @ (ccv @ Xn) @ ccexp))) @ ccc0 @ ccli)))))))).
...
thf(aexprecd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwne @ XA2 @ ccc0)) => ((Xph => (cwcel @ XN @ ccz)) => (Xph => ((cco @ (cco @ cc1 @ XA2 @ ccdiv) @ XN @ ccexp) = (cco @ cc1 @ (cco @ XA2 @ XN @ ccexp) @ ccdiv)))))))))).
...
thf(alediv1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ ((cwcel @ XC @ ccr) & (cwbr @ ccc0 @ XC @ cclt))) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwbr @ (cco @ XA2 @ XC @ ccdiv) @ (cco @ XB2 @ XC @ ccdiv) @ ccle))))))).
thf(a_3eqtrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XB2 = XC)) => ((Xph => (XC = XD)) => (Xph => (XA2 = XD))))))))))).
thf(ambfi1fseqlem2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > $o)))] : ((Xph => (cwcel @ XF @ ccmbf)) => ((Xph => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XJ @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xm:$i] : (^ [Xy1:$i] : ccn)) @ (^ [Xm:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xm:$i] : (^ [Xy1:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccmul) @ ccfl) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccdiv))))))) => ((! [Xy1:$i] : (! [Xm:$i] : ((XG @ Xy1 @ Xm) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (cco @ (ccneg @ (ccv @ Xm)) @ (ccv @ Xm) @ ccicc)) @ (ccif @ (cwbr @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ (ccv @ Xm) @ ccle) @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ (ccv @ Xm)) @ ccc0)))))))) => (! [Xy1:$i] : (! [Xm:$i] : ((cwcel @ XA2 @ ccn) => ((ccfv @ XA2 @ (XG @ Xy1 @ Xm)) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (cco @ (ccneg @ XA2) @ XA2 @ ccicc)) @ (ccif @ (cwbr @ (cco @ XA2 @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ XA2 @ ccle) @ (cco @ XA2 @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1)) @ XA2) @ ccc0))))))))))))))))).
...
thf(cmbfi1fseqlem6_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XJ:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xg1:$i] : ((Xph @ Xg1) => (cwcel @ XF @ ccmbf))) => ((! [Xg1:$i] : ((Xph @ Xg1) => (cwf @ ccr @ (cco @ ccc0 @ ccpnf @ ccico) @ XF))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xg1:$i] : (! [Xn:$i] : ((XJ @ Xx3 @ Xy1 @ Xg1 @ Xn) = (ccmpt2 @ (^ [Xm:$i] : (^ [Xy1:$i] : ccn)) @ (^ [Xm:$i] : (^ [Xy1:$i] : ccr)) @ (^ [Xm:$i] : (^ [Xy1:$i] : (cco @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccmul) @ ccfl) @ (cco @ cc2 @ (ccv @ Xm) @ ccexp) @ ccdiv))))))))) => ((! [Xy1:$i] : (! [Xg1:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XG @ Xy1 @ Xm) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ (cco @ (ccneg @ (ccv @ Xm)) @ (ccv @ Xm) @ ccicc)) @ (ccif @ (cwbr @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1 @ Xg1 @ Xn)) @ (ccv @ Xm) @ ccle) @ (cco @ (ccv @ Xm) @ (ccv @ Xx3) @ (XJ @ Xx3 @ Xy1 @ Xg1 @ Xn)) @ (ccv @ Xm)) @ ccc0)))))))))) => (! [Xg1:$i] : ((Xph @ Xg1) => (? [Xg1:$i] : (cw3a @ (cwf @ ccn @ (ccdm @ ccitg1) @ (ccv @ Xg1)) @ (cwral @ (^ [Xn:$i] : ((cwbr @ cc0p @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ (ccofr @ ccle)) & (cwbr @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1)) @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ (ccv @ Xg1)) @ (ccofr @ ccle)))) @ (^ [Xn:$i] : ccn)) @ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xn) @ (ccv @ Xg1))))) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccli)) @ (^ [Xx3:$i] : ccr))))))))))))))).
