...
thf(acplgr0v_ax,axiom,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => (((cwcel @ XG @ XW) & (XV = cc0)) => (cwcel @ XG @ cccplgr))))))).
thf(aiscusgr_ax,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ cccusgr) <=> ((cwcel @ XG @ ccusgr) & (cwcel @ XG @ cccplgr))))).
thf(ccusgr0v_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cw3a @ (cwcel @ XG @ XW) @ (XV = cc0) @ ((ccfv @ XG @ cciedg) = cc0)) => (cwcel @ XG @ cccusgr))))))).
