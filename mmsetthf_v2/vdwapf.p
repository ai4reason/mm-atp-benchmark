...
thf(avdwapfval_ax,axiom,(! [XK:($i > $o)] : ((cwcel @ XK @ ccn0) => ((ccfv @ XK @ ccvdwa) = (ccmpt2 @ (^ [Xa:$i] : (^ [Xd:$i] : ccn)) @ (^ [Xa:$i] : (^ [Xd:$i] : ccn)) @ (^ [Xa:$i] : (^ [Xd:$i] : (ccrn @ (ccmpt @ (^ [Xm:$i] : (cco @ ccc0 @ (cco @ XK @ cc1 @ ccmin) @ ccfz)) @ (^ [Xm:$i] : (cco @ (ccv @ Xa) @ (cco @ (ccv @ Xm) @ (ccv @ Xd) @ ccmul) @ ccaddc))))))))))).
thf(cvdwapf_conj,conjecture,(! [XK:($i > $o)] : ((cwcel @ XK @ ccn0) => (cwf @ (ccxp @ ccn @ ccn) @ (ccpw @ ccn) @ (ccfv @ XK @ ccvdwa))))).
