...
thf(algseisenlem1_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((Xph => (cwcel @ XQ @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((Xph => (cwne @ XP @ XQ)) => ((! [Xx3:$i] : ((XR @ Xx3) = (cco @ (cco @ XQ @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul) @ ccmul) @ XP @ ccmo))) => ((! [Xx3:$i] : ((XM @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz)) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (cco @ (ccneg @ cc1) @ (XR @ Xx3) @ ccexp) @ (XR @ Xx3) @ ccmul) @ XP @ ccmo) @ cc2 @ ccdiv))))) => (! [Xx3:$i] : (Xph => (cwf @ (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz) @ (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz) @ (XM @ Xx3))))))))))))))).
...
thf(clgseisenlem2_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((Xph => (cwcel @ XQ @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((Xph => (cwne @ XP @ XQ)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XR @ Xx3 @ Xy1) = (cco @ (cco @ XQ @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul) @ ccmul) @ XP @ ccmo)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XM @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz)) @ (^ [Xx3:$i] : (cco @ (cco @ (cco @ (cco @ (ccneg @ cc1) @ (XR @ Xx3 @ Xy1) @ ccexp) @ (XR @ Xx3 @ Xy1) @ ccmul) @ XP @ ccmo) @ cc2 @ ccdiv)))))) => ((! [Xy1:$i] : ((XS @ Xy1) = (cco @ (cco @ XQ @ (cco @ cc2 @ (ccv @ Xy1) @ ccmul) @ ccmul) @ XP @ ccmo))) => (! [Xx3:$i] : (Xph => (cwf1o @ (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz) @ (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz) @ (XM @ Xx3))))))))))))))))).
