...
thf(cdgrlt_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XN = (ccfv @ XF @ ccdgr)) => ((XA2 = (ccfv @ XF @ cccoe)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XM @ ccn0)) => (((XF = cc0p) | (cwbr @ XN @ XM @ cclt)) <=> ((cwbr @ XN @ XM @ ccle) & ((ccfv @ XM @ XA2) = ccc0)))))))))))).
