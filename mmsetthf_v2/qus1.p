...
thf(aablnsg_ax,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ ccabl) => ((ccfv @ XG @ ccnsg) = (ccfv @ XG @ ccsubg))))).
...
thf(cqus1_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : ((XU = (cco @ XR @ (cco @ XR @ XS @ ccqg) @ ccqus)) => ((XI = (ccfv @ XR @ cc2idl)) => ((Xc_1 = (ccfv @ XR @ ccur)) => (((cwcel @ XR @ ccrg) & (cwcel @ XS @ XI)) => ((cwcel @ XU @ ccrg) & ((ccec @ Xc_1 @ (cco @ XR @ XS @ ccqg)) = (ccfv @ XU @ ccur))))))))))))).
