...
thf(aasinrecl_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ (ccneg @ cc1) @ cc1 @ ccicc)) => (cwcel @ (ccfv @ XA2 @ ccasin) @ ccr)))).
thf(aresubcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ ccr))))).
thf(cacosrecl_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ (ccneg @ cc1) @ cc1 @ ccicc)) => (cwcel @ (ccfv @ XA2 @ ccacos) @ ccr)))).
