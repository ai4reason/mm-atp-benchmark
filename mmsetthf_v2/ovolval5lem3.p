...
thf(ainfleinf_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwss @ XA2 @ ccxr)) => ((Xph => (cwss @ XB2 @ ccxr)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwcel @ (ccv @ Xy1) @ ccrp)) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccxad) @ ccle)) @ (^ [Xz:$i] : XA2))))) => (Xph => (cwbr @ (ccinf @ XA2 @ ccxr @ cclt) @ (ccinf @ XB2 @ ccxr @ cclt) @ ccle))))))))).
...
thf(aovolval5lem2_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > $o))] : (! [XQ:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XY:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > $o))] : ((! [Xf1:$i] : (! [Xn:$i] : ((XQ @ Xf1 @ Xn) = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xf1:$i] : ((cwss @ (XA2 @ Xn) @ (ccuni @ (ccrn @ (cccom @ ccioo @ (ccv @ Xf1))))) & ((ccv @ Xz) = (ccfv @ (cccom @ (cccom @ ccvol @ ccioo) @ (ccv @ Xf1)) @ ccsumge0)))) @ (^ [Xf1:$i] : (cco @ (ccxp @ ccr @ ccr) @ ccn @ ccmap)))) @ (^ [Xz:$i] : ccxr))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xz @ Xf1) => ((XY @ Xf1 @ Xn) = (ccfv @ (cccom @ (cccom @ ccvol @ ccico) @ (XF @ Xz @ Xf1)) @ ccsumge0)))))) => ((! [Xz:$i] : (! [Xn:$i] : ((XZ @ Xn) = (ccfv @ (cccom @ (cccom @ ccvol @ ccioo) @ (XG @ Xz)) @ ccsumge0)))) => ((! [Xz:$i] : (! [Xf1:$i] : ((Xph @ Xz @ Xf1) => (cwf @ ccn @ (ccxp @ ccr @ ccr) @ (XF @ Xz @ Xf1))))) => ((! [Xz:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xz @ Xf1) => (cwss @ (XA2 @ Xn) @ (ccuni @ (ccrn @ (cccom @ ccico @ (XF @ Xz @ Xf1))))))))) => ((! [Xz:$i] : (! [Xf1:$i] : ((Xph @ Xz @ Xf1) => (cwcel @ (XW @ Xf1) @ ccrp)))) => ((! [Xz:$i] : (! [Xf1:$i] : ((XG @ Xz) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccop @ (cco @ (ccfv @ (ccfv @ (ccv @ Xn) @ (XF @ Xz @ Xf1)) @ cc1st) @ (cco @ (XW @ Xf1) @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccmin) @ (ccfv @ (ccfv @ (ccv @ Xn) @ (XF @ Xz @ Xf1)) @ cc2nd))))))) => (! [Xz:$i] : (! [Xf1:$i] : (! [Xn:$i] : ((Xph @ Xz @ Xf1) => (cwrex @ (^ [Xz:$i] : (cwbr @ (ccv @ Xz) @ (cco @ (XY @ Xf1 @ Xn) @ (XW @ Xf1) @ ccxad) @ ccle)) @ (^ [Xz:$i] : (XQ @ Xf1 @ Xn))))))))))))))))))))))).
...
thf(avoliooicof_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ (ccxp @ ccr @ ccr) @ XF)) => (Xph => ((cccom @ (cccom @ ccvol @ ccioo) @ XF) = (cccom @ (cccom @ ccvol @ ccico) @ XF)))))))).
