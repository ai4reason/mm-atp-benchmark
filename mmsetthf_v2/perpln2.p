...
thf(abrelrng_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XF) @ (cwcel @ XB2 @ XG) @ (cwbr @ XA2 @ XB2 @ XC)) => (cwcel @ XB2 @ (ccrn @ XC))))))))).
thf(cperpln2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwbr @ XA2 @ XB2 @ (ccfv @ XG @ ccperpg))) => (Xph => (cwcel @ XB2 @ (ccrn @ XL)))))))))))).
