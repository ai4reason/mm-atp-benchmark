...
thf(cfsummmodsnunz_conj,conjecture,(! [Xz:$i] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccfn) @ (cwcel @ XN @ ccn) @ (cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xk) @ ccz)) @ (^ [Xk:$i] : (ccun @ XA2 @ (ccsn @ (ccv @ Xz)))))) => (cwcel @ (ccsu @ (ccun @ XA2 @ (ccsn @ (ccv @ Xz))) @ (^ [Xk:$i] : (cco @ (XB2 @ Xk) @ XN @ ccmo))) @ ccz))))))).
