...
thf(apell1qrge1_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) & (cwcel @ XA2 @ (ccfv @ XD @ ccpell1qr))) => (cwbr @ cc1 @ XA2 @ ccle))))).
...
thf(alerec2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ cclt)) & ((cwcel @ XB2 @ ccr) & (cwbr @ ccc0 @ XB2 @ cclt))) => ((cwbr @ XA2 @ (cco @ cc1 @ XB2 @ ccdiv) @ ccle) <=> (cwbr @ XB2 @ (cco @ cc1 @ XA2 @ ccdiv) @ ccle)))))).
...
thf(apell14qrdich_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) & (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr))) => ((cwcel @ XA2 @ (ccfv @ XD @ ccpell1qr)) | (cwcel @ (cco @ cc1 @ XA2 @ ccdiv) @ (ccfv @ XD @ ccpell1qr))))))).
thf(aorel2_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((~ Xph) => ((Xps | Xph) => Xps))))).
thf(aeqeltrrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (cwcel @ XA2 @ XC)) => (Xph => (cwcel @ XB2 @ XC))))))))).
thf(asimpr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(aad2antrr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => (((Xph & Xch) & Xth) => Xps))))))).
thf(apell1qr1_ax,axiom,(! [XD:($i > $o)] : ((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) => (cwcel @ cc1 @ (ccfv @ XD @ ccpell1qr))))).
thf(celpell1qr2_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) => ((cwcel @ XA2 @ (ccfv @ XD @ ccpell1qr)) <=> ((cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) & (cwbr @ cc1 @ XA2 @ ccle))))))).
