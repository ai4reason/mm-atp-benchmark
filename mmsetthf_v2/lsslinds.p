...
thf(asyl3an3br_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xth <=> Xph) => (((cw3a @ Xps @ Xch @ Xth) => Xta) => ((cw3a @ Xps @ Xch @ Xph) => Xta))))))))).
...
thf(alsslindf_ax,axiom,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XU = (ccfv @ XW @ cclss)) => ((XX = (cco @ XW @ XS @ ccress)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XS @ XU) @ (cwss @ (ccrn @ XF) @ XS)) => ((cwbr @ XF @ XX @ cclindf) <=> (cwbr @ XF @ XW @ cclindf))))))))))).
...
thf(aislinds_ax,axiom,(! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((cwcel @ XW @ XV) => ((cwcel @ XX @ (ccfv @ XW @ cclinds)) <=> ((cwss @ XX @ XB2) & (cwbr @ (ccres @ ccid @ XX) @ XW @ cclindf)))))))))).
thf(a_3ad2ant1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xch) => ((cw3a @ Xph @ Xps @ Xth) => Xch))))))).
thf(clsslinds_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XU = (ccfv @ XW @ cclss)) => ((XX = (cco @ XW @ XS @ ccress)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XS @ XU) @ (cwss @ XF @ XS)) => ((cwcel @ XF @ (ccfv @ XX @ cclinds)) <=> (cwcel @ XF @ (ccfv @ XW @ cclinds)))))))))))).
