...
thf(cdiv32_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ ((cwcel @ XB2 @ ccc) & (cwne @ XB2 @ ccc0)) @ (cwcel @ XC @ ccc)) => ((cco @ (cco @ XA2 @ XB2 @ ccdiv) @ XC @ ccmul) = (cco @ XA2 @ (cco @ XC @ XB2 @ ccdiv) @ ccmul))))))).
