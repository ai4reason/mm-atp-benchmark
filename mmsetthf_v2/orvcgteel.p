...
thf(aorrvccel_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ (XP @ Xy1) @ ccprb))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XX @ (ccfv @ (XP @ Xy1) @ ccrrv)))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XA2 @ (XV @ Xy1)))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ XA2 @ XR)) @ (^ [Xy1:$i] : ccr)) @ (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld)))) => (! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ (cco @ XX @ XA2 @ (ccorvc @ XR)) @ (ccdm @ (XP @ Xy1)))))))))))))))).
...
thf(aicoval_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cco @ XA2 @ XB2 @ ccico) = (ccrab @ (^ [Xx3:$i] : ((cwbr @ XA2 @ (ccv @ Xx3) @ ccle) & (cwbr @ (ccv @ Xx3) @ XB2 @ cclt))) @ (^ [Xx3:$i] : ccxr))))))).
...
thf(corvcgteel_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XP @ ccprb)) => ((Xph => (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => (cwcel @ (cco @ XX @ XA2 @ (ccorvc @ (cccnv @ ccle))) @ (ccdm @ XP))))))))))).
