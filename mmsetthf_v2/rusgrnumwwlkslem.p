...
thf(crusgrnumwwlkslem_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XY @ (ccrab @ (^ [Xw:$i] : ((ccfv @ ccc0 @ (ccv @ Xw)) = XP)) @ (^ [Xw:$i] : XZ))) => ((ccrab @ (^ [Xw:$i] : ((Xph @ Xw) & (Xps @ Xw))) @ (^ [Xw:$i] : (XX @ Xw))) = (ccrab @ (^ [Xw:$i] : (cw3a @ (Xph @ Xw) @ ((ccfv @ ccc0 @ XY) = XP) @ (Xps @ Xw))) @ (^ [Xw:$i] : (XX @ Xw)))))))))))).
