...
thf(apwdif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc)) => ((cco @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XB2 @ XN @ ccexp) @ ccmin) = (cco @ (cco @ XA2 @ XB2 @ ccmin) @ (ccsu @ (cco @ ccc0 @ XN @ ccfzo) @ (^ [Xk:$i] : (cco @ (cco @ XA2 @ (ccv @ Xk) @ ccexp) @ (cco @ XB2 @ (cco @ (cco @ XN @ (ccv @ Xk) @ ccmin) @ cc1 @ ccmin) @ ccexp) @ ccmul))) @ ccmul))))))).
...
thf(cpwm1geoserALT_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((cco @ (cco @ XA2 @ XN @ ccexp) @ cc1 @ ccmin) = (cco @ (cco @ XA2 @ cc1 @ ccmin) @ (ccsu @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (cco @ XA2 @ (ccv @ Xk) @ ccexp))) @ ccmul))))))))).
