...
thf(aim0_ax,axiom,((ccfv @ ccc0 @ ccim) = ccc0)).
...
thf(aimmul2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccc)) => (Xph => ((ccfv @ (cco @ XA2 @ XB2 @ ccmul) @ ccim) = (cco @ XA2 @ (ccfv @ XB2 @ ccim) @ ccmul))))))))).
...
thf(altmul2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccrp)) => (Xph => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (cco @ XC @ XA2 @ ccmul) @ (cco @ XC @ XB2 @ ccmul) @ cclt))))))))))).
thf(aa1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(cc1_tp,type,(cc1 : ($i > $o))).
thf(a_0re_ax,axiom,(cwcel @ ccc0 @ ccr)).
thf(aefiarg_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ XA2 @ ccc0)) => ((ccfv @ (cco @ cci @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ ccmul) @ cce) = (cco @ XA2 @ (ccfv @ XA2 @ ccabs) @ ccdiv))))).
thf(cc2_tp,type,(cc2 : ($i > $o))).
thf(aresinval_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((ccfv @ XA2 @ ccsin) = (ccfv @ (ccfv @ (cco @ cci @ XA2 @ ccmul) @ cce) @ ccim))))).
...
thf(asinq12ge0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ ccpi @ ccicc)) => (cwbr @ ccc0 @ (ccfv @ XA2 @ ccsin) @ ccle)))).
thf(cccos_tp,type,(cccos : ($i > $o))).
thf(asinppi_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (cco @ XA2 @ ccpi @ ccaddc) @ ccsin) = (ccneg @ (ccfv @ XA2 @ ccsin)))))).
...
thf(anegneg_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccneg @ (ccneg @ XA2)) = XA2)))).
...
thf(cargimgt0_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwbr @ ccc0 @ (ccfv @ XA2 @ ccim) @ cclt)) => (cwcel @ (ccfv @ (ccfv @ XA2 @ cclog) @ ccim) @ (cco @ ccc0 @ ccpi @ ccioo))))).
