...
thf(aply1lss_ax,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XS = (ccfv @ XR @ ccps1)) => ((XU = (ccfv @ XP @ ccbs)) => ((cwcel @ XR @ ccrg) => (cwcel @ XU @ (ccfv @ XS @ cclss))))))))))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(asyl3anc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xps) => ((Xph => Xch) => ((Xph => Xth) => (((cw3a @ Xps @ Xch @ Xth) => Xta) => (Xph => Xta))))))))))).
thf(apsr1assa_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : ((XS = (ccfv @ XR @ ccps1)) => ((cwcel @ XR @ cccrg) => (cwcel @ XS @ ccasa)))))).
...
thf(aissubassa_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XS = (cco @ XW @ XA2 @ ccress)) => ((XL = (ccfv @ XW @ cclss)) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_1 = (ccfv @ XW @ ccur)) => ((cw3a @ (cwcel @ XW @ ccasa) @ (cwcel @ Xc_1 @ XA2) @ (cwss @ XA2 @ XV)) => ((cwcel @ XS @ ccasa) <=> ((cwcel @ XA2 @ (ccfv @ XW @ ccsubrg)) & (cwcel @ XA2 @ XL))))))))))))))).
...
thf(cply1assa_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((cwcel @ XR @ cccrg) => (cwcel @ XP @ ccasa)))))).
