...
thf(almatval_ax,axiom,(! [XM:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xi:$i] : (! [Xj:$i] : ((cwcel @ XM @ (XV @ Xi @ Xj)) => ((ccfv @ XM @ cclmat) = (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ cc1 @ (ccfv @ XM @ cchash) @ ccfz))) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ cc1 @ (ccfv @ (ccfv @ ccc0 @ XM) @ cchash) @ ccfz))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccfv @ (cco @ (ccv @ Xj) @ cc1 @ ccmin) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccmin) @ XM)))))))))))).
...
thf(afz1fzo0m1_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XM @ (cco @ cc1 @ XN @ ccfz)) => (cwcel @ (cco @ XM @ cc1 @ ccmin) @ (cco @ ccc0 @ XN @ ccfzo)))))).
