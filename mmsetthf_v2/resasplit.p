...
thf(cresasplit_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cw3a @ (cwfn @ XF @ XA2) @ (cwfn @ XG @ XB2) @ ((ccres @ XF @ (ccin @ XA2 @ XB2)) = (ccres @ XG @ (ccin @ XA2 @ XB2)))) => ((ccun @ XF @ XG) = (ccun @ (ccres @ XF @ (ccin @ XA2 @ XB2)) @ (ccun @ (ccres @ XF @ (ccdif @ XA2 @ XB2)) @ (ccres @ XG @ (ccdif @ XB2 @ XA2))))))))))).
