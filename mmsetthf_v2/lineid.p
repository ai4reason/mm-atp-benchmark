...
thf(clineid_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ ((cwcel @ XA2 @ (ccfv @ XN @ ccee)) & (cwcel @ XB2 @ (ccfv @ XN @ ccee))) @ ((cwcel @ XC @ (ccfv @ XN @ ccee)) & (cwcel @ XD @ (ccfv @ XN @ ccee)))) => ((((cwne @ XA2 @ XB2) & (cwbr @ XA2 @ (ccop @ XB2 @ XC) @ cccolin)) & ((cwbr @ (ccop @ XA2 @ XC) @ (ccop @ XA2 @ XD) @ cccgr) & (cwbr @ (ccop @ XB2 @ XC) @ (ccop @ XB2 @ XD) @ cccgr))) => (XC = XD))))))))).
