...
thf(confrALTlem1_conj,conjecture,(! [Xa:$i] : (! [Xx3:$i] : (((cwss @ (ccv @ Xa) @ ccon0) & (cwne @ (ccv @ Xa) @ cc0)) => (((cwcel @ (ccv @ Xx3) @ (ccv @ Xa)) & ((ccin @ (ccv @ Xa) @ (ccv @ Xx3)) = cc0)) => (cwrex @ (^ [Xy1:$i] : ((ccin @ (ccv @ Xa) @ (ccv @ Xy1)) = cc0)) @ (^ [Xy1:$i] : (ccv @ Xa)))))))).
