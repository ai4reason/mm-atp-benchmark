...
thf(ardglimg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XB2 @ (ccdm @ (ccrdg @ XF @ XA2))) & (cwlim @ XB2)) => ((ccfv @ XB2 @ (ccrdg @ XF @ XA2)) = (ccuni @ (ccima @ (ccrdg @ XF @ XA2) @ XB2)))))))).
thf(crdglim_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XB2 @ XC) & (cwlim @ XB2)) => ((ccfv @ XB2 @ (ccrdg @ XF @ XA2)) = (ccuni @ (ccima @ (ccrdg @ XF @ XA2) @ XB2))))))))).
