...
thf(ccusgrrusgr_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cw3a @ (cwcel @ XG @ cccusgr) @ (cwcel @ XV @ ccfn) @ (cwne @ XV @ cc0)) => (cwbr @ XG @ (cco @ (ccfv @ XV @ cchash) @ cc1 @ ccmin) @ ccrusgr)))))).
