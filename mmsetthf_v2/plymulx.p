...
thf(aplymul02_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (ccfv @ XS @ ccply)) => ((cco @ cc0p @ XF @ (ccof @ ccmul)) = cc0p))))).
...
thf(aplymulx0_ax,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdif @ (ccfv @ ccr @ ccply) @ (ccsn @ cc0p))) => ((ccfv @ (cco @ XF @ ccidp @ (ccof @ ccmul)) @ cccoe) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ ccc0 @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ (ccfv @ XF @ cccoe))))))))).
