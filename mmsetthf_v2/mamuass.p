...
thf(agsumcom3fi_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xph => (cwcel @ XG @ cccmn)) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwcel @ XC @ ccfn)) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph & ((cwcel @ (ccv @ Xj) @ XA2) & (cwcel @ (ccv @ Xk) @ XC))) => (cwcel @ (XX @ Xj @ Xk) @ XB2)))) => (Xph => ((cco @ XG @ (ccmpt @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (cco @ XG @ (ccmpt @ (^ [Xk:$i] : XC) @ (^ [Xk:$i] : (XX @ Xj @ Xk))) @ ccgsu))) @ ccgsu) = (cco @ XG @ (ccmpt @ (^ [Xk:$i] : XC) @ (^ [Xk:$i] : (cco @ XG @ (ccmpt @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (XX @ Xj @ Xk))) @ ccgsu))) @ ccgsu))))))))))))))).
...
thf(cmamuass_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XM @ ccfn)) => ((Xph => (cwcel @ XN @ ccfn)) => ((Xph => (cwcel @ XO @ ccfn)) => ((Xph => (cwcel @ XP @ ccfn)) => ((Xph => (cwcel @ XX @ (cco @ XB2 @ (ccxp @ XM @ XN) @ ccmap))) => ((Xph => (cwcel @ XY @ (cco @ XB2 @ (ccxp @ XN @ XO) @ ccmap))) => ((Xph => (cwcel @ XZ @ (cco @ XB2 @ (ccxp @ XO @ XP) @ ccmap))) => ((XF = (cco @ XR @ (ccotp @ XM @ XN @ XO) @ ccmmul)) => ((XG = (cco @ XR @ (ccotp @ XM @ XO @ XP) @ ccmmul)) => ((XH = (cco @ XR @ (ccotp @ XM @ XN @ XP) @ ccmmul)) => ((XI = (cco @ XR @ (ccotp @ XN @ XO @ XP) @ ccmmul)) => (Xph => ((cco @ (cco @ XX @ XY @ XF) @ XZ @ XG) = (cco @ XX @ (cco @ XY @ XZ @ XI) @ XH))))))))))))))))))))))))))))))).
