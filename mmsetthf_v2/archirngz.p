...
thf(aogrpinv0lt_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_lt = (ccfv @ XG @ ccplt)) => ((XI = (ccfv @ XG @ ccminusg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cwcel @ XG @ ccogrp) & (cwcel @ XX @ XB2)) => ((cwbr @ Xc_0 @ XX @ Xc_lt) <=> (cwbr @ (ccfv @ XX @ XI) @ Xc_0 @ Xc_lt)))))))))))))).
