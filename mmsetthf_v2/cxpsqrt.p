...
thf(acxpsqrtlem_ax,axiom,(! [XA2:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwne @ XA2 @ ccc0)) & ((cco @ XA2 @ (cco @ cc1 @ cc2 @ ccdiv) @ cccxp) = (ccneg @ (ccfv @ XA2 @ ccsqrt)))) => (cwcel @ (cco @ cci @ (ccfv @ XA2 @ ccsqrt) @ ccmul) @ ccr)))).
...
thf(alogneg_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => ((ccfv @ (ccneg @ XA2) @ cclog) = (cco @ (ccfv @ XA2 @ cclog) @ (cco @ cci @ ccpi @ ccmul) @ ccaddc))))).
...
thf(aefhalfpi_ax,axiom,((ccfv @ (cco @ cci @ (cco @ ccpi @ cc2 @ ccdiv) @ ccmul) @ cce) = cci)).
...
thf(ccxpsqrt_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ XA2 @ (cco @ cc1 @ cc2 @ ccdiv) @ cccxp) = (ccfv @ XA2 @ ccsqrt))))).
