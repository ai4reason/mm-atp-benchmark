...
thf(afperiodmullem_ax,axiom,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : ((Xph => (cwf @ ccr @ ccc @ XF)) => ((Xph => (cwcel @ XT @ ccr)) => ((! [Xx3:$i] : (Xph => (cwcel @ (XN @ Xx3) @ ccn0))) => ((Xph => (cwcel @ XX @ ccr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => ((ccfv @ (cco @ (ccv @ Xx3) @ XT @ ccaddc) @ XF) = (ccfv @ (ccv @ Xx3) @ XF)))) => (! [Xx3:$i] : (Xph => ((ccfv @ (cco @ XX @ (cco @ (XN @ Xx3) @ XT @ ccmul) @ ccaddc) @ XF) = (ccfv @ XX @ XF))))))))))))))).
...
thf(cfperiodmul_conj,conjecture,(! [Xph:$o] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwf @ ccr @ ccc @ XF)) => ((Xph => (cwcel @ XT @ ccr)) => ((Xph => (cwcel @ XN @ ccz)) => ((Xph => (cwcel @ XX @ ccr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccr)) => ((ccfv @ (cco @ (ccv @ Xx3) @ XT @ ccaddc) @ XF) = (ccfv @ (ccv @ Xx3) @ XF)))) => (Xph => ((ccfv @ (cco @ XX @ (cco @ XN @ XT @ ccmul) @ ccaddc) @ XF) = (ccfv @ XX @ XF)))))))))))))).
