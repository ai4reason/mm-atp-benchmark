...
thf(aodd2np1lem_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cwrex @ (^ [Xn:$i] : ((cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) = XN)) @ (^ [Xn:$i] : ccz)) | (cwrex @ (^ [Xk:$i] : ((cco @ (ccv @ Xk) @ cc2 @ ccmul) = XN)) @ (^ [Xk:$i] : ccz)))))).
...
thf(codd2np1_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((~ (cwbr @ cc2 @ XN @ ccdvds)) <=> (cwrex @ (^ [Xn:$i] : ((cco @ (cco @ cc2 @ (ccv @ Xn) @ ccmul) @ cc1 @ ccaddc) = XN)) @ (^ [Xn:$i] : ccz)))))).
