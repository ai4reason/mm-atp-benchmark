...
thf(amdslmd4i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XC @ ccch) => ((cwcel @ XD @ ccch) => ((cw3a @ (cwbr @ XA2 @ XB2 @ ccmd) @ ((cwss @ (ccin @ XA2 @ XB2) @ XC) & (cwss @ XC @ XA2)) @ ((cwss @ (ccin @ XA2 @ XB2) @ XD) & (cwss @ XD @ XB2))) => (cwbr @ XC @ XD @ ccmd))))))))))).
...
thf(admdi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) & ((cwbr @ XA2 @ XB2 @ ccdmd) & (cwss @ XB2 @ XC))) => ((cco @ (ccin @ XC @ XA2) @ XB2 @ cchj) = (ccin @ XC @ (cco @ XA2 @ XB2 @ cchj)))))))).
...
thf(amdsl2bi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwbr @ XA2 @ XB2 @ ccmd) <=> (cwral @ (^ [Xx3:$i] : (((cwss @ (ccin @ XA2 @ XB2) @ (ccv @ Xx3)) & (cwss @ (ccv @ Xx3) @ XB2)) => ((ccin @ (cco @ (ccv @ Xx3) @ XA2 @ cchj) @ XB2) = (cco @ (ccv @ Xx3) @ (ccin @ XA2 @ XB2) @ cchj)))) @ (^ [Xx3:$i] : ccch)))))))).
thf(ccsmdsymi_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((! [Xc:$i] : (cwcel @ (XA2 @ Xc) @ ccch)) => ((cwcel @ XB2 @ ccch) => (! [Xc:$i] : (((cwral @ (^ [Xc:$i] : ((cwbr @ (ccv @ Xc) @ XB2 @ ccmd) => (cwbr @ XB2 @ (ccv @ Xc) @ ccdmd))) @ (^ [Xc:$i] : ccch)) & (cwbr @ (XA2 @ Xc) @ XB2 @ ccmd)) => (cwbr @ XB2 @ (XA2 @ Xc) @ ccmd)))))))).
