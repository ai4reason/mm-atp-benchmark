...
thf(acdlemesner_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((cw3a @ (cwcel @ XK @ cchlt) @ ((cwcel @ XR @ XA2) & (cwcel @ XS @ XA2)) @ ((cwbr @ XR @ (cco @ XP @ XQ @ Xc_or) @ Xc_le) & (~ (cwbr @ XS @ (cco @ XP @ XQ @ Xc_or) @ Xc_le)))) => (cwne @ XS @ XR)))))))))))))))).
