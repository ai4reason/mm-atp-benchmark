...
thf(assufl_ax,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XX @ ccufl) & (cwss @ XY @ XX)) => (cwcel @ XY @ ccufl))))).
...
thf(afmid_ax,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccfil)) => ((ccfv @ XF @ (cco @ XX @ (ccres @ ccid @ XX) @ ccfm)) = XF))))).
