...
thf(cdchr1re_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XZ = (ccfv @ XN @ cczn)) => ((Xc_1 = (ccfv @ XG @ cc0g)) => ((XB2 = (ccfv @ XZ @ ccbs)) => ((Xph => (cwcel @ XN @ ccn)) => (Xph => (cwf @ XB2 @ ccr @ Xc_1)))))))))))))).
