...
thf(ahstoh_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : ((cw3a @ (cwcel @ XS @ cchst) @ (cwcel @ XA2 @ ccch) @ ((cco @ (ccfv @ XA2 @ XS) @ (ccfv @ cchil @ XS) @ ccsp) = ccc0)) => ((ccfv @ XA2 @ XS) = cc0v))))).
thf(chst0_conj,conjecture,(! [XS:($i > $o)] : ((cwcel @ XS @ cchst) => ((ccfv @ cc0h @ XS) = cc0v)))).
