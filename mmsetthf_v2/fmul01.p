...
thf(cfmul01_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : ((cwnfc @ (^ [Xi:$i] : (XB2 @ Xi))) => ((cwnf @ (^ [Xi:$i] : (Xph @ Xi))) => ((! [Xi:$i] : ((XA2 @ Xi) = (ccseq @ ccmul @ (XB2 @ Xi) @ XL))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwcel @ XL @ ccz))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwcel @ XM @ (ccfv @ XL @ ccuz)))) => ((! [Xi:$i] : ((Xph @ Xi) => (cwcel @ (XK @ Xi) @ (cco @ XL @ XM @ ccfz)))) => ((! [Xi:$i] : (((Xph @ Xi) & (cwcel @ (ccv @ Xi) @ (cco @ XL @ XM @ ccfz))) => (cwcel @ (ccfv @ (ccv @ Xi) @ (XB2 @ Xi)) @ ccr))) => ((! [Xi:$i] : (((Xph @ Xi) & (cwcel @ (ccv @ Xi) @ (cco @ XL @ XM @ ccfz))) => (cwbr @ ccc0 @ (ccfv @ (ccv @ Xi) @ (XB2 @ Xi)) @ ccle))) => ((! [Xi:$i] : (((Xph @ Xi) & (cwcel @ (ccv @ Xi) @ (cco @ XL @ XM @ ccfz))) => (cwbr @ (ccfv @ (ccv @ Xi) @ (XB2 @ Xi)) @ cc1 @ ccle))) => (! [Xi:$i] : ((Xph @ Xi) => ((cwbr @ ccc0 @ (ccfv @ (XK @ Xi) @ (XA2 @ Xi)) @ ccle) & (cwbr @ (ccfv @ (XK @ Xi) @ (XA2 @ Xi)) @ cc1 @ ccle)))))))))))))))))))).
