...
thf(arpvmasum2_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > ($i > $o)))] : (! [Xc_1:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XN @ cczn)) => ((XL = (ccfv @ XZ @ cczrh)) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XN @ ccn))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XG @ Xx3 @ Xy1 @ Xm @ Xn) = (ccfv @ XN @ ccdchr)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : (XD = (ccfv @ (XG @ Xx3 @ Xy1 @ Xm @ Xn) @ ccbs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : (Xc_1 = (ccfv @ (XG @ Xx3 @ Xy1 @ Xm @ Xn) @ cc0g)))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xn:$i] : ((XW @ Xy1 @ Xm @ Xn) = (ccrab @ (^ [Xy1:$i] : ((ccsu @ ccn @ (^ [Xm:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ XL) @ (ccv @ Xy1)) @ (ccv @ Xm) @ ccdiv))) = ccc0)) @ (^ [Xy1:$i] : (ccdif @ XD @ (ccsn @ Xc_1)))))))) => ((! [Xy1:$i] : (! [Xf1:$i] : ((XU @ Xy1 @ Xf1) = (ccfv @ XZ @ ccui)))) => ((! [Xy1:$i] : (! [Xf1:$i] : ((Xph @ Xy1) => (cwcel @ XA2 @ (XU @ Xy1 @ Xf1))))) => ((! [Xf1:$i] : ((XT @ Xf1) = (ccima @ (cccnv @ XL) @ (ccsn @ XA2)))) => ((! [Xy1:$i] : (! [Xf1:$i] : (! [Xm:$i] : (! [Xn:$i] : (((Xph @ Xy1) & (cwcel @ (ccv @ Xf1) @ (XW @ Xy1 @ Xm @ Xn))) => (XA2 = (ccfv @ XZ @ ccur))))))) => (! [Xy1:$i] : (! [Xf1:$i] : (! [Xm:$i] : (! [Xn:$i] : ((Xph @ Xy1) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ XN @ ccphi) @ (ccsu @ (ccin @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (XT @ Xf1)) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccv @ Xn) @ ccdiv))) @ ccmul) @ (cco @ (ccfv @ (ccv @ Xx3) @ cclog) @ (cco @ cc1 @ (ccfv @ (XW @ Xy1 @ Xm @ Xn) @ cchash) @ ccmin) @ ccmul) @ ccmin))) @ cco1))))))))))))))))))))))))))))).
