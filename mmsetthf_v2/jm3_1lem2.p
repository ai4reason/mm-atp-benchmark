...
thf(ajm3_1lem1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz))) => ((Xph => (cwcel @ XK @ (ccfv @ cc2 @ ccuz))) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwbr @ (cco @ XK @ (cco @ XN @ cc1 @ ccaddc) @ ccrmy) @ XA2 @ ccle)) => (Xph => (cwbr @ (cco @ XK @ XN @ ccexp) @ XA2 @ cclt))))))))))).
