...
thf(areprinrn_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XS @ ccn0)) => (! [Xc:$i] : (Xph => ((cwcel @ (ccv @ Xc) @ (cco @ (ccin @ XA2 @ XB2) @ XM @ (ccfv @ XS @ ccrepr))) <=> ((cwcel @ (ccv @ Xc) @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr))) & (cwss @ (ccrn @ (ccv @ Xc)) @ XB2)))))))))))))).
...
thf(aprodindf_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xk:$i] : (Xph => (cwcel @ XO @ (XV @ Xk)))) => ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwss @ XB2 @ XO)) => ((Xph => (cwf @ XA2 @ XO @ XF)) => (Xph => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ XB2 @ (ccfv @ XO @ ccind))))) = (ccif @ (cwss @ (ccrn @ XF) @ XB2) @ cc1 @ ccc0)))))))))))))).
