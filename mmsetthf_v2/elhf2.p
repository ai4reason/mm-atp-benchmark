...
thf(aelhf_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ cchf) <=> (cwrex @ (^ [Xx3:$i] : (cwcel @ XA2 @ (ccfv @ (ccv @ Xx3) @ ccr1))) @ (^ [Xx3:$i] : ccom))))).
...
thf(atz9_13_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwrex @ (^ [Xx3:$i] : (cwcel @ XA2 @ (ccfv @ (ccv @ Xx3) @ ccr1))) @ (^ [Xx3:$i] : ccon0))))).
...
thf(celhf2_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XA2 @ cchf) <=> (cwcel @ (ccfv @ XA2 @ ccrnk) @ ccom))))).
