...
thf(afndifnfp_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwfn @ XF @ XA2) => ((ccdm @ (ccdif @ XF @ ccid)) = (ccrab @ (^ [Xx3:$i] : (cwne @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XA2))))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(cf1omvdcnv_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwf1o @ XA2 @ XA2 @ XF) => ((ccdm @ (ccdif @ (cccnv @ XF) @ ccid)) = (ccdm @ (ccdif @ XF @ ccid))))))).
