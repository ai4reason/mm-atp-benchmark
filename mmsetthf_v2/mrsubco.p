...
thf(amrsubf_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((XS = (ccfv @ XT @ ccmrsub)) => ((XR = (ccfv @ XT @ ccmrex)) => ((cwcel @ XF @ (ccrn @ XS)) => (cwf @ XR @ XR @ XF))))))))).
...
thf(amrsubcn_ax,axiom,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XS = (ccfv @ XT @ ccmrsub)) => ((XR = (ccfv @ XT @ ccmrex)) => ((XV = (ccfv @ XT @ ccmvar)) => ((XC = (ccfv @ XT @ ccmcn)) => (((cwcel @ XF @ (ccrn @ XS)) & (cwcel @ XX @ (ccdif @ XC @ XV))) => ((ccfv @ (ccs1 @ XX) @ XF) = (ccs1 @ XX))))))))))))))).
...
thf(amrsubccat_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XS = (ccfv @ XT @ ccmrsub)) => ((XR = (ccfv @ XT @ ccmrex)) => ((cw3a @ (cwcel @ XF @ (ccrn @ XS)) @ (cwcel @ XX @ XR) @ (cwcel @ XY @ XR)) => ((ccfv @ (cco @ XX @ XY @ ccconcat) @ XF) = (cco @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ ccconcat)))))))))))).
...
thf(aelmrsubrn_ax,axiom,(! [XC:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xc:$i] : (XS = (ccfv @ (XT @ Xc) @ ccmrsub))) => ((! [Xc:$i] : ((XR @ Xc) = (ccfv @ (XT @ Xc) @ ccmrex))) => ((! [Xc:$i] : (XV = (ccfv @ (XT @ Xc) @ ccmvar))) => ((! [Xc:$i] : (XC = (ccfv @ (XT @ Xc) @ ccmcn))) => (! [Xc:$i] : ((cwcel @ (XT @ Xc) @ (XW @ Xc)) => ((cwcel @ XF @ (ccrn @ XS)) <=> (cw3a @ (cwf @ (XR @ Xc) @ (XR @ Xc) @ XF) @ (cwral @ (^ [Xc:$i] : ((ccfv @ (ccs1 @ (ccv @ Xc)) @ XF) = (ccs1 @ (ccv @ Xc)))) @ (^ [Xc:$i] : (ccdif @ XC @ XV))) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccconcat) @ XF) = (cco @ (ccfv @ (ccv @ Xx3) @ XF) @ (ccfv @ (ccv @ Xy1) @ XF) @ ccconcat))) @ (^ [Xy1:$i] : (XR @ Xc)))) @ (^ [Xx3:$i] : (XR @ Xc))))))))))))))))))).
thf(cmrsubco_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XS = (ccfv @ XT @ ccmrsub)) => (((cwcel @ XF @ (ccrn @ XS)) & (cwcel @ XG @ (ccrn @ XS))) => (cwcel @ (cccom @ XF @ XG) @ (ccrn @ XS))))))))).
