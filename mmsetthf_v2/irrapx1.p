...
thf(airrapxlem6_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwcel @ XB2 @ ccrp)) => (cwrex @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (cco @ (ccv @ Xx3) @ XA2 @ ccmin) @ ccabs) @ XB2 @ cclt)) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : ((cwbr @ ccc0 @ (ccv @ Xy1) @ cclt) & (cwbr @ (ccfv @ (cco @ (ccv @ Xy1) @ XA2 @ ccmin) @ ccabs) @ (cco @ (ccfv @ (ccv @ Xy1) @ ccdenom) @ (ccneg @ cc2) @ ccexp) @ cclt))) @ (^ [Xy1:$i] : ccq)))))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(arencldnfi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cw3a @ (cwss @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (~ (cwcel @ XB2 @ XA2))) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccv @ Xy1) @ XB2 @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccrp))) => (~ (cwcel @ XA2 @ ccfn)))))).
thf(ccsdm_tp,type,(ccsdm : ($i > $o))).
thf(actbnfien_ax,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwbr @ XX @ ccom @ ccen) & (cwbr @ XY @ ccom @ ccen)) & ((cwss @ XA2 @ XX) & (~ (cwcel @ XA2 @ ccfn)))) => (cwbr @ XA2 @ XY @ ccen)))))).
thf(cirrapx1_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdif @ ccrp @ ccq)) => (cwbr @ (ccrab @ (^ [Xy1:$i] : ((cwbr @ ccc0 @ (ccv @ Xy1) @ cclt) & (cwbr @ (ccfv @ (cco @ (ccv @ Xy1) @ XA2 @ ccmin) @ ccabs) @ (cco @ (ccfv @ (ccv @ Xy1) @ ccdenom) @ (ccneg @ cc2) @ ccexp) @ cclt))) @ (^ [Xy1:$i] : ccq)) @ ccn @ ccen)))).
