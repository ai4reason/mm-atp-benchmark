...
thf(adf_drngo_ax,axiom,(ccdrng = (ccopab @ (^ [Xg1:$i] : (^ [Xh:$i] : ((cwcel @ (ccop @ (ccv @ Xg1) @ (ccv @ Xh)) @ ccrngo) & (cwcel @ (ccres @ (ccv @ Xh) @ (ccxp @ (ccdif @ (ccrn @ (ccv @ Xg1)) @ (ccsn @ (ccfv @ (ccv @ Xg1) @ ccgi))) @ (ccdif @ (ccrn @ (ccv @ Xg1)) @ (ccsn @ (ccfv @ (ccv @ Xg1) @ ccgi))))) @ ccgr))))))).
thf(ajca_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => Xch) => (Xph => (Xps & Xch)))))))).
thf(aad2antrl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xch & (Xph & Xth)) => Xps))))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(cc1st_tp,type,(cc1st : ($i > $o))).
thf(arngoablo2_ax,axiom,(! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ (ccop @ XG @ XH) @ ccrngo) => (cwcel @ XG @ ccablo))))).
...
thf(cisdivrngo_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ XA2) => ((cwcel @ (ccop @ XG @ XH) @ ccdrng) <=> ((cwcel @ (ccop @ XG @ XH) @ ccrngo) & (cwcel @ (ccres @ XH @ (ccxp @ (ccdif @ (ccrn @ XG) @ (ccsn @ (ccfv @ XG @ ccgi))) @ (ccdif @ (ccrn @ XG) @ (ccsn @ (ccfv @ XG @ ccgi))))) @ ccgr)))))))).
