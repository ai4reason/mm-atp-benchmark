...
thf(aintrnfi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XB2 @ XV) & (cw3a @ (cwf @ XA2 @ XB2 @ XF) @ (cwne @ XA2 @ cc0) @ (cwcel @ XA2 @ ccfn))) => (cwcel @ (ccint @ (ccrn @ XF)) @ (ccfv @ XB2 @ ccfi)))))))).
thf(ciinfi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : (((cwcel @ XC @ (XV @ Xx3)) & (cw3a @ (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ XC)) @ (^ [Xx3:$i] : XA2)) @ (cwne @ XA2 @ cc0) @ (cwcel @ XA2 @ ccfn))) => (cwcel @ (cciin @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccfv @ XC @ ccfi))))))))).
