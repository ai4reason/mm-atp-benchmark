...
thf(aisfcf_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xs1:$i] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) => ((cwcel @ (XA2 @ Xs1) @ (ccfv @ XF @ (cco @ XJ @ XL @ ccfcf))) <=> ((cwcel @ (XA2 @ Xs1) @ XX) & (cwral @ (^ [Xo:$i] : ((cwcel @ (XA2 @ Xs1) @ (ccv @ Xo)) => (cwral @ (^ [Xs1:$i] : (cwne @ (ccin @ (ccv @ Xo) @ (ccima @ XF @ (ccv @ Xs1))) @ cc0)) @ (^ [Xs1:$i] : XL)))) @ (^ [Xo:$i] : XJ))))))))))))).
...
thf(aneiint_ax,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX) @ (cwss @ XN @ XX)) => ((cwcel @ XN @ (ccfv @ XS @ (ccfv @ XJ @ ccnei))) <=> (cwss @ XS @ (ccfv @ XN @ (ccfv @ XJ @ ccnt))))))))))).
...
thf(cfcfnei_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xs1:$i] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XL @ (ccfv @ XY @ ccfil)) @ (cwf @ XY @ XX @ XF)) => ((cwcel @ (XA2 @ Xs1) @ (ccfv @ XF @ (cco @ XJ @ XL @ ccfcf))) <=> ((cwcel @ (XA2 @ Xs1) @ XX) & (cwral @ (^ [Xn:$i] : (cwral @ (^ [Xs1:$i] : (cwne @ (ccin @ (ccv @ Xn) @ (ccima @ XF @ (ccv @ Xs1))) @ cc0)) @ (^ [Xs1:$i] : XL))) @ (^ [Xn:$i] : (ccfv @ (ccsn @ (XA2 @ Xs1)) @ (ccfv @ XJ @ ccnei))))))))))))))).
