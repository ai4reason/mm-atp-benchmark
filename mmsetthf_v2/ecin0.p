...
thf(ael2v2_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xy1:$i] : (((Xph @ Xy1) & (cwcel @ (ccv @ Xy1) @ ccvv)) => (Xps @ Xy1))) => (! [Xy1:$i] : ((Xph @ Xy1) => (Xps @ Xy1))))))).
...
thf(cecin0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => (((ccin @ (ccec @ XA2 @ XR) @ (ccec @ XB2 @ XR)) = cc0) <=> (! [Xx3:$i] : ((cwbr @ XA2 @ (ccv @ Xx3) @ XR) => (~ (cwbr @ XB2 @ (ccv @ Xx3) @ XR)))))))))))).
