...
thf(assdif2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwss @ XA2 @ XB2)) => ((Xph => (cwss @ XC @ XD)) => (Xph => (cwss @ (ccdif @ XA2 @ XD) @ (ccdif @ XB2 @ XC))))))))))).
...
thf(adifdif2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccdif @ XA2 @ (ccdif @ XB2 @ XC)) = (ccun @ (ccdif @ XA2 @ XB2) @ (ccin @ XA2 @ XC))))))).
