...
thf(atz7_7_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cword @ XA2) & (cwtr @ XB2)) => ((cwcel @ XB2 @ XA2) <=> ((cwss @ XB2 @ XA2) & (cwne @ XB2 @ XA2))))))).
...
thf(adfon2lem7_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (((cwpss @ (ccv @ Xx3) @ XA2) & (cwtr @ (ccv @ Xx3))) => (cwcel @ (ccv @ Xx3) @ XA2))) => ((cwcel @ XB2 @ XA2) => (! [Xy1:$i] : (((cwpss @ (ccv @ Xy1) @ XB2) & (cwtr @ (ccv @ Xy1))) => (cwcel @ (ccv @ Xy1) @ XB2))))))))).
thf(ajca_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => Xch) => (Xph => (Xps & Xch)))))))).
thf(ccint_tp,type,(ccint : (($i > $o) > ($i > $o)))).
thf(adfon2lem9_ax,axiom,(! [XA2:($i > $o)] : ((cwral @ (^ [Xx3:$i] : (! [Xy1:$i] : (((cwpss @ (ccv @ Xy1) @ (ccv @ Xx3)) & (cwtr @ (ccv @ Xy1))) => (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))) @ (^ [Xx3:$i] : XA2)) => (cwfr @ XA2 @ ccep)))).
...
thf(adfon2lem5_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => (((! [Xx3:$i] : (((cwpss @ (ccv @ Xx3) @ XA2) & (cwtr @ (ccv @ Xx3))) => (cwcel @ (ccv @ Xx3) @ XA2))) & (! [Xy1:$i] : (((cwpss @ (ccv @ Xy1) @ XB2) & (cwtr @ (ccv @ Xy1))) => (cwcel @ (ccv @ Xy1) @ XB2)))) => (cw3o @ (cwcel @ XA2 @ XB2) @ (XA2 = XB2) @ (cwcel @ XB2 @ XA2)))))))).
...
thf(cdfon2_conj,conjecture,(ccon0 = (ccab @ (^ [Xx3:$i] : (! [Xy1:$i] : (((cwpss @ (ccv @ Xy1) @ (ccv @ Xx3)) & (cwtr @ (ccv @ Xy1))) => (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)))))))).
