...
thf(cfvrcllb0da_conj,conjecture,(! [Xph:$o] : (! [XR:($i > $o)] : ((Xph => (cwrel @ XR)) => ((Xph => (cwcel @ XR @ ccvv)) => (Xph => (cwss @ (ccres @ ccid @ (ccuni @ (ccuni @ XR))) @ (ccfv @ XR @ ccrcl)))))))).
