...
thf(aogrpsub_ax,axiom,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_le = (ccfv @ XG @ ccple)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((cw3a @ (cwcel @ XG @ ccogrp) @ (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2)) @ (cwbr @ XX @ XY @ Xc_le)) => (cwbr @ (cco @ XX @ XZ @ Xc_mi) @ (cco @ XY @ XZ @ Xc_mi) @ Xc_le))))))))))))).
...
thf(amulgsubdir_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => (((cwcel @ XG @ ccgrp) & (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz) @ (cwcel @ XX @ XB2))) => ((cco @ (cco @ XM @ XN @ ccmin) @ XX @ Xc_x) = (cco @ (cco @ XM @ XX @ Xc_x) @ (cco @ XN @ XX @ Xc_x) @ Xc_mi)))))))))))))).
...
thf(aarchirng_ax,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [Xc_lt:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xn:$i] : ((XB2 @ Xn) = (ccfv @ (XW @ Xn) @ ccbs))) => ((! [Xn:$i] : (Xc_0 = (ccfv @ (XW @ Xn) @ cc0g))) => ((! [Xn:$i] : (Xc_lt = (ccfv @ (XW @ Xn) @ ccplt))) => ((! [Xn:$i] : (Xc_le = (ccfv @ (XW @ Xn) @ ccple))) => ((! [Xn:$i] : (Xc_x = (ccfv @ (XW @ Xn) @ ccmg))) => ((! [Xn:$i] : (Xph => (cwcel @ (XW @ Xn) @ ccogrp))) => ((! [Xn:$i] : (Xph => (cwcel @ (XW @ Xn) @ ccarchi))) => ((! [Xn:$i] : (Xph => (cwcel @ XX @ (XB2 @ Xn)))) => ((! [Xn:$i] : (Xph => (cwcel @ XY @ (XB2 @ Xn)))) => ((Xph => (cwbr @ Xc_0 @ XX @ Xc_lt)) => ((Xph => (cwbr @ Xc_0 @ XY @ Xc_lt)) => (Xph => (cwrex @ (^ [Xn:$i] : ((cwbr @ (cco @ (ccv @ Xn) @ XX @ Xc_x) @ XY @ Xc_lt) & (cwbr @ XY @ (cco @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XX @ Xc_x) @ Xc_le))) @ (^ [Xn:$i] : ccn0)))))))))))))))))))))))).
thf(carchiabllem1a_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((! [Xn:$i] : ((Xc_le @ Xn) = (ccfv @ XW @ ccple))) => ((Xc_lt = (ccfv @ XW @ ccplt)) => ((Xc_x = (ccfv @ XW @ ccmg)) => ((Xph => (cwcel @ XW @ ccogrp)) => ((Xph => (cwcel @ XW @ ccarchi)) => ((Xph => (cwcel @ XU @ XB2)) => ((Xph => (cwbr @ Xc_0 @ XU @ Xc_lt)) => ((! [Xx3:$i] : (! [Xn:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XB2) @ (cwbr @ Xc_0 @ (ccv @ Xx3) @ Xc_lt)) => (cwbr @ XU @ (ccv @ Xx3) @ (Xc_le @ Xn))))) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwbr @ Xc_0 @ XX @ Xc_lt)) => (Xph => (cwrex @ (^ [Xn:$i] : (XX = (cco @ (ccv @ Xn) @ XU @ Xc_x))) @ (^ [Xn:$i] : ccn))))))))))))))))))))))))).
