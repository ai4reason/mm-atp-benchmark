...
thf(cmvllmuld_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwne @ XA2 @ ccc0)) => ((Xph => ((cco @ XA2 @ XB2 @ ccmul) = XC)) => (Xph => (XB2 = (cco @ XC @ XA2 @ ccdiv)))))))))))).
