...
thf(aswrdlsw_ax,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwne @ XW @ cc0)) => ((cco @ XW @ (ccop @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ (ccfv @ XW @ cchash)) @ ccsubstr) = (ccs1 @ (ccfv @ XW @ cclsw))))))).
...
thf(ahashgt0n0_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwbr @ ccc0 @ (ccfv @ XA2 @ cchash) @ cclt)) => (cwne @ XA2 @ cc0))))).
...
thf(c_2swrd1eqwrdeq_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XU @ (ccword @ XV)) @ (cwbr @ ccc0 @ (ccfv @ XW @ cchash) @ cclt)) => ((XW = XU) <=> (((ccfv @ XW @ cchash) = (ccfv @ XU @ cchash)) & (((cco @ XW @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin)) @ ccsubstr) = (cco @ XU @ (ccop @ ccc0 @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin)) @ ccsubstr)) & ((ccfv @ XW @ cclsw) = (ccfv @ XU @ cclsw)))))))))).
