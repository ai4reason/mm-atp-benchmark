...
thf(abposlem2_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XP @ ccprime)) => ((Xph => (cwbr @ cc2 @ XP @ cclt)) => ((Xph => (cwbr @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc3 @ ccdiv) @ XP @ cclt)) => ((Xph => (cwbr @ XP @ XN @ ccle)) => (Xph => ((cco @ XP @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ ccpc) = ccc0))))))))))).
...
thf(abcctr_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) = (cco @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ ccfa) @ (cco @ (ccfv @ XN @ ccfa) @ (ccfv @ XN @ ccfa) @ ccmul) @ ccdiv))))).
