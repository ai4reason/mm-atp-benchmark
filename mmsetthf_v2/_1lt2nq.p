...
thf(a_1lt2pi_ax,axiom,(cwbr @ cc1o @ (cco @ cc1o @ cc1o @ ccpli) @ cclti)).
...
thf(alterpq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ XA2 @ XB2 @ ccltpq) <=> (cwbr @ (ccfv @ XA2 @ ccerq) @ (ccfv @ XB2 @ ccerq) @ ccltq))))).
