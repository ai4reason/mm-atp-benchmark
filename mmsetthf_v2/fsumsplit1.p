...
thf(cfsumsplit1_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((cwnfc @ (^ [Xk:$i] : (XD @ Xk))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XA2 @ ccfn))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccc))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XC @ XA2))) => ((! [Xk:$i] : (((ccv @ Xk) = XC) => ((XB2 @ Xk) = (XD @ Xk)))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccsu @ XA2 @ (^ [Xk:$i] : (XB2 @ Xk))) = (cco @ (XD @ Xk) @ (ccsu @ (ccdif @ XA2 @ (ccsn @ XC)) @ (^ [Xk:$i] : (XB2 @ Xk))) @ ccaddc)))))))))))))))).
