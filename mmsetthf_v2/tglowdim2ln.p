...
thf(atglowdim2l_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > ($i > ($i > ($i > $o))))] : ((XP = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccitv)) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((XL @ Xa @ Xb @ Xc) = (ccfv @ XG @ cclng))))) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwbr @ XG @ cc2 @ ccstrkgld)) => (Xph => (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (~ ((cwcel @ (ccv @ Xc) @ (cco @ (ccv @ Xa) @ (ccv @ Xb) @ (XL @ Xa @ Xb @ Xc))) | ((ccv @ Xa) = (ccv @ Xb))))) @ (^ [Xc:$i] : XP))) @ (^ [Xb:$i] : XP))) @ (^ [Xa:$i] : XP)))))))))))))).
...
thf(ctglowdim2ln_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwbr @ XG @ cc2 @ ccstrkgld)) => ((Xph => (cwcel @ XA2 @ XP)) => ((Xph => (cwcel @ XB2 @ XP)) => ((Xph => (cwne @ XA2 @ XB2)) => (Xph => (cwrex @ (^ [Xc:$i] : (~ (cwcel @ (ccv @ Xc) @ (cco @ XA2 @ XB2 @ XL)))) @ (^ [Xc:$i] : XP))))))))))))))))))).
