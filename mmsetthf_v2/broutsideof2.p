...
thf(abtwncolinear2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cw3a @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XC @ (ccfv @ XN @ ccee)))) => ((cwbr @ XC @ (ccop @ XA2 @ XB2) @ ccbtwn) => (cwbr @ XA2 @ (ccop @ XC @ XB2) @ cccolin)))))))).
...
thf(cbroutsideof2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cw3a @ (cwcel @ XP @ (ccfv @ XN @ ccee)) @ (cwcel @ XA2 @ (ccfv @ XN @ ccee)) @ (cwcel @ XB2 @ (ccfv @ XN @ ccee)))) => ((cwbr @ XP @ (ccop @ XA2 @ XB2) @ ccoutsideof) <=> (cw3a @ (cwne @ XA2 @ XP) @ (cwne @ XB2 @ XP) @ ((cwbr @ XA2 @ (ccop @ XP @ XB2) @ ccbtwn) | (cwbr @ XB2 @ (ccop @ XP @ XA2) @ ccbtwn)))))))))).
