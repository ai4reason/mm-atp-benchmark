...
thf(awl_mo2df_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : ((! [Xy1:$i] : (cwnf @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (cwnf @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => (cwnf @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => ((cwmo @ (^ [Xx3:$i] : (Xps @ Xx3 @ Xy1))) <=> (? [Xy1:$i] : (! [Xx3:$i] : ((Xps @ Xx3 @ Xy1) => ((ccv @ Xx3) = (ccv @ Xy1)))))))))))))))).
...
thf(cwl_mo2tf_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xy1:$i] : (((~ (! [Xx3:$i] : ((ccv @ Xx3) = (ccv @ Xy1)))) & (! [Xx3:$i] : (cwnf @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))) => ((cwmo @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1))) <=> (? [Xy1:$i] : (! [Xx3:$i] : ((Xph @ Xx3 @ Xy1) => ((ccv @ Xx3) = (ccv @ Xy1)))))))))).
