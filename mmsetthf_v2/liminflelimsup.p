...
thf(aliminflelimsuplem_ax,axiom,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XF @ (XV @ Xj @ Xk))))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xj:$i] : (cwne @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xj) @ ccpnf @ ccico)) @ ccxr) @ cc0)) @ (^ [Xj:$i] : (cco @ (ccv @ Xk) @ ccpnf @ ccico)))) @ (^ [Xk:$i] : ccr)))) => (! [Xk:$i] : ((Xph @ Xk) => (cwbr @ (ccfv @ XF @ cclsi) @ (ccfv @ XF @ cclsp) @ ccle))))))))).
...
thf(climinflelimsup_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwcel @ XF @ (XV @ Xj @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwral @ (^ [Xk:$i] : (cwrex @ (^ [Xj:$i] : (cwne @ (ccin @ (ccima @ XF @ (cco @ (ccv @ Xj) @ ccpnf @ ccico)) @ ccxr) @ cc0)) @ (^ [Xj:$i] : (cco @ (ccv @ Xk) @ ccpnf @ ccico)))) @ (^ [Xk:$i] : ccr))))) => (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwbr @ (ccfv @ XF @ cclsi) @ (ccfv @ XF @ cclsp) @ ccle)))))))))).
