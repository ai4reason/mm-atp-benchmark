...
thf(asincos3rdpi_ax,axiom,(((ccfv @ (cco @ ccpi @ cc3 @ ccdiv) @ ccsin) = (cco @ (ccfv @ cc3 @ ccsqrt) @ cc2 @ ccdiv)) & ((ccfv @ (cco @ ccpi @ cc3 @ ccdiv) @ cccos) = (cco @ cc1 @ cc2 @ ccdiv)))).
thf(adiv11i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwcel @ XC @ ccc) => ((cwne @ XC @ ccc0) => (((cco @ XA2 @ XC @ ccdiv) = (cco @ XB2 @ XC @ ccdiv)) <=> (XA2 = XB2)))))))))).
