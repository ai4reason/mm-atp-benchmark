...
thf(aesumcocn_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > $o)] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : ((XJ @ Xx3 @ Xy1 @ Xk) = (cco @ (ccfv @ ccle @ ccordt) @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccrest))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XA2 @ Xx3 @ Xy1) @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (XA2 @ Xx3 @ Xy1))) => (cwcel @ (XB2 @ Xx3 @ Xy1 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xk:$i] : (Xph => (cwcel @ XC @ (cco @ (XJ @ Xx3 @ Xy1 @ Xk) @ (XJ @ Xx3 @ Xy1 @ Xk) @ cccn)))))) => ((Xph => ((ccfv @ ccc0 @ XC) = ccc0)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ (cco @ ccc0 @ ccpnf @ ccicc)) @ (cwcel @ (ccv @ Xy1) @ (cco @ ccc0 @ ccpnf @ ccicc))) => ((ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccxad) @ XC) = (cco @ (ccfv @ (ccv @ Xx3) @ XC) @ (ccfv @ (ccv @ Xy1) @ XC) @ ccxad))))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((ccfv @ (ccesum @ (^ [Xk:$i] : (XA2 @ Xx3 @ Xy1)) @ (^ [Xk:$i] : (XB2 @ Xx3 @ Xy1 @ Xk))) @ XC) = (ccesum @ (^ [Xk:$i] : (XA2 @ Xx3 @ Xy1)) @ (^ [Xk:$i] : (ccfv @ (XB2 @ Xx3 @ Xy1 @ Xk) @ XC)))))))))))))))))))).
...
thf(axrge0mulc1cn_ax,axiom,(! [Xph:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : ((XJ @ Xx3) = (cco @ (ccfv @ ccle @ ccordt) @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccrest))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ ccpnf @ ccicc)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XC @ ccxmu))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XC @ (cco @ ccc0 @ ccpnf @ ccico)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XF @ Xx3) @ (cco @ (XJ @ Xx3) @ (XJ @ Xx3) @ cccn)))))))))))).
...
thf(age0xaddcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc)) & (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => (cwcel @ (cco @ XA2 @ XB2 @ ccxad) @ (cco @ ccc0 @ ccpnf @ ccicc)))))).
...
thf(cesummulc1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((Xph => (cwcel @ XC @ (cco @ ccc0 @ ccpnf @ ccico))) => (Xph => ((cco @ (ccesum @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ XC @ ccxmu) = (ccesum @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (cco @ (XB2 @ Xk) @ XC @ ccxmu)))))))))))))).
