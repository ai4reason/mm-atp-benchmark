...
thf(acsbief_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwcel @ XA2 @ ccvv) => ((cwnfc @ (^ [Xx3:$i] : (XC @ Xx3))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((XB2 @ Xx3) = (XC @ Xx3)))) => (! [Xx3:$i] : ((ccsb @ XA2 @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (XC @ Xx3)))))))))).
...
thf(assiun2sf_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XC @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XD @ Xx3))) => ((! [Xx3:$i] : (((ccv @ Xx3) = (XC @ Xx3)) => ((XB2 @ Xx3) = (XD @ Xx3)))) => (! [Xx3:$i] : ((cwcel @ (XC @ Xx3) @ (XA2 @ Xx3)) => (cwss @ (XD @ Xx3) @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))))))))))))))).
...
thf(adisjors_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) <=> (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (((ccv @ Xi) = (ccv @ Xj)) | ((ccin @ (ccsb @ (ccv @ Xi) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccsb @ (ccv @ Xj) @ (^ [Xx3:$i] : (XB2 @ Xx3)))) = cc0))) @ (^ [Xj:$i] : XA2))) @ (^ [Xi:$i] : XA2)))))).
thf(ciundisj2f_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : ((! [Xn:$i] : (cwnfc @ (^ [Xk:$i] : (XA2 @ Xk @ Xn)))) => ((! [Xk:$i] : (cwnfc @ (^ [Xn:$i] : (XB2 @ Xk @ Xn)))) => ((! [Xk:$i] : (! [Xn:$i] : (((ccv @ Xn) = (ccv @ Xk)) => ((XA2 @ Xk @ Xn) = (XB2 @ Xk @ Xn))))) => (! [Xk:$i] : (cwdisj @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccdif @ (XA2 @ Xk @ Xn) @ (cciun @ (^ [Xk:$i] : (cco @ cc1 @ (ccv @ Xn) @ ccfzo)) @ (^ [Xk:$i] : (XB2 @ Xk @ Xn))))))))))))).
