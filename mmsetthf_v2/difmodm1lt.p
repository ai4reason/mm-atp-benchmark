...
thf(cdifmodm1lt_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ ccn) @ (cwbr @ cc2 @ XN @ cclt)) => (cwbr @ (cco @ (cco @ XA2 @ XN @ ccmo) @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ XN @ ccmo) @ ccmin) @ (cco @ XN @ cc1 @ ccmin) @ cclt))))).
