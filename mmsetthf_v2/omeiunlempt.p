...
thf(comeiunlempt_conj,conjecture,(! [Xph:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((cwnf @ (^ [Xn:$i] : (Xph @ Xn))) => ((! [Xn:$i] : ((Xph @ Xn) => (cwcel @ XO @ ccome))) => ((XX = (ccuni @ (ccdm @ XO))) => ((! [Xn:$i] : (XZ = (ccfv @ (XN @ Xn) @ ccuz))) => ((! [Xn:$i] : (((Xph @ Xn) & (cwcel @ (ccv @ Xn) @ XZ)) => (cwss @ (XE @ Xn) @ XX))) => (! [Xn:$i] : ((Xph @ Xn) => (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (XE @ Xn))) @ XO) @ (ccfv @ (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccfv @ (XE @ Xn) @ XO))) @ ccsumge0) @ ccle))))))))))))))).
