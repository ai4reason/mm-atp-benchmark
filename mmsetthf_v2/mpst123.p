...
thf(cmpst123_conj,conjecture,(! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XT @ ccmpst)) => ((cwcel @ XX @ XP) => (XX = (ccotp @ (ccfv @ (ccfv @ XX @ cc1st) @ cc1st) @ (ccfv @ (ccfv @ XX @ cc1st) @ cc2nd) @ (ccfv @ XX @ cc2nd))))))))).
