...
thf(asrhmsubclem2_ax,axiom,(! [XC:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwral @ (^ [Xr:$i] : (cwcel @ (ccv @ Xr) @ ccrg)) @ (^ [Xr:$i] : XS)) => ((! [Xr:$i] : ((XC @ Xr) = (ccin @ (XU @ Xr) @ XS))) => (! [Xr:$i] : (((cwcel @ (XU @ Xr) @ (XV @ Xr)) & (cwcel @ XX @ (XC @ Xr))) => (cwcel @ XX @ (ccfv @ (ccfv @ (XU @ Xr) @ ccringc) @ ccbs)))))))))))).
...
thf(aidrhm_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((cwcel @ XR @ ccrg) => (cwcel @ (ccres @ ccid @ XB2) @ (cco @ XR @ XR @ ccrh))))))).
thf(aringcid_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XC = (ccfv @ XU @ ccringc)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xc_1 = (ccfv @ XC @ cccid)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (cwcel @ XX @ XB2)) => ((XS = (ccfv @ XX @ ccbs)) => (Xph => ((ccfv @ XX @ Xc_1) = (ccres @ ccid @ XS)))))))))))))))))).
