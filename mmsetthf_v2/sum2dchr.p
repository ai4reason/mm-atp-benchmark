...
thf(asumdchr_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((XG = (ccfv @ XN @ ccdchr)) => ((XD = (ccfv @ XG @ ccbs)) => ((! [Xx3:$i] : ((XZ @ Xx3) = (ccfv @ XN @ cczn))) => ((! [Xx3:$i] : (Xc_1 = (ccfv @ (XZ @ Xx3) @ ccur))) => ((! [Xx3:$i] : ((XB2 @ Xx3) = (ccfv @ (XZ @ Xx3) @ ccbs))) => ((Xph => (cwcel @ XN @ ccn)) => ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XB2 @ Xx3)))) => (Xph => ((ccsu @ XD @ (^ [Xx3:$i] : (ccfv @ XA2 @ (ccv @ Xx3)))) = (ccif @ (XA2 = Xc_1) @ (ccfv @ XN @ ccphi) @ ccc0))))))))))))))))))).
...
thf(adchrghm_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XZ = (ccfv @ XN @ cczn)) => ((XD = (ccfv @ XG @ ccbs)) => ((XU = (ccfv @ XZ @ ccui)) => ((XH = (cco @ (ccfv @ XZ @ ccmgp) @ XU @ ccress)) => ((XM = (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccdif @ ccc @ (ccsn @ ccc0)) @ ccress)) => ((Xph => (cwcel @ XX @ XD)) => (Xph => (cwcel @ (ccres @ XX @ XU) @ (cco @ XH @ XM @ ccghm)))))))))))))))))))).
...
thf(arecval_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ XA2 @ ccc0)) => ((cco @ cc1 @ XA2 @ ccdiv) = (cco @ (ccfv @ XA2 @ cccj) @ (cco @ (ccfv @ XA2 @ ccabs) @ cc2 @ ccexp) @ ccdiv))))).
...
thf(adchrabs_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XD = (ccfv @ XG @ ccbs)) => ((Xph => (cwcel @ XX @ XD)) => ((XZ = (ccfv @ XN @ cczn)) => ((XU = (ccfv @ XZ @ ccui)) => ((Xph => (cwcel @ XA2 @ XU)) => (Xph => ((ccfv @ (ccfv @ XA2 @ XX) @ ccabs) = cc1))))))))))))))))).
...
thf(advreq1_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XU = (ccfv @ XR @ ccui)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XU)) => (((cco @ XX @ XY @ Xc_dv) = Xc_1) <=> (XX = XY))))))))))))))).
