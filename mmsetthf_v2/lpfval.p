...
thf(adf_lp_ax,axiom,(cclp = (ccmpt @ (^ [Xj:$i] : cctop) @ (^ [Xj:$i] : (ccmpt @ (^ [Xx3:$i] : (ccpw @ (ccuni @ (ccv @ Xj)))) @ (^ [Xx3:$i] : (ccab @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xy1) @ (ccfv @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xy1))) @ (ccfv @ (ccv @ Xj) @ cccl))))))))))).
thf(clpfval_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XJ @ cctop) => ((ccfv @ XJ @ cclp) = (ccmpt @ (^ [Xx3:$i] : (ccpw @ XX)) @ (^ [Xx3:$i] : (ccab @ (^ [Xy1:$i] : (cwcel @ (ccv @ Xy1) @ (ccfv @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xy1))) @ (ccfv @ XJ @ cccl))))))))))))).
