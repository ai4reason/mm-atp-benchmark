...
thf(adfdec100_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccr) => ((ccdc @ (ccdc @ XA2 @ XB2) @ XC) = (cco @ (cco @ (ccdc @ (ccdc @ cc1 @ ccc0) @ ccc0) @ XA2 @ ccmul) @ (ccdc @ XB2 @ XC) @ ccaddc))))))))).
...
thf(adpval_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn0) & (cwcel @ XB2 @ ccr)) => ((cco @ XA2 @ XB2 @ ccdp) = (ccdp2 @ XA2 @ XB2)))))).
thf(cdpmul1000_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XC @ ccn0) => ((cwcel @ XD @ ccr) => ((cco @ (cco @ XA2 @ (ccdp2 @ XB2 @ (ccdp2 @ XC @ XD)) @ ccdp) @ (ccdc @ (ccdc @ (ccdc @ cc1 @ ccc0) @ ccc0) @ ccc0) @ ccmul) = (ccdc @ (ccdc @ (ccdc @ XA2 @ XB2) @ XC) @ XD))))))))))).
