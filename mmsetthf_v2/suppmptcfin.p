...
thf(arabsssn_ax,axiom,(! [Xph:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((cwss @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XV @ Xx3))) @ (ccsn @ XX)) <=> (cwral @ (^ [Xx3:$i] : ((Xph @ Xx3) => ((ccv @ Xx3) = XX))) @ (^ [Xx3:$i] : (XV @ Xx3)))))))).
...
thf(csuppmptcfin_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((! [Xx3:$i] : ((XR @ Xx3) = (ccfv @ XM @ ccsca))) => ((! [Xx3:$i] : (Xc_0 = (ccfv @ (XR @ Xx3) @ cc0g))) => ((! [Xx3:$i] : (Xc_1 = (ccfv @ (XR @ Xx3) @ ccur))) => ((XF = (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = XX) @ Xc_1 @ Xc_0)))) => ((cw3a @ (cwcel @ XM @ cclmod) @ (cwcel @ XV @ (ccpw @ XB2)) @ (cwcel @ XX @ XV)) => (cwcel @ (cco @ XF @ Xc_0 @ ccsupp) @ ccfn)))))))))))))))).
