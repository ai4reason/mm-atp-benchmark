...
thf(agtndiv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccn) @ (cwbr @ XB2 @ XA2 @ cclt)) => (~ (cwcel @ (cco @ XB2 @ XA2 @ ccdiv) @ ccz)))))).
...
thf(cprime_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => ((cwral @ (^ [Xx3:$i] : ((cwcel @ (cco @ XA2 @ (ccv @ Xx3) @ ccdiv) @ ccn) => (((ccv @ Xx3) = cc1) | ((ccv @ Xx3) = XA2)))) @ (^ [Xx3:$i] : ccn)) <=> (cwral @ (^ [Xx3:$i] : ((cw3a @ (cwbr @ cc1 @ (ccv @ Xx3) @ cclt) @ (cwbr @ (ccv @ Xx3) @ XA2 @ ccle) @ (cwcel @ (cco @ XA2 @ (ccv @ Xx3) @ ccdiv) @ ccn)) => ((ccv @ Xx3) = XA2))) @ (^ [Xx3:$i] : ccn)))))).
