...
thf(adf_mamu_ax,axiom,(ccmmul = (ccmpt2 @ (^ [Xr:$i] : (^ [Xo:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xo:$i] : ccvv)) @ (^ [Xr:$i] : (^ [Xo:$i] : (ccsb @ (ccfv @ (ccfv @ (ccv @ Xo) @ cc1st) @ cc1st) @ (^ [Xm:$i] : (ccsb @ (ccfv @ (ccfv @ (ccv @ Xo) @ cc1st) @ cc2nd) @ (^ [Xn:$i] : (ccsb @ (ccfv @ (ccv @ Xo) @ cc2nd) @ (^ [Xp:$i] : (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccfv @ (ccv @ Xr) @ ccbs) @ (ccxp @ (ccv @ Xm) @ (ccv @ Xn)) @ ccmap))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cco @ (ccfv @ (ccv @ Xr) @ ccbs) @ (ccxp @ (ccv @ Xn) @ (ccv @ Xp)) @ ccmap))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccmpt2 @ (^ [Xi:$i] : (^ [Xk:$i] : (ccv @ Xm))) @ (^ [Xi:$i] : (^ [Xk:$i] : (ccv @ Xp))) @ (^ [Xi:$i] : (^ [Xk:$i] : (cco @ (ccv @ Xr) @ (ccmpt @ (^ [Xj:$i] : (ccv @ Xn)) @ (^ [Xj:$i] : (cco @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccv @ Xx3)) @ (cco @ (ccv @ Xj) @ (ccv @ Xk) @ (ccv @ Xy1)) @ (ccfv @ (ccv @ Xr) @ ccmulr)))) @ ccgsu)))))))))))))))))).
thf(acsbie2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((! [Xx3:$i] : (! [Xy1:$i] : ((((ccv @ Xx3) = XA2) & ((ccv @ Xy1) = XB2)) => ((XC @ Xx3 @ Xy1) = XD)))) => ((ccsb @ XA2 @ (^ [Xx3:$i] : (ccsb @ XB2 @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1))))) = XD))))))))).
...
thf(aot1stg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwcel @ XC @ XX)) => ((ccfv @ (ccfv @ (ccotp @ XA2 @ XB2 @ XC) @ cc1st) @ cc1st) = XA2))))))))).
thf(aot2ndg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwcel @ XC @ XX)) => ((ccfv @ (ccfv @ (ccotp @ XA2 @ XB2 @ XC) @ cc1st) @ cc2nd) = XB2))))))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(aot3rdg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XC @ XV) => ((ccfv @ (ccotp @ XA2 @ XB2 @ XC) @ cc2nd) = XC))))))).
