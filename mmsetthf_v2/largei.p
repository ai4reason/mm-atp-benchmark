...
thf(ast0_ax,axiom,(! [XS:($i > $o)] : ((cwcel @ XS @ ccst) => ((ccfv @ cc0h @ XS) = ccc0)))).
thf(aeqcom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 = XB2) <=> (XB2 = XA2))))).
thf(amtt_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((~ Xph) => ((~ Xps) <=> (Xps => Xph)))))).
thf(astrb_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwral @ (^ [Xf1:$i] : (((ccfv @ XA2 @ (ccv @ Xf1)) = cc1) => ((ccfv @ XB2 @ (ccv @ Xf1)) = cc1))) @ (^ [Xf1:$i] : ccst)) <=> (cwss @ XA2 @ XB2))))))).
