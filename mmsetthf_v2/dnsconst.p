...
thf(afconst3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ (ccsn @ XB2) @ XF) <=> ((cwfn @ XF @ XA2) & (cwss @ XA2 @ (ccima @ (cccnv @ XF) @ (ccsn @ XB2))))))))).
thf(cdnsconst_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => ((((cwcel @ XK @ cct1) & (cwcel @ XF @ (cco @ XJ @ XK @ cccn))) & (cw3a @ (cwcel @ XP @ XY) @ (cwss @ XA2 @ (ccima @ (cccnv @ XF) @ (ccsn @ XP))) @ ((ccfv @ XA2 @ (ccfv @ XJ @ cccl)) = XX))) => (cwf @ XX @ (ccsn @ XP) @ XF)))))))))))).
