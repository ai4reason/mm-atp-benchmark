...
thf(aiocinioc2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) & (cwbr @ XA2 @ XB2 @ ccle)) => ((ccin @ (cco @ XA2 @ XC @ ccioc) @ (cco @ XB2 @ XC @ ccioc)) = (cco @ XB2 @ XC @ ccioc))))))).
...
thf(ciocinif_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) => ((ccin @ (cco @ XA2 @ XC @ ccioc) @ (cco @ XB2 @ XC @ ccioc)) = (ccif @ (cwbr @ XA2 @ XB2 @ cclt) @ (cco @ XB2 @ XC @ ccioc) @ (cco @ XA2 @ XC @ ccioc)))))))).
