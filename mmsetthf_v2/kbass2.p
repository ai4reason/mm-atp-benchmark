...
thf(ahfmval_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwf @ cchil @ ccc @ XT) @ (cwcel @ XB2 @ cchil)) => ((ccfv @ XB2 @ (cco @ XA2 @ XT @ cchft)) = (cco @ XA2 @ (ccfv @ XB2 @ XT) @ ccmul))))))).
...
thf(ckbass2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil) @ (cwcel @ XC @ cchil)) => ((cco @ (ccfv @ XB2 @ (ccfv @ XA2 @ ccbr)) @ (ccfv @ XC @ ccbr) @ cchft) = (cccom @ (ccfv @ XA2 @ ccbr) @ (cco @ XB2 @ XC @ cck)))))))).
