...
thf(amulgcd_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccn0) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) => ((cco @ (cco @ XK @ XM @ ccmul) @ (cco @ XK @ XN @ ccmul) @ ccgcd) = (cco @ XK @ (cco @ XM @ XN @ ccgcd) @ ccmul))))))).
thf(asimp12_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cw3a @ (cw3a @ Xph @ Xps @ Xch) @ Xth @ Xta) => Xps))))))).
thf(amulgcdr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccn0)) => ((cco @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XC @ ccmul) @ ccgcd) = (cco @ (cco @ XA2 @ XB2 @ ccgcd) @ XC @ ccmul))))))).
...
thf(agcdid_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cco @ XN @ XN @ ccgcd) = (ccfv @ XN @ ccabs))))).
thf(asyl2anc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xph => Xch) => (((Xps & Xch) => Xth) => (Xph => Xth))))))))).
thf(asimp2_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) => Xps))))).
thf(ccneg_tp,type,(ccneg : (($i > $o) > ($i > $o)))).
thf(agcdabs1_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XM @ ccz)) => ((cco @ (ccfv @ XN @ ccabs) @ XM @ ccgcd) = (cco @ XN @ XM @ ccgcd)))))).
thf(cclt_tp,type,(cclt : ($i > $o))).
thf(ccr_tp,type,(ccr : ($i > $o))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(ccsup_tp,type,(ccsup : (($i > $o) > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(ccif_tp,type,(ccif : ($o > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(agcdass_ax,axiom,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XP @ ccz)) => ((cco @ (cco @ XN @ XM @ ccgcd) @ XP @ ccgcd) = (cco @ XN @ (cco @ XM @ XP @ ccgcd) @ ccgcd))))))).
...
thf(ccoprimeprodsq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccn0) @ (cwcel @ XB2 @ ccz) @ (cwcel @ XC @ ccn0)) & ((cco @ (cco @ XA2 @ XB2 @ ccgcd) @ XC @ ccgcd) = cc1)) => (((cco @ XC @ cc2 @ ccexp) = (cco @ XA2 @ XB2 @ ccmul)) => (XA2 = (cco @ (cco @ XA2 @ XC @ ccgcd) @ cc2 @ ccexp)))))))).
