...
thf(aexp520_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((((cw3a @ Xph @ Xps @ Xch) & (Xth & Xta)) => Xet) => (Xph => (Xps => (Xch => (Xth => (Xta => Xet))))))))))))).
...
thf(aomwordri_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) => ((cwss @ XA2 @ XB2) => (cwss @ (cco @ XA2 @ XC @ ccomu) @ (cco @ XB2 @ XC @ ccomu)))))))).
...
thf(aoe0lem_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (((Xph & (XA2 = cc0)) => Xps) => (((((cwcel @ XA2 @ ccon0) & Xph) & (cwcel @ cc0 @ XA2)) => Xps) => (((cwcel @ XA2 @ ccon0) & Xph) => Xps))))))).
...
thf(aoe0m1_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => ((cwcel @ cc0 @ XA2) <=> ((cco @ cc0 @ XA2 @ ccoe) = cc0))))).
...
thf(coewordri_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XB2 @ ccon0) & (cwcel @ XC @ ccon0)) => ((cwcel @ XA2 @ XB2) => (cwss @ (cco @ XA2 @ XC @ ccoe) @ (cco @ XB2 @ XC @ ccoe)))))))).
