...
thf(abcs2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ cchil) @ (cwcel @ XB2 @ cchil) @ (cwbr @ (ccfv @ XA2 @ ccno) @ cc1 @ ccle)) => (cwbr @ (ccfv @ (cco @ XA2 @ XB2 @ ccsp) @ ccabs) @ (ccfv @ XB2 @ ccno) @ ccle))))).
...
thf(abra0_ax,axiom,((ccfv @ cc0v @ ccbr) = (ccxp @ cchil @ (ccsn @ ccc0)))).
thf(anorm0_ax,axiom,((ccfv @ cc0v @ ccno) = ccc0)).
thf(cbranmfn_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((ccfv @ (ccfv @ XA2 @ ccbr) @ ccnmf) = (ccfv @ XA2 @ ccno))))).
