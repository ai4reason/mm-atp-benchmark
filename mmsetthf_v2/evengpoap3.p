...
thf(cevengpoap3_conj,conjecture,(! [XN:($i > $o)] : ((cwral @ (^ [Xm:$i] : ((cwbr @ cc7 @ (ccv @ Xm) @ cclt) => (cwcel @ (ccv @ Xm) @ ccgbo))) @ (^ [Xm:$i] : ccodd)) => (((cwcel @ XN @ (ccfv @ (ccdc @ cc1 @ cc2) @ ccuz)) & (cwcel @ XN @ cceven)) => (cwrex @ (^ [Xo:$i] : (XN = (cco @ (ccv @ Xo) @ cc3 @ ccaddc))) @ (^ [Xo:$i] : ccgbo)))))).
