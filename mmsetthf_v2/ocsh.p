...
thf(aocval_ax,axiom,(! [XH:($i > $o)] : ((cwss @ XH @ cchil) => ((ccfv @ XH @ ccort) = (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsp) = ccc0)) @ (^ [Xy1:$i] : XH))) @ (^ [Xx3:$i] : cchil)))))).
...
thf(aocel_ax,axiom,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : ((cwss @ XH @ cchil) => ((cwcel @ XA2 @ (ccfv @ XH @ ccort)) <=> ((cwcel @ XA2 @ cchil) & (cwral @ (^ [Xx3:$i] : ((cco @ XA2 @ (ccv @ Xx3) @ ccsp) = ccc0)) @ (^ [Xx3:$i] : XH)))))))).
...
thf(aissh2_ax,axiom,(! [XH:($i > $o)] : ((cwcel @ XH @ ccsh) <=> (((cwss @ XH @ cchil) & (cwcel @ cc0v @ XH)) & ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccva) @ XH)) @ (^ [Xy1:$i] : XH))) @ (^ [Xx3:$i] : XH)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsm) @ XH)) @ (^ [Xy1:$i] : XH))) @ (^ [Xx3:$i] : ccc))))))).
