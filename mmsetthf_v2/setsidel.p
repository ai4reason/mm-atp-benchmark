...
thf(csetsidel_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((XR = (cco @ XS @ (ccop @ XA2 @ XB2) @ ccsts)) => (Xph => (cwcel @ (ccop @ XA2 @ XB2) @ XR))))))))))))).
