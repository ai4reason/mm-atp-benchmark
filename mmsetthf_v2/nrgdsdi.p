...
thf(cnrgdsdi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XR @ ccbs)) => ((XN = (ccfv @ XR @ ccnm)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XD = (ccfv @ XR @ ccds)) => (((cwcel @ XR @ ccnrg) & (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX))) => ((cco @ (ccfv @ XA2 @ XN) @ (cco @ XB2 @ XC @ XD) @ ccmul) = (cco @ (cco @ XA2 @ XB2 @ Xc_x) @ (cco @ XA2 @ XC @ Xc_x) @ XD)))))))))))))))).
