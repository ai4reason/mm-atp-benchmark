...
thf(aimval2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ ccim) = (cco @ (cco @ XA2 @ (ccfv @ XA2 @ cccj) @ ccmin) @ (cco @ cc2 @ cci @ ccmul) @ ccdiv))))).
