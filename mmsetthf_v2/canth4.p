...
thf(ccanth4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccopab @ (^ [Xx3:$i] : (^ [Xr:$i] : (((cwss @ (ccv @ Xx3) @ XA2) & (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)))) & ((cwwe @ (ccv @ Xx3) @ (ccv @ Xr)) & (cwral @ (^ [Xy1:$i] : ((ccfv @ (ccima @ (cccnv @ (ccv @ Xr)) @ (ccsn @ (ccv @ Xy1))) @ XF) = (ccv @ Xy1))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))) => ((XB2 = (ccuni @ (ccdm @ XW))) => ((! [Xx3:$i] : (! [Xr:$i] : ((XC @ Xx3 @ Xr) = (ccima @ (cccnv @ (ccfv @ XB2 @ XW)) @ (ccsn @ (ccfv @ XB2 @ XF)))))) => (! [Xx3:$i] : (! [Xr:$i] : ((cw3a @ (cwcel @ XA2 @ XV) @ (cwf @ XD @ XA2 @ XF) @ (cwss @ (ccin @ (ccpw @ XA2) @ (ccdm @ cccrd)) @ XD)) => (cw3a @ (cwss @ XB2 @ XA2) @ (cwpss @ (XC @ Xx3 @ Xr) @ XB2) @ ((ccfv @ XB2 @ XF) = (ccfv @ (XC @ Xx3 @ Xr) @ XF))))))))))))))))).
