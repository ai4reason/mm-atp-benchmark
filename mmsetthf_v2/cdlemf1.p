...
thf(ccdlemf1_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((! [Xq:$i] : ((Xc_or @ Xq) = (ccfv @ XK @ ccjn))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ ((cwcel @ XU @ XA2) & (cwbr @ XU @ XW @ Xc_le)) @ ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le)))) => (cwrex @ (^ [Xq:$i] : (cw3a @ (cwne @ XP @ (ccv @ Xq)) @ (~ (cwbr @ (ccv @ Xq) @ XW @ Xc_le)) @ (cwbr @ XU @ (cco @ XP @ (ccv @ Xq) @ (Xc_or @ Xq)) @ Xc_le))) @ (^ [Xq:$i] : XA2)))))))))))))))).
