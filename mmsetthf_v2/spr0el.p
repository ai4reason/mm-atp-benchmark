...
thf(aspr0nelg_ax,axiom,(cwnel @ cc0 @ (ccab @ (^ [Xp:$i] : (? [Xa:$i] : (? [Xb:$i] : ((ccv @ Xp) = (ccpr @ (ccv @ Xa) @ (ccv @ Xb))))))))).
...
thf(asprssspr_ax,axiom,(! [XV:($i > $o)] : (cwss @ (ccfv @ XV @ ccspr) @ (ccab @ (^ [Xp:$i] : (? [Xa:$i] : (? [Xb:$i] : ((ccv @ Xp) = (ccpr @ (ccv @ Xa) @ (ccv @ Xb)))))))))).
thf(adf_nel_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwnel @ XA2 @ XB2) <=> (~ (cwcel @ XA2 @ XB2)))))).
thf(cspr0el_conj,conjecture,(! [XV:($i > $o)] : (cwnel @ cc0 @ (ccfv @ XV @ ccspr)))).
