...
thf(apwsn_ax,axiom,(! [XA2:($i > $o)] : ((ccpw @ (ccsn @ XA2)) = (ccpr @ cc0 @ (ccsn @ XA2))))).
...
thf(cesumsnf_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwnfc @ (^ [Xk:$i] : (XB2 @ Xk))) => ((! [Xk:$i] : ((Xph & ((ccv @ Xk) = XM)) => ((XA2 @ Xk) = (XB2 @ Xk)))) => ((! [Xk:$i] : (Xph => (cwcel @ XM @ (XV @ Xk)))) => ((! [Xk:$i] : (Xph => (cwcel @ (XB2 @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => (! [Xk:$i] : (Xph => ((ccesum @ (^ [Xk:$i] : (ccsn @ XM)) @ (^ [Xk:$i] : (XA2 @ Xk))) = (XB2 @ Xk)))))))))))))).
