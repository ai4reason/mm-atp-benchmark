...
thf(aftc1anclem3_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (ccdm @ ccitg1)) & (cwcel @ XG @ (ccdm @ ccitg1))) => (cwcel @ (cccom @ ccabs @ (cco @ XF @ (cco @ (ccxp @ ccr @ (ccsn @ cci)) @ XG @ (ccof @ ccmul)) @ (ccof @ ccaddc))) @ (ccdm @ ccitg1)))))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(ccmnf_tp,type,(ccmnf : ($i > $o))).
thf(aioombl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwcel @ (cco @ XA2 @ XB2 @ ccioo) @ (ccdm @ ccvol))))).
thf(ai1fres_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0))))) => (! [Xx3:$i] : (((cwcel @ XF @ (ccdm @ ccitg1)) & (cwcel @ XA2 @ (ccdm @ ccvol))) => (cwcel @ (XG @ Xx3) @ (ccdm @ ccitg1))))))))).
...
thf(a_0pledm_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwfn @ XF @ XA2)) => (Xph => ((cwbr @ cc0p @ XF @ (ccofr @ ccle)) <=> (cwbr @ (ccxp @ XA2 @ (ccsn @ ccc0)) @ XF @ (ccofr @ ccle)))))))))).
...
thf(aitg2itg1_ax,axiom,(! [XF:($i > $o)] : (((cwcel @ XF @ (ccdm @ ccitg1)) & (cwbr @ cc0p @ XF @ (ccofr @ ccle))) => ((ccfv @ XF @ ccitg2) = (ccfv @ XF @ ccitg1))))).
...
thf(aabsi_ax,axiom,((ccfv @ cci @ ccabs) = cc1)).
...
thf(age0addcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ ccpnf @ ccico)) & (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccico))) => (cwcel @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ ccc0 @ ccpnf @ ccico)))))).
thf(aitg2const_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwcel @ (ccfv @ XA2 @ ccvol) @ ccr) @ (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccico))) => ((ccfv @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwcel @ (ccv @ Xx3) @ XA2) @ XB2 @ ccc0))) @ ccitg2) = (cco @ XB2 @ (ccfv @ XA2 @ ccvol) @ ccmul)))))).
...
thf(aabssubge0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ ccle)) => ((ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccabs) = (cco @ XB2 @ XA2 @ ccmin)))))).
thf(asimpr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(altdiv1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccrp)) => (Xph => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (cco @ XA2 @ XC @ ccdiv) @ (cco @ XB2 @ XC @ ccdiv) @ cclt))))))))))).
thf(cftc1anclem7_conj,conjecture,(! [Xph:$o] : (! [Xw:$i] : (! [Xu:$i] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xf1:$i] : (! [Xg1:$i] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xt:$i] : ((XG @ Xx3 @ Xt) = (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccitg @ (^ [Xt:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccioo)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ XF)))))))) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ XD)) => ((Xph => (cwss @ XD @ ccr)) => ((Xph => (cwcel @ XF @ ccibl)) => ((Xph => (cwf @ XD @ ccc @ XF)) => (! [Xy1:$i] : (((((((Xph & ((cwcel @ (ccv @ Xf1) @ (ccdm @ ccitg1)) & (cwcel @ (ccv @ Xg1) @ (ccdm @ ccitg1)))) & (cwbr @ (ccfv @ (ccmpt @ (^ [Xt:$i] : ccr) @ (^ [Xt:$i] : (ccfv @ (cco @ (ccif @ (cwcel @ (ccv @ Xt) @ XD) @ (ccfv @ (ccv @ Xt) @ XF) @ ccc0) @ (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (cco @ cci @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul) @ ccaddc) @ ccmin) @ ccabs))) @ ccitg2) @ (cco @ (ccv @ Xy1) @ cc2 @ ccdiv) @ cclt)) & (cwrex @ (^ [Xr:$i] : (cwne @ (ccv @ Xr) @ ccc0)) @ (^ [Xr:$i] : (ccun @ (ccrn @ (ccv @ Xf1)) @ (ccrn @ (ccv @ Xg1)))))) & (cwcel @ (ccv @ Xy1) @ ccrp)) & (cw3a @ (cwcel @ (ccv @ Xu) @ (cco @ XA2 @ XB2 @ ccicc)) @ (cwcel @ (ccv @ Xw) @ (cco @ XA2 @ XB2 @ ccicc)) @ (cwbr @ (ccv @ Xu) @ (ccv @ Xw) @ ccle))) & (cwbr @ (ccfv @ (cco @ (ccv @ Xw) @ (ccv @ Xu) @ ccmin) @ ccabs) @ (cco @ (cco @ (ccv @ Xy1) @ cc2 @ ccdiv) @ (cco @ cc2 @ (ccsup @ (ccima @ ccabs @ (ccun @ (ccrn @ (ccv @ Xf1)) @ (ccrn @ (ccv @ Xg1)))) @ ccr @ cclt) @ ccmul) @ ccdiv) @ cclt)) => (cwbr @ (cco @ (ccfv @ (ccmpt @ (^ [Xt:$i] : ccr) @ (^ [Xt:$i] : (ccif @ (cwcel @ (ccv @ Xt) @ (cco @ (ccv @ Xu) @ (ccv @ Xw) @ ccioo)) @ (ccfv @ (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (cco @ cci @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul) @ ccaddc) @ ccabs) @ ccc0))) @ ccitg2) @ (ccfv @ (ccmpt @ (^ [Xt:$i] : ccr) @ (^ [Xt:$i] : (ccif @ (cwcel @ (ccv @ Xt) @ (cco @ (ccv @ Xu) @ (ccv @ Xw) @ ccioo)) @ (ccfv @ (cco @ (ccfv @ (ccv @ Xt) @ XF) @ (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (cco @ cci @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul) @ ccaddc) @ ccmin) @ ccabs) @ ccc0))) @ ccitg2) @ ccaddc) @ (cco @ (cco @ (ccv @ Xy1) @ cc2 @ ccdiv) @ (cco @ (ccv @ Xy1) @ cc2 @ ccdiv) @ ccaddc) @ cclt)))))))))))))))))))))).
