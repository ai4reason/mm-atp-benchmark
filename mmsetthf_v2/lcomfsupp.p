...
thf(alcomf_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XB2 = (ccfv @ XW @ ccbs)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwf @ XI @ XK @ XG)) => ((Xph => (cwf @ XI @ XB2 @ XH)) => ((Xph => (cwcel @ XI @ XV)) => (Xph => (cwf @ XI @ XB2 @ (cco @ XG @ XH @ (ccof @ Xc_x))))))))))))))))))))))).
