...
thf(adfsmo2_ax,axiom,(! [XF:($i > $o)] : ((cwsmo @ XF) <=> (cw3a @ (cwf @ (ccdm @ XF) @ ccon0 @ XF) @ (cword @ (ccdm @ XF)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xx3:$i] : (ccdm @ XF))))))).
...
thf(aordin_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cword @ XA2) & (cword @ XB2)) => (cword @ (ccin @ XA2 @ XB2)))))).
...
thf(csmores2_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwsmo @ XF) & (cword @ XA2)) => (cwsmo @ (ccres @ XF @ XA2)))))).
