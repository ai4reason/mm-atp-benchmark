...
thf(cntrcls0_conj,conjecture,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX) @ ((ccfv @ (ccfv @ XS @ (ccfv @ XJ @ cccl)) @ (ccfv @ XJ @ ccnt)) = cc0)) => ((ccfv @ XS @ (ccfv @ XJ @ ccnt)) = cc0))))))).
