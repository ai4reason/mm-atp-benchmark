...
thf(covnsubadd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((Xph => (cwf @ ccn @ (ccpw @ (cco @ ccr @ XX @ ccmap)) @ XA2)) => (Xph => (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XA2))) @ (ccfv @ XX @ ccovoln)) @ (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XA2) @ (ccfv @ XX @ ccovoln)))) @ ccsumge0) @ ccle)))))))).
