...
thf(ccpm2mvalel_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XI = (cco @ XN @ XR @ cccpmat2mat)) => ((XS = (cco @ XN @ XR @ cccpmat)) => (((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ XV) @ (cwcel @ XM @ XS)) & ((cwcel @ XX @ XN) & (cwcel @ XY @ XN))) => ((cco @ XX @ XY @ (ccfv @ XM @ XI)) = (ccfv @ ccc0 @ (ccfv @ (cco @ XX @ XY @ XM) @ ccco1))))))))))))))).
