...
thf(algslem4_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xx3:$i] : ((XZ @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccv @ Xx3) @ ccabs) @ cc1 @ ccle)) @ (^ [Xx3:$i] : ccz)))) => (! [Xx3:$i] : (((cwcel @ XA2 @ ccz) & (cwcel @ (XP @ Xx3) @ (ccdif @ ccprime @ (ccsn @ cc2)))) => (cwcel @ (cco @ (cco @ (cco @ (cco @ XA2 @ (cco @ (cco @ (XP @ Xx3) @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccexp) @ cc1 @ ccaddc) @ (XP @ Xx3) @ ccmo) @ cc1 @ ccmin) @ (XZ @ Xx3))))))))).
...
thf(apczcl_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XP @ ccprime) & ((cwcel @ XN @ ccz) & (cwne @ XN @ ccc0))) => (cwcel @ (cco @ XP @ XN @ ccpc) @ ccn0))))).
thf(cwss_tp,type,(cwss : (($i > $o) > (($i > $o) > $o)))).
thf(aexpcllem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : ((cwss @ XF @ ccc) => ((! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ XF) & (cwcel @ (ccv @ Xy1) @ XF)) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmul) @ XF)))) => ((cwcel @ cc1 @ XF) => (! [Xy1:$i] : (((cwcel @ XA2 @ XF) & (cwcel @ (XB2 @ Xy1) @ ccn0)) => (cwcel @ (cco @ XA2 @ (XB2 @ Xy1) @ ccexp) @ XF)))))))))).
