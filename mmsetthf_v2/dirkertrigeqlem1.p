...
thf(acos2pi_ax,axiom,((ccfv @ (cco @ cc2 @ ccpi @ ccmul) @ cccos) = cc1)).
...
thf(cdirkertrigeqlem1_conj,conjecture,(! [XK:($i > $o)] : ((cwcel @ XK @ ccn) => ((ccsu @ (cco @ cc1 @ (cco @ cc2 @ XK @ ccmul) @ ccfz) @ (^ [Xn:$i] : (ccfv @ (cco @ (ccv @ Xn) @ ccpi @ ccmul) @ cccos))) = ccc0)))).
