...
thf(arpxdivcld_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwcel @ XB2 @ ccrp)) => (Xph => (cwcel @ (cco @ XA2 @ XB2 @ ccxdiv) @ ccrp)))))))).
...
thf(cprobfinmeasbOLD_conj,conjecture,(! [XS:($i > $o)] : (! [XM:($i > $o)] : (((cwcel @ XM @ (ccfv @ XS @ ccmeas)) & (cwcel @ (ccfv @ (ccuni @ XS) @ XM) @ ccrp)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ XM) @ (ccfv @ (ccuni @ XS) @ XM) @ ccxdiv))) @ ccprb))))).
