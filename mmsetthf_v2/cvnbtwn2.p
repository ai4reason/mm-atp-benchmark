...
thf(ccvnbtwn2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) => ((cwbr @ XA2 @ XB2 @ cccv) => (((cwpss @ XA2 @ XC) & (cwss @ XC @ XB2)) => (XC = XB2)))))))).
