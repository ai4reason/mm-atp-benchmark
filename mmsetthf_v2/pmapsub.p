...
thf(cpmapsub_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((XS = (ccfv @ XK @ ccpsubsp)) => ((XM = (ccfv @ XK @ ccpmap)) => (((cwcel @ XK @ cclat) & (cwcel @ XX @ XB2)) => (cwcel @ (ccfv @ XX @ XM) @ XS))))))))))).
