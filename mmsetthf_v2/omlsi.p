...
thf(aelimhyp2v_ax,axiom,(! [Xph:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((XA2 = (ccif @ Xph @ XA2 @ XC)) => (Xph <=> Xch)) => (((XB2 = (ccif @ Xph @ XB2 @ XD)) => (Xch <=> Xth)) => (((XC = (ccif @ Xph @ XA2 @ XC)) => (Xta <=> Xet)) => (((XD = (ccif @ Xph @ XB2 @ XD)) => (Xet <=> Xth)) => (Xta => Xth))))))))))))))).
...
thf(comlsi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccsh) => (((cwss @ XA2 @ XB2) & ((ccin @ XB2 @ (ccfv @ XA2 @ ccort)) = cc0h)) => (XA2 = XB2))))))).
