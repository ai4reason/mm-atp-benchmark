...
thf(apclfinN_ax,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XU = (ccfv @ XK @ ccpclN)) => (((cwcel @ XK @ ccal) & (cwss @ XX @ XA2)) => ((ccfv @ XX @ XU) = (cciun @ (^ [Xy1:$i] : (ccin @ ccfn @ (ccpw @ XX))) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XU)))))))))))).
...
thf(cpclcmpatN_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XU = (ccfv @ XK @ ccpclN)) => ((cw3a @ (cwcel @ XK @ ccal) @ (cwss @ XX @ XA2) @ (cwcel @ XP @ (ccfv @ XX @ XU))) => (cwrex @ (^ [Xy1:$i] : ((cwss @ (ccv @ Xy1) @ XX) & (cwcel @ XP @ (ccfv @ (ccv @ Xy1) @ XU)))) @ (^ [Xy1:$i] : ccfn))))))))))).
