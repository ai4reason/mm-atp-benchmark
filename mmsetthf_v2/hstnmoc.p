...
thf(ahstoc_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XS @ cchst) & (cwcel @ XA2 @ ccch)) => ((cco @ (ccfv @ XA2 @ XS) @ (ccfv @ (ccfv @ XA2 @ ccort) @ XS) @ ccva) = (ccfv @ cchil @ XS)))))).
...
thf(ahstorth_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : ((((cwcel @ XS @ cchst) & (cwcel @ XA2 @ ccch)) & ((cwcel @ XB2 @ ccch) & (cwss @ XA2 @ (ccfv @ XB2 @ ccort)))) => ((cco @ (ccfv @ XA2 @ XS) @ (ccfv @ XB2 @ XS) @ ccsp) = ccc0)))))).
...
thf(ahst1a_ax,axiom,(! [XS:($i > $o)] : ((cwcel @ XS @ cchst) => ((ccfv @ (ccfv @ cchil @ XS) @ ccno) = cc1)))).
