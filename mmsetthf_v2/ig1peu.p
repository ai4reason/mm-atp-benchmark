...
thf(adeg1n0ima_ax,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_0:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((cwcel @ XR @ ccrg) => (cwss @ (ccima @ XD @ (ccdif @ XB2 @ (ccsn @ Xc_0))) @ ccn0)))))))))))).
...
thf(alidl0cl_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_0:($i > $o)] : ((XU = (ccfv @ XR @ cclidl)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccrg) & (cwcel @ XI @ XU)) => (cwcel @ Xc_0 @ XI))))))))).
...
thf(adeg1xrf_ax,axiom,(! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => (cwf @ XB2 @ ccxr @ XD))))))))).
thf(affn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => (cwfn @ XF @ XA2)))))).
thf(assdifssd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwss @ XA2 @ XB2)) => (Xph => (cwss @ (ccdif @ XA2 @ XC) @ XB2)))))))).
thf(afnimaeq0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XA2) & (cwss @ XB2 @ XA2)) => (((ccima @ XF @ XB2) = cc0) <=> (XB2 = cc0))))))).
...
thf(adrnguc1p_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((XC = (ccfv @ XR @ ccuc1p)) => ((cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XF @ XB2) @ (cwne @ XF @ Xc_0)) => (cwcel @ XF @ XC))))))))))))).
...
thf(auc1pmon1p_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((XC = (ccfv @ XR @ ccuc1p)) => ((XM = (ccfv @ XR @ ccmn1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_x = (ccfv @ XP @ ccmulr)) => ((XA2 = (ccfv @ XP @ ccascl)) => ((XD = (ccfv @ XR @ ccdg1)) => ((XI = (ccfv @ XR @ ccinvr)) => (((cwcel @ XR @ ccrg) & (cwcel @ XX @ XC)) => (cwcel @ (cco @ (ccfv @ (ccfv @ (ccfv @ (ccfv @ XX @ XD) @ (ccfv @ XX @ ccco1)) @ XI) @ XA2) @ XX @ Xc_x) @ XM))))))))))))))))))).
...
thf(adeg1submon1p_ax,axiom,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XD = (ccfv @ XR @ ccdg1)) => ((XO = (ccfv @ XR @ ccmn1)) => ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_mi = (ccfv @ XP @ ccsg)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XF @ XO)) => ((Xph => ((ccfv @ XF @ XD) = XX)) => ((Xph => (cwcel @ XG @ XO)) => ((Xph => ((ccfv @ XG @ XD) = XX)) => (Xph => (cwbr @ (ccfv @ (cco @ XF @ XG @ Xc_mi) @ XD) @ XX @ cclt))))))))))))))))))))).
...
thf(alidlsubcl_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XU = (ccfv @ XR @ cclidl)) => ((Xc_mi = (ccfv @ XR @ ccsg)) => ((((cwcel @ XR @ ccrg) & (cwcel @ XI @ XU)) & ((cwcel @ XX @ XI) & (cwcel @ XY @ XI))) => (cwcel @ (cco @ XX @ XY @ Xc_mi) @ XI))))))))))).
...
thf(cig1peu_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XU = (ccfv @ XP @ cclidl)) => ((Xc_0 = (ccfv @ XP @ cc0g)) => ((XM = (ccfv @ XR @ ccmn1)) => ((XD = (ccfv @ XR @ ccdg1)) => ((cw3a @ (cwcel @ XR @ ccdr) @ (cwcel @ XI @ XU) @ (cwne @ XI @ (ccsn @ Xc_0))) => (cwreu @ (^ [Xg1:$i] : ((ccfv @ (ccv @ Xg1) @ XD) = (ccinf @ (ccima @ XD @ (ccdif @ XI @ (ccsn @ Xc_0))) @ ccr @ cclt))) @ (^ [Xg1:$i] : (ccin @ XI @ XM))))))))))))))))).
