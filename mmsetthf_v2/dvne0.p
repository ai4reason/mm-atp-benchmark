...
thf(advgt0_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => ((Xph => (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ ccrp @ (cco @ ccr @ XF @ ccdv))) => (Xph => (cwiso @ (cco @ XA2 @ XB2 @ ccicc) @ (ccrn @ XF) @ cclt @ cclt @ XF))))))))))).
...
thf(advlt0_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => ((Xph => (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ (cco @ ccmnf @ ccc0 @ ccioo) @ (cco @ ccr @ XF @ ccdv))) => (Xph => (cwiso @ (cco @ XA2 @ XB2 @ ccicc) @ (ccrn @ XF) @ cclt @ (cccnv @ cclt) @ XF))))))))))).
...
thf(advivth_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XM @ (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => (cwcel @ XN @ (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ cccncf))) => ((Xph => ((ccdm @ (cco @ ccr @ XF @ ccdv)) = (cco @ XA2 @ XB2 @ ccioo))) => (Xph => (cwss @ (cco @ (ccfv @ XM @ (cco @ ccr @ XF @ ccdv)) @ (ccfv @ XN @ (cco @ ccr @ XF @ ccdv)) @ ccicc) @ (ccrn @ (cco @ ccr @ XF @ ccdv))))))))))))))).
...
thf(cdvne0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => ((Xph => ((ccdm @ (cco @ ccr @ XF @ ccdv)) = (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => (~ (cwcel @ ccc0 @ (ccrn @ (cco @ ccr @ XF @ ccdv))))) => (Xph => ((cwiso @ (cco @ XA2 @ XB2 @ ccicc) @ (ccrn @ XF) @ cclt @ cclt @ XF) | (cwiso @ (cco @ XA2 @ XB2 @ ccicc) @ (ccrn @ XF) @ cclt @ (cccnv @ cclt) @ XF))))))))))))).
