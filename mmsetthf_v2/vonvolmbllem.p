...
thf(assmapsn_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((cwnfc @ (^ [Xf1:$i] : (XD @ Xf1))) => ((! [Xf1:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xf1)))) => ((! [Xf1:$i] : (Xph => (cwss @ XC @ (cco @ (XB2 @ Xf1) @ (ccsn @ XA2) @ ccmap)))) => ((! [Xf1:$i] : ((XD @ Xf1) = (cciun @ (^ [Xf1:$i] : XC) @ (^ [Xf1:$i] : (ccrn @ (ccv @ Xf1)))))) => (! [Xf1:$i] : (Xph => (XC = (cco @ (XD @ Xf1) @ (ccsn @ XA2) @ ccmap))))))))))))))).
thf(anfcv_ax,axiom,(! [XA2:($i > $o)] : (cwnfc @ (^ [Xx3:$i] : XA2)))).
thf(ainmap_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((Xph => (cwcel @ XC @ XZ)) => (Xph => ((ccin @ (cco @ XA2 @ XC @ ccmap) @ (cco @ XB2 @ XC @ ccmap)) = (cco @ (ccin @ XA2 @ XB2) @ XC @ ccmap)))))))))))))).
...
thf(aovnovol_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwss @ XB2 @ ccr)) => (Xph => ((ccfv @ (cco @ XB2 @ (ccsn @ XA2) @ ccmap) @ (ccfv @ (ccsn @ XA2) @ ccovoln)) = (ccfv @ XB2 @ ccovol)))))))))).
thf(assinss1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwss @ XA2 @ XC)) => (Xph => (cwss @ (ccin @ XA2 @ XB2) @ XC)))))))).
thf(adifeq1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((ccdif @ XA2 @ XC) = (ccdif @ XB2 @ XC))))))))).
thf(ccop_tp,type,(ccop : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(adifmapsn_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((Xph => (cwcel @ XC @ XZ)) => (Xph => ((ccdif @ (cco @ XA2 @ (ccsn @ XC) @ ccmap) @ (cco @ XB2 @ (ccsn @ XC) @ ccmap)) = (cco @ (ccdif @ XA2 @ XB2) @ (ccsn @ XC) @ ccmap)))))))))))))).
