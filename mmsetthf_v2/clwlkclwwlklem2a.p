...
thf(alttri3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((XA2 = XB2) <=> ((~ (cwbr @ XA2 @ XB2 @ cclt)) & (~ (cwbr @ XB2 @ XA2 @ cclt)))))))).
thf(aifel_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ (ccif @ Xph @ XA2 @ XB2) @ XC) <=> ((Xph & (cwcel @ XA2 @ XC)) | ((~ Xph) & (cwcel @ XB2 @ XC))))))))).
...
thf(aclwlkclwwlklem2a4_ax,axiom,(! [XP:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccfzo)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ (ccfv @ XP @ cchash) @ cc2 @ ccmin) @ cclt) @ (ccfv @ (ccpr @ (ccfv @ (ccv @ Xx3) @ XP) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XP)) @ (cccnv @ XE)) @ (ccfv @ (ccpr @ (ccfv @ (ccv @ Xx3) @ XP) @ (ccfv @ ccc0 @ XP)) @ (cccnv @ XE))))))) => (! [Xx3:$i] : ((cw3a @ (cwf1 @ (ccdm @ XE) @ (XR @ Xx3) @ XE) @ (cwcel @ XP @ (ccword @ XV)) @ (cwbr @ cc2 @ (ccfv @ XP @ cchash) @ ccle)) => ((((ccfv @ XP @ cclsw) = (ccfv @ ccc0 @ XP)) & (cwcel @ XI @ (cco @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccfzo))) => ((cwcel @ (ccpr @ (ccfv @ XI @ XP) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XP)) @ (ccrn @ XE)) => ((ccfv @ (ccfv @ XI @ (XF @ Xx3)) @ XE) = (ccpr @ (ccfv @ XI @ XP) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XP))))))))))))))).
...
thf(aclwlkclwwlklem2a3_ax,axiom,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccfzo)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ (ccfv @ XP @ cchash) @ cc2 @ ccmin) @ cclt) @ (ccfv @ (ccpr @ (ccfv @ (ccv @ Xx3) @ XP) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XP)) @ (cccnv @ XE)) @ (ccfv @ (ccpr @ (ccfv @ (ccv @ Xx3) @ XP) @ (ccfv @ ccc0 @ XP)) @ (cccnv @ XE))))))) => (! [Xx3:$i] : (((cwcel @ XP @ (ccword @ XV)) & (cwbr @ cc2 @ (ccfv @ XP @ cchash) @ ccle)) => ((ccfv @ (ccfv @ (XF @ Xx3) @ cchash) @ XP) = (ccfv @ XP @ cclsw)))))))))).
thf(cclwlkclwwlklem2a_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccfzo)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ (ccfv @ XP @ cchash) @ cc2 @ ccmin) @ cclt) @ (ccfv @ (ccpr @ (ccfv @ (ccv @ Xx3) @ XP) @ (ccfv @ (cco @ (ccv @ Xx3) @ cc1 @ ccaddc) @ XP)) @ (cccnv @ XE)) @ (ccfv @ (ccpr @ (ccfv @ (ccv @ Xx3) @ XP) @ (ccfv @ ccc0 @ XP)) @ (cccnv @ XE))))))) => (! [Xx3:$i] : ((cw3a @ (cwf1 @ (ccdm @ XE) @ XR @ XE) @ (cwcel @ XP @ (ccword @ XV)) @ (cwbr @ cc2 @ (ccfv @ XP @ cchash) @ ccle)) => ((((ccfv @ XP @ cclsw) = (ccfv @ ccc0 @ XP)) & ((cwral @ (^ [Xi:$i] : (cwcel @ (ccpr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP)) @ (ccrn @ XE))) @ (^ [Xi:$i] : (cco @ ccc0 @ (cco @ (cco @ (cco @ (ccfv @ XP @ cchash) @ cc1 @ ccmin) @ ccc0 @ ccmin) @ cc1 @ ccmin) @ ccfzo))) & (cwcel @ (ccpr @ (ccfv @ (cco @ (ccfv @ XP @ cchash) @ cc2 @ ccmin) @ XP) @ (ccfv @ ccc0 @ XP)) @ (ccrn @ XE)))) => ((cw3a @ (cwcel @ (XF @ Xx3) @ (ccword @ (ccdm @ XE))) @ (cwf @ (cco @ ccc0 @ (ccfv @ (XF @ Xx3) @ cchash) @ ccfz) @ XV @ XP) @ (cwral @ (^ [Xi:$i] : ((ccfv @ (ccfv @ (ccv @ Xi) @ (XF @ Xx3)) @ XE) = (ccpr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP)))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ (XF @ Xx3) @ cchash) @ ccfzo)))) & ((ccfv @ ccc0 @ XP) = (ccfv @ (ccfv @ (XF @ Xx3) @ cchash) @ XP))))))))))))).
