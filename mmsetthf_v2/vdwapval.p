...
thf(cvdwapval_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccn0) @ (cwcel @ XA2 @ ccn) @ (cwcel @ XD @ ccn)) => ((cwcel @ XX @ (cco @ XA2 @ XD @ (ccfv @ XK @ ccvdwa))) <=> (cwrex @ (^ [Xm:$i] : (XX = (cco @ XA2 @ (cco @ (ccv @ Xm) @ XD @ ccmul) @ ccaddc))) @ (^ [Xm:$i] : (cco @ ccc0 @ (cco @ XK @ cc1 @ ccmin) @ ccfz)))))))))).
