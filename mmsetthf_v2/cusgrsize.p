...
thf(acusgrres_ax,axiom,(! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : ((XF @ Xe) = (ccrab @ (^ [Xe:$i] : (cwnel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)))) => ((! [Xe:$i] : ((XS @ Xe) = (ccop @ (ccdif @ XV @ (ccsn @ XN)) @ (ccres @ ccid @ (XF @ Xe))))) => (! [Xe:$i] : (((cwcel @ XG @ cccusgr) & (cwcel @ XN @ XV)) => (cwcel @ (XS @ Xe) @ cccusgr)))))))))))))).
...
thf(acusgrusgr_ax,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ cccusgr) => (cwcel @ XG @ ccusgr)))).
thf(ausgruhgr_ax,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ ccusgr) => (cwcel @ XG @ ccuhgr)))).
thf(ccn_tp,type,(ccn : ($i > $o))).
thf(acusgrsizeindb0_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ ccuhgr) & ((ccfv @ XV @ cchash) = ccc0)) => ((ccfv @ XE @ cchash) = (cco @ (ccfv @ XV @ cchash) @ cc2 @ ccbc))))))))).
...
thf(acusgrsize2inds_ax,axiom,(! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > ($i > $o))] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((! [Xe:$i] : ((XF @ Xe) = (ccrab @ (^ [Xe:$i] : (cwnel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : XE)))) => (! [Xe:$i] : ((cwcel @ (XY @ Xe) @ ccn0) => ((cw3a @ (cwcel @ XG @ cccusgr) @ ((ccfv @ XV @ cchash) = (XY @ Xe)) @ (cwcel @ XN @ XV)) => (((ccfv @ (XF @ Xe) @ cchash) = (cco @ (ccfv @ (ccdif @ XV @ (ccsn @ XN)) @ cchash) @ cc2 @ ccbc)) => ((ccfv @ XE @ cchash) = (cco @ (ccfv @ XV @ cchash) @ cc2 @ ccbc)))))))))))))))).
thf(ccusgrsize_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XG @ cccusgr) & (cwcel @ XV @ ccfn)) => ((ccfv @ XE @ cchash) = (cco @ (ccfv @ XV @ cchash) @ cc2 @ ccbc))))))))).
