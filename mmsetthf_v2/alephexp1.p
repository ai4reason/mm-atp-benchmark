...
thf(aalephord3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((cwss @ XA2 @ XB2) <=> (cwss @ (ccfv @ XA2 @ ccale) @ (ccfv @ XB2 @ ccale))))))).
...
thf(calephexp1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) & (cwss @ XA2 @ XB2)) => (cwbr @ (cco @ (ccfv @ XA2 @ ccale) @ (ccfv @ XB2 @ ccale) @ ccmap) @ (cco @ cc2o @ (ccfv @ XB2 @ ccale) @ ccmap) @ ccen))))).
