...
thf(cgrpoinveu_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccrn @ XG)) => ((XU = (ccfv @ XG @ ccgi)) => (((cwcel @ XG @ ccgr) & (cwcel @ XA2 @ XX)) => (cwreu @ (^ [Xy1:$i] : ((cco @ (ccv @ Xy1) @ XA2 @ XG) = XU)) @ (^ [Xy1:$i] : XX)))))))))).
