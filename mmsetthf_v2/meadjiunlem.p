...
thf(ameaf_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccmea)) => ((XS = (ccdm @ XM)) => (Xph => (cwf @ XS @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)))))))).
...
thf(adisjf1_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ XV))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwne @ (XB2 @ Xx3) @ cc0))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwf1 @ XA2 @ XV @ (XF @ Xx3))))))))))))))).
...
thf(cmeadjiunlem_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xi:$i] : (Xph => (cwcel @ (XM @ Xi) @ ccmea))) => ((! [Xi:$i] : ((XS @ Xi) = (ccdm @ (XM @ Xi)))) => ((! [Xi:$i] : (Xph => (cwcel @ XX @ (XV @ Xi)))) => ((! [Xi:$i] : (Xph => (cwf @ XX @ (XS @ Xi) @ XG))) => ((XY = (ccrab @ (^ [Xi:$i] : (cwne @ (ccfv @ (ccv @ Xi) @ XG) @ cc0)) @ (^ [Xi:$i] : XX))) => ((Xph => (cwdisj @ (^ [Xi:$i] : XX) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ XG)))) => (! [Xi:$i] : (Xph => ((ccfv @ (ccres @ (XM @ Xi) @ (ccrn @ XG)) @ ccsumge0) = (ccfv @ (cccom @ (XM @ Xi) @ XG) @ ccsumge0)))))))))))))))))).
