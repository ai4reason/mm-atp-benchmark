...
thf(aiunxsnf_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XC @ Xx3))) => ((cwcel @ XA2 @ ccvv) => ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((XB2 @ Xx3) = (XC @ Xx3)))) => (! [Xx3:$i] : ((cciun @ (^ [Xx3:$i] : (ccsn @ XA2)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (XC @ Xx3)))))))))).
...
thf(a_0un_ax,axiom,(! [XA2:($i > $o)] : ((ccun @ cc0 @ XA2) = XA2))).
...
thf(cfiiuncl_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xz))) => (cwcel @ (XB2 @ Xx3) @ XD))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cw3a @ (Xph @ Xx3) @ (cwcel @ (ccv @ Xy1) @ XD) @ (cwcel @ (ccv @ Xz) @ XD)) => (cwcel @ (ccun @ (ccv @ Xy1) @ (ccv @ Xz)) @ XD))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xx3) => (cwcel @ (XA2 @ Xy1 @ Xz) @ ccfn))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xx3) => (cwne @ (XA2 @ Xy1 @ Xz) @ cc0))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((Xph @ Xx3) => (cwcel @ (cciun @ (^ [Xx3:$i] : (XA2 @ Xy1 @ Xz)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XD))))))))))))))).
