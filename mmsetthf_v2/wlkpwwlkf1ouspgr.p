...
thf(awlkiswwlks_ax,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XG @ ccuspgr) => ((? [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XP @ (ccfv @ XG @ ccwlks))) <=> (cwcel @ XP @ (ccfv @ XG @ ccwwlks))))))).
...
thf(aad4ant134_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (((cw3a @ Xph @ Xps @ Xch) => Xth) => ((((Xph & Xta) & Xps) & Xch) => Xth)))))))).
thf(ccmin_tp,type,(ccmin : ($i > $o))).
thf(cc1_tp,type,(cc1 : ($i > $o))).
thf(cco_tp,type,(cco : (($i > $o) > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(ccn0_tp,type,(ccn0 : ($i > $o))).
thf(cchash_tp,type,(cchash : ($i > $o))).
thf(auspgr2wlkeqi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : ((cw3a @ (cwcel @ XG @ ccuspgr) @ ((cwcel @ XA2 @ (ccfv @ XG @ ccwlks)) & (cwcel @ XB2 @ (ccfv @ XG @ ccwlks))) @ ((ccfv @ XA2 @ cc2nd) = (ccfv @ XB2 @ cc2nd))) => (XA2 = XB2)))))).
