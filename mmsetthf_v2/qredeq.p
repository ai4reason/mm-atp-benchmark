...
thf(cqredeq_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cw3a @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccn) @ ((cco @ XM @ XN @ ccgcd) = cc1)) @ (cw3a @ (cwcel @ XP @ ccz) @ (cwcel @ XQ @ ccn) @ ((cco @ XP @ XQ @ ccgcd) = cc1)) @ ((cco @ XM @ XN @ ccdiv) = (cco @ XP @ XQ @ ccdiv))) => ((XM = XP) & (XN = XQ)))))))).
