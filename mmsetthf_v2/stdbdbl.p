...
thf(cstdbdbl_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XD @ Xx3 @ Xy1) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XX)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XC) @ XR @ ccle) @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XC) @ XR))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (((cw3a @ (cwcel @ XC @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XR @ ccxr) @ (cwbr @ ccc0 @ XR @ cclt)) & (cw3a @ (cwcel @ XP @ XX) @ (cwcel @ (XS @ Xx3 @ Xy1) @ ccxr) @ (cwbr @ (XS @ Xx3 @ Xy1) @ XR @ ccle))) => ((cco @ XP @ (XS @ Xx3 @ Xy1) @ (ccfv @ (XD @ Xx3 @ Xy1) @ ccbl)) = (cco @ XP @ (XS @ Xx3 @ Xy1) @ (ccfv @ XC @ ccbl)))))))))))))).
