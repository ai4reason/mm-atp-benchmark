...
thf(axrnres2_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((ccres @ (ccxrn @ XR @ XS) @ XA2) = (ccxrn @ XR @ (ccres @ XS @ XA2))))))).
...
thf(aan2anr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) & (Xch & Xth)) <=> ((Xps & Xph) & (Xth & Xch)))))))).
