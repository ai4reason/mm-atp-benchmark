...
thf(aknoppndvlem5_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XJ:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xi:$i] : ((XT @ Xx3 @ Xi) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (ccv @ Xx3) @ ccmin) @ ccabs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((XF @ Xx3 @ Xy1 @ Xi @ Xn) = (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (XC @ Xx3 @ Xi) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (cco @ (cco @ (cco @ cc2 @ (XN @ Xi) @ ccmul) @ (ccv @ Xn) @ ccexp) @ (ccv @ Xy1) @ ccmul) @ (XT @ Xx3 @ Xi)) @ ccmul)))))))))) => ((! [Xx3:$i] : (! [Xi:$i] : ((Xph @ Xx3) => (cwcel @ (XA2 @ Xi) @ ccr)))) => ((! [Xx3:$i] : (! [Xi:$i] : ((Xph @ Xx3) => (cwcel @ (XC @ Xx3 @ Xi) @ ccr)))) => ((! [Xx3:$i] : (! [Xi:$i] : ((Xph @ Xx3) => (cwcel @ (XN @ Xi) @ ccn)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((Xph @ Xx3) => (cwcel @ (ccsu @ (cco @ ccc0 @ (XJ @ Xx3) @ ccfz) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (ccfv @ (XA2 @ Xi) @ (XF @ Xx3 @ Xy1 @ Xi @ Xn))))) @ ccr)))))))))))))))))).
thf(aeqeltrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (cwcel @ XB2 @ XC)) => (Xph => (cwcel @ XA2 @ XC))))))))).
thf(aa1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(aknoppndvlem1_ax,axiom,(! [Xph:$o] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XJ @ ccz)) => ((Xph => (cwcel @ XM @ ccz)) => (Xph => (cwcel @ (cco @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccneg @ XJ) @ ccexp) @ cc2 @ ccdiv) @ XM @ ccmul) @ ccr)))))))))).
...
thf(aknoppndvlem12_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XC @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo))) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwbr @ cc1 @ (cco @ XN @ (ccfv @ XC @ ccabs) @ ccmul) @ cclt)) => (Xph => ((cwne @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccfv @ XC @ ccabs) @ ccmul) @ cc1) & (cwbr @ cc1 @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccfv @ XC @ ccabs) @ ccmul) @ cc1 @ ccmin) @ cclt)))))))))).
thf(altne_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ XA2 @ XB2 @ cclt)) => (cwne @ XB2 @ XA2))))).
thf(aknoppndvlem11_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XJ:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xi:$i] : ((XT @ Xx3 @ Xi) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (ccv @ Xx3) @ ccmin) @ ccabs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((XF @ Xx3 @ Xy1 @ Xi @ Xn) = (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (XC @ Xx3 @ Xi) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (cco @ (cco @ (cco @ cc2 @ (XN @ Xi) @ ccmul) @ (ccv @ Xn) @ ccexp) @ (ccv @ Xy1) @ ccmul) @ (XT @ Xx3 @ Xi)) @ ccmul)))))))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ ccr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XB2 @ ccr))) => ((! [Xx3:$i] : (! [Xi:$i] : ((Xph @ Xx3) => (cwcel @ (XC @ Xx3 @ Xi) @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XJ @ Xx3) @ ccn0))) => ((! [Xx3:$i] : (! [Xi:$i] : ((Xph @ Xx3) => (cwcel @ (XN @ Xi) @ ccn)))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((Xph @ Xx3) => (cwbr @ (ccfv @ (cco @ (ccsu @ (cco @ ccc0 @ (cco @ (XJ @ Xx3) @ cc1 @ ccmin) @ ccfz) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (ccfv @ XB2 @ (XF @ Xx3 @ Xy1 @ Xi @ Xn))))) @ (ccsu @ (cco @ ccc0 @ (cco @ (XJ @ Xx3) @ cc1 @ ccmin) @ ccfz) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (ccfv @ XA2 @ (XF @ Xx3 @ Xy1 @ Xi @ Xn))))) @ ccmin) @ ccabs) @ (cco @ (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccabs) @ (ccsu @ (cco @ ccc0 @ (cco @ (XJ @ Xx3) @ cc1 @ ccmin) @ ccfz) @ (^ [Xi:$i] : (cco @ (cco @ (cco @ cc2 @ (XN @ Xi) @ ccmul) @ (ccfv @ (XC @ Xx3 @ Xi) @ ccabs) @ ccmul) @ (ccv @ Xi) @ ccexp))) @ ccmul) @ ccle))))))))))))))))))))).
...
thf(aabsexpz_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwcel @ XN @ ccz)) => ((ccfv @ (cco @ XA2 @ XN @ ccexp) @ ccabs) = (cco @ (ccfv @ XA2 @ ccabs) @ XN @ ccexp)))))).
...
thf(aknoppndvlem13_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XC @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo))) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwbr @ cc1 @ (cco @ XN @ (ccfv @ XC @ ccabs) @ ccmul) @ cclt)) => (Xph => (cwne @ XC @ ccc0))))))))).
...
thf(cknoppndvlem14_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XJ:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xi:$i] : ((XT @ Xx3 @ Xi) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ (ccv @ Xx3) @ ccmin) @ ccabs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((XF @ Xx3 @ Xy1 @ Xi @ Xn) = (ccmpt @ (^ [Xy1:$i] : ccr) @ (^ [Xy1:$i] : (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (XC @ Xx3) @ (ccv @ Xn) @ ccexp) @ (ccfv @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccv @ Xn) @ ccexp) @ (ccv @ Xy1) @ ccmul) @ (XT @ Xx3 @ Xi)) @ ccmul)))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xn:$i] : (XA2 = (cco @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccneg @ (XJ @ Xx3)) @ ccexp) @ cc2 @ ccdiv) @ (XM @ Xx3 @ Xy1 @ Xi @ Xn) @ ccmul)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xn:$i] : (XB2 = (cco @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccneg @ (XJ @ Xx3)) @ ccexp) @ cc2 @ ccdiv) @ (cco @ (XM @ Xx3 @ Xy1 @ Xi @ Xn) @ cc1 @ ccaddc) @ ccmul)))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XC @ Xx3) @ (cco @ (ccneg @ cc1) @ cc1 @ ccioo)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XJ @ Xx3) @ ccn0))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xi:$i] : (! [Xn:$i] : ((Xph @ Xx3) => (cwcel @ (XM @ Xx3 @ Xy1 @ Xi @ Xn) @ ccz)))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XN @ ccn))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwbr @ cc1 @ (cco @ XN @ (ccfv @ (XC @ Xx3) @ ccabs) @ ccmul) @ cclt))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((Xph @ Xx3) => (cwbr @ (ccfv @ (cco @ (ccsu @ (cco @ ccc0 @ (cco @ (XJ @ Xx3) @ cc1 @ ccmin) @ ccfz) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (ccfv @ XB2 @ (XF @ Xx3 @ Xy1 @ Xi @ Xn))))) @ (ccsu @ (cco @ ccc0 @ (cco @ (XJ @ Xx3) @ cc1 @ ccmin) @ ccfz) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xi) @ (ccfv @ XA2 @ (XF @ Xx3 @ Xy1 @ Xi @ Xn))))) @ ccmin) @ ccabs) @ (cco @ (cco @ (cco @ (ccfv @ (XC @ Xx3) @ ccabs) @ (XJ @ Xx3) @ ccexp) @ cc2 @ ccdiv) @ (cco @ cc1 @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ (ccfv @ (XC @ Xx3) @ ccabs) @ ccmul) @ cc1 @ ccmin) @ ccdiv) @ ccmul) @ ccle)))))))))))))))))))))))).
