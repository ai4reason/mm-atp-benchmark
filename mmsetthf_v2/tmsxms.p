...
thf(atmstopn_ax,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XK = (ccfv @ XD @ cctmt)) => ((XJ = (ccfv @ XD @ ccmopn)) => ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => (XJ = (ccfv @ XK @ cctopn)))))))))).
...
thf(ctmsxms_conj,conjecture,(! [XD:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XK = (ccfv @ XD @ cctmt)) => ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => (cwcel @ XK @ ccxme))))))).
