...
thf(aeldmgm_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn))) <=> ((cwcel @ XA2 @ ccc) & (~ (cwcel @ (ccneg @ XA2) @ ccn0)))))).
thf(clgamgulmlem1_conj,conjecture,(! [Xph:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XR @ ccn))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XU @ Xx3 @ Xk) = (ccrab @ (^ [Xx3:$i] : ((cwbr @ (ccfv @ (ccv @ Xx3) @ ccabs) @ XR @ ccle) & (cwral @ (^ [Xk:$i] : (cwbr @ (cco @ cc1 @ XR @ ccdiv) @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xk) @ ccaddc) @ ccabs) @ ccle)) @ (^ [Xk:$i] : ccn0)))) @ (^ [Xx3:$i] : ccc))))) => (! [Xx3:$i] : (! [Xk:$i] : ((Xph @ Xk) => (cwss @ (XU @ Xx3 @ Xk) @ (ccdif @ ccc @ (ccdif @ ccz @ ccn)))))))))))).
