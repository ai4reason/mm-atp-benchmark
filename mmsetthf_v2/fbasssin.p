...
thf(cfbasssin_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XF @ (ccfv @ XX @ ccfbas)) @ (cwcel @ XA2 @ XF) @ (cwcel @ XB2 @ XF)) => (cwrex @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ (ccin @ XA2 @ XB2))) @ (^ [Xx3:$i] : XF)))))))).
