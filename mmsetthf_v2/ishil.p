...
thf(adf_hil_ax,axiom,(cchs = (ccrab @ (^ [Xh:$i] : ((ccdm @ (ccfv @ (ccv @ Xh) @ ccpj)) = (ccfv @ (ccv @ Xh) @ cccss))) @ (^ [Xh:$i] : ccphl)))).
thf(cishil_conj,conjecture,(! [XC:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : ((XK = (ccfv @ XH @ ccpj)) => ((XC = (ccfv @ XH @ cccss)) => ((cwcel @ XH @ cchs) <=> ((cwcel @ XH @ ccphl) & ((ccdm @ XK) = XC))))))))).
