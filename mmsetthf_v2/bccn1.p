...
thf(abccn0_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XC @ ccc)) => (Xph => ((cco @ XC @ ccc0 @ ccbcc) = cc1)))))).
...
thf(cbccn1_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XC @ ccc)) => (Xph => ((cco @ XC @ cc1 @ ccbcc) = XC)))))).
