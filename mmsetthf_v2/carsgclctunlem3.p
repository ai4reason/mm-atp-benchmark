...
thf(axeqlelt_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((XA2 = XB2) <=> ((cwbr @ XA2 @ XB2 @ ccle) & (~ (cwbr @ XA2 @ XB2 @ cclt)))))))).
...
thf(ccarsgclctunlem3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ XO @ (XV @ Xx3 @ Xy1))))) => ((Xph => (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => ((Xph => ((ccfv @ cc0 @ XM) = ccc0)) => ((! [Xx3:$i] : ((cw3a @ Xph @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwss @ (ccv @ Xx3) @ (ccpw @ XO))) => (cwbr @ (ccfv @ (ccuni @ (ccv @ Xx3)) @ XM) @ (ccesum @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XM))) @ ccle))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ Xph @ (cwss @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwcel @ (ccv @ Xy1) @ (ccpw @ XO))) => (cwbr @ (ccfv @ (ccv @ Xx3) @ XM) @ (ccfv @ (ccv @ Xy1) @ XM) @ ccle)))) => ((Xph => (cwbr @ XA2 @ ccom @ ccdom)) => ((Xph => (cwss @ XA2 @ (ccfv @ XM @ cccarsg))) => ((Xph => (cwcel @ XE @ (ccpw @ XO))) => (Xph => (cwbr @ (cco @ (ccfv @ (ccin @ XE @ (ccuni @ XA2)) @ XM) @ (ccfv @ (ccdif @ XE @ (ccuni @ XA2)) @ XM) @ ccxad) @ (ccfv @ XE @ XM) @ ccle))))))))))))))))).
