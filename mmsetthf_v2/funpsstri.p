...
thf(cfunpsstri_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cw3a @ (cwfun @ XH) @ ((cwss @ XF @ XH) & (cwss @ XG @ XH)) @ ((cwss @ (ccdm @ XF) @ (ccdm @ XG)) | (cwss @ (ccdm @ XG) @ (ccdm @ XF)))) => (cw3o @ (cwpss @ XF @ XG) @ (XF = XG) @ (cwpss @ XG @ XF))))))).
