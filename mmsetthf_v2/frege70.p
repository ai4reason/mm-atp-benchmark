...
thf(afrege68c_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwcel @ (XA2 @ Xx3) @ (XB2 @ Xx3))) => (! [Xx3:$i] : (((! [Xx3:$i] : (Xph @ Xx3)) <=> (Xps @ Xx3)) => ((Xps @ Xx3) => (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (XA2 @ Xx3))))))))))).
...
thf(cfrege70_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (cwcel @ XX @ (XV @ Xy1))) => ((cwhe @ XA2 @ XR) => ((cwcel @ XX @ XA2) => (! [Xy1:$i] : ((cwbr @ XX @ (ccv @ Xy1) @ XR) => (cwcel @ (ccv @ Xy1) @ XA2))))))))))).
