...
thf(cfinlocfin_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XA2)) => ((cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XA2 @ ccfn) @ (XX = XY)) => (cwcel @ XA2 @ (ccfv @ XJ @ cclocfin)))))))))).
