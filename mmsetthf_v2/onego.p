...
thf(aisodd2_ax,axiom,(! [XZ:($i > $o)] : ((cwcel @ XZ @ ccodd) <=> ((cwcel @ XZ @ ccz) & (cwcel @ (cco @ (cco @ XZ @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccz))))).
thf(aisodd_ax,axiom,(! [XZ:($i > $o)] : ((cwcel @ XZ @ ccodd) <=> ((cwcel @ XZ @ ccz) & (cwcel @ (cco @ (cco @ XZ @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccz))))).
thf(conego_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccodd) => (cwcel @ (ccneg @ XA2) @ ccodd)))).
