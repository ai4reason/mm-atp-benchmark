...
thf(cwspthnonp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XW @ (cco @ XA2 @ XB2 @ (cco @ XN @ XG @ ccwwspthsnon))) => (cw3a @ ((cwcel @ XN @ ccn0) & (cwcel @ XG @ ccvv)) @ ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) @ ((cwcel @ XW @ (cco @ XA2 @ XB2 @ (cco @ XN @ XG @ ccwwlksnon))) & (? [Xf1:$i] : (cwbr @ (ccv @ Xf1) @ XW @ (cco @ XA2 @ XB2 @ (ccfv @ XG @ ccspthson))))))))))))))).
