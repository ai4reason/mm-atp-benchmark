...
thf(ausgrislfuspgr_ax,axiom,(! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : ((XI @ Xx3) = (ccfv @ XG @ cciedg))) => (! [Xx3:$i] : ((cwcel @ XG @ ccusgr) <=> ((cwcel @ XG @ ccuspgr) & (cwf @ (ccdm @ (XI @ Xx3)) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ cchash) @ ccle)) @ (^ [Xx3:$i] : (ccpw @ XV))) @ (XI @ Xx3))))))))))).
...
thf(cusgr1vr_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XA2 @ XX) & ((ccfv @ XG @ ccvtx) = (ccsn @ XA2))) => ((cwcel @ XG @ ccusgr) => ((ccfv @ XG @ cciedg) = cc0))))))).
