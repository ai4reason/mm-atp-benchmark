...
thf(aelfv_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [Xy1:$i] : ((cwcel @ (XA2 @ Xy1) @ (ccfv @ XB2 @ XF)) <=> (? [Xx3:$i] : ((cwcel @ (XA2 @ Xy1) @ (ccv @ Xx3)) & (! [Xy1:$i] : ((cwbr @ XB2 @ (ccv @ Xy1) @ XF) <=> ((ccv @ Xy1) = (ccv @ Xx3)))))))))))).
...
thf(cfv3_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((ccfv @ XA2 @ XF) = (ccab @ (^ [Xx3:$i] : ((? [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (cwbr @ XA2 @ (ccv @ Xy1) @ XF))) & (cweu @ (^ [Xy1:$i] : (cwbr @ XA2 @ (ccv @ Xy1) @ XF)))))))))).
