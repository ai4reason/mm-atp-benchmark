...
thf(aaxgroth2_ax,axiom,(! [Xx3:$i] : (? [Xy1:$i] : (cw3a @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwral @ (^ [Xz:$i] : ((! [Xw:$i] : ((cwss @ (ccv @ Xw) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xw) @ (ccv @ Xy1)))) & (cwrex @ (^ [Xw:$i] : (! [Xv:$i] : ((cwss @ (ccv @ Xv) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xv) @ (ccv @ Xw))))) @ (^ [Xw:$i] : (ccv @ Xy1))))) @ (^ [Xz:$i] : (ccv @ Xy1))) @ (! [Xz:$i] : ((cwss @ (ccv @ Xz) @ (ccv @ Xy1)) => ((cwbr @ (ccv @ Xy1) @ (ccv @ Xz) @ ccdom) | (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))))).
...
thf(adominf_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (((cwne @ XA2 @ cc0) & (cwss @ XA2 @ (ccuni @ XA2))) => (cwbr @ ccom @ XA2 @ ccdom))))).
...
thf(agrothac_ax,axiom,((ccdm @ cccrd) = ccvv)).
thf(ainfdif2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwcel @ XB2 @ (ccdm @ cccrd)) @ (cwbr @ ccom @ XA2 @ ccdom)) => ((cwbr @ (ccdif @ XA2 @ XB2) @ XB2 @ ccdom) <=> (cwbr @ XA2 @ XB2 @ ccdom)))))).
thf(adf_3an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) <=> ((Xph & Xps) & Xch)))))).
thf(caxgroth3_conj,conjecture,(! [Xx3:$i] : (? [Xy1:$i] : (cw3a @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwral @ (^ [Xz:$i] : ((! [Xw:$i] : ((cwss @ (ccv @ Xw) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xw) @ (ccv @ Xy1)))) & (cwrex @ (^ [Xw:$i] : (! [Xv:$i] : ((cwss @ (ccv @ Xv) @ (ccv @ Xz)) => (cwcel @ (ccv @ Xv) @ (ccv @ Xw))))) @ (^ [Xw:$i] : (ccv @ Xy1))))) @ (^ [Xz:$i] : (ccv @ Xy1))) @ (! [Xz:$i] : ((cwss @ (ccv @ Xz) @ (ccv @ Xy1)) => ((cwbr @ (ccdif @ (ccv @ Xy1) @ (ccv @ Xz)) @ (ccv @ Xz) @ ccdom) | (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))))).
