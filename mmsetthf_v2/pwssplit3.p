...
thf(apwssca_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XR @ XI @ ccpws)) => ((XS = (ccfv @ XR @ ccsca)) => (((cwcel @ XR @ XV) & (cwcel @ XI @ XW)) => (XS = (ccfv @ XY @ ccsca)))))))))))).
...
thf(apwssplit2_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XY = (cco @ XW @ XU @ ccpws)) => ((XZ = (cco @ XW @ XV @ ccpws)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XC = (ccfv @ XZ @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccres @ (ccv @ Xx3) @ XV))))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XW @ ccgrp) @ (cwcel @ XU @ XX) @ (cwss @ XV @ XU)) => (cwcel @ (XF @ Xx3) @ (cco @ XY @ XZ @ ccghm))))))))))))))))))).
...
thf(apwssplit0_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XY = (cco @ XW @ XU @ ccpws)) => ((XZ = (cco @ XW @ XV @ ccpws)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XC = (ccfv @ XZ @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccres @ (ccv @ Xx3) @ XV))))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XW @ XT) @ (cwcel @ XU @ XX) @ (cwss @ XV @ XU)) => (cwf @ XB2 @ XC @ (XF @ Xx3)))))))))))))))))))).
thf(cpwssplit3_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XY = (cco @ XW @ XU @ ccpws)) => ((XZ = (cco @ XW @ XV @ ccpws)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((XC = (ccfv @ XZ @ ccbs)) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (ccres @ (ccv @ Xx3) @ XV))))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XU @ XX) @ (cwss @ XV @ XU)) => (cwcel @ (XF @ Xx3) @ (cco @ XY @ XZ @ cclmhm))))))))))))))))))).
