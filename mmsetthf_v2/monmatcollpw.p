...
thf(adecpmatval_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xj:$i] : ((XA2 @ Xi @ Xj) = (cco @ (XN @ Xi @ Xj) @ (XR @ Xi @ Xj) @ ccmat)))) => ((! [Xi:$i] : (! [Xj:$i] : (XB2 = (ccfv @ (XA2 @ Xi @ Xj) @ ccbs)))) => (((cwcel @ XM @ XB2) & (cwcel @ XK @ ccn0)) => ((cco @ XM @ XK @ ccdecpmat) = (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xi @ Xj))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xi @ Xj))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccfv @ XK @ (ccfv @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM) @ ccco1)))))))))))))))).
...
thf(amatvscacell_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XK = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XA2 @ ccvsca)) => ((Xc_xp = (ccfv @ XR @ ccmulr)) => ((cw3a @ (cwcel @ XR @ ccrg) @ ((cwcel @ XX @ XK) & (cwcel @ XY @ XB2)) @ ((cwcel @ XI @ XN) & (cwcel @ XJ @ XN))) => ((cco @ XI @ XJ @ (cco @ XX @ XY @ Xc_x)) = (cco @ XX @ (cco @ XI @ XJ @ XY) @ Xc_xp)))))))))))))))))))).
thf(aeqtrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XB2 = XC)) => (Xph => (XA2 = XC))))))))).
thf(aoveq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))))).
thf(amat2pmatvalel_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XT = (cco @ XN @ XR @ ccmat2pmat)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XS = (ccfv @ XP @ ccascl)) => (((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ XV) @ (cwcel @ XM @ XB2)) & ((cwcel @ XX @ XN) & (cwcel @ XY @ XN))) => ((cco @ XX @ XY @ (ccfv @ XM @ XT)) = (ccfv @ (cco @ XX @ XY @ XM) @ XS)))))))))))))))))))).
...
thf(aasclmul2_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XW @ ccascl)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_xp = (ccfv @ XW @ ccmulr)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((cw3a @ (cwcel @ XW @ ccasa) @ (cwcel @ XR @ XK) @ (cwcel @ XX @ XV)) => ((cco @ XX @ (ccfv @ XR @ XA2) @ Xc_xp) = (cco @ XR @ XX @ Xc_x))))))))))))))))))).
...
thf(aifov_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cco @ XA2 @ XB2 @ (ccif @ Xph @ XF @ XG)) = (ccif @ Xph @ (cco @ XA2 @ XB2 @ XF) @ (cco @ XA2 @ XB2 @ XG))))))))).
...
thf(cmonmatcollpw_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XC = (cco @ XN @ XP @ ccmat)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XK = (ccfv @ XA2 @ ccbs)) => ((Xc_0 = (ccfv @ XA2 @ cc0g)) => ((Xc_ex = (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg)) => ((XX = (ccfv @ XR @ ccv1)) => ((Xc_x = (ccfv @ XC @ ccvsca)) => ((XT = (cco @ XN @ XR @ ccmat2pmat)) => ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ cccrg)) & (cw3a @ (cwcel @ XM @ XK) @ (cwcel @ XL @ ccn0) @ (cwcel @ XI @ ccn0))) => ((cco @ (cco @ (cco @ XL @ XX @ Xc_ex) @ (ccfv @ XM @ XT) @ Xc_x) @ XI @ ccdecpmat) = (ccif @ (XI = XL) @ XM @ Xc_0))))))))))))))))))))))))))).
