...
thf(afndmu_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XA2) & (cwfn @ XF @ XB2)) => (XA2 = XB2)))))).
...
thf(axp11_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwne @ XA2 @ cc0) & (cwne @ XB2 @ cc0)) => (((ccxp @ XA2 @ XB2) = (ccxp @ XC @ XD)) <=> ((XA2 = XC) & (XB2 = XD))))))))).
