...
thf(afrege109_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XU) => ((cwcel @ XR @ XV) => (cwhe @ (ccima @ (ccun @ (ccfv @ XR @ cctcl) @ ccid) @ (ccsn @ XX)) @ XR)))))))).
thf(a_3imtr3g_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => (Xps => Xch)) => ((Xps <=> Xth) => ((Xch <=> Xta) => (Xph => (Xth => Xta))))))))))).
thf(afrege78_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xa:$i] : (cwcel @ XX @ (XU @ Xa))) => ((! [Xa:$i] : (cwcel @ (XY @ Xa) @ (XV @ Xa))) => ((! [Xa:$i] : (cwcel @ XR @ (XW @ Xa))) => ((! [Xa:$i] : (cwcel @ XA2 @ (XB2 @ Xa))) => (! [Xa:$i] : ((cwhe @ XA2 @ XR) => ((! [Xa:$i] : ((cwbr @ XX @ (ccv @ Xa) @ XR) => (cwcel @ (ccv @ Xa) @ XA2))) => ((cwbr @ XX @ (XY @ Xa) @ (ccfv @ XR @ cctcl)) => (cwcel @ (XY @ Xa) @ XA2)))))))))))))))))).
...
thf(aimai_ax,axiom,(! [XA2:($i > $o)] : ((ccima @ ccid @ XA2) = XA2))).
...
thf(cfrege110_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xa:$i] : (cwcel @ XX @ (XA2 @ Xa))) => ((! [Xa:$i] : (cwcel @ XY @ (XB2 @ Xa))) => ((! [Xa:$i] : (cwcel @ (XM @ Xa) @ (XC @ Xa))) => ((! [Xa:$i] : (cwcel @ XR @ (XD @ Xa))) => (! [Xa:$i] : ((! [Xa:$i] : ((cwbr @ XY @ (ccv @ Xa) @ XR) => (cwbr @ XX @ (ccv @ Xa) @ (ccun @ (ccfv @ XR @ cctcl) @ ccid)))) => ((cwbr @ XY @ (XM @ Xa) @ (ccfv @ XR @ cctcl)) => (cwbr @ XX @ (XM @ Xa) @ (ccun @ (ccfv @ XR @ cctcl) @ ccid)))))))))))))))))).
