...
thf(afuncoppc_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XC @ ccoppc)) => ((XP = (ccfv @ XD @ ccoppc)) => ((Xph => (cwbr @ XF @ XG @ (cco @ XC @ XD @ ccfunc))) => (Xph => (cwbr @ XF @ (cctpos @ XG) @ (cco @ XO @ XP @ ccfunc)))))))))))))).
...
thf(ahofcl_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((XM = (ccfv @ XC @ cchof)) => ((XO = (ccfv @ XC @ ccoppc)) => ((XD = (ccfv @ XU @ ccsetc)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (cwss @ (ccrn @ (ccfv @ XC @ cchomf)) @ XU)) => (Xph => (cwcel @ XM @ (cco @ (cco @ XO @ XC @ ccxpc) @ XD @ ccfunc))))))))))))))))).
...
thf(atposex_ax,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => (cwcel @ (cctpos @ XF) @ ccvv)))).
...
thf(aovtpos_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cco @ XA2 @ XB2 @ (cctpos @ XF)) = (cco @ XB2 @ XA2 @ XF)))))).
