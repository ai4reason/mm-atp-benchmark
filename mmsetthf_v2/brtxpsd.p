...
thf(abrsymdif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwbr @ XA2 @ XB2 @ (ccsymdif @ XR @ XS)) <=> (~ ((cwbr @ XA2 @ XB2 @ XR) <=> (cwbr @ XA2 @ XB2 @ XS))))))))).
...
thf(cbrtxpsd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((~ (cwbr @ XA2 @ XB2 @ (ccrn @ (ccsymdif @ (cctxp @ ccvv @ ccep) @ (cctxp @ XR @ ccvv))))) <=> (! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XB2) <=> (cwbr @ (ccv @ Xx3) @ XA2 @ XR)))))))))).
