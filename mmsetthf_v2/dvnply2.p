...
thf(advply2g_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XS @ (ccfv @ cccnfld @ ccsubrg)) & (cwcel @ XF @ (ccfv @ XS @ ccply))) => (cwcel @ (cco @ ccc @ XF @ ccdv) @ (ccfv @ XS @ ccply)))))).
...
thf(cdvnply2_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XS @ (ccfv @ cccnfld @ ccsubrg)) @ (cwcel @ XF @ (ccfv @ XS @ ccply)) @ (cwcel @ XN @ ccn0)) => (cwcel @ (ccfv @ XN @ (cco @ ccc @ XF @ ccdvn)) @ (ccfv @ XS @ ccply))))))).
