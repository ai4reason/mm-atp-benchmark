...
thf(aabvdiv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_dv:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XA2 = (ccfv @ XR @ ccabv)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_dv = (ccfv @ XR @ ccdvr)) => ((((cwcel @ XR @ ccdr) & (cwcel @ XF @ XA2)) & (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwne @ XY @ Xc_0))) => ((ccfv @ (cco @ XX @ XY @ Xc_dv) @ XF) = (cco @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ ccdiv)))))))))))))))).
...
thf(aabv1_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = (ccfv @ XR @ ccabv)) => ((Xc_1 = (ccfv @ XR @ ccur)) => (((cwcel @ XR @ ccdr) & (cwcel @ XF @ XA2)) => ((ccfv @ Xc_1 @ XF) = cc1))))))))).
...
thf(aqrngdiv_ax,axiom,(! [XQ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XQ = (cco @ cccnfld @ ccq @ ccress)) => ((cw3a @ (cwcel @ XX @ ccq) @ (cwcel @ XY @ ccq) @ (cwne @ XY @ ccc0)) => ((cco @ XX @ XY @ (ccfv @ XQ @ ccdvr)) = (cco @ XX @ XY @ ccdiv)))))))).
