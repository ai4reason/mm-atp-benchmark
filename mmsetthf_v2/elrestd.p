...
thf(celrestd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XJ @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((Xph => (cwcel @ XX @ XJ)) => ((XA2 = (ccin @ XX @ XB2)) => (Xph => (cwcel @ XA2 @ (cco @ XJ @ XB2 @ ccrest))))))))))))))).
