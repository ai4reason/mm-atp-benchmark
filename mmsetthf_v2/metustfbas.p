...
thf(aopelresi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ (ccop @ XA2 @ XA2) @ (ccres @ ccid @ XB2)) <=> (cwcel @ XA2 @ XB2))))))).
...
thf(ametustto_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico)))))) => ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwcel @ XA2 @ XF) @ (cwcel @ XB2 @ XF)) => ((cwss @ XA2 @ XB2) | (cwss @ XB2 @ XA2)))))))))).
...
thf(cmetustfbas_conj,conjecture,(! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccrn @ (ccmpt @ (^ [Xa:$i] : ccrp) @ (^ [Xa:$i] : (ccima @ (cccnv @ XD) @ (cco @ ccc0 @ (ccv @ Xa) @ ccico)))))) => (((cwne @ XX @ cc0) & (cwcel @ XD @ (ccfv @ XX @ ccpsmet))) => (cwcel @ XF @ (ccfv @ (ccxp @ XX @ XX) @ ccfbas)))))))).
