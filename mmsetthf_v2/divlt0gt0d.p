...
thf(cdivlt0gt0d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => (cwbr @ XA2 @ ccc0 @ cclt)) => (Xph => (cwbr @ (cco @ XA2 @ XB2 @ ccdiv) @ ccc0 @ cclt))))))))).
