...
thf(axleadd1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccr)) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (cwbr @ (cco @ XA2 @ XC @ ccxad) @ (cco @ XB2 @ XC @ ccxad) @ ccle))))))).
...
thf(cxlesubadd_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) & (cw3a @ (cwbr @ ccc0 @ XA2 @ ccle) @ (cwne @ XB2 @ ccmnf) @ (cwbr @ ccc0 @ XC @ ccle))) => ((cwbr @ (cco @ XA2 @ (ccxne @ XB2) @ ccxad) @ XC @ ccle) <=> (cwbr @ XA2 @ (cco @ XC @ XB2 @ ccxad) @ ccle))))))).
