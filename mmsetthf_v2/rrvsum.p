...
thf(arrvadd_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XP @ ccprb)) => ((Xph => (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => ((Xph => (cwcel @ XY @ (ccfv @ XP @ ccrrv))) => (Xph => (cwcel @ (cco @ XX @ XY @ (ccof @ ccaddc)) @ (ccfv @ XP @ ccrrv))))))))))).
