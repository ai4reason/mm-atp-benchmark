...
thf(cdiv11_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ ((cwcel @ XC @ ccc) & (cwne @ XC @ ccc0))) => (((cco @ XA2 @ XC @ ccdiv) = (cco @ XB2 @ XC @ ccdiv)) <=> (XA2 = XB2))))))).
