...
thf(annpw2blenfzo2_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((XN = (cco @ cc2 @ (cco @ (ccfv @ XN @ ccblen) @ cc1 @ ccmin) @ ccexp)) | (cwcel @ XN @ (cco @ (cco @ (cco @ cc2 @ (cco @ (ccfv @ XN @ ccblen) @ cc1 @ ccmin) @ ccexp) @ cc1 @ ccaddc) @ (cco @ cc2 @ (ccfv @ XN @ ccblen) @ ccexp) @ ccfzo)))))).
...
thf(alogbid1_ax,axiom,(! [XA2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwne @ XA2 @ ccc0) @ (cwne @ XA2 @ cc1)) => ((cco @ XA2 @ XA2 @ cclogb) = cc1)))).
...
thf(alogbleb_ax,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XX @ ccrp) @ (cwcel @ XY @ ccrp)) => ((cwbr @ XX @ XY @ ccle) <=> (cwbr @ (cco @ XB2 @ XX @ cclogb) @ (cco @ XB2 @ XY @ cclogb) @ ccle))))))).
thf(arelogbcl_ax,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XB2 @ ccrp) @ (cwcel @ XX @ ccrp) @ (cwne @ XB2 @ cc1)) => (cwcel @ (cco @ XB2 @ XX @ cclogb) @ ccr))))).
...
thf(annpw2even_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => (cwcel @ (cco @ (cco @ cc2 @ XN @ ccexp) @ cc2 @ ccdiv) @ ccn)))).
...
thf(afllog2_ax,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XI @ ccn0) & (cwcel @ XN @ (cco @ (cco @ cc2 @ XI @ ccexp) @ (cco @ cc2 @ (cco @ XI @ cc1 @ ccaddc) @ ccexp) @ ccfzo))) => ((ccfv @ (cco @ cc2 @ XN @ cclogb) @ ccfl) = XI))))).
...
thf(cnnolog2flm1_conj,conjecture,(! [XN:($i > $o)] : (((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) & (cwcel @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ cc2 @ ccdiv) @ ccn)) => ((ccfv @ (cco @ cc2 @ XN @ cclogb) @ ccfl) = (ccfv @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ cclogb) @ ccfl))))).
