...
thf(abj_ismoorec_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccmoore) <=> ((cwcel @ XA2 @ ccvv) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccin @ (ccuni @ XA2) @ (ccint @ (ccv @ Xx3))) @ XA2)) @ (^ [Xx3:$i] : (ccpw @ XA2))))))).
...
thf(cbj_ismoored_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccmoore)) => ((Xph => (cwss @ XB2 @ XA2)) => (Xph => (cwcel @ (ccin @ (ccuni @ XA2) @ (ccint @ XB2)) @ XA2)))))))).
