...
thf(apw0_ax,axiom,((ccpw @ cc0) = (ccsn @ cc0))).
thf(aax_mp_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((Xph => Xps) => Xps))))).
thf(a_0ex_ax,axiom,(cwcel @ cc0 @ ccvv)).
thf(acardsn_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((ccfv @ (ccsn @ XA2) @ cccrd) = cc1o))))).
thf(aackbij1lem13_ax,axiom,(! [XF:($i > $o)] : ((XF = (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => ((ccfv @ cc0 @ XF) = cc0)))).
...
thf(aackbij1lem5_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccom) => ((ccfv @ (ccpw @ (ccsuc @ XA2)) @ cccrd) = (cco @ (ccfv @ (ccpw @ XA2) @ cccrd) @ (ccfv @ (ccpw @ XA2) @ cccrd) @ ccoa))))).
...
thf(aackbij1lem4_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccom) => (cwcel @ (ccsn @ XA2) @ (ccin @ (ccpw @ ccom) @ ccfn))))).
...
thf(aackbij1lem9_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((XF = (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccom) @ ccfn)) @ (^ [Xx3:$i] : (ccfv @ (cciun @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccxp @ (ccsn @ (ccv @ Xy1)) @ (ccpw @ (ccv @ Xy1))))) @ cccrd)))) => ((cw3a @ (cwcel @ XA2 @ (ccin @ (ccpw @ ccom) @ ccfn)) @ (cwcel @ XB2 @ (ccin @ (ccpw @ ccom) @ ccfn)) @ ((ccin @ XA2 @ XB2) = cc0)) => ((ccfv @ (ccun @ XA2 @ XB2) @ XF) = (cco @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF) @ ccoa)))))))).
