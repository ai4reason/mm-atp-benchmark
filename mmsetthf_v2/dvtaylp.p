...
thf(advexp2_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cco @ ccc @ (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XN @ ccexp))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccif @ (XN = ccc0) @ ccc0 @ (cco @ XN @ (cco @ (ccv @ Xx3) @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccmul)))))))).
...
thf(advnadd_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XS @ (ccpr @ ccr @ ccc)) & (cwcel @ XF @ (cco @ ccc @ XS @ ccpm))) & ((cwcel @ XM @ ccn0) & (cwcel @ XN @ ccn0))) => ((ccfv @ XN @ (cco @ XS @ (ccfv @ XM @ (cco @ XS @ XF @ ccdvn)) @ ccdvn)) = (ccfv @ (cco @ XM @ XN @ ccaddc) @ (cco @ XS @ XF @ ccdvn))))))))).
thf(afveq1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (XF = XG)) => (Xph => ((ccfv @ XA2 @ XF) = (ccfv @ XA2 @ XG))))))))).
thf(asyl2anc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xph => Xch) => (((Xps & Xch) => Xth) => (Xph => Xth))))))))).
thf(advn1_ax,axiom,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (((cwss @ XS @ ccc) & (cwcel @ XF @ (cco @ ccc @ XS @ ccpm))) => ((ccfv @ cc1 @ (cco @ XS @ XF @ ccdvn)) = (cco @ XS @ XF @ ccdv)))))).
...
thf(adivcan5rd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwne @ XB2 @ ccc0)) => ((Xph => (cwne @ XC @ ccc0)) => (Xph => ((cco @ (cco @ XA2 @ XC @ ccmul) @ (cco @ XB2 @ XC @ ccmul) @ ccdiv) = (cco @ XA2 @ XB2 @ ccdiv))))))))))))).
...
thf(ataylpfval_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((! [Xx3:$i] : (! [Xk:$i] : (Xph => (cwf @ (XA2 @ Xx3 @ Xk) @ ccc @ XF)))) => ((! [Xx3:$i] : (! [Xk:$i] : (Xph => (cwss @ (XA2 @ Xx3 @ Xk) @ XS)))) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XB2 @ (ccdm @ (ccfv @ XN @ (cco @ XS @ XF @ ccdvn))))) => ((! [Xk:$i] : ((XT @ Xk) = (cco @ XN @ XB2 @ (cco @ XS @ XF @ cctayl)))) => (! [Xk:$i] : (Xph => ((XT @ Xk) = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ (ccfv @ XB2 @ (ccfv @ (ccv @ Xk) @ (cco @ XS @ XF @ ccdvn))) @ (ccfv @ (ccv @ Xk) @ ccfa) @ ccdiv) @ (cco @ (cco @ (ccv @ Xx3) @ XB2 @ ccmin) @ (ccv @ Xk) @ ccexp) @ ccmul)))))))))))))))))))))).
thf(cdvtaylp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwss @ XA2 @ XS)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph => (cwcel @ XB2 @ (ccdm @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ (cco @ XS @ XF @ ccdvn))))) => (Xph => ((cco @ ccc @ (cco @ (cco @ XN @ cc1 @ ccaddc) @ XB2 @ (cco @ XS @ XF @ cctayl)) @ ccdv) = (cco @ XN @ XB2 @ (cco @ XS @ (cco @ XS @ XF @ ccdv) @ cctayl)))))))))))))))).
