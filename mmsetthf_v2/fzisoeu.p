...
thf(altwefz_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwwe @ (cco @ XM @ XN @ ccfz) @ cclt)))).
thf(cwse_tp,type,(cwse : (($i > $o) > (($i > $o) > $o)))).
thf(awemoiso_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwwe @ XA2 @ XR) => (cwmo @ (^ [Xf1:$i] : (cwiso @ XA2 @ XB2 @ XR @ XS @ (ccv @ Xf1)))))))))).
thf(aeu5_ax,axiom,(! [Xph:($i > $o)] : ((cweu @ (^ [Xx3:$i] : (Xph @ Xx3))) <=> ((? [Xx3:$i] : (Xph @ Xx3)) & (cwmo @ (^ [Xx3:$i] : (Xph @ Xx3))))))).
thf(cfzisoeu_conj,conjecture,(! [Xph:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XH @ ccfn))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwor @ XH @ cclt))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XM @ ccz))) => ((XN = (cco @ (ccfv @ XH @ cchash) @ (cco @ XM @ cc1 @ ccmin) @ ccaddc)) => (! [Xf1:$i] : ((Xph @ Xf1) => (cweu @ (^ [Xf1:$i] : (cwiso @ (cco @ XM @ XN @ ccfz) @ XH @ cclt @ cclt @ (ccv @ Xf1))))))))))))))).
