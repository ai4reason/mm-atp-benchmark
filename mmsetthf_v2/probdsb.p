...
thf(aprobdif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprb) @ (cwcel @ XA2 @ (ccdm @ XP)) @ (cwcel @ XB2 @ (ccdm @ XP))) => ((ccfv @ (ccdif @ XA2 @ XB2) @ XP) = (cco @ (ccfv @ XA2 @ XP) @ (ccfv @ (ccin @ XA2 @ XB2) @ XP) @ ccmin))))))).
...
thf(aprobtot_ax,axiom,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprb) => ((ccfv @ (ccuni @ (ccdm @ XP)) @ XP) = cc1)))).
...
thf(cprobdsb_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprb) & (cwcel @ XA2 @ (ccdm @ XP))) => ((ccfv @ (ccdif @ (ccuni @ (ccdm @ XP)) @ XA2) @ XP) = (cco @ cc1 @ (ccfv @ XA2 @ XP) @ ccmin)))))).
