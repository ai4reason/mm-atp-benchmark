...
thf(acply1coe0bi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XK = (ccfv @ XR @ ccbs)) => ((! [Xn:$i] : ((Xc_0 @ Xn) = (ccfv @ XR @ cc0g))) => ((! [Xn:$i] : (! [Xs1:$i] : ((XP @ Xn @ Xs1) = (ccfv @ XR @ ccpl1)))) => ((! [Xn:$i] : (! [Xs1:$i] : (XB2 = (ccfv @ (XP @ Xn @ Xs1) @ ccbs)))) => ((! [Xn:$i] : (! [Xs1:$i] : (XA2 = (ccfv @ (XP @ Xn @ Xs1) @ ccascl)))) => (((cwcel @ XR @ ccrg) & (cwcel @ XM @ XB2)) => ((cwrex @ (^ [Xs1:$i] : (XM = (ccfv @ (ccv @ Xs1) @ XA2))) @ (^ [Xs1:$i] : XK)) <=> (cwral @ (^ [Xn:$i] : ((ccfv @ (ccv @ Xn) @ (ccfv @ XM @ ccco1)) = (Xc_0 @ Xn))) @ (^ [Xn:$i] : ccn))))))))))))))))).
thf(ccpmatel2_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XS @ Xi @ Xj @ Xk) = (cco @ XN @ XR @ cccpmat))))) => ((! [Xi:$i] : (! [Xj:$i] : ((XP @ Xi @ Xj) = (ccfv @ XR @ ccpl1)))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XC @ Xi @ Xj @ Xk) = (cco @ XN @ (XP @ Xi @ Xj) @ ccmat))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((XB2 @ Xk) = (ccfv @ (XC @ Xi @ Xj @ Xk) @ ccbs))))) => ((! [Xi:$i] : (! [Xj:$i] : ((XK @ Xi @ Xj) = (ccfv @ XR @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XA2 @ Xi @ Xj) = (ccfv @ (XP @ Xi @ Xj) @ ccascl)))) => (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : ((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg) @ (cwcel @ XM @ (XB2 @ Xk))) => ((cwcel @ XM @ (XS @ Xi @ Xj @ Xk)) <=> (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwrex @ (^ [Xk:$i] : ((cco @ (ccv @ Xi) @ (ccv @ Xj) @ XM) = (ccfv @ (ccv @ Xk) @ (XA2 @ Xi @ Xj)))) @ (^ [Xk:$i] : (XK @ Xi @ Xj)))) @ (^ [Xj:$i] : XN))) @ (^ [Xi:$i] : XN))))))))))))))))))))))).
