...
thf(amzpresrename_ax,axiom,(! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ ccvv) @ (cwss @ XV @ XW) @ (cwcel @ XF @ (ccfv @ XV @ ccmzp))) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccz @ XW @ ccmap)) @ (^ [Xx3:$i] : (ccfv @ (ccres @ (ccv @ Xx3) @ XV) @ XF))) @ (ccfv @ XW @ ccmzp))))))).
