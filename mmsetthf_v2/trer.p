...
thf(ctrer_conj,conjecture,(! [Xc_le:($i > $o)] : ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (((cwbr @ (ccv @ Xa) @ (ccv @ Xb) @ Xc_le) & (cwbr @ (ccv @ Xb) @ (ccv @ Xc) @ Xc_le)) => (cwbr @ (ccv @ Xa) @ (ccv @ Xc) @ Xc_le))))) => (cwer @ (ccdm @ (ccin @ Xc_le @ (cccnv @ Xc_le))) @ (ccin @ Xc_le @ (cccnv @ Xc_le)))))).
