...
thf(cpmtrval_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((cw3a @ (cwcel @ XD @ XV) @ (cwss @ XP @ XD) @ (cwbr @ XP @ cc2o @ ccen)) => ((ccfv @ XP @ XT) = (ccmpt @ (^ [Xz:$i] : XD) @ (^ [Xz:$i] : (ccif @ (cwcel @ (ccv @ Xz) @ XP) @ (ccuni @ (ccdif @ XP @ (ccsn @ (ccv @ Xz)))) @ (ccv @ Xz)))))))))))).
