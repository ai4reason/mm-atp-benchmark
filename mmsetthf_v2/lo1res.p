...
thf(alo1f_ax,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ cclo1) => (cwf @ (ccdm @ XF) @ ccr @ XF)))).
thf(alo1bdd_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ cclo1) & (cwf @ XA2 @ ccr @ XF)) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle) => (cwbr @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccv @ Xm) @ ccle))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xm:$i] : ccr))) @ (^ [Xx3:$i] : ccr)))))).
...
thf(clo1res_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ cclo1) => (cwcel @ (ccres @ XF @ XA2) @ cclo1))))).
