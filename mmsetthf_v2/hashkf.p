...
thf(chashkf_conj,conjecture,(! [XG:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc1 @ ccaddc))) @ ccc0) @ ccom))) => ((! [Xx3:$i] : ((XK @ Xx3) = (cccom @ (XG @ Xx3) @ cccrd))) => (! [Xx3:$i] : (cwf @ ccfn @ ccn0 @ (XK @ Xx3)))))))).
