...
thf(ahsmex2_ax,axiom,(! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [Xx3:$i] : (! [Xs1:$i] : ((cwcel @ XX @ (XV @ Xx3 @ Xs1)) => (cwcel @ (ccab @ (^ [Xs1:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XX @ ccdom)) @ (^ [Xx3:$i] : (ccfv @ (ccsn @ (ccv @ Xs1)) @ cctc))))) @ ccvv))))))).
thf(assexg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwss @ XA2 @ XB2) & (cwcel @ XB2 @ XC)) => (cwcel @ XA2 @ ccvv)))))).
thf(chsmex3_conj,conjecture,(! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [Xx3:$i] : (! [Xs1:$i] : ((cwcel @ XX @ (XV @ Xx3 @ Xs1)) => (cwcel @ (ccab @ (^ [Xs1:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccv @ Xx3) @ XX @ ccsdm)) @ (^ [Xx3:$i] : (ccfv @ (ccsn @ (ccv @ Xs1)) @ cctc))))) @ ccvv))))))).
