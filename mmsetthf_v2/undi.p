...
thf(auneqri_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((! [Xx3:$i] : (((cwcel @ (ccv @ Xx3) @ XA2) | (cwcel @ (ccv @ Xx3) @ XB2)) <=> (cwcel @ (ccv @ Xx3) @ XC))) => ((ccun @ XA2 @ XB2) = XC)))))).
...
thf(cundi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccun @ XA2 @ (ccin @ XB2 @ XC)) = (ccin @ (ccun @ XA2 @ XB2) @ (ccun @ XA2 @ XC))))))).
