...
thf(ciunxpf_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > $o))))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xz:$i] : (cwnfc @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1 @ Xz))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (cwnfc @ (^ [Xz:$i] : (XC @ Xx3 @ Xy1 @ Xz))))) => ((! [Xy1:$i] : (! [Xz:$i] : (cwnfc @ (^ [Xx3:$i] : (XD @ Xx3 @ Xy1 @ Xz))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((ccv @ Xx3) = (ccop @ (ccv @ Xy1) @ (ccv @ Xz))) => ((XC @ Xx3 @ Xy1 @ Xz) = (XD @ Xx3 @ Xy1 @ Xz)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cciun @ (^ [Xx3:$i] : (ccxp @ (XA2 @ Xz) @ XB2)) @ (^ [Xx3:$i] : (XC @ Xx3 @ Xy1 @ Xz))) = (cciun @ (^ [Xy1:$i] : (XA2 @ Xz)) @ (^ [Xy1:$i] : (cciun @ (^ [Xz:$i] : XB2) @ (^ [Xz:$i] : (XD @ Xx3 @ Xy1 @ Xz)))))))))))))))))).
