...
thf(ausgredg3_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ cciedg)) => (((cwcel @ XG @ ccusgr) & (cwcel @ XX @ (ccdm @ XE))) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) & ((ccfv @ XX @ XE) = (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : XV))) @ (^ [Xx3:$i] : XV)))))))))).
...
thf(cusgredg4_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ cciedg)) => ((cw3a @ (cwcel @ XG @ ccusgr) @ (cwcel @ XX @ (ccdm @ XE)) @ (cwcel @ XY @ (ccfv @ XX @ XE))) => (cwrex @ (^ [Xy1:$i] : ((ccfv @ XX @ XE) = (ccpr @ XY @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : XV))))))))))).
