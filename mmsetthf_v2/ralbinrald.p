...
thf(cralbinrald_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xth:$o] : (! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ XA2)) => ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) => ((ccv @ Xx3) = XX))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XX) => ((Xps @ Xx3) <=> Xth))) => (Xph => ((cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XA2)) <=> Xth))))))))))).
