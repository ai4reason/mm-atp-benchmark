...
thf(aabs2dif_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => (cwbr @ (cco @ (ccfv @ XA2 @ ccabs) @ (ccfv @ XB2 @ ccabs) @ ccmin) @ (ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) @ ccle))))).
...
thf(alogfac_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((ccfv @ (ccfv @ XN @ ccfa) @ cclog) = (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ cclog))))))).
...
thf(advfsum2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xk:$i] : (XS = (cco @ (XT @ Xk) @ ccpnf @ ccioo))) => ((! [Xk:$i] : ((XZ @ Xk) = (ccfv @ XM @ ccuz))) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XD @ ccr)) => ((Xph => (cwcel @ XU @ ccxr)) => ((Xph => (cwbr @ XM @ (cco @ XD @ cc1 @ ccaddc) @ ccle)) => ((! [Xk:$i] : (Xph => (cwcel @ (XT @ Xk) @ ccr))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XS)) => (cwcel @ (XA2 @ Xx3 @ Xk) @ ccr)))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XS)) => (cwcel @ (XB2 @ Xx3) @ (XV @ Xk))))) => ((! [Xx3:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (XZ @ Xk))) => (cwcel @ (XB2 @ Xx3) @ ccr)))) => ((! [Xk:$i] : (Xph => ((cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xk))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))) => ((! [Xx3:$i] : (! [Xk:$i] : (((ccv @ Xx3) = (ccv @ Xk)) => ((XB2 @ Xx3) = (XC @ Xk))))) => ((! [Xx3:$i] : (! [Xk:$i] : ((cw3a @ Xph @ ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xk) @ XS)) @ (cw3a @ (cwbr @ XD @ (ccv @ Xx3) @ ccle) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xk) @ ccle) @ (cwbr @ (ccv @ Xk) @ XU @ ccle))) => (cwbr @ (XB2 @ Xx3) @ (XC @ Xk) @ ccle)))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XG @ Xx3 @ Xk) = (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (cco @ (ccsu @ (cco @ XM @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xk:$i] : (XC @ Xk))) @ (XA2 @ Xx3 @ Xk) @ ccmin)))))) => ((! [Xx3:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwbr @ XD @ (ccv @ Xx3) @ ccle))) => (cwbr @ ccc0 @ (XB2 @ Xx3) @ ccle))) => ((Xph => (cwcel @ XX @ XS)) => ((Xph => (cwcel @ XY @ XS)) => ((Xph => (cwbr @ XD @ XX @ ccle)) => ((Xph => (cwbr @ XX @ XY @ ccle)) => ((Xph => (cwbr @ XY @ XU @ ccle)) => ((! [Xx3:$i] : (! [Xk:$i] : (((ccv @ Xx3) = XY) => ((XB2 @ Xx3) = (XE @ Xk))))) => (! [Xx3:$i] : (! [Xk:$i] : (Xph => (cwbr @ (ccfv @ (cco @ (ccfv @ XY @ (XG @ Xx3 @ Xk)) @ (ccfv @ XX @ (XG @ Xx3 @ Xk)) @ ccmin) @ ccabs) @ (XE @ Xk) @ ccle))))))))))))))))))))))))))))))))))))))))).
...
thf(aadvlog_ax,axiom,((cco @ ccr @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (cco @ (ccfv @ (ccv @ Xx3) @ cclog) @ cc1 @ ccmin) @ ccmul))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ cclog))))).
...
thf(clogfacbnd3_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwbr @ cc1 @ XA2 @ ccle)) => (cwbr @ (ccfv @ (cco @ (ccfv @ (ccfv @ (ccfv @ XA2 @ ccfl) @ ccfa) @ cclog) @ (cco @ XA2 @ (cco @ (ccfv @ XA2 @ cclog) @ cc1 @ ccmin) @ ccmul) @ ccmin) @ ccabs) @ (cco @ (ccfv @ XA2 @ cclog) @ cc1 @ ccaddc) @ ccle)))).
