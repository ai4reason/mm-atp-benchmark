...
thf(csqreu_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwreu @ (^ [Xx3:$i] : (cw3a @ ((cco @ (ccv @ Xx3) @ cc2 @ ccexp) = XA2) @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ ccre) @ ccle) @ (cwnel @ (cco @ cci @ (ccv @ Xx3) @ ccmul) @ ccrp))) @ (^ [Xx3:$i] : ccc))))).
