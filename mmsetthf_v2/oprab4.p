...
thf(coprab4_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : ((ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : ((cwcel @ (ccop @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccxp @ (XA2 @ Xx3 @ Xy1 @ Xz) @ (XB2 @ Xx3 @ Xy1 @ Xz))) & (Xph @ Xx3 @ Xy1 @ Xz)))))) = (ccoprab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (^ [Xz:$i] : (((cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3 @ Xy1 @ Xz)) & (cwcel @ (ccv @ Xy1) @ (XB2 @ Xx3 @ Xy1 @ Xz))) & (Xph @ Xx3 @ Xy1 @ Xz))))))))))).
