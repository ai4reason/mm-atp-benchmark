...
thf(clssats_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (XS = (ccfv @ (XW @ Xx3) @ cclss))) => ((! [Xx3:$i] : (XN = (ccfv @ (XW @ Xx3) @ cclspn))) => ((! [Xx3:$i] : (XA2 = (ccfv @ (XW @ Xx3) @ cclsa))) => (! [Xx3:$i] : (((cwcel @ (XW @ Xx3) @ cclmod) & (cwcel @ XU @ XS)) => (XU = (ccfv @ (ccuni @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XU)) @ (^ [Xx3:$i] : XA2))) @ XN))))))))))))).
