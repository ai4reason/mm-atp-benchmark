...
thf(apmtrfmvdn0_ax,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((XR = (ccrn @ XT)) => ((cwcel @ XF @ XR) => (cwne @ (ccdm @ (ccdif @ XF @ ccid)) @ cc0))))))))).
