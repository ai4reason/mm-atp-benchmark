...
thf(afiint_ax,axiom,(! [XA2:($i > $o)] : ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XA2)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2)) <=> (! [Xx3:$i] : ((cw3a @ (cwss @ (ccv @ Xx3) @ XA2) @ (cwne @ (ccv @ Xx3) @ cc0) @ (cwcel @ (ccv @ Xx3) @ ccfn)) => (cwcel @ (ccint @ (ccv @ Xx3)) @ XA2)))))).
...
thf(cdffi2_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XV @ Xx3)) => ((ccfv @ XA2 @ ccfi) = (ccint @ (ccab @ (^ [Xz:$i] : ((cwss @ XA2 @ (ccv @ Xz)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xz))) @ (^ [Xy1:$i] : (ccv @ Xz)))) @ (^ [Xx3:$i] : (ccv @ Xz))))))))))))).
