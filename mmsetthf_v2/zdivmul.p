...
thf(czdivmul_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (((cw3a @ (cwcel @ XD @ ccn) @ (cwcel @ XA2 @ ccz) @ (cwcel @ XB2 @ ccz)) & (cwcel @ (cco @ XA2 @ XD @ ccdiv) @ ccz)) => (cwcel @ (cco @ (cco @ XB2 @ XA2 @ ccmul) @ XD @ ccdiv) @ ccz)))))).
