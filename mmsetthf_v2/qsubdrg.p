...
thf(aqreccl_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccq) & (cwne @ XA2 @ ccc0)) => (cwcel @ (cco @ cc1 @ XA2 @ ccdiv) @ ccq)))).
thf(cqsubdrg_conj,conjecture,((cwcel @ ccq @ (ccfv @ cccnfld @ ccsubrg)) & (cwcel @ (cco @ cccnfld @ ccq @ ccress) @ ccdr))).
