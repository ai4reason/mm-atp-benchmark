...
thf(adf_ps_ax,axiom,(ccps = (ccab @ (^ [Xr:$i] : (cw3a @ (cwrel @ (ccv @ Xr)) @ (cwss @ (cccom @ (ccv @ Xr) @ (ccv @ Xr)) @ (ccv @ Xr)) @ ((ccin @ (ccv @ Xr) @ (cccnv @ (ccv @ Xr))) = (ccres @ ccid @ (ccuni @ (ccuni @ (ccv @ Xr)))))))))).
thf(cisps_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwcel @ XR @ XA2) => ((cwcel @ XR @ ccps) <=> (cw3a @ (cwrel @ XR) @ (cwss @ (cccom @ XR @ XR) @ XR) @ ((ccin @ XR @ (cccnv @ XR)) = (ccres @ ccid @ (ccuni @ (ccuni @ XR)))))))))).
