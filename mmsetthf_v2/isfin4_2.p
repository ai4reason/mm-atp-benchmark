...
thf(ainfpssr_ax,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (((cwpss @ XX @ XA2) & (cwbr @ XX @ XA2 @ ccen)) => (cwbr @ ccom @ XA2 @ ccdom))))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(ainfpss_ax,axiom,(! [XA2:($i > $o)] : ((cwbr @ ccom @ XA2 @ ccdom) => (? [Xx3:$i] : ((cwpss @ (ccv @ Xx3) @ XA2) & (cwbr @ (ccv @ Xx3) @ XA2 @ ccen)))))).
thf(cisfin4_2_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XA2 @ ccfin4) <=> (~ (cwbr @ ccom @ XA2 @ ccdom))))))).
