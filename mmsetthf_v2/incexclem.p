...
thf(ahashun3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwcel @ XB2 @ ccfn)) => ((ccfv @ (ccun @ XA2 @ XB2) @ cchash) = (cco @ (cco @ (ccfv @ XA2 @ cchash) @ (ccfv @ XB2 @ cchash) @ ccaddc) @ (ccfv @ (ccin @ XA2 @ XB2) @ cchash) @ ccmin)))))).
...
thf(cincexclem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwcel @ XB2 @ ccfn)) => ((cco @ (ccfv @ XB2 @ cchash) @ (ccfv @ (ccin @ XB2 @ (ccuni @ XA2)) @ cchash) @ ccmin) = (ccsu @ (ccpw @ XA2) @ (^ [Xs1:$i] : (cco @ (cco @ (ccneg @ cc1) @ (ccfv @ (ccv @ Xs1) @ cchash) @ ccexp) @ (ccfv @ (ccin @ XB2 @ (ccint @ (ccv @ Xs1))) @ cchash) @ ccmul)))))))).
