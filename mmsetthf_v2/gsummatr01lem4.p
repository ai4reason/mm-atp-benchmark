...
thf(asymgfvne_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XA2 @ ccsymg)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((cw3a @ (cwcel @ XF @ XB2) @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XA2)) => (((ccfv @ XX @ XF) = XZ) => ((cwne @ XY @ XX) => (cwne @ (ccfv @ XY @ XF) @ XZ)))))))))))))).
...
thf(cgsummatr01lem4_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XQ:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [Xn:$i] : (! [XG:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xi:$i] : (! [Xj:$i] : (! [Xr:$i] : ((XP @ Xi @ Xj) = (ccfv @ (ccfv @ (XN @ Xr) @ ccsymg) @ ccbs))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xr:$i] : ((XR @ Xr) = (ccrab @ (^ [Xr:$i] : ((ccfv @ XK @ (ccv @ Xr)) = XL)) @ (^ [Xr:$i] : (XP @ Xi @ Xj))))))) => ((! [Xr:$i] : ((Xc_0 @ Xr) = (ccfv @ (XG @ Xr) @ cc0g))) => ((! [Xr:$i] : ((XS @ Xr) = (ccfv @ (XG @ Xr) @ ccbs))) => (! [Xr:$i] : (((cw3a @ ((cwcel @ (XG @ Xr) @ cccmn) & (cwcel @ (XN @ Xr) @ ccfn)) @ ((cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : (cwcel @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (XA2 @ Xr)) @ (XS @ Xr))) @ (^ [Xj:$i] : (XN @ Xr)))) @ (^ [Xi:$i] : (XN @ Xr))) & (cwcel @ (XB2 @ Xr) @ (XS @ Xr))) @ (cw3a @ (cwcel @ XK @ (XN @ Xr)) @ (cwcel @ XL @ (XN @ Xr)) @ (cwcel @ XQ @ (XR @ Xr)))) & (cwcel @ (ccv @ Xn) @ (ccdif @ (XN @ Xr) @ (ccsn @ XK)))) => ((cco @ (ccv @ Xn) @ (ccfv @ (ccv @ Xn) @ XQ) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xr))) @ (^ [Xi:$i] : (^ [Xj:$i] : (XN @ Xr))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = XK) @ (ccif @ ((ccv @ Xj) = XL) @ (Xc_0 @ Xr) @ (XB2 @ Xr)) @ (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (XA2 @ Xr))))))) = (cco @ (ccv @ Xn) @ (ccfv @ (ccv @ Xn) @ XQ) @ (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : (ccdif @ (XN @ Xr) @ (ccsn @ XK)))) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccdif @ (XN @ Xr) @ (ccsn @ XL)))) @ (^ [Xi:$i] : (^ [Xj:$i] : (cco @ (ccv @ Xi) @ (ccv @ Xj) @ (XA2 @ Xr)))))))))))))))))))))))))).
