...
thf(ainvrvald_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((XU = (ccfv @ XR @ ccui)) => ((XI = (ccfv @ XR @ ccinvr)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => ((cco @ XX @ XY @ Xc_x) = Xc_1)) => ((Xph => ((cco @ XY @ XX @ Xc_x) = Xc_1)) => (Xph => ((cwcel @ XX @ XU) & ((ccfv @ XX @ XI) = XY))))))))))))))))))))))).
...
thf(amatinv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XJ = (cco @ XN @ XR @ ccmadu)) => ((XD = (cco @ XN @ XR @ ccmdat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XU = (ccfv @ XA2 @ ccui)) => ((XV = (ccfv @ XR @ ccui)) => ((XH = (ccfv @ XR @ ccinvr)) => ((XI = (ccfv @ XA2 @ ccinvr)) => ((Xc_xb = (ccfv @ XA2 @ ccvsca)) => ((cw3a @ (cwcel @ XR @ cccrg) @ (cwcel @ XM @ XB2) @ (cwcel @ (ccfv @ XM @ XD) @ XV)) => ((cwcel @ XM @ XU) & ((ccfv @ XM @ XI) = (cco @ (ccfv @ (ccfv @ XM @ XD) @ XH) @ (ccfv @ XM @ XJ) @ Xc_xb)))))))))))))))))))))))))).
