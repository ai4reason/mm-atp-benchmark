...
thf(ak0004lem1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((XD = (ccin @ XB2 @ XC)) => (((cwf @ XA2 @ XB2 @ XF) & (cwss @ (ccima @ XF @ XA2) @ XC)) <=> (cwf @ XA2 @ XD @ XF))))))))).
...
thf(ck0004lem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XU) @ (cwcel @ XB2 @ XV) @ (cwss @ XC @ XB2)) => (((cwcel @ XF @ (cco @ XB2 @ XA2 @ ccmap)) & (cwss @ (ccima @ XF @ XA2) @ XC)) <=> (cwcel @ XF @ (cco @ XC @ XA2 @ ccmap))))))))))).
