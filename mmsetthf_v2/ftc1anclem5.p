...
thf(aftc1anclem1_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwf @ XA2 @ ccr @ XF) & (cwcel @ XF @ ccmbf)) => (cwcel @ (cccom @ ccabs @ XF) @ ccmbf))))).
...
thf(ai1fpos_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccif @ (cwbr @ ccc0 @ (ccfv @ (ccv @ Xx3) @ XF) @ ccle) @ (ccfv @ (ccv @ Xx3) @ XF) @ ccc0))))) => (! [Xx3:$i] : ((cwcel @ XF @ (ccdm @ ccitg1)) => (cwcel @ (XG @ Xx3) @ (ccdm @ ccitg1)))))))).
...
thf(aftc1anclem4_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cw3a @ (cwcel @ XF @ (ccdm @ ccitg1)) @ (cwcel @ XG @ ccibl) @ (cwf @ ccr @ ccr @ XG)) => (cwcel @ (ccfv @ (ccmpt @ (^ [Xt:$i] : ccr) @ (^ [Xt:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xt) @ XG) @ (ccfv @ (ccv @ Xt) @ XF) @ ccmin) @ ccabs))) @ ccitg2) @ ccr))))).
...
thf(alenegcon2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ (ccneg @ XB2) @ ccle)) => (Xph => (cwbr @ XB2 @ (ccneg @ XA2) @ ccle))))))))).
