...
thf(aclwwlkn1_ax,axiom,(! [XG:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ (cco @ cc1 @ XG @ ccclwwlkn)) <=> (cw3a @ ((ccfv @ XW @ cchash) = cc1) @ (cwcel @ XW @ (ccword @ (ccfv @ XG @ ccvtx))) @ (cwcel @ (ccsn @ (ccfv @ ccc0 @ XW)) @ (ccfv @ XG @ ccedg))))))).
...
thf(cclwwlkn1loopb_conj,conjecture,(! [XG:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ (cco @ cc1 @ XG @ ccclwwlkn)) <=> (cwrex @ (^ [Xv:$i] : ((XW = (ccs1 @ (ccv @ Xv))) & (cwcel @ (ccsn @ (ccv @ Xv)) @ (ccfv @ XG @ ccedg)))) @ (^ [Xv:$i] : (ccfv @ XG @ ccvtx))))))).
