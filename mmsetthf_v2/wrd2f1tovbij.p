...
thf(cwrd2f1tovbij_conj,conjecture,(! [XP:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > ($i > ($i > ($i > $o))))] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xn:$i] : (((cwcel @ XV @ (XY @ Xw @ Xf1 @ Xn)) & (cwcel @ XP @ XV)) => (? [Xf1:$i] : (cwf1o @ (ccrab @ (^ [Xw:$i] : (cw3a @ ((ccfv @ (ccv @ Xw) @ cchash) = cc2) @ ((ccfv @ ccc0 @ (ccv @ Xw)) = XP) @ (cwcel @ (ccpr @ (ccfv @ ccc0 @ (ccv @ Xw)) @ (ccfv @ cc1 @ (ccv @ Xw))) @ XX))) @ (^ [Xw:$i] : (ccword @ XV))) @ (ccrab @ (^ [Xn:$i] : (cwcel @ (ccpr @ XP @ (ccv @ Xn)) @ XX)) @ (^ [Xn:$i] : XV)) @ (ccv @ Xf1)))))))))))).
