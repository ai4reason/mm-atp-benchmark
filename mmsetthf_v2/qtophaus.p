...
thf(aopeldifid_ax,axiom,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwrel @ XA2) => ((cwcel @ (ccop @ XX @ XY) @ (ccdif @ XA2 @ ccid)) <=> ((cwcel @ (ccop @ XX @ XY) @ XA2) & (cwne @ XX @ XY)))))))).
...
thf(afcoinvbr_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_sm = (cccom @ (cccnv @ XF) @ XF)) => ((cw3a @ (cwfn @ XF @ XA2) @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XA2)) => ((cwbr @ XX @ XY @ Xc_sm) <=> ((ccfv @ XX @ XF) = (ccfv @ XY @ XF))))))))))).
...
thf(afcoinver_ax,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwfn @ XF @ XX) => (cwer @ XX @ (cccom @ (cccnv @ XF) @ XF)))))).
