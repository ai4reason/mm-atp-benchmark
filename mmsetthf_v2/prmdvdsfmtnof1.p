...
thf(aprmdvdsfmtnof_ax,axiom,(! [XF:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xp:$i] : ((XF @ Xf1 @ Xp) = (ccmpt @ (^ [Xf1:$i] : (ccrn @ ccfmtno)) @ (^ [Xf1:$i] : (ccinf @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ (ccv @ Xf1) @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ ccr @ cclt)))))) => (! [Xf1:$i] : (! [Xp:$i] : (cwf @ (ccrn @ ccfmtno) @ ccprime @ (XF @ Xf1 @ Xp))))))).
...
thf(aprmdvdsfmtnof1lem1_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : ((! [Xp:$i] : ((XI @ Xp) = (ccinf @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XF @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ ccr @ cclt))) => ((! [Xp:$i] : ((XJ @ Xp) = (ccinf @ (ccrab @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XG @ ccdvds)) @ (^ [Xp:$i] : ccprime)) @ ccr @ cclt))) => (! [Xp:$i] : (((cwcel @ XF @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XG @ (ccfv @ cc2 @ ccuz))) => (((XI @ Xp) = (XJ @ Xp)) => (cw3a @ (cwcel @ (XI @ Xp) @ ccprime) @ (cwbr @ (XI @ Xp) @ XF @ ccdvds) @ (cwbr @ (XI @ Xp) @ XG @ ccdvds)))))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(ccgcd_tp,type,(ccgcd : ($i > $o))).
thf(aprmdvdsfmtnof1lem2_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (((cwcel @ XF @ (ccrn @ ccfmtno)) & (cwcel @ XG @ (ccrn @ ccfmtno))) => ((cw3a @ (cwcel @ XI @ ccprime) @ (cwbr @ XI @ XF @ ccdvds) @ (cwbr @ XI @ XG @ ccdvds)) => (XF = XG))))))).
