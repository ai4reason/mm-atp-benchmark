...
thf(aipasslem8_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((! [Xw:$i] : ((XG @ Xw) = (ccfv @ XU @ ccpv))) => ((XS = (ccfv @ XU @ ccns)) => ((XP = (ccfv @ XU @ ccdip)) => ((cwcel @ XU @ cccphlo) => ((cwcel @ XA2 @ XX) => ((cwcel @ XB2 @ XX) => ((! [Xw:$i] : ((XF @ Xw) = (ccmpt @ (^ [Xw:$i] : ccr) @ (^ [Xw:$i] : (cco @ (cco @ (cco @ (ccv @ Xw) @ XA2 @ XS) @ XB2 @ XP) @ (cco @ (ccv @ Xw) @ (cco @ XA2 @ XB2 @ XP) @ ccmul) @ ccmin))))) => (! [Xw:$i] : (cwf @ ccr @ (ccsn @ ccc0) @ (XF @ Xw)))))))))))))))))))).
