...
thf(acoshalfpip_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (cco @ (cco @ ccpi @ cc2 @ ccdiv) @ XA2 @ ccaddc) @ cccos) = (ccneg @ (ccfv @ XA2 @ ccsin)))))).
...
thf(asincos6thpi_ax,axiom,(((ccfv @ (cco @ ccpi @ cc6 @ ccdiv) @ ccsin) = (cco @ cc1 @ cc2 @ ccdiv)) & ((ccfv @ (cco @ ccpi @ cc6 @ ccdiv) @ cccos) = (cco @ (ccfv @ cc3 @ ccsqrt) @ cc2 @ ccdiv)))).
...
thf(asinhalfpip_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (cco @ (cco @ ccpi @ cc2 @ ccdiv) @ XA2 @ ccaddc) @ ccsin) = (ccfv @ XA2 @ cccos))))).
...
thf(aefival_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ (cco @ cci @ XA2 @ ccmul) @ cce) = (cco @ (ccfv @ XA2 @ cccos) @ (cco @ cci @ (ccfv @ XA2 @ ccsin) @ ccmul) @ ccaddc))))).
...
thf(aroot1cj_ax,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwcel @ XK @ ccz)) => ((ccfv @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ XN @ ccdiv) @ cccxp) @ XK @ ccexp) @ cccj) = (cco @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ XN @ ccdiv) @ cccxp) @ (cco @ XN @ XK @ ccmin) @ ccexp)))))).
...
thf(acjdivi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwne @ XB2 @ ccc0) => ((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ cccj) = (cco @ (ccfv @ XA2 @ cccj) @ (ccfv @ XB2 @ cccj) @ ccdiv)))))))).
thf(aaddcli_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => (cwcel @ (cco @ XA2 @ XB2 @ ccaddc) @ ccc)))))).
thf(acjaddi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cccj) = (cco @ (ccfv @ XA2 @ cccj) @ (ccfv @ XB2 @ cccj) @ ccaddc))))))).
