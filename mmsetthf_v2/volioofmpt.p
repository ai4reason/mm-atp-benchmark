...
thf(cvolioofmpt_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XF @ Xx3))) => ((! [Xx3:$i] : (Xph => (cwf @ XA2 @ (ccxp @ ccxr @ ccxr) @ (XF @ Xx3)))) => (! [Xx3:$i] : (Xph => ((cccom @ (cccom @ ccvol @ ccioo) @ (XF @ Xx3)) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (cco @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ cc1st) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ (XF @ Xx3)) @ cc2nd) @ ccioo) @ ccvol)))))))))))).
