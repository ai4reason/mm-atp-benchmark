...
thf(agoldbachth_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XM @ ccn0) @ (cwne @ XN @ XM)) => ((cco @ (ccfv @ XN @ ccfmtno) @ (ccfv @ XM @ ccfmtno) @ ccgcd) = cc1))))).
...
thf(acoprmdvds1_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((cw3a @ (cwcel @ XF @ ccn) @ (cwcel @ XG @ ccn) @ ((cco @ XF @ XG @ ccgcd) = cc1)) => ((cw3a @ (cwcel @ XI @ ccn) @ (cwbr @ XI @ XF @ ccdvds) @ (cwbr @ XI @ XG @ ccdvds)) => (XI = cc1))))))).
...
thf(cprmdvdsfmtnof1lem2_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (((cwcel @ XF @ (ccrn @ ccfmtno)) & (cwcel @ XG @ (ccrn @ ccfmtno))) => ((cw3a @ (cwcel @ XI @ ccprime) @ (cwbr @ XI @ XF @ ccdvds) @ (cwbr @ XI @ XG @ ccdvds)) => (XF = XG))))))).
