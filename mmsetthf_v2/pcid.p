...
thf(apcidlem_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccn0)) => ((cco @ XP @ (cco @ XP @ XA2 @ ccexp) @ ccpc) = XA2))))).
...
thf(cpcid_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccz)) => ((cco @ XP @ (cco @ XP @ XA2 @ ccexp) @ ccpc) = XA2))))).
