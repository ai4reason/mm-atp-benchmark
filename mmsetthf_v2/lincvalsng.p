...
thf(clincvalsng_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((XS = (ccfv @ XM @ ccsca)) => ((XR = (ccfv @ XS @ ccbs)) => ((Xc_x = (ccfv @ XM @ ccvsca)) => ((cw3a @ (cwcel @ XM @ cclmod) @ (cwcel @ XV @ XB2) @ (cwcel @ XY @ XR)) => ((cco @ (ccsn @ (ccop @ XV @ XY)) @ (ccsn @ XV) @ (ccfv @ XM @ cclinc)) = (cco @ XY @ XV @ Xc_x))))))))))))))).
