...
thf(arngoisohom_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwcel @ XR @ ccrngo) @ (cwcel @ XS @ ccrngo) @ (cwcel @ XF @ (cco @ XR @ XS @ ccrngiso))) => (cwcel @ XF @ (cco @ XR @ XS @ ccrnghom))))))).
...
thf(arngohomco_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cw3a @ (cwcel @ XR @ ccrngo) @ (cwcel @ XS @ ccrngo) @ (cwcel @ XT @ ccrngo)) & ((cwcel @ XF @ (cco @ XR @ XS @ ccrnghom)) & (cwcel @ XG @ (cco @ XS @ XT @ ccrnghom)))) => (cwcel @ (cccom @ XG @ XF) @ (cco @ XR @ XT @ ccrnghom))))))))).
thf(asyl2anc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xph => Xch) => (((Xps & Xch) => Xth) => (Xph => Xth))))))))).
thf(aadantrl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => ((Xph & (Xth & Xps)) => Xch))))))).
thf(arngoiso1o_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (ccfv @ XR @ cc1st)) => ((XX = (ccrn @ XG)) => ((XJ = (ccfv @ XS @ cc1st)) => ((XY = (ccrn @ XJ)) => ((cw3a @ (cwcel @ XR @ ccrngo) @ (cwcel @ XS @ ccrngo) @ (cwcel @ XF @ (cco @ XR @ XS @ ccrngiso))) => (cwf1o @ XX @ XY @ XF)))))))))))))).
...
thf(crngoisoco_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cw3a @ (cwcel @ XR @ ccrngo) @ (cwcel @ XS @ ccrngo) @ (cwcel @ XT @ ccrngo)) & ((cwcel @ XF @ (cco @ XR @ XS @ ccrngiso)) & (cwcel @ XG @ (cco @ XS @ XT @ ccrngiso)))) => (cwcel @ (cccom @ XG @ XF) @ (cco @ XR @ XT @ ccrngiso))))))))).
