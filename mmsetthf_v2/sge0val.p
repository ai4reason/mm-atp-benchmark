...
thf(csge0val_conj,conjecture,(! [XF:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : (! [Xy1:$i] : (! [Xw:$i] : (((cwcel @ (XX @ Xw) @ (XV @ Xy1 @ Xw)) & (cwf @ (XX @ Xw) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((ccfv @ XF @ ccsumge0) = (ccif @ (cwcel @ ccpnf @ (ccrn @ XF)) @ ccpnf @ (ccsup @ (ccrn @ (ccmpt @ (^ [Xy1:$i] : (ccin @ (ccpw @ (XX @ Xw)) @ ccfn)) @ (^ [Xy1:$i] : (ccsu @ (ccv @ Xy1) @ (^ [Xw:$i] : (ccfv @ (ccv @ Xw) @ XF)))))) @ ccxr @ cclt)))))))))).
