...
thf(agexcl3_ax,axiom,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => ((! [Xx3:$i] : ((XO @ Xx3) = (ccfv @ XG @ ccod))) => (((cwcel @ XG @ ccgrp) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ (XO @ Xx3)) @ (cco @ cc1 @ XN @ ccfz))) @ (^ [Xx3:$i] : XX))) => (cwcel @ XE @ ccn))))))))))).
