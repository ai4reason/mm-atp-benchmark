...
thf(aiprodefisum_ax,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XF) = (XB2 @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XB2 @ Xk) @ ccc))) => ((Xph => (cwcel @ (ccseq @ ccaddc @ XF @ XM) @ (ccdm @ ccli))) => (Xph => ((ccprod @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccfv @ (XB2 @ Xk) @ cce))) = (ccfv @ (ccsu @ XZ @ (^ [Xk:$i] : (XB2 @ Xk))) @ cce)))))))))))))).
...
thf(ciprodgam_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn)))) => (Xph => ((ccfv @ XA2 @ ccgam) = (cco @ (ccprod @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ cc1 @ (cco @ cc1 @ (ccv @ Xk) @ ccdiv) @ ccaddc) @ XA2 @ cccxp) @ (cco @ cc1 @ (cco @ XA2 @ (ccv @ Xk) @ ccdiv) @ ccaddc) @ ccdiv))) @ XA2 @ ccdiv))))))).
