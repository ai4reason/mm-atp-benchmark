...
thf(cmptiniseg_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XV:($i > $o)] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => (! [Xx3:$i] : ((cwcel @ XC @ XV) => ((ccima @ (cccnv @ (XF @ Xx3)) @ (ccsn @ XC)) = (ccrab @ (^ [Xx3:$i] : ((XB2 @ Xx3) = XC)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))))))).
