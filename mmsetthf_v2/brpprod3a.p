...
thf(approdss4v_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ (ccpprod @ XA2 @ XB2) @ (ccxp @ (ccxp @ ccvv @ ccvv) @ (ccxp @ ccvv @ ccvv)))))).
...
thf(abrpprod_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ ccvv) => ((cwcel @ XZ @ ccvv) => ((cwcel @ XW @ ccvv) => ((cwbr @ (ccop @ XX @ XY) @ (ccop @ XZ @ XW) @ (ccpprod @ XA2 @ XB2)) <=> ((cwbr @ XX @ XZ @ XA2) & (cwbr @ XY @ XW @ XB2)))))))))))))).
thf(avex_ax,axiom,(! [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ ccvv))).
thf(a_3anass_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) <=> (Xph & (Xps & Xch))))))).
thf(cbrpprod3a_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ ccvv) => ((cwcel @ XZ @ ccvv) => ((cwbr @ (ccop @ XX @ XY) @ XZ @ (ccpprod @ XR @ XS)) <=> (? [Xz:$i] : (? [Xw:$i] : (cw3a @ (XZ = (ccop @ (ccv @ Xz) @ (ccv @ Xw))) @ (cwbr @ XX @ (ccv @ Xz) @ XR) @ (cwbr @ XY @ (ccv @ Xw) @ XS)))))))))))))).
