...
thf(alogcxp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccrp) & (cwcel @ XB2 @ ccr)) => ((ccfv @ (cco @ XA2 @ XB2 @ cccxp) @ cclog) = (cco @ XB2 @ (ccfv @ XA2 @ cclog) @ ccmul)))))).
...
thf(crelogbreexp_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : ((cw3a @ (cwcel @ XB2 @ (ccdif @ ccc @ (ccpr @ ccc0 @ cc1))) @ (cwcel @ XC @ ccrp) @ (cwcel @ XE @ ccr)) => ((cco @ XB2 @ (cco @ XC @ XE @ cccxp) @ cclogb) = (cco @ XE @ (cco @ XB2 @ XC @ cclogb) @ ccmul))))))).
