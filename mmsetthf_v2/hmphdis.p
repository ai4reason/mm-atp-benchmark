...
thf(ahmeoopn_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XF @ (cco @ XJ @ XK @ cchmeo)) & (cwss @ XA2 @ XX)) => ((cwcel @ XA2 @ XJ) <=> (cwcel @ (ccima @ XF @ XA2) @ XK)))))))))).
thf(chmphdis_conj,conjecture,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwbr @ XJ @ (ccpw @ XA2) @ cchmph) => (XJ = (ccpw @ XX)))))))).
