...
thf(adf_dmat_ax,axiom,(ccdmat = (ccmpt2 @ (^ [Xn:$i] : (^ [Xr:$i] : ccfn)) @ (^ [Xn:$i] : (^ [Xr:$i] : ccvv)) @ (^ [Xn:$i] : (^ [Xr:$i] : (ccrab @ (^ [Xm:$i] : (cwral @ (^ [Xi:$i] : (cwral @ (^ [Xj:$i] : ((cwne @ (ccv @ Xi) @ (ccv @ Xj)) => ((cco @ (ccv @ Xi) @ (ccv @ Xj) @ (ccv @ Xm)) = (ccfv @ (ccv @ Xr) @ cc0g)))) @ (^ [Xj:$i] : (ccv @ Xn)))) @ (^ [Xi:$i] : (ccv @ Xn)))) @ (^ [Xm:$i] : (ccfv @ (cco @ (ccv @ Xn) @ (ccv @ Xr) @ ccmat) @ ccbs)))))))).
