...
thf(aopprval_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XO:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XO = (ccfv @ XR @ ccoppr)) => (XO = (cco @ XR @ (ccop @ (ccfv @ ccnx @ ccmulr) @ (cctpos @ Xc_x)) @ ccsts)))))))))).
...
thf(atpos0_ax,axiom,((cctpos @ cc0) = cc0)).
...
thf(copprmulfval_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XO:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XO = (ccfv @ XR @ ccoppr)) => ((Xc_xb = (ccfv @ XO @ ccmulr)) => (Xc_xb = (cctpos @ Xc_x)))))))))))).
