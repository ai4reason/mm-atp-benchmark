...
thf(asstp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwss @ XA2 @ (cctp @ XB2 @ XC @ XD)) <=> ((((XA2 = cc0) | (XA2 = (ccsn @ XB2))) | ((XA2 = (ccsn @ XC)) | (XA2 = (ccpr @ XB2 @ XC)))) | (((XA2 = (ccsn @ XD)) | (XA2 = (ccpr @ XB2 @ XD))) | ((XA2 = (ccpr @ XC @ XD)) | (XA2 = (cctp @ XB2 @ XC @ XD))))))))))).
