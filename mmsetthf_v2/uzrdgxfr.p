...
thf(apncan3i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cco @ XA2 @ (cco @ XB2 @ XA2 @ ccmin) @ ccaddc) = XB2)))))).
...
thf(aadd32_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) => ((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ XC @ ccaddc) = (cco @ (cco @ XA2 @ XC @ ccaddc) @ XB2 @ ccaddc))))))).
thf(cuzrdgxfr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc1 @ ccaddc))) @ XA2) @ ccom))) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccres @ (ccrdg @ (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ cc1 @ ccaddc))) @ XB2) @ ccom))) => ((cwcel @ XA2 @ ccz) => ((cwcel @ XB2 @ ccz) => (! [Xx3:$i] : ((cwcel @ (XN @ Xx3) @ ccom) => ((ccfv @ (XN @ Xx3) @ (XG @ Xx3)) = (cco @ (ccfv @ (XN @ Xx3) @ (XH @ Xx3)) @ (cco @ XA2 @ XB2 @ ccmin) @ ccaddc)))))))))))))).
