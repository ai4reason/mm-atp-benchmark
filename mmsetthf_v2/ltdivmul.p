...
thf(cltdivmul_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ ((cwcel @ XC @ ccr) & (cwbr @ ccc0 @ XC @ cclt))) => ((cwbr @ (cco @ XA2 @ XC @ ccdiv) @ XB2 @ cclt) <=> (cwbr @ XA2 @ (cco @ XC @ XB2 @ ccmul) @ cclt))))))).
