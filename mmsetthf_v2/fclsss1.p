...
thf(cfclsss1_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwss @ XJ @ XK)) => (cwss @ (cco @ XK @ XF @ ccfcls) @ (cco @ XJ @ XF @ ccfcls)))))))).
