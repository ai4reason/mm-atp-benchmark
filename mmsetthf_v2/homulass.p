...
thf(chomulass_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwf @ cchil @ cchil @ XT)) => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ XT @ cchot) = (cco @ XA2 @ (cco @ XB2 @ XT @ cchot) @ cchot))))))).
