...
thf(ausgrnloop_ax,axiom,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((! [Xx3:$i] : ((XE @ Xx3) = (ccfv @ XG @ cciedg))) => ((cwcel @ XG @ ccusgr) => ((cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (XE @ Xx3)) = (ccpr @ XM @ XN))) @ (^ [Xx3:$i] : (ccdm @ (XE @ Xx3)))) => (cwne @ XM @ XN))))))))).
