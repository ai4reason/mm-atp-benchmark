...
thf(adignn0flhalflem1_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn) @ (cwcel @ XN @ ccn)) => (cwbr @ (ccfv @ (cco @ (cco @ XA2 @ (cco @ cc2 @ XN @ ccexp) @ ccdiv) @ cc1 @ ccmin) @ ccfl) @ (ccfv @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ (cco @ cc2 @ XN @ ccexp) @ ccdiv) @ ccfl) @ cclt))))).
...
thf(azgtp1leeq_ax,axiom,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (((cwcel @ XI @ ccz) & (cwcel @ XA2 @ ccz)) => (((cwbr @ (cco @ XA2 @ cc1 @ ccmin) @ XI @ cclt) & (cwbr @ XI @ XA2 @ ccle)) => (XI = XA2)))))).
thf(cdignn0flhalflem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccn) @ (cwcel @ XN @ ccn0)) => ((ccfv @ (cco @ XA2 @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccexp) @ ccdiv) @ ccfl) = (ccfv @ (cco @ (ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ ccfl) @ (cco @ cc2 @ XN @ ccexp) @ ccdiv) @ ccfl)))))).
