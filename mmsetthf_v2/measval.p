...
thf(cmeasval_conj,conjecture,(! [XS:($i > ($i > $o))] : (! [Xy1:$i] : ((cwcel @ (XS @ Xy1) @ (ccuni @ (ccrn @ ccsiga))) => ((ccfv @ (XS @ Xy1) @ ccmeas) = (ccab @ (^ [Xm:$i] : (cw3a @ (cwf @ (XS @ Xy1) @ (cco @ ccc0 @ ccpnf @ ccicc) @ (ccv @ Xm)) @ ((ccfv @ cc0 @ (ccv @ Xm)) = ccc0) @ (cwral @ (^ [Xx3:$i] : (((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) & (cwdisj @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccv @ Xy1)))) => ((ccfv @ (ccuni @ (ccv @ Xx3)) @ (ccv @ Xm)) = (ccesum @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ (ccv @ Xm))))))) @ (^ [Xx3:$i] : (ccpw @ (XS @ Xy1)))))))))))).
