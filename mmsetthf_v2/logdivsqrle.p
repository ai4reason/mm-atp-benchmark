...
thf(afdvnegge_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((! [Xx3:$i] : (XE = (cco @ (XC @ Xx3) @ (XD @ Xx3) @ ccioo))) => ((Xph => (cwcel @ XA2 @ XE)) => ((Xph => (cwcel @ XB2 @ XE)) => ((Xph => (cwf @ XE @ ccr @ XF)) => ((Xph => (cwcel @ (cco @ ccr @ XF @ ccdv) @ (cco @ XE @ ccr @ cccncf))) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccioo))) => (cwbr @ (ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) @ ccc0 @ ccle))) => (Xph => (cwbr @ (ccfv @ XB2 @ XF) @ (ccfv @ XA2 @ XF) @ ccle))))))))))))))))).
...
thf(acxpcncf1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwss @ XD @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc)))) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ cccxp))) @ (cco @ XD @ ccc @ cccncf))))))))).
