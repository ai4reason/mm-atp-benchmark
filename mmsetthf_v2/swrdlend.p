...
thf(cswrdlend_conj,conjecture,(! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XF @ ccz) @ (cwcel @ XL @ ccz)) => ((cwbr @ XL @ XF @ ccle) => ((cco @ XW @ (ccop @ XF @ XL) @ ccsubstr) = cc0)))))))).
