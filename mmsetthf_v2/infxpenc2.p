...
thf(acnfcom3c_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (? [Xg1:$i] : (cwral @ (^ [Xb:$i] : ((cwss @ ccom @ (ccv @ Xb)) => (cwrex @ (^ [Xw:$i] : (cwf1o @ (ccv @ Xb) @ (cco @ ccom @ (ccv @ Xw) @ ccoe) @ (ccfv @ (ccv @ Xb) @ (ccv @ Xg1)))) @ (^ [Xw:$i] : (ccdif @ ccon0 @ cc1o))))) @ (^ [Xb:$i] : XA2)))))).
...
thf(aomxpen_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => (cwbr @ (cco @ XA2 @ XB2 @ ccomu) @ (ccxp @ XA2 @ XB2) @ ccen))))).
...
thf(ainfxpenc2lem3_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xg1:$i] : (! [Xn:$i] : ((Xph @ Xg1 @ Xn) => (cwcel @ XA2 @ ccon0)))) => ((! [Xg1:$i] : (! [Xn:$i] : ((Xph @ Xg1 @ Xn) => (cwral @ (^ [Xb:$i] : ((cwss @ ccom @ (ccv @ Xb)) => (cwrex @ (^ [Xw:$i] : (cwf1o @ (ccv @ Xb) @ (cco @ ccom @ (ccv @ Xw) @ ccoe) @ (ccfv @ (ccv @ Xb) @ (ccv @ Xn)))) @ (^ [Xw:$i] : (ccdif @ ccon0 @ cc1o))))) @ (^ [Xb:$i] : XA2))))) => ((! [Xn:$i] : (! [Xb:$i] : ((XW @ Xn @ Xb) = (ccfv @ (ccrn @ (ccfv @ (ccv @ Xb) @ (ccv @ Xn))) @ (cccnv @ (ccmpt @ (^ [Xx3:$i] : (ccdif @ ccon0 @ cc1o)) @ (^ [Xx3:$i] : (cco @ ccom @ (ccv @ Xx3) @ ccoe)))))))) => ((! [Xw:$i] : (! [Xg1:$i] : (! [Xn:$i] : (! [Xb:$i] : ((Xph @ Xg1 @ Xn) => (cwf1o @ (cco @ ccom @ cc2o @ ccoe) @ ccom @ (XF @ Xw @ Xn @ Xb))))))) => ((! [Xw:$i] : (! [Xg1:$i] : (! [Xn:$i] : (! [Xb:$i] : ((Xph @ Xg1 @ Xn) => ((ccfv @ cc0 @ (XF @ Xw @ Xn @ Xb)) = cc0)))))) => (! [Xg1:$i] : (! [Xn:$i] : ((Xph @ Xg1 @ Xn) => (? [Xg1:$i] : (cwral @ (^ [Xb:$i] : ((cwss @ ccom @ (ccv @ Xb)) => (cwf1o @ (ccxp @ (ccv @ Xb) @ (ccv @ Xb)) @ (ccv @ Xb) @ (ccfv @ (ccv @ Xb) @ (ccv @ Xg1))))) @ (^ [Xb:$i] : XA2)))))))))))))))).
...
thf(afveqf1o_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (cccom @ XF @ (ccun @ (ccres @ ccid @ (ccdif @ XA2 @ (ccpr @ XC @ (ccfv @ XD @ (cccnv @ XF))))) @ (ccpr @ (ccop @ XC @ (ccfv @ XD @ (cccnv @ XF))) @ (ccop @ (ccfv @ XD @ (cccnv @ XF)) @ XC))))) => ((cw3a @ (cwf1o @ XA2 @ XB2 @ XF) @ (cwcel @ XC @ XA2) @ (cwcel @ XD @ XB2)) => ((cwf1o @ XA2 @ XB2 @ XG) & ((ccfv @ XC @ XG) = XD))))))))))).
