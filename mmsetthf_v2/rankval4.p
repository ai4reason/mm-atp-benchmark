...
thf(arankid_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwcel @ XA2 @ (ccfv @ (ccsuc @ (ccfv @ XA2 @ ccrnk)) @ ccr1))))).
...
thf(arankval2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XA2 @ (XB2 @ Xx3)) => ((ccfv @ XA2 @ ccrnk) = (ccint @ (ccrab @ (^ [Xx3:$i] : (cwss @ XA2 @ (ccfv @ (ccv @ Xx3) @ ccr1))) @ (^ [Xx3:$i] : ccon0))))))))).
