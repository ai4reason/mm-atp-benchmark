...
thf(acnegex_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwrex @ (^ [Xx3:$i] : ((cco @ XA2 @ (ccv @ Xx3) @ ccaddc) = ccc0)) @ (^ [Xx3:$i] : ccc))))).
...
thf(caddcan2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) => (((cco @ XA2 @ XC @ ccaddc) = (cco @ XB2 @ XC @ ccaddc)) <=> (XA2 = XB2))))))).
