...
thf(arolle_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwcel @ XF @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccr @ cccncf))) => ((Xph => ((ccdm @ (cco @ ccr @ XF @ ccdv)) = (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))) => (Xph => (cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ (cco @ ccr @ XF @ ccdv)) = ccc0)) @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccioo))))))))))))))).
