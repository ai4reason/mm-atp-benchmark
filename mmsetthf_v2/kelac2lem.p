...
thf(abaspartn_ax,axiom,(! [XP:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XP @ (XV @ Xx3 @ Xy1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) | ((ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) = cc0))) @ (^ [Xy1:$i] : XP))) @ (^ [Xx3:$i] : XP))) => (cwcel @ XP @ cctb))))))).
...
thf(atgdom_ax,axiom,(! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => (cwbr @ (ccfv @ XB2 @ cctg) @ (ccpw @ XB2) @ ccdom))))).
thf(adomfi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwbr @ XB2 @ XA2 @ ccdom)) => (cwcel @ XB2 @ ccfn))))).
thf(afincmp_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ (ccin @ cctop @ ccfn)) => (cwcel @ XJ @ cccmp)))).
