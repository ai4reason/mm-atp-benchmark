...
thf(atxuni2_ax,axiom,(! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XB2 @ Xx3 @ Xy1) = (ccrn @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XR)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XS)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccxp @ (ccv @ Xx3) @ (ccv @ Xy1))))))))) => ((XX = (ccuni @ XR)) => ((XY = (ccuni @ XS)) => (! [Xx3:$i] : (! [Xy1:$i] : ((ccxp @ XX @ XY) = (ccuni @ (XB2 @ Xx3 @ Xy1)))))))))))))).
...
thf(csxsigon_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) & (cwcel @ XT @ (ccuni @ (ccrn @ ccsiga)))) => (cwcel @ (cco @ XS @ XT @ ccsx) @ (ccfv @ (ccxp @ (ccuni @ XS) @ (ccuni @ XT)) @ ccsiga)))))).
