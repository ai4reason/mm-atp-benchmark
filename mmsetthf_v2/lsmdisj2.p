...
thf(clsmdisj2_conj,conjecture,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_po = (ccfv @ XG @ cclsm)) => ((Xph => (cwcel @ XS @ (ccfv @ XG @ ccsubg))) => ((Xph => (cwcel @ XT @ (ccfv @ XG @ ccsubg))) => ((Xph => (cwcel @ XU @ (ccfv @ XG @ ccsubg))) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => ((ccin @ (cco @ XS @ XT @ Xc_po) @ XU) = (ccsn @ Xc_0))) => ((Xph => ((ccin @ XS @ XT) = (ccsn @ Xc_0))) => (Xph => ((ccin @ XT @ (cco @ XS @ XU @ Xc_po)) = (ccsn @ Xc_0)))))))))))))))))).
