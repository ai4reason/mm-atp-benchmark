...
thf(cstoweidlem21_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (cwnfc @ (^ [Xt:$i] : (XG @ Xx3 @ Xt)))) => ((! [Xx3:$i] : (cwnfc @ (^ [Xt:$i] : (XH @ Xx3 @ Xt)))) => ((! [Xf1:$i] : (cwnfc @ (^ [Xt:$i] : (XS @ Xt @ Xf1)))) => ((cwnf @ (^ [Xt:$i] : (Xph @ Xt))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : ((XG @ Xx3 @ Xt) = (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (XH @ Xx3 @ Xt)) @ (XS @ Xt @ Xf1) @ ccaddc))))))) => ((! [Xx3:$i] : (! [Xt:$i] : ((Xph @ Xt) => (cwf @ XT @ ccr @ (XF @ Xx3 @ Xt))))) => ((! [Xt:$i] : (! [Xf1:$i] : ((Xph @ Xt) => (cwcel @ (XS @ Xt @ Xf1) @ ccr)))) => ((! [Xt:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((cw3a @ (Xph @ Xt) @ (cwcel @ (ccv @ Xf1) @ (XA2 @ Xt)) @ (cwcel @ (ccv @ Xg1) @ (XA2 @ Xt))) => (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccaddc))) @ (XA2 @ Xt)))))) => ((! [Xx3:$i] : (! [Xt:$i] : (((Xph @ Xt) & (cwcel @ (ccv @ Xx3) @ ccr)) => (cwcel @ (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccv @ Xx3))) @ (XA2 @ Xt))))) => ((! [Xt:$i] : ((Xph @ Xt) => (cwral @ (^ [Xf1:$i] : (cwf @ XT @ ccr @ (ccv @ Xf1))) @ (^ [Xf1:$i] : (XA2 @ Xt))))) => ((! [Xx3:$i] : (! [Xt:$i] : ((Xph @ Xt) => (cwcel @ (XH @ Xx3 @ Xt) @ (XA2 @ Xt))))) => ((! [Xx3:$i] : (! [Xt:$i] : (! [Xf1:$i] : ((Xph @ Xt) => (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xt) @ (XH @ Xx3 @ Xt)) @ (cco @ (ccfv @ (ccv @ Xt) @ (XF @ Xx3 @ Xt)) @ (XS @ Xt @ Xf1) @ ccmin) @ ccmin) @ ccabs) @ (XE @ Xx3 @ Xt) @ cclt)) @ (^ [Xt:$i] : XT)))))) => (! [Xx3:$i] : (! [Xt:$i] : ((Xph @ Xt) => (cwrex @ (^ [Xf1:$i] : (cwral @ (^ [Xt:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xt) @ (XF @ Xx3 @ Xt)) @ ccmin) @ ccabs) @ (XE @ Xx3 @ Xt) @ cclt)) @ (^ [Xt:$i] : XT))) @ (^ [Xf1:$i] : (XA2 @ Xt))))))))))))))))))))))))))).
