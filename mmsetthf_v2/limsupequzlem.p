...
thf(azssxr_ax,axiom,(cwss @ ccz @ ccxr)).
...
thf(atpid1g_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ XB2) => (cwcel @ XA2 @ (cctp @ XA2 @ XC @ XD)))))))).
thf(auzss_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ XM @ ccuz)) => (cwss @ (ccfv @ XN @ ccuz) @ (ccfv @ XM @ ccuz)))))).
thf(atpid2g_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ XB2) => (cwcel @ XA2 @ (cctp @ XC @ XA2 @ XD)))))))).
...
thf(afnexd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwfn @ XF @ XA2)) => ((Xph => (cwcel @ XA2 @ XV)) => (Xph => (cwcel @ XF @ ccvv))))))))).
...
thf(climsupequzlem_conj,conjecture,(! [Xph:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XM @ ccz))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwfn @ XF @ (ccfv @ XM @ ccuz)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XN @ ccz))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwfn @ XG @ (ccfv @ XN @ ccuz)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XK @ ccz))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ (ccfv @ XK @ ccuz))) => ((ccfv @ (ccv @ Xk) @ XF) = (ccfv @ (ccv @ Xk) @ XG)))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccfv @ XF @ cclsp) = (ccfv @ XG @ cclsp)))))))))))))))))).
