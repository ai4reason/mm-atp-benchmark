...
thf(arlimcnp2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : ((Xph => (cwss @ XA2 @ (cco @ ccc0 @ ccpnf @ ccico))) => ((Xph => (cwcel @ ccc0 @ XA2)) => ((Xph => (cwss @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccc)) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XB2)) => (cwcel @ (XS @ Xy1) @ ccc))) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ ccrp)) => ((cwcel @ (ccv @ Xy1) @ XB2) <=> (cwcel @ (cco @ cc1 @ (ccv @ Xy1) @ ccdiv) @ XA2)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xy1) = (cco @ cc1 @ (ccv @ Xx3) @ ccdiv)) => ((XS @ Xy1) = (XR @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XJ @ Xx3 @ Xy1) = (ccfv @ cccnfld @ cctopn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XK @ Xx3 @ Xy1) = (cco @ (XJ @ Xx3 @ Xy1) @ XA2 @ ccrest)))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((cwbr @ (ccmpt @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (XS @ Xy1))) @ XC @ ccrli) <=> (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = ccc0) @ XC @ (XR @ Xx3)))) @ (ccfv @ ccc0 @ (cco @ (XK @ Xx3 @ Xy1) @ (XJ @ Xx3 @ Xy1) @ cccnp))))))))))))))))))))))))).
