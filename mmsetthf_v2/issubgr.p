...
thf(cissubgr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XS @ ccvtx)) => ((XA2 = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XS @ cciedg)) => ((XB2 = (ccfv @ XG @ cciedg)) => ((XE = (ccfv @ XS @ ccedg)) => (((cwcel @ XG @ XW) & (cwcel @ XS @ XU)) => ((cwbr @ XS @ XG @ ccsubgr) <=> (cw3a @ (cwss @ XV @ XA2) @ (XI = (ccres @ XB2 @ (ccdm @ XI))) @ (cwss @ XE @ (ccpw @ XV)))))))))))))))))))).
