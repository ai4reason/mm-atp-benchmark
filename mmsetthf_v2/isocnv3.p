...
thf(cisocnv3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : ((XC = (ccdif @ (ccxp @ XA2 @ XA2) @ XR)) => ((XD = (ccdif @ (ccxp @ XB2 @ XB2) @ XS)) => ((cwiso @ XA2 @ XB2 @ XR @ XS @ XH) <=> (cwiso @ XA2 @ XB2 @ XC @ XD @ XH)))))))))))).
