...
thf(aofcfval4_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwf @ (XA2 @ Xx3) @ XB2 @ XF))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XA2 @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XC @ (XW @ Xx3)))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cco @ XF @ XC @ (ccofc @ XR)) = (cccom @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XC @ XR))) @ XF)))))))))))))))).
...
thf(armulccn_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ (ccrn @ ccioo) @ cctg))) => ((Xph => (cwcel @ XC @ ccr)) => (! [Xx3:$i] : (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XC @ ccmul))) @ (cco @ (XJ @ Xx3) @ (XJ @ Xx3) @ cccn)))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(aa1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(adf_brsiga_ax,axiom,(ccbrsiga = (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ ccsigagen))).
thf(crrvmulc_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XP @ ccprb)) => ((Xph => (cwcel @ XX @ (ccfv @ XP @ ccrrv))) => ((Xph => (cwcel @ XC @ ccr)) => (Xph => (cwcel @ (cco @ XX @ XC @ (ccofc @ ccmul)) @ (ccfv @ XP @ ccrrv))))))))))).
