...
thf(celdmres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xy1:$i] : ((cwcel @ XB2 @ (XV @ Xy1)) => ((cwcel @ XB2 @ (ccdm @ (ccres @ XR @ XA2))) <=> ((cwcel @ XB2 @ XA2) & (? [Xy1:$i] : (cwbr @ XB2 @ (ccv @ Xy1) @ XR))))))))))).
