...
thf(ainitoeu1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XC @ ccinito))) => ((Xph => (cwcel @ XB2 @ (ccfv @ XC @ ccinito))) => (Xph => (cweu @ (^ [Xf1:$i] : (cwcel @ (ccv @ Xf1) @ (cco @ XA2 @ XB2 @ (ccfv @ XC @ cciso)))))))))))))).
...
thf(ainitoo_ax,axiom,(! [XC:($i > $o)] : (! [XO:($i > $o)] : ((cwcel @ XC @ cccat) => ((cwcel @ XO @ (ccfv @ XC @ ccinito)) => (cwcel @ XO @ (ccfv @ XC @ ccbs))))))).
