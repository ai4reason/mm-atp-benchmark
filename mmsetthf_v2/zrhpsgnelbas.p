...
thf(apsgnran_ax,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : ((XP = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((XS = (ccfv @ XN @ ccpsgn)) => (((cwcel @ XN @ ccfn) & (cwcel @ XQ @ XP)) => (cwcel @ (ccfv @ XQ @ XS) @ (ccpr @ cc1 @ (ccneg @ cc1))))))))))).
...
thf(czrhpsgnelbas_conj,conjecture,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((XS = (ccfv @ XN @ ccpsgn)) => ((XY = (ccfv @ XR @ cczrh)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XN @ ccfn) @ (cwcel @ XQ @ XP)) => (cwcel @ (ccfv @ (ccfv @ XQ @ XS) @ XY) @ (ccfv @ XR @ ccbs))))))))))))).
