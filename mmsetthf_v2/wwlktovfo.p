...
thf(awwlktovf_ax,axiom,(! [XD:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xw:$i] : (! [Xt:$i] : (! [Xn:$i] : ((XD @ Xw @ Xn) = (ccrab @ (^ [Xw:$i] : (cw3a @ ((ccfv @ (ccv @ Xw) @ cchash) = cc2) @ ((ccfv @ ccc0 @ (ccv @ Xw)) = XP) @ (cwcel @ (ccpr @ (ccfv @ ccc0 @ (ccv @ Xw)) @ (ccfv @ cc1 @ (ccv @ Xw))) @ (XX @ Xt)))) @ (^ [Xw:$i] : (ccword @ XV))))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xn:$i] : ((XR @ Xw @ Xn) = (ccrab @ (^ [Xn:$i] : (cwcel @ (ccpr @ XP @ (ccv @ Xn)) @ (XX @ Xt))) @ (^ [Xn:$i] : XV)))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xn:$i] : ((XF @ Xw @ Xt @ Xn) = (ccmpt @ (^ [Xt:$i] : (XD @ Xw @ Xn)) @ (^ [Xt:$i] : (ccfv @ cc1 @ (ccv @ Xt)))))))) => (! [Xw:$i] : (! [Xt:$i] : (! [Xn:$i] : (cwf @ (XD @ Xw @ Xn) @ (XR @ Xw @ Xn) @ (XF @ Xw @ Xt @ Xn))))))))))))))).
...
thf(awrdlen2i_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XS @ XV) & (cwcel @ XT @ XV)) => ((XW = (ccpr @ (ccop @ ccc0 @ XS) @ (ccop @ cc1 @ XT))) => (((cwcel @ XW @ (ccword @ XV)) & ((ccfv @ XW @ cchash) = cc2)) & (((ccfv @ ccc0 @ XW) = XS) & ((ccfv @ cc1 @ XW) = XT)))))))))).
