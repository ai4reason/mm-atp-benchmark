...
thf(acnpfcfi_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : ((cw3a @ (cwcel @ XK @ cctop) @ (cwcel @ XA2 @ (cco @ XJ @ XL @ ccfcls)) @ (cwcel @ XF @ (ccfv @ XA2 @ (cco @ XJ @ XK @ cccnp)))) => (cwcel @ (ccfv @ XA2 @ XF) @ (ccfv @ XF @ (cco @ XK @ XL @ ccfcf)))))))))).
...
thf(aflimfcls_ax,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (cwss @ (cco @ XJ @ XF @ ccflim) @ (cco @ XJ @ XF @ ccfcls))))).
...
thf(aflimss2_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XF @ (ccfv @ XX @ ccfil)) @ (cwss @ XG @ XF)) => (cwss @ (cco @ XJ @ XG @ ccflim) @ (cco @ XJ @ XF @ ccflim)))))))).
...
thf(aflimfnfcls_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XF @ (ccfv @ XX @ ccfil)) => ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccflim)) <=> (cwral @ (^ [Xg1:$i] : ((cwss @ XF @ (ccv @ Xg1)) => (cwcel @ XA2 @ (cco @ XJ @ (ccv @ Xg1) @ ccfcls)))) @ (^ [Xg1:$i] : (ccfv @ XX @ ccfil))))))))))).
...
thf(ccnpfcf_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XK @ (ccfv @ XY @ cctopon)) @ (cwcel @ XA2 @ XX)) => ((cwcel @ XF @ (ccfv @ XA2 @ (cco @ XJ @ XK @ cccnp))) <=> ((cwf @ XX @ XY @ XF) & (cwral @ (^ [Xf1:$i] : ((cwcel @ XA2 @ (cco @ XJ @ (ccv @ Xf1) @ ccfcls)) => (cwcel @ (ccfv @ XA2 @ XF) @ (ccfv @ XF @ (cco @ XK @ (ccv @ Xf1) @ ccfcf))))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil))))))))))))).
