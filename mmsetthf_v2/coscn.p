...
thf(adf_cos_ax,axiom,(cccos = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (cco @ (cco @ (ccfv @ (cco @ cci @ (ccv @ Xx3) @ ccmul) @ cce) @ (ccfv @ (cco @ (ccneg @ cci) @ (ccv @ Xx3) @ ccmul) @ cce) @ ccaddc) @ cc2 @ ccdiv))))).
...
thf(ccoscn_conj,conjecture,(cwcel @ cccos @ (cco @ ccc @ ccc @ cccncf))).
