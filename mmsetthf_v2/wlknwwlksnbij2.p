...
thf(awlknwwlksnbij_ax,axiom,(! [XT:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((XT = (ccrab @ (^ [Xp:$i] : ((ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) = XN)) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks)))) => ((XW = (cco @ XN @ XG @ ccwwlksn)) => ((! [Xt:$i] : ((XF @ Xt) = (ccmpt @ (^ [Xt:$i] : XT) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ cc2nd))))) => (! [Xt:$i] : (((cwcel @ XG @ ccuspgr) & (cwcel @ XN @ ccn0)) => (cwf1o @ XT @ XW @ (XF @ Xt))))))))))))).
...
thf(cwlknwwlksnbij2_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XG @ ccuspgr) & (cwcel @ XN @ ccn0)) => (? [Xf1:$i] : (cwf1o @ (ccrab @ (^ [Xp:$i] : ((ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) = XN)) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks))) @ (cco @ XN @ XG @ ccwwlksn) @ (ccv @ Xf1))))))).
