...
thf(agexdvds_ax,axiom,(! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XN @ ccz)) => ((cwbr @ XE @ XN @ ccdvds) <=> (cwral @ (^ [Xx3:$i] : ((cco @ XN @ (ccv @ Xx3) @ Xc_x) = Xc_0)) @ (^ [Xx3:$i] : XX))))))))))))))).
