...
thf(cpmod2iN_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XS = (ccfv @ XK @ ccpsubsp)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => (((cwcel @ XK @ cchlt) & (cw3a @ (cwcel @ XX @ XS) @ (cwss @ XY @ XA2) @ (cwss @ XZ @ XA2))) => ((cwss @ XZ @ XX) => ((cco @ (ccin @ XX @ XY) @ XZ @ Xc_pl) = (ccin @ XX @ (cco @ XY @ XZ @ Xc_pl)))))))))))))))).
