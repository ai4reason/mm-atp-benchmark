...
thf(admaddpi_ax,axiom,((ccdm @ ccpli) = (ccxp @ ccnpi @ ccnpi))).
thf(ccep_tp,type,(ccep : ($i > $o))).
thf(altrelpi_ax,axiom,(cwss @ cclti @ (ccxp @ ccnpi @ ccnpi))).
thf(cwne_tp,type,(cwne : (($i > $o) > (($i > $o) > $o)))).
thf(a_0npi_ax,axiom,(~ (cwcel @ cc0 @ ccnpi))).
...
thf(altpiord_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccnpi) & (cwcel @ XB2 @ ccnpi)) => ((cwbr @ XA2 @ XB2 @ cclti) <=> (cwcel @ XA2 @ XB2)))))).
...
thf(aaddpiord_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccnpi) & (cwcel @ XB2 @ ccnpi)) => ((cco @ XA2 @ XB2 @ ccpli) = (cco @ XA2 @ XB2 @ ccoa)))))).
