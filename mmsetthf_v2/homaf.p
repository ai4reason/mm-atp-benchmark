...
thf(ahomafval_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : ((XH @ Xx3) = (ccfv @ XC @ cchoma))) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XC @ cccat)) => ((! [Xx3:$i] : ((XJ @ Xx3) = (ccfv @ XC @ cchom))) => (! [Xx3:$i] : (Xph => ((XH @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccxp @ XB2 @ XB2)) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xx3) @ (XJ @ Xx3)))))))))))))))))).
thf(chomaf_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XH:($i > $o)] : ((XH = (ccfv @ XC @ cchoma)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XC @ cccat)) => (Xph => (cwf @ (ccxp @ XB2 @ XB2) @ (ccpw @ (ccxp @ (ccxp @ XB2 @ XB2) @ ccvv)) @ XH)))))))))).
