...
thf(cgsumz_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xk:$i] : ((Xc_0 @ Xk) = (ccfv @ XG @ cc0g))) => (! [Xk:$i] : (((cwcel @ XG @ ccmnd) & (cwcel @ XA2 @ XV)) => ((cco @ XG @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (Xc_0 @ Xk))) @ ccgsu) = (Xc_0 @ Xk)))))))))).
