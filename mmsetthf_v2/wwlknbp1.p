...
thf(cwwlknbp1_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ (cco @ XN @ XG @ ccwwlksn)) => (cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ XW @ (ccword @ (ccfv @ XG @ ccvtx))) @ ((ccfv @ XW @ cchash) = (cco @ XN @ cc1 @ ccaddc)))))))).
