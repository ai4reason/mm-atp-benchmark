...
thf(arelelrni_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((cwrel @ XR) => ((cwbr @ XA2 @ XB2 @ XR) => (cwcel @ XB2 @ (ccrn @ XR)))))))).
...
thf(cfpwwe2lem12_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (! [Xu:$i] : (XW = (ccopab @ (^ [Xx3:$i] : (^ [Xr:$i] : (((cwss @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xu)) & (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)))) & ((cwwe @ (ccv @ Xx3) @ (ccv @ Xr)) & (cwral @ (^ [Xy1:$i] : (cwsbc @ (^ [Xu:$i] : ((cco @ (ccv @ Xu) @ (ccin @ (ccv @ Xr) @ (ccxp @ (ccv @ Xu) @ (ccv @ Xu))) @ XF) = (ccv @ Xy1))) @ (ccima @ (cccnv @ (ccv @ Xr)) @ (ccsn @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))))) => ((! [Xy1:$i] : (! [Xu:$i] : (Xph => (cwcel @ (XA2 @ Xy1 @ Xu) @ ccvv)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xr:$i] : ((Xph & (cw3a @ (cwss @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xu)) @ (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3))) @ (cwwe @ (ccv @ Xx3) @ (ccv @ Xr)))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ XF) @ (XA2 @ Xy1 @ Xu))))))) => ((XX = (ccuni @ (ccdm @ XW))) => (Xph => (cwcel @ XX @ (ccdm @ XW))))))))))))).
