...
thf(aelprchashprn2_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((~ (cwcel @ XM @ ccvv)) => (~ ((ccfv @ (ccpr @ XM @ XN) @ cchash) = cc2)))))).
...
thf(chashprb_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XM @ ccvv) @ (cwcel @ XN @ ccvv) @ (cwne @ XM @ XN)) <=> ((ccfv @ (ccpr @ XM @ XN) @ cchash) = cc2))))).
