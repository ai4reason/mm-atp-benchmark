...
thf(cpo3nr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (((cwpo @ XA2 @ XR) & (cw3a @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2) @ (cwcel @ XD @ XA2))) => (~ (cw3a @ (cwbr @ XB2 @ XC @ XR) @ (cwbr @ XC @ XD @ XR) @ (cwbr @ XD @ XB2 @ XR)))))))))).
