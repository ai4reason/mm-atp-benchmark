...
thf(csuppsnop_conj,conjecture,(! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XF = (ccsn @ (ccop @ XX @ XY))) => ((cw3a @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XW) @ (cwcel @ XZ @ XU)) => ((cco @ XF @ XZ @ ccsupp) = (ccif @ (XY = XZ) @ cc0 @ (ccsn @ XX))))))))))))).
