...
thf(a_3decOLD_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccn0) => ((cwcel @ XB2 @ ccn0) => ((ccdc @ (ccdc @ XA2 @ XB2) @ XC) = (cco @ (cco @ (cco @ (cco @ cc10 @ cc2 @ ccexp) @ XA2 @ ccmul) @ (cco @ cc10 @ XB2 @ ccmul) @ ccaddc) @ XC @ ccaddc)))))))).
...
thf(asq10e99m1OLD_ax,axiom,((cco @ cc10 @ cc2 @ ccexp) = (cco @ (ccdc @ cc9 @ cc9) @ cc1 @ ccaddc))).
...
thf(a_9t11e99_ax,axiom,((cco @ cc9 @ (ccdc @ cc1 @ cc1) @ ccmul) = (ccdc @ cc9 @ cc9))).
