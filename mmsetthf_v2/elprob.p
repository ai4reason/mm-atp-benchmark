...
thf(adf_prob_ax,axiom,(ccprb = (ccrab @ (^ [Xp:$i] : ((ccfv @ (ccuni @ (ccdm @ (ccv @ Xp))) @ (ccv @ Xp)) = cc1)) @ (^ [Xp:$i] : (ccuni @ (ccrn @ ccmeas)))))).
thf(celprob_conj,conjecture,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprb) <=> ((cwcel @ XP @ (ccuni @ (ccrn @ ccmeas))) & ((ccfv @ (ccuni @ (ccdm @ XP)) @ XP) = cc1))))).
