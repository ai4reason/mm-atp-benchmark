...
thf(aelfzoel1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (cco @ XB2 @ XC @ ccfzo)) => (cwcel @ XB2 @ ccz)))))).
...
thf(afzoaddel_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ (cco @ XB2 @ XC @ ccfzo)) & (cwcel @ XD @ ccz)) => (cwcel @ (cco @ XA2 @ XD @ ccaddc) @ (cco @ (cco @ XB2 @ XD @ ccaddc) @ (cco @ XC @ XD @ ccaddc) @ ccfzo)))))))).
...
thf(aelfzolt3_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ XM @ XN @ ccfzo)) => (cwbr @ XM @ XN @ cclt)))))).
...
thf(cfzostep1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ (cco @ XB2 @ XC @ ccfzo)) => ((cwcel @ (cco @ XA2 @ cc1 @ ccaddc) @ (cco @ XB2 @ XC @ ccfzo)) | ((cco @ XA2 @ cc1 @ ccaddc) = XC))))))).
