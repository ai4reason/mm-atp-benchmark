...
thf(apellqrex_ax,axiom,(! [XD:($i > $o)] : ((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) => (cwrex @ (^ [Xx3:$i] : (cwbr @ cc1 @ (ccv @ Xx3) @ cclt)) @ (^ [Xx3:$i] : (ccfv @ XD @ ccpell1qr)))))).
...
thf(apell14qrgap_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((cw3a @ (cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) @ (cwcel @ XA2 @ (ccfv @ XD @ ccpell14qr)) @ (cwbr @ cc1 @ XA2 @ cclt)) => (cwbr @ (cco @ (ccfv @ (cco @ XD @ cc1 @ ccaddc) @ ccsqrt) @ (ccfv @ XD @ ccsqrt) @ ccaddc) @ XA2 @ ccle))))).
thf(ainfmrgelbi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cw3a @ (cwss @ XA2 @ ccr) @ (cwne @ XA2 @ cc0) @ (cwcel @ XB2 @ ccr)) & (cwral @ (^ [Xx3:$i] : (cwbr @ XB2 @ (ccv @ Xx3) @ ccle)) @ (^ [Xx3:$i] : XA2))) => (cwbr @ XB2 @ (ccinf @ XA2 @ ccr @ cclt) @ ccle))))).
thf(apellfundval_ax,axiom,(! [XD:($i > $o)] : ((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) => ((ccfv @ XD @ ccpellfund) = (ccinf @ (ccrab @ (^ [Xx3:$i] : (cwbr @ cc1 @ (ccv @ Xx3) @ cclt)) @ (^ [Xx3:$i] : (ccfv @ XD @ ccpell14qr))) @ ccr @ cclt))))).
thf(cpellfundge_conj,conjecture,(! [XD:($i > $o)] : ((cwcel @ XD @ (ccdif @ ccn @ ccsquarenn)) => (cwbr @ (cco @ (ccfv @ (cco @ XD @ cc1 @ ccaddc) @ ccsqrt) @ (ccfv @ XD @ ccsqrt) @ ccaddc) @ (ccfv @ XD @ ccpellfund) @ ccle)))).
