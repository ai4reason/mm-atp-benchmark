...
thf(aramcl2_ax,axiom,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XM @ ccn0) @ (cwcel @ XR @ XV) @ (cwf @ XR @ ccn0 @ XF)) => (cwcel @ (cco @ XM @ XF @ ccram) @ (ccun @ ccn0 @ (ccsn @ ccpnf))))))))).
thf(cramxrcl_conj,conjecture,(! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XM @ ccn0) @ (cwcel @ XR @ XV) @ (cwf @ XR @ ccn0 @ XF)) => (cwcel @ (cco @ XM @ XF @ ccram) @ ccxr))))))).
