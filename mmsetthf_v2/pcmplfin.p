...
thf(cpcmplfin_conj,conjecture,(! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xv:$i] : ((XX @ Xv) = (ccuni @ XJ))) => (! [Xv:$i] : ((cw3a @ (cwcel @ XJ @ ccpcmp) @ (cwss @ XU @ XJ) @ ((XX @ Xv) = (ccuni @ XU))) => (cwrex @ (^ [Xv:$i] : ((cwcel @ (ccv @ Xv) @ (ccfv @ XJ @ cclocfin)) & (cwbr @ (ccv @ Xv) @ XU @ ccref))) @ (^ [Xv:$i] : (ccpw @ XJ)))))))))).
