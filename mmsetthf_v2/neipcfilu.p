...
thf(austneism_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwss @ XV @ (ccxp @ XX @ XX)) & (cwcel @ XA2 @ XX)) => (cwss @ (ccxp @ (ccima @ XV @ (ccsn @ XA2)) @ (ccima @ XV @ (ccsn @ XA2))) @ (cccom @ XV @ (cccnv @ XV)))))))).
...
thf(cneipcfilu_conj,conjecture,(! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XW @ ccbs)) => ((XJ = (ccfv @ XW @ cctopn)) => ((XU = (ccfv @ XW @ ccuss)) => ((cw3a @ (cwcel @ XW @ ccusp) @ (cwcel @ XW @ cctps) @ (cwcel @ XP @ XX)) => (cwcel @ (ccfv @ (ccsn @ XP) @ (ccfv @ XJ @ ccnei)) @ (ccfv @ XU @ cccfilu)))))))))))).
