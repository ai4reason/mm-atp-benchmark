...
thf(avdwlem13_ax,axiom,(! [Xph:$o] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XR @ ccfn)) => ((Xph => (cwcel @ XK @ ccn0)) => (Xph => (cwrex @ (^ [Xn:$i] : (cwral @ (^ [Xf1:$i] : (cwbr @ XK @ (ccv @ Xf1) @ ccvdwm)) @ (^ [Xf1:$i] : (cco @ XR @ (cco @ cc1 @ (ccv @ Xn) @ ccfz) @ ccmap)))) @ (^ [Xn:$i] : ccn))))))))).
...
thf(avdwmc2_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xm:$i] : (! [Xa:$i] : (! [Xc:$i] : (! [Xd:$i] : (cwcel @ (XX @ Xm @ Xa @ Xc @ Xd) @ ccvv))))) => ((! [Xm:$i] : ((Xph @ Xm) => (cwcel @ XK @ ccn0))) => ((! [Xm:$i] : (! [Xa:$i] : (! [Xc:$i] : (! [Xd:$i] : ((Xph @ Xm) => (cwf @ (XX @ Xm @ Xa @ Xc @ Xd) @ (XR @ Xm) @ XF)))))) => ((! [Xm:$i] : (! [Xa:$i] : (! [Xc:$i] : (! [Xd:$i] : ((Xph @ Xm) => (cwcel @ (XA2 @ Xm @ Xa @ Xc @ Xd) @ (XX @ Xm @ Xa @ Xc @ Xd))))))) => (! [Xm:$i] : ((Xph @ Xm) => ((cwbr @ XK @ XF @ ccvdwm) <=> (cwrex @ (^ [Xc:$i] : (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xd:$i] : (cwral @ (^ [Xm:$i] : (cwcel @ (cco @ (ccv @ Xa) @ (cco @ (ccv @ Xm) @ (ccv @ Xd) @ ccmul) @ ccaddc) @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xc))))) @ (^ [Xm:$i] : (cco @ ccc0 @ (cco @ XK @ cc1 @ ccmin) @ ccfz)))) @ (^ [Xd:$i] : ccn))) @ (^ [Xa:$i] : ccn))) @ (^ [Xc:$i] : (XR @ Xm))))))))))))))))).
