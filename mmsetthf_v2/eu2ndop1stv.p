...
thf(aalneu_ax,axiom,(! [Xph:($i > $o)] : ((! [Xx3:$i] : (Xph @ Xx3)) => (~ (cweu @ (^ [Xx3:$i] : (Xph @ Xx3))))))).
...
thf(ceu2ndop1stv_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cweu @ (^ [Xy1:$i] : (cwcel @ (ccop @ XA2 @ (ccv @ Xy1)) @ XV))) => (cwcel @ XA2 @ ccvv))))).
