...
thf(acnnvm_ax,axiom,(! [XU:($i > $o)] : ((XU = (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs)) => (ccmin = (ccfv @ XU @ ccnsb))))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(ccr_tp,type,(ccr : ($i > $o))).
thf(cc2nd_tp,type,(cc2nd : ($i > $o))).
thf(acnnvnm_ax,axiom,(! [XU:($i > $o)] : ((XU = (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs)) => (ccabs = (ccfv @ XU @ ccnmcv))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(ccnims_conj,conjecture,(! [XD:($i > $o)] : (! [XU:($i > $o)] : ((XU = (ccop @ (ccop @ ccaddc @ ccmul) @ ccabs)) => ((XD = (cccom @ ccabs @ ccmin)) => (XD = (ccfv @ XU @ ccims))))))).
