...
thf(ahashsdom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwcel @ XB2 @ ccfn)) => ((cwbr @ (ccfv @ XA2 @ cchash) @ (ccfv @ XB2 @ cchash) @ cclt) <=> (cwbr @ XA2 @ XB2 @ ccsdm)))))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(aerdszelem9_ax,axiom,(! [Xph:$o] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwf1 @ (cco @ cc1 @ XN @ ccfz) @ ccr @ XF)) => ((XI = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xx3:$i] : (ccsup @ (ccima @ cchash @ (ccrab @ (^ [Xy1:$i] : ((cwiso @ (ccv @ Xy1) @ (ccima @ XF @ (ccv @ Xy1)) @ cclt @ cclt @ (ccres @ XF @ (ccv @ Xy1))) & (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccpw @ (cco @ cc1 @ (ccv @ Xx3) @ ccfz))))) @ ccr @ cclt)))) => ((XJ = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xx3:$i] : (ccsup @ (ccima @ cchash @ (ccrab @ (^ [Xy1:$i] : ((cwiso @ (ccv @ Xy1) @ (ccima @ XF @ (ccv @ Xy1)) @ cclt @ (cccnv @ cclt) @ (ccres @ XF @ (ccv @ Xy1))) & (cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccpw @ (cco @ cc1 @ (ccv @ Xx3) @ ccfz))))) @ ccr @ cclt)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : ((XT @ Xx3 @ Xy1 @ Xn) = (ccmpt @ (^ [Xn:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xn:$i] : (ccop @ (ccfv @ (ccv @ Xn) @ XI) @ (ccfv @ (ccv @ Xn) @ XJ)))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (Xph => (cwf1 @ (cco @ cc1 @ XN @ ccfz) @ (ccxp @ ccn @ ccn) @ (XT @ Xx3 @ Xy1 @ Xn)))))))))))))))))).
