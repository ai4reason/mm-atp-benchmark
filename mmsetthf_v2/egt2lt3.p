...
thf(aege2le3_ax,axiom,(! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ cc2 @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (ccv @ Xn) @ ccexp) @ ccmul))))) => ((! [Xn:$i] : ((XG @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ cc1 @ (ccfv @ (ccv @ Xn) @ ccfa) @ ccdiv))))) => ((cwbr @ cc2 @ cceu @ ccle) & (cwbr @ cceu @ cc3 @ ccle))))))).
...
thf(aeirr_ax,axiom,(cwnel @ cceu @ ccq)).
...
thf(altleni_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwbr @ XA2 @ XB2 @ cclt) <=> ((cwbr @ XA2 @ XB2 @ ccle) & (cwne @ XB2 @ XA2)))))))).
