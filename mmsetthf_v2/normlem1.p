...
thf(aabsvalsqi_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ (ccfv @ XA2 @ ccabs) @ cc2 @ ccexp) = (cco @ XA2 @ (ccfv @ XA2 @ cccj) @ ccmul))))).
