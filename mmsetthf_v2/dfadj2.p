...
thf(adf_adjh_ax,axiom,(ccado = (ccopab @ (^ [Xt:$i] : (^ [Xu:$i] : (cw3a @ (cwf @ cchil @ cchil @ (ccv @ Xt)) @ (cwf @ cchil @ cchil @ (ccv @ Xu)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xt)) @ (ccv @ Xy1) @ ccsp) = (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xu)) @ ccsp))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : cchil)))))))).
...
thf(cdfadj2_conj,conjecture,(ccado = (ccopab @ (^ [Xt:$i] : (^ [Xu:$i] : (cw3a @ (cwf @ cchil @ cchil @ (ccv @ Xt)) @ (cwf @ cchil @ cchil @ (ccv @ Xu)) @ (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xt)) @ ccsp) = (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xu)) @ (ccv @ Xy1) @ ccsp))) @ (^ [Xy1:$i] : cchil))) @ (^ [Xx3:$i] : cchil)))))))).
