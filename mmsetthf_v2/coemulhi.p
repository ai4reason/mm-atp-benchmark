...
thf(ccoemulhi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XB2 = (ccfv @ XG @ cccoe)) => ((XM = (ccfv @ XF @ ccdgr)) => ((XN = (ccfv @ XG @ ccdgr)) => (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XS @ ccply))) => ((ccfv @ (cco @ XM @ XN @ ccaddc) @ (ccfv @ (cco @ XF @ XG @ (ccof @ ccmul)) @ cccoe)) = (cco @ (ccfv @ XM @ XA2) @ (ccfv @ XN @ XB2) @ ccmul))))))))))))))).
