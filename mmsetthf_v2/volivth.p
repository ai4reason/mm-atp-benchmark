...
thf(avolsup2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccdm @ ccvol)) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XB2 @ (ccfv @ XA2 @ ccvol) @ cclt)) => (cwrex @ (^ [Xn:$i] : (cwbr @ XB2 @ (ccfv @ (ccin @ XA2 @ (cco @ (ccneg @ (ccv @ Xn)) @ (ccv @ Xn) @ ccicc)) @ ccvol) @ cclt)) @ (^ [Xn:$i] : ccn)))))).
thf(ampd_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => (Xps => Xch)) => (Xph => Xch))))))).
thf(ccioo_tp,type,(ccioo : ($i > $o))).
thf(aivthle_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XU @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccicc) @ XD)) => ((Xph => (cwcel @ XF @ (cco @ XD @ ccc @ cccncf))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XB2 @ ccicc))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ ccr))) => ((Xph => ((cwbr @ (ccfv @ XA2 @ XF) @ XU @ ccle) & (cwbr @ XU @ (ccfv @ XB2 @ XF) @ ccle))) => (Xph => (cwrex @ (^ [Xc:$i] : ((ccfv @ (ccv @ Xc) @ XF) = XU)) @ (^ [Xc:$i] : (cco @ XA2 @ XB2 @ ccicc))))))))))))))))))).
...
thf(avolcn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (ccfv @ (ccin @ XA2 @ (cco @ XB2 @ (ccv @ Xx3) @ ccicc)) @ ccvol))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ XB2 @ ccr)) => (cwcel @ (XF @ Xx3) @ (cco @ ccr @ ccr @ cccncf))))))))).
...
thf(cvolivth_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccdm @ ccvol)) & (cwcel @ XB2 @ (cco @ ccc0 @ (ccfv @ XA2 @ ccvol) @ ccicc))) => (cwrex @ (^ [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) & ((ccfv @ (ccv @ Xx3) @ ccvol) = XB2))) @ (^ [Xx3:$i] : (ccdm @ ccvol))))))).
