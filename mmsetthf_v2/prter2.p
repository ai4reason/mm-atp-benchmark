...
thf(aprtlem19_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_sm:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : ((Xc_sm @ Xx3 @ Xy1 @ Xu) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xu)) & (cwcel @ (ccv @ Xy1) @ (ccv @ Xu)))) @ (^ [Xu:$i] : XA2))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xv:$i] : (! [Xu:$i] : ((cwprt @ XA2) => (((cwcel @ (ccv @ Xv) @ XA2) & (cwcel @ (ccv @ Xz) @ (ccv @ Xv))) => ((ccv @ Xv) = (ccec @ (ccv @ Xz) @ (Xc_sm @ Xx3 @ Xy1 @ Xu)))))))))))))).
thf(aex_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) => Xch) => (Xph => (Xps => Xch))))))).
thf(a_2r19_29_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : (((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1))) & (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)))) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((Xph @ Xx3 @ Xy1) & (Xps @ Xx3 @ Xy1))) @ (^ [Xy1:$i] : (XB2 @ Xx3 @ Xy1)))) @ (^ [Xx3:$i] : (XA2 @ Xx3 @ Xy1)))))))))).
...
thf(aprtlem400_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_sm:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : ((Xc_sm @ Xx3 @ Xy1 @ Xu) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xu)) & (cwcel @ (ccv @ Xy1) @ (ccv @ Xu)))) @ (^ [Xu:$i] : XA2))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (~ (cwcel @ cc0 @ (ccqs @ (ccuni @ XA2) @ (Xc_sm @ Xx3 @ Xy1 @ Xu))))))))))).
...
thf(ajca2r_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps => Xch)) => ((Xps => Xth) => (Xph => (Xps => (Xth & Xch)))))))))).
...
thf(aprtlem11_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_sm:($i > $o)] : ((cwcel @ XB2 @ XD) => ((cwcel @ XC @ XA2) => ((XB2 = (ccec @ XC @ Xc_sm)) => (cwcel @ XB2 @ (ccqs @ XA2 @ Xc_sm))))))))))).
thf(a_19_9v_ax,axiom,(! [Xph:$o] : ((? [Xx3:$i] : Xph) <=> Xph))).
thf(cprter2_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_sm:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : ((Xc_sm @ Xx3 @ Xy1 @ Xu) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xu:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xu)) & (cwcel @ (ccv @ Xy1) @ (ccv @ Xu)))) @ (^ [Xu:$i] : XA2))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : ((cwprt @ XA2) => ((ccqs @ (ccuni @ XA2) @ (Xc_sm @ Xx3 @ Xy1 @ Xu)) = (ccdif @ XA2 @ (ccsn @ cc0))))))))))).
