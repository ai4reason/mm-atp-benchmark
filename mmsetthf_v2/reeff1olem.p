...
thf(creeff1olem_conj,conjecture,(! [XU:($i > $o)] : (((cwcel @ XU @ ccr) & (cwbr @ cc1 @ XU @ cclt)) => (cwrex @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cce) = XU)) @ (^ [Xx3:$i] : ccr))))).
