...
thf(cgrpoidinvlem2_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccrn @ XG)) => ((((cwcel @ XG @ ccgr) & ((cwcel @ XY @ XX) & (cwcel @ XA2 @ XX))) & (((cco @ XU @ XY @ XG) = XY) & ((cco @ XY @ XA2 @ XG) = XU))) => ((cco @ (cco @ XA2 @ XY @ XG) @ (cco @ XA2 @ XY @ XG) @ XG) = (cco @ XA2 @ XY @ XG)))))))))).
