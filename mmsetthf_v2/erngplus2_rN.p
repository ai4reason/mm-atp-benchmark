...
thf(cerngplus2_rN_conj,conjecture,(! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((XD = (ccfv @ XW @ (ccfv @ XK @ ccedring_rN))) => ((Xc_pl = (ccfv @ XD @ ccplusg)) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cw3a @ (cwcel @ XU @ XE) @ (cwcel @ XV @ XE) @ (cwcel @ XF @ XT))) => ((ccfv @ XF @ (cco @ XU @ XV @ Xc_pl)) = (cccom @ (ccfv @ XF @ XU) @ (ccfv @ XF @ XV)))))))))))))))))))).
