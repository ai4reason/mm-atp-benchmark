...
thf(axmetec_ax,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_sm:($i > $o)] : (! [XX:($i > $o)] : ((Xc_sm = (ccima @ (cccnv @ XD) @ ccr)) => (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XP @ XX)) => ((ccec @ XP @ Xc_sm) = (cco @ XP @ ccpnf @ (ccfv @ XD @ ccbl)))))))))).
...
thf(cblpnfctr_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XP @ XX) @ (cwcel @ XA2 @ (cco @ XP @ ccpnf @ (ccfv @ XD @ ccbl)))) => ((cco @ XP @ ccpnf @ (ccfv @ XD @ ccbl)) = (cco @ XA2 @ ccpnf @ (ccfv @ XD @ ccbl))))))))).
