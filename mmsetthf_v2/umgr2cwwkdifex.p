...
thf(aumgr2cwwk2dif_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XG @ ccumgr) @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XW @ (cco @ XN @ XG @ ccclwwlkn))) => (cwne @ (ccfv @ cc1 @ XW) @ (ccfv @ ccc0 @ XW))))))).
thf(cumgr2cwwkdifex_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XG @ ccumgr) @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XW @ (cco @ XN @ XG @ ccclwwlkn))) => (cwrex @ (^ [Xi:$i] : (cwne @ (ccfv @ (ccv @ Xi) @ XW) @ (ccfv @ ccc0 @ XW))) @ (^ [Xi:$i] : (cco @ ccc0 @ XN @ ccfzo)))))))).
