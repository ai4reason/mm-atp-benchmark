...
thf(ciihalf2cn_conj,conjecture,(! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : ((XJ @ Xx3) = (cco @ (ccfv @ (ccrn @ ccioo) @ cctg) @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ cc1 @ ccicc) @ ccrest))) => (! [Xx3:$i] : (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (cco @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul) @ cc1 @ ccmin))) @ (cco @ (XJ @ Xx3) @ ccii @ cccn)))))).
