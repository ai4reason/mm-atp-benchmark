...
thf(apm2mpghm_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XC = (cco @ XN @ XP @ ccmat)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xc_as = (ccfv @ XQ @ ccvsca)) => ((Xc_ex = (ccfv @ (ccfv @ XQ @ ccmgp) @ ccmg)) => ((XX = (ccfv @ XA2 @ ccv1)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XQ = (ccfv @ XA2 @ ccpl1)) => ((XL = (ccfv @ XQ @ ccbs)) => ((XT = (cco @ XN @ XR @ ccpm2mp)) => (((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) => (cwcel @ XT @ (cco @ XC @ XQ @ ccghm)))))))))))))))))))))))))).
...
thf(almodvs0_ax,axiom,(! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((XK = (ccfv @ XF @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => (((cwcel @ XW @ cclmod) & (cwcel @ XX @ XK)) => ((cco @ XX @ Xc_0 @ Xc_x) = Xc_0))))))))))))).
...
thf(amonmat2matmon_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((XC = (cco @ XN @ XP @ ccmat)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xc_as = (ccfv @ XQ @ ccvsca)) => ((Xc_ex = (ccfv @ (ccfv @ XQ @ ccmgp) @ ccmg)) => ((XX = (ccfv @ XA2 @ ccv1)) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XK = (ccfv @ XA2 @ ccbs)) => ((XQ = (ccfv @ XA2 @ ccpl1)) => ((XI = (cco @ XN @ XR @ ccpm2mp)) => ((XE = (ccfv @ (ccfv @ XP @ ccmgp) @ ccmg)) => ((XY = (ccfv @ XR @ ccv1)) => ((Xc_x = (ccfv @ XC @ ccvsca)) => ((XT = (cco @ XN @ XR @ ccmat2pmat)) => ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ cccrg)) & ((cwcel @ XM @ XK) & (cwcel @ XL @ ccn0))) => ((ccfv @ (cco @ (cco @ XL @ XY @ XE) @ (ccfv @ XM @ XT) @ Xc_x) @ XI) = (cco @ XM @ (cco @ XL @ XX @ Xc_ex) @ Xc_as)))))))))))))))))))))))))))))))))))).
thf(cpm2mp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_ex:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [Xc_as:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > $o)] : ((! [Xn:$i] : ((XP @ Xn) = (ccfv @ XR @ ccpl1))) => ((! [Xn:$i] : ((XC @ Xn) = (cco @ XN @ (XP @ Xn) @ ccmat))) => ((! [Xn:$i] : (XB2 = (ccfv @ (XC @ Xn) @ ccbs))) => ((! [Xn:$i] : ((Xc_as @ Xn) = (ccfv @ (XQ @ Xn) @ ccvsca))) => ((! [Xn:$i] : ((Xc_ex @ Xn) = (ccfv @ (ccfv @ (XQ @ Xn) @ ccmgp) @ ccmg))) => ((! [Xn:$i] : ((XX @ Xn) = (ccfv @ XA2 @ ccv1))) => ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XK = (ccfv @ XA2 @ ccbs)) => ((! [Xn:$i] : ((XQ @ Xn) = (ccfv @ XA2 @ ccpl1))) => ((XI = (cco @ XN @ XR @ ccpm2mp)) => ((! [Xn:$i] : (XE = (ccfv @ (ccfv @ (XP @ Xn) @ ccmgp) @ ccmg))) => ((XY = (ccfv @ XR @ ccv1)) => ((! [Xn:$i] : (Xc_x = (ccfv @ (XC @ Xn) @ ccvsca))) => ((XT = (cco @ XN @ XR @ ccmat2pmat)) => (! [Xn:$i] : ((((cwcel @ XN @ ccfn) & (cwcel @ XR @ cccrg)) & ((cwcel @ XM @ (cco @ XK @ ccn0 @ ccmap)) & (cwbr @ XM @ (ccfv @ XA2 @ cc0g) @ ccfsupp))) => ((ccfv @ (cco @ (XC @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (cco @ (ccv @ Xn) @ XY @ XE) @ (ccfv @ (ccfv @ (ccv @ Xn) @ XM) @ XT) @ Xc_x))) @ ccgsu) @ XI) = (cco @ (XQ @ Xn) @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ XM) @ (cco @ (ccv @ Xn) @ (XX @ Xn) @ (Xc_ex @ Xn)) @ (Xc_as @ Xn)))) @ ccgsu)))))))))))))))))))))))))))))))))))).
