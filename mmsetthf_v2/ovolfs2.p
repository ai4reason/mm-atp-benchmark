...
thf(aovolf_ax,axiom,(cwf @ (ccpw @ ccr) @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccovol)).
thf(ccio_tp,type,(ccio : (($i > $o) > ($i > $o)))).
thf(afveq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))).
thf(covolfs2_conj,conjecture,(! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (cccom @ (cccom @ ccabs @ ccmin) @ XF)) => ((cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF) => (XG = (cccom @ (cccom @ ccovol @ ccioo) @ XF))))))).
