...
thf(alogdivsum_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xi:$i] : ((XF @ Xy1 @ Xi) = (ccmpt @ (^ [Xy1:$i] : ccrp) @ (^ [Xy1:$i] : (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xy1) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccv @ Xi) @ ccdiv))) @ (cco @ (cco @ (ccfv @ (ccv @ Xy1) @ cclog) @ cc2 @ ccexp) @ cc2 @ ccdiv) @ ccmin)))))) => (! [Xy1:$i] : (! [Xi:$i] : (cw3a @ (cwf @ ccrp @ ccr @ (XF @ Xy1 @ Xi)) @ (cwcel @ (XF @ Xy1 @ Xi) @ (ccdm @ ccrli)) @ ((cw3a @ (cwbr @ (XF @ Xy1 @ Xi) @ (XL @ Xy1 @ Xi) @ ccrli) @ (cwcel @ XA2 @ ccrp) @ (cwbr @ cceu @ XA2 @ ccle)) => (cwbr @ (ccfv @ (cco @ (ccfv @ XA2 @ (XF @ Xy1 @ Xi)) @ (XL @ Xy1 @ Xi) @ ccmin) @ ccabs) @ (cco @ (ccfv @ XA2 @ cclog) @ XA2 @ ccdiv) @ ccle)))))))))).
...
thf(ao1lo1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccr))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cco1)) => (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cclo1)))))))).
...
thf(ao1lo12_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > $o)] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccr))) => ((Xph => (cwcel @ XM @ ccr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwbr @ XM @ (XB2 @ Xx3) @ ccle))) => (Xph => ((cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cco1) <=> (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cclo1))))))))))).
...
thf(aharmoniclbnd_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwbr @ (ccfv @ XA2 @ cclog) @ (ccsu @ (cco @ cc1 @ (ccfv @ XA2 @ ccfl) @ ccfz) @ (^ [Xm:$i] : (cco @ cc1 @ (ccv @ Xm) @ ccdiv))) @ ccle)))).
