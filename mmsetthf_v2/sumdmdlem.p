...
thf(aelspansncl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ (ccfv @ (ccsn @ XA2) @ ccspn))) => (cwcel @ XB2 @ cchil))))).
...
thf(ashsub1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccsh) & (cwcel @ XB2 @ ccsh)) => (cwss @ XA2 @ (cco @ XA2 @ XB2 @ ccph)))))).
