...
thf(apfxsuffeqwrdeq_ax,axiom,(! [XS:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XS @ (ccword @ XV)) @ (cwcel @ XI @ (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo))) => ((XW = XS) <=> (((ccfv @ XW @ cchash) = (ccfv @ XS @ cchash)) & (((cco @ XW @ XI @ ccpfx) = (cco @ XS @ XI @ ccpfx)) & ((cco @ XW @ (ccop @ XI @ (ccfv @ XW @ cchash)) @ ccsubstr) = (cco @ XS @ (ccop @ XI @ (ccfv @ XW @ cchash)) @ ccsubstr))))))))))).
...
thf(cpfxsuff1eqwrdeq_conj,conjecture,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XU @ (ccword @ XV)) @ (cwbr @ ccc0 @ (ccfv @ XW @ cchash) @ cclt)) => ((XW = XU) <=> (((ccfv @ XW @ cchash) = (ccfv @ XU @ cchash)) & (((cco @ XW @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ ccpfx) = (cco @ XU @ (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccmin) @ ccpfx)) & ((ccfv @ XW @ cclsw) = (ccfv @ XU @ cclsw)))))))))).
