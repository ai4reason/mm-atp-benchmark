...
thf(aupgrspthswlk_ax,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ ccupgr) => ((ccfv @ XG @ ccspths) = (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : ((cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ ccwlks)) & (cwfun @ (cccnv @ (ccv @ Xp))))))))))).
...
thf(cupgrwlkdvspth_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cw3a @ (cwcel @ XG @ ccupgr) @ (cwbr @ XF @ XP @ (ccfv @ XG @ ccwlks)) @ (cwfun @ (cccnv @ XP))) => (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths))))))).
