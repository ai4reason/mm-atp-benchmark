...
thf(cint_ineqmvtd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwcel @ XD @ ccr)) => ((Xph => (cwbr @ XB2 @ XA2 @ ccle)) => ((Xph => (XA2 = (cco @ XC @ XD @ ccaddc))) => (Xph => (cwbr @ (cco @ XB2 @ XD @ ccmin) @ XC @ ccle))))))))))))).
