...
thf(coaord_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) => ((cwcel @ XA2 @ XB2) <=> (cwcel @ (cco @ XC @ XA2 @ ccoa) @ (cco @ XC @ XB2 @ ccoa)))))))).
