...
thf(agsumws3_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (((cwcel @ XG @ ccmnd) & ((cwcel @ XS @ XB2) & ((cwcel @ XT @ XB2) & (cwcel @ XU @ XB2)))) => ((cco @ XG @ (ccs3 @ XS @ XT @ XU) @ ccgsu) = (cco @ XS @ (cco @ XT @ XU @ Xc_pl) @ Xc_pl)))))))))))).
...
thf(camgm3d_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => (cwcel @ XC @ ccrp)) => (Xph => (cwbr @ (cco @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccmul) @ ccmul) @ (cco @ cc1 @ cc3 @ ccdiv) @ cccxp) @ (cco @ (cco @ XA2 @ (cco @ XB2 @ XC @ ccaddc) @ ccaddc) @ cc3 @ ccdiv) @ ccle)))))))))).
