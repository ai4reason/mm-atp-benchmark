...
thf(adchrisum0fno1_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [Xc_1:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XL:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : ((XZ @ Xv @ Xq @ Xb) = (ccfv @ (XN @ Xv @ Xb) @ cczn))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : ((XL @ Xq) = (ccfv @ (XZ @ Xv @ Xq @ Xb) @ cczrh))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : ((Xph @ Xv @ Xq @ Xb) => (cwcel @ (XN @ Xv @ Xb) @ ccn))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xk:$i] : (! [Xq:$i] : (! [Xb:$i] : ((XG @ Xx3 @ Xv @ Xk @ Xq @ Xb) = (ccfv @ (XN @ Xv @ Xb) @ ccdchr))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xk:$i] : (! [Xq:$i] : (! [Xb:$i] : ((XD @ Xv @ Xq @ Xb) = (ccfv @ (XG @ Xx3 @ Xv @ Xk @ Xq @ Xb) @ ccbs))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xk:$i] : (! [Xq:$i] : (! [Xb:$i] : ((Xc_1 @ Xv @ Xq @ Xb) = (ccfv @ (XG @ Xx3 @ Xv @ Xk @ Xq @ Xb) @ cc0g))))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : ((XF @ Xv @ Xq @ Xb) = (ccmpt @ (^ [Xb:$i] : ccn) @ (^ [Xb:$i] : (ccsu @ (ccrab @ (^ [Xq:$i] : (cwbr @ (ccv @ Xq) @ (ccv @ Xb) @ ccdvds)) @ (^ [Xq:$i] : ccn)) @ (^ [Xv:$i] : (ccfv @ (ccfv @ (ccv @ Xv) @ (XL @ Xq)) @ (XX @ Xq)))))))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : ((Xph @ Xv @ Xq @ Xb) => (cwcel @ (XX @ Xq) @ (XD @ Xv @ Xq @ Xb)))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : ((Xph @ Xv @ Xq @ Xb) => (cwf @ (ccfv @ (XZ @ Xv @ Xq @ Xb) @ ccbs) @ ccr @ (XX @ Xq)))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : ((Xph @ Xv @ Xq @ Xb) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XF @ Xv @ Xq @ Xb)) @ (ccfv @ (ccv @ Xk) @ ccsqrt) @ ccdiv))))) @ cco1))))) => (! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : (~ (Xph @ Xv @ Xq @ Xb))))))))))))))))))))))))).
...
thf(adchrisum0re_ax,axiom,(! [Xph:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XN @ cczn)) => ((XL = (ccfv @ XZ @ cczrh)) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XN @ ccn))) => ((! [Xy1:$i] : (! [Xm:$i] : ((XG @ Xy1 @ Xm) = (ccfv @ XN @ ccdchr)))) => ((! [Xy1:$i] : (! [Xm:$i] : (XD = (ccfv @ (XG @ Xy1 @ Xm) @ ccbs)))) => ((! [Xy1:$i] : (! [Xm:$i] : (Xc_1 = (ccfv @ (XG @ Xy1 @ Xm) @ cc0g)))) => ((! [Xy1:$i] : (! [Xm:$i] : ((XW @ Xy1 @ Xm) = (ccrab @ (^ [Xy1:$i] : ((ccsu @ ccn @ (^ [Xm:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ XL) @ (ccv @ Xy1)) @ (ccv @ Xm) @ ccdiv))) = ccc0)) @ (^ [Xy1:$i] : (ccdif @ XD @ (ccsn @ Xc_1))))))) => ((! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xy1) => (cwcel @ XX @ (XW @ Xy1 @ Xm))))) => (! [Xy1:$i] : ((Xph @ Xy1) => (cwf @ (ccfv @ XZ @ ccbs) @ ccr @ XX))))))))))))))))))))).
...
thf(adchrisum0fval_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > $o)] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [Xc_1:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > $o))] : (! [XZ:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xv:$i] : (! [Xt:$i] : (! [Xq:$i] : (! [Xb:$i] : ((XZ @ Xv @ Xt @ Xq @ Xb) = (ccfv @ (XN @ Xv @ Xb) @ cczn)))))) => ((! [Xv:$i] : (! [Xt:$i] : (! [Xq:$i] : (! [Xb:$i] : ((XL @ Xq) = (ccfv @ (XZ @ Xv @ Xt @ Xq @ Xb) @ cczrh)))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : ((Xph @ Xv @ Xq @ Xb) => (cwcel @ (XN @ Xv @ Xb) @ ccn))))) => ((! [Xv:$i] : (! [Xt:$i] : (! [Xq:$i] : (! [Xb:$i] : ((XG @ Xv @ Xt @ Xq @ Xb) = (ccfv @ (XN @ Xv @ Xb) @ ccdchr)))))) => ((! [Xv:$i] : (! [Xt:$i] : (! [Xq:$i] : (! [Xb:$i] : ((XD @ Xv @ Xq @ Xb) = (ccfv @ (XG @ Xv @ Xt @ Xq @ Xb) @ ccbs)))))) => ((! [Xv:$i] : (! [Xt:$i] : (! [Xq:$i] : (! [Xb:$i] : ((Xc_1 @ Xv @ Xq @ Xb) = (ccfv @ (XG @ Xv @ Xt @ Xq @ Xb) @ cc0g)))))) => ((! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : ((XF @ Xv @ Xq @ Xb) = (ccmpt @ (^ [Xb:$i] : ccn) @ (^ [Xb:$i] : (ccsu @ (ccrab @ (^ [Xq:$i] : (cwbr @ (ccv @ Xq) @ (ccv @ Xb) @ ccdvds)) @ (^ [Xq:$i] : ccn)) @ (^ [Xv:$i] : (ccfv @ (ccfv @ (ccv @ Xv) @ (XL @ Xq)) @ (XX @ Xq)))))))))) => (! [Xv:$i] : (! [Xq:$i] : (! [Xb:$i] : ((cwcel @ XA2 @ ccn) => ((ccfv @ XA2 @ (XF @ Xv @ Xq @ Xb)) = (ccsu @ (ccrab @ (^ [Xq:$i] : (cwbr @ (ccv @ Xq) @ XA2 @ ccdvds)) @ (^ [Xq:$i] : ccn)) @ (^ [Xt:$i] : (ccfv @ (ccfv @ (ccv @ Xt) @ (XL @ Xq)) @ (XX @ Xq))))))))))))))))))))))))))).
...
thf(arprege0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => ((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle))))).
...
thf(ao1compt_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : ((! [Xy1:$i] : (Xph => (cwf @ XA2 @ ccc @ (XF @ Xy1)))) => ((! [Xy1:$i] : (Xph => (cwcel @ (XF @ Xy1) @ cco1))) => ((! [Xy1:$i] : ((Xph & (cwcel @ (ccv @ Xy1) @ XB2)) => (cwcel @ (XC @ Xy1) @ XA2))) => ((Xph => (cwss @ XB2 @ ccr)) => ((! [Xm:$i] : ((Xph & (cwcel @ (ccv @ Xm) @ ccr)) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle) => (cwbr @ (ccv @ Xm) @ (XC @ Xy1) @ ccle))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : ccr)))) => (! [Xy1:$i] : (Xph => (cwcel @ (cccom @ (XF @ Xy1) @ (ccmpt @ (^ [Xy1:$i] : XB2) @ (^ [Xy1:$i] : (XC @ Xy1)))) @ cco1)))))))))))))).
thf(asylib_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps <=> Xch) => (Xph => Xch))))))).
thf(ampd_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => (Xps => Xch)) => (Xph => Xch))))))).
thf(ccrli_tp,type,(ccrli : ($i > $o))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(adchrisum0lema_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [Xc_1:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XL:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xt:$i] : (! [Xa:$i] : (! [Xc:$i] : ((XZ @ Xt @ Xa @ Xc) = (ccfv @ (XN @ Xa) @ cczn))))) => ((! [Xt:$i] : (! [Xa:$i] : (! [Xc:$i] : (XL = (ccfv @ (XZ @ Xt @ Xa @ Xc) @ cczrh))))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ (XN @ Xa) @ ccn)))) => ((! [Xy1:$i] : (! [Xt:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xc:$i] : ((XG @ Xy1 @ Xt @ Xm @ Xa @ Xc) = (ccfv @ (XN @ Xa) @ ccdchr))))))) => ((! [Xy1:$i] : (! [Xt:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xc:$i] : ((XD @ Xa) = (ccfv @ (XG @ Xy1 @ Xt @ Xm @ Xa @ Xc) @ ccbs))))))) => ((! [Xy1:$i] : (! [Xt:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xc:$i] : ((Xc_1 @ Xa) = (ccfv @ (XG @ Xy1 @ Xt @ Xm @ Xa @ Xc) @ cc0g))))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : ((XW @ Xy1 @ Xm @ Xa) = (ccrab @ (^ [Xy1:$i] : ((ccsu @ ccn @ (^ [Xm:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ XL) @ (ccv @ Xy1)) @ (ccv @ Xm) @ ccdiv))) = ccc0)) @ (^ [Xy1:$i] : (ccdif @ (XD @ Xa) @ (ccsn @ (Xc_1 @ Xa))))))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ XX @ (XW @ Xy1 @ Xm @ Xa)))))) => ((! [Xa:$i] : ((XF @ Xa) = (ccmpt @ (^ [Xa:$i] : ccn) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xa) @ XL) @ XX) @ (ccfv @ (ccv @ Xa) @ ccsqrt) @ ccdiv))))) => (! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (? [Xt:$i] : (cwrex @ (^ [Xc:$i] : ((cwbr @ (ccseq @ ccaddc @ (XF @ Xa) @ cc1) @ (ccv @ Xt) @ ccli) & (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccfv @ (ccv @ Xy1) @ ccfl) @ (ccseq @ ccaddc @ (XF @ Xa) @ cc1)) @ (ccv @ Xt) @ ccmin) @ ccabs) @ (cco @ (ccv @ Xc) @ (ccfv @ (ccv @ Xy1) @ ccsqrt) @ ccdiv) @ ccle)) @ (^ [Xy1:$i] : (cco @ cc1 @ ccpnf @ ccico))))) @ (^ [Xc:$i] : (cco @ ccc0 @ ccpnf @ ccico))))))))))))))))))))))))))).
...
thf(adchrisum0lem3_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > ($i > $o)))] : (! [XS:($i > ($i > $o))] : (! [Xc_1:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XL:($i > $o)] : (! [XN:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xa:$i] : (! [Xd:$i] : ((XZ @ Xa @ Xd) = (ccfv @ (XN @ Xa @ Xd) @ cczn)))) => ((! [Xa:$i] : (! [Xd:$i] : (XL = (ccfv @ (XZ @ Xa @ Xd) @ cczrh)))) => ((! [Xy1:$i] : (! [Xa:$i] : (! [Xd:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ (XN @ Xa @ Xd) @ ccn))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xd:$i] : ((XG @ Xx3 @ Xy1 @ Xm @ Xa @ Xd) = (ccfv @ (XN @ Xa @ Xd) @ ccdchr))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xd:$i] : ((XD @ Xa @ Xd) = (ccfv @ (XG @ Xx3 @ Xy1 @ Xm @ Xa @ Xd) @ ccbs))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xd:$i] : ((Xc_1 @ Xa @ Xd) = (ccfv @ (XG @ Xx3 @ Xy1 @ Xm @ Xa @ Xd) @ cc0g))))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xd:$i] : ((XW @ Xy1 @ Xm @ Xa @ Xd) = (ccrab @ (^ [Xy1:$i] : ((ccsu @ ccn @ (^ [Xm:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ XL) @ (ccv @ Xy1)) @ (ccv @ Xm) @ ccdiv))) = ccc0)) @ (^ [Xy1:$i] : (ccdif @ (XD @ Xa @ Xd) @ (ccsn @ (Xc_1 @ Xa @ Xd)))))))))) => ((! [Xy1:$i] : (! [Xm:$i] : (! [Xa:$i] : (! [Xd:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ XX @ (XW @ Xy1 @ Xm @ Xa @ Xd))))))) => ((! [Xa:$i] : ((XF @ Xa) = (ccmpt @ (^ [Xa:$i] : ccn) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xa) @ XL) @ XX) @ (ccfv @ (ccv @ Xa) @ ccsqrt) @ ccdiv))))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ (XC @ Xa) @ (cco @ ccc0 @ ccpnf @ ccico))))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwbr @ (ccseq @ ccaddc @ (XF @ Xa) @ cc1) @ (XS @ Xa) @ ccli)))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccfv @ (ccv @ Xy1) @ ccfl) @ (ccseq @ ccaddc @ (XF @ Xa) @ cc1)) @ (XS @ Xa) @ ccmin) @ ccabs) @ (cco @ (XC @ Xa) @ (ccfv @ (ccv @ Xy1) @ ccsqrt) @ ccdiv) @ ccle)) @ (^ [Xy1:$i] : (cco @ cc1 @ ccpnf @ ccico)))))) => (! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccfl) @ ccfz) @ (^ [Xm:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (ccv @ Xm) @ ccdiv) @ ccfl) @ ccfz) @ (^ [Xd:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ XL) @ XX) @ (ccfv @ (cco @ (ccv @ Xm) @ (ccv @ Xd) @ ccmul) @ ccsqrt) @ ccdiv))))))) @ cco1))))))))))))))))))))))))))))).
...
thf(cdchrisum0_conj,conjecture,(! [Xph:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XN @ cczn)) => ((XL = (ccfv @ XZ @ cczrh)) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XN @ ccn))) => ((! [Xy1:$i] : (! [Xm:$i] : ((XG @ Xy1 @ Xm) = (ccfv @ XN @ ccdchr)))) => ((! [Xy1:$i] : (! [Xm:$i] : (XD = (ccfv @ (XG @ Xy1 @ Xm) @ ccbs)))) => ((! [Xy1:$i] : (! [Xm:$i] : (Xc_1 = (ccfv @ (XG @ Xy1 @ Xm) @ cc0g)))) => ((! [Xy1:$i] : (! [Xm:$i] : ((XW @ Xy1 @ Xm) = (ccrab @ (^ [Xy1:$i] : ((ccsu @ ccn @ (^ [Xm:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xm) @ XL) @ (ccv @ Xy1)) @ (ccv @ Xm) @ ccdiv))) = ccc0)) @ (^ [Xy1:$i] : (ccdif @ XD @ (ccsn @ Xc_1))))))) => ((! [Xy1:$i] : (! [Xm:$i] : ((Xph @ Xy1) => (cwcel @ XX @ (XW @ Xy1 @ Xm))))) => (! [Xy1:$i] : (~ (Xph @ Xy1))))))))))))))))))))).
