...
thf(aringsubdi_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_mi = (ccfv @ XR @ ccsg)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XZ @ XB2)) => (Xph => ((cco @ XX @ (cco @ XY @ XZ @ Xc_mi) @ Xc_x) = (cco @ (cco @ XX @ XY @ Xc_x) @ (cco @ XX @ XZ @ Xc_x) @ Xc_mi))))))))))))))))))).
...
thf(afz0fzdiffz0_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ (cco @ ccc0 @ XN @ ccfz)) & (cwcel @ XK @ (cco @ XM @ XN @ ccfz))) => (cwcel @ (cco @ XK @ XM @ ccmin) @ (cco @ ccc0 @ XN @ ccfz))))))).
...
thf(am2pmfzmap_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XY:($i > $o)] : (! [Xb:$i] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XY = (cco @ XN @ XP @ ccmat)) => ((XT = (cco @ XN @ XR @ ccmat2pmat)) => (((cw3a @ (cwcel @ XN @ ccfn) @ (cwcel @ XR @ ccrg) @ (cwcel @ XS @ ccn0)) & ((cwcel @ (ccv @ Xb) @ (cco @ XB2 @ (cco @ ccc0 @ XS @ ccfz) @ ccmap)) & (cwcel @ XI @ (cco @ ccc0 @ XS @ ccfz)))) => (cwcel @ (ccfv @ (ccfv @ XI @ (ccv @ Xb)) @ XT) @ (ccfv @ XY @ ccbs))))))))))))))))))).
...
thf(amulgnnp1_ax,axiom,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => (((cwcel @ XN @ ccn) & (cwcel @ XX @ XB2)) => ((cco @ (cco @ XN @ cc1 @ ccaddc) @ XX @ Xc_x) = (cco @ (cco @ XN @ XX @ Xc_x) @ XX @ Xc_pl))))))))))))).
...
thf(cchfacfpmmulgsum2_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_pl:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [Xc_xp:($i > ($i > ($i > $o)))] : (! [Xc_ex:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XM:($i > ($i > ($i > $o)))] : (! [Xc_mi:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > ($i > ($i > $o))))] : ((! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XA2 @ Xi @ Xn @ Xs1 @ Xb) = (cco @ (XN @ Xs1 @ Xb) @ (XR @ Xs1 @ Xb) @ ccmat)))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XB2 @ Xs1 @ Xb) = (ccfv @ (XA2 @ Xi @ Xn @ Xs1 @ Xb) @ ccbs)))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XP @ Xi @ Xn @ Xs1 @ Xb) = (ccfv @ (XR @ Xs1 @ Xb) @ ccpl1)))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XY @ Xs1 @ Xb) = (cco @ (XN @ Xs1 @ Xb) @ (XP @ Xi @ Xn @ Xs1 @ Xb) @ ccmat)))))) => ((! [Xs1:$i] : (! [Xb:$i] : ((Xc_xp @ Xs1 @ Xb) = (ccfv @ (XY @ Xs1 @ Xb) @ ccmulr)))) => ((! [Xi:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((Xc_mi @ Xi @ Xs1 @ Xb) = (ccfv @ (XY @ Xs1 @ Xb) @ ccsg))))) => ((! [Xi:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((Xc_0 @ Xi @ Xs1 @ Xb) = (ccfv @ (XY @ Xs1 @ Xb) @ cc0g))))) => ((! [Xs1:$i] : (! [Xb:$i] : ((XT @ Xs1 @ Xb) = (cco @ (XN @ Xs1 @ Xb) @ (XR @ Xs1 @ Xb) @ ccmat2pmat)))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((XG @ Xn @ Xs1 @ Xb) = (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = ccc0) @ (cco @ (Xc_0 @ Xi @ Xs1 @ Xb) @ (cco @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xs1 @ Xb)) @ (ccfv @ (ccfv @ ccc0 @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (Xc_xp @ Xs1 @ Xb)) @ (Xc_mi @ Xi @ Xs1 @ Xb)) @ (ccif @ ((ccv @ Xn) = (cco @ (ccv @ Xs1) @ cc1 @ ccaddc)) @ (ccfv @ (ccfv @ (ccv @ Xs1) @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (ccif @ (cwbr @ (cco @ (ccv @ Xs1) @ cc1 @ ccaddc) @ (ccv @ Xn) @ cclt) @ (Xc_0 @ Xi @ Xs1 @ Xb) @ (cco @ (ccfv @ (ccfv @ (cco @ (ccv @ Xn) @ cc1 @ ccmin) @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (cco @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xs1 @ Xb)) @ (ccfv @ (ccfv @ (ccv @ Xn) @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (Xc_xp @ Xs1 @ Xb)) @ (Xc_mi @ Xi @ Xs1 @ Xb)))))))))))) => ((! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((Xc_ex @ Xn @ Xs1 @ Xb) = (ccfv @ (ccfv @ (XY @ Xs1 @ Xb) @ ccmgp) @ ccmg))))) => ((! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : ((Xc_pl @ Xi @ Xn @ Xs1 @ Xb) = (ccfv @ (XY @ Xs1 @ Xb) @ ccplusg)))))) => (! [Xi:$i] : (! [Xn:$i] : (! [Xs1:$i] : (! [Xb:$i] : (((cw3a @ (cwcel @ (XN @ Xs1 @ Xb) @ ccfn) @ (cwcel @ (XR @ Xs1 @ Xb) @ cccrg) @ (cwcel @ (XM @ Xs1 @ Xb) @ (XB2 @ Xs1 @ Xb))) & ((cwcel @ (ccv @ Xs1) @ ccn) & (cwcel @ (ccv @ Xb) @ (cco @ (XB2 @ Xs1 @ Xb) @ (cco @ ccc0 @ (ccv @ Xs1) @ ccfz) @ ccmap)))) => ((cco @ (XY @ Xs1 @ Xb) @ (ccmpt @ (^ [Xi:$i] : ccn0) @ (^ [Xi:$i] : (cco @ (cco @ (ccv @ Xi) @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xs1 @ Xb)) @ (Xc_ex @ Xn @ Xs1 @ Xb)) @ (ccfv @ (ccv @ Xi) @ (XG @ Xn @ Xs1 @ Xb)) @ (Xc_xp @ Xs1 @ Xb)))) @ ccgsu) = (cco @ (cco @ (XY @ Xs1 @ Xb) @ (ccmpt @ (^ [Xi:$i] : (cco @ cc1 @ (ccv @ Xs1) @ ccfz)) @ (^ [Xi:$i] : (cco @ (cco @ (cco @ (ccv @ Xi) @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xs1 @ Xb)) @ (Xc_ex @ Xn @ Xs1 @ Xb)) @ (ccfv @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccmin) @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (Xc_xp @ Xs1 @ Xb)) @ (cco @ (cco @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xs1 @ Xb)) @ (Xc_ex @ Xn @ Xs1 @ Xb)) @ (ccfv @ (ccfv @ (ccv @ Xi) @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (Xc_xp @ Xs1 @ Xb)) @ (Xc_mi @ Xi @ Xs1 @ Xb)))) @ ccgsu) @ (cco @ (cco @ (cco @ (cco @ (ccv @ Xs1) @ cc1 @ ccaddc) @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xs1 @ Xb)) @ (Xc_ex @ Xn @ Xs1 @ Xb)) @ (ccfv @ (ccfv @ (ccv @ Xs1) @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (Xc_xp @ Xs1 @ Xb)) @ (cco @ (ccfv @ (XM @ Xs1 @ Xb) @ (XT @ Xs1 @ Xb)) @ (ccfv @ (ccfv @ ccc0 @ (ccv @ Xb)) @ (XT @ Xs1 @ Xb)) @ (Xc_xp @ Xs1 @ Xb)) @ (Xc_mi @ Xi @ Xs1 @ Xb)) @ (Xc_pl @ Xi @ Xn @ Xs1 @ Xb)))))))))))))))))))))))))))))))))).
