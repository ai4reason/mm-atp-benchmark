...
thf(afrege83_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XX @ XS) => ((cwcel @ XY @ XT) => ((cwcel @ XR @ XU) => ((cwcel @ XB2 @ XV) => ((cwcel @ XC @ XW) => ((cwhe @ (ccun @ XB2 @ XC) @ XR) => ((cwcel @ XX @ XB2) => ((cwbr @ XX @ XY @ (ccfv @ XR @ cctcl)) => (cwcel @ XY @ (ccun @ XB2 @ XC))))))))))))))))))))).
