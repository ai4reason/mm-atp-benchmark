...
thf(ccxpaddlelem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwbr @ XA2 @ cc1 @ ccle)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => (cwbr @ XB2 @ cc1 @ ccle)) => (Xph => (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ cccxp) @ ccle))))))))))).
