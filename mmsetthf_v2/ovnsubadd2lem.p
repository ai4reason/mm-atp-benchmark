...
thf(aovnsubadd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((Xph => (cwf @ ccn @ (ccpw @ (cco @ ccr @ XX @ ccmap)) @ XA2)) => (Xph => (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XA2))) @ (ccfv @ XX @ ccovoln)) @ (ccfv @ (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XA2) @ (ccfv @ XX @ ccovoln)))) @ ccsumge0) @ ccle)))))))).
...
thf(anelpr1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (~ (cwcel @ XA2 @ (ccpr @ XB2 @ XC)))) => (Xph => (cwne @ XA2 @ XB2)))))))))).
thf(avex_ax,axiom,(! [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ ccvv))).
thf(aid_ax,axiom,(! [Xph:$o] : (Xph => Xph))).
thf(anelpr2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (~ (cwcel @ XA2 @ (ccpr @ XB2 @ XC)))) => (Xph => (cwne @ XA2 @ XC)))))))))).
...
thf(aiunxdif3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XE @ Xx3))) => ((cwral @ (^ [Xx3:$i] : ((XB2 @ Xx3) = cc0)) @ (^ [Xx3:$i] : (XE @ Xx3))) => ((cciun @ (^ [Xx3:$i] : (ccdif @ XA2 @ (XE @ Xx3))) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))).
...
thf(aiunxprg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((XC @ Xx3) = XD))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XB2) => ((XC @ Xx3) = XE))) => (! [Xx3:$i] : (((cwcel @ XA2 @ (XV @ Xx3)) & (cwcel @ XB2 @ (XW @ Xx3))) => ((cciun @ (^ [Xx3:$i] : (ccpr @ XA2 @ XB2)) @ (^ [Xx3:$i] : (XC @ Xx3))) = (ccun @ XD @ XE)))))))))))))).
...
thf(aovn0_ax,axiom,(! [Xph:$o] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => (Xph => ((ccfv @ cc0 @ (ccfv @ XX @ ccovoln)) = ccc0)))))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(ccsu_tp,type,(ccsu : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(ccmnf_tp,type,(ccmnf : ($i > $o))).
thf(asge0pr_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((Xph => (cwcel @ XD @ (cco @ ccc0 @ ccpnf @ ccicc))) => ((Xph => (cwcel @ XE @ (cco @ ccc0 @ ccpnf @ ccicc))) => ((! [Xk:$i] : (((ccv @ Xk) = XA2) => ((XC @ Xk) = XD))) => ((! [Xk:$i] : (((ccv @ Xk) = XB2) => ((XC @ Xk) = XE))) => ((Xph => (cwne @ XA2 @ XB2)) => (Xph => ((ccfv @ (ccmpt @ (^ [Xk:$i] : (ccpr @ XA2 @ XB2)) @ (^ [Xk:$i] : (XC @ Xk))) @ ccsumge0) = (cco @ XD @ XE @ ccxad))))))))))))))))))).
thf(aeqsstrd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (cwss @ XB2 @ XC)) => (Xph => (cwss @ XA2 @ XC))))))))).
thf(aoveq12d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => ((Xph => (XC = XD)) => (Xph => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XD @ XF)))))))))))).
thf(covnsubadd2lem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XX @ ccfn)) => ((Xph => (cwss @ XA2 @ (cco @ ccr @ XX @ ccmap))) => ((Xph => (cwss @ XB2 @ (cco @ ccr @ XX @ ccmap))) => ((XC = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = cc1) @ XA2 @ (ccif @ ((ccv @ Xn) = cc2) @ XB2 @ cc0))))) => (Xph => (cwbr @ (ccfv @ (ccun @ XA2 @ XB2) @ (ccfv @ XX @ ccovoln)) @ (cco @ (ccfv @ XA2 @ (ccfv @ XX @ ccovoln)) @ (ccfv @ XB2 @ (ccfv @ XX @ ccovoln)) @ ccxad) @ ccle)))))))))))).
