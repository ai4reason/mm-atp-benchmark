...
thf(apmss12g_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((((cwss @ XA2 @ XC) & (cwss @ XB2 @ XD)) & ((cwcel @ XC @ XV) & (cwcel @ XD @ XW))) => (cwss @ (cco @ XA2 @ XB2 @ ccpm) @ (cco @ XC @ XD @ ccpm)))))))))).
...
thf(ccaures_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XD @ (ccfv @ XX @ ccme))) => ((Xph => (cwcel @ XF @ (cco @ XX @ ccc @ ccpm))) => (Xph => ((cwcel @ XF @ (ccfv @ XD @ ccca)) <=> (cwcel @ (ccres @ XF @ XZ) @ (ccfv @ XD @ ccca))))))))))))))).
