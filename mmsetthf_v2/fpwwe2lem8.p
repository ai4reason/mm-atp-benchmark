...
thf(atfis2_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => ((! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ ccon0) => ((cwral @ (^ [Xy1:$i] : (Xps @ Xy1)) @ (^ [Xy1:$i] : (ccv @ Xx3))) => (Xph @ Xx3)))) => (! [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ ccon0) => (Xph @ Xx3)))))))).
...
thf(afpwwe2lem7_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xy1:$i] : (! [Xu:$i] : (XW = (ccopab @ (^ [Xx3:$i] : (^ [Xr:$i] : (((cwss @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xu)) & (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)))) & ((cwwe @ (ccv @ Xx3) @ (ccv @ Xr)) & (cwral @ (^ [Xy1:$i] : (cwsbc @ (^ [Xu:$i] : ((cco @ (ccv @ Xu) @ (ccin @ (ccv @ Xr) @ (ccxp @ (ccv @ Xu) @ (ccv @ Xu))) @ XF) = (ccv @ Xy1))) @ (ccima @ (cccnv @ (ccv @ Xr)) @ (ccsn @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))))) => ((! [Xy1:$i] : (! [Xu:$i] : (Xph => (cwcel @ (XA2 @ Xy1 @ Xu) @ ccvv)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xr:$i] : ((Xph & (cw3a @ (cwss @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xu)) @ (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3))) @ (cwwe @ (ccv @ Xx3) @ (ccv @ Xr)))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ XF) @ (XA2 @ Xy1 @ Xu))))))) => ((Xph => (cwbr @ XX @ XR @ XW)) => ((Xph => (cwbr @ XY @ XS @ XW)) => ((XM = (ccoi @ XX @ XR)) => ((XN = (ccoi @ XY @ XS)) => ((! [Xx3:$i] : (! [Xr:$i] : (Xph => (cwcel @ (XB2 @ Xx3 @ Xr) @ (ccdm @ XM))))) => ((! [Xx3:$i] : (! [Xr:$i] : (Xph => (cwcel @ (XB2 @ Xx3 @ Xr) @ (ccdm @ XN))))) => ((! [Xx3:$i] : (! [Xr:$i] : (Xph => ((ccres @ XM @ (XB2 @ Xx3 @ Xr)) = (ccres @ XN @ (XB2 @ Xx3 @ Xr)))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xr:$i] : ((Xph & (cwbr @ (XC @ Xx3 @ Xy1 @ Xu @ Xr) @ (ccfv @ (XB2 @ Xx3 @ Xr) @ XM) @ XR)) => ((cwbr @ (XC @ Xx3 @ Xy1 @ Xu @ Xr) @ (ccfv @ (XB2 @ Xx3 @ Xr) @ XN) @ XS) & ((cwbr @ (XD @ Xx3 @ Xy1 @ Xu @ Xr) @ (ccfv @ (XB2 @ Xx3 @ Xr) @ XM) @ XR) => ((cwbr @ (XC @ Xx3 @ Xy1 @ Xu @ Xr) @ (XD @ Xx3 @ Xy1 @ Xu @ Xr) @ XR) <=> (cwbr @ (XC @ Xx3 @ Xy1 @ Xu @ Xr) @ (XD @ Xx3 @ Xy1 @ Xu @ Xr) @ XS))))))))))))))))))))))))))))))))).
...
thf(afpwwe2lem3_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : (! [Xu:$i] : (XW = (ccopab @ (^ [Xx3:$i] : (^ [Xr:$i] : (((cwss @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xu)) & (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)))) & ((cwwe @ (ccv @ Xx3) @ (ccv @ Xr)) & (cwral @ (^ [Xy1:$i] : (cwsbc @ (^ [Xu:$i] : ((cco @ (ccv @ Xu) @ (ccin @ (ccv @ Xr) @ (ccxp @ (ccv @ Xu) @ (ccv @ Xu))) @ XF) = (ccv @ Xy1))) @ (ccima @ (cccnv @ (ccv @ Xr)) @ (ccsn @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))))) => ((! [Xy1:$i] : (! [Xu:$i] : (Xph => (cwcel @ (XA2 @ Xy1 @ Xu) @ ccvv)))) => ((Xph => (cwbr @ XX @ XR @ XW)) => (! [Xx3:$i] : (! [Xr:$i] : ((Xph & (cwcel @ (XB2 @ Xx3 @ Xr) @ XX)) => ((cco @ (ccima @ (cccnv @ XR) @ (ccsn @ (XB2 @ Xx3 @ Xr))) @ (ccin @ XR @ (ccxp @ (ccima @ (cccnv @ XR) @ (ccsn @ (XB2 @ Xx3 @ Xr))) @ (ccima @ (cccnv @ XR) @ (ccsn @ (XB2 @ Xx3 @ Xr))))) @ XF) = (XB2 @ Xx3 @ Xr)))))))))))))))).
thf(cfpwwe2lem8_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xy1:$i] : (! [Xu:$i] : (XW = (ccopab @ (^ [Xx3:$i] : (^ [Xr:$i] : (((cwss @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xu)) & (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3)))) & ((cwwe @ (ccv @ Xx3) @ (ccv @ Xr)) & (cwral @ (^ [Xy1:$i] : (cwsbc @ (^ [Xu:$i] : ((cco @ (ccv @ Xu) @ (ccin @ (ccv @ Xr) @ (ccxp @ (ccv @ Xu) @ (ccv @ Xu))) @ XF) = (ccv @ Xy1))) @ (ccima @ (cccnv @ (ccv @ Xr)) @ (ccsn @ (ccv @ Xy1))))) @ (^ [Xy1:$i] : (ccv @ Xx3))))))))))) => ((! [Xy1:$i] : (! [Xu:$i] : (Xph => (cwcel @ (XA2 @ Xy1 @ Xu) @ ccvv)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xu:$i] : (! [Xr:$i] : ((Xph & (cw3a @ (cwss @ (ccv @ Xx3) @ (XA2 @ Xy1 @ Xu)) @ (cwss @ (ccv @ Xr) @ (ccxp @ (ccv @ Xx3) @ (ccv @ Xx3))) @ (cwwe @ (ccv @ Xx3) @ (ccv @ Xr)))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ XF) @ (XA2 @ Xy1 @ Xu))))))) => ((Xph => (cwbr @ XX @ XR @ XW)) => ((Xph => (cwbr @ XY @ XS @ XW)) => ((XM = (ccoi @ XX @ XR)) => ((XN = (ccoi @ XY @ XS)) => ((Xph => (cwss @ (ccdm @ XM) @ (ccdm @ XN))) => (Xph => (XM = (ccres @ XN @ (ccdm @ XM))))))))))))))))))))))).
