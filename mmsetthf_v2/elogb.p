...
thf(aene0_ax,axiom,(cwne @ cceu @ ccc0)).
thf(cc3_tp,type,(cc3 : ($i > $o))).
thf(cclt_tp,type,(cclt : ($i > $o))).
thf(cc2_tp,type,(cc2 : ($i > $o))).
thf(cwbr_tp,type,(cwbr : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(aene1_ax,axiom,(cwne @ cceu @ cc1)).
...
thf(celogb_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdif @ ccc @ (ccsn @ ccc0))) => ((cco @ cceu @ XA2 @ cclogb) = (ccfv @ XA2 @ cclog))))).
