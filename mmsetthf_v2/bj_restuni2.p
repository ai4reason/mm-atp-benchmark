...
thf(abj_restuni_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ XV) & (cwcel @ XA2 @ XW)) => ((ccuni @ (cco @ XX @ XA2 @ ccrest)) = (ccin @ (ccuni @ XX) @ XA2)))))))).
...
thf(cbj_restuni2_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ XV) & (cwss @ XA2 @ (ccuni @ XX))) => ((ccuni @ (cco @ XX @ XA2 @ ccrest)) = XA2)))))).
