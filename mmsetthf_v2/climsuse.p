...
thf(aclimsuselem1_ax,axiom,(! [Xph:$o] : (! [XI:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ (ccfv @ XM @ XI) @ XZ)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XI) @ (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ XI) @ cc1 @ ccaddc) @ ccuz)))) => (! [Xk:$i] : ((Xph & (cwcel @ (XK @ Xk) @ XZ)) => (cwcel @ (ccfv @ (XK @ Xk) @ XI) @ (ccfv @ (XK @ Xk) @ ccuz)))))))))))))).
