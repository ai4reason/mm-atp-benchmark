...
thf(awlknwwlksnen_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XG @ ccuspgr) & (cwcel @ XN @ ccn0)) => (cwbr @ (ccrab @ (^ [Xp:$i] : ((ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) = XN)) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks))) @ (cco @ XN @ XG @ ccwwlksn) @ ccen))))).
thf(aenfii_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XB2 @ ccfn) & (cwbr @ XA2 @ XB2 @ ccen)) => (cwcel @ XA2 @ ccfn))))).
thf(cwlksnfi_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XG @ ccfusgr) & (cwcel @ XN @ ccn0)) => (cwcel @ (ccrab @ (^ [Xp:$i] : ((ccfv @ (ccfv @ (ccv @ Xp) @ cc1st) @ cchash) = XN)) @ (^ [Xp:$i] : (ccfv @ XG @ ccwlks))) @ ccfn))))).
