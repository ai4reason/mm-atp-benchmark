...
thf(algsdi_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) & ((cwne @ XM @ ccc0) & (cwne @ XN @ ccc0))) => ((cco @ XA2 @ (cco @ XM @ XN @ ccmul) @ cclgs) = (cco @ (cco @ XA2 @ XM @ cclgs) @ (cco @ XA2 @ XN @ cclgs) @ ccmul))))))).
...
thf(algsabs1_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ XN @ ccz)) => (((ccfv @ (cco @ XA2 @ XN @ cclgs) @ ccabs) = cc1) <=> ((cco @ XA2 @ XN @ ccgcd) = cc1)))))).
thf(asq1_ax,axiom,((cco @ cc1 @ cc2 @ ccexp) = cc1)).
thf(azcnd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccz)) => (Xph => (cwcel @ XA2 @ ccc)))))).
thf(clgssq2_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccz) @ (cwcel @ XN @ ccn) @ ((cco @ XA2 @ XN @ ccgcd) = cc1)) => ((cco @ XA2 @ (cco @ XN @ cc2 @ ccexp) @ cclgs) = cc1))))).
