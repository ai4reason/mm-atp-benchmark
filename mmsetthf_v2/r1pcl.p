...
thf(cr1pcl_conj,conjecture,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XE = (ccfv @ XR @ ccr1p)) => ((XP = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XP @ ccbs)) => ((XC = (ccfv @ XR @ ccuc1p)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XC)) => (cwcel @ (cco @ XF @ XG @ XE) @ XB2)))))))))))))).
