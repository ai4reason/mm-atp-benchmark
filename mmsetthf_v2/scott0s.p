...
thf(cscott0s_conj,conjecture,(! [Xph:($i > $o)] : ((? [Xx3:$i] : (Xph @ Xx3)) <=> (cwne @ (ccab @ (^ [Xx3:$i] : ((Xph @ Xx3) & (! [Xy1:$i] : ((cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (ccv @ Xy1)) => (cwss @ (ccfv @ (ccv @ Xx3) @ ccrnk) @ (ccfv @ (ccv @ Xy1) @ ccrnk))))))) @ cc0)))).
