...
thf(aresspsrbas_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((XH = (cco @ XR @ XT @ ccress)) => ((XU = (cco @ XI @ XH @ ccmps)) => ((XB2 = (ccfv @ XU @ ccbs)) => ((XP = (cco @ XS @ XB2 @ ccress)) => ((Xph => (cwcel @ XT @ (ccfv @ XR @ ccsubrg))) => (Xph => (XB2 = (ccfv @ XP @ ccbs))))))))))))))))))).
...
thf(cresspsrvsca_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((XH = (cco @ XR @ XT @ ccress)) => ((XU = (cco @ XI @ XH @ ccmps)) => ((XB2 = (ccfv @ XU @ ccbs)) => ((XP = (cco @ XS @ XB2 @ ccress)) => ((Xph => (cwcel @ XT @ (ccfv @ XR @ ccsubrg))) => ((Xph & ((cwcel @ XX @ XT) & (cwcel @ XY @ XB2))) => ((cco @ XX @ XY @ (ccfv @ XU @ ccvsca)) = (cco @ XX @ XY @ (ccfv @ XP @ ccvsca)))))))))))))))))))))).
