...
thf(aunelsiga_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : ((cw3a @ (cwcel @ XS @ (ccuni @ (ccrn @ ccsiga))) @ (cwcel @ XA2 @ XS) @ (cwcel @ XB2 @ XS)) => (cwcel @ (ccun @ XA2 @ XB2) @ XS)))))).
thf(aa1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => (Xps => Xph))))).
thf(assun1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (cwss @ XA2 @ (ccun @ XA2 @ XB2))))).
thf(asimpr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(ameasle0_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XM @ (ccfv @ XS @ ccmeas)) @ (cwcel @ XA2 @ XS) @ (cwbr @ (ccfv @ XA2 @ XM) @ ccc0 @ ccle)) => ((ccfv @ XA2 @ XM) = ccc0)))))).
...
thf(ameasunl_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ (ccfv @ XS @ ccmeas))) => ((Xph => (cwcel @ XA2 @ XS)) => ((Xph => (cwcel @ XB2 @ XS)) => (Xph => (cwbr @ (ccfv @ (ccun @ XA2 @ XB2) @ XM) @ (cco @ (ccfv @ XA2 @ XM) @ (ccfv @ XB2 @ XM) @ ccxad) @ ccle))))))))))).
...
thf(caean_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XO:($i > $o)] : ((! [Xx3:$i] : ((ccuni @ (ccdm @ (XM @ Xx3))) = XO)) => (! [Xx3:$i] : ((cw3a @ (cwcel @ (XM @ Xx3) @ (ccuni @ (ccrn @ ccmeas))) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (~ (Xph @ Xx3))) @ (^ [Xx3:$i] : XO)) @ (ccdm @ (XM @ Xx3))) @ (cwcel @ (ccrab @ (^ [Xx3:$i] : (~ (Xps @ Xx3))) @ (^ [Xx3:$i] : XO)) @ (ccdm @ (XM @ Xx3)))) => ((cwbr @ (ccrab @ (^ [Xx3:$i] : ((Xph @ Xx3) & (Xps @ Xx3))) @ (^ [Xx3:$i] : XO)) @ (XM @ Xx3) @ ccae) <=> ((cwbr @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XO)) @ (XM @ Xx3) @ ccae) & (cwbr @ (ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : XO)) @ (XM @ Xx3) @ ccae))))))))))).
