...
thf(asbcom_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xy1:$i] : ((cwsb @ (^ [Xz:$i] : (cwsb @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1 @ Xz)) @ Xy1)) @ Xy1) <=> (cwsb @ (^ [Xx3:$i] : (cwsb @ (^ [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)) @ Xy1)) @ Xy1))))).
thf(cwl_sbcom3_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xz:$i] : ((cwsb @ (^ [Xy1:$i] : (cwsb @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1 @ Xz)) @ Xy1)) @ Xz) <=> (cwsb @ (^ [Xx3:$i] : (cwsb @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1 @ Xz)) @ Xz)) @ Xz))))).
