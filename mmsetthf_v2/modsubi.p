...
thf(cmodsubi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cwcel @ XA2 @ ccn) => ((cwcel @ XB2 @ ccn0) => ((cwcel @ XM @ ccn0) => (((cco @ XA2 @ XN @ ccmo) = (cco @ XK @ XN @ ccmo)) => (((cco @ XM @ XB2 @ ccaddc) = XK) => ((cco @ (cco @ XA2 @ XB2 @ ccmin) @ XN @ ccmo) = (cco @ XM @ XN @ ccmo)))))))))))))).
