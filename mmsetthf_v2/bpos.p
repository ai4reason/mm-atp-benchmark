...
thf(abpos1_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwbr @ XN @ (ccdc @ cc6 @ cc4) @ ccle)) => (cwrex @ (^ [Xp:$i] : ((cwbr @ XN @ (ccv @ Xp) @ cclt) & (cwbr @ (ccv @ Xp) @ (cco @ cc2 @ XN @ ccmul) @ ccle))) @ (^ [Xp:$i] : ccprime))))).
thf(apm2_18da_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (((Xph & (~ Xps)) => Xps) => (Xph => Xps))))).
