...
thf(aunisuc_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwtr @ XA2) <=> ((ccuni @ (ccsuc @ XA2)) = XA2))))).
...
thf(asucon_ax,axiom,((ccsuc @ ccon0) = ccon0)).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(aunon_ax,axiom,((ccuni @ ccon0) = ccon0)).
thf(cordunisuc_conj,conjecture,(! [XA2:($i > $o)] : ((cword @ XA2) => ((ccuni @ (ccsuc @ XA2)) = XA2)))).
