...
thf(aun0_1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((cwvd1 @ $true @ Xph) => ((cwvd1 @ Xps @ Xch) => ((cwvd1 @ (cwvhc2 @ $true @ Xps) @ Xth) => (cwvd1 @ Xps @ Xth))))))))).
...
thf(aelpwgdedVD_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwvd1 @ Xph @ (cwcel @ XA2 @ ccvv)) => ((cwvd1 @ Xps @ (cwss @ XA2 @ XB2)) => (cwvd1 @ (cwvhc2 @ Xph @ Xps) @ (cwcel @ XA2 @ (ccpw @ XB2)))))))))).
