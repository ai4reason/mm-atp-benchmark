...
thf(aabsreim_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((ccfv @ (cco @ XA2 @ (cco @ cci @ XB2 @ ccmul) @ ccaddc) @ ccabs) = (ccfv @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccaddc) @ ccsqrt)))))).
...
thf(ai1fd_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : ((Xph => (cwf @ ccr @ ccr @ XF)) => ((Xph => (cwcel @ (ccrn @ XF) @ ccfn)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ (ccrn @ XF) @ (ccsn @ ccc0)))) => (cwcel @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xx3))) @ (ccdm @ ccvol)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ (ccrn @ XF) @ (ccsn @ ccc0)))) => (cwcel @ (ccfv @ (ccima @ (cccnv @ XF) @ (ccsn @ (ccv @ Xx3))) @ ccvol) @ ccr))) => (Xph => (cwcel @ XF @ (ccdm @ ccitg1)))))))))).
...
thf(afco2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwf @ XB2 @ XC @ (ccres @ XF @ XB2)) & (cwf @ XA2 @ XB2 @ XG)) => (cwf @ XA2 @ XC @ (cccom @ XF @ XG))))))))).
thf(asyl5eqel_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((Xph => (cwcel @ XB2 @ XC)) => (Xph => (cwcel @ XA2 @ XC))))))))).
thf(arnco_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((ccrn @ (cccom @ XA2 @ XB2)) = (ccrn @ (ccres @ XA2 @ (ccrn @ XB2))))))).
...
thf(ai1fadd_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ (ccdm @ ccitg1))) => ((Xph => (cwcel @ XG @ (ccdm @ ccitg1))) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ ccaddc)) @ (ccdm @ ccitg1))))))))).
thf(ccdiv_tp,type,(ccdiv : ($i > $o))).
thf(ai1fmul_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XF @ (ccdm @ ccitg1))) => ((Xph => (cwcel @ XG @ (ccdm @ ccitg1))) => (Xph => (cwcel @ (cco @ XF @ XG @ (ccof @ ccmul)) @ (ccdm @ ccitg1))))))))).
...
thf(ai1fima_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ ccitg1)) => (cwcel @ (ccima @ (cccnv @ XF) @ XA2) @ (ccdm @ ccvol)))))).
...
thf(ai1fima2_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ (ccdm @ ccitg1)) & (~ (cwcel @ ccc0 @ XA2))) => (cwcel @ (ccfv @ (ccima @ (cccnv @ XF) @ XA2) @ ccvol) @ ccr))))).
