...
thf(cisnsgrp_conj,conjecture,(! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_op:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((Xc_op = (ccfv @ XM @ ccplusg)) => ((cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2)) => ((cwne @ (cco @ (cco @ XX @ XY @ Xc_op) @ XZ @ Xc_op) @ (cco @ XX @ (cco @ XY @ XZ @ Xc_op) @ Xc_op)) => (cwnel @ XM @ ccsgrp)))))))))))).
