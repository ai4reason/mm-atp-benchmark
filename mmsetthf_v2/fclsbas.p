...
thf(cfclsbas_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xs1:$i] : ((XF @ Xs1) = (cco @ (XX @ Xs1) @ XB2 @ ccfg))) => (! [Xs1:$i] : (((cwcel @ (XJ @ Xs1) @ (ccfv @ (XX @ Xs1) @ cctopon)) & (cwcel @ XB2 @ (ccfv @ (XX @ Xs1) @ ccfbas))) => ((cwcel @ (XA2 @ Xs1) @ (cco @ (XJ @ Xs1) @ (XF @ Xs1) @ ccfcls)) <=> ((cwcel @ (XA2 @ Xs1) @ (XX @ Xs1)) & (cwral @ (^ [Xo:$i] : ((cwcel @ (XA2 @ Xs1) @ (ccv @ Xo)) => (cwral @ (^ [Xs1:$i] : (cwne @ (ccin @ (ccv @ Xo) @ (ccv @ Xs1)) @ cc0)) @ (^ [Xs1:$i] : XB2)))) @ (^ [Xo:$i] : (XJ @ Xs1)))))))))))))).
