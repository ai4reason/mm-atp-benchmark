...
thf(asraassa_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XS @ (ccfv @ XW @ ccsra))) => (((cwcel @ XW @ cccrg) & (cwcel @ XS @ (ccfv @ XW @ ccsubrg))) => (cwcel @ XA2 @ ccasa))))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(ccvv_tp,type,(ccvv : ($i > $o))).
thf(arlmval_ax,axiom,(! [XW:($i > $o)] : ((ccfv @ XW @ ccrglmod) = (ccfv @ (ccfv @ XW @ ccbs) @ (ccfv @ XW @ ccsra))))).
thf(crlmassa_conj,conjecture,(! [XR:($i > $o)] : ((cwcel @ XR @ cccrg) => (cwcel @ (ccfv @ XR @ ccrglmod) @ ccasa)))).
