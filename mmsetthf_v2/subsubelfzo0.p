...
thf(csubsubelfzo0_conj,conjecture,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (cco @ ccc0 @ XN @ ccfzo)) @ (cwcel @ XI @ (cco @ ccc0 @ XN @ ccfzo)) @ (~ (cwbr @ XI @ (cco @ XN @ XA2 @ ccmin) @ cclt))) => (cwcel @ (cco @ XI @ (cco @ XN @ XA2 @ ccmin) @ ccmin) @ (cco @ ccc0 @ XA2 @ ccfzo))))))).
