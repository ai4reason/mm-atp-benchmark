...
thf(aelfzlmr_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ XM @ XN @ ccfz)) => (cw3o @ (XK = XM) @ (cwcel @ XK @ (cco @ (cco @ XM @ cc1 @ ccaddc) @ XN @ ccfzo)) @ (XK = XN))))))).
...
thf(celfz0lmr_conj,conjecture,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) => (cw3o @ (XK = ccc0) @ (cwcel @ XK @ (cco @ cc1 @ XN @ ccfzo)) @ (XK = XN)))))).
