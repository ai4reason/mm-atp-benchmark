...
thf(arankonidlem_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccr1)) => ((cwcel @ XA2 @ (ccuni @ (ccima @ ccr1 @ ccon0))) & ((ccfv @ XA2 @ ccrnk) = XA2))))).
...
thf(conssr1_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ ccr1)) => (cwss @ XA2 @ (ccfv @ XA2 @ ccr1))))).
