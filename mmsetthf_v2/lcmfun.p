...
thf(alcmfunsn_ax,axiom,(! [XN:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwss @ XY @ ccz) @ (cwcel @ XY @ ccfn) @ (cwcel @ XN @ ccz)) => ((ccfv @ (ccun @ XY @ (ccsn @ XN)) @ cclcmf) = (cco @ (ccfv @ XY @ cclcmf) @ XN @ cclcm)))))).
...
thf(alcmass_ax,axiom,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XP @ ccz)) => ((cco @ (cco @ XN @ XM @ cclcm) @ XP @ cclcm) = (cco @ XN @ (cco @ XM @ XP @ cclcm) @ cclcm))))))).
thf(aeqeq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((XC = XA2) <=> (XC = XB2))))))))).
thf(a_3jca_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xph => Xch) => ((Xph => Xth) => (Xph => (cw3a @ Xps @ Xch @ Xth)))))))))).
thf(asimpr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(clcmfun_conj,conjecture,(! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((((cwss @ XY @ ccz) & (cwcel @ XY @ ccfn)) & ((cwss @ XZ @ ccz) & (cwcel @ XZ @ ccfn))) => ((ccfv @ (ccun @ XY @ XZ) @ cclcmf) = (cco @ (ccfv @ XY @ cclcmf) @ (ccfv @ XZ @ cclcmf) @ cclcm)))))).
