...
thf(apockthlem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccn)) => ((Xph => (cwcel @ XB2 @ ccn)) => ((Xph => (cwbr @ XB2 @ XA2 @ cclt)) => ((Xph => (XN = (cco @ (cco @ XA2 @ XB2 @ ccmul) @ cc1 @ ccaddc))) => ((Xph => (cwcel @ XP @ ccprime)) => ((Xph => (cwbr @ XP @ XN @ ccdvds)) => ((Xph => (cwcel @ XQ @ ccprime)) => ((Xph => (cwcel @ (cco @ XQ @ XA2 @ ccpc) @ ccn)) => ((Xph => (cwcel @ XC @ ccz)) => ((Xph => ((cco @ (cco @ XC @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ XN @ ccmo) = cc1)) => ((Xph => ((cco @ (cco @ (cco @ XC @ (cco @ (cco @ XN @ cc1 @ ccmin) @ XQ @ ccdiv) @ ccexp) @ cc1 @ ccmin) @ XN @ ccgcd) = cc1)) => (Xph => (cwbr @ (cco @ XQ @ XA2 @ ccpc) @ (cco @ XQ @ (cco @ XP @ cc1 @ ccmin) @ ccpc) @ ccle))))))))))))))))))))).
