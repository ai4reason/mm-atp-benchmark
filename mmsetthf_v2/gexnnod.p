...
thf(cgexnnod_conj,conjecture,(! [XA2:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XE = (ccfv @ XG @ ccgex)) => ((XO = (ccfv @ XG @ ccod)) => ((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XE @ ccn) @ (cwcel @ XA2 @ XX)) => (cwcel @ (ccfv @ XA2 @ XO) @ ccn))))))))))).
