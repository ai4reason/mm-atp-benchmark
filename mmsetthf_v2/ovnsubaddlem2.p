...
thf(aaxcc3_ax,axiom,(! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwcel @ (XF @ Xn) @ ccvv)) => ((cwbr @ XN @ ccom @ ccen) => (? [Xf1:$i] : ((cwfn @ (ccv @ Xf1) @ XN) & (cwral @ (^ [Xn:$i] : ((cwne @ (XF @ Xn) @ cc0) => (cwcel @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ (XF @ Xn)))) @ (^ [Xn:$i] : XN))))))))).
...
thf(annf1oxpnn_ax,axiom,(? [Xf1:$i] : (cwf1o @ ccn @ (ccxp @ ccn @ ccn) @ (ccv @ Xf1)))).
