...
thf(acosnegpi_ax,axiom,((ccfv @ (ccneg @ ccpi) @ cccos) = (ccneg @ cc1))).
thf(ccosknegpi_conj,conjecture,(! [XK:($i > $o)] : ((cwcel @ XK @ ccz) => ((ccfv @ (cco @ XK @ (ccneg @ ccpi) @ ccmul) @ cccos) = (ccif @ (cwbr @ cc2 @ XK @ ccdvds) @ cc1 @ (ccneg @ cc1)))))).
