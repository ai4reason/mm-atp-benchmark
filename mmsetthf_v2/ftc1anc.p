...
thf(aftc1anclem6_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XY:($i > $o)] : ((! [Xx3:$i] : (! [Xt:$i] : ((XG @ Xx3 @ Xt) = (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccitg @ (^ [Xt:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccioo)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ XF)))))))) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ XD)) => ((Xph => (cwss @ XD @ ccr)) => ((Xph => (cwcel @ XF @ ccibl)) => ((Xph => (cwf @ XD @ ccc @ XF)) => ((Xph & (cwcel @ XY @ ccrp)) => (cwrex @ (^ [Xf1:$i] : (cwrex @ (^ [Xg1:$i] : (cwbr @ (ccfv @ (ccmpt @ (^ [Xt:$i] : ccr) @ (^ [Xt:$i] : (ccfv @ (cco @ (ccif @ (cwcel @ (ccv @ Xt) @ XD) @ (ccfv @ (ccv @ Xt) @ XF) @ ccc0) @ (cco @ (ccfv @ (ccv @ Xt) @ (ccv @ Xf1)) @ (cco @ cci @ (ccfv @ (ccv @ Xt) @ (ccv @ Xg1)) @ ccmul) @ ccaddc) @ ccmin) @ ccabs))) @ ccitg2) @ XY @ cclt)) @ (^ [Xg1:$i] : (ccdm @ ccitg1)))) @ (^ [Xf1:$i] : (ccdm @ ccitg1)))))))))))))))))))).
...
thf(ai1ff_ax,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ ccitg1)) => (cwf @ ccr @ ccr @ XF)))).
...
thf(ai1f0rn_ax,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ ccitg1)) => (cwcel @ ccc0 @ (ccrn @ XF))))).
...
thf(ai1frn_ax,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ (ccdm @ ccitg1)) => (cwcel @ (ccrn @ XF) @ ccfn)))).
...
thf(awlogle_ax,axiom,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : (! [Xth:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((((ccv @ Xz) = (ccv @ Xx3)) & ((ccv @ Xw) = (ccv @ Xy1))) => ((Xps @ Xz @ Xw) <=> (Xch @ Xx3 @ Xy1))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((((ccv @ Xz) = (ccv @ Xy1)) & ((ccv @ Xw) = (ccv @ Xx3))) => ((Xps @ Xz @ Xw) <=> (Xth @ Xx3 @ Xy1 @ Xz @ Xw))))))) => ((Xph => (cwss @ XS @ ccr)) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => ((Xch @ Xx3 @ Xy1) <=> (Xth @ Xx3 @ Xy1 @ Xz @ Xw))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & (cw3a @ (cwcel @ (ccv @ Xx3) @ XS) @ (cwcel @ (ccv @ Xy1) @ XS) @ (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccle))) => (Xch @ Xx3 @ Xy1)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => (Xch @ Xx3 @ Xy1))))))))))))))).
...
thf(aabssub_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) => ((ccfv @ (cco @ XA2 @ XB2 @ ccmin) @ ccabs) = (ccfv @ (cco @ XB2 @ XA2 @ ccmin) @ ccabs)))))).
...
thf(aelixx3g_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XO:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XO @ Xx3 @ Xy1 @ Xz) = (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : ccxr)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccrab @ (^ [Xz:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ XR) & (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ XS))) @ (^ [Xz:$i] : ccxr))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ XC @ (cco @ XA2 @ XB2 @ (XO @ Xx3 @ Xy1 @ Xz))) <=> ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) & ((cwbr @ XA2 @ XC @ XR) & (cwbr @ XC @ XB2 @ XS))))))))))))))).
...
thf(aioossioo_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) & ((cwbr @ XA2 @ XC @ ccle) & (cwbr @ XD @ XB2 @ ccle))) => (cwss @ (cco @ XC @ XD @ ccioo) @ (cco @ XA2 @ XB2 @ ccioo)))))))).
...
thf(aitgeq1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((XA2 = XB2) => ((ccitg @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) = (ccitg @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3))))))))).
...
thf(aitgsplitioo_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => ((Xph => (cwcel @ XB2 @ (cco @ XA2 @ XC @ ccicc))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XA2 @ XC @ ccioo))) => (cwcel @ (XD @ Xx3) @ ccc))) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xx3:$i] : (XD @ Xx3))) @ ccibl)) => ((Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ XB2 @ XC @ ccioo)) @ (^ [Xx3:$i] : (XD @ Xx3))) @ ccibl)) => (Xph => ((ccitg @ (^ [Xx3:$i] : (cco @ XA2 @ XC @ ccioo)) @ (^ [Xx3:$i] : (XD @ Xx3))) = (cco @ (ccitg @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xx3:$i] : (XD @ Xx3))) @ (ccitg @ (^ [Xx3:$i] : (cco @ XB2 @ XC @ ccioo)) @ (^ [Xx3:$i] : (XD @ Xx3))) @ ccaddc))))))))))))))).
...
thf(ait0e0_ax,axiom,((cco @ cci @ ccc0 @ ccmul) = ccc0)).
...
thf(afvif_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((ccfv @ (ccif @ Xph @ XA2 @ XB2) @ XF) = (ccif @ Xph @ (ccfv @ XA2 @ XF) @ (ccfv @ XB2 @ XF)))))))).
thf(aabs0_ax,axiom,((ccfv @ ccc0 @ ccabs) = ccc0)).
thf(aifeq2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((ccif @ Xph @ XC @ XA2) = (ccif @ Xph @ XC @ XB2)))))))).
...
thf(cftc1anc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xt:$i] : ((XG @ Xx3 @ Xt) = (ccmpt @ (^ [Xx3:$i] : (cco @ XA2 @ XB2 @ ccicc)) @ (^ [Xx3:$i] : (ccitg @ (^ [Xt:$i] : (cco @ XA2 @ (ccv @ Xx3) @ ccioo)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ XF)))))))) => ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ ccle)) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ XD)) => ((Xph => (cwss @ XD @ ccr)) => ((Xph => (cwcel @ XF @ ccibl)) => ((Xph => (cwf @ XD @ ccc @ XF)) => ((Xph => (cwral @ (^ [Xs1:$i] : (cwbr @ (ccfv @ (ccitg @ (^ [Xt:$i] : (ccv @ Xs1)) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ XF))) @ ccabs) @ (ccfv @ (ccmpt @ (^ [Xt:$i] : ccr) @ (^ [Xt:$i] : (ccif @ (cwcel @ (ccv @ Xt) @ (ccv @ Xs1)) @ (ccfv @ (ccfv @ (ccv @ Xt) @ XF) @ ccabs) @ ccc0))) @ ccitg2) @ ccle)) @ (^ [Xs1:$i] : (ccima @ ccioo @ (ccxp @ (cco @ XA2 @ XB2 @ ccicc) @ (cco @ XA2 @ XB2 @ ccicc)))))) => (! [Xx3:$i] : (! [Xt:$i] : (Xph => (cwcel @ (XG @ Xx3 @ Xt) @ (cco @ (cco @ XA2 @ XB2 @ ccicc) @ ccc @ cccncf))))))))))))))))))))).
