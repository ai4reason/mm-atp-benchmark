...
thf(adf_dir_ax,axiom,(ccdir = (ccab @ (^ [Xr:$i] : (((cwrel @ (ccv @ Xr)) & (cwss @ (ccres @ ccid @ (ccuni @ (ccuni @ (ccv @ Xr)))) @ (ccv @ Xr))) & ((cwss @ (cccom @ (ccv @ Xr) @ (ccv @ Xr)) @ (ccv @ Xr)) & (cwss @ (ccxp @ (ccuni @ (ccuni @ (ccv @ Xr))) @ (ccuni @ (ccuni @ (ccv @ Xr)))) @ (cccom @ (cccnv @ (ccv @ Xr)) @ (ccv @ Xr))))))))).
