...
thf(cllnle_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccfv @ XK @ ccbs))) => ((Xc_le = (ccfv @ XK @ ccple)) => ((! [Xy1:$i] : ((Xc_0 @ Xy1) = (ccfv @ XK @ ccp0))) => ((! [Xy1:$i] : ((XA2 @ Xy1) = (ccfv @ XK @ ccatm))) => ((XN = (ccfv @ XK @ cclln)) => (! [Xy1:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XX @ (XB2 @ Xy1))) & ((cwne @ XX @ (Xc_0 @ Xy1)) & (~ (cwcel @ XX @ (XA2 @ Xy1))))) => (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ XX @ Xc_le)) @ (^ [Xy1:$i] : XN))))))))))))))))).
