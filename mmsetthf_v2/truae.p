...
thf(abraew_ax,axiom,(! [Xph:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XO:($i > $o)] : ((! [Xx3:$i] : ((ccuni @ (ccdm @ (XM @ Xx3))) = XO)) => (! [Xx3:$i] : ((cwcel @ (XM @ Xx3) @ (ccuni @ (ccrn @ ccmeas))) => ((cwbr @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XO)) @ (XM @ Xx3) @ ccae) <=> ((ccfv @ (ccrab @ (^ [Xx3:$i] : (~ (Xph @ Xx3))) @ (^ [Xx3:$i] : XO)) @ (XM @ Xx3)) = ccc0))))))))).
