...
thf(cchtprm_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccz) & (cwcel @ (cco @ XA2 @ cc1 @ ccaddc) @ ccprime)) => ((ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cccht) = (cco @ (ccfv @ XA2 @ cccht) @ (ccfv @ (cco @ XA2 @ cc1 @ ccaddc) @ cclog) @ ccaddc))))).
