...
thf(cm2detleiblem7_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XN = (ccpr @ cc1 @ cc2)) => ((XP = (ccfv @ (ccfv @ XN @ ccsymg) @ ccbs)) => ((XY = (ccfv @ XR @ cczrh)) => ((XS = (ccfv @ XN @ ccpsgn)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((XI = (ccfv @ XR @ ccminusg)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((Xc_mi = (ccfv @ XR @ ccsg)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ (ccfv @ XR @ ccbs)) @ (cwcel @ XZ @ (ccfv @ XR @ ccbs))) => ((cco @ XX @ (cco @ (ccfv @ Xc_1 @ XI) @ XZ @ Xc_x) @ (ccfv @ XR @ ccplusg)) = (cco @ XX @ XZ @ Xc_mi))))))))))))))))))))))).
