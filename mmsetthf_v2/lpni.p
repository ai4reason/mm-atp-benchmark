...
thf(atncp_ax,axiom,(! [XP:($i > ($i > $o))] : (! [XG:($i > $o)] : ((! [Xl:$i] : ((XP @ Xl) = (ccuni @ XG))) => (! [Xl:$i] : ((cwcel @ XG @ ccplig) => (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : (cwral @ (^ [Xl:$i] : (~ (cw3a @ (cwcel @ (ccv @ Xa) @ (ccv @ Xl)) @ (cwcel @ (ccv @ Xb) @ (ccv @ Xl)) @ (cwcel @ (ccv @ Xc) @ (ccv @ Xl))))) @ (^ [Xl:$i] : XG))) @ (^ [Xc:$i] : (XP @ Xl)))) @ (^ [Xb:$i] : (XP @ Xl)))) @ (^ [Xa:$i] : (XP @ Xl))))))))).
...
thf(a_3jaao_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (! [Xze:$o] : ((Xph => (Xps => Xch)) => ((Xth => (Xta => Xch)) => ((Xet => (Xze => Xch)) => ((cw3a @ Xph @ Xth @ Xet) => ((cw3o @ Xps @ Xta @ Xze) => Xch))))))))))))).
...
thf(clpni_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XL:($i > $o)] : ((XP = (ccuni @ XG)) => (((cwcel @ XG @ ccplig) & (cwcel @ XL @ XG)) => (cwrex @ (^ [Xa:$i] : (cwnel @ (ccv @ Xa) @ XL)) @ (^ [Xa:$i] : XP)))))))).
