...
thf(ainfn0_ax,axiom,(! [XA2:($i > $o)] : ((cwbr @ ccom @ XA2 @ ccdom) => (cwne @ XA2 @ cc0)))).
...
thf(acdafn_ax,axiom,(cwfn @ cccda @ (ccxp @ ccvv @ ccvv))).
...
thf(acdainflem_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwbr @ (ccun @ XA2 @ XB2) @ ccom @ ccen) => ((cwbr @ XA2 @ ccom @ ccen) | (cwbr @ XB2 @ ccom @ ccen)))))).
...
thf(ccdainf_conj,conjecture,(! [XA2:($i > $o)] : ((cwbr @ ccom @ XA2 @ ccdom) <=> (cwbr @ ccom @ (cco @ XA2 @ XA2 @ cccda) @ ccdom)))).
