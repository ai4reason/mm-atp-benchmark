...
thf(areximddv3_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : (((Xph & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) & (Xps @ Xx3)) => (Xch @ Xx3))) => ((Xph => (cwrex @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) => (Xph => (cwrex @ (^ [Xx3:$i] : (Xch @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))))))))))).
...
thf(cclimisp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xk:$i] : (Xph => (cwcel @ (XM @ Xk) @ ccz))) => ((! [Xk:$i] : (XZ = (ccfv @ (XM @ Xk) @ ccuz))) => ((Xph => (cwf @ XZ @ ccc @ XF)) => ((Xph => (cwbr @ XF @ XA2 @ ccli)) => ((Xph => (cwcel @ XX @ ccrp)) => ((! [Xk:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xk) @ XZ) @ (cwne @ (ccfv @ (ccv @ Xk) @ XF) @ XA2)) => (cwbr @ XX @ (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ XF) @ XA2 @ ccmin) @ ccabs) @ ccle))) => (Xph => (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : ((ccfv @ (ccv @ Xk) @ XF) = XA2)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ)))))))))))))))).
