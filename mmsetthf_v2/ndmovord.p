...
thf(cndmovord_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (((ccdm @ XF) = (ccxp @ XS @ XS)) => ((cwss @ XR @ (ccxp @ XS @ XS)) => ((~ (cwcel @ cc0 @ XS)) => (((cw3a @ (cwcel @ XA2 @ XS) @ (cwcel @ XB2 @ XS) @ (cwcel @ XC @ XS)) => ((cwbr @ XA2 @ XB2 @ XR) <=> (cwbr @ (cco @ XC @ XA2 @ XF) @ (cco @ XC @ XB2 @ XF) @ XR))) => ((cwcel @ XC @ XS) => ((cwbr @ XA2 @ XB2 @ XR) <=> (cwbr @ (cco @ XC @ XA2 @ XF) @ (cco @ XC @ XB2 @ XF) @ XR)))))))))))))).
