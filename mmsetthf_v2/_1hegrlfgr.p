...
thf(c_1hegrlfgr_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XA2 @ Xx3) @ (XX @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XB2 @ Xx3) @ XV))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XC @ Xx3) @ XV))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwne @ (XB2 @ Xx3) @ (XC @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XE @ (ccpw @ XV)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => ((ccfv @ (XG @ Xx3) @ cciedg) = (ccsn @ (ccop @ (XA2 @ Xx3) @ XE))))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ (ccpr @ (XB2 @ Xx3) @ (XC @ Xx3)) @ XE))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwf @ (ccsn @ (XA2 @ Xx3)) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ cchash) @ ccle)) @ (^ [Xx3:$i] : (ccpw @ XV))) @ (ccfv @ (XG @ Xx3) @ cciedg)))))))))))))))))))).
