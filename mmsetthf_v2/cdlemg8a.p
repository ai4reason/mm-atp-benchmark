...
thf(ccdlemg8a_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ (((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) & ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le)))) @ (cw3a @ (cwcel @ XF @ XT) @ (cwcel @ XG @ XT) @ ((ccfv @ (ccfv @ XP @ XG) @ XF) = XP))) => ((cco @ (cco @ XP @ (ccfv @ (ccfv @ XP @ XG) @ XF) @ Xc_or) @ XW @ Xc_an) = (cco @ (cco @ XQ @ (ccfv @ (ccfv @ XQ @ XG) @ XF) @ Xc_or) @ XW @ Xc_an)))))))))))))))))))))).
