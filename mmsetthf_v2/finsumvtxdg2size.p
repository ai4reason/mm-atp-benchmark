...
thf(aupgrop_ax,axiom,(! [XG:($i > $o)] : ((cwcel @ XG @ ccupgr) => (cwcel @ (ccop @ (ccfv @ XG @ ccvtx) @ (ccfv @ XG @ cciedg)) @ ccupgr)))).
...
thf(aupgrres_ax,axiom,(! [XS:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xi:$i] : ((XV @ Xi) = (ccfv @ (XG @ Xi) @ ccvtx))) => ((! [Xi:$i] : (XE = (ccfv @ (XG @ Xi) @ cciedg))) => ((! [Xi:$i] : ((XF @ Xi) = (ccrab @ (^ [Xi:$i] : (cwnel @ XN @ (ccfv @ (ccv @ Xi) @ XE))) @ (^ [Xi:$i] : (ccdm @ XE))))) => ((! [Xi:$i] : ((XS @ Xi) = (ccop @ (ccdif @ (XV @ Xi) @ (ccsn @ XN)) @ (ccres @ XE @ (XF @ Xi))))) => (! [Xi:$i] : (((cwcel @ (XG @ Xi) @ ccupgr) & (cwcel @ XN @ (XV @ Xi))) => (cwcel @ (XS @ Xi) @ ccupgr)))))))))))))).
...
thf(avtxdgop_ax,axiom,(! [XG:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XG @ XW) => ((ccfv @ XG @ ccvtxdg) = (cco @ (ccfv @ XG @ ccvtx) @ (ccfv @ XG @ cciedg) @ ccvtxdg)))))).
thf(aoveq2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))).
thf(afveq2i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))).
thf(cfinsumvtxdg2size_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xv:$i] : ((XI @ Xv) = (ccfv @ XG @ cciedg))) => ((! [Xv:$i] : ((XD @ Xv) = (ccfv @ XG @ ccvtxdg))) => (! [Xv:$i] : ((cw3a @ (cwcel @ XG @ ccupgr) @ (cwcel @ XV @ ccfn) @ (cwcel @ (XI @ Xv) @ ccfn)) => ((ccsu @ XV @ (^ [Xv:$i] : (ccfv @ (ccv @ Xv) @ (XD @ Xv)))) = (cco @ cc2 @ (ccfv @ (XI @ Xv) @ cchash) @ ccmul)))))))))))).
