...
thf(aacosval_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((ccfv @ XA2 @ ccacos) = (cco @ (cco @ ccpi @ cc2 @ ccdiv) @ (ccfv @ XA2 @ ccasin) @ ccmin))))).
...
thf(aasinbnd_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwcel @ (ccfv @ (ccfv @ XA2 @ ccasin) @ ccre) @ (cco @ (ccneg @ (cco @ ccpi @ cc2 @ ccdiv)) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccicc))))).
...
thf(apidiv2halves_ax,axiom,((cco @ (cco @ ccpi @ cc2 @ ccdiv) @ (cco @ ccpi @ cc2 @ ccdiv) @ ccaddc) = ccpi)).
thf(asimp2d_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (cw3a @ Xps @ Xch @ Xth)) => (Xph => Xch))))))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(a_0re_ax,axiom,(cwcel @ ccc0 @ ccr)).
thf(cacosbnd_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwcel @ (ccfv @ (ccfv @ XA2 @ ccacos) @ ccre) @ (cco @ ccc0 @ ccpi @ ccicc))))).
