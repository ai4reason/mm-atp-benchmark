...
thf(alhp2atnle_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((cw3a @ (cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) @ (cwne @ XU @ XV)) @ ((cwcel @ XU @ XA2) & (cwbr @ XU @ XW @ Xc_le)) @ ((cwcel @ XV @ XA2) & (cwbr @ XV @ XW @ Xc_le))) => (~ (cwbr @ XV @ (cco @ XP @ XU @ Xc_or) @ Xc_le))))))))))))))))).
...
thf(clhp2atne_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((cw3a @ (cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ ((cwcel @ XP @ XA2) & (~ (cwbr @ XP @ XW @ Xc_le))) @ (cwcel @ XQ @ XA2)) @ (((cwcel @ XU @ XA2) & (cwbr @ XU @ XW @ Xc_le)) & ((cwcel @ XV @ XA2) & (cwbr @ XV @ XW @ Xc_le))) @ (cwne @ XU @ XV)) => (cwne @ (cco @ XP @ XU @ Xc_or) @ (cco @ XQ @ XV @ Xc_or)))))))))))))))))).
