...
thf(arprene0d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => (Xph => ((cwcel @ XA2 @ ccr) & (cwne @ XA2 @ ccc0))))))).
...
thf(asinccvg_ax,axiom,(! [XF:($i > $o)] : (((cwf @ ccn @ (ccdif @ ccr @ (ccsn @ ccc0)) @ XF) & (cwbr @ XF @ ccc0 @ ccli)) => (cwbr @ (cccom @ (ccmpt @ (^ [Xx3:$i] : (ccdif @ ccr @ (ccsn @ ccc0))) @ (^ [Xx3:$i] : (cco @ (ccfv @ (ccv @ Xx3) @ ccsin) @ (ccv @ Xx3) @ ccdiv))) @ XF) @ cc1 @ ccli)))).
