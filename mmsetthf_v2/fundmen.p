...
thf(aelreldm_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwrel @ XA2) & (cwcel @ XB2 @ XA2)) => (cwcel @ (ccint @ (ccint @ XB2)) @ (ccdm @ XA2)))))).
...
thf(cfundmen_conj,conjecture,(! [XF:($i > $o)] : ((cwcel @ XF @ ccvv) => ((cwfun @ XF) => (cwbr @ (ccdm @ XF) @ XF @ ccen))))).
