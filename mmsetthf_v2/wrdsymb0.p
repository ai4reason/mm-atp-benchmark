...
thf(anelfzo_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XK @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XN @ ccz)) => ((cwnel @ XK @ (cco @ XM @ XN @ ccfzo)) <=> ((cwbr @ XK @ XM @ cclt) | (cwbr @ XN @ XK @ ccle)))))))).
...
thf(cwrdsymb0_conj,conjecture,(! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XI @ ccz)) => (((cwbr @ XI @ ccc0 @ cclt) | (cwbr @ (ccfv @ XW @ cchash) @ XI @ ccle)) => ((ccfv @ XI @ XW) = cc0))))))).
