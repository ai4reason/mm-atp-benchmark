...
thf(cresunimafz0_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwfun @ XI)) => ((Xph => (cwf @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XI) @ XF)) => ((Xph => (cwcel @ XN @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo))) => (Xph => ((ccres @ XI @ (ccima @ XF @ (cco @ ccc0 @ XN @ ccfz))) = (ccun @ (ccres @ XI @ (ccima @ XF @ (cco @ ccc0 @ XN @ ccfzo))) @ (ccsn @ (ccop @ (ccfv @ XN @ XF) @ (ccfv @ (ccfv @ XN @ XF) @ XI)))))))))))))).
