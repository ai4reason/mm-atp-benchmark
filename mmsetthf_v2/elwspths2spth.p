...
thf(aelwspths2on_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cw3a @ (cwcel @ XG @ ccupgr) @ (cwcel @ XA2 @ XV) @ (cwcel @ XC @ XV)) => ((cwcel @ XW @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwspthsnon))) <=> (cwrex @ (^ [Xb:$i] : ((XW = (ccs3 @ XA2 @ (ccv @ Xb) @ XC)) & (cwcel @ (ccs3 @ XA2 @ (ccv @ Xb) @ XC) @ (cco @ XA2 @ XC @ (cco @ cc2 @ XG @ ccwwspthsnon))))) @ (^ [Xb:$i] : XV))))))))))).
...
thf(celwspths2spth_conj,conjecture,(! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XG @ ccupgr) => ((cwcel @ XW @ (cco @ cc2 @ XG @ ccwwspthsn)) <=> (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : ((XW = (ccs3 @ (ccv @ Xa) @ (ccv @ Xb) @ (ccv @ Xc))) & (? [Xf1:$i] : (? [Xp:$i] : (cw3a @ (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (ccfv @ XG @ ccspths)) @ ((ccfv @ (ccv @ Xf1) @ cchash) = cc2) @ (cw3a @ ((ccv @ Xa) = (ccfv @ ccc0 @ (ccv @ Xp))) @ ((ccv @ Xb) = (ccfv @ cc1 @ (ccv @ Xp))) @ ((ccv @ Xc) = (ccfv @ cc2 @ (ccv @ Xp))))))))) @ (^ [Xc:$i] : XV))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))))).
