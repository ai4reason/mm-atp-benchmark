...
thf(celioc1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioc)) <=> (cw3a @ (cwcel @ XC @ ccxr) @ (cwbr @ XA2 @ XC @ cclt) @ (cwbr @ XC @ XB2 @ ccle)))))))).
