...
thf(apsgnghm_ax,axiom,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XS = (ccfv @ XD @ ccsymg)) => ((XN = (ccfv @ XD @ ccpsgn)) => ((XF = (cco @ XS @ (ccdm @ XN) @ ccress)) => ((XU = (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccpr @ cc1 @ (ccneg @ cc1)) @ ccress)) => ((cwcel @ XD @ XV) => (cwcel @ XN @ (cco @ XF @ XU @ ccghm)))))))))))))).
...
thf(cevpmss_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : ((XS = (ccfv @ XD @ ccsymg)) => ((XP = (ccfv @ XS @ ccbs)) => (cwss @ (ccfv @ XD @ ccevpm) @ XP))))))).
