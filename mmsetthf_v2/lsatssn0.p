...
thf(clsatssn0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XA2 = (ccfv @ XW @ cclsa)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XQ @ XA2)) => ((Xph => (cwss @ XQ @ XU)) => (Xph => (cwne @ XU @ (ccsn @ Xc_0))))))))))))))).
