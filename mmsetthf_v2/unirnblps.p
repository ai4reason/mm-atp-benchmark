...
thf(ablfps_ax,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) => (cwf @ (ccxp @ XX @ ccxr) @ (ccpw @ XX) @ (ccfv @ XD @ ccbl)))))).
...
thf(cunirnblps_conj,conjecture,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ (ccfv @ XX @ ccpsmet)) => ((ccuni @ (ccrn @ (ccfv @ XD @ ccbl))) = XX))))).
