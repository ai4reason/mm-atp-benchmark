...
thf(ccn1lem_conj,conjecture,(! [Xx3:$i] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xz:$i] : (cwf @ ccc @ ccc @ (XF @ Xz))) => ((! [Xz:$i] : (((cwcel @ (ccv @ Xz) @ ccc) & (cwcel @ XA2 @ ccc)) => (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xz) @ (XF @ Xz)) @ (ccfv @ XA2 @ (XF @ Xz)) @ ccmin) @ ccabs) @ (ccfv @ (cco @ (ccv @ Xz) @ XA2 @ ccmin) @ ccabs) @ ccle))) => (((cwcel @ XA2 @ ccc) & (cwcel @ (ccv @ Xx3) @ ccrp)) => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : ((cwbr @ (ccfv @ (cco @ (ccv @ Xz) @ XA2 @ ccmin) @ ccabs) @ (ccv @ Xy1) @ cclt) => (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xz) @ (XF @ Xz)) @ (ccfv @ XA2 @ (XF @ Xz)) @ ccmin) @ ccabs) @ (ccv @ Xx3) @ cclt))) @ (^ [Xz:$i] : ccc))) @ (^ [Xy1:$i] : ccrp))))))))).
