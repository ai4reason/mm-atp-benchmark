...
thf(abitsp1_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XM @ ccn0)) => ((cwcel @ (cco @ XM @ cc1 @ ccaddc) @ (ccfv @ XN @ ccbits)) <=> (cwcel @ XM @ (ccfv @ (ccfv @ (cco @ XN @ cc2 @ ccdiv) @ ccfl) @ ccbits))))))).
...
thf(cbitsp1e_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XM @ ccn0)) => ((cwcel @ (cco @ XM @ cc1 @ ccaddc) @ (ccfv @ (cco @ cc2 @ XN @ ccmul) @ ccbits)) <=> (cwcel @ XM @ (ccfv @ XN @ ccbits))))))).
