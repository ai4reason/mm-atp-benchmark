...
thf(arelogbcxp_ax,axiom,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XB2 @ (ccdif @ ccrp @ (ccsn @ cc1))) & (cwcel @ XX @ ccr)) => ((cco @ XB2 @ (cco @ XB2 @ XX @ cccxp) @ cclogb) = XX))))).
thf(crelogbcxpb_conj,conjecture,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ ((cwcel @ XB2 @ ccrp) & (cwne @ XB2 @ cc1)) @ (cwcel @ XX @ ccrp) @ (cwcel @ XY @ ccr)) => (((cco @ XB2 @ XX @ cclogb) = XY) <=> ((cco @ XB2 @ XY @ cccxp) = XX))))))).
