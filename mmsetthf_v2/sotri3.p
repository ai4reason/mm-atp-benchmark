...
thf(csotri3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((cwor @ XS @ XR) => ((cwss @ XR @ (ccxp @ XS @ XS)) => ((cw3a @ (cwcel @ XC @ XS) @ (cwbr @ XA2 @ XB2 @ XR) @ (~ (cwbr @ XC @ XB2 @ XR))) => (cwbr @ XA2 @ XC @ XR)))))))))).
