...
thf(aresvid2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XR = (cco @ XW @ XA2 @ ccresv)) => ((XF = (ccfv @ XW @ ccsca)) => ((XB2 = (ccfv @ XF @ ccbs)) => ((cw3a @ (cwss @ XB2 @ XA2) @ (cwcel @ XW @ XX) @ (cwcel @ XA2 @ XY)) => (XR = XW))))))))))))).
thf(ccv_tp,type,(ccv : ($i > ($i > $o)))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(asyl6eqr_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((XC = XB2) => (Xph => (XA2 = XC))))))))).
thf(aresvval2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XR = (cco @ XW @ XA2 @ ccresv)) => ((XF = (ccfv @ XW @ ccsca)) => ((XB2 = (ccfv @ XF @ ccbs)) => ((cw3a @ (~ (cwss @ XB2 @ XA2)) @ (cwcel @ XW @ XX) @ (cwcel @ XA2 @ XY)) => (XR = (cco @ XW @ (ccop @ (ccfv @ ccnx @ ccsca) @ (cco @ XF @ XA2 @ ccress)) @ ccsts)))))))))))))).
...
thf(areldmresv_ax,axiom,(cwrel @ (ccdm @ ccresv))).
...
thf(cresvlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XR = (cco @ XW @ XA2 @ ccresv)) => ((XC = (ccfv @ XW @ XE)) => ((XE = (ccslot @ XN)) => ((cwcel @ XN @ ccn) => ((cwne @ XN @ cc5) => ((cwcel @ XA2 @ XV) => (XC = (ccfv @ XR @ XE)))))))))))))))).
