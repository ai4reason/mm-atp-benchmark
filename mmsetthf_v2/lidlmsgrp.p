...
thf(alidlmmgm_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((XL = (ccfv @ XR @ cclidl)) => ((XI = (cco @ XR @ XU @ ccress)) => (((cwcel @ XR @ ccrg) & (cwcel @ XU @ XL)) => (cwcel @ (ccfv @ XI @ ccmgp) @ ccmgm))))))))).
...
thf(clidlmsgrp_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((XL = (ccfv @ XR @ cclidl)) => ((XI = (cco @ XR @ XU @ ccress)) => (((cwcel @ XR @ ccrg) & (cwcel @ XU @ XL)) => (cwcel @ (ccfv @ XI @ ccmgp) @ ccsgrp))))))))).
