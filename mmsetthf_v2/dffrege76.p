...
thf(abrtrclfv2_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XX @ XU) @ (cwcel @ XY @ XV) @ (cwcel @ XR @ XW)) => ((cwbr @ XX @ XY @ (ccfv @ XR @ cctcl)) <=> (cwcel @ XY @ (ccint @ (ccab @ (^ [Xf1:$i] : (cwss @ (ccima @ XR @ (ccun @ (ccsn @ XX) @ (ccv @ Xf1))) @ (ccv @ Xf1))))))))))))))).
...
thf(cdffrege76_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xa:$i] : (cwcel @ XB2 @ (XU @ Xa))) => ((! [Xa:$i] : (cwcel @ (XE @ Xa) @ (XV @ Xa))) => ((! [Xa:$i] : (cwcel @ XR @ (XW @ Xa))) => (! [Xa:$i] : ((! [Xf1:$i] : ((cwhe @ (ccv @ Xf1) @ XR) => ((! [Xa:$i] : ((cwbr @ XB2 @ (ccv @ Xa) @ XR) => (cwcel @ (ccv @ Xa) @ (ccv @ Xf1)))) => (cwcel @ (XE @ Xa) @ (ccv @ Xf1))))) <=> (cwbr @ XB2 @ (XE @ Xa) @ (ccfv @ XR @ cctcl)))))))))))))).
