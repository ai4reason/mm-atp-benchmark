...
thf(adihglblem2aN_ax,axiom,(! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : ((! [Xv:$i] : (! [Xu:$i] : ((XB2 @ Xv) = (ccfv @ (XK @ Xv @ Xu) @ ccbs)))) => ((! [Xv:$i] : (! [Xu:$i] : ((Xc_le @ Xv @ Xu) = (ccfv @ (XK @ Xv @ Xu) @ ccple)))) => ((! [Xv:$i] : (! [Xu:$i] : (Xc_an = (ccfv @ (XK @ Xv @ Xu) @ ccmee)))) => ((! [Xv:$i] : (! [Xu:$i] : ((XG @ Xv @ Xu) = (ccfv @ (XK @ Xv @ Xu) @ ccglb)))) => ((! [Xv:$i] : (! [Xu:$i] : ((XH @ Xv @ Xu) = (ccfv @ (XK @ Xv @ Xu) @ cclh)))) => ((! [Xv:$i] : (! [Xu:$i] : ((XT @ Xv @ Xu) = (ccrab @ (^ [Xu:$i] : (cwrex @ (^ [Xv:$i] : ((ccv @ Xu) = (cco @ (ccv @ Xv) @ XW @ Xc_an))) @ (^ [Xv:$i] : XS))) @ (^ [Xu:$i] : (XB2 @ Xv)))))) => (! [Xv:$i] : (! [Xu:$i] : ((((cwcel @ (XK @ Xv @ Xu) @ cchlt) & (cwcel @ XW @ (XH @ Xv @ Xu))) & ((cwss @ XS @ (XB2 @ Xv)) & (cwne @ XS @ cc0))) => (cwne @ (XT @ Xv @ Xu) @ cc0)))))))))))))))))))).
...
thf(adihglblem2N_ax,axiom,(! [XB2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : ((! [Xv:$i] : (! [Xu:$i] : ((XB2 @ Xv) = (ccfv @ (XK @ Xv @ Xu) @ ccbs)))) => ((! [Xv:$i] : (! [Xu:$i] : ((Xc_le @ Xv @ Xu) = (ccfv @ (XK @ Xv @ Xu) @ ccple)))) => ((! [Xv:$i] : (! [Xu:$i] : (Xc_an = (ccfv @ (XK @ Xv @ Xu) @ ccmee)))) => ((! [Xv:$i] : (! [Xu:$i] : ((XG @ Xv @ Xu) = (ccfv @ (XK @ Xv @ Xu) @ ccglb)))) => ((! [Xv:$i] : (! [Xu:$i] : ((XH @ Xv @ Xu) = (ccfv @ (XK @ Xv @ Xu) @ cclh)))) => ((! [Xv:$i] : (! [Xu:$i] : ((XT @ Xv @ Xu) = (ccrab @ (^ [Xu:$i] : (cwrex @ (^ [Xv:$i] : ((ccv @ Xu) = (cco @ (ccv @ Xv) @ XW @ Xc_an))) @ (^ [Xv:$i] : XS))) @ (^ [Xu:$i] : (XB2 @ Xv)))))) => (! [Xv:$i] : (! [Xu:$i] : ((cw3a @ ((cwcel @ (XK @ Xv @ Xu) @ cchlt) & (cwcel @ XW @ (XH @ Xv @ Xu))) @ (cwss @ XS @ (XB2 @ Xv)) @ (cwbr @ (ccfv @ XS @ (XG @ Xv @ Xu)) @ XW @ (Xc_le @ Xv @ Xu))) => ((ccfv @ XS @ (XG @ Xv @ Xu)) = (ccfv @ (XT @ Xv @ Xu) @ (XG @ Xv @ Xu)))))))))))))))))))))).
...
thf(cdihglblem3N_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XJ:($i > ($i > ($i > ($i > $o))))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XG = (ccfv @ XK @ ccglb)) => ((XH = (ccfv @ XK @ cclh)) => ((! [Xv:$i] : (! [Xu:$i] : ((XT @ Xv @ Xu) = (ccrab @ (^ [Xu:$i] : (cwrex @ (^ [Xv:$i] : ((ccv @ Xu) = (cco @ (ccv @ Xv) @ XW @ Xc_an))) @ (^ [Xv:$i] : XS))) @ (^ [Xu:$i] : XB2))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : ((XJ @ Xx3 @ Xv @ Xu) = (ccfv @ XW @ (ccfv @ XK @ ccdib)))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : ((XI @ Xx3 @ Xv @ Xu) = (ccfv @ XW @ (ccfv @ XK @ ccdih)))))) => (! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ ((cwss @ XS @ XB2) & (cwne @ XS @ cc0)) @ (cwbr @ (ccfv @ XS @ XG) @ XW @ Xc_le)) => ((ccfv @ (ccfv @ (XT @ Xv @ Xu) @ XG) @ (XI @ Xx3 @ Xv @ Xu)) = (cciin @ (^ [Xx3:$i] : (XT @ Xv @ Xu)) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (XI @ Xx3 @ Xv @ Xu))))))))))))))))))))))))))))).
