...
thf(assnnssfz_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccin @ (ccpw @ ccn) @ ccfn)) => (cwrex @ (^ [Xn:$i] : (cwss @ XA2 @ (cco @ cc1 @ (ccv @ Xn) @ ccfz))) @ (^ [Xn:$i] : ccn))))).
...
thf(cesumfsup_conj,conjecture,(! [XF:($i > ($i > $o))] : ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => (! [Xk:$i] : ((cwf @ ccn @ (cco @ ccc0 @ ccpnf @ ccicc) @ (XF @ Xk)) => ((ccesum @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xk)))) = (ccsup @ (ccrn @ (ccseq @ ccxad @ (XF @ Xk) @ cc1)) @ ccxr @ cclt))))))).
