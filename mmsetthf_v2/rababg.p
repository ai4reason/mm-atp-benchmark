...
thf(aancrb_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph => Xps) <=> (Xph => (Xps & Xph)))))).
...
thf(crababg_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3)))) <=> ((ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) = (ccab @ (^ [Xx3:$i] : (Xph @ Xx3)))))))).
