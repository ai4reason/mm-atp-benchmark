...
thf(apjhthmo_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccsh) @ (cwcel @ XB2 @ ccsh) @ ((ccin @ XA2 @ XB2) = cc0h)) => (cwmo @ (^ [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) & (cwrex @ (^ [Xy1:$i] : (XC = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccva))) @ (^ [Xy1:$i] : XB2)))))))))).
...
thf(cpjhtheu_conj,conjecture,(! [XA2:($i > $o)] : (! [XH:($i > $o)] : (((cwcel @ XH @ ccch) & (cwcel @ XA2 @ cchil)) => (cwreu @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (XA2 = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccva))) @ (^ [Xy1:$i] : (ccfv @ XH @ ccort)))) @ (^ [Xx3:$i] : XH)))))).
