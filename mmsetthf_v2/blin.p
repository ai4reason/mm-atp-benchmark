...
thf(cblin_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwcel @ XP @ XX)) & ((cwcel @ XR @ ccxr) & (cwcel @ XS @ ccxr))) => ((ccin @ (cco @ XP @ XR @ (ccfv @ XD @ ccbl)) @ (cco @ XP @ XS @ (ccfv @ XD @ ccbl))) = (cco @ XP @ (ccif @ (cwbr @ XR @ XS @ ccle) @ XR @ XS) @ (ccfv @ XD @ ccbl)))))))))).
