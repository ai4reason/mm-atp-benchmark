...
thf(clcdlssvscl_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XF = (ccfv @ XU @ ccsca)) => ((XR = (ccfv @ XF @ ccbs)) => ((XC = (ccfv @ XW @ (ccfv @ XK @ cclcd))) => ((XV = (ccfv @ XC @ ccbs)) => ((Xc_x = (ccfv @ XC @ ccvsca)) => ((XS = (ccfv @ XC @ cclss)) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XL @ XS)) => ((Xph => (cwcel @ XX @ XR)) => ((Xph => (cwcel @ XY @ XL)) => (Xph => (cwcel @ (cco @ XX @ XY @ Xc_x) @ XL))))))))))))))))))))))))))))).
