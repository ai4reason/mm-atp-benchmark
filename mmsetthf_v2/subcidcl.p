...
thf(csubcidcl_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XC @ ccsubc))) => ((Xph => (cwfn @ XJ @ (ccxp @ XS @ XS))) => ((Xph => (cwcel @ XX @ XS)) => ((Xc_1 = (ccfv @ XC @ cccid)) => (Xph => (cwcel @ (ccfv @ XX @ Xc_1) @ (cco @ XX @ XX @ XJ)))))))))))))).
