...
thf(alfladd_ax,axiom,(! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XD = (ccfv @ XW @ ccsca)) => ((Xc_pd = (ccfv @ XD @ ccplusg)) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => ((XF = (ccfv @ XW @ cclfn)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XG @ XF) @ ((cwcel @ XX @ XV) & (cwcel @ XY @ XV))) => ((ccfv @ (cco @ XX @ XY @ Xc_pl) @ XG) = (cco @ (ccfv @ XX @ XG) @ (ccfv @ XY @ XG) @ Xc_pd)))))))))))))))))).
thf(chdmaplna1_conj,conjecture,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [Xc_pd:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((Xc_pl = (ccfv @ XU @ ccplusg)) => ((XR = (ccfv @ XU @ ccsca)) => ((Xc_pd = (ccfv @ XR @ ccplusg)) => ((XS = (ccfv @ XW @ (ccfv @ XK @ cchdma))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwcel @ XY @ XV)) => ((Xph => (cwcel @ XZ @ XV)) => (Xph => ((ccfv @ (cco @ XX @ XY @ Xc_pl) @ (ccfv @ XZ @ XS)) = (cco @ (ccfv @ XX @ (ccfv @ XZ @ XS)) @ (ccfv @ XY @ (ccfv @ XZ @ XS)) @ Xc_pd)))))))))))))))))))))))))))).
