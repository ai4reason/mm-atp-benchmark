...
thf(anndiv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XB2 @ ccn)) => ((cwrex @ (^ [Xx3:$i] : ((cco @ XA2 @ (ccv @ Xx3) @ ccmul) = XB2)) @ (^ [Xx3:$i] : ccn)) <=> (cwcel @ (cco @ XB2 @ XA2 @ ccdiv) @ ccn)))))).
...
thf(cnndivides_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn) & (cwcel @ XN @ ccn)) => ((cwbr @ XM @ XN @ ccdvds) <=> (cwrex @ (^ [Xn:$i] : ((cco @ (ccv @ Xn) @ XM @ ccmul) = XN)) @ (^ [Xn:$i] : ccn))))))).
