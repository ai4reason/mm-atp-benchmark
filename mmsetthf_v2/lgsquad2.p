...
thf(algsquad_ax,axiom,(! [XP:($i > $o)] : (! [XQ:($i > $o)] : ((cw3a @ (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (cwcel @ XQ @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (cwne @ XP @ XQ)) => ((cco @ (cco @ XP @ XQ @ cclgs) @ (cco @ XQ @ XP @ cclgs) @ ccmul) = (cco @ (ccneg @ cc1) @ (cco @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (cco @ (cco @ XQ @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccmul) @ ccexp)))))).
...
thf(clgsquad2_conj,conjecture,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (~ (cwbr @ cc2 @ XM @ ccdvds))) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (~ (cwbr @ cc2 @ XN @ ccdvds))) => ((Xph => ((cco @ XM @ XN @ ccgcd) = cc1)) => (Xph => ((cco @ (cco @ XM @ XN @ cclgs) @ (cco @ XN @ XM @ cclgs) @ ccmul) = (cco @ (ccneg @ cc1) @ (cco @ (cco @ (cco @ XM @ cc1 @ ccmin) @ cc2 @ ccdiv) @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccmul) @ ccexp)))))))))))).
