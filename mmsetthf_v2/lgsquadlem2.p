...
thf(algseisen_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((Xph => (cwcel @ XQ @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((Xph => (cwne @ XP @ XQ)) => (Xph => ((cco @ XQ @ XP @ cclgs) = (cco @ (ccneg @ cc1) @ (ccsu @ (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz) @ (^ [Xx3:$i] : (ccfv @ (cco @ (cco @ XQ @ XP @ ccdiv) @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul) @ ccmul) @ ccfl))) @ ccexp)))))))))).
