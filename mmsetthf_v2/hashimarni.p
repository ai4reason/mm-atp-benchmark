...
thf(ahashimarn_ax,axiom,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwf1 @ (ccdm @ XE) @ (ccrn @ XE) @ XE) & (cwcel @ XE @ XV)) => ((cwf1 @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XE) @ XF) => ((ccfv @ (ccima @ XE @ (ccrn @ XF)) @ cchash) = (ccfv @ XF @ cchash)))))))).
thf(aid_ax,axiom,(! [Xph:$o] : (Xph => Xph))).
thf(chashimarni_conj,conjecture,(! [XP:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (((cwf1 @ (ccdm @ XE) @ (ccrn @ XE) @ XE) & (cwcel @ XE @ XV)) => ((cw3a @ (cwf1 @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XE) @ XF) @ (XP = (ccima @ XE @ (ccrn @ XF))) @ ((ccfv @ XP @ cchash) = XN)) => ((ccfv @ XF @ cchash) = XN))))))))).
