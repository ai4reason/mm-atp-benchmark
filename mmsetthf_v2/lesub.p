...
thf(clesub_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) => ((cwbr @ XA2 @ (cco @ XB2 @ XC @ ccmin) @ ccle) <=> (cwbr @ XC @ (cco @ XB2 @ XA2 @ ccmin) @ ccle))))))).
