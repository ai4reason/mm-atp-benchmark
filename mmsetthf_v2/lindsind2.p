...
thf(alinds2_ax,axiom,(! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ (ccfv @ XW @ cclinds)) => (cwbr @ (ccres @ ccid @ XX) @ XW @ cclindf))))).
...
thf(clindsind2_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XW:($i > $o)] : ((XK = (ccfv @ XW @ cclspn)) => ((XL = (ccfv @ XW @ ccsca)) => ((cw3a @ ((cwcel @ XW @ cclmod) & (cwcel @ XL @ ccnzr)) @ (cwcel @ XF @ (ccfv @ XW @ cclinds)) @ (cwcel @ XE @ XF)) => (~ (cwcel @ XE @ (ccfv @ (ccdif @ XF @ (ccsn @ XE)) @ XK)))))))))))).
