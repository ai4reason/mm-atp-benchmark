...
thf(creff_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwbr @ XA2 @ XB2 @ ccref) <=> ((cwss @ (ccuni @ XB2) @ (ccuni @ XA2)) & (? [Xf1:$i] : ((cwf @ XA2 @ XB2 @ (ccv @ Xf1)) & (cwral @ (^ [Xv:$i] : (cwss @ (ccv @ Xv) @ (ccfv @ (ccv @ Xv) @ (ccv @ Xf1)))) @ (^ [Xv:$i] : XA2))))))))))).
