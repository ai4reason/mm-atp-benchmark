...
thf(adivlt1lt_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccrp)) => ((cwbr @ (cco @ XA2 @ XB2 @ ccdiv) @ cc1 @ cclt) <=> (cwbr @ XA2 @ XB2 @ cclt)))))).
...
thf(cflodddiv4_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (XN = (cco @ (cco @ cc2 @ XM @ ccmul) @ cc1 @ ccaddc))) => ((ccfv @ (cco @ XN @ cc4 @ ccdiv) @ ccfl) = (ccif @ (cwbr @ cc2 @ XM @ ccdvds) @ (cco @ XM @ cc2 @ ccdiv) @ (cco @ (cco @ XM @ cc1 @ ccmin) @ cc2 @ ccdiv))))))).
