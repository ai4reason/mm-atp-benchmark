...
thf(arpgtrecnn_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => (cwrex @ (^ [Xn:$i] : (cwbr @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv) @ XA2 @ cclt)) @ (^ [Xn:$i] : ccn))))).
