...
thf(agamcvg2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xm:$i] : ((XF @ Xm) = (ccmpt @ (^ [Xm:$i] : ccn) @ (^ [Xm:$i] : (cco @ (cco @ (cco @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc) @ (ccv @ Xm) @ ccdiv) @ XA2 @ cccxp) @ (cco @ (cco @ XA2 @ (ccv @ Xm) @ ccdiv) @ cc1 @ ccaddc) @ ccdiv))))) => ((Xph => (cwcel @ XA2 @ (ccdif @ ccc @ (ccdif @ ccz @ ccn)))) => (! [Xm:$i] : (Xph => (cwbr @ (ccseq @ ccmul @ (XF @ Xm) @ cc1) @ (cco @ (ccfv @ XA2 @ ccgam) @ XA2 @ ccmul) @ ccli))))))))).
...
thf(cregamcl_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccdif @ ccr @ (ccdif @ ccz @ ccn))) => (cwcel @ (ccfv @ XA2 @ ccgam) @ ccr)))).
