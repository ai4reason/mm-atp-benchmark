...
thf(chial2eq2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => ((cwral @ (^ [Xx3:$i] : ((cco @ (ccv @ Xx3) @ XA2 @ ccsp) = (cco @ (ccv @ Xx3) @ XB2 @ ccsp))) @ (^ [Xx3:$i] : cchil)) <=> (XA2 = XB2)))))).
