...
thf(aifpr_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (((cwcel @ XA2 @ XC) & (cwcel @ XB2 @ XD)) => (cwcel @ (ccif @ Xph @ XA2 @ XB2) @ (ccpr @ XA2 @ XB2))))))))).
...
thf(csuppr_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((cw3a @ (cwor @ XA2 @ XR) @ (cwcel @ XB2 @ XA2) @ (cwcel @ XC @ XA2)) => ((ccsup @ (ccpr @ XB2 @ XC) @ XA2 @ XR) = (ccif @ (cwbr @ XC @ XB2 @ XR) @ XB2 @ XC)))))))).
