...
thf(asymgmatr01lem_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : ((! [Xq:$i] : (XP = (ccfv @ (ccfv @ (XN @ Xq) @ ccsymg) @ ccbs))) => (! [Xq:$i] : (((cwcel @ XK @ (XN @ Xq)) & (cwcel @ XL @ (XN @ Xq))) => ((cwcel @ XQ @ (ccdif @ XP @ (ccrab @ (^ [Xq:$i] : ((ccfv @ XK @ (ccv @ Xq)) = XL)) @ (^ [Xq:$i] : XP)))) => (cwrex @ (^ [Xk:$i] : ((ccif @ ((ccv @ Xk) = XK) @ (ccif @ ((ccfv @ (ccv @ Xk) @ XQ) = XL) @ (XA2 @ Xq) @ (XB2 @ Xq)) @ (cco @ (ccv @ Xk) @ (ccfv @ (ccv @ Xk) @ XQ) @ (XM @ Xq))) = (XB2 @ Xq))) @ (^ [Xk:$i] : (XN @ Xq)))))))))))))))).
