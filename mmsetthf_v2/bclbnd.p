...
thf(abcp1ctr_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => ((cco @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccmul) @ (cco @ XN @ cc1 @ ccaddc) @ ccbc) = (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ (cco @ cc2 @ (cco @ (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc) @ (cco @ XN @ cc1 @ ccaddc) @ ccdiv) @ ccmul) @ ccmul))))).
...
thf(adivmul24d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XD @ ccc)) => ((Xph => (cwne @ XB2 @ ccc0)) => ((Xph => (cwne @ XD @ ccc0)) => (Xph => ((cco @ (cco @ XA2 @ XB2 @ ccdiv) @ (cco @ XC @ XD @ ccdiv) @ ccmul) = (cco @ (cco @ XA2 @ XD @ ccdiv) @ (cco @ XC @ XB2 @ ccdiv) @ ccmul))))))))))))))).
...
thf(cbclbnd_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ cc4 @ ccuz)) => (cwbr @ (cco @ (cco @ cc4 @ XN @ ccexp) @ XN @ ccdiv) @ (cco @ (cco @ cc2 @ XN @ ccmul) @ XN @ ccbc) @ cclt)))).
