...
thf(abriunov2uz_ax,axiom,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [Xc_ex:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((XC = (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (cciun @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xn) @ Xc_ex)))))) => (! [Xn:$i] : (! [Xr:$i] : (((cwcel @ XR @ (XU @ Xn @ Xr)) & (XN = (ccfv @ (XM @ Xn @ Xr) @ ccuz))) => ((cwbr @ (XX @ Xr) @ (XY @ Xr) @ (ccfv @ XR @ XC)) <=> (cwrex @ (^ [Xn:$i] : (cwbr @ (XX @ Xr) @ (XY @ Xr) @ (cco @ XR @ (ccv @ Xn) @ Xc_ex))) @ (^ [Xn:$i] : XN)))))))))))))))).
...
thf(ciunrelexpuztr_conj,conjecture,(! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((XC = (ccmpt @ (^ [Xr:$i] : ccvv) @ (^ [Xr:$i] : (cciun @ (^ [Xn:$i] : XN) @ (^ [Xn:$i] : (cco @ (ccv @ Xr) @ (ccv @ Xn) @ ccrelexp)))))) => (! [Xr:$i] : ((cw3a @ (cwcel @ XR @ (XV @ Xr)) @ (XN = (ccfv @ (XM @ Xr) @ ccuz)) @ (cwcel @ (XM @ Xr) @ ccn0)) => (cwss @ (cccom @ (ccfv @ XR @ XC) @ (ccfv @ XR @ XC)) @ (ccfv @ XR @ XC))))))))))).
