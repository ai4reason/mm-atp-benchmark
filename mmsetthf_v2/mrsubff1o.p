...
thf(cmrsubff1o_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XT @ ccmvar)) => ((XR = (ccfv @ XT @ ccmrex)) => ((XS = (ccfv @ XT @ ccmrsub)) => ((cwcel @ XT @ XW) => (cwf1o @ (cco @ XR @ XV @ ccmap) @ (ccrn @ XS) @ (ccres @ XS @ (cco @ XR @ XV @ ccmap))))))))))))).
