...
thf(ameadjuni_ax,axiom,(! [Xph:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XM @ Xx3) @ ccmea))) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccdm @ (XM @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XX @ (XS @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwbr @ XX @ ccom @ ccdom))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwdisj @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccv @ Xx3))))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccfv @ (ccuni @ XX) @ (XM @ Xx3)) = (ccfv @ (ccres @ (XM @ Xx3) @ XX) @ ccsumge0)))))))))))))).
...
thf(a_1stcrestlem_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((cwbr @ XB2 @ ccom @ ccdom) => (cwbr @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3)))) @ ccom @ ccdom))))).
thf(ccin_tp,type,(ccin : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(adisjrnmpt2_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xy1)) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1)))))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwdisj @ (^ [Xx3:$i] : (XA2 @ Xy1)) @ (^ [Xx3:$i] : (XB2 @ Xx3 @ Xy1))) => (cwdisj @ (^ [Xy1:$i] : (ccrn @ (XF @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xy1))))))))))).
