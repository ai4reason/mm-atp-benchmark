...
thf(akgencmp_ax,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XJ @ cctop) & (cwcel @ (cco @ XJ @ XK @ ccrest) @ cccmp)) => ((cco @ XJ @ XK @ ccrest) = (cco @ (ccfv @ XJ @ cckgen) @ XK @ ccrest)))))).
...
thf(arestrcl_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : ((cwcel @ (cco @ XJ @ XA2 @ ccrest) @ cctop) => ((cwcel @ XJ @ ccvv) & (cwcel @ XA2 @ ccvv)))))).
...
thf(arestuni2_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwcel @ XA2 @ XV)) => ((ccin @ XA2 @ XX) = (ccuni @ (cco @ XJ @ XA2 @ ccrest)))))))))).
thf(asyl2an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xps) => ((Xta => Xch) => (((Xps & Xch) => Xth) => ((Xph & Xta) => Xth)))))))))).
thf(akgenftop_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cctop) => (cwcel @ (ccfv @ XJ @ cckgen) @ cctop)))).
...
thf(asscmp_ax,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XK)) => ((cw3a @ (cwcel @ XJ @ (ccfv @ XX @ cctopon)) @ (cwcel @ XK @ cccmp) @ (cwss @ XJ @ XK)) => (cwcel @ XJ @ cccmp))))))).
