...
thf(apjrn_ax,axiom,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => ((ccrn @ (ccfv @ XH @ ccpjh)) = XH)))).
...
thf(ashorth_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccsh) => ((cwss @ XG @ (ccfv @ XH @ ccort)) => (((cwcel @ XA2 @ XG) & (cwcel @ XB2 @ XH)) => ((cco @ XA2 @ XB2 @ ccsp) = ccc0))))))))).
thf(cpjoi0_conj,conjecture,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (((cw3a @ (cwcel @ XG @ ccch) @ (cwcel @ XH @ ccch) @ (cwcel @ XA2 @ cchil)) & (cwss @ XG @ (ccfv @ XH @ ccort))) => ((cco @ (ccfv @ XA2 @ (ccfv @ XG @ ccpjh)) @ (ccfv @ XA2 @ (ccfv @ XH @ ccpjh)) @ ccsp) = ccc0)))))).
