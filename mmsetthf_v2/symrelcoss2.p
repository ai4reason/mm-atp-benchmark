...
thf(asymrelcoss3_ax,axiom,(! [XR:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : ((! [Xx3:$i] : (! [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ (cccoss @ (XR @ Xx3 @ Xy1))) => (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ (cccoss @ (XR @ Xx3 @ Xy1)))))) & (cwrel @ (cccoss @ (XR @ Xx3 @ Xy1)))))))).
