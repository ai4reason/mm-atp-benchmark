...
thf(afclsval_ax,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xt:$i] : ((XX @ Xt) = (ccuni @ XJ))) => (! [Xt:$i] : (((cwcel @ XJ @ cctop) & (cwcel @ XF @ (ccfv @ (XY @ Xt) @ ccfil))) => ((cco @ XJ @ XF @ ccfcls) = (ccif @ ((XX @ Xt) = (XY @ Xt)) @ (cciin @ (^ [Xt:$i] : XF) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ (ccfv @ XJ @ cccl)))) @ cc0)))))))))).
thf(aiftruei_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (Xph => ((ccif @ Xph @ XA2 @ XB2) = XA2)))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(adfiin3_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ ccvv)) => ((cciin @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3))) = (ccint @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (XA2 @ Xx3)) @ (^ [Xx3:$i] : (XB2 @ Xx3)))))))))).
...
thf(a_0nelfil_ax,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccfil)) => (~ (cwcel @ cc0 @ XF)))))).
thf(acmpfii_ax,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XJ @ cccmp) @ (cwss @ XX @ (ccfv @ XJ @ cccld)) @ (~ (cwcel @ cc0 @ (ccfv @ XX @ ccfi)))) => (cwne @ (ccint @ XX) @ cc0))))).
thf(cfclscmpi_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cccmp) & (cwcel @ XF @ (ccfv @ XX @ ccfil))) => (cwne @ (cco @ XJ @ XF @ ccfcls) @ cc0))))))).
