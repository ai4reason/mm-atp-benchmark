...
thf(amul02lem2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cco @ ccc0 @ XA2 @ ccmul) = ccc0)))).
thf(ai1f0_ax,axiom,(cwcel @ (ccxp @ ccr @ (ccsn @ ccc0)) @ (ccdm @ ccitg1))).
...
thf(ai1fmulclem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XF @ (ccdm @ ccitg1))) => ((Xph => (cwcel @ XA2 @ ccr)) => (((Xph & (cwne @ XA2 @ ccc0)) & (cwcel @ XB2 @ ccr)) => ((ccima @ (cccnv @ (cco @ (ccxp @ ccr @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul))) @ (ccsn @ XB2)) = (ccima @ (cccnv @ XF) @ (ccsn @ (cco @ XB2 @ XA2 @ ccdiv)))))))))))).
...
thf(ci1fmulc_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XF @ (ccdm @ ccitg1))) => ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => (cwcel @ (cco @ (ccxp @ ccr @ (ccsn @ XA2)) @ XF @ (ccof @ ccmul)) @ (ccdm @ ccitg1))))))))).
