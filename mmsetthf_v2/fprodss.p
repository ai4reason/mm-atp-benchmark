...
thf(aprodss_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XM:($i > $o)] : ((Xph => (cwss @ XA2 @ XB2)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XC @ Xk) @ ccc))) => ((Xph => (cwrex @ (^ [Xn:$i] : (? [Xy1:$i] : ((cwne @ (ccv @ Xy1) @ ccc0) & (cwbr @ (ccseq @ ccmul @ (ccmpt @ (^ [Xk:$i] : (ccfv @ XM @ ccuz)) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XB2) @ (XC @ Xk) @ cc1))) @ (ccv @ Xn)) @ (ccv @ Xy1) @ ccli)))) @ (^ [Xn:$i] : (ccfv @ XM @ ccuz)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (ccdif @ XB2 @ XA2))) => ((XC @ Xk) = cc1))) => ((Xph => (cwss @ XB2 @ (ccfv @ XM @ ccuz))) => (Xph => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))) = (ccprod @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (XC @ Xk)))))))))))))))).
...
thf(afprodntriv_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XN:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : (XZ = (ccfv @ (XM @ Xy1 @ Xk @ Xn) @ ccuz))))) => ((! [Xy1:$i] : (! [Xk:$i] : ((Xph @ Xy1 @ Xk) => (cwcel @ (XN @ Xk) @ XZ)))) => ((! [Xy1:$i] : (! [Xk:$i] : (! [Xn:$i] : ((Xph @ Xy1 @ Xk) => (cwss @ XA2 @ (cco @ (XM @ Xy1 @ Xk @ Xn) @ (XN @ Xk) @ ccfz)))))) => (! [Xy1:$i] : (! [Xk:$i] : ((Xph @ Xy1 @ Xk) => (cwrex @ (^ [Xn:$i] : (? [Xy1:$i] : ((cwne @ (ccv @ Xy1) @ ccc0) & (cwbr @ (ccseq @ ccmul @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (ccif @ (cwcel @ (ccv @ Xk) @ XA2) @ (XB2 @ Xk) @ cc1))) @ (ccv @ Xn)) @ (ccv @ Xy1) @ ccli)))) @ (^ [Xn:$i] : XZ))))))))))))))).
...
thf(afisuppfi_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => (Xph => (cwcel @ (ccima @ (cccnv @ XF) @ XC) @ ccfn)))))))))).
...
thf(aprodfc_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((ccprod @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (ccfv @ (ccv @ Xj) @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk)))))) = (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))))))).
...
thf(cfprodss_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : ((Xph => (cwss @ XA2 @ XB2)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XC @ Xk) @ ccc))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (ccdif @ XB2 @ XA2))) => ((XC @ Xk) = cc1))) => ((Xph => (cwcel @ XB2 @ ccfn)) => (Xph => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))) = (ccprod @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (XC @ Xk)))))))))))))).
