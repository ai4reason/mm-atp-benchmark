...
thf(armxdiophlem_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XN @ ccn0) @ (cwcel @ XX @ ccn0)) => ((XX = (cco @ XA2 @ XN @ ccrmx)) <=> (cwrex @ (^ [Xy1:$i] : (((ccv @ Xy1) = (cco @ XA2 @ XN @ ccrmy)) & ((cco @ (cco @ XX @ cc2 @ ccexp) @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccmul) @ ccmin) = cc1))) @ (^ [Xy1:$i] : ccn0)))))))).
...
thf(crmxdioph_conj,conjecture,(cwcel @ (ccrab @ (^ [Xa:$i] : ((cwcel @ (ccfv @ cc1 @ (ccv @ Xa)) @ (ccfv @ cc2 @ ccuz)) & ((ccfv @ cc3 @ (ccv @ Xa)) = (cco @ (ccfv @ cc1 @ (ccv @ Xa)) @ (ccfv @ cc2 @ (ccv @ Xa)) @ ccrmx)))) @ (^ [Xa:$i] : (cco @ ccn0 @ (cco @ cc1 @ cc3 @ ccfz) @ ccmap))) @ (ccfv @ cc3 @ ccdioph))).
