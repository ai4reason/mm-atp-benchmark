...
thf(cmat1comp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > ($i > $o)))] : (! [Xc_1:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xi:$i] : (! [Xj:$i] : (XB2 = (ccfv @ (XR @ Xi @ Xj) @ ccbs)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xph => (cwcel @ (XR @ Xi @ Xj) @ ccrg)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xc_1 = (ccfv @ (XR @ Xi @ Xj) @ ccur)))) => ((! [Xi:$i] : (! [Xj:$i] : (Xc_0 = (ccfv @ (XR @ Xi @ Xj) @ cc0g)))) => ((! [Xi:$i] : (! [Xj:$i] : ((XI @ Xi @ Xj) = (ccmpt2 @ (^ [Xi:$i] : (^ [Xj:$i] : XM)) @ (^ [Xi:$i] : (^ [Xj:$i] : XM)) @ (^ [Xi:$i] : (^ [Xj:$i] : (ccif @ ((ccv @ Xi) = (ccv @ Xj)) @ Xc_1 @ Xc_0))))))) => ((Xph => (cwcel @ XM @ ccfn)) => (! [Xi:$i] : (! [Xj:$i] : (((cwcel @ XA2 @ XM) & (cwcel @ XJ @ XM)) => ((cco @ XA2 @ XJ @ (XI @ Xi @ Xj)) = (ccif @ (XA2 = XJ) @ Xc_1 @ Xc_0))))))))))))))))))))).
