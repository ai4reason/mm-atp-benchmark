...
thf(aprdsbasmpt_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XS @ XR @ ccprds)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xph => (cwcel @ XS @ XV)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwfn @ XR @ XI)) => (Xph => ((cwcel @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XU @ Xx3))) @ XB2) <=> (cwral @ (^ [Xx3:$i] : (cwcel @ (XU @ Xx3) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XR) @ ccbs))) @ (^ [Xx3:$i] : XI))))))))))))))))))).
