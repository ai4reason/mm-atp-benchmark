...
thf(adf_aa_ax,axiom,(ccaa = (cciun @ (^ [Xf1:$i] : (ccdif @ (ccfv @ ccz @ ccply) @ (ccsn @ cc0p))) @ (^ [Xf1:$i] : (ccima @ (cccnv @ (ccv @ Xf1)) @ (ccsn @ ccc0)))))).
...
thf(celaa_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) <=> ((cwcel @ XA2 @ ccc) & (cwrex @ (^ [Xf1:$i] : ((ccfv @ XA2 @ (ccv @ Xf1)) = ccc0)) @ (^ [Xf1:$i] : (ccdif @ (ccfv @ ccz @ ccply) @ (ccsn @ cc0p)))))))).
