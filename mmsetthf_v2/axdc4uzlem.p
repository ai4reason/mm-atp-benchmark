...
thf(aaxdc4_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (((cwcel @ XC @ XA2) & (cwf @ (ccxp @ ccom @ XA2) @ (ccdif @ (ccpw @ XA2) @ (ccsn @ cc0)) @ XF)) => (? [Xg1:$i] : (cw3a @ (cwf @ ccom @ XA2 @ (ccv @ Xg1)) @ ((ccfv @ cc0 @ (ccv @ Xg1)) = XC) @ (cwral @ (^ [Xk:$i] : (cwcel @ (ccfv @ (ccsuc @ (ccv @ Xk)) @ (ccv @ Xg1)) @ (cco @ (ccv @ Xk) @ (ccfv @ (ccv @ Xk) @ (ccv @ Xg1)) @ XF))) @ (^ [Xk:$i] : ccom)))))))))).
