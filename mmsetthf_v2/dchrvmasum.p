...
thf(adchrvmasumlem_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [Xc_1:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XL:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xa:$i] : ((XZ @ Xa) = (ccfv @ (XN @ Xa) @ cczn))) => ((! [Xa:$i] : (XL = (ccfv @ (XZ @ Xa) @ cczrh))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ (XN @ Xa) @ ccn)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (! [Xa:$i] : ((XG @ Xx3 @ Xy1 @ Xn @ Xa) = (ccfv @ (XN @ Xa) @ ccdchr)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (! [Xa:$i] : ((XD @ Xa) = (ccfv @ (XG @ Xx3 @ Xy1 @ Xn @ Xa) @ ccbs)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xn:$i] : (! [Xa:$i] : ((Xc_1 @ Xa) = (ccfv @ (XG @ Xx3 @ Xy1 @ Xn @ Xa) @ cc0g)))))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ XX @ (XD @ Xa))))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwne @ XX @ (Xc_1 @ Xa))))) => ((! [Xa:$i] : ((XF @ Xa) = (ccmpt @ (^ [Xa:$i] : ccn) @ (^ [Xa:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xa) @ XL) @ XX) @ (ccv @ Xa) @ ccdiv))))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ (XC @ Xa) @ (cco @ ccc0 @ ccpnf @ ccico))))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwbr @ (ccseq @ ccaddc @ (XF @ Xa) @ cc1) @ (XT @ Xa) @ ccli)))) => ((! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccfv @ (ccv @ Xy1) @ ccfl) @ (ccseq @ ccaddc @ (XF @ Xa) @ cc1)) @ (XT @ Xa) @ ccmin) @ ccabs) @ (cco @ (XC @ Xa) @ (ccv @ Xy1) @ ccdiv) @ ccle)) @ (^ [Xy1:$i] : (cco @ cc1 @ ccpnf @ ccico)))))) => (! [Xy1:$i] : (! [Xa:$i] : ((Xph @ Xy1 @ Xa) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : ccrp) @ (^ [Xx3:$i] : (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xn) @ XL) @ XX) @ (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccv @ Xn) @ ccdiv) @ ccmul))))) @ cco1)))))))))))))))))))))))))))).
