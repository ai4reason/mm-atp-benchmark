...
thf(afzsscn_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (cwss @ (cco @ XM @ XN @ ccfz) @ ccc)))).
...
thf(aprod1_ax,axiom,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (((cwss @ XA2 @ (ccfv @ XM @ ccuz)) | (cwcel @ XA2 @ ccfn)) => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : cc1)) = cc1))))).
...
thf(afprodexp_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XN @ ccn0))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XA2 @ ccfn))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XB2 @ Xk) @ ccc))) => (! [Xk:$i] : ((Xph @ Xk) => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (cco @ (XB2 @ Xk) @ XN @ ccexp))) = (cco @ (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XB2 @ Xk))) @ XN @ ccexp))))))))))))).
