...
thf(acover2_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((! [Xy1:$i] : ((XA2 @ Xy1) = (ccuni @ XB2))) => (! [Xy1:$i] : ((cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (Xph @ Xy1))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1))) <=> (cwrex @ (^ [Xz:$i] : (((ccuni @ (ccv @ Xz)) = (XA2 @ Xy1)) & (cwral @ (^ [Xy1:$i] : (Xph @ Xy1)) @ (^ [Xy1:$i] : (ccv @ Xz))))) @ (^ [Xz:$i] : (ccpw @ XB2))))))))))).
thf(avex_ax,axiom,(! [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ ccvv))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(ccover2g_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > ($i > $o))))] : ((! [Xy1:$i] : ((XA2 @ Xy1) = (ccuni @ XB2))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ XB2 @ (XC @ Xx3 @ Xy1 @ Xz)) => ((cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ (ccv @ Xy1)) & (Xph @ Xy1))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1))) <=> (cwrex @ (^ [Xz:$i] : (((ccuni @ (ccv @ Xz)) = (XA2 @ Xy1)) & (cwral @ (^ [Xy1:$i] : (Xph @ Xy1)) @ (^ [Xy1:$i] : (ccv @ Xz))))) @ (^ [Xz:$i] : (ccpw @ XB2)))))))))))))).
