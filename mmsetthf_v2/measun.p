...
thf(ameasxun2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XM @ (ccfv @ XS @ ccmeas)) @ ((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS)) @ (cwss @ XB2 @ XA2)) => ((ccfv @ XA2 @ XM) = (cco @ (ccfv @ XB2 @ XM) @ (ccfv @ (ccdif @ XA2 @ XB2) @ XM) @ ccxad)))))))).
...
thf(cmeasun_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((cw3a @ (cwcel @ XM @ (ccfv @ XS @ ccmeas)) @ ((cwcel @ XA2 @ XS) & (cwcel @ XB2 @ XS)) @ ((ccin @ XA2 @ XB2) = cc0)) => ((ccfv @ (ccun @ XA2 @ XB2) @ XM) = (cco @ (ccfv @ XA2 @ XM) @ (ccfv @ XB2 @ XM) @ ccxad)))))))).
