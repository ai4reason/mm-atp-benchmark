...
thf(aisclwwlkn_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ (cco @ XN @ XG @ ccclwwlkn)) <=> ((cwcel @ XW @ (ccfv @ XG @ ccclwwlk)) & ((ccfv @ XW @ cchash) = XN))))))).
...
thf(awlklenvclwlk_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ (ccfv @ XG @ ccvtx))) & (cwbr @ cc1 @ (ccfv @ XW @ cchash) @ ccle)) => ((cwcel @ (ccop @ XF @ (cco @ XW @ (ccs1 @ (ccfv @ ccc0 @ XW)) @ ccconcat)) @ (ccfv @ XG @ ccwlks)) => ((ccfv @ XF @ cchash) = (ccfv @ XW @ cchash)))))))).
...
thf(cclwlksfoclwwlkOLD_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((! [Xc:$i] : ((XA2 @ Xc) = (ccfv @ (ccv @ Xc) @ cc1st))) => ((! [Xc:$i] : ((XB2 @ Xc) = (ccfv @ (ccv @ Xc) @ cc2nd))) => ((XC = (ccrab @ (^ [Xc:$i] : ((ccfv @ (XA2 @ Xc) @ cchash) = XN)) @ (^ [Xc:$i] : (ccfv @ XG @ ccclwlks)))) => ((XF = (ccmpt @ (^ [Xc:$i] : XC) @ (^ [Xc:$i] : (cco @ (XB2 @ Xc) @ (ccop @ ccc0 @ (ccfv @ (XA2 @ Xc) @ cchash)) @ ccsubstr)))) => (((cwcel @ XG @ ccfusgr) & (cwcel @ XN @ ccprime)) => (cwfo @ XC @ (cco @ XN @ XG @ ccclwwlkn) @ XF))))))))))))).
