...
thf(algsquadlem2_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((Xph => (cwcel @ XQ @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((Xph => (cwne @ XP @ XQ)) => ((XM = (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((XN = (cco @ (cco @ XQ @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((XS = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (((cwcel @ (ccv @ Xx3) @ (cco @ cc1 @ XM @ ccfz)) & (cwcel @ (ccv @ Xy1) @ (cco @ cc1 @ XN @ ccfz))) & (cwbr @ (cco @ (ccv @ Xy1) @ XP @ ccmul) @ (cco @ (ccv @ Xx3) @ XQ @ ccmul) @ cclt)))))) => (Xph => ((cco @ XQ @ XP @ cclgs) = (cco @ (ccneg @ cc1) @ (ccfv @ XS @ cchash) @ ccexp)))))))))))))))).
...
thf(acnven_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (((cwrel @ XA2) & (cwcel @ XA2 @ XV)) => (cwbr @ XA2 @ (cccnv @ XA2) @ ccen))))).
thf(cwsb_tp,type,(cwsb : (($i > $o) > ($i > $o)))).
thf(acnvopab_ax,axiom,(! [Xph:($i > ($i > $o))] : ((cccnv @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1))))) = (ccopab @ (^ [Xy1:$i] : (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1))))))).
...
thf(afzm1ndvds_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn) & (cwcel @ XN @ (cco @ cc1 @ (cco @ XM @ cc1 @ ccmin) @ ccfz))) => (~ (cwbr @ XM @ XN @ ccdvds)))))).
...
thf(altnsym2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (~ ((cwbr @ XA2 @ XB2 @ cclt) & (cwbr @ XB2 @ XA2 @ cclt))))))).
...
thf(ahashxp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwcel @ XB2 @ ccfn)) => ((ccfv @ (ccxp @ XA2 @ XB2) @ cchash) = (cco @ (ccfv @ XA2 @ cchash) @ (ccfv @ XB2 @ cchash) @ ccmul)))))).
