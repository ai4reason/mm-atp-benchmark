...
thf(cello1mpt_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((Xph => (cwss @ XA2 @ ccr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccr))) => (Xph => ((cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ cclo1) <=> (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccle) => (cwbr @ (XB2 @ Xx3) @ (ccv @ Xm) @ ccle))) @ (^ [Xx3:$i] : XA2))) @ (^ [Xm:$i] : ccr))) @ (^ [Xy1:$i] : ccr)))))))))).
