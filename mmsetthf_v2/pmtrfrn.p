...
thf(cpmtrfrn_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((XR = (ccrn @ XT)) => ((XP = (ccdm @ (ccdif @ XF @ ccid))) => ((cwcel @ XF @ XR) => ((cw3a @ (cwcel @ XD @ ccvv) @ (cwss @ XP @ XD) @ (cwbr @ XP @ cc2o @ ccen)) & (XF = (ccfv @ XP @ XT))))))))))))).
