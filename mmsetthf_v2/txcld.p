...
thf(adifxp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((ccdif @ (ccxp @ XC @ XD) @ (ccxp @ XA2 @ XB2)) = (ccun @ (ccxp @ (ccdif @ XC @ XA2) @ XD) @ (ccxp @ XC @ (ccdif @ XD @ XB2))))))))).
...
thf(aunopn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : ((cw3a @ (cwcel @ XJ @ cctop) @ (cwcel @ XA2 @ XJ) @ (cwcel @ XB2 @ XJ)) => (cwcel @ (ccun @ XA2 @ XB2) @ XJ)))))).
...
thf(ctxcld_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ XR @ cccld)) & (cwcel @ XB2 @ (ccfv @ XS @ cccld))) => (cwcel @ (ccxp @ XA2 @ XB2) @ (ccfv @ (cco @ XR @ XS @ cctx) @ cccld)))))))).
