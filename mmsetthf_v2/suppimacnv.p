...
thf(acbvexvw_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => ((? [Xx3:$i] : (Xph @ Xx3)) <=> (? [Xy1:$i] : (Xps @ Xy1))))))).
...
thf(asuppvalbr_ax,axiom,(! [XR:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XZ:($i > $o)] : (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XR @ (XV @ Xx3 @ Xy1)) & (cwcel @ XZ @ (XW @ Xx3 @ Xy1))) => ((cco @ XR @ XZ @ ccsupp) = (ccab @ (^ [Xx3:$i] : ((? [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR)) & (? [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) <=> (cwne @ (ccv @ Xy1) @ XZ))))))))))))))).
thf(acnvimadfsn_ax,axiom,(! [XR:($i > $o)] : (! [XZ:($i > $o)] : ((ccima @ (cccnv @ XR) @ (ccdif @ ccvv @ (ccsn @ XZ))) = (ccab @ (^ [Xx3:$i] : (? [Xy1:$i] : ((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR) & (cwne @ (ccv @ Xy1) @ XZ))))))))).
thf(asuppimacnvss_ax,axiom,(! [XR:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : (((cwcel @ XR @ XV) & (cwcel @ XZ @ XW)) => (cwss @ (ccima @ (cccnv @ XR) @ (ccdif @ ccvv @ (ccsn @ XZ))) @ (cco @ XR @ XZ @ ccsupp)))))))).
