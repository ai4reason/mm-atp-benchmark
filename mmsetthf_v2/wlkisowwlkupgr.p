...
thf(awlkpwwlkf1ouspgr_ax,axiom,(! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : ((! [Xw:$i] : ((XF @ Xw) = (ccmpt @ (^ [Xw:$i] : (ccfv @ XG @ ccwlks)) @ (^ [Xw:$i] : (ccfv @ (ccv @ Xw) @ cc2nd))))) => (! [Xw:$i] : ((cwcel @ XG @ ccuspgr) => (cwf1o @ (ccfv @ XG @ ccwlks) @ (ccfv @ XG @ ccwwlks) @ (XF @ Xw)))))))).
