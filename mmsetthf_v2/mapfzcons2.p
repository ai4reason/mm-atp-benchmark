...
thf(cmapfzcons2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XM = (cco @ XN @ cc1 @ ccaddc)) => (((cwcel @ XA2 @ (cco @ XB2 @ (cco @ cc1 @ XN @ ccfz) @ ccmap)) & (cwcel @ XC @ XB2)) => ((ccfv @ XM @ (ccun @ XA2 @ (ccsn @ (ccop @ XM @ XC)))) = XC))))))))).
