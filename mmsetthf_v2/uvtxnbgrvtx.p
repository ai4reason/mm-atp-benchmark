...
thf(avtxnbuvtx_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XN @ (ccfv @ XG @ ccuvtx)) => (cwral @ (^ [Xn:$i] : (cwcel @ (ccv @ Xn) @ (cco @ XG @ XN @ ccnbgr))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ XN)))))))))).
...
thf(anbgrsym_ax,axiom,(! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ (cco @ XG @ XK @ ccnbgr)) <=> (cwcel @ XK @ (cco @ XG @ XN @ ccnbgr))))))).
thf(cuvtxnbgrvtx_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cwcel @ XN @ (ccfv @ XG @ ccuvtx)) => (cwral @ (^ [Xv:$i] : (cwcel @ XN @ (cco @ XG @ (ccv @ Xv) @ ccnbgr))) @ (^ [Xv:$i] : (ccdif @ XV @ (ccsn @ XN)))))))))).
