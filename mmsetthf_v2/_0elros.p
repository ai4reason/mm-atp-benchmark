...
thf(c_0elros_conj,conjecture,(! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > $o)] : (! [XO:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xs1:$i] : ((XQ @ Xx3 @ Xy1 @ Xs1) = (ccrab @ (^ [Xs1:$i] : ((cwcel @ cc0 @ (ccv @ Xs1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwcel @ (ccun @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xs1)) & (cwcel @ (ccdif @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (ccv @ Xs1)))) @ (^ [Xy1:$i] : (ccv @ Xs1)))) @ (^ [Xx3:$i] : (ccv @ Xs1))))) @ (^ [Xs1:$i] : (ccpw @ (ccpw @ (XO @ Xx3 @ Xy1))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xs1:$i] : ((cwcel @ XS @ (XQ @ Xx3 @ Xy1 @ Xs1)) => (cwcel @ cc0 @ XS)))))))))).
