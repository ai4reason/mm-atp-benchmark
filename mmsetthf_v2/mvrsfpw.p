...
thf(amexval2_ax,axiom,(! [XC:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XK = (ccfv @ XT @ ccmtc)) => ((XE = (ccfv @ XT @ ccmex)) => ((XC = (ccfv @ XT @ ccmcn)) => ((XV = (ccfv @ XT @ ccmvar)) => (XE = (ccxp @ XK @ (ccword @ (ccun @ XC @ XV)))))))))))))).
