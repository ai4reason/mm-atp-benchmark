...
thf(a_2alimdv_ax,axiom,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [Xch:($i > ($i > $o))] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => ((Xps @ Xx3 @ Xy1) => (Xch @ Xx3 @ Xy1))))) => (Xph => ((! [Xx3:$i] : (! [Xy1:$i] : (Xps @ Xx3 @ Xy1))) => (! [Xx3:$i] : (! [Xy1:$i] : (Xch @ Xx3 @ Xy1)))))))))).
...
thf(ampstrcl_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : ((XP = (ccfv @ XT @ ccmpst)) => ((cwcel @ (ccotp @ XD @ XH @ XA2) @ XP) => (cw3a @ (cwcel @ XD @ ccvv) @ (cwcel @ XH @ ccvv) @ (cwcel @ XA2 @ ccvv)))))))))).
thf(aspc3gv_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cw3a @ ((ccv @ Xx3) = XA2) @ ((ccv @ Xy1) = XB2) @ ((ccv @ Xz) = XC)) => ((Xph @ Xx3 @ Xy1 @ Xz) <=> Xps))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cw3a @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xz)) @ (cwcel @ XB2 @ (XW @ Xx3 @ Xy1 @ Xz)) @ (cwcel @ XC @ (XX @ Xx3 @ Xy1 @ Xz))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph @ Xx3 @ Xy1 @ Xz)))) => Xps))))))))))))))).
