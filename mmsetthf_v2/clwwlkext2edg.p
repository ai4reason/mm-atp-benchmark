...
thf(aige2m2fzo_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) => (cwcel @ (cco @ XN @ cc2 @ ccmin) @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfzo))))).
...
thf(accatws1ls_ax,axiom,(! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XX @ XV)) => ((ccfv @ (ccfv @ XW @ cchash) @ (cco @ XW @ (ccs1 @ XX) @ ccconcat)) = XX)))))).
...
thf(cclwwlkext2edg_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => (((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XZ @ XV) @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz))) & (cwcel @ (cco @ XW @ (ccs1 @ XZ) @ ccconcat) @ (cco @ XN @ XG @ ccclwwlkn))) => ((cwcel @ (ccpr @ (ccfv @ XW @ cclsw) @ XZ) @ XE) & (cwcel @ (ccpr @ XZ @ (ccfv @ ccc0 @ XW)) @ XE)))))))))))).
