...
thf(a_2pthdlem1_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [XV:($i > ($i > $o))] : ((! [Xj:$i] : (! [Xk:$i] : (XP = (ccs3 @ (XA2 @ Xj @ Xk) @ (XB2 @ Xj @ Xk) @ (XC @ Xj @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : (XF = (ccs2 @ (XJ @ Xj @ Xk) @ (XK @ Xj @ Xk))))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cw3a @ (cwcel @ (XA2 @ Xj @ Xk) @ (XV @ Xj)) @ (cwcel @ (XB2 @ Xj @ Xk) @ (XV @ Xj)) @ (cwcel @ (XC @ Xj @ Xk) @ (XV @ Xj)))))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => ((cwne @ (XA2 @ Xj @ Xk) @ (XB2 @ Xj @ Xk)) & (cwne @ (XB2 @ Xj @ Xk) @ (XC @ Xj @ Xk)))))) => (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xj:$i] : ((cwne @ (ccv @ Xk) @ (ccv @ Xj)) => (cwne @ (ccfv @ (ccv @ Xk) @ XP) @ (ccfv @ (ccv @ Xj) @ XP)))) @ (^ [Xj:$i] : (cco @ cc1 @ (ccfv @ XF @ cchash) @ ccfzo)))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XP @ cchash) @ ccfzo)))))))))))))))))))).
...
thf(c_2pthd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((XP = (ccs3 @ XA2 @ XB2 @ XC)) => ((XF = (ccs2 @ XJ @ XK)) => ((Xph => (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XV))) => ((Xph => ((cwne @ XA2 @ XB2) & (cwne @ XB2 @ XC))) => ((Xph => ((cwss @ (ccpr @ XA2 @ XB2) @ (ccfv @ XJ @ XI)) & (cwss @ (ccpr @ XB2 @ XC) @ (ccfv @ XK @ XI)))) => ((XV = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XG @ cciedg)) => ((Xph => (cwne @ XJ @ XK)) => (Xph => (cwbr @ XF @ XP @ (ccfv @ XG @ ccpths))))))))))))))))))))))).
