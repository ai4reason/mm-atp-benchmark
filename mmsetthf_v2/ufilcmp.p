...
thf(aufli_ax,axiom,(! [XF:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ ccufl) & (cwcel @ XF @ (ccfv @ XX @ ccfil))) => (cwrex @ (^ [Xf1:$i] : (cwss @ XF @ (ccv @ Xf1))) @ (^ [Xf1:$i] : (ccfv @ XX @ ccufil))))))).
...
thf(afclscmp_ax,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XX @ cctopon)) => ((cwcel @ XJ @ cccmp) <=> (cwral @ (^ [Xf1:$i] : (cwne @ (cco @ XJ @ (ccv @ Xf1) @ ccfcls) @ cc0)) @ (^ [Xf1:$i] : (ccfv @ XX @ ccfil)))))))).
...
thf(auffclsflim_ax,axiom,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XF @ (ccfv @ XX @ ccufil)) => ((cco @ XJ @ XF @ ccfcls) = (cco @ XJ @ XF @ ccflim))))))).
thf(cufilcmp_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ ccufl) & (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((cwcel @ XJ @ cccmp) <=> (cwral @ (^ [Xf1:$i] : (cwne @ (cco @ XJ @ (ccv @ Xf1) @ ccflim) @ cc0)) @ (^ [Xf1:$i] : (ccfv @ XX @ ccufil)))))))).
