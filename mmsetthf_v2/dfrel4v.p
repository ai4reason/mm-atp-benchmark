...
thf(acnvcnv3_ax,axiom,(! [XR:($i > $o)] : ((cccnv @ (cccnv @ XR)) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR))))))).
thf(cdfrel4v_conj,conjecture,(! [XR:($i > $o)] : ((cwrel @ XR) <=> (XR = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ XR)))))))).
