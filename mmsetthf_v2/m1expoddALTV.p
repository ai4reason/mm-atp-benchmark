...
thf(aoddm1eveni_ax,axiom,(! [XZ:($i > $o)] : ((cwcel @ XZ @ ccodd) => (cwcel @ (cco @ XZ @ cc1 @ ccmin) @ cceven)))).
thf(ccv_tp,type,(ccv : ($i > ($i > $o)))).
thf(cwrex_tp,type,(cwrex : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(am1expevenALTV_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ cceven) => ((cco @ (ccneg @ cc1) @ XN @ ccexp) = cc1)))).
