...
thf(aidfusubc0_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XI:($i > ($i > ($i > $o)))] : (! [XJ:($i > $o)] : ((XS = (cco @ XC @ XJ @ ccresc)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XI @ Xx3 @ Xy1) = (ccfv @ XS @ ccidfu)))) => ((XB2 = (ccfv @ XS @ ccbs)) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ XJ @ (ccfv @ XC @ ccsubc)) => ((XI @ Xx3 @ Xy1) = (ccop @ (ccres @ ccid @ XB2) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : XB2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccres @ ccid @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccfv @ XS @ cchom)))))))))))))))))))).
