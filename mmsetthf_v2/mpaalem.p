...
thf(ampaaval_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => ((ccfv @ XA2 @ ccmpaa) = (ccrio @ (^ [Xp:$i] : (cw3a @ ((ccfv @ (ccv @ Xp) @ ccdgr) = (ccfv @ XA2 @ ccdgraa)) @ ((ccfv @ XA2 @ (ccv @ Xp)) = ccc0) @ ((ccfv @ (ccfv @ XA2 @ ccdgraa) @ (ccfv @ (ccv @ Xp) @ cccoe)) = cc1))) @ (^ [Xp:$i] : (ccfv @ ccq @ ccply))))))).
...
thf(ampaaeu_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => (cwreu @ (^ [Xp:$i] : (cw3a @ ((ccfv @ (ccv @ Xp) @ ccdgr) = (ccfv @ XA2 @ ccdgraa)) @ ((ccfv @ XA2 @ (ccv @ Xp)) = ccc0) @ ((ccfv @ (ccfv @ XA2 @ ccdgraa) @ (ccfv @ (ccv @ Xp) @ cccoe)) = cc1))) @ (^ [Xp:$i] : (ccfv @ ccq @ ccply)))))).
...
thf(cmpaalem_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccaa) => ((cwcel @ (ccfv @ XA2 @ ccmpaa) @ (ccfv @ ccq @ ccply)) & (cw3a @ ((ccfv @ (ccfv @ XA2 @ ccmpaa) @ ccdgr) = (ccfv @ XA2 @ ccdgraa)) @ ((ccfv @ XA2 @ (ccfv @ XA2 @ ccmpaa)) = ccc0) @ ((ccfv @ (ccfv @ XA2 @ ccdgraa) @ (ccfv @ (ccfv @ XA2 @ ccmpaa) @ cccoe)) = cc1)))))).
