...
thf(acxpeq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn) @ (cwcel @ XB2 @ ccc)) => (((cco @ XA2 @ XN @ ccexp) = XB2) <=> (cwrex @ (^ [Xn:$i] : (XA2 = (cco @ (cco @ XB2 @ (cco @ cc1 @ XN @ ccdiv) @ cccxp) @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ XN @ ccdiv) @ cccxp) @ (ccv @ Xn) @ ccexp) @ ccmul))) @ (^ [Xn:$i] : (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz))))))))).
...
thf(arextp_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> Xps))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XB2) => ((Xph @ Xx3) <=> Xch))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XC) => ((Xph @ Xx3) <=> Xth))) => ((cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (cctp @ XA2 @ XB2 @ XC))) <=> (cw3o @ Xps @ Xch @ Xth)))))))))))))))).
...
thf(a_1cubrlem_ax,axiom,(((cco @ (ccneg @ cc1) @ (cco @ cc2 @ cc3 @ ccdiv) @ cccxp) = (cco @ (cco @ (ccneg @ cc1) @ (cco @ cci @ (ccfv @ cc3 @ ccsqrt) @ ccmul) @ ccaddc) @ cc2 @ ccdiv)) & ((cco @ (cco @ (ccneg @ cc1) @ (cco @ cc2 @ cc3 @ ccdiv) @ cccxp) @ cc2 @ ccexp) = (cco @ (cco @ (ccneg @ cc1) @ (cco @ cci @ (ccfv @ cc3 @ ccsqrt) @ ccmul) @ ccmin) @ cc2 @ ccdiv)))).
