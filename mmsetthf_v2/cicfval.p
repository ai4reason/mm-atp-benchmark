...
thf(adf_cic_ax,axiom,(cccic = (ccmpt @ (^ [Xc:$i] : cccat) @ (^ [Xc:$i] : (cco @ (ccfv @ (ccv @ Xc) @ cciso) @ cc0 @ ccsupp))))).
...
thf(ccicfval_conj,conjecture,(! [XC:($i > $o)] : ((cwcel @ XC @ cccat) => ((ccfv @ XC @ cccic) = (cco @ (ccfv @ XC @ cciso) @ cc0 @ ccsupp))))).
