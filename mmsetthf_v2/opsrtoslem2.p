...
thf(altbwe_ax,axiom,(! [Xph:$o] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xh:$i] : ((XC @ Xh) = (cco @ (XT @ Xh) @ XI @ ccltb))) => ((! [Xh:$i] : ((XD @ Xh) = (ccrab @ (^ [Xh:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xh)) @ ccn) @ ccfn)) @ (^ [Xh:$i] : (cco @ ccn0 @ XI @ ccmap))))) => ((! [Xh:$i] : (Xph => (cwcel @ XI @ (XV @ Xh)))) => ((! [Xh:$i] : (Xph => (cwcel @ (XT @ Xh) @ (XW @ Xh)))) => ((! [Xh:$i] : (Xph => (cwwe @ XI @ (XT @ Xh)))) => (! [Xh:$i] : (Xph => (cwwe @ (XD @ Xh) @ (XC @ Xh))))))))))))))))).
...
thf(awemapso_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XV:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XT @ Xx3 @ Xy1 @ Xz @ Xw) = (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((cwbr @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1)) @ XS) & (cwral @ (^ [Xw:$i] : ((cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ XR) => ((ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) = (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : XA2)))) @ (^ [Xz:$i] : XA2)))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((cw3a @ (cwcel @ XA2 @ (XV @ Xx3 @ Xy1 @ Xz @ Xw)) @ (cwwe @ XA2 @ XR) @ (cwor @ (XB2 @ Xy1 @ Xz @ Xw) @ XS)) => (cwor @ (cco @ (XB2 @ Xy1 @ Xz @ Xw) @ XA2 @ ccmap) @ (XT @ Xx3 @ Xy1 @ Xz @ Xw))))))))))))))).
...
thf(asoinxp_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwor @ XA2 @ XR) <=> (cwor @ XA2 @ (ccin @ XR @ (ccxp @ XA2 @ XA2))))))).
thf(asyl5eq_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((Xph => (XB2 = XC)) => (Xph => (XA2 = XC))))))))).
thf(aax_mp_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (Xph => ((Xph => Xps) => Xps))))).
thf(aeqeltri_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwcel @ XB2 @ XC) => (cwcel @ XA2 @ XC))))))).
thf(ccio_tp,type,(ccio : (($i > $o) > ($i > $o)))).
thf(afvex_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(apltfval_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_lt = (ccfv @ XK @ ccplt)) => ((cwcel @ XK @ XA2) => (Xc_lt = (ccdif @ Xc_le @ ccid)))))))))).
...
thf(aopsrtoslem1_ax,axiom,(! [Xph:$o] : (! [Xps:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XB2:($i > ($i > ($i > ($i > $o))))] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [Xc_lt:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [Xc_le:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XO:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XV:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xh:$i] : ((XO @ Xx3 @ Xy1 @ Xz @ Xw @ Xh) = (ccfv @ (XT @ Xh) @ (cco @ XI @ (XR @ Xh) @ ccopws)))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xh:$i] : (Xph => (cwcel @ XI @ (XV @ Xx3 @ Xy1 @ Xz @ Xw @ Xh)))))))) => ((! [Xh:$i] : (Xph => (cwcel @ (XR @ Xh) @ cctos))) => ((! [Xh:$i] : (Xph => (cwss @ (XT @ Xh) @ (ccxp @ XI @ XI)))) => ((! [Xh:$i] : (Xph => (cwwe @ XI @ (XT @ Xh)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xh:$i] : ((XS @ Xx3 @ Xy1 @ Xz @ Xw @ Xh) = (cco @ XI @ (XR @ Xh) @ ccmps))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xh:$i] : ((XB2 @ Xz @ Xw @ Xh) = (ccfv @ (XS @ Xx3 @ Xy1 @ Xz @ Xw @ Xh) @ ccbs))))))) => ((! [Xh:$i] : ((Xc_lt @ Xh) = (ccfv @ (XR @ Xh) @ ccplt))) => ((! [Xh:$i] : ((XC @ Xh) = (cco @ (XT @ Xh) @ XI @ ccltb))) => ((! [Xh:$i] : ((XD @ Xh) = (ccrab @ (^ [Xh:$i] : (cwcel @ (ccima @ (cccnv @ (ccv @ Xh)) @ ccn) @ ccfn)) @ (^ [Xh:$i] : (cco @ ccn0 @ XI @ ccmap))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xh:$i] : ((Xps @ Xx3 @ Xy1 @ Xz @ Xw @ Xh) <=> (cwrex @ (^ [Xz:$i] : ((cwbr @ (ccfv @ (ccv @ Xz) @ (ccv @ Xx3)) @ (ccfv @ (ccv @ Xz) @ (ccv @ Xy1)) @ (Xc_lt @ Xh)) & (cwral @ (^ [Xw:$i] : ((cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ (XC @ Xh)) => ((ccfv @ (ccv @ Xw) @ (ccv @ Xx3)) = (ccfv @ (ccv @ Xw) @ (ccv @ Xy1))))) @ (^ [Xw:$i] : (XD @ Xh))))) @ (^ [Xz:$i] : (XD @ Xh))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xh:$i] : ((Xc_le @ Xx3 @ Xy1 @ Xz @ Xw @ Xh) = (ccfv @ (XO @ Xx3 @ Xy1 @ Xz @ Xw @ Xh) @ ccple))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xh:$i] : (Xph => ((Xc_le @ Xx3 @ Xy1 @ Xz @ Xw @ Xh) = (ccun @ (ccin @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1 @ Xz @ Xw @ Xh)))) @ (ccxp @ (XB2 @ Xz @ Xw @ Xh) @ (XB2 @ Xz @ Xw @ Xh))) @ (ccres @ ccid @ (XB2 @ Xz @ Xw @ Xh)))))))))))))))))))))))))))))))))))).
...
thf(asoeq1_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((XR = XS) => ((cwor @ XA2 @ XR) <=> (cwor @ XA2 @ XS))))))).
