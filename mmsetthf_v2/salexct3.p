...
thf(csalexct3_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xy1:$i] : ((XA2 @ Xy1) = (cco @ ccc0 @ cc2 @ ccicc))) => ((! [Xy1:$i] : (XS = (ccrab @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xx3) @ ccom @ ccdom) | (cwbr @ (ccdif @ (XA2 @ Xy1) @ (ccv @ Xx3)) @ ccom @ ccdom))) @ (^ [Xx3:$i] : (ccpw @ (XA2 @ Xy1)))))) => ((! [Xy1:$i] : ((XX @ Xy1) = (ccrn @ (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xy1:$i] : (ccsn @ (ccv @ Xy1))))))) => (! [Xy1:$i] : (cw3a @ (cwcel @ XS @ ccsalg) @ (cwss @ (XX @ Xy1) @ XS) @ (~ (cwcel @ (ccuni @ (XX @ Xy1)) @ XS))))))))))).
