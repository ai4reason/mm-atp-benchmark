...
thf(cbnj1186_conj,conjecture,(! [Xph:$o] : (! [Xps:$o] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > $o)))] : ((? [Xz:$i] : (! [Xw:$i] : ((Xph & Xps) => ((cwcel @ (ccv @ Xz) @ (XB2 @ Xz)) & ((cwcel @ (ccv @ Xw) @ (XB2 @ Xz)) => (~ (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ (XR @ Xz @ Xw)))))))) => ((Xph & Xps) => (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xw:$i] : (~ (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ (XR @ Xz @ Xw)))) @ (^ [Xw:$i] : (XB2 @ Xz)))) @ (^ [Xz:$i] : (XB2 @ Xz)))))))))).
