...
thf(acnegex2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (cwrex @ (^ [Xx3:$i] : ((cco @ (ccv @ Xx3) @ XA2 @ ccaddc) = ccc0)) @ (^ [Xx3:$i] : ccc))))).
...
thf(caddcan_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) => (((cco @ XA2 @ XB2 @ ccaddc) = (cco @ XA2 @ XC @ ccaddc)) <=> (XB2 = XC))))))).
