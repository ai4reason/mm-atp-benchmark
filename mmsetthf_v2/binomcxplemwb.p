...
thf(abccval_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XK @ ccn0)) => (Xph => ((cco @ XC @ XK @ ccbcc) = (cco @ (cco @ XC @ XK @ ccfallfac) @ (ccfv @ XK @ ccfa) @ ccdiv))))))))).
...
thf(afacne0_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn0) => (cwne @ (ccfv @ XN @ ccfa) @ ccc0)))).
...
thf(afallfacp1_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XN @ ccn0)) => ((cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccfallfac) = (cco @ (cco @ XA2 @ XN @ ccfallfac) @ (cco @ XA2 @ XN @ ccmin) @ ccmul)))))).
thf(cbinomcxplemwb_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XK @ ccn)) => (Xph => ((cco @ (cco @ (cco @ XC @ XK @ ccmin) @ (cco @ XC @ XK @ ccbcc) @ ccmul) @ (cco @ (cco @ XC @ (cco @ XK @ cc1 @ ccmin) @ ccmin) @ (cco @ XC @ (cco @ XK @ cc1 @ ccmin) @ ccbcc) @ ccmul) @ ccaddc) = (cco @ XC @ (cco @ XC @ XK @ ccbcc) @ ccmul))))))))).
