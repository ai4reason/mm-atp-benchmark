...
thf(anemnftgtmnft_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwne @ XA2 @ ccmnf)) => (cwbr @ ccmnf @ XA2 @ cclt)))).
...
thf(cxrlexaddrp_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccxr)) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ ccrp)) => (cwbr @ XA2 @ (cco @ XB2 @ (ccv @ Xx3) @ ccxad) @ ccle))) => (Xph => (cwbr @ XA2 @ XB2 @ ccle))))))))).
