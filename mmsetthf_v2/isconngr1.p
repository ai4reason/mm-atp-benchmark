...
thf(adfconngr1_ax,axiom,(ccconngr = (ccab @ (^ [Xg1:$i] : (cwsbc @ (^ [Xv:$i] : (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xn:$i] : (? [Xf1:$i] : (? [Xp:$i] : (cwbr @ (ccv @ Xf1) @ (ccv @ Xp) @ (cco @ (ccv @ Xk) @ (ccv @ Xn) @ (ccfv @ (ccv @ Xg1) @ ccpthson)))))) @ (^ [Xn:$i] : (ccdif @ (ccv @ Xv) @ (ccsn @ (ccv @ Xk)))))) @ (^ [Xk:$i] : (ccv @ Xv)))) @ (ccfv @ (ccv @ Xg1) @ ccvtx)))))).
