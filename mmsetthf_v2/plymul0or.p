...
thf(acoe0_ax,axiom,((ccfv @ cc0p @ cccoe) = (ccxp @ ccn0 @ (ccsn @ ccc0)))).
...
thf(cplymul0or_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XF @ (ccfv @ XS @ ccply)) & (cwcel @ XG @ (ccfv @ XS @ ccply))) => (((cco @ XF @ XG @ (ccof @ ccmul)) = cc0p) <=> ((XF = cc0p) | (XG = cc0p)))))))).
