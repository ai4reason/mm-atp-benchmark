...
thf(aex3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (((((Xph & Xps) & Xch) & Xth) => Xta) => ((cw3a @ Xph @ Xps @ Xch) => (Xth => Xta))))))))).
...
thf(ainjresinj_ax,axiom,(! [XF:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XK @ ccn0) => ((cw3a @ (cwf @ (cco @ ccc0 @ XK @ ccfz) @ XV @ XF) @ (cwfun @ (cccnv @ (ccres @ XF @ (cco @ cc1 @ XK @ ccfzo)))) @ (cwne @ (ccfv @ ccc0 @ XF) @ (ccfv @ XK @ XF))) => (((ccin @ (ccima @ XF @ (ccpr @ ccc0 @ XK)) @ (ccima @ XF @ (cco @ cc1 @ XK @ ccfzo))) = cc0) => (cwfun @ (cccnv @ XF))))))))).
thf(aisspth_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwbr @ XF @ XP @ (ccfv @ XG @ ccspths)) <=> ((cwbr @ XF @ XP @ (ccfv @ XG @ cctrls)) & (cwfun @ (cccnv @ XP)))))))).
thf(cpthdepisspth_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) & (cwne @ (ccfv @ ccc0 @ XP) @ (ccfv @ (ccfv @ XF @ cchash) @ XP))) => (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths))))))).
