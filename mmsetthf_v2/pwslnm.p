...
thf(apwslnmlem0_ax,axiom,(! [XW:($i > $o)] : (! [XY:($i > $o)] : ((XY = (cco @ XW @ cc0 @ ccpws)) => ((cwcel @ XW @ cclmod) => (cwcel @ XY @ cclnm)))))).
...
thf(apwslnmlem2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((XX = (cco @ XW @ XA2 @ ccpws)) => ((XY = (cco @ XW @ XB2 @ ccpws)) => ((XZ = (cco @ XW @ (ccun @ XA2 @ XB2) @ ccpws)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => ((ccin @ XA2 @ XB2) = cc0)) => ((Xph => (cwcel @ XX @ cclnm)) => ((Xph => (cwcel @ XY @ cclnm)) => (Xph => (cwcel @ XZ @ cclnm))))))))))))))))))).
...
thf(apwslnmlem1_ax,axiom,(! [XW:($i > $o)] : (! [XY:($i > ($i > $o))] : ((! [Xi:$i] : ((XY @ Xi) = (cco @ XW @ (ccsn @ (ccv @ Xi)) @ ccpws))) => (! [Xi:$i] : ((cwcel @ XW @ cclnm) => (cwcel @ (XY @ Xi) @ cclnm))))))).
