...
thf(cmatval_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XG = (cco @ XR @ (ccxp @ XN @ XN) @ ccfrlm)) => ((Xc_x = (cco @ XR @ (ccotp @ XN @ XN @ XN) @ ccmmul)) => (((cwcel @ XN @ ccfn) & (cwcel @ XR @ XV)) => (XA2 = (cco @ XG @ (ccop @ (ccfv @ ccnx @ ccmulr) @ Xc_x) @ ccsts))))))))))))).
