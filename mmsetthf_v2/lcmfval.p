...
thf(afissn0dvdsn0_ax,axiom,(! [XZ:($i > $o)] : ((cw3a @ (cwss @ XZ @ ccz) @ (cwcel @ XZ @ ccfn) @ (cwnel @ ccc0 @ XZ)) => (cwne @ (ccrab @ (^ [Xn:$i] : (cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ (ccv @ Xn) @ ccdvds)) @ (^ [Xm:$i] : XZ))) @ (^ [Xn:$i] : ccn)) @ cc0)))).
