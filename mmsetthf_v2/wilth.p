...
thf(awilthlem3_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XT:($i > $o)] : ((XT = (ccfv @ cccnfld @ ccmgp)) => ((XA2 = (ccrab @ (^ [Xx3:$i] : ((cwcel @ (cco @ XP @ cc1 @ ccmin) @ (ccv @ Xx3)) & (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (cco @ (ccv @ Xy1) @ (cco @ XP @ cc2 @ ccmin) @ ccexp) @ XP @ ccmo) @ (ccv @ Xx3))) @ (^ [Xy1:$i] : (ccv @ Xx3))))) @ (^ [Xx3:$i] : (ccpw @ (cco @ cc1 @ (cco @ XP @ cc1 @ ccmin) @ ccfz))))) => ((cwcel @ XP @ ccprime) => (cwbr @ XP @ (cco @ (ccfv @ (cco @ XP @ cc1 @ ccmin) @ ccfa) @ cc1 @ ccaddc) @ ccdvds)))))))).
...
thf(cwilth_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccprime) <=> ((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) & (cwbr @ XN @ (cco @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ ccfa) @ cc1 @ ccaddc) @ ccdvds))))).
