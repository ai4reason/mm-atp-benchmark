...
thf(calgr0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((XR = (ccseq @ (cccom @ XF @ cc1st) @ (ccxp @ XZ @ (ccsn @ XA2)) @ XM)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XA2 @ XS)) => (Xph => ((ccfv @ XM @ XR) = XA2)))))))))))))).
