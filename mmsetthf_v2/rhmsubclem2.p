...
thf(crhmsubclem2_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XU @ XV)) => ((XC = (ccfv @ XU @ ccrngc)) => ((Xph => (XR = (ccin @ ccrg @ XU))) => ((XH = (ccres @ ccrh @ (ccxp @ XR @ XR))) => ((cw3a @ Xph @ (cwcel @ XX @ XR) @ (cwcel @ XY @ XR)) => ((cco @ XX @ XY @ XH) = (cco @ XX @ XY @ ccrh)))))))))))))))).
