...
thf(copfv_conj,conjecture,(! [Xx3:$i] : (! [XF:($i > $o)] : ((((cwfun @ XF) & (cwss @ (ccrn @ XF) @ (ccxp @ ccvv @ ccvv))) & (cwcel @ (ccv @ Xx3) @ (ccdm @ XF))) => ((ccfv @ (ccv @ Xx3) @ XF) = (ccop @ (ccfv @ (ccv @ Xx3) @ (cccom @ cc1st @ XF)) @ (ccfv @ (ccv @ Xx3) @ (cccom @ cc2nd @ XF)))))))).
