...
thf(advasin_ax,axiom,(! [XD:($i > $o)] : ((XD = (ccdif @ ccc @ (ccun @ (cco @ ccmnf @ (ccneg @ cc1) @ ccioc) @ (cco @ cc1 @ ccpnf @ ccico)))) => ((cco @ ccc @ (ccres @ ccasin @ XD) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (cco @ cc1 @ (ccfv @ (cco @ cc1 @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccmin) @ ccsqrt) @ ccdiv))))))).
