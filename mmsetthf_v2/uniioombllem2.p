...
thf(aovolfcl_ax,axiom,(! [XF:($i > $o)] : (! [XN:($i > $o)] : (((cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF) & (cwcel @ XN @ ccn)) => (cw3a @ (cwcel @ (ccfv @ (ccfv @ XN @ XF) @ cc1st) @ ccr) @ (cwcel @ (ccfv @ (ccfv @ XN @ XF) @ cc2nd) @ ccr) @ (cwbr @ (ccfv @ (ccfv @ XN @ XF) @ cc1st) @ (ccfv @ (ccfv @ XN @ XF) @ cc2nd) @ ccle)))))).
...
thf(aioorcl_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccrn @ ccioo)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = cc0) @ (ccop @ ccc0 @ ccc0) @ (ccop @ (ccinf @ (ccv @ Xx3) @ ccxr @ cclt) @ (ccsup @ (ccv @ Xx3) @ ccxr @ cclt))))))) => (! [Xx3:$i] : (((cwcel @ XA2 @ (ccrn @ ccioo)) & (cwcel @ (ccfv @ XA2 @ ccovol) @ ccr)) => (cwcel @ (ccfv @ XA2 @ (XF @ Xx3)) @ (ccin @ ccle @ (ccxp @ ccr @ ccr))))))))).
...
thf(aioorf_ax,axiom,(! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccrn @ ccioo)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = cc0) @ (ccop @ ccc0 @ ccc0) @ (ccop @ (ccinf @ (ccv @ Xx3) @ ccxr @ cclt) @ (ccsup @ (ccv @ Xx3) @ ccxr @ cclt))))))) => (! [Xx3:$i] : (cwf @ (ccrn @ ccioo) @ (ccin @ ccle @ (ccxp @ ccxr @ ccxr)) @ (XF @ Xx3)))))).
thf(ccio_tp,type,(ccio : (($i > $o) > ($i > $o)))).
thf(afveq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))).
thf(ccc_tp,type,(ccc : ($i > $o))).
thf(aovolfsf_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (cccom @ (cccom @ ccabs @ ccmin) @ XF)) => ((cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF) => (cwf @ ccn @ (cco @ ccc0 @ ccpnf @ ccico) @ XG)))))).
...
thf(auniioovol_ax,axiom,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : ((Xph => (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((Xph => (cwdisj @ (^ [Xx3:$i] : ccn) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccioo)))) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1))) => (! [Xx3:$i] : (Xph => ((ccfv @ (ccuni @ (ccrn @ (cccom @ ccioo @ XF))) @ ccovol) = (ccsup @ (ccrn @ (XS @ Xx3)) @ ccxr @ cclt))))))))))).
...
thf(aioorinv_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (ccrn @ ccioo)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = cc0) @ (ccop @ ccc0 @ ccc0) @ (ccop @ (ccinf @ (ccv @ Xx3) @ ccxr @ cclt) @ (ccsup @ (ccv @ Xx3) @ ccxr @ cclt))))))) => (! [Xx3:$i] : ((cwcel @ XA2 @ (ccrn @ ccioo)) => ((ccfv @ (ccfv @ XA2 @ (XF @ Xx3)) @ ccioo) = XA2))))))).
...
thf(aovolfs2_ax,axiom,(! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XG = (cccom @ (cccom @ ccabs @ ccmin) @ XF)) => ((cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF) => (XG = (cccom @ (cccom @ ccovol @ ccioo) @ XF))))))).
...
thf(cuniioombllem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XF)) => ((Xph => (cwdisj @ (^ [Xx3:$i] : ccn) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccioo)))) => ((! [Xx3:$i] : (! [Xz:$i] : ((XS @ Xx3 @ Xz) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XF) @ cc1)))) => ((XA2 = (ccuni @ (ccrn @ (cccom @ ccioo @ XF)))) => ((! [Xx3:$i] : (! [Xz:$i] : (Xph => (cwcel @ (ccfv @ (XE @ Xx3 @ Xz) @ ccovol) @ ccr)))) => ((Xph => (cwcel @ XC @ ccrp)) => ((Xph => (cwf @ ccn @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ XG)) => ((! [Xx3:$i] : (! [Xz:$i] : (Xph => (cwss @ (XE @ Xx3 @ Xz) @ (ccuni @ (ccrn @ (cccom @ ccioo @ XG))))))) => ((XT = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ XG) @ cc1)) => ((! [Xx3:$i] : (! [Xz:$i] : (Xph => (cwbr @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ (cco @ (ccfv @ (XE @ Xx3 @ Xz) @ ccovol) @ XC @ ccaddc) @ ccle)))) => ((XH = (ccmpt @ (^ [Xz:$i] : ccn) @ (^ [Xz:$i] : (ccin @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ ccioo) @ (ccfv @ (ccfv @ XJ @ XG) @ ccioo))))) => ((XK = (ccmpt @ (^ [Xx3:$i] : (ccrn @ ccioo)) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = cc0) @ (ccop @ ccc0 @ ccc0) @ (ccop @ (ccinf @ (ccv @ Xx3) @ ccxr @ cclt) @ (ccsup @ (ccv @ Xx3) @ ccxr @ cclt)))))) => ((Xph & (cwcel @ XJ @ ccn)) => (cwbr @ (ccseq @ ccaddc @ (cccom @ ccovol @ XH) @ cc1) @ (ccfv @ (ccin @ (ccfv @ (ccfv @ XJ @ XG) @ ccioo) @ XA2) @ ccovol) @ ccli)))))))))))))))))))))))))).
