...
thf(czm1nn_conj,conjecture,(! [XJ:($i > $o)] : (! [XL:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwcel @ XL @ ccz)) => ((cw3a @ (cwcel @ XJ @ ccr) @ (cwbr @ ccc0 @ XJ @ ccle) @ (cwbr @ XJ @ (cco @ (cco @ XL @ XN @ ccmin) @ cc1 @ ccmin) @ cclt)) => (cwcel @ (cco @ XL @ cc1 @ ccmin) @ ccn))))))).
