...
thf(c_2polcon4bN_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pe = (ccfv @ XK @ ccpolN)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cwss @ XX @ XA2) @ (cwss @ XY @ XA2)) => ((cwss @ (ccfv @ (ccfv @ XX @ Xc_pe) @ Xc_pe) @ (ccfv @ (ccfv @ XY @ Xc_pe) @ Xc_pe)) <=> (cwss @ (ccfv @ XY @ Xc_pe) @ (ccfv @ XX @ Xc_pe)))))))))))).
