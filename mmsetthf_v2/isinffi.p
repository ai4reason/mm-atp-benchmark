...
thf(aisinf_ax,axiom,(! [XA2:($i > $o)] : ((~ (cwcel @ XA2 @ ccfn)) => (cwral @ (^ [Xn:$i] : (? [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XA2) & (cwbr @ (ccv @ Xx3) @ (ccv @ Xn) @ ccen)))) @ (^ [Xn:$i] : ccom))))).
...
thf(cisinffi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((~ (cwcel @ XA2 @ ccfn)) & (cwcel @ XB2 @ ccfn)) => (? [Xf1:$i] : (cwf1 @ XB2 @ XA2 @ (ccv @ Xf1))))))).
