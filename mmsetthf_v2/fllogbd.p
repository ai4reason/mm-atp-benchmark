...
thf(cfllogbd_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XE:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XB2 @ (ccfv @ cc2 @ ccuz))) => ((Xph => (cwcel @ XX @ ccrp)) => ((XE = (ccfv @ (cco @ XB2 @ XX @ cclogb) @ ccfl)) => (Xph => ((cwbr @ (cco @ XB2 @ XE @ ccexp) @ XX @ ccle) & (cwbr @ XX @ (cco @ XB2 @ (cco @ XE @ cc1 @ ccaddc) @ ccexp) @ cclt))))))))))).
