...
thf(acom35_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xph => (Xps => (Xch => (Xth => (Xta => Xet))))) => (Xph => (Xps => (Xta => (Xth => (Xch => Xet))))))))))))).
...
thf(abdaydm_ax,axiom,((ccdm @ ccbday) = ccsur)).
thf(ampan_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (((Xph & Xps) => Xch) => (Xps => Xch))))))).
thf(abdayfun_ax,axiom,(cwfun @ ccbday)).
...
thf(abdayrn_ax,axiom,((ccrn @ ccbday) = ccon0)).
thf(ane0i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ XA2) => (cwne @ XA2 @ cc0))))).
thf(aoninton_ax,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccon0) & (cwne @ XA2 @ cc0)) => (cwcel @ (ccint @ XA2) @ ccon0)))).
thf(abdayelon_ax,axiom,(! [XA2:($i > $o)] : (cwcel @ (ccfv @ XA2 @ ccbday) @ ccon0))).
...
thf(anodense_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccsur) & (cwcel @ XB2 @ ccsur)) & (((ccfv @ XA2 @ ccbday) = (ccfv @ XB2 @ ccbday)) & (cwbr @ XA2 @ XB2 @ ccslt))) => (cwrex @ (^ [Xx3:$i] : (cw3a @ (cwcel @ (ccfv @ (ccv @ Xx3) @ ccbday) @ (ccfv @ XA2 @ ccbday)) @ (cwbr @ XA2 @ (ccv @ Xx3) @ ccslt) @ (cwbr @ (ccv @ Xx3) @ XB2 @ ccslt))) @ (^ [Xx3:$i] : ccsur)))))).
thf(cnocvxminlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : (! [Xx3:$i] : (((cwss @ XA2 @ ccsur) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (((cwbr @ (ccv @ Xx3) @ (ccv @ Xz) @ ccslt) & (cwbr @ (ccv @ Xz) @ (ccv @ Xy1) @ ccslt)) => (cwcel @ (ccv @ Xz) @ XA2))) @ (^ [Xz:$i] : ccsur))) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))) => ((((cwcel @ XX @ XA2) & (cwcel @ (XY @ Xx3) @ XA2)) & (((ccfv @ XX @ ccbday) = (ccint @ (ccima @ ccbday @ XA2))) & ((ccfv @ (XY @ Xx3) @ ccbday) = (ccint @ (ccima @ ccbday @ XA2))))) => (~ (cwbr @ XX @ (XY @ Xx3) @ ccslt))))))))).
