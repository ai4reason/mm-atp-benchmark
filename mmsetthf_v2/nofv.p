...
thf(aelpr2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XA2 @ (ccpr @ XB2 @ XC)) <=> ((XA2 = XB2) | (XA2 = XC))))))))).
...
thf(cnofv_conj,conjecture,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XA2 @ ccsur) => (cw3o @ ((ccfv @ XX @ XA2) = cc0) @ ((ccfv @ XX @ XA2) = cc1o) @ ((ccfv @ XX @ XA2) = cc2o)))))).
