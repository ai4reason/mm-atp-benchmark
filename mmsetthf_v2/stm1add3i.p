...
thf(astm1addi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwcel @ XS @ ccst) => (((ccfv @ (ccin @ XA2 @ XB2) @ XS) = cc1) => ((cco @ (ccfv @ XA2 @ XS) @ (ccfv @ XB2 @ XS) @ ccaddc) = cc2))))))))).
