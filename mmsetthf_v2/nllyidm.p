...
thf(anllyrest_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (((cwcel @ XJ @ (ccnlly @ XA2)) & (cwcel @ XB2 @ XJ)) => (cwcel @ (cco @ XJ @ XB2 @ ccrest) @ (ccnlly @ XA2))))))).
thf(anllytop_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : ((cwcel @ XJ @ (ccnlly @ XA2)) => (cwcel @ XJ @ cctop))))).
thf(cnllyidm_conj,conjecture,(! [XA2:($i > $o)] : ((cclly @ (ccnlly @ XA2)) = (ccnlly @ XA2)))).
