...
thf(aiimulcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccicc)) & (cwcel @ XB2 @ (cco @ ccc0 @ cc1 @ ccicc))) => (cwcel @ (cco @ XA2 @ XB2 @ ccmul) @ (cco @ ccc0 @ cc1 @ ccicc)))))).
...
thf(ciistmd_conj,conjecture,(! [XI:($i > $o)] : ((XI = (cco @ (ccfv @ cccnfld @ ccmgp) @ (cco @ ccc0 @ cc1 @ ccicc) @ ccress)) => (cwcel @ XI @ cctmd)))).
