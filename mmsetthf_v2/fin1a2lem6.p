...
thf(afin1a2lem2_ax,axiom,(! [XS:($i > ($i > $o))] : ((! [Xx3:$i] : ((XS @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccon0) @ (^ [Xx3:$i] : (ccsuc @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwf1 @ ccon0 @ ccon0 @ (XS @ Xx3)))))).
...
thf(afin1a2lem1_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : ((! [Xx3:$i] : ((XS @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccon0) @ (^ [Xx3:$i] : (ccsuc @ (ccv @ Xx3)))))) => (! [Xx3:$i] : ((cwcel @ (XA2 @ Xx3) @ ccon0) => ((ccfv @ (XA2 @ Xx3) @ (XS @ Xx3)) = (ccsuc @ (XA2 @ Xx3))))))))).
...
thf(afin1a2lem5_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : ((! [Xx3:$i] : ((XE @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccom) @ (^ [Xx3:$i] : (cco @ cc2o @ (ccv @ Xx3) @ ccomu))))) => (! [Xx3:$i] : ((cwcel @ (XA2 @ Xx3) @ ccom) => ((cwcel @ (XA2 @ Xx3) @ (ccrn @ (XE @ Xx3))) <=> (~ (cwcel @ (ccsuc @ (XA2 @ Xx3)) @ (ccrn @ (XE @ Xx3))))))))))).
...
thf(cfin1a2lem6_conj,conjecture,(! [XS:($i > ($i > $o))] : (! [XE:($i > ($i > $o))] : ((! [Xx3:$i] : ((XE @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccom) @ (^ [Xx3:$i] : (cco @ cc2o @ (ccv @ Xx3) @ ccomu))))) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccon0) @ (^ [Xx3:$i] : (ccsuc @ (ccv @ Xx3)))))) => (! [Xx3:$i] : (cwf1o @ (ccrn @ (XE @ Xx3)) @ (ccdif @ ccom @ (ccrn @ (XE @ Xx3))) @ (ccres @ (XS @ Xx3) @ (ccrn @ (XE @ Xx3)))))))))).
