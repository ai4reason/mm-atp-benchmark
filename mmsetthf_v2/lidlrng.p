...
thf(alidlabl_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((XL = (ccfv @ XR @ cclidl)) => ((XI = (cco @ XR @ XU @ ccress)) => (((cwcel @ XR @ ccrg) & (cwcel @ XU @ XL)) => (cwcel @ XI @ ccabl))))))))).
thf(ccmnd_tp,type,(ccmnd : ($i > $o))).
thf(ccmgm_tp,type,(ccmgm : ($i > $o))).
thf(alidlmsgrp_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((XL = (ccfv @ XR @ cclidl)) => ((XI = (cco @ XR @ XU @ ccress)) => (((cwcel @ XR @ ccrg) & (cwcel @ XU @ XL)) => (cwcel @ (ccfv @ XI @ ccmgp) @ ccsgrp))))))))).
...
thf(alidlssbas_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((XL = (ccfv @ XR @ cclidl)) => ((XI = (cco @ XR @ XU @ ccress)) => ((cwcel @ XU @ XL) => (cwss @ (ccfv @ XI @ ccbs) @ (ccfv @ XR @ ccbs)))))))))).
...
thf(clidlrng_conj,conjecture,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : ((XL = (ccfv @ XR @ cclidl)) => ((XI = (cco @ XR @ XU @ ccress)) => (((cwcel @ XR @ ccrg) & (cwcel @ XU @ XL)) => (cwcel @ XI @ ccrng))))))))).
