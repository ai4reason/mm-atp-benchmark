...
thf(adf_hlg_ax,axiom,(cchlg = (ccmpt @ (^ [Xg1:$i] : ccvv) @ (^ [Xg1:$i] : (ccmpt @ (^ [Xc:$i] : (ccfv @ (ccv @ Xg1) @ ccbs)) @ (^ [Xc:$i] : (ccopab @ (^ [Xa:$i] : (^ [Xb:$i] : (((cwcel @ (ccv @ Xa) @ (ccfv @ (ccv @ Xg1) @ ccbs)) & (cwcel @ (ccv @ Xb) @ (ccfv @ (ccv @ Xg1) @ ccbs))) & (cw3a @ (cwne @ (ccv @ Xa) @ (ccv @ Xc)) @ (cwne @ (ccv @ Xb) @ (ccv @ Xc)) @ ((cwcel @ (ccv @ Xa) @ (cco @ (ccv @ Xc) @ (ccv @ Xb) @ (ccfv @ (ccv @ Xg1) @ ccitv))) | (cwcel @ (ccv @ Xb) @ (cco @ (ccv @ Xc) @ (ccv @ Xa) @ (ccfv @ (ccv @ Xg1) @ ccitv))))))))))))))).
