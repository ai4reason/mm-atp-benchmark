...
thf(apmtrfconj_ax,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((XR = (ccrn @ XT)) => (((cwcel @ XF @ XR) & (cwf1o @ XD @ XD @ XG)) => (cwcel @ (cccom @ (cccom @ XG @ XF) @ (cccnv @ XG)) @ XR)))))))))).
...
thf(aen2eleq_ax,axiom,(! [XP:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ XP) & (cwbr @ XP @ cc2o @ ccen)) => (XP = (ccpr @ XX @ (ccuni @ (ccdif @ XP @ (ccsn @ XX))))))))).
...
thf(apmtrffv_ax,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XZ:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((XR = (ccrn @ XT)) => ((XP = (ccdm @ (ccdif @ XF @ ccid))) => (((cwcel @ XF @ XR) & (cwcel @ XZ @ XD)) => ((ccfv @ XZ @ XF) = (ccif @ (cwcel @ XZ @ XP) @ (ccuni @ (ccdif @ XP @ (ccsn @ XZ))) @ XZ))))))))))))).
...
thf(af1otrspeq_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((((cwf1o @ XA2 @ XA2 @ XF) & (cwf1o @ XA2 @ XA2 @ XG)) & ((cwbr @ (ccdm @ (ccdif @ XF @ ccid)) @ cc2o @ ccen) & ((ccdm @ (ccdif @ XG @ ccid)) = (ccdm @ (ccdif @ XF @ ccid))))) => (XF = XG)))))).
...
thf(af1omvdconj_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwf @ XA2 @ XA2 @ XF) & (cwf1o @ XA2 @ XA2 @ XG)) => ((ccdm @ (ccdif @ (cccom @ (cccom @ XG @ XF) @ (cccnv @ XG)) @ ccid)) = (ccima @ XG @ (ccdm @ (ccdif @ XF @ ccid))))))))).
