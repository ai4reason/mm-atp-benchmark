...
thf(adnibndlem11_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => (cwbr @ (ccfv @ (cco @ (ccfv @ (cco @ (ccfv @ (cco @ XB2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ XB2 @ ccmin) @ ccabs) @ (ccfv @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ XA2 @ ccmin) @ ccabs) @ ccmin) @ ccabs) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccle)))))))).
...
thf(adnibndlem10_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ (cco @ (ccfv @ (cco @ XA2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ cc2 @ ccaddc) @ (ccfv @ (cco @ XB2 @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ ccfl) @ ccle)) => (Xph => (cwbr @ cc1 @ (cco @ XB2 @ XA2 @ ccmin) @ ccle))))))))).
