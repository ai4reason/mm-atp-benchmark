...
thf(anuleldmp_ax,axiom,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprb) => (cwcel @ cc0 @ (ccdm @ XP))))).
...
thf(aprobnul_ax,axiom,(! [XP:($i > $o)] : ((cwcel @ XP @ ccprb) => ((ccfv @ cc0 @ XP) = ccc0)))).
...
thf(aelunitcn_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ cc1 @ ccicc)) => (cwcel @ XA2 @ ccc)))).
thf(asimp3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((cw3a @ Xph @ Xps @ Xch) => Xch))))).
thf(ccndprobnul_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprb) @ (cwcel @ XA2 @ (ccdm @ XP)) @ (cwne @ (ccfv @ XA2 @ XP) @ ccc0)) => ((ccfv @ (ccop @ cc0 @ XA2) @ (ccfv @ XP @ cccprob)) = ccc0))))).
