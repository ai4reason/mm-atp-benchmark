...
thf(ar19_27v_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > ($i > $o))] : (((cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) & Xps) => (cwral @ (^ [Xx3:$i] : ((Xph @ Xx3) & Xps)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))).
...
thf(ar19_28v_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : ((Xph & (cwral @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))) => (cwral @ (^ [Xx3:$i] : (Xph & (Xps @ Xx3))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))).
...
thf(aopelxp2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ (ccop @ XA2 @ XB2) @ (ccxp @ XC @ XD)) => (cwcel @ XB2 @ XD))))))).
thf(aanbi1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph <=> Xps) => ((Xph & Xch) <=> (Xps & Xch))))))).
thf(asyl6bb_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps <=> Xch)) => ((Xch <=> Xth) => (Xph => (Xps <=> Xth))))))))).
thf(ccpm_tp,type,(ccpm : ($i > $o))).
thf(ccc_tp,type,(ccc : ($i > $o))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(almbrf_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((! [Xu:$i] : (! [Xk:$i] : (XZ = (ccfv @ (XM @ Xu @ Xk) @ ccuz)))) => ((! [Xu:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XM @ Xu @ Xk) @ ccz)))) => ((Xph => (cwf @ XZ @ XX @ XF)) => ((! [Xu:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XF) = (XA2 @ Xu @ Xj @ Xk)))))) => (Xph => ((cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) <=> ((cwcel @ XP @ XX) & (cwral @ (^ [Xu:$i] : ((cwcel @ XP @ (ccv @ Xu)) => (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwcel @ (XA2 @ Xu @ Xj @ Xk) @ (ccv @ Xu))) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : XZ)))) @ (^ [Xu:$i] : XJ))))))))))))))))))).
...
thf(ctxlm_conj,conjecture,(! [Xph:$o] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xn:$i] : (XZ = (ccfv @ (XM @ Xn) @ ccuz))) => ((! [Xn:$i] : (Xph => (cwcel @ (XM @ Xn) @ ccz))) => ((Xph => (cwcel @ XJ @ (ccfv @ XX @ cctopon))) => ((Xph => (cwcel @ XK @ (ccfv @ XY @ cctopon))) => ((Xph => (cwf @ XZ @ XX @ XF)) => ((Xph => (cwf @ XZ @ XY @ XG)) => ((! [Xn:$i] : ((XH @ Xn) = (ccmpt @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (ccop @ (ccfv @ (ccv @ Xn) @ XF) @ (ccfv @ (ccv @ Xn) @ XG)))))) => (! [Xn:$i] : (Xph => (((cwbr @ XF @ (XR @ Xn) @ (ccfv @ XJ @ cclm)) & (cwbr @ XG @ (XS @ Xn) @ (ccfv @ XK @ cclm))) <=> (cwbr @ (XH @ Xn) @ (ccop @ (XR @ Xn) @ (XS @ Xn)) @ (ccfv @ (cco @ XJ @ XK @ cctx) @ cclm))))))))))))))))))))))))).
