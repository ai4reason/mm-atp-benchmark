...
thf(asubrgacs_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((cwcel @ XR @ ccrg) => (cwcel @ (ccfv @ XR @ ccsubrg) @ (ccfv @ XB2 @ ccacs))))))).
...
thf(csdrgacs_conj,conjecture,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((cwcel @ XR @ ccdr) => (cwcel @ (ccfv @ XR @ ccsdrg) @ (ccfv @ XB2 @ ccacs))))))).
