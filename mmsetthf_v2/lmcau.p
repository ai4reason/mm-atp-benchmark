...
thf(almmbr_ax,axiom,(! [Xph:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XD @ (ccfv @ XX @ ccxmt)))) => (! [Xy1:$i] : ((Xph @ Xy1) => ((cwbr @ XF @ XP @ (ccfv @ XJ @ cclm)) <=> (cw3a @ (cwcel @ XF @ (cco @ XX @ ccc @ ccpm)) @ (cwcel @ XP @ XX) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwf @ (ccv @ Xy1) @ (cco @ XP @ (ccv @ Xx3) @ (ccfv @ XD @ ccbl)) @ (ccres @ XF @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : (ccrn @ ccuz)))) @ (^ [Xx3:$i] : ccrp))))))))))))))).
...
thf(clmcau_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => (cwss @ (ccdm @ (ccfv @ XJ @ cclm)) @ (ccfv @ XD @ ccca)))))))).
