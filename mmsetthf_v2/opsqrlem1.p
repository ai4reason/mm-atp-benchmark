...
thf(ahmopm_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XT @ ccho)) => (cwcel @ (cco @ XA2 @ XT @ cchot) @ ccho))))).
...
thf(aleopmuli_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwcel @ XT @ ccho)) & ((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ cch0o @ XT @ ccleo))) => (cwbr @ cch0o @ (cco @ XA2 @ XT @ cchot) @ ccleo))))).
...
thf(ahomco1_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwf @ cchil @ cchil @ XT) @ (cwf @ cchil @ cchil @ XU)) => ((cccom @ (cco @ XA2 @ XT @ cchot) @ XU) = (cco @ XA2 @ (cccom @ XT @ XU) @ cchot))))))).
thf(aoveq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))))).
thf(ccaddc_tp,type,(ccaddc : ($i > $o))).
thf(ccva_tp,type,(ccva : ($i > $o))).
thf(ahmoplin_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ ccho) => (cwcel @ XT @ cclo)))).
thf(ahomco2_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XT @ cclo) @ (cwf @ cchil @ cchil @ XU)) => ((cccom @ XT @ (cco @ XA2 @ XU @ cchot)) = (cco @ XA2 @ (cccom @ XT @ XU) @ cchot))))))).
thf(asyl5reqr_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XB2 = XA2) => ((Xph => (XB2 = XC)) => (Xph => (XC = XA2))))))))).
thf(aoveq1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XC @ XF)))))))).
thf(asqrtthi_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwbr @ ccc0 @ XA2 @ ccle) => ((cco @ (ccfv @ XA2 @ ccsqrt) @ (ccfv @ XA2 @ ccsqrt) @ ccmul) = XA2))))).
...
thf(anmlnopne0_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => ((cwne @ (ccfv @ XT @ ccnop) @ ccc0) <=> (cwne @ XT @ cch0o))))).
thf(arecidzi_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwne @ XA2 @ ccc0) => ((cco @ XA2 @ (cco @ cc1 @ XA2 @ ccdiv) @ ccmul) = cc1))))).
thf(arecnd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => (Xph => (cwcel @ XA2 @ ccc)))))).
thf(arerecclzi_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwne @ XA2 @ ccc0) => (cwcel @ (cco @ cc1 @ XA2 @ ccdiv) @ ccr))))).
