...
thf(apm4_71_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph => Xps) <=> (Xph <=> (Xph & Xps)))))).
...
thf(cdmopab3_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : ((cwral @ (^ [Xx3:$i] : (? [Xy1:$i] : (Xph @ Xx3 @ Xy1))) @ (^ [Xx3:$i] : XA2)) <=> ((ccdm @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) & (Xph @ Xx3 @ Xy1)))))) = XA2))))).
