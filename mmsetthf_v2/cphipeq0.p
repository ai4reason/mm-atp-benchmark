...
thf(ccphipeq0_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_xi = (ccfv @ XW @ ccip)) => ((XV = (ccfv @ XW @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => (((cwcel @ XW @ cccph) & (cwcel @ XA2 @ XV)) => (((cco @ XA2 @ XA2 @ Xc_xi) = ccc0) <=> (XA2 = Xc_0)))))))))))).
