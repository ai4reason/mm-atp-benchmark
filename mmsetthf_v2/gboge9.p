...
thf(aan6_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (((cw3a @ Xph @ Xps @ Xch) & (cw3a @ Xth @ Xta @ Xet)) <=> (cw3a @ (Xph & Xth) @ (Xps & Xta) @ (Xch & Xet)))))))))).
...
thf(aoddprmuzge3_ax,axiom,(! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XP @ ccodd)) => (cwcel @ XP @ (ccfv @ cc3 @ ccuz))))).
...
thf(cgboge9_conj,conjecture,(! [XZ:($i > $o)] : ((cwcel @ XZ @ ccgbo) => (cwbr @ cc9 @ XZ @ ccle)))).
