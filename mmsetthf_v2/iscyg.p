...
thf(adf_cyg_ax,axiom,(cccyg = (ccrab @ (^ [Xg1:$i] : (cwrex @ (^ [Xx3:$i] : ((ccrn @ (ccmpt @ (^ [Xn:$i] : ccz) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xg1) @ ccmg))))) = (ccfv @ (ccv @ Xg1) @ ccbs))) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xg1) @ ccbs)))) @ (^ [Xg1:$i] : ccgrp)))).
thf(ciscyg_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((cwcel @ XG @ cccyg) <=> ((cwcel @ XG @ ccgrp) & (cwrex @ (^ [Xx3:$i] : ((ccrn @ (ccmpt @ (^ [Xn:$i] : ccz) @ (^ [Xn:$i] : (cco @ (ccv @ Xn) @ (ccv @ Xx3) @ Xc_x)))) = XB2)) @ (^ [Xx3:$i] : XB2)))))))))).
