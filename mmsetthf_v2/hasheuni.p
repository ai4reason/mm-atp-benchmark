...
thf(ahashunif_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ ccfn))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XA2 @ ccfn))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3))))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccfv @ (ccuni @ XA2) @ cchash) = (ccsu @ XA2 @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ cchash))))))))))))).
...
thf(ahashf2_ax,axiom,(cwf @ ccvv @ (cco @ ccc0 @ ccpnf @ ccicc) @ cchash)).
