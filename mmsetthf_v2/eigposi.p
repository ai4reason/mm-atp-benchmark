...
thf(aeigrei_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ ccc) => ((((ccfv @ XA2 @ XT) = (cco @ XB2 @ XA2 @ ccsm)) & (cwne @ XA2 @ cc0v)) => (((cco @ XA2 @ (ccfv @ XA2 @ XT) @ ccsp) = (cco @ (ccfv @ XA2 @ XT) @ XA2 @ ccsp)) <=> (cwcel @ XB2 @ ccr))))))))).
...
thf(aax_his4_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwne @ XA2 @ cc0v)) => (cwbr @ ccc0 @ (cco @ XA2 @ XA2 @ ccsp) @ cclt)))).
...
thf(ceigposi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XA2 @ cchil) => ((cwcel @ XB2 @ ccc) => ((((cwcel @ (cco @ XA2 @ (ccfv @ XA2 @ XT) @ ccsp) @ ccr) & (cwbr @ ccc0 @ (cco @ XA2 @ (ccfv @ XA2 @ XT) @ ccsp) @ ccle)) & (((ccfv @ XA2 @ XT) = (cco @ XB2 @ XA2 @ ccsm)) & (cwne @ XA2 @ cc0v))) => ((cwcel @ XB2 @ ccr) & (cwbr @ ccc0 @ XB2 @ ccle))))))))).
