...
thf(cupwlksfval_conj,conjecture,(! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : ((! [Xf1:$i] : (! [Xk:$i] : ((XV @ Xf1 @ Xk) = (ccfv @ XG @ ccvtx)))) => ((! [Xk:$i] : ((XI @ Xk) = (ccfv @ XG @ cciedg))) => (! [Xk:$i] : (! [Xp:$i] : ((cwcel @ XG @ (XW @ Xk @ Xp)) => ((ccfv @ XG @ ccupwlks) = (ccopab @ (^ [Xf1:$i] : (^ [Xp:$i] : (cw3a @ (cwcel @ (ccv @ Xf1) @ (ccword @ (ccdm @ (XI @ Xk)))) @ (cwf @ (cco @ ccc0 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfz) @ (XV @ Xf1 @ Xk) @ (ccv @ Xp)) @ (cwral @ (^ [Xk:$i] : ((ccfv @ (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)) @ (XI @ Xk)) = (ccpr @ (ccfv @ (ccv @ Xk) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (ccv @ Xp))))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xf1) @ cchash) @ ccfzo)))))))))))))))))).
