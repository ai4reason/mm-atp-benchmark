...
thf(acosbnd2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwcel @ (ccfv @ XA2 @ cccos) @ (cco @ (ccneg @ cc1) @ cc1 @ ccicc))))).
...
thf(acos11_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (cco @ ccc0 @ ccpi @ ccicc)) & (cwcel @ XB2 @ (cco @ ccc0 @ ccpi @ ccicc))) => ((XA2 = XB2) <=> ((ccfv @ XA2 @ cccos) = (ccfv @ XB2 @ cccos))))))).
...
thf(acospi_ax,axiom,((ccfv @ ccpi @ cccos) = (ccneg @ cc1))).
...
thf(crecosf1o_conj,conjecture,(cwf1o @ (cco @ ccc0 @ ccpi @ ccicc) @ (cco @ (ccneg @ cc1) @ cc1 @ ccicc) @ (ccres @ cccos @ (cco @ ccc0 @ ccpi @ ccicc)))).
