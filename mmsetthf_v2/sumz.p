...
thf(aser0_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((cwcel @ XN @ XZ) => ((ccfv @ XN @ (ccseq @ ccaddc @ (ccxp @ XZ @ (ccsn @ ccc0)) @ XM)) = ccc0))))))).
thf(annuz_ax,axiom,(ccn = (ccfv @ cc1 @ ccuz))).
thf(csumz_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (((cwss @ XA2 @ (ccfv @ XM @ ccuz)) | (cwcel @ XA2 @ ccfn)) => ((ccsu @ XA2 @ (^ [Xk:$i] : ccc0)) = ccc0))))).
