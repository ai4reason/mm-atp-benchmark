...
thf(clspss_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwss @ XU @ XV) @ (cwss @ XT @ XU)) => (cwss @ (ccfv @ XT @ XN) @ (ccfv @ XU @ XN))))))))))).
