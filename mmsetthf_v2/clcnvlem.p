...
thf(acnvintabd_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > $o)] : ((! [Xx3:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xw) => (? [Xx3:$i] : (Xps @ Xx3))))) => (! [Xx3:$i] : (! [Xw:$i] : ((Xph @ Xx3 @ Xw) => ((cccnv @ (ccint @ (ccab @ (^ [Xx3:$i] : (Xps @ Xx3))))) = (ccint @ (ccrab @ (^ [Xw:$i] : (? [Xx3:$i] : (((ccv @ Xw) = (cccnv @ (ccv @ Xx3))) & (Xps @ Xx3)))) @ (^ [Xw:$i] : (ccpw @ (ccxp @ ccvv @ ccvv))))))))))))).
...
thf(aintabssd_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XV:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : (Xph => (cwcel @ (XA2 @ Xy1) @ (XV @ Xx3 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((ccv @ Xx3) = (XA2 @ Xy1))) => ((Xch @ Xy1) => (Xps @ Xx3))))) => ((! [Xy1:$i] : (Xph => (cwss @ (XA2 @ Xy1) @ (ccv @ Xy1)))) => (Xph => (cwss @ (ccint @ (ccab @ (^ [Xx3:$i] : (Xps @ Xx3)))) @ (ccint @ (ccab @ (^ [Xy1:$i] : (Xch @ Xy1))))))))))))))).
...
thf(arelin2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwrel @ XB2) => (cwrel @ (ccin @ XA2 @ XB2)))))).
...
thf(acnvnonrel_ax,axiom,(! [XA2:($i > $o)] : ((cccnv @ (ccdif @ XA2 @ (cccnv @ (cccnv @ XA2)))) = cc0))).
...
thf(cclcnvlem_conj,conjecture,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((ccv @ Xx3) = (ccun @ (cccnv @ (ccv @ Xy1)) @ (ccdif @ XX @ (cccnv @ (cccnv @ XX)))))) => ((Xch @ Xy1) => (Xps @ Xx3))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((ccv @ Xy1) = (cccnv @ (ccv @ Xx3)))) => ((Xps @ Xx3) => (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XA2 @ Xy1)) => ((Xps @ Xx3) <=> (Xth @ Xy1))))) => ((! [Xy1:$i] : (Xph => (cwss @ XX @ (XA2 @ Xy1)))) => ((! [Xy1:$i] : (Xph => (cwcel @ (XA2 @ Xy1) @ ccvv))) => ((! [Xy1:$i] : (Xph => (Xth @ Xy1))) => (Xph => ((cccnv @ (ccint @ (ccab @ (^ [Xx3:$i] : ((cwss @ XX @ (ccv @ Xx3)) & (Xps @ Xx3)))))) = (ccint @ (ccab @ (^ [Xy1:$i] : ((cwss @ (cccnv @ XX) @ (ccv @ Xy1)) & (Xch @ Xy1)))))))))))))))))))).
