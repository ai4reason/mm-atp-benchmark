...
thf(cmvrf1_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XS = (cco @ XI @ XR @ ccmps)) => ((XV = (cco @ XI @ XR @ ccmvr)) => ((XB2 = (ccfv @ XS @ ccbs)) => ((Xph => (cwcel @ XI @ XW)) => ((Xph => (cwcel @ XR @ ccrg)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((Xph => (cwne @ Xc_1 @ Xc_0)) => (Xph => (cwf1 @ XI @ XB2 @ XV)))))))))))))))))))).
