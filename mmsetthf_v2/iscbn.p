...
thf(adf_cbn_ax,axiom,(cccbn = (ccrab @ (^ [Xu:$i] : (cwcel @ (ccfv @ (ccv @ Xu) @ ccims) @ (ccfv @ (ccfv @ (ccv @ Xu) @ ccba) @ ccms))) @ (^ [Xu:$i] : ccnv)))).
thf(ciscbn_conj,conjecture,(! [XD:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XU @ ccba)) => ((XD = (ccfv @ XU @ ccims)) => ((cwcel @ XU @ cccbn) <=> ((cwcel @ XU @ ccnv) & (cwcel @ XD @ (ccfv @ XX @ ccms)))))))))).
