...
thf(cfourierdlem56_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XK:($i > ($i > $o))] : ((! [Xs1:$i] : ((XK @ Xs1) = (ccmpt @ (^ [Xs1:$i] : (cco @ (ccneg @ ccpi) @ ccpi @ ccicc)) @ (^ [Xs1:$i] : (ccif @ ((ccv @ Xs1) = ccc0) @ cc1 @ (cco @ (ccv @ Xs1) @ (cco @ cc2 @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))) => ((Xph => (cwss @ (cco @ XA2 @ XB2 @ ccioo) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ (ccsn @ ccc0)))) => ((! [Xs1:$i] : ((Xph & (cwcel @ (ccv @ Xs1) @ (cco @ XA2 @ XB2 @ ccioo))) => (cwne @ (ccv @ Xs1) @ ccc0))) => (Xph => ((cco @ ccr @ (ccmpt @ (^ [Xs1:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xs1:$i] : (ccfv @ (ccv @ Xs1) @ (XK @ Xs1)))) @ ccdv) = (ccmpt @ (^ [Xs1:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xs1:$i] : (cco @ (cco @ (cco @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ (cco @ (cco @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ cccos) @ cc2 @ ccdiv) @ (ccv @ Xs1) @ ccmul) @ ccmin) @ (cco @ (ccfv @ (cco @ (ccv @ Xs1) @ cc2 @ ccdiv) @ ccsin) @ cc2 @ ccexp) @ ccdiv) @ cc2 @ ccdiv))))))))))))).
