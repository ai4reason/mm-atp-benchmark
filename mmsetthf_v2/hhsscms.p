...
thf(ahhssmet_ax,axiom,(! [XD:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccop @ (ccop @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ (ccres @ ccsm @ (ccxp @ ccc @ XH))) @ (ccres @ ccno @ XH))) => ((XD = (ccfv @ XW @ ccims)) => ((cwcel @ XH @ ccsh) => (cwcel @ XD @ (ccfv @ XH @ ccme))))))))).
...
thf(ahhssims2_ax,axiom,(! [XD:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccop @ (ccop @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ (ccres @ ccsm @ (ccxp @ ccc @ XH))) @ (ccres @ ccno @ XH))) => ((XD = (ccfv @ XW @ ccims)) => ((cwcel @ XH @ ccsh) => (XD = (ccres @ (cccom @ ccno @ ccmv) @ (ccxp @ XH @ XH)))))))))).
