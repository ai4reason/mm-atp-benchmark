...
thf(cclatglbss_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XG = (ccfv @ XK @ ccglb)) => ((cw3a @ (cwcel @ XK @ cccla) @ (cwss @ XT @ XB2) @ (cwss @ XS @ XT)) => (cwbr @ (ccfv @ XT @ XG) @ (ccfv @ XS @ XG) @ Xc_le)))))))))))).
