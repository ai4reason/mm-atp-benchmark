...
thf(afuclid_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XQ = (cco @ XC @ XD @ ccfuc)) => ((XN = (cco @ XC @ XD @ ccnat)) => ((Xc_xb = (ccfv @ XQ @ ccco)) => ((Xc_1 = (ccfv @ XD @ cccid)) => ((Xph => (cwcel @ XR @ (cco @ XF @ XG @ XN))) => (Xph => ((cco @ (cccom @ Xc_1 @ (ccfv @ XG @ cc1st)) @ XR @ (cco @ (ccop @ XF @ XG) @ XG @ Xc_xb)) = XR)))))))))))))))))).
thf(asimpr31_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xet & (cw3a @ Xth @ Xta @ (cw3a @ Xph @ Xps @ Xch))) => Xph)))))))).
thf(afucrid_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XQ = (cco @ XC @ XD @ ccfuc)) => ((XN = (cco @ XC @ XD @ ccnat)) => ((Xc_xb = (ccfv @ XQ @ ccco)) => ((Xc_1 = (ccfv @ XD @ cccid)) => ((Xph => (cwcel @ XR @ (cco @ XF @ XG @ XN))) => (Xph => ((cco @ XR @ (cccom @ Xc_1 @ (ccfv @ XF @ cc1st)) @ (cco @ (ccop @ XF @ XF) @ XG @ Xc_xb)) = XR)))))))))))))))))).
