...
thf(ahatomici_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwne @ XA2 @ cc0h) => (cwrex @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XA2)) @ (^ [Xx3:$i] : ccat)))))).
...
thf(anssne2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwss @ XA2 @ XC) & (~ (cwss @ XB2 @ XC))) => (cwne @ XA2 @ XB2)))))).
thf(aatnemeq0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccat) & (cwcel @ XB2 @ ccat)) => ((cwne @ XA2 @ XB2) <=> ((ccin @ XA2 @ XB2) = cc0h)))))).
...
thf(acvnbtwn3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) => ((cwbr @ XA2 @ XB2 @ cccv) => (((cwss @ XA2 @ XC) & (cwpss @ XC @ XB2)) => (XC = XA2)))))))).
thf(catcvatlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((((cwcel @ XB2 @ ccat) & (cwcel @ XC @ ccat)) & ((cwne @ XA2 @ cc0h) & (cwpss @ XA2 @ (cco @ XB2 @ XC @ cchj)))) => ((~ (cwss @ XB2 @ XA2)) => (cwcel @ XA2 @ ccat)))))))).
