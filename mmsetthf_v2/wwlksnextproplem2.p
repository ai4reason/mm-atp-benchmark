...
thf(cwwlksnextproplem2_conj,conjecture,(! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ (cco @ XN @ cc1 @ ccaddc) @ XG @ ccwwlksn)) => ((XE = (ccfv @ XG @ ccedg)) => (((cwcel @ XW @ XX) & (cwcel @ XN @ ccn0)) => (cwcel @ (ccpr @ (ccfv @ (cco @ XW @ (ccop @ ccc0 @ (cco @ XN @ cc1 @ ccaddc)) @ ccsubstr) @ cclsw) @ (ccfv @ XW @ cclsw)) @ XE)))))))))).
