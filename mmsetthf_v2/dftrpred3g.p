...
thf(atrpredeq3_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = XY) => ((cctrpred @ XA2 @ XR @ XX) = (cctrpred @ XA2 @ XR @ XY)))))))).
...
thf(atrpredelss_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XX @ XA2) & (cwse @ XA2 @ XR)) => ((cwcel @ XY @ (cctrpred @ XA2 @ XR @ XX)) => (cwss @ (cctrpred @ XA2 @ XR @ XY) @ (cctrpred @ XA2 @ XR @ XX))))))))).
