...
thf(afin34i_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccfin3) @ (cwf @ ccom @ (ccpw @ XA2) @ XG) @ (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccv @ Xx3) @ XG) @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ XG))) @ (^ [Xx3:$i] : ccom))) => (cwcel @ (ccuni @ (ccrn @ XG)) @ (ccrn @ XG)))))).
...
thf(afin1a2lem11_ax,axiom,(! [XA2:($i > $o)] : (((cwor @ XA2 @ ccrpss) & (cwss @ XA2 @ ccfn)) => ((ccrn @ (ccmpt @ (^ [Xb:$i] : ccom) @ (^ [Xb:$i] : (ccuni @ (ccrab @ (^ [Xc:$i] : (cwbr @ (ccv @ Xc) @ (ccv @ Xb) @ ccdom)) @ (^ [Xc:$i] : XA2)))))) = (ccun @ XA2 @ (ccsn @ cc0)))))).
...
thf(cfin1a2lem12_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cw3a @ (cwss @ XA2 @ (ccpw @ XB2)) @ (cwor @ XA2 @ ccrpss) @ (~ (cwcel @ (ccuni @ XA2) @ XA2))) & ((cwss @ XA2 @ ccfn) & (cwne @ XA2 @ cc0))) => (~ (cwcel @ XB2 @ ccfin3)))))).
