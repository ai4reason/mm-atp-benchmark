...
thf(ascmatrhm_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [Xc_as:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XK = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : ((XA2 @ Xx3) = (cco @ XN @ XR @ ccmat))) => ((! [Xx3:$i] : (Xc_1 = (ccfv @ (XA2 @ Xx3) @ ccur))) => ((! [Xx3:$i] : (Xc_as = (ccfv @ (XA2 @ Xx3) @ ccvsca))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XK) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ Xc_1 @ Xc_as))))) => ((XC = (cco @ XN @ XR @ ccscmat)) => ((! [Xx3:$i] : ((XS @ Xx3) = (cco @ (XA2 @ Xx3) @ XC @ ccress))) => (! [Xx3:$i] : (((cwcel @ XN @ ccfn) & (cwcel @ XR @ ccrg)) => (cwcel @ (XF @ Xx3) @ (cco @ XR @ (XS @ Xx3) @ ccrh))))))))))))))))))))).
thf(ampbird_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xch) => ((Xph => (Xps <=> Xch)) => (Xph => Xps))))))).
thf(cwfo_tp,type,(cwfo : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(cwf1_tp,type,(cwf1 : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(ascmatf1o_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [Xc_as:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XK = (ccfv @ XR @ ccbs)) => ((! [Xx3:$i] : ((XA2 @ Xx3) = (cco @ XN @ XR @ ccmat))) => ((! [Xx3:$i] : (Xc_1 = (ccfv @ (XA2 @ Xx3) @ ccur))) => ((! [Xx3:$i] : (Xc_as = (ccfv @ (XA2 @ Xx3) @ ccvsca))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XK) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ Xc_1 @ Xc_as))))) => ((XC = (cco @ XN @ XR @ ccscmat)) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XN @ ccfn) @ (cwne @ XN @ cc0) @ (cwcel @ XR @ ccrg)) => (cwf1o @ XK @ XC @ (XF @ Xx3))))))))))))))))))).
