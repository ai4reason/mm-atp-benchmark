...
thf(csblpnf_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : ((Xph => (cwcel @ XS @ (ccpr @ ccr @ ccc))) => ((XD = (ccres @ (cccom @ ccabs @ ccmin) @ (ccxp @ XS @ XS))) => ((Xph & (cwcel @ XP @ XS)) => ((cco @ XP @ ccpnf @ (ccfv @ XD @ ccbl)) = XS))))))))).
