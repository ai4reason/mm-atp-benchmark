...
thf(aerdisj_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((cwer @ XX @ XR) => (((ccec @ XA2 @ XR) = (ccec @ XB2 @ XR)) | ((ccin @ (ccec @ XA2 @ XR) @ (ccec @ XB2 @ XR)) = cc0)))))))).
thf(cqsdisj_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwer @ XX @ XR)) => ((Xph => (cwcel @ XB2 @ (ccqs @ XA2 @ XR))) => ((Xph => (cwcel @ XC @ (ccqs @ XA2 @ XR))) => (Xph => ((XB2 = XC) | ((ccin @ XB2 @ XC) = cc0))))))))))))).
