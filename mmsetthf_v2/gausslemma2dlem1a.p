...
thf(altoddhalfle_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccz) @ (~ (cwbr @ cc2 @ XN @ ccdvds)) @ (cwcel @ XM @ ccz)) => ((cwbr @ XM @ (cco @ XN @ cc2 @ ccdiv) @ cclt) <=> (cwbr @ XM @ (cco @ (cco @ XN @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccle)))))).
...
thf(ahalfleoddlt_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccz) @ (~ (cwbr @ cc2 @ XN @ ccdvds)) @ (cwcel @ XM @ ccz)) => ((cwbr @ (cco @ XN @ cc2 @ ccdiv) @ XM @ ccle) <=> (cwbr @ (cco @ XN @ cc2 @ ccdiv) @ XM @ cclt)))))).
...
thf(annehalf_ax,axiom,(! [XN:($i > $o)] : (((cwcel @ XN @ ccn) & (cwbr @ cc2 @ XN @ ccdvds)) => (cwcel @ (cco @ XN @ cc2 @ ccdiv) @ ccn)))).
...
thf(aledivge1le_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccrp) @ ((cwcel @ XC @ ccrp) & (cwbr @ cc1 @ XC @ ccle))) => ((cwbr @ XA2 @ XB2 @ ccle) => (cwbr @ (cco @ XA2 @ XC @ ccdiv) @ XB2 @ ccle))))))).
...
thf(cgausslemma2dlem1a_conj,conjecture,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XH:($i > $o)] : ((Xph => (cwcel @ XP @ (ccdif @ ccprime @ (ccsn @ cc2)))) => ((XH = (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv)) => ((! [Xx3:$i] : ((XR @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ XH @ ccfz)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ cc2 @ ccdiv) @ cclt) @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ (cco @ XP @ (cco @ (ccv @ Xx3) @ cc2 @ ccmul) @ ccmin)))))) => (! [Xx3:$i] : (Xph => ((ccrn @ (XR @ Xx3)) = (cco @ cc1 @ XH @ ccfz)))))))))))).
