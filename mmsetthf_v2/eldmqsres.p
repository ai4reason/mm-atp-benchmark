...
thf(aelqsg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xx3:$i] : ((cwcel @ XB2 @ (XV @ Xx3)) => ((cwcel @ XB2 @ (ccqs @ XA2 @ XR)) <=> (cwrex @ (^ [Xx3:$i] : (XB2 = (ccec @ (ccv @ Xx3) @ XR))) @ (^ [Xx3:$i] : XA2)))))))))).
...
thf(aeldmres2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XB2 @ XV) => ((cwcel @ XB2 @ (ccdm @ (ccres @ XR @ XA2))) <=> ((cwcel @ XB2 @ XA2) & (? [Xy1:$i] : (cwcel @ (ccv @ Xy1) @ (ccec @ XB2 @ XR))))))))))).
...
thf(celdmqsres_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xu:$i] : ((cwcel @ (XB2 @ Xx3) @ (XV @ Xx3 @ Xu)) => ((cwcel @ (XB2 @ Xx3) @ (ccqs @ (ccdm @ (ccres @ XR @ XA2)) @ (ccres @ XR @ XA2))) <=> (cwrex @ (^ [Xu:$i] : ((? [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (ccec @ (ccv @ Xu) @ XR))) & ((XB2 @ Xx3) = (ccec @ (ccv @ Xu) @ XR)))) @ (^ [Xu:$i] : XA2))))))))))).
