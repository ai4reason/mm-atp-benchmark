...
thf(aesumsn_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : ((! [Xk:$i] : ((Xph & ((ccv @ Xk) = XM)) => ((XA2 @ Xk) = XB2))) => ((Xph => (cwcel @ XM @ XV)) => ((Xph => (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => (Xph => ((ccesum @ (^ [Xk:$i] : (ccsn @ XM)) @ (^ [Xk:$i] : (XA2 @ Xk))) = XB2))))))))))).
...
thf(afzssnn_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XM @ ccn) => (cwss @ (cco @ XM @ XN @ ccfz) @ ccn))))).
...
thf(cesumfzf_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwnfc @ (^ [Xk:$i] : (XF @ Xk))) => (! [Xk:$i] : (((cwf @ ccn @ (cco @ ccc0 @ ccpnf @ ccicc) @ (XF @ Xk)) & (cwcel @ XN @ ccn)) => ((ccesum @ (^ [Xk:$i] : (cco @ cc1 @ XN @ ccfz)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (XF @ Xk)))) = (ccfv @ XN @ (ccseq @ ccxad @ (XF @ Xk) @ cc1))))))))).
