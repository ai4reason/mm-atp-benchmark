...
thf(cstcltr1i_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) <=> ((cwcel @ XS @ ccst) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((((ccfv @ (ccv @ Xx3) @ XS) = cc1) => ((ccfv @ (ccv @ Xy1) @ XS) = cc1)) => (cwss @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xy1:$i] : ccch))) @ (^ [Xx3:$i] : ccch)))))) => ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => (! [Xx3:$i] : (! [Xy1:$i] : ((Xph @ Xx3 @ Xy1) => ((((ccfv @ XA2 @ XS) = cc1) => ((ccfv @ XB2 @ XS) = cc1)) => (cwss @ XA2 @ XB2))))))))))))).
