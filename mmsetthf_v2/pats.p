...
thf(adf_ats_ax,axiom,(ccatm = (ccmpt @ (^ [Xp:$i] : ccvv) @ (^ [Xp:$i] : (ccrab @ (^ [Xa:$i] : (cwbr @ (ccfv @ (ccv @ Xp) @ ccp0) @ (ccv @ Xa) @ (ccfv @ (ccv @ Xp) @ cccvr))) @ (^ [Xa:$i] : (ccfv @ (ccv @ Xp) @ ccbs))))))).
thf(arabex_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) @ ccvv))))).
thf(aeqeltri_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = XB2) => ((cwcel @ XB2 @ XC) => (cwcel @ XA2 @ XC))))))).
thf(afvex_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (cwcel @ (ccfv @ XA2 @ XF) @ ccvv)))).
thf(cpats_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : ((XB2 = (ccfv @ XK @ ccbs)) => ((! [Xx3:$i] : ((Xc_0 @ Xx3) = (ccfv @ XK @ ccp0))) => ((! [Xx3:$i] : ((XC @ Xx3) = (ccfv @ XK @ cccvr))) => ((! [Xx3:$i] : ((XA2 @ Xx3) = (ccfv @ XK @ ccatm))) => (! [Xx3:$i] : ((cwcel @ XK @ (XD @ Xx3)) => ((XA2 @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwbr @ (Xc_0 @ Xx3) @ (ccv @ Xx3) @ (XC @ Xx3))) @ (^ [Xx3:$i] : XB2)))))))))))))))).
