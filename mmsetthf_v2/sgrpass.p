...
thf(csgrpass_conj,conjecture,(! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_op:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_op = (ccfv @ XG @ ccplusg)) => (((cwcel @ XG @ ccsgrp) & (cw3a @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2) @ (cwcel @ XZ @ XB2))) => ((cco @ (cco @ XX @ XY @ Xc_op) @ XZ @ Xc_op) = (cco @ XX @ (cco @ XY @ XZ @ Xc_op) @ Xc_op)))))))))))).
