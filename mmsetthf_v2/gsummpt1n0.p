...
thf(cgsummpt1n0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xph => (cwcel @ XG @ ccmnd)) => ((! [Xn:$i] : (Xph => (cwcel @ XI @ (XW @ Xn)))) => ((Xph => (cwcel @ XX @ XI)) => ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : XI) @ (^ [Xn:$i] : (ccif @ ((ccv @ Xn) = XX) @ (XA2 @ Xn) @ Xc_0))))) => ((Xph => (cwral @ (^ [Xn:$i] : (cwcel @ (XA2 @ Xn) @ (ccfv @ XG @ ccbs))) @ (^ [Xn:$i] : XI))) => (! [Xn:$i] : (Xph => ((cco @ XG @ (XF @ Xn) @ ccgsu) = (ccsb @ XX @ (^ [Xn:$i] : (XA2 @ Xn))))))))))))))))))))).
