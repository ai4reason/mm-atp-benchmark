...
thf(csqoddm1div8_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (XM = (cco @ (cco @ cc2 @ XN @ ccmul) @ cc1 @ ccaddc))) => ((cco @ (cco @ (cco @ XM @ cc2 @ ccexp) @ cc1 @ ccmin) @ cc8 @ ccdiv) = (cco @ (cco @ XN @ (cco @ XN @ cc1 @ ccaddc) @ ccmul) @ cc2 @ ccdiv)))))).
