...
thf(afrgrwopreglem5lem_ax,axiom,(! [Xy1:$i] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [Xa:$i] : (! [Xb:$i] : ((XV = (ccfv @ XG @ ccvtx)) => ((XD = (ccfv @ XG @ ccvtxdg)) => ((XA2 = (ccrab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XD) = XK)) @ (^ [Xx3:$i] : XV))) => ((XB2 = (ccdif @ XV @ XA2)) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccfv @ XG @ ccedg))) => (! [Xx3:$i] : ((((cwcel @ (ccv @ Xa) @ XA2) & (cwcel @ (ccv @ Xx3) @ XA2)) & ((cwcel @ (ccv @ Xb) @ XB2) & (cwcel @ (ccv @ Xy1) @ XB2))) => (cw3a @ ((ccfv @ (ccv @ Xa) @ XD) = (ccfv @ (ccv @ Xx3) @ XD)) @ (cwne @ (ccfv @ (ccv @ Xa) @ XD) @ (ccfv @ (ccv @ Xb) @ XD)) @ (cwne @ (ccfv @ (ccv @ Xx3) @ XD) @ (ccfv @ (ccv @ Xy1) @ XD))))))))))))))))))))).
thf(afrgrwopreglem5a_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XD = (ccfv @ XG @ ccvtxdg)) => ((XE = (ccfv @ XG @ ccedg)) => ((cw3a @ (cwcel @ XG @ ccfrgr) @ (((cwcel @ XA2 @ XV) & (cwcel @ XX @ XV)) & ((cwcel @ XB2 @ XV) & (cwcel @ XY @ XV))) @ (cw3a @ ((ccfv @ XA2 @ XD) = (ccfv @ XX @ XD)) @ (cwne @ (ccfv @ XA2 @ XD) @ (ccfv @ XB2 @ XD)) @ (cwne @ (ccfv @ XX @ XD) @ (ccfv @ XY @ XD)))) => (((cwcel @ (ccpr @ XA2 @ XB2) @ XE) & (cwcel @ (ccpr @ XB2 @ XX) @ XE)) & ((cwcel @ (ccpr @ XX @ XY) @ XE) & (cwcel @ (ccpr @ XY @ XA2) @ XE)))))))))))))))).
