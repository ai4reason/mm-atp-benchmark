...
thf(aatllat_ax,axiom,(! [XK:($i > $o)] : ((cwcel @ XK @ ccal) => (cwcel @ XK @ cclat)))).
...
thf(csnatpsubN_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((XS = (ccfv @ XK @ ccpsubsp)) => (((cwcel @ XK @ ccal) & (cwcel @ XP @ XA2)) => (cwcel @ (ccsn @ XP) @ XS))))))))).
