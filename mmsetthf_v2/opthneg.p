...
thf(copthneg_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XW)) => ((cwne @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD)) <=> ((cwne @ XA2 @ XC) | (cwne @ XB2 @ XD))))))))))).
