...
thf(afnfz0hash_ax,axiom,(! [XF:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwfn @ XF @ (cco @ ccc0 @ XN @ ccfz))) => ((ccfv @ XF @ cchash) = (cco @ XN @ cc1 @ ccaddc)))))).
