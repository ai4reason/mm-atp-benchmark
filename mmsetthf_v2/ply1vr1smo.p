...
thf(cply1vr1smo_conj,conjecture,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XP = (ccfv @ XR @ ccpl1)) => ((Xc_1 = (ccfv @ XR @ ccur)) => ((Xc_x = (ccfv @ XP @ ccvsca)) => ((XG = (ccfv @ XP @ ccmgp)) => ((Xc_ex = (ccfv @ XG @ ccmg)) => ((XX = (ccfv @ XR @ ccv1)) => ((cwcel @ XR @ ccrg) => ((cco @ Xc_1 @ (cco @ cc1 @ XX @ Xc_ex) @ Xc_x) = XX)))))))))))))))).
