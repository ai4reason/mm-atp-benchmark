...
thf(alcmgcd_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccz)) => ((cco @ (cco @ XM @ XN @ cclcm) @ (cco @ XM @ XN @ ccgcd) @ ccmul) = (ccfv @ (cco @ XM @ XN @ ccmul) @ ccabs)))))).
...
thf(clcmgcdnn_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccn) & (cwcel @ XN @ ccn)) => ((cco @ (cco @ XM @ XN @ cclcm) @ (cco @ XM @ XN @ ccgcd) @ ccmul) = (cco @ XM @ XN @ ccmul)))))).
