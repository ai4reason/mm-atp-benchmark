...
thf(clinc1_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [Xc_1:($i > $o)] : (! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XM @ ccbs)) => ((! [Xx3:$i] : ((XS @ Xx3) = (ccfv @ XM @ ccsca))) => ((! [Xx3:$i] : (Xc_0 = (ccfv @ (XS @ Xx3) @ cc0g))) => ((! [Xx3:$i] : (Xc_1 = (ccfv @ (XS @ Xx3) @ ccur))) => ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XV) @ (^ [Xx3:$i] : (ccif @ ((ccv @ Xx3) = XX) @ Xc_1 @ Xc_0))))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XM @ cclmod) @ (cwcel @ XV @ (ccpw @ XB2)) @ (cwcel @ XX @ XV)) => ((cco @ (XF @ Xx3) @ XV @ (ccfv @ XM @ cclinc)) = XX))))))))))))))))).
