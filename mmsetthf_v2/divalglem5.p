...
thf(adivalglem0_ax,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cwcel @ XD @ ccz) => (((cwcel @ XR @ ccz) & (cwcel @ XK @ ccz)) => ((cwbr @ XD @ (cco @ XN @ XR @ ccmin) @ ccdvds) => (cwbr @ XD @ (cco @ XN @ (cco @ XR @ (cco @ XK @ (ccfv @ XD @ ccabs) @ ccmul) @ ccmin) @ ccmin) @ ccdvds)))))))))).
...
thf(cdivalglem5_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cwcel @ XD @ ccz) => ((cwne @ XD @ ccc0) => ((! [Xr:$i] : ((XS @ Xr) = (ccrab @ (^ [Xr:$i] : (cwbr @ XD @ (cco @ XN @ (ccv @ Xr) @ ccmin) @ ccdvds)) @ (^ [Xr:$i] : ccn0)))) => ((! [Xr:$i] : ((XR @ Xr) = (ccinf @ (XS @ Xr) @ ccr @ cclt))) => (! [Xr:$i] : ((cwbr @ ccc0 @ (XR @ Xr) @ ccle) & (cwbr @ (XR @ Xr) @ (ccfv @ XD @ ccabs) @ cclt))))))))))))).
