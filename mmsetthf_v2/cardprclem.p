...
thf(adomrefg_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwbr @ XA2 @ XA2 @ ccdom))))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(aelharval_ax,axiom,(! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cwcel @ XY @ (ccfv @ XX @ cchar)) <=> ((cwcel @ XY @ ccon0) & (cwbr @ XY @ XX @ ccdom)))))).
...
thf(aharcard_ax,axiom,(! [XA2:($i > $o)] : ((ccfv @ (ccfv @ XA2 @ cchar) @ cccrd) = (ccfv @ XA2 @ cchar)))).
...
thf(ccardprclem_conj,conjecture,(! [XA2:($i > $o)] : ((XA2 = (ccab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cccrd) = (ccv @ Xx3))))) => (~ (cwcel @ XA2 @ ccvv))))).
