...
thf(aisms2_ax,axiom,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XK @ cctopn)) => ((XX = (ccfv @ XK @ ccbs)) => ((XD = (ccres @ (ccfv @ XK @ ccds) @ (ccxp @ XX @ XX))) => ((cwcel @ XK @ ccmt) <=> ((cwcel @ XD @ (ccfv @ XX @ ccme)) & (XJ = (ccfv @ XD @ ccmopn)))))))))))).
...
thf(ccnfldms_conj,conjecture,(cwcel @ cccnfld @ ccmt)).
