...
thf(areprle_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XS @ ccn0)) => ((Xph => (cwcel @ XC @ (cco @ XA2 @ XM @ (ccfv @ XS @ ccrepr)))) => ((Xph => (cwcel @ XX @ (cco @ ccc0 @ XS @ ccfzo))) => (Xph => (cwbr @ (ccfv @ XX @ XC) @ XM @ ccle)))))))))))))).
...
thf(aoddprm2_ax,axiom,(! [XO:($i > $o)] : ((XO = (ccrab @ (^ [Xz:$i] : (~ (cwbr @ cc2 @ (ccv @ Xz) @ ccdvds))) @ (^ [Xz:$i] : ccz))) => ((ccdif @ ccprime @ (ccsn @ cc2)) = (ccin @ XO @ ccprime))))).
