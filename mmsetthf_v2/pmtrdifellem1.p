...
thf(apmtrfb_ax,axiom,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((XR = (ccrn @ XT)) => ((cwcel @ XF @ XR) <=> (cw3a @ (cwcel @ XD @ ccvv) @ (cwf1o @ XD @ XD @ XF) @ (cwbr @ (ccdm @ (ccdif @ XF @ ccid)) @ cc2o @ ccen)))))))))).
...
thf(adifsnexi_ax,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ (ccdif @ XN @ (ccsn @ XK)) @ ccvv) => (cwcel @ XN @ ccvv))))).
...
thf(cpmtrdifellem1_conj,conjecture,(! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((XT = (ccrn @ (ccfv @ (ccdif @ XN @ (ccsn @ XK)) @ ccpmtr))) => ((XR = (ccrn @ (ccfv @ XN @ ccpmtr))) => ((XS = (ccfv @ (ccdm @ (ccdif @ XQ @ ccid)) @ (ccfv @ XN @ ccpmtr))) => ((cwcel @ XQ @ XT) => (cwcel @ XS @ XR)))))))))))).
