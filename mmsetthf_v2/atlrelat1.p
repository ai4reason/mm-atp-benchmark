...
thf(catlrelat1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_lt:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((! [Xp:$i] : ((Xc_lt @ Xp) = (ccfv @ XK @ ccplt))) => ((XA2 = (ccfv @ XK @ ccatm)) => (! [Xp:$i] : ((cw3a @ (cw3a @ (cwcel @ XK @ ccoml) @ (cwcel @ XK @ cccla) @ (cwcel @ XK @ ccal)) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => ((cwbr @ XX @ XY @ (Xc_lt @ Xp)) => (cwrex @ (^ [Xp:$i] : ((~ (cwbr @ (ccv @ Xp) @ XX @ Xc_le)) & (cwbr @ (ccv @ Xp) @ XY @ Xc_le))) @ (^ [Xp:$i] : XA2))))))))))))))))).
