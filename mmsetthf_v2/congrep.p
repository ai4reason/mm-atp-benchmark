...
thf(ccongrep_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ ccn) & (cwcel @ XN @ ccz)) => (cwrex @ (^ [Xa:$i] : (cwbr @ XA2 @ (cco @ (ccv @ Xa) @ XN @ ccmin) @ ccdvds)) @ (^ [Xa:$i] : (cco @ ccc0 @ (cco @ XA2 @ cc1 @ ccmin) @ ccfz))))))).
