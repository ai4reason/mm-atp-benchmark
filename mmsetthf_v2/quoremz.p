...
thf(afraclt1_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwbr @ (cco @ XA2 @ (ccfv @ XA2 @ ccfl) @ ccmin) @ cc1 @ cclt)))).
...
thf(cquoremz_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : ((XQ = (ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ ccfl)) => ((XR = (cco @ XA2 @ (cco @ XB2 @ XQ @ ccmul) @ ccmin)) => (((cwcel @ XA2 @ ccz) & (cwcel @ XB2 @ ccn)) => (((cwcel @ XQ @ ccz) & (cwcel @ XR @ ccn0)) & ((cwbr @ XR @ XB2 @ cclt) & (XA2 = (cco @ (cco @ XB2 @ XQ @ ccmul) @ XR @ ccaddc)))))))))))).
