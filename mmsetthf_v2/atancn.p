...
thf(aatanf_ax,axiom,(cwf @ (ccdif @ ccc @ (ccpr @ (ccneg @ cci) @ cci)) @ ccc @ ccatan)).
thf(asseqtri_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwss @ XA2 @ XB2) => ((XB2 = XC) => (cwss @ XA2 @ XC))))))).
thf(aatansssdm_ax,axiom,(! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((! [Xy1:$i] : ((XS @ Xy1) = (ccrab @ (^ [Xy1:$i] : (cwcel @ (cco @ cc1 @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ XD)) @ (^ [Xy1:$i] : ccc)))) => (! [Xy1:$i] : (cwss @ (XS @ Xy1) @ (ccdm @ ccatan)))))))).
...
thf(advatan_ax,axiom,(! [XD:($i > $o)] : (! [XS:($i > ($i > $o))] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((! [Xy1:$i] : ((XS @ Xy1) = (ccrab @ (^ [Xy1:$i] : (cwcel @ (cco @ cc1 @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ XD)) @ (^ [Xy1:$i] : ccc)))) => (! [Xy1:$i] : ((cco @ ccc @ (ccres @ ccatan @ (XS @ Xy1)) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : (XS @ Xy1)) @ (^ [Xx3:$i] : (cco @ cc1 @ (cco @ cc1 @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ ccaddc) @ ccdiv)))))))))).
