...
thf(c_3dim0_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xq:$i] : (! [Xp:$i] : ((Xc_or @ Xq @ Xp) = (ccfv @ XK @ ccjn)))) => ((! [Xs1:$i] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((Xc_le @ Xs1 @ Xr @ Xq @ Xp) = (ccfv @ XK @ ccple)))))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((cwcel @ XK @ cchlt) => (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : (cwrex @ (^ [Xs1:$i] : (cw3a @ (cwne @ (ccv @ Xp) @ (ccv @ Xq)) @ (~ (cwbr @ (ccv @ Xr) @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ (Xc_or @ Xq @ Xp)) @ (Xc_le @ Xs1 @ Xr @ Xq @ Xp))) @ (~ (cwbr @ (ccv @ Xs1) @ (cco @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ (Xc_or @ Xq @ Xp)) @ (ccv @ Xr) @ (Xc_or @ Xq @ Xp)) @ (Xc_le @ Xs1 @ Xr @ Xq @ Xp))))) @ (^ [Xs1:$i] : XA2))) @ (^ [Xr:$i] : XA2))) @ (^ [Xq:$i] : XA2))) @ (^ [Xp:$i] : XA2))))))))))).
