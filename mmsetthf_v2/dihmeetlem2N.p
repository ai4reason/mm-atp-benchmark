...
thf(adibeldmN_ax,axiom,(! [XB2:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdib))) => (((cwcel @ XK @ XV) & (cwcel @ XW @ XH)) => ((cwcel @ XX @ (ccdm @ XI)) <=> ((cwcel @ XX @ XB2) & (cwbr @ XX @ XW @ Xc_le))))))))))))))))).
...
thf(adibglbN_ax,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((XG = (ccfv @ XK @ ccglb)) => ((XH = (ccfv @ XK @ cclh)) => ((! [Xx3:$i] : ((XI @ Xx3) = (ccfv @ XW @ (ccfv @ XK @ ccdib)))) => (! [Xx3:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwss @ XS @ (ccdm @ (XI @ Xx3))) & (cwne @ XS @ cc0))) => ((ccfv @ (ccfv @ XS @ XG) @ (XI @ Xx3)) = (cciin @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ (XI @ Xx3))))))))))))))))).
...
thf(aiinxprg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((XC @ Xx3) = XD))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XB2) => ((XC @ Xx3) = XE))) => (! [Xx3:$i] : (((cwcel @ XA2 @ (XV @ Xx3)) & (cwcel @ XB2 @ (XW @ Xx3))) => ((cciin @ (^ [Xx3:$i] : (ccpr @ XA2 @ XB2)) @ (^ [Xx3:$i] : (XC @ Xx3))) = (ccin @ XD @ XE)))))))))))))).
thf(ccio_tp,type,(ccio : (($i > $o) > ($i > $o)))).
thf(afveq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))).
thf(cdihmeetlem2N_conj,conjecture,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XP:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > ($i > $o)))] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > ($i > $o)))] : (! [XI:($i > ($i > ($i > $o)))] : (! [Xc_or:($i > ($i > ($i > $o)))] : (! [XK:($i > ($i > ($i > $o)))] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [Xc_an:($i > ($i > ($i > $o)))] : (! [XW:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : (! [Xc_0:($i > ($i > ($i > $o)))] : ((! [Xh:$i] : (! [Xq:$i] : ((XB2 @ Xh @ Xq) = (ccfv @ (XK @ Xh @ Xq) @ ccbs)))) => ((! [Xh:$i] : (! [Xq:$i] : ((Xc_an @ Xh @ Xq) = (ccfv @ (XK @ Xh @ Xq) @ ccmee)))) => ((! [Xh:$i] : (! [Xq:$i] : ((XH @ Xh @ Xq) = (ccfv @ (XK @ Xh @ Xq) @ cclh)))) => ((! [Xh:$i] : (! [Xq:$i] : ((XI @ Xh @ Xq) = (ccfv @ (XW @ Xh @ Xq) @ (ccfv @ (XK @ Xh @ Xq) @ ccdih))))) => ((! [Xh:$i] : (! [Xq:$i] : ((Xc_le @ Xh @ Xq) = (ccfv @ (XK @ Xh @ Xq) @ ccple)))) => ((! [Xh:$i] : (! [Xq:$i] : ((Xc_or @ Xh @ Xq) = (ccfv @ (XK @ Xh @ Xq) @ ccjn)))) => ((! [Xh:$i] : (! [Xq:$i] : ((XA2 @ Xh @ Xq) = (ccfv @ (XK @ Xh @ Xq) @ ccatm)))) => ((! [Xh:$i] : (! [Xq:$i] : ((XP @ Xh @ Xq) = (ccfv @ (XW @ Xh @ Xq) @ (ccfv @ (XK @ Xh @ Xq) @ ccoc))))) => ((! [Xh:$i] : (! [Xq:$i] : ((XT @ Xh @ Xq) = (ccfv @ (XW @ Xh @ Xq) @ (ccfv @ (XK @ Xh @ Xq) @ ccltrn))))) => ((! [Xh:$i] : (! [Xq:$i] : ((XR @ Xh @ Xq) = (ccfv @ (XW @ Xh @ Xq) @ (ccfv @ (XK @ Xh @ Xq) @ cctrl))))) => ((! [Xh:$i] : (! [Xq:$i] : ((XE @ Xh @ Xq) = (ccfv @ (XW @ Xh @ Xq) @ (ccfv @ (XK @ Xh @ Xq) @ cctendo))))) => ((! [Xh:$i] : (! [Xq:$i] : ((XG @ Xh @ Xq) = (ccrio @ (^ [Xh:$i] : ((ccfv @ (XP @ Xh @ Xq) @ (ccv @ Xh)) = (ccv @ Xq))) @ (^ [Xh:$i] : (XT @ Xh @ Xq)))))) => ((! [Xh:$i] : (! [Xq:$i] : ((Xc_0 @ Xh @ Xq) = (ccmpt @ (^ [Xh:$i] : (XT @ Xh @ Xq)) @ (^ [Xh:$i] : (ccres @ ccid @ (XB2 @ Xh @ Xq))))))) => (! [Xh:$i] : (! [Xq:$i] : ((cw3a @ ((cwcel @ (XK @ Xh @ Xq) @ cchlt) & (cwcel @ (XW @ Xh @ Xq) @ (XH @ Xh @ Xq))) @ ((cwcel @ (XX @ Xh @ Xq) @ (XB2 @ Xh @ Xq)) & (cwbr @ (XX @ Xh @ Xq) @ (XW @ Xh @ Xq) @ (Xc_le @ Xh @ Xq))) @ ((cwcel @ (XY @ Xh @ Xq) @ (XB2 @ Xh @ Xq)) & (cwbr @ (XY @ Xh @ Xq) @ (XW @ Xh @ Xq) @ (Xc_le @ Xh @ Xq)))) => ((ccfv @ (cco @ (XX @ Xh @ Xq) @ (XY @ Xh @ Xq) @ (Xc_an @ Xh @ Xq)) @ (XI @ Xh @ Xq)) = (ccin @ (ccfv @ (XX @ Xh @ Xq) @ (XI @ Xh @ Xq)) @ (ccfv @ (XY @ Xh @ Xq) @ (XI @ Xh @ Xq)))))))))))))))))))))))))))))))))))))).
