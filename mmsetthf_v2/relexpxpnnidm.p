...
thf(axpcoidgend_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwne @ (ccin @ XA2 @ XB2) @ cc0)) => (Xph => ((cccom @ (ccxp @ XA2 @ XB2) @ (ccxp @ XA2 @ XB2)) = (ccxp @ XA2 @ XB2)))))))).
thf(asimp23_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((cw3a @ Xph @ (cw3a @ Xps @ Xch @ Xth) @ Xta) => Xth))))))).
thf(crelexpxpnnidm_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XN @ ccn) => ((cw3a @ (cwcel @ XA2 @ XU) @ (cwcel @ XB2 @ XV) @ (cwne @ (ccin @ XA2 @ XB2) @ cc0)) => ((cco @ (ccxp @ XA2 @ XB2) @ XN @ ccrelexp) = (ccxp @ XA2 @ XB2)))))))))).
