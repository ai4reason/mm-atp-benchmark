...
thf(alenlti_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwbr @ XA2 @ XB2 @ ccle) <=> (~ (cwbr @ XB2 @ XA2 @ cclt)))))))).
...
thf(aeqsn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwne @ XA2 @ cc0) => ((XA2 = (ccsn @ XB2)) <=> (cwral @ (^ [Xx3:$i] : ((ccv @ Xx3) = XB2)) @ (^ [Xx3:$i] : XA2))))))).
...
thf(ahashsnle1_ax,axiom,(! [XA2:($i > $o)] : (cwbr @ (ccfv @ (ccsn @ XA2) @ cchash) @ cc1 @ ccle))).
thf(ar19_36v_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > ($i > $o))] : ((cwrex @ (^ [Xx3:$i] : ((Xph @ Xx3) => Xps)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) => Xps)))))).
...
thf(chashgt12el_conj,conjecture,(! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [Xb:$i] : (((cwcel @ XV @ (XW @ Xb)) & (cwbr @ cc1 @ (ccfv @ XV @ cchash) @ cclt)) => (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : (cwne @ (ccv @ Xa) @ (ccv @ Xb))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV))))))).
