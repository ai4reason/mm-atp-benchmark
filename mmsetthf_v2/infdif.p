...
thf(acdainf_ax,axiom,(! [XA2:($i > $o)] : ((cwbr @ ccom @ XA2 @ ccdom) <=> (cwbr @ ccom @ (cco @ XA2 @ XA2 @ cccda) @ ccdom)))).
...
thf(cinfdif_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccdm @ cccrd)) @ (cwbr @ ccom @ XA2 @ ccdom) @ (cwbr @ XB2 @ XA2 @ ccsdm)) => (cwbr @ (ccdif @ XA2 @ XB2) @ XA2 @ ccen))))).
