...
thf(asyl2imc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xps) => ((Xch => Xth) => ((Xps => (Xth => Xta)) => (Xch => (Xph => Xta))))))))))).
...
thf(aoddprmALTV_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccdif @ ccprime @ (ccsn @ cc2))) => (cwcel @ XN @ ccodd)))).
thf(ccc_tp,type,(ccc : ($i > $o))).
thf(ccneg_tp,type,(ccneg : (($i > $o) > ($i > $o)))).
thf(aomoeALTV_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccodd) & (cwcel @ XB2 @ ccodd)) => (cwcel @ (cco @ XA2 @ XB2 @ ccmin) @ cceven))))).
...
thf(aexp5o_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : (((cw3a @ Xph @ Xps @ Xch) => ((Xth & Xta) => Xet)) => (Xph => (Xps => (Xch => (Xth => (Xta => Xet))))))))))))).
...
thf(aleltletr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr)) => (((cwbr @ XA2 @ XB2 @ ccle) & (cwbr @ XB2 @ XC @ cclt)) => (cwbr @ XA2 @ XC @ ccle))))))).
thf(afzisfzounsn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ (ccfv @ XA2 @ ccuz)) => ((cco @ XA2 @ XB2 @ ccfz) = (ccun @ (cco @ XA2 @ XB2 @ ccfzo) @ (ccsn @ XB2))))))).
...
thf(altsubposd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((cwbr @ ccc0 @ XA2 @ cclt) <=> (cwbr @ (cco @ XB2 @ XA2 @ ccmin) @ XB2 @ cclt))))))))).
thf(asimpl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xph)))).
thf(asimpll_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) & Xch) => Xph))))).
thf(cbgoldbtbndlem3_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > $o)))] : (! [XF:($i > ($i > $o))] : (! [XI:($i > ($i > $o))] : (! [XM:($i > ($i > ($i > $o)))] : (! [XN:($i > ($i > $o))] : (! [XX:($i > ($i > ($i > $o)))] : ((! [Xi:$i] : (! [Xn:$i] : ((Xph @ Xi @ Xn) => (cwcel @ (XM @ Xi @ Xn) @ (ccfv @ (ccdc @ cc1 @ cc1) @ ccuz))))) => ((! [Xi:$i] : (! [Xn:$i] : ((Xph @ Xi @ Xn) => (cwcel @ (XN @ Xn) @ (ccfv @ (ccdc @ cc1 @ cc1) @ ccuz))))) => ((! [Xi:$i] : (! [Xn:$i] : ((Xph @ Xi @ Xn) => (cwral @ (^ [Xn:$i] : (((cwbr @ cc4 @ (ccv @ Xn) @ cclt) & (cwbr @ (ccv @ Xn) @ (XN @ Xn) @ cclt)) => (cwcel @ (ccv @ Xn) @ ccgbe))) @ (^ [Xn:$i] : cceven))))) => ((! [Xi:$i] : (! [Xn:$i] : ((Xph @ Xi @ Xn) => (cwcel @ (XD @ Xn) @ (ccfv @ cc3 @ ccuz))))) => ((! [Xi:$i] : (! [Xn:$i] : ((Xph @ Xi @ Xn) => (cwcel @ (XF @ Xn) @ (ccfv @ (XD @ Xn) @ cciccp))))) => ((! [Xi:$i] : (! [Xn:$i] : ((Xph @ Xi @ Xn) => (cwral @ (^ [Xi:$i] : (cw3a @ (cwcel @ (ccfv @ (ccv @ Xi) @ (XF @ Xn)) @ (ccdif @ ccprime @ (ccsn @ cc2))) @ (cwbr @ (cco @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XF @ Xn)) @ (ccfv @ (ccv @ Xi) @ (XF @ Xn)) @ ccmin) @ (cco @ (XN @ Xn) @ cc4 @ ccmin) @ cclt) @ (cwbr @ cc4 @ (cco @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (XF @ Xn)) @ (ccfv @ (ccv @ Xi) @ (XF @ Xn)) @ ccmin) @ cclt))) @ (^ [Xi:$i] : (cco @ ccc0 @ (XD @ Xn) @ ccfzo)))))) => ((! [Xi:$i] : (! [Xn:$i] : ((Xph @ Xi @ Xn) => ((ccfv @ ccc0 @ (XF @ Xn)) = cc7)))) => ((! [Xi:$i] : (! [Xn:$i] : ((Xph @ Xi @ Xn) => ((ccfv @ cc1 @ (XF @ Xn)) = (ccdc @ cc1 @ cc3))))) => ((! [Xi:$i] : (! [Xn:$i] : ((Xph @ Xi @ Xn) => (cwbr @ (XM @ Xi @ Xn) @ (ccfv @ (XD @ Xn) @ (XF @ Xn)) @ cclt)))) => ((! [Xi:$i] : (! [Xn:$i] : ((Xph @ Xi @ Xn) => (cwcel @ (ccfv @ (XD @ Xn) @ (XF @ Xn)) @ ccr)))) => ((! [Xi:$i] : (! [Xn:$i] : ((XS @ Xi @ Xn) = (cco @ (XX @ Xi @ Xn) @ (ccfv @ (XI @ Xn) @ (XF @ Xn)) @ ccmin)))) => (! [Xi:$i] : (! [Xn:$i] : ((cw3a @ (Xph @ Xi @ Xn) @ (cwcel @ (XX @ Xi @ Xn) @ ccodd) @ (cwcel @ (XI @ Xn) @ (cco @ cc1 @ (XD @ Xn) @ ccfzo))) => (((cwcel @ (XX @ Xi @ Xn) @ (cco @ (ccfv @ (XI @ Xn) @ (XF @ Xn)) @ (ccfv @ (cco @ (XI @ Xn) @ cc1 @ ccaddc) @ (XF @ Xn)) @ ccico)) & (cwbr @ cc4 @ (XS @ Xi @ Xn) @ cclt)) => (cw3a @ (cwcel @ (XS @ Xi @ Xn) @ cceven) @ (cwbr @ (XS @ Xi @ Xn) @ (XN @ Xn) @ cclt) @ (cwbr @ cc4 @ (XS @ Xi @ Xn) @ cclt)))))))))))))))))))))))))).
