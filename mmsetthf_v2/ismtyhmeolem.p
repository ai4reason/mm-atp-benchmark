...
thf(aismtyima_ax,axiom,(! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cw3a @ (cwcel @ XM @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XN @ (ccfv @ XY @ ccxmt)) @ (cwcel @ XF @ (cco @ XM @ XN @ ccismty))) & ((cwcel @ XP @ XX) & (cwcel @ XR @ ccxr))) => ((ccima @ XF @ (cco @ XP @ XR @ (ccfv @ XM @ ccbl))) = (cco @ (ccfv @ XP @ XF) @ XR @ (ccfv @ XN @ ccbl)))))))))))).
...
thf(ablf_ax,axiom,(! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XD @ (ccfv @ XX @ ccxmt)) => (cwf @ (ccxp @ XX @ ccxr) @ (ccpw @ XX) @ (ccfv @ XD @ ccbl)))))).
...
thf(atgcn_ax,axiom,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XJ @ (ccfv @ XX @ cctopon)))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (XK = (ccfv @ XB2 @ cctg)))) => ((! [Xy1:$i] : ((Xph @ Xy1) => (cwcel @ XK @ (ccfv @ XY @ cctopon)))) => (! [Xy1:$i] : ((Xph @ Xy1) => ((cwcel @ XF @ (cco @ XJ @ XK @ cccn)) <=> ((cwf @ XX @ XY @ XF) & (cwral @ (^ [Xy1:$i] : (cwcel @ (ccima @ (cccnv @ XF) @ (ccv @ Xy1)) @ XJ)) @ (^ [Xy1:$i] : XB2))))))))))))))))).
...
thf(cismtyhmeolem_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XJ = (ccfv @ XM @ ccmopn)) => ((XK = (ccfv @ XN @ ccmopn)) => ((Xph => (cwcel @ XM @ (ccfv @ XX @ ccxmt))) => ((Xph => (cwcel @ XN @ (ccfv @ XY @ ccxmt))) => ((Xph => (cwcel @ XF @ (cco @ XM @ XN @ ccismty))) => (Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))))))))))))))))).
