...
thf(adifun1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccdif @ XA2 @ (ccun @ XB2 @ XC)) = (ccdif @ (ccdif @ XA2 @ XB2) @ XC)))))).
...
thf(assinss2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwss @ XB2 @ XC)) => (Xph => (cwss @ (ccin @ XA2 @ XB2) @ XC)))))))).
