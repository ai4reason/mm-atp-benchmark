...
thf(csuppss3_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : ((XG @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))))) => ((! [Xx3:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XZ @ (XW @ Xx3)))) => ((Xph => (cwfn @ XF @ XA2)) => ((! [Xx3:$i] : ((cw3a @ Xph @ (cwcel @ (ccv @ Xx3) @ XA2) @ ((ccfv @ (ccv @ Xx3) @ XF) = XZ)) => ((XB2 @ Xx3) = XZ))) => (! [Xx3:$i] : (Xph => (cwss @ (cco @ (XG @ Xx3) @ XZ @ ccsupp) @ (cco @ XF @ XZ @ ccsupp)))))))))))))))))).
