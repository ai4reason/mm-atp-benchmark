...
thf(aclwwlkn_ax,axiom,(! [XG:($i > $o)] : (! [XN:($i > $o)] : ((cco @ XN @ XG @ ccclwwlkn) = (ccrab @ (^ [Xw:$i] : ((ccfv @ (ccv @ Xw) @ cchash) = XN)) @ (^ [Xw:$i] : (ccfv @ XG @ ccclwwlk))))))).
thf(cisclwwlkn_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : ((cwcel @ XW @ (cco @ XN @ XG @ ccclwwlkn)) <=> ((cwcel @ XW @ (ccfv @ XG @ ccclwwlk)) & ((ccfv @ XW @ cchash) = XN))))))).
