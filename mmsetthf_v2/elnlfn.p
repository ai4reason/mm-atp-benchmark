...
thf(anlfnval_ax,axiom,(! [XT:($i > $o)] : ((cwf @ cchil @ ccc @ XT) => ((ccfv @ XT @ ccnl) = (ccima @ (cccnv @ XT) @ (ccsn @ ccc0)))))).
...
thf(celnlfn_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cwf @ cchil @ ccc @ XT) => ((cwcel @ XA2 @ (ccfv @ XT @ ccnl)) <=> ((cwcel @ XA2 @ cchil) & ((ccfv @ XA2 @ XT) = ccc0))))))).
