...
thf(afcof1od_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwf @ XB2 @ XA2 @ XG)) => ((Xph => ((cccom @ XG @ XF) = (ccres @ ccid @ XA2))) => ((Xph => ((cccom @ XF @ XG) = (ccres @ ccid @ XB2))) => (Xph => (cwf1o @ XA2 @ XB2 @ XF)))))))))))).
...
thf(aevpmss_ax,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : ((XS = (ccfv @ XD @ ccsymg)) => ((XP = (ccfv @ XS @ ccbs)) => (cwss @ (ccfv @ XD @ ccevpm) @ XP))))))).
...
thf(apsgnodpm_ax,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XS = (ccfv @ XD @ ccsymg)) => ((XP = (ccfv @ XS @ ccbs)) => ((XN = (ccfv @ XD @ ccpsgn)) => (((cwcel @ XD @ ccfn) & (cwcel @ XF @ (ccdif @ XP @ (ccfv @ XD @ ccevpm)))) => ((ccfv @ XF @ XN) = (ccneg @ cc1)))))))))))).
thf(aadantlr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => (((Xph & Xth) & Xps) => Xch))))))).
thf(apsgnevpm_ax,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XS = (ccfv @ XD @ ccsymg)) => ((XP = (ccfv @ XS @ ccbs)) => ((XN = (ccfv @ XD @ ccpsgn)) => (((cwcel @ XD @ ccfn) & (cwcel @ XF @ (ccfv @ XD @ ccevpm))) => ((ccfv @ XF @ XN) = cc1))))))))))).
...
thf(apsgninv_ax,axiom,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XS = (ccfv @ XD @ ccsymg)) => ((XN = (ccfv @ XD @ ccpsgn)) => ((XP = (ccfv @ XS @ ccbs)) => (((cwcel @ XD @ ccfn) & (cwcel @ XF @ XP)) => ((ccfv @ (cccnv @ XF) @ XN) = (ccfv @ XF @ XN)))))))))))).
...
thf(cevpmodpmf1o_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : ((XS = (ccfv @ XD @ ccsymg)) => ((XP = (ccfv @ XS @ ccbs)) => (((cwcel @ XD @ ccfn) & (cwcel @ XF @ (ccdif @ XP @ (ccfv @ XD @ ccevpm)))) => (cwf1o @ (ccfv @ XD @ ccevpm) @ (ccdif @ XP @ (ccfv @ XD @ ccevpm)) @ (ccmpt @ (^ [Xf1:$i] : (ccfv @ XD @ ccevpm)) @ (^ [Xf1:$i] : (cco @ XF @ (ccv @ Xf1) @ (ccfv @ XS @ ccplusg))))))))))))).
