...
thf(cerngbase_rN_conj,conjecture,(! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((XD = (ccfv @ XW @ (ccfv @ XK @ ccedring_rN))) => ((XC = (ccfv @ XD @ ccbs)) => (((cwcel @ XK @ XV) & (cwcel @ XW @ XH)) => (XC = XE)))))))))))))))).
