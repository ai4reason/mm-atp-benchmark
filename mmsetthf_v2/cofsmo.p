...
thf(asmoiso2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cword @ XA2) & (cwss @ XB2 @ ccon0)) => (((cwfo @ XA2 @ XB2 @ XF) & (cwsmo @ XF)) <=> (cwiso @ XA2 @ XB2 @ ccep @ ccep @ XF))))))).
thf(asmorndom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwf @ XA2 @ XB2 @ XF) @ (cwsmo @ XF) @ (cword @ XB2)) => (cwss @ XA2 @ XB2)))))).
...
thf(ccofsmo_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XK:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XO:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XC @ Xx3 @ Xy1 @ Xz @ Xw @ Xf1 @ Xg1) = (ccrab @ (^ [Xy1:$i] : (cwral @ (^ [Xw:$i] : (cwcel @ (ccfv @ (ccv @ Xw) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)))) @ (^ [Xw:$i] : (ccv @ Xy1)))) @ (^ [Xy1:$i] : (XB2 @ Xg1)))))))))) => ((! [Xx3:$i] : (! [Xz:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XK @ Xx3 @ Xz @ Xf1 @ Xg1) = (ccint @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccv @ Xz) @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)))) @ (^ [Xx3:$i] : (XB2 @ Xg1))))))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : (! [Xf1:$i] : (! [Xg1:$i] : ((XO @ Xy1 @ Xw @ Xf1) = (ccoi @ (XC @ Xx3 @ Xy1 @ Xz @ Xw @ Xf1 @ Xg1) @ ccep)))))))) => (! [Xy1:$i] : (! [Xg1:$i] : (((cword @ (XA2 @ Xy1)) & (cwcel @ (XB2 @ Xg1) @ ccon0)) => ((? [Xf1:$i] : ((cwf @ (XB2 @ Xg1) @ (XA2 @ Xy1) @ (ccv @ Xf1)) & (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xf1)))) @ (^ [Xw:$i] : (XB2 @ Xg1)))) @ (^ [Xz:$i] : (XA2 @ Xy1))))) => (cwrex @ (^ [Xx3:$i] : (? [Xg1:$i] : (cw3a @ (cwf @ (ccv @ Xx3) @ (XA2 @ Xy1) @ (ccv @ Xg1)) @ (cwsmo @ (ccv @ Xg1)) @ (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xv:$i] : (cwss @ (ccv @ Xz) @ (ccfv @ (ccv @ Xv) @ (ccv @ Xg1)))) @ (^ [Xv:$i] : (ccv @ Xx3)))) @ (^ [Xz:$i] : (XA2 @ Xy1)))))) @ (^ [Xx3:$i] : (ccsuc @ (XB2 @ Xg1))))))))))))))))).
