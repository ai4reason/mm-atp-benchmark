...
thf(axrge0subm_ax,axiom,(! [XR:($i > $o)] : ((XR = (cco @ ccxrs @ (ccdif @ ccxr @ (ccsn @ ccmnf)) @ ccress)) => (cwcel @ (cco @ ccc0 @ ccpnf @ ccicc) @ (ccfv @ XR @ ccsubmnd))))).
thf(asubm0_ax,axiom,(! [XS:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [Xc_0:($i > $o)] : ((XH = (cco @ XM @ XS @ ccress)) => ((Xc_0 = (ccfv @ XM @ cc0g)) => ((cwcel @ XS @ (ccfv @ XM @ ccsubmnd)) => (Xc_0 = (ccfv @ XH @ cc0g)))))))))).
...
thf(age0nemnf_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwbr @ ccc0 @ XA2 @ ccle)) => (cwne @ XA2 @ ccmnf)))).
...
thf(aletop_ax,axiom,(cwcel @ (ccfv @ ccle @ ccordt) @ cctop)).
...
thf(axrtgioo_ax,axiom,(! [XJ:($i > $o)] : ((XJ = (cco @ (ccfv @ ccle @ ccordt) @ ccr @ ccrest)) => ((ccfv @ (ccrn @ ccioo) @ cctg) = XJ)))).
...
thf(atg2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ XB2 @ cctg)) & (cwcel @ XC @ XA2)) => (cwrex @ (^ [Xx3:$i] : ((cwcel @ XC @ (ccv @ Xx3)) & (cwss @ (ccv @ Xx3) @ XA2))) @ (^ [Xx3:$i] : XB2))))))).
...
thf(aresfifsupp_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwfun @ XF)) => ((Xph => (cwcel @ XX @ ccfn)) => ((Xph => (cwcel @ XZ @ XV)) => (Xph => (cwbr @ (ccres @ XF @ XX) @ XZ @ ccfsupp))))))))))).
...
thf(axrge0gsumle_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XG = (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((Xph => (cwcel @ XB2 @ (ccin @ (ccpw @ XA2) @ ccfn))) => ((Xph => (cwss @ XC @ XB2)) => (Xph => (cwbr @ (cco @ XG @ (ccres @ XF @ XC) @ ccgsu) @ (cco @ XG @ (ccres @ XF @ XB2) @ ccgsu) @ ccle))))))))))))))).
...
thf(aelioo1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioo)) <=> (cw3a @ (cwcel @ XC @ ccxr) @ (cwbr @ XA2 @ XC @ cclt) @ (cwbr @ XC @ XB2 @ cclt)))))))).
...
thf(asupxrlub_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwss @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwbr @ XB2 @ (ccsup @ XA2 @ ccxr @ cclt) @ cclt) <=> (cwrex @ (^ [Xx3:$i] : (cwbr @ XB2 @ (ccv @ Xx3) @ cclt)) @ (^ [Xx3:$i] : XA2))))))).
...
thf(apnfnei_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ ccle @ ccordt)) & (cwcel @ ccpnf @ XA2)) => (cwrex @ (^ [Xx3:$i] : (cwss @ (cco @ (ccv @ Xx3) @ ccpnf @ ccioc) @ XA2)) @ (^ [Xx3:$i] : ccr))))).
...
thf(aelioc1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ ccioc)) <=> (cw3a @ (cwcel @ XC @ ccxr) @ (cwbr @ XA2 @ XC @ cclt) @ (cwbr @ XC @ XB2 @ ccle)))))))).
thf(ccltrr_tp,type,(ccltrr : ($i > $o))).
thf(altpnf_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => (cwbr @ XA2 @ ccpnf @ cclt)))).
thf(asimplr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (((Xph & Xps) & Xch) => Xps))))).
thf(cw3o_tp,type,(cw3o : ($o > ($o > ($o > $o))))).
thf(axrnemnf_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwne @ XA2 @ ccmnf)) <=> ((cwcel @ XA2 @ ccr) | (XA2 = ccpnf))))).
...
thf(axrstps_ax,axiom,(cwcel @ ccxrs @ cctps)).
thf(aresstps_ax,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XK @ cctps) & (cwcel @ XA2 @ XV)) => (cwcel @ (cco @ XK @ XA2 @ ccress) @ cctps)))))).
thf(cwmo_tp,type,(cwmo : (($i > $o) > $o))).
thf(ahaustsms2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xph => (cwcel @ XG @ cccmn)) => ((Xph => (cwcel @ XG @ cctps)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((XJ = (ccfv @ XG @ cctopn)) => ((Xph => (cwcel @ XJ @ ccha)) => (Xph => ((cwcel @ XX @ (cco @ XG @ XF @ cctsu)) => ((cco @ XG @ XF @ cctsu) = (ccsn @ XX)))))))))))))))))))).
thf(amp1i_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => ((Xph => Xps) => (Xch => Xps))))))).
thf(ccid_tp,type,(ccid : ($i > $o))).
thf(ccps_tp,type,(ccps : ($i > $o))).
thf(aletsr_ax,axiom,(cwcel @ ccle @ cctsr)).
thf(aordthaus_ax,axiom,(! [XR:($i > $o)] : ((cwcel @ XR @ cctsr) => (cwcel @ (ccfv @ XR @ ccordt) @ ccha)))).
thf(aresthaus_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XJ @ ccha) & (cwcel @ XA2 @ XV)) => (cwcel @ (cco @ XJ @ XA2 @ ccrest) @ ccha)))))).
thf(cxrge0tsmsd_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > ($i > $o))] : ((XG = (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress)) => ((! [Xs1:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xs1)))) => ((Xph => (cwf @ XA2 @ (cco @ ccc0 @ ccpnf @ ccicc) @ XF)) => ((! [Xs1:$i] : (Xph => ((XS @ Xs1) = (ccsup @ (ccrn @ (ccmpt @ (^ [Xs1:$i] : (ccin @ (ccpw @ XA2) @ ccfn)) @ (^ [Xs1:$i] : (cco @ XG @ (ccres @ XF @ (ccv @ Xs1)) @ ccgsu)))) @ ccxr @ cclt)))) => (! [Xs1:$i] : (Xph => ((cco @ XG @ XF @ cctsu) = (ccsn @ (XS @ Xs1)))))))))))))))).
