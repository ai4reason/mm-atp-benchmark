...
thf(adfrn4_ax,axiom,(! [XA2:($i > $o)] : ((ccrn @ XA2) = (ccima @ XA2 @ ccvv)))).
...
thf(cffsrn_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XZ @ XW)) => ((Xph => (cwcel @ XF @ XV)) => ((Xph => (cwfun @ XF)) => ((Xph => (cwcel @ (cco @ XF @ XZ @ ccsupp) @ ccfn)) => (Xph => (cwcel @ (ccrn @ XF) @ ccfn)))))))))))).
