...
thf(arelimasn_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwrel @ XR) => ((ccima @ XR @ (ccsn @ XA2)) = (ccab @ (^ [Xy1:$i] : (cwbr @ XA2 @ (ccv @ Xy1) @ XR)))))))).
...
thf(cpredep_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XB2) => ((ccpred @ XA2 @ ccep @ XX) = (ccin @ XA2 @ XX))))))).
