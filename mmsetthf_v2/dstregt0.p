...
thf(cdstregt0_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ (ccdif @ ccc @ ccr)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ (cco @ XA2 @ (ccv @ Xy1) @ ccmin) @ ccabs) @ cclt)) @ (^ [Xy1:$i] : ccr))) @ (^ [Xx3:$i] : ccrp)))))))).
