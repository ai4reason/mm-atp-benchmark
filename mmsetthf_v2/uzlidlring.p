...
thf(alidldomn1_ax,axiom,(! [XR:($i > ($i > $o))] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [Xc_1:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XL:($i > ($i > $o))] : (! [Xc_0:($i > ($i > $o))] : ((! [Xx3:$i] : ((XL @ Xx3) = (ccfv @ (XR @ Xx3) @ cclidl))) => ((! [Xx3:$i] : (Xc_x = (ccfv @ (XR @ Xx3) @ ccmulr))) => ((! [Xx3:$i] : ((Xc_1 @ Xx3) = (ccfv @ (XR @ Xx3) @ ccur))) => ((! [Xx3:$i] : ((Xc_0 @ Xx3) = (ccfv @ (XR @ Xx3) @ cc0g))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ (XR @ Xx3) @ ccdomn) @ ((cwcel @ XU @ (XL @ Xx3)) & (cwne @ XU @ (ccsn @ (Xc_0 @ Xx3)))) @ (cwcel @ XI @ XU)) => ((cwral @ (^ [Xx3:$i] : (((cco @ XI @ (ccv @ Xx3) @ Xc_x) = (ccv @ Xx3)) & ((cco @ (ccv @ Xx3) @ XI @ Xc_x) = (ccv @ Xx3)))) @ (^ [Xx3:$i] : XU)) => (XI = (Xc_1 @ Xx3))))))))))))))))).
...
thf(azlidlring_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_0:($i > $o)] : ((XL = (ccfv @ XR @ cclidl)) => ((XI = (cco @ XR @ XU @ ccress)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_0 = (ccfv @ XR @ cc0g)) => (((cwcel @ XR @ ccrg) & (XU = (ccsn @ Xc_0))) => (cwcel @ XI @ ccrg))))))))))))).
