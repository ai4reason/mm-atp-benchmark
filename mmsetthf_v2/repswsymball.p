...
thf(crepswsymball_conj,conjecture,(! [XS:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [Xi:$i] : (((cwcel @ XW @ (ccword @ (XV @ Xi))) & (cwcel @ XS @ (XV @ Xi))) => ((XW = (cco @ XS @ (ccfv @ XW @ cchash) @ ccreps)) => (cwral @ (^ [Xi:$i] : ((ccfv @ (ccv @ Xi) @ XW) = XS)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XW @ cchash) @ ccfzo)))))))))).
