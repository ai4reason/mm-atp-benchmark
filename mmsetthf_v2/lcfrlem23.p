...
thf(adochdmm1_ax,axiom,(! [Xph:$o] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((Xc_pe = (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((Xc_or = (ccfv @ XW @ (ccfv @ XK @ ccdjh))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XX @ (ccrn @ XI))) => ((Xph => (cwcel @ XY @ (ccrn @ XI))) => (Xph => ((ccfv @ (ccin @ XX @ XY) @ Xc_pe) = (cco @ (ccfv @ XX @ Xc_pe) @ (ccfv @ XY @ Xc_pe) @ Xc_or)))))))))))))))))))))))).
...
thf(adihjat1_ax,axiom,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((Xc_po = (ccfv @ XU @ cclsm)) => ((XN = (ccfv @ XU @ cclspn)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((Xc_or = (ccfv @ XW @ (ccfv @ XK @ ccdjh))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XX @ (ccrn @ XI))) => ((Xph => (cwcel @ XT @ XV)) => (Xph => ((cco @ XX @ (ccfv @ (ccsn @ XT) @ XN) @ Xc_or) = (cco @ XX @ (ccfv @ (ccsn @ XT) @ XN) @ Xc_po)))))))))))))))))))))))))).
...
thf(alspsntri_ax,axiom,(! [Xc_pl:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((Xc_pl = (ccfv @ XW @ ccplusg)) => ((XN = (ccfv @ XW @ cclspn)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV)) => (cwss @ (ccfv @ (ccsn @ (cco @ XX @ XY @ Xc_pl)) @ XN) @ (cco @ (ccfv @ (ccsn @ XX) @ XN) @ (ccfv @ (ccsn @ XY) @ XN) @ Xc_po))))))))))))))).
thf(ccoppg_tp,type,(ccoppg : ($i > $o))).
thf(alsmmod2_ax,axiom,(! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((Xc_po = (ccfv @ XG @ cclsm)) => (((cw3a @ (cwcel @ XS @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XT @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XU @ (ccfv @ XG @ ccsubg))) & (cwss @ XU @ XS)) => ((ccin @ XS @ (cco @ XT @ XU @ Xc_po)) = (cco @ (ccin @ XS @ XT) @ XU @ Xc_po)))))))))).
...
thf(alsm02_ax,axiom,(! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xc_po = (ccfv @ XG @ cclsm)) => ((cwcel @ XX @ (ccfv @ XG @ ccsubg)) => ((cco @ (ccsn @ Xc_0) @ XX @ Xc_po) = XX))))))))).
thf(adihsmsnrn_ax,axiom,(! [Xph:$o] : (! [Xc_po:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((Xc_po = (ccfv @ XU @ cclsm)) => ((XN = (ccfv @ XU @ cclspn)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwcel @ XY @ XV)) => (Xph => (cwcel @ (cco @ (ccfv @ (ccsn @ XX) @ XN) @ (ccfv @ (ccsn @ XY) @ XN) @ Xc_po) @ (ccrn @ XI)))))))))))))))))))))))).
...
thf(adihjat2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => ((Xc_or = (ccfv @ XW @ (ccfv @ XK @ ccdjh))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((Xc_po = (ccfv @ XU @ cclsm)) => ((XA2 = (ccfv @ XU @ cclsa)) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XX @ (ccrn @ XI))) => ((Xph => (cwcel @ XQ @ XA2)) => (Xph => ((cco @ XX @ XQ @ Xc_or) = (cco @ XX @ XQ @ Xc_po)))))))))))))))))))))))).
thf(clcfrlem23_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_0:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((Xc_pe = (ccfv @ XW @ (ccfv @ XK @ ccoch))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((Xc_pl = (ccfv @ XU @ ccplusg)) => ((Xc_0 = (ccfv @ XU @ cc0g)) => ((XN = (ccfv @ XU @ cclspn)) => ((XA2 = (ccfv @ XU @ cclsa)) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => ((Xph => (cwcel @ XX @ (ccdif @ XV @ (ccsn @ Xc_0)))) => ((Xph => (cwcel @ XY @ (ccdif @ XV @ (ccsn @ Xc_0)))) => ((Xph => (cwne @ (ccfv @ (ccsn @ XX) @ XN) @ (ccfv @ (ccsn @ XY) @ XN))) => ((XB2 = (ccin @ (ccfv @ (ccpr @ XX @ XY) @ XN) @ (ccfv @ (ccsn @ (cco @ XX @ XY @ Xc_pl)) @ Xc_pe))) => ((Xc_po = (ccfv @ XU @ cclsm)) => (Xph => ((cco @ (ccfv @ (ccpr @ XX @ XY) @ Xc_pe) @ XB2 @ Xc_po) = (ccfv @ (ccsn @ (cco @ XX @ XY @ Xc_pl)) @ Xc_pe))))))))))))))))))))))))))))))))).
