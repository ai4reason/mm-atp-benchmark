...
thf(asmores_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwsmo @ XA2) & (cwcel @ XB2 @ (ccdm @ XA2))) => (cwsmo @ (ccres @ XA2 @ XB2)))))).
...
thf(asmoeq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((XA2 = XB2) => ((cwsmo @ XA2) <=> (cwsmo @ XB2)))))).
...
thf(acfcof_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => ((? [Xf1:$i] : (cw3a @ (cwf @ XB2 @ XA2 @ (ccv @ Xf1)) @ (cwsmo @ (ccv @ Xf1)) @ (cwral @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : (cwss @ (ccv @ Xz) @ (ccfv @ (ccv @ Xw) @ (ccv @ Xf1)))) @ (^ [Xw:$i] : XB2))) @ (^ [Xz:$i] : XA2)))) => ((ccfv @ XA2 @ cccf) = (ccfv @ XB2 @ cccf))))))).
...
thf(calephsing_conj,conjecture,(! [XA2:($i > $o)] : ((cwlim @ XA2) => ((ccfv @ (ccfv @ XA2 @ ccale) @ cccf) = (ccfv @ XA2 @ cccf))))).
