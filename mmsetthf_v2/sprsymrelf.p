...
thf(asprsymrelfvlem_ax,axiom,(! [XP:($i > $o)] : (! [XV:($i > $o)] : ((cwss @ XP @ (ccfv @ XV @ ccspr)) => (cwcel @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (cwrex @ (^ [Xc:$i] : ((ccv @ Xc) = (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)))) @ (^ [Xc:$i] : XP))))) @ (ccpw @ (ccxp @ XV @ XV))))))).
