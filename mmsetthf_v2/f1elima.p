...
thf(aimpac_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps => Xch)) => ((Xph & Xps) => (Xch & Xps))))))).
...
thf(cf1elima_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwf1 @ XA2 @ XB2 @ XF) @ (cwcel @ XX @ XA2) @ (cwss @ XY @ XA2)) => ((cwcel @ (ccfv @ XX @ XF) @ (ccima @ XF @ XY)) <=> (cwcel @ XX @ XY))))))))).
