...
thf(acats1fv_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XT = (cco @ XS @ (ccs1 @ XX) @ ccconcat)) => ((cwcel @ XS @ (ccword @ ccvv)) => (((ccfv @ XS @ cchash) = XM) => (((cwcel @ XY @ XV) => ((ccfv @ XN @ XS) = XY)) => ((cwcel @ XN @ ccn0) => ((cwbr @ XN @ XM @ cclt) => ((cwcel @ XY @ XV) => ((ccfv @ XN @ XT) = XY)))))))))))))))).
...
thf(cs4fv0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((ccfv @ ccc0 @ (ccs4 @ XA2 @ XB2 @ XC @ XD)) = XA2)))))))).
