...
thf(ccntzcmnf_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((XZ = (ccfv @ XG @ cccntz)) => ((Xph => (cwcel @ XG @ cccmn)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => (Xph => (cwss @ (ccrn @ XF) @ (ccfv @ (ccrn @ XF) @ XZ)))))))))))))).
