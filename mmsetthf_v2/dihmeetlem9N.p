...
thf(alsmmod_ax,axiom,(! [Xc_po:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((Xc_po = (ccfv @ XG @ cclsm)) => (((cw3a @ (cwcel @ XS @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XT @ (ccfv @ XG @ ccsubg)) @ (cwcel @ XU @ (ccfv @ XG @ ccsubg))) & (cwss @ XS @ XU)) => ((cco @ XS @ (ccin @ XT @ XU) @ Xc_po) = (ccin @ (cco @ XS @ XT @ Xc_po) @ XU)))))))))).
