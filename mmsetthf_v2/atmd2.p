...
thf(acvexch_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((cwbr @ (ccin @ XA2 @ XB2) @ XB2 @ cccv) <=> (cwbr @ XA2 @ (cco @ XA2 @ XB2 @ cchj) @ cccv)))))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(a_3expia_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((cw3a @ Xph @ Xps @ Xch) => Xth) => ((Xph & Xps) => (Xch => Xth)))))))).
thf(acvmd_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwbr @ (ccin @ XA2 @ XB2) @ XB2 @ cccv)) => (cwbr @ XA2 @ XB2 @ ccmd))))).
