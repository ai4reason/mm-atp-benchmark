...
thf(acnprcl_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) => (cwcel @ XP @ XX))))))))).
...
thf(aovif12_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : ((cco @ (ccif @ Xph @ XA2 @ XB2) @ (ccif @ Xph @ XC @ XD) @ XF) = (ccif @ Xph @ (cco @ XA2 @ XC @ XF) @ (cco @ XB2 @ XD @ XF)))))))))).
thf(asyl6eleqr_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ XB2)) => ((XC = XB2) => (Xph => (cwcel @ XA2 @ XC))))))))).
thf(ampbid_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => (Xps <=> Xch)) => (Xph => Xch))))))).
thf(atxcnp_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XL:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((! [Xx3:$i] : (Xph => (cwcel @ (XJ @ Xx3) @ (ccfv @ XX @ cctopon)))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XK @ Xx3) @ (ccfv @ XY @ cctopon)))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XL @ Xx3) @ (ccfv @ XZ @ cctopon)))) => ((Xph => (cwcel @ XD @ XX)) => ((! [Xx3:$i] : (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccfv @ XD @ (cco @ (XJ @ Xx3) @ (XK @ Xx3) @ cccnp))))) => ((! [Xx3:$i] : (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccfv @ XD @ (cco @ (XJ @ Xx3) @ (XL @ Xx3) @ cccnp))))) => (! [Xx3:$i] : (Xph => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccop @ (XA2 @ Xx3) @ (XB2 @ Xx3)))) @ (ccfv @ XD @ (cco @ (XJ @ Xx3) @ (cco @ (XK @ Xx3) @ (XL @ Xx3) @ cctx) @ cccnp)))))))))))))))))))))).
...
thf(alimcmpt_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((! [Xz:$i] : ((Xph & (cwcel @ (ccv @ Xz) @ XA2)) => (cwcel @ (XD @ Xz) @ ccc))) => ((! [Xz:$i] : ((XJ @ Xz) = (cco @ (XK @ Xz) @ (ccun @ XA2 @ (ccsn @ XB2)) @ ccrest))) => ((! [Xz:$i] : ((XK @ Xz) = (ccfv @ cccnfld @ cctopn))) => (! [Xz:$i] : (Xph => ((cwcel @ XC @ (cco @ (ccmpt @ (^ [Xz:$i] : XA2) @ (^ [Xz:$i] : (XD @ Xz))) @ XB2 @ cclimc)) <=> (cwcel @ (ccmpt @ (^ [Xz:$i] : (ccun @ XA2 @ (ccsn @ XB2))) @ (^ [Xz:$i] : (ccif @ ((ccv @ Xz) = XB2) @ XC @ (XD @ Xz)))) @ (ccfv @ XB2 @ (cco @ (XJ @ Xz) @ (XK @ Xz) @ cccnp))))))))))))))))))).
...
thf(acnprest2_ax,axiom,(! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => ((cw3a @ (cwcel @ XK @ cctop) @ (cwf @ XX @ XB2 @ XF) @ (cwss @ XB2 @ XY)) => ((cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) <=> (cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ (cco @ XK @ XB2 @ ccrest) @ cccnp))))))))))))))).
...
thf(acnpco_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (((cwcel @ XF @ (ccfv @ XP @ (cco @ XJ @ XK @ cccnp))) & (cwcel @ XG @ (ccfv @ (ccfv @ XP @ XF) @ (cco @ XK @ XL @ cccnp)))) => (cwcel @ (cccom @ XG @ XF) @ (ccfv @ XP @ (cco @ XJ @ XL @ cccnp))))))))))).
...
thf(climccnp2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XR @ Xx3) @ XX))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XS @ Xx3) @ XY))) => ((Xph => (cwss @ XX @ ccc)) => ((Xph => (cwss @ XY @ ccc)) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccfv @ cccnfld @ cctopn))) => ((! [Xx3:$i] : ((XJ @ Xx3) = (cco @ (cco @ (XK @ Xx3) @ (XK @ Xx3) @ cctx) @ (ccxp @ XX @ XY) @ ccrest))) => ((Xph => (cwcel @ XC @ (cco @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XR @ Xx3))) @ XB2 @ cclimc))) => ((Xph => (cwcel @ XD @ (cco @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XS @ Xx3))) @ XB2 @ cclimc))) => ((! [Xx3:$i] : (Xph => (cwcel @ XH @ (ccfv @ (ccop @ XC @ XD) @ (cco @ (XJ @ Xx3) @ (XK @ Xx3) @ cccnp))))) => (Xph => (cwcel @ (cco @ XC @ XD @ XH) @ (cco @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (cco @ (XR @ Xx3) @ (XS @ Xx3) @ XH))) @ XB2 @ cclimc))))))))))))))))))))))))).
