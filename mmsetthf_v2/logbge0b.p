...
thf(aloggt0b_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => ((cwbr @ ccc0 @ (ccfv @ XA2 @ cclog) @ cclt) <=> (cwbr @ cc1 @ XA2 @ cclt))))).
...
thf(alogge0b_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccrp) => ((cwbr @ ccc0 @ (ccfv @ XA2 @ cclog) @ ccle) <=> (cwbr @ cc1 @ XA2 @ ccle))))).
thf(clogbge0b_conj,conjecture,(! [XB2:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XB2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XX @ ccrp)) => ((cwbr @ ccc0 @ (cco @ XB2 @ XX @ cclogb) @ ccle) <=> (cwbr @ cc1 @ XX @ ccle)))))).
