...
thf(advdslelem_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XM @ ccz) => ((cwcel @ XN @ ccn) => ((cwcel @ XK @ ccz) => ((cwbr @ XN @ XM @ cclt) => (cwne @ (cco @ XK @ XM @ ccmul) @ XN))))))))).
...
thf(cdvdsle_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccn)) => ((cwbr @ XM @ XN @ ccdvds) => (cwbr @ XM @ XN @ ccle)))))).
