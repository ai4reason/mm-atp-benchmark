...
thf(acoseq1_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => (((ccfv @ XA2 @ cccos) = cc1) <=> (cwcel @ (cco @ XA2 @ (cco @ cc2 @ ccpi @ ccmul) @ ccdiv) @ ccz))))).
...
thf(adivadddivd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XD @ ccc)) => ((Xph => (cwne @ XB2 @ ccc0)) => ((Xph => (cwne @ XD @ ccc0)) => (Xph => ((cco @ (cco @ XA2 @ XB2 @ ccdiv) @ (cco @ XC @ XD @ ccdiv) @ ccaddc) = (cco @ (cco @ (cco @ XA2 @ XD @ ccmul) @ (cco @ XC @ XB2 @ ccmul) @ ccaddc) @ (cco @ XB2 @ XD @ ccmul) @ ccdiv))))))))))))))).
...
thf(amoddi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccrp)) => ((cco @ XA2 @ (cco @ XB2 @ XC @ ccmo) @ ccmul) = (cco @ (cco @ XA2 @ XB2 @ ccmul) @ (cco @ XA2 @ XC @ ccmul) @ ccmo))))))).
...
thf(adivne0i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XB2 @ ccc) => ((cwne @ XA2 @ ccc0) => ((cwne @ XB2 @ ccc0) => (cwne @ (cco @ XA2 @ XB2 @ ccdiv) @ ccc0)))))))).
thf(aax_1cn_ax,axiom,(cwcel @ cc1 @ ccc)).
thf(aneqne_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((~ (XA2 = XB2)) => (cwne @ XA2 @ XB2))))).
thf(ccle_tp,type,(ccle : ($i > $o))).
thf(aoddfl_ax,axiom,(! [XK:($i > $o)] : (((cwcel @ XK @ ccz) & (cwne @ (cco @ XK @ cc2 @ ccmo) @ ccc0)) => (XK = (cco @ (cco @ cc2 @ (ccfv @ (cco @ XK @ cc2 @ ccdiv) @ ccfl) @ ccmul) @ cc1 @ ccaddc))))).
thf(ccneg_tp,type,(ccneg : (($i > $o) > ($i > $o)))).
thf(adirkertrigeqlem3_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ ccn)) => ((! [Xn:$i] : (Xph => (cwcel @ (XK @ Xn) @ ccz))) => ((! [Xn:$i] : ((XA2 @ Xn) = (cco @ (cco @ (cco @ cc2 @ (XK @ Xn) @ ccmul) @ cc1 @ ccaddc) @ ccpi @ ccmul))) => (! [Xn:$i] : (Xph => ((cco @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xn:$i] : (ccfv @ (cco @ (ccv @ Xn) @ (XA2 @ Xn) @ ccmul) @ cccos))) @ ccaddc) @ ccpi @ ccdiv) = (cco @ (ccfv @ (cco @ (cco @ XN @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ (XA2 @ Xn) @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ (XA2 @ Xn) @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))))))))).
...
thf(adirkertrigeqlem2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwne @ (ccfv @ XA2 @ ccsin) @ ccc0)) => ((Xph => (cwcel @ XN @ ccn)) => (Xph => ((cco @ (cco @ (cco @ cc1 @ cc2 @ ccdiv) @ (ccsu @ (cco @ cc1 @ XN @ ccfz) @ (^ [Xn:$i] : (ccfv @ (cco @ (ccv @ Xn) @ XA2 @ ccmul) @ cccos))) @ ccaddc) @ ccpi @ ccdiv) = (cco @ (ccfv @ (cco @ (cco @ XN @ (cco @ cc1 @ cc2 @ ccdiv) @ ccaddc) @ XA2 @ ccmul) @ ccsin) @ (cco @ (cco @ cc2 @ ccpi @ ccmul) @ (ccfv @ (cco @ XA2 @ cc2 @ ccdiv) @ ccsin) @ ccmul) @ ccdiv)))))))))).
