...
thf(arnelfmlem_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cw3a @ (cwcel @ XY @ XA2) @ (cwcel @ XL @ (ccfv @ XX @ ccfil)) @ (cwf @ XY @ XX @ XF)) & (cwcel @ (ccrn @ XF) @ XL)) => (cwcel @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XL) @ (^ [Xx3:$i] : (ccima @ (cccnv @ XF) @ (ccv @ Xx3))))) @ (ccfv @ XY @ ccfbas))))))))).
...
thf(afmfg_ax,axiom,(! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XL = (cco @ XY @ XB2 @ ccfg)) => ((cw3a @ (cwcel @ XX @ XC) @ (cwcel @ XB2 @ (ccfv @ XY @ ccfbas)) @ (cwf @ XY @ XX @ XF)) => ((ccfv @ XB2 @ (cco @ XX @ XF @ ccfm)) = (ccfv @ XL @ (cco @ XX @ XF @ ccfm)))))))))))).
...
thf(cfmfnfm_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XB2 @ (ccfv @ XY @ ccfbas)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwcel @ XL @ (ccfv @ XX @ ccfil)))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwf @ XY @ XX @ XF))) => ((! [Xf1:$i] : ((Xph @ Xf1) => (cwss @ (ccfv @ XB2 @ (cco @ XX @ XF @ ccfm)) @ XL))) => (! [Xf1:$i] : ((Xph @ Xf1) => (cwrex @ (^ [Xf1:$i] : ((cwss @ XB2 @ (ccv @ Xf1)) & (XL = (ccfv @ (ccv @ Xf1) @ (cco @ XX @ XF @ ccfm))))) @ (^ [Xf1:$i] : (ccfv @ XY @ ccfil)))))))))))))))).
