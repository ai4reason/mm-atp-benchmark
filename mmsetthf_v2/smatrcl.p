...
thf(aovrcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwrel @ (ccdm @ XF)) => ((cwcel @ XC @ (cco @ XA2 @ XB2 @ XF)) => ((cwcel @ XA2 @ ccvv) & (cwcel @ XB2 @ ccvv))))))))).
