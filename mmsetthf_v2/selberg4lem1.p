...
thf(cselberg4lem1_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : ((! [Xy1:$i] : (! [Xi:$i] : ((Xph @ Xy1 @ Xi) => (cwcel @ XA2 @ ccrp)))) => ((! [Xy1:$i] : (! [Xi:$i] : ((Xph @ Xy1 @ Xi) => (cwral @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (cco @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xy1) @ ccfl) @ ccfz) @ (^ [Xi:$i] : (cco @ (ccfv @ (ccv @ Xi) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xi) @ cclog) @ (ccfv @ (cco @ (ccv @ Xy1) @ (ccv @ Xi) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul))) @ (ccv @ Xy1) @ ccdiv) @ (cco @ cc2 @ (ccfv @ (ccv @ Xy1) @ cclog) @ ccmul) @ ccmin) @ ccabs) @ XA2 @ ccle)) @ (^ [Xy1:$i] : (cco @ cc1 @ ccpnf @ ccico)))))) => (! [Xy1:$i] : (! [Xi:$i] : ((Xph @ Xy1 @ Xi) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ cc1 @ ccpnf @ ccioo)) @ (^ [Xx3:$i] : (cco @ (cco @ (ccsu @ (cco @ cc1 @ (ccfv @ (ccv @ Xx3) @ ccfl) @ ccfz) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ ccvma) @ (ccsu @ (cco @ cc1 @ (ccfv @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ ccfl) @ ccfz) @ (^ [Xm:$i] : (cco @ (ccfv @ (ccv @ Xm) @ ccvma) @ (cco @ (ccfv @ (ccv @ Xm) @ cclog) @ (ccfv @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccdiv) @ (ccv @ Xm) @ ccdiv) @ ccchp) @ ccaddc) @ ccmul))) @ ccmul))) @ (cco @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmul) @ ccdiv) @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccmin))) @ cco1))))))))).
