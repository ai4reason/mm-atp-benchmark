...
thf(aisf32lem4_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : ((! [Xx3:$i] : (Xph => (cwf @ ccom @ (ccpw @ (XG @ Xx3)) @ XF))) => ((Xph => (cwral @ (^ [Xx3:$i] : (cwss @ (ccfv @ (ccsuc @ (ccv @ Xx3)) @ XF) @ (ccfv @ (ccv @ Xx3) @ XF))) @ (^ [Xx3:$i] : ccom))) => ((Xph => (~ (cwcel @ (ccint @ (ccrn @ XF)) @ (ccrn @ XF)))) => (((Xph & (cwne @ XA2 @ XB2)) & ((cwcel @ XA2 @ ccom) & (cwcel @ XB2 @ ccom))) => ((ccin @ (ccdif @ (ccfv @ XA2 @ XF) @ (ccfv @ (ccsuc @ XA2) @ XF)) @ (ccdif @ (ccfv @ XB2 @ XF) @ (ccfv @ (ccsuc @ XB2) @ XF))) = cc0))))))))))).
