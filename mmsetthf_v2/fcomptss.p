...
thf(cfcomptss_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwf @ XA2 @ (XB2 @ Xx3) @ XF))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ (XB2 @ Xx3) @ XC))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwf @ XC @ XD @ XG))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((cccom @ XG @ XF) = (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ XG))))))))))))))))).
