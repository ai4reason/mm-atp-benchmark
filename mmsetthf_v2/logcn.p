...
thf(arelog_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwne @ XA2 @ ccc0)) => ((ccfv @ (ccfv @ XA2 @ cclog) @ ccre) = (ccfv @ (ccfv @ XA2 @ ccabs) @ cclog))))).
...
thf(alogcnlem5_ax,axiom,(! [XD:($i > $o)] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xx3) @ cclog) @ ccim))) @ (cco @ XD @ ccr @ cccncf))))).
...
thf(clogcn_conj,conjecture,(! [XD:($i > $o)] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwcel @ (ccres @ cclog @ XD) @ (cco @ XD @ ccc @ cccncf))))).
