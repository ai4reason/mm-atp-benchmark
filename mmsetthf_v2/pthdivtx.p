...
thf(aelfz0lmr_ax,axiom,(! [XK:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ ccc0 @ XN @ ccfz)) => (cw3o @ (XK = ccc0) @ (cwcel @ XK @ (cco @ cc1 @ XN @ ccfzo)) @ (XK = XN)))))).
...
thf(cpthdivtx_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (((cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) & (cw3a @ (cwcel @ XI @ (cco @ cc1 @ (ccfv @ XF @ cchash) @ ccfzo)) @ (cwcel @ XJ @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz)) @ (cwne @ XI @ XJ))) => (cwne @ (ccfv @ XI @ XP) @ (ccfv @ XJ @ XP))))))))).
