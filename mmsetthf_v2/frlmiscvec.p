...
thf(afrlmisfrlm_ax,axiom,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XR @ ccnzr) @ (cwcel @ XI @ XY) @ (cwbr @ XI @ XJ @ ccen)) => (cwbr @ (cco @ XR @ XI @ ccfrlm) @ (cco @ XR @ XJ @ ccfrlm) @ cclmic))))))).
thf(cfrlmiscvec_conj,conjecture,(! [XR:($i > $o)] : (! [XI:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XR @ ccnzr) & (cwcel @ XI @ XY)) => (cwbr @ (cco @ XR @ XI @ ccfrlm) @ (cco @ XR @ (ccxp @ XI @ (ccsn @ cc0)) @ ccfrlm) @ cclmic)))))).
