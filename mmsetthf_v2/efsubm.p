...
thf(aefabl_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ cce)))) => ((XG = (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccrn @ XF) @ ccress)) => ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XX @ (ccfv @ cccnfld @ ccsubg))) => (Xph => (cwcel @ XG @ ccabl)))))))))))).
...
thf(cefsubm_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XF = (ccmpt @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccfv @ (cco @ XA2 @ (ccv @ Xx3) @ ccmul) @ cce)))) => ((XG = (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccrn @ XF) @ ccress)) => ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XX @ (ccfv @ cccnfld @ ccsubg))) => (Xph => (cwcel @ (ccrn @ XF) @ (ccfv @ (ccfv @ cccnfld @ ccmgp) @ ccsubmnd))))))))))))).
