...
thf(aaxccdom_ax,axiom,(! [Xph:($i > $o)] : (! [XX:($i > $o)] : ((! [Xf1:$i] : ((Xph @ Xf1) => (cwbr @ XX @ ccom @ ccdom))) => ((! [Xz:$i] : (! [Xf1:$i] : (((Xph @ Xf1) & (cwcel @ (ccv @ Xz) @ XX)) => (cwne @ (ccv @ Xz) @ cc0)))) => (! [Xf1:$i] : ((Xph @ Xf1) => (? [Xf1:$i] : ((cwfn @ (ccv @ Xf1) @ XX) & (cwral @ (^ [Xz:$i] : (cwcel @ (ccfv @ (ccv @ Xz) @ (ccv @ Xf1)) @ (ccv @ Xz))) @ (^ [Xz:$i] : XX))))))))))).
...
thf(csubsaliuncl_conj,conjecture,(! [Xph:$o] : (! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : ((Xph => (cwcel @ XS @ ccsalg)) => ((! [Xn:$i] : (Xph => (cwcel @ XD @ (XV @ Xn)))) => ((! [Xn:$i] : ((XT @ Xn) = (cco @ XS @ XD @ ccrest))) => ((! [Xn:$i] : (Xph => (cwf @ ccn @ (XT @ Xn) @ XF))) => (! [Xn:$i] : (Xph => (cwcel @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccv @ Xn) @ XF))) @ (XT @ Xn))))))))))))))).
