...
thf(a_0clwlkv_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((cw3a @ (cwcel @ XX @ XV) @ (XF = cc0) @ (cwf @ (ccsn @ ccc0) @ (ccsn @ XX) @ XP)) => (cwbr @ XF @ XP @ (ccfv @ XG @ ccclwlks)))))))))).
