...
thf(aom00_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccon0) & (cwcel @ XB2 @ ccon0)) => (((cco @ XA2 @ XB2 @ ccomu) = cc0) <=> ((XA2 = cc0) | (XB2 = cc0))))))).
...
thf(aonnbtwn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccon0) => (~ ((cwcel @ XA2 @ XB2) & (cwcel @ XB2 @ (ccsuc @ XA2)))))))).
...
thf(aomord_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccon0) @ (cwcel @ XB2 @ ccon0) @ (cwcel @ XC @ ccon0)) => (((cwcel @ XA2 @ XB2) & (cwcel @ cc0 @ XC)) <=> (cwcel @ (cco @ XC @ XA2 @ ccomu) @ (cco @ XC @ XB2 @ ccomu)))))))).
thf(ccuni_tp,type,(ccuni : (($i > $o) > ($i > $o)))).
thf(adflim3_ax,axiom,(! [XA2:($i > $o)] : ((cwlim @ XA2) <=> ((cword @ XA2) & (~ ((XA2 = cc0) | (cwrex @ (^ [Xx3:$i] : (XA2 = (ccsuc @ (ccv @ Xx3)))) @ (^ [Xx3:$i] : ccon0)))))))).
thf(comlimcl_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((((cwcel @ XA2 @ ccon0) & ((cwcel @ XB2 @ XC) & (cwlim @ XB2))) & (cwcel @ cc0 @ XA2)) => (cwlim @ (cco @ XA2 @ XB2 @ ccomu))))))).
