...
thf(ckur14lem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XI:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ cctop) => ((XX = (ccuni @ XJ)) => ((XK = (ccfv @ XJ @ cccl)) => ((XI = (ccfv @ XJ @ ccnt)) => ((cwss @ XA2 @ XX) => (cwss @ (ccfv @ XA2 @ XK) @ XX)))))))))))).
