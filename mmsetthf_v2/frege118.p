...
thf(afrege117_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XX:($i > $o)] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xa:$i] : (! [Xb:$i] : (cwcel @ XX @ (XU @ Xa @ Xb)))) => (! [Xa:$i] : (! [Xb:$i] : (((! [Xb:$i] : ((cwbr @ (ccv @ Xb) @ XX @ XR) => (! [Xa:$i] : ((cwbr @ (ccv @ Xb) @ (ccv @ Xa) @ XR) => ((ccv @ Xa) = XX))))) => ((cwbr @ (XY @ Xa @ Xb) @ XX @ XR) => (! [Xa:$i] : ((cwbr @ (XY @ Xa @ Xb) @ (ccv @ Xa) @ XR) => ((ccv @ Xa) = XX))))) => ((cwfun @ (cccnv @ (cccnv @ XR))) => ((cwbr @ (XY @ Xa @ Xb) @ XX @ XR) => (! [Xa:$i] : ((cwbr @ (XY @ Xa @ Xb) @ (ccv @ Xa) @ XR) => ((ccv @ Xa) = XX)))))))))))))).
