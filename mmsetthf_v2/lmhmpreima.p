...
thf(aghmpreima_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XF @ (cco @ XS @ XT @ ccghm)) & (cwcel @ XV @ (ccfv @ XT @ ccsubg))) => (cwcel @ (ccima @ (cccnv @ XF) @ XV) @ (ccfv @ XS @ ccsubg)))))))).
...
thf(clmhmpreima_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccfv @ XS @ cclss)) => ((XY = (ccfv @ XT @ cclss)) => (((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) & (cwcel @ XU @ XY)) => (cwcel @ (ccima @ (cccnv @ XF) @ XU) @ XX))))))))))).
