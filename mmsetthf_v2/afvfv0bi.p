...
thf(aafv0fv0_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((ccafv @ XA2 @ XF) = cc0) => ((ccfv @ XA2 @ XF) = cc0))))).
thf(ccsn_tp,type,(ccsn : (($i > $o) > ($i > $o)))).
thf(ccres_tp,type,(ccres : (($i > $o) > (($i > $o) > ($i > $o))))).
thf(cwfun_tp,type,(cwfun : (($i > $o) > $o))).
thf(ccdm_tp,type,(ccdm : (($i > $o) > ($i > $o)))).
thf(ccif_tp,type,(ccif : ($o > (($i > $o) > (($i > $o) > ($i > $o)))))).
thf(aafvpcfv0_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((ccafv @ XA2 @ XF) = ccvv) => ((ccfv @ XA2 @ XF) = cc0))))).
thf(cafvfv0bi_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((ccfv @ XA2 @ XF) = cc0) <=> (((ccafv @ XA2 @ XF) = cc0) | ((ccafv @ XA2 @ XF) = ccvv)))))).
