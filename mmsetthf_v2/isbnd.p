...
thf(adf_bnd_ax,axiom,(ccbnd = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccrab @ (^ [Xm:$i] : (cwral @ (^ [Xy1:$i] : (cwrex @ (^ [Xr:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ (ccv @ Xr) @ (ccfv @ (ccv @ Xm) @ ccbl)))) @ (^ [Xr:$i] : ccrp))) @ (^ [Xy1:$i] : (ccv @ Xx3)))) @ (^ [Xm:$i] : (ccfv @ (ccv @ Xx3) @ ccme))))))).
...
thf(cisbnd_conj,conjecture,(! [XM:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XM @ (ccfv @ XX @ ccbnd)) <=> ((cwcel @ XM @ (ccfv @ XX @ ccme)) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xr:$i] : (XX = (cco @ (ccv @ Xx3) @ (ccv @ Xr) @ (ccfv @ XM @ ccbl)))) @ (^ [Xr:$i] : ccrp))) @ (^ [Xx3:$i] : XX))))))).
