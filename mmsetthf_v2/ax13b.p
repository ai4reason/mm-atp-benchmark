...
thf(cax13b_conj,conjecture,(! [Xph:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (((~ ((ccv @ Xx3) = (ccv @ Xy1))) => (((ccv @ Xy1) = (ccv @ Xz)) => (Xph @ Xx3 @ Xy1 @ Xz))) <=> ((~ ((ccv @ Xx3) = (ccv @ Xy1))) => ((~ ((ccv @ Xx3) = (ccv @ Xz))) => (((ccv @ Xy1) = (ccv @ Xz)) => (Xph @ Xx3 @ Xy1 @ Xz)))))))))).
