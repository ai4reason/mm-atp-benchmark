...
thf(azneoALTV_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cceven) & (cwcel @ XB2 @ ccodd)) => (cwne @ XA2 @ XB2))))).
...
thf(cevenltle_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ cceven) @ (cwcel @ XM @ cceven) @ (cwbr @ XM @ XN @ cclt)) => (cwbr @ (cco @ XM @ cc2 @ ccaddc) @ XN @ ccle))))).
