...
thf(celutop_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [Xv:$i] : ((cwcel @ XU @ (ccfv @ (XX @ Xv) @ ccust)) => ((cwcel @ XA2 @ (ccfv @ XU @ ccutop)) <=> ((cwss @ XA2 @ (XX @ Xv)) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xv:$i] : (cwss @ (ccima @ (ccv @ Xv) @ (ccsn @ (ccv @ Xx3))) @ XA2)) @ (^ [Xv:$i] : XU))) @ (^ [Xx3:$i] : XA2)))))))))).
