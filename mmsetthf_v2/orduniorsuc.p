...
thf(aorduni_ax,axiom,(! [XA2:($i > $o)] : ((cword @ XA2) => (cword @ (ccuni @ XA2))))).
thf(aordelssne_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cword @ XA2) & (cword @ XB2)) => ((cwcel @ XA2 @ XB2) <=> ((cwss @ XA2 @ XB2) & (cwne @ XA2 @ XB2))))))).
thf(aordsucss_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cword @ XB2) => ((cwcel @ XA2 @ XB2) => (cwss @ (ccsuc @ XA2) @ XB2)))))).
thf(aordsucuni_ax,axiom,(! [XA2:($i > $o)] : ((cword @ XA2) => (cwss @ XA2 @ (ccsuc @ (ccuni @ XA2)))))).
...
thf(corduniorsuc_conj,conjecture,(! [XA2:($i > $o)] : ((cword @ XA2) => ((XA2 = (ccuni @ XA2)) | (XA2 = (ccsuc @ (ccuni @ XA2))))))).
