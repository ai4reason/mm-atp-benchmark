...
thf(abj_xpima2sn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XA2) => ((ccima @ (ccxp @ XA2 @ XB2) @ (ccsn @ XX)) = XB2)))))).
...
thf(abj_taginv_ax,axiom,(! [XA2:($i > $o)] : (XA2 = (ccab @ (^ [Xx3:$i] : (cwcel @ (ccsn @ (ccv @ Xx3)) @ (cbj_ctag @ XA2))))))).
...
thf(abj_xpima1sn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((cwnel @ XX @ XA2) => ((ccima @ (ccxp @ XA2 @ XB2) @ (ccsn @ XX)) = cc0)))))).
