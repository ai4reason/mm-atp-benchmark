...
thf(ckmlem3_conj,conjecture,(! [Xx3:$i] : (! [Xz:$i] : ((cwne @ (ccdif @ (ccv @ Xz) @ (ccuni @ (ccdif @ (ccv @ Xx3) @ (ccsn @ (ccv @ Xz))))) @ cc0) <=> (cwrex @ (^ [Xv:$i] : (cwral @ (^ [Xw:$i] : ((cwne @ (ccv @ Xz) @ (ccv @ Xw)) => (~ (cwcel @ (ccv @ Xv) @ (ccin @ (ccv @ Xz) @ (ccv @ Xw)))))) @ (^ [Xw:$i] : (ccv @ Xx3)))) @ (^ [Xv:$i] : (ccv @ Xz))))))).
