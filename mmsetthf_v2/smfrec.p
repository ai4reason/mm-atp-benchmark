...
thf(apimrecltpos_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => (cwcel @ (XB2 @ Xx3) @ ccr))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => (cwne @ (XB2 @ Xx3) @ ccc0))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XC @ Xx3) @ ccrp))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccrab @ (^ [Xx3:$i] : (cwbr @ (cco @ cc1 @ (XB2 @ Xx3) @ ccdiv) @ (XC @ Xx3) @ cclt)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) = (ccun @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (cco @ cc1 @ (XC @ Xx3) @ ccdiv) @ (XB2 @ Xx3) @ cclt)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccrab @ (^ [Xx3:$i] : (cwbr @ (XB2 @ Xx3) @ ccc0 @ cclt)) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))))))))))).
...
thf(asaluncld_ax,axiom,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwcel @ XS @ ccsalg)) => ((Xph => (cwcel @ XE @ XS)) => ((Xph => (cwcel @ XF @ XS)) => (Xph => (cwcel @ (ccun @ XE @ XF) @ XS)))))))))).
...
thf(asmfpimgtmpt_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XL:($i > $o)] : (! [XV:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XS @ Xx3) @ ccsalg))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccfv @ (XS @ Xx3) @ ccsmblfn)))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XL @ ccr))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (ccrab @ (^ [Xx3:$i] : (cwbr @ XL @ (XB2 @ Xx3) @ cclt)) @ (^ [Xx3:$i] : XA2)) @ (cco @ (XS @ Xx3) @ XA2 @ ccrest)))))))))))))))).
...
thf(areclt0_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwne @ XA2 @ ccc0)) => (Xph => ((cwbr @ XA2 @ ccc0 @ cclt) <=> (cwbr @ (cco @ cc1 @ XA2 @ ccdiv) @ ccc0 @ cclt)))))))).
...
thf(apimrecltneg_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => (cwcel @ (XB2 @ Xx3) @ ccr))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => (cwne @ (XB2 @ Xx3) @ ccc0))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XC @ Xx3) @ ccr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwbr @ (XC @ Xx3) @ ccc0 @ cclt))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccrab @ (^ [Xx3:$i] : (cwbr @ (cco @ cc1 @ (XB2 @ Xx3) @ ccdiv) @ (XC @ Xx3) @ cclt)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) = (ccrab @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ (cco @ (cco @ cc1 @ (XC @ Xx3) @ ccdiv) @ ccc0 @ ccioo))) @ (^ [Xx3:$i] : (XA2 @ Xx3)))))))))))))))).
...
thf(alt0ne0_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwbr @ XA2 @ ccc0 @ cclt)) => (cwne @ XA2 @ ccc0)))).
thf(csmfrec_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XV:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (XS @ Xx3) @ ccsalg))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ XA2 @ (XV @ Xx3)))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ XA2)) => (cwcel @ (XB2 @ Xx3) @ ccr))) => ((! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ (ccfv @ (XS @ Xx3) @ ccsmblfn)))) => ((XC = (ccrab @ (^ [Xx3:$i] : (cwne @ (XB2 @ Xx3) @ ccc0)) @ (^ [Xx3:$i] : XA2))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : XC) @ (^ [Xx3:$i] : (cco @ cc1 @ (XB2 @ Xx3) @ ccdiv))) @ (ccfv @ (XS @ Xx3) @ ccsmblfn))))))))))))))))).
