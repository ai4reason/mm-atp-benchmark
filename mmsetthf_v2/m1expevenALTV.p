...
thf(adfeven4_ax,axiom,(cceven = (ccrab @ (^ [Xz:$i] : (cwrex @ (^ [Xi:$i] : ((ccv @ Xz) = (cco @ cc2 @ (ccv @ Xi) @ ccmul))) @ (^ [Xi:$i] : ccz))) @ (^ [Xz:$i] : ccz)))).
...
thf(cm1expevenALTV_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ cceven) => ((cco @ (ccneg @ cc1) @ XN @ ccexp) = cc1)))).
