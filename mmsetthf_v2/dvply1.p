...
thf(cdvply1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : ((! [Xz:$i] : (! [Xk:$i] : (Xph => ((XF @ Xz @ Xk) = (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XA2) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul))))))))) => ((! [Xz:$i] : (! [Xk:$i] : (Xph => ((XG @ Xz @ Xk) = (ccmpt @ (^ [Xz:$i] : ccc) @ (^ [Xz:$i] : (ccsu @ (cco @ ccc0 @ (cco @ XN @ cc1 @ ccmin) @ ccfz) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (XB2 @ Xk)) @ (cco @ (ccv @ Xz) @ (ccv @ Xk) @ ccexp) @ ccmul))))))))) => ((Xph => (cwf @ ccn0 @ ccc @ XA2)) => ((! [Xk:$i] : ((XB2 @ Xk) = (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (cco @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XA2) @ ccmul))))) => ((Xph => (cwcel @ XN @ ccn0)) => (! [Xz:$i] : (! [Xk:$i] : (Xph => ((cco @ ccc @ (XF @ Xz @ Xk) @ ccdv) = (XG @ Xz @ Xk))))))))))))))))).
