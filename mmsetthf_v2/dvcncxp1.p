...
thf(cdvcncxp1_conj,conjecture,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => ((cwcel @ XA2 @ ccc) => ((cco @ ccc @ (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ XA2 @ cccxp))) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XD) @ (^ [Xx3:$i] : (cco @ XA2 @ (cco @ (ccv @ Xx3) @ (cco @ XA2 @ cc1 @ ccmin) @ cccxp) @ ccmul))))))))).
