...
thf(arest0_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cctop) => ((cco @ XJ @ cc0 @ ccrest) = (ccsn @ cc0))))).
thf(a_0cmp_ax,axiom,(cwcel @ (ccsn @ cc0) @ cccmp)).
thf(alelttric_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cwbr @ XA2 @ XB2 @ ccle) | (cwbr @ XB2 @ XA2 @ cclt)))))).
thf(cicccmp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ (ccrn @ ccioo) @ cctg)) => ((XT = (cco @ XJ @ (cco @ XA2 @ XB2 @ ccicc) @ ccrest)) => (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (cwcel @ XT @ cccmp))))))))).
