...
thf(aqshash_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_sm:($i > $o)] : ((Xph => (cwer @ XA2 @ Xc_sm)) => ((Xph => (cwcel @ XA2 @ ccfn)) => (Xph => ((ccfv @ XA2 @ cchash) = (ccsu @ (ccqs @ XA2 @ Xc_sm) @ (^ [Xx3:$i] : (ccfv @ (ccv @ Xx3) @ cchash))))))))))).
...
thf(aelqsn0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((((ccdm @ XR) = XA2) & (cwcel @ XB2 @ (ccqs @ XA2 @ XR))) => (cwne @ XB2 @ cc0)))))).
