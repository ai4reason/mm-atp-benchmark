...
thf(aoppgmnd_ax,axiom,(! [XR:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XR @ ccoppg)) => ((cwcel @ XR @ ccmnd) => (cwcel @ XO @ ccmnd)))))).
...
thf(agsumcllem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XW:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xk:$i] : (Xph => (cwf @ XA2 @ (XB2 @ Xk) @ XF))) => ((! [Xk:$i] : (Xph => (cwcel @ XA2 @ (XV @ Xk)))) => ((! [Xk:$i] : (Xph => (cwcel @ (XZ @ Xk) @ (XU @ Xk)))) => ((! [Xk:$i] : (Xph => (cwss @ (cco @ XF @ (XZ @ Xk) @ ccsupp) @ XW))) => ((Xph & (XW = cc0)) => (XF = (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XZ @ Xk)))))))))))))))))).
...
thf(aseqfeq4_ax,axiom,(! [Xph:$o] : (! [Xc_pl:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (cco @ XM @ XN @ ccfz))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ XS))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) @ XS)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((cwcel @ (ccv @ Xx3) @ XS) & (cwcel @ (ccv @ Xy1) @ XS))) => ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ Xc_pl) = (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XQ))))) => (Xph => ((ccfv @ XN @ (ccseq @ Xc_pl @ XF @ XM)) = (ccfv @ XN @ (ccseq @ XQ @ XF @ XM)))))))))))))))).
...
thf(aoppgsubm_ax,axiom,(! [XG:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XG @ ccoppg)) => ((ccfv @ XG @ ccsubmnd) = (ccfv @ XO @ ccsubmnd)))))).
...
thf(acntzspan_ax,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XG @ cccntz)) => ((XK = (ccfv @ (ccfv @ XG @ ccsubmnd) @ ccmrc)) => ((XH = (cco @ XG @ (ccfv @ XS @ XK) @ ccress)) => (((cwcel @ XG @ ccmnd) & (cwss @ XS @ (ccfv @ XS @ XZ))) => (cwcel @ XH @ cccmn))))))))))).
