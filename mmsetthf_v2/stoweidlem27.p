...
thf(cstoweidlem27_conj,conjecture,(! [Xph:($i > ($i > ($i > ($i > $o))))] : (! [XQ:($i > ($i > ($i > ($i > $o))))] : (! [XT:($i > ($i > ($i > ($i > $o))))] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XX:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XY:($i > $o)] : ((! [Xw:$i] : (! [Xt:$i] : (! [Xh:$i] : (! [Xi:$i] : (! [Xq:$i] : (! [Xl:$i] : ((XG @ Xw @ Xt @ Xh @ Xq) = (ccmpt @ (^ [Xw:$i] : (XX @ Xt @ Xh @ Xq @ Xl)) @ (^ [Xw:$i] : (ccrab @ (^ [Xh:$i] : ((ccv @ Xw) = (ccrab @ (^ [Xt:$i] : (cwbr @ ccc0 @ (ccfv @ (ccv @ Xt) @ (ccv @ Xh)) @ cclt)) @ (^ [Xt:$i] : (XT @ Xt @ Xi @ Xl))))) @ (^ [Xh:$i] : (XQ @ Xt @ Xh @ Xi)))))))))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xh:$i] : (! [Xi:$i] : (! [Xq:$i] : ((Xph @ Xw @ Xt @ Xh @ Xq) => (cwcel @ (XQ @ Xt @ Xh @ Xi) @ ccvv))))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xh:$i] : (! [Xq:$i] : (! [Xl:$i] : ((Xph @ Xw @ Xt @ Xh @ Xq) => (cwcel @ (XM @ Xt @ Xh @ Xl) @ ccn))))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xh:$i] : (! [Xq:$i] : ((Xph @ Xw @ Xt @ Xh @ Xq) => (cwfn @ XY @ (ccrn @ (XG @ Xw @ Xt @ Xh @ Xq)))))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xh:$i] : (! [Xq:$i] : ((Xph @ Xw @ Xt @ Xh @ Xq) => (cwcel @ (ccrn @ (XG @ Xw @ Xt @ Xh @ Xq)) @ ccvv)))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xh:$i] : (! [Xq:$i] : (! [Xl:$i] : (((Xph @ Xw @ Xt @ Xh @ Xq) & (cwcel @ (ccv @ Xl) @ (ccrn @ (XG @ Xw @ Xt @ Xh @ Xq)))) => (cwcel @ (ccfv @ (ccv @ Xl) @ XY) @ (ccv @ Xl)))))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xh:$i] : (! [Xq:$i] : (! [Xl:$i] : ((Xph @ Xw @ Xt @ Xh @ Xq) => (cwf1o @ (cco @ cc1 @ (XM @ Xt @ Xh @ Xl) @ ccfz) @ (ccrn @ (XG @ Xw @ Xt @ Xh @ Xq)) @ (XF @ Xl)))))))) => ((! [Xw:$i] : (! [Xt:$i] : (! [Xh:$i] : (! [Xi:$i] : (! [Xq:$i] : (! [Xl:$i] : ((Xph @ Xw @ Xt @ Xh @ Xq) => (cwss @ (ccdif @ (XT @ Xt @ Xi @ Xl) @ (XU @ Xt @ Xh @ Xi @ Xl)) @ (ccuni @ (XX @ Xt @ Xh @ Xq @ Xl)))))))))) => ((! [Xw:$i] : (! [Xh:$i] : (! [Xq:$i] : (cwnf @ (^ [Xt:$i] : (Xph @ Xw @ Xt @ Xh @ Xq)))))) => ((! [Xt:$i] : (! [Xh:$i] : (! [Xq:$i] : (cwnf @ (^ [Xw:$i] : (Xph @ Xw @ Xt @ Xh @ Xq)))))) => ((! [Xt:$i] : (! [Xi:$i] : (cwnfc @ (^ [Xh:$i] : (XQ @ Xt @ Xh @ Xi))))) => (! [Xw:$i] : (! [Xt:$i] : (! [Xh:$i] : (! [Xi:$i] : (! [Xq:$i] : (! [Xl:$i] : ((Xph @ Xw @ Xt @ Xh @ Xq) => (? [Xq:$i] : ((cwcel @ (XM @ Xt @ Xh @ Xl) @ ccn) & ((cwf @ (cco @ cc1 @ (XM @ Xt @ Xh @ Xl) @ ccfz) @ (XQ @ Xt @ Xh @ Xi) @ (ccv @ Xq)) & (cwral @ (^ [Xt:$i] : (cwrex @ (^ [Xi:$i] : (cwbr @ ccc0 @ (ccfv @ (ccv @ Xt) @ (ccfv @ (ccv @ Xi) @ (ccv @ Xq))) @ cclt)) @ (^ [Xi:$i] : (cco @ cc1 @ (XM @ Xt @ Xh @ Xl) @ ccfz)))) @ (^ [Xt:$i] : (ccdif @ (XT @ Xt @ Xi @ Xl) @ (XU @ Xt @ Xh @ Xi @ Xl))))))))))))))))))))))))))))))))))).
