...
thf(alhop2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((Xph => (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ XF)) => ((Xph => (cwf @ (cco @ XA2 @ XB2 @ ccioo) @ ccr @ XG)) => ((Xph => ((ccdm @ (cco @ ccr @ XF @ ccdv)) = (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => ((ccdm @ (cco @ ccr @ XG @ ccdv)) = (cco @ XA2 @ XB2 @ ccioo))) => ((Xph => (cwcel @ ccc0 @ (cco @ XF @ XB2 @ cclimc))) => ((Xph => (cwcel @ ccc0 @ (cco @ XG @ XB2 @ cclimc))) => ((Xph => (~ (cwcel @ ccc0 @ (ccrn @ XG)))) => ((Xph => (~ (cwcel @ ccc0 @ (ccrn @ (cco @ ccr @ XG @ ccdv))))) => ((Xph => (cwcel @ XC @ (cco @ (ccmpt @ (^ [Xz:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xz:$i] : (cco @ (ccfv @ (ccv @ Xz) @ (cco @ ccr @ XF @ ccdv)) @ (ccfv @ (ccv @ Xz) @ (cco @ ccr @ XG @ ccdv)) @ ccdiv))) @ XB2 @ cclimc))) => (Xph => (cwcel @ XC @ (cco @ (ccmpt @ (^ [Xz:$i] : (cco @ XA2 @ XB2 @ ccioo)) @ (^ [Xz:$i] : (cco @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ (ccv @ Xz) @ XG) @ ccdiv))) @ XB2 @ cclimc)))))))))))))))))))))).
...
thf(aubioo_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (~ (cwcel @ XB2 @ (cco @ XA2 @ XB2 @ ccioo)))))).
...
thf(amptresid_ax,axiom,(! [XA2:($i > $o)] : ((ccmpt @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3))) = (ccres @ ccid @ XA2)))).
...
thf(aioon0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwne @ (cco @ XA2 @ XB2 @ ccioo) @ cc0) <=> (cwbr @ XA2 @ XB2 @ cclt)))))).
