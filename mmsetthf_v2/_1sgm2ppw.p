...
thf(asgmppw_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XP @ ccprime) @ (cwcel @ XN @ ccn0)) => ((cco @ XA2 @ (cco @ XP @ XN @ ccexp) @ ccsgm) = (ccsu @ (cco @ ccc0 @ XN @ ccfz) @ (^ [Xk:$i] : (cco @ (cco @ XP @ XA2 @ cccxp) @ (ccv @ Xk) @ ccexp))))))))).
...
thf(acxp1_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ XA2 @ cc1 @ cccxp) = XA2)))).
...
thf(apnpcan_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ (cwcel @ XC @ ccc)) => ((cco @ (cco @ XA2 @ XB2 @ ccaddc) @ (cco @ XA2 @ XC @ ccaddc) @ ccmin) = (cco @ XB2 @ XC @ ccmin))))))).
...
thf(c_1sgm2ppw_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cco @ cc1 @ (cco @ cc2 @ (cco @ XN @ cc1 @ ccmin) @ ccexp) @ ccsgm) = (cco @ (cco @ cc2 @ XN @ ccexp) @ cc1 @ ccmin))))).
