...
thf(cmodremain_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XD @ ccn) @ ((cwcel @ XR @ ccn0) & (cwbr @ XR @ XD @ cclt))) => (((cco @ XN @ XD @ ccmo) = XR) <=> (cwrex @ (^ [Xz:$i] : ((cco @ (cco @ (ccv @ Xz) @ XD @ ccmul) @ XR @ ccaddc) = XN)) @ (^ [Xz:$i] : ccz)))))))).
