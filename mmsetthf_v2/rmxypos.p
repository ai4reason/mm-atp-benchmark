...
thf(armxp1_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccz)) => ((cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccrmx) = (cco @ (cco @ (cco @ XA2 @ XN @ ccrmx) @ XA2 @ ccmul) @ (cco @ (cco @ (cco @ XA2 @ cc2 @ ccexp) @ cc1 @ ccmin) @ (cco @ XA2 @ XN @ ccrmy) @ ccmul) @ ccaddc)))))).
