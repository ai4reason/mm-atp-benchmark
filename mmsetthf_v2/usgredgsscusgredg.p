...
thf(ausgredg_ax,axiom,(! [XC:($i > $o)] : (! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xa:$i] : (! [Xb:$i] : ((XE @ Xa @ Xb) = (ccfv @ XG @ ccedg)))) => (! [Xa:$i] : (! [Xb:$i] : (((cwcel @ XG @ ccusgr) & (cwcel @ XC @ (XE @ Xa @ Xb))) => (cwrex @ (^ [Xa:$i] : (cwrex @ (^ [Xb:$i] : ((cwne @ (ccv @ Xa) @ (ccv @ Xb)) & (XC = (ccpr @ (ccv @ Xa) @ (ccv @ Xb))))) @ (^ [Xb:$i] : XV))) @ (^ [Xa:$i] : XV)))))))))))).
...
thf(aiscusgredg_ax,axiom,(! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xk:$i] : (! [Xn:$i] : ((XE @ Xk @ Xn) = (ccfv @ XG @ ccedg)))) => ((cwcel @ XG @ cccusgr) <=> ((cwcel @ XG @ ccusgr) & (cwral @ (^ [Xk:$i] : (cwral @ (^ [Xn:$i] : (cwcel @ (ccpr @ (ccv @ Xn) @ (ccv @ Xk)) @ (XE @ Xk @ Xn))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xk)))))) @ (^ [Xk:$i] : XV)))))))))).
...
thf(cusgredgsscusgredg_conj,conjecture,(! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((XV = (ccfv @ XH @ ccvtx)) => ((XF = (ccfv @ XH @ ccedg)) => (((cwcel @ XG @ ccusgr) & (cwcel @ XH @ cccusgr)) => (cwss @ XE @ XF)))))))))))).
