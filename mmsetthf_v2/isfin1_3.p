...
thf(adisjpss_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((ccin @ XA2 @ XB2) = cc0) & (cwne @ XB2 @ cc0)) => (cwpss @ XA2 @ (ccun @ XA2 @ XB2)))))).
...
thf(cisfin1_3_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => ((cwcel @ XA2 @ ccfn) <=> (cwfr @ (ccpw @ XA2) @ (cccnv @ ccrpss))))))).
