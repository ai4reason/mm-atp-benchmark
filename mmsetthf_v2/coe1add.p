...
thf(ccoe1add_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [Xc_pb:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccfv @ XR @ ccpl1)) => ((XB2 = (ccfv @ XY @ ccbs)) => ((Xc_pb = (ccfv @ XY @ ccplusg)) => ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XF @ XB2) @ (cwcel @ XG @ XB2)) => ((ccfv @ (cco @ XF @ XG @ Xc_pb) @ ccco1) = (cco @ (ccfv @ XF @ ccco1) @ (ccfv @ XG @ ccco1) @ (ccof @ Xc_pl)))))))))))))))).
