...
thf(cdvnbss_conj,conjecture,(! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XS @ (ccpr @ ccr @ ccc)) @ (cwcel @ XF @ (cco @ ccc @ XS @ ccpm)) @ (cwcel @ XN @ ccn0)) => (cwss @ (ccdm @ (ccfv @ XN @ (cco @ XS @ XF @ ccdvn))) @ (ccdm @ XF))))))).
