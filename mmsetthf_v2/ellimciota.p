...
thf(cellimciota_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XK:($i > $o)] : ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ (ccfv @ XA2 @ (ccfv @ XK @ cclp)))) => ((Xph => (cwne @ (cco @ XF @ XB2 @ cclimc) @ cc0)) => ((XK = (ccfv @ cccnfld @ cctopn)) => (Xph => (cwcel @ (ccio @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (cco @ XF @ XB2 @ cclimc)))) @ (cco @ XF @ XB2 @ cclimc)))))))))))))).
