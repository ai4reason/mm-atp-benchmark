...
thf(crexzrexnn0_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccneg @ (ccv @ Xy1))) => ((Xph @ Xx3) <=> (Xch @ Xy1))))) => ((cwrex @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : ccz)) <=> (cwrex @ (^ [Xy1:$i] : ((Xps @ Xy1) | (Xch @ Xy1))) @ (^ [Xy1:$i] : ccn0))))))))).
