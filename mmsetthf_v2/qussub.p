...
thf(aqusinv_ax,axiom,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XH = (cco @ XG @ (cco @ XG @ XS @ ccqg) @ ccqus)) => ((XV = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccminusg)) => ((XN = (ccfv @ XH @ ccminusg)) => (((cwcel @ XS @ (ccfv @ XG @ ccnsg)) & (cwcel @ XX @ XV)) => ((ccfv @ (ccec @ XX @ (cco @ XG @ XS @ ccqg)) @ XN) = (ccec @ (ccfv @ XX @ XI) @ (cco @ XG @ XS @ ccqg)))))))))))))))).
...
thf(cqussub_conj,conjecture,(! [XS:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XH = (cco @ XG @ (cco @ XG @ XS @ ccqg) @ ccqus)) => ((XV = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((XN = (ccfv @ XH @ ccsg)) => ((cw3a @ (cwcel @ XS @ (ccfv @ XG @ ccnsg)) @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV)) => ((cco @ (ccec @ XX @ (cco @ XG @ XS @ ccqg)) @ (ccec @ XY @ (cco @ XG @ XS @ ccqg)) @ XN) = (ccec @ (cco @ XX @ XY @ Xc_mi) @ (cco @ XG @ XS @ ccqg))))))))))))))))).
