...
thf(cpcprmpw_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (cwcel @ XA2 @ ccn)) => ((cwrex @ (^ [Xn:$i] : (XA2 = (cco @ XP @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn0)) <=> (XA2 = (cco @ XP @ (cco @ XP @ XA2 @ ccpc) @ ccexp))))))).
