...
thf(alenegsq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwbr @ ccc0 @ XB2 @ ccle)) => (((cwbr @ XA2 @ XB2 @ ccle) & (cwbr @ (ccneg @ XA2) @ XB2 @ ccle)) <=> (cwbr @ (cco @ XA2 @ cc2 @ ccexp) @ (cco @ XB2 @ cc2 @ ccexp) @ ccle)))))).
...
thf(ccosbnd_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwbr @ (ccneg @ cc1) @ (ccfv @ XA2 @ cccos) @ ccle) & (cwbr @ (ccfv @ XA2 @ cccos) @ cc1 @ ccle))))).
