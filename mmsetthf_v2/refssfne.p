...
thf(arefrel_ax,axiom,(cwrel @ ccref)).
...
thf(afness_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XA2)) => ((XY = (ccuni @ XB2)) => ((cw3a @ (cwcel @ XB2 @ XC) @ (cwss @ XA2 @ XB2) @ (XX = XY)) => (cwbr @ XA2 @ XB2 @ ccfne)))))))))).
...
thf(arefssex_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [Xx3:$i] : (((cwbr @ (XA2 @ Xx3) @ XB2 @ ccref) & (cwcel @ XS @ (XA2 @ Xx3))) => (cwrex @ (^ [Xx3:$i] : (cwss @ XS @ (ccv @ Xx3))) @ (^ [Xx3:$i] : XB2)))))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(aisref_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > $o)))] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XX @ Xx3 @ Xy1) = (ccuni @ (XA2 @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((XY @ Xx3 @ Xy1) = (ccuni @ XB2)))) => (! [Xx3:$i] : (! [Xy1:$i] : ((cwcel @ (XA2 @ Xy1) @ (XC @ Xx3 @ Xy1)) => ((cwbr @ (XA2 @ Xy1) @ XB2 @ ccref) <=> (((XY @ Xx3 @ Xy1) = (XX @ Xx3 @ Xy1)) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwss @ (ccv @ Xx3) @ (ccv @ Xy1))) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : (XA2 @ Xy1)))))))))))))))).
...
thf(arefbas_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XA2)) => ((XY = (ccuni @ XB2)) => ((cwbr @ XA2 @ XB2 @ ccref) => (XY = XX))))))))).
thf(aeqid_ax,axiom,(! [XA2:($i > $o)] : (XA2 = XA2))).
thf(assref_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XA2)) => ((XY = (ccuni @ XB2)) => ((cw3a @ (cwcel @ XA2 @ XC) @ (cwss @ XA2 @ XB2) @ (XX = XY)) => (cwbr @ XA2 @ XB2 @ ccref)))))))))).
thf(asimprrr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph & (Xps & (Xch & Xth))) => Xth)))))).
thf(areftr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccref) & (cwbr @ XB2 @ XC @ ccref)) => (cwbr @ XA2 @ XC @ ccref)))))).
thf(crefssfne_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XA2)) => ((XY = (ccuni @ XB2)) => ((XX = XY) => ((cwbr @ XB2 @ XA2 @ ccref) <=> (? [Xc:$i] : ((cwss @ XB2 @ (ccv @ Xc)) & ((cwbr @ XA2 @ (ccv @ Xc) @ ccfne) & (cwbr @ (ccv @ Xc) @ XA2 @ ccref))))))))))))).
