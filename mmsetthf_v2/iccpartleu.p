...
thf(aiccpartltu_ax,axiom,(! [Xph:$o] : (! [XP:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccn)) => ((Xph => (cwcel @ XP @ (ccfv @ XM @ cciccp))) => (Xph => (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ XM @ XP) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ XM @ ccfzo)))))))))).
