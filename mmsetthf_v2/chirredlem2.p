...
thf(achsscon3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((cwss @ XA2 @ XB2) <=> (cwss @ (ccfv @ XB2 @ ccort) @ (ccfv @ XA2 @ ccort))))))).
thf(asstr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwss @ XA2 @ XB2) & (cwss @ XB2 @ XC)) => (cwss @ XA2 @ XC)))))).
thf(alecm_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwss @ XA2 @ XB2)) => (cwbr @ XA2 @ XB2 @ cccm))))).
...
thf(afh2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) & ((cwbr @ XB2 @ XA2 @ cccm) & (cwbr @ XB2 @ XC @ cccm))) => ((ccin @ XA2 @ (cco @ XB2 @ XC @ cchj)) = (cco @ (ccin @ XA2 @ XB2) @ (ccin @ XA2 @ XC) @ cchj))))))).
...
thf(achirredlem1_ax,axiom,(! [XA2:($i > $o)] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((cwcel @ XA2 @ ccch) => ((((cwcel @ (ccv @ Xp) @ ccat) & ((cwcel @ (ccv @ Xq) @ ccch) & (cwss @ (ccv @ Xq) @ (ccfv @ XA2 @ ccort)))) & (((cwcel @ (ccv @ Xr) @ ccat) & (cwss @ (ccv @ Xr) @ XA2)) & (cwss @ (ccv @ Xr) @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ cchj)))) => ((ccin @ (ccv @ Xp) @ (ccfv @ (ccv @ Xr) @ ccort)) = cc0h)))))))).
thf(aad2antlr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => (((Xch & Xph) & Xth) => Xps))))))).
thf(achj0_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cco @ XA2 @ cc0h @ cchj) = XA2)))).
thf(cchirredlem2_conj,conjecture,(! [XA2:($i > $o)] : (! [Xr:$i] : (! [Xq:$i] : (! [Xp:$i] : ((cwcel @ XA2 @ ccch) => (((((cwcel @ (ccv @ Xp) @ ccat) & (cwss @ (ccv @ Xp) @ XA2)) & ((cwcel @ (ccv @ Xq) @ ccch) & (cwss @ (ccv @ Xq) @ (ccfv @ XA2 @ ccort)))) & (((cwcel @ (ccv @ Xr) @ ccat) & (cwss @ (ccv @ Xr) @ XA2)) & (cwss @ (ccv @ Xr) @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ cchj)))) => ((ccin @ (ccfv @ (ccv @ Xr) @ ccort) @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ cchj)) = (ccv @ Xq))))))))).
