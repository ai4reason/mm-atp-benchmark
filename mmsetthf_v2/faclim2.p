...
thf(cfaclim2_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [XM:($i > $o)] : ((! [Xn:$i] : ((XF @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xn) @ ccfa) @ (cco @ (cco @ (ccv @ Xn) @ cc1 @ ccaddc) @ XM @ ccexp) @ ccmul) @ (ccfv @ (cco @ (ccv @ Xn) @ XM @ ccaddc) @ ccfa) @ ccdiv))))) => (! [Xn:$i] : ((cwcel @ XM @ ccn0) => (cwbr @ (XF @ Xn) @ cc1 @ ccli))))))).
