...
thf(cicccvx_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => ((cw3a @ (cwcel @ XC @ (cco @ XA2 @ XB2 @ ccicc)) @ (cwcel @ XD @ (cco @ XA2 @ XB2 @ ccicc)) @ (cwcel @ XT @ (cco @ ccc0 @ cc1 @ ccicc))) => (cwcel @ (cco @ (cco @ (cco @ cc1 @ XT @ ccmin) @ XC @ ccmul) @ (cco @ XT @ XD @ ccmul) @ ccaddc) @ (cco @ XA2 @ XB2 @ ccicc)))))))))).
