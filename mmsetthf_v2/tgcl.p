...
thf(atg1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ (ccfv @ XB2 @ cctg)) => (cwss @ XA2 @ (ccuni @ XB2)))))).
...
thf(abasis2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XB2 @ cctb) & (cwcel @ XC @ XB2)) & ((cwcel @ XD @ XB2) & (cwcel @ XA2 @ (ccin @ XC @ XD)))) => (cwrex @ (^ [Xx3:$i] : ((cwcel @ XA2 @ (ccv @ Xx3)) & (cwss @ (ccv @ Xx3) @ (ccin @ XC @ XD)))) @ (^ [Xx3:$i] : XB2)))))))).
...
thf(aistopg_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XJ:($i > $o)] : (! [Xy1:$i] : ((cwcel @ XJ @ (XA2 @ Xy1)) => ((cwcel @ XJ @ cctop) <=> ((! [Xx3:$i] : ((cwss @ (ccv @ Xx3) @ XJ) => (cwcel @ (ccuni @ (ccv @ Xx3)) @ XJ))) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) @ XJ)) @ (^ [Xy1:$i] : XJ))) @ (^ [Xx3:$i] : XJ))))))))).
thf(ctgcl_conj,conjecture,(! [XB2:($i > $o)] : ((cwcel @ XB2 @ cctb) => (cwcel @ (ccfv @ XB2 @ cctg) @ cctop)))).
