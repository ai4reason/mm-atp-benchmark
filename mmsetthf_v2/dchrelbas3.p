...
thf(aunitmulclb_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XU = (ccfv @ XR @ ccui)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((cw3a @ (cwcel @ XR @ cccrg) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) => ((cwcel @ (cco @ XX @ XY @ Xc_x) @ XU) <=> ((cwcel @ XX @ XU) & (cwcel @ XY @ XU)))))))))))))).
