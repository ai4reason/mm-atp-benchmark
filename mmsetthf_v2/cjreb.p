...
thf(aeqnegd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => (Xph => ((XA2 = (ccneg @ XA2)) <=> (XA2 = ccc0))))))).
...
thf(ccjreb_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwcel @ XA2 @ ccr) <=> ((ccfv @ XA2 @ cccj) = XA2))))).
