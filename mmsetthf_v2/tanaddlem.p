...
thf(ctanaddlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccc) & (cwcel @ XB2 @ ccc)) & ((cwne @ (ccfv @ XA2 @ cccos) @ ccc0) & (cwne @ (ccfv @ XB2 @ cccos) @ ccc0))) => ((cwne @ (ccfv @ (cco @ XA2 @ XB2 @ ccaddc) @ cccos) @ ccc0) <=> (cwne @ (cco @ (ccfv @ XA2 @ cctan) @ (ccfv @ XB2 @ cctan) @ ccmul) @ cc1)))))).
