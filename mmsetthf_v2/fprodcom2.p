...
thf(aopeliunxp2f_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XE @ Xx3))) => ((! [Xx3:$i] : (((ccv @ Xx3) = XC) => ((XB2 @ Xx3) = (XE @ Xx3)))) => (! [Xx3:$i] : ((cwcel @ (ccop @ XC @ XD) @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (XB2 @ Xx3))))) <=> ((cwcel @ XC @ XA2) & (cwcel @ XD @ (XE @ Xx3))))))))))))).
...
thf(acbvprodi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (cwnfc @ (^ [Xk:$i] : (XB2 @ Xj @ Xk)))) => ((! [Xk:$i] : (cwnfc @ (^ [Xj:$i] : (XC @ Xj @ Xk)))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xj) = (ccv @ Xk)) => ((XB2 @ Xj @ Xk) = (XC @ Xj @ Xk))))) => (! [Xj:$i] : (! [Xk:$i] : ((ccprod @ (^ [Xj:$i] : XA2) @ (^ [Xj:$i] : (XB2 @ Xj @ Xk))) = (ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xj @ Xk))))))))))))).
...
thf(aprodeq12dv_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XD:($i > ($i > $o))] : ((Xph => (XA2 = XB2)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => ((XC @ Xk) = (XD @ Xk)))) => (Xph => ((ccprod @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk))) = (ccprod @ (^ [Xk:$i] : XB2) @ (^ [Xk:$i] : (XD @ Xk))))))))))))).
