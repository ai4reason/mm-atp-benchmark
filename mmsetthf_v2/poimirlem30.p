...
thf(aelfzole1_ax,axiom,(! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cwcel @ XK @ (cco @ XM @ XN @ ccfzo)) => (cwbr @ XM @ XK @ ccle)))))).
...
thf(aelfzo0le_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ (cco @ ccc0 @ XB2 @ ccfzo)) => (cwbr @ XA2 @ XB2 @ ccle))))).
...
thf(aimaiun_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : ((ccima @ XA2 @ (cciun @ (^ [Xx3:$i] : (XB2 @ Xx3)) @ (^ [Xx3:$i] : (XC @ Xx3)))) = (cciun @ (^ [Xx3:$i] : (XB2 @ Xx3)) @ (^ [Xx3:$i] : (ccima @ XA2 @ (XC @ Xx3))))))))).
...
thf(aptrest_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XA2 @ cctop @ XF)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XS @ Xk) @ (XW @ Xk)))) => (Xph => ((cco @ (ccfv @ XF @ ccpt) @ (ccixp @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XS @ Xk))) @ ccrest) = (ccfv @ (ccmpt @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (XS @ Xk) @ ccrest))) @ ccpt))))))))))))).
...
thf(aiicmp_ax,axiom,(cwcel @ ccii @ cccmp)).
thf(cctopon_tp,type,(cctopon : ($i > $o))).
thf(cchmeo_tp,type,(cchmeo : ($i > $o))).
thf(cchmph_tp,type,(cchmph : ($i > $o))).
thf(cctx_tp,type,(cctx : ($i > $o))).
thf(aptcmpfi_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwf @ XA2 @ cccmp @ XF)) => (cwcel @ (ccfv @ XF @ ccpt) @ cccmp))))).
thf(a_3expia_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((cw3a @ Xph @ Xps @ Xch) => Xth) => ((Xph & Xps) => (Xch => Xth)))))))).
thf(abwth_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwcel @ XJ @ cccmp) @ (cwss @ XA2 @ XX) @ (~ (cwcel @ XA2 @ ccfn))) => (cwrex @ (^ [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ (ccfv @ XA2 @ (ccfv @ XJ @ cclp)))) @ (^ [Xx3:$i] : XX)))))))).
thf(arehaus_ax,axiom,(cwcel @ (ccfv @ (ccrn @ ccioo) @ cctg) @ ccha)).
thf(apthaus_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwf @ XA2 @ ccha @ XF)) => (cwcel @ (ccfv @ XF @ ccpt) @ ccha)))))).
...
thf(aptuniconst_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ (ccxp @ XA2 @ (ccsn @ XR)) @ ccpt)) => ((XX = (ccuni @ XR)) => (((cwcel @ XA2 @ XV) & (cwcel @ XR @ cctop)) => ((cco @ XX @ XA2 @ ccmap) = (ccuni @ XJ))))))))))).
...
thf(aislp3_ax,axiom,(! [XP:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwcel @ XJ @ cctop) @ (cwss @ XS @ XX) @ (cwcel @ XP @ XX)) => ((cwcel @ XP @ (ccfv @ XS @ (ccfv @ XJ @ cclp))) <=> (cwral @ (^ [Xx3:$i] : ((cwcel @ XP @ (ccv @ Xx3)) => (cwne @ (ccin @ (ccv @ Xx3) @ (ccdif @ XS @ (ccsn @ XP))) @ cc0))) @ (^ [Xx3:$i] : XJ)))))))))).
...
thf(aptopn_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XA2 @ cctop @ XF)) => ((Xph => (cwcel @ XW @ ccfn)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XS @ Xk) @ (ccfv @ (ccv @ Xk) @ XF)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (ccdif @ XA2 @ XW))) => ((XS @ Xk) = (ccuni @ (ccfv @ (ccv @ Xk) @ XF))))) => (Xph => (cwcel @ (ccixp @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XS @ Xk))) @ (ccfv @ XF @ ccpt))))))))))))))).
...
thf(arestt1_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XJ @ cct1) & (cwcel @ XA2 @ XV)) => (cwcel @ (cco @ XJ @ XA2 @ ccrest) @ cct1)))))).
...
thf(at1ficld_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwcel @ XJ @ cct1) @ (cwss @ XA2 @ XX) @ (cwcel @ XA2 @ ccfn)) => (cwcel @ XA2 @ (ccfv @ XJ @ cccld)))))))).
...
thf(aimadmrn_ax,axiom,(! [XA2:($i > $o)] : ((ccima @ XA2 @ (ccdm @ XA2)) = (ccrn @ XA2)))).
...
thf(aimadifss_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (cwss @ (ccdif @ (ccima @ XF @ XA2) @ (ccima @ XF @ XB2)) @ (ccima @ XF @ (ccdif @ XA2 @ XB2))))))).
...
thf(auznnssnn_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => (cwss @ (ccfv @ XN @ ccuz) @ ccn)))).
