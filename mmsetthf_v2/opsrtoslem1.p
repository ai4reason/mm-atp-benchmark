...
thf(aopabresid_ax,axiom,(! [XA2:($i > $o)] : ((ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) & ((ccv @ Xy1) = (ccv @ Xx3)))))) = (ccres @ ccid @ XA2)))).
