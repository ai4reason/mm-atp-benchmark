...
thf(cbnj1171_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XR:($i > ($i > ($i > $o)))] : ((! [Xz:$i] : (! [Xw:$i] : (((Xph @ Xz @ Xw) & (Xps @ Xz @ Xw)) => (cwss @ (XB2 @ Xz @ Xw) @ (XA2 @ Xz @ Xw))))) => ((? [Xz:$i] : (! [Xw:$i] : (((Xph @ Xz @ Xw) & (Xps @ Xz @ Xw)) => ((cwcel @ (ccv @ Xz) @ (XB2 @ Xz @ Xw)) & ((cwcel @ (ccv @ Xw) @ (XA2 @ Xz @ Xw)) => ((cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ (XR @ Xz @ Xw)) => (~ (cwcel @ (ccv @ Xw) @ (XB2 @ Xz @ Xw))))))))) => (? [Xz:$i] : (! [Xw:$i] : (((Xph @ Xz @ Xw) & (Xps @ Xz @ Xw)) => ((cwcel @ (ccv @ Xz) @ (XB2 @ Xz @ Xw)) & ((cwcel @ (ccv @ Xw) @ (XB2 @ Xz @ Xw)) => (~ (cwbr @ (ccv @ Xw) @ (ccv @ Xz) @ (XR @ Xz @ Xw)))))))))))))))).
