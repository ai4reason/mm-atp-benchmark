...
thf(cqabvle_conj,conjecture,(! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XQ = (cco @ cccnfld @ ccq @ ccress)) => ((XA2 = (ccfv @ XQ @ ccabv)) => (((cwcel @ XF @ XA2) & (cwcel @ XN @ ccn0)) => (cwbr @ (ccfv @ XN @ XF) @ XN @ ccle))))))))).
