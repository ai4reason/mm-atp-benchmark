...
thf(cpconnpi1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XP = (cco @ XJ @ XA2 @ ccpi1)) => ((XQ = (cco @ XJ @ XB2 @ ccpi1)) => ((XS = (ccfv @ XP @ ccbs)) => ((XT = (ccfv @ XQ @ ccbs)) => ((cw3a @ (cwcel @ XJ @ ccpconn) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) => (cwbr @ XP @ XQ @ ccgic)))))))))))))))).
