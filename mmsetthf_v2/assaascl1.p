...
thf(aascl1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XW:($i > $o)] : ((XA2 = (ccfv @ XW @ ccascl)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xph => (cwcel @ XW @ cclmod)) => ((Xph => (cwcel @ XW @ ccrg)) => (Xph => ((ccfv @ (ccfv @ XF @ ccur) @ XA2) = (ccfv @ XW @ ccur)))))))))))).
