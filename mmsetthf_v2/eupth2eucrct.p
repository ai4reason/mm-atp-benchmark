...
thf(ansyld_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xta:$o] : ((Xph => (Xps => (~ Xch))) => ((Xph => (Xta => Xch)) => (Xph => (Xps => (~ Xta)))))))))).
...
thf(aopeldmd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => (Xph => ((cwcel @ (ccop @ XA2 @ XB2) @ XC) => (cwcel @ XA2 @ (ccdm @ XC))))))))))))).
...
thf(aiscrct_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwbr @ XF @ XP @ (ccfv @ XG @ cccrcts)) <=> ((cwbr @ XF @ XP @ (ccfv @ XG @ cctrls)) & ((ccfv @ ccc0 @ XP) = (ccfv @ (ccfv @ XF @ cchash) @ XP)))))))).
