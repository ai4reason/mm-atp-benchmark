...
thf(alelttrdi_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccr) @ (cwcel @ XC @ ccr))) => ((Xph => (cwbr @ XB2 @ XC @ ccle)) => (Xph => ((cwbr @ XA2 @ XB2 @ cclt) => (cwbr @ XA2 @ XC @ cclt)))))))))).
...
thf(ann0negleid_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn0) => (cwbr @ (ccneg @ XA2) @ XA2 @ ccle)))).
thf(cdifgtsumgt_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccr) @ (cwcel @ XB2 @ ccn0) @ (cwcel @ XC @ ccr)) => ((cwbr @ XC @ (cco @ XA2 @ XB2 @ ccmin) @ cclt) => (cwbr @ XC @ (cco @ XA2 @ XB2 @ ccaddc) @ cclt))))))).
