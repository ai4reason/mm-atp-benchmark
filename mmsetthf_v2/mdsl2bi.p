...
thf(cmdsl2bi_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwbr @ XA2 @ XB2 @ ccmd) <=> (cwral @ (^ [Xx3:$i] : (((cwss @ (ccin @ XA2 @ XB2) @ (ccv @ Xx3)) & (cwss @ (ccv @ Xx3) @ XB2)) => ((ccin @ (cco @ (ccv @ Xx3) @ XA2 @ cchj) @ XB2) = (cco @ (ccv @ Xx3) @ (ccin @ XA2 @ XB2) @ cchj)))) @ (^ [Xx3:$i] : ccch)))))))).
