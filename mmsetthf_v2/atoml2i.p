...
thf(apjoml5_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccch) & (cwcel @ XB2 @ ccch)) => ((cco @ XA2 @ (ccin @ (ccfv @ XA2 @ ccort) @ (cco @ XA2 @ XB2 @ cchj)) @ cchj) = (cco @ XA2 @ XB2 @ cchj)))))).
...
thf(aatomli_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccat) => (cwcel @ (ccin @ (cco @ XA2 @ XB2 @ cchj) @ (ccfv @ XA2 @ ccort)) @ (ccun @ ccat @ (ccsn @ cc0h)))))))).
...
thf(catoml2i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => (((cwcel @ XB2 @ ccat) & (~ (cwss @ XB2 @ XA2))) => (cwcel @ (ccin @ (cco @ XA2 @ XB2 @ cchj) @ (ccfv @ XA2 @ ccort)) @ ccat)))))).
