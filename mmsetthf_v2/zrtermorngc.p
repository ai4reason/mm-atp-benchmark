...
thf(ac0rnghm_ax,axiom,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XS @ ccbs)) => ((Xc_0 = (ccfv @ XT @ cc0g)) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccmpt @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : Xc_0)))) => (! [Xx3:$i] : (((cwcel @ XS @ ccrng) & (cwcel @ XT @ (ccdif @ ccrg @ ccnzr))) => (cwcel @ (XH @ Xx3) @ (cco @ XS @ XT @ ccrngh))))))))))))).
...
thf(afvconst_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwf @ XA2 @ (ccsn @ XB2) @ XF) & (cwcel @ XC @ XA2)) => ((ccfv @ XC @ XF) = XB2))))))).
...
thf(aeqeu_ax,axiom,(! [Xph:($i > $o)] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : ((! [Xx3:$i] : (((ccv @ Xx3) = XA2) => ((Xph @ Xx3) <=> Xps))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XA2 @ (XB2 @ Xx3)) @ Xps @ (! [Xx3:$i] : ((Xph @ Xx3) => ((ccv @ Xx3) = XA2)))) => (cweu @ (^ [Xx3:$i] : (Xph @ Xx3))))))))))).
