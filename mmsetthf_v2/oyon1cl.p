...
thf(aoyoncl_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XQ:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XY:($i > $o)] : ((XO = (ccfv @ XC @ ccoppc)) => ((XY = (ccfv @ XO @ ccyon)) => ((Xph => (cwcel @ XC @ cccat)) => ((XS = (ccfv @ XU @ ccsetc)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (cwss @ (ccrn @ (ccfv @ XC @ cchomf)) @ XU)) => ((XQ = (cco @ XC @ XS @ ccfuc)) => (Xph => (cwcel @ XY @ (cco @ XO @ XQ @ ccfunc))))))))))))))))))).
thf(a_1st2ndbr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwrel @ XB2) & (cwcel @ XA2 @ XB2)) => (cwbr @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XA2 @ cc2nd) @ XB2))))).
thf(coyon1cl_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XO = (ccfv @ XC @ ccoppc)) => ((XY = (ccfv @ XO @ ccyon)) => ((Xph => (cwcel @ XC @ cccat)) => ((XS = (ccfv @ XU @ ccsetc)) => ((Xph => (cwcel @ XU @ XV)) => ((Xph => (cwss @ (ccrn @ (ccfv @ XC @ cchomf)) @ XU)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((Xph => (cwcel @ XX @ XB2)) => (Xph => (cwcel @ (ccfv @ XX @ (ccfv @ XY @ cc1st)) @ (cco @ XC @ XS @ ccfunc))))))))))))))))))))).
