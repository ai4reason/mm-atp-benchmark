...
thf(atmdgsum_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : ((XJ = (ccfv @ XG @ cctopn)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((cw3a @ (cwcel @ XG @ cccmn) @ (cwcel @ XG @ cctmd) @ (cwcel @ XA2 @ ccfn)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ XB2 @ XA2 @ ccmap)) @ (^ [Xx3:$i] : (cco @ XG @ (ccv @ Xx3) @ ccgsu))) @ (cco @ (cco @ XJ @ (ccpw @ XA2) @ ccxko) @ XJ @ cccn)))))))))).
