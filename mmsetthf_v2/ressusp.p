...
thf(arestutopopn_ax,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XU @ (ccfv @ XX @ ccust)) & (cwcel @ XA2 @ (ccfv @ XU @ ccutop))) => ((cco @ (ccfv @ XU @ ccutop) @ XA2 @ ccrest) = (ccfv @ (cco @ XU @ (ccxp @ XA2 @ XA2) @ ccrest) @ ccutop))))))).
...
thf(cressusp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XW:($i > $o)] : ((XB2 = (ccfv @ XW @ ccbs)) => ((XJ = (ccfv @ XW @ cctopn)) => ((cw3a @ (cwcel @ XW @ ccusp) @ (cwcel @ XW @ cctps) @ (cwcel @ XA2 @ XJ)) => (cwcel @ (cco @ XW @ XA2 @ ccress) @ ccusp))))))))).
