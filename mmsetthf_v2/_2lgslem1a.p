...
thf(afldivnn0_ax,axiom,(! [XK:($i > $o)] : (! [XL:($i > $o)] : (((cwcel @ XK @ ccn0) & (cwcel @ XL @ ccn)) => (cwcel @ (ccfv @ (cco @ XK @ XL @ ccdiv) @ ccfl) @ ccn0))))).
...
thf(a_2lgslem1a2_ax,axiom,(! [XI:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccz) & (cwcel @ XI @ ccz)) => ((cwbr @ (ccfv @ (cco @ XN @ cc4 @ ccdiv) @ ccfl) @ XI @ cclt) <=> (cwbr @ (cco @ XN @ cc2 @ ccdiv) @ (cco @ XI @ cc2 @ ccmul) @ cclt)))))).
thf(abreq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cwbr @ XC @ XA2 @ XR) <=> (cwbr @ XC @ XB2 @ XR)))))))))).
thf(asylan_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => (((Xps & Xch) => Xth) => ((Xph & Xch) => Xth)))))))).
thf(ccrp_tp,type,(ccrp : ($i > $o))).
thf(a_2lgslem1a1_ax,axiom,(! [XP:($i > $o)] : (((cwcel @ XP @ ccn) & (~ (cwbr @ cc2 @ XP @ ccdvds))) => (cwral @ (^ [Xi:$i] : ((cco @ (ccv @ Xi) @ cc2 @ ccmul) = (cco @ (cco @ (ccv @ Xi) @ cc2 @ ccmul) @ XP @ ccmo))) @ (^ [Xi:$i] : (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz)))))).
...
thf(c_2lgslem1a_conj,conjecture,(! [XP:($i > $o)] : (((cwcel @ XP @ ccprime) & (~ (cwbr @ cc2 @ XP @ ccdvds))) => ((ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xi:$i] : (((ccv @ Xx3) = (cco @ (ccv @ Xi) @ cc2 @ ccmul)) & (cwbr @ (cco @ XP @ cc2 @ ccdiv) @ (cco @ (ccv @ Xx3) @ XP @ ccmo) @ cclt))) @ (^ [Xi:$i] : (cco @ cc1 @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz)))) @ (^ [Xx3:$i] : ccz)) = (ccrab @ (^ [Xx3:$i] : (cwrex @ (^ [Xi:$i] : ((ccv @ Xx3) = (cco @ (ccv @ Xi) @ cc2 @ ccmul))) @ (^ [Xi:$i] : (cco @ (cco @ (ccfv @ (cco @ XP @ cc4 @ ccdiv) @ ccfl) @ cc1 @ ccaddc) @ (cco @ (cco @ XP @ cc1 @ ccmin) @ cc2 @ ccdiv) @ ccfz)))) @ (^ [Xx3:$i] : ccz)))))).
