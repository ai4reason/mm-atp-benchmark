...
thf(clfuhgr1v0e_conj,conjecture,(! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xx3:$i] : ((XI @ Xx3) = (ccfv @ XG @ cciedg))) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccrab @ (^ [Xx3:$i] : (cwbr @ cc2 @ (ccfv @ (ccv @ Xx3) @ cchash) @ ccle)) @ (^ [Xx3:$i] : (ccpw @ XV))))) => (! [Xx3:$i] : ((cw3a @ (cwcel @ XG @ ccuhgr) @ ((ccfv @ XV @ cchash) = cc1) @ (cwf @ (ccdm @ (XI @ Xx3)) @ (XE @ Xx3) @ (XI @ Xx3))) => ((ccfv @ XG @ ccedg) = cc0))))))))))).
