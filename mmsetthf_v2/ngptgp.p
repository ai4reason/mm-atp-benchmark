...
thf(angpsubcan_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_mi:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccsg)) => ((XD = (ccfv @ XG @ ccds)) => (((cwcel @ XG @ ccngp) & (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX))) => ((cco @ (cco @ XA2 @ XC @ Xc_mi) @ (cco @ XB2 @ XC @ Xc_mi) @ XD) = (cco @ XA2 @ XB2 @ XD)))))))))))))).
...
thf(angplcan_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((Xc_pl = (ccfv @ XG @ ccplusg)) => ((XD = (ccfv @ XG @ ccds)) => ((((cwcel @ XG @ ccngp) & (cwcel @ XG @ ccabl)) & (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX) @ (cwcel @ XC @ XX))) => ((cco @ (cco @ XC @ XA2 @ Xc_pl) @ (cco @ XC @ XB2 @ Xc_pl) @ XD) = (cco @ XA2 @ XB2 @ XD)))))))))))))).
thf(asyl12anc_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xps) => ((Xph => Xch) => ((Xph => Xth) => (((Xps & (Xch & Xth)) => Xta) => (Xph => Xta))))))))))).
thf(angpinvds_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccminusg)) => ((XD = (ccfv @ XG @ ccds)) => ((((cwcel @ XG @ ccngp) & (cwcel @ XG @ ccabl)) & ((cwcel @ XA2 @ XX) & (cwcel @ XB2 @ XX))) => ((cco @ (ccfv @ XA2 @ XI) @ (ccfv @ XB2 @ XI) @ XD) = (cco @ XA2 @ XB2 @ XD))))))))))))).
