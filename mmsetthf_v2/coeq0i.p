...
thf(acoeq0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cccom @ XA2 @ XB2) = cc0) <=> ((ccin @ (ccdm @ XA2) @ (ccrn @ XB2)) = cc0))))).
thf(ccoeq0i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwf @ XC @ XD @ XA2) @ (cwf @ XE @ XF @ XB2) @ ((ccin @ XC @ XF) = cc0)) => ((cccom @ XA2 @ XB2) = cc0))))))))).
