...
thf(apaste_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XJ)) => ((XY = (ccuni @ XK)) => ((Xph => (cwcel @ XA2 @ (ccfv @ XJ @ cccld))) => ((Xph => (cwcel @ XB2 @ (ccfv @ XJ @ cccld))) => ((Xph => ((ccun @ XA2 @ XB2) = XX)) => ((Xph => (cwf @ XX @ XY @ XF)) => ((Xph => (cwcel @ (ccres @ XF @ XA2) @ (cco @ (cco @ XJ @ XA2 @ ccrest) @ XK @ cccn))) => ((Xph => (cwcel @ (ccres @ XF @ XB2) @ (cco @ (cco @ XJ @ XB2 @ ccrest) @ XK @ cccn))) => (Xph => (cwcel @ XF @ (cco @ XJ @ XK @ cccn)))))))))))))))))))).
...
thf(aicccld_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (cwcel @ (cco @ XA2 @ XB2 @ ccicc) @ (ccfv @ (ccfv @ (ccrn @ ccioo) @ cctg) @ cccld)))))).
...
thf(arestcldi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwss @ XA2 @ XX) @ (cwcel @ XB2 @ (ccfv @ XJ @ cccld)) @ (cwss @ XB2 @ XA2)) => (cwcel @ XB2 @ (ccfv @ (cco @ XJ @ XA2 @ ccrest) @ cccld))))))))).
...
thf(atxcld_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ XR @ cccld)) & (cwcel @ XB2 @ (ccfv @ XS @ cccld))) => (cwcel @ (ccxp @ XA2 @ XB2) @ (ccfv @ (cco @ XR @ XS @ cctx) @ cccld)))))))).
