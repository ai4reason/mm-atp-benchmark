...
thf(cdmdsl3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccch) @ (cwcel @ XB2 @ ccch) @ (cwcel @ XC @ ccch)) & (cw3a @ (cwbr @ XB2 @ XA2 @ ccdmd) @ (cwss @ XA2 @ XC) @ (cwss @ XC @ (cco @ XA2 @ XB2 @ cchj)))) => ((cco @ (ccin @ XC @ XB2) @ XA2 @ cchj) = XC)))))).
