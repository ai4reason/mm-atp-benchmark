...
thf(atglineineq_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ (ccrn @ XL))) => ((Xph => (cwcel @ XB2 @ (ccrn @ XL))) => ((Xph => (cwne @ XA2 @ XB2)) => ((Xph => (cwcel @ XX @ (ccin @ XA2 @ XB2))) => ((Xph => (cwcel @ XY @ (ccin @ XA2 @ XB2))) => (Xph => (XX = XY))))))))))))))))))))).
thf(aad4antr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : (! [Xet:$o] : ((Xph => Xps) => (((((Xph & Xch) & Xth) & Xta) & Xet) => Xps))))))))).
thf(ccmir_tp,type,(ccmir : ($i > $o))).
thf(aperpneq_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [Xc_mi:($i > $o)] : ((XP = (ccfv @ XG @ ccbs)) => ((Xc_mi = (ccfv @ XG @ ccds)) => ((XI = (ccfv @ XG @ ccitv)) => ((XL = (ccfv @ XG @ cclng)) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((Xph => (cwcel @ XA2 @ (ccrn @ XL))) => ((Xph => (cwcel @ XB2 @ (ccrn @ XL))) => ((Xph => (cwbr @ XA2 @ XB2 @ (ccfv @ XG @ ccperpg))) => (Xph => (cwne @ XA2 @ XB2))))))))))))))))))).
...
thf(aisperp_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > $o)] : (! [XI:($i > ($i > ($i > ($i > $o))))] : (! [XL:($i > ($i > ($i > ($i > $o))))] : (! [Xc_mi:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : ((XP @ Xx3 @ Xv @ Xu) = (ccfv @ XG @ ccbs))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : ((Xc_mi @ Xx3 @ Xv @ Xu) = (ccfv @ XG @ ccds))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : ((XI @ Xx3 @ Xv @ Xu) = (ccfv @ XG @ ccitv))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : ((XL @ Xx3 @ Xv @ Xu) = (ccfv @ XG @ cclng))))) => ((Xph => (cwcel @ XG @ ccstrkg)) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (Xph => (cwcel @ XA2 @ (ccrn @ (XL @ Xx3 @ Xv @ Xu))))))) => ((! [Xx3:$i] : (! [Xv:$i] : (! [Xu:$i] : (Xph => (cwcel @ XB2 @ (ccrn @ (XL @ Xx3 @ Xv @ Xu))))))) => (Xph => ((cwbr @ XA2 @ XB2 @ (ccfv @ XG @ ccperpg)) <=> (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xu:$i] : (cwral @ (^ [Xv:$i] : (cwcel @ (ccs3 @ (ccv @ Xu) @ (ccv @ Xx3) @ (ccv @ Xv)) @ (ccfv @ XG @ ccrag))) @ (^ [Xv:$i] : XB2))) @ (^ [Xu:$i] : XA2))) @ (^ [Xx3:$i] : (ccin @ XA2 @ XB2))))))))))))))))))))).
