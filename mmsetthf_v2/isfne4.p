...
thf(aisfne_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xx3:$i] : ((XX @ Xx3) = (ccuni @ XA2))) => ((! [Xx3:$i] : ((XY @ Xx3) = (ccuni @ XB2))) => (! [Xx3:$i] : ((cwcel @ XB2 @ XC) => ((cwbr @ XA2 @ XB2 @ ccfne) <=> (((XX @ Xx3) = (XY @ Xx3)) & (cwral @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ (ccuni @ (ccin @ XB2 @ (ccpw @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : XA2)))))))))))))).
...
thf(cisfne4_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccuni @ XA2)) => ((XY = (ccuni @ XB2)) => ((cwbr @ XA2 @ XB2 @ ccfne) <=> ((XX = XY) & (cwss @ XA2 @ (ccfv @ XB2 @ cctg))))))))))).
