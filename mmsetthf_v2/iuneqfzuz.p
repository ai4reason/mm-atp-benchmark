...
thf(aiuneqfzuzlem_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XN:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((! [Xm:$i] : (XZ = (ccfv @ (XN @ Xm) @ ccuz))) => ((cwral @ (^ [Xm:$i] : ((cciun @ (^ [Xn:$i] : (cco @ (XN @ Xm) @ (ccv @ Xm) @ ccfz)) @ (^ [Xn:$i] : (XA2 @ Xn))) = (cciun @ (^ [Xn:$i] : (cco @ (XN @ Xm) @ (ccv @ Xm) @ ccfz)) @ (^ [Xn:$i] : (XB2 @ Xn))))) @ (^ [Xm:$i] : XZ)) => (cwss @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (XA2 @ Xn))) @ (cciun @ (^ [Xn:$i] : XZ) @ (^ [Xn:$i] : (XB2 @ Xn))))))))))).
