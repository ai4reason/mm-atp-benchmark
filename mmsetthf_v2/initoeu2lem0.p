...
thf(arcaninv_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xc_op:($i > $o)] : (! [XZ:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XN = (ccfv @ XC @ ccinv)) => ((Xph => (cwcel @ XC @ cccat)) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XZ @ XB2)) => ((Xph => (cwcel @ XF @ (cco @ XY @ XX @ (ccfv @ XC @ cciso)))) => ((Xph => (cwcel @ XG @ (cco @ XY @ XZ @ (ccfv @ XC @ cchom)))) => ((Xph => (cwcel @ XH @ (cco @ XY @ XZ @ (ccfv @ XC @ cchom)))) => ((XR = (ccfv @ XF @ (cco @ XY @ XX @ XN))) => ((Xc_op = (cco @ (ccop @ XX @ XY) @ XZ @ (ccfv @ XC @ ccco))) => (Xph => (((cco @ XG @ XR @ Xc_op) = (cco @ XH @ XR @ Xc_op)) => (XG = XH))))))))))))))))))))))))))).
