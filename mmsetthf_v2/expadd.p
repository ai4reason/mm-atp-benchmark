...
thf(cexpadd_conj,conjecture,(! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XM @ ccn0) @ (cwcel @ XN @ ccn0)) => ((cco @ XA2 @ (cco @ XM @ XN @ ccaddc) @ ccexp) = (cco @ (cco @ XA2 @ XM @ ccexp) @ (cco @ XA2 @ XN @ ccexp) @ ccmul))))))).
