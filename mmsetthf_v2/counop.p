...
thf(aunopf1o_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ ccuo) => (cwf1o @ cchil @ cchil @ XT)))).
...
thf(ccounop_conj,conjecture,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (((cwcel @ XS @ ccuo) & (cwcel @ XT @ ccuo)) => (cwcel @ (cccom @ XS @ XT) @ ccuo))))).
