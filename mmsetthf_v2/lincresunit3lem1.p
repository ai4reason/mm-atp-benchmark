...
thf(ainvginvrid_ax,axiom,(! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XR @ ccbs)) => ((XU = (ccfv @ XR @ ccui)) => ((XN = (ccfv @ XR @ ccminusg)) => ((XI = (ccfv @ XR @ ccinvr)) => ((Xc_x = (ccfv @ XR @ ccmulr)) => ((cw3a @ (cwcel @ XR @ ccrg) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XU)) => ((cco @ (ccfv @ XY @ XN) @ (cco @ (ccfv @ (ccfv @ XY @ XN) @ XI) @ XX @ Xc_x) @ Xc_x) = XX)))))))))))))))).
thf(clincresunit3lem1_conj,conjecture,(! [Xz:$i] : (! [XB2:($i > $o)] : (! [XR:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((XB2 = (ccfv @ XM @ ccbs)) => ((! [Xs1:$i] : ((XR @ Xs1) = (ccfv @ XM @ ccsca))) => ((! [Xs1:$i] : (XE = (ccfv @ (XR @ Xs1) @ ccbs))) => ((! [Xs1:$i] : (XU = (ccfv @ (XR @ Xs1) @ ccui))) => ((! [Xs1:$i] : ((Xc_0 @ Xs1) = (ccfv @ (XR @ Xs1) @ cc0g))) => ((! [Xs1:$i] : ((XZ @ Xs1) = (ccfv @ XM @ cc0g))) => ((! [Xs1:$i] : (XN = (ccfv @ (XR @ Xs1) @ ccminusg))) => ((! [Xs1:$i] : (XI = (ccfv @ (XR @ Xs1) @ ccinvr))) => ((! [Xs1:$i] : (Xc_x = (ccfv @ (XR @ Xs1) @ ccmulr))) => ((! [Xs1:$i] : ((XG @ Xs1) = (ccmpt @ (^ [Xs1:$i] : (ccdif @ XS @ (ccsn @ XX))) @ (^ [Xs1:$i] : (cco @ (ccfv @ (ccfv @ (ccfv @ XX @ XF) @ XN) @ XI) @ (ccfv @ (ccv @ Xs1) @ XF) @ Xc_x))))) => (! [Xs1:$i] : (((cw3a @ (cwcel @ XS @ (ccpw @ XB2)) @ (cwcel @ XM @ cclmod) @ (cwcel @ XX @ XS)) & (cw3a @ (cwcel @ XF @ (cco @ XE @ XS @ ccmap)) @ (cwcel @ (ccfv @ XX @ XF) @ XU) @ (cwcel @ (ccv @ Xz) @ (ccdif @ XS @ (ccsn @ XX))))) => ((cco @ (ccfv @ (ccfv @ XX @ XF) @ XN) @ (cco @ (ccfv @ (ccv @ Xz) @ (XG @ Xs1)) @ (ccv @ Xz) @ (ccfv @ XM @ ccvsca)) @ (ccfv @ XM @ ccvsca)) = (cco @ (ccfv @ (ccv @ Xz) @ XF) @ (ccv @ Xz) @ (ccfv @ XM @ ccvsca))))))))))))))))))))))))))))))).
