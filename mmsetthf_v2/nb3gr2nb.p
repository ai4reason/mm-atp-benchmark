...
thf(anb3grprlem1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((Xph => (cwcel @ XG @ ccusgr)) => ((Xph => (XV = (cctp @ XA2 @ XB2 @ XC))) => ((Xph => (cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XY) @ (cwcel @ XC @ XZ))) => (Xph => (((cco @ XG @ XA2 @ ccnbgr) = (ccpr @ XB2 @ XC)) <=> ((cwcel @ (ccpr @ XA2 @ XB2) @ XE) & (cwcel @ (ccpr @ XA2 @ XC) @ XE)))))))))))))))))))).
...
thf(cnb3gr2nb_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XY) @ (cwcel @ XC @ XZ)) & (((ccfv @ XG @ ccvtx) = (cctp @ XA2 @ XB2 @ XC)) & (cwcel @ XG @ ccusgr))) => ((((cco @ XG @ XA2 @ ccnbgr) = (ccpr @ XB2 @ XC)) & ((cco @ XG @ XB2 @ ccnbgr) = (ccpr @ XA2 @ XC))) <=> (cw3a @ ((cco @ XG @ XA2 @ ccnbgr) = (ccpr @ XB2 @ XC)) @ ((cco @ XG @ XB2 @ ccnbgr) = (ccpr @ XA2 @ XC)) @ ((cco @ XG @ XC @ ccnbgr) = (ccpr @ XA2 @ XB2))))))))))))).
