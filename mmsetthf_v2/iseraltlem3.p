...
thf(aiseraltlem2_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwf @ XZ @ ccr @ XG)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwbr @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XG) @ (ccfv @ (ccv @ Xk) @ XG) @ ccle))) => ((Xph => (cwbr @ XG @ ccc0 @ ccli)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XF) = (cco @ (cco @ (ccneg @ cc1) @ (ccv @ Xk) @ ccexp) @ (ccfv @ (ccv @ Xk) @ XG) @ ccmul)))) => ((cw3a @ Xph @ (cwcel @ XN @ XZ) @ (cwcel @ XK @ ccn0)) => (cwbr @ (cco @ (cco @ (ccneg @ cc1) @ XN @ ccexp) @ (ccfv @ (cco @ XN @ (cco @ cc2 @ XK @ ccmul) @ ccaddc) @ (ccseq @ ccaddc @ XF @ XM)) @ ccmul) @ (cco @ (cco @ (ccneg @ cc1) @ XN @ ccexp) @ (ccfv @ XN @ (ccseq @ ccaddc @ XF @ XM)) @ ccmul) @ ccle)))))))))))))))).
...
thf(aiseraltlem1_ax,axiom,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwf @ XZ @ ccr @ XG)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwbr @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XG) @ (ccfv @ (ccv @ Xk) @ XG) @ ccle))) => ((Xph => (cwbr @ XG @ ccc0 @ ccli)) => ((Xph & (cwcel @ XN @ XZ)) => (cwbr @ ccc0 @ (ccfv @ XN @ XG) @ ccle))))))))))))).
...
thf(ciseraltlem3_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwf @ XZ @ ccr @ XG)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwbr @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XG) @ (ccfv @ (ccv @ Xk) @ XG) @ ccle))) => ((Xph => (cwbr @ XG @ ccc0 @ ccli)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XF) = (cco @ (cco @ (ccneg @ cc1) @ (ccv @ Xk) @ ccexp) @ (ccfv @ (ccv @ Xk) @ XG) @ ccmul)))) => ((cw3a @ Xph @ (cwcel @ XN @ XZ) @ (cwcel @ XK @ ccn0)) => ((cwbr @ (ccfv @ (cco @ (ccfv @ (cco @ XN @ (cco @ cc2 @ XK @ ccmul) @ ccaddc) @ (ccseq @ ccaddc @ XF @ XM)) @ (ccfv @ XN @ (ccseq @ ccaddc @ XF @ XM)) @ ccmin) @ ccabs) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ XG) @ ccle) & (cwbr @ (ccfv @ (cco @ (ccfv @ (cco @ (cco @ XN @ (cco @ cc2 @ XK @ ccmul) @ ccaddc) @ cc1 @ ccaddc) @ (ccseq @ ccaddc @ XF @ XM)) @ (ccfv @ XN @ (ccseq @ ccaddc @ XF @ XM)) @ ccmin) @ ccabs) @ (ccfv @ (cco @ XN @ cc1 @ ccaddc) @ XG) @ ccle))))))))))))))))).
