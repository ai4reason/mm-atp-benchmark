...
thf(adfphi2_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((ccfv @ XN @ ccphi) = (ccfv @ (ccrab @ (^ [Xx3:$i] : ((cco @ (ccv @ Xx3) @ XN @ ccgcd) = cc1)) @ (^ [Xx3:$i] : (cco @ ccc0 @ XN @ ccfzo))) @ cchash))))).
...
thf(ceulerth_conj,conjecture,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccz) @ ((cco @ XA2 @ XN @ ccgcd) = cc1)) => ((cco @ (cco @ XA2 @ (ccfv @ XN @ ccphi) @ ccexp) @ XN @ ccmo) = (cco @ cc1 @ XN @ ccmo)))))).
