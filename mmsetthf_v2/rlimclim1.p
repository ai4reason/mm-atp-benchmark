...
thf(crlimclim1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwbr @ XF @ XA2 @ ccrli)) => ((Xph => (cwss @ XZ @ (ccdm @ XF))) => (Xph => (cwbr @ XF @ XA2 @ ccli)))))))))))).
