...
thf(cistlm_conj,conjecture,(! [Xc_x:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((Xc_x = (ccfv @ XW @ ccscaf)) => ((XJ = (ccfv @ XW @ cctopn)) => ((XF = (ccfv @ XW @ ccsca)) => ((XK = (ccfv @ XF @ cctopn)) => ((cwcel @ XW @ cctlm) <=> ((cw3a @ (cwcel @ XW @ cctmd) @ (cwcel @ XW @ cclmod) @ (cwcel @ XF @ cctrg)) & (cwcel @ Xc_x @ (cco @ (cco @ XK @ XJ @ cctx) @ XJ @ cccn)))))))))))))).
