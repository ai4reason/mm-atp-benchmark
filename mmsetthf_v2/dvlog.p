...
thf(advloglem_ax,axiom,(! [XD:($i > $o)] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwcel @ (ccima @ cclog @ XD) @ (ccfv @ cccnfld @ cctopn))))).
...
thf(aeff2_ax,axiom,(cwf @ ccc @ (ccdif @ ccc @ (ccsn @ ccc0)) @ cce)).
