...
thf(cfsuppmapnn0ub_conj,conjecture,(! [XR:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [XZ:($i > $o)] : (! [Xx3:$i] : (! [Xm:$i] : (((cwcel @ XF @ (cco @ (XR @ Xx3 @ Xm) @ ccn0 @ ccmap)) & (cwcel @ XZ @ (XV @ Xm))) => ((cwbr @ XF @ XZ @ ccfsupp) => (cwrex @ (^ [Xm:$i] : (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xm) @ (ccv @ Xx3) @ cclt) => ((ccfv @ (ccv @ Xx3) @ XF) = XZ))) @ (^ [Xx3:$i] : ccn0))) @ (^ [Xm:$i] : ccn0))))))))))).
