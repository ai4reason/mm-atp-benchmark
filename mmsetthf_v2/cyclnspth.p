...
thf(aspthdep_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwbr @ XF @ XP @ (ccfv @ XG @ ccspths)) & (cwne @ (ccfv @ XF @ cchash) @ ccc0)) => (cwne @ (ccfv @ ccc0 @ XP) @ (ccfv @ (ccfv @ XF @ cchash) @ XP))))))).
thf(ccyclnspth_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwne @ XF @ cc0) => ((cwbr @ XF @ XP @ (ccfv @ XG @ cccycls)) => (~ (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths))))))))).
