...
thf(aicopnfcnv_ax,axiom,(! [XF:($i > ($i > $o))] : ((! [Xx3:$i] : ((XF @ Xx3) = (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccico)) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (cco @ cc1 @ (ccv @ Xx3) @ ccmin) @ ccdiv))))) => (! [Xx3:$i] : ((cwf1o @ (cco @ ccc0 @ cc1 @ ccico) @ (cco @ ccc0 @ ccpnf @ ccico) @ (XF @ Xx3)) & ((cccnv @ (XF @ Xx3)) = (ccmpt @ (^ [Xy1:$i] : (cco @ ccc0 @ ccpnf @ ccico)) @ (^ [Xy1:$i] : (cco @ (ccv @ Xy1) @ (cco @ cc1 @ (ccv @ Xy1) @ ccaddc) @ ccdiv))))))))).
...
thf(altsub1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccr)) => (Xph => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (cco @ XA2 @ XC @ ccmin) @ (cco @ XB2 @ XC @ ccmin) @ cclt))))))))))).
...
thf(aleiso_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwss @ XA2 @ ccxr) & (cwss @ XB2 @ ccxr)) => ((cwiso @ XA2 @ XB2 @ cclt @ cclt @ XF) <=> (cwiso @ XA2 @ XB2 @ ccle @ ccle @ XF))))))).
thf(aisores1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : ((cwiso @ XA2 @ XB2 @ XR @ XS @ XH) <=> (cwiso @ XA2 @ XB2 @ (ccin @ XR @ (ccxp @ XA2 @ XA2)) @ XS @ XH)))))))).
thf(cwf_tp,type,(cwf : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(aisores2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XH:($i > $o)] : ((cwiso @ XA2 @ XB2 @ XR @ XS @ XH) <=> (cwiso @ XA2 @ XB2 @ XR @ (ccin @ XS @ (ccxp @ XB2 @ XB2)) @ XH)))))))).
thf(cccn_tp,type,(cccn : ($i > $o))).
thf(aordthmeo_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XX = (ccdm @ XR)) => ((XY = (ccdm @ XS)) => ((cw3a @ (cwcel @ XR @ XV) @ (cwcel @ XS @ XW) @ (cwiso @ XX @ XY @ XR @ XS @ XF)) => (cwcel @ XF @ (cco @ (ccfv @ XR @ ccordt) @ (ccfv @ XS @ ccordt) @ cchmeo))))))))))))).
...
thf(axrrest2_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ cccnfld @ cctopn)) => ((XX = (ccfv @ ccle @ ccordt)) => ((cwss @ XA2 @ ccr) => ((cco @ XJ @ XA2 @ ccrest) = (cco @ XX @ XA2 @ ccrest))))))))).
