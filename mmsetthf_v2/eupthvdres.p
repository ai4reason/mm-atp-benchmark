...
thf(avtxdeqd_ax,axiom,(! [Xph:$o] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XG @ XX)) => ((Xph => (cwcel @ XH @ XY)) => ((Xph => ((ccfv @ XH @ ccvtx) = (ccfv @ XG @ ccvtx))) => ((Xph => ((ccfv @ XH @ cciedg) = (ccfv @ XG @ cciedg))) => (Xph => ((ccfv @ XH @ ccvtxdg) = (ccfv @ XG @ ccvtxdg))))))))))))).
...
thf(aeupthf1o_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => ((cwbr @ XF @ XP @ (ccfv @ XG @ cceupth)) => (cwf1o @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XI) @ XF)))))))).
