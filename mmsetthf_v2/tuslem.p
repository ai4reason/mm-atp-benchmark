...
thf(atusval_ax,axiom,(! [XU:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XU @ (ccfv @ XX @ ccust)) => ((ccfv @ XU @ cctus) = (cco @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccdm @ (ccuni @ XU))) @ (ccop @ (ccfv @ ccnx @ ccunif) @ XU)) @ (ccop @ (ccfv @ ccnx @ ccts) @ (ccfv @ XU @ ccutop)) @ ccsts)))))).
...
thf(ctuslem_conj,conjecture,(! [XU:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XK = (ccfv @ XU @ cctus)) => ((cwcel @ XU @ (ccfv @ XX @ ccust)) => (cw3a @ (XX = (ccfv @ XK @ ccbs)) @ (XU = (ccfv @ XK @ ccunif)) @ ((ccfv @ XU @ ccutop) = (ccfv @ XK @ cctopn))))))))).
