...
thf(areuccatpfxs1lem_ax,axiom,(! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xx3:$i] : (! [Xs1:$i] : ((cw3a @ ((cwcel @ XW @ (ccword @ XV)) & (cwcel @ (XU @ Xs1) @ XX)) @ (cwral @ (^ [Xs1:$i] : ((cwcel @ (cco @ XW @ (ccs1 @ (ccv @ Xs1)) @ ccconcat) @ XX) => ((XS @ Xx3) = (ccv @ Xs1)))) @ (^ [Xs1:$i] : XV)) @ (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ (ccword @ XV)) & ((ccfv @ (ccv @ Xx3) @ cchash) = (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc)))) @ (^ [Xx3:$i] : XX))) => ((XW = (cco @ (XU @ Xs1) @ (ccfv @ XW @ cchash) @ ccpfx)) => ((XU @ Xs1) = (cco @ XW @ (ccs1 @ (XS @ Xx3)) @ ccconcat)))))))))))).
...
thf(accats1pfxeqbi_ax,axiom,(! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((cw3a @ (cwcel @ XW @ (ccword @ XV)) @ (cwcel @ XU @ (ccword @ XV)) @ ((ccfv @ XU @ cchash) = (cco @ (ccfv @ XW @ cchash) @ cc1 @ ccaddc))) => ((XW = (cco @ XU @ (ccfv @ XW @ cchash) @ ccpfx)) <=> (XU = (cco @ XW @ (ccs1 @ (ccfv @ XU @ cclsw)) @ ccconcat)))))))).
