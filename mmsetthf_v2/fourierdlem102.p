...
thf(atpfi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (cwcel @ (cctp @ XA2 @ XB2 @ XC) @ ccfn))))).
...
thf(aprunioo_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwbr @ XA2 @ XB2 @ ccle)) => ((ccun @ (cco @ XA2 @ XB2 @ ccioo) @ (ccpr @ XA2 @ XB2)) = (cco @ XA2 @ XB2 @ ccicc)))))).
...
thf(auz2m1nn_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ (ccfv @ cc2 @ ccuz)) => (cwcel @ (cco @ XN @ cc1 @ ccmin) @ ccn)))).
...
thf(afourierdlem36_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccfn)) => ((Xph => (cwss @ XA2 @ ccr)) => ((XF = (ccio @ (^ [Xf1:$i] : (cwiso @ (cco @ ccc0 @ XN @ ccfz) @ XA2 @ cclt @ cclt @ (ccv @ Xf1))))) => ((XN = (cco @ (ccfv @ XA2 @ cchash) @ cc1 @ ccmin)) => (Xph => (cwiso @ (cco @ ccc0 @ XN @ ccfz) @ XA2 @ cclt @ cclt @ XF))))))))))).
...
thf(anegpitopissre_ax,axiom,(cwss @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc) @ ccr)).
thf(affvelrnd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwcel @ XC @ XA2)) => (Xph => (cwcel @ (ccfv @ XC @ XF) @ XB2)))))))))).
thf(ccrp_tp,type,(ccrp : ($i > $o))).
thf(afourierdlem4_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => ((XT = (cco @ XB2 @ XA2 @ ccmin)) => ((! [Xx3:$i] : ((XE @ Xx3) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (cco @ (ccfv @ (cco @ (cco @ XB2 @ (ccv @ Xx3) @ ccmin) @ XT @ ccdiv) @ ccfl) @ XT @ ccmul) @ ccaddc))))) => (! [Xx3:$i] : (Xph => (cwf @ ccr @ (cco @ XA2 @ XB2 @ ccioc) @ (XE @ Xx3))))))))))))))).
...
thf(atpss_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cw3a @ (cwcel @ XA2 @ XD) @ (cwcel @ XB2 @ XD) @ (cwcel @ XC @ XD)) <=> (cwss @ (cctp @ XA2 @ XB2 @ XC) @ XD)))))))))).
...
thf(atpssi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XD) @ (cwcel @ XB2 @ XD) @ (cwcel @ XC @ XD)) => (cwss @ (cctp @ XA2 @ XB2 @ XC) @ XD))))))).
...
thf(afourierdlem46_ax,axiom,(! [Xph:$o] : (! [XC:($i > ($i > $o))] : (! [XQ:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XM:($i > ($i > $o))] : ((Xph => (cwcel @ XF @ (cco @ (ccdm @ XF) @ ccc @ cccncf))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccico) @ (ccdm @ XF)))) => (cwne @ (cco @ (ccres @ XF @ (cco @ (ccv @ Xx3) @ ccpnf @ ccioo)) @ (ccv @ Xx3) @ cclimc) @ cc0))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc) @ (ccdm @ XF)))) => (cwne @ (cco @ (ccres @ XF @ (cco @ ccmnf @ (ccv @ Xx3) @ ccioo)) @ (ccv @ Xx3) @ cclimc) @ cc0))) => ((! [Xx3:$i] : (Xph => (cwiso @ (cco @ ccc0 @ (XM @ Xx3) @ ccfz) @ (XH @ Xx3) @ cclt @ cclt @ XQ))) => ((! [Xx3:$i] : (Xph => (cwf @ (cco @ ccc0 @ (XM @ Xx3) @ ccfz) @ (XH @ Xx3) @ XQ))) => ((! [Xx3:$i] : (Xph => (cwcel @ XI @ (cco @ ccc0 @ (XM @ Xx3) @ ccfzo)))) => ((Xph => (cwbr @ (ccfv @ XI @ XQ) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XQ) @ cclt)) => ((Xph => (cwss @ (cco @ (ccfv @ XI @ XQ) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XQ) @ ccioo) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo))) => ((! [Xx3:$i] : (Xph => (cwcel @ (XC @ Xx3) @ ccr))) => ((! [Xx3:$i] : ((XH @ Xx3) = (ccun @ (cctp @ (ccneg @ ccpi) @ ccpi @ (XC @ Xx3)) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ (ccdm @ XF))))) => ((! [Xx3:$i] : (Xph => ((ccrn @ XQ) = (XH @ Xx3)))) => (Xph => ((cwne @ (cco @ (ccres @ XF @ (cco @ (ccfv @ XI @ XQ) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XQ) @ ccioo)) @ (ccfv @ XI @ XQ) @ cclimc) @ cc0) & (cwne @ (cco @ (ccres @ XF @ (cco @ (ccfv @ XI @ XQ) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XQ) @ ccioo)) @ (ccfv @ (cco @ XI @ cc1 @ ccaddc) @ XQ) @ cclimc) @ cc0)))))))))))))))))))))).
thf(aadantlr_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (((Xph & Xps) => Xch) => (((Xph & Xth) & Xps) => Xch))))))).
thf(asimprd_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (Xps & Xch)) => (Xph => Xch)))))).
thf(cfourierdlem102_conj,conjecture,(! [Xph:($i > $o)] : (! [XP:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XQ:($i > $o)] : (! [XT:($i > ($i > $o))] : (! [XE:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > ($i > ($i > $o)))] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XM:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xg1:$i] : (! [Xp:$i] : ((Xph @ Xp) => (cwf @ ccr @ ccr @ (XF @ Xg1 @ Xp))))) => ((! [Xg1:$i] : ((XT @ Xg1) = (cco @ cc2 @ ccpi @ ccmul))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xp:$i] : (((Xph @ Xp) & (cwcel @ (ccv @ Xx3) @ ccr)) => ((ccfv @ (cco @ (ccv @ Xx3) @ (XT @ Xg1) @ ccaddc) @ (XF @ Xg1 @ Xp)) = (ccfv @ (ccv @ Xx3) @ (XF @ Xg1 @ Xp))))))) => ((! [Xg1:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XG @ Xg1 @ Xn @ Xp) = (ccres @ (cco @ ccr @ (XF @ Xg1 @ Xp) @ ccdv) @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo)))))) => ((! [Xg1:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xph @ Xp) => (cwcel @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioo) @ (ccdm @ (XG @ Xg1 @ Xn @ Xp))) @ ccfn))))) => ((! [Xg1:$i] : (! [Xn:$i] : (! [Xp:$i] : ((Xph @ Xp) => (cwcel @ (XG @ Xg1 @ Xn @ Xp) @ (cco @ (ccdm @ (XG @ Xg1 @ Xn @ Xp)) @ ccc @ cccncf)))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xn:$i] : (! [Xp:$i] : (((Xph @ Xp) & (cwcel @ (ccv @ Xx3) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccico) @ (ccdm @ (XG @ Xg1 @ Xn @ Xp))))) => (cwne @ (cco @ (ccres @ (XG @ Xg1 @ Xn @ Xp) @ (cco @ (ccv @ Xx3) @ ccpnf @ ccioo)) @ (ccv @ Xx3) @ cclimc) @ cc0)))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xn:$i] : (! [Xp:$i] : (((Xph @ Xp) & (cwcel @ (ccv @ Xx3) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccioc) @ (ccdm @ (XG @ Xg1 @ Xn @ Xp))))) => (cwne @ (cco @ (ccres @ (XG @ Xg1 @ Xn @ Xp) @ (cco @ ccmnf @ (ccv @ Xx3) @ ccioo)) @ (ccv @ Xx3) @ cclimc) @ cc0)))))) => ((! [Xg1:$i] : (! [Xp:$i] : ((Xph @ Xp) => (cwcel @ (XX @ Xg1) @ ccr)))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XP @ Xx3 @ Xg1 @ Xi @ Xn @ Xp) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccrab @ (^ [Xp:$i] : ((((ccfv @ ccc0 @ (ccv @ Xp)) = (ccneg @ ccpi)) & ((ccfv @ (ccv @ Xn) @ (ccv @ Xp)) = ccpi)) & (cwral @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccv @ Xi) @ (ccv @ Xp)) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (ccv @ Xp)) @ cclt)) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccv @ Xn) @ ccfzo))))) @ (^ [Xp:$i] : (cco @ ccr @ (cco @ ccc0 @ (ccv @ Xn) @ ccfz) @ ccmap))))))))))) => ((! [Xg1:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XE @ Xg1 @ Xi @ Xn @ Xp) = (ccmpt @ (^ [Xx3:$i] : ccr) @ (^ [Xx3:$i] : (cco @ (ccv @ Xx3) @ (cco @ (ccfv @ (cco @ (cco @ ccpi @ (ccv @ Xx3) @ ccmin) @ (XT @ Xg1) @ ccdiv) @ ccfl) @ (XT @ Xg1) @ ccmul) @ ccaddc)))))))) => ((! [Xx3:$i] : (! [Xg1:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : ((XH @ Xx3 @ Xi @ Xn @ Xp) = (ccun @ (cctp @ (ccneg @ ccpi) @ ccpi @ (ccfv @ (XX @ Xg1) @ (XE @ Xg1 @ Xi @ Xn @ Xp))) @ (ccdif @ (cco @ (ccneg @ ccpi) @ ccpi @ ccicc) @ (ccdm @ (XG @ Xg1 @ Xn @ Xp)))))))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (XM = (cco @ (ccfv @ (XH @ Xx3 @ Xi @ Xn @ Xp) @ cchash) @ cc1 @ ccmin)))))) => ((! [Xx3:$i] : (! [Xi:$i] : (! [Xn:$i] : (! [Xp:$i] : (XQ = (ccio @ (^ [Xg1:$i] : (cwiso @ (cco @ ccc0 @ XM @ ccfz) @ (XH @ Xx3 @ Xi @ Xn @ Xp) @ cclt @ cclt @ (ccv @ Xg1))))))))) => (! [Xg1:$i] : (! [Xp:$i] : ((Xph @ Xp) => ((cwne @ (cco @ (ccres @ (XF @ Xg1 @ Xp) @ (cco @ ccmnf @ (XX @ Xg1) @ ccioo)) @ (XX @ Xg1) @ cclimc) @ cc0) & (cwne @ (cco @ (ccres @ (XF @ Xg1 @ Xp) @ (cco @ (XX @ Xg1) @ ccpnf @ ccioo)) @ (XX @ Xg1) @ cclimc) @ cc0)))))))))))))))))))))))))))))).
