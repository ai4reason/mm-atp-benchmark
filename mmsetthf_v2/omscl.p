...
thf(comscl_conj,conjecture,(! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XQ @ XV) @ (cwf @ XQ @ (cco @ ccc0 @ ccpnf @ ccicc) @ XR) @ (cwcel @ XA2 @ (ccpw @ (ccuni @ (ccdm @ XR))))) => (cwss @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : (ccrab @ (^ [Xz:$i] : ((cwss @ XA2 @ (ccuni @ (ccv @ Xz))) & (cwbr @ (ccv @ Xz) @ ccom @ ccdom))) @ (^ [Xz:$i] : (ccpw @ (ccdm @ XR))))) @ (^ [Xx3:$i] : (ccesum @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XR)))))) @ (cco @ ccc0 @ ccpnf @ ccicc)))))))).
