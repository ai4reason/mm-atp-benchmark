...
thf(aamgmw2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwcel @ XP @ ccrp)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((Xph => (cwcel @ XQ @ ccrp)) => ((Xph => ((cco @ XP @ XQ @ ccaddc) = cc1)) => (Xph => (cwbr @ (cco @ (cco @ XA2 @ XP @ cccxp) @ (cco @ XB2 @ XQ @ cccxp) @ ccmul) @ (cco @ (cco @ XA2 @ XP @ ccmul) @ (cco @ XB2 @ XQ @ ccmul) @ ccaddc) @ ccle))))))))))))).
