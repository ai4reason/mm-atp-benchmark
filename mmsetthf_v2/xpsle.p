...
thf(aimasleval_ax,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XU:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XF:($i > $o)] : (! [Xc_le:($i > ($i > ($i > $o)))] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [XY:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (Xph => ((XU @ Xa @ Xb @ Xc @ Xd) = (cco @ XF @ (XR @ Xa @ Xb @ Xc @ Xd) @ ccimas))))))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (Xph => (XV = (ccfv @ (XR @ Xa @ Xb @ Xc @ Xd) @ ccbs))))))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (Xph => (cwfo @ XV @ (XB2 @ Xa @ Xb @ Xc @ Xd) @ XF)))))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (Xph => (cwcel @ (XR @ Xa @ Xb @ Xc @ Xd) @ (XZ @ Xa @ Xb @ Xc @ Xd))))))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((Xc_le @ Xa @ Xb) = (ccfv @ (XU @ Xa @ Xb @ Xc @ Xd) @ ccple)))))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : (XN = (ccfv @ (XR @ Xa @ Xb @ Xc @ Xd) @ ccple)))))) => ((! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((cw3a @ Xph @ ((cwcel @ (ccv @ Xa) @ XV) & (cwcel @ (ccv @ Xb) @ XV)) @ ((cwcel @ (ccv @ Xc) @ XV) & (cwcel @ (ccv @ Xd) @ XV))) => ((((ccfv @ (ccv @ Xa) @ XF) = (ccfv @ (ccv @ Xc) @ XF)) & ((ccfv @ (ccv @ Xb) @ XF) = (ccfv @ (ccv @ Xd) @ XF))) => ((cwbr @ (ccv @ Xa) @ (ccv @ Xb) @ XN) <=> (cwbr @ (ccv @ Xc) @ (ccv @ Xd) @ XN)))))))) => (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : ((cw3a @ Xph @ (cwcel @ (XX @ Xa @ Xb) @ XV) @ (cwcel @ (XY @ Xa @ Xb @ Xc) @ XV)) => ((cwbr @ (ccfv @ (XX @ Xa @ Xb) @ XF) @ (ccfv @ (XY @ Xa @ Xb @ Xc) @ XF) @ (Xc_le @ Xa @ Xb)) <=> (cwbr @ (XX @ Xa @ Xb) @ (XY @ Xa @ Xb @ Xc) @ XN))))))))))))))))))))))))).
...
thf(af1olecpbl_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwf1o @ XV @ XX @ XF)) => ((cw3a @ Xph @ ((cwcel @ XA2 @ XV) & (cwcel @ XB2 @ XV)) @ ((cwcel @ XC @ XV) & (cwcel @ XD @ XV))) => ((((ccfv @ XA2 @ XF) = (ccfv @ XC @ XF)) & ((ccfv @ XB2 @ XF) = (ccfv @ XD @ XF))) => ((cwbr @ XA2 @ XB2 @ XN) <=> (cwbr @ XC @ XD @ XN))))))))))))))).
