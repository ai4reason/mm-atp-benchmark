...
thf(alimcun_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwss @ XB2 @ ccc)) => ((Xph => (cwf @ (ccun @ XA2 @ XB2) @ ccc @ XF)) => (Xph => ((cco @ XF @ XC @ cclimc) = (ccin @ (cco @ (ccres @ XF @ XA2) @ XC @ cclimc) @ (cco @ (ccres @ XF @ XB2) @ XC @ cclimc))))))))))))).
