...
thf(apadd02_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => (((cwcel @ XK @ XB2) & (cwss @ XX @ XA2)) => ((cco @ cc0 @ XX @ Xc_pl) = XX)))))))))).
...
thf(apexmidlem8N_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => ((Xc_pe = (ccfv @ XK @ ccpolN)) => ((((cwcel @ XK @ cchlt) & (cwss @ XX @ XA2)) & (((ccfv @ (ccfv @ XX @ Xc_pe) @ Xc_pe) = XX) & (cwne @ XX @ cc0))) => ((cco @ XX @ (ccfv @ XX @ Xc_pe) @ Xc_pl) = XA2))))))))))).
thf(cpexmidALTN_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XK @ ccatm)) => ((Xc_pl = (ccfv @ XK @ ccpadd)) => ((Xc_pe = (ccfv @ XK @ ccpolN)) => ((((cwcel @ XK @ cchlt) & (cwss @ XX @ XA2)) & ((ccfv @ (ccfv @ XX @ Xc_pe) @ Xc_pe) = XX)) => ((cco @ XX @ (ccfv @ XX @ Xc_pe) @ Xc_pl) = XA2))))))))))).
