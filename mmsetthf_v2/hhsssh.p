...
thf(ahhshsslem2_ax,axiom,(! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XW:($i > $o)] : ((XU = (ccop @ (ccop @ ccva @ ccsm) @ ccno)) => ((XW = (ccop @ (ccop @ (ccres @ ccva @ (ccxp @ XH @ XH)) @ (ccres @ ccsm @ (ccxp @ ccc @ XH))) @ (ccres @ ccno @ XH))) => ((cwcel @ XW @ (ccfv @ XU @ ccss)) => ((cwss @ XH @ cchil) => (cwcel @ XH @ ccsh))))))))).
...
thf(asspid_ax,axiom,(! [XU:($i > $o)] : (! [XH:($i > $o)] : ((XH = (ccfv @ XU @ ccss)) => ((cwcel @ XU @ ccnv) => (cwcel @ XU @ XH)))))).
