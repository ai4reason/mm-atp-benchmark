...
thf(aelopaba_ax,axiom,(! [Xph:$o] : (! [Xps:($i > ($i > $o))] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : ((XA2 = (ccop @ (ccv @ Xx3) @ (ccv @ Xy1))) => (Xph <=> (Xps @ Xx3 @ Xy1))))) => ((cwcel @ XA2 @ (ccopab @ (^ [Xx3:$i] : (^ [Xy1:$i] : (Xps @ Xx3 @ Xy1))))) <=> ((cwcel @ XA2 @ (ccxp @ ccvv @ ccvv)) & Xph))))))).
