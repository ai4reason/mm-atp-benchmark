...
thf(aelno_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccsur) <=> (cwrex @ (^ [Xx3:$i] : (cwf @ (ccv @ Xx3) @ (ccpr @ cc1o @ cc2o) @ XA2)) @ (^ [Xx3:$i] : ccon0))))).
thf(celno2_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccsur) <=> (cw3a @ (cwfun @ XA2) @ (cwcel @ (ccdm @ XA2) @ ccon0) @ (cwss @ (ccrn @ XA2) @ (ccpr @ cc1o @ cc2o)))))).
