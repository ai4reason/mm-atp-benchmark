...
thf(aradcnvrat_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > ($i > ($i > $o))))] : (! [XR:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XG:($i > $o)] : (! [XL:($i > ($i > ($i > $o)))] : (! [XM:($i > ($i > ($i > ($i > $o))))] : (! [XZ:($i > ($i > ($i > $o)))] : ((! [Xk:$i] : (! [Xr:$i] : (XG = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xk @ Xr)) @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccexp) @ ccmul)))))))) => ((! [Xk:$i] : (! [Xr:$i] : ((Xph @ Xr) => (cwf @ ccn0 @ ccc @ (XA2 @ Xk @ Xr))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xr:$i] : ((XR @ Xx3 @ Xk @ Xn @ Xr) = (ccsup @ (ccrab @ (^ [Xr:$i] : (cwcel @ (ccseq @ ccaddc @ (ccfv @ (ccv @ Xr) @ XG) @ ccc0) @ (ccdm @ ccli))) @ (^ [Xr:$i] : ccr)) @ ccxr @ cclt)))))) => ((! [Xx3:$i] : (! [Xn:$i] : (! [Xr:$i] : ((XD @ Xx3 @ Xn @ Xr) = (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (XA2 @ Xk @ Xr)) @ (ccfv @ (ccv @ Xk) @ (XA2 @ Xk @ Xr)) @ ccdiv) @ ccabs))))))) => ((! [Xx3:$i] : (! [Xn:$i] : (! [Xr:$i] : ((XZ @ Xx3 @ Xr) = (ccfv @ (XM @ Xx3 @ Xn @ Xr) @ ccuz))))) => ((! [Xx3:$i] : (! [Xn:$i] : (! [Xr:$i] : ((Xph @ Xr) => (cwcel @ (XM @ Xx3 @ Xn @ Xr) @ ccn0))))) => ((! [Xx3:$i] : (! [Xk:$i] : (! [Xr:$i] : (((Xph @ Xr) & (cwcel @ (ccv @ Xk) @ (XZ @ Xx3 @ Xr))) => (cwne @ (ccfv @ (ccv @ Xk) @ (XA2 @ Xk @ Xr)) @ ccc0))))) => ((! [Xx3:$i] : (! [Xn:$i] : (! [Xr:$i] : ((Xph @ Xr) => (cwbr @ (XD @ Xx3 @ Xn @ Xr) @ (XL @ Xn @ Xr) @ ccli))))) => ((! [Xn:$i] : (! [Xr:$i] : ((Xph @ Xr) => (cwne @ (XL @ Xn @ Xr) @ ccc0)))) => (! [Xx3:$i] : (! [Xk:$i] : (! [Xn:$i] : (! [Xr:$i] : ((Xph @ Xr) => ((XR @ Xx3 @ Xk @ Xn @ Xr) = (cco @ cc1 @ (XL @ Xn @ Xr) @ ccdiv))))))))))))))))))))))))).
...
thf(abinomcxplemfrat_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XA2 @ Xj @ Xk) @ ccrp)))) => ((! [Xj:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XB2 @ Xj @ Xk) @ ccr)))) => ((! [Xj:$i] : (! [Xk:$i] : (Xph => (cwbr @ (ccfv @ (XB2 @ Xj @ Xk) @ ccabs) @ (ccfv @ (XA2 @ Xj @ Xk) @ ccabs) @ cclt)))) => ((Xph => (cwcel @ XC @ ccc)) => ((! [Xj:$i] : (! [Xk:$i] : ((XF @ Xj @ Xk) = (ccmpt @ (^ [Xj:$i] : ccn0) @ (^ [Xj:$i] : (cco @ XC @ (ccv @ Xj) @ ccbcc)))))) => (! [Xj:$i] : ((Xph & (~ (cwcel @ XC @ ccn0))) => (cwbr @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ (XF @ Xj @ Xk)) @ (ccfv @ (ccv @ Xk) @ (XF @ Xj @ Xk)) @ ccdiv) @ ccabs))) @ cc1 @ ccli)))))))))))))).
