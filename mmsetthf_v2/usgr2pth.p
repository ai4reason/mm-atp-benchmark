...
thf(ausgr2pthspth_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwcel @ XG @ ccusgr) & ((ccfv @ XF @ cchash) = cc2)) => ((cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) <=> (cwbr @ XF @ XP @ (ccfv @ XG @ ccspths)))))))).
...
thf(aupgrf1istrl_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XG @ cciedg)) => ((cwcel @ XG @ ccupgr) => ((cwbr @ XF @ XP @ (ccfv @ XG @ cctrls)) <=> (cw3a @ (cwf1 @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XI) @ XF) @ (cwf @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz) @ XV @ XP) @ (cwral @ (^ [Xk:$i] : ((ccfv @ (ccfv @ (ccv @ Xk) @ XF) @ XI) = (ccpr @ (ccfv @ (ccv @ Xk) @ XP) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XP)))) @ (^ [Xk:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)))))))))))))).
...
thf(ausgr2pthlem_ax,axiom,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xi:$i] : ((XV @ Xi) = (ccfv @ (XG @ Xi) @ ccvtx))) => ((! [Xi:$i] : (XI = (ccfv @ (XG @ Xi) @ cciedg))) => (! [Xi:$i] : ((cw3a @ (cwf1 @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo) @ (ccdm @ XI) @ XF) @ (cwf @ (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfz) @ (XV @ Xi) @ XP) @ (cwral @ (^ [Xi:$i] : ((ccfv @ (ccfv @ (ccv @ Xi) @ XF) @ XI) = (ccpr @ (ccfv @ (ccv @ Xi) @ XP) @ (ccfv @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ XP)))) @ (^ [Xi:$i] : (cco @ ccc0 @ (ccfv @ XF @ cchash) @ ccfzo)))) => (((cwcel @ (XG @ Xi) @ ccusgr) & ((ccfv @ XF @ cchash) = cc2)) => (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((cw3a @ ((ccfv @ ccc0 @ XP) = (ccv @ Xx3)) @ ((ccfv @ cc1 @ XP) = (ccv @ Xy1)) @ ((ccfv @ cc2 @ XP) = (ccv @ Xz))) & (((ccfv @ (ccfv @ ccc0 @ XF) @ XI) = (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1))) & ((ccfv @ (ccfv @ cc1 @ XF) @ XI) = (ccpr @ (ccv @ Xy1) @ (ccv @ Xz)))))) @ (^ [Xz:$i] : (ccdif @ (XV @ Xi) @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)))))) @ (^ [Xy1:$i] : (ccdif @ (XV @ Xi) @ (ccsn @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : (XV @ Xi)))))))))))))).
...
thf(afnfzo0hash_ax,axiom,(! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XN @ ccn0) & (cwf @ (cco @ ccc0 @ XN @ ccfzo) @ XB2 @ XF)) => ((ccfv @ XF @ cchash) = XN)))))).
...
thf(aa1i13_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xps => Xth) => (Xph => (Xps => (Xch => Xth))))))))).
...
thf(cusgr2pth_conj,conjecture,(! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((XI = (ccfv @ XG @ cciedg)) => ((cwcel @ XG @ ccusgr) => (((cwbr @ XF @ XP @ (ccfv @ XG @ ccpths)) & ((ccfv @ XF @ cchash) = cc2)) <=> (cw3a @ (cwf1 @ (cco @ ccc0 @ cc2 @ ccfzo) @ (ccdm @ XI) @ XF) @ (cwf1 @ (cco @ ccc0 @ cc2 @ ccfz) @ XV @ XP) @ (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : ((cw3a @ ((ccfv @ ccc0 @ XP) = (ccv @ Xx3)) @ ((ccfv @ cc1 @ XP) = (ccv @ Xy1)) @ ((ccfv @ cc2 @ XP) = (ccv @ Xz))) & (((ccfv @ (ccfv @ ccc0 @ XF) @ XI) = (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1))) & ((ccfv @ (ccfv @ cc1 @ XF) @ XI) = (ccpr @ (ccv @ Xy1) @ (ccv @ Xz)))))) @ (^ [Xz:$i] : (ccdif @ XV @ (ccpr @ (ccv @ Xx3) @ (ccv @ Xy1)))))) @ (^ [Xy1:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xx3)))))) @ (^ [Xx3:$i] : XV))))))))))))).
