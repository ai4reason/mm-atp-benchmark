...
thf(abitsinv2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ (ccin @ (ccpw @ ccn0) @ ccfn)) => ((ccfv @ (ccsu @ XA2 @ (^ [Xn:$i] : (cco @ cc2 @ (ccv @ Xn) @ ccexp))) @ ccbits) = XA2)))).
...
thf(abitsf_ax,axiom,(cwf @ ccz @ (ccpw @ ccn0) @ ccbits)).
...
thf(cbitsf1ocnv_conj,conjecture,((cwf1o @ ccn0 @ (ccin @ (ccpw @ ccn0) @ ccfn) @ (ccres @ ccbits @ ccn0)) & ((cccnv @ (ccres @ ccbits @ ccn0)) = (ccmpt @ (^ [Xx3:$i] : (ccin @ (ccpw @ ccn0) @ ccfn)) @ (^ [Xx3:$i] : (ccsu @ (ccv @ Xx3) @ (^ [Xn:$i] : (cco @ cc2 @ (ccv @ Xn) @ ccexp)))))))).
