...
thf(aisppw_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => ((cwne @ (ccfv @ XA2 @ ccvma) @ ccc0) <=> (cwreu @ (^ [Xp:$i] : (cwbr @ (ccv @ Xp) @ XA2 @ ccdvds)) @ (^ [Xp:$i] : ccprime)))))).
...
thf(aequequ1_b1_ax,axiom,(! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => (((ccv @ Xx3) = (ccv @ Xy1)) <=> ((ccv @ Xy1) = (ccv @ Xy1))))))).
...
thf(cisppw2_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => ((cwne @ (ccfv @ XA2 @ ccvma) @ ccc0) <=> (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xk:$i] : (XA2 = (cco @ (ccv @ Xp) @ (ccv @ Xk) @ ccexp))) @ (^ [Xk:$i] : ccn))) @ (^ [Xp:$i] : ccprime)))))).
