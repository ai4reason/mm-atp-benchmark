...
thf(acda0en_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XA2 @ XV) => (cwbr @ (cco @ XA2 @ cc0 @ cccda) @ XA2 @ ccen))))).
...
thf(ccdalepw_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwbr @ (cco @ XA2 @ XA2 @ cccda) @ XA2 @ ccen) & (cwbr @ XB2 @ (ccpw @ XA2) @ ccdom)) => (cwbr @ (cco @ XA2 @ XB2 @ cccda) @ (ccpw @ XA2) @ ccdom))))).
