...
thf(astge0_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XS @ ccst) => ((cwcel @ XA2 @ ccch) => (cwbr @ ccc0 @ (ccfv @ XA2 @ XS) @ ccle)))))).
...
thf(cstle0i_conj,conjecture,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XS @ ccst) => ((cwbr @ (ccfv @ XA2 @ XS) @ ccc0 @ ccle) <=> ((ccfv @ XA2 @ XS) = ccc0))))))).
