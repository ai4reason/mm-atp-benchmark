...
thf(aiscard3_ax,axiom,(! [XA2:($i > $o)] : (((ccfv @ XA2 @ cccrd) = XA2) <=> (cwcel @ XA2 @ (ccun @ ccom @ (ccrn @ ccale)))))).
thf(ccardnum_conj,conjecture,((ccab @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ cccrd) = (ccv @ Xx3)))) = (ccun @ ccom @ (ccrn @ ccale)))).
