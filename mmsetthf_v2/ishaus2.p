...
thf(cishaus2_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > ($i > ($i > $o)))] : (! [Xm:$i] : (! [Xn:$i] : ((cwcel @ XJ @ (ccfv @ (XX @ Xm @ Xn) @ cctopon)) => ((cwcel @ XJ @ ccha) <=> (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cwne @ (ccv @ Xx3) @ (ccv @ Xy1)) => (cwrex @ (^ [Xn:$i] : (cwrex @ (^ [Xm:$i] : (cw3a @ (cwcel @ (ccv @ Xx3) @ (ccv @ Xn)) @ (cwcel @ (ccv @ Xy1) @ (ccv @ Xm)) @ ((ccin @ (ccv @ Xn) @ (ccv @ Xm)) = cc0))) @ (^ [Xm:$i] : XJ))) @ (^ [Xn:$i] : XJ)))) @ (^ [Xy1:$i] : (XX @ Xm @ Xn)))) @ (^ [Xx3:$i] : (XX @ Xm @ Xn)))))))))).
