...
thf(adfid4_ax,axiom,(ccid = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccv @ Xx3))))).
...
thf(aintmin2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((ccint @ (ccab @ (^ [Xx3:$i] : (cwss @ XA2 @ (ccv @ Xx3))))) = XA2)))).
thf(avex_ax,axiom,(! [Xx3:$i] : (cwcel @ (ccv @ Xx3) @ ccvv))).
thf(cdfid7_conj,conjecture,(ccid = (ccmpt @ (^ [Xx3:$i] : ccvv) @ (^ [Xx3:$i] : (ccint @ (ccab @ (^ [Xy1:$i] : ((cwss @ (ccv @ Xx3) @ (ccv @ Xy1)) & $true)))))))).
