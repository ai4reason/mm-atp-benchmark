...
thf(cfnn0ind_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [Xth:($i > $o)] : (! [Xta:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = ccc0) => ((Xph @ Xx3) <=> (Xps @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (ccv @ Xy1)) => ((Xph @ Xx3) <=> (Xch @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (cco @ (ccv @ Xy1) @ cc1 @ ccaddc)) => ((Xph @ Xx3) <=> (Xth @ Xy1))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (((ccv @ Xx3) = (XK @ Xy1)) => ((Xph @ Xx3) <=> (Xta @ Xy1))))) => ((! [Xy1:$i] : ((cwcel @ XN @ ccn0) => (Xps @ Xy1))) => ((! [Xy1:$i] : ((cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ (ccv @ Xy1) @ ccn0) @ (cwbr @ (ccv @ Xy1) @ XN @ cclt)) => ((Xch @ Xy1) => (Xth @ Xy1)))) => (! [Xy1:$i] : ((cw3a @ (cwcel @ XN @ ccn0) @ (cwcel @ (XK @ Xy1) @ ccn0) @ (cwbr @ (XK @ Xy1) @ XN @ ccle)) => (Xta @ Xy1))))))))))))))))).
