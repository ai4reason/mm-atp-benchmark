...
thf(admdcompli_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwbr @ XA2 @ XB2 @ ccdmd) <=> (cwbr @ (ccin @ XA2 @ (ccfv @ (ccin @ XA2 @ XB2) @ ccort)) @ (ccin @ XB2 @ (ccfv @ (ccin @ XA2 @ XB2) @ ccort)) @ ccdmd))))))).
thf(amdcompli_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwbr @ XA2 @ XB2 @ ccmd) <=> (cwbr @ (ccin @ XA2 @ (ccfv @ (ccin @ XA2 @ XB2) @ ccort)) @ (ccin @ XB2 @ (ccfv @ (ccin @ XA2 @ XB2) @ ccort)) @ ccmd))))))).
thf(cmddmdin0i_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (((cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccdmd) & ((ccin @ (ccv @ Xx3) @ (ccv @ Xy1)) = cc0h)) => (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccmd))) @ (^ [Xy1:$i] : ccch))) @ (^ [Xx3:$i] : ccch)) => ((cwbr @ XA2 @ XB2 @ ccdmd) => (cwbr @ XA2 @ XB2 @ ccmd)))))))).
