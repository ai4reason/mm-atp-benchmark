...
thf(cordtype2_conj,conjecture,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : ((XF = (ccoi @ XA2 @ XR)) => ((cw3a @ (cwwe @ XA2 @ XR) @ (cwse @ XA2 @ XR) @ (cwcel @ XF @ ccvv)) => (cwiso @ (ccdm @ XF) @ XA2 @ ccep @ XR @ XF))))))).
