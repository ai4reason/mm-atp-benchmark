...
thf(ashsub1i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cwcel @ XB2 @ ccsh) => (cwss @ XA2 @ (cco @ XA2 @ XB2 @ ccph))))))).
thf(cshsidmi_conj,conjecture,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccsh) => ((cco @ XA2 @ XA2 @ ccph) = XA2)))).
