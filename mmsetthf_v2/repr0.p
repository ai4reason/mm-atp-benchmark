...
thf(arabeqsnd_ax,axiom,(! [Xph:$o] : (! [Xps:($i > $o)] : (! [Xch:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : ((! [Xx3:$i] : (((ccv @ Xx3) = XB2) => ((Xps @ Xx3) <=> (Xch @ Xx3)))) => ((! [Xx3:$i] : (Xph => (cwcel @ XB2 @ (XA2 @ Xx3)))) => ((! [Xx3:$i] : (Xph => (Xch @ Xx3))) => ((! [Xx3:$i] : (((Xph & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) & (Xps @ Xx3)) => ((ccv @ Xx3) = XB2))) => (Xph => ((ccrab @ (^ [Xx3:$i] : (Xps @ Xx3)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) = (ccsn @ XB2))))))))))))).
...
thf(crepr0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwss @ XA2 @ ccn)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwcel @ XS @ ccn0)) => (Xph => ((cco @ XA2 @ XM @ (ccfv @ ccc0 @ ccrepr)) = (ccif @ (XM = ccc0) @ (ccsn @ cc0) @ cc0))))))))))).
