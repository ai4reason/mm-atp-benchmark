...
thf(ctoslub_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_lt = (ccfv @ XK @ ccplt)) => ((Xph => (cwcel @ XK @ cctos)) => ((Xph => (cwss @ XA2 @ XB2)) => (Xph => ((ccfv @ XA2 @ (ccfv @ XK @ cclub)) = (ccsup @ XA2 @ XB2 @ Xc_lt))))))))))))).
