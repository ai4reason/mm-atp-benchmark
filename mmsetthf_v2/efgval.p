...
thf(aereq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((XA2 = XB2) => ((cwer @ XA2 @ XR) <=> (cwer @ XB2 @ XR))))))).
...
thf(aerssxp_ax,axiom,(! [XA2:($i > $o)] : (! [XR:($i > $o)] : ((cwer @ XA2 @ XR) => (cwss @ XR @ (ccxp @ XA2 @ XA2)))))).
...
thf(cefgval_conj,conjecture,(! [Xc_sm:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XW:($i > $o)] : ((XW = (ccfv @ (ccword @ (ccxp @ XI @ cc2o)) @ ccid)) => ((! [Xn:$i] : ((Xc_sm @ Xn) = (ccfv @ XI @ ccefg))) => (! [Xn:$i] : ((Xc_sm @ Xn) = (ccint @ (ccab @ (^ [Xr:$i] : ((cwer @ XW @ (ccv @ Xr)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xn:$i] : (cwral @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccv @ Xx3) @ (cco @ (ccv @ Xx3) @ (ccotp @ (ccv @ Xn) @ (ccv @ Xn) @ (ccs2 @ (ccop @ (ccv @ Xy1) @ (ccv @ Xz)) @ (ccop @ (ccv @ Xy1) @ (ccdif @ cc1o @ (ccv @ Xz))))) @ ccsplice) @ (ccv @ Xr))) @ (^ [Xz:$i] : cc2o))) @ (^ [Xy1:$i] : XI))) @ (^ [Xn:$i] : (cco @ ccc0 @ (ccfv @ (ccv @ Xx3) @ cchash) @ ccfz)))) @ (^ [Xx3:$i] : XW)))))))))))))).
