...
thf(ahilmetdval_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((XD = (cccom @ ccno @ ccmv)) => (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => ((cco @ XA2 @ XB2 @ XD) = (ccfv @ (cco @ XA2 @ XB2 @ ccmv) @ ccno)))))))).
...
thf(ahilxmet_ax,axiom,(! [XD:($i > $o)] : ((XD = (cccom @ ccno @ ccmv)) => (cwcel @ XD @ (ccfv @ cchil @ ccxmt))))).
...
thf(chhcnf_conj,conjecture,(! [XD:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XD = (cccom @ ccno @ ccmv)) => ((XJ = (ccfv @ XD @ ccmopn)) => ((XK = (ccfv @ cccnfld @ cctopn)) => (cccnfn = (cco @ XJ @ XK @ cccn))))))))).
