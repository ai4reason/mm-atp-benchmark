...
thf(chvmap1o2_conj,conjecture,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((Xc_0 = (ccfv @ XU @ cc0g)) => ((XC = (ccfv @ XW @ (ccfv @ XK @ cclcd))) => ((XF = (ccfv @ XC @ ccbs)) => ((XO = (ccfv @ XC @ cc0g)) => ((XM = (ccfv @ XW @ (ccfv @ XK @ cchvm))) => ((Xph => ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH))) => (Xph => (cwf1o @ (ccdif @ XV @ (ccsn @ Xc_0)) @ (ccdif @ XF @ (ccsn @ XO)) @ XM))))))))))))))))))))))).
