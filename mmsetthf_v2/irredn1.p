...
thf(airrednu_ax,axiom,(! [XR:($i > $o)] : (! [XU:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XI = (ccfv @ XR @ ccir)) => ((XU = (ccfv @ XR @ ccui)) => ((cwcel @ XX @ XI) => (~ (cwcel @ XX @ XU)))))))))).
...
thf(cirredn1_conj,conjecture,(! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : ((XI = (ccfv @ XR @ ccir)) => ((Xc_1 = (ccfv @ XR @ ccur)) => (((cwcel @ XR @ ccrg) & (cwcel @ XX @ XI)) => (cwne @ XX @ Xc_1))))))))).
