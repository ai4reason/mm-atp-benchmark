...
thf(apmtrfval_ax,axiom,(! [XD:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : ((XT = (ccfv @ XD @ ccpmtr)) => (! [Xy1:$i] : (! [Xp:$i] : ((cwcel @ XD @ (XV @ Xy1 @ Xp)) => (XT = (ccmpt @ (^ [Xp:$i] : (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ cc2o @ ccen)) @ (^ [Xy1:$i] : (ccpw @ XD)))) @ (^ [Xp:$i] : (ccmpt @ (^ [Xz:$i] : XD) @ (^ [Xz:$i] : (ccif @ (cwcel @ (ccv @ Xz) @ (ccv @ Xp)) @ (ccuni @ (ccdif @ (ccv @ Xp) @ (ccsn @ (ccv @ Xz)))) @ (ccv @ Xz))))))))))))))).
...
thf(cpmtrrn_conj,conjecture,(! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XV:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((XR = (ccrn @ XT)) => ((cw3a @ (cwcel @ XD @ XV) @ (cwss @ XP @ XD) @ (cwbr @ XP @ cc2o @ ccen)) => (cwcel @ (ccfv @ XP @ XT) @ XR)))))))))).
