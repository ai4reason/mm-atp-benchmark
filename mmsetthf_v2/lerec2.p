...
thf(clerec2_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ cclt)) & ((cwcel @ XB2 @ ccr) & (cwbr @ ccc0 @ XB2 @ cclt))) => ((cwbr @ XA2 @ (cco @ cc1 @ XB2 @ ccdiv) @ ccle) <=> (cwbr @ XB2 @ (cco @ cc1 @ XA2 @ ccdiv) @ ccle)))))).
