...
thf(cdicelval1stN_conj,conjecture,(! [XA2:($i > $o)] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XW:($i > $o)] : (! [XY:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdic))) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le))) @ (cwcel @ XY @ (ccfv @ XQ @ XI))) => (cwcel @ (ccfv @ XY @ cc1st) @ XT))))))))))))))))).
