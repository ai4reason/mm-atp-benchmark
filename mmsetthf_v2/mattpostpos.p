...
thf(atpostpos2_ax,axiom,(! [XF:($i > $o)] : (((cwrel @ XF) & (cwrel @ (ccdm @ XF))) => ((cctpos @ (cctpos @ XF)) = XF)))).
thf(cmattpostpos_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (cco @ XN @ XR @ ccmat)) => ((XB2 = (ccfv @ XA2 @ ccbs)) => ((cwcel @ XM @ XB2) => ((cctpos @ (cctpos @ XM)) = XM)))))))))).
