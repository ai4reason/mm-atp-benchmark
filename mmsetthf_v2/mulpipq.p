...
thf(amulpipq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccxp @ ccnpi @ ccnpi)) & (cwcel @ XB2 @ (ccxp @ ccnpi @ ccnpi))) => ((cco @ XA2 @ XB2 @ ccmpq) = (ccop @ (cco @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XB2 @ cc1st) @ ccmi) @ (cco @ (ccfv @ XA2 @ cc2nd) @ (ccfv @ XB2 @ cc2nd) @ ccmi))))))).
...
thf(cmulpipq_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccnpi) & (cwcel @ XB2 @ ccnpi)) & ((cwcel @ XC @ ccnpi) & (cwcel @ XD @ ccnpi))) => ((cco @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ ccmpq) = (ccop @ (cco @ XA2 @ XC @ ccmi) @ (cco @ XB2 @ XD @ ccmi))))))))).
