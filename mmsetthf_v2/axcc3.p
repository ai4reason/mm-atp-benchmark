...
thf(caxcc3_conj,conjecture,(! [XF:($i > ($i > $o))] : (! [XN:($i > $o)] : ((! [Xn:$i] : (cwcel @ (XF @ Xn) @ ccvv)) => ((cwbr @ XN @ ccom @ ccen) => (? [Xf1:$i] : ((cwfn @ (ccv @ Xf1) @ XN) & (cwral @ (^ [Xn:$i] : ((cwne @ (XF @ Xn) @ cc0) => (cwcel @ (ccfv @ (ccv @ Xn) @ (ccv @ Xf1)) @ (XF @ Xn)))) @ (^ [Xn:$i] : XN))))))))).
