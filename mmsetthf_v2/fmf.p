...
thf(cfmf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((cw3a @ (cwcel @ XX @ XA2) @ (cwcel @ XY @ XB2) @ (cwf @ XY @ XX @ XF)) => (cwf @ (ccfv @ XY @ ccfbas) @ (ccfv @ XX @ ccfil) @ (cco @ XX @ XF @ ccfm))))))))).
