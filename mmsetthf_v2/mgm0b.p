...
thf(amgm0_ax,axiom,(! [XM:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XM @ XV) & ((ccfv @ XM @ ccbs) = cc0)) => (cwcel @ XM @ ccmgm))))).
thf(cmgm0b_conj,conjecture,(! [XO:($i > $o)] : (cwcel @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccbs) @ cc0) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ XO)) @ ccmgm))).
