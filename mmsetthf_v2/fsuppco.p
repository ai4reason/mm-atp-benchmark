...
thf(acofunex2g_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ XV) & (cwfun @ (cccnv @ XB2))) => (cwcel @ (cccom @ XA2 @ XB2) @ ccvv)))))).
...
thf(afsuppcolem_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ (ccima @ (cccnv @ XF) @ (ccdif @ ccvv @ (ccsn @ XZ))) @ ccfn)) => ((Xph => (cwf1 @ XX @ XY @ XG)) => (Xph => (cwcel @ (ccima @ (cccnv @ (cccom @ XF @ XG)) @ (ccdif @ ccvv @ (ccsn @ XZ))) @ ccfn))))))))))).
...
thf(cfsuppco_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwbr @ XF @ XZ @ ccfsupp)) => ((Xph => (cwf1 @ XX @ XY @ XG)) => ((Xph => (cwcel @ XZ @ XW)) => ((Xph => (cwcel @ XF @ XV)) => (Xph => (cwbr @ (cccom @ XF @ XG) @ XZ @ ccfsupp))))))))))))))).
