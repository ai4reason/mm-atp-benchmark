...
thf(clcmfledvds_conj,conjecture,(! [XK:($i > $o)] : (! [XZ:($i > $o)] : ((cw3a @ (cwss @ XZ @ ccz) @ (cwcel @ XZ @ ccfn) @ (cwnel @ ccc0 @ XZ)) => (((cwcel @ XK @ ccn) & (cwral @ (^ [Xm:$i] : (cwbr @ (ccv @ Xm) @ XK @ ccdvds)) @ (^ [Xm:$i] : XZ))) => (cwbr @ (ccfv @ XZ @ cclcmf) @ XK @ ccle)))))).
