...
thf(apm2_61da3ne_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (((Xph & (XA2 = XB2)) => Xps) => (((Xph & (XC = XD)) => Xps) => (((Xph & (XE = XF)) => Xps) => (((Xph & (cw3a @ (cwne @ XA2 @ XB2) @ (cwne @ XC @ XD) @ (cwne @ XE @ XF))) => Xps) => (Xph => Xps)))))))))))))).
...
thf(ctrljco_conj,conjecture,(! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [XW:($i > $o)] : ((Xc_or = (ccfv @ XK @ ccjn)) => ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XR = (ccfv @ XW @ (ccfv @ XK @ cctrl))) => ((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ (cwcel @ XF @ XT) @ (cwcel @ XG @ XT)) => ((cco @ (ccfv @ XF @ XR) @ (ccfv @ (cccom @ XF @ XG) @ XR) @ Xc_or) = (cco @ (ccfv @ XF @ XR) @ (ccfv @ XG @ XR) @ Xc_or)))))))))))))))).
