...
thf(aodmod_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XX) @ (cwcel @ XN @ ccz)) & (cwcel @ (ccfv @ XA2 @ XO) @ ccn)) => ((cco @ (cco @ XN @ (ccfv @ XA2 @ XO) @ ccmo) @ XA2 @ Xc_x) = (cco @ XN @ XA2 @ Xc_x))))))))))))))).
...
thf(aodnncl_ax,axiom,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => (((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XX) @ (cwcel @ XN @ ccz)) & ((cwne @ XN @ ccc0) & ((cco @ XN @ XA2 @ Xc_x) = Xc_0))) => (cwcel @ (ccfv @ XA2 @ XO) @ ccn)))))))))))))).
...
thf(coddvds_conj,conjecture,(! [XA2:($i > $o)] : (! [Xc_x:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XO:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((XO = (ccfv @ XG @ ccod)) => ((Xc_x = (ccfv @ XG @ ccmg)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XA2 @ XX) @ (cwcel @ XN @ ccz)) => ((cwbr @ (ccfv @ XA2 @ XO) @ XN @ ccdvds) <=> ((cco @ XN @ XA2 @ Xc_x) = Xc_0))))))))))))))).
