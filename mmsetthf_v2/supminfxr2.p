...
thf(ainfxrmnf_ax,axiom,(! [XA2:($i > $o)] : (((cwss @ XA2 @ ccxr) & (cwcel @ ccmnf @ XA2)) => ((ccinf @ XA2 @ ccxr @ cclt) = ccmnf)))).
thf(ccc_tp,type,(ccc : ($i > $o))).
thf(cw3a_tp,type,(cw3a : ($o > ($o > ($o > $o))))).
thf(cc0_tp,type,(cc0 : ($i > $o))).
thf(asupminfxr_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : ((! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ XA2 @ ccr))) => (! [Xx3:$i] : ((Xph @ Xx3) => ((ccsup @ XA2 @ ccxr @ cclt) = (ccxne @ (ccinf @ (ccrab @ (^ [Xx3:$i] : (cwcel @ (ccneg @ (ccv @ Xx3)) @ XA2)) @ (^ [Xx3:$i] : ccr)) @ ccxr @ cclt))))))))).
thf(cw3o_tp,type,(cw3o : ($o > ($o > ($o > $o))))).
thf(axrssre_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwss @ XA2 @ ccxr)) => ((Xph => (~ (cwcel @ ccpnf @ XA2))) => ((Xph => (~ (cwcel @ ccmnf @ XA2))) => (Xph => (cwss @ XA2 @ ccr)))))))).
...
thf(asupxrmnf2_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => ((ccsup @ (ccdif @ XA2 @ (ccsn @ ccmnf)) @ ccxr @ cclt) = (ccsup @ XA2 @ ccxr @ cclt))))).
...
thf(assdf2_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : ((cwnf @ (^ [Xx3:$i] : (Xph @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => ((! [Xx3:$i] : (((Xph @ Xx3) & (cwcel @ (ccv @ Xx3) @ (XA2 @ Xx3))) => (cwcel @ (ccv @ Xx3) @ (XB2 @ Xx3)))) => (! [Xx3:$i] : ((Xph @ Xx3) => (cwss @ (XA2 @ Xx3) @ (XB2 @ Xx3)))))))))))).
...
thf(ainfxrpnf2_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ ccxr) => ((ccinf @ (ccdif @ XA2 @ (ccsn @ ccpnf)) @ ccxr @ cclt) = (ccinf @ XA2 @ ccxr @ cclt))))).
