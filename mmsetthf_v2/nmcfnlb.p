...
thf(anmcfnlbi_ax,axiom,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XT @ cclf) => ((cwcel @ XT @ cccnfn) => ((cwcel @ XA2 @ cchil) => (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ ccabs) @ (cco @ (ccfv @ XT @ ccnmf) @ (ccfv @ XA2 @ ccno) @ ccmul) @ ccle))))))).
...
thf(a_0cnfn_ax,axiom,(cwcel @ (ccxp @ cchil @ (ccsn @ ccc0)) @ cccnfn)).
thf(asimpri_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xph & Xps) => Xps)))).
thf(cnmcfnlb_conj,conjecture,(! [XA2:($i > $o)] : (! [XT:($i > $o)] : ((cw3a @ (cwcel @ XT @ cclf) @ (cwcel @ XT @ cccnfn) @ (cwcel @ XA2 @ cchil)) => (cwbr @ (ccfv @ (ccfv @ XA2 @ XT) @ ccabs) @ (cco @ (ccfv @ XT @ ccnmf) @ (ccfv @ XA2 @ ccno) @ ccmul) @ ccle))))).
