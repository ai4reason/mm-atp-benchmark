...
thf(aodzid_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccz) @ ((cco @ XA2 @ XN @ ccgcd) = cc1)) => (cwbr @ XN @ (cco @ (cco @ XA2 @ (ccfv @ XA2 @ (ccfv @ XN @ ccodz)) @ ccexp) @ cc1 @ ccmin) @ ccdvds))))).
...
thf(codzdvds_conj,conjecture,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccz) @ ((cco @ XA2 @ XN @ ccgcd) = cc1)) & (cwcel @ XK @ ccn0)) => ((cwbr @ XN @ (cco @ (cco @ XA2 @ XK @ ccexp) @ cc1 @ ccmin) @ ccdvds) <=> (cwbr @ (ccfv @ XA2 @ (ccfv @ XN @ ccodz)) @ XK @ ccdvds))))))).
