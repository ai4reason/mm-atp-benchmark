...
thf(ccsuccf_tp,type,(ccsuccf : ($i > $o))).
...
thf(adf_succf_ax,axiom,(ccsuccf = (cccom @ cccup @ (cctxp @ ccid @ ccsingle)))).
...
thf(abrcup_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwbr @ (ccop @ XA2 @ XB2) @ XC @ cccup) <=> (XC = (ccun @ XA2 @ XB2)))))))))).
...
thf(cbrsuccf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwbr @ XA2 @ XB2 @ ccsuccf) <=> (XB2 = (ccsuc @ XA2)))))))).
