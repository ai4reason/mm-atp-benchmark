...
thf(ajoiniooico_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) & ((cwbr @ XA2 @ XB2 @ cclt) & (cwbr @ XB2 @ XC @ ccle))) => (((ccin @ (cco @ XA2 @ XB2 @ ccioo) @ (cco @ XB2 @ XC @ ccico)) = cc0) & ((ccun @ (cco @ XA2 @ XB2 @ ccioo) @ (cco @ XB2 @ XC @ ccico)) = (cco @ XA2 @ XC @ ccioo)))))))).
...
thf(adifeq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((ccdif @ XA2 @ XB2) = XC) <=> (((ccin @ XC @ XB2) = cc0) & ((ccun @ XC @ XB2) = (ccun @ XA2 @ XB2)))))))).
...
thf(axrlelttric_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccxr) & (cwcel @ XB2 @ ccxr)) => ((cwbr @ XA2 @ XB2 @ ccle) | (cwbr @ XB2 @ XA2 @ cclt)))))).
thf(cdifioo_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cw3a @ (cwcel @ XA2 @ ccxr) @ (cwcel @ XB2 @ ccxr) @ (cwcel @ XC @ ccxr)) & (cwbr @ XA2 @ XB2 @ cclt)) => ((ccdif @ (cco @ XA2 @ XC @ ccioo) @ (cco @ XA2 @ XB2 @ ccioo)) = (cco @ XB2 @ XC @ ccico))))))).
