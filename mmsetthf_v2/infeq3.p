...
thf(asupeq3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((XR = XS) => ((ccsup @ XA2 @ XB2 @ XR) = (ccsup @ XA2 @ XB2 @ XS)))))))).
thf(adf_inf_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((ccinf @ XA2 @ XB2 @ XR) = (ccsup @ XA2 @ XB2 @ (cccnv @ XR))))))).
thf(cinfeq3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : ((XR = XS) => ((ccinf @ XA2 @ XB2 @ XR) = (ccinf @ XA2 @ XB2 @ XS)))))))).
