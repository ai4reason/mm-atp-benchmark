...
thf(cislss3_conj,conjecture,(! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ XW @ XU @ ccress)) => ((XV = (ccfv @ XW @ ccbs)) => ((XS = (ccfv @ XW @ cclss)) => ((cwcel @ XW @ cclmod) => ((cwcel @ XU @ XS) <=> ((cwss @ XU @ XV) & (cwcel @ XX @ cclmod))))))))))))).
