...
thf(cmpt2mptsx_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > ($i > $o)))] : ((ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : XA2)) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XB2 @ Xx3))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (XC @ Xx3 @ Xy1)))) = (ccmpt @ (^ [Xz:$i] : (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccxp @ (ccsn @ (ccv @ Xx3)) @ (XB2 @ Xx3))))) @ (^ [Xz:$i] : (ccsb @ (ccfv @ (ccv @ Xz) @ cc1st) @ (^ [Xx3:$i] : (ccsb @ (ccfv @ (ccv @ Xz) @ cc2nd) @ (^ [Xy1:$i] : (XC @ Xx3 @ Xy1)))))))))))).
