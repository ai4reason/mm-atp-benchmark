...
thf(adchrpt_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XG = (ccfv @ XN @ ccdchr)) => ((XZ = (ccfv @ XN @ cczn)) => ((XD = (ccfv @ XG @ ccbs)) => ((XB2 = (ccfv @ XZ @ ccbs)) => ((Xc_1 = (ccfv @ XZ @ ccur)) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwne @ XA2 @ Xc_1)) => ((Xph => (cwcel @ XA2 @ XB2)) => (Xph => (cwrex @ (^ [Xx3:$i] : (cwne @ (ccfv @ XA2 @ (ccv @ Xx3)) @ cc1)) @ (^ [Xx3:$i] : XD)))))))))))))))))))).
