...
thf(alnopeq0i_ax,axiom,(! [XT:($i > $o)] : ((cwcel @ XT @ cclo) => ((cwral @ (^ [Xx3:$i] : ((cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xx3) @ ccsp) = ccc0)) @ (^ [Xx3:$i] : cchil)) <=> (XT = cch0o))))).
thf(cchos_tp,type,(cchos : ($i > $o))).
thf(cchot_tp,type,(cchot : ($i > $o))).
thf(alnophdi_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : ((cwcel @ XS @ cclo) => ((cwcel @ XT @ cclo) => (cwcel @ (cco @ XS @ XT @ cchod) @ cclo)))))).
thf(ahosubeq0i_ax,axiom,(! [XT:($i > $o)] : (! [XU:($i > $o)] : ((cwf @ cchil @ cchil @ XT) => ((cwf @ cchil @ cchil @ XU) => (((cco @ XT @ XU @ cchod) = cch0o) <=> (XT = XU))))))).
thf(clnopeqi_conj,conjecture,(! [XT:($i > $o)] : (! [XU:($i > $o)] : ((cwcel @ XT @ cclo) => ((cwcel @ XU @ cclo) => ((cwral @ (^ [Xx3:$i] : ((cco @ (ccfv @ (ccv @ Xx3) @ XT) @ (ccv @ Xx3) @ ccsp) = (cco @ (ccfv @ (ccv @ Xx3) @ XU) @ (ccv @ Xx3) @ ccsp))) @ (^ [Xx3:$i] : cchil)) <=> (XT = XU))))))).
