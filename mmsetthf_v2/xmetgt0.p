...
thf(cxmetgt0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XD @ (ccfv @ XX @ ccxmt)) @ (cwcel @ XA2 @ XX) @ (cwcel @ XB2 @ XX)) => ((cwne @ XA2 @ XB2) <=> (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ XD) @ cclt)))))))).
