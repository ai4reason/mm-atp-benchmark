...
thf(abj_subcom_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => (Xph => ((cco @ (cco @ XA2 @ XB2 @ ccmul) @ (cco @ XB2 @ XA2 @ ccmul) @ ccmin) = ccc0)))))))).
...
thf(cbj_bary1lem_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (cwne @ XA2 @ XB2)) => (Xph => (XX = (cco @ (cco @ (cco @ (cco @ XB2 @ XX @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ ccdiv) @ XA2 @ ccmul) @ (cco @ (cco @ (cco @ XX @ XA2 @ ccmin) @ (cco @ XB2 @ XA2 @ ccmin) @ ccdiv) @ XB2 @ ccmul) @ ccaddc)))))))))))).
