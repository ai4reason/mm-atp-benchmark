...
thf(afunpartlem_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ (ccdm @ (ccin @ (cccom @ (ccimage @ XF) @ ccsingle) @ (ccxp @ ccvv @ ccsingles)))) <=> (? [Xx3:$i] : ((ccima @ XF @ (ccsn @ XA2)) = (ccsn @ (ccv @ Xx3)))))))).
...
thf(cfunpartfun_conj,conjecture,(! [XF:($i > $o)] : (cwfun @ (ccfunpart @ XF)))).
