...
thf(aisgbo_ax,axiom,(! [XZ:($i > $o)] : ((cwcel @ XZ @ ccgbo) <=> ((cwcel @ XZ @ ccodd) & (cwrex @ (^ [Xp:$i] : (cwrex @ (^ [Xq:$i] : (cwrex @ (^ [Xr:$i] : ((cw3a @ (cwcel @ (ccv @ Xp) @ ccodd) @ (cwcel @ (ccv @ Xq) @ ccodd) @ (cwcel @ (ccv @ Xr) @ ccodd)) & (XZ = (cco @ (cco @ (ccv @ Xp) @ (ccv @ Xq) @ ccaddc) @ (ccv @ Xr) @ ccaddc)))) @ (^ [Xr:$i] : ccprime))) @ (^ [Xq:$i] : ccprime))) @ (^ [Xp:$i] : ccprime)))))).
...
thf(aftp_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwcel @ XX @ ccvv) => ((cwcel @ XY @ ccvv) => ((cwcel @ XZ @ ccvv) => ((cwne @ XA2 @ XB2) => ((cwne @ XA2 @ XC) => ((cwne @ XB2 @ XC) => (cwf @ (cctp @ XA2 @ XB2 @ XC) @ (cctp @ XX @ XY @ XZ) @ (cctp @ (ccop @ XA2 @ XX) @ (ccop @ XB2 @ XY) @ (ccop @ XC @ XZ))))))))))))))))))).
...
thf(afztp_ax,axiom,(! [XM:($i > $o)] : ((cwcel @ XM @ ccz) => ((cco @ XM @ (cco @ XM @ cc2 @ ccaddc) @ ccfz) = (cctp @ XM @ (cco @ XM @ cc1 @ ccaddc) @ (cco @ XM @ cc2 @ ccaddc)))))).
...
thf(asumtp_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((! [Xk:$i] : (((ccv @ Xk) = XA2) => ((XD @ Xk) = XE))) => ((! [Xk:$i] : (((ccv @ Xk) = XB2) => ((XD @ Xk) = XF))) => ((! [Xk:$i] : (((ccv @ Xk) = XC) => ((XD @ Xk) = XG))) => ((Xph => (cw3a @ (cwcel @ XE @ ccc) @ (cwcel @ XF @ ccc) @ (cwcel @ XG @ ccc))) => ((Xph => (cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XB2 @ XW) @ (cwcel @ XC @ XX))) => ((Xph => (cwne @ XA2 @ XB2)) => ((Xph => (cwne @ XA2 @ XC)) => ((Xph => (cwne @ XB2 @ XC)) => (Xph => ((ccsu @ (cctp @ XA2 @ XB2 @ XC) @ (^ [Xk:$i] : (XD @ Xk))) = (cco @ (cco @ XE @ XF @ ccaddc) @ XG @ ccaddc))))))))))))))))))))))).
thf(asyl6eq_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (XA2 = XB2)) => ((XB2 = XC) => (Xph => (XA2 = XC))))))))).
thf(afveq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = XB2) => ((ccfv @ XA2 @ XF) = (ccfv @ XB2 @ XF))))))).
thf(amp2an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (Xph => (Xps => (((Xph & Xps) => Xch) => Xch))))))).
thf(afvtp1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XD @ ccvv) => (((cwne @ XA2 @ XB2) & (cwne @ XA2 @ XC)) => ((ccfv @ XA2 @ (cctp @ (ccop @ XA2 @ XD) @ (ccop @ XB2 @ XE) @ (ccop @ XC @ XF))) = XD))))))))))).
thf(afvtp2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XB2 @ ccvv) => ((cwcel @ XE @ ccvv) => (((cwne @ XA2 @ XB2) & (cwne @ XB2 @ XC)) => ((ccfv @ XB2 @ (cctp @ (ccop @ XA2 @ XD) @ (ccop @ XB2 @ XE) @ (ccop @ XC @ XF))) = XE))))))))))).
thf(afvtp3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : ((cwcel @ XC @ ccvv) => ((cwcel @ XF @ ccvv) => (((cwne @ XA2 @ XC) & (cwne @ XB2 @ XC)) => ((ccfv @ XC @ (cctp @ (ccop @ XA2 @ XD) @ (ccop @ XB2 @ XE) @ (ccop @ XC @ XF))) = XF))))))))))).
...
thf(cnnsum4primesoddALTV_conj,conjecture,(! [XN:($i > $o)] : ((cwral @ (^ [Xm:$i] : ((cwbr @ cc7 @ (ccv @ Xm) @ cclt) => (cwcel @ (ccv @ Xm) @ ccgbo))) @ (^ [Xm:$i] : ccodd)) => (((cwcel @ XN @ (ccfv @ cc8 @ ccuz)) & (cwcel @ XN @ ccodd)) => (cwrex @ (^ [Xf1:$i] : (XN = (ccsu @ (cco @ cc1 @ cc3 @ ccfz) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (ccv @ Xf1)))))) @ (^ [Xf1:$i] : (cco @ ccprime @ (cco @ cc1 @ cc3 @ ccfz) @ ccmap))))))).
