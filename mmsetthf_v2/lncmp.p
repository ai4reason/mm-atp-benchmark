...
thf(clncmp_conj,conjecture,(! [XB2:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XN = (ccfv @ XK @ cclines)) => ((XM = (ccfv @ XK @ ccpmap)) => (((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XB2) @ (cwcel @ XY @ XB2)) & ((cwcel @ (ccfv @ XX @ XM) @ XN) & (cwcel @ (ccfv @ XY @ XM) @ XN))) => ((cwbr @ XX @ XY @ Xc_le) <=> (XX = XY))))))))))))))).
