...
thf(akgenval_ax,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XX @ cctopon)) => ((ccfv @ XJ @ cckgen) = (ccrab @ (^ [Xx3:$i] : (cwral @ (^ [Xk:$i] : ((cwcel @ (cco @ XJ @ (ccv @ Xk) @ ccrest) @ cccmp) => (cwcel @ (ccin @ (ccv @ Xx3) @ (ccv @ Xk)) @ (cco @ XJ @ (ccv @ Xk) @ ccrest)))) @ (^ [Xk:$i] : (ccpw @ XX)))) @ (^ [Xx3:$i] : (ccpw @ XX)))))))).
...
thf(aiunopn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XJ:($i > $o)] : (((cwcel @ XJ @ cctop) & (cwral @ (^ [Xx3:$i] : (cwcel @ (XB2 @ Xx3) @ XJ)) @ (^ [Xx3:$i] : XA2))) => (cwcel @ (cciun @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) @ XJ)))))).
...
thf(ckgentopon_conj,conjecture,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XX @ cctopon)) => (cwcel @ (ccfv @ XJ @ cckgen) @ (ccfv @ XX @ cctopon)))))).
