...
thf(aswrds2m_ax,axiom,(! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XW @ (ccword @ XV)) & (cwcel @ XN @ (cco @ cc2 @ (ccfv @ XW @ cchash) @ ccfz))) => ((cco @ XW @ (ccop @ (cco @ XN @ cc2 @ ccmin) @ XN) @ ccsubstr) = (ccs2 @ (ccfv @ (cco @ XN @ cc2 @ ccmin) @ XW) @ (ccfv @ (cco @ XN @ cc1 @ ccmin) @ XW)))))))).
...
thf(as2elclwwlknon2_ax,axiom,(! [XC:($i > $o)] : (! [XE:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XC = (ccfv @ XG @ ccclwwlknon)) => ((XV = (ccfv @ XG @ ccvtx)) => ((XE = (ccfv @ XG @ ccedg)) => ((cw3a @ (cwcel @ XX @ XV) @ (cwcel @ XY @ XV) @ (cwcel @ (ccpr @ XX @ XY) @ XE)) => (cwcel @ (ccs2 @ XX @ XY) @ (cco @ XX @ cc2 @ XC))))))))))))).
thf(c_2clwwlk2clwwlklem_conj,conjecture,(! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwcel @ XN @ (ccfv @ cc3 @ ccuz)) @ (cwcel @ XW @ (cco @ XX @ XN @ (ccfv @ XG @ ccclwwlknon))) @ ((ccfv @ (cco @ XN @ cc2 @ ccmin) @ XW) = (ccfv @ ccc0 @ XW))) => (cwcel @ (cco @ XW @ (ccop @ (cco @ XN @ cc2 @ ccmin) @ XN) @ ccsubstr) @ (cco @ XX @ cc2 @ (ccfv @ XG @ ccclwwlknon))))))))).
