...
thf(cchrelati_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccch) => ((cwcel @ XB2 @ ccch) => ((cwpss @ XA2 @ XB2) => (cwrex @ (^ [Xx3:$i] : ((cwpss @ XA2 @ (cco @ XA2 @ (ccv @ Xx3) @ cchj)) & (cwss @ (cco @ XA2 @ (ccv @ Xx3) @ cchj) @ XB2))) @ (^ [Xx3:$i] : ccat)))))))).
