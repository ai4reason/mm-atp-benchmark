...
thf(aioovolcl_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccr) & (cwcel @ XB2 @ ccr)) => (cwcel @ (ccfv @ (cco @ XA2 @ XB2 @ ccioo) @ ccvol) @ ccr))))).
...
thf(advef_ax,axiom,((cco @ ccc @ cce @ ccdv) = cce)).
...
thf(aef2kpi_ax,axiom,(! [XK:($i > $o)] : ((cwcel @ XK @ ccz) => ((ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ XK @ ccmul) @ cce) = cc1)))).
...
thf(citgexpif_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((ccitg @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccioo)) @ (^ [Xx3:$i] : (ccfv @ (cco @ (cco @ cci @ (cco @ cc2 @ ccpi @ ccmul) @ ccmul) @ (cco @ XN @ (ccv @ Xx3) @ ccmul) @ ccmul) @ cce))) = (ccif @ (XN = ccc0) @ cc1 @ ccc0))))).
