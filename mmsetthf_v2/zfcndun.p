...
thf(aaxunnd_ax,axiom,(! [Xz:$i] : (? [Xx3:$i] : (! [Xy1:$i] : ((? [Xx3:$i] : ((cwcel @ (ccv @ Xy1) @ (ccv @ Xx3)) & (cwcel @ (ccv @ Xx3) @ (ccv @ Xz)))) => (cwcel @ (ccv @ Xy1) @ (ccv @ Xx3))))))).
...
thf(czfcndun_conj,conjecture,(! [Xx3:$i] : (? [Xy1:$i] : (! [Xz:$i] : ((? [Xw:$i] : ((cwcel @ (ccv @ Xz) @ (ccv @ Xw)) & (cwcel @ (ccv @ Xw) @ (ccv @ Xx3)))) => (cwcel @ (ccv @ Xz) @ (ccv @ Xy1))))))).
