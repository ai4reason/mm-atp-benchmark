...
thf(auz2mulcl_ax,axiom,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XM @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ (ccfv @ cc2 @ ccuz))) => (cwcel @ (cco @ XM @ XN @ ccmul) @ (ccfv @ cc2 @ ccuz)))))).
...
thf(arpexpmord_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccn) @ (cwcel @ XA2 @ ccrp) @ (cwcel @ XB2 @ ccrp)) => ((cwbr @ XA2 @ XB2 @ cclt) <=> (cwbr @ (cco @ XA2 @ XN @ ccexp) @ (cco @ XB2 @ XN @ ccexp) @ cclt))))))).
...
thf(ajm2_17a_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (((cwcel @ XA2 @ (ccfv @ cc2 @ ccuz)) & (cwcel @ XN @ ccn0)) => (cwbr @ (cco @ (cco @ (cco @ cc2 @ XA2 @ ccmul) @ cc1 @ ccmin) @ XN @ ccexp) @ (cco @ XA2 @ (cco @ XN @ cc1 @ ccaddc) @ ccrmy) @ ccle))))).
thf(cjm3_1lem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XA2 @ (ccfv @ cc2 @ ccuz))) => ((Xph => (cwcel @ XK @ (ccfv @ cc2 @ ccuz))) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwbr @ (cco @ XK @ (cco @ XN @ cc1 @ ccaddc) @ ccrmy) @ XA2 @ ccle)) => (Xph => (cwbr @ (cco @ XK @ XN @ ccexp) @ XA2 @ cclt))))))))))).
