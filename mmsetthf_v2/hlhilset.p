...
thf(adf_hlhil_ax,axiom,(cchlh = (ccmpt @ (^ [Xk:$i] : ccvv) @ (^ [Xk:$i] : (ccmpt @ (^ [Xw:$i] : (ccfv @ (ccv @ Xk) @ cclh)) @ (^ [Xw:$i] : (ccsb @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccdvh)) @ (^ [Xu:$i] : (ccsb @ (ccfv @ (ccv @ Xu) @ ccbs) @ (^ [Xv:$i] : (ccun @ (cctp @ (ccop @ (ccfv @ ccnx @ ccbs) @ (ccv @ Xv)) @ (ccop @ (ccfv @ ccnx @ ccplusg) @ (ccfv @ (ccv @ Xu) @ ccplusg)) @ (ccop @ (ccfv @ ccnx @ ccsca) @ (cco @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ ccedring)) @ (ccop @ (ccfv @ ccnx @ ccstv) @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ cchg))) @ ccsts))) @ (ccpr @ (ccop @ (ccfv @ ccnx @ ccvsca) @ (ccfv @ (ccv @ Xu) @ ccvsca)) @ (ccop @ (ccfv @ ccnx @ ccip) @ (ccmpt2 @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xv))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccv @ Xv))) @ (^ [Xx3:$i] : (^ [Xy1:$i] : (ccfv @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xy1) @ (ccfv @ (ccv @ Xw) @ (ccfv @ (ccv @ Xk) @ cchdma)))))))))))))))))))).
