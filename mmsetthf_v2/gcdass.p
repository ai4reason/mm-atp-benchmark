...
thf(cgcdass_conj,conjecture,(! [XP:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ ccz) @ (cwcel @ XM @ ccz) @ (cwcel @ XP @ ccz)) => ((cco @ (cco @ XN @ XM @ ccgcd) @ XP @ ccgcd) = (cco @ XN @ (cco @ XM @ XP @ ccgcd) @ ccgcd))))))).
