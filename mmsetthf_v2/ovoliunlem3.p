...
thf(aovoliunlem2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > ($i > $o))] : (! [XJ:($i > $o)] : ((XT = (ccseq @ ccaddc @ XG @ cc1)) => ((XG = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (XA2 @ Xn) @ ccovol)))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwss @ (XA2 @ Xn) @ ccr))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwcel @ (ccfv @ (XA2 @ Xn) @ ccovol) @ ccr))) => ((Xph => (cwcel @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ ccr)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((! [Xn:$i] : ((XS @ Xn) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (ccfv @ (ccv @ Xn) @ XF)) @ cc1))) => ((! [Xk:$i] : (! [Xn:$i] : ((XU @ Xk @ Xn) = (ccseq @ ccaddc @ (cccom @ (cccom @ ccabs @ ccmin) @ (XH @ Xk)) @ cc1)))) => ((! [Xk:$i] : ((XH @ Xk) = (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccfv @ (ccv @ Xk) @ XJ) @ cc2nd) @ (ccfv @ (ccfv @ (ccfv @ (ccv @ Xk) @ XJ) @ cc1st) @ XF)))))) => ((Xph => (cwf1o @ ccn @ (ccxp @ ccn @ ccn) @ XJ)) => ((Xph => (cwf @ ccn @ (cco @ (ccin @ ccle @ (ccxp @ ccr @ ccr)) @ ccn @ ccmap) @ XF)) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwss @ (XA2 @ Xn) @ (ccuni @ (ccrn @ (cccom @ ccioo @ (ccfv @ (ccv @ Xn) @ XF))))))) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccn)) => (cwbr @ (ccsup @ (ccrn @ (XS @ Xn)) @ ccxr @ cclt) @ (cco @ (ccfv @ (XA2 @ Xn) @ ccovol) @ (cco @ XB2 @ (cco @ cc2 @ (ccv @ Xn) @ ccexp) @ ccdiv) @ ccaddc) @ ccle))) => (Xph => (cwbr @ (ccfv @ (cciun @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccovol) @ (cco @ (ccsup @ (ccrn @ XT) @ ccxr @ cclt) @ XB2 @ ccaddc) @ ccle)))))))))))))))))))))))))).
