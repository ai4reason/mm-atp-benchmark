...
thf(alsatcvatlem_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XU:($i > $o)] : (! [XW:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XS = (ccfv @ XW @ cclss)) => ((Xc_po = (ccfv @ XW @ cclsm)) => ((XA2 = (ccfv @ XW @ cclsa)) => ((Xph => (cwcel @ XW @ cclvec)) => ((Xph => (cwcel @ XU @ XS)) => ((Xph => (cwcel @ XQ @ XA2)) => ((Xph => (cwcel @ XR @ XA2)) => ((Xph => (cwne @ XU @ (ccsn @ Xc_0))) => ((Xph => (cwpss @ XU @ (cco @ XQ @ XR @ Xc_po))) => ((Xph => (~ (cwss @ XQ @ XU))) => (Xph => (cwcel @ XU @ XA2))))))))))))))))))))))).
