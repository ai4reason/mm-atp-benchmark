...
thf(ameadif_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccmea)) => ((Xph => (cwcel @ XA2 @ (ccdm @ XM))) => ((Xph => (cwcel @ (ccfv @ XA2 @ XM) @ ccr)) => ((Xph => (cwcel @ XB2 @ (ccdm @ XM))) => ((Xph => (cwss @ XB2 @ XA2)) => (Xph => ((ccfv @ (ccdif @ XA2 @ XB2) @ XM) = (cco @ (ccfv @ XA2 @ XM) @ (ccfv @ XB2 @ XM) @ ccmin))))))))))))).
thf(cclt_tp,type,(cclt : ($i > $o))).
thf(assdec_ax,axiom,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => ((! [Xm:$i] : ((Xph & (cwcel @ (ccv @ Xm) @ (cco @ XM @ XN @ ccfzo))) => (cwss @ (ccfv @ (cco @ (ccv @ Xm) @ cc1 @ ccaddc) @ XF) @ (ccfv @ (ccv @ Xm) @ XF)))) => (Xph => (cwss @ (ccfv @ XN @ XF) @ (ccfv @ XM @ XF)))))))))).
...
thf(ameassre_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccmea)) => ((Xph => (cwcel @ XA2 @ (ccdm @ XM))) => ((Xph => (cwcel @ (ccfv @ XA2 @ XM) @ ccr)) => ((Xph => (cwss @ XB2 @ XA2)) => ((Xph => (cwcel @ XB2 @ (ccdm @ XM))) => (Xph => (cwcel @ (ccfv @ XB2 @ XM) @ ccr)))))))))))).
thf(cwnf_tp,type,(cwnf : (($i > $o) > $o))).
thf(aclimsubc1mpt_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XM:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((cwnf @ (^ [Xk:$i] : (Xph @ Xk))) => ((! [Xk:$i] : (XZ = (ccfv @ (XM @ Xk) @ ccuz))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XM @ Xk) @ ccz))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XA2 @ ccc))) => ((! [Xk:$i] : (((Xph @ Xk) & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (XB2 @ Xk) @ ccc))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (XB2 @ Xk))) @ (XC @ Xk) @ ccli))) => (! [Xk:$i] : ((Xph @ Xk) => (cwbr @ (ccmpt @ (^ [Xk:$i] : XZ) @ (^ [Xk:$i] : (cco @ XA2 @ (XB2 @ Xk) @ ccmin))) @ (cco @ XA2 @ (XC @ Xk) @ ccmin) @ ccli)))))))))))))))).
thf(anfv_ax,axiom,(! [Xph:$o] : (cwnf @ (^ [Xx3:$i] : Xph)))).
thf(aeluzelzd_ax,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((Xph => (cwcel @ XN @ (ccfv @ XM @ ccuz))) => (Xph => (cwcel @ XN @ ccz))))))).
...
thf(ameadjunre_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XM:($i > $o)] : ((Xph => (cwcel @ XM @ ccmea)) => ((XS = (ccdm @ XM)) => ((Xph => (cwcel @ XA2 @ XS)) => ((Xph => (cwcel @ XB2 @ XS)) => ((Xph => ((ccin @ XA2 @ XB2) = cc0)) => ((Xph => (cwcel @ (ccfv @ XA2 @ XM) @ ccr)) => ((Xph => (cwcel @ (ccfv @ XB2 @ XM) @ ccr)) => (Xph => ((ccfv @ (ccun @ XA2 @ XB2) @ XM) = (cco @ (ccfv @ XA2 @ XM) @ (ccfv @ XB2 @ XM) @ ccaddc)))))))))))))))).
