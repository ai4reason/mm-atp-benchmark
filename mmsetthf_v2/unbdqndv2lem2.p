...
thf(aunbdqndv2lem1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XB2 @ ccc)) => ((Xph => (cwcel @ XC @ ccc)) => ((Xph => (cwcel @ XD @ ccc)) => ((Xph => (cwcel @ XE @ ccrp)) => ((Xph => (cwne @ XD @ ccc0)) => ((Xph => (cwbr @ (cco @ cc2 @ XE @ ccmul) @ (ccfv @ (cco @ (cco @ XA2 @ XB2 @ ccmin) @ XD @ ccdiv) @ ccabs) @ ccle)) => (Xph => ((cwbr @ (cco @ XE @ (ccfv @ XD @ ccabs) @ ccmul) @ (ccfv @ (cco @ XA2 @ XC @ ccmin) @ ccabs) @ ccle) | (cwbr @ (cco @ XE @ (ccfv @ XD @ ccabs) @ ccmul) @ (ccfv @ (cco @ XB2 @ XC @ ccmin) @ ccabs) @ ccle))))))))))))))))).
...
thf(cunbdqndv2lem2_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : (! [XX:($i > $o)] : ((! [Xz:$i] : ((XG @ Xz) = (ccmpt @ (^ [Xz:$i] : (ccdif @ XX @ (ccsn @ XA2))) @ (^ [Xz:$i] : (cco @ (cco @ (ccfv @ (ccv @ Xz) @ XF) @ (ccfv @ XA2 @ XF) @ ccmin) @ (cco @ (ccv @ Xz) @ XA2 @ ccmin) @ ccdiv))))) => ((! [Xz:$i] : ((XW @ Xz) = (ccif @ (cwbr @ (cco @ XB2 @ (cco @ XV @ XU @ ccmin) @ ccmul) @ (ccfv @ (cco @ (ccfv @ XU @ XF) @ (ccfv @ XA2 @ XF) @ ccmin) @ ccabs) @ ccle) @ XU @ XV))) => ((Xph => (cwss @ XX @ ccr)) => ((Xph => (cwf @ XX @ ccc @ XF)) => ((Xph => (cwcel @ XA2 @ XX)) => ((Xph => (cwcel @ XB2 @ ccrp)) => ((! [Xz:$i] : (Xph => (cwcel @ (XD @ Xz) @ ccrp))) => ((Xph => (cwcel @ XU @ XX)) => ((Xph => (cwcel @ XV @ XX)) => ((Xph => (cwne @ XU @ XV)) => ((Xph => (cwbr @ XU @ XA2 @ ccle)) => ((Xph => (cwbr @ XA2 @ XV @ ccle)) => ((! [Xz:$i] : (Xph => (cwbr @ (cco @ XV @ XU @ ccmin) @ (XD @ Xz) @ cclt))) => ((Xph => (cwbr @ (cco @ cc2 @ XB2 @ ccmul) @ (cco @ (ccfv @ (cco @ (ccfv @ XV @ XF) @ (ccfv @ XU @ XF) @ ccmin) @ ccabs) @ (cco @ XV @ XU @ ccmin) @ ccdiv) @ ccle)) => (! [Xz:$i] : (Xph => ((cwcel @ (XW @ Xz) @ (ccdif @ XX @ (ccsn @ XA2))) & ((cwbr @ (ccfv @ (cco @ (XW @ Xz) @ XA2 @ ccmin) @ ccabs) @ (XD @ Xz) @ cclt) & (cwbr @ XB2 @ (ccfv @ (ccfv @ (XW @ Xz) @ (XG @ Xz)) @ ccabs) @ ccle)))))))))))))))))))))))))))))).
