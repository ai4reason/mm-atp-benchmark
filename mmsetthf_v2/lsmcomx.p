...
thf(clsmcomx_conj,conjecture,(! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XG:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_po = (ccfv @ XG @ cclsm)) => ((cw3a @ (cwcel @ XG @ ccabl) @ (cwss @ XT @ XB2) @ (cwss @ XU @ XB2)) => ((cco @ XT @ XU @ Xc_po) = (cco @ XU @ XT @ Xc_po))))))))))).
