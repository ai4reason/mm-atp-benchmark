...
thf(aevl1varpw_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XQ = (ccfv @ XR @ cce1)) => ((XW = (ccfv @ XR @ ccpl1)) => ((XG = (ccfv @ XW @ ccmgp)) => ((XX = (ccfv @ XR @ ccv1)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_ex = (ccfv @ XG @ ccmg)) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XN @ ccn0)) => (Xph => ((ccfv @ (cco @ XN @ XX @ Xc_ex) @ XQ) = (cco @ XN @ (ccfv @ XX @ XQ) @ (ccfv @ (ccfv @ (cco @ XR @ XB2 @ ccpws) @ ccmgp) @ ccmg)))))))))))))))))))))).
...
thf(cevl1scvarpw_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_xb:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XQ = (ccfv @ XR @ cce1)) => ((XW = (ccfv @ XR @ ccpl1)) => ((XG = (ccfv @ XW @ ccmgp)) => ((XX = (ccfv @ XR @ ccv1)) => ((XB2 = (ccfv @ XR @ ccbs)) => ((Xc_ex = (ccfv @ XG @ ccmg)) => ((Xph => (cwcel @ XR @ cccrg)) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xc_xp = (ccfv @ XW @ ccvsca)) => ((Xph => (cwcel @ XA2 @ XB2)) => ((XS = (cco @ XR @ XB2 @ ccpws)) => ((Xc_xb = (ccfv @ XS @ ccmulr)) => ((XM = (ccfv @ XS @ ccmgp)) => ((XF = (ccfv @ XM @ ccmg)) => (Xph => ((ccfv @ (cco @ XA2 @ (cco @ XN @ XX @ Xc_ex) @ Xc_xp) @ XQ) = (cco @ (ccxp @ XB2 @ (ccsn @ XA2)) @ (cco @ XN @ (ccfv @ XX @ XQ) @ XF) @ Xc_xb))))))))))))))))))))))))))))))))).
