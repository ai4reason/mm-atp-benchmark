...
thf(clmodvneg1_conj,conjecture,(! [Xc_x:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ ccminusg)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xc_x = (ccfv @ XW @ ccvsca)) => ((Xc_1 = (ccfv @ XF @ ccur)) => ((XM = (ccfv @ XF @ ccminusg)) => (((cwcel @ XW @ cclmod) & (cwcel @ XX @ XV)) => ((cco @ (ccfv @ Xc_1 @ XM) @ XX @ Xc_x) = (ccfv @ XX @ XN)))))))))))))))))).
