...
thf(abj_evalval_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XF @ XV) => ((ccfv @ XF @ (ccslot @ XA2)) = (ccfv @ XA2 @ XF))))))).
thf(afvresi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XB2 @ XA2) => ((ccfv @ XB2 @ (ccres @ ccid @ XA2)) = XB2))))).
thf(cbj_evalid_conj,conjecture,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (((cwcel @ XV @ XW) & (cwcel @ XA2 @ XV)) => ((ccfv @ (ccres @ ccid @ XV) @ (ccslot @ XA2)) = XA2)))))).
