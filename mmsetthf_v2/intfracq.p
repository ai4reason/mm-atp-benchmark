...
thf(cintfracq_conj,conjecture,(! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ (cco @ XM @ XN @ ccdiv) @ ccfl)) => ((XF = (cco @ (cco @ XM @ XN @ ccdiv) @ XZ @ ccmin)) => (((cwcel @ XM @ ccz) & (cwcel @ XN @ ccn)) => (cw3a @ (cwbr @ ccc0 @ XF @ ccle) @ (cwbr @ XF @ (cco @ (cco @ XN @ cc1 @ ccmin) @ XN @ ccdiv) @ ccle) @ ((cco @ XM @ XN @ ccdiv) = (cco @ XZ @ XF @ ccaddc))))))))))).
