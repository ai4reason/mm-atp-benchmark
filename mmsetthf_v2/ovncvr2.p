...
thf(aidi_ax,axiom,(! [Xph:$o] : (Xph => Xph))).
...
thf(covncvr2_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > ($i > ($i > ($i > $o))))] : (! [XB2:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XC:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XD:($i > ($i > ($i > ($i > ($i > ($i > ($i > ($i > $o))))))))] : (! [XT:($i > ($i > ($i > ($i > ($i > ($i > ($i > $o)))))))] : (! [XE:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XL:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XX:($i > $o)] : ((! [Xi:$i] : (! [Xl:$i] : ((Xph @ Xi @ Xl) => (cwcel @ XX @ ccfn)))) => ((! [Xh:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xl:$i] : ((Xph @ Xi @ Xl) => (cwss @ (XA2 @ Xh @ Xj @ Xk) @ (cco @ ccr @ XX @ ccmap)))))))) => ((! [Xh:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xa:$i] : (! [Xl:$i] : ((Xph @ Xi @ Xl) => (cwcel @ (XE @ Xh @ Xj @ Xk @ Xa @ Xl) @ ccrp)))))))) => ((! [Xh:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xl:$i] : ((XC @ Xh @ Xj @ Xk @ Xl) = (ccmpt @ (^ [Xa:$i] : (ccpw @ (cco @ ccr @ XX @ ccmap))) @ (^ [Xa:$i] : (ccrab @ (^ [Xl:$i] : (cwss @ (ccv @ Xa) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccfv @ (ccv @ Xj) @ (ccv @ Xl)))))))))) @ (^ [Xl:$i] : (cco @ (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap) @ ccn @ ccmap)))))))))) => ((! [Xh:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xl:$i] : ((XL @ Xh @ Xj @ Xk @ Xl) = (ccmpt @ (^ [Xh:$i] : (cco @ (ccxp @ ccr @ ccr) @ XX @ ccmap)) @ (^ [Xh:$i] : (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (cccom @ ccico @ (ccv @ Xh))) @ ccvol)))))))))) => ((! [Xh:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xa:$i] : (! [Xl:$i] : ((XD @ Xh @ Xi @ Xj @ Xk @ Xr @ Xa @ Xl) = (ccmpt @ (^ [Xa:$i] : (ccpw @ (cco @ ccr @ XX @ ccmap))) @ (^ [Xa:$i] : (ccmpt @ (^ [Xr:$i] : ccrp) @ (^ [Xr:$i] : (ccrab @ (^ [Xi:$i] : (cwbr @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccfv @ (ccfv @ (ccv @ Xj) @ (ccv @ Xi)) @ (XL @ Xh @ Xj @ Xk @ Xl)))) @ ccsumge0) @ (cco @ (ccfv @ (ccv @ Xa) @ (ccfv @ XX @ ccovoln)) @ (ccv @ Xr) @ ccxad) @ ccle)) @ (^ [Xi:$i] : (ccfv @ (ccv @ Xa) @ (XC @ Xh @ Xj @ Xk @ Xl)))))))))))))))) => ((! [Xh:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xa:$i] : (! [Xl:$i] : ((Xph @ Xi @ Xl) => (cwcel @ (XI @ Xr @ Xa) @ (ccfv @ (XE @ Xh @ Xj @ Xk @ Xa @ Xl) @ (ccfv @ (XA2 @ Xh @ Xj @ Xk) @ (XD @ Xh @ Xi @ Xj @ Xk @ Xr @ Xa @ Xl)))))))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xa:$i] : (! [Xl:$i] : ((XB2 @ Xi @ Xj @ Xk @ Xr @ Xa @ Xl) = (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccmpt @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (XI @ Xr @ Xa))) @ cc1st)))))))))))) => ((! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xa:$i] : (! [Xl:$i] : ((XT @ Xi @ Xj @ Xk @ Xr @ Xa @ Xl) = (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccmpt @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (XI @ Xr @ Xa))) @ cc2nd)))))))))))) => (! [Xh:$i] : (! [Xi:$i] : (! [Xj:$i] : (! [Xk:$i] : (! [Xr:$i] : (! [Xa:$i] : (! [Xl:$i] : ((Xph @ Xi @ Xl) => ((((cwf @ ccn @ (cco @ ccr @ XX @ ccmap) @ (XB2 @ Xi @ Xj @ Xk @ Xr @ Xa @ Xl)) & (cwf @ ccn @ (cco @ ccr @ XX @ ccmap) @ (XT @ Xi @ Xj @ Xk @ Xr @ Xa @ Xl))) & (cwss @ (XA2 @ Xh @ Xj @ Xk) @ (cciun @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccixp @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (cco @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (XB2 @ Xi @ Xj @ Xk @ Xr @ Xa @ Xl))) @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (XT @ Xi @ Xj @ Xk @ Xr @ Xa @ Xl))) @ ccico))))))) & (cwbr @ (ccfv @ (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (ccprod @ (^ [Xk:$i] : XX) @ (^ [Xk:$i] : (ccfv @ (cco @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (XB2 @ Xi @ Xj @ Xk @ Xr @ Xa @ Xl))) @ (ccfv @ (ccv @ Xk) @ (ccfv @ (ccv @ Xj) @ (XT @ Xi @ Xj @ Xk @ Xr @ Xa @ Xl))) @ ccico) @ ccvol))))) @ ccsumge0) @ (cco @ (ccfv @ (XA2 @ Xh @ Xj @ Xk) @ (ccfv @ XX @ ccovoln)) @ (XE @ Xh @ Xj @ Xk @ Xa @ Xl) @ ccxad) @ ccle)))))))))))))))))))))))))))))).
