...
thf(asnsssn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwss @ (ccsn @ XA2) @ (ccsn @ XB2)) => (XA2 = XB2)))))).
...
thf(ak0004lem2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XU) @ (cwcel @ XB2 @ XV) @ (cwss @ XC @ XB2)) => (((cwcel @ XF @ (cco @ XB2 @ XA2 @ ccmap)) & (cwss @ (ccima @ XF @ XA2) @ XC)) <=> (cwcel @ XF @ (cco @ XC @ XA2 @ ccmap))))))))))).
...
thf(ck0004lem3_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ XU) @ (cwcel @ XB2 @ XV) @ (cwcel @ XC @ XB2)) => (((cwcel @ XF @ (cco @ XB2 @ (ccsn @ XA2) @ ccmap)) & ((ccfv @ XA2 @ XF) = XC)) <=> (XF = (ccsn @ (ccop @ XA2 @ XC)))))))))))).
