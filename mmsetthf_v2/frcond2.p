...
thf(afrcond1_ax,axiom,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xb:$i] : ((XE @ Xb) = (ccfv @ XG @ ccedg))) => ((cwcel @ XG @ ccfrgr) => ((cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XC @ XV) @ (cwne @ XA2 @ XC)) => (cwreu @ (^ [Xb:$i] : (cwss @ (ccpr @ (ccpr @ XA2 @ (ccv @ Xb)) @ (ccpr @ (ccv @ Xb) @ XC)) @ (XE @ Xb))) @ (^ [Xb:$i] : XV)))))))))))).
...
thf(cfrcond2_conj,conjecture,(! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xb:$i] : ((XE @ Xb) = (ccfv @ XG @ ccedg))) => ((cwcel @ XG @ ccfrgr) => ((cw3a @ (cwcel @ XA2 @ XV) @ (cwcel @ XC @ XV) @ (cwne @ XA2 @ XC)) => (cwreu @ (^ [Xb:$i] : ((cwcel @ (ccpr @ XA2 @ (ccv @ Xb)) @ (XE @ Xb)) & (cwcel @ (ccpr @ (ccv @ Xb) @ XC) @ (XE @ Xb)))) @ (^ [Xb:$i] : XV)))))))))))).
