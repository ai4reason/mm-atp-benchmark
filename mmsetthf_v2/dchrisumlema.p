...
thf(arlimclim1_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XM:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwbr @ XF @ XA2 @ ccrli)) => ((Xph => (cwss @ XZ @ (ccdm @ XF))) => (Xph => (cwbr @ XF @ XA2 @ ccli)))))))))))).
...
thf(cdchrisumlema_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XD:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > ($i > ($i > $o)))] : (! [XI:($i > $o)] : (! [XL:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XN @ cczn)) => ((XL = (ccfv @ XZ @ cczrh)) => ((Xph => (cwcel @ XN @ ccn)) => ((! [Xx3:$i] : (! [Xn:$i] : ((XG @ Xx3 @ Xn) = (ccfv @ XN @ ccdchr)))) => ((! [Xx3:$i] : (! [Xn:$i] : (XD = (ccfv @ (XG @ Xx3 @ Xn) @ ccbs)))) => ((! [Xx3:$i] : (! [Xn:$i] : (Xc_1 = (ccfv @ (XG @ Xx3 @ Xn) @ cc0g)))) => ((Xph => (cwcel @ XX @ XD)) => ((Xph => (cwne @ XX @ Xc_1)) => ((! [Xx3:$i] : (! [Xn:$i] : (((ccv @ Xn) = (ccv @ Xx3)) => ((XA2 @ Xn) = (XB2 @ Xx3))))) => ((Xph => (cwcel @ XM @ ccn)) => ((! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ ccrp)) => (cwcel @ (XA2 @ Xn) @ ccr))) => ((! [Xx3:$i] : (! [Xn:$i] : ((cw3a @ Xph @ ((cwcel @ (ccv @ Xn) @ ccrp) & (cwcel @ (ccv @ Xx3) @ ccrp)) @ ((cwbr @ XM @ (ccv @ Xn) @ ccle) & (cwbr @ (ccv @ Xn) @ (ccv @ Xx3) @ ccle))) => (cwbr @ (XB2 @ Xx3) @ (XA2 @ Xn) @ ccle)))) => ((Xph => (cwbr @ (ccmpt @ (^ [Xn:$i] : ccrp) @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccc0 @ ccrli)) => ((XF = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccfv @ (ccv @ Xn) @ XL) @ XX) @ (XA2 @ Xn) @ ccmul)))) => (Xph => (((cwcel @ XI @ ccrp) => (cwcel @ (ccsb @ XI @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccr)) & ((cwcel @ XI @ (cco @ XM @ ccpnf @ ccico)) => (cwbr @ ccc0 @ (ccsb @ XI @ (^ [Xn:$i] : (XA2 @ Xn))) @ ccle)))))))))))))))))))))))))))))))).
