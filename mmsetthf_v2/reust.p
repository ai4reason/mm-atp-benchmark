...
thf(acnflduss_ax,axiom,(! [XU:($i > $o)] : ((XU = (ccfv @ cccnfld @ ccuss)) => (XU = (ccfv @ (cccom @ ccabs @ ccmin) @ ccmetu))))).
...
thf(arestmetu_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XX:($i > $o)] : ((cw3a @ (cwne @ XA2 @ cc0) @ (cwcel @ XD @ (ccfv @ XX @ ccpsmet)) @ (cwss @ XA2 @ XX)) => ((cco @ (ccfv @ XD @ ccmetu) @ (ccxp @ XA2 @ XA2) @ ccrest) = (ccfv @ (ccres @ XD @ (ccxp @ XA2 @ XA2)) @ ccmetu))))))).
...
thf(creust_conj,conjecture,((ccfv @ ccrefld @ ccuss) = (ccfv @ (ccres @ (ccfv @ ccrefld @ ccds) @ (ccxp @ ccr @ ccr)) @ ccmetu))).
