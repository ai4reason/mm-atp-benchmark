...
thf(asumsns_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XM:($i > $o)] : (! [XV:($i > ($i > $o))] : (! [Xk:$i] : (((cwcel @ XM @ (XV @ Xk)) & (cwcel @ (ccsb @ XM @ (^ [Xk:$i] : (XA2 @ Xk))) @ ccc)) => ((ccsu @ (ccsn @ XM) @ (^ [Xk:$i] : (XA2 @ Xk))) = (ccsb @ XM @ (^ [Xk:$i] : (XA2 @ Xk)))))))))).
thf(cfsumsplitsnunOLD_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xz:$i] : ((cw3a @ (cwcel @ (XA2 @ Xz) @ ccfn) @ (cwnel @ (ccv @ Xz) @ (XA2 @ Xz)) @ (cwral @ (^ [Xk:$i] : (cwcel @ (XB2 @ Xz @ Xk) @ ccz)) @ (^ [Xk:$i] : (ccun @ (XA2 @ Xz) @ (ccsn @ (ccv @ Xz)))))) => ((ccsu @ (ccun @ (XA2 @ Xz) @ (ccsn @ (ccv @ Xz))) @ (^ [Xk:$i] : (XB2 @ Xz @ Xk))) = (cco @ (ccsu @ (XA2 @ Xz) @ (^ [Xk:$i] : (XB2 @ Xz @ Xk))) @ (ccsb @ (ccv @ Xz) @ (^ [Xk:$i] : (XB2 @ Xz @ Xk))) @ ccaddc))))))).
