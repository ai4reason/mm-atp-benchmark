...
thf(aabssinper_ax,axiom,(! [XA2:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwcel @ XK @ ccz)) => ((ccfv @ (ccfv @ (cco @ XA2 @ (cco @ XK @ ccpi @ ccmul) @ ccaddc) @ ccsin) @ ccabs) = (ccfv @ (ccfv @ XA2 @ ccsin) @ ccabs)))))).
...
thf(csinkpi_conj,conjecture,(! [XK:($i > $o)] : ((cwcel @ XK @ ccz) => ((ccfv @ (cco @ XK @ ccpi @ ccmul) @ ccsin) = ccc0)))).
