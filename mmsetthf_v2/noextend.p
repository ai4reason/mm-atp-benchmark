...
thf(aelno2_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccsur) <=> (cw3a @ (cwfun @ XA2) @ (cwcel @ (ccdm @ XA2) @ ccon0) @ (cwss @ (ccrn @ XA2) @ (ccpr @ cc1o @ cc2o)))))).
thf(cnoextend_conj,conjecture,(! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ (ccpr @ cc1o @ cc2o)) => ((cwcel @ XA2 @ ccsur) => (cwcel @ (ccun @ XA2 @ (ccsn @ (ccop @ (ccdm @ XA2) @ XX))) @ ccsur)))))).
