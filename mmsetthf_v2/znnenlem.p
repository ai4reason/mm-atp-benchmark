...
thf(cznnenlem_conj,conjecture,(! [Xx3:$i] : (! [Xy1:$i] : ((((cwbr @ ccc0 @ (ccv @ Xx3) @ ccle) & (~ (cwbr @ ccc0 @ (ccv @ Xy1) @ ccle))) & ((cwcel @ (ccv @ Xx3) @ ccz) & (cwcel @ (ccv @ Xy1) @ ccz))) => (((ccv @ Xx3) = (ccv @ Xy1)) <=> ((cco @ cc2 @ (ccv @ Xx3) @ ccmul) = (cco @ (cco @ (ccneg @ cc2) @ (ccv @ Xy1) @ ccmul) @ cc1 @ ccaddc))))))).
