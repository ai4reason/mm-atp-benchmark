...
thf(afococnv2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwfo @ XA2 @ XB2 @ XF) => ((cccom @ XF @ (cccnv @ XF)) = (ccres @ ccid @ XB2))))))).
...
thf(afnopfv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XA2) & (cwcel @ XB2 @ XA2)) => (cwcel @ (ccop @ XB2 @ (ccfv @ XB2 @ XF)) @ XF)))))).
...
thf(cfoeqcnvco_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwfo @ XA2 @ XB2 @ XF) & (cwfo @ XA2 @ XB2 @ XG)) => ((XF = XG) <=> ((cccom @ XF @ (cccnv @ XG)) = (ccres @ ccid @ XB2))))))))).
