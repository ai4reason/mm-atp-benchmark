...
thf(altprord_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccnp) & (cwcel @ XB2 @ ccnp)) => ((cwbr @ XA2 @ XB2 @ ccltp) <=> (cwpss @ XA2 @ XB2)))))).
...
thf(csuplem1pr_conj,conjecture,(! [XA2:($i > $o)] : (((cwne @ XA2 @ cc0) & (cwrex @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ (ccv @ Xx3) @ ccltp)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : ccnp))) => (cwcel @ (ccuni @ XA2) @ ccnp)))).
