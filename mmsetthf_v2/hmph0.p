...
thf(ahmphen_ax,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwbr @ XJ @ XK @ cchmph) => (cwbr @ XJ @ XK @ ccen))))).
thf(ccsuc_tp,type,(ccsuc : (($i > $o) > ($i > $o)))).
thf(adf1o2_ax,axiom,(cc1o = (ccsn @ cc0))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(ahmphtop1_ax,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((cwbr @ XJ @ XK @ cchmph) => (cwcel @ XJ @ cctop))))).
thf(aen1top_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cctop) => ((cwbr @ XJ @ cc1o @ ccen) <=> (XJ = (ccsn @ cc0)))))).
...
thf(chmph0_conj,conjecture,(! [XJ:($i > $o)] : ((cwbr @ XJ @ (ccsn @ cc0) @ cchmph) <=> (XJ = (ccsn @ cc0))))).
