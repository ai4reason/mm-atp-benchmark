...
thf(adfsup2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : ((ccsup @ XB2 @ XA2 @ XR) = (ccuni @ (ccdif @ XA2 @ (ccun @ (ccima @ (cccnv @ XR) @ XB2) @ (ccima @ XR @ (ccdif @ XA2 @ (ccima @ (cccnv @ XR) @ XB2))))))))))).
...
thf(cnfsup_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XB2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XR @ Xx3))) => (cwnfc @ (^ [Xx3:$i] : (ccsup @ (XA2 @ Xx3) @ (XB2 @ Xx3) @ (XR @ Xx3))))))))))).
