...
thf(c_4sqlem4_conj,conjecture,(! [XA2:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((XS @ Xx3 @ Xy1 @ Xz @ Xw) = (ccab @ (^ [Xn:$i] : (cwrex @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwrex @ (^ [Xz:$i] : (cwrex @ (^ [Xw:$i] : ((ccv @ Xn) = (cco @ (cco @ (cco @ (ccv @ Xx3) @ cc2 @ ccexp) @ (cco @ (ccv @ Xy1) @ cc2 @ ccexp) @ ccaddc) @ (cco @ (cco @ (ccv @ Xz) @ cc2 @ ccexp) @ (cco @ (ccv @ Xw) @ cc2 @ ccexp) @ ccaddc) @ ccaddc))) @ (^ [Xw:$i] : ccz))) @ (^ [Xz:$i] : ccz))) @ (^ [Xy1:$i] : ccz))) @ (^ [Xx3:$i] : ccz))))))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (! [Xw:$i] : ((cwcel @ (XA2 @ Xx3 @ Xy1 @ Xz @ Xw) @ (XS @ Xx3 @ Xy1 @ Xz @ Xw)) <=> (cwrex @ (^ [Xu:$i] : (cwrex @ (^ [Xv:$i] : ((XA2 @ Xx3 @ Xy1 @ Xz @ Xw) = (cco @ (cco @ (ccfv @ (ccv @ Xu) @ ccabs) @ cc2 @ ccexp) @ (cco @ (ccfv @ (ccv @ Xv) @ ccabs) @ cc2 @ ccexp) @ ccaddc))) @ (^ [Xv:$i] : ccgz))) @ (^ [Xu:$i] : ccgz))))))))))).
