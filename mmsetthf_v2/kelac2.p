...
thf(akelac1_ax,axiom,(! [Xph:$o] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XS:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XJ:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwne @ (XS @ Xx3) @ cc0))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwcel @ (XJ @ Xx3) @ cctop))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwcel @ (XC @ Xx3) @ (ccfv @ (XJ @ Xx3) @ cccld)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwf1o @ (XS @ Xx3) @ (XC @ Xx3) @ (XB2 @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwcel @ (XU @ Xx3) @ (ccuni @ (XJ @ Xx3))))) => ((Xph => (cwcel @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XJ @ Xx3))) @ ccpt) @ cccmp)) => (Xph => (cwne @ (ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XS @ Xx3))) @ cc0)))))))))))))))).
thf(a_3syl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => Xps) => ((Xps => Xch) => ((Xch => Xth) => (Xph => Xth))))))))).
thf(ccdom_tp,type,(ccdom : ($i > $o))).
thf(cwbr_tp,type,(cwbr : (($i > $o) > (($i > $o) > (($i > $o) > $o))))).
thf(cctb_tp,type,(cctb : ($i > $o))).
thf(akelac2lem_ax,axiom,(! [XS:($i > $o)] : (! [XV:($i > $o)] : ((cwcel @ XS @ XV) => (cwcel @ (ccfv @ (ccpr @ XS @ (ccsn @ (ccpw @ (ccuni @ XS)))) @ cctg) @ cccmp))))).
...
thf(ckelac2_conj,conjecture,(! [Xph:$o] : (! [XS:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwcel @ (XS @ Xx3) @ (XV @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XI)) => (cwne @ (XS @ Xx3) @ cc0))) => ((Xph => (cwcel @ (ccfv @ (ccmpt @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (ccfv @ (ccpr @ (XS @ Xx3) @ (ccsn @ (ccpw @ (ccuni @ (XS @ Xx3))))) @ cctg))) @ ccpt) @ cccmp)) => (Xph => (cwne @ (ccixp @ (^ [Xx3:$i] : XI) @ (^ [Xx3:$i] : (XS @ Xx3))) @ cc0)))))))))).
