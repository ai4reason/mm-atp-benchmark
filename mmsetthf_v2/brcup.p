...
thf(adf_cup_ax,axiom,(cccup = (ccdif @ (ccxp @ (ccxp @ ccvv @ ccvv) @ ccvv) @ (ccrn @ (ccsymdif @ (cctxp @ ccvv @ ccep) @ (cctxp @ (ccun @ (cccom @ (cccnv @ cc1st) @ ccep) @ (cccom @ (cccnv @ cc2nd) @ ccep)) @ ccvv)))))).
...
thf(cbrcup_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((cwcel @ XC @ ccvv) => ((cwbr @ (ccop @ XA2 @ XB2) @ XC @ cccup) <=> (XC = (ccun @ XA2 @ XB2)))))))))).
