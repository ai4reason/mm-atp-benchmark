...
thf(aiscplgredg_ax,axiom,(! [XE:($i > ($i > ($i > $o)))] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : ((XV = (ccfv @ XG @ ccvtx)) => ((! [Xv:$i] : (! [Xn:$i] : ((XE @ Xv @ Xn) = (ccfv @ XG @ ccedg)))) => ((cwcel @ XG @ XW) => ((cwcel @ XG @ cccplgr) <=> (cwral @ (^ [Xv:$i] : (cwral @ (^ [Xn:$i] : (cwrex @ (^ [Xe:$i] : (cwss @ (ccpr @ (ccv @ Xv) @ (ccv @ Xn)) @ (ccv @ Xe))) @ (^ [Xe:$i] : (XE @ Xv @ Xn)))) @ (^ [Xn:$i] : (ccdif @ XV @ (ccsn @ (ccv @ Xv)))))) @ (^ [Xv:$i] : XV))))))))))).
