...
thf(aabsabv_ax,axiom,(cwcel @ ccabs @ (ccfv @ cccnfld @ ccabv))).
...
thf(cqabsabv_conj,conjecture,(! [XA2:($i > $o)] : (! [XQ:($i > $o)] : ((XQ = (cco @ cccnfld @ ccq @ ccress)) => ((XA2 = (ccfv @ XQ @ ccabv)) => (cwcel @ (ccres @ ccabs @ ccq) @ XA2)))))).
