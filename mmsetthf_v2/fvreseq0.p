...
thf(cfvreseq0_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xx3:$i] : ((((cwfn @ XF @ (XA2 @ Xx3)) & (cwfn @ XG @ (XC @ Xx3))) & ((cwss @ XB2 @ (XA2 @ Xx3)) & (cwss @ XB2 @ (XC @ Xx3)))) => (((ccres @ XF @ XB2) = (ccres @ XG @ XB2)) <=> (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) = (ccfv @ (ccv @ Xx3) @ XG))) @ (^ [Xx3:$i] : XB2))))))))))).
