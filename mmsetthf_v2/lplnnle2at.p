...
thf(aislpln_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((! [Xy1:$i] : ((XB2 @ Xy1) = (ccfv @ XK @ ccbs))) => ((! [Xy1:$i] : ((XC @ Xy1) = (ccfv @ XK @ cccvr))) => ((XN = (ccfv @ XK @ cclln)) => ((! [Xy1:$i] : ((XP @ Xy1) = (ccfv @ XK @ cclpl))) => (! [Xy1:$i] : ((cwcel @ XK @ (XA2 @ Xy1)) => ((cwcel @ XX @ (XP @ Xy1)) <=> ((cwcel @ XX @ (XB2 @ Xy1)) & (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xy1) @ XX @ (XC @ Xy1))) @ (^ [Xy1:$i] : XN)))))))))))))))))).
...
thf(allnnlt_ax,axiom,(! [Xc_lt:($i > $o)] : (! [XK:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xc_lt = (ccfv @ XK @ ccplt)) => ((XN = (ccfv @ XK @ cclln)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XN) @ (cwcel @ XY @ XN)) => (~ (cwbr @ XX @ XY @ Xc_lt))))))))))).
...
thf(allnnleat_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XN = (ccfv @ XK @ cclln)) => ((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XN) @ (cwcel @ XP @ XA2)) => (~ (cwbr @ XX @ XP @ Xc_le))))))))))))).
...
thf(clplnnle2at_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XR:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XX:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XP = (ccfv @ XK @ cclpl)) => (((cwcel @ XK @ cchlt) & (cw3a @ (cwcel @ XX @ XP) @ (cwcel @ XQ @ XA2) @ (cwcel @ XR @ XA2))) => (~ (cwbr @ XX @ (cco @ XQ @ XR @ Xc_or) @ Xc_le)))))))))))))))).
