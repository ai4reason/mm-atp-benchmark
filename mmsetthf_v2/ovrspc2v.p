...
thf(covrspc2v_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > ($i > $o))] : (! [Xx3:$i] : ((((cwcel @ XX @ XA2) & (cwcel @ (XY @ Xx3) @ XB2)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XF) @ XC)) @ (^ [Xy1:$i] : XB2))) @ (^ [Xx3:$i] : XA2))) => (cwcel @ (cco @ XX @ (XY @ Xx3) @ XF) @ XC)))))))))).
