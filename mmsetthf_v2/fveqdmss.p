...
thf(cfveqdmss_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : ((XD = (ccdm @ XB2)) => ((cw3a @ (cwfun @ XB2) @ (cwnel @ cc0 @ (ccrn @ XB2)) @ (cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XA2) = (ccfv @ (ccv @ Xx3) @ XB2))) @ (^ [Xx3:$i] : XD))) => (cwss @ XD @ (ccdm @ XA2)))))))).
