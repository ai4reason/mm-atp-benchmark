...
thf(annpw2blen_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => ((cwbr @ (cco @ cc2 @ (cco @ (ccfv @ XN @ ccblen) @ cc1 @ ccmin) @ ccexp) @ XN @ ccle) & (cwbr @ XN @ (cco @ cc2 @ (ccfv @ XN @ ccblen) @ ccexp) @ cclt))))).
...
thf(cnnpw2blenfzo_conj,conjecture,(! [XN:($i > $o)] : ((cwcel @ XN @ ccn) => (cwcel @ XN @ (cco @ (cco @ cc2 @ (cco @ (ccfv @ XN @ ccblen) @ cc1 @ ccmin) @ ccexp) @ (cco @ cc2 @ (ccfv @ XN @ ccblen) @ ccexp) @ ccfzo))))).
