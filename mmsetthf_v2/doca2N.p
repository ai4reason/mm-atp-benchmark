...
thf(cdoca2N_conj,conjecture,(! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_pe:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdia))) => ((Xc_pe = (ccfv @ XW @ (ccfv @ XK @ ccocaN))) => ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & (cwcel @ XX @ (ccdm @ XI))) => ((ccfv @ (ccfv @ (ccfv @ XX @ XI) @ Xc_pe) @ Xc_pe) = (ccfv @ XX @ XI))))))))))))).
