...
thf(cbnj1177_conj,conjecture,(! [Xph:($i > $o)] : (! [Xps:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xy1:$i] : ((Xps @ Xy1) <=> (cw3a @ (cwcel @ (XX @ Xy1) @ (XB2 @ Xy1)) @ (cwcel @ (ccv @ Xy1) @ (XB2 @ Xy1)) @ (cwbr @ (ccv @ Xy1) @ (XX @ Xy1) @ (XR @ Xy1))))) => ((! [Xy1:$i] : ((XC @ Xy1) = (ccin @ (cc_bnj18 @ (XA2 @ Xy1) @ (XR @ Xy1) @ (XX @ Xy1)) @ (XB2 @ Xy1)))) => ((! [Xy1:$i] : (((Xph @ Xy1) & (Xps @ Xy1)) => (cw_bnj15 @ (XA2 @ Xy1) @ (XR @ Xy1)))) => ((! [Xy1:$i] : (((Xph @ Xy1) & (Xps @ Xy1)) => (cwss @ (XB2 @ Xy1) @ (XA2 @ Xy1)))) => ((! [Xy1:$i] : (((Xph @ Xy1) & (Xps @ Xy1)) => (cwcel @ (XX @ Xy1) @ (XA2 @ Xy1)))) => (! [Xy1:$i] : (((Xph @ Xy1) & (Xps @ Xy1)) => (cw_bnj17 @ (cwfr @ (XA2 @ Xy1) @ (XR @ Xy1)) @ (cwss @ (XC @ Xy1) @ (XA2 @ Xy1)) @ (cwne @ (XC @ Xy1) @ cc0) @ (cwcel @ (XC @ Xy1) @ ccvv))))))))))))))))).
