...
thf(ahausmapdom_ax,axiom,(! [XA2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => ((cw3a @ (cwcel @ XJ @ ccha) @ (cwcel @ XJ @ cc1stc) @ (cwss @ XA2 @ XX)) => (cwbr @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (cco @ XA2 @ ccn @ ccmap) @ ccdom))))))).
...
thf(amapdom2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwbr @ XA2 @ XB2 @ ccdom) & (~ ((XA2 = cc0) & (XC = cc0)))) => (cwbr @ (cco @ XC @ XA2 @ ccmap) @ (cco @ XC @ XB2 @ ccmap) @ ccdom)))))).
...
thf(afidomtri_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (((cwcel @ XA2 @ ccfn) & (cwcel @ XB2 @ XV)) => ((cwbr @ XA2 @ XB2 @ ccdom) <=> (~ (cwbr @ XB2 @ XA2 @ ccsdm)))))))).
...
thf(amappwen_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XB2 @ (ccdm @ cccrd)) & (cwbr @ ccom @ XB2 @ ccdom)) & ((cwbr @ cc2o @ XA2 @ ccdom) & (cwbr @ XA2 @ (ccpw @ XB2) @ ccdom))) => (cwbr @ (cco @ XA2 @ XB2 @ ccmap) @ (ccpw @ XB2) @ ccen))))).
...
thf(chauspwdom_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cw3a @ (cwcel @ XJ @ ccha) @ (cwcel @ XJ @ cc1stc) @ (cwss @ XA2 @ XX)) & ((cwbr @ XA2 @ (ccpw @ XB2) @ ccdom) & (cwbr @ ccn @ XB2 @ ccdom))) => (cwbr @ (ccfv @ XA2 @ (ccfv @ XJ @ cccl)) @ (ccpw @ XB2) @ ccdom)))))))).
