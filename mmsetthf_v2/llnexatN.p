...
thf(cllnexatN_conj,conjecture,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [Xc_or:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((! [Xq:$i] : ((Xc_or @ Xq) = (ccfv @ XK @ ccjn))) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XN = (ccfv @ XK @ cclln)) => (((cw3a @ (cwcel @ XK @ cchlt) @ (cwcel @ XX @ XN) @ (cwcel @ XP @ XA2)) & (cwbr @ XP @ XX @ Xc_le)) => (cwrex @ (^ [Xq:$i] : ((cwne @ XP @ (ccv @ Xq)) & (XX = (cco @ XP @ (ccv @ Xq) @ (Xc_or @ Xq))))) @ (^ [Xq:$i] : XA2))))))))))))))).
