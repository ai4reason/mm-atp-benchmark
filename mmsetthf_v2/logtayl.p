...
thf(alogtayllem_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) => (cwcel @ (ccseq @ ccaddc @ (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccif @ ((ccv @ Xn) = ccc0) @ ccc0 @ (cco @ cc1 @ (ccv @ Xn) @ ccdiv)) @ (cco @ XA2 @ (ccv @ Xn) @ ccexp) @ ccmul))) @ ccc0) @ (ccdm @ ccli))))).
...
thf(adv11cn_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XC:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (cco @ XA2 @ XR @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl))) => ((Xph => (cwcel @ XA2 @ ccc)) => ((Xph => (cwcel @ XR @ ccxr)) => ((Xph => (cwf @ XX @ ccc @ XF)) => ((Xph => (cwf @ XX @ ccc @ XG)) => ((Xph => ((ccdm @ (cco @ ccc @ XF @ ccdv)) = XX)) => ((Xph => ((cco @ ccc @ XF @ ccdv) = (cco @ ccc @ XG @ ccdv))) => ((Xph => (cwcel @ XC @ XX)) => ((Xph => ((ccfv @ XC @ XF) = (ccfv @ XC @ XG))) => (Xph => (XF = XG))))))))))))))))))).
...
thf(aradcnvle_ax,axiom,(! [Xph:($i > ($i > ($i > $o)))] : (! [XA2:($i > ($i > $o))] : (! [XR:($i > ($i > ($i > ($i > $o))))] : (! [XG:($i > ($i > ($i > $o)))] : (! [XX:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xn:$i] : (! [Xr:$i] : ((XG @ Xx3 @ Xn) = (ccmpt @ (^ [Xx3:$i] : ccc) @ (^ [Xx3:$i] : (ccmpt @ (^ [Xn:$i] : ccn0) @ (^ [Xn:$i] : (cco @ (ccfv @ (ccv @ Xn) @ (XA2 @ Xr)) @ (cco @ (ccv @ Xx3) @ (ccv @ Xn) @ ccexp) @ ccmul))))))))) => ((! [Xx3:$i] : (! [Xn:$i] : (! [Xr:$i] : ((Xph @ Xx3 @ Xn @ Xr) => (cwf @ ccn0 @ ccc @ (XA2 @ Xr)))))) => ((! [Xx3:$i] : (! [Xn:$i] : (! [Xr:$i] : ((XR @ Xx3 @ Xn @ Xr) = (ccsup @ (ccrab @ (^ [Xr:$i] : (cwcel @ (ccseq @ ccaddc @ (ccfv @ (ccv @ Xr) @ (XG @ Xx3 @ Xn)) @ ccc0) @ (ccdm @ ccli))) @ (^ [Xr:$i] : ccr)) @ ccxr @ cclt))))) => ((! [Xx3:$i] : (! [Xn:$i] : (! [Xr:$i] : ((Xph @ Xx3 @ Xn @ Xr) => (cwcel @ (XX @ Xx3 @ Xn @ Xr) @ ccc))))) => ((! [Xx3:$i] : (! [Xn:$i] : (! [Xr:$i] : ((Xph @ Xx3 @ Xn @ Xr) => (cwcel @ (ccseq @ ccaddc @ (ccfv @ (XX @ Xx3 @ Xn @ Xr) @ (XG @ Xx3 @ Xn)) @ ccc0) @ (ccdm @ ccli)))))) => (! [Xx3:$i] : (! [Xn:$i] : (! [Xr:$i] : ((Xph @ Xx3 @ Xn @ Xr) => (cwbr @ (ccfv @ (XX @ Xx3 @ Xn @ Xr) @ ccabs) @ (XR @ Xx3 @ Xn @ Xr) @ ccle)))))))))))))))).
...
thf(advlog2lem_ax,axiom,(! [XS:($i > $o)] : ((XS = (cco @ cc1 @ cc1 @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl))) => (cwss @ XS @ (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc)))))).
...
thf(advlog2_ax,axiom,(! [XS:($i > $o)] : ((XS = (cco @ cc1 @ cc1 @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl))) => ((cco @ ccc @ (ccres @ cclog @ XS) @ ccdv) = (ccmpt @ (^ [Xx3:$i] : XS) @ (^ [Xx3:$i] : (cco @ cc1 @ (ccv @ Xx3) @ ccdiv))))))).
...
thf(alogf1o_ax,axiom,(cwf1o @ (ccdif @ ccc @ (ccsn @ ccc0)) @ (ccrn @ cclog) @ cclog)).
...
thf(alogdmss_ax,axiom,(! [XD:($i > $o)] : ((XD = (ccdif @ ccc @ (cco @ ccmnf @ ccc0 @ ccioc))) => (cwss @ XD @ (ccdif @ ccc @ (ccsn @ ccc0)))))).
...
thf(aisumshft_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : (! [XZ:($i > ($i > $o))] : ((! [Xj:$i] : (! [Xk:$i] : ((XZ @ Xj) = (ccfv @ (XM @ Xj @ Xk) @ ccuz)))) => ((! [Xj:$i] : (! [Xk:$i] : (XW = (ccfv @ (cco @ (XM @ Xj @ Xk) @ XK @ ccaddc) @ ccuz)))) => ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xj) = (cco @ XK @ (ccv @ Xk) @ ccaddc)) => ((XA2 @ Xj) = (XB2 @ Xk))))) => ((Xph => (cwcel @ XK @ ccz)) => ((! [Xj:$i] : (! [Xk:$i] : (Xph => (cwcel @ (XM @ Xj @ Xk) @ ccz)))) => ((! [Xj:$i] : ((Xph & (cwcel @ (ccv @ Xj) @ XW)) => (cwcel @ (XA2 @ Xj) @ ccc))) => (! [Xj:$i] : (Xph => ((ccsu @ XW @ (^ [Xj:$i] : (XA2 @ Xj))) = (ccsu @ (XZ @ Xj) @ (^ [Xk:$i] : (XB2 @ Xk)))))))))))))))))))).
...
thf(ageoisum_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) => ((ccsu @ ccn0 @ (^ [Xk:$i] : (cco @ XA2 @ (ccv @ Xk) @ ccexp))) = (cco @ cc1 @ (cco @ cc1 @ XA2 @ ccmin) @ ccdiv))))).
...
thf(clogtayl_conj,conjecture,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) => (cwbr @ (ccseq @ ccaddc @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ XA2 @ (ccv @ Xk) @ ccexp) @ (ccv @ Xk) @ ccdiv))) @ cc1) @ (ccneg @ (ccfv @ (cco @ cc1 @ XA2 @ ccmin) @ cclog)) @ ccli)))).
