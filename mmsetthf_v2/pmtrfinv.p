...
thf(aen2other2_ax,axiom,(! [XP:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ XP) & (cwbr @ XP @ cc2o @ ccen)) => ((ccuni @ (ccdif @ XP @ (ccsn @ (ccuni @ (ccdif @ XP @ (ccsn @ XX)))))) = XX))))).
...
thf(cpmtrfinv_conj,conjecture,(! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : ((XT = (ccfv @ XD @ ccpmtr)) => ((XR = (ccrn @ XT)) => ((cwcel @ XF @ XR) => ((cccom @ XF @ XF) = (ccres @ ccid @ XD)))))))))).
