...
thf(a_1stpreimas_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwrel @ XA2) & (cwcel @ XX @ XV)) => ((ccima @ (cccnv @ (ccres @ cc1st @ XA2)) @ (ccsn @ XX)) = (ccxp @ (ccsn @ XX) @ (ccima @ XA2 @ (ccsn @ XX))))))))).
