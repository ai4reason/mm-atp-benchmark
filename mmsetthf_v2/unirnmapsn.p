...
thf(aunirnmap_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwss @ XX @ (cco @ XB2 @ XA2 @ ccmap))) => (Xph => (cwss @ XX @ (cco @ (ccrn @ (ccuni @ XX)) @ XA2 @ ccmap))))))))))).
...
thf(arnsnf_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ (ccsn @ XA2) @ XB2 @ XF)) => (Xph => ((ccrn @ XF) = (ccsn @ (ccfv @ XA2 @ XF)))))))))))).
...
thf(afsneq_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((XB2 = (ccsn @ XA2)) => ((Xph => (cwfn @ XF @ XB2)) => ((Xph => (cwfn @ XG @ XB2)) => (Xph => ((XF = XG) <=> ((ccfv @ XA2 @ XF) = (ccfv @ XA2 @ XG))))))))))))))).
...
thf(cunirnmapsn_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwcel @ XB2 @ XW)) => ((XC = (ccsn @ XA2)) => ((Xph => (cwss @ XX @ (cco @ XB2 @ XC @ ccmap))) => (Xph => (XX = (cco @ (ccrn @ (ccuni @ XX)) @ XC @ ccmap))))))))))))))).
