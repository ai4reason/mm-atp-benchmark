...
thf(alt2msq1_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ ((cwcel @ XA2 @ ccr) & (cwbr @ ccc0 @ XA2 @ ccle)) @ (cwcel @ XB2 @ ccr) @ (cwbr @ XA2 @ XB2 @ cclt)) => (cwbr @ (cco @ XA2 @ XA2 @ ccmul) @ (cco @ XB2 @ XB2 @ ccmul) @ cclt))))).
...
thf(alttrid_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => (Xph => ((cwbr @ XA2 @ XB2 @ cclt) <=> (~ ((XA2 = XB2) | (cwbr @ XB2 @ XA2 @ cclt))))))))))).
