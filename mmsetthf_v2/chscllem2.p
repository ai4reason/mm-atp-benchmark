...
thf(achscllem1_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XA2 @ ccch))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XB2 @ ccch))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwss @ XB2 @ (ccfv @ XA2 @ ccort)))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwf @ ccn @ (cco @ XA2 @ XB2 @ ccph) @ XH))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwbr @ XH @ (ccv @ Xu) @ cchli))) => ((! [Xu:$i] : (! [Xn:$i] : ((XF @ Xu @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XH) @ (ccfv @ XA2 @ ccpjh))))))) => (! [Xu:$i] : (! [Xn:$i] : ((Xph @ Xu) => (cwf @ ccn @ XA2 @ (XF @ Xu @ Xn))))))))))))))))).
thf(asyl_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(achss_ax,axiom,(! [XH:($i > $o)] : ((cwcel @ XH @ ccch) => (cwss @ XH @ cchil)))).
...
thf(ahcaucvg_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (((cwcel @ XF @ cccau) & (cwcel @ XA2 @ ccrp)) => (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xz) @ XF) @ ccmv) @ ccno) @ XA2 @ cclt)) @ (^ [Xz:$i] : (ccfv @ (ccv @ Xy1) @ ccuz)))) @ (^ [Xy1:$i] : ccn)))))).
...
thf(ahvsubsub4_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) & ((cwcel @ XC @ cchil) & (cwcel @ XD @ cchil))) => ((cco @ (cco @ XA2 @ XB2 @ ccmv) @ (cco @ XC @ XD @ ccmv) @ ccmv) = (cco @ (cco @ XA2 @ XC @ ccmv) @ (cco @ XB2 @ XD @ ccmv) @ ccmv)))))))).
thf(ccmul_tp,type,(ccmul : ($i > $o))).
thf(ccrab_tp,type,(ccrab : (($i > $o) > (($i > ($i > $o)) > ($i > $o))))).
thf(aocsh_ax,axiom,(! [XA2:($i > $o)] : ((cwss @ XA2 @ cchil) => (cwcel @ (ccfv @ XA2 @ ccort) @ ccsh)))).
...
thf(ashscom_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccsh) & (cwcel @ XB2 @ ccsh)) => ((cco @ XA2 @ XB2 @ ccph) = (cco @ XB2 @ XA2 @ ccph)))))).
...
thf(ashocorth_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XH:($i > $o)] : ((cwcel @ XH @ ccsh) => (((cwcel @ XA2 @ XH) & (cwcel @ XB2 @ (ccfv @ XH @ ccort))) => ((cco @ XA2 @ XB2 @ ccsp) = ccc0))))))).
thf(anormpyth_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => (((cco @ XA2 @ XB2 @ ccsp) = ccc0) => ((cco @ (ccfv @ (cco @ XA2 @ XB2 @ ccva) @ ccno) @ cc2 @ ccexp) = (cco @ (cco @ (ccfv @ XA2 @ ccno) @ cc2 @ ccexp) @ (cco @ (ccfv @ XB2 @ ccno) @ cc2 @ ccexp) @ ccaddc))))))).
thf(aoveq1d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XA2 @ XC @ XF) = (cco @ XB2 @ XC @ XF)))))))))).
thf(ahvpncan3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ cchil) & (cwcel @ XB2 @ cchil)) => ((cco @ XA2 @ (cco @ XB2 @ XA2 @ ccmv) @ ccva) = XB2))))).
...
thf(ahcau_ax,axiom,(! [XF:($i > $o)] : ((cwcel @ XF @ cccau) <=> ((cwf @ ccn @ cchil @ XF) & (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwral @ (^ [Xz:$i] : (cwbr @ (ccfv @ (cco @ (ccfv @ (ccv @ Xy1) @ XF) @ (ccfv @ (ccv @ Xz) @ XF) @ ccmv) @ ccno) @ (ccv @ Xx3) @ cclt)) @ (^ [Xz:$i] : (ccfv @ (ccv @ Xy1) @ ccuz)))) @ (^ [Xy1:$i] : ccn))) @ (^ [Xx3:$i] : ccrp)))))).
...
thf(ahlimf_ax,axiom,(cwf @ (ccdm @ cchli) @ cchil @ cchli)).
thf(ccrn_tp,type,(ccrn : (($i > $o) > ($i > $o)))).
thf(affn_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) => (cwfn @ XF @ XA2)))))).
thf(afnbr_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (((cwfn @ XF @ XA2) & (cwbr @ XB2 @ XC @ XF)) => (cwcel @ XB2 @ XA2))))))).
thf(cchscllem2_conj,conjecture,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > ($i > ($i > $o)))] : (! [XH:($i > $o)] : ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XA2 @ ccch))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwcel @ XB2 @ ccch))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwss @ XB2 @ (ccfv @ XA2 @ ccort)))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwf @ ccn @ (cco @ XA2 @ XB2 @ ccph) @ XH))) => ((! [Xu:$i] : ((Xph @ Xu) => (cwbr @ XH @ (ccv @ Xu) @ cchli))) => ((! [Xu:$i] : (! [Xn:$i] : ((XF @ Xu @ Xn) = (ccmpt @ (^ [Xn:$i] : ccn) @ (^ [Xn:$i] : (ccfv @ (ccfv @ (ccv @ Xn) @ XH) @ (ccfv @ XA2 @ ccpjh))))))) => (! [Xu:$i] : (! [Xn:$i] : ((Xph @ Xu) => (cwcel @ (XF @ Xu @ Xn) @ (ccdm @ cchli))))))))))))))))).
