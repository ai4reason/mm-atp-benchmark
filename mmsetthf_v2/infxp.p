...
thf(cinfxp_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ (ccdm @ cccrd)) & (cwbr @ ccom @ XA2 @ ccdom)) & ((cwcel @ XB2 @ (ccdm @ cccrd)) & (cwne @ XB2 @ cc0))) => (cwbr @ (ccxp @ XA2 @ XB2) @ (ccun @ XA2 @ XB2) @ ccen))))).
