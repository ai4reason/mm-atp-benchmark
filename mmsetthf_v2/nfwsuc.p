...
thf(cnfwsuc_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((cwnfc @ (^ [Xx3:$i] : (XR @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XA2 @ Xx3))) => ((cwnfc @ (^ [Xx3:$i] : (XX @ Xx3))) => (cwnfc @ (^ [Xx3:$i] : (ccwsuc @ (XA2 @ Xx3) @ (XR @ Xx3) @ (XX @ Xx3))))))))))).
