...
thf(adih1dimb2_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [XB2:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XU:($i > ($i > ($i > $o)))] : (! [XH:($i > ($i > $o))] : (! [XI:($i > ($i > ($i > $o)))] : (! [XK:($i > $o)] : (! [Xc_le:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > $o)))] : (! [XO:($i > ($i > ($i > $o)))] : (! [XW:($i > $o)] : ((! [Xf1:$i] : ((XB2 @ Xf1) = (ccfv @ XK @ ccbs))) => ((! [Xh:$i] : ((Xc_le @ Xh) = (ccfv @ XK @ ccple))) => ((! [Xh:$i] : ((XA2 @ Xh) = (ccfv @ XK @ ccatm))) => ((! [Xh:$i] : ((XH @ Xh) = (ccfv @ XK @ cclh))) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xf1:$i] : (! [Xh:$i] : ((XO @ Xf1 @ Xh) = (ccmpt @ (^ [Xh:$i] : XT) @ (^ [Xh:$i] : (ccres @ ccid @ (XB2 @ Xf1))))))) => ((! [Xf1:$i] : (! [Xh:$i] : ((XU @ Xf1 @ Xh) = (ccfv @ XW @ (ccfv @ XK @ ccdvh))))) => ((! [Xf1:$i] : (! [Xh:$i] : ((XI @ Xf1 @ Xh) = (ccfv @ XW @ (ccfv @ XK @ ccdih))))) => ((! [Xf1:$i] : (! [Xh:$i] : ((XN @ Xf1 @ Xh) = (ccfv @ (XU @ Xf1 @ Xh) @ cclspn)))) => (! [Xh:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ (XH @ Xh))) & ((cwcel @ (XQ @ Xh) @ (XA2 @ Xh)) & (cwbr @ (XQ @ Xh) @ XW @ (Xc_le @ Xh)))) => (cwrex @ (^ [Xf1:$i] : ((cwne @ (ccv @ Xf1) @ (ccres @ ccid @ (XB2 @ Xf1))) & ((ccfv @ (XQ @ Xh) @ (XI @ Xf1 @ Xh)) = (ccfv @ (ccsn @ (ccop @ (ccv @ Xf1) @ (XO @ Xf1 @ Xh))) @ (XN @ Xf1 @ Xh))))) @ (^ [Xf1:$i] : XT)))))))))))))))))))))))))).
...
thf(advhelvbasei_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XH:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : ((XH = (ccfv @ XK @ cclh)) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((XE = (ccfv @ XW @ (ccfv @ XK @ cctendo))) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((XV = (ccfv @ XU @ ccbs)) => ((((cwcel @ XK @ XX) & (cwcel @ XW @ XH)) & ((cwcel @ XF @ XT) & (cwcel @ XS @ XE))) => (cwcel @ (ccop @ XF @ XS) @ XV)))))))))))))))))).
...
thf(alsatlspsn2_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XV = (ccfv @ XW @ ccbs)) => ((XN = (ccfv @ XW @ cclspn)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XA2 = (ccfv @ XW @ cclsa)) => ((cw3a @ (cwcel @ XW @ cclmod) @ (cwcel @ XX @ XV) @ (cwne @ XX @ Xc_0)) => (cwcel @ (ccfv @ (ccsn @ XX) @ XN) @ XA2))))))))))))).
thf(ccdic_tp,type,(ccdic : ($i > $o))).
thf(adih1dimc_ax,axiom,(! [XA2:($i > $o)] : (! [XP:($i > $o)] : (! [XQ:($i > $o)] : (! [XT:($i > $o)] : (! [XU:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XH:($i > $o)] : (! [XI:($i > ($i > $o))] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > $o)] : ((Xc_le = (ccfv @ XK @ ccple)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XH = (ccfv @ XK @ cclh)) => ((XP = (ccfv @ XW @ (ccfv @ XK @ ccoc))) => ((XT = (ccfv @ XW @ (ccfv @ XK @ ccltrn))) => ((! [Xf1:$i] : ((XI @ Xf1) = (ccfv @ XW @ (ccfv @ XK @ ccdih)))) => ((! [Xf1:$i] : ((XU @ Xf1) = (ccfv @ XW @ (ccfv @ XK @ ccdvh)))) => ((! [Xf1:$i] : ((XN @ Xf1) = (ccfv @ (XU @ Xf1) @ cclspn))) => ((! [Xf1:$i] : ((XF @ Xf1) = (ccrio @ (^ [Xf1:$i] : ((ccfv @ XP @ (ccv @ Xf1)) = XQ)) @ (^ [Xf1:$i] : XT)))) => (! [Xf1:$i] : ((((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) & ((cwcel @ XQ @ XA2) & (~ (cwbr @ XQ @ XW @ Xc_le)))) => ((ccfv @ XQ @ (XI @ Xf1)) = (ccfv @ (ccsn @ (ccop @ (XF @ Xf1) @ (ccres @ ccid @ XT))) @ (XN @ Xf1))))))))))))))))))))))))))).
