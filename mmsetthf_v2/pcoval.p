...
thf(apcofval_ax,axiom,(! [XJ:($i > $o)] : ((ccfv @ XJ @ ccpco) = (ccmpt2 @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ ccii @ XJ @ cccn))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (cco @ ccii @ XJ @ cccn))) @ (^ [Xf1:$i] : (^ [Xg1:$i] : (ccmpt @ (^ [Xx3:$i] : (cco @ ccc0 @ cc1 @ ccicc)) @ (^ [Xx3:$i] : (ccif @ (cwbr @ (ccv @ Xx3) @ (cco @ cc1 @ cc2 @ ccdiv) @ ccle) @ (ccfv @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul) @ (ccv @ Xf1)) @ (ccfv @ (cco @ (cco @ cc2 @ (ccv @ Xx3) @ ccmul) @ cc1 @ ccmin) @ (ccv @ Xg1))))))))))).
