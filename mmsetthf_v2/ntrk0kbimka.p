...
thf(cntrk0kbimka_conj,conjecture,(! [XB2:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > ($i > ($i > $o)))] : (! [Xt:$i] : (! [Xs1:$i] : (((cwcel @ XB2 @ (XV @ Xt @ Xs1)) & (cwcel @ XI @ (cco @ (ccpw @ XB2) @ (ccpw @ XB2) @ ccmap))) => ((((ccfv @ XB2 @ XI) = XB2) & (cwral @ (^ [Xs1:$i] : (cwral @ (^ [Xt:$i] : (((ccin @ (ccv @ Xs1) @ (ccv @ Xt)) = cc0) => ((ccin @ (ccfv @ (ccv @ Xs1) @ XI) @ (ccfv @ (ccv @ Xt) @ XI)) = cc0))) @ (^ [Xt:$i] : (ccpw @ XB2)))) @ (^ [Xs1:$i] : (ccpw @ XB2)))) => ((ccfv @ cc0 @ XI) = cc0))))))))).
