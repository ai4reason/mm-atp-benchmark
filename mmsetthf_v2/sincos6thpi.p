...
thf(aredivcli_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwne @ XB2 @ ccc0) => (cwcel @ (cco @ XA2 @ XB2 @ ccdiv) @ ccr))))))).
...
thf(asincosq1eq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XB2 @ ccc) @ ((cco @ XA2 @ XB2 @ ccaddc) = cc1)) => ((ccfv @ (cco @ XA2 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccmul) @ ccsin) = (ccfv @ (cco @ XB2 @ (cco @ ccpi @ cc2 @ ccdiv) @ ccmul) @ cccos)))))).
...
thf(adivgt0ii_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => ((cwbr @ ccc0 @ XA2 @ cclt) => ((cwbr @ ccc0 @ XB2 @ cclt) => (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccdiv) @ cclt)))))))).
...
thf(asqrtpclii_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwbr @ ccc0 @ XA2 @ cclt) => (cwcel @ (ccfv @ XA2 @ ccsqrt) @ ccr))))).
...
thf(adivge0i_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwcel @ XA2 @ ccr) => ((cwcel @ XB2 @ ccr) => (((cwbr @ ccc0 @ XA2 @ ccle) & (cwbr @ ccc0 @ XB2 @ cclt)) => (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccdiv) @ ccle))))))).
...
thf(asqrecii_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cwne @ XA2 @ ccc0) => ((cco @ (cco @ cc1 @ XA2 @ ccdiv) @ cc2 @ ccexp) = (cco @ cc1 @ (cco @ XA2 @ cc2 @ ccexp) @ ccdiv)))))).
thf(asincossq_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccc) => ((cco @ (cco @ (ccfv @ XA2 @ ccsin) @ cc2 @ ccexp) @ (cco @ (ccfv @ XA2 @ cccos) @ cc2 @ ccexp) @ ccaddc) = cc1)))).
thf(csincos6thpi_conj,conjecture,(((ccfv @ (cco @ ccpi @ cc6 @ ccdiv) @ ccsin) = (cco @ cc1 @ cc2 @ ccdiv)) & ((ccfv @ (cco @ ccpi @ cc6 @ ccdiv) @ cccos) = (cco @ (ccfv @ cc3 @ ccsqrt) @ cc2 @ ccdiv)))).
