...
thf(aresdisj_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((ccin @ XA2 @ XB2) = cc0) => ((ccres @ (ccres @ XC @ XA2) @ XB2) = cc0)))))).
...
thf(cfvsnun1_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XB2 @ ccvv) => ((XG = (ccun @ (ccsn @ (ccop @ XA2 @ XB2)) @ (ccres @ XF @ (ccdif @ XC @ (ccsn @ XA2))))) => ((ccfv @ XA2 @ XG) = XB2)))))))))).
