...
thf(adf_lss_ax,axiom,(cclss = (ccmpt @ (^ [Xw:$i] : ccvv) @ (^ [Xw:$i] : (ccrab @ (^ [Xs1:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwcel @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xa) @ (ccfv @ (ccv @ Xw) @ ccvsca)) @ (ccv @ Xb) @ (ccfv @ (ccv @ Xw) @ ccplusg)) @ (ccv @ Xs1))) @ (^ [Xb:$i] : (ccv @ Xs1)))) @ (^ [Xa:$i] : (ccv @ Xs1)))) @ (^ [Xx3:$i] : (ccfv @ (ccfv @ (ccv @ Xw) @ ccsca) @ ccbs)))) @ (^ [Xs1:$i] : (ccdif @ (ccpw @ (ccfv @ (ccv @ Xw) @ ccbs)) @ (ccsn @ cc0)))))))).
...
thf(clssset_conj,conjecture,(! [XB2:($i > ($i > ($i > $o)))] : (! [Xc_pl:($i > ($i > ($i > ($i > $o))))] : (! [XS:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [Xc_x:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > ($i > ($i > ($i > ($i > $o)))))] : (! [XV:($i > ($i > ($i > ($i > $o))))] : (! [XW:($i > $o)] : (! [XX:($i > ($i > ($i > ($i > ($i > $o)))))] : ((! [Xx3:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XF @ Xx3 @ Xs1 @ Xa @ Xb) = (ccfv @ XW @ ccsca)))))) => ((! [Xx3:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XB2 @ Xa @ Xb) = (ccfv @ (XF @ Xx3 @ Xs1 @ Xa @ Xb) @ ccbs)))))) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XV @ Xx3 @ Xa @ Xb) = (ccfv @ XW @ ccbs))))) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xc_pl @ Xx3 @ Xa @ Xb) = (ccfv @ XW @ ccplusg))))) => ((! [Xx3:$i] : (! [Xa:$i] : (! [Xb:$i] : ((Xc_x @ Xx3 @ Xa @ Xb) = (ccfv @ XW @ ccvsca))))) => ((! [Xx3:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((XS @ Xx3 @ Xs1 @ Xa @ Xb) = (ccfv @ XW @ cclss)))))) => (! [Xx3:$i] : (! [Xs1:$i] : (! [Xa:$i] : (! [Xb:$i] : ((cwcel @ XW @ (XX @ Xx3 @ Xs1 @ Xa @ Xb)) => ((XS @ Xx3 @ Xs1 @ Xa @ Xb) = (ccrab @ (^ [Xs1:$i] : (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwcel @ (cco @ (cco @ (ccv @ Xx3) @ (ccv @ Xa) @ (Xc_x @ Xx3 @ Xa @ Xb)) @ (ccv @ Xb) @ (Xc_pl @ Xx3 @ Xa @ Xb)) @ (ccv @ Xs1))) @ (^ [Xb:$i] : (ccv @ Xs1)))) @ (^ [Xa:$i] : (ccv @ Xs1)))) @ (^ [Xx3:$i] : (XB2 @ Xa @ Xb)))) @ (^ [Xs1:$i] : (ccdif @ (ccpw @ (XV @ Xx3 @ Xa @ Xb)) @ (ccsn @ cc0))))))))))))))))))))))))).
