...
thf(a_1marepvmarrepid_ax,axiom,(! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => ((Xc_1 = (ccfv @ (cco @ XN @ XR @ ccmat) @ ccur)) => ((XX = (ccfv @ XI @ (cco @ Xc_1 @ XZ @ (cco @ XN @ XR @ ccmatrepV)))) => ((((cwcel @ XR @ ccrg) & (cwcel @ XN @ ccfn)) & ((cwcel @ XI @ XN) & (cwcel @ XZ @ XV))) => ((cco @ XI @ XI @ (cco @ XX @ (ccfv @ XI @ XZ) @ (cco @ XN @ XR @ ccmarrep))) = XX))))))))))))).
...
thf(asmadiadetr_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XK:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : ((((cwcel @ XR @ cccrg) & (cwcel @ XM @ (ccfv @ (cco @ XN @ XR @ ccmat) @ ccbs))) & ((cwcel @ XK @ XN) & (cwcel @ XS @ (ccfv @ XR @ ccbs)))) => ((ccfv @ (cco @ XK @ XK @ (cco @ XM @ XS @ (cco @ XN @ XR @ ccmarrep))) @ (cco @ XN @ XR @ ccmdat)) = (cco @ XS @ (ccfv @ (cco @ XK @ XK @ (ccfv @ XM @ (cco @ XN @ XR @ ccsubma))) @ (cco @ (ccdif @ XN @ (ccsn @ XK)) @ XR @ ccmdat)) @ (ccfv @ XR @ ccmulr)))))))))).
thf(aoveq2d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((Xph => (XA2 = XB2)) => (Xph => ((cco @ XC @ XA2 @ XF) = (cco @ XC @ XB2 @ XF)))))))))).
thf(a_1marepvsma1_ax,axiom,(! [XR:($i > $o)] : (! [Xc_1:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (! [XZ:($i > $o)] : ((XV = (cco @ (ccfv @ XR @ ccbs) @ XN @ ccmap)) => ((Xc_1 = (ccfv @ (cco @ XN @ XR @ ccmat) @ ccur)) => ((XX = (ccfv @ XI @ (cco @ Xc_1 @ XZ @ (cco @ XN @ XR @ ccmatrepV)))) => ((((cwcel @ XR @ ccrg) & (cwcel @ XN @ ccfn)) & ((cwcel @ XI @ XN) & (cwcel @ XZ @ XV))) => ((cco @ XI @ XI @ (ccfv @ XX @ (cco @ XN @ XR @ ccsubma))) = (ccfv @ (cco @ (ccdif @ XN @ (ccsn @ XI)) @ XR @ ccmat) @ ccur)))))))))))))).
