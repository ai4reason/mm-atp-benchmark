...
thf(apnfged_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccxr)) => (Xph => (cwbr @ XA2 @ ccpnf @ ccle)))))).
...
thf(cxlimpnfvlem2_conj,conjecture,(! [Xph:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XM:($i > ($i > ($i > $o)))] : (! [XZ:($i > ($i > $o))] : ((! [Xj:$i] : (cwnf @ (^ [Xk:$i] : (Xph @ Xj @ Xk)))) => ((! [Xk:$i] : (cwnf @ (^ [Xj:$i] : (Xph @ Xj @ Xk)))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwcel @ (XM @ Xx3 @ Xk) @ ccz))))) => ((! [Xx3:$i] : (! [Xk:$i] : ((XZ @ Xx3) = (ccfv @ (XM @ Xx3 @ Xk) @ ccuz)))) => ((! [Xx3:$i] : (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwf @ (XZ @ Xx3) @ ccxr @ XF))))) => ((! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xj:$i] : (cwral @ (^ [Xk:$i] : (cwbr @ (ccv @ Xx3) @ (ccfv @ (ccv @ Xk) @ XF) @ cclt)) @ (^ [Xk:$i] : (ccfv @ (ccv @ Xj) @ ccuz)))) @ (^ [Xj:$i] : (XZ @ Xx3)))) @ (^ [Xx3:$i] : ccr))))) => (! [Xj:$i] : (! [Xk:$i] : ((Xph @ Xj @ Xk) => (cwbr @ XF @ ccpnf @ cclsxlim))))))))))))))).
