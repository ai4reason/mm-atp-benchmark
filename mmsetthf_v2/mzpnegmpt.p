...
thf(cmzpnegmpt_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XV:($i > $o)] : ((cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccz @ XV @ ccmap)) @ (^ [Xx3:$i] : (XA2 @ Xx3))) @ (ccfv @ XV @ ccmzp)) => (cwcel @ (ccmpt @ (^ [Xx3:$i] : (cco @ ccz @ XV @ ccmap)) @ (^ [Xx3:$i] : (ccneg @ (XA2 @ Xx3)))) @ (ccfv @ XV @ ccmzp)))))).
