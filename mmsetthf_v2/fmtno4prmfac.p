...
thf(afmtnoprmfac2_ax,axiom,(! [XP:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XN @ (ccfv @ cc2 @ ccuz)) @ (cwcel @ XP @ ccprime) @ (cwbr @ XP @ (ccfv @ XN @ ccfmtno) @ ccdvds)) => (cwrex @ (^ [Xk:$i] : (XP = (cco @ (cco @ (ccv @ Xk) @ (cco @ cc2 @ (cco @ XN @ cc2 @ ccaddc) @ ccexp) @ ccmul) @ cc1 @ ccaddc))) @ (^ [Xk:$i] : ccn)))))).
...
thf(afzo1to4tp_ax,axiom,((cco @ cc1 @ cc4 @ ccfzo) = (cctp @ cc1 @ cc2 @ cc3))).
...
thf(afmtno4sqrt_ax,axiom,((ccfv @ (ccfv @ (ccfv @ cc4 @ ccfmtno) @ ccsqrt) @ ccfl) = (ccdc @ (ccdc @ cc2 @ cc5) @ cc6))).
...
thf(cfmtno4prmfac_conj,conjecture,(! [XP:($i > $o)] : ((cw3a @ (cwcel @ XP @ ccprime) @ (cwbr @ XP @ (ccfv @ cc4 @ ccfmtno) @ ccdvds) @ (cwbr @ XP @ (ccfv @ (ccfv @ (ccfv @ cc4 @ ccfmtno) @ ccsqrt) @ ccfl) @ ccle)) => (cw3o @ (XP = (ccdc @ cc6 @ cc5)) @ (XP = (ccdc @ (ccdc @ cc1 @ cc2) @ cc9)) @ (XP = (ccdc @ (ccdc @ cc1 @ cc9) @ cc3)))))).
