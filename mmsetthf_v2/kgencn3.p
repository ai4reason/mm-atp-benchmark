...
thf(acnvresima_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((ccima @ (cccnv @ (ccres @ XF @ XA2)) @ XB2) = (ccin @ (ccima @ (cccnv @ XF) @ XB2) @ XA2)))))).
...
thf(ainpreima_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwfun @ XF) => ((ccima @ (cccnv @ XF) @ (ccin @ XA2 @ XB2)) = (ccin @ (ccima @ (cccnv @ XF) @ XA2) @ (ccima @ (cccnv @ XF) @ XB2)))))))).
thf(ain32_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((ccin @ (ccin @ XA2 @ XB2) @ XC) = (ccin @ (ccin @ XA2 @ XC) @ XB2)))))).
...
thf(akgentop_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ (ccrn @ cckgen)) => (cwcel @ XJ @ cctop)))).
...
thf(akgenidm_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ (ccrn @ cckgen)) => ((ccfv @ XJ @ cckgen) = XJ)))).
thf(asyl2an_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : (! [Xta:$o] : ((Xph => Xps) => ((Xta => Xch) => (((Xps & Xch) => Xth) => ((Xph & Xta) => Xth)))))))))).
thf(asylbi_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph <=> Xps) => ((Xps => Xch) => (Xph => Xch))))))).
thf(cciun_tp,type,(cciun : (($i > ($i > $o)) > (($i > ($i > $o)) > ($i > $o))))).
thf(akgentopon_ax,axiom,(! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XJ @ (ccfv @ XX @ cctopon)) => (cwcel @ (ccfv @ XJ @ cckgen) @ (ccfv @ XX @ cctopon)))))).
...
thf(atoponcom_ax,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XJ @ cctop) & (cwcel @ XK @ (ccfv @ (ccuni @ XJ) @ cctopon))) => (cwcel @ XJ @ (ccfv @ (ccuni @ XK) @ cctopon)))))).
thf(akgenss_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ cctop) => (cwss @ XJ @ (ccfv @ XJ @ cckgen))))).
thf(acnss2_ax,axiom,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XL:($i > $o)] : (! [XY:($i > $o)] : ((XY = (ccuni @ XK)) => (((cwcel @ XL @ (ccfv @ XY @ cctopon)) & (cwss @ XL @ XK)) => (cwss @ (cco @ XJ @ XK @ cccn) @ (cco @ XJ @ XL @ cccn))))))))).
thf(ckgencn3_conj,conjecture,(! [XJ:($i > $o)] : (! [XK:($i > $o)] : (((cwcel @ XJ @ (ccrn @ cckgen)) & (cwcel @ XK @ cctop)) => ((cco @ XJ @ XK @ cccn) = (cco @ XJ @ (ccfv @ XK @ cckgen) @ cccn)))))).
