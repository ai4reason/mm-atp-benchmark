...
thf(adf_fullfun_ax,axiom,(! [XF:($i > $o)] : ((ccfullfn @ XF) = (ccun @ (ccfunpart @ XF) @ (ccxp @ (ccdif @ ccvv @ (ccdm @ (ccfunpart @ XF))) @ (ccsn @ cc0)))))).
...
thf(afunpartfun_ax,axiom,(! [XF:($i > $o)] : (cwfun @ (ccfunpart @ XF)))).
...
thf(afunpartfv_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((ccfv @ XA2 @ (ccfunpart @ XF)) = (ccfv @ XA2 @ XF))))).
thf(afvprc_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((~ (cwcel @ XA2 @ ccvv)) => ((ccfv @ XA2 @ XF) = cc0))))).
thf(cfullfunfv_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : ((ccfv @ XA2 @ (ccfullfn @ XF)) = (ccfv @ XA2 @ XF))))).
