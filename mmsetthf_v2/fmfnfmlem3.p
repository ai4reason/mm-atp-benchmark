...
thf(cfmfnfmlem3_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XL:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwcel @ XB2 @ (ccfv @ XY @ ccfbas))) => ((Xph => (cwcel @ XL @ (ccfv @ XX @ ccfil))) => ((Xph => (cwf @ XY @ XX @ XF)) => ((Xph => (cwss @ (ccfv @ XB2 @ (cco @ XX @ XF @ ccfm)) @ XL)) => (Xph => ((ccfv @ (ccrn @ (ccmpt @ (^ [Xx3:$i] : XL) @ (^ [Xx3:$i] : (ccima @ (cccnv @ XF) @ (ccv @ Xx3))))) @ ccfi) = (ccrn @ (ccmpt @ (^ [Xx3:$i] : XL) @ (^ [Xx3:$i] : (ccima @ (cccnv @ XF) @ (ccv @ Xx3)))))))))))))))))).
