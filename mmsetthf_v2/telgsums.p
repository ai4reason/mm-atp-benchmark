...
thf(agsummptnn0fzv_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((! [Xk:$i] : (XB2 = (ccfv @ (XG @ Xk) @ ccbs))) => ((! [Xk:$i] : (Xc_0 = (ccfv @ (XG @ Xk) @ cc0g))) => ((! [Xk:$i] : (Xph => (cwcel @ (XG @ Xk) @ cccmn))) => ((Xph => (cwral @ (^ [Xk:$i] : (cwcel @ (XC @ Xk) @ XB2)) @ (^ [Xk:$i] : ccn0))) => ((Xph => (cwcel @ XS @ ccn0)) => ((Xph => (cwral @ (^ [Xk:$i] : ((cwbr @ XS @ (ccv @ Xk) @ cclt) => ((XC @ Xk) = Xc_0))) @ (^ [Xk:$i] : ccn0))) => (! [Xk:$i] : (Xph => ((cco @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : ccn0) @ (^ [Xk:$i] : (XC @ Xk))) @ ccgsu) = (cco @ (XG @ Xk) @ (ccmpt @ (^ [Xk:$i] : (cco @ ccc0 @ XS @ ccfz)) @ (^ [Xk:$i] : (XC @ Xk))) @ ccgsu))))))))))))))))).
...
thf(arspsbca_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > ($i > $o))] : (! [XB2:($i > $o)] : (! [Xx3:$i] : (((cwcel @ (XA2 @ Xx3) @ XB2) & (cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XB2))) => (cwsbc @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (XA2 @ Xx3)))))))).
...
thf(ctelgsums_conj,conjecture,(! [Xph:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XS:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [Xc_mi:($i > ($i > $o))] : (! [Xc_0:($i > $o)] : ((! [Xk:$i] : (XB2 = (ccfv @ (XG @ Xk) @ ccbs))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ (XG @ Xk) @ ccabl))) => ((! [Xk:$i] : ((Xc_mi @ Xk) = (ccfv @ (XG @ Xk) @ ccsg))) => ((! [Xk:$i] : (Xc_0 = (ccfv @ (XG @ Xk) @ cc0g))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwral @ (^ [Xk:$i] : (cwcel @ (XC @ Xk) @ XB2)) @ (^ [Xk:$i] : ccn0)))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwcel @ XS @ ccn0))) => ((! [Xk:$i] : ((Xph @ Xk) => (cwral @ (^ [Xk:$i] : ((cwbr @ XS @ (ccv @ Xk) @ cclt) => ((XC @ Xk) = Xc_0))) @ (^ [Xk:$i] : ccn0)))) => (! [Xk:$i] : ((Xph @ Xk) => ((cco @ (XG @ Xk) @ (ccmpt @ (^ [Xi:$i] : ccn0) @ (^ [Xi:$i] : (cco @ (ccsb @ (ccv @ Xi) @ (^ [Xk:$i] : (XC @ Xk))) @ (ccsb @ (cco @ (ccv @ Xi) @ cc1 @ ccaddc) @ (^ [Xk:$i] : (XC @ Xk))) @ (Xc_mi @ Xk)))) @ ccgsu) = (ccsb @ ccc0 @ (^ [Xk:$i] : (XC @ Xk))))))))))))))))))))).
