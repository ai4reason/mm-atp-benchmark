...
thf(awlkon2n0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (((cwbr @ XF @ XP @ (cco @ XA2 @ XB2 @ (ccfv @ XG @ ccwlkson))) & (cwne @ XA2 @ XB2)) => (cwne @ (ccfv @ XF @ cchash) @ ccc0)))))))).
...
thf(awlkonl1iedg_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : ((XI = (ccfv @ XG @ cciedg)) => (! [Xe:$i] : (((cwbr @ XF @ XP @ (cco @ XA2 @ (XB2 @ Xe) @ (ccfv @ XG @ ccwlkson))) & (cwne @ (ccfv @ XF @ cchash) @ ccc0)) => (cwrex @ (^ [Xe:$i] : (cwcel @ XA2 @ (ccv @ Xe))) @ (^ [Xe:$i] : (ccrn @ XI))))))))))))).
thf(cconngrv2edg_conj,conjecture,(! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XN:($i > $o)] : (! [XV:($i > ($i > $o))] : ((! [Xe:$i] : ((XV @ Xe) = (ccfv @ XG @ ccvtx))) => ((XI = (ccfv @ XG @ cciedg)) => (! [Xe:$i] : ((cw3a @ (cwcel @ XG @ ccconngr) @ (cwcel @ XN @ (XV @ Xe)) @ (cwbr @ cc1 @ (ccfv @ (XV @ Xe) @ cchash) @ cclt)) => (cwrex @ (^ [Xe:$i] : (cwcel @ XN @ (ccv @ Xe))) @ (^ [Xe:$i] : (ccrn @ XI)))))))))))).
