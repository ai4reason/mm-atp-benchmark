...
thf(aralss_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cwss @ XA2 @ XB2) => ((cwral @ (^ [Xx3:$i] : (Xph @ Xx3)) @ (^ [Xx3:$i] : XA2)) <=> (cwral @ (^ [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XA2) => (Xph @ Xx3))) @ (^ [Xx3:$i] : XB2)))))))).
...
thf(ariinrab_ax,axiom,(! [Xph:($i > ($i > $o))] : (! [XA2:($i > $o)] : (! [XX:($i > $o)] : ((ccin @ XA2 @ (cciin @ (^ [Xx3:$i] : XX) @ (^ [Xx3:$i] : (ccrab @ (^ [Xy1:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xy1:$i] : XA2))))) = (ccrab @ (^ [Xy1:$i] : (cwral @ (^ [Xx3:$i] : (Xph @ Xx3 @ Xy1)) @ (^ [Xx3:$i] : XX))) @ (^ [Xy1:$i] : XA2))))))).
...
thf(amreacs_ax,axiom,(! [XV:($i > $o)] : (! [XX:($i > $o)] : ((cwcel @ XX @ XV) => (cwcel @ (ccfv @ XX @ ccacs) @ (ccfv @ (ccpw @ XX) @ ccmre)))))).
...
thf(aacsfn_ax,axiom,(! [XT:($i > $o)] : (! [XK:($i > $o)] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : ((((cwcel @ XX @ XV) & (cwcel @ XK @ XX)) & ((cwss @ XT @ XX) & (cwcel @ XT @ ccfn))) => (cwcel @ (ccrab @ (^ [Xa:$i] : ((cwss @ XT @ (ccv @ Xa)) => (cwcel @ XK @ (ccv @ Xa)))) @ (^ [Xa:$i] : (ccpw @ XX))) @ (ccfv @ XX @ ccacs)))))))).
thf(amreriincl_ax,axiom,(! [XC:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XC @ (ccfv @ XX @ ccmre)) & (cwral @ (^ [Xy1:$i] : (cwcel @ (XS @ Xy1) @ XC)) @ (^ [Xy1:$i] : XI))) => (cwcel @ (ccin @ XX @ (cciin @ (^ [Xy1:$i] : XI) @ (^ [Xy1:$i] : (XS @ Xy1)))) @ XC))))))).
thf(cacsfn2_conj,conjecture,(! [XE:($i > ($i > ($i > $o)))] : (! [XV:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XX @ XV) & (cwral @ (^ [Xb:$i] : (cwral @ (^ [Xc:$i] : (cwcel @ (XE @ Xb @ Xc) @ XX)) @ (^ [Xc:$i] : XX))) @ (^ [Xb:$i] : XX))) => (cwcel @ (ccrab @ (^ [Xa:$i] : (cwral @ (^ [Xb:$i] : (cwral @ (^ [Xc:$i] : (cwcel @ (XE @ Xb @ Xc) @ (ccv @ Xa))) @ (^ [Xc:$i] : (ccv @ Xa)))) @ (^ [Xb:$i] : (ccv @ Xa)))) @ (^ [Xa:$i] : (ccpw @ XX))) @ (ccfv @ XX @ ccacs))))))).
