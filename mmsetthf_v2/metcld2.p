...
thf(ametcld_ax,axiom,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwss @ XS @ XX)) => ((cwcel @ XS @ (ccfv @ XJ @ cccld)) <=> (! [Xx3:$i] : (! [Xf1:$i] : (((cwf @ ccn @ XS @ (ccv @ Xf1)) & (cwbr @ (ccv @ Xf1) @ (ccv @ Xx3) @ (ccfv @ XJ @ cclm))) => (cwcel @ (ccv @ Xx3) @ XS)))))))))))).
...
thf(aelima2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cwcel @ XA2 @ ccvv) => ((cwcel @ XA2 @ (ccima @ XB2 @ XC)) <=> (? [Xx3:$i] : ((cwcel @ (ccv @ Xx3) @ XC) & (cwbr @ (ccv @ Xx3) @ XA2 @ XB2))))))))).
...
thf(cmetcld2_conj,conjecture,(! [XD:($i > $o)] : (! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XJ = (ccfv @ XD @ ccmopn)) => (((cwcel @ XD @ (ccfv @ XX @ ccxmt)) & (cwss @ XS @ XX)) => ((cwcel @ XS @ (ccfv @ XJ @ cccld)) <=> (cwss @ (ccima @ (ccfv @ XJ @ cclm) @ (cco @ XS @ ccn @ ccmap)) @ XS))))))))).
