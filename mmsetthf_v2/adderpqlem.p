...
thf(aenqbreq_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : ((((cwcel @ XA2 @ ccnpi) & (cwcel @ XB2 @ ccnpi)) & ((cwcel @ XC @ ccnpi) & (cwcel @ XD @ ccnpi))) => ((cwbr @ (ccop @ XA2 @ XB2) @ (ccop @ XC @ XD) @ cceq) <=> ((cco @ XA2 @ XD @ ccmi) = (cco @ XB2 @ XC @ ccmi))))))))).
...
thf(aenqbreq2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ (ccxp @ ccnpi @ ccnpi)) & (cwcel @ XB2 @ (ccxp @ ccnpi @ ccnpi))) => ((cwbr @ XA2 @ XB2 @ cceq) <=> ((cco @ (ccfv @ XA2 @ cc1st) @ (ccfv @ XB2 @ cc2nd) @ ccmi) = (cco @ (ccfv @ XB2 @ cc1st) @ (ccfv @ XA2 @ cc2nd) @ ccmi))))))).
thf(amulcanpi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccnpi) & (cwcel @ XB2 @ ccnpi)) => (((cco @ XA2 @ XB2 @ ccmi) = (cco @ XA2 @ XC @ ccmi)) <=> (XB2 = XC))))))).
...
thf(aaddcompi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((cco @ XA2 @ XB2 @ ccpli) = (cco @ XB2 @ XA2 @ ccpli))))).
...
thf(aaddcanpi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (((cwcel @ XA2 @ ccnpi) & (cwcel @ XB2 @ ccnpi)) => (((cco @ XA2 @ XB2 @ ccpli) = (cco @ XA2 @ XC @ ccpli)) <=> (XB2 = XC))))))).
thf(cadderpqlem_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ (ccxp @ ccnpi @ ccnpi)) @ (cwcel @ XB2 @ (ccxp @ ccnpi @ ccnpi)) @ (cwcel @ XC @ (ccxp @ ccnpi @ ccnpi))) => ((cwbr @ XA2 @ XB2 @ cceq) <=> (cwbr @ (cco @ XA2 @ XC @ ccplpq) @ (cco @ XB2 @ XC @ ccplpq) @ cceq))))))).
