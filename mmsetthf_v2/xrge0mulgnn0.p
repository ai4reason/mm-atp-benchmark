...
thf(aressmulgnn0_ax,axiom,(! [XA2:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_as:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XH = (cco @ XG @ XA2 @ ccress)) => ((cwss @ XA2 @ (ccfv @ XG @ ccbs)) => ((Xc_as = (ccfv @ XG @ ccmg)) => ((XI = (ccfv @ XG @ ccminusg)) => (((ccfv @ XG @ cc0g) = (ccfv @ XH @ cc0g)) => (((cwcel @ XN @ ccn0) & (cwcel @ XX @ XA2)) => ((cco @ XN @ XX @ (ccfv @ XH @ ccmg)) = (cco @ XN @ XX @ Xc_as)))))))))))))))).
...
thf(cxrge0mulgnn0_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (((cwcel @ XA2 @ ccn0) & (cwcel @ XB2 @ (cco @ ccc0 @ ccpnf @ ccicc))) => ((cco @ XA2 @ XB2 @ (ccfv @ (cco @ ccxrs @ (cco @ ccc0 @ ccpnf @ ccicc) @ ccress) @ ccmg)) = (cco @ XA2 @ XB2 @ ccxmu)))))).
