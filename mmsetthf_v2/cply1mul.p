...
thf(ccply1mul_conj,conjecture,(! [XB2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [Xc_xp:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_0:($i > $o)] : ((! [Xc:$i] : ((XP @ Xc) = (ccfv @ (XR @ Xc) @ ccpl1))) => ((! [Xc:$i] : ((XB2 @ Xc) = (ccfv @ (XP @ Xc) @ ccbs))) => ((! [Xc:$i] : (Xc_0 = (ccfv @ (XR @ Xc) @ cc0g))) => ((! [Xc:$i] : (Xc_xp = (ccfv @ (XP @ Xc) @ ccmulr))) => (! [Xc:$i] : (((cwcel @ (XR @ Xc) @ ccrg) & ((cwcel @ XF @ (XB2 @ Xc)) & (cwcel @ XG @ (XB2 @ Xc)))) => ((cwral @ (^ [Xc:$i] : (((ccfv @ (ccv @ Xc) @ (ccfv @ XF @ ccco1)) = Xc_0) & ((ccfv @ (ccv @ Xc) @ (ccfv @ XG @ ccco1)) = Xc_0))) @ (^ [Xc:$i] : ccn)) => (cwral @ (^ [Xc:$i] : ((ccfv @ (ccv @ Xc) @ (ccfv @ (cco @ XF @ XG @ Xc_xp) @ ccco1)) = Xc_0)) @ (^ [Xc:$i] : ccn))))))))))))))))).
