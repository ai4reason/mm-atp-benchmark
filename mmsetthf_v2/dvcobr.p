...
thf(advcnp2_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (cco @ XK @ XA2 @ ccrest)) => ((XK = (ccfv @ cccnfld @ cctopn)) => (((cw3a @ (cwss @ XS @ ccc) @ (cwf @ XA2 @ ccc @ XF) @ (cwss @ XA2 @ XS)) & (cwcel @ XB2 @ (ccdm @ (cco @ XS @ XF @ ccdv)))) => (cwcel @ XF @ (ccfv @ XB2 @ (cco @ XJ @ XK @ cccnp))))))))))))).
