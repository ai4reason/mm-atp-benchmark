...
thf(aanabs7_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : ((Xps & (Xph & Xps)) <=> (Xph & Xps))))).
...
thf(aprtlem14_ax,axiom,(! [XA2:($i > ($i > $o))] : (! [Xx3:$i] : (! [Xy1:$i] : (! [Xw:$i] : ((cwprt @ (XA2 @ Xw)) => (((cwcel @ (ccv @ Xx3) @ (XA2 @ Xw)) & (cwcel @ (ccv @ Xy1) @ (XA2 @ Xw))) => (((cwcel @ (ccv @ Xw) @ (ccv @ Xx3)) & (cwcel @ (ccv @ Xw) @ (ccv @ Xy1))) => ((ccv @ Xx3) = (ccv @ Xy1)))))))))).
