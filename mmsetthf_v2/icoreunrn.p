...
thf(aicoreresf_ax,axiom,(cwf @ (ccxp @ ccr @ ccr) @ (ccpw @ ccr) @ (ccres @ ccico @ (ccxp @ ccr @ ccr)))).
...
thf(cicoreunrn_conj,conjecture,(! [XI:($i > $o)] : ((XI = (ccima @ ccico @ (ccxp @ ccr @ ccr))) => (ccr = (ccuni @ XI))))).
