...
thf(apadct_ax,axiom,(! [XA2:($i > $o)] : (! [XV:($i > $o)] : (! [XZ:($i > $o)] : ((cw3a @ (cwbr @ XA2 @ ccom @ ccdom) @ (cwcel @ XZ @ XV) @ (~ (cwcel @ XZ @ XA2))) => (? [Xf1:$i] : (cw3a @ (cwf @ ccn @ (ccun @ XA2 @ (ccsn @ XZ)) @ (ccv @ Xf1)) @ (cwss @ XA2 @ (ccrn @ (ccv @ Xf1))) @ (cwfun @ (ccres @ (cccnv @ (ccv @ Xf1)) @ XA2))))))))).
...
thf(a_0elcarsg_ax,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XO @ XV)) => ((Xph => (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => ((Xph => ((ccfv @ cc0 @ XM) = ccc0)) => (Xph => (cwcel @ cc0 @ (ccfv @ XM @ cccarsg))))))))))).
...
thf(acarsgcl_ax,axiom,(! [Xph:$o] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > $o)] : ((Xph => (cwcel @ XO @ XV)) => ((Xph => (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => (Xph => (cwss @ (ccfv @ XM @ cccarsg) @ (ccpw @ XO)))))))))).
...
thf(aesumpad_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (! [XV:($i > $o)] : (! [XW:($i > ($i > $o))] : ((Xph => (cwcel @ XA2 @ XV)) => ((! [Xk:$i] : (Xph => (cwcel @ XB2 @ (XW @ Xk)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XA2)) => (cwcel @ (XC @ Xk) @ (cco @ ccc0 @ ccpnf @ ccicc)))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XB2)) => ((XC @ Xk) = ccc0))) => (Xph => ((ccesum @ (^ [Xk:$i] : (ccun @ XA2 @ XB2)) @ (^ [Xk:$i] : (XC @ Xk))) = (ccesum @ (^ [Xk:$i] : XA2) @ (^ [Xk:$i] : (XC @ Xk)))))))))))))))).
...
thf(adifpreima_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwfun @ XF) => ((ccima @ (cccnv @ XF) @ (ccdif @ XA2 @ XB2)) = (ccdif @ (ccima @ (cccnv @ XF) @ XA2) @ (ccima @ (cccnv @ XF) @ XB2)))))))).
...
thf(afvimacnvi_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwfun @ XF) & (cwcel @ XA2 @ (ccima @ (cccnv @ XF) @ XB2))) => (cwcel @ (ccfv @ XA2 @ XF) @ XB2)))))).
thf(ampbid_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => Xps) => ((Xph => (Xps <=> Xch)) => (Xph => Xch))))))).
thf(abitr3d_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph => (Xps <=> Xch)) => ((Xph => (Xps <=> Xth)) => (Xph => (Xch <=> Xth))))))))).
thf(cwreu_tp,type,(cwreu : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(cwrmo_tp,type,(cwrmo : (($i > $o) > (($i > ($i > $o)) > $o)))).
thf(adisjrdx_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > ($i > $o))] : (! [XC:($i > $o)] : (! [XD:($i > ($i > $o))] : (! [XF:($i > $o)] : ((Xph => (cwf1o @ XA2 @ XC @ XF)) => ((! [Xx3:$i] : (! [Xy1:$i] : ((Xph & ((ccv @ Xy1) = (ccfv @ (ccv @ Xx3) @ XF))) => ((XD @ Xy1) = (XB2 @ Xx3))))) => (Xph => ((cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XB2 @ Xx3))) <=> (cwdisj @ (^ [Xy1:$i] : XC) @ (^ [Xy1:$i] : (XD @ Xy1)))))))))))))).
thf(asimpr3_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : (! [Xth:$o] : ((Xph & (cw3a @ Xps @ Xch @ Xth)) => Xth)))))).
thf(afresf1o_ax,axiom,(! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cw3a @ (cwfun @ XF) @ (cwss @ XC @ (ccrn @ XF)) @ (cwfun @ (ccres @ (cccnv @ XF) @ XC))) => (cwf1o @ (ccima @ (cccnv @ XF) @ XC) @ XC @ (ccres @ XF @ (ccima @ (cccnv @ XF) @ XC))))))).
...
thf(adisjss3_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > ($i > $o))] : (((cwss @ XA2 @ XB2) & (cwral @ (^ [Xx3:$i] : ((XC @ Xx3) = cc0)) @ (^ [Xx3:$i] : (ccdif @ XB2 @ XA2)))) => ((cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (XC @ Xx3))) <=> (cwdisj @ (^ [Xx3:$i] : XB2) @ (^ [Xx3:$i] : (XC @ Xx3))))))))).
...
thf(acbvesum_ax,axiom,(! [XA2:($i > ($i > ($i > $o)))] : (! [XB2:($i > ($i > ($i > $o)))] : (! [XC:($i > ($i > ($i > $o)))] : ((! [Xj:$i] : (! [Xk:$i] : (((ccv @ Xj) = (ccv @ Xk)) => ((XB2 @ Xj @ Xk) = (XC @ Xj @ Xk))))) => ((! [Xj:$i] : (cwnfc @ (^ [Xk:$i] : (XA2 @ Xj @ Xk)))) => ((! [Xk:$i] : (cwnfc @ (^ [Xj:$i] : (XA2 @ Xj @ Xk)))) => ((! [Xj:$i] : (cwnfc @ (^ [Xk:$i] : (XB2 @ Xj @ Xk)))) => ((! [Xk:$i] : (cwnfc @ (^ [Xj:$i] : (XC @ Xj @ Xk)))) => (! [Xj:$i] : (! [Xk:$i] : ((ccesum @ (^ [Xj:$i] : (XA2 @ Xj @ Xk)) @ (^ [Xj:$i] : (XB2 @ Xj @ Xk))) = (ccesum @ (^ [Xk:$i] : (XA2 @ Xj @ Xk)) @ (^ [Xk:$i] : (XC @ Xj @ Xk))))))))))))))).
...
thf(adisjun0_ax,axiom,(! [XA2:($i > $o)] : ((cwdisj @ (^ [Xx3:$i] : XA2) @ (^ [Xx3:$i] : (ccv @ Xx3))) => (cwdisj @ (^ [Xx3:$i] : (ccun @ XA2 @ (ccsn @ cc0))) @ (^ [Xx3:$i] : (ccv @ Xx3)))))).
...
thf(ccarsggect_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XM:($i > $o)] : (! [XO:($i > $o)] : (! [XV:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwcel @ XO @ (XV @ Xx3 @ Xy1 @ Xz)))))) => ((Xph => (cwf @ (ccpw @ XO) @ (cco @ ccc0 @ ccpnf @ ccicc) @ XM)) => ((Xph => ((ccfv @ cc0 @ XM) = ccc0)) => ((! [Xx3:$i] : ((cw3a @ Xph @ (cwbr @ (ccv @ Xx3) @ ccom @ ccdom) @ (cwss @ (ccv @ Xx3) @ (ccpw @ XO))) => (cwbr @ (ccfv @ (ccuni @ (ccv @ Xx3)) @ XM) @ (ccesum @ (^ [Xy1:$i] : (ccv @ Xx3)) @ (^ [Xy1:$i] : (ccfv @ (ccv @ Xy1) @ XM))) @ ccle))) => ((Xph => (~ (cwcel @ cc0 @ XA2))) => ((Xph => (cwbr @ XA2 @ ccom @ ccdom)) => ((Xph => (cwss @ XA2 @ (ccfv @ XM @ cccarsg))) => ((Xph => (cwdisj @ (^ [Xy1:$i] : XA2) @ (^ [Xy1:$i] : (ccv @ Xy1)))) => ((! [Xx3:$i] : (! [Xy1:$i] : ((cw3a @ Xph @ (cwss @ (ccv @ Xx3) @ (ccv @ Xy1)) @ (cwcel @ (ccv @ Xy1) @ (ccpw @ XO))) => (cwbr @ (ccfv @ (ccv @ Xx3) @ XM) @ (ccfv @ (ccv @ Xy1) @ XM) @ ccle)))) => (Xph => (cwbr @ (ccesum @ (^ [Xz:$i] : XA2) @ (^ [Xz:$i] : (ccfv @ (ccv @ Xz) @ XM))) @ (ccfv @ (ccuni @ XA2) @ XM) @ ccle))))))))))))))))).
