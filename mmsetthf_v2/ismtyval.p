...
thf(adf_ismty_ax,axiom,(ccismty = (ccmpt2 @ (^ [Xm:$i] : (^ [Xn:$i] : (ccuni @ (ccrn @ ccxmt)))) @ (^ [Xm:$i] : (^ [Xn:$i] : (ccuni @ (ccrn @ ccxmt)))) @ (^ [Xm:$i] : (^ [Xn:$i] : (ccab @ (^ [Xf1:$i] : ((cwf1o @ (ccdm @ (ccdm @ (ccv @ Xm))) @ (ccdm @ (ccdm @ (ccv @ Xn))) @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (ccv @ Xm)) = (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ (ccv @ Xn)))) @ (^ [Xy1:$i] : (ccdm @ (ccdm @ (ccv @ Xm)))))) @ (^ [Xx3:$i] : (ccdm @ (ccdm @ (ccv @ Xm))))))))))))).
...
thf(cismtyval_conj,conjecture,(! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (((cwcel @ XM @ (ccfv @ XX @ ccxmt)) & (cwcel @ XN @ (ccfv @ XY @ ccxmt))) => ((cco @ XM @ XN @ ccismty) = (ccab @ (^ [Xf1:$i] : ((cwf1o @ XX @ XY @ (ccv @ Xf1)) & (cwral @ (^ [Xx3:$i] : (cwral @ (^ [Xy1:$i] : ((cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ XM) = (cco @ (ccfv @ (ccv @ Xx3) @ (ccv @ Xf1)) @ (ccfv @ (ccv @ Xy1) @ (ccv @ Xf1)) @ XN))) @ (^ [Xy1:$i] : XX))) @ (^ [Xx3:$i] : XX)))))))))))).
