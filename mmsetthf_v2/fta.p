...
thf(aftalem2_ax,axiom,(! [Xph:($i > $o)] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > ($i > $o)))] : (! [XT:($i > ($i > $o))] : (! [XU:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XN = (ccfv @ XF @ ccdgr)) => ((! [Xx3:$i] : (! [Xr:$i] : ((Xph @ Xr) => (cwcel @ XF @ (ccfv @ (XS @ Xx3 @ Xr) @ ccply))))) => ((! [Xr:$i] : ((Xph @ Xr) => (cwcel @ XN @ ccn))) => ((! [Xs1:$i] : ((XU @ Xs1) = (ccif @ (cwbr @ (ccif @ (cwbr @ cc1 @ (ccv @ Xs1) @ ccle) @ (ccv @ Xs1) @ cc1) @ (XT @ Xs1) @ ccle) @ (XT @ Xs1) @ (ccif @ (cwbr @ cc1 @ (ccv @ Xs1) @ ccle) @ (ccv @ Xs1) @ cc1)))) => ((! [Xs1:$i] : ((XT @ Xs1) = (cco @ (ccfv @ (ccfv @ ccc0 @ XF) @ ccabs) @ (cco @ (ccfv @ (ccfv @ XN @ XA2) @ ccabs) @ cc2 @ ccdiv) @ ccdiv))) => (! [Xr:$i] : ((Xph @ Xr) => (cwrex @ (^ [Xr:$i] : (cwral @ (^ [Xx3:$i] : ((cwbr @ (ccv @ Xr) @ (ccfv @ (ccv @ Xx3) @ ccabs) @ cclt) => (cwbr @ (ccfv @ (ccfv @ ccc0 @ XF) @ ccabs) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ cclt))) @ (^ [Xx3:$i] : ccc))) @ (^ [Xr:$i] : ccrp)))))))))))))))))).
...
thf(aftalem3_ax,axiom,(! [Xph:$o] : (! [XA2:($i > ($i > ($i > $o)))] : (! [XD:($i > ($i > $o))] : (! [XR:($i > ($i > $o))] : (! [XS:($i > ($i > ($i > ($i > $o))))] : (! [XF:($i > $o)] : (! [XJ:($i > ($i > $o))] : (! [XN:($i > ($i > ($i > $o)))] : ((! [Xy1:$i] : (! [Xz:$i] : ((XA2 @ Xy1 @ Xz) = (ccfv @ XF @ cccoe)))) => ((! [Xy1:$i] : (! [Xz:$i] : ((XN @ Xy1 @ Xz) = (ccfv @ XF @ ccdgr)))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwcel @ XF @ (ccfv @ (XS @ Xx3 @ Xy1 @ Xz) @ ccply)))))) => ((! [Xy1:$i] : (! [Xz:$i] : (Xph => (cwcel @ (XN @ Xy1 @ Xz) @ ccn)))) => ((! [Xy1:$i] : (! [Xz:$i] : ((XD @ Xy1) = (ccrab @ (^ [Xy1:$i] : (cwbr @ (ccfv @ (ccv @ Xy1) @ ccabs) @ (XR @ Xz) @ ccle)) @ (^ [Xy1:$i] : ccc))))) => ((! [Xy1:$i] : ((XJ @ Xy1) = (ccfv @ cccnfld @ cctopn))) => ((! [Xz:$i] : (Xph => (cwcel @ (XR @ Xz) @ ccrp))) => ((! [Xz:$i] : (Xph => (cwral @ (^ [Xx3:$i] : ((cwbr @ (XR @ Xz) @ (ccfv @ (ccv @ Xx3) @ ccabs) @ cclt) => (cwbr @ (ccfv @ (ccfv @ ccc0 @ XF) @ ccabs) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ cclt))) @ (^ [Xx3:$i] : ccc)))) => (Xph => (cwrex @ (^ [Xz:$i] : (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xz) @ XF) @ ccabs) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ ccle)) @ (^ [Xx3:$i] : ccc))) @ (^ [Xz:$i] : ccc)))))))))))))))))))).
...
thf(aftalem7_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : ((XA2 = (ccfv @ XF @ cccoe)) => ((XN = (ccfv @ XF @ ccdgr)) => ((! [Xx3:$i] : (Xph => (cwcel @ XF @ (ccfv @ (XS @ Xx3) @ ccply)))) => ((Xph => (cwcel @ XN @ ccn)) => ((Xph => (cwcel @ XX @ ccc)) => ((Xph => (cwne @ (ccfv @ XX @ XF) @ ccc0)) => (Xph => (~ (cwral @ (^ [Xx3:$i] : (cwbr @ (ccfv @ (ccfv @ XX @ XF) @ ccabs) @ (ccfv @ (ccfv @ (ccv @ Xx3) @ XF) @ ccabs) @ ccle)) @ (^ [Xx3:$i] : ccc))))))))))))))))).
