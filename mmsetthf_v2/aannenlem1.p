...
thf(caannenlem1_conj,conjecture,(! [XA2:($i > $o)] : (! [XH:($i > ($i > ($i > ($i > ($i > ($i > $o))))))] : ((! [Xe:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((XH @ Xe @ Xa @ Xb @ Xc @ Xd) = (ccmpt @ (^ [Xa:$i] : ccn0) @ (^ [Xa:$i] : (ccrab @ (^ [Xb:$i] : (cwrex @ (^ [Xc:$i] : ((ccfv @ (ccv @ Xb) @ (ccv @ Xc)) = ccc0)) @ (^ [Xc:$i] : (ccrab @ (^ [Xd:$i] : (cw3a @ (cwne @ (ccv @ Xd) @ cc0p) @ (cwbr @ (ccfv @ (ccv @ Xd) @ ccdgr) @ (ccv @ Xa) @ ccle) @ (cwral @ (^ [Xe:$i] : (cwbr @ (ccfv @ (ccfv @ (ccv @ Xe) @ (ccfv @ (ccv @ Xd) @ cccoe)) @ ccabs) @ (ccv @ Xa) @ ccle)) @ (^ [Xe:$i] : ccn0)))) @ (^ [Xd:$i] : (ccfv @ ccz @ ccply)))))) @ (^ [Xb:$i] : ccc)))))))))) => (! [Xe:$i] : (! [Xa:$i] : (! [Xb:$i] : (! [Xc:$i] : (! [Xd:$i] : ((cwcel @ XA2 @ ccn0) => (cwcel @ (ccfv @ XA2 @ (XH @ Xe @ Xa @ Xb @ Xc @ Xd)) @ ccfn))))))))))).
