...
thf(aodcau_ax,axiom,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => ((! [Xg1:$i] : ((XO @ Xg1) = (ccfv @ XG @ ccod))) => (((cw3a @ (cwcel @ XG @ ccgrp) @ (cwcel @ XX @ ccfn) @ (cwcel @ XP @ ccprime)) & (cwbr @ XP @ (ccfv @ XX @ cchash) @ ccdvds)) => (cwrex @ (^ [Xg1:$i] : ((ccfv @ (ccv @ Xg1) @ (XO @ Xg1)) = XP)) @ (^ [Xg1:$i] : XX)))))))))).
...
thf(cpgpfi_conj,conjecture,(! [XP:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccfv @ XG @ ccbs)) => (((cwcel @ XG @ ccgrp) & (cwcel @ XX @ ccfn)) => ((cwbr @ XP @ XG @ ccpgp) <=> ((cwcel @ XP @ ccprime) & (cwrex @ (^ [Xn:$i] : ((ccfv @ XX @ cchash) = (cco @ XP @ (ccv @ Xn) @ ccexp))) @ (^ [Xn:$i] : ccn0)))))))))).
