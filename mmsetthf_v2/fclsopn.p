...
thf(aisfcls2_ax,axiom,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XF @ (ccfv @ XX @ ccfil))) => ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) <=> (cwral @ (^ [Xs1:$i] : (cwcel @ XA2 @ (ccfv @ (ccv @ Xs1) @ (ccfv @ XJ @ cccl)))) @ (^ [Xs1:$i] : XF))))))))).
...
thf(cfclsopn_conj,conjecture,(! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : (((cwcel @ XJ @ (ccfv @ XX @ cctopon)) & (cwcel @ XF @ (ccfv @ XX @ ccfil))) => ((cwcel @ XA2 @ (cco @ XJ @ XF @ ccfcls)) <=> ((cwcel @ XA2 @ XX) & (cwral @ (^ [Xo:$i] : ((cwcel @ XA2 @ (ccv @ Xo)) => (cwral @ (^ [Xs1:$i] : (cwne @ (ccin @ (ccv @ Xo) @ (ccv @ Xs1)) @ cc0)) @ (^ [Xs1:$i] : XF)))) @ (^ [Xo:$i] : XJ)))))))))).
