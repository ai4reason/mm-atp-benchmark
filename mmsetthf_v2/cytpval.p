...
thf(ccytpval_conj,conjecture,(! [XA2:($i > ($i > $o))] : (! [XP:($i > ($i > $o))] : (! [XQ:($i > ($i > $o))] : (! [XT:($i > ($i > $o))] : (! [Xc_mi:($i > ($i > $o))] : (! [XN:($i > $o)] : (! [XO:($i > ($i > $o))] : (! [XX:($i > ($i > $o))] : ((! [Xr:$i] : ((XT @ Xr) = (cco @ (ccfv @ cccnfld @ ccmgp) @ (ccdif @ ccc @ (ccsn @ ccc0)) @ ccress))) => ((! [Xr:$i] : ((XO @ Xr) = (ccfv @ (XT @ Xr) @ ccod))) => ((! [Xr:$i] : ((XP @ Xr) = (ccfv @ cccnfld @ ccpl1))) => ((! [Xr:$i] : ((XX @ Xr) = (ccfv @ cccnfld @ ccv1))) => ((! [Xr:$i] : ((XQ @ Xr) = (ccfv @ (XP @ Xr) @ ccmgp))) => ((! [Xr:$i] : ((Xc_mi @ Xr) = (ccfv @ (XP @ Xr) @ ccsg))) => ((! [Xr:$i] : ((XA2 @ Xr) = (ccfv @ (XP @ Xr) @ ccascl))) => (! [Xr:$i] : ((cwcel @ XN @ ccn) => ((ccfv @ XN @ cccytp) = (cco @ (XQ @ Xr) @ (ccmpt @ (^ [Xr:$i] : (ccima @ (cccnv @ (XO @ Xr)) @ (ccsn @ XN))) @ (^ [Xr:$i] : (cco @ (XX @ Xr) @ (ccfv @ (ccv @ Xr) @ (XA2 @ Xr)) @ (Xc_mi @ Xr)))) @ ccgsu)))))))))))))))))))).
