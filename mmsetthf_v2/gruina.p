...
thf(awinainflem_ax,axiom,(! [XA2:($i > $o)] : ((cw3a @ (cwne @ XA2 @ cc0) @ (cwcel @ XA2 @ ccon0) @ (cwral @ (^ [Xx3:$i] : (cwrex @ (^ [Xy1:$i] : (cwbr @ (ccv @ Xx3) @ (ccv @ Xy1) @ ccsdm)) @ (^ [Xy1:$i] : XA2))) @ (^ [Xx3:$i] : XA2))) => (cwss @ ccom @ XA2)))).
...
thf(acflm_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > ($i > ($i > $o)))] : (! [Xx3:$i] : (! [Xy1:$i] : (((cwcel @ XA2 @ (XB2 @ Xx3 @ Xy1)) & (cwlim @ XA2)) => ((ccfv @ XA2 @ cccf) = (ccint @ (ccab @ (^ [Xx3:$i] : (? [Xy1:$i] : (((ccv @ Xx3) = (ccfv @ (ccv @ Xy1) @ cccrd)) & ((cwss @ (ccv @ Xy1) @ XA2) & (XA2 = (ccuni @ (ccv @ Xy1)))))))))))))))).
...
thf(agruen_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : ((cw3a @ (cwcel @ XU @ ccgru) @ (cwss @ XA2 @ XU) @ ((cwcel @ XB2 @ XU) & (cwbr @ XB2 @ XA2 @ ccen))) => (cwcel @ XA2 @ XU)))))).
thf(cciun_tp,type,(cciun : (($i > ($i > $o)) > (($i > ($i > $o)) > ($i > $o))))).
thf(agruuni_ax,axiom,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : (((cwcel @ XU @ ccgru) & (cwcel @ XA2 @ XU)) => (cwcel @ (ccuni @ XA2) @ XU))))).
...
thf(cgruina_conj,conjecture,(! [XA2:($i > $o)] : (! [XU:($i > $o)] : ((XA2 = (ccin @ XU @ ccon0)) => (((cwcel @ XU @ ccgru) & (cwne @ XU @ cc0)) => (cwcel @ XA2 @ ccina)))))).
