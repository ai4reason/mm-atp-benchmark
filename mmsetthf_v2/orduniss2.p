...
thf(aordpwsuc_ax,axiom,(! [XA2:($i > $o)] : ((cword @ XA2) => ((ccin @ (ccpw @ XA2) @ ccon0) = (ccsuc @ XA2))))).
thf(cwtr_tp,type,(cwtr : (($i > $o) > $o))).
thf(aordunisuc_ax,axiom,(! [XA2:($i > $o)] : ((cword @ XA2) => ((ccuni @ (ccsuc @ XA2)) = XA2)))).
thf(corduniss2_conj,conjecture,(! [XA2:($i > $o)] : ((cword @ XA2) => ((ccuni @ (ccrab @ (^ [Xx3:$i] : (cwss @ (ccv @ Xx3) @ XA2)) @ (^ [Xx3:$i] : ccon0))) = XA2)))).
