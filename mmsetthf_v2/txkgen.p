...
thf(allycmpkgen_ax,axiom,(! [XJ:($i > $o)] : ((cwcel @ XJ @ (ccnlly @ cccmp)) => (cwcel @ XJ @ (ccrn @ cckgen))))).
...
thf(ctxkgen_conj,conjecture,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (((cwcel @ XR @ (ccnlly @ cccmp)) & (cwcel @ XS @ (ccin @ (ccrn @ cckgen) @ ccha))) => (cwcel @ (cco @ XR @ XS @ cctx) @ (ccrn @ cckgen)))))).
