...
thf(csrgbinomlem1_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XD:($i > $o)] : (! [Xc_pl:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [Xc_x:($i > $o)] : (! [Xc_xp:($i > $o)] : (! [XE:($i > $o)] : (! [Xc_ex:($i > $o)] : (! [XG:($i > $o)] : (! [XN:($i > $o)] : ((XS = (ccfv @ XR @ ccbs)) => ((Xc_xp = (ccfv @ XR @ ccmulr)) => ((Xc_x = (ccfv @ XR @ ccmg)) => ((Xc_pl = (ccfv @ XR @ ccplusg)) => ((XG = (ccfv @ XR @ ccmgp)) => ((Xc_ex = (ccfv @ XG @ ccmg)) => ((Xph => (cwcel @ XR @ ccsrg)) => ((Xph => (cwcel @ XA2 @ XS)) => ((Xph => (cwcel @ XB2 @ XS)) => ((Xph => ((cco @ XA2 @ XB2 @ Xc_xp) = (cco @ XB2 @ XA2 @ Xc_xp))) => ((Xph => (cwcel @ XN @ ccn0)) => ((Xph & ((cwcel @ XD @ ccn0) & (cwcel @ XE @ ccn0))) => (cwcel @ (cco @ (cco @ XD @ XA2 @ Xc_ex) @ (cco @ XE @ XB2 @ Xc_ex) @ Xc_xp) @ XS))))))))))))))))))))))))))).
