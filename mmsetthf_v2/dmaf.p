...
thf(adf_doma_ax,axiom,(ccdoma = (cccom @ cc1st @ cc1st))).
...
thf(aarwdm_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((XA2 = (ccfv @ XC @ ccarw)) => ((XB2 = (ccfv @ XC @ ccbs)) => ((cwcel @ XF @ XA2) => (cwcel @ (ccfv @ XF @ ccdoma) @ XB2))))))))).
thf(affnfv_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : ((cwf @ XA2 @ XB2 @ XF) <=> ((cwfn @ XF @ XA2) & (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ XB2)) @ (^ [Xx3:$i] : XA2)))))))).
thf(cdmaf_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((XA2 = (ccfv @ XC @ ccarw)) => ((XB2 = (ccfv @ XC @ ccbs)) => (cwf @ XA2 @ XB2 @ (ccres @ ccdoma @ XA2)))))))).
