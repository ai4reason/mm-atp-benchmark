...
thf(ctchcphlem1_conj,conjecture,(! [Xph:$o] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [Xc_xi:($i > $o)] : (! [XK:($i > ($i > $o))] : (! [Xc_mi:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XG = (ccfv @ XW @ cctch)) => ((XV = (ccfv @ XW @ ccbs)) => ((XF = (ccfv @ XW @ ccsca)) => ((Xph => (cwcel @ XW @ ccphl)) => ((! [Xx3:$i] : (Xph => (XF = (cco @ cccnfld @ (XK @ Xx3) @ ccress)))) => ((Xc_xi = (ccfv @ XW @ ccip)) => ((! [Xx3:$i] : ((Xph & (cw3a @ (cwcel @ (ccv @ Xx3) @ (XK @ Xx3)) @ (cwcel @ (ccv @ Xx3) @ ccr) @ (cwbr @ ccc0 @ (ccv @ Xx3) @ ccle))) => (cwcel @ (ccfv @ (ccv @ Xx3) @ ccsqrt) @ (XK @ Xx3)))) => ((! [Xx3:$i] : ((Xph & (cwcel @ (ccv @ Xx3) @ XV)) => (cwbr @ ccc0 @ (cco @ (ccv @ Xx3) @ (ccv @ Xx3) @ Xc_xi) @ ccle))) => ((! [Xx3:$i] : ((XK @ Xx3) = (ccfv @ XF @ ccbs))) => ((Xc_mi = (ccfv @ XW @ ccsg)) => ((Xph => (cwcel @ XX @ XV)) => ((Xph => (cwcel @ XY @ XV)) => (Xph => (cwbr @ (ccfv @ (cco @ (cco @ XX @ XY @ Xc_mi) @ (cco @ XX @ XY @ Xc_mi) @ Xc_xi) @ ccsqrt) @ (cco @ (ccfv @ (cco @ XX @ XX @ Xc_xi) @ ccsqrt) @ (ccfv @ (cco @ XY @ XY @ Xc_xi) @ ccsqrt) @ ccaddc) @ ccle))))))))))))))))))))))))).
