...
thf(cfwddifn0_conj,conjecture,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XX:($i > $o)] : ((Xph => (cwss @ XA2 @ ccc)) => ((Xph => (cwf @ XA2 @ ccc @ XF)) => ((Xph => (cwcel @ XX @ XA2)) => (Xph => ((ccfv @ XX @ (cco @ ccc0 @ XF @ ccfwddifn)) = (ccfv @ XX @ XF))))))))))).
