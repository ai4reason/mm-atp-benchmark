...
thf(afsuppco2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XU:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XV:($i > $o)] : (! [XW:($i > $o)] : (! [XZ:($i > $o)] : ((Xph => (cwcel @ XZ @ XW)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwf @ XB2 @ XB2 @ XG)) => ((Xph => (cwcel @ XA2 @ XU)) => ((Xph => (cwcel @ XB2 @ XV)) => ((Xph => (cwbr @ XF @ XZ @ ccfsupp)) => ((Xph => ((ccfv @ XZ @ XG) = XZ)) => (Xph => (cwbr @ (cccom @ XG @ XF) @ XZ @ ccfsupp))))))))))))))))))).
...
thf(agsuminv_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XI:($i > $o)] : (! [XV:($i > $o)] : (! [Xc_0:($i > $o)] : ((XB2 = (ccfv @ XG @ ccbs)) => ((Xc_0 = (ccfv @ XG @ cc0g)) => ((XI = (ccfv @ XG @ ccminusg)) => ((Xph => (cwcel @ XG @ ccabl)) => ((Xph => (cwcel @ XA2 @ XV)) => ((Xph => (cwf @ XA2 @ XB2 @ XF)) => ((Xph => (cwbr @ XF @ Xc_0 @ ccfsupp)) => (Xph => ((cco @ XG @ (cccom @ XI @ XF) @ ccgsu) = (ccfv @ (cco @ XG @ XF @ ccgsu) @ XI))))))))))))))))))).
