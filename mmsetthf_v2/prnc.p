...
thf(aisidlc_ax,axiom,(! [XR:($i > $o)] : (! [XG:($i > ($i > ($i > ($i > $o))))] : (! [XH:($i > ($i > ($i > ($i > $o))))] : (! [XI:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XZ:($i > ($i > ($i > ($i > $o))))] : ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XG @ Xx3 @ Xy1 @ Xz) = (ccfv @ XR @ cc1st))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XH @ Xx3 @ Xy1 @ Xz) = (ccfv @ XR @ cc2nd))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XX @ Xy1) = (ccrn @ (XG @ Xx3 @ Xy1 @ Xz)))))) => ((! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((XZ @ Xx3 @ Xy1 @ Xz) = (ccfv @ (XG @ Xx3 @ Xy1 @ Xz) @ ccgi))))) => (! [Xx3:$i] : (! [Xy1:$i] : (! [Xz:$i] : ((cwcel @ XR @ cccring) => ((cwcel @ XI @ (ccfv @ XR @ ccidl)) <=> (cw3a @ (cwss @ XI @ (XX @ Xy1)) @ (cwcel @ (XZ @ Xx3 @ Xy1 @ Xz) @ XI) @ (cwral @ (^ [Xx3:$i] : ((cwral @ (^ [Xy1:$i] : (cwcel @ (cco @ (ccv @ Xx3) @ (ccv @ Xy1) @ (XG @ Xx3 @ Xy1 @ Xz)) @ XI)) @ (^ [Xy1:$i] : XI)) & (cwral @ (^ [Xz:$i] : (cwcel @ (cco @ (ccv @ Xz) @ (ccv @ Xx3) @ (XH @ Xx3 @ Xy1 @ Xz)) @ XI)) @ (^ [Xz:$i] : (XX @ Xy1))))) @ (^ [Xx3:$i] : XI))))))))))))))))))).
...
thf(aigenval2_ax,axiom,(! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XG:($i > ($i > $o))] : (! [XI:($i > $o)] : (! [XX:($i > ($i > $o))] : ((! [Xj:$i] : ((XG @ Xj) = (ccfv @ XR @ cc1st))) => ((! [Xj:$i] : ((XX @ Xj) = (ccrn @ (XG @ Xj)))) => (! [Xj:$i] : (((cwcel @ XR @ ccrngo) & (cwss @ XS @ (XX @ Xj))) => (((cco @ XR @ XS @ ccigen) = XI) <=> (cw3a @ (cwcel @ XI @ (ccfv @ XR @ ccidl)) @ (cwss @ XS @ XI) @ (cwral @ (^ [Xj:$i] : ((cwss @ XS @ (ccv @ Xj)) => (cwss @ XI @ (ccv @ Xj)))) @ (^ [Xj:$i] : (ccfv @ XR @ ccidl))))))))))))))).
