...
thf(cbnj168_conj,conjecture,(! [XD:($i > ($i > $o))] : (! [Xn:$i] : ((! [Xm:$i] : ((XD @ Xm) = (ccdif @ ccom @ (ccsn @ cc0)))) => (! [Xm:$i] : (((cwne @ (ccv @ Xn) @ cc1o) & (cwcel @ (ccv @ Xn) @ (XD @ Xm))) => (cwrex @ (^ [Xm:$i] : ((ccv @ Xn) = (ccsuc @ (ccv @ Xm)))) @ (^ [Xm:$i] : (XD @ Xm))))))))).
