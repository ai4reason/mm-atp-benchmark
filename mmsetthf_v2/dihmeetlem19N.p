...
thf(alsm01_ax,axiom,(! [Xc_po:($i > $o)] : (! [XG:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((Xc_0 = (ccfv @ XG @ cc0g)) => ((Xc_po = (ccfv @ XG @ cclsm)) => ((cwcel @ XX @ (ccfv @ XG @ ccsubg)) => ((cco @ XX @ (ccsn @ Xc_0) @ Xc_po) = XX))))))))).
thf(cdihmeetlem19N_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [Xc_po:($i > $o)] : (! [XU:($i > $o)] : (! [XH:($i > $o)] : (! [XI:($i > $o)] : (! [Xc_or:($i > $o)] : (! [XK:($i > $o)] : (! [Xc_le:($i > $o)] : (! [Xc_an:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : (! [Xr:$i] : (! [Xp:$i] : ((XB2 = (ccfv @ XK @ ccbs)) => ((Xc_le = (ccfv @ XK @ ccple)) => ((XH = (ccfv @ XK @ cclh)) => ((Xc_or = (ccfv @ XK @ ccjn)) => ((Xc_an = (ccfv @ XK @ ccmee)) => ((XA2 = (ccfv @ XK @ ccatm)) => ((XU = (ccfv @ XW @ (ccfv @ XK @ ccdvh))) => ((Xc_po = (ccfv @ XU @ cclsm)) => ((XI = (ccfv @ XW @ (ccfv @ XK @ ccdih))) => (((cw3a @ ((cwcel @ XK @ cchlt) & (cwcel @ XW @ XH)) @ ((cwcel @ XX @ XB2) & (~ (cwbr @ XX @ XW @ Xc_le))) @ (cwcel @ XY @ XB2)) & (cw3a @ ((cwcel @ (ccv @ Xp) @ XA2) & (~ (cwbr @ (ccv @ Xp) @ XW @ Xc_le))) @ ((cwcel @ (ccv @ Xr) @ XA2) & (~ (cwbr @ (ccv @ Xr) @ XW @ Xc_le))) @ (cw3a @ (cwbr @ (ccv @ Xp) @ XX @ Xc_le) @ (cwbr @ (ccv @ Xr) @ XY @ Xc_le) @ (cwbr @ (cco @ XX @ XY @ Xc_an) @ XW @ Xc_le)))) => ((ccfv @ (cco @ XX @ XY @ Xc_an) @ XI) = (ccin @ (ccfv @ XX @ XI) @ (ccfv @ XY @ XI))))))))))))))))))))))))))))).
