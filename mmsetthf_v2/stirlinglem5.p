...
thf(aclimadd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XM @ ccuz)) => ((Xph => (cwcel @ XM @ ccz)) => ((Xph => (cwbr @ XF @ XA2 @ ccli)) => ((! [Xk:$i] : (Xph => (cwcel @ XH @ (XX @ Xk)))) => ((Xph => (cwbr @ XG @ XB2 @ ccli)) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XF) @ ccc))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => (cwcel @ (ccfv @ (ccv @ Xk) @ XG) @ ccc))) => ((! [Xk:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ XZ)) => ((ccfv @ (ccv @ Xk) @ XH) = (cco @ (ccfv @ (ccv @ Xk) @ XF) @ (ccfv @ (ccv @ Xk) @ XG) @ ccaddc)))) => (Xph => (cwbr @ XH @ (cco @ XA2 @ XB2 @ ccaddc) @ ccli)))))))))))))))))))).
...
thf(alogtayl2_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > ($i > $o))] : ((! [Xk:$i] : ((XS @ Xk) = (cco @ cc1 @ cc1 @ (ccfv @ (cccom @ ccabs @ ccmin) @ ccbl)))) => (! [Xk:$i] : ((cwcel @ XA2 @ (XS @ Xk)) => (cwbr @ (ccseq @ ccaddc @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ (ccv @ Xk) @ cc1 @ ccmin) @ ccexp) @ (ccv @ Xk) @ ccdiv) @ (cco @ (cco @ XA2 @ cc1 @ ccmin) @ (ccv @ Xk) @ ccexp) @ ccmul))) @ cc1) @ (ccfv @ XA2 @ cclog) @ ccli))))))).
...
thf(alogtayl_ax,axiom,(! [XA2:($i > $o)] : (((cwcel @ XA2 @ ccc) & (cwbr @ (ccfv @ XA2 @ ccabs) @ cc1 @ cclt)) => (cwbr @ (ccseq @ ccaddc @ (ccmpt @ (^ [Xk:$i] : ccn) @ (^ [Xk:$i] : (cco @ (cco @ XA2 @ (ccv @ Xk) @ ccexp) @ (ccv @ Xk) @ ccdiv))) @ cc1) @ (ccneg @ (ccfv @ (cco @ cc1 @ XA2 @ ccmin) @ cclog)) @ ccli)))).
...
thf(aisercoll2_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > ($i > $o))] : (! [XW:($i > ($i > $o))] : (! [XZ:($i > ($i > $o))] : ((! [Xn:$i] : ((XZ @ Xn) = (ccfv @ XM @ ccuz))) => ((! [Xk:$i] : ((XW @ Xk) = (ccfv @ (XN @ Xk) @ ccuz))) => ((Xph => (cwcel @ XM @ ccz)) => ((! [Xk:$i] : (Xph => (cwcel @ (XN @ Xk) @ ccz))) => ((! [Xk:$i] : (! [Xn:$i] : (Xph => (cwf @ (XZ @ Xn) @ (XW @ Xk) @ XG)))) => ((! [Xk:$i] : (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (XZ @ Xn))) => (cwbr @ (ccfv @ (ccv @ Xk) @ XG) @ (ccfv @ (cco @ (ccv @ Xk) @ cc1 @ ccaddc) @ XG) @ cclt)))) => ((! [Xk:$i] : (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ (ccdif @ (XW @ Xk) @ (ccrn @ XG)))) => ((ccfv @ (ccv @ Xn) @ XF) = ccc0)))) => ((! [Xk:$i] : (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xn) @ (XW @ Xk))) => (cwcel @ (ccfv @ (ccv @ Xn) @ XF) @ ccc)))) => ((! [Xk:$i] : (! [Xn:$i] : ((Xph & (cwcel @ (ccv @ Xk) @ (XZ @ Xn))) => ((ccfv @ (ccv @ Xk) @ XH) = (ccfv @ (ccfv @ (ccv @ Xk) @ XG) @ XF))))) => (! [Xk:$i] : (Xph => ((cwbr @ (ccseq @ ccaddc @ XH @ XM) @ XA2 @ ccli) <=> (cwbr @ (ccseq @ ccaddc @ XF @ (XN @ Xk)) @ XA2 @ ccli))))))))))))))))))))))).
...
thf(altmul2dd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwcel @ XC @ ccrp)) => ((Xph => (cwbr @ XA2 @ XB2 @ cclt)) => (Xph => (cwbr @ (cco @ XC @ XA2 @ ccmul) @ (cco @ XC @ XB2 @ ccmul) @ cclt))))))))))).
...
thf(ann1m1nn_ax,axiom,(! [XA2:($i > $o)] : ((cwcel @ XA2 @ ccn) => ((XA2 = cc1) | (cwcel @ (cco @ XA2 @ cc1 @ ccmin) @ ccn))))).
...
thf(aanabss1_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((((Xph & Xps) & Xph) => Xch) => ((Xph & Xps) => Xch)))))).
...
thf(anan_ax,axiom,(! [Xph:$o] : (! [Xps:$o] : (! [Xch:$o] : ((Xph => (~ (Xps & Xch))) <=> ((Xph & Xps) => (~ Xch))))))).
...
thf(amulltgt0_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((((cwcel @ XA2 @ ccr) & (cwbr @ XA2 @ ccc0 @ cclt)) & ((cwcel @ XB2 @ ccr) & (cwbr @ ccc0 @ XB2 @ cclt))) => (cwbr @ (cco @ XA2 @ XB2 @ ccmul) @ ccc0 @ cclt))))).
...
thf(aoddp1even_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((~ (cwbr @ cc2 @ XN @ ccdvds)) <=> (cwbr @ cc2 @ (cco @ XN @ cc1 @ ccaddc) @ ccdvds))))).
thf(aoexpneg_ax,axiom,(! [XA2:($i > $o)] : (! [XN:($i > $o)] : ((cw3a @ (cwcel @ XA2 @ ccc) @ (cwcel @ XN @ ccn) @ (~ (cwbr @ cc2 @ XN @ ccdvds))) => ((cco @ (ccneg @ XA2) @ XN @ ccexp) = (ccneg @ (cco @ XA2 @ XN @ ccexp))))))).
...
thf(aaddgegt0d_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccr)) => ((Xph => (cwcel @ XB2 @ ccr)) => ((Xph => (cwbr @ ccc0 @ XA2 @ ccle)) => ((Xph => (cwbr @ ccc0 @ XB2 @ cclt)) => (Xph => (cwbr @ ccc0 @ (cco @ XA2 @ XB2 @ ccaddc) @ cclt)))))))))).
...
thf(am1expeven_ax,axiom,(! [XN:($i > $o)] : ((cwcel @ XN @ ccz) => ((cco @ (ccneg @ cc1) @ (cco @ cc2 @ XN @ ccmul) @ ccexp) = cc1)))).
...
thf(arelogdivd_ax,axiom,(! [Xph:$o] : (! [XA2:($i > $o)] : (! [XB2:($i > $o)] : ((Xph => (cwcel @ XA2 @ ccrp)) => ((Xph => (cwcel @ XB2 @ ccrp)) => (Xph => ((ccfv @ (cco @ XA2 @ XB2 @ ccdiv) @ cclog) = (cco @ (ccfv @ XA2 @ cclog) @ (ccfv @ XB2 @ cclog) @ ccmin))))))))).
...
thf(cstirlinglem5_conj,conjecture,(! [Xph:$o] : (! [XD:($i > ($i > $o))] : (! [XT:($i > $o)] : (! [XE:($i > ($i > $o))] : (! [XF:($i > ($i > $o))] : (! [XG:($i > ($i > $o))] : (! [XH:($i > ($i > $o))] : ((! [Xj:$i] : ((XD @ Xj) = (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (cco @ (cco @ (ccneg @ cc1) @ (cco @ (ccv @ Xj) @ cc1 @ ccmin) @ ccexp) @ (cco @ (cco @ XT @ (ccv @ Xj) @ ccexp) @ (ccv @ Xj) @ ccdiv) @ ccmul))))) => ((! [Xj:$i] : ((XE @ Xj) = (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (cco @ (cco @ XT @ (ccv @ Xj) @ ccexp) @ (ccv @ Xj) @ ccdiv))))) => ((! [Xj:$i] : ((XF @ Xj) = (ccmpt @ (^ [Xj:$i] : ccn) @ (^ [Xj:$i] : (cco @ (cco @ (cco @ (ccneg @ cc1) @ (cco @ (ccv @ Xj) @ cc1 @ ccmin) @ ccexp) @ (cco @ (cco @ XT @ (ccv @ Xj) @ ccexp) @ (ccv @ Xj) @ ccdiv) @ ccmul) @ (cco @ (cco @ XT @ (ccv @ Xj) @ ccexp) @ (ccv @ Xj) @ ccdiv) @ ccaddc))))) => ((! [Xj:$i] : ((XH @ Xj) = (ccmpt @ (^ [Xj:$i] : ccn0) @ (^ [Xj:$i] : (cco @ cc2 @ (cco @ (cco @ cc1 @ (cco @ (cco @ cc2 @ (ccv @ Xj) @ ccmul) @ cc1 @ ccaddc) @ ccdiv) @ (cco @ XT @ (cco @ (cco @ cc2 @ (ccv @ Xj) @ ccmul) @ cc1 @ ccaddc) @ ccexp) @ ccmul) @ ccmul))))) => ((! [Xj:$i] : ((XG @ Xj) = (ccmpt @ (^ [Xj:$i] : ccn0) @ (^ [Xj:$i] : (cco @ (cco @ cc2 @ (ccv @ Xj) @ ccmul) @ cc1 @ ccaddc))))) => ((Xph => (cwcel @ XT @ ccrp)) => ((Xph => (cwbr @ (ccfv @ XT @ ccabs) @ cc1 @ cclt)) => (! [Xj:$i] : (Xph => (cwbr @ (ccseq @ ccaddc @ (XH @ Xj) @ ccc0) @ (ccfv @ (cco @ (cco @ cc1 @ XT @ ccaddc) @ (cco @ cc1 @ XT @ ccmin) @ ccdiv) @ cclog) @ ccli)))))))))))))))))).
