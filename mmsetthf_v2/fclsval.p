...
thf(cfclsval_conj,conjecture,(! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > ($i > $o))] : (! [XY:($i > ($i > $o))] : ((! [Xt:$i] : ((XX @ Xt) = (ccuni @ XJ))) => (! [Xt:$i] : (((cwcel @ XJ @ cctop) & (cwcel @ XF @ (ccfv @ (XY @ Xt) @ ccfil))) => ((cco @ XJ @ XF @ ccfcls) = (ccif @ ((XX @ Xt) = (XY @ Xt)) @ (cciin @ (^ [Xt:$i] : XF) @ (^ [Xt:$i] : (ccfv @ (ccv @ Xt) @ (ccfv @ XJ @ cccl)))) @ cc0)))))))))).
