...
thf(atxcls_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XR:($i > $o)] : (! [XS:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((((cwcel @ XR @ (ccfv @ XX @ cctopon)) & (cwcel @ XS @ (ccfv @ XY @ cctopon))) & ((cwss @ XA2 @ XX) & (cwss @ XB2 @ XY))) => ((ccfv @ (ccxp @ XA2 @ XB2) @ (ccfv @ (cco @ XR @ XS @ cctx) @ cccl)) = (ccxp @ (ccfv @ XA2 @ (ccfv @ XR @ cccl)) @ (ccfv @ XB2 @ (ccfv @ XS @ cccl)))))))))))).
...
thf(afunimass5_ax,axiom,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XF:($i > $o)] : (((cwfun @ XF) & (cwss @ XA2 @ (ccdm @ XF))) => ((cwss @ XA2 @ (ccima @ (cccnv @ XF) @ XB2)) <=> (cwral @ (^ [Xx3:$i] : (cwcel @ (ccfv @ (ccv @ Xx3) @ XF) @ XB2)) @ (^ [Xx3:$i] : XA2)))))))).
