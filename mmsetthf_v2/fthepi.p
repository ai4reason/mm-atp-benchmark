...
thf(afthmon_ax,axiom,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XR:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XM:($i > $o)] : (! [XN:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => ((Xph => (cwbr @ XF @ XG @ (cco @ XC @ XD @ ccfth))) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XR @ (cco @ XX @ XY @ XH))) => ((XM = (ccfv @ XC @ ccmon)) => ((XN = (ccfv @ XD @ ccmon)) => ((Xph => (cwcel @ (ccfv @ XR @ (cco @ XX @ XY @ XG)) @ (cco @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ XN))) => (Xph => (cwcel @ XR @ (cco @ XX @ XY @ XM))))))))))))))))))))))))).
...
thf(afthoppc_ax,axiom,(! [Xph:$o] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XO:($i > $o)] : ((XO = (ccfv @ XC @ ccoppc)) => ((XP = (ccfv @ XD @ ccoppc)) => ((Xph => (cwbr @ XF @ XG @ (cco @ XC @ XD @ ccfth))) => (Xph => (cwbr @ XF @ (cctpos @ XG) @ (cco @ XO @ XP @ ccfth)))))))))))))).
...
thf(cfthepi_conj,conjecture,(! [Xph:$o] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XD:($i > $o)] : (! [XP:($i > $o)] : (! [XR:($i > $o)] : (! [XE:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((XB2 = (ccfv @ XC @ ccbs)) => ((XH = (ccfv @ XC @ cchom)) => ((Xph => (cwbr @ XF @ XG @ (cco @ XC @ XD @ ccfth))) => ((Xph => (cwcel @ XX @ XB2)) => ((Xph => (cwcel @ XY @ XB2)) => ((Xph => (cwcel @ XR @ (cco @ XX @ XY @ XH))) => ((XE = (ccfv @ XC @ ccepi)) => ((XP = (ccfv @ XD @ ccepi)) => ((Xph => (cwcel @ (ccfv @ XR @ (cco @ XX @ XY @ XG)) @ (cco @ (ccfv @ XX @ XF) @ (ccfv @ XY @ XF) @ XP))) => (Xph => (cwcel @ XR @ (cco @ XX @ XY @ XE))))))))))))))))))))))))).
