...
thf(antridm_ax,axiom,(! [XS:($i > $o)] : (! [XJ:($i > $o)] : (! [XX:($i > $o)] : ((XX = (ccuni @ XJ)) => (((cwcel @ XJ @ cctop) & (cwss @ XS @ XX)) => ((ccfv @ (ccfv @ XS @ (ccfv @ XJ @ ccnt)) @ (ccfv @ XJ @ ccnt)) = (ccfv @ XS @ (ccfv @ XJ @ ccnt))))))))).
...
thf(cdvresntr_conj,conjecture,(! [Xph:$o] : (! [XS:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : (! [XX:($i > $o)] : (! [XY:($i > $o)] : ((Xph => (cwss @ XS @ ccc)) => ((Xph => (cwss @ XX @ XS)) => ((Xph => (cwf @ XX @ ccc @ XF)) => ((XJ = (cco @ XK @ XS @ ccrest)) => ((XK = (ccfv @ cccnfld @ cctopn)) => ((Xph => ((ccfv @ XX @ (ccfv @ XJ @ ccnt)) = XY)) => (Xph => ((cco @ XS @ XF @ ccdv) = (cco @ XS @ (ccres @ XF @ XY) @ ccdv))))))))))))))))).
