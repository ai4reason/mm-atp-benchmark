...
thf(anghmcn_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (ccfv @ XS @ cctopn)) => ((XK = (ccfv @ XT @ cctopn)) => ((cwcel @ XF @ (cco @ XS @ XT @ ccnghm)) => (cwcel @ XF @ (cco @ XJ @ XK @ cccn))))))))))).
...
thf(anmval2_ax,axiom,(! [XA2:($i > $o)] : (! [XD:($i > $o)] : (! [XE:($i > $o)] : (! [XN:($i > $o)] : (! [XW:($i > $o)] : (! [XX:($i > $o)] : (! [Xc_0:($i > $o)] : ((XN = (ccfv @ XW @ ccnm)) => ((XX = (ccfv @ XW @ ccbs)) => ((Xc_0 = (ccfv @ XW @ cc0g)) => ((XD = (ccfv @ XW @ ccds)) => ((XE = (ccres @ XD @ (ccxp @ XX @ XX))) => (((cwcel @ XW @ ccgrp) & (cwcel @ XA2 @ XX)) => ((ccfv @ XA2 @ XN) = (cco @ XA2 @ Xc_0 @ XE)))))))))))))))).
...
thf(abddnghm_ax,axiom,(! [XA2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XN:($i > $o)] : ((XN = (cco @ XS @ XT @ ccnmo)) => (((cw3a @ (cwcel @ XS @ ccngp) @ (cwcel @ XT @ ccngp) @ (cwcel @ XF @ (cco @ XS @ XT @ ccghm))) & ((cwcel @ XA2 @ ccr) & (cwbr @ (ccfv @ XF @ XN) @ XA2 @ ccle))) => (cwcel @ XF @ (cco @ XS @ XT @ ccnghm)))))))))).
thf(cnmhmcn_conj,conjecture,(! [XB2:($i > $o)] : (! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XJ:($i > $o)] : (! [XK:($i > $o)] : ((XJ = (ccfv @ XS @ cctopn)) => ((XK = (ccfv @ XT @ cctopn)) => ((XG = (ccfv @ XS @ ccsca)) => ((XB2 = (ccfv @ XG @ ccbs)) => ((cw3a @ (cwcel @ XS @ (ccin @ ccnlm @ ccclm)) @ (cwcel @ XT @ (ccin @ ccnlm @ ccclm)) @ (cwss @ ccq @ XB2)) => ((cwcel @ XF @ (cco @ XS @ XT @ ccnmhm)) <=> ((cwcel @ XF @ (cco @ XS @ XT @ cclmhm)) & (cwcel @ XF @ (cco @ XJ @ XK @ cccn))))))))))))))))).
