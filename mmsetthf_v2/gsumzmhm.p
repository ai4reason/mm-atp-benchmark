...
thf(acntzmhm2_ax,axiom,(! [XS:($i > $o)] : (! [XT:($i > $o)] : (! [XF:($i > $o)] : (! [XG:($i > $o)] : (! [XH:($i > $o)] : (! [XY:($i > $o)] : (! [XZ:($i > $o)] : ((XZ = (ccfv @ XG @ cccntz)) => ((XY = (ccfv @ XH @ cccntz)) => (((cwcel @ XF @ (cco @ XG @ XH @ ccmhm)) & (cwss @ XS @ (ccfv @ XT @ XZ))) => (cwss @ (ccima @ XF @ XS) @ (ccfv @ (ccima @ XF @ XT) @ XY))))))))))))).
