...
thf(cfztpval_conj,conjecture,(! [XA2:($i > $o)] : (! [XB2:($i > $o)] : (! [XC:($i > $o)] : (! [XF:($i > $o)] : ((cwral @ (^ [Xx3:$i] : ((ccfv @ (ccv @ Xx3) @ XF) = (ccif @ ((ccv @ Xx3) = cc1) @ XA2 @ (ccif @ ((ccv @ Xx3) = cc2) @ XB2 @ XC)))) @ (^ [Xx3:$i] : (cco @ cc1 @ cc3 @ ccfz))) <=> (cw3a @ ((ccfv @ cc1 @ XF) = XA2) @ ((ccfv @ cc2 @ XF) = XB2) @ ((ccfv @ cc3 @ XF) = XC)))))))).
